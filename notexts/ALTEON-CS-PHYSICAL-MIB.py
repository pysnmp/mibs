...
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", fdbSrcPort=fdbSrcPort, trunkgroup=trunkgroup, mstCistNewCfgBridgeForwardDelay=mstCistNewCfgBridgeForwardDelay, stgCurCfgPriority=stgCurCfgPriority, vlanInfo=vlanInfo, cistInfoPortDesignatedPort=cistInfoPortDesignatedPort, stgNewCfgPortEdge=stgNewCfgPortEdge, layer2Oper=layer2Oper, stpInfoPortState=stpInfoPortState, stgStatsStpIndex=stgStatsStpIndex, cistBridgeForwardDelay=cistBridgeForwardDelay, stpInfoPortTableEntry=stpInfoPortTableEntry, vlanCurCfgPorts=vlanCurCfgPorts, pmNewCfgPmirrMoniPortIndex=pmNewCfgPmirrMoniPortIndex, stpInfo=stpInfo, mstCistNewCfgBridgeMaxAge=mstCistNewCfgBridgeMaxAge, fdbStatsFinds=fdbStatsFinds, vlanNewCfgPorts=vlanNewCfgPorts, portTeamNewCfgPorts=portTeamNewCfgPorts, vlanNewCfgState=vlanNewCfgState, cistRegionalRoot=cistRegionalRoot, lacpNewPortCfgTableEntry=lacpNewPortCfgTableEntry, mstCurCfgMaxHopCount=mstCurCfgMaxHopCount, pmNewCfgPmirrMirrPortIndex=pmNewCfgPmirrMirrPortIndex, mstCistNewCfgPortPathCost=mstCistNewCfgPortPathCost, stgCurCfgIndex=stgCurCfgIndex, vlanNewCfgDelete=vlanNewCfgDelete, fdbVlan=fdbVlan, lacpCurPortCfgTable=lacpCurPortCfgTable, stgNewCfgPriority=stgNewCfgPriority, mstCistNewCfgPortTable=mstCistNewCfgPortTable, mstCistNewCfgPortTableEntry=mstCistNewCfgPortTableEntry, fdbStatsCurrent=fdbStatsCurrent, vlanInfoName=vlanInfoName, fdbTable=fdbTable, portTeamCurCfgTable=portTeamCurCfgTable, vlanInfoBwmContract=vlanInfoBwmContract, mstCurCfgRegionVersion=mstCurCfgRegionVersion, stgCurCfgBrgHelloTime=stgCurCfgBrgHelloTime, mstCurCfgStpMode=mstCurCfgStpMode, portTeamInfoTrunks=portTeamInfoTrunks, fdbStatsDeletes=fdbStatsDeletes, cistGeneralInfo=cistGeneralInfo, fdbStatsLookupFails=fdbStatsLookupFails, cistInfoPortState=cistInfoPortState, cistInfoPortPriority=cistInfoPortPriority, vlanInfoId=vlanInfoId, mstNewCfgMaxHopCount=mstNewCfgMaxHopCount, portTeamNewCfgRemoveTrunk=portTeamNewCfgRemoveTrunk, stpInfoTableEntry=stpInfoTableEntry, lacpCurPortState=lacpCurPortState, cistInfoPortDesignatedBridge=cistInfoPortDesignatedBridge, vlanInfoJumbo=vlanInfoJumbo, stpInfoPortPathCost=stpInfoPortPathCost, vlan=vlan, stgNewCfgStgIndex=stgNewCfgStgIndex, mirrPortMirr=mirrPortMirr, pmCurCfgPortMonitorTable=pmCurCfgPortMonitorTable, mstCistCurCfgBridgePriority=mstCistCurCfgBridgePriority, stpInfoPortIndex=stpInfoPortIndex, portTeamCurCfgState=portTeamCurCfgState, PYSNMP_MODULE_ID=layer2, stpInfoTopChanges=stpInfoTopChanges, vlanInfoTable=vlanInfoTable, stpInfoPortDesignatedCost=stpInfoPortDesignatedCost, lacpInfoPortTable=lacpInfoPortTable, lacpCurPortActorAdminKey=lacpCurPortActorAdminKey, lacp=lacp, mstCistNewCfgBridgePriority=mstCistNewCfgBridgePriority, portTeamNewCfgTable=portTeamNewCfgTable, stgStatsPortIndex=stgStatsPortIndex, stpInfoPortStpIndex=stpInfoPortStpIndex, stpInfoPortRole=stpInfoPortRole, trunkGroupCurCfgTable=trunkGroupCurCfgTable, vlanMaxVlanID=vlanMaxVlanID, stgNewCfgBrgForwardDelay=stgNewCfgBrgForwardDelay, stgStatsPortRcvTcnBpdus=stgStatsPortRcvTcnBpdus, pmNewCfgPortMirrState=pmNewCfgPortMirrState, stgCurCfgStgIndex=stgCurCfgStgIndex, stgCurCfgBrgMaxAge=stgCurCfgBrgMaxAge, portTeamNewCfgRemovePort=portTeamNewCfgRemovePort, mstGeneralCfg=mstGeneralCfg, stgNewCfgIndex=stgNewCfgIndex, vlanCurCfgJumbo=vlanCurCfgJumbo, vlanCurCfgLearn=vlanCurCfgLearn, vlanInfoLearn=vlanInfoLearn, vlanMaxEnt=vlanMaxEnt, mstCistNewCfgPortHelloTime=mstCistNewCfgPortHelloTime, trunkGroupNewCfgBwmContract=trunkGroupNewCfgBwmContract, stgNewCfgVlanBmap=stgNewCfgVlanBmap, stgStatsPortTable=stgStatsPortTable, stgCfg=stgCfg, vlanCurCfgVlanName=vlanCurCfgVlanName, vlanCurCfgBwmContract=vlanCurCfgBwmContract, stgNewCfgAddVlan=stgNewCfgAddVlan, stpInfoRootCost=stpInfoRootCost, fdbStatsLookups=fdbStatsLookups, pmCurCfgPmirrPortVlansBmap=pmCurCfgPmirrPortVlansBmap, trunkGroupNewCfgRemovePort=trunkGroupNewCfgRemovePort, lacpCurPortCfgTableId=lacpCurPortCfgTableId, mstCistNewCfgPortEdge=mstCistNewCfgPortEdge, stpInfoTimeSinceTopChange=stpInfoTimeSinceTopChange, vlanNewCfgAddPort=vlanNewCfgAddPort, vlanNewCfgBwmContract=vlanNewCfgBwmContract, stgCurCfgPortPathCost=stgCurCfgPortPathCost, stpInfoPortEdge=stpInfoPortEdge, portTeamCurCfgIndex=portTeamCurCfgIndex, portTeamNewCfgIndex=portTeamNewCfgIndex, stgNewCfgPortPathCost=stgNewCfgPortPathCost, stpStats=stpStats, stgNewCfgPortState=stgNewCfgPortState, pmNewCfgPortMonitorEntry=pmNewCfgPortMonitorEntry, stgCurCfgPortIndex=stgCurCfgPortIndex, mstCistCurCfgPortIndex=mstCistCurCfgPortIndex, mstCistNewCfgPortIndex=mstCistNewCfgPortIndex, vlanNewCfgStg=vlanNewCfgStg, vlanNewCfgJumbo=vlanNewCfgJumbo, vlanNewCfgVlanName=vlanNewCfgVlanName, trunkGroupCurCfgPorts=trunkGroupCurCfgPorts, stpInfoRootPort=stpInfoRootPort, pmNewCfgPmirrDelete=pmNewCfgPmirrDelete, mstCurCfgRegionName=mstCurCfgRegionName, stgNewCfgTable=stgNewCfgTable, stgCurCfgPortLink=stgCurCfgPortLink, vlanCurCfgState=vlanCurCfgState, lacpInfoPortNtt=lacpInfoPortNtt, trunkGroupNewCfgTableEntry=trunkGroupNewCfgTableEntry, mstCistCurCfgPortTableEntry=mstCistCurCfgPortTableEntry, trunkGroupCurCfgIndex=trunkGroupCurCfgIndex, mstCistCurCfgPortPriority=mstCistCurCfgPortPriority, mstCistCurCfgPortStpState=mstCistCurCfgPortStpState, stgCurCfgPortTable=stgCurCfgPortTable, portTeamNewCfgState=portTeamNewCfgState, portTeamInfoPortsState=portTeamInfoPortsState, stgNewCfgState=stgNewCfgState, cistBridgeHelloTime=cistBridgeHelloTime, fdbMacAddr=fdbMacAddr, mirroring=mirroring, vlanNewCfgVlanId=vlanNewCfgVlanId, lacpInfoPortTableEntry=lacpInfoPortTableEntry, lacpInfoPortReadyN=lacpInfoPortReadyN, vlanNewCfgTableEntry=vlanNewCfgTableEntry, lacpNewPortActorAdminKey=lacpNewPortActorAdminKey, stgNewCfgAgingTime=stgNewCfgAgingTime, stgNewCfgBrgMaxAge=stgNewCfgBrgMaxAge, pmNewCfgRemoveVlan=pmNewCfgRemoveVlan, cistRoot=cistRoot, cistRootPathCost=cistRootPathCost, cistRegionalPathCost=cistRegionalPathCost, mstCfg=mstCfg, stgCurCfgBrgForwardDelay=stgCurCfgBrgForwardDelay, lacpCurSystemTimeoutTime=lacpCurSystemTimeoutTime, stgNewCfgDefaultCfg=stgNewCfgDefaultCfg, mstCistNewCfgPortStpState=mstCistNewCfgPortStpState, stgStatsPortXmtCfgBpdus=stgStatsPortXmtCfgBpdus, stpInfoPortTable=stpInfoPortTable, vlanInfoPorts=vlanInfoPorts, vlanNewCfgTable=vlanNewCfgTable, fdbStatsFindOrCreates=fdbStatsFindOrCreates, portTeamInfoTrunksState=portTeamInfoTrunksState, portTeamCfg=portTeamCfg, lacpInfo=lacpInfo, trunkGroupNewCfgPorts=trunkGroupNewCfgPorts, trunkGroupNewCfgState=trunkGroupNewCfgState, stgNewCfgRemoveVlan=stgNewCfgRemoveVlan, trunkGroupCurCfgState=trunkGroupCurCfgState, stgCurCfgTableEntry=stgCurCfgTableEntry, mstNewCfgRegionVersion=mstNewCfgRegionVersion, portTeamNewCfgAddPort=portTeamNewCfgAddPort, stpInfoForwardDelay=stpInfoForwardDelay, cistInfoPortPathCost=cistInfoPortPathCost, stgNewCfgPortIndex=stgNewCfgPortIndex, pmCurCfgPortMonitorEntry=pmCurCfgPortMonitorEntry, mstCistNewCfgPortPriority=mstCistNewCfgPortPriority, stgCurCfgTable=stgCurCfgTable, fdbInfo=fdbInfo, fdbEntry=fdbEntry, stgNewCfgTableEntry=stgNewCfgTableEntry, lacpInfoPortIndex=lacpInfoPortIndex, portTeamTableMaxSize=portTeamTableMaxSize, cistInfoPortTable=cistInfoPortTable, portTeamInfoTable=portTeamInfoTable, lacpCurSystemPriority=lacpCurSystemPriority, stgCurCfgPortState=stgCurCfgPortState, trunkGroupNewCfgDelete=trunkGroupNewCfgDelete, mstNewCfgState=mstNewCfgState, vlanCurCfgTableEntry=vlanCurCfgTableEntry, lacpNewSystemTimeoutTime=lacpNewSystemTimeoutTime, mstCistCurCfgPortTable=mstCistCurCfgPortTable, mstCistDefaultCfg=mstCistDefaultCfg, vlanCurCfgStg=vlanCurCfgStg, mstCistCurCfgPortLinkType=mstCistCurCfgPortLinkType, cistInfoPortTableEntry=cistInfoPortTableEntry, stgNewCfgPortPriority=stgNewCfgPortPriority, portTeamCurCfgPorts=portTeamCurCfgPorts, mstCistBridgeCfg=mstCistBridgeCfg, layer2Configs=layer2Configs, lacpInfoPortSelected=lacpInfoPortSelected, pmCurCfgPmirrMirrPortIndex=pmCurCfgPmirrMirrPortIndex, BridgeId=BridgeId, stgStatsPortRcvCfgBpdus=stgStatsPortRcvCfgBpdus, fdbState=fdbState, stpInfoPortForwardTransitions=stpInfoPortForwardTransitions, portTeamInfoTableEntry=portTeamInfoTableEntry, lacpNewSystemPriority=lacpNewSystemPriority, lacpCurPortCfgTableEntry=lacpCurPortCfgTableEntry, mstCistCurCfgPortPathCost=mstCistCurCfgPortPathCost, cistRootPort=cistRootPort, stgCurCfgVlanBmap=stgCurCfgVlanBmap, vlanNewCfgLearn=vlanNewCfgLearn, layer2Stats=layer2Stats, lacpNewPortActorPortPriority=lacpNewPortActorPortPriority, trunkGroupNewCfgTable=trunkGroupNewCfgTable, fdbStatsOverflows=fdbStatsOverflows, cistBridgeMaxAge=cistBridgeMaxAge, fdbLearnedPort=fdbLearnedPort, pmNewCfgAddVlan=pmNewCfgAddVlan, stpInfoIndex=stpInfoIndex, stgCurCfgPortPriority=stgCurCfgPortPriority, fdbRefSps=fdbRefSps, trunkGroupCurCfgBwmContract=trunkGroupCurCfgBwmContract, trunkGroupNewCfgAddPort=trunkGroupNewCfgAddPort, fdbStatsHiwat=fdbStatsHiwat, mstCistCfg=mstCistCfg, stpInfoPortDesignatedRoot=stpInfoPortDesignatedRoot, cistInfo=cistInfo, stpInfoPortLinkType=stpInfoPortLinkType, portTeamInfoIndex=portTeamInfoIndex, portTeamCurCfgTableEntry=portTeamCurCfgTableEntry, stpInfoPortDesignatedBridge=stpInfoPortDesignatedBridge, vlanNewCfgRemovePort=vlanNewCfgRemovePort, trunkGroupTableMaxSize=trunkGroupTableMaxSize, cistInfoPortIndex=cistInfoPortIndex, portTeamInfoState=portTeamInfoState, stpInfoHelloTime=stpInfoHelloTime, mstCistCurCfgPortEdge=mstCistCurCfgPortEdge, vlanInfoStatus=vlanInfoStatus, trunkGroupCurCfgTableEntry=trunkGroupCurCfgTableEntry, portTeamNewCfgTableEntry=portTeamNewCfgTableEntry, pmNewCfgPmirrPortVlansBmap=pmNewCfgPmirrPortVlansBmap, mstCistCurCfgPortHelloTime=mstCistCurCfgPortHelloTime, vlanCurCfgVlanId=vlanCurCfgVlanId, stpInfoHoldTime=stpInfoHoldTime, stgStatsPortTableEntry=stgStatsPortTableEntry, stpInfoPortDesignatedPort=stpInfoPortDesignatedPort, cistInfoPortLinkType=cistInfoPortLinkType, stgCurCfgPortEdge=stgCurCfgPortEdge, stgStatsPortXmtTcnBpdus=stgStatsPortXmtTcnBpdus, stpInfoTable=stpInfoTable, stgNewCfgBrgHelloTime=stgNewCfgBrgHelloTime, mstCistCurCfgBridgeMaxAge=mstCistCurCfgBridgeMaxAge, layer2=layer2, pmNewCfgPortMonitorTable=pmNewCfgPortMonitorTable, portTeamNewCfgAddTrunk=portTeamNewCfgAddTrunk)
mibBuilder.exportSymbols("ALTEON-CS-PHYSICAL-MIB", stgNewCfgPortTable=stgNewCfgPortTable, portTeamInfo=portTeamInfo, stgCurCfgState=stgCurCfgState, pmNewCfgPmirrDirection=pmNewCfgPmirrDirection, lacpInfoPortMoved=lacpInfoPortMoved, portTeamCurCfgTrunks=portTeamCurCfgTrunks, cistInfoPortRole=cistInfoPortRole, pmCurCfgPmirrDirection=pmCurCfgPmirrDirection, layer2Info=layer2Info, portTeamInfoPorts=portTeamInfoPorts, vlanCurCfgTable=vlanCurCfgTable, mstCurCfgState=mstCurCfgState, fdbStatsCreates=fdbStatsCreates, lacpNewPortCfgTable=lacpNewPortCfgTable, stgCurCfgPortTableEntry=stgCurCfgPortTableEntry, stgCurCfgAgingTime=stgCurCfgAgingTime, fdbStatsFindFails=fdbStatsFindFails, stpInfoDesignatedRoot=stpInfoDesignatedRoot, mstNewCfgRegionName=mstNewCfgRegionName, portTeamNewCfgDelete=portTeamNewCfgDelete, fdbSrcTrunk=fdbSrcTrunk, stpInfoMaxAge=stpInfoMaxAge, lacpNewPortState=lacpNewPortState, stgNewCfgPortLink=stgNewCfgPortLink, lacpNewPortCfgTableId=lacpNewPortCfgTableId, stgNewCfgPortTableEntry=stgNewCfgPortTableEntry, pmCurCfgPortMirrState=pmCurCfgPortMirrState, vlanInfoTableEntry=vlanInfoTableEntry, pmCurCfgPmirrMoniPortIndex=pmCurCfgPmirrMoniPortIndex, fdbStats=fdbStats, fdbClear=fdbClear, mstCistNewCfgPortLinkType=mstCistNewCfgPortLinkType, mstNewCfgStpMode=mstNewCfgStpMode, mstCistCurCfgBridgeForwardDelay=mstCistCurCfgBridgeForwardDelay, lacpCurPortActorPortPriority=lacpCurPortActorPortPriority, portTeamNewCfgTrunks=portTeamNewCfgTrunks, trunkGroupNewCfgIndex=trunkGroupNewCfgIndex)
