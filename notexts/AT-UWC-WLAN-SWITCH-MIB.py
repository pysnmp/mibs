...
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsAuthenticatedClientSessionTransmitRetryCount=wsAuthenticatedClientSessionTransmitRetryCount, wsDetectedClientTriangulationId=wsDetectedClientTriangulationId, wsRrmChannelLoadCurrentRequestStatus=wsRrmChannelLoadCurrentRequestStatus, wsAPSentryTriangulationMacAddr=wsAPSentryTriangulationMacAddr, wsCapability=wsCapability, wsManagedAPRadioStatisticsTable=wsManagedAPRadioStatisticsTable, wsSwitchAuthenticatedClients=wsSwitchAuthenticatedClients, wsRrmChannelLoadCurrentRequestDuration=wsRrmChannelLoadCurrentRequestDuration, wsAuthenticatedClientVLAN=wsAuthenticatedClientVLAN, wsAssociatedClientNwTime=wsAssociatedClientNwTime, wsAPProfileId=wsAPProfileId, wsNetworkDistTunnelMode=wsNetworkDistTunnelMode, wsAssociatedClientDisassociateAction=wsAssociatedClientDisassociateAction, wsManagedAPEthernetRecvdErrorCount=wsManagedAPEthernetRecvdErrorCount, wsDetectedClientDeAuthCollectionIntvl=wsDetectedClientDeAuthCollectionIntvl, wsPowerManualProposedAdjustmentTable=wsPowerManualProposedAdjustmentTable, wsManagedAPVAPTspecBytesRecvd=wsManagedAPVAPTspecBytesRecvd, wsManagedAPRadioEligibleChannelRdrDetected=wsManagedAPRadioEligibleChannelRdrDetected, wsPowerPlanAPNumInterferingVAPs=wsPowerPlanAPNumInterferingVAPs, wsDetectedClientTriangulationMacAddr=wsDetectedClientTriangulationMacAddr, deauthThresholdValue=deauthThresholdValue, wsSSIDAssociatedClientStatusTable=wsSSIDAssociatedClientStatusTable, maxFailingAuthentication=maxFailingAuthentication, wsPeerSwitchIpAddress=wsPeerSwitchIpAddress, wsRFScanAPOUI=wsRFScanAPOUI, wsNetworkId=wsNetworkId, knownClientDatabaseTest=knownClientDatabaseTest, wsTotalPeerSwitches=wsTotalPeerSwitches, probeThresholdInterval=probeThresholdInterval, wsSwitchTspecTotalTrafficStreamClients=wsSwitchTspecTotalTrafficStreamClients, wsKnownClientMacAddress=wsKnownClientMacAddress, wsNetworkWEPKey1=wsNetworkWEPKey1, wsManagedAPEthernetBytesTransmitted=wsManagedAPEthernetBytesTransmitted, wsManagedAPTspecsRejected=wsManagedAPTspecsRejected, wsAPProvStatus=wsAPProvStatus, wsAssociatedClientQosAccessControlDownName=wsAssociatedClientQosAccessControlDownName, wsManagedAPCL2TunnelBytesTransmitted=wsManagedAPCL2TunnelBytesTransmitted, wsManagedAPRadioEligibleChannelListEntry=wsManagedAPRadioEligibleChannelListEntry, wsChannelPlanHistoryEntry=wsChannelPlanHistoryEntry, wsManagedVAPWLANBytesTransmitDropped=wsManagedVAPWLANBytesTransmitDropped, wsAssociatedClientStatisticsTable=wsAssociatedClientStatisticsTable, wsTotalWLANBytesTransmitted=wsTotalWLANBytesTransmitted, wsFailedAPValidationFailureCount=wsFailedAPValidationFailureCount, notInOUIDatabase=notInOUIDatabase, wsAssociatedClientRRMBeaconPassiveMeasurementSupported=wsAssociatedClientRRMBeaconPassiveMeasurementSupported, wsManagedVAPWLANBytesRecvd=wsManagedVAPWLANBytesRecvd, wsDetectedClientEntryCreateTime=wsDetectedClientEntryCreateTime, wsAPFailureEntriesPurge=wsAPFailureEntriesPurge, wsAPProvMutualAuthMode=wsAPProvMutualAuthMode, wsAPAuthenticationPasswd=wsAPAuthenticationPasswd, wsManagedVAPAuthenticationFailures=wsManagedVAPAuthenticationFailures, wsAssociatedClientStatusEntry=wsAssociatedClientStatusEntry, wsManualPowerAdjustmentStatus=wsManualPowerAdjustmentStatus, wsChannelPlanAPLocation=wsChannelPlanAPLocation, wsAuthenticatedClientSessionPktsRecvd=wsAuthenticatedClientSessionPktsRecvd, wsAPProvCommand=wsAPProvCommand, rogueUnknownApManagedSsid=rogueUnknownApManagedSsid, wsDetectedClientPreAuthenticationMacAddr=wsDetectedClientPreAuthenticationMacAddr, wsAPImageTypeFileTable=wsAPImageTypeFileTable, wsNetworkWPAKeyType=wsNetworkWPAKeyType, wsPowerAdjustmentMode=wsPowerAdjustmentMode, wsAPHWTypeRadioBGmodeSupport=wsAPHWTypeRadioBGmodeSupport, wsNetworkClientQosAccessControlDownType=wsNetworkClientQosAccessControlDownType, wsQOSQueueId=wsQOSQueueId, wsPowerPlanTimeSinceLastPowerPLan=wsPowerPlanTimeSinceLastPowerPLan, wsManagedAPDistTunnelMcastPacketsTransmitted=wsManagedAPDistTunnelMcastPacketsTransmitted, wsNetworkClientQosBandwidthLimitUp=wsNetworkClientQosBandwidthLimitUp, wsChannelPlanAPLastChanScanDuration=wsChannelPlanAPLastChanScanDuration, wsChannelPlanManualAction=wsChannelPlanManualAction, wsDetectedClientThreatMitigationStatus=wsDetectedClientThreatMitigationStatus, wsSwitchManagedAPs=wsSwitchManagedAPs, wsAuthenticatedClientStatisticsTable=wsAuthenticatedClientStatisticsTable, wsAuthenticatedClientSwitchIpAddress=wsAuthenticatedClientSwitchIpAddress, authenticatedClient=authenticatedClient, wsManagedAPNeighborClientListEntry=wsManagedAPNeighborClientListEntry, wsChannelPlanAPCurrentChannel=wsChannelPlanAPCurrentChannel, wsWLANUtilization=wsWLANUtilization, rogueUnexpectedWdsDevice=rogueUnexpectedWdsDevice, wsDetectedClientRoamMacAddr=wsDetectedClientRoamMacAddr, wsWDSSourceMacAddr=wsWDSSourceMacAddr, wsAuthenticatedClientQosCachedDiffservPolicyDownName=wsAuthenticatedClientQosCachedDiffservPolicyDownName, wsPeerConfigurationRadiusClient=wsPeerConfigurationRadiusClient, wsPowerPlanAPNumInterferingAPs=wsPowerPlanAPNumInterferingAPs, wsAPHWTypeRadioDescription=wsAPHWTypeRadioDescription, wsAPSentryTriangulationId=wsAPSentryTriangulationId, wsAPMacAddress=wsAPMacAddress, wsDetectedClientChannel=wsDetectedClientChannel, wsIPPollRowStatus=wsIPPollRowStatus, wsAuthenticatedClientBytesRecvDropped=wsAuthenticatedClientBytesRecvDropped, wsAuthenticatedClientIpAddress=wsAuthenticatedClientIpAddress, wsDevLocBldngEntry=wsDevLocBldngEntry, wsAuthenticatedClientNeighborWSManagedAPRadioInterface=wsAuthenticatedClientNeighborWSManagedAPRadioInterface, wsChannelPlanAPOldChannel=wsChannelPlanAPOldChannel, wsAPClientQosMode=wsAPClientQosMode, wsManagedAPRadioMCAStatus=wsManagedAPRadioMCAStatus, wsManagedAPRadioEligibleChannelLastRdrDetTime=wsManagedAPRadioEligibleChannelLastRdrDetTime, wsSwitchWLANTspecPktsRecvd=wsSwitchWLANTspecPktsRecvd, clientThreatMitigation=clientThreatMitigation, wsManagedAPDebugStatus=wsManagedAPDebugStatus, wsManagedAPDistTunnelBytesReceived=wsManagedAPDistTunnelBytesReceived, wsRrmChannelLoadNewRequestDuration=wsRrmChannelLoadNewRequestDuration, wsChannelPlanManualNewChannel=wsChannelPlanManualNewChannel, wsDevLocApCount=wsDevLocApCount, wsSwitchAuthenticatedClientStatusEntry=wsSwitchAuthenticatedClientStatusEntry, wsModeDisabled=wsModeDisabled, wsSwitchWLANRoamingTspecsAccepted=wsSwitchWLANRoamingTspecsAccepted, wsNetworkAcctRadiusServerName=wsNetworkAcctRadiusServerName, wsOnDemandTriggerFloorStatusDeviceFound=wsOnDemandTriggerFloorStatusDeviceFound, wsMaximumAssociatedClients=wsMaximumAssociatedClients, wsAPProvNewPrimarySwitchIP=wsAPProvNewPrimarySwitchIP, wsManagedAPVAPStatisticsTable=wsManagedAPVAPStatisticsTable, wsDevLocManagedApEntry=wsDevLocManagedApEntry, wsClusterControllerIndicator=wsClusterControllerIndicator, knownClientDatabaseRadiusServerName=knownClientDatabaseRadiusServerName, wsAdHocClientStatusTable=wsAdHocClientStatusTable, tspecGlobal=tspecGlobal, wsManagedAPRadioEligibleChannelRdrDetRequired=wsManagedAPRadioEligibleChannelRdrDetRequired, wsAPCodeDownloadImageType=wsAPCodeDownloadImageType, wsAPRadioLongRetryLimit=wsAPRadioLongRetryLimit, wsAssociatedClientSessionTransmitRetryCount=wsAssociatedClientSessionTransmitRetryCount, wsRrmChannelLoadNewRequestSend=wsRrmChannelLoadNewRequestSend, wsWDSLinkSourceAPPktsSent=wsWDSLinkSourceAPPktsSent, wsAPRadioMCSIndexValue=wsAPRadioMCSIndexValue, wsSwitchWLANTspecPktsTransmitted=wsSwitchWLANTspecPktsTransmitted, wsManagedVAPAuthenticatedClients=wsManagedVAPAuthenticatedClients, wsAPTriangulationSentryStatusEntry=wsAPTriangulationSentryStatusEntry, wsAssociatedClientAge=wsAssociatedClientAge, wsRFScanAPEntriesPurge=wsRFScanAPEntriesPurge, wsManagedAPSysUpTime=wsManagedAPSysUpTime, wsAPProfileName=wsAPProfileName, wsAuthenticatedClientDisassociateAction=wsAuthenticatedClientDisassociateAction, wsNetworkClientQosBandwidthLimitDown=wsNetworkClientQosBandwidthLimitDown, wsVAPAssociatedClientMacAddress=wsVAPAssociatedClientMacAddress, wsTotalProvisioningAPs=wsTotalProvisioningAPs, wsManagedAPStatisticsEntry=wsManagedAPStatisticsEntry, wsTotalAuthenticatedClients=wsTotalAuthenticatedClients, wsChannelPlanManualAPRadioInterface=wsChannelPlanManualAPRadioInterface, wsWDSLinkDestAPPktsSent=wsWDSLinkDestAPPktsSent, wsGlobalTspecStatisticsEntry=wsGlobalTspecStatisticsEntry, at_uwc=at_uwc, tspecClient=tspecClient, wsPeerSwitchFailed=wsPeerSwitchFailed, wsManagedAPFailed=wsManagedAPFailed, wsAPRadioWMMMode=wsAPRadioWMMMode, wsAdHocClientAge=wsAdHocClientAge, wsAPRadioFragmentationThreshold=wsAPRadioFragmentationThreshold, wsSwitchTspecStatisticsEntry=wsSwitchTspecStatisticsEntry, wsManagedAPDistTunnelRoamedClients=wsManagedAPDistTunnelRoamedClients, wsDetectedClientHighestNumDeAuthMsgs=wsDetectedClientHighestNumDeAuthMsgs, wsAssociatedClientTsUserPriority=wsAssociatedClientTsUserPriority, wsGlobalStatistics=wsGlobalStatistics, wsRFScanAPBeaconInterval=wsRFScanAPBeaconInterval, wsAuthenticatedClientQosStatusTable=wsAuthenticatedClientQosStatusTable, wsAssociatedClientTxDataRate=wsAssociatedClientTxDataRate, wsAssociatedClientQosAccessControlDownType=wsAssociatedClientQosAccessControlDownType, wsAuthenticatedClientBSSID=wsAuthenticatedClientBSSID, wsAssociatedClientTsViolatePktsRecvd=wsAssociatedClientTsViolatePktsRecvd, wsAPRadio2TxPower=wsAPRadio2TxPower, wsAPHardwareRadioCapabilityTable=wsAPHardwareRadioCapabilityTable, wsManagedAPRadioTspecPktsTransmitted=wsManagedAPRadioTspecPktsTransmitted, wsKnownClientEntry=wsKnownClientEntry, wsAuthenticatedClientSessionTSViolatePktsRecvd=wsAuthenticatedClientSessionTSViolatePktsRecvd, wsAPRogueClassificationTestState=wsAPRogueClassificationTestState, wsOnDemandTriggerGlobalStatusUsedRadios=wsOnDemandTriggerGlobalStatusUsedRadios, wsRoguesPresent=wsRoguesPresent, wsAuthenticatedClientQosOperStatus=wsAuthenticatedClientQosOperStatus, wsAuthenticatedClientQosCachedStatusTable=wsAuthenticatedClientQosCachedStatusTable, wsWDSLinkStatisticsEntry=wsWDSLinkStatisticsEntry, wsDetectedAPRadioInterface=wsDetectedAPRadioInterface, wsRFScanAPStatusEntry=wsRFScanAPStatusEntry, wsAPImageTypeCapabilityTable=wsAPImageTypeCapabilityTable, wsAPHWTypeRadioID=wsAPHWTypeRadioID, wsNetworkWEPKey4=wsNetworkWEPKey4, wsDetectedClientStatusEntry=wsDetectedClientStatusEntry, wsFailedAPFailureType=wsFailedAPFailureType, wsDetectedClientPreAuthenticationSSID=wsDetectedClientPreAuthenticationSSID, tspecManagedAP=tspecManagedAP, wsFailedAPHWType=wsFailedAPHWType, wsAPHWTypeRadioACmodeSupport=wsAPHWTypeRadioACmodeSupport, wsVAPId=wsVAPId, wsAssociatedClientTransmitRetryFailedCount=wsAssociatedClientTransmitRetryFailedCount, wsSwitchStatusTable=wsSwitchStatusTable, wsClientRogueClassificationLastTime=wsClientRogueClassificationLastTime, wsManagedAPVAPTspecNumActiveTrafficStreams=wsManagedAPVAPTspecNumActiveTrafficStreams, wsAuthenticatedClientTunnelIpAddress=wsAuthenticatedClientTunnelIpAddress, wsOnDemandTriggerGlobalStatusNumOfDetectedBuildings=wsOnDemandTriggerGlobalStatusNumOfDetectedBuildings, wsPeerConfigurationQosAcl=wsPeerConfigurationQosAcl, wsAPProfileRadioSupportedRatesTable=wsAPProfileRadioSupportedRatesTable, wsAPProfileRadioEligibleChannelsEntry=wsAPProfileRadioEligibleChannelsEntry, wsNetworkClientQosDiffservPolicyDownType=wsNetworkClientQosDiffservPolicyDownType, wsNetworkARPSuppressionMode=wsNetworkARPSuppressionMode, wsAssociatedClientTsExcessUsageEvents=wsAssociatedClientTsExcessUsageEvents, wsManagedAPStatus=wsManagedAPStatus, fastPathWLANSwitch=fastPathWLANSwitch, wsClientRogueClassificationReportingAPMac=wsClientRogueClassificationReportingAPMac, wsPowerPlanAPNumPwrChanges=wsPowerPlanAPNumPwrChanges, wsAuthenticatedClientQosAccessControlUpName=wsAuthenticatedClientQosAccessControlUpName, wsAPStandaloneExpectedSecurity=wsAPStandaloneExpectedSecurity, wsStatusTrapMode=wsStatusTrapMode, wsAPHardwareCapabilityEntry=wsAPHardwareCapabilityEntry, wsIPPollListNumOfDiscoveredEntries=wsIPPollListNumOfDiscoveredEntries, wsAPImageAvailability=wsAPImageAvailability, wsNetworkWEPKey2=wsNetworkWEPKey2, wsPowerManualProposedAdjustmentAPRadioInterface=wsPowerManualProposedAdjustmentAPRadioInterface, wsManagedAPDistTunnelsMaxVlanMcastRepl=wsManagedAPDistTunnelsMaxVlanMcastRepl, wsManagedAPVAPTspecMediumTimeRoamingUnallocated=wsManagedAPVAPTspecMediumTimeRoamingUnallocated, wsRFScanAPPhysicalMode=wsRFScanAPPhysicalMode, wsAssociatedClientDot11nCapable=wsAssociatedClientDot11nCapable, wsAssociatedClientStatisticsEntry=wsAssociatedClientStatisticsEntry, wsAuthenticatedClientRRMLocationReportSupported=wsAuthenticatedClientRRMLocationReportSupported, wsFailedAPIpAddress=wsFailedAPIpAddress, wsManagedAPDistTunnelAssocAPClients=wsManagedAPDistTunnelAssocAPClients, wsManagedAPRadioResourceMeasEnabled=wsManagedAPRadioResourceMeasEnabled, wsAPRadioFrequency=wsAPRadioFrequency, wsPeerConfigReceivedTimestamp=wsPeerConfigReceivedTimestamp, wsChannelPlanHistoryDepth=wsChannelPlanHistoryDepth, unmanagedAPReprovisioning=unmanagedAPReprovisioning, wsAPImageTypeID=wsAPImageTypeID, wsDetectedClientStatusTable=wsDetectedClientStatusTable, wsManagedAPWLANBytesTransmitted=wsManagedAPWLANBytesTransmitted, wsWDSAPRootBridge=wsWDSAPRootBridge, wsAPProvUnmanagedAPReprovMode=wsAPProvUnmanagedAPReprovMode, wsGlobalPeerConfigReceived=wsGlobalPeerConfigReceived, wsAPStandaloneExpectedWds=wsAPStandaloneExpectedWds, wsPollIPStatus=wsPollIPStatus, wsAPRadioTspecStaInactivityTimeout=wsAPRadioTspecStaInactivityTimeout, wsManagedAPDebugMode=wsManagedAPDebugMode, wsDetectedClientTriangulationSentryStatusEntry=wsDetectedClientTriangulationSentryStatusEntry, wsVAPAssociatedClientStatusTable=wsVAPAssociatedClientStatusTable, wsManagedAPRadioTspecMediumTimeUnallocated=wsManagedAPRadioTspecMediumTimeUnallocated, wsAssociatedClientQosAccessControlUpType=wsAssociatedClientQosAccessControlUpType, wsNetworkClientQosDiffservPolicyUpName=wsNetworkClientQosDiffservPolicyUpName, wsManagedAPRoamingTspecsRejected=wsManagedAPRoamingTspecsRejected, rogueDetectedTrapIntvl=rogueDetectedTrapIntvl, wsAPRogueClassificationStatusEntry=wsAPRogueClassificationStatusEntry, wsFailedAPAuthenticationFailureCount=wsFailedAPAuthenticationFailureCount, wsManagedAPStatisticsTable=wsManagedAPStatisticsTable, wsOnDemandTriggerFloorStatusXCoordinate=wsOnDemandTriggerFloorStatusXCoordinate, wsTspecTotalVoiceTrafficStreams=wsTspecTotalVoiceTrafficStreams, wsOuiDescription=wsOuiDescription, wsDetectedClientRoamApMac=wsDetectedClientRoamApMac, wsTotalWLANBytesTransmitDropped=wsTotalWLANBytesTransmitDropped, wsManagedAPEthernetTransmitErrorCount=wsManagedAPEthernetTransmitErrorCount, wsDetectedClientDeAuthMsgsRecorded=wsDetectedClientDeAuthMsgsRecorded, wsWDSAPGroupRowStatus=wsWDSAPGroupRowStatus, wsAuthenticatedClientRRMBeaconTableMeasurementSupported=wsAuthenticatedClientRRMBeaconTableMeasurementSupported, wsManagedAPAge=wsManagedAPAge, wsPeerTotalPeerSwitches=wsPeerTotalPeerSwitches, wsManagedAPTspecsAccepted=wsManagedAPTspecsAccepted, rogueManagedApInvalidChannel=rogueManagedApInvalidChannel, wsPeerConfigurationChannelPower=wsPeerConfigurationChannelPower, wsAssociatedClientTsStatusEntry=wsAssociatedClientTsStatusEntry, wsAuthenticatedClientQosCachedBandwidthLimitUp=wsAuthenticatedClientQosCachedBandwidthLimitUp, wsManagedAPVAPTspecNumTrafficStreamClients=wsManagedAPVAPTspecNumTrafficStreamClients)
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsPowerPlanNumPwrChanges=wsPowerPlanNumPwrChanges, wsNeighborClientAge=wsNeighborClientAge, wsNeighborClientDiscoveryReason=wsNeighborClientDiscoveryReason, l2centTunnel=l2centTunnel, wsNetworkWPA2RoambackKeyCacheHoldtime=wsNetworkWPA2RoambackKeyCacheHoldtime, wsAuthenticatedClientStbcCapable=wsAuthenticatedClientStbcCapable, wsAuthenticatedClientQosAccessControlUpType=wsAuthenticatedClientQosAccessControlUpType, wsRFScanAPAge=wsRFScanAPAge, wsRadiusAcctMode=wsRadiusAcctMode, wsPowerPlanAPStrongestDetectorRadio=wsPowerPlanAPStrongestDetectorRadio, wsChannelPlanTable=wsChannelPlanTable, wsNetworkAcctRadiusServerConfiguredStatus=wsNetworkAcctRadiusServerConfiguredStatus, wsAPRadioMulticastTxRate=wsAPRadioMulticastTxRate, wsDevLocManagedApXCoord=wsDevLocManagedApXCoord, wsDetectedClientPreAuthenticationHistoryEntry=wsDetectedClientPreAuthenticationHistoryEntry, wsL2DiscoveryMode=wsL2DiscoveryMode, wsWDSAPGroupAPTable=wsWDSAPGroupAPTable, wsTotalWLANPktsTransmitted=wsTotalWLANPktsTransmitted, wsAssociatedClientPktsTransmitDropped=wsAssociatedClientPktsTransmitDropped, wsChannelPlanAPMacAddress=wsChannelPlanAPMacAddress, wsFailureAPStatusTable=wsFailureAPStatusTable, wsAuthenticatedClientQosCachedDiffservPolicyDownType=wsAuthenticatedClientQosCachedDiffservPolicyDownType, wsAdHocClientStatusEntry=wsAdHocClientStatusEntry, wsPeerConfigReceived=wsPeerConfigReceived, wsManagedAPTspecPktsTransmitted=wsManagedAPTspecPktsTransmitted, wsOnDemandTriggerFloorStatusCircleRadius=wsOnDemandTriggerFloorStatusCircleRadius, wsClusterControllerElected=wsClusterControllerElected, wsAPRadioRateLimitBurst=wsAPRadioRateLimitBurst, wsNetworkClientQosEntry=wsNetworkClientQosEntry, wsChannelPlanNumOfRadiosChanged=wsChannelPlanNumOfRadiosChanged, wsAssociatedClientNetBiosName=wsAssociatedClientNetBiosName, wsChannelPlanLastIterationStatus=wsChannelPlanLastIterationStatus, wsPowerPlanNumPwrInc=wsPowerPlanNumPwrInc, wsNetworkClientQosTable=wsNetworkClientQosTable, wsManagedAPResetStatus=wsManagedAPResetStatus, wsAssociatedClientSessionPktsTransmitted=wsAssociatedClientSessionPktsTransmitted, wsSwitchTspecTotalVideoTrafficStreams=wsSwitchTspecTotalVideoTrafficStreams, wsStationEDCAAIFS=wsStationEDCAAIFS, wsManagedAPWLANPktsTransmitDropped=wsManagedAPWLANPktsTransmitDropped, wsAPDeAuthenticationAttackBSSID=wsAPDeAuthenticationAttackBSSID, wsAuthRadiusServerConfiguredStatus=wsAuthRadiusServerConfiguredStatus, wsNeighborSSID=wsNeighborSSID, wsManagedAPVAPStatusTable=wsManagedAPVAPStatusTable, wsNeighborRSSI=wsNeighborRSSI, wsManagedAPLocation=wsManagedAPLocation, wsDevLocBldngFlrEntry=wsDevLocBldngFlrEntry, wsEligibleChannel=wsEligibleChannel, wsPeerProtocolVersion=wsPeerProtocolVersion, wsChannelPlanAPRadioIntf=wsChannelPlanAPRadioIntf, wsWDSLinkStatisticsTable=wsWDSLinkStatisticsTable, wsAuthenticatedClientSessionDuplicatePktsRecvd=wsAuthenticatedClientSessionDuplicatePktsRecvd, wsPowerPlanAlgoComplete=wsPowerPlanAlgoComplete, wsChannelPlanTime=wsChannelPlanTime, wsManagedAPRadioTxFrameCount=wsManagedAPRadioTxFrameCount, wsAssociatedClientRRMBeaconActiveMeasurementSupported=wsAssociatedClientRRMBeaconActiveMeasurementSupported, wsValidAPConfigEntry=wsValidAPConfigEntry, wsAuthenticatedClientStationDiscoveryReason=wsAuthenticatedClientStationDiscoveryReason, wsTspecTrapMode=wsTspecTrapMode, wsManagedAPRadioChannel=wsManagedAPRadioChannel, wsRrmNeighborApMacAddr=wsRrmNeighborApMacAddr, authWithUnknownAP=authWithUnknownAP, wsDevLocBldngFlrApCount=wsDevLocBldngFlrApCount, wsAPProvAge=wsAPProvAge, wsOuiValue=wsOuiValue, wsTriangLocXCoord=wsTriangLocXCoord, wsFailedAPSwitchMacAddress=wsFailedAPSwitchMacAddress, wsAPStandaloneExpectedSsid=wsAPStandaloneExpectedSsid, wsManagedAPUnknownProtocol=wsManagedAPUnknownProtocol, wsAssociatedClientAssociatingSwitch=wsAssociatedClientAssociatingSwitch, wsAPImageTypeDescription=wsAPImageTypeDescription, wsTspecTotalTrafficStreamClients=wsTspecTotalTrafficStreamClients, wsSwitchTspecStatisticsTable=wsSwitchTspecStatisticsTable, wsAPRadioChannelBandwidth=wsAPRadioChannelBandwidth, wsAPProvMacAddress=wsAPProvMacAddress, wsSwitchWLANPktsTransmitDropped=wsSwitchWLANPktsTransmitDropped, wsMaximumDetectedClientRoamHistoryEntries=wsMaximumDetectedClientRoamHistoryEntries, wsWDSGroupChangePasswdStatus=wsWDSGroupChangePasswdStatus, wsAPProfileRadioTspecEntry=wsAPProfileRadioTspecEntry, wsAssociatedClientQosBandwidthLimitUp=wsAssociatedClientQosBandwidthLimitUp, wsAuthenticatedClientQosCachedAccessControlUpName=wsAuthenticatedClientQosCachedAccessControlUpName, wsAPProfileRadioMCSIndexEntry=wsAPProfileRadioMCSIndexEntry, wsManagedAPVAPTspecStatusTable=wsManagedAPVAPTspecStatusTable, wsManagedAPRadioWLANUtilization=wsManagedAPRadioWLANUtilization, wsManagedAPRadioWLANBytesTransmitDropped=wsManagedAPRadioWLANBytesTransmitDropped, wsWDSAPGroupAPStpPriority=wsWDSAPGroupAPStpPriority, wsManagedAPSwitchIpAddress=wsManagedAPSwitchIpAddress, wsAssociatedClientTsViolatePktsTransmitted=wsAssociatedClientTsViolatePktsTransmitted, wsOnDemandTriggerStart=wsOnDemandTriggerStart, wsAssociatedClientQosDiffservPolicyDownName=wsAssociatedClientQosDiffservPolicyDownName, wsAuthenticatedClientTsViolatePktsTransmitted=wsAuthenticatedClientTsViolatePktsTransmitted, wsSwitchWLANTspecBytesRecvd=wsSwitchWLANTspecBytesRecvd, wsManagedAPCodeDownloadStatus=wsManagedAPCodeDownloadStatus, wsTotalUnknownAPs=wsTotalUnknownAPs, knownClientDatabaseRadiusServerStatus=knownClientDatabaseRadiusServerStatus, wsPowerPlanAPNumOpRadios=wsPowerPlanAPNumOpRadios, wsAPHWTypeDescription=wsAPHWTypeDescription, wsManagedAPRadioStatusEntry=wsManagedAPRadioStatusEntry, wsAPRadioPrimaryChannel=wsAPRadioPrimaryChannel, wsAssociatedClientQosCachedBandwidthLimitUp=wsAssociatedClientQosCachedBandwidthLimitUp, wsDetectedClientTriangulationAge=wsDetectedClientTriangulationAge, wsNeighborClientRSSI=wsNeighborClientRSSI, wsNtwProvisioningChanACompletion=wsNtwProvisioningChanACompletion, wsAPHWTypeRadioVapCount=wsAPHWTypeRadioVapCount, wsAPRadioAPSDMode=wsAPRadioAPSDMode, wsPeerConfigurationWdsGroup=wsPeerConfigurationWdsGroup, wsRFScanAPDot11nMode=wsRFScanAPDot11nMode, wsChannelPlanManualProposedAdjustmentTable=wsChannelPlanManualProposedAdjustmentTable, wsAPRadioAutoChannelMode=wsAPRadioAutoChannelMode, wsRrmChannelLoadHistoryEntryAge=wsRrmChannelLoadHistoryEntryAge, wsManagedAPRadioStatisticsEntry=wsManagedAPRadioStatisticsEntry, wsClientAssociationDetected=wsClientAssociationDetected, wsAssociatedClientVLAN=wsAssociatedClientVLAN, wsManagedAPVAPTspecMediumTimeAdmitted=wsManagedAPVAPTspecMediumTimeAdmitted, wsAPRadioTspecVideoAcmLimit=wsAPRadioTspecVideoAcmLimit, wsAssociatedClientBSSID=wsAssociatedClientBSSID, wsDetectedClientRoamId=wsDetectedClientRoamId, managedAP=managedAP, TspecSuppAC=TspecSuppAC, wsManagedAPTspecNumActiveTrafficStreams=wsManagedAPTspecNumActiveTrafficStreams, wsAPHardwareCapabilityTable=wsAPHardwareCapabilityTable, wsDetectedClientSentryTriangulationMacAddr=wsDetectedClientSentryTriangulationMacAddr, wsRrmChannelLoadNewRequest=wsRrmChannelLoadNewRequest, wsWidsSecurity=wsWidsSecurity, wsAPRogueClassificationStatusTable=wsAPRogueClassificationStatusTable, wsRFScanAPBSSID=wsRFScanAPBSSID, wsStationEDCATXOPLimit=wsStationEDCATXOPLimit, wsIPPollListNumOfConfigEntries=wsIPPollListNumOfConfigEntries, wsChannelPlanInterval=wsChannelPlanInterval, wsDetectedClientTriangulationNoise=wsDetectedClientTriangulationNoise, wsAssociatedClientNeighborManagedAPStatusTable=wsAssociatedClientNeighborManagedAPStatusTable, wsAuthenticatedClientChannel=wsAuthenticatedClientChannel, knownClientDatabaseLocation=knownClientDatabaseLocation, wsAPProfileRadioBasicRatesTable=wsAPProfileRadioBasicRatesTable, wsAPProfileRadioSupportedChannelsTable=wsAPProfileRadioSupportedChannelsTable, wsManagedAPVAPStatisticsEntry=wsManagedAPVAPStatisticsEntry, wsManagedVAPMacAddress=wsManagedVAPMacAddress, wsWDSAPLinkPathCost=wsWDSAPLinkPathCost, wsManagedAPVAPStatusEntry=wsManagedAPVAPStatusEntry, wsRrmChannelLoadHistoryTable=wsRrmChannelLoadHistoryTable, wsAssociatedClientTsPktsRecvd=wsAssociatedClientTsPktsRecvd, wsWDSAPStatusTable=wsWDSAPStatusTable, wsSwitchWLANPktsRecvDropped=wsSwitchWLANPktsRecvDropped, wsManagedAPLastFailingConfigElement=wsManagedAPLastFailingConfigElement, wsAssociatedClientTsPktsTransmitted=wsAssociatedClientTsPktsTransmitted, wsManagedAPVAPTspecStatusEntry=wsManagedAPVAPTspecStatusEntry, wsAPRadioNoAckMode=wsAPRadioNoAckMode, wsSwitchAssociatedClientStatusEntry=wsSwitchAssociatedClientStatusEntry, wsL2DiscoveryVlanId=wsL2DiscoveryVlanId, wsWDSConnectedAPCount=wsWDSConnectedAPCount, wsWDSSatelliteAPCount=wsWDSSatelliteAPCount, wsDetectedClientSentryTriangulationRssi=wsDetectedClientSentryTriangulationRssi, wsWDSAPEthPortLinkState=wsWDSAPEthPortLinkState, wsTriangulationLocStatusEntry=wsTriangulationLocStatusEntry, wsChannelPlanChangeThresholdAdj=wsChannelPlanChangeThresholdAdj, wsAssociatedClientIpAddress=wsAssociatedClientIpAddress, wsRFScanAPAcknowledgeRogue=wsRFScanAPAcknowledgeRogue, wsL2CentTnnlVlanRowStatus=wsL2CentTnnlVlanRowStatus, wsPeerSwitchManagedAPLimitExceeded=wsPeerSwitchManagedAPLimitExceeded, wsAssociatedClientDistTunnelStatus=wsAssociatedClientDistTunnelStatus, wsClientRogueClassificationFirstTime=wsClientRogueClassificationFirstTime, wsChannelPlanNumOfRadiosScanned=wsChannelPlanNumOfRadiosScanned, rogueStandaloneApInvalidConfig=rogueStandaloneApInvalidConfig, wsClearNetworkEntry=wsClearNetworkEntry, wsDetectedClientRoamStatus=wsDetectedClientRoamStatus, wsTotalDetectedClientRoamHistoryEntries=wsTotalDetectedClientRoamHistoryEntries, wsAPRadioTspecApInactivityTimeout=wsAPRadioTspecApInactivityTimeout, wsManagedAPRadioWLANPktsTransmitDropped=wsManagedAPRadioWLANPktsTransmitDropped, wsManagedAPNeighborAPListFull=wsManagedAPNeighborAPListFull, wsSwitchWLANTspecsAccepted=wsSwitchWLANTspecsAccepted, wsPeerConfigurationAPDatabase=wsPeerConfigurationAPDatabase, wsManagedAPFailedEntriesPurge=wsManagedAPFailedEntriesPurge, wsAdHocClientEntriesPurge=wsAdHocClientEntriesPurge, wsDetectedClientProbesDetected=wsDetectedClientProbesDetected, wsAPCodeDownloadSuccessCount=wsAPCodeDownloadSuccessCount, wsAuthenticatedClientStatusEntry=wsAuthenticatedClientStatusEntry, wsPowerPlanPerProfileTable=wsPowerPlanPerProfileTable, intrusionDetection=intrusionDetection, wsAPRadioScanDuration=wsAPRadioScanDuration, wsAPValidationMethod=wsAPValidationMethod, wsAPRadioTspecVoiceAcmMode=wsAPRadioTspecVoiceAcmMode, wsOnDemandTriggerFloorStatus=wsOnDemandTriggerFloorStatus, wsAPProfileRadioSupportedDataMode=wsAPProfileRadioSupportedDataMode, wsAdHocClientMacAddress=wsAdHocClientMacAddress, wsAPStandaloneExpectedChannel=wsAPStandaloneExpectedChannel, wsDetectedClientBcastSSIDProbes=wsDetectedClientBcastSSIDProbes, wsKnownClientName=wsKnownClientName, wsAssociatedClientDuplicatePktsRecvd=wsAssociatedClientDuplicatePktsRecvd, wsAssociatedClientQosDiffservPolicyDownType=wsAssociatedClientQosDiffservPolicyDownType, apProvisionDbAgeTime=apProvisionDbAgeTime, wsManagedAPRadioWLANBytesRecvDropped=wsManagedAPRadioWLANBytesRecvDropped, wsTriangulationLocStatusTable=wsTriangulationLocStatusTable, wsAuthenticatedClientQosCachedAccessControlDownName=wsAuthenticatedClientQosCachedAccessControlDownName, wsManagedAPVendorId=wsManagedAPVendorId, wsTotalWLANDistTunnelRoamedClients=wsTotalWLANDistTunnelRoamedClients, wsManagedVAPWLANPktsRecvd=wsManagedVAPWLANPktsRecvd, wsSwitchTspecStatusTable=wsSwitchTspecStatusTable, wsPeerConfigurationDeviceLocation=wsPeerConfigurationDeviceLocation, wsWidsApSecurity=wsWidsApSecurity, wsWDSLinkAggregationMode=wsWDSLinkAggregationMode, wsAPProvEntryPurge=wsAPProvEntryPurge, wsManagedAPFilteredARPRequest=wsManagedAPFilteredARPRequest, wsAuthenticatedClientQosDiffservPolicyUpName=wsAuthenticatedClientQosDiffservPolicyUpName, wsManagedAPRadioTspecStatisticsEntry=wsManagedAPRadioTspecStatisticsEntry, wsSwitchConnectionFailedAPs=wsSwitchConnectionFailedAPs, wsAPRogueClassificationTestId=wsAPRogueClassificationTestId, wsAPRadioSentryScanMode=wsAPRadioSentryScanMode, wsAPProfileRadioBasicDataMode=wsAPProfileRadioBasicDataMode, wsAuthenticatedClientNeighborWSManagedAPMacAddress=wsAuthenticatedClientNeighborWSManagedAPMacAddress, wsAPEDCAMinContentionWindow=wsAPEDCAMinContentionWindow, wsPowerManualProposedAdjustmentAPNewTxPower=wsPowerManualProposedAdjustmentAPNewTxPower, wsManagedAPDistTunnelHomeAPClients=wsManagedAPDistTunnelHomeAPClients, wsAssociatedClientQosStatusEntry=wsAssociatedClientQosStatusEntry, wsLocallyManagedAPLimitExceeded=wsLocallyManagedAPLimitExceeded, wsManagedAPRadioWLANPktsRecvDropped=wsManagedAPRadioWLANPktsRecvDropped, wsAPProfileRadioMCSIndexTable=wsAPProfileRadioMCSIndexTable, wsSwitchAssociatedClientMacAddress=wsSwitchAssociatedClientMacAddress, wsSupportedChannel=wsSupportedChannel, wsAPRadioTspecLegacyWmmQueueMapMode=wsAPRadioTspecLegacyWmmQueueMapMode, wsNetworkWEPKey3=wsNetworkWEPKey3, wsAssociatedClientRRMChannelLoadMeasurementSupported=wsAssociatedClientRRMChannelLoadMeasurementSupported, wsAuthenticatedClientBytesRecvd=wsAuthenticatedClientBytesRecvd, wsDetectedClientEntryLastUpdatedAt=wsDetectedClientEntryLastUpdatedAt, wsTriangLocMacAddress=wsTriangLocMacAddress, wsAuthenticatedClientSessionTransmitRetryFailedCount=wsAuthenticatedClientSessionTransmitRetryFailedCount, wsAPImageAvailabilityTable=wsAPImageAvailabilityTable, wsRrmChannelLoadNewRequestChannel=wsRrmChannelLoadNewRequestChannel, wsNetworkWPA2PreAuthenticationLimit=wsNetworkWPA2PreAuthenticationLimit, wsAssociatedClientSessionBytesRecvd=wsAssociatedClientSessionBytesRecvd, wsNetworkIdRowStatus=wsNetworkIdRowStatus, wsRFScanAPDiscoveredAge=wsRFScanAPDiscoveredAge, wsGlobalStatusRegulatoryDomainFor5GHz=wsGlobalStatusRegulatoryDomainFor5GHz, wsManagedAPProfileName=wsManagedAPProfileName, wsAPProvPrimarySwitchIP=wsAPProvPrimarySwitchIP, wsWDSAPGroupId=wsWDSAPGroupId, wsDetectedClientTriangulationSentryStatusTable=wsDetectedClientTriangulationSentryStatusTable, wsAPTriangulationId=wsAPTriangulationId, wsStationEDCAMaxContentionWindow=wsStationEDCAMaxContentionWindow, wsManagedAPRadioTspecMediumTimeRoamingUnallocated=wsManagedAPRadioTspecMediumTimeRoamingUnallocated, wsPowerAdjustmentStrength=wsPowerAdjustmentStrength, wsAPTriangulationMacAddr=wsAPTriangulationMacAddr, wsManagedAPDistTunnelRoamedClientsIdleTimedOut=wsManagedAPDistTunnelRoamedClientsIdleTimedOut, wsL2DiscoveryVlanListTable=wsL2DiscoveryVlanListTable, wsWDSAPRootDeviceType=wsWDSAPRootDeviceType, wsSupportedDataRate=wsSupportedDataRate, wsPeerSwitchAPMacAddress=wsPeerSwitchAPMacAddress, wsAssociatedClientTsMediumTime=wsAssociatedClientTsMediumTime, wsWDSLinkDestAPBytesSent=wsWDSLinkDestAPBytesSent, apProfile=apProfile, devLocMeasurementSys=devLocMeasurementSys, wsManagedAPFailedEntryPurge=wsManagedAPFailedEntryPurge, wsManagedAPRadioTspecStatusEntry=wsManagedAPRadioTspecStatusEntry, wsGlobalTspecStatus=wsGlobalTspecStatus, wsAPHWDualBootSuppport=wsAPHWDualBootSuppport, wsAPRadioUtilization=wsAPRadioUtilization)
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsNetworkClientQosMode=wsNetworkClientQosMode, wsOnDemandTriggerFloorStatusTable=wsOnDemandTriggerFloorStatusTable, wsAPLocation=wsAPLocation, wsAuthenticatedClientQosCachedBandwidthLimitDown=wsAuthenticatedClientQosCachedBandwidthLimitDown, deauthThresholdInterval=deauthThresholdInterval, wsClientAssociationFailure=wsClientAssociationFailure, wsManagedAPRadioFCSErrorCount=wsManagedAPRadioFCSErrorCount, wsClientRogueClassificationTestResult=wsClientRogueClassificationTestResult, wsGlobalStatusRegulatoryDomainFor2GHz=wsGlobalStatusRegulatoryDomainFor2GHz, wsChannelPlanAPStrongestNewManagedAPandSignal=wsChannelPlanAPStrongestNewManagedAPandSignal, wsAuthenticatedClientDot11acCapable=wsAuthenticatedClientDot11acCapable, wsAssociatedClientSessionTransmitRetryFailedCount=wsAssociatedClientSessionTransmitRetryFailedCount, tspec=tspec, wsDetectedClientSentryTriangulationAge=wsDetectedClientSentryTriangulationAge, wsManagedAPDistTunnelsTotal=wsManagedAPDistTunnelsTotal, wsAPHWTypeRadioAmodeSupport=wsAPHWTypeRadioAmodeSupport, wsAPProvCertProfileTxStatus=wsAPProvCertProfileTxStatus, wsGlobalRadiusConfiguration=wsGlobalRadiusConfiguration, wsChannelPlanAPStrongestOldSignal=wsChannelPlanAPStrongestOldSignal, wsSSIDAuthenticatedClientStatusEntry=wsSSIDAuthenticatedClientStatusEntry, wsPowerManualProposedAdjustmentAPCurrentTxPower=wsPowerManualProposedAdjustmentAPCurrentTxPower, wsNetworkRedirectURL=wsNetworkRedirectURL, wsChannelPlanAPTimeSinceLastChannelChange=wsChannelPlanAPTimeSinceLastChannelChange, wsKnownClientRowStatus=wsKnownClientRowStatus, wsManagedAPDistTunnelBytesTransmitted=wsManagedAPDistTunnelBytesTransmitted, wsNetworkUseWEPTransferKeyIndex=wsNetworkUseWEPTransferKeyIndex, wsIPPollMode=wsIPPollMode, wsAuthenticatedClientSessionStatisticsEntry=wsAuthenticatedClientSessionStatisticsEntry, wsAuthenticatedClientInactivePeriod=wsAuthenticatedClientInactivePeriod, wsDetectedClientAuthMsgsRecorded=wsDetectedClientAuthMsgsRecorded, wsAPProvisioningEntry=wsAPProvisioningEntry, wsTotalDiscoveredAPs=wsTotalDiscoveredAPs, wsOnDemandTriggerNumOfAPs=wsOnDemandTriggerNumOfAPs, rrmNeighbor=rrmNeighbor, wsAssociatedClientStatusTable=wsAssociatedClientStatusTable, PYSNMP_MODULE_ID=fastPathWLANSwitch, wsRogueClientsPresent=wsRogueClientsPresent, wsManagedVAPWLANPktsRecvDropped=wsManagedVAPWLANPktsRecvDropped, wsManagedAPMacAddress=wsManagedAPMacAddress, wsManagedAPCL2TunnelBytesRecvd=wsManagedAPCL2TunnelBytesRecvd, wsChannelPlanMode=wsChannelPlanMode, wsGlobalTspecStatisticsTable=wsGlobalTspecStatisticsTable, wsAuthenticatedSSID=wsAuthenticatedSSID, wsNetworkWEPKeyLength=wsNetworkWEPKeyLength, wsOnDemandTriggerGlobalStatusNumOfLocatorAPs=wsOnDemandTriggerGlobalStatusNumOfLocatorAPs, wsSwitchTotalClients=wsSwitchTotalClients, wsWLANBandwidthUtilizationExceeded=wsWLANBandwidthUtilizationExceeded, wsAuthenticatedClientNwTime=wsAuthenticatedClientNwTime, wsWDSGroupChangePasswdStart=wsWDSGroupChangePasswdStart, wsRrmNeighborTable=wsRrmNeighborTable, wsAPTriangulationRssi=wsAPTriangulationRssi, wsManagedAPTspecPktsRecvd=wsManagedAPTspecPktsRecvd, wsManagedAPWLANPktsRecvDropped=wsManagedAPWLANPktsRecvDropped, wsAuthenticatedClientSessionBytesTransmitted=wsAuthenticatedClientSessionBytesTransmitted, wsMACAuthenticationMode=wsMACAuthenticationMode, wsClientRogueClassificationReportingAPRadio=wsClientRogueClassificationReportingAPRadio, wsManagedAPVAPTspecMediumTimeUnallocated=wsManagedAPVAPTspecMediumTimeUnallocated, apDeauthenticationAttack=apDeauthenticationAttack, wsManagedAPRadioFixedPowerAction=wsManagedAPRadioFixedPowerAction, wsDetectedClientTriangulationRssi=wsDetectedClientTriangulationRssi, wsPowerPlanAPChannel=wsPowerPlanAPChannel, wsAPEDCAAIFS=wsAPEDCAAIFS, wsNtwProvisoningAction=wsNtwProvisoningAction, wsClientStationMacAddress=wsClientStationMacAddress, wsAPRadioRateLimit=wsAPRadioRateLimit, wsChannelPlanAPMacAddr=wsChannelPlanAPMacAddr, wsTotalWLANDistTunnelPktsTransmitted=wsTotalWLANDistTunnelPktsTransmitted, wsChannelPlanChangeThreshold=wsChannelPlanChangeThreshold, wsAuthenticatedClientBytesTransmitDropped=wsAuthenticatedClientBytesTransmitDropped, wsAuthenticatedClientPktsRecvd=wsAuthenticatedClientPktsRecvd, wsRogueAPMitigationCount=wsRogueAPMitigationCount, wsAPCodeDownloadAbortCount=wsAPCodeDownloadAbortCount, associatedClient=associatedClient, wsAssociatedClientQosCachedStatusTable=wsAssociatedClientQosCachedStatusTable, wsDetectedClientPreAuthenticationHistoryTable=wsDetectedClientPreAuthenticationHistoryTable, wsRrmNeighborAllPurge=wsRrmNeighborAllPurge, authReqTransmitRate=authReqTransmitRate, wsPowerPlanAvgNumInterferingAPs=wsPowerPlanAvgNumInterferingAPs, wsAPRadioTspecVideoAcmMode=wsAPRadioTspecVideoAcmMode, wsWDSAPLinkSourceRadio=wsWDSAPLinkSourceRadio, wsPowerPlanGlobalNumPwrDec=wsPowerPlanGlobalNumPwrDec, wsPowerPlanAPMacAddress=wsPowerPlanAPMacAddress, wsAPDeAuthenticationAttackAge=wsAPDeAuthenticationAttackAge, wsAPSentryTriangulationSentryRadio=wsAPSentryTriangulationSentryRadio, wsDetectedClientEntryPurge=wsDetectedClientEntryPurge, wsPeerConfigurationQosDiffServ=wsPeerConfigurationQosDiffServ, wsAuthenticatedClientQosDiffservPolicyUpType=wsAuthenticatedClientQosDiffservPolicyUpType, wsChannelPlanHistoryTable=wsChannelPlanHistoryTable, wsRrmNeighborRSSI=wsRrmNeighborRSSI, wsPowerManualProposedAdjustmentEntry=wsPowerManualProposedAdjustmentEntry, wsAssociatedClientSwitchIPAddress=wsAssociatedClientSwitchIPAddress, wsTotalRogueAPs=wsTotalRogueAPs, wsAssociatedClientQosBandwidthLimitDown=wsAssociatedClientQosBandwidthLimitDown, wsPeerConfigurationDiscovery=wsPeerConfigurationDiscovery, wsPowerPlanAPStrongestDetectorSignal=wsPowerPlanAPStrongestDetectorSignal, wsAssociatedClientBytesTransmitted=wsAssociatedClientBytesTransmitted, wsAllStatisticsReset=wsAllStatisticsReset, wsAuthenticatedClientRRMBeaconPassiveMeasurementSupported=wsAuthenticatedClientRRMBeaconPassiveMeasurementSupported, wsOnDemandTrigger=wsOnDemandTrigger, wsAuthenticatedClientFragmentedPktsRecvd=wsAuthenticatedClientFragmentedPktsRecvd, wsAuthenticatedClientQosBandwidthLimitUp=wsAuthenticatedClientQosBandwidthLimitUp, wsAPSentryTriangulationRssi=wsAPSentryTriangulationRssi, wsOuiEntry=wsOuiEntry, wsSwitchProvisioningCommand=wsSwitchProvisioningCommand, wsNetworkClientQosAccessControlDownName=wsNetworkClientQosAccessControlDownName, wsDetectedClientOUI=wsDetectedClientOUI, wsDistTunnelIdleTimeout=wsDistTunnelIdleTimeout, rogueManagedApInvalidSsid=rogueManagedApInvalidSsid, wsTotalWLANTspecsAccepted=wsTotalWLANTspecsAccepted, wsAssociatedClientSessionDuplicatePktsRecvd=wsAssociatedClientSessionDuplicatePktsRecvd, wsNetworkAuthRadiusServerName=wsNetworkAuthRadiusServerName, wsAPRadioTspecVoiceAcmLimit=wsAPRadioTspecVoiceAcmLimit, wsDetectedClientSentryTriangulationNoise=wsDetectedClientSentryTriangulationNoise, wsAPRadioAutoPowerMode=wsAPRadioAutoPowerMode, wsOnDemandTriggerFloorStatusSigma=wsOnDemandTriggerFloorStatusSigma, rogueManagedApNoSsid=rogueManagedApNoSsid, wsManagedAPDistTunnelsMaxMcastRepl=wsManagedAPDistTunnelsMaxMcastRepl, wsManagedAPNeighborEntriesPurge=wsManagedAPNeighborEntriesPurge, wsFailedAPAge=wsFailedAPAge, wsAPRadioMinTxPower=wsAPRadioMinTxPower, wsAPRadioTspecRoamReserveLimit=wsAPRadioTspecRoamReserveLimit, wsOnDemandTriggerFloorStatusFloorNum=wsOnDemandTriggerFloorStatusFloorNum, wsManagedAPRadioTxFragmentCount=wsManagedAPRadioTxFragmentCount, wsRFScanAPRRMSupported=wsRFScanAPRRMSupported, wsFailedAPVendorId=wsFailedAPVendorId, wsIPPollListTable=wsIPPollListTable, wsAssociatedClientQosCachedAccessControlDownName=wsAssociatedClientQosCachedAccessControlDownName, wsRFScanAPStatusInitial=wsRFScanAPStatusInitial, wsAuthenticatedClientSessionFragmentedPktsRecvd=wsAuthenticatedClientSessionFragmentedPktsRecvd, wsPeerClusterControllerIndicator=wsPeerClusterControllerIndicator, wsRFScanAPListFull=wsRFScanAPListFull, wsChannelPlanManualMacAddress=wsChannelPlanManualMacAddress, wsAPProvNewBackupSwitchIP=wsAPProvNewBackupSwitchIP, wsAPProfileTable=wsAPProfileTable, wsNetworkRedirectMode=wsNetworkRedirectMode, wsAPFailureAgeTime=wsAPFailureAgeTime, wsAssociatedClientTsAccessCategory=wsAssociatedClientTsAccessCategory, wsNetworkSSID=wsNetworkSSID, wsDetectedClientAcknowledgeAll=wsDetectedClientAcknowledgeAll, wsAPRadioSTBCMode=wsAPRadioSTBCMode, wsWidsStatusMode=wsWidsStatusMode, wsClientRoamAgeTime=wsClientRoamAgeTime, wsAuthenticatedClientDistTunnelAssocAPMac=wsAuthenticatedClientDistTunnelAssocAPMac, wsPeerManagedAPCount=wsPeerManagedAPCount, wsAuthenticatedClientPktsTransmitDropped=wsAuthenticatedClientPktsTransmitDropped, wsPowerPlanAPStrongestDetectorAP=wsPowerPlanAPStrongestDetectorAP, wsManagedAPDistTunnelMaxClientLimitSetupDenials=wsManagedAPDistTunnelMaxClientLimitSetupDenials, wsManagedAPNeighborAPListEntry=wsManagedAPNeighborAPListEntry, wsDetectedClientLastNonBcastBSSID=wsDetectedClientLastNonBcastBSSID, wsDetectedClientTriangulationNonSentryStatusEntry=wsDetectedClientTriangulationNonSentryStatusEntry, wsAPRadioMaxReceiveLifetime=wsAPRadioMaxReceiveLifetime, wsAuthenticatedClientRadioInterface=wsAuthenticatedClientRadioInterface, wsDetectedClientSpecificSSIDProbes=wsDetectedClientSpecificSSIDProbes, wsSwitchStatusEntry=wsSwitchStatusEntry, wsRFScanAPRogueMitigation=wsRFScanAPRogueMitigation, wsTotalWLANDistTunnelClientDenials=wsTotalWLANDistTunnelClientDenials, wsAPRogueClassificationMacAddr=wsAPRogueClassificationMacAddr, wsManagedAPRadioMcastTxFrameCount=wsManagedAPRadioMcastTxFrameCount, wsRrmNeighborVapMacAddr=wsRrmNeighborVapMacAddr, wsRrmChannelLoadCurrentRequestTimeRemaining=wsRrmChannelLoadCurrentRequestTimeRemaining, wsNetworkWPA2PreAuthenticationMode=wsNetworkWPA2PreAuthenticationMode, wsAPDeAuthenticationAttackChannel=wsAPDeAuthenticationAttackChannel, wsChannelPlanHistory=wsChannelPlanHistory, wsMode=wsMode, wsAPProfileRadioEntry=wsAPProfileRadioEntry, wsAssociatedClientRRMBeaconTableMeasurementSupported=wsAssociatedClientRRMBeaconTableMeasurementSupported, wsManagedAPWLANBytesTransmitDropped=wsManagedAPWLANBytesTransmitDropped, wsAssociatedClientQosDiffservPolicyUpName=wsAssociatedClientQosDiffservPolicyUpName, wsRFScanAPMacAddress=wsRFScanAPMacAddress, wsAssociatedClientTsStatisticsEntry=wsAssociatedClientTsStatisticsEntry, wsDevLocManagedApTable=wsDevLocManagedApTable, wsOnDemandTriggerFloorStatusNumOfAPs=wsOnDemandTriggerFloorStatusNumOfAPs, wsManagedAPProtocolVersion=wsManagedAPProtocolVersion, wsAuthenticatedClientStatus=wsAuthenticatedClientStatus, wsDevLocBldngRowStatus=wsDevLocBldngRowStatus, wsClientRogueClassificationTestId=wsClientRogueClassificationTestId, wsAPRadioOtherChannelsScanInterval=wsAPRadioOtherChannelsScanInterval, wsChannelPlanManualStatus=wsChannelPlanManualStatus, wsClientRogueClassificationMacAddr=wsClientRogueClassificationMacAddr, wsChannelPlanAPChannelChangeInd=wsChannelPlanAPChannelChangeInd, wsOnDemandTriggerFloorStatusSolutionType=wsOnDemandTriggerFloorStatusSolutionType, wsOnDemandTriggerDeviceMACAddress=wsOnDemandTriggerDeviceMACAddress, wsManagedAPDistTunnelRoamedClientsAgeTimedOut=wsManagedAPDistTunnelRoamedClientsAgeTimedOut, wsAPRogueClassificationDetected=wsAPRogueClassificationDetected, wsSwitchTspecStatusEntry=wsSwitchTspecStatusEntry, wsManagedAPRadioTspecNumActiveTrafficStreams=wsManagedAPRadioTspecNumActiveTrafficStreams, wsPeerStatusEntry=wsPeerStatusEntry, wsAuthenticatedClientQosBandwidthLimitDown=wsAuthenticatedClientQosBandwidthLimitDown, wsChannelPlanManual=wsChannelPlanManual, wsClientStateTrapMode=wsClientStateTrapMode, wsPowerPlanGlobalNumPwrChanges=wsPowerPlanGlobalNumPwrChanges, wsPeerSoftwareVersion=wsPeerSoftwareVersion, wsFailedAPMacAddress=wsFailedAPMacAddress, wsRrmChannelLoadCurrentRequestChannel=wsRrmChannelLoadCurrentRequestChannel, wsNetworkClientQosDiffservPolicyDownName=wsNetworkClientQosDiffservPolicyDownName, wsManagedAPEthernetMcastPktsRecvd=wsManagedAPEthernetMcastPktsRecvd, rrmChannelLoad=rrmChannelLoad, wsAuthenticatedClientQosCachedStatusEntry=wsAuthenticatedClientQosCachedStatusEntry, wsOnDemandTriggerGlobalStatusNumOfDetectedAPs=wsOnDemandTriggerGlobalStatusNumOfDetectedAPs, wsAPHardwareTypeID=wsAPHardwareTypeID, wsClientNeighborWSManagedAPRadioInterface=wsClientNeighborWSManagedAPRadioInterface, wsRrmChannelLoadHistoryEntryChannel=wsRrmChannelLoadHistoryEntryChannel, wsAPProfileRowStatus=wsAPProfileRowStatus, wsPowerPlanPerProfileAvgNumInterferingVAPs=wsPowerPlanPerProfileAvgNumInterferingVAPs, wsAssociatedClientSessionFragmentedPktsRecvd=wsAssociatedClientSessionFragmentedPktsRecvd, wsAPHardwareRadioCapabilityEntry=wsAPHardwareRadioCapabilityEntry, wsAPProfileVAPTable=wsAPProfileVAPTable, wsRFScanNewClientDetected=wsRFScanNewClientDetected, wsNetworkStaticWEPAuthenticationMode=wsNetworkStaticWEPAuthenticationMode, wsAPFailureTrapMode=wsAPFailureTrapMode, wsTotalWLANTspecBytesTransmitted=wsTotalWLANTspecBytesTransmitted, wsManagedAPHWType=wsManagedAPHWType, wsManagedVAPWLANBytesRecvDropped=wsManagedVAPWLANBytesRecvDropped, wsWDSLinkStatusTable=wsWDSLinkStatusTable, wsOnDemandTriggerGlobalStatusBuildingNumber=wsOnDemandTriggerGlobalStatusBuildingNumber, wsTotalWLANTspecPktsRecvd=wsTotalWLANTspecPktsRecvd, wsAPProfileEntry=wsAPProfileEntry, wsChannelPlanManagedAPFailureInterval=wsChannelPlanManagedAPFailureInterval, wsDetectedClientPreAuthenticationApMac=wsDetectedClientPreAuthenticationApMac, wsAuthenticatedClientPktsRecvDropped=wsAuthenticatedClientPktsRecvDropped, wsManagedAPRadioEligibleChannel=wsManagedAPRadioEligibleChannel, wsManagedAPTspecStatusEntry=wsManagedAPTspecStatusEntry, wsAPTriangulationSentryStatusTable=wsAPTriangulationSentryStatusTable, wsWDSRootAPCount=wsWDSRootAPCount, wsPeerConfigurationAPProfiles=wsPeerConfigurationAPProfiles, wsDetectedClientSentryTriangulationId=wsDetectedClientSentryTriangulationId, wsManagedAPRadioFixedPower=wsManagedAPRadioFixedPower, wsDetectedClientProbeReqRecorded=wsDetectedClientProbeReqRecorded, wsAssociatedClientSessionBytesTransmitted=wsAssociatedClientSessionBytesTransmitted, wsAPStateTrapMode=wsAPStateTrapMode, wsNetworkBcastKeyRefreshRate=wsNetworkBcastKeyRefreshRate, wsManagedAPRadioTspecPktsRecvd=wsManagedAPRadioTspecPktsRecvd, wsManagedAPRadioRTSSuccessCount=wsManagedAPRadioRTSSuccessCount, wsManagedAPTspecNumTrafficStreamClients=wsManagedAPTspecNumTrafficStreamClients, wsAPTriangulationAge=wsAPTriangulationAge, wsManagedAPRadioWLANPktsTransmitted=wsManagedAPRadioWLANPktsTransmitted, wsNetworkTable=wsNetworkTable, wsDetectedClientAuthStatus=wsDetectedClientAuthStatus, wsAPRadioQOSEDCATemplate=wsAPRadioQOSEDCATemplate, wsAPTriangulationNonSentryRadio=wsAPTriangulationNonSentryRadio, wsNetworkWPAVersionsSupported=wsNetworkWPAVersionsSupported, wsAPRogueClassificationReportingAPMac=wsAPRogueClassificationReportingAPMac, wsRrmNeighborEntry=wsRrmNeighborEntry, wsAuthenticatedClientRRMChannelLoadMeasurementSupported=wsAuthenticatedClientRRMChannelLoadMeasurementSupported, wsRrmNeighborVapPurge=wsRrmNeighborVapPurge, wsAuthenticatedClientTransmitRetryCount=wsAuthenticatedClientTransmitRetryCount, wsAuthenticatedClientFragmentedPktsTransmitted=wsAuthenticatedClientFragmentedPktsTransmitted, wsDetectedClientName=wsDetectedClientName, wsIPPollListNumOfDiscoveredFailedEntries=wsIPPollListNumOfDiscoveredFailedEntries, wsPowerPlanAPIsLocal=wsPowerPlanAPIsLocal, wsAssociatedClientTsBytesRecvd=wsAssociatedClientTsBytesRecvd, wsManagedAPRadioTspecBytesRecvd=wsManagedAPRadioTspecBytesRecvd, wsManagedAPTspecBytesRecvd=wsManagedAPTspecBytesRecvd, wsSwitchCertReqCommand=wsSwitchCertReqCommand)
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsWDSAPSTPRootMode=wsWDSAPSTPRootMode, wsAPAutoUpgradeMode=wsAPAutoUpgradeMode, wsClientStationDiscoveryReason=wsClientStationDiscoveryReason, wsOuiTable=wsOuiTable, wsWDSGroupConfigRequestAction=wsWDSGroupConfigRequestAction, wsTotalManagedAPs=wsTotalManagedAPs, wsSSIDAssociatedClientMacAddress=wsSSIDAssociatedClientMacAddress, authFailureThreshold=authFailureThreshold, wsAssociatedClientDistTunnelHomeAPMac=wsAssociatedClientDistTunnelHomeAPMac, wsDevLocManagedApMac=wsDevLocManagedApMac, wsDetectedClientMacAddress=wsDetectedClientMacAddress, wsAPAssociationFailure=wsAPAssociationFailure, wsRrmChannelLoadCurrentRequestApMacAddr=wsRrmChannelLoadCurrentRequestApMacAddr, wsClientNeighborWSManagedAPMacAddress=wsClientNeighborWSManagedAPMacAddress, wsTriangLocBldng=wsTriangLocBldng, wsAPCodeDownloadStatus=wsAPCodeDownloadStatus, wsDetectedClientPreAuthenticationHistoryPurgeAll=wsDetectedClientPreAuthenticationHistoryPurgeAll, wsManagedAPRadioNeighborCount=wsManagedAPRadioNeighborCount, wsNeighborAge=wsNeighborAge, wsAuthenticatedVAPMacAddress=wsAuthenticatedVAPMacAddress, wsAPTriangulationNonSentryStatusTable=wsAPTriangulationNonSentryStatusTable, wsWDSAPLinkTable=wsWDSAPLinkTable, wsGlobalPeerConfigSwitchIp=wsGlobalPeerConfigSwitchIp, wsAPProvBackupSwitchIP=wsAPProvBackupSwitchIP, wsNetworkExchangeCertificates=wsNetworkExchangeCertificates, wsManagedAPRadioTspecStatisticsTable=wsManagedAPRadioTspecStatisticsTable, wsChannelPlanAlgoComplete=wsChannelPlanAlgoComplete, wsManagedAPDistTunnelPacketsReceived=wsManagedAPDistTunnelPacketsReceived, wsManagedAPWLANPktsRecvd=wsManagedAPWLANPktsRecvd, wsRFScanAPAdHoc=wsRFScanAPAdHoc, wsAuthenticatedClientQosCachedAccessControlUpType=wsAuthenticatedClientQosCachedAccessControlUpType, wsSwitchCertReqTarget=wsSwitchCertReqTarget, wsOnDemandTriggerGlobalStatusSearchTime=wsOnDemandTriggerGlobalStatusSearchTime, wdsManagedAP=wdsManagedAP, wsNetworkClientQosAccessControlUpType=wsNetworkClientQosAccessControlUpType, wsTriangLocStatus=wsTriangLocStatus, wsAPSentryTriangulationAge=wsAPSentryTriangulationAge, wsManagedAPRadioFrameDuplicateCount=wsManagedAPRadioFrameDuplicateCount, wsChannelPlanAPRadioInterface=wsChannelPlanAPRadioInterface, wsManagedAPRadioRetryCount=wsManagedAPRadioRetryCount, wsVAPAuthenticatedClientStatusEntry=wsVAPAuthenticatedClientStatusEntry, wsAPTriangulationNoise=wsAPTriangulationNoise, wsManagedAPWLANPktsTransmitted=wsManagedAPWLANPktsTransmitted, wsDevLocFlrRowStatus=wsDevLocFlrRowStatus, wsOnDemandTriggerFloorStatusYCoordinate=wsOnDemandTriggerFloorStatusYCoordinate, wsRFScanAPDetected=wsRFScanAPDetected, wsDetectedClientRoamVapMac=wsDetectedClientRoamVapMac, wsWDSLinkDestAPPktsRcvd=wsWDSLinkDestAPPktsRcvd, wsAPCodeDownloadFailureCount=wsAPCodeDownloadFailureCount, wsAPMode=wsAPMode, wsManagedAPRadioBandwidth=wsManagedAPRadioBandwidth, wsTotalWLANBytesRecvDropped=wsTotalWLANBytesRecvDropped, wsSwitchMaximumManagedAPs=wsSwitchMaximumManagedAPs, wsSwitchWLANBytesRecvDropped=wsSwitchWLANBytesRecvDropped, wsManagedAPVAPTspecPktsRecvd=wsManagedAPVAPTspecPktsRecvd, wsDetectedClientLastNonBcastSSID=wsDetectedClientLastNonBcastSSID, wsAPCodeDownloadTotalCount=wsAPCodeDownloadTotalCount, wsPeerGroupId=wsPeerGroupId, wsClusterController=wsClusterController, wsManagedAPRadioACKFailureCount=wsManagedAPRadioACKFailureCount, wsNtwProvisioningTimeStamp=wsNtwProvisioningTimeStamp, wsChannelPlan=wsChannelPlan, wsTspecTotalTrafficStreamRoamingClients=wsTspecTotalTrafficStreamRoamingClients, wsWDSAPSTPCost=wsWDSAPSTPCost, wsDevLocBldngFlrDesc=wsDevLocBldngFlrDesc, wsChannelPlanNumOfRadios=wsChannelPlanNumOfRadios, wsIPPollListMaxNumOfEntries=wsIPPollListMaxNumOfEntries, wsAuthenticatedClientDot11nCapable=wsAuthenticatedClientDot11nCapable, wsAPProfileRadioTable=wsAPProfileRadioTable, probeReqTransmitRate=probeReqTransmitRate, wsPeerConfigRequestStatus=wsPeerConfigRequestStatus, wsManagedAPIpAddress=wsManagedAPIpAddress, wsAssociatedClientSessionPktsRecvDropped=wsAssociatedClientSessionPktsRecvDropped, wsPeerSwitchManagedAPEntry=wsPeerSwitchManagedAPEntry, wsDetectedClientProbeCollectionIntvl=wsDetectedClientProbeCollectionIntvl, wsManagedAPRadioFixedChannelIndicator=wsManagedAPRadioFixedChannelIndicator, wsManagedAPRadioInterface=wsManagedAPRadioInterface, wsAuthenticatedClientSessionPktsTransmitDropped=wsAuthenticatedClientSessionPktsTransmitDropped, wsAPRadioShortGuardInterval=wsAPRadioShortGuardInterval, wsRFScanAPTxRate=wsRFScanAPTxRate, wsPowerPlanAPLastPwrAdjStatus=wsPowerPlanAPLastPwrAdjStatus, wsWDSAPSatelliteMode=wsWDSAPSatelliteMode, wsAPAuthenticationFailure=wsAPAuthenticationFailure, wsRFScanAPSecurityMode=wsRFScanAPSecurityMode, wsDevLocBldngDesc=wsDevLocBldngDesc, wsWDSGroupNewPassword=wsWDSGroupNewPassword, wsAssociatedClientSessionBytesTransmitDropped=wsAssociatedClientSessionBytesTransmitDropped, wsSSIDAuthenticatedClientMacAddress=wsSSIDAuthenticatedClientMacAddress, wsDetectedClientRoamHistoryTable=wsDetectedClientRoamHistoryTable, wsWDSAPStatusEntry=wsWDSAPStatusEntry, wsAPProfileAeroScoutSupportMode=wsAPProfileAeroScoutSupportMode, wsManagedAPRadioWEPUndecryptableCount=wsManagedAPRadioWEPUndecryptableCount, wsDetectedClientPurgeAll=wsDetectedClientPurgeAll, wsRrmNeighborApPurge=wsRrmNeighborApPurge, wsManagedAPCL2TunnelPktsTransmitted=wsManagedAPCL2TunnelPktsTransmitted, wsPowerManualProposedAdjustmentAPMacAddress=wsPowerManualProposedAdjustmentAPMacAddress, wsChannelPlanEstimatedTimeOfCompletion=wsChannelPlanEstimatedTimeOfCompletion, tspecSwitch=tspecSwitch, wsAuthenticatedClientDistTunnelHomeAPMac=wsAuthenticatedClientDistTunnelHomeAPMac, wsAssociatedClientInactivePeriod=wsAssociatedClientInactivePeriod, wsManagedAPRadioFixedChannel=wsManagedAPRadioFixedChannel, wsPeerVendorId=wsPeerVendorId, wsSwitchCertReqStatus=wsSwitchCertReqStatus, wsRFScanTrapMode=wsRFScanTrapMode, wsAssociatedClientStatus=wsAssociatedClientStatus, wsOperationalStatusDisableReason=wsOperationalStatusDisableReason, wsAuthenticatedClientTxDataRate=wsAuthenticatedClientTxDataRate, wsAssociatedClientTsStatisticsTable=wsAssociatedClientTsStatisticsTable, wsChannelPlanAPStrongestNewUnmanagedAPandSignal=wsChannelPlanAPStrongestNewUnmanagedAPandSignal, wsWDSAPGroupPassword=wsWDSAPGroupPassword, wsChannelPlanAPStrongestNewSignal=wsChannelPlanAPStrongestNewSignal, wsPeerSwitchAPProfileName=wsPeerSwitchAPProfileName, wsPeerWSTrapMode=wsPeerWSTrapMode, wsAssociatedClientQosAccessControlUpName=wsAssociatedClientQosAccessControlUpName, wsRrmChannelLoadNewRequestClientMacAddr=wsRrmChannelLoadNewRequestClientMacAddr, wsTotalAPs=wsTotalAPs, wsManagedAPDistTunnelMcastPacketsReceived=wsManagedAPDistTunnelMcastPacketsReceived, wsWDSLinkDestSTPState=wsWDSLinkDestSTPState, wsAssociatedClientRRMSupported=wsAssociatedClientRRMSupported, wsPeerSwitchAPProfileId=wsPeerSwitchAPProfileId, wsManagedAPTspecNumTrafficStreamRoamingClients=wsManagedAPTspecNumTrafficStreamRoamingClients, wsTriangLocAge=wsTriangLocAge, authThresholdValue=authThresholdValue, wsAuthenticatedClientSessionBytesRecvd=wsAuthenticatedClientSessionBytesRecvd, wsAuthenticatedClientStatusTable=wsAuthenticatedClientStatusTable, wsManagedAPNeighborClientListTable=wsManagedAPNeighborClientListTable, wsAuthenticatedClientQosDiffservPolicyDownName=wsAuthenticatedClientQosDiffservPolicyDownName, wsPeerSwitchDiscovered=wsPeerSwitchDiscovered, wsWDSLinkSourceSTPState=wsWDSLinkSourceSTPState, wsPowerPlanAPTxPower=wsPowerPlanAPTxPower, wsChannelPlanManualCurrentChannel=wsChannelPlanManualCurrentChannel, wsAPProfileDisconnAPFwdingMode=wsAPProfileDisconnAPFwdingMode, wsDetectedClientPreAuthenticationId=wsDetectedClientPreAuthenticationId, wsEligibleChannelRowStatus=wsEligibleChannelRowStatus, wsChannelPlanOperatingStatus=wsChannelPlanOperatingStatus, wsAssociatedClientQosCachedStatusEntry=wsAssociatedClientQosCachedStatusEntry, wsManagedVAPWLANPktsTransmitted=wsManagedVAPWLANPktsTransmitted, wsWDSAPConnectionStatus=wsWDSAPConnectionStatus, wsWDSLinkSourceAPPktsRcvd=wsWDSLinkSourceAPPktsRcvd, wsWDSAPGroupName=wsWDSAPGroupName, wsOnDemandTriggerStatus=wsOnDemandTriggerStatus, wsManagedAPEthernetPktsRecvd=wsManagedAPEthernetPktsRecvd, wsAssociatedClientAPMacAddress=wsAssociatedClientAPMacAddress, wsAssociatedClientRRMLocationReportSupported=wsAssociatedClientRRMLocationReportSupported, wsTotalWLANPktsRecvd=wsTotalWLANPktsRecvd, wsAuthRadiusServerName=wsAuthRadiusServerName, wsAssociatedClientQosStatusTable=wsAssociatedClientQosStatusTable, wsChannelPlanPerRadioPerBandTable=wsChannelPlanPerRadioPerBandTable, wsAssociatedClientUserName=wsAssociatedClientUserName, wsSwitchProvIPAddress=wsSwitchProvIPAddress, wsManagedAPRadioFixedPowerIndicator=wsManagedAPRadioFixedPowerIndicator, wsSwitchAPImageDownloadMode=wsSwitchAPImageDownloadMode, wsAssociatedClientQosCachedDiffservPolicyDownName=wsAssociatedClientQosCachedDiffservPolicyDownName, wsManagedAPManagingSwitch=wsManagedAPManagingSwitch, wsNetworkBandSteerMode=wsNetworkBandSteerMode, wsPeerSwitchManagedAPTable=wsPeerSwitchManagedAPTable, wsIPAddress=wsIPAddress, wsAssociatedClientSessionPktsRecvd=wsAssociatedClientSessionPktsRecvd, wsAssociatedClientTsTid=wsAssociatedClientTsTid, wsRFScanAPStatusTable=wsRFScanAPStatusTable, wsWDSConfigAPCount=wsWDSConfigAPCount, wsAuthenticatedClientNeighborManagedAPStatusTable=wsAuthenticatedClientNeighborManagedAPStatusTable, wsAuthenticatedClientNetBiosName=wsAuthenticatedClientNetBiosName, wsSwitchWLANRoamingTspecsRejected=wsSwitchWLANRoamingTspecsRejected, wsClientFailureTrapMode=wsClientFailureTrapMode, wsAuthenticatedClientAssociatingSwitch=wsAuthenticatedClientAssociatingSwitch, wsOnDemandTriggerGlobalStatusNumOfDetectedFloors=wsOnDemandTriggerGlobalStatusNumOfDetectedFloors, wsDevLocManagedApYCoord=wsDevLocManagedApYCoord, wsAuthenticatedClientDuplicatePktsRecvd=wsAuthenticatedClientDuplicatePktsRecvd, wsDetectedClientHighestNumAuthMsgs=wsDetectedClientHighestNumAuthMsgs, devLocRfScanLocInterval=devLocRfScanLocInterval, wsAcctRadiusServerName=wsAcctRadiusServerName, wsAuthenticatedClientStationMacAddress=wsAuthenticatedClientStationMacAddress, wsOuiRowStatus=wsOuiRowStatus, wsManagedAPRadioFailedCount=wsManagedAPRadioFailedCount, wsNtwProvisioningPowerPlanCnt=wsNtwProvisioningPowerPlanCnt, wsManagedAPRadioRTSFailureCount=wsManagedAPRadioRTSFailureCount, wsMibVersion=wsMibVersion, wsAuthenticatedClientAge=wsAuthenticatedClientAge, wsManagedAPRadioWLANPktsRecvd=wsManagedAPRadioWLANPktsRecvd, wsPowerPlanProfileId=wsPowerPlanProfileId, wsNetworkWPAKey=wsNetworkWPAKey, wsDetectedClientSpecificBSSIDProbes=wsDetectedClientSpecificBSSIDProbes, wsDevLocFlrCount=wsDevLocFlrCount, wsAPRadioDTIMPeriod=wsAPRadioDTIMPeriod, deauthReqTransmitRate=deauthReqTransmitRate, wsNeighborMacAddress=wsNeighborMacAddress, wsChannelPlanPerRadioPerBandEntry=wsChannelPlanPerRadioPerBandEntry, wsDistTunnelMaxTimeout=wsDistTunnelMaxTimeout, wsPeerSwitchAPLocation=wsPeerSwitchAPLocation, wsClusterPriority=wsClusterPriority, wsManagedAPRadioTspecNumTrafficStreamClients=wsManagedAPRadioTspecNumTrafficStreamClients, wsManagedAPDistTunnelMaxReplSetupDenials=wsManagedAPDistTunnelMaxReplSetupDenials, wsIPPollListNumOfPolledEntries=wsIPPollListNumOfPolledEntries, wsAuthenticatedClientQosAccessControlDownType=wsAuthenticatedClientQosAccessControlDownType, wsRrmChannelLoadHistoryEntryLoad=wsRrmChannelLoadHistoryEntryLoad, wsWDSAPGroupEntry=wsWDSAPGroupEntry, wsWDSLinkSourceAPBytesRcvd=wsWDSLinkSourceAPBytesRcvd, wsWDSDestMacAddr=wsWDSDestMacAddr, wsManagedAPNeighborClientListFull=wsManagedAPNeighborClientListFull, wiredNetworkDetectionInterval=wiredNetworkDetectionInterval, wsChannelPlanType=wsChannelPlanType, wsPeerSwitchClientLimitExceeded=wsPeerSwitchClientLimitExceeded, wsAuthenticatedClientQosCachedDiffservPolicyUpName=wsAuthenticatedClientQosCachedDiffservPolicyUpName, wsGlobalPeerConfigReceivedTimestamp=wsGlobalPeerConfigReceivedTimestamp, wsRrmNeighborMacAddr=wsRrmNeighborMacAddr, wsAPRogueClassificationTestResult=wsAPRogueClassificationTestResult, wsDetectedClientAuthCollectionIntvl=wsDetectedClientAuthCollectionIntvl, wsAuthenticatedClientDistTunnelStatus=wsAuthenticatedClientDistTunnelStatus, wsValidAPConfigTable=wsValidAPConfigTable, wsAPDeAuthenticationAttackStatusId=wsAPDeAuthenticationAttackStatusId, wsRrmNeighborAge=wsRrmNeighborAge, wsStationEDCAMinContentionWindow=wsStationEDCAMinContentionWindow, wsWDSAPEthPortMode=wsWDSAPEthPortMode, wsTotalClients=wsTotalClients, wsAPProfileRadioBasicRatesEntry=wsAPProfileRadioBasicRatesEntry, wsManagedAPRadioMultipleRetryCount=wsManagedAPRadioMultipleRetryCount, wsWDSDetectedWDSLinkCount=wsWDSDetectedWDSLinkCount, wsFailedAPReportingSwitch=wsFailedAPReportingSwitch, wsDistTunnelMaxClients=wsDistTunnelMaxClients, wsAssociatedClientSessionStatisticsTable=wsAssociatedClientSessionStatisticsTable, wsOnDemandTriggerGlobalStatus=wsOnDemandTriggerGlobalStatus, devLocRfScanLocMode=devLocRfScanLocMode, wsOnDemandTriggerGlobalStatusDeviceType=wsOnDemandTriggerGlobalStatusDeviceType, wsSwitchWLANPktsTransmitted=wsSwitchWLANPktsTransmitted, wsAssociatedClientChannel=wsAssociatedClientChannel, wsRrmChannelLoadHistoryEntryId=wsRrmChannelLoadHistoryEntryId, wsAuthenticatedClientTsViolatePktsRecvd=wsAuthenticatedClientTsViolatePktsRecvd, deviceLocation=deviceLocation, wsAPRadioInterface=wsAPRadioInterface, wsManagedAPRadioTspecNumTrafficStreamRoamingClients=wsManagedAPRadioTspecNumTrafficStreamRoamingClients, wsAPRadioMaxClients=wsAPRadioMaxClients, wsManagedAPVAPTspecStatisticsTable=wsManagedAPVAPTspecStatisticsTable, wsTriangLocDeviceType=wsTriangLocDeviceType, wsNetworkClientQosAccessControlUpName=wsNetworkClientQosAccessControlUpName, wsAssociatedClientTsBytesTransmitted=wsAssociatedClientTsBytesTransmitted, wsPeerSwitchConfigurationCommandReceived=wsPeerSwitchConfigurationCommandReceived, wsAPProvisioningTable=wsAPProvisioningTable, wsSwitchWLANPktsReceived=wsSwitchWLANPktsReceived, wsAuthenticatedClientSessionBytesTransmitDropped=wsAuthenticatedClientSessionBytesTransmitDropped, wsManagedAPStatusTable=wsManagedAPStatusTable, wsUseNetworkRadiusConfig=wsUseNetworkRadiusConfig, wsAPImageFilePath=wsAPImageFilePath, wsWDSAPGroupSpanningTree=wsWDSAPGroupSpanningTree, wsManagedVAPId=wsManagedVAPId, wsSwitchWLANTspecsRejected=wsSwitchWLANTspecsRejected, wsWDSBlockedWDSLinkCount=wsWDSBlockedWDSLinkCount, wsSwitchStatisticsTable=wsSwitchStatisticsTable, wsAuthenticatedClientSSID=wsAuthenticatedClientSSID, wsWDSAPLinkEntry=wsWDSAPLinkEntry, wsNeighborStatus=wsNeighborStatus, wsAuthenticatedClientRRMBeaconActiveMeasurementSupported=wsAuthenticatedClientRRMBeaconActiveMeasurementSupported, rogueFakeManagedApManagedSsid=rogueFakeManagedApManagedSsid, wsAPDeAuthenticationAttackStatusEntry=wsAPDeAuthenticationAttackStatusEntry)
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsDetectedClientAgeTime=wsDetectedClientAgeTime, wsDetectedClientThreatMitigationSent=wsDetectedClientThreatMitigationSent, wsDetectedClientSentryTriangulationSentryRadio=wsDetectedClientSentryTriangulationSentryRadio, rogueManagedSsidInvalidSecurity=rogueManagedSsidInvalidSecurity, wsAuthenticatedClientSessionStatisticsTable=wsAuthenticatedClientSessionStatisticsTable, wsDetectedClientTriangulationNonSentryMacAddr=wsDetectedClientTriangulationNonSentryMacAddr, wsPeerConfigSwitchIp=wsPeerConfigSwitchIp, wsDetectedClientEntryAcknowledge=wsDetectedClientEntryAcknowledge, wsAssociatedClientDistTunnelRoamStatus=wsAssociatedClientDistTunnelRoamStatus, wsOnDemandTriggerGlobalStatusFloorNumber=wsOnDemandTriggerGlobalStatusFloorNumber, wsPowerPlanAPStrongestDetectedNeighbor=wsPowerPlanAPStrongestDetectedNeighbor, wsChannelPlanPercentageComplete=wsChannelPlanPercentageComplete, wsAdHocClientDetectionMode=wsAdHocClientDetectionMode, wsOnDemandTriggerGlobalStatusCurrentStatus=wsOnDemandTriggerGlobalStatusCurrentStatus, wsNetworkDefaultVLANId=wsNetworkDefaultVLANId, wsDevLocBldngNum=wsDevLocBldngNum, wsManagedVAPSSID=wsManagedVAPSSID, wsAssociatedClientPktsRecvDropped=wsAssociatedClientPktsRecvDropped, wsNetworkWEPKeyType=wsNetworkWEPKeyType, wsDetectedClientRoamHistoryEntry=wsDetectedClientRoamHistoryEntry, wsAuthenticatedClientSessionTSViolatePktsTransmitted=wsAuthenticatedClientSessionTSViolatePktsTransmitted, wsManagedAPRadioWLANBytesRecvd=wsManagedAPRadioWLANBytesRecvd, wsSwitchIPAddress=wsSwitchIPAddress, wsSwitchAuthenticatedClientMacAddress=wsSwitchAuthenticatedClientMacAddress, wsWidsClientSecurity=wsWidsClientSecurity, wsAssociatedClientQosCachedAccessControlUpName=wsAssociatedClientQosCachedAccessControlUpName, wsWDSAPGroupAPEntry=wsWDSAPGroupAPEntry, wsAdHocClientListFull=wsAdHocClientListFull, wsClientDisassociationDetected=wsClientDisassociationDetected, wsAPProfileRadioSupportedRatesEntry=wsAPProfileRadioSupportedRatesEntry, wsAPStandaloneExpectedWired=wsAPStandaloneExpectedWired, wsManagedAPRadioRecvdFragmentCount=wsManagedAPRadioRecvdFragmentCount, wsAPSentryTriangulationStrength=wsAPSentryTriangulationStrength, wsPeerStatusTable=wsPeerStatusTable, wsAPRadioSentryScanChannel=wsAPRadioSentryScanChannel, wsMibInfo=wsMibInfo, wsAuthenticatedClientUserName=wsAuthenticatedClientUserName, wsUseAPProfileId=wsUseAPProfileId, wsL2CentTnnlVlanId=wsL2CentTnnlVlanId, wsManagedAPRadioTspecBytesTransmitted=wsManagedAPRadioTspecBytesTransmitted, wsAssociatedClientQosOperStatus=wsAssociatedClientQosOperStatus, wsGlobalPeerConfigRequestAction=wsGlobalPeerConfigRequestAction, wsPeerSwitchAPHardwareType=wsPeerSwitchAPHardwareType, wsDetectedClientSentryTriangulationSentryMacAddr=wsDetectedClientSentryTriangulationSentryMacAddr, wsOnDemandTriggerFloorNumber=wsOnDemandTriggerFloorNumber, wsAPRadioStationIsolationMode=wsAPRadioStationIsolationMode, rogueAdminConfig=rogueAdminConfig, wsTotalDetectedClientPreAuthenticationHistoryEntries=wsTotalDetectedClientPreAuthenticationHistoryEntries, wsNetworkMutualAuthenticationStatus=wsNetworkMutualAuthenticationStatus, wsAuthenticatedClientQosStatusEntry=wsAuthenticatedClientQosStatusEntry, wsChannelPlanAPReasonCode=wsChannelPlanAPReasonCode, wsDetectedClientListFull=wsDetectedClientListFull, wsAPProfileRadioEligibleChannelsTable=wsAPProfileRadioEligibleChannelsTable, wsAssociatedClientQosCachedDiffservPolicyUpName=wsAssociatedClientQosCachedDiffservPolicyUpName, wsClientRogueClassificationTestName=wsClientRogueClassificationTestName, wsMaximumDetectedClientPreAuthenticationHistoryEntries=wsMaximumDetectedClientPreAuthenticationHistoryEntries, wsManagedAPDiscoveryReason=wsManagedAPDiscoveryReason, wsAutoIPAssignMode=wsAutoIPAssignMode, wsChannelPlanNumOfRadiosChangedToOrigChannel=wsChannelPlanNumOfRadiosChangedToOrigChannel, wsDetectedClientRoamHistoryPurgeAll=wsDetectedClientRoamHistoryPurgeAll, wsManagedAPReset=wsManagedAPReset, wsAPImageAvailabilityEntry=wsAPImageAvailabilityEntry, wsTotalWLANBytesRecvd=wsTotalWLANBytesRecvd, wsPeerSwitchUnknownProtocol=wsPeerSwitchUnknownProtocol, wsManagedAPAuthenticatedClients=wsManagedAPAuthenticatedClients, wsChannelPlanAPChannel=wsChannelPlanAPChannel, wsDetectedClientAuthRSSI=wsDetectedClientAuthRSSI, wsAPTriangulationNonSentryMacAddr=wsAPTriangulationNonSentryMacAddr, wsAuthenticatedClientNeighborManagedAPStatusEntry=wsAuthenticatedClientNeighborManagedAPStatusEntry, snmpTrapsConfig=snmpTrapsConfig, wsManagedAPRadioWLANBytesTransmitted=wsManagedAPRadioWLANBytesTransmitted, wsManagedAPRadioAuthenticatedClients=wsManagedAPRadioAuthenticatedClients, wsAssociatedClientQosCachedBandwidthLimitDown=wsAssociatedClientQosCachedBandwidthLimitDown, wsAPCodeDownloadAbort=wsAPCodeDownloadAbort, wsAPRadioTspecMode=wsAPRadioTspecMode, wsPeerIpAddress=wsPeerIpAddress, wsAPCodeDownloadServerIP=wsAPCodeDownloadServerIP, wsTraps=wsTraps, wsTotalWLANTspecsRejected=wsTotalWLANTspecsRejected, wsTotalStandaloneAPs=wsTotalStandaloneAPs, wsVAPNetworkId=wsVAPNetworkId, wsAdHocClientAgeTime=wsAdHocClientAgeTime, wsRrmChannelLoadCurrentRequest=wsRrmChannelLoadCurrentRequest, wsManagedAPEthernetPktsTransmitted=wsManagedAPEthernetPktsTransmitted, wsWDSAPGroupAPEntryRowStatus=wsWDSAPGroupAPEntryRowStatus, wsAssociatedClientTransmitRetryCount=wsAssociatedClientTransmitRetryCount, wsOnDemandTriggerUseRadios=wsOnDemandTriggerUseRadios, wsVAPAuthenticatedClientStatusTable=wsVAPAuthenticatedClientStatusTable, wsAPRadioMaxTransmitLifetime=wsAPRadioMaxTransmitLifetime, wsAPConfigRowStatus=wsAPConfigRowStatus, wsAuthenticatedClientQosCachedAccessControlDownType=wsAuthenticatedClientQosCachedAccessControlDownType, wsAPRadio2Channel=wsAPRadio2Channel, wsManagedAPPartNumber=wsManagedAPPartNumber, wsAPRadio1Channel=wsAPRadio1Channel, wsAssociatedClientSwitchIpAddress=wsAssociatedClientSwitchIpAddress, wsAssociatedClientPktsRecvd=wsAssociatedClientPktsRecvd, wsAssociatedClientFragmentedPktsRecvd=wsAssociatedClientFragmentedPktsRecvd, wsManagedAPDiscovered=wsManagedAPDiscovered, wsSwitchAssociatedClientStatusTable=wsSwitchAssociatedClientStatusTable, wsSwitchWLANBytesTransmitDropped=wsSwitchWLANBytesTransmitDropped, wsSwitchAuthenticatedClientStatusTable=wsSwitchAuthenticatedClientStatusTable, wsRogueAPMitigationLimit=wsRogueAPMitigationLimit, wsManagedVAPWLANPktsTransmitDropped=wsManagedVAPWLANPktsTransmitDropped, networkMutualAuthMode=networkMutualAuthMode, wsGlobalPeerConfigRequestStatus=wsGlobalPeerConfigRequestStatus, wsManagedAPTspecStatusTable=wsManagedAPTspecStatusTable, wsRrmNeighborSSID=wsRrmNeighborSSID, wsAPRadioLoadBalancingMode=wsAPRadioLoadBalancingMode, authThresholdInterval=authThresholdInterval, wsAssociatedClientTsRoamingClientIndicator=wsAssociatedClientTsRoamingClientIndicator, wsAPProvisioningInitiateAll=wsAPProvisioningInitiateAll, wsAPRogueClassificationLastTime=wsAPRogueClassificationLastTime, wsTotalWLANRoamingTspecsRejected=wsTotalWLANRoamingTspecsRejected, wsFailedAPSoftwareVersion=wsFailedAPSoftwareVersion, wsAPEDCAMaxContentionWindow=wsAPEDCAMaxContentionWindow, wsPowerPlanAPNumPwrInc=wsPowerPlanAPNumPwrInc, wsAPRadioBeaconInterval=wsAPRadioBeaconInterval, apCodeDownload=apCodeDownload, wsNetworkDenyBcastMode=wsNetworkDenyBcastMode, wsDistTunnelMaxMcastRepl=wsDistTunnelMaxMcastRepl, wsRogueAPTrapMode=wsRogueAPTrapMode, wsManagedAPDistTunnelPacketsTransmitted=wsManagedAPDistTunnelPacketsTransmitted, wsAPProfileRadioSupportedChannelsEntry=wsAPProfileRadioSupportedChannelsEntry, wsAuthenticatedClientAPMacAddress=wsAuthenticatedClientAPMacAddress, wsAPRadioAdminMode=wsAPRadioAdminMode, wsManagedAPBroadcastedARPRequests=wsManagedAPBroadcastedARPRequests, wsAssociatedClientMacAddress=wsAssociatedClientMacAddress, wsAuthenticatedClientSwitchIPAddress=wsAuthenticatedClientSwitchIPAddress, wsAPRadioRateLimitMode=wsAPRadioRateLimitMode, wsAPProfileRadioTspecTable=wsAPProfileRadioTspecTable, wsPowerPlanPerRadioEntry=wsPowerPlanPerRadioEntry, wsAPImageFileName=wsAPImageFileName, wsWDSAPEthPortSTPStatus=wsWDSAPEthPortSTPStatus, wsManagedAPTspecBytesTransmitted=wsManagedAPTspecBytesTransmitted, wsAPSentryTriangulationNoise=wsAPSentryTriangulationNoise, wsClientAssociationDatabaseFull=wsClientAssociationDatabaseFull, wsNetworkHideSSIDMode=wsNetworkHideSSIDMode, wsNeighborClientMacAddress=wsNeighborClientMacAddress, wsSwitchWLANTspecBytesTransmitted=wsSwitchWLANTspecBytesTransmitted, wsL2CentTnnlVlanListTable=wsL2CentTnnlVlanListTable, wsManagedAPARPReqsFromBcastToUcast=wsManagedAPARPReqsFromBcastToUcast, wsPowerPlanOperatingStatus=wsPowerPlanOperatingStatus, wsManagedAPStatusEntry=wsManagedAPStatusEntry, wsAssociatedClientTsStatusTable=wsAssociatedClientTsStatusTable, wsDetectedClientPreAuthenticationStatus=wsDetectedClientPreAuthenticationStatus, wsMaximumProvisioningAPs=wsMaximumProvisioningAPs, wsAssociatedClientBytesRecvDropped=wsAssociatedClientBytesRecvDropped, wsManagedAPWLANBytesRecvd=wsManagedAPWLANBytesRecvd, wsCountryCode=wsCountryCode, rogueUnmanagedApWiredNetwork=rogueUnmanagedApWiredNetwork, wsTotalWLANPktsTransmitDropped=wsTotalWLANPktsTransmitDropped, wsPowerPlanAPRadioInterface=wsPowerPlanAPRadioInterface, wsWDSAPGroupStatusEntry=wsWDSAPGroupStatusEntry, wsAuthenticatedClientQosAccessControlDownName=wsAuthenticatedClientQosAccessControlDownName, wsAssociatedClientBytesTransmitDropped=wsAssociatedClientBytesTransmitDropped, wsManagedAPVAPTspecBytesTransmitted=wsManagedAPVAPTspecBytesTransmitted, wsAuthenticatedClientDistTunnelRoamStatus=wsAuthenticatedClientDistTunnelRoamStatus, wsSwitchWLANBytesReceived=wsSwitchWLANBytesReceived, wsSwitchDistTunnelClients=wsSwitchDistTunnelClients, wsManagedAPWLANBytesRecvDropped=wsManagedAPWLANBytesRecvDropped, wsAuthenticatedClientRRMSupported=wsAuthenticatedClientRRMSupported, wsAssociatedClientTsDirection=wsAssociatedClientTsDirection, wsModeEnabled=wsModeEnabled, wsAcctRadiusServerConfiguredStatus=wsAcctRadiusServerConfiguredStatus, wsChannelPlanAPIsLocal=wsChannelPlanAPIsLocal, provisioning=provisioning, wsSwitchWLANBytesTransmitted=wsSwitchWLANBytesTransmitted, wsRFScanAPChannel=wsRFScanAPChannel, wsOnDemandTriggerBuildingNumber=wsOnDemandTriggerBuildingNumber, switchProvisioning=switchProvisioning, wsAuthenticatedClientQosCachedDiffservPolicyUpType=wsAuthenticatedClientQosCachedDiffservPolicyUpType, wsSwitchTotalAPs=wsSwitchTotalAPs, wsAssociatedClientSessionFragmentedPktsTransmitted=wsAssociatedClientSessionFragmentedPktsTransmitted, wsNetworkAuthRadiusServerConfiguredStatus=wsNetworkAuthRadiusServerConfiguredStatus, wsAssociatedClientSessionTSViolatePktsTransmitted=wsAssociatedClientSessionTSViolatePktsTransmitted, wsVAPMacAddress=wsVAPMacAddress, wsTriangLocYCoord=wsTriangLocYCoord, wsAuthenticatedClientSessionFragmentedPktsTransmitted=wsAuthenticatedClientSessionFragmentedPktsTransmitted, wsAPFailureListFull=wsAPFailureListFull, wsNetworkSessionKeyRefreshRate=wsNetworkSessionKeyRefreshRate, wsRFScanAPPeerManaged=wsRFScanAPPeerManaged, wsAPRogueClassificationFirstTime=wsAPRogueClassificationFirstTime, wsTotalWLANRoamingTspecsAccepted=wsTotalWLANRoamingTspecsAccepted, wsManagedAPDatabaseFull=wsManagedAPDatabaseFull, wsWDSLinkSourceEndPointDetected=wsWDSLinkSourceEndPointDetected, wsRFScanAPStatus=wsRFScanAPStatus, wsChannelPlanNumOfRadiosAnalysed=wsChannelPlanNumOfRadiosAnalysed, wsWDSConfigWDSLinkCount=wsWDSConfigWDSLinkCount, wsWDSAPLinkDestMacAddr=wsWDSAPLinkDestMacAddr, wsManagedAPCL2TunnelMcastTransmitted=wsManagedAPCL2TunnelMcastTransmitted, wsPowerPlanGlobalNumPwrInc=wsPowerPlanGlobalNumPwrInc, wsAPProfileState=wsAPProfileState, wsPeerDiscoveryReason=wsPeerDiscoveryReason, wsManagedAPRadioTspecOperStatus=wsManagedAPRadioTspecOperStatus, wsOnDemandTriggerDeviceType=wsOnDemandTriggerDeviceType, wsDetectedClientThreatDetectedStatus=wsDetectedClientThreatDetectedStatus, wsAssociatedClientQosCachedDiffservPolicyDownType=wsAssociatedClientQosCachedDiffservPolicyDownType, wsManagedAPSwitchMacAddress=wsManagedAPSwitchMacAddress, wsAuthenticatedClientSessionPktsTransmitted=wsAuthenticatedClientSessionPktsTransmitted, wsChannelPlanRunOnManagedApFailure=wsChannelPlanRunOnManagedApFailure, wsManagedAPNeighborAPListTable=wsManagedAPNeighborAPListTable, wsSwitchTspecTotalVoiceTrafficStreams=wsSwitchTspecTotalVoiceTrafficStreams, wsRadiusConfiguration=wsRadiusConfiguration, wsTspecViolationReportInterval=wsTspecViolationReportInterval, wsWDSAPLinkRowStatus=wsWDSAPLinkRowStatus, wsAPHWTypeRadioNum=wsAPHWTypeRadioNum, wsDevLocMeasurementUnit=wsDevLocMeasurementUnit, wsAuthenticatedClientBytesTransmitted=wsAuthenticatedClientBytesTransmitted, wsAssociatedClientRadioInterface=wsAssociatedClientRadioInterface, wsManagedAPRadioMcastRecvdFrameCount=wsManagedAPRadioMcastRecvdFrameCount, wsManagedAPEthernetBytesRecvd=wsManagedAPEthernetBytesRecvd, rogueApIllegalChannel=rogueApIllegalChannel, wsManagedAPRadioTspecStatusTable=wsManagedAPRadioTspecStatusTable, wsManagedAPIpMask=wsManagedAPIpMask, wsAPRadio1TxPower=wsAPRadio1TxPower, wsPeerAge=wsPeerAge, wsIpBasePort=wsIpBasePort, wsNetworkClientQosDiffservPolicyUpType=wsNetworkClientQosDiffservPolicyUpType, wsAPImageTypeFileEntry=wsAPImageTypeFileEntry, peerSwitch=peerSwitch, wsManagedAPRadioTspecMediumTimeAdmitted=wsManagedAPRadioTspecMediumTimeAdmitted, wsAPProfileVAPEntry=wsAPProfileVAPEntry, wsDevLocBldngTable=wsDevLocBldngTable, wsAPProfileQOSEntry=wsAPProfileQOSEntry, wsAssociatedClientSessionPktsTransmitDropped=wsAssociatedClientSessionPktsTransmitDropped, wsPeerConfiguration=wsPeerConfiguration, wsAPRadioRTSThreshold=wsAPRadioRTSThreshold, wsDetectedClientStatus=wsDetectedClientStatus, wsWDSLinkDestEndPointDetected=wsWDSLinkDestEndPointDetected, wsRFScanAgeTime=wsRFScanAgeTime, wsAssociatedClientFragmentedPktsTransmitted=wsAssociatedClientFragmentedPktsTransmitted, wsNetworkWPACipherSuites=wsNetworkWPACipherSuites, wsDetectedClientAuthFailures=wsDetectedClientAuthFailures, wsManagedAPRadioEligibleChannelListTable=wsManagedAPRadioEligibleChannelListTable, wsRegenerateX509CertificateAction=wsRegenerateX509CertificateAction, wsPowerPlanAvgNumInterferingVAPs=wsPowerPlanAvgNumInterferingVAPs, wsKnownClientTable=wsKnownClientTable, wsAuthenticatedClientMacAddress=wsAuthenticatedClientMacAddress, wsAPRogueClassificationTestName=wsAPRogueClassificationTestName, wsSwitchTspecTotalTrafficStreamRoamingClients=wsSwitchTspecTotalTrafficStreamRoamingClients, wsManagedAPRadioMacAddress=wsManagedAPRadioMacAddress, wsManagedAPProfileId=wsManagedAPProfileId, wsPowerPlanAPNumPwrCycles=wsPowerPlanAPNumPwrCycles, wsWDSLinkStatusEntry=wsWDSLinkStatusEntry, wsAssociatedClientQosDiffservPolicyUpType=wsAssociatedClientQosDiffservPolicyUpType, wsAPAuthenticationMode=wsAPAuthenticationMode, wsL2DiscoveryVlanListEntry=wsL2DiscoveryVlanListEntry, wsAuthenticatedClientSwitchMacAddress=wsAuthenticatedClientSwitchMacAddress, wsRFScanAPRadioInterface=wsRFScanAPRadioInterface, wsAuthenticatedClientQosDiffservPolicyDownType=wsAuthenticatedClientQosDiffservPolicyDownType, wsRegenerateX509CertificateStatus=wsRegenerateX509CertificateStatus, wsSwitchProvStatus=wsSwitchProvStatus, wsDetectedClientAuthNoise=wsDetectedClientAuthNoise, wsPowerManualProposedAdjustmentAction=wsPowerManualProposedAdjustmentAction)
mibBuilder.exportSymbols("AT-UWC-WLAN-SWITCH-MIB", wsPowerPlanAPLastPwrAdjReasonCode=wsPowerPlanAPLastPwrAdjReasonCode, wsClientRogueClassificationDetected=wsClientRogueClassificationDetected, wsAssociatedClientPktsTransmitted=wsAssociatedClientPktsTransmitted, wsManagedAPSerialNumber=wsManagedAPSerialNumber, wsGlobalPeerConfigReceiveStatus=wsGlobalPeerConfigReceiveStatus, wsAllStatisticsResetStatus=wsAllStatisticsResetStatus, wsAssociatedClientQosCachedAccessControlDownType=wsAssociatedClientQosCachedAccessControlDownType, wsAssociatedClientSessionBytesRecvDropped=wsAssociatedClientSessionBytesRecvDropped, wsTotalConnectionFailedAPs=wsTotalConnectionFailedAPs, wsDetectedClientBcastBSSIDProbes=wsDetectedClientBcastBSSIDProbes, wsPowerPlanNumPwrDec=wsPowerPlanNumPwrDec, wsTspecACIndex=wsTspecACIndex, wsManagedAPVAPTspecNumTrafficStreamRoamingClients=wsManagedAPVAPTspecNumTrafficStreamRoamingClients, wsClientRoamDetected=wsClientRoamDetected, wsManagedAPResetAll=wsManagedAPResetAll, wsAPRadioMCSIndexAvailable=wsAPRadioMCSIndexAvailable, wsPeerConfigurationKnownClients=wsPeerConfigurationKnownClients, wsAssociatedClientQosCachedAccessControlUpType=wsAssociatedClientQosCachedAccessControlUpType, wsDetectedClientHighestNumProbes=wsDetectedClientHighestNumProbes, wsManagedAPRadioMPAStatus=wsManagedAPRadioMPAStatus, wsManagedVAPWLANBytesTransmitted=wsManagedVAPWLANBytesTransmitted, wsVAPAuthenticatedClientMacAddress=wsVAPAuthenticatedClientMacAddress, wsL2DiscoveryVlanRowStatus=wsL2DiscoveryVlanRowStatus, wsAPImageTypeCapabilityEntry=wsAPImageTypeCapabilityEntry, wsRrmChannelLoadHistoryEntry=wsRrmChannelLoadHistoryEntry, wsIPPollListEntry=wsIPPollListEntry, wsAPProvIPAddress=wsAPProvIPAddress, wsMaximumManagedAPsInPeerGroup=wsMaximumManagedAPsInPeerGroup, wsPeerSwitchAPIPAddress=wsPeerSwitchAPIPAddress, wsGlobalTspecConfiguration=wsGlobalTspecConfiguration, wsPollIpAddress=wsPollIpAddress, wsAPTriangulationStrength=wsAPTriangulationStrength, wsPowerPlanPerProfileEntry=wsPowerPlanPerProfileEntry, wsCopyAPProfileToProfileId=wsCopyAPProfileToProfileId, wsSwitchWLANUtilization=wsSwitchWLANUtilization, wsTotalWLANTspecBytesRecvd=wsTotalWLANTspecBytesRecvd, discovery=discovery, wsRrmChannelLoadCurrentRequestClientMacAddr=wsRrmChannelLoadCurrentRequestClientMacAddr, wsDetectedClientTriangulationNonSentryStatusTable=wsDetectedClientTriangulationNonSentryStatusTable, wsManagedAPDebugPassword=wsManagedAPDebugPassword, wsSSIDAssociatedClientStatusEntry=wsSSIDAssociatedClientStatusEntry, wsOnDemandTriggerGlobalStatusHighestSignalFoundFloor=wsOnDemandTriggerGlobalStatusHighestSignalFoundFloor, wsDetectedClientTriangulationNonSentryRadio=wsDetectedClientTriangulationNonSentryRadio, wsDetectedClientRoamApRadioId=wsDetectedClientRoamApRadioId, wsRFScanAPSSID=wsRFScanAPSSID, wsWDSAPLinkDestRadio=wsWDSAPLinkDestRadio, wsPeerConfigurationGlobal=wsPeerConfigurationGlobal, wsAPProfileQOSTable=wsAPProfileQOSTable, wsL2CentTnnlVlanListEntry=wsL2CentTnnlVlanListEntry, wsGlobalConfig=wsGlobalConfig, wsRrmChannelLoadHistoryEntryClientMacAddr=wsRrmChannelLoadHistoryEntryClientMacAddr, wsAdHocClientDetected=wsAdHocClientDetected, wsManagedAPRadioTxPower=wsManagedAPRadioTxPower, wsDetectedAPMacAddress=wsDetectedAPMacAddress, wsRrmChannelLoadCurrentRequestAbort=wsRrmChannelLoadCurrentRequestAbort, wsMaximumDetectedClients=wsMaximumDetectedClients, wsRFScanRogueAPDetected=wsRFScanRogueAPDetected, wsWDSLinkSourceAPBytesSent=wsWDSLinkSourceAPBytesSent, wsWDSAPMacAddr=wsWDSAPMacAddr, wsAPDeAuthenticationAttackTime=wsAPDeAuthenticationAttackTime, wsTriangLocFlr=wsTriangLocFlr, wsPowerPlanPerProfileAvgNumInterferingAPs=wsPowerPlanPerProfileAvgNumInterferingAPs, wsIPPollListNumOfNotPolledEntries=wsIPPollListNumOfNotPolledEntries, wsVAPMode=wsVAPMode, wsManagedAPRadioStatusTable=wsManagedAPRadioStatusTable, wsOnDemandTriggerGlobalStatusHighestSignalFoundBuilding=wsOnDemandTriggerGlobalStatusHighestSignalFoundBuilding, wsVAPAssociatedClientStatusEntry=wsVAPAssociatedClientStatusEntry, wsAPProvNewProfileId=wsAPProvNewProfileId, wsDetectedClientRoamAge=wsDetectedClientRoamAge, wsWDSLinkDestAPBytesRcvd=wsWDSLinkDestAPBytesRcvd, wsNetworkRadiusAccountingMode=wsNetworkRadiusAccountingMode, wsManagedAPCL2TunnelMcastRecvd=wsManagedAPCL2TunnelMcastRecvd, wsWDSSourceRadio=wsWDSSourceRadio, wsClusterMaxAPExceeded=wsClusterMaxAPExceeded, wsChannelPlanEntry=wsChannelPlanEntry, wsOperationalStatus=wsOperationalStatus, wsNtwProvisioningOperatingStatus=wsNtwProvisioningOperatingStatus, wsSSID=wsSSID, wsDevLocManagedApRowStatus=wsDevLocManagedApRowStatus, wsAPRadioResourceMeasEnabled=wsAPRadioResourceMeasEnabled, wsPowerPlanAPNumPwrDec=wsPowerPlanAPNumPwrDec, wsAuthenticatedClientTransmitRetryFailedCount=wsAuthenticatedClientTransmitRetryFailedCount, wsDetectedClientTriangulationStrength=wsDetectedClientTriangulationStrength, wsWDSAPGroupTable=wsWDSAPGroupTable, wsDetectedClientSentryTriangulationStrength=wsDetectedClientSentryTriangulationStrength, wsRFScanAPHighRate=wsRFScanAPHighRate, wsWDSDestRadio=wsWDSDestRadio, wsNeighborClientChannel=wsNeighborClientChannel, wsChannelPlanIgnoreUnamangedAPs=wsChannelPlanIgnoreUnamangedAPs, wsAssociatedClientStbcCapable=wsAssociatedClientStbcCapable, wsFailedAPSwitchIpAddress=wsFailedAPSwitchIpAddress, wsAPCodeDownloadMACAddress=wsAPCodeDownloadMACAddress, wsManagedAPRadioFixedChannelAction=wsManagedAPRadioFixedChannelAction, wsAPRadioOtherChannelsScanMode=wsAPRadioOtherChannelsScanMode, wsOnDemandTriggerGlobalStatusDeviceMACAddress=wsOnDemandTriggerGlobalStatusDeviceMACAddress, wsBasicDataRate=wsBasicDataRate, wsWDSAPLinkSourceMacAddr=wsWDSAPLinkSourceMacAddr, wsAssociatedClientSessionTSViolatePktsRecvd=wsAssociatedClientSessionTSViolatePktsRecvd, wsOuiDatabase=wsOuiDatabase, wsNetworkEntry=wsNetworkEntry, wsAuthenticatedClientPktsTransmitted=wsAuthenticatedClientPktsTransmitted, wsFailedAPProtocolVersion=wsFailedAPProtocolVersion, wsManagedAPTspecStatisticsTable=wsManagedAPTspecStatisticsTable, wsManagedVAPAssociationFailures=wsManagedVAPAssociationFailures, wsManagedAPTspecStatisticsEntry=wsManagedAPTspecStatisticsEntry, wsChannelPlanAPHistoryIteration=wsChannelPlanAPHistoryIteration, wsAPRadioShortRetryLimit=wsAPRadioShortRetryLimit, wsOnDemandTriggerFloorStatusEntry=wsOnDemandTriggerFloorStatusEntry, wsAPRadioProtectionMode=wsAPRadioProtectionMode, wsManagedAPCL2TunnelPktsRecvd=wsManagedAPCL2TunnelPktsRecvd, wsAuthenticatedClientStatisticsEntry=wsAuthenticatedClientStatisticsEntry, wsAPSentryTriangulationSentryMacAddr=wsAPSentryTriangulationSentryMacAddr, wsTriangLocDataType=wsTriangLocDataType, wsTotalWLANTspecPktsTransmitted=wsTotalWLANTspecPktsTransmitted, wsAssociatedClientSSID=wsAssociatedClientSSID, wsAPDeAuthenticationAttackStatusTable=wsAPDeAuthenticationAttackStatusTable, wsSSIDAuthenticatedClientStatusTable=wsSSIDAuthenticatedClientStatusTable, wsDetectedClientPreAuthenticationApRadioId=wsDetectedClientPreAuthenticationApRadioId, wsClientAuthenticationFailure=wsClientAuthenticationFailure, wsPowerPlanAPStrongestDetectedSignal=wsPowerPlanAPStrongestDetectedSignal, wsAPHWTypeID=wsAPHWTypeID, wsTotalDetectedClients=wsTotalDetectedClients, wsPeerConfigRequestAction=wsPeerConfigRequestAction, wsChannelPlanManualProposedAdjustmentEntry=wsChannelPlanManualProposedAdjustmentEntry, wsAPHWTypeRadioCount=wsAPHWTypeRadioCount, wsAssociatedClientTunnelIpAddress=wsAssociatedClientTunnelIpAddress, wsAuthenticatedClientSessionBytesRecvDropped=wsAuthenticatedClientSessionBytesRecvDropped, wsClientRogueClassificationStatusEntry=wsClientRogueClassificationStatusEntry, wsDetectedClientPreAuthenticationAge=wsDetectedClientPreAuthenticationAge, wsManagedAPVAPTspecPktsTransmitted=wsManagedAPVAPTspecPktsTransmitted, wsDevLocBldngFlrNum=wsDevLocBldngFlrNum, wsSwitchDiscoveredAPs=wsSwitchDiscoveredAPs, wsNtwProvisioningChanBGCompletion=wsNtwProvisioningChanBGCompletion, wsSwitchStatisticsEntry=wsSwitchStatisticsEntry, wsOnDemandTriggerFloorStatusBuildingNum=wsOnDemandTriggerFloorStatusBuildingNum, wsAPProfileDisconnAPMgmtMode=wsAPProfileDisconnAPMgmtMode, wsAPTriangulationNonSentryStatusEntry=wsAPTriangulationNonSentryStatusEntry, wsRFScanAPDot11acMode=wsRFScanAPDot11acMode, wsPowerPlanPerRadioTable=wsPowerPlanPerRadioTable, wsRrmChannelLoadHistoryEntryApMacAddr=wsRrmChannelLoadHistoryEntryApMacAddr, wsFailureAPStatusEntry=wsFailureAPStatusEntry, wsAuthenticatedClientSessionPktsRecvDropped=wsAuthenticatedClientSessionPktsRecvDropped, wsKnownClientAuthAction=wsKnownClientAuthAction, probeThresholdValue=probeThresholdValue, wsAssociatedClientSessionStatisticsEntry=wsAssociatedClientSessionStatisticsEntry, wsAPProvisioningDeleteAll=wsAPProvisioningDeleteAll, wsChannelPlanAPStrongestOldUnmanagedAPandSignal=wsChannelPlanAPStrongestOldUnmanagedAPandSignal, wsAPHWTypeRadioNmodeSupport=wsAPHWTypeRadioNmodeSupport, wsManagedAPVAPTspecStatisticsEntry=wsManagedAPVAPTspecStatisticsEntry, wsChannelPlanAPStrongestOldManagedAPandSignal=wsChannelPlanAPStrongestOldManagedAPandSignal, wsNetworkMACAuthenticationMode=wsNetworkMACAuthenticationMode, wsAssociatedClientDistTunnelAssocAPMac=wsAssociatedClientDistTunnelAssocAPMac, wsAssociatedClientNeighborManagedAPStatusEntry=wsAssociatedClientNeighborManagedAPStatusEntry, wsAssociatedClientBytesRecvd=wsAssociatedClientBytesRecvd, rfManagement=rfManagement, wsTspecTotalVideoTrafficStreams=wsTspecTotalVideoTrafficStreams, wsAPProfileApply=wsAPProfileApply, wsSwitchClusterPriority=wsSwitchClusterPriority, wsRogueAPAcknowledgeAll=wsRogueAPAcknowledgeAll, wsRrmNeighborChannel=wsRrmNeighborChannel, wsRFScanAPBaseMacAddress=wsRFScanAPBaseMacAddress, wsAssociatedClientSwitchMacAddress=wsAssociatedClientSwitchMacAddress, wsWDSAPGroupStatusTable=wsWDSAPGroupStatusTable, wsDetectedClientAuthSignal=wsDetectedClientAuthSignal, wsManagedAPConfigFailureErrMsg=wsManagedAPConfigFailureErrMsg, wsWDSAPGroupAPMacAddress=wsWDSAPGroupAPMacAddress, wsClientRogueClassificationTestState=wsClientRogueClassificationTestState, wsAPRadioTxPower=wsAPRadioTxPower, WsOui=WsOui, wsClientRogueClassificationStatusTable=wsClientRogueClassificationStatusTable, wsNetworkSecurityMode=wsNetworkSecurityMode, wsIfNumber=wsIfNumber, wsTotalWLANPktsRecvDropped=wsTotalWLANPktsRecvDropped, wsAPCodeDownloadGroupSize=wsAPCodeDownloadGroupSize, wsManagedAPRoamingTspecsAccepted=wsManagedAPRoamingTspecsAccepted, wsDevLocBldngFlrTable=wsDevLocBldngFlrTable, wsAssociatedClientQosCachedDiffservPolicyUpType=wsAssociatedClientQosCachedDiffservPolicyUpType, wsPeerConfigurationCaptivePortal=wsPeerConfigurationCaptivePortal, wsAPRogueClassificationReportingAPRadio=wsAPRogueClassificationReportingAPRadio, wsSwitchStaticIPAddress=wsSwitchStaticIPAddress, wsAPWiredDetectionVlanId=wsAPWiredDetectionVlanId, wsManagedAPSoftwareVersion=wsManagedAPSoftwareVersion, wsDetectedClientRoamSSID=wsDetectedClientRoamSSID, wsRrmChannelLoadHistoryEntryDuration=wsRrmChannelLoadHistoryEntryDuration, wsAPEDCAMaxBurst=wsAPEDCAMaxBurst, wsGlobalStatus=wsGlobalStatus, wsManagedAPVAPTspecOperStatus=wsManagedAPVAPTspecOperStatus, wsDetectedClientPreAuthenticationVapMac=wsDetectedClientPreAuthenticationVapMac, rogueDetectedTrapInterval=rogueDetectedTrapInterval, wsChannelPlanLastAlgorithmTime=wsChannelPlanLastAlgorithmTime)
