...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSystem=ntpSystem, dialup=dialup, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, etcAlarm=etcAlarm, nts=nts, ntpSysFreq=ntpSysFreq, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, s100=s100, products=products, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, symmTimePictra=symmTimePictra, tymingTime=tymingTime, net=net, tymingVersion=tymingVersion, etcVersion=etcVersion, gpsHealth=gpsHealth, gpsMode=gpsMode, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, experiment=experiment, etcSerialNbr=etcSerialNbr, tyming=tyming, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, ntpSysPeer=ntpSysPeer, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, version=version, ts2100=ts2100, symmTTM=symmTTM, syncserver=syncserver, xli=xli)
