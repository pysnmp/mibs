...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming, ntpSysStratum=ntpSysStratum, products=products, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, tymingStatus=tymingStatus, ntpSysLeap=ntpSysLeap, symmSnmpManagement=symmSnmpManagement, s100=s100, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, tymingVersion=tymingVersion, etcVersion=etcVersion, symmTTM=symmTTM, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, version=version, ntpSysPeer=ntpSysPeer, net=net, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, etcModel=etcModel, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, gps=gps, xli=xli, ntpSysClock=ntpSysClock, etcAlarmString=etcAlarmString, etc=etc, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, gpsMode=gpsMode, gpsPosition=gpsPosition, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmetricom=symmetricom, syncserver=syncserver, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, nts=nts, ts2100=ts2100, dialup=dialup, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000)
