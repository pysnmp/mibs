...
mibBuilder.exportSymbols("SYMM-SMI", tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, etcModel=etcModel, ntpSysLeap=ntpSysLeap, version=version, net=net, xli=xli, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, experiment=experiment, symmTimePictra=symmTimePictra, symmTTM=symmTTM, syncserver=syncserver, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, etc=etc, ntpSysError=ntpSysError, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, tymingTime=tymingTime, ntpSysClock=ntpSysClock, gps=gps, gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, tymingStatus=tymingStatus, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, tymingSource=tymingSource, symmBroadband=symmBroadband, dialup=dialup, ntpSysPrecision=ntpSysPrecision, tymingVersion=tymingVersion, symmetricom=symmetricom, gpsSatlist=gpsSatlist, products=products, ntpSysMode=ntpSysMode, nts=nts, s100=s100, symmNetworkManagement=symmNetworkManagement, ntpSysSystem=ntpSysSystem, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID)
