...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, s100=s100, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, etcModel=etcModel, symmTimePictra=symmTimePictra, products=products, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, etc=etc, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, gps=gps, etcUpgrade=etcUpgrade, ntpSysPhase=ntpSysPhase, gpsPosition=gpsPosition, ntpSysLeap=ntpSysLeap, dialup=dialup, ntpSysPeer=ntpSysPeer, symmBroadband=symmBroadband, ntpSysRefID=ntpSysRefID, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, experiment=experiment, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysRootDelay=ntpSysRootDelay, version=version, net=net, ntpSysClock=ntpSysClock, tyming=tyming, symmNetworkManagement=symmNetworkManagement, tymingStatus=tymingStatus, symmTTM=symmTTM, ntpSysSystem=ntpSysSystem, ntpSysFreq=ntpSysFreq, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, xli=xli, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, nts=nts, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, tymingVersion=tymingVersion, gpsMode=gpsMode, ntpSysError=ntpSysError, syncserver=syncserver)
