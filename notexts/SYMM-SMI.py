...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, ts2000=ts2000, nts=nts, gpsSatlist=gpsSatlist, tymingVersion=tymingVersion, products=products, gps=gps, symmNetworkManagement=symmNetworkManagement, ntpSysClock=ntpSysClock, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, ntpSysNotrust=ntpSysNotrust, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, PYSNMP_MODULE_ID=symmetricom, xli=xli, symmBroadband=symmBroadband, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, s100=s100, experiment=experiment, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysError=ntpSysError, tymingTime=tymingTime, etcUpgrade=etcUpgrade, tymingSource=tymingSource, etcVersion=etcVersion, ntpSysFreq=ntpSysFreq, etc=etc, ntpSysPoll=ntpSysPoll, ntpSysStratum=ntpSysStratum, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, version=version, ntpSysMode=ntpSysMode, symmCmipManagement=symmCmipManagement, ntpSysPrecision=ntpSysPrecision, etcSerialNbr=etcSerialNbr, ts2100=ts2100, symmetricom=symmetricom, tyming=tyming, etcUpgradeServer=etcUpgradeServer, gpsPosition=gpsPosition, net=net, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, dialup=dialup, ntpSysProcessor=ntpSysProcessor, ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, syncserver=syncserver, ntpSystem=ntpSystem, etcModel=etcModel, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, ntpSysPeer=ntpSysPeer)
