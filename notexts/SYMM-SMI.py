...
mibBuilder.exportSymbols("SYMM-SMI", version=version, s100=s100, ntpSysPhase=ntpSysPhase, tyming=tyming, tymingSource=tymingSource, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, ts2100=ts2100, etcAlarm=etcAlarm, tymingTime=tymingTime, symmetricom=symmetricom, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, ntpSysLeap=ntpSysLeap, ntpSysProcessor=ntpSysProcessor, dialup=dialup, syncserver=syncserver, experiment=experiment, net=net, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, ts2000=ts2000, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, etcUpgrade=etcUpgrade, xli=xli, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, tymingVersion=tymingVersion, gps=gps, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, tymingStatus=tymingStatus, nts=nts, etcModel=etcModel, products=products, symmTTM=symmTTM, etc=etc)
