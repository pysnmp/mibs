...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, IpAddress, TimeTicks, Bits, Unsigned32, iso, enterprises, NotificationType, NotificationType, Integer32, Gauge32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "IpAddress", "TimeTicks", "Bits", "Unsigned32", "iso", "enterprises", "NotificationType", "NotificationType", "Integer32", "Gauge32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, dialup=dialup, ntpSysSystem=ntpSysSystem, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, experiment=experiment, ntpSysPhase=ntpSysPhase, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, ntpSysPeer=ntpSysPeer, etcAlarmString=etcAlarmString, nts=nts, xli=xli, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, gpsPosition=gpsPosition, tymingTime=tymingTime, symmetricom=symmetricom, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, ntpSysNotrust=ntpSysNotrust, etcVersion=etcVersion, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, symmNetworkManagement=symmNetworkManagement, tymingSource=tymingSource, tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, version=version, symmTTM=symmTTM, net=net, etc=etc, gpsSatlist=gpsSatlist, ntpSysError=ntpSysError, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, etcModel=etcModel, s100=s100, ntpSystem=ntpSystem, symmSnmpManagement=symmSnmpManagement, products=products, symmCmipManagement=symmCmipManagement)
