...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefTime=ntpSysRefTime, gpsSatlist=gpsSatlist, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ts2000=ts2000, products=products, ntpSysRefID=ntpSysRefID, net=net, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, ntpSysPhase=ntpSysPhase, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, xli=xli, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, ntpSystem=ntpSystem, tymingTime=tymingTime, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, symmTTM=symmTTM, etc=etc, ntpSysProcessor=ntpSysProcessor, gps=gps, nts=nts, gpsHealth=gpsHealth, gpsMode=gpsMode, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, ntpSysSystem=ntpSysSystem, ntpSysLeap=ntpSysLeap, etcModel=etcModel, etcAlarmString=etcAlarmString, version=version, symmBroadband=symmBroadband, s100=s100, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, tyming=tyming, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, symmetricom=symmetricom, etcVersion=etcVersion, ts2100=ts2100, ntpSysStratum=ntpSysStratum, etcUpgradeServer=etcUpgradeServer, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment)
