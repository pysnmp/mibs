...
MibIdentifier, NotificationType, Counter32, ObjectIdentity, TimeTicks, enterprises, iso, Bits, Counter64, Gauge32, Unsigned32, ModuleIdentity, NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "TimeTicks", "enterprises", "iso", "Bits", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, experiment=experiment, dialup=dialup, version=version, tymingVersion=tymingVersion, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, tymingFlyPeriod=tymingFlyPeriod, ntpSysNotrust=ntpSysNotrust, ntpSysRefID=ntpSysRefID, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, gpsMode=gpsMode, etcVersion=etcVersion, gpsPosition=gpsPosition, symmBroadband=symmBroadband, products=products, ntpSystem=ntpSystem, syncserver=syncserver, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, symmNetworkManagement=symmNetworkManagement, xli=xli, net=net, ntpSysPoll=ntpSysPoll, symmetricom=symmetricom, gps=gps, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, nts=nts, ntpSysPhase=ntpSysPhase, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysFreq=ntpSysFreq, etc=etc, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, etcUpgrade=etcUpgrade, ntpSysPktsReceived=ntpSysPktsReceived, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, tymingSource=tymingSource, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, s100=s100, tyming=tyming, etcAlarmString=etcAlarmString)
