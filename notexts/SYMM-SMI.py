...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, IpAddress, Counter32, NotificationType, MibIdentifier, Bits, Counter64, ModuleIdentity, enterprises, Unsigned32, NotificationType, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "IpAddress", "Counter32", "NotificationType", "MibIdentifier", "Bits", "Counter64", "ModuleIdentity", "enterprises", "Unsigned32", "NotificationType", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, tymingTime=tymingTime, gpsPosition=gpsPosition, ntpSysRefID=ntpSysRefID, ntpSysLeap=ntpSysLeap, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, s100=s100, products=products, gps=gps, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, ts2100=ts2100, etcAlarm=etcAlarm, tymingVersion=tymingVersion, symmSnmpManagement=symmSnmpManagement, gpsMode=gpsMode, nts=nts, xli=xli, tymingStatus=tymingStatus, ntpSystem=ntpSystem, net=net, ntpSysVersion=ntpSysVersion, ts2000=ts2000, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, version=version, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, etcVersion=etcVersion, symmCmipManagement=symmCmipManagement, dialup=dialup, syncserver=syncserver, symmTTM=symmTTM, ntpSysPrecision=ntpSysPrecision, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, etc=etc, ntpSysClock=ntpSysClock, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, ntpSysPhase=ntpSysPhase, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, experiment=experiment, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, etcUpgradeServer=etcUpgradeServer, ntpSysFreq=ntpSysFreq, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom)
