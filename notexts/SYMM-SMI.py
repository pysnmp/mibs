...
iso, TimeTicks, NotificationType, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Integer32, IpAddress, Unsigned32, Bits, Counter64, ModuleIdentity, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Integer32", "IpAddress", "Unsigned32", "Bits", "Counter64", "ModuleIdentity", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPhase=ntpSysPhase, ntpSysLeap=ntpSysLeap, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, dialup=dialup, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, ntpSysPeer=ntpSysPeer, gpsSatlist=gpsSatlist, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, symmTimePictra=symmTimePictra, etcAlarm=etcAlarm, symmTTM=symmTTM, gpsPosition=gpsPosition, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust, syncserver=syncserver, gpsMode=gpsMode, ntpSysRefTime=ntpSysRefTime, ntpSysPrecision=ntpSysPrecision, etcVersion=etcVersion, nts=nts, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPoll=ntpSysPoll, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, ts2100=ts2100, ntpSysStratum=ntpSysStratum, products=products, xli=xli, version=version, experiment=experiment, ntpSysSystem=ntpSysSystem, ntpSysProcessor=ntpSysProcessor, net=net, ntpSysError=ntpSysError, gps=gps, ntpSysFreq=ntpSysFreq, s100=s100, etcUpgrade=etcUpgrade, ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, tymingStatus=tymingStatus, symmBroadband=symmBroadband, tymingTime=tymingTime, etc=etc, symmetricom=symmetricom, ts2000=ts2000, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, tyming=tyming)
