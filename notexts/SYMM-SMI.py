...
Unsigned32, ModuleIdentity, Counter32, NotificationType, IpAddress, Bits, MibIdentifier, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, ObjectIdentity, TimeTicks, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter32", "NotificationType", "IpAddress", "Bits", "MibIdentifier", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "ObjectIdentity", "TimeTicks", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, etc=etc, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, nts=nts, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, ntpSysNotrust=ntpSysNotrust, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, tymingFlyPeriod=tymingFlyPeriod, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, gps=gps, ntpSysVersion=ntpSysVersion, etcAlarm=etcAlarm, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, ntpSysRootDelay=ntpSysRootDelay, s100=s100, ts2100=ts2100, tymingSource=tymingSource, etcModel=etcModel, experiment=experiment, tymingStatus=tymingStatus, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, xli=xli, etcUpgradeServer=etcUpgradeServer, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, syncserver=syncserver, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, products=products, gpsPosition=gpsPosition, etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision, tyming=tyming, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, ts2000=ts2000, ntpSysClock=ntpSysClock, ntpSystem=ntpSystem, symmTimePictra=symmTimePictra, net=net, version=version, PYSNMP_MODULE_ID=symmetricom)
