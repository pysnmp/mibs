...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, Gauge32, iso, Integer32, NotificationType, TimeTicks, IpAddress, Counter32, Counter64, ObjectIdentity, ModuleIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "Gauge32", "iso", "Integer32", "NotificationType", "TimeTicks", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "ModuleIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, gps=gps, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, gpsPosition=gpsPosition, tyming=tyming, symmetricom=symmetricom, symmTTM=symmTTM, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, ntpSysStratum=ntpSysStratum, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, etc=etc, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, ntpSysLeap=ntpSysLeap, ntpSysRefTime=ntpSysRefTime, version=version, ntpSysError=ntpSysError, ntpSysRefID=ntpSysRefID, etcUpgrade=etcUpgrade, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, dialup=dialup, xli=xli, etcUpgradeServer=etcUpgradeServer, PYSNMP_MODULE_ID=symmetricom, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, etcVersion=etcVersion, experiment=experiment, products=products, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, net=net, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer, s100=s100, etcAlarmString=etcAlarmString, tymingStatus=tymingStatus, syncserver=syncserver)
