...
Unsigned32, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, iso, TimeTicks, Counter32, NotificationType, MibIdentifier, ModuleIdentity, Counter64, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "iso", "TimeTicks", "Counter32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter64", "Bits", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, gpsPosition=gpsPosition, xli=xli, ntpSysVersion=ntpSysVersion, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, ntpSysStratum=ntpSysStratum, etcAlarm=etcAlarm, tymingVersion=tymingVersion, gps=gps, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, tymingSource=tymingSource, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, tyming=tyming, symmetricom=symmetricom, products=products, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, gpsMode=gpsMode, etcUpgrade=etcUpgrade, syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, etcModel=etcModel, tymingStatus=tymingStatus, symmTTM=symmTTM, dialup=dialup, etc=etc, ntpSysPeer=ntpSysPeer, version=version, tymingTime=tymingTime, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, gpsHealth=gpsHealth, net=net, ntpSysRefID=ntpSysRefID, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, etcVersion=etcVersion, ntpSysRootDispersion=ntpSysRootDispersion, ts2000=ts2000, s100=s100, nts=nts, ntpSysPoll=ntpSysPoll, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDelay=ntpSysRootDelay, symmCmipManagement=symmCmipManagement, experiment=experiment, ntpSysSystem=ntpSysSystem)
