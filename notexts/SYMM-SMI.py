...
iso, NotificationType, Unsigned32, MibIdentifier, Counter32, Bits, TimeTicks, Integer32, Counter64, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Unsigned32", "MibIdentifier", "Counter32", "Bits", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, ntpSysLeap=ntpSysLeap, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, products=products, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, experiment=experiment, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, etc=etc, ntpSysVersion=ntpSysVersion, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, PYSNMP_MODULE_ID=symmetricom, version=version, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, dialup=dialup, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ts2100=ts2100, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, gpsSatlist=gpsSatlist, s100=s100, tyming=tyming, ntpSysNotrust=ntpSysNotrust, xli=xli, etcAlarmString=etcAlarmString, etcModel=etcModel, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, symmetricom=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, tymingVersion=tymingVersion, gpsHealth=gpsHealth, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, gps=gps, net=net, ntpSysRefTime=ntpSysRefTime, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, ntpSysRefID=ntpSysRefID)
