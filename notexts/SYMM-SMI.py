...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, tyming=tyming, ntpSysFreq=ntpSysFreq, syncserver=syncserver, tymingSource=tymingSource, gpsMode=gpsMode, ntpSysClock=ntpSysClock, gps=gps, etcUpgradeServer=etcUpgradeServer, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, ntpSysRefID=ntpSysRefID, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, ntpSysRootDelay=ntpSysRootDelay, nts=nts, etc=etc, ntpSysPoll=ntpSysPoll, experiment=experiment, ntpSysPhase=ntpSysPhase, products=products, gpsSatlist=gpsSatlist, s100=s100, ts2000=ts2000, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, net=net, symmTTM=symmTTM, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, etcModel=etcModel, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, ntpSysRefTime=ntpSysRefTime, version=version, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, etcAlarm=etcAlarm, symmBroadband=symmBroadband, symmSnmpManagement=symmSnmpManagement, etcVersion=etcVersion, tymingTime=tymingTime, ntpSysPeer=ntpSysPeer, ntpSysMode=ntpSysMode, dialup=dialup, xli=xli, tymingStatus=tymingStatus)
