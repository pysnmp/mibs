...
ObjectIdentity, NotificationType, ModuleIdentity, iso, Counter32, Counter64, TimeTicks, MibIdentifier, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, enterprises, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "ModuleIdentity", "iso", "Counter32", "Counter64", "TimeTicks", "MibIdentifier", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "enterprises", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysProcessor=ntpSysProcessor, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, ntpSysStratum=ntpSysStratum, version=version, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, net=net, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefTime=ntpSysRefTime, etcAlarm=etcAlarm, ntpSysError=ntpSysError, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, syncserver=syncserver, dialup=dialup, tymingVersion=tymingVersion, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, experiment=experiment, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, tymingTime=tymingTime, etcVersion=etcVersion, etcUpgrade=etcUpgrade, gpsMode=gpsMode, ts2100=ts2100, ntpSysFreq=ntpSysFreq, etcAlarmString=etcAlarmString, ntpSysVersion=ntpSysVersion, gpsPosition=gpsPosition, ntpSysLeap=ntpSysLeap, xli=xli, nts=nts, symmetricom=symmetricom, etcModel=etcModel, ntpSysPeer=ntpSysPeer, gps=gps, products=products, symmCmipManagement=symmCmipManagement, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, etc=etc, ts2000=ts2000, tyming=tyming, ntpSysPhase=ntpSysPhase, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, tymingFlyPeriod=tymingFlyPeriod, s100=s100, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, gpsSatlist=gpsSatlist, etcUpgradeServer=etcUpgradeServer)
