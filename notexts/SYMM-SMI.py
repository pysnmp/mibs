...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, tymingTime=tymingTime, etcVersion=etcVersion, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, ntpSysPhase=ntpSysPhase, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, version=version, etcModel=etcModel, syncserver=syncserver, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, dialup=dialup, experiment=experiment, symmNetworkManagement=symmNetworkManagement, gps=gps, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, xli=xli, ntpSysRefID=ntpSysRefID, ntpSysRootDelay=ntpSysRootDelay, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, gpsUTCOffset=gpsUTCOffset, ts2100=ts2100, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, products=products, tymingStatus=tymingStatus, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, s100=s100, gpsHealth=gpsHealth, ntpSysRefTime=ntpSysRefTime, etcUpgrade=etcUpgrade, ts2000=ts2000, ntpSysNotrust=ntpSysNotrust, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, ntpSysVersion=ntpSysVersion, ntpSysProcessor=ntpSysProcessor, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, nts=nts, tyming=tyming, net=net, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived)
