...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, gpsPosition=gpsPosition, xli=xli, tymingSource=tymingSource, dialup=dialup, ntpSysFreq=ntpSysFreq, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, etcUpgrade=etcUpgrade, ntpSysStratum=ntpSysStratum, ts2100=ts2100, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, gpsMode=gpsMode, ntpSysClock=ntpSysClock, ntpSysPeer=ntpSysPeer, experiment=experiment, ntpSysRefID=ntpSysRefID, tymingStatus=tymingStatus, ntpSysProcessor=ntpSysProcessor, version=version, etcModel=etcModel, net=net, etcUpgradeServer=etcUpgradeServer, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, s100=s100, nts=nts, gpsSatlist=gpsSatlist, ts2000=ts2000, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, symmSnmpManagement=symmSnmpManagement, ntpSysError=ntpSysError, tymingVersion=tymingVersion, ntpSystem=ntpSystem, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, tyming=tyming, etc=etc, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, symmTTM=symmTTM, products=products, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, gps=gps, syncserver=syncserver, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, ntpSysPktsReceived=ntpSysPktsReceived)
