...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, gpsPosition=gpsPosition, symmetricom=symmetricom, nts=nts, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, net=net, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, etc=etc, gpsMode=gpsMode, ntpSysError=ntpSysError, products=products, tymingFlyPeriod=tymingFlyPeriod, dialup=dialup, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, symmTimePictra=symmTimePictra, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysProcessor=ntpSysProcessor, etcSerialNbr=etcSerialNbr, PYSNMP_MODULE_ID=symmetricom, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, s100=s100, ntpSysSystem=ntpSysSystem, experiment=experiment, symmBroadband=symmBroadband, version=version, tymingTime=tymingTime, xli=xli, ts2100=ts2100, gpsHealth=gpsHealth, tyming=tyming, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, symmTTM=symmTTM, ntpSysMode=ntpSysMode, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ntpSystem=ntpSystem, ntpSysRootDispersion=ntpSysRootDispersion, gps=gps, tymingStatus=tymingStatus, tymingSource=tymingSource, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock)
