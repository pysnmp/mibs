...
Counter32, Unsigned32, Gauge32, IpAddress, MibIdentifier, ModuleIdentity, NotificationType, iso, ObjectIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Gauge32", "IpAddress", "MibIdentifier", "ModuleIdentity", "NotificationType", "iso", "ObjectIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarm=etcAlarm, etc=etc, tymingTime=tymingTime, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, etcUpgrade=etcUpgrade, nts=nts, gpsMode=gpsMode, experiment=experiment, dialup=dialup, symmNetworkManagement=symmNetworkManagement, ntpSysMode=ntpSysMode, ntpSysClock=ntpSysClock, symmTTM=symmTTM, syncserver=syncserver, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, etcVersion=etcVersion, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, ntpSystem=ntpSystem, xli=xli, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, net=net, etcModel=etcModel, ntpSysLeap=ntpSysLeap, gps=gps, ntpSysRefID=ntpSysRefID, etcSerialNbr=etcSerialNbr, version=version, ntpSysRootDelay=ntpSysRootDelay, etcAlarmString=etcAlarmString, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, s100=s100, tymingStatus=tymingStatus, products=products, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, ntpSysError=ntpSysError, ntpSysPeer=ntpSysPeer, ntpSysRootDispersion=ntpSysRootDispersion, symmBroadband=symmBroadband)
