...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, etcAlarmString=etcAlarmString, ntpSysPhase=ntpSysPhase, version=version, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, net=net, products=products, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor, etc=etc, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, symmetricom=symmetricom, ntpSysError=ntpSysError, etcUpgrade=etcUpgrade, gpsPosition=gpsPosition, gps=gps, ts2000=ts2000, symmSnmpManagement=symmSnmpManagement, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, xli=xli, tymingVersion=tymingVersion, gpsSatlist=gpsSatlist, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, etcVersion=etcVersion, etcModel=etcModel, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, symmCmipManagement=symmCmipManagement, experiment=experiment, tymingTime=tymingTime, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, ntpSysStratum=ntpSysStratum, tymingSource=tymingSource, syncserver=syncserver, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, s100=s100, tyming=tyming, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, nts=nts, ntpSysRefID=ntpSysRefID, etcAlarm=etcAlarm)
