...
ObjectIdentity, NotificationType, iso, Bits, Unsigned32, Counter32, Integer32, Gauge32, ModuleIdentity, enterprises, Counter64, IpAddress, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "iso", "Bits", "Unsigned32", "Counter32", "Integer32", "Gauge32", "ModuleIdentity", "enterprises", "Counter64", "IpAddress", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, gps=gps, symmetricom=symmetricom, ntpSysRootDelay=ntpSysRootDelay, symmTTM=symmTTM, ntpSysSystem=ntpSysSystem, symmTimePictra=symmTimePictra, version=version, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, dialup=dialup, tymingSource=tymingSource, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, nts=nts, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ntpSysPeer=ntpSysPeer, xli=xli, PYSNMP_MODULE_ID=symmetricom, net=net, ntpSysStratum=ntpSysStratum, products=products, gpsHealth=gpsHealth, ts2100=ts2100, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, ntpSystem=ntpSystem, ntpSysError=ntpSysError, etcVersion=etcVersion, symmBroadband=symmBroadband, ntpSysMode=ntpSysMode, s100=s100, gpsMode=gpsMode, symmNetworkManagement=symmNetworkManagement, etc=etc, tymingVersion=tymingVersion, ntpSysRefTime=ntpSysRefTime, gpsPosition=gpsPosition, tyming=tyming, syncserver=syncserver, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, tymingTime=tymingTime, gpsSatlist=gpsSatlist, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, experiment=experiment, ts2000=ts2000, ntpSysPhase=ntpSysPhase, etcUpgradeServer=etcUpgradeServer, ntpSysProcessor=ntpSysProcessor, symmCmipManagement=symmCmipManagement)
