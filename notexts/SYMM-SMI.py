...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, ntpSysProcessor=ntpSysProcessor, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarmString=etcAlarmString, version=version, PYSNMP_MODULE_ID=symmetricom, tymingStatus=tymingStatus, ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, tymingVersion=tymingVersion, tymingSource=tymingSource, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, xli=xli, symmTimePictra=symmTimePictra, ntpSysNotrust=ntpSysNotrust, products=products, ntpSysPrecision=ntpSysPrecision, net=net, etc=etc, ntpSysMode=ntpSysMode, etcModel=etcModel, ntpSysError=ntpSysError, gpsMode=gpsMode, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ts2000=ts2000, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, nts=nts, ntpSysSystem=ntpSysSystem, symmTTM=symmTTM, tyming=tyming, symmNetworkManagement=symmNetworkManagement, etcUpgradeServer=etcUpgradeServer, etcAlarm=etcAlarm, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade, dialup=dialup, gps=gps, gpsHealth=gpsHealth, ntpSysStratum=ntpSysStratum, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, s100=s100)
