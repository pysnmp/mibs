...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, etcModel=etcModel, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision, tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefID=ntpSysRefID, syncserver=syncserver, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, products=products, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, gpsMode=gpsMode, etcAlarm=etcAlarm, nts=nts, ntpSysLeap=ntpSysLeap, gps=gps, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, etc=etc, ntpSysError=ntpSysError, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, xli=xli, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, symmTTM=symmTTM, net=net, etcSerialNbr=etcSerialNbr, ntpSysRefTime=ntpSysRefTime, ts2000=ts2000, gpsPosition=gpsPosition, etcVersion=etcVersion, symmTimePictra=symmTimePictra, s100=s100, experiment=experiment, ntpSysVersion=ntpSysVersion, ntpSysClock=ntpSysClock, version=version, dialup=dialup, symmSnmpManagement=symmSnmpManagement, ntpSysMode=ntpSysMode, symmetricom=symmetricom, tymingTime=tymingTime, tymingVersion=tymingVersion)
