...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, ts2100=ts2100, tymingTime=tymingTime, etcModel=etcModel, symmCmipManagement=symmCmipManagement, dialup=dialup, ts2000=ts2000, etc=etc, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, s100=s100, symmTTM=symmTTM, ntpSysNotrust=ntpSysNotrust, version=version, products=products, xli=xli, gpsPosition=gpsPosition, ntpSysPktsReceived=ntpSysPktsReceived, symmetricom=symmetricom, etcAlarmString=etcAlarmString, syncserver=syncserver, ntpSysMode=ntpSysMode, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, tymingVersion=tymingVersion, nts=nts, gpsHealth=gpsHealth, tymingSource=tymingSource, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, etcVersion=etcVersion, gpsSatlist=gpsSatlist, etcAlarm=etcAlarm, ntpSysProcessor=ntpSysProcessor, experiment=experiment, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, net=net, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, tyming=tyming)
