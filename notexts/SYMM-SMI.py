...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, symmBroadband=symmBroadband, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, ts2000=ts2000, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, products=products, etcUpgrade=etcUpgrade, ntpSysStratum=ntpSysStratum, ntpSystem=ntpSystem, gpsHealth=gpsHealth, syncserver=syncserver, gpsPosition=gpsPosition, dialup=dialup, ntpSysNotrust=ntpSysNotrust, experiment=experiment, etcAlarmString=etcAlarmString, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, net=net, nts=nts, etcModel=etcModel, ntpSysRefID=ntpSysRefID, ntpSysRootDelay=ntpSysRootDelay, s100=s100, etc=etc, etcAlarm=etcAlarm, xli=xli, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, ntpSysRootDispersion=ntpSysRootDispersion, version=version, ntpSysClock=ntpSysClock, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, gps=gps, ntpSysPhase=ntpSysPhase, tyming=tyming)
