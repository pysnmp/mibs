...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, symmBroadband=symmBroadband, ntpSysSystem=ntpSysSystem, ts2000=ts2000, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDispersion=ntpSysRootDispersion, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, s100=s100, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, ntpSysLeap=ntpSysLeap, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, ntpSysMode=ntpSysMode, ts2100=ts2100, gpsSatlist=gpsSatlist, net=net, ntpSysRefTime=ntpSysRefTime, dialup=dialup, ntpSysNotrust=ntpSysNotrust, nts=nts, gpsPosition=gpsPosition, version=version, etc=etc, symmSnmpManagement=symmSnmpManagement, gps=gps, ntpSysPhase=ntpSysPhase, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, gpsHealth=gpsHealth, tyming=tyming, products=products, tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, etcModel=etcModel)
