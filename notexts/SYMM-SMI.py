...
iso, Unsigned32, Bits, IpAddress, Integer32, ObjectIdentity, enterprises, Counter64, ModuleIdentity, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Bits", "IpAddress", "Integer32", "ObjectIdentity", "enterprises", "Counter64", "ModuleIdentity", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarm=etcAlarm, ts2000=ts2000, net=net, tymingFlyPeriod=tymingFlyPeriod, symmNetworkManagement=symmNetworkManagement, etcAlarmString=etcAlarmString, xli=xli, symmTTM=symmTTM, syncserver=syncserver, s100=s100, etcSerialNbr=etcSerialNbr, etcModel=etcModel, gps=gps, tymingStatus=tymingStatus, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, gpsMode=gpsMode, ntpSysError=ntpSysError, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, gpsPosition=gpsPosition, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, symmBroadband=symmBroadband, products=products, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, ntpSysPoll=ntpSysPoll, tyming=tyming, ntpSysRefTime=ntpSysRefTime, tymingSource=tymingSource, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, etc=etc, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, experiment=experiment, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, nts=nts, ntpSysClock=ntpSysClock, ntpSysPeer=ntpSysPeer, version=version, dialup=dialup)
