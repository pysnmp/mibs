...
mibBuilder.exportSymbols("SYMM-SMI", s100=s100, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, gps=gps, syncserver=syncserver, nts=nts, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, version=version, ntpSysRefID=ntpSysRefID, tymingSource=tymingSource, etc=etc, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, etcModel=etcModel, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, dialup=dialup, symmTTM=symmTTM, symmetricom=symmetricom, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, products=products, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, symmNetworkManagement=symmNetworkManagement, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, ntpSysLeap=ntpSysLeap, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, tyming=tyming, symmBroadband=symmBroadband, symmSnmpManagement=symmSnmpManagement, ts2000=ts2000, ntpSysPrecision=ntpSysPrecision, etcVersion=etcVersion, etcUpgrade=etcUpgrade, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, net=net, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, ntpSysPeer=ntpSysPeer)
