...
Counter64, Unsigned32, NotificationType, ModuleIdentity, Bits, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, MibIdentifier, NotificationType, enterprises, ObjectIdentity, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "NotificationType", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "MibIdentifier", "NotificationType", "enterprises", "ObjectIdentity", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysFreq=ntpSysFreq, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, experiment=experiment, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, etc=etc, tymingStatus=tymingStatus, symmetricom=symmetricom, ts2000=ts2000, version=version, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, etcUpgrade=etcUpgrade, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, gps=gps, s100=s100, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, ntpSysNotrust=ntpSysNotrust, xli=xli, symmBroadband=symmBroadband, products=products, syncserver=syncserver, gpsUTCOffset=gpsUTCOffset, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, gpsMode=gpsMode, ts2100=ts2100, gpsPosition=gpsPosition, tymingFlyPeriod=tymingFlyPeriod, net=net, etcModel=etcModel, dialup=dialup, ntpSysSystem=ntpSysSystem, nts=nts, etcAlarmString=etcAlarmString, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, tyming=tyming, ntpSysStratum=ntpSysStratum, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, ntpSysError=ntpSysError, ntpSystem=ntpSystem, symmCmipManagement=symmCmipManagement)
