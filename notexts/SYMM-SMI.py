...
Integer32, ModuleIdentity, IpAddress, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Bits, MibIdentifier, Counter64, ObjectIdentity, NotificationType, TimeTicks, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "IpAddress", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Bits", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "TimeTicks", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", experiment=experiment, dialup=dialup, net=net, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, etcSerialNbr=etcSerialNbr, etcModel=etcModel, ntpSysProcessor=ntpSysProcessor, products=products, s100=s100, gpsPosition=gpsPosition, gpsUTCOffset=gpsUTCOffset, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, ntpSysPrecision=ntpSysPrecision, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, symmCmipManagement=symmCmipManagement, ntpSystem=ntpSystem, ts2100=ts2100, gpsMode=gpsMode, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, ntpSysNotrust=ntpSysNotrust, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, tymingTime=tymingTime, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming, symmetricom=symmetricom, ntpSysError=ntpSysError, symmTimePictra=symmTimePictra, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, version=version, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefID=ntpSysRefID, etc=etc, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, ts2000=ts2000, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, symmSnmpManagement=symmSnmpManagement, xli=xli, gps=gps, symmTTM=symmTTM, syncserver=syncserver, tymingSource=tymingSource)
