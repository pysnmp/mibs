...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, Counter32, NotificationType, IpAddress, Counter64, Unsigned32, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Counter32", "NotificationType", "IpAddress", "Counter64", "Unsigned32", "Bits", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarmString=etcAlarmString, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, etcAlarm=etcAlarm, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, net=net, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, s100=s100, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, syncserver=syncserver, symmCmipManagement=symmCmipManagement, tyming=tyming, gpsSatlist=gpsSatlist, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, symmSnmpManagement=symmSnmpManagement, tymingSource=tymingSource, tymingTime=tymingTime, symmTTM=symmTTM, ts2100=ts2100, ntpSysPeer=ntpSysPeer, nts=nts, PYSNMP_MODULE_ID=symmetricom, gpsMode=gpsMode, symmBroadband=symmBroadband, ntpSysRefID=ntpSysRefID, symmTimePictra=symmTimePictra, ntpSysError=ntpSysError, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, products=products, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, ntpSysLeap=ntpSysLeap, etcSerialNbr=etcSerialNbr, version=version, ts2000=ts2000, experiment=experiment, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, xli=xli, gps=gps, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, etc=etc, dialup=dialup)
