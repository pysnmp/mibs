...
Integer32, enterprises, MibIdentifier, Counter64, Counter32, NotificationType, TimeTicks, NotificationType, ObjectIdentity, Bits, Gauge32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "MibIdentifier", "Counter64", "Counter32", "NotificationType", "TimeTicks", "NotificationType", "ObjectIdentity", "Bits", "Gauge32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, version=version, tymingSource=tymingSource, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, symmetricom=symmetricom, etcSerialNbr=etcSerialNbr, s100=s100, gpsSatlist=gpsSatlist, ntpSysClock=ntpSysClock, gps=gps, nts=nts, ntpSysMode=ntpSysMode, dialup=dialup, gpsHealth=gpsHealth, symmCmipManagement=symmCmipManagement, etcVersion=etcVersion, symmTimePictra=symmTimePictra, ts2100=ts2100, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, ts2000=ts2000, etc=etc, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysPoll=ntpSysPoll, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, ntpSysRefTime=ntpSysRefTime, xli=xli, experiment=experiment, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase, tyming=tyming, gpsMode=gpsMode, symmTTM=symmTTM, syncserver=syncserver, net=net, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, products=products, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, ntpSysLeap=ntpSysLeap, ntpSystem=ntpSystem, gpsPosition=gpsPosition)
