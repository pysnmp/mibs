...
Counter64, NotificationType, NotificationType, IpAddress, Unsigned32, iso, Integer32, Bits, enterprises, Gauge32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "NotificationType", "IpAddress", "Unsigned32", "iso", "Integer32", "Bits", "enterprises", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysClock=ntpSysClock, xli=xli, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, net=net, ntpSysVersion=ntpSysVersion, ntpSysRefID=ntpSysRefID, syncserver=syncserver, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, s100=s100, symmTimePictra=symmTimePictra, dialup=dialup, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, gpsMode=gpsMode, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ts2100=ts2100, tyming=tyming, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, symmTTM=symmTTM, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, version=version, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, etcModel=etcModel, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, tymingStatus=tymingStatus, experiment=experiment, products=products, ts2000=ts2000, ntpSysNotrust=ntpSysNotrust, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, tymingSource=tymingSource, ntpSysMode=ntpSysMode, etc=etc, ntpSysSystem=ntpSysSystem, ntpSysPoll=ntpSysPoll, ntpSysStratum=ntpSysStratum, gpsHealth=gpsHealth, ntpSysRefTime=ntpSysRefTime, gps=gps, ntpSysFreq=ntpSysFreq, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, tymingVersion=tymingVersion)
