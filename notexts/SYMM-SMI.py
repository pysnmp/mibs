...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, version=version, syncserver=syncserver, ntpSysRefID=ntpSysRefID, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysVersion=ntpSysVersion, gps=gps, tymingTime=tymingTime, gpsPosition=gpsPosition, ts2000=ts2000, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, ntpSysPhase=ntpSysPhase, ts2100=ts2100, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, symmBroadband=symmBroadband, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, etc=etc, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, tyming=tyming, symmCmipManagement=symmCmipManagement, gpsUTCOffset=gpsUTCOffset, tymingVersion=tymingVersion, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, etcAlarm=etcAlarm, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, experiment=experiment, ntpSysError=ntpSysError, tymingSource=tymingSource, gpsSatlist=gpsSatlist, dialup=dialup, symmSnmpManagement=symmSnmpManagement, gpsHealth=gpsHealth, net=net, ntpSysClock=ntpSysClock, s100=s100, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, nts=nts, products=products, xli=xli, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra)
