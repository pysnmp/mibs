...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, ts2000=ts2000, etcAlarmString=etcAlarmString, ntpSysError=ntpSysError, tymingStatus=tymingStatus, gpsPosition=gpsPosition, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, nts=nts, ntpSysNotrust=ntpSysNotrust, tyming=tyming, experiment=experiment, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, etcAlarm=etcAlarm, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, etcModel=etcModel, symmetricom=symmetricom, etcVersion=etcVersion, dialup=dialup, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, s100=s100, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, tymingVersion=tymingVersion, ntpSysClock=ntpSysClock, symmCmipManagement=symmCmipManagement, net=net, ntpSysRefTime=ntpSysRefTime, gpsHealth=gpsHealth, ntpSysProcessor=ntpSysProcessor, etcSerialNbr=etcSerialNbr, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, version=version, xli=xli, gpsMode=gpsMode, tymingSource=tymingSource, etc=etc, products=products, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist)
