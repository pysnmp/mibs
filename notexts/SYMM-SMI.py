...
ObjectIdentity, Unsigned32, Counter64, MibIdentifier, enterprises, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, IpAddress, NotificationType, Counter32, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "enterprises", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "IpAddress", "NotificationType", "Counter32", "Bits", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, dialup=dialup, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, gpsMode=gpsMode, s100=s100, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, net=net, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, gps=gps, tyming=tyming, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, symmetricom=symmetricom, xli=xli, gpsHealth=gpsHealth, symmSnmpManagement=symmSnmpManagement, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, ntpSysClock=ntpSysClock, symmNetworkManagement=symmNetworkManagement, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, products=products, ntpSysFreq=ntpSysFreq, ts2000=ts2000, version=version, ntpSysSystem=ntpSysSystem, experiment=experiment, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, nts=nts, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, etc=etc, gpsSatlist=gpsSatlist)
