...
ObjectIdentity, MibIdentifier, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, NotificationType, Unsigned32, NotificationType, Counter64, TimeTicks, ModuleIdentity, iso, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "NotificationType", "Unsigned32", "NotificationType", "Counter64", "TimeTicks", "ModuleIdentity", "iso", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", s100=s100, ntpSysLeap=ntpSysLeap, net=net, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, etcAlarm=etcAlarm, syncserver=syncserver, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSystem=ntpSystem, xli=xli, ts2000=ts2000, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, tyming=tyming, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, etcModel=etcModel, gpsSatlist=gpsSatlist, version=version, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, dialup=dialup, ntpSysPhase=ntpSysPhase, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, gps=gps, ntpSysSystem=ntpSysSystem, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, symmSnmpManagement=symmSnmpManagement, ntpSysStratum=ntpSysStratum, products=products, experiment=experiment, etc=etc, ntpSysError=ntpSysError, ntpSysPoll=ntpSysPoll, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, symmTTM=symmTTM, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, tymingStatus=tymingStatus)
