...
TimeTicks, ObjectIdentity, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, ModuleIdentity, NotificationType, Unsigned32, iso, Gauge32, Integer32, Bits, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "ModuleIdentity", "NotificationType", "Unsigned32", "iso", "Gauge32", "Integer32", "Bits", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysClock=ntpSysClock, etc=etc, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, gpsPosition=gpsPosition, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay, gps=gps, etcModel=etcModel, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, version=version, tymingStatus=tymingStatus, gpsMode=gpsMode, xli=xli, symmSnmpManagement=symmSnmpManagement, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, etcSerialNbr=etcSerialNbr, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ntpSysVersion=ntpSysVersion, ntpSysFreq=ntpSysFreq, ntpSysLeap=ntpSysLeap, products=products, etcAlarmString=etcAlarmString, net=net, ntpSysPrecision=ntpSysPrecision, symmetricom=symmetricom, nts=nts, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, s100=s100, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, ts2100=ts2100, etcUpgrade=etcUpgrade, tyming=tyming, etcAlarm=etcAlarm, symmTTM=symmTTM, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, ntpSysPeer=ntpSysPeer, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband)
