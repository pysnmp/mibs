...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, enterprises, NotificationType, TimeTicks, ModuleIdentity, Bits, Unsigned32, iso, Counter32, MibIdentifier, Gauge32, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "enterprises", "NotificationType", "TimeTicks", "ModuleIdentity", "Bits", "Unsigned32", "iso", "Counter32", "MibIdentifier", "Gauge32", "ObjectIdentity", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, ntpSysRefID=ntpSysRefID, syncserver=syncserver, ntpSystem=ntpSystem, dialup=dialup, symmBroadband=symmBroadband, etc=etc, ntpSysMode=ntpSysMode, ntpSysPhase=ntpSysPhase, ntpSysPeer=ntpSysPeer, tymingTime=tymingTime, net=net, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, gpsPosition=gpsPosition, ts2000=ts2000, tyming=tyming, tymingStatus=tymingStatus, symmTTM=symmTTM, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, products=products, gpsUTCOffset=gpsUTCOffset, ntpSysRootDispersion=ntpSysRootDispersion, s100=s100, version=version, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, etcUpgrade=etcUpgrade, gps=gps, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, ntpSysVersion=ntpSysVersion, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, PYSNMP_MODULE_ID=symmetricom, xli=xli, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, nts=nts, etcVersion=etcVersion, experiment=experiment, ntpSysPrecision=ntpSysPrecision)
