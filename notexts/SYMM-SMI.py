...
Bits, Counter64, Unsigned32, enterprises, TimeTicks, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, iso, Gauge32, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Unsigned32", "enterprises", "TimeTicks", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, s100=s100, tyming=tyming, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, ntpSysPhase=ntpSysPhase, ntpSysStratum=ntpSysStratum, symmTTM=symmTTM, tymingTime=tymingTime, gpsMode=gpsMode, ts2100=ts2100, ntpSysVersion=ntpSysVersion, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, gps=gps, net=net, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, version=version, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, ntpSysPeer=ntpSysPeer, syncserver=syncserver, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, ntpSysNotrust=ntpSysNotrust, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, tymingSource=tymingSource, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, etcVersion=etcVersion, symmetricom=symmetricom, nts=nts, dialup=dialup, symmBroadband=symmBroadband, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, tymingVersion=tymingVersion, products=products, gpsUTCOffset=gpsUTCOffset, etc=etc)
