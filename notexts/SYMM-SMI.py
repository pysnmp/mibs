...
Counter32, ObjectIdentity, Counter64, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, ModuleIdentity, IpAddress, MibIdentifier, Integer32, TimeTicks, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Counter64", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "ModuleIdentity", "IpAddress", "MibIdentifier", "Integer32", "TimeTicks", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, gpsMode=gpsMode, symmetricom=symmetricom, ntpSystem=ntpSystem, gpsPosition=gpsPosition, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement, ntpSysPktsReceived=ntpSysPktsReceived, dialup=dialup, products=products, ts2000=ts2000, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, symmBroadband=symmBroadband, symmTTM=symmTTM, etcModel=etcModel, gpsUTCOffset=gpsUTCOffset, ntpSysProcessor=ntpSysProcessor, ntpSysRootDispersion=ntpSysRootDispersion, syncserver=syncserver, gps=gps, ts2100=ts2100, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, etcUpgradeServer=etcUpgradeServer, xli=xli, ntpSysClock=ntpSysClock, ntpSysPrecision=ntpSysPrecision, nts=nts, etcVersion=etcVersion, ntpSysLeap=ntpSysLeap, version=version, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, tyming=tyming, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, s100=s100, ntpSysRootDelay=ntpSysRootDelay, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, etc=etc, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, experiment=experiment, ntpSysMode=ntpSysMode, ntpSysPoll=ntpSysPoll, etcUpgrade=etcUpgrade, net=net, ntpSysRefID=ntpSysRefID)
