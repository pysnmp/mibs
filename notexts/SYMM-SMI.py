...
Integer32, enterprises, Bits, Gauge32, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, iso, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Bits", "Gauge32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, ntpSysRootDispersion=ntpSysRootDispersion, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, gpsHealth=gpsHealth, etcModel=etcModel, etcUpgrade=etcUpgrade, ntpSysVersion=ntpSysVersion, ntpSysProcessor=ntpSysProcessor, ts2100=ts2100, version=version, experiment=experiment, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, ts2000=ts2000, gpsPosition=gpsPosition, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, tymingSource=tymingSource, tymingTime=tymingTime, products=products, tymingVersion=tymingVersion, symmTTM=symmTTM, symmTimePictra=symmTimePictra, s100=s100, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, gpsUTCOffset=gpsUTCOffset, etc=etc, symmNetworkManagement=symmNetworkManagement, tyming=tyming, etcAlarm=etcAlarm, xli=xli, ntpSysClock=ntpSysClock, ntpSysPeer=ntpSysPeer, net=net, ntpSysNotrust=ntpSysNotrust, nts=nts, dialup=dialup, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, ntpSysError=ntpSysError, etcVersion=etcVersion, ntpSysLeap=ntpSysLeap, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode)
