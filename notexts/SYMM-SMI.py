...
Gauge32, Integer32, ObjectIdentity, IpAddress, enterprises, NotificationType, ModuleIdentity, Counter64, Unsigned32, MibIdentifier, iso, Counter32, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ObjectIdentity", "IpAddress", "enterprises", "NotificationType", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "iso", "Counter32", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, tymingSource=tymingSource, etcModel=etcModel, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, tymingStatus=tymingStatus, etcAlarm=etcAlarm, ntpSysPhase=ntpSysPhase, syncserver=syncserver, net=net, etcUpgrade=etcUpgrade, ntpSysPrecision=ntpSysPrecision, xli=xli, s100=s100, etc=etc, gps=gps, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, experiment=experiment, tymingTime=tymingTime, ntpSysRefID=ntpSysRefID, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, tyming=tyming, ntpSysPktsReceived=ntpSysPktsReceived, ntpSystem=ntpSystem, nts=nts, symmetricom=symmetricom, tymingVersion=tymingVersion, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, ts2100=ts2100, etcSerialNbr=etcSerialNbr, gpsSatlist=gpsSatlist, symmTTM=symmTTM, gpsPosition=gpsPosition, gpsMode=gpsMode, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, version=version, products=products, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, ntpSysMode=ntpSysMode, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock)
