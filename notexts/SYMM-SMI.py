...
TimeTicks, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, ObjectIdentity, iso, ModuleIdentity, enterprises, Unsigned32, NotificationType, MibIdentifier, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "ObjectIdentity", "iso", "ModuleIdentity", "enterprises", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, ntpSysPhase=ntpSysPhase, dialup=dialup, products=products, gpsMode=gpsMode, etcUpgrade=etcUpgrade, ntpSysRefTime=ntpSysRefTime, ntpSysPrecision=ntpSysPrecision, tyming=tyming, gpsUTCOffset=gpsUTCOffset, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, version=version, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, experiment=experiment, ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, ntpSysLeap=ntpSysLeap, ntpSysStratum=ntpSysStratum, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, xli=xli, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, etcVersion=etcVersion, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, etcSerialNbr=etcSerialNbr, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, gpsHealth=gpsHealth, tymingFlyPeriod=tymingFlyPeriod, nts=nts, s100=s100, PYSNMP_MODULE_ID=symmetricom, ntpSysFreq=ntpSysFreq, net=net, tymingSource=tymingSource, syncserver=syncserver, tymingStatus=tymingStatus, ntpSysRootDispersion=ntpSysRootDispersion, etcModel=etcModel, gps=gps, ts2000=ts2000, symmetricom=symmetricom, symmBroadband=symmBroadband, ts2100=ts2100)
