...
mibBuilder.exportSymbols("SYMM-SMI", tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, syncserver=syncserver, gpsHealth=gpsHealth, symmBroadband=symmBroadband, version=version, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, etcVersion=etcVersion, products=products, dialup=dialup, gpsPosition=gpsPosition, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, symmTTM=symmTTM, etcModel=etcModel, tyming=tyming, ntpSysStratum=ntpSysStratum, ts2000=ts2000, tymingStatus=tymingStatus, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, symmTimePictra=symmTimePictra, etc=etc, gpsMode=gpsMode, s100=s100, ntpSysMode=ntpSysMode, tymingTime=tymingTime, ntpSysLeap=ntpSysLeap, etcUpgradeServer=etcUpgradeServer, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, net=net, ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, ntpSysRefID=ntpSysRefID, gpsSatlist=gpsSatlist, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, experiment=experiment, ts2100=ts2100, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, gps=gps, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, ntpSysRefTime=ntpSysRefTime, PYSNMP_MODULE_ID=symmetricom, ntpSysError=ntpSysError, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement)
