...
NotificationType, enterprises, Counter32, ModuleIdentity, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, NotificationType, ObjectIdentity, Unsigned32, Gauge32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Counter32", "ModuleIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "Gauge32", "iso", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, net=net, s100=s100, symmCmipManagement=symmCmipManagement, ts2100=ts2100, etc=etc, ntpSysPoll=ntpSysPoll, ntpSysMode=ntpSysMode, etcModel=etcModel, ntpSysLeap=ntpSysLeap, tyming=tyming, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, ntpSystem=ntpSystem, etcUpgradeServer=etcUpgradeServer, gps=gps, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, xli=xli, ntpSysStratum=ntpSysStratum, symmSnmpManagement=symmSnmpManagement, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, ntpSysError=ntpSysError, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, products=products, gpsMode=gpsMode, etcAlarmString=etcAlarmString, symmetricom=symmetricom, PYSNMP_MODULE_ID=symmetricom, nts=nts, ntpSysRootDispersion=ntpSysRootDispersion, gpsSatlist=gpsSatlist, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, tymingTime=tymingTime, ntpSysClock=ntpSysClock, symmTTM=symmTTM, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer, experiment=experiment, dialup=dialup, symmTimePictra=symmTimePictra, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, version=version)
