...
MibIdentifier, ModuleIdentity, Integer32, NotificationType, Bits, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, iso, TimeTicks, Counter32, ObjectIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Integer32", "NotificationType", "Bits", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "iso", "TimeTicks", "Counter32", "ObjectIdentity", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, ntpSysStratum=ntpSysStratum, ntpSysClock=ntpSysClock, symmTTM=symmTTM, tymingTime=tymingTime, ntpSysMode=ntpSysMode, syncserver=syncserver, ntpSysError=ntpSysError, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, nts=nts, tymingVersion=tymingVersion, version=version, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, experiment=experiment, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, dialup=dialup, gps=gps, symmBroadband=symmBroadband, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, etc=etc, ntpSysPeer=ntpSysPeer, etcVersion=etcVersion, ntpSystem=ntpSystem, etcUpgrade=etcUpgrade, products=products, tyming=tyming, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, s100=s100, gpsPosition=gpsPosition, gpsHealth=gpsHealth, etcUpgradeServer=etcUpgradeServer, symmTimePictra=symmTimePictra, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, ntpSysLeap=ntpSysLeap, etcSerialNbr=etcSerialNbr, net=net, ts2000=ts2000, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, ntpSysRefID=ntpSysRefID, xli=xli, ntpSysRootDelay=ntpSysRootDelay)
