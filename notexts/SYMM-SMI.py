...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysNotrust=ntpSysNotrust, products=products, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, ntpSysRootDelay=ntpSysRootDelay, gpsSatlist=gpsSatlist, symmetricom=symmetricom, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, syncserver=syncserver, ntpSysClock=ntpSysClock, ntpSysRootDispersion=ntpSysRootDispersion, dialup=dialup, version=version, ntpSystem=ntpSystem, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, ntpSysLeap=ntpSysLeap, ntpSysError=ntpSysError, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, ntpSysPeer=ntpSysPeer, ts2000=ts2000, gpsPosition=gpsPosition, xli=xli, net=net, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, ntpSysVersion=ntpSysVersion, experiment=experiment, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, ntpSysStratum=ntpSysStratum, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysPhase=ntpSysPhase, etcAlarmString=etcAlarmString, s100=s100, tymingVersion=tymingVersion, etc=etc, nts=nts, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, gps=gps, tyming=tyming, etcModel=etcModel, tymingSource=tymingSource, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq)
