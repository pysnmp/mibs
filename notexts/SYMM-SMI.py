...
IpAddress, Integer32, iso, Bits, NotificationType, TimeTicks, Counter32, Gauge32, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "iso", "Bits", "NotificationType", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, etc=etc, ntpSysError=ntpSysError, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, symmTTM=symmTTM, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, gpsHealth=gpsHealth, symmCmipManagement=symmCmipManagement, net=net, ntpSysMode=ntpSysMode, version=version, ntpSysClock=ntpSysClock, s100=s100, tymingSource=tymingSource, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, etcModel=etcModel, tymingTime=tymingTime, etcUpgrade=etcUpgrade, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPhase=ntpSysPhase, ts2000=ts2000, ntpSysPoll=ntpSysPoll, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, products=products, gpsMode=gpsMode, syncserver=syncserver, ntpSysNotrust=ntpSysNotrust, symmetricom=symmetricom, tyming=tyming, etcAlarm=etcAlarm, dialup=dialup, etcVersion=etcVersion, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, experiment=experiment, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, xli=xli, ntpSysPeer=ntpSysPeer, ntpSysVersion=ntpSysVersion, gps=gps, ntpSysSystem=ntpSysSystem, symmSnmpManagement=symmSnmpManagement)
