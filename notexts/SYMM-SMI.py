...
MibIdentifier, TimeTicks, Bits, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Integer32, Unsigned32, iso, Counter32, Counter64, NotificationType, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Bits", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "iso", "Counter32", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsSatlist=gpsSatlist, gpsMode=gpsMode, symmBroadband=symmBroadband, net=net, etc=etc, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, symmSnmpManagement=symmSnmpManagement, experiment=experiment, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, etcModel=etcModel, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, syncserver=syncserver, symmTTM=symmTTM, ntpSysLeap=ntpSysLeap, products=products, ntpSysClock=ntpSysClock, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, dialup=dialup, nts=nts, xli=xli, ntpSystem=ntpSystem, ntpSysError=ntpSysError, s100=s100, gps=gps, ntpSysPoll=ntpSysPoll, tyming=tyming, version=version, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, ntpSysMode=ntpSysMode, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, symmCmipManagement=symmCmipManagement)
