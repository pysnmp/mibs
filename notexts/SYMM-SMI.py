...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, s100=s100, etcVersion=etcVersion, ntpSysClock=ntpSysClock, gpsSatlist=gpsSatlist, ntpSysFreq=ntpSysFreq, nts=nts, dialup=dialup, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, gps=gps, xli=xli, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, ntpSysPhase=ntpSysPhase, net=net, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, symmBroadband=symmBroadband, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, tyming=tyming, tymingStatus=tymingStatus, gpsMode=gpsMode, gpsHealth=gpsHealth, version=version, tymingFlyPeriod=tymingFlyPeriod, symmTimePictra=symmTimePictra, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, etc=etc, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, experiment=experiment, syncserver=syncserver, ts2100=ts2100, symmetricom=symmetricom, gpsPosition=gpsPosition, gpsUTCOffset=gpsUTCOffset, products=products, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, ts2000=ts2000, ntpSysRefTime=ntpSysRefTime)
