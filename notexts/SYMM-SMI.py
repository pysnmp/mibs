...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysError=ntpSysError, nts=nts, tyming=tyming, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDelay=ntpSysRootDelay, products=products, syncserver=syncserver, etc=etc, ntpSysPoll=ntpSysPoll, ts2000=ts2000, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, version=version, tymingTime=tymingTime, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, tymingVersion=tymingVersion, ntpSysProcessor=ntpSysProcessor, experiment=experiment, ntpSysPrecision=ntpSysPrecision, xli=xli, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, s100=s100, net=net, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, dialup=dialup, gpsMode=gpsMode, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, ts2100=ts2100, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, tymingSource=tymingSource, etcModel=etcModel, symmSnmpManagement=symmSnmpManagement, gps=gps, gpsPosition=gpsPosition, symmBroadband=symmBroadband, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra)
