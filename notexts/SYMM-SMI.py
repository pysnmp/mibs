...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, ts2000=ts2000, ntpSysSystem=ntpSysSystem, gpsMode=gpsMode, ntpSystem=ntpSystem, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, symmTimePictra=symmTimePictra, ntpSysNotrust=ntpSysNotrust, symmNetworkManagement=symmNetworkManagement, tymingTime=tymingTime, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, etcAlarmString=etcAlarmString, etc=etc, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, tymingVersion=tymingVersion, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, s100=s100, etcUpgradeServer=etcUpgradeServer, xli=xli, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, ntpSysPrecision=ntpSysPrecision, syncserver=syncserver, gps=gps, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, etcModel=etcModel, version=version, gpsUTCOffset=gpsUTCOffset, experiment=experiment, net=net, tymingSource=tymingSource, tyming=tyming, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, products=products, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, dialup=dialup, ntpSysPeer=ntpSysPeer, nts=nts, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, symmSnmpManagement=symmSnmpManagement)
