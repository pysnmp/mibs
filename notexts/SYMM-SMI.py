...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, tyming=tyming, ntpSysSystem=ntpSysSystem, xli=xli, etcAlarm=etcAlarm, version=version, ntpSysPrecision=ntpSysPrecision, dialup=dialup, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, nts=nts, symmCmipManagement=symmCmipManagement, etc=etc, symmTTM=symmTTM, ntpSysNotrust=ntpSysNotrust, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, s100=s100, products=products, ntpSystem=ntpSystem, tymingTime=tymingTime, symmTimePictra=symmTimePictra, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, ntpSysMode=ntpSysMode, gps=gps, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, experiment=experiment, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, net=net, ntpSysPoll=ntpSysPoll, ntpSysVersion=ntpSysVersion, etcModel=etcModel, ntpSysFreq=ntpSysFreq, tymingSource=tymingSource, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode)
