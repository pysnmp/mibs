...
enterprises, Integer32, Bits, NotificationType, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, TimeTicks, Gauge32, IpAddress, iso, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Bits", "NotificationType", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "IpAddress", "iso", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDelay=ntpSysRootDelay, ts2100=ts2100, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, ntpSysMode=ntpSysMode, ntpSysPoll=ntpSysPoll, s100=s100, etcModel=etcModel, version=version, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, tymingSource=tymingSource, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, dialup=dialup, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, syncserver=syncserver, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, etcAlarm=etcAlarm, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, symmCmipManagement=symmCmipManagement, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, etc=etc, tyming=tyming, ntpSysPhase=ntpSysPhase, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, net=net, tymingTime=tymingTime, etcAlarmString=etcAlarmString, nts=nts, gps=gps, symmNetworkManagement=symmNetworkManagement, products=products, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, ntpSystem=ntpSystem, symmBroadband=symmBroadband, xli=xli, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom)
