...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPrecision=ntpSysPrecision, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, etc=etc, tymingStatus=tymingStatus, etcModel=etcModel, s100=s100, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, dialup=dialup, version=version, ntpSysError=ntpSysError, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, experiment=experiment, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, etcAlarmString=etcAlarmString, etcVersion=etcVersion, gpsHealth=gpsHealth, ts2000=ts2000, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, ntpSysPhase=ntpSysPhase, ntpSysPeer=ntpSysPeer, symmSnmpManagement=symmSnmpManagement, products=products, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, tyming=tyming, ts2100=ts2100, gps=gps, symmBroadband=symmBroadband, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, symmetricom=symmetricom, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, xli=xli, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, ntpSysFreq=ntpSysFreq, net=net, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, nts=nts)
