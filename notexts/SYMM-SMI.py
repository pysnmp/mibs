...
IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Counter32, ObjectIdentity, Unsigned32, ModuleIdentity, iso, Gauge32, Counter64, MibIdentifier, NotificationType, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Counter32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "iso", "Gauge32", "Counter64", "MibIdentifier", "NotificationType", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysClock=ntpSysClock, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, gpsMode=gpsMode, ntpSysPktsReceived=ntpSysPktsReceived, gps=gps, net=net, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, dialup=dialup, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, etcAlarm=etcAlarm, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, etc=etc, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, etcUpgradeServer=etcUpgradeServer, s100=s100, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, nts=nts, ntpSysPhase=ntpSysPhase, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, symmetricom=symmetricom, tyming=tyming, symmBroadband=symmBroadband, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, ts2000=ts2000, ntpSysMode=ntpSysMode, ntpSysProcessor=ntpSysProcessor, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, symmTimePictra=symmTimePictra, xli=xli, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, version=version, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, tymingTime=tymingTime, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, products=products, etcVersion=etcVersion)
