...
Integer32, NotificationType, Unsigned32, IpAddress, ObjectIdentity, MibIdentifier, iso, Bits, NotificationType, ModuleIdentity, Gauge32, Counter32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "Counter32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, ntpSysRefTime=ntpSysRefTime, symmTTM=symmTTM, tymingVersion=tymingVersion, gps=gps, ntpSysClock=ntpSysClock, ntpSysVersion=ntpSysVersion, s100=s100, ntpSystem=ntpSystem, experiment=experiment, nts=nts, symmTimePictra=symmTimePictra, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, gpsSatlist=gpsSatlist, tyming=tyming, symmNetworkManagement=symmNetworkManagement, ntpSysPktsReceived=ntpSysPktsReceived, version=version, etcUpgrade=etcUpgrade, dialup=dialup, etc=etc, ntpSysError=ntpSysError, tymingSource=tymingSource, ts2000=ts2000, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSysLeap=ntpSysLeap, ntpSysPhase=ntpSysPhase, etcModel=etcModel, symmCmipManagement=symmCmipManagement, PYSNMP_MODULE_ID=symmetricom, xli=xli, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, tymingStatus=tymingStatus, gpsPosition=gpsPosition, syncserver=syncserver, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, ts2100=ts2100, ntpSysPoll=ntpSysPoll, tymingTime=tymingTime, ntpSysMode=ntpSysMode, symmetricom=symmetricom, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, symmBroadband=symmBroadband, net=net, products=products, ntpSysSystem=ntpSysSystem, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, etcSerialNbr=etcSerialNbr)
