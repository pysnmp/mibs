...
MibIdentifier, ObjectIdentity, IpAddress, Unsigned32, Counter64, enterprises, Integer32, NotificationType, TimeTicks, iso, NotificationType, Gauge32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter64", "enterprises", "Integer32", "NotificationType", "TimeTicks", "iso", "NotificationType", "Gauge32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, products=products, PYSNMP_MODULE_ID=symmetricom, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, gpsMode=gpsMode, dialup=dialup, ntpSysLeap=ntpSysLeap, etcVersion=etcVersion, etcUpgrade=etcUpgrade, etcModel=etcModel, symmSnmpManagement=symmSnmpManagement, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, ntpSystem=ntpSystem, ts2100=ts2100, xli=xli, ntpSysPhase=ntpSysPhase, tymingSource=tymingSource, net=net, nts=nts, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, tyming=tyming, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, symmTTM=symmTTM, version=version, ntpSysFreq=ntpSysFreq, ts2000=ts2000, gpsHealth=gpsHealth, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, gps=gps, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, s100=s100, syncserver=syncserver, tymingVersion=tymingVersion, etc=etc, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, experiment=experiment, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError)
