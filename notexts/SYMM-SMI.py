...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, ntpSysRootDelay=ntpSysRootDelay, symmetricom=symmetricom, etcAlarm=etcAlarm, etcUpgrade=etcUpgrade, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, net=net, symmBroadband=symmBroadband, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, etcVersion=etcVersion, experiment=experiment, gpsHealth=gpsHealth, etcModel=etcModel, dialup=dialup, syncserver=syncserver, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, xli=xli, tymingVersion=tymingVersion, ntpSysPktsReceived=ntpSysPktsReceived, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, tyming=tyming, version=version, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, products=products, ntpSysLeap=ntpSysLeap, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, etc=etc, ntpSysVersion=ntpSysVersion, gps=gps, gpsMode=gpsMode, etcAlarmString=etcAlarmString, ntpSysClock=ntpSysClock, ts2100=ts2100, ntpSysNotrust=ntpSysNotrust, symmTimePictra=symmTimePictra, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, etcUpgradeServer=etcUpgradeServer, s100=s100, nts=nts, ntpSysRefID=ntpSysRefID)
