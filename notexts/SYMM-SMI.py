...
iso, Bits, NotificationType, ObjectIdentity, TimeTicks, MibIdentifier, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Gauge32, IpAddress, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "NotificationType", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Gauge32", "IpAddress", "Unsigned32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysFreq=ntpSysFreq, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, gpsSatlist=gpsSatlist, ntpSysNotrust=ntpSysNotrust, net=net, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, symmetricom=symmetricom, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, ts2000=ts2000, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, version=version, products=products, s100=s100, ntpSystem=ntpSystem, syncserver=syncserver, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, etcAlarm=etcAlarm, xli=xli, gps=gps, gpsHealth=gpsHealth, gpsMode=gpsMode, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, ntpSysClock=ntpSysClock, experiment=experiment, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysLeap=ntpSysLeap, ntpSysStratum=ntpSysStratum, ts2100=ts2100, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, dialup=dialup, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, nts=nts, etcModel=etcModel, ntpSysRefID=ntpSysRefID)
