...
ObjectIdentity, Counter32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, NotificationType, MibIdentifier, enterprises, Integer32, ModuleIdentity, Bits, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, version=version, etc=etc, ntpSysNotrust=ntpSysNotrust, ntpSysRefTime=ntpSysRefTime, s100=s100, tymingStatus=tymingStatus, etcModel=etcModel, symmetricom=symmetricom, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, ntpSysPhase=ntpSysPhase, ts2100=ts2100, products=products, tyming=tyming, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, nts=nts, symmBroadband=symmBroadband, ntpSysProcessor=ntpSysProcessor, ntpSysClock=ntpSysClock, ntpSysStratum=ntpSysStratum, gps=gps, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, experiment=experiment, tymingVersion=tymingVersion, gpsHealth=gpsHealth, ntpSysPktsReceived=ntpSysPktsReceived, dialup=dialup, net=net, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDelay=ntpSysRootDelay, xli=xli, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, ntpSysMode=ntpSysMode, tymingSource=tymingSource, symmTTM=symmTTM, gpsPosition=gpsPosition, gpsMode=gpsMode, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, syncserver=syncserver, PYSNMP_MODULE_ID=symmetricom)
