...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, ntpSysRefID=ntpSysRefID, gps=gps, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, symmTimePictra=symmTimePictra, gpsHealth=gpsHealth, symmCmipManagement=symmCmipManagement, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, nts=nts, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, ntpSysLeap=ntpSysLeap, etcAlarmString=etcAlarmString, ntpSysNotrust=ntpSysNotrust, net=net, ntpSysMode=ntpSysMode, syncserver=syncserver, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, ntpSysRootDispersion=ntpSysRootDispersion, tymingVersion=tymingVersion, tymingTime=tymingTime, experiment=experiment, symmSnmpManagement=symmSnmpManagement, tymingSource=tymingSource, etcVersion=etcVersion, ntpSysPhase=ntpSysPhase, dialup=dialup, s100=s100, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, symmTTM=symmTTM, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, tyming=tyming, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcAlarm=etcAlarm, symmBroadband=symmBroadband, products=products, etcUpgradeServer=etcUpgradeServer, ntpSysRootDelay=ntpSysRootDelay, version=version, etcUpgrade=etcUpgrade, xli=xli, ts2000=ts2000)
