...
enterprises, Counter32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, NotificationType, Unsigned32, Integer32, ObjectIdentity, MibIdentifier, Bits, TimeTicks, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "NotificationType", "Unsigned32", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", products=products, dialup=dialup, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, tyming=tyming, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, tymingTime=tymingTime, net=net, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, etcAlarm=etcAlarm, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, etcModel=etcModel, ntpSysClock=ntpSysClock, symmetricom=symmetricom, symmTimePictra=symmTimePictra, s100=s100, ts2100=ts2100, ntpSystem=ntpSystem, experiment=experiment, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, ntpSysPrecision=ntpSysPrecision, ntpSysRootDelay=ntpSysRootDelay, ntpSysFreq=ntpSysFreq, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, etcSerialNbr=etcSerialNbr, ntpSysRefTime=ntpSysRefTime, gpsMode=gpsMode, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, etc=etc, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, ntpSysRootDispersion=ntpSysRootDispersion, tymingSource=tymingSource, version=version, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, symmBroadband=symmBroadband, nts=nts, gps=gps, syncserver=syncserver, gpsPosition=gpsPosition, tymingStatus=tymingStatus, ts2000=ts2000)
