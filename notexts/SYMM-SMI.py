...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysError=ntpSysError, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, ts2000=ts2000, ntpSysPoll=ntpSysPoll, etcSerialNbr=etcSerialNbr, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, symmetricom=symmetricom, etcAlarm=etcAlarm, symmNetworkManagement=symmNetworkManagement, tymingStatus=tymingStatus, dialup=dialup, ntpSysStratum=ntpSysStratum, experiment=experiment, gpsUTCOffset=gpsUTCOffset, ntpSysSystem=ntpSysSystem, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysMode=ntpSysMode, etc=etc, PYSNMP_MODULE_ID=symmetricom, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, etcAlarmString=etcAlarmString, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, version=version, nts=nts, ntpSystem=ntpSystem, xli=xli, gps=gps, ntpSysPhase=ntpSysPhase, products=products, s100=s100, etcVersion=etcVersion, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ts2100=ts2100, tyming=tyming, ntpSysVersion=ntpSysVersion, ntpSysFreq=ntpSysFreq, tymingSource=tymingSource, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, net=net, gpsMode=gpsMode, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod)
