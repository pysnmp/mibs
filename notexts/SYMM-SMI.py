...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, tymingTime=tymingTime, ntpSysClock=ntpSysClock, ts2000=ts2000, ntpSystem=ntpSystem, etcVersion=etcVersion, ntpSysStratum=ntpSysStratum, symmBroadband=symmBroadband, ts2100=ts2100, ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, etcAlarm=etcAlarm, tyming=tyming, dialup=dialup, etcModel=etcModel, symmCmipManagement=symmCmipManagement, gpsMode=gpsMode, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, tymingVersion=tymingVersion, experiment=experiment, symmetricom=symmetricom, version=version, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, s100=s100, ntpSysPktsReceived=ntpSysPktsReceived, gpsSatlist=gpsSatlist, symmTTM=symmTTM, ntpSysLeap=ntpSysLeap, xli=xli, etcUpgrade=etcUpgrade, ntpSysPhase=ntpSysPhase, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, gps=gps, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, ntpSysVersion=ntpSysVersion, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, ntpSysPeer=ntpSysPeer, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, etc=etc, products=products, PYSNMP_MODULE_ID=symmetricom, gpsPosition=gpsPosition, net=net, ntpSysNotrust=ntpSysNotrust, tymingFlyPeriod=tymingFlyPeriod)
