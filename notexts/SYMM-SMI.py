...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, xli=xli, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, tyming=tyming, gpsSatlist=gpsSatlist, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, etc=etc, etcUpgradeServer=etcUpgradeServer, ntpSysPoll=ntpSysPoll, symmTTM=symmTTM, symmBroadband=symmBroadband, products=products, dialup=dialup, ntpSysRefTime=ntpSysRefTime, symmetricom=symmetricom, etcAlarmString=etcAlarmString, ntpSysRootDelay=ntpSysRootDelay, symmCmipManagement=symmCmipManagement, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, ts2000=ts2000, net=net, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, ntpSysMode=ntpSysMode, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, version=version, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, ntpSysError=ntpSysError, gpsUTCOffset=gpsUTCOffset, ntpSysRefID=ntpSysRefID, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, ts2100=ts2100, ntpSysStratum=ntpSysStratum, ntpSystem=ntpSystem, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, experiment=experiment, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, gpsPosition=gpsPosition, etcModel=etcModel, ntpSysSystem=ntpSysSystem, ntpSysPhase=ntpSysPhase, ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, etcAlarm=etcAlarm, s100=s100, ntpSysPrecision=ntpSysPrecision)
