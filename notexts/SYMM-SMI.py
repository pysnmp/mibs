...
NotificationType, Counter32, ObjectIdentity, Gauge32, TimeTicks, NotificationType, ModuleIdentity, iso, Unsigned32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "ObjectIdentity", "Gauge32", "TimeTicks", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, gps=gps, ntpSysRefTime=ntpSysRefTime, gpsHealth=gpsHealth, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, ts2000=ts2000, ntpSysPoll=ntpSysPoll, ntpSysPrecision=ntpSysPrecision, net=net, symmNetworkManagement=symmNetworkManagement, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, symmTimePictra=symmTimePictra, PYSNMP_MODULE_ID=symmetricom, etcSerialNbr=etcSerialNbr, etcVersion=etcVersion, ntpSysRefID=ntpSysRefID, symmTTM=symmTTM, etcUpgrade=etcUpgrade, version=version, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, tyming=tyming, dialup=dialup, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, ts2100=ts2100, syncserver=syncserver, ntpSystem=ntpSystem, ntpSysPhase=ntpSysPhase, gpsMode=gpsMode, s100=s100, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, tymingVersion=tymingVersion, nts=nts, ntpSysPktsReceived=ntpSysPktsReceived, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, etc=etc, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, products=products, symmetricom=symmetricom, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, symmBroadband=symmBroadband, xli=xli, tymingSource=tymingSource, ntpSysStratum=ntpSysStratum, experiment=experiment)
