...
TimeTicks, NotificationType, Counter64, ObjectIdentity, MibIdentifier, IpAddress, ModuleIdentity, Bits, Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "IpAddress", "ModuleIdentity", "Bits", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, experiment=experiment, ntpSysVersion=ntpSysVersion, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, ntpSysLeap=ntpSysLeap, etcModel=etcModel, etcVersion=etcVersion, net=net, syncserver=syncserver, gpsUTCOffset=gpsUTCOffset, ntpSysRootDelay=ntpSysRootDelay, gpsSatlist=gpsSatlist, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, tymingStatus=tymingStatus, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ntpSysRootDispersion=ntpSysRootDispersion, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ts2000=ts2000, tyming=tyming, etc=etc, tymingTime=tymingTime, etcAlarm=etcAlarm, tymingVersion=tymingVersion, ntpSysPrecision=ntpSysPrecision, gps=gps, s100=s100, etcUpgradeServer=etcUpgradeServer, ntpSystem=ntpSystem, ts2100=ts2100, dialup=dialup, etcAlarmString=etcAlarmString, nts=nts, symmCmipManagement=symmCmipManagement, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, xli=xli, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, products=products, version=version)
