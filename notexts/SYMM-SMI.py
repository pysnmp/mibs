...
Bits, TimeTicks, Unsigned32, ObjectIdentity, Gauge32, Counter64, ModuleIdentity, enterprises, Counter32, IpAddress, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "ModuleIdentity", "enterprises", "Counter32", "IpAddress", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, version=version, ntpSysVersion=ntpSysVersion, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, dialup=dialup, etcModel=etcModel, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, tymingStatus=tymingStatus, xli=xli, ntpSysLeap=ntpSysLeap, etcVersion=etcVersion, gpsPosition=gpsPosition, gps=gps, products=products, net=net, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, ntpSysPoll=ntpSysPoll, tyming=tyming, ntpSysFreq=ntpSysFreq, nts=nts, ntpSysProcessor=ntpSysProcessor, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, ntpSysRefID=ntpSysRefID, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, gpsSatlist=gpsSatlist, etc=etc, symmSnmpManagement=symmSnmpManagement, ntpSysNotrust=ntpSysNotrust, ntpSysMode=ntpSysMode, syncserver=syncserver, symmTimePictra=symmTimePictra, s100=s100, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, ts2000=ts2000, ntpSysRefTime=ntpSysRefTime, symmTTM=symmTTM, ts2100=ts2100, tymingSource=tymingSource)
