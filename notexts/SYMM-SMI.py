...
IpAddress, Gauge32, Unsigned32, iso, Integer32, Bits, NotificationType, Counter32, ObjectIdentity, MibIdentifier, TimeTicks, Counter64, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Unsigned32", "iso", "Integer32", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, experiment=experiment, etcAlarmString=etcAlarmString, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, s100=s100, dialup=dialup, ntpSysProcessor=ntpSysProcessor, tyming=tyming, etcAlarm=etcAlarm, gpsMode=gpsMode, symmNetworkManagement=symmNetworkManagement, gpsSatlist=gpsSatlist, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, symmTTM=symmTTM, ntpSysClock=ntpSysClock, etc=etc, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, gpsHealth=gpsHealth, xli=xli, products=products, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, ntpSystem=ntpSystem, syncserver=syncserver, version=version, tymingSource=tymingSource, symmetricom=symmetricom, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, tymingTime=tymingTime, tymingStatus=tymingStatus, gpsPosition=gpsPosition, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, nts=nts, ntpSysRefTime=ntpSysRefTime, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, ntpSysVersion=ntpSysVersion, gps=gps, net=net, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq)
