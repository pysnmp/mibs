...
Counter64, NotificationType, Gauge32, enterprises, Integer32, IpAddress, MibIdentifier, Unsigned32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Gauge32", "enterprises", "Integer32", "IpAddress", "MibIdentifier", "Unsigned32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement, etcVersion=etcVersion, tymingStatus=tymingStatus, gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, gpsMode=gpsMode, gps=gps, etcModel=etcModel, products=products, symmSnmpManagement=symmSnmpManagement, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, net=net, etcSerialNbr=etcSerialNbr, ntpSysNotrust=ntpSysNotrust, s100=s100, ntpSysMode=ntpSysMode, etc=etc, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, tymingFlyPeriod=tymingFlyPeriod, xli=xli, ntpSysVersion=ntpSysVersion, ntpSysPrecision=ntpSysPrecision, ts2100=ts2100, ntpSysClock=ntpSysClock, nts=nts, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, syncserver=syncserver, ts2000=ts2000, etcAlarm=etcAlarm, version=version, tyming=tyming, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, dialup=dialup, ntpSysRefTime=ntpSysRefTime, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, experiment=experiment, symmTTM=symmTTM, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, symmBroadband=symmBroadband, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq)
