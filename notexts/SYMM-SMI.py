...
IpAddress, Integer32, Bits, Unsigned32, MibIdentifier, NotificationType, ObjectIdentity, Counter64, TimeTicks, Gauge32, ModuleIdentity, NotificationType, Counter32, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "Bits", "Unsigned32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Counter64", "TimeTicks", "Gauge32", "ModuleIdentity", "NotificationType", "Counter32", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, tymingVersion=tymingVersion, ntpSysClock=ntpSysClock, xli=xli, tyming=tyming, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, nts=nts, tymingSource=tymingSource, syncserver=syncserver, gpsHealth=gpsHealth, products=products, etcVersion=etcVersion, etcModel=etcModel, etcUpgrade=etcUpgrade, tymingStatus=tymingStatus, etc=etc, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, etcAlarm=etcAlarm, s100=s100, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, ts2000=ts2000, ntpSysMode=ntpSysMode, PYSNMP_MODULE_ID=symmetricom, dialup=dialup, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode, symmBroadband=symmBroadband, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, gps=gps, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, tymingFlyPeriod=tymingFlyPeriod, net=net, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom)
