...
Integer32, Counter64, MibIdentifier, Bits, NotificationType, enterprises, NotificationType, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, iso, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "MibIdentifier", "Bits", "NotificationType", "enterprises", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "iso", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, s100=s100, symmTimePictra=symmTimePictra, dialup=dialup, etc=etc, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, etcUpgrade=etcUpgrade, net=net, tymingStatus=tymingStatus, experiment=experiment, gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, etcModel=etcModel, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, symmCmipManagement=symmCmipManagement, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, symmTTM=symmTTM, syncserver=syncserver, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, ntpSysSystem=ntpSysSystem, xli=xli, tymingSource=tymingSource, tymingVersion=tymingVersion, gps=gps, etcVersion=etcVersion, version=version, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, ts2100=ts2100, tymingTime=tymingTime, etcAlarm=etcAlarm, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, gpsMode=gpsMode, products=products, ts2000=ts2000, nts=nts, ntpSysProcessor=ntpSysProcessor, symmSnmpManagement=symmSnmpManagement, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, etcSerialNbr=etcSerialNbr)
