...
mibBuilder.exportSymbols("SYMM-SMI", products=products, etcUpgrade=etcUpgrade, gpsPosition=gpsPosition, ntpSysPktsReceived=ntpSysPktsReceived, gpsSatlist=gpsSatlist, nts=nts, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, net=net, etcUpgradeServer=etcUpgradeServer, symmTimePictra=symmTimePictra, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, gpsUTCOffset=gpsUTCOffset, etcAlarmString=etcAlarmString, etcSerialNbr=etcSerialNbr, etc=etc, ntpSysMode=ntpSysMode, ntpSysRefTime=ntpSysRefTime, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, ntpSystem=ntpSystem, tymingTime=tymingTime, tymingSource=tymingSource, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, ts2000=ts2000, dialup=dialup, version=version, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, s100=s100, tyming=tyming, ntpSysSystem=ntpSysSystem, ts2100=ts2100, gpsMode=gpsMode, gps=gps, etcModel=etcModel, syncserver=syncserver, symmBroadband=symmBroadband, etcVersion=etcVersion, xli=xli, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, ntpSysPrecision=ntpSysPrecision, PYSNMP_MODULE_ID=symmetricom, tymingVersion=tymingVersion, ntpSysFreq=ntpSysFreq)
