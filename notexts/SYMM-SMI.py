...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, xli=xli, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, syncserver=syncserver, version=version, ntpSysRefTime=ntpSysRefTime, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, nts=nts, ntpSysPhase=ntpSysPhase, etcVersion=etcVersion, net=net, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, symmTTM=symmTTM, gpsSatlist=gpsSatlist, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, gpsMode=gpsMode, tyming=tyming, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, ntpSystem=ntpSystem, products=products, dialup=dialup, ntpSysError=ntpSysError, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, tymingTime=tymingTime, symmetricom=symmetricom, ntpSysFreq=ntpSysFreq, etcAlarm=etcAlarm, experiment=experiment, ntpSysMode=ntpSysMode, etc=etc, ts2000=ts2000, etcAlarmString=etcAlarmString, s100=s100, ts2100=ts2100, etcSerialNbr=etcSerialNbr, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, etcModel=etcModel, gps=gps)
