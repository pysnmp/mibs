...
mibBuilder.exportSymbols("SYMM-SMI", etcUpgrade=etcUpgrade, syncserver=syncserver, net=net, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, gpsSatlist=gpsSatlist, tyming=tyming, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, experiment=experiment, etcModel=etcModel, nts=nts, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, xli=xli, gpsMode=gpsMode, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, etc=etc, symmBroadband=symmBroadband, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, gpsPosition=gpsPosition, version=version, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, tymingTime=tymingTime, etcAlarmString=etcAlarmString, ntpSysRefID=ntpSysRefID, etcAlarm=etcAlarm, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, gps=gps, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, products=products, etcSerialNbr=etcSerialNbr, ntpSysSystem=ntpSysSystem, s100=s100, ts2000=ts2000, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, dialup=dialup)
