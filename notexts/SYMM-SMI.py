...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, symmSnmpManagement=symmSnmpManagement, net=net, products=products, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, s100=s100, PYSNMP_MODULE_ID=symmetricom, tymingFlyPeriod=tymingFlyPeriod, syncserver=syncserver, etcSerialNbr=etcSerialNbr, etc=etc, ts2100=ts2100, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, gpsMode=gpsMode, ntpSysLeap=ntpSysLeap, ntpSysPeer=ntpSysPeer, etcModel=etcModel, ntpSysNotrust=ntpSysNotrust, dialup=dialup, ntpSysRefID=ntpSysRefID, xli=xli, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, gps=gps, ntpSysRefTime=ntpSysRefTime, symmTimePictra=symmTimePictra, nts=nts, ntpSysPoll=ntpSysPoll, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, version=version, tymingVersion=tymingVersion, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, experiment=experiment, symmTTM=symmTTM, tymingStatus=tymingStatus, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming)
