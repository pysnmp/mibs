...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, ntpSysFreq=ntpSysFreq, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, syncserver=syncserver, dialup=dialup, etcUpgrade=etcUpgrade, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, tyming=tyming, gpsMode=gpsMode, tymingVersion=tymingVersion, experiment=experiment, xli=xli, ntpSysSystem=ntpSysSystem, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, etcModel=etcModel, etcVersion=etcVersion, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, ntpSysPeer=ntpSysPeer, net=net, ntpSystem=ntpSystem, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, s100=s100, symmTimePictra=symmTimePictra, tymingStatus=tymingStatus, nts=nts, ts2000=ts2000, ntpSysNotrust=ntpSysNotrust, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, ntpSysProcessor=ntpSysProcessor, version=version, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDelay=ntpSysRootDelay, ntpSysPrecision=ntpSysPrecision, gpsPosition=gpsPosition, ntpSysStratum=ntpSysStratum, gpsHealth=gpsHealth, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, ntpSysPoll=ntpSysPoll, products=products, ntpSysRootDispersion=ntpSysRootDispersion, gps=gps, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysPhase=ntpSysPhase)
