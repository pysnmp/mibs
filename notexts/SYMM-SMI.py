...
mibBuilder.exportSymbols("SYMM-SMI", dialup=dialup, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, xli=xli, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, syncserver=syncserver, products=products, net=net, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysLeap=ntpSysLeap, s100=s100, ntpSysRootDelay=ntpSysRootDelay, tyming=tyming, ts2000=ts2000, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, tymingTime=tymingTime, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM, gpsUTCOffset=gpsUTCOffset, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, version=version, symmSnmpManagement=symmSnmpManagement, etcVersion=etcVersion, PYSNMP_MODULE_ID=symmetricom, ntpSystem=ntpSystem, ntpSysClock=ntpSysClock, gpsHealth=gpsHealth, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, nts=nts, ntpSysPhase=ntpSysPhase, etcModel=etcModel, ts2100=ts2100, ntpSysStratum=ntpSysStratum, etc=etc, tymingVersion=tymingVersion, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, experiment=experiment, etcAlarm=etcAlarm, tymingSource=tymingSource, tymingStatus=tymingStatus)
