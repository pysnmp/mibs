...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, s100=s100, ntpSysMode=ntpSysMode, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, products=products, gpsHealth=gpsHealth, ntpSysProcessor=ntpSysProcessor, etc=etc, syncserver=syncserver, ntpSysPeer=ntpSysPeer, tymingTime=tymingTime, tymingVersion=tymingVersion, ts2100=ts2100, ntpSysRootDelay=ntpSysRootDelay, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, etcVersion=etcVersion, ts2000=ts2000, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, net=net, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, gpsMode=gpsMode, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, version=version, ntpSysVersion=ntpSysVersion, etcAlarm=etcAlarm, gps=gps, symmCmipManagement=symmCmipManagement, experiment=experiment, xli=xli, etcUpgradeServer=etcUpgradeServer, nts=nts, dialup=dialup, ntpSysPrecision=ntpSysPrecision, symmetricom=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, ntpSysPhase=ntpSysPhase, etcModel=etcModel, tyming=tyming, ntpSysNotrust=ntpSysNotrust, ntpSysClock=ntpSysClock, PYSNMP_MODULE_ID=symmetricom)
