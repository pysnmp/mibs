...
Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Counter64, ModuleIdentity, MibIdentifier, Counter32, Integer32, Gauge32, iso, TimeTicks, IpAddress, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Counter64", "ModuleIdentity", "MibIdentifier", "Counter32", "Integer32", "Gauge32", "iso", "TimeTicks", "IpAddress", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmSnmpManagement=symmSnmpManagement, dialup=dialup, nts=nts, experiment=experiment, tymingStatus=tymingStatus, tymingSource=tymingSource, ntpSysError=ntpSysError, symmTimePictra=symmTimePictra, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap, symmBroadband=symmBroadband, etc=etc, net=net, s100=s100, ntpSysPhase=ntpSysPhase, ts2100=ts2100, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, tyming=tyming, PYSNMP_MODULE_ID=symmetricom, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, etcUpgradeServer=etcUpgradeServer, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, products=products, symmTTM=symmTTM, xli=xli, gpsSatlist=gpsSatlist, etcModel=etcModel, syncserver=syncserver, ts2000=ts2000, version=version, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, gpsPosition=gpsPosition, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, symmetricom=symmetricom, gps=gps, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll)
