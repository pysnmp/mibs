...
NotificationType, NotificationType, iso, Gauge32, ObjectIdentity, IpAddress, Integer32, Counter64, Counter32, TimeTicks, ModuleIdentity, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "Counter32", "TimeTicks", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, ntpSysPeer=ntpSysPeer, symmSnmpManagement=symmSnmpManagement, etcModel=etcModel, net=net, ntpSysPoll=ntpSysPoll, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, ntpSysClock=ntpSysClock, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, etc=etc, symmCmipManagement=symmCmipManagement, tyming=tyming, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, gps=gps, nts=nts, version=version, dialup=dialup, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment, tymingVersion=tymingVersion, etcVersion=etcVersion, ntpSysRefTime=ntpSysRefTime, etcAlarm=etcAlarm, ntpSystem=ntpSystem, gpsPosition=gpsPosition, syncserver=syncserver, ntpSysError=ntpSysError, tymingStatus=tymingStatus, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, s100=s100, etcAlarmString=etcAlarmString, xli=xli, symmetricom=symmetricom, ts2000=ts2000, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, gpsSatlist=gpsSatlist, products=products)
