...
mibBuilder.exportSymbols("SYMM-SMI", version=version, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, tymingStatus=tymingStatus, PYSNMP_MODULE_ID=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, xli=xli, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, ntpSysPoll=ntpSysPoll, symmTTM=symmTTM, experiment=experiment, ntpSysClock=ntpSysClock, gpsHealth=gpsHealth, ntpSysPhase=ntpSysPhase, etcModel=etcModel, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, etcUpgrade=etcUpgrade, tymingSource=tymingSource, ntpSysMode=ntpSysMode, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, etcUpgradeServer=etcUpgradeServer, etcAlarm=etcAlarm, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, ts2000=ts2000, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, symmTimePictra=symmTimePictra, products=products, s100=s100, net=net, gpsPosition=gpsPosition, gps=gps, symmBroadband=symmBroadband, ntpSysProcessor=ntpSysProcessor, dialup=dialup, ntpSysNotrust=ntpSysNotrust, nts=nts, etc=etc, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement)
