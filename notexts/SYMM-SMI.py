...
Bits, iso, Counter32, ObjectIdentity, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, NotificationType, Integer32, IpAddress, NotificationType, Counter64, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "NotificationType", "Integer32", "IpAddress", "NotificationType", "Counter64", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", products=products, gpsSatlist=gpsSatlist, symmetricom=symmetricom, etc=etc, dialup=dialup, ntpSysPeer=ntpSysPeer, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, etcAlarmString=etcAlarmString, symmCmipManagement=symmCmipManagement, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, etcVersion=etcVersion, etcAlarm=etcAlarm, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, experiment=experiment, net=net, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, gpsMode=gpsMode, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, ts2000=ts2000, s100=s100, ntpSysStratum=ntpSysStratum, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq, syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, version=version, ntpSysClock=ntpSysClock, xli=xli, tyming=tyming, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, gpsUTCOffset=gpsUTCOffset, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement, gps=gps, tymingSource=tymingSource, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, nts=nts, ntpSysError=ntpSysError)
