...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopback=channelBLoopback, softwareVersion=softwareVersion, targetMACAddress=targetMACAddress, syslogControl=syslogControl, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogClientTrap=syslogClientTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsGroup=dfsGroup, groupID=groupID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControl=phyControl, userTable=userTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aAAControl=aAAControl, receivePower=receivePower, receiveChannel=receiveChannel, syslogControlGroup=syslogControlGroup, txColorCode=txColorCode, transmitChannel=transmitChannel, userPassword=userPassword, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBCableLength=channelBCableLength, encryptionGroup=encryptionGroup, resetGroup=resetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, searchState=searchState, incompatibleRegionCodes=incompatibleRegionCodes, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, targetRange=targetRange, rxColorCode=rxColorCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitModulationMode=transmitModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, dataPortFiberStatus=dataPortFiberStatus, rawReceivePower=rawReceivePower, longitude=longitude, telecomGroup=telecomGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControl=snmpControl, smtp=smtp, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bridgeGroup=bridgeGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, pubStats=pubStats, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteRxTargetPower=remoteRxTargetPower, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortStatus=dataPortStatus, systemReset=systemReset, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerRetries=sNTPServerRetries, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, installArmState=installArmState, pubStatsGroup=pubStatsGroup, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sntp=sntp, aggregateDataRate=aggregateDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTable=sNTPServerTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarmTrap=secureModeAlarmTrap, iPv6PrefixLength=iPv6PrefixLength, ptpGroups=ptpGroups, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, range=range, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, frequencyVariant=frequencyVariant, telecom=telecom, antennaGain=antennaGain, sNTPSync=sNTPSync, tDDSynchronizationMode=tDDSynchronizationMode, hAZLOCConfiguration=hAZLOCConfiguration, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelSelection=telecomsChannelSelection, dataPortAutoMdix=dataPortAutoMdix, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBLineCode=channelBLineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveModulationModeDetail=receiveModulationModeDetail, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddressType=remoteInternetAddressType, dfsPeaks=dfsPeaks, channelACableLength=channelACableLength, dataPortDisabledWarning=dataPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, ethernetBridgingStatus=ethernetBridgingStatus, daylightSaving=daylightSaving, channelALoopback=channelALoopback, dfsTableNumber=dfsTableNumber, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, licence=licence, dfsTableEntry=dfsTableEntry, bandwidthVariant=bandwidthVariant, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, telecomsChannelAStatus=telecomsChannelAStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rangingMode=rangingMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installStatus=installStatus, siteName=siteName, channelALineCode=channelALineCode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, dfs=dfs, versions=versions, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementGroup=managementGroup, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortDisabledWarning=managementPortDisabledWarning, eIRP=eIRP, ethernet=ethernet, securityLevel=securityLevel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementaryGroup=supplementaryGroup, bridge=bridge, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, bootVersion=bootVersion, dfsTableIndex=dfsTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPrimaryServer=sNTPPrimaryServer, subnetMask=subnetMask, altitude=altitude, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, managementPortStatus=managementPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTable=dfsTable, syslogState=syslogState, alarms=alarms, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementVID=vLANManagementVID, gatewayIPAddress=gatewayIPAddress, configuration=configuration, ethernetGroup=ethernetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPState=sNTPState, smtpGroup=smtpGroup, ptpTraps=ptpTraps, licenceGroup=licenceGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPollInterval=sNTPPollInterval, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, productVariant=productVariant, ptp=ptp, ptmp=ptmp, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, iPv6Address=iPv6Address, vLANManagementPriority=vLANManagementPriority, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptp600=ptp600, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, telecomsInterface=telecomsInterface, userRole=userRole, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPVersion=iPVersion, cambium=cambium, reset=reset, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productName=productName, managementMode=managementMode, linkSymmetry=linkSymmetry, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, sNTPServerStatus=sNTPServerStatus, telecomsChannelBStatus=telecomsChannelBStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, byteErrorRatio=byteErrorRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkAvailability=wirelessLinkAvailability, latitude=latitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, hTTPSPortNumber=hTTPSPortNumber, regionCodeTrap=regionCodeTrap, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTable=mPLSTCPriorityTable, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, sntpGroup=sntpGroup, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTimeout=sNTPServerTimeout, localPacketFiltering=localPacketFiltering, regionCode=regionCode, receiveModulationMode=receiveModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitDataRate=transmitDataRate, userName=userName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDControl=tDDControl, managementPortStatusTrap=managementPortStatusTrap, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, channelBLoopbackTrap=channelBLoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, l2CPPriorityTable=l2CPPriorityTable, channelALoopbackTrap=channelALoopbackTrap, userTableNumber=userTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
