...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, altitude=altitude, bridgeGroup=bridgeGroup, siteName=siteName, systemReset=systemReset, userPassword=userPassword, supplementaryGroup=supplementaryGroup, searchState=searchState, channelACableLength=channelACableLength, securityLevel=securityLevel, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelBandwidth=channelBandwidth, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, licence=licence, telecomsChannelBStatus=telecomsChannelBStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable, iPv6Address=iPv6Address, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecom=telecom, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableIndex=sNTPServerTableIndex, range=range, channelBLineCode=channelBLineCode, vectorError=vectorError, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, channelALoopback=channelALoopback, regionCodeTrap=regionCodeTrap, dfs=dfs, transmitChannel=transmitChannel, hAZLOCConfiguration=hAZLOCConfiguration, bandwidthVariant=bandwidthVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, ethernetPriorityTable=ethernetPriorityTable, rawReceivePower=rawReceivePower, alarmsGroup=alarmsGroup, userEnabled=userEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTable=l2CPPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, dfsTableIndex=dfsTableIndex, aAAControlGroup=aAAControlGroup, dataPortFiberStatus=dataPortFiberStatus, masterSlaveMode=masterSlaveMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkLoss=linkLoss, sNTPServerStatus=sNTPServerStatus, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, ethernetPriorityTableIndex=ethernetPriorityTableIndex, frequencyVariant=frequencyVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteRxTargetPower=remoteRxTargetPower, managementPortDisabledWarning=managementPortDisabledWarning, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelALoopbackTrap=channelALoopbackTrap, pubStats=pubStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxColorCode=rxColorCode, managementMode=managementMode, sMTPEnabledMessages=sMTPEnabledMessages, txColorCode=txColorCode, aAAControl=aAAControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, transmitPower=transmitPower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userRole=userRole, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogState=syslogState, ptpGroups=ptpGroups, groupID=groupID, smtpGroup=smtpGroup, installStatus=installStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPv3Enable=sNMPv3Enable, configuration=configuration, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, userName=userName, localPacketFiltering=localPacketFiltering, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelSelection=telecomsChannelSelection, channelBLoopback=channelBLoopback, ethernet=ethernet, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, installStatusTrap=installStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteInternetAddress=remoteInternetAddress, dataPortStatusTrap=dataPortStatusTrap, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, sMTPEmailAlert=sMTPEmailAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTimeout=sNTPServerTimeout, ptp=ptp, rangingMode=rangingMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, versions=versions, versionsGroup=versionsGroup, resetGroup=resetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarms=alarms, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, ethernetBridgingStatus=ethernetBridgingStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, snmpControl=snmpControl, tDDControl=tDDControl, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControlGroup=snmpControlGroup, timeZone=timeZone, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, channelALineCode=channelALineCode, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, phyControl=phyControl, telecomsInterface=telecomsInterface, hTTPPortNumber=hTTPPortNumber, gatewayIPAddress=gatewayIPAddress, linkModeOptimisation=linkModeOptimisation, ptp600=ptp600, wirelessLinkStatus=wirelessLinkStatus, sNTPServerRetries=sNTPServerRetries, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPSync=sNTPSync, antennaGain=antennaGain, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBCableLength=channelBCableLength, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, targetRange=targetRange, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, iPv4Address=iPv4Address, automaticTxPowerControl=automaticTxPowerControl)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingAvailability=ethernetBridgingAvailability, supplementary=supplementary, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelChangeTrap=channelChangeTrap, managementPortStatusTrap=managementPortStatusTrap, syslogClient=syslogClient, userTableIndex=userTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, iPv6GatewayAddress=iPv6GatewayAddress, remoteInternetAddressType=remoteInternetAddressType, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarning=dataPortDisabledWarning, ptmp=ptmp, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, sNMPTrapTable=sNMPTrapTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, bridge=bridge, remoteIPAddress=remoteIPAddress, cambium=cambium, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, transmitModulationMode=transmitModulationMode, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, pubStatsGroup=pubStatsGroup, productName=productName, latitude=latitude, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, sNTPServerTable=sNTPServerTable, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap)
