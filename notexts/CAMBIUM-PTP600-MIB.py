...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", timeZone=timeZone, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, txColorCode=txColorCode, sNTPServerStatus=sNTPServerStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, installArmState=installArmState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, latitude=latitude, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarning=dataPortDisabledWarning, channelBCableLength=channelBCableLength, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, regionCode=regionCode, channelACableLength=channelACableLength, frequencyVariant=frequencyVariant, altitude=altitude, systemReset=systemReset, pubStatsGroup=pubStatsGroup, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortDisabledWarning=managementPortDisabledWarning, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, iPv6PrefixLength=iPv6PrefixLength, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, sNTPSyncTrap=sNTPSyncTrap, rangingMode=rangingMode, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, supplementary=supplementary, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortFiberStatus=dataPortFiberStatus, masterSlaveMode=masterSlaveMode, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteRxTargetPower=remoteRxTargetPower, linkLoss=linkLoss, receiveDataRate=receiveDataRate, sNTPServerTableNumber=sNTPServerTableNumber, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetRange=targetRange, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, regionCodeTrap=regionCodeTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, longitude=longitude, iPv6Address=iPv6Address, channelChangeTrap=channelChangeTrap, ptp=ptp, localPacketFiltering=localPacketFiltering, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, securityLevel=securityLevel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, transmitPower=transmitPower, sNTPState=sNTPState, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogControl=syslogControl, rxColorCode=rxColorCode, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkName=linkName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDControl=tDDControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, telecom=telecom, supplementaryGroup=supplementaryGroup, sNMPCommunityString=sNMPCommunityString, sNTPServerTableEntry=sNTPServerTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, channelALineCode=channelALineCode, userName=userName, smtp=smtp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALoopback=channelALoopback, syslogState=syslogState, licence=licence, receivePower=receivePower, notificationsGroup=notificationsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, userTable=userTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteInternetAddress=remoteInternetAddress, management=management, tFTPServerInternetAddressType=tFTPServerInternetAddressType, searchState=searchState, dfs=dfs, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, eIRP=eIRP, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, iPVersion=iPVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveChannel=receiveChannel, bandwidthVariant=bandwidthVariant, managementPortStatus=managementPortStatus, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, installStatus=installStatus, syslogStateTrap=syslogStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableNumber=sNMPTrapTableNumber, gatewayIPAddress=gatewayIPAddress, dfsMeans=dfsMeans, channelBLoopback=channelBLoopback, rawReceivePower=rawReceivePower, resetGroup=resetGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableIndex=userTableIndex, encryption=encryption, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, hardwareVersion=hardwareVersion, userTableNumber=userTableNumber, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, targetMACAddress=targetMACAddress, userRole=userRole, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, managementMode=managementMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, iPv4Address=iPv4Address, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitChannel=transmitChannel, tDDControlGroup=tDDControlGroup, softwareVersion=softwareVersion, telecomGroup=telecomGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, sNTPServerTable=sNTPServerTable, versionsGroup=versionsGroup, syslogControlGroup=syslogControlGroup, sNTPLastSync=sNTPLastSync, tDDSynchronizationMode=tDDSynchronizationMode, managementPortStatusTrap=managementPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelSelection=telecomsChannelSelection, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, groupID=groupID, qOSPriorityScheme=qOSPriorityScheme, sNTPServerRetries=sNTPServerRetries, receiveFreqMHz=receiveFreqMHz, secureModeAlarm=secureModeAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, sntp=sntp, installStatusTrap=installStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, range=range, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, ethernetPriorityTableEntry=ethernetPriorityTableEntry, subnetMask=subnetMask, dfsTable=dfsTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementGroup=managementGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cambium=cambium, ptp600=ptp600, pubStats=pubStats, productVariant=productVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitDataRate=transmitDataRate)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6GatewayAddress=iPv6GatewayAddress, secureModeAlarmTrap=secureModeAlarmTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, bridgeGroup=bridgeGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, siteName=siteName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerIPAddress=sNTPServerIPAddress, bridge=bridge, versions=versions, alarms=alarms, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementPriority=vLANManagementPriority, daylightSaving=daylightSaving, aAAControlGroup=aAAControlGroup, ptpCompliance=ptpCompliance, remoteInternetAddressType=remoteInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTableIndex=sNTPServerTableIndex, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelALoopbackTrap=channelALoopbackTrap, channelBLineCode=channelBLineCode, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, linkModeOptimisation=linkModeOptimisation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, l2CPPriorityTableEntry=l2CPPriorityTableEntry, phyStatus=phyStatus)
