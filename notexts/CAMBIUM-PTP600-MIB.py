...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatch=dataPortConfigurationMismatch, byteErrorRatio=byteErrorRatio, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControl=tDDControl, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, userTableEntry=userTableEntry, cableLoss=cableLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, phyStatus=phyStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, groupID=groupID, dataPortFiberStatus=dataPortFiberStatus, transmitPower=transmitPower, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoMdix=dataPortAutoMdix, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableIndex=sNTPServerTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, frequencyVariant=frequencyVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, localPacketFiltering=localPacketFiltering, bridge=bridge, channelALoopback=channelALoopback, ptpGroups=ptpGroups, transmitChannel=transmitChannel, sNMPCommunityString=sNMPCommunityString, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, pubStats=pubStats, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTable=dfsTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, receiveFreqKHz=receiveFreqKHz, encryption=encryption, phyStatusGroup=phyStatusGroup, masterSlaveMode=masterSlaveMode, qOSPriorityScheme=qOSPriorityScheme, rxColorCode=rxColorCode, secureModeAlarm=secureModeAlarm, syslogStateTrap=syslogStateTrap, ptp600=ptp600, sNTPState=sNTPState, PYSNMP_MODULE_ID=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cambium=cambium, phyControl=phyControl, rangingMode=rangingMode, alarmsGroup=alarmsGroup, sNTPServerTimeout=sNTPServerTimeout, incompatibleRegionCodes=incompatibleRegionCodes, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, targetMACAddress=targetMACAddress, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, channelBCableLength=channelBCableLength, ptmp=ptmp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, rawReceivePower=rawReceivePower, userEnabled=userEnabled, latitude=latitude, altitude=altitude, sntp=sntp, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, remoteInternetAddress=remoteInternetAddress, regionCode=regionCode, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLineCode=channelBLineCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogControlGroup=syslogControlGroup, ethernetFiberSupport=ethernetFiberSupport, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, sNMPPortNumber=sNMPPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, bridgeGroup=bridgeGroup, channelALineCode=channelALineCode, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, resetGroup=resetGroup, iPVersion=iPVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTableNumber=sNTPServerTableNumber, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTable=mPLSTCPriorityTable, telecom=telecom, dfsTableIndex=dfsTableIndex, smtp=smtp, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, maximumTransmitPower=maximumTransmitPower, siteName=siteName, dataPortStatus=dataPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, searchState=searchState, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerStatus=sNTPServerStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableIndex=userTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installStatus=installStatus, daylightSaving=daylightSaving, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsMeans=dfsMeans, managementPortStatus=managementPortStatus, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerRetries=sNTPServerRetries, bandwidthVariant=bandwidthVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6GatewayAddress=iPv6GatewayAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, userPassword=userPassword, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTable=sNTPServerTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userName=userName, snmpControl=snmpControl, versionsGroup=versionsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, range=range, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveChannel=receiveChannel, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTableNumber=userTableNumber, dfs=dfs, telecomsInterface=telecomsInterface, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, targetRange=targetRange, sNTPPrimaryServer=sNTPPrimaryServer, bootVersion=bootVersion, accessMethod=accessMethod, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitModulationMode=transmitModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, channelALoopbackTrap=channelALoopbackTrap, receiveDataRate=receiveDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, securityLevel=securityLevel, iPv4Address=iPv4Address, unitOutOfCalibration=unitOutOfCalibration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkAvailability=wirelessLinkAvailability, dfsPeaks=dfsPeaks, automaticTxPowerControl=automaticTxPowerControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productVariant=productVariant, ethernet=ethernet)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, dSCPManagementPriority=dSCPManagementPriority, ptpTraps=ptpTraps, phyControlGroup=phyControlGroup, iPv6Address=iPv6Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryptionGroup=encryptionGroup, remoteInternetAddressType=remoteInternetAddressType, licenceGroup=licenceGroup, antennaGain=antennaGain, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBLoopback=channelBLoopback, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, managementPortStatusTrap=managementPortStatusTrap, smtpGroup=smtpGroup, receivePower=receivePower, l2CPPriorityTable=l2CPPriorityTable, systemReset=systemReset, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, softwareVersion=softwareVersion, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, syslogState=syslogState, userTable=userTable, telecomsChannelBStatus=telecomsChannelBStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelACableLength=channelACableLength, userRole=userRole, configuration=configuration, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, linkLoss=linkLoss, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
