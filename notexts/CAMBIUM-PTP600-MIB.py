...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsGroup=dfsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernet=ethernet, telecomGroup=telecomGroup, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, regionCode=regionCode, userName=userName, ethernetGroup=ethernetGroup, qOSPriorityScheme=qOSPriorityScheme, managementPortStatus=managementPortStatus, tDDControlGroup=tDDControlGroup, sNTPServerTimeout=sNTPServerTimeout, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, hTTPPortNumber=hTTPPortNumber, bridgeGroup=bridgeGroup, dfsTableEntry=dfsTableEntry, antennaGain=antennaGain, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, secureModeAlarm=secureModeAlarm, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsMeans=dfsMeans, sNTPServerTable=sNTPServerTable, hAZLOCConfiguration=hAZLOCConfiguration, channelBLineCode=channelBLineCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, sNMPPortNumber=sNMPPortNumber, licenceGroup=licenceGroup, cableLoss=cableLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsTableNumber=dfsTableNumber, productVariant=productVariant, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rawReceivePower=rawReceivePower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPState=sNTPState, syslogState=syslogState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cambium=cambium, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, securityLevel=securityLevel, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitFreqMHz=transmitFreqMHz, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, dfs=dfs, syslogControlGroup=syslogControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, management=management, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveDataRate=receiveDataRate, sntp=sntp, iPv6Address=iPv6Address, l2CPPriorityTable=l2CPPriorityTable, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, snmpControl=snmpControl, iPv4Address=iPv4Address, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bandwidthVariant=bandwidthVariant, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, encryption=encryption, ethernetPriorityTableEntry=ethernetPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, encryptionGroup=encryptionGroup, siteName=siteName, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, userTableIndex=userTableIndex, latitude=latitude, bridge=bridge, telecomsChannelSelection=telecomsChannelSelection, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ptp600=ptp600, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, gatewayIPAddress=gatewayIPAddress, longitude=longitude, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, notificationsGroup=notificationsGroup, alarms=alarms, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, remoteRxTargetPower=remoteRxTargetPower, tFTPServerPortNumber=tFTPServerPortNumber, channelALoopback=channelALoopback, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTable=userTable, aAAControl=aAAControl, eIRP=eIRP, versions=versions, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPVersion=iPVersion, dfsTable=dfsTable, ptpTraps=ptpTraps, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortStatusTrap=managementPortStatusTrap, dfsTableIndex=dfsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, vectorError=vectorError, syslogClientTrap=syslogClientTrap, transmitChannel=transmitChannel, bootVersion=bootVersion, channelALineCode=channelALineCode, dataPortStatus=dataPortStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, rxColorCode=rxColorCode, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, telecomsChannelAStatus=telecomsChannelAStatus, installArmState=installArmState, altitude=altitude, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, txColorCode=txColorCode, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, ptpTrapPrefix=ptpTrapPrefix, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userPassword=userPassword, hardwareVersion=hardwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, channelALoopbackTrap=channelALoopbackTrap, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, targetRange=targetRange, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTable=sNMPTrapTable, phyControlGroup=phyControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, remoteIPAddress=remoteIPAddress, channelBCableLength=channelBCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelBStatus=telecomsChannelBStatus, sNTPLastSync=sNTPLastSync, secureModeAlarmTrap=secureModeAlarmTrap, phyStatusGroup=phyStatusGroup, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, configuration=configuration, managementPortDisabledWarning=managementPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, dataPortFiberStatus=dataPortFiberStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp=ptp, systemClock=systemClock, rangingMode=rangingMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtp=smtp, supplementary=supplementary, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installStatus=installStatus, sNTPServerTableIndex=sNTPServerTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", byteErrorRatio=byteErrorRatio, phyStatus=phyStatus, userEnabled=userEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetPriorityTable=ethernetPriorityTable, sNMPv3Enable=sNMPv3Enable, channelBLoopback=channelBLoopback, reset=reset, sNTPSyncTrap=sNTPSyncTrap, installStatusTrap=installStatusTrap, channelACableLength=channelACableLength, sNTPServerPortNumber=sNTPServerPortNumber, aggregateDataRate=aggregateDataRate, secondarySoftwareVersion=secondarySoftwareVersion, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, telnetPortNumber=telnetPortNumber, groupID=groupID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, automaticTxPowerControl=automaticTxPowerControl, ptpCompliance=ptpCompliance, sNTPServerStatus=sNTPServerStatus, managementGroup=managementGroup, ptmp=ptmp, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, configurationGroup=configurationGroup, phyControl=phyControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecom=telecom, managementMode=managementMode, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup)
