...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, signalStrengthRatio=signalStrengthRatio, remoteRxTargetPower=remoteRxTargetPower, receiveFreqKHz=receiveFreqKHz, latitude=latitude, managementGroup=managementGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, systemClock=systemClock, channelBCableLength=channelBCableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityTable=mPLSTCPriorityTable, byteErrorRatio=byteErrorRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, ethernetFiberSupport=ethernetFiberSupport, channelALoopback=channelALoopback, smtp=smtp, hardwareVersion=hardwareVersion, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBLoopback=channelBLoopback, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, installArmState=installArmState, receiveChannel=receiveChannel, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, iPVersion=iPVersion, telecomsInterface=telecomsInterface, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, userName=userName, linkLoss=linkLoss, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqKHz=transmitFreqKHz, bridge=bridge, ethernetPriorityTableEntry=ethernetPriorityTableEntry, encryptionGroup=encryptionGroup, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, alarmsGroup=alarmsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatus=dataPortFiberStatus, telecom=telecom, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secureModeAlarmTrap=secureModeAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveDataRate=receiveDataRate, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv6Address=iPv6Address, management=management, sMTPServerInternetAddressType=sMTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, remoteInternetAddressType=remoteInternetAddressType, userTable=userTable, supplementaryGroup=supplementaryGroup, productVariant=productVariant, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, licence=licence, iPv6GatewayAddress=iPv6GatewayAddress, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, channelACableLength=channelACableLength, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, reset=reset, phyStatusGroup=phyStatusGroup, telecomGroup=telecomGroup, range=range, rawReceivePower=rawReceivePower, installStatus=installStatus, syslogStateTrap=syslogStateTrap, supplementary=supplementary, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableEntry=dfsTableEntry, txColorCode=txColorCode, timeZone=timeZone, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingStatus=ethernetBridgingStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, securityLevel=securityLevel, managementPortConfigurationMismatch=managementPortConfigurationMismatch, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsGroup=dfsGroup, ptp=ptp, rangingMode=rangingMode, sNTPServerTimeout=sNTPServerTimeout, ptpTraps=ptpTraps, regionCodeTrap=regionCodeTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsChannelAStatus=telecomsChannelAStatus, subnetMask=subnetMask, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, hAZLOCConfiguration=hAZLOCConfiguration, receiveModulationModeDetail=receiveModulationModeDetail, ptpGroups=ptpGroups, systemReset=systemReset, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, licenceGroup=licenceGroup, sNTPServerPortNumber=sNTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, sNTPServerRetries=sNTPServerRetries, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPrimaryServer=sNTPPrimaryServer, dfsMeans=dfsMeans, channelALineCode=channelALineCode, l2CPPriorityTable=l2CPPriorityTable, localPacketFiltering=localPacketFiltering, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBLineCode=channelBLineCode, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, sNMPTrapTable=sNMPTrapTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, targetMACAddress=targetMACAddress, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTable=sNTPServerTable, remoteInternetAddress=remoteInternetAddress, automaticTxPowerControl=automaticTxPowerControl, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetBridgingAvailability=ethernetBridgingAvailability, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsTableIndex=dfsTableIndex, managementMode=managementMode, accessMethod=accessMethod, transmitFreqMHz=transmitFreqMHz, managementPortDisabledWarning=managementPortDisabledWarning, targetRange=targetRange, longitude=longitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, phyControlGroup=phyControlGroup, aAAControl=aAAControl, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortStatus=managementPortStatus, telecomsChannelSelection=telecomsChannelSelection, frequencyVariant=frequencyVariant, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, bridgeGroup=bridgeGroup, maximumTransmitPower=maximumTransmitPower, bandwidthVariant=bandwidthVariant, dataPortAutoMdix=dataPortAutoMdix, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkSymmetry=linkSymmetry, sNTPState=sNTPState, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkStatus=wirelessLinkStatus, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv4Address=iPv4Address, bootVersion=bootVersion, notificationsGroup=notificationsGroup, unitOutOfCalibration=unitOutOfCalibration, smtpGroup=smtpGroup, encryption=encryption, ptmp=ptmp, ptp600=ptp600, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, syslogClientTrap=syslogClientTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, daylightSaving=daylightSaving, sMTPEnabledMessages=sMTPEnabledMessages, iPv6PrefixLength=iPv6PrefixLength, dfsTableNumber=dfsTableNumber, altitude=altitude, dfs=dfs, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPv3Enable=sNMPv3Enable, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, eIRP=eIRP, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap)
