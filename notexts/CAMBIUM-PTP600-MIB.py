...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLineCode=channelBLineCode, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, targetRange=targetRange, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarmsGroup=alarmsGroup, syslogClientTrap=syslogClientTrap, phyControl=phyControl, ptp=ptp, telecomsChannelBStatus=telecomsChannelBStatus, receivePower=receivePower, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementary=supplementary, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSync=sNTPSync, channelBLoopbackTrap=channelBLoopbackTrap, cambium=cambium, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, localPacketFiltering=localPacketFiltering, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPv4Address=iPv4Address, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userEnabled=userEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTable=ethernetPriorityTable, sNTPPollInterval=sNTPPollInterval, longitude=longitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, channelALoopback=channelALoopback, dfsMeans=dfsMeans, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyStatusGroup=phyStatusGroup, ethernetGroup=ethernetGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, sntpGroup=sntpGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelAStatus=telecomsChannelAStatus, telnetPortNumber=telnetPortNumber, groupID=groupID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, telecomsInterface=telecomsInterface, siteName=siteName, linkName=linkName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfs=dfs, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, reset=reset, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPState=sNTPState, installStatusTrap=installStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPCommunityString=sNMPCommunityString, vLANManagementVID=vLANManagementVID, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTable=l2CPPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, remoteInternetAddressType=remoteInternetAddressType, vLANManagementPriority=vLANManagementPriority, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rawReceivePower=rawReceivePower, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmState=installArmState, bridgeGroup=bridgeGroup, userTable=userTable, resetGroup=resetGroup, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, management=management, pubStatsGroup=pubStatsGroup, dfsTableNumber=dfsTableNumber, qOSPriorityScheme=qOSPriorityScheme, channelBLoopback=channelBLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp600=ptp600, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hardwareVersion=hardwareVersion, aAAControl=aAAControl, vectorError=vectorError, managementPortConfigurationMismatch=managementPortConfigurationMismatch, supplementaryGroup=supplementaryGroup, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, latitude=latitude, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, softwareVersion=softwareVersion, rangingMode=rangingMode, rxColorCode=rxColorCode, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, sNTPServerInternetAddress=sNTPServerInternetAddress, txColorCode=txColorCode, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, securityLevel=securityLevel, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, eIRP=eIRP, configuration=configuration, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, telecomsChannelSelection=telecomsChannelSelection, sMTPEnabledMessages=sMTPEnabledMessages, bridge=bridge, tDDControl=tDDControl, timeZone=timeZone, sntp=sntp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, snmpControl=snmpControl, targetMACAddress=targetMACAddress, hTTPSPortNumber=hTTPSPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelALineCode=channelALineCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtpGroup=smtpGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, receiveChannel=receiveChannel, tDDControlGroup=tDDControlGroup, receiveModulationMode=receiveModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, encryptionGroup=encryptionGroup, alarms=alarms, dfsTable=dfsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogState=syslogState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, channelACableLength=channelACableLength, bandwidthVariant=bandwidthVariant, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6Address=iPv6Address, channelBCableLength=channelBCableLength, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, telecom=telecom, ethernetPriorityTableEntry=ethernetPriorityTableEntry, range=range, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, syslogControl=syslogControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerIPAddress=sNTPServerIPAddress, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, versions=versions, pubStats=pubStats, sMTPEmailAlert=sMTPEmailAlert, sNTPServerRetries=sNTPServerRetries, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, dataPortDisabledWarning=dataPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTimeout=sNTPServerTimeout, channelChangeTrap=channelChangeTrap, sNTPServerTableEntry=sNTPServerTableEntry, channelALoopbackTrap=channelALoopbackTrap, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapPortNumber=sNMPTrapPortNumber, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, managementMode=managementMode, ethernetFiberSupport=ethernetFiberSupport, remoteRxTargetPower=remoteRxTargetPower, secureModeAlarmTrap=secureModeAlarmTrap, licence=licence, dfsPeaks=dfsPeaks, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortFiberStatus=dataPortFiberStatus, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPPrimaryServer=sNTPPrimaryServer, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, smtp=smtp, linkLoss=linkLoss, sNTPServerPortNumber=sNTPServerPortNumber, linkSymmetry=linkSymmetry, ethernetBridgingStatus=ethernetBridgingStatus, masterSlaveMode=masterSlaveMode, secureModeAlarm=secureModeAlarm, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, systemClock=systemClock, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, altitude=altitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, transmitDataRate=transmitDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, versionsGroup=versionsGroup, managementPortStatus=managementPortStatus, dataPortStatusTrap=dataPortStatusTrap, remoteInternetAddress=remoteInternetAddress, regionCodeTrap=regionCodeTrap, notificationsGroup=notificationsGroup, userPassword=userPassword, productName=productName, dSCPManagementPriority=dSCPManagementPriority, subnetMask=subnetMask, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPv6PrefixLength=iPv6PrefixLength, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, accessMethod=accessMethod, ethernet=ethernet, hAZLOCConfiguration=hAZLOCConfiguration)
