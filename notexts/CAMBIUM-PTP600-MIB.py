...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, dfsTableNumber=dfsTableNumber, vLANManagementVID=vLANManagementVID, channelBLineCode=channelBLineCode, sNTPState=sNTPState, userTableIndex=userTableIndex, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, frequencyVariant=frequencyVariant, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, timeZone=timeZone, alarms=alarms, userTableEntry=userTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPVersion=iPVersion, dataPortStatus=dataPortStatus, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv4Address=iPv4Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, searchState=searchState, l2CPPriorityTableEntry=l2CPPriorityTableEntry, latitude=latitude, ethernetPriorityTable=ethernetPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, phyStatusGroup=phyStatusGroup, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddress=sNTPServerInternetAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatusTrap=dataPortStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitPower=transmitPower, iPv6PrefixLength=iPv6PrefixLength, userTableNumber=userTableNumber, dfs=dfs, rangingMode=rangingMode, sNTPServerTable=sNTPServerTable, sNTPServerTableIndex=sNTPServerTableIndex, rxColorCode=rxColorCode, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomsChannelSelection=telecomsChannelSelection, pubStats=pubStats, supplementary=supplementary, phyControlGroup=phyControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bridge=bridge, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemReset=systemReset, syslogState=syslogState, userPassword=userPassword, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPServerStatus=sNTPServerStatus, channelChangeTrap=channelChangeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, iPv6Address=iPv6Address, installArmState=installArmState, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopback=channelALoopback, sNTPServerPortNumber=sNTPServerPortNumber, productVariant=productVariant, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, receiveDataRate=receiveDataRate, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelACableLength=channelACableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, targetRange=targetRange, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, versionsGroup=versionsGroup, syslogClient=syslogClient, secureModeAlarmTrap=secureModeAlarmTrap, txColorCode=txColorCode, antennaGain=antennaGain, eIRP=eIRP, tDDControl=tDDControl, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, bridgeGroup=bridgeGroup, userName=userName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, telecom=telecom, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, masterSlaveMode=masterSlaveMode, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelALoopbackTrap=channelALoopbackTrap, snmpControlGroup=snmpControlGroup, channelBLoopback=channelBLoopback, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortStatusTrap=managementPortStatusTrap, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, dSCPManagementPriority=dSCPManagementPriority, configuration=configuration, ethernetBridgingStatus=ethernetBridgingStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, constantPowerSpectralDensity=constantPowerSpectralDensity, altitude=altitude, pubStatsGroup=pubStatsGroup, channelALineCode=channelALineCode, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, qOSPriorityScheme=qOSPriorityScheme, cambium=cambium, localPacketFiltering=localPacketFiltering, receiveFreqMHz=receiveFreqMHz, sNTPServerRetries=sNTPServerRetries, l2CPPriorityTable=l2CPPriorityTable, dataPortFiberStatus=dataPortFiberStatus, sntp=sntp, longitude=longitude, sNTPSync=sNTPSync, sntpGroup=sntpGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServer=sNTPPrimaryServer, management=management, syslogControl=syslogControl, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, ethernet=ethernet, ptpTrapPrefix=ptpTrapPrefix, targetMACAddress=targetMACAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, groupID=groupID, installArmStateTrap=installArmStateTrap, licence=licence, securityLevel=securityLevel, ptp600=ptp600, channelBCableLength=channelBCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, systemClock=systemClock, encryption=encryption, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, automaticTxPowerControl=automaticTxPowerControl, linkSymmetry=linkSymmetry, licenceGroup=licenceGroup, telnetPortNumber=telnetPortNumber, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installStatus=installStatus, sNTPServerTableNumber=sNTPServerTableNumber, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, incompatibleRegionCodes=incompatibleRegionCodes, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, iPv6GatewayAddress=iPv6GatewayAddress, aAAControl=aAAControl, regionCodeTrap=regionCodeTrap, sNMPPortNumber=sNMPPortNumber, rawReceivePower=rawReceivePower, iPDSCPPriorityTable=iPDSCPPriorityTable, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatus=phyStatus, transmitChannel=transmitChannel, userTable=userTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarm=secureModeAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, softwareVersion=softwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, ptpTraps=ptpTraps, telecomsChannelAStatus=telecomsChannelAStatus, sNMPEnabledTraps=sNMPEnabledTraps, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, byteErrorRatio=byteErrorRatio, hTTPPortNumber=hTTPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, productName=productName, phyControl=phyControl, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogClientTrap=syslogClientTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsMeans=dfsMeans, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkName=linkName, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, bootVersion=bootVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, receivePower=receivePower, managementPortStatus=managementPortStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPServerInternetAddress=tFTPServerInternetAddress, resetGroup=resetGroup, dataPortDisabledWarning=dataPortDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementGroup=managementGroup, hAZLOCConfiguration=hAZLOCConfiguration, receiveModulationModeDetail=receiveModulationModeDetail, encryptionAlgorithm=encryptionAlgorithm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, remoteRxTargetPower=remoteRxTargetPower, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementMode=managementMode, accessMethod=accessMethod, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, dataPortAutoMdix=dataPortAutoMdix, siteName=siteName, telecomGroup=telecomGroup, range=range)
