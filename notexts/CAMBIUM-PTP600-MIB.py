...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, supplementary=supplementary, snmpControl=snmpControl, userEnabled=userEnabled, receiveDataRate=receiveDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerTimeout=sNTPServerTimeout, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPSyncTrap=sNTPSyncTrap, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, channelALoopbackTrap=channelALoopbackTrap, telecomGroup=telecomGroup, iPv6Address=iPv6Address, supplementaryGroup=supplementaryGroup, range=range, wirelessLinkAvailability=wirelessLinkAvailability, snmpControlGroup=snmpControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelALineCode=channelALineCode, vectorError=vectorError, l2CPPriorityTable=l2CPPriorityTable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPEmailAlert=sMTPEmailAlert, productName=productName, byteErrorRatio=byteErrorRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteRxTargetPower=remoteRxTargetPower, remoteInternetAddressType=remoteInternetAddressType, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, localPacketFiltering=localPacketFiltering, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, bandwidthVariant=bandwidthVariant, ethernet=ethernet, transmitDataRate=transmitDataRate, automaticTxPowerControl=automaticTxPowerControl, configurationGroup=configurationGroup, bridge=bridge, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, productVariant=productVariant, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, accessMethod=accessMethod, channelBLineCode=channelBLineCode, ptpGroups=ptpGroups, managementGroup=managementGroup, channelBLoopback=channelBLoopback, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, ptpTraps=ptpTraps, userTableEntry=userTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, configuration=configuration, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogClient=syslogClient, longitude=longitude, syslogClientTrap=syslogClientTrap, secureModeAlarmTrap=secureModeAlarmTrap, userTable=userTable, telnetPortNumber=telnetPortNumber, subnetMask=subnetMask, sntp=sntp, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, altitude=altitude, ethernetPriorityTableIndex=ethernetPriorityTableIndex, siteName=siteName, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, receiveFreqKHz=receiveFreqKHz, cableLoss=cableLoss, tDDSynchronizationMode=tDDSynchronizationMode, signalStrengthRatio=signalStrengthRatio, hAZLOCConfiguration=hAZLOCConfiguration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, searchState=searchState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsMeans=dfsMeans, phyStatus=phyStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, smtp=smtp, iPv6PrefixLength=iPv6PrefixLength, secureModeAlarm=secureModeAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, tDDControl=tDDControl, linkName=linkName, iPVersion=iPVersion, dfsTable=dfsTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetAccessEnabled=telnetAccessEnabled, rxColorCode=rxColorCode, sNTPServerStatus=sNTPServerStatus, userName=userName, receiveFreqMHz=receiveFreqMHz, dataPortAutoMdix=dataPortAutoMdix, versions=versions, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableEntry=dfsTableEntry, latitude=latitude, sMTPServerInternetAddress=sMTPServerInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDControlGroup=tDDControlGroup, installArmStateTrap=installArmStateTrap, pubStats=pubStats, incompatibleRegionCodes=incompatibleRegionCodes, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hardwareVersion=hardwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPState=sNTPState, linkSymmetry=linkSymmetry, rangingMode=rangingMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemClock=systemClock, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetFiberSupport=ethernetFiberSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, rawReceivePower=rawReceivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, channelBLoopbackTrap=channelBLoopbackTrap, telecom=telecom, telecomsChannelSelection=telecomsChannelSelection, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, installArmState=installArmState, channelALoopback=channelALoopback, txColorCode=txColorCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTableNumber=userTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, installStatusTrap=installStatusTrap, phyControl=phyControl, ethernetGroup=ethernetGroup, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, licence=licence, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, targetRange=targetRange, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkLoss=linkLoss, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, smtpGroup=smtpGroup, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, sNMPv3Enable=sNMPv3Enable, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, managementPortConfigurationMismatch=managementPortConfigurationMismatch, eIRP=eIRP, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTableIndex=sNTPServerTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANManagementPriority=vLANManagementPriority, sNMPPortNumber=sNMPPortNumber, ptp600=ptp600, channelBandwidth=channelBandwidth, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, regionCode=regionCode, managementMode=managementMode, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, managementPortStatus=managementPortStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, iPv4Address=iPv4Address, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, bridgeGroup=bridgeGroup, syslogControlGroup=syslogControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, securityLevel=securityLevel, encryptionGroup=encryptionGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, syslogControl=syslogControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptmp=ptmp, versionsGroup=versionsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntpGroup=sntpGroup, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, channelACableLength=channelACableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, dfs=dfs, sNTPServerTableEntry=sNTPServerTableEntry, sNTPLastSync=sNTPLastSync, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, sNTPServerTable=sNTPServerTable, aggregateDataRate=aggregateDataRate, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, antennaGain=antennaGain, managementPortDisabledWarning=managementPortDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, regionCodeTrap=regionCodeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aAAControlGroup=aAAControlGroup, channelBCableLength=channelBCableLength, groupID=groupID, resetGroup=resetGroup)
