...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPAccessEnabled=hTTPAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, snmpControl=snmpControl, systemClock=systemClock, dfsTableNumber=dfsTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, mPLSTCPriorityTable=mPLSTCPriorityTable, ptp600=ptp600, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, installArmState=installArmState, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkAvailability=wirelessLinkAvailability, versionsGroup=versionsGroup, ptpGroups=ptpGroups, cableLoss=cableLoss, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, notificationsGroup=notificationsGroup, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmStateTrap=installArmStateTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteRxTargetPower=remoteRxTargetPower, receiveFreqKHz=receiveFreqKHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, resetGroup=resetGroup, channelBLoopback=channelBLoopback, automaticTxPowerControl=automaticTxPowerControl, sNTPServerIPAddress=sNTPServerIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTableIndex=l2CPPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitChannel=transmitChannel, encryption=encryption, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, versions=versions, channelALoopback=channelALoopback, searchState=searchState, linkSymmetry=linkSymmetry, sNTPServerTimeout=sNTPServerTimeout, sNTPServerPortNumber=sNTPServerPortNumber, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, dfsMeans=dfsMeans, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, cambium=cambium, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitPower=transmitPower, syslogControl=syslogControl, syslogStateTrap=syslogStateTrap, managementGroup=managementGroup, managementPortDisabledWarning=managementPortDisabledWarning, sNTPState=sNTPState, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, rxColorCode=rxColorCode, reset=reset, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, telnetAccessEnabled=telnetAccessEnabled, siteName=siteName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, hAZLOCConfiguration=hAZLOCConfiguration, supplementaryGroup=supplementaryGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerStatus=sNTPServerStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTable=dfsTable, iPVersion=iPVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsPeaks=dfsPeaks, l2CPPriorityTable=l2CPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, sNTPPollInterval=sNTPPollInterval, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitFreqKHz=transmitFreqKHz, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bridgeGroup=bridgeGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpCompliance=ptpCompliance, licenceGroup=licenceGroup, installStatus=installStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementPriority=vLANManagementPriority, constantPowerSpectralDensity=constantPowerSpectralDensity, timeZone=timeZone, syslogClientTrap=syslogClientTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, sNMPTrapTable=sNMPTrapTable, iPv6GatewayAddress=iPv6GatewayAddress, range=range, sntpGroup=sntpGroup, channelBLineCode=channelBLineCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, latitude=latitude, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControlGroup=aAAControlGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, managementPortStatusTrap=managementPortStatusTrap, channelALoopbackTrap=channelALoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, telecom=telecom, linkLoss=linkLoss, channelBCableLength=channelBCableLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, encryptionGroup=encryptionGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, rangingMode=rangingMode, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, channelBLoopbackTrap=channelBLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePower=rawReceivePower, aggregateDataRate=aggregateDataRate, syslogControlGroup=syslogControlGroup, remoteInternetAddress=remoteInternetAddress, syslogClient=syslogClient, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, channelChangeTrap=channelChangeTrap, remoteIPAddress=remoteIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStatsGroup=pubStatsGroup, receivePower=receivePower, managementMode=managementMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, dfsTableEntry=dfsTableEntry, softwareVersion=softwareVersion, userTableNumber=userTableNumber, userName=userName, regionCodeTrap=regionCodeTrap, userTable=userTable, ptmp=ptmp, alarmsGroup=alarmsGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPPortNumber=sNMPPortNumber, linkName=linkName, targetRange=targetRange, phyControl=phyControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, eIRP=eIRP, receiveModulationMode=receiveModulationMode, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, productName=productName, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, subnetMask=subnetMask, managementPortStatus=managementPortStatus, targetMACAddress=targetMACAddress, altitude=altitude, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, management=management, dfs=dfs, dfsGroup=dfsGroup, iPv4Address=iPv4Address, maximumTransmitPower=maximumTransmitPower, syslogState=syslogState, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, hTTPPortNumber=hTTPPortNumber, iPv6PrefixLength=iPv6PrefixLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, userEnabled=userEnabled, supplementary=supplementary, pubStats=pubStats, phyControlGroup=phyControlGroup, channelALineCode=channelALineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatus=dataPortFiberStatus, txColorCode=txColorCode, bridge=bridge, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTable=sNTPServerTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTableIndex=sNTPServerTableIndex, transmitFreqMHz=transmitFreqMHz, telecomsChannelSelection=telecomsChannelSelection, installStatusTrap=installStatusTrap, groupID=groupID, securityLevel=securityLevel, phyStatus=phyStatus, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, channelACableLength=channelACableLength, daylightSaving=daylightSaving, receiveChannel=receiveChannel, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTraps=ptpTraps, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatus=dataPortStatus, configuration=configuration, iPv6Address=iPv6Address, vLANManagementVID=vLANManagementVID, ethernetBridgingStatus=ethernetBridgingStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelBandwidth=channelBandwidth, sNTPServerInternetAddressType=sNTPServerInternetAddressType, secureModeAlarm=secureModeAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControlGroup=tDDControlGroup, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, sNTPServerRetries=sNTPServerRetries, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
