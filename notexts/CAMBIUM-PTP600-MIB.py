...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:56:29 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", resetGroup=resetGroup, bandwidthVariant=bandwidthVariant, hTTPAccessEnabled=hTTPAccessEnabled, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, regionCode=regionCode, phyStatus=phyStatus, pubStats=pubStats, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelSelection=telecomsChannelSelection, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, phyStatusGroup=phyStatusGroup, sNTPServerStatus=sNTPServerStatus, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, bridge=bridge, systemClock=systemClock, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelBStatus=telecomsChannelBStatus, ptmp=ptmp, latitude=latitude, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, dfs=dfs, channelBLineCode=channelBLineCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, userTable=userTable, userTableEntry=userTableEntry, versionsGroup=versionsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelAStatus=telecomsChannelAStatus, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, transmitPower=transmitPower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControlGroup=phyControlGroup, channelACableLength=channelACableLength, linkSymmetry=linkSymmetry, cableLoss=cableLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveDataRate=receiveDataRate, versions=versions, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, smtp=smtp, ethernet=ethernet, iPv6Address=iPv6Address, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementGroup=managementGroup, dSCPManagementPriority=dSCPManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSync=sNTPSync, rangingMode=rangingMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkStatus=wirelessLinkStatus, telecomsInterface=telecomsInterface, userTableIndex=userTableIndex, groupID=groupID, ethernetBridgingStatus=ethernetBridgingStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatus=installStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPCommunityString=sNMPCommunityString, regionCodeTrap=regionCodeTrap, tDDControl=tDDControl, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, txColorCode=txColorCode, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableEntry=sNTPServerTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimisation=linkModeOptimisation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerIPAddress=sNTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogState=syslogState, licenceGroup=licenceGroup, localPacketFiltering=localPacketFiltering, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBLoopback=channelBLoopback, managementPortWirelessDownAlert=managementPortWirelessDownAlert, alarmsGroup=alarmsGroup, remoteInternetAddressType=remoteInternetAddressType, sNTPLastSync=sNTPLastSync, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, iPVersion=iPVersion, installArmStateTrap=installArmStateTrap, managementMode=managementMode, userRole=userRole, remoteInternetAddress=remoteInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, antennaGain=antennaGain, sNTPServerTable=sNTPServerTable, secureModeAlarm=secureModeAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, range=range, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, snmpControl=snmpControl, dataPortStatus=dataPortStatus, targetRange=targetRange, tDDSynchronizationAlarm=tDDSynchronizationAlarm, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxColorCode=rxColorCode, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryptionGroup=encryptionGroup, subnetMask=subnetMask, iPDSCPPriorityTable=iPDSCPPriorityTable, productVariant=productVariant, ethernetFiberSupport=ethernetFiberSupport, remoteRxTargetPower=remoteRxTargetPower, sMTPEmailAlert=sMTPEmailAlert, receiveChannel=receiveChannel, dfsGroup=dfsGroup, reset=reset, iPv4Address=iPv4Address, l2CPPriorityTableNumber=l2CPPriorityTableNumber, automaticTxPowerControl=automaticTxPowerControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, sMTPServerPortNumber=sMTPServerPortNumber, userPassword=userPassword, dfsMeans=dfsMeans, telecom=telecom, hAZLOCConfiguration=hAZLOCConfiguration, receivePower=receivePower, encryption=encryption, userEnabled=userEnabled, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sntp=sntp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBLoopbackTrap=channelBLoopbackTrap, telecomGroup=telecomGroup, iPv6GatewayAddress=iPv6GatewayAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, alarms=alarms, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerTableNumber=sNTPServerTableNumber, bridgeGroup=bridgeGroup, channelALoopback=channelALoopback, channelALineCode=channelALineCode, transmitModulationMode=transmitModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, syslogClient=syslogClient, longitude=longitude, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, cambium=cambium, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingAvailability=ethernetBridgingAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementPortStatusTrap=managementPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationMode=receiveModulationMode, management=management, sNTPServerTableIndex=sNTPServerTableIndex, transmitFreqMHz=transmitFreqMHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPPollInterval=sNTPPollInterval, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, byteErrorRatio=byteErrorRatio, encryptionAlgorithm=encryptionAlgorithm, channelALoopbackTrap=channelALoopbackTrap, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, supplementary=supplementary, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, installArmState=installArmState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, transmitDataRate=transmitDataRate, siteName=siteName, ptpTraps=ptpTraps, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, sNMPv3Enable=sNMPv3Enable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptp600=ptp600, searchState=searchState, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetGroup=ethernetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortStatus=managementPortStatus, channelBCableLength=channelBCableLength, rawReceivePower=rawReceivePower, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableNumber=dfsTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, securityLevel=securityLevel, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, phyControl=phyControl, ptp=ptp, sNMPTrapInternetAddress=sNMPTrapInternetAddress, smtpGroup=smtpGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsPeaks=dfsPeaks, eIRP=eIRP, dataPortFiberStatus=dataPortFiberStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, altitude=altitude)
