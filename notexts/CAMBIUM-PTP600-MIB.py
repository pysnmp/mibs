...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, channelALoopback=channelALoopback, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, systemClock=systemClock, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelAStatus=telecomsChannelAStatus, hAZLOCConfiguration=hAZLOCConfiguration, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControlGroup=phyControlGroup, qOSPriorityScheme=qOSPriorityScheme, managementPortDisabledWarning=managementPortDisabledWarning, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, supplementary=supplementary, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, localPacketFiltering=localPacketFiltering, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, txColorCode=txColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bridge=bridge, rxColorCode=rxColorCode, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, syslogControlGroup=syslogControlGroup, ethernetPriorityTable=ethernetPriorityTable, userRole=userRole, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, dfsTableEntry=dfsTableEntry, ptp=ptp, tDDControlGroup=tDDControlGroup, dfsMeans=dfsMeans, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, productName=productName, altitude=altitude, range=range, hardwareVersion=hardwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControlGroup=aAAControlGroup, signalStrengthRatio=signalStrengthRatio, ethernet=ethernet, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, installArmStateTrap=installArmStateTrap, versions=versions, ptpGroups=ptpGroups, userTableIndex=userTableIndex, syslogClient=syslogClient, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, managementMode=managementMode, versionsGroup=versionsGroup, encryptionGroup=encryptionGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPSyncTrap=sNTPSyncTrap, configurationGroup=configurationGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, sNTPSync=sNTPSync, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerPortNumber=sNTPServerPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, groupID=groupID, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, management=management, remoteInternetAddressType=remoteInternetAddressType, phyControl=phyControl, ptpTraps=ptpTraps, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rawReceivePower=rawReceivePower, userName=userName, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, syslogControl=syslogControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableIndex=dfsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryption=encryption, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, sNTPServerTable=sNTPServerTable, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, automaticTxPowerControl=automaticTxPowerControl, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, reset=reset, managementPortWirelessDownAlert=managementPortWirelessDownAlert, softwareVersion=softwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogState=syslogState, telecomGroup=telecomGroup, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, remoteRxTargetPower=remoteRxTargetPower, subnetMask=subnetMask, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, licenceGroup=licenceGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, managementPortStatus=managementPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveFreqMHz=receiveFreqMHz, channelBLoopback=channelBLoopback, iPv4Address=iPv4Address, regionCodeTrap=regionCodeTrap, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopbackTrap=channelALoopbackTrap, telecomsInterface=telecomsInterface, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkStatus=wirelessLinkStatus, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddress=remoteInternetAddress, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, sNTPPrimaryServer=sNTPPrimaryServer, installStatus=installStatus, linkSymmetry=linkSymmetry, iPv6Address=iPv6Address, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsPeaks=dfsPeaks, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTableIndex=sNTPServerTableIndex, ptpCompliance=ptpCompliance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqKHz=transmitFreqKHz, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitFreqMHz=transmitFreqMHz, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, sNTPPollInterval=sNTPPollInterval, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, syslogStateTrap=syslogStateTrap, dfs=dfs, linkName=linkName, channelALineCode=channelALineCode, securityLevel=securityLevel, hTTPPortNumber=hTTPPortNumber, ethernetFiberSupport=ethernetFiberSupport, licence=licence, sNMPTrapTable=sNMPTrapTable, channelACableLength=channelACableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, accessMethod=accessMethod, dSCPManagementPriority=dSCPManagementPriority, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelBStatus=telecomsChannelBStatus, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, regionCode=regionCode, sntp=sntp, searchState=searchState, transmitDataRate=transmitDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, alarms=alarms, dfsTable=dfsTable, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, bridgeGroup=bridgeGroup, l2CPPriorityTable=l2CPPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBCableLength=channelBCableLength, sMTPEnabledMessages=sMTPEnabledMessages, alarmsGroup=alarmsGroup, systemReset=systemReset, sNTPLastSync=sNTPLastSync, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, smtpGroup=smtpGroup, sNTPServerInternetAddress=sNTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDControl=tDDControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLineCode=channelBLineCode, configuration=configuration, receiveFreqKHz=receiveFreqKHz, userTableEntry=userTableEntry, antennaGain=antennaGain, siteName=siteName, sNMPv3Enable=sNMPv3Enable, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptp600=ptp600, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, phyStatus=phyStatus, userTableNumber=userTableNumber, managementPortStatusTrap=managementPortStatusTrap, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPVersion=iPVersion, longitude=longitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vectorError=vectorError, constantPowerSpectralDensity=constantPowerSpectralDensity, secureModeAlarm=secureModeAlarm, eIRP=eIRP, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementaryGroup=supplementaryGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rangingMode=rangingMode)
