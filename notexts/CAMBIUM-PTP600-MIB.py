...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveDataRate=receiveDataRate, managementMode=managementMode, sMTPServerPortNumber=sMTPServerPortNumber, remoteInternetAddressType=remoteInternetAddressType, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveModulationMode=receiveModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dSCPManagementPriority=dSCPManagementPriority, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, sNTPServerRetries=sNTPServerRetries, phyControl=phyControl, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableEntry=sNMPTrapTableEntry, groupID=groupID, management=management, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsMeans=dfsMeans, receiveFreqMHz=receiveFreqMHz, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, bootVersion=bootVersion, transmitDataRate=transmitDataRate, channelALineCode=channelALineCode, telecomsChannelSelection=telecomsChannelSelection, userTableEntry=userTableEntry, channelBCableLength=channelBCableLength, unitOutOfCalibration=unitOutOfCalibration, sNTPSync=sNTPSync, softwareVersion=softwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, masterSlaveMode=masterSlaveMode, productName=productName, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTable=ethernetPriorityTable, accessMethod=accessMethod, dataPortStatus=dataPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secureModeAlarmTrap=secureModeAlarmTrap, configuration=configuration, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, ethernet=ethernet, smtp=smtp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpCompliance=ptpCompliance, linkSymmetry=linkSymmetry, systemReset=systemReset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, syslogStateTrap=syslogStateTrap, managementPortDisabledWarning=managementPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, receivePower=receivePower, dfsTable=dfsTable, rxColorCode=rxColorCode, userTableNumber=userTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPLastSync=sNTPLastSync, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkLoss=linkLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogState=syslogState, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddress=remoteInternetAddress, installArmState=installArmState, range=range, secureModeAlarm=secureModeAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, sNTPServerTimeout=sNTPServerTimeout, aggregateDataRate=aggregateDataRate, eIRP=eIRP, productVariant=productVariant, txColorCode=txColorCode, channelALoopbackTrap=channelALoopbackTrap, ptmp=ptmp, smtpGroup=smtpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, dfs=dfs, rawReceivePower=rawReceivePower, bandwidthVariant=bandwidthVariant, daylightSaving=daylightSaving, remoteIPAddress=remoteIPAddress, supplementary=supplementary, alarms=alarms, userTable=userTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPv4Address=iPv4Address, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, ptp=ptp, vLANManagementPriority=vLANManagementPriority, targetMACAddress=targetMACAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, timeZone=timeZone, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, secondarySoftwareVersion=secondarySoftwareVersion, aAAControl=aAAControl, channelALoopback=channelALoopback, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licence=licence, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerStatus=sNTPServerStatus, reset=reset, longitude=longitude, managementGroup=managementGroup, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6Address=iPv6Address, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, configurationGroup=configurationGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, sntp=sntp, syslogClientTrap=syslogClientTrap, sNMPCommunityString=sNMPCommunityString, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userEnabled=userEnabled, sntpGroup=sntpGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, qOSPriorityScheme=qOSPriorityScheme, dataPortStatusTrap=dataPortStatusTrap, snmpControlGroup=snmpControlGroup, tDDControl=tDDControl, bridge=bridge, sMTPServerInternetAddressType=sMTPServerInternetAddressType, signalStrengthRatio=signalStrengthRatio, channelACableLength=channelACableLength, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControlGroup=phyControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsGroup=dfsGroup, transmitPower=transmitPower, tDDControlGroup=tDDControlGroup, telecom=telecom, bridgeGroup=bridgeGroup, securityLevel=securityLevel, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, ethernetBridgingStatus=ethernetBridgingStatus, automaticTxPowerControl=automaticTxPowerControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userRole=userRole, syslogClient=syslogClient, receiveChannel=receiveChannel, snmpControl=snmpControl, resetGroup=resetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, hardwareVersion=hardwareVersion, channelBLineCode=channelBLineCode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPState=sNTPState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptp600=ptp600, dataPortAutoMdix=dataPortAutoMdix, versionsGroup=versionsGroup, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableEntry=dfsTableEntry, pubStatsGroup=pubStatsGroup, phyStatusGroup=phyStatusGroup, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, alarmsGroup=alarmsGroup, localPacketFiltering=localPacketFiltering, sNMPPortNumber=sNMPPortNumber, altitude=altitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkName=linkName, iPv6PrefixLength=iPv6PrefixLength, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup, iPVersion=iPVersion, rangingMode=rangingMode, channelBLoopback=channelBLoopback, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, userTableIndex=userTableIndex, encryption=encryption, siteName=siteName, sNTPServerTable=sNTPServerTable, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, regionCodeTrap=regionCodeTrap, managementPortStatusTrap=managementPortStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, installStatus=installStatus, latitude=latitude, encryptionAlgorithm=encryptionAlgorithm, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus)
