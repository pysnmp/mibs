...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", masterSlaveMode=masterSlaveMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelBStatus=telecomsChannelBStatus, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, ptp600=ptp600, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelAStatus=telecomsChannelAStatus, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, secureModeAlarmTrap=secureModeAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, managementMode=managementMode, sNTPServerRetries=sNTPServerRetries, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, rxColorCode=rxColorCode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogState=syslogState, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, management=management, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, ptmp=ptmp, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, syslogControlGroup=syslogControlGroup, telecomsChannelSelection=telecomsChannelSelection, cambium=cambium, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, smtp=smtp, bridgeGroup=bridgeGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyControl=phyControl, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPCommunityString=sNMPCommunityString, vectorError=vectorError, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sntpGroup=sntpGroup, resetGroup=resetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6Address=iPv6Address, productVariant=productVariant, dfsMeans=dfsMeans, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemReset=systemReset, syslogClientTrap=syslogClientTrap, l2CPPriorityTable=l2CPPriorityTable, ethernetBridgingStatus=ethernetBridgingStatus, alarms=alarms, sNTPSync=sNTPSync, antennaGain=antennaGain, regionCodeTrap=regionCodeTrap, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, sMTPServerIPAddress=sMTPServerIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, targetRange=targetRange, managementPortStatusTrap=managementPortStatusTrap, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, sNTPServerTimeout=sNTPServerTimeout, pubStats=pubStats, receiveChannel=receiveChannel, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogClient=syslogClient, phyControlGroup=phyControlGroup, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelBLoopback=channelBLoopback, bridge=bridge, supplementary=supplementary, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddressType=sMTPServerInternetAddressType, subnetMask=subnetMask, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernet=ethernet, installStatus=installStatus, txColorCode=txColorCode, linkLoss=linkLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, dfsTableIndex=dfsTableIndex, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, timeZone=timeZone, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, dataPortFiberStatus=dataPortFiberStatus, managementPortDisabledWarning=managementPortDisabledWarning, ptp=ptp, userRole=userRole, aAAControl=aAAControl, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, searchState=searchState, ptpTraps=ptpTraps, sntp=sntp, telecomGroup=telecomGroup, userPassword=userPassword, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userTableEntry=userTableEntry, aggregateDataRate=aggregateDataRate, channelALoopback=channelALoopback, channelALoopbackTrap=channelALoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, localPacketFiltering=localPacketFiltering, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryption=encryption, installArmStateTrap=installArmStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, sNMPTrapTable=sNMPTrapTable, managementPortStatus=managementPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secureModeAlarm=secureModeAlarm, channelChangeTrap=channelChangeTrap, receiveDataRate=receiveDataRate, aAAControlGroup=aAAControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, PYSNMP_MODULE_ID=cambium, range=range, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteRxTargetPower=remoteRxTargetPower, sNTPServerTableIndex=sNTPServerTableIndex, reset=reset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecom=telecom, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, siteName=siteName, syslogStateTrap=syslogStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPPortNumber=sNMPPortNumber, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStatsGroup=pubStatsGroup, longitude=longitude, altitude=altitude, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, latitude=latitude, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, managementGroup=managementGroup, rangingMode=rangingMode, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, versions=versions, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPPollInterval=sNTPPollInterval, channelACableLength=channelACableLength, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, channelBLoopbackTrap=channelBLoopbackTrap, channelALineCode=channelALineCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, installArmState=installArmState, bootVersion=bootVersion, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANManagementPriority=vLANManagementPriority, accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, hardwareVersion=hardwareVersion, tDDControl=tDDControl, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, configuration=configuration)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTable=sNTPServerTable, sNTPState=sNTPState, softwareVersion=softwareVersion, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, bandwidthVariant=bandwidthVariant, qOSPriorityScheme=qOSPriorityScheme, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, groupID=groupID, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBLineCode=channelBLineCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, linkSymmetry=linkSymmetry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, securityLevel=securityLevel, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, channelBCableLength=channelBCableLength, tDDSynchronizationMode=tDDSynchronizationMode, productName=productName, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, encryptionGroup=encryptionGroup, hAZLOCConfiguration=hAZLOCConfiguration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServer=sNTPPrimaryServer, iPv4Address=iPv4Address)
