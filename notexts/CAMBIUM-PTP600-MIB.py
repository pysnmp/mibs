...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkName=linkName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installArmStateTrap=installArmStateTrap, txColorCode=txColorCode, qOSPriorityScheme=qOSPriorityScheme, telecomsInterface=telecomsInterface, sNTPServerTable=sNTPServerTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarmTrap=secureModeAlarmTrap, bootVersion=bootVersion, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, byteErrorRatio=byteErrorRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, channelBCableLength=channelBCableLength, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, ptp600=ptp600, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, timeZone=timeZone, supplementary=supplementary, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, rangingMode=rangingMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, targetRange=targetRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, supplementaryGroup=supplementaryGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBLoopbackTrap=channelBLoopbackTrap, telnetPortNumber=telnetPortNumber, ptmp=ptmp, versions=versions, managementPortDisabledWarning=managementPortDisabledWarning, syslogStateTrap=syslogStateTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDDControl=tDDControl, ethernetPriorityTable=ethernetPriorityTable, vectorError=vectorError, transmitPower=transmitPower, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementGroup=managementGroup, sntp=sntp, bridgeGroup=bridgeGroup, snmpControl=snmpControl, subnetMask=subnetMask, ptpGroups=ptpGroups, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTableIndex=sNTPServerTableIndex, ethernetGroup=ethernetGroup, groupID=groupID, iPv6GatewayAddress=iPv6GatewayAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, longitude=longitude, receivePower=receivePower, localPacketFiltering=localPacketFiltering, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogClientTrap=syslogClientTrap, licence=licence, notificationsGroup=notificationsGroup, productVariant=productVariant, siteName=siteName, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatusTrap=installStatusTrap, iPv6PrefixLength=iPv6PrefixLength, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, receiveFreqKHz=receiveFreqKHz, reset=reset, ethernetFiberSupport=ethernetFiberSupport, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6Address=iPv6Address, sNMPTrapPortNumber=sNMPTrapPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, dataPortStatus=dataPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortStatus=managementPortStatus, resetGroup=resetGroup, userName=userName, eIRP=eIRP, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, linkSymmetry=linkSymmetry, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecom=telecom, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, secureModeAlarm=secureModeAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, alarms=alarms, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTable=dfsTable, rawReceivePower=rawReceivePower, dSCPManagementPriority=dSCPManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, masterSlaveMode=masterSlaveMode, regionCode=regionCode, hardwareVersion=hardwareVersion, managementMode=managementMode, unitOutOfCalibration=unitOutOfCalibration, dfsTableEntry=dfsTableEntry, syslogControlGroup=syslogControlGroup, channelACableLength=channelACableLength, remoteRxTargetPower=remoteRxTargetPower, frequencyVariant=frequencyVariant, dfs=dfs, sntpGroup=sntpGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, automaticTxPowerControl=automaticTxPowerControl, sNTPServerRetries=sNTPServerRetries, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableIndex=ethernetPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPrimaryServer=sNTPPrimaryServer, phyControl=phyControl, smtp=smtp, management=management, iPVersion=iPVersion, syslogControl=syslogControl, sNMPTrapVersion=sNMPTrapVersion, targetMACAddress=targetMACAddress, sNTPServerTableNumber=sNTPServerTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, transmitDataRate=transmitDataRate, tDDControlGroup=tDDControlGroup, userTable=userTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatus=phyStatus, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hAZLOCConfiguration=hAZLOCConfiguration, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, receiveChannel=receiveChannel, sMTPEnabledMessages=sMTPEnabledMessages, ethernetBridgingAvailability=ethernetBridgingAvailability, searchState=searchState, userPassword=userPassword, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPLastSync=sNTPLastSync, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, channelALoopback=channelALoopback, hTTPPortNumber=hTTPPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementPortStatusTrap=managementPortStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, systemClock=systemClock, configurationGroup=configurationGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, cambium=cambium, securityLevel=securityLevel, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitFreqMHz=transmitFreqMHz, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerTableEntry=sNTPServerTableEntry, dfsTableIndex=dfsTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, antennaGain=antennaGain, telecomsChannelSelection=telecomsChannelSelection, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, latitude=latitude, iPv4Address=iPv4Address, productName=productName, telecomsChannelBStatus=telecomsChannelBStatus, accessMethod=accessMethod, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, licenceGroup=licenceGroup, configuration=configuration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aAAControl=aAAControl, ethernet=ethernet, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClient=syslogClient, altitude=altitude, userTableNumber=userTableNumber, transmitChannel=transmitChannel, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTableEntry=userTableEntry, softwareVersion=softwareVersion, phyControlGroup=phyControlGroup, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, channelBandwidth=channelBandwidth, channelBLoopback=channelBLoopback, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelBLineCode=channelBLineCode, remoteInternetAddress=remoteInternetAddress, rxColorCode=rxColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, regionCodeTrap=regionCodeTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerStatus=sNTPServerStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, bridge=bridge, linkModeOptimizationMismatch=linkModeOptimizationMismatch, range=range, bandwidthVariant=bandwidthVariant, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelALineCode=channelALineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogState=syslogState, channelChangeTrap=channelChangeTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, userTableIndex=userTableIndex, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, pubStats=pubStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, aggregateDataRate=aggregateDataRate, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
