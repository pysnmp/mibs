...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementMode=managementMode, linkName=linkName, iPv6Address=iPv6Address, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkLoss=linkLoss, userTable=userTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, aggregateDataRate=aggregateDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogClient=syslogClient, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, iPv4Address=iPv4Address, securityLevel=securityLevel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTable=ethernetPriorityTable, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, receiveFreqMHz=receiveFreqMHz, rxColorCode=rxColorCode, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, syslogControl=syslogControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bridge=bridge, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, sNTPServerTableIndex=sNTPServerTableIndex, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, telnetAccessEnabled=telnetAccessEnabled, supplementary=supplementary, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, siteName=siteName, userTableNumber=userTableNumber, cambium=cambium, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, bridgeGroup=bridgeGroup, remoteIPAddress=remoteIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerStatus=sNTPServerStatus, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveChannel=receiveChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rawReceivePower=rawReceivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPVersion=iPVersion, ethernetBridgingStatus=ethernetBridgingStatus, resetGroup=resetGroup, phyControlGroup=phyControlGroup, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, latitude=latitude, channelBandwidth=channelBandwidth, sNTPSync=sNTPSync, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, sNTPServerTimeout=sNTPServerTimeout, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPv3Enable=sNMPv3Enable, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, hAZLOCConfiguration=hAZLOCConfiguration, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, licenceGroup=licenceGroup, longitude=longitude, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, dSCPManagementPriority=dSCPManagementPriority, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, phyStatus=phyStatus, ethernetGroup=ethernetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, PYSNMP_MODULE_ID=cambium, managementPortStatus=managementPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, channelBLoopbackTrap=channelBLoopbackTrap, rangingMode=rangingMode, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, regionCode=regionCode, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productName=productName, searchState=searchState, channelALoopbackTrap=channelALoopbackTrap, eIRP=eIRP, vLANManagementVID=vLANManagementVID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatus=dataPortFiberStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, gatewayIPAddress=gatewayIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelACableLength=channelACableLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, targetMACAddress=targetMACAddress, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, ptmp=ptmp, ptpTraps=ptpTraps, managementPortStatusTrap=managementPortStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, remoteRxTargetPower=remoteRxTargetPower, telecomsChannelBStatus=telecomsChannelBStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dfsPeaks=dfsPeaks, pubStats=pubStats, channelBLineCode=channelBLineCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, transmitPower=transmitPower, versionsGroup=versionsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpGroups=ptpGroups, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernet=ethernet, ptp600=ptp600, sNTPServerTable=sNTPServerTable, channelALoopback=channelALoopback, bandwidthVariant=bandwidthVariant, targetRange=targetRange, systemClock=systemClock, softwareVersion=softwareVersion, secureModeAlarm=secureModeAlarm, bootVersion=bootVersion, subnetMask=subnetMask, groupID=groupID, iPv6GatewayAddress=iPv6GatewayAddress, range=range, daylightSaving=daylightSaving, versions=versions, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, signalStrengthRatio=signalStrengthRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, userPassword=userPassword, sNTPServerRetries=sNTPServerRetries, encryptionGroup=encryptionGroup, encryption=encryption, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, localPacketFiltering=localPacketFiltering, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelALineCode=channelALineCode, txColorCode=txColorCode, alarmsGroup=alarmsGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, dfsTableNumber=dfsTableNumber, frequencyVariant=frequencyVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, dataPortStatus=dataPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, alarms=alarms, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, smtp=smtp, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, licence=licence, userName=userName, transmitFreqKHz=transmitFreqKHz, ethernetFiberSupport=ethernetFiberSupport, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, ptp=ptp, management=management, transmitModulationMode=transmitModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, dfs=dfs, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryptionAlgorithm=encryptionAlgorithm, telecom=telecom, dfsGroup=dfsGroup, receivePower=receivePower, phyControl=phyControl, timeZone=timeZone, channelBLoopback=channelBLoopback, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, altitude=altitude, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, userTableIndex=userTableIndex, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, managementGroup=managementGroup, syslogState=syslogState, channelChangeTrap=channelChangeTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerInternetAddress=sMTPServerInternetAddress)
