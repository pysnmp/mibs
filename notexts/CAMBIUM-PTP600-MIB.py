...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmState=installArmState, encryptionGroup=encryptionGroup, channelBLoopback=channelBLoopback, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, signalStrengthRatio=signalStrengthRatio, reset=reset, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, encryption=encryption, ethernetBridgingAvailability=ethernetBridgingAvailability, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, channelALoopbackTrap=channelALoopbackTrap, sNTPServerTable=sNTPServerTable, linkName=linkName, aAAControlGroup=aAAControlGroup, receiveChannel=receiveChannel, channelBLineCode=channelBLineCode, rangingMode=rangingMode, channelACableLength=channelACableLength, sMTPServerIPAddress=sMTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ptpCompliance=ptpCompliance, telecomsChannelSelection=telecomsChannelSelection, masterSlaveMode=masterSlaveMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogControlGroup=syslogControlGroup, configuration=configuration, ptpTraps=ptpTraps, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, searchState=searchState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, longitude=longitude, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteInternetAddress=remoteInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfs=dfs, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, sMTPServerInternetAddressType=sMTPServerInternetAddressType, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, sNTPServerTableNumber=sNTPServerTableNumber, snmpControlGroup=snmpControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, vLANManagementVID=vLANManagementVID, sNMPTrapTableIndex=sNMPTrapTableIndex, userPassword=userPassword, txColorCode=txColorCode, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsGroup=dfsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, automaticTxPowerControl=automaticTxPowerControl, cambium=cambium, ptp600=ptp600, phyStatusGroup=phyStatusGroup, licence=licence, sNMPTrapTable=sNMPTrapTable, localPacketFiltering=localPacketFiltering, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALoopback=channelALoopback, userTableNumber=userTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, linkSymmetry=linkSymmetry, versions=versions, sNMPTrapVersion=sNMPTrapVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortDisabledWarning=managementPortDisabledWarning, phyStatus=phyStatus, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, bootVersion=bootVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, softwareVersion=softwareVersion, iPv6PrefixLength=iPv6PrefixLength, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, bridge=bridge, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableEntry=dfsTableEntry, iPVersion=iPVersion, sNTPState=sNTPState, sNMPTrapIPAddress=sNMPTrapIPAddress, dSCPManagementPriority=dSCPManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, syslogState=syslogState, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimisation=linkModeOptimisation, smtpGroup=smtpGroup, tDDControl=tDDControl, ptmp=ptmp, hAZLOCConfiguration=hAZLOCConfiguration, systemClock=systemClock, configurationGroup=configurationGroup, sntpGroup=sntpGroup, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelAStatus=telecomsChannelAStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomGroup=telecomGroup, linkLoss=linkLoss, sNMPPortNumber=sNMPPortNumber, pubStatsGroup=pubStatsGroup, management=management, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSync=sNTPSync, eIRP=eIRP, remoteRxTargetPower=remoteRxTargetPower, userTableIndex=userTableIndex, managementGroup=managementGroup, ethernetBridgingStatus=ethernetBridgingStatus, PYSNMP_MODULE_ID=cambium, channelBCableLength=channelBCableLength, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, systemReset=systemReset, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerRetries=sNTPServerRetries, sNTPPrimaryServer=sNTPPrimaryServer, dfsTable=dfsTable, userTable=userTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, installStatus=installStatus, iPv6Address=iPv6Address, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, alarmsGroup=alarmsGroup, productVariant=productVariant, incompatibleRegionCodes=incompatibleRegionCodes, syslogStateTrap=syslogStateTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortStatus=managementPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogControl=syslogControl, rxColorCode=rxColorCode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, byteErrorRatio=byteErrorRatio, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, qOSPriorityScheme=qOSPriorityScheme, channelALineCode=channelALineCode, channelBLoopbackTrap=channelBLoopbackTrap, telecomsInterface=telecomsInterface, productName=productName, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, securityLevel=securityLevel, pubStats=pubStats, transmitDataRate=transmitDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortAutoMdix=dataPortAutoMdix, l2CPPriorityTable=l2CPPriorityTable, gatewayIPAddress=gatewayIPAddress, managementMode=managementMode, ethernetPriorityTable=ethernetPriorityTable, smtp=smtp, userTableEntry=userTableEntry, snmpControl=snmpControl, rawReceivePower=rawReceivePower, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, sNTPServerStatus=sNTPServerStatus, encryptionAlgorithm=encryptionAlgorithm, aAAControl=aAAControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, notificationsGroup=notificationsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptp=ptp, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqKHz=transmitFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogClientTrap=syslogClientTrap, targetRange=targetRange, remoteInternetAddressType=remoteInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, phyControlGroup=phyControlGroup, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, latitude=latitude, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bridgeGroup=bridgeGroup, channelBandwidth=channelBandwidth, receiveFreqMHz=receiveFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetFiberSupport=ethernetFiberSupport, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsPeaks=dfsPeaks, frequencyVariant=frequencyVariant, sNTPServerTableIndex=sNTPServerTableIndex, userRole=userRole, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, bandwidthVariant=bandwidthVariant, sNMPTrapTableEntry=sNMPTrapTableEntry)
