...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPAccessEnabled=hTTPAccessEnabled, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveFreqKHz=receiveFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bridge=bridge, iPv6PrefixLength=iPv6PrefixLength, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installStatus=installStatus, licence=licence, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryption=encryption, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddress=remoteInternetAddress, smtp=smtp, sntp=sntp, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, installStatusTrap=installStatusTrap, systemReset=systemReset, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControlGroup=phyControlGroup, daylightSaving=daylightSaving, ptpTrapPrefix=ptpTrapPrefix, tFTPServerIPAddress=tFTPServerIPAddress, supplementary=supplementary, dataPortStatus=dataPortStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPSync=sNTPSync, configuration=configuration, management=management, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, transmitFreqMHz=transmitFreqMHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, secondarySoftwareVersion=secondarySoftwareVersion, remoteInternetAddressType=remoteInternetAddressType, signalStrengthRatio=signalStrengthRatio, altitude=altitude, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, wirelessLinkStatus=wirelessLinkStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, ethernetBridgingStatus=ethernetBridgingStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, alarmsGroup=alarmsGroup, productName=productName, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, userRole=userRole, smtpGroup=smtpGroup, channelACableLength=channelACableLength, snmpControl=snmpControl, systemClock=systemClock, regionCode=regionCode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, ptmp=ptmp, syslogControl=syslogControl, telecomGroup=telecomGroup, txColorCode=txColorCode, sNTPServerStatus=sNTPServerStatus, transmitDataRate=transmitDataRate, channelBLoopbackTrap=channelBLoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmState=installArmState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vectorError=vectorError, linkSymmetry=linkSymmetry, phyStatus=phyStatus, sNTPServerTableIndex=sNTPServerTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, dfs=dfs, phyStatusGroup=phyStatusGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, rxColorCode=rxColorCode, sNMPTrapPortNumber=sNMPTrapPortNumber, automaticTxPowerControl=automaticTxPowerControl, byteErrorRatio=byteErrorRatio, eIRP=eIRP, hTTPPortNumber=hTTPPortNumber, rawReceivePower=rawReceivePower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, managementGroup=managementGroup, sNTPSyncTrap=sNTPSyncTrap, iPVersion=iPVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, sMTPEmailAlert=sMTPEmailAlert, timeZone=timeZone, transmitChannel=transmitChannel, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, configurationGroup=configurationGroup, telecom=telecom, iPv6GatewayAddress=iPv6GatewayAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, channelALoopbackTrap=channelALoopbackTrap, receiveChannel=receiveChannel, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, iPv6Address=iPv6Address, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, softwareVersion=softwareVersion, managementPortStatusTrap=managementPortStatusTrap, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userName=userName, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControlGroup=snmpControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, channelBCableLength=channelBCableLength, userPassword=userPassword, sNTPServerTable=sNTPServerTable, ptp600=ptp600, phyControl=phyControl, linkModeOptimisation=linkModeOptimisation, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, telecomsChannelSelection=telecomsChannelSelection, ethernetGroup=ethernetGroup, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, ptpCompliance=ptpCompliance, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortDisabledWarning=managementPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqKHz=transmitFreqKHz, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, encryptionAlgorithm=encryptionAlgorithm, qOSPriorityScheme=qOSPriorityScheme, rangingMode=rangingMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, managementPortStatus=managementPortStatus, maximumTransmitPower=maximumTransmitPower, telecomsChannelAStatus=telecomsChannelAStatus, resetGroup=resetGroup, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, versions=versions, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarm=secureModeAlarm, dfsGroup=dfsGroup, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBLineCode=channelBLineCode, remoteRxTargetPower=remoteRxTargetPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, bandwidthVariant=bandwidthVariant, searchState=searchState, cableLoss=cableLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, siteName=siteName, sNTPServerRetries=sNTPServerRetries, enabledDiagnosticAlarms=enabledDiagnosticAlarms, securityLevel=securityLevel, syslogClient=syslogClient)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, linkName=linkName, sNTPPrimaryServer=sNTPPrimaryServer, managementMode=managementMode, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, regionCodeTrap=regionCodeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, range=range, channelALineCode=channelALineCode, userTable=userTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, dSCPManagementPriority=dSCPManagementPriority, secureModeAlarmTrap=secureModeAlarmTrap, channelALoopback=channelALoopback, telnetPortNumber=telnetPortNumber, userEnabled=userEnabled, hAZLOCConfiguration=hAZLOCConfiguration, targetMACAddress=targetMACAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cambium=cambium, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, aAAControlGroup=aAAControlGroup, channelBLoopback=channelBLoopback)
