...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitChannel=transmitChannel, channelBCableLength=channelBCableLength, alarmsGroup=alarmsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, encryption=encryption, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetGroup=ethernetGroup, sntp=sntp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, rawReceivePower=rawReceivePower, secureModeAlarm=secureModeAlarm, resetGroup=resetGroup, sMTPEmailAlert=sMTPEmailAlert, channelChangeTrap=channelChangeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomGroup=telecomGroup, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, ethernetPriorityTableEntry=ethernetPriorityTableEntry, frequencyVariant=frequencyVariant, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpGroups=ptpGroups, receiveChannel=receiveChannel, ethernetPriorityTable=ethernetPriorityTable, systemReset=systemReset, antennaGain=antennaGain, smtp=smtp, supplementary=supplementary, dfsGroup=dfsGroup, dfsTable=dfsTable, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, dataPortAutoMdix=dataPortAutoMdix, managementPortStatus=managementPortStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, l2CPPriorityTable=l2CPPriorityTable, productName=productName, timeZone=timeZone, channelALineCode=channelALineCode, syslogClient=syslogClient, secureModeAlarmTrap=secureModeAlarmTrap, channelALoopback=channelALoopback, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, eIRP=eIRP, softwareVersion=softwareVersion, remoteInternetAddressType=remoteInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableLoss=cableLoss, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, channelBLineCode=channelBLineCode, sntpGroup=sntpGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControl=aAAControl, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTableIndex=sNTPServerTableIndex, bridgeGroup=bridgeGroup, dataPortFiberStatus=dataPortFiberStatus, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddress=sMTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, regionCode=regionCode, vLANManagementVID=vLANManagementVID, userRole=userRole, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteRxTargetPower=remoteRxTargetPower, managementGroup=managementGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTable=sNTPServerTable, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rangingMode=rangingMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationMode=tDDSynchronizationMode, vectorError=vectorError, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, targetMACAddress=targetMACAddress, supplementaryGroup=supplementaryGroup, installStatus=installStatus, ethernetBridgingStatus=ethernetBridgingStatus, pubStats=pubStats, channelALoopbackTrap=channelALoopbackTrap, securityLevel=securityLevel, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, alarms=alarms, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, userEnabled=userEnabled, ptpCompliance=ptpCompliance, aAAControlGroup=aAAControlGroup, channelBLoopbackTrap=channelBLoopbackTrap, iPv6GatewayAddress=iPv6GatewayAddress, receiveModulationMode=receiveModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, localPacketFiltering=localPacketFiltering, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, groupID=groupID, telecomsChannelAStatus=telecomsChannelAStatus, installStatusTrap=installStatusTrap, iPv6Address=iPv6Address, tDDSynchronizationStatus=tDDSynchronizationStatus, targetRange=targetRange, sNMPv3Enable=sNMPv3Enable, dfsTableIndex=dfsTableIndex, channelBLoopback=channelBLoopback, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, automaticTxPowerControl=automaticTxPowerControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userName=userName, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyStatus=phyStatus, licence=licence, phyControl=phyControl, reset=reset, cambium=cambium, linkLoss=linkLoss, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, masterSlaveMode=masterSlaveMode, ptp600=ptp600, bridge=bridge, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, productVariant=productVariant, receiveModulationModeDetail=receiveModulationModeDetail, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTable=userTable, dfsPeaks=dfsPeaks, telecomsChannelSelection=telecomsChannelSelection, txColorCode=txColorCode, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatch=linkModeOptimizationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelBStatus=telecomsChannelBStatus, phyControlGroup=phyControlGroup, linkName=linkName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, configurationGroup=configurationGroup, managementMode=managementMode, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, ethernet=ethernet, iPv6PrefixLength=iPv6PrefixLength, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTableNumber=sNTPServerTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, linkSymmetry=linkSymmetry, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqKHz=receiveFreqKHz, sNTPServerTimeout=sNTPServerTimeout, syslogState=syslogState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, versionsGroup=versionsGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, gatewayIPAddress=gatewayIPAddress, remoteInternetAddress=remoteInternetAddress, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, daylightSaving=daylightSaving, syslogControlGroup=syslogControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsMeans=dfsMeans, receivePower=receivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, channelACableLength=channelACableLength, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteIPAddress=remoteIPAddress, range=range)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", licenceGroup=licenceGroup, rxColorCode=rxColorCode, iPv4Address=iPv4Address, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTable=mPLSTCPriorityTable, encryptionAlgorithm=encryptionAlgorithm, ptmp=ptmp, pubStatsGroup=pubStatsGroup, telecom=telecom, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, sNTPPollInterval=sNTPPollInterval, versions=versions, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableNumber=dfsTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, longitude=longitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, accessMethod=accessMethod, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, bootVersion=bootVersion, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, l2CPPriorityTableEntry=l2CPPriorityTableEntry, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, ptp=ptp, iPDSCPPriorityTable=iPDSCPPriorityTable, dfs=dfs)
