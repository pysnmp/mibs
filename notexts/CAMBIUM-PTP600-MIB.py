...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", supplementary=supplementary, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryption=encryption, masterSlaveMode=masterSlaveMode, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, channelACableLength=channelACableLength, sMTPEnabledMessages=sMTPEnabledMessages, managementPortStatusTrap=managementPortStatusTrap, syslogControlGroup=syslogControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerIPAddress=tFTPServerIPAddress, siteName=siteName, pubStatsGroup=pubStatsGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogStateTrap=syslogStateTrap, dataPortStatus=dataPortStatus, rawReceivePower=rawReceivePower, phyControlGroup=phyControlGroup, ptp600=ptp600, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, supplementaryGroup=supplementaryGroup, unitOutOfCalibration=unitOutOfCalibration, syslogControl=syslogControl, eIRP=eIRP, sNTPServerStatus=sNTPServerStatus, syslogClient=syslogClient, vLANManagementPriority=vLANManagementPriority, syslogState=syslogState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, localPacketFiltering=localPacketFiltering, channelBLoopback=channelBLoopback, managementPortDisabledWarning=managementPortDisabledWarning, userName=userName, channelBCableLength=channelBCableLength, licence=licence, dfsPeaks=dfsPeaks, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, rxColorCode=rxColorCode, searchState=searchState, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetFiberSupport=ethernetFiberSupport, transmitFreqKHz=transmitFreqKHz, ptpTraps=ptpTraps, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPPortNumber=sNMPPortNumber, ptpCompliance=ptpCompliance, ethernetBridgingStatus=ethernetBridgingStatus, channelALoopback=channelALoopback, receiveFreqKHz=receiveFreqKHz, cableLoss=cableLoss, bridge=bridge, phyStatusGroup=phyStatusGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernet=ethernet, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, targetRange=targetRange, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, managementPortStatus=managementPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStats=pubStats, sNTPServerTableEntry=sNTPServerTableEntry, smtp=smtp, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, iPv6PrefixLength=iPv6PrefixLength, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsInterface=telecomsInterface, bootVersion=bootVersion, longitude=longitude, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rangingMode=rangingMode, productName=productName, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkLoss=linkLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, reset=reset, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, subnetMask=subnetMask, remoteInternetAddressType=remoteInternetAddressType, snmpControlGroup=snmpControlGroup, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, iPv6Address=iPv6Address, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, sNTPServerPortNumber=sNTPServerPortNumber, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTable=iPDSCPPriorityTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, alarms=alarms, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, channelALineCode=channelALineCode, smtpGroup=smtpGroup, ptpGroups=ptpGroups, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, dfsTableIndex=dfsTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptmp=ptmp, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, maximumTransmitPower=maximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, automaticTxPowerControl=automaticTxPowerControl, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPPortNumber=hTTPPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, linkModeOptimisation=linkModeOptimisation, telecomsChannelAStatus=telecomsChannelAStatus, telecomsChannelSelection=telecomsChannelSelection, bandwidthVariant=bandwidthVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, dfsMeans=dfsMeans, vectorError=vectorError, securityLevel=securityLevel, dataPortFiberStatus=dataPortFiberStatus, systemReset=systemReset, aAAControl=aAAControl, receiveFreqMHz=receiveFreqMHz, channelChangeTrap=channelChangeTrap, daylightSaving=daylightSaving, sntpGroup=sntpGroup, managementMode=managementMode, receiveModulationMode=receiveModulationMode, sNTPPollInterval=sNTPPollInterval, telecom=telecom, bridgeGroup=bridgeGroup, sNTPServerIPAddress=sNTPServerIPAddress, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, groupID=groupID, hAZLOCConfiguration=hAZLOCConfiguration, alarmsGroup=alarmsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv4Address=iPv4Address, managementGroup=managementGroup, range=range, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, versions=versions, dfsGroup=dfsGroup, timeZone=timeZone, sntp=sntp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, cambium=cambium, resetGroup=resetGroup, ethernetPriorityTable=ethernetPriorityTable, sNTPState=sNTPState, sMTPServerIPAddress=sMTPServerIPAddress, ptp=ptp, PYSNMP_MODULE_ID=cambium, management=management, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, iPVersion=iPVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, sNTPServerRetries=sNTPServerRetries, phyControl=phyControl, dfsTable=dfsTable, regionCode=regionCode, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, versionsGroup=versionsGroup, remoteRxTargetPower=remoteRxTargetPower, transmitFreqMHz=transmitFreqMHz, sNTPServerTable=sNTPServerTable, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, sNMPv3Enable=sNMPv3Enable, secureModeAlarm=secureModeAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoNegotiation=dataPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, iPv6GatewayAddress=iPv6GatewayAddress, userTableIndex=userTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomGroup=telecomGroup, notificationsGroup=notificationsGroup, userTable=userTable, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopbackTrap=channelALoopbackTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, configuration=configuration, sNTPServerTimeout=sNTPServerTimeout, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, remoteIPAddress=remoteIPAddress, tDDControl=tDDControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, linkSymmetry=linkSymmetry, vLANManagementVID=vLANManagementVID, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, systemClock=systemClock, linkName=linkName, receiveChannel=receiveChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
