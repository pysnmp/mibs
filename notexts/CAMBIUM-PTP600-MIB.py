...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", secureModeAlarm=secureModeAlarm, licence=licence, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, configuration=configuration, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rangingMode=rangingMode, userRole=userRole, latitude=latitude, accessMethod=accessMethod, iPv6Address=iPv6Address, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, secureModeAlarmTrap=secureModeAlarmTrap, phyControl=phyControl, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, receivePower=receivePower, sMTPServerInternetAddress=sMTPServerInternetAddress, aAAControlGroup=aAAControlGroup, sNTPPrimaryServer=sNTPPrimaryServer, qOSPriorityScheme=qOSPriorityScheme, installArmState=installArmState, tDDControl=tDDControl, licenceGroup=licenceGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerStatus=sNTPServerStatus, telecomsChannelAStatus=telecomsChannelAStatus, groupID=groupID, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, channelBCableLength=channelBCableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, syslogControlGroup=syslogControlGroup, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLoopback=channelBLoopback, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelSelection=telecomsChannelSelection, productVariant=productVariant, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClientTrap=syslogClientTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementMode=managementMode, telecomGroup=telecomGroup, dfs=dfs, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6PrefixLength=iPv6PrefixLength, syslogControl=syslogControl, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, bootVersion=bootVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, ptmp=ptmp, ptp=ptp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, telnetAccessEnabled=telnetAccessEnabled, longitude=longitude, encryption=encryption, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPServerIPAddress=tFTPServerIPAddress, channelALoopback=channelALoopback, userEnabled=userEnabled, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, versionsGroup=versionsGroup, userName=userName, telecom=telecom, dataPortFiberStatus=dataPortFiberStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, antennaGain=antennaGain, range=range, transmitModulationMode=transmitModulationMode, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementGroup=managementGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryptionGroup=encryptionGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aAAControl=aAAControl, receiveFreqMHz=receiveFreqMHz, dfsTableEntry=dfsTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtp=smtp, channelALoopbackTrap=channelALoopbackTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBLineCode=channelBLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, vLANManagementVID=vLANManagementVID, hAZLOCConfiguration=hAZLOCConfiguration, iPVersion=iPVersion, ptpGroups=ptpGroups, regionCode=regionCode, txColorCode=txColorCode, sNTPLastSync=sNTPLastSync, sNTPServerTableNumber=sNTPServerTableNumber, cableLoss=cableLoss, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, dataPortAutoMdix=dataPortAutoMdix, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, maximumTransmitPower=maximumTransmitPower, altitude=altitude, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, automaticTxPowerControl=automaticTxPowerControl, systemReset=systemReset, bridge=bridge, alarms=alarms, phyStatus=phyStatus, linkName=linkName, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, dfsTable=dfsTable, localPacketFiltering=localPacketFiltering, iPv4Address=iPv4Address, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, ethernet=ethernet, systemClock=systemClock, eIRP=eIRP, sNMPTrapTable=sNMPTrapTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStatsGroup=pubStatsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, phyStatusGroup=phyStatusGroup, managementPortDisabledWarning=managementPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, vectorError=vectorError, installStatusTrap=installStatusTrap, pubStats=pubStats, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkSymmetry=linkSymmetry, channelBandwidth=channelBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, hTTPSPortNumber=hTTPSPortNumber, ptp600=ptp600, smtpGroup=smtpGroup, receiveChannel=receiveChannel, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, searchState=searchState, targetMACAddress=targetMACAddress, bridgeGroup=bridgeGroup, sNTPServerPortNumber=sNTPServerPortNumber, configurationGroup=configurationGroup, dfsGroup=dfsGroup, channelACableLength=channelACableLength, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, rawReceivePower=rawReceivePower, receiveFreqKHz=receiveFreqKHz, softwareVersion=softwareVersion, channelChangeTrap=channelChangeTrap, ethernetPriorityTable=ethernetPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControlGroup=phyControlGroup, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, sNTPSync=sNTPSync, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, reset=reset, masterSlaveMode=masterSlaveMode, transmitDataRate=transmitDataRate, subnetMask=subnetMask, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteRxTargetPower=remoteRxTargetPower, bandwidthVariant=bandwidthVariant, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, transmitChannel=transmitChannel, incompatibleRegionCodes=incompatibleRegionCodes, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementPortStatus=managementPortStatus, syslogState=syslogState, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, supplementaryGroup=supplementaryGroup, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerTable=sNTPServerTable, cambium=cambium, sntp=sntp, rxColorCode=rxColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, targetRange=targetRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, management=management, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, siteName=siteName, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, sNMPPortNumber=sNMPPortNumber, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, alarmsGroup=alarmsGroup, regionCodeTrap=regionCodeTrap, versions=versions, ethernetBridgingStatus=ethernetBridgingStatus, securityLevel=securityLevel, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber)
