...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, phyControl=phyControl, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, cambium=cambium, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, timeZone=timeZone, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBCableLength=channelBCableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptp600=ptp600, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, qOSPriorityScheme=qOSPriorityScheme, channelALoopback=channelALoopback, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTable=ethernetPriorityTable, automaticTxPowerControl=automaticTxPowerControl, receiveChannel=receiveChannel, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, pubStatsGroup=pubStatsGroup, groupID=groupID, tDDControl=tDDControl, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, targetRange=targetRange, transmitChannel=transmitChannel, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, channelALineCode=channelALineCode, iPVersion=iPVersion, aAAControlGroup=aAAControlGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptp=ptp, ptpCompliance=ptpCompliance, vLANManagementVID=vLANManagementVID, vectorError=vectorError, receiveModulationMode=receiveModulationMode, dataPortFiberStatus=dataPortFiberStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarms=alarms, sntpGroup=sntpGroup, telecomsChannelBStatus=telecomsChannelBStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogState=syslogState, txColorCode=txColorCode, productVariant=productVariant, supplementaryGroup=supplementaryGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, subnetMask=subnetMask, dfs=dfs, dfsTable=dfsTable, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSync=sNTPSync, remoteRxTargetPower=remoteRxTargetPower, channelBandwidth=channelBandwidth, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqMHz=transmitFreqMHz, antennaGain=antennaGain, l2CPPriorityTableEntry=l2CPPriorityTableEntry, regionCode=regionCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqKHz=transmitFreqKHz, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableNumber=userTableNumber, altitude=altitude, channelACableLength=channelACableLength, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, sNTPServerStatus=sNTPServerStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, encryption=encryption, resetGroup=resetGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortStatus=dataPortStatus, userTable=userTable, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, channelBLoopbackTrap=channelBLoopbackTrap, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telecom=telecom, syslogControl=syslogControl, snmpControlGroup=snmpControlGroup, rangingMode=rangingMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarm=secureModeAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, masterSlaveMode=masterSlaveMode, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, bootVersion=bootVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, licenceGroup=licenceGroup, sNTPServerTable=sNTPServerTable, eIRP=eIRP, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userRole=userRole, channelALoopbackTrap=channelALoopbackTrap, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, linkSymmetry=linkSymmetry, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerPortNumber=tFTPServerPortNumber, ptmp=ptmp, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerIPAddress=sNTPServerIPAddress, channelBLineCode=channelBLineCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernet=ethernet, sntp=sntp, userTableIndex=userTableIndex, unitOutOfCalibration=unitOutOfCalibration, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, dataPortAutoMdix=dataPortAutoMdix, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rawReceivePower=rawReceivePower, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, searchState=searchState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerRetries=sNTPServerRetries, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, linkLoss=linkLoss, userPassword=userPassword, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, alarmsGroup=alarmsGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLoopback=channelBLoopback, syslogControlGroup=syslogControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, sNMPPortNumber=sNMPPortNumber, ptpTrapPrefix=ptpTrapPrefix, byteErrorRatio=byteErrorRatio, syslogStateTrap=syslogStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userName=userName, iPv4Address=iPv4Address, tDDControlGroup=tDDControlGroup, rxColorCode=rxColorCode, dfsGroup=dfsGroup, installStatus=installStatus, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelSelection=telecomsChannelSelection, sNTPServerTableNumber=sNTPServerTableNumber, installArmStateTrap=installArmStateTrap, managementPortStatusTrap=managementPortStatusTrap, longitude=longitude, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receivePower=receivePower, ptpGroups=ptpGroups, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPv6PrefixLength=iPv6PrefixLength, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, sNTPServerTableEntry=sNTPServerTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, securityLevel=securityLevel, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTable=mPLSTCPriorityTable, notificationsGroup=notificationsGroup, iPv6Address=iPv6Address, accessMethod=accessMethod, telecomsChannelAStatus=telecomsChannelAStatus, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortDisabledWarning=managementPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, range=range, latitude=latitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCodeTrap=regionCodeTrap, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, hardwareVersion=hardwareVersion, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bridge=bridge, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPCommunityString=sNMPCommunityString, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, telecomGroup=telecomGroup, localPacketFiltering=localPacketFiltering, phyStatusGroup=phyStatusGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteInternetAddressType=remoteInternetAddressType, managementMode=managementMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, bridgeGroup=bridgeGroup, versions=versions, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, supplementary=supplementary, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortStatus=managementPortStatus, channelChangeTrap=channelChangeTrap, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTable=l2CPPriorityTable, sNTPSyncTrap=sNTPSyncTrap, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate)
