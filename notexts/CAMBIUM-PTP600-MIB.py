...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:00:30 2021
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bridge=bridge, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetMACAddress=targetMACAddress, ptpTraps=ptpTraps, channelBLineCode=channelBLineCode, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, sNTPSync=sNTPSync, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerStatus=sNTPServerStatus, ptpGroups=ptpGroups, remoteIPAddress=remoteIPAddress, timeZone=timeZone, sntp=sntp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, alarms=alarms, linkLoss=linkLoss, receiveFreqMHz=receiveFreqMHz, sNTPServerTableEntry=sNTPServerTableEntry, transmitFreqKHz=transmitFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, daylightSaving=daylightSaving, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, hTTPPortNumber=hTTPPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, frequencyVariant=frequencyVariant, telecom=telecom, channelBCableLength=channelBCableLength, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userTableEntry=userTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, localPacketFiltering=localPacketFiltering, supplementaryGroup=supplementaryGroup, unitOutOfCalibration=unitOutOfCalibration, dfsGroup=dfsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityTable=l2CPPriorityTable, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableIndex=dfsTableIndex, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTimeout=sNTPServerTimeout, channelBandwidth=channelBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControlGroup=tDDControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControl=syslogControl, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, managementGroup=managementGroup, ptp=ptp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, masterSlaveMode=masterSlaveMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementMode=managementMode, altitude=altitude, aggregateDataRate=aggregateDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxColorCode=rxColorCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, siteName=siteName, dSCPManagementPriority=dSCPManagementPriority, installStatusTrap=installStatusTrap, smtp=smtp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimisation=linkModeOptimisation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelAStatus=telecomsChannelAStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, dataPortStatus=dataPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableIndex=userTableIndex, userPassword=userPassword, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, regionCodeTrap=regionCodeTrap, syslogClientTrap=syslogClientTrap, ethernet=ethernet, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, targetRange=targetRange, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelBStatus=telecomsChannelBStatus, configurationGroup=configurationGroup, syslogClient=syslogClient, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTable=sNTPServerTable, sntpGroup=sntpGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cambium=cambium, gatewayIPAddress=gatewayIPAddress, managementPortStatus=managementPortStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopback=channelALoopback, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, latitude=latitude, ptpCompliance=ptpCompliance, rangingMode=rangingMode, productVariant=productVariant, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, receiveChannel=receiveChannel, alarmsGroup=alarmsGroup, dfsTable=dfsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteRxTargetPower=remoteRxTargetPower, signalStrengthRatio=signalStrengthRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, secureModeAlarmTrap=secureModeAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, channelALoopbackTrap=channelALoopbackTrap, hardwareVersion=hardwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTable=ethernetPriorityTable, reset=reset, transmitDataRate=transmitDataRate, wirelessLinkStatus=wirelessLinkStatus, transmitChannel=transmitChannel, encryptionAlgorithm=encryptionAlgorithm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, remoteInternetAddress=remoteInternetAddress, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, userEnabled=userEnabled, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, l2CPPriorityTableIndex=l2CPPriorityTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPEmailAlert=sMTPEmailAlert, channelBLoopback=channelBLoopback, sNMPv3Enable=sNMPv3Enable, dfsTableNumber=dfsTableNumber, telecomsInterface=telecomsInterface, cableLoss=cableLoss, productName=productName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControl=phyControl, supplementary=supplementary, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControlGroup=snmpControlGroup, automaticTxPowerControl=automaticTxPowerControl, bridgeGroup=bridgeGroup, secureModeAlarm=secureModeAlarm, eIRP=eIRP, sNTPServerRetries=sNTPServerRetries, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemReset=systemReset, sNTPServerTableIndex=sNTPServerTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, rawReceivePower=rawReceivePower, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, accessMethod=accessMethod, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, userTableNumber=userTableNumber, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPv6PrefixLength=iPv6PrefixLength, iPVersion=iPVersion, telnetPortNumber=telnetPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, groupID=groupID, ethernetBridgingAvailability=ethernetBridgingAvailability, licenceGroup=licenceGroup, installStatus=installStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, channelChangeTrap=channelChangeTrap, aAAControl=aAAControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, linkName=linkName, pubStats=pubStats, iPv6Address=iPv6Address, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, securityLevel=securityLevel, range=range, pubStatsGroup=pubStatsGroup, searchState=searchState, softwareVersion=softwareVersion, channelALineCode=channelALineCode, telecomsChannelSelection=telecomsChannelSelection, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerInternetAddress=sMTPServerInternetAddress, subnetMask=subnetMask, txColorCode=txColorCode, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkSymmetry=linkSymmetry, sNMPTrapTableNumber=sNMPTrapTableNumber, ptp600=ptp600, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bandwidthVariant=bandwidthVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, managementPortDisabledWarning=managementPortDisabledWarning, encryptionGroup=encryptionGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPollInterval=sNTPPollInterval, snmpControl=snmpControl, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, receiveFreqKHz=receiveFreqKHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsPeaks=dfsPeaks, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelACableLength=channelACableLength, configuration=configuration, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatusGroup=phyStatusGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfs=dfs, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsMeans=dfsMeans, ethernetBridgingStatus=ethernetBridgingStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, longitude=longitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userName=userName, resetGroup=resetGroup, iPv4Address=iPv4Address, versionsGroup=versionsGroup, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower)
