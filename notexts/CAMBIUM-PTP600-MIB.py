...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bootVersion=bootVersion, supplementary=supplementary, userPassword=userPassword, telecomGroup=telecomGroup, syslogControlGroup=syslogControlGroup, management=management, ethernetBridgingStatus=ethernetBridgingStatus, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, antennaGain=antennaGain, channelALoopbackTrap=channelALoopbackTrap, userTableIndex=userTableIndex, rangingMode=rangingMode, sMTPServerPortNumber=sMTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aggregateDataRate=aggregateDataRate, secureModeAlarm=secureModeAlarm, userTableNumber=userTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sntpGroup=sntpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitChannel=transmitChannel, ethernet=ethernet, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptp600=ptp600, range=range, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, productName=productName, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, longitude=longitude, dataPortStatus=dataPortStatus, ptp=ptp, byteErrorRatio=byteErrorRatio, managementMode=managementMode, ethernetGroup=ethernetGroup, configurationGroup=configurationGroup, frequencyVariant=frequencyVariant, reset=reset, txColorCode=txColorCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPPortNumber=sNMPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBLineCode=channelBLineCode, channelALineCode=channelALineCode, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveFreqKHz=receiveFreqKHz, telecomsChannelSelection=telecomsChannelSelection, groupID=groupID, dfsGroup=dfsGroup, channelACableLength=channelACableLength, versionsGroup=versionsGroup, dfsTableIndex=dfsTableIndex, syslogControl=syslogControl, ptpTraps=ptpTraps, aAAControl=aAAControl, installStatusTrap=installStatusTrap, pubStatsGroup=pubStatsGroup, securityLevel=securityLevel, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, hardwareVersion=hardwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, automaticTxPowerControl=automaticTxPowerControl, snmpControl=snmpControl, latitude=latitude, regionCode=regionCode, linkModeOptimisation=linkModeOptimisation, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapPortNumber=sNMPTrapPortNumber, sntp=sntp, ethernetPriorityTable=ethernetPriorityTable, softwareVersion=softwareVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, alarmsGroup=alarmsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptmp=ptmp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveFreqMHz=receiveFreqMHz, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, sNTPServerIPAddress=sNTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, systemReset=systemReset, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receivePower=receivePower, transmitModulationMode=transmitModulationMode, resetGroup=resetGroup, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, sNTPLastSync=sNTPLastSync, siteName=siteName, sNTPServerTableIndex=sNTPServerTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTable=l2CPPriorityTable, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPrimaryServer=sNTPPrimaryServer, bridge=bridge, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, qOSPriorityScheme=qOSPriorityScheme, receiveModulationModeDetail=receiveModulationModeDetail, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, timeZone=timeZone, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, tDDControlGroup=tDDControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, telnetAccessEnabled=telnetAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortFiberStatus=dataPortFiberStatus, smtp=smtp, targetRange=targetRange, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, cambium=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, PYSNMP_MODULE_ID=cambium, dfs=dfs, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, licence=licence, iPVersion=iPVersion, rxColorCode=rxColorCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, daylightSaving=daylightSaving, syslogClient=syslogClient, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, regionCodeTrap=regionCodeTrap, dataPortAutoMdix=dataPortAutoMdix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, localPacketFiltering=localPacketFiltering, userTableEntry=userTableEntry, accessMethod=accessMethod, dSCPManagementPriority=dSCPManagementPriority, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarmTrap=secureModeAlarmTrap, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, managementPortDisabledWarning=managementPortDisabledWarning, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, managementPortStatus=managementPortStatus, linkLoss=linkLoss, alarms=alarms, telecomsChannelBStatus=telecomsChannelBStatus, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveChannel=receiveChannel, channelBandwidth=channelBandwidth, channelALoopback=channelALoopback, vectorError=vectorError, userName=userName, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, encryptionGroup=encryptionGroup, channelBCableLength=channelBCableLength, installArmStateTrap=installArmStateTrap, dfsPeaks=dfsPeaks, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv4Address=iPv4Address, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, sNTPServerRetries=sNTPServerRetries, receiveModulationMode=receiveModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, eIRP=eIRP, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, altitude=altitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, channelBLoopbackTrap=channelBLoopbackTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortStatusTrap=managementPortStatusTrap, transmitDataRate=transmitDataRate, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, configuration=configuration, pubStats=pubStats, dfsMeans=dfsMeans, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerIPAddress=sMTPServerIPAddress, channelBLoopback=channelBLoopback, sNMPCommunityString=sNMPCommunityString, bridgeGroup=bridgeGroup, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, installStatus=installStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, phyStatus=phyStatus, versions=versions, telecomsChannelAStatus=telecomsChannelAStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6Address=iPv6Address, hTTPSPortNumber=hTTPSPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerPortNumber=sNTPServerPortNumber, ptpCompliance=ptpCompliance, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, iPv6GatewayAddress=iPv6GatewayAddress)
