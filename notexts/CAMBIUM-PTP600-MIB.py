...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", securityLevel=securityLevel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortAutoMdix=dataPortAutoMdix, ethernetPriorityTable=ethernetPriorityTable, managementPortStatus=managementPortStatus, channelBandwidth=channelBandwidth, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, management=management, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPPortNumber=hTTPPortNumber, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, syslogClientTrap=syslogClientTrap, channelALoopbackTrap=channelALoopbackTrap, aggregateDataRate=aggregateDataRate, receivePower=receivePower, versionsGroup=versionsGroup, installArmState=installArmState, channelALineCode=channelALineCode, receiveChannel=receiveChannel, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userEnabled=userEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTimeout=sNTPServerTimeout, bootVersion=bootVersion, sNTPServerStatus=sNTPServerStatus, sNMPTrapTable=sNMPTrapTable, searchState=searchState, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, ptp=ptp, alarms=alarms, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelALoopback=channelALoopback, productName=productName, sMTPEnabledMessages=sMTPEnabledMessages, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTable=userTable, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, linkName=linkName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, range=range, sNMPCommunityString=sNMPCommunityString, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBLoopback=channelBLoopback, userRole=userRole, channelChangeTrap=channelChangeTrap, smtp=smtp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBCableLength=channelBCableLength, secureModeAlarmTrap=secureModeAlarmTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, snmpControl=snmpControl, tDDControl=tDDControl, telecomGroup=telecomGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkStatus=wirelessLinkStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPrimaryServer=sNTPPrimaryServer, aAAControlGroup=aAAControlGroup, telecomsChannelBStatus=telecomsChannelBStatus, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, accessMethod=accessMethod, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPPortNumber=sNMPPortNumber, sNMPTrapVersion=sNMPTrapVersion, phyControlGroup=phyControlGroup, vLANManagementVID=vLANManagementVID, userPassword=userPassword, sntp=sntp, targetMACAddress=targetMACAddress, ptp600=ptp600, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, smtpGroup=smtpGroup, timeZone=timeZone, transmitChannel=transmitChannel, userTableIndex=userTableIndex, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyStatus=phyStatus, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, dfsTableIndex=dfsTableIndex, managementMode=managementMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetRange=targetRange, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, iPVersion=iPVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, frequencyVariant=frequencyVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, sNTPSync=sNTPSync, vectorError=vectorError, hAZLOCConfiguration=hAZLOCConfiguration, dfsGroup=dfsGroup, managementGroup=managementGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitPower=transmitPower, remoteInternetAddress=remoteInternetAddress, dfsTable=dfsTable, receiveDataRate=receiveDataRate, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, alarmsGroup=alarmsGroup, linkModeOptimisation=linkModeOptimisation, systemReset=systemReset, bridgeGroup=bridgeGroup, ethernetBridgingStatus=ethernetBridgingStatus, txColorCode=txColorCode, masterSlaveMode=masterSlaveMode, ptpCompliance=ptpCompliance, localPacketFiltering=localPacketFiltering, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogStateTrap=syslogStateTrap, iPv6Address=iPv6Address, l2CPPriorityTable=l2CPPriorityTable, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTable=mPLSTCPriorityTable, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, channelACableLength=channelACableLength, versions=versions, receiveFreqMHz=receiveFreqMHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, telnetAccessEnabled=telnetAccessEnabled, transmitModulationMode=transmitModulationMode, secureModeAlarm=secureModeAlarm, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, encryptionGroup=encryptionGroup, sNMPv3Enable=sNMPv3Enable, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControl=aAAControl, sntpGroup=sntpGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, configuration=configuration, receiveFreqKHz=receiveFreqKHz, siteName=siteName, dataPortFiberStatus=dataPortFiberStatus, userName=userName, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatusTrap=installStatusTrap, telecomsChannelAStatus=telecomsChannelAStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, signalStrengthRatio=signalStrengthRatio, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, installStatus=installStatus, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarning=managementPortDisabledWarning, channelBLoopbackTrap=channelBLoopbackTrap, resetGroup=resetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, byteErrorRatio=byteErrorRatio, rxColorCode=rxColorCode, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, syslogControlGroup=syslogControlGroup, qOSPriorityScheme=qOSPriorityScheme, ethernetFiberSupport=ethernetFiberSupport, transmitDataRate=transmitDataRate, telecomsChannelSelection=telecomsChannelSelection, secondarySoftwareVersion=secondarySoftwareVersion, managementPortStatusTrap=managementPortStatusTrap, dfsPeaks=dfsPeaks, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableEntry=userTableEntry, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetPortNumber=telnetPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibration=unitOutOfCalibration, channelBLineCode=channelBLineCode, daylightSaving=daylightSaving, bandwidthVariant=bandwidthVariant, productVariant=productVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, dfsMeans=dfsMeans, dfsTableEntry=dfsTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rawReceivePower=rawReceivePower, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, configurationGroup=configurationGroup, ptpTraps=ptpTraps, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, regionCodeTrap=regionCodeTrap, sNTPServerTable=sNTPServerTable, remoteInternetAddressType=remoteInternetAddressType, longitude=longitude, phyStatusGroup=phyStatusGroup, phyControl=phyControl, iPv6PrefixLength=iPv6PrefixLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStats=pubStats, transmitFreqMHz=transmitFreqMHz, rangingMode=rangingMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPState=sNTPState, ptpGroups=ptpGroups, ethernetBridgingAvailability=ethernetBridgingAvailability, softwareVersion=softwareVersion, licenceGroup=licenceGroup, sNTPServerIPAddress=sNTPServerIPAddress, latitude=latitude, iPv4Address=iPv4Address, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs)
