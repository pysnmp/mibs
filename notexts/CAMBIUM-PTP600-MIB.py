...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveFreqKHz=receiveFreqKHz, snmpControlGroup=snmpControlGroup, encryption=encryption, iPv6Address=iPv6Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, accessMethod=accessMethod, sNTPServerInternetAddressType=sNTPServerInternetAddressType, phyStatus=phyStatus, channelBCableLength=channelBCableLength, installStatus=installStatus, receiveModulationMode=receiveModulationMode, ethernet=ethernet, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClientTrap=syslogClientTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, pubStats=pubStats, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkAvailability=wirelessLinkAvailability, secureModeAlarmTrap=secureModeAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, ethernetBridgingStatus=ethernetBridgingStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, eIRP=eIRP, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, antennaGain=antennaGain, ptp600=ptp600, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPSyncTrap=sNTPSyncTrap, smtpGroup=smtpGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkLoss=linkLoss, sntp=sntp, iPVersion=iPVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, telecomsChannelSelection=telecomsChannelSelection, range=range, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogClient=syslogClient, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, userRole=userRole, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, channelALoopback=channelALoopback, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, groupID=groupID, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, dfsGroup=dfsGroup, bridgeGroup=bridgeGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridge=bridge, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, telnetAccessEnabled=telnetAccessEnabled, ptpTraps=ptpTraps, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, sNMPPortNumber=sNMPPortNumber, dataPortAutoMdix=dataPortAutoMdix, sNMPCommunityString=sNMPCommunityString, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, telecomsInterface=telecomsInterface, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6GatewayAddress=iPv6GatewayAddress, securityLevel=securityLevel, transmitModulationMode=transmitModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, timeZone=timeZone, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomGroup=telecomGroup, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, pubStatsGroup=pubStatsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap, bandwidthVariant=bandwidthVariant, sNTPServerTableNumber=sNTPServerTableNumber, configuration=configuration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBandwidth=channelBandwidth, alarms=alarms, transmitDataRate=transmitDataRate, iPDSCPPriorityTable=iPDSCPPriorityTable, systemReset=systemReset, dfsPeaks=dfsPeaks, regionCodeTrap=regionCodeTrap, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, rangingMode=rangingMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementPriority=vLANManagementPriority, configurationGroup=configurationGroup, txColorCode=txColorCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableLoss=cableLoss, softwareVersion=softwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, searchState=searchState, smtp=smtp, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, rxColorCode=rxColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPv3Enable=sNMPv3Enable, rawReceivePower=rawReceivePower, tFTPServerInternetAddress=tFTPServerInternetAddress, ptpGroups=ptpGroups, dfsTable=dfsTable, managementPortStatusTrap=managementPortStatusTrap, supplementary=supplementary, linkSymmetry=linkSymmetry, remoteRxTargetPower=remoteRxTargetPower, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, ptp=ptp, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveFreqMHz=receiveFreqMHz, systemClock=systemClock, tDDControl=tDDControl, sNTPServerTableIndex=sNTPServerTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, daylightSaving=daylightSaving, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, reset=reset, ethernetBridgingAvailability=ethernetBridgingAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, subnetMask=subnetMask, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, PYSNMP_MODULE_ID=cambium, cambium=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userEnabled=userEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receivePower=receivePower, iPv4Address=iPv4Address, managementGroup=managementGroup, bootVersion=bootVersion, signalStrengthRatio=signalStrengthRatio, channelALoopbackTrap=channelALoopbackTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetPriorityTable=ethernetPriorityTable, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, aAAControl=aAAControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, userTableNumber=userTableNumber, receiveChannel=receiveChannel, hTTPPortNumber=hTTPPortNumber, channelBLoopback=channelBLoopback, transmitPower=transmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, telecomsChannelAStatus=telecomsChannelAStatus, managementPortStatus=managementPortStatus, automaticTxPowerControl=automaticTxPowerControl, constantPowerSpectralDensity=constantPowerSpectralDensity, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, incompatibleRegionCodes=incompatibleRegionCodes, versionsGroup=versionsGroup, transmitChannel=transmitChannel, longitude=longitude, licenceGroup=licenceGroup, siteName=siteName, byteErrorRatio=byteErrorRatio, dataPortFiberStatus=dataPortFiberStatus, localPacketFiltering=localPacketFiltering, telecom=telecom, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALineCode=channelALineCode, managementPortDisabledWarning=managementPortDisabledWarning, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableIndex=userTableIndex, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteIPAddress=remoteIPAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerRetries=sNTPServerRetries, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, secureModeAlarm=secureModeAlarm, ptmp=ptmp, sNTPServerTable=sNTPServerTable, hAZLOCConfiguration=hAZLOCConfiguration, secondarySoftwareVersion=secondarySoftwareVersion, managementMode=managementMode, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, remoteInternetAddressType=remoteInternetAddressType, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibration=unitOutOfCalibration, dataPortStatusTrap=dataPortStatusTrap, sNTPState=sNTPState, alarmsGroup=alarmsGroup, productVariant=productVariant, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelACableLength=channelACableLength, telnetPortNumber=telnetPortNumber, syslogState=syslogState, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, l2CPPriorityTable=l2CPPriorityTable, sNTPServerStatus=sNTPServerStatus, aAAControlGroup=aAAControlGroup, masterSlaveMode=masterSlaveMode, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteInternetAddress=remoteInternetAddress, dataPortStatus=dataPortStatus, userTable=userTable, altitude=altitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap)
