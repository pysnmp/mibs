...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, ptpGroups=ptpGroups, remoteInternetAddress=remoteInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelALoopback=channelALoopback, telecomsChannelSelection=telecomsChannelSelection, automaticTxPowerControl=automaticTxPowerControl, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, targetRange=targetRange, sntp=sntp, byteErrorRatio=byteErrorRatio, syslogState=syslogState, phyControl=phyControl, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingAvailability=ethernetBridgingAvailability, altitude=altitude, userName=userName, channelBCableLength=channelBCableLength, softwareVersion=softwareVersion, telecomGroup=telecomGroup, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementGroup=managementGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, regionCodeTrap=regionCodeTrap, ptpCompliance=ptpCompliance, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, reset=reset, receiveDataRate=receiveDataRate, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, securityLevel=securityLevel, receivePower=receivePower, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, telecomsInterface=telecomsInterface, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, managementMode=managementMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatusGroup=phyStatusGroup, transmitChannel=transmitChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerRetries=sNTPServerRetries, receiveFreqKHz=receiveFreqKHz, versions=versions, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelALineCode=channelALineCode, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteRxTargetPower=remoteRxTargetPower, transmitPower=transmitPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, iPv6GatewayAddress=iPv6GatewayAddress, secureModeAlarmTrap=secureModeAlarmTrap, systemClock=systemClock, sMTPServerInternetAddress=sMTPServerInternetAddress, bridge=bridge, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, iPv4Address=iPv4Address, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableEntry=l2CPPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, iPVersion=iPVersion, secureModeAlarm=secureModeAlarm, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, syslogClient=syslogClient, smtp=smtp, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, bootVersion=bootVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLoopback=channelBLoopback, transmitFreqKHz=transmitFreqKHz, productName=productName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, pubStats=pubStats, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, localPacketFiltering=localPacketFiltering, dataPortFiberStatus=dataPortFiberStatus, eIRP=eIRP, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, channelBLineCode=channelBLineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, siteName=siteName, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, tDDSynchronizationMode=tDDSynchronizationMode, iPv6PrefixLength=iPv6PrefixLength, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, managementPortStatus=managementPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALoopbackTrap=channelALoopbackTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEmailAlert=sMTPEmailAlert, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, ethernetBridgingStatus=ethernetBridgingStatus, channelChangeTrap=channelChangeTrap, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, configuration=configuration, aAAControlGroup=aAAControlGroup, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPCommunityString=sNMPCommunityString, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerIPAddress=sMTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, secondarySoftwareVersion=secondarySoftwareVersion, tDDControl=tDDControl, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityTableEntry=ethernetPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTable=sNTPServerTable, iPv6Address=iPv6Address, ethernet=ethernet, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, groupID=groupID, vLANManagementPriority=vLANManagementPriority, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTableIndex=sNTPServerTableIndex, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptp=ptp, transmitDataRate=transmitDataRate, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerTableEntry=sNTPServerTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, range=range, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControlGroup=syslogControlGroup, pubStatsGroup=pubStatsGroup, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hAZLOCConfiguration=hAZLOCConfiguration, ptp600=ptp600, channelBandwidth=channelBandwidth, installStatus=installStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, vLANManagementVID=vLANManagementVID, userRole=userRole, alarms=alarms, dfsTableNumber=dfsTableNumber, userPassword=userPassword, sNMPTrapTableIndex=sNMPTrapTableIndex, licenceGroup=licenceGroup, dfsMeans=dfsMeans, bridgeGroup=bridgeGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, configurationGroup=configurationGroup, telnetPortNumber=telnetPortNumber, rangingMode=rangingMode, aAAControl=aAAControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, searchState=searchState, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, rxColorCode=rxColorCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rawReceivePower=rawReceivePower, sNTPSyncTrap=sNTPSyncTrap, channelACableLength=channelACableLength, installStatusTrap=installStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, resetGroup=resetGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddress=tFTPServerInternetAddress, installArmStateTrap=installArmStateTrap, userTable=userTable, telecomsChannelAStatus=telecomsChannelAStatus, receiveChannel=receiveChannel, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, cambium=cambium, management=management, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, txColorCode=txColorCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfs=dfs, dSCPManagementPriority=dSCPManagementPriority, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, ptmp=ptmp, dataPortAutoMdix=dataPortAutoMdix, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, remoteInternetAddressType=remoteInternetAddressType, regionCode=regionCode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, linkName=linkName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
