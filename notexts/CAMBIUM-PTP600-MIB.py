...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hardwareVersion=hardwareVersion, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, bridge=bridge, reset=reset, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, installArmStateTrap=installArmStateTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, dfs=dfs, transmitDataRate=transmitDataRate, mPLSTCPriorityTable=mPLSTCPriorityTable, versions=versions, dfsPeaks=dfsPeaks, sNTPServerRetries=sNTPServerRetries, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, tDDSynchronizationMode=tDDSynchronizationMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, systemReset=systemReset, linkSymmetry=linkSymmetry, channelALineCode=channelALineCode, bootVersion=bootVersion, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, channelBLineCode=channelBLineCode, telecomsChannelSelection=telecomsChannelSelection, userTable=userTable, transmitPower=transmitPower, ptmp=ptmp, cableLoss=cableLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, rawReceivePower=rawReceivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTable=ethernetPriorityTable, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installStatusTrap=installStatusTrap, phyStatus=phyStatus, channelBLoopbackTrap=channelBLoopbackTrap, ptp600=ptp600, channelBCableLength=channelBCableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dSCPManagementPriority=dSCPManagementPriority, syslogStateTrap=syslogStateTrap, licence=licence, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, bridgeGroup=bridgeGroup, PYSNMP_MODULE_ID=cambium, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelACableLength=channelACableLength, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, userRole=userRole, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, antennaGain=antennaGain, iPVersion=iPVersion, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableIndex=sNTPServerTableIndex, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, targetMACAddress=targetMACAddress, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, managementPortStatusTrap=managementPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortStatus=managementPortStatus, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTableNumber=sNTPServerTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPv3Enable=sNMPv3Enable, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, rangingMode=rangingMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortFiberStatus=dataPortFiberStatus, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, daylightSaving=daylightSaving, sNTPSync=sNTPSync, iPv6Address=iPv6Address, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, subnetMask=subnetMask, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelBStatus=telecomsChannelBStatus, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, userTableEntry=userTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, smtp=smtp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, snmpControlGroup=snmpControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkName=linkName, cambium=cambium, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, automaticTxPowerControl=automaticTxPowerControl, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerStatus=sNTPServerStatus, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, encryptionGroup=encryptionGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sntpGroup=sntpGroup, eIRP=eIRP, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, txColorCode=txColorCode, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBLoopback=channelBLoopback, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, sMTPServerInternetAddressType=sMTPServerInternetAddressType, latitude=latitude, userEnabled=userEnabled, ethernetBridgingStatus=ethernetBridgingStatus, licenceGroup=licenceGroup, versionsGroup=versionsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, resetGroup=resetGroup, searchState=searchState, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogState=syslogState, ptpTraps=ptpTraps, sNTPPollInterval=sNTPPollInterval, pubStats=pubStats, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomGroup=telecomGroup, remoteInternetAddressType=remoteInternetAddressType, targetRange=targetRange, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitFreqKHz=transmitFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, groupID=groupID, managementGroup=managementGroup, channelALoopback=channelALoopback, installArmState=installArmState, productVariant=productVariant, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyControlGroup=phyControlGroup, channelALoopbackTrap=channelALoopbackTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, ethernet=ethernet, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, configuration=configuration, encryption=encryption, linkLoss=linkLoss, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, phyControl=phyControl, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, signalStrengthRatio=signalStrengthRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aAAControlGroup=aAAControlGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, userName=userName, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, softwareVersion=softwareVersion, telecom=telecom, management=management, dfsTable=dfsTable, snmpControl=snmpControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, syslogClientTrap=syslogClientTrap, altitude=altitude, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTable=sNTPServerTable, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, secureModeAlarm=secureModeAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, receivePower=receivePower, ptp=ptp, receiveModulationMode=receiveModulationMode, iPv4Address=iPv4Address, iPv6PrefixLength=iPv6PrefixLength, dataPortDisabledWarning=dataPortDisabledWarning, tDDControl=tDDControl, sNMPEnabledTraps=sNMPEnabledTraps, managementMode=managementMode, hAZLOCConfiguration=hAZLOCConfiguration, securityLevel=securityLevel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry)
