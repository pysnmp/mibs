...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6GatewayAddress=iPv6GatewayAddress, userPassword=userPassword, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatusTrap=installStatusTrap, securityLevel=securityLevel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, installStatus=installStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerStatus=sNTPServerStatus, incompatibleRegionCodes=incompatibleRegionCodes, receiveDataRate=receiveDataRate, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, range=range, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, management=management, aAAControl=aAAControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, userEnabled=userEnabled, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelACableLength=channelACableLength, phyStatus=phyStatus, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, syslogClient=syslogClient, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, versionsGroup=versionsGroup, localPacketFiltering=localPacketFiltering, managementPortStatus=managementPortStatus, channelBCableLength=channelBCableLength, versions=versions, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableIndex=l2CPPriorityTableIndex, smtp=smtp, sNTPLastSync=sNTPLastSync, syslogControl=syslogControl, sNTPServerTimeout=sNTPServerTimeout, eIRP=eIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerIPAddress=tFTPServerIPAddress, ptp600=ptp600, targetRange=targetRange, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPrimaryServer=sNTPPrimaryServer, accessMethod=accessMethod, managementPortWirelessDownAlert=managementPortWirelessDownAlert, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, phyControl=phyControl, tDDControlGroup=tDDControlGroup, iPv4Address=iPv4Address, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelSelection=telecomsChannelSelection, pubStats=pubStats, transmitPower=transmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSync=sNTPSync, iPv6Address=iPv6Address, qOSPriorityScheme=qOSPriorityScheme, sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, iPVersion=iPVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, dataPortFiberStatus=dataPortFiberStatus, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogState=syslogState, telecomsChannelAStatus=telecomsChannelAStatus, configuration=configuration, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, userTableNumber=userTableNumber, channelALoopbackTrap=channelALoopbackTrap, automaticTxPowerControl=automaticTxPowerControl, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, bridgeGroup=bridgeGroup, telecomsChannelBStatus=telecomsChannelBStatus, bridge=bridge, supplementary=supplementary, ethernetPriorityTable=ethernetPriorityTable, rawReceivePower=rawReceivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteRxTargetPower=remoteRxTargetPower, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLineCode=channelBLineCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, phyControlGroup=phyControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, hardwareVersion=hardwareVersion, latitude=latitude, channelBLoopbackTrap=channelBLoopbackTrap, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmState=installArmState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, channelChangeTrap=channelChangeTrap, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelBLoopback=channelBLoopback, supplementaryGroup=supplementaryGroup, linkName=linkName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTable=dfsTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userTable=userTable, productName=productName, phyStatusGroup=phyStatusGroup, daylightSaving=daylightSaving, sNTPServerRetries=sNTPServerRetries, receiveChannel=receiveChannel, ethernet=ethernet, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableIndex=userTableIndex, altitude=altitude, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, userName=userName, reset=reset, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementGroup=managementGroup, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, telecomGroup=telecomGroup, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, channelALoopback=channelALoopback, l2CPPriorityTable=l2CPPriorityTable, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, ptmp=ptmp, licence=licence, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, productVariant=productVariant, siteName=siteName, frequencyVariant=frequencyVariant, rangingMode=rangingMode, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibration=unitOutOfCalibration, managementPortStatusTrap=managementPortStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, cambium=cambium, sNMPTrapIPAddress=sNMPTrapIPAddress, dfs=dfs, transmitDataRate=transmitDataRate, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, channelBandwidth=channelBandwidth, managementMode=managementMode, pubStatsGroup=pubStatsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", systemClock=systemClock, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, regionCode=regionCode, ptpGroups=ptpGroups, hAZLOCConfiguration=hAZLOCConfiguration, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, cableLoss=cableLoss, sNMPv3Enable=sNMPv3Enable, rxColorCode=rxColorCode, sNMPPortNumber=sNMPPortNumber, receiveModulationMode=receiveModulationMode, longitude=longitude, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortStatus=dataPortStatus, sNTPServerTableIndex=sNTPServerTableIndex, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, channelALineCode=channelALineCode, sNTPServerTableNumber=sNTPServerTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, groupID=groupID, timeZone=timeZone, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry)
