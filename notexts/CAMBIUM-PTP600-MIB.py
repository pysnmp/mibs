...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPVersion=iPVersion, range=range, transmitFreqKHz=transmitFreqKHz, ptp=ptp, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogState=syslogState, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, daylightSaving=daylightSaving, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelALoopback=channelALoopback, tFTPServerInternetAddressType=tFTPServerInternetAddressType, productName=productName, telecom=telecom, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsInterface=telecomsInterface, searchState=searchState, userTableNumber=userTableNumber, smtpGroup=smtpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, l2CPPriorityTable=l2CPPriorityTable, userEnabled=userEnabled, receivePower=receivePower, channelALoopbackTrap=channelALoopbackTrap, dfsGroup=dfsGroup, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, syslogStateTrap=syslogStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, securityLevel=securityLevel, iPv4Address=iPv4Address, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTableEntry=sNTPServerTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, transmitChannel=transmitChannel, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, licenceGroup=licenceGroup, byteErrorRatio=byteErrorRatio, channelACableLength=channelACableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingStatus=ethernetBridgingStatus, regionCode=regionCode, sNTPPollInterval=sNTPPollInterval, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, rangingMode=rangingMode, notificationsGroup=notificationsGroup, linkLoss=linkLoss, dfsMeans=dfsMeans, receiveDataRate=receiveDataRate, reset=reset, ptp600=ptp600, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTable=iPDSCPPriorityTable, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTableIndex=sNTPServerTableIndex, encryptionGroup=encryptionGroup, cableLoss=cableLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, telecomsChannelAStatus=telecomsChannelAStatus, sNMPv3Enable=sNMPv3Enable, userTable=userTable, phyControlGroup=phyControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, groupID=groupID, managementPortStatus=managementPortStatus, syslogClientTrap=syslogClientTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerTable=sNTPServerTable, supplementaryGroup=supplementaryGroup, encryption=encryption, sNMPTrapTable=sNMPTrapTable, dataPortStatusTrap=dataPortStatusTrap, transmitDataRate=transmitDataRate, sNTPServerTimeout=sNTPServerTimeout, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, userTableIndex=userTableIndex, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, systemClock=systemClock, userTableEntry=userTableEntry, automaticTxPowerControl=automaticTxPowerControl, secureModeAlarmTrap=secureModeAlarmTrap, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dfs=dfs, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, accessMethod=accessMethod, bridgeGroup=bridgeGroup, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, txColorCode=txColorCode, supplementary=supplementary, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, installArmStateTrap=installArmStateTrap, targetMACAddress=targetMACAddress, targetRange=targetRange, altitude=altitude, channelBLoopbackTrap=channelBLoopbackTrap, siteName=siteName, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortStatus=dataPortStatus, resetGroup=resetGroup, rawReceivePower=rawReceivePower, sNTPLastSync=sNTPLastSync, sNTPPrimaryServer=sNTPPrimaryServer, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBCableLength=channelBCableLength, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersion=softwareVersion, versionsGroup=versionsGroup, userPassword=userPassword, phyStatus=phyStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, iPv6PrefixLength=iPv6PrefixLength, sNTPState=sNTPState, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, bridge=bridge, transmitModulationMode=transmitModulationMode, aAAControlGroup=aAAControlGroup, hardwareVersion=hardwareVersion, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementVID=vLANManagementVID, pubStatsGroup=pubStatsGroup, managementPortDisabledWarning=managementPortDisabledWarning, timeZone=timeZone, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, channelALineCode=channelALineCode, channelChangeTrap=channelChangeTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelSelection=telecomsChannelSelection, sMTPServerPortNumber=sMTPServerPortNumber, userName=userName, localPacketFiltering=localPacketFiltering, alarmsGroup=alarmsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, hTTPPortNumber=hTTPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, configurationGroup=configurationGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, secureModeAlarm=secureModeAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, longitude=longitude, latitude=latitude, regionCodeTrap=regionCodeTrap, phyControl=phyControl, configuration=configuration, rxColorCode=rxColorCode, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapPortNumber=sNMPTrapPortNumber, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, managementGroup=managementGroup, linkName=linkName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bootVersion=bootVersion, linkSymmetry=linkSymmetry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, licence=licence, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerRetries=sNTPServerRetries, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sntp=sntp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBLineCode=channelBLineCode, remoteInternetAddress=remoteInternetAddress, transmitPower=transmitPower, dataPortFiberStatus=dataPortFiberStatus, sNTPServerStatus=sNTPServerStatus, alarms=alarms, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, aAAControl=aAAControl, iPv6GatewayAddress=iPv6GatewayAddress, dSCPManagementPriority=dSCPManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, channelBLoopback=channelBLoopback, smtp=smtp, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, systemReset=systemReset, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementMode=managementMode, installStatus=installStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup)
