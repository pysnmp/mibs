...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecom=telecom, range=range, ethernet=ethernet, groupID=groupID, remoteInternetAddressType=remoteInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, txColorCode=txColorCode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTimeout=sNTPServerTimeout, timeZone=timeZone, sNTPPrimaryServer=sNTPPrimaryServer, bandwidthVariant=bandwidthVariant, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, sNTPServerTableNumber=sNTPServerTableNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, rxColorCode=rxColorCode, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNTPState=sNTPState, transmitDataRate=transmitDataRate, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, productVariant=productVariant, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkAvailability=wirelessLinkAvailability, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, receiveModulationModeDetail=receiveModulationModeDetail, iPv4Address=iPv4Address, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsChannelSelection=telecomsChannelSelection, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, ethernetBridgingStatus=ethernetBridgingStatus, smtpGroup=smtpGroup, eIRP=eIRP, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vectorError=vectorError, encryptionAlgorithm=encryptionAlgorithm, userTable=userTable, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControl=phyControl, aAAControl=aAAControl, managementMode=managementMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSync=sNTPSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControl=syslogControl, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, frequencyVariant=frequencyVariant, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTable=l2CPPriorityTable, rawReceivePower=rawReceivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, dfsTableEntry=dfsTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControlGroup=phyControlGroup, sNMPPortNumber=sNMPPortNumber, configuration=configuration, transmitFreqKHz=transmitFreqKHz, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, channelALoopbackTrap=channelALoopbackTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receivePower=receivePower, iPVersion=iPVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, automaticTxPowerControl=automaticTxPowerControl, dfsMeans=dfsMeans, ptpGroups=ptpGroups, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, secureModeAlarm=secureModeAlarm, dfsTable=dfsTable, versionsGroup=versionsGroup, iPv6PrefixLength=iPv6PrefixLength, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6Address=iPv6Address, targetRange=targetRange, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, cambium=cambium, managementGroup=managementGroup, localPacketFiltering=localPacketFiltering, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControlGroup=aAAControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, licence=licence, supplementaryGroup=supplementaryGroup, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, bridgeGroup=bridgeGroup, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, snmpControl=snmpControl, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, ptmp=ptmp, supplementary=supplementary, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPCommunityString=sNMPCommunityString, dfsTableNumber=dfsTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, reset=reset, channelBLineCode=channelBLineCode, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBandwidth=channelBandwidth, dataPortStatusTrap=dataPortStatusTrap, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, channelACableLength=channelACableLength, sNTPServerPortNumber=sNTPServerPortNumber, altitude=altitude, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, productName=productName, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, ethernetPriorityTable=ethernetPriorityTable, telecomsInterface=telecomsInterface, latitude=latitude, licenceGroup=licenceGroup, sNTPServerRetries=sNTPServerRetries, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerIPAddress=tFTPServerIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerStatus=sNTPServerStatus, pubStats=pubStats, syslogClient=syslogClient, dSCPManagementPriority=dSCPManagementPriority, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, telecomsChannelBStatus=telecomsChannelBStatus, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfs=dfs, managementPortDisabledWarning=managementPortDisabledWarning, masterSlaveMode=masterSlaveMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, sNTPServerTable=sNTPServerTable, remoteInternetAddress=remoteInternetAddress, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, rangingMode=rangingMode, longitude=longitude, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, searchState=searchState, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, encryption=encryption, siteName=siteName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogState=syslogState, systemReset=systemReset, channelBLoopback=channelBLoopback, channelChangeTrap=channelChangeTrap, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userName=userName, sNTPLastSync=sNTPLastSync, dataPortStatus=dataPortStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, installArmStateTrap=installArmStateTrap, softwareVersion=softwareVersion, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkLoss=linkLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, regionCodeTrap=regionCodeTrap, bridge=bridge, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, channelALoopback=channelALoopback, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, securityLevel=securityLevel, remoteRxTargetPower=remoteRxTargetPower, dfsTableIndex=dfsTableIndex, ptp600=ptp600, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptp=ptp, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPPollInterval=sNTPPollInterval, systemClock=systemClock, daylightSaving=daylightSaving, hTTPSPortNumber=hTTPSPortNumber, linkName=linkName, receiveModulationMode=receiveModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, receiveChannel=receiveChannel, ethernetBridgingAvailability=ethernetBridgingAvailability, alarms=alarms, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteIPAddress=remoteIPAddress, managementPortStatus=managementPortStatus, managementPortStatusTrap=managementPortStatusTrap, channelBCableLength=channelBCableLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, gatewayIPAddress=gatewayIPAddress, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry)
