...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", txColorCode=txColorCode, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, transmitFreqMHz=transmitFreqMHz, dataPortFiberStatus=dataPortFiberStatus, syslogState=syslogState, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteInternetAddressType=remoteInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapVersion=sNMPTrapVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteInternetAddress=remoteInternetAddress, managementPortStatus=managementPortStatus, dataPortStatus=dataPortStatus, eIRP=eIRP, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServer=sNTPPrimaryServer, licenceGroup=licenceGroup, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogClient=syslogClient, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, automaticTxPowerControl=automaticTxPowerControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary, transmitDataRate=transmitDataRate, sNMPTrapTable=sNMPTrapTable, ethernetBridgingStatus=ethernetBridgingStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, tFTPServerIPAddress=tFTPServerIPAddress, smtp=smtp, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, channelALineCode=channelALineCode, licence=licence, rxColorCode=rxColorCode, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernet=ethernet, alarmsGroup=alarmsGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, sntp=sntp, encryption=encryption, configurationGroup=configurationGroup, encryptionAlgorithm=encryptionAlgorithm, channelBCableLength=channelBCableLength, sNMPEnabledTraps=sNMPEnabledTraps, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, groupID=groupID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptpTraps=ptpTraps, iPv6Address=iPv6Address, userRole=userRole, syslogControlGroup=syslogControlGroup, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkLoss=linkLoss, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, localPacketFiltering=localPacketFiltering, antennaGain=antennaGain, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, aAAControl=aAAControl, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, rangingMode=rangingMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementMode=managementMode, iPv4Address=iPv4Address, latitude=latitude, management=management, telnetAccessEnabled=telnetAccessEnabled, dSCPManagementPriority=dSCPManagementPriority, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, altitude=altitude, smtpGroup=smtpGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, ptp600=ptp600, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, gatewayIPAddress=gatewayIPAddress, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortStatusTrap=dataPortStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyStatus=phyStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortConfigurationMismatch=managementPortConfigurationMismatch, snmpControl=snmpControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, tDDControlGroup=tDDControlGroup, siteName=siteName, productName=productName, sNTPServerRetries=sNTPServerRetries, l2CPPriorityTableIndex=l2CPPriorityTableIndex, reset=reset, dfs=dfs, bridgeGroup=bridgeGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkStatus=wirelessLinkStatus, telecomGroup=telecomGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsGroup=dfsGroup, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBLineCode=channelBLineCode, regionCodeTrap=regionCodeTrap, telecomsChannelBStatus=telecomsChannelBStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTable=sNTPServerTable, snmpControlGroup=snmpControlGroup, telecom=telecom, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsMeans=dfsMeans, managementPortDisabledWarning=managementPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelChangeTrap=channelChangeTrap, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, channelALoopback=channelALoopback, range=range, sNTPState=sNTPState, ethernetPriorityTable=ethernetPriorityTable, installStatusTrap=installStatusTrap, receivePower=receivePower, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, hAZLOCConfiguration=hAZLOCConfiguration, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortStatusTrap=managementPortStatusTrap, installArmState=installArmState, l2CPPriorityTable=l2CPPriorityTable, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, cambium=cambium, ethernetPriorityTableEntry=ethernetPriorityTableEntry, PYSNMP_MODULE_ID=cambium, rawReceivePower=rawReceivePower, incompatibleRegionCodes=incompatibleRegionCodes, installArmStateTrap=installArmStateTrap, sNTPServerTableNumber=sNTPServerTableNumber, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyStatusGroup=phyStatusGroup, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelACableLength=channelACableLength, searchState=searchState, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetRange=targetRange, linkModeOptimisation=linkModeOptimisation, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, bridge=bridge, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, dfsPeaks=dfsPeaks, userPassword=userPassword, securityLevel=securityLevel, versions=versions, secureModeAlarmTrap=secureModeAlarmTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userTableNumber=userTableNumber, userTable=userTable, configuration=configuration, alarms=alarms, softwareVersion=softwareVersion, longitude=longitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, channelALoopbackTrap=channelALoopbackTrap, channelBLoopback=channelBLoopback, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versionsGroup=versionsGroup, sntpGroup=sntpGroup, transmitPower=transmitPower, accessMethod=accessMethod, iPVersion=iPVersion, remoteRxTargetPower=remoteRxTargetPower, receiveModulationMode=receiveModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, userName=userName, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, pubStats=pubStats, phyControlGroup=phyControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, dataPortDisabledWarning=dataPortDisabledWarning, remoteIPAddress=remoteIPAddress, receiveDataRate=receiveDataRate)
