...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, range=range, phyControl=phyControl, linkName=linkName, receiveDataRate=receiveDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTimeout=sNTPServerTimeout, accessMethod=accessMethod, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecom=telecom, alarmsGroup=alarmsGroup, groupID=groupID, channelBCableLength=channelBCableLength, channelBLoopback=channelBLoopback, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingStatus=ethernetBridgingStatus, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, telecomsChannelSelection=telecomsChannelSelection, automaticTxPowerControl=automaticTxPowerControl, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, ptp600=ptp600, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCodeTrap=regionCodeTrap, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, channelChangeTrap=channelChangeTrap, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, vLANManagementVID=vLANManagementVID, channelALineCode=channelALineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortDisabledWarning=managementPortDisabledWarning, userTableEntry=userTableEntry, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTable=sNMPTrapTable, channelBLineCode=channelBLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveChannel=receiveChannel, transmitChannel=transmitChannel, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, sNTPServerStatus=sNTPServerStatus, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogClient=syslogClient, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteIPAddress=remoteIPAddress, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, managementGroup=managementGroup, resetGroup=resetGroup, searchState=searchState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, sntpGroup=sntpGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPPortNumber=sNMPPortNumber, dfsTableNumber=dfsTableNumber, userEnabled=userEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rxColorCode=rxColorCode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernet=ethernet, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementMode=managementMode, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, syslogControl=syslogControl, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementary=supplementary, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPSync=sNTPSync, ptpGroups=ptpGroups, ptp=ptp, channelALoopback=channelALoopback, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, pubStatsGroup=pubStatsGroup, reset=reset, systemReset=systemReset, aAAControl=aAAControl, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, sNTPServerTableIndex=sNTPServerTableIndex, userTable=userTable, snmpControlGroup=snmpControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBLoopbackTrap=channelBLoopbackTrap, channelALoopbackTrap=channelALoopbackTrap, dataPortAutoMdix=dataPortAutoMdix, userTableIndex=userTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, masterSlaveMode=masterSlaveMode, management=management, receiveFreqKHz=receiveFreqKHz, iPVersion=iPVersion, remoteInternetAddress=remoteInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telnetPortNumber=telnetPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, rangingMode=rangingMode, iPDSCPPriorityTable=iPDSCPPriorityTable, notificationsGroup=notificationsGroup, snmpControl=snmpControl, managementPortStatus=managementPortStatus, dfsMeans=dfsMeans, sNTPServerTable=sNTPServerTable, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, localPacketFiltering=localPacketFiltering, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, remoteInternetAddressType=remoteInternetAddressType, maximumTransmitPower=maximumTransmitPower, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomGroup=telecomGroup, secureModeAlarm=secureModeAlarm, pubStats=pubStats, installArmState=installArmState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, systemClock=systemClock, installStatusTrap=installStatusTrap, dfs=dfs, productName=productName, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerRetries=sNTPServerRetries, iPv4Address=iPv4Address, iPv6Address=iPv6Address, dfsTable=dfsTable, subnetMask=subnetMask, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, longitude=longitude, managementPortStatusTrap=managementPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, rawReceivePower=rawReceivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPPortNumber=hTTPPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, sMTPEmailAlert=sMTPEmailAlert, securityLevel=securityLevel, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPLastSync=sNTPLastSync, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, bridge=bridge, latitude=latitude, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPCommunityString=sNMPCommunityString, hTTPSPortNumber=hTTPSPortNumber, targetMACAddress=targetMACAddress, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServer=sNTPPrimaryServer, licence=licence, configurationGroup=configurationGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, timeZone=timeZone, tDDControl=tDDControl, antennaGain=antennaGain, altitude=altitude, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, phyControlGroup=phyControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dSCPManagementPriority=dSCPManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, installStatus=installStatus, dfsPeaks=dfsPeaks, l2CPPriorityTableEntry=l2CPPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userRole=userRole, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementPriority=vLANManagementPriority, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, byteErrorRatio=byteErrorRatio, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, telecomsInterface=telecomsInterface, channelACableLength=channelACableLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkLoss=linkLoss, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionAlgorithm=encryptionAlgorithm, userName=userName, sNTPState=sNTPState, secureModeAlarmTrap=secureModeAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, bridgeGroup=bridgeGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, targetRange=targetRange, txColorCode=txColorCode, telecomsChannelAStatus=telecomsChannelAStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtp=smtp, dfsGroup=dfsGroup, sNTPServerTableEntry=sNTPServerTableEntry)
