...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtp=smtp, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkSymmetry=linkSymmetry, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortFiberStatus=dataPortFiberStatus, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, managementMode=managementMode, sMTPServerIPAddress=sMTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, alarms=alarms, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, longitude=longitude, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, rawReceivePower=rawReceivePower, supplementaryGroup=supplementaryGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, telecomsChannelAStatus=telecomsChannelAStatus, linkLoss=linkLoss, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBCableLength=channelBCableLength, channelBLoopbackTrap=channelBLoopbackTrap, receiveChannel=receiveChannel, syslogControl=syslogControl, managementPortStatus=managementPortStatus, supplementary=supplementary, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, userRole=userRole, accessMethod=accessMethod, configurationGroup=configurationGroup, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, ethernetBridgingStatus=ethernetBridgingStatus, ptmp=ptmp, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPv3Enable=sNMPv3Enable, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, iPv6PrefixLength=iPv6PrefixLength, bandwidthVariant=bandwidthVariant, phyStatusGroup=phyStatusGroup, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, channelALineCode=channelALineCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, targetMACAddress=targetMACAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installStatus=installStatus, sNTPServerStatus=sNTPServerStatus, telecomGroup=telecomGroup, signalStrengthRatio=signalStrengthRatio, range=range, timeZone=timeZone, softwareVersion=softwareVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfsTableNumber=dfsTableNumber, secureModeAlarm=secureModeAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteRxTargetPower=remoteRxTargetPower, bridge=bridge, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveFreqMHz=receiveFreqMHz, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, userEnabled=userEnabled, dataPortAutoMdix=dataPortAutoMdix, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, snmpControl=snmpControl, bridgeGroup=bridgeGroup, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelBStatus=telecomsChannelBStatus, dfsTable=dfsTable, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, eIRP=eIRP, userName=userName, dataPortStatusTrap=dataPortStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, txColorCode=txColorCode, sNMPTrapIPAddress=sNMPTrapIPAddress, daylightSaving=daylightSaving, ptpCompliance=ptpCompliance, iPVersion=iPVersion, configuration=configuration, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, telecom=telecom, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, transmitDataRate=transmitDataRate, channelALoopbackTrap=channelALoopbackTrap, management=management, sntpGroup=sntpGroup, ptp=ptp, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, automaticTxPowerControl=automaticTxPowerControl, aAAControlGroup=aAAControlGroup, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, remoteInternetAddress=remoteInternetAddress, ptpGroups=ptpGroups, userTable=userTable, channelBLineCode=channelBLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, siteName=siteName, secureModeAlarmTrap=secureModeAlarmTrap, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, channelACableLength=channelACableLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPState=sNTPState, installArmState=installArmState, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerRetries=sNTPServerRetries, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, groupID=groupID, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveModulationMode=receiveModulationMode, dfs=dfs, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, cambium=cambium, sNTPServerTable=sNTPServerTable, sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userPassword=userPassword, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptp600=ptp600, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelALoopback=channelALoopback, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegotiation=dataPortAutoNegotiation, hAZLOCConfiguration=hAZLOCConfiguration, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, localPacketFiltering=localPacketFiltering, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, reset=reset, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, iPv6Address=iPv6Address, altitude=altitude, encryption=encryption, tDDControlGroup=tDDControlGroup, transmitFreqKHz=transmitFreqKHz, alarmsGroup=alarmsGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, licenceGroup=licenceGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, targetRange=targetRange, phyStatus=phyStatus, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, channelBLoopback=channelBLoopback, sNTPLastSync=sNTPLastSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, dfsTableEntry=dfsTableEntry, securityLevel=securityLevel, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, vLANManagementVID=vLANManagementVID, tFTPServerInternetAddress=tFTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, rxColorCode=rxColorCode, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingAvailability=ethernetBridgingAvailability, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTable=ethernetPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, resetGroup=resetGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortStatusTrap=managementPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, subnetMask=subnetMask, dfsPeaks=dfsPeaks, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dfsMeans=dfsMeans, rangingMode=rangingMode, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, installStatusTrap=installStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telnetPortNumber=telnetPortNumber, telecomsChannelSelection=telecomsChannelSelection, installArmStateTrap=installArmStateTrap, managementGroup=managementGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, ptpTrapPrefix=ptpTrapPrefix, phyControlGroup=phyControlGroup, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPv4Address=iPv4Address, l2CPPriorityTable=l2CPPriorityTable, channelBandwidth=channelBandwidth, sNTPServerTableEntry=sNTPServerTableEntry, notificationsGroup=notificationsGroup, sntp=sntp, mPLSTCPriorityTable=mPLSTCPriorityTable)
