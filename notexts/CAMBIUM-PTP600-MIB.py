...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, channelALoopback=channelALoopback, aAAControl=aAAControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, byteErrorRatio=byteErrorRatio, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortStatus=dataPortStatus, groupID=groupID, ethernetGroup=ethernetGroup, frequencyVariant=frequencyVariant, rangingMode=rangingMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, regionCodeTrap=regionCodeTrap, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, sNTPServerTableNumber=sNTPServerTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, snmpControlGroup=snmpControlGroup, siteName=siteName, iPv6PrefixLength=iPv6PrefixLength, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, ptpGroups=ptpGroups, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, subnetMask=subnetMask, dataPortFiberStatus=dataPortFiberStatus, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, managementPortDisabledWarning=managementPortDisabledWarning, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, managementPortStatus=managementPortStatus, receiveChannel=receiveChannel, channelBLineCode=channelBLineCode, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBLoopback=channelBLoopback, unitOutOfCalibration=unitOutOfCalibration, configurationGroup=configurationGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNMPTrapInternetAddress=sNMPTrapInternetAddress, txColorCode=txColorCode, remoteIPAddress=remoteIPAddress, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodes=incompatibleRegionCodes, snmpControl=snmpControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsTableIndex=dfsTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, productVariant=productVariant, syslogControlGroup=syslogControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, localPacketFiltering=localPacketFiltering, ethernetPriorityTableEntry=ethernetPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, rxColorCode=rxColorCode, sNTPLastSync=sNTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarmsGroup=alarmsGroup, l2CPPriorityTable=l2CPPriorityTable, bridge=bridge, l2CPPriorityTableIndex=l2CPPriorityTableIndex, channelACableLength=channelACableLength, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelSelection=telecomsChannelSelection, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntpGroup=sntpGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, vectorError=vectorError, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, masterSlaveMode=masterSlaveMode, linkName=linkName, ptp=ptp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, configuration=configuration, syslogControl=syslogControl, dfsTableNumber=dfsTableNumber, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, ptp600=ptp600, sNTPServerTable=sNTPServerTable, sNTPSync=sNTPSync, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, eIRP=eIRP, secureModeAlarm=secureModeAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableNumber=userTableNumber, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, smtp=smtp, resetGroup=resetGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, aggregateDataRate=aggregateDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDControl=tDDControl, linkLoss=linkLoss, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, managementMode=managementMode, phyStatus=phyStatus, ptpTraps=ptpTraps, sNTPState=sNTPState, linkSymmetry=linkSymmetry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, alarms=alarms, channelChangeTrap=channelChangeTrap, bridgeGroup=bridgeGroup, channelBLoopbackTrap=channelBLoopbackTrap, telecomsChannelAStatus=telecomsChannelAStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, pubStats=pubStats, ethernet=ethernet, managementGroup=managementGroup, cableLoss=cableLoss, sNTPServerTimeout=sNTPServerTimeout, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, sNTPSyncTrap=sNTPSyncTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPPrimaryServer=sNTPPrimaryServer, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, altitude=altitude, ethernetBridgingAvailability=ethernetBridgingAvailability, userName=userName, telnetAccessEnabled=telnetAccessEnabled, licence=licence, syslogStateTrap=syslogStateTrap, PYSNMP_MODULE_ID=cambium, range=range, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitDataRate=transmitDataRate, installStatusTrap=installStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, reset=reset, dfsMeans=dfsMeans, telnetPortNumber=telnetPortNumber, iPv6Address=iPv6Address, latitude=latitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, aAAControlGroup=aAAControlGroup, pubStatsGroup=pubStatsGroup, installArmState=installArmState, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPAccessEnabled=hTTPAccessEnabled, transmitPower=transmitPower, phyControlGroup=phyControlGroup, transmitFreqKHz=transmitFreqKHz, sNMPPortNumber=sNMPPortNumber, sNTPServerStatus=sNTPServerStatus, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatusTrap=dataPortStatusTrap, tDDControlGroup=tDDControlGroup, remoteInternetAddressType=remoteInternetAddressType, iPv4Address=iPv4Address, sNTPServerRetries=sNTPServerRetries, bootVersion=bootVersion, ethernetFiberSupport=ethernetFiberSupport, transmitChannel=transmitChannel, userEnabled=userEnabled, dfs=dfs, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogState=syslogState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, daylightSaving=daylightSaving, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableEntry=userTableEntry, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, telecomGroup=telecomGroup, qOSPriorityScheme=qOSPriorityScheme, rawReceivePower=rawReceivePower, automaticTxPowerControl=automaticTxPowerControl, ethernetPriorityTable=ethernetPriorityTable, bandwidthVariant=bandwidthVariant, systemClock=systemClock, receiveDataRate=receiveDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, regionCode=regionCode, signalStrengthRatio=signalStrengthRatio, channelALineCode=channelALineCode, channelBCableLength=channelBCableLength, dataPortAutoMdix=dataPortAutoMdix, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, accessMethod=accessMethod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, securityLevel=securityLevel, sNMPEnabledTraps=sNMPEnabledTraps, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortStatusTrap=managementPortStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveFreqKHz=receiveFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelALoopbackTrap=channelALoopbackTrap, syslogClient=syslogClient, dataPortFiberStatusTrap=dataPortFiberStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsInterface=telecomsInterface, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteRxTargetPower=remoteRxTargetPower, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelBStatus=telecomsChannelBStatus, supplementaryGroup=supplementaryGroup, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementary=supplementary, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, versionsGroup=versionsGroup, timeZone=timeZone, softwareVersion=softwareVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex)
