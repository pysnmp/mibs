...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTable=iPDSCPPriorityTable, notificationsGroup=notificationsGroup, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, userPassword=userPassword, sNTPSync=sNTPSync, telecomsInterface=telecomsInterface, encryptionGroup=encryptionGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetMACAddress=targetMACAddress, receiveChannel=receiveChannel, bootVersion=bootVersion, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTimeout=sNTPServerTimeout, telnetPortNumber=telnetPortNumber, dfs=dfs, cableLoss=cableLoss, dataPortAutoMdix=dataPortAutoMdix, managementPortStatus=managementPortStatus, PYSNMP_MODULE_ID=cambium, dfsTableEntry=dfsTableEntry, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodes=incompatibleRegionCodes, timeZone=timeZone, sNTPServerInternetAddressType=sNTPServerInternetAddressType, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, channelBLineCode=channelBLineCode, latitude=latitude, installStatusTrap=installStatusTrap, subnetMask=subnetMask, userName=userName, installArmState=installArmState, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTableIndex=dfsTableIndex, versions=versions, userTableEntry=userTableEntry, dSCPManagementPriority=dSCPManagementPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerTableNumber=sNTPServerTableNumber, secureModeAlarm=secureModeAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, reset=reset, ethernetPriorityTableIndex=ethernetPriorityTableIndex, bridgeGroup=bridgeGroup, resetGroup=resetGroup, configuration=configuration, transmitFreqKHz=transmitFreqKHz, ethernetBridgingAvailability=ethernetBridgingAvailability, configurationGroup=configurationGroup, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, sntpGroup=sntpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelBCableLength=channelBCableLength, targetRange=targetRange, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, rxColorCode=rxColorCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, ethernetGroup=ethernetGroup, iPVersion=iPVersion, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionAlgorithm=encryptionAlgorithm, supplementaryGroup=supplementaryGroup, txColorCode=txColorCode, dataPortDisabledWarning=dataPortDisabledWarning, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, transmitChannel=transmitChannel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, gatewayIPAddress=gatewayIPAddress, range=range, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogStateTrap=syslogStateTrap, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, daylightSaving=daylightSaving, productVariant=productVariant, managementPortStatusTrap=managementPortStatusTrap, channelALineCode=channelALineCode, management=management, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelBStatus=telecomsChannelBStatus, telecomGroup=telecomGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, securityLevel=securityLevel, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productName=productName, automaticTxPowerControl=automaticTxPowerControl, ptpCompliance=ptpCompliance, ethernet=ethernet, rawReceivePower=rawReceivePower, sNTPServerTableIndex=sNTPServerTableIndex, qOSPriorityScheme=qOSPriorityScheme, syslogState=syslogState, encryption=encryption, aAAControlGroup=aAAControlGroup, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, telecom=telecom, masterSlaveMode=masterSlaveMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementVID=vLANManagementVID, ptp=ptp, sNTPServerStatus=sNTPServerStatus, sntp=sntp, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, altitude=altitude, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, remoteRxTargetPower=remoteRxTargetPower, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, licence=licence, remoteInternetAddress=remoteInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelACableLength=channelACableLength, installStatus=installStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, groupID=groupID, localPacketFiltering=localPacketFiltering, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userEnabled=userEnabled, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, eIRP=eIRP, linkSymmetry=linkSymmetry, receivePower=receivePower, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, sNTPState=sNTPState, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteInternetAddressType=remoteInternetAddressType, syslogClient=syslogClient, transmitPower=transmitPower, pubStats=pubStats, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, alarms=alarms, rangingMode=rangingMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, smtp=smtp, smtpGroup=smtpGroup, bandwidthVariant=bandwidthVariant, channelALoopbackTrap=channelALoopbackTrap, snmpControlGroup=snmpControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpGroups=ptpGroups, ptp600=ptp600, accessMethod=accessMethod, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bridge=bridge, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, channelBLoopbackTrap=channelBLoopbackTrap, managementMode=managementMode, channelALoopback=channelALoopback, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, userTable=userTable, dataPortFiberStatus=dataPortFiberStatus, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPv6GatewayAddress=iPv6GatewayAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControl=tDDControl, vectorError=vectorError, versionsGroup=versionsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControl=phyControl, alarmsGroup=alarmsGroup, telecomsChannelSelection=telecomsChannelSelection)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, channelBLoopback=channelBLoopback, userTableNumber=userTableNumber, iPv6PrefixLength=iPv6PrefixLength, sMTPEnabledMessages=sMTPEnabledMessages, iPv6Address=iPv6Address, licenceGroup=licenceGroup, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkName=linkName, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, searchState=searchState, telecomsChannelAStatus=telecomsChannelAStatus, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, l2CPPriorityTable=l2CPPriorityTable, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPv4Address=iPv4Address, ptmp=ptmp, phyStatusGroup=phyStatusGroup, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServer=sNTPPrimaryServer, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTable=sNTPServerTable, regionCode=regionCode, sNTPServerRetries=sNTPServerRetries, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
