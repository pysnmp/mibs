...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:24:44 2021
...
enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Unsigned32, Gauge32, TimeTicks, Bits, ObjectIdentity, NotificationType, iso, MibIdentifier, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Unsigned32", "Gauge32", "TimeTicks", "Bits", "ObjectIdentity", "NotificationType", "iso", "MibIdentifier", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatus=dataPortFiberStatus, installStatusTrap=installStatusTrap, phyControl=phyControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hAZLOCConfiguration=hAZLOCConfiguration, ethernet=ethernet, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, configurationGroup=configurationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, hTTPSPortNumber=hTTPSPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, transmitDataRate=transmitDataRate, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, latitude=latitude, l2CPPriorityTable=l2CPPriorityTable, rawReceivePower=rawReceivePower, channelBandwidth=channelBandwidth, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, gatewayIPAddress=gatewayIPAddress, management=management, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, localPacketFiltering=localPacketFiltering, sntp=sntp, iPVersion=iPVersion, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationMode=tDDSynchronizationMode, licenceGroup=licenceGroup, cableLoss=cableLoss, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, remoteRxTargetPower=remoteRxTargetPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementPortStatus=managementPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, subnetMask=subnetMask, rxColorCode=rxColorCode, iPv6PrefixLength=iPv6PrefixLength, resetGroup=resetGroup, daylightSaving=daylightSaving, altitude=altitude, longitude=longitude, installStatus=installStatus, aggregateDataRate=aggregateDataRate, hTTPPortNumber=hTTPPortNumber, regionCode=regionCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, supplementaryGroup=supplementaryGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, aAAControlGroup=aAAControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, cambium=cambium, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, frequencyVariant=frequencyVariant, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPv6GatewayAddress=iPv6GatewayAddress, timeZone=timeZone, sMTPServerInternetAddress=sMTPServerInternetAddress, searchState=searchState, bootVersion=bootVersion, range=range, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, ptp=ptp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPAccessEnabled=hTTPAccessEnabled, versionsGroup=versionsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqMHz=receiveFreqMHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, txColorCode=txColorCode, antennaGain=antennaGain, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatusGroup=phyStatusGroup, linkName=linkName, eIRP=eIRP, sNTPState=sNTPState, userPassword=userPassword, ptmp=ptmp, sNTPServerRetries=sNTPServerRetries, aAAControl=aAAControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, userTableNumber=userTableNumber, userTableIndex=userTableIndex, wirelessLinkStatus=wirelessLinkStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, targetMACAddress=targetMACAddress, transmitFreqKHz=transmitFreqKHz, channelBLoopback=channelBLoopback, dfsTable=dfsTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerTable=sNTPServerTable, alarms=alarms, dfs=dfs, ptpCompliance=ptpCompliance, groupID=groupID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telecomsInterface=telecomsInterface, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableNumber=dfsTableNumber, installArmState=installArmState, incompatibleRegionCodes=incompatibleRegionCodes, channelBLoopbackTrap=channelBLoopbackTrap, userTable=userTable, constantPowerSpectralDensity=constantPowerSpectralDensity, systemClock=systemClock, unitOutOfCalibration=unitOutOfCalibration, transmitChannel=transmitChannel, iPv6Address=iPv6Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licence=licence, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelAStatus=telecomsChannelAStatus, encryptionGroup=encryptionGroup, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogControlGroup=syslogControlGroup, channelBCableLength=channelBCableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortStatusTrap=managementPortStatusTrap, siteName=siteName, ethernetPriorityTableNumber=ethernetPriorityTableNumber, versions=versions, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPPrimaryServer=sNTPPrimaryServer, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vectorError=vectorError, channelALoopbackTrap=channelALoopbackTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, syslogControl=syslogControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, channelBLineCode=channelBLineCode, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, pubStats=pubStats, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, systemReset=systemReset, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, channelACableLength=channelACableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelChangeTrap=channelChangeTrap, receiveModulationModeDetail=receiveModulationModeDetail, encryption=encryption, sNMPPortNumber=sNMPPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userName=userName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, snmpControl=snmpControl, receivePower=receivePower, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, tDDControl=tDDControl, sNMPCommunityString=sNMPCommunityString, ethernetBridgingAvailability=ethernetBridgingAvailability, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, automaticTxPowerControl=automaticTxPowerControl, notificationsGroup=notificationsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, configuration=configuration, bridge=bridge, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogState=syslogState, productVariant=productVariant, regionCodeTrap=regionCodeTrap, sNTPServerIPAddress=sNTPServerIPAddress, qOSPriorityScheme=qOSPriorityScheme, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, sMTPEmailAlert=sMTPEmailAlert, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, userTableEntry=userTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, dfsTableEntry=dfsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secureModeAlarm=secureModeAlarm, softwareVersion=softwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityTable=ethernetPriorityTable, ethernetGroup=ethernetGroup, targetRange=targetRange, receiveChannel=receiveChannel)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", byteErrorRatio=byteErrorRatio, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, snmpControlGroup=snmpControlGroup, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, reset=reset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelALoopback=channelALoopback, tFTPServerPortNumber=tFTPServerPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, masterSlaveMode=masterSlaveMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, userRole=userRole, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, dataPortStatusTrap=dataPortStatusTrap, remoteInternetAddress=remoteInternetAddress, dfsTableIndex=dfsTableIndex, telecom=telecom, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, remoteInternetAddressType=remoteInternetAddressType, channelALineCode=channelALineCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sntpGroup=sntpGroup, productName=productName, sNTPServerTimeout=sNTPServerTimeout, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, securityLevel=securityLevel, secureModeAlarmTrap=secureModeAlarmTrap, ptp600=ptp600, telecomsChannelSelection=telecomsChannelSelection, hardwareVersion=hardwareVersion, vLANManagementPriority=vLANManagementPriority, accessMethod=accessMethod, receiveDataRate=receiveDataRate, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, linkSymmetry=linkSymmetry, managementMode=managementMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress)
