...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", reset=reset, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerTableIndex=sNTPServerTableIndex, installStatusTrap=installStatusTrap, userPassword=userPassword, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, groupID=groupID, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, bridge=bridge, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, bootVersion=bootVersion, channelBLoopbackTrap=channelBLoopbackTrap, targetMACAddress=targetMACAddress, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTimeout=sNTPServerTimeout, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, phyStatus=phyStatus, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTableNumber=sNTPServerTableNumber, installStatus=installStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hAZLOCConfiguration=hAZLOCConfiguration, sNMPPortNumber=sNMPPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv4Address=iPv4Address, sNTPServerTable=sNTPServerTable, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, subnetMask=subnetMask, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userEnabled=userEnabled, hTTPPortNumber=hTTPPortNumber, ptp600=ptp600, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableIndex=userTableIndex, sNTPServerRetries=sNTPServerRetries, tFTPServerInternetAddressType=tFTPServerInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, productName=productName, l2CPPriorityTable=l2CPPriorityTable, productVariant=productVariant, rawReceivePower=rawReceivePower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDControl=tDDControl, dfs=dfs, tDDControlGroup=tDDControlGroup, secureModeAlarm=secureModeAlarm, sMTPEmailAlert=sMTPEmailAlert, bandwidthVariant=bandwidthVariant, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, accessMethod=accessMethod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBLoopback=channelBLoopback, channelALineCode=channelALineCode, syslogControl=syslogControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aggregateDataRate=aggregateDataRate, licence=licence, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, managementPortStatusTrap=managementPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPollInterval=sNTPPollInterval, rxColorCode=rxColorCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, longitude=longitude, linkModeOptimisation=linkModeOptimisation, qOSPriorityScheme=qOSPriorityScheme, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerStatus=sNTPServerStatus, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, localPacketFiltering=localPacketFiltering, vectorError=vectorError, maximumTransmitPower=maximumTransmitPower, dfsTableNumber=dfsTableNumber, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, syslogClient=syslogClient, regionCode=regionCode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, latitude=latitude, iPv6GatewayAddress=iPv6GatewayAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTable=ethernetPriorityTable, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, telnetPortNumber=telnetPortNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteIPAddress=remoteIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, userName=userName, sMTPServerInternetAddress=sMTPServerInternetAddress, smtp=smtp, siteName=siteName, ethernetBridgingStatus=ethernetBridgingStatus, ethernetGroup=ethernetGroup, dataPortFiberStatus=dataPortFiberStatus, transmitPower=transmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, aAAControlGroup=aAAControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortStatus=managementPortStatus, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, softwareVersion=softwareVersion, alarmsGroup=alarmsGroup, dfsTable=dfsTable, regionCodeTrap=regionCodeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpCompliance=ptpCompliance, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsGroup=dfsGroup, syslogClientTrap=syslogClientTrap, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cambium=cambium, telecom=telecom, supplementary=supplementary, iPVersion=iPVersion, channelBLineCode=channelBLineCode, dfsTableEntry=dfsTableEntry, daylightSaving=daylightSaving, secureModeAlarmTrap=secureModeAlarmTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, resetGroup=resetGroup, telecomsChannelAStatus=telecomsChannelAStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, channelChangeTrap=channelChangeTrap, channelALoopbackTrap=channelALoopbackTrap, pubStats=pubStats, ptmp=ptmp, range=range, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyControl=phyControl, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6Address=iPv6Address, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, txColorCode=txColorCode, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, altitude=altitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsPeaks=dfsPeaks, configuration=configuration, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, receiveFreqKHz=receiveFreqKHz, managementMode=managementMode, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, timeZone=timeZone, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBCableLength=channelBCableLength, hTTPAccessEnabled=hTTPAccessEnabled, versions=versions, installArmStateTrap=installArmStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, targetRange=targetRange, bridgeGroup=bridgeGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sntpGroup=sntpGroup, alarms=alarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rangingMode=rangingMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, snmpControl=snmpControl, linkName=linkName, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, eIRP=eIRP, channelALoopback=channelALoopback, telecomsChannelSelection=telecomsChannelSelection, frequencyVariant=frequencyVariant, securityLevel=securityLevel, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, remoteInternetAddress=remoteInternetAddress, systemClock=systemClock, userTableEntry=userTableEntry, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, encryptionGroup=encryptionGroup, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, receiveModulationMode=receiveModulationMode, linkSymmetry=linkSymmetry, managementGroup=managementGroup, channelACableLength=channelACableLength, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogStateTrap=syslogStateTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, userTable=userTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogState=syslogState, remoteInternetAddressType=remoteInternetAddressType, dfsMeans=dfsMeans)
