...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkName=linkName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, ptp=ptp, remoteInternetAddressType=remoteInternetAddressType, eIRP=eIRP, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveChannel=receiveChannel, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntp=sntp, versions=versions, dfsTableIndex=dfsTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, cableLoss=cableLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableEntry=dfsTableEntry, groupID=groupID, managementMode=managementMode, receiveFreqMHz=receiveFreqMHz, telecomsChannelSelection=telecomsChannelSelection, configurationGroup=configurationGroup, sNTPServerTable=sNTPServerTable, searchState=searchState, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, smtp=smtp, dfsMeans=dfsMeans, secureModeAlarmTrap=secureModeAlarmTrap, transmitModulationMode=transmitModulationMode, sNTPState=sNTPState, telecomGroup=telecomGroup, ethernetBridgingStatus=ethernetBridgingStatus, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleRegionCodes=incompatibleRegionCodes, transmitDataRate=transmitDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, cambium=cambium, ptmp=ptmp, masterSlaveMode=masterSlaveMode, ethernet=ethernet, ptp600=ptp600, dSCPManagementPriority=dSCPManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, channelBLoopback=channelBLoopback, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, l2CPPriorityTable=l2CPPriorityTable, snmpControlGroup=snmpControlGroup, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, userRole=userRole, signalStrengthRatio=signalStrengthRatio, sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, syslogControl=syslogControl, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortFiberStatus=dataPortFiberStatus, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, bridge=bridge, siteName=siteName, iPv4Address=iPv4Address, channelACableLength=channelACableLength, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, installArmStateTrap=installArmStateTrap, phyControl=phyControl, pubStatsGroup=pubStatsGroup, regionCode=regionCode, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableEntry=userTableEntry, channelBCableLength=channelBCableLength, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secureModeAlarm=secureModeAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerRetries=sNTPServerRetries, telecomsChannelAStatus=telecomsChannelAStatus, channelBLoopbackTrap=channelBLoopbackTrap, bandwidthVariant=bandwidthVariant, rawReceivePower=rawReceivePower, sNTPSync=sNTPSync, sNTPServerTableIndex=sNTPServerTableIndex, targetMACAddress=targetMACAddress, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetRange=targetRange, txColorCode=txColorCode, ethernetPriorityTable=ethernetPriorityTable, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, latitude=latitude, hAZLOCConfiguration=hAZLOCConfiguration, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, pubStats=pubStats, automaticTxPowerControl=automaticTxPowerControl, sntpGroup=sntpGroup, ptpGroups=ptpGroups, dfs=dfs, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, reset=reset, resetGroup=resetGroup, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTableNumber=sNTPServerTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, bootVersion=bootVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, telecom=telecom, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, PYSNMP_MODULE_ID=cambium, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSPortNumber=hTTPSPortNumber, management=management, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementaryGroup=supplementaryGroup, linkSymmetry=linkSymmetry, hardwareVersion=hardwareVersion, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, bridgeGroup=bridgeGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, securityLevel=securityLevel, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, systemClock=systemClock, syslogClient=syslogClient, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, channelALineCode=channelALineCode, localPacketFiltering=localPacketFiltering, dataPortStatus=dataPortStatus, longitude=longitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsGroup=dfsGroup, remoteInternetAddress=remoteInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, configuration=configuration, ptpTraps=ptpTraps, channelBLineCode=channelBLineCode, productName=productName, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, softwareVersion=softwareVersion, userTable=userTable, telnetPortNumber=telnetPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rangingMode=rangingMode, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementVID=vLANManagementVID, versionsGroup=versionsGroup, licenceGroup=licenceGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsPeaks=dfsPeaks, channelALoopback=channelALoopback, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, gatewayIPAddress=gatewayIPAddress, rxColorCode=rxColorCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, antennaGain=antennaGain, mPLSTCPriorityTable=mPLSTCPriorityTable, channelALoopbackTrap=channelALoopbackTrap, iPv6PrefixLength=iPv6PrefixLength, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableNumber=userTableNumber, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, qOSPriorityScheme=qOSPriorityScheme, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, encryptionAlgorithm=encryptionAlgorithm, iPVersion=iPVersion, accessMethod=accessMethod, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, regionCodeTrap=regionCodeTrap, managementGroup=managementGroup, iPv6Address=iPv6Address, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortStatus=managementPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, range=range, productVariant=productVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
