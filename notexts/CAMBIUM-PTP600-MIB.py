...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitModulationMode=transmitModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userTableNumber=userTableNumber, sNTPPollInterval=sNTPPollInterval, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, subnetMask=subnetMask, iPDSCPPriorityTable=iPDSCPPriorityTable, installStatus=installStatus, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, antennaGain=antennaGain, channelALoopbackTrap=channelALoopbackTrap, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, transmitDataRate=transmitDataRate, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, smtp=smtp, telecomsChannelBStatus=telecomsChannelBStatus, managementPortStatusTrap=managementPortStatusTrap, syslogStateTrap=syslogStateTrap, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, sNTPServerTableEntry=sNTPServerTableEntry, userRole=userRole, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, licence=licence, managementMode=managementMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteInternetAddressType=remoteInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerStatus=sNTPServerStatus, sNTPLastSync=sNTPLastSync, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productName=productName, notificationsGroup=notificationsGroup, dataPortDisabledWarning=dataPortDisabledWarning, channelALineCode=channelALineCode, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatusGroup=phyStatusGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNTPState=sNTPState, tDDControl=tDDControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, userName=userName, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, userTableIndex=userTableIndex, transmitPower=transmitPower, iPv4Address=iPv4Address, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpTraps=ptpTraps, sntpGroup=sntpGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versions=versions, systemClock=systemClock, longitude=longitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, txColorCode=txColorCode, frequencyVariant=frequencyVariant, cableLoss=cableLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, channelBLoopback=channelBLoopback, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, productVariant=productVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, sNTPServerRetries=sNTPServerRetries, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, iPv6Address=iPv6Address, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, ptp600=ptp600, tFTPServerIPAddress=tFTPServerIPAddress, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, alarms=alarms, range=range, sNTPServerTable=sNTPServerTable, rawReceivePower=rawReceivePower, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cambium=cambium, syslogControlGroup=syslogControlGroup, groupID=groupID, telnetPortNumber=telnetPortNumber, sntp=sntp, channelChangeTrap=channelChangeTrap, snmpControlGroup=snmpControlGroup, linkName=linkName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, regionCodeTrap=regionCodeTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetBridgingAvailability=ethernetBridgingAvailability, bridge=bridge, dfsGroup=dfsGroup, versionsGroup=versionsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortFiberStatusTrap=dataPortFiberStatusTrap, hTTPSPortNumber=hTTPSPortNumber, syslogClient=syslogClient, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBLineCode=channelBLineCode, sNTPSync=sNTPSync, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, userEnabled=userEnabled, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, rxColorCode=rxColorCode, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyControlGroup=phyControlGroup, iPVersion=iPVersion, reset=reset, ptmp=ptmp, hTTPAccessEnabled=hTTPAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secondarySoftwareVersion=secondarySoftwareVersion, regionCode=regionCode, rangingMode=rangingMode, qOSPriorityScheme=qOSPriorityScheme, linkModeOptimisation=linkModeOptimisation, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, dfsPeaks=dfsPeaks, resetGroup=resetGroup, ethernetGroup=ethernetGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, hAZLOCConfiguration=hAZLOCConfiguration, remoteRxTargetPower=remoteRxTargetPower, telecomGroup=telecomGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetBridgingStatus=ethernetBridgingStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, dfsTableIndex=dfsTableIndex, aAAControl=aAAControl, channelALoopback=channelALoopback, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, securityLevel=securityLevel, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, gatewayIPAddress=gatewayIPAddress, receiveModulationMode=receiveModulationMode, supplementary=supplementary, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, systemReset=systemReset, iPv6GatewayAddress=iPv6GatewayAddress, userPassword=userPassword, managementPortStatus=managementPortStatus, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBLoopbackTrap=channelBLoopbackTrap, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, channelACableLength=channelACableLength, eIRP=eIRP, telecomsChannelSelection=telecomsChannelSelection, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogState=syslogState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubStats=pubStats, dSCPManagementPriority=dSCPManagementPriority, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, telecom=telecom, configuration=configuration, encryptionAlgorithm=encryptionAlgorithm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, dfsTable=dfsTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControl=syslogControl, encryptionGroup=encryptionGroup, channelBCableLength=channelBCableLength, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, targetMACAddress=targetMACAddress, secureModeAlarm=secureModeAlarm, userTable=userTable, installArmState=installArmState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, localPacketFiltering=localPacketFiltering, ethernet=ethernet, vLANManagementVID=vLANManagementVID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteInternetAddress=remoteInternetAddress, unitOutOfCalibration=unitOutOfCalibration, management=management)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortAutoMdix=dataPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, syslogClientTrap=syslogClientTrap, dataPortFiberStatus=dataPortFiberStatus, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, dfsMeans=dfsMeans, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, dfs=dfs, licenceGroup=licenceGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, targetRange=targetRange, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, searchState=searchState)
