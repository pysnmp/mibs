...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, ptpCompliance=ptpCompliance, dfs=dfs, rawReceivePower=rawReceivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, automaticTxPowerControl=automaticTxPowerControl, alarmsGroup=alarmsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitFreqMHz=transmitFreqMHz, telnetAccessEnabled=telnetAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableNumber=dfsTableNumber, eIRP=eIRP, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogControlGroup=syslogControlGroup, ptp=ptp, dfsTable=dfsTable, syslogState=syslogState, transmitChannel=transmitChannel, sMTPServerIPAddress=sMTPServerIPAddress, tDDControlGroup=tDDControlGroup, sNMPTrapTable=sNMPTrapTable, iPv4Address=iPv4Address, smtp=smtp, subnetMask=subnetMask, reset=reset, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, supplementary=supplementary, transmitFreqKHz=transmitFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelALoopbackTrap=channelALoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, frequencyVariant=frequencyVariant, siteName=siteName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, txColorCode=txColorCode, channelBLoopbackTrap=channelBLoopbackTrap, signalStrengthRatio=signalStrengthRatio, userEnabled=userEnabled, iPv6GatewayAddress=iPv6GatewayAddress, secureModeAlarmTrap=secureModeAlarmTrap, configurationGroup=configurationGroup, productName=productName, snmpControl=snmpControl, syslogClient=syslogClient, ethernetGroup=ethernetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userRole=userRole, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installStatusTrap=installStatusTrap, userName=userName, sMTPServerInternetAddress=sMTPServerInternetAddress, remoteInternetAddressType=remoteInternetAddressType, telecomsInterface=telecomsInterface, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, range=range, l2CPPriorityTable=l2CPPriorityTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelALineCode=channelALineCode, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installArmState=installArmState, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPState=sNTPState, phyControl=phyControl, userTableEntry=userTableEntry, receivePower=receivePower, transmitPower=transmitPower, regionCode=regionCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortDisabledWarning=managementPortDisabledWarning, managementPortStatusTrap=managementPortStatusTrap, dfsTableEntry=dfsTableEntry, transmitDataRate=transmitDataRate, receiveDataRate=receiveDataRate, versions=versions, ethernetBridgingAvailability=ethernetBridgingAvailability, remoteInternetAddress=remoteInternetAddress, targetMACAddress=targetMACAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSync=sNTPSync, antennaGain=antennaGain, receiveChannel=receiveChannel, targetRange=targetRange, sntpGroup=sntpGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, masterSlaveMode=masterSlaveMode, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, systemClock=systemClock, ethernet=ethernet, supplementaryGroup=supplementaryGroup, installStatus=installStatus, bootVersion=bootVersion, licenceGroup=licenceGroup, telecom=telecom, channelALoopback=channelALoopback, aAAControl=aAAControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptpTraps=ptpTraps, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, sNTPPollInterval=sNTPPollInterval, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, latitude=latitude, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rangingMode=rangingMode, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, hAZLOCConfiguration=hAZLOCConfiguration, syslogClientTrap=syslogClientTrap, bridge=bridge, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLoopback=channelBLoopback, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPv6Address=iPv6Address, bridgeGroup=bridgeGroup, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, iPv6PrefixLength=iPv6PrefixLength, managementPortStatus=managementPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableEntry=sNTPServerTableEntry, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, groupID=groupID, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, localPacketFiltering=localPacketFiltering, unitOutOfCalibration=unitOutOfCalibration, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTable=ethernetPriorityTable, userTable=userTable, sNTPServerTimeout=sNTPServerTimeout, dfsGroup=dfsGroup, hTTPAccessEnabled=hTTPAccessEnabled, productVariant=productVariant, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, vectorError=vectorError, channelACableLength=channelACableLength, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableEntry=l2CPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, dataPortFiberStatusTrap=dataPortFiberStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, securityLevel=securityLevel, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelAStatus=telecomsChannelAStatus, aAAControlGroup=aAAControlGroup, configuration=configuration, ptmp=ptmp, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sntp=sntp, sNTPServerStatus=sNTPServerStatus, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, management=management, phyStatusGroup=phyStatusGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, byteErrorRatio=byteErrorRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerTableNumber=sNTPServerTableNumber, dataPortFiberStatus=dataPortFiberStatus, sNTPServerTable=sNTPServerTable, remoteIPAddress=remoteIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerRetries=sNTPServerRetries, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, softwareVersion=softwareVersion, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelSelection=telecomsChannelSelection, timeZone=timeZone, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, smtpGroup=smtpGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPCommunityString=sNMPCommunityString, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, channelBLineCode=channelBLineCode, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, secureModeAlarm=secureModeAlarm, altitude=altitude, snmpControlGroup=snmpControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpGroups=ptpGroups, telecomGroup=telecomGroup, rxColorCode=rxColorCode, phyStatus=phyStatus, notificationsGroup=notificationsGroup, qOSPriorityScheme=qOSPriorityScheme, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, longitude=longitude, cambium=cambium, sNTPServerTableIndex=sNTPServerTableIndex, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, PYSNMP_MODULE_ID=cambium, resetGroup=resetGroup, managementMode=managementMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, encryption=encryption, vLANManagementPriority=vLANManagementPriority, channelBCableLength=channelBCableLength, syslogControl=syslogControl, dSCPManagementPriority=dSCPManagementPriority, sNTPServerInternetAddress=sNTPServerInternetAddress)
