...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:49:36 2021
...
MibIdentifier, Integer32, ModuleIdentity, Counter64, iso, IpAddress, Counter32, Bits, Gauge32, enterprises, ObjectIdentity, NotificationType, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Counter32", "Bits", "Gauge32", "enterprises", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDControl=tDDControl, ethernetBridgingAvailability=ethernetBridgingAvailability, targetMACAddress=targetMACAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsGroup=dfsGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPState=sNTPState, userName=userName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bridge=bridge, vLANManagementVID=vLANManagementVID, iPv6PrefixLength=iPv6PrefixLength, transmitChannel=transmitChannel, sNTPServerStatus=sNTPServerStatus, linkSymmetry=linkSymmetry, reset=reset, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, ethernetFiberSupport=ethernetFiberSupport, sntp=sntp, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatio=byteErrorRatio, vectorError=vectorError, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, l2CPPriorityTableIndex=l2CPPriorityTableIndex, telecomsInterface=telecomsInterface, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receivePower=receivePower, versions=versions, telecom=telecom, transmitPower=transmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, pubStats=pubStats, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, frequencyVariant=frequencyVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, notificationsGroup=notificationsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBLineCode=channelBLineCode, automaticTxPowerControl=automaticTxPowerControl, incompatibleRegionCodes=incompatibleRegionCodes, sNMPCommunityString=sNMPCommunityString, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, systemClock=systemClock, ethernetPriorityTable=ethernetPriorityTable, snmpControl=snmpControl, antennaGain=antennaGain, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, supplementaryGroup=supplementaryGroup, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, managementPortStatusTrap=managementPortStatusTrap, sNTPServerRetries=sNTPServerRetries, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configuration=configuration, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, licenceGroup=licenceGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernet=ethernet, phyControl=phyControl, smtp=smtp, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, aAAControl=aAAControl, userPassword=userPassword, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelAStatus=telecomsChannelAStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogControl=syslogControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, userTable=userTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secureModeAlarm=secureModeAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, managementPortStatus=managementPortStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, regionCode=regionCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, productVariant=productVariant, userRole=userRole, systemReset=systemReset, userTableIndex=userTableIndex, sNTPServerTable=sNTPServerTable, userTableNumber=userTableNumber, linkLoss=linkLoss, configurationGroup=configurationGroup, rangingMode=rangingMode, installArmState=installArmState, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, timeZone=timeZone, remoteInternetAddressType=remoteInternetAddressType, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, management=management, sNTPLastSync=sNTPLastSync, smtpGroup=smtpGroup, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv4Address=iPv4Address, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, resetGroup=resetGroup, iPv6Address=iPv6Address, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptpTrapPrefix=ptpTrapPrefix, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hardwareVersion=hardwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, dfsTable=dfsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBCableLength=channelBCableLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, localPacketFiltering=localPacketFiltering, telnetPortNumber=telnetPortNumber, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, managementMode=managementMode, rxColorCode=rxColorCode, syslogState=syslogState, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, ethernetPriorityTableEntry=ethernetPriorityTableEntry, masterSlaveMode=masterSlaveMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ptpCompliance=ptpCompliance, siteName=siteName, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogClient=syslogClient, receiveChannel=receiveChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, channelACableLength=channelACableLength, channelALoopback=channelALoopback, hAZLOCConfiguration=hAZLOCConfiguration, encryption=encryption, userTableEntry=userTableEntry, wirelessLinkStatus=wirelessLinkStatus, installStatus=installStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControlGroup=snmpControlGroup, remoteRxTargetPower=remoteRxTargetPower, channelBLoopbackTrap=channelBLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServer=sNTPPrimaryServer, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableEntry=sNTPServerTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopbackTrap=channelALoopbackTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bandwidthVariant=bandwidthVariant, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSync=sNTPSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, channelBandwidth=channelBandwidth, bootVersion=bootVersion, bridgeGroup=bridgeGroup, groupID=groupID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aggregateDataRate=aggregateDataRate, receiveDataRate=receiveDataRate, linkModeOptimisation=linkModeOptimisation, managementGroup=managementGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, latitude=latitude, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoMdix=dataPortAutoMdix, remoteInternetAddress=remoteInternetAddress, sMTPEmailAlert=sMTPEmailAlert, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelALineCode=channelALineCode, targetRange=targetRange, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, txColorCode=txColorCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPPortNumber=sNMPPortNumber, range=range, channelChangeTrap=channelChangeTrap, dfsMeans=dfsMeans, dSCPManagementPriority=dSCPManagementPriority, iPVersion=iPVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, l2CPPriorityTable=l2CPPriorityTable, phyStatusGroup=phyStatusGroup, alarms=alarms, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, searchState=searchState, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, telnetAccessEnabled=telnetAccessEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, longitude=longitude, telecomGroup=telecomGroup, ptp600=ptp600, tDDSynchronizationMode=tDDSynchronizationMode, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelSelection=telecomsChannelSelection, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, dfs=dfs, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, productName=productName, securityLevel=securityLevel, channelBLoopback=channelBLoopback, rawReceivePower=rawReceivePower, telecomsChannelBStatus=telecomsChannelBStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqMHz=receiveFreqMHz, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, secondarySoftwareVersion=secondarySoftwareVersion)
