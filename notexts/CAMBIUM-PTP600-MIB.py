...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", reset=reset, aggregateDataRate=aggregateDataRate, userTableIndex=userTableIndex, localPacketFiltering=localPacketFiltering, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsTableEntry=dfsTableEntry, sntpGroup=sntpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, ethernet=ethernet, securityLevel=securityLevel, configuration=configuration, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, iPv6GatewayAddress=iPv6GatewayAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, licence=licence, remoteIPAddress=remoteIPAddress, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, linkName=linkName, secureModeAlarm=secureModeAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, supplementary=supplementary, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, licenceGroup=licenceGroup, range=range, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelAStatus=telecomsChannelAStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, iPVersion=iPVersion, ptmp=ptmp, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqKHz=transmitFreqKHz, sNTPPollInterval=sNTPPollInterval, sNMPPortNumber=sNMPPortNumber, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitModulationMode=transmitModulationMode, ptp=ptp, ptpGroups=ptpGroups, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, encryption=encryption, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoMdix=dataPortAutoMdix, remoteInternetAddressType=remoteInternetAddressType, telecomsInterface=telecomsInterface, ethernetGroup=ethernetGroup, rawReceivePower=rawReceivePower, userRole=userRole, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, groupID=groupID, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, regionCode=regionCode, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, smtp=smtp, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALoopbackTrap=channelALoopbackTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelACableLength=channelACableLength, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, automaticTxPowerControl=automaticTxPowerControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, userEnabled=userEnabled, channelBLoopback=channelBLoopback, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sntp=sntp, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerTable=sNTPServerTable, daylightSaving=daylightSaving, txColorCode=txColorCode, dSCPManagementPriority=dSCPManagementPriority, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, systemReset=systemReset, channelChangeTrap=channelChangeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userPassword=userPassword, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, linkLoss=linkLoss, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, vLANManagementPriority=vLANManagementPriority, targetRange=targetRange, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelALoopback=channelALoopback, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, productName=productName, unitOutOfCalibration=unitOutOfCalibration, dfsPeaks=dfsPeaks, l2CPPriorityTable=l2CPPriorityTable, sNTPLastSync=sNTPLastSync, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subnetMask=subnetMask, channelBandwidth=channelBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receivePower=receivePower, bridge=bridge, dfsGroup=dfsGroup, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, bridgeGroup=bridgeGroup, transmitPower=transmitPower, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleRegionCodes=incompatibleRegionCodes, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, alarms=alarms, dataPortFiberStatus=dataPortFiberStatus, cableLoss=cableLoss, remoteInternetAddress=remoteInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, managementMode=managementMode, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, telecomGroup=telecomGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, remoteRxTargetPower=remoteRxTargetPower, hAZLOCConfiguration=hAZLOCConfiguration, channelBLineCode=channelBLineCode, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBLoopbackTrap=channelBLoopbackTrap, vectorError=vectorError, managementPortStatusTrap=managementPortStatusTrap, sNMPv3Enable=sNMPv3Enable, channelBCableLength=channelBCableLength, ptpCompliance=ptpCompliance, latitude=latitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogState=syslogState, masterSlaveMode=masterSlaveMode, managementPortStatus=managementPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, management=management, sNTPPrimaryServer=sNTPPrimaryServer, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, smtpGroup=smtpGroup, installArmStateTrap=installArmStateTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, longitude=longitude, syslogStateTrap=syslogStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelSelection=telecomsChannelSelection, aAAControlGroup=aAAControlGroup, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, tDDControl=tDDControl, channelALineCode=channelALineCode, dfsTable=dfsTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemClock=systemClock, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionGroup=encryptionGroup, iPv6Address=iPv6Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPv4Address=iPv4Address, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerRetries=sNTPServerRetries, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, rangingMode=rangingMode, installStatus=installStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapTableEntry=sNMPTrapTableEntry, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, ptp600=ptp600, cambium=cambium, telecomsChannelBStatus=telecomsChannelBStatus, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, userName=userName, managementGroup=managementGroup, byteErrorRatio=byteErrorRatio, syslogClient=syslogClient, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, pubStats=pubStats, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, antennaGain=antennaGain, phyControlGroup=phyControlGroup, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, rxColorCode=rxColorCode, receiveDataRate=receiveDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, targetMACAddress=targetMACAddress)
