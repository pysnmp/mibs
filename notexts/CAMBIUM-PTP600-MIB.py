...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelACableLength=channelACableLength, sNTPLastSync=sNTPLastSync, dfsTableEntry=dfsTableEntry, txColorCode=txColorCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelALoopback=channelALoopback, bandwidthVariant=bandwidthVariant, syslogState=syslogState, regionCodeTrap=regionCodeTrap, iPVersion=iPVersion, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, telecomsChannelAStatus=telecomsChannelAStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rxColorCode=rxColorCode, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTableNumber=sNTPServerTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, tDDControlGroup=tDDControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBCableLength=channelBCableLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBLoopbackTrap=channelBLoopbackTrap, configuration=configuration, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, dfs=dfs, masterSlaveMode=masterSlaveMode, targetRange=targetRange, configurationGroup=configurationGroup, securityLevel=securityLevel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, supplementary=supplementary, installArmState=installArmState, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, userPassword=userPassword, userEnabled=userEnabled, userTableIndex=userTableIndex, channelALineCode=channelALineCode, hTTPSPortNumber=hTTPSPortNumber, phyStatus=phyStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, PYSNMP_MODULE_ID=cambium, sNTPServerTimeout=sNTPServerTimeout, sNTPServerTable=sNTPServerTable, l2CPPriorityTable=l2CPPriorityTable, channelBandwidth=channelBandwidth, regionCode=regionCode, ethernet=ethernet, installStatus=installStatus, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsMeans=dfsMeans, syslogClient=syslogClient, alarmsGroup=alarmsGroup, ethernetPriorityTable=ethernetPriorityTable, sNMPv3Enable=sNMPv3Enable, notificationsGroup=notificationsGroup, remoteInternetAddressType=remoteInternetAddressType, channelBLoopback=channelBLoopback, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerRetries=sNTPServerRetries, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, pubStats=pubStats, userTable=userTable, byteErrorRatio=byteErrorRatio, encryption=encryption, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, dfsGroup=dfsGroup, telecomGroup=telecomGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkName=linkName, sntp=sntp, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, rawReceivePower=rawReceivePower, bootVersion=bootVersion, cableLoss=cableLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, remoteInternetAddress=remoteInternetAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, iPv4Address=iPv4Address, aAAControlGroup=aAAControlGroup, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telecomsInterface=telecomsInterface, telecomsChannelBStatus=telecomsChannelBStatus, userRole=userRole, ptp=ptp, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, softwareVersion=softwareVersion, eIRP=eIRP, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, frequencyVariant=frequencyVariant, systemClock=systemClock, iPv6GatewayAddress=iPv6GatewayAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptmp=ptmp, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, range=range, siteName=siteName, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, bridge=bridge, subnetMask=subnetMask, secondarySoftwareVersion=secondarySoftwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receivePower=receivePower, sNTPPrimaryServer=sNTPPrimaryServer, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitModulationMode=transmitModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, remoteRxTargetPower=remoteRxTargetPower, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecom=telecom, ptpTraps=ptpTraps, dSCPManagementPriority=dSCPManagementPriority, transmitChannel=transmitChannel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receiveDataRate=receiveDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControl=syslogControl, ethernetGroup=ethernetGroup, productName=productName, managementPortStatusTrap=managementPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerInternetAddress=tFTPServerInternetAddress, encryptionGroup=encryptionGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, versions=versions, vLANManagementVID=vLANManagementVID, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, hardwareVersion=hardwareVersion, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, iPv6Address=iPv6Address, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sntpGroup=sntpGroup, dataPortFiberStatus=dataPortFiberStatus, sNTPState=sNTPState, sNTPServerTableIndex=sNTPServerTableIndex, iPv6PrefixLength=iPv6PrefixLength, pubStatsGroup=pubStatsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, snmpControl=snmpControl, ethernetFiberSupport=ethernetFiberSupport, rangingMode=rangingMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, automaticTxPowerControl=automaticTxPowerControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, qOSPriorityScheme=qOSPriorityScheme, sNTPServerStatus=sNTPServerStatus, supplementaryGroup=supplementaryGroup, managementMode=managementMode, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, ptp600=ptp600, aAAControl=aAAControl, ethernetBridgingStatus=ethernetBridgingStatus, searchState=searchState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryptionAlgorithm=encryptionAlgorithm, localPacketFiltering=localPacketFiltering, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, syslogStateTrap=syslogStateTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, bridgeGroup=bridgeGroup, dataPortStatusTrap=dataPortStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, channelBLineCode=channelBLineCode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, reset=reset, tDDSynchronizationMode=tDDSynchronizationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, timeZone=timeZone, antennaGain=antennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelALoopbackTrap=channelALoopbackTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, ptpTrapPrefix=ptpTrapPrefix, managementPortStatus=managementPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, cambium=cambium, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, sNTPServerTableEntry=sNTPServerTableEntry, smtp=smtp, licence=licence, transmitFreqMHz=transmitFreqMHz, secureModeAlarmTrap=secureModeAlarmTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, tFTPServerPortNumber=tFTPServerPortNumber, telecomsChannelSelection=telecomsChannelSelection, tDDControl=tDDControl, transmitFreqKHz=transmitFreqKHz)
