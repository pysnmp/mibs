...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6PrefixLength=iPv6PrefixLength, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControlGroup=aAAControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelBLineCode=channelBLineCode, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarms=alarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, receiveModulationMode=receiveModulationMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogControl=syslogControl, sNTPServerTableEntry=sNTPServerTableEntry, frequencyVariant=frequencyVariant, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangingMode=rangingMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsGroup=dfsGroup, channelBCableLength=channelBCableLength, ethernetFiberSupport=ethernetFiberSupport, receiveChannel=receiveChannel, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, dfsTable=dfsTable, syslogState=syslogState, remoteInternetAddressType=remoteInternetAddressType, smtpGroup=smtpGroup, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, channelBLoopback=channelBLoopback, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, versions=versions, systemClock=systemClock, daylightSaving=daylightSaving, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, qOSPriorityScheme=qOSPriorityScheme, byteErrorRatio=byteErrorRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBLoopbackTrap=channelBLoopbackTrap, vectorError=vectorError, remoteRxTargetPower=remoteRxTargetPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, timeZone=timeZone, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, regionCode=regionCode, dSCPManagementPriority=dSCPManagementPriority, telecomsChannelSelection=telecomsChannelSelection, unitOutOfCalibration=unitOutOfCalibration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, productVariant=productVariant, linkSymmetry=linkSymmetry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, antennaGain=antennaGain, telecomsChannelAStatus=telecomsChannelAStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortWirelessDownAlert=dataPortWirelessDownAlert, securityLevel=securityLevel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, longitude=longitude, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarm=secureModeAlarm, groupID=groupID, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productName=productName, telecomGroup=telecomGroup, cambium=cambium, ptpGroups=ptpGroups, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, pubStats=pubStats, cableLoss=cableLoss, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerRetries=sNTPServerRetries, sNTPState=sNTPState, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, txColorCode=txColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControl=snmpControl, sntp=sntp, remoteIPAddress=remoteIPAddress, syslogClient=syslogClient, installStatus=installStatus, configuration=configuration, managementGroup=managementGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, bootVersion=bootVersion, iPVersion=iPVersion, managementPortDisabledWarning=managementPortDisabledWarning, dfsPeaks=dfsPeaks, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, eIRP=eIRP, managementPortStatus=managementPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, remoteInternetAddress=remoteInternetAddress, telecom=telecom, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, rawReceivePower=rawReceivePower, tDDControl=tDDControl, sNMPTrapVersion=sNMPTrapVersion, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, installArmState=installArmState, transmitChannel=transmitChannel, telecomsChannelBStatus=telecomsChannelBStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, syslogClientTrap=syslogClientTrap, sNTPServerTable=sNTPServerTable, supplementary=supplementary, ptp=ptp, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, userPassword=userPassword, transmitModulationMode=transmitModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aAAControl=aAAControl, tDDControlGroup=tDDControlGroup, iPv6Address=iPv6Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, siteName=siteName, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, bridgeGroup=bridgeGroup, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, management=management, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, hAZLOCConfiguration=hAZLOCConfiguration, sNTPServerIPAddress=sNTPServerIPAddress, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableNumber=l2CPPriorityTableNumber, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, bridge=bridge, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, licence=licence, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, reset=reset, sMTPEmailAlert=sMTPEmailAlert, regionCodeTrap=regionCodeTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, smtp=smtp, bandwidthVariant=bandwidthVariant, phyControlGroup=phyControlGroup, phyStatus=phyStatus, ptpCompliance=ptpCompliance, sNMPEnabledTraps=sNMPEnabledTraps, ethernetBridgingStatus=ethernetBridgingStatus, sNTPServerStatus=sNTPServerStatus, sNTPServerTimeout=sNTPServerTimeout, installArmStateTrap=installArmStateTrap, localPacketFiltering=localPacketFiltering, phyControl=phyControl, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hTTPPortNumber=hTTPPortNumber, sNTPLastSync=sNTPLastSync, rxColorCode=rxColorCode, vLANManagementVID=vLANManagementVID, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv4Address=iPv4Address, encryption=encryption, dataPortStatus=dataPortStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelALoopback=channelALoopback, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, iPv6GatewayAddress=iPv6GatewayAddress, ptp600=ptp600, sNTPPrimaryServer=sNTPPrimaryServer, channelALoopbackTrap=channelALoopbackTrap, ethernetGroup=ethernetGroup, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, sNTPServerTableIndex=sNTPServerTableIndex, dfs=dfs, ethernet=ethernet, channelACableLength=channelACableLength, sNTPServerTableNumber=sNTPServerTableNumber, userTableNumber=userTableNumber, targetRange=targetRange, targetMACAddress=targetMACAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, automaticTxPowerControl=automaticTxPowerControl, sNMPPortNumber=sNMPPortNumber, linkName=linkName, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsInterface=telecomsInterface, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelALineCode=channelALineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
