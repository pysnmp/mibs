...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", reset=reset, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, iPv4Address=iPv4Address, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernet=ethernet, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, receiveFreqMHz=receiveFreqMHz, userPassword=userPassword, installArmStateTrap=installArmStateTrap, sNTPState=sNTPState, managementPortStatus=managementPortStatus, transmitDataRate=transmitDataRate, alarms=alarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, dfsTableNumber=dfsTableNumber, receiveDataRate=receiveDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerTable=sNTPServerTable, channelALoopback=channelALoopback, telecomGroup=telecomGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, linkName=linkName, targetMACAddress=targetMACAddress, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, accessMethod=accessMethod, bridge=bridge, snmpControlGroup=snmpControlGroup, linkModeOptimisation=linkModeOptimisation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, productVariant=productVariant, encryption=encryption, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, management=management, configurationGroup=configurationGroup, channelALoopbackTrap=channelALoopbackTrap, vLANManagementPriority=vLANManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveModulationMode=receiveModulationMode, telecomsInterface=telecomsInterface, transmitPower=transmitPower, sNTPServerTimeout=sNTPServerTimeout, userName=userName, regionCodeTrap=regionCodeTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtpGroup=smtpGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, notificationsGroup=notificationsGroup, searchState=searchState, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, versions=versions, sNTPLastSync=sNTPLastSync, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, channelBLoopback=channelBLoopback, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, timeZone=timeZone, bridgeGroup=bridgeGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, pubStatsGroup=pubStatsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteRxTargetPower=remoteRxTargetPower, snmpControl=snmpControl, ethernetBridgingAvailability=ethernetBridgingAvailability, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerIPAddress=tFTPServerIPAddress, aAAControl=aAAControl, ptpGroups=ptpGroups, longitude=longitude, maximumTransmitPower=maximumTransmitPower, l2CPPriorityTable=l2CPPriorityTable, hTTPPortNumber=hTTPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatusTrap=installStatusTrap, productName=productName, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, systemReset=systemReset, rangingMode=rangingMode, dfsMeans=dfsMeans, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, resetGroup=resetGroup, encryptionAlgorithm=encryptionAlgorithm, channelBandwidth=channelBandwidth, licence=licence, ptpTraps=ptpTraps, ethernetFiberSupport=ethernetFiberSupport, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionGroup=encryptionGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installStatus=installStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, qOSPriorityScheme=qOSPriorityScheme, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, range=range, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableIndex=sNTPServerTableIndex, iPVersion=iPVersion, phyStatus=phyStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortFiberStatus=dataPortFiberStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, sNTPServerStatus=sNTPServerStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, managementMode=managementMode, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, telecomsChannelAStatus=telecomsChannelAStatus, pubStats=pubStats, subnetMask=subnetMask, telecom=telecom, managementPortDisabledWarning=managementPortDisabledWarning, dfsTableEntry=dfsTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableIndex=dfsTableIndex, dfs=dfs, dfsPeaks=dfsPeaks, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, iPv6Address=iPv6Address, channelACableLength=channelACableLength, userRole=userRole, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, secondarySoftwareVersion=secondarySoftwareVersion, alarmsGroup=alarmsGroup, userTableIndex=userTableIndex, telnetPortNumber=telnetPortNumber, latitude=latitude, vectorError=vectorError, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableNumber=userTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secureModeAlarmTrap=secureModeAlarmTrap, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortStatusTrap=managementPortStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, syslogClientTrap=syslogClientTrap, ptmp=ptmp, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, securityLevel=securityLevel, supplementaryGroup=supplementaryGroup, ethernetBridgingStatus=ethernetBridgingStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, telecomsChannelSelection=telecomsChannelSelection, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, rxColorCode=rxColorCode, hardwareVersion=hardwareVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPCommunityString=sNMPCommunityString, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, daylightSaving=daylightSaving, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsGroup=dfsGroup, ptpCompliance=ptpCompliance, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, antennaGain=antennaGain, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, channelALineCode=channelALineCode, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBLineCode=channelBLineCode, licenceGroup=licenceGroup, phyControl=phyControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPv6PrefixLength=iPv6PrefixLength, channelBCableLength=channelBCableLength, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, targetRange=targetRange, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, systemClock=systemClock, syslogState=syslogState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", configuration=configuration, channelBLoopbackTrap=channelBLoopbackTrap, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, aAAControlGroup=aAAControlGroup, installArmState=installArmState, automaticTxPowerControl=automaticTxPowerControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelBStatus=telecomsChannelBStatus, hAZLOCConfiguration=hAZLOCConfiguration, ptp=ptp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, secureModeAlarm=secureModeAlarm, sNMPTrapTable=sNMPTrapTable, txColorCode=txColorCode, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, localPacketFiltering=localPacketFiltering, linkLoss=linkLoss, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, dataPortStatusTrap=dataPortStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cambium=cambium, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, phyStatusGroup=phyStatusGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, softwareVersion=softwareVersion, ptp600=ptp600, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry)
