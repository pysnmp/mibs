...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", rangingMode=rangingMode, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaGain=antennaGain, hardwareVersion=hardwareVersion, ptpTraps=ptpTraps, cambium=cambium, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelALoopback=channelALoopback, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, alarms=alarms, encryption=encryption, resetGroup=resetGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsChannelSelection=telecomsChannelSelection, dfsGroup=dfsGroup, regionCodeTrap=regionCodeTrap, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, securityLevel=securityLevel, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, byteErrorRatio=byteErrorRatio, remoteIPAddress=remoteIPAddress, masterSlaveMode=masterSlaveMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPCommunityString=sNMPCommunityString, channelBCableLength=channelBCableLength, ptpGroups=ptpGroups, versionsGroup=versionsGroup, channelALineCode=channelALineCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, sntp=sntp, sntpGroup=sntpGroup, telecomsChannelAStatus=telecomsChannelAStatus, receiveFreqKHz=receiveFreqKHz, channelALoopbackTrap=channelALoopbackTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, phyControl=phyControl, groupID=groupID, managementMode=managementMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, txColorCode=txColorCode, incompatibleRegionCodes=incompatibleRegionCodes, systemReset=systemReset, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, phyControlGroup=phyControlGroup, ethernetGroup=ethernetGroup, iPv6GatewayAddress=iPv6GatewayAddress, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receivePower=receivePower, sNTPServerTimeout=sNTPServerTimeout, remoteRxTargetPower=remoteRxTargetPower, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, channelBandwidth=channelBandwidth, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userTable=userTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, localPacketFiltering=localPacketFiltering, telecom=telecom, softwareVersion=softwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telnetPortNumber=telnetPortNumber, versions=versions, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecomGroup=telecomGroup, management=management, targetMACAddress=targetMACAddress, bridgeGroup=bridgeGroup, range=range, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userPassword=userPassword, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rawReceivePower=rawReceivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, regionCode=regionCode, bridge=bridge, iPVersion=iPVersion, channelBLoopback=channelBLoopback, managementPortDisabledWarning=managementPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, siteName=siteName, pubStats=pubStats, targetRange=targetRange, hAZLOCConfiguration=hAZLOCConfiguration, unitOutOfCalibration=unitOutOfCalibration, rxColorCode=rxColorCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, configuration=configuration, bandwidthVariant=bandwidthVariant, snmpControl=snmpControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, daylightSaving=daylightSaving, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelBStatus=telecomsChannelBStatus, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, tDDControlGroup=tDDControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dfsTableEntry=dfsTableEntry, ptmp=ptmp, transmitPower=transmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsInterface=telecomsInterface, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDControl=tDDControl, longitude=longitude, iPv6PrefixLength=iPv6PrefixLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBLineCode=channelBLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, installArmState=installArmState, transmitChannel=transmitChannel, userRole=userRole, encryptionGroup=encryptionGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementGroup=managementGroup, automaticTxPowerControl=automaticTxPowerControl, userTableIndex=userTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, sMTPServerPortNumber=sMTPServerPortNumber, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, channelACableLength=channelACableLength, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, ptpCompliance=ptpCompliance, receiveFreqMHz=receiveFreqMHz, wirelessLinkStatus=wirelessLinkStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licence=licence, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarmsGroup=alarmsGroup, ptp600=ptp600, channelChangeTrap=channelChangeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, tDDSynchronizationMode=tDDSynchronizationMode, syslogStateTrap=syslogStateTrap, ethernetBridgingStatus=ethernetBridgingStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortStatus=managementPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapPortNumber=sNMPTrapPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv4Address=iPv4Address, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, syslogClientTrap=syslogClientTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, subnetMask=subnetMask, frequencyVariant=frequencyVariant, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfs=dfs)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bootVersion=bootVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dfsPeaks=dfsPeaks, notificationsGroup=notificationsGroup, syslogClient=syslogClient, userName=userName, linkName=linkName, receiveChannel=receiveChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber, sNTPState=sNTPState, dataPortFiberStatus=dataPortFiberStatus, remoteInternetAddressType=remoteInternetAddressType, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPSync=sNTPSync, timeZone=timeZone, receiveDataRate=receiveDataRate, ethernetBridgingAvailability=ethernetBridgingAvailability, smtp=smtp, dfsMeans=dfsMeans, l2CPPriorityTable=l2CPPriorityTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dfsTableIndex=dfsTableIndex, licenceGroup=licenceGroup, userTableNumber=userTableNumber, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vLANManagementVID=vLANManagementVID, sNTPPrimaryServer=sNTPPrimaryServer, sMTPEnabledMessages=sMTPEnabledMessages, reset=reset)
