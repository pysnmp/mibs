...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", management=management, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, ptp=ptp, dfsTable=dfsTable, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPPortNumber=sNMPPortNumber, remoteInternetAddress=remoteInternetAddress, receivePower=receivePower, snmpControl=snmpControl, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dSCPManagementPriority=dSCPManagementPriority, txColorCode=txColorCode, syslogState=syslogState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, regionCode=regionCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkName=linkName, softwareVersion=softwareVersion, channelACableLength=channelACableLength, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, licenceGroup=licenceGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecom=telecom, tFTPServerInternetAddressType=tFTPServerInternetAddressType, userPassword=userPassword, sntp=sntp, transmitDataRate=transmitDataRate, secureModeAlarm=secureModeAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, productVariant=productVariant, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, PYSNMP_MODULE_ID=cambium, channelBLineCode=channelBLineCode, managementMode=managementMode, userTableIndex=userTableIndex, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, phyStatusGroup=phyStatusGroup, configuration=configuration, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, bridgeGroup=bridgeGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, latitude=latitude, gatewayIPAddress=gatewayIPAddress, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimisation=linkModeOptimisation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, daylightSaving=daylightSaving, userRole=userRole, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemReset=systemReset, channelBLoopbackTrap=channelBLoopbackTrap, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerInternetAddress=sMTPServerInternetAddress, reset=reset, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, qOSPriorityScheme=qOSPriorityScheme, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, configurationGroup=configurationGroup, cableLoss=cableLoss, iPv6Address=iPv6Address, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPv4Address=iPv4Address, telecomsChannelBStatus=telecomsChannelBStatus, installStatus=installStatus, notificationsGroup=notificationsGroup, rxColorCode=rxColorCode, transmitPower=transmitPower, regionCodeTrap=regionCodeTrap, supplementaryGroup=supplementaryGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, linkSymmetry=linkSymmetry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, wirelessLinkAvailability=wirelessLinkAvailability, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTable=iPDSCPPriorityTable, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelSelection=telecomsChannelSelection, pubStatsGroup=pubStatsGroup, targetMACAddress=targetMACAddress, sNTPState=sNTPState, byteErrorRatio=byteErrorRatio, installStatusTrap=installStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, channelALineCode=channelALineCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, masterSlaveMode=masterSlaveMode, securityLevel=securityLevel, sNTPServerStatus=sNTPServerStatus, sNTPServerTableEntry=sNTPServerTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkLoss=linkLoss, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, telecomGroup=telecomGroup, wirelessLinkStatus=wirelessLinkStatus, sNTPServerTimeout=sNTPServerTimeout, ptpTraps=ptpTraps, tDDControlGroup=tDDControlGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, range=range, transmitFreqMHz=transmitFreqMHz, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTable=l2CPPriorityTable, channelChangeTrap=channelChangeTrap, installArmStateTrap=installArmStateTrap, channelALoopbackTrap=channelALoopbackTrap, rawReceivePower=rawReceivePower, licence=licence, userName=userName, syslogClientTrap=syslogClientTrap, iPv6PrefixLength=iPv6PrefixLength, ptp600=ptp600, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementary=supplementary, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, hAZLOCConfiguration=hAZLOCConfiguration, dfsPeaks=dfsPeaks, remoteRxTargetPower=remoteRxTargetPower, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, transmitChannel=transmitChannel, snmpControlGroup=snmpControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortStatus=managementPortStatus, dataPortFiberStatus=dataPortFiberStatus, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementPortDisabledWarning=managementPortDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, frequencyVariant=frequencyVariant, targetRange=targetRange, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryptionGroup=encryptionGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receiveChannel=receiveChannel, vLANManagementVID=vLANManagementVID, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTable=sNTPServerTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, hTTPSPortNumber=hTTPSPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, channelBLoopback=channelBLoopback, productName=productName, receiveModulationMode=receiveModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, channelBCableLength=channelBCableLength, alarmsGroup=alarmsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTable=userTable, dfsTableNumber=dfsTableNumber, ptpCompliance=ptpCompliance, smtp=smtp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, installArmState=installArmState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bridge=bridge, iPVersion=iPVersion, automaticTxPowerControl=automaticTxPowerControl, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, versions=versions, iPv6GatewayAddress=iPv6GatewayAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aggregateDataRate=aggregateDataRate, ethernetBridgingAvailability=ethernetBridgingAvailability, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, timeZone=timeZone, hardwareVersion=hardwareVersion, ethernetBridgingStatus=ethernetBridgingStatus, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, telecomsChannelAStatus=telecomsChannelAStatus, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTable=ethernetPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALoopback=channelALoopback, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortStatusTrap=managementPortStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, eIRP=eIRP, ethernet=ethernet)
