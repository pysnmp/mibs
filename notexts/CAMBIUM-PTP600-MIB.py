...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, regionCodeTrap=regionCodeTrap, incompatibleRegionCodes=incompatibleRegionCodes, frequencyVariant=frequencyVariant, sNMPPortNumber=sNMPPortNumber, managementPortStatus=managementPortStatus, receiveChannel=receiveChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, securityLevel=securityLevel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkSymmetry=linkSymmetry, installStatus=installStatus, sMTPEnabledMessages=sMTPEnabledMessages, targetRange=targetRange, remoteInternetAddressType=remoteInternetAddressType, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteIPAddress=remoteIPAddress, hardwareVersion=hardwareVersion, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, vLANManagementPriority=vLANManagementPriority, dfsTableIndex=dfsTableIndex, dfsPeaks=dfsPeaks, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelSelection=telecomsChannelSelection, tDDControlGroup=tDDControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridgeGroup=bridgeGroup, phyControlGroup=phyControlGroup, channelBCableLength=channelBCableLength, signalStrengthRatio=signalStrengthRatio, dfs=dfs, linkModeOptimisation=linkModeOptimisation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTable=dfsTable, accessMethod=accessMethod, reset=reset, remoteInternetAddress=remoteInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, siteName=siteName, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelAStatus=telecomsChannelAStatus, aAAControl=aAAControl, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, rangingMode=rangingMode, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, automaticTxPowerControl=automaticTxPowerControl, ptpGroups=ptpGroups, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortStatusTrap=managementPortStatusTrap, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, channelALoopback=channelALoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControl=syslogControl, sNTPServerTableEntry=sNTPServerTableEntry, ptmp=ptmp, sNTPServerTimeout=sNTPServerTimeout, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBandwidth=channelBandwidth, management=management, dataPortAutoMdix=dataPortAutoMdix, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, versionsGroup=versionsGroup, cableLoss=cableLoss, sNTPServerRetries=sNTPServerRetries, configuration=configuration, supplementaryGroup=supplementaryGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, versions=versions, smtp=smtp, subnetMask=subnetMask, aAAControlGroup=aAAControlGroup, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, resetGroup=resetGroup, rxColorCode=rxColorCode, channelBLoopback=channelBLoopback, tFTPServerPortNumber=tFTPServerPortNumber, txColorCode=txColorCode, remoteRxTargetPower=remoteRxTargetPower, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, managementMode=managementMode, ethernet=ethernet, telecom=telecom, range=range, iPv6Address=iPv6Address, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userTableIndex=userTableIndex, ethernetGroup=ethernetGroup, pubStats=pubStats, userName=userName, receiveDataRate=receiveDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementary=supplementary, sNTPServerTable=sNTPServerTable, localPacketFiltering=localPacketFiltering, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, userTableEntry=userTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPState=sNTPState, ethernetBridgingStatus=ethernetBridgingStatus, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationMode=receiveModulationMode, syslogState=syslogState, ethernetPriorityTable=ethernetPriorityTable, transmitChannel=transmitChannel, transmitModulationMode=transmitModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, syslogClientTrap=syslogClientTrap, dSCPManagementPriority=dSCPManagementPriority, encryption=encryption, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userPassword=userPassword, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, searchState=searchState, channelBLineCode=channelBLineCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitFreqMHz=transmitFreqMHz, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, hTTPAccessEnabled=hTTPAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerStatus=sNTPServerStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsMeans=dfsMeans, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, cambium=cambium, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTable=l2CPPriorityTable, bootVersion=bootVersion, tDDControl=tDDControl, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, snmpControl=snmpControl, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortDisabledWarning=managementPortDisabledWarning, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sntp=sntp, systemClock=systemClock, smtpGroup=smtpGroup, telecomGroup=telecomGroup, productVariant=productVariant, timeZone=timeZone, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortStatus=dataPortStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, channelALoopbackTrap=channelALoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntpGroup=sntpGroup, syslogClient=syslogClient, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, longitude=longitude, ptpCompliance=ptpCompliance, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomsInterface=telecomsInterface, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, sNTPServerTableNumber=sNTPServerTableNumber, channelChangeTrap=channelChangeTrap, eIRP=eIRP, licence=licence)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, altitude=altitude, secureModeAlarm=secureModeAlarm, vLANManagementVID=vLANManagementVID, sNMPTrapPortNumber=sNMPTrapPortNumber, channelALineCode=channelALineCode, rawReceivePower=rawReceivePower, secureModeAlarmTrap=secureModeAlarmTrap, iPVersion=iPVersion, encryptionGroup=encryptionGroup, productName=productName, sNMPTrapInternetAddress=sNMPTrapInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, transmitDataRate=transmitDataRate, receiveFreqKHz=receiveFreqKHz, configurationGroup=configurationGroup, ptp=ptp, alarms=alarms, channelACableLength=channelACableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, iPv4Address=iPv4Address, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp600=ptp600, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning)
