...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelBandwidth=channelBandwidth, subnetMask=subnetMask, pubStats=pubStats, useVLANForManagementInterfaces=useVLANForManagementInterfaces, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTimeout=sNTPServerTimeout, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNTPLastSync=sNTPLastSync, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, channelALineCode=channelALineCode, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, localPacketFiltering=localPacketFiltering, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, userTableNumber=userTableNumber, remoteRxTargetPower=remoteRxTargetPower, altitude=altitude, dataPortFiberStatus=dataPortFiberStatus, userTableEntry=userTableEntry, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, rangingMode=rangingMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup, automaticTxPowerControl=automaticTxPowerControl, dataPortStatusTrap=dataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControl=tDDControl, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControl=syslogControl, hTTPAccessEnabled=hTTPAccessEnabled, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, management=management, configurationGroup=configurationGroup, linkSymmetry=linkSymmetry, transmitDataRate=transmitDataRate, userPassword=userPassword, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bridgeGroup=bridgeGroup, linkName=linkName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ptmp=ptmp, accessMethod=accessMethod, dSCPManagementPriority=dSCPManagementPriority, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptp600=ptp600, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelBStatus=telecomsChannelBStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, targetRange=targetRange, configuration=configuration, sNTPServerTableNumber=sNTPServerTableNumber, dataPortAutoMdix=dataPortAutoMdix, rawReceivePower=rawReceivePower, sNTPSync=sNTPSync, receiveFreqKHz=receiveFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTableIndex=sNTPServerTableIndex, userRole=userRole, channelChangeTrap=channelChangeTrap, managementPortStatusTrap=managementPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6Address=iPv6Address, supplementary=supplementary, telecomGroup=telecomGroup, channelALoopback=channelALoopback, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, iPVersion=iPVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteIPAddress=remoteIPAddress, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServer=sNTPPrimaryServer, receivePower=receivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBCableLength=channelBCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, longitude=longitude, wirelessLinkStatus=wirelessLinkStatus, syslogStateTrap=syslogStateTrap, targetMACAddress=targetMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, managementPortConfigurationMismatch=managementPortConfigurationMismatch, snmpControl=snmpControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, range=range, tDDControlGroup=tDDControlGroup, systemClock=systemClock, hardwareVersion=hardwareVersion, qOSPriorityScheme=qOSPriorityScheme, pubStatsGroup=pubStatsGroup, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, byteErrorRatio=byteErrorRatio, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementMode=managementMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelACableLength=channelACableLength, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, tDDSynchronizationMode=tDDSynchronizationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, channelBLoopbackTrap=channelBLoopbackTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControlGroup=snmpControlGroup, licence=licence, hAZLOCConfiguration=hAZLOCConfiguration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userName=userName, ptpTraps=ptpTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfs=dfs, bridge=bridge, licenceGroup=licenceGroup, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rxColorCode=rxColorCode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCodeTrap=regionCodeTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTable=l2CPPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, phyControl=phyControl, sNTPServerRetries=sNTPServerRetries, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, versionsGroup=versionsGroup, secureModeAlarm=secureModeAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, regionCode=regionCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfsPeaks=dfsPeaks, groupID=groupID, channelBLoopback=channelBLoopback, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, hTTPPortNumber=hTTPPortNumber, remoteInternetAddressType=remoteInternetAddressType, ptpGroups=ptpGroups, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, syslogClientTrap=syslogClientTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTable=dfsTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, sntp=sntp, aAAControl=aAAControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyStatusGroup=phyStatusGroup, linkModeOptimisation=linkModeOptimisation, linkLoss=linkLoss, sNTPServerStatus=sNTPServerStatus, secondarySoftwareVersion=secondarySoftwareVersion, latitude=latitude, managementPortStatus=managementPortStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatus=phyStatus, receiveDataRate=receiveDataRate, sNTPServerTable=sNTPServerTable, sNTPServerIPAddress=sNTPServerIPAddress, PYSNMP_MODULE_ID=cambium, channelBLineCode=channelBLineCode, telecomsChannelSelection=telecomsChannelSelection, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, ethernetBridgingStatus=ethernetBridgingStatus, sNTPPollInterval=sNTPPollInterval, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, dfsTableNumber=dfsTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bootVersion=bootVersion, userTableIndex=userTableIndex, installArmState=installArmState, channelALoopbackTrap=channelALoopbackTrap, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, syslogClient=syslogClient, sNMPCommunityString=sNMPCommunityString, telecom=telecom, syslogControlGroup=syslogControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, supplementaryGroup=supplementaryGroup, vectorError=vectorError, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, sNTPServerTableEntry=sNTPServerTableEntry, eIRP=eIRP, securityLevel=securityLevel, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatus=dataPortStatus, encryption=encryption, dfsMeans=dfsMeans, ethernetPriorityTable=ethernetPriorityTable, ethernet=ethernet, dfsGroup=dfsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv4Address=iPv4Address, remoteInternetAddress=remoteInternetAddress, txColorCode=txColorCode, installArmStateTrap=installArmStateTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, cambium=cambium)
