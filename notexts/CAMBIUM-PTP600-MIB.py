...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveModulationModeDetail=receiveModulationModeDetail, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteRxTargetPower=remoteRxTargetPower, channelBLoopbackTrap=channelBLoopbackTrap, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLineCode=channelBLineCode, channelACableLength=channelACableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, linkSymmetry=linkSymmetry, regionCode=regionCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, longitude=longitude, ptp=ptp, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTable=l2CPPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, managementMode=managementMode, bridgeGroup=bridgeGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetPortNumber=telnetPortNumber, versions=versions, transmitDataRate=transmitDataRate, latitude=latitude, altitude=altitude, dataPortStatus=dataPortStatus, channelALoopbackTrap=channelALoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, configuration=configuration, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, channelBLoopback=channelBLoopback, dfsTableIndex=dfsTableIndex, productName=productName, secureModeAlarm=secureModeAlarm, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogControlGroup=syslogControlGroup, dSCPManagementPriority=dSCPManagementPriority, linkLoss=linkLoss, cambium=cambium, telecomsInterface=telecomsInterface, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, iPv6Address=iPv6Address, telecomsChannelBStatus=telecomsChannelBStatus, managementPortStatus=managementPortStatus, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernet=ethernet, tDDControl=tDDControl, ptpTraps=ptpTraps, management=management, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, iPv4Address=iPv4Address, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, rawReceivePower=rawReceivePower, bridge=bridge, iPv6GatewayAddress=iPv6GatewayAddress, telecom=telecom, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementVID=vLANManagementVID, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rangingMode=rangingMode, sNTPSync=sNTPSync, ethernetBridgingAvailability=ethernetBridgingAvailability, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, searchState=searchState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, reset=reset, alarmsGroup=alarmsGroup, telecomGroup=telecomGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPv3Enable=sNMPv3Enable, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, channelBCableLength=channelBCableLength, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, rxColorCode=rxColorCode, dfs=dfs, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, automaticTxPowerControl=automaticTxPowerControl, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, range=range, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, txColorCode=txColorCode, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, channelChangeTrap=channelChangeTrap, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, managementPortDisabledWarning=managementPortDisabledWarning, userTableIndex=userTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, vectorError=vectorError, sNTPLastSync=sNTPLastSync, systemReset=systemReset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingStatus=ethernetBridgingStatus, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortFiberStatus=dataPortFiberStatus, encryptionGroup=encryptionGroup, accessMethod=accessMethod, telecomsChannelAStatus=telecomsChannelAStatus, channelALoopback=channelALoopback, transmitPower=transmitPower, sNTPServerInternetAddress=sNTPServerInternetAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveChannel=receiveChannel, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, linkName=linkName, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, iPVersion=iPVersion, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, hTTPAccessEnabled=hTTPAccessEnabled, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, systemClock=systemClock, syslogControl=syslogControl, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, userName=userName, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, sNTPServerStatus=sNTPServerStatus, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, signalStrengthRatio=signalStrengthRatio, ethernetPriorityTableIndex=ethernetPriorityTableIndex, telecomsChannelSelection=telecomsChannelSelection, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTimeout=sNTPServerTimeout, sMTPServerPortNumber=sMTPServerPortNumber, hAZLOCConfiguration=hAZLOCConfiguration, remoteIPAddress=remoteIPAddress, remoteInternetAddress=remoteInternetAddress, securityLevel=securityLevel, installStatusTrap=installStatusTrap, targetRange=targetRange, sNTPServerTable=sNTPServerTable, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, pubStats=pubStats, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licence=licence, syslogClient=syslogClient, channelALineCode=channelALineCode, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, ptp600=ptp600, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControlGroup=aAAControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, userTable=userTable, antennaGain=antennaGain, receiveModulationMode=receiveModulationMode, dataPortAutoMdix=dataPortAutoMdix, aggregateDataRate=aggregateDataRate, encryption=encryption, snmpControl=snmpControl, sNTPServerRetries=sNTPServerRetries, targetMACAddress=targetMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, eIRP=eIRP)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, transmitChannel=transmitChannel, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, channelBandwidth=channelBandwidth, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, dfsMeans=dfsMeans, sNMPTrapInternetAddress=sNMPTrapInternetAddress, subnetMask=subnetMask, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptmp=ptmp, syslogState=syslogState, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, dfsGroup=dfsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPSyncTrap=sNTPSyncTrap, groupID=groupID, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTable=mPLSTCPriorityTable, daylightSaving=daylightSaving, userTableEntry=userTableEntry, receivePower=receivePower)
