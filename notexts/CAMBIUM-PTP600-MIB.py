...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, vectorError=vectorError, managementPortDisabledWarning=managementPortDisabledWarning, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, linkLoss=linkLoss, iPv6PrefixLength=iPv6PrefixLength, phyStatus=phyStatus, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelSelection=telecomsChannelSelection, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTableIndex=sNTPServerTableIndex, bootVersion=bootVersion, dSCPManagementPriority=dSCPManagementPriority, iPv4Address=iPv4Address, dataPortAutoNegotiation=dataPortAutoNegotiation, hardwareVersion=hardwareVersion, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, phyControl=phyControl, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, smtpGroup=smtpGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, qOSPriorityScheme=qOSPriorityScheme, remoteInternetAddress=remoteInternetAddress, sNTPServerRetries=sNTPServerRetries, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomGroup=telecomGroup, vLANManagementVID=vLANManagementVID, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, userTableNumber=userTableNumber, dfsGroup=dfsGroup, phyControlGroup=phyControlGroup, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, tFTPServerIPAddress=tFTPServerIPAddress, aAAControl=aAAControl, syslogClientTrap=syslogClientTrap, sNTPServerStatus=sNTPServerStatus, sNTPState=sNTPState, licenceGroup=licenceGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, smtp=smtp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, masterSlaveMode=masterSlaveMode, telecomsChannelBStatus=telecomsChannelBStatus, linkSymmetry=linkSymmetry, managementPortStatusTrap=managementPortStatusTrap, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelChangeTrap=channelChangeTrap, regionCode=regionCode, userPassword=userPassword, receiveModulationMode=receiveModulationMode, channelBCableLength=channelBCableLength, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPPollInterval=sNTPPollInterval, hAZLOCConfiguration=hAZLOCConfiguration, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, txColorCode=txColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, installArmState=installArmState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, resetGroup=resetGroup, supplementary=supplementary, wirelessLinkAvailability=wirelessLinkAvailability, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, channelBandwidth=channelBandwidth, managementPortStatus=managementPortStatus, channelBLineCode=channelBLineCode, reset=reset, PYSNMP_MODULE_ID=cambium, configuration=configuration, sNTPServerTable=sNTPServerTable, regionCodeTrap=regionCodeTrap, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkStatus=wirelessLinkStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTable=dfsTable, iPVersion=iPVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sMTPServerIPAddress=sMTPServerIPAddress, daylightSaving=daylightSaving, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteInternetAddressType=remoteInternetAddressType, tDDControl=tDDControl, siteName=siteName, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, automaticTxPowerControl=automaticTxPowerControl, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarms=alarms, productName=productName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, channelBLoopbackTrap=channelBLoopbackTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelALoopbackTrap=channelALoopbackTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureModeAlarm=secureModeAlarm, sNTPServerPortNumber=sNTPServerPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, licence=licence, channelBLoopback=channelBLoopback, eIRP=eIRP, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, receivePower=receivePower, sNTPLastSync=sNTPLastSync, pubStatsGroup=pubStatsGroup, dfsTableIndex=dfsTableIndex, sntp=sntp, dfs=dfs, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptp=ptp, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, localPacketFiltering=localPacketFiltering, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTable=ethernetPriorityTable, ethernet=ethernet, cambium=cambium, transmitChannel=transmitChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, userRole=userRole, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, frequencyVariant=frequencyVariant, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, ptp600=ptp600, dfsPeaks=dfsPeaks, remoteRxTargetPower=remoteRxTargetPower, signalStrengthRatio=signalStrengthRatio, sMTPEnabledMessages=sMTPEnabledMessages, securityLevel=securityLevel, sNTPServerTableEntry=sNTPServerTableEntry, iPv6Address=iPv6Address, syslogState=syslogState, syslogStateTrap=syslogStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, managementGroup=managementGroup, managementMode=managementMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, cableLoss=cableLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementaryGroup=supplementaryGroup, channelALineCode=channelALineCode, channelACableLength=channelACableLength, range=range, channelALoopback=channelALoopback, sNTPServerTimeout=sNTPServerTimeout, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, systemClock=systemClock, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, transmitPower=transmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelAStatus=telecomsChannelAStatus, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPSync=sNTPSync, ptmp=ptmp, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarmsGroup=alarmsGroup, userTable=userTable, vLANManagementPriority=vLANManagementPriority, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, rawReceivePower=rawReceivePower, receiveChannel=receiveChannel, userTableEntry=userTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sntpGroup=sntpGroup, rxColorCode=rxColorCode, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, telecom=telecom, sNMPTrapTable=sNMPTrapTable)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", l2CPPriorityTable=l2CPPriorityTable, iPv6GatewayAddress=iPv6GatewayAddress, notificationsGroup=notificationsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hTTPPortNumber=hTTPPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogControl=syslogControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, latitude=latitude, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, altitude=altitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, systemReset=systemReset, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, searchState=searchState, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersion=softwareVersion, bridge=bridge, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, linkModeOptimisation=linkModeOptimisation, targetRange=targetRange, phyStatusGroup=phyStatusGroup)
