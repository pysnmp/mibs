...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPState=sNTPState, ptpTrapPrefix=ptpTrapPrefix, receiveModulationModeDetail=receiveModulationModeDetail, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, aggregateDataRate=aggregateDataRate, telecomsChannelAStatus=telecomsChannelAStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productVariant=productVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, sntp=sntp, transmitFreqKHz=transmitFreqKHz, sntpGroup=sntpGroup, channelBLoopback=channelBLoopback, sNTPServerTableNumber=sNTPServerTableNumber, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, dfsGroup=dfsGroup, groupID=groupID, receiveFreqKHz=receiveFreqKHz, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp600=ptp600, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitDataRate=transmitDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, l2CPPriorityTable=l2CPPriorityTable, masterSlaveMode=masterSlaveMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, userTableNumber=userTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, channelBCableLength=channelBCableLength, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSyncTrap=sNTPSyncTrap, tDDControlGroup=tDDControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, daylightSaving=daylightSaving, managementGroup=managementGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTable=sNMPTrapTable, hAZLOCConfiguration=hAZLOCConfiguration, supplementary=supplementary, mPLSTCPriorityTable=mPLSTCPriorityTable, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, latitude=latitude, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, siteName=siteName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerInternetAddress=tFTPServerInternetAddress, automaticTxPowerControl=automaticTxPowerControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp=ptp, iPVersion=iPVersion, bridgeGroup=bridgeGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelBStatus=telecomsChannelBStatus, receiveModulationMode=receiveModulationMode, range=range, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationMode=tDDSynchronizationMode, localPacketFiltering=localPacketFiltering, userTableIndex=userTableIndex, encryption=encryption, managementMode=managementMode, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, channelACableLength=channelACableLength, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, vectorError=vectorError, systemReset=systemReset, syslogClient=syslogClient, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControlGroup=snmpControlGroup, hardwareVersion=hardwareVersion, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementVID=vLANManagementVID, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenceGroup=licenceGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, longitude=longitude, phyControlGroup=phyControlGroup, aAAControl=aAAControl, secureModeAlarmTrap=secureModeAlarmTrap, receiveChannel=receiveChannel, snmpControl=snmpControl, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, ethernetPriorityTableNumber=ethernetPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, txColorCode=txColorCode, transmitModulationMode=transmitModulationMode, syslogState=syslogState, transmitChannel=transmitChannel, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatus=dataPortFiberStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogControl=syslogControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, securityLevel=securityLevel, qOSPriorityScheme=qOSPriorityScheme, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receivePower=receivePower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, sNTPServerTable=sNTPServerTable, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, ethernetBridgingStatus=ethernetBridgingStatus, rangingMode=rangingMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rxColorCode=rxColorCode, ethernet=ethernet, encryptionAlgorithm=encryptionAlgorithm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteInternetAddress=remoteInternetAddress, sNTPSync=sNTPSync, managementPortStatusTrap=managementPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, dataPortStatus=dataPortStatus, channelALineCode=channelALineCode, gatewayIPAddress=gatewayIPAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsTableIndex=dfsTableIndex, installArmState=installArmState, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installStatusTrap=installStatusTrap, channelALoopback=channelALoopback, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, management=management, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableIndex=ethernetPriorityTableIndex, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, userTableEntry=userTableEntry, userName=userName, systemClock=systemClock, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, targetRange=targetRange, alarms=alarms, sNTPServerTableEntry=sNTPServerTableEntry, phyStatusGroup=phyStatusGroup, secureModeAlarm=secureModeAlarm, channelALoopbackTrap=channelALoopbackTrap, cambium=cambium, dfsTable=dfsTable, iPv6Address=iPv6Address, smtpGroup=smtpGroup, subnetMask=subnetMask, versionsGroup=versionsGroup, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, notificationsGroup=notificationsGroup, bridge=bridge, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, smtp=smtp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, ethernetPriorityTable=ethernetPriorityTable, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpCompliance=ptpCompliance, eIRP=eIRP, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogStateTrap=syslogStateTrap, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, encryptionGroup=encryptionGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptmp=ptmp, searchState=searchState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, telecom=telecom, dataPortAutoNegotiation=dataPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", PYSNMP_MODULE_ID=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTable=userTable, iPv4Address=iPv4Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, sNTPServerStatus=sNTPServerStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, resetGroup=resetGroup, userRole=userRole, softwareVersion=softwareVersion, altitude=altitude, pubStats=pubStats, sNTPServerRetries=sNTPServerRetries, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControl=tDDControl, remoteInternetAddressType=remoteInternetAddressType, channelBLineCode=channelBLineCode, regionCodeTrap=regionCodeTrap, managementPortStatus=managementPortStatus, sNMPTrapVersion=sNMPTrapVersion, licence=licence, rawReceivePower=rawReceivePower, userPassword=userPassword, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkSymmetry=linkSymmetry, channelChangeTrap=channelChangeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBLoopbackTrap=channelBLoopbackTrap, bootVersion=bootVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, supplementaryGroup=supplementaryGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitPower=transmitPower, alarmsGroup=alarmsGroup)
