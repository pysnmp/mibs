...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bandwidthVariant=bandwidthVariant, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, daylightSaving=daylightSaving, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, aggregateDataRate=aggregateDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telecomsChannelAStatus=telecomsChannelAStatus, bridge=bridge, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementary=supplementary, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelALoopback=channelALoopback, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secureModeAlarm=secureModeAlarm, transmitDataRate=transmitDataRate, reset=reset, dataPortStatus=dataPortStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptp=ptp, sNTPPollInterval=sNTPPollInterval, tDDControl=tDDControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, versionsGroup=versionsGroup, installArmState=installArmState, remoteRxTargetPower=remoteRxTargetPower, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableNumber=sNTPServerTableNumber, gatewayIPAddress=gatewayIPAddress, channelChangeTrap=channelChangeTrap, sMTPServerPortNumber=sMTPServerPortNumber, systemClock=systemClock, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, groupID=groupID, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, phyControl=phyControl, sNTPServerTable=sNTPServerTable, incompatibleRegionCodes=incompatibleRegionCodes, management=management, masterSlaveMode=masterSlaveMode, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, channelBLoopbackTrap=channelBLoopbackTrap, channelBLineCode=channelBLineCode, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatusTrap=installStatusTrap, targetRange=targetRange, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cambium=cambium, range=range, telecomGroup=telecomGroup, snmpControlGroup=snmpControlGroup, ethernet=ethernet, pubStatsGroup=pubStatsGroup, PYSNMP_MODULE_ID=cambium, longitude=longitude, signalStrengthRatio=signalStrengthRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsGroup=dfsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqKHz=receiveFreqKHz, productName=productName, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortDisabledWarning=dataPortDisabledWarning, receiveChannel=receiveChannel, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, rangingMode=rangingMode, vectorError=vectorError, sntpGroup=sntpGroup, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementPriority=vLANManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, subnetMask=subnetMask, userTable=userTable, telecomsChannelSelection=telecomsChannelSelection, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, syslogClientTrap=syslogClientTrap, channelBandwidth=channelBandwidth, sNTPServerStatus=sNTPServerStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, rawReceivePower=rawReceivePower, sNTPPrimaryServer=sNTPPrimaryServer, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelBStatus=telecomsChannelBStatus, supplementaryGroup=supplementaryGroup, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitChannel=transmitChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp600=ptp600, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapVersion=sNMPTrapVersion, userName=userName, automaticTxPowerControl=automaticTxPowerControl, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, alarmsGroup=alarmsGroup, cableLoss=cableLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, channelALoopbackTrap=channelALoopbackTrap, eIRP=eIRP, linkLoss=linkLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityTable=mPLSTCPriorityTable, snmpControl=snmpControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, timeZone=timeZone, accessMethod=accessMethod, iPv6PrefixLength=iPv6PrefixLength, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, sNMPTrapTableIndex=sNMPTrapTableIndex, dSCPManagementPriority=dSCPManagementPriority, encryption=encryption, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, transmitFreqKHz=transmitFreqKHz, dataPortFiberStatus=dataPortFiberStatus, sNTPLastSync=sNTPLastSync, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userPassword=userPassword, iPv4Address=iPv4Address, managementPortDisabledWarning=managementPortDisabledWarning, dfsTableEntry=dfsTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, sNTPServerInternetAddress=sNTPServerInternetAddress, channelBCableLength=channelBCableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelBLoopback=channelBLoopback, alarms=alarms, sNMPTrapTable=sNMPTrapTable, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, secureModeAlarmTrap=secureModeAlarmTrap, softwareVersion=softwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, dfsMeans=dfsMeans, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, qOSPriorityScheme=qOSPriorityScheme, channelACableLength=channelACableLength, receivePower=receivePower, managementPortStatusTrap=managementPortStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, frequencyVariant=frequencyVariant, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkName=linkName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, latitude=latitude, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteInternetAddressType=remoteInternetAddressType, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSPortNumber=hTTPSPortNumber, rxColorCode=rxColorCode, transmitPower=transmitPower, dfsTable=dfsTable, versions=versions, ethernetPriorityTableEntry=ethernetPriorityTableEntry, configuration=configuration, iPVersion=iPVersion, linkModeOptimisation=linkModeOptimisation, syslogControlGroup=syslogControlGroup, encryptionGroup=encryptionGroup, userTableNumber=userTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, sntp=sntp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, byteErrorRatio=byteErrorRatio, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, managementPortStatus=managementPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, productVariant=productVariant, managementGroup=managementGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogStateTrap=syslogStateTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelALineCode=channelALineCode, smtp=smtp, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, regionCode=regionCode, hAZLOCConfiguration=hAZLOCConfiguration, sNMPEnabledTraps=sNMPEnabledTraps, managementMode=managementMode, sMTPEmailAlert=sMTPEmailAlert, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetPortNumber=telnetPortNumber, sNTPServerRetries=sNTPServerRetries, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userTableEntry=userTableEntry, remoteInternetAddress=remoteInternetAddress, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTable=iPDSCPPriorityTable, dfs=dfs, transmitModulationMode=transmitModulationMode, transmitFreqMHz=transmitFreqMHz, remoteIPAddress=remoteIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regionCodeTrap=regionCodeTrap, l2CPPriorityTable=l2CPPriorityTable, hTTPPortNumber=hTTPPortNumber, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, iPv6Address=iPv6Address, configurationGroup=configurationGroup, ptmp=ptmp, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, tFTPServerInternetAddressType=tFTPServerInternetAddressType, securityLevel=securityLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
