...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, sNTPServerTableIndex=sNTPServerTableIndex, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTrapPrefix=ptpTrapPrefix, syslogStateTrap=syslogStateTrap, l2CPPriorityTable=l2CPPriorityTable, dfsTableNumber=dfsTableNumber, telecomsChannelSelection=telecomsChannelSelection, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, syslogState=syslogState, installStatus=installStatus, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, transmitModulationMode=transmitModulationMode, smtp=smtp, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveModulationModeDetail=receiveModulationModeDetail, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatusTrap=managementPortStatusTrap, rxColorCode=rxColorCode, receivePower=receivePower, receiveChannel=receiveChannel, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, masterSlaveMode=masterSlaveMode, latitude=latitude, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, linkName=linkName, sMTPEmailAlert=sMTPEmailAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControl=aAAControl, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, altitude=altitude, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, iPv6Address=iPv6Address, managementPortStatus=managementPortStatus, ptmp=ptmp, targetRange=targetRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControl=phyControl, hAZLOCConfiguration=hAZLOCConfiguration, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelAStatus=telecomsChannelAStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, managementGroup=managementGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, userRole=userRole, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configurationGroup=configurationGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, localPacketFiltering=localPacketFiltering, cambium=cambium, installArmState=installArmState, telecom=telecom, longitude=longitude, rangingMode=rangingMode, incompatibleRegionCodes=incompatibleRegionCodes, iPv4Address=iPv4Address, alarmsGroup=alarmsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, ptp600=ptp600, telecomGroup=telecomGroup, iPv6PrefixLength=iPv6PrefixLength, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerStatus=sNTPServerStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, licence=licence, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, bridge=bridge, constantPowerSpectralDensity=constantPowerSpectralDensity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, ptp=ptp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, versionsGroup=versionsGroup, accessMethod=accessMethod, wirelessLinkAvailability=wirelessLinkAvailability, phyControlGroup=phyControlGroup, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTimeout=sNTPServerTimeout, bridgeGroup=bridgeGroup, resetGroup=resetGroup, iPVersion=iPVersion, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, remoteInternetAddress=remoteInternetAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTable=sNTPServerTable, snmpControlGroup=snmpControlGroup, configuration=configuration, regionCodeTrap=regionCodeTrap, userTableEntry=userTableEntry, syslogClientTrap=syslogClientTrap, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, supplementary=supplementary, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, channelBLineCode=channelBLineCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, daylightSaving=daylightSaving, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, alarms=alarms, cableLoss=cableLoss, dSCPManagementPriority=dSCPManagementPriority, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerTableNumber=sNTPServerTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelACableLength=channelACableLength, channelALoopbackTrap=channelALoopbackTrap, timeZone=timeZone, txColorCode=txColorCode, receiveDataRate=receiveDataRate, transmitChannel=transmitChannel, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemReset=systemReset, channelBandwidth=channelBandwidth, channelChangeTrap=channelChangeTrap, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, secondarySoftwareVersion=secondarySoftwareVersion, installArmStateTrap=installArmStateTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, smtpGroup=smtpGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLoopback=channelBLoopback, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, channelALineCode=channelALineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelALoopback=channelALoopback, securityLevel=securityLevel, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, qOSPriorityScheme=qOSPriorityScheme, aggregateDataRate=aggregateDataRate, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, encryptionAlgorithm=encryptionAlgorithm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ptpTraps=ptpTraps, managementMode=managementMode, searchState=searchState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, siteName=siteName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, snmpControl=snmpControl, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, channelBCableLength=channelBCableLength, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productVariant=productVariant, userTableNumber=userTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, management=management, userTableIndex=userTableIndex, ptpCompliance=ptpCompliance, frequencyVariant=frequencyVariant, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, secureModeAlarm=secureModeAlarm, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, ethernet=ethernet, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDDControl=tDDControl)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsInterface=telecomsInterface, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, sMTPServerPortNumber=sMTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, ethernetBridgingStatus=ethernetBridgingStatus, softwareVersion=softwareVersion, dataPortStatus=dataPortStatus, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, userTable=userTable, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, pubStats=pubStats, channelBLoopbackTrap=channelBLoopbackTrap, remoteRxTargetPower=remoteRxTargetPower, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, sntp=sntp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, rawReceivePower=rawReceivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortFiberStatus=dataPortFiberStatus, managementPortDisabledWarning=managementPortDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsPeaks=dfsPeaks, supplementaryGroup=supplementaryGroup, syslogClient=syslogClient, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPState=sNTPState, antennaGain=antennaGain)
