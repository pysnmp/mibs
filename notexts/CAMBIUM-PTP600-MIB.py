...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:04:37 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelBLoopbackTrap=channelBLoopbackTrap, telecom=telecom, remoteRxTargetPower=remoteRxTargetPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitFreqKHz=transmitFreqKHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, ptp600=ptp600, ptpCompliance=ptpCompliance, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteInternetAddress=remoteInternetAddress, sNTPServerStatus=sNTPServerStatus, groupID=groupID, iPv4Address=iPv4Address, sNTPServerInternetAddress=sNTPServerInternetAddress, byteErrorRatio=byteErrorRatio, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, altitude=altitude, telecomsChannelSelection=telecomsChannelSelection, secureModeAlarm=secureModeAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetBridgingStatus=ethernetBridgingStatus, rxColorCode=rxColorCode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, vectorError=vectorError, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, smtp=smtp, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, rangingMode=rangingMode, targetRange=targetRange, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableEntry=dfsTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBLoopback=channelBLoopback, searchState=searchState, dfs=dfs, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, remoteInternetAddressType=remoteInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelALineCode=channelALineCode, wirelessLinkAvailability=wirelessLinkAvailability, txColorCode=txColorCode, ptpGroups=ptpGroups, systemClock=systemClock, vLANManagementVID=vLANManagementVID, channelALoopback=channelALoopback, automaticTxPowerControl=automaticTxPowerControl, licence=licence, receivePower=receivePower, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, installArmStateTrap=installArmStateTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, cableLoss=cableLoss, managementGroup=managementGroup, userTableNumber=userTableNumber, channelACableLength=channelACableLength, hTTPSPortNumber=hTTPSPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, phyStatusGroup=phyStatusGroup, targetMACAddress=targetMACAddress, smtpGroup=smtpGroup, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, receiveModulationModeDetail=receiveModulationModeDetail, maximumTransmitPower=maximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingAvailability=ethernetBridgingAvailability, channelALoopbackTrap=channelALoopbackTrap, installStatusTrap=installStatusTrap, sNTPServerTable=sNTPServerTable, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, phyStatus=phyStatus, range=range, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveDataRate=receiveDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, managementPortDisabledWarning=managementPortDisabledWarning, ptp=ptp, channelBLineCode=channelBLineCode, vLANManagementPriority=vLANManagementPriority, dfsGroup=dfsGroup, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailable=noWirelessChannelAvailable, frequencyVariant=frequencyVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, iPDSCPPriorityTable=iPDSCPPriorityTable, aAAControlGroup=aAAControlGroup, sNMPPortNumber=sNMPPortNumber, rawReceivePower=rawReceivePower, userTableIndex=userTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, reset=reset, transmitChannel=transmitChannel, receiveFreqKHz=receiveFreqKHz, snmpControl=snmpControl, telnetPortNumber=telnetPortNumber, dfsTable=dfsTable, syslogControl=syslogControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, userPassword=userPassword, receiveModulationMode=receiveModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpTrapPrefix=ptpTrapPrefix, dSCPManagementPriority=dSCPManagementPriority, longitude=longitude, alarmsGroup=alarmsGroup, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, systemReset=systemReset, latitude=latitude, bridgeGroup=bridgeGroup, ptpTraps=ptpTraps, iPv6Address=iPv6Address, tDDControl=tDDControl, licenceGroup=licenceGroup, versions=versions, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, ptmp=ptmp, telecomsChannelAStatus=telecomsChannelAStatus, channelBCableLength=channelBCableLength, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secureModeAlarmTrap=secureModeAlarmTrap, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6GatewayAddress=iPv6GatewayAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, syslogStateTrap=syslogStateTrap, pubStats=pubStats, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqMHz=receiveFreqMHz, tDDControlGroup=tDDControlGroup, siteName=siteName, installArmState=installArmState, dataPortFiberStatus=dataPortFiberStatus, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsPeaks=dfsPeaks, transmitPower=transmitPower, aAAControl=aAAControl, cambium=cambium, daylightSaving=daylightSaving, bootVersion=bootVersion, unitOutOfCalibration=unitOutOfCalibration, managementMode=managementMode, securityLevel=securityLevel, ethernet=ethernet, l2CPPriorityTable=l2CPPriorityTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPSync=sNTPSync, eIRP=eIRP, sNTPState=sNTPState, transmitModulationMode=transmitModulationMode, ethernetFiberSupport=ethernetFiberSupport, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, accessMethod=accessMethod, sNTPServerTableIndex=sNTPServerTableIndex, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productName=productName, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, PYSNMP_MODULE_ID=cambium, localPacketFiltering=localPacketFiltering, receiveChannel=receiveChannel, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, softwareVersion=softwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hardwareVersion=hardwareVersion, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, hAZLOCConfiguration=hAZLOCConfiguration, telecomGroup=telecomGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitDataRate=transmitDataRate, management=management)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryption=encryption, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bridge=bridge, incompatibleRegionCodes=incompatibleRegionCodes, iPVersion=iPVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, userTable=userTable, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, alarms=alarms, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, supplementary=supplementary, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, userRole=userRole, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortStatusTrap=dataPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkName=linkName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableNumber=sNTPServerTableNumber, telecomsInterface=telecomsInterface, sNTPSyncTrap=sNTPSyncTrap, timeZone=timeZone, hTTPSAccessEnabled=hTTPSAccessEnabled, userName=userName, supplementaryGroup=supplementaryGroup, managementPortStatusTrap=managementPortStatusTrap, productVariant=productVariant, remoteIPAddress=remoteIPAddress, syslogState=syslogState, configurationGroup=configurationGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTable=ethernetPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogClientTrap=syslogClientTrap, linkModeOptimisation=linkModeOptimisation)
