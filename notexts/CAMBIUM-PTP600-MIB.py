...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, remoteInternetAddressType=remoteInternetAddressType, dfsTableNumber=dfsTableNumber, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetGroup=ethernetGroup, dfsMeans=dfsMeans, licenceGroup=licenceGroup, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatio=byteErrorRatio, snmpControl=snmpControl, receiveModulationModeDetail=receiveModulationModeDetail, latitude=latitude, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, ptp600=ptp600, channelBLineCode=channelBLineCode, channelALoopback=channelALoopback, sNTPSync=sNTPSync, channelChangeTrap=channelChangeTrap, securityLevel=securityLevel, alarms=alarms, aAAControl=aAAControl, smtpGroup=smtpGroup, managementMode=managementMode, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, receivePower=receivePower, siteName=siteName, regionCode=regionCode, transmitModulationMode=transmitModulationMode, installStatus=installStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userTableIndex=userTableIndex, antennaGain=antennaGain, ptpGroups=ptpGroups, iPv4Address=iPv4Address, secureModeAlarm=secureModeAlarm, channelACableLength=channelACableLength, ethernetBridgingAvailability=ethernetBridgingAvailability, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerRetries=sNTPServerRetries, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkLoss=linkLoss, bridgeGroup=bridgeGroup, syslogControlGroup=syslogControlGroup, dfsTable=dfsTable, dataPortStatus=dataPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelALineCode=channelALineCode, channelALoopbackTrap=channelALoopbackTrap, txColorCode=txColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSyncTrap=sNTPSyncTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementGroup=managementGroup, ptpTraps=ptpTraps, receiveFreqMHz=receiveFreqMHz, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, automaticTxPowerControl=automaticTxPowerControl, resetGroup=resetGroup, encryptionGroup=encryptionGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, sNTPState=sNTPState, regionCodeTrap=regionCodeTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptmp=ptmp, hAZLOCConfiguration=hAZLOCConfiguration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, configuration=configuration, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelBStatus=telecomsChannelBStatus, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapTable=sNMPTrapTable, sntp=sntp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telnetPortNumber=telnetPortNumber, l2CPPriorityTable=l2CPPriorityTable, transmitPower=transmitPower, ptpCompliance=ptpCompliance, tDDControl=tDDControl, dataPortAutoNegotiation=dataPortAutoNegotiation, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPPortNumber=sNMPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, userTable=userTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPVersion=iPVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, linkSymmetry=linkSymmetry, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, smtp=smtp, managementPortStatus=managementPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, systemReset=systemReset, hTTPSPortNumber=hTTPSPortNumber, rawReceivePower=rawReceivePower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, accessMethod=accessMethod, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, syslogClient=syslogClient, remoteInternetAddress=remoteInternetAddress, phyControlGroup=phyControlGroup, channelBandwidth=channelBandwidth, bridge=bridge, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, versionsGroup=versionsGroup, userPassword=userPassword, reset=reset, syslogControl=syslogControl, sNTPServerStatus=sNTPServerStatus, channelBCableLength=channelBCableLength, encryption=encryption, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, altitude=altitude, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryptionAlgorithm=encryptionAlgorithm, versions=versions, dataPortFiberStatus=dataPortFiberStatus, installArmState=installArmState, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, targetMACAddress=targetMACAddress, transmitFreqMHz=transmitFreqMHz, userName=userName, bandwidthVariant=bandwidthVariant, ptp=ptp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6Address=iPv6Address, channelBLoopbackTrap=channelBLoopbackTrap, rxColorCode=rxColorCode, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, management=management, sNTPServerTimeout=sNTPServerTimeout, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dfsGroup=dfsGroup, syslogState=syslogState, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPv3Enable=sNMPv3Enable, range=range, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortDisabledWarning=managementPortDisabledWarning, installStatusTrap=installStatusTrap, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableNumber=sNTPServerTableNumber, longitude=longitude, vectorError=vectorError, bootVersion=bootVersion, channelBLoopback=channelBLoopback, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, systemClock=systemClock, installArmStateTrap=installArmStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStats=pubStats, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, pubStatsGroup=pubStatsGroup, telecomsChannelSelection=telecomsChannelSelection, rangingMode=rangingMode, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerPortNumber=sNTPServerPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomGroup=telecomGroup, telecomsChannelAStatus=telecomsChannelAStatus, frequencyVariant=frequencyVariant, receiveDataRate=receiveDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfs=dfs, productName=productName, userTableEntry=userTableEntry, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, phyControl=phyControl, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", eIRP=eIRP, subnetMask=subnetMask, dataPortStatusTrap=dataPortStatusTrap, localPacketFiltering=localPacketFiltering, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, targetRange=targetRange, groupID=groupID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecom=telecom, ethernetBridgingStatus=ethernetBridgingStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, qOSPriorityScheme=qOSPriorityScheme, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, daylightSaving=daylightSaving, sNTPServerTable=sNTPServerTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, supplementary=supplementary, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyStatus=phyStatus, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, dfsPeaks=dfsPeaks, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, managementPortStatusTrap=managementPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTableIndex=sNTPServerTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress)
