...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, bandwidthVariant=bandwidthVariant, sNMPTrapInternetAddress=sNMPTrapInternetAddress, antennaGain=antennaGain, tFTPServerInternetAddressType=tFTPServerInternetAddressType, bridgeGroup=bridgeGroup, cableLoss=cableLoss, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, managementMode=managementMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, syslogClient=syslogClient, dfsMeans=dfsMeans, managementGroup=managementGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, managementPortStatus=managementPortStatus, sNTPLastSync=sNTPLastSync, range=range, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, groupID=groupID, iPv6PrefixLength=iPv6PrefixLength, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, targetRange=targetRange, sNTPServerStatus=sNTPServerStatus, userName=userName, ethernetGroup=ethernetGroup, iPv4Address=iPv4Address, telecom=telecom, productName=productName, installStatus=installStatus, ptpTraps=ptpTraps, secondarySoftwareVersion=secondarySoftwareVersion, channelALoopbackTrap=channelALoopbackTrap, userTable=userTable, supplementaryGroup=supplementaryGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelAStatus=telecomsChannelAStatus, receiveDataRate=receiveDataRate, management=management, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, signalStrengthRatio=signalStrengthRatio, daylightSaving=daylightSaving, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerTableNumber=sNTPServerTableNumber, linkModeOptimisation=linkModeOptimisation, telecomsChannelBStatus=telecomsChannelBStatus, remoteInternetAddress=remoteInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, supplementary=supplementary, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPSync=sNTPSync, aAAControl=aAAControl, iPDSCPPriorityTable=iPDSCPPriorityTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, userEnabled=userEnabled, dfs=dfs, sNTPServerIPAddress=sNTPServerIPAddress, iPVersion=iPVersion, alarmsGroup=alarmsGroup, rawReceivePower=rawReceivePower, bootVersion=bootVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, installStatusTrap=installStatusTrap, channelACableLength=channelACableLength, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telecomsChannelSelection=telecomsChannelSelection, receiveChannel=receiveChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, smtpGroup=smtpGroup, pubStats=pubStats, telecomGroup=telecomGroup, txColorCode=txColorCode, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPv6GatewayAddress=iPv6GatewayAddress, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versionsGroup=versionsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, transmitModulationMode=transmitModulationMode, ptpGroups=ptpGroups, syslogControlGroup=syslogControlGroup, remoteRxTargetPower=remoteRxTargetPower, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, regionCodeTrap=regionCodeTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogStateTrap=syslogStateTrap, secureModeAlarmTrap=secureModeAlarmTrap, notificationsGroup=notificationsGroup, dSCPManagementPriority=dSCPManagementPriority, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, rangingMode=rangingMode, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, regionCode=regionCode, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerTimeout=sNTPServerTimeout, byteErrorRatio=byteErrorRatio, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, smtp=smtp, localPacketFiltering=localPacketFiltering, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, telecomsInterface=telecomsInterface, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, syslogControl=syslogControl, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBLineCode=channelBLineCode, sNTPServerTableEntry=sNTPServerTableEntry, licence=licence, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, dataPortFiberStatus=dataPortFiberStatus, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hAZLOCConfiguration=hAZLOCConfiguration, phyStatus=phyStatus, targetMACAddress=targetMACAddress, linkName=linkName, userTableEntry=userTableEntry, dfsTable=dfsTable, rxColorCode=rxColorCode, cambium=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetPriorityTable=ethernetPriorityTable, tDDControl=tDDControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, configurationGroup=configurationGroup, qOSPriorityScheme=qOSPriorityScheme, dfsTableNumber=dfsTableNumber, resetGroup=resetGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, maximumTransmitPower=maximumTransmitPower, channelBLoopback=channelBLoopback, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, automaticTxPowerControl=automaticTxPowerControl, userRole=userRole, channelBLoopbackTrap=channelBLoopbackTrap, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, sNTPServerPortNumber=sNTPServerPortNumber, bridge=bridge, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, channelBCableLength=channelBCableLength, transmitChannel=transmitChannel, securityLevel=securityLevel, sNMPTrapTable=sNMPTrapTable, secureModeAlarm=secureModeAlarm, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, altitude=altitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, channelALoopback=channelALoopback, tDDSynchronizationMode=tDDSynchronizationMode, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, ethernet=ethernet, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, userTableNumber=userTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, alarms=alarms, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, latitude=latitude, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerTableIndex=sNTPServerTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, syslogClientTrap=syslogClientTrap, searchState=searchState, sNMPv3Enable=sNMPv3Enable, tDDControlGroup=tDDControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelBandwidth=channelBandwidth, versions=versions, sNTPState=sNTPState, channelALineCode=channelALineCode, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, l2CPPriorityTable=l2CPPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, dfsPeaks=dfsPeaks, longitude=longitude, channelChangeTrap=channelChangeTrap, eIRP=eIRP, dataPortDisabledWarning=dataPortDisabledWarning, accessMethod=accessMethod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, sntp=sntp, ptmp=ptmp, reset=reset, managementPortDisabledWarning=managementPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, installArmStateTrap=installArmStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, iPv6Address=iPv6Address, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControl=phyControl, sNTPServerTable=sNTPServerTable, sMTPServerIPAddress=sMTPServerIPAddress, ptp600=ptp600, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, sMTPServerInternetAddressType=sMTPServerInternetAddressType, siteName=siteName, masterSlaveMode=masterSlaveMode, configuration=configuration, sMTPServerInternetAddress=sMTPServerInternetAddress, licenceGroup=licenceGroup)
