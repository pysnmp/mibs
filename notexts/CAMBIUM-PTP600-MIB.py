...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", subnetMask=subnetMask, hardwareVersion=hardwareVersion, secureModeAlarm=secureModeAlarm, securityLevel=securityLevel, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, installArmStateTrap=installArmStateTrap, installStatusTrap=installStatusTrap, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, userEnabled=userEnabled, receivePower=receivePower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bandwidthVariant=bandwidthVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, syslogControl=syslogControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, linkName=linkName, supplementary=supplementary, channelBLoopbackTrap=channelBLoopbackTrap, telecomsChannelSelection=telecomsChannelSelection, searchState=searchState, receiveModulationModeDetail=receiveModulationModeDetail, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, maximumTransmitPower=maximumTransmitPower, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, iPDSCPPriorityTable=iPDSCPPriorityTable, reset=reset, mPLSTCPriorityTable=mPLSTCPriorityTable, masterSlaveMode=masterSlaveMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, automaticTxPowerControl=automaticTxPowerControl, syslogState=syslogState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, receiveFreqMHz=receiveFreqMHz, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, managementPortStatusTrap=managementPortStatusTrap, ethernetBridgingStatus=ethernetBridgingStatus, vectorError=vectorError, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, snmpControl=snmpControl, userTableEntry=userTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, smtp=smtp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsInterface=telecomsInterface, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, remoteRxTargetPower=remoteRxTargetPower, transmitPower=transmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerStatus=sNTPServerStatus, unitOutOfCalibration=unitOutOfCalibration, sntpGroup=sntpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, targetRange=targetRange, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerTable=sNTPServerTable, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetPriorityTableIndex=ethernetPriorityTableIndex, aAAControl=aAAControl, dataPortAutoMdix=dataPortAutoMdix, dSCPManagementPriority=dSCPManagementPriority, channelACableLength=channelACableLength, systemClock=systemClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPState=sNTPState, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomGroup=telecomGroup, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, syslogClientTrap=syslogClientTrap, accessMethod=accessMethod, dataPortFiberStatus=dataPortFiberStatus, dfsTable=dfsTable, regionCodeTrap=regionCodeTrap, iPv6Address=iPv6Address, licenceGroup=licenceGroup, channelALoopbackTrap=channelALoopbackTrap, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, installStatus=installStatus, linkSymmetry=linkSymmetry, tDDControl=tDDControl, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, pubStatsGroup=pubStatsGroup, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, eIRP=eIRP, hAZLOCConfiguration=hAZLOCConfiguration, localPacketFiltering=localPacketFiltering, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetMACAddress=targetMACAddress, ethernet=ethernet, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, l2CPPriorityTable=l2CPPriorityTable, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, txColorCode=txColorCode, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, userName=userName, licence=licence, receiveModulationMode=receiveModulationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, altitude=altitude, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, managementMode=managementMode, aAAControlGroup=aAAControlGroup, managementPortStatus=managementPortStatus, phyStatusGroup=phyStatusGroup, groupID=groupID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryption=encryption, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetPortNumber=telnetPortNumber, systemReset=systemReset, transmitChannel=transmitChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveDataRate=receiveDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, channelALoopback=channelALoopback, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptp600=ptp600, dfsTableNumber=dfsTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLoopback=channelBLoopback, sNTPServerTableIndex=sNTPServerTableIndex, sNMPCommunityString=sNMPCommunityString, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, receiveChannel=receiveChannel, managementPortDisabledWarning=managementPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelALineCode=channelALineCode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControlGroup=phyControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, bridge=bridge, managementGroup=managementGroup, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetPriorityTable=ethernetPriorityTable, rxColorCode=rxColorCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, rawReceivePower=rawReceivePower, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, daylightSaving=daylightSaving, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, bridgeGroup=bridgeGroup, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogClient=syslogClient, alarms=alarms, channelBCableLength=channelBCableLength, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, qOSPriorityScheme=qOSPriorityScheme, dfs=dfs, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, timeZone=timeZone, sNTPServerTimeout=sNTPServerTimeout, encryptionAlgorithm=encryptionAlgorithm, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sntp=sntp, longitude=longitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dfsTableIndex=dfsTableIndex, iPVersion=iPVersion, vLANManagementVID=vLANManagementVID, management=management, configuration=configuration, resetGroup=resetGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rangingMode=rangingMode, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteInternetAddress=remoteInternetAddress, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, sNTPPrimaryServer=sNTPPrimaryServer, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, range=range, sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, ptpTrapPrefix=ptpTrapPrefix, channelBandwidth=channelBandwidth, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, iPv4Address=iPv4Address, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sMTPEnabledMessages=sMTPEnabledMessages, channelBLineCode=channelBLineCode, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetPriorityTableNumber=ethernetPriorityTableNumber, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, latitude=latitude, remoteInternetAddressType=remoteInternetAddressType)
