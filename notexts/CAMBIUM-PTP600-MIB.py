...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", bandwidthVariant=bandwidthVariant, channelALoopbackTrap=channelALoopbackTrap, licence=licence, regionCode=regionCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, securityLevel=securityLevel, smtp=smtp, rxColorCode=rxColorCode, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitPower=transmitPower, ptpCompliance=ptpCompliance, userRole=userRole, txColorCode=txColorCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsGroup=dfsGroup, antennaGain=antennaGain, telecomsInterface=telecomsInterface, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bridge=bridge, vectorError=vectorError, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmStateTrap=installArmStateTrap, groupID=groupID, syslogClient=syslogClient, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hAZLOCConfiguration=hAZLOCConfiguration, phyStatusGroup=phyStatusGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, accessMethod=accessMethod, syslogClientTrap=syslogClientTrap, userTable=userTable, subnetMask=subnetMask, installStatus=installStatus, remoteInternetAddressType=remoteInternetAddressType, configuration=configuration, reset=reset, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, productName=productName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogState=syslogState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, iPv4Address=iPv4Address, userName=userName, managementPortDisabledWarning=managementPortDisabledWarning, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, channelBLoopback=channelBLoopback, sNMPTrapTableEntry=sNMPTrapTableEntry, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, remoteRxTargetPower=remoteRxTargetPower, channelBCableLength=channelBCableLength, managementPortStatus=managementPortStatus, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStatsGroup=pubStatsGroup, dataPortDisabledWarning=dataPortDisabledWarning, channelBLoopbackTrap=channelBLoopbackTrap, phyStatus=phyStatus, channelALoopback=channelALoopback, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPv3Enable=sNMPv3Enable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, snmpControlGroup=snmpControlGroup, installArmState=installArmState, softwareVersion=softwareVersion, dfsMeans=dfsMeans, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, iPv6PrefixLength=iPv6PrefixLength, managementMode=managementMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomGroup=telecomGroup, eIRP=eIRP, receiveDataRate=receiveDataRate, linkModeOptimisation=linkModeOptimisation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortFiberStatus=dataPortFiberStatus, iPv6Address=iPv6Address, PYSNMP_MODULE_ID=cambium, siteName=siteName, userTableNumber=userTableNumber, aAAControl=aAAControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, sNTPServerTimeout=sNTPServerTimeout, vLANManagementVID=vLANManagementVID, sNMPCommunityString=sNMPCommunityString, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, versionsGroup=versionsGroup, timeZone=timeZone, aggregateDataRate=aggregateDataRate, tDDSynchronizationMode=tDDSynchronizationMode, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogControl=syslogControl, dfs=dfs, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControlGroup=aAAControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, targetRange=targetRange, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, alarms=alarms, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, byteErrorRatio=byteErrorRatio, sNMPTrapVersion=sNMPTrapVersion, automaticTxPowerControl=automaticTxPowerControl, masterSlaveMode=masterSlaveMode, ptmp=ptmp, searchState=searchState, sNTPServerTableNumber=sNTPServerTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatusTrap=dataPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, telecomsChannelSelection=telecomsChannelSelection, sNMPEnabledTraps=sNMPEnabledTraps, channelBLineCode=channelBLineCode, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableIndex=userTableIndex, telecomsChannelBStatus=telecomsChannelBStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, userPassword=userPassword, dataPortStatus=dataPortStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, systemClock=systemClock, dataPortFiberStatusTrap=dataPortFiberStatusTrap, telecom=telecom, dfsTable=dfsTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, ptpTraps=ptpTraps, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControl=phyControl, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPTrapTable=sNMPTrapTable, cambium=cambium, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsPeaks=dfsPeaks, resetGroup=resetGroup, daylightSaving=daylightSaving, targetMACAddress=targetMACAddress, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPVersion=iPVersion, productVariant=productVariant, smtpGroup=smtpGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetAccessEnabled=telnetAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, rawReceivePower=rawReceivePower, sNTPPrimaryServer=sNTPPrimaryServer, managementPortConfigurationMismatch=managementPortConfigurationMismatch, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapInternetAddress=sNMPTrapInternetAddress, encryptionGroup=encryptionGroup, gatewayIPAddress=gatewayIPAddress, channelALineCode=channelALineCode, wirelessLinkStatus=wirelessLinkStatus, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, channelACableLength=channelACableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitModulationMode=transmitModulationMode, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, regionCodeTrap=regionCodeTrap, l2CPPriorityTable=l2CPPriorityTable, dfsTableEntry=dfsTableEntry, dSCPManagementPriority=dSCPManagementPriority, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubStats=pubStats, encryptionAlgorithm=encryptionAlgorithm, tDDControlGroup=tDDControlGroup, sNTPServerTable=sNTPServerTable, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, cableLoss=cableLoss, systemReset=systemReset, sNTPServerRetries=sNTPServerRetries, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, notificationsGroup=notificationsGroup, linkName=linkName, userTableEntry=userTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteInternetAddress=remoteInternetAddress, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableIndex=dfsTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, frequencyVariant=frequencyVariant, rangingMode=rangingMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntp=sntp, linkSymmetry=linkSymmetry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, configurationGroup=configurationGroup, latitude=latitude, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, longitude=longitude, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, ptp600=ptp600, sNTPServerTableEntry=sNTPServerTableEntry, phyControlGroup=phyControlGroup, supplementary=supplementary, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, ptpGroups=ptpGroups, receivePower=receivePower, secondarySoftwareVersion=secondarySoftwareVersion, hardwareVersion=hardwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, versions=versions, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, sNTPServerStatus=sNTPServerStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, management=management, encryption=encryption, altitude=altitude, telecomsChannelAStatus=telecomsChannelAStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime)
