...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", encryptionGroup=encryptionGroup, installStatus=installStatus, channelALoopback=channelALoopback, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, aAAControl=aAAControl, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, remoteInternetAddress=remoteInternetAddress, targetMACAddress=targetMACAddress, snmpControl=snmpControl, managementPortStatus=managementPortStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerRetries=sNTPServerRetries, remoteInternetAddressType=remoteInternetAddressType, automaticTxPowerControl=automaticTxPowerControl, receiveDataRate=receiveDataRate, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, ptp600=ptp600, channelBandwidth=channelBandwidth, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, telecomsChannelBStatus=telecomsChannelBStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receivePower=receivePower, channelALoopbackTrap=channelALoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatus=dataPortStatus, longitude=longitude, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTable=sNTPServerTable, dfsPeaks=dfsPeaks, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sntpGroup=sntpGroup, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, remoteRxTargetPower=remoteRxTargetPower, snmpControlGroup=snmpControlGroup, versions=versions, remoteIPAddress=remoteIPAddress, managementMode=managementMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, telecomsChannelSelection=telecomsChannelSelection, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, ethernetBridgingAvailability=ethernetBridgingAvailability, qOSPriorityScheme=qOSPriorityScheme, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, ptpCompliance=ptpCompliance, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, smtp=smtp, dSCPManagementPriority=dSCPManagementPriority, phyStatusGroup=phyStatusGroup, daylightSaving=daylightSaving, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, bridgeGroup=bridgeGroup, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, sNTPServerIPAddress=sNTPServerIPAddress, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogControl=syslogControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationMode=receiveModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, sNTPServerInternetAddressType=sNTPServerInternetAddressType, managementPortDisabledWarning=managementPortDisabledWarning, ethernetGroup=ethernetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomGroup=telecomGroup, encryption=encryption, ptmp=ptmp, installArmState=installArmState, altitude=altitude, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, bridge=bridge, supplementaryGroup=supplementaryGroup, sNMPTrapTable=sNMPTrapTable, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelBCableLength=channelBCableLength, rawReceivePower=rawReceivePower, pubStatsGroup=pubStatsGroup, targetRange=targetRange, sNMPEnabledTraps=sNMPEnabledTraps, secureModeAlarm=secureModeAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, softwareVersion=softwareVersion, userPassword=userPassword, hAZLOCConfiguration=hAZLOCConfiguration, transmitDataRate=transmitDataRate, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortAutoMdix=dataPortAutoMdix, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sntp=sntp, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, iPv6GatewayAddress=iPv6GatewayAddress, sNTPLastSync=sNTPLastSync, dfsGroup=dfsGroup, securityLevel=securityLevel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetPortNumber=telnetPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, supplementary=supplementary, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetBridgingStatus=ethernetBridgingStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, dataPortFiberStatus=dataPortFiberStatus, sNTPServerPortNumber=sNTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, sNMPv3Enable=sNMPv3Enable, vectorError=vectorError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cambium=cambium, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, tDDControl=tDDControl, iPv4Address=iPv4Address, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetFiberSupport=ethernetFiberSupport, configuration=configuration, gatewayIPAddress=gatewayIPAddress, telecomsChannelAStatus=telecomsChannelAStatus, searchState=searchState, bootVersion=bootVersion, telecom=telecom, configurationGroup=configurationGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPPrimaryServer=sNTPPrimaryServer, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licence=licence, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, aAAControlGroup=aAAControlGroup, syslogState=syslogState, ethernetPriorityTable=ethernetPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarning=dataPortDisabledWarning, systemReset=systemReset, subnetMask=subnetMask, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, localPacketFiltering=localPacketFiltering, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, channelBLoopback=channelBLoopback, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTimeout=sNTPServerTimeout, ethernet=ethernet, channelACableLength=channelACableLength, ptp=ptp, rangingMode=rangingMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, regionCodeTrap=regionCodeTrap, antennaGain=antennaGain, sNTPServerTableNumber=sNTPServerTableNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, phyControl=phyControl, userRole=userRole, hTTPPortNumber=hTTPPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPv6PrefixLength=iPv6PrefixLength, channelChangeTrap=channelChangeTrap, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode, productName=productName, management=management, managementPortStatusTrap=managementPortStatusTrap, signalStrengthRatio=signalStrengthRatio)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTable=dfsTable, transmitPower=transmitPower, sNTPState=sNTPState, dfs=dfs, channelALineCode=channelALineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, txColorCode=txColorCode, range=range, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, iPVersion=iPVersion, notificationsGroup=notificationsGroup, groupID=groupID, productVariant=productVariant, siteName=siteName, accessMethod=accessMethod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, userName=userName, syslogControlGroup=syslogControlGroup, pubStats=pubStats, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, aggregateDataRate=aggregateDataRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secureModeAlarmTrap=secureModeAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, frequencyVariant=frequencyVariant, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, versionsGroup=versionsGroup, dfsMeans=dfsMeans, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert)
