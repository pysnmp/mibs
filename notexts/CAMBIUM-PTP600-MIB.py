...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", versionsGroup=versionsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelALineCode=channelALineCode, channelBLoopbackTrap=channelBLoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, remoteRxTargetPower=remoteRxTargetPower, remoteInternetAddress=remoteInternetAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitFreqKHz=transmitFreqKHz, tDDControl=tDDControl, dfs=dfs, pubStats=pubStats, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetBridgingStatus=ethernetBridgingStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, reset=reset, userTableEntry=userTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptp=ptp, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, telecomGroup=telecomGroup, sNMPCommunityString=sNMPCommunityString, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, daylightSaving=daylightSaving, bridgeGroup=bridgeGroup, resetGroup=resetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installArmStateTrap=installArmStateTrap, ptp600=ptp600, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, systemReset=systemReset, aggregateDataRate=aggregateDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityTable=iPDSCPPriorityTable, gatewayIPAddress=gatewayIPAddress, managementPortStatusTrap=managementPortStatusTrap, managementPortStatus=managementPortStatus, ethernetFiberSupport=ethernetFiberSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPTrapTable=sNMPTrapTable, receiveDataRate=receiveDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, secureModeAlarm=secureModeAlarm, encryption=encryption, syslogState=syslogState, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, channelACableLength=channelACableLength, configuration=configuration, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, range=range, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, aAAControl=aAAControl, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, transmitChannel=transmitChannel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetAccessEnabled=telnetAccessEnabled, dataPortFiberStatus=dataPortFiberStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPPrimaryServer=sNTPPrimaryServer, syslogStateTrap=syslogStateTrap, bridge=bridge, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatus=phyStatus, iPv6GatewayAddress=iPv6GatewayAddress, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, phyControl=phyControl, iPVersion=iPVersion, regionCodeTrap=regionCodeTrap, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitModulationMode=transmitModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transmitDataRate=transmitDataRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installArmState=installArmState, iPv6Address=iPv6Address, syslogClient=syslogClient, targetMACAddress=targetMACAddress, accessMethod=accessMethod, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, softwareVersion=softwareVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsTableIndex=dfsTableIndex, sNTPSyncTrap=sNTPSyncTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, timeZone=timeZone, channelChangeTrap=channelChangeTrap, supplementaryGroup=supplementaryGroup, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, securityLevel=securityLevel, receiveFreqMHz=receiveFreqMHz, dSCPManagementPriority=dSCPManagementPriority, altitude=altitude, userPassword=userPassword, telecom=telecom, rxColorCode=rxColorCode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTableNumber=userTableNumber, telnetPortNumber=telnetPortNumber, linkName=linkName, channelALoopback=channelALoopback, sNMPPortNumber=sNMPPortNumber, management=management, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, userTable=userTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, vectorError=vectorError, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTableIndex=sNTPServerTableIndex, hardwareVersion=hardwareVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelBLoopback=channelBLoopback, smtp=smtp, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, hTTPPortNumber=hTTPPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, productName=productName, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBandwidth=channelBandwidth, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, dfsMeans=dfsMeans, automaticTxPowerControl=automaticTxPowerControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, sNTPLastSync=sNTPLastSync, systemClock=systemClock, localPacketFiltering=localPacketFiltering, sMTPEmailAlert=sMTPEmailAlert, alarmsGroup=alarmsGroup, dfsPeaks=dfsPeaks, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBLineCode=channelBLineCode, transmitPower=transmitPower, sNTPServerTableEntry=sNTPServerTableEntry, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, snmpControl=snmpControl, iPv4Address=iPv4Address, licence=licence, installStatus=installStatus, dataPortStatusTrap=dataPortStatusTrap, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, rawReceivePower=rawReceivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNTPPollInterval=sNTPPollInterval, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, versions=versions, telecomsChannelAStatus=telecomsChannelAStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelBStatus=telecomsChannelBStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regionCode=regionCode, sNTPState=sNTPState, remoteInternetAddressType=remoteInternetAddressType, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerRetries=sNTPServerRetries, signalStrengthRatio=signalStrengthRatio, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, ethernetGroup=ethernetGroup, transmitFreqMHz=transmitFreqMHz, managementPortDisabledWarning=managementPortDisabledWarning, txColorCode=txColorCode, iPv6PrefixLength=iPv6PrefixLength, tDDControlGroup=tDDControlGroup, dataPortStatus=dataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, bootVersion=bootVersion, userName=userName, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hAZLOCConfiguration=hAZLOCConfiguration, dataPortAutoMdix=dataPortAutoMdix, channelBCableLength=channelBCableLength, licenceGroup=licenceGroup, antennaGain=antennaGain, syslogClientTrap=syslogClientTrap, groupID=groupID, dfsTableNumber=dfsTableNumber, ptmp=ptmp, dfsTableEntry=dfsTableEntry, phyControlGroup=phyControlGroup, searchState=searchState, managementGroup=managementGroup, latitude=latitude, telecomsChannelSelection=telecomsChannelSelection, receiveModulationMode=receiveModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, longitude=longitude, rangingMode=rangingMode, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpGroups=ptpGroups, encryptionGroup=encryptionGroup, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, l2CPPriorityTable=l2CPPriorityTable, managementMode=managementMode, vLANManagementPriority=vLANManagementPriority, userRole=userRole, sNTPServerTable=sNTPServerTable, siteName=siteName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANManagementVID=vLANManagementVID, telecomsInterface=telecomsInterface, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveFreqKHz=receiveFreqKHz, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, channelALoopbackTrap=channelALoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
