...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogControl=syslogControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, hAZLOCConfiguration=hAZLOCConfiguration, sNMPv3Enable=sNMPv3Enable, systemClock=systemClock, receiveModulationModeDetail=receiveModulationModeDetail, telecomsInterface=telecomsInterface, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptmp=ptmp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelBStatus=telecomsChannelBStatus, userName=userName, pubStatsGroup=pubStatsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerRetries=sNTPServerRetries, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, telnetPortNumber=telnetPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, timeZone=timeZone, syslogClientTrap=syslogClientTrap, sNTPServerTimeout=sNTPServerTimeout, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telecomGroup=telecomGroup, sNTPPollInterval=sNTPPollInterval, tFTPServerIPAddress=tFTPServerIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, groupID=groupID, longitude=longitude, receiveModulationMode=receiveModulationMode, cambium=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, channelALoopback=channelALoopback, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDControl=tDDControl, userTableEntry=userTableEntry, siteName=siteName, ethernetPriorityTable=ethernetPriorityTable, dataPortStatus=dataPortStatus, channelALineCode=channelALineCode, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerTableIndex=sNTPServerTableIndex, searchState=searchState, accessMethod=accessMethod, channelBLineCode=channelBLineCode, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, userRole=userRole, iPVersion=iPVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, supplementaryGroup=supplementaryGroup, bridge=bridge, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementPortStatusTrap=managementPortStatusTrap, dfsGroup=dfsGroup, channelACableLength=channelACableLength, remoteIPAddress=remoteIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortFiberStatus=dataPortFiberStatus, remoteInternetAddressType=remoteInternetAddressType, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aggregateDataRate=aggregateDataRate, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, linkModeOptimisation=linkModeOptimisation, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, iPv6Address=iPv6Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rawReceivePower=rawReceivePower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, alarmsGroup=alarmsGroup, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetBridgingStatus=ethernetBridgingStatus, hTTPPortNumber=hTTPPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptp=ptp, smtpGroup=smtpGroup, dfs=dfs, userTable=userTable, dfsMeans=dfsMeans, eIRP=eIRP, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerTable=sNTPServerTable, softwareVersion=softwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, channelChangeTrap=channelChangeTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bridgeGroup=bridgeGroup, dataPortStatusTrap=dataPortStatusTrap, qOSPriorityScheme=qOSPriorityScheme, transmitPower=transmitPower, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rxColorCode=rxColorCode, vLANManagementPriority=vLANManagementPriority, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, installStatus=installStatus, receiveFreqKHz=receiveFreqKHz, ethernetBridgingAvailability=ethernetBridgingAvailability, encryption=encryption, channelALoopbackTrap=channelALoopbackTrap, reset=reset, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productVariant=productVariant, vectorError=vectorError, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, licence=licence, aAAControl=aAAControl, ptpCompliance=ptpCompliance, managementPortStatus=managementPortStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, maximumTransmitPower=maximumTransmitPower, automaticTxPowerControl=automaticTxPowerControl, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatusGroup=phyStatusGroup, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPState=sNTPState, telecomsChannelAStatus=telecomsChannelAStatus, managementMode=managementMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ptpTrapPrefix=ptpTrapPrefix, sntp=sntp, bandwidthVariant=bandwidthVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCodeTrap=regionCodeTrap, ptp600=ptp600, transmitModulationMode=transmitModulationMode, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, range=range, sMTPEmailAlert=sMTPEmailAlert, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, iPv6PrefixLength=iPv6PrefixLength, hardwareVersion=hardwareVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteRxTargetPower=remoteRxTargetPower, productName=productName, phyControlGroup=phyControlGroup, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, systemReset=systemReset, versions=versions, userPassword=userPassword, userTableNumber=userTableNumber, telecom=telecom, pubStats=pubStats, altitude=altitude, syslogStateTrap=syslogStateTrap, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapTable=sNMPTrapTable, channelBLoopbackTrap=channelBLoopbackTrap, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, alarms=alarms, rangingMode=rangingMode, antennaGain=antennaGain, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secureModeAlarm=secureModeAlarm, transmitFreqMHz=transmitFreqMHz, encryptionGroup=encryptionGroup, subnetMask=subnetMask, receiveFreqMHz=receiveFreqMHz, latitude=latitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveChannel=receiveChannel, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogState=syslogState, versionsGroup=versionsGroup, sNTPServerTableEntry=sNTPServerTableEntry, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSyncTrap=sNTPSyncTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, remoteInternetAddress=remoteInternetAddress, iPv4Address=iPv4Address, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerStatus=sNTPServerStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTableNumber=sNTPServerTableNumber, channelBLoopback=channelBLoopback, dfsTable=dfsTable, linkSymmetry=linkSymmetry, snmpControl=snmpControl, management=management, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, licenceGroup=licenceGroup, linkName=linkName, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, userEnabled=userEnabled, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControl=phyControl, l2CPPriorityTable=l2CPPriorityTable, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, securityLevel=securityLevel, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, ethernetGroup=ethernetGroup, receivePower=receivePower, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelBCableLength=channelBCableLength, targetRange=targetRange, localPacketFiltering=localPacketFiltering, signalStrengthRatio=signalStrengthRatio, sNMPTrapInternetAddress=sNMPTrapInternetAddress, supplementary=supplementary, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, txColorCode=txColorCode, telecomsChannelSelection=telecomsChannelSelection, smtp=smtp, configurationGroup=configurationGroup)
