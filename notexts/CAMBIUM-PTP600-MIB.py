...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", snmpControl=snmpControl, supplementary=supplementary, iPv6PrefixLength=iPv6PrefixLength, configurationGroup=configurationGroup, tDDControlGroup=tDDControlGroup, linkLoss=linkLoss, searchState=searchState, alarms=alarms, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv4Address=iPv4Address, vLANManagementVID=vLANManagementVID, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, iPv6Address=iPv6Address, installArmState=installArmState, syslogControl=syslogControl, pubStats=pubStats, syslogClientTrap=syslogClientTrap, managementGroup=managementGroup, dfsMeans=dfsMeans, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetGroup=ethernetGroup, telecomsInterface=telecomsInterface, productVariant=productVariant, ptp=ptp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, channelALoopbackTrap=channelALoopbackTrap, dataPortFiberStatus=dataPortFiberStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, channelACableLength=channelACableLength, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, sNTPServerIPAddress=sNTPServerIPAddress, targetRange=targetRange, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqMHz=receiveFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, pubStatsGroup=pubStatsGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, receiveModulationMode=receiveModulationMode, channelBLineCode=channelBLineCode, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, notificationsGroup=notificationsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secureModeAlarmTrap=secureModeAlarmTrap, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarning=managementPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sntp=sntp, telnetPortNumber=telnetPortNumber, receiveChannel=receiveChannel, bridgeGroup=bridgeGroup, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, userTable=userTable, channelBLoopbackTrap=channelBLoopbackTrap, transmitChannel=transmitChannel, telnetAccessEnabled=telnetAccessEnabled, managementPortStatusTrap=managementPortStatusTrap, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, reset=reset, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, phyStatus=phyStatus, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, resetGroup=resetGroup, latitude=latitude, licenceGroup=licenceGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, txColorCode=txColorCode, phyStatusGroup=phyStatusGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, rawReceivePower=rawReceivePower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, ethernetBridgingAvailability=ethernetBridgingAvailability, transmitModulationMode=transmitModulationMode, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, syslogControlGroup=syslogControlGroup, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, channelBLoopback=channelBLoopback, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitPower=transmitPower, timeZone=timeZone, mPLSTCPriorityTable=mPLSTCPriorityTable, bootVersion=bootVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteRxTargetPower=remoteRxTargetPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userRole=userRole, secureModeAlarm=secureModeAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, automaticTxPowerControl=automaticTxPowerControl, channelChangeTrap=channelChangeTrap, ethernetFiberSupport=ethernetFiberSupport, sNTPServerTableEntry=sNTPServerTableEntry, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hAZLOCConfiguration=hAZLOCConfiguration, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSyncTrap=sNTPSyncTrap, accessMethod=accessMethod, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionGroup=encryptionGroup, regionCode=regionCode, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, ptpGroups=ptpGroups, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, channelALoopback=channelALoopback, remoteInternetAddressType=remoteInternetAddressType, managementMode=managementMode, snmpControlGroup=snmpControlGroup, systemReset=systemReset, phyControlGroup=phyControlGroup, versions=versions, ethernetBridgingStatus=ethernetBridgingStatus, ptpCompliance=ptpCompliance, l2CPPriorityTableNumber=l2CPPriorityTableNumber, subnetMask=subnetMask, productName=productName, remoteIPAddress=remoteIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerRetries=sNTPServerRetries, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitDataRate=transmitDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userName=userName, ptmp=ptmp, smtpGroup=smtpGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, remoteInternetAddress=remoteInternetAddress, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, sNMPCommunityString=sNMPCommunityString, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp600=ptp600, receivePower=receivePower, sNTPSync=sNTPSync, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, dSCPManagementPriority=dSCPManagementPriority, configuration=configuration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, bandwidthVariant=bandwidthVariant, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogState=syslogState)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", telecom=telecom, telecomsChannelSelection=telecomsChannelSelection, channelBCableLength=channelBCableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClient=syslogClient, byteErrorRatio=byteErrorRatio, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, licence=licence, telecomGroup=telecomGroup, localPacketFiltering=localPacketFiltering, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, bridge=bridge, sNTPServerTimeout=sNTPServerTimeout, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitFreqKHz=transmitFreqKHz, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, securityLevel=securityLevel, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, encryption=encryption, userPassword=userPassword, dataPortStatus=dataPortStatus, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, groupID=groupID, channelALineCode=channelALineCode, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, managementPortStatus=managementPortStatus, telecomsChannelBStatus=telecomsChannelBStatus, altitude=altitude, rangingMode=rangingMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerTable=sNTPServerTable, dfsTable=dfsTable)
