...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userTableIndex=userTableIndex, channelALoopback=channelALoopback, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, licence=licence, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versions=versions, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, notificationsGroup=notificationsGroup, dfs=dfs, timeZone=timeZone, transmitFreqKHz=transmitFreqKHz, channelALineCode=channelALineCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userName=userName, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6PrefixLength=iPv6PrefixLength, regionCode=regionCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userTableNumber=userTableNumber, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, tDDControl=tDDControl, dataPortStatus=dataPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitDataRate=transmitDataRate, channelBLineCode=channelBLineCode, linkName=linkName, phyControlGroup=phyControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, eIRP=eIRP, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTable=sNTPServerTable, remoteInternetAddressType=remoteInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, encryption=encryption, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, automaticTxPowerControl=automaticTxPowerControl, channelBLoopbackTrap=channelBLoopbackTrap, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecom=telecom, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServer=sNTPPrimaryServer, localPacketFiltering=localPacketFiltering, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, remoteInternetAddress=remoteInternetAddress, rxColorCode=rxColorCode, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationMode=tDDSynchronizationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, smtp=smtp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bridge=bridge, installStatus=installStatus, ethernetBridgingStatus=ethernetBridgingStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetGroup=ethernetGroup, dfsTable=dfsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, hAZLOCConfiguration=hAZLOCConfiguration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, longitude=longitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPLastSync=sNTPLastSync, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, txColorCode=txColorCode, iPDSCPPriorityTable=iPDSCPPriorityTable, latitude=latitude, iPVersion=iPVersion, frequencyVariant=frequencyVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, dataPortDisabledWarning=dataPortDisabledWarning, securityLevel=securityLevel, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTableIndex=l2CPPriorityTableIndex, aAAControl=aAAControl, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, telecomsChannelSelection=telecomsChannelSelection, groupID=groupID, managementMode=managementMode, channelBLoopback=channelBLoopback, sNMPv3Enable=sNMPv3Enable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimisation=linkModeOptimisation, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveModulationMode=receiveModulationMode, configuration=configuration, ptpCompliance=ptpCompliance, configurationGroup=configurationGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, siteName=siteName, regionCodeTrap=regionCodeTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerRetries=sNTPServerRetries, supplementaryGroup=supplementaryGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, pubStats=pubStats, iPv4Address=iPv4Address, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableIndex=dfsTableIndex, sNTPServerTimeout=sNTPServerTimeout, smtpGroup=smtpGroup, cambium=cambium, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortStatusTrap=managementPortStatusTrap, productName=productName, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, altitude=altitude, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, channelBCableLength=channelBCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, management=management, installArmState=installArmState, systemClock=systemClock, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, receivePower=receivePower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsMeans=dfsMeans, transmitChannel=transmitChannel, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, dataPortFiberStatus=dataPortFiberStatus, ptp=ptp, qOSPriorityScheme=qOSPriorityScheme, userTableEntry=userTableEntry, sNMPPortNumber=sNMPPortNumber, rangingMode=rangingMode, hTTPPortNumber=hTTPPortNumber, alarms=alarms, targetRange=targetRange, productVariant=productVariant, syslogControlGroup=syslogControlGroup, maximumTransmitPower=maximumTransmitPower, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, ptp600=ptp600, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, secureModeAlarm=secureModeAlarm, installStatusTrap=installStatusTrap, userRole=userRole, supplementary=supplementary, dataPortAutoNegotiation=dataPortAutoNegotiation, secondarySoftwareVersion=secondarySoftwareVersion, receiveChannel=receiveChannel, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTable=ethernetPriorityTable, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licenceGroup=licenceGroup, rawReceivePower=rawReceivePower, range=range, softwareVersion=softwareVersion, resetGroup=resetGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSync=sNTPSync, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, managementPortStatus=managementPortStatus, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, dSCPManagementPriority=dSCPManagementPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkSymmetry=linkSymmetry, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, iPv6Address=iPv6Address, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelACableLength=channelACableLength, encryptionGroup=encryptionGroup, sMTPEmailAlert=sMTPEmailAlert, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState, transmitPower=transmitPower, sntpGroup=sntpGroup, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, pubStatsGroup=pubStatsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, hardwareVersion=hardwareVersion, channelALoopbackTrap=channelALoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cableLoss=cableLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControlGroup=aAAControlGroup, sNTPServerStatus=sNTPServerStatus, snmpControlGroup=snmpControlGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogClient=syslogClient, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPState=sNTPState, remoteRxTargetPower=remoteRxTargetPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
