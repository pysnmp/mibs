...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", linkLoss=linkLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogStateTrap=syslogStateTrap, gatewayIPAddress=gatewayIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerIPAddress=sMTPServerIPAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, telecomsChannelBStatus=telecomsChannelBStatus, channelBLoopback=channelBLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, sNMPEnabledTraps=sNMPEnabledTraps, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBLineCode=channelBLineCode, sNTPServerTableEntry=sNTPServerTableEntry, targetRange=targetRange, versions=versions, bridge=bridge, syslogState=syslogState, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, bridgeGroup=bridgeGroup, phyStatusGroup=phyStatusGroup, groupID=groupID, sNTPServerTableNumber=sNTPServerTableNumber, dfsTableEntry=dfsTableEntry, systemReset=systemReset, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetBridgingStatus=ethernetBridgingStatus, smtp=smtp, channelBandwidth=channelBandwidth, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, userTableIndex=userTableIndex, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, userName=userName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, searchState=searchState, resetGroup=resetGroup, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, pubStats=pubStats, hAZLOCConfiguration=hAZLOCConfiguration, remoteInternetAddressType=remoteInternetAddressType, linkSymmetry=linkSymmetry, qOSPriorityScheme=qOSPriorityScheme, configuration=configuration, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarm=secureModeAlarm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitChannel=transmitChannel, channelBLoopbackTrap=channelBLoopbackTrap, eIRP=eIRP, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControlGroup=tDDControlGroup, alarmsGroup=alarmsGroup, syslogClient=syslogClient, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, telecomsChannelAStatus=telecomsChannelAStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerTimeout=sNTPServerTimeout, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, remoteIPAddress=remoteIPAddress, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, securityLevel=securityLevel, dfsGroup=dfsGroup, receiveDataRate=receiveDataRate, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, reset=reset, encryption=encryption, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, managementMode=managementMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTableNumber=userTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, accessMethod=accessMethod, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, l2CPPriorityTable=l2CPPriorityTable, linkName=linkName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, timeZone=timeZone, sNMPTrapTable=sNMPTrapTable, sNTPServerIPAddress=sNTPServerIPAddress, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteRxTargetPower=remoteRxTargetPower, dfsPeaks=dfsPeaks, installArmState=installArmState, dataPortAutoMdix=dataPortAutoMdix, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, vectorError=vectorError, supplementary=supplementary, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, range=range, sNTPPollInterval=sNTPPollInterval, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, frequencyVariant=frequencyVariant, ptmp=ptmp, rxColorCode=rxColorCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, productName=productName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, dataPortFiberStatus=dataPortFiberStatus, managementPortStatus=managementPortStatus, managementPortDisabledWarning=managementPortDisabledWarning, longitude=longitude, installStatus=installStatus, channelALineCode=channelALineCode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerTableIndex=sNTPServerTableIndex, sNTPServerStatus=sNTPServerStatus, telecomGroup=telecomGroup, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, PYSNMP_MODULE_ID=cambium, ethernetBridgingAvailability=ethernetBridgingAvailability, targetMACAddress=targetMACAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, versionsGroup=versionsGroup, vLANManagementVID=vLANManagementVID, sNTPServerTable=sNTPServerTable, siteName=siteName, transmitPower=transmitPower, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, ptp600=ptp600, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, bandwidthVariant=bandwidthVariant, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rawReceivePower=rawReceivePower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALoopback=channelALoopback, encryptionAlgorithm=encryptionAlgorithm, remoteInternetAddress=remoteInternetAddress, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, byteErrorRatio=byteErrorRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBCableLength=channelBCableLength, dfsMeans=dfsMeans, subnetMask=subnetMask, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, userRole=userRole, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, rangingMode=rangingMode, sNMPTrapTableIndex=sNMPTrapTableIndex, localPacketFiltering=localPacketFiltering, management=management, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, txColorCode=txColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, installArmStateTrap=installArmStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPVersion=iPVersion, altitude=altitude, automaticTxPowerControl=automaticTxPowerControl, iPv6PrefixLength=iPv6PrefixLength, telecomsChannelSelection=telecomsChannelSelection, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, channelACableLength=channelACableLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, licence=licence)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelChangeTrap=channelChangeTrap, tDDControl=tDDControl, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userEnabled=userEnabled, syslogControl=syslogControl, supplementaryGroup=supplementaryGroup, telecomsInterface=telecomsInterface, sNMPTrapTableEntry=sNMPTrapTableEntry, userTable=userTable, sNMPv3Enable=sNMPv3Enable, regionCodeTrap=regionCodeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv4Address=iPv4Address, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, dfsTable=dfsTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cambium=cambium, ptpGroups=ptpGroups, masterSlaveMode=masterSlaveMode, receiveFreqMHz=receiveFreqMHz, userPassword=userPassword, sNTPPrimaryServer=sNTPPrimaryServer, sntp=sntp, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, latitude=latitude, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, managementPortStatusTrap=managementPortStatusTrap, channelALoopbackTrap=channelALoopbackTrap, receiveModulationModeDetail=receiveModulationModeDetail, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, regionCode=regionCode, ptpCompliance=ptpCompliance)
