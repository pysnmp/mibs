...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, byteErrorRatio=byteErrorRatio, dfs=dfs, sNMPv3Enable=sNMPv3Enable, dataPortAutoMdix=dataPortAutoMdix, sntpGroup=sntpGroup, cableLoss=cableLoss, iPv6PrefixLength=iPv6PrefixLength, linkLoss=linkLoss, managementMode=managementMode, userTableEntry=userTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, txColorCode=txColorCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortFiberStatus=dataPortFiberStatus, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, wirelessLinkStatus=wirelessLinkStatus, remoteIPAddress=remoteIPAddress, regionCode=regionCode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, bridge=bridge, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, targetRange=targetRange, licenceGroup=licenceGroup, siteName=siteName, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userEnabled=userEnabled, configuration=configuration, productName=productName, PYSNMP_MODULE_ID=cambium, pubStats=pubStats, sNTPServerTable=sNTPServerTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, encryptionGroup=encryptionGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secureModeAlarmTrap=secureModeAlarmTrap, management=management, syslogControlGroup=syslogControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, alarms=alarms, versionsGroup=versionsGroup, dfsGroup=dfsGroup, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rxColorCode=rxColorCode, searchState=searchState, sNTPServerStatus=sNTPServerStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, antennaGain=antennaGain, installStatus=installStatus, reset=reset, subnetMask=subnetMask, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telnetPortNumber=telnetPortNumber, vLANManagementPriority=vLANManagementPriority, telecomGroup=telecomGroup, transmitModulationMode=transmitModulationMode, timeZone=timeZone, masterSlaveMode=masterSlaveMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, alarmsGroup=alarmsGroup, l2CPPriorityTable=l2CPPriorityTable, smtp=smtp, linkModeOptimisation=linkModeOptimisation, telecomsChannelSelection=telecomsChannelSelection, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetPriorityTable=ethernetPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp600=ptp600, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, range=range, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, ethernetBridgingAvailability=ethernetBridgingAvailability, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTable=userTable, ptpCompliance=ptpCompliance, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitPower=transmitPower, userTableIndex=userTableIndex, hardwareVersion=hardwareVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelBCableLength=channelBCableLength, licence=licence, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, hAZLOCConfiguration=hAZLOCConfiguration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBLineCode=channelBLineCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, supplementaryGroup=supplementaryGroup, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, dataPortFiberStatusTrap=dataPortFiberStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, unitOutOfCalibration=unitOutOfCalibration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddressType=remoteInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, dfsTable=dfsTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installArmStateTrap=installArmStateTrap, configurationGroup=configurationGroup, dataPortStatus=dataPortStatus, secureModeAlarm=secureModeAlarm, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptmp=ptmp, channelACableLength=channelACableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetBridgingStatus=ethernetBridgingStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernet=ethernet, iPv6GatewayAddress=iPv6GatewayAddress, bridgeGroup=bridgeGroup, hTTPPortNumber=hTTPPortNumber, channelALoopback=channelALoopback, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, syslogStateTrap=syslogStateTrap, rangingMode=rangingMode, sNTPState=sNTPState, rawReceivePower=rawReceivePower, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, iPVersion=iPVersion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, channelBLoopback=channelBLoopback, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber, channelALoopbackTrap=channelALoopbackTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitFreqMHz=transmitFreqMHz, sNTPServerInternetAddress=sNTPServerInternetAddress, cambium=cambium, phyControlGroup=phyControlGroup, ptp=ptp, managementPortStatus=managementPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitChannel=transmitChannel, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, groupID=groupID, notificationsGroup=notificationsGroup, iPv6Address=iPv6Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, targetMACAddress=targetMACAddress, remoteInternetAddress=remoteInternetAddress, productVariant=productVariant, receiveModulationMode=receiveModulationMode, receivePower=receivePower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, regionCodeTrap=regionCodeTrap, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, channelALineCode=channelALineCode, linkSymmetry=linkSymmetry, snmpControl=snmpControl, receiveFreqMHz=receiveFreqMHz, telecomsChannelAStatus=telecomsChannelAStatus, accessMethod=accessMethod, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitDataRate=transmitDataRate, dfsTableNumber=dfsTableNumber, longitude=longitude, automaticTxPowerControl=automaticTxPowerControl, daylightSaving=daylightSaving, telecom=telecom, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, constantPowerSpectralDensity=constantPowerSpectralDensity, secondarySoftwareVersion=secondarySoftwareVersion, remoteRxTargetPower=remoteRxTargetPower)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, securityLevel=securityLevel, installStatusTrap=installStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDDControl=tDDControl, systemReset=systemReset, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyControl=phyControl, telnetAccessEnabled=telnetAccessEnabled, userName=userName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userPassword=userPassword, ethernetPriorityTableNumber=ethernetPriorityTableNumber, localPacketFiltering=localPacketFiltering, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPLastSync=sNTPLastSync, channelBLoopbackTrap=channelBLoopbackTrap, telecomsChannelBStatus=telecomsChannelBStatus, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, iPv4Address=iPv4Address, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableIndex=sNTPServerTableIndex, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, managementGroup=managementGroup, resetGroup=resetGroup, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower)
