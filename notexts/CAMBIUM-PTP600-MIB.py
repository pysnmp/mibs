...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installStatus=installStatus, phyControl=phyControl, syslogState=syslogState, frequencyVariant=frequencyVariant, bootVersion=bootVersion, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, dfsGroup=dfsGroup, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, sNTPServerRetries=sNTPServerRetries, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licence=licence, encryption=encryption, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulationMode=receiveModulationMode, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, groupID=groupID, versions=versions, telecomGroup=telecomGroup, longitude=longitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sntp=sntp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitChannel=transmitChannel, accessMethod=accessMethod, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStatsGroup=pubStatsGroup, sNTPServerStatus=sNTPServerStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortDisabledWarning=dataPortDisabledWarning, aggregateDataRate=aggregateDataRate, managementPortStatus=managementPortStatus, altitude=altitude, alarms=alarms, linkSymmetry=linkSymmetry, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, systemClock=systemClock, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, sNTPPrimaryServer=sNTPPrimaryServer, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, channelBLoopbackTrap=channelBLoopbackTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBandwidth=channelBandwidth, localPacketFiltering=localPacketFiltering, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementary=supplementary, aAAControlGroup=aAAControlGroup, cambium=cambium, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernet=ethernet, managementPortDisabledWarning=managementPortDisabledWarning, hardwareVersion=hardwareVersion, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarmsGroup=alarmsGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveDataRate=receiveDataRate, rawReceivePower=rawReceivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, dfsTable=dfsTable, receiveFreqMHz=receiveFreqMHz, secureModeAlarm=secureModeAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, managementPortStatusTrap=managementPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementMode=managementMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxColorCode=rxColorCode, txColorCode=txColorCode, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelSelection=telecomsChannelSelection, channelChangeTrap=channelChangeTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, remoteInternetAddress=remoteInternetAddress, userRole=userRole, latitude=latitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfs=dfs, iPDSCPPriorityTable=iPDSCPPriorityTable, telecom=telecom, reset=reset, sNTPState=sNTPState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsChannelBStatus=telecomsChannelBStatus, channelBCableLength=channelBCableLength, systemReset=systemReset, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelAStatus=telecomsChannelAStatus, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, syslogControl=syslogControl, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, targetMACAddress=targetMACAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, siteName=siteName, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, tDDControlGroup=tDDControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userTableNumber=userTableNumber, targetRange=targetRange, resetGroup=resetGroup, subnetMask=subnetMask, wirelessLinkStatus=wirelessLinkStatus, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, antennaGain=antennaGain, channelBLoopback=channelBLoopback, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, dSCPManagementPriority=dSCPManagementPriority, eIRP=eIRP, rangingMode=rangingMode, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, encryptionGroup=encryptionGroup, iPVersion=iPVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp600=ptp600, byteErrorRatio=byteErrorRatio, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, ethernetBridgingStatus=ethernetBridgingStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, searchState=searchState, securityLevel=securityLevel, dataPortStatusTrap=dataPortStatusTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, installArmState=installArmState, userTableEntry=userTableEntry, channelACableLength=channelACableLength, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, constantPowerSpectralDensity=constantPowerSpectralDensity, bridge=bridge, telecomsInterface=telecomsInterface, ptpCompliance=ptpCompliance, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configuration=configuration, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, channelALoopbackTrap=channelALoopbackTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteInternetAddressType=remoteInternetAddressType, sNTPServerTable=sNTPServerTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, channelBLineCode=channelBLineCode, remoteIPAddress=remoteIPAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, phyStatus=phyStatus, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTable=sNMPTrapTable, dfsPeaks=dfsPeaks, linkName=linkName, channelALineCode=channelALineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, regionCode=regionCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, automaticTxPowerControl=automaticTxPowerControl, linkLoss=linkLoss, ptmp=ptmp, sNTPServerTableNumber=sNTPServerTableNumber, userName=userName, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, userPassword=userPassword, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortAutoNegotiation=dataPortAutoNegotiation, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, hAZLOCConfiguration=hAZLOCConfiguration, syslogClientTrap=syslogClientTrap, ethernetFiberSupport=ethernetFiberSupport, notificationsGroup=notificationsGroup, channelALoopback=channelALoopback, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortFiberStatus=dataPortFiberStatus, bridgeGroup=bridgeGroup, l2CPPriorityTable=l2CPPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry)
