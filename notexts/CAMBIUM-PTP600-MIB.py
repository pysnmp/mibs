...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarms=alarms, remoteIPAddress=remoteIPAddress, tDDControlGroup=tDDControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, bridgeGroup=bridgeGroup, channelACableLength=channelACableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, searchState=searchState, sNTPSync=sNTPSync, ptp=ptp, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkName=linkName, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, userName=userName, channelALineCode=channelALineCode, versions=versions, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, channelBLoopback=channelBLoopback, tFTPServerInternetAddress=tFTPServerInternetAddress, notificationsGroup=notificationsGroup, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, subnetMask=subnetMask, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntp=sntp, installArmState=installArmState, dfsGroup=dfsGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hAZLOCConfiguration=hAZLOCConfiguration, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControl=phyControl, ptp600=ptp600, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControl=syslogControl, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, regionCodeTrap=regionCodeTrap, antennaGain=antennaGain, channelALoopback=channelALoopback, daylightSaving=daylightSaving, managementMode=managementMode, secureModeAlarmTrap=secureModeAlarmTrap, managementPortDisabledWarning=managementPortDisabledWarning, phyStatusGroup=phyStatusGroup, channelBLineCode=channelBLineCode, targetMACAddress=targetMACAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, syslogClient=syslogClient, managementPortStatus=managementPortStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapTable=sNMPTrapTable, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, management=management, dfsMeans=dfsMeans, iPv6Address=iPv6Address, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogControlGroup=syslogControlGroup, dataPortStatus=dataPortStatus, transmitChannel=transmitChannel, ethernet=ethernet, aAAControl=aAAControl, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productName=productName, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, automaticTxPowerControl=automaticTxPowerControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, ptpCompliance=ptpCompliance, encryption=encryption, telecomsChannelAStatus=telecomsChannelAStatus, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, sNTPLastSync=sNTPLastSync, txColorCode=txColorCode, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, hardwareVersion=hardwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, accessMethod=accessMethod, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, longitude=longitude, channelBandwidth=channelBandwidth, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, eIRP=eIRP, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vectorError=vectorError, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, userPassword=userPassword, userRole=userRole, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, dataPortFiberStatus=dataPortFiberStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPCommunityString=sNMPCommunityString, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, dSCPManagementPriority=dSCPManagementPriority, managementGroup=managementGroup, telecomsChannelSelection=telecomsChannelSelection, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, sNTPPrimaryServer=sNTPPrimaryServer, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionGroup=encryptionGroup, altitude=altitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapVersion=sNMPTrapVersion, channelBCableLength=channelBCableLength, sNTPServerTableNumber=sNTPServerTableNumber, timeZone=timeZone, localPacketFiltering=localPacketFiltering, targetRange=targetRange, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, rangingMode=rangingMode, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableEntry=userTableEntry, sNTPState=sNTPState, iPv4Address=iPv4Address, ethernetBridgingAvailability=ethernetBridgingAvailability, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, telecomsInterface=telecomsInterface, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, telecomsChannelBStatus=telecomsChannelBStatus, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, latitude=latitude, l2CPPriorityTable=l2CPPriorityTable, systemReset=systemReset, managementPortStatusTrap=managementPortStatusTrap, resetGroup=resetGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, syslogStateTrap=syslogStateTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfs=dfs, dfsTableIndex=dfsTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, masterSlaveMode=masterSlaveMode, iPVersion=iPVersion, dfsTableEntry=dfsTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableEntry=sNTPServerTableEntry, licence=licence, ethernetBridgingStatus=ethernetBridgingStatus, gatewayIPAddress=gatewayIPAddress, sNTPServerTable=sNTPServerTable, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, receivePower=receivePower, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sntpGroup=sntpGroup, rawReceivePower=rawReceivePower, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelALoopbackTrap=channelALoopbackTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, secureModeAlarm=secureModeAlarm, channelChangeTrap=channelChangeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDControl=tDDControl, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, qOSPriorityScheme=qOSPriorityScheme)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", alarmsGroup=alarmsGroup, dfsTableNumber=dfsTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, groupID=groupID, smtpGroup=smtpGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerTimeout=sNTPServerTimeout, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, securityLevel=securityLevel, sNMPPortNumber=sNMPPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTableIndex=sNTPServerTableIndex, supplementary=supplementary, configuration=configuration, iPv6GatewayAddress=iPv6GatewayAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, telecom=telecom, telnetPortNumber=telnetPortNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, signalStrengthRatio=signalStrengthRatio, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogState=syslogState, vLANManagementVID=vLANManagementVID, remoteInternetAddressType=remoteInternetAddressType, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, phyStatus=phyStatus, rxColorCode=rxColorCode, unitOutOfCalibration=unitOutOfCalibration, productVariant=productVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bridge=bridge, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerStatus=sNTPServerStatus, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, telecomGroup=telecomGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats)
