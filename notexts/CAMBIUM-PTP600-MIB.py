...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, latitude=latitude, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, supplementaryGroup=supplementaryGroup, sNTPServerTimeout=sNTPServerTimeout, telnetPortNumber=telnetPortNumber, installArmState=installArmState, cambium=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerStatus=sNTPServerStatus, ptp600=ptp600, hAZLOCConfiguration=hAZLOCConfiguration, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, sNMPEnabledTraps=sNMPEnabledTraps, pubStats=pubStats, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, groupID=groupID, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerRetries=sNTPServerRetries, targetRange=targetRange, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, receiveDataRate=receiveDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bridgeGroup=bridgeGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, txColorCode=txColorCode, smtp=smtp, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, managementPortStatus=managementPortStatus, eIRP=eIRP, tFTPServerInternetAddress=tFTPServerInternetAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTraps=ptpTraps, channelBLoopback=channelBLoopback, userTableEntry=userTableEntry, rxColorCode=rxColorCode, vectorError=vectorError, transmitDataRate=transmitDataRate, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, channelALineCode=channelALineCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, rangingMode=rangingMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogState=syslogState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, secureModeAlarm=secureModeAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, snmpControl=snmpControl, installStatus=installStatus, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, bridge=bridge, masterSlaveMode=masterSlaveMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteRxTargetPower=remoteRxTargetPower, dfsMeans=dfsMeans, managementMode=managementMode, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, bootVersion=bootVersion, channelBLineCode=channelBLineCode, userTableIndex=userTableIndex, phyControl=phyControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, remoteInternetAddressType=remoteInternetAddressType, dfsTable=dfsTable, channelACableLength=channelACableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, telecom=telecom, alarmsGroup=alarmsGroup, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, longitude=longitude, dfs=dfs, channelALoopbackTrap=channelALoopbackTrap, phyControlGroup=phyControlGroup, aAAControlGroup=aAAControlGroup, configuration=configuration, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, tDDControl=tDDControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, reset=reset, ptpCompliance=ptpCompliance, daylightSaving=daylightSaving, managementPortStatusTrap=managementPortStatusTrap, licenceGroup=licenceGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, searchState=searchState, vLANManagementPriority=vLANManagementPriority, iPv6GatewayAddress=iPv6GatewayAddress, accessMethod=accessMethod, smtpGroup=smtpGroup, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimisation=linkModeOptimisation, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, resetGroup=resetGroup, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, versionsGroup=versionsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, supplementary=supplementary, managementPortDisabledWarning=managementPortDisabledWarning, encryption=encryption, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetGroup=ethernetGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptpGroups=ptpGroups, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, channelBLoopbackTrap=channelBLoopbackTrap, receiveModulationModeDetail=receiveModulationModeDetail, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, range=range, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPState=sNTPState, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTable=ethernetPriorityTable, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementGroup=managementGroup, dataPortStatus=dataPortStatus, productName=productName, secureModeAlarmTrap=secureModeAlarmTrap, telecomsChannelAStatus=telecomsChannelAStatus, tDDControlGroup=tDDControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerTableIndex=sNTPServerTableIndex, sntp=sntp, iPVersion=iPVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, automaticTxPowerControl=automaticTxPowerControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelSelection=telecomsChannelSelection, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableNumber=dfsTableNumber, siteName=siteName, dfsTableIndex=dfsTableIndex, phyStatusGroup=phyStatusGroup, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6Address=iPv6Address, regionCodeTrap=regionCodeTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, management=management, subnetMask=subnetMask, ethernetBridgingStatus=ethernetBridgingStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernet=ethernet, sntpGroup=sntpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, syslogStateTrap=syslogStateTrap, timeZone=timeZone, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, securityLevel=securityLevel, systemReset=systemReset, iPv6PrefixLength=iPv6PrefixLength, userTable=userTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, altitude=altitude, l2CPPriorityTable=l2CPPriorityTable, alarms=alarms, dfsPeaks=dfsPeaks, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, sNTPSync=sNTPSync, sMTPServerInternetAddress=sMTPServerInternetAddress, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelALoopback=channelALoopback, telecomsInterface=telecomsInterface, dSCPManagementPriority=dSCPManagementPriority, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", rawReceivePower=rawReceivePower, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, pubStatsGroup=pubStatsGroup, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, receiveChannel=receiveChannel, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveFreqMHz=receiveFreqMHz, dfsTableEntry=dfsTableEntry, iPv4Address=iPv4Address, telecomGroup=telecomGroup, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, byteErrorRatio=byteErrorRatio, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, remoteIPAddress=remoteIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, linkLoss=linkLoss, hardwareVersion=hardwareVersion, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regionCode=regionCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, versions=versions, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, ethernetBridgingAvailability=ethernetBridgingAvailability, channelChangeTrap=channelChangeTrap, installStatusTrap=installStatusTrap, qOSPriorityScheme=qOSPriorityScheme, encryptionGroup=encryptionGroup, transmitChannel=transmitChannel, channelBCableLength=channelBCableLength)
