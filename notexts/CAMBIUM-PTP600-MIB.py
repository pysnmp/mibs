...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, ptp600=ptp600, transmitPower=transmitPower, ptp=ptp, sNTPServerStatus=sNTPServerStatus, targetRange=targetRange, receiveFreqKHz=receiveFreqKHz, sNTPState=sNTPState, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTable=l2CPPriorityTable, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelALineCode=channelALineCode, aAAControl=aAAControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userPassword=userPassword, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, installStatusTrap=installStatusTrap, cableLoss=cableLoss, dataPortFiberStatusTrap=dataPortFiberStatusTrap, reset=reset, ptpGroups=ptpGroups, automaticTxPowerControl=automaticTxPowerControl, phyStatus=phyStatus, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEmailAlert=sMTPEmailAlert, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, timeZone=timeZone, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, versions=versions, incompatibleRegionCodes=incompatibleRegionCodes, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, rxColorCode=rxColorCode, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, dSCPManagementPriority=dSCPManagementPriority, alarms=alarms, sNMPCommunityString=sNMPCommunityString, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTimeout=sNTPServerTimeout, resetGroup=resetGroup, managementMode=managementMode, transmitDataRate=transmitDataRate, management=management, iPv6PrefixLength=iPv6PrefixLength, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aggregateDataRate=aggregateDataRate, longitude=longitude, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPLastSync=sNTPLastSync, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortFiberStatus=dataPortFiberStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBCableLength=channelBCableLength, installStatus=installStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, channelALoopback=channelALoopback, ethernetGroup=ethernetGroup, receiveModulationModeDetail=receiveModulationModeDetail, channelACableLength=channelACableLength, securityLevel=securityLevel, sNTPServerTableNumber=sNTPServerTableNumber, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitChannel=transmitChannel, channelBLineCode=channelBLineCode, sNTPServerTableEntry=sNTPServerTableEntry, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, userName=userName, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, installArmState=installArmState, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, qOSPriorityScheme=qOSPriorityScheme, licence=licence, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, ptpCompliance=ptpCompliance, ethernetPriorityTableNumber=ethernetPriorityTableNumber, masterSlaveMode=masterSlaveMode, sNTPServerRetries=sNTPServerRetries, secureModeAlarmTrap=secureModeAlarmTrap, systemReset=systemReset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, syslogControlGroup=syslogControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sntpGroup=sntpGroup, iPv6Address=iPv6Address, dfsTableIndex=dfsTableIndex, sNTPSync=sNTPSync, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, channelALoopbackTrap=channelALoopbackTrap, bridge=bridge, configuration=configuration, encryptionGroup=encryptionGroup, frequencyVariant=frequencyVariant, transmitFreqKHz=transmitFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, latitude=latitude, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dfs=dfs, channelBandwidth=channelBandwidth, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, vLANManagementPriority=vLANManagementPriority, localPacketFiltering=localPacketFiltering, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoMdix=dataPortAutoMdix, sntp=sntp, telecomsInterface=telecomsInterface, telecomsChannelBStatus=telecomsChannelBStatus, phyControl=phyControl, bandwidthVariant=bandwidthVariant, tFTPServerInternetAddressType=tFTPServerInternetAddressType, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, snmpControlGroup=snmpControlGroup, secureModeAlarm=secureModeAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv6GatewayAddress=iPv6GatewayAddress, rangingMode=rangingMode, gatewayIPAddress=gatewayIPAddress, dfsTable=dfsTable, rawReceivePower=rawReceivePower, regionCode=regionCode, linkName=linkName, phyControlGroup=phyControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityTable=ethernetPriorityTable, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, channelBLoopback=channelBLoopback, syslogControl=syslogControl, dfsPeaks=dfsPeaks, managementPortStatus=managementPortStatus, remoteRxTargetPower=remoteRxTargetPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTable=sNMPTrapTable, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelChangeTrap=channelChangeTrap, managementPortStatusTrap=managementPortStatusTrap, userTable=userTable, hTTPPortNumber=hTTPPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userRole=userRole, ptmp=ptmp, managementGroup=managementGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerTable=sNTPServerTable, signalStrengthRatio=signalStrengthRatio, targetMACAddress=targetMACAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, dataPortStatus=dataPortStatus, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPv4Address=iPv4Address, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridgeGroup=bridgeGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, transmitFreqMHz=transmitFreqMHz, userTableNumber=userTableNumber, cambium=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControl=snmpControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddress=remoteInternetAddress, linkSymmetry=linkSymmetry, mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", wirelessLinkAvailability=wirelessLinkAvailability, alarmsGroup=alarmsGroup, siteName=siteName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, smtp=smtp, hAZLOCConfiguration=hAZLOCConfiguration, accessMethod=accessMethod, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecom=telecom, vLANManagementVID=vLANManagementVID, aAAControlGroup=aAAControlGroup, versionsGroup=versionsGroup, iPVersion=iPVersion, ptpTraps=ptpTraps, telecomsChannelSelection=telecomsChannelSelection, receivePower=receivePower, dfsMeans=dfsMeans, productVariant=productVariant, encryptionAlgorithm=encryptionAlgorithm, remoteInternetAddressType=remoteInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, range=range, configurationGroup=configurationGroup, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, supplementary=supplementary, receiveDataRate=receiveDataRate, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, daylightSaving=daylightSaving, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, supplementaryGroup=supplementaryGroup, dfsGroup=dfsGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, encryption=encryption)
