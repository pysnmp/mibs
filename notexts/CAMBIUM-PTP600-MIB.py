...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", txColorCode=txColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, timeZone=timeZone, groupID=groupID, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, installArmState=installArmState, searchState=searchState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, supplementaryGroup=supplementaryGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, linkModeOptimisation=linkModeOptimisation, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, userTableNumber=userTableNumber, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPVersion=iPVersion, transmitChannel=transmitChannel, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, dfsMeans=dfsMeans, channelBLoopback=channelBLoopback, sNTPState=sNTPState, siteName=siteName, tFTPServerInternetAddress=tFTPServerInternetAddress, range=range, sMTPServerIPAddress=sMTPServerIPAddress, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, alarms=alarms, reset=reset, sNTPServerTimeout=sNTPServerTimeout, installArmStateTrap=installArmStateTrap, securityLevel=securityLevel, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, userName=userName, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cambium=cambium, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBLineCode=channelBLineCode, targetRange=targetRange, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, sNTPServerTableEntry=sNTPServerTableEntry, vLANManagementPriority=vLANManagementPriority, telecom=telecom, dataPortFiberStatus=dataPortFiberStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userPassword=userPassword, remoteInternetAddressType=remoteInternetAddressType, bootVersion=bootVersion, daylightSaving=daylightSaving, ptpGroups=ptpGroups, sNTPServerTable=sNTPServerTable, receiveFreqMHz=receiveFreqMHz, managementMode=managementMode, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, smtpGroup=smtpGroup, encryption=encryption, snmpControlGroup=snmpControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALoopback=channelALoopback, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rangingMode=rangingMode, installStatus=installStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureModeAlarm=secureModeAlarm, userTableIndex=userTableIndex, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, dataPortStatus=dataPortStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, syslogState=syslogState, licenceGroup=licenceGroup, regionCodeTrap=regionCodeTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, managementPortStatus=managementPortStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsPeaks=dfsPeaks, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, automaticTxPowerControl=automaticTxPowerControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetGroup=ethernetGroup, aAAControl=aAAControl, l2CPPriorityTable=l2CPPriorityTable, bandwidthVariant=bandwidthVariant, sNTPServerTableNumber=sNTPServerTableNumber, productVariant=productVariant, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, pubStatsGroup=pubStatsGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, iPv6GatewayAddress=iPv6GatewayAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, systemReset=systemReset, regionCode=regionCode, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, phyStatus=phyStatus, pubStats=pubStats, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, ethernetBridgingStatus=ethernetBridgingStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, notificationsGroup=notificationsGroup, sNTPPrimaryServer=sNTPPrimaryServer, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, localPacketFiltering=localPacketFiltering, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPCommunityString=sNMPCommunityString, altitude=altitude, snmpControl=snmpControl, hAZLOCConfiguration=hAZLOCConfiguration, antennaGain=antennaGain, targetMACAddress=targetMACAddress, telecomsChannelSelection=telecomsChannelSelection, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6PrefixLength=iPv6PrefixLength, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, rawReceivePower=rawReceivePower, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, cableLoss=cableLoss, softwareVersion=softwareVersion, versions=versions, management=management, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerRetries=sNTPServerRetries, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, channelALineCode=channelALineCode, sNTPServerStatus=sNTPServerStatus, channelACableLength=channelACableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, linkSymmetry=linkSymmetry, frequencyVariant=frequencyVariant, transmitFreqMHz=transmitFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, dfsGroup=dfsGroup, bridgeGroup=bridgeGroup, ptp600=ptp600, smtp=smtp, tDDControl=tDDControl, receiveModulationMode=receiveModulationMode, latitude=latitude, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, managementPortDisabledWarning=managementPortDisabledWarning, productName=productName, telnetPortNumber=telnetPortNumber, userTable=userTable, dSCPManagementPriority=dSCPManagementPriority, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementGroup=managementGroup, ptmp=ptmp, versionsGroup=versionsGroup, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, channelALoopbackTrap=channelALoopbackTrap, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, iPv6Address=iPv6Address, resetGroup=resetGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsTableNumber=dfsTableNumber, remoteInternetAddress=remoteInternetAddress, masterSlaveMode=masterSlaveMode, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, vectorError=vectorError, secureModeAlarmTrap=secureModeAlarmTrap, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sntpGroup=sntpGroup, receivePower=receivePower, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, configuration=configuration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementary=supplementary, sNTPServerInternetAddress=sNTPServerInternetAddress, linkName=linkName, linkLoss=linkLoss, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, licence=licence, userRole=userRole, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, syslogControl=syslogControl, userTableEntry=userTableEntry, userEnabled=userEnabled, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, phyControlGroup=phyControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, channelBCableLength=channelBCableLength, hardwareVersion=hardwareVersion, remoteRxTargetPower=remoteRxTargetPower, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, eIRP=eIRP, bridge=bridge, ptpTrapPrefix=ptpTrapPrefix, managementPortStatusTrap=managementPortStatusTrap, channelBLoopbackTrap=channelBLoopbackTrap, hTTPPortNumber=hTTPPortNumber, iPv4Address=iPv4Address)
