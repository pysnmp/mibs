...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", channelALoopbackTrap=channelALoopbackTrap, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6Address=iPv6Address, ethernetBridgingStatus=ethernetBridgingStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelACableLength=channelACableLength, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, hTTPSPortNumber=hTTPSPortNumber, bandwidthVariant=bandwidthVariant, securityLevel=securityLevel, ptp600=ptp600, remoteInternetAddressType=remoteInternetAddressType, hAZLOCConfiguration=hAZLOCConfiguration, telnetPortNumber=telnetPortNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, syslogControlGroup=syslogControlGroup, masterSlaveMode=masterSlaveMode, channelBLoopback=channelBLoopback, sNTPServerPortNumber=sNTPServerPortNumber, ethernetBridgingAvailability=ethernetBridgingAvailability, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rangingMode=rangingMode, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControl=phyControl, groupID=groupID, cambium=cambium, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, targetRange=targetRange, syslogControl=syslogControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, configuration=configuration, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, versionsGroup=versionsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelBCableLength=channelBCableLength, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, channelALoopback=channelALoopback, ptpTraps=ptpTraps, remoteInternetAddress=remoteInternetAddress, dataPortFiberStatus=dataPortFiberStatus, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, aggregateDataRate=aggregateDataRate, aAAControl=aAAControl, altitude=altitude, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, aAAControlGroup=aAAControlGroup, telecomsChannelAStatus=telecomsChannelAStatus, channelBLineCode=channelBLineCode, transmitModulationMode=transmitModulationMode, systemClock=systemClock, syslogState=syslogState, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, smtpGroup=smtpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPState=sNTPState, syslogStateTrap=syslogStateTrap, automaticTxPowerControl=automaticTxPowerControl, licenceGroup=licenceGroup, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, txColorCode=txColorCode, managementMode=managementMode, sNTPSyncTrap=sNTPSyncTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveFreqMHz=receiveFreqMHz, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, syslogClient=syslogClient, sNTPServerTable=sNTPServerTable, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, sNTPPollInterval=sNTPPollInterval, alarms=alarms, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, encryptionAlgorithm=encryptionAlgorithm, remoteRxTargetPower=remoteRxTargetPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatusTrap=installStatusTrap, searchState=searchState, secureModeAlarm=secureModeAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, versions=versions, range=range, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqKHz=transmitFreqKHz, channelALineCode=channelALineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, userName=userName, iPVersion=iPVersion, bridge=bridge, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityTable=mPLSTCPriorityTable, telecomsInterface=telecomsInterface, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoMdix=dataPortAutoMdix, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, regionCode=regionCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPv3Enable=sNMPv3Enable, sNTPSync=sNTPSync, dfsPeaks=dfsPeaks, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, qOSPriorityScheme=qOSPriorityScheme, sNTPServerRetries=sNTPServerRetries, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDControl=tDDControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, telecom=telecom, iPv4Address=iPv4Address, managementGroup=managementGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, wirelessLinkAvailability=wirelessLinkAvailability, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerTableEntry=sNTPServerTableEntry, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, userTable=userTable, cableLoss=cableLoss, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, vLANManagementPriority=vLANManagementPriority, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveModulationModeDetail=receiveModulationModeDetail, managementPortDisabledWarning=managementPortDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, supplementaryGroup=supplementaryGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licence=licence, ethernetPriorityTable=ethernetPriorityTable, ptmp=ptmp, dfsTableIndex=dfsTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, pubStats=pubStats, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPPrimaryServer=sNTPPrimaryServer, dfs=dfs, rxColorCode=rxColorCode, sNTPServerTableIndex=sNTPServerTableIndex, userEnabled=userEnabled, userPassword=userPassword, smtp=smtp, linkName=linkName, timeZone=timeZone, syslogClientTrap=syslogClientTrap, userRole=userRole, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, dfsTable=dfsTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, installStatus=installStatus, pubStatsGroup=pubStatsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkLoss=linkLoss, dfsTableNumber=dfsTableNumber, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, managementPortStatus=managementPortStatus, sNTPServerTimeout=sNTPServerTimeout, sntpGroup=sntpGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, encryption=encryption, productName=productName, sNTPServerStatus=sNTPServerStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, subnetMask=subnetMask)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", vectorError=vectorError, rawReceivePower=rawReceivePower, regionCodeTrap=regionCodeTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsMeans=dfsMeans, userTableEntry=userTableEntry, localPacketFiltering=localPacketFiltering, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alarmsGroup=alarmsGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, bridgeGroup=bridgeGroup, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, softwareVersion=softwareVersion, managementPortStatusTrap=managementPortStatusTrap, encryptionGroup=encryptionGroup, iPv6GatewayAddress=iPv6GatewayAddress, bootVersion=bootVersion, accessMethod=accessMethod, transmitFreqMHz=transmitFreqMHz, management=management, ptpTrapPrefix=ptpTrapPrefix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, latitude=latitude, userTableIndex=userTableIndex, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, installArmState=installArmState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary)
