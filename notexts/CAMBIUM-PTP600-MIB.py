...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPServerPortNumber=sNTPServerPortNumber, cambium=cambium, userTable=userTable, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telnetPortNumber=telnetPortNumber, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarm=secureModeAlarm, sMTPEmailAlert=sMTPEmailAlert, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatusGroup=phyStatusGroup, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptp600=ptp600, vLANManagementVID=vLANManagementVID, telecomsChannelAStatus=telecomsChannelAStatus, receiveFreqKHz=receiveFreqKHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, linkName=linkName, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, secureModeAlarmTrap=secureModeAlarmTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptmp=ptmp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, smtpGroup=smtpGroup, securityLevel=securityLevel, transmitDataRate=transmitDataRate, ethernetBridgingStatus=ethernetBridgingStatus, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, transmitFreqMHz=transmitFreqMHz, sNTPServerRetries=sNTPServerRetries, installArmStateTrap=installArmStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerStatus=sNTPServerStatus, notificationsGroup=notificationsGroup, dSCPManagementPriority=dSCPManagementPriority, rangingMode=rangingMode, sNTPPrimaryServer=sNTPPrimaryServer, iPv6PrefixLength=iPv6PrefixLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptp=ptp, dfs=dfs, supplementaryGroup=supplementaryGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, pubStats=pubStats, iPDSCPPriorityTable=iPDSCPPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableNumber=userTableNumber, userTableIndex=userTableIndex, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, hTTPPortNumber=hTTPPortNumber, syslogStateTrap=syslogStateTrap, vectorError=vectorError, channelBLoopbackTrap=channelBLoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqKHz=transmitFreqKHz, receiveModulationMode=receiveModulationMode, dataPortAutoMdix=dataPortAutoMdix, managementPortStatus=managementPortStatus, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerTable=sNTPServerTable, receiveModulationModeDetail=receiveModulationModeDetail, hAZLOCConfiguration=hAZLOCConfiguration, syslogControl=syslogControl, targetMACAddress=targetMACAddress, ptpCompliance=ptpCompliance, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, remoteRxTargetPower=remoteRxTargetPower, cableLoss=cableLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelALineCode=channelALineCode, bootVersion=bootVersion, phyControl=phyControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelALoopbackTrap=channelALoopbackTrap, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, alarms=alarms, syslogClient=syslogClient, latitude=latitude, frequencyVariant=frequencyVariant, telecom=telecom, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, automaticTxPowerControl=automaticTxPowerControl, aAAControlGroup=aAAControlGroup, range=range, userTableEntry=userTableEntry, receiveDataRate=receiveDataRate, sNTPSync=sNTPSync, altitude=altitude, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, licence=licence, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userRole=userRole, sNTPServerTimeout=sNTPServerTimeout, versionsGroup=versionsGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, management=management, channelBLineCode=channelBLineCode, txColorCode=txColorCode, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, linkLoss=linkLoss, rawReceivePower=rawReceivePower, systemReset=systemReset, dfsPeaks=dfsPeaks, regionCode=regionCode, noWirelessChannelAvailable=noWirelessChannelAvailable, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, managementPortStatusTrap=managementPortStatusTrap, dataPortStatus=dataPortStatus, eIRP=eIRP, ethernetPriorityTable=ethernetPriorityTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, targetRange=targetRange, installStatus=installStatus, channelBLoopback=channelBLoopback, sNTPServerTableNumber=sNTPServerTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntp=sntp, syslogClientTrap=syslogClientTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, dfsTable=dfsTable, channelBandwidth=channelBandwidth, timeZone=timeZone, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelALoopback=channelALoopback, longitude=longitude, bridge=bridge, ethernetGroup=ethernetGroup, iPv4Address=iPv4Address, receivePower=receivePower, syslogControlGroup=syslogControlGroup, channelBCableLength=channelBCableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortFiberStatus=dataPortFiberStatus, sMTPServerIPAddress=sMTPServerIPAddress, managementMode=managementMode, sMTPServerInternetAddress=sMTPServerInternetAddress, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, sNMPTrapVersion=sNMPTrapVersion, vLANManagementPriority=vLANManagementPriority, remoteInternetAddress=remoteInternetAddress, searchState=searchState, sNTPServerTableIndex=sNTPServerTableIndex, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, localPacketFiltering=localPacketFiltering, aggregateDataRate=aggregateDataRate, managementGroup=managementGroup, transmitPower=transmitPower, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkAvailability=wirelessLinkAvailability, smtp=smtp, byteErrorRatio=byteErrorRatio, userName=userName, sNTPServerTableEntry=sNTPServerTableEntry, telecomsInterface=telecomsInterface, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, channelACableLength=channelACableLength, managementPortDisabledWarning=managementPortDisabledWarning, telecomGroup=telecomGroup, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteInternetAddressType=remoteInternetAddressType, resetGroup=resetGroup, rxColorCode=rxColorCode, sNTPSyncTrap=sNTPSyncTrap, iPv6GatewayAddress=iPv6GatewayAddress, encryption=encryption, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerPortNumber=tFTPServerPortNumber, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, l2CPPriorityTable=l2CPPriorityTable, installStatusTrap=installStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dfsTableNumber=dfsTableNumber, managementPortConfigurationMismatch=managementPortConfigurationMismatch, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, syslogState=syslogState, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveChannel=receiveChannel, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, productName=productName, systemClock=systemClock, sntpGroup=sntpGroup, ethernet=ethernet, linkSymmetry=linkSymmetry, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, telecomsChannelSelection=telecomsChannelSelection, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, siteName=siteName, signalStrengthRatio=signalStrengthRatio, sNTPState=sNTPState, configurationGroup=configurationGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControl=tDDControl, iPVersion=iPVersion, qOSPriorityScheme=qOSPriorityScheme, accessMethod=accessMethod, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, subnetMask=subnetMask, reset=reset, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, userPassword=userPassword, versions=versions, sNMPCommunityString=sNMPCommunityString)
