...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, configurationGroup=configurationGroup, systemClock=systemClock, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkName=linkName, vLANManagementPriority=vLANManagementPriority, txColorCode=txColorCode, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, latitude=latitude, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, dfsTableNumber=dfsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, phyControl=phyControl, licence=licence, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, qOSPriorityScheme=qOSPriorityScheme, linkSymmetry=linkSymmetry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, versions=versions, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, targetRange=targetRange, telnetAccessEnabled=telnetAccessEnabled, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkStatus=wirelessLinkStatus, telecomsChannelAStatus=telecomsChannelAStatus, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, securityLevel=securityLevel, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, telecom=telecom, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, channelALoopbackTrap=channelALoopbackTrap, supplementary=supplementary, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, productVariant=productVariant, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, syslogClient=syslogClient, ethernet=ethernet, dataPortFiberStatus=dataPortFiberStatus, softwareVersion=softwareVersion, ptp=ptp, tDDControl=tDDControl, dfs=dfs, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetFiberSupport=ethernetFiberSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsPeaks=dfsPeaks, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, syslogStateTrap=syslogStateTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBCableLength=channelBCableLength, managementMode=managementMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementPortStatus=managementPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, sMTPServerInternetAddressType=sMTPServerInternetAddressType, smtp=smtp, resetGroup=resetGroup, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, versionsGroup=versionsGroup, antennaGain=antennaGain, localPacketFiltering=localPacketFiltering, installArmState=installArmState, hardwareVersion=hardwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, range=range, receiveChannel=receiveChannel, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, channelACableLength=channelACableLength, transmitChannel=transmitChannel, sNTPState=sNTPState, userPassword=userPassword, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, mPLSTCPriorityTable=mPLSTCPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, cambium=cambium, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, regionCode=regionCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, syslogClientTrap=syslogClientTrap, l2CPPriorityTable=l2CPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, iPVersion=iPVersion, encryptionAlgorithm=encryptionAlgorithm, encryption=encryption, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv4Address=iPv4Address, rxColorCode=rxColorCode, sNTPSync=sNTPSync, altitude=altitude, sntp=sntp, pubStatsGroup=pubStatsGroup, vectorError=vectorError, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, eIRP=eIRP, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, secureModeAlarmTrap=secureModeAlarmTrap, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsMeans=dfsMeans, iPv6PrefixLength=iPv6PrefixLength, userName=userName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, automaticTxPowerControl=automaticTxPowerControl, sNTPPrimaryServer=sNTPPrimaryServer, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, sNTPServerTableNumber=sNTPServerTableNumber, channelALineCode=channelALineCode, syslogState=syslogState, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, management=management, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, transmitDataRate=transmitDataRate, dfsGroup=dfsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, timeZone=timeZone, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationMode=tDDSynchronizationMode, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, ethernetBridgingStatus=ethernetBridgingStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTable=dfsTable, channelBLoopback=channelBLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerTableEntry=sNTPServerTableEntry, secureModeAlarm=secureModeAlarm, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddressType=sNTPServerInternetAddressType, bootVersion=bootVersion, linkModeOptimisation=linkModeOptimisation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, reset=reset, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp600=ptp600, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, managementGroup=managementGroup, daylightSaving=daylightSaving, sntpGroup=sntpGroup, channelBLoopbackTrap=channelBLoopbackTrap, aAAControl=aAAControl, sNTPServerStatus=sNTPServerStatus, bridgeGroup=bridgeGroup, ptpCompliance=ptpCompliance, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, dataPortStatus=dataPortStatus, configuration=configuration, remoteIPAddress=remoteIPAddress, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, productName=productName)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableIndex=dfsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPSyncTrap=sNTPSyncTrap, managementPortStatusTrap=managementPortStatusTrap, bridge=bridge, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, subnetMask=subnetMask, hAZLOCConfiguration=hAZLOCConfiguration, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rangingMode=rangingMode, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, iPv6Address=iPv6Address, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, userTable=userTable, userTableIndex=userTableIndex, searchState=searchState, ethernetBridgingAvailability=ethernetBridgingAvailability, masterSlaveMode=masterSlaveMode, sNMPv3Enable=sNMPv3Enable, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulationMode=receiveModulationMode, channelBLineCode=channelBLineCode, rawReceivePower=rawReceivePower, managementPortDisabledWarning=managementPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, channelALoopback=channelALoopback, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
