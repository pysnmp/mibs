...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", subnetMask=subnetMask, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, sNTPServerPortNumber=sNTPServerPortNumber, dataPortFiberStatus=dataPortFiberStatus, configurationGroup=configurationGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfs=dfs, userTableIndex=userTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, phyStatus=phyStatus, encryptionGroup=encryptionGroup, ethernetFiberSupport=ethernetFiberSupport, byteErrorRatio=byteErrorRatio, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, remoteRxTargetPower=remoteRxTargetPower, dfsTable=dfsTable, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, sNTPServerTableEntry=sNTPServerTableEntry, transmitModulationMode=transmitModulationMode, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, latitude=latitude, ethernet=ethernet, snmpControlGroup=snmpControlGroup, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogClient=syslogClient, iPVersion=iPVersion, telecomsChannelSelection=telecomsChannelSelection, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, productName=productName, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteIPAddress=remoteIPAddress, receivePower=receivePower, channelBLineCode=channelBLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, localPacketFiltering=localPacketFiltering, dfsTableNumber=dfsTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimisation=linkModeOptimisation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTable=ethernetPriorityTable, bandwidthVariant=bandwidthVariant, rangingMode=rangingMode, userEnabled=userEnabled, syslogState=syslogState, channelBLoopback=channelBLoopback, daylightSaving=daylightSaving, telecomsChannelAStatus=telecomsChannelAStatus, productVariant=productVariant, receiveDataRate=receiveDataRate, userTable=userTable, channelACableLength=channelACableLength, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityTable=iPDSCPPriorityTable, accessMethod=accessMethod, bridgeGroup=bridgeGroup, sNTPPrimaryServer=sNTPPrimaryServer, masterSlaveMode=masterSlaveMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, pubStats=pubStats, telecomGroup=telecomGroup, remoteInternetAddress=remoteInternetAddress, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, managementPortStatus=managementPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, telecomsChannelBStatus=telecomsChannelBStatus, vectorError=vectorError, siteName=siteName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPState=sNTPState, hTTPSPortNumber=hTTPSPortNumber, licence=licence, managementPortDisabledWarning=managementPortDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerTableIndex=sNTPServerTableIndex, telecomsInterface=telecomsInterface, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitChannel=transmitChannel, mPLSTCPriorityTable=mPLSTCPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, tDDControl=tDDControl, sNTPLastSync=sNTPLastSync, userRole=userRole, versions=versions, secureModeAlarmTrap=secureModeAlarmTrap, hAZLOCConfiguration=hAZLOCConfiguration, rxColorCode=rxColorCode, txColorCode=txColorCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, iPv6GatewayAddress=iPv6GatewayAddress, phyStatusGroup=phyStatusGroup, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPServerInternetAddress=sMTPServerInternetAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, bridge=bridge, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, rawReceivePower=rawReceivePower, qOSPriorityScheme=qOSPriorityScheme, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementVID=vLANManagementVID, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, dSCPManagementPriority=dSCPManagementPriority, ethernetBridgingStatus=ethernetBridgingStatus, automaticTxPowerControl=automaticTxPowerControl, range=range, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, userName=userName, dfsMeans=dfsMeans, encryptionAlgorithm=encryptionAlgorithm, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, secureModeAlarm=secureModeAlarm, dataPortAutoMdix=dataPortAutoMdix, sntpGroup=sntpGroup, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryption=encryption, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ptp600=ptp600, linkSymmetry=linkSymmetry, softwareVersion=softwareVersion, installStatusTrap=installStatusTrap, userTableNumber=userTableNumber, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControl=phyControl, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, telecom=telecom, aAAControlGroup=aAAControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelALineCode=channelALineCode, receiveFreqKHz=receiveFreqKHz, ptpGroups=ptpGroups, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, timeZone=timeZone, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemClock=systemClock, channelALoopbackTrap=channelALoopbackTrap, installArmState=installArmState, syslogControlGroup=syslogControlGroup, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControl=aAAControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTable=sNTPServerTable, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, syslogControl=syslogControl, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerStatus=sNTPServerStatus, maximumTransmitPower=maximumTransmitPower, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatus=wirelessLinkStatus, iPv6Address=iPv6Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, transmitPower=transmitPower, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, notificationsGroup=notificationsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, systemReset=systemReset, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, smtp=smtp, l2CPPriorityTable=l2CPPriorityTable, sntp=sntp, channelALoopback=channelALoopback, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, regionCode=regionCode, eIRP=eIRP, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveChannel=receiveChannel, sNTPServerTableNumber=sNTPServerTableNumber, bootVersion=bootVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", configuration=configuration, targetRange=targetRange, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, smtpGroup=smtpGroup, channelBLoopbackTrap=channelBLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableEntry=dfsTableEntry, syslogStateTrap=syslogStateTrap, groupID=groupID, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, managementPortStatusTrap=managementPortStatusTrap, channelBandwidth=channelBandwidth, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, longitude=longitude, alarms=alarms, installArmStateTrap=installArmStateTrap, reset=reset, cambium=cambium, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6PrefixLength=iPv6PrefixLength, ptpCompliance=ptpCompliance, channelBCableLength=channelBCableLength, sNTPServerTimeout=sNTPServerTimeout, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, managementMode=managementMode, installStatus=installStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remoteInternetAddressType=remoteInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority, securityLevel=securityLevel)
