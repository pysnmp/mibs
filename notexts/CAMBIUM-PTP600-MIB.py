...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, sNTPState=sNTPState, dSCPManagementPriority=dSCPManagementPriority, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, dfs=dfs, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, ptmp=ptmp, remoteInternetAddress=remoteInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, localPacketFiltering=localPacketFiltering, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, ethernetBridgingAvailability=ethernetBridgingAvailability, transmitFreqKHz=transmitFreqKHz, userTableNumber=userTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPVersion=iPVersion, channelALoopback=channelALoopback, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, sNTPServerStatus=sNTPServerStatus, sntpGroup=sntpGroup, transmitPower=transmitPower, aAAControlGroup=aAAControlGroup, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, longitude=longitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, reset=reset, syslogControl=syslogControl, ptpCompliance=ptpCompliance, txColorCode=txColorCode, vectorError=vectorError, sNTPPrimaryServer=sNTPPrimaryServer, dfsGroup=dfsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bandwidthVariant=bandwidthVariant, ptpTraps=ptpTraps, targetRange=targetRange, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, iPv4Address=iPv4Address, securityLevel=securityLevel, encryptionGroup=encryptionGroup, sNTPSync=sNTPSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, qOSPriorityScheme=qOSPriorityScheme, channelALineCode=channelALineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, sNMPCommunityString=sNMPCommunityString, bridgeGroup=bridgeGroup, userName=userName, antennaGain=antennaGain, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsTable=dfsTable, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, PYSNMP_MODULE_ID=cambium, telecomGroup=telecomGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitDataRate=transmitDataRate, userRole=userRole, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementMode=managementMode, phyStatus=phyStatus, ethernetGroup=ethernetGroup, sNTPServerTable=sNTPServerTable, alarmsGroup=alarmsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, l2CPPriorityTableNumber=l2CPPriorityTableNumber, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, accessMethod=accessMethod, remoteIPAddress=remoteIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, dataPortStatus=dataPortStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, aggregateDataRate=aggregateDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, userTable=userTable, dfsPeaks=dfsPeaks, subnetMask=subnetMask, rxColorCode=rxColorCode, syslogClientTrap=syslogClientTrap, sNTPServerTableNumber=sNTPServerTableNumber, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, supplementary=supplementary, sNMPEnabledTraps=sNMPEnabledTraps, managementGroup=managementGroup, iPv6Address=iPv6Address, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, siteName=siteName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, management=management, bootVersion=bootVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, altitude=altitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortDisabledWarning=managementPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortStatus=managementPortStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, phyControl=phyControl, snmpControlGroup=snmpControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelACableLength=channelACableLength, softwareVersion=softwareVersion, syslogClient=syslogClient, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, aAAControl=aAAControl, cableLoss=cableLoss, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productVariant=productVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTimeout=sNTPServerTimeout, channelBandwidth=channelBandwidth, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, productName=productName, encryption=encryption, cambium=cambium, telecomsChannelSelection=telecomsChannelSelection, channelBLoopback=channelBLoopback, channelBLoopbackTrap=channelBLoopbackTrap, configurationGroup=configurationGroup, bridge=bridge, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, alarms=alarms, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, secureModeAlarm=secureModeAlarm, rangingMode=rangingMode, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, sMTPEmailAlert=sMTPEmailAlert, smtp=smtp, channelBLineCode=channelBLineCode, sMTPServerPortNumber=sMTPServerPortNumber, tDDControl=tDDControl, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogState=syslogState, groupID=groupID, channelBCableLength=channelBCableLength, range=range, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, installArmState=installArmState, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, telnetPortNumber=telnetPortNumber, channelChangeTrap=channelChangeTrap, managementPortStatusTrap=managementPortStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, resetGroup=resetGroup, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, dfsMeans=dfsMeans, linkName=linkName, receivePower=receivePower, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, iPDSCPPriorityTable=iPDSCPPriorityTable, noWirelessChannelAvailable=noWirelessChannelAvailable, channelALoopbackTrap=channelALoopbackTrap, installStatusTrap=installStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTable=sNMPTrapTable, automaticTxPowerControl=automaticTxPowerControl, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, sNTPServerTableIndex=sNTPServerTableIndex, transmitModulationMode=transmitModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, telecomsInterface=telecomsInterface, sntp=sntp)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", phyStatusGroup=phyStatusGroup, linkSymmetry=linkSymmetry, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqMHz=transmitFreqMHz, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, targetMACAddress=targetMACAddress, ptp=ptp, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installStatus=installStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, rawReceivePower=rawReceivePower, syslogStateTrap=syslogStateTrap, systemReset=systemReset, regionCodeTrap=regionCodeTrap, remoteRxTargetPower=remoteRxTargetPower, ethernetPriorityTable=ethernetPriorityTable, configuration=configuration, ptpGroups=ptpGroups, daylightSaving=daylightSaving, linkModeOptimisation=linkModeOptimisation, phyControlGroup=phyControlGroup, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, receiveFreqKHz=receiveFreqKHz, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelAStatus=telecomsChannelAStatus, ptp600=ptp600, tDDControlGroup=tDDControlGroup, versions=versions, userTableIndex=userTableIndex, regionCode=regionCode, sNTPServerTableEntry=sNTPServerTableEntry, dfsTableEntry=dfsTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap)
