...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogClient=syslogClient, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableIndex=userTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, targetRange=targetRange, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, telecomsChannelAStatus=telecomsChannelAStatus, channelALineCode=channelALineCode, sNTPSync=sNTPSync, ptp=ptp, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBLoopbackTrap=channelBLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControlGroup=tDDControlGroup, qOSPriorityScheme=qOSPriorityScheme, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementVID=vLANManagementVID, receiveFreqKHz=receiveFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, hTTPAccessEnabled=hTTPAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, supplementaryGroup=supplementaryGroup, dataPortFiberStatus=dataPortFiberStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetGroup=ethernetGroup, smtp=smtp, iPv4Address=iPv4Address, receivePower=receivePower, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, hAZLOCConfiguration=hAZLOCConfiguration, syslogControlGroup=syslogControlGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerRetries=sNTPServerRetries, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, siteName=siteName, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, regionCode=regionCode, targetMACAddress=targetMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteInternetAddress=remoteInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBLoopback=channelBLoopback, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTraps=ptpTraps, ethernetBridgingAvailability=ethernetBridgingAvailability, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, dfsMeans=dfsMeans, installStatus=installStatus, managementGroup=managementGroup, localPacketFiltering=localPacketFiltering, managementPortDisabledWarning=managementPortDisabledWarning, frequencyVariant=frequencyVariant, supplementary=supplementary, productVariant=productVariant, remoteRxTargetPower=remoteRxTargetPower, receiveChannel=receiveChannel, dSCPManagementPriority=dSCPManagementPriority, remoteInternetAddressType=remoteInternetAddressType, telecomsChannelBStatus=telecomsChannelBStatus, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, eIRP=eIRP, encryption=encryption, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, txColorCode=txColorCode, dfsTableIndex=dfsTableIndex, channelBCableLength=channelBCableLength, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bridge=bridge, ethernetFiberSupport=ethernetFiberSupport, ethernetPriorityTableNumber=ethernetPriorityTableNumber, PYSNMP_MODULE_ID=cambium, encryptionAlgorithm=encryptionAlgorithm, linkLoss=linkLoss, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableEntry=userTableEntry, ptp600=ptp600, signalStrengthRatio=signalStrengthRatio, channelALoopbackTrap=channelALoopbackTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPv3Enable=sNMPv3Enable, managementPortStatus=managementPortStatus, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, systemClock=systemClock, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, bridgeGroup=bridgeGroup, vectorError=vectorError, iPVersion=iPVersion, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ptmp=ptmp, configuration=configuration, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, channelALoopback=channelALoopback, linkModeOptimisation=linkModeOptimisation, management=management, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, transmitFreqMHz=transmitFreqMHz, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableNumber=dfsTableNumber, sNTPServerTimeout=sNTPServerTimeout, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPSyncTrap=sNTPSyncTrap, managementPortStatusTrap=managementPortStatusTrap, longitude=longitude, cableLoss=cableLoss, sNTPServerTable=sNTPServerTable, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, iPv6Address=iPv6Address, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, sMTPServerInternetAddressType=sMTPServerInternetAddressType, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, regionCodeTrap=regionCodeTrap, versions=versions, configurationGroup=configurationGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rangingMode=rangingMode, dataPortStatusTrap=dataPortStatusTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, sntp=sntp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, linkSymmetry=linkSymmetry, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, aAAControl=aAAControl, l2CPPriorityTable=l2CPPriorityTable, managementMode=managementMode, channelBLineCode=channelBLineCode, bandwidthVariant=bandwidthVariant, securityLevel=securityLevel, telecomGroup=telecomGroup, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTable=dfsTable, syslogStateTrap=syslogStateTrap, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, tFTPServerInternetAddress=tFTPServerInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelBandwidth=channelBandwidth, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, hTTPPortNumber=hTTPPortNumber, systemReset=systemReset, telecomsChannelSelection=telecomsChannelSelection, automaticTxPowerControl=automaticTxPowerControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, altitude=altitude, phyStatusGroup=phyStatusGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userEnabled=userEnabled, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, accessMethod=accessMethod, transmitPower=transmitPower, installArmState=installArmState, remoteIPAddress=remoteIPAddress, vLANManagementPriority=vLANManagementPriority, channelACableLength=channelACableLength, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, masterSlaveMode=masterSlaveMode, sNTPPrimaryServer=sNTPPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, notificationsGroup=notificationsGroup, range=range)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetPriorityTable=ethernetPriorityTable, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, ethernetBridgingStatus=ethernetBridgingStatus, productName=productName, rxColorCode=rxColorCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, transmitModulationMode=transmitModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, snmpControlGroup=snmpControlGroup, groupID=groupID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePower=rawReceivePower, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, linkName=linkName, sNTPServerTableIndex=sNTPServerTableIndex, userRole=userRole, iPv6GatewayAddress=iPv6GatewayAddress, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsInterface=telecomsInterface, dfs=dfs, licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telnetPortNumber=telnetPortNumber, snmpControl=snmpControl, ptpGroups=ptpGroups, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude)
