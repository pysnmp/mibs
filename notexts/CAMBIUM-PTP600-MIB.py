...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNTPSyncTrap=sNTPSyncTrap, userRole=userRole, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, channelBLoopback=channelBLoopback, syslogClient=syslogClient, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementPortStatusTrap=managementPortStatusTrap, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, ptmp=ptmp, channelBandwidth=channelBandwidth, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerIPAddress=sNTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, snmpControl=snmpControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveModulationMode=receiveModulationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, telecomsInterface=telecomsInterface, systemReset=systemReset, tDDControl=tDDControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogState=syslogState, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, productName=productName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, telecom=telecom, syslogControlGroup=syslogControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerIPAddress=tFTPServerIPAddress, dataPortFiberStatus=dataPortFiberStatus, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, securityLevel=securityLevel, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTable=l2CPPriorityTable, management=management, secureModeAlarm=secureModeAlarm, transmitFreqKHz=transmitFreqKHz, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, smtp=smtp, sMTPServerInternetAddress=sMTPServerInternetAddress, userPassword=userPassword, sntpGroup=sntpGroup, pubStats=pubStats, sNTPServerTableEntry=sNTPServerTableEntry, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, latitude=latitude, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, channelACableLength=channelACableLength, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, ethernetGroup=ethernetGroup, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementPortStatus=managementPortStatus, phyStatusGroup=phyStatusGroup, timeZone=timeZone, ptp=ptp, sNTPServerTimeout=sNTPServerTimeout, snmpControlGroup=snmpControlGroup, installStatus=installStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, regionCode=regionCode, userEnabled=userEnabled, ethernetBridgingStatus=ethernetBridgingStatus, vectorError=vectorError, secureModeAlarmTrap=secureModeAlarmTrap, sntp=sntp, hAZLOCConfiguration=hAZLOCConfiguration, versionsGroup=versionsGroup, syslogClientTrap=syslogClientTrap, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, ptpCompliance=ptpCompliance, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerRetries=sNTPServerRetries, sNTPLastSync=sNTPLastSync, aAAControl=aAAControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteInternetAddress=remoteInternetAddress, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, configuration=configuration, l2CPPriorityTableEntry=l2CPPriorityTableEntry, siteName=siteName, targetRange=targetRange, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, rxColorCode=rxColorCode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, channelALoopback=channelALoopback, managementGroup=managementGroup, iPv4Address=iPv4Address, phyStatus=phyStatus, rangingMode=rangingMode, accessMethod=accessMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dSCPManagementPriority=dSCPManagementPriority, searchState=searchState, sNTPServerStatus=sNTPServerStatus, receiveDataRate=receiveDataRate, sMTPServerIPAddress=sMTPServerIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTableNumber=sNTPServerTableNumber, syslogStateTrap=syslogStateTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, localPacketFiltering=localPacketFiltering, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, sNTPServerTable=sNTPServerTable, dfsMeans=dfsMeans, dfs=dfs, antennaGain=antennaGain, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, dfsPeaks=dfsPeaks, sNTPPrimaryServer=sNTPPrimaryServer, iPv6Address=iPv6Address, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementMode=managementMode, bridge=bridge, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, dfsTableNumber=dfsTableNumber, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStatsGroup=pubStatsGroup, phyControl=phyControl, installArmState=installArmState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControl=syslogControl, daylightSaving=daylightSaving, tFTPServerInternetAddressType=tFTPServerInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, iPv6PrefixLength=iPv6PrefixLength, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, telecomsChannelBStatus=telecomsChannelBStatus, wirelessLinkAvailability=wirelessLinkAvailability, channelBCableLength=channelBCableLength, channelBLoopbackTrap=channelBLoopbackTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, frequencyVariant=frequencyVariant, longitude=longitude, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, targetMACAddress=targetMACAddress, automaticTxPowerControl=automaticTxPowerControl, dfsTable=dfsTable, ptpTraps=ptpTraps, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, receivePower=receivePower, vLANManagementVID=vLANManagementVID, channelALineCode=channelALineCode, dfsGroup=dfsGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, ptp600=ptp600, txColorCode=txColorCode, linkLoss=linkLoss, productVariant=productVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, eIRP=eIRP, cambium=cambium, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPVersion=iPVersion, resetGroup=resetGroup, byteErrorRatio=byteErrorRatio, licence=licence, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTable=sNMPTrapTable, encryption=encryption)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", subnetMask=subnetMask, tFTPServerInternetAddress=tFTPServerInternetAddress, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, channelBLineCode=channelBLineCode, telecomGroup=telecomGroup, remoteInternetAddressType=remoteInternetAddressType, maximumTransmitPower=maximumTransmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, transmitModulationMode=transmitModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTable=ethernetPriorityTable, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, systemClock=systemClock, cableLoss=cableLoss, sNTPSync=sNTPSync, sNMPPortNumber=sNMPPortNumber, groupID=groupID, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, sNMPv3Enable=sNMPv3Enable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, gatewayIPAddress=gatewayIPAddress, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelALoopbackTrap=channelALoopbackTrap, qOSPriorityScheme=qOSPriorityScheme, receiveFreqKHz=receiveFreqKHz, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, bandwidthVariant=bandwidthVariant, versions=versions, signalStrengthRatio=signalStrengthRatio, supplementary=supplementary, telecomsChannelAStatus=telecomsChannelAStatus)
