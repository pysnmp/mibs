...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:51:42 2021
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", smtpGroup=smtpGroup, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, licenceGroup=licenceGroup, dfsGroup=dfsGroup, iPv6Address=iPv6Address, managementMode=managementMode, regionCode=regionCode, dfsMeans=dfsMeans, telecomsChannelSelection=telecomsChannelSelection, cambium=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqMHz=transmitFreqMHz, sNTPServerRetries=sNTPServerRetries, managementPortStatusTrap=managementPortStatusTrap, transmitChannel=transmitChannel, syslogClient=syslogClient, linkSymmetry=linkSymmetry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogState=syslogState, transmitModulationMode=transmitModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementPortStatus=managementPortStatus, securityLevel=securityLevel, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rawReceivePower=rawReceivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licence=licence, frequencyVariant=frequencyVariant, daylightSaving=daylightSaving, latitude=latitude, ethernetBridgingAvailability=ethernetBridgingAvailability, channelBLineCode=channelBLineCode, userTable=userTable, iPv4Address=iPv4Address, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rxColorCode=rxColorCode, smtp=smtp, telecomsChannelAStatus=telecomsChannelAStatus, configurationGroup=configurationGroup, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bandwidthVariant=bandwidthVariant, linkModeOptimisation=linkModeOptimisation, searchState=searchState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, range=range, sMTPEnabledMessages=sMTPEnabledMessages, phyControlGroup=phyControlGroup, syslogControl=syslogControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, sNMPCommunityString=sNMPCommunityString, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsPeaks=dfsPeaks, tDDControl=tDDControl, gatewayIPAddress=gatewayIPAddress, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControl=phyControl, iPv6GatewayAddress=iPv6GatewayAddress, installArmStateTrap=installArmStateTrap, transmitDataRate=transmitDataRate, channelBCableLength=channelBCableLength, sNTPPollInterval=sNTPPollInterval, byteErrorRatio=byteErrorRatio, maximumTransmitPower=maximumTransmitPower, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, iPDSCPPriorityTable=iPDSCPPriorityTable, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, systemReset=systemReset, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerStatus=sNTPServerStatus, sNTPSyncTrap=sNTPSyncTrap, channelBLoopback=channelBLoopback, pubStats=pubStats, dfsTableIndex=dfsTableIndex, vectorError=vectorError, linkLoss=linkLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dataPortAutoMdix=dataPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementary=supplementary, userTableNumber=userTableNumber, ethernetBridgingStatus=ethernetBridgingStatus, aggregateDataRate=aggregateDataRate, iPVersion=iPVersion, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, sMTPServerInternetAddress=sMTPServerInternetAddress, userEnabled=userEnabled, encryptionGroup=encryptionGroup, txColorCode=txColorCode, bootVersion=bootVersion, ptpTrapPrefix=ptpTrapPrefix, systemClock=systemClock, channelACableLength=channelACableLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopback=channelALoopback, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, sNTPServerTimeout=sNTPServerTimeout, siteName=siteName, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, phyStatus=phyStatus, receiveFreqMHz=receiveFreqMHz, regionCodeTrap=regionCodeTrap, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, automaticTxPowerControl=automaticTxPowerControl, userPassword=userPassword, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTable=l2CPPriorityTable, hAZLOCConfiguration=hAZLOCConfiguration, userRole=userRole, sNMPPortNumber=sNMPPortNumber, dataPortFiberStatus=dataPortFiberStatus, userName=userName, dfsTable=dfsTable, versionsGroup=versionsGroup, aAAControlGroup=aAAControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogStateTrap=syslogStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelBandwidth=channelBandwidth, ptp=ptp, ethernet=ethernet, productName=productName, managementPortConfigurationMismatch=managementPortConfigurationMismatch, snmpControl=snmpControl, tFTPServerPortNumber=tFTPServerPortNumber, channelALineCode=channelALineCode, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementGroup=managementGroup, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, bridgeGroup=bridgeGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpCompliance=ptpCompliance, channelALoopbackTrap=channelALoopbackTrap, sNTPServerIPAddress=sNTPServerIPAddress, versions=versions, transmitFreqKHz=transmitFreqKHz, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, hardwareVersion=hardwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, userTableEntry=userTableEntry, receiveModulationMode=receiveModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, userTableIndex=userTableIndex, sNTPServerTable=sNTPServerTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, tDDControlGroup=tDDControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteRxTargetPower=remoteRxTargetPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telnetPortNumber=telnetPortNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapVersion=sNMPTrapVersion, dfsTableEntry=dfsTableEntry, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, altitude=altitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, channelBLoopbackTrap=channelBLoopbackTrap, ptpGroups=ptpGroups, productVariant=productVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptmp=ptmp, targetMACAddress=targetMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntp=sntp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, sntpGroup=sntpGroup, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteIPAddress=remoteIPAddress, rangingMode=rangingMode, sMTPServerPortNumber=sMTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, accessMethod=accessMethod, sNTPServerTableEntry=sNTPServerTableEntry, installStatusTrap=installStatusTrap, linkName=linkName, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, signalStrengthRatio=signalStrengthRatio, dfs=dfs)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, encryption=encryption, installArmState=installArmState, longitude=longitude, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableLoss=cableLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSync=sNTPSync, ethernetPriorityTableEntry=ethernetPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, targetRange=targetRange, ethernetFiberSupport=ethernetFiberSupport, bridge=bridge, ethernetGroup=ethernetGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, telecom=telecom, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableNumber=dfsTableNumber, dataPortStatus=dataPortStatus, ptp600=ptp600, subnetMask=subnetMask, installStatus=installStatus, eIRP=eIRP, telecomsInterface=telecomsInterface, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
