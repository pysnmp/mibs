...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", receiveModulationModeDetail=receiveModulationModeDetail, dfsMeans=dfsMeans, installStatus=installStatus, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, sNTPServerTable=sNTPServerTable, sntp=sntp, iPVersion=iPVersion, dataPortFiberStatus=dataPortFiberStatus, qOSPriorityScheme=qOSPriorityScheme, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelAStatus=telecomsChannelAStatus, encryptionGroup=encryptionGroup, supplementary=supplementary, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementVID=vLANManagementVID, sNTPPollInterval=sNTPPollInterval, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ptp=ptp, ethernet=ethernet, smtp=smtp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, ptpGroups=ptpGroups, channelBCableLength=channelBCableLength, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, phyControl=phyControl, encryptionAlgorithm=encryptionAlgorithm, linkName=linkName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelSelection=telecomsChannelSelection, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmStateTrap=installArmStateTrap, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimisation=linkModeOptimisation, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, managementMode=managementMode, cableLoss=cableLoss, receiveDataRate=receiveDataRate, configuration=configuration, notificationsGroup=notificationsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, productName=productName, ptpTraps=ptpTraps, telecomGroup=telecomGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitFreqMHz=transmitFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, management=management, sNMPTrapTable=sNMPTrapTable, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, ptmp=ptmp, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, licence=licence, managementPortStatus=managementPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, smtpGroup=smtpGroup, syslogControl=syslogControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogControlGroup=syslogControlGroup, syslogState=syslogState, snmpControlGroup=snmpControlGroup, resetGroup=resetGroup, automaticTxPowerControl=automaticTxPowerControl, installStatusTrap=installStatusTrap, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, sNTPServerRetries=sNTPServerRetries, sNTPServerTableNumber=sNTPServerTableNumber, accessMethod=accessMethod, txColorCode=txColorCode, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, userEnabled=userEnabled, softwareVersion=softwareVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, iPv6Address=iPv6Address, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsTableEntry=dfsTableEntry, iPv6PrefixLength=iPv6PrefixLength, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptp600=ptp600, sNTPServerTableIndex=sNTPServerTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, userRole=userRole, userPassword=userPassword, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, systemClock=systemClock, aggregateDataRate=aggregateDataRate, managementPortDisabledWarning=managementPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, timeZone=timeZone, aAAControlGroup=aAAControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, installArmState=installArmState, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, securityLevel=securityLevel, daylightSaving=daylightSaving, longitude=longitude, syslogClientTrap=syslogClientTrap, encryption=encryption, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, phyStatus=phyStatus, remoteRxTargetPower=remoteRxTargetPower, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userName=userName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, ethernetGroup=ethernetGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsPeaks=dfsPeaks, antennaGain=antennaGain, versions=versions, targetRange=targetRange, l2CPPriorityTable=l2CPPriorityTable, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, localPacketFiltering=localPacketFiltering, hTTPPortNumber=hTTPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, pubStats=pubStats, bridgeGroup=bridgeGroup, eIRP=eIRP, ethernetBridgingStatus=ethernetBridgingStatus, sNMPCommunityString=sNMPCommunityString, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelACableLength=channelACableLength, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopbackTrap=channelALoopbackTrap, channelALineCode=channelALineCode, dfsGroup=dfsGroup, telecom=telecom, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, byteErrorRatio=byteErrorRatio, vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableEntry=userTableEntry, searchState=searchState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, channelBLoopback=channelBLoopback, remoteInternetAddress=remoteInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, channelChangeTrap=channelChangeTrap, siteName=siteName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatusGroup=phyStatusGroup, managementPortStatusTrap=managementPortStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secureModeAlarm=secureModeAlarm, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, tDDControl=tDDControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, systemReset=systemReset, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, managementGroup=managementGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, channelALoopback=channelALoopback, dfs=dfs, useVLANForManagementInterfaces=useVLANForManagementInterfaces, groupID=groupID, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userTable=userTable, altitude=altitude, transmitModulationMode=transmitModulationMode, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetMACAddress=targetMACAddress, rawReceivePower=rawReceivePower, ethernetPriorityTable=ethernetPriorityTable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telnetPortNumber=telnetPortNumber, bandwidthVariant=bandwidthVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, alarmsGroup=alarmsGroup, userTableNumber=userTableNumber, receivePower=receivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBLoopbackTrap=channelBLoopbackTrap, subnetMask=subnetMask, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bridge=bridge, channelBLineCode=channelBLineCode, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, hardwareVersion=hardwareVersion, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, regionCode=regionCode, vLANManagementPriority=vLANManagementPriority, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, incompatibleRegionCodes=incompatibleRegionCodes, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, receiveModulationMode=receiveModulationMode, iPv6GatewayAddress=iPv6GatewayAddress, ethernetBridgingAvailability=ethernetBridgingAvailability, managementPortWirelessDownAlert=managementPortWirelessDownAlert, secureModeAlarmTrap=secureModeAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, rxColorCode=rxColorCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerStatus=sNTPServerStatus, dfsTableNumber=dfsTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rangingMode=rangingMode, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, frequencyVariant=frequencyVariant, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, latitude=latitude, sNMPTrapTableEntry=sNMPTrapTableEntry, cambium=cambium, telecomsInterface=telecomsInterface, pubStatsGroup=pubStatsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, hAZLOCConfiguration=hAZLOCConfiguration, syslogClient=syslogClient)
