...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortFiberStatus=dataPortFiberStatus, encryptionGroup=encryptionGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, localPacketFiltering=localPacketFiltering, telecomGroup=telecomGroup, subnetMask=subnetMask, sMTPServerInternetAddress=sMTPServerInternetAddress, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, secureModeAlarmTrap=secureModeAlarmTrap, sNTPSync=sNTPSync, bootVersion=bootVersion, dfsGroup=dfsGroup, rawReceivePower=rawReceivePower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortWirelessDownAlert=managementPortWirelessDownAlert, productName=productName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp600=ptp600, frequencyVariant=frequencyVariant, sNTPServerTableNumber=sNTPServerTableNumber, ptmp=ptmp, sntpGroup=sntpGroup, sNTPServerTableIndex=sNTPServerTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatus=dataPortStatus, channelBLineCode=channelBLineCode, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sntp=sntp, receiveModulationModeDetail=receiveModulationModeDetail, iPv6Address=iPv6Address, siteName=siteName, vLANManagementPriority=vLANManagementPriority, managementPortStatus=managementPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptp=ptp, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogClientTrap=syslogClientTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerTimeout=sNTPServerTimeout, txColorCode=txColorCode, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, telecomsChannelAStatus=telecomsChannelAStatus, channelALoopback=channelALoopback, configuration=configuration, smtp=smtp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licence=licence, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBCableLength=channelBCableLength, versions=versions, ethernetPriorityTable=ethernetPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cableLoss=cableLoss, syslogStateTrap=syslogStateTrap, versionsGroup=versionsGroup, receiveChannel=receiveChannel, managementPortConfigurationMismatch=managementPortConfigurationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpGroups=ptpGroups, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, dfs=dfs, secureModeAlarm=secureModeAlarm, searchState=searchState, remoteRxTargetPower=remoteRxTargetPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, targetMACAddress=targetMACAddress, groupID=groupID, supplementaryGroup=supplementaryGroup, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, alarmsGroup=alarmsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPState=sNTPState, timeZone=timeZone, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, telecom=telecom, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTraps=ptpTraps, reset=reset, ethernet=ethernet, ethernetPriorityTableEntry=ethernetPriorityTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, management=management, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, syslogControl=syslogControl, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, accessMethod=accessMethod, installStatusTrap=installStatusTrap, iPv4Address=iPv4Address, antennaGain=antennaGain, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlGroup=phyControlGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, bandwidthVariant=bandwidthVariant, iPv6GatewayAddress=iPv6GatewayAddress, channelALineCode=channelALineCode, l2CPPriorityTable=l2CPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCode=regionCode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkSymmetry=linkSymmetry, sMTPEnabledMessages=sMTPEnabledMessages, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, range=range, sNTPServerStatus=sNTPServerStatus, dSCPManagementPriority=dSCPManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, systemClock=systemClock, cambium=cambium, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, dfsTableIndex=dfsTableIndex, phyControl=phyControl, dfsTable=dfsTable, securityLevel=securityLevel, automaticTxPowerControl=automaticTxPowerControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, telecomsInterface=telecomsInterface, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortDisabledWarning=managementPortDisabledWarning, snmpControl=snmpControl, licenceGroup=licenceGroup, telecomsChannelSelection=telecomsChannelSelection, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, channelALoopbackTrap=channelALoopbackTrap, rangingMode=rangingMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkStatus=wirelessLinkStatus, installStatus=installStatus, snmpControlGroup=snmpControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, qOSPriorityScheme=qOSPriorityScheme, installArmStateTrap=installArmStateTrap, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, rxColorCode=rxColorCode, transmitPower=transmitPower, hardwareVersion=hardwareVersion, pubStats=pubStats, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, managementPortStatusTrap=managementPortStatusTrap, userTable=userTable, alarms=alarms, hAZLOCConfiguration=hAZLOCConfiguration, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, iPv6PrefixLength=iPv6PrefixLength, dataPortAutoMdix=dataPortAutoMdix, supplementary=supplementary, channelBLoopbackTrap=channelBLoopbackTrap, productVariant=productVariant, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, channelBLoopback=channelBLoopback, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, managementGroup=managementGroup, altitude=altitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, gatewayIPAddress=gatewayIPAddress, telecomsChannelBStatus=telecomsChannelBStatus, channelACableLength=channelACableLength, masterSlaveMode=masterSlaveMode, encryption=encryption, bridge=bridge, ethernetPriorityTableNumber=ethernetPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ethernetGroup=ethernetGroup, sNTPServerTable=sNTPServerTable, sNTPServerTableEntry=sNTPServerTableEntry, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, userName=userName, telnetAccessEnabled=telnetAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, byteErrorRatio=byteErrorRatio, userTableEntry=userTableEntry, sNTPLastSync=sNTPLastSync, latitude=latitude, notificationsGroup=notificationsGroup, tDDControl=tDDControl, linkName=linkName, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, receiveModulationMode=receiveModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, aAAControl=aAAControl, remoteInternetAddress=remoteInternetAddress, iPVersion=iPVersion, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControlGroup=aAAControlGroup, bridgeGroup=bridgeGroup, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, targetRange=targetRange, hTTPAccessEnabled=hTTPAccessEnabled, remoteIPAddress=remoteIPAddress, userTableIndex=userTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userEnabled=userEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetFiberSupport=ethernetFiberSupport, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementMode=managementMode, phyStatusGroup=phyStatusGroup)
