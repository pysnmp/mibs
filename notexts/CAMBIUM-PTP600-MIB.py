...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:50:25 2021
...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPv3Enable=sNMPv3Enable, userName=userName, channelBCableLength=channelBCableLength, sNTPServerStatus=sNTPServerStatus, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, targetRange=targetRange, signalStrengthRatio=signalStrengthRatio, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, receivePower=receivePower, sNTPLastSync=sNTPLastSync, groupID=groupID, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, securityLevel=securityLevel, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, searchState=searchState, telnetAccessEnabled=telnetAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerTable=sNTPServerTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarning=dataPortDisabledWarning, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, antennaGain=antennaGain, management=management, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortDisabledWarning=managementPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClient=syslogClient, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, longitude=longitude, dfs=dfs, licence=licence, remoteRxTargetPower=remoteRxTargetPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, vLANManagementVID=vLANManagementVID, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, productVariant=productVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, telecomGroup=telecomGroup, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, userPassword=userPassword, hardwareVersion=hardwareVersion, siteName=siteName, channelALoopback=channelALoopback, targetMACAddress=targetMACAddress, ptp=ptp, secureModeAlarm=secureModeAlarm, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, sNTPState=sNTPState, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitFreqMHz=transmitFreqMHz, txColorCode=txColorCode, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableIndex=userTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfsTable=dfsTable, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, eIRP=eIRP, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, reset=reset, tDDControl=tDDControl, iPv6Address=iPv6Address, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, cableLoss=cableLoss, altitude=altitude, telecom=telecom, smtpGroup=smtpGroup, ethernet=ethernet, regionCode=regionCode, sNTPPollInterval=sNTPPollInterval, userTableEntry=userTableEntry, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, transmitPower=transmitPower, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, managementPortStatus=managementPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, bootVersion=bootVersion, sMTPServerIPAddress=sMTPServerIPAddress, installStatus=installStatus, aAAControl=aAAControl, ptpCompliance=ptpCompliance, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelChangeTrap=channelChangeTrap, aAAControlGroup=aAAControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelAStatus=telecomsChannelAStatus, remoteInternetAddressType=remoteInternetAddressType, iPVersion=iPVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configurationGroup=configurationGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, managementPortStatusTrap=managementPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTable=sNMPTrapTable, alarms=alarms, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, receiveModulationMode=receiveModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, automaticTxPowerControl=automaticTxPowerControl, range=range, daylightSaving=daylightSaving, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, remoteInternetAddress=remoteInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rangingMode=rangingMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControl=syslogControl, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsGroup=dfsGroup, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelBStatus=telecomsChannelBStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, supplementaryGroup=supplementaryGroup, versionsGroup=versionsGroup, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, productName=productName, installArmState=installArmState, rawReceivePower=rawReceivePower, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, userTable=userTable, regionCodeTrap=regionCodeTrap, qOSPriorityScheme=qOSPriorityScheme, telecomsChannelSelection=telecomsChannelSelection, linkName=linkName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, phyControl=phyControl, iPv6PrefixLength=iPv6PrefixLength, aggregateDataRate=aggregateDataRate, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTrapPrefix=ptpTrapPrefix, rxColorCode=rxColorCode, managementMode=managementMode, iPv4Address=iPv4Address, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, bridgeGroup=bridgeGroup, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, ethernetPriorityTable=ethernetPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, frequencyVariant=frequencyVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerInternetAddress=sNTPServerInternetAddress, channelBLineCode=channelBLineCode, sNTPServerTimeout=sNTPServerTimeout, ethernetFiberSupport=ethernetFiberSupport, ptp600=ptp600, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, bridge=bridge, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, versions=versions, iPv6GatewayAddress=iPv6GatewayAddress, hAZLOCConfiguration=hAZLOCConfiguration, channelALineCode=channelALineCode, snmpControl=snmpControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortFiberStatus=dataPortFiberStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitDataRate=transmitDataRate, dfsTableIndex=dfsTableIndex, channelALoopbackTrap=channelALoopbackTrap, channelBLoopbackTrap=channelBLoopbackTrap, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, notificationsGroup=notificationsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", transmitModulationMode=transmitModulationMode, timeZone=timeZone, dataPortFiberStatusTrap=dataPortFiberStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, userRole=userRole, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, channelACableLength=channelACableLength, linkLoss=linkLoss, pubStats=pubStats, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerRetries=sNTPServerRetries, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, tDDControlGroup=tDDControlGroup, ethernetBridgingAvailability=ethernetBridgingAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, ptpTraps=ptpTraps, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTable=l2CPPriorityTable, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup, channelBLoopback=channelBLoopback, cambium=cambium, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyStatus=phyStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, iPDSCPPriorityTable=iPDSCPPriorityTable)
