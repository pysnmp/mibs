...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPPortNumber=sNMPPortNumber, maximumTransmitPower=maximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, systemClock=systemClock, snmpControlGroup=snmpControlGroup, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteInternetAddressType=remoteInternetAddressType, txColorCode=txColorCode, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, remoteRxTargetPower=remoteRxTargetPower, managementGroup=managementGroup, transmitChannel=transmitChannel, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, transmitModulationMode=transmitModulationMode, systemReset=systemReset, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, aggregateDataRate=aggregateDataRate, encryptionAlgorithm=encryptionAlgorithm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortDisabledWarning=managementPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarmTrap=secureModeAlarmTrap, phyControl=phyControl, dfs=dfs, remoteInternetAddress=remoteInternetAddress, channelALineCode=channelALineCode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionGroup=encryptionGroup, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bootVersion=bootVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapVersion=sNMPTrapVersion, ethernetBridgingAvailability=ethernetBridgingAvailability, masterSlaveMode=masterSlaveMode, managementPortStatusTrap=managementPortStatusTrap, subnetMask=subnetMask, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, ptp=ptp, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, dfsTable=dfsTable, secureModeAlarm=secureModeAlarm, alarms=alarms, transmitFreqKHz=transmitFreqKHz, userName=userName, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptmp=ptmp, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementMode=managementMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveDataRate=receiveDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTable=l2CPPriorityTable, rangingMode=rangingMode, iPv6GatewayAddress=iPv6GatewayAddress, phyControlGroup=phyControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, searchState=searchState, securityLevel=securityLevel, accessMethod=accessMethod, eIRP=eIRP, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetGroup=ethernetGroup, dataPortStatus=dataPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkLoss=linkLoss, dSCPManagementPriority=dSCPManagementPriority, latitude=latitude, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configuration=configuration, ethernet=ethernet, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, channelALoopback=channelALoopback, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetFiberSupport=ethernetFiberSupport, installStatus=installStatus, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, channelBLoopbackTrap=channelBLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, reset=reset, resetGroup=resetGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, channelBCableLength=channelBCableLength, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, siteName=siteName, targetRange=targetRange, channelBLoopback=channelBLoopback, dfsGroup=dfsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, configurationGroup=configurationGroup, phyStatus=phyStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, receivePower=receivePower, tFTPServerPortNumber=tFTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, productName=productName, dfsTableNumber=dfsTableNumber, telecomsChannelBStatus=telecomsChannelBStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetMACAddress=targetMACAddress, syslogStateTrap=syslogStateTrap, receiveChannel=receiveChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, smtp=smtp, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, qOSPriorityScheme=qOSPriorityScheme, installStatusTrap=installStatusTrap, userTable=userTable, receiveModulationMode=receiveModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, mPLSTCPriorityTable=mPLSTCPriorityTable, transmitDataRate=transmitDataRate, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpGroups=ptpGroups, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableLoss=cableLoss, channelALoopbackTrap=channelALoopbackTrap, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, linkModeOptimisation=linkModeOptimisation, installArmState=installArmState, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, userTableEntry=userTableEntry, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, groupID=groupID, dataPortStatusTrap=dataPortStatusTrap, pubStatsGroup=pubStatsGroup, licenceGroup=licenceGroup, telecomsChannelSelection=telecomsChannelSelection, bridgeGroup=bridgeGroup, automaticTxPowerControl=automaticTxPowerControl, telnetAccessEnabled=telnetAccessEnabled, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, versions=versions, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelACableLength=channelACableLength, userTableNumber=userTableNumber, longitude=longitude, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, localPacketFiltering=localPacketFiltering, hAZLOCConfiguration=hAZLOCConfiguration, ptp600=ptp600, syslogControlGroup=syslogControlGroup, iPv6PrefixLength=iPv6PrefixLength, rxColorCode=rxColorCode, channelBandwidth=channelBandwidth, rawReceivePower=rawReceivePower, iPv6Address=iPv6Address, daylightSaving=daylightSaving, transmitPower=transmitPower, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetBridgingStatus=ethernetBridgingStatus, range=range, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveModulationModeDetail=receiveModulationModeDetail, sntp=sntp, antennaGain=antennaGain, iPv4Address=iPv4Address, management=management, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, bridge=bridge, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTimeout=sNTPServerTimeout, userTableIndex=userTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, iPVersion=iPVersion, snmpControl=snmpControl, aAAControl=aAAControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPServerTable=sNTPServerTable, cambium=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, linkName=linkName, PYSNMP_MODULE_ID=cambium, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, phyStatusGroup=phyStatusGroup, ethernetPriorityTable=ethernetPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPEmailAlert=sMTPEmailAlert, encryption=encryption, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPPrimaryServer=sNTPPrimaryServer, pubStats=pubStats, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogState=syslogState, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, telecom=telecom, dataPortFiberStatus=dataPortFiberStatus, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, channelBLineCode=channelBLineCode, userEnabled=userEnabled, supplementary=supplementary, altitude=altitude, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationMode=tDDSynchronizationMode, tDDControl=tDDControl, managementPortStatus=managementPortStatus, tDDControlGroup=tDDControlGroup, hardwareVersion=hardwareVersion, dfsMeans=dfsMeans)
