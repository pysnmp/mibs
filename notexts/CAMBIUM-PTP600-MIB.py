...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, sntpGroup=sntpGroup, l2CPPriorityTable=l2CPPriorityTable, productName=productName, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, subnetMask=subnetMask, ethernetPriorityTableIndex=ethernetPriorityTableIndex, notificationsGroup=notificationsGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, syslogStateTrap=syslogStateTrap, remoteRxTargetPower=remoteRxTargetPower, transmitModulationMode=transmitModulationMode, groupID=groupID, range=range, licence=licence, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, searchState=searchState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, channelALineCode=channelALineCode, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, frequencyVariant=frequencyVariant, securityLevel=securityLevel, userName=userName, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, userTableIndex=userTableIndex, managementPortStatusTrap=managementPortStatusTrap, receiveModulationMode=receiveModulationMode, systemReset=systemReset, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfs=dfs, automaticTxPowerControl=automaticTxPowerControl, sNTPServerTableIndex=sNTPServerTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteInternetAddress=remoteInternetAddress, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTimeout=sNTPServerTimeout, linkModeOptimisation=linkModeOptimisation, telnetPortNumber=telnetPortNumber, managementPortStatus=managementPortStatus, linkName=linkName, dataPortFiberStatus=dataPortFiberStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, resetGroup=resetGroup, dfsTable=dfsTable, sNTPServerStatus=sNTPServerStatus, sNTPSyncTrap=sNTPSyncTrap, installArmStateTrap=installArmStateTrap, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, encryption=encryption, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitChannel=transmitChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkAvailability=wirelessLinkAvailability, unitOutOfCalibration=unitOutOfCalibration, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, bridge=bridge, alarms=alarms, iPv6GatewayAddress=iPv6GatewayAddress, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogControl=syslogControl, ethernetBridgingAvailability=ethernetBridgingAvailability, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp600=ptp600, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBLoopback=channelBLoopback, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, bridgeGroup=bridgeGroup, iPVersion=iPVersion, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, aggregateDataRate=aggregateDataRate, linkSymmetry=linkSymmetry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, smtp=smtp, versionsGroup=versionsGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, userTableNumber=userTableNumber, ethernetGroup=ethernetGroup, versions=versions, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rawReceivePower=rawReceivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernet=ethernet, reset=reset, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsChannelSelection=telecomsChannelSelection, constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, channelBLineCode=channelBLineCode, userTableEntry=userTableEntry, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, siteName=siteName, l2CPPriorityTableIndex=l2CPPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, localPacketFiltering=localPacketFiltering, sNTPState=sNTPState, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, vectorError=vectorError, accessMethod=accessMethod, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, hardwareVersion=hardwareVersion, configuration=configuration, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBandwidth=channelBandwidth, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, latitude=latitude, userRole=userRole, antennaGain=antennaGain, targetMACAddress=targetMACAddress, telecomsChannelBStatus=telecomsChannelBStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, aAAControlGroup=aAAControlGroup, bootVersion=bootVersion, channelBCableLength=channelBCableLength, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, receiveModulationModeDetail=receiveModulationModeDetail, regionCode=regionCode, userPassword=userPassword, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, channelACableLength=channelACableLength, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, receiveChannel=receiveChannel, targetRange=targetRange, secureModeAlarm=secureModeAlarm, ptpTraps=ptpTraps, iPv6Address=iPv6Address, cambium=cambium, dfsGroup=dfsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telecomsChannelAStatus=telecomsChannelAStatus, phyControl=phyControl, tDDControl=tDDControl, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, syslogClient=syslogClient, installStatusTrap=installStatusTrap, supplementary=supplementary, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, txColorCode=txColorCode, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, userEnabled=userEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, rxColorCode=rxColorCode, iPv4Address=iPv4Address, masterSlaveMode=masterSlaveMode, channelBLoopbackTrap=channelBLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableEntry=l2CPPriorityTableEntry, timeZone=timeZone, telecom=telecom, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, linkLoss=linkLoss, altitude=altitude, encryptionAlgorithm=encryptionAlgorithm, dfsTableEntry=dfsTableEntry, aAAControl=aAAControl, maximumTransmitPower=maximumTransmitPower, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, sNTPSync=sNTPSync, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, channelALoopbackTrap=channelALoopbackTrap, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerInternetAddress=tFTPServerInternetAddress, snmpControlGroup=snmpControlGroup, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", dataPortStatusTrap=dataPortStatusTrap, managementMode=managementMode, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, qOSPriorityScheme=qOSPriorityScheme, phyControlGroup=phyControlGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, daylightSaving=daylightSaving, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, sNTPServerTable=sNTPServerTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, dfsTableIndex=dfsTableIndex, sNMPPortNumber=sNMPPortNumber, ethernetBridgingStatus=ethernetBridgingStatus, hTTPSPortNumber=hTTPSPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, cableLoss=cableLoss, channelALoopback=channelALoopback, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, management=management, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntp=sntp, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, syslogControlGroup=syslogControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatus=dataPortStatus, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dSCPManagementPriority=dSCPManagementPriority)
