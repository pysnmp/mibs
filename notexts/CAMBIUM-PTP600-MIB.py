...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptmp=ptmp, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, snmpControl=snmpControl, eIRP=eIRP, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServer=sNTPPrimaryServer, telnetPortNumber=telnetPortNumber, l2CPPriorityTable=l2CPPriorityTable, productVariant=productVariant, vectorError=vectorError, tFTPServerPortNumber=tFTPServerPortNumber, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, remoteInternetAddressType=remoteInternetAddressType, vLANManagementVID=vLANManagementVID, rangingMode=rangingMode, bridge=bridge, ethernetPriorityTable=ethernetPriorityTable, installStatus=installStatus, systemClock=systemClock, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, alarms=alarms, hAZLOCConfiguration=hAZLOCConfiguration, tDDControl=tDDControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dfsPeaks=dfsPeaks, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, automaticTxPowerControl=automaticTxPowerControl, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, ptp600=ptp600, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, siteName=siteName, regionCodeTrap=regionCodeTrap, sNTPServerTableNumber=sNTPServerTableNumber, byteErrorRatio=byteErrorRatio, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, telecomsChannelAStatus=telecomsChannelAStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitModulationMode=transmitModulationMode, range=range, targetRange=targetRange, aAAControlGroup=aAAControlGroup, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, hTTPPortNumber=hTTPPortNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, encryptionGroup=encryptionGroup, receiveFreqKHz=receiveFreqKHz, smtp=smtp, ptpTraps=ptpTraps, sNMPTrapVersion=sNMPTrapVersion, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, licenceGroup=licenceGroup, bandwidthVariant=bandwidthVariant, supplementaryGroup=supplementaryGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, dSCPManagementPriority=dSCPManagementPriority, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntp=sntp, daylightSaving=daylightSaving, remoteInternetAddress=remoteInternetAddress, sNMPPortNumber=sNMPPortNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfs=dfs, maximumTransmitPower=maximumTransmitPower, dataPortFiberStatus=dataPortFiberStatus, syslogClientTrap=syslogClientTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, securityLevel=securityLevel, secureModeAlarmTrap=secureModeAlarmTrap, secureModeAlarm=secureModeAlarm, phyStatus=phyStatus, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bridgeGroup=bridgeGroup, sNTPServerRetries=sNTPServerRetries, encryption=encryption, sNTPServerTableEntry=sNTPServerTableEntry, ptpCompliance=ptpCompliance, iPVersion=iPVersion, timeZone=timeZone, iPv6PrefixLength=iPv6PrefixLength, notificationsGroup=notificationsGroup, userTableEntry=userTableEntry, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortStatus=dataPortStatus, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, softwareVersion=softwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, remoteRxTargetPower=remoteRxTargetPower, ethernetGroup=ethernetGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, telecom=telecom, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, telecomsChannelSelection=telecomsChannelSelection, linkLoss=linkLoss, transmitDataRate=transmitDataRate, secondarySoftwareVersion=secondarySoftwareVersion, telnetAccessEnabled=telnetAccessEnabled, frequencyVariant=frequencyVariant, reset=reset, syslogState=syslogState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPState=sNTPState, managementPortStatusTrap=managementPortStatusTrap, sNMPv3Enable=sNMPv3Enable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sntpGroup=sntpGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, resetGroup=resetGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, rxColorCode=rxColorCode, cableLoss=cableLoss, channelChangeTrap=channelChangeTrap, userName=userName, iPv4Address=iPv4Address, ethernet=ethernet, userTableNumber=userTableNumber, localPacketFiltering=localPacketFiltering, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, telecomsInterface=telecomsInterface, ptpGroups=ptpGroups, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, txColorCode=txColorCode, systemReset=systemReset, rawReceivePower=rawReceivePower, licence=licence, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, accessMethod=accessMethod, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogControl=syslogControl, iPv6GatewayAddress=iPv6GatewayAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userTable=userTable, transmitChannel=transmitChannel, management=management, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTable=dfsTable, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cambium=cambium, managementPortStatus=managementPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, ethernetBridgingStatus=ethernetBridgingStatus, channelBLoopback=channelBLoopback, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, longitude=longitude, installArmState=installArmState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, channelALoopback=channelALoopback, userTableIndex=userTableIndex, sNTPServerStatus=sNTPServerStatus, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, channelBLineCode=channelBLineCode, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveChannel=receiveChannel, bootVersion=bootVersion, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, channelBCableLength=channelBCableLength, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, phyControl=phyControl, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, channelBandwidth=channelBandwidth, regionCode=regionCode, sNTPServerTable=sNTPServerTable, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTimeout=sNTPServerTimeout, versionsGroup=versionsGroup, hardwareVersion=hardwareVersion, channelALoopbackTrap=channelALoopbackTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, channelBLoopbackTrap=channelBLoopbackTrap, remoteIPAddress=remoteIPAddress, signalStrengthRatio=signalStrengthRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementMode=managementMode, sNTPSync=sNTPSync)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userEnabled=userEnabled, pubStats=pubStats, mPLSTCPriorityTable=mPLSTCPriorityTable, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, managementPortDisabledWarning=managementPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, channelALineCode=channelALineCode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receivePower=receivePower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPv6Address=iPv6Address, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsChannelBStatus=telecomsChannelBStatus, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, altitude=altitude, sNTPLastSync=sNTPLastSync, configurationGroup=configurationGroup, channelACableLength=channelACableLength, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, alarmsGroup=alarmsGroup, ptp=ptp, PYSNMP_MODULE_ID=cambium)
