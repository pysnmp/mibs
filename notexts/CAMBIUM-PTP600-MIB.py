...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", syslogClientTrap=syslogClientTrap, siteName=siteName, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dataPortDisabledWarning=dataPortDisabledWarning, channelBLoopbackTrap=channelBLoopbackTrap, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, sNTPServerTableIndex=sNTPServerTableIndex, vLANManagementVID=vLANManagementVID, telecomGroup=telecomGroup, phyControl=phyControl, dSCPManagementPriority=dSCPManagementPriority, management=management, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, localPacketFiltering=localPacketFiltering, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, alarms=alarms, sNTPServerStatus=sNTPServerStatus, iPVersion=iPVersion, sNTPServerTimeout=sNTPServerTimeout, remoteRxTargetPower=remoteRxTargetPower, telnetAccessEnabled=telnetAccessEnabled, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetBridgingAvailability=ethernetBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, channelBandwidth=channelBandwidth, managementPortStatusTrap=managementPortStatusTrap, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, hardwareVersion=hardwareVersion, channelACableLength=channelACableLength, dfsTableIndex=dfsTableIndex, ethernetPriorityTable=ethernetPriorityTable, sNMPCommunityString=sNMPCommunityString, channelALoopbackTrap=channelALoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortFiberStatus=dataPortFiberStatus, channelBLineCode=channelBLineCode, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, remoteInternetAddressType=remoteInternetAddressType, smtpGroup=smtpGroup, accessMethod=accessMethod, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, ethernetPriorityTableIndex=ethernetPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, bridgeGroup=bridgeGroup, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, cableLoss=cableLoss, transmitFreqKHz=transmitFreqKHz, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, supplementaryGroup=supplementaryGroup, rangingMode=rangingMode, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, ptpTraps=ptpTraps, bridge=bridge, eIRP=eIRP, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, txColorCode=txColorCode, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, syslogControl=syslogControl, sNTPServerTableEntry=sNTPServerTableEntry, targetRange=targetRange, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortDisabledWarning=managementPortDisabledWarning, telnetPortNumber=telnetPortNumber, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsGroup=dfsGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTable=sNTPServerTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimisation=linkModeOptimisation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, versions=versions, receiveChannel=receiveChannel, ptp=ptp, ptpTrapPrefix=ptpTrapPrefix, licence=licence, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, sNTPSync=sNTPSync, userTable=userTable, sNTPServerRetries=sNTPServerRetries, sntp=sntp, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, automaticTxPowerControl=automaticTxPowerControl, securityLevel=securityLevel, iPv6Address=iPv6Address, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, frequencyVariant=frequencyVariant, reset=reset, ethernetFiberSupport=ethernetFiberSupport, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, gatewayIPAddress=gatewayIPAddress, alarmsGroup=alarmsGroup, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTable=mPLSTCPriorityTable, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, remoteInternetAddress=remoteInternetAddress, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyStatus=phyStatus, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, userEnabled=userEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, sNTPPrimaryServer=sNTPPrimaryServer, dfsPeaks=dfsPeaks, productVariant=productVariant, ptp600=ptp600, notificationsGroup=notificationsGroup, transmitChannel=transmitChannel, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSPortNumber=hTTPSPortNumber, receiveFreqKHz=receiveFreqKHz, sMTPServerInternetAddressType=sMTPServerInternetAddressType, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationMode=transmitModulationMode, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, channelALoopback=channelALoopback, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerPortNumber=sNTPServerPortNumber, systemReset=systemReset, syslogState=syslogState, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, ptpCompliance=ptpCompliance, telecomsChannelBStatus=telecomsChannelBStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetBridgingStatus=ethernetBridgingStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, qOSPriorityScheme=qOSPriorityScheme, dataPortAutoMdix=dataPortAutoMdix, rawReceivePower=rawReceivePower, secureModeAlarmTrap=secureModeAlarmTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, encryption=encryption, aAAControlGroup=aAAControlGroup, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDControlGroup=tDDControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementMode=managementMode, secureModeAlarm=secureModeAlarm, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelALineCode=channelALineCode, sNTPServerTableNumber=sNTPServerTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenceGroup=licenceGroup, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, rxColorCode=rxColorCode, subnetMask=subnetMask, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, ptpGroups=ptpGroups, groupID=groupID, channelBCableLength=channelBCableLength, hTTPAccessEnabled=hTTPAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, userPassword=userPassword, dfsMeans=dfsMeans, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, searchState=searchState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, regionCode=regionCode, hAZLOCConfiguration=hAZLOCConfiguration, remoteIPAddress=remoteIPAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", installArmStateTrap=installArmStateTrap, channelBLoopback=channelBLoopback, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, byteErrorRatio=byteErrorRatio, cambium=cambium, dfs=dfs, receivePower=receivePower, systemClock=systemClock, ptmp=ptmp, tDDControl=tDDControl, iPv4Address=iPv4Address, telecom=telecom, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, syslogClient=syslogClient, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, range=range, secondarySoftwareVersion=secondarySoftwareVersion, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPState=sNTPState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, altitude=altitude, userName=userName, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementPortStatus=managementPortStatus, configuration=configuration, sNMPPortNumber=sNMPPortNumber, antennaGain=antennaGain, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelAStatus=telecomsChannelAStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, transmitPower=transmitPower, userRole=userRole, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, smtp=smtp, telecomsChannelSelection=telecomsChannelSelection, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsTableEntry=dfsTableEntry)
