...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomGroup=telecomGroup, masterSlaveMode=masterSlaveMode, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDControl=tDDControl, ethernetGroup=ethernetGroup, dfsTableEntry=dfsTableEntry, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, systemClock=systemClock, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomsInterface=telecomsInterface, userTable=userTable, productName=productName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerRetries=sNTPServerRetries, resetGroup=resetGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPVersion=iPVersion, encryption=encryption, phyControlGroup=phyControlGroup, maximumTransmitPower=maximumTransmitPower, managementMode=managementMode, telecomsChannelBStatus=telecomsChannelBStatus, phyStatus=phyStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, timeZone=timeZone, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementaryGroup=supplementaryGroup, hTTPSPortNumber=hTTPSPortNumber, telnetPortNumber=telnetPortNumber, sntpGroup=sntpGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitPower=transmitPower, siteName=siteName, sNTPState=sNTPState, syslogClient=syslogClient, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, ethernetBridgingAvailability=ethernetBridgingAvailability, hardwareVersion=hardwareVersion, sNTPServerTable=sNTPServerTable, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, smtpGroup=smtpGroup, eIRP=eIRP, channelBLoopback=channelBLoopback, l2CPPriorityTableNumber=l2CPPriorityTableNumber, vLANManagementVID=vLANManagementVID, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpGroups=ptpGroups, secondarySoftwareVersion=secondarySoftwareVersion, secureModeAlarmTrap=secureModeAlarmTrap, range=range, ethernetBridgingStatus=ethernetBridgingStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configuration=configuration, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPPortNumber=hTTPPortNumber, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, alarms=alarms, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, linkSymmetry=linkSymmetry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, longitude=longitude, dfsGroup=dfsGroup, dfs=dfs, qOSPriorityScheme=qOSPriorityScheme, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, sNMPTrapTable=sNMPTrapTable, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv4Address=iPv4Address, receivePower=receivePower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licence=licence, managementPortStatusTrap=managementPortStatusTrap, localPacketFiltering=localPacketFiltering, dataPortDisabledWarning=dataPortDisabledWarning, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveDataRate=receiveDataRate, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, sNTPServerTableEntry=sNTPServerTableEntry, userName=userName, versionsGroup=versionsGroup, managementPortConfigurationMismatch=managementPortConfigurationMismatch, automaticTxPowerControl=automaticTxPowerControl, sNTPPrimaryServer=sNTPPrimaryServer, channelBLoopbackTrap=channelBLoopbackTrap, snmpControl=snmpControl, syslogControl=syslogControl, accessMethod=accessMethod, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, txColorCode=txColorCode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, versions=versions, cambium=cambium, subnetMask=subnetMask, dataPortStatus=dataPortStatus, dataPortAutoMdix=dataPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelACableLength=channelACableLength, remoteInternetAddress=remoteInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, remoteRxTargetPower=remoteRxTargetPower, bridge=bridge, productVariant=productVariant, tFTPServerIPAddress=tFTPServerIPAddress, userTableEntry=userTableEntry, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, daylightSaving=daylightSaving, groupID=groupID, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, targetRange=targetRange, reset=reset, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, installArmStateTrap=installArmStateTrap, frequencyVariant=frequencyVariant, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, iPv6PrefixLength=iPv6PrefixLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionGroup=encryptionGroup, ptp600=ptp600, userPassword=userPassword, rawReceivePower=rawReceivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, ethernet=ethernet, dfsTableNumber=dfsTableNumber, remoteIPAddress=remoteIPAddress, managementPortStatus=managementPortStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, transmitFreqMHz=transmitFreqMHz, userRole=userRole, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqKHz=transmitFreqKHz, channelBCableLength=channelBCableLength, linkLoss=linkLoss, sNTPServerStatus=sNTPServerStatus, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, channelALineCode=channelALineCode, licenceGroup=licenceGroup, wirelessLinkStatus=wirelessLinkStatus, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, userEnabled=userEnabled, hAZLOCConfiguration=hAZLOCConfiguration, altitude=altitude, installStatusTrap=installStatusTrap, ethernetPriorityTable=ethernetPriorityTable, antennaGain=antennaGain, rangingMode=rangingMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableIndex=userTableIndex, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, smtp=smtp, dSCPManagementPriority=dSCPManagementPriority, aggregateDataRate=aggregateDataRate, channelALoopbackTrap=channelALoopbackTrap, sNMPPortNumber=sNMPPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, regionCodeTrap=regionCodeTrap, telecomsChannelAStatus=telecomsChannelAStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, remoteInternetAddressType=remoteInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, bandwidthVariant=bandwidthVariant, rxColorCode=rxColorCode, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, aAAControl=aAAControl, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, pubStats=pubStats, iPv6Address=iPv6Address, channelBLineCode=channelBLineCode)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", supplementary=supplementary, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, dataPortFiberStatus=dataPortFiberStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmState=installArmState, sNTPServerInternetAddress=sNTPServerInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, dfsPeaks=dfsPeaks, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, ptp=ptp, channelBandwidth=channelBandwidth, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerTimeout=sNTPServerTimeout, channelChangeTrap=channelChangeTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, PYSNMP_MODULE_ID=cambium, securityLevel=securityLevel, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveModulationMode=receiveModulationMode, secureModeAlarm=secureModeAlarm, sntp=sntp, installStatus=installStatus, tDDControlGroup=tDDControlGroup, telecomsChannelSelection=telecomsChannelSelection, sNTPServerTableIndex=sNTPServerTableIndex, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, channelALoopback=channelALoopback, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
