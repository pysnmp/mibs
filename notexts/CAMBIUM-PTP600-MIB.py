...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", remoteInternetAddress=remoteInternetAddress, telecomsChannelAStatus=telecomsChannelAStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, versions=versions, dfsTableIndex=dfsTableIndex, userTableEntry=userTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerStatus=sNTPServerStatus, cambium=cambium, smtpGroup=smtpGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANManagementVID=vLANManagementVID, telecomsChannelBStatus=telecomsChannelBStatus, sNTPServerTableEntry=sNTPServerTableEntry, receiveModulationMode=receiveModulationMode, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, altitude=altitude, iPVersion=iPVersion, bootVersion=bootVersion, tDDControl=tDDControl, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, eIRP=eIRP, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, dataPortDisabledWarning=dataPortDisabledWarning, syslogStateTrap=syslogStateTrap, cableLoss=cableLoss, groupID=groupID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, encryptionGroup=encryptionGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqKHz=receiveFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, remoteRxTargetPower=remoteRxTargetPower, sNMPTrapVersion=sNMPTrapVersion, sNTPSyncTrap=sNTPSyncTrap, telnetPortNumber=telnetPortNumber, rawReceivePower=rawReceivePower, channelChangeTrap=channelChangeTrap, ptp=ptp, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, telecomsInterface=telecomsInterface, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, masterSlaveMode=masterSlaveMode, channelACableLength=channelACableLength, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBCableLength=channelBCableLength, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableEntry=dfsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortAutoMdix=dataPortAutoMdix, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, supplementaryGroup=supplementaryGroup, rxColorCode=rxColorCode, transmitModulationMode=transmitModulationMode, alarms=alarms, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, range=range, vLANManagementPriority=vLANManagementPriority, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, phyControlGroup=phyControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, txColorCode=txColorCode, receiveDataRate=receiveDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, transmitPower=transmitPower, phyStatus=phyStatus, sNTPState=sNTPState, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, versionsGroup=versionsGroup, ethernetBridgingStatus=ethernetBridgingStatus, dfsGroup=dfsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, systemReset=systemReset, ethernet=ethernet, userName=userName, resetGroup=resetGroup, installStatusTrap=installStatusTrap, encryption=encryption, tDDControlGroup=tDDControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, iPv6PrefixLength=iPv6PrefixLength, dfsTable=dfsTable, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, configuration=configuration, ptpGroups=ptpGroups, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetRange=targetRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, sNTPServerRetries=sNTPServerRetries, sNTPServerTableIndex=sNTPServerTableIndex, longitude=longitude, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, remoteInternetAddressType=remoteInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortFiberStatus=dataPortFiberStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bridge=bridge, reset=reset, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControlGroup=aAAControlGroup, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetBridgingAvailability=ethernetBridgingAvailability, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, receivePower=receivePower, siteName=siteName, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6Address=iPv6Address, hardwareVersion=hardwareVersion, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, managementPortStatus=managementPortStatus, sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, iPv6GatewayAddress=iPv6GatewayAddress, receiveModulationModeDetail=receiveModulationModeDetail, dfsMeans=dfsMeans, ptp600=ptp600, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, channelALineCode=channelALineCode, syslogControlGroup=syslogControlGroup, syslogControl=syslogControl, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControl=snmpControl, telecom=telecom, managementPortConfigurationMismatch=managementPortConfigurationMismatch, transmitChannel=transmitChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, telecomsChannelSelection=telecomsChannelSelection, wirelessLinkAvailability=wirelessLinkAvailability, channelBLineCode=channelBLineCode, linkLoss=linkLoss, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, installStatus=installStatus, channelALoopback=channelALoopback, securityLevel=securityLevel, managementMode=managementMode, channelBandwidth=channelBandwidth, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetMACAddress=targetMACAddress, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, encryptionAlgorithm=encryptionAlgorithm, syslogClient=syslogClient, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServer=sNTPPrimaryServer, notificationsGroup=notificationsGroup, telecomGroup=telecomGroup, PYSNMP_MODULE_ID=cambium, hAZLOCConfiguration=hAZLOCConfiguration, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, management=management, ethernetPriorityTableEntry=ethernetPriorityTableEntry, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, bridgeGroup=bridgeGroup, channelBLoopbackTrap=channelBLoopbackTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, userTableIndex=userTableIndex, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogState=syslogState, sMTPServerPortNumber=sMTPServerPortNumber, pubStatsGroup=pubStatsGroup, automaticTxPowerControl=automaticTxPowerControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, localPacketFiltering=localPacketFiltering, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secureModeAlarm=secureModeAlarm, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, managementPortStatusTrap=managementPortStatusTrap, byteErrorRatio=byteErrorRatio, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, pubStats=pubStats, qOSPriorityScheme=qOSPriorityScheme, iPv4Address=iPv4Address, smtp=smtp, channelBLoopback=channelBLoopback, searchState=searchState, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, rangingMode=rangingMode, installArmState=installArmState, aggregateDataRate=aggregateDataRate, channelALoopbackTrap=channelALoopbackTrap, userEnabled=userEnabled, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, accessMethod=accessMethod, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
