...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", userName=userName, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, linkName=linkName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernet=ethernet, syslogControlGroup=syslogControlGroup, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, telecomsChannelSelection=telecomsChannelSelection, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTable=sNTPServerTable, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, channelBLoopbackTrap=channelBLoopbackTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetBridgingAvailability=ethernetBridgingAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementMode=managementMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, bandwidthVariant=bandwidthVariant, hardwareVersion=hardwareVersion, channelALoopbackTrap=channelALoopbackTrap, alarms=alarms, sntpGroup=sntpGroup, timeZone=timeZone, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, installArmStateTrap=installArmStateTrap, productName=productName, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, subnetMask=subnetMask, receiveModulationModeDetail=receiveModulationModeDetail, ethernetGroup=ethernetGroup, secureModeAlarm=secureModeAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, remoteInternetAddress=remoteInternetAddress, ptpGroups=ptpGroups, antennaGain=antennaGain, sMTPEnabledMessages=sMTPEnabledMessages, channelBCableLength=channelBCableLength, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, transmitFreqKHz=transmitFreqKHz, syslogControl=syslogControl, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, syslogClient=syslogClient, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, reset=reset, remoteRxTargetPower=remoteRxTargetPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableNumber=userTableNumber, eIRP=eIRP, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetBridgingStatus=ethernetBridgingStatus, transmitFreqMHz=transmitFreqMHz, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, linkLoss=linkLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productVariant=productVariant, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridgeGroup=bridgeGroup, sNTPServerStatus=sNTPServerStatus, receiveFreqMHz=receiveFreqMHz, targetMACAddress=targetMACAddress, maximumTransmitPower=maximumTransmitPower, userEnabled=userEnabled, groupID=groupID, range=range, sNTPPollInterval=sNTPPollInterval, phyStatusGroup=phyStatusGroup, iPv6PrefixLength=iPv6PrefixLength, managementGroup=managementGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegionCodes=incompatibleRegionCodes, phyControl=phyControl, sNTPServerTimeout=sNTPServerTimeout, rxColorCode=rxColorCode, userTable=userTable, iPVersion=iPVersion, pubStats=pubStats, receiveModulationMode=receiveModulationMode, tDDControl=tDDControl, rawReceivePower=rawReceivePower, sNTPSyncTrap=sNTPSyncTrap, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkSymmetry=linkSymmetry, sntp=sntp, localPacketFiltering=localPacketFiltering, masterSlaveMode=masterSlaveMode, accessMethod=accessMethod, managementPortDisabledWarning=managementPortDisabledWarning, channelALineCode=channelALineCode, phyStatus=phyStatus, channelBLineCode=channelBLineCode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, versions=versions, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configuration=configuration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, secureModeAlarmTrap=secureModeAlarmTrap, channelBLoopback=channelBLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerTableEntry=sNTPServerTableEntry, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, sNMPPortNumber=sNMPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, bridge=bridge, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, securityLevel=securityLevel, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, automaticTxPowerControl=automaticTxPowerControl, iPv6Address=iPv6Address, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, rangingMode=rangingMode, iPv6GatewayAddress=iPv6GatewayAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelACableLength=channelACableLength, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortStatusTrap=managementPortStatusTrap, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementary=supplementary, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, dataPortAutoNegotiation=dataPortAutoNegotiation, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, resetGroup=resetGroup, remoteIPAddress=remoteIPAddress, dSCPManagementPriority=dSCPManagementPriority, ethernetFiberSupport=ethernetFiberSupport, sNMPCommunityString=sNMPCommunityString, iPv4Address=iPv4Address, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTableIndex=sNTPServerTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelALoopback=channelALoopback, remoteInternetAddressType=remoteInternetAddressType, regionCode=regionCode, smtp=smtp, telecomsChannelAStatus=telecomsChannelAStatus, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTable=dfsTable, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableEntry=dfsTableEntry, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogState=syslogState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityTable=ethernetPriorityTable, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, ptp600=ptp600, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userPassword=userPassword, licence=licence, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, managementPortStatus=managementPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPSync=sNTPSync, tFTPServerInternetAddressType=tFTPServerInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, installStatus=installStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBandwidth=channelBandwidth, hAZLOCConfiguration=hAZLOCConfiguration, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, dfsTableIndex=dfsTableIndex, targetRange=targetRange, transmitChannel=transmitChannel, softwareVersion=softwareVersion, management=management, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, systemClock=systemClock, latitude=latitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, txColorCode=txColorCode, sNTPServerRetries=sNTPServerRetries)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpCompliance=ptpCompliance, userTableIndex=userTableIndex, dataPortFiberStatus=dataPortFiberStatus, systemReset=systemReset, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, sMTPServerInternetAddress=sMTPServerInternetAddress, aAAControl=aAAControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, supplementaryGroup=supplementaryGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, searchState=searchState, snmpControlGroup=snmpControlGroup, transmitDataRate=transmitDataRate, dfsPeaks=dfsPeaks, aAAControlGroup=aAAControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqKHz=receiveFreqKHz, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, versionsGroup=versionsGroup, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, siteName=siteName, phyControlGroup=phyControlGroup, telecomsChannelBStatus=telecomsChannelBStatus, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatus=dataPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userRole=userRole)
