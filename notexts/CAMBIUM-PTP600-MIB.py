...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", aggregateDataRate=aggregateDataRate, sNTPPrimaryServer=sNTPPrimaryServer, dataPortAutoMdix=dataPortAutoMdix, installArmStateTrap=installArmStateTrap, txColorCode=txColorCode, automaticTxPowerControl=automaticTxPowerControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, receiveDataRate=receiveDataRate, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, latitude=latitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, daylightSaving=daylightSaving, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, channelBLineCode=channelBLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPVersion=iPVersion, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyControl=phyControl, sNTPServerTimeout=sNTPServerTimeout, hTTPSPortNumber=hTTPSPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfs=dfs, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, channelACableLength=channelACableLength, secureModeAlarm=secureModeAlarm, hardwareVersion=hardwareVersion, ptpTraps=ptpTraps, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, channelBLoopbackTrap=channelBLoopbackTrap, userName=userName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, regionCode=regionCode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTable=l2CPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetPriorityTable=ethernetPriorityTable, telecomsChannelAStatus=telecomsChannelAStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, bridge=bridge, channelChangeTrap=channelChangeTrap, licence=licence, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hAZLOCConfiguration=hAZLOCConfiguration, subnetMask=subnetMask, syslogLocalWrappedTrap=syslogLocalWrappedTrap, systemClock=systemClock, iPv6Address=iPv6Address, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, channelALineCode=channelALineCode, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, bridgeGroup=bridgeGroup, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, ptpGroups=ptpGroups, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerRetries=sNTPServerRetries, ptp600=ptp600, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, ethernet=ethernet, versionsGroup=versionsGroup, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetGroup=ethernetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenceGroup=licenceGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, encryption=encryption, sNTPServerTable=sNTPServerTable, receiveModulationModeDetail=receiveModulationModeDetail, linkName=linkName, antennaGain=antennaGain, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rawReceivePower=rawReceivePower, versions=versions, targetMACAddress=targetMACAddress, telecom=telecom, ptmp=ptmp, alarms=alarms, syslogControlGroup=syslogControlGroup, dfsTable=dfsTable, sNTPServerTableEntry=sNTPServerTableEntry, iPv4Address=iPv4Address, receivePower=receivePower, eIRP=eIRP, sNTPServerStatus=sNTPServerStatus, sNTPServerTableIndex=sNTPServerTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, phyStatusGroup=phyStatusGroup, telnetPortNumber=telnetPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, pubStatsGroup=pubStatsGroup, dfsTableEntry=dfsTableEntry, userRole=userRole, aAAControl=aAAControl, userPassword=userPassword, smtp=smtp, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNTPSync=sNTPSync, frequencyVariant=frequencyVariant, sNTPServerInternetAddressType=sNTPServerInternetAddressType, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, reset=reset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, bandwidthVariant=bandwidthVariant, range=range, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortStatus=dataPortStatus, syslogState=syslogState, unitOutOfCalibration=unitOutOfCalibration, managementPortStatusTrap=managementPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetBridgingAvailability=ethernetBridgingAvailability, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, alarmsGroup=alarmsGroup, managementMode=managementMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementary=supplementary, snmpControlGroup=snmpControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, receiveFreqKHz=receiveFreqKHz, dfsMeans=dfsMeans, dSCPManagementPriority=dSCPManagementPriority, dfsTableIndex=dfsTableIndex, signalStrengthRatio=signalStrengthRatio, sNTPServerInternetAddress=sNTPServerInternetAddress, sntp=sntp, encryptionGroup=encryptionGroup, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, userTableEntry=userTableEntry, userTable=userTable, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dataPortFiberStatus=dataPortFiberStatus, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetFiberSupport=ethernetFiberSupport, remoteInternetAddressType=remoteInternetAddressType, linkSymmetry=linkSymmetry, resetGroup=resetGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANManagementPriority=vLANManagementPriority, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, smtpGroup=smtpGroup, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, installArmState=installArmState, productName=productName, tDDControl=tDDControl, telnetAccessEnabled=telnetAccessEnabled, receiveModulationMode=receiveModulationMode, telecomGroup=telecomGroup, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, PYSNMP_MODULE_ID=cambium, dataPortFiberStatusTrap=dataPortFiberStatusTrap, userTableNumber=userTableNumber, managementPortStatus=managementPortStatus, sNTPLastSync=sNTPLastSync, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, secureModeAlarmTrap=secureModeAlarmTrap, localPacketFiltering=localPacketFiltering, management=management, sNMPv3Enable=sNMPv3Enable, channelBCableLength=channelBCableLength, sNTPServerTableNumber=sNTPServerTableNumber, phyControlGroup=phyControlGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteInternetAddress=remoteInternetAddress, telecomsChannelBStatus=telecomsChannelBStatus, sNMPTrapVersion=sNMPTrapVersion, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, targetRange=targetRange, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetBridgingStatus=ethernetBridgingStatus, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, regionCodeTrap=regionCodeTrap, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, configurationGroup=configurationGroup, cableLoss=cableLoss, groupID=groupID, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, longitude=longitude, channelBLoopback=channelBLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, receiveChannel=receiveChannel, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", accessMethod=accessMethod, hTTPAccessEnabled=hTTPAccessEnabled, userEnabled=userEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPState=sNTPState, timeZone=timeZone, rxColorCode=rxColorCode, systemReset=systemReset, bootVersion=bootVersion, channelALoopbackTrap=channelALoopbackTrap, sntpGroup=sntpGroup, channelALoopback=channelALoopback, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementVID=vLANManagementVID, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, remoteRxTargetPower=remoteRxTargetPower, telecomsInterface=telecomsInterface, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rangingMode=rangingMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, cambium=cambium, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, siteName=siteName, telecomsChannelSelection=telecomsChannelSelection, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelBandwidth=channelBandwidth, productVariant=productVariant, securityLevel=securityLevel, linkLoss=linkLoss, linkModeOptimisation=linkModeOptimisation, supplementaryGroup=supplementaryGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex)
