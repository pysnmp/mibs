...
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", latitude=latitude, secureModeAlarm=secureModeAlarm, sNTPServerStatus=sNTPServerStatus, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, configurationGroup=configurationGroup, eIRP=eIRP, dataPortStatusTrap=dataPortStatusTrap, altitude=altitude, dfsGroup=dfsGroup, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, syslogClientTrap=syslogClientTrap, userTableEntry=userTableEntry, accessMethod=accessMethod, ethernetCappedMaxWirelessSpeed=ethernetCappedMaxWirelessSpeed, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetBridgingStatusAlarm=ethernetBridgingStatusAlarm, channelALoopback=channelALoopback, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, iPv6Address=iPv6Address, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementPriority=vLANManagementPriority, sNTPServerTimeout=sNTPServerTimeout, pubStats=pubStats, sNTPServerInternetAddress=sNTPServerInternetAddress, userPassword=userPassword, installArmStateTrap=installArmStateTrap, encryptionGroup=encryptionGroup, sNTPServerTable=sNTPServerTable, hAZLOCConfiguration=hAZLOCConfiguration, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, localPacketFiltering=localPacketFiltering, phyStatusGroup=phyStatusGroup, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerRetries=sNTPServerRetries, versions=versions, frequencyVariant=frequencyVariant, rangingMode=rangingMode, telnetPortNumber=telnetPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, resetGroup=resetGroup, channelACableLength=channelACableLength, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqKHz=transmitFreqKHz, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtpGroup=smtpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, searchState=searchState, sNMPPortNumber=sNMPPortNumber, sNTPPollInterval=sNTPPollInterval, receiveFreqMHz=receiveFreqMHz, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ptpCompliance=ptpCompliance, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licence=licence, dfsPeaks=dfsPeaks, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPv3Enable=sNMPv3Enable, remoteInternetAddress=remoteInternetAddress, securityLevel=securityLevel, snmpControl=snmpControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, snmpControlGroup=snmpControlGroup, bridgeGroup=bridgeGroup, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, dfsTableIndex=dfsTableIndex, remoteRxTargetPower=remoteRxTargetPower, telecomsChannelAStatusTrap=telecomsChannelAStatusTrap, telecomsChannelBStatusTrap=telecomsChannelBStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, telecomsChannelBStatus=telecomsChannelBStatus, linkModeOptimisation=linkModeOptimisation, receiveDataRate=receiveDataRate, targetRange=targetRange, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, rxColorCode=rxColorCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bridge=bridge, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, iPv4Address=iPv4Address, groupID=groupID, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, channelALineCode=channelALineCode, channelChangeTrap=channelChangeTrap, userTable=userTable, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, channelBLineCode=channelBLineCode, rawReceivePower=rawReceivePower, receivePower=receivePower, timeZone=timeZone, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, dSCPManagementPriority=dSCPManagementPriority, management=management, installStatus=installStatus, productName=productName, ethernetPriorityTable=ethernetPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, channelBLoopbackTrap=channelBLoopbackTrap, systemReset=systemReset, telecomsChannelSelection=telecomsChannelSelection, subnetMask=subnetMask, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, ethernetBridgingAvailability=ethernetBridgingAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsInterface=telecomsInterface, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaGain=antennaGain, transmitChannel=transmitChannel, installArmState=installArmState, l2CPPriorityTable=l2CPPriorityTable, receiveModulationMode=receiveModulationMode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, supplementary=supplementary, remoteIPAddress=remoteIPAddress, channelBLoopback=channelBLoopback, wirelessLinkStatus=wirelessLinkStatus, ptp600=ptp600, gatewayIPAddress=gatewayIPAddress, managementPortStatus=managementPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, ptmp=ptmp, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortStatusTrap=managementPortStatusTrap, telecomsChannelAStatus=telecomsChannelAStatus, automaticTxPowerControl=automaticTxPowerControl, ethernetFiberSupport=ethernetFiberSupport, iPVersion=iPVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, versionsGroup=versionsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetBridgingStatusAlarmTrap=ethernetBridgingStatusAlarmTrap, phyControlGroup=phyControlGroup, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, sntpGroup=sntpGroup, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, ethernetBridgingStatus=ethernetBridgingStatus, PYSNMP_MODULE_ID=cambium, ptp=ptp, maximumTransmitPower=maximumTransmitPower, channelBCableLength=channelBCableLength, tFTPServerInternetAddress=tFTPServerInternetAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, productVariant=productVariant, regionCode=regionCode, cambium=cambium, telecom=telecom, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementMode=managementMode, masterSlaveMode=masterSlaveMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, telecomGroup=telecomGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userEnabled=userEnabled, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, systemClock=systemClock, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClient=syslogClient, tFTPServerInternetAddressType=tFTPServerInternetAddressType, hTTPSPortNumber=hTTPSPortNumber, alarms=alarms)
mibBuilder.exportSymbols("CAMBIUM-PTP600-MIB", regionCodeTrap=regionCodeTrap, reset=reset, userTableIndex=userTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkLoss=linkLoss, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, siteName=siteName, hardwareVersion=hardwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarning=dataPortDisabledWarning, targetMACAddress=targetMACAddress, sNTPLastSync=sNTPLastSync, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptpGroups=ptpGroups, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, channelALoopbackTrap=channelALoopbackTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementGroup=managementGroup, linkName=linkName, dataPortStatus=dataPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogControl=syslogControl, sNTPState=sNTPState, longitude=longitude, pubStatsGroup=pubStatsGroup, dataPortFiberStatusTrap=dataPortFiberStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, qOSPriorityScheme=qOSPriorityScheme, vLANManagementVID=vLANManagementVID, encryption=encryption)
