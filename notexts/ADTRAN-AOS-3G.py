...
# ASN.1 source ADTRAN-AOS-3G
# Source digest sha256:2e2abfd886f9a31d9eaac6625dc64791dc233be31b8b86abf179548c53090a15
...
if mibBuilder.loadTexts: adGenAOS3GMib.setLastUpdated('2010-01-05 00:00')
...
adGenAOS3GTable = MibTable((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: adGenAOS3GTable.setStatus('current')
adGenAOS3GEntry = MibTableRow((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
adGenAOS3GHardwareDataTable = MibTable((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: adGenAOS3GHardwareDataTable.setStatus('current')
adGenAOS3GHardwareDataEntry = MibTableRow((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
adGenAOS3GThresholdDataTable = MibTable((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: adGenAOS3GThresholdDataTable.setStatus('current')
adGenAOS3GThresholdDataEntry = MibTableRow((1, 3, 6, 1, 4, 1, 664, 5, 53, 6, 2, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
mibBuilder.exportSymbols("ADTRAN-AOS-3G", PYSNMP_MODULE_ID=adGenAOS3GMib, adGenAOS3G=adGenAOS3G, adGenAOS3GAAASPI=adGenAOS3GAAASPI, adGenAOS3GAAASS=adGenAOS3GAAASS, adGenAOS3GCompliances=adGenAOS3GCompliances, adGenAOS3GConformance=adGenAOS3GConformance, adGenAOS3GConnectionState=adGenAOS3GConnectionState, adGenAOS3GECIO=adGenAOS3GECIO, adGenAOS3GECIOIntegerValue=adGenAOS3GECIOIntegerValue, adGenAOS3GECIOThreshold=adGenAOS3GECIOThreshold, adGenAOS3GESN=adGenAOS3GESN, adGenAOS3GEnableTraps=adGenAOS3GEnableTraps, adGenAOS3GEntry=adGenAOS3GEntry, adGenAOS3GFirmwareVersion=adGenAOS3GFirmwareVersion, adGenAOS3GFullCompliance=adGenAOS3GFullCompliance, adGenAOS3GGroup=adGenAOS3GGroup, adGenAOS3GHASPI=adGenAOS3GHASPI, adGenAOS3GHASS=adGenAOS3GHASS, adGenAOS3GHardwareDataEntry=adGenAOS3GHardwareDataEntry, adGenAOS3GHardwareDataGroup=adGenAOS3GHardwareDataGroup, adGenAOS3GHardwareDataTable=adGenAOS3GHardwareDataTable, adGenAOS3GHardwareVersion=adGenAOS3GHardwareVersion, adGenAOS3GHomeAddress=adGenAOS3GHomeAddress, adGenAOS3GMib=adGenAOS3GMib, adGenAOS3GMobileDirNumber=adGenAOS3GMobileDirNumber, adGenAOS3GMobileStationID=adGenAOS3GMobileStationID, adGenAOS3GNetworkAccessID=adGenAOS3GNetworkAccessID, adGenAOS3GNetworkID=adGenAOS3GNetworkID, adGenAOS3GPnOffset=adGenAOS3GPnOffset, adGenAOS3GPrefferedRoamList=adGenAOS3GPrefferedRoamList, adGenAOS3GPrimaryHomeAddress=adGenAOS3GPrimaryHomeAddress, adGenAOS3GRSSI=adGenAOS3GRSSI, adGenAOS3GRSSIThreshold=adGenAOS3GRSSIThreshold, adGenAOS3GReverseTunneling=adGenAOS3GReverseTunneling, adGenAOS3GSecHomeAddress=adGenAOS3GSecHomeAddress, adGenAOS3GServiceType=adGenAOS3GServiceType, adGenAOS3GServiceTypePreference=adGenAOS3GServiceTypePreference, adGenAOS3GSystemID=adGenAOS3GSystemID, adGenAOS3GTable=adGenAOS3GTable, adGenAOS3GTableGroup=adGenAOS3GTableGroup, adGenAOS3GThresholdDataEntry=adGenAOS3GThresholdDataEntry, adGenAOS3GThresholdDataGroup=adGenAOS3GThresholdDataGroup, adGenAOS3GThresholdDataTable=adGenAOS3GThresholdDataTable, adGenAOS3GTrapGroup=adGenAOS3GTrapGroup, adGenAOS3GTraps=adGenAOS3GTraps, configValueSet=configValueSet, connectionStateDownAlarm=connectionStateDownAlarm, ecioDataRangeAlarm=ecioDataRangeAlarm, ecioDataRangeClear=ecioDataRangeClear, modemResetAlarm=modemResetAlarm, rssiDataRangeAlarm=rssiDataRangeAlarm, rssiDataRangeClear=rssiDataRangeClear, serviceTypeChangeAlarm=serviceTypeChangeAlarm)
