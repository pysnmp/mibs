...
RowStatus, TimeStamp, TextualConvention, DisplayString, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSTable=docsQosPHSTable, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetGroup=docsQosParamSetGroup, docsQosMIB=docsQosMIB, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetPriority=docsQosParamSetPriority, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPHSSize=docsQosPHSSize, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDCCAcks=docsQosDCCAcks, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, BitRate=BitRate, docsQosNotification=docsQosNotification, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassDirection=docsQosPktClassDirection, docsQosConformance=docsQosConformance, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassId=docsQosPktClassId, docsQosDCCs=docsQosDCCs, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosUpstreamFragments=docsQosUpstreamFragments, SchedulingType=SchedulingType, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosCompliance=docsQosCompliance, docsQosParamSetType=docsQosParamSetType, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPHSIndex=docsQosPHSIndex, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPHSField=docsQosPHSField, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosGroups=docsQosGroups, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDSDRsps=docsQosDSDRsps, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetTable=docsQosParamSetTable, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPHSMask=docsQosPHSMask, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosSID=docsQosSID, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosPktClassPriority=docsQosPktClassPriority, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSCReqs=docsQosDSCReqs, docsQosPHSEntry=docsQosPHSEntry, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosCmtsGroup=docsQosCmtsGroup, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosCompliances=docsQosCompliances, docsQosIfDirection=docsQosIfDirection, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, IfDirection=IfDirection, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart)
