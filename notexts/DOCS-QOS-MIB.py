...
MacAddress, RowStatus, TimeStamp, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosDSAReqs=docsQosDSAReqs, docsQosCompliances=docsQosCompliances, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosNotification=docsQosNotification, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassId=docsQosPktClassId, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPHSEntry=docsQosPHSEntry, docsQosDSARsps=docsQosDSARsps, docsQosDCCs=docsQosDCCs, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassName=docsQosServiceClassName, BitRate=BitRate, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosConformance=docsQosConformance, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosCmtsIfIndex=docsQosCmtsIfIndex, IfDirection=IfDirection, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosBaseGroup=docsQosBaseGroup, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPHSMask=docsQosPHSMask, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosIfDirection=docsQosIfDirection, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPHSSize=docsQosPHSSize, docsQosMIB=docsQosMIB, docsQosGroups=docsQosGroups, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, SchedulingType=SchedulingType, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosCompliance=docsQosCompliance, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPHSField=docsQosPHSField, docsQosPHSTable=docsQosPHSTable, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosSID=docsQosSID, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDSAAcks=docsQosDSAAcks, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetType=docsQosParamSetType, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable)
