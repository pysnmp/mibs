...
TruthValue, DisplayString, TextualConvention, TimeStamp, MacAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp", "MacAddress", "RowStatus")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPHSField=docsQosPHSField, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosMIB=docsQosMIB, docsQosDSARsps=docsQosDSARsps, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassName=docsQosServiceClassName, docsQosMIBObjects=docsQosMIBObjects, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosSID=docsQosSID, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetBitMap=docsQosParamSetBitMap, PYSNMP_MODULE_ID=docsQosMIB, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetPriority=docsQosParamSetPriority, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassGroup=docsQosServiceClassGroup, IfDirection=IfDirection, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassEntry=docsQosPktClassEntry, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosConformance=docsQosConformance, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosGroups=docsQosGroups, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, SchedulingType=SchedulingType, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosIfDirection=docsQosIfDirection, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosParamSetType=docsQosParamSetType, BitRate=BitRate, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosDCCReqs=docsQosDCCReqs, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPHSEntry=docsQosPHSEntry, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDCCFails=docsQosDCCFails, docsQosDynamicChanges=docsQosDynamicChanges, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosCompliances=docsQosCompliances, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCompliance=docsQosCompliance, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosNotification=docsQosNotification, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassId=docsQosPktClassId, docsQosDSCReqs=docsQosDSCReqs, docsQosDCCs=docsQosDCCs, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct)
