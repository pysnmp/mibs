...
TimeStamp, DisplayString, RowStatus, TruthValue, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TruthValue", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDSCAcks=docsQosDSCAcks, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosIfDirection=docsQosIfDirection, docsQosDynamicAdds=docsQosDynamicAdds, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosMIB=docsQosMIB, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosPHSEntry=docsQosPHSEntry, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassVlanId=docsQosPktClassVlanId, BitRate=BitRate, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPHSMask=docsQosPHSMask, docsQosNotification=docsQosNotification, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCompliances=docsQosCompliances, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, SchedulingType=SchedulingType, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDSDRsps=docsQosDSDRsps, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDSAReqs=docsQosDSAReqs, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassEntry=docsQosPktClassEntry, docsQosSID=docsQosSID, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDSARsps=docsQosDSARsps, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPktClassTable=docsQosPktClassTable, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassPkts=docsQosPktClassPkts, docsQosGroups=docsQosGroups, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsGroup=docsQosCmtsGroup, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCompliance=docsQosCompliance, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDSCReqs=docsQosDSCReqs, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPHSVerify=docsQosPHSVerify, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosDCCs=docsQosDCCs, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, IfDirection=IfDirection, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDCCAcks=docsQosDCCAcks, docsQosDCCFails=docsQosDCCFails, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPHSTable=docsQosPHSTable, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPHSIndex=docsQosPHSIndex, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosConformance=docsQosConformance, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSField=docsQosPHSField, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst)
