...
DisplayString, TimeStamp, TruthValue, RowStatus, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosNotification=docsQosNotification, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPHSEntry=docsQosPHSEntry, docsQosCompliance=docsQosCompliance, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassGroup=docsQosServiceClassGroup, IfDirection=IfDirection, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDSCReqs=docsQosDSCReqs, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosIfDirection=docsQosIfDirection, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosDCCs=docsQosDCCs, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosSID=docsQosSID, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosMIB=docsQosMIB, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDSCRsps=docsQosDSCRsps, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetTable=docsQosParamSetTable, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosGroups=docsQosGroups, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, BitRate=BitRate, docsQosCompliances=docsQosCompliances, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPHSField=docsQosPHSField, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosDCCFails=docsQosDCCFails, docsQosPktClassState=docsQosPktClassState, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPHSSize=docsQosPHSSize, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosMIBObjects=docsQosMIBObjects, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSCAcks=docsQosDSCAcks, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPHSMask=docsQosPHSMask, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicChanges=docsQosDynamicChanges, SchedulingType=SchedulingType, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPHSTable=docsQosPHSTable, docsQosConformance=docsQosConformance, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDSDReqs=docsQosDSDReqs, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable)
