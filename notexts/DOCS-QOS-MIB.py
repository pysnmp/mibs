...
MacAddress, TimeStamp, TextualConvention, TruthValue, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosSID=docsQosSID, docsQosDynamicChanges=docsQosDynamicChanges, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, PYSNMP_MODULE_ID=docsQosMIB, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosNotification=docsQosNotification, docsQosPHSTable=docsQosPHSTable, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosDSARsps=docsQosDSARsps, docsQosPHSField=docsQosPHSField, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, IfDirection=IfDirection, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCompliance=docsQosCompliance, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosDCCs=docsQosDCCs, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosDynamicAdds=docsQosDynamicAdds, docsQosParamSetGroup=docsQosParamSetGroup, SchedulingType=SchedulingType, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDSDRsps=docsQosDSDRsps, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosMIB=docsQosMIB, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosCompliances=docsQosCompliances, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosIfDirection=docsQosIfDirection, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassState=docsQosPktClassState, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetTable=docsQosParamSetTable, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDSAReqs=docsQosDSAReqs, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, BitRate=BitRate, docsQosPHSVerify=docsQosPHSVerify, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosConformance=docsQosConformance, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosDSAAcks=docsQosDSAAcks, docsQosPHSMask=docsQosPHSMask, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosGroups=docsQosGroups, docsQosCmtsGroup=docsQosCmtsGroup, docsQosParamSetEntry=docsQosParamSetEntry, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosPHSSize=docsQosPHSSize, docsQosPktClassId=docsQosPktClassId, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts)
