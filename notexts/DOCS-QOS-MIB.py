...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosNotification=docsQosNotification, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosConformance=docsQosConformance, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPHSVerify=docsQosPHSVerify, docsQosPHSEntry=docsQosPHSEntry, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosMIB=docsQosMIB, docsQosPHSMask=docsQosPHSMask, docsQosGroups=docsQosGroups, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDSAReqs=docsQosDSAReqs, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDSDRsps=docsQosDSDRsps, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDCCs=docsQosDCCs, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosDSAAcks=docsQosDSAAcks, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassState=docsQosPktClassState, docsQosPHSSize=docsQosPHSSize, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassId=docsQosPktClassId, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDSDReqs=docsQosDSDReqs, docsQosCompliances=docsQosCompliances, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosCompliance=docsQosCompliance, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassEntry=docsQosPktClassEntry, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPHSField=docsQosPHSField, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetTable=docsQosParamSetTable, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPHSTable=docsQosPHSTable, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, BitRate=BitRate, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowPkts=docsQosServiceFlowPkts, SchedulingType=SchedulingType, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosDSCReqs=docsQosDSCReqs, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassVlanId=docsQosPktClassVlanId, IfDirection=IfDirection, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosSID=docsQosSID, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh)
