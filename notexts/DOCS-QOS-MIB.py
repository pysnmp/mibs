...
RowStatus, DisplayString, MacAddress, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "MacAddress", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPHSVerify=docsQosPHSVerify, docsQosParamSetType=docsQosParamSetType, docsQosNotification=docsQosNotification, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosDynamicChanges=docsQosDynamicChanges, BitRate=BitRate, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosDSDRsps=docsQosDSDRsps, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDCCs=docsQosDCCs, docsQosPHSSize=docsQosPHSSize, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDynamicAdds=docsQosDynamicAdds, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPHSField=docsQosPHSField, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPHSEntry=docsQosPHSEntry, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosGroups=docsQosGroups, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPHSIndex=docsQosPHSIndex, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosCompliance=docsQosCompliance, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosSID=docsQosSID, docsQosCompliances=docsQosCompliances, PYSNMP_MODULE_ID=docsQosMIB, docsQosDSAReqs=docsQosDSAReqs, SchedulingType=SchedulingType, docsQosPktClassId=docsQosPktClassId, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDSDReqs=docsQosDSDReqs, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosDCCReqs=docsQosDCCReqs, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosBaseGroup=docsQosBaseGroup, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetPriority=docsQosParamSetPriority, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosDCCFails=docsQosDCCFails, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosMIB=docsQosMIB, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosConformance=docsQosConformance, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPHSMask=docsQosPHSMask, IfDirection=IfDirection, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName)
