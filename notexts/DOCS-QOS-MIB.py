...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosGroups=docsQosGroups, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPHSMask=docsQosPHSMask, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDCCFails=docsQosDCCFails, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, IfDirection=IfDirection, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosMIB=docsQosMIB, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosDSCAcks=docsQosDSCAcks, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosDSAReqs=docsQosDSAReqs, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetEntry=docsQosParamSetEntry, docsQosSID=docsQosSID, docsQosDSDReqs=docsQosDSDReqs, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetPriority=docsQosParamSetPriority, docsQosMIBObjects=docsQosMIBObjects, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosParamSetTable=docsQosParamSetTable, docsQosPHSField=docsQosPHSField, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosCompliance=docsQosCompliance, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosBaseGroup=docsQosBaseGroup, BitRate=BitRate, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosDSCReqs=docsQosDSCReqs, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosConformance=docsQosConformance, docsQosNotification=docsQosNotification, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPHSIndex=docsQosPHSIndex, docsQosDCCs=docsQosDCCs, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosCompliances=docsQosCompliances, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassId=docsQosPktClassId, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDSARsps=docsQosDSARsps, SchedulingType=SchedulingType, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassPkts=docsQosPktClassPkts)
