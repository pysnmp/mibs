...
TimeStamp, TruthValue, DisplayString, MacAddress, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "MacAddress", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, SchedulingType=SchedulingType, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, PYSNMP_MODULE_ID=docsQosMIB, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, BitRate=BitRate, docsQosServiceFlowId=docsQosServiceFlowId, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosDynamicAdds=docsQosDynamicAdds, docsQosDSCReqs=docsQosDSCReqs, docsQosConformance=docsQosConformance, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosMIB=docsQosMIB, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosNotification=docsQosNotification, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPHSVerify=docsQosPHSVerify, docsQosPHSIndex=docsQosPHSIndex, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSTable=docsQosPHSTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosCompliance=docsQosCompliance, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDCCs=docsQosDCCs, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosCompliances=docsQosCompliances, IfDirection=IfDirection, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosSID=docsQosSID, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassId=docsQosPktClassId, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosDSAReqs=docsQosDSAReqs, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPHSSize=docsQosPHSSize, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPHSMask=docsQosPHSMask, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosPHSEntry=docsQosPHSEntry, docsQosGroups=docsQosGroups, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPHSField=docsQosPHSField, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDCCReqs=docsQosDCCReqs, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosDSCRsps=docsQosDSCRsps, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetType=docsQosParamSetType, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassState=docsQosPktClassState, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPktClassPriority=docsQosPktClassPriority, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable)
