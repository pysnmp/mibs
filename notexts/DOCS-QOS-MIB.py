...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosMIB=docsQosMIB, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPHSMask=docsQosPHSMask, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosCompliance=docsQosCompliance, SchedulingType=SchedulingType, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPHSVerify=docsQosPHSVerify, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassState=docsQosPktClassState, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPktClassId=docsQosPktClassId, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosIfDirection=docsQosIfDirection, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPHSField=docsQosPHSField, docsQosDSCReqs=docsQosDSCReqs, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosNotification=docsQosNotification, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDSAAcks=docsQosDSAAcks, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosGroups=docsQosGroups, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCompliances=docsQosCompliances, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetPriority=docsQosParamSetPriority, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosDCCs=docsQosDCCs, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetGroup=docsQosParamSetGroup, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosConformance=docsQosConformance, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPHSIndex=docsQosPHSIndex, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosDynamicAdds=docsQosDynamicAdds, docsQosParamSetType=docsQosParamSetType, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosDSDReqs=docsQosDSDReqs, docsQosDynamicChanges=docsQosDynamicChanges, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, PYSNMP_MODULE_ID=docsQosMIB, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassTable=docsQosPktClassTable, IfDirection=IfDirection, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, BitRate=BitRate, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosSID=docsQosSID, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout)
