...
TextualConvention, DisplayString, TimeStamp, RowStatus, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassEntry=docsQosPktClassEntry, docsQosDSAAcks=docsQosDSAAcks, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosGroups=docsQosGroups, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosDCCAcks=docsQosDCCAcks, docsQosCompliance=docsQosCompliance, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassId=docsQosPktClassId, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassDirection=docsQosPktClassDirection, docsQosConformance=docsQosConformance, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDCCs=docsQosDCCs, docsQosPHSMask=docsQosPHSMask, docsQosDSCRsps=docsQosDSCRsps, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosParamSetEntry=docsQosParamSetEntry, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosCompliances=docsQosCompliances, docsQosServiceFlowOctets=docsQosServiceFlowOctets, IfDirection=IfDirection, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDynamicChanges=docsQosDynamicChanges, docsQosDCCFails=docsQosDCCFails, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosSID=docsQosSID, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassState=docsQosPktClassState, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPHSSize=docsQosPHSSize, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDSARsps=docsQosDSARsps, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, PYSNMP_MODULE_ID=docsQosMIB, docsQosMIB=docsQosMIB, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPHSTable=docsQosPHSTable, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetTable=docsQosParamSetTable, SchedulingType=SchedulingType, docsQosParamSetPriority=docsQosParamSetPriority, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, BitRate=BitRate, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosNotification=docsQosNotification, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassTable=docsQosServiceClassTable, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosBaseGroup=docsQosBaseGroup, docsQosPHSField=docsQosPHSField)
