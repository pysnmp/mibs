...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosCmtsGroup=docsQosCmtsGroup, docsQosParamSetPriority=docsQosParamSetPriority, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPHSField=docsQosPHSField, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosDSCAcks=docsQosDSCAcks, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosDCCs=docsQosDCCs, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassId=docsQosPktClassId, docsQosDSAReqs=docsQosDSAReqs, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosMIBObjects=docsQosMIBObjects, SchedulingType=SchedulingType, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPHSVerify=docsQosPHSVerify, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassPriority=docsQosServiceClassPriority, BitRate=BitRate, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosGroups=docsQosGroups, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassTable=docsQosPktClassTable, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosBaseGroup=docsQosBaseGroup, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosNotification=docsQosNotification, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPHSTable=docsQosPHSTable, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosDSCRsps=docsQosDSCRsps, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDSDRsps=docsQosDSDRsps, docsQosCompliance=docsQosCompliance, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosCompliances=docsQosCompliances, docsQosConformance=docsQosConformance, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPHSEntry=docsQosPHSEntry, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosDSCReqs=docsQosDSCReqs, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetType=docsQosParamSetType, docsQosMIB=docsQosMIB, docsQosPktClassState=docsQosPktClassState, docsQosPHSMask=docsQosPHSMask, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosParamSetTable=docsQosParamSetTable, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosIfDirection=docsQosIfDirection, IfDirection=IfDirection, docsQosSID=docsQosSID, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPHSSize=docsQosPHSSize, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout)
