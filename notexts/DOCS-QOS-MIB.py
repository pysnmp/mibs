...
RowStatus, TruthValue, TimeStamp, DisplayString, MacAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "DisplayString", "MacAddress", "TextualConvention")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetTable=docsQosParamSetTable, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassTable=docsQosServiceClassTable, docsQosCompliances=docsQosCompliances, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosCompliance=docsQosCompliance, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosGroups=docsQosGroups, docsQosDCCRsps=docsQosDCCRsps, SchedulingType=SchedulingType, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosDSARsps=docsQosDSARsps, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetEntry=docsQosParamSetEntry, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, IfDirection=IfDirection, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosNotification=docsQosNotification, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetGroup=docsQosParamSetGroup, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassName=docsQosServiceClassName, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosMIB=docsQosMIB, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, PYSNMP_MODULE_ID=docsQosMIB, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosSID=docsQosSID, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosDCCs=docsQosDCCs, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, BitRate=BitRate, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPHSField=docsQosPHSField, docsQosPHSVerify=docsQosPHSVerify, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosConformance=docsQosConformance, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPHSTable=docsQosPHSTable, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPHSIndex=docsQosPHSIndex, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassState=docsQosPktClassState, docsQosDSCAcks=docsQosDSCAcks, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosDCCFails=docsQosDCCFails, docsQosDSDRsps=docsQosDSDRsps)
