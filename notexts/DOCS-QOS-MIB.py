...
TextualConvention, TimeStamp, MacAddress, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "MacAddress", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDynamicAdds=docsQosDynamicAdds, docsQosCompliances=docsQosCompliances, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosPktClassId=docsQosPktClassId, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDSAReqs=docsQosDSAReqs, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosGroups=docsQosGroups, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosCompliance=docsQosCompliance, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, PYSNMP_MODULE_ID=docsQosMIB, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDynamicChanges=docsQosDynamicChanges, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosBaseGroup=docsQosBaseGroup, IfDirection=IfDirection, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosDCCRsps=docsQosDCCRsps, BitRate=BitRate, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, SchedulingType=SchedulingType, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSField=docsQosPHSField, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosSID=docsQosSID, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosDCCs=docsQosDCCs, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPHSMask=docsQosPHSMask, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetGroup=docsQosParamSetGroup, docsQosMIB=docsQosMIB, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosConformance=docsQosConformance, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosNotification=docsQosNotification, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassState=docsQosPktClassState, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetPriority=docsQosParamSetPriority, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosDSCRsps=docsQosDSCRsps, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry)
