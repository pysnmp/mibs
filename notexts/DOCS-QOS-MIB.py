...
TextualConvention, MacAddress, TruthValue, TimeStamp, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "TruthValue", "TimeStamp", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDSAReqs=docsQosDSAReqs, docsQosDSCRsps=docsQosDSCRsps, docsQosDSCReqs=docsQosDSCReqs, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, SchedulingType=SchedulingType, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosDCCs=docsQosDCCs, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassEntry=docsQosPktClassEntry, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosDSDRsps=docsQosDSDRsps, docsQosPHSTable=docsQosPHSTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosCompliances=docsQosCompliances, docsQosDSCAcks=docsQosDSCAcks, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPHSMask=docsQosPHSMask, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDSARsps=docsQosDSARsps, docsQosDSAAcks=docsQosDSAAcks, docsQosGroups=docsQosGroups, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassTable=docsQosPktClassTable, docsQosParamSetPriority=docsQosParamSetPriority, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosCmtsGroup=docsQosCmtsGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, IfDirection=IfDirection, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, BitRate=BitRate, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassId=docsQosPktClassId, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowId=docsQosServiceFlowId, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosNotification=docsQosNotification, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPHSField=docsQosPHSField, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosSID=docsQosSID, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosCompliance=docsQosCompliance, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDynamicAdds=docsQosDynamicAdds, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosConformance=docsQosConformance, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPHSVerify=docsQosPHSVerify, docsQosDCCReqs=docsQosDCCReqs, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosMIBObjects=docsQosMIBObjects, docsQosMIB=docsQosMIB, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask)
