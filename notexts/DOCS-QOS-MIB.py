...
TruthValue, MacAddress, TextualConvention, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "MacAddress", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosNotification=docsQosNotification, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, SchedulingType=SchedulingType, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSDRsps=docsQosDSDRsps, docsQosPktClassId=docsQosPktClassId, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosCompliances=docsQosCompliances, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosCompliance=docsQosCompliance, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosSID=docsQosSID, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosConformance=docsQosConformance, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, IfDirection=IfDirection, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPHSEntry=docsQosPHSEntry, docsQosPHSMask=docsQosPHSMask, docsQosIfDirection=docsQosIfDirection, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPHSIndex=docsQosPHSIndex, docsQosDSCReqs=docsQosDSCReqs, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetTable=docsQosParamSetTable, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, BitRate=BitRate, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPHSField=docsQosPHSField, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDSAAcks=docsQosDSAAcks, docsQosDCCs=docsQosDCCs, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassState=docsQosPktClassState, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDCCReqs=docsQosDCCReqs, docsQosDCCFails=docsQosDCCFails, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosMIB=docsQosMIB, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosMIBObjects=docsQosMIBObjects, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDSARsps=docsQosDSARsps, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosGroups=docsQosGroups, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosParamSetGroup=docsQosParamSetGroup, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPHSTable=docsQosPHSTable, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout)
