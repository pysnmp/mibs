...
TextualConvention, RowStatus, MacAddress, TimeStamp, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "MacAddress", "TimeStamp", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosSID=docsQosSID, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosMIBObjects=docsQosMIBObjects, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosDSCRsps=docsQosDSCRsps, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassGroup=docsQosServiceClassGroup, PYSNMP_MODULE_ID=docsQosMIB, docsQosNotification=docsQosNotification, docsQosPHSIndex=docsQosPHSIndex, SchedulingType=SchedulingType, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPHSMask=docsQosPHSMask, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosIfDirection=docsQosIfDirection, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassId=docsQosPktClassId, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPHSField=docsQosPHSField, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDCCRsps=docsQosDCCRsps, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDCCAcks=docsQosDCCAcks, docsQosCompliances=docsQosCompliances, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosCompliance=docsQosCompliance, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, BitRate=BitRate, docsQosDSCReqs=docsQosDSCReqs, docsQosMIB=docsQosMIB, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDCCFails=docsQosDCCFails, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosConformance=docsQosConformance, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassPriority=docsQosPktClassPriority, docsQosGroups=docsQosGroups, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassEntry=docsQosPktClassEntry, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosDynamicChanges=docsQosDynamicChanges, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, IfDirection=IfDirection, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSTable=docsQosPHSTable, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosDCCs=docsQosDCCs, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceFlowSID=docsQosServiceFlowSID)
