...
RowStatus, TextualConvention, TimeStamp, TruthValue, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosGroups=docsQosGroups, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicAdds=docsQosDynamicAdds, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDCCs=docsQosDCCs, docsQosServiceClassName=docsQosServiceClassName, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosDSCReqs=docsQosDSCReqs, docsQosPHSEntry=docsQosPHSEntry, docsQosDSDReqs=docsQosDSDReqs, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, BitRate=BitRate, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassEntry=docsQosPktClassEntry, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosCompliances=docsQosCompliances, docsQosCompliance=docsQosCompliance, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDynamicChanges=docsQosDynamicChanges, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosDSCRsps=docsQosDSCRsps, docsQosPHSField=docsQosPHSField, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, IfDirection=IfDirection, docsQosNotification=docsQosNotification, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosDSDRsps=docsQosDSDRsps, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDSARsps=docsQosDSARsps, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDCCRsps=docsQosDCCRsps, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, SchedulingType=SchedulingType, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosParamSetType=docsQosParamSetType, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassId=docsQosPktClassId, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosMIB=docsQosMIB, docsQosPktClassState=docsQosPktClassState, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassTable=docsQosPktClassTable, docsQosPHSMask=docsQosPHSMask, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosConformance=docsQosConformance, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosSID=docsQosSID, docsQosCmtsGroup=docsQosCmtsGroup, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPHSTable=docsQosPHSTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetEntry=docsQosParamSetEntry, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosBaseGroup=docsQosBaseGroup)
