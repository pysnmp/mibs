...
TextualConvention, TimeStamp, DisplayString, RowStatus, MacAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "MacAddress", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassTable=docsQosServiceClassTable, IfDirection=IfDirection, docsQosPHSEntry=docsQosPHSEntry, docsQosConformance=docsQosConformance, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosDSCRsps=docsQosDSCRsps, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassId=docsQosPktClassId, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosParamSetType=docsQosParamSetType, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetEntry=docsQosParamSetEntry, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDynamicChanges=docsQosDynamicChanges, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosUpstreamFragments=docsQosUpstreamFragments, SchedulingType=SchedulingType, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosCompliances=docsQosCompliances, docsQosMIB=docsQosMIB, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosDSARsps=docsQosDSARsps, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, PYSNMP_MODULE_ID=docsQosMIB, docsQosDCCs=docsQosDCCs, docsQosNotification=docsQosNotification, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, BitRate=BitRate, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPHSField=docsQosPHSField, docsQosCompliance=docsQosCompliance, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosGroups=docsQosGroups, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPHSMask=docsQosPHSMask, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassState=docsQosPktClassState, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosParamSetTable=docsQosParamSetTable, docsQosSID=docsQosSID, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassPriority=docsQosPktClassPriority, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDSCReqs=docsQosDSCReqs, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassEntry=docsQosPktClassEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSTable=docsQosPHSTable, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceClassName=docsQosServiceClassName)
