...
TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "MacAddress")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetType=docsQosParamSetType, docsQosPktClassPriority=docsQosPktClassPriority, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPHSMask=docsQosPHSMask, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDynamicChanges=docsQosDynamicChanges, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosCompliance=docsQosCompliance, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSCAcks=docsQosDSCAcks, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPktClassEntry=docsQosPktClassEntry, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassId=docsQosPktClassId, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosDSCReqs=docsQosDSCReqs, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassTable=docsQosPktClassTable, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSDReqs=docsQosDSDReqs, IfDirection=IfDirection, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, BitRate=BitRate, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassState=docsQosPktClassState, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosMIBObjects=docsQosMIBObjects, docsQosCompliances=docsQosCompliances, SchedulingType=SchedulingType, docsQosPHSEntry=docsQosPHSEntry, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPHSSize=docsQosPHSSize, docsQosPHSField=docsQosPHSField, PYSNMP_MODULE_ID=docsQosMIB, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosMIB=docsQosMIB, docsQosNotification=docsQosNotification, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosGroups=docsQosGroups, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosDCCs=docsQosDCCs, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosDCCAcks=docsQosDCCAcks, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDSARsps=docsQosDSARsps, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSVerify=docsQosPHSVerify, docsQosSID=docsQosSID, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosDSDRsps=docsQosDSDRsps, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPHSTable=docsQosPHSTable, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosConformance=docsQosConformance, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType)
