...
RowStatus, TimeStamp, DisplayString, MacAddress, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "MacAddress", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosParamSetType=docsQosParamSetType, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPHSTable=docsQosPHSTable, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPHSMask=docsQosPHSMask, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetPriority=docsQosParamSetPriority, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPHSVerify=docsQosPHSVerify, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, IfDirection=IfDirection, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosDynamicChanges=docsQosDynamicChanges, docsQosDCCRsps=docsQosDCCRsps, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassPriority=docsQosPktClassPriority, docsQosDSAAcks=docsQosDSAAcks, docsQosPHSField=docsQosPHSField, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceFlowId=docsQosServiceFlowId, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDSCReqs=docsQosDSCReqs, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosMIB=docsQosMIB, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosNotification=docsQosNotification, docsQosGroups=docsQosGroups, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosSID=docsQosSID, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetGroup=docsQosParamSetGroup, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDCCAcks=docsQosDCCAcks, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicDeletes=docsQosDynamicDeletes, BitRate=BitRate, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosConformance=docsQosConformance, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPHSSize=docsQosPHSSize, docsQosDCCs=docsQosDCCs, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDSDRsps=docsQosDSDRsps, docsQosCompliances=docsQosCompliances, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassTable=docsQosPktClassTable, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassBitMap=docsQosPktClassBitMap, SchedulingType=SchedulingType, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosCompliance=docsQosCompliance, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh)
