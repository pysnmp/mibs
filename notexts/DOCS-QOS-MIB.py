...
TextualConvention, MacAddress, RowStatus, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "RowStatus", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosSID=docsQosSID, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosIfDirection=docsQosIfDirection, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDSDReqs=docsQosDSDReqs, docsQosNotification=docsQosNotification, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetType=docsQosParamSetType, docsQosDCCAcks=docsQosDCCAcks, docsQosDynamicAdds=docsQosDynamicAdds, BitRate=BitRate, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPHSMask=docsQosPHSMask, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDCCs=docsQosDCCs, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosDSAReqs=docsQosDSAReqs, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPHSSize=docsQosPHSSize, docsQosPHSIndex=docsQosPHSIndex, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosDCCRsps=docsQosDCCRsps, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCompliances=docsQosCompliances, docsQosMIB=docsQosMIB, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosGroups=docsQosGroups, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, SchedulingType=SchedulingType, docsQosDCCFails=docsQosDCCFails, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDSCRsps=docsQosDSCRsps, docsQosConformance=docsQosConformance, docsQosPHSField=docsQosPHSField, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, IfDirection=IfDirection, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosCompliance=docsQosCompliance, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetTable=docsQosParamSetTable, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPHSTable=docsQosPHSTable, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowId=docsQosServiceFlowId, docsQosDSARsps=docsQosDSARsps, docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize)
