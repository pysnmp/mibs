...
RowStatus, MacAddress, DisplayString, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPHSTable=docsQosPHSTable, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, BitRate=BitRate, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosNotification=docsQosNotification, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDSCRsps=docsQosDSCRsps, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, SchedulingType=SchedulingType, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosSID=docsQosSID, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosDCCs=docsQosDCCs, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosConformance=docsQosConformance, docsQosDynamicAdds=docsQosDynamicAdds, docsQosCompliances=docsQosCompliances, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowId=docsQosServiceFlowId, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassState=docsQosPktClassState, docsQosGroups=docsQosGroups, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosDCCReqs=docsQosDCCReqs, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSField=docsQosPHSField, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosCompliance=docsQosCompliance, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetType=docsQosParamSetType, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPHSMask=docsQosPHSMask, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassEntry=docsQosPktClassEntry, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDSDRsps=docsQosDSDRsps, IfDirection=IfDirection, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPHSSize=docsQosPHSSize, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosMIB=docsQosMIB, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosDSARsps=docsQosDSARsps, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr)
