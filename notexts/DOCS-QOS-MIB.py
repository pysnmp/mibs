...
MacAddress, TextualConvention, TimeStamp, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosPktClassId=docsQosPktClassId, docsQosDCCs=docsQosDCCs, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, IfDirection=IfDirection, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosMIB=docsQosMIB, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetPriority=docsQosParamSetPriority, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassTable=docsQosServiceClassTable, docsQosIfDirection=docsQosIfDirection, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetEntry=docsQosParamSetEntry, docsQosNotification=docsQosNotification, docsQosPHSIndex=docsQosPHSIndex, docsQosDSCReqs=docsQosDSCReqs, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetType=docsQosParamSetType, docsQosPHSEntry=docsQosPHSEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDynamicAdds=docsQosDynamicAdds, PYSNMP_MODULE_ID=docsQosMIB, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosSID=docsQosSID, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, SchedulingType=SchedulingType, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDSDRsps=docsQosDSDRsps, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPHSSize=docsQosPHSSize, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosCompliances=docsQosCompliances, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassState=docsQosPktClassState, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosPHSTable=docsQosPHSTable, docsQosPHSMask=docsQosPHSMask, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceFlowDirection=docsQosServiceFlowDirection, BitRate=BitRate, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosConformance=docsQosConformance, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPHSField=docsQosPHSField, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosGroups=docsQosGroups, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassName=docsQosServiceClassName, docsQosDynamicChanges=docsQosDynamicChanges, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosCompliance=docsQosCompliance)
