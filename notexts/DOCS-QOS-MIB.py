...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassDirection=docsQosPktClassDirection, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetPriority=docsQosParamSetPriority, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosDSDReqs=docsQosDSDReqs, docsQosPHSIndex=docsQosPHSIndex, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosDynamicDeletes=docsQosDynamicDeletes, IfDirection=IfDirection, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosNotification=docsQosNotification, docsQosPHSField=docsQosPHSField, docsQosPktClassEntry=docsQosPktClassEntry, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosSID=docsQosSID, docsQosPHSVerify=docsQosPHSVerify, docsQosConformance=docsQosConformance, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, PYSNMP_MODULE_ID=docsQosMIB, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDCCAcks=docsQosDCCAcks, docsQosGroups=docsQosGroups, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetType=docsQosParamSetType, docsQosBaseGroup=docsQosBaseGroup, SchedulingType=SchedulingType, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosDCCRsps=docsQosDCCRsps, docsQosMIB=docsQosMIB, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosDCCs=docsQosDCCs, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDynamicChanges=docsQosDynamicChanges, docsQosCompliance=docsQosCompliance, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSMask=docsQosPHSMask, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPHSTable=docsQosPHSTable, docsQosPktClassId=docsQosPktClassId, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosCompliances=docsQosCompliances, docsQosPktClassState=docsQosPktClassState, docsQosIfDirection=docsQosIfDirection, docsQosParamSetTable=docsQosParamSetTable, docsQosDSCRsps=docsQosDSCRsps, docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, BitRate=BitRate, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards)
