...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassId=docsQosPktClassId, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosCompliances=docsQosCompliances, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosSID=docsQosSID, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCompliance=docsQosCompliance, docsQosDCCs=docsQosDCCs, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassState=docsQosPktClassState, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosGroups=docsQosGroups, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPHSMask=docsQosPHSMask, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDCCRsps=docsQosDCCRsps, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosDSDRsps=docsQosDSDRsps, docsQosPHSTable=docsQosPHSTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, SchedulingType=SchedulingType, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPHSVerify=docsQosPHSVerify, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosConformance=docsQosConformance, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosParamSetEntry=docsQosParamSetEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosMIB=docsQosMIB, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSField=docsQosPHSField, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSAReqs=docsQosDSAReqs, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDCCAcks=docsQosDCCAcks, BitRate=BitRate, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosDSARsps=docsQosDSARsps, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosDSDReqs=docsQosDSDReqs, IfDirection=IfDirection, docsQosParamSetPriority=docsQosParamSetPriority, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowId=docsQosServiceFlowId, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDSCAcks=docsQosDSCAcks, docsQosNotification=docsQosNotification, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst)
