...
TextualConvention, TimeStamp, TruthValue, DisplayString, RowStatus, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "MacAddress")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosMIB=docsQosMIB, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosDSAReqs=docsQosDSAReqs, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosNotification=docsQosNotification, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosCompliances=docsQosCompliances, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDSARsps=docsQosDSARsps, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, IfDirection=IfDirection, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicAdds=docsQosDynamicAdds, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosDCCFails=docsQosDCCFails, docsQosMIBObjects=docsQosMIBObjects, SchedulingType=SchedulingType, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPHSVerify=docsQosPHSVerify, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPktClassVlanId=docsQosPktClassVlanId, BitRate=BitRate, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassEntry=docsQosPktClassEntry, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosCompliance=docsQosCompliance, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassTable=docsQosPktClassTable, docsQosConformance=docsQosConformance, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosPHSField=docsQosPHSField, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosGroups=docsQosGroups, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosDCCs=docsQosDCCs, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPHSMask=docsQosPHSMask, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosPktClassState=docsQosPktClassState, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetGroup=docsQosParamSetGroup, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosDSDRsps=docsQosDSDRsps, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosDSCAcks=docsQosDSCAcks, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosIfDirection=docsQosIfDirection, docsQosDSDReqs=docsQosDSDReqs, docsQosSID=docsQosSID, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetType=docsQosParamSetType)
