...
TimeStamp, TextualConvention, DisplayString, MacAddress, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "MacAddress", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPHSTable=docsQosPHSTable, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, SchedulingType=SchedulingType, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosNotification=docsQosNotification, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosIfDirection=docsQosIfDirection, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosMIB=docsQosMIB, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPHSSize=docsQosPHSSize, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassId=docsQosPktClassId, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPHSIndex=docsQosPHSIndex, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDCCReqs=docsQosDCCReqs, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosConformance=docsQosConformance, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosDynamicAdds=docsQosDynamicAdds, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassTable=docsQosPktClassTable, docsQosPHSMask=docsQosPHSMask, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassPkts=docsQosPktClassPkts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassDirection=docsQosPktClassDirection, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosCompliance=docsQosCompliance, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosDCCAcks=docsQosDCCAcks, IfDirection=IfDirection, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPHSEntry=docsQosPHSEntry, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosCmtsGroup=docsQosCmtsGroup, docsQosParamSetType=docsQosParamSetType, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassPriority=docsQosPktClassPriority, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosGroups=docsQosGroups, docsQosServiceFlowDirection=docsQosServiceFlowDirection, BitRate=BitRate, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSDRsps=docsQosDSDRsps, docsQosPHSField=docsQosPHSField, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassTable=docsQosServiceClassTable, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosCompliances=docsQosCompliances, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosSID=docsQosSID, docsQosDSCReqs=docsQosDSCReqs, docsQosDCCs=docsQosDCCs, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr)
