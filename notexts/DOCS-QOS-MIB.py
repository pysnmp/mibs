...
TruthValue, DisplayString, TextualConvention, RowStatus, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "RowStatus", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosSID=docsQosSID, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPHSField=docsQosPHSField, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosConformance=docsQosConformance, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassStatus=docsQosServiceClassStatus, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosCompliances=docsQosCompliances, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosDSCAcks=docsQosDSCAcks, docsQosDSAAcks=docsQosDSAAcks, docsQosDCCFails=docsQosDCCFails, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, SchedulingType=SchedulingType, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassId=docsQosPktClassId, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosMIB=docsQosMIB, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosIfDirection=docsQosIfDirection, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPHSSize=docsQosPHSSize, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosDSDRsps=docsQosDSDRsps, IfDirection=IfDirection, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCompliance=docsQosCompliance, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDCCAcks=docsQosDCCAcks, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosDSCReqs=docsQosDSCReqs, docsQosDSAReqs=docsQosDSAReqs, docsQosGroups=docsQosGroups, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetTable=docsQosParamSetTable, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetPriority=docsQosParamSetPriority, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosNotification=docsQosNotification, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPHSTable=docsQosPHSTable, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDCCs=docsQosDCCs, BitRate=BitRate, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart)
