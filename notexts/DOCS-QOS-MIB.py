...
TruthValue, TextualConvention, RowStatus, TimeStamp, MacAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp", "MacAddress", "DisplayString")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDynamicChanges=docsQosDynamicChanges, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosMIB=docsQosMIB, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosGroups=docsQosGroups, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPktClassEntry=docsQosPktClassEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPHSVerify=docsQosPHSVerify, docsQosMIBObjects=docsQosMIBObjects, docsQosDSDRsps=docsQosDSDRsps, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosParamSetPriority=docsQosParamSetPriority, docsQosSID=docsQosSID, docsQosCompliances=docsQosCompliances, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassTable=docsQosPktClassTable, docsQosIfDirection=docsQosIfDirection, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetGroup=docsQosParamSetGroup, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPHSSize=docsQosPHSSize, docsQosNotification=docsQosNotification, docsQosDCCs=docsQosDCCs, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosBaseGroup=docsQosBaseGroup, docsQosPktClassId=docsQosPktClassId, docsQosPktClassState=docsQosPktClassState, docsQosParamSetTable=docsQosParamSetTable, docsQosUpstreamFragments=docsQosUpstreamFragments, IfDirection=IfDirection, docsQosPHSMask=docsQosPHSMask, docsQosPHSTable=docsQosPHSTable, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosDSCRsps=docsQosDSCRsps, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, BitRate=BitRate, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, SchedulingType=SchedulingType, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosConformance=docsQosConformance, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosCompliance=docsQosCompliance, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosPHSField=docsQosPHSField, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt)
