...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosDCCFails=docsQosDCCFails, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosSID=docsQosSID, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassId=docsQosPktClassId, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosMIB=docsQosMIB, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPHSField=docsQosPHSField, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, BitRate=BitRate, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceClassName=docsQosServiceClassName, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosConformance=docsQosConformance, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPHSEntry=docsQosPHSEntry, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosDCCRsps=docsQosDCCRsps, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosCompliance=docsQosCompliance, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDCCAcks=docsQosDCCAcks, docsQosPHSTable=docsQosPHSTable, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, IfDirection=IfDirection, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPHSVerify=docsQosPHSVerify, docsQosGroups=docsQosGroups, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosMIBObjects=docsQosMIBObjects, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetPriority=docsQosParamSetPriority, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDSCAcks=docsQosDSCAcks, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassEntry=docsQosServiceClassEntry, PYSNMP_MODULE_ID=docsQosMIB, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, SchedulingType=SchedulingType, docsQosCompliances=docsQosCompliances, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassState=docsQosPktClassState, docsQosDSARsps=docsQosDSARsps, docsQosDCCs=docsQosDCCs, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSDRsps=docsQosDSDRsps, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPHSIndex=docsQosPHSIndex, docsQosIfDirection=docsQosIfDirection, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosNotification=docsQosNotification, docsQosPktClassTable=docsQosPktClassTable, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPHSSize=docsQosPHSSize)
