...
TextualConvention, TruthValue, MacAddress, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "MacAddress", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetType=docsQosParamSetType, docsQosDynamicChanges=docsQosDynamicChanges, docsQosMIB=docsQosMIB, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosDCCs=docsQosDCCs, docsQosIfDirection=docsQosIfDirection, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosConformance=docsQosConformance, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowTable=docsQosServiceFlowTable, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosCmtsGroup=docsQosCmtsGroup, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosDSARsps=docsQosDSARsps, docsQosDynamicAdds=docsQosDynamicAdds, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassPriority=docsQosPktClassPriority, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowId=docsQosServiceFlowId, docsQosCompliances=docsQosCompliances, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosBaseGroup=docsQosBaseGroup, SchedulingType=SchedulingType, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPHSVerify=docsQosPHSVerify, docsQosDSCReqs=docsQosDSCReqs, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDSCRsps=docsQosDSCRsps, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosCompliance=docsQosCompliance, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosNotification=docsQosNotification, BitRate=BitRate, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosParamSetPriority=docsQosParamSetPriority, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosPktClassId=docsQosPktClassId, docsQosDCCFails=docsQosDCCFails, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosGroups=docsQosGroups, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetEntry=docsQosParamSetEntry, docsQosPHSTable=docsQosPHSTable, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosSID=docsQosSID, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosDSAAcks=docsQosDSAAcks, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosPHSField=docsQosPHSField, IfDirection=IfDirection, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPHSMask=docsQosPHSMask, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosMIBObjects=docsQosMIBObjects, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry)
