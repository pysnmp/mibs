...
TimeStamp, TruthValue, MacAddress, DisplayString, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "MacAddress", "DisplayString", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDynamicChanges=docsQosDynamicChanges, docsQosPHSMask=docsQosPHSMask, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosMIBObjects=docsQosMIBObjects, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosNotification=docsQosNotification, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosDCCFails=docsQosDCCFails, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassTable=docsQosPktClassTable, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosDCCRsps=docsQosDCCRsps, IfDirection=IfDirection, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosSID=docsQosSID, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPHSField=docsQosPHSField, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosConformance=docsQosConformance, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, SchedulingType=SchedulingType, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosMIB=docsQosMIB, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosPHSTable=docsQosPHSTable, docsQosDSDReqs=docsQosDSDReqs, docsQosParamSetTable=docsQosParamSetTable, docsQosPHSEntry=docsQosPHSEntry, docsQosPktClassId=docsQosPktClassId, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetGroup=docsQosParamSetGroup, docsQosDSCAcks=docsQosDSCAcks, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDSCReqs=docsQosDSCReqs, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosCompliances=docsQosCompliances, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosGroups=docsQosGroups, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDCCs=docsQosDCCs, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, BitRate=BitRate, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassState=docsQosPktClassState, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPHSIndex=docsQosPHSIndex, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPHSSize=docsQosPHSSize, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosDCCAcks=docsQosDCCAcks, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosCompliance=docsQosCompliance)
