...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassId=docsQosPktClassId, docsQosNotification=docsQosNotification, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosCompliance=docsQosCompliance, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosPHSSize=docsQosPHSSize, docsQosPHSField=docsQosPHSField, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetType=docsQosParamSetType, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDCCs=docsQosDCCs, docsQosGroups=docsQosGroups, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, IfDirection=IfDirection, docsQosParamSetEntry=docsQosParamSetEntry, docsQosConformance=docsQosConformance, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosCompliances=docsQosCompliances, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDynamicChanges=docsQosDynamicChanges, docsQosDSARsps=docsQosDSARsps, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassTable=docsQosServiceClassTable, docsQosPktClassTable=docsQosPktClassTable, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPktClassEntry=docsQosPktClassEntry, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosDCCFails=docsQosDCCFails, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosDSAReqs=docsQosDSAReqs, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetTable=docsQosParamSetTable, docsQosPHSTable=docsQosPHSTable, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosDSCRsps=docsQosDSCRsps, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassPkts=docsQosPktClassPkts, docsQosMIBObjects=docsQosMIBObjects, SchedulingType=SchedulingType, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPktClassState=docsQosPktClassState, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosMIB=docsQosMIB, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPHSIndex=docsQosPHSIndex, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosSID=docsQosSID, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosParamSetPriority=docsQosParamSetPriority, docsQosParamSetGroup=docsQosParamSetGroup, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPHSEntry=docsQosPHSEntry, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosIfDirection=docsQosIfDirection, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDSCAcks=docsQosDSCAcks, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, BitRate=BitRate, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosDCCRsps=docsQosDCCRsps)
