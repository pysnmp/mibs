...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosDSAReqs=docsQosDSAReqs, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosSID=docsQosSID, docsQosPHSEntry=docsQosPHSEntry, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosPHSField=docsQosPHSField, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDSCRsps=docsQosDSCRsps, docsQosDCCs=docsQosDCCs, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosCompliance=docsQosCompliance, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, BitRate=BitRate, docsQosDynamicAdds=docsQosDynamicAdds, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetTable=docsQosParamSetTable, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowId=docsQosServiceFlowId, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosConformance=docsQosConformance, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosGroups=docsQosGroups, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDSAAcks=docsQosDSAAcks, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosPktClassTable=docsQosPktClassTable, docsQosNotification=docsQosNotification, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPHSMask=docsQosPHSMask, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassId=docsQosPktClassId, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosPktClassState=docsQosPktClassState, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosPktClassPkts=docsQosPktClassPkts, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDCCReqs=docsQosDCCReqs, docsQosDCCRsps=docsQosDCCRsps, docsQosCompliances=docsQosCompliances, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPHSTable=docsQosPHSTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPHSSize=docsQosPHSSize, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, IfDirection=IfDirection, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosDSDRsps=docsQosDSDRsps, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, SchedulingType=SchedulingType, docsQosDCCFails=docsQosDCCFails, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosMIB=docsQosMIB, docsQosDSARsps=docsQosDSARsps, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosPHSVerify=docsQosPHSVerify, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout)
