...
TextualConvention, TruthValue, DisplayString, RowStatus, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "RowStatus", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosPHSSize=docsQosPHSSize, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosDynamicAdds=docsQosDynamicAdds, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosPHSField=docsQosPHSField, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosCompliances=docsQosCompliances, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosPktClassId=docsQosPktClassId, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosMIB=docsQosMIB, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPHSMask=docsQosPHSMask, docsQosDCCs=docsQosDCCs, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, SchedulingType=SchedulingType, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPHSIndex=docsQosPHSIndex, docsQosCompliance=docsQosCompliance, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosConformance=docsQosConformance, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosDSDReqs=docsQosDSDReqs, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosGroups=docsQosGroups, docsQosParamSetGroup=docsQosParamSetGroup, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosParamSetTable=docsQosParamSetTable, docsQosIfDirection=docsQosIfDirection, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosPktClassDirection=docsQosPktClassDirection, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosDCCAcks=docsQosDCCAcks, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, IfDirection=IfDirection, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPHSVerify=docsQosPHSVerify, BitRate=BitRate, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosBaseGroup=docsQosBaseGroup, docsQosSID=docsQosSID, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPktClassState=docsQosPktClassState, docsQosPHSEntry=docsQosPHSEntry, docsQosNotification=docsQosNotification, docsQosPktClassTable=docsQosPktClassTable, docsQosDCCFails=docsQosDCCFails, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosDSCAcks=docsQosDSCAcks, docsQosDSARsps=docsQosDSARsps, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSTable=docsQosPHSTable, docsQosDCCReqs=docsQosDCCReqs, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts)
