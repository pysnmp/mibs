...
TimeStamp, TruthValue, TextualConvention, DisplayString, RowStatus, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "RowStatus", "MacAddress")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceFlowId=docsQosServiceFlowId, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosDCCReqs=docsQosDCCReqs, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDSAAcks=docsQosDSAAcks, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPktClassId=docsQosPktClassId, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosPHSField=docsQosPHSField, docsQosConformance=docsQosConformance, docsQosBaseGroup=docsQosBaseGroup, docsQosDSCAcks=docsQosDSCAcks, docsQosServiceFlowEntry=docsQosServiceFlowEntry, SchedulingType=SchedulingType, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicChanges=docsQosDynamicChanges, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosDCCs=docsQosDCCs, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPHSMask=docsQosPHSMask, docsQosParamSetGroup=docsQosParamSetGroup, docsQosCompliances=docsQosCompliances, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetType=docsQosParamSetType, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosCompliance=docsQosCompliance, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosMIB=docsQosMIB, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosGroups=docsQosGroups, docsQosDSCRsps=docsQosDSCRsps, docsQosDCCRsps=docsQosDCCRsps, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosParamSetPriority=docsQosParamSetPriority, IfDirection=IfDirection, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosDCCAcks=docsQosDCCAcks, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosDSCReqs=docsQosDSCReqs, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDCCFails=docsQosDCCFails, docsQosPHSVerify=docsQosPHSVerify, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassPriority=docsQosPktClassPriority, docsQosMIBObjects=docsQosMIBObjects, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassState=docsQosPktClassState, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosParamSetEntry=docsQosParamSetEntry, docsQosDSDRsps=docsQosDSDRsps, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosDSDReqs=docsQosDSDReqs, docsQosSID=docsQosSID, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassTable=docsQosServiceClassTable, docsQosDSARsps=docsQosDSARsps, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosNotification=docsQosNotification, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPHSTable=docsQosPHSTable, BitRate=BitRate, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh)
