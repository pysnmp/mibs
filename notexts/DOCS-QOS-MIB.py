...
TextualConvention, RowStatus, DisplayString, TruthValue, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "MacAddress", "TimeStamp")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDSDRsps=docsQosDSDRsps, docsQosBaseGroup=docsQosBaseGroup, IfDirection=IfDirection, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosMIB=docsQosMIB, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosDynamicAdds=docsQosDynamicAdds, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosDCCReqs=docsQosDCCReqs, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassId=docsQosPktClassId, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosDSAReqs=docsQosDSAReqs, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosSID=docsQosSID, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosDSDReqs=docsQosDSDReqs, docsQosDynamicChanges=docsQosDynamicChanges, docsQosNotification=docsQosNotification, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosServiceClassTable=docsQosServiceClassTable, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPHSSize=docsQosPHSSize, docsQosDSAAcks=docsQosDSAAcks, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, BitRate=BitRate, docsQosServiceFlowId=docsQosServiceFlowId, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDCCs=docsQosDCCs, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPktClassDirection=docsQosPktClassDirection, docsQosIfDirection=docsQosIfDirection, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, SchedulingType=SchedulingType, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosDCCFails=docsQosDCCFails, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosGroups=docsQosGroups, docsQosPktClassPkts=docsQosPktClassPkts, docsQosPktClassEntry=docsQosPktClassEntry, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosCompliances=docsQosCompliances, docsQosParamSetType=docsQosParamSetType, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetPriority=docsQosParamSetPriority, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosDSCReqs=docsQosDSCReqs, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosPHSMask=docsQosPHSMask, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosCompliance=docsQosCompliance, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosCmtsGroup=docsQosCmtsGroup, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosPHSField=docsQosPHSField, docsQosConformance=docsQosConformance, docsQosPHSIndex=docsQosPHSIndex, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosDCCAcks=docsQosDCCAcks, PYSNMP_MODULE_ID=docsQosMIB, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosPHSVerify=docsQosPHSVerify, docsQosDSCRsps=docsQosDSCRsps, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosPktClassTable=docsQosPktClassTable, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosParamSetTable=docsQosParamSetTable, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry)
