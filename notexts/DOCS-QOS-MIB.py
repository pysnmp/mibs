...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosPHSTable=docsQosPHSTable, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, IfDirection=IfDirection, docsQosDCCReqs=docsQosDCCReqs, docsQosNotification=docsQosNotification, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosCompliances=docsQosCompliances, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosPktClassTable=docsQosPktClassTable, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceFlowId=docsQosServiceFlowId, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosDSDReqs=docsQosDSDReqs, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosPktClassId=docsQosPktClassId, docsQosDynamicAdds=docsQosDynamicAdds, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosSID=docsQosSID, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosDCCs=docsQosDCCs, docsQosMIB=docsQosMIB, docsQosParamSetEntry=docsQosParamSetEntry, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosDSCAcks=docsQosDSCAcks, docsQosCompliance=docsQosCompliance, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosConformance=docsQosConformance, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosGroups=docsQosGroups, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosCmtsGroup=docsQosCmtsGroup, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassPriority=docsQosPktClassPriority, docsQosPktClassState=docsQosPktClassState, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosServiceClassTable=docsQosServiceClassTable, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, docsQosDSAReqs=docsQosDSAReqs, docsQosDCCFails=docsQosDCCFails, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, BitRate=BitRate, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, PYSNMP_MODULE_ID=docsQosMIB, docsQosDSCReqs=docsQosDSCReqs, docsQosPHSMask=docsQosPHSMask, docsQosPktClassEntry=docsQosPktClassEntry, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosDCCAcks=docsQosDCCAcks, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosParamSetType=docsQosParamSetType, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosBaseGroup=docsQosBaseGroup, docsQosDSAAcks=docsQosDSAAcks, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosMIBObjects=docsQosMIBObjects, docsQosPktClassPkts=docsQosPktClassPkts, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, SchedulingType=SchedulingType, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosDSCRsps=docsQosDSCRsps, docsQosServiceClassName=docsQosServiceClassName, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPHSSize=docsQosPHSSize, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosParamSetPriority=docsQosParamSetPriority, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosDSARsps=docsQosDSARsps, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPHSEntry=docsQosPHSEntry, docsQosDSDRsps=docsQosDSDRsps, docsQosPHSField=docsQosPHSField, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosPHSVerify=docsQosPHSVerify, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosPktClassDirection=docsQosPktClassDirection, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosParamSetTable=docsQosParamSetTable, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosIfDirection=docsQosIfDirection, docsQosParamSetGroup=docsQosParamSetGroup, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosDynamicChanges=docsQosDynamicChanges, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosParamSetBitMap=docsQosParamSetBitMap)
