...
RowStatus, TimeStamp, TextualConvention, DisplayString, TruthValue, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "TruthValue", "MacAddress")
...
mibBuilder.exportSymbols("DOCS-QOS-MIB", docsQosDynamicDeleteFails=docsQosDynamicDeleteFails, docsQosServiceFlowLogPolicedDelayPkts=docsQosServiceFlowLogPolicedDelayPkts, docsQosPHSSize=docsQosPHSSize, docsQosConformance=docsQosConformance, docsQosDSCAcks=docsQosDSCAcks, docsQosParamSetAdmittedTimeout=docsQosParamSetAdmittedTimeout, PYSNMP_MODULE_ID=docsQosMIB, docsQosPktClassEntry=docsQosPktClassEntry, docsQosDSAAcks=docsQosDSAAcks, docsQosPktClassPriority=docsQosPktClassPriority, docsQosServiceClassTosAndMask=docsQosServiceClassTosAndMask, docsQosParamSetMaxTrafficRate=docsQosParamSetMaxTrafficRate, docsQosServiceClassNomPollInterval=docsQosServiceClassNomPollInterval, docsQosDSARsps=docsQosDSARsps, docsQosServiceFlowLogOctets=docsQosServiceFlowLogOctets, docsQosCmtsGroup=docsQosCmtsGroup, IfDirection=IfDirection, docsQosPktClassIpDestMask=docsQosPktClassIpDestMask, docsQosDynamicDeletes=docsQosDynamicDeletes, docsQosServiceFlowLogTable=docsQosServiceFlowLogTable, docsQosParamSetTosOrMask=docsQosParamSetTosOrMask, docsQosCmtsServiceFlowId=docsQosCmtsServiceFlowId, docsQosServiceClassPolicyIndex=docsQosServiceClassPolicyIndex, docsQosServiceFlowLogIndex=docsQosServiceFlowLogIndex, docsQosServiceFlowEntry=docsQosServiceFlowEntry, docsQosServiceFlowLogEntry=docsQosServiceFlowLogEntry, docsQosServiceClassActiveTimeout=docsQosServiceClassActiveTimeout, docsQosServiceFlowLogCmMac=docsQosServiceFlowLogCmMac, docsQosPktClassEnetProtocol=docsQosPktClassEnetProtocol, docsQosDSCReqs=docsQosDSCReqs, docsQosDynamicChangeFails=docsQosDynamicChangeFails, docsQosPHSIndex=docsQosPHSIndex, docsQosServiceClassTolPollJitter=docsQosServiceClassTolPollJitter, docsQosPktClassIpProtocol=docsQosPktClassIpProtocol, docsQosDCCAcks=docsQosDCCAcks, docsQosCompliances=docsQosCompliances, SchedulingType=SchedulingType, docsQosServiceClassGrantsPerInterval=docsQosServiceClassGrantsPerInterval, docsQosMIBObjects=docsQosMIBObjects, docsQosServiceClassTable=docsQosServiceClassTable, docsQosCmtsMacToSrvFlowTable=docsQosCmtsMacToSrvFlowTable, docsQosUpstreamFragments=docsQosUpstreamFragments, docsQosPktClassPkts=docsQosPktClassPkts, docsQosParamSetMinReservedPkt=docsQosParamSetMinReservedPkt, docsQosServiceFlowLogPrimary=docsQosServiceFlowLogPrimary, docsQosCompliance=docsQosCompliance, docsQosPHSEntry=docsQosPHSEntry, docsQosServiceClassGroup=docsQosServiceClassGroup, docsQosServiceFlowLogPolicedDropPkts=docsQosServiceFlowLogPolicedDropPkts, docsQosServiceClassSchedulingType=docsQosServiceClassSchedulingType, docsQosPktClassUserPriLow=docsQosPktClassUserPriLow, docsQosServiceFlowLogDirection=docsQosServiceFlowLogDirection, docsQosServiceClassMaxTrafficRate=docsQosServiceClassMaxTrafficRate, docsQosUpstreamFragDiscards=docsQosUpstreamFragDiscards, docsQosUpstreamStatsEntry=docsQosUpstreamStatsEntry, docsQosParamSetGrantsPerInterval=docsQosParamSetGrantsPerInterval, docsQosServiceClassPolicyRulePriority=docsQosServiceClassPolicyRulePriority, docsQosServiceFlowLogTimeActive=docsQosServiceFlowLogTimeActive, docsQosServiceClassRequestPolicy=docsQosServiceClassRequestPolicy, docsQosDCCRsps=docsQosDCCRsps, docsQosServiceClassMaxTrafficBurst=docsQosServiceClassMaxTrafficBurst, docsQosPktClassState=docsQosPktClassState, docsQosDynamicServiceStatsTable=docsQosDynamicServiceStatsTable, docsQosParamSetActiveTimeout=docsQosParamSetActiveTimeout, BitRate=BitRate, docsQosServiceClassMaxConcatBurst=docsQosServiceClassMaxConcatBurst, docsQosServiceFlowSID=docsQosServiceFlowSID, docsQosDynamicChanges=docsQosDynamicChanges, docsQosPktClassIpTosLow=docsQosPktClassIpTosLow, docsQosParamSetNomPollInterval=docsQosParamSetNomPollInterval, docsQosServiceFlowPrimary=docsQosServiceFlowPrimary, docsQosPktClassIpDestAddr=docsQosPktClassIpDestAddr, docsQosServiceFlowId=docsQosServiceFlowId, docsQosPktClassSourceMacAddr=docsQosPktClassSourceMacAddr, docsQosServiceFlowLogControl=docsQosServiceFlowLogControl, docsQosServiceClassUnsolicitGrantSize=docsQosServiceClassUnsolicitGrantSize, docsQosPHSField=docsQosPHSField, docsQosServiceClassPolicyName=docsQosServiceClassPolicyName, docsQosServiceClassMaxLatency=docsQosServiceClassMaxLatency, docsQosParamSetUnsolicitGrantSize=docsQosParamSetUnsolicitGrantSize, docsQosSID=docsQosSID, docsQosPHSVerify=docsQosPHSVerify, docsQosServiceClassEntry=docsQosServiceClassEntry, docsQosParamSetServiceClassName=docsQosParamSetServiceClassName, docsQosPHSTable=docsQosPHSTable, docsQosCmtsCmMac=docsQosCmtsCmMac, docsQosServiceClassPriority=docsQosServiceClassPriority, docsQosDCCs=docsQosDCCs, docsQosServiceFlowLogServiceClassName=docsQosServiceFlowLogServiceClassName, docsQosNotification=docsQosNotification, docsQosServiceFlowLogSFID=docsQosServiceFlowLogSFID, docsQosCmtsIfIndex=docsQosCmtsIfIndex, docsQosParamSetTolGrantJitter=docsQosParamSetTolGrantJitter, docsQosParamSetBitMap=docsQosParamSetBitMap, docsQosPktClassEnetProtocolType=docsQosPktClassEnetProtocolType, docsQosPktClassId=docsQosPktClassId, docsQosPktClassIpTosHigh=docsQosPktClassIpTosHigh, docsQosParamSetMaxLatency=docsQosParamSetMaxLatency, docsQosServiceFlowStatsTable=docsQosServiceFlowStatsTable, docsQosServiceClassMinReservedRate=docsQosServiceClassMinReservedRate, docsQosServiceFlowOctets=docsQosServiceFlowOctets, docsQosServiceFlowLogTimeDeleted=docsQosServiceFlowLogTimeDeleted, docsQosParamSetTable=docsQosParamSetTable, docsQosSrvClassPolicyGroup=docsQosSrvClassPolicyGroup, docsQosPktClassDestPortEnd=docsQosPktClassDestPortEnd, docsQosPktClassDestMacAddr=docsQosPktClassDestMacAddr, docsQosPktClassIpSourceAddr=docsQosPktClassIpSourceAddr, docsQosServiceClassPolicyStatus=docsQosServiceClassPolicyStatus, docsQosParamSetEntry=docsQosParamSetEntry, docsQosUpstreamConcatBursts=docsQosUpstreamConcatBursts, docsQosDynamicServiceStatsEntry=docsQosDynamicServiceStatsEntry, docsQosDSDReqs=docsQosDSDReqs, docsQosServiceFlowLogTimeCreated=docsQosServiceFlowLogTimeCreated, docsQosServiceClassPolicyEntry=docsQosServiceClassPolicyEntry, docsQosDynamicAddFails=docsQosDynamicAddFails, docsQosParamSetRequestPolicyOct=docsQosParamSetRequestPolicyOct, docsQosMIB=docsQosMIB, docsQosPktClassSourcePortEnd=docsQosPktClassSourcePortEnd, docsQosServiceClassTolGrantJitter=docsQosServiceClassTolGrantJitter, docsQosPktClassUserPriHigh=docsQosPktClassUserPriHigh, docsQosPktClassDestMacMask=docsQosPktClassDestMacMask, docsQosParamSetTolPollJitter=docsQosParamSetTolPollJitter, docsQosPktClassVlanId=docsQosPktClassVlanId, docsQosCmtsMacToSrvFlowEntry=docsQosCmtsMacToSrvFlowEntry, docsQosServiceFlowPolicedDelayPkts=docsQosServiceFlowPolicedDelayPkts, docsQosParamSetNomGrantInterval=docsQosParamSetNomGrantInterval, docsQosDCCReqs=docsQosDCCReqs, docsQosPktClassIpSourceMask=docsQosPktClassIpSourceMask, docsQosParamSetMaxTrafficBurst=docsQosParamSetMaxTrafficBurst, docsQosUpstreamStatsTable=docsQosUpstreamStatsTable, docsQosServiceFlowPolicedDropPkts=docsQosServiceFlowPolicedDropPkts, docsQosDSDRsps=docsQosDSDRsps, docsQosServiceClassMinReservedPkt=docsQosServiceClassMinReservedPkt, docsQosPHSMask=docsQosPHSMask, docsQosServiceClassPolicyTable=docsQosServiceClassPolicyTable, docsQosServiceClassNomGrantInterval=docsQosServiceClassNomGrantInterval, docsQosParamSetTosAndMask=docsQosParamSetTosAndMask, docsQosParamSetGroup=docsQosParamSetGroup, docsQosParamSetSchedulingType=docsQosParamSetSchedulingType, docsQosParamSetMinReservedRate=docsQosParamSetMinReservedRate, docsQosPktClassBitMap=docsQosPktClassBitMap, docsQosPktClassDestPortStart=docsQosPktClassDestPortStart, docsQosServiceFlowDirection=docsQosServiceFlowDirection, docsQosServiceFlowPkts=docsQosServiceFlowPkts, docsQosIfDirection=docsQosIfDirection, docsQosServiceClassAdmittedTimeout=docsQosServiceClassAdmittedTimeout, docsQosServiceClassTosOrMask=docsQosServiceClassTosOrMask, docsQosServiceFlowTimeCreated=docsQosServiceFlowTimeCreated, docsQosParamSetPriority=docsQosParamSetPriority, docsQosGroups=docsQosGroups, docsQosServiceFlowTable=docsQosServiceFlowTable, docsQosDCCFails=docsQosDCCFails, docsQosPktClassTable=docsQosPktClassTable, docsQosPktClassSourcePortStart=docsQosPktClassSourcePortStart, docsQosServiceFlowLogIfIndex=docsQosServiceFlowLogIfIndex, docsQosServiceClassStatus=docsQosServiceClassStatus, docsQosServiceFlowTimeActive=docsQosServiceFlowTimeActive, docsQosServiceClassDirection=docsQosServiceClassDirection, docsQosServiceFlowStatsEntry=docsQosServiceFlowStatsEntry, docsQosParamSetType=docsQosParamSetType, docsQosServiceFlowLogPkts=docsQosServiceFlowLogPkts, docsQosPktClassIpTosMask=docsQosPktClassIpTosMask, docsQosBaseGroup=docsQosBaseGroup, docsQosParamSetMaxConcatBurst=docsQosParamSetMaxConcatBurst, docsQosServiceClassName=docsQosServiceClassName, docsQosPktClassDirection=docsQosPktClassDirection, docsQosDSAReqs=docsQosDSAReqs, docsQosServiceFlowPHSUnknowns=docsQosServiceFlowPHSUnknowns, docsQosDSCRsps=docsQosDSCRsps, docsQosDynamicAdds=docsQosDynamicAdds)
