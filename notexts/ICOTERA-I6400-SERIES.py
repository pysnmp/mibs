...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:14:54 2023
...
ModuleIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, MibIdentifier, Gauge32, IpAddress, Counter32, Unsigned32, Counter64, iso, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "MibIdentifier", "Gauge32", "IpAddress", "Counter32", "Unsigned32", "Counter64", "iso", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMcastAnalyzer=ictMcastAnalyzer, transceiverDdmTemperature=transceiverDdmTemperature, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrAvgPps=histMetrAvgPps, curMetrSrcPort=curMetrSrcPort, ictServices=ictServices, curMetrTotalPackets=curMetrTotalPackets, curMetrStopTimestamp=curMetrStopTimestamp, histMetrMaxDelta=histMetrMaxDelta, curMetrReordered=curMetrReordered, upgExecute=upgExecute, IctTimeStamp=IctTimeStamp, curMetrMemberPorts=curMetrMemberPorts, transceiverLinkLength=transceiverLinkLength, ictFacRst=ictFacRst, transceiverDdmVoltage=transceiverDdmVoltage, curMetrAvgDelta=curMetrAvgDelta, histMetrGroupAddr=histMetrGroupAddr, histMetrMemberPorts=histMetrMemberPorts, histMetrLost=histMetrLost, transceiverDdmTxPower=transceiverDdmTxPower, transceiverTransceiverType=transceiverTransceiverType, histMetrAvgLostPps=histMetrAvgLostPps, catvModuleFilter=catvModuleFilter, curMetrJitter=curMetrJitter, curMetrDiscontinuities=curMetrDiscontinuities, upgStatus=upgStatus, transceiverDiagCapable=transceiverDiagCapable, ictServicesMibs=ictServicesMibs, performFactoryReset=performFactoryReset, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrTotalLost=histMetrTotalLost, PYSNMP_MODULE_ID=icotera, histMetrReordered=histMetrReordered, curMetrTotalSkips=curMetrTotalSkips, curMetrLost=curMetrLost, curMetrStreamType=curMetrStreamType, historyListEntry=historyListEntry, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrTotalBytes=histMetrTotalBytes, curMetrMaxDelta=curMetrMaxDelta, curMetrAvgPps=curMetrAvgPps, histMetrKbps=histMetrKbps, curMetrTotalReordered=curMetrTotalReordered, ictReboot=ictReboot, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictFwUpg=ictFwUpg, curMetrAvgKbps=curMetrAvgKbps, histMetrStreamType=histMetrStreamType, transceiverEthernetCompliance=transceiverEthernetCompliance, ictMgmt=ictMgmt, IctJitter=IctJitter, performCpeReboot=performCpeReboot, histMetrTotalPackets=histMetrTotalPackets, IctDelta=IctDelta, catvModuleRflevel=catvModuleRflevel, cfgExecute=cfgExecute, curMetrTotalLost=curMetrTotalLost, catvModuleSignalDetected=catvModuleSignalDetected, upgUrl=upgUrl, histMetrAvgDelta=histMetrAvgDelta, curGroupAddr=curGroupAddr, icotera=icotera, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverDdmRxPower=transceiverDdmRxPower, curMetrAvgLostPps=curMetrAvgLostPps, historyMetricsEntry=historyMetricsEntry, histMetrStartTimestamp=histMetrStartTimestamp, cfgTftpPath=cfgTftpPath, catvModuleAdminStatus=catvModuleAdminStatus, currentListEntry=currentListEntry, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histGroupAddr=histGroupAddr, histMetrTotalSkips=histMetrTotalSkips, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalBytes=curMetrTotalBytes, curMetrPps=curMetrPps, histMetrAvgKbps=histMetrAvgKbps, IctPortList=IctPortList, histGroupIndex=histGroupIndex, cfgStatus=cfgStatus, histMetrJitter=histMetrJitter, ictCatv=ictCatv, histMetrPps=histMetrPps, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrKbps=curMetrKbps, curGroupIndex=curGroupIndex, curMetrDstPort=curMetrDstPort, ictFacRstMib=ictFacRstMib, curMetrSourceAddr=curMetrSourceAddr, ictIGW1k=ictIGW1k, transceiverConnectorType=transceiverConnectorType, ictTransceiver=ictTransceiver, histMetrTotalReordered=histMetrTotalReordered, transceiverLaserWavelength=transceiverLaserWavelength, ictMgmtMib=ictMgmtMib, currentMetricsEntry=currentMetricsEntry, histMetrSkips=histMetrSkips, ictReset=ictReset, histMetrDiscontinuities=histMetrDiscontinuities, catvModuleLowSignal=catvModuleLowSignal, histMetrDstPort=histMetrDstPort, histMetrSourceAddr=histMetrSourceAddr, ictCfgUpdate=ictCfgUpdate, histMetrSrcPort=histMetrSrcPort, histMetrStopTimestamp=histMetrStopTimestamp, catvModulePowerLevel=catvModulePowerLevel, curMetrStartTimestamp=curMetrStartTimestamp, curMetrGroupAddr=curMetrGroupAddr, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrSkips=curMetrSkips)
