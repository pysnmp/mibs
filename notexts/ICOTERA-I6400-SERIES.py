...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalAvgDelta=histMetrTotalAvgDelta, IctPortList=IctPortList, curMetrAvgPps=curMetrAvgPps, histMetrStartTimestamp=histMetrStartTimestamp, curMetrReordered=curMetrReordered, histMetrDiscontinuities=histMetrDiscontinuities, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, catvModulePowerLevel=catvModulePowerLevel, ictMgmtMib=ictMgmtMib, transceiverLinkLength=transceiverLinkLength, ictMgmt=ictMgmt, IctTimeStamp=IctTimeStamp, curMetrStreamType=curMetrStreamType, cfgExecute=cfgExecute, curMetrLost=curMetrLost, curMetrStopTimestamp=curMetrStopTimestamp, cfgStatus=cfgStatus, histMetrTotalSkips=histMetrTotalSkips, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalAvgDelta=curMetrTotalAvgDelta, performCpeReboot=performCpeReboot, histMetrAvgLostPps=histMetrAvgLostPps, curMetrSourceAddr=curMetrSourceAddr, histMetrReordered=histMetrReordered, transceiverDdmVoltage=transceiverDdmVoltage, histMetrSrcPort=histMetrSrcPort, curGroupIndex=curGroupIndex, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTxPower=transceiverDdmTxPower, ictIGW1k=ictIGW1k, curMetrDstPort=curMetrDstPort, icotera=icotera, ictServicesMibs=ictServicesMibs, ictReset=ictReset, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalPackets=histMetrTotalPackets, curMetrTotalLost=curMetrTotalLost, catvModuleFilter=catvModuleFilter, transceiverEthernetCompliance=transceiverEthernetCompliance, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverConnectorType=transceiverConnectorType, IctJitter=IctJitter, histMetrAvgPps=histMetrAvgPps, curMetrDiscontinuities=curMetrDiscontinuities, histGroupAddr=histGroupAddr, curMetrTotalReordered=curMetrTotalReordered, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictReboot=ictReboot, curMetrKbps=curMetrKbps, curMetrTotalPackets=curMetrTotalPackets, ictMcastAnalyzer=ictMcastAnalyzer, upgExecute=upgExecute, catvModuleLowSignal=catvModuleLowSignal, curMetrJitter=curMetrJitter, ictFwUpg=ictFwUpg, histMetrPps=histMetrPps, ictTransceiver=ictTransceiver, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgKbps=curMetrAvgKbps, histMetrSkips=histMetrSkips, histGroupIndex=histGroupIndex, curMetrStartTimestamp=curMetrStartTimestamp, histMetrMaxDelta=histMetrMaxDelta, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrAvgLostPps=curMetrAvgLostPps, catvModuleSignalDetected=catvModuleSignalDetected, transceiverDdmTemperature=transceiverDdmTemperature, histMetrLost=histMetrLost, currentMetricsEntry=currentMetricsEntry, histMetrStopTimestamp=histMetrStopTimestamp, performFactoryReset=performFactoryReset, ictFacRst=ictFacRst, curGroupAddr=curGroupAddr, ictServices=ictServices, curMetrSkips=curMetrSkips, histMetrGroupAddr=histMetrGroupAddr, curMetrMaxDelta=curMetrMaxDelta, curMetrMemberPorts=curMetrMemberPorts, currentListEntry=currentListEntry, catvModuleAdminStatus=catvModuleAdminStatus, histMetrStreamType=histMetrStreamType, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, PYSNMP_MODULE_ID=icotera, ictCatv=ictCatv, curMetrSrcPort=curMetrSrcPort, histMetrAvgDelta=histMetrAvgDelta, upgStatus=upgStatus, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, catvModuleRflevel=catvModuleRflevel, curMetrGroupAddr=curMetrGroupAddr, curMetrAvgDelta=curMetrAvgDelta, cfgTftpPath=cfgTftpPath, ictCfgUpdate=ictCfgUpdate, histMetrDstPort=histMetrDstPort, histMetrTotalMaxDelta=histMetrTotalMaxDelta, historyListEntry=historyListEntry, historyMetricsEntry=historyMetricsEntry, curMetrTotalBytes=curMetrTotalBytes, histMetrJitter=histMetrJitter, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverDdmRxPower=transceiverDdmRxPower, upgUrl=upgUrl, transceiverDiagCapable=transceiverDiagCapable, IctDelta=IctDelta, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalLost=histMetrTotalLost, curMetrPps=curMetrPps, histMetrKbps=histMetrKbps, histMetrSourceAddr=histMetrSourceAddr)
