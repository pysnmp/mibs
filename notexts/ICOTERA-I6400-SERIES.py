...
ObjectIdentity, Bits, Unsigned32, NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, iso, ModuleIdentity, Integer32, enterprises, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "iso", "ModuleIdentity", "Integer32", "enterprises", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histGroupIndex=histGroupIndex, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrTotalSkips=histMetrTotalSkips, curMetrStreamType=curMetrStreamType, histMetrTotalPackets=histMetrTotalPackets, IctPortList=IctPortList, ictServices=ictServices, ictCfgUpdate=ictCfgUpdate, cfgExecute=cfgExecute, ictReboot=ictReboot, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRstMib=ictFacRstMib, cfgStatus=cfgStatus, IctJitter=IctJitter, ictTransceiver=ictTransceiver, performCpeReboot=performCpeReboot, histMetrJitter=histMetrJitter, catvModuleAdminStatus=catvModuleAdminStatus, curGroupIndex=curGroupIndex, curMetrSrcPort=curMetrSrcPort, curMetrGroupAddr=curMetrGroupAddr, upgStatus=upgStatus, curMetrTotalLost=curMetrTotalLost, curMetrTotalReordered=curMetrTotalReordered, histMetrSrcPort=histMetrSrcPort, transceiverDiagCapable=transceiverDiagCapable, curMetrSourceAddr=curMetrSourceAddr, histMetrMaxDelta=histMetrMaxDelta, IctDelta=IctDelta, histMetrStartTimestamp=histMetrStartTimestamp, icotera=icotera, histMetrStreamType=histMetrStreamType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrKbps=curMetrKbps, ictIGW1k=ictIGW1k, curMetrLost=curMetrLost, transceiverDdmRxPower=transceiverDdmRxPower, currentListEntry=currentListEntry, histGroupAddr=histGroupAddr, historyMetricsEntry=historyMetricsEntry, ictServicesMibs=ictServicesMibs, curMetrSkips=curMetrSkips, histMetrAvgPps=histMetrAvgPps, ictFwUpg=ictFwUpg, histMetrGroupAddr=histMetrGroupAddr, curMetrJitter=curMetrJitter, histMetrStopTimestamp=histMetrStopTimestamp, histMetrSkips=histMetrSkips, transceiverLaserWavelength=transceiverLaserWavelength, curMetrDiscontinuities=curMetrDiscontinuities, upgUrl=upgUrl, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrAvgLostPps=curMetrAvgLostPps, histMetrKbps=histMetrKbps, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrAvgDelta=histMetrAvgDelta, histMetrTotalLost=histMetrTotalLost, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictCatv=ictCatv, transceiverDdmTxPower=transceiverDdmTxPower, histMetrAvgLostPps=histMetrAvgLostPps, transceiverLinkLength=transceiverLinkLength, curMetrDstPort=curMetrDstPort, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverTransceiverType=transceiverTransceiverType, curMetrMaxDelta=curMetrMaxDelta, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrMemberPorts=curMetrMemberPorts, transceiverConnectorType=transceiverConnectorType, curMetrTotalBytes=curMetrTotalBytes, curMetrAvgPps=curMetrAvgPps, ictFacRst=ictFacRst, catvModulePowerLevel=catvModulePowerLevel, catvModuleSignalDetected=catvModuleSignalDetected, catvModuleFilter=catvModuleFilter, curMetrPps=curMetrPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrDstPort=histMetrDstPort, histMetrReordered=histMetrReordered, curGroupAddr=curGroupAddr, curMetrTotalPackets=curMetrTotalPackets, currentMetricsEntry=currentMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, cfgTftpPath=cfgTftpPath, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, historyListEntry=historyListEntry, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictReset=ictReset, ictMgmt=ictMgmt, histMetrTotalReordered=histMetrTotalReordered, histMetrLost=histMetrLost, histMetrSourceAddr=histMetrSourceAddr, ictMcastAnalyzer=ictMcastAnalyzer, PYSNMP_MODULE_ID=icotera, histMetrMemberPorts=histMetrMemberPorts, ictMgmtMib=ictMgmtMib, histMetrDiscontinuities=histMetrDiscontinuities, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalSkips=curMetrTotalSkips, catvModuleRflevel=catvModuleRflevel, IctTimeStamp=IctTimeStamp, catvModuleLowSignal=catvModuleLowSignal, curMetrReordered=curMetrReordered, transceiverDdmTemperature=transceiverDdmTemperature, histMetrPps=histMetrPps, performFactoryReset=performFactoryReset, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgDelta=curMetrAvgDelta, upgExecute=upgExecute, transceiverEthernetCompliance=transceiverEthernetCompliance)
