...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrAvgPps=curMetrAvgPps, histMetrJitter=histMetrJitter, transceiverDdmVoltage=transceiverDdmVoltage, curMetrAvgLostPps=curMetrAvgLostPps, histMetrStreamType=histMetrStreamType, ictFacRst=ictFacRst, IctDelta=IctDelta, transceiverLaserWavelength=transceiverLaserWavelength, upgUrl=upgUrl, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrSourceAddr=curMetrSourceAddr, histMetrLost=histMetrLost, curGroupIndex=curGroupIndex, ictMgmt=ictMgmt, curMetrTotalBytes=curMetrTotalBytes, catvModuleLowSignal=catvModuleLowSignal, catvModuleRflevel=catvModuleRflevel, ictIGW1k=ictIGW1k, transceiverTransceiverType=transceiverTransceiverType, histMetrSrcPort=histMetrSrcPort, historyMetricsEntry=historyMetricsEntry, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, cfgExecute=cfgExecute, histMetrAvgPps=histMetrAvgPps, historyListEntry=historyListEntry, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictCfgUpdate=ictCfgUpdate, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictServicesMibs=ictServicesMibs, curMetrStopTimestamp=curMetrStopTimestamp, catvModuleSignalDetected=catvModuleSignalDetected, histMetrAvgLostPps=histMetrAvgLostPps, ictMgmtMib=ictMgmtMib, currentListEntry=currentListEntry, histMetrSourceAddr=histMetrSourceAddr, transceiverConnectorType=transceiverConnectorType, IctPortList=IctPortList, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histGroupAddr=histGroupAddr, performFactoryReset=performFactoryReset, transceiverDdmRxPower=transceiverDdmRxPower, histMetrReordered=histMetrReordered, histMetrTotalLost=histMetrTotalLost, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, IctTimeStamp=IctTimeStamp, ictCatv=ictCatv, curMetrDiscontinuities=curMetrDiscontinuities, catvModuleFilter=catvModuleFilter, curMetrTotalLost=curMetrTotalLost, PYSNMP_MODULE_ID=icotera, curMetrAvgKbps=curMetrAvgKbps, catvModuleAdminStatus=catvModuleAdminStatus, currentMetricsEntry=currentMetricsEntry, cfgTftpPath=cfgTftpPath, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalSkips=histMetrTotalSkips, curMetrTotalPackets=curMetrTotalPackets, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrSrcPort=curMetrSrcPort, icotera=icotera, histMetrKbps=histMetrKbps, ictServices=ictServices, histMetrPps=histMetrPps, curMetrLost=curMetrLost, catvModulePowerLevel=catvModulePowerLevel, histMetrDstPort=histMetrDstPort, histGroupIndex=histGroupIndex, IctJitter=IctJitter, curMetrMaxDelta=curMetrMaxDelta, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalReordered=histMetrTotalReordered, upgStatus=upgStatus, curMetrTotalSkips=curMetrTotalSkips, curMetrMemberPorts=curMetrMemberPorts, performCpeReboot=performCpeReboot, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrSkips=curMetrSkips, histMetrTotalBytes=histMetrTotalBytes, curMetrTotalReordered=curMetrTotalReordered, transceiverDdmTxPower=transceiverDdmTxPower, curMetrReordered=curMetrReordered, curMetrPps=curMetrPps, histMetrDiscontinuities=histMetrDiscontinuities, curMetrJitter=curMetrJitter, curGroupAddr=curGroupAddr, histMetrAvgDelta=histMetrAvgDelta, ictFwUpg=ictFwUpg, curMetrKbps=curMetrKbps, histMetrStopTimestamp=histMetrStopTimestamp, histMetrSkips=histMetrSkips, ictFacRstMib=ictFacRstMib, curMetrStartTimestamp=curMetrStartTimestamp, transceiverDiagCapable=transceiverDiagCapable, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, cfgStatus=cfgStatus, transceiverDdmTemperature=transceiverDdmTemperature, transceiverEthernetCompliance=transceiverEthernetCompliance, ictReboot=ictReboot, curMetrDstPort=curMetrDstPort, transceiverLinkLength=transceiverLinkLength, ictReset=ictReset, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrTotalPackets=histMetrTotalPackets, ictMcastAnalyzer=ictMcastAnalyzer, curMetrAvgDelta=curMetrAvgDelta, histMetrStartTimestamp=histMetrStartTimestamp, curMetrGroupAddr=curMetrGroupAddr, ictTransceiver=ictTransceiver, upgExecute=upgExecute, curMetrStreamType=curMetrStreamType, histMetrMaxDelta=histMetrMaxDelta, histMetrGroupAddr=histMetrGroupAddr)
