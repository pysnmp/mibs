...
iso, enterprises, IpAddress, ModuleIdentity, TimeTicks, NotificationType, Counter64, Integer32, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "IpAddress", "ModuleIdentity", "TimeTicks", "NotificationType", "Counter64", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", transceiverDiagCapable=transceiverDiagCapable, histMetrAvgPps=histMetrAvgPps, histMetrPps=histMetrPps, curMetrJitter=curMetrJitter, histMetrKbps=histMetrKbps, curMetrDiscontinuities=curMetrDiscontinuities, icotera=icotera, histMetrStopTimestamp=histMetrStopTimestamp, upgStatus=upgStatus, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrSourceAddr=curMetrSourceAddr, histGroupIndex=histGroupIndex, curMetrReordered=curMetrReordered, catvModulePowerLevel=catvModulePowerLevel, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrKbps=curMetrKbps, transceiverConnectorType=transceiverConnectorType, curMetrStopTimestamp=curMetrStopTimestamp, curMetrAvgPps=curMetrAvgPps, catvModuleSignalDetected=catvModuleSignalDetected, histMetrTotalSkips=histMetrTotalSkips, transceiverLaserWavelength=transceiverLaserWavelength, histMetrAvgDelta=histMetrAvgDelta, curMetrTotalBytes=curMetrTotalBytes, histMetrMemberPorts=histMetrMemberPorts, curMetrTotalSkips=curMetrTotalSkips, ictReset=ictReset, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, ictReboot=ictReboot, histMetrStartTimestamp=histMetrStartTimestamp, curGroupIndex=curGroupIndex, curMetrPps=curMetrPps, curMetrLost=curMetrLost, histMetrGroupAddr=histMetrGroupAddr, histMetrSrcPort=histMetrSrcPort, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverDdmTemperature=transceiverDdmTemperature, PYSNMP_MODULE_ID=icotera, cfgTftpPath=cfgTftpPath, ictFacRst=ictFacRst, performFactoryReset=performFactoryReset, ictIGW1k=ictIGW1k, IctPortList=IctPortList, IctDelta=IctDelta, ictMgmt=ictMgmt, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalReordered=curMetrTotalReordered, histMetrLost=histMetrLost, catvModuleLowSignal=catvModuleLowSignal, histMetrAvgLostPps=histMetrAvgLostPps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictCatv=ictCatv, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrAvgLostPps=curMetrAvgLostPps, cfgStatus=cfgStatus, histMetrStreamType=histMetrStreamType, historyListEntry=historyListEntry, curMetrDstPort=curMetrDstPort, ictCfgUpdate=ictCfgUpdate, curMetrSrcPort=curMetrSrcPort, ictFwUpg=ictFwUpg, histMetrReordered=histMetrReordered, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrMaxDelta=histMetrMaxDelta, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTxPower=transceiverDdmTxPower, historyMetricsEntry=historyMetricsEntry, ictTransceiver=ictTransceiver, performCpeReboot=performCpeReboot, histMetrDiscontinuities=histMetrDiscontinuities, upgExecute=upgExecute, ictMcastAnalyzer=ictMcastAnalyzer, curGroupAddr=curGroupAddr, ictFacRstMib=ictFacRstMib, curMetrTotalPackets=curMetrTotalPackets, catvModuleRflevel=catvModuleRflevel, curMetrStreamType=curMetrStreamType, IctJitter=IctJitter, curMetrSkips=curMetrSkips, curMetrStartTimestamp=curMetrStartTimestamp, transceiverDdmRxPower=transceiverDdmRxPower, catvModuleAdminStatus=catvModuleAdminStatus, curMetrGroupAddr=curMetrGroupAddr, cfgExecute=cfgExecute, catvModuleFilter=catvModuleFilter, histMetrTotalBytes=histMetrTotalBytes, histGroupAddr=histGroupAddr, histMetrJitter=histMetrJitter, transceiverTransceiverType=transceiverTransceiverType, histMetrSourceAddr=histMetrSourceAddr, transceiverDdmVoltage=transceiverDdmVoltage, currentListEntry=currentListEntry, histMetrTotalLost=histMetrTotalLost, IctTimeStamp=IctTimeStamp, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrMaxDelta=curMetrMaxDelta, upgUrl=upgUrl, curMetrAvgKbps=curMetrAvgKbps, histMetrSkips=histMetrSkips, ictServicesMibs=ictServicesMibs, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrMemberPorts=curMetrMemberPorts, transceiverLinkLength=transceiverLinkLength, ictServices=ictServices, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrTotalPackets=histMetrTotalPackets, ictMgmtMib=ictMgmtMib, histMetrDstPort=histMetrDstPort, curMetrTotalLost=curMetrTotalLost, currentMetricsEntry=currentMetricsEntry)
