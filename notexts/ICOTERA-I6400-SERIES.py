...
NotificationType, Counter32, Gauge32, Integer32, Bits, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, iso, ModuleIdentity, Unsigned32, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "Integer32", "Bits", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", currentMetricsEntry=currentMetricsEntry, curMetrSrcPort=curMetrSrcPort, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, histMetrStopTimestamp=histMetrStopTimestamp, ictReset=ictReset, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, curMetrPps=curMetrPps, histMetrJitter=histMetrJitter, histMetrTotalLost=histMetrTotalLost, ictReboot=ictReboot, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictServices=ictServices, histMetrMaxDelta=histMetrMaxDelta, histMetrGroupAddr=histMetrGroupAddr, historyMetricsEntry=historyMetricsEntry, curMetrTotalReordered=curMetrTotalReordered, ictIGW1k=ictIGW1k, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrStreamType=curMetrStreamType, ictFacRst=ictFacRst, ictMgmtMib=ictMgmtMib, curMetrSkips=curMetrSkips, curMetrAvgDelta=curMetrAvgDelta, curMetrGroupAddr=curMetrGroupAddr, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalPackets=curMetrTotalPackets, transceiverLaserWavelength=transceiverLaserWavelength, transceiverDiagCapable=transceiverDiagCapable, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalLost=curMetrTotalLost, transceiverLinkLength=transceiverLinkLength, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrAvgKbps=curMetrAvgKbps, histMetrPps=histMetrPps, histMetrMemberPorts=histMetrMemberPorts, transceiverTransceiverType=transceiverTransceiverType, ictFacRstMib=ictFacRstMib, curGroupIndex=curGroupIndex, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrAvgPps=curMetrAvgPps, cfgTftpPath=cfgTftpPath, histMetrTotalPackets=histMetrTotalPackets, cfgStatus=cfgStatus, curMetrTotalMaxDelta=curMetrTotalMaxDelta, performCpeReboot=performCpeReboot, catvModuleRflevel=catvModuleRflevel, IctJitter=IctJitter, curMetrMemberPorts=curMetrMemberPorts, catvModuleSignalDetected=catvModuleSignalDetected, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictMgmt=ictMgmt, transceiverConnectorType=transceiverConnectorType, historyListEntry=historyListEntry, ictServicesMibs=ictServicesMibs, histMetrDiscontinuities=histMetrDiscontinuities, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleFilter=catvModuleFilter, histMetrStreamType=histMetrStreamType, histMetrTotalSkips=histMetrTotalSkips, curMetrJitter=curMetrJitter, histGroupAddr=histGroupAddr, histMetrDstPort=histMetrDstPort, upgUrl=upgUrl, catvModulePowerLevel=catvModulePowerLevel, histMetrKbps=histMetrKbps, PYSNMP_MODULE_ID=icotera, curMetrStopTimestamp=curMetrStopTimestamp, histMetrAvgLostPps=histMetrAvgLostPps, histMetrSrcPort=histMetrSrcPort, ictTransceiver=ictTransceiver, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrMaxDelta=curMetrMaxDelta, IctPortList=IctPortList, IctDelta=IctDelta, cfgExecute=cfgExecute, histGroupIndex=histGroupIndex, histMetrTotalBytes=histMetrTotalBytes, ictCatv=ictCatv, curMetrSourceAddr=curMetrSourceAddr, transceiverDdmRxPower=transceiverDdmRxPower, histMetrReordered=histMetrReordered, curMetrDiscontinuities=curMetrDiscontinuities, icotera=icotera, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrAvgDelta=histMetrAvgDelta, histMetrSkips=histMetrSkips, ictFwUpg=ictFwUpg, histMetrSourceAddr=histMetrSourceAddr, IctTimeStamp=IctTimeStamp, upgExecute=upgExecute, curMetrReordered=curMetrReordered, histMetrStartTimestamp=histMetrStartTimestamp, histMetrAvgPps=histMetrAvgPps, histMetrLost=histMetrLost, performFactoryReset=performFactoryReset, ictCfgUpdate=ictCfgUpdate, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curGroupAddr=curGroupAddr, transceiverDdmTxPower=transceiverDdmTxPower, curMetrKbps=curMetrKbps, curMetrTotalBytes=curMetrTotalBytes, catvModuleLowSignal=catvModuleLowSignal, upgStatus=upgStatus, curMetrTotalSkips=curMetrTotalSkips, curMetrAvgLostPps=curMetrAvgLostPps, histMetrAvgKbps=histMetrAvgKbps, currentListEntry=currentListEntry, curMetrLost=curMetrLost, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, transceiverDdmTemperature=transceiverDdmTemperature, curMetrDstPort=curMetrDstPort)
