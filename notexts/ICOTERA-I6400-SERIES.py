...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalPackets=histMetrTotalPackets, transceiverDdmRxPower=transceiverDdmRxPower, cfgStatus=cfgStatus, curMetrAvgLostPps=curMetrAvgLostPps, performCpeReboot=performCpeReboot, currentMetricsEntry=currentMetricsEntry, histGroupAddr=histGroupAddr, histMetrTotalReordered=histMetrTotalReordered, ictCatv=ictCatv, curMetrStartTimestamp=curMetrStartTimestamp, curMetrLost=curMetrLost, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalReordered=curMetrTotalReordered, curMetrTotalSkips=curMetrTotalSkips, ictReboot=ictReboot, IctJitter=IctJitter, IctPortList=IctPortList, curMetrDiscontinuities=curMetrDiscontinuities, curMetrSkips=curMetrSkips, curMetrStreamType=curMetrStreamType, curMetrReordered=curMetrReordered, upgExecute=upgExecute, ictFacRstMib=ictFacRstMib, curMetrTotalBytes=curMetrTotalBytes, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictIGW1k=ictIGW1k, histMetrDiscontinuities=histMetrDiscontinuities, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, catvModuleFilter=catvModuleFilter, histMetrSkips=histMetrSkips, curMetrMaxDelta=curMetrMaxDelta, histMetrStartTimestamp=histMetrStartTimestamp, IctDelta=IctDelta, histMetrMemberPorts=histMetrMemberPorts, curMetrSourceAddr=curMetrSourceAddr, histMetrAvgDelta=histMetrAvgDelta, histMetrStopTimestamp=histMetrStopTimestamp, histMetrPps=histMetrPps, transceiverDdmTxPower=transceiverDdmTxPower, transceiverConnectorType=transceiverConnectorType, ictServicesMibs=ictServicesMibs, curGroupAddr=curGroupAddr, historyListEntry=historyListEntry, histMetrAvgPps=histMetrAvgPps, catvModulePowerLevel=catvModulePowerLevel, transceiverDdmTemperature=transceiverDdmTemperature, ictServices=ictServices, histMetrDstPort=histMetrDstPort, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrTotalMaxDelta=histMetrTotalMaxDelta, transceiverDiagCapable=transceiverDiagCapable, historyMetricsEntry=historyMetricsEntry, transceiverLaserWavelength=transceiverLaserWavelength, histMetrTotalSkips=histMetrTotalSkips, curMetrDstPort=curMetrDstPort, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrTotalLost=curMetrTotalLost, histMetrSrcPort=histMetrSrcPort, curMetrAvgKbps=curMetrAvgKbps, catvModuleLowSignal=catvModuleLowSignal, curMetrSrcPort=curMetrSrcPort, catvModuleSignalDetected=catvModuleSignalDetected, histMetrJitter=histMetrJitter, ictReset=ictReset, catvModuleRflevel=catvModuleRflevel, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, transceiverLinkLength=transceiverLinkLength, ictMgmt=ictMgmt, catvModuleAdminStatus=catvModuleAdminStatus, histMetrAvgLostPps=histMetrAvgLostPps, currentListEntry=currentListEntry, curMetrStopTimestamp=curMetrStopTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, curMetrJitter=curMetrJitter, cfgTftpPath=cfgTftpPath, curMetrAvgDelta=curMetrAvgDelta, performFactoryReset=performFactoryReset, IctTimeStamp=IctTimeStamp, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictCfgUpdate=ictCfgUpdate, ictMcastAnalyzer=ictMcastAnalyzer, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histGroupIndex=histGroupIndex, histMetrReordered=histMetrReordered, histMetrTotalAvgDelta=histMetrTotalAvgDelta, upgStatus=upgStatus, cfgExecute=cfgExecute, histMetrKbps=histMetrKbps, PYSNMP_MODULE_ID=icotera, curMetrGroupAddr=curMetrGroupAddr, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrPps=curMetrPps, ictFacRst=ictFacRst, ictMgmtMib=ictMgmtMib, upgUrl=upgUrl, ictTransceiver=ictTransceiver, curMetrAvgPps=curMetrAvgPps, histMetrMaxDelta=histMetrMaxDelta, icotera=icotera, histMetrStreamType=histMetrStreamType, transceiverDdmVoltage=transceiverDdmVoltage, curMetrTotalPackets=curMetrTotalPackets, histMetrLost=histMetrLost, histMetrTotalBytes=histMetrTotalBytes, histMetrGroupAddr=histMetrGroupAddr, ictFwUpg=ictFwUpg, histMetrSourceAddr=histMetrSourceAddr, curMetrMemberPorts=curMetrMemberPorts, histMetrTotalLost=histMetrTotalLost, curGroupIndex=curGroupIndex, curMetrKbps=curMetrKbps, transceiverTransceiverType=transceiverTransceiverType, histMetrAvgKbps=histMetrAvgKbps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics)
