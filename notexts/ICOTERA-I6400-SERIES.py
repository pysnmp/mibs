...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:51:49 2024
...
ModuleIdentity, Bits, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ObjectIdentity, Counter64, iso, IpAddress, NotificationType, Counter32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ObjectIdentity", "Counter64", "iso", "IpAddress", "NotificationType", "Counter32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrStartTimestamp=histMetrStartTimestamp, histMetrTotalReordered=histMetrTotalReordered, ictReset=ictReset, curMetrStopTimestamp=curMetrStopTimestamp, histMetrReordered=histMetrReordered, historyMetricsEntry=historyMetricsEntry, curMetrAvgPps=curMetrAvgPps, transceiverEthernetCompliance=transceiverEthernetCompliance, performCpeReboot=performCpeReboot, IctPortList=IctPortList, ictReboot=ictReboot, upgStatus=upgStatus, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, cfgExecute=cfgExecute, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, transceiverDdmTxPower=transceiverDdmTxPower, transceiverDdmVoltage=transceiverDdmVoltage, histMetrTotalAvgDelta=histMetrTotalAvgDelta, catvModuleSignalDetected=catvModuleSignalDetected, histMetrStreamType=histMetrStreamType, histMetrTotalSkips=histMetrTotalSkips, ictTransceiver=ictTransceiver, catvModuleAdminStatus=catvModuleAdminStatus, histMetrSourceAddr=histMetrSourceAddr, IctDelta=IctDelta, upgExecute=upgExecute, histMetrAvgPps=histMetrAvgPps, curMetrAvgDelta=curMetrAvgDelta, curMetrTotalPackets=curMetrTotalPackets, histMetrLost=histMetrLost, curGroupIndex=curGroupIndex, ictCfgUpdate=ictCfgUpdate, PYSNMP_MODULE_ID=icotera, curMetrMemberPorts=curMetrMemberPorts, curMetrAvgKbps=curMetrAvgKbps, curMetrDiscontinuities=curMetrDiscontinuities, curMetrReordered=curMetrReordered, ictMgmt=ictMgmt, curMetrPps=curMetrPps, ictFacRst=ictFacRst, IctJitter=IctJitter, ictServicesMibs=ictServicesMibs, ictFacRstMib=ictFacRstMib, currentListEntry=currentListEntry, transceiverConnectorType=transceiverConnectorType, histMetrTotalBytes=histMetrTotalBytes, histMetrTotalLost=histMetrTotalLost, transceiverDdmRxPower=transceiverDdmRxPower, histMetrKbps=histMetrKbps, catvModuleLowSignal=catvModuleLowSignal, ictMgmtMib=ictMgmtMib, catvModulePowerLevel=catvModulePowerLevel, transceiverTransceiverType=transceiverTransceiverType, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, IctTimeStamp=IctTimeStamp, ictFwUpg=ictFwUpg, histMetrMaxDelta=histMetrMaxDelta, histGroupAddr=histGroupAddr, curMetrDstPort=curMetrDstPort, cfgStatus=cfgStatus, curMetrSkips=curMetrSkips, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, currentMetricsEntry=currentMetricsEntry, histGroupIndex=histGroupIndex, cfgTftpPath=cfgTftpPath, curMetrSourceAddr=curMetrSourceAddr, transceiverDdmTemperature=transceiverDdmTemperature, curMetrTotalBytes=curMetrTotalBytes, catvModuleFilter=catvModuleFilter, histMetrDstPort=histMetrDstPort, ictServices=ictServices, histMetrStopTimestamp=histMetrStopTimestamp, curMetrTotalLost=curMetrTotalLost, curMetrGroupAddr=curMetrGroupAddr, histMetrAvgDelta=histMetrAvgDelta, histMetrSkips=histMetrSkips, histMetrAvgLostPps=histMetrAvgLostPps, ictIGW1k=ictIGW1k, histMetrPps=histMetrPps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalPackets=histMetrTotalPackets, curMetrTotalReordered=curMetrTotalReordered, catvModuleRflevel=catvModuleRflevel, histMetrAvgKbps=histMetrAvgKbps, upgUrl=upgUrl, ictCatv=ictCatv, histMetrJitter=histMetrJitter, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrLost=curMetrLost, curGroupAddr=curGroupAddr, curMetrAvgLostPps=curMetrAvgLostPps, transceiverLaserWavelength=transceiverLaserWavelength, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrDiscontinuities=histMetrDiscontinuities, histMetrMemberPorts=histMetrMemberPorts, curMetrKbps=curMetrKbps, curMetrSrcPort=curMetrSrcPort, transceiverDiagCapable=transceiverDiagCapable, curMetrJitter=curMetrJitter, histMetrSrcPort=histMetrSrcPort, historyListEntry=historyListEntry, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, performFactoryReset=performFactoryReset, histMetrGroupAddr=histMetrGroupAddr, transceiverLinkLength=transceiverLinkLength, icotera=icotera, curMetrMaxDelta=curMetrMaxDelta, curMetrStreamType=curMetrStreamType)
