...
ModuleIdentity, Counter32, Bits, Gauge32, Counter64, MibIdentifier, enterprises, IpAddress, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "Counter64", "MibIdentifier", "enterprises", "IpAddress", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictTransceiver=ictTransceiver, transceiverLinkLength=transceiverLinkLength, transceiverDdmRxPower=transceiverDdmRxPower, curMetrTotalLost=curMetrTotalLost, upgStatus=upgStatus, cfgTftpPath=cfgTftpPath, ictFacRst=ictFacRst, historyMetricsEntry=historyMetricsEntry, icotera=icotera, curMetrTotalBytes=curMetrTotalBytes, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curGroupAddr=curGroupAddr, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrMaxDelta=histMetrMaxDelta, histMetrAvgPps=histMetrAvgPps, transceiverLaserWavelength=transceiverLaserWavelength, transceiverDiagCapable=transceiverDiagCapable, histMetrTotalReordered=histMetrTotalReordered, curMetrStartTimestamp=curMetrStartTimestamp, curMetrAvgKbps=curMetrAvgKbps, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrTotalBytes=histMetrTotalBytes, curMetrReordered=curMetrReordered, performCpeReboot=performCpeReboot, histMetrStartTimestamp=histMetrStartTimestamp, histGroupIndex=histGroupIndex, ictServices=ictServices, curMetrSrcPort=curMetrSrcPort, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histGroupAddr=histGroupAddr, histMetrSourceAddr=histMetrSourceAddr, curMetrSkips=curMetrSkips, ictCatv=ictCatv, histMetrLost=histMetrLost, transceiverDdmTemperature=transceiverDdmTemperature, IctDelta=IctDelta, IctTimeStamp=IctTimeStamp, catvModuleLowSignal=catvModuleLowSignal, currentListEntry=currentListEntry, curMetrPps=curMetrPps, histMetrTotalLost=histMetrTotalLost, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictCfgUpdate=ictCfgUpdate, histMetrJitter=histMetrJitter, catvModuleSignalDetected=catvModuleSignalDetected, PYSNMP_MODULE_ID=icotera, ictServicesMibs=ictServicesMibs, IctPortList=IctPortList, histMetrTotalSkips=histMetrTotalSkips, cfgExecute=cfgExecute, curMetrTotalMaxDelta=curMetrTotalMaxDelta, ictMgmtMib=ictMgmtMib, curMetrStreamType=curMetrStreamType, histMetrStreamType=histMetrStreamType, transceiverDdmVoltage=transceiverDdmVoltage, curGroupIndex=curGroupIndex, ictReset=ictReset, histMetrKbps=histMetrKbps, ictIGW1k=ictIGW1k, transceiverTransceiverType=transceiverTransceiverType, catvModuleRflevel=catvModuleRflevel, historyListEntry=historyListEntry, curMetrMemberPorts=curMetrMemberPorts, curMetrDiscontinuities=curMetrDiscontinuities, curMetrTotalPackets=curMetrTotalPackets, curMetrJitter=curMetrJitter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrAvgPps=curMetrAvgPps, ictMcastAnalyzer=ictMcastAnalyzer, catvModuleFilter=catvModuleFilter, curMetrAvgLostPps=curMetrAvgLostPps, histMetrMemberPorts=histMetrMemberPorts, histMetrDstPort=histMetrDstPort, histMetrPps=histMetrPps, histMetrAvgLostPps=histMetrAvgLostPps, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTxPower=transceiverDdmTxPower, curMetrSourceAddr=curMetrSourceAddr, ictReboot=ictReboot, histMetrSrcPort=histMetrSrcPort, IctJitter=IctJitter, curMetrTotalSkips=curMetrTotalSkips, curMetrMaxDelta=curMetrMaxDelta, performFactoryReset=performFactoryReset, ictMgmt=ictMgmt, upgExecute=upgExecute, histMetrGroupAddr=histMetrGroupAddr, curMetrKbps=curMetrKbps, catvModulePowerLevel=catvModulePowerLevel, histMetrSkips=histMetrSkips, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrTotalPackets=histMetrTotalPackets, histMetrStopTimestamp=histMetrStopTimestamp, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, upgUrl=upgUrl, histMetrReordered=histMetrReordered, curMetrAvgDelta=curMetrAvgDelta, cfgStatus=cfgStatus, curMetrDstPort=curMetrDstPort, ictFwUpg=ictFwUpg, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrDiscontinuities=histMetrDiscontinuities, curMetrLost=curMetrLost, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrAvgDelta=histMetrAvgDelta, curMetrStopTimestamp=curMetrStopTimestamp, catvModuleAdminStatus=catvModuleAdminStatus, ictFacRstMib=ictFacRstMib, currentMetricsEntry=currentMetricsEntry, transceiverConnectorType=transceiverConnectorType, curMetrGroupAddr=curMetrGroupAddr, curMetrTotalReordered=curMetrTotalReordered)
