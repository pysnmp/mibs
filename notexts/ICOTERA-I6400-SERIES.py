...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:40:48 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, IpAddress, Counter64, MibIdentifier, ObjectIdentity, Counter32, Gauge32, NotificationType, iso, enterprises, Bits, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "IpAddress", "Counter64", "MibIdentifier", "ObjectIdentity", "Counter32", "Gauge32", "NotificationType", "iso", "enterprises", "Bits", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSourceAddr=curMetrSourceAddr, transceiverDiagCapable=transceiverDiagCapable, currentListEntry=currentListEntry, curMetrTotalBytes=curMetrTotalBytes, histMetrReordered=histMetrReordered, curMetrAvgKbps=curMetrAvgKbps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrKbps=curMetrKbps, curMetrStopTimestamp=curMetrStopTimestamp, curMetrSrcPort=curMetrSrcPort, PYSNMP_MODULE_ID=icotera, curMetrReordered=curMetrReordered, curMetrSkips=curMetrSkips, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, catvModulePowerLevel=catvModulePowerLevel, histMetrGroupAddr=histMetrGroupAddr, transceiverLinkLength=transceiverLinkLength, catvModuleLowSignal=catvModuleLowSignal, transceiverDdmTxPower=transceiverDdmTxPower, ictCfgUpdate=ictCfgUpdate, histMetrSkips=histMetrSkips, historyListEntry=historyListEntry, histMetrMaxDelta=histMetrMaxDelta, histMetrTotalLost=histMetrTotalLost, curMetrTotalReordered=curMetrTotalReordered, upgUrl=upgUrl, histMetrSrcPort=histMetrSrcPort, transceiverTransceiverType=transceiverTransceiverType, ictServicesMibs=ictServicesMibs, transceiverLaserWavelength=transceiverLaserWavelength, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRst=ictFacRst, histGroupAddr=histGroupAddr, currentMetricsEntry=currentMetricsEntry, performFactoryReset=performFactoryReset, performCpeReboot=performCpeReboot, histMetrSourceAddr=histMetrSourceAddr, curMetrAvgPps=curMetrAvgPps, curMetrPps=curMetrPps, ictFacRstMib=ictFacRstMib, histMetrTotalAvgDelta=histMetrTotalAvgDelta, IctJitter=IctJitter, historyMetricsEntry=historyMetricsEntry, histMetrJitter=histMetrJitter, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, histMetrKbps=histMetrKbps, curMetrLost=curMetrLost, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictFwUpg=ictFwUpg, histMetrStopTimestamp=histMetrStopTimestamp, upgExecute=upgExecute, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDdmRxPower=transceiverDdmRxPower, histMetrTotalReordered=histMetrTotalReordered, transceiverDdmTemperature=transceiverDdmTemperature, histMetrAvgPps=histMetrAvgPps, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, cfgTftpPath=cfgTftpPath, histMetrTotalBytes=histMetrTotalBytes, ictMgmt=ictMgmt, cfgExecute=cfgExecute, curMetrDstPort=curMetrDstPort, histMetrTotalPackets=histMetrTotalPackets, ictMcastAnalyzer=ictMcastAnalyzer, curGroupAddr=curGroupAddr, catvModuleFilter=catvModuleFilter, catvModuleSignalDetected=catvModuleSignalDetected, curMetrMemberPorts=curMetrMemberPorts, ictIGW1k=ictIGW1k, histMetrDiscontinuities=histMetrDiscontinuities, ictServices=ictServices, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histGroupIndex=histGroupIndex, transceiverEthernetCompliance=transceiverEthernetCompliance, IctDelta=IctDelta, histMetrTotalSkips=histMetrTotalSkips, ictCatv=ictCatv, curMetrAvgDelta=curMetrAvgDelta, histMetrStartTimestamp=histMetrStartTimestamp, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrAvgLostPps=curMetrAvgLostPps, IctPortList=IctPortList, upgStatus=upgStatus, curGroupIndex=curGroupIndex, ictTransceiver=ictTransceiver, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, transceiverDdmVoltage=transceiverDdmVoltage, cfgStatus=cfgStatus, curMetrTotalSkips=curMetrTotalSkips, histMetrAvgKbps=histMetrAvgKbps, catvModuleAdminStatus=catvModuleAdminStatus, catvModuleRflevel=catvModuleRflevel, histMetrAvgLostPps=histMetrAvgLostPps, histMetrDstPort=histMetrDstPort, curMetrStreamType=curMetrStreamType, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrGroupAddr=curMetrGroupAddr, curMetrTotalPackets=curMetrTotalPackets, histMetrMemberPorts=histMetrMemberPorts, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, icotera=icotera, histMetrPps=histMetrPps, histMetrAvgDelta=histMetrAvgDelta, curMetrTotalLost=curMetrTotalLost, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, IctTimeStamp=IctTimeStamp, ictReboot=ictReboot, histMetrLost=histMetrLost, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrJitter=curMetrJitter, histMetrStreamType=histMetrStreamType, ictReset=ictReset, curMetrMaxDelta=curMetrMaxDelta, ictMgmtMib=ictMgmtMib, transceiverConnectorType=transceiverConnectorType)
