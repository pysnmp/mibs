...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", ictMgmt=ictMgmt, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictReboot=ictReboot, ictMcastAnalyzer=ictMcastAnalyzer, curMetrTotalReordered=curMetrTotalReordered, histMetrTotalBytes=histMetrTotalBytes, curMetrAvgLostPps=curMetrAvgLostPps, histMetrReordered=histMetrReordered, curMetrMaxDelta=curMetrMaxDelta, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrTotalSkips=histMetrTotalSkips, ictTransceiver=ictTransceiver, histMetrMemberPorts=histMetrMemberPorts, histMetrPps=histMetrPps, curMetrPps=curMetrPps, histMetrStreamType=histMetrStreamType, curMetrSkips=curMetrSkips, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, transceiverTransceiverType=transceiverTransceiverType, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrStreamType=curMetrStreamType, IctJitter=IctJitter, curMetrSrcPort=curMetrSrcPort, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictCfgUpdate=ictCfgUpdate, curMetrDiscontinuities=curMetrDiscontinuities, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, transceiverDdmTxPower=transceiverDdmTxPower, upgUrl=upgUrl, ictReset=ictReset, ictMgmtMib=ictMgmtMib, histMetrMaxDelta=histMetrMaxDelta, IctTimeStamp=IctTimeStamp, catvModuleLowSignal=catvModuleLowSignal, curGroupAddr=curGroupAddr, curMetrAvgKbps=curMetrAvgKbps, curMetrAvgPps=curMetrAvgPps, curMetrAvgDelta=curMetrAvgDelta, histMetrSrcPort=histMetrSrcPort, curMetrGroupAddr=curMetrGroupAddr, transceiverDdmTemperature=transceiverDdmTemperature, curMetrDstPort=curMetrDstPort, ictCatv=ictCatv, histMetrAvgLostPps=histMetrAvgLostPps, cfgExecute=cfgExecute, IctPortList=IctPortList, ictFwUpg=ictFwUpg, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, transceiverDiagCapable=transceiverDiagCapable, histMetrDiscontinuities=histMetrDiscontinuities, upgExecute=upgExecute, PYSNMP_MODULE_ID=icotera, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrKbps=curMetrKbps, curMetrStartTimestamp=curMetrStartTimestamp, curMetrMemberPorts=curMetrMemberPorts, transceiverLaserWavelength=transceiverLaserWavelength, histMetrSkips=histMetrSkips, ictServices=ictServices, histMetrStopTimestamp=histMetrStopTimestamp, histMetrKbps=histMetrKbps, historyMetricsEntry=historyMetricsEntry, curMetrTotalBytes=curMetrTotalBytes, cfgStatus=cfgStatus, currentMetricsEntry=currentMetricsEntry, curMetrReordered=curMetrReordered, catvModuleSignalDetected=catvModuleSignalDetected, historyListEntry=historyListEntry, histMetrStartTimestamp=histMetrStartTimestamp, currentListEntry=currentListEntry, catvModulePowerLevel=catvModulePowerLevel, upgStatus=upgStatus, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrSourceAddr=curMetrSourceAddr, histMetrTotalReordered=histMetrTotalReordered, histGroupAddr=histGroupAddr, curMetrTotalSkips=curMetrTotalSkips, curMetrTotalLost=curMetrTotalLost, transceiverDdmRxPower=transceiverDdmRxPower, histMetrJitter=histMetrJitter, catvModuleAdminStatus=catvModuleAdminStatus, cfgTftpPath=cfgTftpPath, ictFacRstMib=ictFacRstMib, curMetrLost=curMetrLost, histMetrLost=histMetrLost, curMetrStopTimestamp=curMetrStopTimestamp, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictIGW1k=ictIGW1k, histMetrGroupAddr=histMetrGroupAddr, performCpeReboot=performCpeReboot, catvModuleFilter=catvModuleFilter, performFactoryReset=performFactoryReset, transceiverEthernetCompliance=transceiverEthernetCompliance, transceiverConnectorType=transceiverConnectorType, histMetrAvgDelta=histMetrAvgDelta, histMetrSourceAddr=histMetrSourceAddr, histMetrDstPort=histMetrDstPort, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictFacRst=ictFacRst, curMetrTotalPackets=curMetrTotalPackets, histMetrTotalLost=histMetrTotalLost, transceiverDdmVoltage=transceiverDdmVoltage, histMetrTotalPackets=histMetrTotalPackets, catvModuleRflevel=catvModuleRflevel, transceiverLinkLength=transceiverLinkLength, IctDelta=IctDelta, histMetrAvgPps=histMetrAvgPps, icotera=icotera, histGroupIndex=histGroupIndex, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrJitter=curMetrJitter, ictServicesMibs=ictServicesMibs, curGroupIndex=curGroupIndex, curMetrTotalMaxDelta=curMetrTotalMaxDelta)
