...
Gauge32, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Counter64, Bits, NotificationType, ObjectIdentity, iso, enterprises, Unsigned32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Counter64", "Bits", "NotificationType", "ObjectIdentity", "iso", "enterprises", "Unsigned32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrLost=curMetrLost, curMetrDstPort=curMetrDstPort, curMetrSourceAddr=curMetrSourceAddr, curMetrTotalLost=curMetrTotalLost, PYSNMP_MODULE_ID=icotera, histMetrTotalMaxDelta=histMetrTotalMaxDelta, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrAvgDelta=histMetrAvgDelta, ictCatv=ictCatv, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, IctDelta=IctDelta, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, transceiverEthernetCompliance=transceiverEthernetCompliance, histMetrTotalSkips=histMetrTotalSkips, cfgStatus=cfgStatus, performFactoryReset=performFactoryReset, histMetrStreamType=histMetrStreamType, histMetrAvgLostPps=histMetrAvgLostPps, curMetrAvgPps=curMetrAvgPps, IctJitter=IctJitter, ictFacRstMib=ictFacRstMib, catvModuleRflevel=catvModuleRflevel, curMetrStreamType=curMetrStreamType, transceiverDdmRxPower=transceiverDdmRxPower, transceiverDiagCapable=transceiverDiagCapable, histMetrMaxDelta=histMetrMaxDelta, catvModuleFilter=catvModuleFilter, curMetrSkips=curMetrSkips, upgStatus=upgStatus, histMetrJitter=histMetrJitter, cfgExecute=cfgExecute, curMetrTotalBytes=curMetrTotalBytes, currentListEntry=currentListEntry, curMetrJitter=curMetrJitter, histMetrTotalReordered=histMetrTotalReordered, histMetrTotalLost=histMetrTotalLost, transceiverDdmVoltage=transceiverDdmVoltage, ictMgmtMib=ictMgmtMib, histMetrSkips=histMetrSkips, catvModuleAdminStatus=catvModuleAdminStatus, curMetrPps=curMetrPps, historyListEntry=historyListEntry, histGroupIndex=histGroupIndex, histMetrDiscontinuities=histMetrDiscontinuities, transceiverTransceiverType=transceiverTransceiverType, curMetrGroupAddr=curMetrGroupAddr, transceiverLinkLength=transceiverLinkLength, upgUrl=upgUrl, cfgTftpPath=cfgTftpPath, curMetrTotalPackets=curMetrTotalPackets, IctTimeStamp=IctTimeStamp, ictFacRst=ictFacRst, curMetrReordered=curMetrReordered, histGroupAddr=histGroupAddr, histMetrAvgPps=histMetrAvgPps, histMetrReordered=histMetrReordered, ictFwUpg=ictFwUpg, catvModuleSignalDetected=catvModuleSignalDetected, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, currentMetricsEntry=currentMetricsEntry, curMetrKbps=curMetrKbps, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, ictMcastAnalyzer=ictMcastAnalyzer, curMetrMemberPorts=curMetrMemberPorts, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, ictMgmt=ictMgmt, transceiverDdmTxPower=transceiverDdmTxPower, histMetrStopTimestamp=histMetrStopTimestamp, ictServices=ictServices, curMetrStartTimestamp=curMetrStartTimestamp, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrMemberPorts=histMetrMemberPorts, curGroupIndex=curGroupIndex, histMetrGroupAddr=histMetrGroupAddr, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrSrcPort=histMetrSrcPort, histMetrPps=histMetrPps, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, historyMetricsEntry=historyMetricsEntry, performCpeReboot=performCpeReboot, curMetrDiscontinuities=curMetrDiscontinuities, ictTransceiver=ictTransceiver, curGroupAddr=curGroupAddr, transceiverLaserWavelength=transceiverLaserWavelength, curMetrSrcPort=curMetrSrcPort, histMetrTotalBytes=histMetrTotalBytes, ictServicesMibs=ictServicesMibs, catvModulePowerLevel=catvModulePowerLevel, upgExecute=upgExecute, ictCfgUpdate=ictCfgUpdate, curMetrAvgKbps=curMetrAvgKbps, histMetrSourceAddr=histMetrSourceAddr, IctPortList=IctPortList, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictReset=ictReset, curMetrAvgLostPps=curMetrAvgLostPps, transceiverConnectorType=transceiverConnectorType, histMetrTotalAvgDelta=histMetrTotalAvgDelta, histMetrStartTimestamp=histMetrStartTimestamp, ictIGW1k=ictIGW1k, ictReboot=ictReboot, histMetrLost=histMetrLost, curMetrTotalSkips=curMetrTotalSkips, histMetrAvgKbps=histMetrAvgKbps, histMetrDstPort=histMetrDstPort, curMetrMaxDelta=curMetrMaxDelta, transceiverDdmTemperature=transceiverDdmTemperature, icotera=icotera, catvModuleLowSignal=catvModuleLowSignal, curMetrStopTimestamp=curMetrStopTimestamp, curMetrTotalReordered=curMetrTotalReordered, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrKbps=histMetrKbps, curMetrAvgDelta=curMetrAvgDelta, histMetrTotalPackets=histMetrTotalPackets)
