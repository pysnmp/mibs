...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:55:15 2021
...
ModuleIdentity, Gauge32, iso, Counter32, Bits, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, MibIdentifier, TimeTicks, IpAddress, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "iso", "Counter32", "Bits", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "MibIdentifier", "TimeTicks", "IpAddress", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, curMetrDiscontinuities=curMetrDiscontinuities, histGroupIndex=histGroupIndex, curMetrStartTimestamp=curMetrStartTimestamp, icotera=icotera, histMetrMaxDelta=histMetrMaxDelta, catvModulePowerLevel=catvModulePowerLevel, histMetrAvgLostPps=histMetrAvgLostPps, IctPortList=IctPortList, ictCfgUpdate=ictCfgUpdate, curMetrAvgDelta=curMetrAvgDelta, upgStatus=upgStatus, cfgExecute=cfgExecute, histMetrTotalMaxDelta=histMetrTotalMaxDelta, histMetrAvgDelta=histMetrAvgDelta, curMetrLost=curMetrLost, currentMetricsEntry=currentMetricsEntry, ictFacRst=ictFacRst, curMetrStopTimestamp=curMetrStopTimestamp, histMetrJitter=histMetrJitter, ictTransceiver=ictTransceiver, curMetrMaxDelta=curMetrMaxDelta, curMetrSourceAddr=curMetrSourceAddr, histMetrSkips=histMetrSkips, curMetrDstPort=curMetrDstPort, curMetrTotalPackets=curMetrTotalPackets, curMetrTotalLost=curMetrTotalLost, ictFacRstMib=ictFacRstMib, ictServices=ictServices, curMetrGroupAddr=curMetrGroupAddr, histMetrMemberPorts=histMetrMemberPorts, curMetrKbps=curMetrKbps, curMetrMemberPorts=curMetrMemberPorts, histMetrPps=histMetrPps, ictReboot=ictReboot, IctDelta=IctDelta, curMetrJitter=curMetrJitter, curMetrTotalAvgDelta=curMetrTotalAvgDelta, histMetrStreamType=histMetrStreamType, transceiverConnectorType=transceiverConnectorType, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrDstPort=histMetrDstPort, ictFwUpg=ictFwUpg, curMetrTotalBytes=curMetrTotalBytes, ictServicesMibs=ictServicesMibs, curGroupIndex=curGroupIndex, histMetrTotalPackets=histMetrTotalPackets, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrSkips=curMetrSkips, histMetrLost=histMetrLost, histGroupAddr=histGroupAddr, histMetrReordered=histMetrReordered, catvModuleFilter=catvModuleFilter, IctTimeStamp=IctTimeStamp, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, histMetrSrcPort=histMetrSrcPort, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzer=ictMcastAnalyzer, curMetrTotalSkips=curMetrTotalSkips, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, curMetrAvgKbps=curMetrAvgKbps, cfgStatus=cfgStatus, histMetrAvgKbps=histMetrAvgKbps, histMetrTotalBytes=histMetrTotalBytes, catvModuleLowSignal=catvModuleLowSignal, performCpeReboot=performCpeReboot, histMetrStopTimestamp=histMetrStopTimestamp, histMetrSourceAddr=histMetrSourceAddr, catvModuleRflevel=catvModuleRflevel, transceiverLinkLength=transceiverLinkLength, ictMgmtMib=ictMgmtMib, curMetrSrcPort=curMetrSrcPort, PYSNMP_MODULE_ID=icotera, histMetrGroupAddr=histMetrGroupAddr, ictIGW1k=ictIGW1k, upgExecute=upgExecute, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrStreamType=curMetrStreamType, historyListEntry=historyListEntry, histMetrAvgPps=histMetrAvgPps, transceiverDdmTxPower=transceiverDdmTxPower, transceiverDdmRxPower=transceiverDdmRxPower, cfgTftpPath=cfgTftpPath, histMetrTotalLost=histMetrTotalLost, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrReordered=curMetrReordered, histMetrStartTimestamp=histMetrStartTimestamp, upgUrl=upgUrl, ictMgmt=ictMgmt, curMetrAvgLostPps=curMetrAvgLostPps, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, histMetrKbps=histMetrKbps, curMetrTotalMaxDelta=curMetrTotalMaxDelta, performFactoryReset=performFactoryReset, catvModuleAdminStatus=catvModuleAdminStatus, ictReset=ictReset, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, currentListEntry=currentListEntry, IctJitter=IctJitter, transceiverDiagCapable=transceiverDiagCapable, catvModuleSignalDetected=catvModuleSignalDetected, curMetrPps=curMetrPps, transceiverTransceiverType=transceiverTransceiverType, transceiverLaserWavelength=transceiverLaserWavelength, transceiverDdmTemperature=transceiverDdmTemperature, histMetrTotalReordered=histMetrTotalReordered, curMetrTotalReordered=curMetrTotalReordered, historyMetricsEntry=historyMetricsEntry, ictCatv=ictCatv, transceiverDdmVoltage=transceiverDdmVoltage, curGroupAddr=curGroupAddr, curMetrAvgPps=curMetrAvgPps, histMetrTotalSkips=histMetrTotalSkips)
