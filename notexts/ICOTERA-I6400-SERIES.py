...
Integer32, Unsigned32, Gauge32, MibIdentifier, iso, Counter32, NotificationType, Counter64, Bits, enterprises, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Gauge32", "MibIdentifier", "iso", "Counter32", "NotificationType", "Counter64", "Bits", "enterprises", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrMaxDelta=curMetrMaxDelta, histMetrTotalMaxDelta=histMetrTotalMaxDelta, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, histMetrPps=histMetrPps, ictFacRstMib=ictFacRstMib, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictReset=ictReset, curMetrTotalPackets=curMetrTotalPackets, histMetrAvgKbps=histMetrAvgKbps, curMetrLost=curMetrLost, icotera=icotera, histMetrLost=histMetrLost, histMetrKbps=histMetrKbps, histMetrStopTimestamp=histMetrStopTimestamp, histGroupIndex=histGroupIndex, histMetrDstPort=histMetrDstPort, transceiverConnectorType=transceiverConnectorType, histMetrSrcPort=histMetrSrcPort, histGroupAddr=histGroupAddr, histMetrGroupAddr=histMetrGroupAddr, histMetrAvgDelta=histMetrAvgDelta, curMetrTotalMaxDelta=curMetrTotalMaxDelta, histMetrTotalAvgDelta=histMetrTotalAvgDelta, ictCatv=ictCatv, histMetrReordered=histMetrReordered, ictMcastAnalyzer=ictMcastAnalyzer, histMetrTotalPackets=histMetrTotalPackets, ictReboot=ictReboot, histMetrSourceAddr=histMetrSourceAddr, IctJitter=IctJitter, transceiverDdmTemperature=transceiverDdmTemperature, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, ictMgmt=ictMgmt, performFactoryReset=performFactoryReset, transceiverLinkLength=transceiverLinkLength, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, catvModuleFilter=catvModuleFilter, cfgStatus=cfgStatus, performCpeReboot=performCpeReboot, transceiverDdmRxPower=transceiverDdmRxPower, curMetrStartTimestamp=curMetrStartTimestamp, histMetrTotalSkips=histMetrTotalSkips, currentMetricsEntry=currentMetricsEntry, PYSNMP_MODULE_ID=icotera, histMetrAvgLostPps=histMetrAvgLostPps, curGroupAddr=curGroupAddr, curMetrSourceAddr=curMetrSourceAddr, IctTimeStamp=IctTimeStamp, histMetrAvgPps=histMetrAvgPps, curMetrDstPort=curMetrDstPort, ictFacRst=ictFacRst, transceiverLaserWavelength=transceiverLaserWavelength, historyMetricsEntry=historyMetricsEntry, catvModuleLowSignal=catvModuleLowSignal, transceiverDdmVoltage=transceiverDdmVoltage, transceiverDiagCapable=transceiverDiagCapable, ictFwUpg=ictFwUpg, curMetrSkips=curMetrSkips, curMetrTotalAvgDelta=curMetrTotalAvgDelta, ictServicesMibs=ictServicesMibs, curMetrAvgDelta=curMetrAvgDelta, histMetrDiscontinuities=histMetrDiscontinuities, upgStatus=upgStatus, curGroupIndex=curGroupIndex, histMetrStreamType=histMetrStreamType, curMetrStreamType=curMetrStreamType, histMetrMaxDelta=histMetrMaxDelta, curMetrAvgLostPps=curMetrAvgLostPps, curMetrMemberPorts=curMetrMemberPorts, histMetrTotalBytes=histMetrTotalBytes, curMetrTotalLost=curMetrTotalLost, historyListEntry=historyListEntry, IctDelta=IctDelta, histMetrSkips=histMetrSkips, curMetrTotalBytes=curMetrTotalBytes, histMetrMemberPorts=histMetrMemberPorts, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, curMetrPps=curMetrPps, IctPortList=IctPortList, transceiverEthernetCompliance=transceiverEthernetCompliance, curMetrSrcPort=curMetrSrcPort, ictServices=ictServices, cfgTftpPath=cfgTftpPath, transceiverTransceiverType=transceiverTransceiverType, curMetrAvgKbps=curMetrAvgKbps, curMetrStopTimestamp=curMetrStopTimestamp, ictIGW1k=ictIGW1k, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, ictCfgUpdate=ictCfgUpdate, histMetrTotalLost=histMetrTotalLost, curMetrGroupAddr=curMetrGroupAddr, histMetrTotalReordered=histMetrTotalReordered, curMetrAvgPps=curMetrAvgPps, histMetrJitter=histMetrJitter, upgExecute=upgExecute, transceiverDdmTxPower=transceiverDdmTxPower, curMetrDiscontinuities=curMetrDiscontinuities, catvModuleSignalDetected=catvModuleSignalDetected, curMetrTotalSkips=curMetrTotalSkips, upgUrl=upgUrl, currentListEntry=currentListEntry, curMetrJitter=curMetrJitter, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrStartTimestamp=histMetrStartTimestamp, curMetrTotalReordered=curMetrTotalReordered, curMetrReordered=curMetrReordered, cfgExecute=cfgExecute, catvModuleAdminStatus=catvModuleAdminStatus, ictMgmtMib=ictMgmtMib, catvModulePowerLevel=catvModulePowerLevel, catvModuleRflevel=catvModuleRflevel, curMetrKbps=curMetrKbps, ictTransceiver=ictTransceiver)
