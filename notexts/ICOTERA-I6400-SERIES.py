...
mibBuilder.exportSymbols("ICOTERA-I6400-SERIES", curMetrSkips=curMetrSkips, catvModuleAdminStatus=catvModuleAdminStatus, ictServices=ictServices, curMetrMemberPorts=curMetrMemberPorts, histMetrTotalSkips=histMetrTotalSkips, curMetrTotalMaxDelta=curMetrTotalMaxDelta, curMetrAvgDelta=curMetrAvgDelta, curMetrAvgPps=curMetrAvgPps, curMetrReordered=curMetrReordered, performFactoryReset=performFactoryReset, transceiverTransceiverType=transceiverTransceiverType, histMetrJitter=histMetrJitter, histMetrSrcPort=histMetrSrcPort, cfgStatus=cfgStatus, histMetrSourceAddr=histMetrSourceAddr, catvModuleRflevel=catvModuleRflevel, curMetrPps=curMetrPps, curMetrTotalAvgDelta=curMetrTotalAvgDelta, curMetrDstPort=curMetrDstPort, transceiverLinkLength=transceiverLinkLength, histMetrTotalPackets=histMetrTotalPackets, upgUrl=upgUrl, IctJitter=IctJitter, curMetrSourceAddr=curMetrSourceAddr, ictMgmtMib=ictMgmtMib, historyListEntry=historyListEntry, histMetrStreamType=histMetrStreamType, histGroupIndex=histGroupIndex, catvModulePowerLevel=catvModulePowerLevel, curMetrStreamType=curMetrStreamType, histMetrAvgKbps=histMetrAvgKbps, transceiverDdmTemperature=transceiverDdmTemperature, curMetrSrcPort=curMetrSrcPort, ictMcastAnalyzerCurrentMetrics=ictMcastAnalyzerCurrentMetrics, icotera=icotera, IctPortList=IctPortList, histMetrTotalBytes=histMetrTotalBytes, upgExecute=upgExecute, histMetrTotalDiscontinuities=histMetrTotalDiscontinuities, transceiverDdmTxPower=transceiverDdmTxPower, transceiverDdmTxBiasCurrent=transceiverDdmTxBiasCurrent, currentMetricsEntry=currentMetricsEntry, histMetrSkips=histMetrSkips, ictMcastAnalyzerHistoryList=ictMcastAnalyzerHistoryList, histMetrKbps=histMetrKbps, performCpeReboot=performCpeReboot, histMetrAvgDelta=histMetrAvgDelta, curMetrLost=curMetrLost, histMetrMemberPorts=histMetrMemberPorts, histMetrTotalReordered=histMetrTotalReordered, curMetrStopTimestamp=curMetrStopTimestamp, histMetrPps=histMetrPps, histMetrTotalAvgDelta=histMetrTotalAvgDelta, curMetrTotalSkips=curMetrTotalSkips, histMetrTotalMaxDelta=histMetrTotalMaxDelta, catvModuleFilter=catvModuleFilter, ictFacRstMib=ictFacRstMib, histMetrAvgLostPps=histMetrAvgLostPps, catvModuleSignalDetected=catvModuleSignalDetected, curMetrMaxDelta=curMetrMaxDelta, histMetrAvgPps=histMetrAvgPps, curMetrDiscontinuities=curMetrDiscontinuities, transceiverDdmRxPower=transceiverDdmRxPower, ictTransceiver=ictTransceiver, histGroupAddr=histGroupAddr, ictReboot=ictReboot, currentListEntry=currentListEntry, IctTimeStamp=IctTimeStamp, curMetrKbps=curMetrKbps, historyMetricsEntry=historyMetricsEntry, histMetrStartTimestamp=histMetrStartTimestamp, curMetrGroupAddr=curMetrGroupAddr, transceiverEthernetCompliance=transceiverEthernetCompliance, ictIGW1k=ictIGW1k, curGroupIndex=curGroupIndex, curMetrAvgKbps=curMetrAvgKbps, IctDelta=IctDelta, cfgTftpPath=cfgTftpPath, ictServicesMibs=ictServicesMibs, ictCfgUpdate=ictCfgUpdate, transceiverConnectorType=transceiverConnectorType, upgStatus=upgStatus, cfgExecute=cfgExecute, ictFwUpg=ictFwUpg, curMetrTotalLost=curMetrTotalLost, histMetrStopTimestamp=histMetrStopTimestamp, histMetrMaxDelta=histMetrMaxDelta, histMetrDiscontinuities=histMetrDiscontinuities, ictMcastAnalyzer=ictMcastAnalyzer, histMetrGroupAddr=histMetrGroupAddr, transceiverLaserWavelength=transceiverLaserWavelength, curGroupAddr=curGroupAddr, ictMgmt=ictMgmt, PYSNMP_MODULE_ID=icotera, curMetrTotalReordered=curMetrTotalReordered, catvModuleLowSignal=catvModuleLowSignal, curMetrJitter=curMetrJitter, transceiverDdmVoltage=transceiverDdmVoltage, ictMcastAnalyzerCurrent=ictMcastAnalyzerCurrent, curMetrTotalBytes=curMetrTotalBytes, histMetrDstPort=histMetrDstPort, ictMcastAnalyzerHistory=ictMcastAnalyzerHistory, histMetrReordered=histMetrReordered, ictReset=ictReset, curMetrTotalDiscontinuities=curMetrTotalDiscontinuities, curMetrAvgLostPps=curMetrAvgLostPps, histMetrLost=histMetrLost, ictMcastAnalyzerCurrentList=ictMcastAnalyzerCurrentList, ictCatv=ictCatv, ictMcastAnalyzerHistoryMetrics=ictMcastAnalyzerHistoryMetrics, curMetrStartTimestamp=curMetrStartTimestamp, ictFacRst=ictFacRst, transceiverDiagCapable=transceiverDiagCapable, histMetrTotalLost=histMetrTotalLost, curMetrTotalPackets=curMetrTotalPackets)
