...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmGeneralGroup=jmGeneralGroup, jmGeneralEntry=jmGeneralEntry, JmJobServiceTypesTC=JmJobServiceTypesTC, jmMIBConformance=jmMIBConformance, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJobIDJobIndex=jmJobIDJobIndex, JmJobStateReasons4TC=JmJobStateReasons4TC, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmAttribute=jmAttribute, jmJobIDGroup=jmJobIDGroup, jmMIBGroups=jmMIBGroups, JmJobStateReasons1TC=JmJobStateReasons1TC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmJobIndex=jmJobIndex, JmJobStringTC=JmJobStringTC, JmMediumTypeTC=JmMediumTypeTC, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmGeneralJobSetName=jmGeneralJobSetName, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmJobIDEntry=jmJobIDEntry, jmJobStateReasons1=jmJobStateReasons1, jmGeneralJobPersistence=jmGeneralJobPersistence, jobmonMIBNotifications=jobmonMIBNotifications, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmGeneralTable=jmGeneralTable, jmJobIDJobSetIndex=jmJobIDJobSetIndex, JmBooleanTC=JmBooleanTC, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, JmAttributeTypeTC=JmAttributeTypeTC, jmJobEntry=jmJobEntry, jmAttributeInstanceIndex=jmAttributeInstanceIndex, JmFinishingTC=JmFinishingTC, JmJobStateTC=JmJobStateTC, jmJobID=jmJobID, jmAttributeValueAsInteger=jmAttributeValueAsInteger, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmJobTable=jmJobTable, JmUTF8StringTC=JmUTF8StringTC, jmAttributeTable=jmAttributeTable, jmJobImpressionsCompleted=jmJobImpressionsCompleted, PYSNMP_MODULE_ID=jobmonMIB, jmMIBCompliance=jmMIBCompliance, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, JmPrintQualityTC=JmPrintQualityTC, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmJobIDTable=jmJobIDTable, jobmonMIBObjects=jobmonMIBObjects, jmAttributeGroup=jmAttributeGroup, jmJobOwner=jmJobOwner, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jobmonMIB=jobmonMIB, JmPrinterResolutionTC=JmPrinterResolutionTC, JmTonerEconomyTC=JmTonerEconomyTC, JmJobCollationTypeTC=JmJobCollationTypeTC, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmGeneral=jmGeneral, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, JmTimeStampTC=JmTimeStampTC, jmAttributeTypeIndex=jmAttributeTypeIndex, jmJobSubmissionID=jmJobSubmissionID, jmJob=jmJob, JmJobStateReasons2TC=JmJobStateReasons2TC, jmAttributeEntry=jmAttributeEntry, jmJobState=jmJobState, jmJobGroup=jmJobGroup)
