...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmGeneralJobPersistence=jmGeneralJobPersistence, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, JmJobCollationTypeTC=JmJobCollationTypeTC, JmJobStateReasons4TC=JmJobStateReasons4TC, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmJobIDGroup=jmJobIDGroup, jmJobGroup=jmJobGroup, jobmonMIBObjects=jobmonMIBObjects, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmGeneralTable=jmGeneralTable, JmAttributeTypeTC=JmAttributeTypeTC, jmMIBConformance=jmMIBConformance, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmAttributeEntry=jmAttributeEntry, JmTonerEconomyTC=JmTonerEconomyTC, JmJobStateTC=JmJobStateTC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmJobIDTable=jmJobIDTable, jmJobIDJobIndex=jmJobIDJobIndex, jmGeneral=jmGeneral, JmBooleanTC=JmBooleanTC, jmAttributeGroup=jmAttributeGroup, jmJobIDEntry=jmJobIDEntry, jmGeneralJobSetName=jmGeneralJobSetName, jmJobID=jmJobID, JmJobStateReasons2TC=JmJobStateReasons2TC, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, JmTimeStampTC=JmTimeStampTC, jobmonMIB=jobmonMIB, jobmonMIBNotifications=jobmonMIBNotifications, jmJob=jmJob, jmJobOwner=jmJobOwner, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmAttributeTable=jmAttributeTable, jmGeneralGroup=jmGeneralGroup, jmMIBCompliance=jmMIBCompliance, JmPrintQualityTC=JmPrintQualityTC, jmJobImpressionsCompleted=jmJobImpressionsCompleted, JmJobStateReasons3TC=JmJobStateReasons3TC, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmJobState=jmJobState, JmJobStringTC=JmJobStringTC, jmJobStateReasons1=jmJobStateReasons1, jmJobIndex=jmJobIndex, jmJobTable=jmJobTable, PYSNMP_MODULE_ID=jobmonMIB, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, JmMediumTypeTC=JmMediumTypeTC, jmJobSubmissionID=jmJobSubmissionID, JmUTF8StringTC=JmUTF8StringTC, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, JmJobStateReasons1TC=JmJobStateReasons1TC, jmJobEntry=jmJobEntry, jmAttribute=jmAttribute, JmPrinterResolutionTC=JmPrinterResolutionTC, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmAttributeTypeIndex=jmAttributeTypeIndex, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmAttributeInstanceIndex=jmAttributeInstanceIndex, JmFinishingTC=JmFinishingTC, jmMIBGroups=jmMIBGroups, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jmGeneralEntry=jmGeneralEntry, JmJobServiceTypesTC=JmJobServiceTypesTC)
