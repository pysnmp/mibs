...
mibBuilder.exportSymbols("Job-Monitoring-MIB", JmMediumTypeTC=JmMediumTypeTC, jmJobStateReasons1=jmJobStateReasons1, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jmAttributeValueAsOctets=jmAttributeValueAsOctets, JmJobStateReasons1TC=JmJobStateReasons1TC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, JmTonerEconomyTC=JmTonerEconomyTC, jmMIBGroups=jmMIBGroups, jmGeneralGroup=jmGeneralGroup, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, JmBooleanTC=JmBooleanTC, jobmonMIBObjects=jobmonMIBObjects, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, JmPrintQualityTC=JmPrintQualityTC, jmJobIDEntry=jmJobIDEntry, jmAttributeTable=jmAttributeTable, jmAttributeEntry=jmAttributeEntry, jmMIBCompliance=jmMIBCompliance, JmJobStringTC=JmJobStringTC, JmUTF8StringTC=JmUTF8StringTC, JmFinishingTC=JmFinishingTC, jmJobIDGroup=jmJobIDGroup, JmJobStateReasons4TC=JmJobStateReasons4TC, jmJobImpressionsCompleted=jmJobImpressionsCompleted, JmTimeStampTC=JmTimeStampTC, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJobIDJobIndex=jmJobIDJobIndex, jmAttribute=jmAttribute, jmGeneralEntry=jmGeneralEntry, JmJobStateReasons2TC=JmJobStateReasons2TC, jmJobIDTable=jmJobIDTable, JmJobCollationTypeTC=JmJobCollationTypeTC, jmGeneralJobPersistence=jmGeneralJobPersistence, JmPrinterResolutionTC=JmPrinterResolutionTC, JmJobServiceTypesTC=JmJobServiceTypesTC, jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobState=jmJobState, jmJobSubmissionID=jmJobSubmissionID, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmJobTable=jmJobTable, jmGeneralTable=jmGeneralTable, jmAttributeTypeIndex=jmAttributeTypeIndex, jmGeneralJobSetName=jmGeneralJobSetName, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmJobEntry=jmJobEntry, jmMIBConformance=jmMIBConformance, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmJobIndex=jmJobIndex, jmGeneral=jmGeneral, jobmonMIBNotifications=jobmonMIBNotifications, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmAttributeInstanceIndex=jmAttributeInstanceIndex, jmJob=jmJob, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmAttributeGroup=jmAttributeGroup, jobmonMIB=jobmonMIB, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmJobID=jmJobID, jmGeneralJobSetIndex=jmGeneralJobSetIndex, JmJobStateTC=JmJobStateTC, jmJobOwner=jmJobOwner, jmJobGroup=jmJobGroup, JmAttributeTypeTC=JmAttributeTypeTC, PYSNMP_MODULE_ID=jobmonMIB)
