...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmMIBGroups=jmMIBGroups, jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmJobServiceTypesTC=JmJobServiceTypesTC, jmAttributeGroup=jmAttributeGroup, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, JmMediumTypeTC=JmMediumTypeTC, JmUTF8StringTC=JmUTF8StringTC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmJobImpressionsCompleted=jmJobImpressionsCompleted, jmJobGroup=jmJobGroup, jobmonMIB=jobmonMIB, jobmonMIBObjects=jobmonMIBObjects, JmTonerEconomyTC=JmTonerEconomyTC, jmJobIDJobIndex=jmJobIDJobIndex, jobmonMIBNotifications=jobmonMIBNotifications, JmJobStringTC=JmJobStringTC, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmMIBConformance=jmMIBConformance, jmMIBCompliance=jmMIBCompliance, jmJobIndex=jmJobIndex, jmJobIDEntry=jmJobIDEntry, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmAttributeEntry=jmAttributeEntry, JmJobStateTC=JmJobStateTC, jmJobID=jmJobID, JmJobCollationTypeTC=JmJobCollationTypeTC, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, JmJobStateReasons2TC=JmJobStateReasons2TC, jmGeneralTable=jmGeneralTable, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmJobSubmissionID=jmJobSubmissionID, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmAttributeTable=jmAttributeTable, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jmGeneral=jmGeneral, JmFinishingTC=JmFinishingTC, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, jmJobIDTable=jmJobIDTable, JmJobStateReasons4TC=JmJobStateReasons4TC, JmPrintQualityTC=JmPrintQualityTC, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmJobEntry=jmJobEntry, jmGeneralJobSetName=jmGeneralJobSetName, JmBooleanTC=JmBooleanTC, jmAttribute=jmAttribute, jmJobTable=jmJobTable, jmGeneralJobPersistence=jmGeneralJobPersistence, jmGeneralGroup=jmGeneralGroup, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJob=jmJob, JmJobStateReasons1TC=JmJobStateReasons1TC, JmAttributeTypeTC=JmAttributeTypeTC, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmJobStateReasons1=jmJobStateReasons1, jmAttributeInstanceIndex=jmAttributeInstanceIndex, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobOwner=jmJobOwner, jmJobState=jmJobState, jmJobIDGroup=jmJobIDGroup, JmPrinterResolutionTC=JmPrinterResolutionTC, JmTimeStampTC=JmTimeStampTC, jmAttributeTypeIndex=jmAttributeTypeIndex, jmGeneralEntry=jmGeneralEntry, PYSNMP_MODULE_ID=jobmonMIB)
