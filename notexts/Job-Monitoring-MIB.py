...
mibBuilder.exportSymbols("Job-Monitoring-MIB", JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmAttributeTable=jmAttributeTable, jobmonMIB=jobmonMIB, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmMIBConformance=jmMIBConformance, jmGeneralGroup=jmGeneralGroup, jmJobIDJobIndex=jmJobIDJobIndex, jmGeneral=jmGeneral, JmJobStateReasons2TC=JmJobStateReasons2TC, jmJobIDGroup=jmJobIDGroup, jmJobSubmissionID=jmJobSubmissionID, JmMediumTypeTC=JmMediumTypeTC, JmJobStateReasons1TC=JmJobStateReasons1TC, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, JmTonerEconomyTC=JmTonerEconomyTC, jmJobID=jmJobID, jmGeneralEntry=jmGeneralEntry, jmJob=jmJob, jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJobIndex=jmJobIndex, jmGeneralJobSetIndex=jmGeneralJobSetIndex, JmFinishingTC=JmFinishingTC, JmJobStateReasons4TC=JmJobStateReasons4TC, jmAttributeInstanceIndex=jmAttributeInstanceIndex, jmGeneralAttributePersistence=jmGeneralAttributePersistence, PYSNMP_MODULE_ID=jobmonMIB, jmJobIDTable=jmJobIDTable, jmJobEntry=jmJobEntry, jmAttributeTypeIndex=jmAttributeTypeIndex, jmMIBGroups=jmMIBGroups, jmGeneralJobPersistence=jmGeneralJobPersistence, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmGeneralTable=jmGeneralTable, jmJobKOctetsProcessed=jmJobKOctetsProcessed, JmTimeStampTC=JmTimeStampTC, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmAttribute=jmAttribute, jmMIBCompliance=jmMIBCompliance, jmGeneralJobSetName=jmGeneralJobSetName, jmJobImpressionsCompleted=jmJobImpressionsCompleted, JmJobStringTC=JmJobStringTC, jmAttributeGroup=jmAttributeGroup, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmJobGroup=jmJobGroup, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, jmJobState=jmJobState, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, JmJobStateTC=JmJobStateTC, jobmonMIBObjects=jobmonMIBObjects, JmUTF8StringTC=JmUTF8StringTC, JmBooleanTC=JmBooleanTC, jmJobIDEntry=jmJobIDEntry, jmJobTable=jmJobTable, jmJobStateReasons1=jmJobStateReasons1, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jobmonMIBNotifications=jobmonMIBNotifications, JmPrintQualityTC=JmPrintQualityTC, jmJobOwner=jmJobOwner, JmJobServiceTypesTC=JmJobServiceTypesTC, jmAttributeEntry=jmAttributeEntry, JmAttributeTypeTC=JmAttributeTypeTC, JmJobCollationTypeTC=JmJobCollationTypeTC, JmPrinterResolutionTC=JmPrinterResolutionTC)
