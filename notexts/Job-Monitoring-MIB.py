...
mibBuilder.exportSymbols("Job-Monitoring-MIB", JmFinishingTC=JmFinishingTC, jmJobImpressionsCompleted=jmJobImpressionsCompleted, jmJobIDGroup=jmJobIDGroup, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, JmJobStateReasons4TC=JmJobStateReasons4TC, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmMIBConformance=jmMIBConformance, JmPrintQualityTC=JmPrintQualityTC, jmJobTable=jmJobTable, jmJob=jmJob, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jobmonMIB=jobmonMIB, jmAttribute=jmAttribute, JmPrinterResolutionTC=JmPrinterResolutionTC, JmBooleanTC=JmBooleanTC, jmGeneralTable=jmGeneralTable, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmJobIDTable=jmJobIDTable, jmJobID=jmJobID, jmJobIndex=jmJobIndex, jmAttributeEntry=jmAttributeEntry, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, JmJobStringTC=JmJobStringTC, jmGeneralJobSetName=jmGeneralJobSetName, JmJobCollationTypeTC=JmJobCollationTypeTC, jmMIBGroups=jmMIBGroups, jmJobSubmissionID=jmJobSubmissionID, JmJobStateReasons1TC=JmJobStateReasons1TC, jobmonMIBObjects=jobmonMIBObjects, JmTonerEconomyTC=JmTonerEconomyTC, jmJobOwner=jmJobOwner, jmGeneralJobPersistence=jmGeneralJobPersistence, jobmonMIBNotifications=jobmonMIBNotifications, JmMediumTypeTC=JmMediumTypeTC, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobIDEntry=jmJobIDEntry, JmAttributeTypeTC=JmAttributeTypeTC, jmJobState=jmJobState, jmAttributeValueAsInteger=jmAttributeValueAsInteger, jmAttributeGroup=jmAttributeGroup, jmMIBCompliance=jmMIBCompliance, jmJobStateReasons1=jmJobStateReasons1, jmAttributeInstanceIndex=jmAttributeInstanceIndex, jmJobGroup=jmJobGroup, JmUTF8StringTC=JmUTF8StringTC, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmGeneralGroup=jmGeneralGroup, JmJobStateReasons2TC=JmJobStateReasons2TC, JmJobServiceTypesTC=JmJobServiceTypesTC, jmGeneral=jmGeneral, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmJobKOctetsProcessed=jmJobKOctetsProcessed, JmJobStateReasons3TC=JmJobStateReasons3TC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmJobIDJobIndex=jmJobIDJobIndex, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmGeneralEntry=jmGeneralEntry, PYSNMP_MODULE_ID=jobmonMIB, jmJobEntry=jmJobEntry, jmAttributeTable=jmAttributeTable, JmTimeStampTC=JmTimeStampTC, jmAttributeTypeIndex=jmAttributeTypeIndex, jmJobIDJobSetIndex=jmJobIDJobSetIndex, JmJobStateTC=JmJobStateTC)
