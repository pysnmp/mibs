...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmAttributeTable=jmAttributeTable, jobmonMIBObjects=jobmonMIBObjects, jmJobID=jmJobID, jmGeneralJobSetName=jmGeneralJobSetName, JmJobCollationTypeTC=JmJobCollationTypeTC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmJob=jmJob, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jmAttributeEntry=jmAttributeEntry, JmFinishingTC=JmFinishingTC, jmAttributeInstanceIndex=jmAttributeInstanceIndex, JmJobStateTC=JmJobStateTC, jmJobOwner=jmJobOwner, jmAttributeValueAsOctets=jmAttributeValueAsOctets, JmJobServiceTypesTC=JmJobServiceTypesTC, jobmonMIBNotifications=jobmonMIBNotifications, jmGeneralGroup=jmGeneralGroup, jmJobIDJobIndex=jmJobIDJobIndex, JmJobStateReasons1TC=JmJobStateReasons1TC, jmJobTable=jmJobTable, jmJobStateReasons1=jmJobStateReasons1, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jobmonMIB=jobmonMIB, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, JmBooleanTC=JmBooleanTC, JmAttributeTypeTC=JmAttributeTypeTC, jmGeneralTable=jmGeneralTable, jmJobIDTable=jmJobIDTable, jmJobIndex=jmJobIndex, PYSNMP_MODULE_ID=jobmonMIB, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmMIBCompliance=jmMIBCompliance, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmJobEntry=jmJobEntry, jmAttributeTypeIndex=jmAttributeTypeIndex, jmJobIDGroup=jmJobIDGroup, JmJobStringTC=JmJobStringTC, jmJobState=jmJobState, JmPrintQualityTC=JmPrintQualityTC, JmUTF8StringTC=JmUTF8StringTC, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmGeneralJobPersistence=jmGeneralJobPersistence, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobIDEntry=jmJobIDEntry, JmJobStateReasons3TC=JmJobStateReasons3TC, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, JmPrinterResolutionTC=JmPrinterResolutionTC, jmJobImpressionsCompleted=jmJobImpressionsCompleted, jmGeneralEntry=jmGeneralEntry, JmTimeStampTC=JmTimeStampTC, JmTonerEconomyTC=JmTonerEconomyTC, JmJobStateReasons2TC=JmJobStateReasons2TC, JmJobStateReasons4TC=JmJobStateReasons4TC, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmJobSubmissionID=jmJobSubmissionID, jmAttribute=jmAttribute, jmGeneral=jmGeneral, jmMIBGroups=jmMIBGroups, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmAttributeGroup=jmAttributeGroup, jmMIBConformance=jmMIBConformance, jmJobGroup=jmJobGroup, jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmMediumTypeTC=JmMediumTypeTC)
