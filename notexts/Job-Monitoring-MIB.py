...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmJob=jmJob, PYSNMP_MODULE_ID=jobmonMIB, JmTimeStampTC=JmTimeStampTC, jmJobSubmissionID=jmJobSubmissionID, jmJobStateReasons1=jmJobStateReasons1, JmTonerEconomyTC=JmTonerEconomyTC, jobmonMIBObjects=jobmonMIBObjects, jobmonMIB=jobmonMIB, jmGeneralEntry=jmGeneralEntry, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, JmJobStateReasons4TC=JmJobStateReasons4TC, jmJobIDJobSetIndex=jmJobIDJobSetIndex, JmJobStateReasons3TC=JmJobStateReasons3TC, jmJobIDJobIndex=jmJobIDJobIndex, jmAttributeGroup=jmAttributeGroup, JmJobServiceTypesTC=JmJobServiceTypesTC, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmGeneralJobPersistence=jmGeneralJobPersistence, jobmonMIBNotifications=jobmonMIBNotifications, JmPrinterResolutionTC=JmPrinterResolutionTC, JmJobStateReasons1TC=JmJobStateReasons1TC, JmUTF8StringTC=JmUTF8StringTC, jmJobGroup=jmJobGroup, JmFinishingTC=JmFinishingTC, JmPrintQualityTC=JmPrintQualityTC, jmJobTable=jmJobTable, jmGeneralGroup=jmGeneralGroup, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, jmAttributeTypeIndex=jmAttributeTypeIndex, JmAttributeTypeTC=JmAttributeTypeTC, JmJobStringTC=JmJobStringTC, JmMediumTypeTC=JmMediumTypeTC, jmJobOwner=jmJobOwner, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, jmAttributeTable=jmAttributeTable, JmBooleanTC=JmBooleanTC, jmJobIDEntry=jmJobIDEntry, JmJobCollationTypeTC=JmJobCollationTypeTC, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmJobIndex=jmJobIndex, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmAttribute=jmAttribute, jmGeneral=jmGeneral, jmMIBCompliance=jmMIBCompliance, jmMIBConformance=jmMIBConformance, JmJobStateTC=JmJobStateTC, jmMIBGroups=jmMIBGroups, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmJobImpressionsCompleted=jmJobImpressionsCompleted, JmJobStateReasons2TC=JmJobStateReasons2TC, jmJobIDTable=jmJobIDTable, jmAttributeInstanceIndex=jmAttributeInstanceIndex, jmGeneralJobSetName=jmGeneralJobSetName, jmJobState=jmJobState, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, jmAttributeEntry=jmAttributeEntry, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmJobID=jmJobID, jmJobEntry=jmJobEntry, jmAttributeValueAsInteger=jmAttributeValueAsInteger, jmJobIDGroup=jmJobIDGroup, jmGeneralTable=jmGeneralTable)
