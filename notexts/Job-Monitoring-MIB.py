...
mibBuilder.exportSymbols("Job-Monitoring-MIB", jmAttributeValueAsInteger=jmAttributeValueAsInteger, JmJobStringTC=JmJobStringTC, JmFinishingTC=JmFinishingTC, JmAttributeTypeTC=JmAttributeTypeTC, JmJobServiceTypesTC=JmJobServiceTypesTC, JmJobStateReasons1TC=JmJobStateReasons1TC, jobmonMIBObjects=jobmonMIBObjects, jmGeneralJobPersistence=jmGeneralJobPersistence, jmGeneralJobSetName=jmGeneralJobSetName, jmJob=jmJob, JmJobSubmissionIDTypeTC=JmJobSubmissionIDTypeTC, jmGeneralNewestActiveJobIndex=jmGeneralNewestActiveJobIndex, jmJobTable=jmJobTable, jmJobKOctetsPerCopyRequested=jmJobKOctetsPerCopyRequested, jmAttributeGroup=jmAttributeGroup, jobmonMIBNotifications=jobmonMIBNotifications, jmGeneralEntry=jmGeneralEntry, PYSNMP_MODULE_ID=jobmonMIB, jmMIBConformance=jmMIBConformance, JmTonerEconomyTC=JmTonerEconomyTC, JmMediumTypeTC=JmMediumTypeTC, JmPrinterResolutionTC=JmPrinterResolutionTC, jmJobIDJobSetIndex=jmJobIDJobSetIndex, jmMIBCompliance=jmMIBCompliance, jmMIBGroups=jmMIBGroups, jmJobGroup=jmJobGroup, JmBooleanTC=JmBooleanTC, jmJobID=jmJobID, jmAttributeValueAsOctets=jmAttributeValueAsOctets, jmNumberOfInterveningJobs=jmNumberOfInterveningJobs, jmGeneral=jmGeneral, jmJobStateReasons1=jmJobStateReasons1, jmAttributeEntry=jmAttributeEntry, jmGeneralTable=jmGeneralTable, jmJobState=jmJobState, JmJobStateTC=JmJobStateTC, jmGeneralOldestActiveJobIndex=jmGeneralOldestActiveJobIndex, JmNaturalLanguageTagTC=JmNaturalLanguageTagTC, jmJobIDGroup=jmJobIDGroup, jmGeneralJobSetIndex=jmGeneralJobSetIndex, jmJobEntry=jmJobEntry, JmJobStateReasons3TC=JmJobStateReasons3TC, jmGeneralAttributePersistence=jmGeneralAttributePersistence, jmAttributeTypeIndex=jmAttributeTypeIndex, jmJobImpressionsCompleted=jmJobImpressionsCompleted, jmJobImpressionsPerCopyRequested=jmJobImpressionsPerCopyRequested, JmJobSourcePlatformTypeTC=JmJobSourcePlatformTypeTC, jmGeneralNumberOfActiveJobs=jmGeneralNumberOfActiveJobs, JmTimeStampTC=JmTimeStampTC, JmPrintQualityTC=JmPrintQualityTC, jmJobIDTable=jmJobIDTable, jmJobIndex=jmJobIndex, JmJobCollationTypeTC=JmJobCollationTypeTC, jmJobIDEntry=jmJobIDEntry, jmAttributeTable=jmAttributeTable, JmJobStateReasons4TC=JmJobStateReasons4TC, jmAttribute=jmAttribute, jobmonMIB=jobmonMIB, jmJobKOctetsProcessed=jmJobKOctetsProcessed, jmJobSubmissionID=jmJobSubmissionID, jmJobOwner=jmJobOwner, jmJobIDJobIndex=jmJobIDJobIndex, jmAttributeInstanceIndex=jmAttributeInstanceIndex, jmGeneralGroup=jmGeneralGroup, JmUTF8StringTC=JmUTF8StringTC, JmJobStateReasons2TC=JmJobStateReasons2TC)
