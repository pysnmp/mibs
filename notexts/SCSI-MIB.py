...
ModuleIdentity, mib_2, Unsigned32, Counter32, Bits, Counter64, Integer32, iso, ObjectIdentity, TimeTicks, NotificationType, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "Unsigned32", "Counter32", "Bits", "Counter64", "Integer32", "iso", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TruthValue, RowStatus, TimeStamp, RowPointer, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "RowPointer", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInCommands=scsiLuInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiLuState=scsiLuState, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiLogicalUnit=scsiLogicalUnit, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiObjects=scsiObjects, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, scsiLuIdType=scsiLuIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuEntry=scsiLuEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunLun=scsiDscLunLun, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiDeviceTable=scsiDeviceTable, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotifications=scsiNotifications, scsiLuWwnName=scsiLuWwnName, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiPortTable=scsiPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIndex=scsiLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGeneral=scsiGeneral, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceTable=scsiInstanceTable, scsiLuIdTable=scsiLuIdTable, scsiLuStatus=scsiLuStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
