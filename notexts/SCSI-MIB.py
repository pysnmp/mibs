...
iso, Integer32, TimeTicks, Counter32, Bits, mib_2, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Unsigned32, Counter64, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "TimeTicks", "Counter32", "Bits", "mib-2", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity")
RowStatus, AutonomousType, RowPointer, TextualConvention, DisplayString, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "RowPointer", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptType=scsiTrnsptType, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceRole=scsiDeviceRole, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiConformance=scsiConformance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtName=scsiDscTgtName, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiObjects=scsiObjects, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiName=ScsiName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDevicePortNumber=scsiDevicePortNumber, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiGeneral=scsiGeneral, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiPortTable=scsiPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiInstanceTable=scsiInstanceTable, PYSNMP_MODULE_ID=scsiModule, scsiTarget=scsiTarget, scsiDscLunLun=scsiDscLunLun, scsiLuInCommands=scsiLuInCommands, scsiCompliances=scsiCompliances, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportFCP=scsiTransportFCP, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIndex=scsiLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiTranportOther=scsiTranportOther, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevTable=scsiTgtDevTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTargetGroup=scsiTargetGroup, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuTable=scsiLuTable, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
