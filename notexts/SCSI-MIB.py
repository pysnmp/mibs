...
Counter32, Gauge32, TimeTicks, NotificationType, MibIdentifier, mib_2, Unsigned32, ObjectIdentity, iso, ModuleIdentity, Bits, Integer32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "TimeTicks", "NotificationType", "MibIdentifier", "mib-2", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "Bits", "Integer32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, AutonomousType, DisplayString, RowStatus, TimeStamp, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus", "TimeStamp", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiCompliance=scsiCompliance, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTarget=scsiTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuTable=scsiLuTable, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuEntry=scsiLuEntry, scsiLuIdType=scsiLuIdType, scsiTrnsptType=scsiTrnsptType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceResets=scsiDeviceResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuState=scsiLuState, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortIndex=scsiPortIndex, scsiInstanceEntry=scsiInstanceEntry, ScsiIdAssociation=ScsiIdAssociation, scsiNotifications=scsiNotifications, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceTable=scsiInstanceTable, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtName=scsiIntrPrtName, scsiObjects=scsiObjects, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceRole=scsiDeviceRole, scsiTransportSRP=scsiTransportSRP, scsiDscLunLun=scsiDscLunLun, scsiLuIdTable=scsiLuIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLunMapTable=scsiLunMapTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtDevTable=scsiTgtDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortEntry=scsiPortEntry, scsiGroups=scsiGroups, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTable=scsiPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiTransportSBP=scsiTransportSBP, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuProductId=scsiLuProductId, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes)
