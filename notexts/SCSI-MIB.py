...
Bits, Integer32, ModuleIdentity, TimeTicks, IpAddress, mib_2, Counter64, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Unsigned32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ModuleIdentity", "TimeTicks", "IpAddress", "mib-2", "Counter64", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Unsigned32", "iso", "Gauge32")
DisplayString, RowStatus, TextualConvention, AutonomousType, RowPointer, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiNotifications=scsiNotifications, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuEntry=scsiLuEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortName=scsiAttTgtPortName, ScsiName=ScsiName, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunLun=scsiDscLunLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportFCP=scsiTransportFCP, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiTrnsptType=scsiTrnsptType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiConformance=scsiConformance, scsiDscTgtEntry=scsiDscTgtEntry, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, PYSNMP_MODULE_ID=scsiModule, scsiCompliances=scsiCompliances, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtName=scsiDscTgtName, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuProductId=scsiLuProductId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetGroup=scsiTargetGroup, scsiLuInResets=scsiLuInResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiModule=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuIndex=scsiLuIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdTable=scsiLuIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortIndex=scsiPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiLuStatus=scsiLuStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTarget=scsiTarget, scsiLuState=scsiLuState, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdType=ScsiIdType, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
