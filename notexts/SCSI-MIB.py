...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Gauge32, MibIdentifier, TimeTicks, mib_2, NotificationType, ModuleIdentity, iso, Unsigned32, Counter64, Counter32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Gauge32", "MibIdentifier", "TimeTicks", "mib-2", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "Counter64", "Counter32", "ObjectIdentity", "Integer32")
TextualConvention, DisplayString, AutonomousType, RowPointer, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType", "RowPointer", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuStatus=scsiLuStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotifications=scsiNotifications, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiGroups=scsiGroups, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiPortRole=scsiPortRole, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiConformance=scsiConformance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdAssociation=scsiLuIdAssociation, ScsiName=ScsiName, ScsiIdType=ScsiIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiLuIdType=scsiLuIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInResets=scsiLuInResets, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunTable=scsiDscLunTable, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceTable=scsiInstanceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLogicalUnit=scsiLogicalUnit, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuHSInCommands=scsiLuHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiGeneral=scsiGeneral, scsiTarget=scsiTarget, scsiTransportSRP=scsiTransportSRP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceAlias=scsiDeviceAlias, scsiTargetGroup=scsiTargetGroup, scsiInstIndex=scsiInstIndex, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrName=scsiAuthIntrName, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiObjects=scsiObjects, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry)
