...
TimeTicks, Counter64, Unsigned32, MibIdentifier, Integer32, Counter32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, IpAddress, mib_2, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "IpAddress", "mib-2", "iso", "Bits")
TruthValue, RowStatus, TextualConvention, RowPointer, AutonomousType, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "RowPointer", "AutonomousType", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunTable=scsiDscLunTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortRole=scsiPortRole, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstAlias=scsiInstAlias, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiModule=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSBP=scsiTransportSBP, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, ScsiName=ScsiName, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdType=scsiDscLunIdType, scsiLuProductId=scsiLuProductId, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGeneral=scsiGeneral, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInResets=scsiLuInResets, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptType=scsiTrnsptType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiConformance=scsiConformance, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuState=scsiLuState, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiObjects=scsiObjects, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstIndex=scsiInstIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole)
