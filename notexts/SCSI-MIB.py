...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, iso, ObjectIdentity, NotificationType, Counter32, Gauge32, TimeTicks, Bits, ModuleIdentity, Counter64, MibIdentifier, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "iso", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "TimeTicks", "Bits", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "Unsigned32")
RowPointer, AutonomousType, TruthValue, DisplayString, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TruthValue", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdType=ScsiIdType, scsiLuIdTable=scsiLuIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportTypes=scsiTransportTypes, scsiLogicalUnit=scsiLogicalUnit, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiTgtPortName=scsiTgtPortName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunTable=scsiDscLunTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceRole=scsiDeviceRole, scsiTranportOther=scsiTranportOther, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiNotifications=scsiNotifications, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInResets=scsiLuInResets, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstAlias=scsiInstAlias, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuRevisionId=scsiLuRevisionId, scsiCompliances=scsiCompliances, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGeneral=scsiGeneral, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiCompliance=scsiCompliance, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdValue=scsiLuIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, ScsiIdValue=ScsiIdValue, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus)
