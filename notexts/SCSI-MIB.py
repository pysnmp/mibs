...
TimeTicks, Gauge32, Bits, ModuleIdentity, MibIdentifier, Counter64, Integer32, ObjectIdentity, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Bits", "ModuleIdentity", "MibIdentifier", "Counter64", "Integer32", "ObjectIdentity", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "iso", "Unsigned32")
DisplayString, TimeStamp, TextualConvention, TruthValue, RowStatus, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdEntry=scsiLuIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiator=scsiInitiator, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTable=scsiPortTable, scsiCompliance=scsiCompliance, scsiModule=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, scsiConformance=scsiConformance, scsiNotifications=scsiNotifications, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, ScsiIndexValue=ScsiIndexValue, scsiInstAlias=scsiInstAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTarget=scsiTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiPortRole=scsiPortRole, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportFCP=scsiTransportFCP, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdValue=ScsiIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuVendorId=scsiLuVendorId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuTable=scsiLuTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtName=scsiDscTgtName, scsiLunMapTable=scsiLunMapTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiInstIndex=scsiInstIndex, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunTable=scsiDscLunTable, scsiNotificationsPrefix=scsiNotificationsPrefix)
