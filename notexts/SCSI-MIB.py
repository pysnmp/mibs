...
Unsigned32, Gauge32, Counter64, MibIdentifier, Bits, Counter32, NotificationType, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, mib_2, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "Counter64", "MibIdentifier", "Bits", "Counter32", "NotificationType", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "mib-2", "Integer32", "TimeTicks")
TextualConvention, TruthValue, AutonomousType, TimeStamp, DisplayString, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportSPI=scsiTranportSPI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiDeviceTable=scsiDeviceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdType=scsiLuIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatus=scsiLuStatus, scsiInitiator=scsiInitiator, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiObjects=scsiObjects, scsiTranportOther=scsiTranportOther, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuTable=scsiLuTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortIndex=scsiPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdentifier=ScsiIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiModule=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuInCommands=scsiLuInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiTransportSBP=scsiTransportSBP, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstIndex=scsiInstIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiConformance=scsiConformance, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunLun=scsiDscLunLun, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLun=scsiLunMapLun, scsiLuProductId=scsiLuProductId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex)
