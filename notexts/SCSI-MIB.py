...
ModuleIdentity, iso, Gauge32, ObjectIdentity, MibIdentifier, Bits, Counter32, IpAddress, Integer32, Counter64, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "Counter32", "IpAddress", "Integer32", "Counter64", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32")
TimeStamp, TruthValue, RowStatus, TextualConvention, RowPointer, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention", "RowPointer", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstIndex=scsiInstIndex, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtDevTable=scsiTgtDevTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValue=ScsiIndexValue, scsiNotifications=scsiNotifications, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuTable=scsiLuTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdValue=scsiLuIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuProductId=scsiLuProductId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLogicalUnit=scsiLogicalUnit, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortRole=scsiPortRole, scsiTargetGroup=scsiTargetGroup, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiator=scsiInitiator, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdType=scsiDscLunIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLunMapGroup=scsiLunMapGroup, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtName=scsiDscTgtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiModule=scsiModule, scsiGeneral=scsiGeneral, scsiDscLunEntry=scsiDscLunEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiObjects=scsiObjects, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTable=scsiPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiName=ScsiName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevTable=scsiIntrDevTable, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiConformance=scsiConformance, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName)
