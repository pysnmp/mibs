...
ObjectIdentity, Unsigned32, Integer32, mib_2, iso, ModuleIdentity, Counter32, Counter64, Gauge32, Bits, TimeTicks, IpAddress, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "mib-2", "iso", "ModuleIdentity", "Counter32", "Counter64", "Gauge32", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, RowPointer, TextualConvention, TimeStamp, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuPeripheralType=scsiLuPeripheralType, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportTypes=scsiTransportTypes, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIndex=scsiLuIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTransportSRP=scsiTransportSRP, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTarget=scsiTarget, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdValue=scsiLuIdValue, ScsiName=ScsiName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiLuEntry=scsiLuEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, ScsiIdAssociation=ScsiIdAssociation, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotifications=scsiNotifications, scsiTranportOther=scsiTranportOther, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuProductId=scsiLuProductId, scsiTransportFCP=scsiTransportFCP, scsiLuIdTable=scsiLuIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdType=scsiLuIdType, scsiDscLunIdType=scsiDscLunIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstIndex=scsiInstIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiInitiator=scsiInitiator, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortRole=scsiPortRole, scsiTgtPortTable=scsiTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptTable=scsiTrnsptTable, scsiPortEntry=scsiPortEntry, scsiConformance=scsiConformance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, ScsiIdType=ScsiIdType, ScsiIdValue=ScsiIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex)
