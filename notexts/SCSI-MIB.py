...
Unsigned32, MibIdentifier, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, Counter64, Counter32, TimeTicks, Gauge32, iso, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "Counter64", "Counter32", "TimeTicks", "Gauge32", "iso", "Bits", "Integer32", "NotificationType")
RowPointer, TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdValue=scsiLuIdValue, scsiLuStatus=scsiLuStatus, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiGroups=scsiGroups, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiLunMapIndex=scsiLunMapIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, scsiTransportTypes=scsiTransportTypes, ScsiIdAssociation=ScsiIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiator=scsiInitiator, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiAuthIntrName=scsiAuthIntrName, scsiLuInResets=scsiLuInResets, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteInitiators=scsiRemoteInitiators, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstAlias=scsiInstAlias, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuProductId=scsiLuProductId, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiTarget=scsiTarget, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTable=scsiPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiObjects=scsiObjects, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier)
