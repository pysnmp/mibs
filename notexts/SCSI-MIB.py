...
ModuleIdentity, NotificationType, Unsigned32, mib_2, TimeTicks, IpAddress, ObjectIdentity, Gauge32, Bits, Counter64, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Unsigned32", "mib-2", "TimeTicks", "IpAddress", "ObjectIdentity", "Gauge32", "Bits", "Counter64", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier")
TimeStamp, AutonomousType, RowPointer, DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowPointer", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValue=ScsiIndexValue, scsiDscLunIndex=scsiDscLunIndex, scsiLuWwnName=scsiLuWwnName, scsiLuIdType=scsiLuIdType, scsiLuIdIndex=scsiLuIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportOther=scsiTranportOther, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiDeviceRole=scsiDeviceRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceTable=scsiInstanceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTarget=scsiTarget, scsiLuIndex=scsiLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuDefaultLun=scsiLuDefaultLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiInitiatorGroup=scsiInitiatorGroup, scsiGeneral=scsiGeneral, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuTable=scsiLuTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceTable=scsiDeviceTable, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuState=scsiLuState, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptType=scsiTrnsptType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdType=ScsiIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiator=scsiInitiator, scsiLuIdEntry=scsiLuIdEntry)
