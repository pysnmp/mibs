...
IpAddress, iso, ObjectIdentity, MibIdentifier, Counter32, mib_2, Counter64, Bits, TimeTicks, Integer32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "mib-2", "Counter64", "Bits", "TimeTicks", "Integer32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32")
DisplayString, AutonomousType, TimeStamp, RowStatus, TextualConvention, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstanceTable=scsiInstanceTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiator=scsiInitiator, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdentifier=ScsiIdentifier, scsiLuIdTable=scsiLuIdTable, scsiConformance=scsiConformance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiObjects=scsiObjects, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSBP=scsiTransportSBP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIndex=scsiLuIndex, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiTranportOther=scsiTranportOther, scsiTarget=scsiTarget, scsiCompliance=scsiCompliance, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortRole=scsiPortRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTable=scsiPortTable, ScsiName=ScsiName, scsiLuIdIndex=scsiLuIdIndex, scsiModule=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTransportSRP=scsiTransportSRP, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuEntry=scsiLuEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuState=scsiLuState, scsiLuInResets=scsiLuInResets, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuTable=scsiLuTable, ScsiIdValue=ScsiIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtName=scsiDscTgtName)
