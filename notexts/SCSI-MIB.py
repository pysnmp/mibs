...
Bits, Unsigned32, ObjectIdentity, Counter64, Counter32, Gauge32, iso, IpAddress, mib_2, MibIdentifier, TimeTicks, NotificationType, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "ObjectIdentity", "Counter64", "Counter32", "Gauge32", "iso", "IpAddress", "mib-2", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, AutonomousType, TextualConvention, TimeStamp, DisplayString, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdType=ScsiIdType, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiConformance=scsiConformance, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceRole=scsiDeviceRole, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValue=ScsiIndexValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuState=scsiLuState, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiObjects=scsiObjects, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiGeneral=scsiGeneral, ScsiIdValue=ScsiIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLunMapIndex=scsiLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuEntry=scsiLuEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuProductId=scsiLuProductId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortRole=scsiPortRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliance=scsiCompliance, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiModule=scsiModule, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtName=scsiAttIntrPrtName)
