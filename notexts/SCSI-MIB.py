...
iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, IpAddress, ObjectIdentity, TimeTicks, Counter64, Gauge32, mib_2, Integer32, Bits, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "IpAddress", "ObjectIdentity", "TimeTicks", "Counter64", "Gauge32", "mib-2", "Integer32", "Bits", "Unsigned32", "ModuleIdentity")
TextualConvention, RowPointer, TimeStamp, TruthValue, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "TimeStamp", "TruthValue", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiLuWwnName=scsiLuWwnName, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTranportOther=scsiTranportOther, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInResets=scsiLuInResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuProductId=scsiLuProductId, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, PYSNMP_MODULE_ID=scsiModule, scsiGeneral=scsiGeneral, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiInstAlias=scsiInstAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuState=scsiLuState, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportFCP=scsiTransportFCP, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, scsiLuEntry=scsiLuEntry, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdType=scsiLuIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInCommands=scsiLuInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, ScsiIdType=ScsiIdType, scsiDscLunLun=scsiDscLunLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceResets=scsiDeviceResets, scsiTranportSPI=scsiTranportSPI, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiObjects=scsiObjects, scsiTransportSBP=scsiTransportSBP, scsiInstIndex=scsiInstIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapGroup=scsiLunMapGroup, scsiTransportTypes=scsiTransportTypes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapTable=scsiLunMapTable, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiLUNOrZero=ScsiLUNOrZero)
