...
Counter64, Integer32, ModuleIdentity, Gauge32, TimeTicks, Bits, iso, mib_2, ObjectIdentity, Counter32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "ModuleIdentity", "Gauge32", "TimeTicks", "Bits", "iso", "mib-2", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32")
RowStatus, TextualConvention, AutonomousType, TimeStamp, TruthValue, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortTable=scsiPortTable, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdValue=ScsiIdValue, scsiPortRole=scsiPortRole, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, scsiIntrPrtName=scsiIntrPrtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunTable=scsiDscLunTable, scsiConformance=scsiConformance, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdTable=scsiLuIdTable, scsiDeviceTable=scsiDeviceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptTable=scsiTrnsptTable, scsiInstIndex=scsiInstIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiName=ScsiName, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiator=scsiInitiator, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiPortIndex=scsiPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuInResets=scsiLuInResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportOther=scsiTranportOther, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptType=scsiTrnsptType, ScsiIndexValue=ScsiIndexValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortEntry=scsiPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup)
