...
TimeTicks, ModuleIdentity, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Unsigned32, MibIdentifier, Gauge32, Integer32, Counter64, IpAddress, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Unsigned32", "MibIdentifier", "Gauge32", "Integer32", "Counter64", "IpAddress", "mib-2", "iso")
RowPointer, RowStatus, AutonomousType, TimeStamp, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiGeneral=scsiGeneral, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, PYSNMP_MODULE_ID=scsiModule, scsiGroups=scsiGroups, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiDscLunIndex=scsiDscLunIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuTable=scsiLuTable, scsiInitiator=scsiInitiator, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, scsiLuEntry=scsiLuEntry, scsiTransportISCSI=scsiTransportISCSI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInCommands=scsiLuInCommands, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceGroup=scsiDeviceGroup, scsiObjects=scsiObjects, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceTable=scsiDeviceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstAlias=scsiInstAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtName=scsiDscTgtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiLuState=scsiLuState, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortRole=scsiPortRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuProductId=scsiLuProductId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiTarget=scsiTarget)
