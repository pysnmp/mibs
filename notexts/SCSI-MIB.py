...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, MibIdentifier, Integer32, mib_2, iso, Unsigned32, Counter32, Counter64, Bits, IpAddress, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "MibIdentifier", "Integer32", "mib-2", "iso", "Unsigned32", "Counter32", "Counter64", "Bits", "IpAddress", "TimeTicks", "Gauge32")
RowStatus, AutonomousType, DisplayString, TextualConvention, RowPointer, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "DisplayString", "TextualConvention", "RowPointer", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiObjects=scsiObjects, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliances=scsiCompliances, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortRole=scsiPortRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunEntry=scsiDscLunEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiLuTable=scsiLuTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtName=scsiDscTgtName, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInResets=scsiLuInResets, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTrnsptType=scsiTrnsptType, scsiTranportSPI=scsiTranportSPI, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdentifier=ScsiIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortName=scsiTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiTranportOther=scsiTranportOther, scsiDeviceIndex=scsiDeviceIndex, ScsiName=ScsiName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevEntry=scsiTgtDevEntry, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValue=ScsiIndexValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiConformance=scsiConformance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdIndex=scsiLuIdIndex, scsiGeneral=scsiGeneral, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiGroups=scsiGroups, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuVendorId=scsiLuVendorId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, ScsiIdType=ScsiIdType, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIndex=scsiDscLunIndex)
