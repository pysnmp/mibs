...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Bits, Unsigned32, ObjectIdentity, mib_2, iso, MibIdentifier, Integer32, Counter64, IpAddress, ModuleIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Bits", "Unsigned32", "ObjectIdentity", "mib-2", "iso", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "ModuleIdentity", "Gauge32", "Counter32")
RowStatus, TruthValue, DisplayString, TimeStamp, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDevicePortNumber=scsiDevicePortNumber, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortName=scsiTgtPortName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSBP=scsiTransportSBP, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuInCommands=scsiLuInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtName=scsiDscTgtName, scsiDeviceTable=scsiDeviceTable, scsiLuIdTable=scsiLuIdTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, ScsiName=ScsiName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstanceTable=scsiInstanceTable, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstAlias=scsiInstAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuEntry=scsiLuEntry, scsiPortTable=scsiPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiConformance=scsiConformance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInResets=scsiLuInResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiLuTable=scsiLuTable, scsiGroups=scsiGroups, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptType=scsiTrnsptType, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGeneral=scsiGeneral, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTarget=scsiTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiLuState=scsiLuState, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIndex=scsiLuIndex, scsiTranportOther=scsiTranportOther, scsiLuStatus=scsiLuStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstIndex=scsiInstIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiPortEntry=scsiPortEntry)
