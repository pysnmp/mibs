...
Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, ModuleIdentity, Unsigned32, Bits, ObjectIdentity, iso, IpAddress, MibIdentifier, NotificationType, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "ModuleIdentity", "Unsigned32", "Bits", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "NotificationType", "mib-2", "Integer32")
RowStatus, TextualConvention, TimeStamp, DisplayString, TruthValue, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliance=scsiCompliance, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunLun=scsiDscLunLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiDevicePortNumber=scsiDevicePortNumber, scsiTranportSPI=scsiTranportSPI, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceAlias=scsiDeviceAlias, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiObjects=scsiObjects, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiPortIndex=scsiPortIndex, ScsiIdValue=ScsiIdValue, scsiTgtPortName=scsiTgtPortName, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiLuStatus=scsiLuStatus, scsiInstIndex=scsiInstIndex, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTarget=scsiTarget, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunTable=scsiDscLunTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInResets=scsiLuInResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiPortRole=scsiPortRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiator=scsiInitiator, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuProductId=scsiLuProductId, ScsiIdAssociation=ScsiIdAssociation, scsiNotifications=scsiNotifications, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiLuWwnName=scsiLuWwnName, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValue=ScsiIndexValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuState=scsiLuState, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdType=ScsiIdType, scsiGroups=scsiGroups, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
