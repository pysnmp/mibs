...
Integer32, Gauge32, IpAddress, ModuleIdentity, Unsigned32, Bits, iso, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, Counter64, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "IpAddress", "ModuleIdentity", "Unsigned32", "Bits", "iso", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "Counter64", "Counter32", "ObjectIdentity")
TruthValue, RowStatus, RowPointer, TimeStamp, DisplayString, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "RowPointer", "TimeStamp", "DisplayString", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdTable=scsiLuIdTable, scsiPortEntry=scsiPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptType=scsiTrnsptType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdAssociation=scsiLuIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceEntry=scsiDeviceEntry, scsiNotifications=scsiNotifications, scsiGeneral=scsiGeneral, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstAlias=scsiInstAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstIndex=scsiInstIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGroups=scsiGroups, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInResets=scsiLuInResets, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, scsiConformance=scsiConformance, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, ScsiIdentifier=ScsiIdentifier, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceRole=scsiDeviceRole, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortRole=scsiPortRole, scsiTgtPortTable=scsiTgtPortTable, scsiLuVendorId=scsiLuVendorId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuProductId=scsiLuProductId, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiInitiator=scsiInitiator, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIdType=ScsiIdType, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiLogicalUnit=scsiLogicalUnit)
