...
Counter64, Gauge32, Counter32, ObjectIdentity, Integer32, TimeTicks, Unsigned32, ModuleIdentity, mib_2, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "TimeTicks", "Unsigned32", "ModuleIdentity", "mib-2", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "MibIdentifier")
AutonomousType, RowPointer, TextualConvention, DisplayString, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuEntry=scsiLuEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuWwnName=scsiLuWwnName, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapEntry=scsiLunMapEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetGroup=scsiTargetGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInResets=scsiLuInResets, ScsiIdValue=ScsiIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiModule=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiCompliance=scsiCompliance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtName=scsiDscTgtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiLuIdValue=scsiLuIdValue, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceTable=scsiDeviceTable, scsiInstanceTable=scsiInstanceTable, ScsiIdentifier=ScsiIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortName=scsiTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatus=scsiLuStatus, ScsiIdType=ScsiIdType, scsiPortTable=scsiPortTable, scsiLuState=scsiLuState, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiLuInCommands=scsiLuInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLun=scsiLunMapLun, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscLunEntry=scsiDscLunEntry, scsiPortEntry=scsiPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiObjects=scsiObjects, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands)
