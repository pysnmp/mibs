...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Integer32, Counter64, Gauge32, iso, ObjectIdentity, IpAddress, Bits, mib_2, TimeTicks, MibIdentifier, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Integer32", "Counter64", "Gauge32", "iso", "ObjectIdentity", "IpAddress", "Bits", "mib-2", "TimeTicks", "MibIdentifier", "Unsigned32", "NotificationType")
RowPointer, AutonomousType, DisplayString, TruthValue, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "DisplayString", "TruthValue", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiPortIndex=scsiPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdValue=scsiLuIdValue, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuProductId=scsiLuProductId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliances=scsiCompliances, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiModule=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTable=scsiPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuTable=scsiLuTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, ScsiName=ScsiName, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLuIdTable=scsiLuIdTable, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiObjects=scsiObjects, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliance=scsiCompliance, scsiTarget=scsiTarget, scsiDeviceTable=scsiDeviceTable, scsiLunMapTable=scsiLunMapTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatus=scsiLuStatus, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiPortEntry=scsiPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun)
