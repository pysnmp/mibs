...
iso, NotificationType, Bits, TimeTicks, MibIdentifier, mib_2, IpAddress, Integer32, ModuleIdentity, Counter64, Unsigned32, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "mib-2", "IpAddress", "Integer32", "ModuleIdentity", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
TimeStamp, DisplayString, TextualConvention, RowStatus, RowPointer, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "RowPointer", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTable=scsiPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportTypes=scsiTransportTypes, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdType=ScsiIdType, scsiLuInResets=scsiLuInResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGeneral=scsiGeneral, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdTable=scsiLuIdTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiCompliance=scsiCompliance, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuEntry=scsiLuEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiDeviceRole=scsiDeviceRole, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiInstIndex=scsiInstIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtName=scsiDscTgtName, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdType=scsiLuIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiObjects=scsiObjects, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdType=scsiDscLunIdType, ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunEntry=scsiDscLunEntry, scsiCompliances=scsiCompliances, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, scsiLuState=scsiLuState, scsiConformance=scsiConformance)
