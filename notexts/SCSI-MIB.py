...
ModuleIdentity, IpAddress, Counter64, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks, mib_2, NotificationType, ObjectIdentity, MibIdentifier, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Counter64", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks", "mib-2", "NotificationType", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiInstanceTable=scsiInstanceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiConformance=scsiConformance, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortRole=scsiPortRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiLuInCommands=scsiLuInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGroups=scsiGroups, scsiLuTable=scsiLuTable, scsiPortIndex=scsiPortIndex, scsiLuIdType=scsiLuIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiator=scsiInitiator, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotifications=scsiNotifications, scsiDeviceTable=scsiDeviceTable, ScsiIdentifier=ScsiIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuEntry=scsiLuEntry, scsiDscLunIndex=scsiDscLunIndex, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes)
