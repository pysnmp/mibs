...
iso, Counter32, ObjectIdentity, MibIdentifier, NotificationType, TimeTicks, Counter64, Gauge32, Bits, IpAddress, mib_2, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "Gauge32", "Bits", "IpAddress", "mib-2", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TruthValue, AutonomousType, TimeStamp, TextualConvention, RowStatus, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTable=scsiPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiLunMapEntry=scsiLunMapEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiNotifications=scsiNotifications, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceRole=scsiDeviceRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiTgtDevTable=scsiTgtDevTable, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdIndex=scsiLuIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuState=scsiLuState, scsiInstAlias=scsiInstAlias, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuEntry=scsiLuEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiator=scsiInitiator, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstIndex=scsiInstIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, scsiCompliance=scsiCompliance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInResets=scsiLuInResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiLuProductId=scsiLuProductId, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiPortIndex=scsiPortIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, ScsiIdValue=ScsiIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliances=scsiCompliances, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiInstanceTable=scsiInstanceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuTable=scsiLuTable, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTarget=scsiTarget, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiConformance=scsiConformance, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatus=scsiLuStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdTable=scsiLuIdTable)
