...
IpAddress, Gauge32, TimeTicks, mib_2, Integer32, Unsigned32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, MibIdentifier, Counter32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "TimeTicks", "mib-2", "Integer32", "Unsigned32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter32", "iso", "Counter64")
TextualConvention, AutonomousType, TimeStamp, DisplayString, RowPointer, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "RowPointer", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatusChanged=scsiLuStatusChanged, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapIndex=scsiLunMapIndex, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportOther=scsiTranportOther, scsiConformance=scsiConformance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiCompliance=scsiCompliance, scsiDscLunLun=scsiDscLunLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrName=scsiAuthIntrName, scsiLuEntry=scsiLuEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiName=ScsiName, scsiInstAlias=scsiInstAlias, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdType=ScsiIdType, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiPortTable=scsiPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiTransportTypes=scsiTransportTypes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLuIndex=scsiLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiIntrPrtTable=scsiIntrPrtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiObjects=scsiObjects, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSBP=scsiTransportSBP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, ScsiIdValue=ScsiIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceTable=scsiInstanceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuDefaultLun=scsiLuDefaultLun, scsiGeneral=scsiGeneral, scsiTranportSPI=scsiTranportSPI, scsiLuState=scsiLuState, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdTable=scsiLuIdTable, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiPortRole=scsiPortRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtName=scsiDscTgtName)
