...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, Counter32, mib_2, ModuleIdentity, Bits, MibIdentifier, ObjectIdentity, Counter64, Gauge32, TimeTicks, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "Counter32", "mib-2", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "Unsigned32")
TruthValue, TextualConvention, DisplayString, RowPointer, AutonomousType, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString", "RowPointer", "AutonomousType", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInCommands=scsiLuInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIndexValue=ScsiIndexValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuEntry=scsiLuEntry, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatus=scsiLuStatus, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdentifier=ScsiIdentifier, scsiLuIndex=scsiLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGroups=scsiGroups, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, ScsiIdValue=ScsiIdValue, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceTable=scsiInstanceTable, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiConformance=scsiConformance, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuWwnName=scsiLuWwnName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuTable=scsiLuTable, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiObjects=scsiObjects, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortEntry=scsiPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType)
