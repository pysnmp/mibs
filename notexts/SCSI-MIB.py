...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, Integer32, Bits, iso, mib_2, IpAddress, ModuleIdentity, Counter64, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "Integer32", "Bits", "iso", "mib-2", "IpAddress", "ModuleIdentity", "Counter64", "TimeTicks", "Counter32")
TruthValue, RowPointer, DisplayString, AutonomousType, TimeStamp, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "DisplayString", "AutonomousType", "TimeStamp", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstIndex=scsiInstIndex, scsiTransportSRP=scsiTransportSRP, ScsiName=ScsiName, scsiLunMapLun=scsiLunMapLun, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunLun=scsiDscLunLun, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteTarget=scsiRemoteTarget, scsiLuHSInCommands=scsiLuHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, ScsiIndexValue=ScsiIndexValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuProductId=scsiLuProductId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdType=ScsiIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSBP=scsiTransportSBP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiConformance=scsiConformance, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiObjects=scsiObjects, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuEntry=scsiLuEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportOther=scsiTranportOther, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTarget=scsiTarget, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuTable=scsiLuTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTable=scsiPortTable, scsiModule=scsiModule, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiCompliance=scsiCompliance, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunTable=scsiDscLunTable, scsiLuInCommands=scsiLuInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortEntry=scsiPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortIndex=scsiPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuState=scsiLuState, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstAlias=scsiInstAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstVendorVersion=scsiInstVendorVersion)
