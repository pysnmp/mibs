...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Bits, Unsigned32, Counter32, MibIdentifier, TimeTicks, Counter64, ObjectIdentity, IpAddress, Integer32, NotificationType, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Bits", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType", "ModuleIdentity", "mib-2")
RowStatus, RowPointer, DisplayString, AutonomousType, TextualConvention, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTable=scsiPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiLuEntry=scsiLuEntry, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtName=scsiDscTgtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportOther=scsiTranportOther, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiGeneral=scsiGeneral, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIndex=scsiLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiConformance=scsiConformance, scsiDeviceEntry=scsiDeviceEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiTarget=scsiTarget, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiPortRole=scsiPortRole, scsiPortIndex=scsiPortIndex, scsiGroups=scsiGroups, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, ScsiIdValue=ScsiIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtTable=scsiDscTgtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliances=scsiCompliances, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, ScsiIndexValue=ScsiIndexValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiator=scsiInitiator, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapEntry=scsiLunMapEntry, scsiInstIndex=scsiInstIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuTable=scsiLuTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuWwnName=scsiLuWwnName)
