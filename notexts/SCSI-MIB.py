...
Gauge32, Bits, Counter32, Counter64, Unsigned32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, mib_2, Integer32, ModuleIdentity, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter32", "Counter64", "Unsigned32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "mib-2", "Integer32", "ModuleIdentity", "NotificationType", "MibIdentifier")
RowPointer, DisplayString, RowStatus, TruthValue, AutonomousType, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "RowStatus", "TruthValue", "AutonomousType", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptIndex=scsiTrnsptIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliances=scsiCompliances, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdType=scsiLuIdType, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiLuProductId=scsiLuProductId, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdentifier=ScsiIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdTable=scsiLuIdTable, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiLuRevisionId=scsiLuRevisionId, scsiLuInCommands=scsiLuInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiDscTgtName=scsiDscTgtName, ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtTable=scsiDscTgtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortRole=scsiPortRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevEntry=scsiTgtDevEntry, scsiGroups=scsiGroups, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptType=scsiTrnsptType, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunTable=scsiDscLunTable, scsiRemoteInitiators=scsiRemoteInitiators, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiTranportOther=scsiTranportOther, scsiLuTable=scsiLuTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTarget=scsiTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
