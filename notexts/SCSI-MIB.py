...
IpAddress, ObjectIdentity, Integer32, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, ModuleIdentity, Counter32, iso, Counter64, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Integer32", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "ModuleIdentity", "Counter32", "iso", "Counter64", "Unsigned32", "MibIdentifier")
TextualConvention, AutonomousType, RowPointer, DisplayString, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "DisplayString", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIndex=scsiDscLunIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInCommands=scsiLuInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdValue=scsiLuIdValue, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiInitiator=scsiInitiator, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortRole=scsiPortRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdentifier=ScsiIdentifier, scsiLuIdType=scsiLuIdType, scsiLuVendorId=scsiLuVendorId, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInResets=scsiLuInResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiModule=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiObjects=scsiObjects, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiLunMapGroup=scsiLunMapGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliance=scsiCompliance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTable=scsiPortTable, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTranportSPI=scsiTranportSPI, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdValue=ScsiIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiTransportTypes=scsiTransportTypes, scsiTargetGroup=scsiTargetGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
