...
IpAddress, MibIdentifier, NotificationType, Gauge32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, ModuleIdentity, Counter32, Integer32, iso, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "NotificationType", "Gauge32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "ModuleIdentity", "Counter32", "Integer32", "iso", "ObjectIdentity", "TimeTicks")
DisplayString, AutonomousType, TextualConvention, RowPointer, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdTable=scsiLuIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiConformance=scsiConformance, scsiInitiator=scsiInitiator, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceTable=scsiInstanceTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiPortIndex=scsiPortIndex, scsiCompliances=scsiCompliances, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuState=scsiLuState, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuTable=scsiLuTable, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportOther=scsiTranportOther, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWwnName=scsiLuWwnName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiLuInResets=scsiLuInResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapTable=scsiLunMapTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliance=scsiCompliance, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortRole=scsiPortRole, scsiDscLunLun=scsiDscLunLun, scsiLuIdType=scsiLuIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportFCP=scsiTransportFCP, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTarget=scsiTarget, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, ScsiIdValue=ScsiIdValue, scsiNotifications=scsiNotifications, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes)
