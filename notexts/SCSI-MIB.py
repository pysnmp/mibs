...
NotificationType, iso, Counter64, Bits, ObjectIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Gauge32, IpAddress, ModuleIdentity, Integer32, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter64", "Bits", "ObjectIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Gauge32", "IpAddress", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32")
AutonomousType, RowPointer, RowStatus, TimeStamp, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "RowStatus", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuStatus=scsiLuStatus, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdentifier=ScsiIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiNotifications=scsiNotifications, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiName=ScsiName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstAlias=scsiInstAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportTypes=scsiTransportTypes, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiLuIdType=scsiLuIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiPortRole=scsiPortRole, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuState=scsiLuState, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiInitiator=scsiInitiator, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunTable=scsiDscLunTable, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiModule=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortName=scsiTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiTargetGroup=scsiTargetGroup, scsiInstIndex=scsiInstIndex, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiDscLunLun=scsiDscLunLun, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, scsiLuEntry=scsiLuEntry, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTable=scsiPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus)
