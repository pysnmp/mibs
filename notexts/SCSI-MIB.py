...
Bits, Gauge32, MibIdentifier, IpAddress, Integer32, Counter64, NotificationType, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "Integer32", "Counter64", "NotificationType", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
TimeStamp, RowStatus, TextualConvention, RowPointer, DisplayString, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "RowPointer", "DisplayString", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdType=ScsiIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuIdValue=scsiLuIdValue, scsiInitiator=scsiInitiator, scsiTranportSPI=scsiTranportSPI, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapTable=scsiLunMapTable, scsiLuRevisionId=scsiLuRevisionId, scsiObjects=scsiObjects, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiRemoteTarget=scsiRemoteTarget, scsiLuIndex=scsiLuIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiGroups=scsiGroups, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortEntry=scsiPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTarget=scsiTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiModule=scsiModule, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiConformance=scsiConformance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliance=scsiCompliance, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptTable=scsiTrnsptTable, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, ScsiIdentifier=ScsiIdentifier, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiCompliances=scsiCompliances)
