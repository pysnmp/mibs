...
TimeTicks, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, iso, Counter32, Bits, Integer32, NotificationType, MibIdentifier, ObjectIdentity, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "iso", "Counter32", "Bits", "Integer32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Gauge32", "Counter64")
RowStatus, RowPointer, TruthValue, TextualConvention, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiPortTable=scsiPortTable, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, scsiLunMapLun=scsiLunMapLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliance=scsiCompliance, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuProductId=scsiLuProductId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiObjects=scsiObjects, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIndex=scsiLuIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunLun=scsiDscLunLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuState=scsiLuState, scsiTransportTypes=scsiTransportTypes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInResets=scsiLuInResets, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdValue=ScsiIdValue, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiModule=scsiModule, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapIndex=scsiLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiator=scsiInitiator, scsiDscLunIndex=scsiDscLunIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiLuVendorId=scsiLuVendorId, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdTable=scsiLuIdTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportFCP=scsiTransportFCP, scsiPortRole=scsiPortRole, scsiCompliances=scsiCompliances, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdValue=scsiLuIdValue, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiInstAlias=scsiInstAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup)
