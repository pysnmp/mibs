...
Counter64, TimeTicks, iso, IpAddress, ModuleIdentity, Bits, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, mib_2, Integer32, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Bits", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "mib-2", "Integer32", "NotificationType", "Unsigned32")
RowPointer, AutonomousType, TextualConvention, TimeStamp, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdType=ScsiIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdTable=scsiLuIdTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceResets=scsiDeviceResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuProductId=scsiLuProductId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInResets=scsiLuInResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiConformance=scsiConformance, scsiPortEntry=scsiPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortTable=scsiPortTable, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTable=scsiIntrDevTable, scsiTransportFCP=scsiTransportFCP, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, scsiCompliance=scsiCompliance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType, scsiTgtPortName=scsiTgtPortName, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuState=scsiLuState, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiObjects=scsiObjects, scsiInstIndex=scsiInstIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuRevisionId=scsiLuRevisionId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotifications=scsiNotifications, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral)
