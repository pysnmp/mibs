...
IpAddress, Counter32, ModuleIdentity, Integer32, Gauge32, iso, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, Bits, Counter64, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "ModuleIdentity", "Integer32", "Gauge32", "iso", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "Bits", "Counter64", "NotificationType", "ObjectIdentity")
TimeStamp, TruthValue, AutonomousType, RowStatus, TextualConvention, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowStatus", "TextualConvention", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdType=scsiDscLunIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotifications=scsiNotifications, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortTable=scsiPortTable, scsiPortEntry=scsiPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, scsiDscLunEntry=scsiDscLunEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, ScsiName=ScsiName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiator=scsiInitiator, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapGroup=scsiLunMapGroup, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, scsiGroups=scsiGroups, scsiIntrDevTable=scsiIntrDevTable, scsiInstanceEntry=scsiInstanceEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInResets=scsiLuInResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiLuProductId=scsiLuProductId, scsiModule=scsiModule, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex)
