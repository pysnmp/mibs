...
Unsigned32, ModuleIdentity, MibIdentifier, IpAddress, Bits, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Gauge32, NotificationType, Counter64, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress", "Bits", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Counter64", "Counter32", "mib-2")
RowStatus, TextualConvention, RowPointer, TruthValue, DisplayString, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "RowPointer", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportISCSI=scsiTransportISCSI, scsiGeneral=scsiGeneral, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInResets=scsiLuInResets, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLun=scsiLunMapLun, scsiTransportFCP=scsiTransportFCP, scsiLuState=scsiLuState, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuProductId=scsiLuProductId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdValue=scsiLuIdValue, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiConformance=scsiConformance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportSPI=scsiTranportSPI, scsiPortEntry=scsiPortEntry, scsiPortTable=scsiPortTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortIndex=scsiPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuEntry=scsiLuEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceRole=scsiDeviceRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSBP=scsiTransportSBP, ScsiName=ScsiName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstAlias=scsiInstAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuInCommands=scsiLuInCommands, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiNotifications=scsiNotifications, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuWwnName=scsiLuWwnName, scsiLuStatus=scsiLuStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunEntry=scsiDscLunEntry, scsiInstanceTable=scsiInstanceTable, scsiTarget=scsiTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiModule=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable)
