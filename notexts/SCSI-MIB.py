...
mib_2, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, IpAddress, NotificationType, Unsigned32, Gauge32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "Gauge32", "Integer32", "Bits")
RowPointer, RowStatus, TimeStamp, AutonomousType, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdTable=scsiLuIdTable, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetGroup=scsiTargetGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiGeneral=scsiGeneral, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiCompliances=scsiCompliances, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortRole=scsiPortRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceTable=scsiDeviceTable, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapTable=scsiLunMapTable, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, ScsiIdType=ScsiIdType, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapIndex=scsiLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuProductId=scsiLuProductId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiObjects=scsiObjects, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiNotifications=scsiNotifications, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortName=scsiTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup)
