...
Gauge32, Counter64, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, IpAddress, NotificationType, Integer32, Counter32, Unsigned32, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "Integer32", "Counter32", "Unsigned32", "mib-2", "Bits")
DisplayString, RowPointer, RowStatus, TextualConvention, TimeStamp, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "RowStatus", "TextualConvention", "TimeStamp", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapTable=scsiLunMapTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuVendorId=scsiLuVendorId, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatus=scsiLuStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdType=scsiDscLunIdType, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiPortIndex=scsiPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiConformance=scsiConformance, ScsiIdentifier=ScsiIdentifier, scsiLuIndex=scsiLuIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliances=scsiCompliances, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapEntry=scsiLunMapEntry, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiModule=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceResets=scsiDeviceResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiTranportOther=scsiTranportOther, scsiRemoteTarget=scsiRemoteTarget, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuInResets=scsiLuInResets, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceGroup=scsiDeviceGroup, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtName=scsiDscTgtName, scsiLuIdValue=scsiLuIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
