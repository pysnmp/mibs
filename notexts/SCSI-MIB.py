...
NotificationType, Bits, Unsigned32, MibIdentifier, IpAddress, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Counter32, Gauge32, ModuleIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "iso", "Integer32")
TimeStamp, AutonomousType, RowStatus, DisplayString, RowPointer, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowStatus", "DisplayString", "RowPointer", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGroups=scsiGroups, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceAlias=scsiDeviceAlias, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdEntry=scsiLuIdEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunLun=scsiDscLunLun, scsiInstAlias=scsiInstAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotifications=scsiNotifications, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiLuIdValue=scsiLuIdValue, scsiLuState=scsiLuState, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdentifier=ScsiIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdType=scsiLuIdType, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiName=ScsiName, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdType=scsiDscLunIdType, scsiCompliance=scsiCompliance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue, ScsiIdType=ScsiIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiLuInCommands=scsiLuInCommands, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiator=scsiInitiator, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLuProductId=scsiLuProductId, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliances=scsiCompliances, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable)
