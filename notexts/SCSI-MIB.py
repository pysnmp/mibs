...
iso, MibIdentifier, Bits, Counter32, Counter64, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, mib_2, Gauge32, Unsigned32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Bits", "Counter32", "Counter64", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "mib-2", "Gauge32", "Unsigned32", "NotificationType", "TimeTicks")
TimeStamp, RowStatus, TruthValue, DisplayString, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "DisplayString", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiLuTable=scsiLuTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuEntry=scsiLuEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiInstAlias=scsiInstAlias, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdType=scsiLuIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiator=scsiInitiator, scsiCompliances=scsiCompliances, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuInResets=scsiLuInResets, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapTable=scsiLunMapTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetGroup=scsiTargetGroup, scsiDeviceTable=scsiDeviceTable, scsiTranportOther=scsiTranportOther, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiGeneral=scsiGeneral, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunLun=scsiDscLunLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiCompliance=scsiCompliance, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdValue=ScsiIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortEntry=scsiPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiModule=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiObjects=scsiObjects, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuProductId=scsiLuProductId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSBP=scsiTransportSBP, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstIndex=scsiInstIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIndex=scsiLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptEntry=scsiTrnsptEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatus=scsiLuStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTable=scsiIntrDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
