...
Counter32, mib_2, Bits, IpAddress, ObjectIdentity, iso, Unsigned32, TimeTicks, NotificationType, Integer32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "Bits", "IpAddress", "ObjectIdentity", "iso", "Unsigned32", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
TruthValue, AutonomousType, RowStatus, DisplayString, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapEntry=scsiLunMapEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiPortTable=scsiPortTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtName=scsiDscTgtName, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdEntry=scsiLuIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiTgtDevTable=scsiTgtDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuTable=scsiLuTable, scsiTranportSPI=scsiTranportSPI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstAlias=scsiInstAlias, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, scsiGroups=scsiGroups, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliances=scsiCompliances, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTranportOther=scsiTranportOther, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, ScsiIdentifier=ScsiIdentifier, scsiDscLunTable=scsiDscLunTable, scsiLuIdType=scsiLuIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, ScsiName=ScsiName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptType=scsiTrnsptType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiInstanceTable=scsiInstanceTable, scsiLuState=scsiLuState, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiModule=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup)
