...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Bits, ModuleIdentity, IpAddress, TimeTicks, ObjectIdentity, Unsigned32, Counter32, Gauge32, Integer32, NotificationType, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Bits", "ModuleIdentity", "IpAddress", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "Integer32", "NotificationType", "MibIdentifier", "mib-2")
TimeStamp, AutonomousType, TextualConvention, DisplayString, RowPointer, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuEntry=scsiLuEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTarget=scsiTarget, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliance=scsiCompliance, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiName=ScsiName, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdIndex=scsiLuIdIndex, scsiPortRole=scsiPortRole, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdValue=ScsiIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceTable=scsiInstanceTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGroups=scsiGroups, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiConformance=scsiConformance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInResets=scsiLuInResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdEntry=scsiLuIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceTable=scsiDeviceTable, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiDscLunTable=scsiDscLunTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuStatusChanged=scsiLuStatusChanged, scsiModule=scsiModule, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiInitiator=scsiInitiator, scsiLuWwnName=scsiLuWwnName, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatus=scsiLuStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLuVendorId=scsiLuVendorId, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIndex=scsiDscLunIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
