...
iso, Unsigned32, Integer32, Counter32, IpAddress, Counter64, ModuleIdentity, mib_2, TimeTicks, ObjectIdentity, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Integer32", "Counter32", "IpAddress", "Counter64", "ModuleIdentity", "mib-2", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
RowStatus, AutonomousType, TimeStamp, TextualConvention, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TimeStamp", "TextualConvention", "RowPointer", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiConformance=scsiConformance, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, scsiLuIdType=scsiLuIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuEntry=scsiLuEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLun=scsiLunMapLun, scsiPortEntry=scsiPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdValue=ScsiIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiTransportTypes=scsiTransportTypes, scsiLunMapEntry=scsiLunMapEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuTable=scsiLuTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiModule=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiObjects=scsiObjects, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiTranportSPI=scsiTranportSPI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevEntry=scsiIntrDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliance=scsiCompliance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInResets=scsiLuInResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdValue=scsiLuIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiDeviceRole=scsiDeviceRole, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiGroups=scsiGroups, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiLuState=scsiLuState, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGeneral=scsiGeneral, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstAlias=scsiInstAlias, ScsiIdType=ScsiIdType, PYSNMP_MODULE_ID=scsiModule, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdAssociation=scsiLuIdAssociation)
