...
Bits, Counter32, ModuleIdentity, TimeTicks, ObjectIdentity, mib_2, IpAddress, MibIdentifier, Gauge32, Unsigned32, Counter64, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "mib-2", "IpAddress", "MibIdentifier", "Gauge32", "Unsigned32", "Counter64", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TextualConvention, RowStatus, TimeStamp, AutonomousType, DisplayString, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdType=ScsiIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortIndex=scsiPortIndex, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtName=scsiDscTgtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiLuStatus=scsiLuStatus, scsiTrnsptTable=scsiTrnsptTable, scsiPortTable=scsiPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortName=scsiTgtPortName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunLun=scsiDscLunLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdEntry=scsiLuIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValue=ScsiIndexValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiObjects=scsiObjects, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiGroups=scsiGroups, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstIndex=scsiInstIndex, scsiNotifications=scsiNotifications, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortEntry=scsiPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIndex=scsiLuIndex, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuHSInCommands=scsiLuHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier)
