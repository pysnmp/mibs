...
ModuleIdentity, Counter32, Unsigned32, iso, Counter64, TimeTicks, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Bits, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Bits", "mib-2", "NotificationType")
TimeStamp, DisplayString, RowStatus, RowPointer, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiLuRevisionId=scsiLuRevisionId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, ScsiName=ScsiName, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, scsiTarget=scsiTarget, scsiLuIdIndex=scsiLuIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortRole=scsiPortRole, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapTable=scsiLunMapTable, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportFCP=scsiTransportFCP, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotifications=scsiNotifications, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiGeneral=scsiGeneral, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdType=scsiLuIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuState=scsiLuState, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiGroups=scsiGroups, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiLuInResets=scsiLuInResets, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiObjects=scsiObjects, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportOther=scsiTranportOther, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiModule=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet)
