...
Bits, ObjectIdentity, mib_2, Gauge32, iso, MibIdentifier, TimeTicks, NotificationType, Unsigned32, Counter64, ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "mib-2", "Gauge32", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "Unsigned32", "Counter64", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
DisplayString, TruthValue, AutonomousType, RowStatus, TextualConvention, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "RowStatus", "TextualConvention", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportFCP=scsiTransportFCP, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortRole=scsiPortRole, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuEntry=scsiLuEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiDscLunTable=scsiDscLunTable, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiModule=scsiModule, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatus=scsiLuStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceAlias=scsiDeviceAlias, scsiInstIndex=scsiInstIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdValue=ScsiIdValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliance=scsiCompliance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiObjects=scsiObjects, scsiLuInCommands=scsiLuInCommands, scsiTranportSPI=scsiTranportSPI, scsiNotifications=scsiNotifications, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportOther=scsiTranportOther, scsiGeneral=scsiGeneral, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceTable=scsiDeviceTable, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTarget=scsiTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiConformance=scsiConformance, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapTable=scsiLunMapTable, scsiTrnsptType=scsiTrnsptType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiTransportSRP=scsiTransportSRP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstAlias=scsiInstAlias, ScsiIndexValue=ScsiIndexValue, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetGroup=scsiTargetGroup, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex)
