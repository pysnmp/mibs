...
TimeTicks, Counter32, iso, Integer32, Bits, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, IpAddress, Unsigned32, MibIdentifier, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "iso", "Integer32", "Bits", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "IpAddress", "Unsigned32", "MibIdentifier", "ModuleIdentity", "mib-2")
TextualConvention, AutonomousType, RowStatus, RowPointer, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowStatus", "RowPointer", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuInResets=scsiLuInResets, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuEntry=scsiLuEntry, scsiTrnsptType=scsiTrnsptType, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportOther=scsiTranportOther, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiModule=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapEntry=scsiLunMapEntry, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotifications=scsiNotifications, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapTable=scsiLunMapTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiDeviceResets=scsiDeviceResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceRole=scsiDeviceRole, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIndex=scsiDscLunIndex, scsiTransportISCSI=scsiTransportISCSI, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiInstIndex=scsiInstIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiLuStatus=scsiLuStatus, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiLuState=scsiLuState, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunTable=scsiDscLunTable, scsiCompliance=scsiCompliance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered)
