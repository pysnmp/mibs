...
Counter32, ModuleIdentity, NotificationType, IpAddress, TimeTicks, MibIdentifier, Integer32, Bits, iso, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "iso", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "mib-2")
RowStatus, TruthValue, RowPointer, TimeStamp, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportSRP=scsiTransportSRP, scsiLuStatus=scsiLuStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiName=ScsiName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportOther=scsiTranportOther, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapTable=scsiLunMapTable, ScsiIdValue=ScsiIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTarget=scsiTarget, scsiTgtPortName=scsiTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportSPI=scsiTranportSPI, scsiInstAlias=scsiInstAlias, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiTargetGroup=scsiTargetGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, PYSNMP_MODULE_ID=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSBP=scsiTransportSBP, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiModule=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuEntry=scsiLuEntry, scsiInstanceEntry=scsiInstanceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportTypes=scsiTransportTypes, scsiLuProductId=scsiLuProductId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGroups=scsiGroups, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuState=scsiLuState, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdValue=scsiDscLunIdValue)
