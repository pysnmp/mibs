...
Bits, Integer32, ModuleIdentity, Unsigned32, Counter32, NotificationType, MibIdentifier, iso, TimeTicks, Gauge32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ModuleIdentity", "Unsigned32", "Counter32", "NotificationType", "MibIdentifier", "iso", "TimeTicks", "Gauge32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress")
TruthValue, RowPointer, TextualConvention, RowStatus, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiTarget=scsiTarget, scsiLunMapTable=scsiLunMapTable, scsiLuIdType=scsiLuIdType, scsiTransportFCP=scsiTransportFCP, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdValue=ScsiIdValue, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValue=ScsiIndexValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstAlias=scsiInstAlias, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGeneral=scsiGeneral, scsiConformance=scsiConformance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortEntry=scsiPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLuWwnName=scsiLuWwnName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortRole=scsiPortRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiInitiator=scsiInitiator, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, scsiDeviceRole=scsiDeviceRole, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiDscLunTable=scsiDscLunTable, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiObjects=scsiObjects, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiGroups=scsiGroups, scsiTgtPortTable=scsiTgtPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiInstanceEntry=scsiInstanceEntry, scsiLuIndex=scsiLuIndex, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliances=scsiCompliances, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiNotifications=scsiNotifications, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
