...
Bits, mib_2, IpAddress, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Gauge32, iso, Counter32, ObjectIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "IpAddress", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Gauge32", "iso", "Counter32", "ObjectIdentity", "Unsigned32", "NotificationType")
RowPointer, TextualConvention, RowStatus, DisplayString, AutonomousType, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValue=ScsiIndexValue, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuInCommands=scsiLuInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTranportOther=scsiTranportOther, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdEntry=scsiLuIdEntry, scsiCompliance=scsiCompliance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstAlias=scsiInstAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiLuStatus=scsiLuStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortRole=scsiPortRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdentifier=ScsiIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiGeneral=scsiGeneral, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuState=scsiLuState, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGroups=scsiGroups, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiLuProductId=scsiLuProductId, scsiLuVendorId=scsiLuVendorId, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportFCP=scsiTransportFCP, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, scsiTrnsptTable=scsiTrnsptTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier)
