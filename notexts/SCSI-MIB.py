...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, Unsigned32, TimeTicks, MibIdentifier, Counter64, mib_2, iso, ObjectIdentity, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter64", "mib-2", "iso", "ObjectIdentity", "Bits", "IpAddress", "NotificationType")
DisplayString, RowStatus, TruthValue, AutonomousType, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TruthValue", "AutonomousType", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceGroup=scsiDeviceGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, scsiLuEntry=scsiLuEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdValue=scsiLuIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, scsiPortRole=scsiPortRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiAuthIntrName=scsiAuthIntrName, scsiLuState=scsiLuState, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevTable=scsiTgtDevTable, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapEntry=scsiLunMapEntry, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliance=scsiCompliance, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuProductId=scsiLuProductId, scsiLuIdEntry=scsiLuIdEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdValue=ScsiIdValue, scsiLunMapLun=scsiLunMapLun, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiPortIndex=scsiPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIndex=scsiLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, PYSNMP_MODULE_ID=scsiModule, scsiPortEntry=scsiPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdType=scsiLuIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetGroup=scsiTargetGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiName=ScsiName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex)
