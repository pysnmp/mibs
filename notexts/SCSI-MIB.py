...
Unsigned32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, MibIdentifier, NotificationType, Bits, iso, ObjectIdentity, IpAddress, Gauge32, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "MibIdentifier", "NotificationType", "Bits", "iso", "ObjectIdentity", "IpAddress", "Gauge32", "Integer32", "Counter32")
AutonomousType, TextualConvention, TruthValue, DisplayString, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiDeviceTable=scsiDeviceTable, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdType=ScsiIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliances=scsiCompliances, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiConformance=scsiConformance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuState=scsiLuState, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunTable=scsiDscLunTable, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportTypes=scsiTransportTypes, scsiModule=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetGroup=scsiTargetGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, scsiLuIdIndex=scsiLuIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiName=ScsiName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiInstIndex=scsiInstIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunIndex=scsiDscLunIndex)
