...
Counter32, iso, NotificationType, Counter64, mib_2, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, IpAddress, TimeTicks, Bits, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "NotificationType", "Counter64", "mib-2", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "IpAddress", "TimeTicks", "Bits", "ModuleIdentity", "MibIdentifier")
TruthValue, RowStatus, DisplayString, RowPointer, TimeStamp, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "RowPointer", "TimeStamp", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportTypes=scsiTransportTypes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTarget=scsiTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, PYSNMP_MODULE_ID=scsiModule, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiObjects=scsiObjects, scsiNotifications=scsiNotifications, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiName=ScsiName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatus=scsiLuStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdTable=scsiLuIdTable, ScsiIdValue=ScsiIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceTable=scsiDeviceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdType=ScsiIdType, ScsiIdentifier=ScsiIdentifier, scsiGroups=scsiGroups, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuProductId=scsiLuProductId, scsiDeviceGroup=scsiDeviceGroup, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiator=scsiInitiator, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapTable=scsiLunMapTable, scsiDeviceResets=scsiDeviceResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiLuVendorId=scsiLuVendorId, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortRole=scsiPortRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion)
