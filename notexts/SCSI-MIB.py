...
Gauge32, Counter32, NotificationType, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64, Unsigned32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "NotificationType", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64", "Unsigned32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "TimeTicks")
RowStatus, TruthValue, TimeStamp, DisplayString, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "DisplayString", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSBP=scsiTransportSBP, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiConformance=scsiConformance, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetGroup=scsiTargetGroup, ScsiIndexValue=ScsiIndexValue, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuState=scsiLuState, scsiDeviceResets=scsiDeviceResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiInstAlias=scsiInstAlias, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, ScsiName=ScsiName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiInstIndex=scsiInstIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliances=scsiCompliances, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuEntry=scsiLuEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdTable=scsiLuIdTable, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLuProductId=scsiLuProductId, scsiDeviceGroup=scsiDeviceGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdType=ScsiIdType, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtName=scsiDscTgtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortIndex=scsiPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportFCP=scsiTransportFCP, scsiLuInCommands=scsiLuInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiRemoteTarget=scsiRemoteTarget)
