...
Unsigned32, TimeTicks, Bits, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Integer32, IpAddress, iso, MibIdentifier, mib_2, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Bits", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Integer32", "IpAddress", "iso", "MibIdentifier", "mib-2", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuTable=scsiLuTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiModule=scsiModule, scsiObjects=scsiObjects, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatus=scsiLuStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstAlias=scsiInstAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceRole=scsiDeviceRole, scsiConformance=scsiConformance, scsiInstanceTable=scsiInstanceTable, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiGroups=scsiGroups, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiPortIndex=scsiPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, scsiLuInCommands=scsiLuInCommands, scsiNotifications=scsiNotifications, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdentifier=ScsiIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWwnName=scsiLuWwnName, scsiTransportTypes=scsiTransportTypes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTable=scsiPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdValue=scsiLuIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliance=scsiCompliance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportSPI=scsiTranportSPI, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTable=scsiIntrDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliances=scsiCompliances, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstIndex=scsiInstIndex, scsiDeviceGroup=scsiDeviceGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapGroup=scsiLunMapGroup, scsiPortRole=scsiPortRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiName=ScsiName, scsiTransportSRP=scsiTransportSRP, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup)
