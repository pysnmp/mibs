...
TimeTicks, Gauge32, Integer32, Unsigned32, iso, ModuleIdentity, IpAddress, NotificationType, Counter64, Bits, ObjectIdentity, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Integer32", "Unsigned32", "iso", "ModuleIdentity", "IpAddress", "NotificationType", "Counter64", "Bits", "ObjectIdentity", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
DisplayString, AutonomousType, RowPointer, TruthValue, TimeStamp, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiObjects=scsiObjects, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiInitiator=scsiInitiator, scsiLuEntry=scsiLuEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapTable=scsiLunMapTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, PYSNMP_MODULE_ID=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortName=scsiTgtPortName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdValue=scsiLuIdValue, scsiLuIndex=scsiLuIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtName=scsiDscTgtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiLuHSInCommands=scsiLuHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstIndex=scsiInstIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiDeviceResets=scsiDeviceResets, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiCompliance=scsiCompliance, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdentifier=ScsiIdentifier, scsiPortIndex=scsiPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTable=scsiPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiConformance=scsiConformance, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiTranportOther=scsiTranportOther, scsiTgtDevTable=scsiTgtDevTable)
