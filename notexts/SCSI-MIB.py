...
Bits, NotificationType, Counter64, mib_2, Gauge32, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter32, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter64", "mib-2", "Gauge32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter32", "iso", "ModuleIdentity", "Integer32")
TextualConvention, TimeStamp, RowStatus, AutonomousType, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "AutonomousType", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortIndex=scsiPortIndex, scsiPortRole=scsiPortRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDeviceIndex=scsiDeviceIndex, scsiLuState=scsiLuState, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuEntry=scsiLuEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuRevisionId=scsiLuRevisionId, ScsiIdValue=ScsiIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTable=scsiPortTable, ScsiIdType=ScsiIdType, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapTable=scsiLunMapTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIndex=scsiDscLunIndex, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiNotifications=scsiNotifications, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiTgtPortName=scsiTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIndex=scsiLuIndex, scsiDeviceRole=scsiDeviceRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunTable=scsiDscLunTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuProductId=scsiLuProductId, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiObjects=scsiObjects, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdValue=scsiLuIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiCompliances=scsiCompliances, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInResets=scsiLuInResets, scsiGeneral=scsiGeneral, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiGroups=scsiGroups, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTranportOther=scsiTranportOther, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiModule=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus)
