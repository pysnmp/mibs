...
TimeTicks, ObjectIdentity, mib_2, Bits, Counter64, IpAddress, NotificationType, Counter32, ModuleIdentity, iso, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "mib-2", "Bits", "Counter64", "IpAddress", "NotificationType", "Counter32", "ModuleIdentity", "iso", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32")
AutonomousType, DisplayString, TruthValue, TextualConvention, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TruthValue", "TextualConvention", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdValue=ScsiIdValue, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliances=scsiCompliances, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuVendorId=scsiLuVendorId, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiObjects=scsiObjects, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLogicalUnit=scsiLogicalUnit, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtName=scsiDscTgtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiInitiator=scsiInitiator, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInCommands=scsiLuInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiConformance=scsiConformance, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiCompliance=scsiCompliance, ScsiIndexValue=ScsiIndexValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatus=scsiLuStatus, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGeneral=scsiGeneral, scsiNotifications=scsiNotifications, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevTable=scsiTgtDevTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdTable=scsiLuIdTable, scsiLuIdType=scsiLuIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiModule=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstAlias=scsiInstAlias, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInResets=scsiLuInResets, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiGroups=scsiGroups, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuState=scsiLuState, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtId=scsiAttIntrPrtId)
