...
Integer32, Counter64, IpAddress, Gauge32, ModuleIdentity, mib_2, Bits, MibIdentifier, Counter32, TimeTicks, ObjectIdentity, iso, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "IpAddress", "Gauge32", "ModuleIdentity", "mib-2", "Bits", "MibIdentifier", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, TimeStamp, RowPointer, RowStatus, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowPointer", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportOther=scsiTranportOther, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuVendorId=scsiLuVendorId, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportFCP=scsiTransportFCP, scsiInstAlias=scsiInstAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, ScsiIdType=ScsiIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtName=scsiDscTgtName, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiModule=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiTransportTypes=scsiTransportTypes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiConformance=scsiConformance, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdentifier=ScsiIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuState=scsiLuState, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuProductId=scsiLuProductId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiGroups=scsiGroups, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortEntry=scsiPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiName=ScsiName, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTarget=scsiTarget, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceTable=scsiInstanceTable, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiCompliances=scsiCompliances, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiPortRole=scsiPortRole, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable)
