...
ObjectIdentity, Gauge32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, Counter32, MibIdentifier, iso, Integer32, TimeTicks, Bits, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "Counter32", "MibIdentifier", "iso", "Integer32", "TimeTicks", "Bits", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportOther=scsiTranportOther, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliances=scsiCompliances, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInResets=scsiLuInResets, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiObjects=scsiObjects, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceTable=scsiInstanceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiConformance=scsiConformance, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, ScsiName=ScsiName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortEntry=scsiPortEntry, scsiLuIdType=scsiLuIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliance=scsiCompliance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiLuStatus=scsiLuStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdType=ScsiIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuProductId=scsiLuProductId, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGeneral=scsiGeneral, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortRole=scsiPortRole, scsiLuIdTable=scsiLuIdTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiTarget=scsiTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortInCommands=scsiTgtPortInCommands)
