...
NotificationType, mib_2, Unsigned32, iso, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, TimeTicks, Bits, MibIdentifier, Counter64, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Unsigned32", "iso", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "IpAddress")
RowPointer, DisplayString, RowStatus, TextualConvention, AutonomousType, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuVendorId=scsiLuVendorId, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortRole=scsiPortRole, scsiInstAlias=scsiInstAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIndex=scsiDscLunIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, ScsiName=ScsiName, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptType=scsiTrnsptType, scsiModule=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuTable=scsiLuTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiObjects=scsiObjects, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceGroup=scsiDeviceGroup, ScsiIdentifier=ScsiIdentifier, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdValue=scsiLuIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiNotifications=scsiNotifications, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGroups=scsiGroups, scsiIntrDevTable=scsiIntrDevTable, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstIndex=scsiInstIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiLuStatus=scsiLuStatus, scsiTransportFCP=scsiTransportFCP, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuState=scsiLuState, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTarget=scsiTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtName=scsiDscTgtName, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable)
