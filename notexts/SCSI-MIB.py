...
ObjectIdentity, Integer32, mib_2, TimeTicks, MibIdentifier, Bits, NotificationType, Unsigned32, iso, Gauge32, Counter32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "mib-2", "TimeTicks", "MibIdentifier", "Bits", "NotificationType", "Unsigned32", "iso", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
TextualConvention, TimeStamp, DisplayString, TruthValue, RowPointer, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowPointer", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSBP=scsiTransportSBP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceRole=scsiDeviceRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapEntry=scsiLunMapEntry, ScsiName=ScsiName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiPortRole=scsiPortRole, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiCompliance=scsiCompliance, scsiLuEntry=scsiLuEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotifications=scsiNotifications, scsiDscLunTable=scsiDscLunTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIndexValue=ScsiIndexValue, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportOther=scsiTranportOther, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatus=scsiLuStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdType=scsiLuIdType, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGeneral=scsiGeneral, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiInitiator=scsiInitiator, scsiPortTable=scsiPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiInstAlias=scsiInstAlias, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, ScsiIdentifier=ScsiIdentifier, scsiLuTable=scsiLuTable, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetGroup=scsiTargetGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiInstanceEntry=scsiInstanceEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteTarget=scsiRemoteTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortIndex=scsiPortIndex, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiGroups=scsiGroups, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, PYSNMP_MODULE_ID=scsiModule, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex)
