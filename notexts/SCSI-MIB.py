...
ObjectIdentity, Unsigned32, ModuleIdentity, NotificationType, MibIdentifier, Counter32, Counter64, iso, TimeTicks, IpAddress, Gauge32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "iso", "TimeTicks", "IpAddress", "Gauge32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
RowPointer, TimeStamp, AutonomousType, DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortEntry=scsiPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiLuProductId=scsiLuProductId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTranportOther=scsiTranportOther, ScsiIdValue=ScsiIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunLun=scsiDscLunLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceResets=scsiDeviceResets, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdType=ScsiIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiDeviceAlias=scsiDeviceAlias, scsiCompliance=scsiCompliance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiConformance=scsiConformance, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiModule=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevEntry=scsiIntrDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdType=scsiLuIdType, scsiInstIndex=scsiInstIndex, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportTypes=scsiTransportTypes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero)
