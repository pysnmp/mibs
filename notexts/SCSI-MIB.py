...
IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, MibIdentifier, NotificationType, ObjectIdentity, Bits, Integer32, Counter64, Unsigned32, Gauge32, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Bits", "Integer32", "Counter64", "Unsigned32", "Gauge32", "mib-2", "TimeTicks")
TimeStamp, RowPointer, DisplayString, RowStatus, TruthValue, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "TruthValue", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiDscTgtName=scsiDscTgtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceRole=scsiDeviceRole, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiInstIndex=scsiInstIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTable=scsiPortTable, ScsiIdValue=ScsiIdValue, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceTable=scsiDeviceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTarget=scsiTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdType=scsiLuIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportSPI=scsiTranportSPI, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiLuEntry=scsiLuEntry, scsiLuInResets=scsiLuInResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotifications=scsiNotifications, ScsiIdType=ScsiIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiConformance=scsiConformance, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTranportOther=scsiTranportOther, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapTable=scsiLunMapTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuVendorId=scsiLuVendorId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGeneral=scsiGeneral, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuTable=scsiLuTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuState=scsiLuState, scsiLuInCommands=scsiLuInCommands, scsiObjects=scsiObjects, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiRemoteTarget=scsiRemoteTarget, scsiInitiator=scsiInitiator, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators)
