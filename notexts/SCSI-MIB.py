...
Counter32, mib_2, TimeTicks, ModuleIdentity, Unsigned32, Gauge32, NotificationType, iso, ObjectIdentity, IpAddress, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "TimeTicks", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
DisplayString, TruthValue, AutonomousType, TextualConvention, RowPointer, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "TextualConvention", "RowPointer", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstAlias=scsiInstAlias, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptType=scsiTrnsptType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiCompliance=scsiCompliance, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatus=scsiLuStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInResets=scsiLuInResets, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiInstIndex=scsiInstIndex, scsiTransportTypes=scsiTransportTypes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiDeviceRole=scsiDeviceRole, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunTable=scsiDscLunTable, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdType=scsiLuIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuProductId=scsiLuProductId, scsiGeneral=scsiGeneral, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiName=ScsiName, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortName=scsiTgtPortName, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiLuState=scsiLuState, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTarget=scsiTarget, scsiInitiator=scsiInitiator, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiPortIndex=scsiPortIndex, scsiLunMapLun=scsiLunMapLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiTgtDevTable=scsiTgtDevTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuHSInCommands=scsiLuHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable)
