...
NotificationType, Gauge32, mib_2, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, Counter64, Counter32, Integer32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "mib-2", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "Counter64", "Counter32", "Integer32", "TimeTicks", "iso")
DisplayString, TextualConvention, RowStatus, TimeStamp, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptEntry=scsiTrnsptEntry, scsiLuTable=scsiLuTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiModule=scsiModule, scsiLuEntry=scsiLuEntry, scsiConformance=scsiConformance, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportISCSI=scsiTransportISCSI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTable=scsiPortTable, scsiDscLunTable=scsiDscLunTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInResets=scsiLuInResets, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptType=scsiTrnsptType, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiLuState=scsiLuState, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValue=ScsiIndexValue, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdValue=scsiLuIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdType=scsiLuIdType, ScsiIdValue=ScsiIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiDeviceResets=scsiDeviceResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscTgtName=scsiDscTgtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiName=ScsiName, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapTable=scsiLunMapTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportSPI=scsiTranportSPI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiLunMapEntry=scsiLunMapEntry, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
