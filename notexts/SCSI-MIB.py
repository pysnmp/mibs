...
ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ObjectIdentity, MibIdentifier, Bits, Counter64, Integer32, mib_2, IpAddress, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "Integer32", "mib-2", "IpAddress", "iso", "TimeTicks", "Counter32")
RowPointer, AutonomousType, TextualConvention, TimeStamp, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiInstIndex=scsiInstIndex, scsiLuIdTable=scsiLuIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiLuProductId=scsiLuProductId, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, scsiTranportOther=scsiTranportOther, scsiPortEntry=scsiPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapTable=scsiLunMapTable, scsiLuStatus=scsiLuStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGroups=scsiGroups, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTable=scsiIntrDevTable, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLunMapLun=scsiLunMapLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiCompliance=scsiCompliance, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliances=scsiCompliances, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuState=scsiLuState, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdIndex=scsiLuIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptType=scsiTrnsptType, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTable=scsiPortTable, scsiObjects=scsiObjects, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotifications=scsiNotifications, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiModule=scsiModule, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiDscTgtName=scsiDscTgtName, scsiTransportFCP=scsiTransportFCP, scsiLuTable=scsiLuTable)
