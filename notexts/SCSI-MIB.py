...
Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, ObjectIdentity, Counter32, MibIdentifier, Unsigned32, NotificationType, mib_2, TimeTicks, Integer32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Counter32", "MibIdentifier", "Unsigned32", "NotificationType", "mib-2", "TimeTicks", "Integer32", "iso", "Counter64")
RowPointer, DisplayString, AutonomousType, RowStatus, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSBP=scsiTransportSBP, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInResets=scsiLuInResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortRole=scsiPortRole, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrName=scsiAuthIntrName, scsiNotifications=scsiNotifications, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscLunLun=scsiDscLunLun, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiPortEntry=scsiPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiCompliances=scsiCompliances, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuEntry=scsiLuEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiInitiator=scsiInitiator, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportFCP=scsiTransportFCP, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuTable=scsiLuTable, scsiDeviceAlias=scsiDeviceAlias, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdType=ScsiIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTable=scsiPortTable, scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceResets=scsiDeviceResets, scsiObjects=scsiObjects, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiModule=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTranportOther=scsiTranportOther, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceTable=scsiDeviceTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIndex=scsiLuIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiInstAlias=scsiInstAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
