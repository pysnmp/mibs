...
Integer32, Gauge32, Counter64, TimeTicks, ObjectIdentity, NotificationType, ModuleIdentity, Bits, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "TimeTicks", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Bits", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter32", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceResets=scsiDeviceResets, scsiLuIdValue=scsiLuIdValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtName=scsiIntrPrtName, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstVendorVersion=scsiInstVendorVersion, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiLuIndex=scsiLuIndex, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiName=ScsiName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuState=scsiLuState, scsiCompliance=scsiCompliance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortTable=scsiPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiObjects=scsiObjects, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortRole=scsiPortRole, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortEntry=scsiPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuVendorId=scsiLuVendorId, scsiLuWwnName=scsiLuWwnName, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiPortIndex=scsiPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSRP=scsiTransportSRP, scsiDscLunEntry=scsiDscLunEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotifications=scsiNotifications, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiGroups=scsiGroups, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiTarget=scsiTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstAlias=scsiInstAlias, scsiInstIndex=scsiInstIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiGeneral=scsiGeneral, scsiTranportSPI=scsiTranportSPI, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup)
