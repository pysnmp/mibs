...
MibIdentifier, Bits, NotificationType, Counter64, mib_2, TimeTicks, ObjectIdentity, ModuleIdentity, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "Counter64", "mib-2", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Unsigned32", "Counter32")
RowPointer, DisplayString, TruthValue, TimeStamp, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiLuIndex=scsiLuIndex, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstAlias=scsiInstAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiGroups=scsiGroups, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiCompliances=scsiCompliances, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceAlias=scsiDeviceAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiObjects=scsiObjects, scsiLuIdValue=scsiLuIdValue, ScsiIdentifier=ScsiIdentifier, scsiPortTable=scsiPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtName=scsiDscTgtName, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiLuVendorId=scsiLuVendorId, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiTranportSPI=scsiTranportSPI, scsiLuWwnName=scsiLuWwnName, ScsiIndexValue=ScsiIndexValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiTgtPortTable=scsiTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdEntry=scsiLuIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotifications=scsiNotifications, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuTable=scsiLuTable, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceTable=scsiDeviceTable, scsiTrnsptType=scsiTrnsptType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiName=ScsiName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortIndex=scsiPortIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiConformance=scsiConformance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiModule=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGeneral=scsiGeneral, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuProductId=scsiLuProductId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSRP=scsiTransportSRP, scsiLuIdIndex=scsiLuIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiLuRevisionId=scsiLuRevisionId, scsiLogicalUnit=scsiLogicalUnit, scsiTransportTypes=scsiTransportTypes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands)
