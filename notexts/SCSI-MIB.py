...
Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ObjectIdentity, IpAddress, NotificationType, mib_2, Gauge32, iso, ModuleIdentity, Unsigned32, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ObjectIdentity", "IpAddress", "NotificationType", "mib-2", "Gauge32", "iso", "ModuleIdentity", "Unsigned32", "Counter32", "MibIdentifier")
DisplayString, RowStatus, TimeStamp, TruthValue, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortIndex=scsiPortIndex, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapTable=scsiLunMapTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiGroups=scsiGroups, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdType=scsiLuIdType, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdValue=ScsiIdValue, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiTarget=scsiTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunLun=scsiDscLunLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGeneral=scsiGeneral, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtName=scsiIntrPrtName, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry, ScsiIdentifier=ScsiIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuState=scsiLuState, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiLuDefaultLun=scsiLuDefaultLun, PYSNMP_MODULE_ID=scsiModule, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTranportSPI=scsiTranportSPI, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiObjects=scsiObjects, scsiTransportISCSI=scsiTransportISCSI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiModule=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuProductId=scsiLuProductId, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIndex=scsiDscTgtIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatus=scsiLuStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable)
