...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, Unsigned32, TimeTicks, NotificationType, iso, IpAddress, MibIdentifier, Counter64, Gauge32, ModuleIdentity, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "Unsigned32", "TimeTicks", "NotificationType", "iso", "IpAddress", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "Bits", "Counter32")
AutonomousType, RowPointer, TextualConvention, TimeStamp, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiObjects=scsiObjects, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtName=scsiDscTgtName, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstIndex=scsiInstIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceAlias=scsiDeviceAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiGroups=scsiGroups, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotifications=scsiNotifications, scsiTrnsptTable=scsiTrnsptTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatus=scsiLuStatus, scsiTargetGroup=scsiTargetGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuEntry=scsiLuEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiConformance=scsiConformance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTransportSBP=scsiTransportSBP, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunLun=scsiDscLunLun, scsiTranportSPI=scsiTranportSPI, scsiCompliance=scsiCompliance, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptType=scsiTrnsptType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTable=scsiPortTable, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSRP=scsiTransportSRP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliances=scsiCompliances, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdType=ScsiIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiator=scsiInitiator, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortIndex=scsiPortIndex, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdType=scsiLuIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdValue=scsiLuIdValue, scsiPortEntry=scsiPortEntry, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportFCP=scsiTransportFCP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
