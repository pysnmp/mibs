...
MibIdentifier, NotificationType, Bits, mib_2, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, iso, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Bits", "mib-2", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "iso", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64")
TimeStamp, TruthValue, DisplayString, TextualConvention, RowPointer, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "RowPointer", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdType=scsiLuIdType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstIndex=scsiInstIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunLun=scsiDscLunLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceGroup=scsiDeviceGroup, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTarget=scsiTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiLuEntry=scsiLuEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiCompliances=scsiCompliances, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortEntry=scsiPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, PYSNMP_MODULE_ID=scsiModule, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceResets=scsiDeviceResets, ScsiIndexValue=ScsiIndexValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportFCP=scsiTransportFCP, scsiInstAlias=scsiInstAlias, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiName=ScsiName, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceTable=scsiDeviceTable, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIndex=scsiDscLunIndex, scsiLuTable=scsiLuTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortIndex=scsiPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptType=scsiTrnsptType, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTable=scsiIntrDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortName=scsiTgtPortName)
