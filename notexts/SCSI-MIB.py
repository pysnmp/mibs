...
ModuleIdentity, Bits, Gauge32, TimeTicks, MibIdentifier, NotificationType, Counter32, Unsigned32, iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "Integer32")
TimeStamp, RowPointer, AutonomousType, DisplayString, TruthValue, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "TruthValue", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiRemoteTarget=scsiRemoteTarget, scsiLuIndex=scsiLuIndex, scsiLunMapTable=scsiLunMapTable, scsiLuState=scsiLuState, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTransportFCP=scsiTransportFCP, scsiDeviceIndex=scsiDeviceIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTarget=scsiTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdValue=ScsiIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiLuInCommands=scsiLuInCommands, scsiLunMapLun=scsiLunMapLun, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiTransportSRP=scsiTransportSRP, scsiPortEntry=scsiPortEntry, scsiTransportISCSI=scsiTransportISCSI, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdType=ScsiIdType, scsiGroups=scsiGroups, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliance=scsiCompliance, scsiInstIndex=scsiInstIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiator=scsiInitiator, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliances=scsiCompliances, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuWwnName=scsiLuWwnName, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiModule=scsiModule, scsiPortTable=scsiPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiDscTgtName=scsiDscTgtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptType=scsiTrnsptType, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptTable=scsiTrnsptTable)
