...
iso, Bits, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, TimeTicks, ModuleIdentity, Integer32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "TimeTicks", "ModuleIdentity", "Integer32", "NotificationType", "Counter32")
TextualConvention, TruthValue, TimeStamp, RowPointer, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "RowPointer", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiTgtPortName=scsiTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiInstAlias=scsiInstAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGroups=scsiGroups, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceRole=scsiDeviceRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptType=scsiTrnsptType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstIndex=scsiInstIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiConformance=scsiConformance, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiGeneral=scsiGeneral, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTable=scsiPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuState=scsiLuState, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdValue=scsiLuIdValue, scsiLuIdTable=scsiLuIdTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiName=ScsiName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiTranportSPI=scsiTranportSPI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportOther=scsiTranportOther, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportISCSI=scsiTransportISCSI, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, ScsiIdValue=ScsiIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTarget=scsiTarget, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiModule=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands)
