...
Counter32, Counter64, mib_2, Unsigned32, ModuleIdentity, Gauge32, iso, ObjectIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "mib-2", "Unsigned32", "ModuleIdentity", "Gauge32", "iso", "ObjectIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "IpAddress")
AutonomousType, RowPointer, DisplayString, TextualConvention, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunTable=scsiDscLunTable, scsiTgtDevTable=scsiTgtDevTable, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiTranportOther=scsiTranportOther, scsiPortRole=scsiPortRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInResets=scsiLuInResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, ScsiName=ScsiName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuVendorId=scsiLuVendorId, scsiPortIndex=scsiPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdAssociation=scsiLuIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdType=scsiLuIdType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiTransportSBP=scsiTransportSBP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiPortTable=scsiPortTable, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWwnName=scsiLuWwnName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiObjects=scsiObjects, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstAlias=scsiInstAlias, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTarget=scsiTarget, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiTransportTypes=scsiTransportTypes, scsiInitiatorGroup=scsiInitiatorGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtName=scsiDscTgtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiModule=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdTable=scsiLuIdTable, scsiPortEntry=scsiPortEntry, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstIndex=scsiInstIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
