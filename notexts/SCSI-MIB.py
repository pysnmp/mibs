...
NotificationType, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, Counter64, TimeTicks, IpAddress, MibIdentifier, ModuleIdentity, Bits, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "Counter64", "TimeTicks", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceResets=scsiDeviceResets, scsiLuIdTable=scsiLuIdTable, scsiLunMapLun=scsiLunMapLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceRole=scsiDeviceRole, scsiPortEntry=scsiPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWwnName=scsiLuWwnName, scsiDscTgtName=scsiDscTgtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiLuStatus=scsiLuStatus, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevTable=scsiTgtDevTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGroups=scsiGroups, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiModule=scsiModule, scsiCompliances=scsiCompliances, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdType=ScsiIdType, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdCodeSet=ScsiIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapGroup=scsiLunMapGroup, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiCompliance=scsiCompliance, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceEntry=scsiInstanceEntry, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuProductId=scsiLuProductId, scsiTarget=scsiTarget, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstIndex=scsiInstIndex, scsiInitiator=scsiInitiator, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIndex=scsiDscTgtIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortIndex=scsiPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGeneral=scsiGeneral, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes)
