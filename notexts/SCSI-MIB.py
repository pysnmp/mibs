...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Bits, ObjectIdentity, MibIdentifier, Counter32, Counter64, Integer32, Gauge32, iso, NotificationType, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "Counter64", "Integer32", "Gauge32", "iso", "NotificationType", "mib-2", "Unsigned32")
AutonomousType, TextualConvention, DisplayString, TimeStamp, TruthValue, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInCommands=scsiLuInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIndexValue=ScsiIndexValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliances=scsiCompliances, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstIndex=scsiInstIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiLuIndex=scsiLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportSPI=scsiTranportSPI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSRP=scsiTransportSRP, ScsiIdentifier=ScsiIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, scsiPortRole=scsiPortRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiGroups=scsiGroups, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortIndex=scsiPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceTable=scsiDeviceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiTgtPortName=scsiTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWwnName=scsiLuWwnName, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtName=scsiIntrPrtName)
