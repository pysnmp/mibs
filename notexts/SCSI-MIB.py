...
ObjectIdentity, MibIdentifier, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Counter64, mib_2, Counter32, Bits, NotificationType, ModuleIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Counter64", "mib-2", "Counter32", "Bits", "NotificationType", "ModuleIdentity", "IpAddress", "Unsigned32")
AutonomousType, RowPointer, DisplayString, RowStatus, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "DisplayString", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapIndex=scsiLunMapIndex, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunLun=scsiDscLunLun, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapTable=scsiLunMapTable, scsiTrnsptDevName=scsiTrnsptDevName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtName=scsiDscTgtName, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiModule=scsiModule, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInCommands=scsiLuInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdType=ScsiIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortEntry=scsiPortEntry, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortRole=scsiPortRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdType=scsiDscLunIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuState=scsiLuState, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuVendorId=scsiLuVendorId, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortName=scsiAttTgtPortName)
