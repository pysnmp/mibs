...
mib_2, TimeTicks, MibIdentifier, ModuleIdentity, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, Gauge32, IpAddress, Counter32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "MibIdentifier", "ModuleIdentity", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "Gauge32", "IpAddress", "Counter32", "Integer32", "Counter64")
TimeStamp, AutonomousType, RowStatus, TextualConvention, DisplayString, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowStatus", "TextualConvention", "DisplayString", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceResets=scsiDeviceResets, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiModule=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliance=scsiCompliance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportOther=scsiTranportOther, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiGroups=scsiGroups, scsiInstAlias=scsiInstAlias, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInResets=scsiLuInResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdType=ScsiIdType, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiator=scsiInitiator, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiObjects=scsiObjects, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunEntry=scsiDscLunEntry, scsiPortEntry=scsiPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiGeneral=scsiGeneral, scsiInstIndex=scsiInstIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiTrnsptTable=scsiTrnsptTable, scsiTarget=scsiTarget, ScsiIdValue=ScsiIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortIndex=scsiPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevEntry=scsiIntrDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId)
