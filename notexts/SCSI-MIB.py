...
Gauge32, MibIdentifier, Integer32, NotificationType, Counter64, mib_2, Unsigned32, iso, Bits, TimeTicks, ObjectIdentity, IpAddress, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Integer32", "NotificationType", "Counter64", "mib-2", "Unsigned32", "iso", "Bits", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TimeStamp, DisplayString, RowPointer, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "RowPointer", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiConformance=scsiConformance, scsiLuIdIndex=scsiLuIdIndex, scsiTranportOther=scsiTranportOther, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdValue=ScsiIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortEntry=scsiPortEntry, scsiLuIdTable=scsiLuIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInCommands=scsiLuInCommands, scsiLuIdType=scsiLuIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteInitiators=scsiRemoteInitiators, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdValue=scsiLuIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiCompliance=scsiCompliance, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiGroups=scsiGroups, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTable=scsiIntrDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdEntry=scsiLuIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortName=scsiTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceTable=scsiDeviceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceResets=scsiDeviceResets, scsiTransportSBP=scsiTransportSBP, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortRole=scsiPortRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportFCP=scsiTransportFCP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiObjects=scsiObjects, scsiInstanceEntry=scsiInstanceEntry, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatus=scsiLuStatus, scsiLuIndex=scsiLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule)
