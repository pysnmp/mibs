...
Counter64, NotificationType, ModuleIdentity, mib_2, ObjectIdentity, iso, Unsigned32, IpAddress, Integer32, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "mib-2", "ObjectIdentity", "iso", "Unsigned32", "IpAddress", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32")
AutonomousType, TruthValue, TimeStamp, DisplayString, RowStatus, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TimeStamp", "DisplayString", "RowStatus", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdIndex=scsiLuIdIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuProductId=scsiLuProductId, scsiTrnsptType=scsiTrnsptType, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValue=ScsiIndexValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortName=scsiTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTransportTypes=scsiTransportTypes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevEntry=scsiTgtDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportSPI=scsiTranportSPI, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, ScsiName=ScsiName, scsiDeviceResets=scsiDeviceResets, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliance=scsiCompliance, scsiNotificationsPrefix=scsiNotificationsPrefix, PYSNMP_MODULE_ID=scsiModule, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiConformance=scsiConformance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstAlias=scsiInstAlias, ScsiIdType=ScsiIdType, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptIndex=scsiTrnsptIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuTable=scsiLuTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTable=scsiPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuState=scsiLuState, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, ScsiIdValue=ScsiIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiObjects=scsiObjects, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable)
