...
Integer32, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter32, iso, Unsigned32, Gauge32, NotificationType, Counter64, ObjectIdentity, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter32", "iso", "Unsigned32", "Gauge32", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "TimeTicks")
RowPointer, TextualConvention, AutonomousType, TimeStamp, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapGroup=scsiLunMapGroup, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdType=scsiLuIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceRole=scsiDeviceRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuStatus=scsiLuStatus, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuTable=scsiLuTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiPortIndex=scsiPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTarget=scsiTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTable=scsiPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiModule=scsiModule, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtName=scsiDscTgtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiObjects=scsiObjects, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuEntry=scsiLuEntry, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdType=ScsiIdType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortEntry=scsiTgtPortEntry, ScsiName=ScsiName, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdTable=scsiLuIdTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstIndex=scsiInstIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceIndex=scsiDeviceIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiLuInResets=scsiLuInResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiNotifications=scsiNotifications, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetGroup=scsiTargetGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiCompliances=scsiCompliances, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged)
