...
Counter64, iso, Bits, ModuleIdentity, MibIdentifier, NotificationType, Integer32, mib_2, TimeTicks, ObjectIdentity, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Bits", "ModuleIdentity", "MibIdentifier", "NotificationType", "Integer32", "mib-2", "TimeTicks", "ObjectIdentity", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
TextualConvention, TruthValue, DisplayString, TimeStamp, RowPointer, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "DisplayString", "TimeStamp", "RowPointer", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiObjects=scsiObjects, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiLuProductId=scsiLuProductId, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstIndex=scsiInstIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportFCP=scsiTransportFCP, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportISCSI=scsiTransportISCSI, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceRole=scsiDeviceRole, scsiLuIdType=scsiLuIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiConformance=scsiConformance, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLun=scsiLunMapLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptTable=scsiTrnsptTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiInstanceTable=scsiInstanceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdType=ScsiIdType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiator=scsiInitiator, scsiTgtPortEntry=scsiTgtPortEntry, scsiNotifications=scsiNotifications, scsiDscLunLun=scsiDscLunLun, scsiTarget=scsiTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstAlias=scsiInstAlias, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule)
