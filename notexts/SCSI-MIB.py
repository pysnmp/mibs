...
ModuleIdentity, Counter32, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, mib_2, MibIdentifier, Gauge32, ObjectIdentity, NotificationType, Unsigned32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "mib-2", "MibIdentifier", "Gauge32", "ObjectIdentity", "NotificationType", "Unsigned32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapTable=scsiLunMapTable, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiDscLunIndex=scsiDscLunIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstVendorVersion=scsiInstVendorVersion, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstAlias=scsiInstAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, scsiIntrPrtName=scsiIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGeneral=scsiGeneral, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunLun=scsiDscLunLun, scsiInitiator=scsiInitiator, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuEntry=scsiLuEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuTable=scsiLuTable, scsiPortRole=scsiPortRole, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiModule=scsiModule, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIndex=scsiLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiName=ScsiName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortIndex=scsiPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTarget=scsiTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSRP=scsiTransportSRP, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceTable=scsiInstanceTable, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiTransportTypes=scsiTransportTypes, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, scsiLunMapEntry=scsiLunMapEntry, scsiLuInResets=scsiLuInResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdValue=scsiLuIdValue, ScsiIdValue=ScsiIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliances=scsiCompliances, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuWwnName=scsiLuWwnName, scsiInstanceEntry=scsiInstanceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiConformance=scsiConformance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatus=scsiLuStatus, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceAlias=scsiDeviceAlias, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiCompliance=scsiCompliance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTable=scsiPortTable, ScsiIdType=ScsiIdType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit)
