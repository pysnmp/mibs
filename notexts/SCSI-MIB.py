...
TimeTicks, Integer32, NotificationType, iso, IpAddress, mib_2, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "NotificationType", "iso", "IpAddress", "mib-2", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter64")
TextualConvention, RowStatus, TruthValue, AutonomousType, DisplayString, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "DisplayString", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdAssociation=ScsiIdAssociation, scsiCompliances=scsiCompliances, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuPeripheralType=scsiLuPeripheralType, scsiGroups=scsiGroups, scsiNotifications=scsiNotifications, scsiLuIdEntry=scsiLuIdEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportOther=scsiTranportOther, scsiModule=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiCompliance=scsiCompliance, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiLuInCommands=scsiLuInCommands, scsiInitiator=scsiInitiator, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiConformance=scsiConformance, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuState=scsiLuState, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiLuStatus=scsiLuStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTarget=scsiTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiGeneral=scsiGeneral, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunLun=scsiDscLunLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValue=ScsiIndexValue, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscLunEntry=scsiDscLunEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuEntry=scsiLuEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstIndex=scsiInstIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportSPI=scsiTranportSPI, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuProductId=scsiLuProductId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapEntry=scsiLunMapEntry)
