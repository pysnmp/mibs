...
ObjectIdentity, ModuleIdentity, iso, Integer32, Bits, NotificationType, Counter64, mib_2, Gauge32, Unsigned32, TimeTicks, MibIdentifier, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Integer32", "Bits", "NotificationType", "Counter64", "mib-2", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, AutonomousType, RowPointer, TruthValue, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdValue=ScsiIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortRole=scsiPortRole, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuWwnName=scsiLuWwnName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetGroup=scsiTargetGroup, ScsiName=ScsiName, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiLuTable=scsiLuTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstIndex=scsiInstIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiLuIdAssociation=scsiLuIdAssociation, scsiTarget=scsiTarget, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuStatus=scsiLuStatus, scsiDeviceResets=scsiDeviceResets, scsiLuInCommands=scsiLuInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdTable=scsiLuIdTable, scsiNotifications=scsiNotifications, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptType=scsiTrnsptType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiGroups=scsiGroups, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtTable=scsiDscTgtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTable=scsiPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliances=scsiCompliances, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, scsiInitiator=scsiInitiator, scsiTranportOther=scsiTranportOther, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGeneral=scsiGeneral, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstAlias=scsiInstAlias, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiPortIndex=scsiPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptEntry=scsiTrnsptEntry)
