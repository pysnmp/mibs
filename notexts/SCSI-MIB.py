...
DisplayString, TextualConvention, TimeStamp, TruthValue, RowPointer, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TimeStamp", "TruthValue", "RowPointer", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiPortEntry=scsiPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiLogicalUnit=scsiLogicalUnit, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtEntry=scsiDscTgtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortIndex=scsiPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiPortRole=scsiPortRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtName=scsiDscTgtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSBP=scsiTransportSBP, scsiConformance=scsiConformance, ScsiIdentifier=ScsiIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuTable=scsiLuTable, scsiLunMapTable=scsiLunMapTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiator=scsiInitiator, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceTable=scsiDeviceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiNotifications=scsiNotifications, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportSRP=scsiTransportSRP, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects, scsiTargetGroup=scsiTargetGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort)
