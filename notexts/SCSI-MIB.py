...
Bits, mib_2, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Integer32, iso, ObjectIdentity, Gauge32, Unsigned32, Counter64, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Integer32", "iso", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "Counter32", "NotificationType")
TextualConvention, RowStatus, DisplayString, TimeStamp, TruthValue, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiator=scsiInitiator, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiTransportFCP=scsiTransportFCP, scsiConformance=scsiConformance, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuState=scsiLuState, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGeneral=scsiGeneral, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdCodeSet=ScsiIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiTarget=scsiTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiPortRole=scsiPortRole, scsiTgtPortTable=scsiTgtPortTable, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiPortIndex=scsiPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapTable=scsiLunMapTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, ScsiIdValue=ScsiIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdType=ScsiIdType, scsiDscLunLun=scsiDscLunLun, scsiLuInResets=scsiLuInResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportOther=scsiTranportOther, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiPortEntry=scsiPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable)
