...
NotificationType, iso, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, IpAddress, ModuleIdentity, Bits, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress", "ModuleIdentity", "Bits", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Gauge32")
RowPointer, RowStatus, TimeStamp, TruthValue, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtName=scsiDscTgtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiTranportSPI=scsiTranportSPI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdType=scsiLuIdType, ScsiIdValue=ScsiIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiLuStatus=scsiLuStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiDscLunEntry=scsiDscLunEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuTable=scsiLuTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuInCommands=scsiLuInCommands, scsiDeviceRole=scsiDeviceRole, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWwnName=scsiLuWwnName, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiLuVendorId=scsiLuVendorId, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdentifier=ScsiIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptType=scsiTrnsptType, scsiLuIdTable=scsiLuIdTable, scsiPortEntry=scsiPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceResets=scsiDeviceResets, scsiObjects=scsiObjects, scsiIntrDevTable=scsiIntrDevTable, scsiNotifications=scsiNotifications, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiGeneral=scsiGeneral, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort)
