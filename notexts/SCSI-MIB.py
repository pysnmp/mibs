...
Integer32, ObjectIdentity, NotificationType, ModuleIdentity, Counter64, Bits, TimeTicks, Counter32, Gauge32, IpAddress, mib_2, Unsigned32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "TimeTicks", "Counter32", "Gauge32", "IpAddress", "mib-2", "Unsigned32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TextualConvention, DisplayString, RowStatus, AutonomousType, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliances=scsiCompliances, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiator=scsiInitiator, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuTable=scsiLuTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunTable=scsiDscLunTable, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiTransportSBP=scsiTransportSBP, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdType=ScsiIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiNotifications=scsiNotifications, PYSNMP_MODULE_ID=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstIndex=scsiInstIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTranportOther=scsiTranportOther, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdValue=ScsiIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstAlias=scsiInstAlias, scsiPortRole=scsiPortRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportSPI=scsiTranportSPI, scsiLuIdType=scsiLuIdType, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands)
