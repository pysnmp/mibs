...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, iso, Bits, Integer32, Gauge32, Counter32, ModuleIdentity, mib_2, IpAddress, Unsigned32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "iso", "Bits", "Integer32", "Gauge32", "Counter32", "ModuleIdentity", "mib-2", "IpAddress", "Unsigned32", "NotificationType", "MibIdentifier")
TextualConvention, RowStatus, TimeStamp, AutonomousType, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceRole=scsiDeviceRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiName=ScsiName, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiLuIdIndex=scsiLuIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuInResets=scsiLuInResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdTable=scsiLuIdTable, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTarget=scsiTarget, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiPortRole=scsiPortRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiObjects=scsiObjects, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdentifier=ScsiIdentifier, ScsiIdValue=ScsiIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdValue=scsiLuIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiGroups=scsiGroups, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiConformance=scsiConformance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdType=ScsiIdType, scsiInitiator=scsiInitiator, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuStatus=scsiLuStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiTransportSRP=scsiTransportSRP, scsiDscTgtConfigured=scsiDscTgtConfigured)
