...
Integer32, IpAddress, Counter32, Bits, ObjectIdentity, MibIdentifier, NotificationType, mib_2, Gauge32, iso, ModuleIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "NotificationType", "mib-2", "Gauge32", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
RowStatus, TruthValue, AutonomousType, TimeStamp, TextualConvention, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "AutonomousType", "TimeStamp", "TextualConvention", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWwnName=scsiLuWwnName, scsiConformance=scsiConformance, ScsiName=ScsiName, scsiDeviceTable=scsiDeviceTable, scsiLuState=scsiLuState, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun, scsiDeviceIndex=scsiDeviceIndex, scsiModule=scsiModule, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiInstAlias=scsiInstAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportFCP=scsiTransportFCP, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSBP=scsiTransportSBP, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortIndex=scsiPortIndex, scsiLuInResets=scsiLuInResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiObjects=scsiObjects, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliances=scsiCompliances, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiDeviceResets=scsiDeviceResets, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiLuEntry=scsiLuEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGeneral=scsiGeneral, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdValue=scsiLuIdValue, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportISCSI=scsiTransportISCSI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortName=scsiTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiTransportSRP=scsiTransportSRP, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLun=scsiLunMapLun, ScsiIdType=ScsiIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses)
