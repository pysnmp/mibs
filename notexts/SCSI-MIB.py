...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, Unsigned32, NotificationType, Gauge32, Integer32, ObjectIdentity, Counter32, ModuleIdentity, Counter64, TimeTicks, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "Integer32", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "MibIdentifier", "mib-2")
RowPointer, DisplayString, TextualConvention, AutonomousType, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortEntry=scsiPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, scsiTarget=scsiTarget, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortTable=scsiPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdValue=ScsiIdValue, scsiGroups=scsiGroups, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdType=ScsiIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceAlias=scsiDeviceAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstIndex=scsiInstIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuTable=scsiLuTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGeneral=scsiGeneral, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTable=scsiIntrDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliance=scsiCompliance, scsiTargetGroup=scsiTargetGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiObjects=scsiObjects, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiIdAssociation=ScsiIdAssociation, ScsiName=ScsiName, scsiLuEntry=scsiLuEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiator=scsiInitiator, scsiDscLunIdTable=scsiDscLunIdTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSRP=scsiTransportSRP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdValue=scsiLuIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInResets=scsiLuInResets)
