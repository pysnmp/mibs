...
Integer32, Gauge32, Unsigned32, IpAddress, Counter64, mib_2, NotificationType, ModuleIdentity, Counter32, Bits, TimeTicks, iso, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Unsigned32", "IpAddress", "Counter64", "mib-2", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "iso", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuProductId=scsiLuProductId, scsiInstanceTable=scsiInstanceTable, scsiLuState=scsiLuState, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiName=ScsiName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdType=ScsiIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstAlias=scsiInstAlias, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdValue=scsiLuIdValue, scsiGeneral=scsiGeneral, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTransportSBP=scsiTransportSBP, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiInitiator=scsiInitiator, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValue=ScsiIndexValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInCommands=scsiLuInCommands, scsiDscLunLun=scsiDscLunLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtName=scsiDscTgtName, scsiPortIndex=scsiPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTable=scsiPortTable, scsiConformance=scsiConformance, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuTable=scsiLuTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdValue=ScsiIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportFCP=scsiTransportFCP, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortTable=scsiTgtPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
