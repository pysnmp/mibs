...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, iso, IpAddress, TimeTicks, Bits, Integer32, Gauge32, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "iso", "IpAddress", "TimeTicks", "Bits", "Integer32", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "ModuleIdentity", "NotificationType")
RowStatus, DisplayString, TruthValue, TimeStamp, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "TimeStamp", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuProductId=scsiLuProductId, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuVendorId=scsiLuVendorId, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGroups=scsiGroups, scsiDscTgtEntry=scsiDscTgtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceTable=scsiDeviceTable, scsiLuInCommands=scsiLuInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiConformance=scsiConformance, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiObjects=scsiObjects, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiTransportSBP=scsiTransportSBP, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstIndex=scsiInstIndex, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiPortTable=scsiPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuTable=scsiLuTable, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatus=scsiLuStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup)
