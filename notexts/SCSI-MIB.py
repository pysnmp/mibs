...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, IpAddress, mib_2, Unsigned32, ObjectIdentity, ModuleIdentity, Counter32, Gauge32, Counter64, Bits, TimeTicks, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "IpAddress", "mib-2", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "Bits", "TimeTicks", "iso", "MibIdentifier")
AutonomousType, RowStatus, TruthValue, RowPointer, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TruthValue", "RowPointer", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiator=scsiInitiator, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIndex=scsiDscLunIndex, scsiPortEntry=scsiPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstAlias=scsiInstAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiTarget=scsiTarget, scsiTgtPortName=scsiTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuIdType=scsiLuIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtTable=scsiIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, scsiTransportSRP=scsiTransportSRP, scsiLunMapGroup=scsiLunMapGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliances=scsiCompliances, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSBP=scsiTransportSBP, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiPortIndex=scsiPortIndex, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiCompliance=scsiCompliance, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, ScsiIdentifier=ScsiIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiLuTable=scsiLuTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiObjects=scsiObjects, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
