...
ObjectIdentity, MibIdentifier, NotificationType, Counter32, iso, ModuleIdentity, Integer32, TimeTicks, mib_2, IpAddress, Counter64, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "iso", "ModuleIdentity", "Integer32", "TimeTicks", "mib-2", "IpAddress", "Counter64", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TimeStamp, RowStatus, DisplayString, TextualConvention, AutonomousType, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdType=scsiLuIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportFCP=scsiTransportFCP, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTable=scsiIntrDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunTable=scsiDscLunTable, scsiModule=scsiModule, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuEntry=scsiLuEntry, scsiTransportSBP=scsiTransportSBP, scsiInstAlias=scsiInstAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdType=ScsiIdType, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, PYSNMP_MODULE_ID=scsiModule, scsiCompliance=scsiCompliance, scsiInstIndex=scsiInstIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLun=scsiLunMapLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInCommands=scsiLuInCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiConformance=scsiConformance, scsiPortTable=scsiPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunEntry=scsiDscLunEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiDeviceResets=scsiDeviceResets, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatus=scsiLuStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTarget=scsiTarget, scsiTransportSRP=scsiTransportSRP, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliances=scsiCompliances, scsiGeneral=scsiGeneral, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort)
