...
iso, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, MibIdentifier, IpAddress, Gauge32, Bits, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "MibIdentifier", "IpAddress", "Gauge32", "Bits", "TimeTicks", "Unsigned32")
RowStatus, TextualConvention, RowPointer, DisplayString, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "RowPointer", "DisplayString", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiName=ScsiName, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceTable=scsiInstanceTable, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiInitiator=scsiInitiator, scsiModule=scsiModule, scsiDscLunIdType=scsiDscLunIdType, ScsiIdValue=ScsiIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIndex=scsiLuIndex, ScsiIdType=ScsiIdType, scsiPortEntry=scsiPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLunMapTable=scsiLunMapTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportFCP=scsiTransportFCP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdType=scsiLuIdType, scsiLuInResets=scsiLuInResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdIndex=scsiLuIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortName=scsiTgtPortName, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdTable=scsiLuIdTable, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstIndex=scsiInstIndex, scsiGroups=scsiGroups, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiCompliances=scsiCompliances, scsiTranportOther=scsiTranportOther, ScsiIndexValue=ScsiIndexValue, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiLuEntry=scsiLuEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus)
