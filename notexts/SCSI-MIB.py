...
NotificationType, Unsigned32, Counter64, Gauge32, mib_2, iso, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Counter64", "Gauge32", "mib-2", "iso", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "IpAddress")
RowStatus, TimeStamp, AutonomousType, DisplayString, TextualConvention, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapGroup=scsiLunMapGroup, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevTable=scsiTgtDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTable=scsiPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiObjects=scsiObjects, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTarget=scsiTarget, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceTable=scsiInstanceTable, scsiLuState=scsiLuState, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiConformance=scsiConformance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportFCP=scsiTransportFCP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortEntry=scsiPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunTable=scsiDscLunTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiGeneral=scsiGeneral, scsiLuInResets=scsiLuInResets, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatus=scsiLuStatus, scsiCompliances=scsiCompliances, scsiLuInCommands=scsiLuInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIndex=scsiDscLunIndex, scsiInstanceEntry=scsiInstanceEntry, ScsiIdType=ScsiIdType, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuTable=scsiLuTable, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSBP=scsiTransportSBP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuVendorId=scsiLuVendorId, scsiTranportOther=scsiTranportOther, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiTransportTypes=scsiTransportTypes, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceTable=scsiDeviceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliance=scsiCompliance, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdValue=scsiDscLunIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule)
