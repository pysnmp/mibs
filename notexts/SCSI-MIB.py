...
IpAddress, Gauge32, Counter64, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, mib_2, TimeTicks, Bits, Counter32, Integer32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter64", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "mib-2", "TimeTicks", "Bits", "Counter32", "Integer32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TruthValue, TextualConvention, RowPointer, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TextualConvention", "RowPointer", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdTable=scsiLuIdTable, scsiInstAlias=scsiInstAlias, scsiTransportSRP=scsiTransportSRP, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdType=scsiLuIdType, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLun=scsiLunMapLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuState=scsiLuState, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatus=scsiLuStatus, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdValue=ScsiIdValue, scsiObjects=scsiObjects, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, scsiPortRole=scsiPortRole, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiator=scsiInitiator, PYSNMP_MODULE_ID=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunLun=scsiDscLunLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiCompliance=scsiCompliance, scsiLunMapTable=scsiLunMapTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiTranportSPI=scsiTranportSPI, scsiTransportTypes=scsiTransportTypes, scsiLuWwnName=scsiLuWwnName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIndex=scsiLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiTransportFCP=scsiTransportFCP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, ScsiIdType=ScsiIdType, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuTable=scsiLuTable, scsiPortTable=scsiPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSBP=scsiTransportSBP, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceRole=scsiDeviceRole, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdEntry=scsiLuIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGeneral=scsiGeneral, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiTranportOther=scsiTranportOther, scsiGroups=scsiGroups)
