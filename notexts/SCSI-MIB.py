...
ObjectIdentity, Bits, IpAddress, Gauge32, Integer32, TimeTicks, Unsigned32, Counter32, Counter64, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "IpAddress", "Gauge32", "Integer32", "TimeTicks", "Unsigned32", "Counter32", "Counter64", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiTransportSBP=scsiTransportSBP, scsiLuInResets=scsiLuInResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdType=scsiLuIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapIndex=scsiLunMapIndex, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, scsiLuIndex=scsiLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuPeripheralType=scsiLuPeripheralType, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuState=scsiLuState, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiModule=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunLun=scsiDscLunLun, scsiDeviceGroup=scsiDeviceGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTable=scsiIntrDevTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtName=scsiDscTgtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuDefaultLun=scsiLuDefaultLun, scsiGeneral=scsiGeneral, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiConformance=scsiConformance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliance=scsiCompliance, scsiPortIndex=scsiPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiTrnsptIndex=scsiTrnsptIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiGroups=scsiGroups, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteTarget=scsiRemoteTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceEntry=scsiInstanceEntry, scsiPortRole=scsiPortRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule)
