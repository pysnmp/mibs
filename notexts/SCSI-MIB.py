...
mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity, Gauge32, Counter32, TimeTicks, Unsigned32, Integer32, IpAddress, Bits, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Counter32", "TimeTicks", "Unsigned32", "Integer32", "IpAddress", "Bits", "Counter64", "MibIdentifier")
TimeStamp, RowStatus, TextualConvention, AutonomousType, TruthValue, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "AutonomousType", "TruthValue", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstAlias=scsiInstAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTranportOther=scsiTranportOther, scsiConformance=scsiConformance, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliance=scsiCompliance, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, ScsiName=ScsiName, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdType=ScsiIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiTarget=scsiTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtName=scsiDscTgtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiPortEntry=scsiPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdValue=scsiLuIdValue, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscLunLun=scsiDscLunLun, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiLuProductId=scsiLuProductId, scsiModule=scsiModule, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuState=scsiLuState, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, scsiPortIndex=scsiPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiGeneral=scsiGeneral, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatus=scsiLuStatus, scsiPortRole=scsiPortRole, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGroups=scsiGroups, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, ScsiIndexValue=ScsiIndexValue, scsiTransportSRP=scsiTransportSRP, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, ScsiIdAssociation=ScsiIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptType=scsiTrnsptType, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuTable=scsiLuTable, scsiTranportSPI=scsiTranportSPI, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiCompliances=scsiCompliances, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceTable=scsiInstanceTable)
