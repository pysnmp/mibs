...
ObjectIdentity, ModuleIdentity, mib_2, Bits, NotificationType, IpAddress, Unsigned32, MibIdentifier, Gauge32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "mib-2", "Bits", "NotificationType", "IpAddress", "Unsigned32", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Counter32")
DisplayString, TextualConvention, TimeStamp, RowPointer, AutonomousType, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetGroup=scsiTargetGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstIndex=scsiInstIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiConformance=scsiConformance, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortEntry=scsiPortEntry, scsiGroups=scsiGroups, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiGeneral=scsiGeneral, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiInstAlias=scsiInstAlias, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiLuStatus=scsiLuStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortIndex=scsiPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdAssociation=scsiLuIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiName=ScsiName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTarget=scsiTarget, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTable=scsiPortTable, scsiLuWwnName=scsiLuWwnName, scsiModule=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliances=scsiCompliances, scsiObjects=scsiObjects, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuEntry=scsiLuEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiPortRole=scsiPortRole, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortName=scsiTgtPortName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry)
