...
Unsigned32, iso, MibIdentifier, ModuleIdentity, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, Counter32, Bits, NotificationType, Counter64, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "MibIdentifier", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "Counter32", "Bits", "NotificationType", "Counter64", "IpAddress", "TimeTicks")
DisplayString, TimeStamp, TextualConvention, RowStatus, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiName=ScsiName, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDeviceRole=scsiDeviceRole, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGroups=scsiGroups, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuTable=scsiLuTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdValue=scsiLuIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTarget=scsiTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiObjects=scsiObjects, ScsiIndexValue=ScsiIndexValue, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceIndex=scsiDeviceIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, scsiModule=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIndex=scsiLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiNotifications=scsiNotifications, scsiPortEntry=scsiPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiInstanceEntry=scsiInstanceEntry, scsiTranportOther=scsiTranportOther, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiLuStatus=scsiLuStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortRole=scsiPortRole, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortTable=scsiTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry)
