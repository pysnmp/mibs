...
Counter64, Gauge32, ObjectIdentity, Unsigned32, TimeTicks, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, NotificationType, ModuleIdentity, Counter32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "Integer32")
TruthValue, RowPointer, DisplayString, AutonomousType, TextualConvention, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiCompliances=scsiCompliances, scsiGeneral=scsiGeneral, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, ScsiName=ScsiName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportTypes=scsiTransportTypes, scsiLogicalUnit=scsiLogicalUnit, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceRole=scsiDeviceRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdEntry=scsiLuIdEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiTransportFCP=scsiTransportFCP, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortRole=scsiPortRole, scsiLunMapLun=scsiLunMapLun, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdValue=scsiLuIdValue, scsiCompliance=scsiCompliance, scsiTgtPortName=scsiTgtPortName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceTable=scsiDeviceTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiLuIdTable=scsiLuIdTable, scsiRemoteTarget=scsiRemoteTarget, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiConformance=scsiConformance, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuTable=scsiLuTable, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetGroup=scsiTargetGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, ScsiIdType=ScsiIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiPortIndex=scsiPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapIndex=scsiLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdIndex=scsiLuIdIndex, scsiLuProductId=scsiLuProductId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptType=scsiTrnsptType, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets)
