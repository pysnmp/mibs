...
TimeTicks, Counter64, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, NotificationType, iso, mib_2, Gauge32, IpAddress, ModuleIdentity, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "NotificationType", "iso", "mib-2", "Gauge32", "IpAddress", "ModuleIdentity", "Unsigned32", "Bits")
TextualConvention, DisplayString, TruthValue, TimeStamp, AutonomousType, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "TimeStamp", "AutonomousType", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunLun=scsiDscLunLun, scsiConformance=scsiConformance, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiModule=scsiModule, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIndex=scsiLuIndex, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiPortTable=scsiPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiNotifications=scsiNotifications, scsiObjects=scsiObjects, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportFCP=scsiTransportFCP, ScsiIdValue=ScsiIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTarget=scsiTarget, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliance=scsiCompliance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortEntry=scsiPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortIndex=scsiPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdType=scsiLuIdType, scsiLuInResets=scsiLuInResets, scsiCompliances=scsiCompliances, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiator=scsiInitiator, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuRevisionId=scsiLuRevisionId, ScsiIdType=ScsiIdType, scsiTranportOther=scsiTranportOther, scsiInstAlias=scsiInstAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiLuWwnName=scsiLuWwnName, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIndex=scsiDscLunIndex, scsiGeneral=scsiGeneral, scsiDscLunEntry=scsiDscLunEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortName=scsiTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportSRP=scsiTransportSRP, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry)
