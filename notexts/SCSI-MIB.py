...
ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ObjectIdentity, IpAddress, iso, TimeTicks, MibIdentifier, Unsigned32, NotificationType, Gauge32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "MibIdentifier", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "Integer32")
RowStatus, TextualConvention, TimeStamp, TruthValue, DisplayString, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdentifier=ScsiIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiObjects=scsiObjects, scsiLunMapLun=scsiLunMapLun, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstIndex=scsiInstIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotifications=scsiNotifications, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiator=scsiInitiator, scsiLogicalUnit=scsiLogicalUnit, scsiGroups=scsiGroups, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiPortRole=scsiPortRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortIndex=scsiPortIndex, ScsiIdValue=ScsiIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuTable=scsiLuTable, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceResets=scsiDeviceResets, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapEntry=scsiLunMapEntry, ScsiIdType=ScsiIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunTable=scsiDscLunTable, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiConformance=scsiConformance, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuProductId=scsiLuProductId, ScsiName=ScsiName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable)
