...
Integer32, Bits, IpAddress, MibIdentifier, Unsigned32, NotificationType, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ObjectIdentity, Counter64, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "IpAddress", "MibIdentifier", "Unsigned32", "NotificationType", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ObjectIdentity", "Counter64", "Gauge32", "ModuleIdentity")
RowStatus, DisplayString, AutonomousType, TruthValue, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "AutonomousType", "TruthValue", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiNotifications=scsiNotifications, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdValue=ScsiIdValue, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstanceTable=scsiInstanceTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortTable=scsiPortTable, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiDscTgtName=scsiDscTgtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuProductId=scsiLuProductId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiPortEntry=scsiPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceResets=scsiDeviceResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuWwnName=scsiLuWwnName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInCommands=scsiLuInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInResets=scsiLuInResets, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiTarget=scsiTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiator=scsiInitiator, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdType=ScsiIdType, scsiModule=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiTargetGroup=scsiTargetGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiConformance=scsiConformance, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuState=scsiLuState, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex)
