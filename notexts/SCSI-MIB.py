...
Integer32, Unsigned32, MibIdentifier, ModuleIdentity, Counter64, mib_2, TimeTicks, IpAddress, Counter32, Bits, ObjectIdentity, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter64", "mib-2", "TimeTicks", "IpAddress", "Counter32", "Bits", "ObjectIdentity", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
RowPointer, DisplayString, TextualConvention, RowStatus, AutonomousType, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdValue=ScsiIdValue, scsiInstanceTable=scsiInstanceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuRevisionId=scsiLuRevisionId, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuState=scsiLuState, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSRP=scsiTransportSRP, ScsiIdType=ScsiIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuEntry=scsiLuEntry, scsiDeviceResets=scsiDeviceResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortRole=scsiPortRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortName=scsiTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, scsiDscTgtEntry=scsiDscTgtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunTable=scsiDscLunTable, scsiLuIdTable=scsiLuIdTable, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiDevicePortNumber=scsiDevicePortNumber, scsiGeneral=scsiGeneral, scsiLuIndex=scsiLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiTarget=scsiTarget, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuProductId=scsiLuProductId, scsiPortTable=scsiPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiName=ScsiName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiator=scsiInitiator, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiCompliance=scsiCompliance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup)
