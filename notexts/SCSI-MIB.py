...
Integer32, NotificationType, Counter64, iso, Gauge32, TimeTicks, Counter32, mib_2, ObjectIdentity, MibIdentifier, Bits, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "iso", "Gauge32", "TimeTicks", "Counter32", "mib-2", "ObjectIdentity", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
RowPointer, RowStatus, TruthValue, TextualConvention, DisplayString, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TruthValue", "TextualConvention", "DisplayString", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtTable=scsiDscTgtTable, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiCompliance=scsiCompliance, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtName=scsiDscTgtName, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiTransportSBP=scsiTransportSBP, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceIndex=scsiDeviceIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiPortEntry=scsiPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatus=scsiLuStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLun=scsiLunMapLun, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuProductId=scsiLuProductId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuVendorId=scsiLuVendorId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortRole=scsiPortRole, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes)
