...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, NotificationType, ModuleIdentity, TimeTicks, MibIdentifier, Counter64, Gauge32, mib_2, Bits, Integer32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "mib-2", "Bits", "Integer32", "iso", "Counter32")
TimeStamp, TextualConvention, RowPointer, DisplayString, AutonomousType, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowPointer", "DisplayString", "AutonomousType", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSBP=scsiTransportSBP, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiName=ScsiName, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiDscLunTable=scsiDscLunTable, scsiInstanceEntry=scsiInstanceEntry, scsiLuInCommands=scsiLuInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiLuIdType=scsiLuIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGeneral=scsiGeneral, scsiLunMapTable=scsiLunMapTable, scsiPortEntry=scsiPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiTargetGroup=scsiTargetGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTarget=scsiTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortIndex=scsiPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtName=scsiDscTgtName, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdentifier=ScsiIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunLun=scsiDscLunLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, PYSNMP_MODULE_ID=scsiModule, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiInitiator=scsiInitiator, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceGroup=scsiDeviceGroup, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdType=ScsiIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortName=scsiTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInResets=scsiLuInResets, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuTable=scsiLuTable, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuState=scsiLuState, scsiDeviceRole=scsiDeviceRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuEntry=scsiLuEntry, scsiCompliances=scsiCompliances, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIndex=scsiLuIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdValue=ScsiIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry)
