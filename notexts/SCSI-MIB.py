...
Counter32, MibIdentifier, Integer32, NotificationType, IpAddress, Unsigned32, Gauge32, ObjectIdentity, Counter64, mib_2, TimeTicks, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter64", "mib-2", "TimeTicks", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortRole=scsiPortRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportSBP=scsiTransportSBP, scsiTargetGroup=scsiTargetGroup, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortName=scsiTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiInstIndex=scsiInstIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapLun=scsiLunMapLun, scsiInstanceTable=scsiInstanceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuEntry=scsiLuEntry, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrName=scsiAuthIntrName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiInitiator=scsiInitiator, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptIndex=scsiTrnsptIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuProductId=scsiLuProductId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiConformance=scsiConformance, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIndex=scsiLuIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliances=scsiCompliances, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiTgtPortTable=scsiTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTranportOther=scsiTranportOther, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiGroups=scsiGroups, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands)
