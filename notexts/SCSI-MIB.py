...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Counter32, Counter64, Gauge32, NotificationType, MibIdentifier, Unsigned32, Integer32, Bits, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Counter32", "Counter64", "Gauge32", "NotificationType", "MibIdentifier", "Unsigned32", "Integer32", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress")
TimeStamp, RowStatus, AutonomousType, RowPointer, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "RowPointer", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetGroup=scsiTargetGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliances=scsiCompliances, scsiDeviceAlias=scsiDeviceAlias, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstIndex=scsiInstIndex, ScsiIdAssociation=ScsiIdAssociation, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdValue=ScsiIdValue, PYSNMP_MODULE_ID=scsiModule, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapGroup=scsiLunMapGroup, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWwnName=scsiLuWwnName, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIndex=scsiLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortRole=scsiPortRole, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiTransportFCP=scsiTransportFCP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuVendorId=scsiLuVendorId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, ScsiIndexValue=ScsiIndexValue, scsiLuProductId=scsiLuProductId, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiDscLunEntry=scsiDscLunEntry, scsiRemoteTarget=scsiRemoteTarget, scsiPortEntry=scsiPortEntry)
