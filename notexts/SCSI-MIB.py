...
MibIdentifier, mib_2, Counter32, Integer32, iso, Gauge32, IpAddress, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, ObjectIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "Counter32", "Integer32", "iso", "Gauge32", "IpAddress", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "ObjectIdentity", "NotificationType", "TimeTicks")
TimeStamp, DisplayString, AutonomousType, TruthValue, RowStatus, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "AutonomousType", "TruthValue", "RowStatus", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLun=scsiLunMapLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtTable=scsiIntrPrtTable, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiObjects=scsiObjects, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiCompliance=scsiCompliance, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortRole=scsiPortRole, scsiTransportFCP=scsiTransportFCP, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtName=scsiDscTgtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdTable=scsiLuIdTable, ScsiIndexValue=ScsiIndexValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceTable=scsiDeviceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliances=scsiCompliances, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiName=ScsiName, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuEntry=scsiLuEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiLuVendorId=scsiLuVendorId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortIndex=scsiPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWwnName=scsiLuWwnName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, scsiTgtPortName=scsiTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportTypes=scsiTransportTypes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiator=scsiInitiator, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuStatus=scsiLuStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSRP=scsiTransportSRP, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunTable=scsiDscLunTable, scsiLuInResets=scsiLuInResets, scsiDeviceResets=scsiDeviceResets, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
