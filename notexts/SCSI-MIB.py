...
MibIdentifier, ObjectIdentity, Gauge32, IpAddress, Bits, Integer32, TimeTicks, Counter64, NotificationType, mib_2, iso, ModuleIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Gauge32", "IpAddress", "Bits", "Integer32", "TimeTicks", "Counter64", "NotificationType", "mib-2", "iso", "ModuleIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, RowPointer, TruthValue, AutonomousType, TextualConvention, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuTable=scsiLuTable, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdType=scsiLuIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliances=scsiCompliances, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiLuProductId=scsiLuProductId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatus=scsiLuStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTable=scsiPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiInstAlias=scsiInstAlias, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevTable=scsiTgtDevTable, scsiGeneral=scsiGeneral, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtEntry=scsiDscTgtEntry, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportSPI=scsiTranportSPI, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiator=scsiInitiator, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiConformance=scsiConformance, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstIndex=scsiInstIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGroups=scsiGroups, PYSNMP_MODULE_ID=scsiModule, scsiCompliance=scsiCompliance, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdEntry=scsiLuIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuEntry=scsiLuEntry, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiTgtPortName=scsiTgtPortName, scsiTranportOther=scsiTranportOther, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex)
