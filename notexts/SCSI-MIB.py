...
Gauge32, iso, MibIdentifier, Unsigned32, TimeTicks, ObjectIdentity, NotificationType, Counter32, Bits, ModuleIdentity, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "MibIdentifier", "Unsigned32", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter32", "Bits", "ModuleIdentity", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64")
TruthValue, TextualConvention, AutonomousType, TimeStamp, DisplayString, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdType=scsiLuIdType, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapTable=scsiLunMapTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdValue=scsiLuIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetGroup=scsiTargetGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuEntry=scsiLuEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliances=scsiCompliances, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstAlias=scsiInstAlias, scsiDeviceRole=scsiDeviceRole, scsiDscLunIndex=scsiDscLunIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceTable=scsiInstanceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiName=ScsiName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrName=scsiAuthIntrName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceResets=scsiDeviceResets, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportTypes=scsiTransportTypes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiLuStatus=scsiLuStatus, scsiObjects=scsiObjects, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiLuInCommands=scsiLuInCommands, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliance=scsiCompliance, scsiDscLunLun=scsiDscLunLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortTable=scsiPortTable, scsiTarget=scsiTarget, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGeneral=scsiGeneral, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, scsiConformance=scsiConformance, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuProductId=scsiLuProductId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuTable=scsiLuTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapLun=scsiLunMapLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
