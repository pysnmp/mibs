...
IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, iso, mib_2, MibIdentifier, Bits, Unsigned32, Integer32, ObjectIdentity, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "iso", "mib-2", "MibIdentifier", "Bits", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter64")
AutonomousType, TruthValue, RowStatus, RowPointer, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowStatus", "RowPointer", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiTarget=scsiTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotifications=scsiNotifications, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuWwnName=scsiLuWwnName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuEntry=scsiLuEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortIndex=scsiPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdType=ScsiIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName, scsiDeviceAlias=scsiDeviceAlias, scsiTransportFCP=scsiTransportFCP, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortRole=scsiPortRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrName=scsiAuthIntrName, scsiLuState=scsiLuState, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapLun=scsiLunMapLun, PYSNMP_MODULE_ID=scsiModule, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiInstIndex=scsiInstIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInCommands=scsiLuInCommands, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiPortEntry=scsiPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiConformance=scsiConformance, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiObjects=scsiObjects, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLuInResets=scsiLuInResets, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiModule=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportSBP=scsiTransportSBP, scsiGroups=scsiGroups, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceRole=scsiDeviceRole, scsiInstAlias=scsiInstAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuTable=scsiLuTable)
