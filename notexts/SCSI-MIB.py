...
Gauge32, Unsigned32, Integer32, mib_2, Bits, Counter64, MibIdentifier, TimeTicks, Counter32, ModuleIdentity, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Integer32", "mib-2", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "Counter32", "ModuleIdentity", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TruthValue, DisplayString, AutonomousType, RowPointer, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "RowPointer", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiName=ScsiName, scsiLogicalUnit=scsiLogicalUnit, ScsiIdType=ScsiIdType, scsiLunMapGroup=scsiLunMapGroup, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuIdType=scsiLuIdType, scsiInitiator=scsiInitiator, scsiInstAlias=scsiInstAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunLun=scsiDscLunLun, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdentifier=ScsiIdentifier, scsiCompliance=scsiCompliance, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdValue=scsiLuIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiTgtPortName=scsiTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLuTable=scsiLuTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtTable=scsiDscTgtTable, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuProductId=scsiLuProductId, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiCompliances=scsiCompliances, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortRole=scsiPortRole, scsiGroups=scsiGroups, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportFCP=scsiTransportFCP, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportTypes=scsiTransportTypes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstIndex=scsiInstIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptType=scsiTrnsptType, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceAlias=scsiDeviceAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdType=scsiDscLunIdType)
