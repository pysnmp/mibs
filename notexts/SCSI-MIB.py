...
TimeTicks, Unsigned32, ModuleIdentity, Gauge32, Bits, Integer32, Counter32, NotificationType, iso, ObjectIdentity, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ModuleIdentity", "Gauge32", "Bits", "Integer32", "Counter32", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "mib-2")
TimeStamp, RowPointer, DisplayString, RowStatus, AutonomousType, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiConformance=scsiConformance, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiGroups=scsiGroups, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunEntry=scsiDscLunEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceTable=scsiDeviceTable, scsiTranportSPI=scsiTranportSPI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetGroup=scsiTargetGroup, scsiLuTable=scsiLuTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdentifier=ScsiIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiObjects=scsiObjects, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportFCP=scsiTransportFCP, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotifications=scsiNotifications, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtIndex=scsiDscTgtIndex, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName, scsiLuIndex=scsiLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapLun=scsiLunMapLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuIdTable=scsiLuIdTable, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiModule=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiInstIndex=scsiInstIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtTable=scsiDscTgtTable, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuProductId=scsiLuProductId, scsiLuEntry=scsiLuEntry, scsiInstAlias=scsiInstAlias, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceEntry=scsiInstanceEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportOther=scsiTranportOther, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuIdValue=scsiLuIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
