...
ModuleIdentity, mib_2, iso, Bits, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Gauge32, IpAddress, Integer32, Counter64, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "iso", "Bits", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Gauge32", "IpAddress", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity")
RowPointer, TimeStamp, AutonomousType, TextualConvention, TruthValue, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstVendorVersion=scsiInstVendorVersion, PYSNMP_MODULE_ID=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuEntry=scsiLuEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceTable=scsiInstanceTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdValue=scsiDscLunIdValue, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiGroups=scsiGroups, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceEntry=scsiInstanceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceGroup=scsiDeviceGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiConformance=scsiConformance, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuIndex=scsiLuIndex, scsiLuProductId=scsiLuProductId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptType=scsiTrnsptType, scsiLuWwnName=scsiLuWwnName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapTable=scsiLunMapTable, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiCompliance=scsiCompliance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInResets=scsiLuInResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstAlias=scsiInstAlias, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortEntry=scsiPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValue=ScsiIndexValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiGeneral=scsiGeneral, scsiInitiator=scsiInitiator, scsiDeviceResets=scsiDeviceResets, scsiLuIdTable=scsiLuIdTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstIndex=scsiInstIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdType=ScsiIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiCompliances=scsiCompliances, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportOther=scsiTranportOther, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtName=scsiIntrPrtName)
