...
Counter32, TimeTicks, iso, ModuleIdentity, Gauge32, mib_2, Integer32, Counter64, Unsigned32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "iso", "ModuleIdentity", "Gauge32", "mib-2", "Integer32", "Counter64", "Unsigned32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "NotificationType")
TimeStamp, RowStatus, RowPointer, DisplayString, AutonomousType, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "RowPointer", "DisplayString", "AutonomousType", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiConformance=scsiConformance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiName=ScsiName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrName=scsiAuthIntrName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuVendorId=scsiLuVendorId, scsiLuIndex=scsiLuIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, scsiLuIdValue=scsiLuIdValue, scsiInitiator=scsiInitiator, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSRP=scsiTransportSRP, scsiLuStatus=scsiLuStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceRole=scsiDeviceRole, scsiDscLunEntry=scsiDscLunEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDscLunLun=scsiDscLunLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortRole=scsiPortRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTarget=scsiTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSBP=scsiTransportSBP, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortTable=scsiPortTable, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, scsiLuTable=scsiLuTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortIndex=scsiPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGroups=scsiGroups, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliance=scsiCompliance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportOther=scsiTranportOther, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuProductId=scsiLuProductId)
