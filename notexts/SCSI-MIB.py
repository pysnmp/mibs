...
IpAddress, Counter64, Counter32, Gauge32, Integer32, TimeTicks, ModuleIdentity, iso, NotificationType, Bits, MibIdentifier, Unsigned32, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Counter32", "Gauge32", "Integer32", "TimeTicks", "ModuleIdentity", "iso", "NotificationType", "Bits", "MibIdentifier", "Unsigned32", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TruthValue, TimeStamp, RowStatus, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "TimeStamp", "RowStatus", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstIndex=scsiInstIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, scsiInitiator=scsiInitiator, scsiLuIdTable=scsiLuIdTable, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdType=ScsiIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatus=scsiLuStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiLuIdValue=scsiLuIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiGroups=scsiGroups, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptType=scsiTrnsptType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapIndex=scsiLunMapIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuProductId=scsiLuProductId, scsiTransportSRP=scsiTransportSRP, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiObjects=scsiObjects, scsiLuTable=scsiLuTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportISCSI=scsiTransportISCSI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiNotifications=scsiNotifications, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstAlias=scsiInstAlias, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliances=scsiCompliances, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiDeviceRole=scsiDeviceRole, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapGroup=scsiLunMapGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIndex=scsiLuIndex, scsiTarget=scsiTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportOther=scsiTranportOther, scsiLuState=scsiLuState, scsiModule=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortName=scsiTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiConformance=scsiConformance, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliance=scsiCompliance, scsiTrnsptPointer=scsiTrnsptPointer)
