...
ObjectIdentity, mib_2, Bits, IpAddress, NotificationType, Integer32, iso, Counter64, ModuleIdentity, Gauge32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Bits", "IpAddress", "NotificationType", "Integer32", "iso", "Counter64", "ModuleIdentity", "Gauge32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
TimeStamp, TruthValue, RowStatus, DisplayString, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdType=scsiLuIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdValue=scsiLuIdValue, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiLuInCommands=scsiLuInCommands, scsiLuIndex=scsiLuIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiGeneral=scsiGeneral, scsiModule=scsiModule, scsiLuEntry=scsiLuEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtName=scsiDscTgtName, scsiLuIdEntry=scsiLuIdEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdType=ScsiIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportSPI=scsiTranportSPI, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceAlias=scsiDeviceAlias, scsiLuTable=scsiLuTable, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptType=scsiTrnsptType, scsiConformance=scsiConformance, scsiTgtDevTable=scsiTgtDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiCompliances=scsiCompliances, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiObjects=scsiObjects, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, scsiCompliance=scsiCompliance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotifications=scsiNotifications, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuProductId=scsiLuProductId, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiInstAlias=scsiInstAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex)
