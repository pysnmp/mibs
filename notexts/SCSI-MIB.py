...
mib_2, iso, Counter32, Gauge32, Integer32, TimeTicks, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, Counter64, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Counter32", "Gauge32", "Integer32", "TimeTicks", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter64", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
TextualConvention, TimeStamp, TruthValue, DisplayString, AutonomousType, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceAlias=scsiDeviceAlias, ScsiIdValue=ScsiIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuVendorId=scsiLuVendorId, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiObjects=scsiObjects, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscLunLun=scsiDscLunLun, scsiLuState=scsiLuState, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetGroup=scsiTargetGroup, ScsiName=ScsiName, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiInitiator=scsiInitiator, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtName=scsiDscTgtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiDeviceResets=scsiDeviceResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiLuProductId=scsiLuProductId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortEntry=scsiPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceEntry=scsiDeviceEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdType=scsiLuIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportISCSI=scsiTransportISCSI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiDscTgtTable=scsiDscTgtTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortRole=scsiPortRole, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTable=scsiPortTable)
