...
IpAddress, Gauge32, mib_2, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, iso, Bits, TimeTicks, Unsigned32, ModuleIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "mib-2", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "iso", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibIdentifier", "NotificationType")
DisplayString, AutonomousType, TruthValue, TimeStamp, RowPointer, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdType=ScsiIdType, scsiDscLunTable=scsiDscLunTable, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTranportSPI=scsiTranportSPI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiCompliances=scsiCompliances, scsiLuEntry=scsiLuEntry, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortName=scsiTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiLuIdType=scsiLuIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLun=scsiLunMapLun, scsiGeneral=scsiGeneral, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInResets=scsiLuInResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiLuState=scsiLuState, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuProductId=scsiLuProductId, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiName=ScsiName, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLunMapEntry=scsiLunMapEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSBP=scsiTransportSBP, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiTarget=scsiTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiNotifications=scsiNotifications, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiator=scsiInitiator, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunLun=scsiDscLunLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiObjects=scsiObjects, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapTable=scsiLunMapTable, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiRemoteInitiators=scsiRemoteInitiators, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation)
