...
Integer32, Gauge32, Counter64, ObjectIdentity, iso, ModuleIdentity, Bits, NotificationType, MibIdentifier, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "ObjectIdentity", "iso", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Unsigned32")
TimeStamp, DisplayString, TextualConvention, RowPointer, RowStatus, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "RowPointer", "RowStatus", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiConformance=scsiConformance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiTarget=scsiTarget, scsiTransportSRP=scsiTransportSRP, scsiObjects=scsiObjects, scsiTrnsptTable=scsiTrnsptTable, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGeneral=scsiGeneral, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstAlias=scsiInstAlias, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, ScsiIdAssociation=ScsiIdAssociation, ScsiIdentifier=ScsiIdentifier, ScsiName=ScsiName, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiator=scsiInitiator, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiLuProductId=scsiLuProductId, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiModule=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiLuWwnName=scsiLuWwnName, scsiLuInCommands=scsiLuInCommands, scsiLuIdTable=scsiLuIdTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuTable=scsiLuTable, scsiPortRole=scsiPortRole, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTable=scsiPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceIndex=scsiDeviceIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiCompliances=scsiCompliances, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, ScsiIdType=ScsiIdType, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortEntry=scsiPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdValue=scsiDscLunIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportOther=scsiTranportOther)
