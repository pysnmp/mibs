...
Counter32, iso, TimeTicks, ObjectIdentity, IpAddress, mib_2, Unsigned32, MibIdentifier, NotificationType, ModuleIdentity, Counter64, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "mib-2", "Unsigned32", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
TextualConvention, RowStatus, TimeStamp, TruthValue, RowPointer, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue", "RowPointer", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortTable=scsiTgtPortTable, scsiGeneral=scsiGeneral, scsiLuState=scsiLuState, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiCompliance=scsiCompliance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiModule=scsiModule, scsiLuWwnName=scsiLuWwnName, scsiObjects=scsiObjects, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSBP=scsiTransportSBP, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiDscLunTable=scsiDscLunTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiGroups=scsiGroups, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInitiator=scsiInitiator, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortEntry=scsiPortEntry, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiLuStatus=scsiLuStatus, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliances=scsiCompliances, scsiDeviceResets=scsiDeviceResets, scsiTrnsptType=scsiTrnsptType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, ScsiName=ScsiName, ScsiIdType=ScsiIdType, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortTable=scsiPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapIndex=scsiLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapTable=scsiLunMapTable, scsiTgtPortName=scsiTgtPortName, scsiTrnsptTable=scsiTrnsptTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportFCP=scsiTransportFCP, scsiTranportOther=scsiTranportOther, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdAssociation=ScsiIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdValue=ScsiIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes)
