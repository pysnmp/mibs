...
mib_2, Integer32, Unsigned32, iso, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter64, Gauge32, NotificationType, TimeTicks, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "Unsigned32", "iso", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "NotificationType", "TimeTicks", "ObjectIdentity", "MibIdentifier")
AutonomousType, RowPointer, TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportOther=scsiTranportOther, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, scsiLunMapGroup=scsiLunMapGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdTable=scsiLuIdTable, scsiInitiator=scsiInitiator, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIndex=scsiLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiCompliances=scsiCompliances, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiNotifications=scsiNotifications, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuVendorId=scsiLuVendorId, scsiInstanceTable=scsiInstanceTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLuStatus=scsiLuStatus, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptType=scsiTrnsptType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdType=scsiLuIdType, scsiLuState=scsiLuState, scsiTransportFCP=scsiTransportFCP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortIndex=scsiPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiObjects=scsiObjects, PYSNMP_MODULE_ID=scsiModule, scsiPortRole=scsiPortRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuTable=scsiLuTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortEntry=scsiPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiConformance=scsiConformance, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSRP=scsiTransportSRP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue)
