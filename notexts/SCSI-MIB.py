...
Counter32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, ModuleIdentity, Bits, IpAddress, iso, NotificationType, Unsigned32, ObjectIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "ModuleIdentity", "Bits", "IpAddress", "iso", "NotificationType", "Unsigned32", "ObjectIdentity", "Counter64", "Integer32")
RowPointer, TimeStamp, DisplayString, RowStatus, TruthValue, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "RowStatus", "TruthValue", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiPortIndex=scsiPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortRole=scsiPortRole, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtName=scsiDscTgtName, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValue=ScsiIndexValue, scsiTransportSRP=scsiTransportSRP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdType=scsiDscLunIdType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiCompliance=scsiCompliance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiGroups=scsiGroups, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstanceTable=scsiInstanceTable, scsiInstanceEntry=scsiInstanceEntry, scsiLuTable=scsiLuTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatus=scsiLuStatus, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiModule=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdType=ScsiIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunTable=scsiDscLunTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstAlias=scsiInstAlias, scsiLuIdTable=scsiLuIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuState=scsiLuState, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortTable=scsiPortTable, ScsiIdValue=ScsiIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiName=ScsiName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes)
