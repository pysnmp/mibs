...
Unsigned32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, TimeTicks, ObjectIdentity, Integer32, Counter32, mib_2, MibIdentifier, IpAddress, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "TimeTicks", "ObjectIdentity", "Integer32", "Counter32", "mib-2", "MibIdentifier", "IpAddress", "Bits", "ModuleIdentity")
RowStatus, DisplayString, TruthValue, AutonomousType, RowPointer, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "AutonomousType", "RowPointer", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortName=scsiTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportTypes=scsiTransportTypes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTarget=scsiTarget, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiLuTable=scsiLuTable, scsiTgtPortEntry=scsiTgtPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, scsiDscTgtTable=scsiDscTgtTable, scsiNotifications=scsiNotifications, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, scsiGroups=scsiGroups, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtName=scsiIntrPrtName, scsiPortTable=scsiPortTable, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiLuProductId=scsiLuProductId, scsiLunMapLun=scsiLunMapLun, scsiLuEntry=scsiLuEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtEntry=scsiDscTgtEntry, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdIndex=scsiLuIdIndex, ScsiIdType=ScsiIdType, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiModule=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuState=scsiLuState, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiDeviceTable=scsiDeviceTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuStatus=scsiLuStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstAlias=scsiInstAlias, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiObjects=scsiObjects, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, ScsiName=ScsiName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx)
