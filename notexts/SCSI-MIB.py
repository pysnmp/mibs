...
Unsigned32, ModuleIdentity, Integer32, MibIdentifier, Counter32, iso, IpAddress, NotificationType, Gauge32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Integer32", "MibIdentifier", "Counter32", "iso", "IpAddress", "NotificationType", "Gauge32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "Counter64")
AutonomousType, RowStatus, TextualConvention, RowPointer, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TextualConvention", "RowPointer", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValue=ScsiIndexValue, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdType=scsiLuIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortTable=scsiTgtPortTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiAuthIntrName=scsiAuthIntrName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuVendorId=scsiLuVendorId, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiTarget=scsiTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiTransportTypes=scsiTransportTypes, scsiInitiator=scsiInitiator, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDeviceTable=scsiDeviceTable, scsiInstAlias=scsiInstAlias, scsiTransportSBP=scsiTransportSBP, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdValue=ScsiIdValue, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuEntry=scsiLuEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiPortEntry=scsiPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiConformance=scsiConformance, scsiLuProductId=scsiLuProductId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, ScsiIdType=ScsiIdType, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuWwnName=scsiLuWwnName, scsiGroups=scsiGroups, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTable=scsiPortTable, scsiTargetGroup=scsiTargetGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiLuStatus=scsiLuStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortIndex=scsiPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIndex=scsiLuIndex, scsiLunMapTable=scsiLunMapTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup)
