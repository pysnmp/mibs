...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, iso, TimeTicks, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, MibIdentifier, Gauge32, Bits, IpAddress, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "iso", "TimeTicks", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "Integer32", "Counter32")
RowStatus, TimeStamp, AutonomousType, TruthValue, DisplayString, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue", "DisplayString", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiInstIndex=scsiInstIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTarget=scsiTarget, scsiLuVendorId=scsiLuVendorId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportTypes=scsiTransportTypes, scsiModule=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuProductId=scsiLuProductId, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtTable=scsiDscTgtTable, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTable=scsiPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuStatus=scsiLuStatus, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiObjects=scsiObjects, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiGroups=scsiGroups, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuInCommands=scsiLuInCommands, scsiLunMapLun=scsiLunMapLun, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiPortIndex=scsiPortIndex, scsiInstanceTable=scsiInstanceTable, scsiNotifications=scsiNotifications, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInResets=scsiLuInResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceRole=scsiDeviceRole, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapTable=scsiLunMapTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiGeneral=scsiGeneral, ScsiIdentifier=ScsiIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdValue=ScsiIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiRemoteInitiators=scsiRemoteInitiators, ScsiName=ScsiName, scsiLuIdType=scsiLuIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortRole=scsiPortRole, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets)
