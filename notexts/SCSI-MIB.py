...
Counter64, NotificationType, Counter32, Gauge32, mib_2, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, IpAddress, Bits, MibIdentifier, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Counter32", "Gauge32", "mib-2", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "IpAddress", "Bits", "MibIdentifier", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiator=scsiInitiator, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetGroup=scsiTargetGroup, scsiGroups=scsiGroups, scsiNotifications=scsiNotifications, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiConformance=scsiConformance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdType=scsiLuIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInCommands=scsiLuInCommands, scsiLuEntry=scsiLuEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTable=scsiPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiLuTable=scsiLuTable, scsiDeviceResets=scsiDeviceResets, scsiTransportSRP=scsiTransportSRP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuRevisionId=scsiLuRevisionId, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuInResets=scsiLuInResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptType=scsiTrnsptType, scsiModule=scsiModule, scsiInstAlias=scsiInstAlias, scsiLuProductId=scsiLuProductId, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiObjects=scsiObjects, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortEntry=scsiPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceTable=scsiInstanceTable, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, PYSNMP_MODULE_ID=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiInstIndex=scsiInstIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiPortIndex=scsiPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunLun=scsiDscLunLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiCompliance=scsiCompliance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuVendorId=scsiLuVendorId, ScsiIdValue=ScsiIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLun=scsiLunMapLun)
