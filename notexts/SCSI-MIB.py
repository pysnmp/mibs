...
IpAddress, Counter32, Gauge32, Counter64, ModuleIdentity, Integer32, Bits, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, iso, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "iso", "NotificationType", "mib-2")
RowStatus, DisplayString, TimeStamp, TruthValue, TextualConvention, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportFCP=scsiTransportFCP, scsiTransportTypes=scsiTransportTypes, scsiConformance=scsiConformance, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuState=scsiLuState, scsiLunMapTable=scsiLunMapTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdValue=scsiDscLunIdValue, scsiTarget=scsiTarget, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuHSInCommands=scsiLuHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGroups=scsiGroups, scsiDeviceTable=scsiDeviceTable, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceTable=scsiInstanceTable, scsiTranportSPI=scsiTranportSPI, scsiDscLunIndex=scsiDscLunIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuIdType=scsiLuIdType, scsiTransportISCSI=scsiTransportISCSI, scsiTransportSRP=scsiTransportSRP, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptType=scsiTrnsptType, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuStatus=scsiLuStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdValue=ScsiIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiDeviceIndex=scsiDeviceIndex, scsiInitiator=scsiInitiator, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuTable=scsiLuTable, scsiRemoteTarget=scsiRemoteTarget, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstAlias=scsiInstAlias, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLuInResets=scsiLuInResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceRole=scsiDeviceRole, ScsiName=ScsiName, ScsiIdType=ScsiIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiCompliances=scsiCompliances, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiCompliance=scsiCompliance, scsiTranportOther=scsiTranportOther, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup)
