...
ModuleIdentity, Gauge32, Counter64, ObjectIdentity, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, MibIdentifier, Bits, Unsigned32, Counter32, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Counter32", "mib-2", "NotificationType")
DisplayString, TextualConvention, RowPointer, RowStatus, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowPointer", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliances=scsiCompliances, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdType=scsiLuIdType, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceRole=scsiDeviceRole, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuState=scsiLuState, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, ScsiIdValue=ScsiIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceTable=scsiInstanceTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiGroups=scsiGroups, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLun=scsiLunMapLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortIndex=scsiPortIndex, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiCompliance=scsiCompliance, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiPortEntry=scsiPortEntry, ScsiName=ScsiName, scsiLunMapGroup=scsiLunMapGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, scsiModule=scsiModule, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiLogicalUnit=scsiLogicalUnit, scsiConformance=scsiConformance, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuTable=scsiLuTable, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTransportFCP=scsiTransportFCP, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTarget=scsiTarget, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiObjects=scsiObjects, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdTable=scsiLuIdTable)
