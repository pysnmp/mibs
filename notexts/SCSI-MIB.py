...
Gauge32, Integer32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, MibIdentifier, ModuleIdentity, Counter32, NotificationType, Unsigned32, Counter64, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "MibIdentifier", "ModuleIdentity", "Counter32", "NotificationType", "Unsigned32", "Counter64", "ObjectIdentity", "IpAddress")
RowPointer, AutonomousType, TimeStamp, TruthValue, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdType=scsiLuIdType, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiCompliances=scsiCompliances, scsiTranportOther=scsiTranportOther, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdValue=scsiLuIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTransportFCP=scsiTransportFCP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiNotifications=scsiNotifications, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortEntry=scsiPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiInitiator=scsiInitiator, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportSRP=scsiTransportSRP, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiLuIdTable=scsiLuIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceTable=scsiDeviceTable, ScsiName=ScsiName, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTarget=scsiTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInResets=scsiLuInResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuVendorId=scsiLuVendorId, scsiLuStatus=scsiLuStatus, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiObjects=scsiObjects, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiGroups=scsiGroups, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceGroup=scsiDeviceGroup, ScsiIdValue=ScsiIdValue, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiModule=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapEntry=scsiLunMapEntry, ScsiIdentifier=ScsiIdentifier, scsiGeneral=scsiGeneral, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdType=ScsiIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs)
