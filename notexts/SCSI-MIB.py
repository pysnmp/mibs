...
ModuleIdentity, Bits, IpAddress, Unsigned32, NotificationType, Integer32, iso, Counter64, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "IpAddress", "Unsigned32", "NotificationType", "Integer32", "iso", "Counter64", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "ObjectIdentity", "Counter32")
RowStatus, RowPointer, TextualConvention, TruthValue, AutonomousType, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuTable=scsiLuTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstAlias=scsiInstAlias, scsiDscTgtName=scsiDscTgtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapTable=scsiLunMapTable, scsiGroups=scsiGroups, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortRole=scsiPortRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLuState=scsiLuState, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiName=ScsiName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiCompliance=scsiCompliance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdType=scsiLuIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiTrnsptEntry=scsiTrnsptEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstIndex=scsiInstIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceTable=scsiInstanceTable, scsiPortTable=scsiPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapGroup=scsiLunMapGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdTable=scsiLuIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportSPI=scsiTranportSPI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportOther=scsiTranportOther, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrIndex=scsiAuthIntrIndex, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiConformance=scsiConformance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliances=scsiCompliances, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable)
