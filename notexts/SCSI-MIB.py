...
MibIdentifier, NotificationType, Bits, ObjectIdentity, TimeTicks, Gauge32, Counter64, Unsigned32, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "Gauge32", "Counter64", "Unsigned32", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "IpAddress")
AutonomousType, TruthValue, RowPointer, RowStatus, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "RowPointer", "RowStatus", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiCompliance=scsiCompliance, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiGeneral=scsiGeneral, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceTable=scsiDeviceTable, scsiLuTable=scsiLuTable, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiInitiator=scsiInitiator, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdValue=scsiLuIdValue, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, scsiLuEntry=scsiLuEntry, scsiPortEntry=scsiPortEntry, scsiTranportOther=scsiTranportOther, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunTable=scsiDscLunTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiObjects=scsiObjects, scsiLuProductId=scsiLuProductId, scsiLuIdType=scsiLuIdType, scsiTransportSRP=scsiTransportSRP, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortName=scsiTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortRole=scsiPortRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscTgtIndex=scsiDscTgtIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtName=scsiIntrPrtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdentifier=ScsiIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdType=ScsiIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceResets=scsiDeviceResets, scsiPortIndex=scsiPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiLuVendorId=scsiLuVendorId, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, PYSNMP_MODULE_ID=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapGroup=scsiLunMapGroup, scsiTransportFCP=scsiTransportFCP, scsiLunMapEntry=scsiLunMapEntry, ScsiIdValue=ScsiIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTable=scsiPortTable, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured)
