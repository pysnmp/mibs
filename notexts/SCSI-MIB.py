...
TimeTicks, mib_2, MibIdentifier, Bits, Counter32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, IpAddress, Unsigned32, Gauge32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "mib-2", "MibIdentifier", "Bits", "Counter32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "Gauge32", "Counter64", "Integer32")
TimeStamp, DisplayString, RowStatus, TruthValue, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TruthValue", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiObjects=scsiObjects, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdentifier=ScsiIdentifier, ScsiIdType=ScsiIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiGroups=scsiGroups, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapTable=scsiLunMapTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuVendorId=scsiLuVendorId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWwnName=scsiLuWwnName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiModule=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTransportFCP=scsiTransportFCP, scsiLuTable=scsiLuTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortRole=scsiPortRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtName=scsiDscTgtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortTable=scsiPortTable, scsiLuStatus=scsiLuStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceTable=scsiDeviceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstAlias=scsiInstAlias, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, ScsiIndexValue=ScsiIndexValue, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceRole=scsiDeviceRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortEntry=scsiPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLun=scsiLunMapLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceResets=scsiDeviceResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiInitiator=scsiInitiator, scsiLuInResets=scsiLuInResets, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiCompliances=scsiCompliances, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstIndex=scsiInstIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdValue=ScsiIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort)
