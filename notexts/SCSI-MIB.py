...
NotificationType, iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Unsigned32, mib_2, MibIdentifier, ObjectIdentity, ModuleIdentity, Integer32, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Unsigned32", "mib-2", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Integer32", "IpAddress", "TimeTicks")
TimeStamp, TextualConvention, RowStatus, DisplayString, TruthValue, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiConformance=scsiConformance, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuProductId=scsiLuProductId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtName=scsiIntrPrtName, scsiPortTable=scsiPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdType=scsiLuIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiator=scsiInitiator, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdentifier=ScsiIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortName=scsiTgtPortName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdType=ScsiIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtName=scsiDscTgtName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapTable=scsiLunMapTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiModule=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, scsiTargetGroup=scsiTargetGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiPortEntry=scsiPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceTable=scsiInstanceTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceRole=scsiDeviceRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValue=ScsiIndexValue, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiNotifications=scsiNotifications, scsiLogicalUnit=scsiLogicalUnit, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceAlias=scsiDeviceAlias, scsiGeneral=scsiGeneral, scsiDeviceResets=scsiDeviceResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportTypes=scsiTransportTypes, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortRole=scsiPortRole, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, ScsiIdValue=ScsiIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIndex=scsiLuIndex, scsiLuWwnName=scsiLuWwnName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiTranportOther=scsiTranportOther, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiPortIndex=scsiPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, scsiInstAlias=scsiInstAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation)
