...
Counter64, MibIdentifier, mib_2, ModuleIdentity, Unsigned32, Gauge32, NotificationType, Integer32, Bits, ObjectIdentity, TimeTicks, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "mib-2", "ModuleIdentity", "Unsigned32", "Gauge32", "NotificationType", "Integer32", "Bits", "ObjectIdentity", "TimeTicks", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
RowStatus, TimeStamp, DisplayString, AutonomousType, TextualConvention, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "AutonomousType", "TextualConvention", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiLuProductId=scsiLuProductId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiGroups=scsiGroups, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceRole=scsiDeviceRole, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTarget=scsiTarget, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdType=scsiLuIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLun=scsiLunMapLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiLuState=scsiLuState, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiTgtPortTable=scsiTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, PYSNMP_MODULE_ID=scsiModule, scsiObjects=scsiObjects, scsiInstanceEntry=scsiInstanceEntry, scsiCompliances=scsiCompliances, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdIndex=scsiLuIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiTargetGroup=scsiTargetGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportOther=scsiTranportOther, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdValue=ScsiIdValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdType=ScsiIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstIndex=scsiInstIndex, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuTable=scsiLuTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx)
