...
Unsigned32, Counter32, Integer32, ModuleIdentity, TimeTicks, NotificationType, ObjectIdentity, IpAddress, MibIdentifier, Counter64, iso, mib_2, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Integer32", "ModuleIdentity", "TimeTicks", "NotificationType", "ObjectIdentity", "IpAddress", "MibIdentifier", "Counter64", "iso", "mib-2", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, AutonomousType, TextualConvention, TimeStamp, TruthValue, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp", "TruthValue", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptIndex=scsiTrnsptIndex, PYSNMP_MODULE_ID=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiName=ScsiName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiInstAlias=scsiInstAlias, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortEntry=scsiTgtPortEntry, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiTranportSPI=scsiTranportSPI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuState=scsiLuState, scsiTargetGroup=scsiTargetGroup, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuVendorId=scsiLuVendorId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiLuEntry=scsiLuEntry, scsiDeviceTable=scsiDeviceTable, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunTable=scsiDscLunTable, scsiLuStatus=scsiLuStatus, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, scsiTransportTypes=scsiTransportTypes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceTable=scsiInstanceTable, scsiLunMapEntry=scsiLunMapEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTransportISCSI=scsiTransportISCSI, ScsiIdType=ScsiIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuTable=scsiLuTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIndex=scsiLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiConformance=scsiConformance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIndexValue=ScsiIndexValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuProductId=scsiLuProductId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiNotifications=scsiNotifications)
