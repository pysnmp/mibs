...
TimeTicks, IpAddress, MibIdentifier, NotificationType, Integer32, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Bits, Counter64, Counter32, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Bits", "Counter64", "Counter32", "Unsigned32", "mib-2")
TruthValue, TextualConvention, TimeStamp, DisplayString, AutonomousType, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiName=ScsiName, scsiTransportTypes=scsiTransportTypes, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdValue=ScsiIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIndex=scsiLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiDeviceIndex=scsiDeviceIndex, scsiPortEntry=scsiPortEntry, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatus=scsiLuStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortRole=scsiPortRole, scsiLuWwnName=scsiLuWwnName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortIndex=scsiPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunTable=scsiDscLunTable, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptTable=scsiTrnsptTable, ScsiIdAssociation=ScsiIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiInstAlias=scsiInstAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiator=scsiInitiator, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunLun=scsiDscLunLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuProductId=scsiLuProductId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGroups=scsiGroups, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTable=scsiPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuInResets=scsiLuInResets, scsiCompliances=scsiCompliances, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTranportOther=scsiTranportOther, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuState=scsiLuState, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes)
