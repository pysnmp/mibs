...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, mib_2, NotificationType, Unsigned32, Integer32, IpAddress, ObjectIdentity, MibIdentifier, iso, Bits, ModuleIdentity, Counter32, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "mib-2", "NotificationType", "Unsigned32", "Integer32", "IpAddress", "ObjectIdentity", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "Counter32", "TimeTicks", "Gauge32")
TruthValue, RowStatus, DisplayString, TimeStamp, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdType=scsiDscLunIdType, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSRP=scsiTransportSRP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdValue=ScsiIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstanceTable=scsiInstanceTable, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiModule=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuState=scsiLuState, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiator=scsiInitiator, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceEntry=scsiInstanceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdTable=scsiLuIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiLuInCommands=scsiLuInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunTable=scsiDscLunTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGroups=scsiGroups, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuPeripheralType=scsiLuPeripheralType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportSPI=scsiTranportSPI, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, ScsiIdentifier=ScsiIdentifier, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotifications=scsiNotifications, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiCompliance=scsiCompliance, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiObjects=scsiObjects)
