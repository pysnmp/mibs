...
ModuleIdentity, Bits, Gauge32, mib_2, iso, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter64, Counter32, Unsigned32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Gauge32", "mib-2", "iso", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter64", "Counter32", "Unsigned32", "Integer32", "IpAddress")
TimeStamp, TruthValue, AutonomousType, RowStatus, DisplayString, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiObjects=scsiObjects, scsiTgtDevTable=scsiTgtDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiNotifications=scsiNotifications, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, ScsiIdType=ScsiIdType, scsiLuInResets=scsiLuInResets, scsiTranportSPI=scsiTranportSPI, ScsiIdentifier=ScsiIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiLuIndex=scsiLuIndex, scsiDscLunTable=scsiDscLunTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuProductId=scsiLuProductId, scsiPortTable=scsiPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortName=scsiTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortRole=scsiPortRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuVendorId=scsiLuVendorId, scsiLuState=scsiLuState, scsiInstanceTable=scsiInstanceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTarget=scsiTarget, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtTable=scsiDscTgtTable, scsiInstAlias=scsiInstAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliances=scsiCompliances, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiPortIndex=scsiPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceEntry=scsiInstanceEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLun=scsiLunMapLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiConformance=scsiConformance, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtName=scsiDscTgtName, scsiLuIdType=scsiLuIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdEntry=scsiLuIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuTable=scsiLuTable, scsiDscLunIndex=scsiDscLunIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiLuStatus=scsiLuStatus, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiLuIdValue=scsiLuIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdTable=scsiLuIdTable)
