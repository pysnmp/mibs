...
ObjectIdentity, Bits, Unsigned32, Integer32, MibIdentifier, NotificationType, ModuleIdentity, Counter32, IpAddress, Counter64, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "Integer32", "MibIdentifier", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "Counter64", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso")
TruthValue, TimeStamp, DisplayString, RowStatus, TextualConvention, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "RowStatus", "TextualConvention", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortIndex=scsiPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortRole=scsiPortRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceRole=scsiDeviceRole, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiator=scsiInitiator, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevTable=scsiTgtDevTable, scsiCompliances=scsiCompliances, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuRevisionId=scsiLuRevisionId, ScsiIdType=ScsiIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuState=scsiLuState, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiInstAlias=scsiInstAlias, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiNotifications=scsiNotifications, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdentifier=ScsiIdentifier, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIndex=scsiLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportISCSI=scsiTransportISCSI, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiObjects=scsiObjects, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSBP=scsiTransportSBP, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, ScsiIdValue=ScsiIdValue, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiConformance=scsiConformance, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstIndex=scsiInstIndex, scsiLuIdType=scsiLuIdType, scsiLuPeripheralType=scsiLuPeripheralType, ScsiNameIdOrZero=ScsiNameIdOrZero)
