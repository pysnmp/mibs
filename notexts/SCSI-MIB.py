...
TimeTicks, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, MibIdentifier, Integer32, Gauge32, ModuleIdentity, mib_2, IpAddress, iso, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "mib-2", "IpAddress", "iso", "Bits", "Unsigned32")
RowPointer, TimeStamp, TextualConvention, DisplayString, RowStatus, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportFCP=scsiTransportFCP, scsiDeviceTable=scsiDeviceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortName=scsiTgtPortName, scsiModule=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, PYSNMP_MODULE_ID=scsiModule, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, ScsiIdCodeSet=ScsiIdCodeSet, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLuIndex=scsiLuIndex, scsiPortTable=scsiPortTable, scsiLuIdValue=scsiLuIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortEntry=scsiPortEntry, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetGroup=scsiTargetGroup, scsiTrnsptType=scsiTrnsptType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceRole=scsiDeviceRole, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdType=scsiLuIdType, scsiCompliance=scsiCompliance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiGroups=scsiGroups, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiInstAlias=scsiInstAlias, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotifications=scsiNotifications, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtName=scsiIntrPrtName, ScsiIdValue=ScsiIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevTable=scsiTgtDevTable, scsiInitiator=scsiInitiator, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiLuWwnName=scsiLuWwnName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInCommands=scsiLuInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId)
