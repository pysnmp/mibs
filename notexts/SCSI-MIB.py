...
mib_2, TimeTicks, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Integer32, Bits, Unsigned32, Gauge32, IpAddress, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Integer32", "Bits", "Unsigned32", "Gauge32", "IpAddress", "Counter64", "Counter32")
RowPointer, TimeStamp, DisplayString, RowStatus, AutonomousType, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrName=scsiAuthIntrName, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuState=scsiLuState, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtName=scsiIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceTable=scsiInstanceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiTranportOther=scsiTranportOther, scsiInitiator=scsiInitiator, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, scsiPortEntry=scsiPortEntry, scsiInstIndex=scsiInstIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapLun=scsiLunMapLun, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, scsiLuStatus=scsiLuStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortTable=scsiPortTable, scsiConformance=scsiConformance, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiCompliances=scsiCompliances, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstAlias=scsiInstAlias, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuIndex=scsiLuIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuProductId=scsiLuProductId, scsiTransportFCP=scsiTransportFCP, scsiLuTable=scsiLuTable, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInCommands=scsiLuInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevTable=scsiTgtDevTable, scsiTarget=scsiTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortRole=scsiPortRole, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiName=ScsiName, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets)
