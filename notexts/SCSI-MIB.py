...
Bits, MibIdentifier, mib_2, TimeTicks, Integer32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ObjectIdentity, NotificationType, Unsigned32, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "mib-2", "TimeTicks", "Integer32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "Gauge32")
DisplayString, TimeStamp, TruthValue, RowPointer, RowStatus, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "RowPointer", "RowStatus", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSBP=scsiTransportSBP, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiInstAlias=scsiInstAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiator=scsiInitiator, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiCompliances=scsiCompliances, ScsiIdType=ScsiIdType, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiObjects=scsiObjects, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuState=scsiLuState, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuVendorId=scsiLuVendorId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdType=scsiLuIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdentifier=ScsiIdentifier, scsiLuIdTable=scsiLuIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGroups=scsiGroups, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiName=ScsiName, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunTable=scsiDscLunTable, scsiLuInResets=scsiLuInResets, scsiDscLunIndex=scsiDscLunIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunLun=scsiDscLunLun, scsiTgtPortName=scsiTgtPortName, scsiPortIndex=scsiPortIndex, scsiLuIndex=scsiLuIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiTransportSRP=scsiTransportSRP, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiTransportFCP=scsiTransportFCP, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLuDefaultLun=scsiLuDefaultLun, PYSNMP_MODULE_ID=scsiModule, scsiInstIndex=scsiInstIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuInCommands=scsiLuInCommands, scsiConformance=scsiConformance, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes)
