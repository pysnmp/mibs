...
IpAddress, Unsigned32, mib_2, Integer32, Counter64, MibIdentifier, Counter32, NotificationType, ModuleIdentity, iso, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "mib-2", "Integer32", "Counter64", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "iso", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32")
TruthValue, RowPointer, AutonomousType, TimeStamp, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuTable=scsiLuTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortIndex=scsiPortIndex, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstIndex=scsiInstIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptPointer=scsiTrnsptPointer, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportOther=scsiTranportOther, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtName=scsiDscTgtName, scsiTransportTypes=scsiTransportTypes, ScsiIdType=ScsiIdType, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdType=scsiLuIdType, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, ScsiName=ScsiName, scsiLuProductId=scsiLuProductId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortTable=scsiPortTable, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliance=scsiCompliance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, ScsiIdValue=ScsiIdValue, scsiInitiator=scsiInitiator, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLuEntry=scsiLuEntry, scsiLuDefaultLun=scsiLuDefaultLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdentifier=ScsiIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortEntry=scsiPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortName=scsiTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatus=scsiLuStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiGroups=scsiGroups, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSBP=scsiTransportSBP, scsiLuInResets=scsiLuInResets, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportSPI=scsiTranportSPI)
