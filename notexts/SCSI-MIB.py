...
MibIdentifier, Gauge32, mib_2, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, ObjectIdentity, Counter32, ModuleIdentity, Unsigned32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "mib-2", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "ObjectIdentity", "Counter32", "ModuleIdentity", "Unsigned32", "Integer32", "iso")
TextualConvention, TruthValue, TimeStamp, AutonomousType, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "AutonomousType", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, ScsiIdType=ScsiIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTgtPortName=scsiTgtPortName, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiTransportFCP=scsiTransportFCP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiLuState=scsiLuState, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiTarget=scsiTarget, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiTransportSBP=scsiTransportSBP, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtTable=scsiIntrPrtTable, scsiNotifications=scsiNotifications, scsiLuInResets=scsiLuInResets, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapTable=scsiLunMapTable, scsiDeviceEntry=scsiDeviceEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiPortRole=scsiPortRole, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiCompliances=scsiCompliances, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiConformance=scsiConformance, scsiDeviceResets=scsiDeviceResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevEntry=scsiIntrDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstAlias=scsiInstAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdentifier=ScsiIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuStatus=scsiLuStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuEntry=scsiLuEntry, scsiDeviceRole=scsiDeviceRole, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuTable=scsiLuTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGeneral=scsiGeneral)
