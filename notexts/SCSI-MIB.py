...
NotificationType, MibIdentifier, mib_2, ObjectIdentity, IpAddress, Unsigned32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, iso, Counter32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "mib-2", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "iso", "Counter32", "Gauge32", "TimeTicks")
TextualConvention, RowStatus, TruthValue, DisplayString, AutonomousType, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportOther=scsiTranportOther, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortIndex=scsiPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapTable=scsiLunMapTable, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstIndex=scsiInstIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiTarget=scsiTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdType=ScsiIdType, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValue=ScsiIndexValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, ScsiIdValue=ScsiIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiDscLunTable=scsiDscLunTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceResets=scsiDeviceResets, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptType=scsiTrnsptType, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiTgtPortName=scsiTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortEntry=scsiPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiIntrPrtName=scsiIntrPrtName, ScsiIdAssociation=ScsiIdAssociation, scsiInitiator=scsiInitiator, scsiInstAlias=scsiInstAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiCompliances=scsiCompliances, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiLuStatus=scsiLuStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTable=scsiPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands)
