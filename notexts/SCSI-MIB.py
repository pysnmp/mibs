...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Integer32, ModuleIdentity, mib_2, NotificationType, ObjectIdentity, Counter64, iso, TimeTicks, Counter32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Integer32", "ModuleIdentity", "mib-2", "NotificationType", "ObjectIdentity", "Counter64", "iso", "TimeTicks", "Counter32", "IpAddress", "Bits")
TruthValue, RowStatus, TextualConvention, TimeStamp, RowPointer, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiInstAlias=scsiInstAlias, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiIntrPrtName=scsiIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiLuProductId=scsiLuProductId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuState=scsiLuState, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiPortRole=scsiPortRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTranportSPI=scsiTranportSPI, scsiLuIdType=scsiLuIdType, scsiLuRevisionId=scsiLuRevisionId, scsiLuVendorId=scsiLuVendorId, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWwnName=scsiLuWwnName, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiModule=scsiModule, scsiNotifications=scsiNotifications, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiLuInResets=scsiLuInResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTarget=scsiTarget, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortEntry=scsiPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapTable=scsiLunMapTable, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatus=scsiLuStatus, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdType=ScsiIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceAlias=scsiDeviceAlias, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdTable=scsiDscLunIdTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, scsiIntrDevEntry=scsiIntrDevEntry, scsiObjects=scsiObjects)
