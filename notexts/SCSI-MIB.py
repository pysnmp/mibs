...
Bits, IpAddress, Gauge32, Unsigned32, Integer32, NotificationType, ModuleIdentity, Counter32, Counter64, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Gauge32", "Unsigned32", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "Counter64", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "ObjectIdentity")
TimeStamp, TextualConvention, TruthValue, DisplayString, RowStatus, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "DisplayString", "RowStatus", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWwnName=scsiLuWwnName, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInCommands=scsiLuInCommands, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValue=ScsiIndexValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceTable=scsiDeviceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiLuIndex=scsiLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuEntry=scsiLuEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiModule=scsiModule, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTarget=scsiTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdTable=scsiLuIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatus=scsiLuStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdType=ScsiIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiObjects=scsiObjects, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdIndex=scsiLuIdIndex, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLun=scsiLunMapLun, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliances=scsiCompliances, scsiTrnsptPointer=scsiTrnsptPointer, ScsiName=ScsiName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdType=scsiLuIdType, scsiNotifications=scsiNotifications, scsiTransportSRP=scsiTransportSRP, scsiInstAlias=scsiInstAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, ScsiIdValue=ScsiIdValue, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiTgtPortName=scsiTgtPortName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry)
