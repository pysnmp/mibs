...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32, Counter64, MibIdentifier, TimeTicks, ObjectIdentity, Unsigned32, Bits, IpAddress, mib_2, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Unsigned32", "Bits", "IpAddress", "mib-2", "NotificationType", "Gauge32")
RowStatus, DisplayString, TimeStamp, RowPointer, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "RowPointer", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiConformance=scsiConformance, scsiTransportSRP=scsiTransportSRP, scsiDscLunLun=scsiDscLunLun, scsiLunMapTable=scsiLunMapTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, ScsiIdValue=ScsiIdValue, scsiAuthIntrName=scsiAuthIntrName, scsiInitiator=scsiInitiator, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiModule=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdTable=scsiDscLunIdTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortEntry=scsiPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTarget=scsiTarget, scsiLuProductId=scsiLuProductId, scsiLuTable=scsiLuTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiNotifications=scsiNotifications, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapIndex=scsiLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiInstAlias=scsiInstAlias, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, PYSNMP_MODULE_ID=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIndex=scsiLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiTransportISCSI=scsiTransportISCSI, scsiGeneral=scsiGeneral, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiObjects=scsiObjects, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiName=ScsiName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGroups=scsiGroups, ScsiIndexValue=ScsiIndexValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTable=scsiPortTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapEntry=scsiLunMapEntry, scsiInstIndex=scsiInstIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortRole=scsiPortRole, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevEntry=scsiTgtDevEntry, scsiTranportOther=scsiTranportOther, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWwnName=scsiLuWwnName, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapGroup=scsiLunMapGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteTarget=scsiRemoteTarget)
