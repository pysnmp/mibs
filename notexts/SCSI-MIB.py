...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Unsigned32, Gauge32, Bits, TimeTicks, iso, ObjectIdentity, NotificationType, ModuleIdentity, Counter64, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "Bits", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter64", "mib-2", "Integer32")
AutonomousType, TimeStamp, DisplayString, RowPointer, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "DisplayString", "RowPointer", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiDscTgtName=scsiDscTgtName, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuVendorId=scsiLuVendorId, scsiGeneral=scsiGeneral, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTarget=scsiTarget, scsiTransportTypes=scsiTransportTypes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptPointer=scsiTrnsptPointer, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportISCSI=scsiTransportISCSI, scsiGroups=scsiGroups, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiName=ScsiName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiObjects=scsiObjects, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceEntry=scsiInstanceEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiDeviceRole=scsiDeviceRole, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiLuIdType=scsiLuIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiModule=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiCompliances=scsiCompliances, scsiLuProductId=scsiLuProductId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuEntry=scsiLuEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiLuStatus=scsiLuStatus, scsiTranportOther=scsiTranportOther, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapTable=scsiLunMapTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiPortTable=scsiPortTable, ScsiIdType=ScsiIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiPortEntry=scsiPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportSPI=scsiTranportSPI)
