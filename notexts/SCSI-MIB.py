...
ModuleIdentity, Gauge32, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, NotificationType, Bits, Counter32, Counter64, iso, ObjectIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "NotificationType", "Bits", "Counter32", "Counter64", "iso", "ObjectIdentity", "IpAddress", "Unsigned32")
DisplayString, AutonomousType, TimeStamp, RowPointer, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdValue=ScsiIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiCompliance=scsiCompliance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiCompliances=scsiCompliances, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapTable=scsiLunMapTable, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortIndex=scsiPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGroups=scsiGroups, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceRole=scsiDeviceRole, scsiLuVendorId=scsiLuVendorId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiConformance=scsiConformance, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiObjects=scsiObjects, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiRemoteTarget=scsiRemoteTarget, scsiLuInResets=scsiLuInResets, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptType=scsiTrnsptType, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiPortEntry=scsiPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetGroup=scsiTargetGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevEntry=scsiIntrDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceResets=scsiDeviceResets, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiInstAlias=scsiInstAlias, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunEntry=scsiDscLunEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, ScsiIdType=ScsiIdType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdTable=scsiLuIdTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportTypes=scsiTransportTypes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiModule=scsiModule, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortRole=scsiPortRole, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdTable=scsiDscLunIdTable, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
