...
Bits, MibIdentifier, NotificationType, Integer32, iso, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, Counter64, ObjectIdentity, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "Integer32", "iso", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "mib-2", "Unsigned32")
TruthValue, RowPointer, RowStatus, AutonomousType, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiLuInResets=scsiLuInResets, scsiTgtDevTable=scsiTgtDevTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiCompliances=scsiCompliances, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatus=scsiLuStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdType=scsiLuIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortIndex=scsiPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiName=ScsiName, scsiLunMapLun=scsiLunMapLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiGroups=scsiGroups, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGeneral=scsiGeneral, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, scsiLuInCommands=scsiLuInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiTarget=scsiTarget, scsiLunMapEntry=scsiLunMapEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiDeviceResets=scsiDeviceResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValue=ScsiIndexValue, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiLuRevisionId=scsiLuRevisionId, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTranportOther=scsiTranportOther)
