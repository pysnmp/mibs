...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Gauge32, mib_2, iso, Counter64, ModuleIdentity, Bits, MibIdentifier, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Gauge32", "mib-2", "iso", "Counter64", "ModuleIdentity", "Bits", "MibIdentifier", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter32")
TruthValue, RowStatus, RowPointer, TimeStamp, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtName=scsiDscTgtName, ScsiIdAssociation=ScsiIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIndex=scsiLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportISCSI=scsiTransportISCSI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstIndex=scsiInstIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdType=scsiLuIdType, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiLuProductId=scsiLuProductId, scsiLuDefaultLun=scsiLuDefaultLun, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuState=scsiLuState, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiInstanceEntry=scsiInstanceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportOther=scsiTranportOther, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceRole=scsiDeviceRole, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTargetGroup=scsiTargetGroup, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdValue=scsiLuIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInResets=scsiLuInResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevTable=scsiTgtDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiLuStatus=scsiLuStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInCommands=scsiLuInCommands, scsiGeneral=scsiGeneral, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiModule=scsiModule, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiInitiator=scsiInitiator, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiTarget=scsiTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes)
