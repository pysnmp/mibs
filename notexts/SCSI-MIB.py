...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, Integer32, NotificationType, ModuleIdentity, Bits, MibIdentifier, TimeTicks, Gauge32, Counter64, ObjectIdentity, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "Integer32", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "Counter64", "ObjectIdentity", "iso", "IpAddress")
RowStatus, DisplayString, TruthValue, TextualConvention, RowPointer, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "RowPointer", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiator=scsiInitiator, scsiNotifications=scsiNotifications, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliances=scsiCompliances, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuState=scsiLuState, scsiPortTable=scsiPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiModule=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceTable=scsiInstanceTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapLun=scsiLunMapLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuEntry=scsiLuEntry, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatus=scsiLuStatus, scsiDeviceIndex=scsiDeviceIndex, ScsiName=ScsiName, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiConformance=scsiConformance, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtName=scsiDscTgtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInResets=scsiLuInResets, ScsiIdType=ScsiIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiObjects=scsiObjects, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapIndex=scsiLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuTable=scsiLuTable, scsiPortIndex=scsiPortIndex, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortRole=scsiPortRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSRP=scsiTransportSRP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiGeneral=scsiGeneral, scsiDscLunIndex=scsiDscLunIndex, ScsiIdCodeSet=ScsiIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceRole=scsiDeviceRole, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortName=scsiTgtPortName, scsiLuIdValue=scsiLuIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceEntry=scsiInstanceEntry, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtTable=scsiDscTgtTable)
