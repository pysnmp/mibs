...
Unsigned32, Counter32, mib_2, MibIdentifier, TimeTicks, NotificationType, Counter64, iso, ObjectIdentity, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "mib-2", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "iso", "ObjectIdentity", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiInitiator=scsiInitiator, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrName=scsiAuthIntrName, scsiGeneral=scsiGeneral, scsiTarget=scsiTarget, scsiModule=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortRole=scsiPortRole, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTranportOther=scsiTranportOther, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstIndex=scsiInstIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInCommands=scsiLuInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiLuVendorId=scsiLuVendorId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiName=ScsiName, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiLuProductId=scsiLuProductId, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuEntry=scsiLuEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdType=scsiLuIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceIndex=scsiDeviceIndex, scsiNotifications=scsiNotifications, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapLun=scsiLunMapLun, scsiPortIndex=scsiPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiTransportTypes=scsiTransportTypes, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, scsiTrnsptTable=scsiTrnsptTable, ScsiIdAssociation=ScsiIdAssociation, scsiCompliances=scsiCompliances, scsiLuStatus=scsiLuStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGroups=scsiGroups, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiObjects=scsiObjects, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValue=ScsiIndexValue, scsiTranportSPI=scsiTranportSPI, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportFCP=scsiTransportFCP, scsiInstAlias=scsiInstAlias, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTransportSRP=scsiTransportSRP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiLuState=scsiLuState, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged)
