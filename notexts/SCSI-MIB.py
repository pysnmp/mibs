...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Bits, Unsigned32, NotificationType, Counter32, mib_2, IpAddress, ModuleIdentity, Integer32, MibIdentifier, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "Counter32", "mib-2", "IpAddress", "ModuleIdentity", "Integer32", "MibIdentifier", "TimeTicks", "iso", "Counter64")
TimeStamp, DisplayString, RowStatus, TruthValue, AutonomousType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "TruthValue", "AutonomousType", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortName=scsiTgtPortName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGeneral=scsiGeneral, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunTable=scsiDscLunTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceRole=scsiDeviceRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiator=scsiInitiator, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiLunMapTable=scsiLunMapTable, scsiLuWwnName=scsiLuWwnName, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortRole=scsiPortRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortName=scsiAttTgtPortName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTranportOther=scsiTranportOther, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiModule=scsiModule, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiInstanceTable=scsiInstanceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtTable=scsiDscTgtTable, scsiInstIndex=scsiInstIndex, scsiLuIdValue=scsiLuIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetGroup=scsiTargetGroup, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiConformance=scsiConformance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportFCP=scsiTransportFCP, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuStatus=scsiLuStatus, scsiLunMapLun=scsiLunMapLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTarget=scsiTarget, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIndex=scsiLuIndex, scsiInstAlias=scsiInstAlias, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortEntry=scsiPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtName=scsiIntrPrtName, ScsiName=ScsiName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuState=scsiLuState)
