...
TimeTicks, Counter64, Gauge32, Bits, NotificationType, ObjectIdentity, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, MibIdentifier, ModuleIdentity, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Gauge32", "Bits", "NotificationType", "ObjectIdentity", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress", "Counter32")
DisplayString, AutonomousType, RowPointer, RowStatus, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowPointer", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetGroup=scsiTargetGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuEntry=scsiLuEntry, scsiTransportFCP=scsiTransportFCP, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiObjects=scsiObjects, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiConformance=scsiConformance, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiLuState=scsiLuState, scsiDscTgtTable=scsiDscTgtTable, scsiLuInResets=scsiLuInResets, scsiDscTgtInCommands=scsiDscTgtInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceResets=scsiDeviceResets, scsiLuIdType=scsiLuIdType, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiGeneral=scsiGeneral, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiInitiator=scsiInitiator, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdEntry=scsiLuIdEntry, scsiInstAlias=scsiInstAlias, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdCodeSet=ScsiIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuProductId=scsiLuProductId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiPortRole=scsiPortRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiInstIndex=scsiInstIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiLuTable=scsiLuTable, scsiInstanceTable=scsiInstanceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotifications=scsiNotifications, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiCompliance=scsiCompliance, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiLuIndex=scsiLuIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortTable=scsiPortTable, scsiDscTgtName=scsiDscTgtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation)
