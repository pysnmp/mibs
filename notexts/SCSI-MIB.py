...
IpAddress, MibIdentifier, Integer32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Counter32, mib_2, Gauge32, ModuleIdentity, NotificationType, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Counter32", "mib-2", "Gauge32", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Bits")
DisplayString, TextualConvention, TruthValue, AutonomousType, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "AutonomousType", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuInCommands=scsiLuInCommands, scsiLunMapLun=scsiLunMapLun, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, ScsiIdType=ScsiIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTable=scsiPortTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuState=scsiLuState, scsiObjects=scsiObjects, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdCodeSet=ScsiIdCodeSet, scsiModule=scsiModule, scsiLuIndex=scsiLuIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortName=scsiTgtPortName, scsiLuDefaultLun=scsiLuDefaultLun, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuTable=scsiLuTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGroups=scsiGroups, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortEntry=scsiPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotifications=scsiNotifications, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiator=scsiInitiator, scsiInitiatorGroup=scsiInitiatorGroup, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiCompliances=scsiCompliances, scsiLuIdType=scsiLuIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiConformance=scsiConformance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdentifier=ScsiIdentifier, ScsiIdValue=ScsiIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapTable=scsiLunMapTable, scsiTarget=scsiTarget, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortRole=scsiPortRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdValue=scsiLuIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiPortIndex=scsiPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun)
