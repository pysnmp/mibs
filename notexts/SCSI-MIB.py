...
mib_2, NotificationType, ObjectIdentity, Bits, ModuleIdentity, iso, IpAddress, MibIdentifier, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "ObjectIdentity", "Bits", "ModuleIdentity", "iso", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks")
RowPointer, TextualConvention, TimeStamp, AutonomousType, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuProductId=scsiLuProductId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiGeneral=scsiGeneral, scsiGroups=scsiGroups, scsiDeviceRole=scsiDeviceRole, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiNotifications=scsiNotifications, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiObjects=scsiObjects, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliances=scsiCompliances, scsiTransportFCP=scsiTransportFCP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiPortIndex=scsiPortIndex, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstIndex=scsiInstIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTargetGroup=scsiTargetGroup, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunLun=scsiDscLunLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportOther=scsiTranportOther, ScsiIdType=ScsiIdType, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuTable=scsiLuTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIndex=scsiLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiName=ScsiName, scsiInitiator=scsiInitiator, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortRole=scsiPortRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunTable=scsiDscLunTable, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuInResets=scsiLuInResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiModule=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdType=scsiLuIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, ScsiIdValue=ScsiIdValue)
