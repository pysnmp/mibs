...
Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, IpAddress, Bits, NotificationType, ModuleIdentity, iso, ObjectIdentity, MibIdentifier, Counter64, TimeTicks, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "IpAddress", "Bits", "NotificationType", "ModuleIdentity", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "TimeTicks", "Integer32", "Counter32")
RowPointer, TruthValue, TimeStamp, AutonomousType, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "TimeStamp", "AutonomousType", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuState=scsiLuState, scsiCompliances=scsiCompliances, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstAlias=scsiInstAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportSRP=scsiTransportSRP, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunLun=scsiDscLunLun, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceResets=scsiDeviceResets, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiModule=scsiModule, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGroups=scsiGroups, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstIndex=scsiInstIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIndex=scsiLuIndex, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuEntry=scsiLuEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTable=scsiPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiConformance=scsiConformance, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportFCP=scsiTransportFCP, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGeneral=scsiGeneral, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuTable=scsiLuTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliance=scsiCompliance, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdIndex=scsiLuIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuInResets=scsiLuInResets, scsiInitiator=scsiInitiator, scsiInstanceTable=scsiInstanceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes)
