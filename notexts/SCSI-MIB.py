...
IpAddress, Gauge32, Counter64, TimeTicks, ModuleIdentity, iso, ObjectIdentity, Counter32, Integer32, mib_2, NotificationType, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Counter64", "TimeTicks", "ModuleIdentity", "iso", "ObjectIdentity", "Counter32", "Integer32", "mib-2", "NotificationType", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, DisplayString, AutonomousType, RowStatus, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiCompliances=scsiCompliances, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiGroups=scsiGroups, scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGeneral=scsiGeneral, scsiTransportSBP=scsiTransportSBP, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiInstAlias=scsiInstAlias, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceIndex=scsiDeviceIndex, scsiPortIndex=scsiPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiModule=scsiModule, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiPortTable=scsiPortTable, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapGroup=scsiLunMapGroup, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiConformance=scsiConformance, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceAlias=scsiDeviceAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuState=scsiLuState, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiTranportOther=scsiTranportOther, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapLun=scsiLunMapLun, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuProductId=scsiLuProductId, scsiLuEntry=scsiLuEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceResets=scsiDeviceResets, scsiTgtDevTable=scsiTgtDevTable, scsiPortRole=scsiPortRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTarget=scsiTarget, ScsiIdType=ScsiIdType, scsiLuVendorId=scsiLuVendorId, scsiLuDefaultLun=scsiLuDefaultLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValue=ScsiIndexValue, scsiDscLunTable=scsiDscLunTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdValue=scsiLuIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotifications=scsiNotifications, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex)
