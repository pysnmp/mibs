...
IpAddress, Bits, ObjectIdentity, Counter32, Counter64, Integer32, iso, MibIdentifier, Gauge32, Unsigned32, ModuleIdentity, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ObjectIdentity", "Counter32", "Counter64", "Integer32", "iso", "MibIdentifier", "Gauge32", "Unsigned32", "ModuleIdentity", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuInResets=scsiLuInResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiObjects=scsiObjects, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatus=scsiLuStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiConformance=scsiConformance, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstanceTable=scsiInstanceTable, scsiCompliances=scsiCompliances, scsiAuthIntrName=scsiAuthIntrName, scsiLuState=scsiLuState, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdIndex=scsiLuIdIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTarget=scsiTarget, scsiLuIdTable=scsiLuIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunTable=scsiDscLunTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdType=scsiLuIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuTable=scsiLuTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiTranportOther=scsiTranportOther, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiName=ScsiName, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortTable=scsiPortTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceIndex=scsiDeviceIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapEntry=scsiLunMapEntry, scsiPortRole=scsiPortRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportFCP=scsiTransportFCP, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiator=scsiInitiator, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptType=scsiTrnsptType, scsiInstAlias=scsiInstAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSRP=scsiTransportSRP, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiInstIndex=scsiInstIndex, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValue=ScsiIndexValue, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceAlias=scsiDeviceAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
