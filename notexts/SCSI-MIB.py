...
Gauge32, iso, TimeTicks, Unsigned32, MibIdentifier, ModuleIdentity, NotificationType, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, Bits, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "ModuleIdentity", "NotificationType", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "Bits", "ObjectIdentity", "Counter64")
TruthValue, TextualConvention, DisplayString, RowPointer, TimeStamp, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString", "RowPointer", "TimeStamp", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiModule=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiNotifications=scsiNotifications, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetGroup=scsiTargetGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliance=scsiCompliance, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, ScsiIdType=ScsiIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdValue=scsiLuIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliances=scsiCompliances, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiName=ScsiName, scsiDscTgtTable=scsiDscTgtTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunLun=scsiDscLunLun, scsiInstanceEntry=scsiInstanceEntry, ScsiIdentifier=ScsiIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiPortRole=scsiPortRole, scsiLunMapEntry=scsiLunMapEntry, scsiLuInResets=scsiLuInResets, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportOther=scsiTranportOther, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortTable=scsiTgtPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdValue=ScsiIdValue, scsiGeneral=scsiGeneral, scsiDscTgtName=scsiDscTgtName, scsiTranportSPI=scsiTranportSPI, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdType=scsiDscLunIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdType=scsiLuIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTarget=scsiTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuState=scsiLuState, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuWwnName=scsiLuWwnName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, ScsiLUNOrZero=ScsiLUNOrZero, scsiConformance=scsiConformance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLuProductId=scsiLuProductId, scsiLunMapTable=scsiLunMapTable, scsiDscLunIndex=scsiDscLunIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunEntry=scsiDscLunEntry)
