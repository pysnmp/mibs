...
mib_2, Gauge32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress, iso, Bits, TimeTicks, MibIdentifier, Counter64, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Gauge32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress", "iso", "Bits", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32", "ModuleIdentity")
RowPointer, RowStatus, TextualConvention, DisplayString, AutonomousType, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "DisplayString", "AutonomousType", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceAlias=scsiDeviceAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetGroup=scsiTargetGroup, scsiLuProductId=scsiLuProductId, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiInitiator=scsiInitiator, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceTable=scsiInstanceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtName=scsiIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiCompliances=scsiCompliances, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, ScsiIdValue=ScsiIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiGeneral=scsiGeneral, ScsiName=ScsiName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceIndex=scsiDeviceIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportSRP=scsiTransportSRP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuStatus=scsiLuStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortIndex=scsiPortIndex, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportOther=scsiTranportOther, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiConformance=scsiConformance, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiTransportFCP=scsiTransportFCP, scsiLuEntry=scsiLuEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInResets=scsiLuInResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiNotifications=scsiNotifications, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTransportISCSI=scsiTransportISCSI)
