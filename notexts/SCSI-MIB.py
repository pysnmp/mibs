...
ModuleIdentity, NotificationType, MibIdentifier, Unsigned32, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Integer32, iso, IpAddress, ObjectIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "MibIdentifier", "Unsigned32", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Integer32", "iso", "IpAddress", "ObjectIdentity", "Gauge32", "Counter32")
RowStatus, RowPointer, TruthValue, TimeStamp, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortTable=scsiTgtPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValue=ScsiIndexValue, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSBP=scsiTransportSBP, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortTable=scsiPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuProductId=scsiLuProductId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiName=ScsiName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiTargetGroup=scsiTargetGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotifications=scsiNotifications, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdIndex=scsiLuIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstIndex=scsiInstIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuWwnName=scsiLuWwnName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiInitiator=scsiInitiator, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiTransportFCP=scsiTransportFCP, scsiTarget=scsiTarget, scsiTranportOther=scsiTranportOther, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceGroup=scsiDeviceGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuPeripheralType=scsiLuPeripheralType, PYSNMP_MODULE_ID=scsiModule, scsiCompliances=scsiCompliances, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLogicalUnit=scsiLogicalUnit, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSRP=scsiTransportSRP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortName=scsiTgtPortName, scsiLuTable=scsiLuTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuEntry=scsiLuEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiObjects=scsiObjects)
