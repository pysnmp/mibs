...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, ModuleIdentity, iso, ObjectIdentity, IpAddress, Counter32, Counter64, Gauge32, TimeTicks, NotificationType, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "Counter32", "Counter64", "Gauge32", "TimeTicks", "NotificationType", "mib-2", "MibIdentifier")
TimeStamp, TruthValue, DisplayString, AutonomousType, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiTranportSPI=scsiTranportSPI, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapLun=scsiLunMapLun, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteTarget=scsiRemoteTarget, scsiInstAlias=scsiInstAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiator=scsiInitiator, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotifications=scsiNotifications, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceTable=scsiDeviceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiLuProductId=scsiLuProductId, scsiDeviceEntry=scsiDeviceEntry, scsiConformance=scsiConformance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortTable=scsiPortTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuInResets=scsiLuInResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunLun=scsiDscLunLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWwnName=scsiLuWwnName, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortTable=scsiTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, ScsiName=ScsiName, scsiTgtPortEntry=scsiTgtPortEntry, scsiGeneral=scsiGeneral, scsiTranportOther=scsiTranportOther, scsiDscLunEntry=scsiDscLunEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtName=scsiDscTgtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliances=scsiCompliances, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiPortEntry=scsiPortEntry, ScsiIdValue=ScsiIdValue, scsiGroups=scsiGroups, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiObjects=scsiObjects, scsiDeviceAlias=scsiDeviceAlias, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdValue=scsiLuIdValue, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTarget=scsiTarget, scsiTransportTypes=scsiTransportTypes, scsiModule=scsiModule, scsiPortIndex=scsiPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptDevName=scsiTrnsptDevName)
