...
IpAddress, mib_2, MibIdentifier, iso, Bits, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ObjectIdentity, NotificationType, Counter32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "mib-2", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ObjectIdentity", "NotificationType", "Counter32", "Counter64", "TimeTicks")
DisplayString, RowStatus, TextualConvention, AutonomousType, TruthValue, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "AutonomousType", "TruthValue", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiObjects=scsiObjects, scsiDeviceEntry=scsiDeviceEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiName=ScsiName, scsiNotifications=scsiNotifications, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceRole=scsiDeviceRole, scsiTransportFCP=scsiTransportFCP, scsiTrnsptType=scsiTrnsptType, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportSRP=scsiTransportSRP, ScsiIdValue=ScsiIdValue, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliances=scsiCompliances, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuEntry=scsiLuEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, scsiLuIdType=scsiLuIdType, scsiInstAlias=scsiInstAlias, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWwnName=scsiLuWwnName, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiTranportOther=scsiTranportOther, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuVendorId=scsiLuVendorId, scsiLuState=scsiLuState, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiModule=scsiModule, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiGeneral=scsiGeneral, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiConformance=scsiConformance, scsiLuInCommands=scsiLuInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliance=scsiCompliance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiPortRole=scsiPortRole, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiator=scsiInitiator, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus)
