...
TimeTicks, NotificationType, Unsigned32, Gauge32, Counter64, iso, Integer32, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, IpAddress, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "Counter64", "iso", "Integer32", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "IpAddress", "mib-2", "MibIdentifier")
RowStatus, TimeStamp, AutonomousType, RowPointer, DisplayString, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetGroup=scsiTargetGroup, scsiInitiator=scsiInitiator, scsiDscLunTable=scsiDscLunTable, scsiLuEntry=scsiLuEntry, scsiTransportSBP=scsiTransportSBP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtName=scsiDscTgtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotifications=scsiNotifications, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptType=scsiTrnsptType, scsiLunMapEntry=scsiLunMapEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceResets=scsiDeviceResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdType=ScsiIdType, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiName=ScsiName, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiInstanceEntry=scsiInstanceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiConformance=scsiConformance, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGroups=scsiGroups, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue, scsiLunMapTable=scsiLunMapTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliances=scsiCompliances, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdTable=scsiLuIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiTranportOther=scsiTranportOther, scsiIntrPrtName=scsiIntrPrtName)
