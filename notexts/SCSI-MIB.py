...
ModuleIdentity, mib_2, TimeTicks, ObjectIdentity, Bits, IpAddress, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Unsigned32, MibIdentifier, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "TimeTicks", "ObjectIdentity", "Bits", "IpAddress", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32")
TruthValue, TimeStamp, DisplayString, RowStatus, AutonomousType, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiObjects=scsiObjects, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiModule=scsiModule, scsiCompliance=scsiCompliance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSBP=scsiTransportSBP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceGroup=scsiDeviceGroup, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportTypes=scsiTransportTypes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiInstIndex=scsiInstIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliances=scsiCompliances, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdType=ScsiIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdType=scsiLuIdType, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiGroups=scsiGroups, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiDscLunTable=scsiDscLunTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevTable=scsiIntrDevTable, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiLuStatus=scsiLuStatus, scsiLuTable=scsiLuTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptType=scsiTrnsptType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortRole=scsiPortRole, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuVendorId=scsiLuVendorId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuEntry=scsiLuEntry, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiGeneral=scsiGeneral, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapLun=scsiLunMapLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiConformance=scsiConformance, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSRP=scsiTransportSRP, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceAlias=scsiDeviceAlias, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTranportOther=scsiTranportOther, scsiLuInResets=scsiLuInResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceResets=scsiDeviceResets)
