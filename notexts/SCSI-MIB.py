...
ModuleIdentity, Counter64, Integer32, Bits, MibIdentifier, ObjectIdentity, Gauge32, mib_2, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "Gauge32", "mib-2", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "IpAddress", "Unsigned32")
TruthValue, DisplayString, TimeStamp, RowStatus, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TimeStamp", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunTable=scsiDscLunTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiObjects=scsiObjects, scsiGroups=scsiGroups, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevTable=scsiTgtDevTable, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdentifier=ScsiIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortTable=scsiPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiConformance=scsiConformance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiName=ScsiName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliance=scsiCompliance, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortRole=scsiPortRole, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdTable=scsiLuIdTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuProductId=scsiLuProductId, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdType=ScsiIdType, ScsiIdAssociation=ScsiIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiator=scsiInitiator, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSBP=scsiTransportSBP, scsiTransportSRP=scsiTransportSRP, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, ScsiIdValue=ScsiIdValue, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuTable=scsiLuTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiLuState=scsiLuState, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, PYSNMP_MODULE_ID=scsiModule, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGeneral=scsiGeneral, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrName=scsiAuthIntrName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportSPI=scsiTranportSPI, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuInCommands=scsiLuInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiTransportFCP=scsiTransportFCP, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstIndex=scsiInstIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiInstanceTable=scsiInstanceTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapLun=scsiLunMapLun, scsiPortBusyStatuses=scsiPortBusyStatuses)
