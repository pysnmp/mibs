...
ModuleIdentity, ObjectIdentity, Bits, Gauge32, iso, Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, Counter32, mib_2, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Bits", "Gauge32", "iso", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "Counter32", "mib-2", "IpAddress", "Unsigned32")
RowPointer, RowStatus, TruthValue, TextualConvention, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIndex=scsiDscLunIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiModule=scsiModule, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIndex=scsiLuIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiLuIdIndex=scsiLuIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportFCP=scsiTransportFCP, ScsiIndexValue=ScsiIndexValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTranportOther=scsiTranportOther, scsiDscLunIdType=scsiDscLunIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuEntry=scsiLuEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdValue=ScsiIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIdentifier=ScsiIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiInstIndex=scsiInstIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiObjects=scsiObjects, scsiDscTgtIndex=scsiDscTgtIndex, scsiGeneral=scsiGeneral, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortRole=scsiPortRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiPortEntry=scsiPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSRP=scsiTransportSRP, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportSBP=scsiTransportSBP, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtName=scsiDscTgtName, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunTable=scsiDscLunTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiator=scsiInitiator, scsiTransportTypes=scsiTransportTypes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceAlias=scsiDeviceAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiCompliance=scsiCompliance, PYSNMP_MODULE_ID=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortIndex=scsiPortIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIdType=ScsiIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
