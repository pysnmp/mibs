...
NotificationType, TimeTicks, IpAddress, Integer32, iso, ModuleIdentity, Unsigned32, Gauge32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "IpAddress", "Integer32", "iso", "ModuleIdentity", "Unsigned32", "Gauge32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ObjectIdentity", "Counter64")
DisplayString, RowPointer, TimeStamp, TruthValue, AutonomousType, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TimeStamp", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiTranportSPI=scsiTranportSPI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLun=scsiLunMapLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInCommands=scsiLuInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetGroup=scsiTargetGroup, scsiLuIdType=scsiLuIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdType=scsiDscLunIdType, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevTable=scsiIntrDevTable, scsiConformance=scsiConformance, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuProductId=scsiLuProductId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiLuInResets=scsiLuInResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuTable=scsiLuTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuState=scsiLuState, scsiTrnsptTable=scsiTrnsptTable, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiPortTable=scsiPortTable, scsiTranportOther=scsiTranportOther, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapGroup=scsiLunMapGroup, ScsiIdType=ScsiIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiPortEntry=scsiPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdValue=scsiDscLunIdValue, scsiTarget=scsiTarget, scsiTransportTypes=scsiTransportTypes, ScsiIndexValue=ScsiIndexValue, scsiTransportSBP=scsiTransportSBP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiObjects=scsiObjects, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiLuEntry=scsiLuEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotifications=scsiNotifications, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceEntry=scsiInstanceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportFCP=scsiTransportFCP, scsiGroups=scsiGroups, scsiCompliance=scsiCompliance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier)
