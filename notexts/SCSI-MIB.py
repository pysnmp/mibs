...
mib_2, Bits, TimeTicks, ModuleIdentity, IpAddress, MibIdentifier, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ObjectIdentity, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "TimeTicks", "ModuleIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ObjectIdentity", "Counter64", "iso", "Integer32")
AutonomousType, RowPointer, DisplayString, TruthValue, RowStatus, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInCommands=scsiLuInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortIndex=scsiPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuVendorId=scsiLuVendorId, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptTable=scsiTrnsptTable, scsiLuWwnName=scsiLuWwnName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInResets=scsiLuInResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiName=ScsiName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiGeneral=scsiGeneral, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiNotifications=scsiNotifications, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportSRP=scsiTransportSRP, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortRole=scsiPortRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIndex=scsiLuIndex, scsiDeviceAlias=scsiDeviceAlias, scsiCompliances=scsiCompliances, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdentifier=ScsiIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuProductId=scsiLuProductId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdType=ScsiIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuState=scsiLuState, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTransportTypes=scsiTransportTypes, scsiObjects=scsiObjects, scsiTarget=scsiTarget, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiator=scsiInitiator, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdTable=scsiLuIdTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiTranportOther=scsiTranportOther, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValue=ScsiIndexValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunLun=scsiDscLunLun, scsiLuRevisionId=scsiLuRevisionId, scsiModule=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiPortEntry=scsiPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdValue=scsiDscLunIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable)
