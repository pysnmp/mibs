...
ObjectIdentity, TimeTicks, NotificationType, IpAddress, Integer32, mib_2, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, MibIdentifier, iso, Counter64, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "mib-2", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "MibIdentifier", "iso", "Counter64", "ModuleIdentity", "Unsigned32")
RowStatus, AutonomousType, RowPointer, TruthValue, TextualConvention, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "RowPointer", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiLunMapIndex=scsiLunMapIndex, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiConformance=scsiConformance, scsiLuHSInCommands=scsiLuHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGroups=scsiGroups, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiLuIdType=scsiLuIdType, scsiLuIndex=scsiLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdType=ScsiIdType, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiator=scsiInitiator, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapTable=scsiLunMapTable, scsiTgtPortName=scsiTgtPortName, ScsiIndexValue=ScsiIndexValue, scsiGeneral=scsiGeneral, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuProductId=scsiLuProductId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuEntry=scsiLuEntry, scsiNotifications=scsiNotifications, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportFCP=scsiTransportFCP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiTargetGroup=scsiTargetGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtEntry=scsiDscTgtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuTable=scsiLuTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstanceTable=scsiInstanceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiLuState=scsiLuState, scsiTranportOther=scsiTranportOther, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceGroup=scsiDeviceGroup, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiModule=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtTable=scsiDscTgtTable, PYSNMP_MODULE_ID=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuVendorId=scsiLuVendorId, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapLun=scsiLunMapLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
