...
iso, MibIdentifier, Gauge32, mib_2, Counter32, Bits, Unsigned32, ObjectIdentity, NotificationType, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "Gauge32", "mib-2", "Counter32", "Bits", "Unsigned32", "ObjectIdentity", "NotificationType", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Integer32")
TextualConvention, AutonomousType, RowPointer, TruthValue, DisplayString, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "TruthValue", "DisplayString", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapLun=scsiLunMapLun, scsiNotifications=scsiNotifications, scsiIntrPrtName=scsiIntrPrtName, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstAlias=scsiInstAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiLuVendorId=scsiLuVendorId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, ScsiIdType=ScsiIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTranportOther=scsiTranportOther, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliances=scsiCompliances, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiLuProductId=scsiLuProductId, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuStatus=scsiLuStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapEntry=scsiLunMapEntry, ScsiName=ScsiName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstIndex=scsiInstIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceGroup=scsiDeviceGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuState=scsiLuState, scsiTrnsptIndex=scsiTrnsptIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGroups=scsiGroups, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapTable=scsiLunMapTable, scsiLuIndex=scsiLuIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdentifier=ScsiIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiCompliance=scsiCompliance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtEntry=scsiDscTgtEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs)
