...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, MibIdentifier, mib_2, ObjectIdentity, Gauge32, Bits, TimeTicks, IpAddress, ModuleIdentity, Counter64, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "MibIdentifier", "mib-2", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatus=scsiLuStatus, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstVendorVersion=scsiInstVendorVersion, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIndex=scsiLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuEntry=scsiLuEntry, scsiLuInResets=scsiLuInResets, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceResets=scsiDeviceResets, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceGroup=scsiDeviceGroup, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceIndex=scsiDeviceIndex, scsiGeneral=scsiGeneral, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTargetGroup=scsiTargetGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunLun=scsiDscLunLun, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceRole=scsiDeviceRole, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuTable=scsiLuTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtName=scsiDscTgtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunTable=scsiDscLunTable, scsiLuWwnName=scsiLuWwnName, scsiCompliances=scsiCompliances, scsiDscLunEntry=scsiDscLunEntry, scsiModule=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortEntry=scsiPortEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceEntry=scsiInstanceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstAlias=scsiInstAlias, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptType=scsiTrnsptType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGroups=scsiGroups, scsiConformance=scsiConformance, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdType=scsiDscLunIdType, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuProductId=scsiLuProductId, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuState=scsiLuState, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTarget=scsiTarget, scsiInstIndex=scsiInstIndex, ScsiName=ScsiName)
