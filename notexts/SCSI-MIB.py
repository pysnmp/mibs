...
Gauge32, ObjectIdentity, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, IpAddress, Counter64, MibIdentifier, ModuleIdentity, Counter32, mib_2, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "MibIdentifier", "ModuleIdentity", "Counter32", "mib-2", "Bits", "Integer32")
AutonomousType, RowStatus, TruthValue, RowPointer, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TruthValue", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiPortIndex=scsiPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue, scsiObjects=scsiObjects, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInResets=scsiLuInResets, scsiInitiator=scsiInitiator, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTable=scsiPortTable, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiPortEntry=scsiPortEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWwnName=scsiLuWwnName, scsiLuProductId=scsiLuProductId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceTable=scsiInstanceTable, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuEntry=scsiLuEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunLun=scsiDscLunLun, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, scsiDscTgtName=scsiDscTgtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiCompliances=scsiCompliances, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuDefaultLun=scsiLuDefaultLun, scsiCompliance=scsiCompliance, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceResets=scsiDeviceResets, scsiLuInCommands=scsiLuInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiInstanceEntry=scsiInstanceEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotifications=scsiNotifications, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuTable=scsiLuTable, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortRole=scsiPortRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, ScsiIdentifier=ScsiIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteTarget=scsiRemoteTarget, scsiLuReadMegaBytes=scsiLuReadMegaBytes)
