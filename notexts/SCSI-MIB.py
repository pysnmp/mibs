...
ObjectIdentity, Unsigned32, ModuleIdentity, mib_2, Bits, MibIdentifier, Counter64, Counter32, Gauge32, NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "mib-2", "Bits", "MibIdentifier", "Counter64", "Counter32", "Gauge32", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32")
RowPointer, TruthValue, AutonomousType, DisplayString, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiLuDefaultLun=scsiLuDefaultLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdType=ScsiIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdType=scsiLuIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiModule=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiPortTable=scsiPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiTransportFCP=scsiTransportFCP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdTable=scsiLuIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiInitiator=scsiInitiator, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceRole=scsiDeviceRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtName=scsiIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuEntry=scsiLuEntry, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiPortIndex=scsiPortIndex, ScsiIdValue=ScsiIdValue, scsiLuState=scsiLuState, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunTable=scsiDscLunTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiConformance=scsiConformance, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, scsiGeneral=scsiGeneral, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIndex=scsiLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceTable=scsiDeviceTable, scsiLuIdIndex=scsiLuIdIndex, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation)
