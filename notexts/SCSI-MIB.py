...
ModuleIdentity, Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, TimeTicks, mib_2, IpAddress, ObjectIdentity, NotificationType, Gauge32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "TimeTicks", "mib-2", "IpAddress", "ObjectIdentity", "NotificationType", "Gauge32", "Unsigned32", "iso")
DisplayString, RowStatus, TimeStamp, TruthValue, TextualConvention, RowPointer, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "TruthValue", "TextualConvention", "RowPointer", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotifications=scsiNotifications, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunTable=scsiDscLunTable, scsiGroups=scsiGroups, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiModule=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLogicalUnit=scsiLogicalUnit, scsiInstIndex=scsiInstIndex, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtName=scsiDscTgtName, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTarget=scsiTarget, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdentifier=ScsiIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportTypes=scsiTransportTypes, ScsiIdType=ScsiIdType, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuTable=scsiLuTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiName=ScsiName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiDeviceResets=scsiDeviceResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstAlias=scsiInstAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdType=scsiLuIdType, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIndex=scsiLuIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdTable=scsiLuIdTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLun=scsiLunMapLun, scsiTranportSPI=scsiTranportSPI, scsiCompliances=scsiCompliances, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiLuProductId=scsiLuProductId, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportFCP=scsiTransportFCP, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiPortTable=scsiPortTable, scsiPortRole=scsiPortRole, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiLuWwnName=scsiLuWwnName, scsiDevicePortNumber=scsiDevicePortNumber, scsiConformance=scsiConformance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiObjects=scsiObjects, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuInCommands=scsiLuInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunEntry=scsiDscLunEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiator=scsiInitiator, scsiDeviceEntry=scsiDeviceEntry)
