...
Integer32, Bits, ModuleIdentity, NotificationType, TimeTicks, iso, Counter64, Gauge32, Counter32, mib_2, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ModuleIdentity", "NotificationType", "TimeTicks", "iso", "Counter64", "Gauge32", "Counter32", "mib-2", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32")
AutonomousType, RowStatus, TextualConvention, TimeStamp, RowPointer, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiLuInCommands=scsiLuInCommands, scsiDeviceGroup=scsiDeviceGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapTable=scsiLunMapTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstIndex=scsiInstIndex, scsiLuInResets=scsiLuInResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiObjects=scsiObjects, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstAlias=scsiInstAlias, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTarget=scsiTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLun=scsiLunMapLun, scsiLuProductId=scsiLuProductId, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuState=scsiLuState, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, scsiConformance=scsiConformance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceEntry=scsiDeviceEntry, scsiNotifications=scsiNotifications, scsiPortTable=scsiPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortRole=scsiPortRole, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiLuIndex=scsiLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunTable=scsiDscLunTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiator=scsiInitiator, scsiDscLunLun=scsiDscLunLun, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiLuTable=scsiLuTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiCompliances=scsiCompliances, scsiTgtPortName=scsiTgtPortName, ScsiIdAssociation=ScsiIdAssociation, scsiGroups=scsiGroups, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuVendorId=scsiLuVendorId, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportOther=scsiTranportOther, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiDeviceRole=scsiDeviceRole, scsiTgtPortTable=scsiTgtPortTable)
