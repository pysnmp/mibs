...
TimeTicks, IpAddress, mib_2, ModuleIdentity, Integer32, Counter64, Bits, MibIdentifier, iso, Unsigned32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "mib-2", "ModuleIdentity", "Integer32", "Counter64", "Bits", "MibIdentifier", "iso", "Unsigned32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
TextualConvention, RowPointer, AutonomousType, TruthValue, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "AutonomousType", "TruthValue", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapLun=scsiLunMapLun, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuVendorId=scsiLuVendorId, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrName=scsiAuthIntrName, scsiCompliance=scsiCompliance, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSRP=scsiTransportSRP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTable=scsiPortTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, ScsiIdValue=ScsiIdValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdTable=scsiLuIdTable, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiPortIndex=scsiPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstIndex=scsiInstIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdType=scsiLuIdType, ScsiIdentifier=ScsiIdentifier, scsiTarget=scsiTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotifications=scsiNotifications, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSBP=scsiTransportSBP, scsiTransportTypes=scsiTransportTypes, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtName=scsiDscTgtName, ScsiIndexValue=ScsiIndexValue, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiTranportOther=scsiTranportOther, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtPortName=scsiTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdType=scsiDscLunIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIndex=scsiLuIndex, scsiCompliances=scsiCompliances, scsiLuWwnName=scsiLuWwnName, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTransportFCP=scsiTransportFCP, scsiDscTgtTable=scsiDscTgtTable, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiDscLunTable=scsiDscLunTable, scsiObjects=scsiObjects, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiLuInCommands=scsiLuInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiConformance=scsiConformance, ScsiName=ScsiName)
