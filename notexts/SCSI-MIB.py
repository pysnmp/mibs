...
Unsigned32, Counter32, mib_2, Integer32, Gauge32, NotificationType, MibIdentifier, IpAddress, Counter64, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "mib-2", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "IpAddress", "Counter64", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ObjectIdentity")
TextualConvention, TimeStamp, DisplayString, RowStatus, AutonomousType, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortIdentifier=scsiTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdValue=ScsiIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiPortTable=scsiPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdType=ScsiIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdValue=scsiLuIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdType=scsiLuIdType, scsiCompliances=scsiCompliances, scsiTargetGroup=scsiTargetGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGeneral=scsiGeneral, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiLuProductId=scsiLuProductId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuHSInCommands=scsiLuHSInCommands, scsiTarget=scsiTarget, scsiDscLunTable=scsiDscLunTable, PYSNMP_MODULE_ID=scsiModule, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiTgtPortName=scsiTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiConformance=scsiConformance, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGroups=scsiGroups, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapLun=scsiLunMapLun, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtName=scsiIntrPrtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, ScsiIdentifier=ScsiIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliance=scsiCompliance, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiModule=scsiModule, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, scsiLuEntry=scsiLuEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstIndex=scsiInstIndex, scsiLuIndex=scsiLuIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDevicePortNumber=scsiDevicePortNumber, ScsiName=ScsiName, scsiLuInResets=scsiLuInResets, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotifications=scsiNotifications, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTable=scsiIntrDevTable)
