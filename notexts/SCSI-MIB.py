...
Integer32, Gauge32, ModuleIdentity, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, NotificationType, Counter32, TimeTicks, ObjectIdentity, iso, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "NotificationType", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "Counter64", "IpAddress")
RowPointer, RowStatus, DisplayString, TimeStamp, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceIndex=scsiDeviceIndex, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevTable=scsiIntrDevTable, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSRP=scsiTransportSRP, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortName=scsiTgtPortName, scsiTranportOther=scsiTranportOther, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuState=scsiLuState, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceRole=scsiDeviceRole, scsiPortTable=scsiPortTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, PYSNMP_MODULE_ID=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuInResets=scsiLuInResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiPortIndex=scsiPortIndex, scsiLuStatus=scsiLuStatus, scsiInstAlias=scsiInstAlias, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptIndex=scsiTrnsptIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiName=ScsiName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiConformance=scsiConformance, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliances=scsiCompliances, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, scsiLuRevisionId=scsiLuRevisionId, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdTable=scsiDscLunIdTable, scsiObjects=scsiObjects, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIndex=scsiLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTargetGroup=scsiTargetGroup, scsiTrnsptType=scsiTrnsptType, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuProductId=scsiLuProductId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiModule=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWwnName=scsiLuWwnName, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunLun=scsiDscLunLun, scsiLuEntry=scsiLuEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortEntry=scsiPortEntry)
