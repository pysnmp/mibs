...
ModuleIdentity, IpAddress, NotificationType, MibIdentifier, Counter64, iso, mib_2, Bits, TimeTicks, Gauge32, ObjectIdentity, Unsigned32, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "NotificationType", "MibIdentifier", "Counter64", "iso", "mib-2", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TimeStamp, RowStatus, TruthValue, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuEntry=scsiLuEntry, scsiGeneral=scsiGeneral, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceTable=scsiInstanceTable, ScsiIdValue=ScsiIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiName=ScsiName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIndex=scsiLuIndex, scsiLuStatus=scsiLuStatus, scsiConformance=scsiConformance, scsiTarget=scsiTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuState=scsiLuState, scsiLuIdEntry=scsiLuIdEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceAlias=scsiDeviceAlias, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiGroups=scsiGroups, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdType=scsiLuIdType, scsiDeviceGroup=scsiDeviceGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiLunMapTable=scsiLunMapTable, scsiCompliance=scsiCompliance, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuProductId=scsiLuProductId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceIndex=scsiDeviceIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdType=ScsiIdType, scsiDscLunIdType=scsiDscLunIdType, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, scsiNotifications=scsiNotifications, scsiPortRole=scsiPortRole, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapLun=scsiLunMapLun, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiLuWwnName=scsiLuWwnName)
