...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, MibIdentifier, Counter32, mib_2, NotificationType, iso, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "MibIdentifier", "Counter32", "mib-2", "NotificationType", "iso", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "Counter64", "Integer32")
RowPointer, TextualConvention, DisplayString, RowStatus, AutonomousType, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, PYSNMP_MODULE_ID=scsiModule, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, scsiLunMapEntry=scsiLunMapEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceRole=scsiDeviceRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtName=scsiDscTgtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportSPI=scsiTranportSPI, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTable=scsiPortTable, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiTargetGroup=scsiTargetGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdAssociation=ScsiIdAssociation, scsiGroups=scsiGroups, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptTable=scsiTrnsptTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiInstAlias=scsiInstAlias, scsiModule=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstanceTable=scsiInstanceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiObjects=scsiObjects, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiTarget=scsiTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiator=scsiInitiator, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceIndex=scsiDeviceIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiDscLunLun=scsiDscLunLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrName=scsiAuthIntrName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdentifier=ScsiIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInResets=scsiLuInResets, scsiLuEntry=scsiLuEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportOther=scsiTranportOther, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands)
