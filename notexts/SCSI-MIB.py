...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, iso, TimeTicks, mib_2, IpAddress, Counter32, Unsigned32, Gauge32, MibIdentifier, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "iso", "TimeTicks", "mib-2", "IpAddress", "Counter32", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType", "Bits")
RowPointer, TimeStamp, DisplayString, TruthValue, RowStatus, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdAssociation=ScsiIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuInCommands=scsiLuInCommands, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceRole=scsiDeviceRole, scsiModule=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiName=ScsiName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapGroup=scsiLunMapGroup, ScsiIdValue=ScsiIdValue, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportOther=scsiTranportOther, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapTable=scsiLunMapTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiNotifications=scsiNotifications, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrPrtTable=scsiIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWwnName=scsiLuWwnName, scsiCompliances=scsiCompliances, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiPortIndex=scsiPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortEntry=scsiPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdValue=scsiLuIdValue, scsiGeneral=scsiGeneral, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceGroup=scsiDeviceGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunLun=scsiDscLunLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortRole=scsiPortRole, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiLuStatus=scsiLuStatus, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiConformance=scsiConformance, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliance=scsiCompliance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, scsiTransportISCSI=scsiTransportISCSI, scsiLuState=scsiLuState, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevTable=scsiTgtDevTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValue=ScsiIndexValue, scsiInstAlias=scsiInstAlias)
