...
iso, NotificationType, Counter32, Integer32, Counter64, ModuleIdentity, Bits, IpAddress, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter32", "Integer32", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "TimeTicks", "Unsigned32")
RowPointer, RowStatus, TextualConvention, DisplayString, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiModule=scsiModule, scsiConformance=scsiConformance, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunLun=scsiDscLunLun, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiLuInCommands=scsiLuInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceTable=scsiDeviceTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTarget=scsiTarget, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSBP=scsiTransportSBP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIndex=scsiLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceIndex=scsiDeviceIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTranportSPI=scsiTranportSPI, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceRole=scsiDeviceRole, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdEntry=scsiLuIdEntry, PYSNMP_MODULE_ID=scsiModule, scsiLunMapEntry=scsiLunMapEntry, ScsiIdValue=ScsiIdValue, scsiLuIdTable=scsiLuIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWwnName=scsiLuWwnName, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortEntry=scsiPortEntry, scsiCompliance=scsiCompliance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuStatus=scsiLuStatus, scsiInstanceTable=scsiInstanceTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportTypes=scsiTransportTypes, scsiLuState=scsiLuState, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiGeneral=scsiGeneral, scsiInitiator=scsiInitiator, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtTable=scsiDscTgtTable, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuEntry=scsiLuEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, ScsiName=ScsiName, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex)
