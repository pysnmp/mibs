...
Bits, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, TimeTicks, Counter64, Integer32, ModuleIdentity, MibIdentifier, mib_2, ObjectIdentity, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "TimeTicks", "Counter64", "Integer32", "ModuleIdentity", "MibIdentifier", "mib-2", "ObjectIdentity", "Unsigned32", "iso")
RowPointer, AutonomousType, TextualConvention, DisplayString, TruthValue, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TextualConvention", "DisplayString", "TruthValue", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortIndex=scsiPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, ScsiIdType=ScsiIdType, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtName=scsiIntrPrtName, scsiModule=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuEntry=scsiLuEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliance=scsiCompliance, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportFCP=scsiTransportFCP, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSRP=scsiTransportSRP, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceResets=scsiDeviceResets, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiObjects=scsiObjects, scsiPortTable=scsiPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiPortRole=scsiPortRole, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceAlias=scsiDeviceAlias, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdType=scsiLuIdType, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliances=scsiCompliances, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuProductId=scsiLuProductId, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiTrnsptType=scsiTrnsptType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiIntrDevEntry=scsiIntrDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuWwnName=scsiLuWwnName, scsiTrnsptTable=scsiTrnsptTable, scsiConformance=scsiConformance, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiNotifications=scsiNotifications, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportOther=scsiTranportOther, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, ScsiName=ScsiName, scsiLuVendorId=scsiLuVendorId, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiLuState=scsiLuState, scsiTargetGroup=scsiTargetGroup, ScsiIndexValue=ScsiIndexValue, scsiInstIndex=scsiInstIndex, scsiDscLunLun=scsiDscLunLun, scsiGroups=scsiGroups, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortEntry=scsiPortEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInCommands=scsiLuInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable)
