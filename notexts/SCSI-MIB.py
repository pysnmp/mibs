...
Unsigned32, Integer32, iso, NotificationType, ModuleIdentity, Counter32, Gauge32, TimeTicks, Bits, IpAddress, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "iso", "NotificationType", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity")
RowPointer, TimeStamp, DisplayString, TextualConvention, RowStatus, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuHSInCommands=scsiLuHSInCommands, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdIndex=scsiLuIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiModule=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdentifier=ScsiIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTarget=scsiTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiConformance=scsiConformance, scsiTrnsptTable=scsiTrnsptTable, scsiLuProductId=scsiLuProductId, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapLun=scsiLunMapLun, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiLuInResets=scsiLuInResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiInstIndex=scsiInstIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotifications=scsiNotifications, scsiLuIndex=scsiLuIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortTable=scsiPortTable, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportOther=scsiTranportOther, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSRP=scsiTransportSRP, scsiGroups=scsiGroups, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, scsiInstanceTable=scsiInstanceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSBP=scsiTransportSBP, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevTable=scsiTgtDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiCompliance=scsiCompliance, scsiLuTable=scsiLuTable, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortEntry=scsiPortEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, ScsiName=ScsiName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiDeviceIndex=scsiDeviceIndex, scsiInitiator=scsiInitiator, scsiTrnsptEntry=scsiTrnsptEntry)
