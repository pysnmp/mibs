...
mib_2, NotificationType, Bits, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Gauge32, Unsigned32, Counter64, TimeTicks, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Bits", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter64", "TimeTicks", "Integer32", "Counter32")
TimeStamp, AutonomousType, TextualConvention, RowPointer, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TextualConvention", "RowPointer", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortIndex=scsiPortIndex, scsiLuIdTable=scsiLuIdTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiConformance=scsiConformance, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdValue=ScsiIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSRP=scsiTransportSRP, scsiLuStatus=scsiLuStatus, scsiLuEntry=scsiLuEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiator=scsiInitiator, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuRevisionId=scsiLuRevisionId, scsiLuVendorId=scsiLuVendorId, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteInitiators=scsiRemoteInitiators, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiCompliance=scsiCompliance, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiGeneral=scsiGeneral, scsiPortTable=scsiPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortName=scsiTgtPortName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiName=ScsiName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdentifier=ScsiIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdIndex=scsiLuIdIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceAlias=scsiDeviceAlias, ScsiIdType=ScsiIdType, scsiLuTable=scsiLuTable, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuState=scsiLuState, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtTable=scsiIntrPrtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceRole=scsiDeviceRole, scsiGroups=scsiGroups, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunLun=scsiDscLunLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuIndex=scsiLuIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex)
