...
ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Integer32, MibIdentifier, Counter64, Bits, NotificationType, Unsigned32, ObjectIdentity, iso, IpAddress, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Integer32", "MibIdentifier", "Counter64", "Bits", "NotificationType", "Unsigned32", "ObjectIdentity", "iso", "IpAddress", "Counter32", "TimeTicks")
RowStatus, DisplayString, TimeStamp, TruthValue, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTranportSPI=scsiTranportSPI, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiModule=scsiModule, scsiInstAlias=scsiInstAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdType=ScsiIdType, ScsiName=ScsiName, PYSNMP_MODULE_ID=scsiModule, scsiLunMapIndex=scsiLunMapIndex, scsiObjects=scsiObjects, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiConformance=scsiConformance, scsiTransportSRP=scsiTransportSRP, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiator=scsiInitiator, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuTable=scsiLuTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstIndex=scsiInstIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdValue=scsiLuIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceGroup=scsiDeviceGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiDeviceRole=scsiDeviceRole, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortTable=scsiPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuRevisionId=scsiLuRevisionId, scsiLuEntry=scsiLuEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiCompliance=scsiCompliance, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptEntry=scsiTrnsptEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtName=scsiDscTgtName, scsiTargetGroup=scsiTargetGroup, scsiLuIdType=scsiLuIdType, scsiRemoteTarget=scsiRemoteTarget, scsiTransportISCSI=scsiTransportISCSI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunTable=scsiDscLunTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtTable=scsiDscTgtTable, scsiInstanceTable=scsiInstanceTable, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuVendorId=scsiLuVendorId, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValue=ScsiIndexValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiTrnsptType=scsiTrnsptType, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuProductId=scsiLuProductId, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable)
