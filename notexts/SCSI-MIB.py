...
ModuleIdentity, Counter32, Counter64, ObjectIdentity, Gauge32, iso, MibIdentifier, mib_2, IpAddress, NotificationType, Integer32, Bits, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Counter64", "ObjectIdentity", "Gauge32", "iso", "MibIdentifier", "mib-2", "IpAddress", "NotificationType", "Integer32", "Bits", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, RowStatus, RowPointer, TimeStamp, DisplayString, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "RowPointer", "TimeStamp", "DisplayString", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtName=scsiDscTgtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortIndex=scsiPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdValue=scsiLuIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, ScsiName=ScsiName, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceEntry=scsiInstanceEntry, scsiCompliance=scsiCompliance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstIndex=scsiInstIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiNotifications=scsiNotifications, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiPortRole=scsiPortRole, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTarget=scsiTarget, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortName=scsiTgtPortName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuInCommands=scsiLuInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuState=scsiLuState, scsiDeviceEntry=scsiDeviceEntry, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptTable=scsiTrnsptTable, scsiTargetGroup=scsiTargetGroup, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTable=scsiPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportOther=scsiTranportOther, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceTable=scsiDeviceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuTable=scsiLuTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiObjects=scsiObjects, scsiLuWwnName=scsiLuWwnName, scsiTranportSPI=scsiTranportSPI, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliances=scsiCompliances, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapLun=scsiLunMapLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuStatus=scsiLuStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuInResets=scsiLuInResets, scsiInitiator=scsiInitiator, scsiLuProductId=scsiLuProductId, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiDscLunEntry=scsiDscLunEntry, scsiInstAlias=scsiInstAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiConformance=scsiConformance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdValue=ScsiIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuVendorId=scsiLuVendorId, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceRole=scsiDeviceRole, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType)
