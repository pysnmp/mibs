...
ObjectIdentity, MibIdentifier, IpAddress, Gauge32, iso, NotificationType, Counter32, Bits, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "IpAddress", "Gauge32", "iso", "NotificationType", "Counter32", "Bits", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "Integer32", "ModuleIdentity")
TextualConvention, RowStatus, DisplayString, TruthValue, AutonomousType, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "AutonomousType", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiTransportSRP=scsiTransportSRP, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLun=scsiLunMapLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiCompliances=scsiCompliances, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiTranportOther=scsiTranportOther, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiObjects=scsiObjects, scsiInstanceEntry=scsiInstanceEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortRole=scsiPortRole, scsiModule=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuState=scsiLuState, scsiLuIdType=scsiLuIdType, ScsiIdentifier=ScsiIdentifier, scsiDscLunLun=scsiDscLunLun, scsiLuEntry=scsiLuEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotifications=scsiNotifications, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGeneral=scsiGeneral, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiator=scsiInitiator, scsiDscLunIdType=scsiDscLunIdType, scsiConformance=scsiConformance, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiCompliance=scsiCompliance, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceEntry=scsiDeviceEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportTypes=scsiTransportTypes, scsiPortIndex=scsiPortIndex, scsiLuIndex=scsiLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortTable=scsiTgtPortTable, ScsiIdType=ScsiIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstanceTable=scsiInstanceTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstIndex=scsiInstIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiGroups=scsiGroups, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportSBP=scsiTransportSBP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTarget=scsiTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuTable=scsiLuTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatus=scsiLuStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdValue=ScsiIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus)
