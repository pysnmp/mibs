...
IpAddress, MibIdentifier, mib_2, NotificationType, Unsigned32, Counter32, iso, ObjectIdentity, Bits, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "mib-2", "NotificationType", "Unsigned32", "Counter32", "iso", "ObjectIdentity", "Bits", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Integer32")
RowStatus, RowPointer, TextualConvention, TimeStamp, AutonomousType, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "TextualConvention", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdTable=scsiDscLunIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiLuIndex=scsiLuIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSRP=scsiTransportSRP, scsiTranportOther=scsiTranportOther, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliance=scsiCompliance, scsiModule=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiLuStatus=scsiLuStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdTable=scsiLuIdTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiPortTable=scsiPortTable, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapLun=scsiLunMapLun, scsiLuIdValue=scsiLuIdValue, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiDscLunIndex=scsiDscLunIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiator=scsiInitiator, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiCompliances=scsiCompliances, scsiTranportSPI=scsiTranportSPI, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevTable=scsiIntrDevTable, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiDevicePortNumber=scsiDevicePortNumber, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapTable=scsiLunMapTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapIndex=scsiLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtName=scsiDscTgtName, ScsiName=ScsiName, ScsiIdValue=ScsiIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuState=scsiLuState, scsiObjects=scsiObjects, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceRole=scsiDeviceRole, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptTable=scsiTrnsptTable, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdType=scsiLuIdType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuProductId=scsiLuProductId, scsiLuTable=scsiLuTable, scsiConformance=scsiConformance)
