...
Counter32, Integer32, TimeTicks, Unsigned32, Gauge32, IpAddress, ObjectIdentity, Bits, Counter64, NotificationType, ModuleIdentity, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "TimeTicks", "Unsigned32", "Gauge32", "IpAddress", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "ModuleIdentity", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuInResets=scsiLuInResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSBP=scsiTransportSBP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceRole=scsiDeviceRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiConformance=scsiConformance, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapLun=scsiLunMapLun, scsiDscLunLun=scsiDscLunLun, scsiPortRole=scsiPortRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotifications=scsiNotifications, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTarget=scsiTarget, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuState=scsiLuState, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunTable=scsiDscLunTable, scsiPortEntry=scsiPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdType=ScsiIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdValue=scsiLuIdValue, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiPortIndex=scsiPortIndex, scsiCompliances=scsiCompliances, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportTypes=scsiTransportTypes, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiModule=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiGroups=scsiGroups, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtName=scsiIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiator=scsiInitiator, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiLuStatus=scsiLuStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuTable=scsiLuTable, scsiLuEntry=scsiLuEntry, scsiInstanceTable=scsiInstanceTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdentifier=ScsiIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiCompliance=scsiCompliance, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortBusyStatuses=scsiPortBusyStatuses)
