...
NotificationType, Unsigned32, TimeTicks, MibIdentifier, Counter32, Counter64, ModuleIdentity, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Gauge32", "ObjectIdentity", "iso")
TextualConvention, DisplayString, TruthValue, RowPointer, RowStatus, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceTable=scsiDeviceTable, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiTransportTypes=scsiTransportTypes, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuStatus=scsiLuStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotifications=scsiNotifications, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportOther=scsiTranportOther, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiInstIndex=scsiInstIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunLun=scsiDscLunLun, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiConformance=scsiConformance, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdIndex=scsiLuIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceResets=scsiDeviceResets, scsiLuTable=scsiLuTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiLuInCommands=scsiLuInCommands, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTarget=scsiTarget, scsiPortTable=scsiPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, ScsiIdValue=ScsiIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliances=scsiCompliances, ScsiIdCodeSet=ScsiIdCodeSet, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInResets=scsiLuInResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiObjects=scsiObjects, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, ScsiName=ScsiName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdTable=scsiDscLunIdTable, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevTable=scsiTgtDevTable, scsiPortIndex=scsiPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuProductId=scsiLuProductId, scsiDscLunTable=scsiDscLunTable)
