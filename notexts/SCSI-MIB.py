...
NotificationType, iso, ObjectIdentity, IpAddress, Counter32, Gauge32, Unsigned32, Counter64, mib_2, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ObjectIdentity", "IpAddress", "Counter32", "Gauge32", "Unsigned32", "Counter64", "mib-2", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Bits")
DisplayString, RowPointer, AutonomousType, TextualConvention, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortName=scsiTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuTable=scsiLuTable, scsiInitiator=scsiInitiator, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdValue=ScsiIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuProductId=scsiLuProductId, scsiCompliances=scsiCompliances, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotifications=scsiNotifications, scsiLuIdType=scsiLuIdType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortRole=scsiPortRole, PYSNMP_MODULE_ID=scsiModule, scsiPortEntry=scsiPortEntry, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiConformance=scsiConformance, scsiLuIndex=scsiLuIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatus=scsiLuStatus, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportFCP=scsiTransportFCP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdValue=scsiLuIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportOther=scsiTranportOther, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGeneral=scsiGeneral, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceRole=scsiDeviceRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportSRP=scsiTransportSRP, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuState=scsiLuState, ScsiIdentifier=ScsiIdentifier)
