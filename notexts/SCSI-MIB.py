...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress, Counter64, mib_2, MibIdentifier, NotificationType, Bits, iso, TimeTicks, Gauge32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress", "Counter64", "mib-2", "MibIdentifier", "NotificationType", "Bits", "iso", "TimeTicks", "Gauge32", "ModuleIdentity", "Unsigned32")
RowPointer, DisplayString, RowStatus, AutonomousType, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "RowStatus", "AutonomousType", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportSBP=scsiTransportSBP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceTable=scsiInstanceTable, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiLuInResets=scsiLuInResets, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiDscTgtName=scsiDscTgtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptType=scsiTrnsptType, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapLun=scsiLunMapLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceGroup=scsiDeviceGroup, scsiPortTable=scsiPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapTable=scsiLunMapTable, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstAlias=scsiInstAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiator=scsiInitiator, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiName=ScsiName, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetGroup=scsiTargetGroup, scsiGeneral=scsiGeneral, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiLuState=scsiLuState, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevTable=scsiTgtDevTable, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliance=scsiCompliance, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdentifier=ScsiIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiNotifications=scsiNotifications, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiObjects=scsiObjects, scsiDeviceIndex=scsiDeviceIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiModule=scsiModule, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiPortRole=scsiPortRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes)
