...
mib_2, iso, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter64, NotificationType, ObjectIdentity, MibIdentifier, IpAddress, TimeTicks, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter64", "NotificationType", "ObjectIdentity", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "Gauge32")
DisplayString, RowPointer, AutonomousType, RowStatus, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry, scsiLuStatus=scsiLuStatus, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiGeneral=scsiGeneral, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortIndex=scsiPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuTable=scsiLuTable, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportFCP=scsiTransportFCP, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdValue=scsiLuIdValue, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiGroups=scsiGroups, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortRole=scsiPortRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdValue=ScsiIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiTrnsptIndex=scsiTrnsptIndex, scsiTranportOther=scsiTranportOther, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiator=scsiInitiator, scsiLuProductId=scsiLuProductId, scsiPortEntry=scsiPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceResets=scsiDeviceResets, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdType=ScsiIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuVendorId=scsiLuVendorId, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTable=scsiPortTable, scsiDscLunLun=scsiDscLunLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, scsiTarget=scsiTarget, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportSBP=scsiTransportSBP, scsiTransportTypes=scsiTransportTypes, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdType=scsiLuIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortName=scsiTgtPortName, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiLunMapIndex=scsiLunMapIndex, scsiModule=scsiModule, scsiTgtDeviceStatus=scsiTgtDeviceStatus)
