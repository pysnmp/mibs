...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, Integer32, Counter32, Gauge32, ObjectIdentity, IpAddress, Unsigned32, Bits, MibIdentifier, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "Integer32", "Counter32", "Gauge32", "ObjectIdentity", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "iso", "TimeTicks")
RowPointer, TruthValue, AutonomousType, RowStatus, DisplayString, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "AutonomousType", "RowStatus", "DisplayString", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIndex=scsiLuIndex, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapLun=scsiLunMapLun, scsiPortTable=scsiPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiCompliances=scsiCompliances, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiTransportISCSI=scsiTransportISCSI, scsiNotifications=scsiNotifications, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdType=ScsiIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortName=scsiTgtPortName, scsiLuInResets=scsiLuInResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuTable=scsiLuTable, scsiInstAlias=scsiInstAlias, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInCommands=scsiLuInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortTable=scsiTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdValue=ScsiIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, ScsiIdAssociation=ScsiIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceIndex=scsiDeviceIndex, scsiTransportTypes=scsiTransportTypes, scsiDscLunTable=scsiDscLunTable, scsiInitiator=scsiInitiator, scsiInstanceTable=scsiInstanceTable, scsiLunMapGroup=scsiLunMapGroup, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSBP=scsiTransportSBP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuEntry=scsiLuEntry, scsiTransportFCP=scsiTransportFCP, scsiConformance=scsiConformance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdValue=scsiLuIdValue, scsiLuState=scsiLuState, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliance=scsiCompliance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiLuWwnName=scsiLuWwnName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiLuRevisionId=scsiLuRevisionId, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortEntry=scsiPortEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceRole=scsiDeviceRole, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiInstIndex=scsiInstIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatus=scsiLuStatus, scsiTrnsptTable=scsiTrnsptTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiName=ScsiName, scsiPortRole=scsiPortRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapTable=scsiLunMapTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtName=scsiDscTgtName, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiGeneral=scsiGeneral, scsiObjects=scsiObjects, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus)
