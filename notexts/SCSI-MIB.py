...
ModuleIdentity, Bits, Counter32, TimeTicks, MibIdentifier, Unsigned32, Counter64, iso, mib_2, Integer32, ObjectIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter64", "iso", "mib-2", "Integer32", "ObjectIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
DisplayString, TruthValue, TimeStamp, AutonomousType, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "AutonomousType", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiTarget=scsiTarget, ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiInstIndex=scsiInstIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuProductId=scsiLuProductId, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportSBP=scsiTransportSBP, scsiModule=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGroups=scsiGroups, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuTable=scsiLuTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiator=scsiInitiator, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiCompliances=scsiCompliances, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiLuVendorId=scsiLuVendorId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortEntry=scsiPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstAlias=scsiInstAlias, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTable=scsiIntrDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevEntry=scsiTgtDevEntry, scsiTranportOther=scsiTranportOther, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTable=scsiPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunLun=scsiDscLunLun, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuInResets=scsiLuInResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdAssociation=ScsiIdAssociation, ScsiIdType=ScsiIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTargetGroup=scsiTargetGroup, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuState=scsiLuState, scsiPortIndex=scsiPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapLun=scsiLunMapLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiCompliance=scsiCompliance, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunEntry=scsiDscLunEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiGeneral=scsiGeneral, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuEntry=scsiLuEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiPortRole=scsiPortRole, scsiConformance=scsiConformance, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunTable=scsiDscLunTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun)
