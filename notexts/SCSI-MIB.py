...
ObjectIdentity, IpAddress, Counter64, Counter32, Integer32, TimeTicks, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, NotificationType, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "Counter32", "Integer32", "TimeTicks", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "NotificationType", "iso", "Bits", "ModuleIdentity")
RowPointer, TruthValue, TimeStamp, TextualConvention, RowStatus, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiConformance=scsiConformance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportFCP=scsiTransportFCP, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiPortTable=scsiPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstAlias=scsiInstAlias, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, ScsiIdentifier=ScsiIdentifier, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortIndex=scsiPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiCompliances=scsiCompliances, scsiLogicalUnit=scsiLogicalUnit, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotifications=scsiNotifications, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdValue=ScsiIdValue, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdType=ScsiIdType, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportSBP=scsiTransportSBP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiTransportISCSI=scsiTransportISCSI, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiPortRole=scsiPortRole, scsiLunMapEntry=scsiLunMapEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiName=ScsiName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdEntry=scsiLuIdEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGroups=scsiGroups, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, scsiTranportSPI=scsiTranportSPI, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTranportOther=scsiTranportOther, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, scsiGeneral=scsiGeneral, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTarget=scsiTarget, scsiLunMapLun=scsiLunMapLun, scsiDscTgtTable=scsiDscTgtTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstanceTable=scsiInstanceTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, scsiLuInCommands=scsiLuInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapTable=scsiLunMapTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceIndex=scsiDeviceIndex)
