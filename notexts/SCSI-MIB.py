...
MibIdentifier, Integer32, Gauge32, NotificationType, mib_2, Bits, IpAddress, Counter64, ObjectIdentity, Counter32, Unsigned32, ModuleIdentity, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Gauge32", "NotificationType", "mib-2", "Bits", "IpAddress", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "ModuleIdentity", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, DisplayString, TextualConvention, AutonomousType, TruthValue, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdentifier=ScsiIdentifier, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiLuIdType=scsiLuIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapTable=scsiLunMapTable, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiator=scsiInitiator, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTarget=scsiTarget, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiNotifications=scsiNotifications, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevTable=scsiTgtDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiName=ScsiName, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiModule=scsiModule, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiTrnsptTable=scsiTrnsptTable, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiGeneral=scsiGeneral, scsiLuInCommands=scsiLuInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiConformance=scsiConformance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTranportSPI=scsiTranportSPI, scsiPortRole=scsiPortRole, scsiTrnsptPointer=scsiTrnsptPointer, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIndex=scsiLuIndex, scsiInstIndex=scsiInstIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdType=scsiDscLunIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, scsiTransportSRP=scsiTransportSRP, scsiLuVendorId=scsiLuVendorId, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuTable=scsiLuTable, scsiDeviceAlias=scsiDeviceAlias, scsiLuStatus=scsiLuStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceRole=scsiDeviceRole, scsiDeviceTable=scsiDeviceTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiCompliance=scsiCompliance, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTable=scsiPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiObjects=scsiObjects, scsiTgtPortTable=scsiTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceResets=scsiDeviceResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup)
