...
MibIdentifier, ModuleIdentity, Integer32, iso, IpAddress, NotificationType, Counter32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Counter64, TimeTicks, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Integer32", "iso", "IpAddress", "NotificationType", "Counter32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Counter64", "TimeTicks", "mib-2")
TruthValue, AutonomousType, RowPointer, DisplayString, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowPointer", "DisplayString", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortTable=scsiPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunEntry=scsiDscLunEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdentifier=ScsiIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuProductId=scsiLuProductId, scsiObjects=scsiObjects, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstIndex=scsiInstIndex, scsiLuIndex=scsiLuIndex, scsiDeviceTable=scsiDeviceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortEntry=scsiPortEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTarget=scsiTarget, ScsiName=ScsiName, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatus=scsiLuStatus, scsiGeneral=scsiGeneral, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdType=ScsiIdType, scsiLuEntry=scsiLuEntry, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdType=scsiLuIdType, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortRole=scsiPortRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiCompliance=scsiCompliance, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuTable=scsiLuTable, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiator=scsiInitiator, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIndexValue=ScsiIndexValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuVendorId=scsiLuVendorId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiCompliances=scsiCompliances, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiLuIdTable=scsiLuIdTable)
