...
Counter64, Counter32, mib_2, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, IpAddress, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "mib-2", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "IpAddress", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32")
TimeStamp, RowPointer, TextualConvention, DisplayString, RowStatus, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuEntry=scsiLuEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapGroup=scsiLunMapGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceResets=scsiDeviceResets, scsiLuInResets=scsiLuInResets, scsiLuRevisionId=scsiLuRevisionId, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortIndex=scsiPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSBP=scsiTransportSBP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapIndex=scsiLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValue=ScsiIndexValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortTable=scsiPortTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdType=scsiLuIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdIndex=scsiLuIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuStatus=scsiLuStatus, scsiConformance=scsiConformance, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuTable=scsiLuTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWwnName=scsiLuWwnName, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapTable=scsiLunMapTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiInstIndex=scsiInstIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiDscLunIndex=scsiDscLunIndex, scsiLuVendorId=scsiLuVendorId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDevTable=scsiTgtDevTable, ScsiIdValue=ScsiIdValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiNotifications=scsiNotifications, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiName=ScsiName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, scsiLuIdEntry=scsiLuIdEntry, scsiGroups=scsiGroups, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, scsiTarget=scsiTarget, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiLuIndex=scsiLuIndex, scsiInitiator=scsiInitiator, scsiLuIdTable=scsiLuIdTable, scsiRemoteTarget=scsiRemoteTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstVendorVersion=scsiInstVendorVersion)
