...
Integer32, IpAddress, mib_2, Unsigned32, NotificationType, ModuleIdentity, Bits, Counter32, TimeTicks, MibIdentifier, ObjectIdentity, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "mib-2", "Unsigned32", "NotificationType", "ModuleIdentity", "Bits", "Counter32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TimeStamp, AutonomousType, DisplayString, RowPointer, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "DisplayString", "RowPointer", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, scsiTransportISCSI=scsiTransportISCSI, scsiLuRevisionId=scsiLuRevisionId, scsiLuIndex=scsiLuIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuState=scsiLuState, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortIndex=scsiPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiDeviceAlias=scsiDeviceAlias, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortRole=scsiPortRole, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuWwnName=scsiLuWwnName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceResets=scsiDeviceResets, scsiInstIndex=scsiInstIndex, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiConformance=scsiConformance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTarget=scsiTarget, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunLun=scsiDscLunLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuVendorId=scsiLuVendorId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportFCP=scsiTransportFCP, scsiLunMapEntry=scsiLunMapEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortName=scsiTgtPortName, ScsiIdValue=ScsiIdValue, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGeneral=scsiGeneral, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceEntry=scsiInstanceEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiDscLunTable=scsiDscLunTable, scsiModule=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtName=scsiIntrPrtName, scsiTransportSBP=scsiTransportSBP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiLuStatus=scsiLuStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuInResets=scsiLuInResets, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapIndex=scsiLunMapIndex, scsiInstAlias=scsiInstAlias, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation)
