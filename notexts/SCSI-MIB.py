...
IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity, mib_2, Bits, Counter32, Gauge32, TimeTicks, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "mib-2", "Bits", "Counter32", "Gauge32", "TimeTicks", "Counter64", "iso")
TextualConvention, AutonomousType, TimeStamp, RowStatus, DisplayString, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "DisplayString", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdValue=scsiDscLunIdValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliance=scsiCompliance, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptType=scsiTrnsptType, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiator=scsiInitiator, scsiLuIdType=scsiLuIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuTable=scsiLuTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTarget=scsiTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapIndex=scsiLunMapIndex, scsiPortRole=scsiPortRole, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstAlias=scsiInstAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuEntry=scsiLuEntry, ScsiName=ScsiName, scsiLunMapTable=scsiLunMapTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortIndex=scsiPortIndex, scsiInstanceTable=scsiInstanceTable, scsiLuStatus=scsiLuStatus, scsiTargetGroup=scsiTargetGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdEntry=scsiLuIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiPortTable=scsiPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiConformance=scsiConformance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiGroups=scsiGroups, scsiLuProductId=scsiLuProductId, scsiObjects=scsiObjects, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTranportOther=scsiTranportOther, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdentifier=ScsiIdentifier, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiTransportFCP=scsiTransportFCP, scsiDscTgtName=scsiDscTgtName, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunLun=scsiDscLunLun, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtName=scsiIntrPrtName)
