...
Integer32, ModuleIdentity, IpAddress, TimeTicks, mib_2, Gauge32, iso, Bits, Unsigned32, Counter32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "IpAddress", "TimeTicks", "mib-2", "Gauge32", "iso", "Bits", "Unsigned32", "Counter32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, RowPointer, RowStatus, AutonomousType, TimeStamp, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiPortEntry=scsiPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetGroup=scsiTargetGroup, scsiLuIdType=scsiLuIdType, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatus=scsiLuStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiGeneral=scsiGeneral, scsiNotifications=scsiNotifications, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiator=scsiInitiator, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGroups=scsiGroups, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiLogicalUnit=scsiLogicalUnit, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, scsiTransportSRP=scsiTransportSRP, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportTypes=scsiTransportTypes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiLuProductId=scsiLuProductId, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWwnName=scsiLuWwnName, scsiTarget=scsiTarget, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiLuIdIndex=scsiLuIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIndex=scsiDscLunIndex, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiLuInResets=scsiLuInResets, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiTranportOther=scsiTranportOther, scsiAttTgtPortName=scsiAttTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdValue=ScsiIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceEntry=scsiInstanceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunEntry=scsiDscLunEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceTable=scsiDeviceTable, ScsiIndexValue=ScsiIndexValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuEntry=scsiLuEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunTable=scsiDscLunTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuState=scsiLuState, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportSBP=scsiTransportSBP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus)
