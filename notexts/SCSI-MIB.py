...
mib_2, iso, Integer32, Unsigned32, Counter64, Gauge32, TimeTicks, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, ModuleIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Integer32", "Unsigned32", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "ModuleIdentity", "NotificationType", "Counter32")
TruthValue, RowStatus, AutonomousType, RowPointer, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "AutonomousType", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceIndex=scsiDeviceIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtEntry=scsiDscTgtEntry, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiPortRole=scsiPortRole, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatus=scsiLuStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInstanceTable=scsiInstanceTable, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdValue=scsiLuIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiName=ScsiName, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiCompliance=scsiCompliance, scsiGeneral=scsiGeneral, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportSBP=scsiTransportSBP, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiLuState=scsiLuState, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiator=scsiInitiator, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceTable=scsiDeviceTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdType=scsiLuIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiDeviceResets=scsiDeviceResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapTable=scsiLunMapTable, scsiCompliances=scsiCompliances, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiInstIndex=scsiInstIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiNotifications=scsiNotifications, scsiGroups=scsiGroups, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdAssociation=ScsiIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunTable=scsiDscLunTable, scsiDeviceRole=scsiDeviceRole, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortName=scsiTgtPortName, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiTranportOther=scsiTranportOther, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortIndex=scsiPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortTable=scsiPortTable, scsiLuPeripheralType=scsiLuPeripheralType)
