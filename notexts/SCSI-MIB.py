...
Unsigned32, Counter32, Bits, TimeTicks, Counter64, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Bits", "TimeTicks", "Counter64", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "IpAddress", "mib-2")
DisplayString, TimeStamp, TruthValue, RowStatus, RowPointer, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TruthValue", "RowStatus", "RowPointer", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSBP=scsiTransportSBP, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuEntry=scsiLuEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortTable=scsiPortTable, scsiLunMapLun=scsiLunMapLun, scsiTrnsptType=scsiTrnsptType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiConformance=scsiConformance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportSRP=scsiTransportSRP, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceResets=scsiDeviceResets, scsiDeviceEntry=scsiDeviceEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotifications=scsiNotifications, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapTable=scsiLunMapTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunLun=scsiDscLunLun, scsiObjects=scsiObjects, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGroups=scsiGroups, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceAlias=scsiDeviceAlias, scsiGeneral=scsiGeneral, ScsiIdType=ScsiIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliance=scsiCompliance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportOther=scsiTranportOther, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtName=scsiDscTgtName, scsiInstAlias=scsiInstAlias, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportTypes=scsiTransportTypes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiator=scsiInitiator, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiDscLunEntry=scsiDscLunEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdValue=scsiLuIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuProductId=scsiLuProductId, scsiPortIndex=scsiPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdType=scsiLuIdType, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportFCP=scsiTransportFCP, scsiCompliances=scsiCompliances, scsiInstIndex=scsiInstIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiModule=scsiModule, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiName=ScsiName)
