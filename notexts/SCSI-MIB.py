...
ObjectIdentity, Counter64, mib_2, Unsigned32, NotificationType, ModuleIdentity, iso, Gauge32, Counter32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "mib-2", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "Gauge32", "Counter32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "TimeTicks")
TruthValue, RowStatus, DisplayString, AutonomousType, RowPointer, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "AutonomousType", "RowPointer", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceTable=scsiDeviceTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotifications=scsiNotifications, scsiTransportFCP=scsiTransportFCP, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiModule=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortName=scsiTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortTable=scsiPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiIdType=ScsiIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, scsiLuState=scsiLuState, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, scsiLuStatus=scsiLuStatus, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTargetGroup=scsiTargetGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiTransportSRP=scsiTransportSRP, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptPointer=scsiTrnsptPointer, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortTable=scsiTgtPortTable, scsiInitiator=scsiInitiator, scsiPortRole=scsiPortRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportOther=scsiTranportOther, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiCompliances=scsiCompliances, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiConformance=scsiConformance, scsiTranportSPI=scsiTranportSPI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortIndex=scsiPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiIdValue=ScsiIdValue)
