...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, Gauge32, iso, Bits, mib_2, MibIdentifier, ModuleIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "Gauge32", "iso", "Bits", "mib-2", "MibIdentifier", "ModuleIdentity", "Counter32", "NotificationType")
TextualConvention, TimeStamp, RowStatus, DisplayString, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunTable=scsiDscLunTable, scsiNotifications=scsiNotifications, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdValue=ScsiIdValue, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdType=ScsiIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiInstIndex=scsiInstIndex, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortEntry=scsiPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiLuInCommands=scsiLuInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTable=scsiPortTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportTypes=scsiTransportTypes, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportSPI=scsiTranportSPI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, ScsiIndexValue=ScsiIndexValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, scsiLuIdValue=scsiLuIdValue, scsiCompliance=scsiCompliance, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortIndex=scsiPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapEntry=scsiLunMapEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiModule=scsiModule, scsiLuState=scsiLuState, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWwnName=scsiLuWwnName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSRP=scsiTransportSRP, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTgtDevTable=scsiTgtDevTable, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiLuProductId=scsiLuProductId, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiGeneral=scsiGeneral, scsiLuInResets=scsiLuInResets, ScsiName=ScsiName, scsiInstanceEntry=scsiInstanceEntry)
