...
iso, NotificationType, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Gauge32, ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, mib_2, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "mib-2", "MibIdentifier", "Integer32")
DisplayString, TextualConvention, TruthValue, TimeStamp, RowStatus, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiNotifications=scsiNotifications, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuState=scsiLuState, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortRole=scsiPortRole, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdValue=scsiLuIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuWwnName=scsiLuWwnName, scsiTargetGroup=scsiTargetGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiTransportSBP=scsiTransportSBP, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceAlias=scsiDeviceAlias, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceRole=scsiDeviceRole, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiLuEntry=scsiLuEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiModule=scsiModule, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiCompliance=scsiCompliance, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdType=ScsiIdType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiObjects=scsiObjects, scsiGroups=scsiGroups, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortTable=scsiTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiConformance=scsiConformance, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptType=scsiTrnsptType, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, scsiGeneral=scsiGeneral, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtName=scsiDscTgtName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiTransportSRP=scsiTransportSRP, scsiDscLunEntry=scsiDscLunEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes)
