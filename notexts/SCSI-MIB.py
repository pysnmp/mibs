...
TimeTicks, MibIdentifier, NotificationType, Counter32, mib_2, Bits, iso, ModuleIdentity, IpAddress, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "mib-2", "Bits", "iso", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32")
RowPointer, TimeStamp, RowStatus, DisplayString, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportTypes=scsiTransportTypes, scsiTarget=scsiTarget, scsiTgtPortName=scsiTgtPortName, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceTable=scsiInstanceTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportFCP=scsiTransportFCP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiPortEntry=scsiPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstAlias=scsiInstAlias, scsiDscLunIdType=scsiDscLunIdType, scsiLuInResets=scsiLuInResets, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiModule=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdentifier=ScsiIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceRole=scsiDeviceRole, scsiGroups=scsiGroups, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuState=scsiLuState, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiNotifications=scsiNotifications, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, scsiLuIndex=scsiLuIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuStatus=scsiLuStatus, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtName=scsiDscTgtName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiInitiator=scsiInitiator, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiCompliances=scsiCompliances, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdType=scsiLuIdType, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWwnName=scsiLuWwnName, ScsiIdType=ScsiIdType, scsiCompliance=scsiCompliance, scsiGeneral=scsiGeneral, scsiIntrDevTable=scsiIntrDevTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdValue=ScsiIdValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiConformance=scsiConformance, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdValue=scsiLuIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiObjects=scsiObjects, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceResets=scsiDeviceResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortTable=scsiPortTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP)
