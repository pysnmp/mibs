...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, Counter64, ObjectIdentity, Counter32, Gauge32, Unsigned32, MibIdentifier, Integer32, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "Gauge32", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "mib-2")
TimeStamp, DisplayString, TruthValue, AutonomousType, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdentifier=ScsiIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiGroups=scsiGroups, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSRP=scsiTransportSRP, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIndex=scsiLuIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInResets=scsiLuInResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiConformance=scsiConformance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstIndex=scsiInstIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiDeviceGroup=scsiDeviceGroup, scsiTarget=scsiTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortTable=scsiPortTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdValue=scsiLuIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiLuTable=scsiLuTable, scsiTransportFCP=scsiTransportFCP, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuStatus=scsiLuStatus, scsiTranportOther=scsiTranportOther, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptType=scsiTrnsptType, scsiDeviceResets=scsiDeviceResets, ScsiIdType=ScsiIdType, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunLun=scsiDscLunLun, scsiNotifications=scsiNotifications, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuState=scsiLuState, scsiCompliance=scsiCompliance, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstAlias=scsiInstAlias, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortIndex=scsiPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortName=scsiTgtPortName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTranportSPI=scsiTranportSPI, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiator=scsiInitiator, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdTable=scsiLuIdTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiCompliances=scsiCompliances, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, PYSNMP_MODULE_ID=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptTable=scsiTrnsptTable, ScsiIdValue=ScsiIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiLuInCommands=scsiLuInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands)
