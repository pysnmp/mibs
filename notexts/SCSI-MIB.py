...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, iso, IpAddress, ModuleIdentity, Unsigned32, MibIdentifier, ObjectIdentity, Counter32, Gauge32, Counter64, Bits, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Counter32", "Gauge32", "Counter64", "Bits", "NotificationType", "mib-2")
TimeStamp, AutonomousType, TextualConvention, TruthValue, RowPointer, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue", "RowPointer", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstanceTable=scsiInstanceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstAlias=scsiInstAlias, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiGeneral=scsiGeneral, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiObjects=scsiObjects, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuWwnName=scsiLuWwnName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortTable=scsiPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdTable=scsiLuIdTable, PYSNMP_MODULE_ID=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptEntry=scsiTrnsptEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtName=scsiIntrPrtName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptDevName=scsiTrnsptDevName, scsiModule=scsiModule, scsiInstanceEntry=scsiInstanceEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuState=scsiLuState, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiName=ScsiName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiPortIndex=scsiPortIndex, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiNotifications=scsiNotifications, scsiTarget=scsiTarget, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiTransportSBP=scsiTransportSBP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortEntry=scsiTgtPortEntry, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdType=scsiLuIdType, scsiInstIndex=scsiInstIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValue=ScsiIndexValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdType=ScsiIdType, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatus=scsiLuStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunEntry=scsiDscLunEntry, scsiCompliance=scsiCompliance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceTable=scsiDeviceTable, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiDscLunLun=scsiDscLunLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportFCP=scsiTransportFCP, scsiLunMapGroup=scsiLunMapGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuProductId=scsiLuProductId, scsiConformance=scsiConformance, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtEntry=scsiDscTgtEntry, scsiTranportSPI=scsiTranportSPI, scsiLunMapLun=scsiLunMapLun, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdValue=ScsiIdValue, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuInCommands=scsiLuInCommands, scsiLuIdValue=scsiLuIdValue, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiDscTgtDiscovered=scsiDscTgtDiscovered)
