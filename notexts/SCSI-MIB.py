...
MibIdentifier, IpAddress, ModuleIdentity, Bits, Counter64, Counter32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Integer32, mib_2, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "ModuleIdentity", "Bits", "Counter64", "Counter32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Integer32", "mib-2", "Unsigned32", "NotificationType")
TruthValue, TextualConvention, AutonomousType, DisplayString, RowPointer, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "RowPointer", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortIndex=scsiPortIndex, scsiTranportSPI=scsiTranportSPI, scsiInitiator=scsiInitiator, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortRole=scsiPortRole, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiConformance=scsiConformance, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortName=scsiTgtPortName, ScsiIdentifier=ScsiIdentifier, scsiTransportTypes=scsiTransportTypes, scsiLunMapEntry=scsiLunMapEntry, scsiTranportOther=scsiTranportOther, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInCommands=scsiLuInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuEntry=scsiLuEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuInResets=scsiLuInResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevTable=scsiTgtDevTable, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstIndex=scsiInstIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunTable=scsiDscLunTable, scsiInstanceEntry=scsiInstanceEntry, scsiGeneral=scsiGeneral, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiModule=scsiModule, scsiLunMapLun=scsiLunMapLun, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiLunMapGroup=scsiLunMapGroup, scsiLuTable=scsiLuTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuProductId=scsiLuProductId, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotifications=scsiNotifications, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetGroup=scsiTargetGroup, scsiCompliances=scsiCompliances, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTarget=scsiTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiPortEntry=scsiPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstAlias=scsiInstAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortTable=scsiPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdValue=scsiLuIdValue, scsiInstanceTable=scsiInstanceTable)
