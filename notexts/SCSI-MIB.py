...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, iso, IpAddress, Bits, ModuleIdentity, mib_2, Counter32, Unsigned32, ObjectIdentity, Integer32, NotificationType, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "iso", "IpAddress", "Bits", "ModuleIdentity", "mib-2", "Counter32", "Unsigned32", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "MibIdentifier")
AutonomousType, TimeStamp, RowPointer, DisplayString, RowStatus, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatus=scsiLuStatus, scsiConformance=scsiConformance, scsiGroups=scsiGroups, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInCommands=scsiLuInCommands, scsiLuWwnName=scsiLuWwnName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, scsiDeviceResets=scsiDeviceResets, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiGeneral=scsiGeneral, scsiPortEntry=scsiPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceTable=scsiDeviceTable, scsiLuIdValue=scsiLuIdValue, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunLun=scsiDscLunLun, scsiDscLunTable=scsiDscLunTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTarget=scsiTarget, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapIndex=scsiLunMapIndex, scsiPortRole=scsiPortRole, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiInstanceTable=scsiInstanceTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, ScsiName=ScsiName, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdType=scsiLuIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuIndex=scsiLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapTable=scsiLunMapTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevTable=scsiTgtDevTable, ScsiIdType=ScsiIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortIndex=scsiPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceAlias=scsiDeviceAlias, scsiTransportSRP=scsiTransportSRP, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtName=scsiDscTgtName, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable)
