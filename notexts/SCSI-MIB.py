...
ObjectIdentity, Bits, Counter32, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, Integer32, mib_2, TimeTicks, NotificationType, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "Integer32", "mib-2", "TimeTicks", "NotificationType", "iso", "IpAddress")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWwnName=scsiLuWwnName, ScsiIdValue=ScsiIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportFCP=scsiTransportFCP, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiCompliances=scsiCompliances, ScsiIndexValue=ScsiIndexValue, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdentifier=ScsiIdentifier, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiLuState=scsiLuState, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiModule=scsiModule, PYSNMP_MODULE_ID=scsiModule, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiObjects=scsiObjects, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTarget=scsiTarget, scsiLuTable=scsiLuTable, scsiLuIndex=scsiLuIndex, scsiLuProductId=scsiLuProductId, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdType=ScsiIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportSRP=scsiTransportSRP, scsiPortIndex=scsiPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdType=scsiDscLunIdType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuInResets=scsiLuInResets, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGeneral=scsiGeneral, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands)
