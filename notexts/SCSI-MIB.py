...
Gauge32, NotificationType, iso, ModuleIdentity, ObjectIdentity, Counter32, Bits, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Unsigned32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "iso", "ModuleIdentity", "ObjectIdentity", "Counter32", "Bits", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Unsigned32", "Integer32", "IpAddress")
TextualConvention, TimeStamp, RowPointer, AutonomousType, RowStatus, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowPointer", "AutonomousType", "RowStatus", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortIndex=scsiPortIndex, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiInstIndex=scsiInstIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptIndex=scsiTrnsptIndex, ScsiName=ScsiName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliances=scsiCompliances, scsiLuStatusChanged=scsiLuStatusChanged, scsiTargetGroup=scsiTargetGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuTable=scsiLuTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIndexValue=ScsiIndexValue, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdType=ScsiIdType, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiLuProductId=scsiLuProductId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuInResets=scsiLuInResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdValue=ScsiIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuState=scsiLuState, scsiRemoteTarget=scsiRemoteTarget, scsiObjects=scsiObjects, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiModule=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtIndex=scsiDscTgtIndex, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtName=scsiDscTgtName, scsiTransportTypes=scsiTransportTypes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptTable=scsiTrnsptTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapLun=scsiLunMapLun, scsiInstanceEntry=scsiInstanceEntry, scsiTransportFCP=scsiTransportFCP, scsiLuEntry=scsiLuEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstAlias=scsiInstAlias, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdType=scsiLuIdType, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceIndex=scsiDeviceIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiPortRole=scsiPortRole, scsiLuVendorId=scsiLuVendorId, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceResets=scsiDeviceResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiGeneral=scsiGeneral, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiConformance=scsiConformance, scsiLunMapRowStatus=scsiLunMapRowStatus)
