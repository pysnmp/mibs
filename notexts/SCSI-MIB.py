...
MibIdentifier, Counter32, Gauge32, TimeTicks, Counter64, Bits, NotificationType, Unsigned32, mib_2, ModuleIdentity, IpAddress, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Gauge32", "TimeTicks", "Counter64", "Bits", "NotificationType", "Unsigned32", "mib-2", "ModuleIdentity", "IpAddress", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
AutonomousType, TimeStamp, RowPointer, DisplayString, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "RowPointer", "DisplayString", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortName=scsiTgtPortName, ScsiIdType=ScsiIdType, scsiDscLunTable=scsiDscLunTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLogicalUnit=scsiLogicalUnit, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiModule=scsiModule, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiCompliances=scsiCompliances, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiator=scsiInitiator, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportFCP=scsiTransportFCP, scsiLuState=scsiLuState, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapLun=scsiLunMapLun, scsiTranportOther=scsiTranportOther, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiLUNOrZero=ScsiLUNOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, ScsiName=ScsiName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdIndex=scsiLuIdIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceResets=scsiDeviceResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportSBP=scsiTransportSBP, scsiPortIndex=scsiPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTranportSPI=scsiTranportSPI, scsiLuInResets=scsiLuInResets, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiDeviceAlias=scsiDeviceAlias, scsiInstIndex=scsiInstIndex, scsiPortTable=scsiPortTable, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiObjects=scsiObjects, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiPortEntry=scsiPortEntry, scsiTgtPortTable=scsiTgtPortTable, scsiPortRole=scsiPortRole, scsiLuWwnName=scsiLuWwnName, PYSNMP_MODULE_ID=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtTable=scsiDscTgtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIndex=scsiLuIndex)
