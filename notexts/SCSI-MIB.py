...
MibIdentifier, TimeTicks, mib_2, Counter64, Counter32, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, ObjectIdentity, IpAddress, Integer32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "mib-2", "Counter64", "Counter32", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType", "Bits")
TruthValue, DisplayString, TimeStamp, RowPointer, TextualConvention, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TimeStamp", "RowPointer", "TextualConvention", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuProductId=scsiLuProductId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunTable=scsiDscLunTable, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuState=scsiLuState, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportSBP=scsiTransportSBP, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceAlias=scsiDeviceAlias, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapTable=scsiLunMapTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportSRP=scsiTransportSRP, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuEntry=scsiLuEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortIndex=scsiPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiCompliance=scsiCompliance, scsiPortRole=scsiPortRole, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiCompliances=scsiCompliances, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiModule=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdValue=ScsiIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevTable=scsiIntrDevTable, scsiPortEntry=scsiPortEntry, ScsiIdType=ScsiIdType, scsiInstanceTable=scsiInstanceTable, scsiTarget=scsiTarget, scsiLuVendorId=scsiLuVendorId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInitiator=scsiInitiator, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiConformance=scsiConformance, scsiLunMapLun=scsiLunMapLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGeneral=scsiGeneral, scsiLuIdTable=scsiLuIdTable, scsiDscLunLun=scsiDscLunLun, ScsiIdAssociation=ScsiIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIndex=scsiDscLunIndex, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiGroups=scsiGroups, ScsiIdentifier=ScsiIdentifier, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiName=ScsiName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTable=scsiPortTable, scsiTrnsptType=scsiTrnsptType)
