...
Counter32, mib_2, ObjectIdentity, Unsigned32, NotificationType, Bits, iso, IpAddress, Counter64, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "ObjectIdentity", "Unsigned32", "NotificationType", "Bits", "iso", "IpAddress", "Counter64", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "TimeTicks")
TextualConvention, AutonomousType, RowStatus, RowPointer, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowStatus", "RowPointer", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiPortRole=scsiPortRole, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiLuIndex=scsiLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiLunMapLun=scsiLunMapLun, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportTypes=scsiTransportTypes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiTranportSPI=scsiTranportSPI, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiGeneral=scsiGeneral, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiCompliances=scsiCompliances, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuVendorId=scsiLuVendorId, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevTable=scsiIntrDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIndexValue=ScsiIndexValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstIndex=scsiInstIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiTranportOther=scsiTranportOther, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiConformance=scsiConformance, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdentifier=ScsiIdentifier, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunTable=scsiDscLunTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiName=ScsiName, scsiLuIdType=scsiLuIdType, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiGroups=scsiGroups, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdValue=ScsiIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdType=ScsiIdType, scsiPortTable=scsiPortTable, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetGroup=scsiTargetGroup, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiTransportSRP=scsiTransportSRP, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuTable=scsiLuTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceEntry=scsiDeviceEntry)
