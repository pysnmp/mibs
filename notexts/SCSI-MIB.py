...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter32, NotificationType, Integer32, Gauge32, mib_2, Bits, IpAddress, TimeTicks, Unsigned32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter32", "NotificationType", "Integer32", "Gauge32", "mib-2", "Bits", "IpAddress", "TimeTicks", "Unsigned32", "iso", "Counter64")
RowPointer, RowStatus, TextualConvention, AutonomousType, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TextualConvention", "AutonomousType", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInResets=scsiLuInResets, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiModule=scsiModule, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatus=scsiLuStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiConformance=scsiConformance, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTarget=scsiTarget, scsiDeviceResets=scsiDeviceResets, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIndex=scsiDscLunIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTranportSPI=scsiTranportSPI, ScsiIdType=ScsiIdType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportFCP=scsiTransportFCP, scsiPortIndex=scsiPortIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptType=scsiTrnsptType, ScsiIdentifier=ScsiIdentifier, scsiPortEntry=scsiPortEntry, scsiLuProductId=scsiLuProductId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIndex=scsiDscTgtIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstanceTable=scsiInstanceTable, scsiCompliance=scsiCompliance, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdTable=scsiLuIdTable, scsiGroups=scsiGroups, scsiPortTable=scsiPortTable, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunTable=scsiDscLunTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuState=scsiLuState, scsiDeviceEntry=scsiDeviceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, ScsiIdAssociation=ScsiIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuEntry=scsiLuEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValue=ScsiIndexValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuVendorId=scsiLuVendorId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiCompliances=scsiCompliances, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotifications=scsiNotifications, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstAlias=scsiInstAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportOther=scsiTranportOther, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands)
