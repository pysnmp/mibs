...
MibIdentifier, Integer32, Counter64, IpAddress, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Bits, Unsigned32, ModuleIdentity, ObjectIdentity, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Counter64", "IpAddress", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Bits", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiDscLunLun=scsiDscLunLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSRP=scsiTransportSRP, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortTable=scsiPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiName=ScsiName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTarget=scsiTarget, scsiDscTgtTable=scsiDscTgtTable, scsiTargetGroup=scsiTargetGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInResets=scsiLuInResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapIndex=scsiLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGroups=scsiGroups, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotifications=scsiNotifications, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuState=scsiLuState, scsiPortEntry=scsiPortEntry, scsiObjects=scsiObjects, scsiInstAlias=scsiInstAlias, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValue=ScsiIndexValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiModule=scsiModule, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortTable=scsiTgtPortTable, PYSNMP_MODULE_ID=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiLuTable=scsiLuTable, scsiDeviceRole=scsiDeviceRole, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportSPI=scsiTranportSPI, scsiLuWwnName=scsiLuWwnName, ScsiLUNOrZero=ScsiLUNOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuEntry=scsiLuEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiLuStatus=scsiLuStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdValue=ScsiIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuRevisionId=scsiLuRevisionId, scsiLuProductId=scsiLuProductId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiTranportOther=scsiTranportOther, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiCompliance=scsiCompliance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiGeneral=scsiGeneral, scsiDeviceAlias=scsiDeviceAlias, ScsiIdentifier=ScsiIdentifier, scsiTransportISCSI=scsiTransportISCSI, scsiLuIdType=scsiLuIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunTable=scsiDscLunTable)
