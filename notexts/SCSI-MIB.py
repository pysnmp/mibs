...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Gauge32, mib_2, Unsigned32, ModuleIdentity, NotificationType, TimeTicks, Bits, IpAddress, ObjectIdentity, Integer32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Gauge32", "mib-2", "Unsigned32", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "IpAddress", "ObjectIdentity", "Integer32", "MibIdentifier", "iso")
TruthValue, AutonomousType, RowPointer, TextualConvention, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowPointer", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuVendorId=scsiLuVendorId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortRole=scsiPortRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdentifier=ScsiIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuProductId=scsiLuProductId, scsiTransportSRP=scsiTransportSRP, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiNotifications=scsiNotifications, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtEntry=scsiDscTgtEntry, scsiInstIndex=scsiInstIndex, scsiTransportSBP=scsiTransportSBP, scsiTarget=scsiTarget, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunLun=scsiDscLunLun, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiDscLunTable=scsiDscLunTable, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWwnName=scsiLuWwnName, scsiDeviceTable=scsiDeviceTable, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiInstAlias=scsiInstAlias, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtName=scsiIntrPrtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdValue=scsiLuIdValue, ScsiIdValue=ScsiIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortIndex=scsiPortIndex, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiCompliances=scsiCompliances, scsiLuState=scsiLuState, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortEntry=scsiPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiModule=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuStatus=scsiLuStatus, scsiTransportTypes=scsiTransportTypes, scsiLuInCommands=scsiLuInCommands, scsiDscTgtName=scsiDscTgtName, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiObjects=scsiObjects, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiTgtDevEntry=scsiTgtDevEntry)
