...
mib_2, ModuleIdentity, Counter64, Integer32, MibIdentifier, iso, TimeTicks, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, NotificationType, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Counter64", "Integer32", "MibIdentifier", "iso", "TimeTicks", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "NotificationType", "Gauge32", "Unsigned32")
TimeStamp, RowPointer, TextualConvention, TruthValue, DisplayString, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TextualConvention", "TruthValue", "DisplayString", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceEntry=scsiDeviceEntry, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiGeneral=scsiGeneral, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiModule=scsiModule, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunLun=scsiDscLunLun, scsiPortEntry=scsiPortEntry, scsiPortIndex=scsiPortIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiConformance=scsiConformance, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortName=scsiTgtPortName, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportTypes=scsiTransportTypes, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdentifier=ScsiIdentifier, scsiGroups=scsiGroups, scsiInitiatorGroup=scsiInitiatorGroup, PYSNMP_MODULE_ID=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptType=scsiTrnsptType, scsiTarget=scsiTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiLuState=scsiLuState, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdType=ScsiIdType, scsiTransportISCSI=scsiTransportISCSI, scsiLuWwnName=scsiLuWwnName, scsiDeviceRole=scsiDeviceRole, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiTranportOther=scsiTranportOther, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInCommands=scsiLuInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiCompliances=scsiCompliances, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportFCP=scsiTransportFCP, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiPortTable=scsiPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuStatus=scsiLuStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiNotifications=scsiNotifications, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortRole=scsiPortRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiCompliance=scsiCompliance, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets)
