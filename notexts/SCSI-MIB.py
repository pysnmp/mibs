...
Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Counter32, MibIdentifier, iso, NotificationType, ModuleIdentity, Gauge32, Integer32, TimeTicks, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Counter32", "MibIdentifier", "iso", "NotificationType", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks", "IpAddress", "Bits")
RowStatus, TimeStamp, TextualConvention, TruthValue, AutonomousType, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiName=ScsiName, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, ScsiIdentifier=ScsiIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunLun=scsiDscLunLun, ScsiIdType=ScsiIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, ScsiLUNOrZero=ScsiLUNOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTransportTypes=scsiTransportTypes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuState=scsiLuState, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportOther=scsiTranportOther, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstAlias=scsiInstAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, ScsiIdValue=ScsiIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrName=scsiAuthIntrName, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiTarget=scsiTarget, scsiTargetGroup=scsiTargetGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortEntry=scsiPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstIndex=scsiInstIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdValue=scsiLuIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiDeviceRole=scsiDeviceRole, scsiModule=scsiModule, scsiDscTgtName=scsiDscTgtName, scsiLuWwnName=scsiLuWwnName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptType=scsiTrnsptType, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuTable=scsiLuTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuEntry=scsiLuEntry, scsiLuIdType=scsiLuIdType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceResets=scsiDeviceResets, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGroups=scsiGroups, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuVendorId=scsiLuVendorId, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiCompliance=scsiCompliance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands)
