...
Counter32, TimeTicks, Gauge32, Unsigned32, NotificationType, Integer32, ObjectIdentity, ModuleIdentity, MibIdentifier, Bits, Counter64, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "NotificationType", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
TimeStamp, DisplayString, TextualConvention, RowPointer, TruthValue, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TextualConvention", "RowPointer", "TruthValue", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdType=scsiDscLunIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuInResets=scsiLuInResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtDevTable=scsiTgtDevTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIndexValue=ScsiIndexValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuVendorId=scsiLuVendorId, scsiLuIndex=scsiLuIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortEntry=scsiTgtPortEntry, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportSPI=scsiTranportSPI, scsiIntrDevTable=scsiIntrDevTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportISCSI=scsiTransportISCSI, scsiPortEntry=scsiPortEntry, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceAlias=scsiDeviceAlias, scsiLuProductId=scsiLuProductId, scsiLuIdEntry=scsiLuIdEntry, scsiGroups=scsiGroups, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuInCommands=scsiLuInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiCompliance=scsiCompliance, scsiCompliances=scsiCompliances, scsiTarget=scsiTarget, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiConformance=scsiConformance, scsiLunMapTable=scsiLunMapTable, scsiInstAlias=scsiInstAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuTable=scsiLuTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiName=ScsiName, scsiModule=scsiModule, ScsiIdValue=ScsiIdValue, scsiPortIndex=scsiPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportSBP=scsiTransportSBP, scsiNotifications=scsiNotifications, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstIndex=scsiInstIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtTable=scsiDscTgtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportFCP=scsiTransportFCP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiPortRole=scsiPortRole, scsiLuEntry=scsiLuEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatus=scsiLuStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportOther=scsiTranportOther, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceTable=scsiDeviceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtName=scsiIntrPrtName, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDeviceStatus=scsiTgtDeviceStatus)
