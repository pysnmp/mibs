...
NotificationType, Counter32, Counter64, Bits, IpAddress, TimeTicks, Gauge32, ModuleIdentity, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "Bits", "IpAddress", "TimeTicks", "Gauge32", "ModuleIdentity", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTarget=scsiTarget, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportFCP=scsiTransportFCP, scsiTargetGroup=scsiTargetGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstAlias=scsiInstAlias, scsiLunMapTable=scsiLunMapTable, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLun=scsiLunMapLun, scsiLuIdValue=scsiLuIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiTranportSPI=scsiTranportSPI, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuProductId=scsiLuProductId, scsiInitiator=scsiInitiator, scsiInitiatorGroup=scsiInitiatorGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiName=ScsiName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapGroup=scsiLunMapGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiPortEntry=scsiPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTranportOther=scsiTranportOther, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiLogicalUnit=scsiLogicalUnit, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiDeviceEntry=scsiDeviceEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuTable=scsiLuTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiCompliance=scsiCompliance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdIndex=scsiLuIdIndex, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTable=scsiPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiDeviceResets=scsiDeviceResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuInCommands=scsiLuInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceTable=scsiDeviceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiModule=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue)
