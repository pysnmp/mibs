...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Unsigned32, NotificationType, Counter64, ObjectIdentity, Counter32, mib_2, IpAddress, iso, MibIdentifier, ModuleIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Unsigned32", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "mib-2", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtName=scsiIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtName=scsiDscTgtName, scsiDeviceAlias=scsiDeviceAlias, scsiObjects=scsiObjects, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstVendorVersion=scsiInstVendorVersion, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiGroups=scsiGroups, scsiLuIdAssociation=scsiLuIdAssociation, scsiModule=scsiModule, scsiLuState=scsiLuState, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstAlias=scsiInstAlias, ScsiIdType=ScsiIdType, scsiAttTgtPortName=scsiAttTgtPortName, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiName=ScsiName, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, ScsiIdValue=ScsiIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceIndex=scsiDeviceIndex, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtDevTable=scsiTgtDevTable, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiator=scsiInitiator, scsiLuVendorId=scsiLuVendorId, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunTable=scsiDscLunTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiLuInResets=scsiLuInResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuEntry=scsiLuEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdTable=scsiLuIdTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiTarget=scsiTarget, scsiDeviceRole=scsiDeviceRole, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptType=scsiTrnsptType, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIndex=scsiDscTgtIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIndex=scsiLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliances=scsiCompliances, scsiTransportTypes=scsiTransportTypes, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotifications=scsiNotifications, scsiInstSoftwareIndex=scsiInstSoftwareIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiCompliance=scsiCompliance, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuProductId=scsiLuProductId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapTable=scsiLunMapTable, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValue=ScsiIndexValue, scsiLunMapIndex=scsiLunMapIndex, scsiPortTable=scsiPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation)
