...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, TimeTicks, IpAddress, ModuleIdentity, Counter64, Counter32, mib_2, Bits, Gauge32, MibIdentifier, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "Counter32", "mib-2", "Bits", "Gauge32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Integer32")
AutonomousType, TextualConvention, TruthValue, TimeStamp, RowPointer, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp", "RowPointer", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuInResets=scsiLuInResets, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdAssociation=scsiLuIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliances=scsiCompliances, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiLogicalUnit=scsiLogicalUnit, scsiLuState=scsiLuState, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuVendorId=scsiLuVendorId, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiator=scsiInitiator, scsiLuProductId=scsiLuProductId, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevTable=scsiIntrDevTable, scsiLuIdTable=scsiLuIdTable, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdType=scsiDscLunIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiTransportFCP=scsiTransportFCP, scsiModule=scsiModule, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdValue=ScsiIdValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtTable=scsiDscTgtTable, scsiPortEntry=scsiPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiLuStatus=scsiLuStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstIndex=scsiInstIndex, scsiCompliance=scsiCompliance, scsiConformance=scsiConformance, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdValue=scsiLuIdValue, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdentifier=ScsiIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotifications=scsiNotifications, scsiDscLunEntry=scsiDscLunEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuEntry=scsiLuEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuTable=scsiLuTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTarget=scsiTarget, scsiTargetGroup=scsiTargetGroup, scsiLunMapIndex=scsiLunMapIndex, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptType=scsiTrnsptType, scsiRemoteTarget=scsiRemoteTarget, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiPortRole=scsiPortRole, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiName=ScsiName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
