...
ObjectIdentity, Integer32, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Gauge32, Unsigned32, ModuleIdentity, Bits, NotificationType, MibIdentifier, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "Bits", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks")
TruthValue, RowStatus, AutonomousType, TimeStamp, DisplayString, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "AutonomousType", "TimeStamp", "DisplayString", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstAlias=scsiInstAlias, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortIndex=scsiPortIndex, scsiTransportISCSI=scsiTransportISCSI, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceTable=scsiInstanceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceAlias=scsiDeviceAlias, scsiObjects=scsiObjects, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiInitiator=scsiInitiator, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiCompliance=scsiCompliance, scsiLuInResets=scsiLuInResets, scsiLuRevisionId=scsiLuRevisionId, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTable=scsiPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiNotifications=scsiNotifications, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuProductId=scsiLuProductId, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiName=ScsiName, scsiConformance=scsiConformance, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortEntry=scsiPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceTable=scsiDeviceTable, scsiLuIdValue=scsiLuIdValue, scsiLuStatus=scsiLuStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunLun=scsiDscLunLun, scsiTranportSPI=scsiTranportSPI, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuEntry=scsiLuEntry, scsiTgtPortName=scsiTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiDscLunEntry=scsiDscLunEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiCompliances=scsiCompliances, scsiLunMapIndex=scsiLunMapIndex, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiModule=scsiModule, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapEntry=scsiLunMapEntry, scsiGroups=scsiGroups, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdEntry=scsiLuIdEntry, scsiTransportSBP=scsiTransportSBP, scsiLuState=scsiLuState, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiLuIdType=scsiLuIdType, ScsiIdType=ScsiIdType, scsiDscLunTable=scsiDscLunTable)
