...
iso, ObjectIdentity, mib_2, ModuleIdentity, Integer32, Gauge32, IpAddress, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, NotificationType, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "mib-2", "ModuleIdentity", "Integer32", "Gauge32", "IpAddress", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "NotificationType", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiLogicalUnit=scsiLogicalUnit, scsiLuIndex=scsiLuIndex, scsiPortIndex=scsiPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTranportSPI=scsiTranportSPI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValue=ScsiIndexValue, scsiInstanceTable=scsiInstanceTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiCompliances=scsiCompliances, scsiModule=scsiModule, scsiLuInResets=scsiLuInResets, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTranportOther=scsiTranportOther, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtName=scsiIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGeneral=scsiGeneral, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortName=scsiTgtPortName, scsiDeviceIndex=scsiDeviceIndex, scsiLuIdValue=scsiLuIdValue, scsiLunMapEntry=scsiLunMapEntry, scsiInstAlias=scsiInstAlias, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdTable=scsiLuIdTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, ScsiIdType=ScsiIdType, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiGroups=scsiGroups, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceTable=scsiDeviceTable, scsiTransportISCSI=scsiTransportISCSI, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliance=scsiCompliance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiConformance=scsiConformance, scsiTarget=scsiTarget, scsiDeviceResets=scsiDeviceResets, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuState=scsiLuState, scsiInstVendorVersion=scsiInstVendorVersion, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiNotifications=scsiNotifications, scsiLunMapLun=scsiLunMapLun, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceRole=scsiDeviceRole, scsiLuStatus=scsiLuStatus, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunLun=scsiDscLunLun, scsiPortTable=scsiPortTable, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLunMapTable=scsiLunMapTable, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortEntry=scsiPortEntry, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, ScsiName=ScsiName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceGroup=scsiDeviceGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInitiator=scsiInitiator, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdValue=ScsiIdValue)
