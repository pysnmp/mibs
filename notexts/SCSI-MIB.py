...
Gauge32, Integer32, mib_2, TimeTicks, ModuleIdentity, Counter64, Unsigned32, ObjectIdentity, Counter32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "mib-2", "TimeTicks", "ModuleIdentity", "Counter64", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "iso")
RowPointer, AutonomousType, TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortName=scsiTgtPortName, scsiLuIdAssociation=scsiLuIdAssociation, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunEntry=scsiDscLunEntry, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuEntry=scsiLuEntry, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIndex=scsiLuIndex, ScsiIdType=ScsiIdType, ScsiName=ScsiName, scsiInstAlias=scsiInstAlias, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuState=scsiLuState, scsiLuIdTable=scsiLuIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuWwnName=scsiLuWwnName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuStatus=scsiLuStatus, scsiLunMapGroup=scsiLunMapGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliances=scsiCompliances, scsiDscLunLun=scsiDscLunLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdEntry=scsiDscLunIdEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportFCP=scsiTransportFCP, scsiGroups=scsiGroups, scsiLuTable=scsiLuTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiLuVendorId=scsiLuVendorId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiConformance=scsiConformance, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiModule=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuProductId=scsiLuProductId, scsiPortIndex=scsiPortIndex, scsiPortEntry=scsiPortEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtName=scsiIntrPrtName, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSBP=scsiTransportSBP, scsiLuIdType=scsiLuIdType, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiPortTable=scsiPortTable, scsiTarget=scsiTarget, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapTable=scsiLunMapTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptTable=scsiTrnsptTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceEntry=scsiDeviceEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdentifier=ScsiIdentifier, scsiPortRole=scsiPortRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceResets=scsiDeviceResets, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdEntry=scsiLuIdEntry, scsiTranportSPI=scsiTranportSPI, scsiDscLunTable=scsiDscLunTable, scsiCompliance=scsiCompliance, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiGeneral=scsiGeneral, scsiDeviceTable=scsiDeviceTable)
