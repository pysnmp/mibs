...
IpAddress, TimeTicks, Counter32, mib_2, Gauge32, Counter64, Integer32, iso, ObjectIdentity, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter32", "mib-2", "Gauge32", "Counter64", "Integer32", "iso", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Unsigned32")
DisplayString, TimeStamp, RowStatus, TextualConvention, TruthValue, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuInResets=scsiLuInResets, scsiLuTable=scsiLuTable, scsiLunMapIndex=scsiLunMapIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceEntry=scsiDeviceEntry, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceIndex=scsiDeviceIndex, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiPortRole=scsiPortRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortName=scsiTgtPortName, scsiLuStatus=scsiLuStatus, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiLuState=scsiLuState, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdType=ScsiIdType, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtName=scsiIntrPrtName, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdValue=scsiLuIdValue, scsiDscTgtTable=scsiDscTgtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportSPI=scsiTranportSPI, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunTable=scsiDscLunTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortTable=scsiTgtPortTable, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiGroups=scsiGroups, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTable=scsiIntrDevTable, scsiLuInCommands=scsiLuInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptType=scsiTrnsptType, scsiLunMapLun=scsiLunMapLun, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortIndex=scsiPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiObjects=scsiObjects, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortTable=scsiPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuProductId=scsiLuProductId, scsiNotifications=scsiNotifications, scsiDeviceRole=scsiDeviceRole, scsiTranportOther=scsiTranportOther, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiCompliances=scsiCompliances, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorGroup=scsiInitiatorGroup, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapTable=scsiLunMapTable, PYSNMP_MODULE_ID=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiModule=scsiModule, scsiInstanceTable=scsiInstanceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIndex=scsiLuIndex, scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdType=scsiLuIdType, scsiTgtDevEntry=scsiTgtDevEntry, ScsiName=ScsiName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuWwnName=scsiLuWwnName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstIndex=scsiInstIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands)
