...
Counter32, TimeTicks, Bits, Gauge32, MibIdentifier, Integer32, ObjectIdentity, mib_2, Unsigned32, iso, Counter64, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Bits", "Gauge32", "MibIdentifier", "Integer32", "ObjectIdentity", "mib-2", "Unsigned32", "iso", "Counter64", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
AutonomousType, TruthValue, DisplayString, RowPointer, TimeStamp, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "DisplayString", "RowPointer", "TimeStamp", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiNotifications=scsiNotifications, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdTable=scsiLuIdTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIndexValue=ScsiIndexValue, scsiLogicalUnit=scsiLogicalUnit, scsiTransportFCP=scsiTransportFCP, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceResets=scsiDeviceResets, scsiTranportOther=scsiTranportOther, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSBP=scsiTransportSBP, scsiLuIdType=scsiLuIdType, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdValue=scsiLuIdValue, scsiLuInCommands=scsiLuInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapEntry=scsiLunMapEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLun=scsiLunMapLun, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInstIndex=scsiInstIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapTable=scsiLunMapTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuVendorId=scsiLuVendorId, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrDevTable=scsiIntrDevTable, scsiObjects=scsiObjects, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiModule=scsiModule, scsiCompliances=scsiCompliances, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdEntry=scsiLuIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiName=ScsiName, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtTable=scsiDscTgtTable, ScsiIdValue=ScsiIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunTable=scsiDscLunTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstAlias=scsiInstAlias, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuInResets=scsiLuInResets, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortIndex=scsiPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiInitiator=scsiInitiator, scsiPortTable=scsiPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuProductId=scsiLuProductId, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDeviceEntry=scsiDeviceEntry, scsiDeviceRole=scsiDeviceRole, ScsiIdentifier=ScsiIdentifier, scsiLuEntry=scsiLuEntry, ScsiIdType=ScsiIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatus=scsiLuStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGroups=scsiGroups, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiConformance=scsiConformance, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiRemoteTarget=scsiRemoteTarget)
