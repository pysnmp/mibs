...
Integer32, iso, Gauge32, IpAddress, MibIdentifier, ModuleIdentity, Bits, mib_2, Counter64, TimeTicks, ObjectIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "IpAddress", "MibIdentifier", "ModuleIdentity", "Bits", "mib-2", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
RowStatus, TimeStamp, TruthValue, AutonomousType, TextualConvention, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuEntry=scsiLuEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiPortTable=scsiPortTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuRevisionId=scsiLuRevisionId, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiCompliance=scsiCompliance, scsiNotifications=scsiNotifications, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortRole=scsiPortRole, scsiTargetGroup=scsiTargetGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValue=ScsiIndexValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdTable=scsiLuIdTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiator=scsiInitiator, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuTable=scsiLuTable, scsiConformance=scsiConformance, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortIndex=scsiPortIndex, ScsiName=ScsiName, scsiDscTgtName=scsiDscTgtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceEntry=scsiDeviceEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceTable=scsiDeviceTable, scsiModule=scsiModule, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuInResets=scsiLuInResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiGroups=scsiGroups, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiTranportOther=scsiTranportOther, scsiInstIndex=scsiInstIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuProductId=scsiLuProductId, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, ScsiIdValue=ScsiIdValue, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteTarget=scsiRemoteTarget, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportSRP=scsiTransportSRP, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunLun=scsiDscLunLun, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportFCP=scsiTransportFCP, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiDeviceResets=scsiDeviceResets)
