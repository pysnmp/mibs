...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, NotificationType, ObjectIdentity, ModuleIdentity, Counter64, MibIdentifier, Unsigned32, Bits, Gauge32, iso, TimeTicks, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Counter64", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "iso", "TimeTicks", "mib-2", "Counter32")
AutonomousType, TimeStamp, DisplayString, RowStatus, RowPointer, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, ScsiIdValue=ScsiIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptType=scsiTrnsptType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiLuTable=scsiLuTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapTable=scsiLunMapTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportFCP=scsiTransportFCP, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, ScsiIndexValue=ScsiIndexValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortName=scsiTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiTarget=scsiTarget, scsiDscLunIndex=scsiDscLunIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLun=scsiLunMapLun, scsiDeviceTable=scsiDeviceTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiDeviceResets=scsiDeviceResets, scsiLuState=scsiLuState, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiCompliance=scsiCompliance, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotifications=scsiNotifications, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunLun=scsiDscLunLun, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiIntrDevEntry=scsiIntrDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdEntry=scsiLuIdEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortEntry=scsiPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiObjects=scsiObjects, scsiTransportSRP=scsiTransportSRP, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, ScsiName=ScsiName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiConformance=scsiConformance, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiCompliances=scsiCompliances, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuInResets=scsiLuInResets, scsiLuIdType=scsiLuIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdentifier=ScsiIdentifier, ScsiIdType=ScsiIdType, scsiLuProductId=scsiLuProductId, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiPortIndex=scsiPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiRemoteInitiators=scsiRemoteInitiators, scsiGeneral=scsiGeneral, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceTable=scsiInstanceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuEntry=scsiLuEntry, scsiDeviceStatGroup=scsiDeviceStatGroup)
