...
mib_2, NotificationType, ModuleIdentity, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, MibIdentifier, ObjectIdentity, Gauge32, Bits, TimeTicks, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "ModuleIdentity", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Gauge32", "Bits", "TimeTicks", "Counter32", "Counter64")
AutonomousType, TruthValue, TimeStamp, DisplayString, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "TimeStamp", "DisplayString", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuTable=scsiLuTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuInCommands=scsiLuInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptType=scsiTrnsptType, scsiLuProductId=scsiLuProductId, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTranportOther=scsiTranportOther, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuRevisionId=scsiLuRevisionId, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdIndex=scsiLuIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuEntry=scsiLuEntry, scsiLunMapEntry=scsiLunMapEntry, scsiTarget=scsiTarget, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtName=scsiDscTgtName, scsiDeviceIndex=scsiDeviceIndex, scsiPortTable=scsiPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiCompliance=scsiCompliance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiObjects=scsiObjects, scsiPortRole=scsiPortRole, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiLuIndex=scsiLuIndex, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiGeneral=scsiGeneral, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceRole=scsiDeviceRole, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiCompliances=scsiCompliances, ScsiName=ScsiName, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIndexValue=ScsiIndexValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdTable=scsiLuIdTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTranportSPI=scsiTranportSPI, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotifications=scsiNotifications, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtEntry=scsiDscTgtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstanceEntry=scsiInstanceEntry, scsiLuInResets=scsiLuInResets, scsiDeviceResets=scsiDeviceResets, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceTable=scsiInstanceTable, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuState=scsiLuState, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLun=scsiLunMapLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDeviceTable=scsiDeviceTable, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTransportSRP=scsiTransportSRP, scsiGroups=scsiGroups, scsiLuWwnName=scsiLuWwnName, scsiTransportTypes=scsiTransportTypes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortIndex=scsiPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiInstAlias=scsiInstAlias, ScsiIdCodeSet=ScsiIdCodeSet)
