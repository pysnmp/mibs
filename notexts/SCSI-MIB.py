...
Counter32, Unsigned32, Bits, ModuleIdentity, mib_2, Integer32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, MibIdentifier, ObjectIdentity, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Bits", "ModuleIdentity", "mib-2", "Integer32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter64")
DisplayString, RowStatus, RowPointer, TextualConvention, TruthValue, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "TruthValue", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTranportSPI=scsiTranportSPI, scsiConformance=scsiConformance, scsiTargetGroup=scsiTargetGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortEntry=scsiPortEntry, scsiPortRole=scsiPortRole, scsiDeviceTable=scsiDeviceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiTgtPortTable=scsiTgtPortTable, scsiInstIndex=scsiInstIndex, scsiLunMapLun=scsiLunMapLun, scsiLuRevisionId=scsiLuRevisionId, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportFCP=scsiTransportFCP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, scsiTransportSBP=scsiTransportSBP, scsiLuVendorId=scsiLuVendorId, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdType=ScsiIdType, scsiLuIdTable=scsiLuIdTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiName=ScsiName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdType=scsiLuIdType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortEntry=scsiTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdEntry=scsiLuIdEntry, ScsiIdentifier=ScsiIdentifier, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptType=scsiTrnsptType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliances=scsiCompliances, scsiPortTable=scsiPortTable, scsiTranportOther=scsiTranportOther, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiGroups=scsiGroups, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstAlias=scsiInstAlias, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, PYSNMP_MODULE_ID=scsiModule, scsiLunMapTable=scsiLunMapTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInitiator=scsiInitiator, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTarget=scsiTarget, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliance=scsiCompliance, scsiRemoteTarget=scsiRemoteTarget, scsiLuInResets=scsiLuInResets, scsiDscLunLun=scsiDscLunLun, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptTable=scsiTrnsptTable, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiObjects=scsiObjects, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup)
