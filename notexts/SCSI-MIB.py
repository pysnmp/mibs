...
TimeTicks, ObjectIdentity, Counter32, iso, Bits, MibIdentifier, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, ModuleIdentity, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter32", "iso", "Bits", "MibIdentifier", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "ModuleIdentity", "Gauge32", "mib-2")
AutonomousType, RowPointer, RowStatus, TimeStamp, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "RowStatus", "TimeStamp", "TextualConvention", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevEntry=scsiTgtDevEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatus=scsiLuStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunLun=scsiDscLunLun, ScsiIdType=ScsiIdType, scsiDscLunTable=scsiDscLunTable, scsiLuIdValue=scsiLuIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortTable=scsiPortTable, scsiTransportSRP=scsiTransportSRP, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiRemoteTarget=scsiRemoteTarget, scsiModule=scsiModule, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiObjects=scsiObjects, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortIndex=scsiPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortRole=scsiPortRole, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortEntry=scsiTgtPortEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiTarget=scsiTarget, scsiConformance=scsiConformance, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiPortEntry=scsiPortEntry, scsiInitiator=scsiInitiator, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiCompliance=scsiCompliance, scsiDscTgtName=scsiDscTgtName, ScsiIndexValue=ScsiIndexValue, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuEntry=scsiLuEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInstIndex=scsiInstIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdValue=ScsiIdValue, scsiNotifications=scsiNotifications, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTranportOther=scsiTranportOther, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliances=scsiCompliances, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapTable=scsiLunMapTable, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGeneral=scsiGeneral, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuTable=scsiLuTable, scsiDscTgtTable=scsiDscTgtTable, scsiInstAlias=scsiInstAlias, scsiLuWwnName=scsiLuWwnName, scsiLuState=scsiLuState, scsiTrnsptType=scsiTrnsptType, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuInCommands=scsiLuInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiName=ScsiName, scsiLuInResets=scsiLuInResets, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry)
