...
mib_2, Unsigned32, Counter32, IpAddress, iso, TimeTicks, Integer32, Bits, NotificationType, Counter64, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "Counter32", "IpAddress", "iso", "TimeTicks", "Integer32", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier")
TruthValue, AutonomousType, DisplayString, TextualConvention, RowPointer, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "RowPointer", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuVendorId=scsiLuVendorId, scsiRemoteInitiators=scsiRemoteInitiators, ScsiIdAssociation=ScsiIdAssociation, scsiGeneral=scsiGeneral, scsiNotifications=scsiNotifications, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportTypes=scsiTransportTypes, scsiLuIndex=scsiLuIndex, scsiTransportSBP=scsiTransportSBP, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuProductId=scsiLuProductId, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapIndex=scsiLunMapIndex, ScsiName=ScsiName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIdTable=scsiDscLunIdTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiPortTable=scsiPortTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortIndex=scsiPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdType=ScsiIdType, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetGroup=scsiTargetGroup, scsiLuIdTable=scsiLuIdTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdentifier=ScsiIdentifier, scsiLuTable=scsiLuTable, scsiDscLunTable=scsiDscLunTable, scsiInstIndex=scsiInstIndex, scsiLuState=scsiLuState, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTransportISCSI=scsiTransportISCSI, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuInResets=scsiLuInResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiPortRole=scsiPortRole, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, ScsiIdValue=ScsiIdValue, scsiTrnsptType=scsiTrnsptType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunLun=scsiDscLunLun, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiCompliances=scsiCompliances, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiator=scsiInitiator, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiModule=scsiModule, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTarget=scsiTarget, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdIndex=scsiLuIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus)
