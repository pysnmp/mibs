...
Bits, iso, IpAddress, ObjectIdentity, MibIdentifier, Integer32, Unsigned32, mib_2, ModuleIdentity, NotificationType, Counter64, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "Unsigned32", "mib-2", "ModuleIdentity", "NotificationType", "Counter64", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
TimeStamp, RowPointer, RowStatus, TruthValue, AutonomousType, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "RowStatus", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuEntry=scsiLuEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiLunMapLun=scsiLunMapLun, ScsiIdentifier=ScsiIdentifier, scsiDeviceResets=scsiDeviceResets, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTrnsptDevName=scsiTrnsptDevName, scsiObjects=scsiObjects, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTranportOther=scsiTranportOther, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiPortTable=scsiPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, PYSNMP_MODULE_ID=scsiModule, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdType=scsiLuIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiPortEntry=scsiPortEntry, scsiDeviceRole=scsiDeviceRole, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliances=scsiCompliances, scsiDeviceGroup=scsiDeviceGroup, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunEntry=scsiDscLunEntry, scsiTranportSPI=scsiTranportSPI, scsiInstanceEntry=scsiInstanceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetGroup=scsiTargetGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGroups=scsiGroups, scsiTransportTypes=scsiTransportTypes, scsiLunMapTable=scsiLunMapTable, scsiPortIndex=scsiPortIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiName=ScsiName, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiLuInResets=scsiLuInResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunLun=scsiDscLunLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortTable=scsiTgtPortTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapGroup=scsiLunMapGroup, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuTable=scsiLuTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtTable=scsiDscTgtTable, ScsiIdType=ScsiIdType, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiModule=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIndexValue=ScsiIndexValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstAlias=scsiInstAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunTable=scsiDscLunTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstIndex=scsiInstIndex, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes)
