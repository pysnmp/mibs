...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, Bits, Counter32, Counter64, Gauge32, IpAddress, iso, NotificationType, MibIdentifier, ModuleIdentity, ObjectIdentity, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "Bits", "Counter32", "Counter64", "Gauge32", "IpAddress", "iso", "NotificationType", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Integer32", "Unsigned32")
RowPointer, AutonomousType, TextualConvention, TruthValue, RowStatus, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiGroups=scsiGroups, scsiConformance=scsiConformance, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiTarget=scsiTarget, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTargetGroup=scsiTargetGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuTable=scsiLuTable, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiPortIndex=scsiPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInCommands=scsiLuInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuWwnName=scsiLuWwnName, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportOther=scsiTranportOther, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceTable=scsiInstanceTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliance=scsiCompliance, scsiModule=scsiModule, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiLuVendorId=scsiLuVendorId, scsiLuProductId=scsiLuProductId, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIdType=scsiLuIdType, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiPortTable=scsiPortTable, scsiLuIdValue=scsiLuIdValue, ScsiIndexValue=ScsiIndexValue, scsiLuStatus=scsiLuStatus, scsiLuState=scsiLuState, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiDscLunIdTable=scsiDscLunIdTable, scsiInstAlias=scsiInstAlias, scsiLuEntry=scsiLuEntry, scsiIntrPrtName=scsiIntrPrtName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiCompliances=scsiCompliances, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiObjects=scsiObjects, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, scsiLunMapLun=scsiLunMapLun, scsiLuIdTable=scsiLuIdTable, scsiTrnsptType=scsiTrnsptType, scsiInitiator=scsiInitiator, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdType=ScsiIdType, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtName=scsiDscTgtName, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, scsiPortEntry=scsiPortEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortName=scsiTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunLun=scsiDscLunLun, scsiInstIndex=scsiInstIndex, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTransportSRP=scsiTransportSRP, scsiTransportISCSI=scsiTransportISCSI, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTransportFCP=scsiTransportFCP, scsiRemoteTarget=scsiRemoteTarget, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes)
