...
mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, Bits, Counter32, TimeTicks, Gauge32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "Bits", "Counter32", "TimeTicks", "Gauge32", "iso", "NotificationType")
TruthValue, TextualConvention, TimeStamp, AutonomousType, RowStatus, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TimeStamp", "AutonomousType", "RowStatus", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapGroup=scsiLunMapGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInstVendorVersion=scsiInstVendorVersion, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtTable=scsiDscTgtTable, scsiLuIdType=scsiLuIdType, scsiLuInResets=scsiLuInResets, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTarget=scsiTarget, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdValue=scsiLuIdValue, scsiConformance=scsiConformance, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTranportSPI=scsiTranportSPI, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiNotifications=scsiNotifications, scsiLuTable=scsiLuTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiObjects=scsiObjects, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceRole=scsiDeviceRole, scsiTrnsptTable=scsiTrnsptTable, scsiPortEntry=scsiPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiator=scsiInitiator, scsiCompliance=scsiCompliance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIndexValue=ScsiIndexValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWwnName=scsiLuWwnName, scsiTgtPortName=scsiTgtPortName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptType=scsiTrnsptType, scsiLuEntry=scsiLuEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDeviceTable=scsiDeviceTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiGeneral=scsiGeneral, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliances=scsiCompliances, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiModule=scsiModule, scsiPortIndex=scsiPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiInstanceTable=scsiInstanceTable, scsiLuIdIndex=scsiLuIdIndex, ScsiName=ScsiName, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSRP=scsiTransportSRP, scsiTransportSBP=scsiTransportSBP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiTgtDevTable=scsiTgtDevTable, scsiGroups=scsiGroups, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunTable=scsiDscLunTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdEntry=scsiLuIdEntry, scsiLuState=scsiLuState, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrName=scsiAuthIntrName, ScsiIdType=ScsiIdType, scsiDscLunIndex=scsiDscLunIndex, scsiTranportOther=scsiTranportOther, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdValue=ScsiIdValue, scsiLunMapLun=scsiLunMapLun, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunLun=scsiDscLunLun)
