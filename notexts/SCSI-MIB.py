...
iso, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, TimeTicks, Counter64, IpAddress, Counter32, ObjectIdentity, ModuleIdentity, Bits, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "Counter32", "ObjectIdentity", "ModuleIdentity", "Bits", "mib-2", "Unsigned32")
AutonomousType, RowPointer, TruthValue, DisplayString, RowStatus, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TruthValue", "DisplayString", "RowStatus", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstIndex=scsiInstIndex, ScsiIdValue=ScsiIdValue, scsiCompliances=scsiCompliances, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceRole=scsiDeviceRole, scsiTgtPortEntry=scsiTgtPortEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuWwnName=scsiLuWwnName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuInResets=scsiLuInResets, scsiLuEntry=scsiLuEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTable=scsiIntrDevTable, scsiTransportSBP=scsiTransportSBP, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortRole=scsiPortRole, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptType=scsiTrnsptType, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiNotifications=scsiNotifications, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTransportFCP=scsiTransportFCP, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdTable=scsiLuIdTable, scsiObjects=scsiObjects, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdentifier=ScsiIdentifier, scsiLuIdType=scsiLuIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIndex=scsiDscLunIndex, ScsiName=ScsiName, scsiPortEntry=scsiPortEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, scsiTgtPortTable=scsiTgtPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiConformance=scsiConformance, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLunMapIndex=scsiLunMapIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdType=ScsiIdType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuStatus=scsiLuStatus, scsiCompliance=scsiCompliance, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortIndex=scsiPortIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunTable=scsiDscLunTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportOther=scsiTranportOther, scsiLunMapGroup=scsiLunMapGroup, scsiInstAlias=scsiInstAlias, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiGeneral=scsiGeneral, scsiTransportSRP=scsiTransportSRP, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapEntry=scsiLunMapEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdValue=scsiLuIdValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrPrtName=scsiIntrPrtName, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLogicalUnit=scsiLogicalUnit, ScsiIndexValue=ScsiIndexValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTranportSPI=scsiTranportSPI, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuTable=scsiLuTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceAlias=scsiDeviceAlias, scsiModule=scsiModule, scsiLuProductId=scsiLuProductId, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdType=scsiDscLunIdType, PYSNMP_MODULE_ID=scsiModule, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportTypes=scsiTransportTypes)
