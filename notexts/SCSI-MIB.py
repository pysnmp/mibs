...
Integer32, NotificationType, mib_2, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, TimeTicks, Gauge32, ObjectIdentity, IpAddress, Bits, Counter64, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "mib-2", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "TimeTicks", "Gauge32", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "ModuleIdentity", "Unsigned32")
TruthValue, TextualConvention, AutonomousType, TimeStamp, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuProductId=scsiLuProductId, scsiPortTable=scsiPortTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuTable=scsiLuTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuVendorId=scsiLuVendorId, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortName=scsiAttTgtPortName, PYSNMP_MODULE_ID=scsiModule, scsiGeneral=scsiGeneral, scsiInitiator=scsiInitiator, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceRole=scsiDeviceRole, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportTypes=scsiTransportTypes, ScsiIdType=ScsiIdType, scsiPortIndex=scsiPortIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuWwnName=scsiLuWwnName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrName=scsiAuthIntrName, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtName=scsiIntrPrtName, scsiInstIndex=scsiInstIndex, scsiCompliances=scsiCompliances, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdTable=scsiLuIdTable, scsiLuState=scsiLuState, scsiTarget=scsiTarget, scsiInstAlias=scsiInstAlias, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdValue=scsiLuIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteTarget=scsiRemoteTarget, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiName=ScsiName, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiPortEntry=scsiPortEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIndexValue=ScsiIndexValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGroups=scsiGroups, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdEntry=scsiLuIdEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuStatus=scsiLuStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiObjects=scsiObjects, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiTransportFCP=scsiTransportFCP, scsiDeviceTable=scsiDeviceTable, scsiModule=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliance=scsiCompliance, scsiConformance=scsiConformance, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuInResets=scsiLuInResets, scsiTransportSBP=scsiTransportSBP, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiNotifications=scsiNotifications, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstanceTable=scsiInstanceTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuEntry=scsiLuEntry, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptDevName=scsiTrnsptDevName, scsiTranportOther=scsiTranportOther, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry)
