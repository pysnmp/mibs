...
Gauge32, Bits, Counter64, IpAddress, Integer32, Counter32, Unsigned32, ModuleIdentity, mib_2, TimeTicks, MibIdentifier, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter64", "IpAddress", "Integer32", "Counter32", "Unsigned32", "ModuleIdentity", "mib-2", "TimeTicks", "MibIdentifier", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, AutonomousType, RowPointer, DisplayString, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowPointer", "DisplayString", "RowStatus", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiIdAssociation=ScsiIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceEntry=scsiDeviceEntry, scsiGeneral=scsiGeneral, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiCompliances=scsiCompliances, ScsiIdType=ScsiIdType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiGroups=scsiGroups, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiLogicalUnit=scsiLogicalUnit, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportSRP=scsiTransportSRP, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInitiator=scsiInitiator, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortTable=scsiPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuProductId=scsiLuProductId, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstVendorVersion=scsiInstVendorVersion, ScsiIndexValue=ScsiIndexValue, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportSBP=scsiTransportSBP, scsiDscLunTable=scsiDscLunTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuWwnName=scsiLuWwnName, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptType=scsiTrnsptType, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapIndex=scsiLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLun=scsiLunMapLun, scsiTargetGroup=scsiTargetGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiConformance=scsiConformance, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInResets=scsiLuInResets, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiName=ScsiName, scsiCompliance=scsiCompliance, PYSNMP_MODULE_ID=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiDscLunIdTable=scsiDscLunIdTable, scsiTarget=scsiTarget, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceRole=scsiDeviceRole, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtName=scsiDscTgtName, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortEntry=scsiPortEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceResets=scsiDeviceResets, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiInstIndex=scsiInstIndex, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrName=scsiAuthIntrName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortTable=scsiAttTgtPortTable)
