...
Counter64, mib_2, NotificationType, ModuleIdentity, Bits, TimeTicks, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "iso")
TimeStamp, RowPointer, RowStatus, TruthValue, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "RowStatus", "TruthValue", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuInCommands=scsiLuInCommands, scsiConformance=scsiConformance, scsiTrnsptDevName=scsiTrnsptDevName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetGroup=scsiTargetGroup, scsiPortTable=scsiPortTable, scsiModule=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportTypes=scsiTransportTypes, ScsiIdentifier=ScsiIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiGeneral=scsiGeneral, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevTable=scsiTgtDevTable, scsiLuVendorId=scsiLuVendorId, scsiTranportSPI=scsiTranportSPI, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, PYSNMP_MODULE_ID=scsiModule, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, ScsiIdAssociation=ScsiIdAssociation, scsiRemoteTarget=scsiRemoteTarget, scsiLuProductId=scsiLuProductId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiTranportOther=scsiTranportOther, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIndex=scsiLuIndex, scsiCompliance=scsiCompliance, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTable=scsiIntrDevTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortIndex=scsiPortIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunLun=scsiDscLunLun, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortRole=scsiPortRole, scsiCompliances=scsiCompliances, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiObjects=scsiObjects, scsiTarget=scsiTarget, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiDeviceAlias=scsiDeviceAlias, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIndexValue=ScsiIndexValue, scsiLuIdType=scsiLuIdType, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiName=ScsiName, scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, scsiDeviceTable=scsiDeviceTable, scsiNotifications=scsiNotifications, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiLuInResets=scsiLuInResets, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdAssociation=scsiLuIdAssociation)
