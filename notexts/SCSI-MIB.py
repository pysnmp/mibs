...
Integer32, IpAddress, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter64, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, iso, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter64", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "iso", "Unsigned32", "ModuleIdentity")
RowStatus, RowPointer, DisplayString, TextualConvention, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuProductId=scsiLuProductId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiLuDefaultLun=scsiLuDefaultLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTranportOther=scsiTranportOther, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportTypes=scsiTransportTypes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuEntry=scsiLuEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapLun=scsiLunMapLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIndex=scsiDscLunIndex, scsiPortIndex=scsiPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapTable=scsiLunMapTable, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortTable=scsiTgtPortTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiObjects=scsiObjects, scsiConformance=scsiConformance, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiName=ScsiName, scsiPortRole=scsiPortRole, ScsiIdType=ScsiIdType, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTransportISCSI=scsiTransportISCSI, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiNotifications=scsiNotifications, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtName=scsiDscTgtName, scsiLuInResets=scsiLuInResets, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunEntry=scsiDscLunEntry, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiModule=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTransportFCP=scsiTransportFCP, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdType=scsiLuIdType, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGroups=scsiGroups, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorGroup=scsiInitiatorGroup, PYSNMP_MODULE_ID=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuTable=scsiLuTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuState=scsiLuState, ScsiIndexValue=ScsiIndexValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName)
