...
mib_2, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, iso, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "iso", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "Counter64", "NotificationType")
RowPointer, AutonomousType, TimeStamp, RowStatus, TruthValue, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "AutonomousType", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortEntry=scsiPortEntry, scsiLuWwnName=scsiLuWwnName, scsiTranportOther=scsiTranportOther, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportTypes=scsiTransportTypes, scsiLunMapEntry=scsiLunMapEntry, scsiLuStatusChanged=scsiLuStatusChanged, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIndexValue=ScsiIndexValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceAlias=scsiDeviceAlias, scsiTransportFCP=scsiTransportFCP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTranportSPI=scsiTranportSPI, scsiLunMapIndex=scsiLunMapIndex, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdType=ScsiIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiNotifications=scsiNotifications, scsiTrnsptType=scsiTrnsptType, ScsiName=ScsiName, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiPortRole=scsiPortRole, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortName=scsiTgtPortName, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiLuPeripheralType=scsiLuPeripheralType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuState=scsiLuState, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuInCommands=scsiLuInCommands, scsiCompliance=scsiCompliance, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects, scsiLuTable=scsiLuTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiator=scsiInitiator, ScsiIdValue=ScsiIdValue, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceRole=scsiDeviceRole, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevTable=scsiTgtDevTable, scsiModule=scsiModule, scsiLuEntry=scsiLuEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiCompliances=scsiCompliances, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtName=scsiDscTgtName, scsiTargetGroup=scsiTargetGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiConformance=scsiConformance, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiRemoteTarget=scsiRemoteTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTable=scsiPortTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGeneral=scsiGeneral, scsiAuthIntrName=scsiAuthIntrName, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIndex=scsiLuIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortIndex=scsiPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdValue=scsiLuIdValue, scsiTarget=scsiTarget, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdType=scsiLuIdType, scsiLunMapTable=scsiLunMapTable)
