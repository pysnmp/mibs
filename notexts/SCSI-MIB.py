...
ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, iso, IpAddress, Gauge32, MibIdentifier, Bits, mib_2, Unsigned32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "iso", "IpAddress", "Gauge32", "MibIdentifier", "Bits", "mib-2", "Unsigned32", "Counter32", "ObjectIdentity")
AutonomousType, DisplayString, RowStatus, RowPointer, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceEntry=scsiDeviceEntry, scsiInstanceTable=scsiInstanceTable, scsiPortTable=scsiPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiGeneral=scsiGeneral, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapTable=scsiLunMapTable, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiTarget=scsiTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliances=scsiCompliances, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInitiator=scsiInitiator, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtName=scsiDscTgtName, scsiLuWwnName=scsiLuWwnName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceResets=scsiDeviceResets, scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdValue=scsiLuIdValue, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, PYSNMP_MODULE_ID=scsiModule, scsiLuIdIndex=scsiLuIdIndex, scsiCompliance=scsiCompliance, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortTable=scsiTgtPortTable, scsiTargetGroup=scsiTargetGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiObjects=scsiObjects, ScsiIdValue=ScsiIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiAttTgtPortName=scsiAttTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTgtDevTable=scsiTgtDevTable, scsiInstIndex=scsiInstIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiDeviceGroup=scsiDeviceGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiGroups=scsiGroups, scsiPortRole=scsiPortRole, scsiDscLunIdType=scsiDscLunIdType, scsiLuIdType=scsiLuIdType, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuVendorId=scsiLuVendorId, scsiLuEntry=scsiLuEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortEntry=scsiPortEntry, scsiLuIndex=scsiLuIndex, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstanceEntry=scsiInstanceEntry, scsiLuProductId=scsiLuProductId, ScsiIndexValue=ScsiIndexValue, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceTable=scsiDeviceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiName=ScsiName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuTable=scsiLuTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstAlias=scsiInstAlias, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrName=scsiAuthIntrName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTransportSRP=scsiTransportSRP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportFCP=scsiTransportFCP, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrIndex=scsiAuthIntrIndex)
