...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter32, Bits, iso, MibIdentifier, TimeTicks, Integer32, NotificationType, IpAddress, Counter64, mib_2, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter32", "Bits", "iso", "MibIdentifier", "TimeTicks", "Integer32", "NotificationType", "IpAddress", "Counter64", "mib-2", "Gauge32", "Unsigned32")
TimeStamp, AutonomousType, RowPointer, TruthValue, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowPointer", "TruthValue", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliances=scsiCompliances, scsiLuIdEntry=scsiLuIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatus=scsiLuStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIndex=scsiLuIndex, scsiLuInResets=scsiLuInResets, scsiNotifications=scsiNotifications, scsiConformance=scsiConformance, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceEntry=scsiDeviceEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTransportTypes=scsiTransportTypes, scsiLuProductId=scsiLuProductId, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIdValue=ScsiIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortTable=scsiPortTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceResets=scsiDeviceResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdType=scsiLuIdType, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuState=scsiLuState, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuTable=scsiLuTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuRevisionId=scsiLuRevisionId, scsiGroups=scsiGroups, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstIndex=scsiInstIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapTable=scsiLunMapTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstanceEntry=scsiInstanceEntry, scsiPortIndex=scsiPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortRole=scsiPortRole, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiObjects=scsiObjects, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiTransportSRP=scsiTransportSRP, scsiDscTgtName=scsiDscTgtName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortEntry=scsiPortEntry, scsiLuWwnName=scsiLuWwnName, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIndex=scsiDscLunIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuEntry=scsiLuEntry, scsiInitiator=scsiInitiator, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceIndex=scsiDeviceIndex, ScsiIdType=ScsiIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLun=scsiLunMapLun, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceRole=scsiDeviceRole, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSBP=scsiTransportSBP, ScsiName=ScsiName, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes)
