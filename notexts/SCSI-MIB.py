...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, TimeTicks, Counter32, ModuleIdentity, iso, MibIdentifier, IpAddress, Integer32, Gauge32, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "TimeTicks", "Counter32", "ModuleIdentity", "iso", "MibIdentifier", "IpAddress", "Integer32", "Gauge32", "Bits", "NotificationType", "Unsigned32")
DisplayString, RowStatus, TimeStamp, RowPointer, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TimeStamp", "RowPointer", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiName=ScsiName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuState=scsiLuState, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceResets=scsiDeviceResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunLun=scsiDscLunLun, ScsiIdValue=ScsiIdValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuProductId=scsiLuProductId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiTgtPortName=scsiTgtPortName, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuTable=scsiLuTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, scsiLuInResets=scsiLuInResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuRevisionId=scsiLuRevisionId, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiGeneral=scsiGeneral, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportFCP=scsiTransportFCP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceRole=scsiDeviceRole, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiModule=scsiModule, scsiInitiator=scsiInitiator, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, ScsiIdType=ScsiIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiGroups=scsiGroups, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiDscLunIdType=scsiDscLunIdType, ScsiLUNOrZero=ScsiLUNOrZero, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiCompliance=scsiCompliance, scsiInstanceTable=scsiInstanceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortTable=scsiPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWwnName=scsiLuWwnName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiConformance=scsiConformance, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtName=scsiDscTgtName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortEntry=scsiPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortEntry=scsiTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunEntry=scsiDscLunEntry, scsiDeviceGroup=scsiDeviceGroup, scsiInstIndex=scsiInstIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiTranportSPI=scsiTranportSPI, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtTable=scsiDscTgtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiDeviceTable=scsiDeviceTable, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus)
