...
iso, TimeTicks, Unsigned32, Gauge32, MibIdentifier, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, mib_2, Integer32, Bits, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Unsigned32", "Gauge32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "mib-2", "Integer32", "Bits", "NotificationType", "IpAddress")
AutonomousType, RowStatus, RowPointer, TruthValue, TimeStamp, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "RowPointer", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdType=scsiLuIdType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportOther=scsiTranportOther, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceRole=scsiDeviceRole, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuWwnName=scsiLuWwnName, scsiLuRevisionId=scsiLuRevisionId, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiLunMapIndex=scsiLunMapIndex, scsiLuVendorId=scsiLuVendorId, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortEntry=scsiTgtPortEntry, scsiModule=scsiModule, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstIndex=scsiInstIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdType=scsiDscLunIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtTable=scsiDscTgtTable, ScsiIdValue=ScsiIdValue, scsiTransportFCP=scsiTransportFCP, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunLun=scsiDscLunLun, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptType=scsiTrnsptType, scsiGroups=scsiGroups, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiDscLunTable=scsiDscLunTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTargetGroup=scsiTargetGroup, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuState=scsiLuState, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTransportTypes=scsiTransportTypes, scsiInitiator=scsiInitiator, scsiLunMapLun=scsiLunMapLun, scsiConformance=scsiConformance, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdAssociation=ScsiIdAssociation, ScsiIdType=ScsiIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTranportSPI=scsiTranportSPI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTarget=scsiTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiCompliance=scsiCompliance, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiCompliances=scsiCompliances, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, scsiTgtPortName=scsiTgtPortName, scsiPortTable=scsiPortTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtName=scsiIntrPrtName, scsiPortIndex=scsiPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuTable=scsiLuTable, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiObjects=scsiObjects, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtName=scsiDscTgtName, scsiLuInResets=scsiLuInResets, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdValue=scsiLuIdValue, scsiLuIndex=scsiLuIndex, scsiLuStatus=scsiLuStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptEntry=scsiTrnsptEntry, ScsiIdentifier=ScsiIdentifier, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiTransportSRP=scsiTransportSRP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceTable=scsiDeviceTable)
