...
mib_2, TimeTicks, Counter32, Counter64, ObjectIdentity, NotificationType, Unsigned32, Bits, IpAddress, ModuleIdentity, Gauge32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "Counter32", "Counter64", "ObjectIdentity", "NotificationType", "Unsigned32", "Bits", "IpAddress", "ModuleIdentity", "Gauge32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
DisplayString, RowPointer, RowStatus, AutonomousType, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiNotifications=scsiNotifications, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTransportSRP=scsiTransportSRP, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapTable=scsiLunMapTable, scsiPortEntry=scsiPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceTable=scsiDeviceTable, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiTarget=scsiTarget, scsiTrnsptType=scsiTrnsptType, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdIndex=scsiLuIdIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiGroups=scsiGroups, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdValue=scsiLuIdValue, ScsiName=ScsiName, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceAlias=scsiDeviceAlias, scsiCompliances=scsiCompliances, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdType=ScsiIdType, scsiLuIdTable=scsiLuIdTable, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiModule=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiConformance=scsiConformance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLogicalUnit=scsiLogicalUnit, scsiDeviceRole=scsiDeviceRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInResets=scsiLuInResets, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdType=scsiLuIdType, scsiDeviceResets=scsiDeviceResets, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuTable=scsiLuTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortIndex=scsiPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiInitiator=scsiInitiator, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtName=scsiDscTgtName, scsiDscLunEntry=scsiDscLunEntry, scsiInstAlias=scsiInstAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuEntry=scsiLuEntry, scsiObjects=scsiObjects, scsiTransportISCSI=scsiTransportISCSI, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunLun=scsiDscLunLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortRole=scsiPortRole, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIndex=scsiLuIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiCompliance=scsiCompliance, scsiDscTgtIndex=scsiDscTgtIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuState=scsiLuState, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiLuInCommands=scsiLuInCommands, ScsiIdValue=ScsiIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuWwnName=scsiLuWwnName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiPortTable=scsiPortTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands)
