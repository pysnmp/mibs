...
Bits, ModuleIdentity, NotificationType, ObjectIdentity, Counter64, Gauge32, IpAddress, mib_2, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Counter64", "Gauge32", "IpAddress", "mib-2", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter32", "Integer32", "Unsigned32")
TextualConvention, AutonomousType, DisplayString, RowPointer, TruthValue, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "RowPointer", "TruthValue", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSBP=scsiTransportSBP, ScsiLUNOrZero=ScsiLUNOrZero, scsiTranportSPI=scsiTranportSPI, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtTable=scsiDscTgtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiConformance=scsiConformance, scsiInitiator=scsiInitiator, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscLunEntry=scsiDscLunEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuEntry=scsiLuEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuProductId=scsiLuProductId, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortEntry=scsiPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevEntry=scsiIntrDevEntry, scsiTarget=scsiTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiGeneral=scsiGeneral, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiPortIndex=scsiPortIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuStatus=scsiLuStatus, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotifications=scsiNotifications, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, PYSNMP_MODULE_ID=scsiModule, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuTable=scsiLuTable, scsiCompliances=scsiCompliances, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunTable=scsiDscLunTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTrnsptType=scsiTrnsptType, scsiPortRole=scsiPortRole, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiObjects=scsiObjects, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIndex=scsiLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTranportOther=scsiTranportOther, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiName=ScsiName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapLun=scsiLunMapLun, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuIdValue=scsiLuIdValue, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunLun=scsiDscLunLun, scsiInstanceTable=scsiInstanceTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiTargetGroup=scsiTargetGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapEntry=scsiLunMapEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuWwnName=scsiLuWwnName, ScsiIdentifier=ScsiIdentifier, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdValue=ScsiIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuVendorId=scsiLuVendorId, scsiInstAlias=scsiInstAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdType=scsiLuIdType, scsiDscLunIdType=scsiDscLunIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuInCommands=scsiLuInCommands, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry)
