...
ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType, iso, MibIdentifier, Counter64, Counter32, Bits, TimeTicks, Integer32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType", "iso", "MibIdentifier", "Counter64", "Counter32", "Bits", "TimeTicks", "Integer32", "mib-2")
RowPointer, RowStatus, TimeStamp, TruthValue, DisplayString, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "TimeStamp", "TruthValue", "DisplayString", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuState=scsiLuState, ScsiIdentifier=ScsiIdentifier, scsiTranportOther=scsiTranportOther, scsiInstanceTable=scsiInstanceTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortTable=scsiTgtPortTable, scsiLuTable=scsiLuTable, scsiTransportTypes=scsiTransportTypes, scsiTransportFCP=scsiTransportFCP, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortEntry=scsiPortEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiCompliances=scsiCompliances, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliance=scsiCompliance, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiName=ScsiName, scsiInstAlias=scsiInstAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuInCommands=scsiLuInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdType=ScsiIdType, scsiTransportSRP=scsiTransportSRP, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortRole=scsiPortRole, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiator=scsiInitiator, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiRemoteTarget=scsiRemoteTarget, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIndexValue=ScsiIndexValue, scsiInstIndex=scsiInstIndex, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiTransportISCSI=scsiTransportISCSI, scsiTranportSPI=scsiTranportSPI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdTable=scsiLuIdTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiPortTable=scsiPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceResets=scsiDeviceResets, scsiDscTgtName=scsiDscTgtName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiTarget=scsiTarget, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiGeneral=scsiGeneral, scsiNotifications=scsiNotifications, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiDeviceEntry=scsiDeviceEntry, scsiPortIndex=scsiPortIndex, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuInResets=scsiLuInResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdType=scsiLuIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuRevisionId=scsiLuRevisionId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIndex=scsiLuIndex, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapGroup=scsiLunMapGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiModule=scsiModule, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdValue=ScsiIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdAssociation=ScsiIdAssociation, scsiObjects=scsiObjects, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex)
