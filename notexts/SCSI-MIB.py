...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter64, ObjectIdentity, Counter32, Bits, Gauge32, mib_2, Unsigned32, IpAddress, iso, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter64", "ObjectIdentity", "Counter32", "Bits", "Gauge32", "mib-2", "Unsigned32", "IpAddress", "iso", "TimeTicks", "MibIdentifier", "NotificationType")
TimeStamp, RowStatus, AutonomousType, TruthValue, TextualConvention, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "TruthValue", "TextualConvention", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceAlias=scsiDeviceAlias, scsiTransportTypes=scsiTransportTypes, scsiDscLunIndex=scsiDscLunIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdType=scsiDscLunIdType, scsiLuInCommands=scsiLuInCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdType=scsiLuIdType, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuState=scsiLuState, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiNotifications=scsiNotifications, scsiLuWwnName=scsiLuWwnName, scsiLuTable=scsiLuTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstIndex=scsiInstIndex, scsiDeviceRole=scsiDeviceRole, scsiDeviceTable=scsiDeviceTable, ScsiIdAssociation=ScsiIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuProductId=scsiLuProductId, scsiLuInResets=scsiLuInResets, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiLuIdValue=scsiLuIdValue, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortEntry=scsiPortEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdType=ScsiIdType, scsiCompliances=scsiCompliances, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtName=scsiIntrPrtName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstanceTable=scsiInstanceTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortTable=scsiPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuStatus=scsiLuStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuEntry=scsiLuEntry, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSRP=scsiTransportSRP, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLunMapGroup=scsiLunMapGroup, scsiTranportOther=scsiTranportOther, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceEntry=scsiDeviceEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortRole=scsiPortRole, scsiGeneral=scsiGeneral, scsiInstAlias=scsiInstAlias, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortIndex=scsiPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiModule=scsiModule, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiObjects=scsiObjects, scsiGroups=scsiGroups, ScsiName=ScsiName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTranportSPI=scsiTranportSPI, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTarget=scsiTarget, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet)
