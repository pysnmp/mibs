...
Counter32, Integer32, NotificationType, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, iso, TimeTicks, ModuleIdentity, mib_2, Gauge32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "iso", "TimeTicks", "ModuleIdentity", "mib-2", "Gauge32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, TimeStamp, RowStatus, TextualConvention, RowPointer, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "RowPointer", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiCompliance=scsiCompliance, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiConformance=scsiConformance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportSBP=scsiTransportSBP, scsiDscLunLun=scsiDscLunLun, scsiModule=scsiModule, scsiNotifications=scsiNotifications, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiGeneral=scsiGeneral, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLogicalUnit=scsiLogicalUnit, scsiTranportOther=scsiTranportOther, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValue=ScsiIndexValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortTable=scsiPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptType=scsiTrnsptType, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, ScsiIdValue=ScsiIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLuRevisionId=scsiLuRevisionId, PYSNMP_MODULE_ID=scsiModule, scsiDscLunTable=scsiDscLunTable, scsiLuTable=scsiLuTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtName=scsiDscTgtName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortIndex=scsiPortIndex, ScsiIdType=ScsiIdType, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiIdentifier=ScsiIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscLunEntry=scsiDscLunEntry, scsiInstIndex=scsiInstIndex, scsiLuStatus=scsiLuStatus, scsiDeviceGroup=scsiDeviceGroup, scsiLuInResets=scsiLuInResets, scsiLuIdType=scsiLuIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtTable=scsiDscTgtTable, ScsiName=ScsiName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiator=scsiInitiator, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuState=scsiLuState, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiPortRole=scsiPortRole, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIndex=scsiLuIndex, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiLuIdValue=scsiLuIdValue, scsiTransportFCP=scsiTransportFCP, scsiTranportSPI=scsiTranportSPI, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTargetGroup=scsiTargetGroup, scsiLuVendorId=scsiLuVendorId, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTarget=scsiTarget, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuInCommands=scsiLuInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuEntry=scsiLuEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevTable=scsiTgtDevTable)
