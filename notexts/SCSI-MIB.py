...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Counter64, IpAddress, NotificationType, iso, MibIdentifier, mib_2, Unsigned32, Bits, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Counter64", "IpAddress", "NotificationType", "iso", "MibIdentifier", "mib-2", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "TimeTicks")
TruthValue, RowPointer, RowStatus, DisplayString, AutonomousType, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowPointer", "RowStatus", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstAlias=scsiInstAlias, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiInitiator=scsiInitiator, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceTable=scsiDeviceTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiDscLunTable=scsiDscLunTable, scsiLuIndex=scsiLuIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTransportSRP=scsiTransportSRP, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiConformance=scsiConformance, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtEntry=scsiIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuVendorId=scsiLuVendorId, scsiTransportTypes=scsiTransportTypes, scsiDeviceAlias=scsiDeviceAlias, scsiLuInCommands=scsiLuInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceEntry=scsiDeviceEntry, scsiCompliance=scsiCompliance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortName=scsiTgtPortName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapStatsGroup=scsiLunMapStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceIndex=scsiDeviceIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiObjects=scsiObjects, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuWwnName=scsiLuWwnName, scsiLuIdTable=scsiLuIdTable, scsiDeviceRole=scsiDeviceRole, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiName=ScsiName, scsiLuStatus=scsiLuStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiCompliances=scsiCompliances, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTrnsptType=scsiTrnsptType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTrnsptTable=scsiTrnsptTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTarget=scsiTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortEntry=scsiPortEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiGeneral=scsiGeneral, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIndex=scsiDscLunIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiModule=scsiModule, scsiInstIndex=scsiInstIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiLuState=scsiLuState, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiLunMapEntry=scsiLunMapEntry, scsiDscLunLun=scsiDscLunLun, scsiLuEntry=scsiLuEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTranportOther=scsiTranportOther, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdIndex=scsiLuIdIndex, ScsiIdentifier=ScsiIdentifier, scsiGroups=scsiGroups, scsiRemoteInitiators=scsiRemoteInitiators, scsiNotifications=scsiNotifications, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceResets=scsiDeviceResets, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTranportSPI=scsiTranportSPI, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuTable=scsiLuTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapTable=scsiLunMapTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable)
