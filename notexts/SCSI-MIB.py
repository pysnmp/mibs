...
Counter64, Gauge32, Counter32, ObjectIdentity, Bits, mib_2, iso, ModuleIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "Bits", "mib-2", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "MibIdentifier", "NotificationType")
RowPointer, DisplayString, AutonomousType, TextualConvention, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiGeneral=scsiGeneral, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunLun=scsiDscLunLun, scsiDscLunTable=scsiDscLunTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdEntry=scsiLuIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortTable=scsiTgtPortTable, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIndex=scsiLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceRole=scsiDeviceRole, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIndexValue=ScsiIndexValue, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiName=ScsiName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiCompliance=scsiCompliance, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstAlias=scsiInstAlias, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiPortRole=scsiPortRole, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuEntry=scsiLuEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptType=scsiTrnsptType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiPortEntry=scsiPortEntry, scsiTransportFCP=scsiTransportFCP, scsiTransportTypes=scsiTransportTypes, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLuProductId=scsiLuProductId, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuInCommands=scsiLuInCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIdType=scsiLuIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatus=scsiLuStatus, scsiLuIdValue=scsiLuIdValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdentifier=ScsiIdentifier, scsiTranportSPI=scsiTranportSPI, ScsiIdType=ScsiIdType, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiObjects=scsiObjects, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTargetGroup=scsiTargetGroup, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuVendorId=scsiLuVendorId, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiCompliances=scsiCompliances, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiLUNOrZero=ScsiLUNOrZero, scsiGroups=scsiGroups, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdValue=ScsiIdValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
