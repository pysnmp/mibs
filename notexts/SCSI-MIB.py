...
Integer32, iso, ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, NotificationType, Counter32, MibIdentifier, TimeTicks, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "NotificationType", "Counter32", "MibIdentifier", "TimeTicks", "mib-2", "Counter64")
DisplayString, TimeStamp, AutonomousType, TruthValue, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdIndex=scsiLuIdIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtName=scsiDscTgtName, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, scsiPortTable=scsiPortTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstanceEntry=scsiInstanceEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunTable=scsiDscLunTable, scsiDscLunLun=scsiDscLunLun, scsiLuIdValue=scsiLuIdValue, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIndex=scsiDscLunIndex, scsiPortEntry=scsiPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceRole=scsiDeviceRole, scsiCompliance=scsiCompliance, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportISCSI=scsiTransportISCSI, scsiPortRole=scsiPortRole, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuProductId=scsiLuProductId, scsiDeviceResets=scsiDeviceResets, scsiInstIndex=scsiInstIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInResets=scsiLuInResets, scsiLunMapGroup=scsiLunMapGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiLuPeripheralType=scsiLuPeripheralType, scsiInitiator=scsiInitiator, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdType=scsiDscLunIdType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiModule=scsiModule, scsiDscTgtTable=scsiDscTgtTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiCompliances=scsiCompliances, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiConformance=scsiConformance, scsiPortIndex=scsiPortIndex, scsiLuIdTable=scsiLuIdTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiTarget=scsiTarget, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportTypes=scsiTransportTypes, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptDevName=scsiTrnsptDevName, scsiDeviceEntry=scsiDeviceEntry, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiIdentifier=ScsiIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstAlias=scsiInstAlias, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiGroups=scsiGroups, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuVendorId=scsiLuVendorId, ScsiIdAssociation=ScsiIdAssociation, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrName=scsiAuthIntrName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLunMapLun=scsiLunMapLun, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiObjects=scsiObjects, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdType=ScsiIdType, scsiTrnsptTable=scsiTrnsptTable, ScsiIdValue=ScsiIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuState=scsiLuState, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiTransportFCP=scsiTransportFCP, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTranportSPI=scsiTranportSPI, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapIndex=scsiLunMapIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex)
