...
Gauge32, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits, Counter64, mib_2, ObjectIdentity, TimeTicks, Counter32, iso, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "mib-2", "ObjectIdentity", "TimeTicks", "Counter32", "iso", "NotificationType", "Unsigned32")
DisplayString, RowStatus, AutonomousType, TextualConvention, RowPointer, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention", "RowPointer", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunTable=scsiDscLunTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdIndex=scsiLuIdIndex, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiNotifications=scsiNotifications, scsiTransportISCSI=scsiTransportISCSI, scsiInitiator=scsiInitiator, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDeviceResets=scsiDeviceResets, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIdentifier=ScsiIdentifier, scsiLuInResets=scsiLuInResets, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstAlias=scsiInstAlias, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatus=scsiLuStatus, scsiLuIdType=scsiLuIdType, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuWwnName=scsiLuWwnName, scsiTransportSRP=scsiTransportSRP, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceEntry=scsiDeviceEntry, scsiPortEntry=scsiPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, ScsiIdValue=ScsiIdValue, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtName=scsiDscTgtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTranportOther=scsiTranportOther, scsiObjects=scsiObjects, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortIndex=scsiPortIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiGeneral=scsiGeneral, scsiGroups=scsiGroups, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiRemoteTarget=scsiRemoteTarget, scsiTarget=scsiTarget, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTgtPortName=scsiTgtPortName, scsiConformance=scsiConformance, scsiDscLunEntry=scsiDscLunEntry, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdType=ScsiIdType, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuTable=scsiLuTable, scsiCompliances=scsiCompliances, scsiLunMapLun=scsiLunMapLun, scsiLuState=scsiLuState, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortRole=scsiPortRole, scsiDscLunLun=scsiDscLunLun, scsiLuInCommands=scsiLuInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuVendorId=scsiLuVendorId, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceAlias=scsiDeviceAlias, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuProductId=scsiLuProductId, scsiLuIndex=scsiLuIndex, scsiInstIndex=scsiInstIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTgtDevTable=scsiTgtDevTable, ScsiName=ScsiName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIndexValue=ScsiIndexValue, scsiTransportTypes=scsiTransportTypes, scsiCompliance=scsiCompliance, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup)
