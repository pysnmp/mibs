...
ObjectIdentity, Gauge32, ModuleIdentity, Counter32, iso, IpAddress, MibIdentifier, Integer32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32", "iso", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "NotificationType")
TimeStamp, TextualConvention, RowStatus, DisplayString, RowPointer, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "RowPointer", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiCompliance=scsiCompliance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapGroup=scsiLunMapGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTarget=scsiTarget, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtDevTable=scsiTgtDevTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTransportFCP=scsiTransportFCP, scsiPortTable=scsiPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiPortIndex=scsiPortIndex, scsiLuIdValue=scsiLuIdValue, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTranportOther=scsiTranportOther, scsiTgtDevEntry=scsiTgtDevEntry, PYSNMP_MODULE_ID=scsiModule, scsiModule=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuVendorId=scsiLuVendorId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapLun=scsiLunMapLun, ScsiIndexValueOrZero=ScsiIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdValue=ScsiIdValue, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdEntry=scsiLuIdEntry, scsiConformance=scsiConformance, scsiDeviceIndex=scsiDeviceIndex, scsiTrnsptType=scsiTrnsptType, scsiDeviceResets=scsiDeviceResets, scsiTransportSBP=scsiTransportSBP, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttTgtPortName=scsiAttTgtPortName, scsiLunMapIndex=scsiLunMapIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdTable=scsiLuIdTable, scsiDeviceAlias=scsiDeviceAlias, scsiGeneral=scsiGeneral, ScsiIdType=ScsiIdType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevEntry=scsiIntrDevEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuWwnName=scsiLuWwnName, scsiInstanceTable=scsiInstanceTable, scsiLuTable=scsiLuTable, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiName=ScsiName, scsiPortRole=scsiPortRole, scsiDscLunTable=scsiDscLunTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstAlias=scsiInstAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuInResets=scsiLuInResets, scsiNotifications=scsiNotifications, scsiDeviceRole=scsiDeviceRole, scsiTgtPortName=scsiTgtPortName, scsiLuIndex=scsiLuIndex, ScsiIdAssociation=ScsiIdAssociation, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceTable=scsiDeviceTable, scsiTranportSPI=scsiTranportSPI, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstIndex=scsiInstIndex, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, scsiCompliances=scsiCompliances, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrName=scsiAuthIntrName, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuEntry=scsiLuEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunLun=scsiDscLunLun, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortEntry=scsiPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunEntry=scsiDscLunEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiTransportTypes=scsiTransportTypes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevTable=scsiIntrDevTable, scsiInitiator=scsiInitiator, scsiObjects=scsiObjects, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatus=scsiLuStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup)
