...
ObjectIdentity, Unsigned32, ModuleIdentity, mib_2, TimeTicks, Bits, Counter32, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Counter64, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "mib-2", "TimeTicks", "Bits", "Counter32", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Counter64", "iso", "NotificationType")
DisplayString, TextualConvention, TruthValue, TimeStamp, RowPointer, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "TimeStamp", "RowPointer", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunTable=scsiDscLunTable, scsiTgtPortName=scsiTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdValue=scsiLuIdValue, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIdType=ScsiIdType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiLuEntry=scsiLuEntry, scsiGeneral=scsiGeneral, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIndex=scsiLuIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiIdValue=ScsiIdValue, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuInResets=scsiLuInResets, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortEntry=scsiPortEntry, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, scsiIntrPrtName=scsiIntrPrtName, scsiInitiator=scsiInitiator, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTarget=scsiTarget, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdType=scsiLuIdType, PYSNMP_MODULE_ID=scsiModule, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliance=scsiCompliance, scsiLuInCommands=scsiLuInCommands, scsiLuVendorId=scsiLuVendorId, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortIndex=scsiPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiModule=scsiModule, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTransportFCP=scsiTransportFCP, scsiDeviceRole=scsiDeviceRole, scsiLuRevisionId=scsiLuRevisionId, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiCompliances=scsiCompliances, scsiInstAlias=scsiInstAlias, scsiInstanceTable=scsiInstanceTable, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportOther=scsiTranportOther, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiConformance=scsiConformance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiNotifications=scsiNotifications, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuWwnName=scsiLuWwnName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdTable=scsiLuIdTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiName=ScsiName, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiPortRole=scsiPortRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiLuProductId=scsiLuProductId, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtName=scsiDscTgtName, scsiLuStatus=scsiLuStatus, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtTable=scsiIntrPrtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiGroups=scsiGroups, scsiTgtPortTable=scsiTgtPortTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiObjects=scsiObjects, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapLun=scsiLunMapLun, scsiTransportSBP=scsiTransportSBP, scsiDscTgtTable=scsiDscTgtTable, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry)
