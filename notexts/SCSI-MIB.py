...
Gauge32, Counter64, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, Bits, ModuleIdentity, Counter32, IpAddress, ObjectIdentity, TimeTicks, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "Bits", "ModuleIdentity", "Counter32", "IpAddress", "ObjectIdentity", "TimeTicks", "NotificationType", "Integer32")
AutonomousType, TextualConvention, TimeStamp, RowPointer, DisplayString, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "TimeStamp", "RowPointer", "DisplayString", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiModule=scsiModule, scsiDeviceRole=scsiDeviceRole, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapLun=scsiLunMapLun, scsiTransportISCSI=scsiTransportISCSI, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiLunMapTable=scsiLunMapTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiRemoteTarget=scsiRemoteTarget, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrName=scsiAuthIntrName, scsiInstAlias=scsiInstAlias, scsiDscLunEntry=scsiDscLunEntry, scsiGroups=scsiGroups, scsiDeviceEntry=scsiDeviceEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiTransportSBP=scsiTransportSBP, scsiLuWwnName=scsiLuWwnName, scsiDeviceAlias=scsiDeviceAlias, scsiInstVendorVersion=scsiInstVendorVersion, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuState=scsiLuState, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunIdType=scsiDscLunIdType, scsiTarget=scsiTarget, scsiTranportSPI=scsiTranportSPI, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiLuIdTable=scsiLuIdTable, scsiTrnsptEntry=scsiTrnsptEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuEntry=scsiLuEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiTransportFCP=scsiTransportFCP, scsiTgtPortTable=scsiTgtPortTable, scsiTargetGroup=scsiTargetGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiName=ScsiName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiGeneral=scsiGeneral, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtTable=scsiDscTgtTable, ScsiIndexValue=ScsiIndexValue, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiCompliances=scsiCompliances, scsiLuVendorId=scsiLuVendorId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIdValue=ScsiIdValue, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiPortRole=scsiPortRole, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSRP=scsiTransportSRP, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuProductId=scsiLuProductId, scsiPortEntry=scsiPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiTgtPortEntry=scsiTgtPortEntry, scsiIntrPrtName=scsiIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatus=scsiLuStatus, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIdEntry=scsiLuIdEntry, scsiTranportOther=scsiTranportOther, scsiCompliance=scsiCompliance, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunTable=scsiDscLunTable, scsiConformance=scsiConformance, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortIndex=scsiPortIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapEntry=scsiLunMapEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiObjects=scsiObjects, scsiLuHSInCommands=scsiLuHSInCommands, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceTable=scsiDeviceTable, scsiInstanceEntry=scsiInstanceEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiator=scsiInitiator, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands)
