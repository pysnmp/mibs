...
Counter32, ModuleIdentity, Gauge32, IpAddress, MibIdentifier, Bits, TimeTicks, NotificationType, Unsigned32, ObjectIdentity, Integer32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "TimeTicks", "NotificationType", "Unsigned32", "ObjectIdentity", "Integer32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TimeStamp, TruthValue, TextualConvention, DisplayString, AutonomousType, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "AutonomousType", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiCompliances=scsiCompliances, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortRole=scsiPortRole, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptType=scsiTrnsptType, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuIndex=scsiLuIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuStatus=scsiLuStatus, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceResets=scsiDeviceResets, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortEntry=scsiTgtPortEntry, scsiNotifications=scsiNotifications, scsiTransportSRP=scsiTransportSRP, scsiDeviceTable=scsiDeviceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuState=scsiLuState, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuProductId=scsiLuProductId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtPortName=scsiTgtPortName, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiConformance=scsiConformance, scsiLuTable=scsiLuTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportOther=scsiTranportOther, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTarget=scsiTarget, scsiLuIdEntry=scsiLuIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInResets=scsiLuInResets, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiName=ScsiName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdType=scsiLuIdType, scsiDscTgtLastCreation=scsiDscTgtLastCreation, ScsiIndexValue=ScsiIndexValue, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuEntry=scsiLuEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiGroups=scsiGroups, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiCompliance=scsiCompliance, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiGeneral=scsiGeneral, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiInstanceEntry=scsiInstanceEntry, scsiInstAlias=scsiInstAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInCommands=scsiLuInCommands, scsiInitiator=scsiInitiator, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceRole=scsiDeviceRole, scsiLuIdValue=scsiLuIdValue, scsiTrnsptTable=scsiTrnsptTable, scsiObjects=scsiObjects, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortIndex=scsiPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportISCSI=scsiTransportISCSI)
