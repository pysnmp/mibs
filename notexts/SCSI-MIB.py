...
Integer32, Unsigned32, NotificationType, ObjectIdentity, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, MibIdentifier, Gauge32, Counter64, TimeTicks, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "NotificationType", "ObjectIdentity", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "MibIdentifier", "Gauge32", "Counter64", "TimeTicks", "mib-2", "ModuleIdentity")
TextualConvention, TruthValue, TimeStamp, DisplayString, AutonomousType, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "AutonomousType", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiIdValue=ScsiIdValue, scsiPortIndex=scsiPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceResets=scsiDeviceResets, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapEntry=scsiLunMapEntry, scsiInstanceTable=scsiInstanceTable, scsiLuRevisionId=scsiLuRevisionId, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, scsiLuWwnName=scsiLuWwnName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiNotifications=scsiNotifications, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInResets=scsiLuInResets, scsiLuIndex=scsiLuIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtTable=scsiDscTgtTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiConformance=scsiConformance, scsiLuEntry=scsiLuEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceGroup=scsiDeviceGroup, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiGeneral=scsiGeneral, scsiLuIdIndex=scsiLuIdIndex, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValue=ScsiIndexValue, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiObjects=scsiObjects, scsiGroups=scsiGroups, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiTransportSBP=scsiTransportSBP, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdEntry=scsiLuIdEntry, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstIndex=scsiInstIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTarget=scsiTarget, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuTable=scsiLuTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstAlias=scsiInstAlias, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuProductId=scsiLuProductId, scsiDeviceAlias=scsiDeviceAlias, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTranportSPI=scsiTranportSPI, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdType=ScsiIdType, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdType=scsiLuIdType, scsiCompliances=scsiCompliances, scsiDscLunEntry=scsiDscLunEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportISCSI=scsiTransportISCSI, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtTable=scsiIntrPrtTable, scsiCompliance=scsiCompliance, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiModule=scsiModule, scsiTrnsptType=scsiTrnsptType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortEntry=scsiPortEntry, scsiLunMapLun=scsiLunMapLun, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTransportTypes=scsiTransportTypes, scsiDscLunLun=scsiDscLunLun, scsiDeviceRole=scsiDeviceRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiName=ScsiName, scsiTargetGroup=scsiTargetGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtName=scsiDscTgtName, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortTable=scsiPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportOther=scsiTranportOther, scsiLuInCommands=scsiLuInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInitiatorGroup=scsiInitiatorGroup)
