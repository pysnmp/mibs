...
mib_2, Counter64, TimeTicks, IpAddress, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ObjectIdentity, MibIdentifier, Unsigned32, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "TimeTicks", "IpAddress", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Bits", "Integer32", "NotificationType")
RowPointer, DisplayString, TextualConvention, RowStatus, AutonomousType, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDevicePortNumber=scsiDevicePortNumber, scsiGeneral=scsiGeneral, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, scsiInstIndex=scsiInstIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, scsiInitiator=scsiInitiator, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunTable=scsiDscLunTable, scsiLunMapTable=scsiLunMapTable, scsiTransportSBP=scsiTransportSBP, scsiTransportTypes=scsiTransportTypes, scsiLuWwnName=scsiLuWwnName, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiRemoteTarget=scsiRemoteTarget, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTransportFCP=scsiTransportFCP, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortTable=scsiPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuEntry=scsiLuEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiCompliance=scsiCompliance, scsiDeviceEntry=scsiDeviceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthIntrName=scsiAuthIntrName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDeviceIndex=scsiDeviceIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiLuVendorId=scsiLuVendorId, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunLun=scsiDscLunLun, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiInstAlias=scsiInstAlias, scsiLuProductId=scsiLuProductId, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiConformance=scsiConformance, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuInResets=scsiLuInResets, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstanceTable=scsiInstanceTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiInstanceEntry=scsiInstanceEntry, scsiLuInCommands=scsiLuInCommands, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevEntry=scsiIntrDevEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTransportSRP=scsiTransportSRP, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiName=ScsiName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtName=scsiDscTgtName, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiPortEntry=scsiPortEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdType=ScsiIdType, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTranportSPI=scsiTranportSPI, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiObjects=scsiObjects, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdType=scsiLuIdType, ScsiIdAssociation=ScsiIdAssociation, ScsiIdentifier=ScsiIdentifier, scsiModule=scsiModule, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuState=scsiLuState, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTarget=scsiTarget, scsiPortRole=scsiPortRole, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortName=scsiTgtPortName, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLun=scsiLunMapLun, scsiLuTable=scsiLuTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapIndex=scsiLunMapIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiNotifications=scsiNotifications, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
