...
mib_2, Counter64, ModuleIdentity, Unsigned32, Integer32, Gauge32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, TimeTicks, Bits, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "ModuleIdentity", "Unsigned32", "Integer32", "Gauge32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "TimeTicks", "Bits", "Counter32", "ObjectIdentity")
TextualConvention, DisplayString, AutonomousType, RowStatus, TruthValue, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiDeviceGroup=scsiDeviceGroup, scsiLuWwnName=scsiLuWwnName, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuEntry=scsiLuEntry, scsiLuIndex=scsiLuIndex, scsiInstanceEntry=scsiInstanceEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdType=ScsiIdType, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTarget=scsiTarget, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdValue=scsiLuIdValue, scsiLuInResets=scsiLuInResets, scsiCompliance=scsiCompliance, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTargetGroup=scsiTargetGroup, scsiTrnsptTable=scsiTrnsptTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiConformance=scsiConformance, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIndex=scsiDscLunIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapGroup=scsiLunMapGroup, scsiPortRole=scsiPortRole, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, scsiTransportTypes=scsiTransportTypes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunLun=scsiDscLunLun, scsiLuStatus=scsiLuStatus, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiTranportOther=scsiTranportOther, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, scsiLuState=scsiLuState, scsiDscLunTable=scsiDscLunTable, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSRP=scsiTransportSRP, ScsiIdentifier=ScsiIdentifier, ScsiName=ScsiName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceTable=scsiDeviceTable, scsiInstIndex=scsiInstIndex, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiModule=scsiModule, scsiLuTable=scsiLuTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiNotifications=scsiNotifications, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIdValue=ScsiIdValue, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIdType=scsiLuIdType, scsiObjects=scsiObjects, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceResets=scsiDeviceResets, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiIndexValue=ScsiIndexValue, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiGeneral=scsiGeneral, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtName=scsiDscTgtName, scsiPortIndex=scsiPortIndex, scsiGroups=scsiGroups, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiPortTable=scsiPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiCompliances=scsiCompliances, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLogicalUnit=scsiLogicalUnit, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceRole=scsiDeviceRole, PYSNMP_MODULE_ID=scsiModule, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportSPI=scsiTranportSPI, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands)
