...
Counter32, Counter64, TimeTicks, Unsigned32, NotificationType, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, Bits, MibIdentifier, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity", "Gauge32")
DisplayString, TruthValue, TimeStamp, TextualConvention, RowStatus, AutonomousType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "TextualConvention", "RowStatus", "AutonomousType", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInstAlias=scsiInstAlias, scsiLuProductId=scsiLuProductId, scsiLogicalUnit=scsiLogicalUnit, scsiInstanceTable=scsiInstanceTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevEntry=scsiTgtDevEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTargetGroup=scsiTargetGroup, PYSNMP_MODULE_ID=scsiModule, scsiCompliances=scsiCompliances, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceEntry=scsiDeviceEntry, ScsiIdType=ScsiIdType, scsiDscLunIdTable=scsiDscLunIdTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGeneral=scsiGeneral, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortName=scsiTgtPortName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiLuEntry=scsiLuEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiConformance=scsiConformance, scsiRemoteInitiators=scsiRemoteInitiators, scsiInitiator=scsiInitiator, scsiDeviceRole=scsiDeviceRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiName=ScsiName, scsiLunMapTable=scsiLunMapTable, scsiRemoteTarget=scsiRemoteTarget, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuInCommands=scsiLuInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiCompliance=scsiCompliance, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortTable=scsiPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuStatus=scsiLuStatus, scsiTransportFCP=scsiTransportFCP, scsiLuInResets=scsiLuInResets, scsiLuDefaultLun=scsiLuDefaultLun, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInstIndex=scsiInstIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunTable=scsiDscLunTable, scsiNotifications=scsiNotifications, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuState=scsiLuState, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdType=scsiLuIdType, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortEntry=scsiPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, ScsiIndexValue=ScsiIndexValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceResets=scsiDeviceResets, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdEntry=scsiLuIdEntry, scsiLuIdValue=scsiLuIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiObjects=scsiObjects, scsiDscTgtName=scsiDscTgtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceTable=scsiDeviceTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiTransportTypes=scsiTransportTypes, scsiPortRole=scsiPortRole, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTranportOther=scsiTranportOther, scsiLuTable=scsiLuTable, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTarget=scsiTarget, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevTable=scsiTgtDevTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIndex=scsiLuIndex, scsiLuVendorId=scsiLuVendorId, scsiLuHSInCommands=scsiLuHSInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
