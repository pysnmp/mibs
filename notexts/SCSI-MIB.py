...
NotificationType, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, ObjectIdentity, IpAddress, Bits, iso, ModuleIdentity, Unsigned32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "ObjectIdentity", "IpAddress", "Bits", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Counter64")
TimeStamp, DisplayString, RowStatus, RowPointer, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunTable=scsiDscLunTable, scsiGeneral=scsiGeneral, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTranportSPI=scsiTranportSPI, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportISCSI=scsiTransportISCSI, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportFCP=scsiTransportFCP, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapLun=scsiLunMapLun, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiModule=scsiModule, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtName=scsiDscTgtName, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdType=scsiLuIdType, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiPortEntry=scsiPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, ScsiIndexValue=ScsiIndexValue, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiPortTable=scsiPortTable, scsiInitiator=scsiInitiator, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuTable=scsiLuTable, scsiInstAlias=scsiInstAlias, scsiLuVendorId=scsiLuVendorId, scsiDeviceEntry=scsiDeviceEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiConformance=scsiConformance, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiLuProductId=scsiLuProductId, scsiTargetGroup=scsiTargetGroup, scsiLuIndex=scsiLuIndex, scsiTrnsptType=scsiTrnsptType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuEntry=scsiLuEntry, scsiDeviceGroup=scsiDeviceGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiObjects=scsiObjects, scsiDscTgtEntry=scsiDscTgtEntry, ScsiIdValue=ScsiIdValue, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiName=ScsiName, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceTable=scsiDeviceTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtTable=scsiIntrPrtTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiPortRole=scsiPortRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuState=scsiLuState, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuStatus=scsiLuStatus, scsiLuIdTable=scsiLuIdTable, scsiTarget=scsiTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdentifier=ScsiIdentifier, scsiTgtPortName=scsiTgtPortName, scsiInstIndex=scsiInstIndex, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGroups=scsiGroups, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliances=scsiCompliances, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, ScsiIdType=ScsiIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdType=scsiDscLunIdType, scsiPortIndex=scsiPortIndex)
