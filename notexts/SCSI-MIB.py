...
MibIdentifier, NotificationType, IpAddress, ModuleIdentity, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Counter64, Gauge32, mib_2, Integer32, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "IpAddress", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Counter64", "Gauge32", "mib-2", "Integer32", "Bits", "iso")
TruthValue, RowStatus, TextualConvention, DisplayString, RowPointer, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TextualConvention", "DisplayString", "RowPointer", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuDefaultLun=scsiLuDefaultLun, scsiPortTable=scsiPortTable, ScsiLUNOrZero=ScsiLUNOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdType=scsiLuIdType, ScsiName=ScsiName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTrnsptEntry=scsiTrnsptEntry, PYSNMP_MODULE_ID=scsiModule, scsiTransportTypes=scsiTransportTypes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceTable=scsiDeviceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdEntry=scsiLuIdEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiIntrPrtTable=scsiIntrPrtTable, scsiModule=scsiModule, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstIndex=scsiInstIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceEntry=scsiDeviceEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiator=scsiInitiator, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtName=scsiDscTgtName, scsiLuProductId=scsiLuProductId, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuPeripheralType=scsiLuPeripheralType, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuTable=scsiLuTable, scsiConformance=scsiConformance, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiGeneral=scsiGeneral, ScsiIdCodeSet=ScsiIdCodeSet, scsiTransportISCSI=scsiTransportISCSI, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIndex=scsiLuIndex, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceAlias=scsiDeviceAlias, scsiLuInResets=scsiLuInResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliances=scsiCompliances, scsiPortIndex=scsiPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuInCommands=scsiLuInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiObjects=scsiObjects, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiDscLunLun=scsiDscLunLun, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptType=scsiTrnsptType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTarget=scsiTarget, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortEntry=scsiPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuVendorId=scsiLuVendorId, scsiDeviceResets=scsiDeviceResets, scsiCompliance=scsiCompliance, scsiGroups=scsiGroups, ScsiIdValue=ScsiIdValue, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortName=scsiTgtPortName, ScsiIdAssociation=ScsiIdAssociation, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunTable=scsiDscLunTable, scsiTransportFCP=scsiTransportFCP, scsiDeviceRole=scsiDeviceRole, scsiLunMapLun=scsiLunMapLun, ScsiIdentifier=ScsiIdentifier, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiPortRole=scsiPortRole, ScsiIdType=ScsiIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiNotifications=scsiNotifications, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuState=scsiLuState, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValue=ScsiIndexValue, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTable=scsiIntrDevTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLunMapTable=scsiLunMapTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstAlias=scsiInstAlias, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceTable=scsiInstanceTable, scsiLuIdValue=scsiLuIdValue)
