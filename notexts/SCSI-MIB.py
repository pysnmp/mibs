...
Counter64, IpAddress, Unsigned32, NotificationType, Bits, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, ObjectIdentity, Integer32, iso, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Unsigned32", "NotificationType", "Bits", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "ObjectIdentity", "Integer32", "iso", "ModuleIdentity", "Gauge32")
TimeStamp, TextualConvention, DisplayString, AutonomousType, RowPointer, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType", "RowPointer", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrName=scsiAuthIntrName, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdValue=ScsiIdValue, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiTargetGroup=scsiTargetGroup, ScsiIdType=ScsiIdType, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuState=scsiLuState, scsiLuStatus=scsiLuStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDeviceGroup=scsiDeviceGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiTranportOther=scsiTranportOther, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, PYSNMP_MODULE_ID=scsiModule, scsiCompliance=scsiCompliance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLogicalUnit=scsiLogicalUnit, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIndex=scsiLuIndex, scsiDeviceIndex=scsiDeviceIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiObjects=scsiObjects, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortName=scsiTgtPortName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdType=scsiLuIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiNotifications=scsiNotifications, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtName=scsiDscTgtName, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdentifier=ScsiIdentifier, scsiTarget=scsiTarget, scsiPortTable=scsiPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunTable=scsiDscLunTable, scsiPortEntry=scsiPortEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportTypes=scsiTransportTypes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapLun=scsiLunMapLun, scsiLunMapEntry=scsiLunMapEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuVendorId=scsiLuVendorId, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstIndex=scsiInstIndex, scsiLuIdValue=scsiLuIdValue, scsiPortIndex=scsiPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuWwnName=scsiLuWwnName, scsiLuEntry=scsiLuEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuInCommands=scsiLuInCommands, scsiInstAlias=scsiInstAlias, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunLun=scsiDscLunLun, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiModule=scsiModule, scsiInitiatorGroup=scsiInitiatorGroup, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInitiator=scsiInitiator, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortEntry=scsiTgtPortEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiRemoteTarget=scsiRemoteTarget, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortRole=scsiPortRole, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValue=ScsiIndexValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuProductId=scsiLuProductId, scsiIntrPrtTable=scsiIntrPrtTable, scsiGeneral=scsiGeneral, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptType=scsiTrnsptType, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportISCSI=scsiTransportISCSI)
