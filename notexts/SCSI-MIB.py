...
mib_2, MibIdentifier, Counter64, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, TimeTicks, ModuleIdentity, Gauge32, IpAddress, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "Counter64", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "TimeTicks", "ModuleIdentity", "Gauge32", "IpAddress", "Unsigned32", "Integer32")
RowStatus, TimeStamp, AutonomousType, RowPointer, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "RowPointer", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiCompliances=scsiCompliances, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTarget=scsiTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuState=scsiLuState, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiDeviceAlias=scsiDeviceAlias, scsiLogicalUnit=scsiLogicalUnit, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuRevisionId=scsiLuRevisionId, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunLun=scsiDscLunLun, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuVendorId=scsiLuVendorId, scsiTransportFCP=scsiTransportFCP, scsiRemoteTarget=scsiRemoteTarget, scsiTargetStatsGroup=scsiTargetStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstVendorVersion=scsiInstVendorVersion, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiModule=scsiModule, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtDevTable=scsiTgtDevTable, scsiTransportISCSI=scsiTransportISCSI, scsiTrnsptType=scsiTrnsptType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuIdValue=scsiLuIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSRP=scsiTransportSRP, scsiLuIndex=scsiLuIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiRemoteInitiators=scsiRemoteInitiators, scsiPortIndex=scsiPortIndex, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuIdType=scsiLuIdType, scsiDeviceEntry=scsiDeviceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDeviceRole=scsiDeviceRole, scsiTargetGroup=scsiTargetGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDeviceResets=scsiDeviceResets, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiIdType=ScsiIdType, scsiTransportSBP=scsiTransportSBP, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiInstanceTable=scsiInstanceTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiGroups=scsiGroups, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiTgtPortName=scsiTgtPortName, scsiPortRole=scsiPortRole, scsiInstanceEntry=scsiInstanceEntry, scsiLuInResets=scsiLuInResets, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLunMapEntry=scsiLunMapEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortEntry=scsiPortEntry, scsiLuInCommands=scsiLuInCommands, scsiTranportOther=scsiTranportOther, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuStatus=scsiLuStatus, scsiLuDefaultLun=scsiLuDefaultLun, ScsiName=ScsiName, scsiObjects=scsiObjects, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiConformance=scsiConformance, scsiInstAlias=scsiInstAlias, scsiLuTable=scsiLuTable, scsiLuProductId=scsiLuProductId, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstIndex=scsiInstIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdValue=ScsiIdValue, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuIdTable=scsiLuIdTable, scsiLuIdIndex=scsiLuIdIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiInitiator=scsiInitiator, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiCompliance=scsiCompliance, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdType=scsiDscLunIdType)
