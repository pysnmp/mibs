...
Counter32, mib_2, IpAddress, iso, Integer32, Gauge32, Bits, ModuleIdentity, MibIdentifier, Counter64, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "IpAddress", "iso", "Integer32", "Gauge32", "Bits", "ModuleIdentity", "MibIdentifier", "Counter64", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks")
TimeStamp, AutonomousType, RowStatus, TruthValue, DisplayString, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "RowStatus", "TruthValue", "DisplayString", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInResets=scsiLuInResets, scsiInstanceTable=scsiInstanceTable, scsiLunMapLun=scsiLunMapLun, scsiLuProductId=scsiLuProductId, scsiDscLunIndex=scsiDscLunIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstIndex=scsiInstIndex, scsiDeviceRole=scsiDeviceRole, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstAlias=scsiInstAlias, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliance=scsiCompliance, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiCompliances=scsiCompliances, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiPortTable=scsiPortTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiObjects=scsiObjects, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiDeviceEntry=scsiDeviceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiInitiator=scsiInitiator, scsiRemoteTarget=scsiRemoteTarget, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdType=scsiDscLunIdType, scsiDscTgtName=scsiDscTgtName, scsiLuIdType=scsiLuIdType, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdValue=ScsiIdValue, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiPortIndex=scsiPortIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTarget=scsiTarget, scsiLuStatus=scsiLuStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapIndex=scsiLunMapIndex, ScsiIdType=ScsiIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuEntry=scsiLuEntry, PYSNMP_MODULE_ID=scsiModule, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotifications=scsiNotifications, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportSBP=scsiTransportSBP, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdValue=scsiLuIdValue, scsiDeviceTable=scsiDeviceTable, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiGroups=scsiGroups, scsiDeviceGroup=scsiDeviceGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTrnsptPointer=scsiTrnsptPointer, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuState=scsiLuState, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunTable=scsiDscLunTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiPortRole=scsiPortRole, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportFCP=scsiTransportFCP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiModule=scsiModule, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptTable=scsiTrnsptTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInCommands=scsiLuInCommands, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortEntry=scsiPortEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrName=scsiAuthIntrName, scsiLuTable=scsiLuTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptType=scsiTrnsptType, scsiDscTgtTable=scsiDscTgtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevTable=scsiTgtDevTable, scsiGeneral=scsiGeneral, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiConformance=scsiConformance, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunLun=scsiDscLunLun, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable)
