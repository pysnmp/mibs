...
ObjectIdentity, mib_2, Counter32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, iso, IpAddress, NotificationType, Integer32, Bits, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "Counter32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "iso", "IpAddress", "NotificationType", "Integer32", "Bits", "TimeTicks", "MibIdentifier")
RowStatus, RowPointer, DisplayString, TextualConvention, TruthValue, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "RowPointer", "DisplayString", "TextualConvention", "TruthValue", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstAlias=scsiInstAlias, scsiTranportOther=scsiTranportOther, scsiIntrDevEntry=scsiIntrDevEntry, scsiRemoteTarget=scsiRemoteTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtName=scsiDscTgtName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIdType=scsiLuIdType, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSRP=scsiTransportSRP, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiCompliance=scsiCompliance, scsiRemoteInitiators=scsiRemoteInitiators, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiCompliances=scsiCompliances, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdValue=ScsiIdValue, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdType=ScsiIdType, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiPortEntry=scsiPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuTable=scsiLuTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdTable=scsiLuIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortIndex=scsiPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportFCP=scsiTransportFCP, scsiDscLunIdEntry=scsiDscLunIdEntry, ScsiName=ScsiName, scsiTrnsptEntry=scsiTrnsptEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiTransportISCSI=scsiTransportISCSI, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiTransportSBP=scsiTransportSBP, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiGeneral=scsiGeneral, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInitiator=scsiInitiator, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortRole=scsiPortRole, scsiDeviceResets=scsiDeviceResets, ScsiIdCodeSet=ScsiIdCodeSet, PYSNMP_MODULE_ID=scsiModule, scsiGroups=scsiGroups, scsiInstIndex=scsiInstIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuProductId=scsiLuProductId, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortName=scsiAttTgtPortName, scsiLogicalUnit=scsiLogicalUnit, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTarget=scsiTarget, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuDefaultLun=scsiLuDefaultLun, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtEntry=scsiDscTgtEntry, scsiTargetGroup=scsiTargetGroup, scsiDeviceTable=scsiDeviceTable, scsiModule=scsiModule, scsiTgtPortTable=scsiTgtPortTable, scsiLuState=scsiLuState, scsiLunMapIndex=scsiLunMapIndex, scsiLuWwnName=scsiLuWwnName, scsiDscLunEntry=scsiDscLunEntry, scsiLuInResets=scsiLuInResets, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtDevEntry=scsiTgtDevEntry, scsiLunMapLun=scsiLunMapLun, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiPortTable=scsiPortTable, scsiLuStatus=scsiLuStatus, scsiInstanceTable=scsiInstanceTable, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportTypes=scsiTransportTypes, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceIndex=scsiDeviceIndex, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, ScsiIndexValue=ScsiIndexValue, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiNotifications=scsiNotifications, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortIndex=scsiAttTgtPortIndex, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortName=scsiTgtPortName, scsiDscTgtTable=scsiDscTgtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
