...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, MibIdentifier, Unsigned32, Integer32, IpAddress, ModuleIdentity, ObjectIdentity, Gauge32, mib_2, NotificationType, TimeTicks, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "MibIdentifier", "Unsigned32", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Gauge32", "mib-2", "NotificationType", "TimeTicks", "iso", "Counter64")
TimeStamp, RowStatus, AutonomousType, TextualConvention, TruthValue, RowPointer, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue", "RowPointer", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtName=scsiDscTgtName, scsiDscLunLun=scsiDscLunLun, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiDscLunTable=scsiDscLunTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAuthIntrName=scsiAuthIntrName, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuProductId=scsiLuProductId, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiTargetGroup=scsiTargetGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiName=ScsiName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstanceTable=scsiInstanceTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiConformance=scsiConformance, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuStatusChanged=scsiLuStatusChanged, scsiCompliance=scsiCompliance, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceRole=scsiDeviceRole, scsiGeneral=scsiGeneral, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstAlias=scsiInstAlias, scsiTgtPortTable=scsiTgtPortTable, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortTable=scsiPortTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceIndex=scsiDeviceIndex, scsiCompliances=scsiCompliances, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiGroups=scsiGroups, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuIndex=scsiLuIndex, scsiTransportFCP=scsiTransportFCP, scsiObjects=scsiObjects, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuVendorId=scsiLuVendorId, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuEntry=scsiLuEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdValue=ScsiIdValue, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWwnName=scsiLuWwnName, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTranportOther=scsiTranportOther, scsiLuInResets=scsiLuInResets, scsiLunMapRowStatus=scsiLunMapRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIndex=scsiDscLunIndex, ScsiIdType=ScsiIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortEntry=scsiPortEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuState=scsiLuState, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValue=ScsiIndexValue, scsiTrnsptTable=scsiTrnsptTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiDeviceTable=scsiDeviceTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceAlias=scsiDeviceAlias, scsiInstIndex=scsiInstIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiLunMapEntry=scsiLunMapEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiModule=scsiModule, scsiLuIdType=scsiLuIdType, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuTable=scsiLuTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapTable=scsiLunMapTable, scsiPortRole=scsiPortRole, scsiTrnsptType=scsiTrnsptType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdTable=scsiLuIdTable, scsiDscTgtTable=scsiDscTgtTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtTable=scsiIntrPrtTable, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiNotifications=scsiNotifications, scsiTgtPortName=scsiTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptEntry=scsiTrnsptEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiPortIndex=scsiPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuStatus=scsiLuStatus, scsiLunMapIndex=scsiLunMapIndex, scsiInitiator=scsiInitiator, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtName=scsiIntrPrtName)
