...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Integer32, Unsigned32, NotificationType, Gauge32, TimeTicks, Counter64, ModuleIdentity, iso, ObjectIdentity, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Integer32", "Unsigned32", "NotificationType", "Gauge32", "TimeTicks", "Counter64", "ModuleIdentity", "iso", "ObjectIdentity", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstAlias=scsiInstAlias, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrName=scsiAuthIntrName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceAlias=scsiDeviceAlias, ScsiIndexValue=ScsiIndexValue, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTransportTypes=scsiTransportTypes, scsiInstanceEntry=scsiInstanceEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiName=ScsiName, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuInResets=scsiLuInResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscLunTable=scsiDscLunTable, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuInCommands=scsiLuInCommands, scsiPortIndex=scsiPortIndex, scsiTranportOther=scsiTranportOther, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportFCP=scsiTransportFCP, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdValue=scsiLuIdValue, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiCompliances=scsiCompliances, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptType=scsiTrnsptType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceRole=scsiDeviceRole, ScsiIdType=ScsiIdType, scsiTarget=scsiTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceResets=scsiDeviceResets, scsiConformance=scsiConformance, scsiDscLunIdValue=scsiDscLunIdValue, scsiModule=scsiModule, scsiAttTgtPortTable=scsiAttTgtPortTable, PYSNMP_MODULE_ID=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdEntry=scsiLuIdEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortTable=scsiPortTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorGroup=scsiInitiatorGroup, scsiLogicalUnit=scsiLogicalUnit, scsiLuEntry=scsiLuEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuProductId=scsiLuProductId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapEntry=scsiLunMapEntry, scsiPortEntry=scsiPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtName=scsiIntrPrtName, scsiLuTable=scsiLuTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiNotifications=scsiNotifications, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuStatus=scsiLuStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortName=scsiTgtPortName, scsiInstIndex=scsiInstIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuState=scsiLuState, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTranportSPI=scsiTranportSPI, scsiLuIdIndex=scsiLuIdIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunLun=scsiDscLunLun, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiPortRole=scsiPortRole, scsiCompliance=scsiCompliance, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIdentifier=ScsiIdentifier, scsiGeneral=scsiGeneral, scsiLuIdType=scsiLuIdType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscLunIdType=scsiDscLunIdType, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero)
