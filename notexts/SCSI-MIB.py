...
ModuleIdentity, Unsigned32, Counter64, iso, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, Bits, NotificationType, Gauge32, Counter32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "iso", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "Bits", "NotificationType", "Gauge32", "Counter32", "TimeTicks", "Integer32")
RowPointer, TimeStamp, AutonomousType, TruthValue, DisplayString, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "AutonomousType", "TruthValue", "DisplayString", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiLunMapTable=scsiLunMapTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTransportFCP=scsiTransportFCP, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiObjects=scsiObjects, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuProductId=scsiLuProductId, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLun=scsiLunMapLun, scsiLunMapIndex=scsiLunMapIndex, scsiPortEntry=scsiPortEntry, scsiTranportOther=scsiTranportOther, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiName=ScsiName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, PYSNMP_MODULE_ID=scsiModule, ScsiIdAssociation=ScsiIdAssociation, scsiInstIndex=scsiInstIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuWwnName=scsiLuWwnName, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdType=scsiDscLunIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiConformance=scsiConformance, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuState=scsiLuState, scsiPortIndex=scsiPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceResets=scsiDeviceResets, scsiLuStatus=scsiLuStatus, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtPortEntry=scsiTgtPortEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTargetGroup=scsiTargetGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTrnsptTable=scsiTrnsptTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiPortRole=scsiPortRole, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceRole=scsiDeviceRole, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdType=scsiLuIdType, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportISCSI=scsiTransportISCSI, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTarget=scsiTarget, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiTgtDevTable=scsiTgtDevTable, scsiTransportSRP=scsiTransportSRP, scsiCompliance=scsiCompliance, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInitiator=scsiInitiator, scsiDscLunLun=scsiDscLunLun, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortName=scsiTgtPortName, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrName=scsiAuthIntrName, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuTable=scsiLuTable, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuEntry=scsiLuEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtName=scsiDscTgtName, scsiLogicalUnit=scsiLogicalUnit, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdTable=scsiDscLunIdTable, scsiDeviceEntry=scsiDeviceEntry, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceTable=scsiDeviceTable, scsiDeviceIndex=scsiDeviceIndex, scsiGeneral=scsiGeneral, scsiLuIndex=scsiLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuInResets=scsiLuInResets, scsiDscTgtTable=scsiDscTgtTable, scsiInstAlias=scsiInstAlias, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdValue=ScsiIdValue, scsiInstVendorVersion=scsiInstVendorVersion, scsiModule=scsiModule, scsiGroups=scsiGroups, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrPrtName=scsiIntrPrtName, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstanceTable=scsiInstanceTable, ScsiIdentifier=ScsiIdentifier, scsiTrnsptIndex=scsiTrnsptIndex, scsiNotifications=scsiNotifications, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTable=scsiPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiTransportTypes=scsiTransportTypes, ScsiIdType=ScsiIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptType=scsiTrnsptType)
