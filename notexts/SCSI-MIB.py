...
NotificationType, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, MibIdentifier, Bits, IpAddress, Counter32, ModuleIdentity, mib_2, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "MibIdentifier", "Bits", "IpAddress", "Counter32", "ModuleIdentity", "mib-2", "ObjectIdentity", "Counter64", "Unsigned32")
RowStatus, AutonomousType, TimeStamp, TruthValue, RowPointer, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue", "RowPointer", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIndex=scsiDscLunIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTarget=scsiTarget, scsiLuInResets=scsiLuInResets, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTranportSPI=scsiTranportSPI, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapGroup=scsiLunMapGroup, scsiLuPeripheralType=scsiLuPeripheralType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtName=scsiDscTgtName, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrName=scsiAuthIntrName, scsiCompliance=scsiCompliance, scsiLuIndex=scsiLuIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdTable=scsiLuIdTable, scsiLunMapIndex=scsiLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapTable=scsiLunMapTable, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiName=ScsiName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtPortName=scsiTgtPortName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuState=scsiLuState, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuStatus=scsiLuStatus, scsiNotifications=scsiNotifications, scsiDeviceAlias=scsiDeviceAlias, scsiTransportTypes=scsiTransportTypes, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortIndex=scsiPortIndex, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptType=scsiTrnsptType, scsiLuEntry=scsiLuEntry, scsiTgtDevTable=scsiTgtDevTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTargetGroup=scsiTargetGroup, ScsiIdAssociation=ScsiIdAssociation, scsiPortEntry=scsiPortEntry, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiIntrDevEntry=scsiIntrDevEntry, scsiCompliances=scsiCompliances, ScsiIdType=ScsiIdType, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceResets=scsiDeviceResets, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiGroups=scsiGroups, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLun=scsiLunMapLun, ScsiIndexValue=ScsiIndexValue, scsiLuProductId=scsiLuProductId, scsiDscLunEntry=scsiDscLunEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiPortRole=scsiPortRole, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTransportFCP=scsiTransportFCP, scsiIntrDevTable=scsiIntrDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiConformance=scsiConformance, scsiInstanceEntry=scsiInstanceEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiTranportOther=scsiTranportOther, scsiAttTgtPortEntry=scsiAttTgtPortEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceRole=scsiDeviceRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiLuIdValue=scsiLuIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDscTgtEntry=scsiDscTgtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiTransportSRP=scsiTransportSRP, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceTable=scsiDeviceTable, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiRemoteInitiators=scsiRemoteInitiators, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiGeneral=scsiGeneral, ScsiIdValue=ScsiIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiInstanceTable=scsiInstanceTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex)
