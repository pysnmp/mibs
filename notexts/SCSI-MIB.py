...
Counter32, Bits, TimeTicks, IpAddress, Gauge32, ModuleIdentity, Unsigned32, Integer32, NotificationType, Counter64, iso, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "TimeTicks", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "Integer32", "NotificationType", "Counter64", "iso", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier")
RowStatus, DisplayString, TruthValue, RowPointer, TimeStamp, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "RowPointer", "TimeStamp", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportTypes=scsiTransportTypes, scsiTgtDevTable=scsiTgtDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtPortName=scsiTgtPortName, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceAlias=scsiDeviceAlias, scsiGeneral=scsiGeneral, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiIdentifier=ScsiIdentifier, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiInitiatorGroup=scsiInitiatorGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunIndex=scsiDscLunIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteTarget=scsiRemoteTarget, scsiTranportOther=scsiTranportOther, scsiDeviceStatGroup=scsiDeviceStatGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuTable=scsiLuTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuRevisionId=scsiLuRevisionId, ScsiName=ScsiName, scsiTranportSPI=scsiTranportSPI, scsiTransportFCP=scsiTransportFCP, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuIndex=scsiLuIndex, scsiLuInCommands=scsiLuInCommands, scsiLogicalUnit=scsiLogicalUnit, scsiCompliances=scsiCompliances, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLuIdIndex=scsiLuIdIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiModule=scsiModule, scsiPortEntry=scsiPortEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiTransportSBP=scsiTransportSBP, scsiPortTable=scsiPortTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuStatus=scsiLuStatus, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiInitiator=scsiInitiator, scsiTrnsptType=scsiTrnsptType, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscTgtName=scsiDscTgtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrName=scsiAuthIntrName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunLun=scsiDscLunLun, scsiGroups=scsiGroups, scsiTransportISCSI=scsiTransportISCSI, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiConformance=scsiConformance, scsiTargetGroup=scsiTargetGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdTable=scsiLuIdTable, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapTable=scsiLunMapTable, scsiLuIdValue=scsiLuIdValue, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTarget=scsiTarget, scsiLuWwnName=scsiLuWwnName, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtTable=scsiDscTgtTable, scsiPortRole=scsiPortRole, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstIndex=scsiInstIndex)
