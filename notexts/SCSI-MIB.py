...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, IpAddress, Unsigned32, Bits, Counter32, ModuleIdentity, Integer32, NotificationType, iso, MibIdentifier, Counter64, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "IpAddress", "Unsigned32", "Bits", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "iso", "MibIdentifier", "Counter64", "TimeTicks", "ObjectIdentity")
RowStatus, TimeStamp, DisplayString, TruthValue, RowPointer, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "DisplayString", "TruthValue", "RowPointer", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdEntry=scsiLuIdEntry, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTranportOther=scsiTranportOther, scsiInstAlias=scsiInstAlias, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiGeneral=scsiGeneral, scsiTrnsptTable=scsiTrnsptTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceIndex=scsiDeviceIndex, scsiConformance=scsiConformance, scsiLuTable=scsiLuTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapIndex=scsiLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiator=scsiInitiator, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotifications=scsiNotifications, scsiDscLunIdType=scsiDscLunIdType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIdValue=scsiLuIdValue, scsiLuEntry=scsiLuEntry, scsiInstIndex=scsiInstIndex, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapGroup=scsiLunMapGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiTgtPortTable=scsiTgtPortTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuState=scsiLuState, ScsiIdentifier=ScsiIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtTable=scsiIntrPrtTable, scsiDeviceRole=scsiDeviceRole, scsiPortIndex=scsiPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiObjects=scsiObjects, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortEntry=scsiTgtPortEntry, scsiTransportTypes=scsiTransportTypes, scsiLunMapEntry=scsiLunMapEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuProductId=scsiLuProductId, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIdCodeSet=ScsiIdCodeSet, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiLunMapLun=scsiLunMapLun, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrName=scsiAuthIntrName, scsiLuWwnName=scsiLuWwnName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLunMapTable=scsiLunMapTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceGroup=scsiDeviceGroup, scsiPortEntry=scsiPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTransportFCP=scsiTransportFCP, scsiLuIndex=scsiLuIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdTable=scsiLuIdTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiModule=scsiModule, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiCompliance=scsiCompliance, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiTransportSRP=scsiTransportSRP, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuInResets=scsiLuInResets, scsiLuVendorId=scsiLuVendorId, scsiLuIdType=scsiLuIdType, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptType=scsiTrnsptType, ScsiIdValue=ScsiIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiGroups=scsiGroups, scsiTranportSPI=scsiTranportSPI, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptDevName=scsiTrnsptDevName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSBP=scsiTransportSBP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDscLunEntry=scsiDscLunEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTarget=scsiTarget, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtName=scsiIntrPrtName, scsiIntrDevTable=scsiIntrDevTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiRemoteTarget=scsiRemoteTarget, scsiInstanceTable=scsiInstanceTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiName=ScsiName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiCompliances=scsiCompliances, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuStatus=scsiLuStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLuStatusChanged=scsiLuStatusChanged, scsiPortRole=scsiPortRole, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode)
