...
mib_2, MibIdentifier, Integer32, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, iso, Bits, Counter64, Unsigned32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "iso", "Bits", "Counter64", "Unsigned32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiLuVendorId=scsiLuVendorId, scsiLuTable=scsiLuTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiPortIndex=scsiPortIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiTarget=scsiTarget, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtName=scsiDscTgtName, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliance=scsiCompliance, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscLunLun=scsiDscLunLun, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiTranportOther=scsiTranportOther, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWwnName=scsiLuWwnName, scsiLogicalUnit=scsiLogicalUnit, scsiTransportTypes=scsiTransportTypes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstIndex=scsiInstIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuProductId=scsiLuProductId, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuIdType=scsiLuIdType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiNotifications=scsiNotifications, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapIndex=scsiLunMapIndex, scsiInitiator=scsiInitiator, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuState=scsiLuState, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapLun=scsiLunMapLun, scsiTransportSRP=scsiTransportSRP, scsiDeviceEntry=scsiDeviceEntry, scsiLuInResets=scsiLuInResets, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiLuIdEntry=scsiLuIdEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiIdType=ScsiIdType, scsiInstanceEntry=scsiInstanceEntry, scsiModule=scsiModule, PYSNMP_MODULE_ID=scsiModule, scsiCompliances=scsiCompliances, scsiLuIdValue=scsiLuIdValue, scsiLunMapLuIndex=scsiLunMapLuIndex, ScsiIdAssociation=ScsiIdAssociation, scsiPortTable=scsiPortTable, scsiGroups=scsiGroups, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTargetGroup=scsiTargetGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTable=scsiIntrDevTable, scsiGeneral=scsiGeneral, scsiPortRole=scsiPortRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiDevicePortNumber=scsiDevicePortNumber, ScsiIndexValue=ScsiIndexValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiConformance=scsiConformance, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstAlias=scsiInstAlias, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiName=ScsiName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuIdCodeSet=scsiLuIdCodeSet, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiPortEntry=scsiPortEntry, scsiLuIdTable=scsiLuIdTable, scsiInstanceTable=scsiInstanceTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortName=scsiTgtPortName, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuStatus=scsiLuStatus, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuEntry=scsiLuEntry)
