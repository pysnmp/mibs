...
iso, IpAddress, NotificationType, Bits, Unsigned32, Counter64, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, mib_2, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Bits", "Unsigned32", "Counter64", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "mib-2", "Integer32", "ModuleIdentity", "Counter32")
TruthValue, AutonomousType, DisplayString, TimeStamp, RowStatus, TextualConvention, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiTarget=scsiTarget, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortTable=scsiTgtPortTable, scsiTrnsptTable=scsiTrnsptTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiGroups=scsiGroups, ScsiIdType=ScsiIdType, scsiTransportTypes=scsiTransportTypes, scsiDeviceRole=scsiDeviceRole, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliances=scsiCompliances, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunLun=scsiDscLunLun, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiCompliance=scsiCompliance, scsiTransportSBP=scsiTransportSBP, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuHSInCommands=scsiLuHSInCommands, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuDefaultLun=scsiLuDefaultLun, scsiConformance=scsiConformance, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuIdType=scsiLuIdType, ScsiIndexValue=ScsiIndexValue, scsiRemoteTarget=scsiRemoteTarget, scsiInstAlias=scsiInstAlias, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuVendorId=scsiLuVendorId, scsiLuIdTable=scsiLuIdTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuState=scsiLuState, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIndex=scsiLuIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceEntry=scsiInstanceEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiPortTable=scsiPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortEntry=scsiPortEntry, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiPortRole=scsiPortRole, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLunMapTable=scsiLunMapTable, scsiLunMapLun=scsiLunMapLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiTgtPortName=scsiTgtPortName, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapEntry=scsiLunMapEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInitiator=scsiInitiator, scsiInstIndex=scsiInstIndex, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiGeneral=scsiGeneral, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdIndex=scsiLuIdIndex, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceAlias=scsiDeviceAlias, scsiLuTable=scsiLuTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceIndex=scsiDeviceIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuIdValue=scsiLuIdValue, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportSRP=scsiTransportSRP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, PYSNMP_MODULE_ID=scsiModule, scsiTgtDevEntry=scsiTgtDevEntry, scsiObjects=scsiObjects, scsiLuInResets=scsiLuInResets, scsiDscLunEntry=scsiDscLunEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportFCP=scsiTransportFCP, ScsiLUNOrZero=ScsiLUNOrZero, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdValue=ScsiIdValue, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTranportSPI=scsiTranportSPI, scsiTranportOther=scsiTranportOther, ScsiIdentifier=ScsiIdentifier, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiPortIndex=scsiPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunTable=scsiDscLunTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotifications=scsiNotifications, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportISCSI=scsiTransportISCSI, scsiLuEntry=scsiLuEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuInCommands=scsiLuInCommands, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdType=scsiDscLunIdType, scsiInstanceTable=scsiInstanceTable, scsiModule=scsiModule, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands)
