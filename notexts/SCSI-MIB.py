...
NotificationType, TimeTicks, ObjectIdentity, Unsigned32, Gauge32, IpAddress, iso, MibIdentifier, Bits, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "Gauge32", "IpAddress", "iso", "MibIdentifier", "Bits", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "mib-2")
DisplayString, TruthValue, TextualConvention, AutonomousType, TimeStamp, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiInstIndex=scsiInstIndex, scsiGeneral=scsiGeneral, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortName=scsiTgtPortName, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortEntry=scsiPortEntry, scsiDeviceTable=scsiDeviceTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuState=scsiLuState, scsiTranportSPI=scsiTranportSPI, scsiGroups=scsiGroups, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiDscTgtTable=scsiDscTgtTable, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInResets=scsiLuInResets, scsiDeviceGroup=scsiDeviceGroup, scsiLuIdType=scsiLuIdType, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuIdValue=scsiLuIdValue, scsiDscLunIndex=scsiDscLunIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDeviceIndex=scsiDeviceIndex, scsiLuEntry=scsiLuEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuIdAssociation=scsiLuIdAssociation, scsiAuthIntrName=scsiAuthIntrName, scsiTarget=scsiTarget, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstAlias=scsiInstAlias, scsiCompliance=scsiCompliance, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTranportOther=scsiTranportOther, scsiTransportSRP=scsiTransportSRP, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiCompliances=scsiCompliances, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuTable=scsiLuTable, ScsiIdValue=ScsiIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiPortTable=scsiPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiPortIndex=scsiPortIndex, scsiTgtPortTable=scsiTgtPortTable, scsiLuProductId=scsiLuProductId, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiName=ScsiName, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTgtDevTable=scsiTgtDevTable, scsiNotifications=scsiNotifications, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuInCommands=scsiLuInCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiRemoteTarget=scsiRemoteTarget, scsiLuIdEntry=scsiLuIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, ScsiIdentifier=ScsiIdentifier, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceEntry=scsiDeviceEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuVendorId=scsiLuVendorId, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapIndex=scsiLunMapIndex, scsiModule=scsiModule, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapEntry=scsiLunMapEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstanceTable=scsiInstanceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDeviceResets=scsiDeviceResets, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiPortRole=scsiPortRole, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiObjects=scsiObjects, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiator=scsiInitiator, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiConformance=scsiConformance, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuIdTable=scsiLuIdTable, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiIndexValue=ScsiIndexValue, scsiDscLunLun=scsiDscLunLun, scsiTrnsptType=scsiTrnsptType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatus=scsiLuStatus, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceAlias=scsiDeviceAlias, ScsiIdType=ScsiIdType, scsiTransportFCP=scsiTransportFCP, scsiPortTrnsptPtr=scsiPortTrnsptPtr)
