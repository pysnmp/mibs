...
Integer32, Counter64, mib_2, iso, TimeTicks, Gauge32, Bits, NotificationType, Counter32, ObjectIdentity, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "mib-2", "iso", "TimeTicks", "Gauge32", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier")
DisplayString, RowPointer, TextualConvention, AutonomousType, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowPointer", "TextualConvention", "AutonomousType", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIndexValue=ScsiIndexValue, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuInResets=scsiLuInResets, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdValue=ScsiIdValue, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortEntry=scsiPortEntry, scsiDscLunLun=scsiDscLunLun, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTarget=scsiTarget, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiInstAlias=scsiInstAlias, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunTable=scsiDscLunTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrName=scsiAuthIntrName, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdType=scsiLuIdType, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuProductId=scsiLuProductId, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceResets=scsiDeviceResets, scsiPortTable=scsiPortTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiIdentifier=ScsiIdentifier, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWwnName=scsiLuWwnName, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceRole=scsiDeviceRole, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiator=scsiInitiator, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDscTgtName=scsiDscTgtName, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuIdTable=scsiLuIdTable, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortTable=scsiTgtPortTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceGroup=scsiDeviceGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapTable=scsiLunMapTable, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiNotifications=scsiNotifications, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiModule=scsiModule, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuIndex=scsiLuIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiTargetGroup=scsiTargetGroup, scsiGeneral=scsiGeneral, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceTable=scsiDeviceTable, ScsiIdType=ScsiIdType, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLunMapEntry=scsiLunMapEntry, scsiConformance=scsiConformance, scsiTrnsptEntry=scsiTrnsptEntry, scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdTable=scsiDscLunIdTable, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiDscTgtEntry=scsiDscTgtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortRole=scsiPortRole, scsiTgtDevEntry=scsiTgtDevEntry, scsiTransportSBP=scsiTransportSBP, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuState=scsiLuState, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiInstIndex=scsiInstIndex, scsiGroups=scsiGroups, scsiLunMapIndex=scsiLunMapIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrPrtName=scsiIntrPrtName, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuStatus=scsiLuStatus, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiPortIndex=scsiPortIndex, scsiTgtDevTable=scsiTgtDevTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTranportOther=scsiTranportOther, scsiTgtPortEntry=scsiTgtPortEntry, PYSNMP_MODULE_ID=scsiModule, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIdValue=scsiLuIdValue, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiCompliance=scsiCompliance, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIndex=scsiDscLunIndex, scsiLuRevisionId=scsiLuRevisionId, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptIndex=scsiTrnsptIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex)
