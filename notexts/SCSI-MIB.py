...
NotificationType, Integer32, Bits, IpAddress, Counter32, MibIdentifier, TimeTicks, ModuleIdentity, iso, ObjectIdentity, Unsigned32, Counter64, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Bits", "IpAddress", "Counter32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "iso", "ObjectIdentity", "Unsigned32", "Counter64", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
DisplayString, TruthValue, AutonomousType, TextualConvention, RowStatus, RowPointer, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "RowPointer", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportSBP=scsiTransportSBP, scsiDscLunTable=scsiDscLunTable, scsiLunMapGroup=scsiLunMapGroup, scsiLuEntry=scsiLuEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportTypes=scsiTransportTypes, scsiTransportFCP=scsiTransportFCP, scsiTrnsptType=scsiTrnsptType, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapTable=scsiLunMapTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiInstanceTable=scsiInstanceTable, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIndex=scsiDscLunIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiName=ScsiName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuRevisionId=scsiLuRevisionId, scsiLuInResets=scsiLuInResets, scsiLuWwnName=scsiLuWwnName, scsiDeviceRole=scsiDeviceRole, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTgtPortName=scsiTgtPortName, scsiNotifications=scsiNotifications, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstVendorVersion=scsiInstVendorVersion, scsiTarget=scsiTarget, ScsiIndexValue=ScsiIndexValue, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuVendorId=scsiLuVendorId, PYSNMP_MODULE_ID=scsiModule, scsiPortEntry=scsiPortEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiModule=scsiModule, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortIndex=scsiPortIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiIdValue=ScsiIdValue, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceTable=scsiDeviceTable, scsiTranportOther=scsiTranportOther, scsiLuState=scsiLuState, scsiAuthIntrIndex=scsiAuthIntrIndex, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtName=scsiDscTgtName, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuInCommands=scsiLuInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuTable=scsiLuTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiTransportISCSI=scsiTransportISCSI, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortRole=scsiPortRole, scsiObjects=scsiObjects, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdValue=scsiLuIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortTable=scsiPortTable, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapIndex=scsiLunMapIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiCompliance=scsiCompliance, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDeviceResets=scsiDeviceResets, scsiInstAlias=scsiInstAlias, scsiDeviceAlias=scsiDeviceAlias, scsiTrnsptTable=scsiTrnsptTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiGeneral=scsiGeneral, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiIntrPrtTable=scsiIntrPrtTable, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdTable=scsiLuIdTable, scsiLuStatus=scsiLuStatus, scsiGroups=scsiGroups, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTargetGroup=scsiTargetGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuIdType=scsiLuIdType, scsiAuthIntrName=scsiAuthIntrName, scsiLuPeripheralType=scsiLuPeripheralType, scsiInstIndex=scsiInstIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTranportSPI=scsiTranportSPI, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup)
