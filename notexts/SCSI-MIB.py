...
Integer32, IpAddress, Counter32, iso, Gauge32, Bits, NotificationType, TimeTicks, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter32", "iso", "Gauge32", "Bits", "NotificationType", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Unsigned32", "mib-2")
RowPointer, DisplayString, AutonomousType, TimeStamp, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceIndex=scsiDeviceIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSBP=scsiTransportSBP, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTrnsptEntry=scsiTrnsptEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceEntry=scsiDeviceEntry, ScsiIdentifier=ScsiIdentifier, scsiDscLunTable=scsiDscLunTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiInstAlias=scsiInstAlias, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuProductId=scsiLuProductId, scsiTransportISCSI=scsiTransportISCSI, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiLunMapIndex=scsiLunMapIndex, scsiConformance=scsiConformance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstanceTable=scsiInstanceTable, scsiTransportSRP=scsiTransportSRP, ScsiName=ScsiName, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiator=scsiInitiator, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTgtPortEntry=scsiTgtPortEntry, scsiInstIndex=scsiInstIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuStatus=scsiLuStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuInResets=scsiLuInResets, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuRevisionId=scsiLuRevisionId, scsiLuTable=scsiLuTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiModule=scsiModule, scsiObjects=scsiObjects, scsiDscLunLun=scsiDscLunLun, scsiTranportSPI=scsiTranportSPI, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIndexValue=ScsiIndexValue, scsiLuStatusChanged=scsiLuStatusChanged, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiAuthIntrName=scsiAuthIntrName, ScsiLUNOrZero=ScsiLUNOrZero, PYSNMP_MODULE_ID=scsiModule, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdTable=scsiLuIdTable, ScsiIdValue=ScsiIdValue, scsiLuEntry=scsiLuEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiTarget=scsiTarget, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTrnsptPointer=scsiTrnsptPointer, scsiTgtPortName=scsiTgtPortName, scsiLuIdEntry=scsiLuIdEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiTransportFCP=scsiTransportFCP, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDeviceTable=scsiDeviceTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtName=scsiIntrPrtName, scsiLunMapLun=scsiLunMapLun, scsiPortIndex=scsiPortIndex, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiGroups=scsiGroups, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiNotifications=scsiNotifications, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiTranportOther=scsiTranportOther, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIndex=scsiLuIndex, scsiTransportTypes=scsiTransportTypes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiPortTable=scsiPortTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuState=scsiLuState, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceResets=scsiDeviceResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiPortRole=scsiPortRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortEntry=scsiPortEntry, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiGeneral=scsiGeneral, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtTable=scsiDscTgtTable)
