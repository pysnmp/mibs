...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, mib_2, Bits, Unsigned32, iso, TimeTicks, ObjectIdentity, MibIdentifier, Integer32, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "mib-2", "Bits", "Unsigned32", "iso", "TimeTicks", "ObjectIdentity", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "Counter32")
TextualConvention, DisplayString, TruthValue, AutonomousType, RowStatus, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType", "RowStatus", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceAlias=scsiDeviceAlias, scsiLuWwnName=scsiLuWwnName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtName=scsiDscTgtName, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuInCommands=scsiLuInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiConformance=scsiConformance, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTranportSPI=scsiTranportSPI, scsiDscLunLun=scsiDscLunLun, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstIndex=scsiInstIndex, scsiTarget=scsiTarget, scsiDscLunTable=scsiDscLunTable, scsiPortIndex=scsiPortIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtDevTable=scsiTgtDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrDevEntry=scsiIntrDevEntry, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtTable=scsiDscTgtTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTranportOther=scsiTranportOther, scsiLunMapTable=scsiLunMapTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiInitiator=scsiInitiator, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDeviceRole=scsiDeviceRole, scsiInitiatorGroup=scsiInitiatorGroup, scsiDeviceIndex=scsiDeviceIndex, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuIdIndex=scsiLuIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuTable=scsiLuTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptType=scsiTrnsptType, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuStatus=scsiLuStatus, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdentifier=ScsiIdentifier, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, ScsiIdType=ScsiIdType, scsiGeneral=scsiGeneral, scsiLunMapGroup=scsiLunMapGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceTable=scsiDeviceTable, scsiDscLunEntry=scsiDscLunEntry, scsiTransportSRP=scsiTransportSRP, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiInstanceEntry=scsiInstanceEntry, ScsiName=ScsiName, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, PYSNMP_MODULE_ID=scsiModule, scsiTargetGroup=scsiTargetGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiPortEntry=scsiPortEntry, scsiLunMapLun=scsiLunMapLun, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceResets=scsiDeviceResets, ScsiIdValue=ScsiIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDevicePortNumber=scsiDevicePortNumber, scsiTrnsptDevName=scsiTrnsptDevName, scsiNotifications=scsiNotifications, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiCompliances=scsiCompliances, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIndex=scsiLuIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuVendorId=scsiLuVendorId, scsiTransportISCSI=scsiTransportISCSI, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtPortName=scsiTgtPortName, scsiLuState=scsiLuState, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortTable=scsiTgtPortTable, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscLunIndex=scsiDscLunIndex, scsiPortRole=scsiPortRole, scsiModule=scsiModule, scsiLuProductId=scsiLuProductId, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportFCP=scsiTransportFCP, scsiObjects=scsiObjects, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLogicalUnit=scsiLogicalUnit, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTable=scsiPortTable, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuIdValue=scsiLuIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceTable=scsiInstanceTable, scsiDeviceGroup=scsiDeviceGroup, scsiGroups=scsiGroups, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuEntry=scsiLuEntry, scsiCompliance=scsiCompliance, scsiLuIdType=scsiLuIdType)
