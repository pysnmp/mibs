...
Integer32, Bits, ObjectIdentity, mib_2, Unsigned32, ModuleIdentity, MibIdentifier, IpAddress, NotificationType, Counter64, Gauge32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "ObjectIdentity", "mib-2", "Unsigned32", "ModuleIdentity", "MibIdentifier", "IpAddress", "NotificationType", "Counter64", "Gauge32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
TruthValue, AutonomousType, RowStatus, TimeStamp, RowPointer, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "RowStatus", "TimeStamp", "RowPointer", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliances=scsiCompliances, ScsiIdAssociation=ScsiIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiGroups=scsiGroups, scsiLuIdTable=scsiLuIdTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiModule=scsiModule, scsiLuInCommands=scsiLuInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLuTable=scsiLuTable, scsiTransportTypes=scsiTransportTypes, scsiTransportSBP=scsiTransportSBP, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdentifier=ScsiIdentifier, scsiLuIdType=scsiLuIdType, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLunMapLun=scsiLunMapLun, scsiDeviceGroup=scsiDeviceGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceEntry=scsiDeviceEntry, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIndex=scsiLuIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapIndex=scsiLunMapIndex, scsiCompliance=scsiCompliance, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTrnsptTable=scsiTrnsptTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDeviceResets=scsiDeviceResets, scsiDscLunIdAssociation=scsiDscLunIdAssociation, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTranportSPI=scsiTranportSPI, PYSNMP_MODULE_ID=scsiModule, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuProductId=scsiLuProductId, scsiPortEntry=scsiPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, ScsiName=ScsiName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDscLunIndex=scsiDscLunIndex, scsiTgtDevTable=scsiTgtDevTable, ScsiIdType=ScsiIdType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportSRP=scsiTransportSRP, ScsiLUNOrZero=ScsiLUNOrZero, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortName=scsiTgtPortName, scsiInstVendorVersion=scsiInstVendorVersion, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuInResets=scsiLuInResets, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortRole=scsiPortRole, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiPortIndex=scsiPortIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTrnsptType=scsiTrnsptType, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInitiator=scsiInitiator, scsiTransportFCP=scsiTransportFCP, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuStatus=scsiLuStatus, scsiNotifications=scsiNotifications, scsiLuState=scsiLuState, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdEntry=scsiLuIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunTable=scsiDscLunTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstIndex=scsiInstIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrName=scsiAuthIntrName, scsiLuHSInCommands=scsiLuHSInCommands, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuWwnName=scsiLuWwnName, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceIndex=scsiDeviceIndex, ScsiIdValue=ScsiIdValue, scsiDeviceRole=scsiDeviceRole, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuIdValue=scsiLuIdValue, scsiTargetGroup=scsiTargetGroup, scsiDscTgtName=scsiDscTgtName, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiTarget=scsiTarget, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiConformance=scsiConformance)
