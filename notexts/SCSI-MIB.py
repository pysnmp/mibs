...
TimeTicks, Unsigned32, ModuleIdentity, iso, ObjectIdentity, mib_2, MibIdentifier, NotificationType, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ModuleIdentity", "iso", "ObjectIdentity", "mib-2", "MibIdentifier", "NotificationType", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "Gauge32")
RowPointer, TimeStamp, RowStatus, AutonomousType, DisplayString, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "RowStatus", "AutonomousType", "DisplayString", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, scsiLuIdValue=scsiLuIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapLun=scsiLunMapLun, scsiLuIdType=scsiLuIdType, scsiTrnsptTable=scsiTrnsptTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrName=scsiAuthIntrName, scsiPortRole=scsiPortRole, scsiTgtDevTable=scsiTgtDevTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, ScsiIdType=ScsiIdType, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortEntry=scsiTgtPortEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceEntry=scsiDeviceEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiIdValue=ScsiIdValue, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLunMapLuIndex=scsiLunMapLuIndex, PYSNMP_MODULE_ID=scsiModule, scsiInitiator=scsiInitiator, scsiInstanceTable=scsiInstanceTable, scsiInstAlias=scsiInstAlias, scsiTgtPortName=scsiTgtPortName, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, ScsiName=ScsiName, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliance=scsiCompliance, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValue=ScsiIndexValue, scsiTarget=scsiTarget, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiConformance=scsiConformance, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTranportSPI=scsiTranportSPI, scsiTrnsptType=scsiTrnsptType, scsiLuState=scsiLuState, scsiNotifications=scsiNotifications, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuProductId=scsiLuProductId, scsiDscLunIdType=scsiDscLunIdType, scsiTransportTypes=scsiTransportTypes, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTable=scsiIntrDevTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuInResets=scsiLuInResets, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiGroups=scsiGroups, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtName=scsiDscTgtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiModule=scsiModule, scsiDscLunIndex=scsiDscLunIndex, scsiTransportSBP=scsiTransportSBP, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiPortIndex=scsiPortIndex, scsiDscLunTable=scsiDscLunTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuIndex=scsiLuIndex, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuStatus=scsiLuStatus, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapTable=scsiLunMapTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiObjects=scsiObjects, scsiPortEntry=scsiPortEntry, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscLunIdTable=scsiDscLunIdTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuWwnName=scsiLuWwnName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuEntry=scsiLuEntry, scsiLuVendorId=scsiLuVendorId, scsiRemoteTarget=scsiRemoteTarget, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceResets=scsiDeviceResets, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLuIdEntry=scsiLuIdEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuRevisionId=scsiLuRevisionId, scsiLuIdAssociation=scsiLuIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, scsiCompliances=scsiCompliances, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiInstIndex=scsiInstIndex, scsiDscLunEntry=scsiDscLunEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP)
