...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, IpAddress, ModuleIdentity, MibIdentifier, ObjectIdentity, Counter32, Counter64, iso, TimeTicks, Unsigned32, Integer32, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "IpAddress", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Counter32", "Counter64", "iso", "TimeTicks", "Unsigned32", "Integer32", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdCodeSet=scsiLuIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiPortEntry=scsiPortEntry, scsiDeviceEntry=scsiDeviceEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTranportOther=scsiTranportOther, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuInResets=scsiLuInResets, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdEntry=scsiLuIdEntry, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdAssociation=scsiLuIdAssociation, scsiLuWwnName=scsiLuWwnName, scsiModule=scsiModule, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunLun=scsiDscLunLun, ScsiName=ScsiName, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceRole=scsiDeviceRole, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttTgtPortName=scsiAttTgtPortName, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapTable=scsiLunMapTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuIdTable=scsiLuIdTable, scsiPortRole=scsiPortRole, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuInCommands=scsiLuInCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtIndex=scsiDscTgtIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiTrnsptType=scsiTrnsptType, ScsiIdType=ScsiIdType, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiCompliance=scsiCompliance, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdValue=scsiLuIdValue, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetGroup=scsiTargetGroup, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptTable=scsiTrnsptTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtEntry=scsiDscTgtEntry, scsiTransportFCP=scsiTransportFCP, scsiLuEntry=scsiLuEntry, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTransportISCSI=scsiTransportISCSI, scsiGeneral=scsiGeneral, scsiLuTable=scsiLuTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstanceTable=scsiInstanceTable, scsiDeviceTable=scsiDeviceTable, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortIndex=scsiPortIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTransportSBP=scsiTransportSBP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortTable=scsiTgtPortTable, scsiTranportSPI=scsiTranportSPI, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTarget=scsiTarget, scsiLunMapGroup=scsiLunMapGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdType=scsiDscLunIdType, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiObjects=scsiObjects, scsiLuState=scsiLuState, scsiInitiator=scsiInitiator, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIdType=scsiLuIdType, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotifications=scsiNotifications, scsiRemoteTarget=scsiRemoteTarget, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtEntry=scsiIntrPrtEntry, PYSNMP_MODULE_ID=scsiModule, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuStatus=scsiLuStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAuthIntrName=scsiAuthIntrName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstIndex=scsiInstIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscTgtTable=scsiDscTgtTable, scsiLuIndex=scsiLuIndex, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtPortName=scsiTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiGroups=scsiGroups, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, scsiTransportTypes=scsiTransportTypes, scsiDscLunIdValue=scsiDscLunIdValue, ScsiIdValue=ScsiIdValue, scsiDscLunTable=scsiDscLunTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscLunEntry=scsiDscLunEntry, ScsiIdAssociation=ScsiIdAssociation, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLuVendorId=scsiLuVendorId, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup)
