...
Bits, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, Integer32, Gauge32, iso, IpAddress, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "Integer32", "Gauge32", "iso", "IpAddress", "Counter32", "mib-2")
TruthValue, TimeStamp, TextualConvention, DisplayString, AutonomousType, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "AutonomousType", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLunMapLun=scsiLunMapLun, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtName=scsiIntrPrtName, ScsiIdType=ScsiIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDeviceTable=scsiDeviceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetGroup=scsiTargetGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrIndex=scsiAuthIntrIndex, PYSNMP_MODULE_ID=scsiModule, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTgtPortName=scsiTgtPortName, scsiLunMapTable=scsiLunMapTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptType=scsiTrnsptType, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstVendorVersion=scsiInstVendorVersion, scsiObjects=scsiObjects, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuDefaultLun=scsiLuDefaultLun, scsiModule=scsiModule, scsiTransportFCP=scsiTransportFCP, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTarget=scsiTarget, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuIdType=scsiLuIdType, scsiConformance=scsiConformance, scsiLuInCommands=scsiLuInCommands, scsiLuIndex=scsiLuIndex, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuInResets=scsiLuInResets, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiPortIndex=scsiPortIndex, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiGeneral=scsiGeneral, scsiDscLunEntry=scsiDscLunEntry, scsiTrnsptTable=scsiTrnsptTable, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiPortTable=scsiPortTable, scsiLuIdValue=scsiLuIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapGroup=scsiLunMapGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceGroup=scsiDeviceGroup, scsiCompliances=scsiCompliances, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiNotifications=scsiNotifications, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuIdTable=scsiLuIdTable, scsiCompliance=scsiCompliance, scsiLuIdIndex=scsiLuIdIndex, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstAlias=scsiInstAlias, scsiDeviceEntry=scsiDeviceEntry, scsiPortRole=scsiPortRole, scsiRemoteTarget=scsiRemoteTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiLuTable=scsiLuTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiGroups=scsiGroups, scsiTranportOther=scsiTranportOther, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortEntry=scsiPortEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiator=scsiInitiator, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatus=scsiLuStatus, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstIndex=scsiInstIndex, scsiDscLunIdValue=scsiDscLunIdValue, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValue=ScsiIndexValue, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDeviceAlias=scsiDeviceAlias, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuEntry=scsiLuEntry, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTranportSPI=scsiTranportSPI, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtName=scsiDscTgtName, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDeviceRole=scsiDeviceRole, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, scsiTgtPortTable=scsiTgtPortTable, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuProductId=scsiLuProductId, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSBP=scsiTransportSBP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortName=scsiAttTgtPortName, ScsiIdValue=ScsiIdValue)
