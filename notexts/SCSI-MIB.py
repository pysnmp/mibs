...
Integer32, Counter32, Gauge32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, mib_2, TimeTicks, MibIdentifier, Counter64, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "mib-2", "TimeTicks", "MibIdentifier", "Counter64", "NotificationType", "iso", "ModuleIdentity")
TimeStamp, TruthValue, TextualConvention, AutonomousType, DisplayString, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuInCommands=scsiLuInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, ScsiIdType=ScsiIdType, scsiObjects=scsiObjects, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtIndex=scsiDscTgtIndex, scsiInstanceEntry=scsiInstanceEntry, scsiLunMapIndex=scsiLunMapIndex, scsiTgtPortName=scsiTgtPortName, scsiPortIndex=scsiPortIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGroups=scsiGroups, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTranportOther=scsiTranportOther, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiDeviceResets=scsiDeviceResets, scsiLuEntry=scsiLuEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiTransportTypes=scsiTransportTypes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceTable=scsiDeviceTable, scsiLuState=scsiLuState, scsiLuDefaultLun=scsiLuDefaultLun, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiPortRole=scsiPortRole, scsiDscLunIdTable=scsiDscLunIdTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInResets=scsiLuInResets, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiCompliance=scsiCompliance, scsiPortTable=scsiPortTable, scsiLuIdTable=scsiLuIdTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceEntry=scsiDeviceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiLunMapTable=scsiLunMapTable, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, ScsiIndexValue=ScsiIndexValue, scsiDscTgtName=scsiDscTgtName, scsiRemoteTarget=scsiRemoteTarget, scsiLuWwnName=scsiLuWwnName, scsiTransportFCP=scsiTransportFCP, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiPortEntry=scsiPortEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscLunIdType=scsiDscLunIdType, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDeviceRole=scsiDeviceRole, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuIdType=scsiLuIdType, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiTransportISCSI=scsiTransportISCSI, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortTable=scsiTgtPortTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiNotifications=scsiNotifications, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTranportSPI=scsiTranportSPI, scsiLuIndex=scsiLuIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuVendorId=scsiLuVendorId, scsiInstIndex=scsiInstIndex, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiator=scsiInitiator, scsiLunMapGroup=scsiLunMapGroup, scsiLuProductId=scsiLuProductId, scsiLunMapLun=scsiLunMapLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdValue=scsiDscLunIdValue, ScsiLUNOrZero=ScsiLUNOrZero, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiGeneral=scsiGeneral, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIndex=scsiDscLunIndex, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstAlias=scsiInstAlias, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTrnsptTable=scsiTrnsptTable, scsiIntrPrtTable=scsiIntrPrtTable, scsiInstanceTable=scsiInstanceTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiTgtDevTable=scsiTgtDevTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiCompliances=scsiCompliances, scsiConformance=scsiConformance, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuStatus=scsiLuStatus, scsiTrnsptType=scsiTrnsptType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuIdValue=scsiLuIdValue, scsiDscLunLun=scsiDscLunLun, scsiTarget=scsiTarget, scsiIntrDevTable=scsiIntrDevTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSRP=scsiTransportSRP, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDevicePortNumber=scsiDevicePortNumber)
