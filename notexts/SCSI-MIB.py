...
mib_2, Unsigned32, IpAddress, Counter64, iso, Integer32, Bits, Gauge32, Counter32, TimeTicks, ModuleIdentity, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Unsigned32", "IpAddress", "Counter64", "iso", "Integer32", "Bits", "Gauge32", "Counter32", "TimeTicks", "ModuleIdentity", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowPointer, TimeStamp, DisplayString, TextualConvention, RowStatus, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtTable=scsiDscTgtTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliances=scsiCompliances, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrDevTable=scsiIntrDevTable, ScsiName=ScsiName, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiConformance=scsiConformance, scsiLuWwnName=scsiLuWwnName, scsiInstanceEntry=scsiInstanceEntry, scsiLuTable=scsiLuTable, scsiPortEntry=scsiPortEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortName=scsiTgtPortName, scsiLuRevisionId=scsiLuRevisionId, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTranportOther=scsiTranportOther, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLunMapIndex=scsiLunMapIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuInCommands=scsiLuInCommands, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIdAssociation=ScsiIdAssociation, scsiLuIdAssociation=scsiLuIdAssociation, scsiLunMapTable=scsiLunMapTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuIdIndex=scsiLuIdIndex, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, scsiIntrPrtName=scsiIntrPrtName, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIndex=scsiDscLunIndex, scsiModule=scsiModule, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceEntry=scsiDeviceEntry, scsiLuIdTable=scsiLuIdTable, scsiTgtPortInCommands=scsiTgtPortInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiDeviceGroup=scsiDeviceGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiLuProductId=scsiLuProductId, scsiLuStatusChanged=scsiLuStatusChanged, scsiGroups=scsiGroups, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiator=scsiInitiator, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDscLunTable=scsiDscLunTable, scsiLuIdType=scsiLuIdType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, ScsiIdValue=ScsiIdValue, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiNotifications=scsiNotifications, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiGeneral=scsiGeneral, scsiDscTgtRowStatus=scsiDscTgtRowStatus, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiPortIndex=scsiPortIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiDeviceRole=scsiDeviceRole, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiInstanceTable=scsiInstanceTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtDevTable=scsiTgtDevTable, scsiCompliance=scsiCompliance, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtTable=scsiIntrPrtTable, scsiLuIndex=scsiLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstIndex=scsiInstIndex, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstAlias=scsiInstAlias, scsiLuStatus=scsiLuStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDeviceIndex=scsiDeviceIndex, scsiTransportFCP=scsiTransportFCP, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTarget=scsiTarget, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, PYSNMP_MODULE_ID=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortTable=scsiTgtPortTable, scsiLuPeripheralType=scsiLuPeripheralType, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortTable=scsiPortTable, scsiDeviceTable=scsiDeviceTable, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDscTgtName=scsiDscTgtName, scsiTransportSBP=scsiTransportSBP, scsiPortRole=scsiPortRole, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiLunMapLun=scsiLunMapLun, scsiLuIdEntry=scsiLuIdEntry, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevEntry=scsiTgtDevEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTrnsptPointer=scsiTrnsptPointer, scsiObjects=scsiObjects, scsiLuIdValue=scsiLuIdValue, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTrnsptIndex=scsiTrnsptIndex, ScsiIndexValue=ScsiIndexValue, scsiTranportSPI=scsiTranportSPI, scsiDscLunLun=scsiDscLunLun, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuInResets=scsiLuInResets)
