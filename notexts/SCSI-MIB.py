...
iso, NotificationType, Unsigned32, IpAddress, ObjectIdentity, Counter32, ModuleIdentity, Counter64, MibIdentifier, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter32", "ModuleIdentity", "Counter64", "MibIdentifier", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "Integer32")
TimeStamp, TextualConvention, DisplayString, TruthValue, RowPointer, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "TruthValue", "RowPointer", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiPortRole=scsiPortRole, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuEntry=scsiLuEntry, scsiDeviceGroup=scsiDeviceGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetGroup=scsiTargetGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdEntry=scsiLuIdEntry, scsiNotifications=scsiNotifications, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, ScsiName=ScsiName, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuInCommands=scsiLuInCommands, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortName=scsiAttTgtPortName, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdValue=ScsiIdValue, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValue=ScsiIndexValue, scsiTranportOther=scsiTranportOther, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapTable=scsiLunMapTable, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLuState=scsiLuState, scsiTransportISCSI=scsiTransportISCSI, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuPeripheralType=scsiLuPeripheralType, ScsiIdType=ScsiIdType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceResets=scsiDeviceResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTrnsptDevName=scsiTrnsptDevName, scsiTarget=scsiTarget, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunLun=scsiDscLunLun, scsiDscLunIdType=scsiDscLunIdType, scsiLuStatus=scsiLuStatus, scsiLuWwnName=scsiLuWwnName, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiLunMapGroup=scsiLunMapGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLogicalUnit=scsiLogicalUnit, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceTable=scsiDeviceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuTable=scsiLuTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiAttIntrPrtName=scsiAttIntrPrtName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstIndex=scsiInstIndex, scsiTgtDevTable=scsiTgtDevTable, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, PYSNMP_MODULE_ID=scsiModule, scsiLunMapEntry=scsiLunMapEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptEntry=scsiTrnsptEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiConformance=scsiConformance, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptType=scsiTrnsptType, scsiPortEntry=scsiPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuVendorId=scsiLuVendorId, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTranportSPI=scsiTranportSPI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrDevTable=scsiIntrDevTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiDscTgtName=scsiDscTgtName, scsiPortTable=scsiPortTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstVendorVersion=scsiInstVendorVersion, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInitiator=scsiInitiator, scsiTrnsptTable=scsiTrnsptTable, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiCompliances=scsiCompliances, scsiDeviceRole=scsiDeviceRole, scsiDscLunTable=scsiDscLunTable, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuProductId=scsiLuProductId, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDeviceEntry=scsiDeviceEntry, scsiInstAlias=scsiInstAlias, scsiTgtPortTable=scsiTgtPortTable, scsiIntrPrtName=scsiIntrPrtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliance=scsiCompliance, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdValue=scsiDscLunIdValue, scsiLunMapIndex=scsiLunMapIndex, scsiGroups=scsiGroups, scsiObjects=scsiObjects, scsiInstanceTable=scsiInstanceTable, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrName=scsiAuthIntrName, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportSBP=scsiTransportSBP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuIdTable=scsiLuIdTable, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiGeneral=scsiGeneral, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLunMapLun=scsiLunMapLun, scsiLuIndex=scsiLuIndex, scsiLuIdValue=scsiLuIdValue, scsiTrnsptIndex=scsiTrnsptIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuInResets=scsiLuInResets, ScsiIdentifier=ScsiIdentifier, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiModule=scsiModule, scsiTransportSRP=scsiTransportSRP, scsiIntrPrtTable=scsiIntrPrtTable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiPortIndex=scsiPortIndex, scsiDscTgtTable=scsiDscTgtTable, scsiIntrDevOutResets=scsiIntrDevOutResets)
