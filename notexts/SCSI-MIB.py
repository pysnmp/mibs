...
iso, Unsigned32, Integer32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64, MibIdentifier, NotificationType, Gauge32, mib_2, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Integer32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64", "MibIdentifier", "NotificationType", "Gauge32", "mib-2", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
TextualConvention, RowStatus, TruthValue, DisplayString, RowPointer, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "TruthValue", "DisplayString", "RowPointer", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstVendorVersion=scsiInstVendorVersion, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiNotifications=scsiNotifications, scsiLuInCommands=scsiLuInCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSBP=scsiTransportSBP, scsiTrnsptTable=scsiTrnsptTable, scsiInstanceTable=scsiInstanceTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiRemoteTarget=scsiRemoteTarget, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuEntry=scsiLuEntry, scsiLuStatus=scsiLuStatus, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuWwnName=scsiLuWwnName, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, ScsiIdValue=ScsiIdValue, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiLogicalUnit=scsiLogicalUnit, scsiLunMapGroup=scsiLunMapGroup, scsiCompliance=scsiCompliance, scsiDscTgtName=scsiDscTgtName, scsiLuVendorId=scsiLuVendorId, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, ScsiIdType=ScsiIdType, scsiGeneral=scsiGeneral, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuIdType=scsiLuIdType, scsiDeviceRole=scsiDeviceRole, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLun=scsiLunMapLun, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiTranportSPI=scsiTranportSPI, scsiTranportOther=scsiTranportOther, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiInstAlias=scsiInstAlias, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiLUNOrZero=ScsiLUNOrZero, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiIntrDevTable=scsiIntrDevTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuIdEntry=scsiLuIdEntry, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceEntry=scsiDeviceEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunIdType=scsiDscLunIdType, scsiPortEntry=scsiPortEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuProductId=scsiLuProductId, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTransportSRP=scsiTransportSRP, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLunMapTable=scsiLunMapTable, scsiDscLunLun=scsiDscLunLun, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortRole=scsiPortRole, ScsiName=ScsiName, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiDeviceResets=scsiDeviceResets, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceIndex=scsiDeviceIndex, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtTable=scsiIntrPrtTable, scsiTgtPortName=scsiTgtPortName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdTable=scsiDscLunIdTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapIndex=scsiLunMapIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrName=scsiAuthIntrName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLuIndex=scsiLuIndex, ScsiIndexValue=ScsiIndexValue, scsiTarget=scsiTarget, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptIndex=scsiTrnsptIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuInResets=scsiLuInResets, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtPortTable=scsiTgtPortTable, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDeviceTable=scsiDeviceTable, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtTable=scsiDscTgtTable, scsiPortIndex=scsiPortIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuTable=scsiLuTable, ScsiIdentifier=ScsiIdentifier, scsiTransportFCP=scsiTransportFCP, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiIntrPrtName=scsiIntrPrtName, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiConformance=scsiConformance, scsiCompliances=scsiCompliances, scsiLuIdTable=scsiLuIdTable, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceGroup=scsiDeviceGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInitiator=scsiInitiator, scsiInstanceEntry=scsiInstanceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiInstIndex=scsiInstIndex, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuState=scsiLuState, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiTrnsptDevName=scsiTrnsptDevName, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiGroups=scsiGroups, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDevicePortNumber=scsiDevicePortNumber, scsiObjects=scsiObjects)
