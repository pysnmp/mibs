...
Integer32, ObjectIdentity, IpAddress, Gauge32, TimeTicks, Counter32, MibIdentifier, iso, ModuleIdentity, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "IpAddress", "Gauge32", "TimeTicks", "Counter32", "MibIdentifier", "iso", "ModuleIdentity", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "Counter64")
AutonomousType, DisplayString, TimeStamp, TruthValue, TextualConvention, RowStatus, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus", "RowPointer")
...
mibBuilder.exportSymbols("SCSI-MIB", ScsiIdValue=ScsiIdValue, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuRevisionId=scsiLuRevisionId, scsiInstanceEntry=scsiInstanceEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtEntry=scsiDscTgtEntry, scsiLuIdValue=scsiLuIdValue, scsiTransportTypes=scsiTransportTypes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuIndex=scsiLuIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuProductId=scsiLuProductId, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTargetGroup=scsiTargetGroup, scsiTransportSRP=scsiTransportSRP, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtTable=scsiDscTgtTable, scsiLogicalUnit=scsiLogicalUnit, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiLuVendorId=scsiLuVendorId, scsiDeviceIndex=scsiDeviceIndex, scsiDscLunIndex=scsiDscLunIndex, ScsiIndexValue=ScsiIndexValue, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTrnsptTable=scsiTrnsptTable, scsiTranportOther=scsiTranportOther, scsiPortTable=scsiPortTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapLun=scsiLunMapLun, scsiLuInCommands=scsiLuInCommands, scsiPortRole=scsiPortRole, scsiInitiator=scsiInitiator, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiInstanceTable=scsiInstanceTable, scsiCompliances=scsiCompliances, ScsiIdentifier=ScsiIdentifier, scsiLuState=scsiLuState, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortTable=scsiTgtPortTable, scsiLuEntry=scsiLuEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunEntry=scsiDscLunEntry, scsiLuIdTable=scsiLuIdTable, scsiLuStatus=scsiLuStatus, scsiDeviceAlias=scsiDeviceAlias, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdType=scsiDscLunIdType, scsiNotifications=scsiNotifications, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscLunTable=scsiDscLunTable, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiInstAlias=scsiInstAlias, scsiConformance=scsiConformance, scsiLuTable=scsiLuTable, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiIntrDevTable=scsiIntrDevTable, ScsiIdType=ScsiIdType, ScsiName=ScsiName, scsiLunMapTable=scsiLunMapTable, scsiGeneral=scsiGeneral, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapGroup=scsiLunMapGroup, scsiTrnsptType=scsiTrnsptType, scsiInstIndex=scsiInstIndex, scsiDeviceResets=scsiDeviceResets, scsiModule=scsiModule, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuWwnName=scsiLuWwnName, scsiDeviceGroup=scsiDeviceGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiObjects=scsiObjects, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIdValue=scsiDscLunIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiGroups=scsiGroups, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTransportFCP=scsiTransportFCP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, PYSNMP_MODULE_ID=scsiModule, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtTable=scsiIntrPrtTable, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiRemoteTarget=scsiRemoteTarget, scsiLuInResets=scsiLuInResets, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceRole=scsiDeviceRole, scsiTrnsptEntry=scsiTrnsptEntry, scsiDeviceTable=scsiDeviceTable, scsiTranportSPI=scsiTranportSPI, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiPortEntry=scsiPortEntry, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtIndex=scsiDscTgtIndex, scsiPortIndex=scsiPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuDefaultLun=scsiLuDefaultLun, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiCompliance=scsiCompliance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtName=scsiDscTgtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrName=scsiAuthIntrName, scsiTgtDevTable=scsiTgtDevTable, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuIdIndex=scsiLuIdIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdAssociation=scsiLuIdAssociation, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdType=scsiLuIdType, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTarget=scsiTarget, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuStatusChanged=scsiLuStatusChanged, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
