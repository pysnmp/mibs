...
mib_2, iso, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, TimeTicks, IpAddress, ObjectIdentity, Bits, Counter64, NotificationType, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "ModuleIdentity", "Gauge32")
DisplayString, RowStatus, TextualConvention, RowPointer, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "RowPointer", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtDevTable=scsiTgtDevTable, scsiLunMapTable=scsiLunMapTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuInResets=scsiLuInResets, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiLunMapIndex=scsiLunMapIndex, ScsiIndexValue=ScsiIndexValue, scsiTransportTypes=scsiTransportTypes, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuVendorId=scsiLuVendorId, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiAuthIntrName=scsiAuthIntrName, scsiInstanceTable=scsiInstanceTable, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDscTgtTable=scsiDscTgtTable, scsiTgtPortTable=scsiTgtPortTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtName=scsiIntrPrtName, scsiDscLunIdType=scsiDscLunIdType, scsiDeviceIndex=scsiDeviceIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiInstIndex=scsiInstIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTransportISCSI=scsiTransportISCSI, scsiDeviceGroup=scsiDeviceGroup, scsiDscLunTable=scsiDscLunTable, scsiConformance=scsiConformance, scsiObjects=scsiObjects, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiGroups=scsiGroups, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdCodeSet=ScsiIdCodeSet, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTransportSBP=scsiTransportSBP, scsiCompliance=scsiCompliance, scsiTransportFCP=scsiTransportFCP, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuState=scsiLuState, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiLUNOrZero=ScsiLUNOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptDevName=scsiTrnsptDevName, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiInstAlias=scsiInstAlias, scsiAttTgtPortName=scsiAttTgtPortName, scsiTrnsptIndex=scsiTrnsptIndex, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiTransportSRP=scsiTransportSRP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiCompliances=scsiCompliances, scsiDscTgtIndex=scsiDscTgtIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtName=scsiDscTgtName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuIdType=scsiLuIdType, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdType=ScsiIdType, scsiLuDefaultLun=scsiLuDefaultLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiTrnsptTable=scsiTrnsptTable, scsiNotifications=scsiNotifications, scsiLuIdTable=scsiLuIdTable, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortEntry=scsiPortEntry, scsiLuInCommands=scsiLuInCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortIndex=scsiPortIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuHSInCommands=scsiLuHSInCommands, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiLuWwnName=scsiLuWwnName, scsiGeneral=scsiGeneral, scsiLuStatusChanged=scsiLuStatusChanged, scsiLuIndex=scsiLuIndex, scsiTrnsptEntry=scsiTrnsptEntry, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiModule=scsiModule, scsiDeviceEntry=scsiDeviceEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuStatus=scsiLuStatus, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiInitiator=scsiInitiator, scsiLuRevisionId=scsiLuRevisionId, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceRole=scsiDeviceRole, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, ScsiIdAssociation=ScsiIdAssociation, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuProductId=scsiLuProductId, scsiLuIdValue=scsiLuIdValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiTrnsptPointer=scsiTrnsptPointer, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDeviceAlias=scsiDeviceAlias, scsiPortTable=scsiPortTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTarget=scsiTarget, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuTable=scsiLuTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptType=scsiTrnsptType, scsiDeviceTable=scsiDeviceTable, scsiDeviceResets=scsiDeviceResets, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiIdentifier=ScsiIdentifier, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuEntry=scsiLuEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTargetGroup=scsiTargetGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTranportOther=scsiTranportOther, PYSNMP_MODULE_ID=scsiModule, scsiLuPeripheralType=scsiLuPeripheralType, scsiTgtPortName=scsiTgtPortName, scsiPortRole=scsiPortRole, ScsiName=ScsiName, scsiIntrDevEntry=scsiIntrDevEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLunMapGroup=scsiLunMapGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes)
