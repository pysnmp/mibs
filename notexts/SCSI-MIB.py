...
Gauge32, Bits, mib_2, TimeTicks, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, IpAddress, Unsigned32, Integer32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "mib-2", "TimeTicks", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "IpAddress", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier")
AutonomousType, RowPointer, TimeStamp, TextualConvention, RowStatus, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLuVendorId=scsiLuVendorId, scsiLunMapTable=scsiLunMapTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetGroup=scsiTargetGroup, scsiPortEntry=scsiPortEntry, ScsiIdentifier=ScsiIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiLunMapGroup=scsiLunMapGroup, scsiTarget=scsiTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuIdIndex=scsiLuIdIndex, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiIntrPrtTable=scsiIntrPrtTable, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiPortIndex=scsiPortIndex, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuInCommands=scsiLuInCommands, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuHSInCommands=scsiLuHSInCommands, ScsiIdCodeSet=ScsiIdCodeSet, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuIdTable=scsiLuIdTable, scsiTransportTypes=scsiTransportTypes, scsiInstanceTable=scsiInstanceTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuInResets=scsiLuInResets, scsiLuIdAssociation=scsiLuIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, ScsiName=ScsiName, scsiDscLunIdIndex=scsiDscLunIdIndex, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdType=ScsiIdType, scsiCompliance=scsiCompliance, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiRemoteTarget=scsiRemoteTarget, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiDscLunTable=scsiDscLunTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, scsiDeviceTable=scsiDeviceTable, scsiPortTable=scsiPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiObjects=scsiObjects, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLuIdEntry=scsiLuIdEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdValue=scsiDscLunIdValue, scsiLuState=scsiLuState, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDeviceIndex=scsiDeviceIndex, scsiInstAlias=scsiInstAlias, scsiTgtPortEntry=scsiTgtPortEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapLun=scsiLunMapLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTransportSRP=scsiTransportSRP, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTrnsptTable=scsiTrnsptTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDscLunEntry=scsiDscLunEntry, scsiLuStatus=scsiLuStatus, scsiInitiatorGroup=scsiInitiatorGroup, ScsiIndexValue=ScsiIndexValue, scsiLuWwnName=scsiLuWwnName, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDeviceResets=scsiDeviceResets, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuPeripheralType=scsiLuPeripheralType, PYSNMP_MODULE_ID=scsiModule, scsiGroups=scsiGroups, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiNotifications=scsiNotifications, scsiInstIndex=scsiInstIndex, scsiModule=scsiModule, scsiConformance=scsiConformance, ScsiIdValue=ScsiIdValue, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, ScsiIdAssociation=ScsiIdAssociation, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiInstanceEntry=scsiInstanceEntry, scsiDevicePortNumber=scsiDevicePortNumber, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiInitiator=scsiInitiator, scsiTrnsptIndex=scsiTrnsptIndex, scsiLuIdType=scsiLuIdType, scsiPortRole=scsiPortRole, scsiTgtDevTable=scsiTgtDevTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiCompliances=scsiCompliances, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLunMapEntry=scsiLunMapEntry, scsiLuProductId=scsiLuProductId, scsiDeviceRole=scsiDeviceRole, ScsiLUNOrZero=ScsiLUNOrZero, scsiLogicalUnit=scsiLogicalUnit, scsiGeneral=scsiGeneral, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTranportOther=scsiTranportOther, scsiTrnsptEntry=scsiTrnsptEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuIndex=scsiLuIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDeviceEntry=scsiDeviceEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiTranportSPI=scsiTranportSPI, scsiLuTable=scsiLuTable, scsiDscTgtName=scsiDscTgtName, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtIndex=scsiDscTgtIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDeviceGroup=scsiDeviceGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero)
