...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, MibIdentifier, TimeTicks, Unsigned32, mib_2, ObjectIdentity, Counter32, Gauge32, Counter64, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "MibIdentifier", "TimeTicks", "Unsigned32", "mib-2", "ObjectIdentity", "Counter32", "Gauge32", "Counter64", "Integer32", "ModuleIdentity", "NotificationType")
RowPointer, RowStatus, AutonomousType, TimeStamp, TruthValue, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "RowStatus", "AutonomousType", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTargetGroup=scsiTargetGroup, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscLunIdType=scsiDscLunIdType, scsiTgtDevTable=scsiTgtDevTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuIdAssociation=scsiLuIdAssociation, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscLunIdTable=scsiDscLunIdTable, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiLuWwnName=scsiLuWwnName, scsiPortEntry=scsiPortEntry, ScsiIdAssociation=ScsiIdAssociation, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtEntry=scsiDscTgtEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInstanceTable=scsiInstanceTable, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiCompliance=scsiCompliance, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuTable=scsiLuTable, scsiTrnsptType=scsiTrnsptType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdTable=scsiLuIdTable, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInstIndex=scsiInstIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, ScsiIdentifier=ScsiIdentifier, scsiDevicePortNumber=scsiDevicePortNumber, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLuState=scsiLuState, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuStatusChanged=scsiLuStatusChanged, scsiTarget=scsiTarget, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdType=scsiLuIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiLunMapLun=scsiLunMapLun, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceRole=scsiDeviceRole, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTransportFCP=scsiTransportFCP, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTrnsptDevName=scsiTrnsptDevName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceGroup=scsiDeviceGroup, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiDscTgtTable=scsiDscTgtTable, scsiPortTable=scsiPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuVendorId=scsiLuVendorId, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceEntry=scsiInstanceEntry, scsiGroups=scsiGroups, scsiDscTgtName=scsiDscTgtName, scsiPortTrnsptPtr=scsiPortTrnsptPtr, ScsiIdValue=ScsiIdValue, scsiTranportOther=scsiTranportOther, scsiDscLunTable=scsiDscLunTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuHSInCommands=scsiLuHSInCommands, scsiLuRevisionId=scsiLuRevisionId, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiLuIdValue=scsiLuIdValue, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiRemoteTarget=scsiRemoteTarget, scsiDeviceAlias=scsiDeviceAlias, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiCompliances=scsiCompliances, scsiLuIndex=scsiLuIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiPortIndex=scsiPortIndex, ScsiIndexValue=ScsiIndexValue, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiIntrDevEntry=scsiIntrDevEntry, scsiTransportTypes=scsiTransportTypes, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAuthIntrName=scsiAuthIntrName, PYSNMP_MODULE_ID=scsiModule, scsiObjects=scsiObjects, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunLun=scsiDscLunLun, scsiTgtPortTable=scsiTgtPortTable, scsiLuInResets=scsiLuInResets, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiIdType=ScsiIdType, scsiGeneral=scsiGeneral, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLunMapGroup=scsiLunMapGroup, scsiNotifications=scsiNotifications, scsiPortRole=scsiPortRole, scsiIntrPrtName=scsiIntrPrtName, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiConformance=scsiConformance, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDevEntry=scsiTgtDevEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiLogicalUnit=scsiLogicalUnit, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLuStatus=scsiLuStatus, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiInstAlias=scsiInstAlias, scsiModule=scsiModule, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuProductId=scsiLuProductId, scsiIntrDevTable=scsiIntrDevTable, scsiDscLunIdValue=scsiDscLunIdValue, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuEntry=scsiLuEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTransportSBP=scsiTransportSBP, scsiDeviceIndex=scsiDeviceIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtIndex=scsiDscTgtIndex, scsiLunMapEntry=scsiLunMapEntry, scsiTranportSPI=scsiTranportSPI, scsiDeviceResets=scsiDeviceResets, scsiDscLunEntry=scsiDscLunEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTrnsptTable=scsiTrnsptTable, scsiLunMapTable=scsiLunMapTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTgtPortName=scsiTgtPortName, scsiInitiator=scsiInitiator, scsiDeviceTable=scsiDeviceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIdCodeSet=ScsiIdCodeSet)
