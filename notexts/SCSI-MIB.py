...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, iso, MibIdentifier, Gauge32, Integer32, IpAddress, ObjectIdentity, Counter64, TimeTicks, Unsigned32, Counter32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "iso", "MibIdentifier", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity", "Counter64", "TimeTicks", "Unsigned32", "Counter32", "NotificationType", "ModuleIdentity")
DisplayString, RowStatus, RowPointer, TextualConvention, AutonomousType, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "RowPointer", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscLunIdIndex=scsiDscLunIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiName=ScsiName, scsiDeviceTable=scsiDeviceTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiModule=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuIdValue=scsiLuIdValue, scsiIntrDevEntry=scsiIntrDevEntry, scsiIntrPrtName=scsiIntrPrtName, scsiLuProductId=scsiLuProductId, scsiLuState=scsiLuState, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstVendorVersion=scsiInstVendorVersion, scsiTrnsptPointer=scsiTrnsptPointer, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuRevisionId=scsiLuRevisionId, scsiInstIndex=scsiInstIndex, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortName=scsiAttTgtPortName, scsiDeviceEntry=scsiDeviceEntry, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscTgtEntry=scsiDscTgtEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiTarget=scsiTarget, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLunMapTable=scsiLunMapTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiLunMapGroup=scsiLunMapGroup, scsiPortTable=scsiPortTable, scsiPortEntry=scsiPortEntry, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiIntrPrtTable=scsiIntrPrtTable, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuTable=scsiLuTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtTable=scsiDscTgtTable, ScsiNameIdOrZero=ScsiNameIdOrZero, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDeviceAlias=scsiDeviceAlias, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstanceEntry=scsiInstanceEntry, scsiTgtPortName=scsiTgtPortName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, PYSNMP_MODULE_ID=scsiModule, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, ScsiIdentifier=ScsiIdentifier, ScsiIdType=ScsiIdType, scsiTgtDevTable=scsiTgtDevTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiConformance=scsiConformance, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIndex=scsiLuIndex, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLunMapIndex=scsiLunMapIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTargetGroup=scsiTargetGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLuIdIndex=scsiLuIdIndex, scsiLuEntry=scsiLuEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiLuIdTable=scsiLuIdTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunLun=scsiDscLunLun, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTranportSPI=scsiTranportSPI, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunIndex=scsiDscLunIndex, scsiCompliances=scsiCompliances, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDeviceRole=scsiDeviceRole, scsiGroups=scsiGroups, scsiLuStatus=scsiLuStatus, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLogicalUnit=scsiLogicalUnit, scsiDscLunIdType=scsiDscLunIdType, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapEntry=scsiLunMapEntry, scsiTransportTypes=scsiTransportTypes, scsiRemoteInitiators=scsiRemoteInitiators, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTransportSBP=scsiTransportSBP, scsiInstAlias=scsiInstAlias, scsiTrnsptDevName=scsiTrnsptDevName, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiObjects=scsiObjects, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiPortIndex=scsiPortIndex, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiInstanceTable=scsiInstanceTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorGroup=scsiInitiatorGroup, scsiInitiator=scsiInitiator, scsiDscLunEntry=scsiDscLunEntry, scsiTransportFCP=scsiTransportFCP, scsiGeneral=scsiGeneral, scsiLuWwnName=scsiLuWwnName, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortTable=scsiTgtPortTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiIntrDevTable=scsiIntrDevTable, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiDscTgtName=scsiDscTgtName, ScsiIndexValue=ScsiIndexValue, scsiDeviceResets=scsiDeviceResets, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIdValue=ScsiIdValue, scsiTransportSRP=scsiTransportSRP, scsiTrnsptType=scsiTrnsptType, scsiTgtDevEntry=scsiTgtDevEntry, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscLunTable=scsiDscLunTable, scsiRemoteTarget=scsiRemoteTarget, scsiTrnsptTable=scsiTrnsptTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiNotifications=scsiNotifications, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiCompliance=scsiCompliance, scsiPortRole=scsiPortRole, scsiLuInCommands=scsiLuInCommands, scsiDeviceIndex=scsiDeviceIndex, scsiLuStatusChanged=scsiLuStatusChanged, scsiTranportOther=scsiTranportOther, scsiAuthIntrName=scsiAuthIntrName)
