...
Unsigned32, Bits, IpAddress, Counter64, ModuleIdentity, Integer32, iso, TimeTicks, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Counter32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "iso", "TimeTicks", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Counter32", "mib-2")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiTransportSRP=scsiTransportSRP, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiGroups=scsiGroups, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapLun=scsiLunMapLun, scsiTrnsptEntry=scsiTrnsptEntry, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortTable=scsiTgtPortTable, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrName=scsiAuthIntrName, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTransportISCSI=scsiTransportISCSI, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiLuTable=scsiLuTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiCompliance=scsiCompliance, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInstanceTable=scsiInstanceTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscTgtTable=scsiDscTgtTable, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiTrnsptTable=scsiTrnsptTable, scsiPortRole=scsiPortRole, scsiTarget=scsiTarget, scsiPortEntry=scsiPortEntry, scsiInitiator=scsiInitiator, scsiPortIndex=scsiPortIndex, scsiAttTgtPortTable=scsiAttTgtPortTable, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtTable=scsiIntrPrtTable, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuIndex=scsiLuIndex, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiTransportSBP=scsiTransportSBP, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, ScsiName=ScsiName, scsiDscTgtIndex=scsiDscTgtIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunEntry=scsiDscLunEntry, scsiLuProductId=scsiLuProductId, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLunMapIndex=scsiLunMapIndex, scsiGeneral=scsiGeneral, ScsiIdentifier=ScsiIdentifier, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortName=scsiAttTgtPortName, scsiPortTable=scsiPortTable, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTransportFCP=scsiTransportFCP, ScsiIdCodeSet=ScsiIdCodeSet, scsiLuIdType=scsiLuIdType, scsiRemoteTarget=scsiRemoteTarget, scsiObjects=scsiObjects, scsiInstAlias=scsiInstAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiDscLunIdType=scsiDscLunIdType, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuIdTable=scsiLuIdTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, ScsiIdType=ScsiIdType, scsiRemoteInitiators=scsiRemoteInitiators, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiInstIndex=scsiInstIndex, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceRole=scsiDeviceRole, scsiTgtDevTable=scsiTgtDevTable, scsiLuWwnName=scsiLuWwnName, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiNotifications=scsiNotifications, PYSNMP_MODULE_ID=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstVendorVersion=scsiInstVendorVersion, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, ScsiLUNOrZero=ScsiLUNOrZero, scsiLuState=scsiLuState, scsiLuStatus=scsiLuStatus, scsiLunMapEntry=scsiLunMapEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiCompliances=scsiCompliances, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiConformance=scsiConformance, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiLuEntry=scsiLuEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDscTgtName=scsiDscTgtName, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiInstanceEntry=scsiInstanceEntry, scsiDscTgtEntry=scsiDscTgtEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuVendorId=scsiLuVendorId, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, scsiLuRevisionId=scsiLuRevisionId, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, ScsiIdAssociation=ScsiIdAssociation, scsiDscLunIndex=scsiDscLunIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTranportOther=scsiTranportOther, ScsiIdValue=ScsiIdValue, ScsiIndexValue=ScsiIndexValue, scsiTrnsptType=scsiTrnsptType, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAttIntrPrtTable=scsiAttIntrPrtTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiLuDefaultLun=scsiLuDefaultLun, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceIndex=scsiDeviceIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscLunLun=scsiDscLunLun, scsiLuIdEntry=scsiLuIdEntry, scsiLogicalUnit=scsiLogicalUnit, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuPeripheralType=scsiLuPeripheralType, scsiTrnsptIndex=scsiTrnsptIndex, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTargetGroup=scsiTargetGroup, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDevicePortNumber=scsiDevicePortNumber, scsiLuStatusChanged=scsiLuStatusChanged, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTrnsptPointer=scsiTrnsptPointer, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLuInResets=scsiLuInResets, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceTable=scsiDeviceTable, scsiTgtPortName=scsiTgtPortName, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiLuInCommands=scsiLuInCommands, scsiTransportTypes=scsiTransportTypes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceResets=scsiDeviceResets, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes)
