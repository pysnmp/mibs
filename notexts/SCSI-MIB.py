...
TimeTicks, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, mib_2, IpAddress, Unsigned32, Counter32, iso, Bits, NotificationType, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "mib-2", "IpAddress", "Unsigned32", "Counter32", "iso", "Bits", "NotificationType", "Gauge32", "Counter64")
AutonomousType, RowPointer, RowStatus, DisplayString, TruthValue, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowPointer", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLuIdAssociation=scsiLuIdAssociation, scsiLuIdType=scsiLuIdType, scsiIntrDevTable=scsiIntrDevTable, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLunMapTable=scsiLunMapTable, scsiInitiator=scsiInitiator, scsiTarget=scsiTarget, scsiLuInCommands=scsiLuInCommands, scsiLuIdTable=scsiLuIdTable, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiObjects=scsiObjects, scsiTransportTypes=scsiTransportTypes, scsiPortBusyStatuses=scsiPortBusyStatuses, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiConformance=scsiConformance, scsiTransportFCP=scsiTransportFCP, scsiPortEntry=scsiPortEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuHSInCommands=scsiLuHSInCommands, scsiIntrPrtName=scsiIntrPrtName, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscLunTable=scsiDscLunTable, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, ScsiIdValue=ScsiIdValue, scsiPortIndex=scsiPortIndex, scsiIntrPrtTable=scsiIntrPrtTable, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscTgtInCommands=scsiDscTgtInCommands, ScsiLUNOrZero=ScsiLUNOrZero, scsiTgtPortTable=scsiTgtPortTable, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiTrnsptPointer=scsiTrnsptPointer, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunIndex=scsiDscLunIndex, scsiDeviceTable=scsiDeviceTable, scsiLuEntry=scsiLuEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiLuReadMegaBytes=scsiLuReadMegaBytes, ScsiName=ScsiName, scsiDeviceAlias=scsiDeviceAlias, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiTrnsptType=scsiTrnsptType, scsiRemoteTarget=scsiRemoteTarget, scsiInstIndex=scsiInstIndex, scsiPortRole=scsiPortRole, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiDscTgtEntry=scsiDscTgtEntry, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuIdEntry=scsiLuIdEntry, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTgtPortName=scsiTgtPortName, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuStatusChanged=scsiLuStatusChanged, scsiTrnsptEntry=scsiTrnsptEntry, scsiPortTable=scsiPortTable, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiTransportSRP=scsiTransportSRP, scsiLunMapLun=scsiLunMapLun, ScsiIdType=ScsiIdType, scsiLuInResets=scsiLuInResets, scsiGroups=scsiGroups, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuStatus=scsiLuStatus, scsiDscTgtTable=scsiDscTgtTable, scsiGeneral=scsiGeneral, scsiIntrDevEntry=scsiIntrDevEntry, scsiDeviceRole=scsiDeviceRole, scsiAuthIntrName=scsiAuthIntrName, scsiTransportISCSI=scsiTransportISCSI, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTranportSPI=scsiTranportSPI, scsiLuDefaultLun=scsiLuDefaultLun, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, PYSNMP_MODULE_ID=scsiModule, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiAttTgtPortName=scsiAttTgtPortName, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiModule=scsiModule, scsiDscLunEntry=scsiDscLunEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiNotifications=scsiNotifications, scsiTranportOther=scsiTranportOther, scsiLuProductId=scsiLuProductId, scsiCompliances=scsiCompliances, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiLogicalUnit=scsiLogicalUnit, ScsiIdAssociation=ScsiIdAssociation, scsiLuIndex=scsiLuIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceGroup=scsiDeviceGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiInstanceTable=scsiInstanceTable, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscLunLun=scsiDscLunLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiInstanceEntry=scsiInstanceEntry, scsiTargetGroup=scsiTargetGroup, scsiCompliance=scsiCompliance, ScsiIdentifier=ScsiIdentifier, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTransportSBP=scsiTransportSBP, ScsiIndexValue=ScsiIndexValue, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtDevTable=scsiTgtDevTable, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiIntrDevOutResets=scsiIntrDevOutResets, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTgtDevEntry=scsiTgtDevEntry, scsiInstVendorVersion=scsiInstVendorVersion, scsiDeviceEntry=scsiDeviceEntry, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiLuWwnName=scsiLuWwnName, scsiLunMapIndex=scsiLunMapIndex, scsiLunMapGroup=scsiLunMapGroup, scsiLuState=scsiLuState, scsiLuIdIndex=scsiLuIdIndex, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTrnsptTable=scsiTrnsptTable, scsiLuPeripheralType=scsiLuPeripheralType, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiDscTgtIndex=scsiDscTgtIndex, scsiRemoteInitiators=scsiRemoteInitiators, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiLuVendorId=scsiLuVendorId, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiLunMapEntry=scsiLunMapEntry, ScsiIdCodeSet=ScsiIdCodeSet, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiInstAlias=scsiInstAlias, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLuIdValue=scsiLuIdValue, scsiDevicePortNumber=scsiDevicePortNumber, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDeviceResets=scsiDeviceResets, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiLuTable=scsiLuTable, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscLunIdValue=scsiDscLunIdValue, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes)
