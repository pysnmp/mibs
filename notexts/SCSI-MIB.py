...
NotificationType, mib_2, TimeTicks, Unsigned32, iso, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, MibIdentifier, Bits, ObjectIdentity, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "TimeTicks", "Unsigned32", "iso", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "MibIdentifier", "Bits", "ObjectIdentity", "Gauge32", "Integer32")
RowStatus, TruthValue, AutonomousType, DisplayString, TimeStamp, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "RowPointer", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDscLunLun=scsiDscLunLun, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiPortTable=scsiPortTable, scsiInstVendorVersion=scsiInstVendorVersion, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDeviceResets=scsiDeviceResets, scsiLuRevisionId=scsiLuRevisionId, scsiDeviceAlias=scsiDeviceAlias, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscTgtTable=scsiDscTgtTable, scsiLunMapLun=scsiLunMapLun, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiDeviceTable=scsiDeviceTable, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuIdEntry=scsiLuIdEntry, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstAlias=scsiInstAlias, ScsiName=ScsiName, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTarget=scsiTarget, scsiLunMapIndex=scsiLunMapIndex, PYSNMP_MODULE_ID=scsiModule, scsiLuHSInCommands=scsiLuHSInCommands, scsiPortRole=scsiPortRole, scsiTrnsptDevName=scsiTrnsptDevName, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiLuVendorId=scsiLuVendorId, scsiPortBusyStatuses=scsiPortBusyStatuses, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiInitiator=scsiInitiator, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLunMapGroup=scsiLunMapGroup, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDscLunTable=scsiDscLunTable, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscLunIdValue=scsiDscLunIdValue, scsiConformance=scsiConformance, scsiLuIdTable=scsiLuIdTable, ScsiLUNOrZero=ScsiLUNOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiLunMapEntry=scsiLunMapEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuWwnName=scsiLuWwnName, scsiCompliance=scsiCompliance, ScsiIdentifier=ScsiIdentifier, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdValue=scsiLuIdValue, scsiNotifications=scsiNotifications, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceRole=scsiDeviceRole, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevTable=scsiIntrDevTable, scsiTgtDevTable=scsiTgtDevTable, scsiGeneral=scsiGeneral, scsiDscLunIdType=scsiDscLunIdType, scsiTgtPortEntry=scsiTgtPortEntry, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTransportISCSI=scsiTransportISCSI, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiGroups=scsiGroups, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiModule=scsiModule, scsiTranportSPI=scsiTranportSPI, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportSRP=scsiTransportSRP, scsiLuState=scsiLuState, scsiTrnsptPointer=scsiTrnsptPointer, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiLuIndex=scsiLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiTgtPortName=scsiTgtPortName, ScsiIdType=ScsiIdType, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstanceTable=scsiInstanceTable, scsiRemoteInitiators=scsiRemoteInitiators, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortName=scsiAttTgtPortName, scsiAuthIntrName=scsiAuthIntrName, ScsiIdValue=ScsiIdValue, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstIndex=scsiInstIndex, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiLuProductId=scsiLuProductId, scsiTransportSBP=scsiTransportSBP, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuStatus=scsiLuStatus, scsiPortIndex=scsiPortIndex, scsiTransportFCP=scsiTransportFCP, scsiTargetGroup=scsiTargetGroup, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiIntrDevEntry=scsiIntrDevEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiLunMapTable=scsiLunMapTable, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, ScsiIdAssociation=ScsiIdAssociation, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiTransportTypes=scsiTransportTypes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiDeviceEntry=scsiDeviceEntry, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDevicePortNumber=scsiDevicePortNumber, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuEntry=scsiLuEntry, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuTable=scsiLuTable, ScsiIndexValue=ScsiIndexValue, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiTrnsptIndex=scsiTrnsptIndex, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdType=scsiLuIdType, scsiDeviceGroup=scsiDeviceGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiLuPeripheralType=scsiLuPeripheralType, scsiCompliances=scsiCompliances, scsiPortEntry=scsiPortEntry, scsiDeviceIndex=scsiDeviceIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtPortTable=scsiTgtPortTable, scsiLuInResets=scsiLuInResets, scsiObjects=scsiObjects, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiDscLunIndex=scsiDscLunIndex, scsiLuInCommands=scsiLuInCommands, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiInstanceEntry=scsiInstanceEntry, scsiTranportOther=scsiTranportOther, scsiRemoteTarget=scsiRemoteTarget, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuStatusChanged=scsiLuStatusChanged, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiTrnsptType=scsiTrnsptType, scsiDscTgtEntry=scsiDscTgtEntry)
