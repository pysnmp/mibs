...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter32, Gauge32, TimeTicks, Bits, Unsigned32, ObjectIdentity, MibIdentifier, Counter64, mib_2, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter64", "mib-2", "iso", "Integer32")
TimeStamp, RowPointer, TruthValue, DisplayString, RowStatus, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowPointer", "TruthValue", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTrnsptType=scsiTrnsptType, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiLuWwnName=scsiLuWwnName, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportSBP=scsiTransportSBP, scsiLuEntry=scsiLuEntry, ScsiIndexValue=ScsiIndexValue, ScsiDeviceOrPort=ScsiDeviceOrPort, PYSNMP_MODULE_ID=scsiModule, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiLuRevisionId=scsiLuRevisionId, scsiTransportFCP=scsiTransportFCP, scsiLuIdType=scsiLuIdType, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiGroups=scsiGroups, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiInitiatorGroup=scsiInitiatorGroup, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiDscLunTable=scsiDscLunTable, scsiTarget=scsiTarget, scsiTrnsptIndex=scsiTrnsptIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuPeripheralType=scsiLuPeripheralType, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiLuInCommands=scsiLuInCommands, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTargetGroup=scsiTargetGroup, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiInstAlias=scsiInstAlias, scsiTranportOther=scsiTranportOther, scsiDeviceGroup=scsiDeviceGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiator=scsiInitiator, scsiLuTable=scsiLuTable, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiInstIndex=scsiInstIndex, scsiInstanceTable=scsiInstanceTable, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiDscLunIdTable=scsiDscLunIdTable, scsiLuIndex=scsiLuIndex, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLogicalUnit=scsiLogicalUnit, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuStatus=scsiLuStatus, scsiTranportSPI=scsiTranportSPI, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiDscTgtName=scsiDscTgtName, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunEntry=scsiDscLunEntry, scsiTransportTypes=scsiTransportTypes, scsiPortEntry=scsiPortEntry, scsiTgtDevEntry=scsiTgtDevEntry, ScsiLUNOrZero=ScsiLUNOrZero, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiLuIdValue=scsiLuIdValue, scsiTgtDevTable=scsiTgtDevTable, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiObjects=scsiObjects, scsiLuProductId=scsiLuProductId, scsiDscLunIdValue=scsiDscLunIdValue, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiLunMapEntry=scsiLunMapEntry, scsiDeviceEntry=scsiDeviceEntry, scsiTrnsptEntry=scsiTrnsptEntry, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportISCSI=scsiTransportISCSI, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiRemoteTarget=scsiRemoteTarget, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuState=scsiLuState, scsiTrnsptDevName=scsiTrnsptDevName, scsiDscLunLun=scsiDscLunLun, scsiDeviceIndex=scsiDeviceIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLunMapIndex=scsiLunMapIndex, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceTable=scsiDeviceTable, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiLuIdEntry=scsiLuIdEntry, scsiCompliances=scsiCompliances, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSRP=scsiTransportSRP, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLuIdTable=scsiLuIdTable, scsiTrnsptTable=scsiTrnsptTable, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, ScsiIdentifier=ScsiIdentifier, scsiPortIndex=scsiPortIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapLun=scsiLunMapLun, ScsiIdCodeSet=ScsiIdCodeSet, scsiInstanceEntry=scsiInstanceEntry, scsiIntrDevTable=scsiIntrDevTable, scsiAttTgtPortName=scsiAttTgtPortName, scsiConformance=scsiConformance, scsiGeneral=scsiGeneral, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDevicePortNumber=scsiDevicePortNumber, scsiModule=scsiModule, ScsiIdValue=ScsiIdValue, scsiLuIdIndex=scsiLuIdIndex, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdAssociation=ScsiIdAssociation, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiDeviceAlias=scsiDeviceAlias, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiTgtPortName=scsiTgtPortName, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatusChanged=scsiLuStatusChanged, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiIntrDevEntry=scsiIntrDevEntry, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstVendorVersion=scsiInstVendorVersion, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiCompliance=scsiCompliance, scsiDeviceResets=scsiDeviceResets, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthIntrName=scsiAuthIntrName, scsiLunMapTable=scsiLunMapTable, scsiDeviceRole=scsiDeviceRole, scsiLuInResets=scsiLuInResets, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiDeviceStatGroup=scsiDeviceStatGroup, ScsiName=ScsiName, scsiPortTable=scsiPortTable, scsiDscTgtTable=scsiDscTgtTable, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiNotifications=scsiNotifications, scsiTrnsptPointer=scsiTrnsptPointer, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiPortRole=scsiPortRole, scsiLuDefaultLun=scsiLuDefaultLun, scsiLuVendorId=scsiLuVendorId, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiIntrPrtName=scsiIntrPrtName, scsiIntrPrtTable=scsiIntrPrtTable, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdType=ScsiIdType)
