...
Counter32, Counter64, TimeTicks, Integer32, NotificationType, Gauge32, Bits, mib_2, iso, MibIdentifier, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "Bits", "mib-2", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32")
RowPointer, TruthValue, RowStatus, DisplayString, AutonomousType, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TruthValue", "RowStatus", "DisplayString", "AutonomousType", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiCompliances=scsiCompliances, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiTargetGroup=scsiTargetGroup, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiTgtDevEntry=scsiTgtDevEntry, ScsiIdType=ScsiIdType, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiLuIdAssociation=scsiLuIdAssociation, scsiTgtPortTable=scsiTgtPortTable, ScsiName=ScsiName, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, ScsiIdentifier=ScsiIdentifier, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiInitiatorGroup=scsiInitiatorGroup, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrPrtName=scsiIntrPrtName, scsiLuIdEntry=scsiLuIdEntry, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiTgtDevTable=scsiTgtDevTable, PYSNMP_MODULE_ID=scsiModule, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiLunMapTable=scsiLunMapTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdValue=scsiLuIdValue, scsiDscLunIdValue=scsiDscLunIdValue, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDeviceResets=scsiDeviceResets, scsiDeviceAlias=scsiDeviceAlias, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiDscTgtEntry=scsiDscTgtEntry, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, ScsiIndexValue=ScsiIndexValue, scsiLuStatusChanged=scsiLuStatusChanged, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiLuHSInCommands=scsiLuHSInCommands, scsiInstAlias=scsiInstAlias, ScsiIdAssociation=ScsiIdAssociation, scsiLunMapLun=scsiLunMapLun, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiIntrDevTable=scsiIntrDevTable, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiLuProductId=scsiLuProductId, scsiLunMapGroup=scsiLunMapGroup, scsiTransportSBP=scsiTransportSBP, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiTransportSRP=scsiTransportSRP, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstIndex=scsiInstIndex, scsiLunMapEntry=scsiLunMapEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiTrnsptTable=scsiTrnsptTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiPortTable=scsiPortTable, scsiTrnsptDevName=scsiTrnsptDevName, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiTransportTypes=scsiTransportTypes, scsiDscTgtIndex=scsiDscTgtIndex, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiAttTgtPortName=scsiAttTgtPortName, scsiTranportSPI=scsiTranportSPI, scsiTrnsptType=scsiTrnsptType, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiInstanceTable=scsiInstanceTable, scsiDscLunIdTable=scsiDscLunIdTable, scsiAuthIntrName=scsiAuthIntrName, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortName=scsiTgtPortName, scsiRemoteInitiators=scsiRemoteInitiators, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiLuPeripheralType=scsiLuPeripheralType, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiDscLunIdAssociation=scsiDscLunIdAssociation, ScsiIdValue=ScsiIdValue, scsiPortIndex=scsiPortIndex, scsiObjects=scsiObjects, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiIdCodeSet=ScsiIdCodeSet, scsiLogicalUnit=scsiLogicalUnit, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiConformance=scsiConformance, scsiGroups=scsiGroups, scsiLuInResets=scsiLuInResets, scsiCompliance=scsiCompliance, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiDeviceIndex=scsiDeviceIndex, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiLuInCommands=scsiLuInCommands, scsiLuWwnName=scsiLuWwnName, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiInstanceEntry=scsiInstanceEntry, scsiLuIdTable=scsiLuIdTable, scsiGeneral=scsiGeneral, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiModule=scsiModule, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiDeviceTable=scsiDeviceTable, scsiLuIdType=scsiLuIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiLunMapIndex=scsiLunMapIndex, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiPortEntry=scsiPortEntry, scsiTrnsptIndex=scsiTrnsptIndex, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiIntrPrtTable=scsiIntrPrtTable, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortEntry=scsiTgtPortEntry, scsiTarget=scsiTarget, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiDscLunIdType=scsiDscLunIdType, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiDscLunIndex=scsiDscLunIndex, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTrnsptPointer=scsiTrnsptPointer, scsiLuIndex=scsiLuIndex, scsiRemoteTarget=scsiRemoteTarget, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLuState=scsiLuState, scsiInstVendorVersion=scsiInstVendorVersion, scsiTranportOther=scsiTranportOther, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuDefaultLun=scsiLuDefaultLun, scsiDeviceRole=scsiDeviceRole, scsiLuTable=scsiLuTable, scsiDeviceGroup=scsiDeviceGroup, scsiNotifications=scsiNotifications, scsiDscLunLun=scsiDscLunLun, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiLuIdIndex=scsiLuIdIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiDscTgtTable=scsiDscTgtTable, scsiLuRevisionId=scsiLuRevisionId, scsiLuEntry=scsiLuEntry, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiDscLunEntry=scsiDscLunEntry, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, scsiLuStatus=scsiLuStatus, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiTransportFCP=scsiTransportFCP, scsiLuVendorId=scsiLuVendorId, scsiInitiator=scsiInitiator, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiDscTgtName=scsiDscTgtName, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscLunTable=scsiDscLunTable, scsiNotificationsPrefix=scsiNotificationsPrefix, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiTrnsptEntry=scsiTrnsptEntry, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry)
