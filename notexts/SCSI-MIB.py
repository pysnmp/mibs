...
Unsigned32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, ObjectIdentity, NotificationType, TimeTicks, Counter32, MibIdentifier, iso, Bits, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "IpAddress")
DisplayString, TimeStamp, TextualConvention, AutonomousType, RowStatus, RowPointer, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus", "RowPointer", "TruthValue")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiInstIndex=scsiInstIndex, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiCompliances=scsiCompliances, ScsiLUNOrZero=ScsiLUNOrZero, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiPortTable=scsiPortTable, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiDeviceTable=scsiDeviceTable, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiDscLunIdTable=scsiDscLunIdTable, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiRemoteInitiators=scsiRemoteInitiators, scsiLuVendorId=scsiLuVendorId, scsiLunMapLun=scsiLunMapLun, scsiLuIdAssociation=scsiLuIdAssociation, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiInstVendorVersion=scsiInstVendorVersion, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscLunIdValue=scsiDscLunIdValue, scsiTrnsptDevName=scsiTrnsptDevName, scsiInstanceEntry=scsiInstanceEntry, scsiLuProductId=scsiLuProductId, scsiLuState=scsiLuState, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrDevTable=scsiIntrDevTable, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiPortRole=scsiPortRole, scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdValue=scsiLuIdValue, scsiDscTgtIndex=scsiDscTgtIndex, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiLunMapEntry=scsiLunMapEntry, scsiTrnsptTable=scsiTrnsptTable, ScsiIndexValue=ScsiIndexValue, scsiLuPeripheralType=scsiLuPeripheralType, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiLuInResets=scsiLuInResets, scsiDeviceRole=scsiDeviceRole, scsiLunMapIndex=scsiLunMapIndex, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiTransportSBP=scsiTransportSBP, scsiCompliance=scsiCompliance, scsiTgtDevEntry=scsiTgtDevEntry, scsiTgtPortIdentifier=scsiTgtPortIdentifier, PYSNMP_MODULE_ID=scsiModule, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiAttTgtPortName=scsiAttTgtPortName, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiConformance=scsiConformance, scsiDscLunTable=scsiDscLunTable, ScsiName=ScsiName, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, ScsiIdType=ScsiIdType, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiNotifications=scsiNotifications, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, scsiTransportFCP=scsiTransportFCP, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiTgtPortTable=scsiTgtPortTable, scsiLuStatus=scsiLuStatus, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiTrnsptEntry=scsiTrnsptEntry, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiLuIdEntry=scsiLuIdEntry, scsiInitiator=scsiInitiator, scsiTransportTypes=scsiTransportTypes, scsiDeviceIndex=scsiDeviceIndex, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, scsiLuInCommands=scsiLuInCommands, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiDeviceResets=scsiDeviceResets, scsiTgtPortName=scsiTgtPortName, scsiTransportISCSI=scsiTransportISCSI, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiInstanceTable=scsiInstanceTable, scsiIntrDevEntry=scsiIntrDevEntry, scsiTranportOther=scsiTranportOther, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiTarget=scsiTarget, scsiDevicePortNumber=scsiDevicePortNumber, scsiPortEntry=scsiPortEntry, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapGroup=scsiLunMapGroup, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiTransportSRP=scsiTransportSRP, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiDeviceAlias=scsiDeviceAlias, scsiRemoteTarget=scsiRemoteTarget, ScsiIdCodeSet=ScsiIdCodeSet, scsiIntrPrtName=scsiIntrPrtName, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiDscLunLun=scsiDscLunLun, scsiIntrPrtTable=scsiIntrPrtTable, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiTgtPortEntry=scsiTgtPortEntry, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiTrnsptType=scsiTrnsptType, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiLuDefaultLun=scsiLuDefaultLun, scsiLunMapTable=scsiLunMapTable, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiLuIdIndex=scsiLuIdIndex, scsiLuIdType=scsiLuIdType, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiTargetGroup=scsiTargetGroup, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiDscLunIdType=scsiDscLunIdType, scsiDscLunEntry=scsiDscLunEntry, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLuHSInCommands=scsiLuHSInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiLuEntry=scsiLuEntry, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiTrnsptIndex=scsiTrnsptIndex, scsiGroups=scsiGroups, scsiLuStatusChanged=scsiLuStatusChanged, scsiInitiatorGroup=scsiInitiatorGroup, scsiDscTgtEntry=scsiDscTgtEntry, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiInstAlias=scsiInstAlias, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiGeneral=scsiGeneral, scsiLuIdTable=scsiLuIdTable, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAuthIntrName=scsiAuthIntrName, scsiModule=scsiModule, ScsiIdentifier=ScsiIdentifier, scsiDscLunIndex=scsiDscLunIndex, scsiLogicalUnit=scsiLogicalUnit, scsiLuWwnName=scsiLuWwnName, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, ScsiIdValue=ScsiIdValue, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiDeviceEntry=scsiDeviceEntry, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuTable=scsiLuTable, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiTranportSPI=scsiTranportSPI, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTrnsptPointer=scsiTrnsptPointer, ScsiIdAssociation=ScsiIdAssociation, scsiLuIndex=scsiLuIndex, scsiDscTgtName=scsiDscTgtName, scsiObjects=scsiObjects, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiPortIndex=scsiPortIndex, scsiLuRevisionId=scsiLuRevisionId, scsiTgtDevTable=scsiTgtDevTable)
