...
iso, Gauge32, mib_2, IpAddress, NotificationType, TimeTicks, ModuleIdentity, Counter64, Bits, ObjectIdentity, MibIdentifier, Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "mib-2", "IpAddress", "NotificationType", "TimeTicks", "ModuleIdentity", "Counter64", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, TimeStamp, RowStatus, RowPointer, TruthValue, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "RowPointer", "TruthValue", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("SCSI-MIB", scsiDscTgtRowStatus=scsiDscTgtRowStatus, scsiLuIdAssociation=scsiLuIdAssociation, scsiPortEntry=scsiPortEntry, scsiPortIndex=scsiPortIndex, scsiDeviceStatGroup=scsiDeviceStatGroup, scsiAuthIntrAttachedTimes=scsiAuthIntrAttachedTimes, scsiIntrPrtOutCommands=scsiIntrPrtOutCommands, scsiTransportTypes=scsiTransportTypes, PYSNMP_MODULE_ID=scsiModule, scsiDscLunIdValue=scsiDscLunIdValue, scsiDeviceTable=scsiDeviceTable, scsiInstScsiNotificationsEnable=scsiInstScsiNotificationsEnable, scsiTgtDevNonAccessibleLUs=scsiTgtDevNonAccessibleLUs, scsiLunMapHSStatsGroup=scsiLunMapHSStatsGroup, HrSWInstalledIndexOrZero=HrSWInstalledIndexOrZero, scsiIntrDevOutResets=scsiIntrDevOutResets, scsiDscTgtIndex=scsiDscTgtIndex, scsiLuStatusChanged=scsiLuStatusChanged, ScsiLUNOrZero=ScsiLUNOrZero, scsiTransportSRP=scsiTransportSRP, scsiDscLunIdEntry=scsiDscLunIdEntry, scsiDscTgtLastCreation=scsiDscTgtLastCreation, scsiAuthorizedIntrEntry=scsiAuthorizedIntrEntry, scsiAttIntrPrtName=scsiAttIntrPrtName, scsiLuIdType=scsiLuIdType, scsiLuProductId=scsiLuProductId, scsiAuthIntrLunMapIndex=scsiAuthIntrLunMapIndex, scsiIntrPrtIdentifier=scsiIntrPrtIdentifier, scsiAttIntrPrtEntry=scsiAttIntrPrtEntry, scsiAuthIntrTgtPortIndex=scsiAuthIntrTgtPortIndex, scsiPortTrnsptPtr=scsiPortTrnsptPtr, scsiDeviceResets=scsiDeviceResets, scsiAuthIntrName=scsiAuthIntrName, scsiGeneral=scsiGeneral, scsiDscTgtHSInCommands=scsiDscTgtHSInCommands, scsiTgtPortReadMegaBytes=scsiTgtPortReadMegaBytes, scsiAttIntrPrtAuthIntrIdx=scsiAttIntrPrtAuthIntrIdx, scsiInstAlias=scsiInstAlias, scsiLuDefaultLun=scsiLuDefaultLun, scsiTarget=scsiTarget, ScsiIdAssociation=ScsiIdAssociation, scsiTgtPortWrittenMegaBytes=scsiTgtPortWrittenMegaBytes, scsiLunMapGroup=scsiLunMapGroup, ScsiIndexValue=ScsiIndexValue, scsiDscLunIdCodeSet=scsiDscLunIdCodeSet, scsiTransportSBP=scsiTransportSBP, scsiTranportOther=scsiTranportOther, scsiTargetHSStatsGroup=scsiTargetHSStatsGroup, scsiDscTgtReadMegaBytes=scsiDscTgtReadMegaBytes, scsiLuWrittenMegaBytes=scsiLuWrittenMegaBytes, ScsiPortIndexValueOrZero=ScsiPortIndexValueOrZero, scsiDiscoveryGroup=scsiDiscoveryGroup, scsiTargetStatsGroup=scsiTargetStatsGroup, scsiLuIdValue=scsiLuIdValue, scsiAttTgtPortTable=scsiAttTgtPortTable, scsiDscTgtName=scsiDscTgtName, scsiLunMapRowStatus=scsiLunMapRowStatus, scsiAttTgtPortDscTgtIdx=scsiAttTgtPortDscTgtIdx, scsiTgtPortTable=scsiTgtPortTable, scsiInstSoftwareIndex=scsiInstSoftwareIndex, scsiAttIntrPrtIdx=scsiAttIntrPrtIdx, scsiLuHSInCommands=scsiLuHSInCommands, scsiDiscoveryStatsGroup=scsiDiscoveryStatsGroup, scsiTgtDeviceStatus=scsiTgtDeviceStatus, scsiDscTgtDevOrPort=scsiDscTgtDevOrPort, scsiLuIdCodeSet=scsiLuIdCodeSet, scsiDscLunIdIndex=scsiDscLunIdIndex, scsiInstIndex=scsiInstIndex, scsiLuState=scsiLuState, scsiLuReadMegaBytes=scsiLuReadMegaBytes, scsiConformance=scsiConformance, ScsiName=ScsiName, scsiIntrPrtReadMegaBytes=scsiIntrPrtReadMegaBytes, scsiDscLunIdAssociation=scsiDscLunIdAssociation, scsiTgtPortIdentifier=scsiTgtPortIdentifier, scsiLuRevisionId=scsiLuRevisionId, scsiAttTgtPortIdentifier=scsiAttTgtPortIdentifier, scsiInitiatorHSStatsGroup=scsiInitiatorHSStatsGroup, scsiLuStatus=scsiLuStatus, ScsiIdentifier=ScsiIdentifier, scsiDscTgtInCommands=scsiDscTgtInCommands, scsiLunMapLuIndex=scsiLunMapLuIndex, scsiAttTgtPortIndex=scsiAttTgtPortIndex, scsiTgtDevEntry=scsiTgtDevEntry, scsiLogicalUnit=scsiLogicalUnit, scsiAuthorizedIntrTable=scsiAuthorizedIntrTable, ScsiIdType=ScsiIdType, scsiDscTgtEntry=scsiDscTgtEntry, scsiNotificationsPrefix=scsiNotificationsPrefix, scsiAttIntrPrtTable=scsiAttIntrPrtTable, scsiTgtPortHSInCommands=scsiTgtPortHSInCommands, scsiTgtDevNumberOfLUs=scsiTgtDevNumberOfLUs, scsiTgtDeviceStatusChanged=scsiTgtDeviceStatusChanged, scsiTrnsptTable=scsiTrnsptTable, scsiDscLunIdType=scsiDscLunIdType, scsiLuEntry=scsiLuEntry, scsiTrnsptType=scsiTrnsptType, scsiTgtPortInCommands=scsiTgtPortInCommands, scsiLuPeripheralType=scsiLuPeripheralType, scsiDevicePortNumber=scsiDevicePortNumber, scsiIntrDevTable=scsiIntrDevTable, scsiLuIndex=scsiLuIndex, scsiLuOutQueueFullStatus=scsiLuOutQueueFullStatus, ScsiIndexValueOrZero=ScsiIndexValueOrZero, scsiDiscoveryHSStatsGroup=scsiDiscoveryHSStatsGroup, scsiLuVendorId=scsiLuVendorId, ScsiIdValue=ScsiIdValue, scsiInstanceEntry=scsiInstanceEntry, scsiTrnsptDevName=scsiTrnsptDevName, scsiAuthIntrReadMegaBytes=scsiAuthIntrReadMegaBytes, scsiInitiator=scsiInitiator, scsiTransportFCP=scsiTransportFCP, scsiDeviceEntry=scsiDeviceEntry, scsiAuthIntrWrittenMegaBytes=scsiAuthIntrWrittenMegaBytes, scsiIntrDevTgtAccessMode=scsiIntrDevTgtAccessMode, scsiGroups=scsiGroups, scsiLuIdTable=scsiLuIdTable, scsiTrnsptEntry=scsiTrnsptEntry, scsiTrnsptPointer=scsiTrnsptPointer, scsiAuthIntrHSOutCommands=scsiAuthIntrHSOutCommands, scsiIntrPrtHSOutCommands=scsiIntrPrtHSOutCommands, scsiInstanceTable=scsiInstanceTable, scsiInitiatorGroup=scsiInitiatorGroup, scsiAttTgtPortEntry=scsiAttTgtPortEntry, scsiTgtDevTable=scsiTgtDevTable, scsiIntrPrtName=scsiIntrPrtName, scsiTranportSPI=scsiTranportSPI, scsiLuWwnName=scsiLuWwnName, scsiDscLunLun=scsiDscLunLun, scsiDscTgtConfigured=scsiDscTgtConfigured, scsiLunMapIndex=scsiLunMapIndex, scsiAuthIntrOutCommands=scsiAuthIntrOutCommands, scsiDscLunIndex=scsiDscLunIndex, scsiLuIdEntry=scsiLuIdEntry, ScsiDeviceOrPort=ScsiDeviceOrPort, scsiDscLunEntry=scsiDscLunEntry, scsiLunMapEntry=scsiLunMapEntry, scsiAttTgtPortName=scsiAttTgtPortName, scsiIntrPrtWrittenMegaBytes=scsiIntrPrtWrittenMegaBytes, scsiTgtPortEntry=scsiTgtPortEntry, scsiDscLunIdTable=scsiDscLunIdTable, scsiIntrPrtEntry=scsiIntrPrtEntry, scsiDeviceGroup=scsiDeviceGroup, scsiDscTgtDiscovered=scsiDscTgtDiscovered, scsiDeviceAlias=scsiDeviceAlias, scsiAuthIntrIndex=scsiAuthIntrIndex, scsiModule=scsiModule, scsiTgtPortName=scsiTgtPortName, scsiDscTgtTable=scsiDscTgtTable, scsiAuthIntrDevOrPort=scsiAuthIntrDevOrPort, scsiIntrDevEntry=scsiIntrDevEntry, scsiAuthIntrLastCreation=scsiAuthIntrLastCreation, scsiLuTable=scsiLuTable, scsiTargetGroup=scsiTargetGroup, scsiInitiatorStatsGroup=scsiInitiatorStatsGroup, ScsiIdCodeSet=ScsiIdCodeSet, scsiDeviceIndex=scsiDeviceIndex, scsiLuInResets=scsiLuInResets, scsiLuIdIndex=scsiLuIdIndex, scsiDscTgtWrittenMegaBytes=scsiDscTgtWrittenMegaBytes, scsiLuInCommands=scsiLuInCommands, scsiIntrPrtTable=scsiIntrPrtTable, scsiTransportISCSI=scsiTransportISCSI, scsiLunMapTable=scsiLunMapTable, scsiObjects=scsiObjects, scsiPortBusyStatuses=scsiPortBusyStatuses, scsiPortTable=scsiPortTable, scsiAttIntrPrtId=scsiAttIntrPrtId, scsiNotifications=scsiNotifications, scsiDeviceRole=scsiDeviceRole, scsiRemoteTarget=scsiRemoteTarget, scsiRemoteInitiators=scsiRemoteInitiators, scsiCompliance=scsiCompliance, scsiLunMapStatsGroup=scsiLunMapStatsGroup, scsiDscLunTable=scsiDscLunTable, scsiPortRole=scsiPortRole, scsiLunMapLun=scsiLunMapLun, ScsiNameIdOrZero=ScsiNameIdOrZero, scsiInstVendorVersion=scsiInstVendorVersion, scsiCompliances=scsiCompliances, scsiAuthIntrRowStatus=scsiAuthIntrRowStatus, scsiDscTgtIntrPortIndex=scsiDscTgtIntrPortIndex, scsiTrnsptIndex=scsiTrnsptIndex)
