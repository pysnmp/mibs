...
RowStatus, TextualConvention, PhysAddress, TestAndIncr, DisplayString, TruthValue, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "PhysAddress", "TestAndIncr", "DisplayString", "TruthValue", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifNumber=ifNumber, ifTestId=ifTestId, ifOperStatus=ifOperStatus, ifXEntry=ifXEntry, linkDown=linkDown, ifMIB=ifMIB, ifDescr=ifDescr, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, ifTestStatus=ifTestStatus, ifOutOctets=ifOutOctets, ifMIBObjects=ifMIBObjects, ifMtu=ifMtu, ifType=ifType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressStatus=ifRcvAddressStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifStackTable=ifStackTable, ifFixedLengthGroup=ifFixedLengthGroup, ifTestEntry=ifTestEntry, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance2=ifCompliance2, PYSNMP_MODULE_ID=ifMIB, ifHCInOctets=ifHCInOctets, ifIndex=ifIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, interfaces=interfaces, ifInUnknownProtos=ifInUnknownProtos, ifTestGroup=ifTestGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifAdminStatus=ifAdminStatus, ifOutQLen=ifOutQLen, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressType=ifRcvAddressType, ifConformance=ifConformance, ifInOctets=ifInOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifConnectorPresent=ifConnectorPresent, ifCompliance=ifCompliance, ifTestTable=ifTestTable, ifEntry=ifEntry, ifXTable=ifXTable, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHighSpeed=ifHighSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance3=ifCompliance3, ifName=ifName, InterfaceIndex=InterfaceIndex, ifOutUcastPkts=ifOutUcastPkts, linkUp=linkUp, ifRcvAddressGroup=ifRcvAddressGroup, ifStackEntry=ifStackEntry, ifTableLastChange=ifTableLastChange, ifTestOwner=ifTestOwner, ifInBroadcastPkts=ifInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInDiscards=ifInDiscards, ifSpecific=ifSpecific, ifStackStatus=ifStackStatus, ifPhysAddress=ifPhysAddress, ifRcvAddressEntry=ifRcvAddressEntry, ifGroups=ifGroups, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutOctets=ifHCOutOctets, ifTestCode=ifTestCode, ifSpeed=ifSpeed, ifInMulticastPkts=ifInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTable=ifTable, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifCompliances=ifCompliances, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifLastChange=ifLastChange, ifInErrors=ifInErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts)
