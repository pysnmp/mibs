...
TruthValue, DisplayString, TextualConvention, TimeStamp, RowStatus, AutonomousType, TestAndIncr, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus", "AutonomousType", "TestAndIncr", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup=ifStackGroup, ifGroups=ifGroups, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTable=ifTable, linkUp=linkUp, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifCompliances=ifCompliances, ifRcvAddressEntry=ifRcvAddressEntry, linkDown=linkDown, ifPacketGroup=ifPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTestType=ifTestType, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifIndex=ifIndex, ifSpecific=ifSpecific, ifTestStatus=ifTestStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInUcastPkts=ifHCInUcastPkts, ifPhysAddress=ifPhysAddress, ifRcvAddressType=ifRcvAddressType, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestEntry=ifTestEntry, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifType=ifType, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, ifTestId=ifTestId, ifHCInOctets=ifHCInOctets, ifTestOwner=ifTestOwner, ifRcvAddressGroup=ifRcvAddressGroup, ifXTable=ifXTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLastChange=ifStackLastChange, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackTable=ifStackTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifOperStatus=ifOperStatus, ifInOctets=ifInOctets, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifHCOutOctets=ifHCOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPromiscuousMode=ifPromiscuousMode, ifCompliance=ifCompliance, ifInMulticastPkts=ifInMulticastPkts, InterfaceIndex=InterfaceIndex, ifTableLastChange=ifTableLastChange, ifTestCode=ifTestCode, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, interfaces=interfaces, ifEntry=ifEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifSpeed=ifSpeed, ifXEntry=ifXEntry, ifOutUcastPkts=ifOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifOutDiscards=ifOutDiscards, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifLastChange=ifLastChange, ifAdminStatus=ifAdminStatus, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, ifMIB=ifMIB, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, PYSNMP_MODULE_ID=ifMIB, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConformance=ifConformance, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAlias=ifAlias, ifInNUcastPkts=ifInNUcastPkts, ifTestGroup=ifTestGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup)
