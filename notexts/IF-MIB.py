...
RowStatus, TestAndIncr, TruthValue, AutonomousType, TimeStamp, PhysAddress, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TestAndIncr", "TruthValue", "AutonomousType", "TimeStamp", "PhysAddress", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCPacketGroup=ifHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAdminStatus=ifAdminStatus, ifInNUcastPkts=ifInNUcastPkts, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifStackStatus=ifStackStatus, ifCompliance3=ifCompliance3, ifIndex=ifIndex, ifTestId=ifTestId, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, interfaces=interfaces, ifRcvAddressEntry=ifRcvAddressEntry, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifTestTable=ifTestTable, linkDown=linkDown, ifRcvAddressGroup=ifRcvAddressGroup, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifSpeed=ifSpeed, PYSNMP_MODULE_ID=ifMIB, ifPhysAddress=ifPhysAddress, ifStackLastChange=ifStackLastChange, ifHCOutOctets=ifHCOutOctets, ifTestEntry=ifTestEntry, ifOperStatus=ifOperStatus, ifXEntry=ifXEntry, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifStackHigherLayer=ifStackHigherLayer, ifTestGroup=ifTestGroup, ifInOctets=ifInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMIB=ifMIB, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTable=ifTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifNumber=ifNumber, ifInMulticastPkts=ifInMulticastPkts, ifTestResult=ifTestResult, ifRcvAddressAddress=ifRcvAddressAddress, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance=ifCompliance, ifTestStatus=ifTestStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup2=ifStackGroup2, ifOutUcastPkts=ifOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifTestType=ifTestType, ifEntry=ifEntry, ifAlias=ifAlias, ifMIBObjects=ifMIBObjects, ifStackGroup=ifStackGroup, ifOutErrors=ifOutErrors, ifRcvAddressTable=ifRcvAddressTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConformance=ifConformance, ifName=ifName, ifCompliance2=ifCompliance2, ifVHCPacketGroup=ifVHCPacketGroup, OwnerString=OwnerString, ifOldObjectsGroup=ifOldObjectsGroup, ifType=ifType, ifConnectorPresent=ifConnectorPresent, ifPacketGroup=ifPacketGroup, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, ifStackEntry=ifStackEntry, linkUp=linkUp, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifInBroadcastPkts=ifInBroadcastPkts)
