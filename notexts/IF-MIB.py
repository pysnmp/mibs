...
NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Unsigned32, Bits, IpAddress, TimeTicks, MibIdentifier, Counter32, Integer32, Counter64, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Unsigned32", "Bits", "IpAddress", "TimeTicks", "MibIdentifier", "Counter32", "Integer32", "Counter64", "iso", "ModuleIdentity")
DisplayString, AutonomousType, RowStatus, TimeStamp, PhysAddress, TestAndIncr, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp", "PhysAddress", "TestAndIncr", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliances=ifCompliances, ifTestId=ifTestId, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifNumber=ifNumber, ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackEntry=ifStackEntry, ifGroups=ifGroups, ifEntry=ifEntry, ifMtu=ifMtu, ifPacketGroup=ifPacketGroup, ifSpeed=ifSpeed, ifHighSpeed=ifHighSpeed, ifTestResult=ifTestResult, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifOutNUcastPkts=ifOutNUcastPkts, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutOctets=ifOutOctets, ifLastChange=ifLastChange, ifStackStatus=ifStackStatus, linkDown=linkDown, interfaces=interfaces, ifInDiscards=ifInDiscards, ifInUcastPkts=ifInUcastPkts, ifStackGroup=ifStackGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOperStatus=ifOperStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInOctets=ifInOctets, ifStackHigherLayer=ifStackHigherLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, InterfaceIndex=InterfaceIndex, ifDescr=ifDescr, ifCompliance3=ifCompliance3, ifStackTable=ifStackTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCPacketGroup=ifHCPacketGroup, ifConformance=ifConformance, ifRcvAddressAddress=ifRcvAddressAddress, ifName=ifName, ifIndex=ifIndex, ifCompliance=ifCompliance, ifTestType=ifTestType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressStatus=ifRcvAddressStatus, ifTestTable=ifTestTable, ifMIB=ifMIB, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifConnectorPresent=ifConnectorPresent, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifTestGroup=ifTestGroup, ifStackGroup2=ifStackGroup2, ifPhysAddress=ifPhysAddress, ifXEntry=ifXEntry, ifType=ifType, ifHCInOctets=ifHCInOctets, PYSNMP_MODULE_ID=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifTestStatus=ifTestStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance2=ifCompliance2, ifOutDiscards=ifOutDiscards, ifSpecific=ifSpecific, ifOldObjectsGroup=ifOldObjectsGroup, ifTable=ifTable, ifInUnknownProtos=ifInUnknownProtos, ifHCOutOctets=ifHCOutOctets, ifMIBObjects=ifMIBObjects, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifXTable=ifXTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTableLastChange=ifTableLastChange, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, ifInNUcastPkts=ifInNUcastPkts, ifStackLastChange=ifStackLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifOutErrors=ifOutErrors, ifInErrors=ifInErrors, ifAdminStatus=ifAdminStatus)
