...
DisplayString, RowStatus, TestAndIncr, TextualConvention, TruthValue, TimeStamp, AutonomousType, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TestAndIncr", "TextualConvention", "TruthValue", "TimeStamp", "AutonomousType", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMIB=ifMIB, ifXTable=ifXTable, ifInBroadcastPkts=ifInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifStackTable=ifStackTable, ifInUcastPkts=ifInUcastPkts, ifTestGroup=ifTestGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifTableLastChange=ifTableLastChange, ifStackGroup=ifStackGroup, ifInDiscards=ifInDiscards, ifTestType=ifTestType, ifCompliance2=ifCompliance2, ifStackHigherLayer=ifStackHigherLayer, ifIndex=ifIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInOctets=ifInOctets, ifDescr=ifDescr, linkDown=linkDown, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, ifTestCode=ifTestCode, ifCompliances=ifCompliances, ifStackGroup2=ifStackGroup2, ifXEntry=ifXEntry, ifEntry=ifEntry, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifTestTable=ifTestTable, ifLastChange=ifLastChange, ifAdminStatus=ifAdminStatus, ifRcvAddressTable=ifRcvAddressTable, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifConformance=ifConformance, ifGeneralGroup=ifGeneralGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutOctets=ifHCOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutErrors=ifOutErrors, ifType=ifType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestEntry=ifTestEntry, ifInNUcastPkts=ifInNUcastPkts, interfaces=interfaces, ifStackLowerLayer=ifStackLowerLayer, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpeed=ifSpeed, ifCompliance3=ifCompliance3, OwnerString=OwnerString, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance=ifCompliance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, PYSNMP_MODULE_ID=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifStackLastChange=ifStackLastChange, ifHighSpeed=ifHighSpeed, ifVHCPacketGroup=ifVHCPacketGroup, ifStackStatus=ifStackStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestOwner=ifTestOwner, ifTestId=ifTestId, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, linkUp=linkUp, ifHCInOctets=ifHCInOctets, ifSpecific=ifSpecific, ifPhysAddress=ifPhysAddress, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifGroups=ifGroups, ifOutNUcastPkts=ifOutNUcastPkts, ifInErrors=ifInErrors, ifNumber=ifNumber, ifOutDiscards=ifOutDiscards, ifTestResult=ifTestResult, ifTestStatus=ifTestStatus, ifOutQLen=ifOutQLen)
