...
mib_2, Counter64, IpAddress, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, iso, Gauge32, Integer32, ObjectIdentity, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "iso", "Gauge32", "Integer32", "ObjectIdentity", "Bits", "ModuleIdentity")
TimeStamp, PhysAddress, RowStatus, TextualConvention, DisplayString, TruthValue, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifNumber=ifNumber, ifTestResult=ifTestResult, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifEntry=ifEntry, ifTestEntry=ifTestEntry, ifPromiscuousMode=ifPromiscuousMode, ifConformance=ifConformance, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup=ifStackGroup, ifOutDiscards=ifOutDiscards, ifMtu=ifMtu, ifStackHigherLayer=ifStackHigherLayer, ifTableLastChange=ifTableLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLastChange=ifStackLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackTable=ifStackTable, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifPacketGroup=ifPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUp=linkUp, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifRcvAddressGroup=ifRcvAddressGroup, interfaces=interfaces, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifGeneralGroup=ifGeneralGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestCode=ifTestCode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXEntry=ifXEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpeed=ifSpeed, ifHCInOctets=ifHCInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackGroup2=ifStackGroup2, ifCompliance2=ifCompliance2, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance=ifCompliance, ifCompliances=ifCompliances, ifCompliance3=ifCompliance3, ifMIBObjects=ifMIBObjects, ifXTable=ifXTable, ifOutQLen=ifOutQLen, ifHCPacketGroup=ifHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifStackEntry=ifStackEntry, ifTestType=ifTestType, ifTestStatus=ifTestStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifDescr=ifDescr, ifTestId=ifTestId, ifGroups=ifGroups, ifType=ifType, ifLastChange=ifLastChange, ifTable=ifTable, ifTestTable=ifTestTable, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifPhysAddress=ifPhysAddress, ifOutErrors=ifOutErrors, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifIndex=ifIndex, ifSpecific=ifSpecific, ifInUcastPkts=ifInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifInErrors=ifInErrors, ifTestOwner=ifTestOwner, ifMIB=ifMIB, ifAdminStatus=ifAdminStatus)
