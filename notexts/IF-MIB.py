...
TimeStamp, TextualConvention, PhysAddress, DisplayString, AutonomousType, RowStatus, TruthValue, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "PhysAddress", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifNumber=ifNumber, ifInUcastPkts=ifInUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifPromiscuousMode=ifPromiscuousMode, ifFixedLengthGroup=ifFixedLengthGroup, ifMtu=ifMtu, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifInOctets=ifInOctets, ifStackLowerLayer=ifStackLowerLayer, ifAdminStatus=ifAdminStatus, ifStackTable=ifStackTable, ifSpecific=ifSpecific, ifOperStatus=ifOperStatus, ifCompliance3=ifCompliance3, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, ifOutQLen=ifOutQLen, ifCompliance=ifCompliance, ifTestOwner=ifTestOwner, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifHCOutOctets=ifHCOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifPacketGroup=ifPacketGroup, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestType=ifTestType, ifVHCPacketGroup=ifVHCPacketGroup, ifGeneralGroup=ifGeneralGroup, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestStatus=ifTestStatus, interfaces=interfaces, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifEntry=ifEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutOctets=ifOutOctets, InterfaceIndex=InterfaceIndex, ifTestId=ifTestId, ifConformance=ifConformance, ifXEntry=ifXEntry, ifCompliances=ifCompliances, ifTestEntry=ifTestEntry, ifOutErrors=ifOutErrors, ifIndex=ifIndex, ifTestResult=ifTestResult, ifTestCode=ifTestCode, ifHighSpeed=ifHighSpeed, ifXTable=ifXTable, ifTestTable=ifTestTable, ifStackHigherLayer=ifStackHigherLayer, ifConnectorPresent=ifConnectorPresent, OwnerString=OwnerString, ifInDiscards=ifInDiscards, ifHCInUcastPkts=ifHCInUcastPkts, PYSNMP_MODULE_ID=ifMIB, linkUp=linkUp, ifType=ifType, linkDown=linkDown, ifName=ifName, ifRcvAddressType=ifRcvAddressType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutUcastPkts=ifOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTable=ifTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackGroup=ifStackGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup)
