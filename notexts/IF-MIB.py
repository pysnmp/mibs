...
TestAndIncr, DisplayString, PhysAddress, RowStatus, TimeStamp, TextualConvention, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "PhysAddress", "RowStatus", "TimeStamp", "TextualConvention", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutUcastPkts=ifOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifSpeed=ifSpeed, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, ifStackStatus=ifStackStatus, ifStackLastChange=ifStackLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressType=ifRcvAddressType, ifTestId=ifTestId, interfaces=interfaces, ifOutQLen=ifOutQLen, ifAlias=ifAlias, ifOperStatus=ifOperStatus, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, ifPromiscuousMode=ifPromiscuousMode, ifPhysAddress=ifPhysAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance=ifCompliance, linkUp=linkUp, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance3=ifCompliance3, ifNumber=ifNumber, ifEntry=ifEntry, ifCompliance2=ifCompliance2, ifPacketGroup=ifPacketGroup, linkDown=linkDown, ifName=ifName, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralGroup=ifGeneralGroup, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInOctets=ifInOctets, ifAdminStatus=ifAdminStatus, ifTestType=ifTestType, ifTestTable=ifTestTable, ifOutNUcastPkts=ifOutNUcastPkts, ifIndex=ifIndex, ifMIBObjects=ifMIBObjects, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifTestStatus=ifTestStatus, ifTestOwner=ifTestOwner, ifStackGroup=ifStackGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifTableLastChange=ifTableLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGroups=ifGroups, ifXEntry=ifXEntry, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifInBroadcastPkts=ifInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifStackTable=ifStackTable, InterfaceIndex=InterfaceIndex, ifXTable=ifXTable, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifStackGroup2=ifStackGroup2, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifDescr=ifDescr, ifMIB=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifLastChange=ifLastChange, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHighSpeed=ifHighSpeed, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMtu=ifMtu, ifOutOctets=ifOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifHCPacketGroup=ifHCPacketGroup, ifHCInOctets=ifHCInOctets, ifTestCode=ifTestCode)
