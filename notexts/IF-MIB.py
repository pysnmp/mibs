...
NotificationType, Integer32, Unsigned32, Gauge32, TimeTicks, mib_2, Counter64, Counter32, IpAddress, iso, ModuleIdentity, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "TimeTicks", "mib-2", "Counter64", "Counter32", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TimeStamp, AutonomousType, DisplayString, TruthValue, PhysAddress, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString", "TruthValue", "PhysAddress", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifName=ifName, ifTable=ifTable, ifMIBObjects=ifMIBObjects, OwnerString=OwnerString, ifSpecific=ifSpecific, ifTestCode=ifTestCode, ifDescr=ifDescr, ifHCOutOctets=ifHCOutOctets, ifCompliance2=ifCompliance2, InterfaceIndex=InterfaceIndex, ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestOwner=ifTestOwner, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutOctets=ifOutOctets, ifCompliance=ifCompliance, ifOldObjectsGroup=ifOldObjectsGroup, ifXTable=ifXTable, ifGeneralGroup=ifGeneralGroup, ifTestType=ifTestType, ifTestId=ifTestId, interfaces=interfaces, ifAdminStatus=ifAdminStatus, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInErrors=ifInErrors, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifNumber=ifNumber, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifConformance=ifConformance, ifGroups=ifGroups, ifXEntry=ifXEntry, ifOutUcastPkts=ifOutUcastPkts, ifStackGroup2=ifStackGroup2, ifStackLastChange=ifStackLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifMtu=ifMtu, PYSNMP_MODULE_ID=ifMIB, ifStackStatus=ifStackStatus, ifTestGroup=ifTestGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifTableLastChange=ifTableLastChange, ifPromiscuousMode=ifPromiscuousMode, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifInMulticastPkts=ifInMulticastPkts, ifType=ifType, ifRcvAddressType=ifRcvAddressType, ifOperStatus=ifOperStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestEntry=ifTestEntry, ifHCPacketGroup=ifHCPacketGroup, ifHighSpeed=ifHighSpeed, ifInUnknownProtos=ifInUnknownProtos, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifConnectorPresent=ifConnectorPresent, linkUp=linkUp, ifTestStatus=ifTestStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifTestResult=ifTestResult, ifInUcastPkts=ifInUcastPkts, ifEntry=ifEntry, ifStackHigherLayer=ifStackHigherLayer, ifPhysAddress=ifPhysAddress, ifOutQLen=ifOutQLen, ifCompliance3=ifCompliance3, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup)
