...
TextualConvention, DisplayString, RowStatus, TimeStamp, TestAndIncr, AutonomousType, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TimeStamp", "TestAndIncr", "AutonomousType", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndex=InterfaceIndex, ifName=ifName, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, OwnerString=OwnerString, ifInBroadcastPkts=ifInBroadcastPkts, ifOperStatus=ifOperStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, ifOutMulticastPkts=ifOutMulticastPkts, ifAdminStatus=ifAdminStatus, linkDown=linkDown, ifPromiscuousMode=ifPromiscuousMode, ifHCInUcastPkts=ifHCInUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance2=ifCompliance2, ifXEntry=ifXEntry, ifTestCode=ifTestCode, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestId=ifTestId, ifTestStatus=ifTestStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifConnectorPresent=ifConnectorPresent, ifPacketGroup=ifPacketGroup, ifInOctets=ifInOctets, ifIndex=ifIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifMIB=ifMIB, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifType=ifType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpeed=ifSpeed, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifOutOctets=ifOutOctets, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifStackHigherLayer=ifStackHigherLayer, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifGroups=ifGroups, ifRcvAddressAddress=ifRcvAddressAddress, interfaces=interfaces, ifInDiscards=ifInDiscards, ifTestEntry=ifTestEntry, ifGeneralGroup=ifGeneralGroup, ifXTable=ifXTable, ifHCOutUcastPkts=ifHCOutUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInOctets=ifHCInOctets, ifTestTable=ifTestTable, ifConformance=ifConformance, ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifStackEntry=ifStackEntry, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifCompliances=ifCompliances, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifInErrors=ifInErrors, linkUp=linkUp, ifEntry=ifEntry, ifTable=ifTable, ifStackTable=ifStackTable, ifAlias=ifAlias, ifStackLowerLayer=ifStackLowerLayer, ifMtu=ifMtu, ifTableLastChange=ifTableLastChange, ifOutQLen=ifOutQLen, ifTestResult=ifTestResult, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifCompliance3=ifCompliance3)
