...
ObjectIdentity, NotificationType, TimeTicks, iso, MibIdentifier, Integer32, mib_2, Counter32, IpAddress, Unsigned32, Gauge32, Bits, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "iso", "MibIdentifier", "Integer32", "mib-2", "Counter32", "IpAddress", "Unsigned32", "Gauge32", "Bits", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TimeStamp, TestAndIncr, DisplayString, AutonomousType, PhysAddress, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TestAndIncr", "DisplayString", "AutonomousType", "PhysAddress", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifType=ifType, ifInNUcastPkts=ifInNUcastPkts, ifInErrors=ifInErrors, ifInUcastPkts=ifInUcastPkts, interfaces=interfaces, ifTestStatus=ifTestStatus, ifTestGroup=ifTestGroup, ifTestId=ifTestId, ifTestType=ifTestType, ifHCPacketGroup=ifHCPacketGroup, ifPhysAddress=ifPhysAddress, ifNumber=ifNumber, ifOutDiscards=ifOutDiscards, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGroups=ifGroups, ifOutQLen=ifOutQLen, ifRcvAddressStatus=ifRcvAddressStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifTestOwner=ifTestOwner, linkDown=linkDown, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestTable=ifTestTable, ifIndex=ifIndex, ifLastChange=ifLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressTable=ifRcvAddressTable, ifName=ifName, ifTable=ifTable, OwnerString=OwnerString, ifAlias=ifAlias, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifInMulticastPkts=ifInMulticastPkts, ifSpeed=ifSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, linkUp=linkUp, ifTestCode=ifTestCode, ifAdminStatus=ifAdminStatus, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, ifStackLastChange=ifStackLastChange, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, ifDescr=ifDescr, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPacketGroup=ifPacketGroup, ifCompliance2=ifCompliance2, ifHCInMulticastPkts=ifHCInMulticastPkts, ifEntry=ifEntry, ifPromiscuousMode=ifPromiscuousMode, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackEntry=ifStackEntry, ifStackGroup=ifStackGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutOctets=ifHCOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIBObjects=ifMIBObjects, ifCompliance=ifCompliance, ifMIB=ifMIB, ifXEntry=ifXEntry, ifInOctets=ifInOctets, ifRcvAddressEntry=ifRcvAddressEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifVHCPacketGroup=ifVHCPacketGroup, ifTableLastChange=ifTableLastChange, ifStackHigherLayer=ifStackHigherLayer, ifInDiscards=ifInDiscards, ifStackTable=ifStackTable, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifOutOctets=ifOutOctets, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliances=ifCompliances, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralGroup=ifGeneralGroup, ifHighSpeed=ifHighSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifTestResult=ifTestResult, ifXTable=ifXTable, ifOutUcastPkts=ifOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos)
