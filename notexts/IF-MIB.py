...
RowStatus, AutonomousType, TestAndIncr, TextualConvention, DisplayString, PhysAddress, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TestAndIncr", "TextualConvention", "DisplayString", "PhysAddress", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTestOwner=ifTestOwner, ifTestCode=ifTestCode, ifOutUcastPkts=ifOutUcastPkts, ifIndex=ifIndex, ifName=ifName, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMIB=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifNumber=ifNumber, ifCompliances=ifCompliances, ifType=ifType, ifGroups=ifGroups, ifRcvAddressType=ifRcvAddressType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutUcastPkts=ifHCOutUcastPkts, InterfaceIndex=InterfaceIndex, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifRcvAddressStatus=ifRcvAddressStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, OwnerString=OwnerString, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifTestEntry=ifTestEntry, ifPromiscuousMode=ifPromiscuousMode, ifCompliance=ifCompliance, ifInNUcastPkts=ifInNUcastPkts, ifTestTable=ifTestTable, ifGeneralGroup=ifGeneralGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifInErrors=ifInErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutOctets=ifHCOutOctets, linkUp=linkUp, ifPacketGroup=ifPacketGroup, ifConformance=ifConformance, ifOutDiscards=ifOutDiscards, ifFixedLengthGroup=ifFixedLengthGroup, ifTestStatus=ifTestStatus, ifStackGroup2=ifStackGroup2, ifRcvAddressTable=ifRcvAddressTable, ifInOctets=ifInOctets, linkDown=linkDown, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifTableLastChange=ifTableLastChange, PYSNMP_MODULE_ID=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInDiscards=ifInDiscards, ifStackGroup=ifStackGroup, ifStackLowerLayer=ifStackLowerLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestResult=ifTestResult, ifOutQLen=ifOutQLen, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifConnectorPresent=ifConnectorPresent, ifStackEntry=ifStackEntry, ifAlias=ifAlias, ifCompliance2=ifCompliance2, ifPhysAddress=ifPhysAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutMulticastPkts=ifOutMulticastPkts, interfaces=interfaces, ifLastChange=ifLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifOperStatus=ifOperStatus, ifOutOctets=ifOutOctets, ifCompliance3=ifCompliance3, ifEntry=ifEntry, ifStackHigherLayer=ifStackHigherLayer, ifTestId=ifTestId, ifStackLastChange=ifStackLastChange, ifSpecific=ifSpecific, ifMIBObjects=ifMIBObjects, ifAdminStatus=ifAdminStatus, ifTestType=ifTestType, ifTable=ifTable, ifOutNUcastPkts=ifOutNUcastPkts, ifXTable=ifXTable, ifTestGroup=ifTestGroup, ifStackStatus=ifStackStatus, ifHCPacketGroup=ifHCPacketGroup, ifSpeed=ifSpeed)
