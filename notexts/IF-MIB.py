...
TruthValue, TextualConvention, AutonomousType, TimeStamp, RowStatus, TestAndIncr, DisplayString, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "TestAndIncr", "DisplayString", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifGroups=ifGroups, ifCompliance3=ifCompliance3, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPhysAddress=ifPhysAddress, linkUp=linkUp, ifInBroadcastPkts=ifInBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXTable=ifXTable, ifStackEntry=ifStackEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCPacketGroup=ifHCPacketGroup, ifPacketGroup=ifPacketGroup, ifStackGroup2=ifStackGroup2, ifMtu=ifMtu, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressGroup=ifRcvAddressGroup, interfaces=interfaces, ifAlias=ifAlias, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, ifHCInOctets=ifHCInOctets, ifInNUcastPkts=ifInNUcastPkts, ifAdminStatus=ifAdminStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOperStatus=ifOperStatus, ifRcvAddressTable=ifRcvAddressTable, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifEntry=ifEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifSpecific=ifSpecific, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestResult=ifTestResult, ifVHCPacketGroup=ifVHCPacketGroup, ifSpeed=ifSpeed, ifXEntry=ifXEntry, ifIndex=ifIndex, ifDescr=ifDescr, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLastChange=ifStackLastChange, ifTestOwner=ifTestOwner, ifStackGroup=ifStackGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInErrors=ifInErrors, ifTestType=ifTestType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIBObjects=ifMIBObjects, ifInDiscards=ifInDiscards, ifGeneralGroup=ifGeneralGroup, ifCompliances=ifCompliances, ifOutUcastPkts=ifOutUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInOctets=ifInOctets, ifOutQLen=ifOutQLen, ifRcvAddressEntry=ifRcvAddressEntry, ifTestTable=ifTestTable, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifTableLastChange=ifTableLastChange, InterfaceIndex=InterfaceIndex, ifNumber=ifNumber, ifOutMulticastPkts=ifOutMulticastPkts, ifTestId=ifTestId, ifCompliance=ifCompliance, ifStackLowerLayer=ifStackLowerLayer, ifType=ifType, ifOldObjectsGroup=ifOldObjectsGroup, ifInUnknownProtos=ifInUnknownProtos, PYSNMP_MODULE_ID=ifMIB, ifTestGroup=ifTestGroup, ifOutOctets=ifOutOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifName=ifName, ifMIB=ifMIB, ifPromiscuousMode=ifPromiscuousMode, ifCompliance2=ifCompliance2, ifOutErrors=ifOutErrors)
