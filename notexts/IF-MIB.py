...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, ifStackStatus=ifStackStatus, ifTestGroup=ifTestGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifOutOctets=ifOutOctets, ifLastChange=ifLastChange, ifTestCode=ifTestCode, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifIndex=ifIndex, ifRcvAddressTable=ifRcvAddressTable, ifHCPacketGroup=ifHCPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifMIBObjects=ifMIBObjects, ifRcvAddressType=ifRcvAddressType, ifRcvAddressAddress=ifRcvAddressAddress, ifStackLastChange=ifStackLastChange, ifEntry=ifEntry, ifInUnknownProtos=ifInUnknownProtos, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup, ifInNUcastPkts=ifInNUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifStackTable=ifStackTable, ifStackGroup=ifStackGroup, ifPhysAddress=ifPhysAddress, ifHCOutOctets=ifHCOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestEntry=ifTestEntry, linkUp=linkUp, ifNumber=ifNumber, ifTestStatus=ifTestStatus, interfaces=interfaces, ifSpecific=ifSpecific, ifStackGroup2=ifStackGroup2, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTable=ifTable, ifCompliance3=ifCompliance3, ifOutDiscards=ifOutDiscards, ifTestId=ifTestId, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackEntry=ifStackEntry, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestResult=ifTestResult, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifCompliance=ifCompliance, ifInErrors=ifInErrors, ifTestType=ifTestType, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, ifConformance=ifConformance, ifOutErrors=ifOutErrors, ifGroups=ifGroups, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifHCInOctets=ifHCInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutQLen=ifOutQLen, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifXTable=ifXTable, ifXEntry=ifXEntry, ifTestTable=ifTestTable, ifType=ifType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifPacketGroup=ifPacketGroup, ifCompliance2=ifCompliance2, ifTestOwner=ifTestOwner, ifOutNUcastPkts=ifOutNUcastPkts, ifInOctets=ifInOctets, ifCompliances=ifCompliances, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifSpeed=ifSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifDescr=ifDescr, ifOperStatus=ifOperStatus)
