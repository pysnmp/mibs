...
Counter32, mib_2, ModuleIdentity, Bits, MibIdentifier, Counter64, Unsigned32, Integer32, iso, ObjectIdentity, IpAddress, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "ModuleIdentity", "Bits", "MibIdentifier", "Counter64", "Unsigned32", "Integer32", "iso", "ObjectIdentity", "IpAddress", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
DisplayString, TextualConvention, TruthValue, TestAndIncr, PhysAddress, RowStatus, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "TestAndIncr", "PhysAddress", "RowStatus", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifTestGroup=ifTestGroup, ifLastChange=ifLastChange, ifOutErrors=ifOutErrors, linkUp=linkUp, ifInMulticastPkts=ifInMulticastPkts, ifStackStatus=ifStackStatus, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance=ifCompliance, ifSpecific=ifSpecific, ifInErrors=ifInErrors, linkDown=linkDown, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutQLen=ifOutQLen, ifXTable=ifXTable, ifDescr=ifDescr, ifGroups=ifGroups, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifTestId=ifTestId, ifName=ifName, ifTableLastChange=ifTableLastChange, interfaces=interfaces, ifMIBObjects=ifMIBObjects, ifAdminStatus=ifAdminStatus, ifOutOctets=ifOutOctets, InterfaceIndex=InterfaceIndex, ifRcvAddressStatus=ifRcvAddressStatus, ifEntry=ifEntry, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifTestResult=ifTestResult, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifType=ifType, ifIndex=ifIndex, ifHCInOctets=ifHCInOctets, ifPromiscuousMode=ifPromiscuousMode, ifTable=ifTable, ifInBroadcastPkts=ifInBroadcastPkts, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifTestType=ifTestType, ifVHCPacketGroup=ifVHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifMtu=ifMtu, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackHigherLayer=ifStackHigherLayer, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInOctets=ifInOctets, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, ifHCPacketGroup=ifHCPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifConformance=ifConformance, ifStackGroup=ifStackGroup, ifTestOwner=ifTestOwner, ifPacketGroup=ifPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestEntry=ifTestEntry, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifNumber=ifNumber, ifCompliance3=ifCompliance3, ifOperStatus=ifOperStatus, ifGeneralGroup=ifGeneralGroup, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifTestCode=ifTestCode, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInDiscards=ifInDiscards, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestTable=ifTestTable, ifStackEntry=ifStackEntry, ifCompliance2=ifCompliance2, ifOutUcastPkts=ifOutUcastPkts)
