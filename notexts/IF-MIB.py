...
DisplayString, AutonomousType, PhysAddress, RowStatus, TruthValue, TextualConvention, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "PhysAddress", "RowStatus", "TruthValue", "TextualConvention", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifSpeed=ifSpeed, ifTestResult=ifTestResult, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifIndex=ifIndex, ifXTable=ifXTable, ifAdminStatus=ifAdminStatus, ifVHCPacketGroup=ifVHCPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCompliance2=ifCompliance2, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, ifOutErrors=ifOutErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInDiscards=ifInDiscards, ifRcvAddressTable=ifRcvAddressTable, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifOutQLen=ifOutQLen, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, ifPromiscuousMode=ifPromiscuousMode, ifInUcastPkts=ifInUcastPkts, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, ifConnectorPresent=ifConnectorPresent, ifHCInOctets=ifHCInOctets, ifEntry=ifEntry, ifCompliance3=ifCompliance3, ifTable=ifTable, ifPacketGroup=ifPacketGroup, ifCompliances=ifCompliances, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralGroup=ifGeneralGroup, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup2=ifStackGroup2, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifConformance=ifConformance, interfaces=interfaces, ifOutOctets=ifOutOctets, ifTableLastChange=ifTableLastChange, ifTestStatus=ifTestStatus, ifOperStatus=ifOperStatus, ifTestGroup=ifTestGroup, PYSNMP_MODULE_ID=ifMIB, ifTestCode=ifTestCode, ifRcvAddressAddress=ifRcvAddressAddress, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifMIB=ifMIB, ifHighSpeed=ifHighSpeed, ifTestId=ifTestId, ifXEntry=ifXEntry, ifNumber=ifNumber, ifCompliance=ifCompliance, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifName=ifName, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLastChange=ifStackLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifDescr=ifDescr, linkUp=linkUp, OwnerString=OwnerString, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, linkDown=linkDown, ifType=ifType, ifStackStatus=ifStackStatus, ifStackGroup=ifStackGroup)
