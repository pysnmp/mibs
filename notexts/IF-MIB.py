...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, ObjectIdentity, Gauge32, Integer32, Counter32, TimeTicks, Counter64, MibIdentifier, iso, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "ObjectIdentity", "Gauge32", "Integer32", "Counter32", "TimeTicks", "Counter64", "MibIdentifier", "iso", "Unsigned32", "IpAddress", "NotificationType")
DisplayString, AutonomousType, TestAndIncr, RowStatus, TruthValue, TextualConvention, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TestAndIncr", "RowStatus", "TruthValue", "TextualConvention", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifOperStatus=ifOperStatus, InterfaceIndex=InterfaceIndex, ifInUcastPkts=ifInUcastPkts, ifPacketGroup=ifPacketGroup, ifName=ifName, ifDescr=ifDescr, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMtu=ifMtu, ifNumber=ifNumber, ifIndex=ifIndex, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestCode=ifTestCode, ifRcvAddressAddress=ifRcvAddressAddress, ifConnectorPresent=ifConnectorPresent, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup2=ifStackGroup2, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPhysAddress=ifPhysAddress, ifMIB=ifMIB, ifOutOctets=ifOutOctets, interfaces=interfaces, ifStackStatus=ifStackStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPromiscuousMode=ifPromiscuousMode, ifSpecific=ifSpecific, ifCompliance2=ifCompliance2, ifTestStatus=ifTestStatus, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifInDiscards=ifInDiscards, PYSNMP_MODULE_ID=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards, ifStackHigherLayer=ifStackHigherLayer, OwnerString=OwnerString, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifTestEntry=ifTestEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackGroup=ifStackGroup, ifTestResult=ifTestResult, ifTestType=ifTestType, ifRcvAddressTable=ifRcvAddressTable, ifStackLowerLayer=ifStackLowerLayer, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLastChange=ifStackLastChange, ifType=ifType, ifOutMulticastPkts=ifOutMulticastPkts, ifEntry=ifEntry, ifStackTable=ifStackTable, ifHCOutOctets=ifHCOutOctets, ifLastChange=ifLastChange, ifOutQLen=ifOutQLen, ifOutNUcastPkts=ifOutNUcastPkts, ifAdminStatus=ifAdminStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInOctets=ifHCInOctets, ifXTable=ifXTable, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressType=ifRcvAddressType, ifInErrors=ifInErrors, ifTable=ifTable, ifGeneralGroup=ifGeneralGroup, ifVHCPacketGroup=ifVHCPacketGroup, linkDown=linkDown, linkUp=linkUp, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifTestOwner=ifTestOwner, ifTestTable=ifTestTable, ifInOctets=ifInOctets, ifTestGroup=ifTestGroup, ifTestId=ifTestId, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliances=ifCompliances, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutBroadcastPkts=ifOutBroadcastPkts)
