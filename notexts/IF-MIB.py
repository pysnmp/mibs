...
PhysAddress, TextualConvention, AutonomousType, TruthValue, TestAndIncr, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "AutonomousType", "TruthValue", "TestAndIncr", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", OwnerString=OwnerString, ifTestOwner=ifTestOwner, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutOctets=ifHCOutOctets, ifStackLastChange=ifStackLastChange, ifPromiscuousMode=ifPromiscuousMode, ifXTable=ifXTable, ifDescr=ifDescr, ifConnectorPresent=ifConnectorPresent, ifMtu=ifMtu, ifInOctets=ifInOctets, ifStackLowerLayer=ifStackLowerLayer, ifInNUcastPkts=ifInNUcastPkts, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifIndex=ifIndex, ifSpeed=ifSpeed, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifInErrors=ifInErrors, ifStackStatus=ifStackStatus, linkDown=linkDown, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUp=linkUp, ifFixedLengthGroup=ifFixedLengthGroup, ifTable=ifTable, ifEntry=ifEntry, ifAdminStatus=ifAdminStatus, ifTestGroup=ifTestGroup, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifTestStatus=ifTestStatus, PYSNMP_MODULE_ID=ifMIB, InterfaceIndex=InterfaceIndex, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutDiscards=ifOutDiscards, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifHighSpeed=ifHighSpeed, ifLastChange=ifLastChange, ifType=ifType, ifCompliance3=ifCompliance3, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifTestResult=ifTestResult, ifOutMulticastPkts=ifOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifGroups=ifGroups, ifConformance=ifConformance, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance2=ifCompliance2, ifRcvAddressTable=ifRcvAddressTable, ifCompliance=ifCompliance, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutOctets=ifOutOctets, ifMIB=ifMIB, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, ifCompliances=ifCompliances, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifHCInOctets=ifHCInOctets, ifSpecific=ifSpecific, ifTestEntry=ifTestEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifTestTable=ifTestTable, ifXEntry=ifXEntry, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup=ifStackGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifName=ifName, interfaces=interfaces, ifAlias=ifAlias, ifInUcastPkts=ifInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup)
