...
DisplayString, TruthValue, AutonomousType, TestAndIncr, PhysAddress, TimeStamp, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "AutonomousType", "TestAndIncr", "PhysAddress", "TimeStamp", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, linkDown=linkDown, ifInBroadcastPkts=ifInBroadcastPkts, linkUp=linkUp, ifTestId=ifTestId, ifInMulticastPkts=ifInMulticastPkts, ifTestType=ifTestType, interfaces=interfaces, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMIB=ifMIB, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifInNUcastPkts=ifInNUcastPkts, ifOutErrors=ifOutErrors, ifXEntry=ifXEntry, ifTestGroup=ifTestGroup, InterfaceIndex=InterfaceIndex, ifTestTable=ifTestTable, ifRcvAddressStatus=ifRcvAddressStatus, OwnerString=OwnerString, ifNumber=ifNumber, ifPromiscuousMode=ifPromiscuousMode, ifTestEntry=ifTestEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, ifInUcastPkts=ifInUcastPkts, ifPacketGroup=ifPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifCompliances=ifCompliances, ifMtu=ifMtu, ifEntry=ifEntry, ifStackHigherLayer=ifStackHigherLayer, ifStackGroup2=ifStackGroup2, ifRcvAddressGroup=ifRcvAddressGroup, ifOutQLen=ifOutQLen, ifIndex=ifIndex, ifStackGroup=ifStackGroup, ifTestStatus=ifTestStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressType=ifRcvAddressType, ifXTable=ifXTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPhysAddress=ifPhysAddress, ifOutUcastPkts=ifOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutOctets=ifOutOctets, ifConformance=ifConformance, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, ifGeneralGroup=ifGeneralGroup, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, ifOperStatus=ifOperStatus, ifTestResult=ifTestResult, ifInErrors=ifInErrors, ifOutDiscards=ifOutDiscards, ifStackLowerLayer=ifStackLowerLayer, ifOutMulticastPkts=ifOutMulticastPkts, ifTestOwner=ifTestOwner, ifCompliance=ifCompliance, ifAdminStatus=ifAdminStatus, ifMIBObjects=ifMIBObjects, ifCompliance2=ifCompliance2, ifName=ifName, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackEntry=ifStackEntry, ifInUnknownProtos=ifInUnknownProtos, ifCompliance3=ifCompliance3, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifSpecific=ifSpecific, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInDiscards=ifInDiscards, ifGroups=ifGroups, ifHCInOctets=ifHCInOctets, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifType=ifType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpeed=ifSpeed)
