...
RowStatus, AutonomousType, TextualConvention, TestAndIncr, PhysAddress, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TestAndIncr", "PhysAddress", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifConnectorPresent=ifConnectorPresent, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestGroup=ifTestGroup, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifOutMulticastPkts=ifOutMulticastPkts, ifIndex=ifIndex, ifGeneralInformationGroup=ifGeneralInformationGroup, ifAlias=ifAlias, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifCompliance2=ifCompliance2, interfaces=interfaces, ifStackEntry=ifStackEntry, ifInNUcastPkts=ifInNUcastPkts, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifStackLowerLayer=ifStackLowerLayer, ifOutDiscards=ifOutDiscards, ifOutQLen=ifOutQLen, ifStackTable=ifStackTable, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, ifXTable=ifXTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXEntry=ifXEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestCode=ifTestCode, ifStackGroup=ifStackGroup, ifMIBObjects=ifMIBObjects, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOperStatus=ifOperStatus, linkDown=linkDown, ifOutNUcastPkts=ifOutNUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifPhysAddress=ifPhysAddress, ifTable=ifTable, linkUp=linkUp, ifRcvAddressStatus=ifRcvAddressStatus, ifTestEntry=ifTestEntry, ifInMulticastPkts=ifInMulticastPkts, ifTestStatus=ifTestStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGroups=ifGroups, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifNumber=ifNumber, ifType=ifType, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifCompliance=ifCompliance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIB=ifMIB, ifCompliances=ifCompliances, ifStackHigherLayer=ifStackHigherLayer, ifAdminStatus=ifAdminStatus, ifGeneralGroup=ifGeneralGroup, ifOutOctets=ifOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifTestResult=ifTestResult, ifInBroadcastPkts=ifInBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifConformance=ifConformance, ifInErrors=ifInErrors, ifCompliance3=ifCompliance3, ifFixedLengthGroup=ifFixedLengthGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestType=ifTestType, ifPacketGroup=ifPacketGroup, ifTestId=ifTestId, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifHCInOctets=ifHCInOctets, ifSpecific=ifSpecific, ifRcvAddressEntry=ifRcvAddressEntry, ifName=ifName, ifTestTable=ifTestTable, ifHighSpeed=ifHighSpeed, ifTestOwner=ifTestOwner, ifOldObjectsGroup=ifOldObjectsGroup, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifEntry=ifEntry, ifStackStatus=ifStackStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets)
