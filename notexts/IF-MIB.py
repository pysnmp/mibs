...
Bits, ModuleIdentity, NotificationType, TimeTicks, IpAddress, Counter32, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Integer32, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "TimeTicks", "IpAddress", "Counter32", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier")
TextualConvention, PhysAddress, AutonomousType, TimeStamp, DisplayString, TruthValue, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "AutonomousType", "TimeStamp", "DisplayString", "TruthValue", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance=ifCompliance, ifTestId=ifTestId, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConnectorPresent=ifConnectorPresent, ifPacketGroup=ifPacketGroup, ifEntry=ifEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifType=ifType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliances=ifCompliances, ifIndex=ifIndex, ifInOctets=ifInOctets, ifXEntry=ifXEntry, ifTestStatus=ifTestStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCPacketGroup=ifHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackStatus=ifStackStatus, ifRcvAddressTable=ifRcvAddressTable, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInOctets=ifHCInOctets, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, interfaces=interfaces, ifSpecific=ifSpecific, InterfaceIndex=InterfaceIndex, ifHighSpeed=ifHighSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestResult=ifTestResult, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifTestGroup=ifTestGroup, ifNumber=ifNumber, ifHCInUcastPkts=ifHCInUcastPkts, ifMtu=ifMtu, linkUp=linkUp, ifInNUcastPkts=ifInNUcastPkts, ifTableLastChange=ifTableLastChange, ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, ifRcvAddressAddress=ifRcvAddressAddress, ifStackLastChange=ifStackLastChange, ifInErrors=ifInErrors, ifLastChange=ifLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAlias=ifAlias, ifTestType=ifTestType, ifTestOwner=ifTestOwner, ifStackEntry=ifStackEntry, ifDescr=ifDescr, ifPromiscuousMode=ifPromiscuousMode, ifName=ifName, ifInUcastPkts=ifInUcastPkts, ifCompliance3=ifCompliance3, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup=ifStackGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifStackTable=ifStackTable, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifAdminStatus=ifAdminStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMIB=ifMIB, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, linkDown=linkDown, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifRcvAddressEntry=ifRcvAddressEntry, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifXTable=ifXTable, ifSpeed=ifSpeed)
