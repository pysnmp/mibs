...
DisplayString, TruthValue, RowStatus, PhysAddress, AutonomousType, TimeStamp, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "PhysAddress", "AutonomousType", "TimeStamp", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMtu=ifMtu, ifInNUcastPkts=ifInNUcastPkts, ifStackTable=ifStackTable, ifInUcastPkts=ifInUcastPkts, ifStackGroup=ifStackGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifType=ifType, ifTestGroup=ifTestGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInOctets=ifInOctets, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGroups=ifGroups, ifCompliance2=ifCompliance2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPhysAddress=ifPhysAddress, ifTableLastChange=ifTableLastChange, ifConnectorPresent=ifConnectorPresent, ifOutErrors=ifOutErrors, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, OwnerString=OwnerString, ifLastChange=ifLastChange, ifOutUcastPkts=ifOutUcastPkts, ifOutDiscards=ifOutDiscards, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestOwner=ifTestOwner, ifStackLowerLayer=ifStackLowerLayer, ifIndex=ifIndex, ifName=ifName, ifAlias=ifAlias, ifCompliances=ifCompliances, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifEntry=ifEntry, ifInErrors=ifInErrors, ifTestType=ifTestType, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliance=ifCompliance, ifGeneralGroup=ifGeneralGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpeed=ifSpeed, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifStackStatus=ifStackStatus, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, PYSNMP_MODULE_ID=ifMIB, ifOutOctets=ifOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifSpecific=ifSpecific, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifOldObjectsGroup=ifOldObjectsGroup, ifTable=ifTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInDiscards=ifInDiscards, ifStackLastChange=ifStackLastChange, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifTestStatus=ifTestStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifXEntry=ifXEntry, ifTestTable=ifTestTable, ifHighSpeed=ifHighSpeed, ifRcvAddressType=ifRcvAddressType, ifCompliance3=ifCompliance3, interfaces=interfaces, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifMIBObjects=ifMIBObjects, ifStackGroup2=ifStackGroup2, ifOutQLen=ifOutQLen, ifMIB=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifRcvAddressAddress=ifRcvAddressAddress, ifDescr=ifDescr, ifConformance=ifConformance, ifTestCode=ifTestCode, ifNumber=ifNumber, ifTestResult=ifTestResult, ifXTable=ifXTable, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndex=InterfaceIndex)
