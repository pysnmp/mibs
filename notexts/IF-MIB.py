...
RowStatus, TruthValue, TimeStamp, TestAndIncr, DisplayString, PhysAddress, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TimeStamp", "TestAndIncr", "DisplayString", "PhysAddress", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInMulticastPkts=ifHCInMulticastPkts, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutQLen=ifOutQLen, ifRcvAddressEntry=ifRcvAddressEntry, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifPhysAddress=ifPhysAddress, ifConnectorPresent=ifConnectorPresent, linkUp=linkUp, ifOperStatus=ifOperStatus, ifMIBObjects=ifMIBObjects, ifCompliance3=ifCompliance3, OwnerString=OwnerString, ifOutMulticastPkts=ifOutMulticastPkts, ifEntry=ifEntry, ifTestTable=ifTestTable, ifHighSpeed=ifHighSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTable=ifTable, ifTestResult=ifTestResult, ifXEntry=ifXEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifConformance=ifConformance, ifPacketGroup=ifPacketGroup, interfaces=interfaces, ifStackStatus=ifStackStatus, ifInUcastPkts=ifInUcastPkts, ifTestOwner=ifTestOwner, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, ifOutErrors=ifOutErrors, ifHCInOctets=ifHCInOctets, ifMIB=ifMIB, ifXTable=ifXTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifName=ifName, ifStackHigherLayer=ifStackHigherLayer, ifStackLastChange=ifStackLastChange, ifTestType=ifTestType, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressStatus=ifRcvAddressStatus, PYSNMP_MODULE_ID=ifMIB, linkDown=linkDown, ifOutOctets=ifOutOctets, ifTestStatus=ifTestStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, ifMtu=ifMtu, ifRcvAddressTable=ifRcvAddressTable, ifGroups=ifGroups, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAlias=ifAlias, ifTestId=ifTestId, ifInErrors=ifInErrors, InterfaceIndex=InterfaceIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance=ifCompliance, ifStackTable=ifStackTable, ifOldObjectsGroup=ifOldObjectsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifDescr=ifDescr, ifSpeed=ifSpeed, ifType=ifType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralGroup=ifGeneralGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifTestGroup=ifTestGroup, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInNUcastPkts=ifInNUcastPkts, ifTestEntry=ifTestEntry, ifInMulticastPkts=ifInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliances=ifCompliances, ifNumber=ifNumber, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifHCOutOctets=ifHCOutOctets, ifOutUcastPkts=ifOutUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup=ifStackGroup, ifAdminStatus=ifAdminStatus)
