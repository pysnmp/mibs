...
TimeStamp, TextualConvention, TruthValue, AutonomousType, DisplayString, TestAndIncr, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "TestAndIncr", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifTestOwner=ifTestOwner, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifGroups=ifGroups, ifEntry=ifEntry, ifHCOutOctets=ifHCOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestTable=ifTestTable, ifFixedLengthGroup=ifFixedLengthGroup, ifInOctets=ifInOctets, ifTestType=ifTestType, ifStackStatus=ifStackStatus, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifAdminStatus=ifAdminStatus, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTestResult=ifTestResult, ifTestEntry=ifTestEntry, ifPacketGroup=ifPacketGroup, ifIndex=ifIndex, ifInErrors=ifInErrors, ifDescr=ifDescr, ifOutQLen=ifOutQLen, ifGeneralGroup=ifGeneralGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifType=ifType, ifInUcastPkts=ifInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackLastChange=ifStackLastChange, ifOutUcastPkts=ifOutUcastPkts, linkUp=linkUp, ifStackLowerLayer=ifStackLowerLayer, ifStackEntry=ifStackEntry, ifOutDiscards=ifOutDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressType=ifRcvAddressType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance3=ifCompliance3, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifXTable=ifXTable, ifCompliance2=ifCompliance2, ifStackGroup=ifStackGroup, ifTestCode=ifTestCode, ifMtu=ifMtu, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifLastChange=ifLastChange, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifAlias=ifAlias, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifTestId=ifTestId, InterfaceIndex=InterfaceIndex, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifMIBObjects=ifMIBObjects, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifXEntry=ifXEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup2=ifStackGroup2, ifTableLastChange=ifTableLastChange, linkDown=linkDown, interfaces=interfaces, ifOperStatus=ifOperStatus, ifTestStatus=ifTestStatus, ifHighSpeed=ifHighSpeed, ifPhysAddress=ifPhysAddress, ifCompliances=ifCompliances, ifConformance=ifConformance, ifNumber=ifNumber, OwnerString=OwnerString)
