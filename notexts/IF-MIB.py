...
TextualConvention, AutonomousType, RowStatus, DisplayString, TruthValue, TestAndIncr, TimeStamp, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "RowStatus", "DisplayString", "TruthValue", "TestAndIncr", "TimeStamp", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressEntry=ifRcvAddressEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestCode=ifTestCode, ifSpecific=ifSpecific, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTableLastChange=ifTableLastChange, ifInBroadcastPkts=ifInBroadcastPkts, ifTestEntry=ifTestEntry, ifHCPacketGroup=ifHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifStackEntry=ifStackEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestTable=ifTestTable, ifOutOctets=ifOutOctets, ifStackGroup2=ifStackGroup2, ifStackGroup=ifStackGroup, ifHCOutOctets=ifHCOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifType=ifType, ifHighSpeed=ifHighSpeed, ifIndex=ifIndex, linkDown=linkDown, ifStackTable=ifStackTable, ifInUnknownProtos=ifInUnknownProtos, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifEntry=ifEntry, ifOutDiscards=ifOutDiscards, ifStackStatus=ifStackStatus, ifGroups=ifGroups, ifAlias=ifAlias, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInOctets=ifInOctets, ifRcvAddressType=ifRcvAddressType, ifCompliances=ifCompliances, ifCompliance=ifCompliance, InterfaceIndex=InterfaceIndex, ifTestOwner=ifTestOwner, ifInUcastPkts=ifInUcastPkts, ifAdminStatus=ifAdminStatus, ifMtu=ifMtu, ifTestGroup=ifTestGroup, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifXTable=ifXTable, ifOutErrors=ifOutErrors, ifOperStatus=ifOperStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifTestType=ifTestType, ifInErrors=ifInErrors, ifPromiscuousMode=ifPromiscuousMode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInNUcastPkts=ifInNUcastPkts, ifLastChange=ifLastChange, ifTable=ifTable, ifOutNUcastPkts=ifOutNUcastPkts, ifTestId=ifTestId, linkUp=linkUp, ifConformance=ifConformance, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifXEntry=ifXEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, OwnerString=OwnerString, ifName=ifName, ifHCInOctets=ifHCInOctets, ifDescr=ifDescr, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressTable=ifRcvAddressTable, ifOutQLen=ifOutQLen, ifCompliance2=ifCompliance2, ifPhysAddress=ifPhysAddress, ifFixedLengthGroup=ifFixedLengthGroup, ifTestResult=ifTestResult, ifSpeed=ifSpeed, ifConnectorPresent=ifConnectorPresent, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifOutUcastPkts=ifOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifCompliance3=ifCompliance3, ifStackHigherLayer=ifStackHigherLayer)
