...
Integer32, ModuleIdentity, iso, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, MibIdentifier, ObjectIdentity, NotificationType, Gauge32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "iso", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "MibIdentifier", "ObjectIdentity", "NotificationType", "Gauge32", "Counter32", "Counter64")
TestAndIncr, AutonomousType, DisplayString, TruthValue, TimeStamp, RowStatus, PhysAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "AutonomousType", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "PhysAddress", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", linkUp=linkUp, ifTestEntry=ifTestEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInErrors=ifInErrors, ifOutOctets=ifOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInDiscards=ifInDiscards, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMIBObjects=ifMIBObjects, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifCompliance=ifCompliance, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifOutQLen=ifOutQLen, ifTestTable=ifTestTable, ifTestGroup=ifTestGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifEntry=ifEntry, ifTestStatus=ifTestStatus, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifSpeed=ifSpeed, ifMIB=ifMIB, ifName=ifName, ifType=ifType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifInOctets=ifInOctets, ifCompliances=ifCompliances, ifStackLastChange=ifStackLastChange, ifStackEntry=ifStackEntry, ifSpecific=ifSpecific, ifOutMulticastPkts=ifOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifOutErrors=ifOutErrors, ifPhysAddress=ifPhysAddress, linkDown=linkDown, ifGeneralInformationGroup=ifGeneralInformationGroup, ifGroups=ifGroups, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifTestType=ifTestType, ifOldObjectsGroup=ifOldObjectsGroup, ifAlias=ifAlias, ifHCInOctets=ifHCInOctets, ifHighSpeed=ifHighSpeed, ifCompliance3=ifCompliance3, ifIndex=ifIndex, ifTableLastChange=ifTableLastChange, ifCompliance2=ifCompliance2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOutDiscards=ifOutDiscards, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, PYSNMP_MODULE_ID=ifMIB, ifOperStatus=ifOperStatus, ifMtu=ifMtu, ifRcvAddressEntry=ifRcvAddressEntry, ifXTable=ifXTable, ifLastChange=ifLastChange, ifAdminStatus=ifAdminStatus, ifInUcastPkts=ifInUcastPkts, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCPacketGroup=ifHCPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifInUnknownProtos=ifInUnknownProtos, ifStackGroup2=ifStackGroup2, ifTestId=ifTestId, ifTestOwner=ifTestOwner, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndex=InterfaceIndex, ifConformance=ifConformance, OwnerString=OwnerString, ifXEntry=ifXEntry, interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifStackGroup=ifStackGroup, ifTestCode=ifTestCode)
