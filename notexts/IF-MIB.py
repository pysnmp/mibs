...
Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, iso, TimeTicks, Bits, Unsigned32, MibIdentifier, ObjectIdentity, mib_2, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "iso", "TimeTicks", "Bits", "Unsigned32", "MibIdentifier", "ObjectIdentity", "mib-2", "IpAddress", "Counter32", "ModuleIdentity")
AutonomousType, DisplayString, TruthValue, RowStatus, PhysAddress, TextualConvention, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TruthValue", "RowStatus", "PhysAddress", "TextualConvention", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance2=ifCompliance2, ifGeneralGroup=ifGeneralGroup, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifInNUcastPkts=ifInNUcastPkts, ifTestEntry=ifTestEntry, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance=ifCompliance, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifInMulticastPkts=ifInMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUcastPkts=ifInUcastPkts, ifType=ifType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackStatus=ifStackStatus, ifInDiscards=ifInDiscards, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, ifOutOctets=ifOutOctets, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifName=ifName, ifStackGroup=ifStackGroup, ifGroups=ifGroups, interfaces=interfaces, ifPromiscuousMode=ifPromiscuousMode, ifTestResult=ifTestResult, ifStackGroup2=ifStackGroup2, ifXEntry=ifXEntry, ifOutNUcastPkts=ifOutNUcastPkts, PYSNMP_MODULE_ID=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTable=ifTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifTestOwner=ifTestOwner, ifOldObjectsGroup=ifOldObjectsGroup, ifInOctets=ifInOctets, ifTestCode=ifTestCode, ifNumber=ifNumber, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifOutDiscards=ifOutDiscards, ifCompliance3=ifCompliance3, ifStackLowerLayer=ifStackLowerLayer, ifIndex=ifIndex, ifTableLastChange=ifTableLastChange, ifOutErrors=ifOutErrors, ifVHCPacketGroup=ifVHCPacketGroup, linkUp=linkUp, ifMIB=ifMIB, linkDown=linkDown, ifSpeed=ifSpeed, InterfaceIndex=InterfaceIndex, ifHCInOctets=ifHCInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifAlias=ifAlias, ifInErrors=ifInErrors, ifHCOutOctets=ifHCOutOctets, ifXTable=ifXTable, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, ifMtu=ifMtu, ifOperStatus=ifOperStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressStatus=ifRcvAddressStatus, ifTestType=ifTestType, ifCompliances=ifCompliances, ifTestTable=ifTestTable, ifOutQLen=ifOutQLen, ifTestGroup=ifTestGroup, ifEntry=ifEntry, ifPhysAddress=ifPhysAddress)
