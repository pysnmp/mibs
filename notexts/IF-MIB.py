...
TextualConvention, TruthValue, RowStatus, TestAndIncr, DisplayString, AutonomousType, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "TestAndIncr", "DisplayString", "AutonomousType", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifStackEntry=ifStackEntry, OwnerString=OwnerString, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifGroups=ifGroups, ifHCOutOctets=ifHCOutOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifPhysAddress=ifPhysAddress, ifStackStatus=ifStackStatus, InterfaceIndex=InterfaceIndex, ifOldObjectsGroup=ifOldObjectsGroup, ifTestTable=ifTestTable, ifOperStatus=ifOperStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifPromiscuousMode=ifPromiscuousMode, ifXEntry=ifXEntry, ifStackLastChange=ifStackLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifTestResult=ifTestResult, ifMtu=ifMtu, ifTestType=ifTestType, ifInNUcastPkts=ifInNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackTable=ifStackTable, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance2=ifCompliance2, ifStackLowerLayer=ifStackLowerLayer, ifInOctets=ifInOctets, ifHCInUcastPkts=ifHCInUcastPkts, linkDown=linkDown, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifCompliance3=ifCompliance3, ifCompliances=ifCompliances, ifLastChange=ifLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestStatus=ifTestStatus, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifCompliance=ifCompliance, ifIndex=ifIndex, ifOutDiscards=ifOutDiscards, ifType=ifType, ifOutBroadcastPkts=ifOutBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifDescr=ifDescr, ifInUnknownProtos=ifInUnknownProtos, PYSNMP_MODULE_ID=ifMIB, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestGroup=ifTestGroup, linkUp=linkUp, ifOutErrors=ifOutErrors, ifMIB=ifMIB, ifRcvAddressType=ifRcvAddressType, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifAlias=ifAlias, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifXTable=ifXTable, ifAdminStatus=ifAdminStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifSpeed=ifSpeed, interfaces=interfaces, ifStackGroup=ifStackGroup, ifTableLastChange=ifTableLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifConformance=ifConformance, ifEntry=ifEntry, ifOutUcastPkts=ifOutUcastPkts, ifInErrors=ifInErrors, ifNumber=ifNumber)
