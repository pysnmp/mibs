...
iso, ObjectIdentity, Counter32, Integer32, Gauge32, Bits, ModuleIdentity, mib_2, NotificationType, TimeTicks, MibIdentifier, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Counter32", "Integer32", "Gauge32", "Bits", "ModuleIdentity", "mib-2", "NotificationType", "TimeTicks", "MibIdentifier", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TruthValue, TestAndIncr, TextualConvention, DisplayString, TimeStamp, PhysAddress, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "TextualConvention", "DisplayString", "TimeStamp", "PhysAddress", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutUcastPkts=ifOutUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConformance=ifConformance, linkDown=linkDown, ifXTable=ifXTable, ifEntry=ifEntry, ifInUnknownProtos=ifInUnknownProtos, ifHCOutOctets=ifHCOutOctets, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressTable=ifRcvAddressTable, ifStackEntry=ifStackEntry, ifMtu=ifMtu, ifTestOwner=ifTestOwner, ifInErrors=ifInErrors, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifNumber=ifNumber, ifOperStatus=ifOperStatus, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, ifInBroadcastPkts=ifInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifXEntry=ifXEntry, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestId=ifTestId, ifOutErrors=ifOutErrors, ifCompliance=ifCompliance, ifStackHigherLayer=ifStackHigherLayer, ifTestType=ifTestType, ifOutQLen=ifOutQLen, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup=ifStackGroup, ifAdminStatus=ifAdminStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifTestStatus=ifTestStatus, ifSpecific=ifSpecific, ifName=ifName, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConnectorPresent=ifConnectorPresent, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifInDiscards=ifInDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInOctets=ifHCInOctets, ifPhysAddress=ifPhysAddress, ifHighSpeed=ifHighSpeed, ifTableLastChange=ifTableLastChange, ifTable=ifTable, interfaces=interfaces, ifCompliance3=ifCompliance3, ifTestCode=ifTestCode, ifCompliances=ifCompliances, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifOldObjectsGroup=ifOldObjectsGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifMIB=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifTestResult=ifTestResult, ifIndex=ifIndex, ifOutOctets=ifOutOctets, ifOutDiscards=ifOutDiscards, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestGroup=ifTestGroup, linkUp=linkUp, ifGroups=ifGroups, ifStackTable=ifStackTable, ifTestTable=ifTestTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, ifInOctets=ifInOctets, ifGeneralGroup=ifGeneralGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackStatus=ifStackStatus, ifMIBObjects=ifMIBObjects, ifInNUcastPkts=ifInNUcastPkts, InterfaceIndex=InterfaceIndex)
