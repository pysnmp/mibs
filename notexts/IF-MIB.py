...
DisplayString, TimeStamp, TestAndIncr, AutonomousType, PhysAddress, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TestAndIncr", "AutonomousType", "PhysAddress", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTestGroup=ifTestGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifIndex=ifIndex, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifInMulticastPkts=ifInMulticastPkts, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifPromiscuousMode=ifPromiscuousMode, ifAdminStatus=ifAdminStatus, ifConnectorPresent=ifConnectorPresent, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackLowerLayer=ifStackLowerLayer, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifCompliance=ifCompliance, interfaces=interfaces, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifOutOctets=ifOutOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, linkUp=linkUp, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifXTable=ifXTable, ifStackGroup2=ifStackGroup2, ifNumber=ifNumber, ifOutQLen=ifOutQLen, ifTestTable=ifTestTable, ifOutErrors=ifOutErrors, ifTable=ifTable, ifMtu=ifMtu, ifInErrors=ifInErrors, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestEntry=ifTestEntry, ifTestOwner=ifTestOwner, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, ifInDiscards=ifInDiscards, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifInUcastPkts=ifInUcastPkts, ifType=ifType, ifPacketGroup=ifPacketGroup, ifHighSpeed=ifHighSpeed, ifConformance=ifConformance, ifRcvAddressType=ifRcvAddressType, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifEntry=ifEntry, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTableLastChange=ifTableLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifOldObjectsGroup=ifOldObjectsGroup, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifCompliance2=ifCompliance2, linkDown=linkDown, ifName=ifName, ifRcvAddressTable=ifRcvAddressTable, ifInNUcastPkts=ifInNUcastPkts, ifMIB=ifMIB, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifOperStatus=ifOperStatus, ifGeneralGroup=ifGeneralGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndex=InterfaceIndex, ifAlias=ifAlias, ifLastChange=ifLastChange, ifXEntry=ifXEntry, ifCompliances=ifCompliances, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, ifStackLastChange=ifStackLastChange)
