...
AutonomousType, RowStatus, DisplayString, TestAndIncr, TruthValue, PhysAddress, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "DisplayString", "TestAndIncr", "TruthValue", "PhysAddress", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifTestOwner=ifTestOwner, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInNUcastPkts=ifInNUcastPkts, ifStackTable=ifStackTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMIBObjects=ifMIBObjects, ifEntry=ifEntry, ifAlias=ifAlias, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifInErrors=ifInErrors, ifHCPacketGroup=ifHCPacketGroup, ifSpeed=ifSpeed, linkDown=linkDown, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, interfaces=interfaces, ifTableLastChange=ifTableLastChange, ifOutOctets=ifOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifOutErrors=ifOutErrors, ifPacketGroup=ifPacketGroup, ifOperStatus=ifOperStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifXTable=ifXTable, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance=ifCompliance, ifTestEntry=ifTestEntry, ifHighSpeed=ifHighSpeed, ifHCInOctets=ifHCInOctets, ifCompliance2=ifCompliance2, ifStackLowerLayer=ifStackLowerLayer, ifInDiscards=ifInDiscards, ifStackStatus=ifStackStatus, ifInOctets=ifInOctets, ifStackLastChange=ifStackLastChange, ifStackGroup=ifStackGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifMIB=ifMIB, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestType=ifTestType, ifGroups=ifGroups, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifRcvAddressTable=ifRcvAddressTable, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInUcastPkts=ifHCInUcastPkts, ifType=ifType, ifPhysAddress=ifPhysAddress, ifXEntry=ifXEntry, OwnerString=OwnerString, ifTestStatus=ifTestStatus, ifTestGroup=ifTestGroup, ifOutMulticastPkts=ifOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, linkUp=linkUp, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifStackEntry=ifStackEntry, ifTable=ifTable, InterfaceIndex=InterfaceIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliances=ifCompliances, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifAdminStatus=ifAdminStatus, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifHCOutOctets=ifHCOutOctets, ifCompliance3=ifCompliance3, ifPromiscuousMode=ifPromiscuousMode, ifConformance=ifConformance, ifGeneralGroup=ifGeneralGroup)
