...
Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, iso, Integer32, mib_2, MibIdentifier, Unsigned32, TimeTicks, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "iso", "Integer32", "mib-2", "MibIdentifier", "Unsigned32", "TimeTicks", "IpAddress", "Counter32")
TruthValue, DisplayString, AutonomousType, TimeStamp, TestAndIncr, RowStatus, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "TimeStamp", "TestAndIncr", "RowStatus", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifOutNUcastPkts=ifOutNUcastPkts, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, linkDown=linkDown, ifMIBObjects=ifMIBObjects, ifTestGroup=ifTestGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance2=ifCompliance2, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifSpeed=ifSpeed, ifPacketGroup=ifPacketGroup, ifNumber=ifNumber, ifStackStatus=ifStackStatus, ifType=ifType, ifCompliances=ifCompliances, ifTestCode=ifTestCode, ifConformance=ifConformance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, OwnerString=OwnerString, ifHCOutOctets=ifHCOutOctets, PYSNMP_MODULE_ID=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifCompliance=ifCompliance, ifVHCPacketGroup=ifVHCPacketGroup, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifInUnknownProtos=ifInUnknownProtos, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutErrors=ifOutErrors, ifPromiscuousMode=ifPromiscuousMode, ifOutDiscards=ifOutDiscards, ifRcvAddressGroup=ifRcvAddressGroup, interfaces=interfaces, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUp=linkUp, ifTestTable=ifTestTable, ifXTable=ifXTable, ifOutQLen=ifOutQLen, ifStackLastChange=ifStackLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifEntry=ifEntry, ifGeneralGroup=ifGeneralGroup, ifInUcastPkts=ifInUcastPkts, ifStackGroup=ifStackGroup, ifTestEntry=ifTestEntry, ifTestType=ifTestType, InterfaceIndex=InterfaceIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifOutUcastPkts=ifOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifXEntry=ifXEntry, ifHighSpeed=ifHighSpeed, ifInDiscards=ifInDiscards, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInErrors=ifInErrors, ifAdminStatus=ifAdminStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifIndex=ifIndex, ifDescr=ifDescr, ifGroups=ifGroups, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInOctets=ifInOctets, ifTestOwner=ifTestOwner, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifMIB=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifTestId=ifTestId, ifTable=ifTable, ifStackEntry=ifStackEntry, ifRcvAddressTable=ifRcvAddressTable, ifTestStatus=ifTestStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifSpecific=ifSpecific, ifTableLastChange=ifTableLastChange, ifCompliance3=ifCompliance3, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMtu=ifMtu, ifAlias=ifAlias)
