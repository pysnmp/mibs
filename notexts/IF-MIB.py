...
NotificationType, Counter64, Bits, Integer32, MibIdentifier, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, mib_2, Gauge32, IpAddress, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Bits", "Integer32", "MibIdentifier", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "mib-2", "Gauge32", "IpAddress", "iso", "ModuleIdentity")
TextualConvention, TruthValue, RowStatus, TimeStamp, AutonomousType, TestAndIncr, PhysAddress, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "AutonomousType", "TestAndIncr", "PhysAddress", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInUcastPkts=ifHCInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifTestOwner=ifTestOwner, ifPhysAddress=ifPhysAddress, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifTestId=ifTestId, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInNUcastPkts=ifInNUcastPkts, interfaces=interfaces, ifPromiscuousMode=ifPromiscuousMode, ifInDiscards=ifInDiscards, ifTestEntry=ifTestEntry, InterfaceIndex=InterfaceIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifNumber=ifNumber, ifIndex=ifIndex, ifGeneralGroup=ifGeneralGroup, ifMIBObjects=ifMIBObjects, ifAdminStatus=ifAdminStatus, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifTestGroup=ifTestGroup, ifStackLowerLayer=ifStackLowerLayer, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup2=ifStackGroup2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConformance=ifConformance, ifXEntry=ifXEntry, ifRcvAddressAddress=ifRcvAddressAddress, linkDown=linkDown, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifDescr=ifDescr, ifCompliance=ifCompliance, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMtu=ifMtu, ifMIB=ifMIB, ifSpeed=ifSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifOutErrors=ifOutErrors, ifInUnknownProtos=ifInUnknownProtos, ifTestResult=ifTestResult, ifAlias=ifAlias, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, ifStackGroup=ifStackGroup, ifTestType=ifTestType, ifGroups=ifGroups, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutOctets=ifOutOctets, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifTestStatus=ifTestStatus, ifStackHigherLayer=ifStackHigherLayer, ifTestCode=ifTestCode, ifCompliances=ifCompliances, ifInUcastPkts=ifInUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifTestTable=ifTestTable, ifOutNUcastPkts=ifOutNUcastPkts, ifOutQLen=ifOutQLen, ifHighSpeed=ifHighSpeed, ifStackStatus=ifStackStatus, ifXTable=ifXTable, ifInOctets=ifInOctets, ifLastChange=ifLastChange, ifRcvAddressType=ifRcvAddressType, ifHCOutOctets=ifHCOutOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutDiscards=ifOutDiscards)
