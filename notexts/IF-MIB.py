...
RowStatus, AutonomousType, TruthValue, TextualConvention, PhysAddress, DisplayString, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TruthValue", "TextualConvention", "PhysAddress", "DisplayString", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifOutUcastPkts=ifOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifOutErrors=ifOutErrors, ifType=ifType, ifCompliances=ifCompliances, ifXEntry=ifXEntry, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTable=ifTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInOctets=ifInOctets, ifStackGroup=ifStackGroup, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAlias=ifAlias, ifHCInOctets=ifHCInOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifStackEntry=ifStackEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifXTable=ifXTable, ifRcvAddressTable=ifRcvAddressTable, ifHCInUcastPkts=ifHCInUcastPkts, ifPromiscuousMode=ifPromiscuousMode, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifDescr=ifDescr, OwnerString=OwnerString, ifPacketGroup=ifPacketGroup, ifCompliance2=ifCompliance2, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifSpeed=ifSpeed, ifTestResult=ifTestResult, ifInDiscards=ifInDiscards, ifTestEntry=ifTestEntry, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifMIB=ifMIB, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifStackLastChange=ifStackLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifIndex=ifIndex, ifStackStatus=ifStackStatus, ifName=ifName, ifTableLastChange=ifTableLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, ifPhysAddress=ifPhysAddress, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifSpecific=ifSpecific, ifRcvAddressGroup=ifRcvAddressGroup, ifOutDiscards=ifOutDiscards, ifStackTable=ifStackTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifTestOwner=ifTestOwner, ifStackGroup2=ifStackGroup2, ifTestGroup=ifTestGroup, ifHCPacketGroup=ifHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifStackLowerLayer=ifStackLowerLayer, ifInErrors=ifInErrors, ifConformance=ifConformance, ifTestCode=ifTestCode, linkDown=linkDown, ifAdminStatus=ifAdminStatus)
