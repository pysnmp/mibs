...
RowStatus, TextualConvention, TestAndIncr, AutonomousType, TruthValue, DisplayString, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TestAndIncr", "AutonomousType", "TruthValue", "DisplayString", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackEntry=ifStackEntry, ifCompliance3=ifCompliance3, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralGroup=ifGeneralGroup, ifTestTable=ifTestTable, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifMIB=ifMIB, ifTestCode=ifTestCode, ifStackLastChange=ifStackLastChange, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, OwnerString=OwnerString, ifOutNUcastPkts=ifOutNUcastPkts, ifOperStatus=ifOperStatus, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestType=ifTestType, ifTestGroup=ifTestGroup, ifInUcastPkts=ifInUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConformance=ifConformance, ifTable=ifTable, ifHighSpeed=ifHighSpeed, ifTestResult=ifTestResult, ifPacketGroup=ifPacketGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifLastChange=ifLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutQLen=ifOutQLen, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifEntry=ifEntry, ifHCPacketGroup=ifHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifOutMulticastPkts=ifOutMulticastPkts, linkDown=linkDown, ifTestEntry=ifTestEntry, ifHCOutOctets=ifHCOutOctets, ifTestId=ifTestId, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance=ifCompliance, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry, ifAlias=ifAlias, ifStackGroup2=ifStackGroup2, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, ifOutDiscards=ifOutDiscards, ifHCInOctets=ifHCInOctets, ifXTable=ifXTable, ifTableLastChange=ifTableLastChange, ifStackTable=ifStackTable, ifMtu=ifMtu, ifIndex=ifIndex, ifInUnknownProtos=ifInUnknownProtos, ifStackGroup=ifStackGroup, ifCompliance2=ifCompliance2, ifTestOwner=ifTestOwner, ifType=ifType, ifInErrors=ifInErrors, linkUp=linkUp, ifCompliances=ifCompliances, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestStatus=ifTestStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifStackLowerLayer=ifStackLowerLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInOctets=ifInOctets, ifDescr=ifDescr, ifSpeed=ifSpeed, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifSpecific=ifSpecific, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressStatus=ifRcvAddressStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, PYSNMP_MODULE_ID=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifOutUcastPkts=ifOutUcastPkts)
