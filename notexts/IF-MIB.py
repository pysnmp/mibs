...
DisplayString, TestAndIncr, AutonomousType, RowStatus, PhysAddress, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "AutonomousType", "RowStatus", "PhysAddress", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifMIB=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance=ifCompliance, ifGroups=ifGroups, linkUp=linkUp, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifStackTable=ifStackTable, ifTestResult=ifTestResult, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, interfaces=interfaces, ifRcvAddressAddress=ifRcvAddressAddress, ifStackGroup=ifStackGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifPacketGroup=ifPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifInOctets=ifInOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifGeneralGroup=ifGeneralGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutQLen=ifOutQLen, linkDown=linkDown, ifName=ifName, ifOutOctets=ifOutOctets, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifStackStatus=ifStackStatus, ifTestStatus=ifTestStatus, ifPromiscuousMode=ifPromiscuousMode, ifType=ifType, ifHCOutOctets=ifHCOutOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIBObjects=ifMIBObjects, ifDescr=ifDescr, InterfaceIndex=InterfaceIndex, ifAlias=ifAlias, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInOctets=ifHCInOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCompliance2=ifCompliance2, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifHCPacketGroup=ifHCPacketGroup, ifTestOwner=ifTestOwner, ifOperStatus=ifOperStatus, ifInErrors=ifInErrors, ifRcvAddressTable=ifRcvAddressTable, OwnerString=OwnerString, ifIndex=ifIndex, ifTestId=ifTestId, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestType=ifTestType, ifInUnknownProtos=ifInUnknownProtos, ifNumber=ifNumber, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifLastChange=ifLastChange, ifCompliances=ifCompliances, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressEntry=ifRcvAddressEntry, ifMtu=ifMtu, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifStackEntry=ifStackEntry, ifStackGroup2=ifStackGroup2, ifSpeed=ifSpeed, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifTestTable=ifTestTable, ifXEntry=ifXEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestCode=ifTestCode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry, ifTestGroup=ifTestGroup, ifVHCPacketGroup=ifVHCPacketGroup)
