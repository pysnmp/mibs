...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, ModuleIdentity, Counter32, TimeTicks, Unsigned32, IpAddress, Bits, NotificationType, MibIdentifier, Integer32, Gauge32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "IpAddress", "Bits", "NotificationType", "MibIdentifier", "Integer32", "Gauge32", "iso", "ObjectIdentity")
TextualConvention, TestAndIncr, TimeStamp, DisplayString, PhysAddress, AutonomousType, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TestAndIncr", "TimeStamp", "DisplayString", "PhysAddress", "AutonomousType", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressAddress=ifRcvAddressAddress, ifInErrors=ifInErrors, InterfaceIndex=InterfaceIndex, ifOutNUcastPkts=ifOutNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifType=ifType, ifMtu=ifMtu, ifTestGroup=ifTestGroup, ifHCInOctets=ifHCInOctets, ifGeneralGroup=ifGeneralGroup, ifTestId=ifTestId, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifPromiscuousMode=ifPromiscuousMode, ifCompliance=ifCompliance, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifGroups=ifGroups, ifPacketGroup=ifPacketGroup, ifStackHigherLayer=ifStackHigherLayer, interfaces=interfaces, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestStatus=ifTestStatus, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifCompliance3=ifCompliance3, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInOctets=ifInOctets, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackTable=ifStackTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifEntry=ifEntry, ifInNUcastPkts=ifInNUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifPhysAddress=ifPhysAddress, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutOctets=ifHCOutOctets, ifTestEntry=ifTestEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifNumber=ifNumber, ifLastChange=ifLastChange, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifConnectorPresent=ifConnectorPresent, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInBroadcastPkts=ifInBroadcastPkts, ifConformance=ifConformance, ifOutUcastPkts=ifOutUcastPkts, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifRcvAddressType=ifRcvAddressType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutOctets=ifOutOctets, ifCompliances=ifCompliances, ifCompliance2=ifCompliance2, linkDown=linkDown, ifRcvAddressEntry=ifRcvAddressEntry, ifTestResult=ifTestResult, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifOperStatus=ifOperStatus, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, ifStackGroup2=ifStackGroup2, OwnerString=OwnerString, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIB=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifInMulticastPkts=ifInMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifTable=ifTable, ifName=ifName, ifHCPacketGroup=ifHCPacketGroup, ifAdminStatus=ifAdminStatus, ifStackEntry=ifStackEntry, PYSNMP_MODULE_ID=ifMIB, ifTestCode=ifTestCode)
