...
RowStatus, TestAndIncr, PhysAddress, TruthValue, AutonomousType, TextualConvention, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TestAndIncr", "PhysAddress", "TruthValue", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifStackTable=ifStackTable, ifStackEntry=ifStackEntry, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifOperStatus=ifOperStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutOctets=ifOutOctets, ifTable=ifTable, ifTestType=ifTestType, ifStackGroup2=ifStackGroup2, ifCompliances=ifCompliances, ifStackStatus=ifStackStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInUnknownProtos=ifInUnknownProtos, ifSpecific=ifSpecific, ifTestGroup=ifTestGroup, ifType=ifType, ifPhysAddress=ifPhysAddress, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifInMulticastPkts=ifInMulticastPkts, ifCompliance=ifCompliance, ifHCInUcastPkts=ifHCInUcastPkts, ifConnectorPresent=ifConnectorPresent, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, ifTestTable=ifTestTable, ifFixedLengthGroup=ifFixedLengthGroup, linkUp=linkUp, ifRcvAddressAddress=ifRcvAddressAddress, ifInErrors=ifInErrors, ifTestResult=ifTestResult, ifOutNUcastPkts=ifOutNUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, InterfaceIndex=InterfaceIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifTestCode=ifTestCode, ifAlias=ifAlias, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifInOctets=ifInOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifConformance=ifConformance, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifHighSpeed=ifHighSpeed, ifStackGroup=ifStackGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTestOwner=ifTestOwner, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, linkDown=linkDown, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressTable=ifRcvAddressTable, OwnerString=OwnerString, ifGroups=ifGroups, ifOutDiscards=ifOutDiscards, ifOutQLen=ifOutQLen, ifName=ifName, ifXTable=ifXTable, ifInDiscards=ifInDiscards, ifOutErrors=ifOutErrors, ifCompliance2=ifCompliance2, PYSNMP_MODULE_ID=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifMIBObjects=ifMIBObjects, ifEntry=ifEntry, interfaces=interfaces, ifMtu=ifMtu, ifNumber=ifNumber, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAdminStatus=ifAdminStatus, ifCompliance3=ifCompliance3, ifXEntry=ifXEntry, ifStackHigherLayer=ifStackHigherLayer, ifHCOutOctets=ifHCOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifInNUcastPkts=ifInNUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
