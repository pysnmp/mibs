...
TextualConvention, DisplayString, PhysAddress, TruthValue, AutonomousType, TimeStamp, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "PhysAddress", "TruthValue", "AutonomousType", "TimeStamp", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressType=ifRcvAddressType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifXEntry=ifXEntry, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifAlias=ifAlias, ifXTable=ifXTable, ifInErrors=ifInErrors, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifStackGroup=ifStackGroup, ifHCInOctets=ifHCInOctets, ifHighSpeed=ifHighSpeed, ifAdminStatus=ifAdminStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMIBObjects=ifMIBObjects, ifOutDiscards=ifOutDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifType=ifType, ifTable=ifTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUp=linkUp, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralGroup=ifGeneralGroup, ifOutOctets=ifOutOctets, ifOperStatus=ifOperStatus, ifTestType=ifTestType, ifCompliance3=ifCompliance3, ifOutQLen=ifOutQLen, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifTestTable=ifTestTable, ifCompliance=ifCompliance, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInDiscards=ifInDiscards, ifMtu=ifMtu, ifRcvAddressEntry=ifRcvAddressEntry, ifStackTable=ifStackTable, ifNumber=ifNumber, interfaces=interfaces, ifHCPacketGroup=ifHCPacketGroup, ifStackEntry=ifStackEntry, InterfaceIndex=InterfaceIndex, ifCompliances=ifCompliances, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifInUnknownProtos=ifInUnknownProtos, ifConnectorPresent=ifConnectorPresent, ifHCOutOctets=ifHCOutOctets, ifSpeed=ifSpeed, ifStackLastChange=ifStackLastChange, ifTestStatus=ifTestStatus, OwnerString=OwnerString, ifInOctets=ifInOctets, ifTableLastChange=ifTableLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifTestGroup=ifTestGroup, ifMIB=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifTestResult=ifTestResult, ifPromiscuousMode=ifPromiscuousMode, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifGroups=ifGroups, ifRcvAddressAddress=ifRcvAddressAddress, ifInUcastPkts=ifInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, PYSNMP_MODULE_ID=ifMIB, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkDown=linkDown, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifName=ifName, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestEntry=ifTestEntry, ifTestCode=ifTestCode, ifInMulticastPkts=ifInMulticastPkts, ifSpecific=ifSpecific, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifPhysAddress=ifPhysAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup)
