...
TestAndIncr, RowStatus, TimeStamp, TruthValue, PhysAddress, DisplayString, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "TimeStamp", "TruthValue", "PhysAddress", "DisplayString", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPhysAddress=ifPhysAddress, ifOutUcastPkts=ifOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifInMulticastPkts=ifInMulticastPkts, ifMIB=ifMIB, ifStackStatus=ifStackStatus, ifNumber=ifNumber, ifPacketGroup=ifPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutOctets=ifHCOutOctets, ifConnectorPresent=ifConnectorPresent, ifTableLastChange=ifTableLastChange, ifType=ifType, ifRcvAddressStatus=ifRcvAddressStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestEntry=ifTestEntry, ifRcvAddressType=ifRcvAddressType, ifTestOwner=ifTestOwner, ifMIBObjects=ifMIBObjects, ifIndex=ifIndex, linkUp=linkUp, InterfaceIndex=InterfaceIndex, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifInErrors=ifInErrors, ifTestStatus=ifTestStatus, ifAdminStatus=ifAdminStatus, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifName=ifName, ifTestType=ifTestType, ifStackGroup=ifStackGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOperStatus=ifOperStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutDiscards=ifOutDiscards, ifGeneralGroup=ifGeneralGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifXEntry=ifXEntry, ifRcvAddressGroup=ifRcvAddressGroup, linkDown=linkDown, OwnerString=OwnerString, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTable=ifTable, ifStackEntry=ifStackEntry, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressEntry=ifRcvAddressEntry, ifTestResult=ifTestResult, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLastChange=ifLastChange, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifInDiscards=ifInDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutErrors=ifOutErrors, ifEntry=ifEntry, ifTestTable=ifTestTable, ifDescr=ifDescr, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance=ifCompliance, ifOutOctets=ifOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifTestId=ifTestId, ifAlias=ifAlias, ifStackHigherLayer=ifStackHigherLayer, ifGroups=ifGroups, ifInNUcastPkts=ifInNUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifHighSpeed=ifHighSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifStackTable=ifStackTable, ifVHCPacketGroup=ifVHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConformance=ifConformance, ifTestCode=ifTestCode, ifOutQLen=ifOutQLen, interfaces=interfaces, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifCompliance2=ifCompliance2, ifSpecific=ifSpecific, ifCompliance3=ifCompliance3, ifStackLastChange=ifStackLastChange, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts)
