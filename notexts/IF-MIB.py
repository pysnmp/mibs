...
TestAndIncr, DisplayString, PhysAddress, TextualConvention, AutonomousType, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "PhysAddress", "TextualConvention", "AutonomousType", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXTable=ifXTable, ifOutMulticastPkts=ifOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifType=ifType, ifDescr=ifDescr, ifTestEntry=ifTestEntry, ifInOctets=ifInOctets, ifEntry=ifEntry, ifHighSpeed=ifHighSpeed, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInOctets=ifHCInOctets, ifTableLastChange=ifTableLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifName=ifName, ifLastChange=ifLastChange, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestId=ifTestId, ifConnectorPresent=ifConnectorPresent, ifCompliances=ifCompliances, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLastChange=ifStackLastChange, ifSpecific=ifSpecific, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCPacketGroup=ifHCPacketGroup, linkDown=linkDown, OwnerString=OwnerString, ifStackGroup2=ifStackGroup2, ifRcvAddressType=ifRcvAddressType, ifPhysAddress=ifPhysAddress, ifRcvAddressAddress=ifRcvAddressAddress, ifGroups=ifGroups, ifStackGroup=ifStackGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifTestResult=ifTestResult, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInDiscards=ifInDiscards, ifConformance=ifConformance, PYSNMP_MODULE_ID=ifMIB, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifAlias=ifAlias, ifPromiscuousMode=ifPromiscuousMode, ifCompliance3=ifCompliance3, ifTable=ifTable, ifStackEntry=ifStackEntry, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, ifRcvAddressStatus=ifRcvAddressStatus, linkUp=linkUp, ifFixedLengthGroup=ifFixedLengthGroup, ifIndex=ifIndex, ifPacketGroup=ifPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackTable=ifStackTable, ifMtu=ifMtu, ifTestCode=ifTestCode, ifMIB=ifMIB, ifHCOutOctets=ifHCOutOctets, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInErrors=ifInErrors, ifTestOwner=ifTestOwner, ifTestStatus=ifTestStatus, ifOutDiscards=ifOutDiscards, ifInNUcastPkts=ifInNUcastPkts, ifXEntry=ifXEntry, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifTestType=ifTestType, ifOutOctets=ifOutOctets, ifAdminStatus=ifAdminStatus, ifOutErrors=ifOutErrors, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifCompliance2=ifCompliance2, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutQLen=ifOutQLen, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts)
