...
PhysAddress, TextualConvention, TestAndIncr, RowStatus, DisplayString, TimeStamp, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "TestAndIncr", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifInDiscards=ifInDiscards, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, linkUp=linkUp, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndex=InterfaceIndex, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMtu=ifMtu, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifInOctets=ifInOctets, ifConnectorPresent=ifConnectorPresent, ifPacketGroup=ifPacketGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXTable=ifXTable, ifAdminStatus=ifAdminStatus, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifTestStatus=ifTestStatus, OwnerString=OwnerString, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, ifType=ifType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHighSpeed=ifHighSpeed, ifOutUcastPkts=ifOutUcastPkts, ifHCInOctets=ifHCInOctets, ifStackEntry=ifStackEntry, ifInErrors=ifInErrors, ifRcvAddressType=ifRcvAddressType, ifMIBObjects=ifMIBObjects, ifMIB=ifMIB, ifName=ifName, ifSpeed=ifSpeed, linkDown=linkDown, ifStackStatus=ifStackStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGroups=ifGroups, ifSpecific=ifSpecific, ifStackLastChange=ifStackLastChange, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifLastChange=ifLastChange, ifOperStatus=ifOperStatus, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifConformance=ifConformance, ifDescr=ifDescr, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestType=ifTestType, ifCompliances=ifCompliances, ifStackGroup=ifStackGroup, ifPromiscuousMode=ifPromiscuousMode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifIndex=ifIndex, ifPhysAddress=ifPhysAddress, ifOutDiscards=ifOutDiscards, ifTestGroup=ifTestGroup, ifOutQLen=ifOutQLen, ifTestCode=ifTestCode, ifOutErrors=ifOutErrors, ifTestId=ifTestId, ifCompliance3=ifCompliance3, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup2=ifStackGroup2, interfaces=interfaces, ifCompliance2=ifCompliance2, ifInUnknownProtos=ifInUnknownProtos, ifInMulticastPkts=ifInMulticastPkts, ifTable=ifTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance=ifCompliance, ifInUcastPkts=ifInUcastPkts, ifNumber=ifNumber, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutOctets=ifHCOutOctets, ifTestTable=ifTestTable, ifTestEntry=ifTestEntry)
