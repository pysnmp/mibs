...
ModuleIdentity, Counter64, Bits, iso, ObjectIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Gauge32, NotificationType, mib_2, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Gauge32", "NotificationType", "mib-2", "IpAddress", "Counter32")
TestAndIncr, PhysAddress, TimeStamp, AutonomousType, TruthValue, TextualConvention, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "PhysAddress", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, ifTestGroup=ifTestGroup, ifInOctets=ifInOctets, ifStackHigherLayer=ifStackHigherLayer, ifPacketGroup=ifPacketGroup, ifRcvAddressType=ifRcvAddressType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, ifEntry=ifEntry, ifTestCode=ifTestCode, interfaces=interfaces, ifHCOutMulticastPkts=ifHCOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifGroups=ifGroups, ifStackEntry=ifStackEntry, ifRcvAddressTable=ifRcvAddressTable, ifTestEntry=ifTestEntry, ifMIBObjects=ifMIBObjects, ifNumber=ifNumber, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifFixedLengthGroup=ifFixedLengthGroup, ifTestTable=ifTestTable, ifOldObjectsGroup=ifOldObjectsGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifName=ifName, ifInErrors=ifInErrors, ifXEntry=ifXEntry, ifTable=ifTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpecific=ifSpecific, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutErrors=ifOutErrors, ifTestResult=ifTestResult, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutOctets=ifHCOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifOutMulticastPkts=ifOutMulticastPkts, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifHCInUcastPkts=ifHCInUcastPkts, linkUp=linkUp, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXTable=ifXTable, ifInUnknownProtos=ifInUnknownProtos, ifStackLastChange=ifStackLastChange, ifOutUcastPkts=ifOutUcastPkts, ifOutOctets=ifOutOctets, ifMIB=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifGeneralGroup=ifGeneralGroup, InterfaceIndex=InterfaceIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifConformance=ifConformance, ifStackGroup2=ifStackGroup2, ifPromiscuousMode=ifPromiscuousMode, ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance=ifCompliance, ifLastChange=ifLastChange, ifCompliance2=ifCompliance2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifAdminStatus=ifAdminStatus, ifOperStatus=ifOperStatus, ifOutDiscards=ifOutDiscards, ifTestId=ifTestId, ifInDiscards=ifInDiscards, ifMtu=ifMtu, ifConnectorPresent=ifConnectorPresent, ifIndex=ifIndex, ifHighSpeed=ifHighSpeed, ifStackGroup=ifStackGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifInUcastPkts=ifInUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifTestType=ifTestType, OwnerString=OwnerString, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifType=ifType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutBroadcastPkts=ifOutBroadcastPkts)
