...
TimeTicks, iso, Bits, NotificationType, Integer32, IpAddress, Counter64, Gauge32, mib_2, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "NotificationType", "Integer32", "IpAddress", "Counter64", "Gauge32", "mib-2", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ModuleIdentity")
AutonomousType, TestAndIncr, DisplayString, TextualConvention, RowStatus, TruthValue, TimeStamp, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "DisplayString", "TextualConvention", "RowStatus", "TruthValue", "TimeStamp", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifHCPacketGroup=ifHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralGroup=ifGeneralGroup, ifInNUcastPkts=ifInNUcastPkts, linkUp=linkUp, ifTestEntry=ifTestEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifCompliance2=ifCompliance2, ifStackLastChange=ifStackLastChange, ifOutUcastPkts=ifOutUcastPkts, linkDown=linkDown, OwnerString=OwnerString, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifOutDiscards=ifOutDiscards, ifCompliance=ifCompliance, ifEntry=ifEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestGroup=ifTestGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifMIB=ifMIB, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAlias=ifAlias, ifInUcastPkts=ifInUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifType=ifType, ifInMulticastPkts=ifInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifInBroadcastPkts=ifInBroadcastPkts, interfaces=interfaces, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTable=ifTable, ifIndex=ifIndex, ifName=ifName, ifTestOwner=ifTestOwner, ifMtu=ifMtu, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifStackStatus=ifStackStatus, ifTestResult=ifTestResult, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutQLen=ifOutQLen, ifInDiscards=ifInDiscards, ifRcvAddressTable=ifRcvAddressTable, ifOperStatus=ifOperStatus, ifMIBObjects=ifMIBObjects, ifOldObjectsGroup=ifOldObjectsGroup, ifStackEntry=ifStackEntry, ifRcvAddressType=ifRcvAddressType, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifHCInOctets=ifHCInOctets, ifPromiscuousMode=ifPromiscuousMode, ifTestId=ifTestId, ifXTable=ifXTable, ifSpecific=ifSpecific, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackTable=ifStackTable, ifRcvAddressEntry=ifRcvAddressEntry, ifGroups=ifGroups, PYSNMP_MODULE_ID=ifMIB, ifInErrors=ifInErrors, ifDescr=ifDescr, ifTestCode=ifTestCode, ifPhysAddress=ifPhysAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifPacketGroup=ifPacketGroup, ifTestTable=ifTestTable, ifOutOctets=ifOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInUcastPkts=ifHCInUcastPkts, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestStatus=ifTestStatus, ifLastChange=ifLastChange, ifInOctets=ifInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifHCOutOctets=ifHCOutOctets, ifStackGroup2=ifStackGroup2)
