...
DisplayString, TruthValue, TestAndIncr, TimeStamp, AutonomousType, RowStatus, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TestAndIncr", "TimeStamp", "AutonomousType", "RowStatus", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", PYSNMP_MODULE_ID=ifMIB, ifInOctets=ifInOctets, ifTestResult=ifTestResult, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifOutNUcastPkts=ifOutNUcastPkts, ifType=ifType, ifInNUcastPkts=ifInNUcastPkts, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifStackHigherLayer=ifStackHigherLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifIndex=ifIndex, ifStackGroup=ifStackGroup, ifTestGroup=ifTestGroup, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifGroups=ifGroups, ifLastChange=ifLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInOctets=ifHCInOctets, ifOldObjectsGroup=ifOldObjectsGroup, interfaces=interfaces, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, linkDown=linkDown, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifCompliance=ifCompliance, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutOctets=ifOutOctets, ifNumber=ifNumber, ifAdminStatus=ifAdminStatus, ifOutErrors=ifOutErrors, ifMIB=ifMIB, ifEntry=ifEntry, ifHighSpeed=ifHighSpeed, ifTestType=ifTestType, ifOutQLen=ifOutQLen, ifCompliance2=ifCompliance2, ifTestStatus=ifTestStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifDescr=ifDescr, ifTestCode=ifTestCode, ifOutUcastPkts=ifOutUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXTable=ifXTable, ifHCInUcastPkts=ifHCInUcastPkts, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliances=ifCompliances, ifGeneralGroup=ifGeneralGroup, ifTable=ifTable, ifSpeed=ifSpeed, ifConnectorPresent=ifConnectorPresent, ifInUcastPkts=ifInUcastPkts, ifInDiscards=ifInDiscards, OwnerString=OwnerString, ifXEntry=ifXEntry, ifMtu=ifMtu, ifTestOwner=ifTestOwner, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifTestTable=ifTestTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, ifAlias=ifAlias, linkUp=linkUp, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup)
