...
DisplayString, TestAndIncr, TextualConvention, RowStatus, TruthValue, AutonomousType, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "TextualConvention", "RowStatus", "TruthValue", "AutonomousType", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifGeneralInformationGroup=ifGeneralInformationGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTable=ifTable, ifStackHigherLayer=ifStackHigherLayer, ifTestCode=ifTestCode, ifMIBObjects=ifMIBObjects, ifPacketGroup=ifPacketGroup, ifHighSpeed=ifHighSpeed, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifRcvAddressAddress=ifRcvAddressAddress, ifInErrors=ifInErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifIndex=ifIndex, ifTestTable=ifTestTable, InterfaceIndex=InterfaceIndex, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, OwnerString=OwnerString, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, PYSNMP_MODULE_ID=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConnectorPresent=ifConnectorPresent, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance=ifCompliance, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifType=ifType, ifCompliance2=ifCompliance2, ifFixedLengthGroup=ifFixedLengthGroup, ifAlias=ifAlias, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, interfaces=interfaces, ifPhysAddress=ifPhysAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifTestId=ifTestId, ifName=ifName, ifTestResult=ifTestResult, ifTableLastChange=ifTableLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifMtu=ifMtu, ifNumber=ifNumber, ifVHCPacketGroup=ifVHCPacketGroup, ifMIB=ifMIB, ifDescr=ifDescr, ifInMulticastPkts=ifInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup=ifStackGroup, ifInOctets=ifInOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifTestEntry=ifTestEntry, ifRcvAddressType=ifRcvAddressType, ifHCInOctets=ifHCInOctets, ifXTable=ifXTable, ifInNUcastPkts=ifInNUcastPkts, ifTestOwner=ifTestOwner, ifRcvAddressStatus=ifRcvAddressStatus, ifConformance=ifConformance, ifGroups=ifGroups, ifSpeed=ifSpeed, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliance3=ifCompliance3, ifStackStatus=ifStackStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifInDiscards=ifInDiscards, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifEntry=ifEntry, ifOutDiscards=ifOutDiscards, linkDown=linkDown, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutOctets=ifOutOctets, ifGeneralGroup=ifGeneralGroup, ifStackGroup2=ifStackGroup2, ifOperStatus=ifOperStatus, linkUp=linkUp, ifTestGroup=ifTestGroup, ifPromiscuousMode=ifPromiscuousMode, ifTestType=ifTestType, ifStackEntry=ifStackEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifStackLowerLayer=ifStackLowerLayer, ifOutErrors=ifOutErrors, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifCompliances=ifCompliances)
