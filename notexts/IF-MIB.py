...
MibIdentifier, NotificationType, TimeTicks, IpAddress, Counter64, Unsigned32, ModuleIdentity, Counter32, mib_2, Integer32, Bits, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "mib-2", "Integer32", "Bits", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TimeStamp, TextualConvention, AutonomousType, TruthValue, PhysAddress, TestAndIncr, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "AutonomousType", "TruthValue", "PhysAddress", "TestAndIncr", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifDescr=ifDescr, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralGroup=ifGeneralGroup, ifTableLastChange=ifTableLastChange, ifRcvAddressType=ifRcvAddressType, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGroups=ifGroups, ifStackEntry=ifStackEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifOutQLen=ifOutQLen, PYSNMP_MODULE_ID=ifMIB, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifLastChange=ifLastChange, ifInNUcastPkts=ifInNUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressGroup=ifRcvAddressGroup, ifStackGroup=ifStackGroup, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifCompliance=ifCompliance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifHCPacketGroup=ifHCPacketGroup, linkDown=linkDown, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpecific=ifSpecific, ifAlias=ifAlias, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifVHCPacketGroup=ifVHCPacketGroup, ifTestResult=ifTestResult, ifStackStatus=ifStackStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, OwnerString=OwnerString, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup2=ifStackGroup2, ifType=ifType, ifOutDiscards=ifOutDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifOutUcastPkts=ifOutUcastPkts, ifXEntry=ifXEntry, ifCompliance3=ifCompliance3, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifPacketGroup=ifPacketGroup, ifPhysAddress=ifPhysAddress, ifCompliances=ifCompliances, ifMIB=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifTestId=ifTestId, ifTestGroup=ifTestGroup, ifXTable=ifXTable, ifStackTable=ifStackTable, ifIndex=ifIndex, ifName=ifName, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifConformance=ifConformance, ifHighSpeed=ifHighSpeed, ifNumber=ifNumber, ifCompliance2=ifCompliance2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMtu=ifMtu, ifTestStatus=ifTestStatus, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifTestType=ifTestType, ifEntry=ifEntry, linkUp=linkUp, ifTable=ifTable, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifInErrors=ifInErrors, ifOutOctets=ifOutOctets, ifTestOwner=ifTestOwner, ifTestCode=ifTestCode, ifInOctets=ifInOctets, ifOperStatus=ifOperStatus, ifInUnknownProtos=ifInUnknownProtos, ifConnectorPresent=ifConnectorPresent, ifStackLastChange=ifStackLastChange)
