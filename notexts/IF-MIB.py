...
TruthValue, TestAndIncr, AutonomousType, TimeStamp, PhysAddress, DisplayString, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "AutonomousType", "TimeStamp", "PhysAddress", "DisplayString", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackTable=ifStackTable, ifMIB=ifMIB, ifName=ifName, ifTable=ifTable, ifOutUcastPkts=ifOutUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifVHCPacketGroup=ifVHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup2=ifStackGroup2, ifFixedLengthGroup=ifFixedLengthGroup, ifOperStatus=ifOperStatus, ifStackEntry=ifStackEntry, ifStackLastChange=ifStackLastChange, ifInUcastPkts=ifInUcastPkts, ifConformance=ifConformance, PYSNMP_MODULE_ID=ifMIB, ifSpeed=ifSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutDiscards=ifOutDiscards, ifPhysAddress=ifPhysAddress, ifAlias=ifAlias, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressTable=ifRcvAddressTable, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifHighSpeed=ifHighSpeed, InterfaceIndex=InterfaceIndex, ifTestResult=ifTestResult, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifTestEntry=ifTestEntry, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup=ifStackGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifGroups=ifGroups, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestOwner=ifTestOwner, ifXEntry=ifXEntry, ifLastChange=ifLastChange, ifCompliance3=ifCompliance3, ifInErrors=ifInErrors, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifInOctets=ifInOctets, ifDescr=ifDescr, ifMtu=ifMtu, ifConnectorPresent=ifConnectorPresent, ifHCInOctets=ifHCInOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifInDiscards=ifInDiscards, OwnerString=OwnerString, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifStackHigherLayer=ifStackHigherLayer, ifTestTable=ifTestTable, ifEntry=ifEntry, ifTableLastChange=ifTableLastChange, ifXTable=ifXTable, ifTestStatus=ifTestStatus, ifType=ifType, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, interfaces=interfaces, ifHCInUcastPkts=ifHCInUcastPkts, ifTestGroup=ifTestGroup, ifGeneralGroup=ifGeneralGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpecific=ifSpecific, ifTestType=ifTestType, ifInUnknownProtos=ifInUnknownProtos, ifOutQLen=ifOutQLen, ifCompliances=ifCompliances, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance=ifCompliance)
