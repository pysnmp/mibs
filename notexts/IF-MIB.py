...
ModuleIdentity, Counter64, NotificationType, Bits, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Integer32, Counter32, ObjectIdentity, TimeTicks, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "Bits", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Integer32", "Counter32", "ObjectIdentity", "TimeTicks", "mib-2", "Gauge32")
TextualConvention, PhysAddress, TestAndIncr, DisplayString, TruthValue, TimeStamp, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "TestAndIncr", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifAdminStatus=ifAdminStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, InterfaceIndex=InterfaceIndex, ifInUnknownProtos=ifInUnknownProtos, ifCompliance=ifCompliance, ifHCPacketGroup=ifHCPacketGroup, ifSpeed=ifSpeed, ifOutErrors=ifOutErrors, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifSpecific=ifSpecific, ifRcvAddressTable=ifRcvAddressTable, ifName=ifName, ifMIB=ifMIB, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHighSpeed=ifHighSpeed, ifInErrors=ifInErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestCode=ifTestCode, ifOutDiscards=ifOutDiscards, ifGroups=ifGroups, ifRcvAddressEntry=ifRcvAddressEntry, ifTable=ifTable, ifTestOwner=ifTestOwner, ifAlias=ifAlias, ifPacketGroup=ifPacketGroup, linkUp=linkUp, ifHCOutOctets=ifHCOutOctets, ifStackGroup=ifStackGroup, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestStatus=ifTestStatus, linkDown=linkDown, ifStackStatus=ifStackStatus, ifCompliances=ifCompliances, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPhysAddress=ifPhysAddress, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, interfaces=interfaces, ifType=ifType, ifTestType=ifTestType, ifOutUcastPkts=ifOutUcastPkts, ifTestGroup=ifTestGroup, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifMtu=ifMtu, OwnerString=OwnerString, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackTable=ifStackTable, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance2=ifCompliance2, ifPromiscuousMode=ifPromiscuousMode, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifLastChange=ifLastChange, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, ifInOctets=ifInOctets, ifGeneralGroup=ifGeneralGroup, PYSNMP_MODULE_ID=ifMIB, ifGeneralInformationGroup=ifGeneralInformationGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutNUcastPkts=ifOutNUcastPkts, ifEntry=ifEntry, ifXTable=ifXTable, ifNumber=ifNumber, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestTable=ifTestTable, ifVHCPacketGroup=ifVHCPacketGroup, ifOutOctets=ifOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifTestResult=ifTestResult, ifCompliance3=ifCompliance3, ifOldObjectsGroup=ifOldObjectsGroup, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIBObjects=ifMIBObjects, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifConformance=ifConformance, ifTableLastChange=ifTableLastChange)
