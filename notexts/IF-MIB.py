...
ObjectIdentity, Unsigned32, mib_2, NotificationType, Gauge32, Counter64, ModuleIdentity, Bits, TimeTicks, MibIdentifier, Counter32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "mib-2", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "Bits", "TimeTicks", "MibIdentifier", "Counter32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
AutonomousType, TestAndIncr, DisplayString, TextualConvention, TimeStamp, PhysAddress, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "DisplayString", "TextualConvention", "TimeStamp", "PhysAddress", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, OwnerString=OwnerString, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifTestType=ifTestType, ifType=ifType, ifPacketGroup=ifPacketGroup, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, ifConformance=ifConformance, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackLastChange=ifStackLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifGeneralGroup=ifGeneralGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, interfaces=interfaces, linkDown=linkDown, ifVHCPacketGroup=ifVHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifEntry=ifEntry, ifCompliance3=ifCompliance3, ifCompliance2=ifCompliance2, ifStackLowerLayer=ifStackLowerLayer, ifTable=ifTable, ifFixedLengthGroup=ifFixedLengthGroup, ifOperStatus=ifOperStatus, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifPhysAddress=ifPhysAddress, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestTable=ifTestTable, ifHCPacketGroup=ifHCPacketGroup, ifInDiscards=ifInDiscards, ifIndex=ifIndex, ifInUnknownProtos=ifInUnknownProtos, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifTableLastChange=ifTableLastChange, ifTestResult=ifTestResult, ifHighSpeed=ifHighSpeed, ifInErrors=ifInErrors, ifHCInOctets=ifHCInOctets, ifMIB=ifMIB, ifStackTable=ifStackTable, ifTestStatus=ifTestStatus, ifStackStatus=ifStackStatus, ifMtu=ifMtu, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifName=ifName, ifOutQLen=ifOutQLen, ifStackGroup=ifStackGroup, ifTestEntry=ifTestEntry, linkUp=linkUp, ifNumber=ifNumber, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestCode=ifTestCode, PYSNMP_MODULE_ID=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAlias=ifAlias, ifRcvAddressAddress=ifRcvAddressAddress, ifLastChange=ifLastChange, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackGroup2=ifStackGroup2, ifConnectorPresent=ifConnectorPresent, ifStackEntry=ifStackEntry, ifTestOwner=ifTestOwner, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifTestGroup=ifTestGroup, ifCompliances=ifCompliances, ifInUcastPkts=ifInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutDiscards=ifOutDiscards, ifSpecific=ifSpecific)
