...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifHCPacketGroup=ifHCPacketGroup, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifTestResult=ifTestResult, ifTable=ifTable, ifType=ifType, ifInUcastPkts=ifInUcastPkts, ifNumber=ifNumber, ifName=ifName, ifHCInUcastPkts=ifHCInUcastPkts, ifOutQLen=ifOutQLen, ifInMulticastPkts=ifInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifOperStatus=ifOperStatus, PYSNMP_MODULE_ID=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifTestGroup=ifTestGroup, ifInNUcastPkts=ifInNUcastPkts, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifAlias=ifAlias, ifStackStatus=ifStackStatus, ifCompliance3=ifCompliance3, ifTestOwner=ifTestOwner, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutErrors=ifOutErrors, ifGeneralGroup=ifGeneralGroup, linkDown=linkDown, ifPromiscuousMode=ifPromiscuousMode, ifOutMulticastPkts=ifOutMulticastPkts, ifTestId=ifTestId, ifEntry=ifEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifInDiscards=ifInDiscards, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifStackHigherLayer=ifStackHigherLayer, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifAdminStatus=ifAdminStatus, ifTestEntry=ifTestEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUp=linkUp, ifIndex=ifIndex, ifSpecific=ifSpecific, ifInOctets=ifInOctets, ifMIBObjects=ifMIBObjects, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, InterfaceIndex=InterfaceIndex, ifCompliances=ifCompliances, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup2=ifStackGroup2, ifStackLastChange=ifStackLastChange, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifVHCPacketGroup=ifVHCPacketGroup, ifOutOctets=ifOutOctets, ifTestTable=ifTestTable, ifStackTable=ifStackTable, ifMtu=ifMtu, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifXTable=ifXTable, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifTestCode=ifTestCode, ifGroups=ifGroups, ifXEntry=ifXEntry, ifInErrors=ifInErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifOutUcastPkts=ifOutUcastPkts, ifSpeed=ifSpeed, ifStackGroup=ifStackGroup, ifMIB=ifMIB, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifLastChange=ifLastChange)
