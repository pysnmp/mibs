...
ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, iso, Gauge32, Counter32, Counter64, MibIdentifier, TimeTicks, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "iso", "Gauge32", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits")
TestAndIncr, TextualConvention, PhysAddress, TimeStamp, DisplayString, TruthValue, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "PhysAddress", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndex=InterfaceIndex, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifStackLastChange=ifStackLastChange, ifOutUcastPkts=ifOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackGroup2=ifStackGroup2, ifTestResult=ifTestResult, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifOutDiscards=ifOutDiscards, ifCompliances=ifCompliances, ifStackEntry=ifStackEntry, ifInUcastPkts=ifInUcastPkts, ifOperStatus=ifOperStatus, ifDescr=ifDescr, ifHighSpeed=ifHighSpeed, ifTestId=ifTestId, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifFixedLengthGroup=ifFixedLengthGroup, ifConnectorPresent=ifConnectorPresent, ifTestGroup=ifTestGroup, ifInErrors=ifInErrors, ifHCInOctets=ifHCInOctets, ifOutErrors=ifOutErrors, ifName=ifName, ifTestTable=ifTestTable, ifAdminStatus=ifAdminStatus, ifEntry=ifEntry, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance=ifCompliance, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifIndex=ifIndex, ifOutOctets=ifOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInDiscards=ifInDiscards, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestStatus=ifTestStatus, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifInMulticastPkts=ifInMulticastPkts, ifPhysAddress=ifPhysAddress, ifCompliance3=ifCompliance3, PYSNMP_MODULE_ID=ifMIB, ifMIB=ifMIB, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConformance=ifConformance, ifTable=ifTable, ifTestCode=ifTestCode, ifMtu=ifMtu, ifInOctets=ifInOctets, ifInNUcastPkts=ifInNUcastPkts, ifHCOutOctets=ifHCOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackStatus=ifStackStatus, ifNumber=ifNumber, ifGroups=ifGroups, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifXEntry=ifXEntry, ifRcvAddressTable=ifRcvAddressTable, ifCompliance2=ifCompliance2, ifStackTable=ifStackTable, ifOldObjectsGroup=ifOldObjectsGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifHCInUcastPkts=ifHCInUcastPkts)
