...
Integer32, Bits, Counter64, IpAddress, MibIdentifier, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter64", "IpAddress", "MibIdentifier", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity")
DisplayString, PhysAddress, TimeStamp, TruthValue, RowStatus, AutonomousType, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "TimeStamp", "TruthValue", "RowStatus", "AutonomousType", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifOutNUcastPkts=ifOutNUcastPkts, ifAlias=ifAlias, ifTestGroup=ifTestGroup, ifXEntry=ifXEntry, ifTestOwner=ifTestOwner, ifInMulticastPkts=ifInMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndex=InterfaceIndex, ifInDiscards=ifInDiscards, interfaces=interfaces, ifStackLowerLayer=ifStackLowerLayer, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifStackLastChange=ifStackLastChange, ifConformance=ifConformance, ifMtu=ifMtu, ifTestCode=ifTestCode, ifGroups=ifGroups, ifRcvAddressStatus=ifRcvAddressStatus, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifName=ifName, ifTestStatus=ifTestStatus, ifTestEntry=ifTestEntry, ifOutQLen=ifOutQLen, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutOctets=ifOutOctets, ifSpecific=ifSpecific, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOperStatus=ifOperStatus, ifStackStatus=ifStackStatus, ifInOctets=ifInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, ifLastChange=ifLastChange, ifStackHigherLayer=ifStackHigherLayer, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifInNUcastPkts=ifInNUcastPkts, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifTableLastChange=ifTableLastChange, linkDown=linkDown, linkUp=linkUp, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifSpeed=ifSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifTestResult=ifTestResult, ifMIB=ifMIB, ifHighSpeed=ifHighSpeed, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance2=ifCompliance2, ifDescr=ifDescr, ifOutBroadcastPkts=ifOutBroadcastPkts, ifType=ifType, ifHCInUcastPkts=ifHCInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifHCPacketGroup=ifHCPacketGroup, ifInErrors=ifInErrors, ifPhysAddress=ifPhysAddress, ifPacketGroup=ifPacketGroup, ifConnectorPresent=ifConnectorPresent, ifAdminStatus=ifAdminStatus, ifCompliance3=ifCompliance3, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, ifTestId=ifTestId, ifCompliances=ifCompliances, ifStackGroup2=ifStackGroup2, ifNumber=ifNumber, ifOutErrors=ifOutErrors, PYSNMP_MODULE_ID=ifMIB, ifIndex=ifIndex, ifStackEntry=ifStackEntry, ifOutUcastPkts=ifOutUcastPkts, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutDiscards=ifOutDiscards, ifTable=ifTable, ifRcvAddressGroup=ifRcvAddressGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUcastPkts=ifInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup)
