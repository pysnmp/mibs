...
TestAndIncr, TruthValue, PhysAddress, TextualConvention, RowStatus, AutonomousType, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "PhysAddress", "TextualConvention", "RowStatus", "AutonomousType", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifTestEntry=ifTestEntry, ifTestTable=ifTestTable, ifNumber=ifNumber, ifHCOutOctets=ifHCOutOctets, ifPacketGroup=ifPacketGroup, ifStackLastChange=ifStackLastChange, ifGroups=ifGroups, ifVHCPacketGroup=ifVHCPacketGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance=ifCompliance, ifTestId=ifTestId, ifOldObjectsGroup=ifOldObjectsGroup, ifTestCode=ifTestCode, interfaces=interfaces, ifEntry=ifEntry, ifOutOctets=ifOutOctets, ifGeneralGroup=ifGeneralGroup, InterfaceIndex=InterfaceIndex, ifSpecific=ifSpecific, ifRcvAddressAddress=ifRcvAddressAddress, ifMIBObjects=ifMIBObjects, ifLastChange=ifLastChange, OwnerString=OwnerString, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressGroup=ifRcvAddressGroup, ifConformance=ifConformance, ifConnectorPresent=ifConnectorPresent, ifInErrors=ifInErrors, ifHCInUcastPkts=ifHCInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup=ifStackGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, linkUp=linkUp, ifTestGroup=ifTestGroup, ifCompliance3=ifCompliance3, ifRcvAddressStatus=ifRcvAddressStatus, ifOutErrors=ifOutErrors, ifRcvAddressType=ifRcvAddressType, ifTestStatus=ifTestStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup2=ifStackGroup2, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliances=ifCompliances, ifInBroadcastPkts=ifInBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifInUcastPkts=ifInUcastPkts, ifOutDiscards=ifOutDiscards, ifIndex=ifIndex, ifTable=ifTable, ifXTable=ifXTable, ifTestOwner=ifTestOwner, ifOperStatus=ifOperStatus, ifTestType=ifTestType, ifDescr=ifDescr, ifStackLowerLayer=ifStackLowerLayer, ifInDiscards=ifInDiscards, ifPhysAddress=ifPhysAddress, ifOutMulticastPkts=ifOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifOutQLen=ifOutQLen, ifMtu=ifMtu, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpeed=ifSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifPromiscuousMode=ifPromiscuousMode, ifType=ifType, ifTestResult=ifTestResult, ifXEntry=ifXEntry, ifAdminStatus=ifAdminStatus, ifInNUcastPkts=ifInNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifTableLastChange=ifTableLastChange, ifCompliance2=ifCompliance2, ifStackEntry=ifStackEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHighSpeed=ifHighSpeed, ifAlias=ifAlias, ifName=ifName, ifStackStatus=ifStackStatus, ifInUnknownProtos=ifInUnknownProtos, ifStackTable=ifStackTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup)
