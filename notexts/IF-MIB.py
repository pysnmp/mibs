...
mib_2, Bits, IpAddress, Counter32, iso, TimeTicks, NotificationType, Counter64, ModuleIdentity, ObjectIdentity, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Bits", "IpAddress", "Counter32", "iso", "TimeTicks", "NotificationType", "Counter64", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32")
TruthValue, TestAndIncr, RowStatus, TextualConvention, TimeStamp, AutonomousType, DisplayString, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "RowStatus", "TextualConvention", "TimeStamp", "AutonomousType", "DisplayString", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry, ifNumber=ifNumber, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifRcvAddressStatus=ifRcvAddressStatus, ifPromiscuousMode=ifPromiscuousMode, ifMIBObjects=ifMIBObjects, ifHCFixedLengthGroup=ifHCFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifTestEntry=ifTestEntry, ifStackGroup2=ifStackGroup2, ifTestResult=ifTestResult, ifMIB=ifMIB, ifTestCode=ifTestCode, ifPacketGroup=ifPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOldObjectsGroup=ifOldObjectsGroup, ifTestTable=ifTestTable, ifMtu=ifMtu, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifName=ifName, ifTestType=ifTestType, ifInDiscards=ifInDiscards, ifHighSpeed=ifHighSpeed, ifCompliances=ifCompliances, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifXTable=ifXTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInNUcastPkts=ifInNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, linkDown=linkDown, ifTestStatus=ifTestStatus, ifCompliance=ifCompliance, ifSpeed=ifSpeed, ifInUnknownProtos=ifInUnknownProtos, ifGroups=ifGroups, ifIndex=ifIndex, ifInMulticastPkts=ifInMulticastPkts, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance3=ifCompliance3, ifEntry=ifEntry, ifTable=ifTable, ifStackLastChange=ifStackLastChange, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifPhysAddress=ifPhysAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifLastChange=ifLastChange, ifRcvAddressType=ifRcvAddressType, ifHCInOctets=ifHCInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifType=ifType, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestGroup=ifTestGroup, ifGeneralGroup=ifGeneralGroup, ifStackGroup=ifStackGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAdminStatus=ifAdminStatus, ifConnectorPresent=ifConnectorPresent, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifStackEntry=ifStackEntry, ifSpecific=ifSpecific, ifStackHigherLayer=ifStackHigherLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, linkUp=linkUp, ifCompliance2=ifCompliance2, ifInOctets=ifInOctets, OwnerString=OwnerString, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackTable=ifStackTable, ifDescr=ifDescr, ifInUcastPkts=ifInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards)
