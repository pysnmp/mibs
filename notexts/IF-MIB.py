...
ObjectIdentity, Counter64, mib_2, IpAddress, Counter32, MibIdentifier, iso, TimeTicks, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "mib-2", "IpAddress", "Counter32", "MibIdentifier", "iso", "TimeTicks", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "NotificationType")
AutonomousType, PhysAddress, TestAndIncr, TextualConvention, TruthValue, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "PhysAddress", "TestAndIncr", "TextualConvention", "TruthValue", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, ifType=ifType, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance=ifCompliance, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifTableLastChange=ifTableLastChange, ifTestType=ifTestType, ifStackTable=ifStackTable, ifStackLowerLayer=ifStackLowerLayer, ifHCOutOctets=ifHCOutOctets, ifOutDiscards=ifOutDiscards, ifInErrors=ifInErrors, ifEntry=ifEntry, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifTestTable=ifTestTable, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, linkUp=linkUp, ifGeneralGroup=ifGeneralGroup, ifTestResult=ifTestResult, ifInNUcastPkts=ifInNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressType=ifRcvAddressType, ifAdminStatus=ifAdminStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressAddress=ifRcvAddressAddress, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIBObjects=ifMIBObjects, ifTestStatus=ifTestStatus, ifSpecific=ifSpecific, ifOperStatus=ifOperStatus, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifAlias=ifAlias, ifMtu=ifMtu, InterfaceIndex=InterfaceIndex, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestEntry=ifTestEntry, ifOutOctets=ifOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPhysAddress=ifPhysAddress, ifCompliance3=ifCompliance3, ifInBroadcastPkts=ifInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifNumber=ifNumber, ifConnectorPresent=ifConnectorPresent, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifInUcastPkts=ifInUcastPkts, ifName=ifName, ifStackGroup2=ifStackGroup2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifStackGroup=ifStackGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutQLen=ifOutQLen, ifMIB=ifMIB, ifSpeed=ifSpeed, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifIndex=ifIndex, ifCompliances=ifCompliances, ifTable=ifTable, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, linkDown=linkDown, ifConformance=ifConformance, ifInOctets=ifInOctets, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifXEntry=ifXEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts)
