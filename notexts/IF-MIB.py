...
Bits, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, Counter32, Gauge32, iso, Integer32, mib_2, MibIdentifier, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter32", "Gauge32", "iso", "Integer32", "mib-2", "MibIdentifier", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
AutonomousType, DisplayString, TruthValue, TestAndIncr, TimeStamp, TextualConvention, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TruthValue", "TestAndIncr", "TimeStamp", "TextualConvention", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutDiscards=ifOutDiscards, ifHCPacketGroup=ifHCPacketGroup, ifDescr=ifDescr, ifConnectorPresent=ifConnectorPresent, ifPacketGroup=ifPacketGroup, ifHCInOctets=ifHCInOctets, ifLastChange=ifLastChange, ifStackStatus=ifStackStatus, ifStackGroup2=ifStackGroup2, ifStackEntry=ifStackEntry, ifInDiscards=ifInDiscards, ifOperStatus=ifOperStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifNumber=ifNumber, ifCompliances=ifCompliances, ifHCInUcastPkts=ifHCInUcastPkts, ifType=ifType, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifGeneralGroup=ifGeneralGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestType=ifTestType, ifCompliance3=ifCompliance3, ifRcvAddressTable=ifRcvAddressTable, ifTestTable=ifTestTable, ifTestEntry=ifTestEntry, ifTestOwner=ifTestOwner, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifConformance=ifConformance, ifInOctets=ifInOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifXTable=ifXTable, ifIndex=ifIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, OwnerString=OwnerString, ifTestId=ifTestId, ifOutMulticastPkts=ifOutMulticastPkts, ifOutErrors=ifOutErrors, ifTestStatus=ifTestStatus, ifMtu=ifMtu, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLastChange=ifStackLastChange, ifInNUcastPkts=ifInNUcastPkts, ifCompliance2=ifCompliance2, ifAlias=ifAlias, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTable=ifTable, ifOutUcastPkts=ifOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifStackTable=ifStackTable, ifFixedLengthGroup=ifFixedLengthGroup, ifOutQLen=ifOutQLen, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXEntry=ifXEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifEntry=ifEntry, ifMIB=ifMIB, linkDown=linkDown, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpeed=ifSpeed, ifHCOutOctets=ifHCOutOctets, interfaces=interfaces, ifInErrors=ifInErrors, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifPhysAddress=ifPhysAddress, ifRcvAddressType=ifRcvAddressType, ifName=ifName)
