...
iso, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Integer32, mib_2, NotificationType, ObjectIdentity, IpAddress, Bits, TimeTicks, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Integer32", "mib-2", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "TimeTicks", "Counter32", "Unsigned32")
RowStatus, DisplayString, TimeStamp, TruthValue, TestAndIncr, TextualConvention, AutonomousType, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "TruthValue", "TestAndIncr", "TextualConvention", "AutonomousType", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifHighSpeed=ifHighSpeed, ifHCInUcastPkts=ifHCInUcastPkts, ifXEntry=ifXEntry, ifInDiscards=ifInDiscards, ifTestType=ifTestType, ifOutNUcastPkts=ifOutNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOldObjectsGroup=ifOldObjectsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifNumber=ifNumber, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifInOctets=ifInOctets, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifHCInOctets=ifHCInOctets, ifCompliance3=ifCompliance3, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifStackLastChange=ifStackLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifAlias=ifAlias, ifPhysAddress=ifPhysAddress, ifOutOctets=ifOutOctets, linkDown=linkDown, ifCompliance2=ifCompliance2, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestEntry=ifTestEntry, ifConnectorPresent=ifConnectorPresent, ifTableLastChange=ifTableLastChange, ifRcvAddressType=ifRcvAddressType, ifTestCode=ifTestCode, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackTable=ifStackTable, ifRcvAddressGroup=ifRcvAddressGroup, ifTestOwner=ifTestOwner, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifMtu=ifMtu, ifLastChange=ifLastChange, ifInErrors=ifInErrors, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutDiscards=ifOutDiscards, ifTestTable=ifTestTable, ifTestGroup=ifTestGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifIndex=ifIndex, ifHCOutOctets=ifHCOutOctets, ifOperStatus=ifOperStatus, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifDescr=ifDescr, ifStackGroup=ifStackGroup, ifStackGroup2=ifStackGroup2, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIB=ifMIB, ifTestResult=ifTestResult, ifConformance=ifConformance, ifPacketGroup=ifPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXTable=ifXTable, ifTestStatus=ifTestStatus, interfaces=interfaces, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifOutQLen=ifOutQLen, ifRcvAddressTable=ifRcvAddressTable, ifTestId=ifTestId, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifInUcastPkts=ifInUcastPkts, ifCompliance=ifCompliance, InterfaceIndex=InterfaceIndex, linkUp=linkUp, ifInUnknownProtos=ifInUnknownProtos, ifStackStatus=ifStackStatus)
