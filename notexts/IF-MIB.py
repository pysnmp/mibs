...
DisplayString, TruthValue, PhysAddress, TextualConvention, RowStatus, TimeStamp, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "PhysAddress", "TextualConvention", "RowStatus", "TimeStamp", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLastChange=ifStackLastChange, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackStatus=ifStackStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifStackEntry=ifStackEntry, ifCompliance=ifCompliance, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutQLen=ifOutQLen, ifCompliance2=ifCompliance2, ifCompliances=ifCompliances, ifFixedLengthGroup=ifFixedLengthGroup, ifTable=ifTable, ifInUnknownProtos=ifInUnknownProtos, ifInUcastPkts=ifInUcastPkts, linkUp=linkUp, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifEntry=ifEntry, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifGeneralGroup=ifGeneralGroup, ifGroups=ifGroups, ifStackTable=ifStackTable, ifRcvAddressType=ifRcvAddressType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifInErrors=ifInErrors, ifHighSpeed=ifHighSpeed, ifPacketGroup=ifPacketGroup, ifHCInOctets=ifHCInOctets, ifOutUcastPkts=ifOutUcastPkts, ifAlias=ifAlias, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, ifSpeed=ifSpeed, ifStackGroup=ifStackGroup, ifOutDiscards=ifOutDiscards, ifTestCode=ifTestCode, interfaces=interfaces, ifOldObjectsGroup=ifOldObjectsGroup, linkDown=linkDown, ifPromiscuousMode=ifPromiscuousMode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInOctets=ifInOctets, ifMtu=ifMtu, ifTestOwner=ifTestOwner, ifIndex=ifIndex, OwnerString=OwnerString, ifXEntry=ifXEntry, ifType=ifType, ifXTable=ifXTable, ifTestId=ifTestId, ifHCOutOctets=ifHCOutOctets, ifInDiscards=ifInDiscards, ifInBroadcastPkts=ifInBroadcastPkts, ifTestEntry=ifTestEntry, ifStackGroup2=ifStackGroup2, ifInNUcastPkts=ifInNUcastPkts, ifConformance=ifConformance, ifRcvAddressStatus=ifRcvAddressStatus, ifTestTable=ifTestTable, ifSpecific=ifSpecific, ifInMulticastPkts=ifInMulticastPkts, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifNumber=ifNumber, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifOutNUcastPkts=ifOutNUcastPkts, ifConnectorPresent=ifConnectorPresent, PYSNMP_MODULE_ID=ifMIB, ifMIBObjects=ifMIBObjects, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifOutErrors=ifOutErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressTable=ifRcvAddressTable, ifTestGroup=ifTestGroup, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifTestStatus=ifTestStatus, ifStackHigherLayer=ifStackHigherLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifOutOctets=ifOutOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifName=ifName, ifMIB=ifMIB)
