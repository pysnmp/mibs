...
AutonomousType, TestAndIncr, PhysAddress, TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "PhysAddress", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifStackEntry=ifStackEntry, ifNumber=ifNumber, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLastChange=ifStackLastChange, ifTable=ifTable, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, ifPhysAddress=ifPhysAddress, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifConformance=ifConformance, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifRcvAddressGroup=ifRcvAddressGroup, ifMtu=ifMtu, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifCompliances=ifCompliances, ifCompliance2=ifCompliance2, ifOutOctets=ifOutOctets, ifInNUcastPkts=ifInNUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, interfaces=interfaces, ifTestId=ifTestId, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifTestCode=ifTestCode, ifHCOutOctets=ifHCOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifTestTable=ifTestTable, ifTestStatus=ifTestStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifXEntry=ifXEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifInDiscards=ifInDiscards, ifTestResult=ifTestResult, ifOutDiscards=ifOutDiscards, ifTestEntry=ifTestEntry, ifTestOwner=ifTestOwner, ifOutUcastPkts=ifOutUcastPkts, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackTable=ifStackTable, ifMIB=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifOutNUcastPkts=ifOutNUcastPkts, ifTestGroup=ifTestGroup, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifMIBObjects=ifMIBObjects, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCPacketGroup=ifHCPacketGroup, linkUp=linkUp, ifLastChange=ifLastChange, ifGeneralGroup=ifGeneralGroup, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutErrors=ifOutErrors, ifInOctets=ifInOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHighSpeed=ifHighSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifDescr=ifDescr, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifOperStatus=ifOperStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifCompliance=ifCompliance, ifSpecific=ifSpecific, ifInBroadcastPkts=ifInBroadcastPkts, ifAlias=ifAlias, ifRcvAddressTable=ifRcvAddressTable, ifCompliance3=ifCompliance3, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup2=ifStackGroup2, ifType=ifType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry)
