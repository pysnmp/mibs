...
AutonomousType, TestAndIncr, TruthValue, RowStatus, TimeStamp, DisplayString, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "TruthValue", "RowStatus", "TimeStamp", "DisplayString", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifStackHigherLayer=ifStackHigherLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifEntry=ifEntry, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifMIBObjects=ifMIBObjects, ifInOctets=ifInOctets, ifOutErrors=ifOutErrors, ifStackEntry=ifStackEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestId=ifTestId, ifFixedLengthGroup=ifFixedLengthGroup, ifInUcastPkts=ifInUcastPkts, ifHighSpeed=ifHighSpeed, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifHCPacketGroup=ifHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifTestStatus=ifTestStatus, ifTestGroup=ifTestGroup, ifStackGroup2=ifStackGroup2, ifCompliance3=ifCompliance3, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifPacketGroup=ifPacketGroup, ifTestCode=ifTestCode, ifInDiscards=ifInDiscards, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifRcvAddressTable=ifRcvAddressTable, ifHCInOctets=ifHCInOctets, ifDescr=ifDescr, ifHCOutUcastPkts=ifHCOutUcastPkts, ifIndex=ifIndex, ifConformance=ifConformance, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressType=ifRcvAddressType, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifMIB=ifMIB, ifPhysAddress=ifPhysAddress, ifTestResult=ifTestResult, linkUp=linkUp, ifGeneralGroup=ifGeneralGroup, ifStackLastChange=ifStackLastChange, ifHCInUcastPkts=ifHCInUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifGroups=ifGroups, ifCompliance2=ifCompliance2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTable=ifTable, ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInErrors=ifInErrors, ifHCOutOctets=ifHCOutOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifTestType=ifTestType, ifStackGroup=ifStackGroup, ifRcvAddressStatus=ifRcvAddressStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLastChange=ifLastChange, ifCompliance=ifCompliance, ifOutOctets=ifOutOctets, ifAlias=ifAlias, ifStackLowerLayer=ifStackLowerLayer, ifOutNUcastPkts=ifOutNUcastPkts, ifTestEntry=ifTestEntry, ifType=ifType, ifCompliances=ifCompliances, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndex=InterfaceIndex, ifSpecific=ifSpecific, ifInBroadcastPkts=ifInBroadcastPkts, ifSpeed=ifSpeed, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup)
