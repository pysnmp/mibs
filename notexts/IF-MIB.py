...
RowStatus, TextualConvention, TruthValue, TestAndIncr, TimeStamp, DisplayString, PhysAddress, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TruthValue", "TestAndIncr", "TimeStamp", "DisplayString", "PhysAddress", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifSpecific=ifSpecific, ifOperStatus=ifOperStatus, ifType=ifType, ifNumber=ifNumber, OwnerString=OwnerString, ifOutOctets=ifOutOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, PYSNMP_MODULE_ID=ifMIB, ifName=ifName, ifHCInUcastPkts=ifHCInUcastPkts, ifMIB=ifMIB, ifCompliances=ifCompliances, ifTestResult=ifTestResult, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInOctets=ifInOctets, ifPromiscuousMode=ifPromiscuousMode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPhysAddress=ifPhysAddress, ifSpeed=ifSpeed, ifXEntry=ifXEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifOutUcastPkts=ifOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMIBObjects=ifMIBObjects, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, ifConnectorPresent=ifConnectorPresent, ifVHCPacketGroup=ifVHCPacketGroup, ifInUcastPkts=ifInUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifLastChange=ifLastChange, ifInErrors=ifInErrors, ifCompliance=ifCompliance, ifDescr=ifDescr, ifGroups=ifGroups, ifInMulticastPkts=ifInMulticastPkts, ifCompliance2=ifCompliance2, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifInDiscards=ifInDiscards, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestCode=ifTestCode, ifTestTable=ifTestTable, ifEntry=ifEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkDown=linkDown, ifAdminStatus=ifAdminStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifGeneralGroup=ifGeneralGroup, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifInNUcastPkts=ifInNUcastPkts, ifIndex=ifIndex, ifTestId=ifTestId, ifStackTable=ifStackTable, ifStackStatus=ifStackStatus, ifCompliance3=ifCompliance3, ifTableLastChange=ifTableLastChange, ifMtu=ifMtu, ifTestOwner=ifTestOwner, ifInBroadcastPkts=ifInBroadcastPkts, ifXTable=ifXTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, interfaces=interfaces, ifPacketGroup=ifPacketGroup, ifStackGroup=ifStackGroup, ifOutErrors=ifOutErrors, ifStackHigherLayer=ifStackHigherLayer, ifInUnknownProtos=ifInUnknownProtos, linkUp=linkUp, ifTestGroup=ifTestGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLastChange=ifStackLastChange, ifFixedLengthGroup=ifFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressType=ifRcvAddressType, ifHighSpeed=ifHighSpeed, ifOutDiscards=ifOutDiscards, ifRcvAddressGroup=ifRcvAddressGroup, ifTable=ifTable, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndex=InterfaceIndex, ifStackGroup2=ifStackGroup2, ifConformance=ifConformance, ifTestType=ifTestType)
