...
ObjectIdentity, Unsigned32, MibIdentifier, Counter32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, IpAddress, Integer32, Gauge32, TimeTicks, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "IpAddress", "Integer32", "Gauge32", "TimeTicks", "iso", "mib-2")
DisplayString, PhysAddress, AutonomousType, TestAndIncr, TimeStamp, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "AutonomousType", "TestAndIncr", "TimeStamp", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXTable=ifXTable, PYSNMP_MODULE_ID=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifOperStatus=ifOperStatus, ifEntry=ifEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMtu=ifMtu, ifType=ifType, ifOutOctets=ifOutOctets, ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifInErrors=ifInErrors, InterfaceIndex=InterfaceIndex, ifPhysAddress=ifPhysAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, ifSpeed=ifSpeed, ifConformance=ifConformance, ifInOctets=ifInOctets, ifHCPacketGroup=ifHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestStatus=ifTestStatus, ifPromiscuousMode=ifPromiscuousMode, ifHCOutOctets=ifHCOutOctets, ifCompliance2=ifCompliance2, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifNumber=ifNumber, ifOutNUcastPkts=ifOutNUcastPkts, ifXEntry=ifXEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifHighSpeed=ifHighSpeed, ifInMulticastPkts=ifInMulticastPkts, ifGeneralGroup=ifGeneralGroup, interfaces=interfaces, ifOutQLen=ifOutQLen, ifRcvAddressAddress=ifRcvAddressAddress, ifTestGroup=ifTestGroup, ifSpecific=ifSpecific, ifStackLastChange=ifStackLastChange, linkDown=linkDown, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressType=ifRcvAddressType, ifVHCPacketGroup=ifVHCPacketGroup, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifStackEntry=ifStackEntry, linkUp=linkUp, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMIB=ifMIB, ifTestOwner=ifTestOwner, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestEntry=ifTestEntry, ifTestTable=ifTestTable, ifCompliance3=ifCompliance3, ifTestType=ifTestType, ifCompliances=ifCompliances, ifRcvAddressGroup=ifRcvAddressGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifDescr=ifDescr, ifStackStatus=ifStackStatus, ifOutUcastPkts=ifOutUcastPkts, ifInDiscards=ifInDiscards, ifStackGroup2=ifStackGroup2, ifConnectorPresent=ifConnectorPresent, ifName=ifName, ifAlias=ifAlias, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutErrors=ifOutErrors, ifIndex=ifIndex, ifPacketGroup=ifPacketGroup)
