...
NotificationType, ModuleIdentity, mib_2, Integer32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "mib-2", "Integer32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "Counter32", "IpAddress")
DisplayString, TextualConvention, RowStatus, PhysAddress, TestAndIncr, TruthValue, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "RowStatus", "PhysAddress", "TestAndIncr", "TruthValue", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifTestCode=ifTestCode, ifInMulticastPkts=ifInMulticastPkts, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifTestOwner=ifTestOwner, ifName=ifName, ifOutOctets=ifOutOctets, InterfaceIndex=InterfaceIndex, ifVHCPacketGroup=ifVHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUcastPkts=ifInUcastPkts, ifTestType=ifTestType, ifInBroadcastPkts=ifInBroadcastPkts, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackTable=ifStackTable, ifNumber=ifNumber, ifConformance=ifConformance, ifCompliance3=ifCompliance3, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTable=ifTable, ifIndex=ifIndex, ifGroups=ifGroups, ifStackStatus=ifStackStatus, ifType=ifType, ifXEntry=ifXEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, linkDown=linkDown, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifTableLastChange=ifTableLastChange, ifInNUcastPkts=ifInNUcastPkts, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, interfaces=interfaces, ifHCOutOctets=ifHCOutOctets, ifDescr=ifDescr, ifRcvAddressStatus=ifRcvAddressStatus, ifAlias=ifAlias, ifOutNUcastPkts=ifOutNUcastPkts, ifLastChange=ifLastChange, ifHighSpeed=ifHighSpeed, ifTestTable=ifTestTable, ifInUnknownProtos=ifInUnknownProtos, ifOutDiscards=ifOutDiscards, ifRcvAddressEntry=ifRcvAddressEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestGroup=ifTestGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance2=ifCompliance2, ifRcvAddressType=ifRcvAddressType, ifConnectorPresent=ifConnectorPresent, ifStackLastChange=ifStackLastChange, ifPacketGroup=ifPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, OwnerString=OwnerString, ifPhysAddress=ifPhysAddress, ifCompliances=ifCompliances, ifOutQLen=ifOutQLen, ifInOctets=ifInOctets, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifInDiscards=ifInDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestId=ifTestId, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifStackGroup2=ifStackGroup2, linkUp=linkUp, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifMtu=ifMtu, ifOperStatus=ifOperStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts)
