...
RowStatus, TimeStamp, TextualConvention, TestAndIncr, AutonomousType, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "TestAndIncr", "AutonomousType", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifMIB=ifMIB, ifTestOwner=ifTestOwner, ifAlias=ifAlias, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestResult=ifTestResult, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifOutQLen=ifOutQLen, ifTestGroup=ifTestGroup, ifTestEntry=ifTestEntry, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifRcvAddressType=ifRcvAddressType, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressGroup=ifRcvAddressGroup, ifStackLastChange=ifStackLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifStackTable=ifStackTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifInOctets=ifInOctets, ifInUcastPkts=ifInUcastPkts, ifStackGroup2=ifStackGroup2, ifAdminStatus=ifAdminStatus, ifPhysAddress=ifPhysAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, linkDown=linkDown, ifName=ifName, ifMtu=ifMtu, ifOutErrors=ifOutErrors, ifRcvAddressEntry=ifRcvAddressEntry, ifSpecific=ifSpecific, ifTestStatus=ifTestStatus, ifStackLowerLayer=ifStackLowerLayer, ifConformance=ifConformance, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInErrors=ifInErrors, ifPromiscuousMode=ifPromiscuousMode, ifCompliance2=ifCompliance2, ifOutNUcastPkts=ifOutNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifTestType=ifTestType, ifCompliance=ifCompliance, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackHigherLayer=ifStackHigherLayer, ifTestCode=ifTestCode, ifOutDiscards=ifOutDiscards, interfaces=interfaces, ifTestId=ifTestId, ifSpeed=ifSpeed, ifNumber=ifNumber, ifHCOutOctets=ifHCOutOctets, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, ifInBroadcastPkts=ifInBroadcastPkts, OwnerString=OwnerString, ifLastChange=ifLastChange, ifHighSpeed=ifHighSpeed, PYSNMP_MODULE_ID=ifMIB, ifDescr=ifDescr, ifVHCPacketGroup=ifVHCPacketGroup, ifTableLastChange=ifTableLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifEntry=ifEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliances=ifCompliances, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXEntry=ifXEntry, ifGeneralGroup=ifGeneralGroup, ifType=ifType, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifHCInOctets=ifHCInOctets, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifXTable=ifXTable, ifStackStatus=ifStackStatus, ifFixedLengthGroup=ifFixedLengthGroup)
