...
ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, mib_2, NotificationType, Counter32, ModuleIdentity, TimeTicks, Bits, Integer32, Counter64, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "mib-2", "NotificationType", "Counter32", "ModuleIdentity", "TimeTicks", "Bits", "Integer32", "Counter64", "IpAddress", "Gauge32")
TimeStamp, DisplayString, PhysAddress, TruthValue, TextualConvention, AutonomousType, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "PhysAddress", "TruthValue", "TextualConvention", "AutonomousType", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, OwnerString=OwnerString, interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestResult=ifTestResult, ifCompliance=ifCompliance, ifCompliances=ifCompliances, ifHCInUcastPkts=ifHCInUcastPkts, ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifDescr=ifDescr, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestStatus=ifTestStatus, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPacketGroup=ifPacketGroup, ifStackEntry=ifStackEntry, ifTestCode=ifTestCode, ifSpecific=ifSpecific, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifGroups=ifGroups, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifInMulticastPkts=ifInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifPhysAddress=ifPhysAddress, ifTestType=ifTestType, ifLastChange=ifLastChange, ifStackGroup=ifStackGroup, linkDown=linkDown, ifInOctets=ifInOctets, InterfaceIndex=InterfaceIndex, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifInDiscards=ifInDiscards, ifType=ifType, ifRcvAddressTable=ifRcvAddressTable, ifInNUcastPkts=ifInNUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup2=ifStackGroup2, ifCompliance2=ifCompliance2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifMIB=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifIndex=ifIndex, ifEntry=ifEntry, ifOutNUcastPkts=ifOutNUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestGroup=ifTestGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, PYSNMP_MODULE_ID=ifMIB, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifXEntry=ifXEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLastChange=ifStackLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifNumber=ifNumber, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, ifTestTable=ifTestTable, ifStackLowerLayer=ifStackLowerLayer, ifAdminStatus=ifAdminStatus, ifOutDiscards=ifOutDiscards, ifInErrors=ifInErrors, ifTestId=ifTestId, ifTable=ifTable, linkUp=linkUp, ifXTable=ifXTable, ifAlias=ifAlias, ifRcvAddressStatus=ifRcvAddressStatus, ifConformance=ifConformance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts)
