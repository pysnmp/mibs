...
ObjectIdentity, Unsigned32, Integer32, IpAddress, Counter64, iso, mib_2, NotificationType, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Integer32", "IpAddress", "Counter64", "iso", "mib-2", "NotificationType", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity", "Bits")
TimeStamp, AutonomousType, TestAndIncr, TextualConvention, RowStatus, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TestAndIncr", "TextualConvention", "RowStatus", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifEntry=ifEntry, ifRcvAddressType=ifRcvAddressType, ifTestResult=ifTestResult, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup=ifStackGroup, ifStackGroup2=ifStackGroup2, ifGroups=ifGroups, ifInUcastPkts=ifInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifXTable=ifXTable, ifOutErrors=ifOutErrors, ifCompliance2=ifCompliance2, ifTestOwner=ifTestOwner, ifHCInMulticastPkts=ifHCInMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifOperStatus=ifOperStatus, linkDown=linkDown, ifTestStatus=ifTestStatus, ifLastChange=ifLastChange, ifIndex=ifIndex, ifStackLastChange=ifStackLastChange, ifRcvAddressAddress=ifRcvAddressAddress, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliances=ifCompliances, ifStackTable=ifStackTable, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, interfaces=interfaces, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConformance=ifConformance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInOctets=ifHCInOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifTestEntry=ifTestEntry, ifGeneralGroup=ifGeneralGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifHighSpeed=ifHighSpeed, ifStackEntry=ifStackEntry, ifOutUcastPkts=ifOutUcastPkts, ifCompliance3=ifCompliance3, OwnerString=OwnerString, ifAdminStatus=ifAdminStatus, ifTestTable=ifTestTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifXEntry=ifXEntry, ifPacketGroup=ifPacketGroup, ifOutOctets=ifOutOctets, ifPhysAddress=ifPhysAddress, ifStackStatus=ifStackStatus, ifAlias=ifAlias, ifOutNUcastPkts=ifOutNUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifMIB=ifMIB, ifSpeed=ifSpeed, linkUp=linkUp, ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifVHCPacketGroup=ifVHCPacketGroup, ifInErrors=ifInErrors, ifTestCode=ifTestCode, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifType=ifType, ifTestGroup=ifTestGroup, ifMtu=ifMtu, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifInUnknownProtos=ifInUnknownProtos, ifOutQLen=ifOutQLen)
