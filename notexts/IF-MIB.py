...
NotificationType, ModuleIdentity, Integer32, Bits, mib_2, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Unsigned32, TimeTicks, IpAddress, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Bits", "mib-2", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity")
TruthValue, RowStatus, PhysAddress, TextualConvention, TestAndIncr, DisplayString, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "PhysAddress", "TextualConvention", "TestAndIncr", "DisplayString", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifVHCPacketGroup=ifVHCPacketGroup, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifPromiscuousMode=ifPromiscuousMode, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestType=ifTestType, ifDescr=ifDescr, ifStackStatus=ifStackStatus, ifTestCode=ifTestCode, ifType=ifType, ifGeneralGroup=ifGeneralGroup, ifInUnknownProtos=ifInUnknownProtos, ifTable=ifTable, ifMtu=ifMtu, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, interfaces=interfaces, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifRcvAddressType=ifRcvAddressType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance3=ifCompliance3, ifInMulticastPkts=ifInMulticastPkts, linkUp=linkUp, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifConnectorPresent=ifConnectorPresent, ifTestEntry=ifTestEntry, ifHCInUcastPkts=ifHCInUcastPkts, InterfaceIndex=InterfaceIndex, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance2=ifCompliance2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPacketGroup=ifPacketGroup, ifIndex=ifIndex, ifNumber=ifNumber, ifAdminStatus=ifAdminStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifLastChange=ifLastChange, ifStackEntry=ifStackEntry, ifEntry=ifEntry, ifXTable=ifXTable, ifTestId=ifTestId, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifTestTable=ifTestTable, ifConformance=ifConformance, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifHCInOctets=ifHCInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliances=ifCompliances, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutOctets=ifHCOutOctets, ifTestStatus=ifTestStatus, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifStackGroup2=ifStackGroup2, ifMIB=ifMIB, ifOutQLen=ifOutQLen, ifOutUcastPkts=ifOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPhysAddress=ifPhysAddress, ifRcvAddressAddress=ifRcvAddressAddress, ifOutErrors=ifOutErrors, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifOutOctets=ifOutOctets, ifGroups=ifGroups, ifInBroadcastPkts=ifInBroadcastPkts, OwnerString=OwnerString, ifSpeed=ifSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressTable=ifRcvAddressTable, ifStackGroup=ifStackGroup, ifCompliance=ifCompliance, InterfaceIndexOrZero=InterfaceIndexOrZero)
