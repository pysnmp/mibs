...
TestAndIncr, RowStatus, TextualConvention, AutonomousType, TimeStamp, PhysAddress, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "TextualConvention", "AutonomousType", "TimeStamp", "PhysAddress", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifType=ifType, InterfaceIndex=InterfaceIndex, ifConformance=ifConformance, ifMIB=ifMIB, ifTestId=ifTestId, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifMtu=ifMtu, ifEntry=ifEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifInUnknownProtos=ifInUnknownProtos, ifMIBObjects=ifMIBObjects, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressEntry=ifRcvAddressEntry, ifStackStatus=ifStackStatus, interfaces=interfaces, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInBroadcastPkts=ifInBroadcastPkts, ifTestStatus=ifTestStatus, ifOutDiscards=ifOutDiscards, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifXTable=ifXTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifSpeed=ifSpeed, ifStackGroup=ifStackGroup, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackEntry=ifStackEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifAlias=ifAlias, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifTable=ifTable, ifOutMulticastPkts=ifOutMulticastPkts, ifInErrors=ifInErrors, ifStackLastChange=ifStackLastChange, ifConnectorPresent=ifConnectorPresent, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifDescr=ifDescr, ifTestType=ifTestType, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifTestResult=ifTestResult, ifHCOutOctets=ifHCOutOctets, ifRcvAddressType=ifRcvAddressType, ifCompliance3=ifCompliance3, ifCompliances=ifCompliances, ifInOctets=ifInOctets, ifAdminStatus=ifAdminStatus, ifName=ifName, ifOldObjectsGroup=ifOldObjectsGroup, ifTestTable=ifTestTable, ifInUcastPkts=ifInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOutQLen=ifOutQLen, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifOutErrors=ifOutErrors, ifCompliance2=ifCompliance2, linkDown=linkDown, ifHighSpeed=ifHighSpeed, ifInDiscards=ifInDiscards, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifTableLastChange=ifTableLastChange, ifStackHigherLayer=ifStackHigherLayer)
