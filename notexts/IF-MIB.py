...
ObjectIdentity, iso, TimeTicks, Unsigned32, MibIdentifier, Integer32, NotificationType, Counter64, Counter32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "Counter64", "Counter32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Gauge32", "ModuleIdentity")
TimeStamp, RowStatus, TruthValue, TestAndIncr, PhysAddress, TextualConvention, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "TestAndIncr", "PhysAddress", "TextualConvention", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, ifMtu=ifMtu, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifConformance=ifConformance, ifStackLastChange=ifStackLastChange, ifGeneralGroup=ifGeneralGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifEntry=ifEntry, ifHCPacketGroup=ifHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifStackStatus=ifStackStatus, ifOutOctets=ifOutOctets, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifHCInOctets=ifHCInOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifXEntry=ifXEntry, ifMIB=ifMIB, ifInErrors=ifInErrors, ifStackTable=ifStackTable, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifDescr=ifDescr, ifLastChange=ifLastChange, PYSNMP_MODULE_ID=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifSpeed=ifSpeed, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPromiscuousMode=ifPromiscuousMode, ifStackHigherLayer=ifStackHigherLayer, ifOutDiscards=ifOutDiscards, ifCompliance2=ifCompliance2, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliances=ifCompliances, ifName=ifName, ifTestOwner=ifTestOwner, ifConnectorPresent=ifConnectorPresent, ifTestResult=ifTestResult, ifTestTable=ifTestTable, OwnerString=OwnerString, ifIndex=ifIndex, ifInBroadcastPkts=ifInBroadcastPkts, ifTable=ifTable, ifInDiscards=ifInDiscards, ifAlias=ifAlias, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifNumber=ifNumber, ifTestGroup=ifTestGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPacketGroup=ifPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestEntry=ifTestEntry, ifPhysAddress=ifPhysAddress, ifInUcastPkts=ifInUcastPkts, InterfaceIndex=InterfaceIndex, ifStackGroup=ifStackGroup, ifTestId=ifTestId, ifSpecific=ifSpecific, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance3=ifCompliance3, ifTestStatus=ifTestStatus, ifStackEntry=ifStackEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifGroups=ifGroups, ifStackGroup2=ifStackGroup2, ifXTable=ifXTable, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifStackLowerLayer=ifStackLowerLayer, ifOutErrors=ifOutErrors, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestType=ifTestType, linkDown=linkDown, ifFixedLengthGroup=ifFixedLengthGroup, ifOutMulticastPkts=ifOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutQLen=ifOutQLen, linkUp=linkUp)
