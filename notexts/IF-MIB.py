...
TimeStamp, AutonomousType, TruthValue, DisplayString, RowStatus, PhysAddress, TextualConvention, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "AutonomousType", "TruthValue", "DisplayString", "RowStatus", "PhysAddress", "TextualConvention", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, linkDown=linkDown, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackStatus=ifStackStatus, ifStackGroup=ifStackGroup, ifSpecific=ifSpecific, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifRcvAddressEntry=ifRcvAddressEntry, ifMIB=ifMIB, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifType=ifType, ifFixedLengthGroup=ifFixedLengthGroup, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpeed=ifSpeed, ifStackGroup2=ifStackGroup2, OwnerString=OwnerString, ifCompliances=ifCompliances, ifRcvAddressTable=ifRcvAddressTable, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifTestOwner=ifTestOwner, ifTable=ifTable, ifMtu=ifMtu, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOldObjectsGroup=ifOldObjectsGroup, linkUp=linkUp, ifVHCPacketGroup=ifVHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCOutOctets=ifHCOutOctets, ifMIBObjects=ifMIBObjects, ifTestTable=ifTestTable, ifTableLastChange=ifTableLastChange, ifStackLastChange=ifStackLastChange, ifPhysAddress=ifPhysAddress, ifTestCode=ifTestCode, ifInDiscards=ifInDiscards, ifInMulticastPkts=ifInMulticastPkts, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInErrors=ifInErrors, ifConformance=ifConformance, ifCompliance2=ifCompliance2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInOctets=ifInOctets, ifAdminStatus=ifAdminStatus, PYSNMP_MODULE_ID=ifMIB, ifInBroadcastPkts=ifInBroadcastPkts, ifTestEntry=ifTestEntry, ifName=ifName, ifTestId=ifTestId, ifLastChange=ifLastChange, ifEntry=ifEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifNumber=ifNumber, ifXEntry=ifXEntry, ifAlias=ifAlias, ifOutErrors=ifOutErrors, ifGeneralGroup=ifGeneralGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifOutDiscards=ifOutDiscards, ifStackHigherLayer=ifStackHigherLayer, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifInUcastPkts=ifInUcastPkts, ifCompliance=ifCompliance, ifStackLowerLayer=ifStackLowerLayer, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, interfaces=interfaces, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus)
