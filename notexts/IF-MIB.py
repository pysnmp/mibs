...
TruthValue, DisplayString, TextualConvention, PhysAddress, AutonomousType, TestAndIncr, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "PhysAddress", "AutonomousType", "TestAndIncr", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifTestType=ifTestType, ifTestId=ifTestId, ifMtu=ifMtu, ifConformance=ifConformance, ifTestCode=ifTestCode, ifInOctets=ifInOctets, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifOutQLen=ifOutQLen, ifRcvAddressTable=ifRcvAddressTable, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifStackStatus=ifStackStatus, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifStackLastChange=ifStackLastChange, ifPromiscuousMode=ifPromiscuousMode, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestOwner=ifTestOwner, ifInErrors=ifInErrors, ifConnectorPresent=ifConnectorPresent, linkUp=linkUp, ifSpeed=ifSpeed, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressType=ifRcvAddressType, ifFixedLengthGroup=ifFixedLengthGroup, OwnerString=OwnerString, ifStackEntry=ifStackEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInBroadcastPkts=ifInBroadcastPkts, ifTestStatus=ifTestStatus, ifHighSpeed=ifHighSpeed, ifTestGroup=ifTestGroup, ifInMulticastPkts=ifInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifCompliances=ifCompliances, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup2=ifStackGroup2, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifType=ifType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifHCPacketGroup=ifHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifHCOutOctets=ifHCOutOctets, ifLastChange=ifLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifGroups=ifGroups, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifPhysAddress=ifPhysAddress, InterfaceIndex=InterfaceIndex, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifNumber=ifNumber, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutErrors=ifOutErrors, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifIndex=ifIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackTable=ifStackTable, ifOutNUcastPkts=ifOutNUcastPkts, linkDown=linkDown, ifTestEntry=ifTestEntry, ifMIB=ifMIB, ifTableLastChange=ifTableLastChange, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXTable=ifXTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInDiscards=ifInDiscards, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInUcastPkts=ifInUcastPkts, ifAdminStatus=ifAdminStatus, ifOperStatus=ifOperStatus, ifCompliance3=ifCompliance3, ifEntry=ifEntry)
