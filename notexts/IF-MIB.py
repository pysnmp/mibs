...
TimeStamp, TestAndIncr, AutonomousType, PhysAddress, TruthValue, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TestAndIncr", "AutonomousType", "PhysAddress", "TruthValue", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifSpecific=ifSpecific, ifXTable=ifXTable, ifInUcastPkts=ifInUcastPkts, ifMIB=ifMIB, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralGroup=ifGeneralGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInOctets=ifInOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressEntry=ifRcvAddressEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifStackGroup=ifStackGroup, ifMIBObjects=ifMIBObjects, ifStackLowerLayer=ifStackLowerLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance2=ifCompliance2, ifTestGroup=ifTestGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifTestOwner=ifTestOwner, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifCompliances=ifCompliances, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifXEntry=ifXEntry, ifStackGroup2=ifStackGroup2, ifInDiscards=ifInDiscards, ifGroups=ifGroups, linkUp=linkUp, ifInMulticastPkts=ifInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTable=ifTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestStatus=ifTestStatus, ifHCOutOctets=ifHCOutOctets, ifIndex=ifIndex, ifAlias=ifAlias, ifStackLastChange=ifStackLastChange, ifHCInOctets=ifHCInOctets, ifEntry=ifEntry, ifPhysAddress=ifPhysAddress, ifOutNUcastPkts=ifOutNUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifOutErrors=ifOutErrors, ifHighSpeed=ifHighSpeed, ifStackEntry=ifStackEntry, ifOutOctets=ifOutOctets, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, OwnerString=OwnerString, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, linkDown=linkDown, ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifInNUcastPkts=ifInNUcastPkts, ifPacketGroup=ifPacketGroup, ifType=ifType, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifTestCode=ifTestCode, ifInErrors=ifInErrors, ifLastChange=ifLastChange, ifName=ifName, interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifMtu=ifMtu, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifConformance=ifConformance, PYSNMP_MODULE_ID=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestId=ifTestId)
