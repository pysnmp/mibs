...
mib_2, iso, IpAddress, Unsigned32, Counter32, Counter64, Integer32, Bits, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "iso", "IpAddress", "Unsigned32", "Counter32", "Counter64", "Integer32", "Bits", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, PhysAddress, TestAndIncr, AutonomousType, TextualConvention, TruthValue, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TestAndIncr", "AutonomousType", "TextualConvention", "TruthValue", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInUcastPkts=ifHCInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifTableLastChange=ifTableLastChange, ifTestEntry=ifTestEntry, ifGeneralGroup=ifGeneralGroup, ifStackGroup2=ifStackGroup2, ifStackGroup=ifStackGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestType=ifTestType, ifInMulticastPkts=ifInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifInOctets=ifInOctets, ifGroups=ifGroups, interfaces=interfaces, ifXTable=ifXTable, ifOutDiscards=ifOutDiscards, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifCompliance3=ifCompliance3, ifAdminStatus=ifAdminStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifInErrors=ifInErrors, PYSNMP_MODULE_ID=ifMIB, ifStackHigherLayer=ifStackHigherLayer, ifSpecific=ifSpecific, ifDescr=ifDescr, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifPacketGroup=ifPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifNumber=ifNumber, ifIndex=ifIndex, ifTestResult=ifTestResult, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifMIB=ifMIB, linkUp=linkUp, ifTestOwner=ifTestOwner, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifOutMulticastPkts=ifOutMulticastPkts, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, ifInDiscards=ifInDiscards, OwnerString=OwnerString, ifHCInOctets=ifHCInOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, ifAlias=ifAlias, ifInNUcastPkts=ifInNUcastPkts, ifTestGroup=ifTestGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifOutErrors=ifOutErrors, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCompliance2=ifCompliance2, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifType=ifType, ifTestStatus=ifTestStatus, ifSpeed=ifSpeed, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifRcvAddressGroup=ifRcvAddressGroup, ifMIBObjects=ifMIBObjects, ifMtu=ifMtu, ifOutQLen=ifOutQLen, InterfaceIndex=InterfaceIndex, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifName=ifName, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOperStatus=ifOperStatus, ifPhysAddress=ifPhysAddress)
