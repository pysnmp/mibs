...
DisplayString, PhysAddress, TimeStamp, AutonomousType, TruthValue, TextualConvention, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInUnknownProtos=ifInUnknownProtos, ifFixedLengthGroup=ifFixedLengthGroup, ifTable=ifTable, ifOutDiscards=ifOutDiscards, ifInMulticastPkts=ifInMulticastPkts, ifType=ifType, ifStackStatus=ifStackStatus, ifTestStatus=ifTestStatus, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifHCInOctets=ifHCInOctets, InterfaceIndex=InterfaceIndex, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifCompliance2=ifCompliance2, ifGroups=ifGroups, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifTestTable=ifTestTable, ifHighSpeed=ifHighSpeed, ifRcvAddressEntry=ifRcvAddressEntry, ifInNUcastPkts=ifInNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifName=ifName, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestId=ifTestId, ifSpecific=ifSpecific, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup=ifStackGroup, ifStackEntry=ifStackEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifXEntry=ifXEntry, ifTestOwner=ifTestOwner, ifAlias=ifAlias, ifOutErrors=ifOutErrors, ifLastChange=ifLastChange, interfaces=interfaces, ifTestCode=ifTestCode, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLastChange=ifStackLastChange, PYSNMP_MODULE_ID=ifMIB, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance3=ifCompliance3, ifOutOctets=ifOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifRcvAddressAddress=ifRcvAddressAddress, ifHCPacketGroup=ifHCPacketGroup, linkUp=linkUp, ifTestEntry=ifTestEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifInErrors=ifInErrors, ifConnectorPresent=ifConnectorPresent, ifXTable=ifXTable, ifOperStatus=ifOperStatus, ifTestType=ifTestType, ifRcvAddressTable=ifRcvAddressTable, ifGeneralGroup=ifGeneralGroup, ifTableLastChange=ifTableLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, ifConformance=ifConformance, ifInOctets=ifInOctets, ifDescr=ifDescr, ifOutQLen=ifOutQLen, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutUcastPkts=ifOutUcastPkts, linkDown=linkDown, ifNumber=ifNumber, ifSpeed=ifSpeed, OwnerString=OwnerString, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifMtu=ifMtu, ifRcvAddressType=ifRcvAddressType, ifCompliance=ifCompliance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifIndex=ifIndex, ifStackHigherLayer=ifStackHigherLayer, ifEntry=ifEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInDiscards=ifInDiscards, ifAdminStatus=ifAdminStatus, ifInUcastPkts=ifInUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifPacketGroup=ifPacketGroup, ifMIB=ifMIB)
