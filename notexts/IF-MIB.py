...
AutonomousType, TruthValue, DisplayString, TimeStamp, PhysAddress, TextualConvention, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "DisplayString", "TimeStamp", "PhysAddress", "TextualConvention", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifConnectorPresent=ifConnectorPresent, ifType=ifType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressTable=ifRcvAddressTable, ifFixedLengthGroup=ifFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifTestTable=ifTestTable, OwnerString=OwnerString, ifSpecific=ifSpecific, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralGroup=ifGeneralGroup, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, ifOutOctets=ifOutOctets, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifEntry=ifEntry, ifOutQLen=ifOutQLen, ifStackLastChange=ifStackLastChange, ifConformance=ifConformance, ifTable=ifTable, ifGroups=ifGroups, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, linkDown=linkDown, ifCompliance=ifCompliance, ifIndex=ifIndex, ifHighSpeed=ifHighSpeed, ifRcvAddressType=ifRcvAddressType, ifTestResult=ifTestResult, ifInUcastPkts=ifInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackEntry=ifStackEntry, ifTestId=ifTestId, ifInErrors=ifInErrors, ifInMulticastPkts=ifInMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutDiscards=ifOutDiscards, ifAlias=ifAlias, ifTestGroup=ifTestGroup, ifCompliance3=ifCompliance3, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, ifStackStatus=ifStackStatus, ifAdminStatus=ifAdminStatus, linkUp=linkUp, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, interfaces=interfaces, ifInOctets=ifInOctets, ifOutErrors=ifOutErrors, ifMIB=ifMIB, ifName=ifName, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifMtu=ifMtu, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifHCOutOctets=ifHCOutOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifHCPacketGroup=ifHCPacketGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifLastChange=ifLastChange, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInDiscards=ifInDiscards, ifXTable=ifXTable, ifInUnknownProtos=ifInUnknownProtos, ifPacketGroup=ifPacketGroup, ifStackGroup=ifStackGroup, ifCompliance2=ifCompliance2, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestEntry=ifTestEntry, ifTestStatus=ifTestStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestCode=ifTestCode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInNUcastPkts=ifInNUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifSpeed=ifSpeed, ifTestType=ifTestType, ifRcvAddressAddress=ifRcvAddressAddress)
