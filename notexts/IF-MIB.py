...
TruthValue, TimeStamp, RowStatus, TestAndIncr, PhysAddress, AutonomousType, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "RowStatus", "TestAndIncr", "PhysAddress", "AutonomousType", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance2=ifCompliance2, PYSNMP_MODULE_ID=ifMIB, ifStackLastChange=ifStackLastChange, ifPhysAddress=ifPhysAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliances=ifCompliances, ifOutNUcastPkts=ifOutNUcastPkts, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifInDiscards=ifInDiscards, ifConformance=ifConformance, InterfaceIndex=InterfaceIndex, ifOutQLen=ifOutQLen, ifTestTable=ifTestTable, ifTestResult=ifTestResult, ifIndex=ifIndex, ifInErrors=ifInErrors, ifXTable=ifXTable, ifOutUcastPkts=ifOutUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr, linkUp=linkUp, ifCompliance3=ifCompliance3, ifRcvAddressGroup=ifRcvAddressGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifName=ifName, ifGeneralGroup=ifGeneralGroup, ifMIB=ifMIB, ifTestType=ifTestType, ifStackLowerLayer=ifStackLowerLayer, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifInNUcastPkts=ifInNUcastPkts, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifOperStatus=ifOperStatus, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestId=ifTestId, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, interfaces=interfaces, ifGeneralInformationGroup=ifGeneralInformationGroup, ifLastChange=ifLastChange, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifGroups=ifGroups, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestCode=ifTestCode, ifMtu=ifMtu, ifStackEntry=ifStackEntry, ifNumber=ifNumber, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifMIBObjects=ifMIBObjects, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifEntry=ifEntry, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifSpecific=ifSpecific, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestStatus=ifTestStatus, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifStackStatus=ifStackStatus, ifInUcastPkts=ifInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifXEntry=ifXEntry, ifStackTable=ifStackTable, ifTestOwner=ifTestOwner, ifOutMulticastPkts=ifOutMulticastPkts, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifAdminStatus=ifAdminStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup2=ifStackGroup2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance=ifCompliance, ifType=ifType, OwnerString=OwnerString)
