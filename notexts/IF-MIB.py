...
PhysAddress, TimeStamp, TextualConvention, RowStatus, DisplayString, TestAndIncr, TruthValue, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TestAndIncr", "TruthValue", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifIndex=ifIndex, ifOutUcastPkts=ifOutUcastPkts, ifTestCode=ifTestCode, ifInBroadcastPkts=ifInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifPhysAddress=ifPhysAddress, ifEntry=ifEntry, linkDown=linkDown, ifCompliance2=ifCompliance2, InterfaceIndexOrZero=InterfaceIndexOrZero, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestOwner=ifTestOwner, ifTestResult=ifTestResult, ifInUnknownProtos=ifInUnknownProtos, ifTestId=ifTestId, ifStackStatus=ifStackStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackLowerLayer=ifStackLowerLayer, ifStackTable=ifStackTable, ifOutMulticastPkts=ifOutMulticastPkts, ifGroups=ifGroups, InterfaceIndex=InterfaceIndex, linkUp=linkUp, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifStackLastChange=ifStackLastChange, ifInOctets=ifInOctets, ifHCInUcastPkts=ifHCInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressGroup=ifRcvAddressGroup, OwnerString=OwnerString, ifMIBObjects=ifMIBObjects, ifInDiscards=ifInDiscards, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackEntry=ifStackEntry, ifConformance=ifConformance, ifTable=ifTable, ifRcvAddressType=ifRcvAddressType, ifCompliances=ifCompliances, ifHCOutOctets=ifHCOutOctets, ifCompliance3=ifCompliance3, ifHCInOctets=ifHCInOctets, ifOutErrors=ifOutErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpeed=ifSpeed, ifRcvAddressTable=ifRcvAddressTable, ifOldObjectsGroup=ifOldObjectsGroup, ifOutQLen=ifOutQLen, ifInUcastPkts=ifInUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifGeneralGroup=ifGeneralGroup, PYSNMP_MODULE_ID=ifMIB, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, interfaces=interfaces, ifTestTable=ifTestTable, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestEntry=ifTestEntry, ifOperStatus=ifOperStatus, ifXEntry=ifXEntry, ifName=ifName, ifXTable=ifXTable, ifType=ifType, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifNumber=ifNumber, ifPacketGroup=ifPacketGroup, ifOutDiscards=ifOutDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, ifPromiscuousMode=ifPromiscuousMode, ifMtu=ifMtu, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifStackGroup2=ifStackGroup2, ifStackGroup=ifStackGroup, ifLastChange=ifLastChange)
