...
AutonomousType, TextualConvention, PhysAddress, TruthValue, TestAndIncr, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TextualConvention", "PhysAddress", "TruthValue", "TestAndIncr", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifTestResult=ifTestResult, ifTestOwner=ifTestOwner, ifGroups=ifGroups, ifXTable=ifXTable, ifAlias=ifAlias, ifGeneralGroup=ifGeneralGroup, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifCompliances=ifCompliances, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifTestStatus=ifTestStatus, ifCompliance2=ifCompliance2, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifLastChange=ifLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackTable=ifStackTable, ifOutOctets=ifOutOctets, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifXEntry=ifXEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifSpecific=ifSpecific, ifCompliance3=ifCompliance3, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifHCPacketGroup=ifHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInDiscards=ifInDiscards, ifStackEntry=ifStackEntry, ifEntry=ifEntry, ifAdminStatus=ifAdminStatus, ifTestGroup=ifTestGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifInMulticastPkts=ifInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifTestId=ifTestId, ifMtu=ifMtu, ifConformance=ifConformance, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifStackLowerLayer=ifStackLowerLayer, ifTestEntry=ifTestEntry, ifInOctets=ifInOctets, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifStackGroup=ifStackGroup, ifStackHigherLayer=ifStackHigherLayer, ifTableLastChange=ifTableLastChange, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifType=ifType, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, ifTable=ifTable, ifHCOutOctets=ifHCOutOctets, ifStackStatus=ifStackStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHighSpeed=ifHighSpeed, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPacketGroup=ifPacketGroup, ifInErrors=ifInErrors, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackGroup2=ifStackGroup2, ifCompliance=ifCompliance, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifHCInUcastPkts=ifHCInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutDiscards=ifOutDiscards, linkUp=linkUp, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, linkDown=linkDown, ifDescr=ifDescr, ifOutQLen=ifOutQLen)
