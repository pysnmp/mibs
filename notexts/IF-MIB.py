...
PhysAddress, TruthValue, RowStatus, TestAndIncr, TextualConvention, TimeStamp, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TruthValue", "RowStatus", "TestAndIncr", "TextualConvention", "TimeStamp", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifInErrors=ifInErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestCode=ifTestCode, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifOutErrors=ifOutErrors, ifPromiscuousMode=ifPromiscuousMode, ifCompliance=ifCompliance, ifStackStatus=ifStackStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestResult=ifTestResult, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutDiscards=ifOutDiscards, ifRcvAddressEntry=ifRcvAddressEntry, ifStackLowerLayer=ifStackLowerLayer, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, ifInNUcastPkts=ifInNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifSpeed=ifSpeed, ifNumber=ifNumber, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifAdminStatus=ifAdminStatus, ifStackGroup2=ifStackGroup2, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifType=ifType, ifStackTable=ifStackTable, ifOutUcastPkts=ifOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifStackLastChange=ifStackLastChange, ifConnectorPresent=ifConnectorPresent, ifXTable=ifXTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifName=ifName, ifOutMulticastPkts=ifOutMulticastPkts, ifConformance=ifConformance, ifStackEntry=ifStackEntry, ifTestTable=ifTestTable, ifInBroadcastPkts=ifInBroadcastPkts, ifGroups=ifGroups, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifInOctets=ifInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance3=ifCompliance3, ifInDiscards=ifInDiscards, ifTestType=ifTestType, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifIndex=ifIndex, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, ifGeneralGroup=ifGeneralGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, PYSNMP_MODULE_ID=ifMIB, ifPhysAddress=ifPhysAddress, ifXEntry=ifXEntry, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifMIB=ifMIB, ifTestEntry=ifTestEntry, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifSpecific=ifSpecific, ifHCOutOctets=ifHCOutOctets, ifCompliance2=ifCompliance2, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestGroup=ifTestGroup, InterfaceIndexOrZero=InterfaceIndexOrZero)
