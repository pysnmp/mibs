...
Integer32, Counter64, Bits, iso, IpAddress, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType, ObjectIdentity, mib_2, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Bits", "iso", "IpAddress", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType", "ObjectIdentity", "mib-2", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
DisplayString, TruthValue, TestAndIncr, RowStatus, TimeStamp, TextualConvention, PhysAddress, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TestAndIncr", "RowStatus", "TimeStamp", "TextualConvention", "PhysAddress", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifHighSpeed=ifHighSpeed, ifStackGroup=ifStackGroup, ifMIB=ifMIB, ifCompliance2=ifCompliance2, ifHCOutOctets=ifHCOutOctets, linkUp=linkUp, ifTestEntry=ifTestEntry, ifTestResult=ifTestResult, ifInNUcastPkts=ifInNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifInDiscards=ifInDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifEntry=ifEntry, ifIndex=ifIndex, ifPhysAddress=ifPhysAddress, ifCompliance=ifCompliance, ifRcvAddressAddress=ifRcvAddressAddress, linkDown=linkDown, ifLastChange=ifLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifConformance=ifConformance, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInOctets=ifHCInOctets, ifTestTable=ifTestTable, ifInBroadcastPkts=ifInBroadcastPkts, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, interfaces=interfaces, ifStackHigherLayer=ifStackHigherLayer, ifTestOwner=ifTestOwner, ifNumber=ifNumber, ifCompliance3=ifCompliance3, ifMtu=ifMtu, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndex=InterfaceIndex, ifGroups=ifGroups, ifInOctets=ifInOctets, ifPromiscuousMode=ifPromiscuousMode, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifMIBObjects=ifMIBObjects, ifDescr=ifDescr, ifOperStatus=ifOperStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, PYSNMP_MODULE_ID=ifMIB, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, ifTestId=ifTestId, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackTable=ifStackTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestGroup=ifTestGroup, ifPacketGroup=ifPacketGroup, ifType=ifType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpeed=ifSpeed, ifGeneralGroup=ifGeneralGroup, ifAlias=ifAlias, ifInUnknownProtos=ifInUnknownProtos, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifXEntry=ifXEntry, OwnerString=OwnerString, ifXTable=ifXTable, ifRcvAddressStatus=ifRcvAddressStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressTable=ifRcvAddressTable, ifOutErrors=ifOutErrors, ifOutQLen=ifOutQLen, ifOutMulticastPkts=ifOutMulticastPkts, ifStackEntry=ifStackEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTable=ifTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, ifName=ifName, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInErrors=ifInErrors, ifStackLastChange=ifStackLastChange, ifOutDiscards=ifOutDiscards, InterfaceIndexOrZero=InterfaceIndexOrZero, ifFixedLengthGroup=ifFixedLengthGroup)
