...
TruthValue, TestAndIncr, DisplayString, TextualConvention, TimeStamp, PhysAddress, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "DisplayString", "TextualConvention", "TimeStamp", "PhysAddress", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifOutMulticastPkts=ifOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifStackEntry=ifStackEntry, ifTestType=ifTestType, interfaces=interfaces, ifGroups=ifGroups, ifAlias=ifAlias, PYSNMP_MODULE_ID=ifMIB, ifTestTable=ifTestTable, ifStackGroup2=ifStackGroup2, ifTestOwner=ifTestOwner, ifRcvAddressGroup=ifRcvAddressGroup, ifXEntry=ifXEntry, ifTableLastChange=ifTableLastChange, ifStackLastChange=ifStackLastChange, OwnerString=OwnerString, ifOldObjectsGroup=ifOldObjectsGroup, ifInMulticastPkts=ifInMulticastPkts, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressTable=ifRcvAddressTable, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestGroup=ifTestGroup, ifTestResult=ifTestResult, ifConformance=ifConformance, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance2=ifCompliance2, ifRcvAddressStatus=ifRcvAddressStatus, ifTestId=ifTestId, ifStackHigherLayer=ifStackHigherLayer, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifOperStatus=ifOperStatus, ifLastChange=ifLastChange, ifOutOctets=ifOutOctets, ifDescr=ifDescr, ifNumber=ifNumber, ifSpecific=ifSpecific, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup=ifStackGroup, ifAdminStatus=ifAdminStatus, ifTestStatus=ifTestStatus, ifMtu=ifMtu, ifHighSpeed=ifHighSpeed, ifInOctets=ifInOctets, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInUcastPkts=ifInUcastPkts, ifInErrors=ifInErrors, ifOutDiscards=ifOutDiscards, ifHCPacketGroup=ifHCPacketGroup, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifInUnknownProtos=ifInUnknownProtos, linkUp=linkUp, ifStackTable=ifStackTable, ifInBroadcastPkts=ifInBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, linkDown=linkDown, ifInNUcastPkts=ifInNUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMIB=ifMIB, ifCompliance=ifCompliance, ifTestCode=ifTestCode, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutOctets=ifHCOutOctets, ifName=ifName, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifGeneralGroup=ifGeneralGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance3=ifCompliance3, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressType=ifRcvAddressType, ifType=ifType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifConnectorPresent=ifConnectorPresent, ifOutErrors=ifOutErrors, ifPacketGroup=ifPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup)
