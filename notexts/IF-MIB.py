...
TextualConvention, DisplayString, AutonomousType, PhysAddress, TestAndIncr, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "AutonomousType", "PhysAddress", "TestAndIncr", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, interfaces=interfaces, ifXEntry=ifXEntry, ifTable=ifTable, ifTestOwner=ifTestOwner, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifOutQLen=ifOutQLen, ifRcvAddressType=ifRcvAddressType, ifName=ifName, ifStackLastChange=ifStackLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackStatus=ifStackStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUcastPkts=ifInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMtu=ifMtu, OwnerString=OwnerString, ifStackGroup=ifStackGroup, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifGroups=ifGroups, ifDescr=ifDescr, ifRcvAddressTable=ifRcvAddressTable, ifOutNUcastPkts=ifOutNUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifPhysAddress=ifPhysAddress, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, PYSNMP_MODULE_ID=ifMIB, linkDown=linkDown, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifTestGroup=ifTestGroup, ifRcvAddressStatus=ifRcvAddressStatus, InterfaceIndex=InterfaceIndex, ifTestEntry=ifTestEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifTestResult=ifTestResult, ifInErrors=ifInErrors, ifType=ifType, ifSpeed=ifSpeed, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInDiscards=ifInDiscards, ifHighSpeed=ifHighSpeed, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifPacketGroup=ifPacketGroup, ifIndex=ifIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutErrors=ifOutErrors, ifEntry=ifEntry, ifLastChange=ifLastChange, ifStackHigherLayer=ifStackHigherLayer, ifConformance=ifConformance, ifOutOctets=ifOutOctets, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifXTable=ifXTable, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, ifHCInOctets=ifHCInOctets, ifHCOutOctets=ifHCOutOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOperStatus=ifOperStatus, ifCompliance=ifCompliance, ifStackGroup2=ifStackGroup2, ifRcvAddressGroup=ifRcvAddressGroup, ifHCPacketGroup=ifHCPacketGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMIB=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts)
