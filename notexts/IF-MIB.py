...
TruthValue, TextualConvention, AutonomousType, TimeStamp, RowStatus, PhysAddress, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TimeStamp", "RowStatus", "PhysAddress", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTestType=ifTestType, ifInUnknownProtos=ifInUnknownProtos, ifCompliance3=ifCompliance3, ifAlias=ifAlias, ifCompliance2=ifCompliance2, ifSpeed=ifSpeed, ifOutUcastPkts=ifOutUcastPkts, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressEntry=ifRcvAddressEntry, ifGeneralGroup=ifGeneralGroup, ifTestGroup=ifTestGroup, ifHighSpeed=ifHighSpeed, ifGroups=ifGroups, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInOctets=ifHCInOctets, ifStackLowerLayer=ifStackLowerLayer, ifOutQLen=ifOutQLen, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackTable=ifStackTable, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifTestEntry=ifTestEntry, ifMIB=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifInOctets=ifInOctets, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifRcvAddressTable=ifRcvAddressTable, ifTestResult=ifTestResult, ifRcvAddressStatus=ifRcvAddressStatus, ifHCPacketGroup=ifHCPacketGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifStackEntry=ifStackEntry, ifInDiscards=ifInDiscards, ifAdminStatus=ifAdminStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIBObjects=ifMIBObjects, ifInNUcastPkts=ifInNUcastPkts, ifEntry=ifEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestOwner=ifTestOwner, ifCompliance=ifCompliance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifIndex=ifIndex, ifInErrors=ifInErrors, ifOutErrors=ifOutErrors, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, InterfaceIndexOrZero=InterfaceIndexOrZero, linkUp=linkUp, ifTestId=ifTestId, ifStackGroup=ifStackGroup, OwnerString=OwnerString, ifConnectorPresent=ifConnectorPresent, ifOperStatus=ifOperStatus, ifTestTable=ifTestTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressType=ifRcvAddressType, ifTestStatus=ifTestStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, interfaces=interfaces, ifType=ifType, ifInUcastPkts=ifInUcastPkts, ifMtu=ifMtu, ifOutOctets=ifOutOctets, ifSpecific=ifSpecific, ifRcvAddressGroup=ifRcvAddressGroup, ifInMulticastPkts=ifInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifPhysAddress=ifPhysAddress, PYSNMP_MODULE_ID=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup2=ifStackGroup2, ifPacketGroup=ifPacketGroup, ifStackStatus=ifStackStatus, ifTable=ifTable, ifName=ifName, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifCompliances=ifCompliances, ifTestCode=ifTestCode, ifDescr=ifDescr, ifXTable=ifXTable, InterfaceIndex=InterfaceIndex, ifInBroadcastPkts=ifInBroadcastPkts, ifXEntry=ifXEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
