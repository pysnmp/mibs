...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, ObjectIdentity, NotificationType, ModuleIdentity, mib_2, Unsigned32, TimeTicks, Counter32, IpAddress, Counter64, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "ObjectIdentity", "NotificationType", "ModuleIdentity", "mib-2", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "Counter64", "iso", "Gauge32")
TextualConvention, TimeStamp, RowStatus, TruthValue, PhysAddress, AutonomousType, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "RowStatus", "TruthValue", "PhysAddress", "AutonomousType", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifInDiscards=ifInDiscards, ifSpecific=ifSpecific, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressEntry=ifRcvAddressEntry, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInUnknownProtos=ifInUnknownProtos, ifEntry=ifEntry, ifOperStatus=ifOperStatus, ifOutErrors=ifOutErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTable=ifTable, ifHighSpeed=ifHighSpeed, ifSpeed=ifSpeed, ifTestType=ifTestType, ifLastChange=ifLastChange, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifAdminStatus=ifAdminStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPacketGroup=ifPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLastChange=ifStackLastChange, interfaces=interfaces, ifName=ifName, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifGroups=ifGroups, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifStackTable=ifStackTable, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, ifInOctets=ifInOctets, ifStackGroup2=ifStackGroup2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestCode=ifTestCode, ifIndex=ifIndex, ifType=ifType, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, linkDown=linkDown, linkUp=linkUp, ifHCInOctets=ifHCInOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifOutUcastPkts=ifOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifMIB=ifMIB, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifTestResult=ifTestResult, ifOldObjectsGroup=ifOldObjectsGroup, ifConformance=ifConformance, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifCompliance2=ifCompliance2, ifRcvAddressGroup=ifRcvAddressGroup, ifOutQLen=ifOutQLen, ifGeneralGroup=ifGeneralGroup, ifMtu=ifMtu, ifInBroadcastPkts=ifInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLowerLayer=ifStackLowerLayer, ifTestId=ifTestId, ifInUcastPkts=ifInUcastPkts, ifHCOutOctets=ifHCOutOctets, ifXEntry=ifXEntry, ifTestOwner=ifTestOwner, ifStackGroup=ifStackGroup, OwnerString=OwnerString, ifCompliance3=ifCompliance3, ifAlias=ifAlias, ifRcvAddressType=ifRcvAddressType)
