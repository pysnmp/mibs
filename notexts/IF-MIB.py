...
RowStatus, TimeStamp, AutonomousType, PhysAddress, TestAndIncr, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "AutonomousType", "PhysAddress", "TestAndIncr", "TextualConvention", "DisplayString", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifLastChange=ifLastChange, ifCompliance3=ifCompliance3, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConformance=ifConformance, ifOutMulticastPkts=ifOutMulticastPkts, ifTestCode=ifTestCode, ifOutQLen=ifOutQLen, ifCompliances=ifCompliances, ifConnectorPresent=ifConnectorPresent, ifHCPacketGroup=ifHCPacketGroup, ifNumber=ifNumber, ifDescr=ifDescr, ifHCOutOctets=ifHCOutOctets, ifTestEntry=ifTestEntry, ifTestStatus=ifTestStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifAlias=ifAlias, ifInUcastPkts=ifInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestGroup=ifTestGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifXTable=ifXTable, ifInBroadcastPkts=ifInBroadcastPkts, ifTestOwner=ifTestOwner, ifHCInUcastPkts=ifHCInUcastPkts, ifSpeed=ifSpeed, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifSpecific=ifSpecific, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, ifXEntry=ifXEntry, ifName=ifName, ifHCInOctets=ifHCInOctets, ifTestId=ifTestId, ifStackLastChange=ifStackLastChange, ifMIBObjects=ifMIBObjects, ifFixedLengthGroup=ifFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifOutDiscards=ifOutDiscards, ifStackEntry=ifStackEntry, PYSNMP_MODULE_ID=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode, ifTableLastChange=ifTableLastChange, ifGeneralGroup=ifGeneralGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInOctets=ifInOctets, ifStackGroup2=ifStackGroup2, ifInErrors=ifInErrors, ifGroups=ifGroups, ifStackHigherLayer=ifStackHigherLayer, ifOutErrors=ifOutErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, interfaces=interfaces, ifInDiscards=ifInDiscards, ifRcvAddressEntry=ifRcvAddressEntry, ifStackTable=ifStackTable, ifVHCPacketGroup=ifVHCPacketGroup, OwnerString=OwnerString, ifTestType=ifTestType, ifOutOctets=ifOutOctets, ifTestResult=ifTestResult, ifStackGroup=ifStackGroup, ifType=ifType, linkDown=linkDown, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMtu=ifMtu, ifAdminStatus=ifAdminStatus, linkUp=linkUp, ifTestTable=ifTestTable, ifStackStatus=ifStackStatus, ifMIB=ifMIB, ifOperStatus=ifOperStatus, ifInUnknownProtos=ifInUnknownProtos, ifPhysAddress=ifPhysAddress, ifEntry=ifEntry)
