...
RowStatus, TestAndIncr, PhysAddress, TextualConvention, TimeStamp, TruthValue, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TestAndIncr", "PhysAddress", "TextualConvention", "TimeStamp", "TruthValue", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifOldObjectsGroup=ifOldObjectsGroup, ifInBroadcastPkts=ifInBroadcastPkts, InterfaceIndex=InterfaceIndex, ifTable=ifTable, ifInMulticastPkts=ifInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifInUcastPkts=ifInUcastPkts, ifTestTable=ifTestTable, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode, ifInOctets=ifInOctets, linkUp=linkUp, ifLastChange=ifLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestType=ifTestType, ifInNUcastPkts=ifInNUcastPkts, ifName=ifName, ifRcvAddressTable=ifRcvAddressTable, ifTestOwner=ifTestOwner, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifOutOctets=ifOutOctets, interfaces=interfaces, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHighSpeed=ifHighSpeed, ifOutDiscards=ifOutDiscards, ifMIB=ifMIB, ifStackLowerLayer=ifStackLowerLayer, ifFixedLengthGroup=ifFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifIndex=ifIndex, ifStackTable=ifStackTable, ifOutErrors=ifOutErrors, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackStatus=ifStackStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMtu=ifMtu, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifOperStatus=ifOperStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifAdminStatus=ifAdminStatus, ifOutNUcastPkts=ifOutNUcastPkts, linkDown=linkDown, ifConformance=ifConformance, ifSpecific=ifSpecific, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifSpeed=ifSpeed, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutQLen=ifOutQLen, ifTestStatus=ifTestStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestResult=ifTestResult, ifPacketGroup=ifPacketGroup, ifXEntry=ifXEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifStackGroup=ifStackGroup, ifTestId=ifTestId, ifGeneralGroup=ifGeneralGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInDiscards=ifInDiscards, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXTable=ifXTable, ifCompliances=ifCompliances, ifAlias=ifAlias, ifType=ifType, ifRcvAddressAddress=ifRcvAddressAddress, PYSNMP_MODULE_ID=ifMIB, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUnknownProtos=ifInUnknownProtos, ifHCPacketGroup=ifHCPacketGroup, ifEntry=ifEntry, ifTableLastChange=ifTableLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifStackEntry=ifStackEntry, ifConnectorPresent=ifConnectorPresent, ifInErrors=ifInErrors, ifGroups=ifGroups, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects)
