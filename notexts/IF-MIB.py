...
TruthValue, TextualConvention, TestAndIncr, AutonomousType, TimeStamp, PhysAddress, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "TestAndIncr", "AutonomousType", "TimeStamp", "PhysAddress", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifGroups=ifGroups, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackStatus=ifStackStatus, ifStackGroup2=ifStackGroup2, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifMIB=ifMIB, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifAdminStatus=ifAdminStatus, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifXTable=ifXTable, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndex=InterfaceIndex, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutQLen=ifOutQLen, ifStackEntry=ifStackEntry, ifTestTable=ifTestTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifOperStatus=ifOperStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance3=ifCompliance3, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifMIBObjects=ifMIBObjects, ifStackTable=ifStackTable, linkDown=linkDown, ifXEntry=ifXEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifInOctets=ifInOctets, ifInUcastPkts=ifInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestResult=ifTestResult, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifHCInMulticastPkts=ifHCInMulticastPkts, ifSpecific=ifSpecific, ifType=ifType, OwnerString=OwnerString, ifStackHigherLayer=ifStackHigherLayer, ifTestId=ifTestId, ifHCOutUcastPkts=ifHCOutUcastPkts, ifLastChange=ifLastChange, ifTestStatus=ifTestStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHighSpeed=ifHighSpeed, ifPhysAddress=ifPhysAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestType=ifTestType, ifInErrors=ifInErrors, ifCompliance=ifCompliance, ifTestCode=ifTestCode, ifInMulticastPkts=ifInMulticastPkts, ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifHCOutOctets=ifHCOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifName=ifName, ifCompliances=ifCompliances, ifCompliance2=ifCompliance2, ifOutErrors=ifOutErrors, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutOctets=ifOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifMtu=ifMtu, ifSpeed=ifSpeed, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifStackLowerLayer=ifStackLowerLayer, ifConformance=ifConformance, ifIndex=ifIndex, ifTableLastChange=ifTableLastChange, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifRcvAddressStatus=ifRcvAddressStatus)
