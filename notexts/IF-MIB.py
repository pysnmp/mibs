...
TruthValue, DisplayString, TimeStamp, AutonomousType, TestAndIncr, PhysAddress, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType", "TestAndIncr", "PhysAddress", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInMulticastPkts=ifInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifType=ifType, ifInDiscards=ifInDiscards, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifLastChange=ifLastChange, ifInOctets=ifInOctets, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifTestGroup=ifTestGroup, ifStackEntry=ifStackEntry, ifMtu=ifMtu, ifInBroadcastPkts=ifInBroadcastPkts, ifTestStatus=ifTestStatus, ifSpeed=ifSpeed, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLastChange=ifStackLastChange, ifXEntry=ifXEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifCompliance=ifCompliance, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, ifIndex=ifIndex, ifTestCode=ifTestCode, ifGeneralInformationGroup=ifGeneralInformationGroup, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestEntry=ifTestEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutDiscards=ifOutDiscards, ifNumber=ifNumber, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifStackTable=ifStackTable, ifGroups=ifGroups, ifPhysAddress=ifPhysAddress, ifRcvAddressTable=ifRcvAddressTable, ifAlias=ifAlias, ifTestType=ifTestType, ifStackStatus=ifStackStatus, ifCompliance3=ifCompliance3, ifTestResult=ifTestResult, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliances=ifCompliances, ifInNUcastPkts=ifInNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, ifDescr=ifDescr, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifGeneralGroup=ifGeneralGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifXTable=ifXTable, interfaces=interfaces, ifTestOwner=ifTestOwner, ifTable=ifTable, ifHCInOctets=ifHCInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifOldObjectsGroup=ifOldObjectsGroup, ifInUcastPkts=ifInUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifRcvAddressAddress=ifRcvAddressAddress, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, ifRcvAddressType=ifRcvAddressType, InterfaceIndex=InterfaceIndex, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifHCOutOctets=ifHCOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifMIB=ifMIB, linkUp=linkUp, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, ifStackGroup2=ifStackGroup2, ifStackLowerLayer=ifStackLowerLayer)
