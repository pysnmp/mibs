...
ModuleIdentity, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, MibIdentifier, iso, Integer32, mib_2, Unsigned32, Counter64, Gauge32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "MibIdentifier", "iso", "Integer32", "mib-2", "Unsigned32", "Counter64", "Gauge32", "NotificationType", "Counter32")
RowStatus, TestAndIncr, TruthValue, PhysAddress, TextualConvention, TimeStamp, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TestAndIncr", "TruthValue", "PhysAddress", "TextualConvention", "TimeStamp", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifSpecific=ifSpecific, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackEntry=ifStackEntry, ifInOctets=ifInOctets, ifHCInOctets=ifHCInOctets, ifOutDiscards=ifOutDiscards, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInErrors=ifInErrors, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifInUnknownProtos=ifInUnknownProtos, ifHCPacketGroup=ifHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup=ifStackGroup, ifInUcastPkts=ifInUcastPkts, ifOperStatus=ifOperStatus, ifInDiscards=ifInDiscards, ifStackLastChange=ifStackLastChange, ifTableLastChange=ifTableLastChange, ifMIB=ifMIB, InterfaceIndexOrZero=InterfaceIndexOrZero, OwnerString=OwnerString, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifSpeed=ifSpeed, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInNUcastPkts=ifInNUcastPkts, ifName=ifName, ifVHCPacketGroup=ifVHCPacketGroup, ifTestOwner=ifTestOwner, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifCompliance2=ifCompliance2, ifTestId=ifTestId, ifTestType=ifTestType, ifRcvAddressStatus=ifRcvAddressStatus, ifOutQLen=ifOutQLen, ifCompliances=ifCompliances, ifStackStatus=ifStackStatus, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance=ifCompliance, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifXTable=ifXTable, ifGroups=ifGroups, linkDown=linkDown, ifXEntry=ifXEntry, ifOutErrors=ifOutErrors, ifStackHigherLayer=ifStackHigherLayer, linkUp=linkUp, ifOutMulticastPkts=ifOutMulticastPkts, ifTestTable=ifTestTable, ifConformance=ifConformance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTestGroup=ifTestGroup, ifHCOutOctets=ifHCOutOctets, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifStackTable=ifStackTable, ifCompliance3=ifCompliance3, PYSNMP_MODULE_ID=ifMIB, ifTestEntry=ifTestEntry, ifMtu=ifMtu, ifLastChange=ifLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifMIBObjects=ifMIBObjects, ifAlias=ifAlias, ifAdminStatus=ifAdminStatus, ifTable=ifTable, ifType=ifType, ifGeneralGroup=ifGeneralGroup)
