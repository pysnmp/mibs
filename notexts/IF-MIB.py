...
PhysAddress, AutonomousType, TextualConvention, TruthValue, TimeStamp, DisplayString, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "AutonomousType", "TextualConvention", "TruthValue", "TimeStamp", "DisplayString", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifRcvAddressGroup=ifRcvAddressGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, interfaces=interfaces, ifStackGroup=ifStackGroup, ifGroups=ifGroups, ifStackLowerLayer=ifStackLowerLayer, ifCompliance2=ifCompliance2, ifMtu=ifMtu, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifTestStatus=ifTestStatus, ifInMulticastPkts=ifInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifTestTable=ifTestTable, ifLastChange=ifLastChange, OwnerString=OwnerString, ifConformance=ifConformance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestGroup=ifTestGroup, ifPromiscuousMode=ifPromiscuousMode, ifMIB=ifMIB, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifSpeed=ifSpeed, ifNumber=ifNumber, ifGeneralGroup=ifGeneralGroup, ifStackHigherLayer=ifStackHigherLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifRcvAddressAddress=ifRcvAddressAddress, ifOutMulticastPkts=ifOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifOutQLen=ifOutQLen, ifTable=ifTable, ifCompliance3=ifCompliance3, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestResult=ifTestResult, ifHCInUcastPkts=ifHCInUcastPkts, ifDescr=ifDescr, ifInUcastPkts=ifInUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutOctets=ifOutOctets, ifIndex=ifIndex, ifStackEntry=ifStackEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifInOctets=ifInOctets, ifEntry=ifEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLastChange=ifStackLastChange, ifHighSpeed=ifHighSpeed, ifRcvAddressEntry=ifRcvAddressEntry, ifInUnknownProtos=ifInUnknownProtos, ifXEntry=ifXEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifInDiscards=ifInDiscards, ifInErrors=ifInErrors, ifRcvAddressTable=ifRcvAddressTable, ifTestOwner=ifTestOwner, ifTestType=ifTestType, PYSNMP_MODULE_ID=ifMIB, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifOutErrors=ifOutErrors, ifType=ifType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndex=InterfaceIndex, ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestId=ifTestId, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifCompliances=ifCompliances, ifXTable=ifXTable, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifTestCode=ifTestCode, ifStackStatus=ifStackStatus, ifHCInOctets=ifHCInOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutOctets=ifHCOutOctets, ifRcvAddressType=ifRcvAddressType, ifTestEntry=ifTestEntry)
