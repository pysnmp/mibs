...
TruthValue, RowStatus, PhysAddress, AutonomousType, TextualConvention, TimeStamp, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "PhysAddress", "AutonomousType", "TextualConvention", "TimeStamp", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifIndex=ifIndex, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestType=ifTestType, ifHCOutOctets=ifHCOutOctets, ifXEntry=ifXEntry, ifInNUcastPkts=ifInNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifHCPacketGroup=ifHCPacketGroup, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifAdminStatus=ifAdminStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifHighSpeed=ifHighSpeed, ifRcvAddressType=ifRcvAddressType, ifOutErrors=ifOutErrors, ifMIB=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInDiscards=ifInDiscards, ifLastChange=ifLastChange, ifCompliance3=ifCompliance3, ifPromiscuousMode=ifPromiscuousMode, ifCompliances=ifCompliances, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifStackGroup=ifStackGroup, ifPhysAddress=ifPhysAddress, ifOperStatus=ifOperStatus, InterfaceIndex=InterfaceIndex, ifRcvAddressTable=ifRcvAddressTable, ifDescr=ifDescr, ifVHCPacketGroup=ifVHCPacketGroup, linkUp=linkUp, ifFixedLengthGroup=ifFixedLengthGroup, ifOutOctets=ifOutOctets, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifSpecific=ifSpecific, linkDown=linkDown, ifTestOwner=ifTestOwner, ifMIBObjects=ifMIBObjects, ifCompliance=ifCompliance, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTable=ifTable, ifOutMulticastPkts=ifOutMulticastPkts, ifStackTable=ifStackTable, ifTestTable=ifTestTable, ifHCInUcastPkts=ifHCInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifEntry=ifEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUnknownProtos=ifInUnknownProtos, OwnerString=OwnerString, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInMulticastPkts=ifInMulticastPkts, ifCompliance2=ifCompliance2, ifTestResult=ifTestResult, ifRcvAddressEntry=ifRcvAddressEntry, ifStackStatus=ifStackStatus, ifStackLowerLayer=ifStackLowerLayer, ifTableLastChange=ifTableLastChange, ifTestId=ifTestId, ifName=ifName, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifTestEntry=ifTestEntry, ifConformance=ifConformance, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifConnectorPresent=ifConnectorPresent, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifInErrors=ifInErrors, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifInOctets=ifInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestStatus=ifTestStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifOutDiscards=ifOutDiscards, ifType=ifType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInOctets=ifHCInOctets, ifStackEntry=ifStackEntry, ifTestGroup=ifTestGroup)
