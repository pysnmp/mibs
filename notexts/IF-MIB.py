...
TextualConvention, DisplayString, TimeStamp, TestAndIncr, AutonomousType, TruthValue, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "TestAndIncr", "AutonomousType", "TruthValue", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifStackEntry=ifStackEntry, ifOutDiscards=ifOutDiscards, ifMIBObjects=ifMIBObjects, ifHighSpeed=ifHighSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifTestGroup=ifTestGroup, ifGroups=ifGroups, linkUp=linkUp, ifStackGroup=ifStackGroup, ifSpecific=ifSpecific, ifIndex=ifIndex, ifMtu=ifMtu, ifRcvAddressType=ifRcvAddressType, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, ifHCInOctets=ifHCInOctets, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestId=ifTestId, ifTestType=ifTestType, ifAdminStatus=ifAdminStatus, ifStackHigherLayer=ifStackHigherLayer, ifCompliance3=ifCompliance3, InterfaceIndex=InterfaceIndex, ifTable=ifTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInNUcastPkts=ifInNUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifCompliance2=ifCompliance2, ifName=ifName, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLastChange=ifStackLastChange, ifOutErrors=ifOutErrors, OwnerString=OwnerString, ifCompliance=ifCompliance, ifPhysAddress=ifPhysAddress, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestEntry=ifTestEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifType=ifType, interfaces=interfaces, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifConnectorPresent=ifConnectorPresent, ifVHCPacketGroup=ifVHCPacketGroup, ifXTable=ifXTable, ifOutOctets=ifOutOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifInUcastPkts=ifInUcastPkts, ifOutQLen=ifOutQLen, ifLastChange=ifLastChange, ifAlias=ifAlias, linkDown=linkDown, ifSpeed=ifSpeed, ifTestStatus=ifTestStatus, ifTestResult=ifTestResult, ifPromiscuousMode=ifPromiscuousMode, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCPacketGroup=ifHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, ifEntry=ifEntry, ifStackLowerLayer=ifStackLowerLayer, ifTestCode=ifTestCode, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifTestTable=ifTestTable, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifStackTable=ifStackTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackGroup2=ifStackGroup2, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInOctets=ifInOctets, ifStackStatus=ifStackStatus, ifXEntry=ifXEntry)
