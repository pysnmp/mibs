...
Bits, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, iso, MibIdentifier, TimeTicks, mib_2, Integer32, Unsigned32, Counter64, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "iso", "MibIdentifier", "TimeTicks", "mib-2", "Integer32", "Unsigned32", "Counter64", "Gauge32", "ModuleIdentity")
TestAndIncr, TextualConvention, AutonomousType, PhysAddress, TruthValue, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "AutonomousType", "PhysAddress", "TruthValue", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifInNUcastPkts=ifInNUcastPkts, ifOutErrors=ifOutErrors, OwnerString=OwnerString, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifStackGroup=ifStackGroup, ifConformance=ifConformance, ifStackStatus=ifStackStatus, ifMIBObjects=ifMIBObjects, ifTestTable=ifTestTable, ifInUcastPkts=ifInUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifOperStatus=ifOperStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInOctets=ifInOctets, ifTestEntry=ifTestEntry, ifCompliances=ifCompliances, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifStackHigherLayer=ifStackHigherLayer, ifInDiscards=ifInDiscards, ifInUnknownProtos=ifInUnknownProtos, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifCompliance=ifCompliance, ifType=ifType, ifMIB=ifMIB, ifVHCPacketGroup=ifVHCPacketGroup, ifGeneralGroup=ifGeneralGroup, ifGroups=ifGroups, ifSpecific=ifSpecific, ifTableLastChange=ifTableLastChange, ifEntry=ifEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifStackEntry=ifStackEntry, ifTestId=ifTestId, ifStackTable=ifStackTable, ifInErrors=ifInErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifRcvAddressTable=ifRcvAddressTable, ifStackLowerLayer=ifStackLowerLayer, ifTestOwner=ifTestOwner, ifCompliance3=ifCompliance3, ifTestStatus=ifTestStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifDescr=ifDescr, ifOutUcastPkts=ifOutUcastPkts, ifSpeed=ifSpeed, ifTestGroup=ifTestGroup, ifCompliance2=ifCompliance2, ifFixedLengthGroup=ifFixedLengthGroup, ifOutDiscards=ifOutDiscards, ifOutOctets=ifOutOctets, ifHCOutOctets=ifHCOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifTable=ifTable, ifHCPacketGroup=ifHCPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifRcvAddressStatus=ifRcvAddressStatus, ifTestCode=ifTestCode, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifConnectorPresent=ifConnectorPresent, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifAdminStatus=ifAdminStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifAlias=ifAlias, ifTestResult=ifTestResult, ifHCOutUcastPkts=ifHCOutUcastPkts, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, interfaces=interfaces, ifHighSpeed=ifHighSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifIndex=ifIndex, ifName=ifName, linkDown=linkDown, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifPacketGroup=ifPacketGroup, ifMtu=ifMtu, InterfaceIndexOrZero=InterfaceIndexOrZero)
