...
ObjectIdentity, Integer32, ModuleIdentity, mib_2, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, iso, NotificationType, TimeTicks, IpAddress, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "ModuleIdentity", "mib-2", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "iso", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64")
TruthValue, PhysAddress, TextualConvention, DisplayString, AutonomousType, TimeStamp, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "PhysAddress", "TextualConvention", "DisplayString", "AutonomousType", "TimeStamp", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLastChange=ifStackLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifTestResult=ifTestResult, ifTestOwner=ifTestOwner, ifRcvAddressGroup=ifRcvAddressGroup, ifHCPacketGroup=ifHCPacketGroup, ifEntry=ifEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifStackTable=ifStackTable, ifMIBObjects=ifMIBObjects, ifTableLastChange=ifTableLastChange, ifTestEntry=ifTestEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance3=ifCompliance3, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPhysAddress=ifPhysAddress, ifTestId=ifTestId, ifIndex=ifIndex, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifTestType=ifTestType, ifTestGroup=ifTestGroup, ifTestCode=ifTestCode, ifFixedLengthGroup=ifFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, PYSNMP_MODULE_ID=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifSpeed=ifSpeed, ifGroups=ifGroups, ifMIB=ifMIB, ifGeneralGroup=ifGeneralGroup, ifInDiscards=ifInDiscards, ifInErrors=ifInErrors, ifLastChange=ifLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifConformance=ifConformance, ifInOctets=ifInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, linkDown=linkDown, ifTable=ifTable, ifTestTable=ifTestTable, ifRcvAddressEntry=ifRcvAddressEntry, ifNumber=ifNumber, ifRcvAddressTable=ifRcvAddressTable, ifSpecific=ifSpecific, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifStackHigherLayer=ifStackHigherLayer, ifCompliances=ifCompliances, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutDiscards=ifOutDiscards, ifRcvAddressType=ifRcvAddressType, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifPacketGroup=ifPacketGroup, OwnerString=OwnerString, ifHCInUcastPkts=ifHCInUcastPkts, ifOperStatus=ifOperStatus, interfaces=interfaces, ifConnectorPresent=ifConnectorPresent, ifXTable=ifXTable, ifDescr=ifDescr, ifCompliance2=ifCompliance2, ifType=ifType, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifOutQLen=ifOutQLen, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHighSpeed=ifHighSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutOctets=ifOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifName=ifName, ifStackGroup2=ifStackGroup2, ifMtu=ifMtu, ifAdminStatus=ifAdminStatus, ifHCInOctets=ifHCInOctets)
