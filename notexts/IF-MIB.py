...
NotificationType, Counter32, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, mib_2, ModuleIdentity, IpAddress, ObjectIdentity, MibIdentifier, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "mib-2", "ModuleIdentity", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "Gauge32")
DisplayString, AutonomousType, TruthValue, PhysAddress, TextualConvention, TimeStamp, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TruthValue", "PhysAddress", "TextualConvention", "TimeStamp", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifSpecific=ifSpecific, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifAdminStatus=ifAdminStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifAlias=ifAlias, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, OwnerString=OwnerString, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestStatus=ifTestStatus, ifInNUcastPkts=ifInNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifInErrors=ifInErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifCompliances=ifCompliances, ifStackLastChange=ifStackLastChange, ifStackEntry=ifStackEntry, ifDescr=ifDescr, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifInDiscards=ifInDiscards, ifConnectorPresent=ifConnectorPresent, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutDiscards=ifOutDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance2=ifCompliance2, ifInMulticastPkts=ifInMulticastPkts, ifMIB=ifMIB, PYSNMP_MODULE_ID=ifMIB, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifTable=ifTable, ifEntry=ifEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConformance=ifConformance, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifCompliance=ifCompliance, ifOutOctets=ifOutOctets, ifCompliance3=ifCompliance3, ifStackTable=ifStackTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifTestTable=ifTestTable, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifGeneralGroup=ifGeneralGroup, ifSpeed=ifSpeed, ifPacketGroup=ifPacketGroup, ifTestEntry=ifTestEntry, ifType=ifType, ifRcvAddressType=ifRcvAddressType, ifRcvAddressAddress=ifRcvAddressAddress, ifStackHigherLayer=ifStackHigherLayer, ifNumber=ifNumber, ifTestType=ifTestType, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestGroup=ifTestGroup, ifPhysAddress=ifPhysAddress, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifOutNUcastPkts=ifOutNUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXTable=ifXTable, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifHighSpeed=ifHighSpeed, ifRcvAddressGroup=ifRcvAddressGroup, linkDown=linkDown, ifMtu=ifMtu, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestResult=ifTestResult, interfaces=interfaces, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifOutErrors=ifOutErrors)
