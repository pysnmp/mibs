...
Gauge32, Integer32, Counter32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter64, Unsigned32, IpAddress, mib_2, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "mib-2", "MibIdentifier", "NotificationType", "iso")
AutonomousType, PhysAddress, TruthValue, TextualConvention, TimeStamp, TestAndIncr, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "PhysAddress", "TruthValue", "TextualConvention", "TimeStamp", "TestAndIncr", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifMtu=ifMtu, ifAlias=ifAlias, ifLastChange=ifLastChange, ifInDiscards=ifInDiscards, ifMIBObjects=ifMIBObjects, ifOutErrors=ifOutErrors, ifTestType=ifTestType, ifOutNUcastPkts=ifOutNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifTestTable=ifTestTable, ifCompliance2=ifCompliance2, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestCode=ifTestCode, ifInNUcastPkts=ifInNUcastPkts, ifMIB=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, interfaces=interfaces, ifType=ifType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutDiscards=ifOutDiscards, ifConnectorPresent=ifConnectorPresent, ifHCPacketGroup=ifHCPacketGroup, ifOperStatus=ifOperStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, InterfaceIndex=InterfaceIndex, ifEntry=ifEntry, ifPhysAddress=ifPhysAddress, ifHighSpeed=ifHighSpeed, ifTestGroup=ifTestGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXTable=ifXTable, ifSpeed=ifSpeed, ifHCOutOctets=ifHCOutOctets, ifPacketGroup=ifPacketGroup, ifOutOctets=ifOutOctets, ifStackGroup=ifStackGroup, ifIndex=ifIndex, ifStackLastChange=ifStackLastChange, ifCompliance3=ifCompliance3, ifHCInOctets=ifHCInOctets, ifDescr=ifDescr, ifTestResult=ifTestResult, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup, ifTableLastChange=ifTableLastChange, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifAdminStatus=ifAdminStatus, ifInOctets=ifInOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressType=ifRcvAddressType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifRcvAddressAddress=ifRcvAddressAddress, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup2=ifStackGroup2, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, ifName=ifName, ifGroups=ifGroups, ifStackLowerLayer=ifStackLowerLayer, ifInErrors=ifInErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUp=linkUp, linkDown=linkDown, ifStackTable=ifStackTable, ifNumber=ifNumber, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestStatus=ifTestStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, ifTable=ifTable, ifOutQLen=ifOutQLen, ifHCInUcastPkts=ifHCInUcastPkts, ifInUcastPkts=ifInUcastPkts)
