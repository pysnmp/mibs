...
TestAndIncr, TimeStamp, DisplayString, AutonomousType, TruthValue, PhysAddress, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "DisplayString", "AutonomousType", "TruthValue", "PhysAddress", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", linkDown=linkDown, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestStatus=ifTestStatus, ifPhysAddress=ifPhysAddress, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup=ifStackGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpecific=ifSpecific, ifOutQLen=ifOutQLen, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, OwnerString=OwnerString, linkUp=linkUp, ifFixedLengthGroup=ifFixedLengthGroup, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifDescr=ifDescr, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, interfaces=interfaces, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutDiscards=ifOutDiscards, ifSpeed=ifSpeed, ifStackHigherLayer=ifStackHigherLayer, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifEntry=ifEntry, ifTestTable=ifTestTable, ifTableLastChange=ifTableLastChange, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance3=ifCompliance3, ifStackLowerLayer=ifStackLowerLayer, ifOutErrors=ifOutErrors, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifCompliance=ifCompliance, ifAlias=ifAlias, ifTestEntry=ifTestEntry, ifMtu=ifMtu, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifTable=ifTable, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup, ifCompliance2=ifCompliance2, ifHCPacketGroup=ifHCPacketGroup, ifMIB=ifMIB, ifStackEntry=ifStackEntry, ifTestType=ifTestType, ifOldObjectsGroup=ifOldObjectsGroup, ifInNUcastPkts=ifInNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXTable=ifXTable, ifXEntry=ifXEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifGroups=ifGroups, ifInMulticastPkts=ifInMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifType=ifType, ifTestId=ifTestId, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifInUcastPkts=ifInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressEntry=ifRcvAddressEntry, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifInOctets=ifInOctets, ifMIBObjects=ifMIBObjects, ifGeneralGroup=ifGeneralGroup, ifHCInOctets=ifHCInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifName=ifName, ifRcvAddressTable=ifRcvAddressTable, ifConnectorPresent=ifConnectorPresent, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifLastChange=ifLastChange, ifInErrors=ifInErrors, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets)
