...
TextualConvention, AutonomousType, DisplayString, PhysAddress, TestAndIncr, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "PhysAddress", "TestAndIncr", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifType=ifType, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifCompliance=ifCompliance, ifRcvAddressGroup=ifRcvAddressGroup, ifSpeed=ifSpeed, ifHighSpeed=ifHighSpeed, PYSNMP_MODULE_ID=ifMIB, ifTestEntry=ifTestEntry, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackStatus=ifStackStatus, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifStackGroup2=ifStackGroup2, ifNumber=ifNumber, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConformance=ifConformance, ifInUcastPkts=ifInUcastPkts, linkDown=linkDown, ifTable=ifTable, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifXTable=ifXTable, ifInDiscards=ifInDiscards, ifCompliance2=ifCompliance2, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUnknownProtos=ifInUnknownProtos, ifDescr=ifDescr, ifOperStatus=ifOperStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInOctets=ifHCInOctets, ifCompliance3=ifCompliance3, ifAdminStatus=ifAdminStatus, ifLastChange=ifLastChange, ifTestCode=ifTestCode, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutOctets=ifOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifInMulticastPkts=ifInMulticastPkts, OwnerString=OwnerString, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAlias=ifAlias, ifMIB=ifMIB, InterfaceIndex=InterfaceIndex, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTestTable=ifTestTable, ifInNUcastPkts=ifInNUcastPkts, ifCompliances=ifCompliances, ifOutMulticastPkts=ifOutMulticastPkts, ifOutErrors=ifOutErrors, ifTestOwner=ifTestOwner, ifEntry=ifEntry, ifIndex=ifIndex, ifTestStatus=ifTestStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifStackEntry=ifStackEntry, ifName=ifName, ifGroups=ifGroups, ifGeneralInformationGroup=ifGeneralInformationGroup, interfaces=interfaces, ifTestGroup=ifTestGroup, ifTestResult=ifTestResult, ifInErrors=ifInErrors, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifPromiscuousMode=ifPromiscuousMode, ifTestId=ifTestId, ifHCInUcastPkts=ifHCInUcastPkts, ifConnectorPresent=ifConnectorPresent, linkUp=linkUp, ifOutQLen=ifOutQLen, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifOutDiscards=ifOutDiscards, ifStackLastChange=ifStackLastChange)
