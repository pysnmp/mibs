...
AutonomousType, RowStatus, DisplayString, PhysAddress, TextualConvention, TestAndIncr, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "DisplayString", "PhysAddress", "TextualConvention", "TestAndIncr", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifXTable=ifXTable, ifCompliance3=ifCompliance3, ifOutNUcastPkts=ifOutNUcastPkts, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUcastPkts=ifInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifInErrors=ifInErrors, ifAlias=ifAlias, linkDown=linkDown, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTestCode=ifTestCode, ifName=ifName, ifOperStatus=ifOperStatus, ifStackHigherLayer=ifStackHigherLayer, ifLastChange=ifLastChange, ifOutQLen=ifOutQLen, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance2=ifCompliance2, ifRcvAddressEntry=ifRcvAddressEntry, ifHighSpeed=ifHighSpeed, ifSpeed=ifSpeed, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutOctets=ifOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, interfaces=interfaces, ifTestGroup=ifTestGroup, ifInUnknownProtos=ifInUnknownProtos, ifTestOwner=ifTestOwner, ifStackLowerLayer=ifStackLowerLayer, ifMtu=ifMtu, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifStackGroup=ifStackGroup, ifMIBObjects=ifMIBObjects, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifStackLastChange=ifStackLastChange, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifCompliance=ifCompliance, ifPhysAddress=ifPhysAddress, ifStackEntry=ifStackEntry, ifType=ifType, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifInDiscards=ifInDiscards, ifNumber=ifNumber, ifTestStatus=ifTestStatus, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackTable=ifStackTable, ifCompliances=ifCompliances, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestId=ifTestId, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifMIB=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifXEntry=ifXEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifStackStatus=ifStackStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifIndex=ifIndex, ifSpecific=ifSpecific, ifTable=ifTable, ifRcvAddressGroup=ifRcvAddressGroup, ifInOctets=ifInOctets, ifInNUcastPkts=ifInNUcastPkts, ifDescr=ifDescr, ifPacketGroup=ifPacketGroup, ifTableLastChange=ifTableLastChange, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifStackGroup2=ifStackGroup2, ifHCInOctets=ifHCInOctets, OwnerString=OwnerString, ifTestResult=ifTestResult, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifTestEntry=ifTestEntry, ifOutDiscards=ifOutDiscards)
