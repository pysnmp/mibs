...
TruthValue, RowStatus, TimeStamp, PhysAddress, TextualConvention, DisplayString, TestAndIncr, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "TimeStamp", "PhysAddress", "TextualConvention", "DisplayString", "TestAndIncr", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifGeneralGroup=ifGeneralGroup, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifEntry=ifEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifOutMulticastPkts=ifOutMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifStackLastChange=ifStackLastChange, ifInUnknownProtos=ifInUnknownProtos, ifInUcastPkts=ifInUcastPkts, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifStackLowerLayer=ifStackLowerLayer, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifXEntry=ifXEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPhysAddress=ifPhysAddress, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifDescr=ifDescr, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifTestCode=ifTestCode, ifSpecific=ifSpecific, OwnerString=OwnerString, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestEntry=ifTestEntry, ifRcvAddressType=ifRcvAddressType, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, interfaces=interfaces, ifPromiscuousMode=ifPromiscuousMode, ifName=ifName, ifHCInOctets=ifHCInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifIndex=ifIndex, ifSpeed=ifSpeed, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutOctets=ifOutOctets, ifTestType=ifTestType, ifFixedLengthGroup=ifFixedLengthGroup, ifAlias=ifAlias, ifCompliances=ifCompliances, ifStackGroup=ifStackGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifConnectorPresent=ifConnectorPresent, ifRcvAddressTable=ifRcvAddressTable, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry, linkUp=linkUp, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifStackTable=ifStackTable, ifXTable=ifXTable, ifInErrors=ifInErrors, ifMIBObjects=ifMIBObjects, ifHCPacketGroup=ifHCPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifTable=ifTable, ifInDiscards=ifInDiscards, InterfaceIndex=InterfaceIndex, ifMIB=ifMIB, ifGroups=ifGroups, ifAdminStatus=ifAdminStatus, ifOperStatus=ifOperStatus, ifOutUcastPkts=ifOutUcastPkts, ifCompliance3=ifCompliance3, ifStackHigherLayer=ifStackHigherLayer, ifMtu=ifMtu, ifPacketGroup=ifPacketGroup, ifTestResult=ifTestResult, ifType=ifType, ifOutQLen=ifOutQLen, ifStackEntry=ifStackEntry)
