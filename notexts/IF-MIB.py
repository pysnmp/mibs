...
TruthValue, TestAndIncr, RowStatus, PhysAddress, TimeStamp, AutonomousType, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "RowStatus", "PhysAddress", "TimeStamp", "AutonomousType", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", linkUp=linkUp, ifInErrors=ifInErrors, ifTestGroup=ifTestGroup, ifHCOutOctets=ifHCOutOctets, ifSpecific=ifSpecific, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifAlias=ifAlias, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance2=ifCompliance2, ifTestResult=ifTestResult, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifTestStatus=ifTestStatus, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLowerLayer=ifStackLowerLayer, ifTestOwner=ifTestOwner, ifOutOctets=ifOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, interfaces=interfaces, ifOutErrors=ifOutErrors, ifType=ifType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOperStatus=ifOperStatus, ifInNUcastPkts=ifInNUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifName=ifName, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifEntry=ifEntry, ifStackLastChange=ifStackLastChange, ifCompliance=ifCompliance, ifCompliance3=ifCompliance3, ifDescr=ifDescr, ifInMulticastPkts=ifInMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifTestType=ifTestType, ifMIB=ifMIB, ifAdminStatus=ifAdminStatus, OwnerString=OwnerString, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifStackGroup=ifStackGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInOctets=ifInOctets, ifSpeed=ifSpeed, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifTable=ifTable, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup2=ifStackGroup2, ifTableLastChange=ifTableLastChange, ifTestId=ifTestId, ifTestEntry=ifTestEntry, ifCompliances=ifCompliances, ifGeneralInformationGroup=ifGeneralInformationGroup, ifXEntry=ifXEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifMIBObjects=ifMIBObjects, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifStackHigherLayer=ifStackHigherLayer, ifTestTable=ifTestTable, ifPacketGroup=ifPacketGroup, ifStackStatus=ifStackStatus, ifIndex=ifIndex, ifOutQLen=ifOutQLen, ifGroups=ifGroups, ifInDiscards=ifInDiscards, ifPromiscuousMode=ifPromiscuousMode, ifHCInOctets=ifHCInOctets, InterfaceIndex=InterfaceIndex, ifXTable=ifXTable, ifStackTable=ifStackTable, ifRcvAddressType=ifRcvAddressType, ifPhysAddress=ifPhysAddress, ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackEntry=ifStackEntry, ifConnectorPresent=ifConnectorPresent, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestCode=ifTestCode)
