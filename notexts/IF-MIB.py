...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, iso, IpAddress, Gauge32, Unsigned32, MibIdentifier, Integer32, ObjectIdentity, mib_2, Counter32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "iso", "IpAddress", "Gauge32", "Unsigned32", "MibIdentifier", "Integer32", "ObjectIdentity", "mib-2", "Counter32", "Bits", "NotificationType")
TextualConvention, PhysAddress, AutonomousType, TestAndIncr, TruthValue, RowStatus, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "AutonomousType", "TestAndIncr", "TruthValue", "RowStatus", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifPacketGroup=ifPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifStackEntry=ifStackEntry, ifOutErrors=ifOutErrors, ifMIBObjects=ifMIBObjects, ifTestEntry=ifTestEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifOutOctets=ifOutOctets, ifInUcastPkts=ifInUcastPkts, interfaces=interfaces, ifStackGroup=ifStackGroup, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifStackTable=ifStackTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifTestOwner=ifTestOwner, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifInNUcastPkts=ifInNUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutQLen=ifOutQLen, ifConnectorPresent=ifConnectorPresent, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifStackLastChange=ifStackLastChange, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, linkUp=linkUp, ifTestStatus=ifTestStatus, ifStackLowerLayer=ifStackLowerLayer, ifOutDiscards=ifOutDiscards, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifCompliance2=ifCompliance2, ifType=ifType, ifAdminStatus=ifAdminStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralGroup=ifGeneralGroup, ifInOctets=ifInOctets, ifTestCode=ifTestCode, ifTestTable=ifTestTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkDown=linkDown, ifTable=ifTable, ifConformance=ifConformance, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifInBroadcastPkts=ifInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifEntry=ifEntry, ifMtu=ifMtu, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestGroup=ifTestGroup, ifXEntry=ifXEntry, ifTestType=ifTestType, ifHCPacketGroup=ifHCPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifName=ifName, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance3=ifCompliance3, ifXTable=ifXTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestId=ifTestId, ifAlias=ifAlias, ifSpecific=ifSpecific, ifDescr=ifDescr, ifCompliances=ifCompliances, ifCompliance=ifCompliance, ifTestResult=ifTestResult, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifGroups=ifGroups, OwnerString=OwnerString)
