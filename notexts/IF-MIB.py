...
DisplayString, TimeStamp, TestAndIncr, AutonomousType, RowStatus, TruthValue, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TestAndIncr", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutOctets=ifHCOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliances=ifCompliances, ifStackStatus=ifStackStatus, ifType=ifType, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifAlias=ifAlias, ifConformance=ifConformance, ifPacketGroup=ifPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestId=ifTestId, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTable=ifTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifName=ifName, ifTestGroup=ifTestGroup, ifXEntry=ifXEntry, ifStackGroup2=ifStackGroup2, ifEntry=ifEntry, ifRcvAddressType=ifRcvAddressType, ifAdminStatus=ifAdminStatus, ifTestStatus=ifTestStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifCompliance2=ifCompliance2, ifCompliance3=ifCompliance3, ifStackTable=ifStackTable, ifInUnknownProtos=ifInUnknownProtos, OwnerString=OwnerString, ifNumber=ifNumber, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, PYSNMP_MODULE_ID=ifMIB, ifHCInOctets=ifHCInOctets, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifLastChange=ifLastChange, ifConnectorPresent=ifConnectorPresent, ifCompliance=ifCompliance, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifOutUcastPkts=ifOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralGroup=ifGeneralGroup, InterfaceIndex=InterfaceIndex, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifIndex=ifIndex, linkUp=linkUp, ifTestResult=ifTestResult, ifTestType=ifTestType, ifSpecific=ifSpecific, ifOutMulticastPkts=ifOutMulticastPkts, ifTestEntry=ifTestEntry, ifPhysAddress=ifPhysAddress, ifInUcastPkts=ifInUcastPkts, ifMIBObjects=ifMIBObjects, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOperStatus=ifOperStatus, ifHighSpeed=ifHighSpeed, ifHCInUcastPkts=ifHCInUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifGroups=ifGroups, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifTestCode=ifTestCode, linkDown=linkDown, ifTableLastChange=ifTableLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, interfaces=interfaces, ifInOctets=ifInOctets, ifRcvAddressTable=ifRcvAddressTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIB=ifMIB, ifDescr=ifDescr, ifOutErrors=ifOutErrors, ifFixedLengthGroup=ifFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestTable=ifTestTable, ifStackEntry=ifStackEntry)
