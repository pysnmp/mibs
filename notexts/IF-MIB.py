...
RowStatus, DisplayString, TextualConvention, TimeStamp, AutonomousType, TestAndIncr, TruthValue, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TextualConvention", "TimeStamp", "AutonomousType", "TestAndIncr", "TruthValue", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifOldObjectsGroup=ifOldObjectsGroup, ifSpecific=ifSpecific, ifName=ifName, ifTestTable=ifTestTable, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressType=ifRcvAddressType, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifStackLastChange=ifStackLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, ifTestCode=ifTestCode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestStatus=ifTestStatus, ifLastChange=ifLastChange, ifStackEntry=ifStackEntry, ifGeneralGroup=ifGeneralGroup, ifXEntry=ifXEntry, ifInDiscards=ifInDiscards, ifSpeed=ifSpeed, ifPacketGroup=ifPacketGroup, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifInUnknownProtos=ifInUnknownProtos, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, OwnerString=OwnerString, ifConnectorPresent=ifConnectorPresent, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifXTable=ifXTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifStackStatus=ifStackStatus, ifOutErrors=ifOutErrors, ifCompliance=ifCompliance, ifDescr=ifDescr, ifTableLastChange=ifTableLastChange, ifMtu=ifMtu, ifStackHigherLayer=ifStackHigherLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifNumber=ifNumber, ifTestResult=ifTestResult, ifOperStatus=ifOperStatus, ifMIBObjects=ifMIBObjects, ifHCPacketGroup=ifHCPacketGroup, ifOutQLen=ifOutQLen, ifRcvAddressEntry=ifRcvAddressEntry, ifInNUcastPkts=ifInNUcastPkts, linkUp=linkUp, ifTable=ifTable, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutOctets=ifHCOutOctets, ifOutDiscards=ifOutDiscards, ifTestOwner=ifTestOwner, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressGroup=ifRcvAddressGroup, ifTestType=ifTestType, interfaces=interfaces, ifIndex=ifIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifHighSpeed=ifHighSpeed, ifInBroadcastPkts=ifInBroadcastPkts, ifInOctets=ifInOctets, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, ifHCInOctets=ifHCInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliances=ifCompliances, ifAlias=ifAlias, ifStackGroup2=ifStackGroup2, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestId=ifTestId, ifStackLowerLayer=ifStackLowerLayer, ifConformance=ifConformance, ifTestGroup=ifTestGroup)
