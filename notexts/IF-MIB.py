...
TextualConvention, PhysAddress, TestAndIncr, TruthValue, DisplayString, AutonomousType, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "TestAndIncr", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutOctets=ifHCOutOctets, ifInBroadcastPkts=ifInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, OwnerString=OwnerString, ifLastChange=ifLastChange, ifPhysAddress=ifPhysAddress, ifFixedLengthGroup=ifFixedLengthGroup, ifTestType=ifTestType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUp=linkUp, ifTestCode=ifTestCode, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifTestId=ifTestId, ifType=ifType, interfaces=interfaces, ifTestEntry=ifTestEntry, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifHighSpeed=ifHighSpeed, ifOutUcastPkts=ifOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifXTable=ifXTable, ifInUcastPkts=ifInUcastPkts, ifMIB=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifTestOwner=ifTestOwner, ifTable=ifTable, ifConnectorPresent=ifConnectorPresent, ifOutQLen=ifOutQLen, ifStackEntry=ifStackEntry, InterfaceIndex=InterfaceIndex, ifOutErrors=ifOutErrors, ifTestStatus=ifTestStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifOperStatus=ifOperStatus, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTableLastChange=ifTableLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifSpecific=ifSpecific, ifEntry=ifEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLastChange=ifStackLastChange, ifPromiscuousMode=ifPromiscuousMode, ifTestTable=ifTestTable, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInDiscards=ifInDiscards, ifTestResult=ifTestResult, ifVHCPacketGroup=ifVHCPacketGroup, ifNumber=ifNumber, ifXEntry=ifXEntry, ifOutDiscards=ifOutDiscards, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, ifCompliance3=ifCompliance3, ifAdminStatus=ifAdminStatus, ifStackStatus=ifStackStatus, ifInOctets=ifInOctets, ifIndex=ifIndex, ifMIBObjects=ifMIBObjects, ifPacketGroup=ifPacketGroup, linkDown=linkDown, ifHCInOctets=ifHCInOctets, ifStackTable=ifStackTable, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance=ifCompliance, ifDescr=ifDescr, ifCompliance2=ifCompliance2, ifGeneralInformationGroup=ifGeneralInformationGroup, ifGroups=ifGroups, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifSpeed=ifSpeed, ifInErrors=ifInErrors, PYSNMP_MODULE_ID=ifMIB, ifName=ifName)
