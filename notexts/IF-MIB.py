...
RowStatus, TruthValue, DisplayString, TimeStamp, AutonomousType, PhysAddress, TextualConvention, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "DisplayString", "TimeStamp", "AutonomousType", "PhysAddress", "TextualConvention", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", linkUp=linkUp, ifHighSpeed=ifHighSpeed, ifRcvAddressEntry=ifRcvAddressEntry, ifPacketGroup=ifPacketGroup, ifMIB=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifStackStatus=ifStackStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressTable=ifRcvAddressTable, ifTestEntry=ifTestEntry, ifAlias=ifAlias, ifEntry=ifEntry, ifTestStatus=ifTestStatus, ifGroups=ifGroups, ifCompliance=ifCompliance, ifCompliance3=ifCompliance3, ifTestGroup=ifTestGroup, ifStackGroup2=ifStackGroup2, ifXTable=ifXTable, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInOctets=ifHCInOctets, ifStackTable=ifStackTable, ifInErrors=ifInErrors, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliances=ifCompliances, ifInOctets=ifInOctets, ifName=ifName, ifType=ifType, ifCompliance2=ifCompliance2, ifRcvAddressStatus=ifRcvAddressStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifSpeed=ifSpeed, ifMIBObjects=ifMIBObjects, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifNumber=ifNumber, ifRcvAddressAddress=ifRcvAddressAddress, ifLastChange=ifLastChange, ifInBroadcastPkts=ifInBroadcastPkts, linkDown=linkDown, ifTableLastChange=ifTableLastChange, ifInDiscards=ifInDiscards, ifTable=ifTable, ifXEntry=ifXEntry, ifStackLastChange=ifStackLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, interfaces=interfaces, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpecific=ifSpecific, ifIndex=ifIndex, ifMtu=ifMtu, ifGeneralGroup=ifGeneralGroup, ifInUnknownProtos=ifInUnknownProtos, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifInUcastPkts=ifInUcastPkts, ifAdminStatus=ifAdminStatus, ifOutDiscards=ifOutDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCPacketGroup=ifHCPacketGroup, ifTestResult=ifTestResult, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestOwner=ifTestOwner, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifTestId=ifTestId, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifOperStatus=ifOperStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup=ifStackGroup, ifPhysAddress=ifPhysAddress, ifStackEntry=ifStackEntry, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode)
