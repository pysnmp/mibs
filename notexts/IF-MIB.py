...
iso, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, NotificationType, Counter32, Integer32, ModuleIdentity, TimeTicks, mib_2, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "NotificationType", "Counter32", "Integer32", "ModuleIdentity", "TimeTicks", "mib-2", "Gauge32", "Bits")
TestAndIncr, AutonomousType, DisplayString, TimeStamp, RowStatus, TextualConvention, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "AutonomousType", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifMIBObjects=ifMIBObjects, ifInOctets=ifInOctets, ifCompliance2=ifCompliance2, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifInErrors=ifInErrors, ifMtu=ifMtu, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackHigherLayer=ifStackHigherLayer, ifLastChange=ifLastChange, ifIndex=ifIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, linkDown=linkDown, ifTestStatus=ifTestStatus, ifTestTable=ifTestTable, ifTestEntry=ifTestEntry, ifTable=ifTable, ifOutUcastPkts=ifOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifPromiscuousMode=ifPromiscuousMode, ifPhysAddress=ifPhysAddress, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifOperStatus=ifOperStatus, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifMIB=ifMIB, PYSNMP_MODULE_ID=ifMIB, ifCompliances=ifCompliances, ifAdminStatus=ifAdminStatus, ifConformance=ifConformance, ifRcvAddressTable=ifRcvAddressTable, ifOutDiscards=ifOutDiscards, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifTestOwner=ifTestOwner, ifGroups=ifGroups, ifStackEntry=ifStackEntry, ifNumber=ifNumber, ifName=ifName, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifEntry=ifEntry, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifType=ifType, ifTestResult=ifTestResult, ifStackStatus=ifStackStatus, ifHCPacketGroup=ifHCPacketGroup, ifOutQLen=ifOutQLen, ifSpecific=ifSpecific, ifRcvAddressAddress=ifRcvAddressAddress, ifXEntry=ifXEntry, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifTestId=ifTestId, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifSpeed=ifSpeed, ifInUcastPkts=ifInUcastPkts, ifDescr=ifDescr, ifInDiscards=ifInDiscards, ifHighSpeed=ifHighSpeed, ifStackLastChange=ifStackLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutErrors=ifOutErrors, ifTestType=ifTestType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUp=linkUp, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressType=ifRcvAddressType, ifStackGroup2=ifStackGroup2, ifInNUcastPkts=ifInNUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets)
