...
Gauge32, TimeTicks, iso, Bits, Counter64, ModuleIdentity, Counter32, NotificationType, Unsigned32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, mib_2, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "iso", "Bits", "Counter64", "ModuleIdentity", "Counter32", "NotificationType", "Unsigned32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "mib-2", "IpAddress")
RowStatus, DisplayString, TestAndIncr, TruthValue, AutonomousType, TimeStamp, PhysAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TestAndIncr", "TruthValue", "AutonomousType", "TimeStamp", "PhysAddress", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", PYSNMP_MODULE_ID=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifTestType=ifTestType, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifEntry=ifEntry, ifCompliance3=ifCompliance3, ifStackLowerLayer=ifStackLowerLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPhysAddress=ifPhysAddress, ifStackLastChange=ifStackLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTestOwner=ifTestOwner, ifRcvAddressEntry=ifRcvAddressEntry, ifTestCode=ifTestCode, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifHCInUcastPkts=ifHCInUcastPkts, ifConnectorPresent=ifConnectorPresent, ifName=ifName, ifStackGroup=ifStackGroup, ifSpecific=ifSpecific, ifCompliances=ifCompliances, ifStackEntry=ifStackEntry, OwnerString=OwnerString, ifInDiscards=ifInDiscards, ifStackGroup2=ifStackGroup2, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, ifTable=ifTable, ifNumber=ifNumber, ifCompliance=ifCompliance, ifOutQLen=ifOutQLen, ifInBroadcastPkts=ifInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifGroups=ifGroups, ifOutDiscards=ifOutDiscards, ifAlias=ifAlias, ifXEntry=ifXEntry, ifOutOctets=ifOutOctets, ifOutUcastPkts=ifOutUcastPkts, ifTestEntry=ifTestEntry, ifAdminStatus=ifAdminStatus, ifMIB=ifMIB, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifTestGroup=ifTestGroup, ifRcvAddressType=ifRcvAddressType, ifLastChange=ifLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndex=InterfaceIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifXTable=ifXTable, ifOldObjectsGroup=ifOldObjectsGroup, ifDescr=ifDescr, ifRcvAddressAddress=ifRcvAddressAddress, ifInMulticastPkts=ifInMulticastPkts, ifPacketGroup=ifPacketGroup, ifConformance=ifConformance, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackHigherLayer=ifStackHigherLayer, ifCompliance2=ifCompliance2, ifPromiscuousMode=ifPromiscuousMode, ifOperStatus=ifOperStatus, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMIBObjects=ifMIBObjects, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCPacketGroup=ifHCPacketGroup, linkDown=linkDown, ifMtu=ifMtu, ifInOctets=ifInOctets, ifHCOutOctets=ifHCOutOctets, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifInUnknownProtos=ifInUnknownProtos, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInOctets=ifHCInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifTestResult=ifTestResult, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackTable=ifStackTable)
