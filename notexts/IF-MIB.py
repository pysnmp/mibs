...
TruthValue, PhysAddress, AutonomousType, TestAndIncr, TextualConvention, RowStatus, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "PhysAddress", "AutonomousType", "TestAndIncr", "TextualConvention", "RowStatus", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutMulticastPkts=ifHCOutMulticastPkts, OwnerString=OwnerString, ifOutNUcastPkts=ifOutNUcastPkts, ifTestResult=ifTestResult, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInOctets=ifInOctets, ifTestType=ifTestType, ifName=ifName, ifTestCode=ifTestCode, ifHCInUcastPkts=ifHCInUcastPkts, linkUp=linkUp, ifTestId=ifTestId, ifHCOutOctets=ifHCOutOctets, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifStackTable=ifStackTable, ifStackEntry=ifStackEntry, ifPromiscuousMode=ifPromiscuousMode, ifStackLastChange=ifStackLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifOutErrors=ifOutErrors, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifVHCPacketGroup=ifVHCPacketGroup, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, ifRcvAddressType=ifRcvAddressType, ifLastChange=ifLastChange, ifGeneralGroup=ifGeneralGroup, ifRcvAddressTable=ifRcvAddressTable, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCPacketGroup=ifHCPacketGroup, ifInUcastPkts=ifInUcastPkts, ifOutQLen=ifOutQLen, ifInErrors=ifInErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifOutUcastPkts=ifOutUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestGroup=ifTestGroup, ifTestStatus=ifTestStatus, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifAlias=ifAlias, ifHighSpeed=ifHighSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAdminStatus=ifAdminStatus, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifTestTable=ifTestTable, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifType=ifType, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliances=ifCompliances, ifCompliance2=ifCompliance2, ifCompliance=ifCompliance, ifRcvAddressAddress=ifRcvAddressAddress, ifStackGroup=ifStackGroup, ifIndex=ifIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInMulticastPkts=ifInMulticastPkts, ifSpecific=ifSpecific, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifXTable=ifXTable, ifOutDiscards=ifOutDiscards, ifHCInOctets=ifHCInOctets, ifTableLastChange=ifTableLastChange, ifTable=ifTable, ifEntry=ifEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, linkDown=linkDown, ifTestEntry=ifTestEntry, interfaces=interfaces, ifSpeed=ifSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, ifInDiscards=ifInDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifXEntry=ifXEntry, ifOutOctets=ifOutOctets)
