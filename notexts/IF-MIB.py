...
DisplayString, TruthValue, TimeStamp, TestAndIncr, TextualConvention, AutonomousType, PhysAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "TimeStamp", "TestAndIncr", "TextualConvention", "AutonomousType", "PhysAddress", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifMIBObjects=ifMIBObjects, ifRcvAddressGroup=ifRcvAddressGroup, ifTestTable=ifTestTable, ifStackTable=ifStackTable, ifAdminStatus=ifAdminStatus, ifName=ifName, ifOldObjectsGroup=ifOldObjectsGroup, ifEntry=ifEntry, ifInOctets=ifInOctets, ifMIB=ifMIB, ifInDiscards=ifInDiscards, ifFixedLengthGroup=ifFixedLengthGroup, ifXTable=ifXTable, ifTestId=ifTestId, ifHighSpeed=ifHighSpeed, ifXEntry=ifXEntry, ifCompliance3=ifCompliance3, ifCompliance=ifCompliance, interfaces=interfaces, ifHCOutOctets=ifHCOutOctets, ifTestOwner=ifTestOwner, ifConformance=ifConformance, ifHCPacketGroup=ifHCPacketGroup, ifHCInOctets=ifHCInOctets, ifOutDiscards=ifOutDiscards, ifOutOctets=ifOutOctets, ifTable=ifTable, ifOutUcastPkts=ifOutUcastPkts, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, ifGroups=ifGroups, ifRcvAddressAddress=ifRcvAddressAddress, ifStackHigherLayer=ifStackHigherLayer, ifLastChange=ifLastChange, ifType=ifType, ifInMulticastPkts=ifInMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMtu=ifMtu, linkUp=linkUp, ifPhysAddress=ifPhysAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifInErrors=ifInErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, ifGeneralGroup=ifGeneralGroup, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, ifSpecific=ifSpecific, ifDescr=ifDescr, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestCode=ifTestCode, ifNumber=ifNumber, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, OwnerString=OwnerString, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifOperStatus=ifOperStatus, ifInNUcastPkts=ifInNUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifOutQLen=ifOutQLen, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpeed=ifSpeed, ifInUnknownProtos=ifInUnknownProtos, ifPacketGroup=ifPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifIndex=ifIndex, linkDown=linkDown, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifTestStatus=ifTestStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifStackGroup2=ifStackGroup2, ifTestGroup=ifTestGroup, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance2=ifCompliance2, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts)
