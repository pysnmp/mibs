...
DisplayString, TestAndIncr, TruthValue, TextualConvention, AutonomousType, RowStatus, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "TruthValue", "TextualConvention", "AutonomousType", "RowStatus", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifStackStatus=ifStackStatus, ifConformance=ifConformance, ifIndex=ifIndex, ifGroups=ifGroups, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifMIB=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifSpeed=ifSpeed, ifTestResult=ifTestResult, ifOperStatus=ifOperStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifPacketGroup=ifPacketGroup, ifStackGroup=ifStackGroup, ifInNUcastPkts=ifInNUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliances=ifCompliances, ifPhysAddress=ifPhysAddress, ifVHCPacketGroup=ifVHCPacketGroup, ifEntry=ifEntry, ifConnectorPresent=ifConnectorPresent, ifInErrors=ifInErrors, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifNumber=ifNumber, ifTestType=ifTestType, ifSpecific=ifSpecific, ifXEntry=ifXEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInDiscards=ifInDiscards, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutDiscards=ifOutDiscards, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifRcvAddressType=ifRcvAddressType, ifTestCode=ifTestCode, ifTestId=ifTestId, ifCompliance2=ifCompliance2, interfaces=interfaces, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance=ifCompliance, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInOctets=ifInOctets, ifTestOwner=ifTestOwner, InterfaceIndex=InterfaceIndex, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifRcvAddressStatus=ifRcvAddressStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifAdminStatus=ifAdminStatus, ifXTable=ifXTable, ifTable=ifTable, ifCompliance3=ifCompliance3, ifOutQLen=ifOutQLen, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLastChange=ifStackLastChange, ifStackTable=ifStackTable, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifMIBObjects=ifMIBObjects, ifOutOctets=ifOutOctets, ifLastChange=ifLastChange, ifGeneralGroup=ifGeneralGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifName=ifName, ifStackHigherLayer=ifStackHigherLayer, ifInUnknownProtos=ifInUnknownProtos, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackGroup2=ifStackGroup2, PYSNMP_MODULE_ID=ifMIB, OwnerString=OwnerString, ifTestStatus=ifTestStatus, ifType=ifType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUp=linkUp, ifRcvAddressTable=ifRcvAddressTable, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifTestGroup=ifTestGroup, ifInUcastPkts=ifInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup)
