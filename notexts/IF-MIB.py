...
TextualConvention, DisplayString, RowStatus, TestAndIncr, AutonomousType, TimeStamp, TruthValue, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowStatus", "TestAndIncr", "AutonomousType", "TimeStamp", "TruthValue", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance=ifCompliance, ifMIBObjects=ifMIBObjects, PYSNMP_MODULE_ID=ifMIB, ifXTable=ifXTable, ifMIB=ifMIB, ifStackGroup2=ifStackGroup2, ifGroups=ifGroups, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestResult=ifTestResult, ifOutOctets=ifOutOctets, ifInUcastPkts=ifInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifInErrors=ifInErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifInOctets=ifInOctets, ifTestType=ifTestType, ifStackStatus=ifStackStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutQLen=ifOutQLen, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutOctets=ifHCOutOctets, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestTable=ifTestTable, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, ifVHCPacketGroup=ifVHCPacketGroup, ifEntry=ifEntry, ifLastChange=ifLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup=ifStackGroup, ifRcvAddressType=ifRcvAddressType, ifHighSpeed=ifHighSpeed, ifGeneralGroup=ifGeneralGroup, ifOutDiscards=ifOutDiscards, ifTestCode=ifTestCode, ifPacketGroup=ifPacketGroup, linkUp=linkUp, ifXEntry=ifXEntry, ifTestGroup=ifTestGroup, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, ifDescr=ifDescr, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutMulticastPkts=ifOutMulticastPkts, ifInDiscards=ifInDiscards, ifStackHigherLayer=ifStackHigherLayer, ifTestId=ifTestId, ifName=ifName, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifTestOwner=ifTestOwner, ifConformance=ifConformance, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifSpeed=ifSpeed, ifTestStatus=ifTestStatus, ifRcvAddressTable=ifRcvAddressTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAdminStatus=ifAdminStatus, OwnerString=OwnerString, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInOctets=ifHCInOctets, ifTable=ifTable, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifConnectorPresent=ifConnectorPresent, ifOutUcastPkts=ifOutUcastPkts, ifOperStatus=ifOperStatus, ifIndex=ifIndex, linkDown=linkDown, ifStackTable=ifStackTable, ifStackLastChange=ifStackLastChange, ifNumber=ifNumber, ifCompliance3=ifCompliance3, ifType=ifType, ifMtu=ifMtu, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifTestEntry=ifTestEntry, ifHCPacketGroup=ifHCPacketGroup, ifCompliances=ifCompliances)
