...
iso, IpAddress, Counter32, Counter64, mib_2, ObjectIdentity, Integer32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Bits, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "Counter64", "mib-2", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Bits", "NotificationType", "Gauge32")
TextualConvention, AutonomousType, DisplayString, RowStatus, PhysAddress, TruthValue, TestAndIncr, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "DisplayString", "RowStatus", "PhysAddress", "TruthValue", "TestAndIncr", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifTestTable=ifTestTable, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, ifSpeed=ifSpeed, ifPhysAddress=ifPhysAddress, ifTestResult=ifTestResult, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifOutQLen=ifOutQLen, ifInOctets=ifInOctets, ifOutNUcastPkts=ifOutNUcastPkts, OwnerString=OwnerString, ifAlias=ifAlias, ifStackHigherLayer=ifStackHigherLayer, ifTestEntry=ifTestEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifTestId=ifTestId, ifPacketGroup=ifPacketGroup, ifTestStatus=ifTestStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifGeneralGroup=ifGeneralGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, ifOperStatus=ifOperStatus, ifMIB=ifMIB, InterfaceIndex=InterfaceIndex, ifStackTable=ifStackTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInMulticastPkts=ifInMulticastPkts, ifTestOwner=ifTestOwner, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup2=ifStackGroup2, ifHCInOctets=ifHCInOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInErrors=ifInErrors, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance2=ifCompliance2, ifDescr=ifDescr, ifPromiscuousMode=ifPromiscuousMode, ifXTable=ifXTable, ifGroups=ifGroups, ifLastChange=ifLastChange, ifEntry=ifEntry, ifCompliances=ifCompliances, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestGroup=ifTestGroup, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLowerLayer=ifStackLowerLayer, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, ifTable=ifTable, ifIndex=ifIndex, ifStackEntry=ifStackEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, linkUp=linkUp, ifHCOutOctets=ifHCOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifInDiscards=ifInDiscards, ifNumber=ifNumber, ifTestType=ifTestType, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifOutDiscards=ifOutDiscards, ifHighSpeed=ifHighSpeed, ifStackStatus=ifStackStatus, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifStackLastChange=ifStackLastChange, ifType=ifType, interfaces=interfaces, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifRcvAddressStatus=ifRcvAddressStatus, linkDown=linkDown, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifName=ifName, ifRcvAddressType=ifRcvAddressType, ifHCInBroadcastPkts=ifHCInBroadcastPkts)
