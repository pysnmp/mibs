...
TextualConvention, TimeStamp, PhysAddress, TruthValue, DisplayString, AutonomousType, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "PhysAddress", "TruthValue", "DisplayString", "AutonomousType", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInDiscards=ifInDiscards, ifName=ifName, ifInMulticastPkts=ifInMulticastPkts, ifHighSpeed=ifHighSpeed, ifXEntry=ifXEntry, ifHCPacketGroup=ifHCPacketGroup, ifType=ifType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, linkUp=linkUp, ifMIBObjects=ifMIBObjects, interfaces=interfaces, ifRcvAddressStatus=ifRcvAddressStatus, ifOutUcastPkts=ifOutUcastPkts, ifOutDiscards=ifOutDiscards, ifOperStatus=ifOperStatus, ifStackStatus=ifStackStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifStackEntry=ifStackEntry, ifConformance=ifConformance, ifFixedLengthGroup=ifFixedLengthGroup, ifGroups=ifGroups, ifOutOctets=ifOutOctets, ifInOctets=ifInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInErrors=ifInErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifTestEntry=ifTestEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInOctets=ifHCInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifCompliance=ifCompliance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifPacketGroup=ifPacketGroup, ifIndex=ifIndex, ifGeneralGroup=ifGeneralGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXTable=ifXTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestId=ifTestId, ifTable=ifTable, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifStackLowerLayer=ifStackLowerLayer, linkDown=linkDown, ifHCOutOctets=ifHCOutOctets, ifTableLastChange=ifTableLastChange, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup2=ifStackGroup2, ifTestGroup=ifTestGroup, ifOutQLen=ifOutQLen, ifStackLastChange=ifStackLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutErrors=ifOutErrors, ifOutMulticastPkts=ifOutMulticastPkts, OwnerString=OwnerString, ifMtu=ifMtu, ifNumber=ifNumber, ifOutNUcastPkts=ifOutNUcastPkts, ifTestOwner=ifTestOwner, ifLastChange=ifLastChange, ifDescr=ifDescr, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestStatus=ifTestStatus, ifTestTable=ifTestTable, ifCompliances=ifCompliances, ifStackHigherLayer=ifStackHigherLayer, ifCompliance2=ifCompliance2, ifRcvAddressAddress=ifRcvAddressAddress, ifVHCPacketGroup=ifVHCPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifTestType=ifTestType, ifCompliance3=ifCompliance3, ifMIB=ifMIB, ifAlias=ifAlias, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry)
