...
PhysAddress, TestAndIncr, TruthValue, AutonomousType, TextualConvention, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TestAndIncr", "TruthValue", "AutonomousType", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifMIB=ifMIB, ifStackGroup2=ifStackGroup2, ifXTable=ifXTable, ifCompliances=ifCompliances, ifXEntry=ifXEntry, ifSpeed=ifSpeed, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInOctets=ifHCInOctets, ifGroups=ifGroups, PYSNMP_MODULE_ID=ifMIB, ifOutUcastPkts=ifOutUcastPkts, ifCompliance=ifCompliance, OwnerString=OwnerString, ifHCInUcastPkts=ifHCInUcastPkts, ifMtu=ifMtu, ifStackStatus=ifStackStatus, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifTableLastChange=ifTableLastChange, ifStackLastChange=ifStackLastChange, ifSpecific=ifSpecific, InterfaceIndex=InterfaceIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTable=ifTable, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifTestId=ifTestId, ifType=ifType, ifTestCode=ifTestCode, ifRcvAddressType=ifRcvAddressType, ifOutMulticastPkts=ifOutMulticastPkts, ifTestGroup=ifTestGroup, ifOutDiscards=ifOutDiscards, ifCompliance3=ifCompliance3, ifRcvAddressEntry=ifRcvAddressEntry, interfaces=interfaces, ifAlias=ifAlias, ifVHCPacketGroup=ifVHCPacketGroup, ifInDiscards=ifInDiscards, ifTestResult=ifTestResult, ifPhysAddress=ifPhysAddress, ifInNUcastPkts=ifInNUcastPkts, ifOperStatus=ifOperStatus, ifStackTable=ifStackTable, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifLastChange=ifLastChange, ifIndex=ifIndex, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifHighSpeed=ifHighSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutUcastPkts=ifHCOutUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLowerLayer=ifStackLowerLayer, ifInErrors=ifInErrors, ifInUcastPkts=ifInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifInOctets=ifInOctets, ifOutQLen=ifOutQLen, ifHCPacketGroup=ifHCPacketGroup, ifDescr=ifDescr, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestType=ifTestType, ifOutOctets=ifOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance2=ifCompliance2, linkDown=linkDown, ifMIBObjects=ifMIBObjects, ifRcvAddressAddress=ifRcvAddressAddress, ifPacketGroup=ifPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifRcvAddressStatus=ifRcvAddressStatus, ifConnectorPresent=ifConnectorPresent, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifTestStatus=ifTestStatus, ifAdminStatus=ifAdminStatus, ifTestOwner=ifTestOwner, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup)
