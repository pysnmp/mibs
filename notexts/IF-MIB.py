...
TextualConvention, TruthValue, PhysAddress, RowStatus, DisplayString, AutonomousType, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "PhysAddress", "RowStatus", "DisplayString", "AutonomousType", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifName=ifName, ifOldObjectsGroup=ifOldObjectsGroup, ifStackEntry=ifStackEntry, ifHCPacketGroup=ifHCPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMIB=ifMIB, ifPhysAddress=ifPhysAddress, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifCompliance3=ifCompliance3, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLastChange=ifLastChange, PYSNMP_MODULE_ID=ifMIB, ifAlias=ifAlias, ifOutQLen=ifOutQLen, linkUp=linkUp, ifSpeed=ifSpeed, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifSpecific=ifSpecific, ifTable=ifTable, ifFixedLengthGroup=ifFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInDiscards=ifInDiscards, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, linkDown=linkDown, interfaces=interfaces, ifTestType=ifTestType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifOutUcastPkts=ifOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup2=ifStackGroup2, OwnerString=OwnerString, ifHCOutOctets=ifHCOutOctets, ifDescr=ifDescr, ifAdminStatus=ifAdminStatus, ifHighSpeed=ifHighSpeed, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifOperStatus=ifOperStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTestResult=ifTestResult, ifIndex=ifIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInOctets=ifInOctets, ifTestGroup=ifTestGroup, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifTestId=ifTestId, ifTableLastChange=ifTableLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance=ifCompliance, ifMtu=ifMtu, ifOutOctets=ifOutOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifOutDiscards=ifOutDiscards, ifRcvAddressAddress=ifRcvAddressAddress, ifTestTable=ifTestTable, ifGeneralGroup=ifGeneralGroup, ifMIBObjects=ifMIBObjects, ifOutErrors=ifOutErrors, ifTestOwner=ifTestOwner, ifXEntry=ifXEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifTestEntry=ifTestEntry, ifRcvAddressType=ifRcvAddressType, ifCompliance2=ifCompliance2, ifStackGroup=ifStackGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifCompliances=ifCompliances, ifInNUcastPkts=ifInNUcastPkts, ifXTable=ifXTable, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, ifInErrors=ifInErrors, ifRcvAddressStatus=ifRcvAddressStatus)
