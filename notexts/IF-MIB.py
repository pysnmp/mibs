...
DisplayString, TimeStamp, TestAndIncr, RowStatus, PhysAddress, TruthValue, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TestAndIncr", "RowStatus", "PhysAddress", "TruthValue", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifMtu=ifMtu, ifPhysAddress=ifPhysAddress, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifStackTable=ifStackTable, ifTestStatus=ifTestStatus, ifConnectorPresent=ifConnectorPresent, ifRcvAddressEntry=ifRcvAddressEntry, ifMIBObjects=ifMIBObjects, ifInUcastPkts=ifInUcastPkts, ifStackGroup=ifStackGroup, ifHCOutOctets=ifHCOutOctets, linkDown=linkDown, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestResult=ifTestResult, ifAlias=ifAlias, ifDescr=ifDescr, ifOutDiscards=ifOutDiscards, ifOutQLen=ifOutQLen, ifInErrors=ifInErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifStackEntry=ifStackEntry, ifTestType=ifTestType, ifOutNUcastPkts=ifOutNUcastPkts, interfaces=interfaces, ifMIB=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackLastChange=ifStackLastChange, linkUp=linkUp, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifEntry=ifEntry, ifSpeed=ifSpeed, ifName=ifName, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifHighSpeed=ifHighSpeed, OwnerString=OwnerString, ifStackStatus=ifStackStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifLastChange=ifLastChange, ifTestOwner=ifTestOwner, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliances=ifCompliances, ifSpecific=ifSpecific, ifTable=ifTable, ifRcvAddressStatus=ifRcvAddressStatus, ifInNUcastPkts=ifInNUcastPkts, ifIndex=ifIndex, PYSNMP_MODULE_ID=ifMIB, ifXEntry=ifXEntry, ifGeneralGroup=ifGeneralGroup, ifTestGroup=ifTestGroup, ifType=ifType, ifHCPacketGroup=ifHCPacketGroup, ifAdminStatus=ifAdminStatus, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndex=InterfaceIndex, ifXTable=ifXTable, ifOutOctets=ifOutOctets, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifConformance=ifConformance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestTable=ifTestTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifNumber=ifNumber, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifStackHigherLayer=ifStackHigherLayer, ifTestId=ifTestId, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, ifPromiscuousMode=ifPromiscuousMode, ifTableLastChange=ifTableLastChange, ifCompliance=ifCompliance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifInOctets=ifInOctets, ifPacketGroup=ifPacketGroup, ifVHCPacketGroup=ifVHCPacketGroup)
