...
TruthValue, RowStatus, DisplayString, AutonomousType, TimeStamp, PhysAddress, TextualConvention, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "RowStatus", "DisplayString", "AutonomousType", "TimeStamp", "PhysAddress", "TextualConvention", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifLastChange=ifLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInDiscards=ifInDiscards, ifMIBObjects=ifMIBObjects, ifStackLowerLayer=ifStackLowerLayer, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifEntry=ifEntry, OwnerString=OwnerString, linkUp=linkUp, ifMtu=ifMtu, ifSpecific=ifSpecific, ifStackGroup2=ifStackGroup2, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifOutOctets=ifOutOctets, ifStackLastChange=ifStackLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifXEntry=ifXEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifStackStatus=ifStackStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInOctets=ifHCInOctets, ifAlias=ifAlias, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestResult=ifTestResult, ifType=ifType, ifCompliance=ifCompliance, InterfaceIndex=InterfaceIndex, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressType=ifRcvAddressType, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutUcastPkts=ifOutUcastPkts, linkDown=linkDown, ifStackHigherLayer=ifStackHigherLayer, ifIndex=ifIndex, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, ifStackTable=ifStackTable, ifTable=ifTable, ifOutQLen=ifOutQLen, ifTableLastChange=ifTableLastChange, ifHCOutOctets=ifHCOutOctets, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, ifInErrors=ifInErrors, ifTestOwner=ifTestOwner, ifInNUcastPkts=ifInNUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifCompliance2=ifCompliance2, ifDescr=ifDescr, ifMIB=ifMIB, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifOutDiscards=ifOutDiscards, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifAdminStatus=ifAdminStatus, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifOutErrors=ifOutErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInOctets=ifInOctets, interfaces=interfaces, ifGeneralGroup=ifGeneralGroup, ifStackEntry=ifStackEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifConformance=ifConformance, ifRcvAddressStatus=ifRcvAddressStatus, ifInMulticastPkts=ifInMulticastPkts, ifTestEntry=ifTestEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifTestId=ifTestId, ifCompliance3=ifCompliance3, ifCompliances=ifCompliances, ifNumber=ifNumber)
