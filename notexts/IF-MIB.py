...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter64, Integer32, ObjectIdentity, Unsigned32, Counter32, iso, IpAddress, ModuleIdentity, mib_2, Gauge32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter64", "Integer32", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "IpAddress", "ModuleIdentity", "mib-2", "Gauge32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("IF-MIB", ifGroups=ifGroups, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifInMulticastPkts=ifInMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifSpeed=ifSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifOutErrors=ifOutErrors, ifTable=ifTable, ifOperStatus=ifOperStatus, ifStackEntry=ifStackEntry, ifHCInOctets=ifHCInOctets, ifTestType=ifTestType, ifTestStatus=ifTestStatus, ifInDiscards=ifInDiscards, ifMtu=ifMtu, ifInNUcastPkts=ifInNUcastPkts, ifTestResult=ifTestResult, ifStackHigherLayer=ifStackHigherLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifStackTable=ifStackTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXTable=ifXTable, ifXEntry=ifXEntry, ifInUcastPkts=ifInUcastPkts, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode, ifOutMulticastPkts=ifOutMulticastPkts, ifMIBObjects=ifMIBObjects, ifStackLastChange=ifStackLastChange, ifTestGroup=ifTestGroup, ifInErrors=ifInErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutOctets=ifOutOctets, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressType=ifRcvAddressType, ifCompliance2=ifCompliance2, linkUp=linkUp, ifCompliances=ifCompliances, ifOldObjectsGroup=ifOldObjectsGroup, ifTestOwner=ifTestOwner, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifTestEntry=ifTestEntry, ifHCInUcastPkts=ifHCInUcastPkts, InterfaceIndex=InterfaceIndex, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifIndex=ifIndex, ifAdminStatus=ifAdminStatus, OwnerString=OwnerString, ifOutNUcastPkts=ifOutNUcastPkts, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, linkDown=linkDown, ifOutBroadcastPkts=ifOutBroadcastPkts, ifType=ifType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackGroup=ifStackGroup, ifLastChange=ifLastChange, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifDescr=ifDescr, ifTestTable=ifTestTable, ifVHCPacketGroup=ifVHCPacketGroup, ifStackStatus=ifStackStatus, ifSpecific=ifSpecific, ifMIB=ifMIB, ifInOctets=ifInOctets, interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts)
