...
TextualConvention, DisplayString, TimeStamp, AutonomousType, TruthValue, PhysAddress, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "TruthValue", "PhysAddress", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInBroadcastPkts=ifInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTable=ifTable, ifType=ifType, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifXTable=ifXTable, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifPacketGroup=ifPacketGroup, ifName=ifName, ifStackTable=ifStackTable, ifInUcastPkts=ifInUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifInNUcastPkts=ifInNUcastPkts, ifTestTable=ifTestTable, ifInDiscards=ifInDiscards, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackStatus=ifStackStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifStackGroup2=ifStackGroup2, ifConformance=ifConformance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutOctets=ifHCOutOctets, ifOutDiscards=ifOutDiscards, ifTestCode=ifTestCode, ifVHCPacketGroup=ifVHCPacketGroup, ifTestId=ifTestId, ifHCInBroadcastPkts=ifHCInBroadcastPkts, OwnerString=OwnerString, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifGeneralGroup=ifGeneralGroup, ifOutUcastPkts=ifOutUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, linkUp=linkUp, ifTableLastChange=ifTableLastChange, ifOperStatus=ifOperStatus, ifCompliance2=ifCompliance2, ifInOctets=ifInOctets, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifOutQLen=ifOutQLen, interfaces=interfaces, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifXEntry=ifXEntry, ifCompliance=ifCompliance, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressType=ifRcvAddressType, ifStackGroup=ifStackGroup, ifNumber=ifNumber, ifDescr=ifDescr, ifOutBroadcastPkts=ifOutBroadcastPkts, ifEntry=ifEntry, ifInErrors=ifInErrors, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifHCPacketGroup=ifHCPacketGroup, ifMIB=ifMIB, ifAdminStatus=ifAdminStatus, PYSNMP_MODULE_ID=ifMIB, ifTestType=ifTestType, ifTestStatus=ifTestStatus, ifTestGroup=ifTestGroup, ifGroups=ifGroups, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, InterfaceIndex=InterfaceIndex, ifCompliances=ifCompliances, ifStackEntry=ifStackEntry, ifIndex=ifIndex, ifPhysAddress=ifPhysAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifSpecific=ifSpecific, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifConnectorPresent=ifConnectorPresent)
