...
TimeStamp, TruthValue, AutonomousType, PhysAddress, RowStatus, DisplayString, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "PhysAddress", "RowStatus", "DisplayString", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifTestCode=ifTestCode, ifSpecific=ifSpecific, InterfaceIndex=InterfaceIndex, ifCompliances=ifCompliances, ifTestOwner=ifTestOwner, ifHCInBroadcastPkts=ifHCInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestGroup=ifTestGroup, ifHighSpeed=ifHighSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, ifTestResult=ifTestResult, ifInBroadcastPkts=ifInBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifInDiscards=ifInDiscards, ifTable=ifTable, ifTestTable=ifTestTable, ifRcvAddressGroup=ifRcvAddressGroup, linkUp=linkUp, ifNumber=ifNumber, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIBObjects=ifMIBObjects, ifConnectorPresent=ifConnectorPresent, ifCompliance3=ifCompliance3, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifAlias=ifAlias, ifStackEntry=ifStackEntry, ifXEntry=ifXEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifGroups=ifGroups, ifLastChange=ifLastChange, ifDescr=ifDescr, ifCompliance2=ifCompliance2, ifStackHigherLayer=ifStackHigherLayer, ifIndex=ifIndex, ifCompliance=ifCompliance, ifTestEntry=ifTestEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifOutOctets=ifOutOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifTestType=ifTestType, OwnerString=OwnerString, ifInUcastPkts=ifInUcastPkts, ifPacketGroup=ifPacketGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifRcvAddressEntry=ifRcvAddressEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutErrors=ifOutErrors, ifMtu=ifMtu, ifXTable=ifXTable, ifStackStatus=ifStackStatus, ifPhysAddress=ifPhysAddress, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifStackTable=ifStackTable, ifInUnknownProtos=ifInUnknownProtos, ifVHCPacketGroup=ifVHCPacketGroup, ifMIB=ifMIB, ifTestId=ifTestId, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifOperStatus=ifOperStatus, ifInErrors=ifInErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifGeneralGroup=ifGeneralGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCPacketGroup=ifHCPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTableLastChange=ifTableLastChange, linkDown=linkDown)
