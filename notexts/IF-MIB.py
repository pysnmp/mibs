...
TimeStamp, DisplayString, AutonomousType, RowStatus, TruthValue, TextualConvention, PhysAddress, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "AutonomousType", "RowStatus", "TruthValue", "TextualConvention", "PhysAddress", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup2=ifStackGroup2, ifConnectorPresent=ifConnectorPresent, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, ifHCPacketGroup=ifHCPacketGroup, ifType=ifType, ifOutMulticastPkts=ifOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIBObjects=ifMIBObjects, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifXTable=ifXTable, ifTestId=ifTestId, ifOldObjectsGroup=ifOldObjectsGroup, ifInDiscards=ifInDiscards, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressType=ifRcvAddressType, ifTestStatus=ifTestStatus, ifOutOctets=ifOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifStackHigherLayer=ifStackHigherLayer, ifOperStatus=ifOperStatus, ifOutDiscards=ifOutDiscards, ifRcvAddressAddress=ifRcvAddressAddress, ifPacketGroup=ifPacketGroup, linkUp=linkUp, ifAdminStatus=ifAdminStatus, interfaces=interfaces, ifCompliance3=ifCompliance3, ifStackTable=ifStackTable, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifCompliances=ifCompliances, ifNumber=ifNumber, ifRcvAddressEntry=ifRcvAddressEntry, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifInMulticastPkts=ifInMulticastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifConformance=ifConformance, ifOutNUcastPkts=ifOutNUcastPkts, ifStackStatus=ifStackStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInErrors=ifInErrors, ifLastChange=ifLastChange, ifMtu=ifMtu, ifTestType=ifTestType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInOctets=ifHCInOctets, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpecific=ifSpecific, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance2=ifCompliance2, OwnerString=OwnerString, linkDown=linkDown, ifXEntry=ifXEntry, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifTableLastChange=ifTableLastChange, ifPhysAddress=ifPhysAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifOutQLen=ifOutQLen, ifAlias=ifAlias, ifIndex=ifIndex, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, ifHCOutOctets=ifHCOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInOctets=ifInOctets, ifInUcastPkts=ifInUcastPkts, ifOutErrors=ifOutErrors, ifGroups=ifGroups, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifSpeed=ifSpeed, ifHighSpeed=ifHighSpeed)
