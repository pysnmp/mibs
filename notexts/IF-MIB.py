...
Counter32, Bits, IpAddress, mib_2, Counter64, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ObjectIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "IpAddress", "mib-2", "Counter64", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ObjectIdentity", "Unsigned32", "Gauge32")
DisplayString, PhysAddress, AutonomousType, TextualConvention, TimeStamp, TruthValue, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "AutonomousType", "TextualConvention", "TimeStamp", "TruthValue", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXTable=ifXTable, linkUp=linkUp, ifHCPacketGroup=ifHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifCompliance=ifCompliance, ifInUcastPkts=ifInUcastPkts, ifMIBObjects=ifMIBObjects, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackEntry=ifStackEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackStatus=ifStackStatus, ifAlias=ifAlias, ifStackTable=ifStackTable, ifCompliances=ifCompliances, ifXEntry=ifXEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifOperStatus=ifOperStatus, ifTableLastChange=ifTableLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifSpeed=ifSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, ifLastChange=ifLastChange, ifHighSpeed=ifHighSpeed, ifInBroadcastPkts=ifInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, InterfaceIndex=InterfaceIndex, ifInOctets=ifInOctets, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifConnectorPresent=ifConnectorPresent, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMtu=ifMtu, ifRcvAddressTable=ifRcvAddressTable, interfaces=interfaces, ifMIB=ifMIB, ifCompliance3=ifCompliance3, ifStackHigherLayer=ifStackHigherLayer, ifPacketGroup=ifPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance2=ifCompliance2, ifInMulticastPkts=ifInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, linkDown=linkDown, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifName=ifName, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGroups=ifGroups, ifStackLastChange=ifStackLastChange, ifTable=ifTable, ifConformance=ifConformance, ifTestResult=ifTestResult, ifPhysAddress=ifPhysAddress, ifAdminStatus=ifAdminStatus, PYSNMP_MODULE_ID=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestStatus=ifTestStatus, ifStackGroup=ifStackGroup, ifType=ifType, ifOutOctets=ifOutOctets, ifIndex=ifIndex, ifHCOutOctets=ifHCOutOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifInErrors=ifInErrors, ifTestTable=ifTestTable, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifEntry=ifEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifNumber=ifNumber, ifTestCode=ifTestCode, ifDescr=ifDescr, ifTestId=ifTestId, ifTestType=ifTestType, ifSpecific=ifSpecific, ifGeneralGroup=ifGeneralGroup, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards, ifInNUcastPkts=ifInNUcastPkts)
