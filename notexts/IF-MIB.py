...
TestAndIncr, TruthValue, TextualConvention, DisplayString, TimeStamp, AutonomousType, PhysAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "PhysAddress", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifTestResult=ifTestResult, ifVHCPacketGroup=ifVHCPacketGroup, ifStackTable=ifStackTable, ifTestId=ifTestId, ifOutQLen=ifOutQLen, ifLastChange=ifLastChange, ifTestType=ifTestType, ifAdminStatus=ifAdminStatus, ifStackLastChange=ifStackLastChange, ifOutErrors=ifOutErrors, ifEntry=ifEntry, ifConnectorPresent=ifConnectorPresent, ifTestCode=ifTestCode, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifInNUcastPkts=ifInNUcastPkts, ifTable=ifTable, ifStackLowerLayer=ifStackLowerLayer, OwnerString=OwnerString, ifXEntry=ifXEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutOctets=ifHCOutOctets, ifCompliances=ifCompliances, ifIndex=ifIndex, ifInOctets=ifInOctets, ifTestGroup=ifTestGroup, ifOutUcastPkts=ifOutUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance3=ifCompliance3, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, linkUp=linkUp, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInErrors=ifInErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifTestEntry=ifTestEntry, ifOutDiscards=ifOutDiscards, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifMtu=ifMtu, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackStatus=ifStackStatus, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifTableLastChange=ifTableLastChange, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, ifInUcastPkts=ifInUcastPkts, ifTestStatus=ifTestStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifGeneralGroup=ifGeneralGroup, ifOperStatus=ifOperStatus, ifType=ifType, ifRcvAddressStatus=ifRcvAddressStatus, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifCompliance2=ifCompliance2, ifCompliance=ifCompliance, ifOutMulticastPkts=ifOutMulticastPkts, linkDown=linkDown, ifHCInOctets=ifHCInOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifStackEntry=ifStackEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifStackGroup=ifStackGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHighSpeed=ifHighSpeed, ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, ifSpeed=ifSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifGroups=ifGroups, ifDescr=ifDescr)
