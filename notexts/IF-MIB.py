...
RowStatus, DisplayString, TestAndIncr, TimeStamp, AutonomousType, PhysAddress, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TestAndIncr", "TimeStamp", "AutonomousType", "PhysAddress", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifSpecific=ifSpecific, ifDescr=ifDescr, ifAlias=ifAlias, ifMtu=ifMtu, ifTestGroup=ifTestGroup, ifTestType=ifTestType, interfaces=interfaces, ifInErrors=ifInErrors, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifXEntry=ifXEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestStatus=ifTestStatus, ifHighSpeed=ifHighSpeed, ifTableLastChange=ifTableLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifEntry=ifEntry, ifTestResult=ifTestResult, ifTestOwner=ifTestOwner, ifFixedLengthGroup=ifFixedLengthGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifStackStatus=ifStackStatus, ifType=ifType, ifPacketGroup=ifPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifTestTable=ifTestTable, ifNumber=ifNumber, ifGeneralGroup=ifGeneralGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifAdminStatus=ifAdminStatus, ifInUcastPkts=ifInUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup2=ifStackGroup2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, OwnerString=OwnerString, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifCompliances=ifCompliances, ifStackEntry=ifStackEntry, ifOutDiscards=ifOutDiscards, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIBObjects=ifMIBObjects, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, ifStackLastChange=ifStackLastChange, ifName=ifName, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifGroups=ifGroups, ifRcvAddressTable=ifRcvAddressTable, ifTable=ifTable, ifInUnknownProtos=ifInUnknownProtos, ifMIB=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance3=ifCompliance3, ifConnectorPresent=ifConnectorPresent, ifTestCode=ifTestCode, ifConformance=ifConformance, ifRcvAddressStatus=ifRcvAddressStatus, ifTestId=ifTestId, ifOperStatus=ifOperStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifOutQLen=ifOutQLen, ifHCOutOctets=ifHCOutOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackTable=ifStackTable, ifLastChange=ifLastChange, ifCompliance=ifCompliance, linkDown=linkDown, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestEntry=ifTestEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifOutErrors=ifOutErrors, ifInOctets=ifInOctets, ifIndex=ifIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup)
