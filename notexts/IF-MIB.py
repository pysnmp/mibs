...
TextualConvention, AutonomousType, PhysAddress, DisplayString, TimeStamp, TestAndIncr, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "PhysAddress", "DisplayString", "TimeStamp", "TestAndIncr", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifStackEntry=ifStackEntry, ifStackStatus=ifStackStatus, ifRcvAddressType=ifRcvAddressType, ifLastChange=ifLastChange, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUcastPkts=ifInUcastPkts, ifAlias=ifAlias, ifStackGroup2=ifStackGroup2, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifTestResult=ifTestResult, ifStackHigherLayer=ifStackHigherLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifMtu=ifMtu, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, ifEntry=ifEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackTable=ifStackTable, ifTestId=ifTestId, ifCompliance3=ifCompliance3, ifTestOwner=ifTestOwner, ifHCInUcastPkts=ifHCInUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInOctets=ifInOctets, interfaces=interfaces, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInErrors=ifInErrors, ifMIB=ifMIB, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifTable=ifTable, ifXTable=ifXTable, ifHighSpeed=ifHighSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifInNUcastPkts=ifInNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifStackLastChange=ifStackLastChange, ifOutOctets=ifOutOctets, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressGroup=ifRcvAddressGroup, ifOperStatus=ifOperStatus, ifTestGroup=ifTestGroup, ifNumber=ifNumber, InterfaceIndex=InterfaceIndex, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifIndex=ifIndex, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInOctets=ifHCInOctets, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, linkDown=linkDown, OwnerString=OwnerString, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestStatus=ifTestStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, ifOutQLen=ifOutQLen, ifPacketGroup=ifPacketGroup, ifOutDiscards=ifOutDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifInUnknownProtos=ifInUnknownProtos, ifOutErrors=ifOutErrors, ifTestCode=ifTestCode, ifCompliances=ifCompliances, ifXEntry=ifXEntry, ifCompliance2=ifCompliance2, ifType=ifType, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifTableLastChange=ifTableLastChange, ifHCOutOctets=ifHCOutOctets, ifGroups=ifGroups, PYSNMP_MODULE_ID=ifMIB, linkUp=linkUp, ifOldObjectsGroup=ifOldObjectsGroup)
