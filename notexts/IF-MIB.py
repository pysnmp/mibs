...
ObjectIdentity, NotificationType, TimeTicks, Counter32, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, IpAddress, Integer32, MibIdentifier, Unsigned32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "IpAddress", "Integer32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Counter64")
RowStatus, PhysAddress, TimeStamp, TruthValue, TextualConvention, DisplayString, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TimeStamp", "TruthValue", "TextualConvention", "DisplayString", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutOctets=ifHCOutOctets, ifDescr=ifDescr, ifTestId=ifTestId, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifGroups=ifGroups, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, linkDown=linkDown, ifPhysAddress=ifPhysAddress, ifRcvAddressAddress=ifRcvAddressAddress, ifName=ifName, ifOperStatus=ifOperStatus, ifStackLowerLayer=ifStackLowerLayer, ifInMulticastPkts=ifInMulticastPkts, ifMtu=ifMtu, ifConformance=ifConformance, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifMIBObjects=ifMIBObjects, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackTable=ifStackTable, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestGroup=ifTestGroup, ifCompliance3=ifCompliance3, ifLastChange=ifLastChange, ifHCInOctets=ifHCInOctets, ifStackLastChange=ifStackLastChange, ifInUcastPkts=ifInUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifIndex=ifIndex, ifRcvAddressType=ifRcvAddressType, ifStackEntry=ifStackEntry, ifSpecific=ifSpecific, InterfaceIndexOrZero=InterfaceIndexOrZero, interfaces=interfaces, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifStackGroup2=ifStackGroup2, ifGeneralGroup=ifGeneralGroup, ifRcvAddressTable=ifRcvAddressTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestType=ifTestType, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifTestOwner=ifTestOwner, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutDiscards=ifOutDiscards, ifNumber=ifNumber, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifTestEntry=ifTestEntry, ifInDiscards=ifInDiscards, ifInUnknownProtos=ifInUnknownProtos, ifOutQLen=ifOutQLen, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAlias=ifAlias, ifTable=ifTable, ifInNUcastPkts=ifInNUcastPkts, ifMIB=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutErrors=ifOutErrors, ifTestTable=ifTestTable, ifTestStatus=ifTestStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifOutUcastPkts=ifOutUcastPkts, ifStackGroup=ifStackGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifXTable=ifXTable, OwnerString=OwnerString, ifTestResult=ifTestResult, linkUp=linkUp, ifOutOctets=ifOutOctets, ifType=ifType, ifCompliances=ifCompliances, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance=ifCompliance, ifPacketGroup=ifPacketGroup)
