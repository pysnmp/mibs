...
TimeTicks, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2, IpAddress, ObjectIdentity, Bits, Counter64, NotificationType, Unsigned32, ModuleIdentity, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2", "IpAddress", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter32")
TextualConvention, TimeStamp, TruthValue, DisplayString, RowStatus, AutonomousType, PhysAddress, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TruthValue", "DisplayString", "RowStatus", "AutonomousType", "PhysAddress", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifSpecific=ifSpecific, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifStackLastChange=ifStackLastChange, linkDown=linkDown, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressTable=ifRcvAddressTable, ifOutErrors=ifOutErrors, ifHCOutOctets=ifHCOutOctets, ifAdminStatus=ifAdminStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifDescr=ifDescr, ifCompliance3=ifCompliance3, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInOctets=ifInOctets, ifOutQLen=ifOutQLen, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifInUnknownProtos=ifInUnknownProtos, ifOutOctets=ifOutOctets, ifCompliance=ifCompliance, OwnerString=OwnerString, InterfaceIndex=InterfaceIndex, ifPacketGroup=ifPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHighSpeed=ifHighSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifType=ifType, ifCompliance2=ifCompliance2, ifTable=ifTable, ifTestType=ifTestType, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXEntry=ifXEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifEntry=ifEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, PYSNMP_MODULE_ID=ifMIB, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackTable=ifStackTable, ifOutDiscards=ifOutDiscards, ifGroups=ifGroups, ifStackHigherLayer=ifStackHigherLayer, ifTestTable=ifTestTable, linkUp=linkUp, ifTableLastChange=ifTableLastChange, ifCompliances=ifCompliances, ifRcvAddressAddress=ifRcvAddressAddress, interfaces=interfaces, ifStackGroup2=ifStackGroup2, ifInUcastPkts=ifInUcastPkts, ifMtu=ifMtu, ifGeneralGroup=ifGeneralGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifName=ifName, ifMIBObjects=ifMIBObjects, ifOutNUcastPkts=ifOutNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifSpeed=ifSpeed, ifInDiscards=ifInDiscards, InterfaceIndexOrZero=InterfaceIndexOrZero, ifIndex=ifIndex, ifTestCode=ifTestCode, ifNumber=ifNumber, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifStackStatus=ifStackStatus, ifTestEntry=ifTestEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, ifHCPacketGroup=ifHCPacketGroup, ifStackEntry=ifStackEntry, ifInErrors=ifInErrors, ifOutUcastPkts=ifOutUcastPkts, ifTestGroup=ifTestGroup, ifOperStatus=ifOperStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifPhysAddress=ifPhysAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLastChange=ifLastChange, ifMIB=ifMIB, ifTestId=ifTestId, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXTable=ifXTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestOwner=ifTestOwner, ifTestStatus=ifTestStatus, ifConformance=ifConformance)
