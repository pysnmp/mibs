...
TestAndIncr, TimeStamp, PhysAddress, DisplayString, RowStatus, AutonomousType, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "PhysAddress", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInUcastPkts=ifHCInUcastPkts, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup2=ifStackGroup2, ifGeneralInformationGroup=ifGeneralInformationGroup, ifConformance=ifConformance, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, InterfaceIndex=InterfaceIndex, ifAlias=ifAlias, ifTestEntry=ifTestEntry, ifHCPacketGroup=ifHCPacketGroup, ifSpeed=ifSpeed, OwnerString=OwnerString, ifTestType=ifTestType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLastChange=ifLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifOutQLen=ifOutQLen, ifTable=ifTable, ifCompliances=ifCompliances, ifInBroadcastPkts=ifInBroadcastPkts, ifTestResult=ifTestResult, ifPacketGroup=ifPacketGroup, ifEntry=ifEntry, ifInUcastPkts=ifInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifOperStatus=ifOperStatus, ifStackHigherLayer=ifStackHigherLayer, ifCompliance3=ifCompliance3, ifTableLastChange=ifTableLastChange, ifMIB=ifMIB, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutDiscards=ifOutDiscards, ifTestStatus=ifTestStatus, ifPhysAddress=ifPhysAddress, ifStackTable=ifStackTable, linkUp=linkUp, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifType=ifType, ifDescr=ifDescr, ifCompliance2=ifCompliance2, ifOutMulticastPkts=ifOutMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressType=ifRcvAddressType, ifHighSpeed=ifHighSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifName=ifName, ifSpecific=ifSpecific, ifOutErrors=ifOutErrors, ifTestId=ifTestId, ifInNUcastPkts=ifInNUcastPkts, ifTestOwner=ifTestOwner, ifFixedLengthGroup=ifFixedLengthGroup, ifStackStatus=ifStackStatus, ifTestGroup=ifTestGroup, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, interfaces=interfaces, ifRcvAddressGroup=ifRcvAddressGroup, ifAdminStatus=ifAdminStatus, ifStackGroup=ifStackGroup, ifTestCode=ifTestCode, ifGroups=ifGroups, ifHCOutOctets=ifHCOutOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInErrors=ifInErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, linkDown=linkDown, ifGeneralGroup=ifGeneralGroup, ifMtu=ifMtu, ifRcvAddressTable=ifRcvAddressTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifOutUcastPkts=ifOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifIndex=ifIndex, ifStackLastChange=ifStackLastChange, PYSNMP_MODULE_ID=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifInOctets=ifInOctets)
