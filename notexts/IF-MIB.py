...
TextualConvention, PhysAddress, DisplayString, TimeStamp, TruthValue, TestAndIncr, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "DisplayString", "TimeStamp", "TruthValue", "TestAndIncr", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifMtu=ifMtu, ifLastChange=ifLastChange, ifInBroadcastPkts=ifInBroadcastPkts, InterfaceIndex=InterfaceIndex, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, OwnerString=OwnerString, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackTable=ifStackTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMIB=ifMIB, ifInErrors=ifInErrors, ifStackLastChange=ifStackLastChange, ifTestGroup=ifTestGroup, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifInNUcastPkts=ifInNUcastPkts, ifTestCode=ifTestCode, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifCompliance=ifCompliance, ifStackHigherLayer=ifStackHigherLayer, ifTestEntry=ifTestEntry, ifStackGroup2=ifStackGroup2, ifCompliance3=ifCompliance3, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry, PYSNMP_MODULE_ID=ifMIB, ifOutOctets=ifOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInOctets=ifHCInOctets, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifPacketGroup=ifPacketGroup, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifOutQLen=ifOutQLen, ifEntry=ifEntry, ifStackStatus=ifStackStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOperStatus=ifOperStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifStackGroup=ifStackGroup, ifGeneralGroup=ifGeneralGroup, ifTableLastChange=ifTableLastChange, ifHighSpeed=ifHighSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXTable=ifXTable, ifOutErrors=ifOutErrors, ifInMulticastPkts=ifInMulticastPkts, ifTestResult=ifTestResult, linkDown=linkDown, ifStackLowerLayer=ifStackLowerLayer, ifNumber=ifNumber, ifCompliances=ifCompliances, ifStackEntry=ifStackEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifTestOwner=ifTestOwner, ifInOctets=ifInOctets, ifRcvAddressType=ifRcvAddressType, ifInUcastPkts=ifInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestType=ifTestType, ifIndex=ifIndex, ifTable=ifTable, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, ifSpeed=ifSpeed, ifTestTable=ifTestTable, ifName=ifName, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifOutUcastPkts=ifOutUcastPkts, linkUp=linkUp, ifRcvAddressAddress=ifRcvAddressAddress, ifConnectorPresent=ifConnectorPresent, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2)
