...
Gauge32, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, Integer32, Counter64, Unsigned32, Counter32, Bits, ModuleIdentity, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "Integer32", "Counter64", "Unsigned32", "Counter32", "Bits", "ModuleIdentity", "MibIdentifier", "iso")
RowStatus, PhysAddress, AutonomousType, TimeStamp, TextualConvention, TestAndIncr, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "AutonomousType", "TimeStamp", "TextualConvention", "TestAndIncr", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifXEntry=ifXEntry, ifTestId=ifTestId, ifTestCode=ifTestCode, ifGroups=ifGroups, ifRcvAddressAddress=ifRcvAddressAddress, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, ifTestEntry=ifTestEntry, ifTestOwner=ifTestOwner, ifEntry=ifEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifPhysAddress=ifPhysAddress, linkUp=linkUp, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCompliances=ifCompliances, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifGeneralGroup=ifGeneralGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifIndex=ifIndex, ifInMulticastPkts=ifInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifHCInOctets=ifHCInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackEntry=ifStackEntry, ifStackStatus=ifStackStatus, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifHCOutOctets=ifHCOutOctets, ifRcvAddressTable=ifRcvAddressTable, ifOutQLen=ifOutQLen, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTableLastChange=ifTableLastChange, ifOutOctets=ifOutOctets, ifTestStatus=ifTestStatus, interfaces=interfaces, ifRcvAddressType=ifRcvAddressType, ifNumber=ifNumber, InterfaceIndex=InterfaceIndex, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifOutNUcastPkts=ifOutNUcastPkts, ifAdminStatus=ifAdminStatus, ifMIBObjects=ifMIBObjects, linkDown=linkDown, ifStackHigherLayer=ifStackHigherLayer, ifConnectorPresent=ifConnectorPresent, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifTestGroup=ifTestGroup, ifXTable=ifXTable, ifTestTable=ifTestTable, ifSpecific=ifSpecific, ifMIB=ifMIB, ifOperStatus=ifOperStatus, ifOutErrors=ifOutErrors, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifTestResult=ifTestResult, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance2=ifCompliance2, ifOldObjectsGroup=ifOldObjectsGroup, ifTable=ifTable, ifCompliance=ifCompliance, ifLastChange=ifLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifMtu=ifMtu, ifHighSpeed=ifHighSpeed, ifDescr=ifDescr, ifName=ifName, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifInUcastPkts=ifInUcastPkts, ifCompliance3=ifCompliance3, ifStackGroup2=ifStackGroup2, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifTestType=ifTestType, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts)
