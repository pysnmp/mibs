...
TextualConvention, PhysAddress, DisplayString, AutonomousType, TestAndIncr, TimeStamp, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "DisplayString", "AutonomousType", "TestAndIncr", "TimeStamp", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutOctets=ifHCOutOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, ifStackStatus=ifStackStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifInUcastPkts=ifInUcastPkts, ifNumber=ifNumber, ifHCInOctets=ifHCInOctets, ifOutMulticastPkts=ifOutMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifConformance=ifConformance, ifVHCPacketGroup=ifVHCPacketGroup, ifStackTable=ifStackTable, ifLastChange=ifLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifTestResult=ifTestResult, ifRcvAddressEntry=ifRcvAddressEntry, ifPromiscuousMode=ifPromiscuousMode, ifHCInUcastPkts=ifHCInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifOutOctets=ifOutOctets, ifOutDiscards=ifOutDiscards, ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestId=ifTestId, OwnerString=OwnerString, ifStackLowerLayer=ifStackLowerLayer, ifDescr=ifDescr, linkUp=linkUp, ifFixedLengthGroup=ifFixedLengthGroup, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestEntry=ifTestEntry, ifCompliance=ifCompliance, ifTestStatus=ifTestStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifOutErrors=ifOutErrors, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestGroup=ifTestGroup, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifPacketGroup=ifPacketGroup, ifSpeed=ifSpeed, ifInDiscards=ifInDiscards, ifInErrors=ifInErrors, ifTestTable=ifTestTable, ifAlias=ifAlias, ifInUnknownProtos=ifInUnknownProtos, ifStackGroup=ifStackGroup, ifRcvAddressTable=ifRcvAddressTable, ifInOctets=ifInOctets, ifCompliance2=ifCompliance2, ifXEntry=ifXEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLastChange=ifStackLastChange, ifCompliances=ifCompliances, ifOldObjectsGroup=ifOldObjectsGroup, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifMIB=ifMIB, ifMtu=ifMtu, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifIndex=ifIndex, ifSpecific=ifSpecific, ifHCPacketGroup=ifHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifTableLastChange=ifTableLastChange, ifType=ifType, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifXTable=ifXTable, ifStackGroup2=ifStackGroup2, ifTestType=ifTestType, ifTable=ifTable, ifStackEntry=ifStackEntry, ifCompliance3=ifCompliance3, ifGeneralGroup=ifGeneralGroup, ifConnectorPresent=ifConnectorPresent, ifRcvAddressType=ifRcvAddressType, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutUcastPkts=ifHCOutUcastPkts)
