...
TestAndIncr, TextualConvention, TimeStamp, RowStatus, DisplayString, AutonomousType, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "TimeStamp", "RowStatus", "DisplayString", "AutonomousType", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLowerLayer=ifStackLowerLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInMulticastPkts=ifInMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, ifTestGroup=ifTestGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifHCInOctets=ifHCInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTable=ifTable, ifMIB=ifMIB, ifIndex=ifIndex, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifOutDiscards=ifOutDiscards, ifCompliance=ifCompliance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance3=ifCompliance3, ifHighSpeed=ifHighSpeed, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifType=ifType, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifStackTable=ifStackTable, ifInUcastPkts=ifInUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, linkDown=linkDown, ifOutErrors=ifOutErrors, ifHCOutOctets=ifHCOutOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliances=ifCompliances, OwnerString=OwnerString, ifVHCPacketGroup=ifVHCPacketGroup, ifStackStatus=ifStackStatus, linkUp=linkUp, ifStackGroup=ifStackGroup, ifTestResult=ifTestResult, ifTestType=ifTestType, ifStackLastChange=ifStackLastChange, ifOutQLen=ifOutQLen, InterfaceIndex=InterfaceIndex, interfaces=interfaces, ifTestOwner=ifTestOwner, ifInBroadcastPkts=ifInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifSpeed=ifSpeed, ifTestStatus=ifTestStatus, ifTestEntry=ifTestEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifLastChange=ifLastChange, ifXEntry=ifXEntry, ifInNUcastPkts=ifInNUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifInDiscards=ifInDiscards, ifTestTable=ifTestTable, ifRcvAddressTable=ifRcvAddressTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConformance=ifConformance, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXTable=ifXTable, ifEntry=ifEntry, ifRcvAddressType=ifRcvAddressType, ifPromiscuousMode=ifPromiscuousMode, ifStackHigherLayer=ifStackHigherLayer, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifRcvAddressStatus=ifRcvAddressStatus, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInOctets=ifInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifOperStatus=ifOperStatus, ifGroups=ifGroups, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifMtu=ifMtu, ifStackGroup2=ifStackGroup2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressAddress=ifRcvAddressAddress)
