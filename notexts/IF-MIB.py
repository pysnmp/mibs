...
RowStatus, TimeStamp, TruthValue, AutonomousType, PhysAddress, TextualConvention, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TruthValue", "AutonomousType", "PhysAddress", "TextualConvention", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestOwner=ifTestOwner, ifTestType=ifTestType, linkDown=linkDown, ifOperStatus=ifOperStatus, ifTable=ifTable, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifType=ifType, ifIndex=ifIndex, ifLastChange=ifLastChange, ifXTable=ifXTable, ifConnectorPresent=ifConnectorPresent, ifDescr=ifDescr, ifRcvAddressStatus=ifRcvAddressStatus, ifInDiscards=ifInDiscards, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, PYSNMP_MODULE_ID=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGroups=ifGroups, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifHCInOctets=ifHCInOctets, ifAdminStatus=ifAdminStatus, ifMtu=ifMtu, ifPacketGroup=ifPacketGroup, InterfaceIndex=InterfaceIndex, ifOutQLen=ifOutQLen, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifStackGroup2=ifStackGroup2, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifStackEntry=ifStackEntry, ifGeneralGroup=ifGeneralGroup, ifRcvAddressAddress=ifRcvAddressAddress, interfaces=interfaces, ifSpeed=ifSpeed, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifTestEntry=ifTestEntry, ifOutDiscards=ifOutDiscards, ifXEntry=ifXEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTestId=ifTestId, ifCompliance2=ifCompliance2, ifConformance=ifConformance, ifName=ifName, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestCode=ifTestCode, ifAlias=ifAlias, ifInUcastPkts=ifInUcastPkts, ifTestResult=ifTestResult, ifInErrors=ifInErrors, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutOctets=ifHCOutOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifStackTable=ifStackTable, ifStackHigherLayer=ifStackHigherLayer, ifTestStatus=ifTestStatus, ifStackGroup=ifStackGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifPromiscuousMode=ifPromiscuousMode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifSpecific=ifSpecific, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, ifStackStatus=ifStackStatus, ifStackLastChange=ifStackLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliances=ifCompliances, ifOutMulticastPkts=ifOutMulticastPkts, ifOutUcastPkts=ifOutUcastPkts)
