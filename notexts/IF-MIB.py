...
TextualConvention, RowStatus, DisplayString, AutonomousType, PhysAddress, TimeStamp, TestAndIncr, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType", "PhysAddress", "TimeStamp", "TestAndIncr", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifOutOctets=ifOutOctets, ifXTable=ifXTable, ifTable=ifTable, ifOutErrors=ifOutErrors, ifTestTable=ifTestTable, linkDown=linkDown, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifOldObjectsGroup=ifOldObjectsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestType=ifTestType, ifConformance=ifConformance, ifCompliances=ifCompliances, ifOutDiscards=ifOutDiscards, ifEntry=ifEntry, ifType=ifType, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, ifStackGroup2=ifStackGroup2, ifOperStatus=ifOperStatus, InterfaceIndex=InterfaceIndex, ifStackEntry=ifStackEntry, ifPhysAddress=ifPhysAddress, ifTableLastChange=ifTableLastChange, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, ifHCInOctets=ifHCInOctets, ifTestId=ifTestId, ifFixedLengthGroup=ifFixedLengthGroup, ifXEntry=ifXEntry, ifIndex=ifIndex, ifStackTable=ifStackTable, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, linkUp=linkUp, ifInOctets=ifInOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifTestCode=ifTestCode, ifStackLowerLayer=ifStackLowerLayer, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutQLen=ifOutQLen, ifTestEntry=ifTestEntry, ifInUcastPkts=ifInUcastPkts, ifSpecific=ifSpecific, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifSpeed=ifSpeed, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInDiscards=ifInDiscards, ifGeneralGroup=ifGeneralGroup, ifMtu=ifMtu, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInUnknownProtos=ifInUnknownProtos, ifName=ifName, ifMIB=ifMIB, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifStackLastChange=ifStackLastChange, ifGroups=ifGroups, ifInMulticastPkts=ifInMulticastPkts, ifCompliance3=ifCompliance3, ifTestResult=ifTestResult, ifNumber=ifNumber, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestOwner=ifTestOwner, ifCompliance2=ifCompliance2, ifDescr=ifDescr, ifTestStatus=ifTestStatus, ifVHCPacketGroup=ifVHCPacketGroup, interfaces=interfaces, ifHighSpeed=ifHighSpeed, OwnerString=OwnerString, ifInErrors=ifInErrors, ifOutUcastPkts=ifOutUcastPkts, ifAdminStatus=ifAdminStatus, ifInNUcastPkts=ifInNUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, ifCompliance=ifCompliance)
