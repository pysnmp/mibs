...
TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, ObjectIdentity, NotificationType, Counter64, Integer32, Bits, Counter32, Gauge32, iso, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter64", "Integer32", "Bits", "Counter32", "Gauge32", "iso", "Unsigned32", "mib-2")
TimeStamp, TruthValue, DisplayString, TestAndIncr, PhysAddress, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "DisplayString", "TestAndIncr", "PhysAddress", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifOutErrors=ifOutErrors, ifOutUcastPkts=ifOutUcastPkts, ifRcvAddressType=ifRcvAddressType, ifFixedLengthGroup=ifFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, ifRcvAddressGroup=ifRcvAddressGroup, ifInOctets=ifInOctets, ifConnectorPresent=ifConnectorPresent, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup2=ifStackGroup2, ifStackStatus=ifStackStatus, ifTestType=ifTestType, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance2=ifCompliance2, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifInNUcastPkts=ifInNUcastPkts, linkUp=linkUp, ifTestEntry=ifTestEntry, ifLastChange=ifLastChange, ifXEntry=ifXEntry, ifInUnknownProtos=ifInUnknownProtos, ifAdminStatus=ifAdminStatus, interfaces=interfaces, ifMIBObjects=ifMIBObjects, ifStackEntry=ifStackEntry, ifOutQLen=ifOutQLen, ifInErrors=ifInErrors, ifCompliance=ifCompliance, ifTestId=ifTestId, ifStackTable=ifStackTable, ifOutOctets=ifOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, PYSNMP_MODULE_ID=ifMIB, ifInBroadcastPkts=ifInBroadcastPkts, ifType=ifType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkDown=linkDown, ifDescr=ifDescr, ifTableLastChange=ifTableLastChange, ifInUcastPkts=ifInUcastPkts, ifTestStatus=ifTestStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLastChange=ifStackLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifOutNUcastPkts=ifOutNUcastPkts, ifTable=ifTable, ifOperStatus=ifOperStatus, ifTestCode=ifTestCode, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup=ifStackGroup, ifHCInOctets=ifHCInOctets, ifSpeed=ifSpeed, ifOutDiscards=ifOutDiscards, ifIndex=ifIndex, ifNumber=ifNumber, ifInMulticastPkts=ifInMulticastPkts, ifTestOwner=ifTestOwner, ifTestResult=ifTestResult, OwnerString=OwnerString, ifStackHigherLayer=ifStackHigherLayer, ifHCOutOctets=ifHCOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralGroup=ifGeneralGroup, ifMIB=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPhysAddress=ifPhysAddress, ifTestGroup=ifTestGroup, ifName=ifName, ifSpecific=ifSpecific, ifInDiscards=ifInDiscards, ifEntry=ifEntry, ifTestTable=ifTestTable, ifCompliances=ifCompliances, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifXTable=ifXTable)
