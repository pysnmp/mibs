...
Gauge32, mib_2, Bits, IpAddress, Unsigned32, Counter32, iso, Integer32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "mib-2", "Bits", "IpAddress", "Unsigned32", "Counter32", "iso", "Integer32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity")
DisplayString, TimeStamp, TextualConvention, AutonomousType, RowStatus, PhysAddress, TruthValue, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus", "PhysAddress", "TruthValue", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressAddress=ifRcvAddressAddress, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestEntry=ifTestEntry, ifStackLastChange=ifStackLastChange, ifStackStatus=ifStackStatus, ifTable=ifTable, ifTestType=ifTestType, ifHCInOctets=ifHCInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutOctets=ifOutOctets, ifConformance=ifConformance, linkDown=linkDown, ifOutDiscards=ifOutDiscards, ifRcvAddressType=ifRcvAddressType, ifInErrors=ifInErrors, ifOutUcastPkts=ifOutUcastPkts, ifIndex=ifIndex, ifMIBObjects=ifMIBObjects, ifStackHigherLayer=ifStackHigherLayer, ifName=ifName, ifGroups=ifGroups, ifTestOwner=ifTestOwner, ifOutErrors=ifOutErrors, ifAlias=ifAlias, ifTestId=ifTestId, ifTestResult=ifTestResult, ifHCOutUcastPkts=ifHCOutUcastPkts, ifType=ifType, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliances=ifCompliances, ifRcvAddressTable=ifRcvAddressTable, ifCompliance=ifCompliance, ifTableLastChange=ifTableLastChange, ifLastChange=ifLastChange, ifTestStatus=ifTestStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, OwnerString=OwnerString, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifMtu=ifMtu, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifNumber=ifNumber, ifHighSpeed=ifHighSpeed, ifCompliance2=ifCompliance2, ifGeneralInformationGroup=ifGeneralInformationGroup, ifDescr=ifDescr, ifStackGroup2=ifStackGroup2, ifXTable=ifXTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifTestTable=ifTestTable, ifInNUcastPkts=ifInNUcastPkts, ifXEntry=ifXEntry, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifSpeed=ifSpeed, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance3=ifCompliance3, ifStackEntry=ifStackEntry, interfaces=interfaces, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOperStatus=ifOperStatus, ifHCOutOctets=ifHCOutOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifPhysAddress=ifPhysAddress, ifStackTable=ifStackTable, ifTestCode=ifTestCode, ifStackGroup=ifStackGroup, ifInDiscards=ifInDiscards, ifInUnknownProtos=ifInUnknownProtos, ifEntry=ifEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, InterfaceIndex=InterfaceIndex, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode)
