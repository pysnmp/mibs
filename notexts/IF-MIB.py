...
Gauge32, Counter64, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, TimeTicks, Counter32, NotificationType, ModuleIdentity, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "Counter32", "NotificationType", "ModuleIdentity", "mib-2", "Integer32")
RowStatus, TimeStamp, TextualConvention, AutonomousType, DisplayString, TestAndIncr, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TextualConvention", "AutonomousType", "DisplayString", "TestAndIncr", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifMIBObjects=ifMIBObjects, ifEntry=ifEntry, ifOutQLen=ifOutQLen, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestCode=ifTestCode, ifOutUcastPkts=ifOutUcastPkts, ifTestType=ifTestType, ifRcvAddressStatus=ifRcvAddressStatus, interfaces=interfaces, ifIndex=ifIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifTestId=ifTestId, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLastChange=ifStackLastChange, ifNumber=ifNumber, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInUcastPkts=ifInUcastPkts, ifGroups=ifGroups, ifDescr=ifDescr, ifOutErrors=ifOutErrors, ifSpecific=ifSpecific, ifOperStatus=ifOperStatus, ifInUnknownProtos=ifInUnknownProtos, ifTestStatus=ifTestStatus, ifStackGroup=ifStackGroup, ifOutOctets=ifOutOctets, ifTableLastChange=ifTableLastChange, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, linkDown=linkDown, ifRcvAddressGroup=ifRcvAddressGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConnectorPresent=ifConnectorPresent, ifStackEntry=ifStackEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliances=ifCompliances, ifName=ifName, ifHCInUcastPkts=ifHCInUcastPkts, ifTestTable=ifTestTable, ifSpeed=ifSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, linkUp=linkUp, ifInOctets=ifInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifStackStatus=ifStackStatus, ifXTable=ifXTable, ifPhysAddress=ifPhysAddress, ifHCInOctets=ifHCInOctets, ifGeneralGroup=ifGeneralGroup, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLastChange=ifLastChange, ifTable=ifTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifMtu=ifMtu, ifOutDiscards=ifOutDiscards, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifInErrors=ifInErrors, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifStackGroup2=ifStackGroup2, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifInMulticastPkts=ifInMulticastPkts, ifHighSpeed=ifHighSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifTestOwner=ifTestOwner, ifCompliance3=ifCompliance3, ifInDiscards=ifInDiscards, ifTestGroup=ifTestGroup, InterfaceIndex=InterfaceIndex, ifHCOutOctets=ifHCOutOctets, ifAlias=ifAlias, ifCompliance=ifCompliance, ifType=ifType, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIB=ifMIB, ifConformance=ifConformance, ifCompliance2=ifCompliance2)
