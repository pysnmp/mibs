...
ModuleIdentity, Counter64, Bits, IpAddress, Gauge32, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter32, NotificationType, ObjectIdentity, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "IpAddress", "Gauge32", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "ObjectIdentity", "TimeTicks", "iso")
AutonomousType, TimeStamp, TextualConvention, PhysAddress, TruthValue, RowStatus, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TextualConvention", "PhysAddress", "TruthValue", "RowStatus", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUcastPkts=ifInUcastPkts, linkUp=linkUp, ifTestGroup=ifTestGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifXTable=ifXTable, ifOutUcastPkts=ifOutUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, ifRcvAddressType=ifRcvAddressType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifTestEntry=ifTestEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInOctets=ifInOctets, interfaces=interfaces, ifTestCode=ifTestCode, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, ifStackStatus=ifStackStatus, ifOutQLen=ifOutQLen, ifCompliance=ifCompliance, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifOutOctets=ifOutOctets, ifStackEntry=ifStackEntry, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, ifXEntry=ifXEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestId=ifTestId, ifIndex=ifIndex, ifConnectorPresent=ifConnectorPresent, ifStackGroup2=ifStackGroup2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInOctets=ifHCInOctets, ifTestOwner=ifTestOwner, ifRcvAddressEntry=ifRcvAddressEntry, ifHighSpeed=ifHighSpeed, ifMtu=ifMtu, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifRcvAddressStatus=ifRcvAddressStatus, ifTable=ifTable, ifInErrors=ifInErrors, ifOperStatus=ifOperStatus, ifOutDiscards=ifOutDiscards, PYSNMP_MODULE_ID=ifMIB, ifCompliance3=ifCompliance3, ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestType=ifTestType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGroups=ifGroups, ifSpecific=ifSpecific, ifOutBroadcastPkts=ifOutBroadcastPkts, ifLastChange=ifLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackTable=ifStackTable, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifHCInUcastPkts=ifHCInUcastPkts, ifName=ifName, ifOutErrors=ifOutErrors, ifInMulticastPkts=ifInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifPhysAddress=ifPhysAddress, ifStackHigherLayer=ifStackHigherLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifNumber=ifNumber, ifStackLowerLayer=ifStackLowerLayer, ifCompliances=ifCompliances, ifGeneralGroup=ifGeneralGroup, OwnerString=OwnerString, linkDown=linkDown, ifTestStatus=ifTestStatus)
