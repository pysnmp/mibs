...
TimeStamp, RowStatus, TruthValue, AutonomousType, TestAndIncr, PhysAddress, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TruthValue", "AutonomousType", "TestAndIncr", "PhysAddress", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifInDiscards=ifInDiscards, InterfaceIndex=InterfaceIndex, ifConnectorPresent=ifConnectorPresent, ifStackGroup2=ifStackGroup2, ifRcvAddressStatus=ifRcvAddressStatus, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifOutUcastPkts=ifOutUcastPkts, ifTestStatus=ifTestStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifXTable=ifXTable, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifSpeed=ifSpeed, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifTestGroup=ifTestGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackEntry=ifStackEntry, ifGeneralGroup=ifGeneralGroup, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifEntry=ifEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifStackGroup=ifStackGroup, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifGeneralInformationGroup=ifGeneralInformationGroup, ifType=ifType, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifPacketGroup=ifPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifTestCode=ifTestCode, ifTestTable=ifTestTable, ifCompliance=ifCompliance, ifOutMulticastPkts=ifOutMulticastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifOutQLen=ifOutQLen, linkUp=linkUp, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAdminStatus=ifAdminStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifDescr=ifDescr, ifOperStatus=ifOperStatus, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifStackLastChange=ifStackLastChange, ifStackTable=ifStackTable, ifTestOwner=ifTestOwner, ifInOctets=ifInOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestId=ifTestId, ifPhysAddress=ifPhysAddress, ifHCOutOctets=ifHCOutOctets, ifName=ifName, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifGroups=ifGroups, interfaces=interfaces, ifTestEntry=ifTestEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance3=ifCompliance3, ifOutErrors=ifOutErrors, ifMtu=ifMtu, ifMIB=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts)
