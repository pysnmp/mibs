...
TruthValue, AutonomousType, PhysAddress, TextualConvention, DisplayString, TimeStamp, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "PhysAddress", "TextualConvention", "DisplayString", "TimeStamp", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressAddress=ifRcvAddressAddress, ifStackLowerLayer=ifStackLowerLayer, ifTestResult=ifTestResult, ifTestEntry=ifTestEntry, ifPhysAddress=ifPhysAddress, ifStackHigherLayer=ifStackHigherLayer, OwnerString=OwnerString, ifGroups=ifGroups, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInErrors=ifInErrors, ifType=ifType, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup=ifStackGroup, ifPacketGroup=ifPacketGroup, ifIndex=ifIndex, ifTestId=ifTestId, ifTestType=ifTestType, ifConnectorPresent=ifConnectorPresent, ifInNUcastPkts=ifInNUcastPkts, ifInDiscards=ifInDiscards, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressTable=ifRcvAddressTable, ifHCInOctets=ifHCInOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifInOctets=ifInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifName=ifName, ifTestStatus=ifTestStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifOutQLen=ifOutQLen, ifTestTable=ifTestTable, ifRcvAddressStatus=ifRcvAddressStatus, ifTable=ifTable, ifMIBObjects=ifMIBObjects, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, ifCompliance2=ifCompliance2, ifOutUcastPkts=ifOutUcastPkts, interfaces=interfaces, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHighSpeed=ifHighSpeed, ifSpecific=ifSpecific, ifHCOutOctets=ifHCOutOctets, ifTestOwner=ifTestOwner, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance3=ifCompliance3, ifGeneralGroup=ifGeneralGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMtu=ifMtu, ifMIB=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifConformance=ifConformance, linkUp=linkUp, ifCompliance=ifCompliance, ifOldObjectsGroup=ifOldObjectsGroup, ifSpeed=ifSpeed, ifOutNUcastPkts=ifOutNUcastPkts, ifAdminStatus=ifAdminStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXTable=ifXTable, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifOutErrors=ifOutErrors, ifStackLastChange=ifStackLastChange, ifPromiscuousMode=ifPromiscuousMode, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifNumber=ifNumber, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifOutOctets=ifOutOctets, ifInBroadcastPkts=ifInBroadcastPkts)
