...
TruthValue, TextualConvention, RowStatus, DisplayString, TestAndIncr, PhysAddress, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "RowStatus", "DisplayString", "TestAndIncr", "PhysAddress", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifAdminStatus=ifAdminStatus, ifEntry=ifEntry, ifIndex=ifIndex, ifHCInOctets=ifHCInOctets, ifInMulticastPkts=ifInMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifStackLowerLayer=ifStackLowerLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, interfaces=interfaces, ifRcvAddressType=ifRcvAddressType, ifOutOctets=ifOutOctets, ifGroups=ifGroups, ifStackStatus=ifStackStatus, ifMtu=ifMtu, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifInBroadcastPkts=ifInBroadcastPkts, InterfaceIndex=InterfaceIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInDiscards=ifInDiscards, ifName=ifName, ifStackHigherLayer=ifStackHigherLayer, ifTestResult=ifTestResult, ifXTable=ifXTable, ifHCInUcastPkts=ifHCInUcastPkts, ifTestCode=ifTestCode, ifInOctets=ifInOctets, ifStackEntry=ifStackEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackTable=ifStackTable, ifCompliances=ifCompliances, ifStackGroup=ifStackGroup, ifPacketGroup=ifPacketGroup, ifInUcastPkts=ifInUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifType=ifType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifTestTable=ifTestTable, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifPhysAddress=ifPhysAddress, ifLastChange=ifLastChange, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTestOwner=ifTestOwner, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOperStatus=ifOperStatus, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackGroup2=ifStackGroup2, ifTableLastChange=ifTableLastChange, ifTestId=ifTestId, ifInNUcastPkts=ifInNUcastPkts, ifOutQLen=ifOutQLen, ifTestStatus=ifTestStatus, ifHighSpeed=ifHighSpeed, ifHCOutOctets=ifHCOutOctets, ifOutDiscards=ifOutDiscards, ifRcvAddressTable=ifRcvAddressTable, ifNumber=ifNumber, linkUp=linkUp, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifOldObjectsGroup=ifOldObjectsGroup, ifTable=ifTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifSpeed=ifSpeed, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, linkDown=linkDown, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifTestType=ifTestType, ifInErrors=ifInErrors, ifInUnknownProtos=ifInUnknownProtos, ifPromiscuousMode=ifPromiscuousMode, OwnerString=OwnerString, ifSpecific=ifSpecific, ifDescr=ifDescr, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressAddress=ifRcvAddressAddress, ifOutErrors=ifOutErrors, ifXEntry=ifXEntry, ifCompliance3=ifCompliance3)
