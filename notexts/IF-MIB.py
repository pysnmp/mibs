...
AutonomousType, TestAndIncr, TruthValue, RowStatus, DisplayString, TimeStamp, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "TruthValue", "RowStatus", "DisplayString", "TimeStamp", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifMIB=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifEntry=ifEntry, ifName=ifName, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTable=ifTable, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifCompliance3=ifCompliance3, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifInUcastPkts=ifInUcastPkts, interfaces=interfaces, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCPacketGroup=ifHCPacketGroup, ifInErrors=ifInErrors, ifOperStatus=ifOperStatus, ifHighSpeed=ifHighSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifType=ifType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifConformance=ifConformance, ifTableLastChange=ifTableLastChange, PYSNMP_MODULE_ID=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifInBroadcastPkts=ifInBroadcastPkts, ifStackGroup=ifStackGroup, ifInMulticastPkts=ifInMulticastPkts, ifSpecific=ifSpecific, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifMIBObjects=ifMIBObjects, ifTestType=ifTestType, ifIndex=ifIndex, ifInDiscards=ifInDiscards, ifOldObjectsGroup=ifOldObjectsGroup, ifOutDiscards=ifOutDiscards, ifTestEntry=ifTestEntry, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifMtu=ifMtu, ifXTable=ifXTable, ifCompliances=ifCompliances, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifPhysAddress=ifPhysAddress, ifStackStatus=ifStackStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifPacketGroup=ifPacketGroup, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifDescr=ifDescr, ifTestId=ifTestId, ifOutOctets=ifOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifInOctets=ifInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance2=ifCompliance2, ifLastChange=ifLastChange, ifAdminStatus=ifAdminStatus, ifNumber=ifNumber, ifHCInOctets=ifHCInOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance=ifCompliance, ifRcvAddressAddress=ifRcvAddressAddress, ifPromiscuousMode=ifPromiscuousMode, ifGroups=ifGroups, OwnerString=OwnerString, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutErrors=ifOutErrors, ifAlias=ifAlias, ifInNUcastPkts=ifInNUcastPkts, ifStackLastChange=ifStackLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralGroup=ifGeneralGroup, InterfaceIndex=InterfaceIndex, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, linkDown=linkDown, ifOutQLen=ifOutQLen)
