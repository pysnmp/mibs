...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, iso, MibIdentifier, Counter64, Gauge32, ModuleIdentity, TimeTicks, Bits, NotificationType, Unsigned32, mib_2, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "iso", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "TimeTicks", "Bits", "NotificationType", "Unsigned32", "mib-2", "Counter32")
PhysAddress, TruthValue, TextualConvention, TimeStamp, AutonomousType, TestAndIncr, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TruthValue", "TextualConvention", "TimeStamp", "AutonomousType", "TestAndIncr", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", OwnerString=OwnerString, ifTestStatus=ifTestStatus, ifHCInOctets=ifHCInOctets, ifInErrors=ifInErrors, ifInMulticastPkts=ifInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifDescr=ifDescr, ifRcvAddressGroup=ifRcvAddressGroup, ifStackEntry=ifStackEntry, ifStackLastChange=ifStackLastChange, ifTable=ifTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkDown=linkDown, ifIndex=ifIndex, ifOutDiscards=ifOutDiscards, ifTableLastChange=ifTableLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTestId=ifTestId, ifTestOwner=ifTestOwner, ifCompliance3=ifCompliance3, ifXTable=ifXTable, InterfaceIndex=InterfaceIndex, ifCompliance=ifCompliance, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutQLen=ifOutQLen, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifStackGroup2=ifStackGroup2, linkUp=linkUp, ifInNUcastPkts=ifInNUcastPkts, ifXEntry=ifXEntry, ifInUnknownProtos=ifInUnknownProtos, ifStackLowerLayer=ifStackLowerLayer, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInOctets=ifInOctets, ifPacketGroup=ifPacketGroup, ifInDiscards=ifInDiscards, ifEntry=ifEntry, ifHCPacketGroup=ifHCPacketGroup, ifStackTable=ifStackTable, ifStackGroup=ifStackGroup, ifLastChange=ifLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifConformance=ifConformance, ifHCOutOctets=ifHCOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpecific=ifSpecific, ifStackStatus=ifStackStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifMIB=ifMIB, ifInUcastPkts=ifInUcastPkts, ifName=ifName, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifTestResult=ifTestResult, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifTestType=ifTestType, ifRcvAddressAddress=ifRcvAddressAddress, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifNumber=ifNumber, ifCompliance2=ifCompliance2, ifRcvAddressType=ifRcvAddressType, ifMtu=ifMtu, ifVHCPacketGroup=ifVHCPacketGroup, ifAlias=ifAlias, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifAdminStatus=ifAdminStatus, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, ifTestGroup=ifTestGroup, ifOperStatus=ifOperStatus, ifType=ifType)
