...
iso, TimeTicks, ObjectIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Unsigned32, Counter64, mib_2, Gauge32, NotificationType, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Unsigned32", "Counter64", "mib-2", "Gauge32", "NotificationType", "MibIdentifier", "Integer32")
TestAndIncr, TruthValue, TimeStamp, PhysAddress, DisplayString, RowStatus, AutonomousType, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "TimeStamp", "PhysAddress", "DisplayString", "RowStatus", "AutonomousType", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance=ifCompliance, ifStackLowerLayer=ifStackLowerLayer, ifName=ifName, ifCompliance2=ifCompliance2, ifStackGroup=ifStackGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUp=linkUp, ifTestGroup=ifTestGroup, ifLastChange=ifLastChange, ifInNUcastPkts=ifInNUcastPkts, ifTestEntry=ifTestEntry, ifIndex=ifIndex, ifOutQLen=ifOutQLen, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackEntry=ifStackEntry, ifOutOctets=ifOutOctets, ifDescr=ifDescr, ifTestResult=ifTestResult, ifPacketGroup=ifPacketGroup, ifConformance=ifConformance, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, interfaces=interfaces, ifStackGroup2=ifStackGroup2, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkDown=linkDown, ifCompliance3=ifCompliance3, ifCompliances=ifCompliances, ifType=ifType, ifVHCPacketGroup=ifVHCPacketGroup, ifTestId=ifTestId, ifXTable=ifXTable, ifStackTable=ifStackTable, ifPromiscuousMode=ifPromiscuousMode, ifAdminStatus=ifAdminStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLastChange=ifStackLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifInMulticastPkts=ifInMulticastPkts, ifHCInOctets=ifHCInOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifAlias=ifAlias, ifMIB=ifMIB, OwnerString=OwnerString, ifTestType=ifTestType, ifOutDiscards=ifOutDiscards, ifInErrors=ifInErrors, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInUcastPkts=ifHCInUcastPkts, ifInDiscards=ifInDiscards, ifInUcastPkts=ifInUcastPkts, ifTestTable=ifTestTable, ifStackStatus=ifStackStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifOperStatus=ifOperStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestStatus=ifTestStatus, ifOutErrors=ifOutErrors, ifNumber=ifNumber, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressType=ifRcvAddressType, ifHCPacketGroup=ifHCPacketGroup, ifGeneralGroup=ifGeneralGroup, ifMtu=ifMtu, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifEntry=ifEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestOwner=ifTestOwner, ifRcvAddressStatus=ifRcvAddressStatus, ifTableLastChange=ifTableLastChange, PYSNMP_MODULE_ID=ifMIB, ifHCOutOctets=ifHCOutOctets, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifSpeed=ifSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifGroups=ifGroups, ifInOctets=ifInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup)
