...
Integer32, iso, Bits, Counter32, MibIdentifier, ModuleIdentity, IpAddress, Gauge32, NotificationType, mib_2, Unsigned32, ObjectIdentity, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Bits", "Counter32", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32", "NotificationType", "mib-2", "Unsigned32", "ObjectIdentity", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, TruthValue, TestAndIncr, AutonomousType, TimeStamp, PhysAddress, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TruthValue", "TestAndIncr", "AutonomousType", "TimeStamp", "PhysAddress", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", linkUp=linkUp, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPromiscuousMode=ifPromiscuousMode, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifStackHigherLayer=ifStackHigherLayer, ifCompliances=ifCompliances, ifLastChange=ifLastChange, ifHCInOctets=ifHCInOctets, ifConnectorPresent=ifConnectorPresent, ifCompliance2=ifCompliance2, linkDown=linkDown, ifStackTable=ifStackTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifXEntry=ifXEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, ifCompliance=ifCompliance, ifTestCode=ifTestCode, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifInNUcastPkts=ifInNUcastPkts, ifName=ifName, ifTable=ifTable, ifStackEntry=ifStackEntry, ifOutOctets=ifOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifOutQLen=ifOutQLen, ifSpecific=ifSpecific, InterfaceIndexOrZero=InterfaceIndexOrZero, ifSpeed=ifSpeed, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInErrors=ifInErrors, interfaces=interfaces, ifEntry=ifEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXTable=ifXTable, ifOperStatus=ifOperStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifConformance=ifConformance, ifType=ifType, ifOutErrors=ifOutErrors, InterfaceIndex=InterfaceIndex, ifPacketGroup=ifPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifMIB=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifIndex=ifIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, ifInBroadcastPkts=ifInBroadcastPkts, ifAdminStatus=ifAdminStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestType=ifTestType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifTestTable=ifTestTable, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifAlias=ifAlias, ifOldObjectsGroup=ifOldObjectsGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackGroup=ifStackGroup, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestResult=ifTestResult, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressAddress=ifRcvAddressAddress, ifStackLastChange=ifStackLastChange, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutNUcastPkts=ifOutNUcastPkts, ifInOctets=ifInOctets, ifHCOutOctets=ifHCOutOctets, ifTestEntry=ifTestEntry, ifMtu=ifMtu, ifStackLowerLayer=ifStackLowerLayer)
