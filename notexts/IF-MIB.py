...
PhysAddress, AutonomousType, TextualConvention, TruthValue, RowStatus, TestAndIncr, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "AutonomousType", "TextualConvention", "TruthValue", "RowStatus", "TestAndIncr", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifInNUcastPkts=ifInNUcastPkts, ifOutDiscards=ifOutDiscards, ifTestStatus=ifTestStatus, ifOutUcastPkts=ifOutUcastPkts, linkUp=linkUp, ifInMulticastPkts=ifInMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifConnectorPresent=ifConnectorPresent, ifStackGroup2=ifStackGroup2, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInOctets=ifInOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifGroups=ifGroups, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestOwner=ifTestOwner, ifTestEntry=ifTestEntry, ifHCOutOctets=ifHCOutOctets, ifRcvAddressType=ifRcvAddressType, ifOutQLen=ifOutQLen, ifTestType=ifTestType, ifSpecific=ifSpecific, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifNumber=ifNumber, ifAlias=ifAlias, ifRcvAddressAddress=ifRcvAddressAddress, ifStackTable=ifStackTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifName=ifName, ifInErrors=ifInErrors, ifMtu=ifMtu, ifTestId=ifTestId, ifPacketGroup=ifPacketGroup, ifLastChange=ifLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIB=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInDiscards=ifInDiscards, ifIndex=ifIndex, ifStackGroup=ifStackGroup, ifEntry=ifEntry, ifAdminStatus=ifAdminStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifTable=ifTable, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifHighSpeed=ifHighSpeed, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifMIBObjects=ifMIBObjects, ifTableLastChange=ifTableLastChange, ifXEntry=ifXEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifSpeed=ifSpeed, ifInUnknownProtos=ifInUnknownProtos, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifStackEntry=ifStackEntry, linkDown=linkDown, ifType=ifType, ifCompliances=ifCompliances, InterfaceIndex=InterfaceIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifDescr=ifDescr, ifStackLastChange=ifStackLastChange, ifOutErrors=ifOutErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, ifOperStatus=ifOperStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInOctets=ifHCInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifConformance=ifConformance, ifRcvAddressTable=ifRcvAddressTable, OwnerString=OwnerString, ifInUcastPkts=ifInUcastPkts, ifTestCode=ifTestCode, ifStackStatus=ifStackStatus, ifXTable=ifXTable, ifTestResult=ifTestResult, ifCompliance3=ifCompliance3, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode)
