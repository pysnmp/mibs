...
ModuleIdentity, ObjectIdentity, mib_2, Integer32, TimeTicks, iso, Counter32, MibIdentifier, Bits, Gauge32, NotificationType, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "mib-2", "Integer32", "TimeTicks", "iso", "Counter32", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
DisplayString, AutonomousType, TimeStamp, PhysAddress, TextualConvention, RowStatus, TruthValue, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TimeStamp", "PhysAddress", "TextualConvention", "RowStatus", "TruthValue", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTestId=ifTestId, ifHCOutOctets=ifHCOutOctets, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTable=ifTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutUcastPkts=ifOutUcastPkts, ifOutDiscards=ifOutDiscards, ifGroups=ifGroups, ifTestGroup=ifTestGroup, ifCompliance3=ifCompliance3, ifAlias=ifAlias, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifInUcastPkts=ifInUcastPkts, ifStackGroup=ifStackGroup, ifInErrors=ifInErrors, ifTestOwner=ifTestOwner, ifTestStatus=ifTestStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifOutOctets=ifOutOctets, PYSNMP_MODULE_ID=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifGeneralGroup=ifGeneralGroup, ifPhysAddress=ifPhysAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifConformance=ifConformance, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifInUnknownProtos=ifInUnknownProtos, ifInNUcastPkts=ifInNUcastPkts, ifInOctets=ifInOctets, ifMIB=ifMIB, ifTableLastChange=ifTableLastChange, ifTestEntry=ifTestEntry, ifTestType=ifTestType, ifRcvAddressTable=ifRcvAddressTable, ifTestResult=ifTestResult, ifIndex=ifIndex, ifType=ifType, ifInMulticastPkts=ifInMulticastPkts, ifInDiscards=ifInDiscards, ifStackLastChange=ifStackLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifLastChange=ifLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifMtu=ifMtu, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPacketGroup=ifPacketGroup, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifVHCPacketGroup=ifVHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifRcvAddressStatus=ifRcvAddressStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifOutQLen=ifOutQLen, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifXEntry=ifXEntry, ifCompliance2=ifCompliance2, ifNumber=ifNumber, ifStackStatus=ifStackStatus, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifTestTable=ifTestTable, ifName=ifName, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInOctets=ifHCInOctets, ifStackLowerLayer=ifStackLowerLayer, ifCompliances=ifCompliances, ifStackHigherLayer=ifStackHigherLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, interfaces=interfaces, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance=ifCompliance, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, OwnerString=OwnerString, ifDescr=ifDescr, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress)
