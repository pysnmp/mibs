...
Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Integer32, ObjectIdentity, Counter32, Unsigned32, mib_2, MibIdentifier, NotificationType, iso, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Integer32", "ObjectIdentity", "Counter32", "Unsigned32", "mib-2", "MibIdentifier", "NotificationType", "iso", "IpAddress", "ModuleIdentity")
TextualConvention, PhysAddress, TruthValue, AutonomousType, DisplayString, TestAndIncr, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "TruthValue", "AutonomousType", "DisplayString", "TestAndIncr", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressEntry=ifRcvAddressEntry, PYSNMP_MODULE_ID=ifMIB, ifTestCode=ifTestCode, ifRcvAddressType=ifRcvAddressType, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOperStatus=ifOperStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackEntry=ifStackEntry, ifXEntry=ifXEntry, ifStackGroup2=ifStackGroup2, ifRcvAddressAddress=ifRcvAddressAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifCompliance2=ifCompliance2, ifOutOctets=ifOutOctets, ifInDiscards=ifInDiscards, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, linkUp=linkUp, ifOutQLen=ifOutQLen, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifPhysAddress=ifPhysAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifTableLastChange=ifTableLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifEntry=ifEntry, ifInMulticastPkts=ifInMulticastPkts, ifTable=ifTable, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCompliance3=ifCompliance3, ifInErrors=ifInErrors, interfaces=interfaces, ifConnectorPresent=ifConnectorPresent, ifStackHigherLayer=ifStackHigherLayer, ifSpeed=ifSpeed, ifHighSpeed=ifHighSpeed, ifStackStatus=ifStackStatus, ifTestEntry=ifTestEntry, ifTestGroup=ifTestGroup, ifDescr=ifDescr, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInOctets=ifInOctets, ifOutDiscards=ifOutDiscards, OwnerString=OwnerString, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifTestType=ifTestType, ifStackLastChange=ifStackLastChange, ifPromiscuousMode=ifPromiscuousMode, ifAdminStatus=ifAdminStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, ifSpecific=ifSpecific, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifCompliance=ifCompliance, ifConformance=ifConformance, ifIndex=ifIndex, ifTestResult=ifTestResult, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutErrors=ifOutErrors, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifType=ifType, ifTestOwner=ifTestOwner, ifStackGroup=ifStackGroup, ifTestTable=ifTestTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIB=ifMIB, ifAlias=ifAlias, ifGeneralGroup=ifGeneralGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifMIBObjects=ifMIBObjects, ifHCInOctets=ifHCInOctets, ifHCOutOctets=ifHCOutOctets, ifRcvAddressTable=ifRcvAddressTable, linkDown=linkDown, ifFixedLengthGroup=ifFixedLengthGroup, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifGroups=ifGroups, ifNumber=ifNumber)
