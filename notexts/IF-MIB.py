...
TruthValue, PhysAddress, DisplayString, AutonomousType, RowStatus, TestAndIncr, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "PhysAddress", "DisplayString", "AutonomousType", "RowStatus", "TestAndIncr", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifInUcastPkts=ifInUcastPkts, ifInDiscards=ifInDiscards, ifType=ifType, ifInMulticastPkts=ifInMulticastPkts, ifEntry=ifEntry, ifRcvAddressType=ifRcvAddressType, ifXTable=ifXTable, ifCompliance=ifCompliance, ifIndex=ifIndex, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndex=InterfaceIndex, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifTestGroup=ifTestGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifGroups=ifGroups, ifRcvAddressTable=ifRcvAddressTable, ifPromiscuousMode=ifPromiscuousMode, ifSpeed=ifSpeed, ifTestResult=ifTestResult, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifFixedLengthGroup=ifFixedLengthGroup, ifStackStatus=ifStackStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestOwner=ifTestOwner, ifTableLastChange=ifTableLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestStatus=ifTestStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutErrors=ifOutErrors, ifPacketGroup=ifPacketGroup, ifOperStatus=ifOperStatus, PYSNMP_MODULE_ID=ifMIB, ifTestTable=ifTestTable, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifConformance=ifConformance, ifHCInOctets=ifHCInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, interfaces=interfaces, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifStackGroup=ifStackGroup, ifTestType=ifTestType, ifConnectorPresent=ifConnectorPresent, ifGeneralGroup=ifGeneralGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLastChange=ifStackLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAlias=ifAlias, ifNumber=ifNumber, ifInNUcastPkts=ifInNUcastPkts, ifInErrors=ifInErrors, ifRcvAddressAddress=ifRcvAddressAddress, ifTestId=ifTestId, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, linkDown=linkDown, ifMIB=ifMIB, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, linkUp=linkUp, ifTestCode=ifTestCode, ifStackGroup2=ifStackGroup2, ifXEntry=ifXEntry, ifStackHigherLayer=ifStackHigherLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifMtu=ifMtu, ifCompliance3=ifCompliance3, ifOutNUcastPkts=ifOutNUcastPkts, ifSpecific=ifSpecific, ifRcvAddressEntry=ifRcvAddressEntry, ifPhysAddress=ifPhysAddress, ifDescr=ifDescr, ifOutDiscards=ifOutDiscards, ifOutQLen=ifOutQLen, ifStackTable=ifStackTable, OwnerString=OwnerString)
