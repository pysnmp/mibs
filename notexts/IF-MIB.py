...
TestAndIncr, TextualConvention, TimeStamp, PhysAddress, TruthValue, AutonomousType, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "TimeStamp", "PhysAddress", "TruthValue", "AutonomousType", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifTestOwner=ifTestOwner, ifGeneralInformationGroup=ifGeneralInformationGroup, PYSNMP_MODULE_ID=ifMIB, ifGeneralGroup=ifGeneralGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliances=ifCompliances, linkUp=linkUp, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifOutOctets=ifOutOctets, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, ifSpecific=ifSpecific, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifTestResult=ifTestResult, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifTable=ifTable, interfaces=interfaces, ifInOctets=ifInOctets, ifCompliance=ifCompliance, ifTestTable=ifTestTable, ifHCOutOctets=ifHCOutOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInOctets=ifHCInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressType=ifRcvAddressType, ifStackGroup=ifStackGroup, ifOutUcastPkts=ifOutUcastPkts, ifAdminStatus=ifAdminStatus, ifTableLastChange=ifTableLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifPacketGroup=ifPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifTestStatus=ifTestStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInUnknownProtos=ifInUnknownProtos, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifEntry=ifEntry, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, OwnerString=OwnerString, ifHighSpeed=ifHighSpeed, ifHCInUcastPkts=ifHCInUcastPkts, InterfaceIndex=InterfaceIndex, ifMIB=ifMIB, ifConformance=ifConformance, ifPhysAddress=ifPhysAddress, ifCompliance3=ifCompliance3, ifNumber=ifNumber, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifInBroadcastPkts=ifInBroadcastPkts, ifInErrors=ifInErrors, ifMtu=ifMtu, ifCompliance2=ifCompliance2, linkDown=linkDown, ifLastChange=ifLastChange, ifMIBObjects=ifMIBObjects, ifRcvAddressGroup=ifRcvAddressGroup, ifStackGroup2=ifStackGroup2, ifName=ifName, ifAlias=ifAlias, ifDescr=ifDescr, ifInDiscards=ifInDiscards, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGroups=ifGroups, ifXTable=ifXTable, ifTestType=ifTestType, ifVHCPacketGroup=ifVHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifTestId=ifTestId, ifHCPacketGroup=ifHCPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifStackStatus=ifStackStatus, ifTestGroup=ifTestGroup, ifOperStatus=ifOperStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackEntry=ifStackEntry)
