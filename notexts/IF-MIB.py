...
TextualConvention, DisplayString, PhysAddress, AutonomousType, TruthValue, TestAndIncr, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "PhysAddress", "AutonomousType", "TruthValue", "TestAndIncr", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance=ifCompliance, ifName=ifName, ifStackHigherLayer=ifStackHigherLayer, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIBObjects=ifMIBObjects, ifTableLastChange=ifTableLastChange, ifGeneralGroup=ifGeneralGroup, ifHCPacketGroup=ifHCPacketGroup, ifEntry=ifEntry, ifInOctets=ifInOctets, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifInDiscards=ifInDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMIB=ifMIB, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifTestTable=ifTestTable, ifTestId=ifTestId, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, ifOutUcastPkts=ifOutUcastPkts, ifCompliances=ifCompliances, ifInNUcastPkts=ifInNUcastPkts, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUnknownProtos=ifInUnknownProtos, ifAdminStatus=ifAdminStatus, ifTestResult=ifTestResult, ifInMulticastPkts=ifInMulticastPkts, InterfaceIndex=InterfaceIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifMtu=ifMtu, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, ifCompliance3=ifCompliance3, PYSNMP_MODULE_ID=ifMIB, linkDown=linkDown, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifConformance=ifConformance, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, ifOutOctets=ifOutOctets, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifVHCPacketGroup=ifVHCPacketGroup, ifTestGroup=ifTestGroup, ifCompliance2=ifCompliance2, ifTable=ifTable, ifOutErrors=ifOutErrors, ifStackTable=ifStackTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifGroups=ifGroups, ifPhysAddress=ifPhysAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHighSpeed=ifHighSpeed, ifRcvAddressType=ifRcvAddressType, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, ifXTable=ifXTable, ifTestEntry=ifTestEntry, ifNumber=ifNumber, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOldObjectsGroup=ifOldObjectsGroup, ifPacketGroup=ifPacketGroup, ifSpecific=ifSpecific, ifHCInOctets=ifHCInOctets, interfaces=interfaces, ifHCOutOctets=ifHCOutOctets, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifStackLastChange=ifStackLastChange, ifLastChange=ifLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestStatus=ifTestStatus, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry)
