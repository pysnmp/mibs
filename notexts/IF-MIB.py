...
TruthValue, TimeStamp, TextualConvention, TestAndIncr, PhysAddress, RowStatus, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "TestAndIncr", "PhysAddress", "RowStatus", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressStatus=ifRcvAddressStatus, ifAlias=ifAlias, ifHCInOctets=ifHCInOctets, ifGeneralGroup=ifGeneralGroup, ifCompliance3=ifCompliance3, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifOutQLen=ifOutQLen, interfaces=interfaces, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkUp=linkUp, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifGroups=ifGroups, ifMtu=ifMtu, ifNumber=ifNumber, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliances=ifCompliances, ifRcvAddressEntry=ifRcvAddressEntry, ifTestGroup=ifTestGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTestId=ifTestId, ifSpeed=ifSpeed, ifIndex=ifIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifEntry=ifEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifCompliance=ifCompliance, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLastChange=ifStackLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifLastChange=ifLastChange, PYSNMP_MODULE_ID=ifMIB, ifXTable=ifXTable, ifTestEntry=ifTestEntry, ifInNUcastPkts=ifInNUcastPkts, ifOutUcastPkts=ifOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInErrors=ifInErrors, ifMIBObjects=ifMIBObjects, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifName=ifName, ifFixedLengthGroup=ifFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAdminStatus=ifAdminStatus, ifStackEntry=ifStackEntry, OwnerString=OwnerString, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackHigherLayer=ifStackHigherLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifTable=ifTable, ifOperStatus=ifOperStatus, ifDescr=ifDescr, ifInOctets=ifInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifConnectorPresent=ifConnectorPresent, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndex=InterfaceIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance2=ifCompliance2, ifStackTable=ifStackTable, linkDown=linkDown, ifSpecific=ifSpecific, ifPhysAddress=ifPhysAddress, ifTestOwner=ifTestOwner, ifOutDiscards=ifOutDiscards, ifOutErrors=ifOutErrors, ifXEntry=ifXEntry, ifInUnknownProtos=ifInUnknownProtos, ifTestResult=ifTestResult, ifTestType=ifTestType, ifOutMulticastPkts=ifOutMulticastPkts, ifTestCode=ifTestCode, ifRcvAddressTable=ifRcvAddressTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestTable=ifTestTable, ifConformance=ifConformance, ifStackGroup=ifStackGroup, ifMIB=ifMIB, ifHighSpeed=ifHighSpeed, ifOutOctets=ifOutOctets, ifInDiscards=ifInDiscards, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType)
