...
TruthValue, TimeStamp, TestAndIncr, TextualConvention, AutonomousType, PhysAddress, DisplayString, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TestAndIncr", "TextualConvention", "AutonomousType", "PhysAddress", "DisplayString", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifTestTable=ifTestTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifRcvAddressType=ifRcvAddressType, ifAlias=ifAlias, ifSpeed=ifSpeed, ifStackStatus=ifStackStatus, linkUp=linkUp, ifStackHigherLayer=ifStackHigherLayer, ifOutQLen=ifOutQLen, ifTestStatus=ifTestStatus, OwnerString=OwnerString, ifCompliance=ifCompliance, ifInUcastPkts=ifInUcastPkts, ifIndex=ifIndex, ifConnectorPresent=ifConnectorPresent, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup=ifStackGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifTestGroup=ifTestGroup, ifLastChange=ifLastChange, ifStackEntry=ifStackEntry, ifHighSpeed=ifHighSpeed, ifMIB=ifMIB, ifCompliance3=ifCompliance3, ifMtu=ifMtu, ifHCOutOctets=ifHCOutOctets, ifStackLastChange=ifStackLastChange, ifFixedLengthGroup=ifFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralGroup=ifGeneralGroup, ifXEntry=ifXEntry, ifTestType=ifTestType, ifStackGroup2=ifStackGroup2, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifGeneralInformationGroup=ifGeneralInformationGroup, ifAdminStatus=ifAdminStatus, ifType=ifType, ifRcvAddressTable=ifRcvAddressTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestCode=ifTestCode, ifName=ifName, ifInOctets=ifInOctets, ifOutOctets=ifOutOctets, interfaces=interfaces, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifXTable=ifXTable, ifInDiscards=ifInDiscards, ifRcvAddressEntry=ifRcvAddressEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackLowerLayer=ifStackLowerLayer, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInMulticastPkts=ifInMulticastPkts, InterfaceIndex=InterfaceIndex, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressStatus=ifRcvAddressStatus, linkDown=linkDown, ifHCInOctets=ifHCInOctets, ifTable=ifTable, ifTableLastChange=ifTableLastChange, ifDescr=ifDescr, ifTestEntry=ifTestEntry, ifNumber=ifNumber, ifConformance=ifConformance, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInErrors=ifInErrors, ifTestId=ifTestId, ifInNUcastPkts=ifInNUcastPkts, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOperStatus=ifOperStatus, ifHCPacketGroup=ifHCPacketGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInBroadcastPkts=ifInBroadcastPkts, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifOutErrors=ifOutErrors, ifOutUcastPkts=ifOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliances=ifCompliances, ifOldObjectsGroup=ifOldObjectsGroup)
