...
TimeStamp, RowStatus, TestAndIncr, TextualConvention, TruthValue, PhysAddress, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TestAndIncr", "TextualConvention", "TruthValue", "PhysAddress", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifStackHigherLayer=ifStackHigherLayer, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, ifStackLastChange=ifStackLastChange, ifCompliances=ifCompliances, ifXTable=ifXTable, ifPacketGroup=ifPacketGroup, ifStackGroup=ifStackGroup, ifInNUcastPkts=ifInNUcastPkts, ifDescr=ifDescr, ifTestEntry=ifTestEntry, linkDown=linkDown, ifOutUcastPkts=ifOutUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifAlias=ifAlias, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXEntry=ifXEntry, ifGroups=ifGroups, ifVHCPacketGroup=ifVHCPacketGroup, ifPhysAddress=ifPhysAddress, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, linkUp=linkUp, ifStackGroup2=ifStackGroup2, ifAdminStatus=ifAdminStatus, ifStackLowerLayer=ifStackLowerLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, interfaces=interfaces, ifSpecific=ifSpecific, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifEntry=ifEntry, ifTestTable=ifTestTable, ifRcvAddressType=ifRcvAddressType, ifTestGroup=ifTestGroup, ifTestType=ifTestType, ifGeneralGroup=ifGeneralGroup, ifInErrors=ifInErrors, ifStackStatus=ifStackStatus, ifCompliance2=ifCompliance2, ifTestStatus=ifTestStatus, ifNumber=ifNumber, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifOutErrors=ifOutErrors, ifCompliance=ifCompliance, ifTestOwner=ifTestOwner, ifRcvAddressAddress=ifRcvAddressAddress, OwnerString=OwnerString, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifMIBObjects=ifMIBObjects, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestCode=ifTestCode, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifName=ifName, ifHighSpeed=ifHighSpeed, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifConnectorPresent=ifConnectorPresent, ifInOctets=ifInOctets, ifTestResult=ifTestResult, ifRcvAddressStatus=ifRcvAddressStatus, ifOutQLen=ifOutQLen, ifInMulticastPkts=ifInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTable=ifTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutOctets=ifHCOutOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOperStatus=ifOperStatus, PYSNMP_MODULE_ID=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifIndex=ifIndex, ifLastChange=ifLastChange, ifSpeed=ifSpeed, InterfaceIndex=InterfaceIndex, ifMtu=ifMtu, ifOutMulticastPkts=ifOutMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifStackEntry=ifStackEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts)
