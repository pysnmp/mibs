...
TestAndIncr, DisplayString, TruthValue, PhysAddress, AutonomousType, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TruthValue", "PhysAddress", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInOctets=ifHCInOctets, ifTableLastChange=ifTableLastChange, ifTestCode=ifTestCode, ifOutMulticastPkts=ifOutMulticastPkts, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifGroups=ifGroups, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifMIB=ifMIB, interfaces=interfaces, ifInErrors=ifInErrors, ifTestTable=ifTestTable, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifStackGroup=ifStackGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifStackLowerLayer=ifStackLowerLayer, ifPromiscuousMode=ifPromiscuousMode, ifOldObjectsGroup=ifOldObjectsGroup, ifDescr=ifDescr, ifTestStatus=ifTestStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, linkDown=linkDown, ifStackLastChange=ifStackLastChange, PYSNMP_MODULE_ID=ifMIB, ifStackTable=ifStackTable, ifStackStatus=ifStackStatus, ifIndex=ifIndex, ifInOctets=ifInOctets, ifConformance=ifConformance, ifCompliances=ifCompliances, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifSpecific=ifSpecific, ifOutNUcastPkts=ifOutNUcastPkts, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifTestGroup=ifTestGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackHigherLayer=ifStackHigherLayer, ifPhysAddress=ifPhysAddress, ifOutUcastPkts=ifOutUcastPkts, ifType=ifType, OwnerString=OwnerString, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifName=ifName, ifTable=ifTable, ifTestResult=ifTestResult, ifXEntry=ifXEntry, ifEntry=ifEntry, ifLastChange=ifLastChange, ifCompliance2=ifCompliance2, ifXTable=ifXTable, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifHCOutUcastPkts=ifHCOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, ifHighSpeed=ifHighSpeed, ifAdminStatus=ifAdminStatus, ifNumber=ifNumber, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutQLen=ifOutQLen, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralGroup=ifGeneralGroup, ifOutDiscards=ifOutDiscards, ifInUnknownProtos=ifInUnknownProtos, ifInUcastPkts=ifInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, ifInNUcastPkts=ifInNUcastPkts)
