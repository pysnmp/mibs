...
MibIdentifier, IpAddress, Integer32, Counter32, mib_2, Gauge32, iso, Bits, Unsigned32, ModuleIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Integer32", "Counter32", "mib-2", "Gauge32", "iso", "Bits", "Unsigned32", "ModuleIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
TextualConvention, TimeStamp, TestAndIncr, TruthValue, AutonomousType, DisplayString, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TimeStamp", "TestAndIncr", "TruthValue", "AutonomousType", "DisplayString", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifOutQLen=ifOutQLen, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutOctets=ifHCOutOctets, ifAdminStatus=ifAdminStatus, ifSpeed=ifSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkDown=linkDown, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifRcvAddressGroup=ifRcvAddressGroup, ifOutErrors=ifOutErrors, ifTestTable=ifTestTable, ifStackLowerLayer=ifStackLowerLayer, ifConnectorPresent=ifConnectorPresent, OwnerString=OwnerString, ifStackEntry=ifStackEntry, ifMIB=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifXTable=ifXTable, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifName=ifName, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifTestCode=ifTestCode, ifStackGroup=ifStackGroup, ifOperStatus=ifOperStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifEntry=ifEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralGroup=ifGeneralGroup, ifTestResult=ifTestResult, ifDescr=ifDescr, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestStatus=ifTestStatus, ifCompliance2=ifCompliance2, ifStackStatus=ifStackStatus, ifType=ifType, ifTestGroup=ifTestGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifRcvAddressType=ifRcvAddressType, ifOutUcastPkts=ifOutUcastPkts, ifStackLastChange=ifStackLastChange, ifPacketGroup=ifPacketGroup, interfaces=interfaces, ifStackTable=ifStackTable, ifIndex=ifIndex, ifMIBObjects=ifMIBObjects, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliances=ifCompliances, ifMtu=ifMtu, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, InterfaceIndex=InterfaceIndex, ifOutOctets=ifOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, linkUp=linkUp, ifTestOwner=ifTestOwner, ifTable=ifTable, ifTestId=ifTestId, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifHCInOctets=ifHCInOctets, ifInErrors=ifInErrors, ifPromiscuousMode=ifPromiscuousMode, ifOldObjectsGroup=ifOldObjectsGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifConformance=ifConformance, ifHCInUcastPkts=ifHCInUcastPkts, ifXEntry=ifXEntry, ifPhysAddress=ifPhysAddress, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifOutBroadcastPkts=ifOutBroadcastPkts)
