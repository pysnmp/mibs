...
Bits, Counter64, ObjectIdentity, NotificationType, Counter32, iso, Unsigned32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, mib_2, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "ObjectIdentity", "NotificationType", "Counter32", "iso", "Unsigned32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "mib-2", "MibIdentifier", "TimeTicks")
TruthValue, TimeStamp, TextualConvention, DisplayString, PhysAddress, RowStatus, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "TextualConvention", "DisplayString", "PhysAddress", "RowStatus", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifStackHigherLayer=ifStackHigherLayer, ifXEntry=ifXEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, OwnerString=OwnerString, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifIndex=ifIndex, ifTestResult=ifTestResult, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifTableLastChange=ifTableLastChange, ifXTable=ifXTable, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliance2=ifCompliance2, ifInBroadcastPkts=ifInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestCode=ifTestCode, ifGeneralGroup=ifGeneralGroup, ifDescr=ifDescr, interfaces=interfaces, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifType=ifType, ifCompliance3=ifCompliance3, ifStackGroup2=ifStackGroup2, ifTestStatus=ifTestStatus, linkDown=linkDown, ifEntry=ifEntry, ifMIB=ifMIB, ifOutErrors=ifOutErrors, ifStackTable=ifStackTable, ifTestOwner=ifTestOwner, ifStackStatus=ifStackStatus, ifSpecific=ifSpecific, ifPhysAddress=ifPhysAddress, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLastChange=ifLastChange, ifConnectorPresent=ifConnectorPresent, ifRcvAddressTable=ifRcvAddressTable, ifInMulticastPkts=ifInMulticastPkts, ifStackLastChange=ifStackLastChange, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTable=ifTable, linkUp=linkUp, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInErrors=ifInErrors, ifNumber=ifNumber, ifMtu=ifMtu, ifOperStatus=ifOperStatus, ifGroups=ifGroups, PYSNMP_MODULE_ID=ifMIB, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifHighSpeed=ifHighSpeed, ifTestTable=ifTestTable, ifOutNUcastPkts=ifOutNUcastPkts, ifInOctets=ifInOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutQLen=ifOutQLen, ifHCOutOctets=ifHCOutOctets, ifHCInOctets=ifHCInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifPacketGroup=ifPacketGroup, ifTestType=ifTestType, ifSpeed=ifSpeed, InterfaceIndex=InterfaceIndex, ifOutBroadcastPkts=ifOutBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInUcastPkts=ifInUcastPkts, ifAdminStatus=ifAdminStatus, ifOutDiscards=ifOutDiscards, ifMIBObjects=ifMIBObjects, ifStackEntry=ifStackEntry, ifRcvAddressType=ifRcvAddressType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifConformance=ifConformance, ifInDiscards=ifInDiscards, ifStackGroup=ifStackGroup, ifTestEntry=ifTestEntry, ifCompliance=ifCompliance, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime)
