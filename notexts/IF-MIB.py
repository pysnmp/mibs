...
mib_2, Gauge32, Counter64, ModuleIdentity, ObjectIdentity, Counter32, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, TimeTicks, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity", "Counter32", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "TimeTicks", "Bits", "NotificationType")
TestAndIncr, DisplayString, TruthValue, TimeStamp, RowStatus, AutonomousType, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TruthValue", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifTestEntry=ifTestEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifOutDiscards=ifOutDiscards, ifGroups=ifGroups, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifHighSpeed=ifHighSpeed, ifOperStatus=ifOperStatus, ifStackStatus=ifStackStatus, InterfaceIndex=InterfaceIndex, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifDescr=ifDescr, ifTestTable=ifTestTable, ifOutMulticastPkts=ifOutMulticastPkts, ifInOctets=ifInOctets, ifRcvAddressTable=ifRcvAddressTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifConnectorPresent=ifConnectorPresent, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifFixedLengthGroup=ifFixedLengthGroup, ifStackTable=ifStackTable, ifConformance=ifConformance, ifEntry=ifEntry, ifStackLastChange=ifStackLastChange, ifTestOwner=ifTestOwner, ifTable=ifTable, ifStackGroup2=ifStackGroup2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifInNUcastPkts=ifInNUcastPkts, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifType=ifType, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifXTable=ifXTable, linkDown=linkDown, ifHCOutOctets=ifHCOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifInUcastPkts=ifInUcastPkts, ifTestType=ifTestType, ifSpecific=ifSpecific, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifTableLastChange=ifTableLastChange, ifTestGroup=ifTestGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInErrors=ifInErrors, ifPacketGroup=ifPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifMIB=ifMIB, PYSNMP_MODULE_ID=ifMIB, ifTestId=ifTestId, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressGroup=ifRcvAddressGroup, OwnerString=OwnerString, ifOutOctets=ifOutOctets, ifAdminStatus=ifAdminStatus, ifSpeed=ifSpeed, interfaces=interfaces, ifRcvAddressType=ifRcvAddressType, ifOutNUcastPkts=ifOutNUcastPkts, ifName=ifName, ifStackEntry=ifStackEntry, ifPromiscuousMode=ifPromiscuousMode, ifHCOutUcastPkts=ifHCOutUcastPkts, ifNumber=ifNumber, ifOutUcastPkts=ifOutUcastPkts, ifTestResult=ifTestResult, ifOutErrors=ifOutErrors, ifTestCode=ifTestCode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCPacketGroup=ifHCPacketGroup, ifMIBObjects=ifMIBObjects, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, ifCompliance2=ifCompliance2, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, ifCompliance=ifCompliance)
