...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, mib_2, TimeTicks, ModuleIdentity, Counter32, IpAddress, Integer32, Bits, Unsigned32, Counter64, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "mib-2", "TimeTicks", "ModuleIdentity", "Counter32", "IpAddress", "Integer32", "Bits", "Unsigned32", "Counter64", "NotificationType", "ObjectIdentity")
RowStatus, TextualConvention, TruthValue, AutonomousType, DisplayString, TimeStamp, TestAndIncr, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "TestAndIncr", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifTestId=ifTestId, ifCompliance=ifCompliance, ifOldObjectsGroup=ifOldObjectsGroup, ifStackHigherLayer=ifStackHigherLayer, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifXEntry=ifXEntry, ifIndex=ifIndex, ifOutNUcastPkts=ifOutNUcastPkts, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifNumber=ifNumber, ifOutMulticastPkts=ifOutMulticastPkts, ifConformance=ifConformance, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifStackGroup=ifStackGroup, ifOutQLen=ifOutQLen, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestStatus=ifTestStatus, ifOutOctets=ifOutOctets, ifStackLastChange=ifStackLastChange, InterfaceIndex=InterfaceIndex, ifTestResult=ifTestResult, ifFixedLengthGroup=ifFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifCompliances=ifCompliances, ifSpeed=ifSpeed, ifCompliance3=ifCompliance3, ifTestEntry=ifTestEntry, ifPhysAddress=ifPhysAddress, ifTestOwner=ifTestOwner, ifStackStatus=ifStackStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifOutDiscards=ifOutDiscards, ifGroups=ifGroups, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInErrors=ifInErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCompliance2=ifCompliance2, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifMIBObjects=ifMIBObjects, ifLastChange=ifLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifStackLowerLayer=ifStackLowerLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifVHCPacketGroup=ifVHCPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTable=ifTable, ifPacketGroup=ifPacketGroup, ifTestTable=ifTestTable, ifOperStatus=ifOperStatus, ifXTable=ifXTable, ifType=ifType, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInOctets=ifInOctets, ifHCInOctets=ifHCInOctets, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressType=ifRcvAddressType, ifDescr=ifDescr, ifHCOutOctets=ifHCOutOctets, ifMtu=ifMtu, ifMIB=ifMIB, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifStackTable=ifStackTable, ifStackEntry=ifStackEntry, ifHighSpeed=ifHighSpeed, ifAlias=ifAlias, ifName=ifName, ifInUnknownProtos=ifInUnknownProtos, ifInMulticastPkts=ifInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifGeneralGroup=ifGeneralGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressEntry=ifRcvAddressEntry, linkDown=linkDown)
