...
DisplayString, TimeStamp, TestAndIncr, TextualConvention, TruthValue, AutonomousType, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TestAndIncr", "TextualConvention", "TruthValue", "AutonomousType", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestType=ifTestType, ifAdminStatus=ifAdminStatus, ifInUnknownProtos=ifInUnknownProtos, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestResult=ifTestResult, ifTable=ifTable, ifOutErrors=ifOutErrors, interfaces=interfaces, ifSpeed=ifSpeed, ifInDiscards=ifInDiscards, ifTestGroup=ifTestGroup, ifPacketGroup=ifPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifXTable=ifXTable, ifRcvAddressGroup=ifRcvAddressGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTestCode=ifTestCode, ifXEntry=ifXEntry, ifNumber=ifNumber, ifOutUcastPkts=ifOutUcastPkts, ifTestId=ifTestId, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIB=ifMIB, ifTestEntry=ifTestEntry, ifOperStatus=ifOperStatus, ifGroups=ifGroups, ifRcvAddressTable=ifRcvAddressTable, ifGeneralGroup=ifGeneralGroup, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifEntry=ifEntry, ifConformance=ifConformance, ifRcvAddressType=ifRcvAddressType, ifOutQLen=ifOutQLen, ifSpecific=ifSpecific, ifHCInOctets=ifHCInOctets, ifType=ifType, ifInErrors=ifInErrors, ifInNUcastPkts=ifInNUcastPkts, InterfaceIndex=InterfaceIndex, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifOutOctets=ifOutOctets, ifInUcastPkts=ifInUcastPkts, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestOwner=ifTestOwner, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup=ifStackGroup, linkDown=linkDown, ifTableLastChange=ifTableLastChange, ifStackEntry=ifStackEntry, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance=ifCompliance, ifCompliances=ifCompliances, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAlias=ifAlias, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackTable=ifStackTable, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressAddress=ifRcvAddressAddress, ifMtu=ifMtu, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, ifStackLastChange=ifStackLastChange, ifStackGroup2=ifStackGroup2, ifStackStatus=ifStackStatus, ifCompliance2=ifCompliance2, ifTestStatus=ifTestStatus, linkUp=linkUp, ifLastChange=ifLastChange, ifPhysAddress=ifPhysAddress, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifName=ifName)
