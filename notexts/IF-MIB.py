...
DisplayString, TextualConvention, TimeStamp, TruthValue, RowStatus, TestAndIncr, PhysAddress, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TimeStamp", "TruthValue", "RowStatus", "TestAndIncr", "PhysAddress", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConformance=ifConformance, ifMtu=ifMtu, ifOutMulticastPkts=ifOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTable=ifTable, ifOutErrors=ifOutErrors, ifXEntry=ifXEntry, ifTestStatus=ifTestStatus, ifInErrors=ifInErrors, ifHCInOctets=ifHCInOctets, ifStackEntry=ifStackEntry, ifType=ifType, ifFixedLengthGroup=ifFixedLengthGroup, ifLastChange=ifLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLastChange=ifStackLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifIndex=ifIndex, ifTestEntry=ifTestEntry, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifSpeed=ifSpeed, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifConnectorPresent=ifConnectorPresent, ifRcvAddressEntry=ifRcvAddressEntry, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifCompliance=ifCompliance, ifRcvAddressTable=ifRcvAddressTable, ifInDiscards=ifInDiscards, ifName=ifName, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHighSpeed=ifHighSpeed, ifGroups=ifGroups, ifInUcastPkts=ifInUcastPkts, ifAlias=ifAlias, InterfaceIndex=InterfaceIndex, ifHCOutOctets=ifHCOutOctets, interfaces=interfaces, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifTestType=ifTestType, ifMIBObjects=ifMIBObjects, ifCompliances=ifCompliances, linkUp=linkUp, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifPhysAddress=ifPhysAddress, PYSNMP_MODULE_ID=ifMIB, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifInUnknownProtos=ifInUnknownProtos, ifInOctets=ifInOctets, ifXTable=ifXTable, ifTestResult=ifTestResult, ifOutOctets=ifOutOctets, ifNumber=ifNumber, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance2=ifCompliance2, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, linkDown=linkDown, ifTestOwner=ifTestOwner, ifStackHigherLayer=ifStackHigherLayer, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestTable=ifTestTable, ifTestCode=ifTestCode, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackTable=ifStackTable, ifCompliance3=ifCompliance3, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifEntry=ifEntry, ifSpecific=ifSpecific, ifGeneralGroup=ifGeneralGroup, ifMIB=ifMIB, ifRcvAddressType=ifRcvAddressType)
