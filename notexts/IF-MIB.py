...
RowStatus, TimeStamp, TestAndIncr, PhysAddress, DisplayString, TextualConvention, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TestAndIncr", "PhysAddress", "DisplayString", "TextualConvention", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressGroup=ifRcvAddressGroup, linkUp=linkUp, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInUnknownProtos=ifInUnknownProtos, ifLastChange=ifLastChange, ifAlias=ifAlias, ifName=ifName, ifGroups=ifGroups, ifPacketGroup=ifPacketGroup, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifTestTable=ifTestTable, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressTable=ifRcvAddressTable, ifMIB=ifMIB, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestGroup=ifTestGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestCode=ifTestCode, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifTestId=ifTestId, ifGeneralInformationGroup=ifGeneralInformationGroup, ifType=ifType, ifTable=ifTable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifStackEntry=ifStackEntry, ifCompliance2=ifCompliance2, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, ifCompliance3=ifCompliance3, ifInOctets=ifInOctets, ifOutQLen=ifOutQLen, ifPhysAddress=ifPhysAddress, ifStackLastChange=ifStackLastChange, OwnerString=OwnerString, ifXTable=ifXTable, ifTableLastChange=ifTableLastChange, ifSpecific=ifSpecific, ifStackStatus=ifStackStatus, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInOctets=ifHCInOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifSpeed=ifSpeed, ifOutOctets=ifOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifInUcastPkts=ifInUcastPkts, InterfaceIndex=InterfaceIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifStackGroup2=ifStackGroup2, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifMIBObjects=ifMIBObjects, interfaces=interfaces, ifTestStatus=ifTestStatus, ifTestOwner=ifTestOwner, ifInNUcastPkts=ifInNUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutUcastPkts=ifOutUcastPkts, ifAdminStatus=ifAdminStatus, ifInBroadcastPkts=ifInBroadcastPkts, linkDown=linkDown, ifTestResult=ifTestResult, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackTable=ifStackTable, ifMtu=ifMtu, ifInErrors=ifInErrors, ifNumber=ifNumber, ifDescr=ifDescr, ifOutErrors=ifOutErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifConformance=ifConformance, ifHCPacketGroup=ifHCPacketGroup, ifIndex=ifIndex, ifGeneralGroup=ifGeneralGroup)
