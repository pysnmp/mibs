...
TimeStamp, PhysAddress, DisplayString, AutonomousType, TestAndIncr, TextualConvention, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "DisplayString", "AutonomousType", "TestAndIncr", "TextualConvention", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestTable=ifTestTable, ifStackGroup=ifStackGroup, linkUp=linkUp, ifSpeed=ifSpeed, ifHCPacketGroup=ifHCPacketGroup, ifTestResult=ifTestResult, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, ifStackLastChange=ifStackLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifInOctets=ifInOctets, ifTable=ifTable, ifCompliance3=ifCompliance3, ifTestStatus=ifTestStatus, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInErrors=ifInErrors, ifEntry=ifEntry, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifIndex=ifIndex, ifPhysAddress=ifPhysAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, ifNumber=ifNumber, ifStackEntry=ifStackEntry, ifStackStatus=ifStackStatus, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifOldObjectsGroup=ifOldObjectsGroup, ifTestOwner=ifTestOwner, ifLastChange=ifLastChange, ifMtu=ifMtu, ifDescr=ifDescr, ifXEntry=ifXEntry, ifOutQLen=ifOutQLen, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliances=ifCompliances, InterfaceIndex=InterfaceIndex, ifMIB=ifMIB, ifOutDiscards=ifOutDiscards, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAlias=ifAlias, ifGeneralGroup=ifGeneralGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifAdminStatus=ifAdminStatus, ifXTable=ifXTable, ifFixedLengthGroup=ifFixedLengthGroup, ifOperStatus=ifOperStatus, ifType=ifType, ifStackTable=ifStackTable, ifSpecific=ifSpecific, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, OwnerString=OwnerString, ifCompliance=ifCompliance, ifStackGroup2=ifStackGroup2, ifHCInOctets=ifHCInOctets, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifTestEntry=ifTestEntry, ifTableLastChange=ifTableLastChange, PYSNMP_MODULE_ID=ifMIB, ifHCOutOctets=ifHCOutOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestType=ifTestType, ifOutMulticastPkts=ifOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifRcvAddressAddress=ifRcvAddressAddress, ifInNUcastPkts=ifInNUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifRcvAddressType=ifRcvAddressType, ifTestCode=ifTestCode)
