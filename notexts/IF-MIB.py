...
Bits, MibIdentifier, Gauge32, ModuleIdentity, iso, Unsigned32, mib_2, IpAddress, Counter32, Integer32, TimeTicks, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Gauge32", "ModuleIdentity", "iso", "Unsigned32", "mib-2", "IpAddress", "Counter32", "Integer32", "TimeTicks", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
DisplayString, AutonomousType, PhysAddress, TimeStamp, TextualConvention, TruthValue, RowStatus, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "PhysAddress", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTestStatus=ifTestStatus, ifTestTable=ifTestTable, ifName=ifName, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance=ifCompliance, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifType=ifType, ifOutQLen=ifOutQLen, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, linkDown=linkDown, ifIndex=ifIndex, ifOutUcastPkts=ifOutUcastPkts, InterfaceIndex=InterfaceIndex, linkUp=linkUp, ifXEntry=ifXEntry, PYSNMP_MODULE_ID=ifMIB, ifGeneralGroup=ifGeneralGroup, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPacketGroup=ifPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackTable=ifStackTable, ifTableLastChange=ifTableLastChange, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTable=ifTable, ifOperStatus=ifOperStatus, ifTestGroup=ifTestGroup, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifEntry=ifEntry, ifCompliance2=ifCompliance2, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifTestResult=ifTestResult, ifStackEntry=ifStackEntry, ifTestOwner=ifTestOwner, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifOutOctets=ifOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifInUcastPkts=ifInUcastPkts, ifSpeed=ifSpeed, ifNumber=ifNumber, ifXTable=ifXTable, ifCompliance3=ifCompliance3, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackStatus=ifStackStatus, ifCompliances=ifCompliances, interfaces=interfaces, ifRcvAddressAddress=ifRcvAddressAddress, ifConformance=ifConformance, ifFixedLengthGroup=ifFixedLengthGroup, ifSpecific=ifSpecific, ifMIB=ifMIB, ifTestType=ifTestType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMtu=ifMtu, ifAlias=ifAlias, ifRcvAddressGroup=ifRcvAddressGroup, ifStackHigherLayer=ifStackHigherLayer, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifInNUcastPkts=ifInNUcastPkts, OwnerString=OwnerString, ifDescr=ifDescr, ifInErrors=ifInErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifInOctets=ifInOctets, ifStackGroup2=ifStackGroup2, ifHCInOctets=ifHCInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifAdminStatus=ifAdminStatus, ifOutDiscards=ifOutDiscards)
