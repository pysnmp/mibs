...
TimeStamp, TextualConvention, DisplayString, TruthValue, RowStatus, TestAndIncr, PhysAddress, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "DisplayString", "TruthValue", "RowStatus", "TestAndIncr", "PhysAddress", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndexOrZero=InterfaceIndexOrZero, linkUp=linkUp, InterfaceIndex=InterfaceIndex, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, ifHCPacketGroup=ifHCPacketGroup, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifStackGroup=ifStackGroup, linkDown=linkDown, ifSpeed=ifSpeed, ifTestId=ifTestId, ifOutQLen=ifOutQLen, ifDescr=ifDescr, ifOutDiscards=ifOutDiscards, ifStackTable=ifStackTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifEntry=ifEntry, ifHighSpeed=ifHighSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutOctets=ifHCOutOctets, ifIndex=ifIndex, ifStackStatus=ifStackStatus, OwnerString=OwnerString, PYSNMP_MODULE_ID=ifMIB, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAdminStatus=ifAdminStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifName=ifName, ifPacketGroup=ifPacketGroup, ifTestResult=ifTestResult, ifStackGroup2=ifStackGroup2, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifTestStatus=ifTestStatus, ifGroups=ifGroups, ifStackEntry=ifStackEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifConnectorPresent=ifConnectorPresent, ifCompliance2=ifCompliance2, ifPromiscuousMode=ifPromiscuousMode, ifInOctets=ifInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestType=ifTestType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifLastChange=ifLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifSpecific=ifSpecific, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLastChange=ifStackLastChange, ifGeneralGroup=ifGeneralGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifOutOctets=ifOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifStackLowerLayer=ifStackLowerLayer, ifCompliance3=ifCompliance3, ifMIBObjects=ifMIBObjects, ifType=ifType, ifMtu=ifMtu, ifConformance=ifConformance, ifTestEntry=ifTestEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifInErrors=ifInErrors, ifXTable=ifXTable, ifTestTable=ifTestTable, ifTable=ifTable, ifRcvAddressType=ifRcvAddressType, ifCompliance=ifCompliance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifNumber=ifNumber, ifRcvAddressGroup=ifRcvAddressGroup, ifOutMulticastPkts=ifOutMulticastPkts, interfaces=interfaces, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIB=ifMIB, ifGeneralInformationGroup=ifGeneralInformationGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifOutErrors=ifOutErrors)
