...
RowStatus, PhysAddress, TimeStamp, TruthValue, DisplayString, TextualConvention, TestAndIncr, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TimeStamp", "TruthValue", "DisplayString", "TextualConvention", "TestAndIncr", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifStackStatus=ifStackStatus, ifMtu=ifMtu, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifAlias=ifAlias, ifConnectorPresent=ifConnectorPresent, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressTable=ifRcvAddressTable, linkDown=linkDown, InterfaceIndex=InterfaceIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackTable=ifStackTable, ifStackGroup2=ifStackGroup2, ifOutNUcastPkts=ifOutNUcastPkts, ifOutErrors=ifOutErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifLastChange=ifLastChange, ifHCPacketGroup=ifHCPacketGroup, ifTestOwner=ifTestOwner, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifMIB=ifMIB, ifTestTable=ifTestTable, ifIndex=ifIndex, ifTestResult=ifTestResult, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutOctets=ifHCOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, ifEntry=ifEntry, ifInOctets=ifInOctets, ifHighSpeed=ifHighSpeed, ifSpecific=ifSpecific, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifStackLastChange=ifStackLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutQLen=ifOutQLen, ifCompliance3=ifCompliance3, ifName=ifName, ifCompliances=ifCompliances, ifTable=ifTable, ifTestStatus=ifTestStatus, ifGeneralGroup=ifGeneralGroup, ifTestType=ifTestType, ifRcvAddressAddress=ifRcvAddressAddress, ifOutUcastPkts=ifOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifTableLastChange=ifTableLastChange, ifType=ifType, ifInErrors=ifInErrors, ifGroups=ifGroups, ifMIBObjects=ifMIBObjects, ifStackGroup=ifStackGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, interfaces=interfaces, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifTestGroup=ifTestGroup, ifStackLowerLayer=ifStackLowerLayer, ifAdminStatus=ifAdminStatus, ifDescr=ifDescr, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifInUcastPkts=ifInUcastPkts, linkUp=linkUp, ifXTable=ifXTable, ifCompliance=ifCompliance, ifSpeed=ifSpeed, ifHCInUcastPkts=ifHCInUcastPkts, ifConformance=ifConformance, ifRcvAddressType=ifRcvAddressType, ifInNUcastPkts=ifInNUcastPkts, ifTestId=ifTestId, ifInMulticastPkts=ifInMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifCompliance2=ifCompliance2, OwnerString=OwnerString)
