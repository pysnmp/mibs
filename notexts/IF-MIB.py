...
TextualConvention, TruthValue, RowStatus, PhysAddress, TestAndIncr, DisplayString, AutonomousType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "RowStatus", "PhysAddress", "TestAndIncr", "DisplayString", "AutonomousType", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifStackGroup2=ifStackGroup2, ifEntry=ifEntry, ifCompliances=ifCompliances, ifTestGroup=ifTestGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifCompliance2=ifCompliance2, ifHCInUcastPkts=ifHCInUcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkDown=linkDown, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifTestType=ifTestType, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode, ifXEntry=ifXEntry, ifStackLastChange=ifStackLastChange, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifOutDiscards=ifOutDiscards, ifOutUcastPkts=ifOutUcastPkts, ifTestTable=ifTestTable, ifOutNUcastPkts=ifOutNUcastPkts, ifLastChange=ifLastChange, ifConnectorPresent=ifConnectorPresent, ifAdminStatus=ifAdminStatus, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestOwner=ifTestOwner, ifRcvAddressEntry=ifRcvAddressEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutOctets=ifHCOutOctets, ifInUnknownProtos=ifInUnknownProtos, ifOperStatus=ifOperStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPacketGroup=ifPacketGroup, ifName=ifName, ifXTable=ifXTable, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifRcvAddressStatus=ifRcvAddressStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIB=ifMIB, ifInOctets=ifInOctets, ifDescr=ifDescr, PYSNMP_MODULE_ID=ifMIB, ifMtu=ifMtu, ifRcvAddressAddress=ifRcvAddressAddress, ifTestStatus=ifTestStatus, ifStackHigherLayer=ifStackHigherLayer, ifConformance=ifConformance, linkUp=linkUp, ifRcvAddressTable=ifRcvAddressTable, ifHighSpeed=ifHighSpeed, ifRcvAddressType=ifRcvAddressType, ifStackEntry=ifStackEntry, ifStackStatus=ifStackStatus, ifInMulticastPkts=ifInMulticastPkts, ifTable=ifTable, ifInUcastPkts=ifInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifTestEntry=ifTestEntry, ifStackGroup=ifStackGroup, ifOutQLen=ifOutQLen, ifIndex=ifIndex, ifCompliance3=ifCompliance3, ifTestId=ifTestId, ifOldObjectsGroup=ifOldObjectsGroup, ifSpeed=ifSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, interfaces=interfaces, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndex=InterfaceIndex, ifGroups=ifGroups, ifInNUcastPkts=ifInNUcastPkts, ifMIBObjects=ifMIBObjects, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifType=ifType, ifInDiscards=ifInDiscards, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifSpecific=ifSpecific, ifAlias=ifAlias, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts)
