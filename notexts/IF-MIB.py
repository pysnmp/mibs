...
AutonomousType, PhysAddress, DisplayString, TimeStamp, TruthValue, TextualConvention, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "PhysAddress", "DisplayString", "TimeStamp", "TruthValue", "TextualConvention", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMtu=ifMtu, linkDown=linkDown, ifHCOutOctets=ifHCOutOctets, ifStackGroup2=ifStackGroup2, ifRcvAddressEntry=ifRcvAddressEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifOutUcastPkts=ifOutUcastPkts, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifInErrors=ifInErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifEntry=ifEntry, ifStackGroup=ifStackGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralGroup=ifGeneralGroup, ifName=ifName, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, PYSNMP_MODULE_ID=ifMIB, ifTestStatus=ifTestStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXEntry=ifXEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifLastChange=ifLastChange, ifPhysAddress=ifPhysAddress, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifInOctets=ifInOctets, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifStackLastChange=ifStackLastChange, ifCompliance3=ifCompliance3, interfaces=interfaces, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutOctets=ifOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifInDiscards=ifInDiscards, ifTestResult=ifTestResult, ifStackHigherLayer=ifStackHigherLayer, ifHCInOctets=ifHCInOctets, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode, ifOutDiscards=ifOutDiscards, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, InterfaceIndex=InterfaceIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance2=ifCompliance2, ifTestGroup=ifTestGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressType=ifRcvAddressType, ifStackTable=ifStackTable, ifConformance=ifConformance, ifInUcastPkts=ifInUcastPkts, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, ifGroups=ifGroups, ifMIB=ifMIB, ifTestTable=ifTestTable, ifTestOwner=ifTestOwner, ifCompliances=ifCompliances, ifTable=ifTable, ifRcvAddressAddress=ifRcvAddressAddress, ifOutQLen=ifOutQLen, ifTestCode=ifTestCode, ifTestEntry=ifTestEntry, ifXTable=ifXTable, OwnerString=OwnerString, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTableLastChange=ifTableLastChange, ifInNUcastPkts=ifInNUcastPkts, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifHCPacketGroup=ifHCPacketGroup, ifType=ifType, linkUp=linkUp, ifOutErrors=ifOutErrors, ifIndex=ifIndex, ifTestType=ifTestType, ifStackLowerLayer=ifStackLowerLayer, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime)
