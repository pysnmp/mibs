...
NotificationType, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Bits, Integer32, IpAddress, Counter32, Unsigned32, Gauge32, mib_2, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Bits", "Integer32", "IpAddress", "Counter32", "Unsigned32", "Gauge32", "mib-2", "Counter64", "ObjectIdentity")
TestAndIncr, RowStatus, TextualConvention, DisplayString, TimeStamp, AutonomousType, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "TextualConvention", "DisplayString", "TimeStamp", "AutonomousType", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifStackGroup=ifStackGroup, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpecific=ifSpecific, ifStackHigherLayer=ifStackHigherLayer, ifSpeed=ifSpeed, ifTestCode=ifTestCode, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPacketGroup=ifPacketGroup, ifCompliance2=ifCompliance2, ifOldObjectsGroup=ifOldObjectsGroup, ifMIBObjects=ifMIBObjects, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifHighSpeed=ifHighSpeed, ifHCPacketGroup=ifHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifInErrors=ifInErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifGeneralGroup=ifGeneralGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackLastChange=ifStackLastChange, ifType=ifType, ifRcvAddressType=ifRcvAddressType, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTable=ifTable, ifInUcastPkts=ifInUcastPkts, ifTestId=ifTestId, ifNumber=ifNumber, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutMulticastPkts=ifOutMulticastPkts, OwnerString=OwnerString, PYSNMP_MODULE_ID=ifMIB, ifOperStatus=ifOperStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifInOctets=ifInOctets, ifMIB=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifCompliance=ifCompliance, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifAlias=ifAlias, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestResult=ifTestResult, ifHCInOctets=ifHCInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifOutQLen=ifOutQLen, ifTestStatus=ifTestStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUnknownProtos=ifInUnknownProtos, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifPhysAddress=ifPhysAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestEntry=ifTestEntry, linkDown=linkDown, ifAdminStatus=ifAdminStatus, ifTestTable=ifTestTable, ifCompliances=ifCompliances, ifTestOwner=ifTestOwner, ifXEntry=ifXEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifTestGroup=ifTestGroup, ifName=ifName, ifTestType=ifTestType, ifXTable=ifXTable, ifEntry=ifEntry, ifOutUcastPkts=ifOutUcastPkts, ifStackEntry=ifStackEntry, ifRcvAddressTable=ifRcvAddressTable, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifGroups=ifGroups, ifLastChange=ifLastChange, ifCompliance3=ifCompliance3, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutErrors=ifOutErrors, ifDescr=ifDescr, interfaces=interfaces, ifFixedLengthGroup=ifFixedLengthGroup, InterfaceIndex=InterfaceIndex, ifStackTable=ifStackTable)
