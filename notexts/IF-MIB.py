...
MibIdentifier, ObjectIdentity, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, NotificationType, IpAddress, iso, TimeTicks, ModuleIdentity, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "NotificationType", "IpAddress", "iso", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter32", "Integer32")
TestAndIncr, DisplayString, TimeStamp, TextualConvention, AutonomousType, PhysAddress, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TimeStamp", "TextualConvention", "AutonomousType", "PhysAddress", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance=ifCompliance, ifHCInOctets=ifHCInOctets, ifConnectorPresent=ifConnectorPresent, ifTestType=ifTestType, ifInOctets=ifInOctets, ifOutDiscards=ifOutDiscards, ifNumber=ifNumber, ifGeneralGroup=ifGeneralGroup, ifRcvAddressTable=ifRcvAddressTable, ifDescr=ifDescr, ifType=ifType, ifTestStatus=ifTestStatus, ifName=ifName, ifStackTable=ifStackTable, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpeed=ifSpeed, ifIndex=ifIndex, ifXEntry=ifXEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifMIBObjects=ifMIBObjects, ifMtu=ifMtu, ifInUcastPkts=ifInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressType=ifRcvAddressType, ifTestEntry=ifTestEntry, ifInErrors=ifInErrors, OwnerString=OwnerString, ifCompliances=ifCompliances, interfaces=interfaces, ifInDiscards=ifInDiscards, ifAlias=ifAlias, ifMIB=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutErrors=ifOutErrors, ifStackEntry=ifStackEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifConformance=ifConformance, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestGroup=ifTestGroup, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestOwner=ifTestOwner, ifOutQLen=ifOutQLen, ifInNUcastPkts=ifInNUcastPkts, linkDown=linkDown, ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup2=ifStackGroup2, ifTestId=ifTestId, ifOperStatus=ifOperStatus, ifCompliance2=ifCompliance2, ifStackLowerLayer=ifStackLowerLayer, ifTestCode=ifTestCode, ifPacketGroup=ifPacketGroup, ifTestTable=ifTestTable, ifRcvAddressGroup=ifRcvAddressGroup, ifXTable=ifXTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance3=ifCompliance3, ifHCOutOctets=ifHCOutOctets, PYSNMP_MODULE_ID=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestResult=ifTestResult, ifStackGroup=ifStackGroup, ifEntry=ifEntry, ifSpecific=ifSpecific, ifInUnknownProtos=ifInUnknownProtos, ifOutOctets=ifOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifAdminStatus=ifAdminStatus, ifHCPacketGroup=ifHCPacketGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHighSpeed=ifHighSpeed, ifGroups=ifGroups, ifOutBroadcastPkts=ifOutBroadcastPkts)
