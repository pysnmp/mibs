...
Counter32, Integer32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, IpAddress, ModuleIdentity, NotificationType, Gauge32, ObjectIdentity, iso, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "IpAddress", "ModuleIdentity", "NotificationType", "Gauge32", "ObjectIdentity", "iso", "TimeTicks", "Counter64", "Bits")
RowStatus, PhysAddress, AutonomousType, TestAndIncr, TextualConvention, DisplayString, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "AutonomousType", "TestAndIncr", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressStatus=ifRcvAddressStatus, ifOutQLen=ifOutQLen, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifHCPacketGroup=ifHCPacketGroup, ifOutOctets=ifOutOctets, ifHCOutOctets=ifHCOutOctets, ifDescr=ifDescr, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, interfaces=interfaces, ifCompliance3=ifCompliance3, ifStackStatus=ifStackStatus, ifName=ifName, ifIndex=ifIndex, ifXTable=ifXTable, ifInUnknownProtos=ifInUnknownProtos, ifAdminStatus=ifAdminStatus, ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifStackLowerLayer=ifStackLowerLayer, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, InterfaceIndex=InterfaceIndex, ifNumber=ifNumber, ifLastChange=ifLastChange, ifInBroadcastPkts=ifInBroadcastPkts, ifEntry=ifEntry, ifConnectorPresent=ifConnectorPresent, ifGroups=ifGroups, ifTable=ifTable, ifOutUcastPkts=ifOutUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestResult=ifTestResult, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifOutMulticastPkts=ifOutMulticastPkts, ifPacketGroup=ifPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifXEntry=ifXEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance2=ifCompliance2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, ifStackLastChange=ifStackLastChange, ifCompliance=ifCompliance, ifMIB=ifMIB, ifCompliances=ifCompliances, ifInUcastPkts=ifInUcastPkts, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestType=ifTestType, ifMtu=ifMtu, ifTestStatus=ifTestStatus, linkDown=linkDown, ifTestId=ifTestId, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifOutErrors=ifOutErrors, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, OwnerString=OwnerString, ifStackHigherLayer=ifStackHigherLayer, ifHCInOctets=ifHCInOctets, ifAlias=ifAlias, ifStackGroup=ifStackGroup, ifInOctets=ifInOctets, ifInErrors=ifInErrors, ifTestTable=ifTestTable, ifRcvAddressEntry=ifRcvAddressEntry, ifOperStatus=ifOperStatus, ifSpecific=ifSpecific, PYSNMP_MODULE_ID=ifMIB, ifTestOwner=ifTestOwner, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifType=ifType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestGroup=ifTestGroup, ifMIBObjects=ifMIBObjects, ifGeneralGroup=ifGeneralGroup, linkUp=linkUp, ifStackEntry=ifStackEntry, ifPhysAddress=ifPhysAddress, ifConformance=ifConformance, ifSpeed=ifSpeed, ifTestEntry=ifTestEntry)
