...
Unsigned32, MibIdentifier, iso, ModuleIdentity, TimeTicks, Counter64, Counter32, Gauge32, Integer32, Bits, ObjectIdentity, IpAddress, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "TimeTicks", "Counter64", "Counter32", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "IpAddress", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TestAndIncr, TimeStamp, TextualConvention, RowStatus, DisplayString, AutonomousType, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "AutonomousType", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", linkDown=linkDown, InterfaceIndex=InterfaceIndex, ifName=ifName, ifOutMulticastPkts=ifOutMulticastPkts, ifTestEntry=ifTestEntry, ifGroups=ifGroups, ifRcvAddressType=ifRcvAddressType, ifOutQLen=ifOutQLen, ifStackGroup=ifStackGroup, ifHighSpeed=ifHighSpeed, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestId=ifTestId, ifInNUcastPkts=ifInNUcastPkts, ifAlias=ifAlias, ifXTable=ifXTable, ifIndex=ifIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifTestResult=ifTestResult, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifTestCode=ifTestCode, ifNumber=ifNumber, ifCompliances=ifCompliances, ifCompliance=ifCompliance, ifInUcastPkts=ifInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutUcastPkts=ifOutUcastPkts, ifTestOwner=ifTestOwner, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifDescr=ifDescr, ifMIB=ifMIB, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifCompliance3=ifCompliance3, ifVHCPacketGroup=ifVHCPacketGroup, interfaces=interfaces, ifTestTable=ifTestTable, ifXEntry=ifXEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifTestType=ifTestType, ifStackTable=ifStackTable, ifHCInOctets=ifHCInOctets, ifInMulticastPkts=ifInMulticastPkts, ifCompliance2=ifCompliance2, ifOutNUcastPkts=ifOutNUcastPkts, ifMIBObjects=ifMIBObjects, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressStatus=ifRcvAddressStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackStatus=ifStackStatus, ifStackGroup2=ifStackGroup2, PYSNMP_MODULE_ID=ifMIB, ifHCInMulticastPkts=ifHCInMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifInErrors=ifInErrors, ifTable=ifTable, ifStackLastChange=ifStackLastChange, ifPhysAddress=ifPhysAddress, ifStackLowerLayer=ifStackLowerLayer, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifConformance=ifConformance, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifLastChange=ifLastChange, ifPromiscuousMode=ifPromiscuousMode, ifMtu=ifMtu, ifStackEntry=ifStackEntry, ifStackHigherLayer=ifStackHigherLayer, ifFixedLengthGroup=ifFixedLengthGroup, ifTestGroup=ifTestGroup, ifOutErrors=ifOutErrors, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifInOctets=ifInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInDiscards=ifInDiscards, ifConnectorPresent=ifConnectorPresent, ifSpecific=ifSpecific, OwnerString=OwnerString, ifRcvAddressAddress=ifRcvAddressAddress, ifTableLastChange=ifTableLastChange, ifEntry=ifEntry, ifGeneralGroup=ifGeneralGroup, linkUp=linkUp, ifHCPacketGroup=ifHCPacketGroup)
