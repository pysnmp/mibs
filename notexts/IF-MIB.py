...
AutonomousType, DisplayString, PhysAddress, TestAndIncr, RowStatus, TextualConvention, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "PhysAddress", "TestAndIncr", "RowStatus", "TextualConvention", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifXEntry=ifXEntry, linkUp=linkUp, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackTable=ifStackTable, ifTestTable=ifTestTable, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifFixedLengthGroup=ifFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackGroup2=ifStackGroup2, ifTestType=ifTestType, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressStatus=ifRcvAddressStatus, ifGroups=ifGroups, ifTestResult=ifTestResult, ifMtu=ifMtu, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTable=ifTable, ifTestOwner=ifTestOwner, ifSpeed=ifSpeed, ifPhysAddress=ifPhysAddress, interfaces=interfaces, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifTestGroup=ifTestGroup, ifAdminStatus=ifAdminStatus, ifInMulticastPkts=ifInMulticastPkts, ifTestCode=ifTestCode, ifCompliance2=ifCompliance2, ifConformance=ifConformance, ifNumber=ifNumber, ifInBroadcastPkts=ifInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifName=ifName, OwnerString=OwnerString, ifTestStatus=ifTestStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifStackLastChange=ifStackLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifOutQLen=ifOutQLen, ifGeneralGroup=ifGeneralGroup, ifEntry=ifEntry, ifInNUcastPkts=ifInNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndex=InterfaceIndex, ifConnectorPresent=ifConnectorPresent, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInOctets=ifHCInOctets, ifHCPacketGroup=ifHCPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifInDiscards=ifInDiscards, ifOutErrors=ifOutErrors, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup=ifStackGroup, ifMIB=ifMIB, ifInOctets=ifInOctets, ifOutOctets=ifOutOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifDescr=ifDescr, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPacketGroup=ifPacketGroup, ifPromiscuousMode=ifPromiscuousMode, ifAlias=ifAlias, ifHighSpeed=ifHighSpeed, ifType=ifType, ifIndex=ifIndex, ifInUcastPkts=ifInUcastPkts, ifOutDiscards=ifOutDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifTestId=ifTestId, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifOperStatus=ifOperStatus, ifStackStatus=ifStackStatus)
