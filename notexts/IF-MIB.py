...
AutonomousType, TestAndIncr, PhysAddress, TruthValue, TimeStamp, RowStatus, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TestAndIncr", "PhysAddress", "TruthValue", "TimeStamp", "RowStatus", "TextualConvention", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifOutQLen=ifOutQLen, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLowerLayer=ifStackLowerLayer, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifGeneralGroup=ifGeneralGroup, ifStackEntry=ifStackEntry, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestType=ifTestType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, interfaces=interfaces, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTableLastChange=ifTableLastChange, ifTestCode=ifTestCode, ifTestEntry=ifTestEntry, ifMIBObjects=ifMIBObjects, linkUp=linkUp, ifXTable=ifXTable, InterfaceIndex=InterfaceIndex, ifRcvAddressAddress=ifRcvAddressAddress, linkDown=linkDown, ifGroups=ifGroups, ifTestId=ifTestId, ifStackHigherLayer=ifStackHigherLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifInMulticastPkts=ifInMulticastPkts, ifSpeed=ifSpeed, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifCompliance=ifCompliance, ifTable=ifTable, ifInErrors=ifInErrors, ifStackStatus=ifStackStatus, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutErrors=ifOutErrors, ifOperStatus=ifOperStatus, ifInUnknownProtos=ifInUnknownProtos, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifAdminStatus=ifAdminStatus, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifInUcastPkts=ifInUcastPkts, ifTestTable=ifTestTable, ifInOctets=ifInOctets, ifEntry=ifEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifAlias=ifAlias, ifHCOutUcastPkts=ifHCOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifSpecific=ifSpecific, ifHCInOctets=ifHCInOctets, ifConformance=ifConformance, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInDiscards=ifInDiscards, ifConnectorPresent=ifConnectorPresent, ifTestGroup=ifTestGroup, ifCompliances=ifCompliances, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance2=ifCompliance2, ifOutDiscards=ifOutDiscards, ifPacketGroup=ifPacketGroup, ifTestResult=ifTestResult, ifIndex=ifIndex, ifXEntry=ifXEntry, ifHCOutOctets=ifHCOutOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackGroup2=ifStackGroup2, ifRcvAddressGroup=ifRcvAddressGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestStatus=ifTestStatus, PYSNMP_MODULE_ID=ifMIB, ifStackLastChange=ifStackLastChange, ifHighSpeed=ifHighSpeed, ifStackGroup=ifStackGroup, ifDescr=ifDescr, ifTestOwner=ifTestOwner, ifLastChange=ifLastChange, ifOutOctets=ifOutOctets, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressType=ifRcvAddressType)
