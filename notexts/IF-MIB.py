...
mib_2, TimeTicks, Counter64, ObjectIdentity, IpAddress, MibIdentifier, NotificationType, Unsigned32, Gauge32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Counter32")
TruthValue, TimeStamp, AutonomousType, PhysAddress, TestAndIncr, RowStatus, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "AutonomousType", "PhysAddress", "TestAndIncr", "RowStatus", "DisplayString", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifTestTable=ifTestTable, ifName=ifName, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifInDiscards=ifInDiscards, ifOutMulticastPkts=ifOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressAddress=ifRcvAddressAddress, ifTestId=ifTestId, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInNUcastPkts=ifInNUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifStackLowerLayer=ifStackLowerLayer, ifInErrors=ifInErrors, ifOutErrors=ifOutErrors, ifGroups=ifGroups, ifRcvAddressTable=ifRcvAddressTable, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifOutQLen=ifOutQLen, ifStackEntry=ifStackEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifLastChange=ifLastChange, ifOldObjectsGroup=ifOldObjectsGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance2=ifCompliance2, ifOperStatus=ifOperStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpeed=ifSpeed, ifTable=ifTable, ifStackHigherLayer=ifStackHigherLayer, ifTestStatus=ifTestStatus, linkDown=linkDown, ifOutNUcastPkts=ifOutNUcastPkts, ifConformance=ifConformance, ifCompliance=ifCompliance, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIBObjects=ifMIBObjects, interfaces=interfaces, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, OwnerString=OwnerString, ifTestCode=ifTestCode, ifStackTable=ifStackTable, ifStackLastChange=ifStackLastChange, ifTestOwner=ifTestOwner, ifSpecific=ifSpecific, ifHCInUcastPkts=ifHCInUcastPkts, ifAlias=ifAlias, ifTestEntry=ifTestEntry, ifTestGroup=ifTestGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, InterfaceIndex=InterfaceIndex, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, ifEntry=ifEntry, ifDescr=ifDescr, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifHCOutOctets=ifHCOutOctets, ifIndex=ifIndex, ifTestType=ifTestType, ifOutDiscards=ifOutDiscards, ifInUcastPkts=ifInUcastPkts, ifCompliances=ifCompliances, ifCompliance3=ifCompliance3, ifInMulticastPkts=ifInMulticastPkts, ifXEntry=ifXEntry, ifRcvAddressType=ifRcvAddressType, ifStackGroup=ifStackGroup, ifPromiscuousMode=ifPromiscuousMode, ifNumber=ifNumber, ifMtu=ifMtu, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInOctets=ifInOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHighSpeed=ifHighSpeed, ifRcvAddressGroup=ifRcvAddressGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInOctets=ifHCInOctets, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifType=ifType, linkUp=linkUp)
