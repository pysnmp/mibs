...
TestAndIncr, DisplayString, TimeStamp, TextualConvention, RowStatus, PhysAddress, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "PhysAddress", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifInUcastPkts=ifInUcastPkts, ifIndex=ifIndex, ifCompliance3=ifCompliance3, ifGeneralGroup=ifGeneralGroup, ifTestId=ifTestId, ifInOctets=ifInOctets, ifOperStatus=ifOperStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLastChange=ifStackLastChange, ifHCInOctets=ifHCInOctets, ifStackLowerLayer=ifStackLowerLayer, ifOutQLen=ifOutQLen, ifStackTable=ifStackTable, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliances=ifCompliances, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpeed=ifSpeed, ifMtu=ifMtu, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestTable=ifTestTable, ifInDiscards=ifInDiscards, ifSpecific=ifSpecific, linkDown=linkDown, ifRcvAddressGroup=ifRcvAddressGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifTestCode=ifTestCode, ifRcvAddressAddress=ifRcvAddressAddress, ifType=ifType, ifOutUcastPkts=ifOutUcastPkts, ifTestGroup=ifTestGroup, ifAdminStatus=ifAdminStatus, ifCompliance2=ifCompliance2, ifRcvAddressTable=ifRcvAddressTable, ifPacketGroup=ifPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifOutDiscards=ifOutDiscards, ifConformance=ifConformance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackGroup2=ifStackGroup2, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackEntry=ifStackEntry, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndex=InterfaceIndex, ifOutOctets=ifOutOctets, ifEntry=ifEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutOctets=ifHCOutOctets, ifTable=ifTable, ifNumber=ifNumber, ifXEntry=ifXEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMIB=ifMIB, ifTestEntry=ifTestEntry, ifInErrors=ifInErrors, ifXTable=ifXTable, ifOutMulticastPkts=ifOutMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, OwnerString=OwnerString, interfaces=interfaces, ifStackGroup=ifStackGroup, ifTestType=ifTestType, ifTestStatus=ifTestStatus, ifCompliance=ifCompliance, ifStackStatus=ifStackStatus, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, linkUp=linkUp, ifInUnknownProtos=ifInUnknownProtos, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, ifLastChange=ifLastChange, ifName=ifName)
