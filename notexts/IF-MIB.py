...
ModuleIdentity, Counter32, Gauge32, Counter64, Integer32, TimeTicks, mib_2, NotificationType, Bits, Unsigned32, IpAddress, MibIdentifier, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Gauge32", "Counter64", "Integer32", "TimeTicks", "mib-2", "NotificationType", "Bits", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
TextualConvention, PhysAddress, DisplayString, TimeStamp, TestAndIncr, TruthValue, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "DisplayString", "TimeStamp", "TestAndIncr", "TruthValue", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifTableLastChange=ifTableLastChange, ifTestOwner=ifTestOwner, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifCompliance=ifCompliance, ifPacketGroup=ifPacketGroup, ifInUcastPkts=ifInUcastPkts, ifTestTable=ifTestTable, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInOctets=ifInOctets, ifPromiscuousMode=ifPromiscuousMode, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, linkDown=linkDown, ifXTable=ifXTable, ifOperStatus=ifOperStatus, ifRcvAddressTable=ifRcvAddressTable, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifMtu=ifMtu, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifTestStatus=ifTestStatus, ifStackLastChange=ifStackLastChange, ifOutOctets=ifOutOctets, ifLastChange=ifLastChange, ifTestGroup=ifTestGroup, ifStackEntry=ifStackEntry, ifStackGroup=ifStackGroup, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifName=ifName, PYSNMP_MODULE_ID=ifMIB, ifTestCode=ifTestCode, ifDescr=ifDescr, ifTestId=ifTestId, ifNumber=ifNumber, ifRcvAddressGroup=ifRcvAddressGroup, ifStackGroup2=ifStackGroup2, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInOctets=ifHCInOctets, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, linkUp=linkUp, ifSpeed=ifSpeed, ifType=ifType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, ifInUnknownProtos=ifInUnknownProtos, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifHighSpeed=ifHighSpeed, ifInNUcastPkts=ifInNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifGroups=ifGroups, ifCompliances=ifCompliances, ifTable=ifTable, ifOutQLen=ifOutQLen, ifMIB=ifMIB, ifInErrors=ifInErrors, ifSpecific=ifSpecific, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestResult=ifTestResult, ifStackTable=ifStackTable, ifRcvAddressType=ifRcvAddressType, ifCompliance3=ifCompliance3, ifTestEntry=ifTestEntry, interfaces=interfaces, ifTestType=ifTestType, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressAddress=ifRcvAddressAddress)
