...
AutonomousType, DisplayString, TestAndIncr, RowStatus, TimeStamp, TruthValue, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TestAndIncr", "RowStatus", "TimeStamp", "TruthValue", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifHCInOctets=ifHCInOctets, ifTestType=ifTestType, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackTable=ifStackTable, ifType=ifType, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIB=ifMIB, ifInErrors=ifInErrors, ifTableLastChange=ifTableLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent, ifRcvAddressEntry=ifRcvAddressEntry, ifTestStatus=ifTestStatus, ifStackStatus=ifStackStatus, ifName=ifName, ifOutUcastPkts=ifOutUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutErrors=ifOutErrors, ifRcvAddressType=ifRcvAddressType, InterfaceIndex=InterfaceIndex, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifXEntry=ifXEntry, ifSpecific=ifSpecific, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackLowerLayer=ifStackLowerLayer, ifCompliance2=ifCompliance2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestResult=ifTestResult, ifDescr=ifDescr, ifMtu=ifMtu, interfaces=interfaces, ifGroups=ifGroups, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLastChange=ifStackLastChange, ifOutDiscards=ifOutDiscards, ifHighSpeed=ifHighSpeed, ifAlias=ifAlias, ifCompliance=ifCompliance, ifVHCPacketGroup=ifVHCPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifTestId=ifTestId, ifTestOwner=ifTestOwner, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressGroup=ifRcvAddressGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifAdminStatus=ifAdminStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackGroup=ifStackGroup, ifSpeed=ifSpeed, ifGeneralGroup=ifGeneralGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestTable=ifTestTable, ifStackGroup2=ifStackGroup2, ifFixedLengthGroup=ifFixedLengthGroup, ifCompliances=ifCompliances, ifEntry=ifEntry, ifOperStatus=ifOperStatus, linkDown=linkDown, ifPacketGroup=ifPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, OwnerString=OwnerString, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifTable=ifTable, ifInUnknownProtos=ifInUnknownProtos, ifTestGroup=ifTestGroup, ifMIBObjects=ifMIBObjects, PYSNMP_MODULE_ID=ifMIB, ifIndex=ifIndex, ifLastChange=ifLastChange, ifConformance=ifConformance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, linkUp=linkUp, ifCompliance3=ifCompliance3, ifInOctets=ifInOctets, ifNumber=ifNumber, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestEntry=ifTestEntry, ifTestCode=ifTestCode, ifInUcastPkts=ifInUcastPkts)
