...
TimeStamp, PhysAddress, AutonomousType, DisplayString, TextualConvention, TestAndIncr, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "AutonomousType", "DisplayString", "TextualConvention", "TestAndIncr", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifAlias=ifAlias, ifGeneralGroup=ifGeneralGroup, ifStackStatus=ifStackStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifAdminStatus=ifAdminStatus, ifTable=ifTable, ifTestResult=ifTestResult, ifName=ifName, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifOutMulticastPkts=ifOutMulticastPkts, ifInDiscards=ifInDiscards, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifTestGroup=ifTestGroup, ifRcvAddressType=ifRcvAddressType, InterfaceIndexOrZero=InterfaceIndexOrZero, InterfaceIndex=InterfaceIndex, ifIndex=ifIndex, ifMIB=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTestEntry=ifTestEntry, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestType=ifTestType, ifType=ifType, ifHCInOctets=ifHCInOctets, ifPromiscuousMode=ifPromiscuousMode, ifInOctets=ifInOctets, ifOutOctets=ifOutOctets, ifMtu=ifMtu, ifHCOutOctets=ifHCOutOctets, ifStackTable=ifStackTable, OwnerString=OwnerString, ifCompliance2=ifCompliance2, ifSpecific=ifSpecific, ifConformance=ifConformance, ifPacketGroup=ifPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifGroups=ifGroups, ifOperStatus=ifOperStatus, linkDown=linkDown, linkUp=linkUp, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifLastChange=ifLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifNumber=ifNumber, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifPhysAddress=ifPhysAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXEntry=ifXEntry, ifTestId=ifTestId, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutDiscards=ifOutDiscards, ifRcvAddressTable=ifRcvAddressTable, ifEntry=ifEntry, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, interfaces=interfaces, ifInUnknownProtos=ifInUnknownProtos, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifHighSpeed=ifHighSpeed, ifCompliance=ifCompliance, ifTableLastChange=ifTableLastChange, ifSpeed=ifSpeed, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifMIBObjects=ifMIBObjects, ifOutNUcastPkts=ifOutNUcastPkts, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, ifInUcastPkts=ifInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup=ifStackGroup, ifOutErrors=ifOutErrors, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup)
