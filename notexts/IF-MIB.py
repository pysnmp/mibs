...
AutonomousType, DisplayString, TextualConvention, PhysAddress, TestAndIncr, TimeStamp, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TextualConvention", "PhysAddress", "TestAndIncr", "TimeStamp", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifGeneralGroup=ifGeneralGroup, ifStackLastChange=ifStackLastChange, ifInErrors=ifInErrors, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInUcastPkts=ifInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpecific=ifSpecific, ifStackHigherLayer=ifStackHigherLayer, ifXTable=ifXTable, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifPacketGroup=ifPacketGroup, ifLastChange=ifLastChange, ifTestEntry=ifTestEntry, ifStackTable=ifStackTable, ifTestId=ifTestId, ifAdminStatus=ifAdminStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, interfaces=interfaces, ifHighSpeed=ifHighSpeed, ifMIBObjects=ifMIBObjects, ifOutBroadcastPkts=ifOutBroadcastPkts, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifStackStatus=ifStackStatus, ifXEntry=ifXEntry, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressStatus=ifRcvAddressStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifMIB=ifMIB, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifDescr=ifDescr, linkDown=linkDown, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance2=ifCompliance2, ifSpeed=ifSpeed, linkUp=linkUp, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressType=ifRcvAddressType, ifTestGroup=ifTestGroup, ifConformance=ifConformance, ifTestTable=ifTestTable, ifInDiscards=ifInDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifInOctets=ifInOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutUcastPkts=ifOutUcastPkts, ifCompliances=ifCompliances, ifHCPacketGroup=ifHCPacketGroup, ifOperStatus=ifOperStatus, ifGroups=ifGroups, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutQLen=ifOutQLen, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifEntry=ifEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, OwnerString=OwnerString, ifTestStatus=ifTestStatus, ifOutDiscards=ifOutDiscards, ifInMulticastPkts=ifInMulticastPkts, ifName=ifName, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifPromiscuousMode=ifPromiscuousMode, ifStackEntry=ifStackEntry, ifCompliance3=ifCompliance3, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifType=ifType, ifTableLastChange=ifTableLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTable=ifTable, ifIndex=ifIndex, ifTestOwner=ifTestOwner, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup=ifStackGroup, ifTestType=ifTestType, ifOutErrors=ifOutErrors, ifCompliance=ifCompliance, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifMtu=ifMtu, PYSNMP_MODULE_ID=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets)
