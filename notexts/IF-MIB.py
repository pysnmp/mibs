...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, TimeTicks, Bits, ModuleIdentity, Gauge32, Integer32, NotificationType, iso, mib_2, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "TimeTicks", "Bits", "ModuleIdentity", "Gauge32", "Integer32", "NotificationType", "iso", "mib-2", "IpAddress", "MibIdentifier")
DisplayString, TimeStamp, PhysAddress, TruthValue, TestAndIncr, RowStatus, TextualConvention, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "PhysAddress", "TruthValue", "TestAndIncr", "RowStatus", "TextualConvention", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifOutMulticastPkts=ifOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifConformance=ifConformance, ifTestStatus=ifTestStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifMtu=ifMtu, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifOutErrors=ifOutErrors, ifCompliances=ifCompliances, ifEntry=ifEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifOutUcastPkts=ifOutUcastPkts, ifTestType=ifTestType, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance3=ifCompliance3, ifStackStatus=ifStackStatus, ifInMulticastPkts=ifInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestResult=ifTestResult, ifMIB=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifSpeed=ifSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutQLen=ifOutQLen, ifLastChange=ifLastChange, ifHCOutOctets=ifHCOutOctets, ifRcvAddressTable=ifRcvAddressTable, linkUp=linkUp, PYSNMP_MODULE_ID=ifMIB, ifPacketGroup=ifPacketGroup, ifTestEntry=ifTestEntry, ifPhysAddress=ifPhysAddress, ifStackEntry=ifStackEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance2=ifCompliance2, ifInDiscards=ifInDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutOctets=ifOutOctets, ifTable=ifTable, ifXTable=ifXTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifType=ifType, ifInErrors=ifInErrors, ifTestCode=ifTestCode, ifStackGroup=ifStackGroup, InterfaceIndex=InterfaceIndex, ifStackLastChange=ifStackLastChange, ifInUcastPkts=ifInUcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifSpecific=ifSpecific, ifInOctets=ifInOctets, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifAlias=ifAlias, ifRcvAddressStatus=ifRcvAddressStatus, ifInUnknownProtos=ifInUnknownProtos, ifPromiscuousMode=ifPromiscuousMode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifMIBObjects=ifMIBObjects, ifHighSpeed=ifHighSpeed, ifTestId=ifTestId, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifStackHigherLayer=ifStackHigherLayer, ifTableLastChange=ifTableLastChange, ifTestTable=ifTestTable, ifTestGroup=ifTestGroup, ifStackTable=ifStackTable, ifIndex=ifIndex, ifName=ifName, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifGeneralGroup=ifGeneralGroup, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifCompliance=ifCompliance, OwnerString=OwnerString, ifHCInUcastPkts=ifHCInUcastPkts, linkDown=linkDown, ifXEntry=ifXEntry, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLowerLayer=ifStackLowerLayer, ifOutDiscards=ifOutDiscards, ifConnectorPresent=ifConnectorPresent, ifRcvAddressGroup=ifRcvAddressGroup)
