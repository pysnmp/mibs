...
RowStatus, PhysAddress, TestAndIncr, TruthValue, TextualConvention, AutonomousType, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TestAndIncr", "TruthValue", "TextualConvention", "AutonomousType", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralGroup=ifGeneralGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, ifInUcastPkts=ifInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, ifSpeed=ifSpeed, ifStackStatus=ifStackStatus, ifConnectorPresent=ifConnectorPresent, ifMIB=ifMIB, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutErrors=ifOutErrors, ifTestId=ifTestId, ifStackEntry=ifStackEntry, ifOutDiscards=ifOutDiscards, ifIndex=ifIndex, ifEntry=ifEntry, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifTestEntry=ifTestEntry, ifInDiscards=ifInDiscards, ifStackGroup2=ifStackGroup2, ifOperStatus=ifOperStatus, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifOutOctets=ifOutOctets, ifPacketGroup=ifPacketGroup, ifTableLastChange=ifTableLastChange, ifTestResult=ifTestResult, ifMIBObjects=ifMIBObjects, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, InterfaceIndex=InterfaceIndex, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutUcastPkts=ifOutUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInNUcastPkts=ifInNUcastPkts, ifAdminStatus=ifAdminStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifXTable=ifXTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAlias=ifAlias, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifSpecific=ifSpecific, ifRcvAddressType=ifRcvAddressType, ifTable=ifTable, ifLastChange=ifLastChange, ifStackGroup=ifStackGroup, ifPhysAddress=ifPhysAddress, ifCompliance2=ifCompliance2, ifStackLowerLayer=ifStackLowerLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestGroup=ifTestGroup, ifStackTable=ifStackTable, ifType=ifType, OwnerString=OwnerString, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCPacketGroup=ifHCPacketGroup, ifCompliance=ifCompliance, ifPromiscuousMode=ifPromiscuousMode, ifName=ifName, linkDown=linkDown, ifInErrors=ifInErrors, ifTestTable=ifTestTable, interfaces=interfaces, ifStackHigherLayer=ifStackHigherLayer, ifDescr=ifDescr, ifHighSpeed=ifHighSpeed, linkUp=linkUp, ifXEntry=ifXEntry, ifStackLastChange=ifStackLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConformance=ifConformance, ifTestCode=ifTestCode, ifCompliance3=ifCompliance3, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliances=ifCompliances, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutOctets=ifHCOutOctets)
