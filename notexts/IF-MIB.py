...
PhysAddress, TestAndIncr, TruthValue, TextualConvention, DisplayString, TimeStamp, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TestAndIncr", "TruthValue", "TextualConvention", "DisplayString", "TimeStamp", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifInUnknownProtos=ifInUnknownProtos, ifHCInUcastPkts=ifHCInUcastPkts, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, ifCompliance2=ifCompliance2, ifMIB=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifInBroadcastPkts=ifInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifConnectorPresent=ifConnectorPresent, ifNumber=ifNumber, ifAlias=ifAlias, ifHCInOctets=ifHCInOctets, ifTable=ifTable, ifGroups=ifGroups, ifStackTable=ifStackTable, ifType=ifType, ifPhysAddress=ifPhysAddress, linkUp=linkUp, ifOutOctets=ifOutOctets, ifRcvAddressType=ifRcvAddressType, ifDescr=ifDescr, ifVHCPacketGroup=ifVHCPacketGroup, ifMIBObjects=ifMIBObjects, OwnerString=OwnerString, ifCompliance3=ifCompliance3, ifMtu=ifMtu, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifTestGroup=ifTestGroup, interfaces=interfaces, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifTestType=ifTestType, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifOutErrors=ifOutErrors, ifCompliance=ifCompliance, ifXEntry=ifXEntry, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestId=ifTestId, ifConformance=ifConformance, ifInOctets=ifInOctets, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifEntry=ifEntry, ifHCOutOctets=ifHCOutOctets, ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifPacketGroup=ifPacketGroup, ifOperStatus=ifOperStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifOutDiscards=ifOutDiscards, ifStackStatus=ifStackStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifRcvAddressStatus=ifRcvAddressStatus, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifIndex=ifIndex, ifHighSpeed=ifHighSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, linkDown=linkDown, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXTable=ifXTable, ifPromiscuousMode=ifPromiscuousMode, ifStackGroup=ifStackGroup, ifStackLowerLayer=ifStackLowerLayer, ifOldObjectsGroup=ifOldObjectsGroup, ifOutUcastPkts=ifOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifInDiscards=ifInDiscards, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInNUcastPkts=ifInNUcastPkts, ifSpecific=ifSpecific, ifTestTable=ifTestTable, ifOutQLen=ifOutQLen, ifGeneralGroup=ifGeneralGroup, ifStackGroup2=ifStackGroup2, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestOwner=ifTestOwner, ifStackEntry=ifStackEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestStatus=ifTestStatus)
