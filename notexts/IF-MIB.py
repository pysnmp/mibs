...
iso, Bits, Integer32, ModuleIdentity, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, MibIdentifier, NotificationType, Gauge32, Counter64, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "ModuleIdentity", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "MibIdentifier", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "IpAddress")
TestAndIncr, TimeStamp, PhysAddress, TruthValue, AutonomousType, TextualConvention, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "PhysAddress", "TruthValue", "AutonomousType", "TextualConvention", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifTestResult=ifTestResult, OwnerString=OwnerString, ifInOctets=ifInOctets, ifTestOwner=ifTestOwner, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliances=ifCompliances, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPacketGroup=ifPacketGroup, ifPhysAddress=ifPhysAddress, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifIndex=ifIndex, ifSpeed=ifSpeed, interfaces=interfaces, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup=ifStackGroup, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifInNUcastPkts=ifInNUcastPkts, ifMtu=ifMtu, ifHCInUcastPkts=ifHCInUcastPkts, ifXTable=ifXTable, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressAddress=ifRcvAddressAddress, linkDown=linkDown, ifTestStatus=ifTestStatus, ifGroups=ifGroups, ifStackLastChange=ifStackLastChange, ifTableLastChange=ifTableLastChange, ifFixedLengthGroup=ifFixedLengthGroup, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutErrors=ifOutErrors, ifOutUcastPkts=ifOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAlias=ifAlias, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifStackEntry=ifStackEntry, PYSNMP_MODULE_ID=ifMIB, ifTable=ifTable, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifConformance=ifConformance, ifTestGroup=ifTestGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifDescr=ifDescr, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifType=ifType, ifCompliance2=ifCompliance2, ifAdminStatus=ifAdminStatus, ifOutOctets=ifOutOctets, ifName=ifName, ifInErrors=ifInErrors, ifInDiscards=ifInDiscards, ifTestEntry=ifTestEntry, ifTestId=ifTestId, ifInUcastPkts=ifInUcastPkts, ifHCOutOctets=ifHCOutOctets, ifStackStatus=ifStackStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressGroup=ifRcvAddressGroup, ifOutDiscards=ifOutDiscards, ifSpecific=ifSpecific, ifTestTable=ifTestTable, ifHCInOctets=ifHCInOctets, ifHighSpeed=ifHighSpeed, ifXEntry=ifXEntry, ifHCPacketGroup=ifHCPacketGroup, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifOutQLen=ifOutQLen, ifOutMulticastPkts=ifOutMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifGeneralGroup=ifGeneralGroup, ifEntry=ifEntry, ifRcvAddressTable=ifRcvAddressTable, ifCompliance3=ifCompliance3)
