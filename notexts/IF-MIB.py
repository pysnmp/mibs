...
TestAndIncr, RowStatus, TruthValue, PhysAddress, DisplayString, AutonomousType, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "TruthValue", "PhysAddress", "DisplayString", "AutonomousType", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutDiscards=ifOutDiscards, ifInErrors=ifInErrors, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestStatus=ifTestStatus, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliances=ifCompliances, ifOutQLen=ifOutQLen, ifEntry=ifEntry, ifStackGroup=ifStackGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifConformance=ifConformance, ifXTable=ifXTable, ifOutMulticastPkts=ifOutMulticastPkts, ifTestType=ifTestType, ifHCInOctets=ifHCInOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifAdminStatus=ifAdminStatus, ifPacketGroup=ifPacketGroup, ifSpeed=ifSpeed, ifLastChange=ifLastChange, ifRcvAddressEntry=ifRcvAddressEntry, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGroups=ifGroups, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance3=ifCompliance3, ifMIB=ifMIB, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackEntry=ifStackEntry, ifCompliance2=ifCompliance2, ifPromiscuousMode=ifPromiscuousMode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifTestId=ifTestId, ifInOctets=ifInOctets, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifRcvAddressStatus=ifRcvAddressStatus, ifOperStatus=ifOperStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifRcvAddressGroup=ifRcvAddressGroup, ifMtu=ifMtu, ifInUcastPkts=ifInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifHighSpeed=ifHighSpeed, ifTestResult=ifTestResult, ifName=ifName, ifStackHigherLayer=ifStackHigherLayer, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, OwnerString=OwnerString, ifTestOwner=ifTestOwner, ifStackStatus=ifStackStatus, linkDown=linkDown, ifTestCode=ifTestCode, ifCompliance=ifCompliance, ifStackGroup2=ifStackGroup2, ifIndex=ifIndex, ifOutOctets=ifOutOctets, ifPhysAddress=ifPhysAddress, InterfaceIndex=InterfaceIndex, ifSpecific=ifSpecific, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifTestTable=ifTestTable, ifMIBObjects=ifMIBObjects, ifHCPacketGroup=ifHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifStackTable=ifStackTable, ifHCOutOctets=ifHCOutOctets, ifTableLastChange=ifTableLastChange, interfaces=interfaces, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifOutErrors=ifOutErrors, ifXEntry=ifXEntry)
