...
RowStatus, TextualConvention, DisplayString, TruthValue, TestAndIncr, PhysAddress, TimeStamp, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "DisplayString", "TruthValue", "TestAndIncr", "PhysAddress", "TimeStamp", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifXEntry=ifXEntry, ifRcvAddressAddress=ifRcvAddressAddress, linkDown=linkDown, ifTableLastChange=ifTableLastChange, ifMIBObjects=ifMIBObjects, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInOctets=ifInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInMulticastPkts=ifInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifStackStatus=ifStackStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHighSpeed=ifHighSpeed, ifMIB=ifMIB, ifSpeed=ifSpeed, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndex=InterfaceIndex, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifInUcastPkts=ifInUcastPkts, ifTestEntry=ifTestEntry, ifType=ifType, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestOwner=ifTestOwner, ifGroups=ifGroups, ifVHCPacketGroup=ifVHCPacketGroup, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, ifConnectorPresent=ifConnectorPresent, ifTestStatus=ifTestStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifStackTable=ifStackTable, ifCompliance=ifCompliance, OwnerString=OwnerString, ifRcvAddressStatus=ifRcvAddressStatus, ifTestType=ifTestType, ifTable=ifTable, ifTestCode=ifTestCode, ifEntry=ifEntry, ifStackGroup=ifStackGroup, PYSNMP_MODULE_ID=ifMIB, ifOutOctets=ifOutOctets, ifOutErrors=ifOutErrors, ifIndex=ifIndex, ifAlias=ifAlias, ifTestTable=ifTestTable, ifCompliance3=ifCompliance3, ifSpecific=ifSpecific, ifRcvAddressType=ifRcvAddressType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifName=ifName, ifPacketGroup=ifPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutQLen=ifOutQLen, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifStackGroup2=ifStackGroup2, interfaces=interfaces, ifNumber=ifNumber, ifConformance=ifConformance, ifInErrors=ifInErrors, ifLastChange=ifLastChange, ifDescr=ifDescr, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifXTable=ifXTable, ifGeneralGroup=ifGeneralGroup, ifInDiscards=ifInDiscards, ifCompliances=ifCompliances, ifStackHigherLayer=ifStackHigherLayer, ifHCInOctets=ifHCInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifAdminStatus=ifAdminStatus, ifTestId=ifTestId, ifMtu=ifMtu, ifStackLastChange=ifStackLastChange, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, linkUp=linkUp, ifHCOutOctets=ifHCOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestGroup=ifTestGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressTable=ifRcvAddressTable, ifTestResult=ifTestResult)
