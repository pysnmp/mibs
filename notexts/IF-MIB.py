...
DisplayString, AutonomousType, TimeStamp, TestAndIncr, RowStatus, TextualConvention, TruthValue, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "AutonomousType", "TimeStamp", "TestAndIncr", "RowStatus", "TextualConvention", "TruthValue", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestId=ifTestId, ifStackStatus=ifStackStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifXTable=ifXTable, ifInDiscards=ifInDiscards, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInErrors=ifInErrors, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTable=ifTable, ifStackLastChange=ifStackLastChange, ifRcvAddressTable=ifRcvAddressTable, ifTestGroup=ifTestGroup, ifOutQLen=ifOutQLen, ifHCOutUcastPkts=ifHCOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifInMulticastPkts=ifInMulticastPkts, ifOutUcastPkts=ifOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifStackGroup=ifStackGroup, ifHCOutOctets=ifHCOutOctets, ifOldObjectsGroup=ifOldObjectsGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifEntry=ifEntry, ifOutDiscards=ifOutDiscards, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGroups=ifGroups, ifInOctets=ifInOctets, ifMIB=ifMIB, ifStackTable=ifStackTable, ifOutOctets=ifOutOctets, PYSNMP_MODULE_ID=ifMIB, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMtu=ifMtu, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifTestStatus=ifTestStatus, ifSpeed=ifSpeed, ifHCInOctets=ifHCInOctets, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifTestCode=ifTestCode, ifOutErrors=ifOutErrors, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGeneralGroup=ifGeneralGroup, ifInUnknownProtos=ifInUnknownProtos, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestType=ifTestType, ifRcvAddressStatus=ifRcvAddressStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifType=ifType, ifTestTable=ifTestTable, ifIndex=ifIndex, ifNumber=ifNumber, ifLastChange=ifLastChange, ifStackEntry=ifStackEntry, ifConformance=ifConformance, interfaces=interfaces, ifCompliance=ifCompliance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUp=linkUp, ifCompliance3=ifCompliance3, ifStackLowerLayer=ifStackLowerLayer, ifName=ifName, ifRcvAddressType=ifRcvAddressType, ifAlias=ifAlias, ifInBroadcastPkts=ifInBroadcastPkts, ifInUcastPkts=ifInUcastPkts, ifHighSpeed=ifHighSpeed, ifPhysAddress=ifPhysAddress, linkDown=linkDown, ifMIBObjects=ifMIBObjects, ifTestResult=ifTestResult, ifStackGroup2=ifStackGroup2, InterfaceIndex=InterfaceIndex, ifXEntry=ifXEntry, ifAdminStatus=ifAdminStatus, ifSpecific=ifSpecific, ifCompliances=ifCompliances)
