...
TestAndIncr, RowStatus, PhysAddress, DisplayString, AutonomousType, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "PhysAddress", "DisplayString", "AutonomousType", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifStackLastChange=ifStackLastChange, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackEntry=ifStackEntry, ifLastChange=ifLastChange, ifTestCode=ifTestCode, ifInUcastPkts=ifInUcastPkts, ifTestEntry=ifTestEntry, ifInErrors=ifInErrors, ifType=ifType, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressType=ifRcvAddressType, ifOutErrors=ifOutErrors, PYSNMP_MODULE_ID=ifMIB, ifTestTable=ifTestTable, ifMIBObjects=ifMIBObjects, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTestResult=ifTestResult, ifOutUcastPkts=ifOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutOctets=ifHCOutOctets, ifAdminStatus=ifAdminStatus, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifHighSpeed=ifHighSpeed, ifCompliances=ifCompliances, ifStackTable=ifStackTable, ifInNUcastPkts=ifInNUcastPkts, ifStackStatus=ifStackStatus, ifCompliance3=ifCompliance3, ifXEntry=ifXEntry, ifInDiscards=ifInDiscards, ifOutDiscards=ifOutDiscards, ifNumber=ifNumber, ifOutQLen=ifOutQLen, ifTestId=ifTestId, ifCompliance2=ifCompliance2, ifAlias=ifAlias, ifOutOctets=ifOutOctets, ifName=ifName, interfaces=interfaces, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLowerLayer=ifStackLowerLayer, ifInOctets=ifInOctets, ifIndex=ifIndex, OwnerString=OwnerString, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkUp=linkUp, ifGroups=ifGroups, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifTestType=ifTestType, ifGeneralGroup=ifGeneralGroup, ifPacketGroup=ifPacketGroup, ifConformance=ifConformance, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackGroup=ifStackGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifPhysAddress=ifPhysAddress, ifCompliance=ifCompliance, ifSpeed=ifSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpecific=ifSpecific, ifTable=ifTable, ifEntry=ifEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifTestGroup=ifTestGroup, ifDescr=ifDescr, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestStatus=ifTestStatus, InterfaceIndex=InterfaceIndex, ifOperStatus=ifOperStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifHCInOctets=ifHCInOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCPacketGroup=ifHCPacketGroup, ifConnectorPresent=ifConnectorPresent, linkDown=linkDown, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMtu=ifMtu, ifStackGroup2=ifStackGroup2, ifRcvAddressGroup=ifRcvAddressGroup)
