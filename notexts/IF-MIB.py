...
TextualConvention, TruthValue, TimeStamp, AutonomousType, DisplayString, TestAndIncr, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "TruthValue", "TimeStamp", "AutonomousType", "DisplayString", "TestAndIncr", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifType=ifType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestId=ifTestId, ifConformance=ifConformance, ifName=ifName, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifNumber=ifNumber, ifConnectorPresent=ifConnectorPresent, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTable=ifTable, ifXEntry=ifXEntry, ifInDiscards=ifInDiscards, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifCompliance3=ifCompliance3, InterfaceIndex=InterfaceIndex, ifInUnknownProtos=ifInUnknownProtos, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifAdminStatus=ifAdminStatus, ifMIBObjects=ifMIBObjects, ifStackGroup2=ifStackGroup2, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifTestStatus=ifTestStatus, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, ifInBroadcastPkts=ifInBroadcastPkts, ifInOctets=ifInOctets, ifTestOwner=ifTestOwner, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifXTable=ifXTable, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifMIB=ifMIB, ifRcvAddressAddress=ifRcvAddressAddress, ifStackTable=ifStackTable, PYSNMP_MODULE_ID=ifMIB, ifInUcastPkts=ifInUcastPkts, ifTableLastChange=ifTableLastChange, ifStackEntry=ifStackEntry, interfaces=interfaces, ifTestGroup=ifTestGroup, ifIndex=ifIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkUp=linkUp, ifSpecific=ifSpecific, ifHCInMulticastPkts=ifHCInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, ifRcvAddressTable=ifRcvAddressTable, ifPromiscuousMode=ifPromiscuousMode, ifOperStatus=ifOperStatus, ifTestResult=ifTestResult, ifGroups=ifGroups, ifPacketGroup=ifPacketGroup, ifDescr=ifDescr, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressType=ifRcvAddressType, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutErrors=ifOutErrors, ifPhysAddress=ifPhysAddress, ifHighSpeed=ifHighSpeed, ifOutUcastPkts=ifOutUcastPkts, ifCompliances=ifCompliances, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpeed=ifSpeed, ifEntry=ifEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifStackHigherLayer=ifStackHigherLayer, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifTestCode=ifTestCode, ifCompliance=ifCompliance, ifOutDiscards=ifOutDiscards, ifInMulticastPkts=ifInMulticastPkts, ifHCOutOctets=ifHCOutOctets, linkDown=linkDown, ifTestType=ifTestType, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors)
