...
TruthValue, AutonomousType, TestAndIncr, DisplayString, TextualConvention, RowStatus, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "TestAndIncr", "DisplayString", "TextualConvention", "RowStatus", "PhysAddress", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifPromiscuousMode=ifPromiscuousMode, ifInDiscards=ifInDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifCompliances=ifCompliances, ifOldObjectsGroup=ifOldObjectsGroup, ifTestGroup=ifTestGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifStackEntry=ifStackEntry, ifEntry=ifEntry, ifHCInOctets=ifHCInOctets, ifTestTable=ifTestTable, ifConnectorPresent=ifConnectorPresent, OwnerString=OwnerString, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifTestType=ifTestType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestCode=ifTestCode, ifTestResult=ifTestResult, ifInNUcastPkts=ifInNUcastPkts, ifGeneralGroup=ifGeneralGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMIBObjects=ifMIBObjects, ifXEntry=ifXEntry, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifRcvAddressType=ifRcvAddressType, ifPacketGroup=ifPacketGroup, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards, linkUp=linkUp, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpeed=ifSpeed, ifIndex=ifIndex, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndex=InterfaceIndex, ifCompliance3=ifCompliance3, ifTableLastChange=ifTableLastChange, ifRcvAddressTable=ifRcvAddressTable, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutQLen=ifOutQLen, ifConformance=ifConformance, ifInOctets=ifInOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifCompliance2=ifCompliance2, ifOutUcastPkts=ifOutUcastPkts, ifStackGroup2=ifStackGroup2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOperStatus=ifOperStatus, ifOutOctets=ifOutOctets, ifXTable=ifXTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifSpecific=ifSpecific, ifHCOutOctets=ifHCOutOctets, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifInErrors=ifInErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifGroups=ifGroups, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestId=ifTestId, ifAdminStatus=ifAdminStatus, ifMtu=ifMtu, ifHCPacketGroup=ifHCPacketGroup, ifDescr=ifDescr, ifTable=ifTable, ifStackTable=ifStackTable, interfaces=interfaces, ifMIB=ifMIB, ifAlias=ifAlias, ifTestOwner=ifTestOwner, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifNumber=ifNumber, ifStackGroup=ifStackGroup, ifName=ifName, ifFixedLengthGroup=ifFixedLengthGroup, ifTestStatus=ifTestStatus, ifType=ifType, ifCompliance=ifCompliance, ifInUnknownProtos=ifInUnknownProtos, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts)
