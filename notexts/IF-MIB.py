...
TruthValue, TextualConvention, AutonomousType, TestAndIncr, RowStatus, PhysAddress, DisplayString, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "AutonomousType", "TestAndIncr", "RowStatus", "PhysAddress", "DisplayString", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifInUcastPkts=ifInUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifLastChange=ifLastChange, ifPhysAddress=ifPhysAddress, ifStackEntry=ifStackEntry, ifStackHigherLayer=ifStackHigherLayer, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifStackStatus=ifStackStatus, ifConnectorPresent=ifConnectorPresent, interfaces=interfaces, ifTestId=ifTestId, ifTestResult=ifTestResult, ifStackGroup=ifStackGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifVHCPacketGroup=ifVHCPacketGroup, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifHCOutUcastPkts=ifHCOutUcastPkts, linkDown=linkDown, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifHighSpeed=ifHighSpeed, ifInBroadcastPkts=ifInBroadcastPkts, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, linkUp=linkUp, ifTable=ifTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifSpeed=ifSpeed, ifType=ifType, ifCompliance=ifCompliance, ifStackTable=ifStackTable, ifInMulticastPkts=ifInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifXTable=ifXTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifTestOwner=ifTestOwner, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressGroup=ifRcvAddressGroup, ifPacketGroup=ifPacketGroup, ifStackLowerLayer=ifStackLowerLayer, ifTestGroup=ifTestGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXEntry=ifXEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliances=ifCompliances, ifStackLastChange=ifStackLastChange, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifTestCode=ifTestCode, ifNumber=ifNumber, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifName=ifName, ifTestTable=ifTestTable, ifCompliance2=ifCompliance2, ifInUnknownProtos=ifInUnknownProtos, ifHCInUcastPkts=ifHCInUcastPkts, OwnerString=OwnerString, ifInOctets=ifInOctets, ifConformance=ifConformance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMIBObjects=ifMIBObjects, ifPromiscuousMode=ifPromiscuousMode, ifOutErrors=ifOutErrors, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifAlias=ifAlias, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType, ifRcvAddressTable=ifRcvAddressTable, ifEntry=ifEntry, InterfaceIndex=InterfaceIndex, ifHCInOctets=ifHCInOctets, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifMIB=ifMIB, ifMtu=ifMtu, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestStatus=ifTestStatus)
