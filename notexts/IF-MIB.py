...
AutonomousType, PhysAddress, RowStatus, DisplayString, TestAndIncr, TimeStamp, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "PhysAddress", "RowStatus", "DisplayString", "TestAndIncr", "TimeStamp", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifInUnknownProtos=ifInUnknownProtos, ifInMulticastPkts=ifInMulticastPkts, ifTestGroup=ifTestGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifInOctets=ifInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifType=ifType, ifCompliances=ifCompliances, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestId=ifTestId, ifOutOctets=ifOutOctets, ifAlias=ifAlias, linkUp=linkUp, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifRcvAddressTable=ifRcvAddressTable, ifTestStatus=ifTestStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifName=ifName, ifGeneralGroup=ifGeneralGroup, ifSpecific=ifSpecific, ifStackGroup=ifStackGroup, ifCompliance=ifCompliance, ifTable=ifTable, ifRcvAddressGroup=ifRcvAddressGroup, ifConformance=ifConformance, ifDescr=ifDescr, ifMIBObjects=ifMIBObjects, ifOutMulticastPkts=ifOutMulticastPkts, ifXTable=ifXTable, ifCompliance3=ifCompliance3, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, ifCompliance2=ifCompliance2, ifVHCPacketGroup=ifVHCPacketGroup, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, OwnerString=OwnerString, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifStackHigherLayer=ifStackHigherLayer, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInErrors=ifInErrors, ifOutQLen=ifOutQLen, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackStatus=ifStackStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifMtu=ifMtu, ifOutDiscards=ifOutDiscards, ifMIB=ifMIB, ifInNUcastPkts=ifInNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackGroup2=ifStackGroup2, PYSNMP_MODULE_ID=ifMIB, ifHCPacketGroup=ifHCPacketGroup, interfaces=interfaces, ifConnectorPresent=ifConnectorPresent, ifOutNUcastPkts=ifOutNUcastPkts, ifInDiscards=ifInDiscards, ifTestEntry=ifTestEntry, ifTestCode=ifTestCode, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, InterfaceIndexOrZero=InterfaceIndexOrZero, ifFixedLengthGroup=ifFixedLengthGroup, ifEntry=ifEntry, linkDown=linkDown, ifOutUcastPkts=ifOutUcastPkts, ifOutErrors=ifOutErrors, ifSpeed=ifSpeed, ifLastChange=ifLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifOperStatus=ifOperStatus, ifRcvAddressType=ifRcvAddressType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInOctets=ifHCInOctets, ifTestOwner=ifTestOwner, ifOldObjectsGroup=ifOldObjectsGroup, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressEntry=ifRcvAddressEntry, ifStackEntry=ifStackEntry, ifNumber=ifNumber, ifHCOutOctets=ifHCOutOctets, ifTestTable=ifTestTable, ifPacketGroup=ifPacketGroup, ifStackTable=ifStackTable)
