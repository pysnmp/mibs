...
RowStatus, TextualConvention, TimeStamp, DisplayString, TestAndIncr, TruthValue, AutonomousType, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "TimeStamp", "DisplayString", "TestAndIncr", "TruthValue", "AutonomousType", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifOperStatus=ifOperStatus, ifName=ifName, ifHighSpeed=ifHighSpeed, ifDescr=ifDescr, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, interfaces=interfaces, ifCompliance=ifCompliance, ifInNUcastPkts=ifInNUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifSpecific=ifSpecific, ifSpeed=ifSpeed, ifRcvAddressTable=ifRcvAddressTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, linkDown=linkDown, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifConnectorPresent=ifConnectorPresent, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestEntry=ifTestEntry, PYSNMP_MODULE_ID=ifMIB, ifNumber=ifNumber, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackGroup=ifStackGroup, ifPacketGroup=ifPacketGroup, ifOutDiscards=ifOutDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifInErrors=ifInErrors, ifInDiscards=ifInDiscards, ifConformance=ifConformance, ifStackTable=ifStackTable, ifPhysAddress=ifPhysAddress, ifStackGroup2=ifStackGroup2, ifIndex=ifIndex, ifCompliance3=ifCompliance3, ifRcvAddressGroup=ifRcvAddressGroup, ifEntry=ifEntry, ifStackStatus=ifStackStatus, ifInOctets=ifInOctets, ifStackLastChange=ifStackLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifCompliances=ifCompliances, ifInBroadcastPkts=ifInBroadcastPkts, ifMtu=ifMtu, ifOutErrors=ifOutErrors, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifStackLowerLayer=ifStackLowerLayer, ifTestCode=ifTestCode, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, InterfaceIndex=InterfaceIndex, ifTableLastChange=ifTableLastChange, ifTable=ifTable, ifTestTable=ifTestTable, ifOutMulticastPkts=ifOutMulticastPkts, ifTestOwner=ifTestOwner, ifHCInUcastPkts=ifHCInUcastPkts, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifType=ifType, ifAdminStatus=ifAdminStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifGroups=ifGroups, ifTestType=ifTestType, ifHCInOctets=ifHCInOctets, OwnerString=OwnerString, ifTestResult=ifTestResult, ifHCOutOctets=ifHCOutOctets, ifMIB=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifTestGroup=ifTestGroup, ifLastChange=ifLastChange, ifOutQLen=ifOutQLen, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifTestStatus=ifTestStatus, ifMIBObjects=ifMIBObjects, ifOutOctets=ifOutOctets)
