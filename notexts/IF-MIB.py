...
DisplayString, TestAndIncr, PhysAddress, TruthValue, TimeStamp, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "PhysAddress", "TruthValue", "TimeStamp", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifPacketGroup=ifPacketGroup, ifHCPacketGroup=ifHCPacketGroup, ifInOctets=ifInOctets, ifHCInOctets=ifHCInOctets, ifStackLastChange=ifStackLastChange, ifMIBObjects=ifMIBObjects, ifCompliance3=ifCompliance3, ifInUcastPkts=ifInUcastPkts, ifAlias=ifAlias, ifInDiscards=ifInDiscards, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutDiscards=ifOutDiscards, ifRcvAddressTable=ifRcvAddressTable, linkDown=linkDown, ifOutErrors=ifOutErrors, ifOutQLen=ifOutQLen, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLastChange=ifLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAdminStatus=ifAdminStatus, ifCompliance=ifCompliance, ifTestTable=ifTestTable, ifFixedLengthGroup=ifFixedLengthGroup, ifTestGroup=ifTestGroup, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifConformance=ifConformance, ifMtu=ifMtu, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifGroups=ifGroups, ifTestType=ifTestType, ifSpecific=ifSpecific, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifTableLastChange=ifTableLastChange, ifName=ifName, ifInMulticastPkts=ifInMulticastPkts, ifCompliances=ifCompliances, ifOperStatus=ifOperStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifEntry=ifEntry, ifStackGroup2=ifStackGroup2, OwnerString=OwnerString, ifHCOutOctets=ifHCOutOctets, ifType=ifType, ifSpeed=ifSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifNumber=ifNumber, ifMIB=ifMIB, ifOutOctets=ifOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutUcastPkts=ifOutUcastPkts, ifStackEntry=ifStackEntry, ifStackHigherLayer=ifStackHigherLayer, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackTable=ifStackTable, ifXEntry=ifXEntry, InterfaceIndex=InterfaceIndex, ifRcvAddressType=ifRcvAddressType, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, ifTestEntry=ifTestEntry, ifCompliance2=ifCompliance2, ifHighSpeed=ifHighSpeed, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, interfaces=interfaces, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifXTable=ifXTable, ifTestResult=ifTestResult, ifStackGroup=ifStackGroup, ifPromiscuousMode=ifPromiscuousMode, ifInBroadcastPkts=ifInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressEntry=ifRcvAddressEntry, ifTestStatus=ifTestStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestOwner=ifTestOwner, ifOutMulticastPkts=ifOutMulticastPkts, linkUp=linkUp, ifDescr=ifDescr, ifIndex=ifIndex, ifTestId=ifTestId, ifOldObjectsGroup=ifOldObjectsGroup, ifPhysAddress=ifPhysAddress, ifTestCode=ifTestCode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTable=ifTable, ifGeneralGroup=ifGeneralGroup)
