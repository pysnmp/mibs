...
TextualConvention, DisplayString, PhysAddress, TruthValue, TestAndIncr, AutonomousType, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "PhysAddress", "TruthValue", "TestAndIncr", "AutonomousType", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifInNUcastPkts=ifInNUcastPkts, ifTestId=ifTestId, ifInOctets=ifInOctets, ifName=ifName, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTestGroup=ifTestGroup, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifGroups=ifGroups, ifInDiscards=ifInDiscards, ifRcvAddressType=ifRcvAddressType, ifOperStatus=ifOperStatus, ifTestOwner=ifTestOwner, PYSNMP_MODULE_ID=ifMIB, ifCompliances=ifCompliances, ifStackLowerLayer=ifStackLowerLayer, ifType=ifType, ifXTable=ifXTable, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifOutOctets=ifOutOctets, ifConformance=ifConformance, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifInMulticastPkts=ifInMulticastPkts, ifInErrors=ifInErrors, ifHCInOctets=ifHCInOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifTable=ifTable, ifFixedLengthGroup=ifFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifHCPacketGroup=ifHCPacketGroup, ifTableLastChange=ifTableLastChange, ifTestEntry=ifTestEntry, ifXEntry=ifXEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifOutQLen=ifOutQLen, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifNumber=ifNumber, ifMIB=ifMIB, ifConnectorPresent=ifConnectorPresent, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifEntry=ifEntry, ifDescr=ifDescr, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifCompliance3=ifCompliance3, OwnerString=OwnerString, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackTable=ifStackTable, ifOutErrors=ifOutErrors, ifOldObjectsGroup=ifOldObjectsGroup, ifTestStatus=ifTestStatus, ifMtu=ifMtu, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifIndex=ifIndex, ifAdminStatus=ifAdminStatus, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkDown=linkDown, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifStackGroup2=ifStackGroup2, ifStackStatus=ifStackStatus, ifInUcastPkts=ifInUcastPkts, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifPromiscuousMode=ifPromiscuousMode, ifOutMulticastPkts=ifOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, interfaces=interfaces, InterfaceIndex=InterfaceIndex, ifMIBObjects=ifMIBObjects, ifVHCPacketGroup=ifVHCPacketGroup, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifCompliance2=ifCompliance2, ifTestType=ifTestType, linkUp=linkUp, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifPacketGroup=ifPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressTable=ifRcvAddressTable)
