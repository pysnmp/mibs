...
RowStatus, TimeStamp, TestAndIncr, TruthValue, AutonomousType, DisplayString, PhysAddress, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "TestAndIncr", "TruthValue", "AutonomousType", "DisplayString", "PhysAddress", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifFixedLengthGroup=ifFixedLengthGroup, ifOutDiscards=ifOutDiscards, ifRcvAddressTable=ifRcvAddressTable, ifCompliance2=ifCompliance2, ifGeneralGroup=ifGeneralGroup, ifPromiscuousMode=ifPromiscuousMode, ifEntry=ifEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressGroup=ifRcvAddressGroup, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup2=ifStackGroup2, ifStackStatus=ifStackStatus, ifName=ifName, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressStatus=ifRcvAddressStatus, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, OwnerString=OwnerString, ifAdminStatus=ifAdminStatus, ifXTable=ifXTable, ifNumber=ifNumber, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, linkDown=linkDown, ifTestType=ifTestType, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifInNUcastPkts=ifInNUcastPkts, ifTestId=ifTestId, ifTableLastChange=ifTableLastChange, ifHighSpeed=ifHighSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutOctets=ifHCOutOctets, ifOutQLen=ifOutQLen, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, ifInUnknownProtos=ifInUnknownProtos, ifInUcastPkts=ifInUcastPkts, ifType=ifType, ifXEntry=ifXEntry, ifTestCode=ifTestCode, ifHCInUcastPkts=ifHCInUcastPkts, ifTestTable=ifTestTable, ifStackLowerLayer=ifStackLowerLayer, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLastChange=ifStackLastChange, ifTestGroup=ifTestGroup, ifSpecific=ifSpecific, ifIndex=ifIndex, ifCompliances=ifCompliances, ifPacketGroup=ifPacketGroup, ifCompliance3=ifCompliance3, ifInMulticastPkts=ifInMulticastPkts, ifOperStatus=ifOperStatus, interfaces=interfaces, ifCompliance=ifCompliance, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifInDiscards=ifInDiscards, ifOutErrors=ifOutErrors, ifStackTable=ifStackTable, ifMIB=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestStatus=ifTestStatus, ifStackEntry=ifStackEntry, ifLastChange=ifLastChange, ifConformance=ifConformance, PYSNMP_MODULE_ID=ifMIB, ifStackGroup=ifStackGroup, ifInOctets=ifInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMtu=ifMtu, ifInErrors=ifInErrors, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutOctets=ifOutOctets, linkUp=linkUp, ifAlias=ifAlias, ifMIBObjects=ifMIBObjects, ifOutUcastPkts=ifOutUcastPkts, ifTestOwner=ifTestOwner, ifSpeed=ifSpeed, ifGroups=ifGroups, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInOctets=ifHCInOctets, ifTestResult=ifTestResult, ifTable=ifTable, ifTestEntry=ifTestEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifConnectorPresent=ifConnectorPresent)
