...
mib_2, NotificationType, Counter64, Bits, IpAddress, Gauge32, Unsigned32, ModuleIdentity, iso, TimeTicks, MibIdentifier, ObjectIdentity, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "NotificationType", "Counter64", "Bits", "IpAddress", "Gauge32", "Unsigned32", "ModuleIdentity", "iso", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
PhysAddress, TextualConvention, TruthValue, TestAndIncr, RowStatus, TimeStamp, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "TruthValue", "TestAndIncr", "RowStatus", "TimeStamp", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifPhysAddress=ifPhysAddress, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressType=ifRcvAddressType, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifAdminStatus=ifAdminStatus, ifMIB=ifMIB, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestOwner=ifTestOwner, ifInOctets=ifInOctets, ifCompliances=ifCompliances, ifTestEntry=ifTestEntry, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpeed=ifSpeed, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifOutDiscards=ifOutDiscards, ifPromiscuousMode=ifPromiscuousMode, ifTestTable=ifTestTable, ifTestResult=ifTestResult, ifConformance=ifConformance, PYSNMP_MODULE_ID=ifMIB, ifGeneralInformationGroup=ifGeneralInformationGroup, InterfaceIndex=InterfaceIndex, ifTestId=ifTestId, ifStackGroup=ifStackGroup, ifAlias=ifAlias, interfaces=interfaces, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInOctets=ifHCInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackStatus=ifStackStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifPacketGroup=ifPacketGroup, ifCompliance=ifCompliance, ifInDiscards=ifInDiscards, ifRcvAddressTable=ifRcvAddressTable, ifTestCode=ifTestCode, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutQLen=ifOutQLen, ifEntry=ifEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifInUnknownProtos=ifInUnknownProtos, ifName=ifName, ifSpecific=ifSpecific, ifHighSpeed=ifHighSpeed, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifStackLastChange=ifStackLastChange, ifTable=ifTable, ifConnectorPresent=ifConnectorPresent, ifOutErrors=ifOutErrors, ifInNUcastPkts=ifInNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifMtu=ifMtu, ifCompliance2=ifCompliance2, OwnerString=OwnerString, ifStackTable=ifStackTable, ifOperStatus=ifOperStatus, ifRcvAddressGroup=ifRcvAddressGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, linkDown=linkDown, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLastChange=ifLastChange, ifRcvAddressStatus=ifRcvAddressStatus, linkUp=linkUp, ifTestType=ifTestType, ifDescr=ifDescr, ifGeneralGroup=ifGeneralGroup, ifStackGroup2=ifStackGroup2, ifStackHigherLayer=ifStackHigherLayer, ifHCPacketGroup=ifHCPacketGroup, ifType=ifType, ifCompliance3=ifCompliance3, ifIndex=ifIndex, ifTableLastChange=ifTableLastChange, ifNumber=ifNumber, ifGroups=ifGroups, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifMIBObjects=ifMIBObjects, ifInBroadcastPkts=ifInBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
