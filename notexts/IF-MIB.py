...
PhysAddress, TestAndIncr, DisplayString, RowStatus, TimeStamp, AutonomousType, TruthValue, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TestAndIncr", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType", "TruthValue", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressTable=ifRcvAddressTable, ifPacketGroup=ifPacketGroup, InterfaceIndex=InterfaceIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressType=ifRcvAddressType, interfaces=interfaces, ifRcvAddressAddress=ifRcvAddressAddress, ifName=ifName, linkUp=linkUp, ifInErrors=ifInErrors, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifGeneralGroup=ifGeneralGroup, ifInDiscards=ifInDiscards, ifTestOwner=ifTestOwner, ifTableLastChange=ifTableLastChange, OwnerString=OwnerString, ifTestTable=ifTestTable, ifStackStatus=ifStackStatus, ifInNUcastPkts=ifInNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifNumber=ifNumber, ifHCInUcastPkts=ifHCInUcastPkts, PYSNMP_MODULE_ID=ifMIB, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXEntry=ifXEntry, ifConformance=ifConformance, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifCompliance=ifCompliance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifSpeed=ifSpeed, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifPhysAddress=ifPhysAddress, linkDown=linkDown, ifXTable=ifXTable, ifType=ifType, ifInOctets=ifInOctets, ifStackGroup=ifStackGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliance2=ifCompliance2, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifVHCPacketGroup=ifVHCPacketGroup, ifConnectorPresent=ifConnectorPresent, ifStackGroup2=ifStackGroup2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifAdminStatus=ifAdminStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackEntry=ifStackEntry, ifOutOctets=ifOutOctets, ifStackTable=ifStackTable, ifSpecific=ifSpecific, ifDescr=ifDescr, ifAlias=ifAlias, ifRcvAddressEntry=ifRcvAddressEntry, ifOutUcastPkts=ifOutUcastPkts, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestType=ifTestType, ifFixedLengthGroup=ifFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifOutErrors=ifOutErrors, ifHighSpeed=ifHighSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifLastChange=ifLastChange, ifMIB=ifMIB, ifGroups=ifGroups, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestId=ifTestId, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLastChange=ifStackLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutQLen=ifOutQLen, ifInUnknownProtos=ifInUnknownProtos, ifHCInOctets=ifHCInOctets, ifTestStatus=ifTestStatus, ifOutDiscards=ifOutDiscards, ifTestCode=ifTestCode, ifCompliance3=ifCompliance3, ifTestEntry=ifTestEntry, ifEntry=ifEntry, ifInUcastPkts=ifInUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup)
