...
TextualConvention, PhysAddress, TruthValue, RowStatus, DisplayString, AutonomousType, TestAndIncr, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "TruthValue", "RowStatus", "DisplayString", "AutonomousType", "TestAndIncr", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, ifInErrors=ifInErrors, ifTableLastChange=ifTableLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLastChange=ifStackLastChange, ifTestEntry=ifTestEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, InterfaceIndex=InterfaceIndex, ifStackGroup2=ifStackGroup2, interfaces=interfaces, ifMtu=ifMtu, ifConformance=ifConformance, ifOutOctets=ifOutOctets, ifMIB=ifMIB, ifOperStatus=ifOperStatus, ifPromiscuousMode=ifPromiscuousMode, ifTestResult=ifTestResult, ifTestTable=ifTestTable, ifTestStatus=ifTestStatus, ifConnectorPresent=ifConnectorPresent, ifEntry=ifEntry, ifVHCPacketGroup=ifVHCPacketGroup, linkUp=linkUp, OwnerString=OwnerString, PYSNMP_MODULE_ID=ifMIB, ifStackTable=ifStackTable, ifInNUcastPkts=ifInNUcastPkts, ifTestOwner=ifTestOwner, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifRcvAddressTable=ifRcvAddressTable, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifLastChange=ifLastChange, ifCompliance3=ifCompliance3, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressAddress=ifRcvAddressAddress, ifInMulticastPkts=ifInMulticastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTable=ifTable, linkDown=linkDown, ifStackEntry=ifStackEntry, ifPhysAddress=ifPhysAddress, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifSpeed=ifSpeed, ifAdminStatus=ifAdminStatus, ifIndex=ifIndex, ifName=ifName, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifMIBObjects=ifMIBObjects, ifInDiscards=ifInDiscards, ifXTable=ifXTable, ifCompliances=ifCompliances, ifRcvAddressType=ifRcvAddressType, ifAlias=ifAlias, ifCompliance2=ifCompliance2, ifHCInOctets=ifHCInOctets, ifStackLowerLayer=ifStackLowerLayer, ifDescr=ifDescr, ifHighSpeed=ifHighSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestType=ifTestType, ifOutUcastPkts=ifOutUcastPkts, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInMulticastPkts=ifHCInMulticastPkts, ifNumber=ifNumber, ifHCOutOctets=ifHCOutOctets, ifPacketGroup=ifPacketGroup, ifHCPacketGroup=ifHCPacketGroup, ifCompliance=ifCompliance, ifTestCode=ifTestCode, ifInBroadcastPkts=ifInBroadcastPkts, ifType=ifType, ifGeneralGroup=ifGeneralGroup, ifStackStatus=ifStackStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifGroups=ifGroups, ifRcvAddressEntry=ifRcvAddressEntry, ifInUcastPkts=ifInUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutQLen=ifOutQLen, ifStackHigherLayer=ifStackHigherLayer, ifOutErrors=ifOutErrors, ifTestGroup=ifTestGroup)
