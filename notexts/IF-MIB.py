...
Counter32, Gauge32, Counter64, TimeTicks, mib_2, iso, NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Counter64", "TimeTicks", "mib-2", "iso", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "Integer32", "Bits")
TruthValue, DisplayString, PhysAddress, TextualConvention, TestAndIncr, AutonomousType, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "PhysAddress", "TextualConvention", "TestAndIncr", "AutonomousType", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressEntry=ifRcvAddressEntry, ifVHCPacketGroup=ifVHCPacketGroup, linkDown=linkDown, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance3=ifCompliance3, ifOutUcastPkts=ifOutUcastPkts, ifInErrors=ifInErrors, ifXTable=ifXTable, ifTestType=ifTestType, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifAdminStatus=ifAdminStatus, OwnerString=OwnerString, ifHCInMulticastPkts=ifHCInMulticastPkts, ifAlias=ifAlias, ifTestTable=ifTestTable, ifTestOwner=ifTestOwner, InterfaceIndexOrZero=InterfaceIndexOrZero, InterfaceIndex=InterfaceIndex, ifLastChange=ifLastChange, ifTestGroup=ifTestGroup, ifConnectorPresent=ifConnectorPresent, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCInOctets=ifHCInOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance2=ifCompliance2, ifGeneralGroup=ifGeneralGroup, ifName=ifName, ifOutErrors=ifOutErrors, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifType=ifType, ifMtu=ifMtu, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackEntry=ifStackEntry, ifPacketGroup=ifPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUp=linkUp, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, ifStackTable=ifStackTable, ifCompliance=ifCompliance, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliances=ifCompliances, ifInBroadcastPkts=ifInBroadcastPkts, ifPhysAddress=ifPhysAddress, ifMIB=ifMIB, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifTestId=ifTestId, ifInOctets=ifInOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifHighSpeed=ifHighSpeed, ifTable=ifTable, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifDescr=ifDescr, ifSpeed=ifSpeed, ifTestCode=ifTestCode, ifEntry=ifEntry, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackGroup2=ifStackGroup2, ifPromiscuousMode=ifPromiscuousMode, ifIndex=ifIndex, ifOutNUcastPkts=ifOutNUcastPkts, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, interfaces=interfaces, ifHCPacketGroup=ifHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUnknownProtos=ifInUnknownProtos, ifStackStatus=ifStackStatus, ifRcvAddressType=ifRcvAddressType, ifStackLowerLayer=ifStackLowerLayer, ifNumber=ifNumber, ifTableLastChange=ifTableLastChange, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, PYSNMP_MODULE_ID=ifMIB, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifTestStatus=ifTestStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup)
