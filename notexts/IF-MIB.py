...
TextualConvention, AutonomousType, TestAndIncr, TruthValue, DisplayString, PhysAddress, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "AutonomousType", "TestAndIncr", "TruthValue", "DisplayString", "PhysAddress", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifEntry=ifEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInErrors=ifInErrors, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifStackTable=ifStackTable, ifGeneralGroup=ifGeneralGroup, ifTestStatus=ifTestStatus, interfaces=interfaces, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLastChange=ifStackLastChange, ifOutOctets=ifOutOctets, ifHCInMulticastPkts=ifHCInMulticastPkts, ifNumber=ifNumber, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressEntry=ifRcvAddressEntry, ifPhysAddress=ifPhysAddress, ifOldObjectsGroup=ifOldObjectsGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInUcastPkts=ifHCInUcastPkts, InterfaceIndex=InterfaceIndex, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndexOrZero=InterfaceIndexOrZero, ifType=ifType, ifAdminStatus=ifAdminStatus, ifOperStatus=ifOperStatus, ifStackGroup2=ifStackGroup2, ifOutUcastPkts=ifOutUcastPkts, ifCompliance2=ifCompliance2, ifMIBObjects=ifMIBObjects, ifInUcastPkts=ifInUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHighSpeed=ifHighSpeed, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance3=ifCompliance3, ifOutQLen=ifOutQLen, ifInNUcastPkts=ifInNUcastPkts, ifXEntry=ifXEntry, ifLastChange=ifLastChange, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifDescr=ifDescr, linkUp=linkUp, ifCompliances=ifCompliances, ifTableLastChange=ifTableLastChange, linkDown=linkDown, ifTestId=ifTestId, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifOutDiscards=ifOutDiscards, ifInDiscards=ifInDiscards, ifSpecific=ifSpecific, ifMIB=ifMIB, ifTestType=ifTestType, ifStackGroup=ifStackGroup, ifConnectorPresent=ifConnectorPresent, ifGroups=ifGroups, ifTable=ifTable, ifXTable=ifXTable, ifIndex=ifIndex, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackStatus=ifStackStatus, ifConformance=ifConformance, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifTestEntry=ifTestEntry, OwnerString=OwnerString, ifName=ifName, ifPacketGroup=ifPacketGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutErrors=ifOutErrors, ifAlias=ifAlias, ifInOctets=ifInOctets, ifMtu=ifMtu, ifInUnknownProtos=ifInUnknownProtos, ifTestTable=ifTestTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressAddress=ifRcvAddressAddress, ifTestOwner=ifTestOwner, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifSpeed=ifSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutOctets=ifHCOutOctets, ifRcvAddressType=ifRcvAddressType, ifTestCode=ifTestCode, ifHCInOctets=ifHCInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB)
