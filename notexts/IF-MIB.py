...
RowStatus, TextualConvention, AutonomousType, DisplayString, TruthValue, PhysAddress, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "AutonomousType", "DisplayString", "TruthValue", "PhysAddress", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressType=ifRcvAddressType, ifNumber=ifNumber, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifConformance=ifConformance, linkUp=linkUp, ifPacketGroup=ifPacketGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifStackGroup2=ifStackGroup2, ifTableLastChange=ifTableLastChange, ifStackLowerLayer=ifStackLowerLayer, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestCode=ifTestCode, ifTestId=ifTestId, ifPhysAddress=ifPhysAddress, ifInUnknownProtos=ifInUnknownProtos, ifAdminStatus=ifAdminStatus, ifInUcastPkts=ifInUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifHCPacketGroup=ifHCPacketGroup, linkDown=linkDown, ifSpeed=ifSpeed, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifTestTable=ifTestTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutDiscards=ifOutDiscards, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifRcvAddressAddress=ifRcvAddressAddress, InterfaceIndex=InterfaceIndex, ifCompliance3=ifCompliance3, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifCompliance=ifCompliance, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifLastChange=ifLastChange, ifConnectorPresent=ifConnectorPresent, ifXTable=ifXTable, ifOutMulticastPkts=ifOutMulticastPkts, ifMIB=ifMIB, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, ifTestStatus=ifTestStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifTestOwner=ifTestOwner, ifType=ifType, ifGeneralGroup=ifGeneralGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInErrors=ifInErrors, ifInNUcastPkts=ifInNUcastPkts, ifStackEntry=ifStackEntry, PYSNMP_MODULE_ID=ifMIB, ifPromiscuousMode=ifPromiscuousMode, ifTestEntry=ifTestEntry, ifName=ifName, ifTable=ifTable, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliances=ifCompliances, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifCompliance2=ifCompliance2, ifIndex=ifIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestType=ifTestType, ifAlias=ifAlias, ifOutErrors=ifOutErrors, ifOutQLen=ifOutQLen, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifInDiscards=ifInDiscards, interfaces=interfaces, ifStackLastChange=ifStackLastChange, ifHighSpeed=ifHighSpeed, ifRcvAddressStatus=ifRcvAddressStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCInOctets=ifHCInOctets, ifTestResult=ifTestResult, ifMIBObjects=ifMIBObjects, ifOutOctets=ifOutOctets, ifEntry=ifEntry, ifInOctets=ifInOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackGroup=ifStackGroup, ifDescr=ifDescr, ifMtu=ifMtu, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup)
