...
PhysAddress, TimeStamp, AutonomousType, DisplayString, TestAndIncr, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TimeStamp", "AutonomousType", "DisplayString", "TestAndIncr", "RowStatus", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifTestResult=ifTestResult, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifXEntry=ifXEntry, ifRcvAddressTable=ifRcvAddressTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifMIB=ifMIB, linkUp=linkUp, PYSNMP_MODULE_ID=ifMIB, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifInErrors=ifInErrors, ifStackTable=ifStackTable, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, ifInUnknownProtos=ifInUnknownProtos, ifTestOwner=ifTestOwner, linkDown=linkDown, ifInBroadcastPkts=ifInBroadcastPkts, ifStackStatus=ifStackStatus, ifConformance=ifConformance, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliance=ifCompliance, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressGroup=ifRcvAddressGroup, ifTestType=ifTestType, ifHCPacketGroup=ifHCPacketGroup, ifStackEntry=ifStackEntry, ifStackGroup2=ifStackGroup2, ifMIBObjects=ifMIBObjects, ifInOctets=ifInOctets, ifCompliance2=ifCompliance2, ifInUcastPkts=ifInUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTestCode=ifTestCode, ifNumber=ifNumber, ifType=ifType, ifStackGroup=ifStackGroup, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifHCInOctets=ifHCInOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutNUcastPkts=ifOutNUcastPkts, OwnerString=OwnerString, ifOutUcastPkts=ifOutUcastPkts, ifTable=ifTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCompliance3=ifCompliance3, ifGroups=ifGroups, ifName=ifName, ifCompliances=ifCompliances, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifLastChange=ifLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressType=ifRcvAddressType, ifTestId=ifTestId, ifStackLowerLayer=ifStackLowerLayer, ifXTable=ifXTable, ifEntry=ifEntry, ifInMulticastPkts=ifInMulticastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifTestGroup=ifTestGroup, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifOperStatus=ifOperStatus, ifMtu=ifMtu, ifOutErrors=ifOutErrors, ifConnectorPresent=ifConnectorPresent, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestTable=ifTestTable, ifIndex=ifIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestStatus=ifTestStatus, ifHCOutOctets=ifHCOutOctets, ifPhysAddress=ifPhysAddress, ifSpecific=ifSpecific, ifHighSpeed=ifHighSpeed, ifAdminStatus=ifAdminStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifFixedLengthGroup=ifFixedLengthGroup, interfaces=interfaces, ifInNUcastPkts=ifInNUcastPkts, ifTestEntry=ifTestEntry, ifRcvAddressAddress=ifRcvAddressAddress)
