...
TestAndIncr, TruthValue, AutonomousType, PhysAddress, DisplayString, TextualConvention, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TruthValue", "AutonomousType", "PhysAddress", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifSpecific=ifSpecific, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifPromiscuousMode=ifPromiscuousMode, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup2=ifStackGroup2, ifMtu=ifMtu, OwnerString=OwnerString, ifTestTable=ifTestTable, ifHCOutOctets=ifHCOutOctets, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance2=ifCompliance2, ifInUcastPkts=ifInUcastPkts, ifOperStatus=ifOperStatus, ifCompliance3=ifCompliance3, ifOldObjectsGroup=ifOldObjectsGroup, ifSpeed=ifSpeed, ifStackTable=ifStackTable, ifMIBObjects=ifMIBObjects, ifGeneralGroup=ifGeneralGroup, ifPacketGroup=ifPacketGroup, ifStackStatus=ifStackStatus, ifPhysAddress=ifPhysAddress, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestType=ifTestType, ifMIB=ifMIB, ifTableLastChange=ifTableLastChange, ifRcvAddressTable=ifRcvAddressTable, ifTable=ifTable, ifEntry=ifEntry, interfaces=interfaces, InterfaceIndexOrZero=InterfaceIndexOrZero, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifInMulticastPkts=ifInMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestGroup=ifTestGroup, ifOutOctets=ifOutOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifTestId=ifTestId, ifOutMulticastPkts=ifOutMulticastPkts, ifCompliance=ifCompliance, ifTestCode=ifTestCode, ifInUnknownProtos=ifInUnknownProtos, ifTestResult=ifTestResult, linkUp=linkUp, ifHCInOctets=ifHCInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, InterfaceIndex=InterfaceIndex, ifRcvAddressType=ifRcvAddressType, ifConnectorPresent=ifConnectorPresent, ifAdminStatus=ifAdminStatus, linkDown=linkDown, ifConformance=ifConformance, ifInOctets=ifInOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestStatus=ifTestStatus, ifGroups=ifGroups, ifDescr=ifDescr, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifInErrors=ifInErrors, ifHighSpeed=ifHighSpeed, ifHCPacketGroup=ifHCPacketGroup, ifOutDiscards=ifOutDiscards, ifStackGroup=ifStackGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifName=ifName, ifTestEntry=ifTestEntry, ifTestOwner=ifTestOwner, ifXTable=ifXTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackEntry=ifStackEntry, ifRcvAddressGroup=ifRcvAddressGroup, PYSNMP_MODULE_ID=ifMIB, ifOutErrors=ifOutErrors, ifLastChange=ifLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifOutUcastPkts=ifOutUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable)
