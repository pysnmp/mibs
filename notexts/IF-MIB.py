...
PhysAddress, RowStatus, TestAndIncr, TextualConvention, TimeStamp, DisplayString, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "RowStatus", "TestAndIncr", "TextualConvention", "TimeStamp", "DisplayString", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutOctets=ifOutOctets, InterfaceIndex=InterfaceIndex, ifInNUcastPkts=ifInNUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifNumber=ifNumber, ifHighSpeed=ifHighSpeed, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackGroup2=ifStackGroup2, ifAlias=ifAlias, ifStackEntry=ifStackEntry, ifTestEntry=ifTestEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTableLastChange=ifTableLastChange, ifPacketGroup=ifPacketGroup, ifTestTable=ifTestTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestId=ifTestId, ifType=ifType, ifXEntry=ifXEntry, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifTestStatus=ifTestStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, OwnerString=OwnerString, ifPromiscuousMode=ifPromiscuousMode, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, ifOldObjectsGroup=ifOldObjectsGroup, ifInUnknownProtos=ifInUnknownProtos, ifInDiscards=ifInDiscards, ifOperStatus=ifOperStatus, ifInOctets=ifInOctets, ifStackLastChange=ifStackLastChange, ifTestType=ifTestType, ifAdminStatus=ifAdminStatus, ifStackStatus=ifStackStatus, ifInUcastPkts=ifInUcastPkts, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifOutDiscards=ifOutDiscards, ifLastChange=ifLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInMulticastPkts=ifInMulticastPkts, ifSpeed=ifSpeed, ifDescr=ifDescr, ifXTable=ifXTable, ifOutUcastPkts=ifOutUcastPkts, ifOutQLen=ifOutQLen, ifName=ifName, ifTestCode=ifTestCode, ifGroups=ifGroups, PYSNMP_MODULE_ID=ifMIB, ifTestOwner=ifTestOwner, ifStackTable=ifStackTable, linkUp=linkUp, ifInErrors=ifInErrors, ifRcvAddressType=ifRcvAddressType, ifConnectorPresent=ifConnectorPresent, ifCompliance3=ifCompliance3, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestGroup=ifTestGroup, ifSpecific=ifSpecific, ifHCPacketGroup=ifHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifMtu=ifMtu, ifHCInUcastPkts=ifHCInUcastPkts, ifHCInOctets=ifHCInOctets, interfaces=interfaces, ifMIB=ifMIB, ifEntry=ifEntry, ifIndex=ifIndex, ifStackHigherLayer=ifStackHigherLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMIBObjects=ifMIBObjects, ifOutErrors=ifOutErrors, ifRcvAddressEntry=ifRcvAddressEntry, ifStackGroup=ifStackGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance2=ifCompliance2, ifHCOutUcastPkts=ifHCOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifTable=ifTable, ifCompliance=ifCompliance, linkDown=linkDown)
