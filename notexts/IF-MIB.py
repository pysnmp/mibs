...
AutonomousType, DisplayString, TestAndIncr, TimeStamp, TextualConvention, PhysAddress, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TestAndIncr", "TimeStamp", "TextualConvention", "PhysAddress", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifSpeed=ifSpeed, ifInDiscards=ifInDiscards, OwnerString=OwnerString, InterfaceIndex=InterfaceIndex, ifMIB=ifMIB, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliances=ifCompliances, ifInOctets=ifInOctets, ifStackGroup2=ifStackGroup2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestStatus=ifTestStatus, PYSNMP_MODULE_ID=ifMIB, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup=ifStackGroup, ifTestResult=ifTestResult, ifAlias=ifAlias, linkUp=linkUp, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifInMulticastPkts=ifInMulticastPkts, ifDescr=ifDescr, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutDiscards=ifOutDiscards, linkDown=linkDown, ifTable=ifTable, ifTestGroup=ifTestGroup, ifStackHigherLayer=ifStackHigherLayer, interfaces=interfaces, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutQLen=ifOutQLen, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifTestCode=ifTestCode, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMIBObjects=ifMIBObjects, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifOutUcastPkts=ifOutUcastPkts, ifCompliance2=ifCompliance2, ifOperStatus=ifOperStatus, ifIndex=ifIndex, ifSpecific=ifSpecific, ifStackEntry=ifStackEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifPhysAddress=ifPhysAddress, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, ifLastChange=ifLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifStackLastChange=ifStackLastChange, ifHighSpeed=ifHighSpeed, ifFixedLengthGroup=ifFixedLengthGroup, ifName=ifName, ifTestOwner=ifTestOwner, ifInNUcastPkts=ifInNUcastPkts, ifStackTable=ifStackTable, ifOutErrors=ifOutErrors, ifStackLowerLayer=ifStackLowerLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTableLastChange=ifTableLastChange, ifTestType=ifTestType, ifTestEntry=ifTestEntry, ifHCOutOctets=ifHCOutOctets, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMtu=ifMtu, ifStackStatus=ifStackStatus, ifTestTable=ifTestTable, ifRcvAddressType=ifRcvAddressType, ifInUcastPkts=ifInUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifAdminStatus=ifAdminStatus, ifInUnknownProtos=ifInUnknownProtos, InterfaceIndexOrZero=InterfaceIndexOrZero, ifType=ifType, ifVHCPacketGroup=ifVHCPacketGroup, ifNumber=ifNumber, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGroups=ifGroups, ifEntry=ifEntry, ifHCInUcastPkts=ifHCInUcastPkts, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifXTable=ifXTable, ifConformance=ifConformance, ifPacketGroup=ifPacketGroup)
