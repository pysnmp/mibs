...
ModuleIdentity, iso, mib_2, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Integer32, Bits, Unsigned32, Counter64, TimeTicks, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "mib-2", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Integer32", "Bits", "Unsigned32", "Counter64", "TimeTicks", "IpAddress", "NotificationType")
DisplayString, TestAndIncr, AutonomousType, PhysAddress, RowStatus, TruthValue, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TestAndIncr", "AutonomousType", "PhysAddress", "RowStatus", "TruthValue", "TimeStamp", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", PYSNMP_MODULE_ID=ifMIB, ifXEntry=ifXEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressType=ifRcvAddressType, ifStackLastChange=ifStackLastChange, InterfaceIndex=InterfaceIndex, OwnerString=OwnerString, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance2=ifCompliance2, ifAlias=ifAlias, ifInNUcastPkts=ifInNUcastPkts, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, ifConformance=ifConformance, ifOutOctets=ifOutOctets, ifTestResult=ifTestResult, ifGroups=ifGroups, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifNumber=ifNumber, ifLastChange=ifLastChange, ifEntry=ifEntry, ifMIB=ifMIB, ifOutQLen=ifOutQLen, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifOperStatus=ifOperStatus, ifPacketGroup=ifPacketGroup, ifMtu=ifMtu, ifGeneralGroup=ifGeneralGroup, interfaces=interfaces, ifTestOwner=ifTestOwner, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifPromiscuousMode=ifPromiscuousMode, ifStackTable=ifStackTable, ifMIBObjects=ifMIBObjects, ifHCInUcastPkts=ifHCInUcastPkts, ifTestCode=ifTestCode, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTable=ifTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHighSpeed=ifHighSpeed, ifPhysAddress=ifPhysAddress, ifInDiscards=ifInDiscards, ifTestGroup=ifTestGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifAdminStatus=ifAdminStatus, ifDescr=ifDescr, ifHCInOctets=ifHCInOctets, ifCompliance=ifCompliance, ifTestTable=ifTestTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestId=ifTestId, ifRcvAddressGroup=ifRcvAddressGroup, ifType=ifType, ifConnectorPresent=ifConnectorPresent, ifStackEntry=ifStackEntry, ifName=ifName, ifRcvAddressTable=ifRcvAddressTable, ifInOctets=ifInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkUp=linkUp, ifCompliances=ifCompliances, ifOutErrors=ifOutErrors, ifOutDiscards=ifOutDiscards, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifSpecific=ifSpecific, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifIndex=ifIndex, ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifSpeed=ifSpeed, ifInMulticastPkts=ifInMulticastPkts, ifXTable=ifXTable, ifRcvAddressAddress=ifRcvAddressAddress, ifVHCPacketGroup=ifVHCPacketGroup, ifTestEntry=ifTestEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkDown=linkDown, ifInUcastPkts=ifInUcastPkts, ifStackGroup2=ifStackGroup2, ifCompliance3=ifCompliance3, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup)
