...
ModuleIdentity, Bits, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Gauge32, Integer32, NotificationType, IpAddress, TimeTicks, MibIdentifier, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Gauge32", "Integer32", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter64")
TimeStamp, DisplayString, TestAndIncr, TextualConvention, AutonomousType, TruthValue, PhysAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TestAndIncr", "TextualConvention", "AutonomousType", "TruthValue", "PhysAddress", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInOctets=ifHCInOctets, ifGroups=ifGroups, ifIndex=ifIndex, ifStackLastChange=ifStackLastChange, ifSpeed=ifSpeed, ifXTable=ifXTable, ifTable=ifTable, ifStackStatus=ifStackStatus, ifInDiscards=ifInDiscards, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifNumber=ifNumber, ifInBroadcastPkts=ifInBroadcastPkts, ifAdminStatus=ifAdminStatus, ifPhysAddress=ifPhysAddress, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOperStatus=ifOperStatus, ifOutDiscards=ifOutDiscards, interfaces=interfaces, ifTableLastChange=ifTableLastChange, ifVHCPacketGroup=ifVHCPacketGroup, ifEntry=ifEntry, ifMIBObjects=ifMIBObjects, ifSpecific=ifSpecific, ifHCOutOctets=ifHCOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackGroup2=ifStackGroup2, ifTestTable=ifTestTable, linkUp=linkUp, ifTestType=ifTestType, ifDescr=ifDescr, linkDown=linkDown, ifGeneralGroup=ifGeneralGroup, ifCompliance=ifCompliance, ifHighSpeed=ifHighSpeed, ifRcvAddressTable=ifRcvAddressTable, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifTestGroup=ifTestGroup, ifOutQLen=ifOutQLen, ifPromiscuousMode=ifPromiscuousMode, ifLastChange=ifLastChange, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAlias=ifAlias, ifCompliances=ifCompliances, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifMtu=ifMtu, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXEntry=ifXEntry, OwnerString=OwnerString, ifName=ifName, ifStackEntry=ifStackEntry, ifInUcastPkts=ifInUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutOctets=ifOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutErrors=ifOutErrors, ifConnectorPresent=ifConnectorPresent, InterfaceIndex=InterfaceIndex, ifTestResult=ifTestResult, ifPacketGroup=ifPacketGroup, ifStackTable=ifStackTable, ifConformance=ifConformance, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifTestStatus=ifTestStatus, ifCompliance2=ifCompliance2, ifInErrors=ifInErrors, ifMIB=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutNUcastPkts=ifOutNUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTestOwner=ifTestOwner, ifTestId=ifTestId, ifStackGroup=ifStackGroup, ifInNUcastPkts=ifInNUcastPkts, ifType=ifType, ifTestCode=ifTestCode, ifOldObjectsGroup=ifOldObjectsGroup, ifInUnknownProtos=ifInUnknownProtos, ifStackLowerLayer=ifStackLowerLayer, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressType=ifRcvAddressType)
