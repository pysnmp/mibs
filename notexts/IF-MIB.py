...
Gauge32, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress, MibIdentifier, TimeTicks, mib_2, ModuleIdentity, Bits, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress", "MibIdentifier", "TimeTicks", "mib-2", "ModuleIdentity", "Bits", "Unsigned32", "iso", "NotificationType")
RowStatus, TestAndIncr, TimeStamp, TextualConvention, DisplayString, PhysAddress, AutonomousType, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TestAndIncr", "TimeStamp", "TextualConvention", "DisplayString", "PhysAddress", "AutonomousType", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOperStatus=ifOperStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifOutDiscards=ifOutDiscards, ifMIBObjects=ifMIBObjects, ifPacketGroup=ifPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, OwnerString=OwnerString, ifTestId=ifTestId, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestGroup=ifTestGroup, ifConformance=ifConformance, ifTestOwner=ifTestOwner, ifHCPacketGroup=ifHCPacketGroup, ifCompliance=ifCompliance, ifTestEntry=ifTestEntry, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifHighSpeed=ifHighSpeed, ifTestStatus=ifTestStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifSpecific=ifSpecific, ifVHCPacketGroup=ifVHCPacketGroup, ifTestType=ifTestType, ifSpeed=ifSpeed, ifRcvAddressType=ifRcvAddressType, ifStackGroup=ifStackGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifGroups=ifGroups, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifInMulticastPkts=ifInMulticastPkts, linkDown=linkDown, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifLastChange=ifLastChange, ifTable=ifTable, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifOutErrors=ifOutErrors, ifPhysAddress=ifPhysAddress, ifCompliance3=ifCompliance3, ifOutNUcastPkts=ifOutNUcastPkts, ifXEntry=ifXEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifConnectorPresent=ifConnectorPresent, ifOutOctets=ifOutOctets, ifType=ifType, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInUcastPkts=ifHCInUcastPkts, InterfaceIndex=InterfaceIndex, ifInErrors=ifInErrors, ifHCOutOctets=ifHCOutOctets, ifAdminStatus=ifAdminStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressTable=ifRcvAddressTable, ifInOctets=ifInOctets, ifMIB=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifName=ifName, ifMtu=ifMtu, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifXTable=ifXTable, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifStackLastChange=ifStackLastChange, ifInUcastPkts=ifInUcastPkts, ifStackTable=ifStackTable, ifStackHigherLayer=ifStackHigherLayer, ifIndex=ifIndex, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, interfaces=interfaces, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifStackLowerLayer=ifStackLowerLayer, linkUp=linkUp, ifTableLastChange=ifTableLastChange, ifStackEntry=ifStackEntry, ifAlias=ifAlias, ifOutQLen=ifOutQLen)
