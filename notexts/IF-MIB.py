...
TruthValue, DisplayString, RowStatus, TextualConvention, PhysAddress, TimeStamp, TestAndIncr, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "TextualConvention", "PhysAddress", "TimeStamp", "TestAndIncr", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifHCInOctets=ifHCInOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, OwnerString=OwnerString, ifTestType=ifTestType, ifXTable=ifXTable, ifInNUcastPkts=ifInNUcastPkts, linkUp=linkUp, interfaces=interfaces, ifPhysAddress=ifPhysAddress, ifOutOctets=ifOutOctets, ifStackGroup=ifStackGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutDiscards=ifOutDiscards, ifStackHigherLayer=ifStackHigherLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifMIBObjects=ifMIBObjects, ifOutQLen=ifOutQLen, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackEntry=ifStackEntry, ifTestId=ifTestId, ifAdminStatus=ifAdminStatus, ifTestStatus=ifTestStatus, ifXEntry=ifXEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance2=ifCompliance2, ifFixedLengthGroup=ifFixedLengthGroup, ifConformance=ifConformance, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifIndex=ifIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutUcastPkts=ifOutUcastPkts, ifAlias=ifAlias, ifHCFixedLengthGroup=ifHCFixedLengthGroup, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, ifOutErrors=ifOutErrors, ifTestResult=ifTestResult, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifDescr=ifDescr, ifHCOutOctets=ifHCOutOctets, ifNumber=ifNumber, ifConnectorPresent=ifConnectorPresent, ifInOctets=ifInOctets, ifName=ifName, ifGroups=ifGroups, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, PYSNMP_MODULE_ID=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifInDiscards=ifInDiscards, ifPacketGroup=ifPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifTable=ifTable, ifCompliance3=ifCompliance3, ifRcvAddressAddress=ifRcvAddressAddress, ifGeneralGroup=ifGeneralGroup, ifMIB=ifMIB, ifTestOwner=ifTestOwner, ifEntry=ifEntry, ifSpeed=ifSpeed, ifOutNUcastPkts=ifOutNUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, linkDown=linkDown, ifCompliances=ifCompliances, ifRcvAddressStatus=ifRcvAddressStatus, ifStackTable=ifStackTable, ifType=ifType, ifStackLowerLayer=ifStackLowerLayer, ifInUcastPkts=ifInUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifMtu=ifMtu, ifInMulticastPkts=ifInMulticastPkts, ifOperStatus=ifOperStatus, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInErrors=ifInErrors, ifTableLastChange=ifTableLastChange, ifHighSpeed=ifHighSpeed, ifInUnknownProtos=ifInUnknownProtos, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifCompliance=ifCompliance)
