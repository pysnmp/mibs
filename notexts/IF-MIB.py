...
TestAndIncr, DisplayString, RowStatus, TimeStamp, AutonomousType, TextualConvention, TruthValue, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "DisplayString", "RowStatus", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifAlias=ifAlias, ifGeneralGroup=ifGeneralGroup, ifName=ifName, ifPhysAddress=ifPhysAddress, ifTestOwner=ifTestOwner, ifHCPacketGroup=ifHCPacketGroup, OwnerString=OwnerString, ifCompliance=ifCompliance, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliances=ifCompliances, ifSpecific=ifSpecific, ifSpeed=ifSpeed, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, interfaces=interfaces, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestStatus=ifTestStatus, ifType=ifType, ifEntry=ifEntry, ifHCOutOctets=ifHCOutOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMIBObjects=ifMIBObjects, ifInUnknownProtos=ifInUnknownProtos, ifStackLastChange=ifStackLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifStackStatus=ifStackStatus, ifTableLastChange=ifTableLastChange, ifOutErrors=ifOutErrors, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifConnectorPresent=ifConnectorPresent, ifHighSpeed=ifHighSpeed, ifTestEntry=ifTestEntry, ifXEntry=ifXEntry, PYSNMP_MODULE_ID=ifMIB, linkUp=linkUp, ifStackTable=ifStackTable, ifRcvAddressStatus=ifRcvAddressStatus, ifTestTable=ifTestTable, ifPromiscuousMode=ifPromiscuousMode, ifStackEntry=ifStackEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance2=ifCompliance2, ifInUcastPkts=ifInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifMIB=ifMIB, ifNumber=ifNumber, ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestType=ifTestType, ifPacketGroup=ifPacketGroup, ifTestGroup=ifTestGroup, ifInNUcastPkts=ifInNUcastPkts, ifInOctets=ifInOctets, ifOperStatus=ifOperStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInOctets=ifHCInOctets, ifStackGroup2=ifStackGroup2, InterfaceIndex=InterfaceIndex, ifIndex=ifIndex, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXTable=ifXTable, ifCompliance3=ifCompliance3, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifConformance=ifConformance, ifLastChange=ifLastChange, ifTestCode=ifTestCode, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMtu=ifMtu, ifOutDiscards=ifOutDiscards, ifOutNUcastPkts=ifOutNUcastPkts, ifInErrors=ifInErrors, ifStackGroup=ifStackGroup, ifInMulticastPkts=ifInMulticastPkts, ifGroups=ifGroups, ifTestResult=ifTestResult, ifOutMulticastPkts=ifOutMulticastPkts, ifAdminStatus=ifAdminStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifStackLowerLayer=ifStackLowerLayer, linkDown=linkDown, ifTable=ifTable, ifOutQLen=ifOutQLen)
