...
TimeTicks, ModuleIdentity, Integer32, mib_2, Counter32, IpAddress, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, ObjectIdentity, Counter64, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "mib-2", "Counter32", "IpAddress", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "NotificationType")
AutonomousType, RowStatus, PhysAddress, TruthValue, TextualConvention, TimeStamp, DisplayString, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "RowStatus", "PhysAddress", "TruthValue", "TextualConvention", "TimeStamp", "DisplayString", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifXEntry=ifXEntry, ifMIBObjects=ifMIBObjects, ifRcvAddressType=ifRcvAddressType, OwnerString=OwnerString, ifStackTable=ifStackTable, ifPacketGroup=ifPacketGroup, ifTestType=ifTestType, ifCompliance3=ifCompliance3, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInOctets=ifInOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliances=ifCompliances, ifOutQLen=ifOutQLen, ifInNUcastPkts=ifInNUcastPkts, ifHCInOctets=ifHCInOctets, ifNumber=ifNumber, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifMIB=ifMIB, interfaces=interfaces, ifTestOwner=ifTestOwner, linkUp=linkUp, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifTestEntry=ifTestEntry, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifRcvAddressGroup=ifRcvAddressGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInUcastPkts=ifInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, ifCompliance=ifCompliance, ifRcvAddressEntry=ifRcvAddressEntry, ifType=ifType, ifConnectorPresent=ifConnectorPresent, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifEntry=ifEntry, linkDown=linkDown, ifHCInUcastPkts=ifHCInUcastPkts, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, ifTestStatus=ifTestStatus, ifSpecific=ifSpecific, ifOutNUcastPkts=ifOutNUcastPkts, ifGroups=ifGroups, ifRcvAddressTable=ifRcvAddressTable, ifConformance=ifConformance, ifTestId=ifTestId, ifStackGroup2=ifStackGroup2, ifSpeed=ifSpeed, ifHCInMulticastPkts=ifHCInMulticastPkts, InterfaceIndex=InterfaceIndex, ifLastChange=ifLastChange, ifOperStatus=ifOperStatus, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifXTable=ifXTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifIndex=ifIndex, ifMtu=ifMtu, ifAdminStatus=ifAdminStatus, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifTable=ifTable, ifInDiscards=ifInDiscards, ifOldObjectsGroup=ifOldObjectsGroup, ifOutOctets=ifOutOctets, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackStatus=ifStackStatus, ifOutErrors=ifOutErrors, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifStackEntry=ifStackEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestTable=ifTestTable, ifPhysAddress=ifPhysAddress, ifTestGroup=ifTestGroup, ifTestResult=ifTestResult, ifHCPacketGroup=ifHCPacketGroup, ifHighSpeed=ifHighSpeed, ifStackLastChange=ifStackLastChange, ifRcvAddressStatus=ifRcvAddressStatus, ifStackHigherLayer=ifStackHigherLayer)
