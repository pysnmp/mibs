...
Gauge32, Unsigned32, mib_2, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, NotificationType, ObjectIdentity, MibIdentifier, Counter32, TimeTicks, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "mib-2", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Counter32", "TimeTicks", "ModuleIdentity", "Bits")
TimeStamp, TextualConvention, TestAndIncr, TruthValue, AutonomousType, DisplayString, PhysAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "TestAndIncr", "TruthValue", "AutonomousType", "DisplayString", "PhysAddress", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutErrors=ifOutErrors, ifTestId=ifTestId, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackGroup=ifStackGroup, ifInUnknownProtos=ifInUnknownProtos, ifGeneralGroup=ifGeneralGroup, ifCompliance=ifCompliance, ifStackEntry=ifStackEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackTable=ifStackTable, ifXTable=ifXTable, ifTestTable=ifTestTable, ifCompliances=ifCompliances, ifMIB=ifMIB, ifInBroadcastPkts=ifInBroadcastPkts, ifDescr=ifDescr, ifPacketGroup=ifPacketGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestStatus=ifTestStatus, ifPromiscuousMode=ifPromiscuousMode, PYSNMP_MODULE_ID=ifMIB, ifOldObjectsGroup=ifOldObjectsGroup, ifInNUcastPkts=ifInNUcastPkts, ifOutQLen=ifOutQLen, ifTestOwner=ifTestOwner, ifOutBroadcastPkts=ifOutBroadcastPkts, ifOutDiscards=ifOutDiscards, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifTestEntry=ifTestEntry, ifSpecific=ifSpecific, ifInDiscards=ifInDiscards, ifAdminStatus=ifAdminStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressEntry=ifRcvAddressEntry, ifOperStatus=ifOperStatus, ifAlias=ifAlias, ifOutOctets=ifOutOctets, ifRcvAddressType=ifRcvAddressType, ifCompliance3=ifCompliance3, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressTable=ifRcvAddressTable, ifHCInUcastPkts=ifHCInUcastPkts, ifInErrors=ifInErrors, ifMtu=ifMtu, ifName=ifName, ifSpeed=ifSpeed, ifStackStatus=ifStackStatus, ifTable=ifTable, ifVHCPacketGroup=ifVHCPacketGroup, ifHighSpeed=ifHighSpeed, ifStackGroup2=ifStackGroup2, ifRcvAddressStatus=ifRcvAddressStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifTableLastChange=ifTableLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifEntry=ifEntry, ifCompliance2=ifCompliance2, ifInUcastPkts=ifInUcastPkts, ifTestGroup=ifTestGroup, linkUp=linkUp, ifRcvAddressGroup=ifRcvAddressGroup, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, linkDown=linkDown, ifConformance=ifConformance, ifTestCode=ifTestCode, ifStackLastChange=ifStackLastChange, ifStackHigherLayer=ifStackHigherLayer, ifXEntry=ifXEntry, ifType=ifType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifNumber=ifNumber, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLastChange=ifLastChange, InterfaceIndex=InterfaceIndex, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, OwnerString=OwnerString, ifInOctets=ifInOctets, ifTestType=ifTestType, ifHCInOctets=ifHCInOctets, ifOutMulticastPkts=ifOutMulticastPkts, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifStackLowerLayer=ifStackLowerLayer)
