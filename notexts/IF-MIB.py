...
Integer32, ObjectIdentity, iso, Bits, Unsigned32, mib_2, MibIdentifier, Counter64, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "iso", "Bits", "Unsigned32", "mib-2", "MibIdentifier", "Counter64", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType", "TimeTicks")
PhysAddress, TestAndIncr, DisplayString, AutonomousType, TextualConvention, RowStatus, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TestAndIncr", "DisplayString", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, ifDescr=ifDescr, ifConformance=ifConformance, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, OwnerString=OwnerString, ifIndex=ifIndex, ifRcvAddressAddress=ifRcvAddressAddress, ifXEntry=ifXEntry, ifCompliance2=ifCompliance2, ifRcvAddressStatus=ifRcvAddressStatus, ifTestTable=ifTestTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPhysAddress=ifPhysAddress, PYSNMP_MODULE_ID=ifMIB, ifOutDiscards=ifOutDiscards, ifName=ifName, ifPromiscuousMode=ifPromiscuousMode, ifOperStatus=ifOperStatus, linkDown=linkDown, ifStackStatus=ifStackStatus, ifCompliance=ifCompliance, ifStackTable=ifStackTable, ifVHCPacketGroup=ifVHCPacketGroup, ifMtu=ifMtu, ifHCPacketGroup=ifHCPacketGroup, ifInUnknownProtos=ifInUnknownProtos, ifInBroadcastPkts=ifInBroadcastPkts, ifOutQLen=ifOutQLen, ifGroups=ifGroups, ifTestType=ifTestType, ifTestEntry=ifTestEntry, ifRcvAddressType=ifRcvAddressType, ifAdminStatus=ifAdminStatus, InterfaceIndex=InterfaceIndex, ifRcvAddressGroup=ifRcvAddressGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifNumber=ifNumber, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifTestResult=ifTestResult, ifStackLowerLayer=ifStackLowerLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifType=ifType, ifTestStatus=ifTestStatus, ifStackGroup=ifStackGroup, ifInErrors=ifInErrors, ifTestId=ifTestId, ifTestCode=ifTestCode, ifOutErrors=ifOutErrors, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliances=ifCompliances, ifMIBObjects=ifMIBObjects, ifHighSpeed=ifHighSpeed, ifHCInOctets=ifHCInOctets, ifConnectorPresent=ifConnectorPresent, ifStackHigherLayer=ifStackHigherLayer, ifOldObjectsGroup=ifOldObjectsGroup, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifSpecific=ifSpecific, ifSpeed=ifSpeed, ifInUcastPkts=ifInUcastPkts, ifTable=ifTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifLastChange=ifLastChange, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressEntry=ifRcvAddressEntry, ifEntry=ifEntry, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance3=ifCompliance3, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCOutOctets=ifHCOutOctets, ifStackGroup2=ifStackGroup2, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifStackEntry=ifStackEntry, ifTestOwner=ifTestOwner, linkUp=linkUp)
