...
TimeTicks, iso, Unsigned32, NotificationType, Counter64, Integer32, Counter32, ModuleIdentity, mib_2, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Unsigned32", "NotificationType", "Counter64", "Integer32", "Counter32", "ModuleIdentity", "mib-2", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
DisplayString, PhysAddress, TestAndIncr, TimeStamp, RowStatus, AutonomousType, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "PhysAddress", "TestAndIncr", "TimeStamp", "RowStatus", "AutonomousType", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTableLastChange=ifTableLastChange, ifInErrors=ifInErrors, ifCompliance3=ifCompliance3, ifLastChange=ifLastChange, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifMIB=ifMIB, ifHCInOctets=ifHCInOctets, ifInDiscards=ifInDiscards, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifRcvAddressType=ifRcvAddressType, ifName=ifName, ifMIBObjects=ifMIBObjects, InterfaceIndex=InterfaceIndex, interfaces=interfaces, ifCompliance=ifCompliance, ifEntry=ifEntry, ifAdminStatus=ifAdminStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInUnknownProtos=ifInUnknownProtos, ifXTable=ifXTable, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifTable=ifTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifFixedLengthGroup=ifFixedLengthGroup, ifStackStatus=ifStackStatus, ifTestId=ifTestId, ifInUcastPkts=ifInUcastPkts, ifStackLastChange=ifStackLastChange, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifSpeed=ifSpeed, ifPhysAddress=ifPhysAddress, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpecific=ifSpecific, ifOutDiscards=ifOutDiscards, ifStackGroup=ifStackGroup, ifConformance=ifConformance, ifTestOwner=ifTestOwner, ifXEntry=ifXEntry, ifHCOutOctets=ifHCOutOctets, ifTestResult=ifTestResult, ifGeneralGroup=ifGeneralGroup, ifVHCPacketGroup=ifVHCPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifTestTable=ifTestTable, ifDescr=ifDescr, ifPacketGroup=ifPacketGroup, ifOutErrors=ifOutErrors, ifRcvAddressGroup=ifRcvAddressGroup, ifConnectorPresent=ifConnectorPresent, ifTestType=ifTestType, ifGroups=ifGroups, ifStackTable=ifStackTable, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestEntry=ifTestEntry, ifOutUcastPkts=ifOutUcastPkts, ifAlias=ifAlias, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressStatus=ifRcvAddressStatus, linkDown=linkDown, ifInBroadcastPkts=ifInBroadcastPkts, OwnerString=OwnerString, ifStackGroup2=ifStackGroup2, ifRcvAddressEntry=ifRcvAddressEntry, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, ifHCPacketGroup=ifHCPacketGroup, ifTestCode=ifTestCode, ifOutOctets=ifOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackEntry=ifStackEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifIndex=ifIndex, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifMtu=ifMtu, linkUp=linkUp, ifHighSpeed=ifHighSpeed, ifNumber=ifNumber, ifOutQLen=ifOutQLen, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer)
