...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, iso, MibIdentifier, Bits, Unsigned32, Integer32, NotificationType, Gauge32, mib_2, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "iso", "MibIdentifier", "Bits", "Unsigned32", "Integer32", "NotificationType", "Gauge32", "mib-2", "Counter64", "IpAddress")
PhysAddress, TextualConvention, TruthValue, RowStatus, TestAndIncr, TimeStamp, AutonomousType, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "TruthValue", "RowStatus", "TestAndIncr", "TimeStamp", "AutonomousType", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", InterfaceIndex=InterfaceIndex, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInErrors=ifInErrors, ifTableLastChange=ifTableLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutDiscards=ifOutDiscards, ifStackGroup=ifStackGroup, linkUp=linkUp, ifDescr=ifDescr, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifConformance=ifConformance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCInUcastPkts=ifHCInUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifTestType=ifTestType, ifEntry=ifEntry, ifConnectorPresent=ifConnectorPresent, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIB=ifMIB, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, ifFixedLengthGroup=ifFixedLengthGroup, ifTestId=ifTestId, ifType=ifType, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestResult=ifTestResult, ifGroups=ifGroups, ifPhysAddress=ifPhysAddress, ifOutOctets=ifOutOctets, ifInBroadcastPkts=ifInBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifAdminStatus=ifAdminStatus, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, linkDown=linkDown, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressType=ifRcvAddressType, ifHighSpeed=ifHighSpeed, ifOutErrors=ifOutErrors, ifTestTable=ifTestTable, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifCompliance=ifCompliance, ifName=ifName, ifOutQLen=ifOutQLen, ifHCInOctets=ifHCInOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifSpecific=ifSpecific, ifTestOwner=ifTestOwner, ifRcvAddressTable=ifRcvAddressTable, ifTestCode=ifTestCode, ifInUcastPkts=ifInUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifStackStatus=ifStackStatus, ifInOctets=ifInOctets, ifPromiscuousMode=ifPromiscuousMode, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressStatus=ifRcvAddressStatus, ifSpeed=ifSpeed, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifTable=ifTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestEntry=ifTestEntry, ifOperStatus=ifOperStatus, ifGeneralGroup=ifGeneralGroup, ifMtu=ifMtu, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifInDiscards=ifInDiscards, ifCompliance3=ifCompliance3, interfaces=interfaces, ifStackLowerLayer=ifStackLowerLayer, ifCompliances=ifCompliances, ifPacketGroup=ifPacketGroup, ifTestStatus=ifTestStatus, ifAlias=ifAlias, ifInUnknownProtos=ifInUnknownProtos, ifStackTable=ifStackTable, ifOutUcastPkts=ifOutUcastPkts, ifXTable=ifXTable, ifNumber=ifNumber, ifCompliance2=ifCompliance2, ifIndex=ifIndex, ifStackGroup2=ifStackGroup2, ifLastChange=ifLastChange)
