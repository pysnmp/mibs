...
RowStatus, DisplayString, TruthValue, PhysAddress, TimeStamp, TextualConvention, AutonomousType, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "PhysAddress", "TimeStamp", "TextualConvention", "AutonomousType", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifInUcastPkts=ifInUcastPkts, ifGroups=ifGroups, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTable=ifTable, linkUp=linkUp, ifDescr=ifDescr, ifStackLowerLayer=ifStackLowerLayer, ifRcvAddressAddress=ifRcvAddressAddress, ifTestEntry=ifTestEntry, ifTestResult=ifTestResult, ifOutDiscards=ifOutDiscards, ifAdminStatus=ifAdminStatus, ifOutQLen=ifOutQLen, ifStackLastChange=ifStackLastChange, ifTestId=ifTestId, ifInUnknownProtos=ifInUnknownProtos, ifMtu=ifMtu, ifTestGroup=ifTestGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInOctets=ifInOctets, ifCompliance=ifCompliance, ifStackGroup=ifStackGroup, ifInNUcastPkts=ifInNUcastPkts, ifTableLastChange=ifTableLastChange, ifOutErrors=ifOutErrors, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifNumber=ifNumber, ifLastChange=ifLastChange, ifRcvAddressGroup=ifRcvAddressGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, OwnerString=OwnerString, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifTestOwner=ifTestOwner, ifConformance=ifConformance, ifStackStatus=ifStackStatus, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifType=ifType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifIndex=ifIndex, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressEntry=ifRcvAddressEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, InterfaceIndex=InterfaceIndex, ifHCInOctets=ifHCInOctets, ifStackTable=ifStackTable, ifHighSpeed=ifHighSpeed, linkDown=linkDown, interfaces=interfaces, ifInErrors=ifInErrors, ifTestCode=ifTestCode, ifTestTable=ifTestTable, ifCompliance2=ifCompliance2, ifPacketGroup=ifPacketGroup, ifXEntry=ifXEntry, ifEntry=ifEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifRcvAddressStatus=ifRcvAddressStatus, ifCompliance3=ifCompliance3, ifVHCPacketGroup=ifVHCPacketGroup, ifMIBObjects=ifMIBObjects, ifRcvAddressType=ifRcvAddressType, ifSpecific=ifSpecific, ifTestType=ifTestType, ifConnectorPresent=ifConnectorPresent, ifPromiscuousMode=ifPromiscuousMode, ifStackHigherLayer=ifStackHigherLayer, ifXTable=ifXTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOperStatus=ifOperStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestStatus=ifTestStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressTable=ifRcvAddressTable, ifSpeed=ifSpeed, ifStackEntry=ifStackEntry, ifCompliances=ifCompliances, ifPhysAddress=ifPhysAddress, ifGeneralGroup=ifGeneralGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, InterfaceIndexOrZero=InterfaceIndexOrZero, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup)
