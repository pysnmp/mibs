...
TestAndIncr, RowStatus, DisplayString, PhysAddress, TimeStamp, AutonomousType, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "RowStatus", "DisplayString", "PhysAddress", "TimeStamp", "AutonomousType", "TextualConvention", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifTestCode=ifTestCode, ifOperStatus=ifOperStatus, linkUp=linkUp, ifTestResult=ifTestResult, ifMtu=ifMtu, ifInErrors=ifInErrors, ifConformance=ifConformance, ifStackTable=ifStackTable, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance3=ifCompliance3, ifTestEntry=ifTestEntry, ifInUnknownProtos=ifInUnknownProtos, ifHCInOctets=ifHCInOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCOutOctets=ifHCOutOctets, ifInOctets=ifInOctets, ifMIBObjects=ifMIBObjects, ifSpeed=ifSpeed, ifPacketGroup=ifPacketGroup, ifHCPacketGroup=ifHCPacketGroup, ifStackGroup2=ifStackGroup2, ifStackHigherLayer=ifStackHigherLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, ifTestId=ifTestId, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestGroup=ifTestGroup, ifHighSpeed=ifHighSpeed, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, ifGroups=ifGroups, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackLastChange=ifStackLastChange, ifPhysAddress=ifPhysAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, interfaces=interfaces, ifNumber=ifNumber, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndex=InterfaceIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressType=ifRcvAddressType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifInMulticastPkts=ifInMulticastPkts, ifOutOctets=ifOutOctets, ifType=ifType, ifRcvAddressGroup=ifRcvAddressGroup, ifTable=ifTable, ifInUcastPkts=ifInUcastPkts, ifLastChange=ifLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, OwnerString=OwnerString, ifIndex=ifIndex, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifXTable=ifXTable, ifHCInMulticastPkts=ifHCInMulticastPkts, PYSNMP_MODULE_ID=ifMIB, ifInDiscards=ifInDiscards, ifTableLastChange=ifTableLastChange, ifOutQLen=ifOutQLen, ifMIB=ifMIB, ifAlias=ifAlias, ifCompliances=ifCompliances, ifTestOwner=ifTestOwner, ifDescr=ifDescr, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifOutDiscards=ifOutDiscards, ifStackEntry=ifStackEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifTestTable=ifTestTable, ifXEntry=ifXEntry, ifStackGroup=ifStackGroup, linkDown=linkDown, ifOutUcastPkts=ifOutUcastPkts, ifName=ifName, ifInBroadcastPkts=ifInBroadcastPkts, ifTestType=ifTestType, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifEntry=ifEntry, ifInNUcastPkts=ifInNUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifAdminStatus=ifAdminStatus)
