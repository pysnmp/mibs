...
PhysAddress, TestAndIncr, TextualConvention, TruthValue, AutonomousType, DisplayString, TimeStamp, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TestAndIncr", "TextualConvention", "TruthValue", "AutonomousType", "DisplayString", "TimeStamp", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifConnectorPresent=ifConnectorPresent, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInOctets=ifHCInOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, linkDown=linkDown, ifInDiscards=ifInDiscards, ifStackHigherLayer=ifStackHigherLayer, ifStackGroup2=ifStackGroup2, ifTestCode=ifTestCode, ifCompliance2=ifCompliance2, ifPhysAddress=ifPhysAddress, ifMIBObjects=ifMIBObjects, ifTestEntry=ifTestEntry, ifStackGroup=ifStackGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifTable=ifTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressEntry=ifRcvAddressEntry, ifRcvAddressType=ifRcvAddressType, ifSpeed=ifSpeed, ifOutUcastPkts=ifOutUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifOutErrors=ifOutErrors, ifCompliance3=ifCompliance3, ifTestResult=ifTestResult, ifTableLastChange=ifTableLastChange, interfaces=interfaces, ifMtu=ifMtu, ifStackLowerLayer=ifStackLowerLayer, ifStackLastChange=ifStackLastChange, InterfaceIndex=InterfaceIndex, ifType=ifType, ifCompliance=ifCompliance, ifInOctets=ifInOctets, ifConformance=ifConformance, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliances=ifCompliances, ifSpecific=ifSpecific, ifVHCPacketGroup=ifVHCPacketGroup, ifAdminStatus=ifAdminStatus, ifName=ifName, ifTestType=ifTestType, ifStackTable=ifStackTable, ifOperStatus=ifOperStatus, ifXEntry=ifXEntry, ifInMulticastPkts=ifInMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifGeneralGroup=ifGeneralGroup, ifHCOutOctets=ifHCOutOctets, ifXTable=ifXTable, ifAlias=ifAlias, ifRcvAddressGroup=ifRcvAddressGroup, linkUp=linkUp, ifPromiscuousMode=ifPromiscuousMode, ifInUnknownProtos=ifInUnknownProtos, ifInBroadcastPkts=ifInBroadcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, ifEntry=ifEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifHighSpeed=ifHighSpeed, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifInErrors=ifInErrors, ifOldObjectsGroup=ifOldObjectsGroup, ifMIB=ifMIB, ifLastChange=ifLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressTable=ifRcvAddressTable, ifInUcastPkts=ifInUcastPkts, ifTestOwner=ifTestOwner, ifOutNUcastPkts=ifOutNUcastPkts, ifDescr=ifDescr, ifOutOctets=ifOutOctets, PYSNMP_MODULE_ID=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackEntry=ifStackEntry, ifTestId=ifTestId, ifFixedLengthGroup=ifFixedLengthGroup, ifIndex=ifIndex, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifGroups=ifGroups, ifOutDiscards=ifOutDiscards, ifHCInUcastPkts=ifHCInUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestGroup=ifTestGroup)
