...
TimeStamp, TruthValue, AutonomousType, TestAndIncr, DisplayString, TextualConvention, RowStatus, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TruthValue", "AutonomousType", "TestAndIncr", "DisplayString", "TextualConvention", "RowStatus", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressTable=ifRcvAddressTable, interfaces=interfaces, ifInUnknownProtos=ifInUnknownProtos, PYSNMP_MODULE_ID=ifMIB, ifFixedLengthGroup=ifFixedLengthGroup, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifInBroadcastPkts=ifInBroadcastPkts, ifName=ifName, linkUp=linkUp, ifOutQLen=ifOutQLen, ifIndex=ifIndex, InterfaceIndex=InterfaceIndex, ifSpecific=ifSpecific, ifStackLowerLayer=ifStackLowerLayer, ifXEntry=ifXEntry, ifType=ifType, ifConformance=ifConformance, ifStackGroup=ifStackGroup, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifOutUcastPkts=ifOutUcastPkts, ifAlias=ifAlias, ifCompliance2=ifCompliance2, ifOldObjectsGroup=ifOldObjectsGroup, ifHCPacketGroup=ifHCPacketGroup, ifMIB=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifTestType=ifTestType, ifTestStatus=ifTestStatus, ifCompliance=ifCompliance, ifInOctets=ifInOctets, ifHCOutOctets=ifHCOutOctets, ifGeneralGroup=ifGeneralGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifDescr=ifDescr, ifTestResult=ifTestResult, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifStackLastChange=ifStackLastChange, ifAdminStatus=ifAdminStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifHCInOctets=ifHCInOctets, ifInDiscards=ifInDiscards, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliances=ifCompliances, ifOutOctets=ifOutOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTable=ifTable, ifStackGroup2=ifStackGroup2, ifTestId=ifTestId, ifConnectorPresent=ifConnectorPresent, ifPromiscuousMode=ifPromiscuousMode, ifTestCode=ifTestCode, ifVHCPacketGroup=ifVHCPacketGroup, ifTestGroup=ifTestGroup, ifInNUcastPkts=ifInNUcastPkts, ifTestOwner=ifTestOwner, ifOperStatus=ifOperStatus, ifStackHigherLayer=ifStackHigherLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifXTable=ifXTable, ifGroups=ifGroups, ifPacketGroup=ifPacketGroup, ifTestTable=ifTestTable, ifOutMulticastPkts=ifOutMulticastPkts, ifTableLastChange=ifTableLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackTable=ifStackTable, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifRcvAddressAddress=ifRcvAddressAddress, ifRcvAddressType=ifRcvAddressType, ifTestEntry=ifTestEntry, ifOutDiscards=ifOutDiscards, linkDown=linkDown, ifCompliance3=ifCompliance3, ifInUcastPkts=ifInUcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutErrors=ifOutErrors, InterfaceIndexOrZero=InterfaceIndexOrZero, ifLastChange=ifLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifEntry=ifEntry)
