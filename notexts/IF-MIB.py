...
TextualConvention, PhysAddress, DisplayString, TruthValue, AutonomousType, RowStatus, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "DisplayString", "TruthValue", "AutonomousType", "RowStatus", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifDescr=ifDescr, ifSpeed=ifSpeed, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifInErrors=ifInErrors, ifTestStatus=ifTestStatus, ifPacketGroup=ifPacketGroup, ifStackTable=ifStackTable, ifCompliance3=ifCompliance3, ifCompliance=ifCompliance, ifInMulticastPkts=ifInMulticastPkts, ifAdminStatus=ifAdminStatus, ifXEntry=ifXEntry, ifConnectorPresent=ifConnectorPresent, ifOldObjectsGroup=ifOldObjectsGroup, ifHighSpeed=ifHighSpeed, ifInUnknownProtos=ifInUnknownProtos, ifHCOutOctets=ifHCOutOctets, ifOutUcastPkts=ifOutUcastPkts, ifTestType=ifTestType, ifMIB=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifOutErrors=ifOutErrors, ifRcvAddressStatus=ifRcvAddressStatus, ifSpecific=ifSpecific, ifPromiscuousMode=ifPromiscuousMode, ifStackStatus=ifStackStatus, ifNumber=ifNumber, ifGeneralGroup=ifGeneralGroup, OwnerString=OwnerString, ifOutNUcastPkts=ifOutNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressType=ifRcvAddressType, ifOutMulticastPkts=ifOutMulticastPkts, ifInOctets=ifInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifTable=ifTable, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLastChange=ifStackLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutQLen=ifOutQLen, ifEntry=ifEntry, ifTestEntry=ifTestEntry, linkUp=linkUp, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance2=ifCompliance2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifIndex=ifIndex, ifOperStatus=ifOperStatus, ifInNUcastPkts=ifInNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutOctets=ifOutOctets, ifInDiscards=ifInDiscards, ifGroups=ifGroups, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, InterfaceIndexOrZero=InterfaceIndexOrZero, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifTableLastChange=ifTableLastChange, ifAlias=ifAlias, ifMtu=ifMtu, ifStackLowerLayer=ifStackLowerLayer, ifLastChange=ifLastChange, ifStackGroup2=ifStackGroup2, ifTestResult=ifTestResult, ifTestCode=ifTestCode, ifXTable=ifXTable, InterfaceIndex=InterfaceIndex, linkDown=linkDown, ifTestGroup=ifTestGroup, ifStackEntry=ifStackEntry, ifType=ifType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifMIBObjects=ifMIBObjects, ifConformance=ifConformance, ifStackGroup=ifStackGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifName=ifName, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackHigherLayer=ifStackHigherLayer, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliances=ifCompliances, ifTestTable=ifTestTable, ifPhysAddress=ifPhysAddress, ifTestOwner=ifTestOwner)
