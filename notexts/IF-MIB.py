...
Counter32, Gauge32, mib_2, Bits, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, Unsigned32, Integer32, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "mib-2", "Bits", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "Unsigned32", "Integer32", "ModuleIdentity", "MibIdentifier")
RowStatus, PhysAddress, TextualConvention, TestAndIncr, TimeStamp, AutonomousType, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "PhysAddress", "TextualConvention", "TestAndIncr", "TimeStamp", "AutonomousType", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifStackHigherLayer=ifStackHigherLayer, OwnerString=OwnerString, ifGeneralGroup=ifGeneralGroup, ifStackTable=ifStackTable, ifTestOwner=ifTestOwner, ifConformance=ifConformance, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, ifTable=ifTable, ifTestEntry=ifTestEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestCode=ifTestCode, ifHCInUcastPkts=ifHCInUcastPkts, ifPhysAddress=ifPhysAddress, ifRcvAddressGroup=ifRcvAddressGroup, ifStackLastChange=ifStackLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMtu=ifMtu, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, ifTestType=ifTestType, linkUp=linkUp, ifOperStatus=ifOperStatus, ifDescr=ifDescr, ifAlias=ifAlias, ifType=ifType, ifTestStatus=ifTestStatus, ifHCPacketGroup=ifHCPacketGroup, ifOutQLen=ifOutQLen, ifInDiscards=ifInDiscards, ifMIBObjects=ifMIBObjects, PYSNMP_MODULE_ID=ifMIB, ifInUnknownProtos=ifInUnknownProtos, ifOutDiscards=ifOutDiscards, ifInNUcastPkts=ifInNUcastPkts, ifLastChange=ifLastChange, ifInUcastPkts=ifInUcastPkts, ifIndex=ifIndex, ifOutMulticastPkts=ifOutMulticastPkts, ifPromiscuousMode=ifPromiscuousMode, ifInMulticastPkts=ifInMulticastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifXEntry=ifXEntry, ifAdminStatus=ifAdminStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifOutOctets=ifOutOctets, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackStatus=ifStackStatus, ifXTable=ifXTable, ifConnectorPresent=ifConnectorPresent, ifRcvAddressAddress=ifRcvAddressAddress, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestResult=ifTestResult, ifInErrors=ifInErrors, linkDown=linkDown, ifCompliance=ifCompliance, ifGroups=ifGroups, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifTableLastChange=ifTableLastChange, ifOutErrors=ifOutErrors, ifStackGroup2=ifStackGroup2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutOctets=ifHCOutOctets, ifCompliance3=ifCompliance3, ifOutUcastPkts=ifOutUcastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifTestGroup=ifTestGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifEntry=ifEntry, ifInOctets=ifInOctets, ifHighSpeed=ifHighSpeed, ifSpecific=ifSpecific, ifTestId=ifTestId, ifSpeed=ifSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndex=InterfaceIndex, ifRcvAddressType=ifRcvAddressType, ifRcvAddressTable=ifRcvAddressTable, ifTestTable=ifTestTable, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifFixedLengthGroup=ifFixedLengthGroup, interfaces=interfaces, ifHCInOctets=ifHCInOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifMIB=ifMIB, ifCompliances=ifCompliances)
