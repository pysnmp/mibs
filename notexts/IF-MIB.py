...
TimeTicks, Counter64, Gauge32, MibIdentifier, NotificationType, mib_2, iso, Counter32, ModuleIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Gauge32", "MibIdentifier", "NotificationType", "mib-2", "iso", "Counter32", "ModuleIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "IpAddress")
PhysAddress, TextualConvention, TimeStamp, DisplayString, RowStatus, AutonomousType, TestAndIncr, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "TimeStamp", "DisplayString", "RowStatus", "AutonomousType", "TestAndIncr", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifOutErrors=ifOutErrors, InterfaceIndex=InterfaceIndex, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance2=ifCompliance2, ifInOctets=ifInOctets, ifRcvAddressStatus=ifRcvAddressStatus, ifNumber=ifNumber, ifInMulticastPkts=ifInMulticastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance=ifCompliance, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOldObjectsGroup=ifOldObjectsGroup, ifMIBObjects=ifMIBObjects, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliances=ifCompliances, ifAlias=ifAlias, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifHCPacketGroup=ifHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifInDiscards=ifInDiscards, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifSpeed=ifSpeed, ifConformance=ifConformance, ifOutQLen=ifOutQLen, ifOutDiscards=ifOutDiscards, ifTable=ifTable, ifEntry=ifEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifXTable=ifXTable, ifSpecific=ifSpecific, ifOperStatus=ifOperStatus, ifAdminStatus=ifAdminStatus, linkUp=linkUp, ifTestEntry=ifTestEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifType=ifType, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestOwner=ifTestOwner, ifInUnknownProtos=ifInUnknownProtos, ifTestId=ifTestId, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifRcvAddressType=ifRcvAddressType, ifStackStatus=ifStackStatus, ifHCOutOctets=ifHCOutOctets, interfaces=interfaces, ifInUcastPkts=ifInUcastPkts, ifTestTable=ifTestTable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifXEntry=ifXEntry, ifTestType=ifTestType, ifOutUcastPkts=ifOutUcastPkts, ifIndex=ifIndex, linkDown=linkDown, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifPromiscuousMode=ifPromiscuousMode, ifConnectorPresent=ifConnectorPresent, ifStackLowerLayer=ifStackLowerLayer, ifHCInOctets=ifHCInOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup=ifStackGroup, ifTestStatus=ifTestStatus, ifStackGroup2=ifStackGroup2, ifStackTable=ifStackTable, ifTableLastChange=ifTableLastChange, ifHighSpeed=ifHighSpeed, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifPacketGroup=ifPacketGroup, ifDescr=ifDescr, ifLastChange=ifLastChange, ifStackLastChange=ifStackLastChange, ifGroups=ifGroups, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance3=ifCompliance3, ifGeneralGroup=ifGeneralGroup, PYSNMP_MODULE_ID=ifMIB, ifOutOctets=ifOutOctets, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifMIB=ifMIB, ifStackHigherLayer=ifStackHigherLayer, ifMtu=ifMtu)
