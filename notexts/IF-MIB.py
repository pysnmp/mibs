...
AutonomousType, TruthValue, DisplayString, TimeStamp, TextualConvention, RowStatus, PhysAddress, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "PhysAddress", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTestType=ifTestType, ifInMulticastPkts=ifInMulticastPkts, interfaces=interfaces, ifNumber=ifNumber, ifInUnknownProtos=ifInUnknownProtos, ifInOctets=ifInOctets, InterfaceIndex=InterfaceIndex, ifTestOwner=ifTestOwner, ifHighSpeed=ifHighSpeed, ifStackLowerLayer=ifStackLowerLayer, ifPhysAddress=ifPhysAddress, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackGroup=ifStackGroup, ifConnectorPresent=ifConnectorPresent, ifTestGroup=ifTestGroup, ifAdminStatus=ifAdminStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifXEntry=ifXEntry, ifTestResult=ifTestResult, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance3=ifCompliance3, ifRcvAddressAddress=ifRcvAddressAddress, ifMIBObjects=ifMIBObjects, ifInErrors=ifInErrors, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutErrors=ifOutErrors, ifEntry=ifEntry, ifMIB=ifMIB, ifCompliance2=ifCompliance2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressStatus=ifRcvAddressStatus, ifTable=ifTable, ifTestTable=ifTestTable, ifOperStatus=ifOperStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifXTable=ifXTable, ifName=ifName, ifType=ifType, ifInBroadcastPkts=ifInBroadcastPkts, ifStackTable=ifStackTable, ifInUcastPkts=ifInUcastPkts, ifRcvAddressEntry=ifRcvAddressEntry, ifMtu=ifMtu, ifFixedLengthGroup=ifFixedLengthGroup, ifHCInUcastPkts=ifHCInUcastPkts, linkDown=linkDown, ifCompliance=ifCompliance, ifRcvAddressGroup=ifRcvAddressGroup, linkUp=linkUp, ifSpecific=ifSpecific, ifOutUcastPkts=ifOutUcastPkts, ifStackEntry=ifStackEntry, ifOldObjectsGroup=ifOldObjectsGroup, ifLastChange=ifLastChange, ifInDiscards=ifInDiscards, ifHCOutOctets=ifHCOutOctets, ifSpeed=ifSpeed, ifPacketGroup=ifPacketGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutOctets=ifOutOctets, ifTestId=ifTestId, ifTableLastChange=ifTableLastChange, ifConformance=ifConformance, ifGeneralGroup=ifGeneralGroup, ifHCInOctets=ifHCInOctets, ifTestEntry=ifTestEntry, ifIndex=ifIndex, ifAlias=ifAlias, ifCompliances=ifCompliances, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackLastChange=ifStackLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutDiscards=ifOutDiscards, ifTestStatus=ifTestStatus, ifOutMulticastPkts=ifOutMulticastPkts, ifOutQLen=ifOutQLen, ifGroups=ifGroups, ifPromiscuousMode=ifPromiscuousMode, OwnerString=OwnerString, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup2=ifStackGroup2, ifStackHigherLayer=ifStackHigherLayer, ifStackStatus=ifStackStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestCode=ifTestCode, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifDescr=ifDescr)
