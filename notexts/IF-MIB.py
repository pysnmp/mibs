...
TruthValue, PhysAddress, TestAndIncr, TimeStamp, DisplayString, TextualConvention, RowStatus, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "PhysAddress", "TestAndIncr", "TimeStamp", "DisplayString", "TextualConvention", "RowStatus", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifName=ifName, ifVHCPacketGroup=ifVHCPacketGroup, ifTestEntry=ifTestEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInOctets=ifHCInOctets, ifOperStatus=ifOperStatus, ifNumber=ifNumber, ifTestTable=ifTestTable, ifHCOutUcastPkts=ifHCOutUcastPkts, ifSpeed=ifSpeed, ifTestOwner=ifTestOwner, ifType=ifType, ifStackTable=ifStackTable, ifStackHigherLayer=ifStackHigherLayer, ifOldObjectsGroup=ifOldObjectsGroup, ifStackGroup=ifStackGroup, ifAdminStatus=ifAdminStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifInNUcastPkts=ifInNUcastPkts, ifIndex=ifIndex, ifStackEntry=ifStackEntry, ifMIBObjects=ifMIBObjects, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifStackLowerLayer=ifStackLowerLayer, ifCompliances=ifCompliances, ifHighSpeed=ifHighSpeed, ifCompliance3=ifCompliance3, ifStackGroup2=ifStackGroup2, ifGeneralInformationGroup=ifGeneralInformationGroup, OwnerString=OwnerString, ifInOctets=ifInOctets, ifTestResult=ifTestResult, ifInMulticastPkts=ifInMulticastPkts, ifTestCode=ifTestCode, ifPromiscuousMode=ifPromiscuousMode, ifOutErrors=ifOutErrors, ifRcvAddressTable=ifRcvAddressTable, ifHCOutOctets=ifHCOutOctets, ifRcvAddressType=ifRcvAddressType, ifInErrors=ifInErrors, ifTestStatus=ifTestStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifXTable=ifXTable, ifFixedLengthGroup=ifFixedLengthGroup, ifConformance=ifConformance, ifHCPacketGroup=ifHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLastChange=ifLastChange, ifMIB=ifMIB, ifMtu=ifMtu, ifCompliance2=ifCompliance2, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUp=linkUp, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifTestType=ifTestType, ifTestId=ifTestId, ifOutNUcastPkts=ifOutNUcastPkts, ifOutQLen=ifOutQLen, ifTable=ifTable, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifGroups=ifGroups, ifOutBroadcastPkts=ifOutBroadcastPkts, interfaces=interfaces, ifXEntry=ifXEntry, ifOutUcastPkts=ifOutUcastPkts, ifTestGroup=ifTestGroup, ifSpecific=ifSpecific, ifGeneralGroup=ifGeneralGroup, linkDown=linkDown, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifOutDiscards=ifOutDiscards, ifTableLastChange=ifTableLastChange, ifInUnknownProtos=ifInUnknownProtos, ifHCInUcastPkts=ifHCInUcastPkts, ifStackStatus=ifStackStatus, ifRcvAddressEntry=ifRcvAddressEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, InterfaceIndex=InterfaceIndex, ifInDiscards=ifInDiscards, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCompliance=ifCompliance, ifInUcastPkts=ifInUcastPkts, ifOutOctets=ifOutOctets)
