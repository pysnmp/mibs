...
RowStatus, AutonomousType, TextualConvention, TestAndIncr, TruthValue, DisplayString, TimeStamp, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "TextualConvention", "TestAndIncr", "TruthValue", "DisplayString", "TimeStamp", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifType=ifType, OwnerString=OwnerString, ifInUnknownProtos=ifInUnknownProtos, ifCompliance3=ifCompliance3, ifOperStatus=ifOperStatus, ifRcvAddressEntry=ifRcvAddressEntry, ifOutUcastPkts=ifOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, ifTestResult=ifTestResult, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifStackEntry=ifStackEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, linkUp=linkUp, ifOutMulticastPkts=ifOutMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifGroups=ifGroups, ifFixedLengthGroup=ifFixedLengthGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifEntry=ifEntry, ifTestCode=ifTestCode, ifStackHigherLayer=ifStackHigherLayer, ifStackTable=ifStackTable, ifTestEntry=ifTestEntry, ifAlias=ifAlias, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifTestId=ifTestId, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralGroup=ifGeneralGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifDescr=ifDescr, ifGeneralInformationGroup=ifGeneralInformationGroup, interfaces=interfaces, ifOutDiscards=ifOutDiscards, ifVHCPacketGroup=ifVHCPacketGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutQLen=ifOutQLen, ifRcvAddressStatus=ifRcvAddressStatus, ifSpecific=ifSpecific, ifCompliances=ifCompliances, linkDown=linkDown, ifHCInOctets=ifHCInOctets, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndex=InterfaceIndex, ifTestOwner=ifTestOwner, ifCompliance=ifCompliance, ifTestGroup=ifTestGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestStatus=ifTestStatus, ifInNUcastPkts=ifInNUcastPkts, ifTestTable=ifTestTable, ifHCOutOctets=ifHCOutOctets, ifInMulticastPkts=ifInMulticastPkts, ifStackGroup2=ifStackGroup2, ifRcvAddressType=ifRcvAddressType, ifOutBroadcastPkts=ifOutBroadcastPkts, ifIndex=ifIndex, ifOutOctets=ifOutOctets, ifStackStatus=ifStackStatus, ifPromiscuousMode=ifPromiscuousMode, ifTestType=ifTestType, ifInBroadcastPkts=ifInBroadcastPkts, ifTable=ifTable, ifXEntry=ifXEntry, ifMIBObjects=ifMIBObjects, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifConformance=ifConformance, ifNumber=ifNumber, ifAdminStatus=ifAdminStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifSpeed=ifSpeed, ifMtu=ifMtu, ifCompliance2=ifCompliance2, ifPacketGroup=ifPacketGroup, ifName=ifName, ifMIB=ifMIB, ifLastChange=ifLastChange, ifInOctets=ifInOctets, ifPhysAddress=ifPhysAddress, PYSNMP_MODULE_ID=ifMIB, ifHighSpeed=ifHighSpeed, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifStackGroup=ifStackGroup, ifConnectorPresent=ifConnectorPresent, ifRcvAddressGroup=ifRcvAddressGroup, ifInErrors=ifInErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifTableLastChange=ifTableLastChange)
