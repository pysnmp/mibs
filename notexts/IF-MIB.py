...
NotificationType, ObjectIdentity, Bits, MibIdentifier, mib_2, Gauge32, Counter32, Unsigned32, IpAddress, TimeTicks, Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Bits", "MibIdentifier", "mib-2", "Gauge32", "Counter32", "Unsigned32", "IpAddress", "TimeTicks", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
TruthValue, AutonomousType, DisplayString, TextualConvention, TimeStamp, RowStatus, PhysAddress, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "AutonomousType", "DisplayString", "TextualConvention", "TimeStamp", "RowStatus", "PhysAddress", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifInOctets=ifInOctets, ifConformance=ifConformance, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifRcvAddressTable=ifRcvAddressTable, ifTestTable=ifTestTable, ifPacketGroup=ifPacketGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInOctets=ifHCInOctets, ifXEntry=ifXEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifIndex=ifIndex, ifRcvAddressType=ifRcvAddressType, ifInUnknownProtos=ifInUnknownProtos, ifOutUcastPkts=ifOutUcastPkts, ifGroups=ifGroups, ifEntry=ifEntry, ifStackGroup=ifStackGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifFixedLengthGroup=ifFixedLengthGroup, ifTestGroup=ifTestGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifSpeed=ifSpeed, ifPromiscuousMode=ifPromiscuousMode, ifHighSpeed=ifHighSpeed, interfaces=interfaces, ifTestResult=ifTestResult, ifHCFixedLengthGroup=ifHCFixedLengthGroup, linkUp=linkUp, InterfaceIndexOrZero=InterfaceIndexOrZero, ifRcvAddressEntry=ifRcvAddressEntry, ifTestId=ifTestId, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestCode=ifTestCode, ifTestOwner=ifTestOwner, ifStackLastChange=ifStackLastChange, ifTestType=ifTestType, ifHCOutOctets=ifHCOutOctets, ifGeneralGroup=ifGeneralGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifDescr=ifDescr, ifConnectorPresent=ifConnectorPresent, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutDiscards=ifOutDiscards, ifMIB=ifMIB, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifName=ifName, ifType=ifType, PYSNMP_MODULE_ID=ifMIB, ifInDiscards=ifInDiscards, ifOperStatus=ifOperStatus, ifLastChange=ifLastChange, ifStackLowerLayer=ifStackLowerLayer, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackTable=ifStackTable, ifTable=ifTable, ifHCInUcastPkts=ifHCInUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifStackGroup2=ifStackGroup2, ifAlias=ifAlias, ifOutQLen=ifOutQLen, ifRcvAddressGroup=ifRcvAddressGroup, ifOutOctets=ifOutOctets, ifNumber=ifNumber, ifCompliance2=ifCompliance2, ifInBroadcastPkts=ifInBroadcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifCompliance3=ifCompliance3, OwnerString=OwnerString, ifAdminStatus=ifAdminStatus, ifOutNUcastPkts=ifOutNUcastPkts, ifSpecific=ifSpecific, ifCompliances=ifCompliances, ifTestEntry=ifTestEntry, ifRcvAddressStatus=ifRcvAddressStatus, ifOutErrors=ifOutErrors, ifTestStatus=ifTestStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, InterfaceIndex=InterfaceIndex, ifHCPacketGroup=ifHCPacketGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTableLastChange=ifTableLastChange, ifMtu=ifMtu, ifInUcastPkts=ifInUcastPkts, ifXTable=ifXTable, ifStackStatus=ifStackStatus, ifPhysAddress=ifPhysAddress, ifInErrors=ifInErrors, ifMIBObjects=ifMIBObjects, ifStackEntry=ifStackEntry, ifInMulticastPkts=ifInMulticastPkts, linkDown=linkDown)
