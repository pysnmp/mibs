...
AutonomousType, DisplayString, TruthValue, PhysAddress, TimeStamp, TestAndIncr, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "DisplayString", "TruthValue", "PhysAddress", "TimeStamp", "TestAndIncr", "TextualConvention", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", interfaces=interfaces, ifStackEntry=ifStackEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifSpecific=ifSpecific, OwnerString=OwnerString, InterfaceIndex=InterfaceIndex, ifTestOwner=ifTestOwner, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifInUnknownProtos=ifInUnknownProtos, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, PYSNMP_MODULE_ID=ifMIB, ifRcvAddressTable=ifRcvAddressTable, ifName=ifName, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralGroup=ifGeneralGroup, ifSpeed=ifSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifMIBObjects=ifMIBObjects, ifRcvAddressType=ifRcvAddressType, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInNUcastPkts=ifInNUcastPkts, ifIndex=ifIndex, ifAdminStatus=ifAdminStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifOperStatus=ifOperStatus, ifCompliances=ifCompliances, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifPhysAddress=ifPhysAddress, ifOutErrors=ifOutErrors, ifInErrors=ifInErrors, ifInOctets=ifInOctets, ifMIB=ifMIB, ifType=ifType, ifStackGroup2=ifStackGroup2, ifTestTable=ifTestTable, ifOutOctets=ifOutOctets, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifStackLastChange=ifStackLastChange, ifConformance=ifConformance, linkDown=linkDown, ifLastChange=ifLastChange, ifOutQLen=ifOutQLen, ifRcvAddressAddress=ifRcvAddressAddress, ifTableLastChange=ifTableLastChange, ifGroups=ifGroups, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifXTable=ifXTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackStatus=ifStackStatus, ifStackHigherLayer=ifStackHigherLayer, ifHCOutUcastPkts=ifHCOutUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifCompliance2=ifCompliance2, ifHighSpeed=ifHighSpeed, ifAlias=ifAlias, ifInMulticastPkts=ifInMulticastPkts, ifTestEntry=ifTestEntry, ifNumber=ifNumber, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXEntry=ifXEntry, ifRcvAddressGroup=ifRcvAddressGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutOctets=ifHCOutOctets, ifEntry=ifEntry, ifConnectorPresent=ifConnectorPresent, ifOutDiscards=ifOutDiscards, ifDescr=ifDescr, ifTestGroup=ifTestGroup, linkUp=linkUp, ifTestResult=ifTestResult, ifMtu=ifMtu, ifTestId=ifTestId, ifTestCode=ifTestCode, ifTable=ifTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliance=ifCompliance, ifCompliance3=ifCompliance3, ifTestType=ifTestType, ifInUcastPkts=ifInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup=ifStackGroup, ifHCInOctets=ifHCInOctets, ifInBroadcastPkts=ifInBroadcastPkts, ifPacketGroup=ifPacketGroup, ifStackTable=ifStackTable)
