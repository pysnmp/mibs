...
PhysAddress, TextualConvention, TestAndIncr, TruthValue, AutonomousType, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "TestAndIncr", "TruthValue", "AutonomousType", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifAdminStatus=ifAdminStatus, ifEntry=ifEntry, ifPacketGroup=ifPacketGroup, ifCompliances=ifCompliances, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifMIBObjects=ifMIBObjects, ifRcvAddressStatus=ifRcvAddressStatus, ifMtu=ifMtu, ifName=ifName, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifOutErrors=ifOutErrors, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGroups=ifGroups, ifInUcastPkts=ifInUcastPkts, ifTestStatus=ifTestStatus, ifNumber=ifNumber, ifOldObjectsGroup=ifOldObjectsGroup, ifType=ifType, ifDescr=ifDescr, InterfaceIndexOrZero=InterfaceIndexOrZero, ifPromiscuousMode=ifPromiscuousMode, OwnerString=OwnerString, ifTestOwner=ifTestOwner, ifCompliance3=ifCompliance3, ifRcvAddressAddress=ifRcvAddressAddress, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestId=ifTestId, ifTestResult=ifTestResult, ifCompliance2=ifCompliance2, ifOutMulticastPkts=ifOutMulticastPkts, ifStackLastChange=ifStackLastChange, ifTestCode=ifTestCode, InterfaceIndex=InterfaceIndex, ifTestEntry=ifTestEntry, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifTestGroup=ifTestGroup, ifTestTable=ifTestTable, interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, linkUp=linkUp, ifGeneralGroup=ifGeneralGroup, linkDown=linkDown, ifGeneralInformationGroup=ifGeneralInformationGroup, ifHCInOctets=ifHCInOctets, ifFixedLengthGroup=ifFixedLengthGroup, ifLastChange=ifLastChange, ifOutOctets=ifOutOctets, ifSpeed=ifSpeed, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTableLastChange=ifTableLastChange, ifInUnknownProtos=ifInUnknownProtos, ifSpecific=ifSpecific, ifOutNUcastPkts=ifOutNUcastPkts, ifInNUcastPkts=ifInNUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifTestType=ifTestType, ifStackHigherLayer=ifStackHigherLayer, ifConformance=ifConformance, ifRcvAddressTable=ifRcvAddressTable, ifStackLowerLayer=ifStackLowerLayer, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifOperStatus=ifOperStatus, ifXEntry=ifXEntry, ifIndex=ifIndex, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifConnectorPresent=ifConnectorPresent, ifStackStatus=ifStackStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifInErrors=ifInErrors, ifStackEntry=ifStackEntry, ifOutUcastPkts=ifOutUcastPkts, ifMIB=ifMIB, ifStackGroup=ifStackGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifHCPacketGroup=ifHCPacketGroup, ifTable=ifTable, ifInDiscards=ifInDiscards, ifCompliance=ifCompliance, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts, ifStackTable=ifStackTable, ifOutDiscards=ifOutDiscards, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifXTable=ifXTable, ifOutQLen=ifOutQLen, ifPhysAddress=ifPhysAddress, ifAlias=ifAlias)
