...
PhysAddress, TextualConvention, AutonomousType, TruthValue, DisplayString, RowStatus, TimeStamp, TestAndIncr = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TextualConvention", "AutonomousType", "TruthValue", "DisplayString", "RowStatus", "TimeStamp", "TestAndIncr")
...
mibBuilder.exportSymbols("IF-MIB", ifTestType=ifTestType, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifDescr=ifDescr, ifRcvAddressType=ifRcvAddressType, ifOldObjectsGroup=ifOldObjectsGroup, ifLastChange=ifLastChange, ifCompliance=ifCompliance, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifSpecific=ifSpecific, ifConformance=ifConformance, ifStackTable=ifStackTable, ifOperStatus=ifOperStatus, ifTestCode=ifTestCode, ifXTable=ifXTable, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifGeneralInformationGroup=ifGeneralInformationGroup, ifPromiscuousMode=ifPromiscuousMode, ifTestTable=ifTestTable, ifConnectorPresent=ifConnectorPresent, ifInMulticastPkts=ifInMulticastPkts, linkDown=linkDown, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifInDiscards=ifInDiscards, ifInUcastPkts=ifInUcastPkts, ifTestId=ifTestId, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMtu=ifMtu, ifEntry=ifEntry, ifName=ifName, linkUp=linkUp, ifCompliance3=ifCompliance3, InterfaceIndex=InterfaceIndex, ifPhysAddress=ifPhysAddress, ifOutDiscards=ifOutDiscards, ifHCOutUcastPkts=ifHCOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHCPacketGroup=ifHCPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIB=ifMIB, ifPacketGroup=ifPacketGroup, ifTestGroup=ifTestGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifStackEntry=ifStackEntry, OwnerString=OwnerString, ifGroups=ifGroups, ifXEntry=ifXEntry, ifType=ifType, ifStackGroup2=ifStackGroup2, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackHigherLayer=ifStackHigherLayer, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpeed=ifSpeed, ifInOctets=ifInOctets, ifIndex=ifIndex, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackLastChange=ifStackLastChange, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTable=ifTable, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifHighSpeed=ifHighSpeed, ifAlias=ifAlias, ifTestResult=ifTestResult, ifHCOutOctets=ifHCOutOctets, ifTestOwner=ifTestOwner, ifStackStatus=ifStackStatus, ifRcvAddressAddress=ifRcvAddressAddress, ifTableLastChange=ifTableLastChange, PYSNMP_MODULE_ID=ifMIB, ifInErrors=ifInErrors, ifCompliance2=ifCompliance2, ifGeneralGroup=ifGeneralGroup, ifInNUcastPkts=ifInNUcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutErrors=ifOutErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifOutOctets=ifOutOctets, ifCompliances=ifCompliances, ifTestStatus=ifTestStatus, ifMIBObjects=ifMIBObjects, ifRcvAddressTable=ifRcvAddressTable, ifStackGroup=ifStackGroup, ifAdminStatus=ifAdminStatus, ifRcvAddressStatus=ifRcvAddressStatus, ifTestEntry=ifTestEntry, interfaces=interfaces, ifOutUcastPkts=ifOutUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInOctets=ifHCInOctets, ifInUnknownProtos=ifInUnknownProtos)
