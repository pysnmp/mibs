...
PhysAddress, TruthValue, DisplayString, TestAndIncr, AutonomousType, TextualConvention, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "TruthValue", "DisplayString", "TestAndIncr", "AutonomousType", "TextualConvention", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestGroup=ifTestGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifInUcastPkts=ifInUcastPkts, ifConformance=ifConformance, ifTestId=ifTestId, ifStackGroup2=ifStackGroup2, ifStackLastChange=ifStackLastChange, ifRcvAddressTable=ifRcvAddressTable, ifOperStatus=ifOperStatus, ifCompliance3=ifCompliance3, ifPacketGroup=ifPacketGroup, ifHCInOctets=ifHCInOctets, ifCompliance2=ifCompliance2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifTestStatus=ifTestStatus, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutErrors=ifOutErrors, ifDescr=ifDescr, ifStackHigherLayer=ifStackHigherLayer, ifTestEntry=ifTestEntry, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestResult=ifTestResult, ifTable=ifTable, ifAlias=ifAlias, ifFixedLengthGroup=ifFixedLengthGroup, ifIndex=ifIndex, linkUp=linkUp, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestOwner=ifTestOwner, ifLastChange=ifLastChange, ifStackGroup=ifStackGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifNumber=ifNumber, ifHighSpeed=ifHighSpeed, ifOutDiscards=ifOutDiscards, ifStackStatus=ifStackStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutOctets=ifHCOutOctets, ifTestCode=ifTestCode, ifRcvAddressAddress=ifRcvAddressAddress, ifInBroadcastPkts=ifInBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifSpeed=ifSpeed, ifTableLastChange=ifTableLastChange, ifOutNUcastPkts=ifOutNUcastPkts, OwnerString=OwnerString, ifCompliance=ifCompliance, ifOutUcastPkts=ifOutUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifOutQLen=ifOutQLen, interfaces=interfaces, ifInNUcastPkts=ifInNUcastPkts, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifOutOctets=ifOutOctets, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifMtu=ifMtu, InterfaceIndexOrZero=InterfaceIndexOrZero, ifAdminStatus=ifAdminStatus, ifConnectorPresent=ifConnectorPresent, ifInErrors=ifInErrors, ifGroups=ifGroups, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifRcvAddressType=ifRcvAddressType, ifInDiscards=ifInDiscards, ifMIB=ifMIB, ifStackEntry=ifStackEntry, linkDown=linkDown, ifRcvAddressStatus=ifRcvAddressStatus, ifPhysAddress=ifPhysAddress, ifStackTable=ifStackTable, ifInOctets=ifInOctets, ifEntry=ifEntry, ifSpecific=ifSpecific, ifTestTable=ifTestTable, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifGeneralGroup=ifGeneralGroup, ifXTable=ifXTable, PYSNMP_MODULE_ID=ifMIB, ifXEntry=ifXEntry, ifRcvAddressEntry=ifRcvAddressEntry, ifInMulticastPkts=ifInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifName=ifName, ifMIBObjects=ifMIBObjects, ifCompliances=ifCompliances, InterfaceIndex=InterfaceIndex, ifPromiscuousMode=ifPromiscuousMode, ifType=ifType, ifHCOutUcastPkts=ifHCOutUcastPkts)
