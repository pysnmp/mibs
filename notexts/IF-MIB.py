...
RowStatus, AutonomousType, DisplayString, PhysAddress, TextualConvention, TestAndIncr, TimeStamp, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "DisplayString", "PhysAddress", "TextualConvention", "TestAndIncr", "TimeStamp", "TruthValue")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressGroup=ifRcvAddressGroup, ifInNUcastPkts=ifInNUcastPkts, ifAlias=ifAlias, ifPromiscuousMode=ifPromiscuousMode, ifOutMulticastPkts=ifOutMulticastPkts, ifInUnknownProtos=ifInUnknownProtos, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInOctets=ifHCInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, linkDown=linkDown, ifInMulticastPkts=ifInMulticastPkts, ifTestCode=ifTestCode, ifStackHigherLayer=ifStackHigherLayer, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGeneralGroup=ifGeneralGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifMIB=ifMIB, ifXTable=ifXTable, ifStackGroup2=ifStackGroup2, ifInOctets=ifInOctets, ifXEntry=ifXEntry, ifStackEntry=ifStackEntry, ifCompliances=ifCompliances, ifTestResult=ifTestResult, ifConformance=ifConformance, ifLastChange=ifLastChange, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInDiscards=ifInDiscards, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifSpeed=ifSpeed, ifHCOutOctets=ifHCOutOctets, ifCompliance=ifCompliance, ifOutQLen=ifOutQLen, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressAddress=ifRcvAddressAddress, ifTableLastChange=ifTableLastChange, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackLowerLayer=ifStackLowerLayer, ifMIBObjects=ifMIBObjects, ifStackTable=ifStackTable, ifRcvAddressStatus=ifRcvAddressStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifTestType=ifTestType, ifDescr=ifDescr, ifMtu=ifMtu, ifTestId=ifTestId, ifPacketGroup=ifPacketGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance2=ifCompliance2, ifInErrors=ifInErrors, ifSpecific=ifSpecific, ifStackStatus=ifStackStatus, interfaces=interfaces, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutErrors=ifOutErrors, ifHCInUcastPkts=ifHCInUcastPkts, OwnerString=OwnerString, ifInBroadcastPkts=ifInBroadcastPkts, ifTestStatus=ifTestStatus, ifVHCPacketGroup=ifVHCPacketGroup, ifStackLastChange=ifStackLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifPhysAddress=ifPhysAddress, ifIndex=ifIndex, ifConnectorPresent=ifConnectorPresent, ifType=ifType, ifGroups=ifGroups, ifTestOwner=ifTestOwner, ifOutUcastPkts=ifOutUcastPkts, ifOutBroadcastPkts=ifOutBroadcastPkts, ifAdminStatus=ifAdminStatus, ifTestGroup=ifTestGroup, ifOperStatus=ifOperStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifName=ifName, ifRcvAddressEntry=ifRcvAddressEntry, ifOutOctets=ifOutOctets, ifTestTable=ifTestTable, PYSNMP_MODULE_ID=ifMIB, ifStackGroup=ifStackGroup, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, InterfaceIndex=InterfaceIndex, ifCompliance3=ifCompliance3, ifNumber=ifNumber, ifInUcastPkts=ifInUcastPkts, ifHighSpeed=ifHighSpeed, ifTable=ifTable, ifHCOutMulticastPkts=ifHCOutMulticastPkts, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, ifEntry=ifEntry, ifOutDiscards=ifOutDiscards)
