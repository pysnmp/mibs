...
TruthValue, DisplayString, AutonomousType, RowStatus, PhysAddress, TestAndIncr, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "AutonomousType", "RowStatus", "PhysAddress", "TestAndIncr", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifName=ifName, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestCode=ifTestCode, ifHCInMulticastPkts=ifHCInMulticastPkts, ifStackTable=ifStackTable, ifLastChange=ifLastChange, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutDiscards=ifOutDiscards, ifTableLastChange=ifTableLastChange, ifStackEntry=ifStackEntry, ifVHCPacketGroup=ifVHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifInErrors=ifInErrors, ifCompliances=ifCompliances, ifHCInOctets=ifHCInOctets, ifGroups=ifGroups, ifDescr=ifDescr, linkDown=linkDown, ifInUnknownProtos=ifInUnknownProtos, ifGeneralInformationGroup=ifGeneralInformationGroup, OwnerString=OwnerString, ifIndex=ifIndex, ifCompliance3=ifCompliance3, ifConnectorPresent=ifConnectorPresent, ifMIBObjects=ifMIBObjects, ifTestStatus=ifTestStatus, ifTestId=ifTestId, ifOperStatus=ifOperStatus, ifHCInUcastPkts=ifHCInUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifTestResult=ifTestResult, ifOutErrors=ifOutErrors, ifPromiscuousMode=ifPromiscuousMode, PYSNMP_MODULE_ID=ifMIB, ifEntry=ifEntry, ifHCPacketGroup=ifHCPacketGroup, ifTestEntry=ifTestEntry, ifTestType=ifTestType, linkUp=linkUp, ifSpecific=ifSpecific, ifStackHigherLayer=ifStackHigherLayer, ifPacketGroup=ifPacketGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifOutQLen=ifOutQLen, ifHighSpeed=ifHighSpeed, ifOldObjectsGroup=ifOldObjectsGroup, ifNumber=ifNumber, ifStackStatus=ifStackStatus, ifTable=ifTable, ifMIB=ifMIB, ifType=ifType, ifInNUcastPkts=ifInNUcastPkts, InterfaceIndex=InterfaceIndex, ifAlias=ifAlias, ifPhysAddress=ifPhysAddress, ifInUcastPkts=ifInUcastPkts, ifXTable=ifXTable, ifXEntry=ifXEntry, ifStackLastChange=ifStackLastChange, ifMtu=ifMtu, ifInOctets=ifInOctets, ifTestTable=ifTestTable, ifOutOctets=ifOutOctets, ifTestGroup=ifTestGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutMulticastPkts=ifOutMulticastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutUcastPkts=ifOutUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifHCOutOctets=ifHCOutOctets, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackGroup2=ifStackGroup2, ifConformance=ifConformance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, interfaces=interfaces, ifHCOutUcastPkts=ifHCOutUcastPkts, ifAdminStatus=ifAdminStatus, ifSpeed=ifSpeed, ifCompliance=ifCompliance, ifRcvAddressTable=ifRcvAddressTable, ifInDiscards=ifInDiscards, ifGeneralGroup=ifGeneralGroup, ifStackGroup=ifStackGroup, ifTestOwner=ifTestOwner, ifOutNUcastPkts=ifOutNUcastPkts, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifCompliance2=ifCompliance2, ifInMulticastPkts=ifInMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts)
