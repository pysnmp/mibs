...
AutonomousType, TimeStamp, TruthValue, TextualConvention, RowStatus, PhysAddress, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TimeStamp", "TruthValue", "TextualConvention", "RowStatus", "PhysAddress", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifOperStatus=ifOperStatus, ifXTable=ifXTable, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifMIBObjects=ifMIBObjects, ifInUnknownProtos=ifInUnknownProtos, ifStackEntry=ifStackEntry, ifPacketGroup=ifPacketGroup, ifGeneralGroup=ifGeneralGroup, ifOutNUcastPkts=ifOutNUcastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifType=ifType, ifInErrors=ifInErrors, ifInBroadcastPkts=ifInBroadcastPkts, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifOutUcastPkts=ifOutUcastPkts, ifTestStatus=ifTestStatus, ifTestType=ifTestType, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressType=ifRcvAddressType, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifConformance=ifConformance, ifInUcastPkts=ifInUcastPkts, ifInDiscards=ifInDiscards, ifOutOctets=ifOutOctets, ifRcvAddressAddress=ifRcvAddressAddress, ifFixedLengthGroup=ifFixedLengthGroup, ifOutQLen=ifOutQLen, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifCompliances=ifCompliances, ifGeneralInformationGroup=ifGeneralInformationGroup, OwnerString=OwnerString, ifConnectorPresent=ifConnectorPresent, ifPromiscuousMode=ifPromiscuousMode, ifPhysAddress=ifPhysAddress, ifAlias=ifAlias, linkUp=linkUp, ifStackLastChange=ifStackLastChange, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifXEntry=ifXEntry, ifTestId=ifTestId, ifOutErrors=ifOutErrors, ifRcvAddressEntry=ifRcvAddressEntry, ifTestEntry=ifTestEntry, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifCompliance3=ifCompliance3, ifVHCPacketGroup=ifVHCPacketGroup, ifDescr=ifDescr, ifHCInOctets=ifHCInOctets, ifMtu=ifMtu, ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifMIB=ifMIB, ifSpecific=ifSpecific, ifAdminStatus=ifAdminStatus, ifStackGroup=ifStackGroup, ifTestTable=ifTestTable, ifSpeed=ifSpeed, ifIndex=ifIndex, ifLastChange=ifLastChange, ifOutDiscards=ifOutDiscards, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTableLastChange=ifTableLastChange, ifInMulticastPkts=ifInMulticastPkts, ifInOctets=ifInOctets, ifTable=ifTable, ifTestResult=ifTestResult, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInNUcastPkts=ifInNUcastPkts, ifStackTable=ifStackTable, InterfaceIndex=InterfaceIndex, ifStackLowerLayer=ifStackLowerLayer, ifStackHigherLayer=ifStackHigherLayer, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifTestOwner=ifTestOwner, ifHCInUcastPkts=ifHCInUcastPkts, ifStackStatus=ifStackStatus, ifCompliance2=ifCompliance2, ifCompliance=ifCompliance, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCOutOctets=ifHCOutOctets, ifEntry=ifEntry, ifHCOutUcastPkts=ifHCOutUcastPkts)
