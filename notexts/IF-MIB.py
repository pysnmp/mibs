...
TextualConvention, PhysAddress, RowStatus, DisplayString, AutonomousType, TestAndIncr, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "PhysAddress", "RowStatus", "DisplayString", "AutonomousType", "TestAndIncr", "TruthValue", "TimeStamp")
...
mibBuilder.exportSymbols("IF-MIB", ifEntry=ifEntry, ifCompliance3=ifCompliance3, ifOutQLen=ifOutQLen, ifSpecific=ifSpecific, ifLastChange=ifLastChange, ifInDiscards=ifInDiscards, ifSpeed=ifSpeed, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifMIBObjects=ifMIBObjects, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestResult=ifTestResult, ifHCOutOctets=ifHCOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifOutDiscards=ifOutDiscards, ifCompliance2=ifCompliance2, ifTestId=ifTestId, ifHCInUcastPkts=ifHCInUcastPkts, ifTable=ifTable, ifAdminStatus=ifAdminStatus, ifFixedLengthGroup=ifFixedLengthGroup, ifName=ifName, ifRcvAddressStatus=ifRcvAddressStatus, ifInOctets=ifInOctets, PYSNMP_MODULE_ID=ifMIB, ifInMulticastPkts=ifInMulticastPkts, ifInUcastPkts=ifInUcastPkts, ifXEntry=ifXEntry, ifMIB=ifMIB, ifHCPacketGroup=ifHCPacketGroup, ifHCInOctets=ifHCInOctets, ifTestEntry=ifTestEntry, OwnerString=OwnerString, ifCompliance=ifCompliance, ifType=ifType, ifRcvAddressTable=ifRcvAddressTable, ifOutOctets=ifOutOctets, ifAlias=ifAlias, ifIndex=ifIndex, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCompliances=ifCompliances, ifGroups=ifGroups, ifRcvAddressAddress=ifRcvAddressAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOutMulticastPkts=ifOutMulticastPkts, ifOutErrors=ifOutErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifStackGroup=ifStackGroup, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifInErrors=ifInErrors, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHighSpeed=ifHighSpeed, ifStackEntry=ifStackEntry, ifTestStatus=ifTestStatus, ifInBroadcastPkts=ifInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifOperStatus=ifOperStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestGroup=ifTestGroup, ifMtu=ifMtu, ifTestCode=ifTestCode, interfaces=interfaces, ifXTable=ifXTable, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifPhysAddress=ifPhysAddress, linkDown=linkDown, ifStackLastChange=ifStackLastChange, ifInUnknownProtos=ifInUnknownProtos, ifStackStatus=ifStackStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestTable=ifTestTable, ifOldObjectsGroup=ifOldObjectsGroup, ifPacketGroup=ifPacketGroup, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifNumber=ifNumber, ifStackTable=ifStackTable, ifTableLastChange=ifTableLastChange, linkUp=linkUp, ifConformance=ifConformance, ifRcvAddressGroup=ifRcvAddressGroup, InterfaceIndex=InterfaceIndex, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifTestType=ifTestType, ifRcvAddressType=ifRcvAddressType, ifInNUcastPkts=ifInNUcastPkts, ifConnectorPresent=ifConnectorPresent, ifOutUcastPkts=ifOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner)
