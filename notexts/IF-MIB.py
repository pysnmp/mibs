...
mib_2, Counter64, Integer32, iso, Unsigned32, Counter32, MibIdentifier, TimeTicks, IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "Integer32", "iso", "Unsigned32", "Counter32", "MibIdentifier", "TimeTicks", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity")
AutonomousType, TruthValue, DisplayString, TimeStamp, TextualConvention, RowStatus, TestAndIncr, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "AutonomousType", "TruthValue", "DisplayString", "TimeStamp", "TextualConvention", "RowStatus", "TestAndIncr", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifInBroadcastPkts=ifInBroadcastPkts, linkDown=linkDown, ifOutOctets=ifOutOctets, ifGroups=ifGroups, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifTestResult=ifTestResult, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifInDiscards=ifInDiscards, ifInErrors=ifInErrors, ifCompliance3=ifCompliance3, ifStackGroup2=ifStackGroup2, ifMIB=ifMIB, ifOutNUcastPkts=ifOutNUcastPkts, ifOutDiscards=ifOutDiscards, ifHCOutOctets=ifHCOutOctets, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInUnknownProtos=ifInUnknownProtos, ifSpeed=ifSpeed, ifStackTable=ifStackTable, ifMIBObjects=ifMIBObjects, ifMtu=ifMtu, ifRcvAddressType=ifRcvAddressType, ifAlias=ifAlias, ifXTable=ifXTable, ifFixedLengthGroup=ifFixedLengthGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifCompliance=ifCompliance, ifInMulticastPkts=ifInMulticastPkts, ifStackLowerLayer=ifStackLowerLayer, ifVHCPacketGroup=ifVHCPacketGroup, ifType=ifType, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestOwner=ifTestOwner, ifEntry=ifEntry, ifGeneralGroup=ifGeneralGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, interfaces=interfaces, ifTestGroup=ifTestGroup, ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressGroup=ifRcvAddressGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLastChange=ifStackLastChange, ifTable=ifTable, ifXEntry=ifXEntry, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInOctets=ifHCInOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, ifTestEntry=ifTestEntry, ifStackEntry=ifStackEntry, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifStackHigherLayer=ifStackHigherLayer, ifNumber=ifNumber, PYSNMP_MODULE_ID=ifMIB, ifOutQLen=ifOutQLen, ifTableLastChange=ifTableLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifDescr=ifDescr, ifPromiscuousMode=ifPromiscuousMode, ifConnectorPresent=ifConnectorPresent, ifOutMulticastPkts=ifOutMulticastPkts, ifTestStatus=ifTestStatus, ifTestTable=ifTestTable, ifOutUcastPkts=ifOutUcastPkts, OwnerString=OwnerString, ifPhysAddress=ifPhysAddress, InterfaceIndex=InterfaceIndex, ifTestId=ifTestId, linkUp=linkUp, ifOldObjectsGroup=ifOldObjectsGroup, ifName=ifName, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifTestCode=ifTestCode, ifOperStatus=ifOperStatus, ifCompliance2=ifCompliance2, ifIndex=ifIndex, ifSpecific=ifSpecific, ifInUcastPkts=ifInUcastPkts, ifPacketGroup=ifPacketGroup, ifInOctets=ifInOctets, ifInNUcastPkts=ifInNUcastPkts, ifConformance=ifConformance, ifAdminStatus=ifAdminStatus, ifStackGroup=ifStackGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHighSpeed=ifHighSpeed, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackStatus=ifStackStatus, ifCompliances=ifCompliances, ifRcvAddressStatus=ifRcvAddressStatus, ifLastChange=ifLastChange)
