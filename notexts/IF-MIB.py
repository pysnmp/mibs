...
ObjectIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Integer32, ModuleIdentity, iso, Counter64, IpAddress, mib_2, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Integer32", "ModuleIdentity", "iso", "Counter64", "IpAddress", "mib-2", "Bits", "NotificationType", "Counter32")
TextualConvention, DisplayString, PhysAddress, TruthValue, TimeStamp, AutonomousType, TestAndIncr, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "PhysAddress", "TruthValue", "TimeStamp", "AutonomousType", "TestAndIncr", "RowStatus")
...
mibBuilder.exportSymbols("IF-MIB", ifTestCode=ifTestCode, ifIndex=ifIndex, ifInMulticastPkts=ifInMulticastPkts, ifTestResult=ifTestResult, ifName=ifName, ifHCInUcastPkts=ifHCInUcastPkts, ifHighSpeed=ifHighSpeed, ifEntry=ifEntry, ifRcvAddressType=ifRcvAddressType, PYSNMP_MODULE_ID=ifMIB, ifOutErrors=ifOutErrors, ifTestTable=ifTestTable, ifInDiscards=ifInDiscards, ifTestType=ifTestType, ifOutQLen=ifOutQLen, ifRcvAddressEntry=ifRcvAddressEntry, ifTestOwner=ifTestOwner, ifDescr=ifDescr, ifRcvAddressAddress=ifRcvAddressAddress, ifOutNUcastPkts=ifOutNUcastPkts, ifMtu=ifMtu, ifCompliance3=ifCompliance3, ifNumber=ifNumber, ifHCInBroadcastPkts=ifHCInBroadcastPkts, InterfaceIndex=InterfaceIndex, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackStatus=ifStackStatus, ifOperStatus=ifOperStatus, ifGeneralGroup=ifGeneralGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifTestEntry=ifTestEntry, interfaces=interfaces, ifMIB=ifMIB, ifLastChange=ifLastChange, ifInUnknownProtos=ifInUnknownProtos, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifStackGroup2=ifStackGroup2, ifOutBroadcastPkts=ifOutBroadcastPkts, ifSpecific=ifSpecific, InterfaceIndexOrZero=InterfaceIndexOrZero, ifConformance=ifConformance, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifXEntry=ifXEntry, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTableLastChange=ifTableLastChange, ifStackLastChange=ifStackLastChange, ifOutUcastPkts=ifOutUcastPkts, ifTestGroup=ifTestGroup, ifSpeed=ifSpeed, ifType=ifType, ifInErrors=ifInErrors, ifOutMulticastPkts=ifOutMulticastPkts, ifStackTable=ifStackTable, ifInNUcastPkts=ifInNUcastPkts, ifInUcastPkts=ifInUcastPkts, ifTable=ifTable, ifInBroadcastPkts=ifInBroadcastPkts, ifStackEntry=ifStackEntry, ifCompliance=ifCompliance, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGroups=ifGroups, ifTestStatus=ifTestStatus, ifHCOutOctets=ifHCOutOctets, ifOutOctets=ifOutOctets, ifStackHigherLayer=ifStackHigherLayer, ifPhysAddress=ifPhysAddress, ifPacketGroup=ifPacketGroup, ifMIBObjects=ifMIBObjects, ifStackGroup=ifStackGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressTable=ifRcvAddressTable, OwnerString=OwnerString, ifCompliance2=ifCompliance2, ifHCOutUcastPkts=ifHCOutUcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressStatus=ifRcvAddressStatus, ifHCPacketGroup=ifHCPacketGroup, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInOctets=ifHCInOctets, ifXTable=ifXTable, ifCompliances=ifCompliances, ifAdminStatus=ifAdminStatus, ifInOctets=ifInOctets, linkDown=linkDown, ifVHCPacketGroup=ifVHCPacketGroup, linkUp=linkUp, ifConnectorPresent=ifConnectorPresent, ifHCInMulticastPkts=ifHCInMulticastPkts, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifAlias=ifAlias)
