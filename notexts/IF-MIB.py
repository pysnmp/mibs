...
TestAndIncr, PhysAddress, AutonomousType, TimeStamp, DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "PhysAddress", "AutonomousType", "TimeStamp", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifType=ifType, ifStackGroup=ifStackGroup, ifGeneralGroup=ifGeneralGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifCompliance2=ifCompliance2, ifXEntry=ifXEntry, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestTable=ifTestTable, ifOutQLen=ifOutQLen, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTableLastChange=ifTableLastChange, ifConformance=ifConformance, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifAdminStatus=ifAdminStatus, ifTestResult=ifTestResult, ifHCOutOctets=ifHCOutOctets, ifOutNUcastPkts=ifOutNUcastPkts, ifInUcastPkts=ifInUcastPkts, ifHCInOctets=ifHCInOctets, ifRcvAddressGroup=ifRcvAddressGroup, ifTestId=ifTestId, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifVHCPacketGroup=ifVHCPacketGroup, ifCompliance3=ifCompliance3, ifRcvAddressEntry=ifRcvAddressEntry, ifHighSpeed=ifHighSpeed, ifTable=ifTable, ifInUnknownProtos=ifInUnknownProtos, ifTestEntry=ifTestEntry, ifMIBObjects=ifMIBObjects, ifInNUcastPkts=ifInNUcastPkts, ifDescr=ifDescr, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifStackHigherLayer=ifStackHigherLayer, ifCompliances=ifCompliances, ifPacketGroup=ifPacketGroup, ifOutErrors=ifOutErrors, interfaces=interfaces, linkDown=linkDown, ifInErrors=ifInErrors, ifFixedLengthGroup=ifFixedLengthGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifStackEntry=ifStackEntry, ifOperStatus=ifOperStatus, ifCompliance=ifCompliance, ifStackLastChange=ifStackLastChange, linkUp=linkUp, ifRcvAddressTable=ifRcvAddressTable, InterfaceIndexOrZero=InterfaceIndexOrZero, ifOutMulticastPkts=ifOutMulticastPkts, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifNumber=ifNumber, ifGeneralInformationGroup=ifGeneralInformationGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifName=ifName, ifPhysAddress=ifPhysAddress, ifTestGroup=ifTestGroup, OwnerString=OwnerString, ifMIB=ifMIB, ifLastChange=ifLastChange, ifStackLowerLayer=ifStackLowerLayer, ifHCInUcastPkts=ifHCInUcastPkts, ifStackGroup2=ifStackGroup2, ifSpeed=ifSpeed, ifOutOctets=ifOutOctets, ifTestStatus=ifTestStatus, ifEntry=ifEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifMtu=ifMtu, PYSNMP_MODULE_ID=ifMIB, ifTestType=ifTestType, ifSpecific=ifSpecific, ifStackStatus=ifStackStatus, InterfaceIndex=InterfaceIndex, ifGroups=ifGroups, ifXTable=ifXTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifPromiscuousMode=ifPromiscuousMode, ifTestOwner=ifTestOwner, ifTestCode=ifTestCode, ifHCPacketGroup=ifHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifInDiscards=ifInDiscards, ifOutUcastPkts=ifOutUcastPkts, ifStackTable=ifStackTable, ifConnectorPresent=ifConnectorPresent, ifRcvAddressType=ifRcvAddressType, ifAlias=ifAlias)
