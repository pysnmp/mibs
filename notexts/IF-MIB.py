...
TimeStamp, RowStatus, TextualConvention, TruthValue, TestAndIncr, PhysAddress, DisplayString, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "TestAndIncr", "PhysAddress", "DisplayString", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifCompliance3=ifCompliance3, ifAdminStatus=ifAdminStatus, ifTableLastChange=ifTableLastChange, ifOutOctets=ifOutOctets, ifOutQLen=ifOutQLen, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifFixedLengthGroup=ifFixedLengthGroup, ifGeneralInformationGroup=ifGeneralInformationGroup, ifConformance=ifConformance, ifConnectorPresent=ifConnectorPresent, ifStackGroup=ifStackGroup, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifHCInUcastPkts=ifHCInUcastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifTestEntry=ifTestEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestCode=ifTestCode, ifTestType=ifTestType, ifEntry=ifEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifDescr=ifDescr, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackLowerLayer=ifStackLowerLayer, InterfaceIndexOrZero=InterfaceIndexOrZero, ifVHCPacketGroup=ifVHCPacketGroup, ifTable=ifTable, ifRcvAddressEntry=ifRcvAddressEntry, ifStackHigherLayer=ifStackHigherLayer, ifTestResult=ifTestResult, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifGroups=ifGroups, ifCompliance2=ifCompliance2, ifInErrors=ifInErrors, ifInOctets=ifInOctets, ifInUnknownProtos=ifInUnknownProtos, ifHCPacketGroup=ifHCPacketGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifInDiscards=ifInDiscards, ifRcvAddressAddress=ifRcvAddressAddress, ifTestStatus=ifTestStatus, linkDown=linkDown, ifMIBObjects=ifMIBObjects, ifHCInOctets=ifHCInOctets, ifTestGroup=ifTestGroup, ifStackGroup2=ifStackGroup2, ifInNUcastPkts=ifInNUcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressStatus=ifRcvAddressStatus, ifRcvAddressGroup=ifRcvAddressGroup, ifName=ifName, ifOutDiscards=ifOutDiscards, ifHighSpeed=ifHighSpeed, ifLastChange=ifLastChange, ifOutNUcastPkts=ifOutNUcastPkts, ifInUcastPkts=ifInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifStackTable=ifStackTable, ifXEntry=ifXEntry, ifOutMulticastPkts=ifOutMulticastPkts, ifHCInMulticastPkts=ifHCInMulticastPkts, linkUp=linkUp, ifStackEntry=ifStackEntry, ifRcvAddressTable=ifRcvAddressTable, ifType=ifType, ifSpeed=ifSpeed, ifCompliances=ifCompliances, ifTestTable=ifTestTable, ifGeneralGroup=ifGeneralGroup, ifStackStatus=ifStackStatus, ifNumber=ifNumber, ifPhysAddress=ifPhysAddress, InterfaceIndex=InterfaceIndex, ifSpecific=ifSpecific, OwnerString=OwnerString, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifXTable=ifXTable, ifOldObjectsGroup=ifOldObjectsGroup, ifPacketGroup=ifPacketGroup, ifTestId=ifTestId, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, ifAlias=ifAlias, ifRcvAddressType=ifRcvAddressType, ifOutErrors=ifOutErrors, ifPromiscuousMode=ifPromiscuousMode, ifHCOutOctets=ifHCOutOctets, ifMtu=ifMtu, PYSNMP_MODULE_ID=ifMIB, interfaces=interfaces, ifCompliance=ifCompliance, ifTestOwner=ifTestOwner, ifOperStatus=ifOperStatus)
