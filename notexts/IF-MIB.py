...
TestAndIncr, TimeStamp, DisplayString, RowStatus, TextualConvention, TruthValue, PhysAddress, AutonomousType = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TimeStamp", "DisplayString", "RowStatus", "TextualConvention", "TruthValue", "PhysAddress", "AutonomousType")
...
mibBuilder.exportSymbols("IF-MIB", ifTestType=ifTestType, ifStackLowerLayer=ifStackLowerLayer, ifGeneralGroup=ifGeneralGroup, ifInDiscards=ifInDiscards, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOperStatus=ifOperStatus, ifOutBroadcastPkts=ifOutBroadcastPkts, ifPacketGroup=ifPacketGroup, ifTestOwner=ifTestOwner, ifInUcastPkts=ifInUcastPkts, ifOutOctets=ifOutOctets, interfaces=interfaces, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifInUnknownProtos=ifInUnknownProtos, ifSpecific=ifSpecific, ifXEntry=ifXEntry, ifTestId=ifTestId, ifStackLastChange=ifStackLastChange, ifHCPacketGroup=ifHCPacketGroup, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackGroup2=ifStackGroup2, ifRcvAddressType=ifRcvAddressType, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifDescr=ifDescr, ifMIBObjects=ifMIBObjects, ifStackHigherLayer=ifStackHigherLayer, ifInMulticastPkts=ifInMulticastPkts, ifNumber=ifNumber, ifTestEntry=ifTestEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestGroup=ifTestGroup, ifHighSpeed=ifHighSpeed, ifRcvAddressEntry=ifRcvAddressEntry, ifOutErrors=ifOutErrors, ifCompliance3=ifCompliance3, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifOutNUcastPkts=ifOutNUcastPkts, linkUp=linkUp, ifTestResult=ifTestResult, ifStackEntry=ifStackEntry, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifAdminStatus=ifAdminStatus, ifTestStatus=ifTestStatus, ifSpeed=ifSpeed, ifOutDiscards=ifOutDiscards, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifStackTable=ifStackTable, ifConnectorPresent=ifConnectorPresent, ifHCOutOctets=ifHCOutOctets, ifHCOutUcastPkts=ifHCOutUcastPkts, ifRcvAddressGroup=ifRcvAddressGroup, ifLastChange=ifLastChange, ifHCInUcastPkts=ifHCInUcastPkts, ifOutUcastPkts=ifOutUcastPkts, ifPhysAddress=ifPhysAddress, OwnerString=OwnerString, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifMIB=ifMIB, ifTestCode=ifTestCode, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifStackStatus=ifStackStatus, ifTestTable=ifTestTable, ifOutQLen=ifOutQLen, ifName=ifName, ifEntry=ifEntry, ifHCInOctets=ifHCInOctets, ifCompliances=ifCompliances, ifOutMulticastPkts=ifOutMulticastPkts, ifAlias=ifAlias, ifRcvAddressTable=ifRcvAddressTable, ifFixedLengthGroup=ifFixedLengthGroup, PYSNMP_MODULE_ID=ifMIB, ifMtu=ifMtu, ifInErrors=ifInErrors, ifGroups=ifGroups, ifInBroadcastPkts=ifInBroadcastPkts, ifType=ifType, ifPromiscuousMode=ifPromiscuousMode, linkDown=linkDown, ifCompliance=ifCompliance, ifTableLastChange=ifTableLastChange, ifHCInMulticastPkts=ifHCInMulticastPkts, ifConformance=ifConformance, ifTable=ifTable, ifOldObjectsGroup=ifOldObjectsGroup, InterfaceIndex=InterfaceIndex, ifInOctets=ifInOctets, ifIndex=ifIndex, ifRcvAddressStatus=ifRcvAddressStatus, ifStackGroup=ifStackGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifXTable=ifXTable, ifCompliance2=ifCompliance2)
