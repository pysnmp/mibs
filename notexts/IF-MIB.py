...
RowStatus, AutonomousType, PhysAddress, DisplayString, TruthValue, TimeStamp, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "AutonomousType", "PhysAddress", "DisplayString", "TruthValue", "TimeStamp", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifTable=ifTable, InterfaceIndex=InterfaceIndex, ifRcvAddressType=ifRcvAddressType, ifRcvAddressEntry=ifRcvAddressEntry, ifInUcastPkts=ifInUcastPkts, ifTestType=ifTestType, ifOutBroadcastPkts=ifOutBroadcastPkts, linkDown=linkDown, linkUp=linkUp, ifOutUcastPkts=ifOutUcastPkts, ifVHCPacketGroup=ifVHCPacketGroup, ifPacketGroup=ifPacketGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestStatus=ifTestStatus, ifInNUcastPkts=ifInNUcastPkts, ifSpeed=ifSpeed, ifGeneralGroup=ifGeneralGroup, ifIndex=ifIndex, ifConformance=ifConformance, ifHCPacketGroup=ifHCPacketGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifCompliance=ifCompliance, ifHCInOctets=ifHCInOctets, ifTestEntry=ifTestEntry, ifHCInMulticastPkts=ifHCInMulticastPkts, ifCompliance3=ifCompliance3, ifInErrors=ifInErrors, ifXEntry=ifXEntry, ifOutOctets=ifOutOctets, ifOutErrors=ifOutErrors, ifInDiscards=ifInDiscards, ifStackTable=ifStackTable, ifTableLastChange=ifTableLastChange, ifInOctets=ifInOctets, ifConnectorPresent=ifConnectorPresent, ifStackGroup2=ifStackGroup2, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifHCOutOctets=ifHCOutOctets, ifHCInUcastPkts=ifHCInUcastPkts, ifStackHigherLayer=ifStackHigherLayer, ifSpecific=ifSpecific, ifType=ifType, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestOwner=ifTestOwner, ifAlias=ifAlias, ifAdminStatus=ifAdminStatus, ifGroups=ifGroups, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifXTable=ifXTable, ifName=ifName, ifOutMulticastPkts=ifOutMulticastPkts, ifOutDiscards=ifOutDiscards, ifTestTable=ifTestTable, ifMIB=ifMIB, ifOutNUcastPkts=ifOutNUcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifStackLastChange=ifStackLastChange, ifRcvAddressTable=ifRcvAddressTable, ifStackStatus=ifStackStatus, ifOutQLen=ifOutQLen, ifNumber=ifNumber, ifFixedLengthGroup=ifFixedLengthGroup, ifTestCode=ifTestCode, ifDescr=ifDescr, ifOperStatus=ifOperStatus, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHighSpeed=ifHighSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifMtu=ifMtu, ifStackLowerLayer=ifStackLowerLayer, ifInBroadcastPkts=ifInBroadcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifPromiscuousMode=ifPromiscuousMode, ifTestGroup=ifTestGroup, ifCompliance2=ifCompliance2, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackEntry=ifStackEntry, ifPhysAddress=ifPhysAddress, ifCompliances=ifCompliances, ifRcvAddressStatus=ifRcvAddressStatus, ifLastChange=ifLastChange, interfaces=interfaces, PYSNMP_MODULE_ID=ifMIB, ifTestResult=ifTestResult, ifMIBObjects=ifMIBObjects, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifEntry=ifEntry, ifOldObjectsGroup=ifOldObjectsGroup, OwnerString=OwnerString, ifStackGroup=ifStackGroup, ifTestId=ifTestId)
