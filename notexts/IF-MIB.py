...
TimeStamp, PhysAddress, TextualConvention, TruthValue, AutonomousType, RowStatus, TestAndIncr, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "PhysAddress", "TextualConvention", "TruthValue", "AutonomousType", "RowStatus", "TestAndIncr", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressGroup=ifRcvAddressGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifType=ifType, ifStackHigherLayer=ifStackHigherLayer, ifMIBObjects=ifMIBObjects, ifTestResult=ifTestResult, ifOutQLen=ifOutQLen, ifMtu=ifMtu, ifStackGroup2=ifStackGroup2, OwnerString=OwnerString, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackEntry=ifStackEntry, ifStackGroup=ifStackGroup, ifHighSpeed=ifHighSpeed, ifOperStatus=ifOperStatus, ifTestOwner=ifTestOwner, ifOutUcastPkts=ifOutUcastPkts, ifPacketGroup=ifPacketGroup, PYSNMP_MODULE_ID=ifMIB, ifCompliance=ifCompliance, ifMIB=ifMIB, ifInDiscards=ifInDiscards, ifConnectorPresent=ifConnectorPresent, ifTestGroup=ifTestGroup, ifCompliance2=ifCompliance2, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifGeneralGroup=ifGeneralGroup, linkUp=linkUp, ifCompliance3=ifCompliance3, ifHCOutUcastPkts=ifHCOutUcastPkts, ifTestStatus=ifTestStatus, ifInMulticastPkts=ifInMulticastPkts, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifStackLastChange=ifStackLastChange, ifHCPacketGroup=ifHCPacketGroup, ifCompliances=ifCompliances, ifRcvAddressType=ifRcvAddressType, ifPhysAddress=ifPhysAddress, ifOutMulticastPkts=ifOutMulticastPkts, ifTable=ifTable, ifTestEntry=ifTestEntry, ifOutNUcastPkts=ifOutNUcastPkts, ifLastChange=ifLastChange, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifXTable=ifXTable, ifTestCode=ifTestCode, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifOutErrors=ifOutErrors, ifFixedLengthGroup=ifFixedLengthGroup, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTestTable=ifTestTable, InterfaceIndex=InterfaceIndex, ifHCInUcastPkts=ifHCInUcastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifInBroadcastPkts=ifInBroadcastPkts, ifGroups=ifGroups, ifTestId=ifTestId, ifStackTable=ifStackTable, ifPromiscuousMode=ifPromiscuousMode, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifVHCPacketGroup=ifVHCPacketGroup, ifOutOctets=ifOutOctets, ifEntry=ifEntry, ifHCOutOctets=ifHCOutOctets, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifAlias=ifAlias, ifRcvAddressStatus=ifRcvAddressStatus, ifNumber=ifNumber, ifRcvAddressEntry=ifRcvAddressEntry, ifHCInOctets=ifHCInOctets, ifSpecific=ifSpecific, ifXEntry=ifXEntry, ifInOctets=ifInOctets, ifInUnknownProtos=ifInUnknownProtos, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifRcvAddressAddress=ifRcvAddressAddress, ifTableLastChange=ifTableLastChange, ifGeneralInformationGroup=ifGeneralInformationGroup, ifTestType=ifTestType, interfaces=interfaces, ifConformance=ifConformance, ifSpeed=ifSpeed, ifInNUcastPkts=ifInNUcastPkts, ifStackStatus=ifStackStatus, linkDown=linkDown, ifDescr=ifDescr, ifInErrors=ifInErrors, ifName=ifName, ifOutDiscards=ifOutDiscards, ifInUcastPkts=ifInUcastPkts, ifAdminStatus=ifAdminStatus, ifRcvAddressTable=ifRcvAddressTable)
