...
DisplayString, TimeStamp, AutonomousType, PhysAddress, RowStatus, TruthValue, TestAndIncr, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "AutonomousType", "PhysAddress", "RowStatus", "TruthValue", "TestAndIncr", "TextualConvention")
...
mibBuilder.exportSymbols("IF-MIB", ifTestType=ifTestType, ifStackTable=ifStackTable, ifOutQLen=ifOutQLen, ifGroups=ifGroups, ifVHCPacketGroup=ifVHCPacketGroup, ifTestOwner=ifTestOwner, ifInDiscards=ifInDiscards, ifRcvAddressEntry=ifRcvAddressEntry, ifHCPacketGroup=ifHCPacketGroup, ifName=ifName, ifMtu=ifMtu, interfaces=interfaces, ifInMulticastPkts=ifInMulticastPkts, ifConformance=ifConformance, ifInBroadcastPkts=ifInBroadcastPkts, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifCompliance=ifCompliance, ifHighSpeed=ifHighSpeed, ifAdminStatus=ifAdminStatus, ifAlias=ifAlias, ifConnectorPresent=ifConnectorPresent, ifGeneralGroup=ifGeneralGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifOutMulticastPkts=ifOutMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOldObjectsGroup=ifOldObjectsGroup, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ifInNUcastPkts=ifInNUcastPkts, ifStackLowerLayer=ifStackLowerLayer, ifOutBroadcastPkts=ifOutBroadcastPkts, PYSNMP_MODULE_ID=ifMIB, ifHCInUcastPkts=ifHCInUcastPkts, ifStackEntry=ifStackEntry, ifSpeed=ifSpeed, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifTable=ifTable, ifRcvAddressAddress=ifRcvAddressAddress, ifOutOctets=ifOutOctets, ifSpecific=ifSpecific, ifMIBObjects=ifMIBObjects, ifTestTable=ifTestTable, ifCompliance2=ifCompliance2, ifNumber=ifNumber, ifInUcastPkts=ifInUcastPkts, linkDown=linkDown, InterfaceIndexOrZero=InterfaceIndexOrZero, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifInUnknownProtos=ifInUnknownProtos, ifPromiscuousMode=ifPromiscuousMode, ifRcvAddressGroup=ifRcvAddressGroup, ifTableLastChange=ifTableLastChange, ifLastChange=ifLastChange, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifIndex=ifIndex, ifStackStatus=ifStackStatus, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliance3=ifCompliance3, ifOutUcastPkts=ifOutUcastPkts, ifEntry=ifEntry, ifGeneralInformationGroup=ifGeneralInformationGroup, ifOperStatus=ifOperStatus, ifStackGroup=ifStackGroup, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifCompliances=ifCompliances, ifRcvAddressType=ifRcvAddressType, ifOutErrors=ifOutErrors, ifPacketGroup=ifPacketGroup, InterfaceIndex=InterfaceIndex, ifStackHigherLayer=ifStackHigherLayer, ifTestResult=ifTestResult, ifDescr=ifDescr, ifTestGroup=ifTestGroup, ifFixedLengthGroup=ifFixedLengthGroup, ifTestEntry=ifTestEntry, ifHCInOctets=ifHCInOctets, ifTestCode=ifTestCode, ifXTable=ifXTable, ifMIB=ifMIB, ifStackLastChange=ifStackLastChange, linkUp=linkUp, ifRcvAddressStatus=ifRcvAddressStatus, ifInErrors=ifInErrors, ifOutNUcastPkts=ifOutNUcastPkts, ifXEntry=ifXEntry, ifHCOutOctets=ifHCOutOctets, ifTestStatus=ifTestStatus, ifType=ifType, ifStackGroup2=ifStackGroup2, ifPhysAddress=ifPhysAddress, ifRcvAddressTable=ifRcvAddressTable, ifTestId=ifTestId)
