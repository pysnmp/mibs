...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, mib_2, Counter32, Counter64, iso, Bits, IpAddress, MibIdentifier, ObjectIdentity, Gauge32, NotificationType, Unsigned32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "mib-2", "Counter32", "Counter64", "iso", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "Gauge32", "NotificationType", "Unsigned32", "ModuleIdentity", "Integer32")
TruthValue, TestAndIncr, DisplayString, TimeStamp, RowStatus, TextualConvention, AutonomousType, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TestAndIncr", "DisplayString", "TimeStamp", "RowStatus", "TextualConvention", "AutonomousType", "PhysAddress")
...
mibBuilder.exportSymbols("IF-MIB", ifRcvAddressTable=ifRcvAddressTable, ifRcvAddressStatus=ifRcvAddressStatus, linkDown=linkDown, ifInErrors=ifInErrors, ifGeneralGroup=ifGeneralGroup, ifHCInUcastPkts=ifHCInUcastPkts, ifType=ifType, ifCompliance=ifCompliance, ifRcvAddressAddress=ifRcvAddressAddress, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifHCInOctets=ifHCInOctets, ifOperStatus=ifOperStatus, ifInOctets=ifInOctets, ifCompliance3=ifCompliance3, ifOutMulticastPkts=ifOutMulticastPkts, ifAlias=ifAlias, ifInUnknownProtos=ifInUnknownProtos, ifCompliances=ifCompliances, ifXTable=ifXTable, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifStackGroup2=ifStackGroup2, ifStackEntry=ifStackEntry, ifCompliance2=ifCompliance2, linkUp=linkUp, ifRcvAddressType=ifRcvAddressType, OwnerString=OwnerString, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifOutDiscards=ifOutDiscards, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifHCInMulticastPkts=ifHCInMulticastPkts, ifGeneralInformationGroup=ifGeneralInformationGroup, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifMIB=ifMIB, ifVHCPacketGroup=ifVHCPacketGroup, ifStackGroup=ifStackGroup, ifRcvAddressGroup=ifRcvAddressGroup, ifOldObjectsGroup=ifOldObjectsGroup, ifTestResult=ifTestResult, ifTestGroup=ifTestGroup, ifTable=ifTable, ifTestOwner=ifTestOwner, ifStackLastChange=ifStackLastChange, ifHCOutUcastPkts=ifHCOutUcastPkts, ifInMulticastPkts=ifInMulticastPkts, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestType=ifTestType, ifTableLastChange=ifTableLastChange, ifTestTable=ifTestTable, ifRcvAddressEntry=ifRcvAddressEntry, InterfaceIndexOrZero=InterfaceIndexOrZero, ifLastChange=ifLastChange, ifConformance=ifConformance, ifIndex=ifIndex, ifStackLowerLayer=ifStackLowerLayer, ifMIBObjects=ifMIBObjects, ifNumber=ifNumber, ifTestId=ifTestId, ifPromiscuousMode=ifPromiscuousMode, PYSNMP_MODULE_ID=ifMIB, ifSpecific=ifSpecific, ifTestStatus=ifTestStatus, ifMtu=ifMtu, ifHCOutOctets=ifHCOutOctets, ifConnectorPresent=ifConnectorPresent, ifName=ifName, ifPacketGroup=ifPacketGroup, ifOutBroadcastPkts=ifOutBroadcastPkts, ifHighSpeed=ifHighSpeed, ifTestEntry=ifTestEntry, InterfaceIndex=InterfaceIndex, ifStackStatus=ifStackStatus, ifStackHigherLayer=ifStackHigherLayer, ifOutUcastPkts=ifOutUcastPkts, ifStackTable=ifStackTable, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifXEntry=ifXEntry, ifGroups=ifGroups, ifInDiscards=ifInDiscards, ifSpeed=ifSpeed, ifInUcastPkts=ifInUcastPkts, ifPhysAddress=ifPhysAddress, ifAdminStatus=ifAdminStatus, ifOutQLen=ifOutQLen, ifOutNUcastPkts=ifOutNUcastPkts, interfaces=interfaces, ifTestCode=ifTestCode, ifFixedLengthGroup=ifFixedLengthGroup, ifInNUcastPkts=ifInNUcastPkts, ifOutOctets=ifOutOctets, ifEntry=ifEntry, ifInBroadcastPkts=ifInBroadcastPkts, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifDescr=ifDescr)
