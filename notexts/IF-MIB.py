...
TestAndIncr, TextualConvention, AutonomousType, RowStatus, PhysAddress, TruthValue, TimeStamp, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TestAndIncr", "TextualConvention", "AutonomousType", "RowStatus", "PhysAddress", "TruthValue", "TimeStamp", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifStackEntry=ifStackEntry, ifHighSpeed=ifHighSpeed, ifMIB=ifMIB, ifOutUcastPkts=ifOutUcastPkts, ifCompliance=ifCompliance, ifPhysAddress=ifPhysAddress, ifHCInMulticastPkts=ifHCInMulticastPkts, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifInBroadcastPkts=ifInBroadcastPkts, ifCompliance3=ifCompliance3, ifTestOwner=ifTestOwner, OwnerString=OwnerString, ifRcvAddressStatus=ifRcvAddressStatus, ifXTable=ifXTable, interfaces=interfaces, ifXEntry=ifXEntry, ifAlias=ifAlias, linkDown=linkDown, PYSNMP_MODULE_ID=ifMIB, ifTableLastChange=ifTableLastChange, ifCompliance2=ifCompliance2, ifInUcastPkts=ifInUcastPkts, ifOldObjectsGroup=ifOldObjectsGroup, ifHCOutUcastPkts=ifHCOutUcastPkts, ifAdminStatus=ifAdminStatus, ifGeneralInformationGroup=ifGeneralInformationGroup, ifStackStatus=ifStackStatus, ifInErrors=ifInErrors, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifInOctets=ifInOctets, ifConnectorPresent=ifConnectorPresent, ifFixedLengthGroup=ifFixedLengthGroup, ifTestGroup=ifTestGroup, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifOperStatus=ifOperStatus, ifSpeed=ifSpeed, ifLastChange=ifLastChange, ifType=ifType, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPacketGroup=ifPacketGroup, ifTestId=ifTestId, linkUp=linkUp, ifGroups=ifGroups, ifHCOutOctets=ifHCOutOctets, ifTestTable=ifTestTable, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifRcvAddressTable=ifRcvAddressTable, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressEntry=ifRcvAddressEntry, ifOutBroadcastPkts=ifOutBroadcastPkts, ifGeneralGroup=ifGeneralGroup, ifName=ifName, ifIndex=ifIndex, ifTestStatus=ifTestStatus, ifConformance=ifConformance, ifOutMulticastPkts=ifOutMulticastPkts, InterfaceIndex=InterfaceIndex, ifTestType=ifTestType, ifNumber=ifNumber, ifMIBObjects=ifMIBObjects, ifTestResult=ifTestResult, ifTestCode=ifTestCode, ifCompliances=ifCompliances, ifTestEntry=ifTestEntry, ifStackHigherLayer=ifStackHigherLayer, ifInMulticastPkts=ifInMulticastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifMtu=ifMtu, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifHCFixedLengthGroup=ifHCFixedLengthGroup, ifOutErrors=ifOutErrors, ifDescr=ifDescr, ifPromiscuousMode=ifPromiscuousMode, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackGroup=ifStackGroup, ifStackLastChange=ifStackLastChange, ifOutOctets=ifOutOctets, ifHCInOctets=ifHCInOctets, ifSpecific=ifSpecific, ifEntry=ifEntry, ifOutQLen=ifOutQLen, ifStackTable=ifStackTable, ifStackLowerLayer=ifStackLowerLayer, ifTable=ifTable, ifHCPacketGroup=ifHCPacketGroup, ifInNUcastPkts=ifInNUcastPkts, ifRcvAddressType=ifRcvAddressType, ifInDiscards=ifInDiscards, ifInUnknownProtos=ifInUnknownProtos, ifRcvAddressGroup=ifRcvAddressGroup, ifOutDiscards=ifOutDiscards, ifStackGroup2=ifStackGroup2, ifHCInUcastPkts=ifHCInUcastPkts)
