...
PhysAddress, AutonomousType, TimeStamp, RowStatus, TestAndIncr, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "AutonomousType", "TimeStamp", "RowStatus", "TestAndIncr", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("IF-MIB", ifHighSpeed=ifHighSpeed, linkDown=linkDown, ifInUnknownProtos=ifInUnknownProtos, ifLinkUpDownTrapEnable=ifLinkUpDownTrapEnable, ifTestStatus=ifTestStatus, ifOldObjectsGroup=ifOldObjectsGroup, ifHCInMulticastPkts=ifHCInMulticastPkts, ifMIB=ifMIB, ifRcvAddressGroup=ifRcvAddressGroup, ifTestEntry=ifTestEntry, ifEntry=ifEntry, ifInErrors=ifInErrors, linkUp=linkUp, ifMIBObjects=ifMIBObjects, ifFixedLengthGroup=ifFixedLengthGroup, ifTestType=ifTestType, ifTestOwner=ifTestOwner, ifAlias=ifAlias, ifStackTable=ifStackTable, ifAdminStatus=ifAdminStatus, ifInNUcastPkts=ifInNUcastPkts, ifXEntry=ifXEntry, ifCounterDiscontinuityTime=ifCounterDiscontinuityTime, ifSpecific=ifSpecific, ifVHCPacketGroup=ifVHCPacketGroup, ifRcvAddressStatus=ifRcvAddressStatus, ifHCFixedLengthGroup=ifHCFixedLengthGroup, OwnerString=OwnerString, ifRcvAddressTable=ifRcvAddressTable, ifMtu=ifMtu, ifInDiscards=ifInDiscards, ifOutErrors=ifOutErrors, ifIndex=ifIndex, ifOutQLen=ifOutQLen, ifOutUcastPkts=ifOutUcastPkts, ifCompliance3=ifCompliance3, ifHCOutMulticastPkts=ifHCOutMulticastPkts, ifConformance=ifConformance, ifConnectorPresent=ifConnectorPresent, ifCompliance2=ifCompliance2, ifHCOutBroadcastPkts=ifHCOutBroadcastPkts, ifPhysAddress=ifPhysAddress, ifRcvAddressType=ifRcvAddressType, ifInOctets=ifInOctets, ifHCInOctets=ifHCInOctets, ifStackHigherLayer=ifStackHigherLayer, ifCounterDiscontinuityGroup=ifCounterDiscontinuityGroup, ifStackEntry=ifStackEntry, ifInMulticastPkts=ifInMulticastPkts, ifRcvAddressAddress=ifRcvAddressAddress, ifHCInBroadcastPkts=ifHCInBroadcastPkts, ifHCOutUcastPkts=ifHCOutUcastPkts, ifCompliances=ifCompliances, ifGeneralInformationGroup=ifGeneralInformationGroup, ifCompliance=ifCompliance, ifOutOctets=ifOutOctets, ifRcvAddressEntry=ifRcvAddressEntry, ifNumber=ifNumber, ifStackGroup2=ifStackGroup2, InterfaceIndex=InterfaceIndex, ifLastChange=ifLastChange, ifPromiscuousMode=ifPromiscuousMode, PYSNMP_MODULE_ID=ifMIB, ifGroups=ifGroups, ifHCInUcastPkts=ifHCInUcastPkts, ifInUcastPkts=ifInUcastPkts, ifStackLastChange=ifStackLastChange, ifOutDiscards=ifOutDiscards, ifOutMulticastPkts=ifOutMulticastPkts, ifInBroadcastPkts=ifInBroadcastPkts, ifOutNUcastPkts=ifOutNUcastPkts, ifHCPacketGroup=ifHCPacketGroup, ifTestTable=ifTestTable, interfaces=interfaces, ifName=ifName, ifPacketGroup=ifPacketGroup, ifOperStatus=ifOperStatus, linkUpDownNotificationsGroup=linkUpDownNotificationsGroup, ifTestResult=ifTestResult, ifType=ifType, ifDescr=ifDescr, ifTestCode=ifTestCode, ifTestGroup=ifTestGroup, ifXTable=ifXTable, ifGeneralGroup=ifGeneralGroup, ifHCOutOctets=ifHCOutOctets, ifSpeed=ifSpeed, InterfaceIndexOrZero=InterfaceIndexOrZero, ifStackStatus=ifStackStatus, ifStackLowerLayer=ifStackLowerLayer, ifTableLastChange=ifTableLastChange, ifStackGroup=ifStackGroup, ifTable=ifTable, ifOutBroadcastPkts=ifOutBroadcastPkts, ifTestId=ifTestId)
