...
# ASN.1 source ENTITY-STATE-MIB
# Source digest sha256:62bc121879d3b2af2322cf5a89472e192c330a257f21618c1e7c5c9e9fb19bc1
...
if mibBuilder.loadTexts: entityStateMIB.setLastUpdated('2005-11-22 00:00')
...
entStateTable = MibTable((1, 3, 6, 1, 2, 1, 131, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: entStateTable.setStatus('current')
entStateEntry = MibTableRow((1, 3, 6, 1, 2, 1, 131, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ENTITY-MIB", "entPhysicalIndex"))
...
mibBuilder.exportSymbols("ENTITY-STATE-MIB", PYSNMP_MODULE_ID=entityStateMIB, entStateAdmin=entStateAdmin, entStateAlarm=entStateAlarm, entStateCompliance=entStateCompliance, entStateCompliances=entStateCompliances, entStateConformance=entStateConformance, entStateEntry=entStateEntry, entStateGroup=entStateGroup, entStateGroups=entStateGroups, entStateLastChanged=entStateLastChanged, entStateNotifications=entStateNotifications, entStateNotificationsGroup=entStateNotificationsGroup, entStateObjects=entStateObjects, entStateOper=entStateOper, entStateOperDisabled=entStateOperDisabled, entStateOperEnabled=entStateOperEnabled, entStateStandby=entStateStandby, entStateTable=entStateTable, entStateUsage=entStateUsage, entityStateMIB=entityStateMIB)
