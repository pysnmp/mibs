...
# ASN.1 source APAGENTCAP-MIB
# Source digest sha256:cabeb736a8cd638746d11b926d76590f45dde1e2b4ea3d6509b7d8fa2f03aa3d
...
apAgentCapModule.setRevisions(('2001-08-01 00:00', '2004-11-18 00:00', '2006-05-01 00:00', '2007-05-07 00:00', '1920-12-15 00:00', '2012-03-07 00:00', '2012-07-16 00:00', '2014-02-26 00:00', '2014-06-20 00:00', '2014-06-26 00:00', '2017-02-09 00:00', '2017-10-18 00:00', '2017-11-24 00:00', '2017-12-14 00:00', '2018-04-10 00:00', '2018-04-27 00:00', '2019-04-24 00:00', '2020-07-20 00:00', '2020-12-10 00:00', '2021-07-21 00:00', '2021-08-13 00:00', '2021-08-26 00:00', '2022-02-09 00:00', '2022-05-06 00:00', '2022-05-06 00:00', '2022-07-21 00:00',))
if mibBuilder.loadTexts: apAgentCapModule.setLastUpdated('2022-07-21 00:00')
...
apResrvdNsepUtlMibCapabilities = MibIdentifier((1, 3, 6, 1, 4, 1, 9148, 2, 1, 33))
...
apSmgmtReservedNSEPCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 8, 60))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSmgmtReservedNSEPCap = apSmgmtReservedNSEPCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSmgmtReservedNSEPCap = apSmgmtReservedNSEPCap.setStatus('current')
apSmgmtLDAPServerCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 8, 61))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSmgmtLDAPServerCap = apSmgmtLDAPServerCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSmgmtLDAPServerCap = apSmgmtLDAPServerCap.setStatus('current')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSecurityIkeIfcBlAuthIDErrorCap = apSecurityIkeIfcBlAuthIDErrorCap.setStatus('obsolete')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSecurityTscfCap = apSecurityTscfCap.setStatus('obsolete')
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSecurityTscfTimeoutCap = apSecurityTscfTimeoutCap.setStatus('obsolete')
...
apDiamAcctBufferUsageNotifyCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 17, 7))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDiamAcctBufferUsageNotifyCap = apDiamAcctBufferUsageNotifyCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDiamAcctBufferUsageNotifyCap = apDiamAcctBufferUsageNotifyCap.setStatus('current')
...
apDosThresholdCountersCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 20, 7))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDosThresholdCountersCap = apDosThresholdCountersCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDosThresholdCountersCap = apDosThresholdCountersCap.setStatus('current')
apDosThresholdTrapCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 20, 8))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDosThresholdTrapCap = apDosThresholdTrapCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apDosThresholdTrapCap = apDosThresholdTrapCap.setStatus('current')
...
apSip503RespThresholdNotificationsGroupCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 21, 16))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSip503RespThresholdNotificationsGroupCap = apSip503RespThresholdNotificationsGroupCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSip503RespThresholdNotificationsGroupCap = apSip503RespThresholdNotificationsGroupCap.setStatus('current')
apSipSteeringPoolUtilNotificationsGroupCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 21, 17))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSipSteeringPoolUtilNotificationsGroupCap = apSipSteeringPoolUtilNotificationsGroupCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apSipSteeringPoolUtilNotificationsGroupCap = apSipSteeringPoolUtilNotificationsGroupCap.setStatus('current')
...
apResrvdNsepUtlTrapCap = AgentCapabilities((1, 3, 6, 1, 4, 1, 9148, 2, 1, 33, 1))
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apResrvdNsepUtlTrapCap = apResrvdNsepUtlTrapCap.setProductRelease('Oracle Communications Acme Packet SBC')
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    apResrvdNsepUtlTrapCap = apResrvdNsepUtlTrapCap.setStatus('current')
mibBuilder.exportSymbols("APAGENTCAP-MIB", PYSNMP_MODULE_ID=apAgentCapModule, apAclDropCap=apAclDropCap, apAclDropMibCapabilities=apAclDropMibCapabilities, apAgentCapModule=apAgentCapModule, apAmiCap=apAmiCap, apAmiMibCapabilities=apAmiMibCapabilities, apAppsDNSStatusGroupCap=apAppsDNSStatusGroupCap, apAppsDNSSvrNotifGroupCap=apAppsDNSSvrNotifGroupCap, apAppsENUMRateGroupCap=apAppsENUMRateGroupCap, apAppsENUMStatusGroupCap=apAppsENUMStatusGroupCap, apAppsENUMSvrNotifGroupCap=apAppsENUMSvrNotifGroupCap, apAppsMibCapabilities=apAppsMibCapabilities, apCodecMediaProcessingCap=apCodecMediaProcessingCap, apCodecMibCapabilities=apCodecMibCapabilities, apCodecRealmCodecCap10=apCodecRealmCodecCap10, apCodecRealmCodecCap2=apCodecRealmCodecCap2, apCodecRealmCodecCap3=apCodecRealmCodecCap3, apCodecRealmCodecCap4=apCodecRealmCodecCap4, apCodecRealmCodecCap5=apCodecRealmCodecCap5, apCodecRealmCodecCap6=apCodecRealmCodecCap6, apCodecRealmCodecCap7=apCodecRealmCodecCap7, apCodecRealmCodecCap8=apCodecRealmCodecCap8, apCodecRealmCodecCap9=apCodecRealmCodecCap9, apCodecRealmCodecCap=apCodecRealmCodecCap, apCodecTranscodingStatsCap=apCodecTranscodingStatsCap, apCommMonitorNotificationGroupCap=apCommMonitorNotificationGroupCap, apCoreLBMemberStatusNotifCap=apCoreLBMemberStatusNotifCap, apCoreLbMibCapabilities=apCoreLbMibCapabilities, apCsvConfigMibCapabilities=apCsvConfigMibCapabilities, apCsvConfigSaveCap=apCsvConfigSaveCap, apDDMibCapabilities=apDDMibCapabilities, apDDNotifGroupCap=apDDNotifGroupCap, apDDSCTPNotifGroupCap=apDDSCTPNotifGroupCap, apDDStatsGroup2Cap=apDDStatsGroup2Cap, apDDStatsGroup3Cap=apDDStatsGroup3Cap, apDDStatsGroup4Cap=apDDStatsGroup4Cap, apDDStatsGroupCap=apDDStatsGroupCap, apDNSALGMibCapabilities=apDNSALGMibCapabilities, apDNSALGNotifGroupCap=apDNSALGNotifGroupCap, apDNSALGRateGroupCap=apDNSALGRateGroupCap, apDNSALGStatsGroupCap=apDNSALGStatsGroupCap, apDiamAcctBufferUsageNotifyCap=apDiamAcctBufferUsageNotifyCap, apDiamAuthCap=apDiamAuthCap, apDiamAuthNotifyCap=apDiamAuthNotifyCap, apDiamClfCap=apDiamClfCap, apDiamIntfCap=apDiamIntfCap, apDiamMibCap=apDiamMibCap, apDiamMibCapabilities=apDiamMibCapabilities, apDiamNotifCap=apDiamNotifCap, apDosThresholdCountersCap=apDosThresholdCountersCap, apDosThresholdTrapCap=apDosThresholdTrapCap, apEntityCap=apEntityCap, apEntityCapabilities=apEntityCapabilities, apEnvMonCap2=apEnvMonCap2, apEnvMonCap4=apEnvMonCap4, apEnvMonCap=apEnvMonCap, apEnvMonCardCap=apEnvMonCardCap, apEnvMonPortChangeCap=apEnvMonPortChangeCap, apEnvMonitorMibCapabilities=apEnvMonitorMibCapabilities, apH323MibCapabilites=apH323MibCapabilites, apH323StackCap=apH323StackCap, apIPMibCapabilities=apIPMibCapabilities, apIcmpStatsCap=apIcmpStatsCap, apIfMibCap=apIfMibCap, apIfMibCapabilities=apIfMibCapabilities, apIfMibHCCap=apIfMibHCCap, apIfMibVHCCap=apIfMibVHCCap, apInterfacesCap=apInterfacesCap, apIpCap2=apIpCap2, apIpCap=apIpCap, apLicenseCap=apLicenseCap, apLicenseDBRegCap=apLicenseDBRegCap, apLicenseExpirationWarnCap=apLicenseExpirationWarnCap, apLicenseMibCapabilities=apLicenseMibCapabilities, apRadiusMibCap=apRadiusMibCap, apRadiusMibCapabilities=apRadiusMibCapabilities, apRadiusServerStatsCap=apRadiusServerStatsCap, apResrvdNsepUtlMibCapabilities=apResrvdNsepUtlMibCapabilities, apResrvdNsepUtlTrapCap=apResrvdNsepUtlTrapCap, apSLBEndpointCapacityCap=apSLBEndpointCapacityCap, apSLBMibCapabilities=apSLBMibCapabilities, apSLBUntrustedEndpointCapacityCap=apSLBUntrustedEndpointCapacityCap, apSecurityCap=apSecurityCap, apSecurityCertStatusCap=apSecurityCertStatusCap, apSecurityCertificateCap=apSecurityCertificateCap, apSecurityDhcpInterfaceCap=apSecurityDhcpInterfaceCap, apSecurityGtpCaviumStatsCap=apSecurityGtpCaviumStatsCap, apSecurityGtpProfileCap=apSecurityGtpProfileCap, apSecurityGtpStatusCap=apSecurityGtpStatusCap, apSecurityIPsecTunnelsCap=apSecurityIPsecTunnelsCap, apSecurityIkeDDoSCap=apSecurityIkeDDoSCap, apSecurityIkeDDoSInetCap=apSecurityIkeDDoSInetCap, apSecurityIkeIfcBlAuthIDErrorCap=apSecurityIkeIfcBlAuthIDErrorCap, apSecurityIkeInterface3GPPAuthErrorsCap=apSecurityIkeInterface3GPPAuthErrorsCap, apSecurityIkeInterfaceCap=apSecurityIkeInterfaceCap, apSecurityIkeInterfaceDpdStatsCap=apSecurityIkeInterfaceDpdStatsCap, apSecurityIkeInterfaceEapMethodsStatsCap=apSecurityIkeInterfaceEapMethodsStatsCap, apSecurityIkeInterfaceEapOnlyAuthStatsCap=apSecurityIkeInterfaceEapOnlyAuthStatsCap, apSecurityIkeInterfaceIkeErrorStatsCap=apSecurityIkeInterfaceIkeErrorStatsCap, apSecurityIkeInterfaceInfoCap=apSecurityIkeInterfaceInfoCap, apSecurityIkeInterfaceMobikeStatsCap=apSecurityIkeInterfaceMobikeStatsCap, apSecurityInetCap=apSecurityInetCap, apSecurityMibCapabilities=apSecurityMibCapabilities, apSecurityRekeyOnSNoverflowCap=apSecurityRekeyOnSNoverflowCap, apSecuritySrtpCap=apSecuritySrtpCap, apSecurityTacacsCap=apSecurityTacacsCap, apSecurityTacacsDownLocalAuthCap=apSecurityTacacsDownLocalAuthCap, apSecurityTacacsNotifCap=apSecurityTacacsNotifCap, apSecurityTlsCap=apSecurityTlsCap, apSecurityTscfCap=apSecurityTscfCap, apSecurityTscfTimeoutCap=apSecurityTscfTimeoutCap, apSip503RespThresholdNotificationsGroupCap=apSip503RespThresholdNotificationsGroupCap, apSipAudioVideoCallsCap=apSipAudioVideoCallsCap, apSipCACNotificationsGroupCap=apSipCACNotificationsGroupCap, apSipCACStatsCap=apSipCACStatsCap, apSipCACStatsGroupCap=apSipCACStatsGroupCap, apSipCallInformationCap=apSipCallInformationCap, apSipMSRPStatsCap=apSipMSRPStatsCap, apSipMibCapabilities=apSipMibCapabilities, apSipRateGroupCap=apSipRateGroupCap, apSipRecNotificationsGroupCap=apSipRecNotificationsGroupCap, apSipRegEvtSubscriptionCap=apSipRegEvtSubscriptionCap, apSipSRVCCPreAlertingStatsCap=apSipSRVCCPreAlertingStatsCap, apSipSecInterfaceRegNotifGroupCap=apSipSecInterfaceRegNotifGroupCap, apSipSecInterfaceRegObjectsGroupCap=apSipSecInterfaceRegObjectsGroupCap, apSipSteeringPoolUtilNotificationsGroupCap=apSipSteeringPoolUtilNotificationsGroupCap, apSipSurvivabilityNotificationsGroupCap=apSipSurvivabilityNotificationsGroupCap, apSipVoLTECountersCap=apSipVoLTECountersCap, apSlogMibCapabilities=apSlogMibCapabilities, apSmgmtAdminCap=apSmgmtAdminCap, apSmgmtApplicationCPUUsageCap=apSmgmtApplicationCPUUsageCap, apSmgmtCDRPushReceiverFailureCap=apSmgmtCDRPushReceiverFailureCap, apSmgmtCPULoadAvgCap=apSmgmtCPULoadAvgCap, apSmgmtCallRecordingCap=apSmgmtCallRecordingCap, apSmgmtCallsRejectedCap=apSmgmtCallsRejectedCap, apSmgmtCap2=apSmgmtCap2, apSmgmtCap3=apSmgmtCap3, apSmgmtCap4=apSmgmtCap4, apSmgmtCap5=apSmgmtCap5, apSmgmtCap6=apSmgmtCap6, apSmgmtCap=apSmgmtCap, apSmgmtClockNotifyCap=apSmgmtClockNotifyCap, apSmgmtCollectorPushSuccessNotifyCap=apSmgmtCollectorPushSuccessNotifyCap, apSmgmtCtrlStatsCap2=apSmgmtCtrlStatsCap2, apSmgmtCtrlStatsCap=apSmgmtCtrlStatsCap, apSmgmtDOSNotifyCap=apSmgmtDOSNotifyCap, apSmgmtDOSNotifyTrustedtoUntrustedCap=apSmgmtDOSNotifyTrustedtoUntrustedCap, apSmgmtDatabaseRegCap=apSmgmtDatabaseRegCap, apSmgmtENUMCap=apSmgmtENUMCap, apSmgmtEndPtDemotionCap=apSmgmtEndPtDemotionCap, apSmgmtExtSigRealmCap=apSmgmtExtSigRealmCap, apSmgmtExtSipCap=apSmgmtExtSipCap, apSmgmtH248Cap=apSmgmtH248Cap, apSmgmtH248PortMapUsageCap=apSmgmtH248PortMapUsageCap, apSmgmtH323AdditionsCap=apSmgmtH323AdditionsCap, apSmgmtHDRCap=apSmgmtHDRCap, apSmgmtInetAddrDOSNotifyCap=apSmgmtInetAddrDOSNotifyCap, apSmgmtLDAPCap=apSmgmtLDAPCap, apSmgmtLDAPServerCap=apSmgmtLDAPServerCap, apSmgmtLPCap=apSmgmtLPCap, apSmgmtMediaSuperCap=apSmgmtMediaSuperCap, apSmgmtMibCapabilities=apSmgmtMibCapabilities, apSmgmtNSEPCap=apSmgmtNSEPCap, apSmgmtNTPNotifyCap=apSmgmtNTPNotifyCap, apSmgmtPhyUtilCap=apSmgmtPhyUtilCap, apSmgmtRFactorCap=apSmgmtRFactorCap, apSmgmtRealmIcmpFailureCap=apSmgmtRealmIcmpFailureCap, apSmgmtRealmRegCacheSummaryCap=apSmgmtRealmRegCacheSummaryCap, apSmgmtRealmStatsQoSCap=apSmgmtRealmStatsQoSCap, apSmgmtRegCacheLimCap=apSmgmtRegCacheLimCap, apSmgmtRegNotifyCap=apSmgmtRegNotifyCap, apSmgmtRegistrationCap2=apSmgmtRegistrationCap2, apSmgmtRegistrationCap3=apSmgmtRegistrationCap3, apSmgmtRegistrationCap=apSmgmtRegistrationCap, apSmgmtRegistrationCapacityCap=apSmgmtRegistrationCapacityCap, apSmgmtRejectedMessagesCap=apSmgmtRejectedMessagesCap, apSmgmtReservedNSEPCap=apSmgmtReservedNSEPCap, apSmgmtShortSessionCap=apSmgmtShortSessionCap, apSmgmtSipInterfaceRegCacheLimCap=apSmgmtSipInterfaceRegCacheLimCap, apSmgmtSipMethodStatsCap=apSmgmtSipMethodStatsCap, apSmgmtSipRejectCap=apSmgmtSipRejectCap, apSmgmtStorageSpaceCap=apSmgmtStorageSpaceCap, apSmgmtSubscriptionSummaryCap=apSmgmtSubscriptionSummaryCap, apSmgmtTrapTableObjectCap=apSmgmtTrapTableObjectCap, apSmgmtXCodeEVRCNWUtilCap=apSmgmtXCodeEVRCNWUtilCap, apSmgmtXCodeEVRCUtilCap=apSmgmtXCodeEVRCUtilCap, apSmgmtXCodeEVSUtilCap=apSmgmtXCodeEVSUtilCap, apSmgmtXCodeG729UtilCap=apSmgmtXCodeG729UtilCap, apSmgmtXCodeOpusUtilCap=apSmgmtXCodeOpusUtilCap, apSmgmtXCodeSILKUtilCap=apSmgmtXCodeSILKUtilCap, apSnmpCap=apSnmpCap, apSnmpMibCapabilities=apSnmpMibCapabilities, apSnmpv3Cap=apSnmpv3Cap, apSwInventoryCap=apSwInventoryCap, apSwinventoryMibCapabilities=apSwinventoryMibCapabilities, apSysMgmtETCUtilCap=apSysMgmtETCUtilCap, apSyslogCap=apSyslogCap, apSystemManagementGatewaySynchronizedMonitorCap=apSystemManagementGatewaySynchronizedMonitorCap, apTCPMibCapabilities=apTCPMibCapabilities, apTcpCap2=apTcpCap2, apTcpCap=apTcpCap, apUDPMibCapabilities=apUDPMibCapabilities, apUdpCap2=apUdpCap2, apUdpCap=apUdpCap, apUsbcSysCap=apUsbcSysCap, apUsbcSysDPDKCap=apUsbcSysDPDKCap, apUsbcSysDPDKMibCapabilities=apUsbcSysDPDKMibCapabilities, apUsbcSysFdCap=apUsbcSysFdCap, apUsbcSysMibCapabilities=apUsbcSysMibCapabilities, apUsbcSysScalingCap=apUsbcSysScalingCap, apUsbcSysScalingMibCapabilities=apUsbcSysScalingMibCapabilities, apUsbcSysSmCap=apUsbcSysSmCap, apUsbcSysSmMibCapabilities=apUsbcSysSmMibCapabilities, apUsbcSysThreadCap2=apUsbcSysThreadCap2, apUsbcSysThreadCap3=apUsbcSysThreadCap3, apUsbcSysThreadCap4=apUsbcSysThreadCap4, apUsbcSysThreadCap=apUsbcSysThreadCap, apUsbcSysThreadMibCapabilities2=apUsbcSysThreadMibCapabilities2, apUsbcSysThreadMibCapabilities3=apUsbcSysThreadMibCapabilities3, apUsbcSysThreadMibCapabilities=apUsbcSysThreadMibCapabilities)
