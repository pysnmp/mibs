...
DisplayString, TextualConvention, AutonomousType, RowPointer, RowStatus, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "AutonomousType", "RowPointer", "RowStatus", "StorageType")
...
mibBuilder.exportSymbols("DIFFSERV-MIB", diffServTBParamTswTCM=diffServTBParamTswTCM, diffServMIBGroups=diffServMIBGroups, diffServClfrEntry=diffServClfrEntry, diffServMinRateStatus=diffServMinRateStatus, diffServCountActId=diffServCountActId, diffServMIBRandomDropGroup=diffServMIBRandomDropGroup, diffServActionId=diffServActionId, diffServMeterSucceedNext=diffServMeterSucceedNext, diffServAlgRandomDropPkts=diffServAlgRandomDropPkts, diffServTBParamAvgRate=diffServTBParamAvgRate, diffServAlgDrop=diffServAlgDrop, diffServQId=diffServQId, diffServClfrElementNextFree=diffServClfrElementNextFree, diffServMIBReadOnlyCompliance=diffServMIBReadOnlyCompliance, diffServRandomDropWeight=diffServRandomDropWeight, diffServMIBFullCompliance=diffServMIBFullCompliance, diffServMIBConformance=diffServMIBConformance, diffServTBParamStatus=diffServTBParamStatus, diffServMinRateStorage=diffServMinRateStorage, diffServDataPathStart=diffServDataPathStart, diffServClfrElementEntry=diffServClfrElementEntry, diffServTBParamSrTCMAware=diffServTBParamSrTCMAware, diffServRandomDropMaxThreshBytes=diffServRandomDropMaxThreshBytes, diffServMeterId=diffServMeterId, diffServDscpMarkActEntry=diffServDscpMarkActEntry, diffServMIBClfrGroup=diffServMIBClfrGroup, diffServMaxRateLevel=diffServMaxRateLevel, diffServDataPathEntry=diffServDataPathEntry, diffServMib=diffServMib, diffServTBParamId=diffServTBParamId, diffServClfrElementPrecedence=diffServClfrElementPrecedence, diffServActionNext=diffServActionNext, diffServClfrId=diffServClfrId, diffServMultiFieldClfrFlowId=diffServMultiFieldClfrFlowId, diffServMaxRateStorage=diffServMaxRateStorage, diffServAlgDropOctets=diffServAlgDropOctets, diffServClfrElementStatus=diffServClfrElementStatus, diffServAlgDropPkts=diffServAlgDropPkts, diffServMaxRateThreshold=diffServMaxRateThreshold, diffServMultiFieldClfrDstAddr=diffServMultiFieldClfrDstAddr, diffServSchedulerMaxRate=diffServSchedulerMaxRate, diffServAlgDropNextFree=diffServAlgDropNextFree, diffServMultiFieldClfrNextFree=diffServMultiFieldClfrNextFree, diffServClfrStorage=diffServClfrStorage, diffServActionTable=diffServActionTable, diffServRandomDropEntry=diffServRandomDropEntry, diffServActionSpecific=diffServActionSpecific, diffServMeterFailNext=diffServMeterFailNext, diffServMeter=diffServMeter, diffServMultiFieldClfrProtocol=diffServMultiFieldClfrProtocol, diffServSchedulerStatus=diffServSchedulerStatus, diffServMaxRateTable=diffServMaxRateTable, diffServMIBTBParamGroup=diffServMIBTBParamGroup, diffServAlgDropSpecific=diffServAlgDropSpecific, diffServMultiFieldClfrId=diffServMultiFieldClfrId, diffServRandomDropMaxThreshPkts=diffServRandomDropMaxThreshPkts, diffServCountActEntry=diffServCountActEntry, diffServCountActStatus=diffServCountActStatus, diffServSchedulerWRR=diffServSchedulerWRR, diffServMinRateId=diffServMinRateId, diffServActionNextFree=diffServActionNextFree, diffServMIBDscpMarkActGroup=diffServMIBDscpMarkActGroup, diffServSchedulerMinRate=diffServSchedulerMinRate, diffServMIBAdmin=diffServMIBAdmin, diffServMIBClfrElementGroup=diffServMIBClfrElementGroup, diffServRandomDropSamplingRate=diffServRandomDropSamplingRate, diffServDataPathStatus=diffServDataPathStatus, diffServMinRateEntry=diffServMinRateEntry, diffServTBParamSimpleTokenBucket=diffServTBParamSimpleTokenBucket, diffServDscpMarkActTable=diffServDscpMarkActTable, diffServClfrNextFree=diffServClfrNextFree, IndexInteger=IndexInteger, diffServMIBMaxRateGroup=diffServMIBMaxRateGroup, diffServCountActStorage=diffServCountActStorage, diffServMIBCompliances=diffServMIBCompliances, diffServMaxRateAbsolute=diffServMaxRateAbsolute, diffServAlgDropEntry=diffServAlgDropEntry, diffServQNextFree=diffServQNextFree, diffServAlgDropQThreshold=diffServAlgDropQThreshold, diffServMIBSchedulerGroup=diffServMIBSchedulerGroup, diffServQMinRate=diffServQMinRate, diffServAlgDropNext=diffServAlgDropNext, diffServClassifier=diffServClassifier, diffServRandomDropMinThreshBytes=diffServRandomDropMinThreshBytes, diffServMIBCounterGroup=diffServMIBCounterGroup, diffServMinRateNextFree=diffServMinRateNextFree, diffServMaxRateStatus=diffServMaxRateStatus, PYSNMP_MODULE_ID=diffServMib, diffServMeterStorage=diffServMeterStorage, diffServDataPathIfDirection=diffServDataPathIfDirection, diffServAlgDropStorage=diffServAlgDropStorage, diffServMaxRateEntry=diffServMaxRateEntry, diffServMultiFieldClfrDstL4PortMax=diffServMultiFieldClfrDstL4PortMax, diffServDataPathStorage=diffServDataPathStorage, diffServRandomDropStatus=diffServRandomDropStatus, diffServSchedulerId=diffServSchedulerId, diffServSchedulerNextFree=diffServSchedulerNextFree, diffServClfrElementId=diffServClfrElementId, diffServMultiFieldClfrSrcAddr=diffServMultiFieldClfrSrcAddr, diffServMinRateAbsolute=diffServMinRateAbsolute, diffServMIBActionGroup=diffServMIBActionGroup, diffServMeterSpecific=diffServMeterSpecific, IfDirection=IfDirection, diffServRandomDropStorage=diffServRandomDropStorage, diffServQNext=diffServQNext, diffServAlgDropQMeasure=diffServAlgDropQMeasure, diffServQEntry=diffServQEntry, diffServMultiFieldClfrSrcPrefixLength=diffServMultiFieldClfrSrcPrefixLength, diffServActionInterface=diffServActionInterface, diffServMultiFieldClfrTable=diffServMultiFieldClfrTable, diffServQueue=diffServQueue, diffServMIBMeterGroup=diffServMIBMeterGroup, diffServMinRatePriority=diffServMinRatePriority, diffServMaxRateRelative=diffServMaxRateRelative, diffServAction=diffServAction, diffServMultiFieldClfrDstPrefixLength=diffServMultiFieldClfrDstPrefixLength, diffServMIBObjects=diffServMIBObjects, diffServMIBAlgDropGroup=diffServMIBAlgDropGroup, diffServRandomDropNextFree=diffServRandomDropNextFree, diffServMultiFieldClfrStatus=diffServMultiFieldClfrStatus, diffServCountActTable=diffServCountActTable, diffServMultiFieldClfrEntry=diffServMultiFieldClfrEntry, diffServSchedulerPriority=diffServSchedulerPriority, diffServMIBQGroup=diffServMIBQGroup, diffServMIBMultiFieldClfrGroup=diffServMIBMultiFieldClfrGroup, diffServAlgDropStatus=diffServAlgDropStatus, diffServAlgDropId=diffServAlgDropId, diffServTBParamRate=diffServTBParamRate, diffServActionStatus=diffServActionStatus, diffServTBParamTable=diffServTBParamTable, diffServRandomDropId=diffServRandomDropId, diffServTBParamBurstSize=diffServTBParamBurstSize, diffServQStorage=diffServQStorage, diffServMultiFieldClfrStorage=diffServMultiFieldClfrStorage, IndexIntegerNextFree=IndexIntegerNextFree, diffServMeterTable=diffServMeterTable, diffServTBParamTrTCMAware=diffServTBParamTrTCMAware, diffServSchedulers=diffServSchedulers, diffServMultiFieldClfrSrcL4PortMin=diffServMultiFieldClfrSrcL4PortMin, diffServAlgDropTable=diffServAlgDropTable, diffServMinRateRelative=diffServMinRateRelative, diffServMIBDataPathGroup=diffServMIBDataPathGroup, diffServTBParamNextFree=diffServTBParamNextFree, diffServClfrTable=diffServClfrTable, diffServMeterNextFree=diffServMeterNextFree, diffServAlgRandomDropOctets=diffServAlgRandomDropOctets, diffServScheduler=diffServScheduler, diffServMultiFieldClfrDscp=diffServMultiFieldClfrDscp, diffServTBParamEntry=diffServTBParamEntry, diffServQTable=diffServQTable, diffServRandomDropProbMax=diffServRandomDropProbMax, diffServCountActNextFree=diffServCountActNextFree, diffServClfrElementStorage=diffServClfrElementStorage, diffServMeterStatus=diffServMeterStatus, diffServMultiFieldClfrDstL4PortMin=diffServMultiFieldClfrDstL4PortMin, diffServMultiFieldClfrAddrType=diffServMultiFieldClfrAddrType, diffServSchedulerWFQ=diffServSchedulerWFQ, diffServCountActPkts=diffServCountActPkts, diffServClfrStatus=diffServClfrStatus, diffServMeterEntry=diffServMeterEntry, diffServRandomDropTable=diffServRandomDropTable, diffServSchedulerMethod=diffServSchedulerMethod, diffServSchedulerNext=diffServSchedulerNext, diffServRandomDropMinThreshPkts=diffServRandomDropMinThreshPkts, diffServActionEntry=diffServActionEntry, diffServCountActOctets=diffServCountActOctets, diffServTBParamType=diffServTBParamType, diffServTBParamTrTCMBlind=diffServTBParamTrTCMBlind, diffServClfrElementSpecific=diffServClfrElementSpecific, diffServTBParamInterval=diffServTBParamInterval, diffServSchedulerTable=diffServSchedulerTable, diffServSchedulerEntry=diffServSchedulerEntry, diffServTBMeters=diffServTBMeters, diffServTBParamSrTCMBlind=diffServTBParamSrTCMBlind, diffServDataPath=diffServDataPath, diffServMIBMinRateGroup=diffServMIBMinRateGroup, diffServClfrElementTable=diffServClfrElementTable, diffServMaxRateId=diffServMaxRateId, diffServQMaxRate=diffServQMaxRate, diffServSchedulerStorage=diffServSchedulerStorage, diffServTBParamStorage=diffServTBParamStorage, diffServDataPathTable=diffServDataPathTable, diffServAlgDropType=diffServAlgDropType, diffServActionStorage=diffServActionStorage, diffServClfrElementNext=diffServClfrElementNext, diffServTBParam=diffServTBParam, diffServQStatus=diffServQStatus, diffServMinRateTable=diffServMinRateTable, diffServDscpMarkActDscp=diffServDscpMarkActDscp, diffServMaxRateNextFree=diffServMaxRateNextFree, diffServMultiFieldClfrSrcL4PortMax=diffServMultiFieldClfrSrcL4PortMax)
