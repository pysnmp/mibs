...
RowPointer, DisplayString, StorageType, TextualConvention, AutonomousType, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "StorageType", "TextualConvention", "AutonomousType", "RowStatus")
...
mibBuilder.exportSymbols("DIFFSERV-MIB", diffServQTable=diffServQTable, diffServDscpMarkActEntry=diffServDscpMarkActEntry, diffServMaxRateRelative=diffServMaxRateRelative, diffServMIBMultiFieldClfrGroup=diffServMIBMultiFieldClfrGroup, diffServMinRatePriority=diffServMinRatePriority, diffServTBParamAvgRate=diffServTBParamAvgRate, diffServTBParamTrTCMAware=diffServTBParamTrTCMAware, diffServMaxRateStatus=diffServMaxRateStatus, diffServMultiFieldClfrDstL4PortMin=diffServMultiFieldClfrDstL4PortMin, diffServDataPathStart=diffServDataPathStart, diffServDataPathIfDirection=diffServDataPathIfDirection, diffServScheduler=diffServScheduler, diffServSchedulerEntry=diffServSchedulerEntry, diffServMIBDataPathGroup=diffServMIBDataPathGroup, diffServMeterSucceedNext=diffServMeterSucceedNext, diffServClfrEntry=diffServClfrEntry, diffServMinRateRelative=diffServMinRateRelative, diffServActionStorage=diffServActionStorage, diffServMaxRateThreshold=diffServMaxRateThreshold, diffServMultiFieldClfrNextFree=diffServMultiFieldClfrNextFree, diffServDataPathTable=diffServDataPathTable, diffServDscpMarkActTable=diffServDscpMarkActTable, diffServMaxRateNextFree=diffServMaxRateNextFree, diffServMinRateId=diffServMinRateId, diffServTBParamStatus=diffServTBParamStatus, diffServCountActStatus=diffServCountActStatus, diffServMIBFullCompliance=diffServMIBFullCompliance, diffServRandomDropMinThreshPkts=diffServRandomDropMinThreshPkts, diffServQEntry=diffServQEntry, diffServActionNext=diffServActionNext, diffServAlgDropNextFree=diffServAlgDropNextFree, diffServMultiFieldClfrId=diffServMultiFieldClfrId, diffServClfrId=diffServClfrId, diffServAlgDropId=diffServAlgDropId, diffServRandomDropSamplingRate=diffServRandomDropSamplingRate, diffServTBParamInterval=diffServTBParamInterval, IfDirection=IfDirection, diffServDataPathStorage=diffServDataPathStorage, diffServRandomDropTable=diffServRandomDropTable, diffServCountActOctets=diffServCountActOctets, diffServRandomDropNextFree=diffServRandomDropNextFree, diffServMultiFieldClfrDstL4PortMax=diffServMultiFieldClfrDstL4PortMax, diffServMIBConformance=diffServMIBConformance, IndexIntegerNextFree=IndexIntegerNextFree, diffServMeterNextFree=diffServMeterNextFree, diffServTBParamTrTCMBlind=diffServTBParamTrTCMBlind, diffServMultiFieldClfrStatus=diffServMultiFieldClfrStatus, diffServSchedulerTable=diffServSchedulerTable, diffServClfrStorage=diffServClfrStorage, diffServSchedulerMethod=diffServSchedulerMethod, diffServMIBAdmin=diffServMIBAdmin, diffServClfrNextFree=diffServClfrNextFree, diffServRandomDropStatus=diffServRandomDropStatus, diffServMIBTBParamGroup=diffServMIBTBParamGroup, diffServAlgDropNext=diffServAlgDropNext, diffServTBParamTswTCM=diffServTBParamTswTCM, diffServSchedulers=diffServSchedulers, diffServMaxRateId=diffServMaxRateId, diffServDataPathEntry=diffServDataPathEntry, diffServMultiFieldClfrSrcAddr=diffServMultiFieldClfrSrcAddr, diffServMIBGroups=diffServMIBGroups, diffServAlgDropTable=diffServAlgDropTable, diffServTBParamSrTCMAware=diffServTBParamSrTCMAware, diffServTBParamTable=diffServTBParamTable, diffServMultiFieldClfrEntry=diffServMultiFieldClfrEntry, diffServAlgDropQThreshold=diffServAlgDropQThreshold, diffServClfrElementStorage=diffServClfrElementStorage, diffServActionTable=diffServActionTable, diffServTBParamNextFree=diffServTBParamNextFree, diffServMIBClfrElementGroup=diffServMIBClfrElementGroup, diffServMinRateAbsolute=diffServMinRateAbsolute, diffServTBParamType=diffServTBParamType, diffServAlgRandomDropOctets=diffServAlgRandomDropOctets, diffServAlgDropSpecific=diffServAlgDropSpecific, diffServQId=diffServQId, diffServSchedulerWRR=diffServSchedulerWRR, diffServSchedulerStorage=diffServSchedulerStorage, diffServMinRateStatus=diffServMinRateStatus, diffServSchedulerMinRate=diffServSchedulerMinRate, diffServMultiFieldClfrDscp=diffServMultiFieldClfrDscp, diffServMIBAlgDropGroup=diffServMIBAlgDropGroup, diffServClfrElementNext=diffServClfrElementNext, diffServActionId=diffServActionId, diffServRandomDropWeight=diffServRandomDropWeight, diffServSchedulerMaxRate=diffServSchedulerMaxRate, diffServMIBRandomDropGroup=diffServMIBRandomDropGroup, diffServTBParamSrTCMBlind=diffServTBParamSrTCMBlind, diffServMIBObjects=diffServMIBObjects, diffServDscpMarkActDscp=diffServDscpMarkActDscp, diffServMaxRateLevel=diffServMaxRateLevel, diffServTBParamSimpleTokenBucket=diffServTBParamSimpleTokenBucket, diffServQNext=diffServQNext, diffServAlgDropOctets=diffServAlgDropOctets, diffServMeter=diffServMeter, diffServTBParam=diffServTBParam, diffServMIBClfrGroup=diffServMIBClfrGroup, diffServCountActNextFree=diffServCountActNextFree, diffServActionInterface=diffServActionInterface, diffServActionNextFree=diffServActionNextFree, diffServSchedulerNext=diffServSchedulerNext, diffServClfrElementPrecedence=diffServClfrElementPrecedence, diffServMultiFieldClfrSrcPrefixLength=diffServMultiFieldClfrSrcPrefixLength, diffServClfrElementTable=diffServClfrElementTable, diffServQMinRate=diffServQMinRate, diffServCountActTable=diffServCountActTable, diffServMultiFieldClfrDstPrefixLength=diffServMultiFieldClfrDstPrefixLength, diffServMinRateTable=diffServMinRateTable, diffServCountActPkts=diffServCountActPkts, diffServMultiFieldClfrProtocol=diffServMultiFieldClfrProtocol, diffServSchedulerPriority=diffServSchedulerPriority, diffServAlgRandomDropPkts=diffServAlgRandomDropPkts, diffServClassifier=diffServClassifier, diffServRandomDropId=diffServRandomDropId, diffServMeterEntry=diffServMeterEntry, diffServMeterId=diffServMeterId, diffServTBParamId=diffServTBParamId, diffServQStorage=diffServQStorage, diffServMIBDscpMarkActGroup=diffServMIBDscpMarkActGroup, diffServMultiFieldClfrStorage=diffServMultiFieldClfrStorage, diffServMIBCompliances=diffServMIBCompliances, diffServRandomDropProbMax=diffServRandomDropProbMax, diffServRandomDropStorage=diffServRandomDropStorage, diffServDataPathStatus=diffServDataPathStatus, diffServMaxRateStorage=diffServMaxRateStorage, diffServClfrStatus=diffServClfrStatus, diffServMIBMinRateGroup=diffServMIBMinRateGroup, diffServRandomDropMinThreshBytes=diffServRandomDropMinThreshBytes, diffServMultiFieldClfrSrcL4PortMin=diffServMultiFieldClfrSrcL4PortMin, diffServActionSpecific=diffServActionSpecific, diffServMeterSpecific=diffServMeterSpecific, diffServSchedulerStatus=diffServSchedulerStatus, diffServMaxRateAbsolute=diffServMaxRateAbsolute, diffServTBParamBurstSize=diffServTBParamBurstSize, diffServSchedulerWFQ=diffServSchedulerWFQ, diffServAlgDropPkts=diffServAlgDropPkts, diffServActionEntry=diffServActionEntry, diffServTBMeters=diffServTBMeters, diffServClfrElementNextFree=diffServClfrElementNextFree, diffServMinRateStorage=diffServMinRateStorage, diffServMIBMaxRateGroup=diffServMIBMaxRateGroup, diffServDataPath=diffServDataPath, diffServMultiFieldClfrAddrType=diffServMultiFieldClfrAddrType, diffServQStatus=diffServQStatus, diffServMIBCounterGroup=diffServMIBCounterGroup, diffServAlgDrop=diffServAlgDrop, diffServMIBSchedulerGroup=diffServMIBSchedulerGroup, diffServMeterFailNext=diffServMeterFailNext, diffServClfrTable=diffServClfrTable, diffServMultiFieldClfrTable=diffServMultiFieldClfrTable, diffServMib=diffServMib, diffServClfrElementId=diffServClfrElementId, diffServQMaxRate=diffServQMaxRate, PYSNMP_MODULE_ID=diffServMib, diffServAlgDropStorage=diffServAlgDropStorage, diffServMeterStorage=diffServMeterStorage, diffServCountActStorage=diffServCountActStorage, diffServClfrElementSpecific=diffServClfrElementSpecific, diffServCountActEntry=diffServCountActEntry, diffServMultiFieldClfrDstAddr=diffServMultiFieldClfrDstAddr, diffServTBParamStorage=diffServTBParamStorage, diffServMeterTable=diffServMeterTable, diffServMinRateNextFree=diffServMinRateNextFree, diffServQNextFree=diffServQNextFree, diffServRandomDropEntry=diffServRandomDropEntry, diffServSchedulerId=diffServSchedulerId, diffServRandomDropMaxThreshBytes=diffServRandomDropMaxThreshBytes, diffServAlgDropType=diffServAlgDropType, diffServTBParamEntry=diffServTBParamEntry, diffServMaxRateEntry=diffServMaxRateEntry, diffServCountActId=diffServCountActId, diffServMIBReadOnlyCompliance=diffServMIBReadOnlyCompliance, diffServTBParamRate=diffServTBParamRate, diffServAlgDropEntry=diffServAlgDropEntry, diffServMIBMeterGroup=diffServMIBMeterGroup, diffServClfrElementStatus=diffServClfrElementStatus, diffServAlgDropStatus=diffServAlgDropStatus, diffServQueue=diffServQueue, diffServMIBQGroup=diffServMIBQGroup, diffServActionStatus=diffServActionStatus, diffServMIBActionGroup=diffServMIBActionGroup, diffServMeterStatus=diffServMeterStatus, diffServAlgDropQMeasure=diffServAlgDropQMeasure, diffServMultiFieldClfrSrcL4PortMax=diffServMultiFieldClfrSrcL4PortMax, diffServMinRateEntry=diffServMinRateEntry, diffServMaxRateTable=diffServMaxRateTable, diffServAction=diffServAction, diffServMultiFieldClfrFlowId=diffServMultiFieldClfrFlowId, diffServClfrElementEntry=diffServClfrElementEntry, diffServRandomDropMaxThreshPkts=diffServRandomDropMaxThreshPkts, diffServSchedulerNextFree=diffServSchedulerNextFree, IndexInteger=IndexInteger)
