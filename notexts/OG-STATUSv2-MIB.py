...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsIndex=ogUpsIndex, ogRpcDescription=ogRpcDescription, ogSerialPortDCD=ogSerialPortDCD, ogUpsType=ogUpsType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApTable=ogWifiApTable, ogWifiApSsid=ogWifiApSsid, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSystem=ogSystem, ogCellModemCounter=ogCellModemCounter, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceHost=ogHostServiceHost, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioEmd=ogEmdDioEmd, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemModel=ogCellModemModel, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmTime=ogAlarmTime, ogWebUserIndex=ogWebUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceName=ogCheckDeviceName, ogCellModemTable=ogCellModemTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmSummary=ogAlarmSummary, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsTable=ogUpsTable, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserTable=ogHostUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellDataNotification=ogCellDataNotification, ogRpcTable=ogRpcTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserHost=ogHostUserHost, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientEntry=ogWifiClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserTable=ogSerialUserTable, ogWifiApInterface=ogWifiApInterface, ogCheckTable=ogCheckTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellSignalNotification=ogCellSignalNotification, ogUpsNotification=ogUpsNotification, ogHostName=ogHostName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletState=ogRpcOutletState, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellTowerNotification=ogCellTowerNotification, ogHostUserEntry=ogHostUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDataBits=ogSerialPortDataBits, ogHostEntry=ogHostEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmUser=ogAlarmUser, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmEventId=ogCurrentAlarmEventId, PYSNMP_MODULE_ID=ogStatus2, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostPingNotification=ogHostPingNotification, ogHostServiceNotification=ogHostServiceNotification, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTable=ogEmdDioTable, ogRpcConnectType=ogRpcConnectType, ogHostUserNotification=ogHostUserNotification, ogWifiClientApMac=ogWifiClientApMac, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogFirmwareVersion=ogFirmwareVersion, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceRef=ogCheckDeviceRef, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserStartTime=ogWebUserStartTime, ogSerialNumber=ogSerialNumber, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserName=ogSerialUserName, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsState=ogUpsState, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcType=ogRpcType, ogCheckType=ogCheckType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortLabel=ogSerialPortLabel, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsEntry=ogUpsEntry, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Conformance=ogStatus2Conformance, ogEmdEntry=ogEmdEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsName=ogUpsName, ogEmdDioNotification=ogEmdDioNotification, ogCheckName=ogCheckName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmName=ogAlarmName, ogCellModemApn=ogCellModemApn, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortTable=ogSerialPortTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserIndex=ogSerialUserIndex, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDescription=ogEmdDescription, ogHostTable=ogHostTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApIndex=ogWifiApIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientAp=ogWifiApClientAp, ogCheckIndex=ogCheckIndex, ogCellModemIndex=ogCellModemIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckEntry=ogCheckEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmLogTable=ogAlarmLogTable, ogCellMessageNotification=ogCellMessageNotification, ogWifiApCounter=ogWifiApCounter, ogUpsCounter=ogUpsCounter, ogHostIndex=ogHostIndex, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortMode=ogSerialPortMode, ogMibNotifications=ogMibNotifications, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTower=ogCellModemTower, ogRpcOutputNotification=ogRpcOutputNotification, ogCustomNotification=ogCustomNotification, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemEntry=ogCellModemEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientMode=ogWifiClientMode, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserName=ogWebUserName, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsDescription=ogUpsDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserPort=ogSerialUserPort, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceType=ogHostServiceType, ogEmdTable=ogEmdTable, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcEntry=ogRpcEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmState=ogAlarmState, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApEntry=ogWifiApEntry, ogSerialPortIndex=ogSerialPortIndex, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEssid=ogWifiClientEssid, ogCellModemConnected=ogCellModemConnected, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogWebUserTable=ogWebUserTable, ogHostUserIndex=ogHostUserIndex, ogStatus2=ogStatus2, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdName=ogEmdName, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientTable=ogWifiClientTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogAlarmEventId=ogAlarmEventId, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceType=ogNetInterfaceType, ogEmdIndex=ogEmdIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioName=ogEmdDioName, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortParity=ogSerialPortParity, ogEmdDioState=ogEmdDioState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmType=ogAlarmType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmCheck=ogAlarmCheck, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServicePort=ogHostServicePort, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsTemperature=ogUpsTemperature, ogRpcName=ogRpcName, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserHostName=ogHostUserHostName, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientIndex=ogWifiClientIndex, ogWebUserNotification=ogWebUserNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNotification=ogUpsInputNotification, ogAlarm=ogAlarm, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserEntry=ogSerialUserEntry, ogCellApnNotification=ogCellApnNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcIndex=ogRpcIndex, ogRpcCounter=ogRpcCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceStatus=ogHostServiceStatus, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
