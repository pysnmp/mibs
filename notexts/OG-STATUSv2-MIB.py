...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDescription=ogEmdDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletName=ogRpcOutletName, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceName=ogNetInterfaceName, ogAlarmEventId=ogAlarmEventId, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmName=ogAlarmName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserName=ogSerialUserName, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostPingNotification=ogHostPingNotification, ogAlarmState=ogAlarmState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, PYSNMP_MODULE_ID=ogStatus2, ogWebUserNotification=ogWebUserNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortEntry=ogSerialPortEntry, ogHostUserIndex=ogHostUserIndex, ogFirmwareVersion=ogFirmwareVersion, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Groups=ogStatus2Groups, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserTable=ogHostUserTable, ogCellModemModel=ogCellModemModel, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsType=ogUpsType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckTable=ogCheckTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserPort=ogSerialUserPort, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogEmdEntry=ogEmdEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogHostEntry=ogHostEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogCellDataNotification=ogCellDataNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioState=ogEmdDioState, ogEmdDioName=ogEmdDioName, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsEntry=ogUpsEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortCTS=ogSerialPortCTS, ogCheckName=ogCheckName, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletEntry=ogRpcOutletEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcConnectType=ogRpcConnectType, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortMode=ogSerialPortMode, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserName=ogWebUserName, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientCounter=ogWifiClientCounter, ogAlarmLogTable=ogAlarmLogTable, ogCellApnNotification=ogCellApnNotification, ogAlarm=ogAlarm, ogSerialPortIndex=ogSerialPortIndex, ogEmdConnectType=ogEmdConnectType, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceHost=ogHostServiceHost, ogCellModemCounter=ogCellModemCounter, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientInterface=ogWifiClientInterface, ogRpcType=ogRpcType, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckIndex=ogCheckIndex, ogCellModemIndex=ogCellModemIndex, ogCellModemApn=ogCellModemApn, ogRpcIndex=ogRpcIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserLabel=ogSerialUserLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcEntry=ogRpcEntry, ogWifiClientApMac=ogWifiClientApMac, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserIndex=ogWebUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckType=ogCheckType, ogUpsTemperature=ogUpsTemperature, ogCellModemVendor=ogCellModemVendor, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcName=ogRpcName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdName=ogEmdName, ogSerialPortTable=ogSerialPortTable, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientMode=ogWifiClientMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmCheck=ogAlarmCheck, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSystem=ogSystem, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApIndex=ogWifiApIndex, ogHostServicePort=ogHostServicePort, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialNumber=ogSerialNumber, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogMibNotifications=ogMibNotifications, ogCellNetworkNotification=ogCellNetworkNotification, ogHostName=ogHostName, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNotification=ogUpsInputNotification, ogAlarmUser=ogAlarmUser, ogWifiApCounter=ogWifiApCounter, ogHostUserEntry=ogHostUserEntry, ogAlarmInstance=ogAlarmInstance, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsHumidity=ogUpsHumidity, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckEntry=ogCheckEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEmd=ogEmdDioEmd, ogCheckResolveActions=ogCheckResolveActions, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Compliance=ogStatus2Compliance, ogCellSignalNotification=ogCellSignalNotification, ogCellModemTable=ogCellModemTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserNotification=ogHostUserNotification, ogHostUserHost=ogHostUserHost, ogUpsName=ogUpsName, ogAlarmTime=ogAlarmTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdIndex=ogEmdIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmType=ogAlarmType, ogHostIndex=ogHostIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsTable=ogUpsTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsNotification=ogUpsNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmDevice=ogAlarmDevice, ogHostServiceTable=ogHostServiceTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostIpV4Address=ogHostIpV4Address, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientIndex=ogWifiClientIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiApTable=ogWifiApTable, ogWebUserEntry=ogWebUserEntry, ogCellModemTower=ogCellModemTower, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTable=ogEmdTable, ogEmdDioType=ogEmdDioType, ogWifiApSsid=ogWifiApSsid, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcCounter=ogRpcCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioTable=ogEmdDioTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCustomNotification=ogCustomNotification, ogRpcDescription=ogRpcDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceType=ogHostServiceType, ogHostUserHostName=ogHostUserHostName, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsIndex=ogUpsIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserIndex=ogSerialUserIndex, ogUpsDescription=ogUpsDescription, ogRpcTable=ogRpcTable, ogHostUserStartTime=ogHostUserStartTime, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserTable=ogWebUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2=ogStatus2, ogEmdDioCounter=ogEmdDioCounter, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsState=ogUpsState, ogHostUserName=ogHostUserName, ogWifiApClientTable=ogWifiApClientTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostTable=ogHostTable, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDirection=ogEmdDioDirection)
