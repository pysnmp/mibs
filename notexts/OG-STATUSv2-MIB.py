...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmTime=ogAlarmTime, ogHostUserEntry=ogHostUserEntry, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemTower=ogCellModemTower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserName=ogSerialUserName, ogRpcOutletState=ogRpcOutletState, ogAlarmEventId=ogAlarmEventId, ogAlarmType=ogAlarmType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserName=ogHostUserName, ogUpsIndex=ogUpsIndex, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceType=ogHostServiceType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserLabel=ogSerialUserLabel, ogRpcInputNotification=ogRpcInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityTotal=ogEmdHumidityTotal, ogMibNotifications=ogMibNotifications, ogUpsConnectType=ogUpsConnectType, ogUpsCounter=ogUpsCounter, ogCheckType=ogCheckType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientBitRate=ogWifiClientBitRate, ogHostIndex=ogHostIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityTable=ogEmdHumidityTable, PYSNMP_MODULE_ID=ogStatus2, ogCellModemModel=ogCellModemModel, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortDCD=ogSerialPortDCD, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdIndex=ogEmdIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcIndex=ogRpcIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceTable=ogHostServiceTable, ogCheckIndex=ogCheckIndex, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserNotification=ogSerialUserNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientTable=ogWifiClientTable, ogSystem=ogSystem, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmState=ogAlarmState, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEntry=ogWifiClientEntry, ogHostEntry=ogHostEntry, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceIndex=ogHostServiceIndex, ogHostUserAddress=ogHostUserAddress, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmDevice=ogAlarmDevice, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsState=ogUpsState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemCounter=ogCellModemCounter, ogWifiApClientAp=ogWifiApClientAp, ogBasicStatusGroup=ogBasicStatusGroup, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogRpcCounter=ogRpcCounter, ogUpsTable=ogUpsTable, ogHostTable=ogHostTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarm=ogAlarm, ogWifiApTable=ogWifiApTable, ogRpcOutletTable=ogRpcOutletTable, ogCellModemIndex=ogCellModemIndex, ogRpcType=ogRpcType, ogSerialUserIndex=ogSerialUserIndex, ogRpcDescription=ogRpcDescription, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParity=ogSerialPortParity, ogFirmwareVersion=ogFirmwareVersion, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2Groups=ogStatus2Groups, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioTable=ogEmdDioTable, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellMessageNotification=ogCellMessageNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDescription=ogEmdDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTemperature=ogCellModemTemperature, ogWebUserName=ogWebUserName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioCounter=ogEmdDioCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTable=ogEmdTable, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsType=ogUpsType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckName=ogCheckName, ogWebUserTable=ogWebUserTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceState=ogNetInterfaceState, ogEmdEntry=ogEmdEntry, ogWifiClientInterface=ogWifiClientInterface, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemNetwork=ogCellModemNetwork, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientCounter=ogWifiClientCounter, ogRpcEntry=ogRpcEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogAlarmName=ogAlarmName, ogAlarmCheck=ogAlarmCheck, ogSerialPortTable=ogSerialPortTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsDescription=ogUpsDescription, ogRpcName=ogRpcName, ogAlarmUser=ogAlarmUser, ogCustomNotification=ogCustomNotification, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsTemperature=ogUpsTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsName=ogUpsName, ogCheckResetTimeout=ogCheckResetTimeout, ogCellDataNotification=ogCellDataNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserEntry=ogWebUserEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmName=ogCurrentAlarmName, ogCellSignalNotification=ogCellSignalNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRssi=ogWifiClientRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialNumber=ogSerialNumber, ogCurrentAlarmState=ogCurrentAlarmState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTable=ogCheckTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientEssid=ogWifiClientEssid, ogHostName=ogHostName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortMode=ogSerialPortMode, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceHost=ogHostServiceHost, ogEmdConnectType=ogEmdConnectType, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserHost=ogHostUserHost, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEntry=ogCellModemEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcTable=ogRpcTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientMode=ogWifiClientMode, ogUpsEntry=ogUpsEntry, ogCellModemTable=ogCellModemTable, ogWifiApEntry=ogWifiApEntry, ogSerialPortLabel=ogSerialPortLabel, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdName=ogEmdName, ogEmdDioName=ogEmdDioName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsNotification=ogUpsNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemVendor=ogCellModemVendor, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdEnabled=ogEmdEnabled, ogEmdDioType=ogEmdDioType, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServicePort=ogHostServicePort, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckEntry=ogCheckEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioState=ogEmdDioState, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApIeeeMode=ogWifiApIeeeMode)
