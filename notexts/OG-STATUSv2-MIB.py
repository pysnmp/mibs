...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHost=ogHostUserHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsTemperature=ogUpsTemperature, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortParity=ogSerialPortParity, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceNotification=ogHostServiceNotification, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioState=ogEmdDioState, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortTable=ogSerialPortTable, ogAlarmState=ogAlarmState, ogRpcOutletState=ogRpcOutletState, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsHumidity=ogUpsHumidity, ogStatus2=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdEnabled=ogEmdEnabled, ogAlarm=ogAlarm, ogCellModemIndex=ogCellModemIndex, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortDCD=ogSerialPortDCD, ogAlarmTime=ogAlarmTime, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApInterface=ogWifiApInterface, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientEnabled=ogWifiClientEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemIMSI=ogCellModemIMSI, ogAlarmEventId=ogAlarmEventId, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortEntry=ogSerialPortEntry, ogUpsName=ogUpsName, ogRpcEntry=ogRpcEntry, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckIndex=ogCheckIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioTable=ogEmdDioTable, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmCheck=ogAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellApnNotification=ogCellApnNotification, ogCellModemEntry=ogCellModemEntry, ogUpsDescription=ogUpsDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceTable=ogHostServiceTable, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceEntry=ogCheckDeviceEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTable=ogCellModemTable, ogSystem=ogSystem, ogHostName=ogHostName, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdName=ogEmdName, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserPort=ogSerialUserPort, ogWebUserName=ogWebUserName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsType=ogUpsType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserTable=ogHostUserTable, ogCellSignalNotification=ogCellSignalNotification, ogWebUserTable=ogWebUserTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApFrequency=ogWifiApFrequency, ogAlarmInstance=ogAlarmInstance, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceType=ogHostServiceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApCounter=ogWifiApCounter, ogWifiApTxPower=ogWifiApTxPower, ogHostIndex=ogHostIndex, ogCellDataNotification=ogCellDataNotification, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckTable=ogCheckTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserName=ogHostUserName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioType=ogEmdDioType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmDevice=ogAlarmDevice, ogRpcInputNotification=ogRpcInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckResolveActions=ogCheckResolveActions, ogCellModemApn=ogCellModemApn, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserEntry=ogHostUserEntry, ogHostTable=ogHostTable, ogUpsNotification=ogUpsNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserNotification=ogHostUserNotification, ogUpsConnectType=ogUpsConnectType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserName=ogSerialUserName, ogRpcType=ogRpcType, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceIndex=ogHostServiceIndex, ogAlarmSummary=ogAlarmSummary, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioName=ogEmdDioName, ogUpsTable=ogUpsTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckName=ogCheckName, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortSpeed=ogSerialPortSpeed, ogCellMessageNotification=ogCellMessageNotification, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsCounter=ogUpsCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientMode=ogWifiClientMode, ogHostServiceHost=ogHostServiceHost, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemTower=ogCellModemTower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyName=ogPowerSupplyName, ogAlarmType=ogAlarmType, ogHostUserStartTime=ogHostUserStartTime, ogRpcConnectType=ogRpcConnectType, ogHostEntry=ogHostEntry, ogUpsState=ogUpsState, ogCustomNotification=ogCustomNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApTable=ogWifiApTable, ogEmdDioCounter=ogEmdDioCounter, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmUser=ogAlarmUser, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmName=ogAlarmName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServicePort=ogHostServicePort, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDescription=ogEmdDescription, ogUpsIndex=ogUpsIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryState=ogUpsBatteryState, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcCounter=ogRpcCounter, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioEmd=ogEmdDioEmd, ogRpcTable=ogRpcTable, ogWifiApEnabled=ogWifiApEnabled, ogRpcIndex=ogRpcIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserAddress=ogHostUserAddress, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcName=ogRpcName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientCounter=ogWifiClientCounter, ogCheckType=ogCheckType, ogCellModemConnected=ogCellModemConnected, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserTable=ogSerialUserTable, ogHostIpV4Address=ogHostIpV4Address, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogMibNotifications=ogMibNotifications, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdIndex=ogEmdIndex, ogHostServiceCounter=ogHostServiceCounter, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckEntry=ogCheckEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityName=ogEmdHumidityName, ogHostUserHostName=ogHostUserHostName, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletName=ogRpcOutletName, PYSNMP_MODULE_ID=ogStatus2, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialNumber=ogSerialNumber, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
