...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemModel=ogCellModemModel, ogWifiApClientMac=ogWifiApClientMac, ogHostUserIndex=ogHostUserIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTemperature=ogUpsTemperature, ogSystem=ogSystem, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcEntry=ogRpcEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioDescription=ogEmdDioDescription, ogUpsNotification=ogUpsNotification, ogStatus2Groups=ogStatus2Groups, ogHostServiceHost=ogHostServiceHost, ogAlarmUser=ogAlarmUser, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsState=ogUpsState, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemCounter=ogCellModemCounter, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdName=ogEmdName, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogHostName=ogHostName, ogWifiApTxPower=ogWifiApTxPower, ogRpcIndex=ogRpcIndex, ogCheckIndex=ogCheckIndex, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserNotification=ogWebUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletState=ogRpcOutletState, ogCheckResolveActions=ogCheckResolveActions, ogMibNotifications=ogMibNotifications, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceNotification=ogHostServiceNotification, ogUpsEntry=ogUpsEntry, ogHostUserHostName=ogHostUserHostName, ogRpcOutletTable=ogRpcOutletTable, ogHostPingNotification=ogHostPingNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientEnabled=ogWifiClientEnabled, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckType=ogCheckType, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserName=ogWebUserName, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdIndex=ogEmdIndex, ogHostServiceEntry=ogHostServiceEntry, ogCellModemEnabled=ogCellModemEnabled, ogHostUserNotification=ogHostUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientCounter=ogWifiClientCounter, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityName=ogEmdHumidityName, ogCellApnNotification=ogCellApnNotification, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientRssi=ogWifiClientRssi, ogUpsDescription=ogUpsDescription, ogUpsBatteryState=ogUpsBatteryState, ogWifiApFrequency=ogWifiApFrequency, ogHostTable=ogHostTable, ogRpcType=ogRpcType, ogHostIndex=ogHostIndex, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarm=ogAlarm, ogSerialUserName=ogSerialUserName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmSummary=ogAlarmSummary, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcMaxTemperature=ogRpcMaxTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserTable=ogWebUserTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellTowerNotification=ogCellTowerNotification, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckTable=ogCheckTable, ogRpcOutletName=ogRpcOutletName, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceTable=ogHostServiceTable, ogStatus2Compliances=ogStatus2Compliances, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApIndex=ogWifiApIndex, ogAlarmTime=ogAlarmTime, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemTable=ogCellModemTable, ogStatus2Conformance=ogStatus2Conformance, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientEntry=ogWifiClientEntry, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioState=ogEmdDioState, ogAlarmState=ogAlarmState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserLabel=ogSerialUserLabel, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostEntry=ogHostEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmName=ogAlarmName, ogHostIpV6Address=ogHostIpV6Address, ogUpsTable=ogUpsTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApCounter=ogWifiApCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputPower=ogUpsOutputPower, ogCellModemTower=ogCellModemTower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientIndex=ogWifiClientIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserPort=ogSerialUserPort, ogEmdDioName=ogEmdDioName, ogHostUserHost=ogHostUserHost, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdConnectType=ogEmdConnectType, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserTable=ogHostUserTable, ogCellModemEntry=ogCellModemEntry, ogUpsType=ogUpsType, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsName=ogUpsName, ogAlarmType=ogAlarmType, ogCellModemIndex=ogCellModemIndex, ogCellDataNotification=ogCellDataNotification, ogWifiApTable=ogWifiApTable, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcName=ogRpcName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputLoad=ogUpsOutputLoad, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApSsid=ogWifiApSsid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserName=ogHostUserName, ogUpsInputCurrent=ogUpsInputCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApInterface=ogWifiApInterface, ogWifiApClientTable=ogWifiApClientTable, ogEmdDescription=ogEmdDescription, ogCheckEntry=ogCheckEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmEventId=ogAlarmEventId, ogEmdDioType=ogEmdDioType, ogUpsIndex=ogUpsIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogRpcTable=ogRpcTable, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortTable=ogSerialPortTable, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcCounter=ogRpcCounter, ogCustomNotification=ogCustomNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialNumber=ogSerialNumber, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserEntry=ogHostUserEntry, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsCounter=ogUpsCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApEntry=ogWifiApEntry, ogHostIpV4Address=ogHostIpV4Address, ogRpcDescription=ogRpcDescription, ogHostServiceType=ogHostServiceType, ogSerialPortParity=ogSerialPortParity, ogSerialUserNotification=ogSerialUserNotification, ogAlarmDevice=ogAlarmDevice, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortMode=ogSerialPortMode, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEntry=ogEmdEntry, ogStatus2=ogStatus2, ogCellModemConnected=ogCellModemConnected, ogWifiClientEssid=ogWifiClientEssid, ogWebUserStartTime=ogWebUserStartTime, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDTR=ogSerialPortDTR, ogCellModemApn=ogCellModemApn, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceIndex=ogHostServiceIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdEnabled=ogEmdEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckName=ogCheckName, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTable=ogEmdTable)
