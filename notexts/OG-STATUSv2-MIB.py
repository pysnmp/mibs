...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApCounter=ogWifiApCounter, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioState=ogEmdDioState, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckTable=ogCheckTable, ogCheckName=ogCheckName, ogWifiClientRssi=ogWifiClientRssi, ogUpsTemperature=ogUpsTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcTable=ogRpcTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceType=ogHostServiceType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcType=ogRpcType, ogCheckType=ogCheckType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceHost=ogHostServiceHost, ogEmdDescription=ogEmdDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsNotification=ogUpsNotification, ogRpcConnectType=ogRpcConnectType, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEntry=ogWifiClientEntry, ogAlarmCheck=ogAlarmCheck, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmSummary=ogAlarmSummary, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellApnNotification=ogCellApnNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceTable=ogHostServiceTable, ogSerialPortParity=ogSerialPortParity, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceState=ogNetInterfaceState, ogHostIpV6Address=ogHostIpV6Address, ogEmdConnectType=ogEmdConnectType, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserEntry=ogSerialUserEntry, ogCellModemVendor=ogCellModemVendor, ogAlarmEventId=ogAlarmEventId, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcEntry=ogRpcEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientTable=ogWifiApClientTable, ogCellModemCounter=ogCellModemCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserIndex=ogHostUserIndex, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsTable=ogUpsTable, ogCellModemApn=ogCellModemApn, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientInterface=ogWifiClientInterface, ogCheckIndex=ogCheckIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemModel=ogCellModemModel, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApSsid=ogWifiApSsid, ogAlarmUser=ogAlarmUser, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserLabel=ogSerialUserLabel, ogRpcName=ogRpcName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsEntry=ogUpsEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApTable=ogWifiApTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletState=ogRpcOutletState, ogHostServiceEntry=ogHostServiceEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutputNotification=ogRpcOutputNotification, ogHostTable=ogHostTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserTable=ogHostUserTable, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2Conformance=ogStatus2Conformance, ogWebUserTable=ogWebUserTable, ogUpsType=ogUpsType, ogUpsName=ogUpsName, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioType=ogEmdDioType, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserNotification=ogHostUserNotification, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceName=ogNetInterfaceName, ogCellModemTemperature=ogCellModemTemperature, ogHostUserHost=ogHostUserHost, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogUpsIndex=ogUpsIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemEntry=ogCellModemEntry, ogRpcDescription=ogRpcDescription, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserStartTime=ogWebUserStartTime, ogHostUserHostName=ogHostUserHostName, ogCheckEntry=ogCheckEntry, ogWifiApTxPower=ogWifiApTxPower, ogEmdName=ogEmdName, ogRpcOutletTable=ogRpcOutletTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserNotification=ogWebUserNotification, ogSerialPortTable=ogSerialPortTable, ogAlarmDevice=ogAlarmDevice, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServicePort=ogHostServicePort, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostEntry=ogHostEntry, ogAlarmState=ogAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2=ogStatus2, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemEnabled=ogCellModemEnabled, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioName=ogEmdDioName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceTable=ogNetInterfaceTable, ogMibNotifications=ogMibNotifications, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellSignalNotification=ogCellSignalNotification, ogCustomNotification=ogCustomNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserTable=ogSerialUserTable, ogCellModemIndex=ogCellModemIndex, ogEmdDioTable=ogEmdDioTable, ogCellModemTable=ogCellModemTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserName=ogSerialUserName, ogWebUserIndex=ogWebUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdEntry=ogEmdEntry, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApInterface=ogWifiApInterface, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsDescription=ogUpsDescription, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletName=ogRpcOutletName, ogHostServiceNotification=ogHostServiceNotification, ogSystem=ogSystem, ogEmdIndex=ogEmdIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2Compliances=ogStatus2Compliances)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsHumidity=ogUpsHumidity, ogAlarm=ogAlarm, ogStatus2Groups=ogStatus2Groups, ogEmdTable=ogEmdTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmName=ogAlarmName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApEntry=ogWifiApEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserPort=ogSerialUserPort, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellTowerNotification=ogCellTowerNotification, ogWebUserName=ogWebUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientIndex=ogWifiClientIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserName=ogHostUserName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsState=ogUpsState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcIndex=ogRpcIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmInstance=ogAlarmInstance, ogAlarmType=ogAlarmType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApIndex=ogWifiApIndex, ogUpsCounter=ogUpsCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserEntry=ogWebUserEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserEntry=ogHostUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIndex=ogHostIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcCounter=ogRpcCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialNumber=ogSerialNumber, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostName=ogHostName)
