...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioNotification=ogEmdDioNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDescription=ogEmdDescription, ogRpcIndex=ogRpcIndex, ogHostServiceNotification=ogHostServiceNotification, ogWifiApCounter=ogWifiApCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcEntry=ogRpcEntry, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortIndex=ogSerialPortIndex, ogUpsNotification=ogUpsNotification, ogWifiClientTable=ogWifiClientTable, ogAlarmState=ogAlarmState, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsEntry=ogUpsEntry, ogHostIpV4Address=ogHostIpV4Address, ogEmdIndex=ogEmdIndex, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckName=ogCheckName, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioEntry=ogEmdDioEntry, ogCellDataNotification=ogCellDataNotification, ogAlarmSummary=ogAlarmSummary, ogWifiClientCounter=ogWifiClientCounter, ogCellModemRegistered=ogCellModemRegistered, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckType=ogCheckType, ogWifiApEnabled=ogWifiApEnabled, ogHostUserName=ogHostUserName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogHostName=ogHostName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcType=ogRpcType, ogCellModemEntry=ogCellModemEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserName=ogSerialUserName, ogCheckTable=ogCheckTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientApMac=ogWifiClientApMac, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsName=ogUpsName, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogCellTowerNotification=ogCellTowerNotification, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserTable=ogHostUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmName=ogAlarmName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogMibNotifications=ogMibNotifications, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckResolveActions=ogCheckResolveActions, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellMessageNotification=ogCellMessageNotification, ogCellModemVendor=ogCellModemVendor, ogHostServicePort=ogHostServicePort, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogStatus2Compliance=ogStatus2Compliance, ogStatus2=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogSerialUserStartTime=ogSerialUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioName=ogEmdDioName, ogUpsState=ogUpsState, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserEntry=ogHostUserEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletTable=ogRpcOutletTable, ogRpcCounter=ogRpcCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceName=ogCheckDeviceName, ogCheckResetTimeout=ogCheckResetTimeout, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsIndex=ogUpsIndex, ogHostUserAddress=ogHostUserAddress, ogAlarmUser=ogAlarmUser, ogStatus2Groups=ogStatus2Groups, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioCounter=ogEmdDioCounter, ogSerialNumber=ogSerialNumber, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostPingNotification=ogHostPingNotification, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogUpsTable=ogUpsTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsCounter=ogUpsCounter, ogCheckEntry=ogCheckEntry, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletName=ogRpcOutletName, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortRTS=ogSerialPortRTS, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserIndex=ogHostUserIndex, ogUpsOutputPower=ogUpsOutputPower, ogEmdConnectType=ogEmdConnectType, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsDescription=ogUpsDescription, ogEmdDioState=ogEmdDioState, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDSR=ogSerialPortDSR, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserHost=ogHostUserHost, ogHostUserNotification=ogHostUserNotification, ogRpcName=ogRpcName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceEntry=ogHostServiceEntry, ogHostEntry=ogHostEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientIndex=ogWifiClientIndex, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyName=ogPowerSupplyName, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckIndex=ogCheckIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSystem=ogSystem, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmInstance=ogAlarmInstance, ogRpcTable=ogRpcTable, ogCellModemEnabled=ogCellModemEnabled, ogEmdEnabled=ogEmdEnabled, ogCellModemModel=ogCellModemModel, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmCheck=ogAlarmCheck, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserHostName=ogHostUserHostName, ogWifiClientInterface=ogWifiClientInterface, ogRpcDescription=ogRpcDescription, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortMode=ogSerialPortMode, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemApn=ogCellModemApn, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioType=ogEmdDioType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCustomNotification=ogCustomNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceType=ogHostServiceType, ogHostServiceTable=ogHostServiceTable, ogAlarm=ogAlarm, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemTower=ogCellModemTower, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceHost=ogHostServiceHost, ogCellModemTable=ogCellModemTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserStartTime=ogHostUserStartTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNotification=ogUpsInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortTable=ogSerialPortTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdName=ogEmdName, ogEmdDioTable=ogEmdDioTable, ogWifiApInterface=ogWifiApInterface, ogAlarmTime=ogAlarmTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParity=ogSerialPortParity, ogHostTable=ogHostTable, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsHumidity=ogUpsHumidity, ogWebUserEntry=ogWebUserEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemConnected=ogCellModemConnected, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCellSignalNotification=ogCellSignalNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientFrequency=ogWifiClientFrequency, ogStatus2Compliances=ogStatus2Compliances, ogUpsType=ogUpsType, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApTable=ogWifiApTable, ogSerialUserTable=ogSerialUserTable, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcConnectType=ogRpcConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApEntry=ogWifiApEntry, ogHostIndex=ogHostIndex, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogWebUserTable=ogWebUserTable, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserName=ogWebUserName, ogAlarmType=ogAlarmType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon)
