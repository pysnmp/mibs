...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostTable=ogHostTable, ogUpsHumidity=ogUpsHumidity, ogCellModemConnected=ogCellModemConnected, ogStatus2=ogStatus2, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIndex=ogHostIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmTime=ogAlarmTime, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEnabled=ogCellModemEnabled, ogCellModemEntry=ogCellModemEntry, ogEmdTable=ogEmdTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientEssid=ogWifiClientEssid, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApTxPower=ogWifiApTxPower, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogUpsDescription=ogUpsDescription, ogEmdDioCounter=ogEmdDioCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApIndex=ogWifiApIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsEntry=ogUpsEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortParity=ogSerialPortParity, ogAlarmInstance=ogAlarmInstance, ogWifiClientMode=ogWifiClientMode, ogSystem=ogSystem, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemModel=ogCellModemModel, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioNotification=ogEmdDioNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcIndex=ogRpcIndex, ogRpcType=ogRpcType, ogSerialPortDataBits=ogSerialPortDataBits, ogCellApnNotification=ogCellApnNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogAlarmUser=ogAlarmUser, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserNotification=ogWebUserNotification, ogUpsIndex=ogUpsIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckName=ogCheckName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserName=ogSerialUserName, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyTable=ogPowerSupplyTable, ogCellSignalNotification=ogCellSignalNotification, ogAlarmName=ogAlarmName, ogRpcName=ogRpcName, ogSerialPortEntry=ogSerialPortEntry, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmEventId=ogAlarmEventId, ogAlarm=ogAlarm, ogEmdDescription=ogEmdDescription, ogHostServicePort=ogHostServicePort, ogWifiApTable=ogWifiApTable, ogWifiClientEntry=ogWifiClientEntry, ogCellModemRegistered=ogCellModemRegistered, ogCustomNotification=ogCustomNotification, ogAlarmType=ogAlarmType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientApMac=ogWifiClientApMac, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioType=ogEmdDioType, ogRpcOutletName=ogRpcOutletName, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceType=ogNetInterfaceType, ogUpsConnectType=ogUpsConnectType, ogCellModemTable=ogCellModemTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputPower=ogUpsOutputPower, ogCheckIndex=ogCheckIndex, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceHost=ogHostServiceHost, ogSerialPortMode=ogSerialPortMode, ogRpcEntry=ogRpcEntry, ogCellModemVendor=ogCellModemVendor, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserIndex=ogHostUserIndex, ogSerialPortTable=ogSerialPortTable, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsCounter=ogUpsCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserPort=ogSerialUserPort, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioState=ogEmdDioState, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceStatus=ogHostServiceStatus, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogMibNotifications=ogMibNotifications, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostPingNotification=ogHostPingNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientAp=ogWifiApClientAp, ogWebUserTable=ogWebUserTable, ogCheckDeviceName=ogCheckDeviceName, ogRpcDescription=ogRpcDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceIndex=ogHostServiceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckType=ogCheckType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceType=ogHostServiceType, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdName=ogEmdName, ogHostEntry=ogHostEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApCounter=ogWifiApCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogRpcConnectType=ogRpcConnectType, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryState=ogUpsBatteryState, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogRpcInputNotification=ogRpcInputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserName=ogHostUserName, ogEmdEnabled=ogEmdEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserEntry=ogSerialUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialNumber=ogSerialNumber, ogUpsType=ogUpsType, ogAlarmCheck=ogAlarmCheck, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2Groups=ogStatus2Groups)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEntry=ogEmdDioEntry, PYSNMP_MODULE_ID=ogStatus2, ogWebUserName=ogWebUserName, ogHostServiceEntry=ogHostServiceEntry, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdEntry=ogEmdEntry, ogPowerSupplyName=ogPowerSupplyName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdIndex=ogEmdIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApFrequency=ogWifiApFrequency, ogCheckTable=ogCheckTable, ogRpcTable=ogRpcTable, ogWifiClientTable=ogWifiClientTable, ogHostIpV4Address=ogHostIpV4Address, ogHostUserTable=ogHostUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogStatus2Compliance=ogStatus2Compliance, ogCellModemTower=ogCellModemTower, ogWifiApEnabled=ogWifiApEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApSsid=ogWifiApSsid, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsTemperature=ogUpsTemperature, ogRpcCounter=ogRpcCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserAddress=ogHostUserAddress, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceState=ogNetInterfaceState, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsState=ogUpsState, ogUpsTable=ogUpsTable, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioTable=ogEmdDioTable, ogSerialUserTable=ogSerialUserTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsName=ogUpsName, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmDevice=ogAlarmDevice, ogHostName=ogHostName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogCellModemApn=ogCellModemApn, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserHost=ogHostUserHost, ogWifiApEntry=ogWifiApEntry, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioEmd=ogEmdDioEmd, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsNotification=ogUpsNotification)
