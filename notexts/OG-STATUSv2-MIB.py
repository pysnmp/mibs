...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckName=ogCheckName, ogCellModemApn=ogCellModemApn, ogRpcOutletTable=ogRpcOutletTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcIndex=ogRpcIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDescription=ogEmdDescription, ogAlarmEventId=ogAlarmEventId, ogWifiClientEssid=ogWifiClientEssid, ogWebUserName=ogWebUserName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRssi=ogWifiClientRssi, ogAlarmUser=ogAlarmUser, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyTable=ogPowerSupplyTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPatternNotification=ogSerialPatternNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmInstance=ogAlarmInstance, ogCheckEntry=ogCheckEntry, ogCustomNotification=ogCustomNotification, ogRpcTable=ogRpcTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioNotification=ogEmdDioNotification, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcDescription=ogRpcDescription, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceType=ogHostServiceType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsState=ogUpsState, ogRpcConnectType=ogRpcConnectType, ogWifiApEntry=ogWifiApEntry, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogHostEntry=ogHostEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserTable=ogHostUserTable, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserHost=ogHostUserHost, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemTable=ogCellModemTable, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserPort=ogSerialUserPort, ogHostUserAddress=ogHostUserAddress, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientCounter=ogWifiClientCounter, ogEmdTable=ogEmdTable, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemVendor=ogCellModemVendor, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserTable=ogSerialUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserStartTime=ogSerialUserStartTime, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemEntry=ogCellModemEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsCounter=ogUpsCounter, ogEmdDioCounter=ogEmdDioCounter, ogCheckIndex=ogCheckIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogFirmwareVersion=ogFirmwareVersion, ogAlarmLogTable=ogAlarmLogTable, ogCheckType=ogCheckType, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogMibNotifications=ogMibNotifications, ogUpsTable=ogUpsTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDCD=ogSerialPortDCD, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserName=ogHostUserName, ogEmdName=ogEmdName, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmName=ogAlarmName, ogEmdEnabled=ogEmdEnabled, ogStatus2=ogStatus2, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioTable=ogEmdDioTable, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserEntry=ogWebUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTower=ogCellModemTower, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientTable=ogWifiApClientTable, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostTable=ogHostTable, ogCellModemIndex=ogCellModemIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortMode=ogSerialPortMode, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcName=ogRpcName, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcCounter=ogRpcCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserHostName=ogHostUserHostName, ogWifiApInterface=ogWifiApInterface, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceEntry=ogHostServiceEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientAp=ogWifiApClientAp, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureName=ogEmdTemperatureName, ogSystem=ogSystem, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioState=ogEmdDioState, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemModel=ogCellModemModel, ogWifiClientTable=ogWifiClientTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdEntry=ogEmdEntry, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApIndex=ogWifiApIndex, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceTable=ogHostServiceTable, ogSerialUserEntry=ogSerialUserEntry, ogHostName=ogHostName, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserStartTime=ogWebUserStartTime, ogAlarmType=ogAlarmType, ogWifiClientMode=ogWifiClientMode, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortTable=ogSerialPortTable, ogCellModemEnabled=ogCellModemEnabled, ogUpsDescription=ogUpsDescription, ogHostServiceCounter=ogHostServiceCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletState=ogRpcOutletState, ogHostServicePort=ogHostServicePort, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletName=ogRpcOutletName, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsName=ogUpsName, ogAlarmLogEntry=ogAlarmLogEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApSsid=ogWifiApSsid, ogEmdDioName=ogEmdDioName, ogHostUserEntry=ogHostUserEntry, ogWifiClientApMac=ogWifiClientApMac, ogHostIndex=ogHostIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserStartTime=ogHostUserStartTime, ogWebUserTable=ogWebUserTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCellApnNotification=ogCellApnNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialNumber=ogSerialNumber, ogStatus2Groups=ogStatus2Groups, ogRpcEntry=ogRpcEntry, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsEntry=ogUpsEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarm=ogAlarm, ogEmdIndex=ogEmdIndex, ogCellTowerNotification=ogCellTowerNotification, ogAlarmState=ogAlarmState, ogAlarmDevice=ogAlarmDevice, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2Compliance=ogStatus2Compliance, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsIndex=ogUpsIndex, ogUpsNotification=ogUpsNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsType=ogUpsType, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserName=ogSerialUserName, ogEmdConnectType=ogEmdConnectType, ogHostUserNotification=ogHostUserNotification, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogRpcType=ogRpcType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortParity=ogSerialPortParity, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyName=ogPowerSupplyName, ogCellModemCounter=ogCellModemCounter, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceStatus=ogHostServiceStatus, ogAlarmTime=ogAlarmTime, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryState=ogUpsBatteryState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApTable=ogWifiApTable, ogHostIpV4Address=ogHostIpV4Address, ogCheckTable=ogCheckTable, ogUpsInputNotification=ogUpsInputNotification)
