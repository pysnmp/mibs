...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmEventId=ogAlarmEventId, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckName=ogCheckName, ogEmdDioState=ogEmdDioState, ogCellApnNotification=ogCellApnNotification, ogUpsType=ogUpsType, ogCheckTable=ogCheckTable, ogHostUserName=ogHostUserName, ogRpcOutletLoad=ogRpcOutletLoad, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostPingNotification=ogHostPingNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientMode=ogWifiClientMode, ogUpsOutputPower=ogUpsOutputPower, ogAlarmTime=ogAlarmTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserIndex=ogSerialUserIndex, ogCheckIndex=ogCheckIndex, ogCheckType=ogCheckType, ogRpcEntry=ogRpcEntry, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsName=ogUpsName, ogAlarmType=ogAlarmType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModem3gRssi=ogCellModem3gRssi, ogCustomNotification=ogCustomNotification, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdName=ogEmdName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletState=ogRpcOutletState, ogCellDataNotification=ogCellDataNotification, ogCellModemRegistered=ogCellModemRegistered, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcCounter=ogRpcCounter, ogAlarmUser=ogAlarmUser, PYSNMP_MODULE_ID=ogStatus2, ogWebUserIndex=ogWebUserIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmSummary=ogAlarmSummary, ogRpcIndex=ogRpcIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserNotification=ogWebUserNotification, ogWifiClientIndex=ogWifiClientIndex, ogHostTable=ogHostTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmInstance=ogAlarmInstance, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogHostUserEntry=ogHostUserEntry, ogSerialNumber=ogSerialNumber, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Compliance=ogStatus2Compliance, ogUpsEntry=ogUpsEntry, ogSerialPortMode=ogSerialPortMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdEntry=ogEmdEntry, ogEmdHumidityName=ogEmdHumidityName, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserPort=ogSerialUserPort, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserAddress=ogHostUserAddress, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNotification=ogUpsInputNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogBasicStatusGroup=ogBasicStatusGroup, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckResolveActions=ogCheckResolveActions, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDescription=ogEmdDescription, ogSerialUserTable=ogSerialUserTable, ogWebUserTable=ogWebUserTable, ogHostUserIndex=ogHostUserIndex, ogAlarmState=ogAlarmState, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApEntry=ogWifiApEntry, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcName=ogRpcName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletIndex=ogRpcOutletIndex, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTower=ogCellModemTower, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputNotification=ogRpcInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdIndex=ogEmdIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdEnabled=ogEmdEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApIndex=ogWifiApIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApSsid=ogWifiApSsid, ogSerialPortParity=ogSerialPortParity, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogHostEntry=ogHostEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemModel=ogCellModemModel, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Groups=ogStatus2Groups, ogHostIpV4Address=ogHostIpV4Address, ogMibNotifications=ogMibNotifications, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckEntry=ogCheckEntry, ogAlarmDevice=ogAlarmDevice, ogEmdDioType=ogEmdDioType, ogFirmwareVersion=ogFirmwareVersion, ogHostUserNotification=ogHostUserNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserHostName=ogHostUserHostName, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcDescription=ogRpcDescription, ogWifiApTable=ogWifiApTable, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserEntry=ogSerialUserEntry, ogUpsTable=ogUpsTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemVendor=ogCellModemVendor, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortTable=ogSerialPortTable, ogWifiApEnabled=ogWifiApEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceType=ogHostServiceType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcTable=ogRpcTable, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserTable=ogHostUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServicePort=ogHostServicePort, ogAlarm=ogAlarm, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserEntry=ogWebUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioDescription=ogEmdDioDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsDescription=ogUpsDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientApMac=ogWifiClientApMac, ogAlarmName=ogAlarmName, ogUpsCounter=ogUpsCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientLinkQuality=ogWifiClientLinkQuality)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogTable=ogAlarmLogTable, ogEmdDioName=ogEmdDioName, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHost=ogHostUserHost, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioTable=ogEmdDioTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceNotification=ogHostServiceNotification, ogRpcType=ogRpcType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserLabel=ogSerialUserLabel, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientTable=ogWifiClientTable, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientInterface=ogWifiClientInterface, ogUpsState=ogUpsState, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemIndex=ogCellModemIndex, ogCellModemApn=ogCellModemApn, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsIndex=ogUpsIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcConnectType=ogRpcConnectType, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTable=ogEmdTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceHost=ogHostServiceHost, ogHostServiceCounter=ogHostServiceCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostIndex=ogHostIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsNotification=ogUpsNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostName=ogHostName, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortDSR=ogSerialPortDSR, ogAlarmCheck=ogAlarmCheck, ogWebUserName=ogWebUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserName=ogSerialUserName, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSystem=ogSystem)
