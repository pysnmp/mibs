...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTemperature=ogUpsTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsTable=ogUpsTable, ogUpsCounter=ogUpsCounter, ogUpsBatteryState=ogUpsBatteryState, ogWebUserIndex=ogWebUserIndex, ogEmdDescription=ogEmdDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdEntry=ogEmdEntry, ogCheckName=ogCheckName, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemCounter=ogCellModemCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApInterface=ogWifiApInterface, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTable=ogWifiApClientTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceType=ogHostServiceType, ogCheckEntry=ogCheckEntry, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioName=ogEmdDioName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioEntry=ogEmdDioEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserHost=ogHostUserHost, ogEmdIndex=ogEmdIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserName=ogHostUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmUser=ogAlarmUser, ogEmdDioTable=ogEmdDioTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserName=ogWebUserName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostIndex=ogHostIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyName=ogPowerSupplyName, ogHostName=ogHostName, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceState=ogNetInterfaceState, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmInstance=ogAlarmInstance, ogRpcTable=ogRpcTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostEntry=ogHostEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsName=ogUpsName, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletState=ogRpcOutletState, ogCheckIndex=ogCheckIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApTable=ogWifiApTable, ogEmdDioDirection=ogEmdDioDirection, ogAlarmType=ogAlarmType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2Groups=ogStatus2Groups, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceEntry=ogHostServiceEntry, ogHostUserAddress=ogHostUserAddress, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserHostName=ogHostUserHostName, ogHostTable=ogHostTable, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientTable=ogWifiClientTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsState=ogUpsState, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsDescription=ogUpsDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApCounter=ogWifiApCounter, ogHostUserTable=ogHostUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogMibNotifications=ogMibNotifications, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTable=ogCellModemTable, ogAlarmState=ogAlarmState, ogWifiClientIndex=ogWifiClientIndex, ogEmdConnectType=ogEmdConnectType, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellApnNotification=ogCellApnNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientRssi=ogWifiApClientRssi, ogCustomNotification=ogCustomNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceType=ogNetInterfaceType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcIndex=ogRpcIndex, ogCellModemIMSI=ogCellModemIMSI, ogWifiApIndex=ogWifiApIndex, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyTable=ogPowerSupplyTable, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcEntry=ogRpcEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckResolveActions=ogCheckResolveActions, ogCellModemVendor=ogCellModemVendor, ogCheckTable=ogCheckTable, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmEventId=ogAlarmEventId, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserName=ogSerialUserName, ogEmdDioType=ogEmdDioType, ogCurrentAlarmName=ogCurrentAlarmName, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioState=ogEmdDioState, ogSerialPortMode=ogSerialPortMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletTable=ogRpcOutletTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPortDCD=ogSerialPortDCD, ogCellModemEnabled=ogCellModemEnabled, ogRpcDescription=ogRpcDescription, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApEntry=ogWifiApEntry, ogHostUserNotification=ogHostUserNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsIndex=ogUpsIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRssi=ogWifiClientRssi, ogAlarmLogTable=ogAlarmLogTable, ogHostUserEntry=ogHostUserEntry, ogEmdTable=ogEmdTable, ogUpsConnectType=ogUpsConnectType, ogHostIpV4Address=ogHostIpV4Address, ogCellMessageNotification=ogCellMessageNotification, ogUpsNotification=ogUpsNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsEntry=ogUpsEntry, ogStatus2Conformance=ogStatus2Conformance, ogAlarm=ogAlarm, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientMac=ogWifiApClientMac, ogRpcInputNotification=ogRpcInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemTower=ogCellModemTower, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcConnectType=ogRpcConnectType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmName=ogAlarmName, ogWifiClientCounter=ogWifiClientCounter, ogAlarmSummary=ogAlarmSummary, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsType=ogUpsType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserPort=ogSerialUserPort, ogSerialPortDSR=ogSerialPortDSR, ogWebUserStartTime=ogWebUserStartTime, ogAlarmDevice=ogAlarmDevice, ogWebUserNotification=ogWebUserNotification, ogEmdDioDescription=ogEmdDioDescription, ogRpcType=ogRpcType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServicePort=ogHostServicePort, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceNotification=ogHostServiceNotification, ogSystem=ogSystem, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdEnabled=ogEmdEnabled, ogCellDataNotification=ogCellDataNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortEntry=ogSerialPortEntry, ogCellModemApn=ogCellModemApn, ogStatus2=ogStatus2, ogAlarmCheck=ogAlarmCheck, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserTable=ogWebUserTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServiceCounter=ogHostServiceCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientInterface=ogWifiClientInterface, ogWifiApSsid=ogWifiApSsid, ogSerialNumber=ogSerialNumber, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRegistered=ogCellModemRegistered, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdName=ogEmdName, ogCheckType=ogCheckType, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientMode=ogWifiClientMode, ogRpcOutletName=ogRpcOutletName, ogRpcName=ogRpcName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemModel=ogCellModemModel, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserIndex=ogSerialUserIndex)
