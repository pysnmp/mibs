...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserIndex=ogWebUserIndex, ogUpsState=ogUpsState, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemEntry=ogCellModemEntry, ogUpsTemperature=ogUpsTemperature, ogRpcOutletState=ogRpcOutletState, ogHostPingNotification=ogHostPingNotification, ogEmdDioTable=ogEmdDioTable, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortLogLevel=ogSerialPortLogLevel, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortIndex=ogSerialPortIndex, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogAlarmState=ogAlarmState, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserHostName=ogHostUserHostName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsHumidity=ogUpsHumidity, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemModel=ogCellModemModel, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcDescription=ogRpcDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserStartTime=ogHostUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialNumber=ogSerialNumber, ogHostServiceNotification=ogHostServiceNotification, ogCheckTable=ogCheckTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmType=ogAlarmType, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemVendor=ogCellModemVendor, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmEventId=ogAlarmEventId, ogRpcEntry=ogRpcEntry, ogWifiApEntry=ogWifiApEntry, ogUpsType=ogUpsType, ogUpsDescription=ogUpsDescription, ogRpcIndex=ogRpcIndex, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Groups=ogStatus2Groups, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcType=ogRpcType, ogUpsNotification=ogUpsNotification, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogEmdDioName=ogEmdDioName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserName=ogHostUserName, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmName=ogAlarmName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmSummary=ogAlarmSummary, ogUpsTable=ogUpsTable, ogWifiClientInterface=ogWifiClientInterface, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogRpcInputNotification=ogRpcInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckName=ogCheckName, ogSerialPortMode=ogSerialPortMode, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcName=ogRpcName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientTable=ogWifiClientTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientCounter=ogWifiClientCounter, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemApn=ogCellModemApn, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2=ogStatus2, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemIndex=ogCellModemIndex, ogCellMessageNotification=ogCellMessageNotification, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSystem=ogSystem, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserPort=ogSerialUserPort, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserIndex=ogHostUserIndex, ogEmdDioType=ogEmdDioType, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsEntry=ogUpsEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogHostName=ogHostName, ogCellModemNetwork=ogCellModemNetwork, ogCheckIndex=ogCheckIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogCellDataNotification=ogCellDataNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCustomNotification=ogCustomNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2Compliance=ogStatus2Compliance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApInterface=ogWifiApInterface, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceType=ogHostServiceType, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckType=ogCheckType, ogSerialPortTable=ogSerialPortTable, ogWebUserTable=ogWebUserTable, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemTable=ogCellModemTable, ogAlarmUser=ogAlarmUser, ogUpsIndex=ogUpsIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletNotification=ogRpcOutletNotification, ogHostEntry=ogHostEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceHost=ogHostServiceHost, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogIndex=ogAlarmLogIndex, ogCellSignalNotification=ogCellSignalNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogSerialUserTable=ogSerialUserTable, ogCellApnNotification=ogCellApnNotification, ogHostServicePort=ogHostServicePort, ogWifiApSsid=ogWifiApSsid, ogSerialUserName=ogSerialUserName, ogEmdTable=ogEmdTable, ogWifiApCounter=ogWifiApCounter, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioNotification=ogEmdDioNotification, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDTR=ogSerialPortDTR, ogHostUserHost=ogHostUserHost, ogAlarmTime=ogAlarmTime, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNotification=ogUpsInputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortRTS=ogSerialPortRTS, ogHostIndex=ogHostIndex, ogSerialUserIndex=ogSerialUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogEmdName=ogEmdName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmDevice=ogAlarmDevice, ogRpcCounter=ogRpcCounter, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdConnectType=ogEmdConnectType, ogEmdDescription=ogEmdDescription, ogAlarm=ogAlarm, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdEntry=ogEmdEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceTable=ogHostServiceTable, ogEmdDioDirection=ogEmdDioDirection, ogMibNotifications=ogMibNotifications, ogEmdDioState=ogEmdDioState, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserTable=ogHostUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogRpcTable=ogRpcTable, ogUpsConnectType=ogUpsConnectType, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApTable=ogWifiApTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserName=ogWebUserName, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioDescription=ogEmdDioDescription, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckEntry=ogCheckEntry, ogHostTable=ogHostTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmState=ogCurrentAlarmState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsName=ogUpsName, ogRpcConnectType=ogRpcConnectType, ogEmdIndex=ogEmdIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceEntry=ogCheckDeviceEntry)
