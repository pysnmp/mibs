...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortRTS=ogSerialPortRTS, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryState=ogUpsBatteryState, ogHostTable=ogHostTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientTable=ogWifiClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmState=ogAlarmState, ogCellApnNotification=ogCellApnNotification, ogRpcCounter=ogRpcCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdName=ogEmdName, ogWifiApClientTable=ogWifiApClientTable, ogUpsHumidity=ogUpsHumidity, ogCellModemEntry=ogCellModemEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiApIndex=ogWifiApIndex, ogWifiClientMode=ogWifiClientMode, ogHostServiceHost=ogHostServiceHost, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientApMac=ogWifiClientApMac, ogEmdEnabled=ogEmdEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserEntry=ogWebUserEntry, ogUpsTable=ogUpsTable, ogCellModemNetwork=ogCellModemNetwork, ogAlarmEventId=ogAlarmEventId, ogUpsConnectType=ogUpsConnectType, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogHostIpV6Address=ogHostIpV6Address, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcIndex=ogRpcIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserTable=ogHostUserTable, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientCounter=ogWifiClientCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmUser=ogAlarmUser, ogUpsIndex=ogUpsIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckIndex=ogCheckIndex, ogRpcDescription=ogRpcDescription, ogSerialUserPort=ogSerialUserPort, ogCellModemTemperature=ogCellModemTemperature, ogHostUserEntry=ogHostUserEntry, ogWifiApEntry=ogWifiApEntry, ogEmdEntry=ogEmdEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmType=ogAlarmType, ogCellMessageNotification=ogCellMessageNotification, ogCellModemVendor=ogCellModemVendor, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceStatus=ogHostServiceStatus, ogFirmwareVersion=ogFirmwareVersion, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsTemperature=ogUpsTemperature, ogCellModemRegistered=ogCellModemRegistered, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTable=ogEmdTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, PYSNMP_MODULE_ID=ogStatus2, ogCheckResolveActions=ogCheckResolveActions, ogCellModemEnabled=ogCellModemEnabled, ogCellModemApn=ogCellModemApn, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApInterface=ogWifiApInterface, ogHostUserHost=ogHostUserHost, ogEmdConnectType=ogEmdConnectType, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceEntry=ogHostServiceEntry, ogWifiApCounter=ogWifiApCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortTable=ogSerialPortTable, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientAp=ogWifiApClientAp, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemConnected=ogCellModemConnected, ogWebUserTable=ogWebUserTable, ogUpsEntry=ogUpsEntry, ogCellModemTable=ogCellModemTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserName=ogHostUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsState=ogUpsState, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioState=ogEmdDioState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsName=ogUpsName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceType=ogHostServiceType, ogHostIndex=ogHostIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogHostEntry=ogHostEntry, ogHostName=ogHostName, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogSystem=ogSystem, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServicePort=ogHostServicePort, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemModel=ogCellModemModel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcType=ogRpcType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemIndex=ogCellModemIndex, ogCheckName=ogCheckName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcName=ogRpcName, ogRpcTable=ogRpcTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceCounter=ogHostServiceCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserName=ogWebUserName, ogHostUserStartTime=ogHostUserStartTime, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApTable=ogWifiApTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserLabel=ogSerialUserLabel, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApFrequency=ogWifiApFrequency, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsNotification=ogUpsNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckTable=ogCheckTable, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNotification=ogUpsInputNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortParity=ogSerialPortParity, ogHostServiceNotification=ogHostServiceNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserIndex=ogHostUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsDescription=ogUpsDescription, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceRef=ogCheckDeviceRef, ogWebUserIndex=ogWebUserIndex, ogCellDataNotification=ogCellDataNotification, ogCellModemCounter=ogCellModemCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWebUserNotification=ogWebUserNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTower=ogCellModemTower, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCustomNotification=ogCustomNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletState=ogRpcOutletState, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRssi=ogWifiClientRssi, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmTime=ogAlarmTime, ogAlarm=ogAlarm, ogAlarmInstance=ogAlarmInstance, ogUpsCounter=ogUpsCounter, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioTable=ogEmdDioTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckType=ogCheckType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserTable=ogSerialUserTable, ogUpsType=ogUpsType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserName=ogSerialUserName, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcEntry=ogRpcEntry, ogAlarmName=ogAlarmName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioName=ogEmdDioName, ogRpcOutletName=ogRpcOutletName, ogStatus2=ogStatus2, ogEmdDioDescription=ogEmdDioDescription, ogCheckEntry=ogCheckEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryVoltage=ogUpsBatteryVoltage)
