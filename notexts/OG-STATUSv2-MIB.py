...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioCounter=ogEmdDioCounter, ogCheckIndex=ogCheckIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsState=ogUpsState, ogRpcOutletName=ogRpcOutletName, ogCellDataNotification=ogCellDataNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemModel=ogCellModemModel, ogSerialUserIndex=ogSerialUserIndex, ogRpcTable=ogRpcTable, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserName=ogHostUserName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioState=ogEmdDioState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarm=ogAlarm, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemApn=ogCellModemApn, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSystem=ogSystem, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckTable=ogCheckTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortParity=ogSerialPortParity, ogHostUserNotification=ogHostUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortMode=ogSerialPortMode, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmEventId=ogAlarmEventId, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogMibNotifications=ogMibNotifications, ogEmdEnabled=ogEmdEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceTable=ogHostServiceTable, ogWifiApSsid=ogWifiApSsid, ogAlarmTime=ogAlarmTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsTable=ogUpsTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIndex=ogWifiApIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmName=ogAlarmName, ogCellModemTower=ogCellModemTower, ogUpsNotification=ogUpsNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserEntry=ogWebUserEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioNotification=ogEmdDioNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApTable=ogWifiApTable, ogRpcName=ogRpcName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServicePort=ogHostServicePort, ogRpcCounter=ogRpcCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceHost=ogHostServiceHost, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserTable=ogSerialUserTable, ogCellModemIndex=ogCellModemIndex, ogCheckType=ogCheckType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Groups=ogStatus2Groups, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceType=ogHostServiceType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostName=ogHostName, ogCellModemEntry=ogCellModemEntry, ogCustomNotification=ogCustomNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsName=ogUpsName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserName=ogWebUserName, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserTable=ogWebUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmState=ogAlarmState, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcType=ogRpcType, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApEnabled=ogWifiApEnabled, ogUpsConnectType=ogUpsConnectType, ogAlarmType=ogAlarmType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletState=ogRpcOutletState, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientCounter=ogWifiClientCounter, ogHostUserHost=ogHostUserHost, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsIndex=ogUpsIndex, ogEmdDioTable=ogEmdDioTable, ogHostUserTable=ogHostUserTable, ogNetInterfaceName=ogNetInterfaceName, ogCellModemTable=ogCellModemTable, ogEmdDioEntry=ogEmdDioEntry, ogWifiApTxPower=ogWifiApTxPower, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortCTS=ogSerialPortCTS, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioDirection=ogEmdDioDirection, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureName=ogEmdTemperatureName, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcEntry=ogRpcEntry, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmDevice=ogAlarmDevice, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioEmd=ogEmdDioEmd, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserAddress=ogHostUserAddress, ogStatus2=ogStatus2, ogEmdEntry=ogEmdEntry, ogUpsType=ogUpsType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellApnNotification=ogCellApnNotification, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyName=ogPowerSupplyName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApCounter=ogWifiApCounter, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcDescription=ogRpcDescription, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostEntry=ogHostEntry, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserEntry=ogSerialUserEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemConnected=ogCellModemConnected, ogAlarmInstance=ogAlarmInstance, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsCounter=ogUpsCounter, ogUpsEntry=ogUpsEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioName=ogEmdDioName, ogAlarmLogTable=ogAlarmLogTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputLoad=ogUpsOutputLoad, ogRpcIndex=ogRpcIndex, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdIndex=ogEmdIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletTable=ogRpcOutletTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCheck=ogAlarmCheck, ogCheckEntry=ogCheckEntry, ogHostIpV4Address=ogHostIpV4Address, ogEmdDescription=ogEmdDescription, ogWifiApEntry=ogWifiApEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostTable=ogHostTable, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Conformance=ogStatus2Conformance, ogHostIndex=ogHostIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckName=ogCheckName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsDescription=ogUpsDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioType=ogEmdDioType, ogEmdTable=ogEmdTable, ogSerialUserName=ogSerialUserName, ogSerialNumber=ogSerialNumber, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserNotification=ogWebUserNotification, ogEmdConnectType=ogEmdConnectType, ogSerialUserLabel=ogSerialUserLabel, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcConnectType=ogRpcConnectType, ogAlarmUser=ogAlarmUser, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsHumidity=ogUpsHumidity, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserNotification=ogSerialUserNotification, ogUpsTemperature=ogUpsTemperature, ogCellModemEnabled=ogCellModemEnabled, ogEmdName=ogEmdName, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceEntry=ogHostServiceEntry, ogHostUserStartTime=ogHostUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification)
