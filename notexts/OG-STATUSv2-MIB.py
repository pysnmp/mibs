...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioTable=ogEmdDioTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserIndex=ogHostUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdName=ogEmdName, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckIndex=ogCheckIndex, ogAlarmEventId=ogAlarmEventId, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcConnectType=ogRpcConnectType, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserPort=ogSerialUserPort, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDSR=ogSerialPortDSR, ogWifiApEntry=ogWifiApEntry, ogStatus2=ogStatus2, ogCellModemCounter=ogCellModemCounter, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApSsid=ogWifiApSsid, ogStatus2Compliance=ogStatus2Compliance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsEntry=ogUpsEntry, ogHostServiceTable=ogHostServiceTable, ogCellModemRegistered=ogCellModemRegistered, ogUpsCounter=ogUpsCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientApMac=ogWifiClientApMac, ogStatus2Groups=ogStatus2Groups, ogHostServiceCounter=ogHostServiceCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceType=ogHostServiceType, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserIndex=ogWebUserIndex, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioNotification=ogEmdDioNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceState=ogNetInterfaceState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogRpcEntry=ogRpcEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserName=ogSerialUserName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdEnabled=ogEmdEnabled, ogAlarmName=ogAlarmName, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcIndex=ogRpcIndex, ogHostEntry=ogHostEntry, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmType=ogAlarmType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemEntry=ogCellModemEntry, ogCheckName=ogCheckName, ogSystem=ogSystem, ogHostTable=ogHostTable, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsState=ogUpsState, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserAddress=ogHostUserAddress, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogMibNotifications=ogMibNotifications, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortTable=ogSerialPortTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserName=ogWebUserName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioName=ogEmdDioName, ogCheckType=ogCheckType, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcTable=ogRpcTable, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletName=ogRpcOutletName, ogRpcName=ogRpcName, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioType=ogEmdDioType, ogSerialUserTable=ogSerialUserTable, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckTable=ogCheckTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApCounter=ogWifiApCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserEntry=ogHostUserEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcCounter=ogRpcCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApInterface=ogWifiApInterface, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostPingNotification=ogHostPingNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortRTS=ogSerialPortRTS, ogAlarmCheck=ogAlarmCheck, ogUpsTemperature=ogUpsTemperature, ogAlarmLogTable=ogAlarmLogTable, ogWifiApTable=ogWifiApTable, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientTable=ogWifiClientTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserHostName=ogHostUserHostName, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceHost=ogHostServiceHost, ogUpsIndex=ogUpsIndex, ogWifiApFrequency=ogWifiApFrequency, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemTemperature=ogCellModemTemperature, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsConnectType=ogUpsConnectType, ogSerialPortMode=ogSerialPortMode, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsType=ogUpsType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsTable=ogUpsTable, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioCounter=ogEmdDioCounter, ogCheckEntry=ogCheckEntry, ogRpcDescription=ogRpcDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApEnabled=ogWifiApEnabled, ogHostUserTable=ogHostUserTable, ogNetInterfaceName=ogNetInterfaceName, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientAp=ogWifiApClientAp, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmTime=ogAlarmTime, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsNotification=ogUpsNotification, ogCellDataNotification=ogCellDataNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletNotification=ogRpcOutletNotification, ogHostName=ogHostName, ogEmdIndex=ogEmdIndex, ogFirmwareVersion=ogFirmwareVersion)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemApn=ogCellModemApn, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTable=ogCellModemTable, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsDescription=ogUpsDescription, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryState=ogUpsBatteryState, ogEmdDescription=ogEmdDescription, ogEmdTable=ogEmdTable, ogCellApnNotification=ogCellApnNotification, ogEmdEntry=ogEmdEntry, ogSerialPortCTS=ogSerialPortCTS, ogWebUserEntry=ogWebUserEntry, ogAlarmUser=ogAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIpV6Address=ogHostIpV6Address, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarm=ogAlarm, ogCellModemTower=ogCellModemTower, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserStartTime=ogWebUserStartTime, ogWifiApIndex=ogWifiApIndex, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsName=ogUpsName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmInstance=ogAlarmInstance, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCustomNotification=ogCustomNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserTable=ogWebUserTable, ogSerialNumber=ogSerialNumber, ogHostUserName=ogHostUserName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemIndex=ogCellModemIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioState=ogEmdDioState, ogCellModemModel=ogCellModemModel, ogHostIndex=ogHostIndex, ogAlarmState=ogAlarmState, ogWebUserNotification=ogWebUserNotification, ogEmdConnectType=ogEmdConnectType, ogCellModemConnected=ogCellModemConnected, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletState=ogRpcOutletState)
