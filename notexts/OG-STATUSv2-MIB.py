...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsNotification=ogUpsNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientTable=ogWifiClientTable, ogCustomNotification=ogCustomNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserHost=ogHostUserHost, ogAlarmDevice=ogAlarmDevice, ogSerialPortEntry=ogSerialPortEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApSsid=ogWifiApSsid, ogRpcOutletState=ogRpcOutletState, ogWifiClientApMac=ogWifiClientApMac, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApEntry=ogWifiApEntry, ogEmdEntry=ogEmdEntry, ogWifiApInterface=ogWifiApInterface, ogWifiApTxPower=ogWifiApTxPower, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellApnNotification=ogCellApnNotification, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApIndex=ogWifiApIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmType=ogAlarmType, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioTable=ogEmdDioTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Compliance=ogStatus2Compliance, ogAlarm=ogAlarm, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemConnected=ogCellModemConnected, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientInterface=ogWifiClientInterface, ogStatus2=ogStatus2, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialNumber=ogSerialNumber, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserNotification=ogSerialUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsCounter=ogUpsCounter, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceCounter=ogHostServiceCounter, ogAlarmName=ogAlarmName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckIndex=ogCheckIndex, ogHostUserEntry=ogHostUserEntry, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServicePort=ogHostServicePort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientMode=ogWifiClientMode, ogCellModemCounter=ogCellModemCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortParity=ogSerialPortParity, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioType=ogEmdDioType, ogUpsEntry=ogUpsEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserNotification=ogWebUserNotification, ogHostEntry=ogHostEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmCheck=ogAlarmCheck, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmSummary=ogAlarmSummary, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientIndex=ogWifiClientIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckTable=ogCheckTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceState=ogNetInterfaceState, ogCheckType=ogCheckType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, PYSNMP_MODULE_ID=ogStatus2, ogEmdConnectType=ogEmdConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserStartTime=ogWebUserStartTime, ogRpcDescription=ogRpcDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsDescription=ogUpsDescription, ogCellDataNotification=ogCellDataNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientAp=ogWifiApClientAp, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcIndex=ogRpcIndex, ogCheckEntry=ogCheckEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserName=ogWebUserName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemTable=ogCellModemTable, ogHostServiceNotification=ogHostServiceNotification, ogAlarmState=ogAlarmState, ogSerialUserPort=ogSerialUserPort, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyName=ogPowerSupplyName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmUser=ogAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogHostIndex=ogHostIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserHostName=ogHostUserHostName, ogWifiClientEntry=ogWifiClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcType=ogRpcType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTower=ogCellModemTower, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdName=ogEmdName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSystem=ogSystem, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV4Address=ogHostIpV4Address, ogCellModemModel=ogCellModemModel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsTable=ogUpsTable, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceHost=ogHostServiceHost, ogWebUserTable=ogWebUserTable, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemVendor=ogCellModemVendor, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsState=ogUpsState, ogStatus2Groups=ogStatus2Groups, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcEntry=ogRpcEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsName=ogUpsName, ogWifiApCounter=ogWifiApCounter, ogHostUserName=ogHostUserName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcConnectType=ogRpcConnectType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletName=ogRpcOutletName, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTable=ogEmdTable, ogHostName=ogHostName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcCounter=ogRpcCounter, ogUpsIndex=ogUpsIndex, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsConnectType=ogUpsConnectType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostPingNotification=ogHostPingNotification, ogUpsType=ogUpsType, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdIndex=ogEmdIndex, ogUpsBatteryState=ogUpsBatteryState, ogWifiApTable=ogWifiApTable, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcTable=ogRpcTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortCTS=ogSerialPortCTS, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellModemIMSI=ogCellModemIMSI, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDSR=ogSerialPortDSR, ogCheckName=ogCheckName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcName=ogRpcName, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletTable=ogRpcOutletTable, ogEmdDescription=ogEmdDescription, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogMibNotifications=ogMibNotifications, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioState=ogEmdDioState, ogAlarmInstance=ogAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemApn=ogCellModemApn, ogHostServiceType=ogHostServiceType, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdEnabled=ogEmdEnabled, ogHostTable=ogHostTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTable=ogWifiApClientTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserIndex=ogWebUserIndex, ogSerialUserName=ogSerialUserName, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryRunTime=ogUpsBatteryRunTime)
