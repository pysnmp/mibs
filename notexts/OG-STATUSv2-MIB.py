...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmEventId=ogAlarmEventId, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsType=ogUpsType, ogUpsInputVoltage=ogUpsInputVoltage, ogHostEntry=ogHostEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmTime=ogAlarmTime, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemCounter=ogCellModemCounter, ogMibNotifications=ogMibNotifications, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserName=ogHostUserName, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApCounter=ogWifiApCounter, ogCheckName=ogCheckName, ogRpcTable=ogRpcTable, ogWifiApEntry=ogWifiApEntry, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserEntry=ogWebUserEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRssi=ogWifiClientRssi, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcEntry=ogRpcEntry, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcInputNotification=ogRpcInputNotification, ogEmdTable=ogEmdTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserPort=ogSerialUserPort, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserNotification=ogSerialUserNotification, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcConnectType=ogRpcConnectType, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmType=ogAlarmType, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsCounter=ogUpsCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmLogIndex=ogAlarmLogIndex, ogHostIpV6Address=ogHostIpV6Address, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmName=ogAlarmName, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserHost=ogHostUserHost, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2=ogStatus2, ogHostServiceType=ogHostServiceType, ogRpcOutletState=ogRpcOutletState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceTable=ogHostServiceTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsNotification=ogUpsNotification, ogCheckResolveActions=ogCheckResolveActions, ogEmdEntry=ogEmdEntry, ogRpcCounter=ogRpcCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdName=ogEmdName, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserIndex=ogWebUserIndex, ogEmdDioState=ogEmdDioState, ogAlarmSummary=ogAlarmSummary, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcDescription=ogRpcDescription, ogSerialPortTable=ogSerialPortTable, ogWifiClientEssid=ogWifiClientEssid, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemTable=ogCellModemTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemConnected=ogCellModemConnected, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserStartTime=ogHostUserStartTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortParity=ogSerialPortParity, ogCellSignalNotification=ogCellSignalNotification, ogEmdDescription=ogEmdDescription, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcName=ogRpcName, ogWifiClientTable=ogWifiClientTable, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLabel=ogSerialPortLabel, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmCheck=ogAlarmCheck, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsName=ogUpsName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServicePort=ogHostServicePort, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Groups=ogStatus2Groups, ogCellModemEntry=ogCellModemEntry, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortCTS=ogSerialPortCTS, ogWebUserName=ogWebUserName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcIndex=ogRpcIndex, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortMode=ogSerialPortMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserTable=ogHostUserTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserNotification=ogWebUserNotification, ogStatus2Conformance=ogStatus2Conformance, ogStatus2Compliance=ogStatus2Compliance, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletName=ogRpcOutletName, ogHostUserAddress=ogHostUserAddress, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioEntry=ogEmdDioEntry, ogAlarmState=ogAlarmState, ogUpsConnectType=ogUpsConnectType, ogCellModemIndex=ogCellModemIndex, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientMode=ogWifiClientMode, ogHostUserNotification=ogHostUserNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarm=ogAlarm, ogUpsTemperature=ogUpsTemperature, ogHostTable=ogHostTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsState=ogUpsState, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsDescription=ogUpsDescription, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioType=ogEmdDioType, ogHostUserEntry=ogHostUserEntry, ogEmdEnabled=ogEmdEnabled, ogWifiApTable=ogWifiApTable, ogCellModemModel=ogCellModemModel, ogWifiApTxPower=ogWifiApTxPower, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCustomNotification=ogCustomNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserTable=ogWebUserTable, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostName=ogHostName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceIndex=ogHostServiceIndex, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceEntry=ogHostServiceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryState=ogUpsBatteryState, ogEmdDioIndex=ogEmdDioIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsTable=ogUpsTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceCounter=ogHostServiceCounter, ogHostPingNotification=ogHostPingNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioName=ogEmdDioName, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserName=ogSerialUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserIndex=ogHostUserIndex, ogCheckTable=ogCheckTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdIndex=ogEmdIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckType=ogCheckType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTower=ogCellModemTower, ogCellModemApn=ogCellModemApn, ogHostServiceHost=ogHostServiceHost, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmUser=ogAlarmUser, ogUpsEntry=ogUpsEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostIndex=ogHostIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioTable=ogEmdDioTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckEntry=ogCheckEntry, ogCheckDeviceName=ogCheckDeviceName, ogSystem=ogSystem, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcType=ogRpcType, ogCheckIndex=ogCheckIndex, ogUpsIndex=ogUpsIndex, ogNetInterfaceType=ogNetInterfaceType, ogAlarmInstance=ogAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserEntry=ogSerialUserEntry)
