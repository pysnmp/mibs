...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmType=ogAlarmType, ogSerialPortTable=ogSerialPortTable, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemVendor=ogCellModemVendor, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientApMac=ogWifiClientApMac, ogCellModemEntry=ogCellModemEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostPingNotification=ogHostPingNotification, ogCellModemCounter=ogCellModemCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcTable=ogRpcTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmInstance=ogAlarmInstance, ogUpsInputVoltage=ogUpsInputVoltage, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServicePort=ogHostServicePort, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsHumidity=ogUpsHumidity, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletState=ogRpcOutletState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDCD=ogSerialPortDCD, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostEntry=ogHostEntry, ogWifiClientTable=ogWifiClientTable, ogAlarmState=ogAlarmState, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdIndex=ogEmdIndex, ogEmdName=ogEmdName, ogCheckDeviceName=ogCheckDeviceName, ogWifiApEnabled=ogWifiApEnabled, ogHostIndex=ogHostIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioState=ogEmdDioState, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2=ogStatus2, ogSerialUserEntry=ogSerialUserEntry, ogHostTable=ogHostTable, ogWifiApTable=ogWifiApTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckName=ogCheckName, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserAddress=ogHostUserAddress, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletName=ogRpcOutletName, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserHost=ogHostUserHost, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceType=ogNetInterfaceType, ogSystem=ogSystem, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserName=ogSerialUserName, ogHostServiceType=ogHostServiceType, ogAlarmName=ogAlarmName, ogHostName=ogHostName, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemModel=ogCellModemModel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmTime=ogAlarmTime, ogEmdDioType=ogEmdDioType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserIndex=ogSerialUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcDescription=ogRpcDescription, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApCounter=ogWifiApCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcIndex=ogRpcIndex, ogCellTowerNotification=ogCellTowerNotification, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserStartTime=ogWebUserStartTime, ogUpsTemperature=ogUpsTemperature, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientInterface=ogWifiClientInterface, ogHostUserEntry=ogHostUserEntry, ogUpsTable=ogUpsTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckTable=ogCheckTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcEntry=ogRpcEntry, ogFirmwareVersion=ogFirmwareVersion, ogEmdEnabled=ogEmdEnabled, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortMode=ogSerialPortMode, ogCellModemTable=ogCellModemTable, ogCellModemRegistered=ogCellModemRegistered, ogRpcType=ogRpcType, ogCustomNotification=ogCustomNotification, ogRpcConnectType=ogRpcConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTemperature=ogCellModemTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarm=ogAlarm, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemTower=ogCellModemTower, ogWebUserName=ogWebUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceHost=ogHostServiceHost, ogEmdDioTable=ogEmdDioTable, ogCellModemApn=ogCellModemApn, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyName=ogPowerSupplyName, ogCheckEntry=ogCheckEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemConnected=ogCellModemConnected, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTable=ogPowerSupplyTable, ogMibNotifications=ogMibNotifications, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserName=ogHostUserName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserPort=ogSerialUserPort, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsState=ogUpsState, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortLabel=ogSerialPortLabel, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserHostName=ogHostUserHostName, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmCheck=ogAlarmCheck, ogUpsName=ogUpsName, ogCellModemEnabled=ogCellModemEnabled, ogUpsNotification=ogUpsNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEntry=ogWifiClientEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsEntry=ogUpsEntry, ogHostUserTable=ogHostUserTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTable=ogEmdTable, ogWifiApInterface=ogWifiApInterface, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsConnectType=ogUpsConnectType, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserIndex=ogWebUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioName=ogEmdDioName, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceState=ogNetInterfaceState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckIndex=ogCheckIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsDescription=ogUpsDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientIndex=ogWifiClientIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsType=ogUpsType, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientMode=ogWifiClientMode, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialNumber=ogSerialNumber, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellMessageNotification=ogCellMessageNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcName=ogRpcName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputNotification=ogRpcInputNotification, ogAlarmUser=ogAlarmUser, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApIndex=ogWifiApIndex, ogEmdConnectType=ogEmdConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceTable=ogHostServiceTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserNotification=ogHostUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserTable=ogWebUserTable, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdEntry=ogEmdEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserNotification=ogWebUserNotification, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsIndex=ogUpsIndex, ogCheckType=ogCheckType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIpV4Address=ogHostIpV4Address, ogRpcCounter=ogRpcCounter, ogSerialPortCTS=ogSerialPortCTS)
