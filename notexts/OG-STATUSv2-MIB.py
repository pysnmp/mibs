...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckName=ogCheckName, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckType=ogCheckType, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemIndex=ogCellModemIndex, ogCheckEntry=ogCheckEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserEntry=ogHostUserEntry, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsName=ogUpsName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCustomNotification=ogCustomNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserNotification=ogWebUserNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemModel=ogCellModemModel, ogEmdDioNotification=ogEmdDioNotification, ogUpsType=ogUpsType, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTable=ogSerialPortTable, ogEmdEnabled=ogEmdEnabled, ogSerialNumber=ogSerialNumber, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemApn=ogCellModemApn, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTable=ogEmdTable, ogHostUserHostName=ogHostUserHostName, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemConnected=ogCellModemConnected, ogAlarmState=ogAlarmState, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogHostEntry=ogHostEntry, ogHostUserName=ogHostUserName, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserName=ogWebUserName, ogUpsState=ogUpsState, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserStartTime=ogHostUserStartTime, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTable=ogEmdDioTable, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioName=ogEmdDioName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientMode=ogWifiClientMode, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioState=ogEmdDioState, ogEmdDioEntry=ogEmdDioEntry, ogUpsEntry=ogUpsEntry, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Conformance=ogStatus2Conformance, ogHostUserAddress=ogHostUserAddress, ogHostUserIndex=ogHostUserIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmDevice=ogAlarmDevice, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSystem=ogSystem, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckIndex=ogCheckIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputCurrent=ogUpsInputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogHostPingNotification=ogHostPingNotification, ogSerialPortLabel=ogSerialPortLabel, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceTable=ogHostServiceTable, ogCellModemCounter=ogCellModemCounter, ogUpsNotification=ogUpsNotification, ogAlarmType=ogAlarmType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserTable=ogWebUserTable, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdIndex=ogEmdIndex, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemIMSI=ogCellModemIMSI, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckTable=ogCheckTable, ogRpcType=ogRpcType, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarm=ogAlarm, ogHostServiceType=ogHostServiceType, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcCounter=ogRpcCounter, ogEmdDioCounter=ogEmdDioCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientApMac=ogWifiClientApMac, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortIndex=ogSerialPortIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDirection=ogEmdDioDirection, ogHostName=ogHostName, ogWebUserEntry=ogWebUserEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApFrequency=ogWifiApFrequency, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceName=ogNetInterfaceName, ogRpcIndex=ogRpcIndex, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortParity=ogSerialPortParity, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcEntry=ogRpcEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Compliance=ogStatus2Compliance, ogAlarmEventId=ogAlarmEventId, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserIndex=ogSerialUserIndex, ogEmdConnectType=ogEmdConnectType, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsIndex=ogUpsIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientTable=ogWifiClientTable, ogCellSignalNotification=ogCellSignalNotification, ogHostIndex=ogHostIndex, ogMibNotifications=ogMibNotifications, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRTS=ogSerialPortRTS, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserTable=ogSerialUserTable, ogUpsDescription=ogUpsDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceHost=ogHostServiceHost, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceType=ogNetInterfaceType, ogEmdDescription=ogEmdDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIpV6Address=ogHostIpV6Address, ogEmdEntry=ogEmdEntry, ogSerialUserName=ogSerialUserName, ogAlarmCheck=ogAlarmCheck, ogCheckResolveActions=ogCheckResolveActions, ogRpcTable=ogRpcTable, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Groups=ogStatus2Groups, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostTable=ogHostTable, ogUpsTable=ogUpsTable, ogCurrentAlarmState=ogCurrentAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogCellMessageNotification=ogCellMessageNotification, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserNotification=ogSerialUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApTxPower=ogWifiApTxPower, ogStatus2=ogStatus2, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserTable=ogHostUserTable, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApSsid=ogWifiApSsid, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcDescription=ogRpcDescription, ogAlarmUser=ogAlarmUser, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserPort=ogSerialUserPort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServicePort=ogHostServicePort, ogWifiApTable=ogWifiApTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdName=ogEmdName, ogHostUserNotification=ogHostUserNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmName=ogAlarmName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellDataNotification=ogCellDataNotification, ogCellModemTower=ogCellModemTower, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientIndex=ogWifiClientIndex, ogRpcConnectType=ogRpcConnectType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemTable=ogCellModemTable, ogWifiApClientAp=ogWifiApClientAp, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserIndex=ogWebUserIndex, ogUpsConnectType=ogUpsConnectType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyName=ogPowerSupplyName, ogHostUserHost=ogHostUserHost, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRssi=ogWifiClientRssi, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletName=ogRpcOutletName, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletState=ogRpcOutletState, ogRpcName=ogRpcName, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletNotification=ogRpcOutletNotification)
