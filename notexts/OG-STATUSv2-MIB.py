...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIndex=ogCellModemIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServicePort=ogHostServicePort, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserName=ogHostUserName, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsTable=ogUpsTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserStartTime=ogHostUserStartTime, ogWebUserTable=ogWebUserTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioName=ogEmdDioName, ogAlarmEventId=ogAlarmEventId, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemEntry=ogCellModemEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserHost=ogHostUserHost, ogStatus2=ogStatus2, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdEntry=ogEmdEntry, ogHostUserNotification=ogHostUserNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsConnectType=ogUpsConnectType, ogAlarmUser=ogAlarmUser, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTable=ogCheckTable, ogWifiApTable=ogWifiApTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientMode=ogWifiClientMode, ogEmdDioState=ogEmdDioState, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostTable=ogHostTable, ogHostUserHostName=ogHostUserHostName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserTable=ogHostUserTable, ogUpsIndex=ogUpsIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceName=ogNetInterfaceName, ogCheckType=ogCheckType, ogAlarm=ogAlarm, ogEmdEnabled=ogEmdEnabled, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcCounter=ogRpcCounter, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcDescription=ogRpcDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryState=ogUpsBatteryState, ogCellDataNotification=ogCellDataNotification, ogEmdIndex=ogEmdIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApEntry=ogWifiApEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyName=ogPowerSupplyName, ogFirmwareVersion=ogFirmwareVersion, ogUpsCounter=ogUpsCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcName=ogRpcName, ogSerialUserLabel=ogSerialUserLabel, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputPower=ogUpsOutputPower, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientTable=ogWifiClientTable, ogWifiClientInterface=ogWifiClientInterface, ogHostUserEntry=ogHostUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogUpsName=ogUpsName, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyIndex=ogPowerSupplyIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostPingNotification=ogHostPingNotification, ogSerialPortDSR=ogSerialPortDSR, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsDescription=ogUpsDescription, ogSerialPortMode=ogSerialPortMode, ogCheckEntry=ogCheckEntry, ogEmdTable=ogEmdTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemCounter=ogCellModemCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogHostIndex=ogHostIndex, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientRssi=ogWifiClientRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialNumber=ogSerialNumber, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientEntry=ogWifiClientEntry, ogAlarmName=ogAlarmName, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmSummary=ogAlarmSummary, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcTable=ogRpcTable, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckName=ogCheckName, ogCheckIndex=ogCheckIndex, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserEntry=ogWebUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortParity=ogSerialPortParity, ogCellApnNotification=ogCellApnNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserTable=ogSerialUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostName=ogHostName, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCustomNotification=ogCustomNotification, ogWebUserIndex=ogWebUserIndex, ogAlarmTime=ogAlarmTime, ogSerialPortIndex=ogSerialPortIndex, ogWebUserNotification=ogWebUserNotification, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsState=ogUpsState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIpV6Address=ogHostIpV6Address, ogMibNotifications=ogMibNotifications, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemVendor=ogCellModemVendor, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSystem=ogSystem, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmCheck=ogAlarmCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellSignalNotification=ogCellSignalNotification, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserName=ogWebUserName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemModel=ogCellModemModel, ogSerialUserNotification=ogSerialUserNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserEntry=ogSerialUserEntry, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceCounter=ogHostServiceCounter, ogRpcType=ogRpcType, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemTable=ogCellModemTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserPort=ogSerialUserPort, ogAlarmState=ogAlarmState, ogAlarmInstance=ogAlarmInstance, ogCellModemApn=ogCellModemApn, ogRpcOutletName=ogRpcOutletName, ogAlarmLogTable=ogAlarmLogTable, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Groups=ogStatus2Groups, ogRpcEntry=ogRpcEntry, ogAlarmDevice=ogAlarmDevice, ogAlarmType=ogAlarmType, ogEmdDescription=ogEmdDescription, ogCellModemConnected=ogCellModemConnected, ogHostEntry=ogHostEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdName=ogEmdName, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioTable=ogEmdDioTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsTemperature=ogUpsTemperature, ogUpsHumidity=ogUpsHumidity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsNotification=ogUpsNotification, ogWifiApCounter=ogWifiApCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsType=ogUpsType, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioType=ogEmdDioType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserName=ogSerialUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApEnabled=ogWifiApEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApIndex=ogWifiApIndex, ogHostServiceStatus=ogHostServiceStatus, ogUpsEntry=ogUpsEntry, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceType=ogHostServiceType, ogRpcIndex=ogRpcIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
