...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Conformance=ogStatus2Conformance, ogEmdDioType=ogEmdDioType, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdName=ogEmdName, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcType=ogRpcType, ogAlarmDevice=ogAlarmDevice, ogAlarmState=ogAlarmState, ogUpsNotification=ogUpsNotification, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostName=ogHostName, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellApnNotification=ogCellApnNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortRTS=ogSerialPortRTS, ogSystem=ogSystem, ogSerialNumber=ogSerialNumber, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckType=ogCheckType, ogEmdDescription=ogEmdDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogTable=ogAlarmLogTable, ogUpsType=ogUpsType, ogWifiApTable=ogWifiApTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioState=ogEmdDioState, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdIndex=ogEmdIndex, ogSerialPortIndex=ogSerialPortIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHost=ogHostUserHost, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsDescription=ogUpsDescription, ogHostIpV6Address=ogHostIpV6Address, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioName=ogEmdDioName, ogCheckEntry=ogCheckEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserEntry=ogSerialUserEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletState=ogRpcOutletState, ogHostServicePort=ogHostServicePort, ogCellModemIMSI=ogCellModemIMSI, ogRpcDescription=ogRpcDescription, ogWebUserStartTime=ogWebUserStartTime, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientAp=ogWifiApClientAp, ogAlarmName=ogAlarmName, ogHostPingNotification=ogHostPingNotification, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserNotification=ogWebUserNotification, ogEmdDioNotification=ogEmdDioNotification, ogAlarmCheck=ogAlarmCheck, ogHostServiceNotification=ogHostServiceNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserNotification=ogHostUserNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsState=ogUpsState, ogEmdTemperatureName=ogEmdTemperatureName, ogHostTable=ogHostTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmUser=ogAlarmUser, ogUpsIndex=ogUpsIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIndex=ogHostIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortDCD=ogSerialPortDCD, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserLabel=ogSerialUserLabel, ogHostUserTable=ogHostUserTable, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemVendor=ogCellModemVendor, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHostName=ogHostUserHostName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemModel=ogCellModemModel, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcName=ogRpcName, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemIndex=ogCellModemIndex, ogWebUserName=ogWebUserName, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceEntry=ogHostServiceEntry, ogWifiApIndex=ogWifiApIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcCounter=ogRpcCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostUserEntry=ogHostUserEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostUserName=ogHostUserName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmType=ogAlarmType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckIndex=ogCheckIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApEntry=ogWifiApEntry, ogWifiApCounter=ogWifiApCounter, ogSerialUserPort=ogSerialUserPort, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdEntry=ogEmdEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsName=ogUpsName, ogAlarmEventId=ogAlarmEventId, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEntry=ogWifiClientEntry, ogCellModemTable=ogCellModemTable, ogWebUserIndex=ogWebUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTower=ogCellModemTower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmSummary=ogAlarmSummary, ogSerialPortDSR=ogSerialPortDSR, ogRpcIndex=ogRpcIndex, ogStatus2Compliance=ogStatus2Compliance, ogUpsEntry=ogUpsEntry, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceType=ogNetInterfaceType, ogCustomNotification=ogCustomNotification, ogWebUserTable=ogWebUserTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserName=ogSerialUserName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsTable=ogUpsTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletName=ogRpcOutletName, ogAlarm=ogAlarm, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRssi=ogWifiClientRssi, ogWifiApInterface=ogWifiApInterface, ogStatus2=ogStatus2, ogRpcTable=ogRpcTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdEnabled=ogEmdEnabled, ogHostServiceHost=ogHostServiceHost, ogUpsTemperature=ogUpsTemperature, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortParity=ogSerialPortParity, ogCellModemApn=ogCellModemApn, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientTable=ogWifiApClientTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApSsid=ogWifiApSsid, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceType=ogHostServiceType, ogWifiApEnabled=ogWifiApEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemNetwork=ogCellModemNetwork, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsHumidity=ogUpsHumidity, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogMibNotifications=ogMibNotifications, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmTime=ogAlarmTime, ogCheckTable=ogCheckTable, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcEntry=ogRpcEntry, ogSerialPortMode=ogSerialPortMode, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckName=ogCheckName, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutputNotification=ogRpcOutputNotification, PYSNMP_MODULE_ID=ogStatus2, ogCellModemConnected=ogCellModemConnected, ogHostServiceTable=ogHostServiceTable, ogSerialUserNotification=ogSerialUserNotification, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputPower=ogUpsOutputPower, ogAlarmInstance=ogAlarmInstance, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortTable=ogSerialPortTable, ogWifiClientMode=ogWifiClientMode, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserAddress=ogHostUserAddress, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientTable=ogWifiClientTable, ogEmdDioDirection=ogEmdDioDirection, ogCellModemEntry=ogCellModemEntry, ogEmdDioTable=ogEmdDioTable, ogUpsCounter=ogUpsCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue)
