...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRssi=ogWifiClientRssi, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletState=ogRpcOutletState, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcConnectType=ogRpcConnectType, ogHostUserTable=ogHostUserTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmState=ogAlarmState, ogEmdDioTable=ogEmdDioTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmSummary=ogAlarmSummary, ogCellModemTable=ogCellModemTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsName=ogUpsName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceName=ogCheckDeviceName, ogEmdName=ogEmdName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2=ogStatus2, ogSerialPortMode=ogSerialPortMode, ogUpsCounter=ogUpsCounter, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceHost=ogHostServiceHost, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserHost=ogHostUserHost, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmEventId=ogAlarmEventId, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcIndex=ogRpcIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogCheckTable=ogCheckTable, ogHostServiceCounter=ogHostServiceCounter, ogWebUserTable=ogWebUserTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientTable=ogWifiClientTable, ogWifiApTable=ogWifiApTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNotification=ogUpsInputNotification, ogRpcEntry=ogRpcEntry, ogWebUserIndex=ogWebUserIndex, ogCustomNotification=ogCustomNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogHostName=ogHostName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemNetwork=ogCellModemNetwork, ogWifiApIndex=ogWifiApIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserName=ogHostUserName, ogCellSignalNotification=ogCellSignalNotification, ogCheckType=ogCheckType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostTable=ogHostTable, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsTable=ogUpsTable, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserTable=ogSerialUserTable, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdEnabled=ogEmdEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientAp=ogWifiApClientAp, ogAlarmCheck=ogAlarmCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityName=ogEmdHumidityName, ogRpcTable=ogRpcTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemVendor=ogCellModemVendor, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletName=ogRpcOutletName, ogSerialPortLabel=ogSerialPortLabel, ogCellModemConnected=ogCellModemConnected, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogCellModemCounter=ogCellModemCounter, ogEmdConnectType=ogEmdConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemModel=ogCellModemModel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmTime=ogAlarmTime, ogRpcDescription=ogRpcDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdEntry=ogEmdEntry, ogFirmwareVersion=ogFirmwareVersion, ogRpcName=ogRpcName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmType=ogAlarmType, ogNetInterfaceName=ogNetInterfaceName, ogWebUserStartTime=ogWebUserStartTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortTable=ogSerialPortTable, ogUpsType=ogUpsType, ogHostUserEntry=ogHostUserEntry, ogStatus2Compliance=ogStatus2Compliance, ogHostEntry=ogHostEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTemperature=ogCellModemTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTable=ogEmdTable, ogUpsDescription=ogUpsDescription, ogUpsNotification=ogUpsNotification, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmInstance=ogAlarmInstance, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemEntry=ogCellModemEntry, ogSerialPortIndex=ogSerialPortIndex, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsTemperature=ogUpsTemperature, ogWifiClientCounter=ogWifiClientCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostPingNotification=ogHostPingNotification, ogAlarmName=ogAlarmName, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarm=ogAlarm, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogStatus2Groups=ogStatus2Groups, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogMibNotifications=ogMibNotifications, ogAlarmUser=ogAlarmUser, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserNotification=ogHostUserNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDTR=ogSerialPortDTR, ogCheckEntry=ogCheckEntry, ogWebUserNotification=ogWebUserNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckName=ogCheckName, ogHostServiceType=ogHostServiceType, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientMode=ogWifiClientMode, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserNotification=ogSerialUserNotification, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceState=ogNetInterfaceState, ogSystem=ogSystem, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServicePort=ogHostServicePort)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioDescription=ogEmdDioDescription, ogSerialNumber=ogSerialNumber, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserName=ogWebUserName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApInterface=ogWifiApInterface, ogSerialPortParity=ogSerialPortParity, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioType=ogEmdDioType, ogStatus2Compliances=ogStatus2Compliances, ogCellModemIndex=ogCellModemIndex, ogUpsState=ogUpsState, ogCellModemApn=ogCellModemApn, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserHostName=ogHostUserHostName, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcCounter=ogRpcCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioEntry=ogEmdDioEntry, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsIndex=ogUpsIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemTower=ogCellModemTower, ogHostIndex=ogHostIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDescription=ogEmdDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcType=ogRpcType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceIndex=ogHostServiceIndex, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdIndex=ogEmdIndex, ogCheckIndex=ogCheckIndex, ogEmdDioName=ogEmdDioName, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceEntry=ogHostServiceEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApCounter=ogWifiApCounter, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryTemperature=ogUpsBatteryTemperature)
