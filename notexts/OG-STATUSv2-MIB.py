...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApCounter=ogWifiApCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApTable=ogWifiApTable, ogEmdTable=ogEmdTable, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceRef=ogCheckDeviceRef, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Compliances=ogStatus2Compliances, ogRpcTable=ogRpcTable, ogSerialUserTable=ogSerialUserTable, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientTable=ogWifiClientTable, ogRpcName=ogRpcName, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcCounter=ogRpcCounter, ogEmdConnectType=ogEmdConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckType=ogCheckType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCheck=ogAlarmCheck, ogStatus2Groups=ogStatus2Groups, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletTable=ogRpcOutletTable, ogEmdName=ogEmdName, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmName=ogAlarmName, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletName=ogRpcOutletName, ogWebUserEntry=ogWebUserEntry, ogUpsIndex=ogUpsIndex, ogCustomNotification=ogCustomNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogMibNotifications=ogMibNotifications, ogRpcInputNotification=ogRpcInputNotification, ogRpcDescription=ogRpcDescription, ogUpsState=ogUpsState, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceEntry=ogHostServiceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortIndex=ogSerialPortIndex, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmUser=ogAlarmUser, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortMode=ogSerialPortMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApIndex=ogWifiApIndex, ogSerialUserPort=ogSerialUserPort, ogHostUserHost=ogHostUserHost, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientInterface=ogWifiClientInterface, ogCellModemCounter=ogCellModemCounter, ogUpsCounter=ogUpsCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApEntry=ogWifiApEntry, ogHostServiceIndex=ogHostServiceIndex, ogHostUserEntry=ogHostUserEntry, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioState=ogEmdDioState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdEntry=ogEmdEntry, ogAlarmState=ogAlarmState, ogWifiClientCounter=ogWifiClientCounter, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceType=ogHostServiceType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcEntry=ogRpcEntry, ogEmdDioIndex=ogEmdDioIndex, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServicePort=ogHostServicePort, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemModel=ogCellModemModel, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsEntry=ogUpsEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserIndex=ogHostUserIndex, ogHostServiceNotification=ogHostServiceNotification, ogCheckName=ogCheckName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserNotification=ogHostUserNotification, ogSerialUserLabel=ogSerialUserLabel, ogCellModemApn=ogCellModemApn, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmEventId=ogAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDescription=ogEmdDescription, ogCellModemConnected=ogCellModemConnected, ogUpsHumidity=ogUpsHumidity, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogFirmwareVersion=ogFirmwareVersion, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientTable=ogWifiApClientTable, ogHostIndex=ogHostIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogTable=ogAlarmLogTable, ogCellModemTemperature=ogCellModemTemperature, ogWebUserStartTime=ogWebUserStartTime, ogCheckTable=ogCheckTable, ogSerialNumber=ogSerialNumber, ogCheckIndex=ogCheckIndex, ogEmdDioType=ogEmdDioType, ogWifiApEnabled=ogWifiApEnabled, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApInterface=ogWifiApInterface, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarm=ogAlarm, ogHostIpV4Address=ogHostIpV4Address, ogHostUserStartTime=ogHostUserStartTime, ogWebUserNotification=ogWebUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceCounter=ogHostServiceCounter, ogWebUserName=ogWebUserName, ogSerialPortDTR=ogSerialPortDTR, ogAlarmInstance=ogAlarmInstance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsDescription=ogUpsDescription, ogRpcOutletState=ogRpcOutletState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientIndex=ogWifiClientIndex, ogHostUserTable=ogHostUserTable, ogAlarmSummary=ogAlarmSummary, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDCD=ogSerialPortDCD, ogRpcIndex=ogRpcIndex, ogCellModemTower=ogCellModemTower, ogUpsTable=ogUpsTable, ogCheckEntry=ogCheckEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioName=ogEmdDioName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceState=ogNetInterfaceState, ogAlarmTime=ogAlarmTime, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortTable=ogSerialPortTable, ogHostServiceTable=ogHostServiceTable, ogUpsTemperature=ogUpsTemperature, ogCheckResolveActions=ogCheckResolveActions, ogStatus2Compliance=ogStatus2Compliance, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputPower=ogUpsOutputPower, ogEmdIndex=ogEmdIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostTable=ogHostTable, ogSystem=ogSystem, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostEntry=ogHostEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsType=ogUpsType, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostName=ogHostName, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserEntry=ogSerialUserEntry, ogAlarmType=ogAlarmType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityName=ogEmdHumidityName, ogHostUserName=ogHostUserName, ogStatus2=ogStatus2, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostPingNotification=ogHostPingNotification, ogUpsName=ogUpsName, ogSerialUserName=ogSerialUserName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId)
