...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServicePort=ogHostServicePort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialNumber=ogSerialNumber, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2Groups=ogStatus2Groups, ogStatus2Compliance=ogStatus2Compliance, ogUpsTemperature=ogUpsTemperature, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsEntry=ogUpsEntry, ogEmdEntry=ogEmdEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIndex=ogHostIndex, ogHostEntry=ogHostEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsDescription=ogUpsDescription, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2Conformance=ogStatus2Conformance, ogWifiApTable=ogWifiApTable, ogHostUserEntry=ogHostUserEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceTable=ogHostServiceTable, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserEntry=ogSerialUserEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiApEntry=ogWifiApEntry, ogCellModemEnabled=ogCellModemEnabled, ogWebUserEntry=ogWebUserEntry, ogRpcName=ogRpcName, ogAlarmType=ogAlarmType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTable=ogWifiApClientTable, ogSystem=ogSystem, ogCheckIndex=ogCheckIndex, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioType=ogEmdDioType, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcType=ogRpcType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientEssid=ogWifiClientEssid, ogWifiApIndex=ogWifiApIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemVendor=ogCellModemVendor, ogHostServiceHost=ogHostServiceHost, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcDescription=ogRpcDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmTime=ogAlarmTime, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsNotification=ogUpsNotification, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserTable=ogWebUserTable, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioTable=ogEmdDioTable, ogUpsIndex=ogUpsIndex, ogSerialPortParity=ogSerialPortParity, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceIndex=ogHostServiceIndex, ogCellModemEntry=ogCellModemEntry, ogAlarmInstance=ogAlarmInstance, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmSummary=ogAlarmSummary, ogUpsOutputPower=ogUpsOutputPower, ogAlarmDevice=ogAlarmDevice, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckEntry=ogCheckEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcIndex=ogRpcIndex, ogHostServiceCounter=ogHostServiceCounter, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApCounter=ogWifiApCounter, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserIndex=ogHostUserIndex, ogSerialUserTable=ogSerialUserTable, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApInterface=ogWifiApInterface, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRegistered=ogCellModemRegistered, ogAlarmEventId=ogAlarmEventId, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientApMac=ogWifiClientApMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogStatus2=ogStatus2, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserAddress=ogHostUserAddress, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsTable=ogUpsTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserName=ogSerialUserName, ogWifiClientIndex=ogWifiClientIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostTable=ogHostTable, ogEmdConnectType=ogEmdConnectType, ogAlarmUser=ogAlarmUser, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceType=ogHostServiceType, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmState=ogAlarmState, ogRpcTable=ogRpcTable, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserNotification=ogHostUserNotification, ogHostUserHost=ogHostUserHost, ogUpsName=ogUpsName, ogEmdDioCounter=ogEmdDioCounter, ogUpsCounter=ogUpsCounter, ogWebUserNotification=ogWebUserNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemTower=ogCellModemTower, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsHumidity=ogUpsHumidity, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDescription=ogEmdDescription, ogCellModemIMSI=ogCellModemIMSI, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcCounter=ogRpcCounter, ogHostName=ogHostName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApSsid=ogWifiApSsid, ogRpcOutletTable=ogRpcOutletTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputNotification=ogUpsInputNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortTable=ogSerialPortTable, ogHostUserTable=ogHostUserTable, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemCounter=ogCellModemCounter, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcEntry=ogRpcEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioState=ogEmdDioState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellSignalNotification=ogCellSignalNotification, ogUpsState=ogUpsState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmLogTable=ogAlarmLogTable, ogRpcConnectType=ogRpcConnectType, ogWebUserName=ogWebUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemTable=ogCellModemTable, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckTable=ogCheckTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemIndex=ogCellModemIndex, ogAlarm=ogAlarm, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdName=ogEmdName, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsConnectType=ogUpsConnectType, ogUpsType=ogUpsType, ogHostServiceNotification=ogHostServiceNotification, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioName=ogEmdDioName, ogCellApnNotification=ogCellApnNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckType=ogCheckType, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTable=ogEmdTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemNetwork=ogCellModemNetwork, ogHostPingNotification=ogHostPingNotification, ogAlarmName=ogAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletName=ogRpcOutletName, ogCellTowerNotification=ogCellTowerNotification, ogCustomNotification=ogCustomNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserPort=ogSerialUserPort, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserName=ogHostUserName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdIndex=ogEmdIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemApn=ogCellModemApn, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceState=ogNetInterfaceState, ogCheckName=ogCheckName, ogWifiClientTable=ogWifiClientTable)
