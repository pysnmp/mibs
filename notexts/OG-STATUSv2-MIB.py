...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyName=ogPowerSupplyName, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdIndex=ogEmdIndex, ogHostTable=ogHostTable, ogSerialPortDTR=ogSerialPortDTR, ogRpcIndex=ogRpcIndex, ogHostUserIndex=ogHostUserIndex, ogStatus2Conformance=ogStatus2Conformance, ogHostUserHostName=ogHostUserHostName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioName=ogEmdDioName, ogSerialPortIndex=ogSerialPortIndex, ogCellModemApn=ogCellModemApn, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsState=ogUpsState, ogStatus2Compliances=ogStatus2Compliances, ogHostIpV4Address=ogHostIpV4Address, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserName=ogSerialUserName, ogWifiApCounter=ogWifiApCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsEntry=ogUpsEntry, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserEntry=ogWebUserEntry, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmUser=ogAlarmUser, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcName=ogRpcName, ogWifiApSsid=ogWifiApSsid, ogWifiClientInterface=ogWifiClientInterface, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsName=ogUpsName, ogCellModemCounter=ogCellModemCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletState=ogRpcOutletState, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserPort=ogSerialUserPort, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmSummary=ogAlarmSummary, ogSerialUserLabel=ogSerialUserLabel, ogCellModemVendor=ogCellModemVendor, ogCheckTable=ogCheckTable, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserName=ogHostUserName, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostName=ogHostName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckType=ogCheckType, ogAlarmName=ogAlarmName, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientMode=ogWifiClientMode, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSystem=ogSystem, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientCounter=ogWifiClientCounter, ogRpcTable=ogRpcTable, ogHostIpV6Address=ogHostIpV6Address, ogCellModemModel=ogCellModemModel, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserIndex=ogWebUserIndex, ogCheckEntry=ogCheckEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortMode=ogSerialPortMode, ogStatus2=ogStatus2, ogAlarmState=ogAlarmState, ogWifiApIndex=ogWifiApIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmTime=ogAlarmTime, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceType=ogHostServiceType, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApEntry=ogWifiApEntry, ogCellModemConnected=ogCellModemConnected, ogRpcDescription=ogRpcDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsConnectType=ogUpsConnectType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellDataNotification=ogCellDataNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientTable=ogWifiClientTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceStatus=ogHostServiceStatus, ogEmdEntry=ogEmdEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiApTable=ogWifiApTable, ogEmdTable=ogEmdTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsIndex=ogUpsIndex, ogSerialNumber=ogSerialNumber, ogSerialPortSpeed=ogSerialPortSpeed, ogMibNotifications=ogMibNotifications, ogCellModemIndex=ogCellModemIndex, ogSerialPortEntry=ogSerialPortEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcConnectType=ogRpcConnectType, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmEventId=ogAlarmEventId, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemIMSI=ogCellModemIMSI, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTable=ogCellModemTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserTable=ogHostUserTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcType=ogRpcType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDescription=ogEmdDescription, ogWifiApFrequency=ogWifiApFrequency, ogUpsType=ogUpsType, ogCellApnNotification=ogCellApnNotification, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserEntry=ogHostUserEntry, ogEmdName=ogEmdName, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceHost=ogHostServiceHost, ogWifiApInterface=ogWifiApInterface, ogHostEntry=ogHostEntry, ogRpcOutletName=ogRpcOutletName, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckName=ogCheckName, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserName=ogWebUserName, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmType=ogAlarmType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortTable=ogSerialPortTable, ogWifiApClientAp=ogWifiApClientAp, ogCellModemTower=ogCellModemTower, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmCheck=ogAlarmCheck, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsDescription=ogUpsDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCustomNotification=ogCustomNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemRegistered=ogCellModemRegistered, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserTable=ogSerialUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserAddress=ogHostUserAddress, ogRpcEntry=ogRpcEntry, ogEmdDioType=ogEmdDioType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsTemperature=ogUpsTemperature, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsNotification=ogUpsNotification, ogWifiClientApMac=ogWifiClientApMac, ogRpcCounter=ogRpcCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceCounter=ogHostServiceCounter, ogHostIndex=ogHostIndex, ogEmdDioState=ogEmdDioState, ogEmdDioDescription=ogEmdDioDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioTable=ogEmdDioTable, ogAlarmLogTable=ogAlarmLogTable, ogCellModemEntry=ogCellModemEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserHost=ogHostUserHost, ogWebUserTable=ogWebUserTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceEntry=ogHostServiceEntry, ogUpsHumidity=ogUpsHumidity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServicePort=ogHostServicePort, ogCellTowerNotification=ogCellTowerNotification, ogUpsTable=ogUpsTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemNetwork=ogCellModemNetwork, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmDevice=ogAlarmDevice, ogAlarm=ogAlarm, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioIndex=ogEmdDioIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogFirmwareVersion=ogFirmwareVersion, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdEnabled=ogEmdEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceName=ogNetInterfaceName, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApEnabled=ogWifiApEnabled, ogWebUserNotification=ogWebUserNotification, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsCounter=ogUpsCounter, ogCheckIndex=ogCheckIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
