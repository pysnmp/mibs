...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmName=ogAlarmName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemEntry=ogCellModemEntry, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsTemperature=ogUpsTemperature, ogRpcConnectType=ogRpcConnectType, ogRpcEntry=ogRpcEntry, ogUpsIndex=ogUpsIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserNotification=ogSerialUserNotification, ogUpsEntry=ogUpsEntry, ogSerialPortDCD=ogSerialPortDCD, ogAlarmSummary=ogAlarmSummary, ogHostUserTable=ogHostUserTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTable=ogEmdTable, ogHostServiceHost=ogHostServiceHost, ogUpsNotification=ogUpsNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostIndex=ogHostIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdIndex=ogEmdIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemVendor=ogCellModemVendor, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsCounter=ogUpsCounter, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostEntry=ogHostEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientMode=ogWifiClientMode, ogRpcCounter=ogRpcCounter, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientApMac=ogWifiClientApMac, ogEmdConnectType=ogEmdConnectType, ogSerialNumber=ogSerialNumber, ogWebUserNotification=ogWebUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSystem=ogSystem, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioCounter=ogEmdDioCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureValue=ogEmdTemperatureValue, PYSNMP_MODULE_ID=ogStatus2, ogEmdName=ogEmdName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcName=ogRpcName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientTable=ogWifiApClientTable, ogCheckType=ogCheckType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortParity=ogSerialPortParity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserHost=ogHostUserHost, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserName=ogHostUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApSsid=ogWifiApSsid, ogHostIpV6Address=ogHostIpV6Address, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApIndex=ogWifiApIndex, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmEventId=ogAlarmEventId, ogCustomNotification=ogCustomNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmState=ogAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogRpcIndex=ogRpcIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserHostName=ogHostUserHostName, ogCheckResetTimeout=ogCheckResetTimeout, ogMibNotifications=ogMibNotifications, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputNotification=ogUpsOutputNotification, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApTable=ogWifiApTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioEntry=ogEmdDioEntry, ogWifiApInterface=ogWifiApInterface, ogUpsTable=ogUpsTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmTime=ogAlarmTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRssi=ogWifiClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientCounter=ogWifiClientCounter, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserEntry=ogSerialUserEntry, ogHostName=ogHostName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemCounter=ogCellModemCounter, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTemperature=ogCellModemTemperature, ogCellMessageNotification=ogCellMessageNotification, ogHostServicePort=ogHostServicePort, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceNotification=ogNetInterfaceNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortIndex=ogSerialPortIndex, ogCheckResolveActions=ogCheckResolveActions, ogCellModemModel=ogCellModemModel, ogUpsDescription=ogUpsDescription, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTable=ogSerialPortTable, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsState=ogUpsState, ogSerialUserPort=ogSerialUserPort, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceStatus=ogHostServiceStatus, ogAlarmDevice=ogAlarmDevice, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogTable=ogAlarmLogTable, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioType=ogEmdDioType, ogCheckTable=ogCheckTable, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcType=ogRpcType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemTable=ogCellModemTable, ogAlarmType=ogAlarmType, ogAlarmUser=ogAlarmUser, ogAlarm=ogAlarm, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdEnabled=ogEmdEnabled, ogStatus2Groups=ogStatus2Groups, ogCellModemIMSI=ogCellModemIMSI, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientTable=ogWifiClientTable, ogCellModemTower=ogCellModemTower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2=ogStatus2, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserIndex=ogSerialUserIndex, ogAlarmCheck=ogAlarmCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientIndex=ogWifiClientIndex, ogCellModemNetwork=ogCellModemNetwork, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsName=ogUpsName, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserIndex=ogWebUserIndex, ogEmdDescription=ogEmdDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Compliance=ogStatus2Compliance, ogWebUserName=ogWebUserName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsConnectType=ogUpsConnectType, ogCellModemApn=ogCellModemApn, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceType=ogHostServiceType, ogRpcOutletTable=ogRpcOutletTable, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckIndex=ogCheckIndex, ogCheckEntry=ogCheckEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioState=ogEmdDioState, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckName=ogCheckName, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostTable=ogHostTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioName=ogEmdDioName, ogSerialPortMode=ogSerialPortMode, ogEmdEntry=ogEmdEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellDataNotification=ogCellDataNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2Conformance=ogStatus2Conformance, ogWifiApEntry=ogWifiApEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcDescription=ogRpcDescription, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsHumidity=ogUpsHumidity, ogHostUserEntry=ogHostUserEntry, ogRpcTable=ogRpcTable, ogRpcOutletState=ogRpcOutletState, ogSerialPortDSR=ogSerialPortDSR, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserTable=ogWebUserTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsType=ogUpsType, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserLabel=ogSerialUserLabel, ogCellModemConnected=ogCellModemConnected, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmInstance=ogAlarmInstance, ogSerialUserName=ogSerialUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserIndex=ogHostUserIndex)
