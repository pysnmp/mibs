...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortLabel=ogSerialPortLabel, ogSerialPortDSR=ogSerialPortDSR, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostIpV4Address=ogHostIpV4Address, ogEmdDescription=ogEmdDescription, ogEmdDioName=ogEmdDioName, ogUpsState=ogUpsState, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTemperature=ogCellModemTemperature, ogStatus2Groups=ogStatus2Groups, ogWebUserIndex=ogWebUserIndex, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceCounter=ogHostServiceCounter, ogWifiApSsid=ogWifiApSsid, ogUpsInputNotification=ogUpsInputNotification, ogRpcName=ogRpcName, ogUpsHumidity=ogUpsHumidity, ogCellModemEnabled=ogCellModemEnabled, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientBitRate=ogWifiClientBitRate, ogCellTowerNotification=ogCellTowerNotification, ogHostName=ogHostName, ogSerialPortRTS=ogSerialPortRTS, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckTable=ogCheckTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioState=ogEmdDioState, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarm=ogAlarm, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmState=ogCurrentAlarmState, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEntry=ogCellModemEntry, ogCheckType=ogCheckType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserStartTime=ogWebUserStartTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmState=ogAlarmState, ogCellModemTable=ogCellModemTable, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortCTS=ogSerialPortCTS, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioType=ogEmdDioType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTable=ogEmdTable, ogAlarmCheck=ogAlarmCheck, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcEntry=ogRpcEntry, ogWifiClientRssi=ogWifiClientRssi, ogCustomNotification=ogCustomNotification, ogHostPingNotification=ogHostPingNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletName=ogRpcOutletName, ogRpcCounter=ogRpcCounter, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellApnNotification=ogCellApnNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEntry=ogWifiApEntry, ogStatus2=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserHost=ogHostUserHost, ogWifiApInterface=ogWifiApInterface, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostServiceType=ogHostServiceType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortParity=ogSerialPortParity, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcDescription=ogRpcDescription, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckEntry=ogCheckEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserTable=ogHostUserTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserAddress=ogHostUserAddress, ogAlarmDevice=ogAlarmDevice, ogUpsEntry=ogUpsEntry, ogWifiClientEntry=ogWifiClientEntry, ogWebUserTable=ogWebUserTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserNotification=ogWebUserNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientAp=ogWifiApClientAp, ogRpcIndex=ogRpcIndex, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApCounter=ogWifiApCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdEnabled=ogEmdEnabled, ogAlarmInstance=ogAlarmInstance, ogWifiClientApMac=ogWifiClientApMac, ogWebUserName=ogWebUserName, ogSerialPortDTR=ogSerialPortDTR, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApEnabled=ogWifiApEnabled, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioTable=ogEmdDioTable, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortEntry=ogSerialPortEntry, ogCellModemModel=ogCellModemModel, ogUpsNotification=ogUpsNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogUpsIndex=ogUpsIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdIndex=ogEmdIndex, ogMibNotifications=ogMibNotifications, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemNetwork=ogCellModemNetwork, ogCellModemConnected=ogCellModemConnected, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceTable=ogHostServiceTable, ogEmdConnectType=ogEmdConnectType, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientMode=ogWifiClientMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputPower=ogUpsOutputPower, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortMode=ogSerialPortMode, ogRpcType=ogRpcType, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemIndex=ogCellModemIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsTemperature=ogUpsTemperature, ogUpsDescription=ogUpsDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserName=ogSerialUserName, ogEmdLogEnabled=ogEmdLogEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioDirection=ogEmdDioDirection, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckName=ogCheckName, ogUpsType=ogUpsType, ogHostServiceEntry=ogHostServiceEntry, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserIndex=ogSerialUserIndex, ogUpsTable=ogUpsTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserNotification=ogHostUserNotification, ogEmdName=ogEmdName, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmTime=ogAlarmTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemApn=ogCellModemApn, ogHostServicePort=ogHostServicePort, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserIndex=ogHostUserIndex, ogSerialNumber=ogSerialNumber, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientInterface=ogWifiClientInterface, ogAlarmName=ogAlarmName, ogUpsName=ogUpsName, ogWifiApTable=ogWifiApTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryState=ogUpsBatteryState, ogHostEntry=ogHostEntry, ogWebUserEntry=ogWebUserEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmSummary=ogAlarmSummary, ogEmdDioNotification=ogEmdDioNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserTable=ogSerialUserTable, ogCellModemTower=ogCellModemTower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSystem=ogSystem, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortTable=ogSerialPortTable, ogWifiApTxPower=ogWifiApTxPower, ogHostIndex=ogHostIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcTable=ogRpcTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputNotification=ogRpcInputNotification, ogAlarmUser=ogAlarmUser, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortBreaks=ogSerialPortBreaks, ogHostTable=ogHostTable, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserName=ogHostUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Compliances=ogStatus2Compliances, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemVendor=ogCellModemVendor, ogAlarmType=ogAlarmType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdEntry=ogEmdEntry, ogCellDataNotification=ogCellDataNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioDescription=ogEmdDioDescription, ogHostUserEntry=ogHostUserEntry, ogHostServiceNotification=ogHostServiceNotification, ogCheckIndex=ogCheckIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserPort=ogSerialUserPort)
