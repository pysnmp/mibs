...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientIndex=ogWifiClientIndex, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcDescription=ogRpcDescription, ogSerialPortMode=ogSerialPortMode, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApFrequency=ogWifiApFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmUser=ogAlarmUser, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemTable=ogCellModemTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserName=ogSerialUserName, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemTower=ogCellModemTower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmSummary=ogAlarmSummary, ogHostServicePort=ogHostServicePort, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcCounter=ogRpcCounter, ogCheckIndex=ogCheckIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcTable=ogRpcTable, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApTable=ogWifiApTable, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryState=ogUpsBatteryState, ogAlarmLogEntry=ogAlarmLogEntry, ogCellTowerNotification=ogCellTowerNotification, ogStatus2=ogStatus2, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletName=ogRpcOutletName, ogWifiClientApMac=ogWifiClientApMac, ogAlarmPreviousValue=ogAlarmPreviousValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcName=ogRpcName, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostName=ogHostName, ogHostServiceEntry=ogHostServiceEntry, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceHost=ogHostServiceHost, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserIndex=ogHostUserIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIndex=ogWifiApIndex, ogHostServiceType=ogHostServiceType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckTable=ogCheckTable, ogHostUserNotification=ogHostUserNotification, ogHostServiceNotification=ogHostServiceNotification, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApCounter=ogWifiApCounter, ogCellModemIndex=ogCellModemIndex, ogCheckName=ogCheckName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsState=ogUpsState, ogEmdDioState=ogEmdDioState, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdIndex=ogEmdIndex, ogHostIndex=ogHostIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientCounter=ogWifiClientCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckType=ogCheckType, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdConnectType=ogEmdConnectType, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientMode=ogWifiClientMode, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioName=ogEmdDioName, ogWebUserName=ogWebUserName, ogRpcInputVoltage=ogRpcInputVoltage, ogWebUserStartTime=ogWebUserStartTime, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserEntry=ogHostUserEntry, ogUpsOutputPower=ogUpsOutputPower, ogHostUserTable=ogHostUserTable, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioTable=ogEmdDioTable, ogHostUserHost=ogHostUserHost, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemApn=ogCellModemApn, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApEntry=ogWifiApEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmInstance=ogAlarmInstance, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmLogTable=ogAlarmLogTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialNumber=ogSerialNumber, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientInterface=ogWifiClientInterface, ogAlarmType=ogAlarmType, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserName=ogHostUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApInterface=ogWifiApInterface, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSystem=ogSystem, ogEmdName=ogEmdName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsCounter=ogUpsCounter, ogSerialPortDTR=ogSerialPortDTR, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserTable=ogSerialUserTable, ogWifiApClientTable=ogWifiApClientTable, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityName=ogEmdHumidityName, ogCheckEntry=ogCheckEntry, ogAlarmTime=ogAlarmTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTemperature=ogCellModemTemperature, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsDescription=ogUpsDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientMac=ogWifiApClientMac, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserPort=ogSerialUserPort, ogRpcEntry=ogRpcEntry, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioEmd=ogEmdDioEmd, ogCellModemNetwork=ogCellModemNetwork, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserEntry=ogWebUserEntry, ogEmdDioType=ogEmdDioType, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsTable=ogUpsTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemModel=ogCellModemModel, ogUpsType=ogUpsType, ogCellMessageNotification=ogCellMessageNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserNotification=ogWebUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Groups=ogStatus2Groups)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortParity=ogSerialPortParity, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdEntry=ogEmdEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceName=ogNetInterfaceName, ogCustomNotification=ogCustomNotification, ogAlarmCheck=ogAlarmCheck, ogAlarmState=ogAlarmState, ogUpsInputVoltage=ogUpsInputVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcConnectType=ogRpcConnectType, ogAlarm=ogAlarm, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortTable=ogSerialPortTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellApnNotification=ogCellApnNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckDeviceName=ogCheckDeviceName, ogAlarmDevice=ogAlarmDevice, ogCellModem4gRssi=ogCellModem4gRssi, ogHostTable=ogHostTable, ogHostEntry=ogHostEntry, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcType=ogRpcType, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcIndex=ogRpcIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsNotification=ogUpsNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogMibNotifications=ogMibNotifications, ogWebUserTable=ogWebUserTable, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsEntry=ogUpsEntry, ogUpsInputNotification=ogUpsInputNotification, ogEmdTable=ogEmdTable, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientEssid=ogWifiClientEssid, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmName=ogAlarmName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserHostName=ogHostUserHostName, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioNotification=ogEmdDioNotification, ogUpsName=ogUpsName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent)
