...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioType=ogEmdDioType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortMode=ogSerialPortMode, ogUpsDescription=ogUpsDescription, ogHostServiceType=ogHostServiceType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcConnectType=ogRpcConnectType, ogWifiApTable=ogWifiApTable, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserNotification=ogWebUserNotification, ogWifiClientEssid=ogWifiClientEssid, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTable=ogSerialPortTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmDevice=ogAlarmDevice, ogHostServicePort=ogHostServicePort, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Conformance=ogStatus2Conformance, ogAlarmInstance=ogAlarmInstance, ogRpcOutletState=ogRpcOutletState, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostIndex=ogHostIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmType=ogAlarmType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortParity=ogSerialPortParity, ogSerialSignalNotification=ogSerialSignalNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcTable=ogRpcTable, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserTable=ogHostUserTable, ogAlarmState=ogAlarmState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdIndex=ogEmdIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserTable=ogWebUserTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserName=ogSerialUserName, ogHostUserHost=ogHostUserHost, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdEntry=ogEmdEntry, ogAlarmUser=ogAlarmUser, ogHostName=ogHostName, ogCellMessageNotification=ogCellMessageNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellModemRegistered=ogCellModemRegistered, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceHost=ogHostServiceHost, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDescription=ogEmdDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApFrequency=ogWifiApFrequency, ogStatus2=ogStatus2, ogHostPingNotification=ogHostPingNotification, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryState=ogUpsBatteryState, ogAlarmEventId=ogAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemVendor=ogCellModemVendor, ogEmdDioEmd=ogEmdDioEmd, ogWifiApCounter=ogWifiApCounter, ogUpsTable=ogUpsTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckType=ogCheckType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcIndex=ogRpcIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNotification=ogUpsInputNotification, ogWebUserStartTime=ogWebUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarm=ogAlarm, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsEntry=ogUpsEntry, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogCellModemConnected=ogCellModemConnected, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdEnabled=ogEmdEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsNotification=ogUpsNotification, ogRpcOutletTable=ogRpcOutletTable, ogWebUserName=ogWebUserName, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortCTS=ogSerialPortCTS, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceName=ogNetInterfaceName, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcMaxTemperature=ogRpcMaxTemperature, ogStatus2Groups=ogStatus2Groups, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsState=ogUpsState, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogMibNotifications=ogMibNotifications, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserNotification=ogHostUserNotification, ogRpcName=ogRpcName, ogEmdDioNotification=ogEmdDioNotification, ogHostEntry=ogHostEntry, ogSystem=ogSystem, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcCounter=ogRpcCounter, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckName=ogCheckName, ogEmdDioTable=ogEmdDioTable, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdName=ogEmdName, ogUpsIndex=ogUpsIndex, ogCellModemModel=ogCellModemModel, ogUpsTemperature=ogUpsTemperature, ogHostTable=ogHostTable, ogSerialPortRTS=ogSerialPortRTS, ogCellApnNotification=ogCellApnNotification, ogRpcOutletName=ogRpcOutletName, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdConnectType=ogEmdConnectType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletNotification=ogRpcOutletNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserName=ogHostUserName, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckIndex=ogCheckIndex, ogUpsHumidity=ogUpsHumidity, ogCustomNotification=ogCustomNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemCounter=ogCellModemCounter, ogWifiApIndex=ogWifiApIndex, ogEmdTable=ogEmdTable, ogWifiClientMode=ogWifiClientMode, ogRpcType=ogRpcType, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceStatus=ogHostServiceStatus, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserIndex=ogHostUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmTime=ogAlarmTime, ogSerialPortDSR=ogSerialPortDSR, ogHostUserHostName=ogHostUserHostName, ogCellModemIMSI=ogCellModemIMSI, ogCheckEntry=ogCheckEntry, ogCellModemTower=ogCellModemTower, ogBasicAlarmGroup=ogBasicAlarmGroup, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogEmdDioName=ogEmdDioName, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryTemperature=ogUpsBatteryTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApEnabled=ogWifiApEnabled, ogAlarmName=ogAlarmName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogFirmwareVersion=ogFirmwareVersion, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemApn=ogCellModemApn, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsName=ogUpsName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTable=ogCellModemTable, ogWebUserIndex=ogWebUserIndex, ogHostIpV6Address=ogHostIpV6Address, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckTable=ogCheckTable, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioState=ogEmdDioState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserLabel=ogSerialUserLabel, ogUpsType=ogUpsType, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserTable=ogSerialUserTable, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioEntry=ogEmdDioEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostUserEntry=ogHostUserEntry, ogWifiClientTable=ogWifiClientTable, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputNotification=ogRpcInputNotification, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceIndex=ogCheckDeviceIndex)
