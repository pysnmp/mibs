...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientCounter=ogWifiClientCounter, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityTotal=ogEmdHumidityTotal, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioState=ogEmdDioState, ogUpsTemperature=ogUpsTemperature, ogWebUserEntry=ogWebUserEntry, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientTable=ogWifiClientTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioType=ogEmdDioType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyName=ogPowerSupplyName, ogHostTable=ogHostTable, ogSerialUserTable=ogSerialUserTable, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientMac=ogWifiApClientMac, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmCheck=ogAlarmCheck, ogEmdDioEmd=ogEmdDioEmd, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcTable=ogRpcTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserAddress=ogHostUserAddress, ogWifiApTable=ogWifiApTable, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarm=ogAlarm, ogWebUserNotification=ogWebUserNotification, ogUpsName=ogUpsName, ogHostServiceTable=ogHostServiceTable, ogRpcName=ogRpcName, ogCellModemTable=ogCellModemTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioTable=ogEmdDioTable, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostEntry=ogHostEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserIndex=ogSerialUserIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSystem=ogSystem, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmEventId=ogAlarmEventId, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostIpV6Address=ogHostIpV6Address, ogUpsNotification=ogUpsNotification, ogRpcIndex=ogRpcIndex, ogRpcDescription=ogRpcDescription, ogStatus2=ogStatus2, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceNotification=ogHostServiceNotification, ogUpsCounter=ogUpsCounter, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemTower=ogCellModemTower, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDescription=ogEmdDescription, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortSpeed=ogSerialPortSpeed, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletTotal=ogRpcOutletTotal, ogHostIndex=ogHostIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsConnectType=ogUpsConnectType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialNumber=ogSerialNumber, ogUpsIndex=ogUpsIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemEntry=ogCellModemEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckEntry=ogCheckEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletName=ogRpcOutletName, ogSerialPortParity=ogSerialPortParity, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserTable=ogHostUserTable, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortLabel=ogSerialPortLabel, ogWebUserName=ogWebUserName, ogCellModemCounter=ogCellModemCounter, ogWifiClientIndex=ogWifiClientIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsTable=ogUpsTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcConnectType=ogRpcConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCustomNotification=ogCustomNotification, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogRpcCounter=ogRpcCounter, ogHostUserHost=ogHostUserHost, ogCellModemVendor=ogCellModemVendor, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientMode=ogWifiClientMode, ogHostUserName=ogHostUserName, ogNetInterfaceType=ogNetInterfaceType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserStartTime=ogWebUserStartTime, ogCheckType=ogCheckType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityName=ogEmdHumidityName, ogEmdName=ogEmdName, ogUpsType=ogUpsType, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTable=ogEmdTable, ogEmdConnectType=ogEmdConnectType, ogHostServiceType=ogHostServiceType, ogRpcEntry=ogRpcEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputNotification=ogRpcInputNotification, ogWebUserTable=ogWebUserTable, ogWifiApFrequency=ogWifiApFrequency, ogAlarmType=ogAlarmType, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsState=ogUpsState, ogEmdIndex=ogEmdIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemIMSI=ogCellModemIMSI, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioName=ogEmdDioName, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellApnNotification=ogCellApnNotification, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserNotification=ogSerialUserNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIndex=ogWifiApIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmTime=ogAlarmTime, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletTable=ogRpcOutletTable, ogUpsDescription=ogUpsDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortTable=ogSerialPortTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioCounter=ogEmdDioCounter, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputPower=ogUpsOutputPower, ogHostUserHostName=ogHostUserHostName, ogCheckIndex=ogCheckIndex, ogWifiApTxPower=ogWifiApTxPower, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellSignalNotification=ogCellSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckName=ogCheckName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsEntry=ogUpsEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserPort=ogSerialUserPort, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserName=ogSerialUserName, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogCellDataNotification=ogCellDataNotification, ogCellModemModel=ogCellModemModel, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemIndex=ogCellModemIndex, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmUser=ogAlarmUser, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioNotification=ogEmdDioNotification, ogCheckTable=ogCheckTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEntry=ogWifiClientEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmState=ogAlarmState, ogWifiClientRssi=ogWifiClientRssi, ogEmdEntry=ogEmdEntry, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortCTS=ogSerialPortCTS, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApSsid=ogWifiApSsid, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdEnabled=ogEmdEnabled, ogWifiClientInterface=ogWifiClientInterface, ogAlarmName=ogAlarmName, ogHostUserEntry=ogHostUserEntry, ogMibNotifications=ogMibNotifications, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcType=ogRpcType, ogCellTowerNotification=ogCellTowerNotification, ogHostIpV4Address=ogHostIpV4Address, ogCellModemApn=ogCellModemApn, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortMode=ogSerialPortMode, ogCheckResetTimeout=ogCheckResetTimeout, ogHostName=ogHostName)
