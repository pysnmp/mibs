...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2=ogStatus2, ogWifiClientInterface=ogWifiClientInterface, ogHostUserTable=ogHostUserTable, ogRpcConnectType=ogRpcConnectType, ogSerialUserPort=ogSerialUserPort, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmName=ogAlarmName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserTable=ogWebUserTable, ogHostUserName=ogHostUserName, ogWebUserNotification=ogWebUserNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostIpV4Address=ogHostIpV4Address, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcType=ogRpcType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserLabel=ogSerialUserLabel, ogRpcName=ogRpcName, ogStatus2Groups=ogStatus2Groups, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientTable=ogWifiApClientTable, ogSerialNumber=ogSerialNumber, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserHost=ogHostUserHost, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemCounter=ogCellModemCounter, ogCheckEntry=ogCheckEntry, ogHostServiceCounter=ogHostServiceCounter, ogHostTable=ogHostTable, ogHostUserNotification=ogHostUserNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientMac=ogWifiApClientMac, ogUpsName=ogUpsName, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemModel=ogCellModemModel, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNotification=ogUpsInputNotification, ogRpcEntry=ogRpcEntry, ogCellApnNotification=ogCellApnNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceType=ogHostServiceType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogAlarmInstance=ogAlarmInstance, ogUpsType=ogUpsType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogFirmwareVersion=ogFirmwareVersion, ogEmdConnectType=ogEmdConnectType, ogHostIndex=ogHostIndex, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTable=ogEmdTable, ogEmdIndex=ogEmdIndex, ogAlarmEventId=ogAlarmEventId, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogCellModemIndex=ogCellModemIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioNotification=ogEmdDioNotification, ogEmdEntry=ogEmdEntry, ogHostName=ogHostName, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsTable=ogUpsTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmTime=ogAlarmTime, ogUpsConnectType=ogUpsConnectType, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletName=ogRpcOutletName, ogWifiClientIndex=ogWifiClientIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortCTS=ogSerialPortCTS, ogRpcIndex=ogRpcIndex, ogPowerSupplyName=ogPowerSupplyName, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsNotification=ogUpsNotification, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsHumidity=ogUpsHumidity, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioDescription=ogEmdDioDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostPingNotification=ogHostPingNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckTable=ogCheckTable, ogAlarmState=ogAlarmState, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioTable=ogEmdDioTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmUser=ogAlarmUser, ogWifiApIndex=ogWifiApIndex, ogEmdDioState=ogEmdDioState, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApInterface=ogWifiApInterface, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHostName=ogHostUserHostName, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckIndex=ogCheckIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemTable=ogCellModemTable, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApEntry=ogWifiApEntry, ogRpcCounter=ogRpcCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDescription=ogEmdDescription, ogCellModemApn=ogCellModemApn, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemRegistered=ogCellModemRegistered, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmCheck=ogAlarmCheck, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmType=ogAlarmType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemEntry=ogCellModemEntry, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemVendor=ogCellModemVendor, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioType=ogEmdDioType, ogSerialPortTable=ogSerialPortTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortRTS=ogSerialPortRTS, ogUpsCounter=ogUpsCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientCounter=ogWifiClientCounter, ogSystem=ogSystem, ogSerialPortMode=ogSerialPortMode, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApTable=ogWifiApTable, ogAlarmDevice=ogAlarmDevice, ogWifiClientTable=ogWifiClientTable, ogEmdName=ogEmdName, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortIndex=ogSerialPortIndex, ogCellSignalNotification=ogCellSignalNotification, ogCellModemTower=ogCellModemTower, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsEntry=ogUpsEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceTable=ogHostServiceTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientMode=ogWifiClientMode, ogUpsDescription=ogUpsDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsIndex=ogUpsIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckType=ogCheckType, ogCellModemIMSI=ogCellModemIMSI, ogMibNotifications=ogMibNotifications, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceName=ogNetInterfaceName, ogRpcInputNotification=ogRpcInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTemperature=ogCellModemTemperature, ogRpcTable=ogRpcTable, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApTxPower=ogWifiApTxPower, ogCustomNotification=ogCustomNotification, ogWifiApCounter=ogWifiApCounter, ogWifiApFrequency=ogWifiApFrequency, ogSerialUserName=ogSerialUserName, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceIndex=ogHostServiceIndex, ogHostUserIndex=ogHostUserIndex, ogWebUserName=ogWebUserName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckName=ogCheckName, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortEntry=ogSerialPortEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogTable=ogAlarmLogTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParity=ogSerialPortParity, ogCellModemNetwork=ogCellModemNetwork, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcDescription=ogRpcDescription, ogCellModemConnected=ogCellModemConnected, ogAlarm=ogAlarm, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogHostEntry=ogHostEntry, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserTable=ogSerialUserTable, ogUpsState=ogUpsState, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServicePort=ogHostServicePort)
