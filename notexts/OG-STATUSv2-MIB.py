...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmState=ogCurrentAlarmState, ogRpcCounter=ogRpcCounter, ogWebUserNotification=ogWebUserNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioTable=ogEmdDioTable, ogCheckName=ogCheckName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortEntry=ogSerialPortEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientTable=ogWifiClientTable, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsCounter=ogUpsCounter, ogSerialPortDTR=ogSerialPortDTR, ogAlarmType=ogAlarmType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientApMac=ogWifiClientApMac, ogRpcType=ogRpcType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdName=ogEmdName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemIMSI=ogCellModemIMSI, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceType=ogHostServiceType, ogHostServiceTable=ogHostServiceTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApIndex=ogWifiApIndex, ogEmdDioEntry=ogEmdDioEntry, ogCellModemModel=ogCellModemModel, ogUpsEntry=ogUpsEntry, ogEmdDioType=ogEmdDioType, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceName=ogNetInterfaceName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckEntry=ogCheckEntry, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsName=ogUpsName, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletState=ogRpcOutletState, ogUpsIndex=ogUpsIndex, ogCellModemIndex=ogCellModemIndex, ogSerialNumber=ogSerialNumber, ogWifiApTable=ogWifiApTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioDirection=ogEmdDioDirection, ogEmdIndex=ogEmdIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmTime=ogAlarmTime, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcName=ogRpcName, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmUser=ogAlarmUser, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostPingNotification=ogHostPingNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceIndex=ogHostServiceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckResolveActions=ogCheckResolveActions, ogStatus2=ogStatus2, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientIndex=ogWifiClientIndex, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsDescription=ogUpsDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserName=ogSerialUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTower=ogCellModemTower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortDSR=ogSerialPortDSR, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserTable=ogWebUserTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortTable=ogSerialPortTable, ogWebUserIndex=ogWebUserIndex, ogHostUserName=ogHostUserName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputNotification=ogRpcInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserIndex=ogSerialUserIndex, ogHostUserAddress=ogHostUserAddress, ogCellModemCounter=ogCellModemCounter, ogUpsState=ogUpsState, ogAlarmState=ogAlarmState, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogStatus2Compliance=ogStatus2Compliance, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellDataNotification=ogCellDataNotification, ogEmdEnabled=ogEmdEnabled, ogWebUserEntry=ogWebUserEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostTable=ogHostTable, ogAlarmLogTable=ogAlarmLogTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserEntry=ogHostUserEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcIndex=ogRpcIndex, ogEmdDioName=ogEmdDioName, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsConnectType=ogUpsConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioState=ogEmdDioState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientMac=ogWifiApClientMac, ogWifiApSsid=ogWifiApSsid, ogStatus2Groups=ogStatus2Groups, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortIndex=ogSerialPortIndex, ogHostUserHostName=ogHostUserHostName, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserHost=ogHostUserHost, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletTable=ogRpcOutletTable, ogEmdConnectType=ogEmdConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmName=ogAlarmName, ogRpcConnectType=ogRpcConnectType, ogCheckTable=ogCheckTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcEntry=ogRpcEntry, ogEmdDescription=ogEmdDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApTxPower=ogWifiApTxPower, ogAlarmCheck=ogAlarmCheck, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsTable=ogUpsTable, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceEntry=ogHostServiceEntry, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCustomNotification=ogCustomNotification, ogMibNotifications=ogMibNotifications, ogSystem=ogSystem, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsType=ogUpsType, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostName=ogHostName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemRegistered=ogCellModemRegistered, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserPort=ogSerialUserPort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserLabel=ogSerialUserLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcDescription=ogRpcDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioNotification=ogEmdDioNotification, ogEmdTable=ogEmdTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEntry=ogEmdEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputPower=ogUpsOutputPower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarm=ogAlarm, ogWifiApEntry=ogWifiApEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogHostEntry=ogHostEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmSummary=ogAlarmSummary, ogCellMessageNotification=ogCellMessageNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogCellModemConnected=ogCellModemConnected, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServicePort=ogHostServicePort, ogCellModemTable=ogCellModemTable, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserTable=ogSerialUserTable, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserTable=ogHostUserTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserEntry=ogSerialUserEntry, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceName=ogCheckDeviceName, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTable=ogWifiApClientTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckType=ogCheckType, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcTable=ogRpcTable, ogWifiApCounter=ogWifiApCounter, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostIndex=ogHostIndex, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientMode=ogWifiClientMode, ogCellSignalNotification=ogCellSignalNotification, ogUpsHumidity=ogUpsHumidity, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletName=ogRpcOutletName, ogWebUserName=ogWebUserName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEnabled=ogWifiApEnabled, ogCheckIndex=ogCheckIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCellApnNotification=ogCellApnNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsNotification=ogUpsNotification, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceIndex=ogNetInterfaceIndex)
