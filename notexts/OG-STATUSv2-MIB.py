...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmSummary=ogAlarmSummary, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemTable=ogCellModemTable, ogRpcOutletName=ogRpcOutletName, ogHostUserHost=ogHostUserHost, ogCellModemApn=ogCellModemApn, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputNotification=ogUpsInputNotification, ogCellModemModel=ogCellModemModel, ogEmdConnectType=ogEmdConnectType, ogHostServiceEntry=ogHostServiceEntry, ogAlarm=ogAlarm, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioCounter=ogEmdDioCounter, ogAlarmCheck=ogAlarmCheck, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcIndex=ogRpcIndex, ogHostEntry=ogHostEntry, ogHostUserIndex=ogHostUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostPingNotification=ogHostPingNotification, ogCellApnNotification=ogCellApnNotification, ogWebUserNotification=ogWebUserNotification, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcName=ogRpcName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostName=ogHostName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogFirmwareVersion=ogFirmwareVersion, ogCellModemEnabled=ogCellModemEnabled, ogAlarmName=ogAlarmName, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsDescription=ogUpsDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsHumidity=ogUpsHumidity, ogCheckName=ogCheckName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserTable=ogHostUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyName=ogPowerSupplyName, ogWebUserIndex=ogWebUserIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmDevice=ogAlarmDevice, ogSerialUserPort=ogSerialUserPort, ogWifiApClientMac=ogWifiApClientMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientIndex=ogWifiClientIndex, ogCheckTable=ogCheckTable, ogSerialNumber=ogSerialNumber, ogHostServiceType=ogHostServiceType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientMode=ogWifiClientMode, ogSerialPortMode=ogSerialPortMode, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioState=ogEmdDioState, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceName=ogNetInterfaceName, ogCustomNotification=ogCustomNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogHostTable=ogHostTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApIndex=ogWifiApIndex, ogHostIpV6Address=ogHostIpV6Address, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryState=ogUpsBatteryState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserLabel=ogSerialUserLabel, ogCheckDeviceName=ogCheckDeviceName, ogStatus2Compliance=ogStatus2Compliance, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsType=ogUpsType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortDSR=ogSerialPortDSR, ogCheckIndex=ogCheckIndex, ogWifiApEntry=ogWifiApEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientEssid=ogWifiClientEssid, ogCellModemIMSI=ogCellModemIMSI, ogHostUserStartTime=ogHostUserStartTime, ogHostUserName=ogHostUserName, ogWifiClientCounter=ogWifiClientCounter, ogUpsEntry=ogUpsEntry, ogRpcCounter=ogRpcCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsTemperature=ogUpsTemperature, ogEmdTable=ogEmdTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientBitRate=ogWifiClientBitRate, ogSystem=ogSystem, ogEmdHumidityName=ogEmdHumidityName, ogHostUserEntry=ogHostUserEntry, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServicePort=ogHostServicePort, ogWifiApCounter=ogWifiApCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsIndex=ogUpsIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmType=ogAlarmType, ogCellSignalNotification=ogCellSignalNotification, ogAlarmState=ogAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserName=ogSerialUserName, ogNetInterfaceType=ogNetInterfaceType, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmLogTable=ogAlarmLogTable, ogUpsNotification=ogUpsNotification, ogUpsCounter=ogUpsCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Groups=ogStatus2Groups, PYSNMP_MODULE_ID=ogStatus2, ogUpsName=ogUpsName, ogUpsState=ogUpsState, ogWebUserTable=ogWebUserTable, ogRpcType=ogRpcType, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcEntry=ogRpcEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApSsid=ogWifiApSsid, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcTable=ogRpcTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2=ogStatus2, ogRpcConnectType=ogRpcConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientApMac=ogWifiClientApMac, ogCellModemCounter=ogCellModemCounter, ogWifiApTxPower=ogWifiApTxPower, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceTable=ogHostServiceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmEventId=ogAlarmEventId, ogCheckType=ogCheckType, ogAlarmInstance=ogAlarmInstance, ogSerialPortTable=ogSerialPortTable, ogMibNotifications=ogMibNotifications, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemIndex=ogCellModemIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDescription=ogEmdDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmTime=ogAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemEntry=ogCellModemEntry, ogWebUserName=ogWebUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdName=ogEmdName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmInstance=ogCurrentAlarmInstance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceState=ogNetInterfaceState, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogEmdEntry=ogEmdEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2Compliances=ogStatus2Compliances, ogEmdEnabled=ogEmdEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckEntry=ogCheckEntry, ogHostIndex=ogHostIndex, ogWifiClientTable=ogWifiClientTable, ogUpsOutputPower=ogUpsOutputPower, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTable=ogWifiApClientTable, ogCellTowerNotification=ogCellTowerNotification, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserTable=ogSerialUserTable, ogCellModemConnected=ogCellModemConnected, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTower=ogCellModemTower, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsConnectType=ogUpsConnectType, ogWifiApTable=ogWifiApTable, ogHostServiceHost=ogHostServiceHost, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdIndex=ogEmdIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiApInterface=ogWifiApInterface, ogEmdDioEntry=ogEmdDioEntry, ogRpcDescription=ogRpcDescription, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortParity=ogSerialPortParity, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserNotification=ogSerialUserNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmUser=ogAlarmUser, ogUpsTable=ogUpsTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioName=ogEmdDioName, ogRpcOutletState=ogRpcOutletState, ogEmdDioType=ogEmdDioType, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputVoltage=ogRpcInputVoltage)
