...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserEntry=ogWebUserEntry, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortDTR=ogSerialPortDTR, ogEmdTable=ogEmdTable, ogWifiApEntry=ogWifiApEntry, ogRpcOutletName=ogRpcOutletName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServicePort=ogHostServicePort, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceIndex=ogHostServiceIndex, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceCounter=ogHostServiceCounter, ogWebUserNotification=ogWebUserNotification, ogCellModemTable=ogCellModemTable, ogUpsState=ogUpsState, ogHostServiceHost=ogHostServiceHost, ogStatus2Groups=ogStatus2Groups, ogRpcDescription=ogRpcDescription, ogCellModemModel=ogCellModemModel, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioTable=ogEmdDioTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApInterface=ogWifiApInterface, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserNotification=ogHostUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputFrequency=ogUpsOutputFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdEnabled=ogEmdEnabled, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserLabel=ogSerialUserLabel, ogUpsType=ogUpsType, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcName=ogRpcName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApCounter=ogWifiApCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEssid=ogWifiClientEssid, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckIndex=ogCheckIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceStatus=ogHostServiceStatus, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmEventId=ogAlarmEventId, ogCellNetworkNotification=ogCellNetworkNotification, PYSNMP_MODULE_ID=ogStatus2, ogFirmwareVersion=ogFirmwareVersion, ogUpsTable=ogUpsTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckResolveActions=ogCheckResolveActions, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserPort=ogSerialUserPort, ogSerialNumber=ogSerialNumber, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarm=ogAlarm, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckType=ogCheckType, ogEmdName=ogEmdName, ogHostUserHostName=ogHostUserHostName, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellApnNotification=ogCellApnNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemApn=ogCellModemApn, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcIndex=ogRpcIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemEntry=ogCellModemEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceTable=ogHostServiceTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientTable=ogWifiApClientTable, ogAlarmUser=ogAlarmUser, ogAlarmTime=ogAlarmTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceState=ogNetInterfaceState, ogCheckTable=ogCheckTable, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcTable=ogRpcTable, ogSerialUserName=ogSerialUserName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsName=ogUpsName, ogUpsTemperature=ogUpsTemperature, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioType=ogEmdDioType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioDescription=ogEmdDioDescription, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDSR=ogSerialPortDSR, ogHostName=ogHostName, ogAlarmState=ogAlarmState, ogEmdDescription=ogEmdDescription, ogCellModemVendor=ogCellModemVendor, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogMibNotifications=ogMibNotifications, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioName=ogEmdDioName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCustomNotification=ogCustomNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserName=ogHostUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApTxPower=ogWifiApTxPower, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceNotification=ogHostServiceNotification, ogUpsDescription=ogUpsDescription, ogUpsConnectType=ogUpsConnectType, ogWifiApSsid=ogWifiApSsid, ogUpsIndex=ogUpsIndex, ogHostEntry=ogHostEntry, ogRpcEntry=ogRpcEntry, ogUpsHumidity=ogUpsHumidity, ogEmdEntry=ogEmdEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientTable=ogWifiClientTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogSystem=ogSystem, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceType=ogHostServiceType, ogUpsEntry=ogUpsEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmInstance=ogAlarmInstance, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostTable=ogHostTable, ogSerialPortTable=ogSerialPortTable, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemTemperature=ogCellModemTemperature, ogCheckName=ogCheckName, ogSerialPortLabel=ogSerialPortLabel, ogAlarmType=ogAlarmType, ogUpsNotification=ogUpsNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityValue=ogEmdHumidityValue, ogHostIndex=ogHostIndex, ogRpcType=ogRpcType, ogRpcOutletTable=ogRpcOutletTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserTable=ogHostUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApTable=ogWifiApTable, ogWifiClientMode=ogWifiClientMode, ogCellModemConnected=ogCellModemConnected)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserIndex=ogSerialUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTower=ogCellModemTower, ogCellTowerNotification=ogCellTowerNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckEntry=ogCheckEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyName=ogPowerSupplyName, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserEntry=ogHostUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogWebUserTable=ogWebUserTable, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientInterface=ogWifiClientInterface, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortMode=ogSerialPortMode, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcCounter=ogRpcCounter, ogHostUserStartTime=ogHostUserStartTime, ogHostPingNotification=ogHostPingNotification, ogCellModemCounter=ogCellModemCounter, ogAlarmName=ogAlarmName, ogSerialPortParity=ogSerialPortParity, ogAlarmCheck=ogAlarmCheck, ogAlarmSummary=ogAlarmSummary, ogSerialUserEntry=ogSerialUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureName=ogEmdTemperatureName, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2=ogStatus2, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcConnectType=ogRpcConnectType, ogEmdIndex=ogEmdIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioState=ogEmdDioState, ogCellDataNotification=ogCellDataNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogWebUserName=ogWebUserName, ogWifiApIndex=ogWifiApIndex, ogHostUserHost=ogHostUserHost)
