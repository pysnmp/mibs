...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioState=ogEmdDioState, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsType=ogUpsType, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcName=ogRpcName, ogRpcIndex=ogRpcIndex, ogPowerSupplyName=ogPowerSupplyName, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdConnectType=ogEmdConnectType, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogHostTable=ogHostTable, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdIndex=ogEmdIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmEventId=ogAlarmEventId, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmCheck=ogAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogFirmwareVersion=ogFirmwareVersion, ogUpsNotification=ogUpsNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckIndex=ogCheckIndex, ogUpsInputNotification=ogUpsInputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDescription=ogEmdDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmSummary=ogAlarmSummary, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostIpV6Address=ogHostIpV6Address, ogHostUserAddress=ogHostUserAddress, PYSNMP_MODULE_ID=ogStatus2, ogAlarmName=ogAlarmName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortMode=ogSerialPortMode, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioIndex=ogEmdDioIndex, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceName=ogCheckDeviceName, ogCellModemConnected=ogCellModemConnected, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioType=ogEmdDioType, ogWifiApEntry=ogWifiApEntry, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortIndex=ogSerialPortIndex, ogCellModemTower=ogCellModemTower, ogHostServiceIndex=ogHostServiceIndex, ogAlarmState=ogAlarmState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiApIndex=ogWifiApIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcTable=ogRpcTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2=ogStatus2, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientTable=ogWifiClientTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemEntry=ogCellModemEntry, ogCheckName=ogCheckName, ogWebUserIndex=ogWebUserIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckEntry=ogCheckEntry, ogHostUserNotification=ogHostUserNotification, ogMibNotifications=ogMibNotifications, ogSerialUserPort=ogSerialUserPort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcType=ogRpcType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApTable=ogWifiApTable, ogCellModemCounter=ogCellModemCounter, ogAlarmInstance=ogAlarmInstance, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogTable=ogAlarmLogTable, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmUser=ogAlarmUser, ogCheckType=ogCheckType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortRTS=ogSerialPortRTS, ogUpsState=ogUpsState, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemApn=ogCellModemApn, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarm=ogAlarm, ogCheckResolveActions=ogCheckResolveActions, ogHostName=ogHostName, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemVendor=ogCellModemVendor, ogHostUserHost=ogHostUserHost, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliance=ogStatus2Compliance, ogHostUserHostName=ogHostUserHostName, ogWifiClientEntry=ogWifiClientEntry, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioName=ogEmdDioName, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceType=ogNetInterfaceType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcDescription=ogRpcDescription, ogUpsIndex=ogUpsIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientMode=ogWifiClientMode, ogRpcCounter=ogRpcCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogAlarmTime=ogAlarmTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsDescription=ogUpsDescription, ogEmdDioTable=ogEmdDioTable, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsTemperature=ogUpsTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserIndex=ogHostUserIndex, ogCellModemTable=ogCellModemTable, ogWebUserStartTime=ogWebUserStartTime, ogCustomNotification=ogCustomNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcConnectType=ogRpcConnectType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialNumber=ogSerialNumber, ogCellModemIMSI=ogCellModemIMSI, ogWebUserEntry=ogWebUserEntry, ogWebUserName=ogWebUserName, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemIndex=ogCellModemIndex, ogEmdName=ogEmdName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcEntry=ogRpcEntry, ogCellDataNotification=ogCellDataNotification, ogWifiApInterface=ogWifiApInterface, ogCellModemModel=ogCellModemModel, ogUpsTable=ogUpsTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceType=ogHostServiceType, ogUpsName=ogUpsName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserNotification=ogWebUserNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdEntry=ogEmdEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientTxPower=ogWifiClientTxPower, ogSystem=ogSystem, ogHostServiceTable=ogHostServiceTable, ogSerialUserLabel=ogSerialUserLabel, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserTable=ogSerialUserTable, ogHostServiceHost=ogHostServiceHost)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostPingNotification=ogHostPingNotification, ogCheckTable=ogCheckTable, ogHostServicePort=ogHostServicePort, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserTable=ogHostUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceCounter=ogHostServiceCounter, ogUpsHumidity=ogUpsHumidity, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserTable=ogWebUserTable, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortTable=ogSerialPortTable, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserName=ogHostUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTable=ogEmdTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityName=ogEmdHumidityName, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortDCD=ogSerialPortDCD, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserName=ogSerialUserName, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostEntry=ogHostEntry, ogHostIndex=ogHostIndex, ogAlarmType=ogAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientCounter=ogWifiClientCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemRadioTechnology=ogCellModemRadioTechnology)
