...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsConnectType=ogUpsConnectType, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsIndex=ogUpsIndex, ogCellModemTower=ogCellModemTower, ogCheckType=ogCheckType, ogUpsInputNotification=ogUpsInputNotification, ogCellModemApn=ogCellModemApn, ogSerialPortDSR=ogSerialPortDSR, ogUpsState=ogUpsState, ogWifiClientTable=ogWifiClientTable, ogWebUserIndex=ogWebUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmUser=ogAlarmUser, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcDescription=ogRpcDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Compliance=ogStatus2Compliance, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsType=ogUpsType, ogHostUserStartTime=ogHostUserStartTime, ogRpcTable=ogRpcTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientTxPower=ogWifiClientTxPower, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsDescription=ogUpsDescription, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserIndex=ogHostUserIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserTable=ogSerialUserTable, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioNotification=ogEmdDioNotification, ogHostUserAddress=ogHostUserAddress, ogRpcOutletName=ogRpcOutletName, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcName=ogRpcName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserNotification=ogHostUserNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDescription=ogEmdDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemTable=ogCellModemTable, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceHost=ogHostServiceHost, ogEmdDioState=ogEmdDioState, ogCheckIndex=ogCheckIndex, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortParity=ogSerialPortParity, ogWifiClientEntry=ogWifiClientEntry, ogCellTowerNotification=ogCellTowerNotification, ogHostName=ogHostName, ogRpcConnectType=ogRpcConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserName=ogSerialUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmLogTable=ogAlarmLogTable, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSystem=ogSystem, ogHostPingNotification=ogHostPingNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemNetwork=ogCellModemNetwork, ogHostEntry=ogHostEntry, ogAlarmState=ogAlarmState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdEntry=ogEmdEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsHumidity=ogUpsHumidity, ogWifiApEntry=ogWifiApEntry, ogWebUserEntry=ogWebUserEntry, ogHostTable=ogHostTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsNotification=ogUpsNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCellMessageNotification=ogCellMessageNotification, ogHostUserHost=ogHostUserHost, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortDCD=ogSerialPortDCD, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserName=ogHostUserName, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioName=ogEmdDioName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioType=ogEmdDioType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApFrequency=ogWifiApFrequency, ogCellModemEnabled=ogCellModemEnabled, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemIMSI=ogCellModemIMSI, ogAlarmName=ogAlarmName, ogHostIndex=ogHostIndex, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogFirmwareVersion=ogFirmwareVersion, ogEmdTable=ogEmdTable, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserNotification=ogWebUserNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmSummary=ogAlarmSummary, ogSerialUserPort=ogSerialUserPort, ogSerialUserLabel=ogSerialUserLabel, ogCellApnNotification=ogCellApnNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmEventId=ogAlarmEventId, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApSsid=ogWifiApSsid, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceTable=ogHostServiceTable, ogStatus2=ogStatus2, ogHostUserHostName=ogHostUserHostName, ogUpsEntry=ogUpsEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemModel=ogCellModemModel, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientTable=ogWifiApClientTable, ogWebUserName=ogWebUserName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletState=ogRpcOutletState, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsTable=ogUpsTable, ogCellModemCounter=ogCellModemCounter, ogHostServiceEntry=ogHostServiceEntry, ogUpsCounter=ogUpsCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortRTS=ogSerialPortRTS, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientCounter=ogWifiClientCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserTable=ogHostUserTable, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortMode=ogSerialPortMode, ogAlarmDevice=ogAlarmDevice, ogHostServicePort=ogHostServicePort, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserIndex=ogSerialUserIndex, ogSerialNumber=ogSerialNumber, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmType=ogAlarmType, ogWifiApTxPower=ogWifiApTxPower, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmTime=ogAlarmTime, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputNotification=ogRpcInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsName=ogUpsName, ogEmdDioEmd=ogEmdDioEmd, ogCustomNotification=ogCustomNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemIndex=ogCellModemIndex, ogRpcOutletTable=ogRpcOutletTable, ogMibNotifications=ogMibNotifications, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckEntry=ogCheckEntry, ogCellDataNotification=ogCellDataNotification, ogStatus2Groups=ogStatus2Groups, ogWebUserTable=ogWebUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmCheck=ogAlarmCheck, ogCheckName=ogCheckName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceType=ogHostServiceType, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientMode=ogWifiClientMode, ogAlarm=ogAlarm, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdName=ogEmdName, ogAlarmInstance=ogAlarmInstance, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemEntry=ogCellModemEntry, ogRpcIndex=ogRpcIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsTemperature=ogUpsTemperature, ogHostUserEntry=ogHostUserEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTemperature=ogCellModemTemperature, ogWifiApTable=ogWifiApTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcCounter=ogRpcCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckTable=ogCheckTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdIndex=ogEmdIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTable=ogSerialPortTable, ogRpcEntry=ogRpcEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets)
