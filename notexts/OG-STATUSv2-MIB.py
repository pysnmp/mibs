...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemModel=ogCellModemModel, ogEmdDioName=ogEmdDioName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdIndex=ogEmdIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApTable=ogWifiApTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialNumber=ogSerialNumber, ogSerialUserEntry=ogSerialUserEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletNotification=ogRpcOutletNotification, ogCellTowerNotification=ogCellTowerNotification, ogAlarmSummary=ogAlarmSummary, ogRpcOutletTable=ogRpcOutletTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmInstance=ogAlarmInstance, ogUpsTemperature=ogUpsTemperature, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputPower=ogUpsOutputPower, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTable=ogEmdTable, ogSerialPortTable=ogSerialPortTable, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellApnNotification=ogCellApnNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdEntry=ogEmdEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceHost=ogHostServiceHost, ogHostUserIndex=ogHostUserIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckName=ogCheckName, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioTable=ogEmdDioTable, ogAlarmCheck=ogAlarmCheck, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostTable=ogHostTable, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemVendor=ogCellModemVendor, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckType=ogCheckType, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceEntry=ogHostServiceEntry, ogRpcDescription=ogRpcDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcConnectType=ogRpcConnectType, ogUpsIndex=ogUpsIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserNotification=ogWebUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserTable=ogHostUserTable, ogEmdName=ogEmdName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientIndex=ogWifiClientIndex, ogWebUserTable=ogWebUserTable, ogCellModemRegistered=ogCellModemRegistered, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsTable=ogUpsTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortLabel=ogSerialPortLabel, ogHostServicePort=ogHostServicePort, ogAlarmName=ogAlarmName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAuthNotification=ogWifiApAuthNotification, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckTable=ogCheckTable, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckEntry=ogCheckEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogMibNotifications=ogMibNotifications, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSystem=ogSystem, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostPingNotification=ogHostPingNotification, ogCheckIndex=ogCheckIndex, ogAlarm=ogAlarm, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceType=ogHostServiceType, ogUpsName=ogUpsName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserAddress=ogHostUserAddress, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRssi=ogWifiClientRssi, ogHostName=ogHostName, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortMode=ogSerialPortMode, ogHostServiceIndex=ogHostServiceIndex, ogEmdDescription=ogEmdDescription, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostIpV4Address=ogHostIpV4Address, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsNotification=ogUpsNotification, ogEmdHumidityName=ogEmdHumidityName, ogUpsCounter=ogUpsCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2=ogStatus2, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIndex=ogWifiApIndex, ogHostUserEntry=ogHostUserEntry, ogSerialUserPort=ogSerialUserPort, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientMac=ogWifiApClientMac, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientApMac=ogWifiClientApMac, ogHostUserName=ogHostUserName, ogHostUserNotification=ogHostUserNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsEntry=ogUpsEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioType=ogEmdDioType, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserHostName=ogHostUserHostName, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemTower=ogCellModemTower, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckDeviceName=ogCheckDeviceName, ogCellModemNetwork=ogCellModemNetwork, ogWebUserStartTime=ogWebUserStartTime, ogUpsState=ogUpsState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcType=ogRpcType, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserName=ogSerialUserName, ogStatus2Groups=ogStatus2Groups, ogCheckResolveActions=ogCheckResolveActions, ogCellModemIndex=ogCellModemIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletEntry=ogRpcOutletEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcName=ogRpcName, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserHost=ogHostUserHost, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCustomNotification=ogCustomNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiApInterface=ogWifiApInterface, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmState=ogCurrentAlarmState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserIndex=ogWebUserIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserName=ogWebUserName, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioState=ogEmdDioState, ogRpcInputVoltage=ogRpcInputVoltage, ogHostEntry=ogHostEntry, ogEmdEnabled=ogEmdEnabled, ogUpsHumidity=ogUpsHumidity, ogCellModemApn=ogCellModemApn, ogAlarmUser=ogAlarmUser, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientTable=ogWifiClientTable, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcEntry=ogRpcEntry, ogStatus2Conformance=ogStatus2Conformance, ogCellModemTable=ogCellModemTable, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemEntry=ogCellModemEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApEnabled=ogWifiApEnabled, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientCounter=ogWifiClientCounter, ogRpcIndex=ogRpcIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientEntry=ogWifiClientEntry, ogUpsType=ogUpsType, ogCellSignalNotification=ogCellSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsDescription=ogUpsDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogCellDataNotification=ogCellDataNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmState=ogAlarmState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmType=ogAlarmType, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApSsid=ogWifiApSsid, ogRpcCounter=ogRpcCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIndex=ogHostIndex, ogRpcTable=ogRpcTable, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientInterface=ogWifiClientInterface)
