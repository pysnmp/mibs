...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsTable=ogUpsTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemApn=ogCellModemApn, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2Groups=ogStatus2Groups, ogWifiApEnabled=ogWifiApEnabled, ogRpcConnectType=ogRpcConnectType, ogCellModemVendor=ogCellModemVendor, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserNotification=ogWebUserNotification, ogEmdDioNotification=ogEmdDioNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmType=ogCurrentAlarmType, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceTable=ogHostServiceTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdIndex=ogEmdIndex, ogCheckType=ogCheckType, ogCellApnNotification=ogCellApnNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCheck=ogAlarmCheck, ogHostPingNotification=ogHostPingNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserName=ogWebUserName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientIndex=ogWifiClientIndex, ogEmdConnectType=ogEmdConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceType=ogHostServiceType, ogCellModemTower=ogCellModemTower, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmSummary=ogAlarmSummary, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmName=ogAlarmName, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIndex=ogHostIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceCounter=ogHostServiceCounter, ogHostEntry=ogHostEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityName=ogEmdHumidityName, ogHostUserEntry=ogHostUserEntry, ogWifiApInterface=ogWifiApInterface, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserAddress=ogHostUserAddress, ogRpcDescription=ogRpcDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryState=ogUpsBatteryState, ogCustomNotification=ogCustomNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellDataNotification=ogCellDataNotification, ogRpcEntry=ogRpcEntry, ogSerialPortMode=ogSerialPortMode, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmType=ogAlarmType, ogCellModemNetwork=ogCellModemNetwork, ogWifiApTxPower=ogWifiApTxPower, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserHost=ogHostUserHost, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsType=ogUpsType, ogRpcName=ogRpcName, ogEmdDioState=ogEmdDioState, ogWifiApSsid=ogWifiApSsid, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcIndex=ogRpcIndex, ogHostUserNotification=ogHostUserNotification, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialNumber=ogSerialNumber, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortEntry=ogSerialPortEntry, ogCellModemEntry=ogCellModemEntry, ogHostUserTable=ogHostUserTable, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApTable=ogWifiApTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiApIndex=ogWifiApIndex, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTime=ogCurrentAlarmTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletLoad=ogRpcOutletLoad, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortTable=ogSerialPortTable, ogWebUserIndex=ogWebUserIndex, ogAlarmUser=ogAlarmUser, ogEmdEnabled=ogEmdEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletState=ogRpcOutletState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEntry=ogWifiClientEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostName=ogHostName, ogWebUserEntry=ogWebUserEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcCounter=ogRpcCounter, ogEmdTable=ogEmdTable, ogUpsState=ogUpsState, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsNotification=ogUpsNotification, ogHostUserHostName=ogHostUserHostName, ogCellModemModel=ogCellModemModel, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioName=ogEmdDioName, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmState=ogAlarmState, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEntry=ogEmdDioEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdEntry=ogEmdEntry, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserTable=ogSerialUserTable, ogSerialPortParity=ogSerialPortParity, ogCheckEntry=ogCheckEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckName=ogCheckName, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdName=ogEmdName, ogHostTable=ogHostTable, ogCellModemEnabled=ogCellModemEnabled, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyName=ogPowerSupplyName, ogCheckIndex=ogCheckIndex, ogSerialUserPort=ogSerialUserPort, ogRpcType=ogRpcType, ogUpsDescription=ogUpsDescription, ogNetInterfaceState=ogNetInterfaceState, ogEmdDescription=ogEmdDescription, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemTable=ogCellModemTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIndex=ogCellModemIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApEntry=ogWifiApEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsEntry=ogUpsEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmDevice=ogAlarmDevice, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcTable=ogRpcTable, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioType=ogEmdDioType, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsIndex=ogUpsIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmTime=ogAlarmTime, ogHostServiceStatus=ogHostServiceStatus, ogHostUserIndex=ogHostUserIndex, ogEmdDioTable=ogEmdDioTable, ogUpsOutputLoad=ogUpsOutputLoad, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogStatus2=ogStatus2, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserTable=ogWebUserTable, ogHostServicePort=ogHostServicePort, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientMode=ogWifiClientMode, ogSerialUserIndex=ogSerialUserIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserName=ogHostUserName, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcInputNotification=ogRpcInputNotification, ogWifiApCounter=ogWifiApCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserName=ogSerialUserName, ogAlarmEventId=ogAlarmEventId, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceName=ogNetInterfaceName, ogSystem=ogSystem, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsName=ogUpsName, ogSerialPortDTR=ogSerialPortDTR, ogCheckTable=ogCheckTable, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarm=ogAlarm, ogMibNotifications=ogMibNotifications, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate)
