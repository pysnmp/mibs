...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortDTR=ogSerialPortDTR, ogCellModemRegistered=ogCellModemRegistered, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsIndex=ogUpsIndex, ogRpcEntry=ogRpcEntry, ogEmdHumidityName=ogEmdHumidityName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDescription=ogEmdDioDescription, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckIndex=ogCheckIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPatternNotification=ogSerialPatternNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdDescription=ogEmdDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcType=ogRpcType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserTable=ogWebUserTable, ogFirmwareVersion=ogFirmwareVersion, ogRpcCounter=ogRpcCounter, ogWifiClientInterface=ogWifiClientInterface, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemConnected=ogCellModemConnected, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemEntry=ogCellModemEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserEntry=ogHostUserEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApCounter=ogWifiApCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdConnectType=ogEmdConnectType, ogCellMessageNotification=ogCellMessageNotification, ogWebUserEntry=ogWebUserEntry, ogCellModemModel=ogCellModemModel, ogRpcOutletName=ogRpcOutletName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortIndex=ogSerialPortIndex, ogUpsNotification=ogUpsNotification, ogEmdTable=ogEmdTable, ogUpsTable=ogUpsTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserHost=ogHostUserHost, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcDescription=ogRpcDescription, PYSNMP_MODULE_ID=ogStatus2, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcConnectType=ogRpcConnectType, ogHostServicePort=ogHostServicePort, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientApMac=ogWifiClientApMac, ogHostUserIndex=ogHostUserIndex, ogEmdDioEmd=ogEmdDioEmd, ogCheckEntry=ogCheckEntry, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDSR=ogSerialPortDSR, ogCellModemApn=ogCellModemApn, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmState=ogAlarmState, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmTime=ogAlarmTime, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsTemperature=ogUpsTemperature, ogWifiApTable=ogWifiApTable, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdName=ogEmdName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsState=ogUpsState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserPort=ogSerialUserPort, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioIndex=ogEmdDioIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortLabel=ogSerialPortLabel, ogAlarmDevice=ogAlarmDevice, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortParity=ogSerialPortParity, ogCellModemVendor=ogCellModemVendor, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyName=ogPowerSupplyName, ogHostIndex=ogHostIndex, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceState=ogNetInterfaceState, ogHostIpV4Address=ogHostIpV4Address, ogCheckTable=ogCheckTable, ogSerialUserTable=ogSerialUserTable, ogSystem=ogSystem, ogHostServiceType=ogHostServiceType, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioName=ogEmdDioName, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientTable=ogWifiClientTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogMibNotifications=ogMibNotifications, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostPingNotification=ogHostPingNotification, ogCellSignalNotification=ogCellSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientCounter=ogWifiClientCounter, ogUpsName=ogUpsName, ogHostUserTable=ogHostUserTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsDescription=ogUpsDescription, ogEmdDioNotification=ogEmdDioNotification, ogWifiApEnabled=ogWifiApEnabled, ogWifiApIndex=ogWifiApIndex, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletState=ogRpcOutletState, ogAlarmSummary=ogAlarmSummary, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcIndex=ogRpcIndex, ogSerialNumber=ogSerialNumber, ogRpcName=ogRpcName, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsConnectType=ogUpsConnectType, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmUser=ogAlarmUser, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCustomNotification=ogCustomNotification, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellTowerNotification=ogCellTowerNotification, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserNotification=ogWebUserNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellDataNotification=ogCellDataNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemIndex=ogCellModemIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsEntry=ogUpsEntry, ogSerialPortRTS=ogSerialPortRTS, ogHostTable=ogHostTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdIndex=ogEmdIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserAddress=ogHostUserAddress, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceTable=ogHostServiceTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortMode=ogSerialPortMode, ogWifiApEntry=ogWifiApEntry, ogHostUserName=ogHostUserName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsType=ogUpsType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortTable=ogSerialPortTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemTower=ogCellModemTower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostName=ogHostName, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemIMSI=ogCellModemIMSI)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientMac=ogWifiApClientMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserHostName=ogHostUserHostName, ogCellModemNetwork=ogCellModemNetwork, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRssi=ogWifiClientRssi, ogStatus2=ogStatus2, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserName=ogWebUserName, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckName=ogCheckName, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmCheck=ogAlarmCheck, ogCheckType=ogCheckType, ogWebUserStartTime=ogWebUserStartTime, ogEmdEnabled=ogEmdEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryState=ogUpsBatteryState, ogAlarmType=ogAlarmType, ogSerialUserName=ogSerialUserName, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcTable=ogRpcTable, ogWifiClientMode=ogWifiClientMode, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsCounter=ogUpsCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceHost=ogHostServiceHost, ogHostServiceEntry=ogHostServiceEntry, ogAlarmName=ogAlarmName, ogEmdDioType=ogEmdDioType, ogNetInterfaceType=ogNetInterfaceType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEssid=ogWifiClientEssid, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemTemperature=ogCellModemTemperature, ogAlarm=ogAlarm, ogEmdDioState=ogEmdDioState, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdEntry=ogEmdEntry, ogAlarmInstance=ogAlarmInstance, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTable=ogCellModemTable, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellApnNotification=ogCellApnNotification)
