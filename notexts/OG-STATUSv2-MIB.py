...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmDevice=ogAlarmDevice, ogRpcType=ogRpcType, ogRpcInputNotification=ogRpcInputNotification, ogUpsHumidity=ogUpsHumidity, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemCounter=ogCellModemCounter, ogCellModemIMSI=ogCellModemIMSI, ogUpsName=ogUpsName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarm=ogAlarm, ogWifiApClientTable=ogWifiApClientTable, ogCellModemTable=ogCellModemTable, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServicePort=ogHostServicePort, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioType=ogEmdDioType, ogSerialUserIndex=ogSerialUserIndex, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceIndex=ogHostServiceIndex, ogHostUserStartTime=ogHostUserStartTime, ogUpsNotification=ogUpsNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogHostPingNotification=ogHostPingNotification, ogSerialPortMode=ogSerialPortMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputNotification=ogUpsInputNotification, ogCellModemTower=ogCellModemTower, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmType=ogAlarmType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckType=ogCheckType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcTable=ogRpcTable, ogCellApnNotification=ogCellApnNotification, ogWebUserTable=ogWebUserTable, ogUpsCounter=ogUpsCounter, ogCellModemIndex=ogCellModemIndex, ogWifiApTable=ogWifiApTable, ogCheckName=ogCheckName, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserNotification=ogSerialUserNotification, ogAlarmTime=ogAlarmTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceEntry=ogHostServiceEntry, ogStatus2Conformance=ogStatus2Conformance, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioDirection=ogEmdDioDirection, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientRssi=ogWifiClientRssi, ogRpcDescription=ogRpcDescription, ogEmdDioName=ogEmdDioName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmEventId=ogAlarmEventId, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemTemperature=ogCellModemTemperature, ogHostIndex=ogHostIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputPower=ogUpsOutputPower, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemEntry=ogCellModemEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortParity=ogSerialPortParity, ogHostServiceHost=ogHostServiceHost, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDSR=ogSerialPortDSR, ogMibNotifications=ogMibNotifications, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserEntry=ogHostUserEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceType=ogHostServiceType, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletName=ogRpcOutletName, ogHostName=ogHostName, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsConnectType=ogUpsConnectType, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceName=ogCheckDeviceName, PYSNMP_MODULE_ID=ogStatus2, ogEmdIndex=ogEmdIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmCheck=ogAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcEntry=ogRpcEntry, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserNotification=ogWebUserNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientAp=ogWifiApClientAp, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioTable=ogEmdDioTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientMode=ogWifiClientMode, ogEmdDescription=ogEmdDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsTable=ogUpsTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckTable=ogCheckTable, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioState=ogEmdDioState, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogHostEntry=ogHostEntry, ogWebUserEntry=ogWebUserEntry, ogEmdName=ogEmdName, ogAlarmState=ogAlarmState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserIndex=ogWebUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2=ogStatus2, ogUpsIndex=ogUpsIndex, ogCheckIndex=ogCheckIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemConnected=ogCellModemConnected, ogHostTable=ogHostTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTable=ogEmdTable, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserNotification=ogHostUserNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckEntry=ogCheckEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserHost=ogHostUserHost, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmLogTable=ogAlarmLogTable, ogHostUserName=ogHostUserName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemModel=ogCellModemModel, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsEntry=ogUpsEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogHostUserTable=ogHostUserTable, ogCellModemNetwork=ogCellModemNetwork, ogRpcIndex=ogRpcIndex, ogWifiApSsid=ogWifiApSsid, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApInterface=ogWifiApInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostUserIndex=ogHostUserIndex, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortIndex=ogSerialPortIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialNumber=ogSerialNumber, ogUpsType=ogUpsType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioDescription=ogEmdDioDescription, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceTable=ogHostServiceTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioNotification=ogEmdDioNotification, ogAlarmName=ogAlarmName, ogWifiApEnabled=ogWifiApEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserAddress=ogHostUserAddress, ogCellModemRegistered=ogCellModemRegistered, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientTable=ogWifiClientTable, ogRpcCounter=ogRpcCounter, ogAlarmUser=ogAlarmUser, ogHostServiceNotification=ogHostServiceNotification, ogCellTowerNotification=ogCellTowerNotification, ogCellModemApn=ogCellModemApn, ogEmdDioIndex=ogEmdDioIndex, ogWifiApIndex=ogWifiApIndex, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRTS=ogSerialPortRTS, ogWebUserName=ogWebUserName, ogUpsTemperature=ogUpsTemperature, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdEntry=ogEmdEntry, ogEmdDioEmd=ogEmdDioEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserName=ogSerialUserName, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsState=ogUpsState, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcName=ogRpcName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSystem=ogSystem, ogWifiApCounter=ogWifiApCounter, ogCustomNotification=ogCustomNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientApMac=ogWifiClientApMac, ogUpsDescription=ogUpsDescription)
