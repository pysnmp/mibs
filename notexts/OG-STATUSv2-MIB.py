...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceTable=ogHostServiceTable, ogUpsType=ogUpsType, ogEmdIndex=ogEmdIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientIndex=ogWifiClientIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserName=ogWebUserName, ogEmdDioEmd=ogEmdDioEmd, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsState=ogUpsState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioNotification=ogEmdDioNotification, ogWebUserTable=ogWebUserTable, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcTable=ogRpcTable, ogSerialPortMode=ogSerialPortMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputVoltage=ogUpsInputVoltage, ogHostServicePort=ogHostServicePort, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApTable=ogWifiApTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiApInterface=ogWifiApInterface, ogSystem=ogSystem, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCustomNotification=ogCustomNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCellModemEntry=ogCellModemEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostEntry=ogHostEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserName=ogSerialUserName, ogAlarmName=ogAlarmName, ogCellDataNotification=ogCellDataNotification, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApSsid=ogWifiApSsid, ogStatus2Compliances=ogStatus2Compliances, ogCellModemConnected=ogCellModemConnected, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogMibNotifications=ogMibNotifications, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDescription=ogEmdDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemVendor=ogCellModemVendor, ogUpsTable=ogUpsTable, ogEmdDioName=ogEmdDioName, ogRpcType=ogRpcType, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletState=ogRpcOutletState, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcEntry=ogRpcEntry, ogAlarmUser=ogAlarmUser, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckType=ogCheckType, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdEntry=ogEmdEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsName=ogUpsName, ogUpsConnectType=ogUpsConnectType, ogWebUserNotification=ogWebUserNotification, ogUpsOutputPower=ogUpsOutputPower, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRTS=ogSerialPortRTS, ogHostUserHostName=ogHostUserHostName, ogEmdDioState=ogEmdDioState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientMode=ogWifiClientMode, ogHostUserTable=ogHostUserTable, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletName=ogRpcOutletName, ogStatus2Groups=ogStatus2Groups, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcIndex=ogRpcIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmCheck=ogAlarmCheck, ogWifiApIndex=ogWifiApIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserIndex=ogSerialUserIndex, ogHostPingNotification=ogHostPingNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmType=ogAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcName=ogRpcName, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmSummary=ogAlarmSummary, ogAlarmState=ogAlarmState, ogHostUserStartTime=ogHostUserStartTime, ogEmdName=ogEmdName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellApnNotification=ogCellApnNotification, ogHostIndex=ogHostIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTable=ogEmdTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogCheckTable=ogCheckTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsTemperature=ogUpsTemperature, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTable=ogSerialPortTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTower=ogCellModemTower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemModel=ogCellModemModel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApEntry=ogWifiApEntry, ogWebUserEntry=ogWebUserEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApCounter=ogWifiApCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogRpcCounter=ogRpcCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserAddress=ogHostUserAddress, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserHost=ogHostUserHost, ogSerialPortDCD=ogSerialPortDCD, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRssi=ogWifiClientRssi, ogCellModemIndex=ogCellModemIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserNotification=ogHostUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryState=ogUpsBatteryState, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserEntry=ogHostUserEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsNotification=ogUpsNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarm=ogAlarm, ogSerialNumber=ogSerialNumber, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioType=ogEmdDioType, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserSourceAddress=ogWebUserSourceAddress)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortParity=ogSerialPortParity, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceHost=ogHostServiceHost, ogUpsCounter=ogUpsCounter, ogStatus2=ogStatus2, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceType=ogNetInterfaceType, ogCellModemTable=ogCellModemTable, ogHostServiceStatus=ogHostServiceStatus, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsDescription=ogUpsDescription, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemCounter=ogCellModemCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserTable=ogSerialUserTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientEssid=ogWifiClientEssid, ogAlarmTime=ogAlarmTime, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostName=ogHostName, ogHostUserName=ogHostUserName, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemApn=ogCellModemApn, ogSerialUserPort=ogSerialUserPort, ogHostServiceType=ogHostServiceType, ogRpcDescription=ogRpcDescription, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientInterface=ogWifiClientInterface, ogUpsEntry=ogUpsEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsIndex=ogUpsIndex, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckEntry=ogCheckEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostTable=ogHostTable, ogCheckName=ogCheckName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDTR=ogSerialPortDTR, ogCheckIndex=ogCheckIndex, ogEmdHumidityName=ogEmdHumidityName)
