...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", PYSNMP_MODULE_ID=ogStatus2, ogHostUserName=ogHostUserName, ogUpsIndex=ogUpsIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmState=ogAlarmState, ogHostPingNotification=ogHostPingNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserNotification=ogWebUserNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmTime=ogAlarmTime, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortParity=ogSerialPortParity, ogAlarmInstance=ogAlarmInstance, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemVendor=ogCellModemVendor, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceType=ogHostServiceType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceStatus=ogHostServiceStatus, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmType=ogAlarmType, ogFirmwareVersion=ogFirmwareVersion, ogHostEntry=ogHostEntry, ogWifiApIndex=ogWifiApIndex, ogCellModemModel=ogCellModemModel, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletName=ogRpcOutletName, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemIndex=ogCellModemIndex, ogEmdName=ogEmdName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserAddress=ogHostUserAddress, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogCustomNotification=ogCustomNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCellApnNotification=ogCellApnNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarm=ogAlarm, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioType=ogEmdDioType, ogCheckType=ogCheckType, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmEventId=ogAlarmEventId, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServicePort=ogHostServicePort, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostTable=ogHostTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdEntry=ogEmdEntry, ogHostUserHost=ogHostUserHost, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsEntry=ogUpsEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyName=ogPowerSupplyName, ogHostName=ogHostName, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemConnected=ogCellModemConnected, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserTable=ogSerialUserTable, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemEnabled=ogCellModemEnabled, ogStatus2Compliances=ogStatus2Compliances, ogUpsHumidity=ogUpsHumidity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmCheck=ogAlarmCheck, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2=ogStatus2, ogCheckTable=ogCheckTable, ogRpcType=ogRpcType, ogNetInterfaceState=ogNetInterfaceState, ogAlarmName=ogAlarmName, ogCheckName=ogCheckName, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserName=ogWebUserName, ogHostIpV6Address=ogHostIpV6Address, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsDescription=ogUpsDescription, ogWifiApTxPower=ogWifiApTxPower, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckIndex=ogCheckIndex, ogSerialUserPort=ogSerialUserPort, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortMode=ogSerialPortMode, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioNotification=ogEmdDioNotification, ogWebUserIndex=ogWebUserIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserTable=ogHostUserTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcInputNotification=ogRpcInputNotification, ogCellModemEntry=ogCellModemEntry, ogUpsConnectType=ogUpsConnectType, ogRpcOutletState=ogRpcOutletState, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioEmd=ogEmdDioEmd, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEssid=ogWifiClientEssid, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortIndex=ogSerialPortIndex, ogHostUserIndex=ogHostUserIndex, ogUpsNotification=ogUpsNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceName=ogCheckDeviceName, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdEnabled=ogEmdEnabled, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcTable=ogRpcTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDCD=ogSerialPortDCD, ogSystem=ogSystem, ogWifiApTable=ogWifiApTable, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientApMac=ogWifiClientApMac, ogRpcName=ogRpcName, ogCellDataNotification=ogCellDataNotification, ogCheckEntry=ogCheckEntry, ogSerialPortTable=ogSerialPortTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserNotification=ogHostUserNotification, ogSerialNumber=ogSerialNumber, ogWifiApEntry=ogWifiApEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserEntry=ogWebUserEntry, ogEmdDescription=ogEmdDescription, ogEmdConnectType=ogEmdConnectType, ogUpsTemperature=ogUpsTemperature, ogWifiClientEntry=ogWifiClientEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsType=ogUpsType, ogEmdDioState=ogEmdDioState, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioIndex=ogEmdDioIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdIndex=ogEmdIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcIndex=ogRpcIndex, ogRpcCounter=ogRpcCounter, ogSerialUserIndex=ogSerialUserIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemTower=ogCellModemTower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceTable=ogHostServiceTable, ogAlarmUser=ogAlarmUser, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsCounter=ogUpsCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApSsid=ogWifiApSsid, ogHostUserEntry=ogHostUserEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityName=ogEmdHumidityName, ogAlarmSummary=ogAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogEmdTable=ogEmdTable, ogMibNotifications=ogMibNotifications, ogRpcEntry=ogRpcEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiApInterface=ogWifiApInterface, ogUpsTable=ogUpsTable, ogWifiClientRssi=ogWifiClientRssi, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletTable=ogRpcOutletTable, ogRpcDescription=ogRpcDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostIndex=ogHostIndex, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserHostName=ogHostUserHostName, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserName=ogSerialUserName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsName=ogUpsName, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserStartTime=ogHostUserStartTime, ogCellModemTable=ogCellModemTable, ogUpsState=ogUpsState, ogEmdDioName=ogEmdDioName)
