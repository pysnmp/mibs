...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserEntry=ogHostUserEntry, ogSerialPortTable=ogSerialPortTable, ogHostUserTable=ogHostUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellTowerNotification=ogCellTowerNotification, ogUpsName=ogUpsName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostTable=ogHostTable, ogHostIpV6Address=ogHostIpV6Address, ogWebUserNotification=ogWebUserNotification, ogHostServiceTable=ogHostServiceTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiApCounter=ogWifiApCounter, ogRpcOutletState=ogRpcOutletState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApInterface=ogWifiApInterface, ogSerialUserLabel=ogSerialUserLabel, ogCellModemApn=ogCellModemApn, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApTable=ogWifiApTable, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemEntry=ogCellModemEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmSummary=ogAlarmSummary, ogAlarmInstance=ogAlarmInstance, ogHostName=ogHostName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNotification=ogUpsInputNotification, ogRpcIndex=ogRpcIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmUser=ogAlarmUser, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioDirection=ogEmdDioDirection, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceCounter=ogHostServiceCounter, ogUpsConnectType=ogUpsConnectType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceType=ogHostServiceType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletNotification=ogRpcOutletNotification, ogHostPingNotification=ogHostPingNotification, ogEmdDioEntry=ogEmdDioEntry, ogCheckIndex=ogCheckIndex, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortDSR=ogSerialPortDSR, ogWifiApEntry=ogWifiApEntry, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioIndex=ogEmdDioIndex, ogEmdDescription=ogEmdDescription, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsEntry=ogUpsEntry, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserName=ogSerialUserName, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserName=ogHostUserName, ogHostUserHostName=ogHostUserHostName, ogUpsNotification=ogUpsNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsCounter=ogUpsCounter, ogWebUserName=ogWebUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientEssid=ogWifiClientEssid, ogEmdEntry=ogEmdEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioTable=ogEmdDioTable, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcType=ogRpcType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureName=ogEmdTemperatureName, ogCellApnNotification=ogCellApnNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmState=ogAlarmState, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemModel=ogCellModemModel, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserTable=ogWebUserTable, ogUpsDescription=ogUpsDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserPort=ogSerialUserPort, ogCellModemIMSI=ogCellModemIMSI, ogCellModemRegistered=ogCellModemRegistered, ogRpcDescription=ogRpcDescription, ogAlarmDevice=ogAlarmDevice, ogUpsIndex=ogUpsIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2=ogStatus2, ogCellModemVendor=ogCellModemVendor, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemTable=ogCellModemTable, ogCheckEntry=ogCheckEntry, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceState=ogNetInterfaceState, ogUpsState=ogUpsState, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDTR=ogSerialPortDTR, ogMibNotifications=ogMibNotifications, ogAlarmEventId=ogAlarmEventId, ogAlarmTime=ogAlarmTime, ogEmdTable=ogEmdTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDCD=ogSerialPortDCD, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogCustomNotification=ogCustomNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmName=ogAlarmName, ogWifiApSsid=ogWifiApSsid, ogSerialPortMode=ogSerialPortMode, ogHostIndex=ogHostIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortParity=ogSerialPortParity, ogEmdDioName=ogEmdDioName, ogAlarmLogTable=ogAlarmLogTable, ogStatus2Groups=ogStatus2Groups, ogAlarmType=ogAlarmType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserIndex=ogHostUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletName=ogRpcOutletName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostEntry=ogHostEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioState=ogEmdDioState, ogNetInterfaceName=ogNetInterfaceName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcName=ogRpcName, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortLabel=ogSerialPortLabel, ogEmdEnabled=ogEmdEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortCTS=ogSerialPortCTS, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApIndex=ogWifiApIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserHost=ogHostUserHost, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioType=ogEmdDioType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientApMac=ogWifiClientApMac)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserIndex=ogWebUserIndex, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogCellDataNotification=ogCellDataNotification, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdIndex=ogEmdIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientEntry=ogWifiClientEntry, ogRpcTable=ogRpcTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsTable=ogUpsTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsType=ogUpsType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioEmd=ogEmdDioEmd, ogCheckDeviceName=ogCheckDeviceName, ogRpcConnectType=ogRpcConnectType, ogCellModemTower=ogCellModemTower, ogHostServicePort=ogHostServicePort, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarm=ogAlarm, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSystem=ogSystem, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcEntry=ogRpcEntry, ogWebUserEntry=ogWebUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckName=ogCheckName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserAddress=ogHostUserAddress, ogEmdConnectType=ogEmdConnectType, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmCheck=ogAlarmCheck, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckTable=ogCheckTable, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceHost=ogHostServiceHost, ogCheckType=ogCheckType, ogEmdName=ogEmdName, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsTemperature=ogUpsTemperature, ogCellModemNetwork=ogCellModemNetwork, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortFlowControl=ogSerialPortFlowControl)
