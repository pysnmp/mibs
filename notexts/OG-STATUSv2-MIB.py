...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcCounter=ogRpcCounter, ogHostUserHostName=ogHostUserHostName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApEntry=ogWifiApEntry, ogWifiClientEssid=ogWifiClientEssid, ogCellApnNotification=ogCellApnNotification, ogHostIndex=ogHostIndex, ogEmdConnectType=ogEmdConnectType, ogAlarmDevice=ogAlarmDevice, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServicePort=ogHostServicePort, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmState=ogAlarmState, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemModel=ogCellModemModel, ogSerialNumber=ogSerialNumber, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserName=ogWebUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Compliance=ogStatus2Compliance, ogAlarmSummary=ogAlarmSummary, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemCounter=ogCellModemCounter, ogAlarmEventId=ogAlarmEventId, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientIndex=ogWifiClientIndex, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientTable=ogWifiClientTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortDTR=ogSerialPortDTR, ogWifiApTable=ogWifiApTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdEntry=ogEmdEntry, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletName=ogRpcOutletName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckIndex=ogCheckIndex, ogCellTowerNotification=ogCellTowerNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogAlarmType=ogAlarmType, ogHostName=ogHostName, ogStatus2Groups=ogStatus2Groups, ogAlarmCheck=ogAlarmCheck, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmName=ogAlarmName, ogSerialUserNotification=ogSerialUserNotification, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceState=ogNetInterfaceState, ogUpsTable=ogUpsTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceNotification=ogHostServiceNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortStopBits=ogSerialPortStopBits, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserName=ogHostUserName, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceHost=ogHostServiceHost, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientMac=ogWifiApClientMac, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellSignalNotification=ogCellSignalNotification, ogUpsCounter=ogUpsCounter, ogWifiApCounter=ogWifiApCounter, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdName=ogEmdName, ogRpcIndex=ogRpcIndex, ogCellModemTemperature=ogCellModemTemperature, ogCellModemIndex=ogCellModemIndex, ogHostUserEntry=ogHostUserEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortDCD=ogSerialPortDCD, ogHostServiceTable=ogHostServiceTable, ogEmdDioType=ogEmdDioType, ogWifiClientCounter=ogWifiClientCounter, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortTable=ogSerialPortTable, ogRpcDescription=ogRpcDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2=ogStatus2, ogUpsIndex=ogUpsIndex, ogEmdDioEmd=ogEmdDioEmd, ogCellModemApn=ogCellModemApn, ogUpsNotification=ogUpsNotification, ogSystem=ogSystem, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceType=ogNetInterfaceType, ogUpsConnectType=ogUpsConnectType, ogAlarmUser=ogAlarmUser, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientInterface=ogWifiClientInterface, ogCheckEntry=ogCheckEntry, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostPingNotification=ogHostPingNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemEntry=ogCellModemEntry, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserNotification=ogWebUserNotification, ogHostUserAddress=ogHostUserAddress, ogCheckName=ogCheckName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemVendor=ogCellModemVendor, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDescription=ogEmdDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcType=ogRpcType, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserName=ogSerialUserName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsName=ogUpsName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsEntry=ogUpsEntry, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostTable=ogHostTable, ogSerialUserPort=ogSerialUserPort, ogRpcName=ogRpcName, ogEmdIndex=ogEmdIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserEntry=ogWebUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemConnected=ogCellModemConnected, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioState=ogEmdDioState, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityName=ogEmdHumidityName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserTable=ogSerialUserTable, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortIndex=ogSerialPortIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceType=ogHostServiceType, ogHostUserTable=ogHostUserTable, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckTable=ogCheckTable, ogUpsState=ogUpsState, ogSerialUserIndex=ogSerialUserIndex, ogAlarmTime=ogAlarmTime, ogUpsInputNotification=ogUpsInputNotification, ogRpcConnectType=ogRpcConnectType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcEntry=ogRpcEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCustomNotification=ogCustomNotification, ogRpcTable=ogRpcTable, ogCellModemTower=ogCellModemTower, ogEmdDioCounter=ogEmdDioCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHost=ogHostUserHost, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceEntry=ogHostServiceEntry, ogUpsDescription=ogUpsDescription, ogWifiApTxPower=ogWifiApTxPower, ogWifiApSsid=ogWifiApSsid, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTable=ogCellModemTable, ogEmdDioName=ogEmdDioName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostEntry=ogHostEntry, ogHostUserStartTime=ogHostUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityValue=ogEmdHumidityValue, ogCellDataNotification=ogCellDataNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarm=ogAlarm, ogWifiApIndex=ogWifiApIndex, ogUpsType=ogUpsType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserTable=ogWebUserTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckType=ogCheckType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Compliances=ogStatus2Compliances, ogMibNotifications=ogMibNotifications, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmLogTable=ogAlarmLogTable, ogWifiApInterface=ogWifiApInterface)
