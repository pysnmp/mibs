...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioCounter=ogEmdDioCounter, ogRpcIndex=ogRpcIndex, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletState=ogRpcOutletState, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemIMSI=ogCellModemIMSI, ogEmdTable=ogEmdTable, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioType=ogEmdDioType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmDevice=ogAlarmDevice, ogSerialPortDCD=ogSerialPortDCD, ogHostUserName=ogHostUserName, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmType=ogAlarmType, ogCellModemSessionTime=ogCellModemSessionTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemTower=ogCellModemTower, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceName=ogNetInterfaceName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmUser=ogAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckIndex=ogCheckIndex, ogWebUserNotification=ogWebUserNotification, ogCheckTable=ogCheckTable, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSystem=ogSystem, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsType=ogUpsType, ogSerialPortDSR=ogSerialPortDSR, ogHostPingNotification=ogHostPingNotification, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostEntry=ogHostEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostIndex=ogHostIndex, ogEmdIndex=ogEmdIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletTable=ogRpcOutletTable, ogRpcTable=ogRpcTable, ogUpsIndex=ogUpsIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdEnabled=ogEmdEnabled, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApSsid=ogWifiApSsid, ogUpsHumidity=ogUpsHumidity, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientTable=ogWifiClientTable, ogWebUserIndex=ogWebUserIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserPort=ogSerialUserPort, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryState=ogUpsBatteryState, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioName=ogEmdDioName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellTowerNotification=ogCellTowerNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsEntry=ogUpsEntry, ogEmdHumidityName=ogEmdHumidityName, ogStatus2Groups=ogStatus2Groups, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApTxPower=ogWifiApTxPower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcEntry=ogRpcEntry, ogSerialPortParity=ogSerialPortParity, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEntry=ogCellModemEntry, ogAlarmTime=ogAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcType=ogRpcType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserTable=ogWebUserTable, ogWebUserName=ogWebUserName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemApn=ogCellModemApn, ogCellModemIndex=ogCellModemIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceType=ogHostServiceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemModel=ogCellModemModel, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEntry=ogEmdDioEntry, ogAlarmSummary=ogAlarmSummary, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputNotification=ogRpcInputNotification, ogCheckResolveActions=ogCheckResolveActions, ogHostUserNotification=ogHostUserNotification, ogWifiApTable=ogWifiApTable, ogAlarmCheck=ogAlarmCheck, ogRpcConnectType=ogRpcConnectType, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientIndex=ogWifiClientIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckType=ogCheckType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellDataNotification=ogCellDataNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemVendor=ogCellModemVendor, ogMibNotifications=ogMibNotifications, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletName=ogRpcOutletName, ogUpsNotification=ogUpsNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmInstance=ogAlarmInstance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortMode=ogSerialPortMode, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsTable=ogUpsTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDescription=ogEmdDioDescription, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortDTR=ogSerialPortDTR, ogEmdName=ogEmdName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApCounter=ogWifiApCounter, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioState=ogEmdDioState, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsDescription=ogUpsDescription, ogWifiClientRssi=ogWifiClientRssi, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcDescription=ogRpcDescription, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityEmd=ogEmdHumidityEmd, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogHostUserStartTime=ogHostUserStartTime, ogWifiApFrequency=ogWifiApFrequency, ogAlarm=ogAlarm, ogWebUserEntry=ogWebUserEntry, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsState=ogUpsState, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceCounter=ogHostServiceCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmName=ogAlarmName, ogWifiClientApMac=ogWifiClientApMac, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCustomNotification=ogCustomNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserAddress=ogHostUserAddress, ogWifiClientFrequency=ogWifiClientFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceHost=ogHostServiceHost, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioEmd=ogEmdDioEmd, ogNetInterfaceState=ogNetInterfaceState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostName=ogHostName, ogHostUserEntry=ogHostUserEntry, ogCellMessageNotification=ogCellMessageNotification, ogCheckName=ogCheckName, ogWifiApIndex=ogWifiApIndex, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsCounter=ogUpsCounter, ogCellModemRegistered=ogCellModemRegistered, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsTemperature=ogUpsTemperature, ogUpsName=ogUpsName, ogEmdDioNotification=ogEmdDioNotification, ogSerialNumber=ogSerialNumber, ogStatus2=ogStatus2, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServicePort=ogHostServicePort, ogHostUserTable=ogHostUserTable, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcCounter=ogRpcCounter, ogEmdDescription=ogEmdDescription, ogHostTable=ogHostTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmState=ogAlarmState, ogEmdEntry=ogEmdEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcName=ogRpcName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEssid=ogWifiClientEssid, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmEventId=ogAlarmEventId, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserHost=ogHostUserHost, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputPower=ogUpsOutputPower, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckEntry=ogCheckEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemTable=ogCellModemTable, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletLoad=ogRpcOutletLoad)
