...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApEnabled=ogWifiApEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsHumidity=ogUpsHumidity, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogFirmwareVersion=ogFirmwareVersion, ogSerialNumber=ogSerialNumber, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortTable=ogSerialPortTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmType=ogAlarmType, ogUpsName=ogUpsName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEntry=ogCellModemEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTower=ogCellModemTower, ogRpcOutletState=ogRpcOutletState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostPingNotification=ogHostPingNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdEnabled=ogEmdEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemModel=ogCellModemModel, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdIndex=ogEmdIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmDevice=ogAlarmDevice, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioName=ogEmdDioName, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioIndex=ogEmdDioIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcConnectType=ogRpcConnectType, ogWifiClientInterface=ogWifiClientInterface, ogEmdConnectType=ogEmdConnectType, ogCheckTable=ogCheckTable, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsDescription=ogUpsDescription, ogWifiApSsid=ogWifiApSsid, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortSpeed=ogSerialPortSpeed, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserName=ogWebUserName, ogHostUserName=ogHostUserName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckType=ogCheckType, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServicePort=ogHostServicePort, ogRpcInputNotification=ogRpcInputNotification, ogCellDataNotification=ogCellDataNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientTable=ogWifiClientTable, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceType=ogNetInterfaceType, ogSystem=ogSystem, ogStatus2Conformance=ogStatus2Conformance, ogWifiApEntry=ogWifiApEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioCounter=ogEmdDioCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsIndex=ogUpsIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserIndex=ogHostUserIndex, ogWifiApInterface=ogWifiApInterface, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioType=ogEmdDioType, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserName=ogSerialUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarm=ogAlarm, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTable=ogUpsTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Groups=ogStatus2Groups, ogWebUserEntry=ogWebUserEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientEntry=ogWifiClientEntry, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcIndex=ogRpcIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialUserPort=ogSerialUserPort, ogEmdDioEntry=ogEmdDioEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserHostName=ogHostUserHostName, ogUpsType=ogUpsType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserIndex=ogSerialUserIndex, ogHostUserEntry=ogHostUserEntry, ogCellModemRegistered=ogCellModemRegistered, ogHostIpV6Address=ogHostIpV6Address, ogUpsConnectType=ogUpsConnectType, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemTemperature=ogCellModemTemperature, ogRpcCounter=ogRpcCounter, ogEmdDioEmd=ogEmdDioEmd, ogEmdTable=ogEmdTable, ogUpsNotification=ogUpsNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortDCD=ogSerialPortDCD, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceName=ogNetInterfaceName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserTable=ogHostUserTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckName=ogCheckName, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioDirection=ogEmdDioDirection, ogCheckIndex=ogCheckIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNotification=ogUpsInputNotification, ogRpcEntry=ogRpcEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserStartTime=ogHostUserStartTime, ogWebUserStartTime=ogWebUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsState=ogUpsState, ogHostUserAddress=ogHostUserAddress, ogUpsTemperature=ogUpsTemperature, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckEntry=ogCheckEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcName=ogRpcName, ogWifiApTxPower=ogWifiApTxPower, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcTable=ogRpcTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApCounter=ogWifiApCounter, ogAlarmUser=ogAlarmUser, ogUpsOutputPower=ogUpsOutputPower, ogStatus2=ogStatus2, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemTable=ogCellModemTable, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTable=ogWifiApClientTable, ogEmdEntry=ogEmdEntry, ogSerialUserEntry=ogSerialUserEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortLabel=ogSerialPortLabel, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserHost=ogHostUserHost, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostName=ogHostName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceTable=ogHostServiceTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostIndex=ogHostIndex, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortParity=ogSerialPortParity, ogSerialUserLabel=ogSerialUserLabel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmInstance=ogAlarmInstance, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioNotification=ogEmdDioNotification, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmEventId=ogAlarmEventId, ogWebUserTable=ogWebUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmCheck=ogAlarmCheck, ogHostTable=ogHostTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdName=ogEmdName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserNotification=ogWebUserNotification, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmState=ogAlarmState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemApn=ogCellModemApn, ogCellTowerNotification=ogCellTowerNotification, ogRpcDescription=ogRpcDescription, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIpV4Address=ogHostIpV4Address, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsCounter=ogUpsCounter, ogEmdDescription=ogEmdDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTable=ogWifiApTable, ogEmdDioTable=ogEmdDioTable, PYSNMP_MODULE_ID=ogStatus2, ogHostEntry=ogHostEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogMibNotifications=ogMibNotifications, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletNotification=ogRpcOutletNotification, ogCustomNotification=ogCustomNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyName=ogPowerSupplyName, ogWebUserIndex=ogWebUserIndex, ogAlarmName=ogAlarmName, ogRpcType=ogRpcType, ogUpsEntry=ogUpsEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientEssid=ogWifiClientEssid)
