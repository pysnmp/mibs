...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsTemperature=ogUpsTemperature, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserNotification=ogHostUserNotification, ogAlarmUser=ogAlarmUser, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemIndex=ogCellModemIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserIndex=ogSerialUserIndex, ogRpcType=ogRpcType, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmType=ogAlarmType, ogHostTable=ogHostTable, ogUpsInputNotification=ogUpsInputNotification, ogCellModemEntry=ogCellModemEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserPort=ogSerialUserPort, ogCellModemCounter=ogCellModemCounter, ogRpcIndex=ogRpcIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmEventId=ogAlarmEventId, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmTime=ogAlarmTime, ogHostUserName=ogHostUserName, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemTower=ogCellModemTower, ogStatus2Groups=ogStatus2Groups, ogEmdDioEntry=ogEmdDioEntry, ogUpsName=ogUpsName, ogEmdEnabled=ogEmdEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortMode=ogSerialPortMode, ogRpcInputNotification=ogRpcInputNotification, ogWifiApIndex=ogWifiApIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckName=ogCheckName, ogEmdEntry=ogEmdEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceTable=ogHostServiceTable, ogCellModemIMSI=ogCellModemIMSI, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientMode=ogWifiClientMode, ogUpsEntry=ogUpsEntry, ogWifiApEnabled=ogWifiApEnabled, ogUpsTable=ogUpsTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityName=ogEmdHumidityName, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdIndex=ogEmdIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsCounter=ogUpsCounter, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcEntry=ogRpcEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortEntry=ogSerialPortEntry, ogWifiApTable=ogWifiApTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceIndex=ogNetInterfaceIndex, ogMibNotifications=ogMibNotifications, ogHostUserHost=ogHostUserHost, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsDescription=ogUpsDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserTable=ogWebUserTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsNotification=ogUpsNotification, ogWebUserName=ogWebUserName, ogHostServicePort=ogHostServicePort, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyName=ogPowerSupplyName, ogUpsState=ogUpsState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserName=ogSerialUserName, ogRpcName=ogRpcName, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioState=ogEmdDioState, ogEmdDioType=ogEmdDioType, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckEntry=ogCheckEntry, ogRpcConnectType=ogRpcConnectType, ogHostIndex=ogHostIndex, ogHostUserHostName=ogHostUserHostName, ogWifiApClientMac=ogWifiApClientMac, ogHostName=ogHostName, ogRpcOutletState=ogRpcOutletState, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmInstance=ogAlarmInstance, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCheck=ogAlarmCheck, ogWifiApCounter=ogWifiApCounter, ogCheckTable=ogCheckTable, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioDirection=ogEmdDioDirection, ogWebUserEntry=ogWebUserEntry, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientTable=ogWifiApClientTable, ogCellModemApn=ogCellModemApn, ogCellTowerNotification=ogCellTowerNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserAddress=ogHostUserAddress, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortDTR=ogSerialPortDTR, ogCellModemModel=ogCellModemModel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogEmdTable=ogEmdTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserTable=ogHostUserTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialNumber=ogSerialNumber, ogRpcCounter=ogRpcCounter, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientTable=ogWifiClientTable, ogCellModemTemperature=ogCellModemTemperature, ogStatus2Compliance=ogStatus2Compliance, ogHostEntry=ogHostEntry, ogUpsType=ogUpsType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdName=ogEmdName, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDescription=ogEmdDescription, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2=ogStatus2, ogSerialUserTable=ogSerialUserTable, ogCellDataNotification=ogCellDataNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsConnectType=ogUpsConnectType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmName=ogAlarmName, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioEmd=ogEmdDioEmd, ogWifiApEntry=ogWifiApEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsHumidity=ogUpsHumidity, ogAlarm=ogAlarm, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserNotification=ogWebUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemNetwork=ogCellModemNetwork, ogStatus2Compliances=ogStatus2Compliances, ogAlarmDevice=ogAlarmDevice, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmState=ogAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckIndex=ogCheckIndex, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserIndex=ogWebUserIndex, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortParity=ogSerialPortParity, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemVendor=ogCellModemVendor, ogHostUserIndex=ogHostUserIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioName=ogEmdDioName, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceType=ogHostServiceType, ogWifiApSsid=ogWifiApSsid, ogUpsIndex=ogUpsIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletName=ogRpcOutletName, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSystem=ogSystem, ogCheckType=ogCheckType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue)
