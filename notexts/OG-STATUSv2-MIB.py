...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcDescription=ogRpcDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcEntry=ogRpcEntry, ogAlarmName=ogAlarmName, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemApn=ogCellModemApn, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApInterface=ogWifiApInterface, ogAlarm=ogAlarm, ogSerialUserEntry=ogSerialUserEntry, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApTable=ogWifiApTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Compliances=ogStatus2Compliances, ogRpcType=ogRpcType, ogEmdIndex=ogEmdIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioType=ogEmdDioType, ogHostIndex=ogHostIndex, ogEmdEntry=ogEmdEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServiceTable=ogHostServiceTable, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Groups=ogStatus2Groups, ogWifiApClientAp=ogWifiApClientAp, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsTable=ogUpsTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogStatus2=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortDTR=ogSerialPortDTR, ogUpsState=ogUpsState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserTable=ogHostUserTable, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceState=ogNetInterfaceState, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserHostName=ogHostUserHostName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmInstance=ogAlarmInstance, ogWifiApClientMac=ogWifiApClientMac, ogAlarmUser=ogAlarmUser, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryState=ogUpsBatteryState, ogUpsCounter=ogUpsCounter, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserName=ogSerialUserName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletName=ogRpcOutletName, ogWebUserTable=ogWebUserTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServicePort=ogHostServicePort, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortIndex=ogSerialPortIndex, ogWifiApCounter=ogWifiApCounter, ogUpsDescription=ogUpsDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientInterface=ogWifiClientInterface, ogCellDataNotification=ogCellDataNotification, ogCheckIndex=ogCheckIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckName=ogCheckName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioDirection=ogEmdDioDirection, ogCellMessageNotification=ogCellMessageNotification, ogUpsTemperature=ogUpsTemperature, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceType=ogNetInterfaceType, ogCellModemSessionTime=ogCellModemSessionTime, ogHostIpV4Address=ogHostIpV4Address, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApEntry=ogWifiApEntry, ogSerialUserTable=ogSerialUserTable, ogWifiClientTable=ogWifiClientTable, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckTable=ogCheckTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostPingNotification=ogHostPingNotification, ogEmdConnectType=ogEmdConnectType, ogHostEntry=ogHostEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceCounter=ogHostServiceCounter, ogHostUserEntry=ogHostUserEntry, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortCTS=ogSerialPortCTS, ogSystem=ogSystem, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmState=ogAlarmState, ogEmdEnabled=ogEmdEnabled, ogWebUserNotification=ogWebUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogAlarmCheck=ogAlarmCheck, ogRpcOutletTable=ogRpcOutletTable, ogHostUserHost=ogHostUserHost, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmType=ogAlarmType, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioNotification=ogEmdDioNotification, ogHostUserIndex=ogHostUserIndex, ogCheckType=ogCheckType, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemTable=ogCellModemTable, ogCellModemIndex=ogCellModemIndex, ogCellModemTower=ogCellModemTower, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsEntry=ogUpsEntry, ogRpcCounter=ogRpcCounter, ogCellModemConnected=ogCellModemConnected, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTable=ogEmdTable, ogAlarmEventId=ogAlarmEventId, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcTable=ogRpcTable, ogSerialUserPort=ogSerialUserPort, PYSNMP_MODULE_ID=ogStatus2, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserNotification=ogHostUserNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceStatus=ogHostServiceStatus, ogWebUserName=ogWebUserName, ogAlarmSummary=ogAlarmSummary, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsName=ogUpsName, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceHost=ogHostServiceHost, ogHostTable=ogHostTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsIndex=ogUpsIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemCounter=ogCellModemCounter, ogHostServiceType=ogHostServiceType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserIndex=ogSerialUserIndex, ogEmdDescription=ogEmdDescription, ogWifiApIndex=ogWifiApIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialNumber=ogSerialNumber, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemVendor=ogCellModemVendor, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemModel=ogCellModemModel, ogAlarmDevice=ogAlarmDevice, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletState=ogRpcOutletState, ogUpsHumidity=ogUpsHumidity, ogHostUserName=ogHostUserName, ogUpsNotification=ogUpsNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioState=ogEmdDioState, ogHostUserAddress=ogHostUserAddress, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsType=ogUpsType, ogMibNotifications=ogMibNotifications, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortTable=ogSerialPortTable, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmTime=ogAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostName=ogHostName, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcIndex=ogRpcIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellApnNotification=ogCellApnNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioTable=ogEmdDioTable, ogRpcName=ogRpcName, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApSsid=ogWifiApSsid, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioName=ogEmdDioName, ogEmdName=ogEmdName, ogWebUserIndex=ogWebUserIndex, ogWifiClientApMac=ogWifiClientApMac, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserStartTime=ogSerialUserStartTime, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow)
