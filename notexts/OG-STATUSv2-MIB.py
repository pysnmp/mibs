...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmCheck=ogAlarmCheck, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2=ogStatus2, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioType=ogEmdDioType, ogRpcIndex=ogRpcIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemEnabled=ogCellModemEnabled, ogHostUserTable=ogHostUserTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientIndex=ogWifiClientIndex, ogRpcName=ogRpcName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortMode=ogSerialPortMode, ogUpsType=ogUpsType, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellSignalNotification=ogCellSignalNotification, ogRpcCounter=ogRpcCounter, ogSerialPortDTR=ogSerialPortDTR, ogUpsTemperature=ogUpsTemperature, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApFrequency=ogWifiApFrequency, ogWifiApEntry=ogWifiApEntry, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmInstance=ogAlarmInstance, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcInputNotification=ogRpcInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsDescription=ogUpsDescription, ogAlarmEventId=ogAlarmEventId, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceType=ogNetInterfaceType, ogCellModemTower=ogCellModemTower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserEntry=ogHostUserEntry, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsState=ogUpsState, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsName=ogUpsName, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdEnabled=ogEmdEnabled, ogEmdDioNotification=ogEmdDioNotification, ogAlarmSummary=ogAlarmSummary, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserName=ogWebUserName, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Groups=ogStatus2Groups, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortParity=ogSerialPortParity, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceName=ogCheckDeviceName, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserIndex=ogHostUserIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemModel=ogCellModemModel, ogSerialPortSpeed=ogSerialPortSpeed, ogCellMessageNotification=ogCellMessageNotification, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserNotification=ogWebUserNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTable=ogWifiApClientTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsEntry=ogUpsEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckDeviceRef=ogCheckDeviceRef, ogCellApnNotification=ogCellApnNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputPower=ogUpsOutputPower, ogCheckIndex=ogCheckIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserStartTime=ogHostUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckType=ogCheckType, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletName=ogRpcOutletName, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdIndex=ogEmdIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcDescription=ogRpcDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogMibNotifications=ogMibNotifications, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcEntry=ogRpcEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmState=ogAlarmState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdEntry=ogEmdEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTable=ogEmdTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletNotification=ogRpcOutletNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsIndex=ogUpsIndex, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckName=ogCheckName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcConnectType=ogRpcConnectType, ogRpcType=ogRpcType, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsNotification=ogUpsNotification, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostTable=ogHostTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApIndex=ogWifiApIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioEntry=ogEmdDioEntry, ogCheckEntry=ogCheckEntry, ogHostServiceTable=ogHostServiceTable, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmTime=ogAlarmTime, ogEmdDioName=ogEmdDioName, ogHostUserHostName=ogHostUserHostName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyName=ogPowerSupplyName, ogHostEntry=ogHostEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServicePort=ogHostServicePort, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserIndex=ogWebUserIndex, ogWifiApTable=ogWifiApTable, ogSerialPortRTS=ogSerialPortRTS, ogHostUserName=ogHostUserName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserHost=ogHostUserHost, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDSR=ogSerialPortDSR, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityName=ogEmdHumidityName, ogAlarmDevice=ogAlarmDevice, ogSerialPortEntry=ogSerialPortEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdName=ogEmdName, ogUpsCounter=ogUpsCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceCounter=ogHostServiceCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialNumber=ogSerialNumber, ogUpsHumidity=ogUpsHumidity, ogHostName=ogHostName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserAddress=ogHostUserAddress, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserTable=ogWebUserTable, ogWifiClientApMac=ogWifiClientApMac, ogCellModemApn=ogCellModemApn, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioState=ogEmdDioState, ogWifiApInterface=ogWifiApInterface, ogAlarmType=ogAlarmType, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostIndex=ogHostIndex, ogHostServiceType=ogHostServiceType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortCTS=ogSerialPortCTS, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioIndex=ogEmdDioIndex, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserPort=ogSerialUserPort, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarm=ogAlarm, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserIndex=ogSerialUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogCellModemCounter=ogCellModemCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCustomNotification=ogCustomNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmUser=ogAlarmUser, ogSerialPortTable=ogSerialPortTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogCellModemEntry=ogCellModemEntry, ogSerialUserName=ogSerialUserName, ogSystem=ogSystem, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDescription=ogEmdDescription, ogAlarmName=ogAlarmName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcTable=ogRpcTable, ogRpcOutletIndex=ogRpcOutletIndex, ogCellDataNotification=ogCellDataNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemVendor=ogCellModemVendor, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemIndex=ogCellModemIndex, ogStatus2Conformance=ogStatus2Conformance, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserNotification=ogHostUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Compliance=ogStatus2Compliance, ogNetInterfaceName=ogNetInterfaceName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsTable=ogUpsTable)
