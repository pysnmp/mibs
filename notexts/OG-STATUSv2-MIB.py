...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserTable=ogSerialUserTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceEntry=ogHostServiceEntry, ogStatus2Groups=ogStatus2Groups, ogWebUserName=ogWebUserName, ogAlarmType=ogAlarmType, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientMode=ogWifiClientMode, ogStatus2=ogStatus2, ogUpsDescription=ogUpsDescription, ogEmdDioDescription=ogEmdDioDescription, ogCellModemEnabled=ogCellModemEnabled, ogUpsType=ogUpsType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioType=ogEmdDioType, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioState=ogEmdDioState, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckTable=ogCheckTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsIndex=ogUpsIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmState=ogAlarmState, ogHostUserNotification=ogHostUserNotification, ogUpsHumidity=ogUpsHumidity, ogWebUserTable=ogWebUserTable, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApEntry=ogWifiApEntry, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceType=ogHostServiceType, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDescription=ogEmdDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientTable=ogWifiApClientTable, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceIndex=ogCheckDeviceIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsEntry=ogUpsEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsTable=ogUpsTable, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckName=ogCheckName, ogEmdHumidityValue=ogEmdHumidityValue, ogMibNotifications=ogMibNotifications, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsState=ogUpsState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostTable=ogHostTable, ogAlarmCheck=ogAlarmCheck, ogUpsNotification=ogUpsNotification, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckEntry=ogCheckEntry, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserAddress=ogHostUserAddress, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcCounter=ogRpcCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemEntry=ogCellModemEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryState=ogUpsBatteryState, ogCellApnNotification=ogCellApnNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserHostName=ogHostUserHostName, ogCellModemTower=ogCellModemTower, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmEventId=ogAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcName=ogRpcName, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, ogAlarmDevice=ogAlarmDevice, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSessionTime=ogCellModemSessionTime, ogCustomNotification=ogCustomNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostUserTable=ogHostUserTable, ogEmdDioName=ogEmdDioName, ogWifiApIndex=ogWifiApIndex, ogRpcOutletName=ogRpcOutletName, ogUpsConnectType=ogUpsConnectType, ogRpcConnectType=ogRpcConnectType, ogWebUserEntry=ogWebUserEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRTS=ogSerialPortRTS, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletState=ogRpcOutletState, ogHostServicePort=ogHostServicePort, ogAlarmSummary=ogAlarmSummary, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialNumber=ogSerialNumber, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemModel=ogCellModemModel, ogSerialPortEntry=ogSerialPortEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckType=ogCheckType, ogWebUserIndex=ogWebUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserNotification=ogWebUserNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceTable=ogHostServiceTable, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceState=ogNetInterfaceState, ogWifiApSsid=ogWifiApSsid, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTable=ogEmdTable, ogCellModemNetwork=ogCellModemNetwork, ogCheckIndex=ogCheckIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDTR=ogSerialPortDTR, ogWifiApTable=ogWifiApTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserNotification=ogSerialUserNotification, ogAlarmTime=ogAlarmTime, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientTable=ogWifiClientTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcDescription=ogRpcDescription, ogEmdIndex=ogEmdIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserIndex=ogHostUserIndex, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioTable=ogEmdDioTable, ogCellDataNotification=ogCellDataNotification, ogCheckResolveActions=ogCheckResolveActions, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceCounter=ogHostServiceCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsName=ogUpsName, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcEntry=ogRpcEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcIndex=ogRpcIndex, ogCellMessageNotification=ogCellMessageNotification, ogCellModemIndex=ogCellModemIndex, ogWifiClientIndex=ogWifiClientIndex, ogCellModemTable=ogCellModemTable, ogRpcType=ogRpcType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdConnectType=ogEmdConnectType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientEntry=ogWifiApClientEntry, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogHostName=ogHostName, ogEmdName=ogEmdName, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserName=ogHostUserName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemVendor=ogCellModemVendor, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Compliances=ogStatus2Compliances, ogAlarm=ogAlarm, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemCounter=ogCellModemCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdEntry=ogEmdEntry, ogEmdEnabled=ogEmdEnabled, ogUpsCounter=ogUpsCounter, ogHostEntry=ogHostEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostIndex=ogHostIndex, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsTemperature=ogUpsTemperature, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputPower=ogUpsOutputPower, ogAlarmUser=ogAlarmUser, ogSerialUserName=ogSerialUserName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLabel=ogSerialPortLabel, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceNotification=ogHostServiceNotification, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmName=ogAlarmName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmInstance=ogAlarmInstance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogSystem=ogSystem, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserIndex=ogSerialUserIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage)
