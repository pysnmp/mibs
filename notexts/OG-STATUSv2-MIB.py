...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserLabel=ogSerialUserLabel, ogAlarmDevice=ogAlarmDevice, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientEntry=ogWifiClientEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserName=ogSerialUserName, ogHostIpV4Address=ogHostIpV4Address, ogUpsName=ogUpsName, ogCellModemEntry=ogCellModemEntry, ogAlarmName=ogAlarmName, ogAlarmUser=ogAlarmUser, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostName=ogHostName, ogHostPingNotification=ogHostPingNotification, ogCheckDeviceName=ogCheckDeviceName, ogRpcDescription=ogRpcDescription, ogStatus2=ogStatus2, ogWifiApInterface=ogWifiApInterface, ogSerialNumber=ogSerialNumber, ogStatus2Compliance=ogStatus2Compliance, ogUpsIndex=ogUpsIndex, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckType=ogCheckType, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemCounter=ogCellModemCounter, ogRpcName=ogRpcName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogSystem=ogSystem, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsHumidity=ogUpsHumidity, ogHostServiceTable=ogHostServiceTable, ogUpsConnectType=ogUpsConnectType, ogAlarmTime=ogAlarmTime, ogUpsEntry=ogUpsEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmState=ogAlarmState, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortTable=ogSerialPortTable, ogMibNotifications=ogMibNotifications, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserHost=ogHostUserHost, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceEntry=ogHostServiceEntry, ogUpsTemperature=ogUpsTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdIndex=ogEmdIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogCellTowerNotification=ogCellTowerNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemModel=ogCellModemModel, ogWebUserTable=ogWebUserTable, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsType=ogUpsType, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsTable=ogUpsTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortDTR=ogSerialPortDTR, ogUpsDescription=ogUpsDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDescription=ogEmdDescription, ogHostServiceIndex=ogHostServiceIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogFirmwareVersion=ogFirmwareVersion, ogRpcCounter=ogRpcCounter, ogSerialUserTable=ogSerialUserTable, ogEmdConnectType=ogEmdConnectType, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemTable=ogCellModemTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckIndex=ogCheckIndex, ogEmdTable=ogEmdTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioState=ogEmdDioState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcIndex=ogRpcIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserPort=ogSerialUserPort, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserName=ogWebUserName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceType=ogHostServiceType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcConnectType=ogRpcConnectType, ogCellModemEnabled=ogCellModemEnabled, ogCheckEntry=ogCheckEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortMode=ogSerialPortMode, ogAlarmInstance=ogAlarmInstance, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceHost=ogHostServiceHost, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserTable=ogHostUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioName=ogEmdDioName, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortLabel=ogSerialPortLabel, ogRpcType=ogRpcType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogBasicNotificationGroup=ogBasicNotificationGroup, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Conformance=ogStatus2Conformance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckName=ogCheckName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserIndex=ogWebUserIndex, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIndex=ogHostIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIndex=ogWifiApIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserEntry=ogSerialUserEntry, ogHostUserIndex=ogHostUserIndex, ogHostUserEntry=ogHostUserEntry, ogEmdDioType=ogEmdDioType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmSummary=ogAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientMode=ogWifiClientMode, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserStartTime=ogHostUserStartTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdName=ogEmdName, ogCheckTable=ogCheckTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientIndex=ogWifiClientIndex, ogCellModemNetwork=ogCellModemNetwork, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemApn=ogCellModemApn, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletState=ogRpcOutletState, ogWebUserNotification=ogWebUserNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogHostUserName=ogHostUserName, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdEntry=ogEmdEntry, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletEntry=ogRpcOutletEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcEntry=ogRpcEntry, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioTable=ogEmdDioTable, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceState=ogNetInterfaceState, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortParity=ogSerialPortParity, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemConnected=ogCellModemConnected, ogUpsNotification=ogUpsNotification, ogHostUserAddress=ogHostUserAddress, ogHostServicePort=ogHostServicePort, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostTable=ogHostTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientTable=ogWifiClientTable, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApTable=ogWifiApTable, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTower=ogCellModemTower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemIndex=ogCellModemIndex, ogCustomNotification=ogCustomNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientMac=ogWifiApClientMac, ogCellModemRegistered=ogCellModemRegistered, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemVendor=ogCellModemVendor, ogAlarm=ogAlarm, ogAlarmType=ogAlarmType, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApSsid=ogWifiApSsid, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApEntry=ogWifiApEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceType=ogNetInterfaceType, ogHostEntry=ogHostEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsState=ogUpsState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceEntry=ogCheckDeviceEntry)
