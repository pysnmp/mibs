...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserTable=ogWebUserTable, ogUpsName=ogUpsName, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckIndex=ogCheckIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckType=ogCheckType, ogAlarmState=ogAlarmState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApTxPower=ogWifiApTxPower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserHostName=ogHostUserHostName, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemVendor=ogCellModemVendor, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserEntry=ogWebUserEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmName=ogAlarmName, ogCellModemConnected=ogCellModemConnected, ogMibNotifications=ogMibNotifications, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserSourceAddress=ogWebUserSourceAddress, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioDirection=ogEmdDioDirection, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputNotification=ogRpcInputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsIndex=ogUpsIndex, ogCellModemTable=ogCellModemTable, ogCellMessageNotification=ogCellMessageNotification, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryCharge=ogUpsBatteryCharge, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApCounter=ogWifiApCounter, ogWebUserIndex=ogWebUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientApMac=ogWifiClientApMac, ogHostIndex=ogHostIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogCellDataNotification=ogCellDataNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletName=ogRpcOutletName, ogEmdIndex=ogEmdIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcDescription=ogRpcDescription, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyName=ogPowerSupplyName, ogHostEntry=ogHostEntry, ogWifiApTable=ogWifiApTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCustomNotification=ogCustomNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckTable=ogCheckTable, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserAddress=ogHostUserAddress, ogWifiApIndex=ogWifiApIndex, ogStatus2=ogStatus2, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserName=ogSerialUserName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdEntry=ogEmdEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApSsid=ogWifiApSsid, PYSNMP_MODULE_ID=ogStatus2, ogHostName=ogHostName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdEnabled=ogEmdEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsType=ogUpsType, ogHostServicePort=ogHostServicePort, ogEmdDioState=ogEmdDioState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckEntry=ogCheckEntry, ogAlarmDevice=ogAlarmDevice, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceState=ogNetInterfaceState, ogCellModemCounter=ogCellModemCounter, ogUpsCounter=ogUpsCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostTable=ogHostTable, ogCellModemIndex=ogCellModemIndex, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioName=ogEmdDioName, ogEmdDioTable=ogEmdDioTable, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserHost=ogHostUserHost, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceHost=ogHostServiceHost, ogEmdDescription=ogEmdDescription, ogHostUserTable=ogHostUserTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceType=ogHostServiceType, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsTable=ogUpsTable, ogAlarmEventId=ogAlarmEventId, ogUpsNotification=ogUpsNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcTable=ogRpcTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceIndex=ogHostServiceIndex, ogCellTowerNotification=ogCellTowerNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioEmd=ogEmdDioEmd, ogUpsState=ogUpsState, ogUpsTemperature=ogUpsTemperature, ogWifiClientIndex=ogWifiClientIndex, ogSystem=ogSystem, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApEntry=ogWifiApEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemModel=ogCellModemModel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmCheck=ogAlarmCheck, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemRegistered=ogCellModemRegistered, ogEmdTable=ogEmdTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientTable=ogWifiClientTable, ogHostUserName=ogHostUserName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityName=ogEmdHumidityName, ogAlarmLogTable=ogAlarmLogTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialNumber=ogSerialNumber, ogSerialUserTable=ogSerialUserTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmType=ogAlarmType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserEntry=ogHostUserEntry, ogWebUserNotification=ogWebUserNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmTime=ogAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientEssid=ogWifiClientEssid, ogAlarmUser=ogAlarmUser, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsDescription=ogUpsDescription, ogUpsEntry=ogUpsEntry, ogCellModemEnabled=ogCellModemEnabled, ogCellModemEntry=ogCellModemEntry, ogCheckName=ogCheckName, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEntry=ogEmdDioEntry, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogRpcCounter=ogRpcCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserEntry=ogSerialUserEntry, ogCellModemTower=ogCellModemTower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortIndex=ogSerialPortIndex, ogRpcEntry=ogRpcEntry, ogAlarmPreviousValue=ogAlarmPreviousValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientAp=ogWifiApClientAp, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserName=ogWebUserName, ogSerialUserIndex=ogSerialUserIndex, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemApn=ogCellModemApn, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Groups=ogStatus2Groups, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdName=ogEmdName, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarm=ogAlarm, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortEntry=ogSerialPortEntry, ogHostUserNotification=ogHostUserNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTable=ogWifiApClientTable, ogCellApnNotification=ogCellApnNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogEmdDioNotification=ogEmdDioNotification, ogRpcName=ogRpcName, ogUpsHumidity=ogUpsHumidity, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientMode=ogWifiClientMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortBreaks=ogSerialPortBreaks, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTemperature=ogCellModemTemperature, ogRpcType=ogRpcType, ogRpcIndex=ogRpcIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserPort=ogSerialUserPort)
