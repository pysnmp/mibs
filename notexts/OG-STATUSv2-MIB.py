...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckTable=ogCheckTable, ogHostIndex=ogHostIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioState=ogEmdDioState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmState=ogAlarmState, ogHostUserAddress=ogHostUserAddress, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletState=ogRpcOutletState, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioName=ogEmdDioName, ogUpsEntry=ogUpsEntry, ogUpsType=ogUpsType, ogRpcDescription=ogRpcDescription, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserIndex=ogSerialUserIndex, ogHostUserHostName=ogHostUserHostName, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserStartTime=ogWebUserStartTime, ogHostUserIndex=ogHostUserIndex, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmEventId=ogAlarmEventId, ogCellModemIMSI=ogCellModemIMSI, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEntry=ogWifiApEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortTable=ogSerialPortTable, ogCellDataNotification=ogCellDataNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemTower=ogCellModemTower, ogCellModemIndex=ogCellModemIndex, ogUpsConnectType=ogUpsConnectType, ogCellModemVendor=ogCellModemVendor, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemApn=ogCellModemApn, ogSerialPortCTS=ogSerialPortCTS, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioIndex=ogEmdDioIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Groups=ogStatus2Groups, ogCheckIndex=ogCheckIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsTable=ogUpsTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserTable=ogWebUserTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmUser=ogAlarmUser, ogEmdIndex=ogEmdIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserNotification=ogHostUserNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialNumber=ogSerialNumber, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioEmd=ogEmdDioEmd, ogCheckType=ogCheckType, ogUpsTemperature=ogUpsTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsName=ogUpsName, ogRpcCounter=ogRpcCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientApMac=ogWifiClientApMac, ogAlarmName=ogAlarmName, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Conformance=ogStatus2Conformance, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmType=ogAlarmType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApTable=ogWifiApTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDSR=ogSerialPortDSR, ogCellModemTable=ogCellModemTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserIndex=ogWebUserIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcConnectType=ogRpcConnectType, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApSsid=ogWifiApSsid, ogRpcInputCurrent=ogRpcInputCurrent, ogCustomNotification=ogCustomNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIpV6Address=ogHostIpV6Address, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTable=ogWifiApClientTable, ogCellModemModel=ogCellModemModel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputNotification=ogRpcInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdName=ogEmdName, ogAlarmInstance=ogAlarmInstance, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogRpcType=ogRpcType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemConnected=ogCellModemConnected, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdEntry=ogEmdEntry, ogSerialUserPort=ogSerialUserPort, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmTime=ogAlarmTime, ogWebUserEntry=ogWebUserEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyName=ogPowerSupplyName, ogHostUserName=ogHostUserName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientTable=ogWifiClientTable, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogIndex=ogAlarmLogIndex, ogSystem=ogSystem, ogRpcName=ogRpcName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApEnabled=ogWifiApEnabled, ogHostEntry=ogHostEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostTable=ogHostTable, ogCellModemEntry=ogCellModemEntry, ogHostPingNotification=ogHostPingNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckEntry=ogCheckEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioDirection=ogEmdDioDirection, ogMibNotifications=ogMibNotifications, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTable=ogEmdTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmSummary=ogAlarmSummary, ogUpsNotification=ogUpsNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletName=ogRpcOutletName, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellTowerNotification=ogCellTowerNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioTable=ogEmdDioTable, ogWebUserNotification=ogWebUserNotification, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserHost=ogHostUserHost, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDescription=ogEmdDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmDevice=ogAlarmDevice, ogWebUserName=ogWebUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceEntry=ogHostServiceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostName=ogHostName, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortMode=ogSerialPortMode, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServicePort=ogHostServicePort, ogCheckName=ogCheckName, ogUpsIndex=ogUpsIndex, ogHostServiceIndex=ogHostServiceIndex, ogUpsDescription=ogUpsDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceTable=ogHostServiceTable, ogEmdDioNotification=ogEmdDioNotification, ogWifiApInterface=ogWifiApInterface, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsHumidity=ogUpsHumidity, ogHostServiceHost=ogHostServiceHost, ogHostServiceType=ogHostServiceType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcEntry=ogRpcEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientEnabled=ogWifiClientEnabled, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceState=ogNetInterfaceState, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmCheck=ogAlarmCheck, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcTable=ogRpcTable, ogAlarm=ogAlarm, ogRpcIndex=ogRpcIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioType=ogEmdDioType, ogNetInterfaceType=ogNetInterfaceType, ogStatus2=ogStatus2, ogEmdEnabled=ogEmdEnabled)
