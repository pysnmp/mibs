...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemVendor=ogCellModemVendor, ogUpsState=ogUpsState, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApFrequency=ogWifiApFrequency, ogRpcConnectType=ogRpcConnectType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApSsid=ogWifiApSsid, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioState=ogEmdDioState, ogCellModemTable=ogCellModemTable, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityTotal=ogEmdHumidityTotal, PYSNMP_MODULE_ID=ogStatus2, ogEmdConnectType=ogEmdConnectType, ogCheckResolveActions=ogCheckResolveActions, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellNetworkNotification=ogCellNetworkNotification, ogCellDataNotification=ogCellDataNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputNotification=ogRpcInputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityName=ogEmdHumidityName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemEntry=ogCellModemEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceName=ogNetInterfaceName, ogAlarmUser=ogAlarmUser, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsCounter=ogUpsCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemRegistered=ogCellModemRegistered, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserStartTime=ogWebUserStartTime, ogUpsEntry=ogUpsEntry, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDescription=ogEmdDescription, ogHostName=ogHostName, ogWifiApClientTable=ogWifiApClientTable, ogHostServicePort=ogHostServicePort, ogSerialNumber=ogSerialNumber, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDSR=ogSerialPortDSR, ogUpsDescription=ogUpsDescription, ogWifiApEntry=ogWifiApEntry, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogCellMessageNotification=ogCellMessageNotification, ogRpcName=ogRpcName, ogHostUserIndex=ogHostUserIndex, ogEmdIndex=ogEmdIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmLogTable=ogAlarmLogTable, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserEntry=ogHostUserEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortTable=ogSerialPortTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceHost=ogHostServiceHost, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Compliance=ogStatus2Compliance, ogUpsNotification=ogUpsNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletName=ogRpcOutletName, ogHostPingNotification=ogHostPingNotification, ogEmdEntry=ogEmdEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemApn=ogCellModemApn, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemConnected=ogCellModemConnected, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogStatus2=ogStatus2, ogHostUserHost=ogHostUserHost, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostEntry=ogHostEntry, ogRpcTable=ogRpcTable, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserAddress=ogHostUserAddress, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserEntry=ogWebUserEntry, ogWifiApCounter=ogWifiApCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdName=ogEmdName, ogHostIpV4Address=ogHostIpV4Address, ogHostUserStartTime=ogHostUserStartTime, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientTable=ogWifiClientTable, ogSerialUserTable=ogSerialUserTable, ogSerialPortIndex=ogSerialPortIndex, ogCheckTable=ogCheckTable, ogEmdDioCounter=ogEmdDioCounter, ogUpsIndex=ogUpsIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmEventId=ogAlarmEventId, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserIndex=ogSerialUserIndex, ogMibNotifications=ogMibNotifications, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputVoltage=ogRpcInputVoltage, ogCellTowerNotification=ogCellTowerNotification, ogWifiApTable=ogWifiApTable, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckType=ogCheckType, ogEmdEnabled=ogEmdEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcEntry=ogRpcEntry, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortMode=ogSerialPortMode, ogWebUserIndex=ogWebUserIndex, ogEmdTable=ogEmdTable, ogSerialPortDCD=ogSerialPortDCD, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserName=ogHostUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemModel=ogCellModemModel, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApInterface=ogWifiApInterface, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcCounter=ogRpcCounter, ogHostTable=ogHostTable, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientMode=ogWifiClientMode, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsHumidity=ogUpsHumidity, ogHostUserTable=ogHostUserTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEntry=ogWifiClientEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellApnNotification=ogCellApnNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserTable=ogWebUserTable, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckName=ogCheckName, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmInstance=ogAlarmInstance, ogWifiClientRssi=ogWifiClientRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcIndex=ogRpcIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioName=ogEmdDioName, ogAlarm=ogAlarm, ogRpcDescription=ogRpcDescription, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceStatus=ogHostServiceStatus, ogCheckIndex=ogCheckIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserPort=ogSerialUserPort, ogAlarmType=ogAlarmType, ogUpsType=ogUpsType, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserName=ogSerialUserName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSystem=ogSystem, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsTable=ogUpsTable, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIndex=ogHostIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmName=ogAlarmName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmDevice=ogAlarmDevice, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsName=ogUpsName, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceName=ogCheckDeviceName, ogAlarmState=ogAlarmState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioType=ogEmdDioType, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserLabel=ogSerialUserLabel, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCustomNotification=ogCustomNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTemperature=ogCellModemTemperature, ogAlarmSummary=ogAlarmSummary, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserName=ogWebUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcType=ogRpcType, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientIndex=ogWifiClientIndex, ogCheckEntry=ogCheckEntry)
