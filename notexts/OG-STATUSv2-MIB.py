...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientIndex=ogWifiClientIndex, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientAp=ogWifiApClientAp, ogRpcName=ogRpcName, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsTable=ogUpsTable, ogEmdDioTable=ogEmdDioTable, ogRpcOutletState=ogRpcOutletState, ogWifiClientMode=ogWifiClientMode, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmEventId=ogAlarmEventId, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserName=ogHostUserName, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckTable=ogCheckTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceStatus=ogHostServiceStatus, ogUpsState=ogUpsState, ogUpsIndex=ogUpsIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServicePort=ogHostServicePort, ogUpsType=ogUpsType, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortRTS=ogSerialPortRTS, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioState=ogEmdDioState, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletName=ogRpcOutletName, ogEmdIndex=ogEmdIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceHost=ogHostServiceHost, ogEmdEntry=ogEmdEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDCD=ogSerialPortDCD, ogUpsDescription=ogUpsDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2=ogStatus2, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserTable=ogHostUserTable, ogSerialPortMode=ogSerialPortMode, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdEnabled=ogEmdEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserStartTime=ogWebUserStartTime, ogAlarmType=ogAlarmType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmState=ogAlarmState, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceCounter=ogHostServiceCounter, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserIndex=ogSerialUserIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostName=ogHostName, ogAlarmName=ogAlarmName, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputNotification=ogUpsOutputNotification, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDirection=ogEmdDioDirection, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserEntry=ogSerialUserEntry, ogHostUserNotification=ogHostUserNotification, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmTime=ogAlarmTime, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogUpsEntry=ogUpsEntry, ogSystem=ogSystem, ogSerialNumber=ogSerialNumber, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApTable=ogWifiApTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioEmd=ogEmdDioEmd, ogWebUserTable=ogWebUserTable, ogStatus2Compliances=ogStatus2Compliances, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsHumidity=ogUpsHumidity, ogAlarmUser=ogAlarmUser, ogHostTable=ogHostTable, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdConnectType=ogEmdConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioType=ogEmdDioType, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemConnected=ogCellModemConnected, ogCellSignalNotification=ogCellSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTable=ogCellModemTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTable=ogWifiApClientTable, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcEntry=ogRpcEntry, ogSerialUserName=ogSerialUserName, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckIndex=ogCheckIndex, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceEntry=ogHostServiceEntry, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsNotification=ogUpsNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcIndex=ogRpcIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsCounter=ogUpsCounter, ogCustomNotification=ogCustomNotification, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellMessageNotification=ogCellMessageNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientEssid=ogWifiClientEssid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityCounter=ogEmdHumidityCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDescription=ogEmdDescription, ogHostServiceType=ogHostServiceType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckEntry=ogCheckEntry, ogWifiApIndex=ogWifiApIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioName=ogEmdDioName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientInterface=ogWifiClientInterface, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostEntry=ogHostEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserEntry=ogWebUserEntry, ogSerialUserLabel=ogSerialUserLabel, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserHostName=ogHostUserHostName, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmInstance=ogAlarmInstance, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdName=ogEmdName, ogRpcOutletTable=ogRpcOutletTable, ogMibNotifications=ogMibNotifications, ogAlarmDevice=ogAlarmDevice, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserNotification=ogWebUserNotification, ogRpcTable=ogRpcTable, ogWifiApInterface=ogWifiApInterface, ogWebUserName=ogWebUserName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellApnNotification=ogCellApnNotification, ogCellModemIndex=ogCellModemIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsTemperature=ogUpsTemperature, ogSerialPortCTS=ogSerialPortCTS, ogHostUserIndex=ogHostUserIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsConnectType=ogUpsConnectType, ogRpcConnectType=ogRpcConnectType, ogRpcType=ogRpcType, ogCellModemSessionTime=ogCellModemSessionTime, ogHostIndex=ogHostIndex, ogCheckType=ogCheckType, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserIndex=ogWebUserIndex, ogWifiApCounter=ogWifiApCounter, ogWifiApSsid=ogWifiApSsid, ogAlarm=ogAlarm, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsName=ogUpsName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmCheck=ogAlarmCheck, ogCellModemApn=ogCellModemApn, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTable=ogEmdTable, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortParity=ogSerialPortParity, ogRpcDescription=ogRpcDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserHost=ogHostUserHost, ogHostServiceIndex=ogHostServiceIndex, ogCellModemModel=ogCellModemModel, ogCellTowerNotification=ogCellTowerNotification, ogCheckName=ogCheckName, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientApMac=ogWifiClientApMac, ogRpcCounter=ogRpcCounter, ogAlarmSummary=ogAlarmSummary, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage)
