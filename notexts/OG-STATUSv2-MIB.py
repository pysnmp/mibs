...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserIndex=ogSerialUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogHostPingNotification=ogHostPingNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialNumber=ogSerialNumber, ogEmdEntry=ogEmdEntry, ogSerialPortMode=ogSerialPortMode, ogAlarmName=ogAlarmName, ogSystem=ogSystem, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioType=ogEmdDioType, ogCellModemIndex=ogCellModemIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceName=ogNetInterfaceName, ogCellDataNotification=ogCellDataNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcEntry=ogRpcEntry, ogAlarmState=ogAlarmState, ogAlarmType=ogAlarmType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2Compliances=ogStatus2Compliances, ogWebUserTable=ogWebUserTable, ogWebUserNotification=ogWebUserNotification, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioState=ogEmdDioState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserAddress=ogHostUserAddress, ogWifiApTable=ogWifiApTable, ogAlarmDevice=ogAlarmDevice, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcDescription=ogRpcDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckType=ogCheckType, ogAlarmCheck=ogAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortTable=ogSerialPortTable, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDescription=ogEmdDescription, ogUpsIndex=ogUpsIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDCD=ogSerialPortDCD, ogCellModemCounter=ogCellModemCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIndex=ogHostIndex, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApSsid=ogWifiApSsid, ogRpcOutletState=ogRpcOutletState, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDSR=ogSerialPortDSR, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcConnectType=ogRpcConnectType, ogCellModemConnected=ogCellModemConnected, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostName=ogHostName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcName=ogRpcName, ogSerialUserName=ogSerialUserName, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApEntry=ogWifiApEntry, ogHostServiceTable=ogHostServiceTable, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientEssid=ogWifiClientEssid, ogCheckName=ogCheckName, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApCounter=ogWifiApCounter, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcTable=ogRpcTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemEntry=ogCellModemEntry, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceType=ogHostServiceType, ogEmdDioDescription=ogEmdDioDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogCustomNotification=ogCustomNotification, ogCellModemRegistered=ogCellModemRegistered, ogAlarmTime=ogAlarmTime, ogCellModemNetwork=ogCellModemNetwork, ogCellModemApn=ogCellModemApn, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsName=ogUpsName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdIndex=ogEmdIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckDeviceName=ogCheckDeviceName, ogCheckResolveActions=ogCheckResolveActions, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserEntry=ogSerialUserEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioName=ogEmdDioName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmEventId=ogAlarmEventId, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdName=ogEmdName, ogUpsTemperature=ogUpsTemperature, ogEmdDioNotification=ogEmdDioNotification, ogHostServicePort=ogHostServicePort, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientMac=ogWifiApClientMac, ogRpcIndex=ogRpcIndex, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserHost=ogHostUserHost, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserIndex=ogHostUserIndex, ogRpcType=ogRpcType, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserNotification=ogHostUserNotification, ogUpsCounter=ogUpsCounter, ogCellModemTower=ogCellModemTower, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogMibNotifications=ogMibNotifications, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostTable=ogHostTable, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientMode=ogWifiClientMode, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsNotification=ogUpsNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiApInterface=ogWifiApInterface, ogWebUserIndex=ogWebUserIndex, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputNotification=ogRpcInputNotification, ogAlarmInstance=ogAlarmInstance, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceType=ogNetInterfaceType, ogAlarm=ogAlarm, ogRpcCounter=ogRpcCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioDirection=ogEmdDioDirection, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTable=ogEmdTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientFrequency=ogWifiClientFrequency, ogCheckIndex=ogCheckIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioIndex=ogEmdDioIndex, ogUpsType=ogUpsType, ogStatus2=ogStatus2, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmUser=ogAlarmUser, ogHostUserTable=ogHostUserTable, ogUpsConnectType=ogUpsConnectType, ogWifiClientCounter=ogWifiClientCounter, ogUpsTable=ogUpsTable, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdEnabled=ogEmdEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyName=ogPowerSupplyName, ogCellSignalNotification=ogCellSignalNotification, ogUpsState=ogUpsState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserName=ogHostUserName, ogWifiApFrequency=ogWifiApFrequency, ogCheckTable=ogCheckTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostEntry=ogHostEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2Groups=ogStatus2Groups, ogCellModemModel=ogCellModemModel, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDTR=ogSerialPortDTR, ogCheckEntry=ogCheckEntry, ogHostUserHostName=ogHostUserHostName, ogWifiApEnabled=ogWifiApEnabled, ogWifiApIndex=ogWifiApIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV4Address=ogHostIpV4Address, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserPort=ogSerialUserPort, ogAlarmSummary=ogAlarmSummary, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsEntry=ogUpsEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserName=ogWebUserName, ogRpcOutletName=ogRpcOutletName, ogUpsDescription=ogUpsDescription, ogUpsHumidity=ogUpsHumidity, ogUpsOutputCurrent=ogUpsOutputCurrent)
