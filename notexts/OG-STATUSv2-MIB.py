...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceHost=ogHostServiceHost, ogUpsTemperature=ogUpsTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSystem=ogSystem, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioType=ogEmdDioType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIndex=ogHostIndex, ogWebUserName=ogWebUserName, ogHostUserEntry=ogHostUserEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemCounter=ogCellModemCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortMode=ogSerialPortMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApIndex=ogWifiApIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientMac=ogWifiApClientMac, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserIndex=ogHostUserIndex, ogHostEntry=ogHostEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogCellModemTower=ogCellModemTower, ogAlarmDevice=ogAlarmDevice, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsTable=ogUpsTable, ogUpsInputCurrent=ogUpsInputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemModel=ogCellModemModel, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliance=ogStatus2Compliance, ogWebUserEntry=ogWebUserEntry, ogEmdEnabled=ogEmdEnabled, ogCheckName=ogCheckName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApTxPower=ogWifiApTxPower, ogAlarm=ogAlarm, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckType=ogCheckType, ogUpsDescription=ogUpsDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserTable=ogWebUserTable, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTable=ogCellModemTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcCounter=ogRpcCounter, ogWifiApTable=ogWifiApTable, ogCurrentAlarmType=ogCurrentAlarmType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceType=ogNetInterfaceType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCustomNotification=ogCustomNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemVendor=ogCellModemVendor, ogAlarmState=ogAlarmState, ogRpcName=ogRpcName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemIMSI=ogCellModemIMSI, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserName=ogSerialUserName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserHostName=ogHostUserHostName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdName=ogEmdName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmCheck=ogAlarmCheck, ogRpcDescription=ogRpcDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTime=ogAlarmTime, ogEmdHumidityValue=ogEmdHumidityValue, ogHostName=ogHostName, ogEmdDioName=ogEmdDioName, ogCellModemConnected=ogCellModemConnected, ogAlarmType=ogAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckDeviceName=ogCheckDeviceName, ogAlarmEventId=ogAlarmEventId, ogSerialUserEntry=ogSerialUserEntry, ogWifiApEntry=ogWifiApEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdIndex=ogEmdIndex, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioEntry=ogEmdDioEntry, ogHostUserAddress=ogHostUserAddress, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortCTS=ogSerialPortCTS, ogHostIpV4Address=ogHostIpV4Address, ogCheckTable=ogCheckTable, ogCurrentAlarmState=ogCurrentAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserStartTime=ogWebUserStartTime, ogCellModemRegistered=ogCellModemRegistered, ogHostTable=ogHostTable, ogUpsCounter=ogUpsCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserPort=ogSerialUserPort, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmInstance=ogAlarmInstance, ogCellModemIndex=ogCellModemIndex, ogWifiClientIndex=ogWifiClientIndex, ogMibNotifications=ogMibNotifications, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialNumber=ogSerialNumber, ogUpsIndex=ogUpsIndex, ogHostUserTable=ogHostUserTable, ogSerialPortParity=ogSerialPortParity, ogWifiClientBitRate=ogWifiClientBitRate, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioState=ogEmdDioState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserIndex=ogWebUserIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsNotification=ogUpsNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceType=ogHostServiceType, ogEmdTable=ogEmdTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserHost=ogHostUserHost, ogWifiApCounter=ogWifiApCounter, ogSerialUserTable=ogSerialUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsType=ogUpsType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcIndex=ogRpcIndex, ogHostPingNotification=ogHostPingNotification, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDescription=ogEmdDescription, ogRpcEntry=ogRpcEntry, ogSerialUserStartTime=ogSerialUserStartTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientCounter=ogWifiClientCounter, ogEmdDioDescription=ogEmdDioDescription, ogEmdEntry=ogEmdEntry, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortTable=ogSerialPortTable, ogUpsState=ogUpsState, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServicePort=ogHostServicePort, ogCellNetworkNotification=ogCellNetworkNotification, ogCellDataNotification=ogCellDataNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientAp=ogWifiApClientAp, ogWebUserNotification=ogWebUserNotification, ogRpcConnectType=ogRpcConnectType, ogCheckEntry=ogCheckEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmSummary=ogAlarmSummary, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserNotification=ogHostUserNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletName=ogRpcOutletName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemEntry=ogCellModemEntry, ogCellModemApn=ogCellModemApn, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientTable=ogWifiClientTable, ogUpsName=ogUpsName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNotification=ogUpsInputNotification, ogAlarmUser=ogAlarmUser, ogRpcType=ogRpcType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdConnectType=ogEmdConnectType, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckIndex=ogCheckIndex, ogWifiApSsid=ogWifiApSsid, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcTable=ogRpcTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2Groups=ogStatus2Groups, ogAlarmName=ogAlarmName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserName=ogHostUserName, ogSerialUserNotification=ogSerialUserNotification, ogStatus2=ogStatus2, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsEntry=ogUpsEntry)
