...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdEnabled=ogEmdEnabled, ogRpcIndex=ogRpcIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioDirection=ogEmdDioDirection, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientIndex=ogWifiClientIndex, ogCellModemApn=ogCellModemApn, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmType=ogAlarmType, ogUpsNotification=ogUpsNotification, ogSerialNumber=ogSerialNumber, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsDescription=ogUpsDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostName=ogHostName, ogCellModemCounter=ogCellModemCounter, ogStatus2Compliance=ogStatus2Compliance, ogUpsCounter=ogUpsCounter, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsName=ogUpsName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServicePort=ogHostServicePort, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletTable=ogRpcOutletTable, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioCounter=ogEmdDioCounter, ogCellModemVendor=ogCellModemVendor, ogSerialPortLogLevel=ogSerialPortLogLevel, ogFirmwareVersion=ogFirmwareVersion, ogWebUserStartTime=ogWebUserStartTime, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserIndex=ogSerialUserIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemIndex=ogCellModemIndex, ogAlarmName=ogAlarmName, ogCellMessageNotification=ogCellMessageNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcDescription=ogRpcDescription, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogHostUserIndex=ogHostUserIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioEmd=ogEmdDioEmd, ogHostIpV4Address=ogHostIpV4Address, ogAlarmState=ogAlarmState, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellDataNotification=ogCellDataNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostTable=ogHostTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserName=ogSerialUserName, ogCellSignalNotification=ogCellSignalNotification, ogEmdIndex=ogEmdIndex, ogUpsHumidity=ogUpsHumidity, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioEntry=ogEmdDioEntry, ogStatus2Groups=ogStatus2Groups, ogCheckTable=ogCheckTable, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsType=ogUpsType, ogSerialPortDCD=ogSerialPortDCD, ogHostServiceTable=ogHostServiceTable, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortParity=ogSerialPortParity, ogAlarmSummary=ogAlarmSummary, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmEventId=ogAlarmEventId, ogHostIndex=ogHostIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortCTS=ogSerialPortCTS, ogUpsConnectType=ogUpsConnectType, ogEmdConnectType=ogEmdConnectType, ogWebUserTable=ogWebUserTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialUserNotification=ogSerialUserNotification, ogUpsEntry=ogUpsEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApInterface=ogWifiApInterface, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcTable=ogRpcTable, ogRpcCounter=ogRpcCounter, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientTable=ogWifiClientTable, ogSerialPortEntry=ogSerialPortEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceType=ogNetInterfaceType, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostEntry=ogHostEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSystem=ogSystem, ogCellModemTable=ogCellModemTable, ogWebUserNotification=ogWebUserNotification, ogRpcConnectType=ogRpcConnectType, ogStatus2Conformance=ogStatus2Conformance, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientMode=ogWifiClientMode, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioState=ogEmdDioState, ogHostServiceHost=ogHostServiceHost, ogRpcName=ogRpcName, ogAlarmLogTable=ogAlarmLogTable, ogUpsState=ogUpsState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApCounter=ogWifiApCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceType=ogHostServiceType, ogCellModemTower=ogCellModemTower, ogCheckEntry=ogCheckEntry, ogSerialUserPort=ogSerialUserPort, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApIndex=ogWifiApIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApTable=ogWifiApTable, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApFrequency=ogWifiApFrequency, ogSerialUserTable=ogSerialUserTable, ogEmdName=ogEmdName, ogWifiApClientTable=ogWifiApClientTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemModel=ogCellModemModel, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsLogEnabled=ogUpsLogEnabled, ogHostPingNotification=ogHostPingNotification, ogWifiApClientMac=ogWifiApClientMac, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioTable=ogEmdDioTable, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserName=ogWebUserName, ogEmdDioType=ogEmdDioType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortRTS=ogSerialPortRTS, ogCheckIndex=ogCheckIndex, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserHostName=ogHostUserHostName, ogHostUserNotification=ogHostUserNotification, ogUpsTable=ogUpsTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2=ogStatus2, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdEntry=ogEmdEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarm=ogAlarm, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserName=ogHostUserName, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioName=ogEmdDioName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserTable=ogHostUserTable, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDescription=ogEmdDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletName=ogRpcOutletName, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemRegistered=ogCellModemRegistered, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientAp=ogWifiApClientAp, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcType=ogRpcType, ogCellModemEntry=ogCellModemEntry, ogSerialUserLabel=ogSerialUserLabel, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckType=ogCheckType, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmTime=ogAlarmTime, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsTemperature=ogUpsTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemTemperature=ogCellModemTemperature, ogCheckName=ogCheckName, ogWifiApSsid=ogWifiApSsid, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceNotification=ogHostServiceNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmUser=ogAlarmUser, ogHostUserHost=ogHostUserHost, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientApMac=ogWifiClientApMac, ogMibNotifications=ogMibNotifications, ogUpsIndex=ogUpsIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcEntry=ogRpcEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogCellApnNotification=ogCellApnNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyEntry=ogPowerSupplyEntry)
