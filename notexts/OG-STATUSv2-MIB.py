...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceNotification=ogHostServiceNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogHostEntry=ogHostEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTable=ogEmdTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmState=ogAlarmState, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdIndex=ogEmdIndex, ogHostName=ogHostName, ogCellModemEntry=ogCellModemEntry, ogHostUserStartTime=ogHostUserStartTime, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogAlarmType=ogAlarmType, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsTemperature=ogUpsTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApTable=ogWifiApTable, ogCellModemTable=ogCellModemTable, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserAddress=ogHostUserAddress, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmInstance=ogAlarmInstance, ogSerialPortMode=ogSerialPortMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserHost=ogHostUserHost, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserName=ogSerialUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsType=ogUpsType, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTable=ogCheckTable, ogSerialPortLabel=ogSerialPortLabel, ogHostUserName=ogHostUserName, ogMibNotifications=ogMibNotifications, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCustomNotification=ogCustomNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHostName=ogHostUserHostName, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsState=ogUpsState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsName=ogUpsName, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmCheck=ogAlarmCheck, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserLabel=ogSerialUserLabel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsIndex=ogUpsIndex, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcConnectType=ogRpcConnectType, ogEmdName=ogEmdName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortDCD=ogSerialPortDCD, ogRpcIndex=ogRpcIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2=ogStatus2, ogAlarmSummary=ogAlarmSummary, ogEmdDioName=ogEmdDioName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientTable=ogWifiClientTable, ogCellModemIMSI=ogCellModemIMSI, ogHostUserNotification=ogHostUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmName=ogAlarmName, ogHostServiceTable=ogHostServiceTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcCounter=ogRpcCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckResetTimeout=ogCheckResetTimeout, ogCellDataNotification=ogCellDataNotification, ogRpcInputNotification=ogRpcInputNotification, ogWifiApInterface=ogWifiApInterface, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemApn=ogCellModemApn, ogHostPingNotification=ogHostPingNotification, ogSerialUserPort=ogSerialUserPort, ogCellModemCounter=ogCellModemCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserTable=ogSerialUserTable, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Groups=ogStatus2Groups, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmDevice=ogAlarmDevice, ogRpcDescription=ogRpcDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogFirmwareVersion=ogFirmwareVersion, ogEmdEntry=ogEmdEntry, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDescription=ogEmdDescription, ogHostIpV6Address=ogHostIpV6Address, ogRpcEntry=ogRpcEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemModel=ogCellModemModel, ogRpcType=ogRpcType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioType=ogEmdDioType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsCounter=ogUpsCounter, ogWebUserStartTime=ogWebUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckName=ogCheckName, ogUpsEntry=ogUpsEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmLogTable=ogAlarmLogTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSystem=ogSystem, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceHost=ogHostServiceHost, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsDescription=ogUpsDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortTable=ogSerialPortTable, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceName=ogNetInterfaceName, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemVendor=ogCellModemVendor, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsTable=ogUpsTable, ogWebUserSourcePort=ogWebUserSourcePort, ogHostIpV4Address=ogHostIpV4Address, ogUpsConnectType=ogUpsConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogCellModemTemperature=ogCellModemTemperature, ogAlarmTime=ogAlarmTime, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServicePort=ogHostServicePort, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemIndex=ogCellModemIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmUser=ogAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserNotification=ogWebUserNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmEventId=ogAlarmEventId, ogCellTowerNotification=ogCellTowerNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcTable=ogRpcTable, ogUpsNotification=ogUpsNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogHostUserEntry=ogHostUserEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEnabled=ogEmdEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckType=ogCheckType, ogUpsBatteryNotification=ogUpsBatteryNotification, PYSNMP_MODULE_ID=ogStatus2, ogCellModemConnected=ogCellModemConnected, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApEntry=ogWifiApEntry, ogEmdDioState=ogEmdDioState, ogSerialPortParity=ogSerialPortParity, ogCheckEntry=ogCheckEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletTable=ogRpcOutletTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDTR=ogSerialPortDTR, ogRpcName=ogRpcName, ogHostServiceType=ogHostServiceType, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckIndex=ogCheckIndex, ogWifiClientMode=ogWifiClientMode, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserTable=ogWebUserTable, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialNumber=ogSerialNumber, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarm=ogAlarm, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserName=ogWebUserName, ogHostUserIndex=ogHostUserIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletName=ogRpcOutletName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryState=ogUpsBatteryState, ogWifiApTxPower=ogWifiApTxPower, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIndex=ogHostIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioEmd=ogEmdDioEmd)
