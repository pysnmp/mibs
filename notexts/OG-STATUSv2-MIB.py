...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdEntry=ogEmdEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientTable=ogWifiClientTable, ogSerialUserPort=ogSerialUserPort, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsName=ogUpsName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsState=ogUpsState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmType=ogAlarmType, ogHostUserName=ogHostUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsTemperature=ogUpsTemperature, ogEmdName=ogEmdName, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemIndex=ogCellModemIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputNotification=ogRpcInputNotification, ogStatus2Groups=ogStatus2Groups, ogUpsTable=ogUpsTable, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSystem=ogSystem, ogAlarmSummary=ogAlarmSummary, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostName=ogHostName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsDescription=ogUpsDescription, ogHostUserNotification=ogHostUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApSsid=ogWifiApSsid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmTime=ogAlarmTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckType=ogCheckType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioIndex=ogEmdDioIndex, ogCheckEntry=ogCheckEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsIndex=ogUpsIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserStartTime=ogWebUserStartTime, ogEmdDescription=ogEmdDescription, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostEntry=ogHostEntry, ogSerialPortMode=ogSerialPortMode, ogEmdDioCounter=ogEmdDioCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcIndex=ogRpcIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, PYSNMP_MODULE_ID=ogStatus2, ogCellModemApn=ogCellModemApn, ogHostTable=ogHostTable, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortTable=ogSerialPortTable, ogCellModemEntry=ogCellModemEntry, ogCellModemTower=ogCellModemTower, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceName=ogCheckDeviceName, ogHostUserAddress=ogHostUserAddress, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceStatus=ogHostServiceStatus, ogCellApnNotification=ogCellApnNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialNumber=ogSerialNumber, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdIndex=ogEmdIndex, ogFirmwareVersion=ogFirmwareVersion, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceName=ogNetInterfaceName, ogRpcCounter=ogRpcCounter, ogUpsEntry=ogUpsEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemCounter=ogCellModemCounter, ogCellModemNetwork=ogCellModemNetwork, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserTable=ogWebUserTable, ogAlarmCheck=ogAlarmCheck, ogRpcType=ogRpcType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserHostName=ogHostUserHostName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTable=ogEmdTable, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserName=ogSerialUserName, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTable=ogWifiApTable, ogCheckIndex=ogCheckIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserEntry=ogWebUserEntry, ogCellModemTable=ogCellModemTable, ogSerialPortParity=ogSerialPortParity, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmState=ogAlarmState, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputPower=ogUpsOutputPower, ogMibNotifications=ogMibNotifications, ogCurrentAlarmName=ogCurrentAlarmName, ogHostIndex=ogHostIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdConnectType=ogEmdConnectType, ogRpcEntry=ogRpcEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogRpcDescription=ogRpcDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientInterface=ogWifiClientInterface, ogStatus2=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckName=ogCheckName, ogEmdEnabled=ogEmdEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletName=ogRpcOutletName, ogEmdDioType=ogEmdDioType, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Compliance=ogStatus2Compliance, ogRpcName=ogRpcName, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDTR=ogSerialPortDTR, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmName=ogAlarmName, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserTable=ogHostUserTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemModel=ogCellModemModel, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputCurrent=ogUpsInputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRegistered=ogCellModemRegistered, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsNotification=ogUpsNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserHost=ogHostUserHost, ogWebUserIndex=ogWebUserIndex, ogUpsHumidity=ogUpsHumidity, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceState=ogNetInterfaceState, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioTable=ogEmdDioTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsCounter=ogUpsCounter, ogCellModemEnabled=ogCellModemEnabled, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputVoltage=ogRpcInputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortIndex=ogSerialPortIndex, ogCellModemVendor=ogCellModemVendor, ogUpsType=ogUpsType, ogRpcConnectType=ogRpcConnectType, ogHostUserIndex=ogHostUserIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientMode=ogWifiClientMode, ogHostUserEntry=ogHostUserEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioState=ogEmdDioState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserName=ogWebUserName, ogCustomNotification=ogCustomNotification, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceCounter=ogHostServiceCounter, ogAlarm=ogAlarm, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioDescription=ogEmdDioDescription, ogHostServicePort=ogHostServicePort, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioEmd=ogEmdDioEmd, ogHostServiceType=ogHostServiceType, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioName=ogEmdDioName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserTable=ogSerialUserTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmInstance=ogAlarmInstance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckTable=ogCheckTable, ogCellModemConnected=ogCellModemConnected, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserLabel=ogSerialUserLabel, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientTxPower=ogWifiClientTxPower)
