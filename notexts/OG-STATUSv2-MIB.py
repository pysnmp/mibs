...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApInterface=ogWifiApInterface, ogHostEntry=ogHostEntry, ogSerialNumber=ogSerialNumber, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcDescription=ogRpcDescription, ogNetInterfaceType=ogNetInterfaceType, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostTable=ogHostTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmTime=ogAlarmTime, ogRpcConnectType=ogRpcConnectType, ogUpsCounter=ogUpsCounter, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Compliances=ogStatus2Compliances, ogEmdConnectType=ogEmdConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserEntry=ogWebUserEntry, ogHostServiceHost=ogHostServiceHost, ogEmdDioIndex=ogEmdDioIndex, ogHostUserTable=ogHostUserTable, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortRTS=ogSerialPortRTS, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDescription=ogEmdDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientMac=ogWifiApClientMac, ogCellModemModel=ogCellModemModel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogTable=ogAlarmLogTable, ogCellModemTemperature=ogCellModemTemperature, ogCellModemConnected=ogCellModemConnected, ogCellModemTable=ogCellModemTable, ogUpsTable=ogUpsTable, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioEntry=ogEmdDioEntry, ogUpsConnectType=ogUpsConnectType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemCounter=ogCellModemCounter, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletName=ogRpcOutletName, ogCheckEntry=ogCheckEntry, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserLabel=ogSerialUserLabel, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsType=ogUpsType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmState=ogAlarmState, ogSerialPortMode=ogSerialPortMode, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputNotification=ogUpsInputNotification, ogCheckIndex=ogCheckIndex, ogRpcIndex=ogRpcIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellSignalNotification=ogCellSignalNotification, ogCheckName=ogCheckName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserEntry=ogHostUserEntry, ogCellModemVendor=ogCellModemVendor, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortCTS=ogSerialPortCTS, ogSystem=ogSystem, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserHost=ogHostUserHost, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmEventId=ogAlarmEventId, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRssi=ogWifiClientRssi, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceCounter=ogHostServiceCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmSummary=ogAlarmSummary, ogHostServiceType=ogHostServiceType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortLabel=ogSerialPortLabel, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmInstance=ogAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdName=ogEmdName, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceEntry=ogHostServiceEntry, ogWifiApTable=ogWifiApTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIndex=ogHostIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemEntry=ogCellModemEntry, ogAlarmName=ogAlarmName, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmUser=ogAlarmUser, ogEmdDioDescription=ogEmdDioDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarm=ogAlarm, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserPort=ogSerialUserPort, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmState=ogCurrentAlarmState, ogCellDataNotification=ogCellDataNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemApn=ogCellModemApn, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2=ogStatus2, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityTable=ogEmdHumidityTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioTable=ogEmdDioTable, ogHostServicePort=ogHostServicePort, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmDevice=ogAlarmDevice, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceIndex=ogHostServiceIndex, ogCheckType=ogCheckType, ogHostIpV6Address=ogHostIpV6Address, ogAlarmType=ogAlarmType, ogWifiApSsid=ogWifiApSsid, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityName=ogEmdHumidityName, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientEntry=ogWifiClientEntry, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceNotification=ogHostServiceNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserName=ogHostUserName, ogEmdIndex=ogEmdIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletState=ogRpcOutletState, ogWifiApFrequency=ogWifiApFrequency, ogCheckTable=ogCheckTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcTable=ogRpcTable, ogUpsName=ogUpsName, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckDeviceName=ogCheckDeviceName, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2Groups=ogStatus2Groups, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmCheck=ogAlarmCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioName=ogEmdDioName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcType=ogRpcType, ogSerialUserName=ogSerialUserName, ogRpcEntry=ogRpcEntry, ogWebUserTable=ogWebUserTable, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogHostName=ogHostName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsDescription=ogUpsDescription, ogUpsEntry=ogUpsEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcName=ogRpcName, ogHostUserHostName=ogHostUserHostName, ogEmdEntry=ogEmdEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogCustomNotification=ogCustomNotification, ogCellModemIndex=ogCellModemIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogMibNotifications=ogMibNotifications, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWebUserName=ogWebUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceName=ogNetInterfaceName, ogCellModemNetwork=ogCellModemNetwork, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletLoad=ogRpcOutletLoad, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcCounter=ogRpcCounter, ogWebUserNotification=ogWebUserNotification, ogHostUserNotification=ogHostUserNotification, ogEmdTable=ogEmdTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTower=ogCellModemTower, ogSerialPortDCD=ogSerialPortDCD, ogCellTowerNotification=ogCellTowerNotification, ogUpsState=ogUpsState, ogWifiClientEnabled=ogWifiClientEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsTemperature=ogUpsTemperature, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckResolveActions=ogCheckResolveActions, ogUpsNotification=ogUpsNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioState=ogEmdDioState)
