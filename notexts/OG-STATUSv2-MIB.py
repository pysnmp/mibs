...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServicePort=ogHostServicePort, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSystem=ogSystem, ogCheckIndex=ogCheckIndex, ogUpsIndex=ogUpsIndex, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientMode=ogWifiClientMode, ogWifiApClientTable=ogWifiApClientTable, ogHostName=ogHostName, ogRpcCounter=ogRpcCounter, ogCheckName=ogCheckName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckResolveActions=ogCheckResolveActions, ogWebUserTable=ogWebUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserName=ogSerialUserName, ogSerialPortParity=ogSerialPortParity, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsType=ogUpsType, ogAlarmUser=ogAlarmUser, ogUpsNotification=ogUpsNotification, ogRpcType=ogRpcType, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Conformance=ogStatus2Conformance, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckTable=ogCheckTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdEntry=ogEmdEntry, ogStatus2=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdIndex=ogEmdIndex, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserIndex=ogWebUserIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTable=ogCellModemTable, ogRpcTable=ogRpcTable, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioEmd=ogEmdDioEmd, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsEntry=ogUpsEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserHostName=ogHostUserHostName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApTable=ogWifiApTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputPower=ogUpsOutputPower, ogEmdConnectType=ogEmdConnectType, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarm=ogAlarm, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmType=ogAlarmType, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemRegistered=ogCellModemRegistered, ogStatus2Compliances=ogStatus2Compliances, ogBasicStatusGroup=ogBasicStatusGroup, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDTR=ogSerialPortDTR, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogHostEntry=ogHostEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcIndex=ogRpcIndex, ogHostUserName=ogHostUserName, ogEmdDioEntry=ogEmdDioEntry, ogSerialNumber=ogSerialNumber, ogWifiApCounter=ogWifiApCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIndex=ogHostIndex, ogEmdDioTable=ogEmdDioTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserEntry=ogHostUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogCellModemApn=ogCellModemApn, ogEmdDioName=ogEmdDioName, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmSummary=ogAlarmSummary, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDescription=ogEmdDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApInterface=ogWifiApInterface, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserName=ogWebUserName, ogSerialUserEntry=ogSerialUserEntry, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsTable=ogUpsTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortTable=ogSerialPortTable, ogWifiApClientMac=ogWifiApClientMac, ogCheckType=ogCheckType, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsCounter=ogUpsCounter, ogHostUserTable=ogHostUserTable, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientInterface=ogWifiClientInterface, ogHostUserNotification=ogHostUserNotification, ogAlarmTime=ogAlarmTime, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2Groups=ogStatus2Groups, ogEmdDioState=ogEmdDioState, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceTable=ogHostServiceTable, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceType=ogHostServiceType, ogEmdDioType=ogEmdDioType, ogSerialPatternNotification=ogSerialPatternNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceHost=ogHostServiceHost, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientTable=ogWifiClientTable, ogCellModemCounter=ogCellModemCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputVoltage=ogUpsInputVoltage, ogHostTable=ogHostTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostPingNotification=ogHostPingNotification, ogAlarmName=ogAlarmName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsTemperature=ogUpsTemperature, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserStartTime=ogHostUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserAddress=ogHostUserAddress, ogWifiClientApMac=ogWifiClientApMac, ogCellModemConnected=ogCellModemConnected, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDescription=ogEmdDioDescription, ogWifiApTxPower=ogWifiApTxPower, ogCellModemIndex=ogCellModemIndex, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityName=ogEmdHumidityName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserEntry=ogWebUserEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyName=ogPowerSupplyName, ogCellModemVendor=ogCellModemVendor, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmEventId=ogAlarmEventId, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDSR=ogSerialPortDSR, ogMibNotifications=ogMibNotifications, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIndex=ogWifiApIndex, ogCustomNotification=ogCustomNotification, ogRpcDescription=ogRpcDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCellApnNotification=ogCellApnNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsDescription=ogUpsDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEntry=ogWifiApEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmState=ogAlarmState, ogUpsConnectType=ogUpsConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsName=ogUpsName, ogRpcName=ogRpcName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogRpcEntry=ogRpcEntry, ogUpsHumidity=ogUpsHumidity, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserLabel=ogSerialUserLabel, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdName=ogEmdName, ogEmdDioIndex=ogEmdDioIndex, ogHostUserHost=ogHostUserHost, ogSerialUserPort=ogSerialUserPort, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEntry=ogWifiClientEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortIndex=ogSerialPortIndex, ogCheckEntry=ogCheckEntry, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTable=ogEmdTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceNotification=ogHostServiceNotification)
