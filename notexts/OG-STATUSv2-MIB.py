...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioIndex=ogEmdDioIndex, ogWebUserIndex=ogWebUserIndex, ogHostUserIndex=ogHostUserIndex, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortLabel=ogSerialPortLabel, ogWebUserTable=ogWebUserTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemCounter=ogCellModemCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortTable=ogSerialPortTable, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsDescription=ogUpsDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcName=ogRpcName, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmEventId=ogAlarmEventId, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemTable=ogCellModemTable, ogUpsConnectType=ogUpsConnectType, ogHostTable=ogHostTable, ogEmdDioName=ogEmdDioName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserName=ogSerialUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcIndex=ogRpcIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemEntry=ogCellModemEntry, ogStatus2Groups=ogStatus2Groups, ogRpcDescription=ogRpcDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdIndex=ogEmdIndex, ogRpcType=ogRpcType, ogNetInterfaceState=ogNetInterfaceState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyName=ogPowerSupplyName, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTower=ogCellModemTower, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortMode=ogSerialPortMode, ogHostUserHostName=ogHostUserHostName, ogAlarmCheck=ogAlarmCheck, ogWifiClientInterface=ogWifiClientInterface, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemApn=ogCellModemApn, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostServiceType=ogHostServiceType, ogWebUserStartTime=ogWebUserStartTime, ogHostName=ogHostName, ogWifiClientCounter=ogWifiClientCounter, ogEmdEntry=ogEmdEntry, ogCheckIndex=ogCheckIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemIndex=ogCellModemIndex, ogEmdDioTable=ogEmdDioTable, ogWifiApTable=ogWifiApTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckName=ogCheckName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletName=ogRpcOutletName, ogHostUserName=ogHostUserName, ogNetInterfaceType=ogNetInterfaceType, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogMibNotifications=ogMibNotifications, ogUpsInputNotification=ogUpsInputNotification, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEssid=ogWifiClientEssid, ogUpsNotification=ogUpsNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemVendor=ogCellModemVendor, ogWifiClientTable=ogWifiClientTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2=ogStatus2, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserTable=ogHostUserTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogUpsTable=ogUpsTable, ogCheckTable=ogCheckTable, ogUpsType=ogUpsType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogAlarmState=ogAlarmState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2Conformance=ogStatus2Conformance, ogWebUserName=ogWebUserName, ogAlarmType=ogAlarmType, ogSerialPortDSR=ogSerialPortDSR, ogRpcEntry=ogRpcEntry, ogSerialPortParity=ogSerialPortParity, ogAlarm=ogAlarm, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostPingNotification=ogHostPingNotification, ogHostServiceHost=ogHostServiceHost, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellTowerNotification=ogCellTowerNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckEntry=ogCheckEntry, ogUpsCounter=ogUpsCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApCounter=ogWifiApCounter, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEnabled=ogWifiApEnabled, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmUser=ogAlarmUser, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserStartTime=ogHostUserStartTime, ogUpsState=ogUpsState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioType=ogEmdDioType, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientRssi=ogWifiClientRssi, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcConnectType=ogRpcConnectType, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTable=ogRpcOutletTable, ogEmdDescription=ogEmdDescription, ogAlarmName=ogAlarmName, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortDTR=ogSerialPortDTR, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckType=ogCheckType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceName=ogNetInterfaceName, ogUpsIndex=ogUpsIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCustomNotification=ogCustomNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServicePort=ogHostServicePort, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApInterface=ogWifiApInterface, ogSerialUserLabel=ogSerialUserLabel, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceTable=ogHostServiceTable, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellDataNotification=ogCellDataNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsEntry=ogUpsEntry, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemModel=ogCellModemModel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemIMSI=ogCellModemIMSI, ogHostUserNotification=ogHostUserNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsName=ogUpsName, ogEmdDioState=ogEmdDioState, ogStatus2Compliance=ogStatus2Compliance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdName=ogEmdName, ogSerialUserPort=ogSerialUserPort, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientMode=ogWifiClientMode, ogHostServiceEntry=ogHostServiceEntry, ogSystem=ogSystem, ogEmdTable=ogEmdTable, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApIndex=ogWifiApIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmSummary=ogAlarmSummary, ogWifiApEntry=ogWifiApEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTime=ogAlarmTime, ogSerialUserTable=ogSerialUserTable, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIpV6Address=ogHostIpV6Address, ogEmdConnectType=ogEmdConnectType, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmName=ogCurrentAlarmName, ogCellMessageNotification=ogCellMessageNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmDevice=ogAlarmDevice, PYSNMP_MODULE_ID=ogStatus2, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcCounter=ogRpcCounter, ogHostServiceIndex=ogHostServiceIndex, ogHostUserEntry=ogHostUserEntry, ogHostIndex=ogHostIndex, ogRpcTable=ogRpcTable, ogSerialPortDCD=ogSerialPortDCD, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserHost=ogHostUserHost, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime)
