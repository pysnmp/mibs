...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmType=ogAlarmType, ogCheckTable=ogCheckTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserTable=ogSerialUserTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsDescription=ogUpsDescription, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsConnectType=ogUpsConnectType, ogSerialPortDCD=ogSerialPortDCD, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsTable=ogUpsTable, ogWifiApSsid=ogWifiApSsid, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDescription=ogEmdDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogFirmwareVersion=ogFirmwareVersion, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsIndex=ogUpsIndex, ogCellModemTable=ogCellModemTable, ogRpcIndex=ogRpcIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellMessageNotification=ogCellMessageNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmDevice=ogAlarmDevice, ogWifiClientEntry=ogWifiClientEntry, ogAlarmState=ogAlarmState, ogCellModemModel=ogCellModemModel, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsState=ogUpsState, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientMode=ogWifiClientMode, ogStatus2Groups=ogStatus2Groups, ogHostName=ogHostName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputPower=ogUpsOutputPower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApIndex=ogWifiApIndex, ogEmdDioState=ogEmdDioState, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostServiceTable=ogHostServiceTable, ogWifiClientApMac=ogWifiClientApMac, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsEntry=ogUpsEntry, ogAlarmTime=ogAlarmTime, ogSerialPortTable=ogSerialPortTable, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemApn=ogCellModemApn, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHost=ogHostUserHost, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHostName=ogHostUserHostName, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcDescription=ogRpcDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdName=ogEmdName, ogRpcTable=ogRpcTable, ogRpcInputNotification=ogRpcInputNotification, ogUpsNotification=ogUpsNotification, ogHostServiceCounter=ogHostServiceCounter, ogCheckIndex=ogCheckIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWebUserEntry=ogWebUserEntry, ogCellModemCounter=ogCellModemCounter, ogCellDataNotification=ogCellDataNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortBreaks=ogSerialPortBreaks, ogSystem=ogSystem, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortRTS=ogSerialPortRTS, ogHostIndex=ogHostIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Compliance=ogStatus2Compliance, ogHostEntry=ogHostEntry, ogAlarmName=ogAlarmName, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcCounter=ogRpcCounter, ogEmdDioEntry=ogEmdDioEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserName=ogWebUserName, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdEnabled=ogEmdEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioIndex=ogEmdDioIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostTable=ogHostTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceEntry=ogHostServiceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserName=ogHostUserName, ogEmdDioType=ogEmdDioType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServicePort=ogHostServicePort, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmEventId=ogAlarmEventId, ogHostUserIndex=ogHostUserIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellSignalNotification=ogCellSignalNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarm=ogAlarm, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogTable=ogAlarmLogTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdIndex=ogEmdIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserIndex=ogSerialUserIndex, ogWifiApEntry=ogWifiApEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserIndex=ogWebUserIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemIMSI=ogCellModemIMSI, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserEntry=ogHostUserEntry, ogWebUserNotification=ogWebUserNotification, ogCheckType=ogCheckType, ogUpsType=ogUpsType, ogRpcName=ogRpcName, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortDTR=ogSerialPortDTR, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserAddress=ogHostUserAddress, ogEmdTable=ogEmdTable, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserTable=ogHostUserTable, ogWifiApInterface=ogWifiApInterface, ogStatus2=ogStatus2, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserStartTime=ogHostUserStartTime, ogCheckDeviceName=ogCheckDeviceName, ogAlarmCheck=ogAlarmCheck, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceStatus=ogHostServiceStatus, ogRpcConnectType=ogRpcConnectType, ogRpcOutletName=ogRpcOutletName, ogSerialUserPort=ogSerialUserPort, ogSerialUserName=ogSerialUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcType=ogRpcType, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserStartTime=ogWebUserStartTime, ogAlarmInstance=ogAlarmInstance, ogUpsInputNotification=ogUpsInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioCounter=ogEmdDioCounter, ogHostServiceType=ogHostServiceType, ogUpsTemperature=ogUpsTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemTower=ogCellModemTower, ogAlarmUser=ogAlarmUser, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcEntry=ogRpcEntry, ogCheckName=ogCheckName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsName=ogUpsName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletState=ogRpcOutletState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityTable=ogEmdHumidityTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmSummary=ogAlarmSummary, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellApnNotification=ogCellApnNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdEntry=ogEmdEntry, ogWifiApEnabled=ogWifiApEnabled, ogCustomNotification=ogCustomNotification, ogWebUserTable=ogWebUserTable, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsCounter=ogUpsCounter, ogMibNotifications=ogMibNotifications, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemConnected=ogCellModemConnected, ogSerialPortDSR=ogSerialPortDSR, ogHostUserNotification=ogHostUserNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApTable=ogWifiApTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortMode=ogSerialPortMode, ogCellModemEnabled=ogCellModemEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckEntry=ogCheckEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApCounter=ogWifiApCounter)
