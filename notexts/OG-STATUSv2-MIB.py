...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2=ogStatus2, ogCustomNotification=ogCustomNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserIndex=ogSerialUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletLoad=ogRpcOutletLoad, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcDescription=ogRpcDescription, ogWifiClientCounter=ogWifiClientCounter, ogUpsNotification=ogUpsNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostTable=ogHostTable, ogSerialUserTable=ogSerialUserTable, ogRpcOutletState=ogRpcOutletState, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApTable=ogWifiApTable, ogEmdDescription=ogEmdDescription, ogRpcOutletName=ogRpcOutletName, ogAlarmUser=ogAlarmUser, ogEmdTable=ogEmdTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsCounter=ogUpsCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckName=ogCheckName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcConnectType=ogRpcConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsState=ogUpsState, ogUpsType=ogUpsType, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientRssi=ogWifiApClientRssi, ogHostName=ogHostName, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Groups=ogStatus2Groups, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemIndex=ogCellModemIndex, ogSerialPortEntry=ogSerialPortEntry, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsEntry=ogUpsEntry, ogHostUserHostName=ogHostUserHostName, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioName=ogEmdDioName, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortIndex=ogSerialPortIndex, ogCheckIndex=ogCheckIndex, ogHostUserIndex=ogHostUserIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdIndex=ogEmdIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientMac=ogWifiApClientMac, ogUpsDescription=ogUpsDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsTable=ogUpsTable, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioType=ogEmdDioType, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmCheck=ogAlarmCheck, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApCounter=ogWifiApCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceHost=ogHostServiceHost, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcIndex=ogRpcIndex, ogCellModemRegistered=ogCellModemRegistered, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApEntry=ogWifiApEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApFrequency=ogWifiApFrequency, ogHostUserAddress=ogHostUserAddress, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioState=ogEmdDioState, ogWifiApClientAp=ogWifiApClientAp, ogHostUserNotification=ogHostUserNotification, ogAlarmEventId=ogAlarmEventId, ogRpcType=ogRpcType, ogWebUserIndex=ogWebUserIndex, ogCellSignalNotification=ogCellSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdName=ogEmdName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsName=ogUpsName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortMode=ogSerialPortMode, ogHostUserHost=ogHostUserHost, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserNotification=ogSerialUserNotification, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceName=ogCheckDeviceName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogUpsIndex=ogUpsIndex, ogHostServicePort=ogHostServicePort, ogWebUserTable=ogWebUserTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemEnabled=ogCellModemEnabled, ogCheckType=ogCheckType, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckResolveActions=ogCheckResolveActions, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcCounter=ogRpcCounter, ogCellModemModel=ogCellModemModel, ogWebUserName=ogWebUserName, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcEntry=ogRpcEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceType=ogHostServiceType, ogSerialPortParity=ogSerialPortParity, ogWifiClientMode=ogWifiClientMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserTable=ogHostUserTable, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemTable=ogCellModemTable, ogHostUserName=ogHostUserName, ogCellModemNetwork=ogCellModemNetwork, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemIMSI=ogCellModemIMSI, ogCheckTable=ogCheckTable, ogEmdDioIndex=ogEmdDioIndex, ogMibNotifications=ogMibNotifications, ogAlarmTime=ogAlarmTime, ogSystem=ogSystem, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellApnNotification=ogCellApnNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmInstance=ogAlarmInstance, ogWifiClientTable=ogWifiClientTable, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostIndex=ogHostIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserEntry=ogWebUserEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortDCD=ogSerialPortDCD, ogHostServiceCounter=ogHostServiceCounter, ogHostEntry=ogHostEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserEntry=ogHostUserEntry, ogRpcTable=ogRpcTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdEntry=ogEmdEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdLogEnabled=ogEmdLogEnabled, ogCellDataNotification=ogCellDataNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsTemperature=ogUpsTemperature, ogSerialUserPort=ogSerialUserPort, ogAlarmState=ogAlarmState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserStartTime=ogWebUserStartTime, ogCheckEntry=ogCheckEntry, ogAlarm=ogAlarm, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserName=ogSerialUserName, ogCellModemApn=ogCellModemApn, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcName=ogRpcName, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceIndex=ogHostServiceIndex, ogWebUserNotification=ogWebUserNotification, ogCellModemTower=ogCellModemTower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApSsid=ogWifiApSsid, ogSerialPortTable=ogSerialPortTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTemperature=ogCellModemTemperature, ogAlarmType=ogAlarmType, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialNumber=ogSerialNumber, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioTable=ogEmdDioTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmDevice=ogAlarmDevice, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdEnabled=ogEmdEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmName=ogAlarmName, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification)
