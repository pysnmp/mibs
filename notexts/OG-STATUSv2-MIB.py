...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsState=ogUpsState, ogEmdEntry=ogEmdEntry, ogRpcOutletName=ogRpcOutletName, ogEmdConnectType=ogEmdConnectType, ogWebUserIndex=ogWebUserIndex, ogUpsName=ogUpsName, ogWifiApEntry=ogWifiApEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialUserTable=ogSerialUserTable, ogSerialUserPort=ogSerialUserPort, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemIMSI=ogCellModemIMSI, ogUpsCounter=ogUpsCounter, ogCellModemTable=ogCellModemTable, ogSerialPortMode=ogSerialPortMode, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliances=ogStatus2Compliances, ogAlarmInstance=ogAlarmInstance, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcIndex=ogRpcIndex, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcCounter=ogRpcCounter, ogRpcInputNotification=ogRpcInputNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckEntry=ogCheckEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemCounter=ogCellModemCounter, ogHostServiceEntry=ogHostServiceEntry, ogRpcConnectType=ogRpcConnectType, ogHostEntry=ogHostEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortTable=ogSerialPortTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmUser=ogAlarmUser, ogUpsTable=ogUpsTable, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserIndex=ogHostUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceHost=ogHostServiceHost, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2=ogStatus2, ogHostServiceType=ogHostServiceType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServicePort=ogHostServicePort, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServiceTable=ogHostServiceTable, ogEmdDioTable=ogEmdDioTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletCurrent=ogRpcOutletCurrent, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserName=ogSerialUserName, ogWebUserEntry=ogWebUserEntry, ogCellModemApn=ogCellModemApn, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemModel=ogCellModemModel, ogSerialNumber=ogSerialNumber, ogHostUserHostName=ogHostUserHostName, ogUpsIndex=ogUpsIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckType=ogCheckType, ogStatus2Groups=ogStatus2Groups, ogAlarmState=ogAlarmState, ogCellModemTemperature=ogCellModemTemperature, ogRpcTable=ogRpcTable, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDescription=ogEmdDescription, ogHostUserName=ogHostUserName, ogWebUserName=ogWebUserName, ogRpcName=ogRpcName, ogWebUserStartTime=ogWebUserStartTime, ogUpsHumidity=ogUpsHumidity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsEntry=ogUpsEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientApMac=ogWifiClientApMac, ogCellModemSessionTime=ogCellModemSessionTime, ogCellMessageNotification=ogCellMessageNotification, ogHostName=ogHostName, ogWebUserNotification=ogWebUserNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckName=ogCheckName, ogAlarmTime=ogAlarmTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsNotification=ogUpsNotification, ogWifiApInterface=ogWifiApInterface, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientTable=ogWifiClientTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioType=ogEmdDioType, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDCD=ogSerialPortDCD, ogUpsType=ogUpsType, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostTable=ogHostTable, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioCounter=ogEmdDioCounter, ogMibNotifications=ogMibNotifications, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityName=ogEmdHumidityName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckTable=ogCheckTable, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApIndex=ogWifiApIndex, ogEmdEnabled=ogEmdEnabled, ogAlarmEventId=ogAlarmEventId, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioName=ogEmdDioName, ogWifiApTable=ogWifiApTable, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApEnabled=ogWifiApEnabled, ogCellModemTower=ogCellModemTower, ogWebUserTable=ogWebUserTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioEntry=ogEmdDioEntry, ogHostUserTable=ogHostUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletTable=ogRpcOutletTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserEntry=ogHostUserEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortEntry=ogSerialPortEntry, ogCellModemEntry=ogCellModemEntry, ogEmdName=ogEmdName, ogEmdTable=ogEmdTable, ogCellSignalNotification=ogCellSignalNotification, ogCellModemEnabled=ogCellModemEnabled, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemRegistered=ogCellModemRegistered, ogUpsDescription=ogUpsDescription, ogCheckResolveActions=ogCheckResolveActions, ogHostUserNotification=ogHostUserNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientMode=ogWifiClientMode, ogEmdIndex=ogEmdIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceName=ogNetInterfaceName, ogHostUserHost=ogHostUserHost, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceNotification=ogHostServiceNotification, ogHostIndex=ogHostIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceTable=ogNetInterfaceTable, ogCustomNotification=ogCustomNotification, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogCellModemIndex=ogCellModemIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceCounter=ogHostServiceCounter, ogWifiApTxPower=ogWifiApTxPower, ogCheckIndex=ogCheckIndex, ogUpsConnectType=ogUpsConnectType, ogAlarmName=ogAlarmName, ogBasicStatusGroup=ogBasicStatusGroup, ogSystem=ogSystem, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellApnNotification=ogCellApnNotification, ogRpcType=ogRpcType, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmDevice=ogAlarmDevice, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioDirection=ogEmdDioDirection, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcDescription=ogRpcDescription, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNotification=ogUpsInputNotification, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarm=ogAlarm, ogHostIpV4Address=ogHostIpV4Address, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserIndex=ogSerialUserIndex, ogWifiApCounter=ogWifiApCounter, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioState=ogEmdDioState, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmCheck=ogAlarmCheck, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmType=ogAlarmType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostPingNotification=ogHostPingNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcEntry=ogRpcEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostUserAddress=ogHostUserAddress, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceIndex=ogCheckDeviceIndex)
