...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckType=ogCheckType, ogRpcName=ogRpcName, ogUpsInputNotification=ogUpsInputNotification, ogCellModemTable=ogCellModemTable, ogHostIndex=ogHostIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortMode=ogSerialPortMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserIndex=ogWebUserIndex, ogAlarmType=ogAlarmType, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckIndex=ogCheckIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsEntry=ogUpsEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientMode=ogWifiClientMode, ogEmdIndex=ogEmdIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogMibNotifications=ogMibNotifications, ogWifiClientEntry=ogWifiClientEntry, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserTable=ogHostUserTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserHost=ogHostUserHost, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsNotification=ogUpsNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApIndex=ogWifiApIndex, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmSummary=ogAlarmSummary, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcConnectType=ogRpcConnectType, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserIndex=ogSerialUserIndex, ogCellApnNotification=ogCellApnNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserSourcePort=ogWebUserSourcePort, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortEntry=ogSerialPortEntry, ogEmdEntry=ogEmdEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserEntry=ogWebUserEntry, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceTable=ogHostServiceTable, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletState=ogRpcOutletState, ogEmdDescription=ogEmdDescription, ogSerialNumber=ogSerialNumber, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientInterface=ogWifiClientInterface, ogCheckName=ogCheckName, ogWifiApTxPower=ogWifiApTxPower, ogRpcEntry=ogRpcEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserName=ogWebUserName, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserNotification=ogHostUserNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellSignalNotification=ogCellSignalNotification, ogEmdEnabled=ogEmdEnabled, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserTable=ogWebUserTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemModel=ogCellModemModel, ogHostPingNotification=ogHostPingNotification, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserEntry=ogHostUserEntry, ogRpcDescription=ogRpcDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserStartTime=ogWebUserStartTime, ogUpsCounter=ogUpsCounter, ogAlarmInstance=ogAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsType=ogUpsType, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputPower=ogUpsOutputPower, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Groups=ogStatus2Groups, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmDevice=ogAlarmDevice, ogEmdDioState=ogEmdDioState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityEmd=ogEmdHumidityEmd, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcCounter=ogRpcCounter, ogWifiClientApMac=ogWifiClientApMac, ogHostUserIndex=ogHostUserIndex, ogSerialPortDTR=ogSerialPortDTR, ogCellModemTower=ogCellModemTower, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemTemperature=ogCellModemTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsIndex=ogUpsIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioEntry=ogEmdDioEntry, ogAlarmName=ogAlarmName, ogHostName=ogHostName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioTable=ogEmdDioTable, ogRpcType=ogRpcType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdTable=ogEmdTable, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioName=ogEmdDioName, ogWifiApClientMac=ogWifiApClientMac, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIndex=ogCellModemIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceType=ogHostServiceType, ogHostServiceHost=ogHostServiceHost, ogHostUserAddress=ogHostUserAddress, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemCounter=ogCellModemCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEssid=ogWifiClientEssid, ogAlarmState=ogAlarmState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellDataNotification=ogCellDataNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemConnected=ogCellModemConnected, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletEntry=ogRpcOutletEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortTable=ogSerialPortTable, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostEntry=ogHostEntry, ogHostServiceEntry=ogHostServiceEntry, ogCellModemRegistered=ogCellModemRegistered, ogSystem=ogSystem, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioDescription=ogEmdDioDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsHumidity=ogUpsHumidity, ogCellModemIMSI=ogCellModemIMSI, ogUpsTable=ogUpsTable, ogRpcIndex=ogRpcIndex, ogUpsConnectType=ogUpsConnectType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmTime=ogAlarmTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Compliance=ogStatus2Compliance, ogWifiApSsid=ogWifiApSsid, ogEmdName=ogEmdName, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserName=ogSerialUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioDirection=ogEmdDioDirection, ogAlarmEventId=ogAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemApn=ogCellModemApn, ogSerialUserNotification=ogSerialUserNotification, ogUpsDescription=ogUpsDescription, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientTable=ogWifiClientTable, ogSerialUserTable=ogSerialUserTable, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogCustomNotification=ogCustomNotification, ogWifiApTable=ogWifiApTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmCheck=ogAlarmCheck, ogAlarm=ogAlarm, ogUpsName=ogUpsName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckTable=ogCheckTable, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckEntry=ogCheckEntry, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmUser=ogAlarmUser, ogNetInterfaceNotification=ogNetInterfaceNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceName=ogNetInterfaceName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostTable=ogHostTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioType=ogEmdDioType, ogWifiApInterface=ogWifiApInterface, ogRpcTable=ogRpcTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsState=ogUpsState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2=ogStatus2)
