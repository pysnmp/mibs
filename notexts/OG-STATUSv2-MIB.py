...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortDSR=ogSerialPortDSR, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmType=ogAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApTxPower=ogWifiApTxPower, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostIndex=ogHostIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialNumber=ogSerialNumber, ogAlarmTime=ogAlarmTime, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarm=ogAlarm, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryState=ogUpsBatteryState, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientMac=ogWifiApClientMac, ogRpcDescription=ogRpcDescription, ogEmdName=ogEmdName, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceStatus=ogHostServiceStatus, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemTower=ogCellModemTower, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckName=ogCheckName, ogNetInterfaceState=ogNetInterfaceState, ogCellModemCounter=ogCellModemCounter, ogWifiApTable=ogWifiApTable, ogCellModemEnabled=ogCellModemEnabled, ogCheckTable=ogCheckTable, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioNotification=ogEmdDioNotification, ogRpcEntry=ogRpcEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcTable=ogRpcTable, ogSystem=ogSystem, ogWebUserTable=ogWebUserTable, ogWifiClientRssi=ogWifiClientRssi, ogUpsState=ogUpsState, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcCounter=ogRpcCounter, ogCellSignalNotification=ogCellSignalNotification, ogHostPingNotification=ogHostPingNotification, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioInputTotal=ogEmdDioInputTotal, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientAp=ogWifiApClientAp, ogRpcName=ogRpcName, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckType=ogCheckType, ogHostName=ogHostName, ogHostServiceEntry=ogHostServiceEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceIndex=ogHostServiceIndex, ogHostIpV4Address=ogHostIpV4Address, ogUpsConnectType=ogUpsConnectType, ogAlarmState=ogAlarmState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsTemperature=ogUpsTemperature, ogHostServiceHost=ogHostServiceHost, ogCellModemEntry=ogCellModemEntry, ogEmdEntry=ogEmdEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckEntry=ogCheckEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcIndex=ogRpcIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsType=ogUpsType, ogSerialPortTable=ogSerialPortTable, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortSpeed=ogSerialPortSpeed, ogMibNotifications=ogMibNotifications, ogHostUserHost=ogHostUserHost, ogEmdDioType=ogEmdDioType, ogCellModemConnected=ogCellModemConnected, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEssid=ogWifiClientEssid, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserNotification=ogWebUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRTS=ogSerialPortRTS, ogWebUserName=ogWebUserName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserIndex=ogHostUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServiceNotification=ogHostServiceNotification, ogUpsTable=ogUpsTable, ogCellModemApn=ogCellModemApn, ogCellModemTable=ogCellModemTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserIndex=ogSerialUserIndex, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsHumidity=ogUpsHumidity, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsDescription=ogUpsDescription, ogUpsName=ogUpsName, ogWebUserEntry=ogWebUserEntry, ogSerialPortEntry=ogSerialPortEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemIndex=ogCellModemIndex, ogHostServiceTable=ogHostServiceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApIndex=ogWifiApIndex, ogAlarmCheck=ogAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostEntry=ogHostEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDescription=ogEmdDescription, ogRpcOutletName=ogRpcOutletName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogHostUserEntry=ogHostUserEntry, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserTable=ogSerialUserTable, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserName=ogSerialUserName, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmName=ogAlarmName, ogEmdDioEmd=ogEmdDioEmd, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApEntry=ogWifiApEntry, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcConnectType=ogRpcConnectType, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsIndex=ogUpsIndex, ogHostUserName=ogHostUserName, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioState=ogEmdDioState, ogHostServicePort=ogHostServicePort, ogPowerSupplyName=ogPowerSupplyName, ogHostTable=ogHostTable, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserAddress=ogHostUserAddress, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserNotification=ogHostUserNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellApnNotification=ogCellApnNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckDeviceName=ogCheckDeviceName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortIndex=ogSerialPortIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserIndex=ogWebUserIndex, ogCheckIndex=ogCheckIndex, ogAlarmInstance=ogAlarmInstance, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceType=ogHostServiceType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioName=ogEmdDioName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdEnabled=ogEmdEnabled, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserEntry=ogSerialUserEntry, ogStatus2=ogStatus2, ogCellModemVendor=ogCellModemVendor, ogRpcOutletRpc=ogRpcOutletRpc, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserHostName=ogHostUserHostName, ogRpcType=ogRpcType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioEntry=ogEmdDioEntry, ogAlarmUser=ogAlarmUser, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioCounter=ogEmdDioCounter, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemModel=ogCellModemModel, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCustomNotification=ogCustomNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsEntry=ogUpsEntry, ogSerialPortDCD=ogSerialPortDCD, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientIndex=ogWifiClientIndex, ogHostUserTable=ogHostUserTable, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellTowerNotification=ogCellTowerNotification, ogEmdIndex=ogEmdIndex, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioTable=ogEmdDioTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsNotification=ogUpsNotification, ogUpsCounter=ogUpsCounter)
