...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemIndex=ogCellModemIndex, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTable=ogSerialPortTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletCurrent=ogRpcOutletCurrent, PYSNMP_MODULE_ID=ogStatus2, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApTable=ogWifiApTable, ogCheckType=ogCheckType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioTable=ogEmdDioTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioEntry=ogEmdDioEntry, ogCheckEntry=ogCheckEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsEntry=ogUpsEntry, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceType=ogNetInterfaceType, ogWebUserIndex=ogWebUserIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioType=ogEmdDioType, ogSerialPortEntry=ogSerialPortEntry, ogEmdName=ogEmdName, ogHostIndex=ogHostIndex, ogSerialUserNotification=ogSerialUserNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdConnectType=ogEmdConnectType, ogStatus2Compliance=ogStatus2Compliance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParity=ogSerialPortParity, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioCounter=ogEmdDioCounter, ogUpsState=ogUpsState, ogRpcCounter=ogRpcCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortIndex=ogSerialPortIndex, ogAlarmSummary=ogAlarmSummary, ogAlarm=ogAlarm, ogHostUserHost=ogHostUserHost, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsTable=ogUpsTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientTable=ogWifiApClientTable, ogWifiApCounter=ogWifiApCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellApnNotification=ogCellApnNotification, ogCellModemNetwork=ogCellModemNetwork, ogAlarmDevice=ogAlarmDevice, ogHostServiceHost=ogHostServiceHost, ogUpsLogEnabled=ogUpsLogEnabled, ogMibNotifications=ogMibNotifications, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcIndex=ogRpcIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserTable=ogHostUserTable, ogHostPingNotification=ogHostPingNotification, ogHostUserAddress=ogHostUserAddress, ogHostUserEntry=ogHostUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientMode=ogWifiClientMode, ogAlarmType=ogAlarmType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemModel=ogCellModemModel, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcTable=ogRpcTable, ogRpcEntry=ogRpcEntry, ogWifiApInterface=ogWifiApInterface, ogUpsType=ogUpsType, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServiceType=ogHostServiceType, ogSerialPortMode=ogSerialPortMode, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsTemperature=ogUpsTemperature, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyName=ogPowerSupplyName, ogHostUserName=ogHostUserName, ogWifiClientTable=ogWifiClientTable, ogHostServicePort=ogHostServicePort, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserPort=ogSerialUserPort, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsCounter=ogUpsCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostEntry=ogHostEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsIndex=ogUpsIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserNotification=ogWebUserNotification, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputNotification=ogRpcInputNotification, ogHostTable=ogHostTable, ogEmdDioState=ogEmdDioState, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityName=ogEmdHumidityName, ogAlarmTime=ogAlarmTime, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmUser=ogAlarmUser, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2=ogStatus2, ogEmdTable=ogEmdTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmEventId=ogAlarmEventId, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApEnabled=ogWifiApEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTable=ogCellModemTable, ogWifiClientInterface=ogWifiClientInterface, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcName=ogRpcName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEntry=ogCellModemEntry, ogEmdDioDescription=ogEmdDioDescription, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsConnectType=ogUpsConnectType, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortLabel=ogSerialPortLabel, ogHostName=ogHostName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckTable=ogCheckTable, ogCellModemIMSI=ogCellModemIMSI, ogWebUserEntry=ogWebUserEntry, ogSerialUserName=ogSerialUserName, ogEmdEnabled=ogEmdEnabled, ogCellModemVendor=ogCellModemVendor, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcDescription=ogRpcDescription, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletName=ogRpcOutletName, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogStatus2Compliances=ogStatus2Compliances, ogSystem=ogSystem, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmName=ogAlarmName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemRegistered=ogCellModemRegistered, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmState=ogAlarmState, ogEmdDescription=ogEmdDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcConnectType=ogRpcConnectType, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsDescription=ogUpsDescription, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostIpV4Address=ogHostIpV4Address, ogUpsName=ogUpsName, ogWifiApSsid=ogWifiApSsid)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserLabel=ogSerialUserLabel, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserStartTime=ogHostUserStartTime, ogWebUserName=ogWebUserName, ogEmdDioName=ogEmdDioName, ogEmdEntry=ogEmdEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserTable=ogWebUserTable, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientMac=ogWifiApClientMac, ogEmdIndex=ogEmdIndex, ogSerialUserTable=ogSerialUserTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckName=ogCheckName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientAp=ogWifiApClientAp, ogCellSignalNotification=ogCellSignalNotification, ogSerialNumber=ogSerialNumber, ogCustomNotification=ogCustomNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletState=ogRpcOutletState, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsNotification=ogUpsNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTower=ogCellModemTower, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRssi=ogWifiClientRssi, ogCellDataNotification=ogCellDataNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogHostIpV6Address=ogHostIpV6Address, ogRpcType=ogRpcType, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserNotification=ogHostUserNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryState=ogUpsBatteryState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceTable=ogHostServiceTable, ogCellModemApn=ogCellModemApn, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckIndex=ogCheckIndex)
