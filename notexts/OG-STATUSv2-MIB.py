...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsName=ogUpsName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioDescription=ogEmdDioDescription, ogSystem=ogSystem, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortIndex=ogSerialPortIndex, ogHostIndex=ogHostIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemTower=ogCellModemTower, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemCounter=ogCellModemCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemTable=ogCellModemTable, ogSerialPortLabel=ogSerialPortLabel, ogRpcDescription=ogRpcDescription, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientMode=ogWifiClientMode, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserTable=ogSerialUserTable, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckIndex=ogCheckIndex, ogRpcCounter=ogRpcCounter, ogCheckName=ogCheckName, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsConnectType=ogUpsConnectType, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2=ogStatus2, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityName=ogEmdHumidityName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemIndex=ogCellModemIndex, ogEmdIndex=ogEmdIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcType=ogRpcType, ogUpsHumidity=ogUpsHumidity, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApIndex=ogWifiApIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserName=ogHostUserName, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDescription=ogEmdDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServicePort=ogHostServicePort, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioEntry=ogEmdDioEntry, ogCellModemEntry=ogCellModemEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserStartTime=ogWebUserStartTime, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceHost=ogHostServiceHost, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioState=ogEmdDioState, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEntry=ogWifiApEntry, ogAlarmCheck=ogAlarmCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceType=ogNetInterfaceType, ogAlarmInstance=ogAlarmInstance, ogUpsTable=ogUpsTable, PYSNMP_MODULE_ID=ogStatus2, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdName=ogEmdName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckTable=ogCheckTable, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcEntry=ogRpcEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostName=ogHostName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioEmd=ogEmdDioEmd, ogAlarmState=ogAlarmState, ogUpsState=ogUpsState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserPort=ogSerialUserPort, ogHostPingNotification=ogHostPingNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcIndex=ogRpcIndex, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Compliance=ogStatus2Compliance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortParity=ogSerialPortParity, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserIndex=ogHostUserIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApSsid=ogWifiApSsid, ogCellSignalNotification=ogCellSignalNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryState=ogUpsBatteryState, ogEmdTable=ogEmdTable, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioDirection=ogEmdDioDirection, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserEntry=ogHostUserEntry, ogWifiClientTable=ogWifiClientTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogEmdEnabled=ogEmdEnabled, ogSerialUserNotification=ogSerialUserNotification, ogUpsDescription=ogUpsDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcTable=ogRpcTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletName=ogRpcOutletName, ogCellModemApn=ogCellModemApn, ogHostServiceType=ogHostServiceType, ogUpsType=ogUpsType, ogWifiApFrequency=ogWifiApFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApTxPower=ogWifiApTxPower, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogUpsTemperature=ogUpsTemperature, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Conformance=ogStatus2Conformance, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcName=ogRpcName, ogAlarm=ogAlarm, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckType=ogCheckType, ogSerialUserName=ogSerialUserName, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortDSR=ogSerialPortDSR, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserTable=ogHostUserTable, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortEntry=ogSerialPortEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserName=ogWebUserName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2Compliances=ogStatus2Compliances, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHost=ogHostUserHost, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdEntry=ogEmdEntry, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdConnectType=ogEmdConnectType, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApInterface=ogWifiApInterface, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRssi=ogWifiClientRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserTable=ogWebUserTable, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmEventId=ogAlarmEventId, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostTable=ogHostTable, ogSerialPortRxBytes=ogSerialPortRxBytes)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResolveActions=ogCheckResolveActions, ogAlarmUser=ogAlarmUser, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcConnectType=ogRpcConnectType, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmTime=ogAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckEntry=ogCheckEntry, ogAlarmName=ogAlarmName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemModel=ogCellModemModel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemConnected=ogCellModemConnected, ogUpsNotification=ogUpsNotification, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserHostName=ogHostUserHostName, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDCD=ogSerialPortDCD, ogUpsIndex=ogUpsIndex, ogEmdDioTable=ogEmdDioTable, ogSerialNumber=ogSerialNumber, ogMibNotifications=ogMibNotifications, ogWifiApEnabled=ogWifiApEnabled, ogWebUserIndex=ogWebUserIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCustomNotification=ogCustomNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceNotification=ogHostServiceNotification, ogAlarmType=ogAlarmType, ogEmdDioName=ogEmdDioName, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortTxBytes=ogSerialPortTxBytes, ogFirmwareVersion=ogFirmwareVersion, ogCellDataNotification=ogCellDataNotification, ogAlarmDevice=ogAlarmDevice, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputPower=ogUpsOutputPower, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsEntry=ogUpsEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortMode=ogSerialPortMode, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityCounter=ogEmdHumidityCounter)
