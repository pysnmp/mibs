...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", masterSlaveMode=masterSlaveMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, rxColorCode=rxColorCode, sFPPortDisabledWarning=sFPPortDisabledWarning, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair2Distance=cableDiagPair2Distance, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMGroup=tDMGroup, eIRP=eIRP, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControl=phyControl, receiveModulationMode=receiveModulationMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogControl=syslogControl, licenseGroupAccess=licenseGroupAccess, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortAutoMdix=sFPPortAutoMdix, systemReset=systemReset, licenseCountry=licenseCountry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transparentClockPort=transparentClockPort, vectorError=vectorError, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, auxPortSSMTx=auxPortSSMTx, tdmTableNumber=tdmTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, userTableNumber=userTableNumber, transparentClockVID=transparentClockVID, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, portAllocationMismatchTrap=portAllocationMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, longitude=longitude, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, channelBandwidth=channelBandwidth, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, subbandLowestFrequency=subbandLowestFrequency, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, installStatus=installStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, daylightSaving=daylightSaving, resetGroup=resetGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transparentClockVLAN=transparentClockVLAN, mABTransmissionInterval=mABTransmissionInterval, systemClock=systemClock, receiveFreqKHz=receiveFreqKHz, syslogStateTrap=syslogStateTrap, bridge=bridge, dfsPeaks=dfsPeaks, receiveFreqMHz=receiveFreqMHz, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, secondDataBridgingStatus=secondDataBridgingStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableEntry=dfsTableEntry, sFPPortAllocation=sFPPortAllocation, smtpGroup=smtpGroup, pubStatsGroup=pubStatsGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, mABHoldoffPeriod=mABHoldoffPeriod, iPDSCPPriorityTable=iPDSCPPriorityTable, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABProtocolVID=mABProtocolVID, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagnosticsControl=cableDiagnosticsControl, transmitFreqMHz=transmitFreqMHz, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveDataRate=receiveDataRate, tdmTable=tdmTable, sFPPortStatus=sFPPortStatus, configurationGroup=configurationGroup, sNTPServerPortNumber=sNTPServerPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userTableIndex=userTableIndex, ptpTrapPrefix=ptpTrapPrefix, tDMChannelStatus=tDMChannelStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkLoss=linkLoss, sNTPSync=sNTPSync, dfsTable=dfsTable, managementGroup=managementGroup, accessMethod=accessMethod, subnetMask=subnetMask, hTTPPortNumber=hTTPPortNumber, sntp=sntp, cableDiagPair1Distance=cableDiagPair1Distance, licenseUnitSerialNumber=licenseUnitSerialNumber, maximumTransmitPower=maximumTransmitPower, siteName=siteName, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPServerRetries=sNTPServerRetries, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, configuration=configuration, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, syslogControlGroup=syslogControlGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, auxPortAcceptedQLRx=auxPortAcceptedQLRx, remoteInternetAddress=remoteInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, routerProtocolsGroup=routerProtocolsGroup, cableDiagPair2Results=cableDiagPair2Results, tDMChannelLineCode=tDMChannelLineCode, sNTPServerTable=sNTPServerTable, transmitPower=transmitPower, nIDULanPortStatus=nIDULanPortStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, tDDControlGroup=tDDControlGroup, userName=userName, mABNominalModulationMode=mABNominalModulationMode, licenseIEEE1588Support=licenseIEEE1588Support, phyStatus=phyStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ptmp=ptmp, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetPortNumber=telnetPortNumber, dfsGroup=dfsGroup, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableDiagPair4Results=cableDiagPair4Results, sNMPPortNumber=sNMPPortNumber, licenseIPv6Support=licenseIPv6Support, bridgeGroup=bridgeGroup, lowestTDMModulationMode=lowestTDMModulationMode, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, syslogClientTrap=syslogClientTrap, auxPortAllocation=auxPortAllocation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseBandwidthCap=licenseBandwidthCap, sNMPCommunityString=sNMPCommunityString, txColorCode=txColorCode, sNTPSyncTrap=sNTPSyncTrap, tDMChannelLoopback=tDMChannelLoopback, licenseIssueNumber=licenseIssueNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsMeans=dfsMeans, tdmTableEntry=tdmTableEntry, sFPPortQLRx=sFPPortQLRx, unitOutOfCalibration=unitOutOfCalibration, versionsGroup=versionsGroup, dSCPManagementPriority=dSCPManagementPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, portAllocationMismatch=portAllocationMismatch, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cambium=cambium, rawReceivePower=rawReceivePower, sNTPServerTableNumber=sNTPServerTableNumber, license=license, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortQLRx=mainPSUPortQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPState=sNTPState, cableDiagPair3Results=cableDiagPair3Results, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableNumber=ethernetPriorityTableNumber, regulatoryBand=regulatoryBand, dataPortPauseFrames=dataPortPauseFrames, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMInterfaceControl=tDMInterfaceControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableEntry=userTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPLastSync=sNTPLastSync, userPassword=userPassword, auxPortDisabledWarning=auxPortDisabledWarning, rangingMode=rangingMode, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatusTrap=installStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, targetMACAddress=targetMACAddress, pubStats=pubStats, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, transparentClock=transparentClock, regulatoryBandTrap=regulatoryBandTrap, tDMInterfaceStatus=tDMInterfaceStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTableEntry=l2CPPriorityTableEntry, supplementary=supplementary, dataBridgingAvailability=dataBridgingAvailability, receiveChannel=receiveChannel, capacityVariantMismatch=capacityVariantMismatch, secureModeAlarm=secureModeAlarm, syncEEquipmentClock=syncEEquipmentClock, iPv6PrefixLength=iPv6PrefixLength, enableTransmission=enableTransmission, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", ptpCompliance=ptpCompliance, cableDiagnosticsGroup=cableDiagnosticsGroup, aAAControl=aAAControl, transmitChannel=transmitChannel, sFPError=sFPError, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, localPacketFiltering=localPacketFiltering, auxPortQLRx=auxPortQLRx, encryption=encryption, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMChannelStatusTrap=tDMChannelStatusTrap, lowestDataModulationMode=lowestDataModulationMode, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPServerPortNumber=tFTPServerPortNumber, notificationsGroup=notificationsGroup, ethernetPriorityTable=ethernetPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataBridgingStatus=dataBridgingStatus, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPErrorTrap=sFPErrorTrap, sNMPv3Enable=sNMPv3Enable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, mainPSUPortAutoMdix=mainPSUPortAutoMdix, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseGroup=licenseGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortQLTx=sFPPortQLTx, iPVersion=iPVersion, licenseCapacity=licenseCapacity, cableDiagPair4Distance=cableDiagPair4Distance, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseTrialPeriod=licenseTrialPeriod, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, altitude=altitude, iPv6Address=iPv6Address, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, tDMEnabledChannels=tDMEnabledChannels, aAAControlGroup=aAAControlGroup, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpGroups=ptpGroups, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagnostics=cableDiagnostics, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv4Address=iPv4Address, l2CPPriorityTable=l2CPPriorityTable, tDDControl=tDDControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, targetRange=targetRange, byteErrorRatio=byteErrorRatio, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetPriorityTableIndex=ethernetPriorityTableIndex, softwareVersion=softwareVersion, licenseEncryption=licenseEncryption, wirelessLinkAvailability=wirelessLinkAvailability, auxPortStatusTrap=auxPortStatusTrap, ptp650=ptp650, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, latitude=latitude, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syslogState=syslogState, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMChannelCableLength=tDMChannelCableLength, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, txMABFrames=txMABFrames, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ptp=ptp, hardwareVersion=hardwareVersion, groupID=groupID, ethernetGroup=ethernetGroup, tdmTableIndex=tdmTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerInternetAddress=tFTPServerInternetAddress, linkModeOptimization=linkModeOptimization, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagnosticsResultTable=cableDiagnosticsResultTable, productName=productName, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, channelChangeTrap=channelChangeTrap, mainPSUPortStatus=mainPSUPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkName=linkName, timeZone=timeZone, licenseMaxLinkRange=licenseMaxLinkRange, receivePower=receivePower, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, extendedSpectrumScanning=extendedSpectrumScanning, licenseSFPPortSupport=licenseSFPPortSupport, phyStatusGroup=phyStatusGroup, licenseSecurityLevel=licenseSecurityLevel, installArmState=installArmState, phyControlGroup=phyControlGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTable=userTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, auxPortConfigurationMismatch=auxPortConfigurationMismatch, useVLANForMABProtocol=useVLANForMABProtocol, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, auxPortQLTx=auxPortQLTx, licenseVersion=licenseVersion, syncETracking=syncETracking, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, userEnabled=userEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, tDM=tDM, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, qOSPriorityScheme=qOSPriorityScheme, transmitFreqKHz=transmitFreqKHz, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, frequencyVariant=frequencyVariant, sNTPServerStatus=sNTPServerStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, snmpControl=snmpControl, auxPortStatus=auxPortStatus, sFPPortStatusTrap=sFPPortStatusTrap, management=management, mABState=mABState, routerProtocols=routerProtocols, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkSymmetry=linkSymmetry, range=range, mABMaintenanceLevel=mABMaintenanceLevel, ethernet=ethernet, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, reset=reset, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortSSMTx=sFPPortSSMTx, syncETrackingState=syncETrackingState, versions=versions, supplementaryGroup=supplementaryGroup, telnetAccessEnabled=telnetAccessEnabled, licenseRARSupport=licenseRARSupport, encryptionGroup=encryptionGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation)
