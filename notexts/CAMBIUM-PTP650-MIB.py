...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", userRole=userRole, alarmsGroup=alarmsGroup, sMTPEmailAlert=sMTPEmailAlert, snmpControlGroup=snmpControlGroup, licenseRARSupport=licenseRARSupport, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, configurationGroup=configurationGroup, userTableNumber=userTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortQLTx=mainPSUPortQLTx, mABProtocolVLANPriority=mABProtocolVLANPriority, syncETracking=syncETracking, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ptp=ptp, tFTPServerPortNumber=tFTPServerPortNumber, userTableIndex=userTableIndex, userName=userName, installArmState=installArmState, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementPriority=vLANManagementPriority, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, userEnabled=userEnabled, cableDiagPair2Results=cableDiagPair2Results, hTTPSPortNumber=hTTPSPortNumber, supplementaryGroup=supplementaryGroup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataBridgingAvailability=dataBridgingAvailability, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPCommunityString=sNMPCommunityString, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseCountry=licenseCountry, sFPError=sFPError, configuration=configuration, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPServerTable=sNTPServerTable, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTable=ethernetPriorityTable, tdmTableEntry=tdmTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cambium=cambium, userTable=userTable, l2CPPriorityTable=l2CPPriorityTable, linkSymmetry=linkSymmetry, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, auxPortDisabledWarning=auxPortDisabledWarning, linkModeOptimization=linkModeOptimization, cableLoss=cableLoss, ptpCompliance=ptpCompliance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMChannelLoopback=tDMChannelLoopback, auxPortSSMTx=auxPortSSMTx, routerProtocolsGroup=routerProtocolsGroup, smtp=smtp, tDMGroup=tDMGroup, userPassword=userPassword, lowestDataModulationMode=lowestDataModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, versions=versions, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseSecurityLevel=licenseSecurityLevel, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, managementGroup=managementGroup, dfs=dfs, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ptpTraps=ptpTraps, remoteInternetAddressType=remoteInternetAddressType, syslogControl=syslogControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPPrimaryServer=sNTPPrimaryServer, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPv6Address=iPv6Address, qOSPriorityScheme=qOSPriorityScheme, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceControl=tDMInterfaceControl, systemClock=systemClock, secureModeAlarmTrap=secureModeAlarmTrap, dfsPeaks=dfsPeaks, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tdmTable=tdmTable, tDM=tDM, transmitFreqMHz=transmitFreqMHz, channelChangeTrap=channelChangeTrap, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBandwidth=channelBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPState=sNTPState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, lowestTDMModulationMode=lowestTDMModulationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, ethernet=ethernet, notificationsGroup=notificationsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitPower=transmitPower, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableIndex=dfsTableIndex, eIRP=eIRP, nIDULanPortStatus=nIDULanPortStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, targetMACAddress=targetMACAddress, mABState=mABState, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, daylightSaving=daylightSaving, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, targetRange=targetRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkLoss=linkLoss, iPv6GatewayAddress=iPv6GatewayAddress, licenseSyncESupport=licenseSyncESupport, sMTPEnabledMessages=sMTPEnabledMessages, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerPortNumber=sMTPServerPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, siteName=siteName, licenseGroupAccess=licenseGroupAccess, iPVersion=iPVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, rxColorCode=rxColorCode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair3Distance=cableDiagPair3Distance, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, supplementary=supplementary, mainPSUPortQLRx=mainPSUPortQLRx, iPDSCPPriorityTable=iPDSCPPriorityTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, txColorCode=txColorCode, dSCPManagementPriority=dSCPManagementPriority, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, mABProtocolVID=mABProtocolVID, sNMPTrapVersion=sNMPTrapVersion, sFPPortDisabledWarning=sFPPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, management=management, transparentClockPort=transparentClockPort, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, enabledDiagnosticAlarms=enabledDiagnosticAlarms, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortPauseFrames=dataPortPauseFrames, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, resetGroup=resetGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, ptp650=ptp650, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, sNTPServerInternetAddressType=sNTPServerInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, cableDiagPair3Results=cableDiagPair3Results, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortAutoMdix=sFPPortAutoMdix, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDDControl=tDDControl, cableDiagPair2Distance=cableDiagPair2Distance, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, productVariant=productVariant, lowestSecondDataModulationMode=lowestSecondDataModulationMode, dfsMeans=dfsMeans, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTableIndex=sNTPServerTableIndex, linkName=linkName, bridge=bridge, sNTPSyncTrap=sNTPSyncTrap, txMABFrames=txMABFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMInterfaceStatus=tDMInterfaceStatus, secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseCapacity=licenseCapacity, encryptionAlgorithm=encryptionAlgorithm, licenseMaxLinkRange=licenseMaxLinkRange, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, pubStats=pubStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, antennaGain=antennaGain, sNTPServerStatus=sNTPServerStatus, syslogControlGroup=syslogControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, groupID=groupID, mABNominalModulationMode=mABNominalModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, accessMethod=accessMethod, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair4Distance=cableDiagPair4Distance, tDMChannelStatus=tDMChannelStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, auxPortAllocation=auxPortAllocation, rangingMode=rangingMode, phyControl=phyControl, receiveDataRate=receiveDataRate, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTableEntry=dfsTableEntry, enableTransmission=enableTransmission, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, iPv6PrefixLength=iPv6PrefixLength, longitude=longitude, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, tDMChannelCableLength=tDMChannelCableLength, hTTPPortNumber=hTTPPortNumber, auxPortStatus=auxPortStatus, installStatus=installStatus, alarms=alarms, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transparentClockVID=transparentClockVID, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagnostics=cableDiagnostics, auxPortQLRx=auxPortQLRx, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, byteErrorRatio=byteErrorRatio, licenseIEEE1588Support=licenseIEEE1588Support, encryptionGroup=encryptionGroup, timeZone=timeZone, transparentClock=transparentClock, syncETrackingState=syncETrackingState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsTable=dfsTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, phyStatus=phyStatus, cableDiagPair1Distance=cableDiagPair1Distance, telnetPortNumber=telnetPortNumber, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseOOBManagementSupport=licenseOOBManagementSupport, phyStatusGroup=phyStatusGroup, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortQLTx=sFPPortQLTx, bridgeGroup=bridgeGroup, syncEEquipmentClock=syncEEquipmentClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseEncryption=licenseEncryption, subbandHighestFrequency=subbandHighestFrequency, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortSyncERxStatus=auxPortSyncERxStatus, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogStateTrap=syslogStateTrap, licenseBandwidthCap=licenseBandwidthCap, searchState=searchState, sNMPPortNumber=sNMPPortNumber, receiveChannel=receiveChannel, secondDataBridgingStatus=secondDataBridgingStatus, vectorError=vectorError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseIPv6Support=licenseIPv6Support, cableDiagPair1Results=cableDiagPair1Results, portAllocationMismatch=portAllocationMismatch, regulatoryBand=regulatoryBand, dataBridgingStatus=dataBridgingStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receivePower=receivePower, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ptmp=ptmp, license=license, installStatusTrap=installStatusTrap, sntp=sntp, sNTPServerRetries=sNTPServerRetries, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABTransmissionInterval=mABTransmissionInterval, versionsGroup=versionsGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogClient=syslogClient, licenseIssueNumber=licenseIssueNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, signalStrengthRatio=signalStrengthRatio, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, snmpControl=snmpControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortStatus=mainPSUPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogClientTrap=syslogClientTrap, encryption=encryption, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, ptpGroups=ptpGroups, auxPortQLTx=auxPortQLTx, tdmTableNumber=tdmTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transmitModulationMode=transmitModulationMode, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transparentClockVLAN=transparentClockVLAN, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortSSMTx=sFPPortSSMTx, latitude=latitude, tDMEnabledChannels=tDMEnabledChannels, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mABMaintenanceLevel=mABMaintenanceLevel, rawReceivePower=rawReceivePower, regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tdmTableIndex=tdmTableIndex, sFPPortStatus=sFPPortStatus, receiveFreqKHz=receiveFreqKHz, localPacketFiltering=localPacketFiltering, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseVersion=licenseVersion, sFPPortAllocation=sFPPortAllocation, syslogState=syslogState, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transmitChannel=transmitChannel, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortQLRx=sFPPortQLRx, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseGroup=licenseGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagPair4Results=cableDiagPair4Results, altitude=altitude, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, bootVersion=bootVersion, routerProtocols=routerProtocols, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, userTableEntry=userTableEntry, mainPSUPortSSMTx=mainPSUPortSSMTx, smtpGroup=smtpGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseTrialPeriod=licenseTrialPeriod, iPv4Address=iPv4Address, phyControlGroup=phyControlGroup, sNTPServerTableEntry=sNTPServerTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, reset=reset)
