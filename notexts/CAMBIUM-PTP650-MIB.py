...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", systemClock=systemClock, mABState=mABState, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseIPv6Support=licenseIPv6Support, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair3Results=cableDiagPair3Results, licenseRARSupport=licenseRARSupport, snmpControlGroup=snmpControlGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cableDiagPair2Results=cableDiagPair2Results, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementGroup=managementGroup, tDMInterfaceStatus=tDMInterfaceStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, mainPSUPortStatus=mainPSUPortStatus, syncEEquipmentClock=syncEEquipmentClock, dfsGroup=dfsGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsTable=dfsTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, rxColorCode=rxColorCode, syslogStateTrap=syslogStateTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, nIDULanPortStatus=nIDULanPortStatus, PYSNMP_MODULE_ID=cambium, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, alarmsGroup=alarmsGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, latitude=latitude, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDMChannelStatus=tDMChannelStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABProtocolVLANPriority=mABProtocolVLANPriority, txColorCode=txColorCode, tdmTableNumber=tdmTableNumber, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, versions=versions, sNMPPortNumber=sNMPPortNumber, tDMChannelLineCode=tDMChannelLineCode, sFPPortQLRx=sFPPortQLRx, resetGroup=resetGroup, cableDiagnostics=cableDiagnostics, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerStatus=sNTPServerStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, userTableIndex=userTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapVersion=sNMPTrapVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, userPassword=userPassword, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regulatoryBand=regulatoryBand, licenseSecurityLevel=licenseSecurityLevel, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dfs=dfs, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, targetRange=targetRange, transmitModulationMode=transmitModulationMode, tdmTableIndex=tdmTableIndex, dataBridgingStatus=dataBridgingStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, unitOutOfCalibration=unitOutOfCalibration, tDMChannelCableLength=tDMChannelCableLength, lowestDataModulationMode=lowestDataModulationMode, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkAvailability=wirelessLinkAvailability, mABHoldoffPeriod=mABHoldoffPeriod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productVariant=productVariant, installArmStateTrap=installArmStateTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dSCPManagementPriority=dSCPManagementPriority, phyControlGroup=phyControlGroup, iPv6Address=iPv6Address, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, aAAControl=aAAControl, l2CPPriorityTable=l2CPPriorityTable, dataPortPauseFrames=dataPortPauseFrames, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPv3Enable=sNMPv3Enable, cableDiagPair1Distance=cableDiagPair1Distance, telnetPortNumber=telnetPortNumber, auxPortSSMTx=auxPortSSMTx, userRole=userRole, configuration=configuration, tdmTableEntry=tdmTableEntry, auxPortQLRx=auxPortQLRx, alarms=alarms, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortAutoMdix=nIDULanPortAutoMdix, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDControl=tDDControl, sntpGroup=sntpGroup, userTableEntry=userTableEntry, licenseSyncESupport=licenseSyncESupport, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimization=linkModeOptimization, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortAutoNegotiation=sFPPortAutoNegotiation, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPLastSync=sNTPLastSync, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkSymmetry=linkSymmetry, bridge=bridge, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, auxPortQLTx=auxPortQLTx, auxPortStatusTrap=auxPortStatusTrap, secureModeAlarm=secureModeAlarm, phyControl=phyControl, sNTPServerTimeout=sNTPServerTimeout, licenseRegulatoryBandsList=licenseRegulatoryBandsList, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPError=sFPError, tDMChannelLoopback=tDMChannelLoopback, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userEnabled=userEnabled, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, ptp650=ptp650, remoteInternetAddress=remoteInternetAddress, syslogControlGroup=syslogControlGroup, licenseGroup=licenseGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerTableNumber=sNTPServerTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tdmTable=tdmTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseIssueNumber=licenseIssueNumber, installStatus=installStatus, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, regulatoryBandTrap=regulatoryBandTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseBandwidthCap=licenseBandwidthCap, range=range, mABProtocolVID=mABProtocolVID, tDMInterfaceControl=tDMInterfaceControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, bootVersion=bootVersion, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPv4Address=iPv4Address, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerInternetAddressType=sNTPServerInternetAddressType, management=management, routerProtocols=routerProtocols, mABNominalModulationMode=mABNominalModulationMode, iPv6PrefixLength=iPv6PrefixLength, dfsPeaks=dfsPeaks, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortStatus=sFPPortStatus, systemReset=systemReset, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortAutoMdix=sFPPortAutoMdix, auxPortStatus=auxPortStatus, syslogState=syslogState, userTable=userTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, subbandHighestFrequency=subbandHighestFrequency, sNTPPrimaryServer=sNTPPrimaryServer, licenseIEEE1588Support=licenseIEEE1588Support, secureModeAlarmTrap=secureModeAlarmTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, licenseVersion=licenseVersion, byteErrorRatio=byteErrorRatio, secondDataBridgingStatus=secondDataBridgingStatus, portAllocationMismatch=portAllocationMismatch, cableLoss=cableLoss, phyStatus=phyStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitPower=transmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, syslogClient=syslogClient, wirelessLinkStatus=wirelessLinkStatus, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, phyStatusGroup=phyStatusGroup, qOSPriorityScheme=qOSPriorityScheme, tDM=tDM, licenseOOBManagementSupport=licenseOOBManagementSupport, targetMACAddress=targetMACAddress, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortAllocation=sFPPortAllocation, tDDControlGroup=tDDControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, cableDiagnosticsGroup=cableDiagnosticsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseCountry=licenseCountry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, smtp=smtp, ptp=ptp, timeZone=timeZone, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerTable=sNTPServerTable, subbandLowestFrequency=subbandLowestFrequency, snmpControl=snmpControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, capacityVariantMismatch=capacityVariantMismatch, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, transmitFreqKHz=transmitFreqKHz, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, userTableNumber=userTableNumber, dfsTableEntry=dfsTableEntry, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, accessMethod=accessMethod, ptpTrapPrefix=ptpTrapPrefix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, mainPSUPortQLRx=mainPSUPortQLRx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, lowestTDMModulationMode=lowestTDMModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernet=ethernet, useVLANForMABProtocol=useVLANForMABProtocol, encryptionGroup=encryptionGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseGroupAccess=licenseGroupAccess, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, hardwareVersion=hardwareVersion, sFPPortSyncERxStatus=sFPPortSyncERxStatus, extendedSpectrumScanning=extendedSpectrumScanning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortSSMTx=sFPPortSSMTx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseTrialPeriod=licenseTrialPeriod, notificationsGroup=notificationsGroup, ptpCompliance=ptpCompliance, transparentClock=transparentClock, cableDiagPair3Distance=cableDiagPair3Distance, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortQLTx=sFPPortQLTx, transparentClockVID=transparentClockVID, sNTPServerInternetAddress=sNTPServerInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, groupID=groupID, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, longitude=longitude, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, txMABFrames=txMABFrames, linkName=linkName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, localPacketFiltering=localPacketFiltering, sNTPPollInterval=sNTPPollInterval, transparentClockPort=transparentClockPort, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryption=encryption, mainPSUPortQLTx=mainPSUPortQLTx, sNTPState=sNTPState, cambium=cambium, rangingMode=rangingMode, licenseEncryption=licenseEncryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, sNMPTrapTable=sNMPTrapTable, ptmp=ptmp, rawReceivePower=rawReceivePower, licenseCapacity=licenseCapacity, syslogControl=syslogControl, pubStatsGroup=pubStatsGroup, syncETracking=syncETracking, transmitFreqMHz=transmitFreqMHz, productName=productName, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, vectorError=vectorError, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMGroup=tDMGroup, bridgeGroup=bridgeGroup, mABMaintenanceLevel=mABMaintenanceLevel, auxPortDisabledWarning=auxPortDisabledWarning, iPVersion=iPVersion, transparentClockVLAN=transparentClockVLAN, lowestSecondDataModulationMode=lowestSecondDataModulationMode, installStatusTrap=installStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTableIndex=dfsTableIndex, maximumTransmitPower=maximumTransmitPower, searchState=searchState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, mainPSUPortAutoMdix=mainPSUPortAutoMdix, versionsGroup=versionsGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, receiveChannel=receiveChannel, auxPortAllocation=auxPortAllocation, transmitDataRate=transmitDataRate, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagPair4Results=cableDiagPair4Results, aAAControlGroup=aAAControlGroup, dataBridgingAvailability=dataBridgingAvailability, routerProtocolsGroup=routerProtocolsGroup, cableDiagPair2Distance=cableDiagPair2Distance, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, ptpTraps=ptpTraps, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, antennaGain=antennaGain, syncETrackingState=syncETrackingState, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, vLANManagementPriority=vLANManagementPriority, smtpGroup=smtpGroup, receivePower=receivePower, licenseSFPPortSupport=licenseSFPPortSupport, tDMChannelStatusTrap=tDMChannelStatusTrap, softwareVersion=softwareVersion, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnosticsPorts=cableDiagnosticsPorts, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, enableTransmission=enableTransmission, license=license, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDMEnabledChannels=tDMEnabledChannels, reset=reset, linkLoss=linkLoss)
