...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", transmitModulationMode=transmitModulationMode, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, licenseGroupAccess=licenseGroupAccess, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortQLRx=sFPPortQLRx, transparentClockPort=transparentClockPort, dfsPeaks=dfsPeaks, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyControlGroup=phyControlGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, licenseIEEE1588Support=licenseIEEE1588Support, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseCapacity=licenseCapacity, sFPError=sFPError, userRole=userRole, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, tDMChannelLoopback=tDMChannelLoopback, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControl=aAAControl, syslogControl=syslogControl, auxPortStatusTrap=auxPortStatusTrap, sFPPortAutoMdix=sFPPortAutoMdix, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortQLTx=sFPPortQLTx, licenseRARSupport=licenseRARSupport, dfs=dfs, sFPErrorTrap=sFPErrorTrap, phyStatusGroup=phyStatusGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagPair1Distance=cableDiagPair1Distance, auxPortStatus=auxPortStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, groupID=groupID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv4Address=iPv4Address, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, timeZone=timeZone, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseSyncESupport=licenseSyncESupport, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, pubStatsGroup=pubStatsGroup, sFPPortSSMTx=sFPPortSSMTx, userName=userName, tDMChannelStatusTrap=tDMChannelStatusTrap, tdmTableIndex=tdmTableIndex, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPServerTable=sNTPServerTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, ptpCompliance=ptpCompliance, extendedSpectrumScanning=extendedSpectrumScanning, maximumTransmitPower=maximumTransmitPower, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, installArmStateTrap=installArmStateTrap, secureModeAlarm=secureModeAlarm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortAllocation=sFPPortAllocation, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, siteName=siteName, ptpGroups=ptpGroups, targetRange=targetRange, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortStatus=mainPSUPortStatus, txMABFrames=txMABFrames, useVLANForMABProtocol=useVLANForMABProtocol, syslogState=syslogState, userTable=userTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABState=mABState, licenseVersion=licenseVersion, mABProtocolVLANPriority=mABProtocolVLANPriority, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataBridgingAvailability=dataBridgingAvailability, receiveFreqMHz=receiveFreqMHz, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMGroup=tDMGroup, transparentClock=transparentClock, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, installStatusTrap=installStatusTrap, systemReset=systemReset, sFPPortStatus=sFPPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortPauseFrames=dataPortPauseFrames, daylightSaving=daylightSaving, supplementary=supplementary, mainPSUPortAllocation=mainPSUPortAllocation, mABProtocolVID=mABProtocolVID, configuration=configuration, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ptp=ptp, licenseGroup=licenseGroup, vLANManagementVID=vLANManagementVID, cableDiagnostics=cableDiagnostics, auxPortQLRx=auxPortQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, PYSNMP_MODULE_ID=cambium, mABNominalTransmitCapacity=mABNominalTransmitCapacity, routerProtocols=routerProtocols, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, ptmp=ptmp, transmitDataRate=transmitDataRate, cableDiagnosticsControl=cableDiagnosticsControl, sNTPServerTableIndex=sNTPServerTableIndex, phyStatus=phyStatus, byteErrorRatio=byteErrorRatio, eIRP=eIRP, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingStatus=dataBridgingStatus, secondDataBridgingStatus=secondDataBridgingStatus, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sNTPServerTimeout=sNTPServerTimeout, sntpGroup=sntpGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, transmitChannel=transmitChannel, ptpTraps=ptpTraps, iPv6GatewayAddress=iPv6GatewayAddress, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationMode=tDDSynchronizationMode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, syncEEquipmentClock=syncEEquipmentClock, snmpControlGroup=snmpControlGroup, phyControl=phyControl, ethernetGroup=ethernetGroup, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, linkLoss=linkLoss, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerInternetAddressType=tFTPServerInternetAddressType, accessMethod=accessMethod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dfsTable=dfsTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDMInterfaceStatus=tDMInterfaceStatus, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPServerRetries=sNTPServerRetries, cableDiagPair4Results=cableDiagPair4Results, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mABMaintenanceLevel=mABMaintenanceLevel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regulatoryBand=regulatoryBand, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagPair4Distance=cableDiagPair4Distance, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, cambium=cambium, sNTPServerInternetAddress=sNTPServerInternetAddress, lowestDataModulationMode=lowestDataModulationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, receiveFreqKHz=receiveFreqKHz, vLANManagementPriority=vLANManagementPriority, subbandLowestFrequency=subbandLowestFrequency, installStatus=installStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortSSMTx=auxPortSSMTx, smtp=smtp, sntp=sntp, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortDisabledWarning=auxPortDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, management=management, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPLastSync=sNTPLastSync, maxLinkRangeExceeded=maxLinkRangeExceeded, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableEntry=l2CPPriorityTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, snmpControl=snmpControl, systemClock=systemClock, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseTrialPeriod=licenseTrialPeriod, sNTPServerStatus=sNTPServerStatus, syncETrackingState=syncETrackingState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tdmTable=tdmTable, linkSymmetry=linkSymmetry, receivePower=receivePower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, tDMEnabledChannels=tDMEnabledChannels, hTTPPortNumber=hTTPPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitPower=transmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, license=license, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, encryptionAlgorithm=encryptionAlgorithm, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkModeOptimization=linkModeOptimization, receiveChannel=receiveChannel, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMChannelLineCode=tDMChannelLineCode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userPassword=userPassword, channelChangeTrap=channelChangeTrap, qOSPriorityScheme=qOSPriorityScheme, sNTPPollInterval=sNTPPollInterval, licenseTDDSyncSupport=licenseTDDSyncSupport, dfsTableNumber=dfsTableNumber, auxPortQLTx=auxPortQLTx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, enableTransmission=enableTransmission, dfsGroup=dfsGroup, subbandHighestFrequency=subbandHighestFrequency, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, searchState=searchState, cableLoss=cableLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, pubStats=pubStats, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagPair2Results=cableDiagPair2Results, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transparentClockVID=transparentClockVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagPair3Distance=cableDiagPair3Distance, notificationsGroup=notificationsGroup, ptp650=ptp650, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, userEnabled=userEnabled, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDMChannelCableLength=tDMChannelCableLength, targetMACAddress=targetMACAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, bridge=bridge, receiveDataRate=receiveDataRate, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortStatusTrap=sFPPortStatusTrap, encryption=encryption, regulatoryBandTrap=regulatoryBandTrap, remoteInternetAddress=remoteInternetAddress, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, bridgeGroup=bridgeGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, userTableEntry=userTableEntry, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tdmTableEntry=tdmTableEntry, sNTPSync=sNTPSync, aggregateDataRate=aggregateDataRate, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelStatus=tDMChannelStatus, frequencyVariant=frequencyVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, alarmsGroup=alarmsGroup, productName=productName, cableDiagPair3Results=cableDiagPair3Results, txColorCode=txColorCode, syncETracking=syncETracking, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmState=installArmState, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseBandwidthCap=licenseBandwidthCap, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, vectorError=vectorError, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortAllocation=auxPortAllocation, tFTPServerInternetAddress=tFTPServerInternetAddress, rxColorCode=rxColorCode, portAllocationMismatch=portAllocationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortQLRx=mainPSUPortQLRx, rawReceivePower=rawReceivePower, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair2Distance=cableDiagPair2Distance, managementGroup=managementGroup, lowestSecondDataModulationMode=lowestSecondDataModulationMode, iPVersion=iPVersion, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, telnetAccessEnabled=telnetAccessEnabled, licenseIPv6Support=licenseIPv6Support, noWirelessChannelAvailable=noWirelessChannelAvailable, configurationGroup=configurationGroup, tDM=tDM, dfsTableIndex=dfsTableIndex, ethernet=ethernet, mABHoldoffPeriod=mABHoldoffPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, iPv6Address=iPv6Address, softwareVersion=softwareVersion, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, syslogControlGroup=syslogControlGroup, nIDULanPortStatus=nIDULanPortStatus, transmitFreqKHz=transmitFreqKHz, sFPPortDisabledWarning=sFPPortDisabledWarning, rangingMode=rangingMode, licenseCountry=licenseCountry, licenseEncryption=licenseEncryption, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, versions=versions, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDControl=tDDControl, transparentClockVLAN=transparentClockVLAN, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, tdmTableNumber=tdmTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkName=linkName, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, userTableIndex=userTableIndex, licenseSecurityLevel=licenseSecurityLevel, secondDataPortPauseFrames=secondDataPortPauseFrames, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, range=range, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dSCPManagementPriority=dSCPManagementPriority, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, telnetPortNumber=telnetPortNumber, cableDiagPair1Results=cableDiagPair1Results, aAAControlGroup=aAAControlGroup)
