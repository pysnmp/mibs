...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", ptpTraps=ptpTraps, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, iPv6Address=iPv6Address, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dataBridgingStatus=dataBridgingStatus, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagnostics=cableDiagnostics, configurationGroup=configurationGroup, dfsGroup=dfsGroup, eIRP=eIRP, searchState=searchState, byteErrorRatio=byteErrorRatio, sNMPCommunityString=sNMPCommunityString, tDM=tDM, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, altitude=altitude, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transparentClock=transparentClock, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortAllocation=mainPSUPortAllocation, auxPortQLRx=auxPortQLRx, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userTable=userTable, sFPPortAllocation=sFPPortAllocation, cableDiagPair4Results=cableDiagPair4Results, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseSFPPortSupport=licenseSFPPortSupport, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mABTransmissionInterval=mABTransmissionInterval, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortSSMTx=auxPortSSMTx, pubStats=pubStats, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqKHz=transmitFreqKHz, dfsTableEntry=dfsTableEntry, ptmp=ptmp, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDControl=tDDControl, tDMInterfaceControl=tDMInterfaceControl, license=license, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, regulatoryBand=regulatoryBand, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, productName=productName, auxPortAllocation=auxPortAllocation, licenseCountry=licenseCountry, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, linkSymmetry=linkSymmetry, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, tDMChannelLoopback=tDMChannelLoopback, mABHoldoffPeriod=mABHoldoffPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, installStatusTrap=installStatusTrap, syncETracking=syncETracking, ptp650=ptp650, accessMethod=accessMethod, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, bootVersion=bootVersion, lowestTDMModulationMode=lowestTDMModulationMode, licenseIPv6Support=licenseIPv6Support, useVLANForMABProtocol=useVLANForMABProtocol, pubStatsGroup=pubStatsGroup, capacityVariantMismatch=capacityVariantMismatch, sNTPServerTableEntry=sNTPServerTableEntry, gatewayIPAddress=gatewayIPAddress, licenseCapacity=licenseCapacity, transparentClockPort=transparentClockPort, dfsMeans=dfsMeans, userEnabled=userEnabled, userTableNumber=userTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseTrialPeriod=licenseTrialPeriod, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mABProtocolVID=mABProtocolVID, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mPLSTCPriorityTable=mPLSTCPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, licenseSyncESupport=licenseSyncESupport, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, latitude=latitude, regulatoryBandTrap=regulatoryBandTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortStatus=sFPPortStatus, txColorCode=txColorCode, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, sFPError=sFPError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortPauseFrames=dataPortPauseFrames, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagPair4Distance=cableDiagPair4Distance, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, localPacketFiltering=localPacketFiltering, mABNominalModulationMode=mABNominalModulationMode, sFPErrorTrap=sFPErrorTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, syslogControl=syslogControl, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortAutoMdix=sFPPortAutoMdix, userPassword=userPassword, dSCPManagementPriority=dSCPManagementPriority, rawReceivePower=rawReceivePower, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitDataRate=transmitDataRate, routerProtocolsGroup=routerProtocolsGroup, systemClock=systemClock, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDDControlGroup=tDDControlGroup, tDMChannelLineCode=tDMChannelLineCode, iPv6PrefixLength=iPv6PrefixLength, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, userRole=userRole, encryptionGroup=encryptionGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, linkModeOptimization=linkModeOptimization, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveFreqMHz=receiveFreqMHz, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarmsGroup=alarmsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogStateTrap=syslogStateTrap, tDMGroup=tDMGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarm=secureModeAlarm, iPv4Address=iPv4Address, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseVersion=licenseVersion, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsPeaks=dfsPeaks, userName=userName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, snmpControlGroup=snmpControlGroup, sNTPServerTableIndex=sNTPServerTableIndex, timeZone=timeZone, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, dfsTableIndex=dfsTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, ethernet=ethernet, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, resetGroup=resetGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mainPSUPortStatus=mainPSUPortStatus, tdmTableNumber=tdmTableNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, masterSlaveMode=masterSlaveMode, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, versionsGroup=versionsGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair1Results=cableDiagPair1Results, sntp=sntp, lowestDataModulationMode=lowestDataModulationMode, routerProtocols=routerProtocols, subbandHighestFrequency=subbandHighestFrequency, sNTPServerTable=sNTPServerTable, auxPortQLTx=auxPortQLTx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, extendedSpectrumScanning=extendedSpectrumScanning, iPv6GatewayAddress=iPv6GatewayAddress, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, secondDataBridgingStatus=secondDataBridgingStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, hTTPAccessEnabled=hTTPAccessEnabled, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, supplementary=supplementary, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, channelBandwidth=channelBandwidth, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTable=sNMPTrapTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, softwareVersion=softwareVersion, ethernetPriorityTableNumber=ethernetPriorityTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPEnabledTraps=sNMPEnabledTraps, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, tdmTableIndex=tdmTableIndex, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, bridge=bridge, auxPortAcceptedQLRx=auxPortAcceptedQLRx, targetRange=targetRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, rxColorCode=rxColorCode, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsTable=dfsTable)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControl=snmpControl, licenseBandwidthCap=licenseBandwidthCap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPPortNumber=sNMPPortNumber, longitude=longitude, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, transmitChannel=transmitChannel, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, maxLinkRangeExceeded=maxLinkRangeExceeded, userTableIndex=userTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, auxPortSyncERxStatus=auxPortSyncERxStatus, sMTPServerPortNumber=sMTPServerPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRARSupport=licenseRARSupport, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, subbandLowestFrequency=subbandLowestFrequency, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortAutoMdix=mainPSUPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDMChannelStatusTrap=tDMChannelStatusTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, cableDiagPair2Results=cableDiagPair2Results, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClientTrap=syslogClientTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, licenseGroup=licenseGroup, frequencyVariant=frequencyVariant, dfs=dfs, licenseIEEE1588Support=licenseIEEE1588Support, notificationsGroup=notificationsGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, sNTPState=sNTPState, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, tDMEnabledChannels=tDMEnabledChannels, syslogClient=syslogClient, sNTPSync=sNTPSync, aAAControl=aAAControl, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receivePower=receivePower, mABState=mABState, reset=reset, sNTPSyncTrap=sNTPSyncTrap, rangingMode=rangingMode, portAllocationMismatch=portAllocationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaGain=antennaGain, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTableNumber=sNTPServerTableNumber, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, sFPPortStatusTrap=sFPPortStatusTrap, alarms=alarms, encryption=encryption, installStatus=installStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mABMaintenanceLevel=mABMaintenanceLevel, qOSPriorityScheme=qOSPriorityScheme, sFPPortQLTx=sFPPortQLTx, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ptpGroups=ptpGroups, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseSecurityLevel=licenseSecurityLevel, installArmStateTrap=installArmStateTrap, auxPortStatusTrap=auxPortStatusTrap, sntpGroup=sntpGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receiveFreqKHz=receiveFreqKHz, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyControl=phyControl, groupID=groupID, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseEncryption=licenseEncryption, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyControlGroup=phyControlGroup, tdmTable=tdmTable, ethernetGroup=ethernetGroup, vectorError=vectorError, userTableEntry=userTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, PYSNMP_MODULE_ID=cambium, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, productVariant=productVariant, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, phyStatusGroup=phyStatusGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDMChannelCableLength=tDMChannelCableLength, sNTPServerRetries=sNTPServerRetries, telnetPortNumber=telnetPortNumber, versions=versions, tdmTableEntry=tdmTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, management=management, targetMACAddress=targetMACAddress, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syncETrackingState=syncETrackingState, licenseGroupAccess=licenseGroupAccess, cableDiagPair1Distance=cableDiagPair1Distance, iPVersion=iPVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transmitPower=transmitPower, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, cableDiagnosticsPorts=cableDiagnosticsPorts, managementGroup=managementGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortStatus=auxPortStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, nIDULanPortStatus=nIDULanPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, cableDiagPair2Distance=cableDiagPair2Distance, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, secondarySoftwareVersion=secondarySoftwareVersion, licenseIssueNumber=licenseIssueNumber, receiveModulationMode=receiveModulationMode, transparentClockVID=transparentClockVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, linkName=linkName, aggregateDataRate=aggregateDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, remoteInternetAddressType=remoteInternetAddressType, vLANManagementPriority=vLANManagementPriority, smtp=smtp, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANManagementVID=vLANManagementVID)
