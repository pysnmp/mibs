...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, tDMEnabledChannels=tDMEnabledChannels, ptp=ptp, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveFreqKHz=receiveFreqKHz, tDMChannelStatusTrap=tDMChannelStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, smtp=smtp, iPv4Address=iPv4Address, receivePower=receivePower, syslogControlGroup=syslogControlGroup, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, enableTransmission=enableTransmission, sFPPortStatusTrap=sFPPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTable=iPDSCPPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, dataPortPauseFrames=dataPortPauseFrames, licenseVersion=licenseVersion, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, userTableEntry=userTableEntry, dfsGroup=dfsGroup, routerProtocolsGroup=routerProtocolsGroup, receiveModulationModeDetail=receiveModulationModeDetail, iPVersion=iPVersion, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair3Results=cableDiagPair3Results, management=management, sNTPServerStatus=sNTPServerStatus, tDMChannelCableLength=tDMChannelCableLength, cambium=cambium, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, phyControl=phyControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, configurationGroup=configurationGroup, secondDataBridgingStatus=secondDataBridgingStatus, sntp=sntp, cableDiagnosticsControl=cableDiagnosticsControl, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, lowestTDMModulationMode=lowestTDMModulationMode, sNTPLastSync=sNTPLastSync, tDMChannelStatus=tDMChannelStatus, pubStats=pubStats, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, capacityVariantMismatch=capacityVariantMismatch, cableDiagPair1Results=cableDiagPair1Results, regulatoryBandTrap=regulatoryBandTrap, syslogStateTrap=syslogStateTrap, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPPollInterval=sNTPPollInterval, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, antennaGain=antennaGain, accessMethod=accessMethod, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANManagementPriority=vLANManagementPriority, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, mABProtocolVID=mABProtocolVID, mABHoldoffPeriod=mABHoldoffPeriod, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, syncETracking=syncETracking, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv6PrefixLength=iPv6PrefixLength, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSyncERxStatus=auxPortSyncERxStatus, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, mainPSUPortAutoMdix=mainPSUPortAutoMdix, targetRange=targetRange, lowestSecondDataModulationMode=lowestSecondDataModulationMode, cableDiagPair2Distance=cableDiagPair2Distance, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseSecurityLevel=licenseSecurityLevel, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, supplementaryGroup=supplementaryGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, linkModeOptimization=linkModeOptimization, alarms=alarms, auxPortQLRx=auxPortQLRx, sNMPTrapVersion=sNMPTrapVersion, siteName=siteName, remoteInternetAddress=remoteInternetAddress, ptpTraps=ptpTraps, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, searchState=searchState, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, managementGroup=managementGroup, subbandLowestFrequency=subbandLowestFrequency, supplementary=supplementary, productVariant=productVariant, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortStatusTrap=auxPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, userTableNumber=userTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, encryption=encryption, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, signalStrengthRatio=signalStrengthRatio, sNMPv3Enable=sNMPv3Enable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, systemClock=systemClock, byteErrorRatio=byteErrorRatio, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, sFPPortAutoMdix=sFPPortAutoMdix, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, sFPPortSSMTx=sFPPortSSMTx, transmitFreqMHz=transmitFreqMHz, licenseIPv6Support=licenseIPv6Support, licenseGroupAccess=licenseGroupAccess, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTable=sNTPServerTable, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6Address=iPv6Address, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, linkSymmetry=linkSymmetry, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, hardwareVersion=hardwareVersion, managementNetworkAccessEnabled=managementNetworkAccessEnabled, installStatusTrap=installStatusTrap, dataBridgingStatus=dataBridgingStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, tFTPServerInternetAddress=tFTPServerInternetAddress, channelBandwidth=channelBandwidth, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortStatus=auxPortStatus, systemReset=systemReset, mainPSUPortQLTx=mainPSUPortQLTx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseCapacity=licenseCapacity, subnetMask=subnetMask, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, installArmStateTrap=installArmStateTrap, tdmTableIndex=tdmTableIndex, installArmState=installArmState, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, subbandHighestFrequency=subbandHighestFrequency, ethernetPriorityTable=ethernetPriorityTable, productName=productName, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkName=linkName, portAllocationMismatch=portAllocationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dfs=dfs, rxColorCode=rxColorCode, ptpGroups=ptpGroups, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, sFPError=sFPError, licenseSyncESupport=licenseSyncESupport, userTableIndex=userTableIndex, syslogControl=syslogControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseBandwidthCap=licenseBandwidthCap, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortQLTx=auxPortQLTx, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseIEEE1588Support=licenseIEEE1588Support, hTTPSPortNumber=hTTPSPortNumber, ptp650=ptp650, routerProtocols=routerProtocols, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDMGroup=tDMGroup, secondDataPortPauseFrames=secondDataPortPauseFrames, mABNominalModulationMode=mABNominalModulationMode, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, installStatus=installStatus, localPacketFiltering=localPacketFiltering, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, tDMChannelLoopback=tDMChannelLoopback, eIRP=eIRP, aggregateDataRate=aggregateDataRate, cableDiagPair3Distance=cableDiagPair3Distance, licenseCountry=licenseCountry, tdmTableEntry=tdmTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", bridge=bridge, linkLoss=linkLoss, tDM=tDM, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ptmp=ptmp, configuration=configuration, sFPPortStatus=sFPPortStatus, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, dfsTableNumber=dfsTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, longitude=longitude, sFPErrorTrap=sFPErrorTrap, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagPair2Results=cableDiagPair2Results, versions=versions, rangingMode=rangingMode, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userName=userName, l2CPPriorityTable=l2CPPriorityTable, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortAllocation=sFPPortAllocation, timeZone=timeZone, mABState=mABState, secureModeAlarm=secureModeAlarm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableEntry=sNTPServerTableEntry, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, channelChangeTrap=channelChangeTrap, transparentClockVID=transparentClockVID, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, lowestDataModulationMode=lowestDataModulationMode, mABTransmissionInterval=mABTransmissionInterval, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPCommunityString=sNMPCommunityString, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, daylightSaving=daylightSaving, groupID=groupID, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rawReceivePower=rawReceivePower, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, userRole=userRole, sNTPServerTableIndex=sNTPServerTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, snmpControl=snmpControl, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTable=mPLSTCPriorityTable, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, mainPSUPortStatus=mainPSUPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transparentClock=transparentClock, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseTrialPeriod=licenseTrialPeriod, syncEEquipmentClock=syncEEquipmentClock, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, sMTPEnabledMessages=sMTPEnabledMessages, tDDControlGroup=tDDControlGroup, qOSPriorityScheme=qOSPriorityScheme, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, vLANManagementVID=vLANManagementVID, secureModeAlarmTrap=secureModeAlarmTrap, dataBridgingAvailability=dataBridgingAvailability, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogState=syslogState, transparentClockPort=transparentClockPort, sFPPortQLTx=sFPPortQLTx, ethernetGroup=ethernetGroup, sNTPServerRetries=sNTPServerRetries, licenseGroup=licenseGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, targetMACAddress=targetMACAddress, licenseRARSupport=licenseRARSupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userPassword=userPassword, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, receiveChannel=receiveChannel, cableDiagnostics=cableDiagnostics, tdmTableNumber=tdmTableNumber, txColorCode=txColorCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, PYSNMP_MODULE_ID=cambium, transparentClockVLAN=transparentClockVLAN, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, alarmsGroup=alarmsGroup, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortQLRx=sFPPortQLRx, vectorError=vectorError, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTable=sNMPTrapTable, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tdmTable=tdmTable, noWirelessChannelAvailable=noWirelessChannelAvailable, cableLoss=cableLoss, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, reset=reset, syncETrackingState=syncETrackingState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClient=syslogClient, encryptionGroup=encryptionGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseEncryption=licenseEncryption, auxPortAllocation=auxPortAllocation, dfsTable=dfsTable, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseIssueNumber=licenseIssueNumber, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelLineCode=tDMChannelLineCode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, txMABFrames=txMABFrames, license=license, altitude=altitude, phyStatusGroup=phyStatusGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tDMInterfaceControl=tDMInterfaceControl, transmitPower=transmitPower, tDMInterfaceStatus=tDMInterfaceStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, auxPortSSMTx=auxPortSSMTx, sNTPPrimaryServer=sNTPPrimaryServer, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, range=range, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, snmpControlGroup=snmpControlGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetPortNumber=telnetPortNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, regulatoryBand=regulatoryBand, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap)
