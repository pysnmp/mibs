...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", encryption=encryption, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortAllocation=auxPortAllocation, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, rawReceivePower=rawReceivePower, range=range, receiveDataRate=receiveDataRate, userRole=userRole, timeZone=timeZone, sNTPServerTable=sNTPServerTable, latitude=latitude, tDMChannelLoopback=tDMChannelLoopback, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondDataBridgingStatus=secondDataBridgingStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTable=tdmTable, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsTableIndex=dfsTableIndex, licenseCapacity=licenseCapacity, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortStatus=sFPPortStatus, mainPSUPortStatus=mainPSUPortStatus, transmitPower=transmitPower, syncETrackingState=syncETrackingState, license=license, resetGroup=resetGroup, txColorCode=txColorCode, ptmp=ptmp, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, sFPPortAutoMdix=sFPPortAutoMdix, channelChangeTrap=channelChangeTrap, mABState=mABState, targetRange=targetRange, tDMChannelCableLength=tDMChannelCableLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, aAAControl=aAAControl, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sntpGroup=sntpGroup, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, userTableNumber=userTableNumber, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aggregateDataRate=aggregateDataRate, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMInterfaceControl=tDMInterfaceControl, linkName=linkName, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, lowestSecondDataModulationMode=lowestSecondDataModulationMode, management=management, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, productName=productName, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, auxPortStatus=auxPortStatus, licenseIssueNumber=licenseIssueNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, enableTransmission=enableTransmission, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, syslogControlGroup=syslogControlGroup, qOSPriorityScheme=qOSPriorityScheme, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, tdmTableIndex=tdmTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, managementGroup=managementGroup, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tdmTableNumber=tdmTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, byteErrorRatio=byteErrorRatio, receivePower=receivePower, smtpGroup=smtpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, routerProtocolsGroup=routerProtocolsGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, installStatusTrap=installStatusTrap, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortQLRx=auxPortQLRx, accessMethod=accessMethod, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receiveFreqKHz=receiveFreqKHz, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, daylightSaving=daylightSaving, dataBridgingStatusAlarm=dataBridgingStatusAlarm, hTTPAccessEnabled=hTTPAccessEnabled, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPPollInterval=sNTPPollInterval, licenseBandwidthCap=licenseBandwidthCap, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, cableDiagPair4Results=cableDiagPair4Results, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cambium=cambium, licenseSyncESupport=licenseSyncESupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, remoteInternetAddress=remoteInternetAddress, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseRARSupport=licenseRARSupport, licenseGroup=licenseGroup, alarms=alarms, sNTPSync=sNTPSync, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnosticsControl=cableDiagnosticsControl, syslogClientTrap=syslogClientTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, longitude=longitude, transparentClockVLAN=transparentClockVLAN, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetGroup=ethernetGroup, mainPSUPortQLTx=mainPSUPortQLTx, sFPErrorTrap=sFPErrorTrap, sFPPortQLTx=sFPPortQLTx, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, linkSymmetry=linkSymmetry, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationMode=tDDSynchronizationMode, subnetMask=subnetMask, txMABFrames=txMABFrames, licenseSFPPortSupport=licenseSFPPortSupport, versions=versions, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseTrialPeriod=licenseTrialPeriod, secureModeAlarmTrap=secureModeAlarmTrap, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, sNTPServerTableNumber=sNTPServerTableNumber, mABTransmissionInterval=mABTransmissionInterval, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, vLANManagementPriority=vLANManagementPriority, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, vLANManagementVID=vLANManagementVID, nIDULanPortStatusTrap=nIDULanPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpGroups=ptpGroups, targetMACAddress=targetMACAddress, bootVersion=bootVersion, userTable=userTable, sNTPServerTableIndex=sNTPServerTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dataBridgingStatus=dataBridgingStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPv6GatewayAddress=iPv6GatewayAddress, lowestTDMModulationMode=lowestTDMModulationMode, syslogState=syslogState, reset=reset, sNMPEnabledTraps=sNMPEnabledTraps, iPv6Address=iPv6Address, licenseUnitSerialNumber=licenseUnitSerialNumber, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerTimeout=sNTPServerTimeout, iPVersion=iPVersion, dfsPeaks=dfsPeaks, subbandLowestFrequency=subbandLowestFrequency, linkLoss=linkLoss, vectorError=vectorError, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerStatus=sNTPServerStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagPair3Distance=cableDiagPair3Distance, auxPortDisabledWarning=auxPortDisabledWarning, mABMaintenanceLevel=mABMaintenanceLevel, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, userName=userName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsGroup=dfsGroup, transparentClockPort=transparentClockPort, sNTPSyncTrap=sNTPSyncTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, alarmsGroup=alarmsGroup, gatewayIPAddress=gatewayIPAddress, remoteInternetAddressType=remoteInternetAddressType, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagPair1Distance=cableDiagPair1Distance, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseVersion=licenseVersion, licenseEncryption=licenseEncryption, lowestDataModulationMode=lowestDataModulationMode, ptp650=ptp650, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, snmpControlGroup=snmpControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, rangingMode=rangingMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tdmTableEntry=tdmTableEntry, hTTPSPortNumber=hTTPSPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userEnabled=userEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, regulatoryBandTrap=regulatoryBandTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableIndex=userTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpCompliance=ptpCompliance, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagPair1Results=cableDiagPair1Results, dfsMeans=dfsMeans, sNTPServerTableEntry=sNTPServerTableEntry, configuration=configuration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, installArmStateTrap=installArmStateTrap, systemClock=systemClock, tDDControl=tDDControl, pubStats=pubStats, portAllocationMismatchTrap=portAllocationMismatchTrap, phyControl=phyControl, iPv4Address=iPv4Address, transmitModulationMode=transmitModulationMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTable=iPDSCPPriorityTable, phyControlGroup=phyControlGroup, tDMInterfaceStatus=tDMInterfaceStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNTPLastSync=sNTPLastSync, licenseOOBManagementSupport=licenseOOBManagementSupport, supplementaryGroup=supplementaryGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxColorCode=rxColorCode, dataBridgingAvailability=dataBridgingAvailability, linkModeOptimization=linkModeOptimization, sNTPServerRetries=sNTPServerRetries, cableDiagnostics=cableDiagnostics, siteName=siteName, sFPPortAllocation=sFPPortAllocation, smtp=smtp, bridgeGroup=bridgeGroup, frequencyVariant=frequencyVariant, tDDControlGroup=tDDControlGroup, bridge=bridge, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelLineCode=tDMChannelLineCode, masterSlaveMode=masterSlaveMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, phyStatus=phyStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp=ptp, sFPPortSSMTx=sFPPortSSMTx, telnetPortNumber=telnetPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, mABProtocolVLANPriority=mABProtocolVLANPriority, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, transparentClock=transparentClock, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABProtocolVID=mABProtocolVID, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mABHoldoffPeriod=mABHoldoffPeriod, installStatus=installStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortQLTx=auxPortQLTx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, snmpControl=snmpControl, userTableEntry=userTableEntry, systemReset=systemReset, receiveChannel=receiveChannel, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, subbandHighestFrequency=subbandHighestFrequency, licenseSecurityLevel=licenseSecurityLevel, sNMPTrapTableNumber=sNMPTrapTableNumber, localPacketFiltering=localPacketFiltering, receiveFreqMHz=receiveFreqMHz, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syncETracking=syncETracking, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseIPv6Support=licenseIPv6Support, cableDiagPair4Distance=cableDiagPair4Distance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair2Results=cableDiagPair2Results, transparentClockVID=transparentClockVID, licenseCountry=licenseCountry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, installArmState=installArmState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPError=sFPError, mainPSUPortSSMTx=mainPSUPortSSMTx, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementary=supplementary, dSCPManagementPriority=dSCPManagementPriority, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, userPassword=userPassword, regulatoryBand=regulatoryBand, tDMEnabledChannels=tDMEnabledChannels, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseGroupAccess=licenseGroupAccess, dataPortPauseFrames=dataPortPauseFrames, configurationGroup=configurationGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dfsTable=dfsTable, dfs=dfs, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, transmitDataRate=transmitDataRate, altitude=altitude, tDMChannelStatus=tDMChannelStatus, sNTPState=sNTPState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sntp=sntp, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secureModeAlarm=secureModeAlarm, transmitChannel=transmitChannel, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortSSMTx=auxPortSSMTx, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortQLRx=sFPPortQLRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTable=ethernetPriorityTable, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMGroup=tDMGroup, notificationsGroup=notificationsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, transmitFreqKHz=transmitFreqKHz, tDM=tDM, routerProtocols=routerProtocols, cableDiagnosticsPorts=cableDiagnosticsPorts, channelBandwidth=channelBandwidth)
