...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", encryptionGroup=encryptionGroup, remoteInternetAddress=remoteInternetAddress, syslogControl=syslogControl, dSCPManagementPriority=dSCPManagementPriority, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, routerProtocolsGroup=routerProtocolsGroup, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMChannelStatus=tDMChannelStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortQLTx=auxPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, vLANManagementPriority=vLANManagementPriority, licenseIEEE1588Support=licenseIEEE1588Support, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpGroups=ptpGroups, sFPPortStatus=sFPPortStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, vLANManagementVID=vLANManagementVID, licenseSecurityLevel=licenseSecurityLevel, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseEncryption=licenseEncryption, ptpTrapPrefix=ptpTrapPrefix, userTableIndex=userTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityVariantMismatchTrap=capacityVariantMismatchTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseSFPPortSupport=licenseSFPPortSupport, sNMPPortNumber=sNMPPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerTableNumber=sNTPServerTableNumber, softwareVersion=softwareVersion, syncETracking=syncETracking, longitude=longitude, maxLinkRangeExceeded=maxLinkRangeExceeded, tdmTableIndex=tdmTableIndex, hTTPPortNumber=hTTPPortNumber, useVLANForMABProtocol=useVLANForMABProtocol, supplementaryGroup=supplementaryGroup, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfs=dfs, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMGroup=tDMGroup, encryption=encryption, receivePower=receivePower, mPLSTCPriorityTable=mPLSTCPriorityTable, tDMEnabledChannels=tDMEnabledChannels, mABNominalModulationMode=mABNominalModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseIPv6Support=licenseIPv6Support, channelChangeTrap=channelChangeTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortStatusTrap=sFPPortStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, secondDataPortPauseFrames=secondDataPortPauseFrames, sNTPServerInternetAddress=sNTPServerInternetAddress, txMABFrames=txMABFrames, regulatoryBand=regulatoryBand, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, sNTPSync=sNTPSync, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortQLRx=auxPortQLRx, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, regulatoryBandTrap=regulatoryBandTrap, versions=versions, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userName=userName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, altitude=altitude, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, capacityVariantMismatch=capacityVariantMismatch, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, sNTPServerTableIndex=sNTPServerTableIndex, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, managementGroup=managementGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, daylightSaving=daylightSaving, routerProtocols=routerProtocols, lowestSecondDataModulationMode=lowestSecondDataModulationMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPErrorTrap=sFPErrorTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, transmitModulationMode=transmitModulationMode, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, sNTPServerStatus=sNTPServerStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transparentClockVID=transparentClockVID, oOBPriorityQueueMapping=oOBPriorityQueueMapping, supplementary=supplementary, sNTPServerTableEntry=sNTPServerTableEntry, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, dfsPeaks=dfsPeaks, txColorCode=txColorCode, channelBandwidth=channelBandwidth, transparentClockVLAN=transparentClockVLAN, mainPSUPortQLRx=mainPSUPortQLRx, localPacketFiltering=localPacketFiltering, tDMChannelStatusTrap=tDMChannelStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, lowestDataModulationMode=lowestDataModulationMode, sNMPTrapVersion=sNMPTrapVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, iPVersion=iPVersion, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagnostics=cableDiagnostics, frequencyVariant=frequencyVariant, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMInterfaceControl=tDMInterfaceControl, mABProtocolVID=mABProtocolVID, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, dfsGroup=dfsGroup, userTable=userTable, tDM=tDM, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mainPSUPortStatus=mainPSUPortStatus, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transmitFreqMHz=transmitFreqMHz, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, license=license, hTTPAccessEnabled=hTTPAccessEnabled, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDDControlGroup=tDDControlGroup, transparentClock=transparentClock, sNTPPollInterval=sNTPPollInterval, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortStatus=auxPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, range=range, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, licenseGroupAccess=licenseGroupAccess, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsTable=dfsTable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, bootVersion=bootVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, phyStatusGroup=phyStatusGroup, cableDiagPair4Distance=cableDiagPair4Distance, userRole=userRole, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsControl=cableDiagnosticsControl, syncETrackingState=syncETrackingState, hardwareVersion=hardwareVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, targetMACAddress=targetMACAddress, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, resetGroup=resetGroup, subbandHighestFrequency=subbandHighestFrequency, cableDiagnosticsWarning=cableDiagnosticsWarning, linkLoss=linkLoss, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataBridgingAvailability=dataBridgingAvailability, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortStatusTrap=auxPortStatusTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, configuration=configuration, transparentClockPort=transparentClockPort, sNTPServerTable=sNTPServerTable, dataBridgingStatus=dataBridgingStatus, versionsGroup=versionsGroup, licenseBandwidthCap=licenseBandwidthCap, mABState=mABState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, qOSPriorityScheme=qOSPriorityScheme, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMConfigurationMismatch=tDMConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, pubStats=pubStats, cableLoss=cableLoss, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseVersion=licenseVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, enableTransmission=enableTransmission, sFPPortQLRx=sFPPortQLRx, targetRange=targetRange, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTable=sNMPTrapTable, rxColorCode=rxColorCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelLoopback=tDMChannelLoopback, iPv6Address=iPv6Address, licenseRARSupport=licenseRARSupport)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", incompatibleRegulatoryBands=incompatibleRegulatoryBands, iPv4Address=iPv4Address, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, syslogState=syslogState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLTx=sFPPortQLTx, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, iPv6GatewayAddress=iPv6GatewayAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTable=tdmTable, ethernet=ethernet, userTableEntry=userTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, subbandLowestFrequency=subbandLowestFrequency, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transmitChannel=transmitChannel, sFPError=sFPError, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, linkName=linkName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bridge=bridge, alarmsGroup=alarmsGroup, linkModeOptimization=linkModeOptimization, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, secureModeAlarm=secureModeAlarm, aAAControlGroup=aAAControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, alarms=alarms, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, auxPortDisabledWarning=auxPortDisabledWarning, portAllocationMismatch=portAllocationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerRetries=sNTPServerRetries, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, cableDiagPair1Results=cableDiagPair1Results, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, tdmTableEntry=tdmTableEntry, signalStrengthRatio=signalStrengthRatio, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tdmTableNumber=tdmTableNumber, management=management, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortAllocation=auxPortAllocation, licenseCapacity=licenseCapacity, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, rangingMode=rangingMode, tDDSynchronizationMode=tDDSynchronizationMode, syslogStateTrap=syslogStateTrap, licenseIssueNumber=licenseIssueNumber, gatewayIPAddress=gatewayIPAddress, ptp650=ptp650, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, systemReset=systemReset, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, secondDataBridgingStatus=secondDataBridgingStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userEnabled=userEnabled, iPv6PrefixLength=iPv6PrefixLength, sFPPortAllocation=sFPPortAllocation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseGroup=licenseGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPLastSync=sNTPLastSync, mABHoldoffPeriod=mABHoldoffPeriod, installArmState=installArmState, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityTable=l2CPPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveChannel=receiveChannel, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagPair3Distance=cableDiagPair3Distance, maximumTransmitPower=maximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, notificationsGroup=notificationsGroup, ptpCompliance=ptpCompliance, auxPortSSMTx=auxPortSSMTx, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, groupID=groupID, tDDControl=tDDControl, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userPassword=userPassword, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, vectorError=vectorError, installArmStateTrap=installArmStateTrap, cableDiagPair1Distance=cableDiagPair1Distance, rawReceivePower=rawReceivePower, sFPPortAutoNegotiation=sFPPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, mABTransmissionInterval=mABTransmissionInterval, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, extendedSpectrumScanning=extendedSpectrumScanning, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, cambium=cambium, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortStatus=nIDULanPortStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseCountry=licenseCountry, cableDiagPair2Results=cableDiagPair2Results, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, productName=productName, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userTableNumber=userTableNumber, bridgeGroup=bridgeGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sntpGroup=sntpGroup, timeZone=timeZone, ethernetGroup=ethernetGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, smtpGroup=smtpGroup, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ptp=ptp, linkSymmetry=linkSymmetry, accessMethod=accessMethod, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sntp=sntp, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMChannelLineCode=tDMChannelLineCode, ethernetPriorityTable=ethernetPriorityTable, syslogControlGroup=syslogControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, smtp=smtp, subnetMask=subnetMask, syncEEquipmentClock=syncEEquipmentClock, transmitPower=transmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaGain=antennaGain, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode)
