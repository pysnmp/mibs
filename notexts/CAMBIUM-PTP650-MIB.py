...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mABHoldoffPeriod=mABHoldoffPeriod, linkLoss=linkLoss, tDMConfigurationMismatch=tDMConfigurationMismatch, regulatoryBand=regulatoryBand, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortStatusTrap=auxPortStatusTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tdmTableNumber=tdmTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, targetRange=targetRange, bridge=bridge, syslogState=syslogState, syslogClientTrap=syslogClientTrap, bridgeGroup=bridgeGroup, groupID=groupID, systemReset=systemReset, mABProtocolVLANPriority=mABProtocolVLANPriority, dataPortPauseFrames=dataPortPauseFrames, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userName=userName, tDMInterfaceStatus=tDMInterfaceStatus, searchState=searchState, iPv6GatewayAddress=iPv6GatewayAddress, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubStats=pubStats, remoteInternetAddressType=remoteInternetAddressType, qOSPriorityScheme=qOSPriorityScheme, configuration=configuration, transmitChannel=transmitChannel, regulatoryBandTrap=regulatoryBandTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transparentClockVID=transparentClockVID, syncEEquipmentClock=syncEEquipmentClock, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, maximumTransmitPower=maximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, license=license, ptp650=ptp650, tDMChannelStatusTrap=tDMChannelStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transparentClockVLAN=transparentClockVLAN, auxPortStatus=auxPortStatus, licenseIEEE1588Support=licenseIEEE1588Support, auxPortQLRx=auxPortQLRx, licenseGroupAccess=licenseGroupAccess, sNMPTrapTable=sNMPTrapTable, timeZone=timeZone, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, vectorError=vectorError, mABProtocolVID=mABProtocolVID, range=range, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetGroup=ethernetGroup, mainPSUPortQLRx=mainPSUPortQLRx, ptp=ptp, iPv6Address=iPv6Address, rxColorCode=rxColorCode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, productName=productName, receiveModulationMode=receiveModulationMode, longitude=longitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, PYSNMP_MODULE_ID=cambium, tDMChannelLineCode=tDMChannelLineCode, targetMACAddress=targetMACAddress, unitOutOfCalibration=unitOutOfCalibration, versionsGroup=versionsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, localPacketFiltering=localPacketFiltering, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, txColorCode=txColorCode, installArmStateTrap=installArmStateTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv6PrefixLength=iPv6PrefixLength, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, secondDataPortPauseFrames=secondDataPortPauseFrames, lowestDataModulationMode=lowestDataModulationMode, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, softwareVersion=softwareVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tDDControl=tDDControl, txMABFrames=txMABFrames, supplementaryGroup=supplementaryGroup, userTable=userTable, licenseMaxLinkRange=licenseMaxLinkRange, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sntp=sntp, sFPError=sFPError, configurationGroup=configurationGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, bootVersion=bootVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, gatewayIPAddress=gatewayIPAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSSMTx=auxPortSSMTx, syncETracking=syncETracking, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortAutoMdix=sFPPortAutoMdix, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseTrialPeriod=licenseTrialPeriod, sNTPServerTableEntry=sNTPServerTableEntry, licenseEncryption=licenseEncryption, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, licenseCapacity=licenseCapacity, licenseRARSupport=licenseRARSupport, tdmTableIndex=tdmTableIndex, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseIssueNumber=licenseIssueNumber, channelBandwidth=channelBandwidth, userTableIndex=userTableIndex, licenseVersion=licenseVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, capacityVariantMismatch=capacityVariantMismatch, ethernetPriorityTable=ethernetPriorityTable, auxPortDisabledWarning=auxPortDisabledWarning, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerTimeout=sNTPServerTimeout, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagPair2Results=cableDiagPair2Results, receiveDataRate=receiveDataRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, encryption=encryption, alarms=alarms, tDMChannelLoopback=tDMChannelLoopback, cableDiagPair1Distance=cableDiagPair1Distance, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, auxPortAllocation=auxPortAllocation, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMGroup=tDMGroup, licenseCountry=licenseCountry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receivePower=receivePower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPEnabledMessages=sMTPEnabledMessages, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, dataBridgingAvailability=dataBridgingAvailability, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, secondDataBridgingStatus=secondDataBridgingStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerStatus=sNTPServerStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANManagementVID=vLANManagementVID, sNTPServerTable=sNTPServerTable, siteName=siteName, signalStrengthRatio=signalStrengthRatio, rawReceivePower=rawReceivePower, licenseSFPPortSupport=licenseSFPPortSupport, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, transmitFreqKHz=transmitFreqKHz, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnostics=cableDiagnostics, dfsMeans=dfsMeans, userRole=userRole, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, iPVersion=iPVersion, cableDiagPair1Results=cableDiagPair1Results, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagnosticsWarning=cableDiagnosticsWarning, aAAControl=aAAControl, syslogControl=syslogControl, iPv4Address=iPv4Address, oOBPriorityQueueMapping=oOBPriorityQueueMapping, masterSlaveMode=masterSlaveMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortAllocation=mainPSUPortAllocation, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagnosticsControl=cableDiagnosticsControl, latitude=latitude, licenseIPv6Support=licenseIPv6Support, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sFPPortQLTx=sFPPortQLTx, licenseGroup=licenseGroup, syslogStateTrap=syslogStateTrap, extendedSpectrumScanning=extendedSpectrumScanning, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, versions=versions, mABTransmissionInterval=mABTransmissionInterval, sNTPSync=sNTPSync, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsTableEntry=dfsTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPLastSync=sNTPLastSync, dfsTableIndex=dfsTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfs=dfs, routerProtocols=routerProtocols, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkSymmetry=linkSymmetry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMInterfaceControl=tDMInterfaceControl, mainPSUPortStatusTrap=mainPSUPortStatusTrap, eIRP=eIRP, syncETrackingState=syncETrackingState, tDDControlGroup=tDDControlGroup, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, telnetPortNumber=telnetPortNumber, wirelessLinkStatus=wirelessLinkStatus, hTTPAccessEnabled=hTTPAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dfsGroup=dfsGroup, portAllocationMismatch=portAllocationMismatch, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, hTTPPortNumber=hTTPPortNumber, tdmTableEntry=tdmTableEntry, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair3Results=cableDiagPair3Results, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDMEnabledChannels=tDMEnabledChannels, subbandLowestFrequency=subbandLowestFrequency, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, installArmState=installArmState, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair4Results=cableDiagPair4Results, encryptionGroup=encryptionGroup, frequencyVariant=frequencyVariant, ptmp=ptmp, sFPPortSSMTx=sFPPortSSMTx, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitModulationMode=transmitModulationMode, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortQLRx=sFPPortQLRx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerTableIndex=sNTPServerTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, secureModeAlarmTrap=secureModeAlarmTrap, transmitPower=transmitPower, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, snmpControlGroup=snmpControlGroup, auxPortQLTx=auxPortQLTx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, byteErrorRatio=byteErrorRatio, systemClock=systemClock, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, altitude=altitude, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, maxLinkRangeExceeded=maxLinkRangeExceeded, sNMPCommunityString=sNMPCommunityString, userEnabled=userEnabled, mainPSUPortQLTx=mainPSUPortQLTx, phyControl=phyControl, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cambium=cambium, ptpGroups=ptpGroups, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userPassword=userPassword, sNTPPrimaryServer=sNTPPrimaryServer, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userTableEntry=userTableEntry, ptpTraps=ptpTraps, mABState=mABState, useVLANForMABProtocol=useVLANForMABProtocol, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyStatusGroup=phyStatusGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, smtp=smtp, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPServerRetries=sNTPServerRetries, resetGroup=resetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secureModeAlarm=secureModeAlarm, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortStatusTrap=sFPPortStatusTrap, antennaGain=antennaGain, transmitFreqMHz=transmitFreqMHz, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, licenseSecurityLevel=licenseSecurityLevel, ethernet=ethernet, sNTPState=sNTPState, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syslogControlGroup=syslogControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseSyncESupport=licenseSyncESupport, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, enableTransmission=enableTransmission, sFPPortDisabledWarning=sFPPortDisabledWarning, daylightSaving=daylightSaving, installStatusTrap=installStatusTrap, accessMethod=accessMethod, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, lowestTDMModulationMode=lowestTDMModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTable=l2CPPriorityTable, linkName=linkName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, dataBridgingStatus=dataBridgingStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, mABMaintenanceLevel=mABMaintenanceLevel, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClock=transparentClock, installStatus=installStatus, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortStatus=sFPPortStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABNominalModulationMode=mABNominalModulationMode, tDMChannelCableLength=tDMChannelCableLength, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteInternetAddress=remoteInternetAddress, mainPSUPortStatus=mainPSUPortStatus, dSCPManagementPriority=dSCPManagementPriority, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, rangingMode=rangingMode, transmitDataRate=transmitDataRate, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClockPort=transparentClockPort, tdmTable=tdmTable, nIDULanPortStatus=nIDULanPortStatus, channelChangeTrap=channelChangeTrap, tDM=tDM, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, subbandHighestFrequency=subbandHighestFrequency, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPErrorTrap=sFPErrorTrap, pubStatsGroup=pubStatsGroup, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimization=linkModeOptimization, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortAllocation=sFPPortAllocation)
