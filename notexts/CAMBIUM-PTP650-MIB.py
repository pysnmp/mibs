...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", subbandHighestFrequency=subbandHighestFrequency, sFPErrorTrap=sFPErrorTrap, reset=reset, regulatoryBand=regulatoryBand, portAllocationMismatch=portAllocationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, tdmTableIndex=tdmTableIndex, sNMPv3Enable=sNMPv3Enable, searchState=searchState, transparentClockVLAN=transparentClockVLAN, tDDControl=tDDControl, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetGroup=ethernetGroup, accessMethod=accessMethod, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableDiagPair2Distance=cableDiagPair2Distance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, vectorError=vectorError, rxColorCode=rxColorCode, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, nIDULanPortStatus=nIDULanPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syncETrackingState=syncETrackingState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, routerProtocols=routerProtocols, syslogControl=syslogControl, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userEnabled=userEnabled, licenseMaxLinkRange=licenseMaxLinkRange, daylightSaving=daylightSaving, auxPortQLRx=auxPortQLRx, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, remoteInternetAddressType=remoteInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, byteErrorRatio=byteErrorRatio, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receivePower=receivePower, mainPSUPortAutoMdix=mainPSUPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlave=incompatibleMasterAndSlave, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mABTransmissionInterval=mABTransmissionInterval, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMGroup=tDMGroup, longitude=longitude, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hTTPSAccessEnabled=hTTPSAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseUnitSerialNumber=licenseUnitSerialNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnostics=cableDiagnostics, useVLANForMABProtocol=useVLANForMABProtocol, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseIPv6Support=licenseIPv6Support, targetRange=targetRange, auxPortSSMTx=auxPortSSMTx, licenseGroup=licenseGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, lowestTDMModulationMode=lowestTDMModulationMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPServerTableEntry=sNTPServerTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseGroupAccess=licenseGroupAccess, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tdmTableEntry=tdmTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, userTableEntry=userTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, range=range, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transparentClockPort=transparentClockPort, cableDiagPair2Results=cableDiagPair2Results, transmitChannel=transmitChannel, extendedSpectrumScanning=extendedSpectrumScanning, sFPError=sFPError, transmitModulationMode=transmitModulationMode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sMTPServerPortNumber=sMTPServerPortNumber, auxPortStatus=auxPortStatus, receiveChannel=receiveChannel, supplementary=supplementary, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagPair1Results=cableDiagPair1Results, productName=productName, transmitFreqMHz=transmitFreqMHz, regulatoryBandTrap=regulatoryBandTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortQLTx=sFPPortQLTx, dfsTableNumber=dfsTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, mABNominalModulationMode=mABNominalModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetPriorityTableNumber=ethernetPriorityTableNumber, lowestDataModulationMode=lowestDataModulationMode, sntp=sntp, linkLoss=linkLoss, tDMInterfaceControl=tDMInterfaceControl, telnetAccessEnabled=telnetAccessEnabled, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv6PrefixLength=iPv6PrefixLength, sFPPortSyncERxStatus=sFPPortSyncERxStatus, linkName=linkName, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair4Results=cableDiagPair4Results, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, hardwareVersion=hardwareVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseIssueNumber=licenseIssueNumber, licenseIEEE1588Support=licenseIEEE1588Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortSSMTx=sFPPortSSMTx, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernet=ethernet, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, cableDiagPair4Distance=cableDiagPair4Distance, auxPortStatusTrap=auxPortStatusTrap, userTable=userTable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, lowestSecondDataModulationMode=lowestSecondDataModulationMode, managementGroup=managementGroup, groupID=groupID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, smtp=smtp, iPv6GatewayAddress=iPv6GatewayAddress, licenseVersion=licenseVersion, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mainPSUPortStatus=mainPSUPortStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, channelBandwidth=channelBandwidth, linkModeOptimization=linkModeOptimization, auxPortConfigurationMismatch=auxPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarms=alarms, sFPPortDisabledWarning=sFPPortDisabledWarning, localPacketFiltering=localPacketFiltering, sNTPServerStatus=sNTPServerStatus, softwareVersion=softwareVersion, hTTPPortNumber=hTTPPortNumber, encryptionAlgorithm=encryptionAlgorithm, systemReset=systemReset, aAAControl=aAAControl, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, ethernetPriorityTable=ethernetPriorityTable, mABHoldoffPeriod=mABHoldoffPeriod, licenseCountry=licenseCountry, encryption=encryption, sNTPServerRetries=sNTPServerRetries, auxPortDisabledWarning=auxPortDisabledWarning, mABProtocolVID=mABProtocolVID, mABState=mABState, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnosticsControl=cableDiagnosticsControl, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, oOBPriorityQueueMapping=oOBPriorityQueueMapping, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, license=license, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unitOutOfCalibration=unitOutOfCalibration, sFPPortStatus=sFPPortStatus, installArmState=installArmState, altitude=altitude, userName=userName, iPv4Address=iPv4Address, syslogControlGroup=syslogControlGroup, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, sNTPPrimaryServer=sNTPPrimaryServer, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDM=tDM, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortAllocation=auxPortAllocation, timeZone=timeZone, signalStrengthRatio=signalStrengthRatio, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMEnabledChannels=tDMEnabledChannels, enableTransmission=enableTransmission, tDMChannelCableLength=tDMChannelCableLength, latitude=latitude, licenseEncryption=licenseEncryption, tDMChannelStatus=tDMChannelStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, txColorCode=txColorCode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, l2CPPriorityTable=l2CPPriorityTable, syslogClient=syslogClient, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transparentClock=transparentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMChannelLoopback=tDMChannelLoopback, hTTPSPortNumber=hTTPSPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsMeans=dfsMeans, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortAllocation=sFPPortAllocation, cableDiagPair3Results=cableDiagPair3Results, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyStatus=phyStatus, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, cableDiagPair3Distance=cableDiagPair3Distance, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerTable=sNTPServerTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, bootVersion=bootVersion, secureModeAlarm=secureModeAlarm, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPSyncTrap=sNTPSyncTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsPeaks=dfsPeaks, phyStatusGroup=phyStatusGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, rangingMode=rangingMode, iPv6Address=iPv6Address, encryptionGroup=encryptionGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortAllocation=mainPSUPortAllocation, licenseBandwidthCap=licenseBandwidthCap, siteName=siteName, sNMPPortNumber=sNMPPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, userRole=userRole, capacityVariantMismatchTrap=capacityVariantMismatchTrap, phyControlGroup=phyControlGroup, secondDataBridgingStatus=secondDataBridgingStatus, licenseTrialPeriod=licenseTrialPeriod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dSCPManagementPriority=dSCPManagementPriority, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, installArmStateTrap=installArmStateTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ptp=ptp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transparentClockVID=transparentClockVID, dfs=dfs, supplementaryGroup=supplementaryGroup, mABMaintenanceLevel=mABMaintenanceLevel, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortQLRx=sFPPortQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortSyncERxStatus=auxPortSyncERxStatus, capacityVariantMismatch=capacityVariantMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseSecurityLevel=licenseSecurityLevel, sNTPSync=sNTPSync, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, subnetMask=subnetMask, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortQLTx=auxPortQLTx, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp650=ptp650, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, dataPortPauseFrames=dataPortPauseFrames, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, channelChangeTrap=channelChangeTrap, bridge=bridge, dfsTable=dfsTable, pubStats=pubStats, licenseCapacity=licenseCapacity, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRARSupport=licenseRARSupport, licenseTDDSyncSupport=licenseTDDSyncSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rawReceivePower=rawReceivePower, syslogState=syslogState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, eIRP=eIRP, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitPower=transmitPower, masterSlaveMode=masterSlaveMode, txMABFrames=txMABFrames, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusTrap=installStatusTrap, versionsGroup=versionsGroup, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPPollInterval=sNTPPollInterval, cambium=cambium, sNMPTrapTable=sNMPTrapTable, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, snmpControl=snmpControl, versions=versions, subbandLowestFrequency=subbandLowestFrequency, sNMPEnabledTraps=sNMPEnabledTraps, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, alarmsGroup=alarmsGroup, systemClock=systemClock, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, tdmTable=tdmTable, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTableIndex=sNMPTrapTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, tdmTableNumber=tdmTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, routerProtocolsGroup=routerProtocolsGroup, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, configurationGroup=configurationGroup, licenseSyncESupport=licenseSyncESupport, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userPassword=userPassword, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPLastSync=sNTPLastSync, tDMInterfaceStatus=tDMInterfaceStatus, userTableNumber=userTableNumber, bridgeGroup=bridgeGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, aAAControlGroup=aAAControlGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, receiveFreqMHz=receiveFreqMHz, sNTPServerTableIndex=sNTPServerTableIndex, dataBridgingStatus=dataBridgingStatus, telnetPortNumber=telnetPortNumber, installStatus=installStatus, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapTableNumber=sNMPTrapTableNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, management=management, cableDiagPair1Distance=cableDiagPair1Distance)
