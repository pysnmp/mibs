...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPEnabledTraps=sNMPEnabledTraps, useVLANForMABProtocol=useVLANForMABProtocol, ethernet=ethernet, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, softwareVersion=softwareVersion, licenseUnitSerialNumber=licenseUnitSerialNumber, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, subnetMask=subnetMask, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair4Distance=cableDiagPair4Distance, cambium=cambium, systemReset=systemReset, transmitFreqMHz=transmitFreqMHz, auxPortSyncERxStatus=auxPortSyncERxStatus, lowestTDMModulationMode=lowestTDMModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp650=ptp650, receiveDataRate=receiveDataRate, iPv6Address=iPv6Address, lowestDataModulationMode=lowestDataModulationMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptpGroups=ptpGroups, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, bridge=bridge, tDMChannelStatus=tDMChannelStatus, cableDiagnosticsControl=cableDiagnosticsControl, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, receiveChannel=receiveChannel, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, longitude=longitude, licenseRegulatoryBandsList=licenseRegulatoryBandsList, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, supplementaryGroup=supplementaryGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, aAAControl=aAAControl, capacityVariantMismatch=capacityVariantMismatch, transmitModulationMode=transmitModulationMode, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseCapacity=licenseCapacity, transmitChannel=transmitChannel, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, installArmState=installArmState, transparentClock=transparentClock, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortStatus=auxPortStatus, ptpTrapPrefix=ptpTrapPrefix, userPassword=userPassword, regulatoryBandTrap=regulatoryBandTrap, wirelessLinkStatus=wirelessLinkStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sNTPPollInterval=sNTPPollInterval, configuration=configuration, routerProtocolsGroup=routerProtocolsGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseCountry=licenseCountry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondDataPortPauseFrames=secondDataPortPauseFrames, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDM=tDM, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, snmpControlGroup=snmpControlGroup, remoteInternetAddressType=remoteInternetAddressType, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortQLTx=mainPSUPortQLTx, ptpCompliance=ptpCompliance, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortStatus=nIDULanPortStatus, receiveFreqKHz=receiveFreqKHz, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseGroupAccess=licenseGroupAccess, lowestSecondDataModulationMode=lowestSecondDataModulationMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, ethernetGroup=ethernetGroup, sNTPServerTimeout=sNTPServerTimeout, tDMChannelLoopback=tDMChannelLoopback, transmitFreqKHz=transmitFreqKHz, syslogStateTrap=syslogStateTrap, secureModeAlarm=secureModeAlarm, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsMeans=dfsMeans, sNTPServerTable=sNTPServerTable, auxPortStatusTrap=auxPortStatusTrap, linkSymmetry=linkSymmetry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, license=license, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode, mainPSUPortAllocation=mainPSUPortAllocation, sntp=sntp, licenseRARSupport=licenseRARSupport, licenseBandwidthCap=licenseBandwidthCap, encryption=encryption, regulatoryBand=regulatoryBand, receiveFreqMHz=receiveFreqMHz, siteName=siteName, receivePower=receivePower, latitude=latitude, mABTransmissionInterval=mABTransmissionInterval, userTableIndex=userTableIndex, auxPortQLRx=auxPortQLRx, accessMethod=accessMethod, tdmTableEntry=tdmTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tdmTableIndex=tdmTableIndex, licenseTDDSyncSupport=licenseTDDSyncSupport, enableTransmission=enableTransmission, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, subbandLowestFrequency=subbandLowestFrequency, transparentClockPort=transparentClockPort, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortDisabledWarning=auxPortDisabledWarning, versions=versions, iPVersion=iPVersion, dfsTable=dfsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMChannelCableLength=tDMChannelCableLength, tDMInterfaceStatus=tDMInterfaceStatus, hTTPAccessEnabled=hTTPAccessEnabled, smtpGroup=smtpGroup, sFPPortQLRx=sFPPortQLRx, mainPSUPortSSMTx=mainPSUPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, portAllocationMismatch=portAllocationMismatch, sFPError=sFPError, txColorCode=txColorCode, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMConfigurationMismatch=tDMConfigurationMismatch, hardwareVersion=hardwareVersion, sNMPTrapTable=sNMPTrapTable, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, auxPortSSMTx=auxPortSSMTx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, rangingMode=rangingMode, supplementary=supplementary, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMInterfaceControl=tDMInterfaceControl, cableDiagPair3Results=cableDiagPair3Results, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseGroup=licenseGroup, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, managementGroup=managementGroup, ptmp=ptmp, syslogControl=syslogControl, mABProtocolVLANPriority=mABProtocolVLANPriority, phyControl=phyControl, tdmTableNumber=tdmTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userRole=userRole, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagPair1Distance=cableDiagPair1Distance, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, tDDControlGroup=tDDControlGroup, mABHoldoffPeriod=mABHoldoffPeriod, sNTPServerRetries=sNTPServerRetries, bridgeGroup=bridgeGroup, transparentClockVID=transparentClockVID, cableDiagPair2Distance=cableDiagPair2Distance, extendedSpectrumScanning=extendedSpectrumScanning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortStatus=mainPSUPortStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, tDDSynchronizationMode=tDDSynchronizationMode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, management=management, sFPPortQLTx=sFPPortQLTx, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPCommunityString=sNMPCommunityString, licenseSyncESupport=licenseSyncESupport, tDMChannelLineCode=tDMChannelLineCode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, productName=productName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, maximumTransmitPower=maximumTransmitPower, notificationsGroup=notificationsGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, iPv6PrefixLength=iPv6PrefixLength, remoteInternetAddress=remoteInternetAddress, tFTPServerPortNumber=tFTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", userTable=userTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpTraps=ptpTraps, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, pubStats=pubStats, channelChangeTrap=channelChangeTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, altitude=altitude, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, sFPPortStatus=sFPPortStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkModeOptimization=linkModeOptimization, installArmStateTrap=installArmStateTrap, sNTPServerTableNumber=sNTPServerTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, secureModeAlarmTrap=secureModeAlarmTrap, transparentClockVLAN=transparentClockVLAN, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, pubStatsGroup=pubStatsGroup, licenseIssueNumber=licenseIssueNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp=ptp, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, installStatus=installStatus, phyStatus=phyStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, txMABFrames=txMABFrames, installStatusTrap=installStatusTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, localPacketFiltering=localPacketFiltering, receiveModulationModeDetail=receiveModulationModeDetail, mABProtocolVID=mABProtocolVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsGroup=dfsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, maxLinkRangeExceeded=maxLinkRangeExceeded, userTableNumber=userTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortQLTx=auxPortQLTx, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, portAllocationMismatchTrap=portAllocationMismatchTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dataBridgingStatus=dataBridgingStatus, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair3Distance=cableDiagPair3Distance, cableDiagPair4Results=cableDiagPair4Results, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseSFPPortSupport=licenseSFPPortSupport, rawReceivePower=rawReceivePower, dfsTableNumber=dfsTableNumber, productVariant=productVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPState=sNTPState, syslogState=syslogState, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveModulationMode=receiveModulationMode, sFPPortAllocation=sFPPortAllocation, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mABState=mABState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortQLRx=mainPSUPortQLRx, sFPErrorTrap=sFPErrorTrap, dfs=dfs, syslogControlGroup=syslogControlGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transmitDataRate=transmitDataRate, tdmTable=tdmTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, l2CPPriorityTable=l2CPPriorityTable, snmpControl=snmpControl, iPv4Address=iPv4Address, vLANManagementPriority=vLANManagementPriority, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dataPortPauseFrames=dataPortPauseFrames, searchState=searchState, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionGroup=encryptionGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnostics=cableDiagnostics, licenseMaxLinkRange=licenseMaxLinkRange, tDMGroup=tDMGroup, licenseIEEE1588Support=licenseIEEE1588Support, tDDControl=tDDControl, mABMaintenanceLevel=mABMaintenanceLevel, channelBandwidth=channelBandwidth, dataBridgingAvailability=dataBridgingAvailability, syncETrackingState=syncETrackingState, transmitPower=transmitPower, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sFPPortAutoMdix=sFPPortAutoMdix, licenseTrialPeriod=licenseTrialPeriod, eIRP=eIRP, linkName=linkName, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagPair1Results=cableDiagPair1Results, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vectorError=vectorError, bootVersion=bootVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxColorCode=rxColorCode, vLANManagementVID=vLANManagementVID, resetGroup=resetGroup, secondDataBridgingStatus=secondDataBridgingStatus, aAAControlGroup=aAAControlGroup, tDMEnabledChannels=tDMEnabledChannels, sNTPServerTableEntry=sNTPServerTableEntry, auxPortAllocation=auxPortAllocation, targetRange=targetRange, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControlGroup=phyControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABNominalModulationMode=mABNominalModulationMode, licenseVersion=licenseVersion, sMTPEmailAlert=sMTPEmailAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemClock=systemClock, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, smtp=smtp, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableIndex=sNTPServerTableIndex, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syncETracking=syncETracking, reset=reset, syncEEquipmentClock=syncEEquipmentClock, routerProtocols=routerProtocols, managementNetworkAccessEnabled=managementNetworkAccessEnabled, aggregateDataRate=aggregateDataRate, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerStatus=sNTPServerStatus, licenseEncryption=licenseEncryption, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, alarmsGroup=alarmsGroup)
