...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", frequencyVariant=frequencyVariant, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMEnabledChannels=tDMEnabledChannels, sNTPServerPortNumber=sNTPServerPortNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mABProtocolVID=mABProtocolVID, tDDSynchronizationMode=tDDSynchronizationMode, licenseSecurityLevel=licenseSecurityLevel, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegulatoryBands=incompatibleRegulatoryBands, aAAControl=aAAControl, mABMaintenanceLevel=mABMaintenanceLevel, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDM=tDM, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortPauseFrames=dataPortPauseFrames, lowestSecondDataModulationMode=lowestSecondDataModulationMode, iPv6PrefixLength=iPv6PrefixLength, sFPPortStatus=sFPPortStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, snmpControlGroup=snmpControlGroup, receiveFreqKHz=receiveFreqKHz, sNTPSync=sNTPSync, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntpGroup=sntpGroup, siteName=siteName, sNTPState=sNTPState, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableLoss=cableLoss, rawReceivePower=rawReceivePower, sFPPortDisabledWarning=sFPPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regulatoryBand=regulatoryBand, receiveDataRate=receiveDataRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, licenseIPv6Support=licenseIPv6Support, tDMConfigurationMismatch=tDMConfigurationMismatch, userRole=userRole, installStatus=installStatus, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, sNTPPrimaryServer=sNTPPrimaryServer, channelChangeTrap=channelChangeTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABNominalModulationMode=mABNominalModulationMode, sFPPortQLRx=sFPPortQLRx, ptp650=ptp650, receiveModulationModeDetail=receiveModulationModeDetail, userTableNumber=userTableNumber, tdmTableNumber=tdmTableNumber, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, encryptionGroup=encryptionGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPVersion=iPVersion, auxPortSyncERxStatus=auxPortSyncERxStatus, sNTPServerTableIndex=sNTPServerTableIndex, syslogStateTrap=syslogStateTrap, transmitModulationMode=transmitModulationMode, portAllocationMismatch=portAllocationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitDataRate=transmitDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, sNTPServerTableEntry=sNTPServerTableEntry, phyStatus=phyStatus, secureModeAlarm=secureModeAlarm, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortQLRx=mainPSUPortQLRx, sNTPPollInterval=sNTPPollInterval, latitude=latitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryption=encryption, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, reset=reset, licenseRARSupport=licenseRARSupport, smtpGroup=smtpGroup, dfs=dfs, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, remoteInternetAddress=remoteInternetAddress, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hardwareVersion=hardwareVersion, tdmTableEntry=tdmTableEntry, sntp=sntp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ptp=ptp, iPv4Address=iPv4Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, management=management, syslogState=syslogState, dataBridgingStatus=dataBridgingStatus, ptpCompliance=ptpCompliance, versions=versions, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair1Results=cableDiagPair1Results, targetRange=targetRange, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, daylightSaving=daylightSaving, licenseVersion=licenseVersion, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair2Results=cableDiagPair2Results, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, altitude=altitude, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, hTTPPortNumber=hTTPPortNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortStatusTrap=auxPortStatusTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, auxPortDisabledWarning=auxPortDisabledWarning, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, rxColorCode=rxColorCode, licenseCapacity=licenseCapacity, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClientTrap=syslogClientTrap, receiveChannel=receiveChannel, sNMPEnabledTraps=sNMPEnabledTraps, syslogControl=syslogControl, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, alarmsGroup=alarmsGroup, sNTPServerTimeout=sNTPServerTimeout, ptpTrapPrefix=ptpTrapPrefix, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, alarms=alarms, auxPortAllocation=auxPortAllocation, tDDControl=tDDControl, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, licenseBandwidthCap=licenseBandwidthCap, transparentClockPort=transparentClockPort, transparentClockVID=transparentClockVID, sNMPTrapPortNumber=sNMPTrapPortNumber, secondDataBridgingStatus=secondDataBridgingStatus, ethernetPriorityTable=ethernetPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, licenseIEEE1588Support=licenseIEEE1588Support, sNTPServerTableNumber=sNTPServerTableNumber, licenseIssueNumber=licenseIssueNumber, targetMACAddress=targetMACAddress, tDMChannelCableLength=tDMChannelCableLength, rangingMode=rangingMode, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, byteErrorRatio=byteErrorRatio, bootVersion=bootVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseCountry=licenseCountry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, phyStatusGroup=phyStatusGroup, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, cableDiagPair2Distance=cableDiagPair2Distance, iPv6Address=iPv6Address, transmitFreqMHz=transmitFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnostics=cableDiagnostics, auxPortQLTx=auxPortQLTx, licenseEncryption=licenseEncryption, cableDiagPair3Distance=cableDiagPair3Distance, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, linkLoss=linkLoss, installStatusTrap=installStatusTrap, systemReset=systemReset, managementGroup=managementGroup, linkName=linkName, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, licenseTrialPeriod=licenseTrialPeriod, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, receiveModulationMode=receiveModulationMode, sFPError=sFPError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnosticsGroup=cableDiagnosticsGroup, ptmp=ptmp, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, localPacketFiltering=localPacketFiltering, groupID=groupID, sFPPortSyncERxStatus=sFPPortSyncERxStatus, routerProtocols=routerProtocols, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortSSMTx=auxPortSSMTx, mABState=mABState, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, qOSPriorityScheme=qOSPriorityScheme, auxPortQLRx=auxPortQLRx, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, license=license, mABTransmissionInterval=mABTransmissionInterval, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, licenseGroupAccess=licenseGroupAccess)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClock=transparentClock, linkModeOptimization=linkModeOptimization, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, antennaGain=antennaGain, tdmTable=tdmTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, syncETrackingState=syncETrackingState, timeZone=timeZone, pubStats=pubStats, bridge=bridge, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, secondDataPortPauseFrames=secondDataPortPauseFrames, sNMPv3Enable=sNMPv3Enable, sFPPortAllocation=sFPPortAllocation, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userTableIndex=userTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, iPv6GatewayAddress=iPv6GatewayAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, syncETracking=syncETracking, sFPErrorTrap=sFPErrorTrap, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, sNMPCommunityString=sNMPCommunityString, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTable=sNTPServerTable, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagPair1Distance=cableDiagPair1Distance, ethernet=ethernet, productName=productName, licenseSFPPortSupport=licenseSFPPortSupport, eIRP=eIRP, dfsTableIndex=dfsTableIndex, configuration=configuration, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagPair4Results=cableDiagPair4Results, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, subbandLowestFrequency=subbandLowestFrequency, dataBridgingAvailability=dataBridgingAvailability, enableTransmission=enableTransmission, transmitPower=transmitPower, dfsTableEntry=dfsTableEntry, cambium=cambium, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, useVLANForMABProtocol=useVLANForMABProtocol, licenseGroup=licenseGroup, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, tDMInterfaceControl=tDMInterfaceControl, supplementaryGroup=supplementaryGroup, cableDiagPair3Results=cableDiagPair3Results, tDMChannelStatus=tDMChannelStatus, regulatoryBandTrap=regulatoryBandTrap, lowestDataModulationMode=lowestDataModulationMode, smtp=smtp, supplementary=supplementary, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, productVariant=productVariant, wirelessLinkStatus=wirelessLinkStatus, txMABFrames=txMABFrames, userTable=userTable, resetGroup=resetGroup, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tdmTableIndex=tdmTableIndex, receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseMaxLinkRange=licenseMaxLinkRange, aAAControlGroup=aAAControlGroup, txColorCode=txColorCode, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, bridgeGroup=bridgeGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, extendedSpectrumScanning=extendedSpectrumScanning, linkSymmetry=linkSymmetry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClockVLAN=transparentClockVLAN, sMTPEmailAlert=sMTPEmailAlert, tDMInterfaceStatus=tDMInterfaceStatus, sNTPSyncTrap=sNTPSyncTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTable=dfsTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, accessMethod=accessMethod, capacityVariantMismatch=capacityVariantMismatch, range=range, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, installArmState=installArmState, dSCPManagementPriority=dSCPManagementPriority, transmitChannel=transmitChannel, searchState=searchState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseSyncESupport=licenseSyncESupport, ptpGroups=ptpGroups, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, routerProtocolsGroup=routerProtocolsGroup, dfsPeaks=dfsPeaks, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementVID=vLANManagementVID, lowestTDMModulationMode=lowestTDMModulationMode, auxPortStatus=auxPortStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, longitude=longitude, userPassword=userPassword, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, remoteInternetAddressType=remoteInternetAddressType, cableDiagnosticsPorts=cableDiagnosticsPorts, tDDControlGroup=tDDControlGroup, sNTPServerRetries=sNTPServerRetries, ethernetGroup=ethernetGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDMGroup=tDMGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABProtocolVLANPriority=mABProtocolVLANPriority, snmpControl=snmpControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
