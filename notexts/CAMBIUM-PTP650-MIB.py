...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, userTableIndex=userTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, tDDSynchronizationStatus=tDDSynchronizationStatus, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, timeZone=timeZone, cableDiagPair2Distance=cableDiagPair2Distance, hTTPSPortNumber=hTTPSPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, reset=reset, licenseRARSupport=licenseRARSupport, syslogState=syslogState, auxPortQLRx=auxPortQLRx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transmitDataRate=transmitDataRate, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerTableEntry=sNTPServerTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTable=sNMPTrapTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortStatus=sFPPortStatus, telnetPortNumber=telnetPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogLocalWrappedTrap=syslogLocalWrappedTrap, lowestTDMModulationMode=lowestTDMModulationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, mABNominalModulationMode=mABNominalModulationMode, licenseTDDSyncSupport=licenseTDDSyncSupport, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetGroup=ethernetGroup, auxPortAllocation=auxPortAllocation, auxPortStatus=auxPortStatus, frequencyVariant=frequencyVariant, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, vLANManagementVID=vLANManagementVID, sFPPortQLRx=sFPPortQLRx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, siteName=siteName, supplementaryGroup=supplementaryGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableIndex=dfsTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, tdmTableIndex=tdmTableIndex, regulatoryBand=regulatoryBand, tDMInterfaceControl=tDMInterfaceControl, altitude=altitude, useVLANForMABProtocol=useVLANForMABProtocol, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockPort=transparentClockPort, systemClock=systemClock, ptp650=ptp650, dfsMeans=dfsMeans, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagPair3Results=cableDiagPair3Results, rangingMode=rangingMode, alarms=alarms, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, maximumTransmitPower=maximumTransmitPower, licenseGroupAccess=licenseGroupAccess, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, licenseMaxLinkRange=licenseMaxLinkRange, userRole=userRole, cableDiagPair2Results=cableDiagPair2Results, syncETracking=syncETracking, maxLinkRangeExceeded=maxLinkRangeExceeded, range=range, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, byteErrorRatio=byteErrorRatio, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, sntpGroup=sntpGroup, sFPPortStatusTrap=sFPPortStatusTrap, ptmp=ptmp, pubStatsGroup=pubStatsGroup, transparentClock=transparentClock, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syncETrackingState=syncETrackingState, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortStatus=mainPSUPortStatus, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseSecurityLevel=licenseSecurityLevel, versions=versions, bootVersion=bootVersion, licenseBandwidthCap=licenseBandwidthCap, userTable=userTable, transmitFreqKHz=transmitFreqKHz, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPv6GatewayAddress=iPv6GatewayAddress, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, userTableNumber=userTableNumber, tDDControl=tDDControl, sNTPServerTableIndex=sNTPServerTableIndex, unitOutOfCalibration=unitOutOfCalibration, sFPPortDisabledWarning=sFPPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, eIRP=eIRP, sNTPServerTable=sNTPServerTable, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, bridgeGroup=bridgeGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, daylightSaving=daylightSaving, ptpTraps=ptpTraps, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rxColorCode=rxColorCode, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIPv6Support=licenseIPv6Support, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPVersion=iPVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dfsPeaks=dfsPeaks, groupID=groupID, sNMPv3Enable=sNMPv3Enable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, configuration=configuration, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerRetries=sNTPServerRetries, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPv4Address=iPv4Address, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sFPPortAllocation=sFPPortAllocation, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseIEEE1588Support=licenseIEEE1588Support, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, management=management, sFPPortSSMTx=sFPPortSSMTx, installArmState=installArmState, cableDiagPair3Distance=cableDiagPair3Distance, tdmTableNumber=tdmTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, license=license, dfsTableNumber=dfsTableNumber, mABState=mABState, userTableEntry=userTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, targetRange=targetRange, productVariant=productVariant, syslogControlGroup=syslogControlGroup, enableTransmission=enableTransmission, dfsTableEntry=dfsTableEntry, supplementary=supplementary, licenseSFPPortSupport=licenseSFPPortSupport, vLANManagementPriority=vLANManagementPriority, syncEEquipmentClock=syncEEquipmentClock, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, channelBandwidth=channelBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, syslogStateTrap=syslogStateTrap, subbandHighestFrequency=subbandHighestFrequency, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpGroups=ptpGroups, hardwareVersion=hardwareVersion, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, cableLoss=cableLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerStatus=sNTPServerStatus, auxPortStatusTrap=auxPortStatusTrap, sNTPState=sNTPState, telnetAccessEnabled=telnetAccessEnabled, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, accessMethod=accessMethod, dataBridgingStatus=dataBridgingStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, notificationsGroup=notificationsGroup, dfs=dfs, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMGroup=tDMGroup, userName=userName, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseCountry=licenseCountry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyStatus=phyStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, transparentClockVLAN=transparentClockVLAN, receiveFreqKHz=receiveFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, linkName=linkName, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseIssueNumber=licenseIssueNumber, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair4Results=cableDiagPair4Results, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, encryption=encryption, gatewayIPAddress=gatewayIPAddress, mABMaintenanceLevel=mABMaintenanceLevel, sNTPPrimaryServer=sNTPPrimaryServer, localPacketFiltering=localPacketFiltering, remoteInternetAddress=remoteInternetAddress, transmitFreqMHz=transmitFreqMHz)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", cableDiagPair1Results=cableDiagPair1Results, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dfsTable=dfsTable, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, masterSlaveMode=masterSlaveMode, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapPortNumber=sNMPTrapPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNTPLastSync=sNTPLastSync, txColorCode=txColorCode, mainPSUPortAllocation=mainPSUPortAllocation, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aAAControl=aAAControl, licenseVersion=licenseVersion, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transparentClockVID=transparentClockVID, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTable=mPLSTCPriorityTable, configurationGroup=configurationGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, targetMACAddress=targetMACAddress, pubStats=pubStats, sNTPServerTimeout=sNTPServerTimeout, mABHoldoffPeriod=mABHoldoffPeriod, dfsGroup=dfsGroup, mABProtocolVID=mABProtocolVID, PYSNMP_MODULE_ID=cambium, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, capacityVariantMismatch=capacityVariantMismatch, ptp=ptp, dataPortPauseFrames=dataPortPauseFrames, qOSPriorityScheme=qOSPriorityScheme, cableDiagPair1Distance=cableDiagPair1Distance, secureModeAlarm=secureModeAlarm, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secondarySoftwareVersion=secondarySoftwareVersion, sFPErrorTrap=sFPErrorTrap, receiveChannel=receiveChannel, userPassword=userPassword, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABProtocolVLANPriority=mABProtocolVLANPriority, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnostics=cableDiagnostics, sNTPSync=sNTPSync, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, regulatoryBandTrap=regulatoryBandTrap, tDMChannelLoopback=tDMChannelLoopback, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, licenseEncryption=licenseEncryption, syslogClient=syslogClient, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, secondDataBridgingStatus=secondDataBridgingStatus, tdmTable=tdmTable, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseTrialPeriod=licenseTrialPeriod, syslogControl=syslogControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingAvailability=dataBridgingAvailability, auxPortQLTx=auxPortQLTx, syslogClientTrap=syslogClientTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, linkModeOptimization=linkModeOptimization, sNTPServerTableNumber=sNTPServerTableNumber, installArmStateTrap=installArmStateTrap, subnetMask=subnetMask, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, phyControlGroup=phyControlGroup, auxPortSSMTx=auxPortSSMTx, sNTPServerPortNumber=sNTPServerPortNumber, tDMChannelLineCode=tDMChannelLineCode, licenseSyncESupport=licenseSyncESupport, linkLoss=linkLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sntp=sntp, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, routerProtocols=routerProtocols, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMEnabledChannels=tDMEnabledChannels, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, smtp=smtp, bridge=bridge, installStatus=installStatus, versionsGroup=versionsGroup, tdmTableEntry=tdmTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagPair4Distance=cableDiagPair4Distance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, longitude=longitude, vectorError=vectorError, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, latitude=latitude, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, portAllocationMismatch=portAllocationMismatch, antennaGain=antennaGain, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, extendedSpectrumScanning=extendedSpectrumScanning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDM=tDM, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortQLTx=sFPPortQLTx, txMABFrames=txMABFrames, secondDataPortPauseFrames=secondDataPortPauseFrames, smtpGroup=smtpGroup, cambium=cambium, sNTPSyncTrap=sNTPSyncTrap, productName=productName, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMChannelStatus=tDMChannelStatus, sFPError=sFPError, licenseCapacity=licenseCapacity, receivePower=receivePower, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitChannel=transmitChannel, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, installStatusTrap=installStatusTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityTable=ethernetPriorityTable, rawReceivePower=rawReceivePower, lowestDataModulationMode=lowestDataModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, mainPSUPortSSMTx=mainPSUPortSSMTx, iPv6Address=iPv6Address, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, routerProtocolsGroup=routerProtocolsGroup, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseGroup=licenseGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControlGroup=snmpControlGroup, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortQLRx=mainPSUPortQLRx, tDDSynchronizationAlarm=tDDSynchronizationAlarm)
