...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNTPSync=sNTPSync, versions=versions, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, iPv6GatewayAddress=iPv6GatewayAddress, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortQLRx=sFPPortQLRx, daylightSaving=daylightSaving, tDMChannelCableLength=tDMChannelCableLength, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABProtocolVID=mABProtocolVID, licenseIPv6Support=licenseIPv6Support, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, transparentClockPort=transparentClockPort, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseRegulatoryBandsList=licenseRegulatoryBandsList, receiveModulationModeDetail=receiveModulationModeDetail, supplementary=supplementary, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerRetries=sNTPServerRetries, iPv4Address=iPv4Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClient=syslogClient, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, aAAControl=aAAControl, sNMPTrapTable=sNMPTrapTable, sFPPortStatusTrap=sFPPortStatusTrap, smtp=smtp, sNMPTrapInternetAddress=sNMPTrapInternetAddress, enableTransmission=enableTransmission, mainPSUPortQLRx=mainPSUPortQLRx, installStatusTrap=installStatusTrap, cableDiagPair4Results=cableDiagPair4Results, receiveModulationMode=receiveModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, sntpGroup=sntpGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMEnabledChannels=tDMEnabledChannels, tDMChannelLineCode=tDMChannelLineCode, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPPortNumber=sNMPPortNumber, localPacketFiltering=localPacketFiltering, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, mABProtocolVLANPriority=mABProtocolVLANPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, accessMethod=accessMethod, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTable=sNTPServerTable, configuration=configuration, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rxColorCode=rxColorCode, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, syslogState=syslogState, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPCommunityString=sNMPCommunityString, transparentClock=transparentClock, ptp=ptp, cableDiagPair2Results=cableDiagPair2Results, phyStatusGroup=phyStatusGroup, searchState=searchState, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, timeZone=timeZone, transmitChannel=transmitChannel, cableDiagPair3Results=cableDiagPair3Results, sFPPortStatus=sFPPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, resetGroup=resetGroup, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetPriorityTable=ethernetPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, maximumTransmitPower=maximumTransmitPower, sFPPortAllocation=sFPPortAllocation, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, subbandHighestFrequency=subbandHighestFrequency, auxPortQLRx=auxPortQLRx, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dataBridgingStatus=dataBridgingStatus, ethernet=ethernet, snmpControl=snmpControl, sNMPTrapPortNumber=sNMPTrapPortNumber, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqKHz=receiveFreqKHz, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, alarmsGroup=alarmsGroup, auxPortSSMTx=auxPortSSMTx, channelChangeTrap=channelChangeTrap, channelBandwidth=channelBandwidth, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNMPv3Enable=sNMPv3Enable, sFPError=sFPError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, targetRange=targetRange, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, phyControl=phyControl, auxPortQLTx=auxPortQLTx, licenseGroupAccess=licenseGroupAccess, remoteInternetAddressType=remoteInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, siteName=siteName, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secondDataBridgingStatus=secondDataBridgingStatus, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tdmTableNumber=tdmTableNumber, sNTPState=sNTPState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, rangingMode=rangingMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABTransmissionInterval=mABTransmissionInterval, subnetMask=subnetMask, remoteInternetAddress=remoteInternetAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, regulatoryBand=regulatoryBand, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABState=mABState, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair3Distance=cableDiagPair3Distance, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, userRole=userRole, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, syncEEquipmentClock=syncEEquipmentClock, mainPSUPortStatus=mainPSUPortStatus, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnostics=cableDiagnostics, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, bridgeGroup=bridgeGroup, licenseEncryption=licenseEncryption, secureModeAlarm=secureModeAlarm, tdmTableIndex=tdmTableIndex, licenseBandwidthCap=licenseBandwidthCap, sFPErrorTrap=sFPErrorTrap, licenseCountry=licenseCountry, rawReceivePower=rawReceivePower, tDMChannelLoopback=tDMChannelLoopback, cableDiagPair1Results=cableDiagPair1Results, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfs=dfs, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, vLANManagementVID=vLANManagementVID, ethernetGroup=ethernetGroup, managementGroup=managementGroup, tFTPServerPortNumber=tFTPServerPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, extendedSpectrumScanning=extendedSpectrumScanning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, systemReset=systemReset, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortStatus=nIDULanPortStatus, installArmState=installArmState, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableEntry=dfsTableEntry, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPv6Address=iPv6Address, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimization=linkModeOptimization, cableLoss=cableLoss, tDMInterfaceControl=tDMInterfaceControl, transmitPower=transmitPower, vectorError=vectorError, sNTPServerStatus=sNTPServerStatus, licenseGroup=licenseGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagnosticsControl=cableDiagnosticsControl, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkName=linkName, regulatoryBandTrap=regulatoryBandTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortDisabledWarning=auxPortDisabledWarning, bootVersion=bootVersion, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, tDDControl=tDDControl, useVLANForMABProtocol=useVLANForMABProtocol, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, bridge=bridge, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sMTPServerInternetAddress=sMTPServerInternetAddress, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagPair4Distance=cableDiagPair4Distance, routerProtocolsGroup=routerProtocolsGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMConfigurationMismatch=tDMConfigurationMismatch, groupID=groupID, sNTPServerInternetAddress=sNTPServerInternetAddress, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, reset=reset, txColorCode=txColorCode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataBridgingAvailability=dataBridgingAvailability, dfsTable=dfsTable, l2CPPriorityTable=l2CPPriorityTable, licenseSyncESupport=licenseSyncESupport, dfsTableNumber=dfsTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, sNTPServerTableIndex=sNTPServerTableIndex, receiveDataRate=receiveDataRate, licenseOOBManagementSupport=licenseOOBManagementSupport, dfsMeans=dfsMeans, tDMInterfaceStatus=tDMInterfaceStatus, encryption=encryption, licenseIEEE1588Support=licenseIEEE1588Support, tDMGroup=tDMGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aAAControlGroup=aAAControlGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, targetMACAddress=targetMACAddress, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, licenseTrialPeriod=licenseTrialPeriod, ptp650=ptp650, transparentClockVLAN=transparentClockVLAN, licenseCapacity=licenseCapacity, range=range, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, syncETracking=syncETracking, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, smtpGroup=smtpGroup, userTable=userTable, sNTPLastSync=sNTPLastSync, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, license=license, sNTPPrimaryServer=sNTPPrimaryServer, licenseTDDSyncSupport=licenseTDDSyncSupport, softwareVersion=softwareVersion, auxPortStatusTrap=auxPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, masterSlaveMode=masterSlaveMode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syslogStateTrap=syslogStateTrap, portAllocationMismatch=portAllocationMismatch, receiveFreqMHz=receiveFreqMHz, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortAllocation=mainPSUPortAllocation, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseMaxLinkRange=licenseMaxLinkRange, userName=userName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABNominalModulationMode=mABNominalModulationMode, sNTPSyncTrap=sNTPSyncTrap, transparentClockVID=transparentClockVID, transmitFreqKHz=transmitFreqKHz, cableDiagPair2Distance=cableDiagPair2Distance, syslogClientTrap=syslogClientTrap, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, mPLSTCPriorityTable=mPLSTCPriorityTable, iPv6PrefixLength=iPv6PrefixLength, auxPortConfigurationMismatch=auxPortConfigurationMismatch, hardwareVersion=hardwareVersion, latitude=latitude, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, versionsGroup=versionsGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, hTTPSAccessEnabled=hTTPSAccessEnabled, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dSCPManagementPriority=dSCPManagementPriority, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseSecurityLevel=licenseSecurityLevel, byteErrorRatio=byteErrorRatio, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, routerProtocols=routerProtocols, subbandLowestFrequency=subbandLowestFrequency, userTableEntry=userTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPServerTableEntry=sNTPServerTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, licenseVersion=licenseVersion, cambium=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tdmTableEntry=tdmTableEntry, sFPPortQLTx=sFPPortQLTx, auxPortStatus=auxPortStatus, receiveChannel=receiveChannel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, licenseRARSupport=licenseRARSupport, dfsPeaks=dfsPeaks, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, transmitModulationMode=transmitModulationMode, pubStats=pubStats, mainPSUPortQLTx=mainPSUPortQLTx, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelStatus=tDMChannelStatus, alarms=alarms, auxPortAllocation=auxPortAllocation, secondDataPortPauseFrames=secondDataPortPauseFrames, txMABFrames=txMABFrames, sMTPEmailAlert=sMTPEmailAlert, telnetPortNumber=telnetPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, capacityVariantMismatch=capacityVariantMismatch, systemClock=systemClock, sFPPortSSMTx=sFPPortSSMTx, userTableNumber=userTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkLoss=linkLoss, telnetAccessEnabled=telnetAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, encryptionAlgorithm=encryptionAlgorithm, syslogControl=syslogControl, sNTPServerPortNumber=sNTPServerPortNumber, userTableIndex=userTableIndex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPVersion=iPVersion, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerTableNumber=sNTPServerTableNumber, pubStatsGroup=pubStatsGroup, dfsTableIndex=dfsTableIndex, mABMaintenanceLevel=mABMaintenanceLevel, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDControlGroup=tDDControlGroup, secureModeAlarmTrap=secureModeAlarmTrap, syncETrackingState=syncETrackingState, management=management, tdmTable=tdmTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, antennaGain=antennaGain, hTTPPortNumber=hTTPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDM=tDM, ptpGroups=ptpGroups, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogControlGroup=syslogControlGroup, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber)
