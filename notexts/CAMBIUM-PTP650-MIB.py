...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseEncryption=licenseEncryption, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, linkName=linkName, channelChangeTrap=channelChangeTrap, dfsTableNumber=dfsTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortStatus=nIDULanPortStatus, versions=versions, userTableNumber=userTableNumber, tDMChannelStatus=tDMChannelStatus, groupID=groupID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, PYSNMP_MODULE_ID=cambium, licenseTDDSyncSupport=licenseTDDSyncSupport, transparentClockVLAN=transparentClockVLAN, supplementary=supplementary, accessMethod=accessMethod, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortQLTx=sFPPortQLTx, dfs=dfs, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, hTTPSPortNumber=hTTPSPortNumber, routerProtocols=routerProtocols, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnostics=cableDiagnostics, hTTPAccessEnabled=hTTPAccessEnabled, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair3Results=cableDiagPair3Results, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMGroup=tDMGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPEmailAlert=sMTPEmailAlert, antennaGain=antennaGain, localPacketFiltering=localPacketFiltering, installArmState=installArmState, capacityVariantMismatch=capacityVariantMismatch, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPState=sNTPState, mABMaintenanceLevel=mABMaintenanceLevel, targetMACAddress=targetMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, receivePower=receivePower, l2CPPriorityTable=l2CPPriorityTable, iPVersion=iPVersion, encryption=encryption, mainPSUPortAllocation=mainPSUPortAllocation, pubStatsGroup=pubStatsGroup, licenseBandwidthCap=licenseBandwidthCap, snmpControl=snmpControl, iPv6GatewayAddress=iPv6GatewayAddress, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsTableEntry=dfsTableEntry, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockPort=transparentClockPort, ptpTraps=ptpTraps, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, lowestTDMModulationMode=lowestTDMModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsGroup=dfsGroup, cableDiagPair2Results=cableDiagPair2Results, cableDiagPair2Distance=cableDiagPair2Distance, timeZone=timeZone, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, enableTransmission=enableTransmission, lowestSecondDataModulationMode=lowestSecondDataModulationMode, auxPortSyncERxStatus=auxPortSyncERxStatus, channelBandwidth=channelBandwidth, dataPortWirelessDownAlert=dataPortWirelessDownAlert, license=license, sNTPServerTableEntry=sNTPServerTableEntry, sNTPLastSync=sNTPLastSync, regulatoryBandTrap=regulatoryBandTrap, daylightSaving=daylightSaving, aAAControl=aAAControl, tDMInterfaceStatus=tDMInterfaceStatus, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, ptp650=ptp650, licenseIPv6Support=licenseIPv6Support, tFTPServerPortNumber=tFTPServerPortNumber, tdmTableNumber=tdmTableNumber, userTable=userTable, sNMPv3Enable=sNMPv3Enable, sNMPPortNumber=sNMPPortNumber, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortQLRx=sFPPortQLRx, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, aAAControlGroup=aAAControlGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, phyControl=phyControl, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationMode=transmitModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mainPSUPortQLTx=mainPSUPortQLTx, auxPortQLRx=auxPortQLRx, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondDataBridgingStatus=secondDataBridgingStatus, cableDiagPair1Results=cableDiagPair1Results, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, byteErrorRatio=byteErrorRatio, cableDiagPair3Distance=cableDiagPair3Distance, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, softwareVersion=softwareVersion, transparentClock=transparentClock, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAllocation=sFPPortAllocation, sNMPCommunityString=sNMPCommunityString, installArmStateTrap=installArmStateTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, pubStats=pubStats, licenseIEEE1588Support=licenseIEEE1588Support, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableLoss=cableLoss, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, smtpGroup=smtpGroup, mABNominalModulationMode=mABNominalModulationMode, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, maximumTransmitPower=maximumTransmitPower, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, iPv4Address=iPv4Address, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, altitude=altitude, sntp=sntp, portAllocationMismatch=portAllocationMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsControl=cableDiagnosticsControl, userName=userName, systemReset=systemReset, phyStatus=phyStatus, licenseCapacity=licenseCapacity, subbandLowestFrequency=subbandLowestFrequency, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, transparentClockVID=transparentClockVID, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, remoteInternetAddressType=remoteInternetAddressType, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syslogControl=syslogControl, sNTPServerTable=sNTPServerTable, sNTPServerRetries=sNTPServerRetries, tDDSynchronizationMode=tDDSynchronizationMode, tdmTable=tdmTable, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, subbandHighestFrequency=subbandHighestFrequency, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installStatus=installStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelCableLength=tDMChannelCableLength, tdmTableEntry=tdmTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsWarning=cableDiagnosticsWarning, productName=productName, managementPortWirelessDownAlert=managementPortWirelessDownAlert, extendedSpectrumScanning=extendedSpectrumScanning, dfsTableIndex=dfsTableIndex, sFPPortStatusTrap=sFPPortStatusTrap, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, sFPPortStatus=sFPPortStatus, rangingMode=rangingMode, lowestDataModulationMode=lowestDataModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tdmTableIndex=tdmTableIndex, iPv6Address=iPv6Address, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, rawReceivePower=rawReceivePower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, licenseSecurityLevel=licenseSecurityLevel, txColorCode=txColorCode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, latitude=latitude, licenseVersion=licenseVersion, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, unitOutOfCalibration=unitOutOfCalibration, sFPPortAutoMdix=sFPPortAutoMdix, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPTrapTableNumber=sNMPTrapTableNumber, productVariant=productVariant, syslogClient=syslogClient, ptp=ptp, tDDControl=tDDControl, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPErrorTrap=sFPErrorTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syslogStateTrap=syslogStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, snmpControlGroup=snmpControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, versionsGroup=versionsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, txMABFrames=txMABFrames, regulatoryBand=regulatoryBand, sNTPSync=sNTPSync, rxColorCode=rxColorCode, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortStatus=auxPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syncETracking=syncETracking, receiveFreqKHz=receiveFreqKHz, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogState=syslogState, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, auxPortStatusTrap=auxPortStatusTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, management=management, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDM=tDM, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, reset=reset, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPServerStatus=sNTPServerStatus, ptpCompliance=ptpCompliance, mABProtocolVID=mABProtocolVID, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPSyncTrap=sNTPSyncTrap, syncEEquipmentClock=syncEEquipmentClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTable=ethernetPriorityTable, dataBridgingAvailability=dataBridgingAvailability, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, linkLoss=linkLoss, userTableIndex=userTableIndex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, systemClock=systemClock, licenseGroup=licenseGroup, linkModeOptimization=linkModeOptimization, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ptmp=ptmp, sFPError=sFPError, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, targetRange=targetRange, telnetAccessEnabled=telnetAccessEnabled, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerTableIndex=sNTPServerTableIndex, licenseGroupAccess=licenseGroupAccess, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ethernet=ethernet, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSSMTx=sFPPortSSMTx, dfsPeaks=dfsPeaks, auxPortAllocation=auxPortAllocation, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABHoldoffPeriod=mABHoldoffPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, smtp=smtp, resetGroup=resetGroup, siteName=siteName, portAllocationMismatchTrap=portAllocationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, hardwareVersion=hardwareVersion, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagPair4Distance=cableDiagPair4Distance, alarmsGroup=alarmsGroup, licenseRARSupport=licenseRARSupport, transmitChannel=transmitChannel, userPassword=userPassword, cableDiagPair1Distance=cableDiagPair1Distance, sNTPServerTimeout=sNTPServerTimeout, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatus=dataBridgingStatus, telnetPortNumber=telnetPortNumber, cambium=cambium, alarms=alarms, syslogClientTrap=syslogClientTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, vectorError=vectorError, eIRP=eIRP, secureModeAlarmTrap=secureModeAlarmTrap, auxPortQLTx=auxPortQLTx, dfsMeans=dfsMeans, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, tDMChannelLoopback=tDMChannelLoopback, auxPortSSMTx=auxPortSSMTx, sNTPServerTableNumber=sNTPServerTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, useVLANForMABProtocol=useVLANForMABProtocol, transmitDataRate=transmitDataRate, mABState=mABState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTable=dfsTable, mABTransmissionInterval=mABTransmissionInterval, secondDataPortPauseFrames=secondDataPortPauseFrames, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, longitude=longitude, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, secureModeAlarm=secureModeAlarm, encryptionGroup=encryptionGroup, bootVersion=bootVersion, managementGroup=managementGroup, routerProtocolsGroup=routerProtocolsGroup, sntpGroup=sntpGroup, bridgeGroup=bridgeGroup, tDMEnabledChannels=tDMEnabledChannels, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, bridge=bridge, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPPollInterval=sNTPPollInterval, licenseIssueNumber=licenseIssueNumber, licenseCountry=licenseCountry, searchState=searchState, masterSlaveMode=masterSlaveMode, remoteInternetAddress=remoteInternetAddress, receiveModulationMode=receiveModulationMode, licenseSyncESupport=licenseSyncESupport, syncETrackingState=syncETrackingState)
