...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, userTableIndex=userTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortDisabledWarning=sFPPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, groupID=groupID, versions=versions, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseRegulatoryBandsList=licenseRegulatoryBandsList, phyControl=phyControl, lowestDataModulationMode=lowestDataModulationMode, auxPortQLRx=auxPortQLRx, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptpTraps=ptpTraps, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, userName=userName, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, tDMChannelStatus=tDMChannelStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleRegulatoryBands=incompatibleRegulatoryBands, channelChangeTrap=channelChangeTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tdmTableIndex=tdmTableIndex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortDisabledWarning=auxPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair3Results=cableDiagPair3Results, sNTPServerTimeout=sNTPServerTimeout, licenseSyncESupport=licenseSyncESupport, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRARSupport=licenseRARSupport, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, tDM=tDM, remoteInternetAddress=remoteInternetAddress, secureModeAlarm=secureModeAlarm, sNMPTrapVersion=sNMPTrapVersion, cableDiagnosticsControl=cableDiagnosticsControl, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, range=range, vLANManagementVID=vLANManagementVID, dSCPManagementPriority=dSCPManagementPriority, useVLANForMABProtocol=useVLANForMABProtocol, telnetPortNumber=telnetPortNumber, latitude=latitude, productVariant=productVariant, cableDiagnostics=cableDiagnostics, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitModulationMode=transmitModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseVersion=licenseVersion, licenseTrialPeriod=licenseTrialPeriod, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, lowestSecondDataModulationMode=lowestSecondDataModulationMode, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rxColorCode=rxColorCode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userRole=userRole, tDDSynchronizationMode=tDDSynchronizationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogClient=syslogClient, receiveFreqMHz=receiveFreqMHz, mainPSUPortStatus=mainPSUPortStatus, siteName=siteName, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTable=sNTPServerTable, licenseUnitSerialNumber=licenseUnitSerialNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, auxPortStatusTrap=auxPortStatusTrap, bridgeGroup=bridgeGroup, accessMethod=accessMethod, userEnabled=userEnabled, dataBridgingAvailability=dataBridgingAvailability, timeZone=timeZone, managementGroup=managementGroup, cableDiagPair1Results=cableDiagPair1Results, smtpGroup=smtpGroup, syslogState=syslogState, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsTableEntry=dfsTableEntry, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, dfsGroup=dfsGroup, dfsTable=dfsTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPv4Address=iPv4Address, noWirelessChannelAvailable=noWirelessChannelAvailable, targetMACAddress=targetMACAddress, iPv6GatewayAddress=iPv6GatewayAddress, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, dfsTableIndex=dfsTableIndex, syncETracking=syncETracking, licenseIssueNumber=licenseIssueNumber, auxPortSSMTx=auxPortSSMTx, transmitFreqKHz=transmitFreqKHz, portAllocationMismatch=portAllocationMismatch, softwareVersion=softwareVersion, mABHoldoffPeriod=mABHoldoffPeriod, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseOOBManagementSupport=licenseOOBManagementSupport, configuration=configuration, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mABNominalModulationMode=mABNominalModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionAlgorithm=encryptionAlgorithm, transparentClock=transparentClock, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseIPv6Support=licenseIPv6Support, txColorCode=txColorCode, cableDiagPair1Distance=cableDiagPair1Distance, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableLoss=cableLoss, secondarySoftwareVersion=secondarySoftwareVersion, eIRP=eIRP, auxPortAcceptedQLRx=auxPortAcceptedQLRx, syslogClientTrap=syslogClientTrap, ethernetGroup=ethernetGroup, licenseCountry=licenseCountry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseIEEE1588Support=licenseIEEE1588Support, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, license=license, tdmTableNumber=tdmTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMChannelCableLength=tDMChannelCableLength, encryption=encryption, bridge=bridge, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseSFPPortSupport=licenseSFPPortSupport, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair4Results=cableDiagPair4Results, auxPortQLTx=auxPortQLTx, supplementaryGroup=supplementaryGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMEnabledChannels=tDMEnabledChannels, rangingMode=rangingMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptp=ptp, linkName=linkName, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, versionsGroup=versionsGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPEnabledMessages=sMTPEnabledMessages, tDMChannelLoopback=tDMChannelLoopback, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, secureModeAlarmTrap=secureModeAlarmTrap, systemReset=systemReset, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, sntp=sntp, longitude=longitude, sNMPTrapTable=sNMPTrapTable, licenseEncryption=licenseEncryption, mABState=mABState, transmitDataRate=transmitDataRate, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, enableTransmission=enableTransmission, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dfsMeans=dfsMeans, licenseGroupAccess=licenseGroupAccess, tDMChannelLineCode=tDMChannelLineCode, userPassword=userPassword, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, configurationGroup=configurationGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, management=management, iPVersion=iPVersion, PYSNMP_MODULE_ID=cambium, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, localPacketFiltering=localPacketFiltering, licenseSecurityLevel=licenseSecurityLevel, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, gatewayIPAddress=gatewayIPAddress, dfsPeaks=dfsPeaks, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, frequencyVariant=frequencyVariant, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, aAAControl=aAAControl, sNMPPortNumber=sNMPPortNumber, mABMaintenanceLevel=mABMaintenanceLevel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cambium=cambium, userTable=userTable, cableDiagPair4Distance=cableDiagPair4Distance, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, sNTPServerRetries=sNTPServerRetries, notificationsGroup=notificationsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStats=pubStats, regulatoryBandTrap=regulatoryBandTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mABProtocolVID=mABProtocolVID, encryptionGroup=encryptionGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", nIDULanPortStatus=nIDULanPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, cableDiagnosticsGroup=cableDiagnosticsGroup, sMTPEmailAlert=sMTPEmailAlert, licenseCapacity=licenseCapacity, transmitFreqMHz=transmitFreqMHz, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveChannel=receiveChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, subbandHighestFrequency=subbandHighestFrequency, sFPError=sFPError, sFPErrorTrap=sFPErrorTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, linkModeOptimization=linkModeOptimization, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableDiagPair3Distance=cableDiagPair3Distance, tdmTableEntry=tdmTableEntry, sNTPServerStatus=sNTPServerStatus, routerProtocols=routerProtocols, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hardwareVersion=hardwareVersion, mainPSUPortQLRx=mainPSUPortQLRx, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTable=ethernetPriorityTable, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMInterfaceStatus=tDMInterfaceStatus, masterSlaveMode=masterSlaveMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortAllocation=auxPortAllocation, sFPPortAutoMdix=sFPPortAutoMdix, sNTPLastSync=sNTPLastSync, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, userTableNumber=userTableNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, syslogStateTrap=syslogStateTrap, tDMGroup=tDMGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syncETrackingState=syncETrackingState, sFPPortSyncERxStatus=sFPPortSyncERxStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, tdmTable=tdmTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, qOSPriorityScheme=qOSPriorityScheme, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, mABTransmissionInterval=mABTransmissionInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, phyStatus=phyStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, searchState=searchState, secondDataBridgingStatus=secondDataBridgingStatus, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLTx=mainPSUPortQLTx, installArmState=installArmState, sFPPortQLTx=sFPPortQLTx, regulatoryBand=regulatoryBand, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagPair2Results=cableDiagPair2Results, sFPPortStatus=sFPPortStatus, ptpTrapPrefix=ptpTrapPrefix, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, byteErrorRatio=byteErrorRatio, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, ethernet=ethernet, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseGroup=licenseGroup, sNTPServerTableIndex=sNTPServerTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, supplementary=supplementary, wirelessLinkStatus=wirelessLinkStatus, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, installStatusTrap=installStatusTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syslogControlGroup=syslogControlGroup, subbandLowestFrequency=subbandLowestFrequency, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveFreqKHz=receiveFreqKHz, phyControlGroup=phyControlGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, userTableEntry=userTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsTableNumber=dfsTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receivePower=receivePower, targetRange=targetRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, productName=productName, reset=reset, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, resetGroup=resetGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, ptp650=ptp650, routerProtocolsGroup=routerProtocolsGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sFPPortQLRx=sFPPortQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAllocation=sFPPortAllocation, iPv6Address=iPv6Address, auxPortStatus=auxPortStatus, syslogControl=syslogControl, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transparentClockPort=transparentClockPort, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, bootVersion=bootVersion, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerTableEntry=sNTPServerTableEntry, tDMInterfaceControl=tDMInterfaceControl, rawReceivePower=rawReceivePower, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortAllocation=mainPSUPortAllocation, syncEEquipmentClock=syncEEquipmentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPState=sNTPState, cableDiagnosticsResultTable=cableDiagnosticsResultTable, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, txMABFrames=txMABFrames, installStatus=installStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockVID=transparentClockVID, remoteInternetAddressType=remoteInternetAddressType, capacityVariantMismatch=capacityVariantMismatch, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mainPSUPortStatusTrap=mainPSUPortStatusTrap)
