...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, smtp=smtp, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagPair1Distance=cableDiagPair1Distance, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, receiveDataRate=receiveDataRate, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, bridge=bridge, auxPortSyncERxStatus=auxPortSyncERxStatus, rxColorCode=rxColorCode, sFPPortQLRx=sFPPortQLRx, syslogControlGroup=syslogControlGroup, sFPError=sFPError, dfsTableEntry=dfsTableEntry, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aAAControlGroup=aAAControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productVariant=productVariant, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, userTableIndex=userTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, ptp650=ptp650, license=license, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, resetGroup=resetGroup, targetMACAddress=targetMACAddress, syncEEquipmentClock=syncEEquipmentClock, tFTPServerInternetAddress=tFTPServerInternetAddress, dataBridgingAvailability=dataBridgingAvailability, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, reset=reset, enableTransmission=enableTransmission, tDMInterfaceStatus=tDMInterfaceStatus, dfsGroup=dfsGroup, sFPPortStatus=sFPPortStatus, ptmp=ptmp, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatch=capacityVariantMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, installStatus=installStatus, iPv6Address=iPv6Address, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, ptpCompliance=ptpCompliance, transmitFreqKHz=transmitFreqKHz, sFPPortQLTx=sFPPortQLTx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, telnetPortNumber=telnetPortNumber, routerProtocols=routerProtocols, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMEnabledChannels=tDMEnabledChannels, syslogStateTrap=syslogStateTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, licenseGroupAccess=licenseGroupAccess, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, snmpControl=snmpControl, sntp=sntp, dfsTable=dfsTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, systemReset=systemReset, sNTPLastSync=sNTPLastSync, smtpGroup=smtpGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveFreqKHz=receiveFreqKHz, siteName=siteName, txMABFrames=txMABFrames, receiveChannel=receiveChannel, auxPortQLRx=auxPortQLRx, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, cableDiagPair2Results=cableDiagPair2Results, iPVersion=iPVersion, vectorError=vectorError, secureModeAlarm=secureModeAlarm, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPState=sNTPState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, qOSPriorityScheme=qOSPriorityScheme, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, routerProtocolsGroup=routerProtocolsGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, dfsMeans=dfsMeans, sNMPCommunityString=sNMPCommunityString, productName=productName, hardwareVersion=hardwareVersion, licenseTrialPeriod=licenseTrialPeriod, tdmTable=tdmTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, signalStrengthRatio=signalStrengthRatio, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syslogClient=syslogClient, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, versionsGroup=versionsGroup, daylightSaving=daylightSaving, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, channelBandwidth=channelBandwidth, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, management=management, remoteInternetAddressType=remoteInternetAddressType, phyControl=phyControl, userName=userName, managementGroup=managementGroup, dfsTableIndex=dfsTableIndex, mainPSUPortAllocation=mainPSUPortAllocation, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, channelChangeTrap=channelChangeTrap, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, cableLoss=cableLoss, sNMPTrapVersion=sNMPTrapVersion, cableDiagPair1Results=cableDiagPair1Results, linkModeOptimization=linkModeOptimization, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, transparentClockVID=transparentClockVID, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveFreqMHz=receiveFreqMHz, iPv4Address=iPv4Address, tDMInterfaceControl=tDMInterfaceControl, subbandHighestFrequency=subbandHighestFrequency, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, byteErrorRatio=byteErrorRatio, iPv6PrefixLength=iPv6PrefixLength, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsPeaks=dfsPeaks, auxPortStatus=auxPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitFreqMHz=transmitFreqMHz, sFPPortSSMTx=sFPPortSSMTx, lowestTDMModulationMode=lowestTDMModulationMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRARSupport=licenseRARSupport, auxPortStatusTrap=auxPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transparentClock=transparentClock, cableDiagnosticsWarning=cableDiagnosticsWarning, alarms=alarms, licenseSyncESupport=licenseSyncESupport, noWirelessChannelAvailable=noWirelessChannelAvailable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, l2CPPriorityTable=l2CPPriorityTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, userEnabled=userEnabled, mainPSUPortQLRx=mainPSUPortQLRx, configuration=configuration, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerStatus=sNTPServerStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseIssueNumber=licenseIssueNumber, transparentClockPort=transparentClockPort, syncETrackingState=syncETrackingState, tdmTableEntry=tdmTableEntry, licenseEncryption=licenseEncryption, auxPortSSMTx=auxPortSSMTx, sFPPortAutoMdix=sFPPortAutoMdix, auxPortAllocation=auxPortAllocation, tDMChannelLoopback=tDMChannelLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABMaintenanceLevel=mABMaintenanceLevel, systemClock=systemClock, phyControlGroup=phyControlGroup, tDMChannelCableLength=tDMChannelCableLength, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, installStatusTrap=installStatusTrap, dataBridgingStatus=dataBridgingStatus, auxPortQLTx=auxPortQLTx, localPacketFiltering=localPacketFiltering, notificationsGroup=notificationsGroup, txColorCode=txColorCode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortStatus=mainPSUPortStatus, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortQLTx=mainPSUPortQLTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, installArmState=installArmState, latitude=latitude, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, installArmStateTrap=installArmStateTrap, versions=versions, tDM=tDM, sFPPortSyncERxStatus=sFPPortSyncERxStatus, encryptionGroup=encryptionGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secondDataPortPauseFrames=secondDataPortPauseFrames, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSync=sNTPSync, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, mABState=mABState, licenseTDDSyncSupport=licenseTDDSyncSupport, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, syslogControl=syslogControl)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerTable=sNTPServerTable, sNTPServerRetries=sNTPServerRetries, lowestDataModulationMode=lowestDataModulationMode, aAAControl=aAAControl, tFTPServerPortNumber=tFTPServerPortNumber, licenseSecurityLevel=licenseSecurityLevel, syslogState=syslogState, regulatoryBandTrap=regulatoryBandTrap, telnetAccessEnabled=telnetAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMChannelStatus=tDMChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aggregateDataRate=aggregateDataRate, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, linkName=linkName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMGroup=tDMGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitDataRate=transmitDataRate, extendedSpectrumScanning=extendedSpectrumScanning, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, snmpControlGroup=snmpControlGroup, mABTransmissionInterval=mABTransmissionInterval, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, phyStatus=phyStatus, dataPortPauseFrames=dataPortPauseFrames, iPDSCPPriorityTable=iPDSCPPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, licenseGroup=licenseGroup, mABProtocolVID=mABProtocolVID, l2CPPriorityTableIndex=l2CPPriorityTableIndex, supplementaryGroup=supplementaryGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, tdmTableIndex=tdmTableIndex, licenseBandwidthCap=licenseBandwidthCap, bootVersion=bootVersion, cableDiagPair3Results=cableDiagPair3Results, portAllocationMismatch=portAllocationMismatch, tdmTableNumber=tdmTableNumber, supplementary=supplementary, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, userRole=userRole, timeZone=timeZone, ptp=ptp, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, range=range, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernet=ethernet, sFPErrorTrap=sFPErrorTrap, ptpGroups=ptpGroups, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortAutoMdix=mainPSUPortAutoMdix, subbandLowestFrequency=subbandLowestFrequency, licenseCountry=licenseCountry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPServerPortNumber=sNTPServerPortNumber, groupID=groupID, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpTraps=ptpTraps, cableDiagPair3Distance=cableDiagPair3Distance, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, encryption=encryption, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatusGroup=phyStatusGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, softwareVersion=softwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, useVLANForMABProtocol=useVLANForMABProtocol, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, cableDiagPair2Distance=cableDiagPair2Distance, subnetMask=subnetMask, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAllocation=sFPPortAllocation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, transparentClockVLAN=transparentClockVLAN, receivePower=receivePower, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABNominalModulationMode=mABNominalModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, secondDataBridgingStatus=secondDataBridgingStatus, tDMChannelLineCode=tDMChannelLineCode, licenseVersion=licenseVersion, sNTPPrimaryServer=sNTPPrimaryServer, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, cableDiagnostics=cableDiagnostics, sNTPServerTimeout=sNTPServerTimeout, nIDULanPortStatus=nIDULanPortStatus, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetRange=targetRange, sNMPPortNumber=sNMPPortNumber, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseMaxLinkRange=licenseMaxLinkRange, dfs=dfs, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, accessMethod=accessMethod, ethernetGroup=ethernetGroup, searchState=searchState, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cambium=cambium, dfsTableNumber=dfsTableNumber, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitChannel=transmitChannel, maxLinkRangeExceeded=maxLinkRangeExceeded, bridgeGroup=bridgeGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDControl=tDDControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, userTableEntry=userTableEntry, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsControl=cableDiagnosticsControl, licenseCapacity=licenseCapacity, userTableNumber=userTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, lowestSecondDataModulationMode=lowestSecondDataModulationMode, eIRP=eIRP, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rangingMode=rangingMode)
