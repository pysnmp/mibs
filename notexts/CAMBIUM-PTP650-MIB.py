...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, sNMPPortNumber=sNMPPortNumber, routerProtocolsGroup=routerProtocolsGroup, phyStatus=phyStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseSecurityLevel=licenseSecurityLevel, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, userTableIndex=userTableIndex, licenseSyncESupport=licenseSyncESupport, sFPPortQLRx=sFPPortQLRx, syncEEquipmentClock=syncEEquipmentClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, dataBridgingStatus=dataBridgingStatus, tDMGroup=tDMGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, notificationsGroup=notificationsGroup, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, ethernetPriorityTableEntry=ethernetPriorityTableEntry, reset=reset, licenseRARSupport=licenseRARSupport, managementGroup=managementGroup, licenseSFPPortSupport=licenseSFPPortSupport, sntpGroup=sntpGroup, sntp=sntp, transparentClockVID=transparentClockVID, alarmsGroup=alarmsGroup, groupID=groupID, tDDControl=tDDControl, tdmTableIndex=tdmTableIndex, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortAllocation=auxPortAllocation, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, licenseCountry=licenseCountry, tDDSynchronizationMode=tDDSynchronizationMode, mABState=mABState, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, txMABFrames=txMABFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tdmTable=tdmTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mABHoldoffPeriod=mABHoldoffPeriod, mABProtocolVID=mABProtocolVID, rxColorCode=rxColorCode, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortQLTx=sFPPortQLTx, telnetPortNumber=telnetPortNumber, sNMPTrapVersion=sNMPTrapVersion, transparentClockPort=transparentClockPort, softwareVersion=softwareVersion, sFPErrorTrap=sFPErrorTrap, bridgeGroup=bridgeGroup, dfsMeans=dfsMeans, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sFPPortAutoMdix=sFPPortAutoMdix, auxPortDisabledWarning=auxPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTable=sNMPTrapTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, licenseMaxLinkRange=licenseMaxLinkRange, licenseTDDSyncSupport=licenseTDDSyncSupport, snmpControlGroup=snmpControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityTableIndex=ethernetPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, auxPortSSMTx=auxPortSSMTx, altitude=altitude, managementNetworkAccessEnabled=managementNetworkAccessEnabled, frequencyVariant=frequencyVariant, sFPPortDisabledWarning=sFPPortDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsPeaks=dfsPeaks, capacityVariantMismatch=capacityVariantMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetGroup=ethernetGroup, ptp=ptp, dataBridgingStatusAlarm=dataBridgingStatusAlarm, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sFPPortAutoNegotiation=sFPPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, bridge=bridge, tdmTableEntry=tdmTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair1Results=cableDiagPair1Results, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, antennaGain=antennaGain, licenseIssueNumber=licenseIssueNumber, vectorError=vectorError, ptpCompliance=ptpCompliance, tDM=tDM, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableNumber=userTableNumber, licenseCapacity=licenseCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsResultTable=cableDiagnosticsResultTable, hardwareVersion=hardwareVersion, cableDiagnostics=cableDiagnostics, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, userPassword=userPassword, portAllocationMismatch=portAllocationMismatch, targetMACAddress=targetMACAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveDataRate=receiveDataRate, snmpControl=snmpControl, ptmp=ptmp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, linkName=linkName, dataPortPauseFrames=dataPortPauseFrames, dfsGroup=dfsGroup, receivePower=receivePower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, systemReset=systemReset, mainPSUPortQLRx=mainPSUPortQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMChannelStatus=tDMChannelStatus, mainPSUPortAllocation=mainPSUPortAllocation, targetRange=targetRange, tDMChannelLineCode=tDMChannelLineCode, licenseEncryption=licenseEncryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseVersion=licenseVersion, siteName=siteName, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABTransmissionInterval=mABTransmissionInterval, syslogState=syslogState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, txColorCode=txColorCode, cableDiagnosticsGroup=cableDiagnosticsGroup, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, regulatoryBand=regulatoryBand, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPError=sFPError, vLANManagementVID=vLANManagementVID, dataBridgingAvailability=dataBridgingAvailability, subbandHighestFrequency=subbandHighestFrequency, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, range=range, nIDULanPortStatusTrap=nIDULanPortStatusTrap, configurationGroup=configurationGroup, routerProtocols=routerProtocols, sNTPPollInterval=sNTPPollInterval, sNTPServerTableEntry=sNTPServerTableEntry, versionsGroup=versionsGroup, daylightSaving=daylightSaving, cableDiagPair3Distance=cableDiagPair3Distance, linkLoss=linkLoss, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, auxPortStatusTrap=auxPortStatusTrap, smtp=smtp, transmitModulationMode=transmitModulationMode, remoteInternetAddress=remoteInternetAddress, mABMaintenanceLevel=mABMaintenanceLevel, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, userName=userName, syncETrackingState=syncETrackingState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, gatewayIPAddress=gatewayIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, dfsTableEntry=dfsTableEntry, licenseBandwidthCap=licenseBandwidthCap, useVLANForMABProtocol=useVLANForMABProtocol, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, phyStatusGroup=phyStatusGroup, management=management, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoMdix=mainPSUPortAutoMdix, versions=versions, subbandLowestFrequency=subbandLowestFrequency, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userEnabled=userEnabled, ptpTraps=ptpTraps, tDMInterfaceControl=tDMInterfaceControl, ptpGroups=ptpGroups, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, encryption=encryption, sNTPPrimaryServer=sNTPPrimaryServer, licenseOOBManagementSupport=licenseOOBManagementSupport, receiveFreqMHz=receiveFreqMHz, cableDiagnosticsWarning=cableDiagnosticsWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", productName=productName, iPv6Address=iPv6Address, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userTable=userTable, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, tDMInterfaceStatus=tDMInterfaceStatus, lowestDataModulationMode=lowestDataModulationMode, sFPPortAllocation=sFPPortAllocation, smtpGroup=smtpGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, iPVersion=iPVersion, linkModeOptimization=linkModeOptimization, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair3Results=cableDiagPair3Results, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, receiveModulationMode=receiveModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, latitude=latitude, cableDiagnosticsPorts=cableDiagnosticsPorts, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPServerRetries=sNTPServerRetries, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortStatusTrap=sFPPortStatusTrap, iPv4Address=iPv4Address, sNMPTrapTableIndex=sNMPTrapTableIndex, regulatoryBandTrap=regulatoryBandTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, auxPortQLRx=auxPortQLRx, userTableEntry=userTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transmitDataRate=transmitDataRate, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, timeZone=timeZone, license=license, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, transmitChannel=transmitChannel, longitude=longitude, lowestTDMModulationMode=lowestTDMModulationMode, pubStatsGroup=pubStatsGroup, licenseIEEE1588Support=licenseIEEE1588Support, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, ptp650=ptp650, aAAControlGroup=aAAControlGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, secondDataPortPauseFrames=secondDataPortPauseFrames, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, rawReceivePower=rawReceivePower, cableDiagPair2Results=cableDiagPair2Results, transparentClock=transparentClock, sFPPortSyncERxStatus=sFPPortSyncERxStatus, productVariant=productVariant, eIRP=eIRP, subnetMask=subnetMask, transparentClockVLAN=transparentClockVLAN, cambium=cambium, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, receiveChannel=receiveChannel, masterSlaveMode=masterSlaveMode, installStatus=installStatus, mainPSUPortStatus=mainPSUPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, auxPortStatus=auxPortStatus, byteErrorRatio=byteErrorRatio, aAAControl=aAAControl, sFPPortStatus=sFPPortStatus, secureModeAlarmTrap=secureModeAlarmTrap, installArmState=installArmState, bootVersion=bootVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, accessMethod=accessMethod, dfsTable=dfsTable, transmitFreqKHz=transmitFreqKHz, sNTPServerInternetAddress=sNTPServerInternetAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseIPv6Support=licenseIPv6Support, iPv6GatewayAddress=iPv6GatewayAddress, enableTransmission=enableTransmission, cableDiagPair2Distance=cableDiagPair2Distance, secureModeAlarm=secureModeAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair4Results=cableDiagPair4Results, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTimeout=sNTPServerTimeout, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, tDMChannelLoopback=tDMChannelLoopback, dfs=dfs, mABNominalModulationMode=mABNominalModulationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rangingMode=rangingMode, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteInternetAddressType=remoteInternetAddressType, syncETracking=syncETracking, installStatusTrap=installStatusTrap, searchState=searchState, licenseGroup=licenseGroup, extendedSpectrumScanning=extendedSpectrumScanning, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTableIndex=dfsTableIndex, auxPortQLTx=auxPortQLTx, secondDataBridgingStatus=secondDataBridgingStatus, tDMChannelCableLength=tDMChannelCableLength, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, localPacketFiltering=localPacketFiltering, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, nIDULanPortStatus=nIDULanPortStatus, cableDiagnosticsControl=cableDiagnosticsControl, tDMEnabledChannels=tDMEnabledChannels, sMTPServerInternetAddress=sMTPServerInternetAddress, tDDControlGroup=tDDControlGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTableNumber=tdmTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, supplementaryGroup=supplementaryGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, phyControlGroup=phyControlGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, sMTPEnabledMessages=sMTPEnabledMessages, iPDSCPPriorityTable=iPDSCPPriorityTable, tDDSynchronizationStatus=tDDSynchronizationStatus)
