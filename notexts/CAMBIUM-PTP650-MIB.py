...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", maxLinkRangeExceeded=maxLinkRangeExceeded, portAllocationMismatch=portAllocationMismatch, targetRange=targetRange, sNTPState=sNTPState, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseVersion=licenseVersion, dfsGroup=dfsGroup, cableLoss=cableLoss, sNMPPortNumber=sNMPPortNumber, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptp=ptp, licenseCapacity=licenseCapacity, transparentClockVID=transparentClockVID, syslogClient=syslogClient, remoteInternetAddress=remoteInternetAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRARSupport=licenseRARSupport, versionsGroup=versionsGroup, tDMInterfaceControl=tDMInterfaceControl, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerTimeout=sNTPServerTimeout, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, tdmTable=tdmTable, lowestDataModulationMode=lowestDataModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, userEnabled=userEnabled, hardwareVersion=hardwareVersion, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsTableNumber=dfsTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, tDMGroup=tDMGroup, dfsTableIndex=dfsTableIndex, linkName=linkName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, userPassword=userPassword, tDMChannelLoopback=tDMChannelLoopback, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, localPacketFiltering=localPacketFiltering, regulatoryBandTrap=regulatoryBandTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, antennaGain=antennaGain, userName=userName, tDDControl=tDDControl, licenseUnitSerialNumber=licenseUnitSerialNumber, pubStats=pubStats, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syslogState=syslogState, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxColorCode=rxColorCode, rawReceivePower=rawReceivePower, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControlGroup=aAAControlGroup, sNTPServerRetries=sNTPServerRetries, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortQLRx=sFPPortQLRx, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, productVariant=productVariant, accessMethod=accessMethod, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, phyControl=phyControl, sFPPortStatus=sFPPortStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, byteErrorRatio=byteErrorRatio, installArmState=installArmState, ptpTraps=ptpTraps, searchState=searchState, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveFreqMHz=receiveFreqMHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortQLTx=auxPortQLTx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sntpGroup=sntpGroup, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, targetMACAddress=targetMACAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, userTableNumber=userTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveDataRate=receiveDataRate, systemClock=systemClock, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, subbandLowestFrequency=subbandLowestFrequency, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, dataBridgingAvailability=dataBridgingAvailability, licenseIPv6Support=licenseIPv6Support, configurationGroup=configurationGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, routerProtocols=routerProtocols, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, capacityVariantMismatchTrap=capacityVariantMismatchTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerInternetAddress=tFTPServerInternetAddress, wirelessLinkStatus=wirelessLinkStatus, channelChangeTrap=channelChangeTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userTable=userTable, snmpControl=snmpControl, enableTransmission=enableTransmission, vLANManagementPriority=vLANManagementPriority, iPVersion=iPVersion, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, linkSymmetry=linkSymmetry, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, ptp650=ptp650, ptmp=ptmp, mABNominalTransmitCapacity=mABNominalTransmitCapacity, userTableEntry=userTableEntry, bootVersion=bootVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortQLTx=sFPPortQLTx, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPTrapTable=sNMPTrapTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, signalStrengthRatio=signalStrengthRatio, bridge=bridge, mABState=mABState, hTTPPortNumber=hTTPPortNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, aAAControl=aAAControl, ethernet=ethernet, sFPPortAutoMdix=sFPPortAutoMdix, ptpCompliance=ptpCompliance, sNMPCommunityString=sNMPCommunityString, maximumTransmitPower=maximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitChannel=transmitChannel, mainPSUPortStatus=mainPSUPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, smtpGroup=smtpGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tdmTableIndex=tdmTableIndex, license=license, syslogClientTrap=syslogClientTrap, licenseCountry=licenseCountry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, receiveModulationModeDetail=receiveModulationModeDetail, auxPortSSMTx=auxPortSSMTx, snmpControlGroup=snmpControlGroup, cableDiagnostics=cableDiagnostics, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, range=range, longitude=longitude, bridgeGroup=bridgeGroup, mainPSUPortQLRx=mainPSUPortQLRx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, timeZone=timeZone, tdmTableEntry=tdmTableEntry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDMEnabledChannels=tDMEnabledChannels, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimization=linkModeOptimization, transmitPower=transmitPower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, licenseTrialPeriod=licenseTrialPeriod, supplementary=supplementary, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortAllocation=auxPortAllocation, tDMChannelCableLength=tDMChannelCableLength, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsWarning=cableDiagnosticsWarning, sMTPServerPortNumber=sMTPServerPortNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkLoss=linkLoss, reset=reset, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, groupID=groupID, sNTPServerTable=sNTPServerTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, lowestTDMModulationMode=lowestTDMModulationMode, installStatus=installStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, softwareVersion=softwareVersion, secondDataBridgingStatus=secondDataBridgingStatus, iPv6PrefixLength=iPv6PrefixLength, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, management=management, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, phyStatus=phyStatus, licenseIssueNumber=licenseIssueNumber, sNTPServerStatus=sNTPServerStatus, syncETracking=syncETracking, encryptionGroup=encryptionGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mABHoldoffPeriod=mABHoldoffPeriod, qOSPriorityScheme=qOSPriorityScheme, licenseMaxLinkRange=licenseMaxLinkRange, licenseGroup=licenseGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagPair1Results=cableDiagPair1Results, latitude=latitude, mainPSUPortQLTx=mainPSUPortQLTx, rangingMode=rangingMode, mPLSTCPriorityTable=mPLSTCPriorityTable, tDMChannelLineCode=tDMChannelLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortAllocation=sFPPortAllocation, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, nIDULanPortStatus=nIDULanPortStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", PYSNMP_MODULE_ID=cambium, sFPError=sFPError, smtp=smtp, sFPPortDisabledWarning=sFPPortDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, userRole=userRole, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, altitude=altitude, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, mABTransmissionInterval=mABTransmissionInterval, daylightSaving=daylightSaving, managementGroup=managementGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, phyControlGroup=phyControlGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transmitModulationMode=transmitModulationMode, mABProtocolVID=mABProtocolVID, licenseSyncESupport=licenseSyncESupport, syncETrackingState=syncETrackingState, unitOutOfCalibration=unitOutOfCalibration, transparentClock=transparentClock, mABNominalModulationMode=mABNominalModulationMode, txMABFrames=txMABFrames, routerProtocolsGroup=routerProtocolsGroup, cableDiagPair3Distance=cableDiagPair3Distance, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, subbandHighestFrequency=subbandHighestFrequency, sNTPServerTableIndex=sNTPServerTableIndex, capacityVariantMismatch=capacityVariantMismatch, secondDataPortPauseFrames=secondDataPortPauseFrames, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair2Results=cableDiagPair2Results, noWirelessChannelAvailable=noWirelessChannelAvailable, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableEntry=dfsTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitDataRate=transmitDataRate, sNTPServerTableNumber=sNTPServerTableNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, sFPErrorTrap=sFPErrorTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortStatus=auxPortStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseSFPPortSupport=licenseSFPPortSupport, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDDSynchronizationMode=tDDSynchronizationMode, versions=versions, auxPortDisabledWarning=auxPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPAccessEnabled=hTTPAccessEnabled, iPv6Address=iPv6Address, mABProtocolVLANPriority=mABProtocolVLANPriority, resetGroup=resetGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorError=vectorError, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveFreqKHz=receiveFreqKHz, auxPortSyncERxStatus=auxPortSyncERxStatus, dfs=dfs, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, extendedSpectrumScanning=extendedSpectrumScanning, telnetAccessEnabled=telnetAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataBridgingStatus=dataBridgingStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, subnetMask=subnetMask, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortSSMTx=sFPPortSSMTx, txColorCode=txColorCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, iPv6GatewayAddress=iPv6GatewayAddress, sntp=sntp, syncEEquipmentClock=syncEEquipmentClock, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tdmTableNumber=tdmTableNumber, cableDiagPair4Results=cableDiagPair4Results, transparentClockVLAN=transparentClockVLAN, vLANManagementVID=vLANManagementVID, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, gatewayIPAddress=gatewayIPAddress, secureModeAlarm=secureModeAlarm, tDM=tDM, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogStateTrap=syslogStateTrap, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, regulatoryBand=regulatoryBand, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, useVLANForMABProtocol=useVLANForMABProtocol, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseBandwidthCap=licenseBandwidthCap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv4Address=iPv4Address, licenseGroupAccess=licenseGroupAccess, ptpGroups=ptpGroups, auxPortStatusTrap=auxPortStatusTrap, dfsMeans=dfsMeans, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair2Distance=cableDiagPair2Distance, configuration=configuration, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseSecurityLevel=licenseSecurityLevel, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, sNMPTrapVersion=sNMPTrapVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMChannelStatus=tDMChannelStatus, auxPortQLRx=auxPortQLRx, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, eIRP=eIRP, transparentClockPort=transparentClockPort, mainPSUPortAllocation=mainPSUPortAllocation, sNTPServerPortNumber=sNTPServerPortNumber, dataPortPauseFrames=dataPortPauseFrames, transmitFreqKHz=transmitFreqKHz, encryption=encryption, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, alarms=alarms, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseEncryption=licenseEncryption, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagPair3Results=cableDiagPair3Results, productName=productName, sFPPortStatusTrap=sFPPortStatusTrap, masterSlaveMode=masterSlaveMode, cableDiagnosticsGroup=cableDiagnosticsGroup, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRegulatoryBandsList=licenseRegulatoryBandsList, cableDiagPair1Distance=cableDiagPair1Distance, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput)
