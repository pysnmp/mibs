...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, PYSNMP_MODULE_ID=cambium, licenseIssueNumber=licenseIssueNumber, telnetAccessEnabled=telnetAccessEnabled, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPState=sNTPState, tDMInterfaceControl=tDMInterfaceControl, alarms=alarms, mainPSUPortQLTx=mainPSUPortQLTx, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, dfsTableNumber=dfsTableNumber, sNTPServerTable=sNTPServerTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, targetMACAddress=targetMACAddress, tdmTableNumber=tdmTableNumber, snmpControlGroup=snmpControlGroup, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, encryption=encryption, management=management, vLANManagementPriority=vLANManagementPriority, transmitPower=transmitPower, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtpGroup=smtpGroup, regulatoryBand=regulatoryBand, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, notificationsGroup=notificationsGroup, searchState=searchState, licenseCountry=licenseCountry, sNTPLastSync=sNTPLastSync, versions=versions, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair4Distance=cableDiagPair4Distance, dataBridgingAvailability=dataBridgingAvailability, pubStatsGroup=pubStatsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, productName=productName, auxPortAllocation=auxPortAllocation, systemReset=systemReset, dfsMeans=dfsMeans, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, receiveChannel=receiveChannel, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNTPServerRetries=sNTPServerRetries, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, siteName=siteName, sNTPServerTableIndex=sNTPServerTableIndex, softwareVersion=softwareVersion, tDMChannelLoopback=tDMChannelLoopback, sNTPPollInterval=sNTPPollInterval, portAllocationMismatch=portAllocationMismatch, capacityVariantMismatch=capacityVariantMismatch, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, pubStats=pubStats, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licenseSyncESupport=licenseSyncESupport, syncETracking=syncETracking, secondDataPortPauseFrames=secondDataPortPauseFrames, sMTPEnabledMessages=sMTPEnabledMessages, iPv6Address=iPv6Address, mABState=mABState, sNTPServerPortNumber=sNTPServerPortNumber, userTableIndex=userTableIndex, vectorError=vectorError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableNumber=userTableNumber, transparentClockVLAN=transparentClockVLAN, signalStrengthRatio=signalStrengthRatio, lowestTDMModulationMode=lowestTDMModulationMode, ptmp=ptmp, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxColorCode=rxColorCode, sNMPv3Enable=sNMPv3Enable, daylightSaving=daylightSaving, ptpCompliance=ptpCompliance, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagPair2Results=cableDiagPair2Results, targetRange=targetRange, hTTPSPortNumber=hTTPSPortNumber, sMTPEmailAlert=sMTPEmailAlert, licenseTDDSyncSupport=licenseTDDSyncSupport, ptp=ptp, lowestSecondDataModulationMode=lowestSecondDataModulationMode, secureModeAlarm=secureModeAlarm, txColorCode=txColorCode, mABProtocolVID=mABProtocolVID, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapVersion=sNMPTrapVersion, mABMaintenanceLevel=mABMaintenanceLevel, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, iPv4Address=iPv4Address, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, nIDULanPortStatus=nIDULanPortStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, receiveDataRate=receiveDataRate, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mABTransmissionInterval=mABTransmissionInterval, bridge=bridge, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseSecurityLevel=licenseSecurityLevel, eIRP=eIRP, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimization=linkModeOptimization, auxPortConfigurationMismatch=auxPortConfigurationMismatch, versionsGroup=versionsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ptpGroups=ptpGroups, installStatusTrap=installStatusTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, rangingMode=rangingMode, sFPPortSyncERxStatus=sFPPortSyncERxStatus, routerProtocols=routerProtocols, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transparentClockPort=transparentClockPort, tDMChannelCableLength=tDMChannelCableLength, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerStatus=sNTPServerStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, bootVersion=bootVersion, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerTableNumber=sNTPServerTableNumber, dfs=dfs, dfsPeaks=dfsPeaks, userRole=userRole, supplementary=supplementary, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortStatus=mainPSUPortStatus, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseTrialPeriod=licenseTrialPeriod, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, extendedSpectrumScanning=extendedSpectrumScanning, syslogControlGroup=syslogControlGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, syslogStateTrap=syslogStateTrap, txMABFrames=txMABFrames, iPv6GatewayAddress=iPv6GatewayAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, supplementaryGroup=supplementaryGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagPair1Distance=cableDiagPair1Distance, userEnabled=userEnabled, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, sFPPortQLRx=sFPPortQLRx, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsGroup=dfsGroup, antennaGain=antennaGain, enableTransmission=enableTransmission, licenseSFPPortSupport=licenseSFPPortSupport, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mainPSUPortAllocation=mainPSUPortAllocation, tDM=tDM, systemClock=systemClock, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, cableDiagPair3Results=cableDiagPair3Results, tdmTable=tdmTable, vLANManagementVID=vLANManagementVID, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseGroupAccess=licenseGroupAccess, managementGroup=managementGroup, userPassword=userPassword, ethernet=ethernet, tDMChannelStatus=tDMChannelStatus, transmitDataRate=transmitDataRate, regulatoryBandTrap=regulatoryBandTrap, sFPPortStatus=sFPPortStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, accessMethod=accessMethod, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, subbandLowestFrequency=subbandLowestFrequency, configurationGroup=configurationGroup, auxPortDisabledWarning=auxPortDisabledWarning, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortStatus=auxPortStatus, userName=userName, sNTPServerTimeout=sNTPServerTimeout, secondDataBridgingStatus=secondDataBridgingStatus, tdmTableIndex=tdmTableIndex, ptpTrapPrefix=ptpTrapPrefix, mABProtocolVLANPriority=mABProtocolVLANPriority)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dfsTable=dfsTable, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnostics=cableDiagnostics, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, bridgeGroup=bridgeGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, snmpControl=snmpControl, longitude=longitude, l2CPPriorityTable=l2CPPriorityTable, licenseBandwidthCap=licenseBandwidthCap, tFTPServerInternetAddress=tFTPServerInternetAddress, transmitFreqKHz=transmitFreqKHz, license=license, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, channelBandwidth=channelBandwidth, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPError=sFPError, encryptionGroup=encryptionGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, qOSPriorityScheme=qOSPriorityScheme, iPVersion=iPVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, licenseCapacity=licenseCapacity, ethernetPriorityTableEntry=ethernetPriorityTableEntry, altitude=altitude, phyControlGroup=phyControlGroup, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseRARSupport=licenseRARSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, subnetMask=subnetMask, dfsTableEntry=dfsTableEntry, tDMEnabledChannels=tDMEnabledChannels, cableDiagPair3Distance=cableDiagPair3Distance, dfsTableIndex=dfsTableIndex, gatewayIPAddress=gatewayIPAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortQLRx=mainPSUPortQLRx, dataBridgingStatus=dataBridgingStatus, telnetPortNumber=telnetPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, ptp650=ptp650, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair1Results=cableDiagPair1Results, tDMGroup=tDMGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, transparentClock=transparentClock, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortDisabledWarning=sFPPortDisabledWarning, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortStatusTrap=mainPSUPortStatusTrap, syslogClientTrap=syslogClientTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPErrorTrap=sFPErrorTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseOOBManagementSupport=licenseOOBManagementSupport, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, remoteInternetAddress=remoteInternetAddress, maxLinkRangeExceeded=maxLinkRangeExceeded, useVLANForMABProtocol=useVLANForMABProtocol, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transparentClockVID=transparentClockVID, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortAutoMdix=nIDULanPortAutoMdix, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, syslogState=syslogState, configuration=configuration, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortAllocation=sFPPortAllocation, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPTrapTable=sNMPTrapTable, localPacketFiltering=localPacketFiltering, linkLoss=linkLoss, licenseMaxLinkRange=licenseMaxLinkRange, tDMChannelLineCode=tDMChannelLineCode, cambium=cambium, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortQLTx=sFPPortQLTx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, reset=reset, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, capacityVariantMismatchTrap=capacityVariantMismatchTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetGroup=ethernetGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, productVariant=productVariant, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dSCPManagementPriority=dSCPManagementPriority, cableDiagnosticsControl=cableDiagnosticsControl, aAAControl=aAAControl, licenseIPv6Support=licenseIPv6Support, maximumTransmitPower=maximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, resetGroup=resetGroup, ptpTraps=ptpTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syncETrackingState=syncETrackingState, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, userTableEntry=userTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, range=range, wirelessLinkStatus=wirelessLinkStatus, sFPPortStatusTrap=sFPPortStatusTrap, phyStatus=phyStatus, auxPortQLRx=auxPortQLRx, auxPortQLTx=auxPortQLTx, transmitFreqMHz=transmitFreqMHz, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, cableDiagPair4Results=cableDiagPair4Results, secondarySoftwareVersion=secondarySoftwareVersion, alarmsGroup=alarmsGroup, tdmTableEntry=tdmTableEntry, latitude=latitude, auxPortStatusTrap=auxPortStatusTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortPauseFrames=dataPortPauseFrames, sFPPortSSMTx=sFPPortSSMTx, receivePower=receivePower, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveFreqKHz=receiveFreqKHz, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, syslogControl=syslogControl, tDDSynchronizationStatus=tDDSynchronizationStatus, mABNominalModulationMode=mABNominalModulationMode, phyControl=phyControl, auxPortSyncERxStatus=auxPortSyncERxStatus, userTable=userTable, aAAControlGroup=aAAControlGroup, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, installArmState=installArmState, licenseGroup=licenseGroup, routerProtocolsGroup=routerProtocolsGroup, auxPortSSMTx=auxPortSSMTx, tDDControl=tDDControl, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncEEquipmentClock=syncEEquipmentClock, licenseVersion=licenseVersion, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap)
