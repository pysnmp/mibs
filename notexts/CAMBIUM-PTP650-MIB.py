...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", txMABFrames=txMABFrames, syncETracking=syncETracking, userName=userName, iPv6GatewayAddress=iPv6GatewayAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDMChannelStatus=tDMChannelStatus, ptpGroups=ptpGroups, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDM=tDM, sNTPServerInternetAddressType=sNTPServerInternetAddressType, routerProtocolsGroup=routerProtocolsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, transmitDataRate=transmitDataRate, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockPort=transparentClockPort, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortQLTx=sFPPortQLTx, sNTPServerStatus=sNTPServerStatus, portAllocationMismatch=portAllocationMismatch, bridgeGroup=bridgeGroup, phyControl=phyControl, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transparentClockVID=transparentClockVID, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, targetRange=targetRange, ptpCompliance=ptpCompliance, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPLastSync=sNTPLastSync, ptp650=ptp650, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetPriorityTable=ethernetPriorityTable, userEnabled=userEnabled, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mABTransmissionInterval=mABTransmissionInterval, unitOutOfCalibration=unitOutOfCalibration, sFPError=sFPError, txColorCode=txColorCode, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsTableIndex=dfsTableIndex, dfsTable=dfsTable, cableDiagPair1Results=cableDiagPair1Results, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsGroup=cableDiagnosticsGroup, aAAControl=aAAControl, daylightSaving=daylightSaving, ptpTraps=ptpTraps, sntp=sntp, userPassword=userPassword, ethernetPriorityTableIndex=ethernetPriorityTableIndex, localPacketFiltering=localPacketFiltering, mainPSUPortStatus=mainPSUPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABMaintenanceLevel=mABMaintenanceLevel, encryption=encryption, licenseTDDSyncSupport=licenseTDDSyncSupport, snmpControl=snmpControl, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogStateTrap=syslogStateTrap, phyStatus=phyStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mABProtocolVID=mABProtocolVID, pubStatsGroup=pubStatsGroup, altitude=altitude, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hTTPPortNumber=hTTPPortNumber, sFPPortSSMTx=sFPPortSSMTx, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, auxPortStatus=auxPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANManagementPriority=vLANManagementPriority, versionsGroup=versionsGroup, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dfsPeaks=dfsPeaks, configuration=configuration, sNTPServerTable=sNTPServerTable, mainPSUPortQLRx=mainPSUPortQLRx, capacityVariantMismatch=capacityVariantMismatch, groupID=groupID, sMTPServerPortNumber=sMTPServerPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, snmpControlGroup=snmpControlGroup, tDMInterfaceStatus=tDMInterfaceStatus, auxPortQLRx=auxPortQLRx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPrimaryServer=sNTPPrimaryServer, sNTPSync=sNTPSync, masterSlaveMode=masterSlaveMode, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sFPPortStatus=sFPPortStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, secureModeAlarmTrap=secureModeAlarmTrap, remoteInternetAddressType=remoteInternetAddressType, mABNominalModulationMode=mABNominalModulationMode, smtpGroup=smtpGroup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, rxColorCode=rxColorCode, syslogState=syslogState, gatewayIPAddress=gatewayIPAddress, extendedSpectrumScanning=extendedSpectrumScanning, receivePower=receivePower, licenseBandwidthCap=licenseBandwidthCap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, smtp=smtp, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPCommunityString=sNMPCommunityString, sntpGroup=sntpGroup, cableDiagPair2Results=cableDiagPair2Results, tFTPServerInternetAddress=tFTPServerInternetAddress, syslogClientTrap=syslogClientTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, alarms=alarms, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagPair4Results=cableDiagPair4Results, receiveChannel=receiveChannel, dfsGroup=dfsGroup, linkName=linkName, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseCountry=licenseCountry, transmitChannel=transmitChannel, licenseIEEE1588Support=licenseIEEE1588Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, bridge=bridge, notificationsGroup=notificationsGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ptp=ptp, tDMChannelLineCode=tDMChannelLineCode, dataBridgingAvailability=dataBridgingAvailability, sNTPSyncTrap=sNTPSyncTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMInterfaceControl=tDMInterfaceControl, dfsTableEntry=dfsTableEntry, cableDiagnostics=cableDiagnostics, userTableEntry=userTableEntry, cableDiagPair3Results=cableDiagPair3Results, useVLANForMABProtocol=useVLANForMABProtocol, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, installArmStateTrap=installArmStateTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, secureModeAlarm=secureModeAlarm, portAllocationMismatchTrap=portAllocationMismatchTrap, PYSNMP_MODULE_ID=cambium, lowestSecondDataModulationMode=lowestSecondDataModulationMode, range=range, reset=reset, incompatibleRegulatoryBands=incompatibleRegulatoryBands, rawReceivePower=rawReceivePower, tDMChannelCableLength=tDMChannelCableLength, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortAutoMdix=sFPPortAutoMdix, latitude=latitude, tdmTable=tdmTable, rangingMode=rangingMode, phyStatusGroup=phyStatusGroup, linkModeOptimization=linkModeOptimization, tdmTableNumber=tdmTableNumber, userTable=userTable, bootVersion=bootVersion, accessMethod=accessMethod, hardwareVersion=hardwareVersion, sNMPv3Enable=sNMPv3Enable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, softwareVersion=softwareVersion, systemClock=systemClock, sNTPServerTableNumber=sNTPServerTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, qOSPriorityScheme=qOSPriorityScheme, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, syncETrackingState=syncETrackingState, dfs=dfs, linkSymmetry=linkSymmetry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, productName=productName, maximumTransmitPower=maximumTransmitPower, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hTTPSPortNumber=hTTPSPortNumber, dSCPManagementPriority=dSCPManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseEncryption=licenseEncryption, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, management=management, configurationGroup=configurationGroup, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, installStatusTrap=installStatusTrap, cambium=cambium, vectorError=vectorError, productVariant=productVariant, dfsMeans=dfsMeans, systemReset=systemReset, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseGroupAccess=licenseGroupAccess, licenseSFPPortSupport=licenseSFPPortSupport, syslogClient=syslogClient, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseCapacity=licenseCapacity, mABHoldoffPeriod=mABHoldoffPeriod, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, supplementary=supplementary, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseIPv6Support=licenseIPv6Support, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernet=ethernet, tDMGroup=tDMGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTableIndex=userTableIndex, cableDiagnosticsWarning=cableDiagnosticsWarning, userRole=userRole, auxPortDisabledWarning=auxPortDisabledWarning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, supplementaryGroup=supplementaryGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, routerProtocols=routerProtocols, cableDiagPair1Distance=cableDiagPair1Distance, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transparentClock=transparentClock, licenseMaxLinkRange=licenseMaxLinkRange, tDDControlGroup=tDDControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tdmTableIndex=tdmTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, aAAControlGroup=aAAControlGroup, licenseVersion=licenseVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, cableDiagPair3Distance=cableDiagPair3Distance, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, managementGroup=managementGroup, subbandLowestFrequency=subbandLowestFrequency, versions=versions, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tdmTableEntry=tdmTableEntry, sNTPPollInterval=sNTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transparentClockVLAN=transparentClockVLAN, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPState=sNTPState, sNTPServerTableEntry=sNTPServerTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, telnetPortNumber=telnetPortNumber, licenseGroup=licenseGroup, mainPSUPortQLTx=mainPSUPortQLTx, tDDSynchronizationMode=tDDSynchronizationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, encryptionGroup=encryptionGroup, license=license, sNMPEnabledTraps=sNMPEnabledTraps, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPv4Address=iPv4Address, managementPortWirelessDownAlert=managementPortWirelessDownAlert, licenseSyncESupport=licenseSyncESupport, sMTPEmailAlert=sMTPEmailAlert, iPv6PrefixLength=iPv6PrefixLength, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortAllocation=mainPSUPortAllocation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, secondDataBridgingStatus=secondDataBridgingStatus, receiveModulationModeDetail=receiveModulationModeDetail, mABState=mABState, wirelessLinkAvailability=wirelessLinkAvailability, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagnosticsPorts=cableDiagnosticsPorts, syslogControlGroup=syslogControlGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMChannelLoopback=tDMChannelLoopback, resetGroup=resetGroup, enableTransmission=enableTransmission, iPv6Address=iPv6Address, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, l2CPPriorityTable=l2CPPriorityTable, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseRARSupport=licenseRARSupport, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortStatusTrap=sFPPortStatusTrap, sNTPServerTimeout=sNTPServerTimeout, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, pubStats=pubStats, transmitFreqKHz=transmitFreqKHz, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortStatusTrap=auxPortStatusTrap, phyControlGroup=phyControlGroup, auxPortAllocation=auxPortAllocation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, remoteInternetAddress=remoteInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, installStatus=installStatus, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, timeZone=timeZone, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortSSMTx=auxPortSSMTx, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, syslogControl=syslogControl, searchState=searchState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBand=regulatoryBand, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, aggregateDataRate=aggregateDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagnosticsControl=cableDiagnosticsControl, channelChangeTrap=channelChangeTrap, receiveDataRate=receiveDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortQLRx=sFPPortQLRx, sNTPServerTableIndex=sNTPServerTableIndex, lowestDataModulationMode=lowestDataModulationMode, syncEEquipmentClock=syncEEquipmentClock, siteName=siteName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPErrorTrap=sFPErrorTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, dfsTableNumber=dfsTableNumber, longitude=longitude, sFPPortAllocation=sFPPortAllocation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseIssueNumber=licenseIssueNumber, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, ethernetGroup=ethernetGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, regulatoryBandTrap=regulatoryBandTrap, installArmState=installArmState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDDControl=tDDControl, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseOOBManagementSupport=licenseOOBManagementSupport, nIDULanPortStatus=nIDULanPortStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortQLTx=auxPortQLTx, alarmsGroup=alarmsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, channelBandwidth=channelBandwidth, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSSMTx=mainPSUPortSSMTx, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm)
