...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortQLRx=auxPortQLRx, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cableDiagPair2Distance=cableDiagPair2Distance, tDMChannelCableLength=tDMChannelCableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dataPortPauseFrames=dataPortPauseFrames, dfsPeaks=dfsPeaks, managementGroup=managementGroup, tDMGroup=tDMGroup, dfsTableEntry=dfsTableEntry, tDMChannelLoopback=tDMChannelLoopback, dfsGroup=dfsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, lowestSecondDataModulationMode=lowestSecondDataModulationMode, subnetMask=subnetMask, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseGroup=licenseGroup, lowestDataModulationMode=lowestDataModulationMode, tDMEnabledChannels=tDMEnabledChannels, sNTPLastSync=sNTPLastSync, targetMACAddress=targetMACAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseTrialPeriod=licenseTrialPeriod, cableDiagPair3Distance=cableDiagPair3Distance, snmpControl=snmpControl, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair4Distance=cableDiagPair4Distance, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, iPv6GatewayAddress=iPv6GatewayAddress, iPv6PrefixLength=iPv6PrefixLength, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, bootVersion=bootVersion, auxPortStatus=auxPortStatus, cableDiagPair3Results=cableDiagPair3Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, cableDiagPair4Results=cableDiagPair4Results, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddress=remoteInternetAddress, smtpGroup=smtpGroup, ptp=ptp, sNMPTrapTable=sNMPTrapTable, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, antennaGain=antennaGain, sntp=sntp, byteErrorRatio=byteErrorRatio, transparentClock=transparentClock, sntpGroup=sntpGroup, altitude=altitude, aggregateDataRate=aggregateDataRate, sNMPCommunityString=sNMPCommunityString, reset=reset, licenseSFPPortSupport=licenseSFPPortSupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortQLTx=mainPSUPortQLTx, licenseEncryption=licenseEncryption, secureModeAlarm=secureModeAlarm, sNTPSync=sNTPSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, systemReset=systemReset, mABTransmissionInterval=mABTransmissionInterval, management=management, dataBridgingStatusAlarm=dataBridgingStatusAlarm, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, telnetPortNumber=telnetPortNumber, sFPPortQLRx=sFPPortQLRx, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, transmitChannel=transmitChannel, tdmTableEntry=tdmTableEntry, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, pubStatsGroup=pubStatsGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveDataRate=receiveDataRate, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, snmpControlGroup=snmpControlGroup, auxPortAllocation=auxPortAllocation, qOSPriorityScheme=qOSPriorityScheme, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, sFPPortStatus=sFPPortStatus, licenseCountry=licenseCountry, tdmTable=tdmTable, localPacketFiltering=localPacketFiltering, userEnabled=userEnabled, transmitPower=transmitPower, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, mABHoldoffPeriod=mABHoldoffPeriod, userPassword=userPassword, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, siteName=siteName, encryptionGroup=encryptionGroup, dSCPManagementPriority=dSCPManagementPriority, auxPortDisabledWarning=auxPortDisabledWarning, iPv6Address=iPv6Address, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPErrorTrap=sFPErrorTrap, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPPortSSMTx=sFPPortSSMTx, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ptp650=ptp650, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagPair1Distance=cableDiagPair1Distance, groupID=groupID, syncEEquipmentClock=syncEEquipmentClock, licenseBandwidthCap=licenseBandwidthCap, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityTable=ethernetPriorityTable, bridgeGroup=bridgeGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortQLTx=sFPPortQLTx, signalStrengthRatio=signalStrengthRatio, cableDiagPair2Results=cableDiagPair2Results, cambium=cambium, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseIPv6Support=licenseIPv6Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseSecurityLevel=licenseSecurityLevel, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, targetRange=targetRange, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, configuration=configuration, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, bridge=bridge, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnostics=cableDiagnostics, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, latitude=latitude, pubStats=pubStats, mABNominalModulationMode=mABNominalModulationMode, iPv4Address=iPv4Address, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTableIndex=sNTPServerTableIndex, eIRP=eIRP, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, aAAControlGroup=aAAControlGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair1Results=cableDiagPair1Results, l2CPPriorityTable=l2CPPriorityTable, transparentClockPort=transparentClockPort, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseRARSupport=licenseRARSupport, subbandHighestFrequency=subbandHighestFrequency, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, vectorError=vectorError, linkName=linkName, tdmTableNumber=tdmTableNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, secondDataBridgingStatus=secondDataBridgingStatus, tDMInterfaceControl=tDMInterfaceControl, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpCompliance=ptpCompliance, receivePower=receivePower, sNTPSyncTrap=sNTPSyncTrap, subbandLowestFrequency=subbandLowestFrequency, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortAllocation=sFPPortAllocation, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, userTable=userTable, alarmsGroup=alarmsGroup, mABMaintenanceLevel=mABMaintenanceLevel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, syncETracking=syncETracking, sFPError=sFPError, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarms=alarms, productName=productName, sFPPortAutoMdix=sFPPortAutoMdix, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseTDDSyncSupport=licenseTDDSyncSupport, dataBridgingStatus=dataBridgingStatus, dataBridgingAvailability=dataBridgingAvailability, productVariant=productVariant, mainPSUPortQLRx=mainPSUPortQLRx, transparentClockVLAN=transparentClockVLAN, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, userTableIndex=userTableIndex, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, supplementary=supplementary, vLANManagementVID=vLANManagementVID, secondDataPortPauseFrames=secondDataPortPauseFrames, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, transmitFreqMHz=transmitFreqMHz, tDMChannelStatus=tDMChannelStatus, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, systemClock=systemClock, linkSymmetry=linkSymmetry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortStatusTrap=sFPPortStatusTrap, PYSNMP_MODULE_ID=cambium, ptpTrapPrefix=ptpTrapPrefix, transparentClockVID=transparentClockVID, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", wirelessLinkAvailability=wirelessLinkAvailability, ethernet=ethernet, encryption=encryption, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsMeans=dfsMeans, licenseIssueNumber=licenseIssueNumber, mainPSUPortAllocation=mainPSUPortAllocation, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, regulatoryBandTrap=regulatoryBandTrap, frequencyVariant=frequencyVariant, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseSyncESupport=licenseSyncESupport, tDM=tDM, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, mABProtocolVID=mABProtocolVID, rxColorCode=rxColorCode, syslogClientTrap=syslogClientTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, iPVersion=iPVersion, sNTPServerInternetAddress=sNTPServerInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, portAllocationMismatch=portAllocationMismatch, useVLANForMABProtocol=useVLANForMABProtocol, receiveChannel=receiveChannel, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitModulationMode=transmitModulationMode, accessMethod=accessMethod, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogState=syslogState, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, installStatusTrap=installStatusTrap, ethernetGroup=ethernetGroup, cableDiagnosticsControl=cableDiagnosticsControl, dfsTableIndex=dfsTableIndex, licenseVersion=licenseVersion, resetGroup=resetGroup, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, mainPSUPortSSMTx=mainPSUPortSSMTx, phyControlGroup=phyControlGroup, searchState=searchState, sFPPortDisabledWarning=sFPPortDisabledWarning, license=license, rangingMode=rangingMode, cableLoss=cableLoss, auxPortSyncERxStatus=auxPortSyncERxStatus, txColorCode=txColorCode, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transmitDataRate=transmitDataRate, tDMInterfaceStatus=tDMInterfaceStatus, channelChangeTrap=channelChangeTrap, mABState=mABState, sNTPServerTableNumber=sNTPServerTableNumber, userRole=userRole, sFPPortAutoNegotiation=sFPPortAutoNegotiation, channelBandwidth=channelBandwidth, tFTPServerInternetAddress=tFTPServerInternetAddress, notificationsGroup=notificationsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkLoss=linkLoss, sNTPPollInterval=sNTPPollInterval, syslogStateTrap=syslogStateTrap, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, rawReceivePower=rawReceivePower, aAAControl=aAAControl, licenseIEEE1588Support=licenseIEEE1588Support, installStatus=installStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortQLTx=auxPortQLTx, mABProtocolVLANPriority=mABProtocolVLANPriority, userTableNumber=userTableNumber, userName=userName, linkModeOptimization=linkModeOptimization, sNTPState=sNTPState, routerProtocolsGroup=routerProtocolsGroup, syncETrackingState=syncETrackingState, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, noWirelessChannelAvailable=noWirelessChannelAvailable, regulatoryBand=regulatoryBand, daylightSaving=daylightSaving, configurationGroup=configurationGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, timeZone=timeZone, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, routerProtocols=routerProtocols, enableTransmission=enableTransmission, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tdmTableIndex=tdmTableIndex, licenseGroupAccess=licenseGroupAccess, licenseMaxLinkRange=licenseMaxLinkRange, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mainPSUPortStatus=mainPSUPortStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secureModeAlarmTrap=secureModeAlarmTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, syslogControl=syslogControl, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTable=sNTPServerTable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, auxPortSSMTx=auxPortSSMTx, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTraps=ptpTraps, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, capacityVariantMismatch=capacityVariantMismatch, installArmState=installArmState, longitude=longitude, phyStatusGroup=phyStatusGroup, syslogClient=syslogClient, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, smtp=smtp, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, portAllocationMismatchTrap=portAllocationMismatchTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ptmp=ptmp, receiveModulationMode=receiveModulationMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDDControlGroup=tDDControlGroup, tDDControl=tDDControl, versions=versions, licenseCapacity=licenseCapacity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, txMABFrames=txMABFrames, phyControl=phyControl, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseRegulatoryBandsList=licenseRegulatoryBandsList, versionsGroup=versionsGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, userTableEntry=userTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, maxLinkRangeExceeded=maxLinkRangeExceeded, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, wirelessLinkStatus=wirelessLinkStatus)
