...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, hardwareVersion=hardwareVersion, managementNetworkAccessEnabled=managementNetworkAccessEnabled, secondDataBridgingStatus=secondDataBridgingStatus, ptpGroups=ptpGroups, licenseMaxLinkRange=licenseMaxLinkRange, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseCapacity=licenseCapacity, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPErrorTrap=sFPErrorTrap, telnetAccessEnabled=telnetAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortStatus=mainPSUPortStatus, subbandLowestFrequency=subbandLowestFrequency, licenseBandwidthCap=licenseBandwidthCap, rawReceivePower=rawReceivePower, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, tdmTableEntry=tdmTableEntry, secondDataPortPauseFrames=secondDataPortPauseFrames, vectorError=vectorError, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerTableNumber=sNTPServerTableNumber, userTableIndex=userTableIndex, licenseRARSupport=licenseRARSupport, mABMaintenanceLevel=mABMaintenanceLevel, licenseTrialPeriod=licenseTrialPeriod, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNTPState=sNTPState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptp=ptp, configuration=configuration, PYSNMP_MODULE_ID=cambium, ethernetPriorityTableIndex=ethernetPriorityTableIndex, groupID=groupID, installArmStateTrap=installArmStateTrap, sNTPServerStatus=sNTPServerStatus, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, accessMethod=accessMethod, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dataBridgingStatus=dataBridgingStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfsTableNumber=dfsTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagPair2Results=cableDiagPair2Results, encryptionAlgorithm=encryptionAlgorithm, daylightSaving=daylightSaving, masterSlaveMode=masterSlaveMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestSecondDataModulationMode=lowestSecondDataModulationMode, snmpControlGroup=snmpControlGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, userEnabled=userEnabled, alarms=alarms, sFPPortSSMTx=sFPPortSSMTx, tDMChannelLineCode=tDMChannelLineCode, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, regulatoryBand=regulatoryBand, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tdmTableIndex=tdmTableIndex, bootVersion=bootVersion, mABTransmissionInterval=mABTransmissionInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, linkName=linkName, transmitFreqMHz=transmitFreqMHz, sMTPServerInternetAddress=sMTPServerInternetAddress, supplementary=supplementary, sntp=sntp, dfsTableIndex=dfsTableIndex, syncEEquipmentClock=syncEEquipmentClock, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, management=management, snmpControl=snmpControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogClient=syslogClient, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cableDiagPair2Distance=cableDiagPair2Distance, latitude=latitude, cableDiagPair3Distance=cableDiagPair3Distance, remoteInternetAddress=remoteInternetAddress, sMTPEmailAlert=sMTPEmailAlert, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, signalStrengthRatio=signalStrengthRatio, transparentClock=transparentClock, routerProtocolsGroup=routerProtocolsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, syslogStateTrap=syslogStateTrap, rxColorCode=rxColorCode, auxPortStatus=auxPortStatus, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMGroup=tDMGroup, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, frequencyVariant=frequencyVariant, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, siteName=siteName, sFPPortStatusTrap=sFPPortStatusTrap, receiveModulationMode=receiveModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseGroupAccess=licenseGroupAccess, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, installStatus=installStatus, subbandHighestFrequency=subbandHighestFrequency, licenseIEEE1588Support=licenseIEEE1588Support, auxPortAllocation=auxPortAllocation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, lowestTDMModulationMode=lowestTDMModulationMode, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityTable=l2CPPriorityTable, licenseSyncESupport=licenseSyncESupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseGroup=licenseGroup, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, license=license, routerProtocols=routerProtocols, phyControlGroup=phyControlGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, receiveFreqMHz=receiveFreqMHz, sNTPServerRetries=sNTPServerRetries, userTable=userTable, ptpTraps=ptpTraps, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, timeZone=timeZone, antennaGain=antennaGain, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, configurationGroup=configurationGroup, bridge=bridge, sMTPServerPortNumber=sMTPServerPortNumber, range=range, sNTPLastSync=sNTPLastSync, auxPortQLTx=auxPortQLTx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerTable=sNTPServerTable, sFPPortAllocation=sFPPortAllocation, regulatoryBandTrap=regulatoryBandTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortAllocation=mainPSUPortAllocation, pubStats=pubStats, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, searchState=searchState, gatewayIPAddress=gatewayIPAddress, licenseEncryption=licenseEncryption, licenseCountry=licenseCountry, transparentClockPort=transparentClockPort, tDM=tDM, txMABFrames=txMABFrames, sNTPPrimaryServer=sNTPPrimaryServer, linkModeOptimization=linkModeOptimization, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ethernetPriorityTable=ethernetPriorityTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, sFPError=sFPError, vLANManagementVID=vLANManagementVID, sNTPServerTableEntry=sNTPServerTableEntry, dataBridgingAvailability=dataBridgingAvailability, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, iPv4Address=iPv4Address, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, systemClock=systemClock, ptmp=ptmp, telnetPortNumber=telnetPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseSecurityLevel=licenseSecurityLevel, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, receiveFreqKHz=receiveFreqKHz, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syncETrackingState=syncETrackingState, cableDiagPair1Results=cableDiagPair1Results, ptpCompliance=ptpCompliance, reset=reset, dfsMeans=dfsMeans, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, smtpGroup=smtpGroup, secureModeAlarm=secureModeAlarm, longitude=longitude, userTableEntry=userTableEntry, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair4Distance=cableDiagPair4Distance, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, receiveChannel=receiveChannel, receivePower=receivePower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessLinkAvailability=wirelessLinkAvailability, bridgeGroup=bridgeGroup, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockVID=transparentClockVID, tDMChannelStatus=tDMChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dfsGroup=dfsGroup, tDMInterfaceControl=tDMInterfaceControl, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, mainPSUPortQLTx=mainPSUPortQLTx, aAAControl=aAAControl)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortSyncERxStatus=auxPortSyncERxStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, iPv6PrefixLength=iPv6PrefixLength, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControl=phyControl, iPVersion=iPVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortSyncERxStatus=sFPPortSyncERxStatus, lowestDataModulationMode=lowestDataModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagnosticsControl=cableDiagnosticsControl, remoteInternetAddressType=remoteInternetAddressType, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortStatusTrap=auxPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseIssueNumber=licenseIssueNumber, tDMEnabledChannels=tDMEnabledChannels, syslogState=syslogState, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, capacityVariantMismatchTrap=capacityVariantMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, cableDiagPair4Results=cableDiagPair4Results, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, versions=versions, ptp650=ptp650, smtp=smtp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, txColorCode=txColorCode, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, capacityVariantMismatch=capacityVariantMismatch, targetRange=targetRange, sFPPortDisabledWarning=sFPPortDisabledWarning, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maxLinkRangeExceeded=maxLinkRangeExceeded, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseVersion=licenseVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, nIDULanPortStatus=nIDULanPortStatus, cableDiagPair3Results=cableDiagPair3Results, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsPeaks=dfsPeaks, licenseIPv6Support=licenseIPv6Support, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, oOBPriorityQueueMapping=oOBPriorityQueueMapping, rangingMode=rangingMode, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, pubStatsGroup=pubStatsGroup, mABNominalModulationMode=mABNominalModulationMode, cableLoss=cableLoss, receiveDataRate=receiveDataRate, installArmState=installArmState, sNTPServerInternetAddress=sNTPServerInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControl=syslogControl, productVariant=productVariant, iPv6GatewayAddress=iPv6GatewayAddress, mainPSUPortSSMTx=mainPSUPortSSMTx, mABState=mABState, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABHoldoffPeriod=mABHoldoffPeriod, byteErrorRatio=byteErrorRatio, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, cambium=cambium, dfsTableEntry=dfsTableEntry, userName=userName, transmitFreqKHz=transmitFreqKHz, tDMInterfaceStatus=tDMInterfaceStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, mABProtocolVID=mABProtocolVID, sFPPortAutoNegotiation=sFPPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup, auxPortDisabledWarning=auxPortDisabledWarning, userTableNumber=userTableNumber, cableDiagnosticsWarning=cableDiagnosticsWarning, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernet=ethernet, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnostics=cableDiagnostics, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, portAllocationMismatch=portAllocationMismatch, versionsGroup=versionsGroup, channelBandwidth=channelBandwidth, sFPPortStatus=sFPPortStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMChannelLoopback=tDMChannelLoopback, sntpGroup=sntpGroup, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, supplementaryGroup=supplementaryGroup, syncETracking=syncETracking, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sNTPPollInterval=sNTPPollInterval, syslogControlGroup=syslogControlGroup, iPDSCPPriorityTable=iPDSCPPriorityTable, dSCPManagementPriority=dSCPManagementPriority, sNTPSync=sNTPSync, dataPortPauseFrames=dataPortPauseFrames, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tDDControl=tDDControl, targetMACAddress=targetMACAddress, tdmTable=tdmTable, sFPPortQLRx=sFPPortQLRx, sNMPv3Enable=sNMPv3Enable, subnetMask=subnetMask, qOSPriorityScheme=qOSPriorityScheme, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tdmTableNumber=tdmTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, notificationsGroup=notificationsGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, linkSymmetry=linkSymmetry, auxPortQLRx=auxPortQLRx, transmitDataRate=transmitDataRate, localPacketFiltering=localPacketFiltering, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelStatusTrap=tDMChannelStatusTrap, transparentClockVLAN=transparentClockVLAN, encryption=encryption, sFPPortQLTx=sFPPortQLTx, auxPortSSMTx=auxPortSSMTx, eIRP=eIRP, installStatusTrap=installStatusTrap, dfsTable=dfsTable, secureModeAlarmTrap=secureModeAlarmTrap, systemReset=systemReset, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
