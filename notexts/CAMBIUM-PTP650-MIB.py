...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, mABState=mABState, installStatusTrap=installStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, capacityVariantMismatch=capacityVariantMismatch, snmpControl=snmpControl, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tdmTable=tdmTable, sFPPortDisabledWarning=sFPPortDisabledWarning, tDMInterfaceStatus=tDMInterfaceStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortStatus=sFPPortStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryptionGroup=encryptionGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, accessMethod=accessMethod, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelBandwidth=channelBandwidth, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortConfigurationMismatch=auxPortConfigurationMismatch, ethernetGroup=ethernetGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dSCPManagementPriority=dSCPManagementPriority, tDMChannelLoopback=tDMChannelLoopback, sNTPServerStatus=sNTPServerStatus, ptmp=ptmp, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, receiveChannel=receiveChannel, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, regulatoryBandTrap=regulatoryBandTrap, syslogClient=syslogClient, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, receiveFreqMHz=receiveFreqMHz, sntp=sntp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, byteErrorRatio=byteErrorRatio, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarm=secureModeAlarm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sMTPEmailAlert=sMTPEmailAlert, searchState=searchState, mABTransmissionInterval=mABTransmissionInterval, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mABProtocolVID=mABProtocolVID, dfsMeans=dfsMeans, userTable=userTable, tdmTableNumber=tdmTableNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseEncryption=licenseEncryption, sNTPServerPortNumber=sNTPServerPortNumber, licenseCountry=licenseCountry, masterSlaveMode=masterSlaveMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, txColorCode=txColorCode, licenseBandwidthCap=licenseBandwidthCap, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortQLTx=mainPSUPortQLTx, PYSNMP_MODULE_ID=cambium, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPLastSync=sNTPLastSync, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, maximumTransmitPower=maximumTransmitPower, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transparentClockVID=transparentClockVID, sNTPServerRetries=sNTPServerRetries, tdmTableEntry=tdmTableEntry, sFPPortQLRx=sFPPortQLRx, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerInternetAddressType=sMTPServerInternetAddressType, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortDisabledWarning=auxPortDisabledWarning, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, receiveDataRate=receiveDataRate, nIDULanPortAutoMdix=nIDULanPortAutoMdix, resetGroup=resetGroup, iPv6GatewayAddress=iPv6GatewayAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortQLTx=sFPPortQLTx, supplementary=supplementary, sNMPPortNumber=sNMPPortNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, ethernetPriorityTable=ethernetPriorityTable, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, configuration=configuration, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, bridgeGroup=bridgeGroup, remoteInternetAddress=remoteInternetAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userPassword=userPassword, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPState=sNTPState, pubStats=pubStats, syslogState=syslogState, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, altitude=altitude, phyStatus=phyStatus, iPVersion=iPVersion, licenseMaxLinkRange=licenseMaxLinkRange, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsTable=dfsTable, subnetMask=subnetMask, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibration=unitOutOfCalibration, targetRange=targetRange, dfsTableNumber=dfsTableNumber, phyControlGroup=phyControlGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, enableTransmission=enableTransmission, ptp=ptp, targetMACAddress=targetMACAddress, syncETrackingState=syncETrackingState, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, transmitModulationMode=transmitModulationMode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, supplementaryGroup=supplementaryGroup, productVariant=productVariant, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPTrapTable=sNMPTrapTable, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, sNMPTrapVersion=sNMPTrapVersion, signalStrengthRatio=signalStrengthRatio, tDDControl=tDDControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, userRole=userRole, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, mainPSUPortStatusTrap=mainPSUPortStatusTrap, installArmState=installArmState, sNMPCommunityString=sNMPCommunityString, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transparentClockVLAN=transparentClockVLAN, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseVersion=licenseVersion, licenseIPv6Support=licenseIPv6Support, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, licenseGroup=licenseGroup, mPLSTCPriorityTable=mPLSTCPriorityTable, transparentClockPort=transparentClockPort, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortSSMTx=sFPPortSSMTx, cableDiagPair4Distance=cableDiagPair4Distance, dataBridgingStatus=dataBridgingStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, latitude=latitude, groupID=groupID, localPacketFiltering=localPacketFiltering, managementNetworkAccessEnabled=managementNetworkAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, cableDiagPair2Distance=cableDiagPair2Distance, encryption=encryption, hardwareVersion=hardwareVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseTrialPeriod=licenseTrialPeriod, aggregateDataRate=aggregateDataRate, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, rxColorCode=rxColorCode, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDMChannelCableLength=tDMChannelCableLength, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseSecurityLevel=licenseSecurityLevel, syslogControl=syslogControl, installStatus=installStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, routerProtocolsGroup=routerProtocolsGroup, auxPortStatus=auxPortStatus, phyStatusGroup=phyStatusGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortStatusTrap=auxPortStatusTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, versions=versions, syslogClientTrap=syslogClientTrap, qOSPriorityScheme=qOSPriorityScheme, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, auxPortAllocation=auxPortAllocation, sFPPortAutoMdix=sFPPortAutoMdix, systemReset=systemReset, range=range, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, userTableIndex=userTableIndex, syslogControlGroup=syslogControlGroup, installArmStateTrap=installArmStateTrap, iPv4Address=iPv4Address, userTableNumber=userTableNumber, systemClock=systemClock, secondDataPortPauseFrames=secondDataPortPauseFrames, hTTPPortNumber=hTTPPortNumber, auxPortSSMTx=auxPortSSMTx, extendedSpectrumScanning=extendedSpectrumScanning, ptp650=ptp650, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseSFPPortSupport=licenseSFPPortSupport, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPError=sFPError, channelChangeTrap=channelChangeTrap, productName=productName, telnetAccessEnabled=telnetAccessEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsGroup=dfsGroup, snmpControlGroup=snmpControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", ethernet=ethernet, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, daylightSaving=daylightSaving, vLANManagementVID=vLANManagementVID, mABNominalModulationMode=mABNominalModulationMode, longitude=longitude, cableLoss=cableLoss, tDMEnabledChannels=tDMEnabledChannels, receiveModulationMode=receiveModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDM=tDM, cableDiagnosticsControl=cableDiagnosticsControl, rawReceivePower=rawReceivePower, sNTPSync=sNTPSync, sFPErrorTrap=sFPErrorTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, pubStatsGroup=pubStatsGroup, sNTPServerTableNumber=sNTPServerTableNumber, management=management, sFPPortAllocation=sFPPortAllocation, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseCapacity=licenseCapacity, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regulatoryBand=regulatoryBand, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagPair1Distance=cableDiagPair1Distance, tFTPServerPortNumber=tFTPServerPortNumber, subbandLowestFrequency=subbandLowestFrequency, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syncETracking=syncETracking, configurationGroup=configurationGroup, cableDiagPair3Distance=cableDiagPair3Distance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, linkSymmetry=linkSymmetry, tDMGroup=tDMGroup, nIDULanPortStatus=nIDULanPortStatus, sNTPPrimaryServer=sNTPPrimaryServer, wirelessLinkAvailability=wirelessLinkAvailability, softwareVersion=softwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseIssueNumber=licenseIssueNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNTPServerTable=sNTPServerTable, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, dataBridgingAvailability=dataBridgingAvailability, lowestDataModulationMode=lowestDataModulationMode, useVLANForMABProtocol=useVLANForMABProtocol, bootVersion=bootVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocols=routerProtocols, sFPPortStatusTrap=sFPPortStatusTrap, mABMaintenanceLevel=mABMaintenanceLevel, tDMChannelStatus=tDMChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagnostics=cableDiagnostics, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, siteName=siteName, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, vectorError=vectorError, portAllocationMismatch=portAllocationMismatch, secondDataBridgingStatus=secondDataBridgingStatus, transparentClock=transparentClock, cableDiagPair4Results=cableDiagPair4Results, sNTPSyncTrap=sNTPSyncTrap, timeZone=timeZone, linkLoss=linkLoss, sNMPv3Enable=sNMPv3Enable, userEnabled=userEnabled, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseTDDSyncSupport=licenseTDDSyncSupport, syncEEquipmentClock=syncEEquipmentClock, licenseUnitSerialNumber=licenseUnitSerialNumber, cambium=cambium, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControl=phyControl, subbandHighestFrequency=subbandHighestFrequency, licenseSyncESupport=licenseSyncESupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bridge=bridge, reset=reset, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, auxPortQLTx=auxPortQLTx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataBridgingStatusAlarm=dataBridgingStatusAlarm, smtpGroup=smtpGroup, sNTPServerTimeout=sNTPServerTimeout, linkModeOptimization=linkModeOptimization, smtp=smtp, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsTableEntry=dfsTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, lowestSecondDataModulationMode=lowestSecondDataModulationMode, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseRARSupport=licenseRARSupport, tDMChannelLineCode=tDMChannelLineCode, rangingMode=rangingMode, mABProtocolVLANPriority=mABProtocolVLANPriority, iPv6Address=iPv6Address, transmitDataRate=transmitDataRate, dfs=dfs, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMConfigurationMismatch=tDMConfigurationMismatch, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveModulationModeDetail=receiveModulationModeDetail, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, license=license, cableDiagPair3Results=cableDiagPair3Results, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mABNominalTransmitCapacity=mABNominalTransmitCapacity, lowestTDMModulationMode=lowestTDMModulationMode, tFTPServerInternetAddress=tFTPServerInternetAddress, versionsGroup=versionsGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, gatewayIPAddress=gatewayIPAddress, linkName=linkName, licenseGroupAccess=licenseGroupAccess, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, tDDControlGroup=tDDControlGroup, dataPortPauseFrames=dataPortPauseFrames, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTableNumber=l2CPPriorityTableNumber, telnetPortNumber=telnetPortNumber, transmitPower=transmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerTableIndex=sNTPServerTableIndex, alarms=alarms, receivePower=receivePower, transmitChannel=transmitChannel, tdmTableIndex=tdmTableIndex, managementGroup=managementGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortQLRx=auxPortQLRx, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mABHoldoffPeriod=mABHoldoffPeriod, portAllocationMismatchTrap=portAllocationMismatchTrap, dfsPeaks=dfsPeaks, vLANManagementPriority=vLANManagementPriority, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagPair2Results=cableDiagPair2Results, aAAControl=aAAControl, userTableEntry=userTableEntry, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, txMABFrames=txMABFrames, tDMInterfaceControl=tDMInterfaceControl, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, userName=userName)
