...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, txColorCode=txColorCode, userTableEntry=userTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dfsPeaks=dfsPeaks, wirelessLinkAvailability=wirelessLinkAvailability, mainPSUPortStatus=mainPSUPortStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAllocation=sFPPortAllocation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, unitOutOfCalibration=unitOutOfCalibration, configurationGroup=configurationGroup, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, routerProtocolsGroup=routerProtocolsGroup, cableDiagPair3Distance=cableDiagPair3Distance, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, enableTransmission=enableTransmission, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, alarms=alarms, receivePower=receivePower, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControl=phyControl, lowestSecondDataModulationMode=lowestSecondDataModulationMode, encryption=encryption, systemClock=systemClock, tdmTable=tdmTable, bridge=bridge, sNMPEnabledTraps=sNMPEnabledTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, ethernet=ethernet, installArmStateTrap=installArmStateTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, vectorError=vectorError, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsTableEntry=dfsTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, regulatoryBand=regulatoryBand, cableDiagPair4Distance=cableDiagPair4Distance, configuration=configuration, cableDiagnostics=cableDiagnostics, cableDiagnosticsGroup=cableDiagnosticsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseSecurityLevel=licenseSecurityLevel, licenseSFPPortSupport=licenseSFPPortSupport, licenseIPv6Support=licenseIPv6Support, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, installArmState=installArmState, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, auxPortQLTx=auxPortQLTx, transmitChannel=transmitChannel, ptp=ptp, tDDSynchronizationMode=tDDSynchronizationMode, daylightSaving=daylightSaving, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestTDMModulationMode=lowestTDMModulationMode, sntp=sntp, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, bootVersion=bootVersion, sFPPortQLRx=sFPPortQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dfsGroup=dfsGroup, auxPortQLRx=auxPortQLRx, management=management, receiveFreqKHz=receiveFreqKHz, ethernetPriorityTableIndex=ethernetPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseGroup=licenseGroup, timeZone=timeZone, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortStatus=auxPortStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transparentClockVLAN=transparentClockVLAN, tDMEnabledChannels=tDMEnabledChannels, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkName=linkName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, userEnabled=userEnabled, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPv6PrefixLength=iPv6PrefixLength, tDMChannelCableLength=tDMChannelCableLength, sNTPServerTable=sNTPServerTable, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tdmTableEntry=tdmTableEntry, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMChannelLineCode=tDMChannelLineCode, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapTableNumber=sNMPTrapTableNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, syncEEquipmentClock=syncEEquipmentClock, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingAvailability=dataBridgingAvailability, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cambium=cambium, sMTPServerInternetAddress=sMTPServerInternetAddress, transmitDataRate=transmitDataRate, lowestDataModulationMode=lowestDataModulationMode, mABTransmissionInterval=mABTransmissionInterval, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, licenseTrialPeriod=licenseTrialPeriod, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortAllocation=mainPSUPortAllocation, secureModeAlarmTrap=secureModeAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDControl=tDDControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dataBridgingStatusAlarm=dataBridgingStatusAlarm, transparentClockPort=transparentClockPort, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, rxColorCode=rxColorCode, cableDiagPair1Distance=cableDiagPair1Distance, sNTPServerStatus=sNTPServerStatus, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitFreqKHz=transmitFreqKHz, ptmp=ptmp, l2CPPriorityTableEntry=l2CPPriorityTableEntry, routerProtocols=routerProtocols, userTableNumber=userTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, useVLANForMABProtocol=useVLANForMABProtocol, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dSCPManagementPriority=dSCPManagementPriority, iPv4Address=iPv4Address, tFTPServerInternetAddress=tFTPServerInternetAddress, auxPortSSMTx=auxPortSSMTx, qOSPriorityScheme=qOSPriorityScheme, antennaGain=antennaGain, sFPError=sFPError, vLANManagementVID=vLANManagementVID, syslogControlGroup=syslogControlGroup, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPCommunityString=sNMPCommunityString, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, sNTPServerRetries=sNTPServerRetries, sFPPortAutoMdix=sFPPortAutoMdix, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortQLTx=sFPPortQLTx, versionsGroup=versionsGroup, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, ethernetPriorityTable=ethernetPriorityTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, supplementary=supplementary, tDDControlGroup=tDDControlGroup, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, ptp650=ptp650, linkLoss=linkLoss, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRegulatoryBandsList=licenseRegulatoryBandsList, license=license, subbandLowestFrequency=subbandLowestFrequency, targetRange=targetRange, cableDiagPair2Distance=cableDiagPair2Distance, ethernetPriorityTableNumber=ethernetPriorityTableNumber, syncETracking=syncETracking, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, sFPPortStatusTrap=sFPPortStatusTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelChangeTrap=channelChangeTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, aAAControl=aAAControl, hardwareVersion=hardwareVersion, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mABNominalModulationMode=mABNominalModulationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpGroups=ptpGroups, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPv3Enable=sNMPv3Enable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDMInterfaceStatus=tDMInterfaceStatus, dfsMeans=dfsMeans, licenseCountry=licenseCountry, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, userTable=userTable, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, regulatoryBandTrap=regulatoryBandTrap, rangingMode=rangingMode, cableDiagnosticsPorts=cableDiagnosticsPorts, siteName=siteName, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseVersion=licenseVersion, subnetMask=subnetMask, licenseTDDSyncSupport=licenseTDDSyncSupport, transmitModulationMode=transmitModulationMode, encryptionGroup=encryptionGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", versions=versions, syslogState=syslogState, sFPErrorTrap=sFPErrorTrap, receiveModulationMode=receiveModulationMode, transparentClock=transparentClock, smtp=smtp, licenseIssueNumber=licenseIssueNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, byteErrorRatio=byteErrorRatio, nIDULanPortStatus=nIDULanPortStatus, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, altitude=altitude, secureModeAlarm=secureModeAlarm, cableDiagPair2Results=cableDiagPair2Results, licenseEncryption=licenseEncryption, subbandHighestFrequency=subbandHighestFrequency, managementGroup=managementGroup, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkModeOptimization=linkModeOptimization, cableDiagPair1Results=cableDiagPair1Results, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userRole=userRole, mABProtocolVLANPriority=mABProtocolVLANPriority, smtpGroup=smtpGroup, remoteInternetAddress=remoteInternetAddress, phyControlGroup=phyControlGroup, sNTPState=sNTPState, licenseMaxLinkRange=licenseMaxLinkRange, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syncETrackingState=syncETrackingState, userTableIndex=userTableIndex, licenseGroupAccess=licenseGroupAccess, tdmTableNumber=tdmTableNumber, systemReset=systemReset, tDMGroup=tDMGroup, sMTPServerPortNumber=sMTPServerPortNumber, capacityVariantMismatch=capacityVariantMismatch, licenseIEEE1588Support=licenseIEEE1588Support, tFTPServerInternetAddressType=tFTPServerInternetAddressType, auxPortStatusTrap=auxPortStatusTrap, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, cableDiagPair4Results=cableDiagPair4Results, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseRARSupport=licenseRARSupport, dataPortPauseFrames=dataPortPauseFrames, transmitFreqMHz=transmitFreqMHz, longitude=longitude, dfsTableNumber=dfsTableNumber, mABProtocolVID=mABProtocolVID, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPVersion=iPVersion, mABState=mABState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bridgeGroup=bridgeGroup, masterSlaveMode=masterSlaveMode, sNTPServerTableNumber=sNTPServerTableNumber, maximumTransmitPower=maximumTransmitPower, sFPPortDisabledWarning=sFPPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, eIRP=eIRP, linkSymmetry=linkSymmetry, l2CPPriorityTable=l2CPPriorityTable, receiveFreqMHz=receiveFreqMHz, accessMethod=accessMethod, portAllocationMismatch=portAllocationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, installStatusTrap=installStatusTrap, tDM=tDM, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, auxPortAllocation=auxPortAllocation, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockVID=transparentClockVID, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair3Results=cableDiagPair3Results, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPLastSync=sNTPLastSync, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStatsGroup=pubStatsGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, iPv6GatewayAddress=iPv6GatewayAddress, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogClient=syslogClient, range=range, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, iPv6Address=iPv6Address, resetGroup=resetGroup, licenseCapacity=licenseCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tdmTableIndex=tdmTableIndex, sFPPortSSMTx=sFPPortSSMTx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableIndex=sNTPServerTableIndex, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, txMABFrames=txMABFrames, mainPSUPortAutoMdix=mainPSUPortAutoMdix, phyStatus=phyStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rawReceivePower=rawReceivePower, secondDataBridgingStatus=secondDataBridgingStatus, dfs=dfs, installStatus=installStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, softwareVersion=softwareVersion, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, licenseBandwidthCap=licenseBandwidthCap, tDMConfigurationMismatch=tDMConfigurationMismatch, reset=reset, ptpTraps=ptpTraps, dataBridgingStatus=dataBridgingStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, cableDiagnosticsControl=cableDiagnosticsControl, ptpTrapPrefix=ptpTrapPrefix, productName=productName, userPassword=userPassword, ptpCompliance=ptpCompliance, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, localPacketFiltering=localPacketFiltering, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
