...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", range=range, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagPair3Distance=cableDiagPair3Distance, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, antennaGain=antennaGain, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPv4Address=iPv4Address, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, aAAControl=aAAControl, portAllocationMismatchTrap=portAllocationMismatchTrap, mABState=mABState, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMGroup=tDMGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mABProtocolVLANPriority=mABProtocolVLANPriority, license=license, channelBandwidth=channelBandwidth, mABMaintenanceLevel=mABMaintenanceLevel, dataBridgingStatus=dataBridgingStatus, tDMChannelLoopback=tDMChannelLoopback, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogStateTrap=syslogStateTrap, ethernet=ethernet, productName=productName, ptmp=ptmp, sNTPSync=sNTPSync, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRARSupport=licenseRARSupport, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAutoNegotiation=sFPPortAutoNegotiation, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secureModeAlarm=secureModeAlarm, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, licenseSecurityLevel=licenseSecurityLevel, masterSlaveMode=masterSlaveMode, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapVersion=sNMPTrapVersion, dfsPeaks=dfsPeaks, dataBridgingAvailability=dataBridgingAvailability, txMABFrames=txMABFrames, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDMInterfaceStatus=tDMInterfaceStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, installArmState=installArmState, sNTPServerTimeout=sNTPServerTimeout, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, tdmTableIndex=tdmTableIndex, transparentClockVID=transparentClockVID, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, ethernetGroup=ethernetGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseEncryption=licenseEncryption, encryptionGroup=encryptionGroup, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, auxPortDisabledWarning=auxPortDisabledWarning, supplementary=supplementary, mABHoldoffPeriod=mABHoldoffPeriod, licenseBandwidthCap=licenseBandwidthCap, auxPortStatus=auxPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, transmitChannel=transmitChannel, subnetMask=subnetMask, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogState=syslogState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, supplementaryGroup=supplementaryGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkModeOptimization=linkModeOptimization, txColorCode=txColorCode, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, sNMPEnabledTraps=sNMPEnabledTraps, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, aggregateDataRate=aggregateDataRate, enableTransmission=enableTransmission, versionsGroup=versionsGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receiveDataRate=receiveDataRate, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, routerProtocolsGroup=routerProtocolsGroup, linkName=linkName, channelChangeTrap=channelChangeTrap, lowestTDMModulationMode=lowestTDMModulationMode, sNMPv3Enable=sNMPv3Enable, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mABProtocolVID=mABProtocolVID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPCommunityString=sNMPCommunityString, routerProtocols=routerProtocols, frequencyVariant=frequencyVariant, timeZone=timeZone, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, management=management, lowestDataModulationMode=lowestDataModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, managementNetworkAccessEnabled=managementNetworkAccessEnabled, transparentClockPort=transparentClockPort, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, userTable=userTable, userTableEntry=userTableEntry, syncETrackingState=syncETrackingState, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, remoteInternetAddress=remoteInternetAddress, sFPPortSSMTx=sFPPortSSMTx, installStatusTrap=installStatusTrap, bridge=bridge, wirelessLinkStatus=wirelessLinkStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, encryptionAlgorithm=encryptionAlgorithm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortAllocation=sFPPortAllocation, licenseSFPPortSupport=licenseSFPPortSupport, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortStatus=sFPPortStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, vLANManagementPriority=vLANManagementPriority, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, longitude=longitude, dfsTableNumber=dfsTableNumber, latitude=latitude, licenseIEEE1588Support=licenseIEEE1588Support, transparentClock=transparentClock, sNTPServerPortNumber=sNTPServerPortNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseVersion=licenseVersion, aAAControlGroup=aAAControlGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, tDMInterfaceControl=tDMInterfaceControl, transmitPower=transmitPower, cableLoss=cableLoss, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tdmTable=tdmTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseGroup=licenseGroup, regulatoryBandTrap=regulatoryBandTrap, cableDiagPair3Results=cableDiagPair3Results, tDMConfigurationMismatch=tDMConfigurationMismatch, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, encryption=encryption, sNTPServerInternetAddressType=sNTPServerInternetAddressType, ptpCompliance=ptpCompliance, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultTable=cableDiagnosticsResultTable, receiveFreqMHz=receiveFreqMHz, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableEntry=sNTPServerTableEntry, phyStatusGroup=phyStatusGroup, targetRange=targetRange, hTTPPortNumber=hTTPPortNumber, alarms=alarms, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerTable=sNTPServerTable, portAllocationMismatch=portAllocationMismatch, smtpGroup=smtpGroup, qOSPriorityScheme=qOSPriorityScheme, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, phyStatus=phyStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, productVariant=productVariant, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, eIRP=eIRP, licenseTrialPeriod=licenseTrialPeriod, smtp=smtp, rawReceivePower=rawReceivePower, rxColorCode=rxColorCode, userName=userName, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDMEnabledChannels=tDMEnabledChannels, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, useVLANForMABProtocol=useVLANForMABProtocol, maximumTransmitPower=maximumTransmitPower, searchState=searchState, licenseIPv6Support=licenseIPv6Support, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagPair1Results=cableDiagPair1Results, transparentClockVLAN=transparentClockVLAN, syncETracking=syncETracking, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNMPPortNumber=sNMPPortNumber, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userPassword=userPassword, licenseGroupAccess=licenseGroupAccess, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDMChannelStatus=tDMChannelStatus, pubStats=pubStats, licenseOOBManagementSupport=licenseOOBManagementSupport, phyControlGroup=phyControlGroup, tDMChannelLineCode=tDMChannelLineCode, phyControl=phyControl, licenseCapacity=licenseCapacity, secureModeAlarmTrap=secureModeAlarmTrap, telnetPortNumber=telnetPortNumber, auxPortQLRx=auxPortQLRx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortQLRx=sFPPortQLRx, iPv6Address=iPv6Address, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, reset=reset, remoteInternetAddressType=remoteInternetAddressType, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseIssueNumber=licenseIssueNumber, vLANManagementVID=vLANManagementVID, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, systemClock=systemClock, syslogClient=syslogClient, sNTPLastSync=sNTPLastSync, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, regulatoryBand=regulatoryBand, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortStatusTrap=mainPSUPortStatusTrap, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerRetries=sNTPServerRetries, userRole=userRole, cambium=cambium, licenseCountry=licenseCountry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortQLTx=sFPPortQLTx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syncEEquipmentClock=syncEEquipmentClock, dfsMeans=dfsMeans, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseUnitSerialNumber=licenseUnitSerialNumber, auxPortAllocation=auxPortAllocation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPState=sNTPState, installArmStateTrap=installArmStateTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, cableDiagnosticsGroup=cableDiagnosticsGroup, linkLoss=linkLoss, unitOutOfCalibration=unitOutOfCalibration, dfsTable=dfsTable, tDM=tDM, userTableIndex=userTableIndex, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnostics=cableDiagnostics, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortSSMTx=mainPSUPortSSMTx, l2CPPriorityTable=l2CPPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ptp650=ptp650, sNTPPollInterval=sNTPPollInterval, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagPair2Results=cableDiagPair2Results, capacityVariantMismatch=capacityVariantMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tDMChannelCableLength=tDMChannelCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPVersion=iPVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, secondarySoftwareVersion=secondarySoftwareVersion, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, PYSNMP_MODULE_ID=cambium, sFPError=sFPError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagPair4Distance=cableDiagPair4Distance, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPErrorTrap=sFPErrorTrap, tdmTableEntry=tdmTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, resetGroup=resetGroup, localPacketFiltering=localPacketFiltering, dataPortPauseFrames=dataPortPauseFrames, tDDSynchronizationMode=tDDSynchronizationMode, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsWarning=cableDiagnosticsWarning, tdmTableNumber=tdmTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, lowestSecondDataModulationMode=lowestSecondDataModulationMode, transmitDataRate=transmitDataRate, bridgeGroup=bridgeGroup, iPv6PrefixLength=iPv6PrefixLength, auxPortStatusTrap=auxPortStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, dfsTableIndex=dfsTableIndex, auxPortQLTx=auxPortQLTx, hardwareVersion=hardwareVersion, tDDControl=tDDControl, sFPPortSyncERxStatus=sFPPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, tDDControlGroup=tDDControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapTable=sNMPTrapTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, softwareVersion=softwareVersion, mABNominalModulationMode=mABNominalModulationMode, licenseSyncESupport=licenseSyncESupport, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, subbandLowestFrequency=subbandLowestFrequency, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortStatus=mainPSUPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortSyncERxStatus=auxPortSyncERxStatus, managementGroup=managementGroup, secondDataBridgingStatus=secondDataBridgingStatus, auxPortSSMTx=auxPortSSMTx, userEnabled=userEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, altitude=altitude, snmpControl=snmpControl, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, nIDULanPortStatus=nIDULanPortStatus, subbandHighestFrequency=subbandHighestFrequency, syslogControlGroup=syslogControlGroup, bootVersion=bootVersion, receiveChannel=receiveChannel, ptp=ptp, receivePower=receivePower, ethernetPriorityTable=ethernetPriorityTable, cableDiagPair4Results=cableDiagPair4Results, installStatus=installStatus)
