...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNTPServerRetries=sNTPServerRetries, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, sNTPState=sNTPState, hardwareVersion=hardwareVersion, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsTableEntry=dfsTableEntry, eIRP=eIRP, tDMChannelCableLength=tDMChannelCableLength, pubStatsGroup=pubStatsGroup, transmitModulationMode=transmitModulationMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mainPSUPortQLTx=mainPSUPortQLTx, mABProtocolVLANPriority=mABProtocolVLANPriority, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, targetMACAddress=targetMACAddress, ptpTraps=ptpTraps, systemClock=systemClock, cableDiagnosticsGroup=cableDiagnosticsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, snmpControlGroup=snmpControlGroup, sNTPServerTimeout=sNTPServerTimeout, licenseCountry=licenseCountry, routerProtocols=routerProtocols, softwareVersion=softwareVersion, userPassword=userPassword, productName=productName, sNMPCommunityString=sNMPCommunityString, auxPortSSMTx=auxPortSSMTx, cableDiagPair4Distance=cableDiagPair4Distance, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDMConfigurationMismatch=tDMConfigurationMismatch, linkSymmetry=linkSymmetry, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, ptp=ptp, userTableIndex=userTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mABHoldoffPeriod=mABHoldoffPeriod, secondDataBridgingStatus=secondDataBridgingStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv6GatewayAddress=iPv6GatewayAddress, reset=reset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsControl=cableDiagnosticsControl, transmitPower=transmitPower, aAAControl=aAAControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, targetRange=targetRange, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPServerStatus=sNTPServerStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABProtocolVID=mABProtocolVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair2Results=cableDiagPair2Results, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseSecurityLevel=licenseSecurityLevel, l2CPPriorityTableNumber=l2CPPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortStatusTrap=auxPortStatusTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sMTPServerPortNumber=sMTPServerPortNumber, byteErrorRatio=byteErrorRatio, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTableIndex=sNTPServerTableIndex, subbandHighestFrequency=subbandHighestFrequency, dfsGroup=dfsGroup, cableDiagPair4Results=cableDiagPair4Results, transparentClockVID=transparentClockVID, dfs=dfs, cableDiagnosticsPorts=cableDiagnosticsPorts, altitude=altitude, mABNominalModulationMode=mABNominalModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, PYSNMP_MODULE_ID=cambium, systemReset=systemReset, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, pubStats=pubStats, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mABState=mABState, managementNetworkAccessEnabled=managementNetworkAccessEnabled, latitude=latitude, licenseRARSupport=licenseRARSupport, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPVersion=iPVersion, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerTable=sNTPServerTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, aAAControlGroup=aAAControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, transparentClockVLAN=transparentClockVLAN, syslogClientTrap=syslogClientTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, resetGroup=resetGroup, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, l2CPPriorityTable=l2CPPriorityTable, syncEEquipmentClock=syncEEquipmentClock, channelBandwidth=channelBandwidth, userTableNumber=userTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, alarms=alarms, secureModeAlarm=secureModeAlarm, localPacketFiltering=localPacketFiltering, dfsTableNumber=dfsTableNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transparentClock=transparentClock, licenseUnitSerialNumber=licenseUnitSerialNumber, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, iPv6Address=iPv6Address, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mainPSUPortStatus=mainPSUPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, management=management, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sMTPEnabledMessages=sMTPEnabledMessages, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableNumber=sNTPServerTableNumber, signalStrengthRatio=signalStrengthRatio, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rangingMode=rangingMode, dataBridgingStatus=dataBridgingStatus, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, licenseGroup=licenseGroup, licenseIssueNumber=licenseIssueNumber, licenseMaxLinkRange=licenseMaxLinkRange, licenseIPv6Support=licenseIPv6Support, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, aggregateDataRate=aggregateDataRate, productVariant=productVariant, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, configurationGroup=configurationGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementGroup=managementGroup, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sFPPortSSMTx=sFPPortSSMTx, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, lowestTDMModulationMode=lowestTDMModulationMode, txColorCode=txColorCode, ptpGroups=ptpGroups, sFPPortSyncERxStatus=sFPPortSyncERxStatus, qOSPriorityScheme=qOSPriorityScheme, smtpGroup=smtpGroup, rxColorCode=rxColorCode, tdmTableNumber=tdmTableNumber, capacityVariantMismatchTrap=capacityVariantMismatchTrap, license=license, hTTPPortNumber=hTTPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userEnabled=userEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, licenseEncryption=licenseEncryption, dataPortPauseFrames=dataPortPauseFrames, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, bridgeGroup=bridgeGroup, wirelessLinkStatus=wirelessLinkStatus, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerPortNumber=sNTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, siteName=siteName, maxLinkRangeExceeded=maxLinkRangeExceeded, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortQLRx=mainPSUPortQLRx, tDMInterfaceControl=tDMInterfaceControl, licenseCapacity=licenseCapacity, tDMChannelStatusTrap=tDMChannelStatusTrap, tDDControlGroup=tDDControlGroup, tDMEnabledChannels=tDMEnabledChannels, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortAllocation=auxPortAllocation, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABNominalTransmitCapacity=mABNominalTransmitCapacity, userTable=userTable, receiveFreqKHz=receiveFreqKHz, ptpCompliance=ptpCompliance, licenseIEEE1588Support=licenseIEEE1588Support, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseSyncESupport=licenseSyncESupport, licenseOOBManagementSupport=licenseOOBManagementSupport, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseTrialPeriod=licenseTrialPeriod, alarmsGroup=alarmsGroup, tDMInterfaceStatus=tDMInterfaceStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, auxPortQLTx=auxPortQLTx, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, timeZone=timeZone, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, sntp=sntp, nIDULanPortStatus=nIDULanPortStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, regulatoryBandTrap=regulatoryBandTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", remoteInternetAddress=remoteInternetAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogStateTrap=syslogStateTrap, notificationsGroup=notificationsGroup, syncETracking=syncETracking, sNTPSync=sNTPSync, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, installStatus=installStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortQLRx=auxPortQLRx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sntpGroup=sntpGroup, vectorError=vectorError, sNTPPrimaryServer=sNTPPrimaryServer, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, linkModeOptimization=linkModeOptimization, licenseGroupAccess=licenseGroupAccess, capacityVariantMismatch=capacityVariantMismatch, auxPortStatus=auxPortStatus, sFPPortQLTx=sFPPortQLTx, searchState=searchState, cableDiagPair3Results=cableDiagPair3Results, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, syslogControl=syslogControl, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagPair2Distance=cableDiagPair2Distance, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, subnetMask=subnetMask, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, transmitFreqMHz=transmitFreqMHz, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortDisabledWarning=auxPortDisabledWarning, encryption=encryption, cableDiagPair1Results=cableDiagPair1Results, licenseVersion=licenseVersion, cableLoss=cableLoss, tdmTableIndex=tdmTableIndex, sFPPortStatus=sFPPortStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPError=sFPError, sNTPPollInterval=sNTPPollInterval, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, ptmp=ptmp, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapVersion=sNMPTrapVersion, dataBridgingAvailability=dataBridgingAvailability, useVLANForMABProtocol=useVLANForMABProtocol, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, channelChangeTrap=channelChangeTrap, ptp650=ptp650, sFPPortAutoNegotiation=sFPPortAutoNegotiation, phyControl=phyControl, sMTPEmailAlert=sMTPEmailAlert, dfsTableIndex=dfsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, ethernetPriorityTable=ethernetPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABTransmissionInterval=mABTransmissionInterval, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, phyStatusGroup=phyStatusGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ethernetGroup=ethernetGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, accessMethod=accessMethod, txMABFrames=txMABFrames, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnostics=cableDiagnostics, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortAcceptedQLRx=auxPortAcceptedQLRx, receiveDataRate=receiveDataRate, syslogClient=syslogClient, routerProtocolsGroup=routerProtocolsGroup, sFPPortQLRx=sFPPortQLRx, tdmTableEntry=tdmTableEntry, daylightSaving=daylightSaving, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPErrorTrap=sFPErrorTrap, cableDiagPair1Distance=cableDiagPair1Distance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, configuration=configuration, phyControlGroup=phyControlGroup, installArmState=installArmState, lowestDataModulationMode=lowestDataModulationMode, groupID=groupID, installArmStateTrap=installArmStateTrap, bootVersion=bootVersion, unitOutOfCalibration=unitOutOfCalibration, frequencyVariant=frequencyVariant, tDMChannelStatus=tDMChannelStatus, receiveModulationMode=receiveModulationMode, bridge=bridge, mainPSUPortAllocation=mainPSUPortAllocation, transparentClockPort=transparentClockPort, transmitChannel=transmitChannel, sFPPortAutoMdix=sFPPortAutoMdix, iPv4Address=iPv4Address, encryptionAlgorithm=encryptionAlgorithm, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syncETrackingState=syncETrackingState, ptpTrapPrefix=ptpTrapPrefix, auxPortConfigurationMismatch=auxPortConfigurationMismatch, linkLoss=linkLoss, sFPPortAllocation=sFPPortAllocation, supplementaryGroup=supplementaryGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dSCPManagementPriority=dSCPManagementPriority, regulatoryBand=regulatoryBand, tDM=tDM, enableTransmission=enableTransmission, tdmTable=tdmTable, smtp=smtp, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, userName=userName, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, portAllocationMismatch=portAllocationMismatch, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkName=linkName, cambium=cambium, ethernet=ethernet, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, range=range, mABMaintenanceLevel=mABMaintenanceLevel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControl=tDDControl, receiveChannel=receiveChannel, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, versionsGroup=versionsGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, supplementary=supplementary, rawReceivePower=rawReceivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagPair3Distance=cableDiagPair3Distance, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsMeans=dfsMeans, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMGroup=tDMGroup)
