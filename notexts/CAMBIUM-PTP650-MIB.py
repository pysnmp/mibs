...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", cableDiagPair4Results=cableDiagPair4Results, mainPSUPortStatusTrap=mainPSUPortStatusTrap, regulatoryBand=regulatoryBand, receiveModulationModeDetail=receiveModulationModeDetail, auxPortStatus=auxPortStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDMChannelCableLength=tDMChannelCableLength, sNTPLastSync=sNTPLastSync, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transparentClockVLAN=transparentClockVLAN, licenseIssueNumber=licenseIssueNumber, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userPassword=userPassword, mainPSUPortAllocation=mainPSUPortAllocation, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseUnitSerialNumber=licenseUnitSerialNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPErrorTrap=sFPErrorTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, txColorCode=txColorCode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortSyncERxStatus=auxPortSyncERxStatus, mABTransmissionInterval=mABTransmissionInterval, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, vectorError=vectorError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, auxPortQLTx=auxPortQLTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, routerProtocolsGroup=routerProtocolsGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRate=transmitDataRate, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseSFPPortSupport=licenseSFPPortSupport, antennaGain=antennaGain, cableDiagPair3Distance=cableDiagPair3Distance, secureModeAlarm=secureModeAlarm, ptpCompliance=ptpCompliance, ptpTrapPrefix=ptpTrapPrefix, mABProtocolVLANPriority=mABProtocolVLANPriority, transmitFreqMHz=transmitFreqMHz, licenseRARSupport=licenseRARSupport, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortQLRx=mainPSUPortQLRx, sNTPServerPortNumber=sNTPServerPortNumber, phyControlGroup=phyControlGroup, alarmsGroup=alarmsGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, tDDControl=tDDControl, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPServerTable=sNTPServerTable, sNTPPrimaryServer=sNTPPrimaryServer, PYSNMP_MODULE_ID=cambium, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syncEEquipmentClock=syncEEquipmentClock, tDMGroup=tDMGroup, licenseIPv6Support=licenseIPv6Support, byteErrorRatio=byteErrorRatio, management=management, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, dataPortPauseFrames=dataPortPauseFrames, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ptmp=ptmp, transparentClockPort=transparentClockPort, portAllocationMismatchTrap=portAllocationMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseGroup=licenseGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitPower=transmitPower, daylightSaving=daylightSaving, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, tdmTableNumber=tdmTableNumber, latitude=latitude, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClock=transparentClock, hTTPSPortNumber=hTTPSPortNumber, subnetMask=subnetMask, hardwareVersion=hardwareVersion, tDDControlGroup=tDDControlGroup, phyStatusGroup=phyStatusGroup, secondDataBridgingStatus=secondDataBridgingStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, aAAControl=aAAControl, iPv6PrefixLength=iPv6PrefixLength, tDMInterfaceControl=tDMInterfaceControl, ptpTraps=ptpTraps, mPLSTCPriorityTable=mPLSTCPriorityTable, qOSPriorityScheme=qOSPriorityScheme, managementPortWirelessDownAlert=managementPortWirelessDownAlert, capacityVariantMismatch=capacityVariantMismatch, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, searchState=searchState, resetGroup=resetGroup, ethernet=ethernet, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsMeans=dfsMeans, ptp=ptp, dataBridgingStatus=dataBridgingStatus, bridgeGroup=bridgeGroup, systemReset=systemReset, cableDiagPair4Distance=cableDiagPair4Distance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, eIRP=eIRP, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, localPacketFiltering=localPacketFiltering, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDMEnabledChannels=tDMEnabledChannels, versions=versions, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPServerTimeout=sNTPServerTimeout, useVLANForMABProtocol=useVLANForMABProtocol, licenseBandwidthCap=licenseBandwidthCap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPError=sFPError, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sntpGroup=sntpGroup, altitude=altitude, lowestDataModulationMode=lowestDataModulationMode, smtpGroup=smtpGroup, sFPPortQLRx=sFPPortQLRx, enableTransmission=enableTransmission, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseEncryption=licenseEncryption, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, portAllocationMismatch=portAllocationMismatch, mABState=mABState, smtp=smtp, supplementary=supplementary, dfsPeaks=dfsPeaks, pubStats=pubStats, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteInternetAddress=remoteInternetAddress, sNTPSync=sNTPSync, targetMACAddress=targetMACAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNMPTrapInternetAddress=sNMPTrapInternetAddress, extendedSpectrumScanning=extendedSpectrumScanning, transmitChannel=transmitChannel, snmpControl=snmpControl, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, tdmTableEntry=tdmTableEntry, ptp650=ptp650, iPv4Address=iPv4Address, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortQLTx=sFPPortQLTx, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpGroups=ptpGroups, cableDiagPair2Results=cableDiagPair2Results, sFPPortAutoNegotiation=sFPPortAutoNegotiation, snmpControlGroup=snmpControlGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, aggregateDataRate=aggregateDataRate, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, auxPortDisabledWarning=auxPortDisabledWarning, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerTableNumber=sNTPServerTableNumber, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versionsGroup=versionsGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, aAAControlGroup=aAAControlGroup, userTableNumber=userTableNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetGroup=ethernetGroup, userName=userName, rawReceivePower=rawReceivePower, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddress=tFTPServerInternetAddress, cableDiagPair3Results=cableDiagPair3Results, sNTPServerRetries=sNTPServerRetries, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, channelBandwidth=channelBandwidth, sNTPServerTableEntry=sNTPServerTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair1Results=cableDiagPair1Results, gatewayIPAddress=gatewayIPAddress, dfs=dfs, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, userEnabled=userEnabled, licenseVersion=licenseVersion, iPv6GatewayAddress=iPv6GatewayAddress, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveChannel=receiveChannel, sNTPServerInternetAddressType=sNTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syncETracking=syncETracking, sNTPSyncTrap=sNTPSyncTrap, syslogState=syslogState, cambium=cambium, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, auxPortAllocation=auxPortAllocation, dfsTableNumber=dfsTableNumber, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, cableDiagPair2Distance=cableDiagPair2Distance, linkSymmetry=linkSymmetry, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tDMInterfaceStatus=tDMInterfaceStatus, userTable=userTable, targetRange=targetRange)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortStatus=sFPPortStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sMTPEmailAlert=sMTPEmailAlert, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syslogControlGroup=syslogControlGroup, subbandLowestFrequency=subbandLowestFrequency, receivePower=receivePower, tDM=tDM, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, bootVersion=bootVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, phyStatus=phyStatus, mABHoldoffPeriod=mABHoldoffPeriod, encryption=encryption, vLANManagementVID=vLANManagementVID, groupID=groupID, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogStateTrap=syslogStateTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortStatus=mainPSUPortStatus, userTableEntry=userTableEntry, userRole=userRole, auxPortQLRx=auxPortQLRx, tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mABNominalModulationMode=mABNominalModulationMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, transparentClockVID=transparentClockVID, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, installStatus=installStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseSyncESupport=licenseSyncESupport, nIDULanPortAutoMdix=nIDULanPortAutoMdix, license=license, sFPPortAllocation=sFPPortAllocation, regulatoryBandTrap=regulatoryBandTrap, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mABProtocolVID=mABProtocolVID, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, dfsTableEntry=dfsTableEntry, iPVersion=iPVersion, syncETrackingState=syncETrackingState, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, linkLoss=linkLoss, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPv6Address=iPv6Address, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, bridge=bridge, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseCapacity=licenseCapacity, licenseCountry=licenseCountry, sMTPServerPortNumber=sMTPServerPortNumber, longitude=longitude, tdmTable=tdmTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, siteName=siteName, pubStatsGroup=pubStatsGroup, linkName=linkName, licenseGroupAccess=licenseGroupAccess, tdmTableIndex=tdmTableIndex, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagnosticsControl=cableDiagnosticsControl, dataBridgingAvailability=dataBridgingAvailability, rangingMode=rangingMode, mABMaintenanceLevel=mABMaintenanceLevel, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userTableIndex=userTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, linkModeOptimization=linkModeOptimization, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetPriorityTable=ethernetPriorityTable, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagnostics=cableDiagnostics, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, notificationsGroup=notificationsGroup, tDMChannelStatus=tDMChannelStatus, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, lowestTDMModulationMode=lowestTDMModulationMode, alarms=alarms, mainPSUPortAutoMdix=mainPSUPortAutoMdix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, supplementaryGroup=supplementaryGroup, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, txMABFrames=txMABFrames, auxPortSSMTx=auxPortSSMTx, syslogClientTrap=syslogClientTrap, rxColorCode=rxColorCode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, telnetPortNumber=telnetPortNumber, licenseMaxLinkRange=licenseMaxLinkRange, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTable=l2CPPriorityTable, sFPPortSSMTx=sFPPortSSMTx, subbandHighestFrequency=subbandHighestFrequency, licenseOOBManagementSupport=licenseOOBManagementSupport, channelChangeTrap=channelChangeTrap, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, range=range, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, timeZone=timeZone, licenseSecurityLevel=licenseSecurityLevel, installArmStateTrap=installArmStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, tDMChannelLoopback=tDMChannelLoopback, incompatibleRegulatoryBands=incompatibleRegulatoryBands, productName=productName, syslogControl=syslogControl, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionGroup=encryptionGroup, routerProtocols=routerProtocols, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortStatusTrap=auxPortStatusTrap)
