...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", iPv6PrefixLength=iPv6PrefixLength, auxPortQLTx=auxPortQLTx, aAAControlGroup=aAAControlGroup, syncETrackingState=syncETrackingState, sFPPortAllocation=sFPPortAllocation, sNMPCommunityString=sNMPCommunityString, cableDiagnostics=cableDiagnostics, dfsTable=dfsTable, sFPErrorTrap=sFPErrorTrap, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptp650=ptp650, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortDisabledWarning=auxPortDisabledWarning, enableTransmission=enableTransmission, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secondDataBridgingStatus=secondDataBridgingStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tDMChannelStatusTrap=tDMChannelStatusTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, longitude=longitude, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, productName=productName, ptpGroups=ptpGroups, licenseSecurityLevel=licenseSecurityLevel, pubStats=pubStats, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, cableDiagPair1Distance=cableDiagPair1Distance, sNTPState=sNTPState, dfsTableEntry=dfsTableEntry, tDMGroup=tDMGroup, lowestDataModulationMode=lowestDataModulationMode, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, regulatoryBand=regulatoryBand, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, managementGroup=managementGroup, tdmTableNumber=tdmTableNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, rawReceivePower=rawReceivePower, auxPortSSMTx=auxPortSSMTx, sNMPTrapVersion=sNMPTrapVersion, license=license, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, installArmState=installArmState, transmitChannel=transmitChannel, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transmitFreqKHz=transmitFreqKHz, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortAcceptedQLRx=auxPortAcceptedQLRx, aAAControl=aAAControl, extendedSpectrumScanning=extendedSpectrumScanning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, systemReset=systemReset, auxPortSyncERxStatus=auxPortSyncERxStatus, syncEEquipmentClock=syncEEquipmentClock, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, reset=reset, ptpCompliance=ptpCompliance, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimization=linkModeOptimization, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, rxColorCode=rxColorCode, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ethernetGroup=ethernetGroup, sNTPServerTableNumber=sNTPServerTableNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortSSMTx=sFPPortSSMTx, altitude=altitude, subnetMask=subnetMask, sNMPTrapInternetAddress=sNMPTrapInternetAddress, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogControl=syslogControl, sFPPortQLRx=sFPPortQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsGroup=dfsGroup, cableDiagPair3Distance=cableDiagPair3Distance, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, syslogState=syslogState, remoteInternetAddressType=remoteInternetAddressType, sFPError=sFPError, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, systemClock=systemClock, versions=versions, qOSPriorityScheme=qOSPriorityScheme, byteErrorRatio=byteErrorRatio, txMABFrames=txMABFrames, tDMInterfaceStatus=tDMInterfaceStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, sFPPortQLTx=sFPPortQLTx, latitude=latitude, tDM=tDM, capacityVariantMismatch=capacityVariantMismatch, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, groupID=groupID, managementNetworkAccessEnabled=managementNetworkAccessEnabled, subbandLowestFrequency=subbandLowestFrequency, tFTPServerInternetAddress=tFTPServerInternetAddress, nIDULanPortStatus=nIDULanPortStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDMChannelCableLength=tDMChannelCableLength, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, userEnabled=userEnabled, bootVersion=bootVersion, dfsPeaks=dfsPeaks, receiveFreqKHz=receiveFreqKHz, tDMInterfaceControl=tDMInterfaceControl, eIRP=eIRP, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDControl=tDDControl, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mainPSUPortQLTx=mainPSUPortQLTx, resetGroup=resetGroup, licenseGroupAccess=licenseGroupAccess, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, syslogClientTrap=syslogClientTrap, supplementary=supplementary, mABHoldoffPeriod=mABHoldoffPeriod, dfsMeans=dfsMeans, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDControlGroup=tDDControlGroup, iPv6Address=iPv6Address, siteName=siteName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tdmTableIndex=tdmTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, accessMethod=accessMethod, subbandHighestFrequency=subbandHighestFrequency, l2CPPriorityTableEntry=l2CPPriorityTableEntry, lowestSecondDataModulationMode=lowestSecondDataModulationMode, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, regulatoryBandTrap=regulatoryBandTrap, cableDiagPair2Distance=cableDiagPair2Distance, licenseMaxLinkRange=licenseMaxLinkRange, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, localPacketFiltering=localPacketFiltering, transparentClock=transparentClock, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transparentClockPort=transparentClockPort, iPv4Address=iPv4Address, snmpControlGroup=snmpControlGroup, licenseGroup=licenseGroup, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tdmTable=tdmTable, iPv6GatewayAddress=iPv6GatewayAddress, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, targetMACAddress=targetMACAddress, ptpTrapPrefix=ptpTrapPrefix, licenseIssueNumber=licenseIssueNumber, useVLANForMABProtocol=useVLANForMABProtocol, mABState=mABState, receiveModulationMode=receiveModulationMode, auxPortConfigurationMismatch=auxPortConfigurationMismatch, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receiveChannel=receiveChannel, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, daylightSaving=daylightSaving, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseIPv6Support=licenseIPv6Support, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortQLRx=mainPSUPortQLRx, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dSCPManagementPriority=dSCPManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, linkSymmetry=linkSymmetry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortQLRx=auxPortQLRx, cableDiagnosticsPorts=cableDiagnosticsPorts, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cambium=cambium, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, cableDiagPair4Results=cableDiagPair4Results, sNTPServerRetries=sNTPServerRetries, dataBridgingStatusAlarm=dataBridgingStatusAlarm, linkLoss=linkLoss, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, dataPortPauseFrames=dataPortPauseFrames, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, dfsTableNumber=dfsTableNumber, licenseSyncESupport=licenseSyncESupport, sNTPServerPortNumber=sNTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mainPSUPortAllocation=mainPSUPortAllocation, licenseOOBManagementSupport=licenseOOBManagementSupport, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseTrialPeriod=licenseTrialPeriod, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, portAllocationMismatch=portAllocationMismatch, secondDataPortPauseFrames=secondDataPortPauseFrames, sNTPServerTable=sNTPServerTable, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseRARSupport=licenseRARSupport, sFPPortAutoMdix=sFPPortAutoMdix, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, range=range, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTable=userTable, encryptionAlgorithm=encryptionAlgorithm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDMEnabledChannels=tDMEnabledChannels, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, phyControlGroup=phyControlGroup, phyStatus=phyStatus, sNTPServerStatus=sNTPServerStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABProtocolVID=mABProtocolVID, sNTPServerTimeout=sNTPServerTimeout, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagPair1Results=cableDiagPair1Results, encryption=encryption, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, userName=userName, syncETracking=syncETracking, auxPortAllocation=auxPortAllocation, ethernet=ethernet, userTableNumber=userTableNumber, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPPortNumber=sNMPPortNumber, linkName=linkName, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, timeZone=timeZone, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, portAllocationMismatchTrap=portAllocationMismatchTrap, dataBridgingAvailability=dataBridgingAvailability, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, routerProtocols=routerProtocols, cableDiagnosticsGroup=cableDiagnosticsGroup, transmitFreqMHz=transmitFreqMHz, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tDMChannelLoopback=tDMChannelLoopback, frequencyVariant=frequencyVariant, licenseEncryption=licenseEncryption, rangingMode=rangingMode, sFPPortStatus=sFPPortStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, masterSlaveMode=masterSlaveMode, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityTable=ethernetPriorityTable, receiveFreqMHz=receiveFreqMHz, userTableEntry=userTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseUnitSerialNumber=licenseUnitSerialNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, mABProtocolVLANPriority=mABProtocolVLANPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tdmTableEntry=tdmTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, licenseSFPPortSupport=licenseSFPPortSupport, ptpTraps=ptpTraps, antennaGain=antennaGain, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, licenseVersion=licenseVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortWirelessDownAlert=dataPortWirelessDownAlert, maxLinkRangeExceeded=maxLinkRangeExceeded, userTableIndex=userTableIndex, routerProtocolsGroup=routerProtocolsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, cableLoss=cableLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, encryptionGroup=encryptionGroup, txColorCode=txColorCode, tDMChannelLineCode=tDMChannelLineCode, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, syslogClient=syslogClient, cableDiagPair4Distance=cableDiagPair4Distance, installStatus=installStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, iPVersion=iPVersion, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteInternetAddress=remoteInternetAddress, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, gatewayIPAddress=gatewayIPAddress, mainPSUPortStatus=mainPSUPortStatus, ptp=ptp, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, cableDiagPair2Results=cableDiagPair2Results, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mABNominalModulationMode=mABNominalModulationMode, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseBandwidthCap=licenseBandwidthCap, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, management=management, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, channelChangeTrap=channelChangeTrap, bridge=bridge, licenseCapacity=licenseCapacity, dataBridgingStatus=dataBridgingStatus, sMTPEmailAlert=sMTPEmailAlert, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortStatusTrap=sFPPortStatusTrap, smtp=smtp, installArmStateTrap=installArmStateTrap, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, licenseCountry=licenseCountry, lowestTDMModulationMode=lowestTDMModulationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transparentClockVID=transparentClockVID, auxPortStatus=auxPortStatus, receiveDataRate=receiveDataRate, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, sNTPPrimaryServer=sNTPPrimaryServer, dfs=dfs, tDMChannelStatus=tDMChannelStatus, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
