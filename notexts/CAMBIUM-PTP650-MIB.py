...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mainPSUPortStatus=mainPSUPortStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAllocation=sFPPortAllocation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, regulatoryBandTrap=regulatoryBandTrap, capacityVariantMismatch=capacityVariantMismatch, remoteInternetAddressType=remoteInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseRegulatoryBandsList=licenseRegulatoryBandsList, management=management, sFPPortQLRx=sFPPortQLRx, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNMPTrapTableEntry=sNMPTrapTableEntry, targetRange=targetRange, tFTPServerPortNumber=tFTPServerPortNumber, accessMethod=accessMethod, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelLoopback=tDMChannelLoopback, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, transmitPower=transmitPower, regulatoryBand=regulatoryBand, iPv6Address=iPv6Address, sNTPServerTableEntry=sNTPServerTableEntry, iPVersion=iPVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cableDiagPair2Results=cableDiagPair2Results, remoteInternetAddress=remoteInternetAddress, transparentClockVID=transparentClockVID, aggregateDataRate=aggregateDataRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPCommunityString=sNMPCommunityString, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, secondDataBridgingStatus=secondDataBridgingStatus, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, bridgeGroup=bridgeGroup, bridge=bridge, supplementary=supplementary, lowestDataModulationMode=lowestDataModulationMode, phyControlGroup=phyControlGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, nIDULanPortAutoMdix=nIDULanPortAutoMdix, userTableIndex=userTableIndex, sNMPTrapTable=sNMPTrapTable, tDMInterfaceControl=tDMInterfaceControl, wirelessLinkAvailability=wirelessLinkAvailability, sntp=sntp, auxPortDisabledWarning=auxPortDisabledWarning, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, managementGroup=managementGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, auxPortQLRx=auxPortQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mABNominalModulationMode=mABNominalModulationMode, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cambium=cambium, licenseCapacity=licenseCapacity, transmitDataRate=transmitDataRate, subnetMask=subnetMask, systemClock=systemClock, auxPortSyncERxStatus=auxPortSyncERxStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, licenseTrialPeriod=licenseTrialPeriod, masterSlaveMode=masterSlaveMode, receiveFreqKHz=receiveFreqKHz, bootVersion=bootVersion, gatewayIPAddress=gatewayIPAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, auxPortAllocation=auxPortAllocation, groupID=groupID, mainPSUPortAllocation=mainPSUPortAllocation, userTableEntry=userTableEntry, userPassword=userPassword, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMChannelStatus=tDMChannelStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installStatusTrap=installStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, range=range, sNTPSyncTrap=sNTPSyncTrap, licenseRARSupport=licenseRARSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, smtpGroup=smtpGroup, aAAControl=aAAControl, cableDiagPair3Distance=cableDiagPair3Distance, syslogClient=syslogClient, mABProtocolVID=mABProtocolVID, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, versionsGroup=versionsGroup, mABHoldoffPeriod=mABHoldoffPeriod, cableDiagPair3Results=cableDiagPair3Results, nIDULanPortStatus=nIDULanPortStatus, sNTPLastSync=sNTPLastSync, sFPPortQLTx=sFPPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, eIRP=eIRP, licenseGroupAccess=licenseGroupAccess, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPv4Address=iPv4Address, tDDControlGroup=tDDControlGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, pubStats=pubStats, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPSync=sNTPSync, qOSPriorityScheme=qOSPriorityScheme, auxPortSSMTx=auxPortSSMTx, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, telnetAccessEnabled=telnetAccessEnabled, lowestSecondDataModulationMode=lowestSecondDataModulationMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, searchState=searchState, managementNetworkAccessEnabled=managementNetworkAccessEnabled, ptp=ptp, sntpGroup=sntpGroup, ethernetPriorityTable=ethernetPriorityTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, subbandHighestFrequency=subbandHighestFrequency, tDDControl=tDDControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableIndex=sNMPTrapTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded, supplementaryGroup=supplementaryGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dfsTable=dfsTable, userTable=userTable, productName=productName, mainPSUPortAutoMdix=mainPSUPortAutoMdix, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, receiveChannel=receiveChannel, capacityVariantMismatchTrap=capacityVariantMismatchTrap, altitude=altitude, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, siteName=siteName, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, license=license, auxPortStatusTrap=auxPortStatusTrap, subbandLowestFrequency=subbandLowestFrequency, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, tdmTable=tdmTable, transparentClockVLAN=transparentClockVLAN, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, longitude=longitude, dSCPManagementPriority=dSCPManagementPriority, cableLoss=cableLoss, rxColorCode=rxColorCode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sNTPServerTableIndex=sNTPServerTableIndex, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, auxPortStatus=auxPortStatus, transparentClockPort=transparentClockPort, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, timeZone=timeZone, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, extendedSpectrumScanning=extendedSpectrumScanning, tdmTableIndex=tdmTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, signalStrengthRatio=signalStrengthRatio, telnetPortNumber=telnetPortNumber, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, secureModeAlarm=secureModeAlarm, sMTPEmailAlert=sMTPEmailAlert, installStatus=installStatus, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, mainPSUPortQLTx=mainPSUPortQLTx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, PYSNMP_MODULE_ID=cambium, localPacketFiltering=localPacketFiltering, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, versions=versions, syslogControl=syslogControl, tDMChannelStatusTrap=tDMChannelStatusTrap, sNTPServerTimeout=sNTPServerTimeout, mABProtocolVLANPriority=mABProtocolVLANPriority, secureModeAlarmTrap=secureModeAlarmTrap, phyControl=phyControl, routerProtocolsGroup=routerProtocolsGroup, dataBridgingStatus=dataBridgingStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseSecurityLevel=licenseSecurityLevel, vectorError=vectorError, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, targetMACAddress=targetMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDMEnabledChannels=tDMEnabledChannels, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, configuration=configuration, resetGroup=resetGroup, userTableNumber=userTableNumber, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseSFPPortSupport=licenseSFPPortSupport, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rawReceivePower=rawReceivePower, syslogClientTrap=syslogClientTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, syncETracking=syncETracking, installArmState=installArmState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receivePower=receivePower, channelChangeTrap=channelChangeTrap, sFPPortStatus=sFPPortStatus, antennaGain=antennaGain, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPError=sFPError, txMABFrames=txMABFrames, hTTPSPortNumber=hTTPSPortNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, encryption=encryption, sFPPortSSMTx=sFPPortSSMTx, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqMHz=receiveFreqMHz, licenseIEEE1588Support=licenseIEEE1588Support, licenseVersion=licenseVersion, cableDiagnosticsControl=cableDiagnosticsControl, dfsPeaks=dfsPeaks, ptmp=ptmp, transmitChannel=transmitChannel, licenseUnitSerialNumber=licenseUnitSerialNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, userRole=userRole, mABState=mABState, routerProtocols=routerProtocols, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseIPv6Support=licenseIPv6Support, ptpGroups=ptpGroups, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, sNMPv3Enable=sNMPv3Enable, cableDiagPair4Distance=cableDiagPair4Distance, licenseGroup=licenseGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnostics=cableDiagnostics, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tdmTableNumber=tdmTableNumber, syncETrackingState=syncETrackingState, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsWarning=cableDiagnosticsWarning, byteErrorRatio=byteErrorRatio, cableDiagPair1Distance=cableDiagPair1Distance, iPv6GatewayAddress=iPv6GatewayAddress, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerStatus=sNTPServerStatus, linkSymmetry=linkSymmetry, mABTransmissionInterval=mABTransmissionInterval, dfsMeans=dfsMeans, linkModeOptimization=linkModeOptimization, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, phyStatus=phyStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClock=transparentClock, sFPPortAutoMdix=sFPPortAutoMdix, softwareVersion=softwareVersion, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtp=smtp, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortDisabledWarning=sFPPortDisabledWarning, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPPrimaryServer=sNTPPrimaryServer, oOBPriorityQueueMapping=oOBPriorityQueueMapping, txColorCode=txColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagnosticsResultTable=cableDiagnosticsResultTable, tdmTableEntry=tdmTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPState=sNTPState, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, licenseCountry=licenseCountry, syncEEquipmentClock=syncEEquipmentClock, cableDiagnosticsPorts=cableDiagnosticsPorts, hTTPAccessEnabled=hTTPAccessEnabled, syslogState=syslogState, auxPortQLTx=auxPortQLTx, tDM=tDM, cableDiagnosticsGroup=cableDiagnosticsGroup, alarms=alarms, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, portAllocationMismatch=portAllocationMismatch, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPPollInterval=sNTPPollInterval, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, sNTPServerRetries=sNTPServerRetries, dataPortPauseFrames=dataPortPauseFrames, tDMInterfaceStatus=tDMInterfaceStatus, userName=userName, reset=reset, sFPPortStatusTrap=sFPPortStatusTrap, snmpControlGroup=snmpControlGroup, tDMGroup=tDMGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, mABMaintenanceLevel=mABMaintenanceLevel, l2CPPriorityTable=l2CPPriorityTable, cableDiagPair1Results=cableDiagPair1Results, enableTransmission=enableTransmission, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortQLRx=mainPSUPortQLRx, ptpCompliance=ptpCompliance, cableDiagPair4Results=cableDiagPair4Results, rangingMode=rangingMode, unitOutOfCalibration=unitOutOfCalibration, ptp650=ptp650, lowestTDMModulationMode=lowestTDMModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogControlGroup=syslogControlGroup, channelBandwidth=channelBandwidth, pubStatsGroup=pubStatsGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, useVLANForMABProtocol=useVLANForMABProtocol, receiveModulationMode=receiveModulationMode, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseOOBManagementSupport=licenseOOBManagementSupport, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseIssueNumber=licenseIssueNumber, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseEncryption=licenseEncryption, dataBridgingAvailability=dataBridgingAvailability, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
