...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syncETrackingState=syncETrackingState, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseIssueNumber=licenseIssueNumber, bootVersion=bootVersion, syslogControlGroup=syslogControlGroup, management=management, lowestDataModulationMode=lowestDataModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortQLRx=sFPPortQLRx, aggregateDataRate=aggregateDataRate, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableDiagnosticsResultTable=cableDiagnosticsResultTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, productName=productName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, sFPPortStatus=sFPPortStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTimeout=sNTPServerTimeout, sNMPv3Enable=sNMPv3Enable, sNMPPortNumber=sNMPPortNumber, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, dataBridgingStatus=dataBridgingStatus, nIDULanPortStatus=nIDULanPortStatus, dfsTableIndex=dfsTableIndex, subbandLowestFrequency=subbandLowestFrequency, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, useVLANForMABProtocol=useVLANForMABProtocol, iPv6PrefixLength=iPv6PrefixLength, dataPortPauseFrames=dataPortPauseFrames, transparentClockVID=transparentClockVID, ethernetPriorityTable=ethernetPriorityTable, auxPortStatusTrap=auxPortStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, tFTPServerInternetAddress=tFTPServerInternetAddress, alarmsGroup=alarmsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mABNominalTransmitCapacity=mABNominalTransmitCapacity, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, portAllocationMismatch=portAllocationMismatch, qOSPriorityScheme=qOSPriorityScheme, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mABState=mABState, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortQLRx=mainPSUPortQLRx, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, gatewayIPAddress=gatewayIPAddress, dfsTable=dfsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, latitude=latitude, PYSNMP_MODULE_ID=cambium, dfs=dfs, iPVersion=iPVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, tDMInterfaceControl=tDMInterfaceControl, localPacketFiltering=localPacketFiltering, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transparentClockPort=transparentClockPort, tDMEnabledChannels=tDMEnabledChannels, unitOutOfCalibration=unitOutOfCalibration, hTTPAccessEnabled=hTTPAccessEnabled, sFPErrorTrap=sFPErrorTrap, ptp650=ptp650, mainPSUPortQLTx=mainPSUPortQLTx, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsGroup=cableDiagnosticsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, subbandHighestFrequency=subbandHighestFrequency, licenseBandwidthCap=licenseBandwidthCap, tDDControl=tDDControl, transparentClockVLAN=transparentClockVLAN, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, targetMACAddress=targetMACAddress, dfsMeans=dfsMeans, regulatoryBandTrap=regulatoryBandTrap, bridgeGroup=bridgeGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, secondDataBridgingStatus=secondDataBridgingStatus, sFPPortQLTx=sFPPortQLTx, installStatus=installStatus, phyStatus=phyStatus, sNTPServerTable=sNTPServerTable, tDMChannelLoopback=tDMChannelLoopback, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, tDM=tDM, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTable=sNMPTrapTable, tDMChannelStatus=tDMChannelStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, cableDiagPair3Results=cableDiagPair3Results, userPassword=userPassword, cableDiagPair1Distance=cableDiagPair1Distance, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, installArmState=installArmState, capacityVariantMismatch=capacityVariantMismatch, antennaGain=antennaGain, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userTableIndex=userTableIndex, rangingMode=rangingMode, sMTPServerPortNumber=sMTPServerPortNumber, licenseSyncESupport=licenseSyncESupport, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, userTableNumber=userTableNumber, sntpGroup=sntpGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitChannel=transmitChannel, ethernet=ethernet, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTable=userTable, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, ethernetGroup=ethernetGroup, txColorCode=txColorCode, licenseMaxLinkRange=licenseMaxLinkRange, sNMPTrapTableNumber=sNMPTrapTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseCapacity=licenseCapacity, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, ptmp=ptmp, receiveFreqMHz=receiveFreqMHz, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, linkModeOptimization=linkModeOptimization, mainPSUPortAllocation=mainPSUPortAllocation, receivePower=receivePower, dataBridgingStatusAlarm=dataBridgingStatusAlarm, siteName=siteName, licenseEncryption=licenseEncryption, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, bridge=bridge, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyControlGroup=phyControlGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, routerProtocols=routerProtocols, timeZone=timeZone, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, receiveDataRate=receiveDataRate, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, smtp=smtp, licenseRARSupport=licenseRARSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableLoss=cableLoss, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tdmTableIndex=tdmTableIndex, auxPortQLTx=auxPortQLTx, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, txMABFrames=txMABFrames, userTableEntry=userTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, linkLoss=linkLoss, syncETracking=syncETracking, auxPortStatus=auxPortStatus, receiveChannel=receiveChannel, vLANManagementVID=vLANManagementVID, installArmStateTrap=installArmStateTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, managementGroup=managementGroup, licenseGroupAccess=licenseGroupAccess, userRole=userRole, secondDataPortPauseFrames=secondDataPortPauseFrames, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rawReceivePower=rawReceivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, sFPPortAutoMdix=sFPPortAutoMdix, sFPPortSyncERxStatus=sFPPortSyncERxStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, versions=versions, l2CPPriorityTableIndex=l2CPPriorityTableIndex, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPServerTableEntry=sNTPServerTableEntry, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDMChannelCableLength=tDMChannelCableLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, tFTPServerInternetAddressType=tFTPServerInternetAddressType, phyControl=phyControl, vLANManagementPriority=vLANManagementPriority, licenseVersion=licenseVersion, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, supplementaryGroup=supplementaryGroup, productVariant=productVariant, range=range, transmitFreqMHz=transmitFreqMHz, tdmTable=tdmTable, frequencyVariant=frequencyVariant, reset=reset, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tdmTableEntry=tdmTableEntry, groupID=groupID, ptpTraps=ptpTraps, aAAControl=aAAControl, syslogControl=syslogControl, installStatusTrap=installStatusTrap, pubStatsGroup=pubStatsGroup, telnetPortNumber=telnetPortNumber, snmpControl=snmpControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", systemReset=systemReset, enableTransmission=enableTransmission, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, regulatoryBand=regulatoryBand, transmitModulationMode=transmitModulationMode, sNTPState=sNTPState, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortSyncERxStatus=auxPortSyncERxStatus, transmitPower=transmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, targetRange=targetRange, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userEnabled=userEnabled, licenseUnitSerialNumber=licenseUnitSerialNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, routerProtocolsGroup=routerProtocolsGroup, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, daylightSaving=daylightSaving, accessMethod=accessMethod, dSCPManagementPriority=dSCPManagementPriority, cableDiagnostics=cableDiagnostics, linkSymmetry=linkSymmetry, licenseSFPPortSupport=licenseSFPPortSupport, searchState=searchState, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPv4Address=iPv4Address, sNTPServerRetries=sNTPServerRetries, altitude=altitude, sNTPSync=sNTPSync, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, subnetMask=subnetMask, cableDiagPair2Distance=cableDiagPair2Distance, transmitDataRate=transmitDataRate, pubStats=pubStats, sFPPortAllocation=sFPPortAllocation, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, iPv6Address=iPv6Address, hTTPSPortNumber=hTTPSPortNumber, license=license, cambium=cambium, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, supplementary=supplementary, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortSSMTx=mainPSUPortSSMTx, secureModeAlarm=secureModeAlarm, remoteInternetAddressType=remoteInternetAddressType, transparentClock=transparentClock, licenseTrialPeriod=licenseTrialPeriod, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, longitude=longitude, ptp=ptp, mABTransmissionInterval=mABTransmissionInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDMGroup=tDMGroup, lowestTDMModulationMode=lowestTDMModulationMode, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, dfsGroup=dfsGroup, versionsGroup=versionsGroup, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPError=sFPError, syslogClientTrap=syslogClientTrap, sntp=sntp, cableDiagPair4Results=cableDiagPair4Results, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortQLRx=auxPortQLRx, sNMPEnabledTraps=sNMPEnabledTraps, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortStatus=mainPSUPortStatus, resetGroup=resetGroup, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNTPLastSync=sNTPLastSync, sNTPServerTableIndex=sNTPServerTableIndex, mABHoldoffPeriod=mABHoldoffPeriod, channelChangeTrap=channelChangeTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, signalStrengthRatio=signalStrengthRatio, tDDControlGroup=tDDControlGroup, telnetAccessEnabled=telnetAccessEnabled, tdmTableNumber=tdmTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPPollInterval=sNTPPollInterval, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkAvailability=wirelessLinkAvailability, licenseGroup=licenseGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, rxColorCode=rxColorCode, mABProtocolVID=mABProtocolVID, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseIPv6Support=licenseIPv6Support, aAAControlGroup=aAAControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, linkName=linkName, mABNominalModulationMode=mABNominalModulationMode, tDMChannelLineCode=tDMChannelLineCode, maximumTransmitPower=maximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, alarms=alarms, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, vectorError=vectorError, userName=userName, licenseCountry=licenseCountry, encryptionGroup=encryptionGroup, dfsPeaks=dfsPeaks, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, receiveModulationMode=receiveModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableEntry=l2CPPriorityTableEntry, eIRP=eIRP, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseSecurityLevel=licenseSecurityLevel, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, configuration=configuration, dataBridgingAvailability=dataBridgingAvailability, sNTPServerStatus=sNTPServerStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortDisabledWarning=auxPortDisabledWarning, auxPortSSMTx=auxPortSSMTx, sNMPTrapTableEntry=sNMPTrapTableEntry, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, sMTPEnabledMessages=sMTPEnabledMessages, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, ptpCompliance=ptpCompliance, auxPortAllocation=auxPortAllocation, syncEEquipmentClock=syncEEquipmentClock, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseOOBManagementSupport=licenseOOBManagementSupport)
