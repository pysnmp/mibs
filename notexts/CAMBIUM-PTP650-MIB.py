...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", receiveModulationModeDetail=receiveModulationModeDetail, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortAllocation=mainPSUPortAllocation, managementGroup=managementGroup, tDMChannelLoopback=tDMChannelLoopback, tDMChannelCableLength=tDMChannelCableLength, auxPortQLRx=auxPortQLRx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerStatus=sNTPServerStatus, timeZone=timeZone, capacityVariantMismatchTrap=capacityVariantMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, userTableEntry=userTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, mABTransmissionInterval=mABTransmissionInterval, sntp=sntp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsPeaks=dfsPeaks, transmitPower=transmitPower, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, versions=versions, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTable=ethernetPriorityTable, configurationGroup=configurationGroup, sNTPState=sNTPState, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarm=secureModeAlarm, dataPortPauseFrames=dataPortPauseFrames, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bridge=bridge, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDDControlGroup=tDDControlGroup, tDM=tDM, syncEEquipmentClock=syncEEquipmentClock, secondDataPortPauseFrames=secondDataPortPauseFrames, regulatoryBandTrap=regulatoryBandTrap, antennaGain=antennaGain, licenseSyncESupport=licenseSyncESupport, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, remoteInternetAddressType=remoteInternetAddressType, rxColorCode=rxColorCode, sNTPServerInternetAddress=sNTPServerInternetAddress, configuration=configuration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatusGroup=phyStatusGroup, linkModeOptimization=linkModeOptimization, dfsMeans=dfsMeans, remoteInternetAddress=remoteInternetAddress, pubStats=pubStats, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, aAAControl=aAAControl, transmitModulationMode=transmitModulationMode, sFPPortQLRx=sFPPortQLRx, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseOOBManagementSupport=licenseOOBManagementSupport, transmitFreqKHz=transmitFreqKHz, bridgeGroup=bridgeGroup, range=range, tDMInterfaceStatus=tDMInterfaceStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userEnabled=userEnabled, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syslogClient=syslogClient, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernet=ethernet, frequencyVariant=frequencyVariant, maximumTransmitPower=maximumTransmitPower, licenseIssueNumber=licenseIssueNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseVersion=licenseVersion, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, licenseIEEE1588Support=licenseIEEE1588Support, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, rangingMode=rangingMode, tDMGroup=tDMGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, dfsTable=dfsTable, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTimeout=sNTPServerTimeout, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, qOSPriorityScheme=qOSPriorityScheme, tDMChannelStatusTrap=tDMChannelStatusTrap, syncETrackingState=syncETrackingState, licenseSFPPortSupport=licenseSFPPortSupport, siteName=siteName, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRARSupport=licenseRARSupport, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, byteErrorRatio=byteErrorRatio, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPPrimaryServer=sNTPPrimaryServer, iPv4Address=iPv4Address, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, reset=reset, groupID=groupID, subnetMask=subnetMask, notificationsGroup=notificationsGroup, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tdmTableEntry=tdmTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, l2CPPriorityTable=l2CPPriorityTable, phyStatus=phyStatus, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, targetRange=targetRange, sNMPEnabledTraps=sNMPEnabledTraps, latitude=latitude, licenseGroup=licenseGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableDiagPair1Distance=cableDiagPair1Distance, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPVersion=iPVersion, cableDiagPair3Results=cableDiagPair3Results, userTable=userTable, ptpCompliance=ptpCompliance, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, ptpTraps=ptpTraps, dataBridgingStatusAlarm=dataBridgingStatusAlarm, snmpControl=snmpControl, tDDControl=tDDControl, linkLoss=linkLoss, cableDiagPair3Distance=cableDiagPair3Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, telnetPortNumber=telnetPortNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, syncETracking=syncETracking, phyControlGroup=phyControlGroup, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, l2CPPriorityTableNumber=l2CPPriorityTableNumber, alarmsGroup=alarmsGroup, encryptionGroup=encryptionGroup, auxPortDisabledWarning=auxPortDisabledWarning, sNMPTrapVersion=sNMPTrapVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, masterSlaveMode=masterSlaveMode, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockVID=transparentClockVID, auxPortAllocation=auxPortAllocation, channelBandwidth=channelBandwidth, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, managementNetworkAccessEnabled=managementNetworkAccessEnabled, hardwareVersion=hardwareVersion, versionsGroup=versionsGroup, subbandLowestFrequency=subbandLowestFrequency, ptp650=ptp650, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsTableNumber=dfsTableNumber, auxPortQLTx=auxPortQLTx, sFPPortAllocation=sFPPortAllocation, maxLinkRangeExceeded=maxLinkRangeExceeded, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sFPPortQLTx=sFPPortQLTx, tDMEnabledChannels=tDMEnabledChannels, ptmp=ptmp, cambium=cambium, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, installStatus=installStatus, unitOutOfCalibration=unitOutOfCalibration, mABState=mABState, userName=userName, sNTPSync=sNTPSync, cableDiagPair2Results=cableDiagPair2Results, extendedSpectrumScanning=extendedSpectrumScanning, snmpControlGroup=snmpControlGroup, sNTPServerTableNumber=sNTPServerTableNumber, mABProtocolVID=mABProtocolVID, cableDiagnostics=cableDiagnostics, supplementaryGroup=supplementaryGroup, tdmTableNumber=tdmTableNumber, sntpGroup=sntpGroup, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transparentClockPort=transparentClockPort, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseBandwidthCap=licenseBandwidthCap, phyControl=phyControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, syslogClientTrap=syslogClientTrap, enableTransmission=enableTransmission, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPv6Address=iPv6Address, txColorCode=txColorCode, sFPError=sFPError, sNTPPollInterval=sNTPPollInterval, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, management=management, sNMPCommunityString=sNMPCommunityString, txMABFrames=txMABFrames, installStatusTrap=installStatusTrap, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", receiveFreqKHz=receiveFreqKHz, tDMChannelStatus=tDMChannelStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dfsTableIndex=dfsTableIndex, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPv3Enable=sNMPv3Enable, licenseGroupAccess=licenseGroupAccess, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, channelChangeTrap=channelChangeTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, mainPSUPortSSMTx=mainPSUPortSSMTx, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv6GatewayAddress=iPv6GatewayAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, secondDataBridgingStatus=secondDataBridgingStatus, routerProtocolsGroup=routerProtocolsGroup, supplementary=supplementary, sNTPServerTableIndex=sNTPServerTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, PYSNMP_MODULE_ID=cambium, syslogControl=syslogControl, pubStatsGroup=pubStatsGroup, linkName=linkName, cableDiagnosticsGroup=cableDiagnosticsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tdmTableIndex=tdmTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPv6PrefixLength=iPv6PrefixLength, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, auxPortStatus=auxPortStatus, receiveDataRate=receiveDataRate, dataBridgingStatus=dataBridgingStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, auxPortStatusTrap=auxPortStatusTrap, aAAControlGroup=aAAControlGroup, licenseIPv6Support=licenseIPv6Support, linkSymmetry=linkSymmetry, tFTPServerInternetAddress=tFTPServerInternetAddress, localPacketFiltering=localPacketFiltering, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, mABProtocolVLANPriority=mABProtocolVLANPriority, licenseMaxLinkRange=licenseMaxLinkRange, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, productName=productName, longitude=longitude, nIDULanPortStatus=nIDULanPortStatus, installArmState=installArmState, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sFPPortDisabledWarning=sFPPortDisabledWarning, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dfs=dfs, auxPortSyncERxStatus=auxPortSyncERxStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableDiagnosticsResultTable=cableDiagnosticsResultTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortAutoMdix=sFPPortAutoMdix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regulatoryBand=regulatoryBand, sFPPortStatus=sFPPortStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, sFPPortStatusTrap=sFPPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, encryptionAlgorithm=encryptionAlgorithm, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, rawReceivePower=rawReceivePower, eIRP=eIRP, cableLoss=cableLoss, altitude=altitude, sNTPServerTable=sNTPServerTable, productVariant=productVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseCountry=licenseCountry, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sFPPortSSMTx=sFPPortSSMTx, sFPPortAutoNegotiation=sFPPortAutoNegotiation, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerRetries=sNTPServerRetries, hTTPSPortNumber=hTTPSPortNumber, cableDiagPair1Results=cableDiagPair1Results, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataBridgingAvailability=dataBridgingAvailability, license=license, portAllocationMismatchTrap=portAllocationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, mainPSUPortQLRx=mainPSUPortQLRx, auxPortSSMTx=auxPortSSMTx, userRole=userRole, ptp=ptp, portAllocationMismatch=portAllocationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, hTTPPortNumber=hTTPPortNumber, lowestDataModulationMode=lowestDataModulationMode, receiveFreqMHz=receiveFreqMHz, mainPSUPortStatus=mainPSUPortStatus, receivePower=receivePower, mABHoldoffPeriod=mABHoldoffPeriod, userTableIndex=userTableIndex, licenseEncryption=licenseEncryption, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, subbandHighestFrequency=subbandHighestFrequency, licenseTrialPeriod=licenseTrialPeriod, systemReset=systemReset, aggregateDataRate=aggregateDataRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, useVLANForMABProtocol=useVLANForMABProtocol, userTableNumber=userTableNumber, tdmTable=tdmTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsControl=cableDiagnosticsControl, dfsTableEntry=dfsTableEntry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, smtp=smtp, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptpGroups=ptpGroups, routerProtocols=routerProtocols, transparentClockVLAN=transparentClockVLAN, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, wirelessLinkAvailability=wirelessLinkAvailability, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, capacityVariantMismatch=capacityVariantMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, receiveChannel=receiveChannel, transparentClock=transparentClock, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, licenseCapacity=licenseCapacity, sFPErrorTrap=sFPErrorTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving)
