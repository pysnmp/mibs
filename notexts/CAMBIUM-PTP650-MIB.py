...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, license=license, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, ptpCompliance=ptpCompliance, tDMInterfaceControl=tDMInterfaceControl, sFPPortDisabledWarning=sFPPortDisabledWarning, secondDataBridgingStatus=secondDataBridgingStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortQLTx=auxPortQLTx, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseSFPPortSupport=licenseSFPPortSupport, sNMPEnabledTraps=sNMPEnabledTraps, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, supplementary=supplementary, tdmTable=tdmTable, tdmTableNumber=tdmTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair4Distance=cableDiagPair4Distance, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transparentClock=transparentClock, installStatus=installStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, extendedSpectrumScanning=extendedSpectrumScanning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseMaxLinkRange=licenseMaxLinkRange, aAAControlGroup=aAAControlGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tDM=tDM, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, ptp650=ptp650, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseBandwidthCap=licenseBandwidthCap, licenseCapacity=licenseCapacity, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortQLTx=sFPPortQLTx, dataPortPauseFrames=dataPortPauseFrames, secondDataPortPauseFrames=secondDataPortPauseFrames, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, longitude=longitude, userEnabled=userEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, sFPErrorTrap=sFPErrorTrap, userTableNumber=userTableNumber, mABTransmissionInterval=mABTransmissionInterval, tDMChannelLineCode=tDMChannelLineCode, routerProtocols=routerProtocols, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortSSMTx=sFPPortSSMTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, latitude=latitude, auxPortStatusTrap=auxPortStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, searchState=searchState, sNMPTrapTable=sNMPTrapTable, sFPPortQLRx=sFPPortQLRx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, linkSymmetry=linkSymmetry, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRate=transmitDataRate, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dSCPManagementPriority=dSCPManagementPriority, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableNumber=dfsTableNumber, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, auxPortStatus=auxPortStatus, siteName=siteName, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagPair2Results=cableDiagPair2Results, sNMPPortNumber=sNMPPortNumber, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cableDiagPair3Results=cableDiagPair3Results, sMTPServerInternetAddressType=sMTPServerInternetAddressType, eIRP=eIRP, sMTPServerInternetAddress=sMTPServerInternetAddress, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, secureModeAlarm=secureModeAlarm, reset=reset, syncEEquipmentClock=syncEEquipmentClock, sMTPEnabledMessages=sMTPEnabledMessages, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, tDMChannelLoopback=tDMChannelLoopback, licenseTrialPeriod=licenseTrialPeriod, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transparentClockVLAN=transparentClockVLAN, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, remoteInternetAddress=remoteInternetAddress, installArmState=installArmState, sNMPTrapTableNumber=sNMPTrapTableNumber, lowestTDMModulationMode=lowestTDMModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, transparentClockPort=transparentClockPort, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, daylightSaving=daylightSaving, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortStatus=nIDULanPortStatus, productName=productName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseSyncESupport=licenseSyncESupport, transmitPower=transmitPower, aAAControl=aAAControl, resetGroup=resetGroup, receiveChannel=receiveChannel, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, configuration=configuration, mABNominalModulationMode=mABNominalModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, versions=versions, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, sFPPortAllocation=sFPPortAllocation, syncETrackingState=syncETrackingState, enableTransmission=enableTransmission, sNTPServerTable=sNTPServerTable, licenseGroupAccess=licenseGroupAccess, licenseOOBManagementSupport=licenseOOBManagementSupport, ptmp=ptmp, userTableIndex=userTableIndex, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair4Results=cableDiagPair4Results, dfsTable=dfsTable, syslogClientTrap=syslogClientTrap, transmitModulationMode=transmitModulationMode, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControl=snmpControl, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagnosticsWarning=cableDiagnosticsWarning, capacityVariantMismatchTrap=capacityVariantMismatchTrap, frequencyVariant=frequencyVariant, transmitChannel=transmitChannel, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, sFPError=sFPError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogControl=syslogControl, altitude=altitude, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableDiagnostics=cableDiagnostics, txColorCode=txColorCode, remoteInternetAddressType=remoteInternetAddressType, iPv4Address=iPv4Address, txMABFrames=txMABFrames, regulatoryBandTrap=regulatoryBandTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerRetries=sNTPServerRetries, snmpControlGroup=snmpControlGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetPriorityTable=ethernetPriorityTable, licenseIEEE1588Support=licenseIEEE1588Support, licenseSecurityLevel=licenseSecurityLevel, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, localPacketFiltering=localPacketFiltering, sNTPServerTimeout=sNTPServerTimeout, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernetGroup=ethernetGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, cableDiagPair2Distance=cableDiagPair2Distance, userPassword=userPassword, tDDControl=tDDControl, softwareVersion=softwareVersion, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControlGroup=phyControlGroup, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, antennaGain=antennaGain, mABState=mABState, gatewayIPAddress=gatewayIPAddress, dfsMeans=dfsMeans, portAllocationMismatchTrap=portAllocationMismatchTrap, rxColorCode=rxColorCode, auxPortSSMTx=auxPortSSMTx, sNTPPollInterval=sNTPPollInterval, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTableEntry=sNTPServerTableEntry, dfsPeaks=dfsPeaks, bridgeGroup=bridgeGroup, auxPortAllocation=auxPortAllocation, auxPortSyncERxStatus=auxPortSyncERxStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForMABProtocol=useVLANForMABProtocol, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, subbandLowestFrequency=subbandLowestFrequency, tFTPServerInternetAddress=tFTPServerInternetAddress, routerProtocolsGroup=routerProtocolsGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, bridge=bridge, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, lowestDataModulationMode=lowestDataModulationMode, userTable=userTable, licenseIPv6Support=licenseIPv6Support, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, regulatoryBand=regulatoryBand, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, managementNetworkAccessEnabled=managementNetworkAccessEnabled, cableDiagPair1Distance=cableDiagPair1Distance, tDMInterfaceStatus=tDMInterfaceStatus, tDDControlGroup=tDDControlGroup, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sNTPServerStatus=sNTPServerStatus, syslogClient=syslogClient, linkName=linkName, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveDataRate=receiveDataRate, tDMChannelCableLength=tDMChannelCableLength, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, maxLinkRangeExceeded=maxLinkRangeExceeded, syncETracking=syncETracking, sNTPState=sNTPState, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ethernet=ethernet, pubStatsGroup=pubStatsGroup, sNMPCommunityString=sNMPCommunityString, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, licenseCountry=licenseCountry, syslogState=syslogState, dfsTableIndex=dfsTableIndex, tdmTableEntry=tdmTableEntry, hTTPPortNumber=hTTPPortNumber, licenseEncryption=licenseEncryption, mABHoldoffPeriod=mABHoldoffPeriod, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, smtp=smtp, hardwareVersion=hardwareVersion, targetMACAddress=targetMACAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, systemReset=systemReset, notificationsGroup=notificationsGroup, syslogStateTrap=syslogStateTrap, installArmStateTrap=installArmStateTrap, groupID=groupID, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, telnetPortNumber=telnetPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, PYSNMP_MODULE_ID=cambium, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, subnetMask=subnetMask, cableDiagPair1Results=cableDiagPair1Results, tDDSynchronizationStatus=tDDSynchronizationStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortAllocation=mainPSUPortAllocation, iPv6PrefixLength=iPv6PrefixLength, sFPPortStatus=sFPPortStatus, channelBandwidth=channelBandwidth, cableDiagnosticsPorts=cableDiagnosticsPorts, l2CPPriorityTableEntry=l2CPPriorityTableEntry, targetRange=targetRange, tDMChannelStatus=tDMChannelStatus, encryption=encryption, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, transparentClockVID=transparentClockVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfs=dfs, productVariant=productVariant, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortQLRx=auxPortQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, tDMEnabledChannels=tDMEnabledChannels, bootVersion=bootVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mABMaintenanceLevel=mABMaintenanceLevel, userTableEntry=userTableEntry, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, mABProtocolVID=mABProtocolVID, licenseRARSupport=licenseRARSupport, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityVariantMismatch=capacityVariantMismatch, cableDiagnosticsResultTable=cableDiagnosticsResultTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPLastSync=sNTPLastSync, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, mABProtocolVLANPriority=mABProtocolVLANPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, alarms=alarms, sNTPSync=sNTPSync, tDMConfigurationMismatch=tDMConfigurationMismatch, telnetAccessEnabled=telnetAccessEnabled, sNTPServerTableNumber=sNTPServerTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, linkModeOptimization=linkModeOptimization, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortStatus=mainPSUPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, userName=userName, rawReceivePower=rawReceivePower, phyStatus=phyStatus, pubStats=pubStats, auxPortDisabledWarning=auxPortDisabledWarning, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagnosticsControl=cableDiagnosticsControl, ptpGroups=ptpGroups, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, managementGroup=managementGroup, rangingMode=rangingMode, phyControl=phyControl, iPv6Address=iPv6Address, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, timeZone=timeZone, licenseGroup=licenseGroup, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, licenseVersion=licenseVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseIssueNumber=licenseIssueNumber, hTTPSPortNumber=hTTPSPortNumber, tDMGroup=tDMGroup, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, dataBridgingStatus=dataBridgingStatus, tdmTableIndex=tdmTableIndex, portAllocationMismatch=portAllocationMismatch, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
