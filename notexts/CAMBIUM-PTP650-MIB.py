...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", linkModeOptimization=linkModeOptimization, licenseSFPPortSupport=licenseSFPPortSupport, smtp=smtp, cableDiagnosticsWarning=cableDiagnosticsWarning, dataBridgingStatus=dataBridgingStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, userTableIndex=userTableIndex, supplementary=supplementary, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, sFPPortSSMTx=sFPPortSSMTx, versionsGroup=versionsGroup, ethernet=ethernet, sFPErrorTrap=sFPErrorTrap, syslogState=syslogState, auxPortQLTx=auxPortQLTx, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogControlGroup=syslogControlGroup, targetMACAddress=targetMACAddress, installStatus=installStatus, range=range, subbandLowestFrequency=subbandLowestFrequency, licenseRARSupport=licenseRARSupport, dfsTableNumber=dfsTableNumber, bridge=bridge, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, snmpControl=snmpControl, syslogClientTrap=syslogClientTrap, routerProtocolsGroup=routerProtocolsGroup, userName=userName, tDMInterfaceStatus=tDMInterfaceStatus, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, lowestTDMModulationMode=lowestTDMModulationMode, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableDiagPair4Distance=cableDiagPair4Distance, licenseEncryption=licenseEncryption, aAAControlGroup=aAAControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveDataRate=receiveDataRate, nIDULanPortStatusTrap=nIDULanPortStatusTrap, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagnosticsControl=cableDiagnosticsControl, auxPortAllocation=auxPortAllocation, hardwareVersion=hardwareVersion, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, ptp650=ptp650, sNTPServerRetries=sNTPServerRetries, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerTable=sNTPServerTable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, receiveFreqKHz=receiveFreqKHz, smtpGroup=smtpGroup, localPacketFiltering=localPacketFiltering, systemClock=systemClock, reset=reset, frequencyVariant=frequencyVariant, mainPSUPortQLRx=mainPSUPortQLRx, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, mainPSUPortStatus=mainPSUPortStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableDiagPair1Distance=cableDiagPair1Distance, sNTPServerTableIndex=sNTPServerTableIndex, subbandHighestFrequency=subbandHighestFrequency, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDMChannelStatus=tDMChannelStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, managementGroup=managementGroup, phyControlGroup=phyControlGroup, dataBridgingAvailability=dataBridgingAvailability, l2CPPriorityTable=l2CPPriorityTable, licenseBandwidthCap=licenseBandwidthCap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, encryptionGroup=encryptionGroup, mainPSUPortAllocation=mainPSUPortAllocation, tDMInterfaceControl=tDMInterfaceControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkLoss=linkLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortStatus=sFPPortStatus, receiveChannel=receiveChannel, syslogControl=syslogControl, licenseSyncESupport=licenseSyncESupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSyncTrap=sNTPSyncTrap, sFPPortQLTx=sFPPortQLTx, ptmp=ptmp, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, tDMGroup=tDMGroup, receivePower=receivePower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortAllocation=sFPPortAllocation, phyStatusGroup=phyStatusGroup, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syslogClient=syslogClient, tDMChannelLoopback=tDMChannelLoopback, licenseCountry=licenseCountry, cableDiagnosticsGroup=cableDiagnosticsGroup, tDMChannelCableLength=tDMChannelCableLength, nIDULanPortStatus=nIDULanPortStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDMChannelLineCode=tDMChannelLineCode, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, sFPPortStatusTrap=sFPPortStatusTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseTrialPeriod=licenseTrialPeriod, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, configuration=configuration, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userTableEntry=userTableEntry, transmitPower=transmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, management=management, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseGroup=licenseGroup, dfsGroup=dfsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, mABNominalModulationMode=mABNominalModulationMode, ptpTraps=ptpTraps, sNTPState=sNTPState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, receiveModulationMode=receiveModulationMode, tDMChannelStatusTrap=tDMChannelStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPv6Address=iPv6Address, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseSecurityLevel=licenseSecurityLevel, sFPError=sFPError, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, tDM=tDM, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, vLANManagementVID=vLANManagementVID, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, lowestDataModulationMode=lowestDataModulationMode, subnetMask=subnetMask, dfsMeans=dfsMeans, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatch=auxPortConfigurationMismatch, installStatusTrap=installStatusTrap, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, managementPortWirelessDownAlert=managementPortWirelessDownAlert, iPv4Address=iPv4Address, channelBandwidth=channelBandwidth, sntp=sntp, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, linkSymmetry=linkSymmetry, cableDiagnostics=cableDiagnostics, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, auxPortQLRx=auxPortQLRx, tdmTableEntry=tdmTableEntry, sNMPTrapTable=sNMPTrapTable, mainPSUPortQLTx=mainPSUPortQLTx, secondDataBridgingStatus=secondDataBridgingStatus, alarms=alarms, longitude=longitude, aAAControl=aAAControl, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagPair1Results=cableDiagPair1Results, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, configurationGroup=configurationGroup, linkName=linkName, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transparentClockPort=transparentClockPort, iPv6GatewayAddress=iPv6GatewayAddress, unitOutOfCalibration=unitOutOfCalibration, tdmTableNumber=tdmTableNumber, licenseTDDSyncSupport=licenseTDDSyncSupport, sNTPServerStatus=sNTPServerStatus, syncETrackingState=syncETrackingState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, secureModeAlarm=secureModeAlarm, mainPSUPortAutoMdix=mainPSUPortAutoMdix, capacityVariantMismatch=capacityVariantMismatch, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dfsTableIndex=dfsTableIndex, bridgeGroup=bridgeGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, productName=productName, eIRP=eIRP, sNTPServerTableNumber=sNTPServerTableNumber, qOSPriorityScheme=qOSPriorityScheme, txColorCode=txColorCode, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, remoteInternetAddressType=remoteInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, auxPortDisabledWarning=auxPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControlGroup=snmpControlGroup)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTable=userTable, versions=versions, tdmTable=tdmTable, siteName=siteName, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tDDControl=tDDControl, useVLANForMABProtocol=useVLANForMABProtocol, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, license=license, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, byteErrorRatio=byteErrorRatio, dataPortPauseFrames=dataPortPauseFrames, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enableTransmission=enableTransmission, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, encryption=encryption, tDDControlGroup=tDDControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseOOBManagementSupport=licenseOOBManagementSupport, targetRange=targetRange, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, searchState=searchState, gatewayIPAddress=gatewayIPAddress, tdmTableIndex=tdmTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, portAllocationMismatch=portAllocationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, ethernetGroup=ethernetGroup, rxColorCode=rxColorCode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, routerProtocols=routerProtocols, resetGroup=resetGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, sFPPortAutoMdix=sFPPortAutoMdix, managementNetworkAccessEnabled=managementNetworkAccessEnabled, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, extendedSpectrumScanning=extendedSpectrumScanning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sNMPCommunityString=sNMPCommunityString, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, pubStats=pubStats, mABState=mABState, syslogStateTrap=syslogStateTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, dSCPManagementPriority=dSCPManagementPriority, rawReceivePower=rawReceivePower, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair2Results=cableDiagPair2Results, supplementaryGroup=supplementaryGroup, sNTPPollInterval=sNTPPollInterval, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, cableDiagPair3Distance=cableDiagPair3Distance, licenseIssueNumber=licenseIssueNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, auxPortStatus=auxPortStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, userRole=userRole, accessMethod=accessMethod, transmitModulationMode=transmitModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, iPv6PrefixLength=iPv6PrefixLength, sNTPSync=sNTPSync, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerInternetAddress=sMTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortAcceptedQLRx=auxPortAcceptedQLRx, signalStrengthRatio=signalStrengthRatio, timeZone=timeZone, syncEEquipmentClock=syncEEquipmentClock, sNMPPortNumber=sNMPPortNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, userEnabled=userEnabled, PYSNMP_MODULE_ID=cambium, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, auxPortSyncERxStatus=auxPortSyncERxStatus, softwareVersion=softwareVersion, auxPortSSMTx=auxPortSSMTx, iPVersion=iPVersion, secondDataPortPauseFrames=secondDataPortPauseFrames, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ptp=ptp, productVariant=productVariant, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ptpGroups=ptpGroups, mABProtocolVLANPriority=mABProtocolVLANPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortQLRx=sFPPortQLRx, regulatoryBand=regulatoryBand, tDDSynchronizationMode=tDDSynchronizationMode, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, installArmState=installArmState, dfs=dfs, tDMEnabledChannels=tDMEnabledChannels, cambium=cambium, userPassword=userPassword, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, tDMConfigurationMismatch=tDMConfigurationMismatch, mABProtocolVID=mABProtocolVID, altitude=altitude, transmitFreqKHz=transmitFreqKHz, alarmsGroup=alarmsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transparentClockVID=transparentClockVID, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syncETracking=syncETracking, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPPortNumber=hTTPPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseVersion=licenseVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, mABTransmissionInterval=mABTransmissionInterval, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, transparentClock=transparentClock, licenseCapacity=licenseCapacity, licenseRegulatoryBandsList=licenseRegulatoryBandsList, rangingMode=rangingMode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, encryptionAlgorithm=encryptionAlgorithm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, telnetPortNumber=telnetPortNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, installArmStateTrap=installArmStateTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, regulatoryBandTrap=regulatoryBandTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerTableEntry=sNTPServerTableEntry, notificationsGroup=notificationsGroup)
