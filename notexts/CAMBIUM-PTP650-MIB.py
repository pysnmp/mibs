...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syslogControl=syslogControl, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntp=sntp, secureModeAlarm=secureModeAlarm, tdmTableIndex=tdmTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPState=sNTPState, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, frequencyVariant=frequencyVariant, dfsTable=dfsTable, oOBPriorityQueueMapping=oOBPriorityQueueMapping, timeZone=timeZone, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syslogClient=syslogClient, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableEntry=dfsTableEntry, smtpGroup=smtpGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagnosticsControl=cableDiagnosticsControl, userTableEntry=userTableEntry, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptp650=ptp650, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerTableIndex=sNTPServerTableIndex, bridgeGroup=bridgeGroup, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagPair2Results=cableDiagPair2Results, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, targetMACAddress=targetMACAddress, supplementaryGroup=supplementaryGroup, mainPSUPortQLTx=mainPSUPortQLTx, userPassword=userPassword, alarms=alarms, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, localPacketFiltering=localPacketFiltering, syslogStateTrap=syslogStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseCountry=licenseCountry, cableDiagnosticsPorts=cableDiagnosticsPorts, userName=userName, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, lowestTDMModulationMode=lowestTDMModulationMode, licenseSecurityLevel=licenseSecurityLevel, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseRARSupport=licenseRARSupport, sNMPCommunityString=sNMPCommunityString, dSCPManagementPriority=dSCPManagementPriority, userTable=userTable, txColorCode=txColorCode, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sFPPortQLRx=sFPPortQLRx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transparentClockPort=transparentClockPort, systemClock=systemClock, cableDiagPair4Distance=cableDiagPair4Distance, licenseCapacity=licenseCapacity, sNTPServerStatus=sNTPServerStatus, regulatoryBandTrap=regulatoryBandTrap, cableDiagnostics=cableDiagnostics, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseIEEE1588Support=licenseIEEE1588Support, configuration=configuration, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, remoteInternetAddress=remoteInternetAddress, tDMChannelLineCode=tDMChannelLineCode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, daylightSaving=daylightSaving, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPTrapVersion=sNMPTrapVersion, transparentClockVLAN=transparentClockVLAN, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPPollInterval=sNTPPollInterval, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, mainPSUPortAllocation=mainPSUPortAllocation, dfsTableNumber=dfsTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, sFPPortQLTx=sFPPortQLTx, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, bootVersion=bootVersion, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, notificationsGroup=notificationsGroup, tdmTableEntry=tdmTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, regulatoryBand=regulatoryBand, alarmsGroup=alarmsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, licenseGroup=licenseGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, receiveFreqMHz=receiveFreqMHz, sFPPortAllocation=sFPPortAllocation, vLANManagementPriority=vLANManagementPriority, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseBandwidthCap=licenseBandwidthCap, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, channelChangeTrap=channelChangeTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry, routerProtocols=routerProtocols, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, ethernetPriorityTable=ethernetPriorityTable, antennaGain=antennaGain, smtp=smtp, aggregateDataRate=aggregateDataRate, softwareVersion=softwareVersion, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mABState=mABState, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, cableDiagPair3Distance=cableDiagPair3Distance, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortStatusTrap=sFPPortStatusTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, cableDiagPair3Results=cableDiagPair3Results, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tdmTable=tdmTable, rangingMode=rangingMode, syslogClientTrap=syslogClientTrap, tDDSynchronizationMode=tDDSynchronizationMode, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, pubStats=pubStats, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, cableDiagPair2Distance=cableDiagPair2Distance, mABTransmissionInterval=mABTransmissionInterval, groupID=groupID, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, maxLinkRangeExceeded=maxLinkRangeExceeded, dfsTableIndex=dfsTableIndex, auxPortQLTx=auxPortQLTx, phyStatus=phyStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, masterSlaveMode=masterSlaveMode, bridge=bridge, productVariant=productVariant, userTableIndex=userTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, mainPSUPortQLRx=mainPSUPortQLRx, license=license, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syncETracking=syncETracking, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortSSMTx=auxPortSSMTx, licenseIPv6Support=licenseIPv6Support, dfsPeaks=dfsPeaks, sNTPPrimaryServer=sNTPPrimaryServer, mABProtocolVID=mABProtocolVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControlGroup=phyControlGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syncETrackingState=syncETrackingState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernet=ethernet, auxPortAllocation=auxPortAllocation, licenseIssueNumber=licenseIssueNumber, sNTPServerTableNumber=sNTPServerTableNumber, syslogState=syslogState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseEncryption=licenseEncryption, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagPair4Results=cableDiagPair4Results, dataBridgingStatus=dataBridgingStatus, iPv4Address=iPv4Address, tDMEnabledChannels=tDMEnabledChannels, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, licenseSyncESupport=licenseSyncESupport, syncEEquipmentClock=syncEEquipmentClock, PYSNMP_MODULE_ID=cambium, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, dfs=dfs, transmitChannel=transmitChannel, tDMInterfaceControl=tDMInterfaceControl, encryption=encryption, resetGroup=resetGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, useVLANForMABProtocol=useVLANForMABProtocol, auxPortDisabledWarning=auxPortDisabledWarning, receiveChannel=receiveChannel, systemReset=systemReset, cableDiagPair1Distance=cableDiagPair1Distance, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPError=sFPError, productName=productName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortPauseFrames=dataPortPauseFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, nIDULanPortStatus=nIDULanPortStatus, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControl=aAAControl, hTTPAccessEnabled=hTTPAccessEnabled, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMChannelLoopback=tDMChannelLoopback, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transparentClockVID=transparentClockVID, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, licenseVersion=licenseVersion, channelBandwidth=channelBandwidth, userEnabled=userEnabled, ptpCompliance=ptpCompliance, iPv6GatewayAddress=iPv6GatewayAddress, routerProtocolsGroup=routerProtocolsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, enableTransmission=enableTransmission, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, iPv6Address=iPv6Address, targetRange=targetRange, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, transmitModulationMode=transmitModulationMode, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, linkLoss=linkLoss, reset=reset, sMTPServerPortNumber=sMTPServerPortNumber, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMChannelStatus=tDMChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, linkName=linkName, linkModeOptimization=linkModeOptimization, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, configurationGroup=configurationGroup, iPv6PrefixLength=iPv6PrefixLength, tDDControl=tDDControl, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPTrapTableNumber=sNMPTrapTableNumber, versionsGroup=versionsGroup, tDM=tDM, secondDataBridgingStatus=secondDataBridgingStatus, auxPortQLRx=auxPortQLRx, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receivePower=receivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPSync=sNTPSync, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortStatus=auxPortStatus, ptmp=ptmp, pubStatsGroup=pubStatsGroup, sFPErrorTrap=sFPErrorTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRegulatoryBandsList=licenseRegulatoryBandsList, versions=versions, wirelessLinkStatus=wirelessLinkStatus, altitude=altitude, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableDiagPair1Results=cableDiagPair1Results, subnetMask=subnetMask, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptp=ptp, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortStatus=mainPSUPortStatus, rawReceivePower=rawReceivePower, tDMInterfaceStatus=tDMInterfaceStatus, sMTPEmailAlert=sMTPEmailAlert, dataBridgingAvailability=dataBridgingAvailability, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, ptpGroups=ptpGroups, supplementary=supplementary, dfsGroup=dfsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ptpTraps=ptpTraps, installArmState=installArmState, secondarySoftwareVersion=secondarySoftwareVersion, l2CPPriorityTable=l2CPPriorityTable, tDMGroup=tDMGroup, secureModeAlarmTrap=secureModeAlarmTrap, eIRP=eIRP, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableLoss=cableLoss, capacityVariantMismatch=capacityVariantMismatch, latitude=latitude, tdmTableNumber=tdmTableNumber, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPTrapTable=sNMPTrapTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, l2CPPriorityTableIndex=l2CPPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, lowestDataModulationMode=lowestDataModulationMode, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, vLANManagementVID=vLANManagementVID, userRole=userRole, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementGroup=managementGroup, sNTPServerTable=sNTPServerTable, siteName=siteName, sNTPServerInternetAddressType=sNTPServerInternetAddressType, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, vectorError=vectorError, sFPPortStatus=sFPPortStatus, installStatus=installStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClock=transparentClock, cableDiagnosticsWarning=cableDiagnosticsWarning, installArmStateTrap=installArmStateTrap, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveModulationMode=receiveModulationMode, portAllocationMismatch=portAllocationMismatch, installStatusTrap=installStatusTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDSynchronizationStatus=tDDSynchronizationStatus, mABHoldoffPeriod=mABHoldoffPeriod, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, phyControl=phyControl, cambium=cambium, telnetPortNumber=telnetPortNumber, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, mABMaintenanceLevel=mABMaintenanceLevel, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultTable=cableDiagnosticsResultTable, unitOutOfCalibration=unitOutOfCalibration, licenseSFPPortSupport=licenseSFPPortSupport, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, sNTPServerTimeout=sNTPServerTimeout, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mABNominalModulationMode=mABNominalModulationMode, gatewayIPAddress=gatewayIPAddress, dfsMeans=dfsMeans, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tDMChannelCableLength=tDMChannelCableLength, ethernetPriorityTableNumber=ethernetPriorityTableNumber, range=range, rxColorCode=rxColorCode, mPLSTCPriorityTable=mPLSTCPriorityTable, sFPPortSSMTx=sFPPortSSMTx, encryptionAlgorithm=encryptionAlgorithm, hTTPSAccessEnabled=hTTPSAccessEnabled, management=management, licenseUnitSerialNumber=licenseUnitSerialNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, subbandLowestFrequency=subbandLowestFrequency, hardwareVersion=hardwareVersion, transmitFreqMHz=transmitFreqMHz, iPDSCPPriorityTable=iPDSCPPriorityTable)
