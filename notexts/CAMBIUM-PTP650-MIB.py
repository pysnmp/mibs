...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseCapacity=licenseCapacity, sNMPTrapInternetAddress=sNMPTrapInternetAddress, dfs=dfs, useVLANForMABProtocol=useVLANForMABProtocol, alarmsGroup=alarmsGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, encryptionAlgorithm=encryptionAlgorithm, syncEEquipmentClock=syncEEquipmentClock, linkLoss=linkLoss, l2CPPriorityTableEntry=l2CPPriorityTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, siteName=siteName, accessMethod=accessMethod, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, routerProtocolsGroup=routerProtocolsGroup, gatewayIPAddress=gatewayIPAddress, sNMPv3Enable=sNMPv3Enable, dfsTableEntry=dfsTableEntry, cableDiagnosticsControl=cableDiagnosticsControl, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, tDDControl=tDDControl, remoteInternetAddressType=remoteInternetAddressType, licenseGroup=licenseGroup, tDMEnabledChannels=tDMEnabledChannels, range=range, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sFPPortQLTx=sFPPortQLTx, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tdmTableEntry=tdmTableEntry, transmitDataRate=transmitDataRate, licenseSecurityLevel=licenseSecurityLevel, sNTPPrimaryServer=sNTPPrimaryServer, routerProtocols=routerProtocols, oOBPriorityQueueMapping=oOBPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installArmStateTrap=installArmStateTrap, remoteInternetAddress=remoteInternetAddress, resetGroup=resetGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, aAAControlGroup=aAAControlGroup, auxPortSSMTx=auxPortSSMTx, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseCountry=licenseCountry, management=management, managementPortWirelessDownAlert=managementPortWirelessDownAlert, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dfsTableIndex=dfsTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, syncETrackingState=syncETrackingState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sntpGroup=sntpGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, licenseOOBManagementSupport=licenseOOBManagementSupport, groupID=groupID, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, linkModeOptimization=linkModeOptimization, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortSSMTx=sFPPortSSMTx, phyStatusGroup=phyStatusGroup, licenseVersion=licenseVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, transparentClockVLAN=transparentClockVLAN, tFTPServerInternetAddress=tFTPServerInternetAddress, regulatoryBandTrap=regulatoryBandTrap, ptp=ptp, dfsMeans=dfsMeans, sFPPortAutoMdix=sFPPortAutoMdix, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tdmTableIndex=tdmTableIndex, configurationGroup=configurationGroup, syslogStateTrap=syslogStateTrap, iPv6Address=iPv6Address, cableLoss=cableLoss, tDMInterfaceStatus=tDMInterfaceStatus, ptpTraps=ptpTraps, pubStatsGroup=pubStatsGroup, hTTPAccessEnabled=hTTPAccessEnabled, licenseRARSupport=licenseRARSupport, mainPSUPortStatusTrap=mainPSUPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, iPv6GatewayAddress=iPv6GatewayAddress, licenseSyncESupport=licenseSyncESupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mABNominalTransmitCapacity=mABNominalTransmitCapacity, txMABFrames=txMABFrames, tdmTableNumber=tdmTableNumber, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, channelBandwidth=channelBandwidth, dSCPManagementPriority=dSCPManagementPriority, tDMChannelLoopback=tDMChannelLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerTableIndex=sNTPServerTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, licenseIssueNumber=licenseIssueNumber, byteErrorRatio=byteErrorRatio, tDMChannelStatusTrap=tDMChannelStatusTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, masterSlaveMode=masterSlaveMode, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, pubStats=pubStats, regulatoryBand=regulatoryBand, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, supplementaryGroup=supplementaryGroup, aAAControl=aAAControl, sFPPortDisabledWarning=sFPPortDisabledWarning, ethernetPriorityTable=ethernetPriorityTable, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatus=phyStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseIEEE1588Support=licenseIEEE1588Support, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, mainPSUPortAutoMdix=mainPSUPortAutoMdix, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, PYSNMP_MODULE_ID=cambium, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, auxPortStatusTrap=auxPortStatusTrap, sNTPState=sNTPState, cableDiagPair3Results=cableDiagPair3Results, productName=productName, dataBridgingAvailability=dataBridgingAvailability, cambium=cambium, installStatusTrap=installStatusTrap, license=license, frequencyVariant=frequencyVariant, cableDiagPair2Distance=cableDiagPair2Distance, sntp=sntp, transparentClockVID=transparentClockVID, sNTPServerRetries=sNTPServerRetries, telnetPortNumber=telnetPortNumber, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, mainPSUPortQLRx=mainPSUPortQLRx, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPCommunityString=sNMPCommunityString, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, longitude=longitude, tDMGroup=tDMGroup, sNTPServerStatus=sNTPServerStatus, syslogControl=syslogControl, qOSPriorityScheme=qOSPriorityScheme, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, eIRP=eIRP, rangingMode=rangingMode, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortStatus=nIDULanPortStatus, sFPPortAllocation=sFPPortAllocation, licenseRegulatoryBandsList=licenseRegulatoryBandsList, vLANManagementVID=vLANManagementVID, cableDiagnostics=cableDiagnostics, userRole=userRole, auxPortQLRx=auxPortQLRx, cableDiagPair1Results=cableDiagPair1Results, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableNumber=l2CPPriorityTableNumber, installArmState=installArmState, secondarySoftwareVersion=secondarySoftwareVersion, dfsPeaks=dfsPeaks, telnetAccessEnabled=telnetAccessEnabled, dfsGroup=dfsGroup, auxPortQLTx=auxPortQLTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagnosticsPorts=cableDiagnosticsPorts, userTable=userTable, sFPPortStatusTrap=sFPPortStatusTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, secureModeAlarm=secureModeAlarm, linkSymmetry=linkSymmetry, encryption=encryption, hTTPPortNumber=hTTPPortNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz, productVariant=productVariant, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortAllocation=mainPSUPortAllocation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, auxPortAllocation=auxPortAllocation, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, systemClock=systemClock, managementNetworkAccessEnabled=managementNetworkAccessEnabled, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tdmTable=tdmTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, capacityVariantMismatch=capacityVariantMismatch, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv4Address=iPv4Address, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseGroupAccess=licenseGroupAccess, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bridgeGroup=bridgeGroup, maximumTransmitPower=maximumTransmitPower, transparentClock=transparentClock, linkName=linkName, antennaGain=antennaGain, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPServerTable=sNTPServerTable)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", smtpGroup=smtpGroup, mABState=mABState, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseMaxLinkRange=licenseMaxLinkRange, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, incompatibleRegulatoryBands=incompatibleRegulatoryBands, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, secureModeAlarmTrap=secureModeAlarmTrap, mABTransmissionInterval=mABTransmissionInterval, auxPortDisabledWarning=auxPortDisabledWarning, userEnabled=userEnabled, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, vectorError=vectorError, dfsTableNumber=dfsTableNumber, cableDiagPair3Distance=cableDiagPair3Distance, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagPair1Distance=cableDiagPair1Distance, l2CPPriorityTable=l2CPPriorityTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, cableDiagPair2Results=cableDiagPair2Results, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, subbandLowestFrequency=subbandLowestFrequency, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, altitude=altitude, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, latitude=latitude, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, rxColorCode=rxColorCode, userTableEntry=userTableEntry, iPVersion=iPVersion, sFPPortStatus=sFPPortStatus, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, timeZone=timeZone, lowestDataModulationMode=lowestDataModulationMode, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseEncryption=licenseEncryption, mainPSUPortQLTx=mainPSUPortQLTx, receiveFreqMHz=receiveFreqMHz, sNTPServerTableEntry=sNTPServerTableEntry, bootVersion=bootVersion, mABProtocolVID=mABProtocolVID, ethernet=ethernet, mABProtocolVLANPriority=mABProtocolVLANPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, userPassword=userPassword, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, txColorCode=txColorCode, targetRange=targetRange, extendedSpectrumScanning=extendedSpectrumScanning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair4Results=cableDiagPair4Results, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, syslogState=syslogState, notificationsGroup=notificationsGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, mABMaintenanceLevel=mABMaintenanceLevel, tDMInterfaceControl=tDMInterfaceControl, mABNominalModulationMode=mABNominalModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, versions=versions, tDMConfigurationMismatch=tDMConfigurationMismatch, userTableIndex=userTableIndex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, ethernetPriorityTableNumber=ethernetPriorityTableNumber, tDMChannelCableLength=tDMChannelCableLength, receiveDataRate=receiveDataRate, ptmp=ptmp, tDM=tDM, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptp650=ptp650, receivePower=receivePower, ethernetGroup=ethernetGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, cableDiagnosticsGroup=cableDiagnosticsGroup, sNTPServerTableNumber=sNTPServerTableNumber, sFPPortQLRx=sFPPortQLRx, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNTPServerTimeout=sNTPServerTimeout, softwareVersion=softwareVersion, syncETracking=syncETracking, aggregateDataRate=aggregateDataRate, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPLastSync=sNTPLastSync, transparentClockPort=transparentClockPort, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNMPTrapTable=sNMPTrapTable, reset=reset, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveModulationModeDetail=receiveModulationModeDetail, supplementary=supplementary, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, phyControl=phyControl, sFPErrorTrap=sFPErrorTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseBandwidthCap=licenseBandwidthCap, sMTPEmailAlert=sMTPEmailAlert, portAllocationMismatch=portAllocationMismatch, licenseTrialPeriod=licenseTrialPeriod, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, userName=userName, daylightSaving=daylightSaving, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortAutoNegotiation=sFPPortAutoNegotiation, subnetMask=subnetMask, cableDiagPair4Distance=cableDiagPair4Distance, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, auxPortStatus=auxPortStatus, localPacketFiltering=localPacketFiltering, searchState=searchState, dataPortPauseFrames=dataPortPauseFrames, lowestTDMModulationMode=lowestTDMModulationMode, dfsTable=dfsTable, targetMACAddress=targetMACAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortStatus=mainPSUPortStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, receiveChannel=receiveChannel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPv6PrefixLength=iPv6PrefixLength, enableTransmission=enableTransmission, bridge=bridge, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, syslogControlGroup=syslogControlGroup, tDMChannelLineCode=tDMChannelLineCode, sNMPEnabledTraps=sNMPEnabledTraps, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, rawReceivePower=rawReceivePower, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPError=sFPError, dataBridgingStatus=dataBridgingStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, sNTPSync=sNTPSync, phyControlGroup=phyControlGroup, receiveModulationMode=receiveModulationMode, lowestSecondDataModulationMode=lowestSecondDataModulationMode, tDMChannelStatus=tDMChannelStatus, managementGroup=managementGroup, licenseIPv6Support=licenseIPv6Support, secondDataBridgingStatus=secondDataBridgingStatus)
