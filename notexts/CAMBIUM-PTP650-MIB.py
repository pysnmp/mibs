...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", snmpControl=snmpControl, ethernetPriorityTable=ethernetPriorityTable, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ptp=ptp, encryption=encryption, auxPortStatusTrap=auxPortStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, ptpCompliance=ptpCompliance, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortAllocation=mainPSUPortAllocation, syslogClient=syslogClient, mABState=mABState, tDMChannelStatusTrap=tDMChannelStatusTrap, tDMChannelStatus=tDMChannelStatus, ptpTraps=ptpTraps, reset=reset, sNMPv3Enable=sNMPv3Enable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dfsMeans=dfsMeans, userRole=userRole, sNTPServerTable=sNTPServerTable, tDMChannelLoopback=tDMChannelLoopback, userEnabled=userEnabled, receiveChannel=receiveChannel, snmpControlGroup=snmpControlGroup, remoteInternetAddress=remoteInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitPower=transmitPower, tDMChannelCableLength=tDMChannelCableLength, masterSlaveMode=masterSlaveMode, auxPortQLRx=auxPortQLRx, tdmTableEntry=tdmTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, cableDiagPair3Distance=cableDiagPair3Distance, aggregateDataRate=aggregateDataRate, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, iPv6GatewayAddress=iPv6GatewayAddress, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetGroup=ethernetGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tDDControlGroup=tDDControlGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPPortAutoMdix=sFPPortAutoMdix, sNTPServerRetries=sNTPServerRetries, lowestSecondDataModulationMode=lowestSecondDataModulationMode, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tDDSynchronizationStatus=tDDSynchronizationStatus, systemClock=systemClock, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syncEEquipmentClock=syncEEquipmentClock, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseCountry=licenseCountry, sFPPortSSMTx=sFPPortSSMTx, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqKHz=transmitFreqKHz, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, bridgeGroup=bridgeGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDControl=tDDControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, resetGroup=resetGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTableEntry=ethernetPriorityTableEntry, userTable=userTable, sNTPSyncTrap=sNTPSyncTrap, cableDiagnosticsControl=cableDiagnosticsControl, versions=versions, cableDiagPair2Distance=cableDiagPair2Distance, licenseEncryption=licenseEncryption, sFPPortQLRx=sFPPortQLRx, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, auxPortSyncERxStatus=auxPortSyncERxStatus, maximumTransmitPower=maximumTransmitPower, versionsGroup=versionsGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, telnetPortNumber=telnetPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transparentClockVID=transparentClockVID, smtp=smtp, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sNTPState=sNTPState, cableDiagnosticsGroup=cableDiagnosticsGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tdmTableNumber=tdmTableNumber, routerProtocolsGroup=routerProtocolsGroup, subbandLowestFrequency=subbandLowestFrequency, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, localPacketFiltering=localPacketFiltering, auxPortQLTx=auxPortQLTx, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPVersion=iPVersion, licenseCapacity=licenseCapacity, oOBPriorityQueueMapping=oOBPriorityQueueMapping, receivePower=receivePower, installArmStateTrap=installArmStateTrap, capacityVariantMismatch=capacityVariantMismatch, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMConfigurationMismatch=tDMConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, transparentClockVLAN=transparentClockVLAN, productVariant=productVariant, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rangingMode=rangingMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sFPPortAllocation=sFPPortAllocation, sntp=sntp, mainPSUPortAutoMdix=mainPSUPortAutoMdix, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, iPv6Address=iPv6Address, latitude=latitude, sNTPPrimaryServer=sNTPPrimaryServer, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, systemReset=systemReset, vLANManagementVID=vLANManagementVID, mABMaintenanceLevel=mABMaintenanceLevel, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, mABNominalTransmitCapacity=mABNominalTransmitCapacity, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, configurationGroup=configurationGroup, regulatoryBandTrap=regulatoryBandTrap, secureModeAlarm=secureModeAlarm, iPv6PrefixLength=iPv6PrefixLength, cambium=cambium, extendedSpectrumScanning=extendedSpectrumScanning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, targetRange=targetRange, sNMPTrapTable=sNMPTrapTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNMPCommunityString=sNMPCommunityString, mainPSUPortQLTx=mainPSUPortQLTx, dSCPManagementPriority=dSCPManagementPriority, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, wirelessLinkAvailability=wirelessLinkAvailability, licenseSFPPortSupport=licenseSFPPortSupport, ptpGroups=ptpGroups, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortPauseFrames=dataPortPauseFrames, aAAControl=aAAControl, cableDiagPair2Results=cableDiagPair2Results, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, transmitModulationMode=transmitModulationMode, auxPortAllocation=auxPortAllocation, range=range, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, hTTPSPortNumber=hTTPSPortNumber, dfsTableEntry=dfsTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, encryptionGroup=encryptionGroup, eIRP=eIRP, rxColorCode=rxColorCode, syncETracking=syncETracking, mainPSUPortQLRx=mainPSUPortQLRx, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPPollInterval=sNTPPollInterval, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mABProtocolVID=mABProtocolVID, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDM=tDM, dfsTable=dfsTable, supplementaryGroup=supplementaryGroup, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sFPPortAutoNegotiation=sFPPortAutoNegotiation, subnetMask=subnetMask, tdmTableIndex=tdmTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, remoteInternetAddressType=remoteInternetAddressType, licenseUnitSerialNumber=licenseUnitSerialNumber, longitude=longitude, sNMPPortNumber=sNMPPortNumber, license=license, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, phyStatusGroup=phyStatusGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, userTableEntry=userTableEntry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, dataBridgingStatus=dataBridgingStatus, altitude=altitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sFPPortStatus=sFPPortStatus, gatewayIPAddress=gatewayIPAddress, rawReceivePower=rawReceivePower, cableDiagnostics=cableDiagnostics, sFPError=sFPError, useVLANForMABProtocol=useVLANForMABProtocol, licenseBandwidthCap=licenseBandwidthCap, PYSNMP_MODULE_ID=cambium, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syslogControl=syslogControl, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, userPassword=userPassword, frequencyVariant=frequencyVariant, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dfsPeaks=dfsPeaks, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, softwareVersion=softwareVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, lowestTDMModulationMode=lowestTDMModulationMode, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkSymmetry=linkSymmetry, transmitDataRate=transmitDataRate, sNTPSync=sNTPSync, secondDataPortPauseFrames=secondDataPortPauseFrames, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseSecurityLevel=licenseSecurityLevel, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, installStatusTrap=installStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableDiagPair1Distance=cableDiagPair1Distance)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mABProtocolVLANPriority=mABProtocolVLANPriority, tDMInterfaceStatus=tDMInterfaceStatus, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, signalStrengthRatio=signalStrengthRatio, syslogClientTrap=syslogClientTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, notificationsGroup=notificationsGroup, licenseGroupAccess=licenseGroupAccess, licenseIssueNumber=licenseIssueNumber, licenseTrialPeriod=licenseTrialPeriod, timeZone=timeZone, syslogControlGroup=syslogControlGroup, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortStatusTrap=mainPSUPortStatusTrap, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, mABHoldoffPeriod=mABHoldoffPeriod, linkModeOptimization=linkModeOptimization, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationMode=receiveModulationMode, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, bridge=bridge, syslogState=syslogState, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenseVersion=licenseVersion, tDDSynchronizationMode=tDDSynchronizationMode, alarmsGroup=alarmsGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, cableDiagPair4Distance=cableDiagPair4Distance, transmitChannel=transmitChannel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, dfsGroup=dfsGroup, mABNominalModulationMode=mABNominalModulationMode, regulatoryBand=regulatoryBand, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, targetMACAddress=targetMACAddress, linkName=linkName, byteErrorRatio=byteErrorRatio, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, l2CPPriorityTable=l2CPPriorityTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortSSMTx=mainPSUPortSSMTx, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transparentClockPort=transparentClockPort, productName=productName, auxPortSSMTx=auxPortSSMTx, tdmTable=tdmTable, enableTransmission=enableTransmission, searchState=searchState, tDMInterfaceControl=tDMInterfaceControl, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIPv6Support=licenseIPv6Support, managementPortWirelessDownAlert=managementPortWirelessDownAlert, nIDULanPortStatus=nIDULanPortStatus, tDMGroup=tDMGroup, sFPPortQLTx=sFPPortQLTx, smtpGroup=smtpGroup, dfsTableNumber=dfsTableNumber, auxPortStatus=auxPortStatus, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, receiveDataRate=receiveDataRate, mainPSUPortStatus=mainPSUPortStatus, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, userTableNumber=userTableNumber, daylightSaving=daylightSaving, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, sFPErrorTrap=sFPErrorTrap, licenseGroup=licenseGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, portAllocationMismatch=portAllocationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, auxPortDisabledWarning=auxPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, sntpGroup=sntpGroup, ptp650=ptp650, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, userTableIndex=userTableIndex, siteName=siteName, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsPorts=cableDiagnosticsPorts, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, txColorCode=txColorCode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, pubStats=pubStats, sNTPServerTableNumber=sNTPServerTableNumber, ptpTrapPrefix=ptpTrapPrefix, pubStatsGroup=pubStatsGroup, bootVersion=bootVersion, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, cableLoss=cableLoss, licenseIEEE1588Support=licenseIEEE1588Support, sMTPServerInternetAddress=sMTPServerInternetAddress, managementNetworkAccessEnabled=managementNetworkAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mABTransmissionInterval=mABTransmissionInterval, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, sNTPServerTimeout=sNTPServerTimeout, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPv4Address=iPv4Address, configuration=configuration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMEnabledChannels=tDMEnabledChannels, dataBridgingAvailability=dataBridgingAvailability, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseSyncESupport=licenseSyncESupport, hTTPAccessEnabled=hTTPAccessEnabled, routerProtocols=routerProtocols, sFPPortStatusTrap=sFPPortStatusTrap, installArmState=installArmState, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syncETrackingState=syncETrackingState, transparentClock=transparentClock, managementGroup=managementGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDMChannelLineCode=tDMChannelLineCode, receiveModulationModeDetail=receiveModulationModeDetail, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseRARSupport=licenseRARSupport, lowestDataModulationMode=lowestDataModulationMode, accessMethod=accessMethod, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerStatus=sNTPServerStatus, cableDiagPair1Results=cableDiagPair1Results, userName=userName, secondDataBridgingStatus=secondDataBridgingStatus, cableDiagPair4Results=cableDiagPair4Results, cableDiagPair3Results=cableDiagPair3Results, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, secureModeAlarmTrap=secureModeAlarmTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerTableEntry=sNTPServerTableEntry, maxLinkRangeExceeded=maxLinkRangeExceeded, groupID=groupID, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning)
