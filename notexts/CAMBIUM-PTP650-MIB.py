...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNMPTrapTable=sNMPTrapTable, telnetAccessEnabled=telnetAccessEnabled, vLANManagementVID=vLANManagementVID, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, dfsPeaks=dfsPeaks, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, licenseGroup=licenseGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseBandwidthCap=licenseBandwidthCap, licenseCapacity=licenseCapacity, userTableNumber=userTableNumber, rangingMode=rangingMode, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPPortQLRx=sFPPortQLRx, supplementary=supplementary, phyControlGroup=phyControlGroup, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, installStatusTrap=installStatusTrap, gatewayIPAddress=gatewayIPAddress, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseEncryption=licenseEncryption, iPv6Address=iPv6Address, userEnabled=userEnabled, lowestSecondDataModulationMode=lowestSecondDataModulationMode, productVariant=productVariant, capacityVariantMismatchTrap=capacityVariantMismatchTrap, targetRange=targetRange, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogClient=syslogClient, versionsGroup=versionsGroup, antennaGain=antennaGain, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bridgeGroup=bridgeGroup, sMTPEmailAlert=sMTPEmailAlert, sFPPortStatus=sFPPortStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapPortNumber=sNMPTrapPortNumber, sFPPortStatusTrap=sFPPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortDisabledWarning=sFPPortDisabledWarning, cambium=cambium, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortStatus=auxPortStatus, sNTPSync=sNTPSync, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPrimaryServer=sNTPPrimaryServer, ethernet=ethernet, ptpTrapPrefix=ptpTrapPrefix, groupID=groupID, licenseTDDSyncSupport=licenseTDDSyncSupport, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableNumber=sNTPServerTableNumber, transmitModulationMode=transmitModulationMode, subnetMask=subnetMask, hardwareVersion=hardwareVersion, auxPortAllocation=auxPortAllocation, sNMPPortNumber=sNMPPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, tDMEnabledChannels=tDMEnabledChannels, enableTransmission=enableTransmission, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortStatusTrap=mainPSUPortStatusTrap, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, dataBridgingStatus=dataBridgingStatus, transmitChannel=transmitChannel, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortQLRx=auxPortQLRx, softwareVersion=softwareVersion, sFPPortAutoMdix=sFPPortAutoMdix, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, byteErrorRatio=byteErrorRatio, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPPortNumber=hTTPPortNumber, ptpCompliance=ptpCompliance, phyControl=phyControl, channelBandwidth=channelBandwidth, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sMTPServerInternetAddress=sMTPServerInternetAddress, dfsGroup=dfsGroup, mABNominalModulationMode=mABNominalModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnosticsControl=cableDiagnosticsControl, tFTPServerInternetAddress=tFTPServerInternetAddress, resetGroup=resetGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, managementGroup=managementGroup, nIDULanPortStatus=nIDULanPortStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, tDMGroup=tDMGroup, range=range, transparentClockVID=transparentClockVID, userTableIndex=userTableIndex, versions=versions, sNTPServerTableEntry=sNTPServerTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPVersion=iPVersion, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnostics=cableDiagnostics, cableDiagPair4Results=cableDiagPair4Results, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syncEEquipmentClock=syncEEquipmentClock, tDMChannelStatus=tDMChannelStatus, latitude=latitude, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStats=pubStats, syslogState=syslogState, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secondDataBridgingStatus=secondDataBridgingStatus, sNTPServerStatus=sNTPServerStatus, smtpGroup=smtpGroup, syslogStateTrap=syslogStateTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, txColorCode=txColorCode, licenseVersion=licenseVersion, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, eIRP=eIRP, tDDControl=tDDControl, userName=userName, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, daylightSaving=daylightSaving, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDMChannelCableLength=tDMChannelCableLength, sNTPServerInternetAddressType=sNTPServerInternetAddressType, alarmsGroup=alarmsGroup, licenseIPv6Support=licenseIPv6Support, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, configuration=configuration, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseIEEE1588Support=licenseIEEE1588Support, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsResultTable=cableDiagnosticsResultTable, pubStatsGroup=pubStatsGroup, mABHoldoffPeriod=mABHoldoffPeriod, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp650=ptp650, cableDiagPair3Results=cableDiagPair3Results, localPacketFiltering=localPacketFiltering, l2CPPriorityTable=l2CPPriorityTable, licenseCountry=licenseCountry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, syslogControl=syslogControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, systemClock=systemClock, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mABState=mABState, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, capacityVariantMismatch=capacityVariantMismatch, auxPortConfigurationMismatch=auxPortConfigurationMismatch, PYSNMP_MODULE_ID=cambium, auxPortSyncERxStatus=auxPortSyncERxStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, maxLinkRangeExceeded=maxLinkRangeExceeded, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, maximumTransmitPower=maximumTransmitPower, regulatoryBand=regulatoryBand, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementNetworkAccessEnabled=managementNetworkAccessEnabled, userRole=userRole, syncETrackingState=syncETrackingState, syslogClientTrap=syslogClientTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagPair2Distance=cableDiagPair2Distance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, sNMPv3Enable=sNMPv3Enable, license=license, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortStatus=mainPSUPortStatus, vectorError=vectorError, nIDULanPortAutoMdix=nIDULanPortAutoMdix, smtp=smtp, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, siteName=siteName, sNTPState=sNTPState, dfsTableNumber=dfsTableNumber, timeZone=timeZone, alarms=alarms, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortSSMTx=auxPortSSMTx, sNTPServerTimeout=sNTPServerTimeout, transparentClockPort=transparentClockPort, licenseUnitSerialNumber=licenseUnitSerialNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsWarning=cableDiagnosticsWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv4Address=iPv4Address, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, sNTPServerInternetAddress=sNTPServerInternetAddress, phyStatusGroup=phyStatusGroup, licenseSFPPortSupport=licenseSFPPortSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syncETracking=syncETracking, licenseIssueNumber=licenseIssueNumber, dfs=dfs, sNTPServerTable=sNTPServerTable, sNTPServerTableIndex=sNTPServerTableIndex, bridge=bridge, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mABProtocolVLANPriority=mABProtocolVLANPriority, txMABFrames=txMABFrames, unitOutOfCalibration=unitOutOfCalibration, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, remoteInternetAddressType=remoteInternetAddressType, secureModeAlarmTrap=secureModeAlarmTrap, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", ptmp=ptmp, masterSlaveMode=masterSlaveMode, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, cableDiagPair4Distance=cableDiagPair4Distance, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTable=dfsTable, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, mABTransmissionInterval=mABTransmissionInterval, tDMInterfaceStatus=tDMInterfaceStatus, receiveFreqMHz=receiveFreqMHz, sNTPServerRetries=sNTPServerRetries, tDM=tDM, sntp=sntp, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, licenseGroupAccess=licenseGroupAccess, sFPPortAllocation=sFPPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, cableDiagPair1Distance=cableDiagPair1Distance, installArmStateTrap=installArmStateTrap, auxPortQLTx=auxPortQLTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, reset=reset, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tdmTable=tdmTable, telnetPortNumber=telnetPortNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, installStatus=installStatus, snmpControl=snmpControl, licenseRARSupport=licenseRARSupport, routerProtocolsGroup=routerProtocolsGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, configurationGroup=configurationGroup, iPv6GatewayAddress=iPv6GatewayAddress, aAAControl=aAAControl, rawReceivePower=rawReceivePower, cableDiagnosticsPorts=cableDiagnosticsPorts, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableLoss=cableLoss, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, productName=productName, receiveModulationMode=receiveModulationMode, sFPPortSSMTx=sFPPortSSMTx, dfsMeans=dfsMeans, dfsTableIndex=dfsTableIndex, receivePower=receivePower, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortQLTx=mainPSUPortQLTx, auxPortStatusTrap=auxPortStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, useVLANForMABProtocol=useVLANForMABProtocol, encryptionAlgorithm=encryptionAlgorithm, tdmTableEntry=tdmTableEntry, portAllocationMismatch=portAllocationMismatch, mABProtocolVID=mABProtocolVID, tDMChannelLineCode=tDMChannelLineCode, encryptionGroup=encryptionGroup, transparentClock=transparentClock, cableDiagPair1Results=cableDiagPair1Results, frequencyVariant=frequencyVariant, userTableEntry=userTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPErrorTrap=sFPErrorTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, searchState=searchState, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, transmitPower=transmitPower, iPv6PrefixLength=iPv6PrefixLength, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, rxColorCode=rxColorCode, linkModeOptimization=linkModeOptimization, cableDiagPair3Distance=cableDiagPair3Distance, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, systemReset=systemReset, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortQLTx=sFPPortQLTx, secondDataPortPauseFrames=secondDataPortPauseFrames, userPassword=userPassword, wirelessLinkStatus=wirelessLinkStatus, mABMaintenanceLevel=mABMaintenanceLevel, channelChangeTrap=channelChangeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPError=sFPError, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, subbandLowestFrequency=subbandLowestFrequency, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, cableDiagPair2Results=cableDiagPair2Results, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPTrapInternetAddress=sNMPTrapInternetAddress, transmitDataRate=transmitDataRate, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitFreqKHz=transmitFreqKHz, lowestTDMModulationMode=lowestTDMModulationMode, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBandTrap=regulatoryBandTrap, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, tdmTableIndex=tdmTableIndex, snmpControlGroup=snmpControlGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tdmTableNumber=tdmTableNumber, licenseSyncESupport=licenseSyncESupport, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseSecurityLevel=licenseSecurityLevel, syslogControlGroup=syslogControlGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, qOSPriorityScheme=qOSPriorityScheme, longitude=longitude, management=management, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, dataPortPauseFrames=dataPortPauseFrames, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortQLRx=mainPSUPortQLRx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, linkSymmetry=linkSymmetry, auxPortDisabledWarning=auxPortDisabledWarning, remoteInternetAddress=remoteInternetAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, routerProtocols=routerProtocols, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTable=userTable, secureModeAlarm=secureModeAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseMaxLinkRange=licenseMaxLinkRange, linkName=linkName, mainPSUPortAllocation=mainPSUPortAllocation, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMInterfaceControl=tDMInterfaceControl, accessMethod=accessMethod, tDDControlGroup=tDDControlGroup, licenseTrialPeriod=licenseTrialPeriod, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, dataBridgingAvailability=dataBridgingAvailability)
