...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", supplementary=supplementary, syncETrackingState=syncETrackingState, cableDiagnostics=cableDiagnostics, syslogControlGroup=syslogControlGroup, mainPSUPortAllocation=mainPSUPortAllocation, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMChannelStatusTrap=tDMChannelStatusTrap, tDMInterfaceStatus=tDMInterfaceStatus, supplementaryGroup=supplementaryGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNMPTrapTable=sNMPTrapTable, localPacketFiltering=localPacketFiltering, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, licenseRARSupport=licenseRARSupport, userName=userName, license=license, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, searchState=searchState, cableDiagnosticsPorts=cableDiagnosticsPorts, subbandLowestFrequency=subbandLowestFrequency, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, ptpCompliance=ptpCompliance, cableLoss=cableLoss, bridge=bridge, phyStatusGroup=phyStatusGroup, ethernet=ethernet, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseCountry=licenseCountry, targetRange=targetRange, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortSSMTx=sFPPortSSMTx, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, tDMChannelLoopback=tDMChannelLoopback, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, reset=reset, aAAControlGroup=aAAControlGroup, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVID=mABProtocolVID, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, alarms=alarms, smtpGroup=smtpGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, transmitModulationMode=transmitModulationMode, txColorCode=txColorCode, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseTDDSyncSupport=licenseTDDSyncSupport, receiveModulationMode=receiveModulationMode, bridgeGroup=bridgeGroup, iPv4Address=iPv4Address, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntp=sntp, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, phyControl=phyControl, licenseEncryption=licenseEncryption, sNTPServerTable=sNTPServerTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv6GatewayAddress=iPv6GatewayAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagnosticsControl=cableDiagnosticsControl, sNTPServerTimeout=sNTPServerTimeout, auxPortSSMTx=auxPortSSMTx, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enableTransmission=enableTransmission, auxPortAllocation=auxPortAllocation, configurationGroup=configurationGroup, ptp650=ptp650, mABMaintenanceLevel=mABMaintenanceLevel, receiveChannel=receiveChannel, encryption=encryption, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, lowestDataModulationMode=lowestDataModulationMode, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sFPErrorTrap=sFPErrorTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagPair3Distance=cableDiagPair3Distance, siteName=siteName, pubStatsGroup=pubStatsGroup, syslogStateTrap=syslogStateTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNTPServerStatus=sNTPServerStatus, eIRP=eIRP, syslogClient=syslogClient, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, syslogState=syslogState, dfsTableNumber=dfsTableNumber, dataBridgingAvailability=dataBridgingAvailability, dfsPeaks=dfsPeaks, productVariant=productVariant, userRole=userRole, ethernetGroup=ethernetGroup, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseGroup=licenseGroup, transmitFreqKHz=transmitFreqKHz, ptpTrapPrefix=ptpTrapPrefix, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, extendedSpectrumScanning=extendedSpectrumScanning, auxPortAcceptedQLRx=auxPortAcceptedQLRx, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDMGroup=tDMGroup, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimization=linkModeOptimization, wirelessLinkAvailability=wirelessLinkAvailability, iPv6PrefixLength=iPv6PrefixLength, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bootVersion=bootVersion, remoteInternetAddress=remoteInternetAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, linkLoss=linkLoss, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, subnetMask=subnetMask, remoteInternetAddressType=remoteInternetAddressType, sNTPSync=sNTPSync, iPv6Address=iPv6Address, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControlGroup=tDDControlGroup, sNMPCommunityString=sNMPCommunityString, receivePower=receivePower, ptpGroups=ptpGroups, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, regulatoryBandTrap=regulatoryBandTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, sFPPortAutoMdix=sFPPortAutoMdix, capacityVariantMismatch=capacityVariantMismatch, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDM=tDM, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, txMABFrames=txMABFrames, licenseSFPPortSupport=licenseSFPPortSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPPollInterval=sNTPPollInterval, cableDiagPair3Results=cableDiagPair3Results, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, hTTPSPortNumber=hTTPSPortNumber, timeZone=timeZone, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, resetGroup=resetGroup, sFPError=sFPError, syncEEquipmentClock=syncEEquipmentClock, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortStatus=mainPSUPortStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, dfs=dfs, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, secureModeAlarm=secureModeAlarm, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, subbandHighestFrequency=subbandHighestFrequency, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tdmTableIndex=tdmTableIndex, antennaGain=antennaGain, userTable=userTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseBandwidthCap=licenseBandwidthCap, mABState=mABState, sNTPLastSync=sNTPLastSync, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, receiveDataRate=receiveDataRate, configuration=configuration, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, mABProtocolVLANPriority=mABProtocolVLANPriority, tDDControl=tDDControl, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, systemClock=systemClock, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, linkName=linkName, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, vLANManagementPriority=vLANManagementPriority, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sMTPEmailAlert=sMTPEmailAlert, rxColorCode=rxColorCode, sFPPortStatusTrap=sFPPortStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpTraps=ptpTraps, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkStatus=wirelessLinkStatus, dfsTableEntry=dfsTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPPortNumber=sNMPPortNumber, receiveFreqKHz=receiveFreqKHz, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, licenseCapacity=licenseCapacity, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, licenseSecurityLevel=licenseSecurityLevel, sNTPServerTableEntry=sNTPServerTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, accessMethod=accessMethod, tdmTable=tdmTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseVersion=licenseVersion, longitude=longitude, rangingMode=rangingMode, sFPPortSyncERxStatus=sFPPortSyncERxStatus, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, encryptionGroup=encryptionGroup, tDMChannelStatus=tDMChannelStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, snmpControlGroup=snmpControlGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair4Results=cableDiagPair4Results, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sFPPortAllocation=sFPPortAllocation, tDMChannelLineCode=tDMChannelLineCode, tDMConfigurationMismatch=tDMConfigurationMismatch, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ptmp=ptmp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maxLinkRangeExceeded=maxLinkRangeExceeded, dataBridgingStatus=dataBridgingStatus, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vectorError=vectorError, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, aAAControl=aAAControl, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, auxPortDisabledWarning=auxPortDisabledWarning, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, groupID=groupID, alarmsGroup=alarmsGroup, licenseTrialPeriod=licenseTrialPeriod, range=range, managementGroup=managementGroup, versions=versions, cambium=cambium, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, management=management, tdmTableEntry=tdmTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, iPVersion=iPVersion, transmitChannel=transmitChannel, sNTPServerRetries=sNTPServerRetries, licenseIssueNumber=licenseIssueNumber, dfsTable=dfsTable, installArmStateTrap=installArmStateTrap, nIDULanPortStatus=nIDULanPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, versionsGroup=versionsGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseGroupAccess=licenseGroupAccess, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, sNMPv3Enable=sNMPv3Enable, auxPortSyncERxStatus=auxPortSyncERxStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, notificationsGroup=notificationsGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, altitude=altitude, linkSymmetry=linkSymmetry, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secondDataBridgingStatus=secondDataBridgingStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, hardwareVersion=hardwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortQLRx=mainPSUPortQLRx, masterSlaveMode=masterSlaveMode, tDMEnabledChannels=tDMEnabledChannels, transparentClockVLAN=transparentClockVLAN, rawReceivePower=rawReceivePower, phyControlGroup=phyControlGroup, auxPortQLTx=auxPortQLTx, qOSPriorityScheme=qOSPriorityScheme, auxPortConfigurationMismatch=auxPortConfigurationMismatch, unitOutOfCalibration=unitOutOfCalibration, syslogControl=syslogControl, sFPPortQLTx=sFPPortQLTx, installArmState=installArmState, tdmTableNumber=tdmTableNumber, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagPair1Results=cableDiagPair1Results, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagPair4Distance=cableDiagPair4Distance, cableDiagPair2Results=cableDiagPair2Results, portAllocationMismatch=portAllocationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, auxPortStatus=auxPortStatus, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseIEEE1588Support=licenseIEEE1588Support, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, mABTransmissionInterval=mABTransmissionInterval, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tDMInterfaceControl=tDMInterfaceControl, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, l2CPPriorityTable=l2CPPriorityTable, mainPSUPortStatusTrap=mainPSUPortStatusTrap, transparentClock=transparentClock, sMTPServerPortNumber=sMTPServerPortNumber, useVLANForMABProtocol=useVLANForMABProtocol, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, dataPortPauseFrames=dataPortPauseFrames, nIDULanPortAutoMdix=nIDULanPortAutoMdix, installStatusTrap=installStatusTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPServerTableIndex=sNTPServerTableIndex, installStatus=installStatus, routerProtocols=routerProtocols, sntpGroup=sntpGroup, daylightSaving=daylightSaving, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transparentClockVID=transparentClockVID, dfsGroup=dfsGroup, ptp=ptp, PYSNMP_MODULE_ID=cambium, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sFPPortQLRx=sFPPortQLRx, snmpControl=snmpControl, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transmitFreqMHz=transmitFreqMHz, syncETracking=syncETracking, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, regulatoryBand=regulatoryBand, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, transparentClockPort=transparentClockPort, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, auxPortQLRx=auxPortQLRx, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementVID=vLANManagementVID, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseIPv6Support=licenseIPv6Support, l2CPPriorityTableEntry=l2CPPriorityTableEntry)
