...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", reset=reset, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, sFPPortStatus=sFPPortStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableDiagPair2Distance=cableDiagPair2Distance, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMInterfaceControl=tDMInterfaceControl, channelBandwidth=channelBandwidth, mainPSUPortStatus=mainPSUPortStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, dfsTable=dfsTable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, cableDiagnosticsResultTable=cableDiagnosticsResultTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableIndex=sNTPServerTableIndex, secondDataBridgingStatus=secondDataBridgingStatus, licenseGroupAccess=licenseGroupAccess, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, alarmsGroup=alarmsGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, userTable=userTable, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, licenseEncryption=licenseEncryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, lowestTDMModulationMode=lowestTDMModulationMode, accessMethod=accessMethod, auxPortSSMTx=auxPortSSMTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, rxColorCode=rxColorCode, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortQLTx=sFPPortQLTx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tdmTableIndex=tdmTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, syslogState=syslogState, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, hTTPAccessEnabled=hTTPAccessEnabled, configuration=configuration, subbandLowestFrequency=subbandLowestFrequency, ethernet=ethernet, byteErrorRatio=byteErrorRatio, cableDiagPair4Results=cableDiagPair4Results, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, phyStatus=phyStatus, sNTPServerTimeout=sNTPServerTimeout, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, auxPortAllocation=auxPortAllocation, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, sFPErrorTrap=sFPErrorTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetGroup=ethernetGroup, extendedSpectrumScanning=extendedSpectrumScanning, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpTraps=ptpTraps, mABHoldoffPeriod=mABHoldoffPeriod, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userTableEntry=userTableEntry, txMABFrames=txMABFrames, sNTPState=sNTPState, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPSync=sNTPSync, antennaGain=antennaGain, cableDiagnosticsWarning=cableDiagnosticsWarning, sFPPortSSMTx=sFPPortSSMTx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ptpCompliance=ptpCompliance, targetRange=targetRange, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, iPv4Address=iPv4Address, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPError=sFPError, remoteInternetAddressType=remoteInternetAddressType, mainPSUPortQLRx=mainPSUPortQLRx, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, linkSymmetry=linkSymmetry, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitModulationMode=transmitModulationMode, installArmState=installArmState, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABProtocolVID=mABProtocolVID, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, tDMEnabledChannels=tDMEnabledChannels, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, bridgeGroup=bridgeGroup, searchState=searchState, sNTPPollInterval=sNTPPollInterval, subbandHighestFrequency=subbandHighestFrequency, phyControlGroup=phyControlGroup, sFPPortStatusTrap=sFPPortStatusTrap, nIDULanPortStatus=nIDULanPortStatus, capacityVariantMismatch=capacityVariantMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tDMInterfaceStatus=tDMInterfaceStatus, sFPPortQLRx=sFPPortQLRx, syslogStateTrap=syslogStateTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, userName=userName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveChannel=receiveChannel, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegulatoryBands=incompatibleRegulatoryBands, pubStats=pubStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, txColorCode=txColorCode, transmitPower=transmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnostics=cableDiagnostics, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, secureModeAlarm=secureModeAlarm, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ptpGroups=ptpGroups, installStatus=installStatus, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair1Results=cableDiagPair1Results, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataBridgingStatus=dataBridgingStatus, sMTPEmailAlert=sMTPEmailAlert, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimizationMismatch=linkModeOptimizationMismatch, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClientTrap=syslogClientTrap, sntpGroup=sntpGroup, licenseVersion=licenseVersion, maximumTransmitPower=maximumTransmitPower, lowestSecondDataModulationMode=lowestSecondDataModulationMode, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, dfsTableEntry=dfsTableEntry, phyControl=phyControl, transparentClock=transparentClock, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, gatewayIPAddress=gatewayIPAddress, lowestDataModulationMode=lowestDataModulationMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerRetries=sNTPServerRetries, syncETrackingState=syncETrackingState, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, mABMaintenanceLevel=mABMaintenanceLevel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNTPSyncTrap=sNTPSyncTrap, licenseBandwidthCap=licenseBandwidthCap, ptpTrapPrefix=ptpTrapPrefix, channelChangeTrap=channelChangeTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, syslogClient=syslogClient, mainPSUPortQLTx=mainPSUPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, sNMPCommunityString=sNMPCommunityString, dataBridgingStatusAlarm=dataBridgingStatusAlarm, cableDiagPair3Results=cableDiagPair3Results, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, altitude=altitude, siteName=siteName, userPassword=userPassword, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, enableTransmission=enableTransmission, auxPortQLTx=auxPortQLTx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv6Address=iPv6Address, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, tDMChannelLoopback=tDMChannelLoopback, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tdmTableEntry=tdmTableEntry, userEnabled=userEnabled, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, l2CPPriorityTable=l2CPPriorityTable, dfsTableIndex=dfsTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, linkLoss=linkLoss, sNTPServerStatus=sNTPServerStatus, transparentClockVID=transparentClockVID, licenseIPv6Support=licenseIPv6Support, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userTableNumber=userTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mainPSUPortAutoMdix=mainPSUPortAutoMdix, sntp=sntp, mainPSUPortAllocation=mainPSUPortAllocation, signalStrengthRatio=signalStrengthRatio, tdmTableNumber=tdmTableNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sFPPortAllocation=sFPPortAllocation, useVLANForMABProtocol=useVLANForMABProtocol, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, smtpGroup=smtpGroup, mABState=mABState, licenseRARSupport=licenseRARSupport, ptp650=ptp650, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, smtp=smtp, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseIssueNumber=licenseIssueNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, productVariant=productVariant, regulatoryBandTrap=regulatoryBandTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, receiveDataRate=receiveDataRate, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receivePower=receivePower, snmpControl=snmpControl, tDDControl=tDDControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMChannelCableLength=tDMChannelCableLength, auxPortStatus=auxPortStatus, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseTrialPeriod=licenseTrialPeriod, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, eIRP=eIRP, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseSyncESupport=licenseSyncESupport, cableDiagPair2Results=cableDiagPair2Results, supplementary=supplementary, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, ptmp=ptmp, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABTransmissionInterval=mABTransmissionInterval, bridge=bridge, cambium=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, sMTPServerInternetAddress=sMTPServerInternetAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, hTTPSPortNumber=hTTPSPortNumber, regulatoryBand=regulatoryBand, portAllocationMismatch=portAllocationMismatch, systemReset=systemReset, bootVersion=bootVersion, managementGroup=managementGroup, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, tdmTable=tdmTable, license=license, licenseCountry=licenseCountry, dfsTableNumber=dfsTableNumber, range=range, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, transmitChannel=transmitChannel, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMChannelStatus=tDMChannelStatus, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rawReceivePower=rawReceivePower, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, frequencyVariant=frequencyVariant, licenseMaxLinkRange=licenseMaxLinkRange, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, routerProtocols=routerProtocols, sMTPServerPortNumber=sMTPServerPortNumber, aAAControl=aAAControl, sNTPServerTableEntry=sNTPServerTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, userRole=userRole, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dataBridgingAvailability=dataBridgingAvailability, groupID=groupID, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNMPTrapInternetAddress=sNMPTrapInternetAddress, cableLoss=cableLoss, localPacketFiltering=localPacketFiltering, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, installStatusTrap=installStatusTrap, licenseGroup=licenseGroup, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, remoteInternetAddress=remoteInternetAddress, syncETracking=syncETracking, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, syslogControlGroup=syslogControlGroup, routerProtocolsGroup=routerProtocolsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptp=ptp, rangingMode=rangingMode, tDM=tDM, versions=versions, resetGroup=resetGroup, versionsGroup=versionsGroup, auxPortQLRx=auxPortQLRx, transmitFreqMHz=transmitFreqMHz, targetMACAddress=targetMACAddress, dfsMeans=dfsMeans, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, alarms=alarms, PYSNMP_MODULE_ID=cambium, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABNominalModulationMode=mABNominalModulationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, phyStatusGroup=phyStatusGroup, receiveModulationMode=receiveModulationMode, auxPortStatusTrap=auxPortStatusTrap, hTTPPortNumber=hTTPPortNumber, linkModeOptimization=linkModeOptimization, tFTPServerPortNumber=tFTPServerPortNumber, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitFreqKHz=transmitFreqKHz, licenseCapacity=licenseCapacity, sNTPServerPortNumber=sNTPServerPortNumber, syncEEquipmentClock=syncEEquipmentClock, transparentClockVLAN=transparentClockVLAN, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, dfsGroup=dfsGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transparentClockPort=transparentClockPort, userTableIndex=userTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, iPv6GatewayAddress=iPv6GatewayAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPTrapTable=sNMPTrapTable, management=management, pubStatsGroup=pubStatsGroup, tDMGroup=tDMGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagPair1Distance=cableDiagPair1Distance, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration)
