...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortConfigurationMismatch=auxPortConfigurationMismatch, lowestSecondDataModulationMode=lowestSecondDataModulationMode, subnetMask=subnetMask, mainPSUPortStatus=mainPSUPortStatus, receiveDataRate=receiveDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortAllocation=mainPSUPortAllocation, sMTPEmailAlert=sMTPEmailAlert, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, smtp=smtp, receiveFreqKHz=receiveFreqKHz, regulatoryBandTrap=regulatoryBandTrap, sNMPv3Enable=sNMPv3Enable, auxPortSyncERxStatus=auxPortSyncERxStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortAllocation=auxPortAllocation, tDDControl=tDDControl, ethernetPriorityTableEntry=ethernetPriorityTableEntry, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userTableIndex=userTableIndex, dataBridgingStatusAlarm=dataBridgingStatusAlarm, versions=versions, licenseGroupAccess=licenseGroupAccess, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, productVariant=productVariant, phyControl=phyControl, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, mABHoldoffPeriod=mABHoldoffPeriod, regulatoryBand=regulatoryBand, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, snmpControlGroup=snmpControlGroup, linkName=linkName, tDM=tDM, tDMInterfaceStatus=tDMInterfaceStatus, bridge=bridge, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNTPSync=sNTPSync, sMTPServerInternetAddress=sMTPServerInternetAddress, licenseIEEE1588Support=licenseIEEE1588Support, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, latitude=latitude, rxColorCode=rxColorCode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, lowestDataModulationMode=lowestDataModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerTimeout=sNTPServerTimeout, dfsTableIndex=dfsTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, iPv6PrefixLength=iPv6PrefixLength, altitude=altitude, iPv6GatewayAddress=iPv6GatewayAddress, mABNominalModulationMode=mABNominalModulationMode, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp650=ptp650, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, mABProtocolVID=mABProtocolVID, encryptionAlgorithm=encryptionAlgorithm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfsTable=dfsTable, licenseOOBManagementSupport=licenseOOBManagementSupport, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, targetMACAddress=targetMACAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, installArmState=installArmState, localPacketFiltering=localPacketFiltering, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, remoteInternetAddress=remoteInternetAddress, siteName=siteName, tDDSynchronizationStatus=tDDSynchronizationStatus, sFPPortQLTx=sFPPortQLTx, receiveModulationModeDetail=receiveModulationModeDetail, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, cableDiagnosticsResultTable=cableDiagnosticsResultTable, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, routerProtocolsGroup=routerProtocolsGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, tDMChannelLoopback=tDMChannelLoopback, installStatus=installStatus, dataPortPauseFrames=dataPortPauseFrames, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseCountry=licenseCountry, auxPortStatus=auxPortStatus, transmitDataRate=transmitDataRate, sNMPTrapVersion=sNMPTrapVersion, syslogStateTrap=syslogStateTrap, ethernetPriorityTable=ethernetPriorityTable, sFPPortQLRx=sFPPortQLRx, remoteInternetAddressType=remoteInternetAddressType, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagPair4Results=cableDiagPair4Results, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, l2CPPriorityTableNumber=l2CPPriorityTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, iPv4Address=iPv4Address, transmitPower=transmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntpGroup=sntpGroup, systemClock=systemClock, licenseVersion=licenseVersion, txColorCode=txColorCode, dataBridgingStatus=dataBridgingStatus, cableLoss=cableLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, nIDULanPortStatus=nIDULanPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, iPv6Address=iPv6Address, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, receiveChannel=receiveChannel, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, syslogControlGroup=syslogControlGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, telnetPortNumber=telnetPortNumber, sntp=sntp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair2Distance=cableDiagPair2Distance, syslogClient=syslogClient, userEnabled=userEnabled, cableDiagnosticsPorts=cableDiagnosticsPorts, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, reset=reset, sFPError=sFPError, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, qOSPriorityScheme=qOSPriorityScheme, licenseIPv6Support=licenseIPv6Support, cableDiagPair1Distance=cableDiagPair1Distance, aAAControl=aAAControl, tdmTableEntry=tdmTableEntry, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPPortAllocation=sFPPortAllocation, receiveModulationMode=receiveModulationMode, subbandLowestFrequency=subbandLowestFrequency, transmitFreqKHz=transmitFreqKHz, licenseGroup=licenseGroup, hardwareVersion=hardwareVersion, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, secondDataBridgingStatus=secondDataBridgingStatus, mainPSUPortQLRx=mainPSUPortQLRx, tDMConfigurationMismatch=tDMConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseTDDSyncSupport=licenseTDDSyncSupport, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, sNTPServerInternetAddress=sNTPServerInternetAddress, tDMChannelLineCode=tDMChannelLineCode, cableDiagPair4Distance=cableDiagPair4Distance, sNTPServerTableNumber=sNTPServerTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseEncryption=licenseEncryption, mainPSUPortSSMTx=mainPSUPortSSMTx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, byteErrorRatio=byteErrorRatio, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, linkLoss=linkLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, userTableNumber=userTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, accessMethod=accessMethod, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, masterSlaveMode=masterSlaveMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mABState=mABState, pubStatsGroup=pubStatsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, tFTPServerInternetAddress=tFTPServerInternetAddress, useVLANForMABProtocol=useVLANForMABProtocol, sNTPServerTableEntry=sNTPServerTableEntry, userRole=userRole, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarmsGroup=alarmsGroup, sFPPortStatus=sFPPortStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair1Results=cableDiagPair1Results, sNMPTrapPortNumber=sNMPTrapPortNumber, transparentClockVID=transparentClockVID, licenseBandwidthCap=licenseBandwidthCap, userName=userName, lowestTDMModulationMode=lowestTDMModulationMode, installStatusTrap=installStatusTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tDMChannelStatus=tDMChannelStatus, ptpTraps=ptpTraps, longitude=longitude, tdmTable=tdmTable, cableDiagPair3Distance=cableDiagPair3Distance, frequencyVariant=frequencyVariant, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, aAAControlGroup=aAAControlGroup, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sNMPTrapTable=sNMPTrapTable, licenseIssueNumber=licenseIssueNumber, maximumTransmitPower=maximumTransmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortDisabledWarning=auxPortDisabledWarning, cambium=cambium, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMGroup=tDMGroup, phyControlGroup=phyControlGroup, iPVersion=iPVersion, tdmTableIndex=tdmTableIndex)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, rangingMode=rangingMode, linkModeOptimization=linkModeOptimization, l2CPPriorityTable=l2CPPriorityTable, timeZone=timeZone, dfsPeaks=dfsPeaks, resetGroup=resetGroup, ethernetGroup=ethernetGroup, tDDSynchronizationMode=tDDSynchronizationMode, gatewayIPAddress=gatewayIPAddress, cableDiagnostics=cableDiagnostics, sNMPTrapInternetAddress=sNMPTrapInternetAddress, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, systemReset=systemReset, eIRP=eIRP, syslogState=syslogState, pubStats=pubStats, transmitChannel=transmitChannel, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogControl=syslogControl, encryptionGroup=encryptionGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, userTable=userTable, mABMaintenanceLevel=mABMaintenanceLevel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ethernet=ethernet, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, management=management, auxPortQLRx=auxPortQLRx, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClientTrap=syslogClientTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, linkSymmetry=linkSymmetry, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDMChannelStatusTrap=tDMChannelStatusTrap, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, txMABFrames=txMABFrames, sNMPTrapTableIndex=sNMPTrapTableIndex, transparentClockPort=transparentClockPort, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsMeans=dfsMeans, transparentClockVLAN=transparentClockVLAN, syncETrackingState=syncETrackingState, cableDiagPair3Results=cableDiagPair3Results, license=license, enableTransmission=enableTransmission, searchState=searchState, transmitModulationMode=transmitModulationMode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, antennaGain=antennaGain, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyStatus=phyStatus, userTableEntry=userTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseCapacity=licenseCapacity, hTTPPortNumber=hTTPPortNumber, sFPPortSSMTx=sFPPortSSMTx, ptpGroups=ptpGroups, mABNominalTransmitCapacity=mABNominalTransmitCapacity, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerStatus=sNTPServerStatus, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tdmTableNumber=tdmTableNumber, sNTPLastSync=sNTPLastSync, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, productName=productName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, sNTPState=sNTPState, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syncEEquipmentClock=syncEEquipmentClock, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, daylightSaving=daylightSaving, tDMInterfaceControl=tDMInterfaceControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, subbandHighestFrequency=subbandHighestFrequency, dataBridgingAvailability=dataBridgingAvailability, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortAutoNegotiation=sFPPortAutoNegotiation, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseTrialPeriod=licenseTrialPeriod, ptpCompliance=ptpCompliance, sNTPServerRetries=sNTPServerRetries, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syncETracking=syncETracking, configurationGroup=configurationGroup, licenseSyncESupport=licenseSyncESupport, supplementaryGroup=supplementaryGroup, alarms=alarms, range=range, sNTPServerTable=sNTPServerTable, rawReceivePower=rawReceivePower, sNMPEnabledTraps=sNMPEnabledTraps, groupID=groupID, mainPSUPortQLTx=mainPSUPortQLTx, channelChangeTrap=channelChangeTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, PYSNMP_MODULE_ID=cambium, dfsGroup=dfsGroup, versionsGroup=versionsGroup, auxPortQLTx=auxPortQLTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, telnetAccessEnabled=telnetAccessEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPErrorTrap=sFPErrorTrap, capacityVariantMismatch=capacityVariantMismatch, cableDiagPair2Results=cableDiagPair2Results, tDMEnabledChannels=tDMEnabledChannels, dfsTableEntry=dfsTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, supplementary=supplementary, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, userPassword=userPassword, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, routerProtocols=routerProtocols, softwareVersion=softwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dSCPManagementPriority=dSCPManagementPriority, secureModeAlarmTrap=secureModeAlarmTrap, configuration=configuration, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, channelBandwidth=channelBandwidth, managementPortWirelessDownAlert=managementPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseRARSupport=licenseRARSupport, cableDiagnosticsControl=cableDiagnosticsControl, secureModeAlarm=secureModeAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transparentClock=transparentClock, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, auxPortStatusTrap=auxPortStatusTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, cableDiagnosticsGroup=cableDiagnosticsGroup, installArmStateTrap=installArmStateTrap, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mABTransmissionInterval=mABTransmissionInterval, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortAutoMdix=nIDULanPortAutoMdix, auxPortSSMTx=auxPortSSMTx, targetRange=targetRange, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortStatusTrap=sFPPortStatusTrap)
