...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syslogState=syslogState, rawReceivePower=rawReceivePower, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagPair4Distance=cableDiagPair4Distance, alarms=alarms, syslogClientTrap=syslogClientTrap, tdmTableNumber=tdmTableNumber, versions=versions, dfsMeans=dfsMeans, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortAllocation=mainPSUPortAllocation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseSFPPortSupport=licenseSFPPortSupport, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, cableDiagPair1Results=cableDiagPair1Results, sNTPServerTableIndex=sNTPServerTableIndex, licenseGroup=licenseGroup, sNTPPollInterval=sNTPPollInterval, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, subbandLowestFrequency=subbandLowestFrequency, dfsTableEntry=dfsTableEntry, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPServerRetries=sNTPServerRetries, userTable=userTable, routerProtocols=routerProtocols, phyControlGroup=phyControlGroup, iPv6Address=iPv6Address, syslogStateTrap=syslogStateTrap, sNTPServerStatus=sNTPServerStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp=ptp, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortStatus=auxPortStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, iPVersion=iPVersion, linkName=linkName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tDMChannelLineCode=tDMChannelLineCode, cableDiagnosticsControl=cableDiagnosticsControl, txMABFrames=txMABFrames, sFPPortAutoNegotiation=sFPPortAutoNegotiation, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, phyStatusGroup=phyStatusGroup, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableNumber=userTableNumber, userEnabled=userEnabled, receiveModulationMode=receiveModulationMode, licenseSyncESupport=licenseSyncESupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, snmpControlGroup=snmpControlGroup, sNTPLastSync=sNTPLastSync, tDDControl=tDDControl, remoteInternetAddress=remoteInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitDataRate=transmitDataRate, licenseRegulatoryBandsList=licenseRegulatoryBandsList, smtpGroup=smtpGroup, ptmp=ptmp, cableDiagPair3Distance=cableDiagPair3Distance, alarmsGroup=alarmsGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, hTTPPortNumber=hTTPPortNumber, remoteInternetAddressType=remoteInternetAddressType, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, sFPPortStatus=sFPPortStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, ptpTraps=ptpTraps, dfs=dfs, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv4Address=iPv4Address, telnetPortNumber=telnetPortNumber, bootVersion=bootVersion, rangingMode=rangingMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, versionsGroup=versionsGroup, transparentClockVLAN=transparentClockVLAN, auxPortStatusTrap=auxPortStatusTrap, dfsTableIndex=dfsTableIndex, smtp=smtp, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, rxColorCode=rxColorCode, auxPortSSMTx=auxPortSSMTx, dataBridgingStatus=dataBridgingStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sFPPortStatusTrap=sFPPortStatusTrap, tDMChannelLoopback=tDMChannelLoopback, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqMHz=transmitFreqMHz, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, capacityVariantMismatch=capacityVariantMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licenseVersion=licenseVersion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, longitude=longitude, tDMEnabledChannels=tDMEnabledChannels, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPPrimaryServer=sNTPPrimaryServer, mABNominalModulationMode=mABNominalModulationMode, tDMChannelCableLength=tDMChannelCableLength, hTTPAccessEnabled=hTTPAccessEnabled, dfsTable=dfsTable, userPassword=userPassword, cambium=cambium, maxLinkRangeExceeded=maxLinkRangeExceeded, receiveFreqKHz=receiveFreqKHz, auxPortDisabledWarning=auxPortDisabledWarning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagPair1Distance=cableDiagPair1Distance, mABProtocolVLANPriority=mABProtocolVLANPriority, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTableEntry=ethernetPriorityTableEntry, linkSymmetry=linkSymmetry, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sFPPortAllocation=sFPPortAllocation, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, searchState=searchState, portAllocationMismatch=portAllocationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, secureModeAlarm=secureModeAlarm, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp650=ptp650, sNTPServerTableNumber=sNTPServerTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mPLSTCPriorityTable=mPLSTCPriorityTable, channelChangeTrap=channelChangeTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dfsPeaks=dfsPeaks, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, groupID=groupID, sFPPortDisabledWarning=sFPPortDisabledWarning, oOBPriorityQueueMapping=oOBPriorityQueueMapping, syncETracking=syncETracking, txColorCode=txColorCode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, eIRP=eIRP, licenseTDDSyncSupport=licenseTDDSyncSupport, syslogClient=syslogClient, licenseCountry=licenseCountry, wirelessLinkAvailability=wirelessLinkAvailability, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, auxPortQLRx=auxPortQLRx, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPErrorTrap=sFPErrorTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPPortNumber=sNMPPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mABState=mABState, routerProtocolsGroup=routerProtocolsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, daylightSaving=daylightSaving, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseBandwidthCap=licenseBandwidthCap, sNTPServerTable=sNTPServerTable, bridge=bridge, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, nIDULanPortStatus=nIDULanPortStatus, licenseGroupAccess=licenseGroupAccess, auxPortSyncERxStatus=auxPortSyncERxStatus, reset=reset, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, cableDiagPair4Results=cableDiagPair4Results, antennaGain=antennaGain, capacityVariantMismatchTrap=capacityVariantMismatchTrap, accessMethod=accessMethod, iPv6GatewayAddress=iPv6GatewayAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationMode=tDDSynchronizationMode, supplementary=supplementary, tDMInterfaceControl=tDMInterfaceControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vectorError=vectorError, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimization=linkModeOptimization, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, vLANManagementVID=vLANManagementVID, mainPSUPortQLRx=mainPSUPortQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sFPPortQLRx=sFPPortQLRx, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, sFPPortSyncERxStatus=sFPPortSyncERxStatus, license=license, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogControl=syslogControl, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, transmitFreqKHz=transmitFreqKHz, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, regulatoryBandTrap=regulatoryBandTrap, subnetMask=subnetMask)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", secondDataPortPauseFrames=secondDataPortPauseFrames, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair2Results=cableDiagPair2Results, transparentClockVID=transparentClockVID, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mABNominalTransmitCapacity=mABNominalTransmitCapacity, regulatoryBand=regulatoryBand, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClock=transparentClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPv3Enable=sNMPv3Enable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, cableDiagnosticsWarning=cableDiagnosticsWarning, cableDiagnostics=cableDiagnostics, ptpCompliance=ptpCompliance, licenseEncryption=licenseEncryption, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userName=userName, enableTransmission=enableTransmission, cableDiagPair2Distance=cableDiagPair2Distance, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tdmTable=tdmTable, cableLoss=cableLoss, encryptionGroup=encryptionGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveFreqMHz=receiveFreqMHz, productVariant=productVariant, snmpControl=snmpControl, latitude=latitude, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPState=sNTPState, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveModulationModeDetail=receiveModulationModeDetail, useVLANForMABProtocol=useVLANForMABProtocol, lowestDataModulationMode=lowestDataModulationMode, targetRange=targetRange, auxPortAllocation=auxPortAllocation, dSCPManagementPriority=dSCPManagementPriority, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, receiveDataRate=receiveDataRate, resetGroup=resetGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, lowestSecondDataModulationMode=lowestSecondDataModulationMode, mABTransmissionInterval=mABTransmissionInterval, licenseTrialPeriod=licenseTrialPeriod, receiveChannel=receiveChannel, ethernetGroup=ethernetGroup, mainPSUPortStatus=mainPSUPortStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syncEEquipmentClock=syncEEquipmentClock, hTTPSPortNumber=hTTPSPortNumber, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, siteName=siteName, lowestTDMModulationMode=lowestTDMModulationMode, licenseMaxLinkRange=licenseMaxLinkRange, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, cableDiagPair3Results=cableDiagPair3Results, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mainPSUPortAutoMdix=mainPSUPortAutoMdix, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mainPSUPortQLTx=mainPSUPortQLTx, licenseCapacity=licenseCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortAutoMdix=sFPPortAutoMdix, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDMChannelStatus=tDMChannelStatus, dataPortPauseFrames=dataPortPauseFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, supplementaryGroup=supplementaryGroup, sntpGroup=sntpGroup, tdmTableEntry=tdmTableEntry, gatewayIPAddress=gatewayIPAddress, altitude=altitude, tDMGroup=tDMGroup, productName=productName, licenseIssueNumber=licenseIssueNumber, tdmTableIndex=tdmTableIndex, softwareVersion=softwareVersion, sNTPSync=sNTPSync, configuration=configuration, management=management, extendedSpectrumScanning=extendedSpectrumScanning, dataBridgingAvailability=dataBridgingAvailability, transparentClockPort=transparentClockPort, ethernetPriorityTable=ethernetPriorityTable, licenseUnitSerialNumber=licenseUnitSerialNumber, tDM=tDM, ptpGroups=ptpGroups, transmitPower=transmitPower, pubStats=pubStats, tDDControlGroup=tDDControlGroup, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, masterSlaveMode=masterSlaveMode, sMTPEnabledMessages=sMTPEnabledMessages, mABMaintenanceLevel=mABMaintenanceLevel, managementGroup=managementGroup, secureModeAlarmTrap=secureModeAlarmTrap, licenseRARSupport=licenseRARSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sFPError=sFPError, sMTPServerInternetAddressType=sMTPServerInternetAddressType, receivePower=receivePower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, syncETrackingState=syncETrackingState, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibration=unitOutOfCalibration, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mABProtocolVID=mABProtocolVID, sFPPortQLTx=sFPPortQLTx, licenseSecurityLevel=licenseSecurityLevel, installArmStateTrap=installArmStateTrap, sntp=sntp, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, frequencyVariant=frequencyVariant, l2CPPriorityTable=l2CPPriorityTable, transmitModulationMode=transmitModulationMode, secondDataBridgingStatus=secondDataBridgingStatus, subbandHighestFrequency=subbandHighestFrequency, range=range, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, syslogControlGroup=syslogControlGroup, cableDiagnosticsPorts=cableDiagnosticsPorts, configurationGroup=configurationGroup, sFPPortSSMTx=sFPPortSSMTx, channelBandwidth=channelBandwidth, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aAAControlGroup=aAAControlGroup, linkLoss=linkLoss, userTableEntry=userTableEntry, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortStatusTrap=mainPSUPortStatusTrap, auxPortQLTx=auxPortQLTx, bridgeGroup=bridgeGroup, phyControl=phyControl, licenseIPv6Support=licenseIPv6Support, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus)
