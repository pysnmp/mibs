...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortAutoMdix=sFPPortAutoMdix, groupID=groupID, tDMChannelLineCode=tDMChannelLineCode, regulatoryBandTrap=regulatoryBandTrap, range=range, siteName=siteName, sFPPortAutoNegotiation=sFPPortAutoNegotiation, targetRange=targetRange, mABMaintenanceLevel=mABMaintenanceLevel, transmitFreqKHz=transmitFreqKHz, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mABTransmissionInterval=mABTransmissionInterval, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sFPPortStatus=sFPPortStatus, license=license, sntpGroup=sntpGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, snmpControlGroup=snmpControlGroup, auxPortAllocation=auxPortAllocation, licenseUnitSerialNumber=licenseUnitSerialNumber, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, licenseRARSupport=licenseRARSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, capacityVariantMismatchTrap=capacityVariantMismatchTrap, regulatoryBand=regulatoryBand, alarms=alarms, lowestTDMModulationMode=lowestTDMModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ptmp=ptmp, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfsTableIndex=dfsTableIndex, sFPError=sFPError, useVLANForMABProtocol=useVLANForMABProtocol, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, iPv4Address=iPv4Address, softwareVersion=softwareVersion, ptpGroups=ptpGroups, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syncEEquipmentClock=syncEEquipmentClock, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerStatus=sNTPServerStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, licenseCapacity=licenseCapacity, sNMPPortNumber=sNMPPortNumber, antennaGain=antennaGain, tDMGroup=tDMGroup, hTTPAccessEnabled=hTTPAccessEnabled, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dataBridgingStatus=dataBridgingStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, accessMethod=accessMethod, iPv6GatewayAddress=iPv6GatewayAddress, auxPortQLRx=auxPortQLRx, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimization=linkModeOptimization, secondDataPortPauseFrames=secondDataPortPauseFrames, tdmTableIndex=tdmTableIndex, userTableEntry=userTableEntry, oOBPriorityQueueMapping=oOBPriorityQueueMapping, iPDSCPPriorityTable=iPDSCPPriorityTable, localPacketFiltering=localPacketFiltering, syncETrackingState=syncETrackingState, mainPSUPortStatusTrap=mainPSUPortStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerTableNumber=sNTPServerTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, configuration=configuration, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, ethernet=ethernet, enableTransmission=enableTransmission, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ptp=ptp, sFPPortStatusTrap=sFPPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, ethernetGroup=ethernetGroup, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, remoteInternetAddressType=remoteInternetAddressType, tdmTableEntry=tdmTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sNTPServerTimeout=sNTPServerTimeout, licenseSFPPortSupport=licenseSFPPortSupport, iPv6Address=iPv6Address, masterSlaveMode=masterSlaveMode, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, tDMInterfaceControl=tDMInterfaceControl, tDDSynchronizationMode=tDDSynchronizationMode, tDMChannelLoopback=tDMChannelLoopback, installStatus=installStatus, mainPSUPortQLRx=mainPSUPortQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, smtp=smtp, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, phyStatus=phyStatus, dataBridgingAvailability=dataBridgingAvailability, maximumTransmitPower=maximumTransmitPower, tDDControl=tDDControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseGroup=licenseGroup, tdmTableNumber=tdmTableNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControl=phyControl, encryption=encryption, dfs=dfs, tDMInterfaceStatus=tDMInterfaceStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, phyStatusGroup=phyStatusGroup, sNTPLastSync=sNTPLastSync, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNTPServerRetries=sNTPServerRetries, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, routerProtocolsGroup=routerProtocolsGroup, hTTPSPortNumber=hTTPSPortNumber, sFPPortQLTx=sFPPortQLTx, channelBandwidth=channelBandwidth, userRole=userRole, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkLoss=linkLoss, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, cableDiagPair4Results=cableDiagPair4Results, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, cableLoss=cableLoss, sNTPServerTable=sNTPServerTable, auxPortStatusTrap=auxPortStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, cableDiagPair1Results=cableDiagPair1Results, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, licenseIssueNumber=licenseIssueNumber, licenseEncryption=licenseEncryption, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, cableDiagnosticsControl=cableDiagnosticsControl, installArmState=installArmState, cableDiagPair4Distance=cableDiagPair4Distance, subnetMask=subnetMask, dfsPeaks=dfsPeaks, timeZone=timeZone, pubStatsGroup=pubStatsGroup, nIDULanPortStatus=nIDULanPortStatus, mABState=mABState, vLANManagementPriority=vLANManagementPriority, cableDiagPair1Distance=cableDiagPair1Distance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dataPortPauseFrames=dataPortPauseFrames, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDMChannelCableLength=tDMChannelCableLength, transparentClockPort=transparentClockPort, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, systemReset=systemReset, productVariant=productVariant, licenseGroupAccess=licenseGroupAccess, sNMPTrapTableEntry=sNMPTrapTableEntry, tDM=tDM, rangingMode=rangingMode, signalStrengthRatio=signalStrengthRatio, sNTPSyncTrap=sNTPSyncTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatchTrap=portAllocationMismatchTrap, receiveDataRate=receiveDataRate, subbandHighestFrequency=subbandHighestFrequency, cableDiagPair2Distance=cableDiagPair2Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, licenseVersion=licenseVersion, longitude=longitude, supplementaryGroup=supplementaryGroup, auxPortQLTx=auxPortQLTx, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, phyControlGroup=phyControlGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, alarmsGroup=alarmsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, encryptionGroup=encryptionGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControlGroup=syslogControlGroup, auxPortStatus=auxPortStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortAllocation=mainPSUPortAllocation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPErrorTrap=sFPErrorTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDMConfigurationMismatch=tDMConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDMChannelStatus=tDMChannelStatus, cableDiagPair3Distance=cableDiagPair3Distance, daylightSaving=daylightSaving, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, dfsTable=dfsTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, aAAControl=aAAControl, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, bridge=bridge, syslogState=syslogState, userPassword=userPassword, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPSync=sNTPSync, vLANManagementVID=vLANManagementVID, sFPPortDisabledWarning=sFPPortDisabledWarning, mABNominalTransmitCapacity=mABNominalTransmitCapacity, secondDataBridgingStatus=secondDataBridgingStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortSSMTx=sFPPortSSMTx, licenseSecurityLevel=licenseSecurityLevel, userTableIndex=userTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, bridgeGroup=bridgeGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortStatus=mainPSUPortStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, auxPortConfigurationMismatch=auxPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, hTTPPortNumber=hTTPPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, snmpControl=snmpControl, maxLinkRangeExceeded=maxLinkRangeExceeded, userEnabled=userEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair2Results=cableDiagPair2Results, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, rxColorCode=rxColorCode, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortSSMTx=auxPortSSMTx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, rawReceivePower=rawReceivePower, pubStats=pubStats, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsPorts=cableDiagnosticsPorts, subbandLowestFrequency=subbandLowestFrequency, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerInternetAddress=tFTPServerInternetAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, lowestSecondDataModulationMode=lowestSecondDataModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, transmitDataRate=transmitDataRate, syslogClient=syslogClient, txColorCode=txColorCode, gatewayIPAddress=gatewayIPAddress, dSCPManagementPriority=dSCPManagementPriority, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfsTableEntry=dfsTableEntry, iPVersion=iPVersion, dfsGroup=dfsGroup, receiveModulationMode=receiveModulationMode, sntp=sntp, syncETracking=syncETracking, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, transmitChannel=transmitChannel, txMABFrames=txMABFrames, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapVersion=sNMPTrapVersion, portAllocationMismatch=portAllocationMismatch, tDDControlGroup=tDDControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower, cambium=cambium, versionsGroup=versionsGroup, resetGroup=resetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortQLTx=mainPSUPortQLTx, sNTPServerPortNumber=sNTPServerPortNumber, l2CPPriorityTable=l2CPPriorityTable, altitude=altitude, auxPortAcceptedQLRx=auxPortAcceptedQLRx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tdmTable=tdmTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABProtocolVID=mABProtocolVID, licenseBandwidthCap=licenseBandwidthCap, sNTPServerTableEntry=sNTPServerTableEntry, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTable=cableDiagnosticsResultTable, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, management=management, tFTPServerPortNumber=tFTPServerPortNumber, productName=productName, ptp650=ptp650, bootVersion=bootVersion, sFPPortAllocation=sFPPortAllocation, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transmitFreqMHz=transmitFreqMHz, extendedSpectrumScanning=extendedSpectrumScanning, transparentClockVID=transparentClockVID, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, userTable=userTable, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, dataBridgingStatusAlarm=dataBridgingStatusAlarm, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteInternetAddress=remoteInternetAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, userName=userName, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagnostics=cableDiagnostics, targetMACAddress=targetMACAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, qOSPriorityScheme=qOSPriorityScheme, licenseSyncESupport=licenseSyncESupport, licenseMaxLinkRange=licenseMaxLinkRange, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, syslogControl=syslogControl, supplementary=supplementary, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseCountry=licenseCountry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, routerProtocols=routerProtocols, transparentClock=transparentClock, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, transparentClockVLAN=transparentClockVLAN, managementGroup=managementGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseTrialPeriod=licenseTrialPeriod, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortDisabledWarning=auxPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, dfsMeans=dfsMeans, lowestDataModulationMode=lowestDataModulationMode, mABNominalModulationMode=mABNominalModulationMode, mABHoldoffPeriod=mABHoldoffPeriod, installStatusTrap=installStatusTrap, cableDiagPair3Results=cableDiagPair3Results, tDMEnabledChannels=tDMEnabledChannels, latitude=latitude)
