...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, oOBPriorityQueueMapping=oOBPriorityQueueMapping, vectorError=vectorError, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, bridgeGroup=bridgeGroup, tdmTable=tdmTable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogClient=syslogClient, mainPSUPortStatusTrap=mainPSUPortStatusTrap, dfsMeans=dfsMeans, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsResultTable=cableDiagnosticsResultTable, managementGroup=managementGroup, licenseCountry=licenseCountry, range=range, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, ethernetGroup=ethernetGroup, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, supplementaryGroup=supplementaryGroup, receiveDataRate=receiveDataRate, sNTPServerTableNumber=sNTPServerTableNumber, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelCableLength=tDMChannelCableLength, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPSync=sNTPSync, useVLANForMABProtocol=useVLANForMABProtocol, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rawReceivePower=rawReceivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, license=license, licenseMaxLinkRange=licenseMaxLinkRange, txColorCode=txColorCode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, routerProtocolsGroup=routerProtocolsGroup, transmitModulationMode=transmitModulationMode, secureModeAlarmTrap=secureModeAlarmTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseEncryption=licenseEncryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseSyncESupport=licenseSyncESupport, byteErrorRatio=byteErrorRatio, smtp=smtp, localPacketFiltering=localPacketFiltering, auxPortStatus=auxPortStatus, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, syslogControl=syslogControl, snmpControlGroup=snmpControlGroup, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, altitude=altitude, sNMPTrapTable=sNMPTrapTable, syncETrackingState=syncETrackingState, licenseSecurityLevel=licenseSecurityLevel, dfsTableEntry=dfsTableEntry, licenseBandwidthCap=licenseBandwidthCap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, cableDiagPair1Distance=cableDiagPair1Distance, auxPortQLTx=auxPortQLTx, sFPPortStatus=sFPPortStatus, syslogClientTrap=syslogClientTrap, tDDControlGroup=tDDControlGroup, linkLoss=linkLoss, l2CPPriorityTable=l2CPPriorityTable, lowestDataModulationMode=lowestDataModulationMode, eIRP=eIRP, accessMethod=accessMethod, sNTPServerRetries=sNTPServerRetries, sntp=sntp, transparentClockPort=transparentClockPort, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, sFPPortSSMTx=sFPPortSSMTx, siteName=siteName, tDMChannelLineCode=tDMChannelLineCode, cableDiagnostics=cableDiagnostics, mainPSUPortQLTx=mainPSUPortQLTx, transmitDataRate=transmitDataRate, dataPortPauseFrames=dataPortPauseFrames, regulatoryBand=regulatoryBand, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortAutoMdix=sFPPortAutoMdix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, transmitPower=transmitPower, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, nIDULanPortStatus=nIDULanPortStatus, subnetMask=subnetMask, lowestTDMModulationMode=lowestTDMModulationMode, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetRange=targetRange, linkModeOptimization=linkModeOptimization, sNTPServerStatus=sNTPServerStatus, installStatus=installStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, management=management, enableTransmission=enableTransmission, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveModulationMode=receiveModulationMode, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, aAAControl=aAAControl, syncEEquipmentClock=syncEEquipmentClock, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortStatusTrap=auxPortStatusTrap, userEnabled=userEnabled, dfs=dfs, bootVersion=bootVersion, sFPPortQLRx=sFPPortQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, mABProtocolVID=mABProtocolVID, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, iPv6GatewayAddress=iPv6GatewayAddress, licenseGroupAccess=licenseGroupAccess, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sntpGroup=sntpGroup, dfsTableIndex=dfsTableIndex, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, productVariant=productVariant, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, auxPortSyncERxStatus=auxPortSyncERxStatus, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortStatusTrap=sFPPortStatusTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenseRARSupport=licenseRARSupport, timeZone=timeZone, syslogState=syslogState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, licenseIPv6Support=licenseIPv6Support, tDMEnabledChannels=tDMEnabledChannels, subbandHighestFrequency=subbandHighestFrequency, phyStatus=phyStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkName=linkName, userTableEntry=userTableEntry, dfsTable=dfsTable, cableDiagPair3Distance=cableDiagPair3Distance, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, extendedSpectrumScanning=extendedSpectrumScanning, qOSPriorityScheme=qOSPriorityScheme, dfsTableNumber=dfsTableNumber, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, portAllocationMismatch=portAllocationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, transparentClockVID=transparentClockVID, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagPair4Distance=cableDiagPair4Distance, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tFTPServerPortNumber=tFTPServerPortNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortQLRx=auxPortQLRx, linkSymmetry=linkSymmetry, dfsGroup=dfsGroup, ethernet=ethernet, regulatoryBandTrap=regulatoryBandTrap, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, subbandLowestFrequency=subbandLowestFrequency, sNTPServerTableIndex=sNTPServerTableIndex, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortAllocation=sFPPortAllocation, sNMPTrapPortNumber=sNMPTrapPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, channelBandwidth=channelBandwidth, versions=versions, secondDataPortPauseFrames=secondDataPortPauseFrames, telnetPortNumber=telnetPortNumber, systemReset=systemReset, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, auxPortDisabledWarning=auxPortDisabledWarning, sNTPPollInterval=sNTPPollInterval, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPv6Address=iPv6Address, licenseIEEE1588Support=licenseIEEE1588Support, transparentClock=transparentClock, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerTable=sNTPServerTable, licenseTDDSyncSupport=licenseTDDSyncSupport, lowestSecondDataModulationMode=lowestSecondDataModulationMode, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, PYSNMP_MODULE_ID=cambium, sMTPServerInternetAddress=sMTPServerInternetAddress, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagPair3Results=cableDiagPair3Results, cableLoss=cableLoss, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNTPLastSync=sNTPLastSync, ptpTrapPrefix=ptpTrapPrefix, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, capacityVariantMismatchTrap=capacityVariantMismatchTrap, aAAControlGroup=aAAControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, mABHoldoffPeriod=mABHoldoffPeriod, mABMaintenanceLevel=mABMaintenanceLevel, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tDM=tDM, sNMPTrapVersion=sNMPTrapVersion, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, userTableIndex=userTableIndex, maxLinkRangeExceeded=maxLinkRangeExceeded)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMChannelStatusTrap=tDMChannelStatusTrap, sFPPortQLTx=sFPPortQLTx, licenseIssueNumber=licenseIssueNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dSCPManagementPriority=dSCPManagementPriority, licenseGroup=licenseGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, rangingMode=rangingMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsPorts=cableDiagnosticsPorts, encryptionAlgorithm=encryptionAlgorithm, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair2Distance=cableDiagPair2Distance, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair1Results=cableDiagPair1Results, dataBridgingAvailability=dataBridgingAvailability, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMChannelLoopback=tDMChannelLoopback, sNTPServerTableEntry=sNTPServerTableEntry, dataBridgingStatus=dataBridgingStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, cambium=cambium, ethernetPriorityTable=ethernetPriorityTable, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, mPLSTCPriorityTable=mPLSTCPriorityTable, resetGroup=resetGroup, txMABFrames=txMABFrames, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortStatus=mainPSUPortStatus, bridge=bridge, secureModeAlarm=secureModeAlarm, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarms=alarms, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsWarning=cableDiagnosticsWarning, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, reset=reset, licenseSFPPortSupport=licenseSFPPortSupport, installArmStateTrap=installArmStateTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, masterSlaveMode=masterSlaveMode, antennaGain=antennaGain, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, capacityVariantMismatch=capacityVariantMismatch, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mABTransmissionInterval=mABTransmissionInterval, groupID=groupID, iPv6PrefixLength=iPv6PrefixLength, wirelessLinkStatus=wirelessLinkStatus, syncETracking=syncETracking, sFPErrorTrap=sFPErrorTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortAllocation=auxPortAllocation, userName=userName, iPv4Address=iPv4Address, productName=productName, ptpTraps=ptpTraps, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, remoteInternetAddress=remoteInternetAddress, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, iPVersion=iPVersion, installStatusTrap=installStatusTrap, receiveChannel=receiveChannel, pubStats=pubStats, dataBridgingStatusAlarm=dataBridgingStatusAlarm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementNetworkAccessEnabled=managementNetworkAccessEnabled, auxPortConfigurationMismatch=auxPortConfigurationMismatch, versionsGroup=versionsGroup, auxPortSSMTx=auxPortSSMTx, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, licenseVersion=licenseVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, cableDiagPair2Results=cableDiagPair2Results, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, secondDataBridgingStatus=secondDataBridgingStatus, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, ptpCompliance=ptpCompliance, sNTPServerInternetAddress=sNTPServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, tDMChannelStatus=tDMChannelStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, wirelessLinkAvailability=wirelessLinkAvailability, tDMInterfaceControl=tDMInterfaceControl, targetMACAddress=targetMACAddress, rxColorCode=rxColorCode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, configurationGroup=configurationGroup, tdmTableEntry=tdmTableEntry, licenseCapacity=licenseCapacity, mABNominalTransmitCapacity=mABNominalTransmitCapacity, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableNumber=userTableNumber, vLANManagementVID=vLANManagementVID, tDMGroup=tDMGroup, sFPError=sFPError, latitude=latitude, sNMPPortNumber=sNMPPortNumber, tdmTableNumber=tdmTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, tdmTableIndex=tdmTableIndex, mABState=mABState, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, nIDULanPortAutoMdix=nIDULanPortAutoMdix, longitude=longitude, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, routerProtocols=routerProtocols, ptmp=ptmp, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, ptp650=ptp650, phyControlGroup=phyControlGroup, licenseTrialPeriod=licenseTrialPeriod, licenseUnitSerialNumber=licenseUnitSerialNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitFreqKHz=transmitFreqKHz, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, configuration=configuration, searchState=searchState)
