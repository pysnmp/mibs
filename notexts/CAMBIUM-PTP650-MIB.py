...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dSCPManagementPriority=dSCPManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPState=sNTPState, mABHoldoffPeriod=mABHoldoffPeriod, portAllocationMismatchTrap=portAllocationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aggregateDataRate=aggregateDataRate, routerProtocolsGroup=routerProtocolsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseBandwidthCap=licenseBandwidthCap, softwareVersion=softwareVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortSSMTx=auxPortSSMTx, transmitChannel=transmitChannel, userRole=userRole, sFPPortQLTx=sFPPortQLTx, sFPPortSyncERxStatus=sFPPortSyncERxStatus, secureModeAlarmTrap=secureModeAlarmTrap, cableDiagPair1Results=cableDiagPair1Results, byteErrorRatio=byteErrorRatio, userName=userName, vLANManagementVID=vLANManagementVID, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, daylightSaving=daylightSaving, remoteMaximumTransmitPower=remoteMaximumTransmitPower, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tDMInterfaceControl=tDMInterfaceControl, unitOutOfCalibration=unitOutOfCalibration, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, hardwareVersion=hardwareVersion, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, portAllocationMismatch=portAllocationMismatch, bridge=bridge, licenseRARSupport=licenseRARSupport, qOSPriorityScheme=qOSPriorityScheme, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortQLTx=auxPortQLTx, ethernetGroup=ethernetGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, secureModeAlarm=secureModeAlarm, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, txColorCode=txColorCode, encryption=encryption, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, transparentClockPort=transparentClockPort, incompatibleRegulatoryBands=incompatibleRegulatoryBands, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPVersion=iPVersion, iPv4Address=iPv4Address, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tDMChannelLineCode=tDMChannelLineCode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, cambium=cambium, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ptpGroups=ptpGroups, smtpGroup=smtpGroup, tDMChannelCableLength=tDMChannelCableLength, sNTPServerTableEntry=sNTPServerTableEntry, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, transparentClock=transparentClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, tDMConfigurationMismatch=tDMConfigurationMismatch, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair3Results=cableDiagPair3Results, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortStatusTrap=sFPPortStatusTrap, mABProtocolVID=mABProtocolVID, siteName=siteName, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptmp=ptmp, sntpGroup=sntpGroup, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, cableDiagPair2Results=cableDiagPair2Results, extendedSpectrumScanning=extendedSpectrumScanning, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseTrialPeriod=licenseTrialPeriod, iPv6PrefixLength=iPv6PrefixLength, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, txMABFrames=txMABFrames, ptp=ptp, reset=reset, tDMChannelStatus=tDMChannelStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, dataBridgingAvailability=dataBridgingAvailability, transmitFreqKHz=transmitFreqKHz, tdmTableNumber=tdmTableNumber, syncETracking=syncETracking, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, encryptionGroup=encryptionGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPv3Enable=sNMPv3Enable, userPassword=userPassword, userEnabled=userEnabled, dfsTable=dfsTable, aAAControlGroup=aAAControlGroup, rxColorCode=rxColorCode, licenseMaxLinkRange=licenseMaxLinkRange, linkName=linkName, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, targetMACAddress=targetMACAddress, mainPSUPortQLTx=mainPSUPortQLTx, transmitDataRate=transmitDataRate, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, capacityVariantMismatch=capacityVariantMismatch, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, tdmTableEntry=tdmTableEntry, mainPSUPortAllocation=mainPSUPortAllocation, iPDSCPPriorityTable=iPDSCPPriorityTable, resetGroup=resetGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPEmailAlert=sMTPEmailAlert, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, PYSNMP_MODULE_ID=cambium, transparentClockVLAN=transparentClockVLAN, sFPError=sFPError, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, mABProtocolVLANPriority=mABProtocolVLANPriority, transmitPower=transmitPower, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, searchState=searchState, regulatoryBand=regulatoryBand, sNMPTrapPortNumber=sNMPTrapPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, routerProtocols=routerProtocols, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syncEEquipmentClock=syncEEquipmentClock, syslogClient=syslogClient, supplementary=supplementary, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tdmTable=tdmTable, bridgeGroup=bridgeGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, longitude=longitude, ethernetPriorityTableNumber=ethernetPriorityTableNumber, phyControl=phyControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPServerStatus=sNTPServerStatus, mABMaintenanceLevel=mABMaintenanceLevel, timeZone=timeZone, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, installArmStateTrap=installArmStateTrap, capacityVariantMismatchTrap=capacityVariantMismatchTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mABTransmissionInterval=mABTransmissionInterval, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortSSMTx=mainPSUPortSSMTx, groupID=groupID, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dfsMeans=dfsMeans, remoteInternetAddress=remoteInternetAddress, licenseSFPPortSupport=licenseSFPPortSupport, targetRange=targetRange, systemReset=systemReset, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, pubStats=pubStats, installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPrimaryServer=sNTPPrimaryServer, cableDiagPair1Distance=cableDiagPair1Distance, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfs=dfs, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, receiveModulationMode=receiveModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqMHz=receiveFreqMHz, transparentClockVID=transparentClockVID, auxPortConfigurationMismatch=auxPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernet=ethernet, tDM=tDM, tDMEnabledChannels=tDMEnabledChannels, sFPPortStatus=sFPPortStatus, auxPortQLRx=auxPortQLRx, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortStatus=nIDULanPortStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortDisabledWarning=auxPortDisabledWarning, receivePower=receivePower, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, lowestDataModulationMode=lowestDataModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableDiagPair4Distance=cableDiagPair4Distance, sNMPTrapTable=sNMPTrapTable, receiveChannel=receiveChannel, linkModeOptimization=linkModeOptimization, regulatoryBandTrap=regulatoryBandTrap, sFPPortAllocation=sFPPortAllocation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkLoss=linkLoss, subnetMask=subnetMask, dataBridgingStatus=dataBridgingStatus, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair4Results=cableDiagPair4Results, sNMPTrapVersion=sNMPTrapVersion, ptp650=ptp650, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licenseGroup=licenseGroup, tFTPServerPortNumber=tFTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortStatus=auxPortStatus, channelChangeTrap=channelChangeTrap, cableDiagPair3Distance=cableDiagPair3Distance, rangingMode=rangingMode, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseIEEE1588Support=licenseIEEE1588Support, mABNominalModulationMode=mABNominalModulationMode, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, linkSymmetry=linkSymmetry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseIssueNumber=licenseIssueNumber, secondDataPortPauseFrames=secondDataPortPauseFrames, sFPPortAutoMdix=sFPPortAutoMdix, tDDSynchronizationMode=tDDSynchronizationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, rawReceivePower=rawReceivePower, gatewayIPAddress=gatewayIPAddress, userTable=userTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsPorts=cableDiagnosticsPorts, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, range=range, userTableIndex=userTableIndex, transmitFreqMHz=transmitFreqMHz, sNTPSyncTrap=sNTPSyncTrap, alarms=alarms, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dataPortPauseFrames=dataPortPauseFrames, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, managementGroup=managementGroup, altitude=altitude, dfsPeaks=dfsPeaks, snmpControl=snmpControl, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sFPPortSSMTx=sFPPortSSMTx, license=license, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, l2CPPriorityTable=l2CPPriorityTable, cableDiagnosticsGroup=cableDiagnosticsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagnosticsWarning=cableDiagnosticsWarning, sNTPServerTableNumber=sNTPServerTableNumber, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, tDMChannelLoopback=tDMChannelLoopback, configuration=configuration, productVariant=productVariant, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, licenseGroupAccess=licenseGroupAccess, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, mainPSUPortQLRx=mainPSUPortQLRx, sNMPEnabledTraps=sNMPEnabledTraps, notificationsGroup=notificationsGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, syslogState=syslogState, licenseUnitSerialNumber=licenseUnitSerialNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseCapacity=licenseCapacity, auxPortAllocation=auxPortAllocation, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerPortNumber=sMTPServerPortNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseSyncESupport=licenseSyncESupport, maxLinkRangeExceeded=maxLinkRangeExceeded, sNTPServerTimeout=sNTPServerTimeout, enableTransmission=enableTransmission, licenseIPv6Support=licenseIPv6Support, management=management, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, versions=versions, latitude=latitude, localPacketFiltering=localPacketFiltering, frequencyVariant=frequencyVariant, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortQLRx=sFPPortQLRx, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mABState=mABState, dfsTableNumber=dfsTableNumber, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagnostics=cableDiagnostics, licenseSecurityLevel=licenseSecurityLevel, userTableEntry=userTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, tdmTableIndex=tdmTableIndex, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, sNTPServerRetries=sNTPServerRetries, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveFreqKHz=receiveFreqKHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, productName=productName, cableLoss=cableLoss, phyStatusGroup=phyStatusGroup, secondDataBridgingStatus=secondDataBridgingStatus, telnetPortNumber=telnetPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, tDDControl=tDDControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseVersion=licenseVersion, pubStatsGroup=pubStatsGroup, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, phyStatus=phyStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, systemClock=systemClock, licenseEncryption=licenseEncryption, subbandHighestFrequency=subbandHighestFrequency, syslogControlGroup=syslogControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licenseCountry=licenseCountry, sFPErrorTrap=sFPErrorTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sNTPServerPortNumber=sNTPServerPortNumber, syncETrackingState=syncETrackingState, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortStatusTrap=auxPortStatusTrap, phyControlGroup=phyControlGroup, sntp=sntp, supplementaryGroup=supplementaryGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPServerTableIndex=sNTPServerTableIndex, iPv6Address=iPv6Address, sNTPServerTable=sNTPServerTable, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, sNTPSync=sNTPSync, licenseRegulatoryBandsList=licenseRegulatoryBandsList, vectorError=vectorError, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, mainPSUPortStatus=mainPSUPortStatus, tDMGroup=tDMGroup, dfsTableIndex=dfsTableIndex, dfsTableEntry=dfsTableEntry, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync)
