...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", regulatoryBand=regulatoryBand, tDMChannelLineCode=tDMChannelLineCode, cableDiagPair1Distance=cableDiagPair1Distance, dfsTable=dfsTable, notificationsGroup=notificationsGroup, supplementary=supplementary, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, incompatibleRegulatoryBands=incompatibleRegulatoryBands, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, byteErrorRatio=byteErrorRatio, remoteInternetAddressType=remoteInternetAddressType, encryption=encryption, systemReset=systemReset, userName=userName, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, range=range, syslogClient=syslogClient, sNTPServerTable=sNTPServerTable, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMGroup=tDMGroup, secureModeAlarmTrap=secureModeAlarmTrap, licenseIssueNumber=licenseIssueNumber, dfsTableEntry=dfsTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkLoss=linkLoss, tDDControlGroup=tDDControlGroup, tdmTableEntry=tdmTableEntry, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, cableDiagPair4Distance=cableDiagPair4Distance, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortSSMTx=auxPortSSMTx, siteName=siteName, tDDControl=tDDControl, bootVersion=bootVersion, managementGroup=managementGroup, hardwareVersion=hardwareVersion, dfsPeaks=dfsPeaks, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPServerTableNumber=sNTPServerTableNumber, phyStatusGroup=phyStatusGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, frequencyVariant=frequencyVariant, routerProtocols=routerProtocols, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortQLTx=mainPSUPortQLTx, sFPPortQLRx=sFPPortQLRx, sNTPServerStatus=sNTPServerStatus, sNMPTrapTable=sNMPTrapTable, txMABFrames=txMABFrames, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsResultTable=cableDiagnosticsResultTable, syncETracking=syncETracking, productName=productName, transmitModulationMode=transmitModulationMode, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPollInterval=sNTPPollInterval, dataBridgingStatus=dataBridgingStatus, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, maxLinkRangeExceeded=maxLinkRangeExceeded, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, tDM=tDM, enableTransmission=enableTransmission, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, ptpTraps=ptpTraps, linkModeOptimization=linkModeOptimization, cableDiagPair2Results=cableDiagPair2Results, syslogControlGroup=syslogControlGroup, cableDiagPair1Results=cableDiagPair1Results, subbandHighestFrequency=subbandHighestFrequency, dSCPManagementPriority=dSCPManagementPriority, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, userRole=userRole, timeZone=timeZone, sFPPortStatusTrap=sFPPortStatusTrap, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, pubStatsGroup=pubStatsGroup, dfsMeans=dfsMeans, l2CPPriorityTable=l2CPPriorityTable, license=license, tDMChannelLoopback=tDMChannelLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseSFPPortSupport=licenseSFPPortSupport, transmitFreqKHz=transmitFreqKHz, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, userEnabled=userEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tdmTable=tdmTable, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, userPassword=userPassword, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, iPv6PrefixLength=iPv6PrefixLength, vectorError=vectorError, targetMACAddress=targetMACAddress, dfsTableNumber=dfsTableNumber, dfsGroup=dfsGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, antennaGain=antennaGain, mABTransmissionInterval=mABTransmissionInterval, receiveFreqMHz=receiveFreqMHz, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, mABMaintenanceLevel=mABMaintenanceLevel, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, transmitChannel=transmitChannel, rxColorCode=rxColorCode, auxPortQLTx=auxPortQLTx, aggregateDataRate=aggregateDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, resetGroup=resetGroup, mABProtocolVID=mABProtocolVID, ethernetPriorityTableIndex=ethernetPriorityTableIndex, wirelessLinkStatus=wirelessLinkStatus, capacityVariantMismatch=capacityVariantMismatch, vLANManagementVID=vLANManagementVID, syslogControl=syslogControl, iPv6Address=iPv6Address, sMTPServerInternetAddressType=sMTPServerInternetAddressType, latitude=latitude, alarmsGroup=alarmsGroup, userTableNumber=userTableNumber, cableDiagPair3Results=cableDiagPair3Results, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, configuration=configuration, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, dfs=dfs, syncEEquipmentClock=syncEEquipmentClock, dfsTableIndex=dfsTableIndex, unitOutOfCalibration=unitOutOfCalibration, channelChangeTrap=channelChangeTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, ethernet=ethernet, transparentClockVID=transparentClockVID, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerInternetAddressType=tFTPServerInternetAddressType, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, aAAControlGroup=aAAControlGroup, subbandLowestFrequency=subbandLowestFrequency, sNTPSync=sNTPSync, cableDiagPair4Results=cableDiagPair4Results, dataPortPauseFrames=dataPortPauseFrames, eIRP=eIRP, versionsGroup=versionsGroup, groupID=groupID, userTableEntry=userTableEntry, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sFPPortDisabledWarning=sFPPortDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseOOBManagementSupport=licenseOOBManagementSupport, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, phyStatus=phyStatus, rawReceivePower=rawReceivePower, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortStatus=mainPSUPortStatus, receiveModulationMode=receiveModulationMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortStatus=auxPortStatus, transmitDataRate=transmitDataRate, iPv4Address=iPv4Address, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ptmp=ptmp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, aAAControl=aAAControl, qOSPriorityScheme=qOSPriorityScheme, tDMChannelStatus=tDMChannelStatus, installArmStateTrap=installArmStateTrap, regulatoryBandTrap=regulatoryBandTrap, mABNominalModulationMode=mABNominalModulationMode, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, configurationGroup=configurationGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, licenseIPv6Support=licenseIPv6Support, sNTPServerTimeout=sNTPServerTimeout, receiveDataRate=receiveDataRate, nIDULanPortStatusTrap=nIDULanPortStatusTrap, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortStatus=sFPPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseTrialPeriod=licenseTrialPeriod, txColorCode=txColorCode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sntpGroup=sntpGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, systemClock=systemClock, lowestDataModulationMode=lowestDataModulationMode, mABNominalTransmitCapacity=mABNominalTransmitCapacity, lowestSecondDataModulationMode=lowestSecondDataModulationMode, auxPortQLRx=auxPortQLRx, management=management, transmitPower=transmitPower, ptpCompliance=ptpCompliance, licenseSecurityLevel=licenseSecurityLevel, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, licenseIEEE1588Support=licenseIEEE1588Support, encryptionAlgorithm=encryptionAlgorithm, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, smtp=smtp, ethernetPriorityTable=ethernetPriorityTable, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRARSupport=licenseRARSupport, masterSlaveMode=masterSlaveMode, dataBridgingStatusAlarm=dataBridgingStatusAlarm, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, sNTPPrimaryServer=sNTPPrimaryServer, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPv3Enable=sNMPv3Enable, secondarySoftwareVersion=secondarySoftwareVersion, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsWarning=cableDiagnosticsWarning)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPServerRetries=sNTPServerRetries, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, accessMethod=accessMethod, auxPortAcceptedQLRx=auxPortAcceptedQLRx, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, installArmState=installArmState, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseGroupAccess=licenseGroupAccess, auxPortConfigurationMismatch=auxPortConfigurationMismatch, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, maximumTransmitPower=maximumTransmitPower, remoteInternetAddress=remoteInternetAddress, syslogState=syslogState, sFPPortAutoMdix=sFPPortAutoMdix, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, PYSNMP_MODULE_ID=cambium, mainPSUPortQLRx=mainPSUPortQLRx, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, targetRange=targetRange, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sFPError=sFPError, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tdmTableNumber=tdmTableNumber, mABHoldoffPeriod=mABHoldoffPeriod, syncETrackingState=syncETrackingState, secureModeAlarm=secureModeAlarm, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cambium=cambium, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, licenseGroup=licenseGroup, tDMInterfaceControl=tDMInterfaceControl, tDMEnabledChannels=tDMEnabledChannels, lowestTDMModulationMode=lowestTDMModulationMode, alarms=alarms, licenseCapacity=licenseCapacity, sFPPortAllocation=sFPPortAllocation, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, extendedSpectrumScanning=extendedSpectrumScanning, daylightSaving=daylightSaving, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, ptp650=ptp650, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, syslogLocalWrappedTrap=syslogLocalWrappedTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, vLANManagementPriority=vLANManagementPriority, localPacketFiltering=localPacketFiltering, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDMConfigurationMismatch=tDMConfigurationMismatch, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, receivePower=receivePower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, iPVersion=iPVersion, transparentClockPort=transparentClockPort, cableLoss=cableLoss, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transparentClockVLAN=transparentClockVLAN, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDMChannelCableLength=tDMChannelCableLength, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bridgeGroup=bridgeGroup, telnetAccessEnabled=telnetAccessEnabled, phyControl=phyControl, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, receiveFreqKHz=receiveFreqKHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, searchState=searchState, syslogClientTrap=syslogClientTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortSSMTx=sFPPortSSMTx, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, tdmTableIndex=tdmTableIndex, sntp=sntp, nIDULanPortStatus=nIDULanPortStatus, signalStrengthRatio=signalStrengthRatio, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, productVariant=productVariant, licenseBandwidthCap=licenseBandwidthCap, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsControl=cableDiagnosticsControl, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, phyControlGroup=phyControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, transparentClock=transparentClock, dataBridgingAvailability=dataBridgingAvailability, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, mABProtocolVLANPriority=mABProtocolVLANPriority, secondDataBridgingStatus=secondDataBridgingStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, cableDiagPair2Distance=cableDiagPair2Distance, bridge=bridge, cableDiagPair3Distance=cableDiagPair3Distance, iPv6GatewayAddress=iPv6GatewayAddress, tDMInterfaceStatus=tDMInterfaceStatus, auxPortAllocation=auxPortAllocation, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, sFPErrorTrap=sFPErrorTrap, sNTPServerInternetAddress=sNTPServerInternetAddress, auxPortStatusTrap=auxPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseEncryption=licenseEncryption, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseVersion=licenseVersion, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, portAllocationMismatch=portAllocationMismatch, softwareVersion=softwareVersion, rangingMode=rangingMode, reset=reset, licenseCountry=licenseCountry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sFPPortAutoNegotiation=sFPPortAutoNegotiation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptp=ptp, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, userTable=userTable, longitude=longitude, altitude=altitude, subnetMask=subnetMask, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, useVLANForMABProtocol=useVLANForMABProtocol, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnostics=cableDiagnostics, mABState=mABState, sFPPortQLTx=sFPPortQLTx, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled)
