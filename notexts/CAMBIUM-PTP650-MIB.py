...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", l2CPPriorityTable=l2CPPriorityTable, sFPPortSSMTx=sFPPortSSMTx, enableTransmission=enableTransmission, sNMPCommunityString=sNMPCommunityString, sNTPServerStatus=sNTPServerStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDDSynchronizationMode=tDDSynchronizationMode, bootVersion=bootVersion, capacityVariantMismatch=capacityVariantMismatch, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsPeaks=dfsPeaks, mABProtocolVLANPriority=mABProtocolVLANPriority, syslogClient=syslogClient, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityVariantMismatchTrap=capacityVariantMismatchTrap, syncEEquipmentClock=syncEEquipmentClock, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableLoss=cableLoss, cableDiagPair1Results=cableDiagPair1Results, subbandHighestFrequency=subbandHighestFrequency, telnetPortNumber=telnetPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABTransmissionInterval=mABTransmissionInterval, auxPortAcceptedQLRx=auxPortAcceptedQLRx, targetMACAddress=targetMACAddress, userTable=userTable, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, encryptionGroup=encryptionGroup, sNTPServerTable=sNTPServerTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, rawReceivePower=rawReceivePower, mainPSUPortSSMTx=mainPSUPortSSMTx, dfsGroup=dfsGroup, channelChangeTrap=channelChangeTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, secureModeAlarmTrap=secureModeAlarmTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveDataRate=receiveDataRate, tDMChannelLineCode=tDMChannelLineCode, aAAControl=aAAControl, sntpGroup=sntpGroup, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, dataBridgingAvailability=dataBridgingAvailability, tDMChannelCableLength=tDMChannelCableLength, cableDiagnosticsWarning=cableDiagnosticsWarning, signalStrengthRatio=signalStrengthRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, mABNominalModulationMode=mABNominalModulationMode, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, tDMEnabledChannels=tDMEnabledChannels, dataPortWirelessDownAlert=dataPortWirelessDownAlert, lowestTDMModulationMode=lowestTDMModulationMode, tdmTableNumber=tdmTableNumber, sNMPTrapVersion=sNMPTrapVersion, iPv4Address=iPv4Address, dataPortPauseFrames=dataPortPauseFrames, licenseGroupAccess=licenseGroupAccess, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, receiveModulationModeDetail=receiveModulationModeDetail, tdmTableIndex=tdmTableIndex, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, longitude=longitude, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseRARSupport=licenseRARSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseCapacity=licenseCapacity, ptpTraps=ptpTraps, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tDMInterfaceStatus=tDMInterfaceStatus, license=license, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, dfsMeans=dfsMeans, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, txMABFrames=txMABFrames, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, mainPSUPortQLTx=mainPSUPortQLTx, tDMGroup=tDMGroup, vLANManagementPriority=vLANManagementPriority, siteName=siteName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyStatus=phyStatus, sNTPPrimaryServer=sNTPPrimaryServer, licenseIssueNumber=licenseIssueNumber, tDDControl=tDDControl, range=range, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, mainPSUPortStatus=mainPSUPortStatus, sNTPSync=sNTPSync, managementPortWirelessDownAlert=managementPortWirelessDownAlert, receivePower=receivePower, regulatoryBandTrap=regulatoryBandTrap, dSCPManagementPriority=dSCPManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortStatus=sFPPortStatus, PYSNMP_MODULE_ID=cambium, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnostics=cableDiagnostics, cambium=cambium, iPv6GatewayAddress=iPv6GatewayAddress, versions=versions, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, auxPortStatus=auxPortStatus, syslogState=syslogState, nIDULanPortStatus=nIDULanPortStatus, localPacketFiltering=localPacketFiltering, tDMChannelStatus=tDMChannelStatus, cableDiagPair3Results=cableDiagPair3Results, mPLSTCPriorityTable=mPLSTCPriorityTable, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseGroup=licenseGroup, l2CPPriorityTableIndex=l2CPPriorityTableIndex, nIDULanPortStatusTrap=nIDULanPortStatusTrap, bridgeGroup=bridgeGroup, licenseBandwidthCap=licenseBandwidthCap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatus=installStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, auxPortAllocation=auxPortAllocation, ptpGroups=ptpGroups, licenseIPv6Support=licenseIPv6Support, auxPortSSMTx=auxPortSSMTx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseMaxLinkRange=licenseMaxLinkRange, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, sNMPPortNumber=sNMPPortNumber, mABState=mABState, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, reset=reset, sNTPState=sNTPState, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secureModeAlarm=secureModeAlarm, rxColorCode=rxColorCode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNMPTrapInternetAddress=sNMPTrapInternetAddress, linkModeOptimization=linkModeOptimization, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, tdmTableEntry=tdmTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortQLTx=sFPPortQLTx, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseEncryption=licenseEncryption, extendedSpectrumScanning=extendedSpectrumScanning, ptpCompliance=ptpCompliance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortDisabledWarning=auxPortDisabledWarning, transmitFreqMHz=transmitFreqMHz, qOSPriorityScheme=qOSPriorityScheme, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, hTTPPortNumber=hTTPPortNumber, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseOOBManagementSupport=licenseOOBManagementSupport, tFTPServerPortNumber=tFTPServerPortNumber, mABProtocolVID=mABProtocolVID, transparentClockVID=transparentClockVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, cableDiagPair2Distance=cableDiagPair2Distance, productVariant=productVariant, licenseCountry=licenseCountry, sNTPLastSync=sNTPLastSync, transparentClock=transparentClock, dfsTable=dfsTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, cableDiagPair4Results=cableDiagPair4Results, mABMaintenanceLevel=mABMaintenanceLevel, syslogControlGroup=syslogControlGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, transmitDataRate=transmitDataRate, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sNMPv3Enable=sNMPv3Enable, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, receiveModulationMode=receiveModulationMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, iPv6PrefixLength=iPv6PrefixLength, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, notificationsGroup=notificationsGroup, cableDiagPair2Results=cableDiagPair2Results, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, versionsGroup=versionsGroup, ptp=ptp, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, transparentClockVLAN=transparentClockVLAN, supplementaryGroup=supplementaryGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, sNTPServerRetries=sNTPServerRetries, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, auxPortQLTx=auxPortQLTx, softwareVersion=softwareVersion, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ptp650=ptp650, licenseRegulatoryBandsList=licenseRegulatoryBandsList, auxPortConfigurationMismatch=auxPortConfigurationMismatch, cableDiagPair4Distance=cableDiagPair4Distance, ethernetGroup=ethernetGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, routerProtocolsGroup=routerProtocolsGroup, lowestSecondDataModulationMode=lowestSecondDataModulationMode, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddress=sNTPServerInternetAddress, hardwareVersion=hardwareVersion, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, tDMChannelLoopback=tDMChannelLoopback, userPassword=userPassword, phyControlGroup=phyControlGroup, userRole=userRole)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dfsTableEntry=dfsTableEntry, eIRP=eIRP, vLANManagementVID=vLANManagementVID, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, pubStatsGroup=pubStatsGroup, vectorError=vectorError, managementGroup=managementGroup, mainPSUPortAllocation=mainPSUPortAllocation, alarmsGroup=alarmsGroup, sFPPortAutoMdix=sFPPortAutoMdix, lowestDataModulationMode=lowestDataModulationMode, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syncETrackingState=syncETrackingState, useVLANForMABProtocol=useVLANForMABProtocol, hTTPSPortNumber=hTTPSPortNumber, linkName=linkName, dataBridgingStatus=dataBridgingStatus, ptmp=ptmp, remoteInternetAddressType=remoteInternetAddressType, cableDiagPair3Distance=cableDiagPair3Distance, secondDataBridgingStatus=secondDataBridgingStatus, tDM=tDM, telnetAccessEnabled=telnetAccessEnabled, cableDiagPair1Distance=cableDiagPair1Distance, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPSyncTrap=sNTPSyncTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sFPError=sFPError, licenseSFPPortSupport=licenseSFPPortSupport, installArmState=installArmState, transparentClockPort=transparentClockPort, transmitChannel=transmitChannel, routerProtocols=routerProtocols, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, phyControl=phyControl, byteErrorRatio=byteErrorRatio, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, bridge=bridge, wirelessLinkAvailability=wirelessLinkAvailability, frequencyVariant=frequencyVariant, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStats=pubStats, phyStatusGroup=phyStatusGroup, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, auxPortStatusTrap=auxPortStatusTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, subnetMask=subnetMask, portAllocationMismatch=portAllocationMismatch, licenseIEEE1588Support=licenseIEEE1588Support, linkLoss=linkLoss, alarms=alarms, syncETracking=syncETracking, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, antennaGain=antennaGain, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sFPPortStatusTrap=sFPPortStatusTrap, syslogControl=syslogControl, secondDataPortPauseFrames=secondDataPortPauseFrames, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, tdmTable=tdmTable, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, configuration=configuration, userName=userName, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, aAAControlGroup=aAAControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableEntry=userTableEntry, tDDControlGroup=tDDControlGroup, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, management=management, iPv6Address=iPv6Address, productName=productName, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, accessMethod=accessMethod, licenseSyncESupport=licenseSyncESupport, latitude=latitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkSymmetry=linkSymmetry, targetRange=targetRange, syslogStateTrap=syslogStateTrap, mABHoldoffPeriod=mABHoldoffPeriod, transmitFreqKHz=transmitFreqKHz, cableDiagnosticsControl=cableDiagnosticsControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNTPServerTableNumber=sNTPServerTableNumber, snmpControlGroup=snmpControlGroup, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, noWirelessChannelAvailable=noWirelessChannelAvailable, dfs=dfs, installStatusTrap=installStatusTrap, txColorCode=txColorCode, receiveChannel=receiveChannel, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, userEnabled=userEnabled, sFPPortAllocation=sFPPortAllocation, tDMInterfaceControl=tDMInterfaceControl, smtpGroup=smtpGroup, receiveFreqKHz=receiveFreqKHz, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, rangingMode=rangingMode, auxPortQLRx=auxPortQLRx, syslogClientTrap=syslogClientTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitModulationMode=transmitModulationMode, systemReset=systemReset, channelBandwidth=channelBandwidth, maxLinkRangeExceeded=maxLinkRangeExceeded, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseSecurityLevel=licenseSecurityLevel, mainPSUPortQLRx=mainPSUPortQLRx, altitude=altitude, searchState=searchState, sFPPortSyncERxStatus=sFPPortSyncERxStatus, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, regulatoryBand=regulatoryBand, iPVersion=iPVersion, licenseVersion=licenseVersion, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPErrorTrap=sFPErrorTrap, sNTPServerTableEntry=sNTPServerTableEntry, dfsTableIndex=dfsTableIndex, sFPPortAutoNegotiation=sFPPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, groupID=groupID, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortQLRx=sFPPortQLRx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTable=ethernetPriorityTable, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, cableDiagnosticsGroup=cableDiagnosticsGroup, supplementary=supplementary, subbandLowestFrequency=subbandLowestFrequency, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, gatewayIPAddress=gatewayIPAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, smtp=smtp)
