...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", versions=versions, targetRange=targetRange, licenseVersion=licenseVersion, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, maximumTransmitPower=maximumTransmitPower, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, bootVersion=bootVersion, mABHoldoffPeriod=mABHoldoffPeriod, lowestDataModulationMode=lowestDataModulationMode, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, userName=userName, cableDiagnosticsControl=cableDiagnosticsControl, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, reset=reset, dfsGroup=dfsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, txColorCode=txColorCode, accessMethod=accessMethod, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, secureModeAlarm=secureModeAlarm, sFPError=sFPError, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, tDMChannelStatus=tDMChannelStatus, userEnabled=userEnabled, PYSNMP_MODULE_ID=cambium, supplementary=supplementary, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, useVLANForMABProtocol=useVLANForMABProtocol, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sFPPortStatus=sFPPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, sFPErrorTrap=sFPErrorTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, mABState=mABState, productName=productName, mABMaintenanceLevel=mABMaintenanceLevel, mainPSUPortAllocation=mainPSUPortAllocation, localPacketFiltering=localPacketFiltering, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dSCPManagementPriority=dSCPManagementPriority, pubStats=pubStats, dataBridgingStatus=dataBridgingStatus, syncETracking=syncETracking, alarms=alarms, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, transparentClockVID=transparentClockVID, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondDataBridgingStatus=secondDataBridgingStatus, licenseSFPPortSupport=licenseSFPPortSupport, alarmsGroup=alarmsGroup, siteName=siteName, sNTPPollInterval=sNTPPollInterval, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, cableDiagnostics=cableDiagnostics, tDMChannelLoopback=tDMChannelLoopback, installArmStateTrap=installArmStateTrap, installStatus=installStatus, dfsTable=dfsTable, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, signalStrengthRatio=signalStrengthRatio, licenseSecurityLevel=licenseSecurityLevel, cableDiagPair1Results=cableDiagPair1Results, sNTPSync=sNTPSync, sNTPServerTableIndex=sNTPServerTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPEmailAlert=sMTPEmailAlert, dataBridgingAvailability=dataBridgingAvailability, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userTableIndex=userTableIndex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, regulatoryBand=regulatoryBand, dfs=dfs, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subbandLowestFrequency=subbandLowestFrequency, telnetPortNumber=telnetPortNumber, capacityVariantMismatch=capacityVariantMismatch, tdmTableNumber=tdmTableNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, encryption=encryption, timeZone=timeZone, iPv6PrefixLength=iPv6PrefixLength, aAAControl=aAAControl, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagPair2Results=cableDiagPair2Results, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpTraps=ptpTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, auxPortQLRx=auxPortQLRx, cambium=cambium, enableTransmission=enableTransmission, linkLoss=linkLoss, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, secureModeAlarmTrap=secureModeAlarmTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, wirelessLinkAvailability=wirelessLinkAvailability, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableNumber=ethernetPriorityTableNumber, snmpControl=snmpControl, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, latitude=latitude, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, syslogState=syslogState, sNTPServerInternetAddressType=sNTPServerInternetAddressType, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, sFPPortQLTx=sFPPortQLTx, licenseGroupAccess=licenseGroupAccess, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, sNTPPrimaryServer=sNTPPrimaryServer, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmState=installArmState, encryptionGroup=encryptionGroup, lowestSecondDataModulationMode=lowestSecondDataModulationMode, userPassword=userPassword, regulatoryBandTrap=regulatoryBandTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, incompatibleRegulatoryBands=incompatibleRegulatoryBands, longitude=longitude, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, transparentClockVLAN=transparentClockVLAN, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair3Results=cableDiagPair3Results, cableDiagPair4Results=cableDiagPair4Results, dfsTableEntry=dfsTableEntry, notificationsGroup=notificationsGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerInternetAddress=sNTPServerInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, phyControl=phyControl, linkName=linkName, frequencyVariant=frequencyVariant, auxPortQLTx=auxPortQLTx, sNMPTrapTableIndex=sNMPTrapTableIndex, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, license=license, syslogStateTrap=syslogStateTrap, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, iPv6Address=iPv6Address, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, rawReceivePower=rawReceivePower, receiveFreqKHz=receiveFreqKHz, searchState=searchState, antennaGain=antennaGain, syslogControl=syslogControl, mainPSUPortAutoMdix=mainPSUPortAutoMdix, remoteInternetAddressType=remoteInternetAddressType, auxPortSSMTx=auxPortSSMTx, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, licenseMaxLinkRange=licenseMaxLinkRange, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, ptpGroups=ptpGroups, cableDiagPair4Distance=cableDiagPair4Distance, ptmp=ptmp, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, txMABFrames=txMABFrames, sFPPortAllocation=sFPPortAllocation, sFPPortStatusTrap=sFPPortStatusTrap, tDDControlGroup=tDDControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, licenseTDDSyncSupport=licenseTDDSyncSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementPortWirelessDownAlert=managementPortWirelessDownAlert, daylightSaving=daylightSaving, licenseIEEE1588Support=licenseIEEE1588Support, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, subbandHighestFrequency=subbandHighestFrequency, supplementaryGroup=supplementaryGroup, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMEnabledChannels=tDMEnabledChannels, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNTPServerTableNumber=sNTPServerTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortAllocation=auxPortAllocation, telnetAccessEnabled=telnetAccessEnabled, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, byteErrorRatio=byteErrorRatio, sNTPServerTimeout=sNTPServerTimeout, remoteInternetAddress=remoteInternetAddress, syncEEquipmentClock=syncEEquipmentClock, dfsTableIndex=dfsTableIndex, licenseIPv6Support=licenseIPv6Support, mABTransmissionInterval=mABTransmissionInterval, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, masterSlaveMode=masterSlaveMode, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, ethernetPriorityTableIndex=ethernetPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ptp650=ptp650, tDMGroup=tDMGroup, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, groupID=groupID, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, tDM=tDM, gatewayIPAddress=gatewayIPAddress, linkModeOptimization=linkModeOptimization, sNMPTrapInternetAddress=sNMPTrapInternetAddress, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tdmTableEntry=tdmTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, ethernet=ethernet, sFPPortQLRx=sFPPortQLRx, softwareVersion=softwareVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, ptpCompliance=ptpCompliance, userTableEntry=userTableEntry, cableDiagPair2Distance=cableDiagPair2Distance, sNTPServerPortNumber=sNTPServerPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", userTableNumber=userTableNumber, altitude=altitude, tDMConfigurationMismatch=tDMConfigurationMismatch, productVariant=productVariant, tDMInterfaceStatus=tDMInterfaceStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNTPServerRetries=sNTPServerRetries, licenseUnitSerialNumber=licenseUnitSerialNumber, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortSSMTx=mainPSUPortSSMTx, receiveChannel=receiveChannel, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, licenseSyncESupport=licenseSyncESupport, maxLinkRangeExceeded=maxLinkRangeExceeded, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, transparentClock=transparentClock, sntpGroup=sntpGroup, smtp=smtp, tdmTable=tdmTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDMInterfaceControl=tDMInterfaceControl, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseGroup=licenseGroup, vectorError=vectorError, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secondDataPortPauseFrames=secondDataPortPauseFrames, sNTPServerStatus=sNTPServerStatus, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, sNMPTrapTable=sNMPTrapTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernetGroup=ethernetGroup, tDMChannelCableLength=tDMChannelCableLength, licenseBandwidthCap=licenseBandwidthCap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDMChannelLineCode=tDMChannelLineCode, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, transparentClockPort=transparentClockPort, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, routerProtocols=routerProtocols, sNMPv3Enable=sNMPv3Enable, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, configuration=configuration, userTable=userTable, portAllocationMismatch=portAllocationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, ptp=ptp, eIRP=eIRP, pubStatsGroup=pubStatsGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, phyStatus=phyStatus, rangingMode=rangingMode, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, subnetMask=subnetMask, mainPSUPortQLRx=mainPSUPortQLRx, sNTPSyncTrap=sNTPSyncTrap, auxPortStatusTrap=auxPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tdmTableIndex=tdmTableIndex, rxColorCode=rxColorCode, nIDULanPortStatus=nIDULanPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, secondarySoftwareVersion=secondarySoftwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseEncryption=licenseEncryption, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPv4Address=iPv4Address, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerTable=sNTPServerTable, installStatusTrap=installStatusTrap, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, mABNominalModulationMode=mABNominalModulationMode, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, management=management, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseRegulatoryBandsList=licenseRegulatoryBandsList, systemClock=systemClock, auxPortDisabledWarning=auxPortDisabledWarning, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, transmitFreqKHz=transmitFreqKHz, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseIssueNumber=licenseIssueNumber, cableLoss=cableLoss, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, dfsPeaks=dfsPeaks, range=range, licenseCountry=licenseCountry, licenseCapacity=licenseCapacity, syncETrackingState=syncETrackingState, routerProtocolsGroup=routerProtocolsGroup, channelBandwidth=channelBandwidth, tFTPServerInternetAddressType=tFTPServerInternetAddressType, receiveModulationMode=receiveModulationMode, dfsMeans=dfsMeans, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, ethernetPriorityTable=ethernetPriorityTable, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortStatus=mainPSUPortStatus, bridge=bridge, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, mABProtocolVID=mABProtocolVID, managementNetworkAccessEnabled=managementNetworkAccessEnabled, vLANManagementPriority=vLANManagementPriority, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, transmitDataRate=transmitDataRate, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagnosticsResultTable=cableDiagnosticsResultTable, lowestTDMModulationMode=lowestTDMModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPVersion=iPVersion, qOSPriorityScheme=qOSPriorityScheme, licenseRARSupport=licenseRARSupport, sNTPLastSync=sNTPLastSync, extendedSpectrumScanning=extendedSpectrumScanning, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, phyControlGroup=phyControlGroup, cableDiagPair3Distance=cableDiagPair3Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControlGroup=syslogControlGroup, auxPortStatus=auxPortStatus, bridgeGroup=bridgeGroup, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, licenseTrialPeriod=licenseTrialPeriod, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortAutoMdix=sFPPortAutoMdix)
