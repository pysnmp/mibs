...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMGroup=tDMGroup, remoteInternetAddress=remoteInternetAddress, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTable=iPDSCPPriorityTable, mABTransmissionInterval=mABTransmissionInterval, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDMConfigurationMismatch=tDMConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, dfsTable=dfsTable, regulatoryBand=regulatoryBand, userTableNumber=userTableNumber, txColorCode=txColorCode, cableDiagPair3Distance=cableDiagPair3Distance, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, userPassword=userPassword, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, alarms=alarms, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, timeZone=timeZone, syncETrackingState=syncETrackingState, phyControl=phyControl, licenseVersion=licenseVersion, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, subbandHighestFrequency=subbandHighestFrequency, bridge=bridge, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, range=range, tDDControl=tDDControl, hardwareVersion=hardwareVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, management=management, targetMACAddress=targetMACAddress, installArmState=installArmState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sFPPortQLTx=sFPPortQLTx, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseGroup=licenseGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dataBridgingStatus=dataBridgingStatus, sntp=sntp, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, vLANManagementPriority=vLANManagementPriority, aAAControl=aAAControl, mPLSTCPriorityTable=mPLSTCPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPPortNumber=sNMPPortNumber, encryptionAlgorithm=encryptionAlgorithm, tFTPServerInternetAddressType=tFTPServerInternetAddressType, linkModeOptimization=linkModeOptimization, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tdmTableNumber=tdmTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, receivePower=receivePower, userRole=userRole, qOSPriorityScheme=qOSPriorityScheme, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, dfsMeans=dfsMeans, auxPortStatusTrap=auxPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, iPv6PrefixLength=iPv6PrefixLength, licenseCapacity=licenseCapacity, cableDiagPair4Results=cableDiagPair4Results, sFPPortSSMTx=sFPPortSSMTx, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sFPPortAllocation=sFPPortAllocation, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableDiagnosticsControl=cableDiagnosticsControl, syncEEquipmentClock=syncEEquipmentClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableDiagnosticsPorts=cableDiagnosticsPorts, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagPair4Distance=cableDiagPair4Distance, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, licenseBandwidthCap=licenseBandwidthCap, rangingMode=rangingMode, localPacketFiltering=localPacketFiltering, linkSymmetry=linkSymmetry, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, targetRange=targetRange, hTTPAccessEnabled=hTTPAccessEnabled, licenseIssueNumber=licenseIssueNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, productName=productName, capacityVariantMismatch=capacityVariantMismatch, daylightSaving=daylightSaving, rawReceivePower=rawReceivePower, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, userTableIndex=userTableIndex, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, sFPError=sFPError, lowestSecondDataModulationMode=lowestSecondDataModulationMode, hTTPSPortNumber=hTTPSPortNumber, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, installArmStateTrap=installArmStateTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNTPSync=sNTPSync, systemClock=systemClock, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, phyControlGroup=phyControlGroup, dfsPeaks=dfsPeaks, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tdmTableIndex=tdmTableIndex, dfsTableIndex=dfsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sNTPState=sNTPState, searchState=searchState, dfsGroup=dfsGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tdmTable=tdmTable, transparentClockVLAN=transparentClockVLAN, transparentClockVID=transparentClockVID, auxPortQLTx=auxPortQLTx, licenseEncryption=licenseEncryption, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, phyStatus=phyStatus, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, productVariant=productVariant, tDMInterfaceControl=tDMInterfaceControl, iPVersion=iPVersion, iPv6Address=iPv6Address, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transparentClock=transparentClock, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptpGroups=ptpGroups, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, portAllocationMismatch=portAllocationMismatch, tDM=tDM, mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelLineCode=tDMChannelLineCode, subnetMask=subnetMask, snmpControl=snmpControl, smtp=smtp, configuration=configuration, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortQLRx=mainPSUPortQLRx, txMABFrames=txMABFrames, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, lowestTDMModulationMode=lowestTDMModulationMode, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, managementGroup=managementGroup, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnostics=cableDiagnostics, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, channelChangeTrap=channelChangeTrap, groupID=groupID, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPPortQLRx=sFPPortQLRx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, versions=versions, cableDiagnosticsGroup=cableDiagnosticsGroup, mainPSUPortStatus=mainPSUPortStatus, aAAControlGroup=aAAControlGroup, auxPortDisabledWarning=auxPortDisabledWarning, tDMChannelStatusTrap=tDMChannelStatusTrap, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseOOBManagementSupport=licenseOOBManagementSupport, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tdmTableEntry=tdmTableEntry, userEnabled=userEnabled, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transmitChannel=transmitChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, routerProtocols=routerProtocols, receiveModulationModeDetail=receiveModulationModeDetail, mABMaintenanceLevel=mABMaintenanceLevel, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, siteName=siteName, rxColorCode=rxColorCode, notificationsGroup=notificationsGroup, tDMChannelCableLength=tDMChannelCableLength, ptp=ptp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ptp650=ptp650, auxPortStatus=auxPortStatus, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, licenseRARSupport=licenseRARSupport, ethernetGroup=ethernetGroup, ethernetPriorityTable=ethernetPriorityTable, dataPortPauseFrames=dataPortPauseFrames, configurationGroup=configurationGroup, installStatusTrap=installStatusTrap, licenseIPv6Support=licenseIPv6Support, sNTPPollInterval=sNTPPollInterval, secondDataPortPauseFrames=secondDataPortPauseFrames, syslogStateTrap=syslogStateTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sNTPServerRetries=sNTPServerRetries, sFPPortAutoMdix=sFPPortAutoMdix, cableDiagPair1Distance=cableDiagPair1Distance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDMEnabledChannels=tDMEnabledChannels, licenseGroupAccess=licenseGroupAccess, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, auxPortAllocation=auxPortAllocation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, licenseCountry=licenseCountry, lowestDataModulationMode=lowestDataModulationMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, transparentClockPort=transparentClockPort, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, tDMChannelLoopback=tDMChannelLoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEmailAlert=sMTPEmailAlert, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, ptmp=ptmp, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair2Results=cableDiagPair2Results, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, secondDataBridgingStatus=secondDataBridgingStatus, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortAutoMdix=nIDULanPortAutoMdix, mainPSUPortQLTx=mainPSUPortQLTx, telnetPortNumber=telnetPortNumber, ptpCompliance=ptpCompliance, supplementary=supplementary, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerTable=sNTPServerTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableLoss=cableLoss, userTable=userTable, syslogControlGroup=syslogControlGroup, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkAvailability=wirelessLinkAvailability, mABHoldoffPeriod=mABHoldoffPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, nIDULanPortStatus=nIDULanPortStatus, secureModeAlarmTrap=secureModeAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syncETracking=syncETracking, secondarySoftwareVersion=secondarySoftwareVersion, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitDataRate=transmitDataRate, cableDiagPair1Results=cableDiagPair1Results, receiveDataRate=receiveDataRate, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, sNTPServerTableNumber=sNTPServerTableNumber, subbandLowestFrequency=subbandLowestFrequency, phyStatusGroup=phyStatusGroup, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, vLANManagementVID=vLANManagementVID, userTableEntry=userTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ptpTraps=ptpTraps, mABState=mABState, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, longitude=longitude, mABProtocolVLANPriority=mABProtocolVLANPriority, iPv6GatewayAddress=iPv6GatewayAddress, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv4Address=iPv4Address, linkLoss=linkLoss, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, routerProtocolsGroup=routerProtocolsGroup, altitude=altitude, resetGroup=resetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, secureModeAlarm=secureModeAlarm, sFPPortStatus=sFPPortStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, reset=reset, auxPortAcceptedQLRx=auxPortAcceptedQLRx, dataBridgingStatusAlarm=dataBridgingStatusAlarm, masterSlaveMode=masterSlaveMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, supplementaryGroup=supplementaryGroup, aggregateDataRate=aggregateDataRate, enableTransmission=enableTransmission, bridgeGroup=bridgeGroup, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, license=license, tDMChannelStatus=tDMChannelStatus, auxPortQLRx=auxPortQLRx, versionsGroup=versionsGroup, regulatoryBandTrap=regulatoryBandTrap, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cambium=cambium, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, nIDULanPortStatusTrap=nIDULanPortStatusTrap, auxPortSSMTx=auxPortSSMTx, sNTPPrimaryServer=sNTPPrimaryServer, tDMInterfaceStatus=tDMInterfaceStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, accessMethod=accessMethod, userName=userName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, useVLANForMABProtocol=useVLANForMABProtocol, licenseIEEE1588Support=licenseIEEE1588Support, sFPErrorTrap=sFPErrorTrap, extendedSpectrumScanning=extendedSpectrumScanning, installStatus=installStatus, l2CPPriorityTable=l2CPPriorityTable, channelBandwidth=channelBandwidth, vectorError=vectorError, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerStatus=sNTPServerStatus, transmitPower=transmitPower, eIRP=eIRP, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogClient=syslogClient, latitude=latitude, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNTPLastSync=sNTPLastSync, mABNominalModulationMode=mABNominalModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableNumber=dfsTableNumber, sNMPTrapTable=sNMPTrapTable, licenseSFPPortSupport=licenseSFPPortSupport, mABProtocolVID=mABProtocolVID, dfs=dfs, cableDiagPair3Results=cableDiagPair3Results)
