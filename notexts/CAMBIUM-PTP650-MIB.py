...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, supplementary=supplementary, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, installArmState=installArmState, pubStats=pubStats, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, systemClock=systemClock, sFPPortDisabledWarning=sFPPortDisabledWarning, receiveFreqMHz=receiveFreqMHz, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABHoldoffPeriod=mABHoldoffPeriod, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelBandwidth=channelBandwidth, transmitFreqMHz=transmitFreqMHz, license=license, notificationsGroup=notificationsGroup, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, portAllocationMismatch=portAllocationMismatch, secureModeAlarmTrap=secureModeAlarmTrap, linkSymmetry=linkSymmetry, sntpGroup=sntpGroup, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bridgeGroup=bridgeGroup, subbandHighestFrequency=subbandHighestFrequency, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, vLANManagementPriority=vLANManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagPair1Distance=cableDiagPair1Distance, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, sNMPPortNumber=sNMPPortNumber, licenseRARSupport=licenseRARSupport, subbandLowestFrequency=subbandLowestFrequency, latitude=latitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, rawReceivePower=rawReceivePower, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, bootVersion=bootVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseVersion=licenseVersion, userTableNumber=userTableNumber, tDMChannelLoopback=tDMChannelLoopback, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mABProtocolVLANPriority=mABProtocolVLANPriority, smtp=smtp, sFPPortQLTx=sFPPortQLTx, management=management, remoteInternetAddressType=remoteInternetAddressType, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPServerRetries=sNTPServerRetries, licenseEncryption=licenseEncryption, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, tDMInterfaceControl=tDMInterfaceControl, unitOutOfCalibration=unitOutOfCalibration, auxPortStatusTrap=auxPortStatusTrap, dfs=dfs, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortQLRx=auxPortQLRx, sFPPortAllocation=sFPPortAllocation, tDMInterfaceStatus=tDMInterfaceStatus, auxPortSyncERxStatus=auxPortSyncERxStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, syslogState=syslogState, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sNTPServerTimeout=sNTPServerTimeout, maximumTransmitPower=maximumTransmitPower, tDMChannelCableLength=tDMChannelCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sFPPortQLRx=sFPPortQLRx, licenseSecurityLevel=licenseSecurityLevel, aAAControlGroup=aAAControlGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, portAllocationMismatchTrap=portAllocationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatus=sFPPortStatus, sNTPServerTableIndex=sNTPServerTableIndex, syslogClient=syslogClient, dfsTable=dfsTable, snmpControl=snmpControl, iPv6PrefixLength=iPv6PrefixLength, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, configurationGroup=configurationGroup, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, iPv4Address=iPv4Address, frequencyVariant=frequencyVariant, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, transparentClockVID=transparentClockVID, syslogControl=syslogControl, ethernetGroup=ethernetGroup, productVariant=productVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortSSMTx=auxPortSSMTx, phyControl=phyControl, mainPSUPortStatus=mainPSUPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMGroup=tDMGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABTransmissionInterval=mABTransmissionInterval, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseSFPPortSupport=licenseSFPPortSupport, sMTPEnabledMessages=sMTPEnabledMessages, telnetPortNumber=telnetPortNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, syncETracking=syncETracking, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licenseCapacity=licenseCapacity, lowestSecondDataModulationMode=lowestSecondDataModulationMode, installStatusTrap=installStatusTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, dfsGroup=dfsGroup, aggregateDataRate=aggregateDataRate, cableDiagPair2Distance=cableDiagPair2Distance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transmitPower=transmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDMEnabledChannels=tDMEnabledChannels, licenseBandwidthCap=licenseBandwidthCap, auxPortStatus=auxPortStatus, userRole=userRole, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cambium=cambium, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, tDMConfigurationMismatch=tDMConfigurationMismatch, linkName=linkName, channelChangeTrap=channelChangeTrap, licenseGroupAccess=licenseGroupAccess, sNTPServerTableEntry=sNTPServerTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, licenseSyncESupport=licenseSyncESupport, extendedSpectrumScanning=extendedSpectrumScanning, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tdmTableNumber=tdmTableNumber, productName=productName, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transparentClock=transparentClock, sNTPServerInternetAddress=sNTPServerInternetAddress, tDDSynchronizationMode=tDDSynchronizationMode, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseMaxLinkRange=licenseMaxLinkRange, userName=userName, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortSSMTx=sFPPortSSMTx, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, dSCPManagementPriority=dSCPManagementPriority, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, cableDiagPair2Results=cableDiagPair2Results, cableDiagPair3Distance=cableDiagPair3Distance, mABState=mABState, cableDiagnosticsPorts=cableDiagnosticsPorts, cableDiagnosticsGroup=cableDiagnosticsGroup, dataBridgingStatusAlarm=dataBridgingStatusAlarm, ethernet=ethernet, licenseCountry=licenseCountry, auxPortAllocation=auxPortAllocation, groupID=groupID, auxPortQLTx=auxPortQLTx, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tDDControlGroup=tDDControlGroup, alarms=alarms, signalStrengthRatio=signalStrengthRatio, targetMACAddress=targetMACAddress, iPv6Address=iPv6Address, transparentClockPort=transparentClockPort, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, targetRange=targetRange, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagPair4Results=cableDiagPair4Results, tDMChannelStatusTrap=tDMChannelStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, range=range, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveModulationMode=receiveModulationMode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingStatus=dataBridgingStatus, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPollInterval=sNTPPollInterval, sntp=sntp, tDMChannelLineCode=tDMChannelLineCode, licenseTrialPeriod=licenseTrialPeriod, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, supplementaryGroup=supplementaryGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, mainPSUPortStatusTrap=mainPSUPortStatusTrap, daylightSaving=daylightSaving, tdmTableIndex=tdmTableIndex, mainPSUPortSSMTx=mainPSUPortSSMTx, txColorCode=txColorCode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, userTableEntry=userTableEntry, capacityVariantMismatch=capacityVariantMismatch, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, secureModeAlarm=secureModeAlarm)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", userTableIndex=userTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, receiveDataRate=receiveDataRate, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, txMABFrames=txMABFrames, qOSPriorityScheme=qOSPriorityScheme, tDDSynchronizationStatus=tDDSynchronizationStatus, tDMChannelStatus=tDMChannelStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortAcceptedQLRx=auxPortAcceptedQLRx, ptpGroups=ptpGroups, sFPError=sFPError, systemReset=systemReset, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondDataBridgingStatus=secondDataBridgingStatus, transmitDataRate=transmitDataRate, licenseIEEE1588Support=licenseIEEE1588Support, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseUnitSerialNumber=licenseUnitSerialNumber, ptmp=ptmp, smtpGroup=smtpGroup, remoteInternetAddress=remoteInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, cableDiagPair4Distance=cableDiagPair4Distance, tDM=tDM, receivePower=receivePower, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, ethernetPriorityTable=ethernetPriorityTable, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseIPv6Support=licenseIPv6Support, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, byteErrorRatio=byteErrorRatio, bridge=bridge, mABNominalTransmitCapacity=mABNominalTransmitCapacity, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPLastSync=sNTPLastSync, encryption=encryption, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, altitude=altitude, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortQLTx=mainPSUPortQLTx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkLoss=linkLoss, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sFPErrorTrap=sFPErrorTrap, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, managementGroup=managementGroup, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, longitude=longitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, nIDULanPortStatus=nIDULanPortStatus, dataPortPauseFrames=dataPortPauseFrames, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, tDDControl=tDDControl, cableDiagnostics=cableDiagnostics, routerProtocols=routerProtocols, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, cableDiagPair3Results=cableDiagPair3Results, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVID=mABProtocolVID, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, syncETrackingState=syncETrackingState, licenseIssueNumber=licenseIssueNumber, userTable=userTable, syncEEquipmentClock=syncEEquipmentClock, reset=reset, transparentClockVLAN=transparentClockVLAN, phyStatus=phyStatus, resetGroup=resetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableLoss=cableLoss, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, phyStatusGroup=phyStatusGroup, sNTPServerTableNumber=sNTPServerTableNumber, sNTPPrimaryServer=sNTPPrimaryServer, sNTPServerStatus=sNTPServerStatus, syslogControlGroup=syslogControlGroup, dataBridgingAvailability=dataBridgingAvailability, tdmTable=tdmTable, cableDiagPair1Results=cableDiagPair1Results, ethernetPriorityTableIndex=ethernetPriorityTableIndex, l2CPPriorityTableIndex=l2CPPriorityTableIndex, iPVersion=iPVersion, timeZone=timeZone, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, l2CPPriorityTable=l2CPPriorityTable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseGroup=licenseGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsWarning=cableDiagnosticsWarning, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, syslogStateTrap=syslogStateTrap, lowestDataModulationMode=lowestDataModulationMode, rxColorCode=rxColorCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagnosticsControl=cableDiagnosticsControl, alarmsGroup=alarmsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, maxLinkRangeExceeded=maxLinkRangeExceeded, enableTransmission=enableTransmission, snmpControlGroup=snmpControlGroup, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNMPEnabledTraps=sNMPEnabledTraps, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPTrapVersion=sNMPTrapVersion, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPCommunityString=sNMPCommunityString, userEnabled=userEnabled, sFPPortAutoMdix=sFPPortAutoMdix, tdmTableEntry=tdmTableEntry, configuration=configuration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortStatusTrap=nIDULanPortStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, localPacketFiltering=localPacketFiltering, transmitFreqKHz=transmitFreqKHz, sNMPTrapTable=sNMPTrapTable, ptp650=ptp650, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userPassword=userPassword, cableDiagnosticsResultTable=cableDiagnosticsResultTable, hTTPSAccessEnabled=hTTPSAccessEnabled, regulatoryBand=regulatoryBand, lowestTDMModulationMode=lowestTDMModulationMode, auxPortDisabledWarning=auxPortDisabledWarning, rangingMode=rangingMode, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNTPServerTable=sNTPServerTable, linkModeOptimization=linkModeOptimization)
