...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNTPState=sNTPState, licenseOOBManagementSupport=licenseOOBManagementSupport, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptmp=ptmp, remoteInternetAddress=remoteInternetAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sFPPortQLTx=sFPPortQLTx, iPVersion=iPVersion, gatewayIPAddress=gatewayIPAddress, auxPortDisabledWarning=auxPortDisabledWarning, searchState=searchState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControl=syslogControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseIssueNumber=licenseIssueNumber, targetRange=targetRange, iPv6GatewayAddress=iPv6GatewayAddress, iPv4Address=iPv4Address, tDMChannelStatusTrap=tDMChannelStatusTrap, encryptionGroup=encryptionGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, mainPSUPortSSMTx=mainPSUPortSSMTx, auxPortStatus=auxPortStatus, sFPPortQLRx=sFPPortQLRx, ethernet=ethernet, transmitDataRate=transmitDataRate, userRole=userRole, tdmTableEntry=tdmTableEntry, syncETrackingState=syncETrackingState, alarmsGroup=alarmsGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, auxPortStatusTrap=auxPortStatusTrap, tdmTableIndex=tdmTableIndex, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, userTable=userTable, masterSlaveMode=masterSlaveMode, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair3Distance=cableDiagPair3Distance, telnetAccessEnabled=telnetAccessEnabled, tFTPServerInternetAddressType=tFTPServerInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, aAAControl=aAAControl, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, cableDiagPair3Results=cableDiagPair3Results, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tDMChannelCableLength=tDMChannelCableLength, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDMChannelLineCode=tDMChannelLineCode, managementNetworkAccessEnabled=managementNetworkAccessEnabled, smtp=smtp, tDMInterfaceControl=tDMInterfaceControl, syncETracking=syncETracking, regulatoryBandTrap=regulatoryBandTrap, cableDiagnosticsControl=cableDiagnosticsControl, routerProtocolsGroup=routerProtocolsGroup, sFPPortStatus=sFPPortStatus, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dfsTableNumber=dfsTableNumber, oOBPriorityQueueMapping=oOBPriorityQueueMapping, lowestSecondDataModulationMode=lowestSecondDataModulationMode, receivePower=receivePower, installStatusTrap=installStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, lowestDataModulationMode=lowestDataModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, sFPErrorTrap=sFPErrorTrap, sFPPortStatusTrap=sFPPortStatusTrap, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, txMABFrames=txMABFrames, transparentClockPort=transparentClockPort, licenseBandwidthCap=licenseBandwidthCap, cableDiagPair1Results=cableDiagPair1Results, dataPortPauseFrames=dataPortPauseFrames, receiveFreqKHz=receiveFreqKHz, dataBridgingStatusAlarm=dataBridgingStatusAlarm, licenseMaxLinkRange=licenseMaxLinkRange, portAllocationMismatch=portAllocationMismatch, sFPPortAutoMdix=sFPPortAutoMdix, auxPortQLRx=auxPortQLRx, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, pubStatsGroup=pubStatsGroup, cableDiagPair4Distance=cableDiagPair4Distance, syncEEquipmentClock=syncEEquipmentClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqKHz=transmitFreqKHz, userTableNumber=userTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mABProtocolVID=mABProtocolVID, cableDiagnosticsWarning=cableDiagnosticsWarning, signalStrengthRatio=signalStrengthRatio, sntpGroup=sntpGroup, transmitPower=transmitPower, aAAControlGroup=aAAControlGroup, mABTransmissionInterval=mABTransmissionInterval, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, longitude=longitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, dataBridgingStatus=dataBridgingStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPSync=sNTPSync, qOSPriorityScheme=qOSPriorityScheme, sNTPServerRetries=sNTPServerRetries, bridgeGroup=bridgeGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cableDiagnosticsPorts=cableDiagnosticsPorts, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, systemClock=systemClock, licenseVersion=licenseVersion, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMChannelLoopback=tDMChannelLoopback, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnostics=cableDiagnostics, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subnetMask=subnetMask, auxPortAllocation=auxPortAllocation, iPv6Address=iPv6Address, hTTPSPortNumber=hTTPSPortNumber, licenseGroupAccess=licenseGroupAccess, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, userTableEntry=userTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, altitude=altitude, sFPPortAutoNegotiation=sFPPortAutoNegotiation, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, snmpControlGroup=snmpControlGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortQLTx=auxPortQLTx, tDMGroup=tDMGroup, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, managementPortWirelessDownAlert=managementPortWirelessDownAlert, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseTDDSyncSupport=licenseTDDSyncSupport, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, productName=productName, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, bridge=bridge, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, linkLoss=linkLoss, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerInternetAddress=sNTPServerInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogState=syslogState, auxPortAcceptedQLRx=auxPortAcceptedQLRx, groupID=groupID, range=range, hardwareVersion=hardwareVersion, installArmState=installArmState, telnetPortNumber=telnetPortNumber, tDMInterfaceStatus=tDMInterfaceStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, useVLANForMABProtocol=useVLANForMABProtocol, transmitModulationMode=transmitModulationMode, sntp=sntp, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, rawReceivePower=rawReceivePower, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, systemReset=systemReset, l2CPPriorityTable=l2CPPriorityTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, nIDULanPortStatus=nIDULanPortStatus, capacityVariantMismatch=capacityVariantMismatch, receiveModulationModeDetail=receiveModulationModeDetail, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, versions=versions, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sNTPPollInterval=sNTPPollInterval, iPv6PrefixLength=iPv6PrefixLength, dfs=dfs, smtpGroup=smtpGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, sNTPServerStatus=sNTPServerStatus, subbandLowestFrequency=subbandLowestFrequency, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, txColorCode=txColorCode, mABState=mABState, ptpTraps=ptpTraps, secondDataBridgingStatus=secondDataBridgingStatus, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPPortNumber=sNMPPortNumber, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, enableTransmission=enableTransmission, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, dfsTable=dfsTable, licenseEncryption=licenseEncryption, sNMPTrapPortNumber=sNMPTrapPortNumber, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, regulatoryBand=regulatoryBand, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, phyStatus=phyStatus, sNTPServerTable=sNTPServerTable, tFTPServerInternetAddress=tFTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagPair4Results=cableDiagPair4Results, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, supplementary=supplementary, managementGroup=managementGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, receiveDataRate=receiveDataRate, licenseSecurityLevel=licenseSecurityLevel, bootVersion=bootVersion, licenseCapacity=licenseCapacity, wirelessLinkStatus=wirelessLinkStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ethernetPriorityTableEntry=ethernetPriorityTableEntry, auxPortConfigurationMismatch=auxPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, ptp650=ptp650, licenseCountry=licenseCountry, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, productVariant=productVariant, installArmStateTrap=installArmStateTrap, remoteInternetAddressType=remoteInternetAddressType, cambium=cambium, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, license=license, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, hTTPPortNumber=hTTPPortNumber, secureModeAlarm=secureModeAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, rangingMode=rangingMode, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sMTPEmailAlert=sMTPEmailAlert, tDDControl=tDDControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementPriority=vLANManagementPriority, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, resetGroup=resetGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, tdmTableNumber=tdmTableNumber, linkName=linkName, mABMaintenanceLevel=mABMaintenanceLevel, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataBridgingAvailability=dataBridgingAvailability, transparentClockVID=transparentClockVID, byteErrorRatio=byteErrorRatio, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerTableIndex=sNTPServerTableIndex, phyStatusGroup=phyStatusGroup, cableDiagPair2Results=cableDiagPair2Results, targetMACAddress=targetMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, syslogStateTrap=syslogStateTrap, licenseTrialPeriod=licenseTrialPeriod, ethernetPriorityTable=ethernetPriorityTable, sFPPortDisabledWarning=sFPPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, userTableIndex=userTableIndex, licenseSyncESupport=licenseSyncESupport, secondDataPortPauseFrames=secondDataPortPauseFrames, cableDiagPair2Distance=cableDiagPair2Distance, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, routerProtocols=routerProtocols, tDDSynchronizationMode=tDDSynchronizationMode, localPacketFiltering=localPacketFiltering, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, sFPPortSyncERxStatus=sFPPortSyncERxStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, nIDULanPortStatusTrap=nIDULanPortStatusTrap, licenseIPv6Support=licenseIPv6Support, sNTPServerInternetAddressType=sNTPServerInternetAddressType, reset=reset, ptpCompliance=ptpCompliance, vectorError=vectorError, dfsGroup=dfsGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPError=sFPError, secureModeAlarmTrap=secureModeAlarmTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseIEEE1588Support=licenseIEEE1588Support, userName=userName, antennaGain=antennaGain, licenseGroup=licenseGroup, versionsGroup=versionsGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, PYSNMP_MODULE_ID=cambium, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortQLRx=mainPSUPortQLRx, ethernetGroup=ethernetGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, userPassword=userPassword, sFPPortSSMTx=sFPPortSSMTx, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, rxColorCode=rxColorCode, dfsPeaks=dfsPeaks, linkModeOptimization=linkModeOptimization, syslogClientTrap=syslogClientTrap, sNTPServerTableNumber=sNTPServerTableNumber, cableDiagPair1Distance=cableDiagPair1Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, siteName=siteName, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, management=management, latitude=latitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, transparentClock=transparentClock, syslogClient=syslogClient, tDMEnabledChannels=tDMEnabledChannels, cableLoss=cableLoss, sNTPServerTimeout=sNTPServerTimeout, channelBandwidth=channelBandwidth, auxPortSSMTx=auxPortSSMTx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryption=encryption, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, tdmTable=tdmTable, sFPPortAllocation=sFPPortAllocation, configurationGroup=configurationGroup, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, lowestTDMModulationMode=lowestTDMModulationMode, tDMConfigurationMismatch=tDMConfigurationMismatch, frequencyVariant=frequencyVariant, pubStats=pubStats, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mABNominalModulationMode=mABNominalModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, licenseRARSupport=licenseRARSupport, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sNTPLastSync=sNTPLastSync, mainPSUPortStatus=mainPSUPortStatus, supplementaryGroup=supplementaryGroup, dfsMeans=dfsMeans, noWirelessChannelAvailable=noWirelessChannelAvailable, iPDSCPPriorityTable=iPDSCPPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTable=sNMPTrapTable, incompatibleRegulatoryBands=incompatibleRegulatoryBands, transparentClockVLAN=transparentClockVLAN, installStatus=installStatus, configuration=configuration, ptpGroups=ptpGroups, daylightSaving=daylightSaving, extendedSpectrumScanning=extendedSpectrumScanning, phyControlGroup=phyControlGroup, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMChannelStatus=tDMChannelStatus, tDM=tDM, timeZone=timeZone, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sNTPServerTableEntry=sNTPServerTableEntry, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, cableDiagnosticsGroup=cableDiagnosticsGroup)
