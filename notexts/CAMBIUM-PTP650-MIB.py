...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syslogStateTrap=syslogStateTrap, transmitFreqMHz=transmitFreqMHz, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, vLANManagementVID=vLANManagementVID, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, syslogClient=syslogClient, sNMPTrapTable=sNMPTrapTable, tDM=tDM, mainPSUPortAllocation=mainPSUPortAllocation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, licenseIssueNumber=licenseIssueNumber, ethernet=ethernet, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, cableDiagnostics=cableDiagnostics, encryption=encryption, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPv6Address=iPv6Address, transparentClockPort=transparentClockPort, nIDULanPortAutoMdix=nIDULanPortAutoMdix, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, txMABFrames=txMABFrames, tDMConfigurationMismatch=tDMConfigurationMismatch, aggregateDataRate=aggregateDataRate, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, aAAControl=aAAControl, tdmTable=tdmTable, iPDSCPPriorityTable=iPDSCPPriorityTable, systemClock=systemClock, rangingMode=rangingMode, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, sNTPServerTableIndex=sNTPServerTableIndex, tDMInterfaceStatus=tDMInterfaceStatus, hTTPSPortNumber=hTTPSPortNumber, cableDiagPair1Results=cableDiagPair1Results, licenseSecurityLevel=licenseSecurityLevel, gatewayIPAddress=gatewayIPAddress, sNTPServerTimeout=sNTPServerTimeout, noWirelessChannelAvailable=noWirelessChannelAvailable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, phyStatus=phyStatus, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTableEntry=userTableEntry, sNTPServerRetries=sNTPServerRetries, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, secureModeAlarm=secureModeAlarm, subbandHighestFrequency=subbandHighestFrequency, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sFPPortQLTx=sFPPortQLTx, routerProtocolsGroup=routerProtocolsGroup, tdmTableIndex=tdmTableIndex, cableDiagPair1Distance=cableDiagPair1Distance, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, licenseIEEE1588Support=licenseIEEE1588Support, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, subnetMask=subnetMask, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sFPPortStatusTrap=sFPPortStatusTrap, l2CPPriorityTable=l2CPPriorityTable, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regulatoryBandTrap=regulatoryBandTrap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortQLTx=auxPortQLTx, resetGroup=resetGroup, licenseSFPPortSupport=licenseSFPPortSupport, syncETracking=syncETracking, transparentClockVID=transparentClockVID, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortStatusTrap=nIDULanPortStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, targetMACAddress=targetMACAddress, transmitModulationMode=transmitModulationMode, sFPError=sFPError, syslogClientTrap=syslogClientTrap, incompatibleRegulatoryBands=incompatibleRegulatoryBands, ptpTrapPrefix=ptpTrapPrefix, licenseIPv6Support=licenseIPv6Support, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapVersion=sNMPTrapVersion, transparentClock=transparentClock, remoteInternetAddress=remoteInternetAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, tFTPServerInternetAddressType=tFTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, sFPPortQLRx=sFPPortQLRx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, secondDataPortPauseFrames=secondDataPortPauseFrames, channelBandwidth=channelBandwidth, sntp=sntp, secondDataBridgingStatus=secondDataBridgingStatus, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dfsTable=dfsTable, sNTPSync=sNTPSync, sMTPServerInternetAddressType=sMTPServerInternetAddressType, groupID=groupID, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, qOSPriorityScheme=qOSPriorityScheme, licenseCountry=licenseCountry, antennaGain=antennaGain, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, receiveFreqKHz=receiveFreqKHz, phyControl=phyControl, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPv4Address=iPv4Address, sFPErrorTrap=sFPErrorTrap, smtpGroup=smtpGroup, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPCommunityString=sNMPCommunityString, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocols=routerProtocols, sFPPortDisabledWarning=sFPPortDisabledWarning, timeZone=timeZone, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, l2CPPriorityTableIndex=l2CPPriorityTableIndex, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMChannelLoopback=tDMChannelLoopback, mPLSTCPriorityTable=mPLSTCPriorityTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, l2CPPriorityTableEntry=l2CPPriorityTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableLoss=cableLoss, cableDiagPair3Results=cableDiagPair3Results, dfsMeans=dfsMeans, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, encryptionGroup=encryptionGroup, managementPortWirelessDownAlert=managementPortWirelessDownAlert, channelChangeTrap=channelChangeTrap, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, receivePower=receivePower, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, cableDiagPair4Results=cableDiagPair4Results, sNMPPortNumber=sNMPPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, linkName=linkName, cableDiagPair4Distance=cableDiagPair4Distance, license=license, searchState=searchState, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sMTPEmailAlert=sMTPEmailAlert, tFTPServerPortNumber=tFTPServerPortNumber, dfsPeaks=dfsPeaks, userPassword=userPassword, userTableNumber=userTableNumber, userTable=userTable, configuration=configuration, alarms=alarms, softwareVersion=softwareVersion, longitude=longitude, licenseBandwidthCap=licenseBandwidthCap, transparentClockVLAN=transparentClockVLAN, dataPortWirelessDownAlert=dataPortWirelessDownAlert, auxPortAllocation=auxPortAllocation, sFPPortSyncERxStatus=sFPPortSyncERxStatus, installStatus=installStatus, auxPortStatus=auxPortStatus, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sntpGroup=sntpGroup, userName=userName, licenseEncryption=licenseEncryption, dataPortPauseFrames=dataPortPauseFrames, supplementaryGroup=supplementaryGroup, syslogState=syslogState, cableDiagnosticsResultTable=cableDiagnosticsResultTable, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair3Distance=cableDiagPair3Distance, licenseGroupAccess=licenseGroupAccess, eIRP=eIRP, mainPSUPortQLRx=mainPSUPortQLRx, nIDULanPortStatus=nIDULanPortStatus, licenseOOBManagementSupport=licenseOOBManagementSupport, supplementary=supplementary, auxPortAcceptedQLRx=auxPortAcceptedQLRx, portAllocationMismatchTrap=portAllocationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, auxPortQLRx=auxPortQLRx, tDDSynchronizationMode=tDDSynchronizationMode, auxPortStatusTrap=auxPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, hardwareVersion=hardwareVersion, capacityVariantMismatch=capacityVariantMismatch, encryptionAlgorithm=encryptionAlgorithm, tDMChannelStatusTrap=tDMChannelStatusTrap, transmitFreqKHz=transmitFreqKHz, extendedSpectrumScanning=extendedSpectrumScanning, regulatoryBand=regulatoryBand, ptmp=ptmp, localPacketFiltering=localPacketFiltering, licenseRARSupport=licenseRARSupport, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dfsTableEntry=dfsTableEntry, latitude=latitude, management=management, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, ethernetPriorityTableNumber=ethernetPriorityTableNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", syncEEquipmentClock=syncEEquipmentClock, licenseUnitSerialNumber=licenseUnitSerialNumber, ptp650=ptp650, productName=productName, tDMInterfaceControl=tDMInterfaceControl, bridgeGroup=bridgeGroup, iPv6GatewayAddress=iPv6GatewayAddress, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, licenseMaxLinkRange=licenseMaxLinkRange, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagnosticsGroup=cableDiagnosticsGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sNTPServerTable=sNTPServerTable, maximumTransmitPower=maximumTransmitPower, sNMPv3Enable=sNMPv3Enable, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, hTTPPortNumber=hTTPPortNumber, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpGroups=ptpGroups, range=range, sFPPortAllocation=sFPPortAllocation, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseSyncESupport=licenseSyncESupport, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, mABHoldoffPeriod=mABHoldoffPeriod, ethernetPriorityTableEntry=ethernetPriorityTableEntry, PYSNMP_MODULE_ID=cambium, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, tDMGroup=tDMGroup, mABState=mABState, mainPSUPortQLTx=mainPSUPortQLTx, linkSymmetry=linkSymmetry, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerPortNumber=sMTPServerPortNumber, targetRange=targetRange, receiveChannel=receiveChannel, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, secureModeAlarmTrap=secureModeAlarmTrap, mABProtocolVID=mABProtocolVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, transmitPower=transmitPower, iPVersion=iPVersion, receiveModulationMode=receiveModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, pubStats=pubStats, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, receiveDataRate=receiveDataRate, txColorCode=txColorCode, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, remoteInternetAddressType=remoteInternetAddressType, sNTPPrimaryServer=sNTPPrimaryServer, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transmitDataRate=transmitDataRate, bootVersion=bootVersion, syslogControl=syslogControl, userTableIndex=userTableIndex, smtp=smtp, rxColorCode=rxColorCode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, alarmsGroup=alarmsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMChannelStatus=tDMChannelStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortSSMTx=mainPSUPortSSMTx, configurationGroup=configurationGroup, subbandLowestFrequency=subbandLowestFrequency, aAAControlGroup=aAAControlGroup, cableDiagnosticsWarning=cableDiagnosticsWarning, userRole=userRole, tDMChannelLineCode=tDMChannelLineCode, linkLoss=linkLoss, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unitOutOfCalibration=unitOutOfCalibration, dataBridgingStatus=dataBridgingStatus, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userEnabled=userEnabled, cableDiagPair2Results=cableDiagPair2Results, tDDSynchronizationStatus=tDDSynchronizationStatus, tdmTableEntry=tdmTableEntry, tDMChannelCableLength=tDMChannelCableLength, licenseGroup=licenseGroup, tdmTableNumber=tdmTableNumber, tDDControl=tDDControl, enableTransmission=enableTransmission, licenseVersion=licenseVersion, mainPSUPortStatus=mainPSUPortStatus, syncETrackingState=syncETrackingState, sFPPortSSMTx=sFPPortSSMTx, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, snmpControl=snmpControl, linkModeOptimization=linkModeOptimization, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, tDDControlGroup=tDDControlGroup, siteName=siteName, reset=reset, linkModeOptimizationMismatch=linkModeOptimizationMismatch, productVariant=productVariant, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortSSMTx=auxPortSSMTx, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, mABProtocolVLANPriority=mABProtocolVLANPriority, sNTPPollInterval=sNTPPollInterval, cableDiagnosticsControl=cableDiagnosticsControl, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, ethernetPriorityTable=ethernetPriorityTable, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, installArmState=installArmState, installArmStateTrap=installArmStateTrap, cambium=cambium, rawReceivePower=rawReceivePower, licenseTrialPeriod=licenseTrialPeriod, sNTPServerTableNumber=sNTPServerTableNumber, iPv6PrefixLength=iPv6PrefixLength, lowestTDMModulationMode=lowestTDMModulationMode, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortAutoMdix=sFPPortAutoMdix, secondarySoftwareVersion=secondarySoftwareVersion, phyStatusGroup=phyStatusGroup, portAllocationMismatch=portAllocationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mainPSUPortAutoMdix=mainPSUPortAutoMdix, mABTransmissionInterval=mABTransmissionInterval, sNTPLastSync=sNTPLastSync, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, bridge=bridge, sFPPortStatus=sFPPortStatus, versions=versions, licenseCapacity=licenseCapacity, tDMEnabledChannels=tDMEnabledChannels, dataBridgingAvailability=dataBridgingAvailability, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, mABNominalModulationMode=mABNominalModulationMode, versionsGroup=versionsGroup, accessMethod=accessMethod, sNTPServerStatus=sNTPServerStatus, mABMaintenanceLevel=mABMaintenanceLevel, transmitChannel=transmitChannel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, licenseTDDSyncSupport=licenseTDDSyncSupport, ptpCompliance=ptpCompliance)
