...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagnosticsResultTable=cableDiagnosticsResultTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortStatusTrap=mainPSUPortStatusTrap, cableDiagPair1Distance=cableDiagPair1Distance, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, linkSymmetry=linkSymmetry, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tdmTable=tdmTable, tDMEnabledChannels=tDMEnabledChannels, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDMInterfaceControl=tDMInterfaceControl, lowestTDMModulationMode=lowestTDMModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetPortNumber=telnetPortNumber, sFPPortAutoNegotiation=sFPPortAutoNegotiation, smtpGroup=smtpGroup, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, sFPPortAllocation=sFPPortAllocation, licenseIssueNumber=licenseIssueNumber, sNMPTrapTable=sNMPTrapTable, maxLinkRangeExceeded=maxLinkRangeExceeded, auxPortSyncERxStatus=auxPortSyncERxStatus, licenseEncryption=licenseEncryption, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementNetworkAccessEnabled=managementNetworkAccessEnabled, enableTransmission=enableTransmission, cambium=cambium, syncETrackingState=syncETrackingState, dataBridgingStatus=dataBridgingStatus, tDDControlGroup=tDDControlGroup, tDMChannelStatusTrap=tDMChannelStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernet=ethernet, tDDControl=tDDControl, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementGroup=managementGroup, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseCountry=licenseCountry, hardwareVersion=hardwareVersion, useVLANForMABProtocol=useVLANForMABProtocol, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerTableIndex=sNTPServerTableIndex, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, cableDiagPair3Results=cableDiagPair3Results, versionsGroup=versionsGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, sNTPLastSync=sNTPLastSync, licenseCapacity=licenseCapacity, accessMethod=accessMethod, transmitPower=transmitPower, auxPortStatusTrap=auxPortStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, receiveChannel=receiveChannel, syslogStateTrap=syslogStateTrap, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, systemClock=systemClock, tdmTableNumber=tdmTableNumber, ethernetPriorityTableIndex=ethernetPriorityTableIndex, cableDiagPair2Results=cableDiagPair2Results, tDMChannelLineCode=tDMChannelLineCode, licenseRegulatoryBandsList=licenseRegulatoryBandsList, userPassword=userPassword, incompatibleRegulatoryBands=incompatibleRegulatoryBands, dataBridgingStatusAlarm=dataBridgingStatusAlarm, aAAControlGroup=aAAControlGroup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, mABTransmissionInterval=mABTransmissionInterval, tDDSynchronizationMode=tDDSynchronizationMode, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, transparentClockVLAN=transparentClockVLAN, cableDiagnostics=cableDiagnostics, tDMChannelStatus=tDMChannelStatus, licenseIPv6Support=licenseIPv6Support, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, snmpControl=snmpControl, sNTPServerRetries=sNTPServerRetries, targetMACAddress=targetMACAddress, cableDiagPair1Results=cableDiagPair1Results, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableEntry=sNMPTrapTableEntry, phyControl=phyControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secureModeAlarmTrap=secureModeAlarmTrap, syslogState=syslogState, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, tDDSynchronizationStatus=tDDSynchronizationStatus, syncETracking=syncETracking, mainPSUPortQLRx=mainPSUPortQLRx, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseSFPPortSupport=licenseSFPPortSupport, localPacketFiltering=localPacketFiltering, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, subbandHighestFrequency=subbandHighestFrequency, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, longitude=longitude, sFPError=sFPError, mainPSUPortQLTx=mainPSUPortQLTx, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, configurationGroup=configurationGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, tDM=tDM, altitude=altitude, mABProtocolVLANPriority=mABProtocolVLANPriority, secondDataBridgingStatus=secondDataBridgingStatus, maximumTransmitPower=maximumTransmitPower, dfsTableIndex=dfsTableIndex, receiveFreqKHz=receiveFreqKHz, lowestSecondDataModulationMode=lowestSecondDataModulationMode, alarms=alarms, notificationsGroup=notificationsGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortAutoMdix=mainPSUPortAutoMdix, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPState=sNTPState, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABProtocolVID=mABProtocolVID, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, nIDULanPortStatus=nIDULanPortStatus, rangingMode=rangingMode, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortStatus=mainPSUPortStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, installArmStateTrap=installArmStateTrap, transmitModulationMode=transmitModulationMode, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, userRole=userRole, txColorCode=txColorCode, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dfsPeaks=dfsPeaks, dfsTable=dfsTable, lowestDataModulationMode=lowestDataModulationMode, licenseBandwidthCap=licenseBandwidthCap, sNTPServerInternetAddress=sNTPServerInternetAddress, transparentClock=transparentClock, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mABHoldoffPeriod=mABHoldoffPeriod, syslogControl=syslogControl, installArmState=installArmState, licenseTrialPeriod=licenseTrialPeriod, ptp650=ptp650, licenseGroupAccess=licenseGroupAccess, remoteInternetAddress=remoteInternetAddress, remoteInternetAddressType=remoteInternetAddressType, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, auxPortQLRx=auxPortQLRx, byteErrorRatio=byteErrorRatio, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortStatusTrap=sFPPortStatusTrap, aggregateDataRate=aggregateDataRate, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPTrapInternetAddress=sNMPTrapInternetAddress, installStatus=installStatus, dfsMeans=dfsMeans, subnetMask=subnetMask, capacityVariantMismatchTrap=capacityVariantMismatchTrap, regulatoryBand=regulatoryBand, dfsGroup=dfsGroup, syncEEquipmentClock=syncEEquipmentClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatus=sFPPortStatus, ptp=ptp, licenseSecurityLevel=licenseSecurityLevel, noWirelessChannelAvailable=noWirelessChannelAvailable, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, bridgeGroup=bridgeGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, iPv6PrefixLength=iPv6PrefixLength, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, transmitDataRate=transmitDataRate, versions=versions, latitude=latitude, cableDiagnosticsPorts=cableDiagnosticsPorts, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, qOSPriorityScheme=qOSPriorityScheme, resetGroup=resetGroup, productName=productName, sntpGroup=sntpGroup, dSCPManagementPriority=dSCPManagementPriority, licenseSyncESupport=licenseSyncESupport, linkLoss=linkLoss, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortDisabledWarning=auxPortDisabledWarning, auxPortConfigurationMismatch=auxPortConfigurationMismatch, management=management, tDMChannelLoopback=tDMChannelLoopback, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv4Address=iPv4Address, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bridge=bridge, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, txMABFrames=txMABFrames, vLANManagementVID=vLANManagementVID, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, ethernetGroup=ethernetGroup, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, license=license, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, auxPortStatus=auxPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, transparentClockPort=transparentClockPort, mainPSUPortAllocation=mainPSUPortAllocation, rxColorCode=rxColorCode, dfs=dfs)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", pubStatsGroup=pubStatsGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, extendedSpectrumScanning=extendedSpectrumScanning, linkModeOptimization=linkModeOptimization, userTableNumber=userTableNumber, range=range, cableLoss=cableLoss, sNTPServerTableEntry=sNTPServerTableEntry, vectorError=vectorError, phyStatus=phyStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cableDiagnosticsControl=cableDiagnosticsControl, encryptionGroup=encryptionGroup, licenseIEEE1588Support=licenseIEEE1588Support, licenseMaxLinkRange=licenseMaxLinkRange, mABNominalModulationMode=mABNominalModulationMode, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, iPVersion=iPVersion, licenseTDDSyncSupport=licenseTDDSyncSupport, hTTPAccessEnabled=hTTPAccessEnabled, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, vLANManagementPriority=vLANManagementPriority, sNTPServerStatus=sNTPServerStatus, tdmTableEntry=tdmTableEntry, transmitFreqKHz=transmitFreqKHz, sMTPEmailAlert=sMTPEmailAlert, signalStrengthRatio=signalStrengthRatio, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerTimeout=sNTPServerTimeout, transmitFreqMHz=transmitFreqMHz, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tDMChannelCableLength=tDMChannelCableLength, cableDiagPair2Distance=cableDiagPair2Distance, sNMPTrapVersion=sNMPTrapVersion, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, auxPortAcceptedQLRx=auxPortAcceptedQLRx, antennaGain=antennaGain, oOBPriorityQueueMapping=oOBPriorityQueueMapping, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, auxPortQLTx=auxPortQLTx, cableDiagnosticsWarning=cableDiagnosticsWarning, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sFPPortAutoMdix=sFPPortAutoMdix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptmp=ptmp, ethernetPriorityTable=ethernetPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSyncTrap=sNTPSyncTrap, groupID=groupID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, auxPortSSMTx=auxPortSSMTx, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sFPPortDisabledWarning=sFPPortDisabledWarning, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABState=mABState, routerProtocolsGroup=routerProtocolsGroup, aAAControl=aAAControl, bootVersion=bootVersion, dataBridgingAvailability=dataBridgingAvailability, sNTPServerInternetAddressType=sNTPServerInternetAddressType, encryptionAlgorithm=encryptionAlgorithm, l2CPPriorityTable=l2CPPriorityTable, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, ethernetPriorityTableNumber=ethernetPriorityTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tdmTableIndex=tdmTableIndex, syslogClientTrap=syslogClientTrap, configuration=configuration, licenseVersion=licenseVersion, phyStatusGroup=phyStatusGroup, cableDiagPair3Distance=cableDiagPair3Distance, secureModeAlarm=secureModeAlarm, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogControlGroup=syslogControlGroup, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, iPv6Address=iPv6Address, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, subbandLowestFrequency=subbandLowestFrequency, tDMGroup=tDMGroup, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMInterfaceStatus=tDMInterfaceStatus, gatewayIPAddress=gatewayIPAddress, auxPortAllocation=auxPortAllocation, rawReceivePower=rawReceivePower, iPv6GatewayAddress=iPv6GatewayAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPErrorTrap=sFPErrorTrap, supplementaryGroup=supplementaryGroup, sFPPortQLTx=sFPPortQLTx, cableDiagPair4Results=cableDiagPair4Results, l2CPPriorityTableIndex=l2CPPriorityTableIndex, searchState=searchState, reset=reset, alarmsGroup=alarmsGroup, sFPPortSSMTx=sFPPortSSMTx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, secondDataPortPauseFrames=secondDataPortPauseFrames, transparentClockVID=transparentClockVID, sNMPPortNumber=sNMPPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPrimaryServer=sNTPPrimaryServer, unitOutOfCalibration=unitOutOfCalibration, sNTPServerTableNumber=sNTPServerTableNumber, portAllocationMismatch=portAllocationMismatch, userTableIndex=userTableIndex, systemReset=systemReset, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, routerProtocols=routerProtocols, sFPPortQLRx=sFPPortQLRx, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, linkName=linkName, dataPortPauseFrames=dataPortPauseFrames, cableDiagPair4Distance=cableDiagPair4Distance, frequencyVariant=frequencyVariant, licenseRARSupport=licenseRARSupport, userName=userName, regulatoryBandTrap=regulatoryBandTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sMTPServerPortNumber=sMTPServerPortNumber, installStatusTrap=installStatusTrap, targetRange=targetRange, sNTPServerTable=sNTPServerTable, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, syslogClient=syslogClient, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseGroup=licenseGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, userTable=userTable, receiveModulationMode=receiveModulationMode, encryption=encryption, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, iPDSCPPriorityTable=iPDSCPPriorityTable, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelChangeTrap=channelChangeTrap, sntp=sntp, channelBandwidth=channelBandwidth, capacityVariantMismatch=capacityVariantMismatch, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, daylightSaving=daylightSaving, mABMaintenanceLevel=mABMaintenanceLevel, receivePower=receivePower)
