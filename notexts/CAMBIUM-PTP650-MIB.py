...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", eIRP=eIRP, altitude=altitude, mABProtocolVID=mABProtocolVID, subbandLowestFrequency=subbandLowestFrequency, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableDiagnosticsPorts=cableDiagnosticsPorts, userName=userName, extendedSpectrumScanning=extendedSpectrumScanning, sNTPServerInternetAddress=sNTPServerInternetAddress, pubStats=pubStats, auxPortQLTx=auxPortQLTx, cableDiagnostics=cableDiagnostics, tDMInterfaceControl=tDMInterfaceControl, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, rangingMode=rangingMode, tDMConfigurationMismatch=tDMConfigurationMismatch, iPDSCPPriorityTable=iPDSCPPriorityTable, signalStrengthRatio=signalStrengthRatio, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, ptpCompliance=ptpCompliance, regulatoryBandTrap=regulatoryBandTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, snmpControlGroup=snmpControlGroup, transmitFreqMHz=transmitFreqMHz, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, dfsTableIndex=dfsTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, txColorCode=txColorCode, sNTPSync=sNTPSync, sNTPServerTableNumber=sNTPServerTableNumber, rxColorCode=rxColorCode, regulatoryBand=regulatoryBand, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, installStatus=installStatus, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, subnetMask=subnetMask, cableDiagPair1Results=cableDiagPair1Results, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPv6PrefixLength=iPv6PrefixLength, licenseMaxLinkRange=licenseMaxLinkRange, receiveModulationMode=receiveModulationMode, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortQLRx=mainPSUPortQLRx, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, ptmp=ptmp, sNTPServerInternetAddressType=sNTPServerInternetAddressType, transparentClockPort=transparentClockPort, licenseEncryption=licenseEncryption, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDMChannelLoopback=tDMChannelLoopback, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tDM=tDM, cableDiagPair2Distance=cableDiagPair2Distance, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, managementPortWirelessDownAlert=managementPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, sMTPServerInternetAddressType=sMTPServerInternetAddressType, linkModeOptimization=linkModeOptimization, PYSNMP_MODULE_ID=cambium, unitOutOfCalibration=unitOutOfCalibration, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair1Distance=cableDiagPair1Distance, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortAllocation=sFPPortAllocation, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, cableDiagPair4Distance=cableDiagPair4Distance, dfsTableNumber=dfsTableNumber, syslogClient=syslogClient, ptp650=ptp650, tFTPServerInternetAddressType=tFTPServerInternetAddressType, alarms=alarms, reset=reset, userTableIndex=userTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, hardwareVersion=hardwareVersion, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMChannelStatus=tDMChannelStatus, tDMChannelCableLength=tDMChannelCableLength, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, managementGroup=managementGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, linkSymmetry=linkSymmetry, licenseRARSupport=licenseRARSupport, secureModeAlarm=secureModeAlarm, licenseCountry=licenseCountry, secureModeAlarmTrap=secureModeAlarmTrap, dfsTable=dfsTable, licenseSFPPortSupport=licenseSFPPortSupport, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, nIDULanPortStatus=nIDULanPortStatus, license=license, iPv6Address=iPv6Address, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, userPassword=userPassword, installArmStateTrap=installArmStateTrap, sNTPServerTable=sNTPServerTable, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mABState=mABState, maxLinkRangeExceeded=maxLinkRangeExceeded, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, searchState=searchState, mABTransmissionInterval=mABTransmissionInterval, tDMEnabledChannels=tDMEnabledChannels, dfsPeaks=dfsPeaks, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ethernetPriorityTableEntry=ethernetPriorityTableEntry, lowestDataModulationMode=lowestDataModulationMode, ethernet=ethernet, oOBPriorityQueueMapping=oOBPriorityQueueMapping, routerProtocols=routerProtocols, licenseSyncESupport=licenseSyncESupport, iPv4Address=iPv4Address, groupID=groupID, secondDataBridgingStatus=secondDataBridgingStatus, channelChangeTrap=channelChangeTrap, userTable=userTable, licenseIssueNumber=licenseIssueNumber, timeZone=timeZone, mainPSUPortSSMTx=mainPSUPortSSMTx, sFPPortDisabledWarning=sFPPortDisabledWarning, capacityVariantMismatch=capacityVariantMismatch, syncETrackingState=syncETrackingState, tFTPServerPortNumber=tFTPServerPortNumber, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, dataBridgingStatus=dataBridgingStatus, tDMInterfaceStatus=tDMInterfaceStatus, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, antennaGain=antennaGain, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, l2CPPriorityTable=l2CPPriorityTable, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, portAllocationMismatchTrap=portAllocationMismatchTrap, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, subbandHighestFrequency=subbandHighestFrequency, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, versionsGroup=versionsGroup, txMABFrames=txMABFrames, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, licenseBandwidthCap=licenseBandwidthCap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, tFTPServerInternetAddress=tFTPServerInternetAddress, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, productVariant=productVariant, mABNominalModulationMode=mABNominalModulationMode, cambium=cambium, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, dataBridgingAvailability=dataBridgingAvailability, hTTPPortNumber=hTTPPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, tDDControl=tDDControl, licenseIEEE1588Support=licenseIEEE1588Support, capacityVariantMismatchTrap=capacityVariantMismatchTrap, licenseGroupAccess=licenseGroupAccess, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, daylightSaving=daylightSaving, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tdmTable=tdmTable, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, cableDiagPair3Results=cableDiagPair3Results, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sNTPState=sNTPState, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, qOSPriorityScheme=qOSPriorityScheme, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, configurationGroup=configurationGroup, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, useVLANForMABProtocol=useVLANForMABProtocol, licenseVersion=licenseVersion, userTableEntry=userTableEntry, accessMethod=accessMethod, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, portAllocationMismatch=portAllocationMismatch, vLANManagementPriority=vLANManagementPriority, tDMGroup=tDMGroup, transparentClockVID=transparentClockVID, encryptionGroup=encryptionGroup, configuration=configuration, localPacketFiltering=localPacketFiltering, phyStatusGroup=phyStatusGroup, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, auxPortStatus=auxPortStatus, versions=versions, frequencyVariant=frequencyVariant, resetGroup=resetGroup, bootVersion=bootVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sFPErrorTrap=sFPErrorTrap, ethernetGroup=ethernetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, remoteInternetAddress=remoteInternetAddress, snmpControl=snmpControl, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, cableDiagPair3Distance=cableDiagPair3Distance, tDMChannelLineCode=tDMChannelLineCode, targetRange=targetRange, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mABHoldoffPeriod=mABHoldoffPeriod, alarmsGroup=alarmsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bridge=bridge, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mABNominalTransmitCapacity=mABNominalTransmitCapacity, cableLoss=cableLoss, mainPSUPortStatus=mainPSUPortStatus, rawReceivePower=rawReceivePower, tDDSynchronizationMode=tDDSynchronizationMode, aAAControl=aAAControl, receiveFreqKHz=receiveFreqKHz, management=management, ethernetPriorityTable=ethernetPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, licenseCapacity=licenseCapacity, userTableNumber=userTableNumber, enableTransmission=enableTransmission, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, useVLANForManagementInterfaces=useVLANForManagementInterfaces, range=range, transparentClock=transparentClock, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, licenseTrialPeriod=licenseTrialPeriod, ptp=ptp, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, sMTPServerInternetAddress=sMTPServerInternetAddress, userEnabled=userEnabled, auxPortQLRx=auxPortQLRx, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnosticsWarning=cableDiagnosticsWarning, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, hTTPSPortNumber=hTTPSPortNumber, auxPortDisabledWarning=auxPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sFPPortQLRx=sFPPortQLRx, sFPPortQLTx=sFPPortQLTx, siteName=siteName, sNTPServerTableEntry=sNTPServerTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tdmTableNumber=tdmTableNumber, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, notificationsGroup=notificationsGroup, linkName=linkName, auxPortSyncERxStatus=auxPortSyncERxStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, licenseIPv6Support=licenseIPv6Support, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, latitude=latitude, sNTPServerStatus=sNTPServerStatus, auxPortSSMTx=auxPortSSMTx, dfsGroup=dfsGroup, cableDiagnosticsControl=cableDiagnosticsControl, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerTimeout=sNTPServerTimeout, routerProtocolsGroup=routerProtocolsGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, cableDiagnosticsGroup=cableDiagnosticsGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNTPServerRetries=sNTPServerRetries, sNTPServerTableIndex=sNTPServerTableIndex, telnetPortNumber=telnetPortNumber, iPv6GatewayAddress=iPv6GatewayAddress, transmitFreqKHz=transmitFreqKHz, licenseSecurityLevel=licenseSecurityLevel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transparentClockVLAN=transparentClockVLAN, smtpGroup=smtpGroup, syslogStateTrap=syslogStateTrap, cableDiagPair2Results=cableDiagPair2Results, receiveFreqMHz=receiveFreqMHz, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, sFPPortStatus=sFPPortStatus, bridgeGroup=bridgeGroup, sFPPortStatusTrap=sFPPortStatusTrap, dfs=dfs, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, receiveDataRate=receiveDataRate, sFPPortSSMTx=sFPPortSSMTx, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, productName=productName, tdmTableIndex=tdmTableIndex, systemReset=systemReset, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sntp=sntp, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, sMTPEnabledMessages=sMTPEnabledMessages, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitChannel=transmitChannel, syncEEquipmentClock=syncEEquipmentClock, licenseTDDSyncSupport=licenseTDDSyncSupport, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair4Results=cableDiagPair4Results, sFPError=sFPError, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPVersion=iPVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, ptpTraps=ptpTraps, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, mainPSUPortQLTx=mainPSUPortQLTx, managementNetworkAccessEnabled=managementNetworkAccessEnabled, tdmTableEntry=tdmTableEntry, lowestSecondDataModulationMode=lowestSecondDataModulationMode, vectorError=vectorError, byteErrorRatio=byteErrorRatio, licenseGroup=licenseGroup, auxPortAllocation=auxPortAllocation, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, encryptionAlgorithm=encryptionAlgorithm, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, tDMChannelStatusTrap=tDMChannelStatusTrap, receiveChannel=receiveChannel, incompatibleRegulatoryBands=incompatibleRegulatoryBands, masterSlaveMode=masterSlaveMode, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteInternetAddressType=remoteInternetAddressType, auxPortStatusTrap=auxPortStatusTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, systemClock=systemClock, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syncETracking=syncETracking, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, linkLoss=linkLoss, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitDataRate=transmitDataRate, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, secondDataPortPauseFrames=secondDataPortPauseFrames, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, ptpGroups=ptpGroups, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mABMaintenanceLevel=mABMaintenanceLevel, longitude=longitude, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, encryption=encryption)
