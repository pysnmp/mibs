...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", secureModeAlarm=secureModeAlarm, sNTPPollInterval=sNTPPollInterval, mainPSUPortAutoMdix=mainPSUPortAutoMdix, subbandHighestFrequency=subbandHighestFrequency, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsGroup=cableDiagnosticsGroup, aAAControl=aAAControl, antennaGain=antennaGain, licenseIEEE1588Support=licenseIEEE1588Support, bridge=bridge, nIDULanPortStatus=nIDULanPortStatus, tDDControlGroup=tDDControlGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseVersion=licenseVersion, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, aggregateDataRate=aggregateDataRate, dataBridgingStatus=dataBridgingStatus, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userRole=userRole, sFPPortStatus=sFPPortStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, snmpControl=snmpControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, remoteInternetAddressType=remoteInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, syslogClient=syslogClient, sFPPortStatusTrap=sFPPortStatusTrap, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, eIRP=eIRP, masterSlaveMode=masterSlaveMode, iPVersion=iPVersion, rxColorCode=rxColorCode, mainPSUPortStatus=mainPSUPortStatus, regulatoryBand=regulatoryBand, transparentClockVID=transparentClockVID, sNTPServerTimeout=sNTPServerTimeout, secondDataBridgingStatus=secondDataBridgingStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, tDMChannelStatusTrap=tDMChannelStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, pubStats=pubStats, mainPSUPortAllocation=mainPSUPortAllocation, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNTPServerTableIndex=sNTPServerTableIndex, installArmStateTrap=installArmStateTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ptpGroups=ptpGroups, accessMethod=accessMethod, receiveChannel=receiveChannel, cableLoss=cableLoss, ptpTraps=ptpTraps, sMTPServerInternetAddressType=sMTPServerInternetAddressType, ethernetGroup=ethernetGroup, siteName=siteName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerPortNumber=sMTPServerPortNumber, rangingMode=rangingMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseIssueNumber=licenseIssueNumber, mainPSUPortQLRx=mainPSUPortQLRx, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, auxPortAllocation=auxPortAllocation, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, installStatusTrap=installStatusTrap, systemReset=systemReset, sNTPServerTableNumber=sNTPServerTableNumber, syncETrackingState=syncETrackingState, lowestDataModulationMode=lowestDataModulationMode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementVID=vLANManagementVID, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, cableDiagPair3Distance=cableDiagPair3Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, useVLANForMABProtocol=useVLANForMABProtocol, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortPauseFrames=dataPortPauseFrames, licenseEncryption=licenseEncryption, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, hardwareVersion=hardwareVersion, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, txMABFrames=txMABFrames, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataBridgingStatusAlarm=dataBridgingStatusAlarm, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, ptmp=ptmp, cambium=cambium, vectorError=vectorError, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortConfigurationMismatch=auxPortConfigurationMismatch, transmitPower=transmitPower, mainPSUPortQLTx=mainPSUPortQLTx, tDDControl=tDDControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, ethernet=ethernet, licenseBandwidthCap=licenseBandwidthCap, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tdmTableEntry=tdmTableEntry, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, dfsTableIndex=dfsTableIndex, sFPPortSSMTx=sFPPortSSMTx, routerProtocols=routerProtocols, sNTPServerRetries=sNTPServerRetries, iPv6GatewayAddress=iPv6GatewayAddress, ptp650=ptp650, gatewayIPAddress=gatewayIPAddress, tdmTableIndex=tdmTableIndex, sNMPv3Enable=sNMPv3Enable, frequencyVariant=frequencyVariant, userEnabled=userEnabled, cableDiagPair4Distance=cableDiagPair4Distance, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cableDiagPair2Results=cableDiagPair2Results, userTableEntry=userTableEntry, cableDiagPair3Results=cableDiagPair3Results, linkSymmetry=linkSymmetry, iPDSCPPriorityTable=iPDSCPPriorityTable, sNTPSyncTrap=sNTPSyncTrap, licenseGroupAccess=licenseGroupAccess, managementGroup=managementGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, softwareVersion=softwareVersion, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPPrimaryServer=sNTPPrimaryServer, productVariant=productVariant, dfsTableNumber=dfsTableNumber, tDM=tDM, l2CPPriorityTableEntry=l2CPPriorityTableEntry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, linkModeOptimization=linkModeOptimization, transparentClockVLAN=transparentClockVLAN, regulatoryBandTrap=regulatoryBandTrap, cableDiagnosticsPorts=cableDiagnosticsPorts, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, sNTPServerStatus=sNTPServerStatus, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, pubStatsGroup=pubStatsGroup, licenseIPv6Support=licenseIPv6Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, sFPErrorTrap=sFPErrorTrap, txColorCode=txColorCode, dfsTable=dfsTable, sNMPTrapTableIndex=sNMPTrapTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tDMChannelCableLength=tDMChannelCableLength, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogControl=syslogControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, qOSPriorityScheme=qOSPriorityScheme, cableDiagnosticsWarning=cableDiagnosticsWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenseTDDSyncSupport=licenseTDDSyncSupport, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, l2CPPriorityTable=l2CPPriorityTable, capacityVariantMismatch=capacityVariantMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, subbandLowestFrequency=subbandLowestFrequency, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, cableDiagPair2Distance=cableDiagPair2Distance, mABState=mABState, sNMPTrapTableEntry=sNMPTrapTableEntry, tDMGroup=tDMGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, incompatibleRegulatoryBands=incompatibleRegulatoryBands, sFPPortDisabledWarning=sFPPortDisabledWarning, enableTransmission=enableTransmission, mABHoldoffPeriod=mABHoldoffPeriod, remoteInternetAddress=remoteInternetAddress, sNTPServerPortNumber=sNTPServerPortNumber, mABTransmissionInterval=mABTransmissionInterval, licenseSyncESupport=licenseSyncESupport, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, wirelessLinkAvailability=wirelessLinkAvailability, mABProtocolVID=mABProtocolVID, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, transmitDataRate=transmitDataRate, tDMInterfaceControl=tDMInterfaceControl, auxPortSyncERxStatus=auxPortSyncERxStatus, transmitModulationMode=transmitModulationMode, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortAcceptedQLRx=auxPortAcceptedQLRx, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, sMTPServerInternetAddress=sMTPServerInternetAddress, cableDiagnosticsControl=cableDiagnosticsControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortAllocation=sFPPortAllocation, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNTPServerTable=sNTPServerTable, dfsGroup=dfsGroup, licenseSFPPortSupport=licenseSFPPortSupport, secureModeAlarmTrap=secureModeAlarmTrap, auxPortDisabledWarning=auxPortDisabledWarning, maxLinkRangeExceeded=maxLinkRangeExceeded, tDMInterfaceStatus=tDMInterfaceStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", aAAControlGroup=aAAControlGroup, licenseUnitSerialNumber=licenseUnitSerialNumber, management=management, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dfsTableEntry=dfsTableEntry, cableDiagPair1Results=cableDiagPair1Results, cableDiagnosticsResultTable=cableDiagnosticsResultTable, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, maximumTransmitPower=maximumTransmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseCountry=licenseCountry, iPv6Address=iPv6Address, sMTPEnabledMessages=sMTPEnabledMessages, range=range, dataBridgingAvailability=dataBridgingAvailability, systemClock=systemClock, tDMConfigurationMismatch=tDMConfigurationMismatch, bootVersion=bootVersion, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseRARSupport=licenseRARSupport, supplementary=supplementary, auxPortStatusTrap=auxPortStatusTrap, smtp=smtp, subnetMask=subnetMask, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mABNominalTransmitCapacity=mABNominalTransmitCapacity, phyStatusGroup=phyStatusGroup, auxPortQLTx=auxPortQLTx, sNMPPortNumber=sNMPPortNumber, linkName=linkName, altitude=altitude, managementPortWirelessDownAlert=managementPortWirelessDownAlert, encryption=encryption, telnetAccessEnabled=telnetAccessEnabled, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, channelBandwidth=channelBandwidth, smtpGroup=smtpGroup, capacityVariantMismatchTrap=capacityVariantMismatchTrap, secondDataPortPauseFrames=secondDataPortPauseFrames, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sFPPortQLTx=sFPPortQLTx, latitude=latitude, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, license=license, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortQLRx=auxPortQLRx, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, unitOutOfCalibration=unitOutOfCalibration, versions=versions, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sFPPortAutoNegotiation=sFPPortAutoNegotiation, sntpGroup=sntpGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syslogClientTrap=syslogClientTrap, transmitFreqMHz=transmitFreqMHz, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, tdmTableNumber=tdmTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, targetMACAddress=targetMACAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseTrialPeriod=licenseTrialPeriod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, versionsGroup=versionsGroup, groupID=groupID, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, encryptionGroup=encryptionGroup, supplementaryGroup=supplementaryGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dSCPManagementPriority=dSCPManagementPriority, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, receivePower=receivePower, transparentClockPort=transparentClockPort, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPError=sFPError, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, installArmState=installArmState, syncEEquipmentClock=syncEEquipmentClock, extendedSpectrumScanning=extendedSpectrumScanning, tDMEnabledChannels=tDMEnabledChannels, linkLoss=linkLoss, userName=userName, resetGroup=resetGroup, tDMChannelLoopback=tDMChannelLoopback, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, timeZone=timeZone, transparentClock=transparentClock, receiveFreqKHz=receiveFreqKHz, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseRegulatoryBandsList=licenseRegulatoryBandsList, tdmTable=tdmTable, tDMChannelLineCode=tDMChannelLineCode, reset=reset, userPassword=userPassword, lowestTDMModulationMode=lowestTDMModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, portAllocationMismatch=portAllocationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, auxPortSSMTx=auxPortSSMTx, targetRange=targetRange, productName=productName, lowestSecondDataModulationMode=lowestSecondDataModulationMode, syslogState=syslogState, portAllocationMismatchTrap=portAllocationMismatchTrap, iPv4Address=iPv4Address, cableDiagnostics=cableDiagnostics, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseMaxLinkRange=licenseMaxLinkRange, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mABNominalModulationMode=mABNominalModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, tDMChannelStatus=tDMChannelStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, localPacketFiltering=localPacketFiltering, sFPPortQLRx=sFPPortQLRx, sNMPCommunityString=sNMPCommunityString, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, longitude=longitude, auxPortStatus=auxPortStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, cableDiagPair4Results=cableDiagPair4Results, bridgeGroup=bridgeGroup, iPv6PrefixLength=iPv6PrefixLength, sFPPortAutoMdix=sFPPortAutoMdix, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableNumber=userTableNumber, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, rawReceivePower=rawReceivePower, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, licenseSecurityLevel=licenseSecurityLevel, receiveModulationModeDetail=receiveModulationModeDetail, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, licenseGroup=licenseGroup, alarms=alarms, routerProtocolsGroup=routerProtocolsGroup, receiveDataRate=receiveDataRate, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenseCapacity=licenseCapacity, userTableIndex=userTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, configurationGroup=configurationGroup, syncETracking=syncETracking, receiveFreqMHz=receiveFreqMHz, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz)
