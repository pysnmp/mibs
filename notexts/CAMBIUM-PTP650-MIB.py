...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", subbandHighestFrequency=subbandHighestFrequency, auxPortStatus=auxPortStatus, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, siteName=siteName, sMTPEmailAlert=sMTPEmailAlert, tFTPServerInternetAddress=tFTPServerInternetAddress, tDMChannelLineCode=tDMChannelLineCode, auxPortAllocation=auxPortAllocation, range=range, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDMGroup=tDMGroup, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, rangingMode=rangingMode, mainPSUPortQLRx=mainPSUPortQLRx, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, auxPortSSMTx=auxPortSSMTx, dataPortWirelessDownAlert=dataPortWirelessDownAlert, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, cableDiagnosticsControl=cableDiagnosticsControl, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, tDMChannelStatus=tDMChannelStatus, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, licenseCountry=licenseCountry, hTTPSAccessEnabled=hTTPSAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, syncEEquipmentClock=syncEEquipmentClock, sNTPServerTableEntry=sNTPServerTableEntry, managementNetworkAccessEnabled=managementNetworkAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, oOBPriorityQueueMapping=oOBPriorityQueueMapping, sNTPSyncTrap=sNTPSyncTrap, subbandLowestFrequency=subbandLowestFrequency, longitude=longitude, ptmp=ptmp, aggregateDataRate=aggregateDataRate, cableDiagPair2Results=cableDiagPair2Results, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDMChannelCableLength=tDMChannelCableLength, sFPError=sFPError, ethernetGroup=ethernetGroup, licenseSecurityLevel=licenseSecurityLevel, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sntp=sntp, installArmState=installArmState, managementGroup=managementGroup, pubStats=pubStats, tDMEnabledChannels=tDMEnabledChannels, remoteInternetAddress=remoteInternetAddress, nIDULanPortAutoMdix=nIDULanPortAutoMdix, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, userRole=userRole, hTTPPortNumber=hTTPPortNumber, sFPPortAutoMdix=sFPPortAutoMdix, receivePower=receivePower, linkSymmetry=linkSymmetry, snmpControl=snmpControl, alarmsGroup=alarmsGroup, mainPSUPortAutoMdix=mainPSUPortAutoMdix, sNMPTrapPortNumber=sNMPTrapPortNumber, extendedSpectrumScanning=extendedSpectrumScanning, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dataBridgingStatusAlarm=dataBridgingStatusAlarm, smtpGroup=smtpGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, cableDiagPair4Results=cableDiagPair4Results, daylightSaving=daylightSaving, iPVersion=iPVersion, auxPortStatusTrap=auxPortStatusTrap, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, rawReceivePower=rawReceivePower, dSCPManagementPriority=dSCPManagementPriority, notificationsGroup=notificationsGroup, pubStatsGroup=pubStatsGroup, mABMaintenanceLevel=mABMaintenanceLevel, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, nIDULanPortStatus=nIDULanPortStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpGroups=ptpGroups, ptp=ptp, licenseRegulatoryBandsList=licenseRegulatoryBandsList, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPPortQLTx=sFPPortQLTx, aAAControlGroup=aAAControlGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, mABTransmissionInterval=mABTransmissionInterval, sntpGroup=sntpGroup, supplementary=supplementary, tDDSynchronizationAlarm=tDDSynchronizationAlarm, signalStrengthRatio=signalStrengthRatio, cableDiagnostics=cableDiagnostics, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, cableDiagPair3Results=cableDiagPair3Results, encryptionGroup=encryptionGroup, mABState=mABState, tFTPServerPortNumber=tFTPServerPortNumber, transmitDataRate=transmitDataRate, versionsGroup=versionsGroup, sNTPLastSync=sNTPLastSync, alarms=alarms, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, qOSPriorityScheme=qOSPriorityScheme, hardwareVersion=hardwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, licenseRARSupport=licenseRARSupport, dfsTableIndex=dfsTableIndex, channelChangeTrap=channelChangeTrap, phyStatusGroup=phyStatusGroup, cableDiagPair3Distance=cableDiagPair3Distance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transparentClockPort=transparentClockPort, mainPSUPortQLTx=mainPSUPortQLTx, sMTPEnabledMessages=sMTPEnabledMessages, localPacketFiltering=localPacketFiltering, routerProtocolsGroup=routerProtocolsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerInternetAddressType=sMTPServerInternetAddressType, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, cableDiagnosticsResultTable=cableDiagnosticsResultTable, licenseEncryption=licenseEncryption, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, remoteInternetAddressType=remoteInternetAddressType, versions=versions, tdmTableNumber=tdmTableNumber, capacityVariantMismatch=capacityVariantMismatch, management=management, sNTPServerTableNumber=sNTPServerTableNumber, encryption=encryption, cableDiagPair1Distance=cableDiagPair1Distance, linkName=linkName, secondDataBridgingStatus=secondDataBridgingStatus, cableDiagPair2Distance=cableDiagPair2Distance, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tdmTable=tdmTable, tDM=tDM, cableDiagnosticsWarning=cableDiagnosticsWarning, dataPortPauseFrames=dataPortPauseFrames, syslogLocalWrappedTrap=syslogLocalWrappedTrap, auxPortQLTx=auxPortQLTx, noWirelessChannelAvailable=noWirelessChannelAvailable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licenseCapacity=licenseCapacity, userName=userName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, receiveFreqKHz=receiveFreqKHz, sFPPortStatus=sFPPortStatus, rxColorCode=rxColorCode, licenseOOBManagementSupport=licenseOOBManagementSupport, syslogClient=syslogClient, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vectorError=vectorError, regulatoryBand=regulatoryBand, receiveFreqMHz=receiveFreqMHz, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, eIRP=eIRP, cableLoss=cableLoss, sNTPPrimaryServer=sNTPPrimaryServer, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, cableDiagPair1Results=cableDiagPair1Results, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, dataBridgingStatus=dataBridgingStatus, userTableEntry=userTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, smtp=smtp, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, useVLANForMABProtocol=useVLANForMABProtocol, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, licenseIEEE1588Support=licenseIEEE1588Support, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, dfsPeaks=dfsPeaks, transmitChannel=transmitChannel, timeZone=timeZone, iPv4Address=iPv4Address, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, tDMInterfaceStatus=tDMInterfaceStatus, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, bridgeGroup=bridgeGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ethernetPriorityTable=ethernetPriorityTable, telnetPortNumber=telnetPortNumber, sFPPortQLRx=sFPPortQLRx, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, transmitPower=transmitPower, licenseUnitSerialNumber=licenseUnitSerialNumber, receiveChannel=receiveChannel, iPv6Address=iPv6Address, sFPPortSSMTx=sFPPortSSMTx, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, byteErrorRatio=byteErrorRatio, ptp650=ptp650, syslogControl=syslogControl, altitude=altitude, reset=reset, encryptionAlgorithm=encryptionAlgorithm, sNMPv3Enable=sNMPv3Enable, userTableNumber=userTableNumber, targetRange=targetRange, sMTPSourceEmailAddress=sMTPSourceEmailAddress, enableTransmission=enableTransmission, auxPortSyncERxStatus=auxPortSyncERxStatus, productName=productName, lowestTDMModulationMode=lowestTDMModulationMode, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, syslogStateTrap=syslogStateTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveModulationMode=receiveModulationMode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, gatewayIPAddress=gatewayIPAddress, installArmStateTrap=installArmStateTrap, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, tDMChannelLoopback=tDMChannelLoopback, softwareVersion=softwareVersion, txMABFrames=txMABFrames, mABProtocolVID=mABProtocolVID, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogClientTrap=syslogClientTrap, unitOutOfCalibration=unitOutOfCalibration, sNTPServerStatus=sNTPServerStatus, ethernet=ethernet, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, hTTPSPortNumber=hTTPSPortNumber)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", bridge=bridge, snmpControlGroup=snmpControlGroup, auxPortAcceptedQLRx=auxPortAcceptedQLRx, iPDSCPPriorityTable=iPDSCPPriorityTable, cambium=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, channelBandwidth=channelBandwidth, configuration=configuration, aAAControl=aAAControl, syslogState=syslogState, userEnabled=userEnabled, sNTPServerTable=sNTPServerTable, mainPSUPortStatus=mainPSUPortStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, auxPortDisabledWarning=auxPortDisabledWarning, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, frequencyVariant=frequencyVariant, tDDControlGroup=tDDControlGroup, dataBridgingAvailability=dataBridgingAvailability, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, supplementaryGroup=supplementaryGroup, ethernetPriorityTableEntry=ethernetPriorityTableEntry, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maxLinkRangeExceeded=maxLinkRangeExceeded, transmitFreqKHz=transmitFreqKHz, sMTPServerInternetAddress=sMTPServerInternetAddress, transparentClock=transparentClock, tDMConfigurationMismatch=tDMConfigurationMismatch, groupID=groupID, antennaGain=antennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sNMPTrapVersion=sNMPTrapVersion, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sFPPortStatusTrap=sFPPortStatusTrap, tDMInterfaceControl=tDMInterfaceControl, sNTPServerPortNumber=sNTPServerPortNumber, mABHoldoffPeriod=mABHoldoffPeriod, lowestSecondDataModulationMode=lowestSecondDataModulationMode, regulatoryBandTrap=regulatoryBandTrap, licenseTrialPeriod=licenseTrialPeriod, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, dfsTable=dfsTable, licenseIssueNumber=licenseIssueNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, dfsGroup=dfsGroup, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, linkLoss=linkLoss, lowestDataModulationMode=lowestDataModulationMode, mPLSTCPriorityTable=mPLSTCPriorityTable, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, sFPPortDisabledWarning=sFPPortDisabledWarning, syncETracking=syncETracking, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, sNTPSync=sNTPSync, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseSFPPortSupport=licenseSFPPortSupport, auxPortQLRx=auxPortQLRx, portAllocationMismatch=portAllocationMismatch, sNTPServerTimeout=sNTPServerTimeout, ethernetPriorityTableNumber=ethernetPriorityTableNumber, routerProtocols=routerProtocols, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, txColorCode=txColorCode, syslogControlGroup=syslogControlGroup, installStatusTrap=installStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dfsMeans=dfsMeans, transparentClockVID=transparentClockVID, licenseIPv6Support=licenseIPv6Support, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, syncETrackingState=syncETrackingState, wirelessLinkStatus=wirelessLinkStatus, tdmTableIndex=tdmTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, sMTPServerPortNumber=sMTPServerPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, license=license, sNTPServerTableIndex=sNTPServerTableIndex, cableDiagPair4Distance=cableDiagPair4Distance, iPv6PrefixLength=iPv6PrefixLength, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, portAllocationMismatchTrap=portAllocationMismatchTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyStatus=phyStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, ptpCompliance=ptpCompliance, linkModeOptimization=linkModeOptimization, mABNominalModulationMode=mABNominalModulationMode, subnetMask=subnetMask, PYSNMP_MODULE_ID=cambium, masterSlaveMode=masterSlaveMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configurationGroup=configurationGroup, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, sFPErrorTrap=sFPErrorTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, tDDControl=tDDControl, sNTPServerRetries=sNTPServerRetries, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sFPPortAllocation=sFPPortAllocation, tDDSynchronizationMode=tDDSynchronizationMode, dfs=dfs, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, managementPortWirelessDownAlert=managementPortWirelessDownAlert, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dfsTableEntry=dfsTableEntry, licenseBandwidthCap=licenseBandwidthCap, phyControl=phyControl, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNMPCommunityString=sNMPCommunityString, l2CPPriorityTable=l2CPPriorityTable, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, secureModeAlarm=secureModeAlarm, phyControlGroup=phyControlGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, systemClock=systemClock, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseVersion=licenseVersion, cableDiagnosticsGroup=cableDiagnosticsGroup, iPv6GatewayAddress=iPv6GatewayAddress, licenseSyncESupport=licenseSyncESupport, nIDULanPortStatusTrap=nIDULanPortStatusTrap, latitude=latitude, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, searchState=searchState, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseGroupAccess=licenseGroupAccess, resetGroup=resetGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTable=sNMPTrapTable, tdmTableEntry=tdmTableEntry, sNTPState=sNTPState, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secondDataPortPauseFrames=secondDataPortPauseFrames, mainPSUPortAllocation=mainPSUPortAllocation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseGroup=licenseGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableDiagnosticsPorts=cableDiagnosticsPorts)
