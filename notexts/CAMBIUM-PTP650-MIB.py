...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", cableDiagPair2Distance=cableDiagPair2Distance, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, auxPortQLRx=auxPortQLRx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, sNTPServerTimeout=sNTPServerTimeout, bootVersion=bootVersion, sNTPServerStatus=sNTPServerStatus, secondDataPortPauseFrames=secondDataPortPauseFrames, searchState=searchState, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortStatusTrap=auxPortStatusTrap, bridge=bridge, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, wirelessLinkStatus=wirelessLinkStatus, aAAControlGroup=aAAControlGroup, iPv6GatewayAddress=iPv6GatewayAddress, accessMethod=accessMethod, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, targetMACAddress=targetMACAddress, auxPortDisabledWarning=auxPortDisabledWarning, smtpGroup=smtpGroup, timeZone=timeZone, cableDiagnosticsWarning=cableDiagnosticsWarning, phyStatus=phyStatus, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseOOBManagementSupport=licenseOOBManagementSupport, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableDiagPair1Results=cableDiagPair1Results, capacityVariantMismatchTrap=capacityVariantMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, receiveDataRate=receiveDataRate, licenseIssueNumber=licenseIssueNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, cableDiagPair4Distance=cableDiagPair4Distance, auxPortSSMTx=auxPortSSMTx, mainPSUPortAllocation=mainPSUPortAllocation, masterSlaveMode=masterSlaveMode, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortSSMTx=sFPPortSSMTx, l2CPPriorityTable=l2CPPriorityTable, encryptionAlgorithm=encryptionAlgorithm, receiveFreqMHz=receiveFreqMHz, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mABProtocolVID=mABProtocolVID, aAAControl=aAAControl, linkModeOptimization=linkModeOptimization, supplementary=supplementary, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseIEEE1588Support=licenseIEEE1588Support, mABHoldoffPeriod=mABHoldoffPeriod, eIRP=eIRP, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMInterfaceControl=tDMInterfaceControl, sNTPPollInterval=sNTPPollInterval, syncETracking=syncETracking, sMTPServerPortNumber=sMTPServerPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, configurationGroup=configurationGroup, systemClock=systemClock, sNTPServerTable=sNTPServerTable, remoteInternetAddressType=remoteInternetAddressType, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, phyControl=phyControl, mABState=mABState, pubStats=pubStats, mainPSUPortStatus=mainPSUPortStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPState=sNTPState, dfs=dfs, ethernetPriorityTable=ethernetPriorityTable, channelBandwidth=channelBandwidth, management=management, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, aggregateDataRate=aggregateDataRate, receiveChannel=receiveChannel, tDMGroup=tDMGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, nIDULanPortStatus=nIDULanPortStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, alarms=alarms, productName=productName, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, txMABFrames=txMABFrames, dSCPManagementPriority=dSCPManagementPriority, userTable=userTable, maximumTransmitPower=maximumTransmitPower, mainPSUPortSSMTx=mainPSUPortSSMTx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, syncEEquipmentClock=syncEEquipmentClock, secureModeAlarmTrap=secureModeAlarmTrap, syslogControl=syslogControl, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, snmpControl=snmpControl, useVLANForMABProtocol=useVLANForMABProtocol, transparentClock=transparentClock, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseRARSupport=licenseRARSupport, sntp=sntp, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagnosticsControl=cableDiagnosticsControl, tDMChannelCableLength=tDMChannelCableLength, secondDataBridgingStatus=secondDataBridgingStatus, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, userTableIndex=userTableIndex, auxPortSyncERxStatus=auxPortSyncERxStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableIndex=dfsTableIndex, managementNetworkAccessEnabled=managementNetworkAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetRange=targetRange, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, iPVersion=iPVersion, sFPErrorTrap=sFPErrorTrap, subbandHighestFrequency=subbandHighestFrequency, tdmTableNumber=tdmTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, vectorError=vectorError, portAllocationMismatchTrap=portAllocationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, txColorCode=txColorCode, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMChannelStatus=tDMChannelStatus, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, tdmTable=tdmTable, tDMChannelStatusTrap=tDMChannelStatusTrap, mABTransmissionInterval=mABTransmissionInterval, encryptionGroup=encryptionGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationModeDetail=receiveModulationModeDetail, byteErrorRatio=byteErrorRatio, licenseSecurityLevel=licenseSecurityLevel, vLANManagementPriority=vLANManagementPriority, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsPeaks=dfsPeaks, auxPortQLTx=auxPortQLTx, userTableNumber=userTableNumber, licenseSFPPortSupport=licenseSFPPortSupport, licenseGroupAccess=licenseGroupAccess, tDMInterfaceStatus=tDMInterfaceStatus, mABNominalModulationMode=mABNominalModulationMode, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, longitude=longitude, iPv6PrefixLength=iPv6PrefixLength, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, license=license, iPv4Address=iPv4Address, sFPError=sFPError, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, versionsGroup=versionsGroup, sNTPServerRetries=sNTPServerRetries, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userEnabled=userEnabled, licenseCountry=licenseCountry, regulatoryBand=regulatoryBand, licenseBandwidthCap=licenseBandwidthCap, sNMPTrapTable=sNMPTrapTable, dataBridgingStatus=dataBridgingStatus, ptp=ptp, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sFPPortAutoMdix=sFPPortAutoMdix, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, cableDiagPair3Results=cableDiagPair3Results, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, linkName=linkName, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, channelChangeTrap=channelChangeTrap, gatewayIPAddress=gatewayIPAddress, smtp=smtp, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, maxLinkRangeExceeded=maxLinkRangeExceeded, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDDControl=tDDControl, tDMConfigurationMismatch=tDMConfigurationMismatch, auxPortStatus=auxPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, licenseGroup=licenseGroup, sNMPTrapInternetAddress=sNMPTrapInternetAddress, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, regulatoryBandTrap=regulatoryBandTrap, routerProtocols=routerProtocols, lowestTDMModulationMode=lowestTDMModulationMode, ptp650=ptp650, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, dataBridgingAvailability=dataBridgingAvailability, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, dataPortPauseFrames=dataPortPauseFrames, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cambium=cambium, auxPortAllocation=auxPortAllocation, tFTPServerPortNumber=tFTPServerPortNumber, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, receiveModulationMode=receiveModulationMode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNTPSync=sNTPSync, managementGroup=managementGroup, transmitPower=transmitPower, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, remoteInternetAddress=remoteInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", dfsTable=dfsTable, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, bridgeGroup=bridgeGroup, tDMChannelLoopback=tDMChannelLoopback, tDMEnabledChannels=tDMEnabledChannels, licenseEncryption=licenseEncryption, localPacketFiltering=localPacketFiltering, sFPPortStatusTrap=sFPPortStatusTrap, syslogStateTrap=syslogStateTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, sFPPortAllocation=sFPPortAllocation, mainPSUPortAutoMdix=mainPSUPortAutoMdix, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsPorts=cableDiagnosticsPorts, sntpGroup=sntpGroup, configuration=configuration, receiveFreqKHz=receiveFreqKHz, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, lowestSecondDataModulationMode=lowestSecondDataModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, tDMChannelLineCode=tDMChannelLineCode, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, rxColorCode=rxColorCode, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseVersion=licenseVersion, syslogState=syslogState, syslogControlGroup=syslogControlGroup, mABProtocolVLANPriority=mABProtocolVLANPriority, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, cableDiagPair4Results=cableDiagPair4Results, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sFPPortSyncERxStatus=sFPPortSyncERxStatus, telnetPortNumber=telnetPortNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, unitOutOfCalibration=unitOutOfCalibration, daylightSaving=daylightSaving, productVariant=productVariant, sFPPortAutoNegotiation=sFPPortAutoNegotiation, transparentClockPort=transparentClockPort, sNTPServerTableNumber=sNTPServerTableNumber, rawReceivePower=rawReceivePower, dfsMeans=dfsMeans, subnetMask=subnetMask, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, ptpTraps=ptpTraps, tdmTableIndex=tdmTableIndex, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortQLTx=mainPSUPortQLTx, phyStatusGroup=phyStatusGroup, transmitFreqMHz=transmitFreqMHz, rangingMode=rangingMode, lowestDataModulationMode=lowestDataModulationMode, ptpGroups=ptpGroups, syncETrackingState=syncETrackingState, softwareVersion=softwareVersion, mainPSUPortQLRx=mainPSUPortQLRx, latitude=latitude, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagPair3Distance=cableDiagPair3Distance, syslogClientTrap=syslogClientTrap, hTTPPortNumber=hTTPPortNumber, sFPPortStatus=sFPPortStatus, mainPSUPortStatusTrap=mainPSUPortStatusTrap, receivePower=receivePower, installArmState=installArmState, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagnosticsResultTable=cableDiagnosticsResultTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, range=range, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tDDControlGroup=tDDControlGroup, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPrimaryServer=sNTPPrimaryServer, transparentClockVID=transparentClockVID, sNTPServerTableIndex=sNTPServerTableIndex, sNMPTrapVersion=sNMPTrapVersion, phyControlGroup=phyControlGroup, vLANManagementVID=vLANManagementVID, userPassword=userPassword, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tdmTableEntry=tdmTableEntry, transmitChannel=transmitChannel, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, licenseMaxLinkRange=licenseMaxLinkRange, supplementaryGroup=supplementaryGroup, licenseCapacity=licenseCapacity, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocolsGroup=routerProtocolsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseSyncESupport=licenseSyncESupport, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, subbandLowestFrequency=subbandLowestFrequency, systemReset=systemReset, oOBPriorityQueueMapping=oOBPriorityQueueMapping, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, mABMaintenanceLevel=mABMaintenanceLevel, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, iPv6Address=iPv6Address, cableDiagPair2Results=cableDiagPair2Results, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, licenseTrialPeriod=licenseTrialPeriod, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, versions=versions, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, ethernet=ethernet, transmitModulationMode=transmitModulationMode, secureModeAlarm=secureModeAlarm, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPSyncTrap=sNTPSyncTrap, userName=userName, siteName=siteName, licenseUnitSerialNumber=licenseUnitSerialNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, signalStrengthRatio=signalStrengthRatio, enableTransmission=enableTransmission, transmitFreqKHz=transmitFreqKHz, hardwareVersion=hardwareVersion, installStatus=installStatus, auxPortConfigurationMismatch=auxPortConfigurationMismatch, resetGroup=resetGroup, capacityVariantMismatch=capacityVariantMismatch, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, portAllocationMismatch=portAllocationMismatch, licenseTDDSyncSupport=licenseTDDSyncSupport, sFPPortQLRx=sFPPortQLRx, dfsTableEntry=dfsTableEntry, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, tDM=tDM, cableDiagnostics=cableDiagnostics, sNMPTrapTableIndex=sNMPTrapTableIndex)
