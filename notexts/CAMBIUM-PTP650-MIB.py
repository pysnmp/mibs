...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, cableDiagPair2Results=cableDiagPair2Results, mainPSUPortAllocation=mainPSUPortAllocation, tDMInterfaceStatus=tDMInterfaceStatus, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licenseGroupAccess=licenseGroupAccess, hardwareVersion=hardwareVersion, linkSymmetry=linkSymmetry, sMTPEnabledMessages=sMTPEnabledMessages, targetRange=targetRange, ethernetPriorityTableIndex=ethernetPriorityTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, auxPortStatusTrap=auxPortStatusTrap, bridgeGroup=bridgeGroup, signalStrengthRatio=signalStrengthRatio, syncETracking=syncETracking, sFPPortStatus=sFPPortStatus, remoteInternetAddress=remoteInternetAddress, mABHoldoffPeriod=mABHoldoffPeriod, nIDULanPortStatus=nIDULanPortStatus, aAAControl=aAAControl, phyStatus=phyStatus, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, rangingMode=rangingMode, notificationsGroup=notificationsGroup, tDMChannelLoopback=tDMChannelLoopback, licenseBandwidthCap=licenseBandwidthCap, channelBandwidth=channelBandwidth, tDMChannelCableLength=tDMChannelCableLength, sMTPServerInternetAddress=sMTPServerInternetAddress, versionsGroup=versionsGroup, licenseSyncESupport=licenseSyncESupport, supplementaryGroup=supplementaryGroup, transparentClockPort=transparentClockPort, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTable=userTable, versions=versions, subnetMask=subnetMask, licenseMaxLinkRange=licenseMaxLinkRange, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mABProtocolVID=mABProtocolVID, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, tDM=tDM, tFTPServerPortNumber=tFTPServerPortNumber, txColorCode=txColorCode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, regulatoryBandTrap=regulatoryBandTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, licenseRegulatoryBandsList=licenseRegulatoryBandsList, range=range, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, iPv6Address=iPv6Address, syncETrackingState=syncETrackingState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, auxPortDisabledWarning=auxPortDisabledWarning, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, userName=userName, dfsGroup=dfsGroup, sNTPState=sNTPState, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, tdmTable=tdmTable, cableDiagnosticsControl=cableDiagnosticsControl, linkLoss=linkLoss, transmitChannel=transmitChannel, transmitModulationMode=transmitModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sFPPortAllocation=sFPPortAllocation, wirelessLinkAvailability=wirelessLinkAvailability, licenseUnitSerialNumber=licenseUnitSerialNumber, cableDiagnosticsGroup=cableDiagnosticsGroup, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAutoNegotiation=sFPPortAutoNegotiation, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mainPSUPortStatus=mainPSUPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, syslogStateTrap=syslogStateTrap, cambium=cambium, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, auxPortAllocation=auxPortAllocation, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sFPPortAutoMdix=sFPPortAutoMdix, smtpGroup=smtpGroup, cableDiagnostics=cableDiagnostics, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, mABState=mABState, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableEntry=sNMPTrapTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, licenseIssueNumber=licenseIssueNumber, secondarySoftwareVersion=secondarySoftwareVersion, tDMInterfaceControl=tDMInterfaceControl, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, sFPErrorTrap=sFPErrorTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, regulatoryBand=regulatoryBand, sNMPPortNumber=sNMPPortNumber, portAllocationMismatch=portAllocationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddressType=sMTPServerInternetAddressType, auxPortSSMTx=auxPortSSMTx, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mainPSUPortAutoMdix=mainPSUPortAutoMdix, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, mABMaintenanceLevel=mABMaintenanceLevel, subbandLowestFrequency=subbandLowestFrequency, mABNominalModulationMode=mABNominalModulationMode, accessMethod=accessMethod, reset=reset, aggregateDataRate=aggregateDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenseSFPPortSupport=licenseSFPPortSupport, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, wirelessLinkStatus=wirelessLinkStatus, mainPSUPortSSMTx=mainPSUPortSSMTx, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerTableEntry=sNTPServerTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syncEEquipmentClock=syncEEquipmentClock, management=management, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, mainPSUPortQLTx=mainPSUPortQLTx, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, receiveFreqMHz=receiveFreqMHz, linkModeOptimization=linkModeOptimization, aAAControlGroup=aAAControlGroup, receivePower=receivePower, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, rxColorCode=rxColorCode, tDMChannelStatus=tDMChannelStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, bridge=bridge, capacityVariantMismatch=capacityVariantMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseGroup=licenseGroup, sNTPServerTable=sNTPServerTable, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseCapacity=licenseCapacity, license=license, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPSync=sNTPSync, syslogClientTrap=syslogClientTrap, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mABNominalTransmitCapacity=mABNominalTransmitCapacity, licenseOOBManagementSupport=licenseOOBManagementSupport, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, alarmsGroup=alarmsGroup, qOSPriorityScheme=qOSPriorityScheme, sNTPServerStatus=sNTPServerStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, bootVersion=bootVersion, tDDControl=tDDControl, l2CPPriorityTableNumber=l2CPPriorityTableNumber, licenseIPv6Support=licenseIPv6Support, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, dfsTableNumber=dfsTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, secondDataBridgingStatus=secondDataBridgingStatus, ptpTraps=ptpTraps, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sntp=sntp, systemClock=systemClock, dataPortPauseFrames=dataPortPauseFrames, auxPortSyncERxStatus=auxPortSyncERxStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, maximumTransmitPower=maximumTransmitPower, transparentClock=transparentClock, altitude=altitude, rawReceivePower=rawReceivePower, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, tDMChannelStatusTrap=tDMChannelStatusTrap, cableDiagPair1Results=cableDiagPair1Results, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, nIDULanPortStatusTrap=nIDULanPortStatusTrap, alarms=alarms, tDMChannelLineCode=tDMChannelLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementNetworkAccessEnabled=managementNetworkAccessEnabled, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, telnetPortNumber=telnetPortNumber, userRole=userRole, licenseCountry=licenseCountry, dataBridgingAvailability=dataBridgingAvailability, cableDiagnosticsWarning=cableDiagnosticsWarning, latitude=latitude, portAllocationMismatchTrap=portAllocationMismatchTrap, vLANManagementPriority=vLANManagementPriority, tDMGroup=tDMGroup, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, phyControlGroup=phyControlGroup, sFPError=sFPError, dfsTable=dfsTable, maxLinkRangeExceeded=maxLinkRangeExceeded, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseSecurityLevel=licenseSecurityLevel, auxPortAcceptedQLRx=auxPortAcceptedQLRx, cableDiagPair3Results=cableDiagPair3Results, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tDMEnabledChannels=tDMEnabledChannels, ptpGroups=ptpGroups, transmitPower=transmitPower, syslogControl=syslogControl, routerProtocols=routerProtocols, mABTransmissionInterval=mABTransmissionInterval)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sFPPortQLTx=sFPPortQLTx, resetGroup=resetGroup, ethernet=ethernet, sNTPPrimaryServer=sNTPPrimaryServer, userTableIndex=userTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, ethernetGroup=ethernetGroup, pubStats=pubStats, lowestSecondDataModulationMode=lowestSecondDataModulationMode, supplementary=supplementary, localPacketFiltering=localPacketFiltering, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sFPPortQLRx=sFPPortQLRx, licenseTrialPeriod=licenseTrialPeriod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationMode=receiveModulationMode, ethernetPriorityTable=ethernetPriorityTable, cableDiagnosticsResultTable=cableDiagnosticsResultTable, byteErrorRatio=byteErrorRatio, useVLANForMABProtocol=useVLANForMABProtocol, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, cableDiagPair2Distance=cableDiagPair2Distance, sFPPortStatusTrap=sFPPortStatusTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, enableTransmission=enableTransmission, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, ptp650=ptp650, transmitFreqMHz=transmitFreqMHz, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, l2CPPriorityTable=l2CPPriorityTable, pubStatsGroup=pubStatsGroup, sFPPortSSMTx=sFPPortSSMTx, licenseEncryption=licenseEncryption, sNMPTrapTableIndex=sNMPTrapTableIndex, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, mABProtocolVLANPriority=mABProtocolVLANPriority, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, lowestDataModulationMode=lowestDataModulationMode, auxPortQLTx=auxPortQLTx, tDDSynchronizationStatus=tDDSynchronizationStatus, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, cableDiagPair4Distance=cableDiagPair4Distance, incompatibleRegulatoryBands=incompatibleRegulatoryBands, timeZone=timeZone, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, daylightSaving=daylightSaving, routerProtocolsGroup=routerProtocolsGroup, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, auxPortStatus=auxPortStatus, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, secureModeAlarm=secureModeAlarm, vLANManagementVID=vLANManagementVID, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, encryptionGroup=encryptionGroup, productName=productName, transmitDataRate=transmitDataRate, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, iPv4Address=iPv4Address, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControl=phyControl, transparentClockVID=transparentClockVID, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cableDiagPair4Results=cableDiagPair4Results, ethernetPriorityTableEntry=ethernetPriorityTableEntry, transparentClockVLAN=transparentClockVLAN, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerRetries=sNTPServerRetries, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, installStatus=installStatus, remoteInternetAddressType=remoteInternetAddressType, tdmTableIndex=tdmTableIndex, dfsPeaks=dfsPeaks, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, dfs=dfs, sFPPortDisabledWarning=sFPPortDisabledWarning, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, siteName=siteName, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, sNTPServerTimeout=sNTPServerTimeout, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tdmTableNumber=tdmTableNumber, ptmp=ptmp, cableLoss=cableLoss, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, smtp=smtp, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, tdmTableEntry=tdmTableEntry, dataBridgingStatusAlarm=dataBridgingStatusAlarm, mainPSUPortStatusTrap=mainPSUPortStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, cableDiagPair1Distance=cableDiagPair1Distance, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, userTableEntry=userTableEntry, dataBridgingStatus=dataBridgingStatus, syslogState=syslogState, auxPortQLRx=auxPortQLRx, cableDiagnosticsPorts=cableDiagnosticsPorts, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, subbandHighestFrequency=subbandHighestFrequency, dSCPManagementPriority=dSCPManagementPriority, encryption=encryption, systemReset=systemReset, licenseTDDSyncSupport=licenseTDDSyncSupport, userPassword=userPassword, syslogControlGroup=syslogControlGroup, licenseRARSupport=licenseRARSupport, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, secondDataPortPauseFrames=secondDataPortPauseFrames, mainPSUPortQLRx=mainPSUPortQLRx, searchState=searchState, hTTPAccessEnabled=hTTPAccessEnabled, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, cableDiagPair3Distance=cableDiagPair3Distance, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseVersion=licenseVersion, snmpControl=snmpControl, hTTPSPortNumber=hTTPSPortNumber, productVariant=productVariant, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, txMABFrames=txMABFrames, sntpGroup=sntpGroup, syslogClient=syslogClient, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, sNTPPollInterval=sNTPPollInterval, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, eIRP=eIRP, installStatusTrap=installStatusTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, iPVersion=iPVersion, configurationGroup=configurationGroup, ptp=ptp, installArmState=installArmState, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, lowestTDMModulationMode=lowestTDMModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod)
