...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, licenseUnitSerialNumber=licenseUnitSerialNumber, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveFreqMHz=receiveFreqMHz, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPv3Enable=sNMPv3Enable, licenseRARSupport=licenseRARSupport, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, smtp=smtp, secureModeAlarmTrap=secureModeAlarmTrap, nIDULanPortStatus=nIDULanPortStatus, transmitDataRate=transmitDataRate, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, ptmp=ptmp, masterSlaveMode=masterSlaveMode, mainPSUPortQLRx=mainPSUPortQLRx, receiveModulationModeDetail=receiveModulationModeDetail, licenseIEEE1588Support=licenseIEEE1588Support, userRole=userRole, tDMChannelStatus=tDMChannelStatus, capacityVariantMismatchTrap=capacityVariantMismatchTrap, sNTPServerStatus=sNTPServerStatus, userEnabled=userEnabled, syslogControl=syslogControl, regulatoryBand=regulatoryBand, tDDControl=tDDControl, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, ptp650=ptp650, siteName=siteName, iPv4Address=iPv4Address, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, phyControl=phyControl, licenseVersion=licenseVersion, userTableEntry=userTableEntry, sNMPTrapTable=sNMPTrapTable, mABNominalModulationMode=mABNominalModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, receiveDataRate=receiveDataRate, transparentClock=transparentClock, tDMChannelLineCode=tDMChannelLineCode, transparentClockVLAN=transparentClockVLAN, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseSyncESupport=licenseSyncESupport, licenseTrialPeriod=licenseTrialPeriod, tDMInterfaceStatus=tDMInterfaceStatus, pubStats=pubStats, sntpGroup=sntpGroup, ptpGroups=ptpGroups, sNTPServerInternetAddress=sNTPServerInternetAddress, licenseGroupAccess=licenseGroupAccess, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, cableDiagPair4Results=cableDiagPair4Results, sNMPPortNumber=sNMPPortNumber, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, sNTPServerTimeout=sNTPServerTimeout, cableDiagPair3Distance=cableDiagPair3Distance, alarms=alarms, sFPPortQLTx=sFPPortQLTx, userName=userName, tDMChannelLoopback=tDMChannelLoopback, phyControlGroup=phyControlGroup, bridgeGroup=bridgeGroup, tDMGroup=tDMGroup, systemClock=systemClock, syslogClient=syslogClient, subnetMask=subnetMask, receiveFreqKHz=receiveFreqKHz, installStatus=installStatus, auxPortAllocation=auxPortAllocation, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, productName=productName, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNMPTrapVersion=sNMPTrapVersion, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, softwareVersion=softwareVersion, userTable=userTable, telnetPortNumber=telnetPortNumber, licenseGroup=licenseGroup, rangingMode=rangingMode, lowestDataModulationMode=lowestDataModulationMode, vLANManagementVID=vLANManagementVID, dfsPeaks=dfsPeaks, subbandHighestFrequency=subbandHighestFrequency, dataBridgingStatus=dataBridgingStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, tdmTable=tdmTable, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, regulatoryBandTrap=regulatoryBandTrap, accessMethod=accessMethod, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, mABTransmissionInterval=mABTransmissionInterval, sNTPServerPortNumber=sNTPServerPortNumber, tDMChannelCableLength=tDMChannelCableLength, transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, managementGroup=managementGroup, auxPortSSMTx=auxPortSSMTx, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, receiveChannel=receiveChannel, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, cableDiagnosticsGroup=cableDiagnosticsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, searchState=searchState, configurationGroup=configurationGroup, sNTPServerTable=sNTPServerTable, altitude=altitude, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, dfsMeans=dfsMeans, transmitModulationMode=transmitModulationMode, cableDiagPair1Distance=cableDiagPair1Distance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, supplementary=supplementary, secondDataPortPauseFrames=secondDataPortPauseFrames, ethernet=ethernet, transmitFreqMHz=transmitFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseSFPPortSupport=licenseSFPPortSupport, lowestSecondDataModulationMode=lowestSecondDataModulationMode, tDM=tDM, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetGroup=ethernetGroup, syncETracking=syncETracking, txMABFrames=txMABFrames, bridge=bridge, userPassword=userPassword, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, cableDiagPair3Results=cableDiagPair3Results, iPDSCPPriorityTable=iPDSCPPriorityTable, secureModeAlarm=secureModeAlarm, installStatusTrap=installStatusTrap, licenseTDDSyncSupport=licenseTDDSyncSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, rawReceivePower=rawReceivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, txColorCode=txColorCode, cableDiagnosticsWarning=cableDiagnosticsWarning, latitude=latitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, mABNominalTransmitCapacity=mABNominalTransmitCapacity, encryptionGroup=encryptionGroup, auxPortSyncERxStatus=auxPortSyncERxStatus, cableDiagPair2Results=cableDiagPair2Results, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, resetGroup=resetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDMChannelStatusTrap=tDMChannelStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, localPacketFiltering=localPacketFiltering, dfsGroup=dfsGroup, remoteInternetAddress=remoteInternetAddress, license=license, sFPPortStatus=sFPPortStatus, licenseCapacity=licenseCapacity, sFPPortSyncERxStatus=sFPPortSyncERxStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, mainPSUPortStatusTrap=mainPSUPortStatusTrap, lowestTDMModulationMode=lowestTDMModulationMode, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, versionsGroup=versionsGroup, dataBridgingAvailability=dataBridgingAvailability, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortAllocation=sFPPortAllocation, rxColorCode=rxColorCode, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mainPSUPortAutoMdix=mainPSUPortAutoMdix, antennaGain=antennaGain, systemReset=systemReset, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitPower=transmitPower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, qOSPriorityScheme=qOSPriorityScheme, iPVersion=iPVersion, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetPriorityTableNumber=ethernetPriorityTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, byteErrorRatio=byteErrorRatio, syncEEquipmentClock=syncEEquipmentClock, iPv6Address=iPv6Address, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, capacityVariantMismatch=capacityVariantMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, range=range, ptp=ptp, remoteInternetAddressType=remoteInternetAddressType, licenseEncryption=licenseEncryption, dfsTableEntry=dfsTableEntry, sFPPortDisabledWarning=sFPPortDisabledWarning, dfsTable=dfsTable, sNTPState=sNTPState, mainPSUPortStatus=mainPSUPortStatus, dataPortPauseFrames=dataPortPauseFrames, ptpTrapPrefix=ptpTrapPrefix, sFPErrorTrap=sFPErrorTrap, transparentClockPort=transparentClockPort, tdmTableIndex=tdmTableIndex, licenseMaxLinkRange=licenseMaxLinkRange, hTTPPortNumber=hTTPPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tdmTableNumber=tdmTableNumber, cableDiagPair4Distance=cableDiagPair4Distance, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, snmpControlGroup=snmpControlGroup, syslogClientTrap=syslogClientTrap, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, signalStrengthRatio=signalStrengthRatio, notificationsGroup=notificationsGroup, enableTransmission=enableTransmission, mABMaintenanceLevel=mABMaintenanceLevel, installArmStateTrap=installArmStateTrap, licenseBandwidthCap=licenseBandwidthCap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, linkLoss=linkLoss, mABProtocolVID=mABProtocolVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, targetMACAddress=targetMACAddress, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sFPError=sFPError, dfs=dfs, sNTPServerTableNumber=sNTPServerTableNumber, reset=reset, extendedSpectrumScanning=extendedSpectrumScanning, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, supplementaryGroup=supplementaryGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDControlGroup=tDDControlGroup, cableDiagnostics=cableDiagnostics, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sFPPortAutoNegotiation=sFPPortAutoNegotiation, tDMConfigurationMismatch=tDMConfigurationMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, sNTPSyncTrap=sNTPSyncTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, mABState=mABState, useVLANForMABProtocol=useVLANForMABProtocol, tFTPServerInternetAddress=tFTPServerInternetAddress, dfsTableNumber=dfsTableNumber, iPv6PrefixLength=iPv6PrefixLength, sFPPortAutoMdix=sFPPortAutoMdix, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, licenseOOBManagementSupport=licenseOOBManagementSupport, mainPSUPortQLTx=mainPSUPortQLTx, daylightSaving=daylightSaving, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, portAllocationMismatchTrap=portAllocationMismatchTrap, tDMInterfaceControl=tDMInterfaceControl, transparentClockVID=transparentClockVID, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatus=phyStatus, auxPortStatusTrap=auxPortStatusTrap, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkName=linkName, cableDiagPair2Distance=cableDiagPair2Distance, eIRP=eIRP, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortStatusTrap=sFPPortStatusTrap, linkModeOptimization=linkModeOptimization, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, sntp=sntp, dfsTableIndex=dfsTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, cableLoss=cableLoss, nIDULanPortAutoMdix=nIDULanPortAutoMdix, tFTPServerInternetAddressType=tFTPServerInternetAddressType, groupID=groupID, sNTPPollInterval=sNTPPollInterval, syncETrackingState=syncETrackingState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, cambium=cambium, l2CPPriorityTable=l2CPPriorityTable, tdmTableEntry=tdmTableEntry, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, cableDiagnosticsControl=cableDiagnosticsControl, pubStatsGroup=pubStatsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerRetries=sNTPServerRetries, auxPortQLTx=auxPortQLTx, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, targetRange=targetRange, cableDiagnosticsResultTable=cableDiagnosticsResultTable, frequencyVariant=frequencyVariant, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, syslogState=syslogState, licenseIssueNumber=licenseIssueNumber, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortAllocation=mainPSUPortAllocation, routerProtocolsGroup=routerProtocolsGroup, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, bootVersion=bootVersion, tDMEnabledChannels=tDMEnabledChannels, licenseSecurityLevel=licenseSecurityLevel, licenseIPv6Support=licenseIPv6Support, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, PYSNMP_MODULE_ID=cambium, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, management=management, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkSymmetry=linkSymmetry, hardwareVersion=hardwareVersion, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseCountry=licenseCountry, smtpGroup=smtpGroup, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, longitude=longitude, auxPortQLRx=auxPortQLRx, mABProtocolVLANPriority=mABProtocolVLANPriority, receiveModulationMode=receiveModulationMode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, configuration=configuration, ptpTraps=ptpTraps, cableDiagPair1Results=cableDiagPair1Results, channelBandwidth=channelBandwidth, secondDataBridgingStatus=secondDataBridgingStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, timeZone=timeZone, sFPPortSSMTx=sFPPortSSMTx, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, routerProtocols=routerProtocols, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, subbandLowestFrequency=subbandLowestFrequency, mABHoldoffPeriod=mABHoldoffPeriod, userTableIndex=userTableIndex, portAllocationMismatch=portAllocationMismatch, auxPortStatus=auxPortStatus, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, sFPPortQLRx=sFPPortQLRx, productVariant=productVariant)
