...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", softwareVersion=softwareVersion, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, dfsGroup=dfsGroup, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, lowestDataModulationMode=lowestDataModulationMode, cableDiagPair3Distance=cableDiagPair3Distance, encryptionGroup=encryptionGroup, mABMaintenanceLevel=mABMaintenanceLevel, tDM=tDM, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, license=license, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, masterSlaveMode=masterSlaveMode, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, linkLoss=linkLoss, regulatoryBandTrap=regulatoryBandTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, pubStatsGroup=pubStatsGroup, iPv6GatewayAddress=iPv6GatewayAddress, linkName=linkName, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv6PrefixLength=iPv6PrefixLength, ptpGroups=ptpGroups, sFPPortStatus=sFPPortStatus, accessMethod=accessMethod, receiveDataRate=receiveDataRate, subbandLowestFrequency=subbandLowestFrequency, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, sNTPLastSync=sNTPLastSync, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, cableDiagPair3Results=cableDiagPair3Results, sFPErrorTrap=sFPErrorTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, syncEEquipmentClock=syncEEquipmentClock, ptpTrapPrefix=ptpTrapPrefix, remoteInternetAddressType=remoteInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, snmpControlGroup=snmpControlGroup, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rangingMode=rangingMode, installStatus=installStatus, siteName=siteName, ptpCompliance=ptpCompliance, licenseVersion=licenseVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, dfs=dfs, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mABNominalModulationMode=mABNominalModulationMode, bootVersion=bootVersion, tdmTableIndex=tdmTableIndex, transmitPower=transmitPower, sNTPPrimaryServer=sNTPPrimaryServer, subnetMask=subnetMask, iPv4Address=iPv4Address, syslogState=syslogState, tDMChannelStatus=tDMChannelStatus, vLANManagementVID=vLANManagementVID, configuration=configuration, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, smtpGroup=smtpGroup, nIDULanPortAutoMdix=nIDULanPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, licenseEncryption=licenseEncryption, mainPSUPortSSMTx=mainPSUPortSSMTx, iPv6Address=iPv6Address, secondarySoftwareVersion=secondarySoftwareVersion, userTableEntry=userTableEntry, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, secondDataBridgingStatus=secondDataBridgingStatus, dSCPManagementPriority=dSCPManagementPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, maximumTransmitPower=maximumTransmitPower, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPPortAutoMdix=sFPPortAutoMdix, productName=productName, licenseOOBManagementSupport=licenseOOBManagementSupport, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, mainPSUPortStatus=mainPSUPortStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, localPacketFiltering=localPacketFiltering, userName=userName, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, ethernetPriorityTableEntry=ethernetPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, groupID=groupID, sNMPPortNumber=sNMPPortNumber, phyControl=phyControl, oOBPriorityQueueMapping=oOBPriorityQueueMapping, receivePower=receivePower, receiveChannel=receiveChannel, transparentClockPort=transparentClockPort, lowestSecondDataModulationMode=lowestSecondDataModulationMode, extendedSpectrumScanning=extendedSpectrumScanning, txColorCode=txColorCode, searchState=searchState, systemClock=systemClock, auxPortAcceptedQLRx=auxPortAcceptedQLRx, noWirelessChannelAvailable=noWirelessChannelAvailable, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, smtp=smtp, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, dfsMeans=dfsMeans, pubStats=pubStats, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseIEEE1588Support=licenseIEEE1588Support, mABTransmissionInterval=mABTransmissionInterval, tdmTable=tdmTable, systemReset=systemReset, cableDiagPair2Distance=cableDiagPair2Distance, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortQLTx=sFPPortQLTx, remoteInternetAddress=remoteInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, sntp=sntp, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortDisabledWarning=sFPPortDisabledWarning, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, auxPortAllocation=auxPortAllocation, tDMInterfaceControl=tDMInterfaceControl, subbandHighestFrequency=subbandHighestFrequency, cableDiagPair4Results=cableDiagPair4Results, sNTPServerInternetAddress=sNTPServerInternetAddress, sFPPortAutoNegotiation=sFPPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, aAAControlGroup=aAAControlGroup, auxPortConfigurationMismatch=auxPortConfigurationMismatch, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, licenseSecurityLevel=licenseSecurityLevel, licenseIssueNumber=licenseIssueNumber, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sFPPortQLRx=sFPPortQLRx, cableDiagPair1Results=cableDiagPair1Results, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, mainPSUPortQLRx=mainPSUPortQLRx, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, auxPortSSMTx=auxPortSSMTx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, licenseGroup=licenseGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, bridge=bridge, licenseRARSupport=licenseRARSupport, userEnabled=userEnabled, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, mABState=mABState, cableDiagPair2Results=cableDiagPair2Results, userTableIndex=userTableIndex, gatewayIPAddress=gatewayIPAddress, secondDataPortPauseFrames=secondDataPortPauseFrames, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, qOSPriorityScheme=qOSPriorityScheme, productVariant=productVariant, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseMaxLinkRange=licenseMaxLinkRange, mainPSUPortAllocation=mainPSUPortAllocation, nIDULanPortStatus=nIDULanPortStatus, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, transmitFreqKHz=transmitFreqKHz, iPVersion=iPVersion, linkModeOptimization=linkModeOptimization, ethernetPriorityTable=ethernetPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, hTTPSPortNumber=hTTPSPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, transparentClockVID=transparentClockVID, phyStatusGroup=phyStatusGroup, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, tDDSynchronizationStatus=tDDSynchronizationStatus, targetRange=targetRange, syslogControl=syslogControl, notificationsGroup=notificationsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, userTable=userTable, syslogControlGroup=syslogControlGroup, lowestTDMModulationMode=lowestTDMModulationMode, transmitChannel=transmitChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, resetGroup=resetGroup, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rawReceivePower=rawReceivePower, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, cableDiagnosticsResultTable=cableDiagnosticsResultTable, routerProtocols=routerProtocols, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, licenseGroupAccess=licenseGroupAccess, sMTPServerInternetAddress=sMTPServerInternetAddress, tDMGroup=tDMGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sNTPServerTable=sNTPServerTable, cableDiagPair4Distance=cableDiagPair4Distance, secureModeAlarmTrap=secureModeAlarmTrap, auxPortQLTx=auxPortQLTx, routerProtocolsGroup=routerProtocolsGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, range=range, sNMPTrapVersion=sNMPTrapVersion, mainPSUPortAutoMdix=mainPSUPortAutoMdix, regulatoryBand=regulatoryBand, hTTPPortNumber=hTTPPortNumber, vectorError=vectorError, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, frequencyVariant=frequencyVariant, dataPortPauseFrames=dataPortPauseFrames, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDDControlGroup=tDDControlGroup, auxPortStatusTrap=auxPortStatusTrap, tDMInterfaceStatus=tDMInterfaceStatus)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, auxPortQLRx=auxPortQLRx, daylightSaving=daylightSaving, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, sFPError=sFPError, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, licenseTDDSyncSupport=licenseTDDSyncSupport, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, portAllocationMismatch=portAllocationMismatch, tdmTableNumber=tdmTableNumber, versions=versions, managementGroup=managementGroup, useVLANForMABProtocol=useVLANForMABProtocol, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernet=ethernet, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, supplementaryGroup=supplementaryGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, licenseSyncESupport=licenseSyncESupport, signalStrengthRatio=signalStrengthRatio, iPDSCPPriorityTable=iPDSCPPriorityTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, alarms=alarms, auxPortStatus=auxPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, ptpTraps=ptpTraps, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, tDMChannelLineCode=tDMChannelLineCode, ptmp=ptmp, telnetPortNumber=telnetPortNumber, licenseBandwidthCap=licenseBandwidthCap, vLANManagementPriority=vLANManagementPriority, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortQLTx=mainPSUPortQLTx, cambium=cambium, tDMChannelLoopback=tDMChannelLoopback, transparentClockVLAN=transparentClockVLAN, licenseSFPPortSupport=licenseSFPPortSupport, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, phyStatus=phyStatus, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, capacityVariantMismatchTrap=capacityVariantMismatchTrap, dataBridgingStatusAlarm=dataBridgingStatusAlarm, targetMACAddress=targetMACAddress, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, dataBridgingStatus=dataBridgingStatus, enableTransmission=enableTransmission, aAAControl=aAAControl, mABProtocolVLANPriority=mABProtocolVLANPriority, nIDULanPortStatusTrap=nIDULanPortStatusTrap, userPassword=userPassword, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, licenseTrialPeriod=licenseTrialPeriod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseIPv6Support=licenseIPv6Support, rxColorCode=rxColorCode, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, ethernetPriorityTableIndex=ethernetPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, longitude=longitude, snmpControl=snmpControl, cableDiagPair1Distance=cableDiagPair1Distance, sFPPortStatusTrap=sFPPortStatusTrap, bridgeGroup=bridgeGroup, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogClient=syslogClient, sNTPServerRetries=sNTPServerRetries, ptp650=ptp650, installArmState=installArmState, sFPPortSSMTx=sFPPortSSMTx, sNMPTrapTableIndex=sNMPTrapTableIndex, sFPPortAllocation=sFPPortAllocation, aggregateDataRate=aggregateDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseCountry=licenseCountry, channelChangeTrap=channelChangeTrap, sMTPEmailAlert=sMTPEmailAlert, encryption=encryption, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, cableDiagnostics=cableDiagnostics, antennaGain=antennaGain, sNTPSync=sNTPSync, installArmStateTrap=installArmStateTrap, transparentClock=transparentClock, tDMChannelCableLength=tDMChannelCableLength, receiveModulationModeDetail=receiveModulationModeDetail, tDMEnabledChannels=tDMEnabledChannels, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsPeaks=dfsPeaks, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNMPCommunityString=sNMPCommunityString, dfsTableNumber=dfsTableNumber, managementNetworkAccessEnabled=managementNetworkAccessEnabled, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, maxLinkRangeExceeded=maxLinkRangeExceeded, licenseCapacity=licenseCapacity, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, management=management, tDMConfigurationMismatch=tDMConfigurationMismatch, tdmTableEntry=tdmTableEntry, syncETrackingState=syncETrackingState, auxPortSyncERxStatus=auxPortSyncERxStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, dfsTableIndex=dfsTableIndex, capacityVariantMismatch=capacityVariantMismatch, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPollInterval=sNTPPollInterval, ethernetPriorityTableNumber=ethernetPriorityTableNumber, secureModeAlarm=secureModeAlarm, auxPortDisabledWarning=auxPortDisabledWarning, mABProtocolVID=mABProtocolVID, txMABFrames=txMABFrames, managementPortWirelessDownAlert=managementPortWirelessDownAlert, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, userRole=userRole, cableDiagnosticsWarning=cableDiagnosticsWarning, sMTPServerPortNumber=sMTPServerPortNumber, reset=reset, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerStatus=sNTPServerStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, mABHoldoffPeriod=mABHoldoffPeriod, mPLSTCPriorityTable=mPLSTCPriorityTable, cableLoss=cableLoss, transmitDataRate=transmitDataRate, sNTPServerTimeout=sNTPServerTimeout, tDDControl=tDDControl, syncETracking=syncETracking, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, userTableNumber=userTableNumber, byteErrorRatio=byteErrorRatio)
