...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", hTTPAccessEnabled=hTTPAccessEnabled, licenseTDDSyncSupport=licenseTDDSyncSupport, mABNominalTransmitCapacity=mABNominalTransmitCapacity, sntp=sntp, phyControl=phyControl, tDDSynchronizationStatus=tDDSynchronizationStatus, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortDisabledWarning=auxPortDisabledWarning, dataBridgingStatusAlarm=dataBridgingStatusAlarm, timeZone=timeZone, phyStatus=phyStatus, managementGroup=managementGroup, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, mainPSUPortAutoMdix=mainPSUPortAutoMdix, lowestTDMModulationMode=lowestTDMModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vectorError=vectorError, licenseGroup=licenseGroup, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, userTableIndex=userTableIndex, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, licenseSecurityLevel=licenseSecurityLevel, unitOutOfCalibration=unitOutOfCalibration, auxPortStatusTrap=auxPortStatusTrap, tDMInterfaceControl=tDMInterfaceControl, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, transmitPower=transmitPower, phyControlGroup=phyControlGroup, systemClock=systemClock, iPv4Address=iPv4Address, l2CPPriorityTableEntry=l2CPPriorityTableEntry, tdmTableNumber=tdmTableNumber, transmitFreqKHz=transmitFreqKHz, productName=productName, pubStats=pubStats, licenseGroupAccess=licenseGroupAccess, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDMChannelStatus=tDMChannelStatus, auxPortAllocation=auxPortAllocation, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, oOBPriorityQueueMapping=oOBPriorityQueueMapping, cableDiagPair1Results=cableDiagPair1Results, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, licenseSyncESupport=licenseSyncESupport, ethernetPriorityTable=ethernetPriorityTable, receiveModulationMode=receiveModulationMode, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, longitude=longitude, capacityVariantMismatchTrap=capacityVariantMismatchTrap, antennaGain=antennaGain, mABMaintenanceLevel=mABMaintenanceLevel, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, nIDULanPortStatus=nIDULanPortStatus, sNTPServerTable=sNTPServerTable, ethernet=ethernet, managementPortWirelessDownAlert=managementPortWirelessDownAlert, subnetMask=subnetMask, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, portAllocationMismatch=portAllocationMismatch, receiveFreqMHz=receiveFreqMHz, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, range=range, pubStatsGroup=pubStatsGroup, tDM=tDM, licenseEncryption=licenseEncryption, userRole=userRole, sNMPTrapTableIndex=sNMPTrapTableIndex, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, configurationGroup=configurationGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseIEEE1588Support=licenseIEEE1588Support, dfsTable=dfsTable, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transparentClockVID=transparentClockVID, sFPPortQLTx=sFPPortQLTx, versionsGroup=versionsGroup, transparentClockVLAN=transparentClockVLAN, licenseVersion=licenseVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableDiagnosticsControl=cableDiagnosticsControl, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, mABNominalModulationMode=mABNominalModulationMode, licenseCapacity=licenseCapacity, installArmStateTrap=installArmStateTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, sFPPortSSMTx=sFPPortSSMTx, maximumTransmitPower=maximumTransmitPower, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, tDDControlGroup=tDDControlGroup, l2CPPriorityTableNumber=l2CPPriorityTableNumber, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, auxPortStatus=auxPortStatus, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, ptmp=ptmp, transmitFreqMHz=transmitFreqMHz, ptp650=ptp650, remoteInternetAddressType=remoteInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMChannelStatusTrap=tDMChannelStatusTrap, licenseIssueNumber=licenseIssueNumber, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, auxPortQLTx=auxPortQLTx, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, byteErrorRatio=byteErrorRatio, syslogState=syslogState, auxPortConfigurationMismatch=auxPortConfigurationMismatch, altitude=altitude, PYSNMP_MODULE_ID=cambium, tDMChannelLoopback=tDMChannelLoopback, softwareVersion=softwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sntpGroup=sntpGroup, reset=reset, userTableEntry=userTableEntry, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, sNTPSync=sNTPSync, sFPPortDisabledWarning=sFPPortDisabledWarning, licenseBandwidthCap=licenseBandwidthCap, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, receiveFreqKHz=receiveFreqKHz, tdmTableIndex=tdmTableIndex, dataPortPauseFrames=dataPortPauseFrames, iPv6GatewayAddress=iPv6GatewayAddress, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, mainPSUPortStatus=mainPSUPortStatus, smtp=smtp, transmitModulationMode=transmitModulationMode, eIRP=eIRP, regulatoryBandTrap=regulatoryBandTrap, masterSlaveMode=masterSlaveMode, license=license, iPv6PrefixLength=iPv6PrefixLength, userEnabled=userEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, channelChangeTrap=channelChangeTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, tdmTable=tdmTable, licenseRegulatoryBandsList=licenseRegulatoryBandsList, mABState=mABState, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, cableDiagPair2Results=cableDiagPair2Results, sNMPCommunityString=sNMPCommunityString, auxPortSSMTx=auxPortSSMTx, transparentClock=transparentClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secondarySoftwareVersion=secondarySoftwareVersion, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagnosticsPorts=cableDiagnosticsPorts, snmpControl=snmpControl, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTimeout=sNTPServerTimeout, ptp=ptp, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, mainPSUPortQLTx=mainPSUPortQLTx, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mABProtocolVID=mABProtocolVID, cableDiagPair4Distance=cableDiagPair4Distance, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, mABTransmissionInterval=mABTransmissionInterval, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDMInterfaceStatus=tDMInterfaceStatus, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, channelBandwidth=channelBandwidth, auxPortSyncERxStatus=auxPortSyncERxStatus, vLANManagementVID=vLANManagementVID, alarms=alarms, aAAControl=aAAControl, routerProtocolsGroup=routerProtocolsGroup, tDMEnabledChannels=tDMEnabledChannels, sNTPState=sNTPState, signalStrengthRatio=signalStrengthRatio, sNTPPrimaryServer=sNTPPrimaryServer, syslogClientTrap=syslogClientTrap, tdmTableEntry=tdmTableEntry, gatewayIPAddress=gatewayIPAddress, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, licenseMaxLinkRange=licenseMaxLinkRange, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, sNTPSyncTrap=sNTPSyncTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, tDMChannelLineCode=tDMChannelLineCode, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, ptpTrapPrefix=ptpTrapPrefix, tDMChannelCableLength=tDMChannelCableLength, sFPPortSyncERxStatus=sFPPortSyncERxStatus, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, nIDULanPortStatusTrap=nIDULanPortStatusTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, userTableNumber=userTableNumber, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, remoteInternetAddress=remoteInternetAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, targetRange=targetRange, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, sNMPTrapVersion=sNMPTrapVersion, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, userName=userName, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpCompliance=ptpCompliance, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, incompatibleRegulatoryBands=incompatibleRegulatoryBands, tFTPServerInternetAddressType=tFTPServerInternetAddressType, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, receivePower=receivePower, hardwareVersion=hardwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sMTPServerInternetAddressType=sMTPServerInternetAddressType, managementNetworkAccessEnabled=managementNetworkAccessEnabled, latitude=latitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, licenseSFPPortSupport=licenseSFPPortSupport, bridge=bridge, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, syncETrackingState=syncETrackingState, mABProtocolVLANPriority=mABProtocolVLANPriority, tFTPServerPortNumber=tFTPServerPortNumber, iPVersion=iPVersion, secureModeAlarm=secureModeAlarm, transparentClockPort=transparentClockPort, licenseCountry=licenseCountry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, lowestDataModulationMode=lowestDataModulationMode, sFPPortQLRx=sFPPortQLRx, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, licenseUnitSerialNumber=licenseUnitSerialNumber, sNMPv3Enable=sNMPv3Enable, syncEEquipmentClock=syncEEquipmentClock, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, configuration=configuration, aAAControlGroup=aAAControlGroup, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tDDControl=tDDControl, l2CPPriorityTable=l2CPPriorityTable, iPv6Address=iPv6Address, cableDiagPair3Results=cableDiagPair3Results, vLANManagementPriority=vLANManagementPriority, sNTPServerTableIndex=sNTPServerTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, auxPortQLRx=auxPortQLRx, sNMPTrapTableEntry=sNMPTrapTableEntry, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, cableLoss=cableLoss, sNTPServerTableEntry=sNTPServerTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, syncETracking=syncETracking, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installStatus=installStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, dfsTableNumber=dfsTableNumber, tDMConfigurationMismatch=tDMConfigurationMismatch, sFPPortAllocation=sFPPortAllocation, sFPPortStatusTrap=sFPPortStatusTrap, cableDiagnostics=cableDiagnostics, dfsPeaks=dfsPeaks, smtpGroup=smtpGroup, secondDataBridgingStatus=secondDataBridgingStatus, dfsGroup=dfsGroup, rawReceivePower=rawReceivePower, sNTPServerTableNumber=sNTPServerTableNumber, mainPSUPortAllocation=mainPSUPortAllocation, resetGroup=resetGroup, userTable=userTable, txMABFrames=txMABFrames, productVariant=productVariant, management=management, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, regulatoryBand=regulatoryBand, dSCPManagementPriority=dSCPManagementPriority, tDMGroup=tDMGroup, ethernetPriorityTableNumber=ethernetPriorityTableNumber, accessMethod=accessMethod, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, receiveModulationModeDetail=receiveModulationModeDetail, syslogControl=syslogControl, mainPSUPortSSMTx=mainPSUPortSSMTx, mABHoldoffPeriod=mABHoldoffPeriod, supplementary=supplementary, ptpGroups=ptpGroups, licenseTrialPeriod=licenseTrialPeriod, qOSPriorityScheme=qOSPriorityScheme, subbandHighestFrequency=subbandHighestFrequency, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, dataBridgingAvailability=dataBridgingAvailability, mainPSUPortQLRx=mainPSUPortQLRx, receiveDataRate=receiveDataRate, sNTPServerStatus=sNTPServerStatus, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, cableDiagPair3Distance=cableDiagPair3Distance, secondDataPortPauseFrames=secondDataPortPauseFrames, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerRetries=sNTPServerRetries, licenseIPv6Support=licenseIPv6Support, versions=versions, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, secureModeAlarmTrap=secureModeAlarmTrap, routerProtocols=routerProtocols, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPollInterval=sNTPPollInterval, cableDiagPair1Distance=cableDiagPair1Distance, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, systemReset=systemReset, sFPPortStatus=sFPPortStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, syslogClient=syslogClient, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, bootVersion=bootVersion, frequencyVariant=frequencyVariant, localPacketFiltering=localPacketFiltering, siteName=siteName, sFPPortAutoNegotiation=sFPPortAutoNegotiation, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSPortNumber=hTTPSPortNumber, subbandLowestFrequency=subbandLowestFrequency, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, linkModeOptimization=linkModeOptimization, cableDiagPair2Distance=cableDiagPair2Distance, enableTransmission=enableTransmission, dataBridgingStatus=dataBridgingStatus, syslogControlGroup=syslogControlGroup, maxLinkRangeExceeded=maxLinkRangeExceeded, userPassword=userPassword, dfsMeans=dfsMeans, bridgeGroup=bridgeGroup, sMTPEnabledMessages=sMTPEnabledMessages, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, telnetPortNumber=telnetPortNumber, rangingMode=rangingMode, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, searchState=searchState, sFPErrorTrap=sFPErrorTrap, cableDiagnosticsWarning=cableDiagnosticsWarning, rxColorCode=rxColorCode, installStatusTrap=installStatusTrap, sFPPortAutoMdix=sFPPortAutoMdix, sFPError=sFPError, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveChannel=receiveChannel, txColorCode=txColorCode, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, dfs=dfs, cableDiagPair4Results=cableDiagPair4Results, capacityVariantMismatch=capacityVariantMismatch, daylightSaving=daylightSaving, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, iPDSCPPriorityTable=iPDSCPPriorityTable, licenseRARSupport=licenseRARSupport, cableDiagnosticsResultTable=cableDiagnosticsResultTable)
