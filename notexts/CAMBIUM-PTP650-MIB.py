...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", tDMChannelLineCode=tDMChannelLineCode, sNMPTrapInternetAddress=sNMPTrapInternetAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, ptmp=ptmp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, sNTPServerInternetAddress=sNTPServerInternetAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerTableIndex=sNTPServerTableIndex, linkLoss=linkLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerRetries=sNTPServerRetries, syncEEquipmentClock=syncEEquipmentClock, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, targetRange=targetRange, licenseBandwidthCap=licenseBandwidthCap, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, transparentClockPort=transparentClockPort, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configurationGroup=configurationGroup, sNMPPortNumber=sNMPPortNumber, sNTPServerStatus=sNTPServerStatus, sFPPortStatusTrap=sFPPortStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNMPCommunityString=sNMPCommunityString, installArmStateTrap=installArmStateTrap, mABProtocolVID=mABProtocolVID, mABMaintenanceLevel=mABMaintenanceLevel, byteErrorRatio=byteErrorRatio, linkSymmetry=linkSymmetry, transmitPower=transmitPower, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, mainPSUPortAutoMdix=mainPSUPortAutoMdix, daylightSaving=daylightSaving, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortAllocation=sFPPortAllocation, productVariant=productVariant, l2CPPriorityTableEntry=l2CPPriorityTableEntry, versions=versions, dataBridgingAvailability=dataBridgingAvailability, remoteInternetAddressType=remoteInternetAddressType, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, targetMACAddress=targetMACAddress, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpGroups=ptpGroups, license=license, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, licenseGroup=licenseGroup, oOBPriorityQueueMapping=oOBPriorityQueueMapping, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, auxPortConfigurationMismatch=auxPortConfigurationMismatch, auxPortStatusTrap=auxPortStatusTrap, encryptionGroup=encryptionGroup, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClock=transparentClock, vLANManagementVID=vLANManagementVID, tDDControlGroup=tDDControlGroup, tDMChannelLoopback=tDMChannelLoopback, mainPSUPortStatus=mainPSUPortStatus, licenseTDDSyncSupport=licenseTDDSyncSupport, dfsTable=dfsTable, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, sFPError=sFPError, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClientTrap=syslogClientTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, dfs=dfs, dfsMeans=dfsMeans, eIRP=eIRP, mainPSUPortQLTx=mainPSUPortQLTx, accessMethod=accessMethod, l2CPPriorityTable=l2CPPriorityTable, nIDULanPortAutoMdix=nIDULanPortAutoMdix, receiveFreqKHz=receiveFreqKHz, softwareVersion=softwareVersion, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, userEnabled=userEnabled, licenseUnitSerialNumber=licenseUnitSerialNumber, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, auxPortQLRx=auxPortQLRx, longitude=longitude, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, txColorCode=txColorCode, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseIssueNumber=licenseIssueNumber, supplementary=supplementary, tDDControl=tDDControl, channelBandwidth=channelBandwidth, secondDataBridgingStatus=secondDataBridgingStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, tDMInterfaceControl=tDMInterfaceControl, notificationsGroup=notificationsGroup, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenseRARSupport=licenseRARSupport, cableDiagnosticsWarning=cableDiagnosticsWarning, lowestSecondDataModulationMode=lowestSecondDataModulationMode, licenseTrialPeriod=licenseTrialPeriod, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortStatus=auxPortStatus, encryptionAlgorithm=encryptionAlgorithm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, snmpControl=snmpControl, sNTPPollInterval=sNTPPollInterval, installStatusTrap=installStatusTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, userRole=userRole, aAAControl=aAAControl, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, mABTransmissionInterval=mABTransmissionInterval, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, receiveChannel=receiveChannel, auxPortSyncERxStatus=auxPortSyncERxStatus, tDMChannelStatus=tDMChannelStatus, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mainPSUPortStatusTrap=mainPSUPortStatusTrap, iPVersion=iPVersion, encryption=encryption, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tdmTableEntry=tdmTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, mPLSTCPriorityTable=mPLSTCPriorityTable, licenseIPv6Support=licenseIPv6Support, capacityVariantMismatch=capacityVariantMismatch, vectorError=vectorError, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, auxPortQLTx=auxPortQLTx, alarms=alarms, auxPortAllocation=auxPortAllocation, licenseSFPPortSupport=licenseSFPPortSupport, cableDiagPair3Distance=cableDiagPair3Distance, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, mABProtocolVLANPriority=mABProtocolVLANPriority, sFPPortSSMTx=sFPPortSSMTx, dataBridgingStatus=dataBridgingStatus, installStatus=installStatus, aggregateDataRate=aggregateDataRate, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, ethernetPriorityTableNumber=ethernetPriorityTableNumber, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, syncETracking=syncETracking, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, dfsTableEntry=dfsTableEntry, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, groupID=groupID, ethernet=ethernet, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, telnetPortNumber=telnetPortNumber, syslogControl=syslogControl, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, reset=reset, sNTPSync=sNTPSync, sFPPortAutoMdix=sFPPortAutoMdix, dataBridgingStatusAlarm=dataBridgingStatusAlarm, subnetMask=subnetMask, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licenseSyncESupport=licenseSyncESupport, mABHoldoffPeriod=mABHoldoffPeriod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementGroup=managementGroup, cableDiagnostics=cableDiagnostics, userPassword=userPassword, portAllocationMismatchTrap=portAllocationMismatchTrap, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tdmTableNumber=tdmTableNumber, tDMEnabledChannels=tDMEnabledChannels, sFPPortSyncERxStatus=sFPPortSyncERxStatus, transmitChannel=transmitChannel, ptp=ptp, iPv4Address=iPv4Address, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sNTPServerTable=sNTPServerTable, sntpGroup=sntpGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, cableDiagPair1Distance=cableDiagPair1Distance, systemReset=systemReset, qOSPriorityScheme=qOSPriorityScheme, channelChangeTrap=channelChangeTrap, receiveModulationMode=receiveModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, tDMInterfaceStatus=tDMInterfaceStatus, tdmTableIndex=tdmTableIndex, sFPPortDisabledWarning=sFPPortDisabledWarning, sMTPServerInternetAddressType=sMTPServerInternetAddressType, configuration=configuration, sMTPServerInternetAddress=sMTPServerInternetAddress, mABNominalModulationMode=mABNominalModulationMode, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, nIDULanPortStatus=nIDULanPortStatus, tDMChannelCableLength=tDMChannelCableLength, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, hTTPSAccessEnabled=hTTPSAccessEnabled, userTable=userTable, dfsTableNumber=dfsTableNumber, hardwareVersion=hardwareVersion, secureModeAlarm=secureModeAlarm, secondarySoftwareVersion=secondarySoftwareVersion, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, ptpCompliance=ptpCompliance, latitude=latitude, userTableEntry=userTableEntry, ptp650=ptp650, linkModeOptimization=linkModeOptimization, licenseOOBManagementSupport=licenseOOBManagementSupport, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, productName=productName, ethernetPriorityTableEntry=ethernetPriorityTableEntry, cableDiagPair4Results=cableDiagPair4Results, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tdmTable=tdmTable)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagnosticsResultTable=cableDiagnosticsResultTable, maxLinkRangeExceeded=maxLinkRangeExceeded, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, regulatoryBand=regulatoryBand, transmitDataRate=transmitDataRate, sFPPortQLRx=sFPPortQLRx, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, transmitModulationMode=transmitModulationMode, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, rangingMode=rangingMode, cambium=cambium, altitude=altitude, tDM=tDM, wirelessLinkAvailability=wirelessLinkAvailability, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, txMABFrames=txMABFrames, cableDiagPair2Results=cableDiagPair2Results, routerProtocols=routerProtocols, cableDiagPair4Distance=cableDiagPair4Distance, sFPErrorTrap=sFPErrorTrap, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, mainPSUPortAllocation=mainPSUPortAllocation, subbandHighestFrequency=subbandHighestFrequency, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseGroupAccess=licenseGroupAccess, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, antennaGain=antennaGain, iPv6GatewayAddress=iPv6GatewayAddress, bridgeGroup=bridgeGroup, vLANManagementPriority=vLANManagementPriority, ptpTrapPrefix=ptpTrapPrefix, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, siteName=siteName, licenseCountry=licenseCountry, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dSCPManagementPriority=dSCPManagementPriority, syslogControlGroup=syslogControlGroup, licenseSecurityLevel=licenseSecurityLevel, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, lowestDataModulationMode=lowestDataModulationMode, iPDSCPPriorityTable=iPDSCPPriorityTable, portAllocationMismatch=portAllocationMismatch, licenseMaxLinkRange=licenseMaxLinkRange, mABState=mABState, sNTPState=sNTPState, sNTPLastSync=sNTPLastSync, bridge=bridge, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, transparentClockVID=transparentClockVID, supplementaryGroup=supplementaryGroup, licenseEncryption=licenseEncryption, cableLoss=cableLoss, rxColorCode=rxColorCode, aAAControlGroup=aAAControlGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForMABProtocol=useVLANForMABProtocol, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapTable=sNMPTrapTable, licenseVersion=licenseVersion, range=range, auxPortAcceptedQLRx=auxPortAcceptedQLRx, phyControlGroup=phyControlGroup, sFPPortQLTx=sFPPortQLTx, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rawReceivePower=rawReceivePower, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, auxPortDisabledWarning=auxPortDisabledWarning, subbandLowestFrequency=subbandLowestFrequency, syslogStateTrap=syslogStateTrap, dataPortPauseFrames=dataPortPauseFrames, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, management=management, localPacketFiltering=localPacketFiltering, userName=userName, sFPPortAutoNegotiation=sFPPortAutoNegotiation, cableDiagPair1Results=cableDiagPair1Results, syncETrackingState=syncETrackingState, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, userTableNumber=userTableNumber, nIDULanPortStatusTrap=nIDULanPortStatusTrap, tDMConfigurationMismatch=tDMConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableDiagPair3Results=cableDiagPair3Results, ethernetGroup=ethernetGroup, cableDiagnosticsControl=cableDiagnosticsControl, sNTPSyncTrap=sNTPSyncTrap, sNMPEnabledTraps=sNMPEnabledTraps, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, lowestTDMModulationMode=lowestTDMModulationMode, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, extendedSpectrumScanning=extendedSpectrumScanning, transparentClockVLAN=transparentClockVLAN, syslogLocalWrappedTrap=syslogLocalWrappedTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, routerProtocolsGroup=routerProtocolsGroup, timeZone=timeZone, sFPPortStatus=sFPPortStatus, userTableIndex=userTableIndex, syslogState=syslogState, remoteInternetAddress=remoteInternetAddress, linkName=linkName, capacityVariantMismatchTrap=capacityVariantMismatchTrap, iPv6Address=iPv6Address, ethernetPriorityTable=ethernetPriorityTable, licenseCapacity=licenseCapacity, dfsGroup=dfsGroup, phyControl=phyControl, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, installArmState=installArmState, sNTPServerTableEntry=sNTPServerTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, systemClock=systemClock, syslogClient=syslogClient, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNTPServerTimeout=sNTPServerTimeout, hTTPAccessEnabled=hTTPAccessEnabled, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, signalStrengthRatio=signalStrengthRatio, mainPSUPortQLRx=mainPSUPortQLRx, enableTransmission=enableTransmission, auxPortSSMTx=auxPortSSMTx, incompatibleMasterAndSlave=incompatibleMasterAndSlave, mABNominalTransmitCapacity=mABNominalTransmitCapacity, tDMGroup=tDMGroup, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, cableDiagnosticsGroup=cableDiagnosticsGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, secondDataPortPauseFrames=secondDataPortPauseFrames, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, cableDiagPair2Distance=cableDiagPair2Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regulatoryBandTrap=regulatoryBandTrap, sNTPServerTableNumber=sNTPServerTableNumber, wirelessLinkStatus=wirelessLinkStatus, tDMChannelStatusTrap=tDMChannelStatusTrap, iPv6PrefixLength=iPv6PrefixLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStatsGroup=pubStatsGroup, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, maximumTransmitPower=maximumTransmitPower, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex)
