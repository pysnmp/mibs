...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", alarmsGroup=alarmsGroup, licenseCapacity=licenseCapacity, tdmTableEntry=tdmTableEntry, syncETracking=syncETracking, licenseVersion=licenseVersion, licenseIPv6Support=licenseIPv6Support, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPv6PrefixLength=iPv6PrefixLength, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cableDiagnosticsPorts=cableDiagnosticsPorts, regulatoryBandTrap=regulatoryBandTrap, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, l2CPPriorityTable=l2CPPriorityTable, mABHoldoffPeriod=mABHoldoffPeriod, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, tdmTableNumber=tdmTableNumber, secureModeAlarm=secureModeAlarm, secondDataBridgingStatus=secondDataBridgingStatus, mainPSUPortStatus=mainPSUPortStatus, auxPortAllocation=auxPortAllocation, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, tDMInterfaceStatus=tDMInterfaceStatus, tDMChannelStatus=tDMChannelStatus, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, ethernetPriorityTableEntry=ethernetPriorityTableEntry, useVLANForMABProtocol=useVLANForMABProtocol, linkSymmetry=linkSymmetry, linkModeOptimization=linkModeOptimization, syslogLocalWrappedTrap=syslogLocalWrappedTrap, searchState=searchState, notificationsGroup=notificationsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, routerProtocolsGroup=routerProtocolsGroup, eIRP=eIRP, targetRange=targetRange, bridge=bridge, installArmState=installArmState, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenseRegulatoryBandsList=licenseRegulatoryBandsList, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, wirelessLinkStatus=wirelessLinkStatus, cableDiagnosticsWarning=cableDiagnosticsWarning, iPv6GatewayAddress=iPv6GatewayAddress, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, licenseCountry=licenseCountry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, tDMChannelLoopback=tDMChannelLoopback, routerProtocols=routerProtocols, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, localPacketFiltering=localPacketFiltering, rangingMode=rangingMode, mABState=mABState, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortStatusTrap=sFPPortStatusTrap, auxPortStatusTrap=auxPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, daylightSaving=daylightSaving, syncETrackingState=syncETrackingState, aAAControlGroup=aAAControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, sFPError=sFPError, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, dfs=dfs, cableDiagnosticsGroup=cableDiagnosticsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenseGroupAccess=licenseGroupAccess, tDDSynchronizationAlarm=tDDSynchronizationAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableIndex=userTableIndex, txMABFrames=txMABFrames, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, cableDiagPair2Distance=cableDiagPair2Distance, dataBridgingStatus=dataBridgingStatus, supplementary=supplementary, cableDiagnosticsControl=cableDiagnosticsControl, dfsPeaks=dfsPeaks, sNTPServerTableNumber=sNTPServerTableNumber, transparentClock=transparentClock, longitude=longitude, remoteInternetAddressType=remoteInternetAddressType, sNTPServerStatus=sNTPServerStatus, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, ethernet=ethernet, mainPSUPortAutoMdix=mainPSUPortAutoMdix, dfsMeans=dfsMeans, maxLinkRangeExceeded=maxLinkRangeExceeded, syslogControlGroup=syslogControlGroup, tDMInterfaceControl=tDMInterfaceControl, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, gatewayIPAddress=gatewayIPAddress, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, sFPPortAutoNegotiation=sFPPortAutoNegotiation, licenseEncryption=licenseEncryption, telnetPortNumber=telnetPortNumber, transparentClockPort=transparentClockPort, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, tDMChannelLineCode=tDMChannelLineCode, versionsGroup=versionsGroup, userTableEntry=userTableEntry, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, auxPortDisabledWarning=auxPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, tDMChannelStatusTrap=tDMChannelStatusTrap, enableTransmission=enableTransmission, tDMGroup=tDMGroup, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, alarms=alarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, portAllocationMismatch=portAllocationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, tDMEnabledChannels=tDMEnabledChannels, dfsTableNumber=dfsTableNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, subbandHighestFrequency=subbandHighestFrequency, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, supplementaryGroup=supplementaryGroup, sFPPortAutoMdix=sFPPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userEnabled=userEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, sFPPortSyncERxStatus=sFPPortSyncERxStatus, mABTransmissionInterval=mABTransmissionInterval, receiveDataRate=receiveDataRate, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementVID=vLANManagementVID, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, sNTPServerTimeout=sNTPServerTimeout, phyControl=phyControl, siteName=siteName, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, altitude=altitude, capacityVariantMismatch=capacityVariantMismatch, bridgeGroup=bridgeGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelChangeTrap=channelChangeTrap, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sntpGroup=sntpGroup, nIDULanPortStatusTrap=nIDULanPortStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, nIDULanPortStatus=nIDULanPortStatus, transparentClockVLAN=transparentClockVLAN, cableDiagPair1Distance=cableDiagPair1Distance, userName=userName, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, sFPPortStatus=sFPPortStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, licenseIEEE1588Support=licenseIEEE1588Support, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPPortNumber=sNMPPortNumber, mainPSUPortSSMTx=mainPSUPortSSMTx, transparentClockVID=transparentClockVID, noWirelessChannelAvailable=noWirelessChannelAvailable, syncEEquipmentClock=syncEEquipmentClock, userTable=userTable, mainPSUPortAllocation=mainPSUPortAllocation, cableDiagPair4Results=cableDiagPair4Results, softwareVersion=softwareVersion, lowestSecondDataModulationMode=lowestSecondDataModulationMode, capacityVariantMismatchTrap=capacityVariantMismatchTrap, masterSlaveMode=masterSlaveMode, licenseRARSupport=licenseRARSupport, tDDControlGroup=tDDControlGroup, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, license=license, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, mainPSUPortStatusTrap=mainPSUPortStatusTrap, sFPErrorTrap=sFPErrorTrap, secureModeAlarmTrap=secureModeAlarmTrap, receiveModulationMode=receiveModulationMode, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, oOBPriorityQueueMapping=oOBPriorityQueueMapping, dataBridgingAvailability=dataBridgingAvailability, receiveFreqMHz=receiveFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableIndex=dfsTableIndex, tDMConfigurationMismatch=tDMConfigurationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableDiagPair4Distance=cableDiagPair4Distance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installStatusTrap=installStatusTrap, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync, syslogState=syslogState, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, linkLoss=linkLoss, cableDiagPair2Results=cableDiagPair2Results, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, auxPortQLTx=auxPortQLTx, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, auxPortSyncERxStatus=auxPortSyncERxStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", encryption=encryption, tdmTable=tdmTable, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, lowestDataModulationMode=lowestDataModulationMode, portAllocationMismatchTrap=portAllocationMismatchTrap, systemReset=systemReset, l2CPPriorityTableIndex=l2CPPriorityTableIndex, subnetMask=subnetMask, qOSPriorityScheme=qOSPriorityScheme, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, reset=reset, sNTPServerTableEntry=sNTPServerTableEntry, licenseOOBManagementSupport=licenseOOBManagementSupport, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondDataPortPauseFrames=secondDataPortPauseFrames, rxColorCode=rxColorCode, receiveChannel=receiveChannel, sNTPServerTableIndex=sNTPServerTableIndex, rawReceivePower=rawReceivePower, cableDiagPair3Results=cableDiagPair3Results, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, mainPSUPortQLRx=mainPSUPortQLRx, cableDiagPair1Results=cableDiagPair1Results, versions=versions, sNTPSync=sNTPSync, pubStats=pubStats, sNTPServerInternetAddressType=sNTPServerInternetAddressType, auxPortConfigurationMismatch=auxPortConfigurationMismatch, tDMChannelCableLength=tDMChannelCableLength, ptp650=ptp650, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, iPv4Address=iPv4Address, tdmTableIndex=tdmTableIndex, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, hardwareVersion=hardwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subbandLowestFrequency=subbandLowestFrequency, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, cableDiagnosticsResultTable=cableDiagnosticsResultTable, remoteInternetAddress=remoteInternetAddress, auxPortAcceptedQLRx=auxPortAcceptedQLRx, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, tDM=tDM, sNMPTrapVersion=sNMPTrapVersion, auxPortStatus=auxPortStatus, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userPassword=userPassword, mABProtocolVID=mABProtocolVID, licenseMaxLinkRange=licenseMaxLinkRange, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, licenseBandwidthCap=licenseBandwidthCap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sFPPortAllocation=sFPPortAllocation, mABProtocolVLANPriority=mABProtocolVLANPriority, management=management, targetMACAddress=targetMACAddress, txColorCode=txColorCode, smtpGroup=smtpGroup, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, resetGroup=resetGroup, iPv6Address=iPv6Address, sNTPState=sNTPState, lowestTDMModulationMode=lowestTDMModulationMode, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABMaintenanceLevel=mABMaintenanceLevel, cableDiagnostics=cableDiagnostics, systemClock=systemClock, transmitChannel=transmitChannel, sntp=sntp, range=range, sNMPTrapTableIndex=sNMPTrapTableIndex, licenseUnitSerialNumber=licenseUnitSerialNumber, tDDControl=tDDControl, sNTPServerRetries=sNTPServerRetries, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sFPPortQLRx=sFPPortQLRx, licenseSFPPortSupport=licenseSFPPortSupport, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sNTPServerTable=sNTPServerTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cambium=cambium, aggregateDataRate=aggregateDataRate, phyStatus=phyStatus, configurationGroup=configurationGroup, ethernetGroup=ethernetGroup, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, licenseGroup=licenseGroup, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, sNTPServerInternetAddress=sNTPServerInternetAddress, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, sNMPv3Enable=sNMPv3Enable, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenseTDDSyncSupport=licenseTDDSyncSupport, accessMethod=accessMethod, iPVersion=iPVersion, licenseTrialPeriod=licenseTrialPeriod, managementGroup=managementGroup, regulatoryBand=regulatoryBand, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitPower=transmitPower, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, latitude=latitude, licenseIssueNumber=licenseIssueNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, timeZone=timeZone, dataBridgingStatusAlarm=dataBridgingStatusAlarm, productName=productName, dataPortPauseFrames=dataPortPauseFrames, transmitModulationMode=transmitModulationMode, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, sNMPTrapInternetAddress=sNMPTrapInternetAddress, aAAControl=aAAControl, smtp=smtp, frequencyVariant=frequencyVariant, dfsTableEntry=dfsTableEntry, mainPSUPortQLTx=mainPSUPortQLTx, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, mABNominalModulationMode=mABNominalModulationMode, receivePower=receivePower, ptpTraps=ptpTraps, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, sFPPortSSMTx=sFPPortSSMTx, sNTPPollInterval=sNTPPollInterval, sNMPCommunityString=sNMPCommunityString, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, dfsTable=dfsTable, licenseSecurityLevel=licenseSecurityLevel, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, auxPortSSMTx=auxPortSSMTx, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, vectorError=vectorError, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, sFPPortQLTx=sFPPortQLTx, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, cableLoss=cableLoss, ethernetPriorityTable=ethernetPriorityTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, auxPortQLRx=auxPortQLRx, licenseSyncESupport=licenseSyncESupport)
