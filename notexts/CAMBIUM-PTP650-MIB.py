...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", sNTPState=sNTPState, phyControl=phyControl, transmitPower=transmitPower, cambium=cambium, telnetPortNumber=telnetPortNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, auxPortAllocation=auxPortAllocation, userEnabled=userEnabled, secondarySoftwareVersion=secondarySoftwareVersion, extendedSpectrumScanning=extendedSpectrumScanning, ethernetPriorityTable=ethernetPriorityTable, pubStatsGroup=pubStatsGroup, tDDControl=tDDControl, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, mainPSUPortQLTx=mainPSUPortQLTx, sNMPTrapTableNumber=sNMPTrapTableNumber, sFPPortSSMTx=sFPPortSSMTx, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, tDMEnabledChannels=tDMEnabledChannels, licenseTrialPeriod=licenseTrialPeriod, mainPSUPortQLRx=mainPSUPortQLRx, tdmTableNumber=tdmTableNumber, alarms=alarms, tDMChannelCableLength=tDMChannelCableLength, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, syslogState=syslogState, supplementaryGroup=supplementaryGroup, licenseSFPPortSupport=licenseSFPPortSupport, mainPSUPortSSMTx=mainPSUPortSSMTx, subnetMask=subnetMask, dfsTable=dfsTable, mainPSUPortAutoMdix=mainPSUPortAutoMdix, linkModeOptimization=linkModeOptimization, sNMPTrapVersion=sNMPTrapVersion, transmitFreqKHz=transmitFreqKHz, gatewayIPAddress=gatewayIPAddress, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, syslogClientTrap=syslogClientTrap, sFPErrorTrap=sFPErrorTrap, sFPPortSyncERxStatus=sFPPortSyncERxStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rangingMode=rangingMode, dataBridgingAvailability=dataBridgingAvailability, capacityVariantMismatchTrap=capacityVariantMismatchTrap, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerTable=sNTPServerTable, sFPPortQLRx=sFPPortQLRx, cableLoss=cableLoss, dataBridgingStatusAlarm=dataBridgingStatusAlarm, aAAControl=aAAControl, configuration=configuration, auxPortSSMTx=auxPortSSMTx, capacityVariantMismatch=capacityVariantMismatch, tdmTable=tdmTable, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, sntp=sntp, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dSCPManagementPriority=dSCPManagementPriority, tDMChannelStatus=tDMChannelStatus, PYSNMP_MODULE_ID=cambium, userPassword=userPassword, alarmsGroup=alarmsGroup, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, syslogStateTrap=syslogStateTrap, mABNominalModulationMode=mABNominalModulationMode, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, dfsGroup=dfsGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, licenseVersion=licenseVersion, iPv6Address=iPv6Address, accessMethod=accessMethod, sNTPServerPortNumber=sNTPServerPortNumber, routerProtocolsGroup=routerProtocolsGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, latitude=latitude, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transparentClock=transparentClock, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, subbandHighestFrequency=subbandHighestFrequency, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenseCountry=licenseCountry, sFPPortAllocation=sFPPortAllocation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionGroup=encryptionGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, tDM=tDM, nIDULanPortStatus=nIDULanPortStatus, sFPPortAutoMdix=sFPPortAutoMdix, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, bridgeGroup=bridgeGroup, supplementary=supplementary, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, transparentClockVID=transparentClockVID, qOSPriorityScheme=qOSPriorityScheme, tDMInterfaceStatus=tDMInterfaceStatus, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, licenseUnitSerialNumber=licenseUnitSerialNumber, transmitDataRate=transmitDataRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, mABProtocolVID=mABProtocolVID, ptp=ptp, receiveModulationMode=receiveModulationMode, sFPError=sFPError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, l2CPPriorityTableNumber=l2CPPriorityTableNumber, secondDataBridgingStatus=secondDataBridgingStatus, cableDiagPair3Results=cableDiagPair3Results, portAllocationMismatch=portAllocationMismatch, tDMInterfaceControl=tDMInterfaceControl, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sNTPSync=sNTPSync, cableDiagnosticsControl=cableDiagnosticsControl, userTableNumber=userTableNumber, receiveFreqMHz=receiveFreqMHz, productName=productName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, remoteInternetAddress=remoteInternetAddress, nIDULanPortStatusTrap=nIDULanPortStatusTrap, bootVersion=bootVersion, reset=reset, auxPortSyncERxStatus=auxPortSyncERxStatus, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, cableDiagPair4Results=cableDiagPair4Results, tDMChannelLineCode=tDMChannelLineCode, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, cableDiagPair1Distance=cableDiagPair1Distance, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, unitOutOfCalibration=unitOutOfCalibration, syncEEquipmentClock=syncEEquipmentClock, cableDiagPair2Results=cableDiagPair2Results, dfsTableEntry=dfsTableEntry, licenseSecurityLevel=licenseSecurityLevel, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, transparentClockVLAN=transparentClockVLAN, cableDiagnosticsWarning=cableDiagnosticsWarning, tDMChannelStatusTrap=tDMChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, mABNominalTransmitCapacity=mABNominalTransmitCapacity, ptpTrapPrefix=ptpTrapPrefix, byteErrorRatio=byteErrorRatio, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, tDDControlGroup=tDDControlGroup, sNTPPrimaryServer=sNTPPrimaryServer, installStatus=installStatus, sNTPServerTableNumber=sNTPServerTableNumber, txMABFrames=txMABFrames, longitude=longitude, ptpGroups=ptpGroups, frequencyVariant=frequencyVariant, tDMChannelLoopback=tDMChannelLoopback, hTTPPortNumber=hTTPPortNumber, sNMPv3Enable=sNMPv3Enable, mPLSTCPriorityTable=mPLSTCPriorityTable, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, cableDiagPair1Results=cableDiagPair1Results, sMTPServerPortNumber=sMTPServerPortNumber, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, oOBPriorityQueueMapping=oOBPriorityQueueMapping, transparentClockPort=transparentClockPort, sFPPortStatusTrap=sFPPortStatusTrap, auxPortAcceptedQLRx=auxPortAcceptedQLRx, management=management, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, phyControlGroup=phyControlGroup, versions=versions, ptpCompliance=ptpCompliance, l2CPPriorityTable=l2CPPriorityTable, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, hTTPSPortNumber=hTTPSPortNumber, timeZone=timeZone, sNMPTrapTableIndex=sNMPTrapTableIndex, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableDiagnosticsResultTable=cableDiagnosticsResultTable, cableDiagPair4Distance=cableDiagPair4Distance, dfsMeans=dfsMeans, licenseEncryption=licenseEncryption, licenseTDDSyncSupport=licenseTDDSyncSupport, auxPortStatus=auxPortStatus, licenseIssueNumber=licenseIssueNumber, transmitChannel=transmitChannel, systemClock=systemClock, iPVersion=iPVersion, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vectorError=vectorError, receiveDataRate=receiveDataRate, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, versionsGroup=versionsGroup, txColorCode=txColorCode, productVariant=productVariant, secureModeAlarmTrap=secureModeAlarmTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitFreqMHz=transmitFreqMHz, tFTPServerInternetAddress=tFTPServerInternetAddress, antennaGain=antennaGain, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTableEntry=ethernetPriorityTableEntry, license=license, managementGroup=managementGroup, sNTPServerStatus=sNTPServerStatus, cableDiagnosticsGroup=cableDiagnosticsGroup, resetGroup=resetGroup, licenseGroupAccess=licenseGroupAccess, userTable=userTable, sNMPEnabledTraps=sNMPEnabledTraps, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, mainPSUPortStatus=mainPSUPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, secureModeAlarm=secureModeAlarm, dataPortPauseFrames=dataPortPauseFrames, licenseRARSupport=licenseRARSupport, tDMGroup=tDMGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, managementNetworkAccessEnabled=managementNetworkAccessEnabled, syslogClient=syslogClient, userRole=userRole, installStatusTrap=installStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", mABHoldoffPeriod=mABHoldoffPeriod, lowestTDMModulationMode=lowestTDMModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syncETrackingState=syncETrackingState, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, tdmTableIndex=tdmTableIndex, ethernet=ethernet, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, dfsTableIndex=dfsTableIndex, sNTPServerRetries=sNTPServerRetries, smtpGroup=smtpGroup, linkLoss=linkLoss, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, sNMPPortNumber=sNMPPortNumber, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, userName=userName, installArmStateTrap=installArmStateTrap, licenseBandwidthCap=licenseBandwidthCap, sMTPServerInternetAddress=sMTPServerInternetAddress, mainPSUPortAllocation=mainPSUPortAllocation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, managementPortWirelessDownAlert=managementPortWirelessDownAlert, ethernetGroup=ethernetGroup, auxPortQLTx=auxPortQLTx, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, tDDSynchronizationMode=tDDSynchronizationMode, ethernetPriorityTableNumber=ethernetPriorityTableNumber, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, licenseOOBManagementSupport=licenseOOBManagementSupport, sNMPTrapTableEntry=sNMPTrapTableEntry, subbandLowestFrequency=subbandLowestFrequency, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, incompatibleRegulatoryBands=incompatibleRegulatoryBands, remoteInternetAddressType=remoteInternetAddressType, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, lowestDataModulationMode=lowestDataModulationMode, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sFPPortQLTx=sFPPortQLTx, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, licenseMaxLinkRange=licenseMaxLinkRange, softwareVersion=softwareVersion, dfsPeaks=dfsPeaks, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, licenseIPv6Support=licenseIPv6Support, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, receiveChannel=receiveChannel, sNTPServerInternetAddress=sNTPServerInternetAddress, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, sNTPServerTableIndex=sNTPServerTableIndex, encryptionAlgorithm=encryptionAlgorithm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, targetRange=targetRange, linkName=linkName, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, aAAControlGroup=aAAControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, dfs=dfs, channelBandwidth=channelBandwidth, iPv6GatewayAddress=iPv6GatewayAddress, routerProtocols=routerProtocols, altitude=altitude, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, encryption=encryption, regulatoryBandTrap=regulatoryBandTrap, licenseSyncESupport=licenseSyncESupport, lowestSecondDataModulationMode=lowestSecondDataModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, snmpControl=snmpControl, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syncETracking=syncETracking, eIRP=eIRP, mABTransmissionInterval=mABTransmissionInterval, sMTPEmailAlert=sMTPEmailAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, mABState=mABState, wirelessLinkStatus=wirelessLinkStatus, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, auxPortConfigurationMismatch=auxPortConfigurationMismatch, linkSymmetry=linkSymmetry, systemReset=systemReset, tDMConfigurationMismatch=tDMConfigurationMismatch, phyStatus=phyStatus, auxPortDisabledWarning=auxPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, pubStats=pubStats, licenseGroup=licenseGroup, tFTPServerPortNumber=tFTPServerPortNumber, cableDiagPair3Distance=cableDiagPair3Distance, ptmp=ptmp, tdmTableEntry=tdmTableEntry, licenseIEEE1588Support=licenseIEEE1588Support, sFPPortStatus=sFPPortStatus, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, userTableIndex=userTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, rawReceivePower=rawReceivePower, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, cableDiagnostics=cableDiagnostics, searchState=searchState, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, nIDULanPortAutoMdix=nIDULanPortAutoMdix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, maxLinkRangeExceeded=maxLinkRangeExceeded, useVLANForMABProtocol=useVLANForMABProtocol, syslogControlGroup=syslogControlGroup, auxPortQLRx=auxPortQLRx, userTableEntry=userTableEntry, secondDataPortPauseFrames=secondDataPortPauseFrames, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, mABProtocolVLANPriority=mABProtocolVLANPriority, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, iPv4Address=iPv4Address, rxColorCode=rxColorCode, mABMaintenanceLevel=mABMaintenanceLevel, receivePower=receivePower, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, dataBridgingStatus=dataBridgingStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableEntry=sNTPServerTableEntry, signalStrengthRatio=signalStrengthRatio, configurationGroup=configurationGroup, notificationsGroup=notificationsGroup, licenseRegulatoryBandsList=licenseRegulatoryBandsList, installArmState=installArmState, enableTransmission=enableTransmission, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, auxPortStatusTrap=auxPortStatusTrap, cableDiagPair2Distance=cableDiagPair2Distance, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, hardwareVersion=hardwareVersion, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, ptp650=ptp650, portAllocationMismatchTrap=portAllocationMismatchTrap, bridge=bridge, sNMPCommunityString=sNMPCommunityString, localPacketFiltering=localPacketFiltering, sNTPServerTimeout=sNTPServerTimeout, cableDiagnosticsPorts=cableDiagnosticsPorts, licenseCapacity=licenseCapacity, sNTPLastSync=sNTPLastSync, mainPSUPortStatusTrap=mainPSUPortStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, regulatoryBand=regulatoryBand, sFPPortAutoNegotiation=sFPPortAutoNegotiation, channelChangeTrap=channelChangeTrap)
