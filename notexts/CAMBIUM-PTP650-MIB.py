...
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", licenseTDDSyncSupport=licenseTDDSyncSupport, receiveFreqKHz=receiveFreqKHz, auxPortDisabledWarningTrap=auxPortDisabledWarningTrap, licenseBandwidthCap=licenseBandwidthCap, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsPeaks=dfsPeaks, lowestSecondDataModulationMode=lowestSecondDataModulationMode, mainPSUPortAllocation=mainPSUPortAllocation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, routerProtocols=routerProtocols, cableDiagPair2Distance=cableDiagPair2Distance, hardwareVersion=hardwareVersion, installArmState=installArmState, receiveChannel=receiveChannel, auxPortSyncEMasterSlaveStatus=auxPortSyncEMasterSlaveStatus, iPVersion=iPVersion, microwaveAdaptiveBandwidth=microwaveAdaptiveBandwidth, lowestTDMModulationMode=lowestTDMModulationMode, userName=userName, linkLoss=linkLoss, tdmTable=tdmTable, encryptionGroup=encryptionGroup, auxPortQLTx=auxPortQLTx, txMABFrames=txMABFrames, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, installStatusTrap=installStatusTrap, tdmTableIndex=tdmTableIndex, transmitDataRate=transmitDataRate, masterSlaveMode=masterSlaveMode, tDMInterfaceStatusTrap=tDMInterfaceStatusTrap, tDMChannelLoopbackTrap=tDMChannelLoopbackTrap, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, cableDiagnosticsPorts=cableDiagnosticsPorts, productVariant=productVariant, transparentClockVID=transparentClockVID, iPDSCPPriorityTable=iPDSCPPriorityTable, cableDiagPair4Results=cableDiagPair4Results, cableDiagnosticsWarning=cableDiagnosticsWarning, nIDULanPortAutoNegotiation=nIDULanPortAutoNegotiation, sNTPServerInternetAddress=sNTPServerInternetAddress, capacityVariantMismatch=capacityVariantMismatch, tdmTableEntry=tdmTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, rawReceivePower=rawReceivePower, dataBridgingStatus=dataBridgingStatus, syslogStateTrap=syslogStateTrap, syslogClient=syslogClient, hTTPAccessEnabled=hTTPAccessEnabled, licenseOOBManagementSupport=licenseOOBManagementSupport, softwareVersion=softwareVersion, cableDiagnosticsResultsDateTime=cableDiagnosticsResultsDateTime, rangingMode=rangingMode, secondDataPortPauseFrames=secondDataPortPauseFrames, mainPSUPortAutoMdix=mainPSUPortAutoMdix, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sFPPortSyncERxStatus=sFPPortSyncERxStatus, licenseIssueNumber=licenseIssueNumber, linkModeOptimization=linkModeOptimization, sFPPortStatus=sFPPortStatus, ptp650=ptp650, snmpControlGroup=snmpControlGroup, licenseGroupAccess=licenseGroupAccess, regulatoryBandTrap=regulatoryBandTrap, targetMACAddress=targetMACAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, mABTransmissionInterval=mABTransmissionInterval, auxPortStatus=auxPortStatus, sNMPTrapInternetAddress=sNMPTrapInternetAddress, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, capacityVariantMismatchTrap=capacityVariantMismatchTrap, extendedSpectrumScanning=extendedSpectrumScanning, mainPSUPortDisabledWarningTrap=mainPSUPortDisabledWarningTrap, licenseGroup=licenseGroup, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, nIDULanPortAutoNegAdvertisement=nIDULanPortAutoNegAdvertisement, dataBridgingAvailability=dataBridgingAvailability, nIDULanPortSpeedAndDuplex=nIDULanPortSpeedAndDuplex, licenseNumberOfRegulatoryBands=licenseNumberOfRegulatoryBands, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, auxPortSSMTx=auxPortSSMTx, tDMChannelLineCode=tDMChannelLineCode, mainPSUPortConfigurationMismatchTrap=mainPSUPortConfigurationMismatchTrap, licenseVersion=licenseVersion, tDMChannelCableLength=tDMChannelCableLength, bridgeGroup=bridgeGroup, licenseMaxNumberOfTDMChannels=licenseMaxNumberOfTDMChannels, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, tDMInterfaceControl=tDMInterfaceControl, ptmp=ptmp, groupID=groupID, tDMChannelLoopback=tDMChannelLoopback, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableNumber=dfsTableNumber, altitude=altitude, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tdmTableNumber=tdmTableNumber, sntpGroup=sntpGroup, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, auxPortPowerOverEthernetOutputStatus=auxPortPowerOverEthernetOutputStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, nIDULanPortConfigurationMismatchTrap=nIDULanPortConfigurationMismatchTrap, sntp=sntp, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, mPLSTCPriorityTable=mPLSTCPriorityTable, userTableIndex=userTableIndex, tDMConfigurationMismatchTrap=tDMConfigurationMismatchTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, transmitChannel=transmitChannel, mainPSUPortAutoNegotiation=mainPSUPortAutoNegotiation, licenseCapacity=licenseCapacity, sFPError=sFPError, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, tDMEnabledChannels=tDMEnabledChannels, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, useVLANForMABProtocol=useVLANForMABProtocol, auxPortPowerOverEthernetOutput=auxPortPowerOverEthernetOutput, sNTPServerTableIndex=sNTPServerTableIndex, mainPSUPortQLTx=mainPSUPortQLTx, iPv6Address=iPv6Address, sFPPortSyncEMasterSlaveStatus=sFPPortSyncEMasterSlaveStatus, antennaGain=antennaGain, remoteInternetAddressType=remoteInternetAddressType, receivePower=receivePower, tDMChannelStatusTrap=tDMChannelStatusTrap, transparentClockSourcePortAlarmTrap=transparentClockSourcePortAlarmTrap, regulatoryBand=regulatoryBand, phyControl=phyControl, installStatus=installStatus, supplementary=supplementary, txColorCode=txColorCode, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, mABProtocolVID=mABProtocolVID, vLANManagementPriority=vLANManagementPriority, mABCurrentTransmitCapacity=mABCurrentTransmitCapacity, ptp=ptp, dataPortPauseFrames=dataPortPauseFrames, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, systemReset=systemReset, phyStatus=phyStatus, portAllocationMismatchTrap=portAllocationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, dSCPManagementPriority=dSCPManagementPriority, sNTPServerRetries=sNTPServerRetries, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPrimaryServer=sNTPPrimaryServer, sFPPortConfigurationMismatchTrap=sFPPortConfigurationMismatchTrap, dfsMeans=dfsMeans, l2CPPriorityTable=l2CPPriorityTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dfsTable=dfsTable, cableDiagPair1Results=cableDiagPair1Results, auxPortAllocation=auxPortAllocation, mainPSUPortStatusTrap=mainPSUPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, licenseCountry=licenseCountry, tDMChannelStatus=tDMChannelStatus, dataBridgingStatusAlarm=dataBridgingStatusAlarm, tFTPServerPortNumber=tFTPServerPortNumber, sFPPortGigabitMasterSlaveStatus=sFPPortGigabitMasterSlaveStatus, installArmStateTrap=installArmStateTrap, tDDControlGroup=tDDControlGroup, managementNetworkAccessEnabled=managementNetworkAccessEnabled, mABState=mABState, syncEEquipmentClock=syncEEquipmentClock, l2CPPriorityTableIndex=l2CPPriorityTableIndex, licenseRegulatoryBandsTable=licenseRegulatoryBandsTable, sFPPortAutoNegotiation=sFPPortAutoNegotiation, frequencyVariant=frequencyVariant, cableDiagPair3Distance=cableDiagPair3Distance, tFTPServerInternetAddress=tFTPServerInternetAddress, mainPSUPortSpeedAndDuplex=mainPSUPortSpeedAndDuplex, versions=versions, userPassword=userPassword, nIDULanPortStatusTrap=nIDULanPortStatusTrap, transmitPower=transmitPower, iPv4Address=iPv4Address, notificationsGroup=notificationsGroup, cableDiagnostics=cableDiagnostics, smtpGroup=smtpGroup, cableDiagnosticsGroup=cableDiagnosticsGroup, dfs=dfs, sNMPv3Enable=sNMPv3Enable, auxPortStatusTrap=auxPortStatusTrap, syslogControlGroup=syslogControlGroup, sFPPortDisabledWarning=sFPPortDisabledWarning, signalStrengthRatio=signalStrengthRatio, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, managementGroup=managementGroup, productName=productName, aAAControlGroup=aAAControlGroup, sNTPServerInternetAddressType=sNTPServerInternetAddressType, resetGroup=resetGroup, byteErrorRatio=byteErrorRatio, cambium=cambium, nIDULanPortGigabitMasterSlaveStatus=nIDULanPortGigabitMasterSlaveStatus, hTTPPortNumber=hTTPPortNumber, rxColorCode=rxColorCode, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtp=smtp, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, nIDULanPortDisabledWarningTrap=nIDULanPortDisabledWarningTrap, ethernetGroup=ethernetGroup, sFPPortSpeedAndDuplex=sFPPortSpeedAndDuplex, sNTPServerTableEntry=sNTPServerTableEntry, sNTPServerTableNumber=sNTPServerTableNumber, secureModeAlarm=secureModeAlarm, mABNominalTransmitCapacity=mABNominalTransmitCapacity, bridge=bridge, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sFPPortConfigurationMismatch=sFPPortConfigurationMismatch, secondDataBridgingStatus=secondDataBridgingStatus, tDDSynchronizationMode=tDDSynchronizationMode, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, auxPortSyncERxStatus=auxPortSyncERxStatus, userTableNumber=userTableNumber, management=management, mainPSUPortAcceptedQLRx=mainPSUPortAcceptedQLRx, oOBPriorityQueueMapping=oOBPriorityQueueMapping, userTable=userTable, supplementaryGroup=supplementaryGroup, ethernetPriorityTable=ethernetPriorityTable, pubStats=pubStats, tFTPServerInternetAddressType=tFTPServerInternetAddressType, licenseMaxLinkRange=licenseMaxLinkRange, cableDiagnosticsResultTableIndex=cableDiagnosticsResultTableIndex, transparentClock=transparentClock)
mibBuilder.exportSymbols("CAMBIUM-PTP650-MIB", phyStatusGroup=phyStatusGroup, licenseRemainingTrialPeriodAlarm=licenseRemainingTrialPeriodAlarm, sFPPortDisabledWarningTrap=sFPPortDisabledWarningTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, nIDULanPortAutoMdix=nIDULanPortAutoMdix, ptpTraps=ptpTraps, licenseSyncESupport=licenseSyncESupport, subnetMask=subnetMask, subbandHighestFrequency=subbandHighestFrequency, licenseMinimumFirmwareVersion=licenseMinimumFirmwareVersion, sFPErrorTrap=sFPErrorTrap, configurationGroup=configurationGroup, portAllocationMismatch=portAllocationMismatch, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, cableDiagnosticsResultTableEntry=cableDiagnosticsResultTableEntry, channelBandwidth=channelBandwidth, transparentClockPort=transparentClockPort, tDMConfigurationMismatch=tDMConfigurationMismatch, lowestDataModulationMode=lowestDataModulationMode, licenseAuxiliaryPortSupport=licenseAuxiliaryPortSupport, sNTPServerTable=sNTPServerTable, userRole=userRole, mABHoldoffPeriod=mABHoldoffPeriod, licenseIPv6Support=licenseIPv6Support, mainPSUPortSyncERxStatus=mainPSUPortSyncERxStatus, sFPPortAcceptedQLRx=sFPPortAcceptedQLRx, nIDULanPortConfigurationMismatch=nIDULanPortConfigurationMismatch, targetRange=targetRange, mainPSUPortQLRxOverwrite=mainPSUPortQLRxOverwrite, mainPSUPortSyncEMasterSlaveStatus=mainPSUPortSyncEMasterSlaveStatus, auxPortPowerOverEthernetOutputStatusTrap=auxPortPowerOverEthernetOutputStatusTrap, phyControlGroup=phyControlGroup, mainPSUPortAutoNegAdvertisement=mainPSUPortAutoNegAdvertisement, nIDULanPortStatus=nIDULanPortStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, auxPortGigabitMasterSlaveStatus=auxPortGigabitMasterSlaveStatus, sFPPortAutoNegAdvertisement=sFPPortAutoNegAdvertisement, incompatibleRegulatoryBandsTrap=incompatibleRegulatoryBandsTrap, sNMPTrapVersion=sNMPTrapVersion, sFPPortSSMTx=sFPPortSSMTx, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, maxLinkRangeExceededTrap=maxLinkRangeExceededTrap, unitOutOfCalibration=unitOutOfCalibration, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, daylightSaving=daylightSaving, syncETracking=syncETracking, cableDiagPair4Distance=cableDiagPair4Distance, sMTPServerInternetAddress=sMTPServerInternetAddress, syncETrackingState=syncETrackingState, latitude=latitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpCompliance=ptpCompliance, searchState=searchState, sNMPTrapTableIndex=sNMPTrapTableIndex, secondDataBridgingStatusAlarmTrap=secondDataBridgingStatusAlarmTrap, sFPPortAutoMdix=sFPPortAutoMdix, licenseRegulatoryBandsList=licenseRegulatoryBandsList, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, auxPortConfigurationMismatch=auxPortConfigurationMismatch, subbandLowestFrequency=subbandLowestFrequency, syslogControl=syslogControl, license=license, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerStatus=sNTPServerStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, qOSPriorityScheme=qOSPriorityScheme, tDMInterfaceStatus=tDMInterfaceStatus, tDMGroup=tDMGroup, auxPortConfigurationMismatchTrap=auxPortConfigurationMismatchTrap, sNTPSync=sNTPSync, cableDiagPair1Distance=cableDiagPair1Distance, snmpControl=snmpControl, cableDiagnosticsResultTableNumber=cableDiagnosticsResultTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqKHz=transmitFreqKHz, maxLinkRangeExceeded=maxLinkRangeExceeded, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mABNominalModulationMode=mABNominalModulationMode, cableDiagnosticsControl=cableDiagnosticsControl, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, secureModeAlarmTrap=secureModeAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enableTransmission=enableTransmission, l2CPPriorityTableEntry=l2CPPriorityTableEntry, receiveDataRate=receiveDataRate, sFPPortAllocation=sFPPortAllocation, auxPortDisabledWarning=auxPortDisabledWarning, sFPPortStatusTrap=sFPPortStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, cableLoss=cableLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sFPPortQLRx=sFPPortQLRx, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6GatewayAddress=iPv6GatewayAddress, transparentClockSourcePortAlarm=transparentClockSourcePortAlarm, telnetPortNumber=telnetPortNumber, alarms=alarms, mainPSUPortStatus=mainPSUPortStatus, range=range, dataBridgingStatusAlarmTrap=dataBridgingStatusAlarmTrap, timeZone=timeZone, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, mainPSUPortSSMTx=mainPSUPortSSMTx, licenseRegulatoryBandsTableIndex=licenseRegulatoryBandsTableIndex, nIDULanPortDisabledWarning=nIDULanPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, auxPortAcceptedQLRx=auxPortAcceptedQLRx, sFPPortQLTx=sFPPortQLTx, dfsGroup=dfsGroup, sNTPServerTimeout=sNTPServerTimeout, licenseFullCapabilityTrialStatus=licenseFullCapabilityTrialStatus, licenseUnitSerialNumber=licenseUnitSerialNumber, licenseTrialPeriod=licenseTrialPeriod, licenseIEEE1588Support=licenseIEEE1588Support, ptpGroups=ptpGroups, licenseRemainingTrialPeriodAlarmTrap=licenseRemainingTrialPeriodAlarmTrap, tDM=tDM, secondDataBridgingStatusAlarm=secondDataBridgingStatusAlarm, licenseRegulatoryBandsTableEntry=licenseRegulatoryBandsTableEntry, cableDiagPair2Results=cableDiagPair2Results, routerProtocolsGroup=routerProtocolsGroup, sNMPTrapTable=sNMPTrapTable, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, auxPortSpeedAndDuplex=auxPortSpeedAndDuplex, remoteInternetAddress=remoteInternetAddress, mainPSUPortQLRx=mainPSUPortQLRx, dfsTableIndex=dfsTableIndex, transmitFreqMHz=transmitFreqMHz, licenseSecurityLevel=licenseSecurityLevel, longitude=longitude, licenseRARSupport=licenseRARSupport, cableDiagPair3Results=cableDiagPair3Results, auxPortQLRx=auxPortQLRx, aAAControl=aAAControl, mainPSUPortDisabledWarning=mainPSUPortDisabledWarning, linkName=linkName, licenseEncryption=licenseEncryption, mainPSUPortConfigurationMismatch=mainPSUPortConfigurationMismatch, mainPSUPortGigabitMasterSlaveStatus=mainPSUPortGigabitMasterSlaveStatus, transparentClockVLAN=transparentClockVLAN, mABMaintenanceLevel=mABMaintenanceLevel, incompatibleRegulatoryBands=incompatibleRegulatoryBands, licenseRemainingTrialPeriod=licenseRemainingTrialPeriod, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, licenseSFPPortSupport=licenseSFPPortSupport, maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, ethernet=ethernet, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, mABProtocolVLANPriority=mABProtocolVLANPriority, syslogClientTrap=syslogClientTrap, iPv6PrefixLength=iPv6PrefixLength, secondarySoftwareVersion=secondarySoftwareVersion, cableDiagnosticsResultTable=cableDiagnosticsResultTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSyncTrap=sNTPSyncTrap)
