...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:12:43 2022
...
iso, Bits, Integer32, Counter64, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, TimeTicks, IpAddress, MibIdentifier, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "Counter64", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "MibIdentifier", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spcommFailure=spcommFailure, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spImpactPps=spImpactPps, spDNSName=spDNSName, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, collectorStart=collectorStart, spHijackLocal=spHijackLocal, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spApplicationName=spApplicationName, spMitigationStart=spMitigationStart, spManagedObjects=spManagedObjects, spDNSObservedMax=spDNSObservedMax, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spLicenseErrType=spLicenseErrType, notificationLimit=notificationLimit, serviceUsage=serviceUsage, spFingerprintFeedback=spFingerprintFeedback, snmpDown=snmpDown, collectorDown=collectorDown, spInterfaceUsageHC=spInterfaceUsageHC, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSPrefix=spTMSPrefix, spBlackholePrefix=spBlackholePrefix, bgpInstabilityDone=bgpInstabilityDone, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, PYSNMP_MODULE_ID=peakflowSPMIB, spUsageType=spUsageType, spScriptCommand=spScriptCommand, bgpTrap=bgpTrap, hardwareFailure=hardwareFailure, spTMSTimeout=spTMSTimeout, spBGPTrapPrefix=spBGPTrapPrefix, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, fingerprintUsageDone=fingerprintUsageDone, dnsBaselineDone=dnsBaselineDone, spBlackholeNexthop=spBlackholeNexthop, spSystemErrorType=spSystemErrorType, spHardwareFailureDescription=spHardwareFailureDescription, spDNSObservedMean=spDNSObservedMean, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, peakflowSPCMI=peakflowSPCMI, interfaceUsageDone=interfaceUsageDone, spDuration=spDuration, cloudSignalingFault=cloudSignalingFault, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUnit=spUnit, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, managedObjectUsageDone=managedObjectUsageDone, spReportURL=spReportURL, spTMSMultiPrefix=spTMSMultiPrefix, spServiceName=spServiceName, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationBlackholeStart=mitigationBlackholeStart, spInetAddressType=spInetAddressType, deviceDiskUsage=deviceDiskUsage, spCommFailureDestination=spCommFailureDestination, flowUp=flowUp, spDetector=spDetector, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, devicePhysicalMemory=devicePhysicalMemory, mitigationTMSStartV2=mitigationTMSStartV2, spFlowspecCommunity=spFlowspecCommunity, autoclassifyStart=autoclassifyStart, fingerprintReceive=fingerprintReceive, spScriptPort=spScriptPort, spDetectedCountries=spDetectedCountries, bgpHijack=bgpHijack, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapEvent=spBGPTrapEvent, bgpDown=bgpDown, alertScript=alertScript, bgpUp=bgpUp, spDNSObserved=spDNSObserved, licenseError=licenseError, spScriptStart=spScriptStart, peakflowSPMgr=peakflowSPMgr, spUsername=spUsername, greDown=greDown, spInterfaceIndex=spInterfaceIndex, spHijackAttr=spHijackAttr, spInterfaceUsage=spInterfaceUsage, spGreTunnelName=spGreTunnelName, spServiceElement=spServiceElement, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPEvent=spBGPEvent, spMitigationID=spMitigationID, spDNSExpected=spDNSExpected, spScriptHost=spScriptHost, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spManagedObject=spManagedObject, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseErrorDone=licenseErrorDone, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailureDone=spcommFailureDone, reportDone=reportDone, spSystemErrorDescription=spSystemErrorDescription, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, deviceSwapSpace=deviceSwapSpace, spCommFailureDescription=spCommFailureDescription, peakflowSPMIB=peakflowSPMIB, spBlackholeCommunity=spBlackholeCommunity, snmpUp=snmpUp, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationFlowspecStart=mitigationFlowspecStart, spVersion=spVersion, trafficAutoMitigation=trafficAutoMitigation, mitigationTMSStart=mitigationTMSStart, hardwareFailureDone=hardwareFailureDone, spBlackholeTimeout=spBlackholeTimeout, spMitigationName=spMitigationName, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, spPravail=spPravail, spReportID=spReportID, spInterfaceSpeed=spInterfaceSpeed, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintUsage=fingerprintUsage, dosHostDetectionAlert=dosHostDetectionAlert, deviceHealth=deviceHealth, greDownDone=greDownDone, spInetAddress=spInetAddress, configChange=configChange, flowDown=flowDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, dnsBaseline=dnsBaseline, spInterface=spInterface, spReportName=spReportName, spManagedObjectFamily=spManagedObjectFamily, spFlowspecTimeout=spFlowspecTimeout, managedObjectUsage=managedObjectUsage, routingFailover=routingFailover, spThirdPartyAddr=spThirdPartyAddr, deviceSystemError=deviceSystemError, spBGPInstability=spBGPInstability, collectorUp=collectorUp, deviceTotalFlows=deviceTotalFlows, interfaceUsage=interfaceUsage, spAlertID=spAlertID, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrDescription=spLicenseErrDescription, spLicenseErrCount=spLicenseErrCount, spBGPTrapName=spBGPTrapName, spFingerprintMessage=spFingerprintMessage, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationDone=mitigationDone, spImpactBps=spImpactBps, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsage=spUsage, spLicenseErrLimit=spLicenseErrLimit, peakflowSPTraps=peakflowSPTraps, fingerprintFeedback=fingerprintFeedback, serviceUsageDone=serviceUsageDone)
