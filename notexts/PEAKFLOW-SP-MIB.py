...
ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Unsigned32, TimeTicks, NotificationType, ModuleIdentity, Integer32, IpAddress, Counter32, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress", "Counter32", "iso", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dnsBaseline=dnsBaseline, spLicenseErrDescription=spLicenseErrDescription, bgpDown=bgpDown, spDuration=spDuration, notificationLimit=notificationLimit, spInterfaceUsageHC=spInterfaceUsageHC, spMitigationName=spMitigationName, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInetAddress=spInetAddress, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spVersion=spVersion, spInetAddressType=spInetAddressType, deviceSwapSpace=deviceSwapSpace, fingerprintUsageDone=fingerprintUsageDone, spCommFailureDestination=spCommFailureDestination, spUsage=spUsage, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spAlertDetectionSignatures=spAlertDetectionSignatures, dnsBaselineDone=dnsBaselineDone, spInterfaceUsage=spInterfaceUsage, collectorDown=collectorDown, flowUp=flowUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, licenseErrorDone=licenseErrorDone, spLicenseErrType=spLicenseErrType, spHardwareFailureDescription=spHardwareFailureDescription, hardwareFailureDone=hardwareFailureDone, peakflowSPMgr=peakflowSPMgr, spFlowspecTimeout=spFlowspecTimeout, spInterface=spInterface, mitigationTMSStart=mitigationTMSStart, routingFailover=routingFailover, reportDone=reportDone, fingerprintReceive=fingerprintReceive, fingerprintUsage=fingerprintUsage, peakflowSPCMI=peakflowSPCMI, spPravail=spPravail, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDNSName=spDNSName, spMitigationStart=spMitigationStart, serviceUsageDone=serviceUsageDone, managedObjectUsage=managedObjectUsage, bgpInstabilityDone=bgpInstabilityDone, spGreTunnelName=spGreTunnelName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spMitigationID=spMitigationID, spScriptStart=spScriptStart, deviceSystemError=deviceSystemError, bgpInstability=bgpInstability, spTMSPrefix=spTMSPrefix, spImpactPps=spImpactPps, fingerprintFeedback=fingerprintFeedback, spUnit=spUnit, PYSNMP_MODULE_ID=peakflowSPMIB, bgpHijack=bgpHijack, spDetectedCountries=spDetectedCountries, spHijackRoute=spHijackRoute, spLicenseErrLimit=spLicenseErrLimit, spRouter=spRouter, spSystemErrorType=spSystemErrorType, spManagedObjects=spManagedObjects, spAlertID=spAlertID, deviceHealth=deviceHealth, spScriptPort=spScriptPort, spFingerprintSender=spFingerprintSender, snmpDown=snmpDown, interfaceUsage=interfaceUsage, managedObjectUsageDone=managedObjectUsageDone, spReportID=spReportID, serviceUsage=serviceUsage, spGreTunnelDestination=spGreTunnelDestination, spThirdPartyZone=spThirdPartyZone, alertScript=alertScript, spInterfaceIndex=spInterfaceIndex, spHijackAttr=spHijackAttr, spBlackholePrefix=spBlackholePrefix, spBGPTrapPrefix=spBGPTrapPrefix, spServiceElement=spServiceElement, hardwareFailure=hardwareFailure, spScriptHost=spScriptHost, greDownDone=greDownDone, deviceSystemErrorDone=deviceSystemErrorDone, spBlackholeNexthop=spBlackholeNexthop, spInterfaceSpeed=spInterfaceSpeed, spFingerprintFeedback=spFingerprintFeedback, spDNSObservedMean=spDNSObservedMean, spReportName=spReportName, spFingerprintMessage=spFingerprintMessage, bgpTrap=bgpTrap, configChange=configChange, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, cloudSignalingFault=cloudSignalingFault, mitigationFlowspecStart=mitigationFlowspecStart, spTMSCommunity=spTMSCommunity, deviceTotalFlowsHC=deviceTotalFlowsHC, spLicenseErrCount=spLicenseErrCount, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, licenseError=licenseError, trafficAutoMitigation=trafficAutoMitigation, peakflowSPTraps=peakflowSPTraps, spBGPTrapEvent=spBGPTrapEvent, spCommFailureDescription=spCommFailureDescription, spBlackholeCommunity=spBlackholeCommunity, spScriptCommand=spScriptCommand, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosHostDetectionAlert=dosHostDetectionAlert, collectorUp=collectorUp, spThreshold=spThreshold, spManagedObject=spManagedObject, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spManagedObjectFamily=spManagedObjectFamily, spFingerprintName=spFingerprintName, peakflowSPMIB=peakflowSPMIB, spThirdPartyAddr=spThirdPartyAddr, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCollector=spCollector, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, flowDown=flowDown, spBGPTrapName=spBGPTrapName, collectorStart=collectorStart, mitigationDone=mitigationDone, spHijackLocal=spHijackLocal, spTMSTimeout=spTMSTimeout, spDetector=spDetector, spApplicationName=spApplicationName, deviceDiskUsage=deviceDiskUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDNSObservedMax=spDNSObservedMax, spUsageType=spUsageType, mitigationBlackholeStart=mitigationBlackholeStart, spUsername=spUsername, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpUp=bgpUp, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPInstability=spBGPInstability, spImpactBps=spImpactBps, spDNSObserved=spDNSObserved, mitigationTMSStartV2=mitigationTMSStartV2, dosNetworkProfiledAlert=dosNetworkProfiledAlert, snmpUp=snmpUp, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSExpected=spDNSExpected, spFlowspecCommunity=spFlowspecCommunity, spSystemErrorDescription=spSystemErrorDescription, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spcommFailureDone=spcommFailureDone, spBGPEvent=spBGPEvent, spcommFailure=spcommFailure, autoclassifyStart=autoclassifyStart, greDown=greDown, deviceTotalFlows=deviceTotalFlows, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportURL=spReportURL, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spServiceName=spServiceName, devicePhysicalMemory=devicePhysicalMemory)
