...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:41:25 2022
...
MibIdentifier, NotificationType, Unsigned32, ObjectIdentity, TimeTicks, Bits, Gauge32, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "ObjectIdentity", "TimeTicks", "Bits", "Gauge32", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPMgr=peakflowSPMgr, snmpDown=snmpDown, spThreshold=spThreshold, fingerprintUsageDone=fingerprintUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spSystemErrorType=spSystemErrorType, spBGPEvent=spBGPEvent, spDetector=spDetector, spManagedObjects=spManagedObjects, spReportName=spReportName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeed=spInterfaceSpeed, PYSNMP_MODULE_ID=peakflowSPMIB, spThirdPartyZone=spThirdPartyZone, interfaceUsageDone=interfaceUsageDone, collectorUp=collectorUp, bgpInstabilityDone=bgpInstabilityDone, flowDown=flowDown, spBGPTrapName=spBGPTrapName, trafficAutoMitigation=trafficAutoMitigation, bgpHijack=bgpHijack, spServiceName=spServiceName, spImpactPps=spImpactPps, deviceSwapSpaceUsage=deviceSwapSpaceUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spFingerprintMessage=spFingerprintMessage, spHijackAttr=spHijackAttr, spApplicationName=spApplicationName, bgpDown=bgpDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, greDownDone=greDownDone, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStartV2=mitigationTMSStartV2, spUsage=spUsage, managedObjectUsage=managedObjectUsage, spDetectedCountries=spDetectedCountries, spFlowspecCommunity=spFlowspecCommunity, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInetAddressType=spInetAddressType, spServiceElement=spServiceElement, spHijackRoute=spHijackRoute, spGreTunnelDestination=spGreTunnelDestination, deviceDiskUsage=deviceDiskUsage, spTMSPrefix=spTMSPrefix, spSystemErrorDescription=spSystemErrorDescription, dnsBaselineDone=dnsBaselineDone, spTMSCommunity=spTMSCommunity, spInetAddress=spInetAddress, spTMSTimeout=spTMSTimeout, serviceUsageDone=serviceUsageDone, serviceUsage=serviceUsage, snmpUp=snmpUp, spUsageType=spUsageType, spGreTunnelName=spGreTunnelName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInterfaceUsage=spInterfaceUsage, bgpTrap=bgpTrap, spDNSExpected=spDNSExpected, peakflowSPTraps=peakflowSPTraps, spBlackholeNexthop=spBlackholeNexthop, devicePhysicalMemory=devicePhysicalMemory, spScriptHost=spScriptHost, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecTimeout=spFlowspecTimeout, alertScript=alertScript, spDNSObserved=spDNSObserved, spPravail=spPravail, spScriptPort=spScriptPort, peakflowSPMIB=peakflowSPMIB, spBGPInstability=spBGPInstability, spFingerprintSender=spFingerprintSender, spBlackholeTimeout=spBlackholeTimeout, bgpUp=bgpUp, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spcommFailure=spcommFailure, mitigationFlowspecStart=mitigationFlowspecStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceIndex=spInterfaceIndex, spAlertDetectionSignatures=spAlertDetectionSignatures, notificationLimit=notificationLimit, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrLimit=spLicenseErrLimit, spUsername=spUsername, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapPrefix=spBGPTrapPrefix, licenseError=licenseError, dnsBaseline=dnsBaseline, spInterfaceUsageHC=spInterfaceUsageHC, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObject=spManagedObject, spVersion=spVersion, hardwareFailure=hardwareFailure, spReportURL=spReportURL, flowUp=flowUp, deviceHealth=deviceHealth, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, collectorDown=collectorDown, spScriptCommand=spScriptCommand, autoclassifyStart=autoclassifyStart, spLicenseErrDescription=spLicenseErrDescription, reportDone=reportDone, mitigationDone=mitigationDone, mitigationTMSStart=mitigationTMSStart, spFingerprintFeedback=spFingerprintFeedback, spDuration=spDuration, spInterface=spInterface, greDown=greDown, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, spAlertID=spAlertID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spImpactBps=spImpactBps, spMitigationID=spMitigationID, spDNSObservedMax=spDNSObservedMax, deviceSystemErrorDone=deviceSystemErrorDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHardwareFailureDescription=spHardwareFailureDescription, spReportID=spReportID, spBlackholePrefix=spBlackholePrefix, spHijackLocal=spHijackLocal, spLicenseErrCount=spLicenseErrCount, cloudSignalingFault=cloudSignalingFault, spRouter=spRouter, spDNSObservedMean=spDNSObservedMean, deviceTotalFlows=deviceTotalFlows, collectorStart=collectorStart, licenseErrorDone=licenseErrorDone, mitigationBlackholeStart=mitigationBlackholeStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsageDone=managedObjectUsageDone, spScriptStart=spScriptStart, peakflowSPCMI=peakflowSPCMI, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spLicenseErrType=spLicenseErrType, spFingerprintName=spFingerprintName, routingFailover=routingFailover, bgpInstability=bgpInstability, dosHostDetectionAlert=dosHostDetectionAlert, spCommFailureDescription=spCommFailureDescription, spUnit=spUnit, spCollector=spCollector, hardwareFailureDone=hardwareFailureDone, deviceSwapSpace=deviceSwapSpace, spDNSName=spDNSName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjectFamily=spManagedObjectFamily, configChange=configChange, spcommFailureDone=spcommFailureDone, fingerprintFeedback=fingerprintFeedback, fingerprintReceive=fingerprintReceive, spMitigationStart=spMitigationStart, deviceSystemError=deviceSystemError, spMitigationName=spMitigationName, spInterfaceSpeedHC=spInterfaceSpeedHC)
