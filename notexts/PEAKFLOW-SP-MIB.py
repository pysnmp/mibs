...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:19:58 2023
...
ModuleIdentity, Integer32, Gauge32, TimeTicks, iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, NotificationType, MibIdentifier, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Gauge32", "TimeTicks", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spAlertID=spAlertID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDNSExpected=spDNSExpected, bgpInstabilityDone=bgpInstabilityDone, spMitigationID=spMitigationID, spBGPEvent=spBGPEvent, configChange=configChange, spLicenseErrDescription=spLicenseErrDescription, bgpInstability=bgpInstability, spInetAddress=spInetAddress, spDNSObserved=spDNSObserved, bgpHijack=bgpHijack, spBlackholeNexthop=spBlackholeNexthop, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spMitigationStart=spMitigationStart, licenseErrorDone=licenseErrorDone, reportDone=reportDone, greDownDone=greDownDone, spDNSObservedMax=spDNSObservedMax, fingerprintReceive=fingerprintReceive, spImpactBps=spImpactBps, greDown=greDown, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, serviceUsage=serviceUsage, interfaceUsage=interfaceUsage, spInterfaceUsage=spInterfaceUsage, spLicenseErrType=spLicenseErrType, spScriptPort=spScriptPort, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSTimeout=spTMSTimeout, mitigationTMSStartV2=mitigationTMSStartV2, spDNSObservedMean=spDNSObservedMean, spCollector=spCollector, spMitigationName=spMitigationName, spReportID=spReportID, mitigationDone=mitigationDone, spDetectedCountries=spDetectedCountries, spFingerprintFeedback=spFingerprintFeedback, cloudSignalingFault=cloudSignalingFault, spManagedObjects=spManagedObjects, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, managedObjectUsageDone=managedObjectUsageDone, PYSNMP_MODULE_ID=peakflowSPMIB, dnsBaseline=dnsBaseline, spThirdPartyAddr=spThirdPartyAddr, spBlackholeCommunity=spBlackholeCommunity, spUsage=spUsage, peakflowSPTraps=peakflowSPTraps, collectorStart=collectorStart, spHardwareFailureDescription=spHardwareFailureDescription, spTMSMultiPrefix=spTMSMultiPrefix, spReportName=spReportName, collectorUp=collectorUp, spThreshold=spThreshold, spFlowspecTimeout=spFlowspecTimeout, deviceSwapSpaceInUse=deviceSwapSpaceInUse, licenseError=licenseError, spDNSName=spDNSName, spFingerprintMessage=spFingerprintMessage, peakflowSPMgr=peakflowSPMgr, autoclassifyStart=autoclassifyStart, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, mitigationThirdPartyStart=mitigationThirdPartyStart, spManagedObjectFamily=spManagedObjectFamily, snmpUp=snmpUp, cloudSignalingFaultDone=cloudSignalingFaultDone, routingFailover=routingFailover, spSystemErrorDescription=spSystemErrorDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, dnsBaselineDone=dnsBaselineDone, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceDiskUsage=deviceDiskUsage, deviceSystemError=deviceSystemError, mitigationBlackholeStart=mitigationBlackholeStart, spcommFailureDone=spcommFailureDone, fingerprintUsageDone=fingerprintUsageDone, spThirdPartyZone=spThirdPartyZone, spDuration=spDuration, spUsageType=spUsageType, serviceUsageDone=serviceUsageDone, spFingerprintName=spFingerprintName, spCommFailureDescription=spCommFailureDescription, spCommFailureDestination=spCommFailureDestination, peakflowSPCMI=peakflowSPCMI, mitigationTMSStart=mitigationTMSStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spApplicationName=spApplicationName, spTMSCommunity=spTMSCommunity, spGreTunnelName=spGreTunnelName, spSystemErrorType=spSystemErrorType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFingerprintSender=spFingerprintSender, spHijackAttr=spHijackAttr, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, spServiceElement=spServiceElement, spFlowspecCommunity=spFlowspecCommunity, spBGPTrapName=spBGPTrapName, bgpDown=bgpDown, interfaceUsageDone=interfaceUsageDone, spPravail=spPravail, spBlackholePrefix=spBlackholePrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spLicenseErrCount=spLicenseErrCount, collectorDown=collectorDown, dosHostDetectionAlert=dosHostDetectionAlert, deviceSwapSpaceUsage=deviceSwapSpaceUsage, flowDown=flowDown, deviceSwapSpace=deviceSwapSpace, fingerprintFeedback=fingerprintFeedback, spBlackholeTimeout=spBlackholeTimeout, spScriptStart=spScriptStart, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPMIB=peakflowSPMIB, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackRoute=spHijackRoute, deviceTotalFlows=deviceTotalFlows, hardwareFailureDone=hardwareFailureDone, spBGPInstability=spBGPInstability, spManagedObject=spManagedObject, notificationLimit=notificationLimit, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spRouter=spRouter, managedObjectUsage=managedObjectUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUnit=spUnit, spInterfaceIndex=spInterfaceIndex, spBGPTrapEvent=spBGPTrapEvent, spInetAddressType=spInetAddressType, spLicenseErrLimit=spLicenseErrLimit, flowUp=flowUp, spcommFailure=spcommFailure, trafficAutoMitigation=trafficAutoMitigation, spReportURL=spReportURL, spScriptHost=spScriptHost, spImpactPps=spImpactPps, spDetector=spDetector, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceSpeed=spInterfaceSpeed, snmpDown=snmpDown, bgpTrap=bgpTrap, mitigationFlowspecStart=mitigationFlowspecStart, deviceSystemErrorDone=deviceSystemErrorDone, bgpUp=bgpUp, deviceHealth=deviceHealth, fingerprintUsage=fingerprintUsage, spUsername=spUsername, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, hardwareFailure=hardwareFailure, spTMSPrefix=spTMSPrefix, spScriptCommand=spScriptCommand, spInterfaceUsageHC=spInterfaceUsageHC, spVersion=spVersion, spHijackLocal=spHijackLocal, alertScript=alertScript, spServiceName=spServiceName)
