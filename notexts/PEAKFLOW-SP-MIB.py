...
# Produced by pysmi-1.1.8 at Tue Jan 18 14:00:21 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, MibIdentifier, Integer32, TimeTicks, Counter64, iso, Bits, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "TimeTicks", "Counter64", "iso", "Bits", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHardwareFailureDescription=spHardwareFailureDescription, spFlowspecCommunity=spFlowspecCommunity, spSystemErrorDescription=spSystemErrorDescription, mitigationBlackholeStart=mitigationBlackholeStart, spServiceElement=spServiceElement, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBlackholeNexthop=spBlackholeNexthop, spHijackRoute=spHijackRoute, hardwareFailureDone=hardwareFailureDone, spBGPInstability=spBGPInstability, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSMultiPrefix=spTMSMultiPrefix, flowDown=flowDown, spUsage=spUsage, bgpDown=bgpDown, spUnit=spUnit, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationFlowspecStart=mitigationFlowspecStart, greDownDone=greDownDone, interfaceUsageDone=interfaceUsageDone, collectorUp=collectorUp, spScriptHost=spScriptHost, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintReceive=fingerprintReceive, deviceSystemError=deviceSystemError, bgpHijack=bgpHijack, spImpactPps=spImpactPps, spcommFailureDone=spcommFailureDone, spBlackholePrefix=spBlackholePrefix, peakflowSPCMI=peakflowSPCMI, spDetector=spDetector, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInterfaceUsage=spInterfaceUsage, spPravail=spPravail, spImpactBps=spImpactBps, spcommFailure=spcommFailure, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spUsageType=spUsageType, flowUp=flowUp, spCloudSignalFaultDescription=spCloudSignalFaultDescription, trafficAutoMitigation=trafficAutoMitigation, spDNSObserved=spDNSObserved, spLicenseErrType=spLicenseErrType, spTMSPrefix=spTMSPrefix, spTMSTimeout=spTMSTimeout, fingerprintUsageDone=fingerprintUsageDone, alertScript=alertScript, spManagedObject=spManagedObject, spInterfaceIndex=spInterfaceIndex, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelName=spGreTunnelName, deviceSystemErrorDone=deviceSystemErrorDone, greDown=greDown, serviceUsageDone=serviceUsageDone, spManagedObjectFamily=spManagedObjectFamily, collectorDown=collectorDown, spInterfaceSpeed=spInterfaceSpeed, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSExpected=spDNSExpected, spUsername=spUsername, bgpUp=bgpUp, spLicenseErrCount=spLicenseErrCount, autoclassifyStart=autoclassifyStart, devicePhysicalMemory=devicePhysicalMemory, spGreTunnelDestination=spGreTunnelDestination, spInetAddress=spInetAddress, spReportName=spReportName, bgpTrap=bgpTrap, managedObjectUsageDone=managedObjectUsageDone, spScriptStart=spScriptStart, mitigationTMSStartV2=mitigationTMSStartV2, spDNSName=spDNSName, spMitigationName=spMitigationName, dnsBaseline=dnsBaseline, spThirdPartyZone=spThirdPartyZone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceTotalFlows=deviceTotalFlows, serviceUsage=serviceUsage, spFingerprintName=spFingerprintName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingFault=cloudSignalingFault, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, collectorStart=collectorStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrLimit=spLicenseErrLimit, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpInstabilityDone=bgpInstabilityDone, spInetAddressType=spInetAddressType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spReportURL=spReportURL, spVersion=spVersion, spCommFailureDestination=spCommFailureDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spCommFailureDescription=spCommFailureDescription, spCollector=spCollector, configChange=configChange, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBlackholeCommunity=spBlackholeCommunity, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPMgr=peakflowSPMgr, spMitigationID=spMitigationID, spScriptCommand=spScriptCommand, spLicenseErrDescription=spLicenseErrDescription, spAlertID=spAlertID, snmpDown=snmpDown, dosHostDetectionAlert=dosHostDetectionAlert, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptPort=spScriptPort, hardwareFailure=hardwareFailure, routingFailover=routingFailover, spThreshold=spThreshold, notificationLimit=notificationLimit, spDetectedCountries=spDetectedCountries, spReportID=spReportID, spDNSObservedMean=spDNSObservedMean, spDuration=spDuration, peakflowSPMIB=peakflowSPMIB, bgpInstability=bgpInstability, spHijackAttr=spHijackAttr, dnsBaselineDone=dnsBaselineDone, licenseError=licenseError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, interfaceUsage=interfaceUsage, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, spFingerprintMessage=spFingerprintMessage, spMitigationStart=spMitigationStart, deviceHealth=deviceHealth, licenseErrorDone=licenseErrorDone, fingerprintFeedback=fingerprintFeedback, reportDone=reportDone, spBGPEvent=spBGPEvent, spHijackLocal=spHijackLocal, managedObjectUsage=managedObjectUsage, fingerprintUsage=fingerprintUsage, spFingerprintSender=spFingerprintSender, deviceSwapSpace=deviceSwapSpace, spInterface=spInterface, deviceDiskUsage=deviceDiskUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, spSystemErrorType=spSystemErrorType, spApplicationName=spApplicationName, spTMSCommunity=spTMSCommunity, spBGPTrapName=spBGPTrapName, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObjects=spManagedObjects, spBGPTrapEvent=spBGPTrapEvent, spDNSObservedMax=spDNSObservedMax, spServiceName=spServiceName, peakflowSPTraps=peakflowSPTraps, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, spBlackholeTimeout=spBlackholeTimeout, mitigationTMSStart=mitigationTMSStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spRouter=spRouter)
