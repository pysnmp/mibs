...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPMgr=peakflowSPMgr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, configChange=configChange, spLicenseErrDescription=spLicenseErrDescription, managedObjectUsage=managedObjectUsage, spInterfaceIndex=spInterfaceIndex, spBlackholePrefix=spBlackholePrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrLimit=spLicenseErrLimit, bgpHijack=bgpHijack, spImpactPps=spImpactPps, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObject=spManagedObject, spFingerprintName=spFingerprintName, spThirdPartyAddr=spThirdPartyAddr, routingFailover=routingFailover, spAlertID=spAlertID, spMitigationStart=spMitigationStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, hardwareFailureDone=hardwareFailureDone, cloudSignalingFault=cloudSignalingFault, peakflowSPTraps=peakflowSPTraps, spReportName=spReportName, spBlackholeCommunity=spBlackholeCommunity, spUsageType=spUsageType, spCommFailureDescription=spCommFailureDescription, spBGPInstability=spBGPInstability, notificationLimit=notificationLimit, serviceUsageDone=serviceUsageDone, PYSNMP_MODULE_ID=peakflowSPMIB, spHijackLocal=spHijackLocal, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, snmpUp=snmpUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapEvent=spBGPTrapEvent, spDNSExpected=spDNSExpected, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHijackAttr=spHijackAttr, spHardwareFailureDescription=spHardwareFailureDescription, bgpInstabilityDone=bgpInstabilityDone, spTMSCommunity=spTMSCommunity, flowUp=flowUp, snmpDown=snmpDown, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapName=spBGPTrapName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spScriptHost=spScriptHost, spDetectedCountries=spDetectedCountries, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationName=spMitigationName, spDuration=spDuration, spFlowspecTimeout=spFlowspecTimeout, mitigationFlowspecStart=mitigationFlowspecStart, spTMSTimeout=spTMSTimeout, spGreTunnelDestination=spGreTunnelDestination, spDNSObservedMax=spDNSObservedMax, spTMSMultiPrefix=spTMSMultiPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintUsageDone=fingerprintUsageDone, spMitigationID=spMitigationID, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spServiceElement=spServiceElement, spScriptCommand=spScriptCommand, spDetector=spDetector, dosHostDetectionAlert=dosHostDetectionAlert, bgpDown=bgpDown, dnsBaseline=dnsBaseline, managedObjectUsageDone=managedObjectUsageDone, spTMSPrefix=spTMSPrefix, collectorStart=collectorStart, licenseError=licenseError, spVersion=spVersion, spBGPTrapPrefix=spBGPTrapPrefix, spDNSObserved=spDNSObserved, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsage=fingerprintUsage, deviceTotalFlows=deviceTotalFlows, greDownDone=greDownDone, spScriptStart=spScriptStart, devicePhysicalMemory=devicePhysicalMemory, collectorDown=collectorDown, spFingerprintMessage=spFingerprintMessage, spReportURL=spReportURL, deviceHealth=deviceHealth, mitigationDone=mitigationDone, spServiceName=spServiceName, collectorUp=collectorUp, cloudSignalingFaultDone=cloudSignalingFaultDone, greDown=greDown, spDNSObservedMean=spDNSObservedMean, spInetAddressType=spInetAddressType, interfaceUsageDone=interfaceUsageDone, spApplicationName=spApplicationName, bgpInstability=bgpInstability, serviceUsage=serviceUsage, dnsBaselineDone=dnsBaselineDone, bgpUp=bgpUp, spUnit=spUnit, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spImpactBps=spImpactBps, spInetAddress=spInetAddress, peakflowSPMIB=peakflowSPMIB, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterface=spInterface, spGreTunnelName=spGreTunnelName, alertScript=alertScript, spUsage=spUsage, spScriptPort=spScriptPort, bgpTrap=bgpTrap, spSystemErrorType=spSystemErrorType, spcommFailureDone=spcommFailureDone, interfaceUsage=interfaceUsage, spFingerprintFeedback=spFingerprintFeedback, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceUsage=spInterfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spPravail=spPravail, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrType=spLicenseErrType, spThreshold=spThreshold, spCollector=spCollector, deviceDiskUsage=deviceDiskUsage, spFlowspecCommunity=spFlowspecCommunity, spThirdPartyZone=spThirdPartyZone, spDNSName=spDNSName, spManagedObjects=spManagedObjects, spLicenseErrCount=spLicenseErrCount, deviceSystemError=deviceSystemError, spBlackholeTimeout=spBlackholeTimeout, flowDown=flowDown, deviceSystemErrorDone=deviceSystemErrorDone, trafficAutoMitigation=trafficAutoMitigation, spUsername=spUsername, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackRoute=spHijackRoute, hardwareFailure=hardwareFailure, spRouter=spRouter, deviceSwapSpace=deviceSwapSpace, spcommFailure=spcommFailure, fingerprintReceive=fingerprintReceive, licenseErrorDone=licenseErrorDone, spBlackholeNexthop=spBlackholeNexthop, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPCMI=peakflowSPCMI, spManagedObjectFamily=spManagedObjectFamily, autoclassifyStart=autoclassifyStart, reportDone=reportDone, spFingerprintSender=spFingerprintSender, mitigationBlackholeStart=mitigationBlackholeStart, mitigationTMSStart=mitigationTMSStart, spBGPEvent=spBGPEvent, spReportID=spReportID, spSystemErrorDescription=spSystemErrorDescription)
