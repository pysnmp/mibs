...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:07:26 2022
...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Gauge32, TimeTicks, IpAddress, Integer32, Counter64, Unsigned32, ObjectIdentity, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Gauge32", "TimeTicks", "IpAddress", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spcommFailureDone=spcommFailureDone, spBGPTrapName=spBGPTrapName, spBlackholeCommunity=spBlackholeCommunity, spRouter=spRouter, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSPrefix=spTMSPrefix, deviceHealth=deviceHealth, peakflowSPMgr=peakflowSPMgr, spBlackholeTimeout=spBlackholeTimeout, PYSNMP_MODULE_ID=peakflowSPMIB, spCommFailureDestination=spCommFailureDestination, spDNSObservedMean=spDNSObservedMean, trafficAutoMitigation=trafficAutoMitigation, spFingerprintSender=spFingerprintSender, hardwareFailure=hardwareFailure, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, flowUp=flowUp, configChange=configChange, deviceDiskUsage=deviceDiskUsage, fingerprintFeedback=fingerprintFeedback, spLicenseErrType=spLicenseErrType, spBlackholePrefix=spBlackholePrefix, bgpInstabilityDone=bgpInstabilityDone, serviceUsageDone=serviceUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, greDown=greDown, bgpInstability=bgpInstability, cloudSignalingFault=cloudSignalingFault, spVersion=spVersion, spBGPTrapOldAttributes=spBGPTrapOldAttributes, notificationLimit=notificationLimit, spBGPEvent=spBGPEvent, spcommFailure=spcommFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, mitigationFlowspecStart=mitigationFlowspecStart, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpDown=bgpDown, spManagedObjects=spManagedObjects, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapEvent=spBGPTrapEvent, spReportID=spReportID, spManagedObject=spManagedObject, spTMSCommunity=spTMSCommunity, spInterfaceIndex=spInterfaceIndex, autoclassifyStart=autoclassifyStart, spTMSTimeout=spTMSTimeout, spInterfaceUsage=spInterfaceUsage, spUnit=spUnit, spInetAddressType=spInetAddressType, spPravail=spPravail, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationDone=mitigationDone, collectorStart=collectorStart, cloudSignalingFaultDone=cloudSignalingFaultDone, serviceUsage=serviceUsage, spDNSName=spDNSName, hardwareFailureDone=hardwareFailureDone, spDuration=spDuration, spInterfaceUsageHC=spInterfaceUsageHC, spUsername=spUsername, licenseError=licenseError, spLicenseErrCount=spLicenseErrCount, spFingerprintName=spFingerprintName, spSystemErrorDescription=spSystemErrorDescription, spBlackholeNexthop=spBlackholeNexthop, spScriptCommand=spScriptCommand, mitigationTMSStart=mitigationTMSStart, spFingerprintMessage=spFingerprintMessage, dnsBaseline=dnsBaseline, collectorUp=collectorUp, alertScript=alertScript, interfaceUsageDone=interfaceUsageDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spServiceName=spServiceName, dnsBaselineDone=dnsBaselineDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, snmpDown=snmpDown, spThreshold=spThreshold, spMitigationStart=spMitigationStart, managedObjectUsage=managedObjectUsage, deviceSystemError=deviceSystemError, spGreTunnelName=spGreTunnelName, spAlertID=spAlertID, spDNSExpected=spDNSExpected, peakflowSPCMI=peakflowSPCMI, spHardwareFailureDescription=spHardwareFailureDescription, spDetectedCountries=spDetectedCountries, managedObjectUsageDone=managedObjectUsageDone, spHijackRoute=spHijackRoute, spSystemErrorType=spSystemErrorType, spBGPTrapNewAttributes=spBGPTrapNewAttributes, mitigationTMSStartV2=mitigationTMSStartV2, spReportName=spReportName, routingFailover=routingFailover, spServiceElement=spServiceElement, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPInstability=spBGPInstability, interfaceUsage=interfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, deviceTotalFlows=deviceTotalFlows, spReportURL=spReportURL, collectorDown=collectorDown, reportDone=reportDone, spCollector=spCollector, spFingerprintFeedback=spFingerprintFeedback, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpace=deviceSwapSpace, spInterface=spInterface, spLicenseErrLimit=spLicenseErrLimit, spFlowspecTimeout=spFlowspecTimeout, spUsageType=spUsageType, snmpUp=snmpUp, spApplicationName=spApplicationName, spScriptPort=spScriptPort, spLicenseErrDescription=spLicenseErrDescription, spManagedObjectFamily=spManagedObjectFamily, fingerprintReceive=fingerprintReceive, devicePhysicalMemory=devicePhysicalMemory, spScriptHost=spScriptHost, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPTrapPrefix=spBGPTrapPrefix, bgpTrap=bgpTrap, spHijackAttr=spHijackAttr, spCommFailureDescription=spCommFailureDescription, licenseErrorDone=licenseErrorDone, spScriptStart=spScriptStart, spGreTunnelDestination=spGreTunnelDestination, spImpactBps=spImpactBps, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spImpactPps=spImpactPps, spTMSMultiPrefix=spTMSMultiPrefix, spMitigationID=spMitigationID, spInetAddress=spInetAddress, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSObserved=spDNSObserved, spThirdPartyAddr=spThirdPartyAddr, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpHijack=bgpHijack, fingerprintUsage=fingerprintUsage, spUsage=spUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPTraps=peakflowSPTraps, bgpUp=bgpUp, spThirdPartyZone=spThirdPartyZone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPMIB=peakflowSPMIB, spFlowspecCommunity=spFlowspecCommunity, flowDown=flowDown, spInterfaceSpeed=spInterfaceSpeed, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spHijackLocal=spHijackLocal, spDetector=spDetector, spMitigationName=spMitigationName, deviceSystemErrorDone=deviceSystemErrorDone, greDownDone=greDownDone, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintUsageDone=fingerprintUsageDone, spDNSObservedMax=spDNSObservedMax)
