...
ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, TimeTicks, IpAddress, Counter64, Counter32, Bits, iso, Integer32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64", "Counter32", "Bits", "iso", "Integer32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThreshold=spThreshold, deviceHealth=deviceHealth, spImpactBps=spImpactBps, spTMSCommunity=spTMSCommunity, spDuration=spDuration, flowDown=flowDown, dnsBaselineDone=dnsBaselineDone, deviceSwapSpace=deviceSwapSpace, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spScriptCommand=spScriptCommand, spDNSObservedMax=spDNSObservedMax, serviceUsage=serviceUsage, spBlackholeTimeout=spBlackholeTimeout, spDNSObservedMean=spDNSObservedMean, spFingerprintSender=spFingerprintSender, spInetAddress=spInetAddress, spFingerprintMessage=spFingerprintMessage, reportDone=reportDone, spGreTunnelDestination=spGreTunnelDestination, spDNSExpected=spDNSExpected, collectorDown=collectorDown, spInterfaceSpeed=spInterfaceSpeed, snmpUp=snmpUp, spFlowspecCommunity=spFlowspecCommunity, spUnit=spUnit, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapPrefix=spBGPTrapPrefix, fingerprintReceive=fingerprintReceive, spManagedObjects=spManagedObjects, spReportID=spReportID, hardwareFailure=hardwareFailure, spCommFailureDescription=spCommFailureDescription, PYSNMP_MODULE_ID=peakflowSPMIB, spSystemErrorDescription=spSystemErrorDescription, spBlackholeCommunity=spBlackholeCommunity, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spVersion=spVersion, spUsage=spUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spThirdPartyZone=spThirdPartyZone, spInetAddressType=spInetAddressType, spDetector=spDetector, spApplicationName=spApplicationName, spBGPTrapEvent=spBGPTrapEvent, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dosHostDetectionAlert=dosHostDetectionAlert, greDownDone=greDownDone, configChange=configChange, mitigationDone=mitigationDone, interfaceUsageDone=interfaceUsageDone, peakflowSPMgr=peakflowSPMgr, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spLicenseErrLimit=spLicenseErrLimit, spTMSTimeout=spTMSTimeout, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPMIB=peakflowSPMIB, spLicenseErrDescription=spLicenseErrDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSMultiPrefix=spTMSMultiPrefix, spBGPEvent=spBGPEvent, mitigationBlackholeStart=mitigationBlackholeStart, spImpactPps=spImpactPps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, snmpDown=snmpDown, spInterfaceIndex=spInterfaceIndex, bgpInstabilityDone=bgpInstabilityDone, spcommFailureDone=spcommFailureDone, spCommFailureDestination=spCommFailureDestination, spCollector=spCollector, spSystemErrorType=spSystemErrorType, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDetectedCountries=spDetectedCountries, bgpDown=bgpDown, spHijackAttr=spHijackAttr, alertScript=alertScript, spHijackRoute=spHijackRoute, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dnsBaseline=dnsBaseline, spMitigationStart=spMitigationStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spManagedObjectFamily=spManagedObjectFamily, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholePrefix=spBlackholePrefix, licenseError=licenseError, greDown=greDown, hardwareFailureDone=hardwareFailureDone, spReportURL=spReportURL, deviceDiskUsage=deviceDiskUsage, spMitigationName=spMitigationName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spReportName=spReportName, flowUp=flowUp, spInterfaceUsageHC=spInterfaceUsageHC, spServiceName=spServiceName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, devicePhysicalMemory=devicePhysicalMemory, spGreTunnelName=spGreTunnelName, spManagedObject=spManagedObject, spHijackLocal=spHijackLocal, trafficAutoMitigation=trafficAutoMitigation, spDNSName=spDNSName, spPravail=spPravail, spInterfaceSpeedHC=spInterfaceSpeedHC, spDNSObserved=spDNSObserved, fingerprintUsage=fingerprintUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, interfaceUsage=interfaceUsage, spLicenseErrType=spLicenseErrType, routingFailover=routingFailover, licenseErrorDone=licenseErrorDone, spFingerprintName=spFingerprintName, cloudSignalingFaultDone=cloudSignalingFaultDone, collectorUp=collectorUp, spUsername=spUsername, spUsageType=spUsageType, spScriptPort=spScriptPort, spInterfaceUsage=spInterfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationFlowspecStart=mitigationFlowspecStart, collectorStart=collectorStart, peakflowSPTraps=peakflowSPTraps, bgpTrap=bgpTrap, fingerprintFeedback=fingerprintFeedback, autoclassifyStart=autoclassifyStart, spMitigationID=spMitigationID, spThirdPartyAddr=spThirdPartyAddr, serviceUsageDone=serviceUsageDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationTMSStart=mitigationTMSStart, spFingerprintFeedback=spFingerprintFeedback, bgpInstability=bgpInstability, fingerprintUsageDone=fingerprintUsageDone, spBGPInstability=spBGPInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSystemError=deviceSystemError, spRouter=spRouter, spLicenseErrCount=spLicenseErrCount, spFlowspecTimeout=spFlowspecTimeout, managedObjectUsageDone=managedObjectUsageDone, spHardwareFailureDescription=spHardwareFailureDescription, cloudSignalingFault=cloudSignalingFault, spScriptHost=spScriptHost, bgpUp=bgpUp, spcommFailure=spcommFailure, deviceTotalFlows=deviceTotalFlows, mitigationTMSStartV2=mitigationTMSStartV2, managedObjectUsage=managedObjectUsage, peakflowSPCMI=peakflowSPCMI, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptStart=spScriptStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholeNexthop=spBlackholeNexthop, bgpHijack=bgpHijack, spServiceElement=spServiceElement, spAlertID=spAlertID)
