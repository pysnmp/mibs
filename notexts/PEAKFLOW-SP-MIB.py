...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:51:28 2022
...
Gauge32, Counter32, NotificationType, Bits, MibIdentifier, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, iso, TimeTicks, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "NotificationType", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "iso", "TimeTicks", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spManagedObject=spManagedObject, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjects=spManagedObjects, hardwareFailure=hardwareFailure, serviceUsageDone=serviceUsageDone, bgpTrap=bgpTrap, interfaceUsageDone=interfaceUsageDone, spGreTunnelName=spGreTunnelName, spFingerprintSender=spFingerprintSender, spUnit=spUnit, spImpactPps=spImpactPps, snmpDown=snmpDown, spHijackLocal=spHijackLocal, alertScript=alertScript, collectorUp=collectorUp, bgpUp=bgpUp, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPMgr=peakflowSPMgr, dnsBaselineDone=dnsBaselineDone, spMitigationID=spMitigationID, spTMSCommunity=spTMSCommunity, spInetAddress=spInetAddress, bgpHijack=bgpHijack, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, trafficAutoMitigation=trafficAutoMitigation, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHardwareFailureDescription=spHardwareFailureDescription, spHijackAttr=spHijackAttr, autoclassifyStart=autoclassifyStart, spBGPEvent=spBGPEvent, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, managedObjectUsageDone=managedObjectUsageDone, spMitigationName=spMitigationName, mitigationBlackholeStart=mitigationBlackholeStart, notificationLimit=notificationLimit, spInetAddressType=spInetAddressType, serviceUsage=serviceUsage, devicePhysicalMemory=devicePhysicalMemory, spThirdPartyAddr=spThirdPartyAddr, spPravail=spPravail, spServiceElement=spServiceElement, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dnsBaseline=dnsBaseline, spInterfaceIndex=spInterfaceIndex, spScriptHost=spScriptHost, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPInstability=spBGPInstability, spSystemErrorDescription=spSystemErrorDescription, fingerprintUsageDone=fingerprintUsageDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spTMSPrefix=spTMSPrefix, spScriptPort=spScriptPort, spApplicationName=spApplicationName, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, snmpUp=snmpUp, mitigationFlowspecStart=mitigationFlowspecStart, cloudSignalingFault=cloudSignalingFault, spInterfaceUsage=spInterfaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPMIB=peakflowSPMIB, spCollector=spCollector, collectorStart=collectorStart, spGreTunnelDestination=spGreTunnelDestination, spBlackholeCommunity=spBlackholeCommunity, spBlackholeNexthop=spBlackholeNexthop, spBGPTrapEvent=spBGPTrapEvent, spScriptCommand=spScriptCommand, licenseErrorDone=licenseErrorDone, peakflowSPTraps=peakflowSPTraps, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, configChange=configChange, spImpactBps=spImpactBps, spThirdPartyZone=spThirdPartyZone, spLicenseErrType=spLicenseErrType, spSystemErrorType=spSystemErrorType, flowUp=flowUp, spCommFailureDestination=spCommFailureDestination, dosHostDetectionAlert=dosHostDetectionAlert, spAlertID=spAlertID, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSMultiPrefix=spTMSMultiPrefix, managedObjectUsage=managedObjectUsage, greDownDone=greDownDone, spLicenseErrDescription=spLicenseErrDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterface=spInterface, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, reportDone=reportDone, spDetector=spDetector, deviceHealth=deviceHealth, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, bgpDown=bgpDown, spServiceName=spServiceName, spMitigationStart=spMitigationStart, spManagedObjectFamily=spManagedObjectFamily, spDNSObservedMean=spDNSObservedMean, bgpInstability=bgpInstability, spDuration=spDuration, spFingerprintFeedback=spFingerprintFeedback, spScriptStart=spScriptStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsageType=spUsageType, PYSNMP_MODULE_ID=peakflowSPMIB, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterfaceSpeed=spInterfaceSpeed, spcommFailureDone=spcommFailureDone, deviceSystemError=deviceSystemError, spDNSName=spDNSName, spFingerprintMessage=spFingerprintMessage, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationDone=mitigationDone, spReportURL=spReportURL, spReportName=spReportName, spDNSExpected=spDNSExpected, spDNSObservedMax=spDNSObservedMax, deviceSwapSpace=deviceSwapSpace, mitigationTMSStart=mitigationTMSStart, spCommFailureDescription=spCommFailureDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThreshold=spThreshold, spLicenseErrLimit=spLicenseErrLimit, interfaceUsage=interfaceUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapName=spBGPTrapName, spUsage=spUsage, spBlackholeTimeout=spBlackholeTimeout, spFlowspecTimeout=spFlowspecTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholePrefix=spBlackholePrefix, licenseError=licenseError, flowDown=flowDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spVersion=spVersion, spFlowspecCommunity=spFlowspecCommunity, spRouter=spRouter, peakflowSPCMI=peakflowSPCMI, spcommFailure=spcommFailure, spUsername=spUsername, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, collectorDown=collectorDown, routingFailover=routingFailover, fingerprintFeedback=fingerprintFeedback, spBGPTrapPrefix=spBGPTrapPrefix, spTMSTimeout=spTMSTimeout, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrCount=spLicenseErrCount, deviceTotalFlows=deviceTotalFlows, fingerprintReceive=fingerprintReceive, deviceSystemErrorDone=deviceSystemErrorDone, spDetectedCountries=spDetectedCountries, spDNSObserved=spDNSObserved, hardwareFailureDone=hardwareFailureDone, fingerprintUsage=fingerprintUsage, spReportID=spReportID)
