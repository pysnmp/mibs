...
# Produced by pysmi-1.1.10 at Fri Nov 10 07:38:03 2023
...
Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, MibIdentifier, TimeTicks, NotificationType, Gauge32, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "Gauge32", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInetAddress=spInetAddress, spcommFailure=spcommFailure, collectorStart=collectorStart, spInterface=spInterface, dnsBaselineDone=dnsBaselineDone, deviceTotalFlows=deviceTotalFlows, spMitigationStart=spMitigationStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSystemErrorType=spSystemErrorType, snmpUp=snmpUp, licenseErrorDone=licenseErrorDone, spReportID=spReportID, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceDiskUsage=deviceDiskUsage, spLicenseErrCount=spLicenseErrCount, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spFlowspecCommunity=spFlowspecCommunity, spUsername=spUsername, managedObjectUsage=managedObjectUsage, fingerprintUsageDone=fingerprintUsageDone, peakflowSPTraps=peakflowSPTraps, collectorDown=collectorDown, spLicenseErrDescription=spLicenseErrDescription, spServiceName=spServiceName, spUnit=spUnit, spLicenseErrLimit=spLicenseErrLimit, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptCommand=spScriptCommand, autoclassifyStart=autoclassifyStart, trafficAutoMitigation=trafficAutoMitigation, spRouter=spRouter, alertScript=alertScript, flowUp=flowUp, spBGPTrapName=spBGPTrapName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrType=spLicenseErrType, interfaceUsage=interfaceUsage, greDown=greDown, spScriptHost=spScriptHost, spMitigationName=spMitigationName, spInetAddressType=spInetAddressType, spDetectedCountries=spDetectedCountries, spcommFailureDone=spcommFailureDone, spMitigationID=spMitigationID, spAlertID=spAlertID, spInterfaceSpeed=spInterfaceSpeed, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactPps=spImpactPps, spBlackholeCommunity=spBlackholeCommunity, spTMSPrefix=spTMSPrefix, spCommFailureDescription=spCommFailureDescription, peakflowSPMIB=peakflowSPMIB, devicePhysicalMemory=devicePhysicalMemory, spBlackholePrefix=spBlackholePrefix, spBlackholeTimeout=spBlackholeTimeout, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, flowDown=flowDown, managedObjectUsageDone=managedObjectUsageDone, mitigationBlackholeStart=mitigationBlackholeStart, spBGPTrapEvent=spBGPTrapEvent, interfaceUsageDone=interfaceUsageDone, serviceUsageDone=serviceUsageDone, spVersion=spVersion, spApplicationName=spApplicationName, fingerprintFeedback=fingerprintFeedback, spManagedObjects=spManagedObjects, spInterfaceSpeedHC=spInterfaceSpeedHC, spDNSExpected=spDNSExpected, licenseError=licenseError, spTMSMultiPrefix=spTMSMultiPrefix, spScriptStart=spScriptStart, spGreTunnelDestination=spGreTunnelDestination, spServiceElement=spServiceElement, spPravail=spPravail, spFlowspecTimeout=spFlowspecTimeout, spScriptPort=spScriptPort, spThirdPartyAddr=spThirdPartyAddr, spImpactBps=spImpactBps, mitigationTMSStart=mitigationTMSStart, spDuration=spDuration, spUsage=spUsage, hardwareFailureDone=hardwareFailureDone, peakflowSPMgr=peakflowSPMgr, spManagedObject=spManagedObject, spHijackAttr=spHijackAttr, spBGPEvent=spBGPEvent, spInterfaceUsageHC=spInterfaceUsageHC, snmpDown=snmpDown, spFingerprintMessage=spFingerprintMessage, bgpInstabilityDone=bgpInstabilityDone, configChange=configChange, fingerprintUsage=fingerprintUsage, PYSNMP_MODULE_ID=peakflowSPMIB, fingerprintReceive=fingerprintReceive, spDNSObservedMean=spDNSObservedMean, spReportName=spReportName, spFingerprintName=spFingerprintName, deviceSystemError=deviceSystemError, spThirdPartyZone=spThirdPartyZone, routingFailover=routingFailover, spInterfaceUsage=spInterfaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, bgpTrap=bgpTrap, greDownDone=greDownDone, bgpDown=bgpDown, deviceHealth=deviceHealth, spDNSObservedMax=spDNSObservedMax, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spUsageType=spUsageType, spFingerprintSender=spFingerprintSender, spSystemErrorDescription=spSystemErrorDescription, dnsBaseline=dnsBaseline, collectorUp=collectorUp, reportDone=reportDone, spReportURL=spReportURL, spDNSName=spDNSName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spCollector=spCollector, spBGPTrapPrefix=spBGPTrapPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpUp=bgpUp, spBGPInstability=spBGPInstability, spTMSTimeout=spTMSTimeout, notificationLimit=notificationLimit, spManagedObjectFamily=spManagedObjectFamily, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPCMI=peakflowSPCMI, hardwareFailure=hardwareFailure, spThreshold=spThreshold, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDNSObserved=spDNSObserved, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSystemErrorDone=deviceSystemErrorDone, spHijackRoute=spHijackRoute, spDetector=spDetector, serviceUsage=serviceUsage, spGreTunnelName=spGreTunnelName, spCommFailureDestination=spCommFailureDestination, deviceSwapSpace=deviceSwapSpace, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterfaceIndex=spInterfaceIndex, mitigationDone=mitigationDone, spHardwareFailureDescription=spHardwareFailureDescription, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, mitigationTMSStartV2=mitigationTMSStartV2, bgpHijack=bgpHijack, spBlackholeNexthop=spBlackholeNexthop, spFingerprintFeedback=spFingerprintFeedback, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, cloudSignalingFault=cloudSignalingFault, bgpInstability=bgpInstability, spHijackLocal=spHijackLocal)
