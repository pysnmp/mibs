...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:40:26 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, IpAddress, iso, Unsigned32, Gauge32, Counter64, NotificationType, TimeTicks, MibIdentifier, Integer32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "IpAddress", "iso", "Unsigned32", "Gauge32", "Counter64", "NotificationType", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationThirdPartyStart=mitigationThirdPartyStart, spInetAddressType=spInetAddressType, deviceSystemError=deviceSystemError, spHijackAttr=spHijackAttr, spUnit=spUnit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObjects=spManagedObjects, spLicenseErrLimit=spLicenseErrLimit, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, serviceUsageDone=serviceUsageDone, spBGPInstability=spBGPInstability, spDuration=spDuration, spHijackLocal=spHijackLocal, peakflowSPTraps=peakflowSPTraps, mitigationDone=mitigationDone, peakflowSPCMI=peakflowSPCMI, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpInstability=bgpInstability, spScriptCommand=spScriptCommand, spUsage=spUsage, spCollector=spCollector, spcommFailureDone=spcommFailureDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsername=spUsername, mitigationBlackholeStart=mitigationBlackholeStart, snmpDown=snmpDown, collectorStart=collectorStart, deviceTotalFlows=deviceTotalFlows, autoclassifyStart=autoclassifyStart, hardwareFailure=hardwareFailure, alertScript=alertScript, spApplicationName=spApplicationName, spReportID=spReportID, bgpDown=bgpDown, spFingerprintName=spFingerprintName, spInterfaceIndex=spInterfaceIndex, mitigationTMSStartV2=mitigationTMSStartV2, mitigationFlowspecStart=mitigationFlowspecStart, peakflowSPMIB=peakflowSPMIB, reportDone=reportDone, spDNSObservedMax=spDNSObservedMax, routingFailover=routingFailover, spDNSObserved=spDNSObserved, dnsBaselineDone=dnsBaselineDone, licenseErrorDone=licenseErrorDone, spThirdPartyZone=spThirdPartyZone, spThirdPartyAddr=spThirdPartyAddr, spLicenseErrType=spLicenseErrType, spTMSTimeout=spTMSTimeout, managedObjectUsageDone=managedObjectUsageDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, flowUp=flowUp, spServiceElement=spServiceElement, spPravail=spPravail, spBlackholeTimeout=spBlackholeTimeout, collectorUp=collectorUp, spReportName=spReportName, spRouter=spRouter, spGreTunnelDestination=spGreTunnelDestination, spHijackRoute=spHijackRoute, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSPrefix=spTMSPrefix, spCommFailureDescription=spCommFailureDescription, spBlackholeNexthop=spBlackholeNexthop, spcommFailure=spcommFailure, spDetector=spDetector, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceSpeedHC=spInterfaceSpeedHC, spManagedObjectFamily=spManagedObjectFamily, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSName=spDNSName, spFingerprintSender=spFingerprintSender, spGreTunnelName=spGreTunnelName, spMitigationID=spMitigationID, spInterfaceUsage=spInterfaceUsage, fingerprintUsage=fingerprintUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceDiskUsage=deviceDiskUsage, managedObjectUsage=managedObjectUsage, interfaceUsageDone=interfaceUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceHealth=deviceHealth, dnsBaseline=dnsBaseline, cloudSignalingFaultDone=cloudSignalingFaultDone, spInetAddress=spInetAddress, spServiceName=spServiceName, spAlertDetectionSignatures=spAlertDetectionSignatures, spMitigationName=spMitigationName, snmpUp=snmpUp, spFingerprintMessage=spFingerprintMessage, spBlackholePrefix=spBlackholePrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpUp=bgpUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, notificationLimit=notificationLimit, spBGPTrapEvent=spBGPTrapEvent, spBGPEvent=spBGPEvent, peakflowSPMgr=peakflowSPMgr, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterface=spInterface, mitigationTMSStart=mitigationTMSStart, trafficAutoMitigation=trafficAutoMitigation, deviceSwapSpace=deviceSwapSpace, spTMSCommunity=spTMSCommunity, fingerprintFeedback=fingerprintFeedback, spFingerprintFeedback=spFingerprintFeedback, greDown=greDown, fingerprintUsageDone=fingerprintUsageDone, spHardwareFailureDescription=spHardwareFailureDescription, spCommFailureDestination=spCommFailureDestination, PYSNMP_MODULE_ID=peakflowSPMIB, spUsageType=spUsageType, spVersion=spVersion, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDownDone=greDownDone, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsage=serviceUsage, bgpInstabilityDone=bgpInstabilityDone, fingerprintReceive=fingerprintReceive, bgpHijack=bgpHijack, spInterfaceSpeed=spInterfaceSpeed, spScriptStart=spScriptStart, bgpTrap=bgpTrap, spManagedObject=spManagedObject, spSystemErrorDescription=spSystemErrorDescription, spFlowspecTimeout=spFlowspecTimeout, spMitigationStart=spMitigationStart, cloudSignalingFault=cloudSignalingFault, spBGPTrapName=spBGPTrapName, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemory=devicePhysicalMemory, spThreshold=spThreshold, configChange=configChange, spSystemErrorType=spSystemErrorType, spImpactBps=spImpactBps, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMean=spDNSObservedMean, hardwareFailureDone=hardwareFailureDone, spAlertID=spAlertID, spFlowspecCommunity=spFlowspecCommunity, flowDown=flowDown, spBlackholeCommunity=spBlackholeCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapPrefix=spBGPTrapPrefix, spImpactPps=spImpactPps, collectorDown=collectorDown, spDNSExpected=spDNSExpected, spScriptPort=spScriptPort, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseError=licenseError, spScriptHost=spScriptHost, spReportURL=spReportURL, interfaceUsage=interfaceUsage, spInterfaceUsageHC=spInterfaceUsageHC)
