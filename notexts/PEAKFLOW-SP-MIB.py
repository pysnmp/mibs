...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:36:43 2023
...
NotificationType, IpAddress, Gauge32, MibIdentifier, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, iso, ObjectIdentity, Unsigned32, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "iso", "ObjectIdentity", "Unsigned32", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThirdPartyAddr=spThirdPartyAddr, spReportURL=spReportURL, spScriptStart=spScriptStart, spLicenseErrLimit=spLicenseErrLimit, bgpInstability=bgpInstability, spThirdPartyZone=spThirdPartyZone, flowUp=flowUp, serviceUsageDone=serviceUsageDone, spDetectedCountries=spDetectedCountries, peakflowSPCMI=peakflowSPCMI, collectorDown=collectorDown, peakflowSPTraps=peakflowSPTraps, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, dnsBaseline=dnsBaseline, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterfaceUsage=spInterfaceUsage, spServiceElement=spServiceElement, spApplicationName=spApplicationName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spManagedObjects=spManagedObjects, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCollector=spCollector, spInterfaceIndex=spInterfaceIndex, spBGPTrapName=spBGPTrapName, spUsage=spUsage, bgpDown=bgpDown, spReportName=spReportName, fingerprintReceive=fingerprintReceive, spInterfaceUsageHC=spInterfaceUsageHC, spDetector=spDetector, spFingerprintFeedback=spFingerprintFeedback, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, spSystemErrorType=spSystemErrorType, interfaceUsageDone=interfaceUsageDone, spHijackAttr=spHijackAttr, deviceHealth=deviceHealth, devicePhysicalMemory=devicePhysicalMemory, hardwareFailureDone=hardwareFailureDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, snmpDown=snmpDown, bgpInstabilityDone=bgpInstabilityDone, spMitigationID=spMitigationID, licenseError=licenseError, spBlackholeNexthop=spBlackholeNexthop, spDNSExpected=spDNSExpected, spBGPEvent=spBGPEvent, spLicenseErrType=spLicenseErrType, spMitigationStart=spMitigationStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spLicenseErrCount=spLicenseErrCount, cloudSignalingFault=cloudSignalingFault, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceDiskUsage=deviceDiskUsage, spGreTunnelName=spGreTunnelName, autoclassifyStart=autoclassifyStart, bgpHijack=bgpHijack, deviceSwapSpace=deviceSwapSpace, spUsername=spUsername, interfaceUsage=interfaceUsage, alertScript=alertScript, spMitigationName=spMitigationName, bgpUp=bgpUp, spSystemErrorDescription=spSystemErrorDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBlackholePrefix=spBlackholePrefix, reportDone=reportDone, spDNSObserved=spDNSObserved, spInetAddressType=spInetAddressType, serviceUsage=serviceUsage, spVersion=spVersion, mitigationTMSStart=mitigationTMSStart, licenseErrorDone=licenseErrorDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dnsBaselineDone=dnsBaselineDone, mitigationBlackholeStart=mitigationBlackholeStart, routingFailover=routingFailover, managedObjectUsage=managedObjectUsage, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailure=spcommFailure, spReportID=spReportID, spThreshold=spThreshold, hardwareFailure=hardwareFailure, spTMSMultiPrefix=spTMSMultiPrefix, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceSpeed=spInterfaceSpeed, fingerprintUsage=fingerprintUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpTrap=bgpTrap, peakflowSPMgr=peakflowSPMgr, snmpUp=snmpUp, spTMSPrefix=spTMSPrefix, flowDown=flowDown, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObject=spManagedObject, spUnit=spUnit, spDNSObservedMax=spDNSObservedMax, spRouter=spRouter, deviceSystemError=deviceSystemError, spScriptHost=spScriptHost, spHardwareFailureDescription=spHardwareFailureDescription, greDown=greDown, spHijackLocal=spHijackLocal, spTMSCommunity=spTMSCommunity, spTMSTimeout=spTMSTimeout, spCommFailureDestination=spCommFailureDestination, spHijackRoute=spHijackRoute, spUsageType=spUsageType, spGreTunnelDestination=spGreTunnelDestination, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPInstability=spBGPInstability, spScriptCommand=spScriptCommand, spFingerprintName=spFingerprintName, spcommFailureDone=spcommFailureDone, spDNSObservedMean=spDNSObservedMean, deviceTotalFlowsHC=deviceTotalFlowsHC, spImpactBps=spImpactBps, configChange=configChange, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintFeedback=fingerprintFeedback, spAlertID=spAlertID, spFlowspecTimeout=spFlowspecTimeout, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationFlowspecStart=mitigationFlowspecStart, spDuration=spDuration, deviceTotalFlows=deviceTotalFlows, spImpactPps=spImpactPps, greDownDone=greDownDone, spFingerprintMessage=spFingerprintMessage, spAlertDetectionSignatures=spAlertDetectionSignatures, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, collectorUp=collectorUp, peakflowSPMIB=peakflowSPMIB, fingerprintUsageDone=fingerprintUsageDone, spPravail=spPravail, notificationLimit=notificationLimit, spCommFailureDescription=spCommFailureDescription, trafficAutoMitigation=trafficAutoMitigation, spBlackholeCommunity=spBlackholeCommunity, spFingerprintSender=spFingerprintSender, mitigationDone=mitigationDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, managedObjectUsageDone=managedObjectUsageDone, spBlackholeTimeout=spBlackholeTimeout, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spServiceName=spServiceName, spLicenseErrDescription=spLicenseErrDescription, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapPrefix=spBGPTrapPrefix, collectorStart=collectorStart, spBGPTrapEvent=spBGPTrapEvent, spScriptPort=spScriptPort, spDNSName=spDNSName, spInetAddress=spInetAddress)
