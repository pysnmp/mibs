...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:02:14 2023
...
Counter32, Gauge32, Unsigned32, iso, Counter64, Bits, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "Unsigned32", "iso", "Counter64", "Bits", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHijackAttr=spHijackAttr, spCommFailureDescription=spCommFailureDescription, spManagedObjectFamily=spManagedObjectFamily, spDNSName=spDNSName, spReportID=spReportID, fingerprintFeedback=fingerprintFeedback, spBlackholeTimeout=spBlackholeTimeout, spInetAddress=spInetAddress, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPTraps=peakflowSPTraps, trafficAutoMitigation=trafficAutoMitigation, spBlackholeNexthop=spBlackholeNexthop, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSMultiPrefix=spTMSMultiPrefix, managedObjectUsageDone=managedObjectUsageDone, bgpInstability=bgpInstability, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spHardwareFailureDescription=spHardwareFailureDescription, spBGPEvent=spBGPEvent, spFlowspecCommunity=spFlowspecCommunity, collectorUp=collectorUp, spDuration=spDuration, devicePhysicalMemory=devicePhysicalMemory, spMitigationStart=spMitigationStart, spInterfaceSpeed=spInterfaceSpeed, mitigationTMSStart=mitigationTMSStart, spRouter=spRouter, spSystemErrorType=spSystemErrorType, spBGPTrapPrefix=spBGPTrapPrefix, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spServiceElement=spServiceElement, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThirdPartyAddr=spThirdPartyAddr, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintMessage=spFingerprintMessage, spGreTunnelDestination=spGreTunnelDestination, mitigationFlowspecStart=mitigationFlowspecStart, spcommFailureDone=spcommFailureDone, spBGPInstability=spBGPInstability, spMitigationID=spMitigationID, peakflowSPMIB=peakflowSPMIB, spInterfaceIndex=spInterfaceIndex, bgpUp=bgpUp, managedObjectUsage=managedObjectUsage, hardwareFailureDone=hardwareFailureDone, spManagedObjects=spManagedObjects, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spMitigationName=spMitigationName, snmpDown=snmpDown, dnsBaselineDone=dnsBaselineDone, greDownDone=greDownDone, bgpInstabilityDone=bgpInstabilityDone, spDNSObservedMax=spDNSObservedMax, greDown=greDown, spUsername=spUsername, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsage=interfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, spApplicationName=spApplicationName, spManagedObject=spManagedObject, mitigationDone=mitigationDone, autoclassifyStart=autoclassifyStart, bgpTrap=bgpTrap, spTMSPrefix=spTMSPrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsageType=spUsageType, spCommFailureDestination=spCommFailureDestination, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationThirdPartyStart=mitigationThirdPartyStart, bgpDown=bgpDown, spcommFailure=spcommFailure, spDetector=spDetector, spHijackRoute=spHijackRoute, fingerprintUsage=fingerprintUsage, spDNSObserved=spDNSObserved, deviceTotalFlowsHC=deviceTotalFlowsHC, dnsBaseline=dnsBaseline, spThreshold=spThreshold, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseErrorDone=licenseErrorDone, spLicenseErrDescription=spLicenseErrDescription, spCollector=spCollector, configChange=configChange, spFingerprintFeedback=spFingerprintFeedback, deviceSystemError=deviceSystemError, spFingerprintSender=spFingerprintSender, spLicenseErrType=spLicenseErrType, spDNSObservedMean=spDNSObservedMean, interfaceUsageDone=interfaceUsageDone, serviceUsageDone=serviceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDetectedCountries=spDetectedCountries, spThirdPartyZone=spThirdPartyZone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, snmpUp=snmpUp, spScriptPort=spScriptPort, spInterfaceUsage=spInterfaceUsage, deviceSystemErrorDone=deviceSystemErrorDone, spHijackLocal=spHijackLocal, peakflowSPCMI=peakflowSPCMI, spReportName=spReportName, peakflowSPMgr=peakflowSPMgr, spGreTunnelName=spGreTunnelName, flowDown=flowDown, spScriptCommand=spScriptCommand, spTMSTimeout=spTMSTimeout, spDNSExpected=spDNSExpected, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, licenseError=licenseError, deviceTotalFlows=deviceTotalFlows, spBlackholeCommunity=spBlackholeCommunity, alertScript=alertScript, routingFailover=routingFailover, deviceDiskUsage=deviceDiskUsage, deviceSwapSpace=deviceSwapSpace, spBGPTrapEvent=spBGPTrapEvent, spInterface=spInterface, notificationLimit=notificationLimit, flowUp=flowUp, spAlertID=spAlertID, cloudSignalingFault=cloudSignalingFault, spBlackholePrefix=spBlackholePrefix, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spLicenseErrCount=spLicenseErrCount, hardwareFailure=hardwareFailure, bgpHijack=bgpHijack, spServiceName=spServiceName, spBGPTrapName=spBGPTrapName, collectorStart=collectorStart, spInterfaceSpeedHC=spInterfaceSpeedHC, spUnit=spUnit, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spScriptHost=spScriptHost, spSystemErrorDescription=spSystemErrorDescription, reportDone=reportDone, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceHealth=deviceHealth, spScriptStart=spScriptStart, spUsage=spUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, dosHostDetectionAlert=dosHostDetectionAlert, spPravail=spPravail, serviceUsage=serviceUsage, spLicenseErrLimit=spLicenseErrLimit, spFingerprintName=spFingerprintName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spReportURL=spReportURL, spTMSCommunity=spTMSCommunity, spInetAddressType=spInetAddressType, spImpactBps=spImpactBps, spVersion=spVersion, spFlowspecTimeout=spFlowspecTimeout, collectorDown=collectorDown, spImpactPps=spImpactPps)
