...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:12:50 2023
...
NotificationType, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, TimeTicks, Gauge32, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "TimeTicks", "Gauge32", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spAlertDetectionSignatures=spAlertDetectionSignatures, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spManagedObjects=spManagedObjects, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBlackholeCommunity=spBlackholeCommunity, spScriptHost=spScriptHost, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemory=devicePhysicalMemory, spTMSPrefix=spTMSPrefix, spSystemErrorType=spSystemErrorType, mitigationDone=mitigationDone, spServiceElement=spServiceElement, serviceUsage=serviceUsage, spGreTunnelName=spGreTunnelName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrCount=spLicenseErrCount, spUsageType=spUsageType, dosHostDetectionAlert=dosHostDetectionAlert, collectorDown=collectorDown, spcommFailure=spcommFailure, bgpTrap=bgpTrap, mitigationTMSStartV2=mitigationTMSStartV2, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptCommand=spScriptCommand, spcommFailureDone=spcommFailureDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spReportName=spReportName, spFingerprintMessage=spFingerprintMessage, managedObjectUsageDone=managedObjectUsageDone, autoclassifyStart=autoclassifyStart, spInetAddress=spInetAddress, greDownDone=greDownDone, spDetector=spDetector, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeed=spInterfaceSpeed, configChange=configChange, spInterface=spInterface, spFingerprintName=spFingerprintName, spCommFailureDescription=spCommFailureDescription, spApplicationName=spApplicationName, deviceSystemError=deviceSystemError, spDuration=spDuration, spFlowspecTimeout=spFlowspecTimeout, spTMSCommunity=spTMSCommunity, spTMSMultiPrefix=spTMSMultiPrefix, fingerprintUsageDone=fingerprintUsageDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spSystemErrorDescription=spSystemErrorDescription, licenseErrorDone=licenseErrorDone, spFingerprintFeedback=spFingerprintFeedback, fingerprintReceive=fingerprintReceive, spReportID=spReportID, dnsBaselineDone=dnsBaselineDone, spManagedObject=spManagedObject, notificationLimit=notificationLimit, bgpInstability=bgpInstability, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, greDown=greDown, peakflowSPMgr=peakflowSPMgr, reportDone=reportDone, cloudSignalingFault=cloudSignalingFault, spLicenseErrType=spLicenseErrType, spDNSExpected=spDNSExpected, flowDown=flowDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBlackholePrefix=spBlackholePrefix, spInterfaceIndex=spInterfaceIndex, serviceUsageDone=serviceUsageDone, spPravail=spPravail, licenseError=licenseError, spRouter=spRouter, spInterfaceUsage=spInterfaceUsage, fingerprintUsage=fingerprintUsage, spHijackLocal=spHijackLocal, deviceSwapSpace=deviceSwapSpace, flowUp=flowUp, spBGPTrapPrefix=spBGPTrapPrefix, collectorStart=collectorStart, interfaceUsageDone=interfaceUsageDone, spTMSTimeout=spTMSTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInetAddressType=spInetAddressType, spThreshold=spThreshold, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationThirdPartyStart=mitigationThirdPartyStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailover=routingFailover, spUsername=spUsername, spUsage=spUsage, deviceHealth=deviceHealth, spLicenseErrLimit=spLicenseErrLimit, spDetectedCountries=spDetectedCountries, spInterfaceUsageHC=spInterfaceUsageHC, snmpUp=snmpUp, bgpUp=bgpUp, spUnit=spUnit, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObjectFamily=spManagedObjectFamily, collectorUp=collectorUp, spMitigationID=spMitigationID, spLicenseErrDescription=spLicenseErrDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spGreTunnelDestination=spGreTunnelDestination, managedObjectUsage=managedObjectUsage, hardwareFailureDone=hardwareFailureDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, hardwareFailure=hardwareFailure, spCommFailureDestination=spCommFailureDestination, spBGPInstability=spBGPInstability, spImpactPps=spImpactPps, peakflowSPMIB=peakflowSPMIB, alertScript=alertScript, spFlowspecCommunity=spFlowspecCommunity, spAlertID=spAlertID, deviceTotalFlowsHC=deviceTotalFlowsHC, spVersion=spVersion, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpHijack=bgpHijack, interfaceUsage=interfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, fingerprintFeedback=fingerprintFeedback, spMitigationName=spMitigationName, spReportURL=spReportURL, spBlackholeNexthop=spBlackholeNexthop, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spHijackAttr=spHijackAttr, spServiceName=spServiceName, spImpactBps=spImpactBps, bgpInstabilityDone=bgpInstabilityDone, spBlackholeTimeout=spBlackholeTimeout, spBGPEvent=spBGPEvent, deviceTotalFlows=deviceTotalFlows, spScriptStart=spScriptStart, dnsBaseline=dnsBaseline, spHijackRoute=spHijackRoute, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSObserved=spDNSObserved, spCollector=spCollector, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationStart=spMitigationStart, spBGPTrapName=spBGPTrapName, peakflowSPCMI=peakflowSPCMI, bgpDown=bgpDown, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStart=mitigationTMSStart, spDNSObservedMax=spDNSObservedMax, spScriptPort=spScriptPort, spFingerprintSender=spFingerprintSender, snmpDown=snmpDown, trafficAutoMitigation=trafficAutoMitigation, spDNSObservedMean=spDNSObservedMean, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPTraps=peakflowSPTraps, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDNSName=spDNSName, spThirdPartyZone=spThirdPartyZone)
