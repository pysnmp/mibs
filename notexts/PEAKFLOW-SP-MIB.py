...
TimeTicks, Counter32, Bits, IpAddress, iso, ModuleIdentity, ObjectIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Bits", "IpAddress", "iso", "ModuleIdentity", "ObjectIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spSystemErrorType=spSystemErrorType, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceTotalFlows=deviceTotalFlows, spApplicationName=spApplicationName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSCommunity=spTMSCommunity, spDuration=spDuration, spBGPEvent=spBGPEvent, spInterfaceUsageHC=spInterfaceUsageHC, spBGPInstability=spBGPInstability, fingerprintReceive=fingerprintReceive, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsage=fingerprintUsage, spDNSObservedMax=spDNSObservedMax, spThirdPartyAddr=spThirdPartyAddr, cloudSignalingFaultDone=cloudSignalingFaultDone, spUnit=spUnit, spInterfaceIndex=spInterfaceIndex, spImpactBps=spImpactBps, spDNSObservedMean=spDNSObservedMean, spScriptStart=spScriptStart, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, bgpInstability=bgpInstability, spCommFailureDestination=spCommFailureDestination, spLicenseErrType=spLicenseErrType, spImpactPps=spImpactPps, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPCMI=peakflowSPCMI, spMitigationName=spMitigationName, spFlowspecTimeout=spFlowspecTimeout, dosHostDetectionAlert=dosHostDetectionAlert, notificationLimit=notificationLimit, spFingerprintName=spFingerprintName, serviceUsage=serviceUsage, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptPort=spScriptPort, collectorUp=collectorUp, spThirdPartyZone=spThirdPartyZone, spMitigationStart=spMitigationStart, spGreTunnelDestination=spGreTunnelDestination, snmpUp=snmpUp, fingerprintFeedback=fingerprintFeedback, configChange=configChange, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjects=spManagedObjects, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapName=spBGPTrapName, spServiceElement=spServiceElement, spRouter=spRouter, deviceDiskUsage=deviceDiskUsage, spDetector=spDetector, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDown=greDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSName=spDNSName, spManagedObject=spManagedObject, spVersion=spVersion, mitigationBlackholeStart=mitigationBlackholeStart, spInterface=spInterface, licenseErrorDone=licenseErrorDone, spMitigationID=spMitigationID, managedObjectUsage=managedObjectUsage, deviceHealth=deviceHealth, spFingerprintMessage=spFingerprintMessage, spAlertDetectionSignatures=spAlertDetectionSignatures, spReportName=spReportName, spBlackholeNexthop=spBlackholeNexthop, bgpUp=bgpUp, spBGPTrapOldAttributes=spBGPTrapOldAttributes, routingFailover=routingFailover, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spPravail=spPravail, spBlackholeTimeout=spBlackholeTimeout, mitigationTMSStart=mitigationTMSStart, fingerprintUsageDone=fingerprintUsageDone, spInterfaceSpeed=spInterfaceSpeed, bgpDown=bgpDown, mitigationDone=mitigationDone, spServiceName=spServiceName, peakflowSPTraps=peakflowSPTraps, spAlertID=spAlertID, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapEvent=spBGPTrapEvent, serviceUsageDone=serviceUsageDone, spDNSExpected=spDNSExpected, spInterfaceUsage=spInterfaceUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, devicePhysicalMemory=devicePhysicalMemory, spHijackAttr=spHijackAttr, spHardwareFailureDescription=spHardwareFailureDescription, interfaceUsage=interfaceUsage, bgpTrap=bgpTrap, spcommFailureDone=spcommFailureDone, spCollector=spCollector, bgpInstabilityDone=bgpInstabilityDone, peakflowSPMIB=peakflowSPMIB, spLicenseErrCount=spLicenseErrCount, trafficAutoMitigation=trafficAutoMitigation, spFingerprintSender=spFingerprintSender, deviceSystemError=deviceSystemError, managedObjectUsageDone=managedObjectUsageDone, mitigationThirdPartyStart=mitigationThirdPartyStart, spTMSMultiPrefix=spTMSMultiPrefix, hardwareFailure=hardwareFailure, spReportID=spReportID, spLicenseErrDescription=spLicenseErrDescription, spGreTunnelName=spGreTunnelName, spInterfaceSpeedHC=spInterfaceSpeedHC, spBlackholePrefix=spBlackholePrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailure=spcommFailure, dnsBaseline=dnsBaseline, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, deviceSwapSpace=deviceSwapSpace, reportDone=reportDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spLicenseErrLimit=spLicenseErrLimit, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spHijackLocal=spHijackLocal, spFlowspecCommunity=spFlowspecCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSObserved=spDNSObserved, greDownDone=greDownDone, cloudSignalingFault=cloudSignalingFault, spTMSPrefix=spTMSPrefix, spBGPTrapPrefix=spBGPTrapPrefix, spCommFailureDescription=spCommFailureDescription, spSystemErrorDescription=spSystemErrorDescription, spScriptCommand=spScriptCommand, collectorDown=collectorDown, spUsername=spUsername, spThreshold=spThreshold, spManagedObjectFamily=spManagedObjectFamily, bgpHijack=bgpHijack, spInetAddressType=spInetAddressType, hardwareFailureDone=hardwareFailureDone, spDetectedCountries=spDetectedCountries, flowDown=flowDown, flowUp=flowUp, spTMSTimeout=spTMSTimeout, peakflowSPMgr=peakflowSPMgr, licenseError=licenseError, spUsage=spUsage, spReportURL=spReportURL, spBlackholeCommunity=spBlackholeCommunity, alertScript=alertScript, dosHostDetectionAlertDone=dosHostDetectionAlertDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, collectorStart=collectorStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInetAddress=spInetAddress, snmpDown=snmpDown, spHijackRoute=spHijackRoute, dnsBaselineDone=dnsBaselineDone, spScriptHost=spScriptHost, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse)
