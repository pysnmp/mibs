...
pdosAnomalyDuration, pdosAnomalyClassification, pdosAnomalyDirection, pdosAnomalyStart, pdosUrl = mibBuilder.importSymbols("PEAKFLOW-DOS-MIB", "pdosAnomalyDuration", "pdosAnomalyClassification", "pdosAnomalyDirection", "pdosAnomalyStart", "pdosUrl")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrType=spLicenseErrType, spBlackholeCommunity=spBlackholeCommunity, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spSystemErrorDescription=spSystemErrorDescription, spTMSMultiPrefix=spTMSMultiPrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, spMitigationName=spMitigationName, spHijackAttr=spHijackAttr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, snmpUp=snmpUp, spcommFailure=spcommFailure, spCollector=spCollector, spScriptHost=spScriptHost, spManagedObjects=spManagedObjects, bgpInstabilityDone=bgpInstabilityDone, spThirdPartyZone=spThirdPartyZone, spImpactPps=spImpactPps, spSystemErrorType=spSystemErrorType, spHijackRoute=spHijackRoute, fingerprintFeedback=fingerprintFeedback, spTMSPrefix=spTMSPrefix, spInetAddressType=spInetAddressType, bgpInstability=bgpInstability, bgpHijack=bgpHijack, spTMSTimeout=spTMSTimeout, dnsBaselineDone=dnsBaselineDone, spLicenseErrDescription=spLicenseErrDescription, interfaceUsage=interfaceUsage, routingFailover=routingFailover, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spMitigationID=spMitigationID, spTMSCommunity=spTMSCommunity, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, fingerprintUsage=fingerprintUsage, interfaceUsageDone=interfaceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterface=spInterface, spAlertID=spAlertID, spBGPTrapName=spBGPTrapName, spBlackholePrefix=spBlackholePrefix, spFlowspecCommunity=spFlowspecCommunity, serviceUsage=serviceUsage, spBGPTrapEvent=spBGPTrapEvent, spBlackholeNexthop=spBlackholeNexthop, deviceTotalFlowsHC=deviceTotalFlowsHC, flowDown=flowDown, spFingerprintName=spFingerprintName, managedObjectUsageDone=managedObjectUsageDone, deviceTotalFlows=deviceTotalFlows, cloudSignalingFault=cloudSignalingFault, hardwareFailure=hardwareFailure, spUsageType=spUsageType, spDNSObserved=spDNSObserved, spPravail=spPravail, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDuration=spDuration, spVersion=spVersion, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPInstability=spBGPInstability, peakflowSPMgr=peakflowSPMgr, trafficAutoMitigation=trafficAutoMitigation, mitigationTMSStart=mitigationTMSStart, alertScript=alertScript, spInterfaceIndex=spInterfaceIndex, spLicenseErrLimit=spLicenseErrLimit, spInetAddress=spInetAddress, spDNSExpected=spDNSExpected, collectorUp=collectorUp, spGreTunnelName=spGreTunnelName, spScriptStart=spScriptStart, flowUp=flowUp, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpDown=bgpDown, spReportID=spReportID, deviceSystemErrorDone=deviceSystemErrorDone, spUsername=spUsername, snmpDown=snmpDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUnit=spUnit, bgpTrap=bgpTrap, fingerprintUsageDone=fingerprintUsageDone, dnsBaseline=dnsBaseline, peakflowSPTraps=peakflowSPTraps, spRouter=spRouter, spUsage=spUsage, spDetector=spDetector, greDown=greDown, peakflowSPMIB=peakflowSPMIB, spMitigationStart=spMitigationStart, spThreshold=spThreshold, spDNSName=spDNSName, bgpUp=bgpUp, spBGPTrapPrefix=spBGPTrapPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, collectorStart=collectorStart, spBlackholeTimeout=spBlackholeTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spHardwareFailureDescription=spHardwareFailureDescription, spImpactBps=spImpactBps, licenseError=licenseError, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportName=spReportName, spDetectedCountries=spDetectedCountries, fingerprintReceive=fingerprintReceive, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFingerprintFeedback=spFingerprintFeedback, devicePhysicalMemory=devicePhysicalMemory, spBGPEvent=spBGPEvent, dosHostDetectionAlert=dosHostDetectionAlert, spReportURL=spReportURL, spDNSObservedMax=spDNSObservedMax, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationFlowspecStart=mitigationFlowspecStart, spScriptCommand=spScriptCommand, autoclassifyStart=autoclassifyStart, spFingerprintMessage=spFingerprintMessage, greDownDone=greDownDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, notificationLimit=notificationLimit, collectorDown=collectorDown, serviceUsageDone=serviceUsageDone, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, reportDone=reportDone, mitigationDone=mitigationDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSObservedMean=spDNSObservedMean, spServiceElement=spServiceElement, licenseErrorDone=licenseErrorDone, spLicenseErrCount=spLicenseErrCount, spHijackLocal=spHijackLocal, deviceHealth=deviceHealth, spGreTunnelDestination=spGreTunnelDestination, spFingerprintSender=spFingerprintSender, spManagedObject=spManagedObject, spThirdPartyAddr=spThirdPartyAddr, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, configChange=configChange, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceDiskUsage=deviceDiskUsage, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceUsage=spInterfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemError=deviceSystemError, deviceSwapSpace=deviceSwapSpace, managedObjectUsage=managedObjectUsage, spcommFailureDone=spcommFailureDone, hardwareFailureDone=hardwareFailureDone, spApplicationName=spApplicationName, spInterfaceSpeed=spInterfaceSpeed, spServiceName=spServiceName, peakflowSPCMI=peakflowSPCMI, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptPort=spScriptPort, spCommFailureDescription=spCommFailureDescription, spManagedObjectFamily=spManagedObjectFamily, spFlowspecTimeout=spFlowspecTimeout, spInterfaceUsageHC=spInterfaceUsageHC, spCommFailureDestination=spCommFailureDestination)
