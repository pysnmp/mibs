...
iso, IpAddress, NotificationType, Counter32, Counter64, ObjectIdentity, Unsigned32, Integer32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "NotificationType", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrLimit=spLicenseErrLimit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, peakflowSPCMI=peakflowSPCMI, spPravail=spPravail, spUsageType=spUsageType, mitigationBlackholeStart=mitigationBlackholeStart, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spSystemErrorType=spSystemErrorType, bgpUp=bgpUp, spReportID=spReportID, spDNSObserved=spDNSObserved, licenseError=licenseError, mitigationTMSStartV2=mitigationTMSStartV2, routingFailover=routingFailover, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spLicenseErrType=spLicenseErrType, spHijackLocal=spHijackLocal, spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapPrefix=spBGPTrapPrefix, deviceTotalFlowsHC=deviceTotalFlowsHC, spCommFailureDescription=spCommFailureDescription, spInetAddress=spInetAddress, spManagedObjects=spManagedObjects, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, notificationLimit=notificationLimit, spBlackholeCommunity=spBlackholeCommunity, bgpHijack=bgpHijack, deviceDiskUsage=deviceDiskUsage, bgpInstability=bgpInstability, spcommFailureDone=spcommFailureDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrDescription=spLicenseErrDescription, mitigationThirdPartyStart=mitigationThirdPartyStart, greDown=greDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, fingerprintUsage=fingerprintUsage, spInetAddressType=spInetAddressType, spRouter=spRouter, deviceSystemErrorDone=deviceSystemErrorDone, spTMSMultiPrefix=spTMSMultiPrefix, spMitigationStart=spMitigationStart, peakflowSPMIB=peakflowSPMIB, bgpInstabilityDone=bgpInstabilityDone, interfaceUsageDone=interfaceUsageDone, fingerprintFeedback=fingerprintFeedback, spBlackholeTimeout=spBlackholeTimeout, spVersion=spVersion, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSwapSpace=deviceSwapSpace, spUnit=spUnit, spInterfaceUsageHC=spInterfaceUsageHC, deviceHealth=deviceHealth, managedObjectUsageDone=managedObjectUsageDone, spBGPTrapName=spBGPTrapName, deviceTotalFlows=deviceTotalFlows, spInterfaceIndex=spInterfaceIndex, spBlackholeNexthop=spBlackholeNexthop, mitigationDone=mitigationDone, spHijackAttr=spHijackAttr, spAlertDetectionSignatures=spAlertDetectionSignatures, spScriptStart=spScriptStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spManagedObject=spManagedObject, spFingerprintSender=spFingerprintSender, managedObjectUsage=managedObjectUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spImpactPps=spImpactPps, interfaceUsage=interfaceUsage, spImpactBps=spImpactBps, spInterfaceUsage=spInterfaceUsage, spUsername=spUsername, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptCommand=spScriptCommand, licenseErrorDone=licenseErrorDone, spFlowspecTimeout=spFlowspecTimeout, spFingerprintFeedback=spFingerprintFeedback, spFlowspecCommunity=spFlowspecCommunity, greDownDone=greDownDone, spTMSPrefix=spTMSPrefix, spUsage=spUsage, spBlackholePrefix=spBlackholePrefix, hardwareFailureDone=hardwareFailureDone, spReportURL=spReportURL, spDetector=spDetector, spDuration=spDuration, bgpTrap=bgpTrap, spSystemErrorDescription=spSystemErrorDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, spGreTunnelName=spGreTunnelName, spServiceElement=spServiceElement, devicePhysicalMemory=devicePhysicalMemory, flowUp=flowUp, spAlertID=spAlertID, reportDone=reportDone, spMitigationID=spMitigationID, peakflowSPMgr=peakflowSPMgr, fingerprintReceive=fingerprintReceive, spcommFailure=spcommFailure, spHijackRoute=spHijackRoute, spBGPTrapEvent=spBGPTrapEvent, collectorDown=collectorDown, spScriptHost=spScriptHost, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintUsageDone=fingerprintUsageDone, hardwareFailure=hardwareFailure, spTMSTimeout=spTMSTimeout, mitigationTMSStart=mitigationTMSStart, spMitigationName=spMitigationName, spDetectedCountries=spDetectedCountries, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spGreTunnelDestination=spGreTunnelDestination, snmpDown=snmpDown, dosNetworkProfiledAlert=dosNetworkProfiledAlert, collectorStart=collectorStart, spDNSObservedMean=spDNSObservedMean, serviceUsage=serviceUsage, alertScript=alertScript, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spDNSName=spDNSName, spScriptPort=spScriptPort, flowDown=flowDown, spFingerprintName=spFingerprintName, snmpUp=snmpUp, bgpDown=bgpDown, autoclassifyStart=autoclassifyStart, dnsBaseline=dnsBaseline, mitigationFlowspecStart=mitigationFlowspecStart, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spThirdPartyAddr=spThirdPartyAddr, spBGPEvent=spBGPEvent, dnsBaselineDone=dnsBaselineDone, spThirdPartyZone=spThirdPartyZone, spDNSExpected=spDNSExpected, spFingerprintMessage=spFingerprintMessage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spTMSCommunity=spTMSCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spManagedObjectFamily=spManagedObjectFamily, spApplicationName=spApplicationName, peakflowSPTraps=peakflowSPTraps, deviceSystemError=deviceSystemError, spCollector=spCollector, cloudSignalingFault=cloudSignalingFault, spServiceName=spServiceName, collectorUp=collectorUp, spReportName=spReportName, spLicenseErrCount=spLicenseErrCount, PYSNMP_MODULE_ID=peakflowSPMIB, configChange=configChange, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDNSObservedMax=spDNSObservedMax, spCommFailureDestination=spCommFailureDestination, spInterface=spInterface, spBGPInstability=spBGPInstability, spThreshold=spThreshold, spInterfaceSpeedHC=spInterfaceSpeedHC)
