...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:42:41 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Bits, IpAddress, iso, ModuleIdentity, Gauge32, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Bits", "IpAddress", "iso", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", reportDone=reportDone, spBGPInstability=spBGPInstability, spCommFailureDescription=spCommFailureDescription, fingerprintFeedback=fingerprintFeedback, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, cloudSignalingFault=cloudSignalingFault, spAlertDetectionSignatures=spAlertDetectionSignatures, fingerprintUsageDone=fingerprintUsageDone, spMitigationName=spMitigationName, snmpUp=snmpUp, spBlackholeNexthop=spBlackholeNexthop, dosHostDetectionAlertDone=dosHostDetectionAlertDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, dosHostDetectionAlert=dosHostDetectionAlert, spDetectedCountries=spDetectedCountries, spScriptHost=spScriptHost, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterface=spInterface, bgpInstability=bgpInstability, spThirdPartyAddr=spThirdPartyAddr, spcommFailureDone=spcommFailureDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpTrap=bgpTrap, spServiceElement=spServiceElement, spInetAddressType=spInetAddressType, peakflowSPMIB=peakflowSPMIB, spSystemErrorDescription=spSystemErrorDescription, spDNSObserved=spDNSObserved, spScriptCommand=spScriptCommand, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPCMI=peakflowSPCMI, spGreTunnelDestination=spGreTunnelDestination, spBlackholeTimeout=spBlackholeTimeout, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spTMSPrefix=spTMSPrefix, spBGPTrapOldAttributes=spBGPTrapOldAttributes, trafficAutoMitigation=trafficAutoMitigation, spBlackholePrefix=spBlackholePrefix, spLicenseErrType=spLicenseErrType, spTMSTimeout=spTMSTimeout, interfaceUsageDone=interfaceUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, fingerprintUsage=fingerprintUsage, spImpactPps=spImpactPps, spUnit=spUnit, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spManagedObject=spManagedObject, deviceSystemError=deviceSystemError, spPravail=spPravail, PYSNMP_MODULE_ID=peakflowSPMIB, spSystemErrorType=spSystemErrorType, spScriptStart=spScriptStart, bgpDown=bgpDown, spFingerprintFeedback=spFingerprintFeedback, serviceUsage=serviceUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spRouter=spRouter, spBGPEvent=spBGPEvent, spLicenseErrDescription=spLicenseErrDescription, bgpInstabilityDone=bgpInstabilityDone, spHijackAttr=spHijackAttr, spThreshold=spThreshold, spReportName=spReportName, spBGPTrapEvent=spBGPTrapEvent, spFingerprintMessage=spFingerprintMessage, flowUp=flowUp, spFingerprintSender=spFingerprintSender, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, greDownDone=greDownDone, mitigationBlackholeStart=mitigationBlackholeStart, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, spHijackLocal=spHijackLocal, spAlertID=spAlertID, spTMSCommunity=spTMSCommunity, spScriptPort=spScriptPort, spDetector=spDetector, serviceUsageDone=serviceUsageDone, managedObjectUsageDone=managedObjectUsageDone, licenseErrorDone=licenseErrorDone, spDNSObservedMean=spDNSObservedMean, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSystemErrorDone=deviceSystemErrorDone, spTMSMultiPrefix=spTMSMultiPrefix, licenseError=licenseError, hardwareFailure=hardwareFailure, spInterfaceUsage=spInterfaceUsage, autoclassifyStart=autoclassifyStart, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, collectorDown=collectorDown, alertScript=alertScript, spGreTunnelName=spGreTunnelName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spServiceName=spServiceName, spCommFailureDestination=spCommFailureDestination, deviceDiskUsage=deviceDiskUsage, deviceTotalFlows=deviceTotalFlows, fingerprintReceive=fingerprintReceive, spInterfaceSpeed=spInterfaceSpeed, spDNSName=spDNSName, interfaceUsage=interfaceUsage, routingFailover=routingFailover, flowDown=flowDown, mitigationTMSStart=mitigationTMSStart, spLicenseErrLimit=spLicenseErrLimit, spBlackholeCommunity=spBlackholeCommunity, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spImpactBps=spImpactBps, dnsBaseline=dnsBaseline, spUsername=spUsername, spMitigationStart=spMitigationStart, spInterfaceIndex=spInterfaceIndex, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, spReportURL=spReportURL, spFlowspecTimeout=spFlowspecTimeout, spVersion=spVersion, notificationLimit=notificationLimit, greDown=greDown, managedObjectUsage=managedObjectUsage, spUsage=spUsage, spDuration=spDuration, collectorUp=collectorUp, spFingerprintName=spFingerprintName, mitigationFlowspecStart=mitigationFlowspecStart, spInterfaceUsageHC=spInterfaceUsageHC, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spReportID=spReportID, deviceSwapSpace=deviceSwapSpace, spBGPTrapName=spBGPTrapName, spUsageType=spUsageType, collectorStart=collectorStart, spDNSExpected=spDNSExpected, configChange=configChange, spFlowspecCommunity=spFlowspecCommunity, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjectFamily=spManagedObjectFamily, spCollector=spCollector, hardwareFailureDone=hardwareFailureDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, peakflowSPMgr=peakflowSPMgr, bgpUp=bgpUp, spcommFailure=spcommFailure, deviceHealth=deviceHealth, mitigationDone=mitigationDone, spThirdPartyZone=spThirdPartyZone, spInetAddress=spInetAddress, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpHijack=bgpHijack, dnsBaselineDone=dnsBaselineDone, spHijackRoute=spHijackRoute, spApplicationName=spApplicationName, spManagedObjects=spManagedObjects, spMitigationID=spMitigationID, snmpDown=snmpDown, peakflowSPTraps=peakflowSPTraps, spDNSObservedMax=spDNSObservedMax)
