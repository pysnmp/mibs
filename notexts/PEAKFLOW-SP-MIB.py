...
# Produced by pysmi-1.1.12 at Mon Jul  1 09:16:24 2024
...
ObjectIdentity, Gauge32, Unsigned32, MibIdentifier, IpAddress, Integer32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spManagedObjects=spManagedObjects, spInterfaceSpeed=spInterfaceSpeed, spBGPTrapNewAttributes=spBGPTrapNewAttributes, interfaceUsage=interfaceUsage, spScriptStart=spScriptStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, reportDone=reportDone, deviceSystemError=deviceSystemError, spUsage=spUsage, spBGPTrapPrefix=spBGPTrapPrefix, configChange=configChange, notificationLimit=notificationLimit, spBGPEvent=spBGPEvent, spThirdPartyAddr=spThirdPartyAddr, deviceTotalFlowsHC=deviceTotalFlowsHC, dnsBaseline=dnsBaseline, spGreTunnelName=spGreTunnelName, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, spDNSExpected=spDNSExpected, spBlackholeCommunity=spBlackholeCommunity, spPravail=spPravail, deviceTotalFlows=deviceTotalFlows, collectorDown=collectorDown, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, licenseError=licenseError, dnsBaselineDone=dnsBaselineDone, licenseErrorDone=licenseErrorDone, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrCount=spLicenseErrCount, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFlowspecCommunity=spFlowspecCommunity, spScriptPort=spScriptPort, spInterface=spInterface, trafficAutoMitigation=trafficAutoMitigation, spInterfaceUsageHC=spInterfaceUsageHC, spFingerprintSender=spFingerprintSender, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjectFamily=spManagedObjectFamily, fingerprintReceive=fingerprintReceive, peakflowSPMIB=peakflowSPMIB, spLicenseErrLimit=spLicenseErrLimit, spGreTunnelDestination=spGreTunnelDestination, spDNSObservedMax=spDNSObservedMax, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSObserved=spDNSObserved, hardwareFailureDone=hardwareFailureDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spReportURL=spReportURL, spLicenseErrDescription=spLicenseErrDescription, bgpHijack=bgpHijack, PYSNMP_MODULE_ID=peakflowSPMIB, spUsername=spUsername, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPCMI=peakflowSPCMI, spBGPInstability=spBGPInstability, spUnit=spUnit, spDetector=spDetector, serviceUsage=serviceUsage, spImpactBps=spImpactBps, spThreshold=spThreshold, spHijackLocal=spHijackLocal, spThirdPartyZone=spThirdPartyZone, spDNSObservedMean=spDNSObservedMean, spFlowspecTimeout=spFlowspecTimeout, spBlackholeTimeout=spBlackholeTimeout, spReportID=spReportID, dosHostDetectionAlert=dosHostDetectionAlert, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSMultiPrefix=spTMSMultiPrefix, serviceUsageDone=serviceUsageDone, spAlertID=spAlertID, snmpUp=snmpUp, spRouter=spRouter, spFingerprintFeedback=spFingerprintFeedback, collectorUp=collectorUp, snmpDown=snmpDown, mitigationTMSStartV2=mitigationTMSStartV2, spcommFailure=spcommFailure, deviceSystemErrorDone=deviceSystemErrorDone, spUsageType=spUsageType, peakflowSPMgr=peakflowSPMgr, spFingerprintName=spFingerprintName, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackAttr=spHijackAttr, spImpactPps=spImpactPps, spDetectedCountries=spDetectedCountries, mitigationBlackholeStart=mitigationBlackholeStart, greDown=greDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailover=routingFailover, bgpDown=bgpDown, mitigationTMSStart=mitigationTMSStart, mitigationFlowspecStart=mitigationFlowspecStart, devicePhysicalMemory=devicePhysicalMemory, spReportName=spReportName, spServiceName=spServiceName, spTMSPrefix=spTMSPrefix, spServiceElement=spServiceElement, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsage=managedObjectUsage, spInterfaceSpeedHC=spInterfaceSpeedHC, spFingerprintMessage=spFingerprintMessage, spInterfaceUsage=spInterfaceUsage, bgpTrap=bgpTrap, spScriptCommand=spScriptCommand, spMitigationName=spMitigationName, cloudSignalingFault=cloudSignalingFault, spTMSTimeout=spTMSTimeout, dosNetworkProfiledAlert=dosNetworkProfiledAlert, autoclassifyStart=autoclassifyStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spCommFailureDescription=spCommFailureDescription, managedObjectUsageDone=managedObjectUsageDone, interfaceUsageDone=interfaceUsageDone, bgpUp=bgpUp, spMitigationStart=spMitigationStart, bgpInstabilityDone=bgpInstabilityDone, spCollector=spCollector, spHardwareFailureDescription=spHardwareFailureDescription, spScriptHost=spScriptHost, fingerprintUsageDone=fingerprintUsageDone, deviceHealth=deviceHealth, fingerprintFeedback=fingerprintFeedback, spTMSCommunity=spTMSCommunity, spLicenseErrType=spLicenseErrType, hardwareFailure=hardwareFailure, flowUp=flowUp, spBlackholePrefix=spBlackholePrefix, spBlackholeNexthop=spBlackholeNexthop, spSystemErrorType=spSystemErrorType, spDNSName=spDNSName, spInetAddressType=spInetAddressType, peakflowSPTraps=peakflowSPTraps, spBGPTrapName=spBGPTrapName, alertScript=alertScript, spMitigationID=spMitigationID, spInterfaceIndex=spInterfaceIndex, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spVersion=spVersion, flowDown=flowDown, spcommFailureDone=spcommFailureDone, greDownDone=greDownDone, deviceSwapSpace=deviceSwapSpace, spManagedObject=spManagedObject, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceDiskUsage=deviceDiskUsage, spCommFailureDestination=spCommFailureDestination, spDuration=spDuration, spInetAddress=spInetAddress, spApplicationName=spApplicationName, bgpInstability=bgpInstability, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintUsage=fingerprintUsage, collectorStart=collectorStart, mitigationDone=mitigationDone, spHijackRoute=spHijackRoute)
