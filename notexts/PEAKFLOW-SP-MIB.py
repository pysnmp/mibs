...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:42:33 2022
...
Gauge32, MibIdentifier, iso, ModuleIdentity, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Unsigned32, Bits, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Unsigned32", "Bits", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spReportURL=spReportURL, spBlackholeNexthop=spBlackholeNexthop, spPravail=spPravail, spMitigationID=spMitigationID, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintUsageDone=fingerprintUsageDone, spInetAddressType=spInetAddressType, mitigationTMSStart=mitigationTMSStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spFingerprintMessage=spFingerprintMessage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintFeedback=fingerprintFeedback, spUsage=spUsage, spDetector=spDetector, alertScript=alertScript, snmpUp=snmpUp, fingerprintReceive=fingerprintReceive, spHijackLocal=spHijackLocal, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spCollector=spCollector, spFlowspecTimeout=spFlowspecTimeout, notificationLimit=notificationLimit, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFlowspecCommunity=spFlowspecCommunity, spScriptHost=spScriptHost, deviceSystemError=deviceSystemError, spThirdPartyZone=spThirdPartyZone, managedObjectUsageDone=managedObjectUsageDone, spServiceName=spServiceName, bgpDown=bgpDown, spHijackAttr=spHijackAttr, spLicenseErrCount=spLicenseErrCount, dosHostDetectionAlertDone=dosHostDetectionAlertDone, licenseErrorDone=licenseErrorDone, deviceDiskUsage=deviceDiskUsage, spInterfaceSpeed=spInterfaceSpeed, deviceTotalFlowsHC=deviceTotalFlowsHC, spGreTunnelDestination=spGreTunnelDestination, spApplicationName=spApplicationName, spSystemErrorType=spSystemErrorType, flowDown=flowDown, spBGPTrapEvent=spBGPTrapEvent, spInetAddress=spInetAddress, spInterfaceIndex=spInterfaceIndex, devicePhysicalMemory=devicePhysicalMemory, spDNSName=spDNSName, snmpDown=snmpDown, bgpHijack=bgpHijack, serviceUsage=serviceUsage, bgpUp=bgpUp, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterface=spInterface, spCommFailureDescription=spCommFailureDescription, spBGPTrapNewAttributes=spBGPTrapNewAttributes, hardwareFailureDone=hardwareFailureDone, routingFailover=routingFailover, mitigationFlowspecStart=mitigationFlowspecStart, spDNSObserved=spDNSObserved, spManagedObjects=spManagedObjects, spMitigationName=spMitigationName, spTMSPrefix=spTMSPrefix, reportDone=reportDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFault=cloudSignalingFault, spReportID=spReportID, deviceHealth=deviceHealth, spScriptCommand=spScriptCommand, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrDescription=spLicenseErrDescription, interfaceUsage=interfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailure=hardwareFailure, licenseError=licenseError, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spAlertID=spAlertID, managedObjectUsage=managedObjectUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsage=fingerprintUsage, serviceUsageDone=serviceUsageDone, spReportName=spReportName, mitigationBlackholeStart=mitigationBlackholeStart, spLicenseErrLimit=spLicenseErrLimit, spCommFailureDestination=spCommFailureDestination, spImpactBps=spImpactBps, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, dnsBaselineDone=dnsBaselineDone, dosHostDetectionAlert=dosHostDetectionAlert, spDetectedCountries=spDetectedCountries, deviceSwapSpace=deviceSwapSpace, bgpTrap=bgpTrap, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHijackRoute=spHijackRoute, spBlackholePrefix=spBlackholePrefix, mitigationDone=mitigationDone, spHardwareFailureDescription=spHardwareFailureDescription, collectorUp=collectorUp, spTMSCommunity=spTMSCommunity, bgpInstabilityDone=bgpInstabilityDone, peakflowSPCMI=peakflowSPCMI, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceTotalFlows=deviceTotalFlows, spBGPTrapOldAttributes=spBGPTrapOldAttributes, configChange=configChange, spDuration=spDuration, spThreshold=spThreshold, spcommFailureDone=spcommFailureDone, spInterfaceUsage=spInterfaceUsage, peakflowSPMgr=peakflowSPMgr, spVersion=spVersion, collectorDown=collectorDown, spUsageType=spUsageType, spMitigationStart=spMitigationStart, spUnit=spUnit, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDNSExpected=spDNSExpected, spServiceElement=spServiceElement, spDNSObservedMax=spDNSObservedMax, dnsBaseline=dnsBaseline, spInterfaceUsageHC=spInterfaceUsageHC, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, mitigationTMSStartV2=mitigationTMSStartV2, greDown=greDown, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spcommFailure=spcommFailure, spScriptPort=spScriptPort, spTMSMultiPrefix=spTMSMultiPrefix, spSystemErrorDescription=spSystemErrorDescription, interfaceUsageDone=interfaceUsageDone, spThirdPartyAddr=spThirdPartyAddr, spImpactPps=spImpactPps, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFingerprintFeedback=spFingerprintFeedback, peakflowSPMIB=peakflowSPMIB, collectorStart=collectorStart, greDownDone=greDownDone, spBGPTrapPrefix=spBGPTrapPrefix, spBGPEvent=spBGPEvent, spBlackholeCommunity=spBlackholeCommunity, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptStart=spScriptStart, deviceSystemErrorDone=deviceSystemErrorDone, spBGPInstability=spBGPInstability, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjectFamily=spManagedObjectFamily, spDNSObservedMean=spDNSObservedMean, spTMSTimeout=spTMSTimeout, spFingerprintName=spFingerprintName, spRouter=spRouter, flowUp=flowUp, spLicenseErrType=spLicenseErrType, peakflowSPTraps=peakflowSPTraps, spManagedObject=spManagedObject, autoclassifyStart=autoclassifyStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUsername=spUsername, spGreTunnelName=spGreTunnelName, spBlackholeTimeout=spBlackholeTimeout, bgpInstability=bgpInstability, spFingerprintSender=spFingerprintSender)
