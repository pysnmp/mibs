...
# Produced by pysmi-1.1.12 at Tue Jun  4 07:45:56 2024
...
ModuleIdentity, MibIdentifier, TimeTicks, iso, IpAddress, Counter64, Unsigned32, Counter32, Bits, Gauge32, ObjectIdentity, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "TimeTicks", "iso", "IpAddress", "Counter64", "Unsigned32", "Counter32", "Bits", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", greDownDone=greDownDone, spMitigationStart=spMitigationStart, spLicenseErrType=spLicenseErrType, fingerprintUsage=fingerprintUsage, serviceUsage=serviceUsage, spVersion=spVersion, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceHealth=deviceHealth, cloudSignalingFaultDone=cloudSignalingFaultDone, snmpDown=snmpDown, spBGPEvent=spBGPEvent, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spReportURL=spReportURL, spFingerprintName=spFingerprintName, spLicenseErrCount=spLicenseErrCount, spMitigationName=spMitigationName, cloudSignalingFault=cloudSignalingFault, peakflowSPTraps=peakflowSPTraps, spManagedObjects=spManagedObjects, spFlowspecCommunity=spFlowspecCommunity, deviceSystemError=deviceSystemError, dnsBaselineDone=dnsBaselineDone, interfaceUsage=interfaceUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spHijackAttr=spHijackAttr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationDone=mitigationDone, spDetector=spDetector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDetectedCountries=spDetectedCountries, snmpUp=snmpUp, spInetAddressType=spInetAddressType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpace=deviceSwapSpace, spInterfaceSpeedHC=spInterfaceSpeedHC, spBlackholeCommunity=spBlackholeCommunity, spTMSMultiPrefix=spTMSMultiPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spReportName=spReportName, reportDone=reportDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, hardwareFailureDone=hardwareFailureDone, routingFailover=routingFailover, spInterfaceUsage=spInterfaceUsage, dnsBaseline=dnsBaseline, collectorUp=collectorUp, collectorStart=collectorStart, spCommFailureDestination=spCommFailureDestination, spManagedObjectFamily=spManagedObjectFamily, spInterfaceSpeed=spInterfaceSpeed, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThreshold=spThreshold, spGreTunnelName=spGreTunnelName, spBlackholeTimeout=spBlackholeTimeout, spMitigationID=spMitigationID, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpTrap=bgpTrap, spSystemErrorDescription=spSystemErrorDescription, bgpDown=bgpDown, spTMSPrefix=spTMSPrefix, spcommFailureDone=spcommFailureDone, spReportID=spReportID, notificationLimit=notificationLimit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceSystemErrorDone=deviceSystemErrorDone, spAlertDetectionSignatures=spAlertDetectionSignatures, alertScript=alertScript, fingerprintUsageDone=fingerprintUsageDone, spScriptCommand=spScriptCommand, spDuration=spDuration, spHijackLocal=spHijackLocal, spBGPTrapPrefix=spBGPTrapPrefix, licenseError=licenseError, spServiceName=spServiceName, spTMSCommunity=spTMSCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spFingerprintMessage=spFingerprintMessage, spUsageType=spUsageType, fingerprintReceive=fingerprintReceive, spUnit=spUnit, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptHost=spScriptHost, spImpactBps=spImpactBps, spPravail=spPravail, spHijackRoute=spHijackRoute, spUsername=spUsername, spDNSObservedMean=spDNSObservedMean, spRouter=spRouter, hardwareFailure=hardwareFailure, spThirdPartyZone=spThirdPartyZone, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholeNexthop=spBlackholeNexthop, mitigationBlackholeStart=mitigationBlackholeStart, spLicenseErrLimit=spLicenseErrLimit, spInterface=spInterface, spInterfaceUsageHC=spInterfaceUsageHC, flowDown=flowDown, spScriptStart=spScriptStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, flowUp=flowUp, bgpHijack=bgpHijack, mitigationFlowspecStart=mitigationFlowspecStart, spBGPTrapEvent=spBGPTrapEvent, collectorDown=collectorDown, spAlertID=spAlertID, spFlowspecTimeout=spFlowspecTimeout, licenseErrorDone=licenseErrorDone, spDNSObserved=spDNSObserved, spFingerprintSender=spFingerprintSender, mitigationTMSStart=mitigationTMSStart, spServiceElement=spServiceElement, spLicenseErrDescription=spLicenseErrDescription, spBGPInstability=spBGPInstability, fingerprintFeedback=fingerprintFeedback, configChange=configChange, peakflowSPCMI=peakflowSPCMI, serviceUsageDone=serviceUsageDone, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPMIB=peakflowSPMIB, bgpInstability=bgpInstability, spCollector=spCollector, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spDNSObservedMax=spDNSObservedMax, managedObjectUsage=managedObjectUsage, spDNSExpected=spDNSExpected, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBlackholePrefix=spBlackholePrefix, mitigationTMSStartV2=mitigationTMSStartV2, spCommFailureDescription=spCommFailureDescription, peakflowSPMgr=peakflowSPMgr, interfaceUsageDone=interfaceUsageDone, bgpInstabilityDone=bgpInstabilityDone, spBGPTrapName=spBGPTrapName, spDNSName=spDNSName, deviceTotalFlows=deviceTotalFlows, spScriptPort=spScriptPort, trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, bgpUp=bgpUp, spTMSTimeout=spTMSTimeout, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spImpactPps=spImpactPps, spManagedObject=spManagedObject, spSystemErrorType=spSystemErrorType, spInterfaceIndex=spInterfaceIndex, spFingerprintFeedback=spFingerprintFeedback, deviceDiskUsage=deviceDiskUsage, spcommFailure=spcommFailure, devicePhysicalMemory=devicePhysicalMemory, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, autoclassifyStart=autoclassifyStart, spInetAddress=spInetAddress, spUsage=spUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, PYSNMP_MODULE_ID=peakflowSPMIB, managedObjectUsageDone=managedObjectUsageDone, spGreTunnelDestination=spGreTunnelDestination, spApplicationName=spApplicationName, deviceTotalFlowsHC=deviceTotalFlowsHC)
