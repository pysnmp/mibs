...
Bits, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks, Counter64, iso, ModuleIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFingerprintName=spFingerprintName, mitigationDone=mitigationDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spMitigationName=spMitigationName, fingerprintUsage=fingerprintUsage, peakflowSPMgr=peakflowSPMgr, spDNSObservedMean=spDNSObservedMean, spSystemErrorDescription=spSystemErrorDescription, spInetAddressType=spInetAddressType, spVersion=spVersion, spCollector=spCollector, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceHealth=deviceHealth, spFingerprintSender=spFingerprintSender, spLicenseErrCount=spLicenseErrCount, fingerprintFeedback=fingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, spCommFailureDestination=spCommFailureDestination, spScriptCommand=spScriptCommand, managedObjectUsageDone=managedObjectUsageDone, spDuration=spDuration, hardwareFailureDone=hardwareFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, spGreTunnelName=spGreTunnelName, collectorUp=collectorUp, spFlowspecCommunity=spFlowspecCommunity, spCommFailureDescription=spCommFailureDescription, snmpDown=snmpDown, spDNSObserved=spDNSObserved, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spGreTunnelDestination=spGreTunnelDestination, trafficAutoMitigation=trafficAutoMitigation, spFingerprintFeedback=spFingerprintFeedback, spUsage=spUsage, spBGPTrapPrefix=spBGPTrapPrefix, spServiceElement=spServiceElement, greDownDone=greDownDone, peakflowSPTraps=peakflowSPTraps, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapName=spBGPTrapName, spDetector=spDetector, mitigationFlowspecStart=mitigationFlowspecStart, interfaceUsageDone=interfaceUsageDone, bgpTrap=bgpTrap, spMitigationStart=spMitigationStart, configChange=configChange, licenseErrorDone=licenseErrorDone, spInterfaceSpeed=spInterfaceSpeed, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpace=deviceSwapSpace, fingerprintUsageDone=fingerprintUsageDone, devicePhysicalMemory=devicePhysicalMemory, spReportName=spReportName, bgpInstabilityDone=bgpInstabilityDone, hardwareFailure=hardwareFailure, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUsageType=spUsageType, spUsername=spUsername, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptStart=spScriptStart, bgpInstability=bgpInstability, spThirdPartyAddr=spThirdPartyAddr, spServiceName=spServiceName, alertScript=alertScript, fingerprintReceive=fingerprintReceive, cloudSignalingFault=cloudSignalingFault, flowUp=flowUp, autoclassifyStart=autoclassifyStart, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPEvent=spBGPEvent, spInetAddress=spInetAddress, spLicenseErrType=spLicenseErrType, spThirdPartyZone=spThirdPartyZone, spDNSExpected=spDNSExpected, reportDone=reportDone, interfaceUsage=interfaceUsage, spTMSMultiPrefix=spTMSMultiPrefix, spUnit=spUnit, spImpactBps=spImpactBps, routingFailover=routingFailover, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrDescription=spLicenseErrDescription, spBlackholeTimeout=spBlackholeTimeout, spDetectedCountries=spDetectedCountries, spAlertID=spAlertID, spDNSObservedMax=spDNSObservedMax, spBGPTrapOldAttributes=spBGPTrapOldAttributes, collectorStart=collectorStart, peakflowSPMIB=peakflowSPMIB, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, notificationLimit=notificationLimit, licenseError=licenseError, managedObjectUsage=managedObjectUsage, spApplicationName=spApplicationName, spImpactPps=spImpactPps, serviceUsage=serviceUsage, greDown=greDown, peakflowSPCMI=peakflowSPCMI, deviceTotalFlows=deviceTotalFlows, spBGPInstability=spBGPInstability, spBlackholePrefix=spBlackholePrefix, spMitigationID=spMitigationID, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, serviceUsageDone=serviceUsageDone, spcommFailureDone=spcommFailureDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSName=spDNSName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInterface=spInterface, deviceSystemError=deviceSystemError, mitigationBlackholeStart=mitigationBlackholeStart, spSystemErrorType=spSystemErrorType, dosHostDetectionAlert=dosHostDetectionAlert, spTMSCommunity=spTMSCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpHijack=bgpHijack, spBGPTrapEvent=spBGPTrapEvent, spHijackRoute=spHijackRoute, dnsBaseline=dnsBaseline, spPravail=spPravail, bgpDown=bgpDown, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, flowDown=flowDown, spInterfaceUsage=spInterfaceUsage, spThreshold=spThreshold, spHijackAttr=spHijackAttr, spFingerprintMessage=spFingerprintMessage, bgpUp=bgpUp, collectorDown=collectorDown, spLicenseErrLimit=spLicenseErrLimit, spScriptPort=spScriptPort, spReportURL=spReportURL, spManagedObjectFamily=spManagedObjectFamily, spReportID=spReportID, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceSpeedHC=spInterfaceSpeedHC, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjects=spManagedObjects, spBlackholeNexthop=spBlackholeNexthop, snmpUp=snmpUp, spInterfaceUsageHC=spInterfaceUsageHC, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spRouter=spRouter, mitigationTMSStart=mitigationTMSStart, spInterfaceIndex=spInterfaceIndex, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceDiskUsage=deviceDiskUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spcommFailure=spcommFailure, spFlowspecTimeout=spFlowspecTimeout, spHijackLocal=spHijackLocal, spScriptHost=spScriptHost, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spTMSTimeout=spTMSTimeout, spTMSPrefix=spTMSPrefix, spManagedObject=spManagedObject, dnsBaselineDone=dnsBaselineDone, deviceSystemErrorDone=deviceSystemErrorDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription)
