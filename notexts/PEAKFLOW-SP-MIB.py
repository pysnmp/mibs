...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:15:42 2023
...
TimeTicks, MibIdentifier, IpAddress, Counter32, Bits, ObjectIdentity, Gauge32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "IpAddress", "Counter32", "Bits", "ObjectIdentity", "Gauge32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Integer32", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsageHC=spInterfaceUsageHC, spImpactBps=spImpactBps, snmpUp=snmpUp, mitigationTMSStartV2=mitigationTMSStartV2, spHijackRoute=spHijackRoute, spManagedObject=spManagedObject, spUsageType=spUsageType, peakflowSPTraps=peakflowSPTraps, spDuration=spDuration, spPravail=spPravail, spReportURL=spReportURL, spInetAddress=spInetAddress, spThirdPartyZone=spThirdPartyZone, spInterface=spInterface, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationFlowspecStart=mitigationFlowspecStart, bgpHijack=bgpHijack, spInetAddressType=spInetAddressType, dnsBaseline=dnsBaseline, spUsage=spUsage, hardwareFailure=hardwareFailure, spDNSObserved=spDNSObserved, peakflowSPCMI=peakflowSPCMI, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceSpeedHC=spInterfaceSpeedHC, spCommFailureDescription=spCommFailureDescription, collectorUp=collectorUp, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationStart=spMitigationStart, spScriptStart=spScriptStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSPrefix=spTMSPrefix, cloudSignalingFault=cloudSignalingFault, flowUp=flowUp, bgpDown=bgpDown, spFingerprintMessage=spFingerprintMessage, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholePrefix=spBlackholePrefix, greDown=greDown, fingerprintUsage=fingerprintUsage, spInterfaceUsage=spInterfaceUsage, spLicenseErrType=spLicenseErrType, spUnit=spUnit, spInterfaceSpeed=spInterfaceSpeed, spFlowspecTimeout=spFlowspecTimeout, hardwareFailureDone=hardwareFailureDone, licenseError=licenseError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPMgr=peakflowSPMgr, trafficAutoMitigation=trafficAutoMitigation, bgpTrap=bgpTrap, spDNSObservedMean=spDNSObservedMean, collectorStart=collectorStart, spBGPTrapOldAttributes=spBGPTrapOldAttributes, alertScript=alertScript, deviceDiskUsage=deviceDiskUsage, interfaceUsageDone=interfaceUsageDone, dnsBaselineDone=dnsBaselineDone, spCollector=spCollector, spTMSCommunity=spTMSCommunity, spManagedObjectFamily=spManagedObjectFamily, spDNSExpected=spDNSExpected, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpInstabilityDone=bgpInstabilityDone, spBlackholeNexthop=spBlackholeNexthop, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholeTimeout=spBlackholeTimeout, licenseErrorDone=licenseErrorDone, spcommFailureDone=spcommFailureDone, spBGPEvent=spBGPEvent, serviceUsageDone=serviceUsageDone, spServiceElement=spServiceElement, notificationLimit=notificationLimit, configChange=configChange, mitigationBlackholeStart=mitigationBlackholeStart, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrDescription=spLicenseErrDescription, spScriptCommand=spScriptCommand, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptHost=spScriptHost, fingerprintFeedback=fingerprintFeedback, spAlertID=spAlertID, spDetector=spDetector, deviceSwapSpaceUsage=deviceSwapSpaceUsage, peakflowSPMIB=peakflowSPMIB, spRouter=spRouter, spUsername=spUsername, spTMSTimeout=spTMSTimeout, spReportName=spReportName, spSystemErrorDescription=spSystemErrorDescription, fingerprintReceive=fingerprintReceive, flowDown=flowDown, interfaceUsage=interfaceUsage, spSystemErrorType=spSystemErrorType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceSystemError=deviceSystemError, spThirdPartyAddr=spThirdPartyAddr, spScriptPort=spScriptPort, bgpInstability=bgpInstability, fingerprintUsageDone=fingerprintUsageDone, spFingerprintSender=spFingerprintSender, spMitigationName=spMitigationName, spBGPTrapName=spBGPTrapName, mitigationDone=mitigationDone, devicePhysicalMemory=devicePhysicalMemory, spHardwareFailureDescription=spHardwareFailureDescription, bgpUp=bgpUp, spBlackholeCommunity=spBlackholeCommunity, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpace=deviceSwapSpace, deviceTotalFlowsHC=deviceTotalFlowsHC, spLicenseErrLimit=spLicenseErrLimit, spcommFailure=spcommFailure, spHijackLocal=spHijackLocal, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spGreTunnelName=spGreTunnelName, deviceTotalFlows=deviceTotalFlows, spReportID=spReportID, managedObjectUsageDone=managedObjectUsageDone, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceHealth=deviceHealth, serviceUsage=serviceUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, managedObjectUsage=managedObjectUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecCommunity=spFlowspecCommunity, spBGPTrapPrefix=spBGPTrapPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObjects=spManagedObjects, spDNSName=spDNSName, collectorDown=collectorDown, spApplicationName=spApplicationName, spMitigationID=spMitigationID, spGreTunnelDestination=spGreTunnelDestination, spBGPInstability=spBGPInstability, spImpactPps=spImpactPps, routingFailover=routingFailover, spVersion=spVersion, reportDone=reportDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationTMSStart=mitigationTMSStart, spFingerprintName=spFingerprintName, snmpDown=snmpDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, greDownDone=greDownDone, spLicenseErrCount=spLicenseErrCount, spHijackAttr=spHijackAttr, spInterfaceIndex=spInterfaceIndex, spDNSObservedMax=spDNSObservedMax, spFingerprintFeedback=spFingerprintFeedback, spServiceName=spServiceName, autoclassifyStart=autoclassifyStart, spThreshold=spThreshold)
