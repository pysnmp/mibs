...
# Produced by pysmi-1.1.12 at Mon Jun  3 11:52:48 2024
...
TimeTicks, iso, Bits, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Counter64, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Bits", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Counter64", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptStart=spScriptStart, spInterfaceSpeedHC=spInterfaceSpeedHC, fingerprintUsage=fingerprintUsage, spDetector=spDetector, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPCMI=peakflowSPCMI, spThreshold=spThreshold, spDNSObservedMax=spDNSObservedMax, spGreTunnelName=spGreTunnelName, spDNSObserved=spDNSObserved, collectorDown=collectorDown, devicePhysicalMemory=devicePhysicalMemory, spTMSTimeout=spTMSTimeout, managedObjectUsage=managedObjectUsage, deviceTotalFlows=deviceTotalFlows, snmpUp=snmpUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorStart=collectorStart, spMitigationName=spMitigationName, bgpUp=bgpUp, licenseError=licenseError, dnsBaselineDone=dnsBaselineDone, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrDescription=spLicenseErrDescription, spUsageType=spUsageType, PYSNMP_MODULE_ID=peakflowSPMIB, fingerprintUsageDone=fingerprintUsageDone, spScriptPort=spScriptPort, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInetAddress=spInetAddress, peakflowSPMIB=peakflowSPMIB, spDNSExpected=spDNSExpected, spUnit=spUnit, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBlackholeNexthop=spBlackholeNexthop, spManagedObjects=spManagedObjects, spDetectedCountries=spDetectedCountries, spBlackholeTimeout=spBlackholeTimeout, alertScript=alertScript, spHardwareFailureDescription=spHardwareFailureDescription, flowDown=flowDown, deviceDiskUsage=deviceDiskUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spLicenseErrCount=spLicenseErrCount, notificationLimit=notificationLimit, bgpHijack=bgpHijack, spMitigationID=spMitigationID, spFingerprintFeedback=spFingerprintFeedback, bgpTrap=bgpTrap, spReportURL=spReportURL, mitigationTMSStart=mitigationTMSStart, spCommFailureDestination=spCommFailureDestination, spHijackLocal=spHijackLocal, hardwareFailureDone=hardwareFailureDone, spPravail=spPravail, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsageDone=interfaceUsageDone, spLicenseErrType=spLicenseErrType, spGreTunnelDestination=spGreTunnelDestination, spCloudSignalFaultDescription=spCloudSignalFaultDescription, greDownDone=greDownDone, spVersion=spVersion, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationFlowspecStart=mitigationFlowspecStart, spTMSCommunity=spTMSCommunity, flowUp=flowUp, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintName=spFingerprintName, spManagedObjectFamily=spManagedObjectFamily, bgpInstabilityDone=bgpInstabilityDone, spAlertID=spAlertID, spRouter=spRouter, spReportID=spReportID, fingerprintFeedback=fingerprintFeedback, spcommFailure=spcommFailure, spThirdPartyZone=spThirdPartyZone, spTMSMultiPrefix=spTMSMultiPrefix, spImpactPps=spImpactPps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, serviceUsage=serviceUsage, spCollector=spCollector, spScriptCommand=spScriptCommand, cloudSignalingFault=cloudSignalingFault, routingFailover=routingFailover, spSystemErrorDescription=spSystemErrorDescription, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInetAddressType=spInetAddressType, dnsBaseline=dnsBaseline, spServiceName=spServiceName, licenseErrorDone=licenseErrorDone, spHijackAttr=spHijackAttr, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spServiceElement=spServiceElement, spBGPInstability=spBGPInstability, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSObservedMean=spDNSObservedMean, mitigationBlackholeStart=mitigationBlackholeStart, interfaceUsage=interfaceUsage, fingerprintReceive=fingerprintReceive, snmpDown=snmpDown, spTMSPrefix=spTMSPrefix, bgpDown=bgpDown, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spApplicationName=spApplicationName, spHijackRoute=spHijackRoute, greDown=greDown, spUsername=spUsername, spLicenseErrLimit=spLicenseErrLimit, spScriptHost=spScriptHost, configChange=configChange, spBlackholeCommunity=spBlackholeCommunity, spcommFailureDone=spcommFailureDone, trafficAutoMitigation=trafficAutoMitigation, spBGPTrapEvent=spBGPTrapEvent, mitigationTMSStartV2=mitigationTMSStartV2, spDNSName=spDNSName, peakflowSPTraps=peakflowSPTraps, managedObjectUsageDone=managedObjectUsageDone, spInterface=spInterface, spBlackholePrefix=spBlackholePrefix, spFlowspecCommunity=spFlowspecCommunity, deviceSystemErrorDone=deviceSystemErrorDone, deviceSwapSpace=deviceSwapSpace, collectorUp=collectorUp, autoclassifyStart=autoclassifyStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsage=spUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceHealth=deviceHealth, peakflowSPMgr=peakflowSPMgr, spReportName=spReportName, hardwareFailure=hardwareFailure, spCommFailureDescription=spCommFailureDescription, mitigationDone=mitigationDone, spBGPEvent=spBGPEvent, spInterfaceUsage=spInterfaceUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationThirdPartyStart=mitigationThirdPartyStart, spManagedObject=spManagedObject, spInterfaceIndex=spInterfaceIndex, spSystemErrorType=spSystemErrorType, spMitigationStart=spMitigationStart, bgpInstability=bgpInstability, reportDone=reportDone, serviceUsageDone=serviceUsageDone, spFlowspecTimeout=spFlowspecTimeout, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapName=spBGPTrapName, spFingerprintMessage=spFingerprintMessage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapPrefix=spBGPTrapPrefix, spDuration=spDuration, spFingerprintSender=spFingerprintSender, deviceSystemError=deviceSystemError)
