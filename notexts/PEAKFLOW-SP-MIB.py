...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:34:56 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, ObjectIdentity, iso, NotificationType, Bits, ModuleIdentity, Counter64, Unsigned32, MibIdentifier, Gauge32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "Bits", "ModuleIdentity", "Counter64", "Unsigned32", "MibIdentifier", "Gauge32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHijackRoute=spHijackRoute, spBlackholeTimeout=spBlackholeTimeout, mitigationDone=mitigationDone, licenseErrorDone=licenseErrorDone, spFingerprintSender=spFingerprintSender, flowUp=flowUp, spReportID=spReportID, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSName=spDNSName, hardwareFailureDone=hardwareFailureDone, spPravail=spPravail, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailure=spcommFailure, spUsageType=spUsageType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPInstability=spBGPInstability, routingFailover=routingFailover, spScriptPort=spScriptPort, greDown=greDown, spCommFailureDestination=spCommFailureDestination, spMitigationStart=spMitigationStart, spScriptCommand=spScriptCommand, deviceSystemErrorDone=deviceSystemErrorDone, autoclassifyStart=autoclassifyStart, serviceUsage=serviceUsage, spLicenseErrLimit=spLicenseErrLimit, interfaceUsageDone=interfaceUsageDone, spBlackholePrefix=spBlackholePrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationTMSStartV2=mitigationTMSStartV2, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsageDone=managedObjectUsageDone, bgpInstabilityDone=bgpInstabilityDone, fingerprintReceive=fingerprintReceive, peakflowSPTraps=peakflowSPTraps, fingerprintUsageDone=fingerprintUsageDone, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintUsage=fingerprintUsage, deviceDiskUsage=deviceDiskUsage, spUsage=spUsage, mitigationTMSStart=mitigationTMSStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, snmpDown=snmpDown, spLicenseErrDescription=spLicenseErrDescription, flowDown=flowDown, spInterfaceSpeedHC=spInterfaceSpeedHC, spImpactBps=spImpactBps, spInterfaceUsageHC=spInterfaceUsageHC, spGreTunnelName=spGreTunnelName, spCommFailureDescription=spCommFailureDescription, spCollector=spCollector, spVersion=spVersion, spUnit=spUnit, spLicenseErrType=spLicenseErrType, spInterfaceUsage=spInterfaceUsage, spDuration=spDuration, spRouter=spRouter, collectorDown=collectorDown, spDetector=spDetector, hardwareFailure=hardwareFailure, spDNSObservedMax=spDNSObservedMax, spBGPTrapEvent=spBGPTrapEvent, bgpHijack=bgpHijack, PYSNMP_MODULE_ID=peakflowSPMIB, bgpTrap=bgpTrap, deviceSwapSpace=deviceSwapSpace, spTMSCommunity=spTMSCommunity, spTMSTimeout=spTMSTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjects=spManagedObjects, notificationLimit=notificationLimit, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceIndex=spInterfaceIndex, bgpUp=bgpUp, spScriptHost=spScriptHost, spScriptStart=spScriptStart, spInterfaceSpeed=spInterfaceSpeed, spBGPEvent=spBGPEvent, spFingerprintMessage=spFingerprintMessage, dosHostDetectionAlert=dosHostDetectionAlert, devicePhysicalMemory=devicePhysicalMemory, spServiceElement=spServiceElement, reportDone=reportDone, trafficAutoMitigation=trafficAutoMitigation, spDNSObservedMean=spDNSObservedMean, spHijackLocal=spHijackLocal, spFingerprintFeedback=spFingerprintFeedback, managedObjectUsage=managedObjectUsage, deviceHealth=deviceHealth, spGreTunnelDestination=spGreTunnelDestination, serviceUsageDone=serviceUsageDone, spInterface=spInterface, spSystemErrorDescription=spSystemErrorDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrCount=spLicenseErrCount, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSPrefix=spTMSPrefix, spMitigationID=spMitigationID, spSystemErrorType=spSystemErrorType, spDetectedCountries=spDetectedCountries, spDNSExpected=spDNSExpected, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spUsername=spUsername, dosNetworkProfiledAlert=dosNetworkProfiledAlert, bgpDown=bgpDown, snmpUp=snmpUp, collectorStart=collectorStart, spDNSObserved=spDNSObserved, peakflowSPCMI=peakflowSPCMI, spReportName=spReportName, spBlackholeCommunity=spBlackholeCommunity, spThirdPartyZone=spThirdPartyZone, bgpInstability=bgpInstability, spReportURL=spReportURL, spMitigationName=spMitigationName, spTMSMultiPrefix=spTMSMultiPrefix, spManagedObject=spManagedObject, spInetAddressType=spInetAddressType, spServiceName=spServiceName, spAlertID=spAlertID, deviceTotalFlows=deviceTotalFlows, collectorUp=collectorUp, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spManagedObjectFamily=spManagedObjectFamily, deviceSystemError=deviceSystemError, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, alertScript=alertScript, interfaceUsage=interfaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, spImpactPps=spImpactPps, spFlowspecCommunity=spFlowspecCommunity, dnsBaseline=dnsBaseline, spThreshold=spThreshold, spCloudSignalFaultDescription=spCloudSignalFaultDescription, peakflowSPMgr=peakflowSPMgr, spApplicationName=spApplicationName, spHijackAttr=spHijackAttr, peakflowSPMIB=peakflowSPMIB, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintName=spFingerprintName, spFlowspecTimeout=spFlowspecTimeout, spcommFailureDone=spcommFailureDone, spHardwareFailureDescription=spHardwareFailureDescription, spBlackholeNexthop=spBlackholeNexthop, dnsBaselineDone=dnsBaselineDone, configChange=configChange, dosHostDetectionAlertDone=dosHostDetectionAlertDone, licenseError=licenseError, spInetAddress=spInetAddress, spThirdPartyAddr=spThirdPartyAddr, greDownDone=greDownDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, cloudSignalingFault=cloudSignalingFault, spBGPTrapName=spBGPTrapName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, fingerprintFeedback=fingerprintFeedback)
