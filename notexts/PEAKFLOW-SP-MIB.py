...
# Produced by pysmi-1.1.12 at Wed Jun 26 13:31:09 2024
...
Counter32, Unsigned32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter64, TimeTicks, NotificationType, ModuleIdentity, ObjectIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter64", "TimeTicks", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spReportURL=spReportURL, spThirdPartyZone=spThirdPartyZone, collectorDown=collectorDown, deviceSwapSpace=deviceSwapSpace, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlert=dosHostDetectionAlert, spDNSObservedMean=spDNSObservedMean, spBlackholeCommunity=spBlackholeCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsage=serviceUsage, spFingerprintSender=spFingerprintSender, spUsage=spUsage, spFlowspecCommunity=spFlowspecCommunity, greDownDone=greDownDone, routingFailover=routingFailover, spBGPTrapName=spBGPTrapName, spFingerprintMessage=spFingerprintMessage, spInterfaceUsageHC=spInterfaceUsageHC, hardwareFailureDone=hardwareFailureDone, reportDone=reportDone, mitigationTMSStartV2=mitigationTMSStartV2, spThirdPartyAddr=spThirdPartyAddr, spBGPInstability=spBGPInstability, spFingerprintName=spFingerprintName, spScriptPort=spScriptPort, spDNSExpected=spDNSExpected, deviceHealth=deviceHealth, spcommFailure=spcommFailure, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackLocal=spHijackLocal, bgpTrap=bgpTrap, spDNSObserved=spDNSObserved, spGreTunnelName=spGreTunnelName, spcommFailureDone=spcommFailureDone, spHijackAttr=spHijackAttr, spUnit=spUnit, spImpactBps=spImpactBps, peakflowSPTraps=peakflowSPTraps, trafficAutoMitigation=trafficAutoMitigation, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapPrefix=spBGPTrapPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, mitigationFlowspecStart=mitigationFlowspecStart, spInterface=spInterface, spFingerprintFeedback=spFingerprintFeedback, snmpUp=snmpUp, spManagedObject=spManagedObject, spDetector=spDetector, spManagedObjectFamily=spManagedObjectFamily, deviceTotalFlows=deviceTotalFlows, spInetAddressType=spInetAddressType, spInterfaceUsage=spInterfaceUsage, spPravail=spPravail, spScriptCommand=spScriptCommand, flowDown=flowDown, spLicenseErrType=spLicenseErrType, interfaceUsageDone=interfaceUsageDone, spServiceElement=spServiceElement, spDetectedCountries=spDetectedCountries, spGreTunnelDestination=spGreTunnelDestination, spBlackholeNexthop=spBlackholeNexthop, alertScript=alertScript, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPMIB=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, fingerprintReceive=fingerprintReceive, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptStart=spScriptStart, spTMSCommunity=spTMSCommunity, spCollector=spCollector, deviceSystemErrorDone=deviceSystemErrorDone, spRouter=spRouter, spScriptHost=spScriptHost, spApplicationName=spApplicationName, spUsername=spUsername, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObjects=spManagedObjects, managedObjectUsage=managedObjectUsage, spInetAddress=spInetAddress, licenseErrorDone=licenseErrorDone, deviceDiskUsage=deviceDiskUsage, notificationLimit=notificationLimit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, fingerprintUsageDone=fingerprintUsageDone, hardwareFailure=hardwareFailure, spBGPEvent=spBGPEvent, spAlertID=spAlertID, bgpInstability=bgpInstability, peakflowSPCMI=peakflowSPCMI, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterfaceIndex=spInterfaceIndex, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBlackholeTimeout=spBlackholeTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDNSName=spDNSName, dnsBaselineDone=dnsBaselineDone, spTMSTimeout=spTMSTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, collectorUp=collectorUp, spSystemErrorType=spSystemErrorType, fingerprintUsage=fingerprintUsage, spMitigationName=spMitigationName, serviceUsageDone=serviceUsageDone, licenseError=licenseError, spVersion=spVersion, dnsBaseline=dnsBaseline, deviceSystemError=deviceSystemError, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsageType=spUsageType, spThreshold=spThreshold, spMitigationStart=spMitigationStart, spTMSMultiPrefix=spTMSMultiPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholePrefix=spBlackholePrefix, devicePhysicalMemory=devicePhysicalMemory, interfaceUsage=interfaceUsage, collectorStart=collectorStart, spCommFailureDestination=spCommFailureDestination, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackRoute=spHijackRoute, peakflowSPMgr=peakflowSPMgr, flowUp=flowUp, managedObjectUsageDone=managedObjectUsageDone, greDown=greDown, spReportName=spReportName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactPps=spImpactPps, spMitigationID=spMitigationID, spLicenseErrLimit=spLicenseErrLimit, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationTMSStart=mitigationTMSStart, mitigationBlackholeStart=mitigationBlackholeStart, deviceTotalFlowsHC=deviceTotalFlowsHC, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDuration=spDuration, spTMSPrefix=spTMSPrefix, spInterfaceSpeed=spInterfaceSpeed, bgpDown=bgpDown, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDNSObservedMax=spDNSObservedMax, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpUp=bgpUp, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationDone=mitigationDone, spCommFailureDescription=spCommFailureDescription, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, snmpDown=snmpDown, autoclassifyStart=autoclassifyStart, fingerprintFeedback=fingerprintFeedback, spHardwareFailureDescription=spHardwareFailureDescription, configChange=configChange, spLicenseErrDescription=spLicenseErrDescription, spServiceName=spServiceName, spLicenseErrCount=spLicenseErrCount, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spReportID=spReportID, spSystemErrorDescription=spSystemErrorDescription)
