...
# Produced by pysmi-1.1.12 at Mon Jun  3 14:02:58 2024
...
ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, iso, IpAddress, MibIdentifier, Gauge32, Counter32, ObjectIdentity, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHardwareFailureDescription=spHardwareFailureDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spTMSCommunity=spTMSCommunity, spFingerprintSender=spFingerprintSender, mitigationFlowspecStart=mitigationFlowspecStart, mitigationTMSStartV2=mitigationTMSStartV2, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spSystemErrorType=spSystemErrorType, spUsername=spUsername, spCloudSignalFaultDescription=spCloudSignalFaultDescription, bgpTrap=bgpTrap, autoclassifyStart=autoclassifyStart, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, spDetectedCountries=spDetectedCountries, spBGPTrapOldAttributes=spBGPTrapOldAttributes, managedObjectUsage=managedObjectUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSTimeout=spTMSTimeout, snmpDown=snmpDown, spInterfaceSpeed=spInterfaceSpeed, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceUsage=spInterfaceUsage, bgpDown=bgpDown, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapEvent=spBGPTrapEvent, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapName=spBGPTrapName, PYSNMP_MODULE_ID=peakflowSPMIB, spVersion=spVersion, spScriptStart=spScriptStart, peakflowSPMgr=peakflowSPMgr, hardwareFailureDone=hardwareFailureDone, spManagedObject=spManagedObject, spDuration=spDuration, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpUp=bgpUp, spcommFailure=spcommFailure, spFlowspecCommunity=spFlowspecCommunity, spBlackholePrefix=spBlackholePrefix, spInterface=spInterface, spcommFailureDone=spcommFailureDone, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSMultiPrefix=spTMSMultiPrefix, spDNSExpected=spDNSExpected, trafficAutoMitigation=trafficAutoMitigation, spDNSObservedMax=spDNSObservedMax, bgpHijack=bgpHijack, spScriptPort=spScriptPort, spUnit=spUnit, spScriptCommand=spScriptCommand, flowUp=flowUp, peakflowSPCMI=peakflowSPCMI, collectorDown=collectorDown, collectorUp=collectorUp, spSystemErrorDescription=spSystemErrorDescription, licenseErrorDone=licenseErrorDone, greDown=greDown, spUsageType=spUsageType, spGreTunnelDestination=spGreTunnelDestination, dnsBaselineDone=dnsBaselineDone, mitigationDone=mitigationDone, reportDone=reportDone, spThreshold=spThreshold, spLicenseErrDescription=spLicenseErrDescription, licenseError=licenseError, spBGPEvent=spBGPEvent, spReportName=spReportName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceTotalFlows=deviceTotalFlows, deviceSwapSpace=deviceSwapSpace, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spFingerprintMessage=spFingerprintMessage, spMitigationID=spMitigationID, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBGPTrapPrefix=spBGPTrapPrefix, flowDown=flowDown, spFingerprintName=spFingerprintName, spThirdPartyZone=spThirdPartyZone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spDetector=spDetector, alertScript=alertScript, spMitigationStart=spMitigationStart, serviceUsage=serviceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, serviceUsageDone=serviceUsageDone, spFingerprintFeedback=spFingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, spGreTunnelName=spGreTunnelName, interfaceUsageDone=interfaceUsageDone, spServiceElement=spServiceElement, spBlackholeTimeout=spBlackholeTimeout, spManagedObjects=spManagedObjects, spServiceName=spServiceName, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPMIB=peakflowSPMIB, spImpactPps=spImpactPps, spManagedObjectFamily=spManagedObjectFamily, peakflowSPTraps=peakflowSPTraps, spLicenseErrCount=spLicenseErrCount, spHijackAttr=spHijackAttr, spMitigationName=spMitigationName, spInetAddress=spInetAddress, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterfaceIndex=spInterfaceIndex, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spReportURL=spReportURL, dnsBaseline=dnsBaseline, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSName=spDNSName, bgpInstability=bgpInstability, spInetAddressType=spInetAddressType, spDNSObserved=spDNSObserved, spHijackRoute=spHijackRoute, deviceTotalFlowsHC=deviceTotalFlowsHC, spCollector=spCollector, snmpUp=snmpUp, spImpactBps=spImpactBps, spInterfaceUsageHC=spInterfaceUsageHC, spReportID=spReportID, spScriptHost=spScriptHost, spDNSObservedMean=spDNSObservedMean, spApplicationName=spApplicationName, collectorStart=collectorStart, managedObjectUsageDone=managedObjectUsageDone, spAlertID=spAlertID, spCommFailureDescription=spCommFailureDescription, deviceDiskUsage=deviceDiskUsage, spHijackLocal=spHijackLocal, spBlackholeNexthop=spBlackholeNexthop, bgpInstabilityDone=bgpInstabilityDone, spPravail=spPravail, spBlackholeCommunity=spBlackholeCommunity, greDownDone=greDownDone, spUsage=spUsage, deviceHealth=deviceHealth, spLicenseErrType=spLicenseErrType, fingerprintUsage=fingerprintUsage, configChange=configChange, deviceSystemError=deviceSystemError, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, fingerprintReceive=fingerprintReceive, routingFailover=routingFailover, interfaceUsage=interfaceUsage, fingerprintUsageDone=fingerprintUsageDone, mitigationTMSStart=mitigationTMSStart, spBGPInstability=spBGPInstability, cloudSignalingFault=cloudSignalingFault, dosHostDetectionAlert=dosHostDetectionAlert, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spFlowspecTimeout=spFlowspecTimeout)
