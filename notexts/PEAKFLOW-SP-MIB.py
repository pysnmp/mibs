...
ModuleIdentity, Unsigned32, Counter64, NotificationType, Integer32, Counter32, iso, TimeTicks, Gauge32, IpAddress, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "NotificationType", "Integer32", "Counter32", "iso", "TimeTicks", "Gauge32", "IpAddress", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceTotalFlows=deviceTotalFlows, spGreTunnelName=spGreTunnelName, snmpDown=snmpDown, spImpactPps=spImpactPps, dosHostDetectionAlert=dosHostDetectionAlert, bgpHijack=bgpHijack, spDetectedCountries=spDetectedCountries, licenseError=licenseError, notificationLimit=notificationLimit, cloudSignalingFaultDone=cloudSignalingFaultDone, spUsername=spUsername, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, spInterfaceIndex=spInterfaceIndex, spHijackLocal=spHijackLocal, spTMSMultiPrefix=spTMSMultiPrefix, spPravail=spPravail, spUsage=spUsage, alertScript=alertScript, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spThirdPartyZone=spThirdPartyZone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spImpactBps=spImpactBps, mitigationTMSStart=mitigationTMSStart, spDNSName=spDNSName, spDNSObserved=spDNSObserved, spSystemErrorDescription=spSystemErrorDescription, spReportURL=spReportURL, fingerprintFeedback=fingerprintFeedback, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spManagedObject=spManagedObject, bgpDown=bgpDown, spFingerprintName=spFingerprintName, collectorUp=collectorUp, spDNSExpected=spDNSExpected, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptPort=spScriptPort, hardwareFailure=hardwareFailure, hardwareFailureDone=hardwareFailureDone, spInterfaceUsageHC=spInterfaceUsageHC, spSystemErrorType=spSystemErrorType, spServiceElement=spServiceElement, dnsBaseline=dnsBaseline, spAlertDetectionSignatures=spAlertDetectionSignatures, spApplicationName=spApplicationName, collectorDown=collectorDown, spThirdPartyAddr=spThirdPartyAddr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, spInetAddressType=spInetAddressType, spServiceName=spServiceName, spDetector=spDetector, spCommFailureDescription=spCommFailureDescription, spHijackAttr=spHijackAttr, spInterfaceUsage=spInterfaceUsage, spBGPTrapEvent=spBGPTrapEvent, fingerprintUsageDone=fingerprintUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHijackRoute=spHijackRoute, spCollector=spCollector, spRouter=spRouter, spInetAddress=spInetAddress, spCommFailureDestination=spCommFailureDestination, spMitigationID=spMitigationID, configChange=configChange, managedObjectUsageDone=managedObjectUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSObservedMax=spDNSObservedMax, spTMSCommunity=spTMSCommunity, interfaceUsage=interfaceUsage, serviceUsageDone=serviceUsageDone, peakflowSPTraps=peakflowSPTraps, spMitigationName=spMitigationName, spManagedObjects=spManagedObjects, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPMgr=peakflowSPMgr, spLicenseErrType=spLicenseErrType, bgpTrap=bgpTrap, flowDown=flowDown, bgpUp=bgpUp, spLicenseErrLimit=spLicenseErrLimit, snmpUp=snmpUp, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrCount=spLicenseErrCount, spScriptStart=spScriptStart, peakflowSPCMI=peakflowSPCMI, collectorStart=collectorStart, spFlowspecCommunity=spFlowspecCommunity, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, interfaceUsageDone=interfaceUsageDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPMIB=peakflowSPMIB, spcommFailureDone=spcommFailureDone, spAlertID=spAlertID, cloudSignalingFault=cloudSignalingFault, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spVersion=spVersion, bgpInstability=bgpInstability, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSTimeout=spTMSTimeout, spTMSPrefix=spTMSPrefix, spDNSObservedMean=spDNSObservedMean, deviceDiskUsage=deviceDiskUsage, fingerprintUsage=fingerprintUsage, reportDone=reportDone, spBGPTrapName=spBGPTrapName, spcommFailure=spcommFailure, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationFlowspecStart=mitigationFlowspecStart, routingFailover=routingFailover, deviceSwapSpace=deviceSwapSpace, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, devicePhysicalMemory=devicePhysicalMemory, spBlackholeTimeout=spBlackholeTimeout, fingerprintReceive=fingerprintReceive, spBGPInstability=spBGPInstability, spScriptCommand=spScriptCommand, deviceTotalFlowsHC=deviceTotalFlowsHC, spFlowspecTimeout=spFlowspecTimeout, greDownDone=greDownDone, spReportID=spReportID, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptHost=spScriptHost, mitigationBlackholeStart=mitigationBlackholeStart, spHardwareFailureDescription=spHardwareFailureDescription, greDown=greDown, dnsBaselineDone=dnsBaselineDone, spInterface=spInterface, managedObjectUsage=managedObjectUsage, spReportName=spReportName, serviceUsage=serviceUsage, spGreTunnelDestination=spGreTunnelDestination, spUnit=spUnit, trafficAutoMitigation=trafficAutoMitigation, spInterfaceSpeed=spInterfaceSpeed, spBGPEvent=spBGPEvent, spManagedObjectFamily=spManagedObjectFamily, autoclassifyStart=autoclassifyStart, spMitigationStart=spMitigationStart, deviceHealth=deviceHealth, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, mitigationTMSStartV2=mitigationTMSStartV2, spBlackholeCommunity=spBlackholeCommunity, spBlackholeNexthop=spBlackholeNexthop, spDuration=spDuration, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spLicenseErrDescription=spLicenseErrDescription, mitigationDone=mitigationDone, spFingerprintFeedback=spFingerprintFeedback, spBlackholePrefix=spBlackholePrefix, bgpInstabilityDone=bgpInstabilityDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSystemError=deviceSystemError, licenseErrorDone=licenseErrorDone, flowUp=flowUp)
