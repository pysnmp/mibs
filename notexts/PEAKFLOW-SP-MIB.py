...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:50:48 2021
...
MibIdentifier, Integer32, iso, Gauge32, TimeTicks, ModuleIdentity, Unsigned32, Bits, NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "iso", "Gauge32", "TimeTicks", "ModuleIdentity", "Unsigned32", "Bits", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapEvent=spBGPTrapEvent, bgpInstabilityDone=bgpInstabilityDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceTotalFlows=deviceTotalFlows, spBlackholeNexthop=spBlackholeNexthop, spScriptCommand=spScriptCommand, spImpactPps=spImpactPps, spTMSPrefix=spTMSPrefix, spHijackRoute=spHijackRoute, hardwareFailureDone=hardwareFailureDone, spVersion=spVersion, spBlackholeTimeout=spBlackholeTimeout, spManagedObject=spManagedObject, spLicenseErrDescription=spLicenseErrDescription, spImpactBps=spImpactBps, greDown=greDown, bgpUp=bgpUp, peakflowSPCMI=peakflowSPCMI, spBlackholeCommunity=spBlackholeCommunity, licenseErrorDone=licenseErrorDone, spPravail=spPravail, hardwareFailure=hardwareFailure, spLicenseErrCount=spLicenseErrCount, spRouter=spRouter, spDNSObservedMax=spDNSObservedMax, spThirdPartyAddr=spThirdPartyAddr, mitigationTMSStartV2=mitigationTMSStartV2, licenseError=licenseError, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpDown=bgpDown, mitigationFlowspecStart=mitigationFlowspecStart, serviceUsageDone=serviceUsageDone, spInterfaceSpeed=spInterfaceSpeed, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailover=routingFailover, peakflowSPMIB=peakflowSPMIB, collectorStart=collectorStart, spReportURL=spReportURL, spBlackholePrefix=spBlackholePrefix, flowUp=flowUp, spMitigationStart=spMitigationStart, deviceDiskUsage=deviceDiskUsage, dosHostDetectionAlert=dosHostDetectionAlert, spCollector=spCollector, spCommFailureDescription=spCommFailureDescription, spDNSName=spDNSName, spBGPTrapName=spBGPTrapName, spSystemErrorType=spSystemErrorType, bgpTrap=bgpTrap, spThirdPartyZone=spThirdPartyZone, spBGPEvent=spBGPEvent, configChange=configChange, spThreshold=spThreshold, serviceUsage=serviceUsage, fingerprintReceive=fingerprintReceive, spInterfaceIndex=spInterfaceIndex, dnsBaselineDone=dnsBaselineDone, greDownDone=greDownDone, mitigationBlackholeStart=mitigationBlackholeStart, spDetector=spDetector, autoclassifyStart=autoclassifyStart, spApplicationName=spApplicationName, spGreTunnelName=spGreTunnelName, spBGPInstability=spBGPInstability, spHijackLocal=spHijackLocal, collectorDown=collectorDown, spLicenseErrType=spLicenseErrType, spScriptPort=spScriptPort, spManagedObjects=spManagedObjects, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrLimit=spLicenseErrLimit, flowDown=flowDown, managedObjectUsage=managedObjectUsage, spTMSTimeout=spTMSTimeout, managedObjectUsageDone=managedObjectUsageDone, spReportID=spReportID, mitigationDone=mitigationDone, snmpUp=snmpUp, trafficAutoMitigation=trafficAutoMitigation, spTMSMultiPrefix=spTMSMultiPrefix, spDNSObservedMean=spDNSObservedMean, spInetAddress=spInetAddress, spManagedObjectFamily=spManagedObjectFamily, spInetAddressType=spInetAddressType, interfaceUsageDone=interfaceUsageDone, spDNSObserved=spDNSObserved, fingerprintUsage=fingerprintUsage, cloudSignalingFault=cloudSignalingFault, spAlertID=spAlertID, notificationLimit=notificationLimit, collectorUp=collectorUp, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spServiceName=spServiceName, fingerprintUsageDone=fingerprintUsageDone, spHijackAttr=spHijackAttr, spTMSCommunity=spTMSCommunity, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemory=devicePhysicalMemory, bgpInstability=bgpInstability, spScriptHost=spScriptHost, spFingerprintName=spFingerprintName, spcommFailure=spcommFailure, deviceSystemErrorDone=deviceSystemErrorDone, spUsageType=spUsageType, spMitigationName=spMitigationName, spUnit=spUnit, interfaceUsage=interfaceUsage, snmpDown=snmpDown, spFingerprintMessage=spFingerprintMessage, deviceTotalFlowsHC=deviceTotalFlowsHC, spcommFailureDone=spcommFailureDone, deviceSystemError=deviceSystemError, mitigationTMSStart=mitigationTMSStart, peakflowSPMgr=peakflowSPMgr, spInterface=spInterface, spCommFailureDestination=spCommFailureDestination, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintFeedback=fingerprintFeedback, spServiceElement=spServiceElement, spMitigationID=spMitigationID, spSystemErrorDescription=spSystemErrorDescription, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSExpected=spDNSExpected, cloudSignalingFaultDone=cloudSignalingFaultDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spFingerprintSender=spFingerprintSender, spUsage=spUsage, spHardwareFailureDescription=spHardwareFailureDescription, spUsername=spUsername, bgpHijack=bgpHijack, spInterfaceUsage=spInterfaceUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptStart=spScriptStart, spAlertDetectionSignatures=spAlertDetectionSignatures, alertScript=alertScript, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterfaceUsageHC=spInterfaceUsageHC, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceSwapSpace=deviceSwapSpace, spBGPTrapPrefix=spBGPTrapPrefix, spFlowspecCommunity=spFlowspecCommunity, spReportName=spReportName, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPTraps=peakflowSPTraps, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaseline=dnsBaseline, reportDone=reportDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spGreTunnelDestination=spGreTunnelDestination, spDuration=spDuration, deviceHealth=deviceHealth)
