...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:07:12 2024
...
MibIdentifier, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, TimeTicks, IpAddress, Counter64, Integer32, Bits, Counter32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "TimeTicks", "IpAddress", "Counter64", "Integer32", "Bits", "Counter32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spUsername=spUsername, spScriptStart=spScriptStart, spManagedObjectFamily=spManagedObjectFamily, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPMIB=peakflowSPMIB, devicePhysicalMemory=devicePhysicalMemory, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spServiceName=spServiceName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSystemErrorDone=deviceSystemErrorDone, bgpHijack=bgpHijack, fingerprintFeedback=fingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, spReportName=spReportName, spMitigationStart=spMitigationStart, spTMSMultiPrefix=spTMSMultiPrefix, notificationLimit=notificationLimit, spCommFailureDescription=spCommFailureDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, autoclassifyStart=autoclassifyStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, serviceUsageDone=serviceUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spLicenseErrType=spLicenseErrType, mitigationDone=mitigationDone, spInetAddressType=spInetAddressType, flowUp=flowUp, spBGPInstability=spBGPInstability, spServiceElement=spServiceElement, serviceUsage=serviceUsage, spBGPTrapName=spBGPTrapName, bgpDown=bgpDown, hardwareFailureDone=hardwareFailureDone, spInterfaceSpeed=spInterfaceSpeed, spPravail=spPravail, interfaceUsageDone=interfaceUsageDone, spcommFailure=spcommFailure, managedObjectUsage=managedObjectUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptCommand=spScriptCommand, spApplicationName=spApplicationName, spUsage=spUsage, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationTMSStartV2=mitigationTMSStartV2, bgpInstability=bgpInstability, peakflowSPMgr=peakflowSPMgr, bgpUp=bgpUp, cloudSignalingFaultDone=cloudSignalingFaultDone, spImpactPps=spImpactPps, licenseError=licenseError, licenseErrorDone=licenseErrorDone, spHijackRoute=spHijackRoute, spAlertID=spAlertID, spDNSObservedMean=spDNSObservedMean, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemError=deviceSystemError, spScriptPort=spScriptPort, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spGreTunnelDestination=spGreTunnelDestination, spFingerprintName=spFingerprintName, spInterfaceUsageHC=spInterfaceUsageHC, spUnit=spUnit, PYSNMP_MODULE_ID=peakflowSPMIB, deviceHealth=deviceHealth, spInterfaceUsage=spInterfaceUsage, spBlackholeTimeout=spBlackholeTimeout, spDuration=spDuration, greDownDone=greDownDone, spDetectedCountries=spDetectedCountries, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCommFailureDestination=spCommFailureDestination, spDNSExpected=spDNSExpected, routingFailover=routingFailover, deviceTotalFlows=deviceTotalFlows, spTMSTimeout=spTMSTimeout, hardwareFailure=hardwareFailure, flowDown=flowDown, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecCommunity=spFlowspecCommunity, spFingerprintFeedback=spFingerprintFeedback, spLicenseErrCount=spLicenseErrCount, spReportID=spReportID, spCollector=spCollector, bgpInstabilityDone=bgpInstabilityDone, spFlowspecTimeout=spFlowspecTimeout, dosHostDetectionAlert=dosHostDetectionAlert, managedObjectUsageDone=managedObjectUsageDone, spLicenseErrDescription=spLicenseErrDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorDown=collectorDown, spVersion=spVersion, bgpTrap=bgpTrap, greDown=greDown, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spHardwareFailureDescription=spHardwareFailureDescription, configChange=configChange, deviceSwapSpace=deviceSwapSpace, collectorStart=collectorStart, peakflowSPCMI=peakflowSPCMI, fingerprintUsage=fingerprintUsage, spMitigationID=spMitigationID, spBlackholeNexthop=spBlackholeNexthop, spReportURL=spReportURL, dnsBaseline=dnsBaseline, spFingerprintMessage=spFingerprintMessage, spDNSName=spDNSName, spUsageType=spUsageType, spBGPEvent=spBGPEvent, spHijackAttr=spHijackAttr, spManagedObject=spManagedObject, dnsBaselineDone=dnsBaselineDone, spInterfaceIndex=spInterfaceIndex, spHijackLocal=spHijackLocal, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorUp=collectorUp, spFingerprintSender=spFingerprintSender, interfaceUsage=interfaceUsage, spcommFailureDone=spcommFailureDone, spInterface=spInterface, spRouter=spRouter, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spThirdPartyZone=spThirdPartyZone, peakflowSPTraps=peakflowSPTraps, spDNSObserved=spDNSObserved, spInetAddress=spInetAddress, cloudSignalingFault=cloudSignalingFault, alertScript=alertScript, spScriptHost=spScriptHost, spBlackholeCommunity=spBlackholeCommunity, mitigationFlowspecStart=mitigationFlowspecStart, spGreTunnelName=spGreTunnelName, spTMSCommunity=spTMSCommunity, mitigationTMSStart=mitigationTMSStart, trafficAutoMitigation=trafficAutoMitigation, spSystemErrorType=spSystemErrorType, spDNSObservedMax=spDNSObservedMax, spBlackholePrefix=spBlackholePrefix, spThreshold=spThreshold, snmpUp=snmpUp, spMitigationName=spMitigationName, spLicenseErrLimit=spLicenseErrLimit, spTMSPrefix=spTMSPrefix, spThirdPartyAddr=spThirdPartyAddr, snmpDown=snmpDown, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapNewAttributes=spBGPTrapNewAttributes, reportDone=reportDone, deviceDiskUsage=deviceDiskUsage, spBGPTrapPrefix=spBGPTrapPrefix, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObjects=spManagedObjects, spDetector=spDetector, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate)
