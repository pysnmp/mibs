...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:25:38 2022
...
TimeTicks, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, Integer32, Counter32, iso, MibIdentifier, NotificationType, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "Integer32", "Counter32", "iso", "MibIdentifier", "NotificationType", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", trafficAutoMitigation=trafficAutoMitigation, spHijackLocal=spHijackLocal, spDNSObservedMean=spDNSObservedMean, spHijackRoute=spHijackRoute, spFingerprintSender=spFingerprintSender, spLicenseErrLimit=spLicenseErrLimit, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, hardwareFailureDone=hardwareFailureDone, deviceTotalFlows=deviceTotalFlows, dnsBaselineDone=dnsBaselineDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpTrap=bgpTrap, spReportURL=spReportURL, spManagedObjects=spManagedObjects, bgpInstability=bgpInstability, spDetectedCountries=spDetectedCountries, spHijackAttr=spHijackAttr, bgpDown=bgpDown, spGreTunnelDestination=spGreTunnelDestination, spBGPInstability=spBGPInstability, spBlackholePrefix=spBlackholePrefix, spPravail=spPravail, spDNSObservedMax=spDNSObservedMax, PYSNMP_MODULE_ID=peakflowSPMIB, snmpDown=snmpDown, spFingerprintName=spFingerprintName, peakflowSPMIB=peakflowSPMIB, spFingerprintFeedback=spFingerprintFeedback, spManagedObjectFamily=spManagedObjectFamily, deviceSwapSpace=deviceSwapSpace, interfaceUsage=interfaceUsage, spFlowspecCommunity=spFlowspecCommunity, alertScript=alertScript, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPCMI=peakflowSPCMI, spServiceElement=spServiceElement, spCommFailureDescription=spCommFailureDescription, spFingerprintMessage=spFingerprintMessage, collectorStart=collectorStart, deviceDiskUsage=deviceDiskUsage, notificationLimit=notificationLimit, spMitigationStart=spMitigationStart, spSystemErrorDescription=spSystemErrorDescription, spDNSExpected=spDNSExpected, mitigationTMSStartV2=mitigationTMSStartV2, spThirdPartyAddr=spThirdPartyAddr, spManagedObject=spManagedObject, peakflowSPMgr=peakflowSPMgr, spCollector=spCollector, spImpactPps=spImpactPps, spGreTunnelName=spGreTunnelName, spLicenseErrType=spLicenseErrType, spServiceName=spServiceName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spcommFailureDone=spcommFailureDone, greDownDone=greDownDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, mitigationBlackholeStart=mitigationBlackholeStart, spBGPEvent=spBGPEvent, spTMSTimeout=spTMSTimeout, interfaceUsageDone=interfaceUsageDone, serviceUsageDone=serviceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, collectorUp=collectorUp, routingFailover=routingFailover, mitigationThirdPartyStart=mitigationThirdPartyStart, spSystemErrorType=spSystemErrorType, greDown=greDown, licenseError=licenseError, dosHostDetectionAlert=dosHostDetectionAlert, spDNSObserved=spDNSObserved, spDuration=spDuration, spInterfaceSpeed=spInterfaceSpeed, spThreshold=spThreshold, spMitigationID=spMitigationID, spInetAddressType=spInetAddressType, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpHijack=bgpHijack, configChange=configChange, flowDown=flowDown, spLicenseErrDescription=spLicenseErrDescription, mitigationTMSStart=mitigationTMSStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSystemError=deviceSystemError, spScriptHost=spScriptHost, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, dnsBaseline=dnsBaseline, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSName=spDNSName, spTMSPrefix=spTMSPrefix, spDetector=spDetector, deviceSystemErrorDone=deviceSystemErrorDone, mitigationDone=mitigationDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceIndex=spInterfaceIndex, autoclassifyStart=autoclassifyStart, serviceUsage=serviceUsage, licenseErrorDone=licenseErrorDone, spTMSMultiPrefix=spTMSMultiPrefix, fingerprintUsageDone=fingerprintUsageDone, spBlackholeNexthop=spBlackholeNexthop, spUsername=spUsername, spUsageType=spUsageType, spBGPTrapPrefix=spBGPTrapPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, fingerprintFeedback=fingerprintFeedback, spMitigationName=spMitigationName, bgpUp=bgpUp, fingerprintReceive=fingerprintReceive, spCloudSignalFaultDescription=spCloudSignalFaultDescription, cloudSignalingFault=cloudSignalingFault, spHardwareFailureDescription=spHardwareFailureDescription, deviceHealth=deviceHealth, spScriptStart=spScriptStart, spImpactBps=spImpactBps, spReportID=spReportID, spVersion=spVersion, spThirdPartyZone=spThirdPartyZone, spScriptPort=spScriptPort, spBlackholeTimeout=spBlackholeTimeout, spInetAddress=spInetAddress, spInterface=spInterface, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, flowUp=flowUp, peakflowSPTraps=peakflowSPTraps, managedObjectUsage=managedObjectUsage, spBGPTrapName=spBGPTrapName, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptCommand=spScriptCommand, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, bgpInstabilityDone=bgpInstabilityDone, devicePhysicalMemory=devicePhysicalMemory, snmpUp=snmpUp, spAlertID=spAlertID, spFlowspecTimeout=spFlowspecTimeout, spUnit=spUnit, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceTotalFlowsHC=deviceTotalFlowsHC, hardwareFailure=hardwareFailure, spcommFailure=spcommFailure, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrCount=spLicenseErrCount, spInterfaceUsage=spInterfaceUsage, spTMSCommunity=spTMSCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBlackholeCommunity=spBlackholeCommunity, fingerprintUsage=fingerprintUsage, spCommFailureDestination=spCommFailureDestination, spReportName=spReportName, spApplicationName=spApplicationName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, managedObjectUsageDone=managedObjectUsageDone, collectorDown=collectorDown, reportDone=reportDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsageHC=spInterfaceUsageHC, spUsage=spUsage)
