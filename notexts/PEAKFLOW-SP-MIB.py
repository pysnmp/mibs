...
MibIdentifier, iso, ObjectIdentity, Bits, TimeTicks, NotificationType, ModuleIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "ObjectIdentity", "Bits", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDestination=spCommFailureDestination, spInetAddress=spInetAddress, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholeTimeout=spBlackholeTimeout, spThreshold=spThreshold, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeedHC=spInterfaceSpeedHC, spDNSObservedMean=spDNSObservedMean, spScriptHost=spScriptHost, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInterfaceUsage=spInterfaceUsage, spTMSPrefix=spTMSPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, snmpUp=snmpUp, deviceTotalFlowsHC=deviceTotalFlowsHC, spAlertID=spAlertID, deviceTotalFlows=deviceTotalFlows, bgpHijack=bgpHijack, licenseError=licenseError, devicePhysicalMemory=devicePhysicalMemory, hardwareFailure=hardwareFailure, dnsBaseline=dnsBaseline, bgpDown=bgpDown, spImpactPps=spImpactPps, mitigationFlowspecStart=mitigationFlowspecStart, spDNSExpected=spDNSExpected, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPTraps=peakflowSPTraps, deviceSwapSpace=deviceSwapSpace, spUnit=spUnit, trafficAutoMitigation=trafficAutoMitigation, spScriptStart=spScriptStart, spReportName=spReportName, spInterfaceUsageHC=spInterfaceUsageHC, spTMSMultiPrefix=spTMSMultiPrefix, collectorStart=collectorStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spReportID=spReportID, mitigationBlackholeStart=mitigationBlackholeStart, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrLimit=spLicenseErrLimit, deviceDiskUsage=deviceDiskUsage, hardwareFailureDone=hardwareFailureDone, spSystemErrorDescription=spSystemErrorDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapPrefix=spBGPTrapPrefix, spVersion=spVersion, spDNSName=spDNSName, cloudSignalingFaultDone=cloudSignalingFaultDone, spThirdPartyZone=spThirdPartyZone, spBlackholeNexthop=spBlackholeNexthop, spInetAddressType=spInetAddressType, reportDone=reportDone, spInterfaceIndex=spInterfaceIndex, spManagedObjectFamily=spManagedObjectFamily, managedObjectUsage=managedObjectUsage, dnsBaselineDone=dnsBaselineDone, deviceSystemError=deviceSystemError, flowDown=flowDown, bgpInstability=bgpInstability, spLicenseErrDescription=spLicenseErrDescription, spMitigationName=spMitigationName, spReportURL=spReportURL, spScriptCommand=spScriptCommand, routingFailover=routingFailover, mitigationTMSStart=mitigationTMSStart, spBGPEvent=spBGPEvent, spDetectedCountries=spDetectedCountries, spUsername=spUsername, notificationLimit=notificationLimit, spFingerprintMessage=spFingerprintMessage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spcommFailure=spcommFailure, alertScript=alertScript, spPravail=spPravail, spGreTunnelDestination=spGreTunnelDestination, snmpDown=snmpDown, bgpTrap=bgpTrap, spManagedObject=spManagedObject, configChange=configChange, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecTimeout=spFlowspecTimeout, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, serviceUsage=serviceUsage, spDetector=spDetector, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, interfaceUsage=interfaceUsage, peakflowSPMgr=peakflowSPMgr, flowUp=flowUp, spServiceElement=spServiceElement, greDown=greDown, peakflowSPMIB=peakflowSPMIB, spInterfaceSpeed=spInterfaceSpeed, spSystemErrorType=spSystemErrorType, greDownDone=greDownDone, spDuration=spDuration, spHijackRoute=spHijackRoute, spDNSObserved=spDNSObserved, spFingerprintName=spFingerprintName, spFlowspecCommunity=spFlowspecCommunity, fingerprintUsage=fingerprintUsage, mitigationDone=mitigationDone, spHijackLocal=spHijackLocal, spcommFailureDone=spcommFailureDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCollector=spCollector, spBGPTrapOldAttributes=spBGPTrapOldAttributes, serviceUsageDone=serviceUsageDone, autoclassifyStart=autoclassifyStart, collectorUp=collectorUp, spTMSCommunity=spTMSCommunity, spScriptPort=spScriptPort, spCommFailureDescription=spCommFailureDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, spUsage=spUsage, collectorDown=collectorDown, spGreTunnelName=spGreTunnelName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, interfaceUsageDone=interfaceUsageDone, spLicenseErrType=spLicenseErrType, spManagedObjects=spManagedObjects, spBGPTrapName=spBGPTrapName, mitigationThirdPartyStart=mitigationThirdPartyStart, spApplicationName=spApplicationName, spHardwareFailureDescription=spHardwareFailureDescription, spServiceName=spServiceName, licenseErrorDone=licenseErrorDone, spDNSObservedMax=spDNSObservedMax, spFingerprintSender=spFingerprintSender, fingerprintReceive=fingerprintReceive, fingerprintUsageDone=fingerprintUsageDone, managedObjectUsageDone=managedObjectUsageDone, cloudSignalingFault=cloudSignalingFault, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPCMI=peakflowSPCMI, spTMSTimeout=spTMSTimeout, spBlackholePrefix=spBlackholePrefix, spMitigationID=spMitigationID, spImpactBps=spImpactBps, bgpUp=bgpUp, spFingerprintFeedback=spFingerprintFeedback, spLicenseErrCount=spLicenseErrCount, spBlackholeCommunity=spBlackholeCommunity, bgpInstabilityDone=bgpInstabilityDone, spBGPInstability=spBGPInstability, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationStart=spMitigationStart, deviceHealth=deviceHealth, PYSNMP_MODULE_ID=peakflowSPMIB, spHijackAttr=spHijackAttr, spUsageType=spUsageType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spRouter=spRouter, fingerprintFeedback=fingerprintFeedback, dosNetworkProfiledAlert=dosNetworkProfiledAlert)
