...
# Produced by pysmi-1.1.8 at Fri Feb 11 19:35:21 2022
...
Counter32, Bits, iso, Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "iso", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", managedObjectUsageDone=managedObjectUsageDone, spCommFailureDescription=spCommFailureDescription, configChange=configChange, spAlertDetectionSignatures=spAlertDetectionSignatures, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dnsBaseline=dnsBaseline, spLicenseErrCount=spLicenseErrCount, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelDestination=spGreTunnelDestination, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBlackholeTimeout=spBlackholeTimeout, spReportName=spReportName, mitigationThirdPartyStart=mitigationThirdPartyStart, spDetectedCountries=spDetectedCountries, spHijackLocal=spHijackLocal, spMitigationName=spMitigationName, trafficAutoMitigation=trafficAutoMitigation, spThreshold=spThreshold, collectorDown=collectorDown, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapName=spBGPTrapName, spFlowspecTimeout=spFlowspecTimeout, deviceTotalFlowsHC=deviceTotalFlowsHC, flowDown=flowDown, serviceUsageDone=serviceUsageDone, spFingerprintFeedback=spFingerprintFeedback, spApplicationName=spApplicationName, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorDescription=spSystemErrorDescription, dnsBaselineDone=dnsBaselineDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spImpactBps=spImpactBps, cloudSignalingFault=cloudSignalingFault, flowUp=flowUp, spDuration=spDuration, spBGPTrapPrefix=spBGPTrapPrefix, spBlackholeNexthop=spBlackholeNexthop, fingerprintUsageDone=fingerprintUsageDone, spDNSExpected=spDNSExpected, mitigationBlackholeStart=mitigationBlackholeStart, bgpInstability=bgpInstability, spCommFailureDestination=spCommFailureDestination, bgpDown=bgpDown, licenseError=licenseError, deviceDiskUsage=deviceDiskUsage, mitigationDone=mitigationDone, spFingerprintName=spFingerprintName, autoclassifyStart=autoclassifyStart, spScriptPort=spScriptPort, peakflowSPMgr=peakflowSPMgr, spDNSObserved=spDNSObserved, spLicenseErrDescription=spLicenseErrDescription, spTMSCommunity=spTMSCommunity, spHardwareFailureDescription=spHardwareFailureDescription, spReportURL=spReportURL, spLicenseErrLimit=spLicenseErrLimit, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceTotalFlows=deviceTotalFlows, spDNSObservedMax=spDNSObservedMax, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObservedMean=spDNSObservedMean, hardwareFailure=hardwareFailure, spScriptHost=spScriptHost, spManagedObjects=spManagedObjects, snmpUp=snmpUp, alertScript=alertScript, peakflowSPMIB=peakflowSPMIB, bgpHijack=bgpHijack, spFlowspecCommunity=spFlowspecCommunity, spInetAddressType=spInetAddressType, spGreTunnelName=spGreTunnelName, peakflowSPCMI=peakflowSPCMI, spInterfaceUsage=spInterfaceUsage, deviceSystemErrorDone=deviceSystemErrorDone, bgpUp=bgpUp, spInterfaceSpeedHC=spInterfaceSpeedHC, spPravail=spPravail, bgpInstabilityDone=bgpInstabilityDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsageType=spUsageType, collectorStart=collectorStart, cloudSignalingFaultDone=cloudSignalingFaultDone, spServiceElement=spServiceElement, spUnit=spUnit, spcommFailureDone=spcommFailureDone, spTMSPrefix=spTMSPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spImpactPps=spImpactPps, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObject=spManagedObject, spMitigationStart=spMitigationStart, interfaceUsageDone=interfaceUsageDone, collectorUp=collectorUp, spReportID=spReportID, greDownDone=greDownDone, interfaceUsage=interfaceUsage, fingerprintUsage=fingerprintUsage, spRouter=spRouter, deviceHealth=deviceHealth, spDNSName=spDNSName, spInterface=spInterface, spFingerprintSender=spFingerprintSender, mitigationTMSStart=mitigationTMSStart, spcommFailure=spcommFailure, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, snmpDown=snmpDown, spHijackRoute=spHijackRoute, deviceSystemError=deviceSystemError, peakflowSPTraps=peakflowSPTraps, hardwareFailureDone=hardwareFailureDone, spHijackAttr=spHijackAttr, spScriptCommand=spScriptCommand, spBGPTrapEvent=spBGPTrapEvent, spInterfaceIndex=spInterfaceIndex, deviceSwapSpace=deviceSwapSpace, notificationLimit=notificationLimit, spCollector=spCollector, spServiceName=spServiceName, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintMessage=spFingerprintMessage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholePrefix=spBlackholePrefix, reportDone=reportDone, bgpTrap=bgpTrap, licenseErrorDone=licenseErrorDone, spUsername=spUsername, spSystemErrorType=spSystemErrorType, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spThirdPartyZone=spThirdPartyZone, fingerprintReceive=fingerprintReceive, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPEvent=spBGPEvent, spTMSTimeout=spTMSTimeout, routingFailover=routingFailover, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationID=spMitigationID, dosHostDetectionAlert=dosHostDetectionAlert, spUsage=spUsage, serviceUsage=serviceUsage, spDetector=spDetector, greDown=greDown, fingerprintFeedback=fingerprintFeedback, spAlertID=spAlertID, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInetAddress=spInetAddress, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spVersion=spVersion, spBGPInstability=spBGPInstability, managedObjectUsage=managedObjectUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spScriptStart=spScriptStart, spInterfaceSpeed=spInterfaceSpeed, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationFlowspecStart=mitigationFlowspecStart)
