...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:08:15 2024
...
TimeTicks, iso, Gauge32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Bits, MibIdentifier, Integer32, Unsigned32, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Gauge32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Bits", "MibIdentifier", "Integer32", "Unsigned32", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spApplicationName=spApplicationName, spTMSPrefix=spTMSPrefix, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrLimit=spLicenseErrLimit, fingerprintFeedback=fingerprintFeedback, mitigationTMSStartV2=mitigationTMSStartV2, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholePrefix=spBlackholePrefix, flowDown=flowDown, devicePhysicalMemory=devicePhysicalMemory, spCommFailureDescription=spCommFailureDescription, spTMSCommunity=spTMSCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, dnsBaselineDone=dnsBaselineDone, spBlackholeNexthop=spBlackholeNexthop, spInterface=spInterface, spManagedObject=spManagedObject, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUnit=spUnit, spDNSName=spDNSName, spBGPTrapEvent=spBGPTrapEvent, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spFlowspecTimeout=spFlowspecTimeout, spMitigationID=spMitigationID, autoclassifyStart=autoclassifyStart, spImpactBps=spImpactBps, licenseErrorDone=licenseErrorDone, spInterfaceSpeedHC=spInterfaceSpeedHC, notificationLimit=notificationLimit, bgpInstability=bgpInstability, greDownDone=greDownDone, spManagedObjectFamily=spManagedObjectFamily, spDNSExpected=spDNSExpected, spBlackholeCommunity=spBlackholeCommunity, spThreshold=spThreshold, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptPort=spScriptPort, collectorDown=collectorDown, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationTMSStart=mitigationTMSStart, spDNSObserved=spDNSObserved, spDetector=spDetector, deviceSwapSpace=deviceSwapSpace, collectorUp=collectorUp, spScriptHost=spScriptHost, spReportName=spReportName, bgpHijack=bgpHijack, spcommFailure=spcommFailure, fingerprintUsage=fingerprintUsage, spManagedObjects=spManagedObjects, deviceDiskUsage=deviceDiskUsage, spHijackLocal=spHijackLocal, bgpDown=bgpDown, deviceSystemError=deviceSystemError, bgpUp=bgpUp, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholeTimeout=spBlackholeTimeout, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrDescription=spLicenseErrDescription, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceUsage=spInterfaceUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPEvent=spBGPEvent, flowUp=flowUp, routingFailover=routingFailover, serviceUsage=serviceUsage, spDNSObservedMax=spDNSObservedMax, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrType=spLicenseErrType, collectorStart=collectorStart, interfaceUsageDone=interfaceUsageDone, spHijackRoute=spHijackRoute, peakflowSPCMI=peakflowSPCMI, bgpTrap=bgpTrap, licenseError=licenseError, spReportURL=spReportURL, mitigationDone=mitigationDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, managedObjectUsage=managedObjectUsage, spBGPTrapName=spBGPTrapName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSystemErrorType=spSystemErrorType, spSystemErrorDescription=spSystemErrorDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, spCollector=spCollector, spScriptCommand=spScriptCommand, reportDone=reportDone, hardwareFailure=hardwareFailure, spHijackAttr=spHijackAttr, spMitigationName=spMitigationName, spTMSTimeout=spTMSTimeout, peakflowSPTraps=peakflowSPTraps, spThirdPartyZone=spThirdPartyZone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spFlowspecCommunity=spFlowspecCommunity, spDetectedCountries=spDetectedCountries, spUsername=spUsername, cloudSignalingFault=cloudSignalingFault, fingerprintReceive=fingerprintReceive, hardwareFailureDone=hardwareFailureDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, interfaceUsage=interfaceUsage, spImpactPps=spImpactPps, spInterfaceIndex=spInterfaceIndex, peakflowSPMIB=peakflowSPMIB, managedObjectUsageDone=managedObjectUsageDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spPravail=spPravail, spcommFailureDone=spcommFailureDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsageType=spUsageType, spGreTunnelDestination=spGreTunnelDestination, mitigationThirdPartyStart=mitigationThirdPartyStart, spRouter=spRouter, spScriptStart=spScriptStart, deviceTotalFlows=deviceTotalFlows, spMitigationStart=spMitigationStart, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPMgr=peakflowSPMgr, spVersion=spVersion, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInetAddress=spInetAddress, spGreTunnelName=spGreTunnelName, spCommFailureDestination=spCommFailureDestination, alertScript=alertScript, spFingerprintName=spFingerprintName, spFingerprintMessage=spFingerprintMessage, spLicenseErrCount=spLicenseErrCount, mitigationFlowspecStart=mitigationFlowspecStart, trafficAutoMitigation=trafficAutoMitigation, deviceHealth=deviceHealth, spAlertID=spAlertID, spServiceName=spServiceName, spDuration=spDuration, greDown=greDown, serviceUsageDone=serviceUsageDone, deviceSystemErrorDone=deviceSystemErrorDone, spBGPInstability=spBGPInstability, spUsage=spUsage, snmpDown=snmpDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInetAddressType=spInetAddressType, spReportID=spReportID, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, configChange=configChange, spServiceElement=spServiceElement, PYSNMP_MODULE_ID=peakflowSPMIB, bgpInstabilityDone=bgpInstabilityDone, mitigationBlackholeStart=mitigationBlackholeStart, fingerprintUsageDone=fingerprintUsageDone, spFingerprintSender=spFingerprintSender, spAlertDetectionSignatures=spAlertDetectionSignatures, spHardwareFailureDescription=spHardwareFailureDescription, spDNSObservedMean=spDNSObservedMean, dnsBaseline=dnsBaseline, cloudSignalingFaultDone=cloudSignalingFaultDone, snmpUp=snmpUp)
