...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:08:36 2023
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, NotificationType, MibIdentifier, Unsigned32, IpAddress, Counter64, ModuleIdentity, iso, Integer32, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "iso", "Integer32", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", routingFailover=routingFailover, spFingerprintMessage=spFingerprintMessage, spServiceElement=spServiceElement, licenseError=licenseError, spLicenseErrDescription=spLicenseErrDescription, spAlertID=spAlertID, bgpHijack=bgpHijack, spSystemErrorType=spSystemErrorType, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spHijackAttr=spHijackAttr, spMitigationID=spMitigationID, spHardwareFailureDescription=spHardwareFailureDescription, spTMSPrefix=spTMSPrefix, spLicenseErrLimit=spLicenseErrLimit, spFingerprintSender=spFingerprintSender, fingerprintFeedback=fingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, peakflowSPCMI=peakflowSPCMI, spBGPTrapName=spBGPTrapName, flowUp=flowUp, spImpactPps=spImpactPps, peakflowSPMgr=peakflowSPMgr, spTMSTimeout=spTMSTimeout, spServiceName=spServiceName, spThirdPartyZone=spThirdPartyZone, collectorUp=collectorUp, spDetectedCountries=spDetectedCountries, bgpInstability=bgpInstability, interfaceUsage=interfaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spScriptCommand=spScriptCommand, spLicenseErrType=spLicenseErrType, deviceHealth=deviceHealth, dnsBaseline=dnsBaseline, bgpTrap=bgpTrap, spcommFailure=spcommFailure, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationTMSStartV2=mitigationTMSStartV2, spVersion=spVersion, mitigationFlowspecStart=mitigationFlowspecStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, greDownDone=greDownDone, spReportName=spReportName, spInterfaceUsage=spInterfaceUsage, spManagedObjects=spManagedObjects, spInterface=spInterface, spDNSObservedMean=spDNSObservedMean, collectorDown=collectorDown, cloudSignalingFault=cloudSignalingFault, spThirdPartyAddr=spThirdPartyAddr, spUsername=spUsername, mitigationDone=mitigationDone, deviceTotalFlows=deviceTotalFlows, spTMSCommunity=spTMSCommunity, peakflowSPTraps=peakflowSPTraps, spScriptPort=spScriptPort, spPravail=spPravail, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapPrefix=spBGPTrapPrefix, spBGPEvent=spBGPEvent, collectorStart=collectorStart, spThreshold=spThreshold, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceIndex=spInterfaceIndex, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCloudSignalFaultDescription=spCloudSignalFaultDescription, licenseErrorDone=licenseErrorDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, serviceUsageDone=serviceUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spInetAddressType=spInetAddressType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackLocal=spHijackLocal, spScriptStart=spScriptStart, spSystemErrorDescription=spSystemErrorDescription, spFingerprintName=spFingerprintName, spCommFailureDestination=spCommFailureDestination, spLicenseErrCount=spLicenseErrCount, spDNSObserved=spDNSObserved, spGreTunnelDestination=spGreTunnelDestination, autoclassifyStart=autoclassifyStart, snmpDown=snmpDown, cloudSignalingFaultDone=cloudSignalingFaultDone, spDuration=spDuration, spInterfaceUsageHC=spInterfaceUsageHC, spUsage=spUsage, hardwareFailure=hardwareFailure, trafficAutoMitigation=trafficAutoMitigation, greDown=greDown, spImpactBps=spImpactBps, deviceSystemErrorDone=deviceSystemErrorDone, bgpInstabilityDone=bgpInstabilityDone, spManagedObjectFamily=spManagedObjectFamily, managedObjectUsageDone=managedObjectUsageDone, spGreTunnelName=spGreTunnelName, spDetector=spDetector, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSystemError=deviceSystemError, alertScript=alertScript, spBlackholeTimeout=spBlackholeTimeout, spRouter=spRouter, spBlackholeNexthop=spBlackholeNexthop, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, spCollector=spCollector, spManagedObject=spManagedObject, spDNSObservedMax=spDNSObservedMax, fingerprintUsage=fingerprintUsage, bgpDown=bgpDown, spHijackRoute=spHijackRoute, snmpUp=snmpUp, dosHostDetectionAlert=dosHostDetectionAlert, spReportURL=spReportURL, spDNSExpected=spDNSExpected, spMitigationStart=spMitigationStart, spBlackholeCommunity=spBlackholeCommunity, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpUp=bgpUp, spReportID=spReportID, deviceDiskUsage=deviceDiskUsage, notificationLimit=notificationLimit, mitigationTMSStart=mitigationTMSStart, peakflowSPMIB=peakflowSPMIB, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, devicePhysicalMemory=devicePhysicalMemory, spInetAddress=spInetAddress, spMitigationName=spMitigationName, spTMSMultiPrefix=spTMSMultiPrefix, spcommFailureDone=spcommFailureDone, flowDown=flowDown, interfaceUsageDone=interfaceUsageDone, spBGPTrapEvent=spBGPTrapEvent, spUsageType=spUsageType, serviceUsage=serviceUsage, reportDone=reportDone, spBGPInstability=spBGPInstability, configChange=configChange, spFingerprintFeedback=spFingerprintFeedback, spCommFailureDescription=spCommFailureDescription, spBlackholePrefix=spBlackholePrefix, spInterfaceSpeed=spInterfaceSpeed, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, managedObjectUsage=managedObjectUsage, spFlowspecTimeout=spFlowspecTimeout, spUnit=spUnit, spApplicationName=spApplicationName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationThirdPartyStart=mitigationThirdPartyStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSwapSpace=deviceSwapSpace, dnsBaselineDone=dnsBaselineDone, hardwareFailureDone=hardwareFailureDone, spScriptHost=spScriptHost, spDNSName=spDNSName)
