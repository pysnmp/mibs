...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:12:56 2022
...
ObjectIdentity, NotificationType, Counter64, Gauge32, iso, Bits, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Counter64", "Gauge32", "iso", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackLocal=spHijackLocal, greDown=greDown, spMitigationStart=spMitigationStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, fingerprintUsage=fingerprintUsage, snmpDown=snmpDown, spReportName=spReportName, spFingerprintFeedback=spFingerprintFeedback, mitigationBlackholeStart=mitigationBlackholeStart, interfaceUsage=interfaceUsage, autoclassifyStart=autoclassifyStart, collectorDown=collectorDown, interfaceUsageDone=interfaceUsageDone, mitigationDone=mitigationDone, spRouter=spRouter, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceUsage=spInterfaceUsage, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptStart=spScriptStart, spDetector=spDetector, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpInstability=bgpInstability, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, trafficAutoMitigation=trafficAutoMitigation, cloudSignalingFaultDone=cloudSignalingFaultDone, spDNSObservedMax=spDNSObservedMax, spLicenseErrLimit=spLicenseErrLimit, spInterfaceSpeed=spInterfaceSpeed, bgpUp=bgpUp, spUsage=spUsage, collectorStart=collectorStart, bgpTrap=bgpTrap, spReportURL=spReportURL, peakflowSPTraps=peakflowSPTraps, spDNSExpected=spDNSExpected, spDNSName=spDNSName, notificationLimit=notificationLimit, spAlertID=spAlertID, spUsername=spUsername, fingerprintFeedback=fingerprintFeedback, greDownDone=greDownDone, spThirdPartyZone=spThirdPartyZone, spFingerprintName=spFingerprintName, spServiceElement=spServiceElement, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInetAddress=spInetAddress, collectorUp=collectorUp, spUsageType=spUsageType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, fingerprintUsageDone=fingerprintUsageDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceHealth=deviceHealth, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spHardwareFailureDescription=spHardwareFailureDescription, serviceUsage=serviceUsage, spTMSPrefix=spTMSPrefix, spGreTunnelDestination=spGreTunnelDestination, configChange=configChange, spImpactBps=spImpactBps, spFlowspecTimeout=spFlowspecTimeout, spDNSObserved=spDNSObserved, spScriptCommand=spScriptCommand, mitigationTMSStart=mitigationTMSStart, spThirdPartyAddr=spThirdPartyAddr, spHijackAttr=spHijackAttr, bgpInstabilityDone=bgpInstabilityDone, alertScript=alertScript, spFingerprintSender=spFingerprintSender, spFingerprintMessage=spFingerprintMessage, spScriptPort=spScriptPort, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBGPInstability=spBGPInstability, peakflowSPCMI=peakflowSPCMI, spHijackRoute=spHijackRoute, deviceTotalFlows=deviceTotalFlows, bgpHijack=bgpHijack, spSystemErrorType=spSystemErrorType, spLicenseErrDescription=spLicenseErrDescription, spBGPTrapName=spBGPTrapName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailover=routingFailover, spCommFailureDescription=spCommFailureDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSystemError=deviceSystemError, spInterfaceIndex=spInterfaceIndex, licenseErrorDone=licenseErrorDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObjectFamily=spManagedObjectFamily, fingerprintReceive=fingerprintReceive, deviceSwapSpace=deviceSwapSpace, spTMSCommunity=spTMSCommunity, deviceTotalFlowsHC=deviceTotalFlowsHC, spSystemErrorDescription=spSystemErrorDescription, spInetAddressType=spInetAddressType, bgpDown=bgpDown, spBGPEvent=spBGPEvent, spInterface=spInterface, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spDNSObservedMean=spDNSObservedMean, spGreTunnelName=spGreTunnelName, spBlackholeNexthop=spBlackholeNexthop, spInterfaceSpeedHC=spInterfaceSpeedHC, cloudSignalingFault=cloudSignalingFault, deviceDiskUsage=deviceDiskUsage, spLicenseErrType=spLicenseErrType, spBlackholePrefix=spBlackholePrefix, flowUp=flowUp, managedObjectUsage=managedObjectUsage, spMitigationID=spMitigationID, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjects=spManagedObjects, spDuration=spDuration, peakflowSPMgr=peakflowSPMgr, spScriptHost=spScriptHost, spTMSTimeout=spTMSTimeout, spMitigationName=spMitigationName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spManagedObject=spManagedObject, managedObjectUsageDone=managedObjectUsageDone, spBlackholeCommunity=spBlackholeCommunity, spServiceName=spServiceName, hardwareFailure=hardwareFailure, spReportID=spReportID, spUnit=spUnit, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spcommFailure=spcommFailure, reportDone=reportDone, mitigationFlowspecStart=mitigationFlowspecStart, flowDown=flowDown, spCollector=spCollector, spLicenseErrCount=spLicenseErrCount, spVersion=spVersion, dnsBaselineDone=dnsBaselineDone, spApplicationName=spApplicationName, peakflowSPMIB=peakflowSPMIB, spBGPTrapEvent=spBGPTrapEvent, licenseError=licenseError, snmpUp=snmpUp, devicePhysicalMemory=devicePhysicalMemory, spcommFailureDone=spcommFailureDone, spThreshold=spThreshold, spBlackholeTimeout=spBlackholeTimeout, hardwareFailureDone=hardwareFailureDone, dnsBaseline=dnsBaseline, spImpactPps=spImpactPps, spFlowspecCommunity=spFlowspecCommunity, spTMSMultiPrefix=spTMSMultiPrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPTrapPrefix=spBGPTrapPrefix, spPravail=spPravail, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSystemErrorDone=deviceSystemErrorDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min)
