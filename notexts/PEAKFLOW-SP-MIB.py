...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:49:36 2021
...
iso, IpAddress, Counter32, Bits, Unsigned32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, TimeTicks, ObjectIdentity, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "Bits", "Unsigned32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", licenseErrorDone=licenseErrorDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spThreshold=spThreshold, serviceUsage=serviceUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spTMSMultiPrefix=spTMSMultiPrefix, autoclassifyStart=autoclassifyStart, spHijackAttr=spHijackAttr, spInterfaceSpeedHC=spInterfaceSpeedHC, spDetectedCountries=spDetectedCountries, notificationLimit=notificationLimit, deviceSystemError=deviceSystemError, snmpDown=snmpDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, managedObjectUsageDone=managedObjectUsageDone, spHijackLocal=spHijackLocal, spBGPTrapName=spBGPTrapName, snmpUp=snmpUp, spBGPInstability=spBGPInstability, spLicenseErrLimit=spLicenseErrLimit, spManagedObjectFamily=spManagedObjectFamily, spMitigationID=spMitigationID, spBGPTrapEvent=spBGPTrapEvent, mitigationBlackholeStart=mitigationBlackholeStart, spLicenseErrType=spLicenseErrType, deviceTotalFlows=deviceTotalFlows, spFingerprintSender=spFingerprintSender, spBlackholeNexthop=spBlackholeNexthop, bgpDown=bgpDown, spcommFailure=spcommFailure, trafficAutoMitigation=trafficAutoMitigation, spMitigationStart=spMitigationStart, spServiceElement=spServiceElement, fingerprintUsage=fingerprintUsage, spPravail=spPravail, spCommFailureDestination=spCommFailureDestination, spBlackholeCommunity=spBlackholeCommunity, hardwareFailure=hardwareFailure, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptCommand=spScriptCommand, spMitigationName=spMitigationName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObject=spManagedObject, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFlowspecTimeout=spFlowspecTimeout, spInterfaceUsage=spInterfaceUsage, hardwareFailureDone=hardwareFailureDone, greDownDone=greDownDone, spHijackRoute=spHijackRoute, deviceTotalFlowsHC=deviceTotalFlowsHC, spHardwareFailureDescription=spHardwareFailureDescription, mitigationFlowspecStart=mitigationFlowspecStart, spAlertID=spAlertID, spUsage=spUsage, spDNSName=spDNSName, spImpactBps=spImpactBps, spLicenseErrCount=spLicenseErrCount, deviceSwapSpace=deviceSwapSpace, spTMSTimeout=spTMSTimeout, spThirdPartyAddr=spThirdPartyAddr, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spLicenseErrDescription=spLicenseErrDescription, peakflowSPMgr=peakflowSPMgr, spScriptHost=spScriptHost, spFingerprintName=spFingerprintName, collectorStart=collectorStart, spCollector=spCollector, spDuration=spDuration, spInterface=spInterface, spUnit=spUnit, peakflowSPMIB=peakflowSPMIB, spBlackholePrefix=spBlackholePrefix, alertScript=alertScript, spDNSObservedMean=spDNSObservedMean, spThirdPartyZone=spThirdPartyZone, spInterfaceSpeed=spInterfaceSpeed, spImpactPps=spImpactPps, collectorDown=collectorDown, spUsername=spUsername, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, interfaceUsage=interfaceUsage, routingFailover=routingFailover, reportDone=reportDone, spScriptPort=spScriptPort, dnsBaseline=dnsBaseline, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFault=cloudSignalingFault, spDetector=spDetector, interfaceUsageDone=interfaceUsageDone, spBlackholeTimeout=spBlackholeTimeout, spcommFailureDone=spcommFailureDone, spInterfaceUsageHC=spInterfaceUsageHC, spBGPEvent=spBGPEvent, managedObjectUsage=managedObjectUsage, fingerprintUsageDone=fingerprintUsageDone, spServiceName=spServiceName, spDNSExpected=spDNSExpected, spDNSObserved=spDNSObserved, bgpHijack=bgpHijack, deviceSystemErrorDone=deviceSystemErrorDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, devicePhysicalMemory=devicePhysicalMemory, spTMSCommunity=spTMSCommunity, spUsageType=spUsageType, peakflowSPTraps=peakflowSPTraps, spFingerprintMessage=spFingerprintMessage, spInetAddress=spInetAddress, flowDown=flowDown, spManagedObjects=spManagedObjects, spTMSPrefix=spTMSPrefix, spCommFailureDescription=spCommFailureDescription, dnsBaselineDone=dnsBaselineDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, dosHostDetectionAlert=dosHostDetectionAlert, mitigationDone=mitigationDone, spDNSObservedMax=spDNSObservedMax, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintReceive=fingerprintReceive, spGreTunnelName=spGreTunnelName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spRouter=spRouter, flowUp=flowUp, bgpInstabilityDone=bgpInstabilityDone, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceDiskUsage=deviceDiskUsage, spVersion=spVersion, spReportID=spReportID, spCloudSignalFaultDescription=spCloudSignalFaultDescription, licenseError=licenseError, spInterfaceIndex=spInterfaceIndex, spInetAddressType=spInetAddressType, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, configChange=configChange, deviceHealth=deviceHealth, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintFeedback=spFingerprintFeedback, collectorUp=collectorUp, spBGPTrapPrefix=spBGPTrapPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spSystemErrorType=spSystemErrorType, PYSNMP_MODULE_ID=peakflowSPMIB, fingerprintFeedback=fingerprintFeedback, bgpUp=bgpUp, peakflowSPCMI=peakflowSPCMI, spApplicationName=spApplicationName, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spReportName=spReportName, bgpTrap=bgpTrap, spGreTunnelDestination=spGreTunnelDestination, spReportURL=spReportURL, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, serviceUsageDone=serviceUsageDone, greDown=greDown, spScriptStart=spScriptStart, bgpInstability=bgpInstability, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationTMSStart=mitigationTMSStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min)
