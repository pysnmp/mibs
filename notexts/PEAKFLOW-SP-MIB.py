...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:39:18 2024
...
TimeTicks, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Counter64, ModuleIdentity, Integer32, MibIdentifier, ObjectIdentity, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Counter64", "ModuleIdentity", "Integer32", "MibIdentifier", "ObjectIdentity", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spApplicationName=spApplicationName, spLicenseErrLimit=spLicenseErrLimit, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDetector=spDetector, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUsage=spUsage, interfaceUsage=interfaceUsage, fingerprintReceive=fingerprintReceive, spBGPInstability=spBGPInstability, bgpUp=bgpUp, spFingerprintFeedback=spFingerprintFeedback, spInterfaceSpeedHC=spInterfaceSpeedHC, dnsBaselineDone=dnsBaselineDone, spBlackholeTimeout=spBlackholeTimeout, spHardwareFailureDescription=spHardwareFailureDescription, collectorDown=collectorDown, configChange=configChange, deviceSwapSpaceInUse=deviceSwapSpaceInUse, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCommFailureDescription=spCommFailureDescription, mitigationTMSStart=mitigationTMSStart, spScriptStart=spScriptStart, spThreshold=spThreshold, peakflowSPMgr=peakflowSPMgr, spReportName=spReportName, mitigationBlackholeStart=mitigationBlackholeStart, spTMSMultiPrefix=spTMSMultiPrefix, flowUp=flowUp, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spManagedObjectFamily=spManagedObjectFamily, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapName=spBGPTrapName, deviceHealth=deviceHealth, fingerprintFeedback=fingerprintFeedback, spFingerprintSender=spFingerprintSender, spFlowspecTimeout=spFlowspecTimeout, spGreTunnelDestination=spGreTunnelDestination, spCollector=spCollector, spManagedObjects=spManagedObjects, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, serviceUsage=serviceUsage, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapEvent=spBGPTrapEvent, spUsername=spUsername, spImpactPps=spImpactPps, spCommFailureDestination=spCommFailureDestination, spcommFailure=spcommFailure, cloudSignalingFault=cloudSignalingFault, PYSNMP_MODULE_ID=peakflowSPMIB, spImpactBps=spImpactBps, spThirdPartyZone=spThirdPartyZone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, collectorStart=collectorStart, greDown=greDown, bgpInstabilityDone=bgpInstabilityDone, spBlackholePrefix=spBlackholePrefix, deviceSystemErrorDone=deviceSystemErrorDone, spRouter=spRouter, spInterfaceIndex=spInterfaceIndex, bgpTrap=bgpTrap, spBGPTrapPrefix=spBGPTrapPrefix, spUsageType=spUsageType, spServiceName=spServiceName, spDNSObservedMax=spDNSObservedMax, routingFailover=routingFailover, peakflowSPMIB=peakflowSPMIB, spInterfaceUsage=spInterfaceUsage, deviceSystemError=deviceSystemError, spHijackRoute=spHijackRoute, spInterface=spInterface, spTMSPrefix=spTMSPrefix, managedObjectUsageDone=managedObjectUsageDone, spReportURL=spReportURL, spThirdPartyAddr=spThirdPartyAddr, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spVersion=spVersion, bgpDown=bgpDown, spDetectedCountries=spDetectedCountries, dnsBaseline=dnsBaseline, reportDone=reportDone, spMitigationID=spMitigationID, snmpUp=snmpUp, spReportID=spReportID, spUnit=spUnit, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholeNexthop=spBlackholeNexthop, spHijackLocal=spHijackLocal, mitigationFlowspecStart=mitigationFlowspecStart, serviceUsageDone=serviceUsageDone, spPravail=spPravail, spDuration=spDuration, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSName=spDNSName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintName=spFingerprintName, spMitigationStart=spMitigationStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, greDownDone=greDownDone, collectorUp=collectorUp, bgpHijack=bgpHijack, spInetAddressType=spInetAddressType, spInterfaceUsageHC=spInterfaceUsageHC, spAlertDetectionSignatures=spAlertDetectionSignatures, mitigationDone=mitigationDone, licenseError=licenseError, hardwareFailure=hardwareFailure, deviceDiskUsage=deviceDiskUsage, spInetAddress=spInetAddress, spScriptCommand=spScriptCommand, spFingerprintMessage=spFingerprintMessage, spManagedObject=spManagedObject, deviceSwapSpace=deviceSwapSpace, hardwareFailureDone=hardwareFailureDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, managedObjectUsage=managedObjectUsage, notificationLimit=notificationLimit, spFlowspecCommunity=spFlowspecCommunity, spLicenseErrCount=spLicenseErrCount, deviceTotalFlows=deviceTotalFlows, licenseErrorDone=licenseErrorDone, spBlackholeCommunity=spBlackholeCommunity, spSystemErrorType=spSystemErrorType, spDNSExpected=spDNSExpected, spDNSObserved=spDNSObserved, flowDown=flowDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDNSObservedMean=spDNSObservedMean, snmpDown=snmpDown, peakflowSPTraps=peakflowSPTraps, alertScript=alertScript, spScriptHost=spScriptHost, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrType=spLicenseErrType, spBGPEvent=spBGPEvent, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPCMI=peakflowSPCMI, cloudSignalingFaultDone=cloudSignalingFaultDone, spTMSTimeout=spTMSTimeout, spGreTunnelName=spGreTunnelName, spScriptPort=spScriptPort, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spcommFailureDone=spcommFailureDone, spTMSCommunity=spTMSCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintUsage=fingerprintUsage, spServiceElement=spServiceElement, spAlertID=spAlertID, spMitigationName=spMitigationName, bgpInstability=bgpInstability, spHijackAttr=spHijackAttr, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, mitigationTMSStartV2=mitigationTMSStartV2)
