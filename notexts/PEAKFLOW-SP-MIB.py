...
NotificationType, Bits, ObjectIdentity, Counter64, MibIdentifier, Gauge32, TimeTicks, Integer32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "ObjectIdentity", "Counter64", "MibIdentifier", "Gauge32", "TimeTicks", "Integer32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, hardwareFailureDone=hardwareFailureDone, spDNSExpected=spDNSExpected, spDNSObserved=spDNSObserved, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemory=devicePhysicalMemory, spTMSTimeout=spTMSTimeout, spDNSObservedMean=spDNSObservedMean, spBlackholeTimeout=spBlackholeTimeout, spImpactPps=spImpactPps, spUnit=spUnit, spDetectedCountries=spDetectedCountries, deviceHealth=deviceHealth, flowDown=flowDown, licenseError=licenseError, spCommFailureDescription=spCommFailureDescription, spTMSMultiPrefix=spTMSMultiPrefix, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapName=spBGPTrapName, fingerprintUsage=fingerprintUsage, interfaceUsageDone=interfaceUsageDone, deviceDiskUsage=deviceDiskUsage, autoclassifyStart=autoclassifyStart, dnsBaseline=dnsBaseline, routingFailover=routingFailover, spHijackAttr=spHijackAttr, peakflowSPCMI=peakflowSPCMI, spBlackholeCommunity=spBlackholeCommunity, spInterfaceUsageHC=spInterfaceUsageHC, spManagedObjects=spManagedObjects, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spScriptHost=spScriptHost, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPMgr=peakflowSPMgr, spDNSName=spDNSName, mitigationDone=mitigationDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spReportName=spReportName, spServiceName=spServiceName, spInetAddress=spInetAddress, spBGPEvent=spBGPEvent, serviceUsageDone=serviceUsageDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spVersion=spVersion, spInterfaceSpeedHC=spInterfaceSpeedHC, spTMSCommunity=spTMSCommunity, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPTrapEvent=spBGPTrapEvent, reportDone=reportDone, spHijackLocal=spHijackLocal, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spApplicationName=spApplicationName, spFingerprintSender=spFingerprintSender, spScriptPort=spScriptPort, deviceSwapSpace=deviceSwapSpace, deviceTotalFlows=deviceTotalFlows, spScriptStart=spScriptStart, snmpDown=snmpDown, spInterfaceSpeed=spInterfaceSpeed, spBGPInstability=spBGPInstability, configChange=configChange, deviceSystemError=deviceSystemError, notificationLimit=notificationLimit, deviceTotalFlowsHC=deviceTotalFlowsHC, spLicenseErrDescription=spLicenseErrDescription, spCollector=spCollector, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackRoute=spHijackRoute, spLicenseErrCount=spLicenseErrCount, spAlertID=spAlertID, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceUsage=spInterfaceUsage, spThirdPartyAddr=spThirdPartyAddr, licenseErrorDone=licenseErrorDone, spHardwareFailureDescription=spHardwareFailureDescription, bgpInstability=bgpInstability, spManagedObject=spManagedObject, bgpHijack=bgpHijack, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, managedObjectUsageDone=managedObjectUsageDone, peakflowSPMIB=peakflowSPMIB, dnsBaselineDone=dnsBaselineDone, spCommFailureDestination=spCommFailureDestination, snmpUp=snmpUp, spMitigationID=spMitigationID, managedObjectUsage=managedObjectUsage, greDownDone=greDownDone, spMitigationStart=spMitigationStart, spGreTunnelName=spGreTunnelName, bgpTrap=bgpTrap, spBlackholeNexthop=spBlackholeNexthop, bgpUp=bgpUp, spcommFailureDone=spcommFailureDone, collectorUp=collectorUp, bgpDown=bgpDown, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationTMSStart=mitigationTMSStart, trafficAutoMitigation=trafficAutoMitigation, spSystemErrorType=spSystemErrorType, alertScript=alertScript, deviceSwapSpaceUsage=deviceSwapSpaceUsage, fingerprintFeedback=fingerprintFeedback, spDetector=spDetector, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsageDone=fingerprintUsageDone, spFingerprintName=spFingerprintName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, collectorStart=collectorStart, spBGPTrapPrefix=spBGPTrapPrefix, hardwareFailure=hardwareFailure, interfaceUsage=interfaceUsage, fingerprintReceive=fingerprintReceive, spUsageType=spUsageType, spSystemErrorDescription=spSystemErrorDescription, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceSystemErrorDone=deviceSystemErrorDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFault=cloudSignalingFault, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDuration=spDuration, spScriptCommand=spScriptCommand, mitigationFlowspecStart=mitigationFlowspecStart, mitigationTMSStartV2=mitigationTMSStartV2, spGreTunnelDestination=spGreTunnelDestination, spBlackholePrefix=spBlackholePrefix, spInterface=spInterface, flowUp=flowUp, peakflowSPTraps=peakflowSPTraps, spMitigationName=spMitigationName, spTMSPrefix=spTMSPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailure=spcommFailure, spServiceElement=spServiceElement, spPravail=spPravail, spThirdPartyZone=spThirdPartyZone, spManagedObjectFamily=spManagedObjectFamily, serviceUsage=serviceUsage, bgpInstabilityDone=bgpInstabilityDone, spImpactBps=spImpactBps, spLicenseErrType=spLicenseErrType, collectorDown=collectorDown, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spUsage=spUsage, spUsername=spUsername, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spReportURL=spReportURL, spReportID=spReportID, mitigationBlackholeStart=mitigationBlackholeStart, greDown=greDown, spInterfaceIndex=spInterfaceIndex, spDNSObservedMax=spDNSObservedMax, spLicenseErrLimit=spLicenseErrLimit, spRouter=spRouter, spFlowspecTimeout=spFlowspecTimeout, spInetAddressType=spInetAddressType, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintMessage=spFingerprintMessage, spThreshold=spThreshold)
