...
# Produced by pysmi-1.1.8 at Mon Jan 17 21:59:56 2022
...
Counter32, ModuleIdentity, iso, Bits, Integer32, Gauge32, IpAddress, ObjectIdentity, NotificationType, MibIdentifier, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "Bits", "Integer32", "Gauge32", "IpAddress", "ObjectIdentity", "NotificationType", "MibIdentifier", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", notificationLimit=notificationLimit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spApplicationName=spApplicationName, spBGPTrapName=spBGPTrapName, interfaceUsage=interfaceUsage, spFingerprintFeedback=spFingerprintFeedback, collectorStart=collectorStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceDiskUsage=deviceDiskUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, peakflowSPTraps=peakflowSPTraps, spFingerprintMessage=spFingerprintMessage, spInetAddress=spInetAddress, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInterfaceSpeed=spInterfaceSpeed, flowUp=flowUp, collectorDown=collectorDown, reportDone=reportDone, spInterface=spInterface, spReportID=spReportID, snmpDown=snmpDown, spThirdPartyZone=spThirdPartyZone, spUsage=spUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintSender=spFingerprintSender, spReportName=spReportName, dnsBaseline=dnsBaseline, licenseErrorDone=licenseErrorDone, spManagedObjects=spManagedObjects, spFlowspecTimeout=spFlowspecTimeout, spServiceElement=spServiceElement, flowDown=flowDown, spServiceName=spServiceName, dosHostDetectionAlert=dosHostDetectionAlert, spThreshold=spThreshold, bgpUp=bgpUp, spAlertID=spAlertID, alertScript=alertScript, dosHostDetectionAlertDone=dosHostDetectionAlertDone, routingFailover=routingFailover, deviceSystemError=deviceSystemError, hardwareFailure=hardwareFailure, spUsageType=spUsageType, mitigationDone=mitigationDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDetector=spDetector, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spPravail=spPravail, deviceSwapSpace=deviceSwapSpace, configChange=configChange, bgpInstabilityDone=bgpInstabilityDone, spLicenseErrDescription=spLicenseErrDescription, spCommFailureDestination=spCommFailureDestination, spThirdPartyAddr=spThirdPartyAddr, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationFlowspecStart=mitigationFlowspecStart, spBGPTrapPrefix=spBGPTrapPrefix, spImpactPps=spImpactPps, bgpTrap=bgpTrap, managedObjectUsage=managedObjectUsage, mitigationBlackholeStart=mitigationBlackholeStart, snmpUp=snmpUp, spVersion=spVersion, spBGPEvent=spBGPEvent, spInterfaceIndex=spInterfaceIndex, spBGPInstability=spBGPInstability, mitigationThirdPartyStart=mitigationThirdPartyStart, spCommFailureDescription=spCommFailureDescription, spcommFailureDone=spcommFailureDone, greDownDone=greDownDone, spBlackholePrefix=spBlackholePrefix, deviceSystemErrorDone=deviceSystemErrorDone, fingerprintFeedback=fingerprintFeedback, bgpDown=bgpDown, fingerprintReceive=fingerprintReceive, fingerprintUsageDone=fingerprintUsageDone, spTMSPrefix=spTMSPrefix, spHijackLocal=spHijackLocal, bgpHijack=bgpHijack, spLicenseErrType=spLicenseErrType, peakflowSPMgr=peakflowSPMgr, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceTotalFlowsHC=deviceTotalFlowsHC, dnsBaselineDone=dnsBaselineDone, managedObjectUsageDone=managedObjectUsageDone, spHardwareFailureDescription=spHardwareFailureDescription, spDuration=spDuration, spDNSObservedMean=spDNSObservedMean, spInterfaceUsage=spInterfaceUsage, spUnit=spUnit, fingerprintUsage=fingerprintUsage, spScriptPort=spScriptPort, spManagedObjectFamily=spManagedObjectFamily, deviceTotalFlows=deviceTotalFlows, spCollector=spCollector, spTMSCommunity=spTMSCommunity, spGreTunnelName=spGreTunnelName, spRouter=spRouter, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, PYSNMP_MODULE_ID=peakflowSPMIB, spUsername=spUsername, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spHijackAttr=spHijackAttr, spGreTunnelDestination=spGreTunnelDestination, spDNSName=spDNSName, greDown=greDown, spDNSObserved=spDNSObserved, spFingerprintName=spFingerprintName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSTimeout=spTMSTimeout, interfaceUsageDone=interfaceUsageDone, bgpInstability=bgpInstability, spMitigationStart=spMitigationStart, spBlackholeNexthop=spBlackholeNexthop, licenseError=licenseError, spDetectedCountries=spDetectedCountries, spHijackRoute=spHijackRoute, spScriptHost=spScriptHost, serviceUsageDone=serviceUsageDone, mitigationTMSStartV2=mitigationTMSStartV2, spBlackholeTimeout=spBlackholeTimeout, spTMSMultiPrefix=spTMSMultiPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, collectorUp=collectorUp, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spReportURL=spReportURL, spSystemErrorType=spSystemErrorType, spScriptCommand=spScriptCommand, cloudSignalingFault=cloudSignalingFault, spMitigationName=spMitigationName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceUsageHC=spInterfaceUsageHC, spFlowspecCommunity=spFlowspecCommunity, spLicenseErrCount=spLicenseErrCount, peakflowSPMIB=peakflowSPMIB, spDNSExpected=spDNSExpected, spcommFailure=spcommFailure, spMitigationID=spMitigationID, spInetAddressType=spInetAddressType, spImpactBps=spImpactBps, autoclassifyStart=autoclassifyStart, spSystemErrorDescription=spSystemErrorDescription, serviceUsage=serviceUsage, devicePhysicalMemory=devicePhysicalMemory, deviceHealth=deviceHealth, hardwareFailureDone=hardwareFailureDone, spBlackholeCommunity=spBlackholeCommunity, spDNSObservedMax=spDNSObservedMax, trafficAutoMitigation=trafficAutoMitigation, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPCMI=peakflowSPCMI, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spScriptStart=spScriptStart, mitigationTMSStart=mitigationTMSStart, spManagedObject=spManagedObject, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrLimit=spLicenseErrLimit)
