...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:12:21 2023
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceSpeed=spInterfaceSpeed, bgpInstabilityDone=bgpInstabilityDone, spInterfaceUsageHC=spInterfaceUsageHC, spAlertDetectionSignatures=spAlertDetectionSignatures, spReportName=spReportName, spFingerprintName=spFingerprintName, mitigationDone=mitigationDone, spBGPTrapName=spBGPTrapName, spCollector=spCollector, bgpTrap=bgpTrap, spVersion=spVersion, spInetAddress=spInetAddress, spBlackholeTimeout=spBlackholeTimeout, spInetAddressType=spInetAddressType, spBGPTrapEvent=spBGPTrapEvent, spUnit=spUnit, deviceDiskUsage=deviceDiskUsage, spTMSCommunity=spTMSCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceHealth=deviceHealth, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spHijackRoute=spHijackRoute, deviceTotalFlowsHC=deviceTotalFlowsHC, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrLimit=spLicenseErrLimit, spGreTunnelDestination=spGreTunnelDestination, spDuration=spDuration, collectorDown=collectorDown, spSystemErrorDescription=spSystemErrorDescription, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowUp=flowUp, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spThreshold=spThreshold, dnsBaseline=dnsBaseline, spLicenseErrType=spLicenseErrType, greDownDone=greDownDone, spBlackholeCommunity=spBlackholeCommunity, mitigationFlowspecStart=mitigationFlowspecStart, reportDone=reportDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spcommFailure=spcommFailure, spDNSObservedMax=spDNSObservedMax, spBGPTrapPrefix=spBGPTrapPrefix, spSystemErrorType=spSystemErrorType, spServiceElement=spServiceElement, peakflowSPMIB=peakflowSPMIB, peakflowSPMgr=peakflowSPMgr, interfaceUsageDone=interfaceUsageDone, fingerprintUsage=fingerprintUsage, alertScript=alertScript, hardwareFailureDone=hardwareFailureDone, spReportID=spReportID, snmpDown=snmpDown, managedObjectUsageDone=managedObjectUsageDone, spScriptPort=spScriptPort, spBlackholeNexthop=spBlackholeNexthop, spInterface=spInterface, fingerprintFeedback=fingerprintFeedback, spManagedObjects=spManagedObjects, greDown=greDown, spReportURL=spReportURL, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spThirdPartyZone=spThirdPartyZone, spThirdPartyAddr=spThirdPartyAddr, spMitigationName=spMitigationName, spScriptStart=spScriptStart, mitigationBlackholeStart=mitigationBlackholeStart, spApplicationName=spApplicationName, spFingerprintFeedback=spFingerprintFeedback, spManagedObject=spManagedObject, dosNetworkProfiledAlert=dosNetworkProfiledAlert, licenseErrorDone=licenseErrorDone, deviceSystemError=deviceSystemError, spLicenseErrCount=spLicenseErrCount, collectorStart=collectorStart, autoclassifyStart=autoclassifyStart, bgpDown=bgpDown, spBlackholePrefix=spBlackholePrefix, devicePhysicalMemory=devicePhysicalMemory, mitigationTMSStart=mitigationTMSStart, spImpactPps=spImpactPps, spTMSMultiPrefix=spTMSMultiPrefix, fingerprintUsageDone=fingerprintUsageDone, spDNSObservedMean=spDNSObservedMean, spBGPEvent=spBGPEvent, routingFailover=routingFailover, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPCMI=peakflowSPCMI, spInterfaceIndex=spInterfaceIndex, spTMSPrefix=spTMSPrefix, spFingerprintSender=spFingerprintSender, spTMSTimeout=spTMSTimeout, spcommFailureDone=spcommFailureDone, licenseError=licenseError, spUsername=spUsername, deviceSwapSpace=deviceSwapSpace, flowDown=flowDown, spFingerprintMessage=spFingerprintMessage, bgpInstability=bgpInstability, spBGPInstability=spBGPInstability, spMitigationStart=spMitigationStart, spGreTunnelName=spGreTunnelName, fingerprintReceive=fingerprintReceive, bgpHijack=bgpHijack, dnsBaselineDone=dnsBaselineDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spMitigationID=spMitigationID, spHijackLocal=spHijackLocal, serviceUsageDone=serviceUsageDone, mitigationTMSStartV2=mitigationTMSStartV2, spDNSName=spDNSName, spManagedObjectFamily=spManagedObjectFamily, spDNSObserved=spDNSObserved, spAlertID=spAlertID, interfaceUsage=interfaceUsage, spHijackAttr=spHijackAttr, spDNSExpected=spDNSExpected, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, collectorUp=collectorUp, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationThirdPartyStart=mitigationThirdPartyStart, configChange=configChange, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSystemErrorDone=deviceSystemErrorDone, snmpUp=snmpUp, bgpUp=bgpUp, spHardwareFailureDescription=spHardwareFailureDescription, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spScriptCommand=spScriptCommand, spFlowspecTimeout=spFlowspecTimeout, spLicenseErrDescription=spLicenseErrDescription, spScriptHost=spScriptHost, spCommFailureDescription=spCommFailureDescription, managedObjectUsage=managedObjectUsage, notificationLimit=notificationLimit, spRouter=spRouter, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsage=spUsage, hardwareFailure=hardwareFailure, deviceTotalFlows=deviceTotalFlows, peakflowSPTraps=peakflowSPTraps, spUsageType=spUsageType, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, serviceUsage=serviceUsage, spInterfaceUsage=spInterfaceUsage, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spServiceName=spServiceName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, cloudSignalingFault=cloudSignalingFault, spFlowspecCommunity=spFlowspecCommunity, spDetectedCountries=spDetectedCountries, spDetector=spDetector, spPravail=spPravail)
