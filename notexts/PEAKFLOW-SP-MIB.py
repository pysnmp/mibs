...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:00:03 2024
...
TimeTicks, Counter64, iso, Bits, Gauge32, ModuleIdentity, IpAddress, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "iso", "Bits", "Gauge32", "ModuleIdentity", "IpAddress", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPInstability=spBGPInstability, serviceUsageDone=serviceUsageDone, spInterfaceUsage=spInterfaceUsage, spImpactBps=spImpactBps, spInterfaceUsageHC=spInterfaceUsageHC, collectorStart=collectorStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spSystemErrorType=spSystemErrorType, flowUp=flowUp, notificationLimit=notificationLimit, spVersion=spVersion, fingerprintUsageDone=fingerprintUsageDone, deviceSystemError=deviceSystemError, spFingerprintSender=spFingerprintSender, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemory=devicePhysicalMemory, spReportURL=spReportURL, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, autoclassifyStart=autoclassifyStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spGreTunnelName=spGreTunnelName, peakflowSPMgr=peakflowSPMgr, deviceDiskUsage=deviceDiskUsage, spGreTunnelDestination=spGreTunnelDestination, spHijackRoute=spHijackRoute, peakflowSPTraps=peakflowSPTraps, peakflowSPMIB=peakflowSPMIB, spManagedObjectFamily=spManagedObjectFamily, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapOldAttributes=spBGPTrapOldAttributes, configChange=configChange, spTMSMultiPrefix=spTMSMultiPrefix, licenseErrorDone=licenseErrorDone, spScriptCommand=spScriptCommand, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintName=spFingerprintName, spDNSObserved=spDNSObserved, bgpInstabilityDone=bgpInstabilityDone, spScriptHost=spScriptHost, spApplicationName=spApplicationName, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpDown=bgpDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyZone=spThirdPartyZone, spAlertID=spAlertID, cloudSignalingFault=cloudSignalingFault, serviceUsage=serviceUsage, spCollector=spCollector, spBGPEvent=spBGPEvent, collectorUp=collectorUp, spRouter=spRouter, spDuration=spDuration, spMitigationStart=spMitigationStart, spTMSCommunity=spTMSCommunity, spDNSObservedMean=spDNSObservedMean, spFlowspecCommunity=spFlowspecCommunity, greDownDone=greDownDone, spCommFailureDestination=spCommFailureDestination, spDNSName=spDNSName, alertScript=alertScript, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpTrap=bgpTrap, spPravail=spPravail, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spDetectedCountries=spDetectedCountries, spManagedObjects=spManagedObjects, spImpactPps=spImpactPps, spBlackholeCommunity=spBlackholeCommunity, spMitigationID=spMitigationID, spUsageType=spUsageType, hardwareFailureDone=hardwareFailureDone, spTMSPrefix=spTMSPrefix, spLicenseErrLimit=spLicenseErrLimit, interfaceUsage=interfaceUsage, spLicenseErrDescription=spLicenseErrDescription, spScriptPort=spScriptPort, spDetector=spDetector, hardwareFailure=hardwareFailure, mitigationFlowspecStart=mitigationFlowspecStart, spcommFailureDone=spcommFailureDone, spBGPTrapName=spBGPTrapName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, reportDone=reportDone, spServiceName=spServiceName, spLicenseErrType=spLicenseErrType, managedObjectUsageDone=managedObjectUsageDone, spHijackAttr=spHijackAttr, spUsername=spUsername, spInetAddress=spInetAddress, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpUp=bgpUp, licenseError=licenseError, dnsBaselineDone=dnsBaselineDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, fingerprintUsage=fingerprintUsage, spThreshold=spThreshold, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapPrefix=spBGPTrapPrefix, spScriptStart=spScriptStart, dosHostDetectionAlert=dosHostDetectionAlert, spInetAddressType=spInetAddressType, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceIndex=spInterfaceIndex, deviceSwapSpace=deviceSwapSpace, fingerprintFeedback=fingerprintFeedback, peakflowSPCMI=peakflowSPCMI, PYSNMP_MODULE_ID=peakflowSPMIB, snmpDown=snmpDown, spBlackholePrefix=spBlackholePrefix, mitigationDone=mitigationDone, managedObjectUsage=managedObjectUsage, spSystemErrorDescription=spSystemErrorDescription, spServiceElement=spServiceElement, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spUsage=spUsage, dnsBaseline=dnsBaseline, snmpUp=snmpUp, routingFailover=routingFailover, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spThirdPartyAddr=spThirdPartyAddr, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spHijackLocal=spHijackLocal, spManagedObject=spManagedObject, spMitigationName=spMitigationName, fingerprintReceive=fingerprintReceive, spLicenseErrCount=spLicenseErrCount, deviceSystemErrorDone=deviceSystemErrorDone, spDNSObservedMax=spDNSObservedMax, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, spReportName=spReportName, trafficAutoMitigation=trafficAutoMitigation, flowDown=flowDown, spFingerprintMessage=spFingerprintMessage, deviceHealth=deviceHealth, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spcommFailure=spcommFailure, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDown=greDown, spBlackholeNexthop=spBlackholeNexthop, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spUnit=spUnit, spHardwareFailureDescription=spHardwareFailureDescription, spDNSExpected=spDNSExpected, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationTMSStart=mitigationTMSStart, spBGPTrapEvent=spBGPTrapEvent, spFingerprintFeedback=spFingerprintFeedback, interfaceUsageDone=interfaceUsageDone, deviceTotalFlows=deviceTotalFlows, mitigationTMSStartV2=mitigationTMSStartV2, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationBlackholeStart=mitigationBlackholeStart, bgpHijack=bgpHijack, spReportID=spReportID, collectorDown=collectorDown, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate)
