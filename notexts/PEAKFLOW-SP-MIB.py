...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:05:42 2022
...
ObjectIdentity, Counter32, Integer32, IpAddress, iso, MibIdentifier, Bits, TimeTicks, NotificationType, ModuleIdentity, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Integer32", "IpAddress", "iso", "MibIdentifier", "Bits", "TimeTicks", "NotificationType", "ModuleIdentity", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFault=cloudSignalingFault, spBGPTrapEvent=spBGPTrapEvent, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPTraps=peakflowSPTraps, spDNSObservedMax=spDNSObservedMax, dnsBaselineDone=dnsBaselineDone, spDetector=spDetector, spThreshold=spThreshold, greDownDone=greDownDone, spUnit=spUnit, mitigationFlowspecStart=mitigationFlowspecStart, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlert=dosHostDetectionAlert, spInterfaceIndex=spInterfaceIndex, spReportName=spReportName, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsage=managedObjectUsage, spDuration=spDuration, mitigationTMSStartV2=mitigationTMSStartV2, spUsername=spUsername, spFingerprintFeedback=spFingerprintFeedback, spBlackholePrefix=spBlackholePrefix, serviceUsage=serviceUsage, spcommFailureDone=spcommFailureDone, spSystemErrorType=spSystemErrorType, deviceTotalFlowsHC=deviceTotalFlowsHC, hardwareFailureDone=hardwareFailureDone, collectorUp=collectorUp, deviceTotalFlows=deviceTotalFlows, spManagedObjectFamily=spManagedObjectFamily, spFlowspecTimeout=spFlowspecTimeout, spInetAddress=spInetAddress, devicePhysicalMemory=devicePhysicalMemory, spBGPEvent=spBGPEvent, mitigationThirdPartyStart=mitigationThirdPartyStart, collectorStart=collectorStart, trafficAutoMitigation=trafficAutoMitigation, managedObjectUsageDone=managedObjectUsageDone, spDNSObservedMean=spDNSObservedMean, spScriptCommand=spScriptCommand, bgpHijack=bgpHijack, spBlackholeTimeout=spBlackholeTimeout, bgpDown=bgpDown, flowDown=flowDown, collectorDown=collectorDown, spUsageType=spUsageType, spInterfaceUsageHC=spInterfaceUsageHC, interfaceUsage=interfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spAlertID=spAlertID, spBGPInstability=spBGPInstability, flowUp=flowUp, spMitigationID=spMitigationID, spTMSPrefix=spTMSPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, licenseError=licenseError, peakflowSPMgr=peakflowSPMgr, spDNSExpected=spDNSExpected, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spTMSCommunity=spTMSCommunity, routingFailover=routingFailover, spImpactBps=spImpactBps, hardwareFailure=hardwareFailure, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceDiskUsage=deviceDiskUsage, spInterfaceUsage=spInterfaceUsage, spMitigationStart=spMitigationStart, spDetectedCountries=spDetectedCountries, spManagedObjects=spManagedObjects, bgpUp=bgpUp, bgpInstabilityDone=bgpInstabilityDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackAttr=spHijackAttr, spApplicationName=spApplicationName, notificationLimit=notificationLimit, fingerprintReceive=fingerprintReceive, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spGreTunnelDestination=spGreTunnelDestination, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintSender=spFingerprintSender, spCommFailureDescription=spCommFailureDescription, spMitigationName=spMitigationName, spReportID=spReportID, bgpInstability=bgpInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapPrefix=spBGPTrapPrefix, spDNSName=spDNSName, serviceUsageDone=serviceUsageDone, spServiceName=spServiceName, fingerprintUsage=fingerprintUsage, spScriptHost=spScriptHost, cloudSignalingFaultDone=cloudSignalingFaultDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintName=spFingerprintName, interfaceUsageDone=interfaceUsageDone, deviceSystemError=deviceSystemError, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, spUsage=spUsage, peakflowSPMIB=peakflowSPMIB, spScriptPort=spScriptPort, snmpUp=snmpUp, spDNSObserved=spDNSObserved, mitigationBlackholeStart=mitigationBlackholeStart, autoclassifyStart=autoclassifyStart, spHijackRoute=spHijackRoute, greDown=greDown, licenseErrorDone=licenseErrorDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceHealth=deviceHealth, spTMSMultiPrefix=spTMSMultiPrefix, spRouter=spRouter, mitigationDone=mitigationDone, fingerprintUsageDone=fingerprintUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spScriptStart=spScriptStart, spLicenseErrDescription=spLicenseErrDescription, spThirdPartyZone=spThirdPartyZone, spcommFailure=spcommFailure, spServiceElement=spServiceElement, spPravail=spPravail, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSTimeout=spTMSTimeout, spInterfaceSpeed=spInterfaceSpeed, spImpactPps=spImpactPps, spCollector=spCollector, spBlackholeNexthop=spBlackholeNexthop, spGreTunnelName=spGreTunnelName, snmpDown=snmpDown, reportDone=reportDone, fingerprintFeedback=fingerprintFeedback, spFingerprintMessage=spFingerprintMessage, spLicenseErrCount=spLicenseErrCount, PYSNMP_MODULE_ID=peakflowSPMIB, peakflowSPCMI=peakflowSPCMI, spVersion=spVersion, spInterface=spInterface, configChange=configChange, bgpTrap=bgpTrap, dnsBaseline=dnsBaseline, spInetAddressType=spInetAddressType, spLicenseErrLimit=spLicenseErrLimit, alertScript=alertScript, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyAddr=spThirdPartyAddr, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpace=deviceSwapSpace, spBlackholeCommunity=spBlackholeCommunity, spSystemErrorDescription=spSystemErrorDescription, mitigationTMSStart=mitigationTMSStart, spReportURL=spReportURL, spManagedObject=spManagedObject, spHijackLocal=spHijackLocal)
