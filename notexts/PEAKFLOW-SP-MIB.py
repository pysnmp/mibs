...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:58:30 2023
...
ObjectIdentity, Unsigned32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, Bits, iso, Integer32, Counter64, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "Bits", "iso", "Integer32", "Counter64", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spPravail=spPravail, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpInstability=bgpInstability, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDuration=spDuration, spRouter=spRouter, bgpUp=bgpUp, spcommFailure=spcommFailure, collectorStart=collectorStart, managedObjectUsageDone=managedObjectUsageDone, flowUp=flowUp, spUnit=spUnit, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSCommunity=spTMSCommunity, autoclassifyStart=autoclassifyStart, bgpInstabilityDone=bgpInstabilityDone, spLicenseErrDescription=spLicenseErrDescription, spBGPEvent=spBGPEvent, trafficAutoMitigation=trafficAutoMitigation, spUsageType=spUsageType, greDown=greDown, spGreTunnelDestination=spGreTunnelDestination, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, hardwareFailureDone=hardwareFailureDone, bgpTrap=bgpTrap, fingerprintUsageDone=fingerprintUsageDone, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, spManagedObjects=spManagedObjects, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationTMSStart=mitigationTMSStart, snmpDown=snmpDown, bgpDown=bgpDown, spBGPTrapName=spBGPTrapName, spThirdPartyZone=spThirdPartyZone, peakflowSPCMI=peakflowSPCMI, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholeNexthop=spBlackholeNexthop, spCollector=spCollector, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObservedMean=spDNSObservedMean, cloudSignalingFaultDone=cloudSignalingFaultDone, spBlackholeCommunity=spBlackholeCommunity, routingFailover=routingFailover, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spServiceName=spServiceName, spMitigationStart=spMitigationStart, interfaceUsage=interfaceUsage, spSystemErrorType=spSystemErrorType, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSystemError=deviceSystemError, deviceSystemErrorDone=deviceSystemErrorDone, spDNSExpected=spDNSExpected, spcommFailureDone=spcommFailureDone, collectorDown=collectorDown, deviceDiskUsage=deviceDiskUsage, spTMSPrefix=spTMSPrefix, dnsBaselineDone=dnsBaselineDone, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsage=serviceUsage, bgpHijack=bgpHijack, spFingerprintName=spFingerprintName, greDownDone=greDownDone, reportDone=reportDone, spAlertID=spAlertID, spScriptCommand=spScriptCommand, spServiceElement=spServiceElement, mitigationBlackholeStart=mitigationBlackholeStart, alertScript=alertScript, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDetectedCountries=spDetectedCountries, fingerprintReceive=fingerprintReceive, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapPrefix=spBGPTrapPrefix, deviceSwapSpace=deviceSwapSpace, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spTMSTimeout=spTMSTimeout, snmpUp=snmpUp, spMitigationName=spMitigationName, deviceTotalFlows=deviceTotalFlows, spBGPInstability=spBGPInstability, spInterfaceSpeedHC=spInterfaceSpeedHC, spFingerprintSender=spFingerprintSender, spScriptStart=spScriptStart, spHardwareFailureDescription=spHardwareFailureDescription, spThreshold=spThreshold, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSObservedMax=spDNSObservedMax, licenseError=licenseError, spLicenseErrType=spLicenseErrType, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterface=spInterface, spUsername=spUsername, spSystemErrorDescription=spSystemErrorDescription, spBlackholeTimeout=spBlackholeTimeout, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, dnsBaseline=dnsBaseline, spReportURL=spReportURL, mitigationDone=mitigationDone, spReportID=spReportID, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spScriptPort=spScriptPort, spDNSObserved=spDNSObserved, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecTimeout=spFlowspecTimeout, deviceHealth=deviceHealth, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDetector=spDetector, managedObjectUsage=managedObjectUsage, configChange=configChange, spCommFailureDescription=spCommFailureDescription, peakflowSPMIB=peakflowSPMIB, spHijackLocal=spHijackLocal, spHijackAttr=spHijackAttr, cloudSignalingFault=cloudSignalingFault, spScriptHost=spScriptHost, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapEvent=spBGPTrapEvent, spVersion=spVersion, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spApplicationName=spApplicationName, spBlackholePrefix=spBlackholePrefix, spCommFailureDestination=spCommFailureDestination, licenseErrorDone=licenseErrorDone, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, spInterfaceUsage=spInterfaceUsage, spReportName=spReportName, spInetAddress=spInetAddress, mitigationFlowspecStart=mitigationFlowspecStart, spHijackRoute=spHijackRoute, spLicenseErrCount=spLicenseErrCount, mitigationTMSStartV2=mitigationTMSStartV2, spInetAddressType=spInetAddressType, flowDown=flowDown, collectorUp=collectorUp, fingerprintFeedback=fingerprintFeedback, peakflowSPTraps=peakflowSPTraps, spManagedObject=spManagedObject, spGreTunnelName=spGreTunnelName, PYSNMP_MODULE_ID=peakflowSPMIB, notificationLimit=notificationLimit, spFingerprintFeedback=spFingerprintFeedback, devicePhysicalMemory=devicePhysicalMemory, spUsage=spUsage, fingerprintUsage=fingerprintUsage, serviceUsageDone=serviceUsageDone, spLicenseErrLimit=spLicenseErrLimit, spImpactPps=spImpactPps, spInterfaceIndex=spInterfaceIndex, spDNSName=spDNSName, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationID=spMitigationID, spFingerprintMessage=spFingerprintMessage, peakflowSPMgr=peakflowSPMgr)
