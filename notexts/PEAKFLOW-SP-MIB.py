...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:39:51 2024
...
TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Bits, Unsigned32, Gauge32, Counter32, ModuleIdentity, iso, Integer32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Bits", "Unsigned32", "Gauge32", "Counter32", "ModuleIdentity", "iso", "Integer32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInetAddressType=spInetAddressType, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spMitigationName=spMitigationName, spCommFailureDestination=spCommFailureDestination, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spScriptPort=spScriptPort, spManagedObjects=spManagedObjects, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceUsageHC=spInterfaceUsageHC, mitigationFlowspecStart=mitigationFlowspecStart, spGreTunnelDestination=spGreTunnelDestination, spSystemErrorType=spSystemErrorType, cloudSignalingFault=cloudSignalingFault, spLicenseErrDescription=spLicenseErrDescription, spManagedObjectFamily=spManagedObjectFamily, spCloudSignalFaultDescription=spCloudSignalFaultDescription, licenseError=licenseError, spBGPTrapEvent=spBGPTrapEvent, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, fingerprintFeedback=fingerprintFeedback, spBGPInstability=spBGPInstability, fingerprintReceive=fingerprintReceive, spRouter=spRouter, licenseErrorDone=licenseErrorDone, spMitigationID=spMitigationID, peakflowSPMIB=peakflowSPMIB, spSystemErrorDescription=spSystemErrorDescription, spTMSMultiPrefix=spTMSMultiPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceSpeed=spInterfaceSpeed, deviceDiskUsage=deviceDiskUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlowsHC=deviceTotalFlowsHC, spHijackLocal=spHijackLocal, spVersion=spVersion, spHijackRoute=spHijackRoute, spDNSName=spDNSName, spScriptStart=spScriptStart, alertScript=alertScript, spUsage=spUsage, configChange=configChange, interfaceUsage=interfaceUsage, spCommFailureDescription=spCommFailureDescription, spReportID=spReportID, spFingerprintMessage=spFingerprintMessage, spCollector=spCollector, spMitigationStart=spMitigationStart, peakflowSPMgr=peakflowSPMgr, spBGPEvent=spBGPEvent, greDown=greDown, mitigationTMSStartV2=mitigationTMSStartV2, deviceSystemErrorDone=deviceSystemErrorDone, spImpactPps=spImpactPps, spFingerprintSender=spFingerprintSender, serviceUsage=serviceUsage, interfaceUsageDone=interfaceUsageDone, managedObjectUsage=managedObjectUsage, mitigationBlackholeStart=mitigationBlackholeStart, spBlackholeNexthop=spBlackholeNexthop, deviceTotalFlows=deviceTotalFlows, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceUsage=spInterfaceUsage, spFingerprintName=spFingerprintName, dnsBaselineDone=dnsBaselineDone, spFlowspecTimeout=spFlowspecTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailover=routingFailover, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, serviceUsageDone=serviceUsageDone, fingerprintUsageDone=fingerprintUsageDone, spInetAddress=spInetAddress, managedObjectUsageDone=managedObjectUsageDone, spThreshold=spThreshold, spInterface=spInterface, mitigationThirdPartyStart=mitigationThirdPartyStart, spDuration=spDuration, flowDown=flowDown, spApplicationName=spApplicationName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spReportName=spReportName, spImpactBps=spImpactBps, reportDone=reportDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spReportURL=spReportURL, peakflowSPTraps=peakflowSPTraps, spDetector=spDetector, spTMSPrefix=spTMSPrefix, peakflowSPCMI=peakflowSPCMI, spManagedObject=spManagedObject, bgpTrap=bgpTrap, spFingerprintFeedback=spFingerprintFeedback, spTMSCommunity=spTMSCommunity, snmpDown=snmpDown, notificationLimit=notificationLimit, autoclassifyStart=autoclassifyStart, bgpHijack=bgpHijack, mitigationTMSStart=mitigationTMSStart, spTMSTimeout=spTMSTimeout, spLicenseErrCount=spLicenseErrCount, spDNSObservedMax=spDNSObservedMax, PYSNMP_MODULE_ID=peakflowSPMIB, spAlertDetectionSignatures=spAlertDetectionSignatures, spDetectedCountries=spDetectedCountries, snmpUp=snmpUp, spFlowspecCommunity=spFlowspecCommunity, spBlackholeCommunity=spBlackholeCommunity, spHijackAttr=spHijackAttr, spBlackholePrefix=spBlackholePrefix, collectorUp=collectorUp, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosHostDetectionAlertDone=dosHostDetectionAlertDone, greDownDone=greDownDone, bgpInstability=bgpInstability, deviceSwapSpace=deviceSwapSpace, bgpDown=bgpDown, spUnit=spUnit, hardwareFailure=hardwareFailure, spcommFailureDone=spcommFailureDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spServiceName=spServiceName, spThirdPartyZone=spThirdPartyZone, deviceHealth=deviceHealth, flowUp=flowUp, spBGPTrapName=spBGPTrapName, spScriptCommand=spScriptCommand, mitigationDone=mitigationDone, spBGPTrapPrefix=spBGPTrapPrefix, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelName=spGreTunnelName, fingerprintUsage=fingerprintUsage, spLicenseErrLimit=spLicenseErrLimit, spAlertID=spAlertID, spDNSObserved=spDNSObserved, deviceSystemError=deviceSystemError, bgpUp=bgpUp, spScriptHost=spScriptHost, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spServiceElement=spServiceElement, spBGPTrapOldAttributes=spBGPTrapOldAttributes, hardwareFailureDone=hardwareFailureDone, spUsername=spUsername, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, collectorDown=collectorDown, spDNSExpected=spDNSExpected, bgpInstabilityDone=bgpInstabilityDone, dnsBaseline=dnsBaseline, dosHostDetectionAlert=dosHostDetectionAlert, spUsageType=spUsageType, spDNSObservedMean=spDNSObservedMean, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spcommFailure=spcommFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorStart=collectorStart, spPravail=spPravail, spInterfaceIndex=spInterfaceIndex, trafficAutoMitigation=trafficAutoMitigation, spBlackholeTimeout=spBlackholeTimeout)
