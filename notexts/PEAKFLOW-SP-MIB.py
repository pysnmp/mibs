...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:18:54 2021
...
ModuleIdentity, ObjectIdentity, Gauge32, IpAddress, Counter32, Unsigned32, iso, NotificationType, Integer32, Counter64, Bits, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Gauge32", "IpAddress", "Counter32", "Unsigned32", "iso", "NotificationType", "Integer32", "Counter64", "Bits", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapName=spBGPTrapName, mitigationThirdPartyStart=mitigationThirdPartyStart, spHardwareFailureDescription=spHardwareFailureDescription, hardwareFailure=hardwareFailure, spTMSCommunity=spTMSCommunity, spImpactBps=spImpactBps, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spMitigationName=spMitigationName, dnsBaselineDone=dnsBaselineDone, spCommFailureDescription=spCommFailureDescription, spLicenseErrLimit=spLicenseErrLimit, spFingerprintName=spFingerprintName, spBGPEvent=spBGPEvent, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptCommand=spScriptCommand, alertScript=alertScript, trafficAutoMitigation=trafficAutoMitigation, deviceTotalFlows=deviceTotalFlows, spTMSTimeout=spTMSTimeout, collectorDown=collectorDown, spMitigationID=spMitigationID, spScriptStart=spScriptStart, reportDone=reportDone, spLicenseErrCount=spLicenseErrCount, spBlackholeCommunity=spBlackholeCommunity, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spManagedObjects=spManagedObjects, peakflowSPMgr=peakflowSPMgr, spMitigationStart=spMitigationStart, snmpUp=snmpUp, spInetAddress=spInetAddress, spScriptPort=spScriptPort, spInterfaceUsage=spInterfaceUsage, serviceUsage=serviceUsage, dosHostDetectionAlert=dosHostDetectionAlert, greDown=greDown, licenseErrorDone=licenseErrorDone, routingFailover=routingFailover, peakflowSPMIB=peakflowSPMIB, managedObjectUsage=managedObjectUsage, fingerprintFeedback=fingerprintFeedback, mitigationBlackholeStart=mitigationBlackholeStart, spInterface=spInterface, spManagedObjectFamily=spManagedObjectFamily, snmpDown=snmpDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSObservedMax=spDNSObservedMax, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spImpactPps=spImpactPps, hardwareFailureDone=hardwareFailureDone, fingerprintUsage=fingerprintUsage, autoclassifyStart=autoclassifyStart, licenseError=licenseError, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceIndex=spInterfaceIndex, mitigationTMSStart=mitigationTMSStart, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, spDNSExpected=spDNSExpected, interfaceUsage=interfaceUsage, spThirdPartyAddr=spThirdPartyAddr, bgpUp=bgpUp, deviceDiskUsage=deviceDiskUsage, spReportName=spReportName, fingerprintUsageDone=fingerprintUsageDone, spInterfaceSpeed=spInterfaceSpeed, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFlowspecTimeout=spFlowspecTimeout, spHijackAttr=spHijackAttr, managedObjectUsageDone=managedObjectUsageDone, spReportURL=spReportURL, peakflowSPCMI=peakflowSPCMI, collectorStart=collectorStart, spTMSPrefix=spTMSPrefix, spVersion=spVersion, devicePhysicalMemory=devicePhysicalMemory, collectorUp=collectorUp, spcommFailureDone=spcommFailureDone, spApplicationName=spApplicationName, spFlowspecCommunity=spFlowspecCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpHijack=bgpHijack, spBlackholeTimeout=spBlackholeTimeout, flowDown=flowDown, greDownDone=greDownDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, cloudSignalingFault=cloudSignalingFault, spcommFailure=spcommFailure, deviceSystemError=deviceSystemError, spInterfaceSpeedHC=spInterfaceSpeedHC, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceHealth=deviceHealth, spTMSMultiPrefix=spTMSMultiPrefix, spDetectedCountries=spDetectedCountries, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstabilityDone=bgpInstabilityDone, mitigationDone=mitigationDone, spScriptHost=spScriptHost, spGreTunnelDestination=spGreTunnelDestination, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spPravail=spPravail, mitigationTMSStartV2=mitigationTMSStartV2, configChange=configChange, spFingerprintSender=spFingerprintSender, serviceUsageDone=serviceUsageDone, bgpDown=bgpDown, peakflowSPTraps=peakflowSPTraps, spBlackholeNexthop=spBlackholeNexthop, fingerprintReceive=fingerprintReceive, spThirdPartyZone=spThirdPartyZone, spHijackLocal=spHijackLocal, interfaceUsageDone=interfaceUsageDone, bgpTrap=bgpTrap, cloudSignalingFaultDone=cloudSignalingFaultDone, spDetector=spDetector, spInetAddressType=spInetAddressType, spUsage=spUsage, spBGPInstability=spBGPInstability, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spThreshold=spThreshold, spLicenseErrDescription=spLicenseErrDescription, spLicenseErrType=spLicenseErrType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spFingerprintMessage=spFingerprintMessage, spFingerprintFeedback=spFingerprintFeedback, spHijackRoute=spHijackRoute, spUnit=spUnit, spDNSObservedMean=spDNSObservedMean, bgpInstability=bgpInstability, deviceSwapSpace=deviceSwapSpace, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapPrefix=spBGPTrapPrefix, spUsername=spUsername, spManagedObject=spManagedObject, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceSystemErrorDone=deviceSystemErrorDone, spAlertID=spAlertID, spReportID=spReportID, spServiceElement=spServiceElement, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationFlowspecStart=mitigationFlowspecStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSObserved=spDNSObserved, notificationLimit=notificationLimit, flowUp=flowUp, spGreTunnelName=spGreTunnelName, spCollector=spCollector, spUsageType=spUsageType, spInterfaceUsageHC=spInterfaceUsageHC, spDNSName=spDNSName, spDuration=spDuration, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spServiceName=spServiceName, spSystemErrorDescription=spSystemErrorDescription, spSystemErrorType=spSystemErrorType, dnsBaseline=dnsBaseline)
