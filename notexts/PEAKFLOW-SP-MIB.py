...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:00:50 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ObjectIdentity, MibIdentifier, Counter64, ModuleIdentity, Counter32, Gauge32, Integer32, TimeTicks, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ObjectIdentity", "MibIdentifier", "Counter64", "ModuleIdentity", "Counter32", "Gauge32", "Integer32", "TimeTicks", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThreshold=spThreshold, spBGPEvent=spBGPEvent, cloudSignalingFaultDone=cloudSignalingFaultDone, bgpDown=bgpDown, spFlowspecCommunity=spFlowspecCommunity, spAlertID=spAlertID, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSTimeout=spTMSTimeout, spCommFailureDescription=spCommFailureDescription, fingerprintReceive=fingerprintReceive, spInterfaceIndex=spInterfaceIndex, spApplicationName=spApplicationName, reportDone=reportDone, spInterfaceSpeed=spInterfaceSpeed, collectorDown=collectorDown, mitigationTMSStartV2=mitigationTMSStartV2, deviceSwapSpace=deviceSwapSpace, spDNSName=spDNSName, hardwareFailureDone=hardwareFailureDone, spInetAddressType=spInetAddressType, peakflowSPCMI=peakflowSPCMI, spDNSObservedMean=spDNSObservedMean, routingFailover=routingFailover, spDuration=spDuration, trafficAutoMitigation=trafficAutoMitigation, spVersion=spVersion, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, serviceUsage=serviceUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPInstability=spBGPInstability, spBlackholeCommunity=spBlackholeCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, flowDown=flowDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsageDone=serviceUsageDone, spTMSCommunity=spTMSCommunity, autoclassifyStart=autoclassifyStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationName=spMitigationName, greDownDone=greDownDone, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObject=spManagedObject, spMitigationStart=spMitigationStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spSystemErrorType=spSystemErrorType, spServiceName=spServiceName, collectorStart=collectorStart, spBlackholeTimeout=spBlackholeTimeout, licenseError=licenseError, peakflowSPMgr=peakflowSPMgr, spDetector=spDetector, spScriptHost=spScriptHost, spInterfaceUsage=spInterfaceUsage, bgpUp=bgpUp, spLicenseErrCount=spLicenseErrCount, notificationLimit=notificationLimit, spScriptCommand=spScriptCommand, spDNSExpected=spDNSExpected, spBlackholePrefix=spBlackholePrefix, spCollector=spCollector, spReportID=spReportID, managedObjectUsage=managedObjectUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spScriptPort=spScriptPort, bgpHijack=bgpHijack, peakflowSPTraps=peakflowSPTraps, dnsBaseline=dnsBaseline, spScriptStart=spScriptStart, spRouter=spRouter, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, snmpDown=snmpDown, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dnsBaselineDone=dnsBaselineDone, spLicenseErrType=spLicenseErrType, peakflowSPMIB=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, spServiceElement=spServiceElement, spDNSObserved=spDNSObserved, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spHijackAttr=spHijackAttr, licenseErrorDone=licenseErrorDone, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorDescription=spSystemErrorDescription, spFingerprintSender=spFingerprintSender, spGreTunnelName=spGreTunnelName, fingerprintUsageDone=fingerprintUsageDone, spReportName=spReportName, bgpTrap=bgpTrap, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingFault=cloudSignalingFault, PYSNMP_MODULE_ID=peakflowSPMIB, spThirdPartyZone=spThirdPartyZone, spcommFailure=spcommFailure, greDown=greDown, spHardwareFailureDescription=spHardwareFailureDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCommFailureDestination=spCommFailureDestination, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBGPTrapName=spBGPTrapName, spInetAddress=spInetAddress, deviceTotalFlowsHC=deviceTotalFlowsHC, managedObjectUsageDone=managedObjectUsageDone, spUsername=spUsername, mitigationTMSStart=mitigationTMSStart, flowUp=flowUp, deviceTotalFlows=deviceTotalFlows, collectorUp=collectorUp, snmpUp=snmpUp, interfaceUsageDone=interfaceUsageDone, spFingerprintMessage=spFingerprintMessage, interfaceUsage=interfaceUsage, deviceHealth=deviceHealth, spReportURL=spReportURL, deviceSystemError=deviceSystemError, spImpactBps=spImpactBps, spImpactPps=spImpactPps, deviceDiskUsage=deviceDiskUsage, spMitigationID=spMitigationID, dosHostDetectionAlert=dosHostDetectionAlert, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, fingerprintUsage=fingerprintUsage, spFingerprintFeedback=spFingerprintFeedback, spUsage=spUsage, spInterface=spInterface, mitigationDone=mitigationDone, spGreTunnelDestination=spGreTunnelDestination, spDetectedCountries=spDetectedCountries, alertScript=alertScript, fingerprintFeedback=fingerprintFeedback, spLicenseErrDescription=spLicenseErrDescription, spTMSPrefix=spTMSPrefix, devicePhysicalMemory=devicePhysicalMemory, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPTrapEvent=spBGPTrapEvent, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObservedMax=spDNSObservedMax, spManagedObjects=spManagedObjects, spThirdPartyAddr=spThirdPartyAddr, mitigationBlackholeStart=mitigationBlackholeStart, spHijackRoute=spHijackRoute, configChange=configChange, spBlackholeNexthop=spBlackholeNexthop, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, bgpInstabilityDone=bgpInstabilityDone, spFingerprintName=spFingerprintName, spcommFailureDone=spcommFailureDone, spFlowspecTimeout=spFlowspecTimeout, spUsageType=spUsageType, hardwareFailure=hardwareFailure, spPravail=spPravail, spHijackLocal=spHijackLocal, spUnit=spUnit)
