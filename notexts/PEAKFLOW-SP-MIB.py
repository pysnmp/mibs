...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:54:47 2024
...
ObjectIdentity, Counter32, Counter64, NotificationType, iso, TimeTicks, Unsigned32, ModuleIdentity, Integer32, Gauge32, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "Counter64", "NotificationType", "iso", "TimeTicks", "Unsigned32", "ModuleIdentity", "Integer32", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDNSObserved=spDNSObserved, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpHijack=bgpHijack, spLicenseErrCount=spLicenseErrCount, deviceTotalFlowsHC=deviceTotalFlowsHC, spFlowspecCommunity=spFlowspecCommunity, greDownDone=greDownDone, spcommFailureDone=spcommFailureDone, peakflowSPMIB=peakflowSPMIB, mitigationDone=mitigationDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spApplicationName=spApplicationName, trafficAutoMitigation=trafficAutoMitigation, serviceUsageDone=serviceUsageDone, peakflowSPCMI=peakflowSPCMI, flowUp=flowUp, managedObjectUsageDone=managedObjectUsageDone, spInterfaceSpeedHC=spInterfaceSpeedHC, licenseError=licenseError, spCommFailureDescription=spCommFailureDescription, spVersion=spVersion, collectorUp=collectorUp, deviceSwapSpace=deviceSwapSpace, spCommFailureDestination=spCommFailureDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpUp=bgpUp, spLicenseErrLimit=spLicenseErrLimit, spInterfaceSpeed=spInterfaceSpeed, dosHostDetectionAlert=dosHostDetectionAlert, snmpUp=snmpUp, spMitigationStart=spMitigationStart, spGreTunnelName=spGreTunnelName, devicePhysicalMemory=devicePhysicalMemory, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spLicenseErrDescription=spLicenseErrDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spPravail=spPravail, spScriptCommand=spScriptCommand, dnsBaseline=dnsBaseline, spManagedObjects=spManagedObjects, bgpInstability=bgpInstability, spBGPTrapPrefix=spBGPTrapPrefix, spMitigationName=spMitigationName, spBGPTrapEvent=spBGPTrapEvent, collectorStart=collectorStart, spcommFailure=spcommFailure, spHardwareFailureDescription=spHardwareFailureDescription, mitigationTMSStartV2=mitigationTMSStartV2, mitigationBlackholeStart=mitigationBlackholeStart, spDNSObservedMean=spDNSObservedMean, spLicenseErrType=spLicenseErrType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjectFamily=spManagedObjectFamily, spScriptHost=spScriptHost, spBlackholeNexthop=spBlackholeNexthop, spBlackholePrefix=spBlackholePrefix, spManagedObject=spManagedObject, spBGPTrapName=spBGPTrapName, spInterfaceIndex=spInterfaceIndex, spInetAddressType=spInetAddressType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDetector=spDetector, peakflowSPTraps=peakflowSPTraps, alertScript=alertScript, bgpTrap=bgpTrap, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyZone=spThirdPartyZone, spBlackholeTimeout=spBlackholeTimeout, licenseErrorDone=licenseErrorDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, serviceUsage=serviceUsage, spGreTunnelDestination=spGreTunnelDestination, spSystemErrorType=spSystemErrorType, spUsage=spUsage, spReportID=spReportID, bgpInstabilityDone=bgpInstabilityDone, spUsageType=spUsageType, dnsBaselineDone=dnsBaselineDone, spHijackRoute=spHijackRoute, spInterfaceUsage=spInterfaceUsage, fingerprintUsage=fingerprintUsage, spMitigationID=spMitigationID, interfaceUsage=interfaceUsage, hardwareFailure=hardwareFailure, hardwareFailureDone=hardwareFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, spFlowspecTimeout=spFlowspecTimeout, spInetAddress=spInetAddress, reportDone=reportDone, bgpDown=bgpDown, fingerprintFeedback=fingerprintFeedback, spTMSTimeout=spTMSTimeout, spHijackLocal=spHijackLocal, fingerprintUsageDone=fingerprintUsageDone, spSystemErrorDescription=spSystemErrorDescription, spTMSPrefix=spTMSPrefix, spRouter=spRouter, deviceSystemErrorDone=deviceSystemErrorDone, deviceHealth=deviceHealth, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spReportName=spReportName, spFingerprintFeedback=spFingerprintFeedback, spDetectedCountries=spDetectedCountries, mitigationFlowspecStart=mitigationFlowspecStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spHijackAttr=spHijackAttr, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spUsername=spUsername, mitigationTMSStart=mitigationTMSStart, spScriptPort=spScriptPort, spServiceName=spServiceName, spReportURL=spReportURL, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterface=spInterface, autoclassifyStart=autoclassifyStart, spDuration=spDuration, managedObjectUsage=managedObjectUsage, snmpDown=snmpDown, spScriptStart=spScriptStart, spTMSMultiPrefix=spTMSMultiPrefix, spFingerprintMessage=spFingerprintMessage, spFingerprintName=spFingerprintName, spBGPInstability=spBGPInstability, spThirdPartyAddr=spThirdPartyAddr, deviceSystemError=deviceSystemError, spAlertID=spAlertID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintSender=spFingerprintSender, spCollector=spCollector, configChange=configChange, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, interfaceUsageDone=interfaceUsageDone, spTMSCommunity=spTMSCommunity, deviceTotalFlows=deviceTotalFlows, fingerprintReceive=fingerprintReceive, deviceDiskUsage=deviceDiskUsage, notificationLimit=notificationLimit, cloudSignalingFault=cloudSignalingFault, spInterfaceUsageHC=spInterfaceUsageHC, spBGPEvent=spBGPEvent, collectorDown=collectorDown, spServiceElement=spServiceElement, spImpactPps=spImpactPps, spUnit=spUnit, spBlackholeCommunity=spBlackholeCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPMgr=peakflowSPMgr, spThreshold=spThreshold, spDNSObservedMax=spDNSObservedMax, spImpactBps=spImpactBps, flowDown=flowDown, spDNSExpected=spDNSExpected, greDown=greDown, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSName=spDNSName, routingFailover=routingFailover, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage)
