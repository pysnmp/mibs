...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, Gauge32, Counter32, iso, NotificationType, Counter64, Bits, IpAddress, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "Gauge32", "Counter32", "iso", "NotificationType", "Counter64", "Bits", "IpAddress", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDestination=spCommFailureDestination, dnsBaseline=dnsBaseline, spInetAddress=spInetAddress, deviceDiskUsage=deviceDiskUsage, devicePhysicalMemory=devicePhysicalMemory, peakflowSPMIB=peakflowSPMIB, deviceSwapSpace=deviceSwapSpace, spInterfaceUsageHC=spInterfaceUsageHC, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, serviceUsage=serviceUsage, bgpHijack=bgpHijack, mitigationFlowspecStart=mitigationFlowspecStart, spDuration=spDuration, fingerprintUsage=fingerprintUsage, spManagedObjectFamily=spManagedObjectFamily, spTMSPrefix=spTMSPrefix, spLicenseErrDescription=spLicenseErrDescription, spDNSObserved=spDNSObserved, spScriptCommand=spScriptCommand, spGreTunnelName=spGreTunnelName, spMitigationID=spMitigationID, spBlackholePrefix=spBlackholePrefix, spcommFailure=spcommFailure, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceIndex=spInterfaceIndex, spInterface=spInterface, bgpInstabilityDone=bgpInstabilityDone, trafficAutoMitigation=trafficAutoMitigation, fingerprintReceive=fingerprintReceive, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSObservedMean=spDNSObservedMean, spScriptStart=spScriptStart, spLicenseErrCount=spLicenseErrCount, spHardwareFailureDescription=spHardwareFailureDescription, spMitigationStart=spMitigationStart, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPTrapPrefix=spBGPTrapPrefix, spFingerprintFeedback=spFingerprintFeedback, dosHostDetectionAlert=dosHostDetectionAlert, spServiceElement=spServiceElement, spThirdPartyAddr=spThirdPartyAddr, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFault=cloudSignalingFault, greDownDone=greDownDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationTMSStart=mitigationTMSStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInterfaceUsage=spInterfaceUsage, greDown=greDown, PYSNMP_MODULE_ID=peakflowSPMIB, serviceUsageDone=serviceUsageDone, spSystemErrorType=spSystemErrorType, spScriptPort=spScriptPort, spcommFailureDone=spcommFailureDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceHealth=deviceHealth, spReportName=spReportName, deviceSystemErrorDone=deviceSystemErrorDone, deviceTotalFlows=deviceTotalFlows, spTMSCommunity=spTMSCommunity, spScriptHost=spScriptHost, dnsBaselineDone=dnsBaselineDone, peakflowSPMgr=peakflowSPMgr, configChange=configChange, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintMessage=spFingerprintMessage, spDNSName=spDNSName, spInterfaceSpeedHC=spInterfaceSpeedHC, notificationLimit=notificationLimit, spFingerprintSender=spFingerprintSender, bgpTrap=bgpTrap, spInetAddressType=spInetAddressType, managedObjectUsageDone=managedObjectUsageDone, spBGPTrapName=spBGPTrapName, spHijackAttr=spHijackAttr, spManagedObject=spManagedObject, interfaceUsage=interfaceUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailover=routingFailover, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spAlertID=spAlertID, spInterfaceSpeed=spInterfaceSpeed, collectorStart=collectorStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrType=spLicenseErrType, spUsageType=spUsageType, spTMSTimeout=spTMSTimeout, spDetectedCountries=spDetectedCountries, alertScript=alertScript, deviceTotalFlowsHC=deviceTotalFlowsHC, spApplicationName=spApplicationName, spDetector=spDetector, spBGPEvent=spBGPEvent, snmpDown=snmpDown, managedObjectUsage=managedObjectUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPCMI=peakflowSPCMI, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spGreTunnelDestination=spGreTunnelDestination, interfaceUsageDone=interfaceUsageDone, autoclassifyStart=autoclassifyStart, licenseErrorDone=licenseErrorDone, spCommFailureDescription=spCommFailureDescription, spRouter=spRouter, licenseError=licenseError, spDNSExpected=spDNSExpected, fingerprintFeedback=fingerprintFeedback, spThirdPartyZone=spThirdPartyZone, spBGPTrapEvent=spBGPTrapEvent, spReportID=spReportID, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorDown=collectorDown, spDNSObservedMax=spDNSObservedMax, reportDone=reportDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spPravail=spPravail, spImpactBps=spImpactBps, spManagedObjects=spManagedObjects, bgpInstability=bgpInstability, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, flowDown=flowDown, spServiceName=spServiceName, snmpUp=snmpUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpUp=bgpUp, spUsername=spUsername, hardwareFailureDone=hardwareFailureDone, spBGPInstability=spBGPInstability, spBlackholeTimeout=spBlackholeTimeout, bgpDown=bgpDown, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, spUsage=spUsage, flowUp=flowUp, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBlackholeNexthop=spBlackholeNexthop, peakflowSPTraps=peakflowSPTraps, spUnit=spUnit, collectorUp=collectorUp, spCollector=spCollector, hardwareFailure=hardwareFailure, spMitigationName=spMitigationName, deviceSystemError=deviceSystemError, spImpactPps=spImpactPps, fingerprintUsageDone=fingerprintUsageDone, spHijackLocal=spHijackLocal, spFlowspecCommunity=spFlowspecCommunity, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFlowspecTimeout=spFlowspecTimeout, spVersion=spVersion, spSystemErrorDescription=spSystemErrorDescription, mitigationDone=mitigationDone, spThreshold=spThreshold, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapNewAttributes=spBGPTrapNewAttributes)
