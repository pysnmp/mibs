...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:52:11 2022
...
NotificationType, Counter64, ModuleIdentity, MibIdentifier, Counter32, Gauge32, Integer32, ObjectIdentity, TimeTicks, IpAddress, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "MibIdentifier", "Counter32", "Gauge32", "Integer32", "ObjectIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spLicenseErrDescription=spLicenseErrDescription, spManagedObject=spManagedObject, spBlackholeNexthop=spBlackholeNexthop, spDNSObserved=spDNSObserved, spHijackLocal=spHijackLocal, spInterfaceSpeed=spInterfaceSpeed, spAlertID=spAlertID, spFingerprintSender=spFingerprintSender, spBGPTrapEvent=spBGPTrapEvent, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dosNetworkProfiledAlert=dosNetworkProfiledAlert, interfaceUsageDone=interfaceUsageDone, spInetAddressType=spInetAddressType, spThirdPartyZone=spThirdPartyZone, flowDown=flowDown, spUsageType=spUsageType, interfaceUsage=interfaceUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHijackRoute=spHijackRoute, spFlowspecCommunity=spFlowspecCommunity, spTMSPrefix=spTMSPrefix, spDNSObservedMax=spDNSObservedMax, spTMSMultiPrefix=spTMSMultiPrefix, spApplicationName=spApplicationName, configChange=configChange, greDown=greDown, licenseError=licenseError, spcommFailureDone=spcommFailureDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spUnit=spUnit, spImpactBps=spImpactBps, peakflowSPCMI=peakflowSPCMI, notificationLimit=notificationLimit, peakflowSPMIB=peakflowSPMIB, deviceTotalFlows=deviceTotalFlows, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterfaceUsage=spInterfaceUsage, spManagedObjects=spManagedObjects, dnsBaseline=dnsBaseline, hardwareFailureDone=hardwareFailureDone, alertScript=alertScript, routingFailover=routingFailover, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapPrefix=spBGPTrapPrefix, spVersion=spVersion, spServiceElement=spServiceElement, spMitigationID=spMitigationID, mitigationDone=mitigationDone, mitigationFlowspecStart=mitigationFlowspecStart, licenseErrorDone=licenseErrorDone, spUsage=spUsage, spBGPInstability=spBGPInstability, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spCollector=spCollector, spTMSCommunity=spTMSCommunity, fingerprintUsageDone=fingerprintUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spReportID=spReportID, spDetectedCountries=spDetectedCountries, collectorStart=collectorStart, spReportName=spReportName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spCommFailureDescription=spCommFailureDescription, spFingerprintMessage=spFingerprintMessage, spBGPTrapName=spBGPTrapName, snmpDown=snmpDown, spInterface=spInterface, spInterfaceIndex=spInterfaceIndex, flowUp=flowUp, serviceUsage=serviceUsage, spDNSObservedMean=spDNSObservedMean, spThirdPartyAddr=spThirdPartyAddr, hardwareFailure=hardwareFailure, spRouter=spRouter, collectorUp=collectorUp, dosHostDetectionAlert=dosHostDetectionAlert, deviceDiskUsage=deviceDiskUsage, spImpactPps=spImpactPps, spDNSExpected=spDNSExpected, spScriptCommand=spScriptCommand, spCloudSignalFaultDescription=spCloudSignalFaultDescription, managedObjectUsage=managedObjectUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spGreTunnelName=spGreTunnelName, devicePhysicalMemory=devicePhysicalMemory, spInterfaceUsageHC=spInterfaceUsageHC, spSystemErrorType=spSystemErrorType, spBlackholeCommunity=spBlackholeCommunity, spScriptPort=spScriptPort, deviceSystemErrorDone=deviceSystemErrorDone, bgpDown=bgpDown, managedObjectUsageDone=managedObjectUsageDone, spLicenseErrLimit=spLicenseErrLimit, bgpUp=bgpUp, spDetector=spDetector, mitigationBlackholeStart=mitigationBlackholeStart, bgpInstability=bgpInstability, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailure=spcommFailure, spInetAddress=spInetAddress, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationTMSStartV2=mitigationTMSStartV2, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spReportURL=spReportURL, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSwapSpace=deviceSwapSpace, peakflowSPTraps=peakflowSPTraps, spPravail=spPravail, spInterfaceSpeedHC=spInterfaceSpeedHC, spMitigationName=spMitigationName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeTimeout=spBlackholeTimeout, spBlackholePrefix=spBlackholePrefix, spThreshold=spThreshold, serviceUsageDone=serviceUsageDone, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHardwareFailureDescription=spHardwareFailureDescription, deviceSystemError=deviceSystemError, spScriptStart=spScriptStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spGreTunnelDestination=spGreTunnelDestination, spScriptHost=spScriptHost, collectorDown=collectorDown, dnsBaselineDone=dnsBaselineDone, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPMgr=peakflowSPMgr, bgpTrap=bgpTrap, cloudSignalingFault=cloudSignalingFault, spManagedObjectFamily=spManagedObjectFamily, spLicenseErrType=spLicenseErrType, fingerprintReceive=fingerprintReceive, spFingerprintName=spFingerprintName, bgpHijack=bgpHijack, spFingerprintFeedback=spFingerprintFeedback, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationTMSStart=mitigationTMSStart, spTMSTimeout=spTMSTimeout, greDownDone=greDownDone, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, bgpInstabilityDone=bgpInstabilityDone, spDuration=spDuration, spMitigationStart=spMitigationStart, fingerprintFeedback=fingerprintFeedback, spDNSName=spDNSName, spServiceName=spServiceName, deviceHealth=deviceHealth, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPEvent=spBGPEvent, fingerprintUsage=fingerprintUsage, trafficAutoMitigation=trafficAutoMitigation, autoclassifyStart=autoclassifyStart, reportDone=reportDone, spHijackAttr=spHijackAttr, spUsername=spUsername, spSystemErrorDescription=spSystemErrorDescription)
