...
IpAddress, MibIdentifier, NotificationType, Bits, iso, Unsigned32, Counter64, Gauge32, Counter32, ObjectIdentity, ModuleIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "NotificationType", "Bits", "iso", "Unsigned32", "Counter64", "Gauge32", "Counter32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spTMSCommunity=spTMSCommunity, spBGPEvent=spBGPEvent, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDNSName=spDNSName, mitigationTMSStart=mitigationTMSStart, spInterfaceSpeed=spInterfaceSpeed, spDNSObserved=spDNSObserved, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceTotalFlowsHC=deviceTotalFlowsHC, spGreTunnelDestination=spGreTunnelDestination, hardwareFailure=hardwareFailure, spUnit=spUnit, spBlackholePrefix=spBlackholePrefix, spDetectedCountries=spDetectedCountries, bgpInstabilityDone=bgpInstabilityDone, bgpInstability=bgpInstability, fingerprintUsageDone=fingerprintUsageDone, spFingerprintSender=spFingerprintSender, collectorDown=collectorDown, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrType=spLicenseErrType, spInterfaceUsageHC=spInterfaceUsageHC, collectorStart=collectorStart, deviceSystemError=deviceSystemError, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeNexthop=spBlackholeNexthop, autoclassifyStart=autoclassifyStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dnsBaseline=dnsBaseline, spVersion=spVersion, spImpactPps=spImpactPps, spAlertID=spAlertID, spInterfaceIndex=spInterfaceIndex, greDown=greDown, licenseErrorDone=licenseErrorDone, spHijackAttr=spHijackAttr, fingerprintFeedback=fingerprintFeedback, spFingerprintMessage=spFingerprintMessage, alertScript=alertScript, mitigationTMSStartV2=mitigationTMSStartV2, spSystemErrorDescription=spSystemErrorDescription, spManagedObjects=spManagedObjects, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, mitigationThirdPartyStart=mitigationThirdPartyStart, greDownDone=greDownDone, spSystemErrorType=spSystemErrorType, spPravail=spPravail, cloudSignalingFault=cloudSignalingFault, spCloudSignalFaultDescription=spCloudSignalFaultDescription, managedObjectUsageDone=managedObjectUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, snmpUp=snmpUp, fingerprintReceive=fingerprintReceive, spScriptPort=spScriptPort, spScriptCommand=spScriptCommand, spcommFailure=spcommFailure, bgpUp=bgpUp, spTMSPrefix=spTMSPrefix, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeedHC=spInterfaceSpeedHC, configChange=configChange, spReportURL=spReportURL, dosHostDetectionAlertDone=dosHostDetectionAlertDone, dosHostDetectionAlert=dosHostDetectionAlert, spUsername=spUsername, spFlowspecTimeout=spFlowspecTimeout, fingerprintUsage=fingerprintUsage, spMitigationStart=spMitigationStart, spHijackRoute=spHijackRoute, spInetAddress=spInetAddress, collectorUp=collectorUp, spManagedObject=spManagedObject, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptHost=spScriptHost, spBGPTrapEvent=spBGPTrapEvent, bgpTrap=bgpTrap, hardwareFailureDone=hardwareFailureDone, spTMSTimeout=spTMSTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, interfaceUsage=interfaceUsage, spHijackLocal=spHijackLocal, mitigationDone=mitigationDone, spUsage=spUsage, spBlackholeTimeout=spBlackholeTimeout, peakflowSPMgr=peakflowSPMgr, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDNSExpected=spDNSExpected, bgpDown=bgpDown, spLicenseErrCount=spLicenseErrCount, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, spScriptStart=spScriptStart, spServiceName=spServiceName, spCommFailureDestination=spCommFailureDestination, spInetAddressType=spInetAddressType, cloudSignalingFaultDone=cloudSignalingFaultDone, interfaceUsageDone=interfaceUsageDone, spReportName=spReportName, spBGPInstability=spBGPInstability, spBGPTrapName=spBGPTrapName, spFingerprintName=spFingerprintName, spInterface=spInterface, notificationLimit=notificationLimit, spHardwareFailureDescription=spHardwareFailureDescription, spReportID=spReportID, spServiceElement=spServiceElement, spDetector=spDetector, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, snmpDown=snmpDown, managedObjectUsage=managedObjectUsage, licenseError=licenseError, deviceSwapSpace=deviceSwapSpace, spLicenseErrDescription=spLicenseErrDescription, spApplicationName=spApplicationName, mitigationBlackholeStart=mitigationBlackholeStart, deviceHealth=deviceHealth, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPTraps=peakflowSPTraps, mitigationFlowspecStart=mitigationFlowspecStart, spThreshold=spThreshold, spLicenseErrLimit=spLicenseErrLimit, spMitigationName=spMitigationName, spUsageType=spUsageType, spManagedObjectFamily=spManagedObjectFamily, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spGreTunnelName=spGreTunnelName, spFlowspecCommunity=spFlowspecCommunity, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlows=deviceTotalFlows, peakflowSPMIB=peakflowSPMIB, trafficAutoMitigation=trafficAutoMitigation, spInterfaceUsage=spInterfaceUsage, deviceDiskUsage=deviceDiskUsage, spMitigationID=spMitigationID, spcommFailureDone=spcommFailureDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCommFailureDescription=spCommFailureDescription, spDNSObservedMax=spDNSObservedMax, spDNSObservedMean=spDNSObservedMean, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dnsBaselineDone=dnsBaselineDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDuration=spDuration, spImpactBps=spImpactBps, spRouter=spRouter, flowUp=flowUp, reportDone=reportDone, bgpHijack=bgpHijack, serviceUsageDone=serviceUsageDone, routingFailover=routingFailover, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiPrefix=spTMSMultiPrefix, flowDown=flowDown, serviceUsage=serviceUsage, peakflowSPCMI=peakflowSPCMI, deviceSwapSpaceUsage=deviceSwapSpaceUsage)
