...
# Produced by pysmi-1.1.8 at Mon Feb  7 15:44:39 2022
...
ModuleIdentity, TimeTicks, NotificationType, Bits, Unsigned32, IpAddress, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "NotificationType", "Bits", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, spLicenseErrCount=spLicenseErrCount, mitigationTMSStartV2=mitigationTMSStartV2, deviceHealth=deviceHealth, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemory=devicePhysicalMemory, serviceUsage=serviceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPInstability=spBGPInstability, spImpactBps=spImpactBps, spInetAddressType=spInetAddressType, spMitigationName=spMitigationName, routingFailover=routingFailover, greDown=greDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceUsage=spInterfaceUsage, spManagedObjectFamily=spManagedObjectFamily, spHijackRoute=spHijackRoute, spcommFailureDone=spcommFailureDone, spTMSMultiPrefix=spTMSMultiPrefix, autoclassifyStart=autoclassifyStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spImpactPps=spImpactPps, bgpTrap=bgpTrap, mitigationThirdPartyStart=mitigationThirdPartyStart, spUsage=spUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spMitigationStart=spMitigationStart, spDNSName=spDNSName, spReportName=spReportName, spBlackholePrefix=spBlackholePrefix, spDuration=spDuration, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCommFailureDestination=spCommFailureDestination, spInterfaceUsageHC=spInterfaceUsageHC, spUsername=spUsername, PYSNMP_MODULE_ID=peakflowSPMIB, spLicenseErrType=spLicenseErrType, hardwareFailure=hardwareFailure, spDNSObservedMax=spDNSObservedMax, spMitigationID=spMitigationID, spInetAddress=spInetAddress, spPravail=spPravail, spServiceElement=spServiceElement, deviceSystemError=deviceSystemError, spVersion=spVersion, managedObjectUsage=managedObjectUsage, configChange=configChange, spFlowspecTimeout=spFlowspecTimeout, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spApplicationName=spApplicationName, collectorStart=collectorStart, spCollector=spCollector, deviceTotalFlowsHC=deviceTotalFlowsHC, peakflowSPMIB=peakflowSPMIB, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPCMI=peakflowSPCMI, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, reportDone=reportDone, greDownDone=greDownDone, spScriptHost=spScriptHost, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spFingerprintMessage=spFingerprintMessage, fingerprintUsage=fingerprintUsage, bgpInstability=bgpInstability, spTMSCommunity=spTMSCommunity, spGreTunnelDestination=spGreTunnelDestination, collectorUp=collectorUp, spScriptPort=spScriptPort, spServiceName=spServiceName, fingerprintFeedback=fingerprintFeedback, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThirdPartyZone=spThirdPartyZone, bgpInstabilityDone=bgpInstabilityDone, notificationLimit=notificationLimit, cloudSignalingFault=cloudSignalingFault, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spcommFailure=spcommFailure, spFingerprintName=spFingerprintName, bgpUp=bgpUp, spThreshold=spThreshold, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceSpeed=spInterfaceSpeed, dosHostDetectionAlertDone=dosHostDetectionAlertDone, interfaceUsage=interfaceUsage, spBGPTrapName=spBGPTrapName, fingerprintReceive=fingerprintReceive, serviceUsageDone=serviceUsageDone, bgpDown=bgpDown, snmpUp=snmpUp, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrDescription=spLicenseErrDescription, mitigationBlackholeStart=mitigationBlackholeStart, fingerprintUsageDone=fingerprintUsageDone, hardwareFailureDone=hardwareFailureDone, alertScript=alertScript, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHijackAttr=spHijackAttr, collectorDown=collectorDown, spHijackLocal=spHijackLocal, spInterface=spInterface, licenseErrorDone=licenseErrorDone, spFingerprintSender=spFingerprintSender, spManagedObject=spManagedObject, spTMSTimeout=spTMSTimeout, spReportID=spReportID, snmpDown=snmpDown, spUnit=spUnit, cloudSignalingFaultDone=cloudSignalingFaultDone, dnsBaselineDone=dnsBaselineDone, spScriptStart=spScriptStart, spDNSObserved=spDNSObserved, spManagedObjects=spManagedObjects, spLicenseErrLimit=spLicenseErrLimit, spBlackholeNexthop=spBlackholeNexthop, interfaceUsageDone=interfaceUsageDone, licenseError=licenseError, managedObjectUsageDone=managedObjectUsageDone, spRouter=spRouter, spUsageType=spUsageType, deviceSwapSpace=deviceSwapSpace, spThirdPartyAddr=spThirdPartyAddr, spScriptCommand=spScriptCommand, spSystemErrorType=spSystemErrorType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDNSObservedMean=spDNSObservedMean, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapEvent=spBGPTrapEvent, dnsBaseline=dnsBaseline, spBlackholeCommunity=spBlackholeCommunity, deviceTotalFlows=deviceTotalFlows, flowUp=flowUp, spGreTunnelName=spGreTunnelName, spInterfaceSpeedHC=spInterfaceSpeedHC, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPMgr=peakflowSPMgr, spInterfaceIndex=spInterfaceIndex, spTMSPrefix=spTMSPrefix, spReportURL=spReportURL, spSystemErrorDescription=spSystemErrorDescription, spBGPEvent=spBGPEvent, flowDown=flowDown, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPTraps=peakflowSPTraps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDetector=spDetector, mitigationDone=mitigationDone, mitigationFlowspecStart=mitigationFlowspecStart, spDetectedCountries=spDetectedCountries, spDNSExpected=spDNSExpected, spAlertID=spAlertID, bgpHijack=bgpHijack, spFlowspecCommunity=spFlowspecCommunity, deviceDiskUsage=deviceDiskUsage, mitigationTMSStart=mitigationTMSStart)
