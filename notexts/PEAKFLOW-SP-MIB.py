...
# Produced by pysmi-1.1.12 at Thu Sep 26 02:10:17 2024
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Counter64, Bits, ObjectIdentity, Unsigned32, IpAddress, Counter32, TimeTicks, Integer32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Counter64", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "TimeTicks", "Integer32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spServiceName=spServiceName, spBGPEvent=spBGPEvent, spServiceElement=spServiceElement, spScriptStart=spScriptStart, spInterfaceUsageHC=spInterfaceUsageHC, snmpDown=snmpDown, peakflowSPCMI=peakflowSPCMI, managedObjectUsage=managedObjectUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spcommFailureDone=spcommFailureDone, fingerprintUsage=fingerprintUsage, fingerprintUsageDone=fingerprintUsageDone, mitigationTMSStartV2=mitigationTMSStartV2, spMitigationID=spMitigationID, spDNSObserved=spDNSObserved, spHijackRoute=spHijackRoute, spThirdPartyAddr=spThirdPartyAddr, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpTrap=bgpTrap, spVersion=spVersion, spLicenseErrLimit=spLicenseErrLimit, spCloudSignalFaultDescription=spCloudSignalFaultDescription, peakflowSPTraps=peakflowSPTraps, spMitigationStart=spMitigationStart, spLicenseErrType=spLicenseErrType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSystemErrorDone=deviceSystemErrorDone, routingFailover=routingFailover, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportID=spReportID, spHijackAttr=spHijackAttr, spManagedObjectFamily=spManagedObjectFamily, bgpHijack=bgpHijack, spApplicationName=spApplicationName, notificationLimit=notificationLimit, spImpactBps=spImpactBps, spDNSObservedMean=spDNSObservedMean, bgpInstability=bgpInstability, spDuration=spDuration, deviceDiskUsage=deviceDiskUsage, flowDown=flowDown, spInterfaceUsage=spInterfaceUsage, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemory=devicePhysicalMemory, managedObjectUsageDone=managedObjectUsageDone, spScriptHost=spScriptHost, spSystemErrorType=spSystemErrorType, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, flowUp=flowUp, spCollector=spCollector, spDNSExpected=spDNSExpected, peakflowSPMgr=peakflowSPMgr, peakflowSPMIB=peakflowSPMIB, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorStart=collectorStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstabilityDone=bgpInstabilityDone, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, greDownDone=greDownDone, spImpactPps=spImpactPps, spBGPTrapEvent=spBGPTrapEvent, spFlowspecTimeout=spFlowspecTimeout, mitigationTMSStart=mitigationTMSStart, fingerprintReceive=fingerprintReceive, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceIndex=spInterfaceIndex, spSystemErrorDescription=spSystemErrorDescription, reportDone=reportDone, serviceUsage=serviceUsage, spUnit=spUnit, mitigationDone=mitigationDone, spBlackholePrefix=spBlackholePrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spAlertID=spAlertID, alertScript=alertScript, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spThreshold=spThreshold, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dnsBaseline=dnsBaseline, deviceTotalFlows=deviceTotalFlows, spManagedObject=spManagedObject, spTMSMultiPrefix=spTMSMultiPrefix, mitigationFlowspecStart=mitigationFlowspecStart, spTMSCommunity=spTMSCommunity, spDetector=spDetector, spDNSObservedMax=spDNSObservedMax, spCommFailureDescription=spCommFailureDescription, spPravail=spPravail, spInterface=spInterface, spUsername=spUsername, collectorDown=collectorDown, spGreTunnelName=spGreTunnelName, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, trafficAutoMitigation=trafficAutoMitigation, serviceUsageDone=serviceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseErrorDone=licenseErrorDone, mitigationThirdPartyStart=mitigationThirdPartyStart, bgpUp=bgpUp, deviceSystemError=deviceSystemError, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spThirdPartyZone=spThirdPartyZone, spHijackLocal=spHijackLocal, interfaceUsageDone=interfaceUsageDone, snmpUp=snmpUp, autoclassifyStart=autoclassifyStart, spTMSTimeout=spTMSTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, collectorUp=collectorUp, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeCommunity=spBlackholeCommunity, spUsageType=spUsageType, spBlackholeNexthop=spBlackholeNexthop, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFingerprintSender=spFingerprintSender, deviceHealth=deviceHealth, spTMSPrefix=spTMSPrefix, bgpDown=bgpDown, interfaceUsage=interfaceUsage, cloudSignalingFault=cloudSignalingFault, mitigationBlackholeStart=mitigationBlackholeStart, spBlackholeTimeout=spBlackholeTimeout, spInetAddressType=spInetAddressType, dosHostDetectionAlert=dosHostDetectionAlert, spReportURL=spReportURL, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintFeedback=fingerprintFeedback, spDNSName=spDNSName, spGreTunnelDestination=spGreTunnelDestination, greDown=greDown, spMitigationName=spMitigationName, spDetectedCountries=spDetectedCountries, spLicenseErrCount=spLicenseErrCount, spBGPInstability=spBGPInstability, configChange=configChange, spRouter=spRouter, spUsage=spUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapName=spBGPTrapName, spInetAddress=spInetAddress, spBGPTrapPrefix=spBGPTrapPrefix, spManagedObjects=spManagedObjects, deviceSwapSpace=deviceSwapSpace, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spcommFailure=spcommFailure, dnsBaselineDone=dnsBaselineDone, spFlowspecCommunity=spFlowspecCommunity, hardwareFailure=hardwareFailure, spLicenseErrDescription=spLicenseErrDescription, hardwareFailureDone=hardwareFailureDone, spReportName=spReportName, spScriptPort=spScriptPort, licenseError=licenseError, spFingerprintMessage=spFingerprintMessage, spFingerprintFeedback=spFingerprintFeedback, spFingerprintName=spFingerprintName, spScriptCommand=spScriptCommand, spHardwareFailureDescription=spHardwareFailureDescription)
