...
ObjectIdentity, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, TimeTicks, Counter64, Gauge32, Integer32, Bits, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "Gauge32", "Integer32", "Bits", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", routingFailover=routingFailover, spManagedObject=spManagedObject, spRouter=spRouter, spTMSMultiPrefix=spTMSMultiPrefix, notificationLimit=notificationLimit, spReportURL=spReportURL, deviceSwapSpace=deviceSwapSpace, spLicenseErrCount=spLicenseErrCount, spFingerprintSender=spFingerprintSender, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spScriptStart=spScriptStart, spLicenseErrLimit=spLicenseErrLimit, spImpactBps=spImpactBps, spInterface=spInterface, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spUsername=spUsername, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyZone=spThirdPartyZone, spVersion=spVersion, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceDiskUsage=deviceDiskUsage, fingerprintReceive=fingerprintReceive, trafficAutoMitigation=trafficAutoMitigation, configChange=configChange, spInetAddress=spInetAddress, snmpUp=snmpUp, spHijackLocal=spHijackLocal, hardwareFailureDone=hardwareFailureDone, serviceUsageDone=serviceUsageDone, spDNSObserved=spDNSObserved, spInterfaceUsageHC=spInterfaceUsageHC, deviceHealth=deviceHealth, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spFingerprintName=spFingerprintName, spInterfaceSpeed=spInterfaceSpeed, spManagedObjectFamily=spManagedObjectFamily, spMitigationName=spMitigationName, spDuration=spDuration, spTMSCommunity=spTMSCommunity, bgpTrap=bgpTrap, peakflowSPMIB=peakflowSPMIB, bgpUp=bgpUp, flowUp=flowUp, mitigationDone=mitigationDone, spPravail=spPravail, fingerprintUsage=fingerprintUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPEvent=spBGPEvent, spInterfaceUsage=spInterfaceUsage, spBlackholePrefix=spBlackholePrefix, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spAlertDetectionSignatures=spAlertDetectionSignatures, spThreshold=spThreshold, spFingerprintMessage=spFingerprintMessage, spTMSPrefix=spTMSPrefix, bgpHijack=bgpHijack, flowDown=flowDown, spInterfaceSpeedHC=spInterfaceSpeedHC, licenseError=licenseError, spHijackRoute=spHijackRoute, deviceSystemErrorDone=deviceSystemErrorDone, bgpInstability=bgpInstability, spCommFailureDescription=spCommFailureDescription, spServiceElement=spServiceElement, reportDone=reportDone, collectorUp=collectorUp, spUsageType=spUsageType, dosHostDetectionAlert=dosHostDetectionAlert, spApplicationName=spApplicationName, spFlowspecTimeout=spFlowspecTimeout, alertScript=alertScript, spServiceName=spServiceName, cloudSignalingFault=cloudSignalingFault, mitigationThirdPartyStart=mitigationThirdPartyStart, spBlackholeCommunity=spBlackholeCommunity, spHijackAttr=spHijackAttr, interfaceUsage=interfaceUsage, collectorDown=collectorDown, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBGPInstability=spBGPInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceTotalFlows=deviceTotalFlows, spAlertID=spAlertID, cloudSignalingFaultDone=cloudSignalingFaultDone, spLicenseErrDescription=spLicenseErrDescription, spUsage=spUsage, spReportName=spReportName, spUnit=spUnit, spScriptCommand=spScriptCommand, spInetAddressType=spInetAddressType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spMitigationID=spMitigationID, spScriptPort=spScriptPort, spcommFailure=spcommFailure, spcommFailureDone=spcommFailureDone, serviceUsage=serviceUsage, spDetectedCountries=spDetectedCountries, interfaceUsageDone=interfaceUsageDone, spManagedObjects=spManagedObjects, bgpDown=bgpDown, fingerprintUsageDone=fingerprintUsageDone, spImpactPps=spImpactPps, spReportID=spReportID, spBlackholeTimeout=spBlackholeTimeout, spLicenseErrType=spLicenseErrType, spTMSTimeout=spTMSTimeout, spSystemErrorDescription=spSystemErrorDescription, spDNSExpected=spDNSExpected, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemory=devicePhysicalMemory, bgpInstabilityDone=bgpInstabilityDone, spHardwareFailureDescription=spHardwareFailureDescription, dnsBaselineDone=dnsBaselineDone, spSystemErrorType=spSystemErrorType, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBGPTrapName=spBGPTrapName, spScriptHost=spScriptHost, spCloudSignalFaultDescription=spCloudSignalFaultDescription, greDownDone=greDownDone, PYSNMP_MODULE_ID=peakflowSPMIB, autoclassifyStart=autoclassifyStart, mitigationFlowspecStart=mitigationFlowspecStart, deviceSystemError=deviceSystemError, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, hardwareFailure=hardwareFailure, spDNSObservedMax=spDNSObservedMax, spBGPTrapEvent=spBGPTrapEvent, spCollector=spCollector, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapPrefix=spBGPTrapPrefix, greDown=greDown, mitigationTMSStart=mitigationTMSStart, spGreTunnelName=spGreTunnelName, snmpDown=snmpDown, spFlowspecCommunity=spFlowspecCommunity, peakflowSPCMI=peakflowSPCMI, licenseErrorDone=licenseErrorDone, managedObjectUsage=managedObjectUsage, spDNSName=spDNSName, spBlackholeNexthop=spBlackholeNexthop, managedObjectUsageDone=managedObjectUsageDone, spMitigationStart=spMitigationStart, peakflowSPTraps=peakflowSPTraps, spDNSObservedMean=spDNSObservedMean, spDetector=spDetector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, fingerprintFeedback=fingerprintFeedback, spFingerprintFeedback=spFingerprintFeedback, collectorStart=collectorStart, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, peakflowSPMgr=peakflowSPMgr, dnsBaseline=dnsBaseline, spInterfaceIndex=spInterfaceIndex, spThirdPartyAddr=spThirdPartyAddr, spCommFailureDestination=spCommFailureDestination, spGreTunnelDestination=spGreTunnelDestination, mitigationBlackholeStart=mitigationBlackholeStart)
