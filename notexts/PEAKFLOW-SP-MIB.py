...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:01:40 2021
...
MibIdentifier, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, iso, Counter32, Integer32, Bits, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "iso", "Counter32", "Integer32", "Bits", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationTMSStart=mitigationTMSStart, peakflowSPTraps=peakflowSPTraps, spDuration=spDuration, spInterfaceSpeed=spInterfaceSpeed, deviceSwapSpaceUsage=deviceSwapSpaceUsage, flowUp=flowUp, fingerprintUsageDone=fingerprintUsageDone, mitigationFlowspecStart=mitigationFlowspecStart, spUsage=spUsage, collectorStart=collectorStart, spScriptHost=spScriptHost, peakflowSPMgr=peakflowSPMgr, spServiceName=spServiceName, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceUsage=spInterfaceUsage, spManagedObjectFamily=spManagedObjectFamily, spFingerprintFeedback=spFingerprintFeedback, collectorUp=collectorUp, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObject=spManagedObject, spUsername=spUsername, snmpUp=snmpUp, spBlackholePrefix=spBlackholePrefix, spDetectedCountries=spDetectedCountries, spCommFailureDestination=spCommFailureDestination, deviceHealth=deviceHealth, spDNSName=spDNSName, bgpTrap=bgpTrap, spHijackAttr=spHijackAttr, hardwareFailure=hardwareFailure, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spLicenseErrDescription=spLicenseErrDescription, spInetAddress=spInetAddress, spDetector=spDetector, trafficAutoMitigation=trafficAutoMitigation, fingerprintUsage=fingerprintUsage, bgpHijack=bgpHijack, spInterface=spInterface, cloudSignalingFault=cloudSignalingFault, spReportID=spReportID, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationID=spMitigationID, spRouter=spRouter, spGreTunnelDestination=spGreTunnelDestination, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spScriptCommand=spScriptCommand, spScriptStart=spScriptStart, alertScript=alertScript, spLicenseErrType=spLicenseErrType, spThreshold=spThreshold, spcommFailureDone=spcommFailureDone, spFlowspecTimeout=spFlowspecTimeout, interfaceUsageDone=interfaceUsageDone, spInetAddressType=spInetAddressType, hardwareFailureDone=hardwareFailureDone, interfaceUsage=interfaceUsage, spPravail=spPravail, spFingerprintName=spFingerprintName, mitigationBlackholeStart=mitigationBlackholeStart, spHijackRoute=spHijackRoute, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spMitigationName=spMitigationName, spDNSObservedMean=spDNSObservedMean, spServiceElement=spServiceElement, serviceUsage=serviceUsage, autoclassifyStart=autoclassifyStart, greDownDone=greDownDone, spImpactPps=spImpactPps, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlowsHC=deviceTotalFlowsHC, spCollector=spCollector, spReportURL=spReportURL, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosHostDetectionAlert=dosHostDetectionAlert, flowDown=flowDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, configChange=configChange, managedObjectUsageDone=managedObjectUsageDone, deviceSwapSpace=deviceSwapSpace, peakflowSPCMI=peakflowSPCMI, spcommFailure=spcommFailure, routingFailover=routingFailover, fingerprintReceive=fingerprintReceive, mitigationTMSStartV2=mitigationTMSStartV2, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceIndex=spInterfaceIndex, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDNSExpected=spDNSExpected, bgpInstability=bgpInstability, deviceTotalFlows=deviceTotalFlows, spBGPTrapEvent=spBGPTrapEvent, spUnit=spUnit, bgpDown=bgpDown, managedObjectUsage=managedObjectUsage, deviceSystemError=deviceSystemError, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPEvent=spBGPEvent, dosHostDetectionAlertDone=dosHostDetectionAlertDone, fingerprintFeedback=fingerprintFeedback, peakflowSPMIB=peakflowSPMIB, collectorDown=collectorDown, spThirdPartyAddr=spThirdPartyAddr, spVersion=spVersion, spScriptPort=spScriptPort, snmpDown=snmpDown, spTMSPrefix=spTMSPrefix, spMitigationStart=spMitigationStart, spAlertID=spAlertID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spSystemErrorType=spSystemErrorType, reportDone=reportDone, greDown=greDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, serviceUsageDone=serviceUsageDone, spInterfaceUsageHC=spInterfaceUsageHC, spBGPTrapName=spBGPTrapName, spReportName=spReportName, dnsBaselineDone=dnsBaselineDone, spLicenseErrLimit=spLicenseErrLimit, spTMSTimeout=spTMSTimeout, deviceDiskUsage=deviceDiskUsage, spBGPTrapPrefix=spBGPTrapPrefix, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spApplicationName=spApplicationName, spGreTunnelName=spGreTunnelName, notificationLimit=notificationLimit, spDNSObserved=spDNSObserved, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBlackholeNexthop=spBlackholeNexthop, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, spImpactBps=spImpactBps, spDNSObservedMax=spDNSObservedMax, spInterfaceSpeedHC=spInterfaceSpeedHC, spHardwareFailureDescription=spHardwareFailureDescription, spManagedObjects=spManagedObjects, mitigationDone=mitigationDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spFlowspecCommunity=spFlowspecCommunity, dnsBaseline=dnsBaseline, spHijackLocal=spHijackLocal, bgpUp=bgpUp, spLicenseErrCount=spLicenseErrCount, spFingerprintSender=spFingerprintSender, licenseError=licenseError, spBGPInstability=spBGPInstability, spTMSCommunity=spTMSCommunity, spThirdPartyZone=spThirdPartyZone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBlackholeCommunity=spBlackholeCommunity, licenseErrorDone=licenseErrorDone, spBlackholeTimeout=spBlackholeTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, bgpInstabilityDone=bgpInstabilityDone, deviceSystemErrorDone=deviceSystemErrorDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCommFailureDescription=spCommFailureDescription)
