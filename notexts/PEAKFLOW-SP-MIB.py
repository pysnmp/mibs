...
MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, iso, Counter64, TimeTicks, Unsigned32, IpAddress, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "iso", "Counter64", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spScriptHost=spScriptHost, spBlackholePrefix=spBlackholePrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceSwapSpaceInUse=deviceSwapSpaceInUse, flowUp=flowUp, greDownDone=greDownDone, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, spDNSName=spDNSName, spTMSPrefix=spTMSPrefix, spMitigationID=spMitigationID, snmpDown=snmpDown, deviceTotalFlows=deviceTotalFlows, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterfaceUsageHC=spInterfaceUsageHC, snmpUp=snmpUp, mitigationTMSStart=mitigationTMSStart, alertScript=alertScript, spScriptPort=spScriptPort, spImpactPps=spImpactPps, autoclassifyStart=autoclassifyStart, spReportID=spReportID, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceUsage=spInterfaceUsage, spThirdPartyZone=spThirdPartyZone, dnsBaseline=dnsBaseline, deviceSystemError=deviceSystemError, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spManagedObjects=spManagedObjects, spDuration=spDuration, spSystemErrorType=spSystemErrorType, licenseErrorDone=licenseErrorDone, spServiceElement=spServiceElement, spVersion=spVersion, spFingerprintMessage=spFingerprintMessage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceHealth=deviceHealth, interfaceUsage=interfaceUsage, bgpHijack=bgpHijack, fingerprintFeedback=fingerprintFeedback, spThreshold=spThreshold, spLicenseErrCount=spLicenseErrCount, spScriptCommand=spScriptCommand, spTMSMultiPrefix=spTMSMultiPrefix, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spCommFailureDescription=spCommFailureDescription, bgpTrap=bgpTrap, spLicenseErrDescription=spLicenseErrDescription, spApplicationName=spApplicationName, spBlackholeNexthop=spBlackholeNexthop, spInetAddressType=spInetAddressType, serviceUsageDone=serviceUsageDone, spMitigationStart=spMitigationStart, spThirdPartyAddr=spThirdPartyAddr, serviceUsage=serviceUsage, spHijackRoute=spHijackRoute, managedObjectUsageDone=managedObjectUsageDone, fingerprintUsageDone=fingerprintUsageDone, spDNSObservedMax=spDNSObservedMax, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceSystemErrorDone=deviceSystemErrorDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spcommFailure=spcommFailure, flowDown=flowDown, spCollector=spCollector, spGreTunnelDestination=spGreTunnelDestination, spBGPInstability=spBGPInstability, spHijackAttr=spHijackAttr, peakflowSPMgr=peakflowSPMgr, spReportName=spReportName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpUp=bgpUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spServiceName=spServiceName, hardwareFailure=hardwareFailure, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spAlertID=spAlertID, spSystemErrorDescription=spSystemErrorDescription, spUnit=spUnit, hardwareFailureDone=hardwareFailureDone, spFlowspecCommunity=spFlowspecCommunity, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPTrapPrefix=spBGPTrapPrefix, PYSNMP_MODULE_ID=peakflowSPMIB, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpInstability=bgpInstability, collectorUp=collectorUp, spDNSExpected=spDNSExpected, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spcommFailureDone=spcommFailureDone, peakflowSPCMI=peakflowSPCMI, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportURL=spReportURL, interfaceUsageDone=interfaceUsageDone, peakflowSPTraps=peakflowSPTraps, spDNSObservedMean=spDNSObservedMean, spDetector=spDetector, mitigationDone=mitigationDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationBlackholeStart=mitigationBlackholeStart, fingerprintUsage=fingerprintUsage, spInterfaceIndex=spInterfaceIndex, cloudSignalingFault=cloudSignalingFault, spTMSCommunity=spTMSCommunity, spImpactBps=spImpactBps, fingerprintReceive=fingerprintReceive, spHardwareFailureDescription=spHardwareFailureDescription, licenseError=licenseError, spDetectedCountries=spDetectedCountries, spManagedObject=spManagedObject, configChange=configChange, mitigationFlowspecStart=mitigationFlowspecStart, spTMSTimeout=spTMSTimeout, peakflowSPMIB=peakflowSPMIB, spManagedObjectFamily=spManagedObjectFamily, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailover=routingFailover, spScriptStart=spScriptStart, spRouter=spRouter, spUsage=spUsage, notificationLimit=notificationLimit, trafficAutoMitigation=trafficAutoMitigation, deviceDiskUsage=deviceDiskUsage, spDNSObserved=spDNSObserved, spInetAddress=spInetAddress, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapName=spBGPTrapName, devicePhysicalMemory=devicePhysicalMemory, collectorStart=collectorStart, spUsername=spUsername, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpInstabilityDone=bgpInstabilityDone, spLicenseErrType=spLicenseErrType, greDown=greDown, spCommFailureDestination=spCommFailureDestination, dnsBaselineDone=dnsBaselineDone, spInterface=spInterface, spFingerprintName=spFingerprintName, spGreTunnelName=spGreTunnelName, spBlackholeCommunity=spBlackholeCommunity, spHijackLocal=spHijackLocal, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecTimeout=spFlowspecTimeout, mitigationThirdPartyStart=mitigationThirdPartyStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, reportDone=reportDone, spInterfaceSpeed=spInterfaceSpeed, collectorDown=collectorDown, spPravail=spPravail, managedObjectUsage=managedObjectUsage, bgpDown=bgpDown, spBGPEvent=spBGPEvent, spMitigationName=spMitigationName, spFingerprintSender=spFingerprintSender, dosHostDetectionAlert=dosHostDetectionAlert, deviceSwapSpace=deviceSwapSpace, mitigationTMSStartV2=mitigationTMSStartV2, spLicenseErrLimit=spLicenseErrLimit)
