...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:07:43 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, IpAddress, Integer32, ModuleIdentity, Gauge32, NotificationType, Bits, Counter64, TimeTicks, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "NotificationType", "Bits", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, spInterfaceUsageHC=spInterfaceUsageHC, spHijackRoute=spHijackRoute, fingerprintUsage=fingerprintUsage, spFingerprintMessage=spFingerprintMessage, spSystemErrorType=spSystemErrorType, spFlowspecCommunity=spFlowspecCommunity, interfaceUsageDone=interfaceUsageDone, spThirdPartyAddr=spThirdPartyAddr, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPCMI=peakflowSPCMI, spGreTunnelDestination=spGreTunnelDestination, serviceUsage=serviceUsage, routingFailover=routingFailover, collectorDown=collectorDown, alertScript=alertScript, bgpDown=bgpDown, spInterfaceUsage=spInterfaceUsage, fingerprintFeedback=fingerprintFeedback, peakflowSPTraps=peakflowSPTraps, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spScriptCommand=spScriptCommand, spMitigationID=spMitigationID, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInetAddressType=spInetAddressType, spReportName=spReportName, dnsBaseline=dnsBaseline, spBlackholeNexthop=spBlackholeNexthop, greDown=greDown, spInterfaceIndex=spInterfaceIndex, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationFlowspecStart=mitigationFlowspecStart, deviceTotalFlowsHC=deviceTotalFlowsHC, flowDown=flowDown, spCommFailureDescription=spCommFailureDescription, spHijackLocal=spHijackLocal, deviceSwapSpace=deviceSwapSpace, collectorStart=collectorStart, spUsername=spUsername, spcommFailure=spcommFailure, mitigationBlackholeStart=mitigationBlackholeStart, PYSNMP_MODULE_ID=peakflowSPMIB, spReportID=spReportID, spUnit=spUnit, spMitigationName=spMitigationName, spDNSObserved=spDNSObserved, spScriptStart=spScriptStart, deviceHealth=deviceHealth, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFingerprintSender=spFingerprintSender, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spThreshold=spThreshold, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecTimeout=spFlowspecTimeout, spImpactBps=spImpactBps, mitigationDone=mitigationDone, spInetAddress=spInetAddress, flowUp=flowUp, spTMSPrefix=spTMSPrefix, spInterface=spInterface, spSystemErrorDescription=spSystemErrorDescription, deviceSystemErrorDone=deviceSystemErrorDone, spCollector=spCollector, spBGPTrapEvent=spBGPTrapEvent, spManagedObjectFamily=spManagedObjectFamily, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrType=spLicenseErrType, spScriptHost=spScriptHost, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dnsBaselineDone=dnsBaselineDone, spHardwareFailureDescription=spHardwareFailureDescription, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationTMSStart=mitigationTMSStart, spInterfaceSpeed=spInterfaceSpeed, spGreTunnelName=spGreTunnelName, devicePhysicalMemory=devicePhysicalMemory, spUsageType=spUsageType, spDNSObservedMax=spDNSObservedMax, spTMSCommunity=spTMSCommunity, spReportURL=spReportURL, spDNSExpected=spDNSExpected, cloudSignalingFaultDone=cloudSignalingFaultDone, bgpUp=bgpUp, spUsage=spUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBlackholeTimeout=spBlackholeTimeout, spAlertID=spAlertID, spServiceElement=spServiceElement, spImpactPps=spImpactPps, spBGPInstability=spBGPInstability, spVersion=spVersion, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlows=deviceTotalFlows, hardwareFailureDone=hardwareFailureDone, managedObjectUsage=managedObjectUsage, fingerprintReceive=fingerprintReceive, spServiceName=spServiceName, deviceSystemError=deviceSystemError, bgpInstability=bgpInstability, reportDone=reportDone, spFingerprintName=spFingerprintName, spDetectedCountries=spDetectedCountries, spMitigationStart=spMitigationStart, spBlackholePrefix=spBlackholePrefix, trafficAutoMitigation=trafficAutoMitigation, spManagedObject=spManagedObject, peakflowSPMgr=peakflowSPMgr, spThirdPartyZone=spThirdPartyZone, spPravail=spPravail, spDetector=spDetector, fingerprintUsageDone=fingerprintUsageDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, licenseError=licenseError, dosHostDetectionAlert=dosHostDetectionAlert, spApplicationName=spApplicationName, spTMSMultiPrefix=spTMSMultiPrefix, bgpTrap=bgpTrap, spScriptPort=spScriptPort, snmpDown=snmpDown, spCommFailureDestination=spCommFailureDestination, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrDescription=spLicenseErrDescription, spBGPEvent=spBGPEvent, spcommFailureDone=spcommFailureDone, collectorUp=collectorUp, spLicenseErrCount=spLicenseErrCount, managedObjectUsageDone=managedObjectUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjects=spManagedObjects, bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, mitigationTMSStartV2=mitigationTMSStartV2, hardwareFailure=hardwareFailure, spDNSName=spDNSName, spTMSTimeout=spTMSTimeout, peakflowSPMIB=peakflowSPMIB, snmpUp=snmpUp, notificationLimit=notificationLimit, spHijackAttr=spHijackAttr, spAlertDetectionSignatures=spAlertDetectionSignatures, greDownDone=greDownDone, spDNSObservedMean=spDNSObservedMean, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, interfaceUsage=interfaceUsage, licenseErrorDone=licenseErrorDone, spDuration=spDuration, deviceDiskUsage=deviceDiskUsage, autoclassifyStart=autoclassifyStart, spLicenseErrLimit=spLicenseErrLimit, spBGPTrapPrefix=spBGPTrapPrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeCommunity=spBlackholeCommunity, serviceUsageDone=serviceUsageDone, configChange=configChange)
