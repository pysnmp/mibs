...
# Produced by pysmi-1.1.12 at Tue May 28 12:03:09 2024
...
Gauge32, ObjectIdentity, NotificationType, TimeTicks, IpAddress, MibIdentifier, ModuleIdentity, Integer32, iso, Bits, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "ModuleIdentity", "Integer32", "iso", "Bits", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceUsage=spInterfaceUsage, spCommFailureDescription=spCommFailureDescription, collectorDown=collectorDown, peakflowSPCMI=peakflowSPCMI, dnsBaseline=dnsBaseline, notificationLimit=notificationLimit, spInetAddressType=spInetAddressType, spInterfaceSpeed=spInterfaceSpeed, spImpactPps=spImpactPps, spMitigationName=spMitigationName, greDownDone=greDownDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInetAddress=spInetAddress, mitigationBlackholeStart=mitigationBlackholeStart, spPravail=spPravail, flowUp=flowUp, managedObjectUsage=managedObjectUsage, spCollector=spCollector, alertScript=alertScript, configChange=configChange, spcommFailure=spcommFailure, cloudSignalingFaultDone=cloudSignalingFaultDone, spCommFailureDestination=spCommFailureDestination, spManagedObjects=spManagedObjects, peakflowSPMIB=peakflowSPMIB, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorType=spSystemErrorType, autoclassifyStart=autoclassifyStart, mitigationFlowspecStart=mitigationFlowspecStart, spInterface=spInterface, spFingerprintSender=spFingerprintSender, spSystemErrorDescription=spSystemErrorDescription, spDNSName=spDNSName, peakflowSPMgr=peakflowSPMgr, spDNSExpected=spDNSExpected, spTMSCommunity=spTMSCommunity, spScriptHost=spScriptHost, spFlowspecTimeout=spFlowspecTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, fingerprintUsageDone=fingerprintUsageDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spUsername=spUsername, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceHealth=deviceHealth, spBGPInstability=spBGPInstability, spDNSObservedMean=spDNSObservedMean, spReportName=spReportName, spDNSObservedMax=spDNSObservedMax, spLicenseErrType=spLicenseErrType, bgpTrap=bgpTrap, dosHostDetectionAlert=dosHostDetectionAlert, deviceTotalFlows=deviceTotalFlows, mitigationThirdPartyStart=mitigationThirdPartyStart, trafficAutoMitigation=trafficAutoMitigation, spBGPTrapPrefix=spBGPTrapPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spLicenseErrCount=spLicenseErrCount, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpInstabilityDone=bgpInstabilityDone, serviceUsage=serviceUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spManagedObject=spManagedObject, mitigationTMSStart=mitigationTMSStart, spUsage=spUsage, spImpactBps=spImpactBps, mitigationTMSStartV2=mitigationTMSStartV2, serviceUsageDone=serviceUsageDone, deviceSystemError=deviceSystemError, fingerprintUsage=fingerprintUsage, spBlackholeTimeout=spBlackholeTimeout, spDetector=spDetector, collectorUp=collectorUp, bgpHijack=bgpHijack, spUnit=spUnit, spFlowspecCommunity=spFlowspecCommunity, collectorStart=collectorStart, spThirdPartyZone=spThirdPartyZone, spDuration=spDuration, routingFailover=routingFailover, spHijackAttr=spHijackAttr, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBlackholeNexthop=spBlackholeNexthop, spLicenseErrLimit=spLicenseErrLimit, peakflowSPTraps=peakflowSPTraps, devicePhysicalMemory=devicePhysicalMemory, spTMSTimeout=spTMSTimeout, spBlackholeCommunity=spBlackholeCommunity, fingerprintFeedback=fingerprintFeedback, bgpUp=bgpUp, spFingerprintMessage=spFingerprintMessage, spScriptCommand=spScriptCommand, hardwareFailureDone=hardwareFailureDone, deviceSwapSpace=deviceSwapSpace, spReportURL=spReportURL, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dnsBaselineDone=dnsBaselineDone, greDown=greDown, spcommFailureDone=spcommFailureDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceSpeedHC=spInterfaceSpeedHC, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBGPTrapEvent=spBGPTrapEvent, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpDown=bgpDown, spGreTunnelDestination=spGreTunnelDestination, mitigationDone=mitigationDone, reportDone=reportDone, spRouter=spRouter, spDetectedCountries=spDetectedCountries, spBGPTrapName=spBGPTrapName, spHijackLocal=spHijackLocal, deviceDiskUsage=deviceDiskUsage, snmpDown=snmpDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFingerprintFeedback=spFingerprintFeedback, spScriptStart=spScriptStart, spHijackRoute=spHijackRoute, licenseErrorDone=licenseErrorDone, spBlackholePrefix=spBlackholePrefix, spTMSPrefix=spTMSPrefix, bgpInstability=bgpInstability, deviceTotalFlowsHC=deviceTotalFlowsHC, spReportID=spReportID, hardwareFailure=hardwareFailure, spLicenseErrDescription=spLicenseErrDescription, flowDown=flowDown, spBGPEvent=spBGPEvent, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUsageType=spUsageType, cloudSignalingFault=cloudSignalingFault, spVersion=spVersion, spFingerprintName=spFingerprintName, spMitigationID=spMitigationID, interfaceUsage=interfaceUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spServiceElement=spServiceElement, spAlertID=spAlertID, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spGreTunnelName=spGreTunnelName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, managedObjectUsageDone=managedObjectUsageDone, interfaceUsageDone=interfaceUsageDone, spDNSObserved=spDNSObserved, fingerprintReceive=fingerprintReceive, spTMSMultiPrefix=spTMSMultiPrefix, spThreshold=spThreshold, spServiceName=spServiceName, snmpUp=snmpUp, spHardwareFailureDescription=spHardwareFailureDescription, spThirdPartyAddr=spThirdPartyAddr, spApplicationName=spApplicationName, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationStart=spMitigationStart, spBGPTrapOldAttributes=spBGPTrapOldAttributes, licenseError=licenseError, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spScriptPort=spScriptPort, spInterfaceIndex=spInterfaceIndex)
