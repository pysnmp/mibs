...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:48:59 2023
...
IpAddress, iso, NotificationType, Counter32, TimeTicks, Counter64, Gauge32, Bits, ModuleIdentity, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "NotificationType", "Counter32", "TimeTicks", "Counter64", "Gauge32", "Bits", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, spServiceName=spServiceName, collectorUp=collectorUp, configChange=configChange, spGreTunnelName=spGreTunnelName, spFlowspecTimeout=spFlowspecTimeout, mitigationDone=mitigationDone, licenseErrorDone=licenseErrorDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCollector=spCollector, spUsage=spUsage, spScriptStart=spScriptStart, spInterfaceUsageHC=spInterfaceUsageHC, spBGPTrapEvent=spBGPTrapEvent, mitigationFlowspecStart=mitigationFlowspecStart, notificationLimit=notificationLimit, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spSystemErrorDescription=spSystemErrorDescription, peakflowSPCMI=peakflowSPCMI, spLicenseErrType=spLicenseErrType, spDNSName=spDNSName, spThirdPartyAddr=spThirdPartyAddr, PYSNMP_MODULE_ID=peakflowSPMIB, spHijackAttr=spHijackAttr, spThreshold=spThreshold, mitigationBlackholeStart=mitigationBlackholeStart, greDownDone=greDownDone, spCommFailureDestination=spCommFailureDestination, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintUsageDone=fingerprintUsageDone, spFingerprintFeedback=spFingerprintFeedback, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spcommFailure=spcommFailure, spServiceElement=spServiceElement, spLicenseErrLimit=spLicenseErrLimit, deviceTotalFlowsHC=deviceTotalFlowsHC, reportDone=reportDone, spBGPEvent=spBGPEvent, spManagedObjectFamily=spManagedObjectFamily, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dnsBaseline=dnsBaseline, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpUp=bgpUp, managedObjectUsage=managedObjectUsage, spApplicationName=spApplicationName, deviceTotalFlows=deviceTotalFlows, spInterfaceIndex=spInterfaceIndex, peakflowSPMIB=peakflowSPMIB, bgpHijack=bgpHijack, greDown=greDown, spMitigationID=spMitigationID, snmpUp=snmpUp, dosHostDetectionAlert=dosHostDetectionAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpInstability=bgpInstability, spAlertID=spAlertID, flowDown=flowDown, spImpactBps=spImpactBps, bgpTrap=bgpTrap, deviceHealth=deviceHealth, spManagedObjects=spManagedObjects, spFlowspecCommunity=spFlowspecCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, cloudSignalingFault=cloudSignalingFault, peakflowSPMgr=peakflowSPMgr, spGreTunnelDestination=spGreTunnelDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBlackholePrefix=spBlackholePrefix, spHardwareFailureDescription=spHardwareFailureDescription, spDNSExpected=spDNSExpected, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintFeedback=fingerprintFeedback, fingerprintUsage=fingerprintUsage, interfaceUsage=interfaceUsage, spImpactPps=spImpactPps, spDetectedCountries=spDetectedCountries, spReportID=spReportID, spReportURL=spReportURL, bgpDown=bgpDown, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInetAddress=spInetAddress, spTMSCommunity=spTMSCommunity, spInterfaceUsage=spInterfaceUsage, spScriptPort=spScriptPort, spHijackRoute=spHijackRoute, snmpDown=snmpDown, spBlackholeNexthop=spBlackholeNexthop, spInterface=spInterface, spFingerprintName=spFingerprintName, deviceDiskUsage=deviceDiskUsage, spInetAddressType=spInetAddressType, mitigationTMSStart=mitigationTMSStart, mitigationThirdPartyStart=mitigationThirdPartyStart, alertScript=alertScript, peakflowSPTraps=peakflowSPTraps, spTMSTimeout=spTMSTimeout, deviceSwapSpace=deviceSwapSpace, spDNSObservedMax=spDNSObservedMax, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrDescription=spLicenseErrDescription, spUnit=spUnit, spVersion=spVersion, spScriptCommand=spScriptCommand, devicePhysicalMemory=devicePhysicalMemory, spManagedObject=spManagedObject, spBlackholeCommunity=spBlackholeCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spCommFailureDescription=spCommFailureDescription, hardwareFailureDone=hardwareFailureDone, interfaceUsageDone=interfaceUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSObservedMean=spDNSObservedMean, spTMSMultiPrefix=spTMSMultiPrefix, flowUp=flowUp, spBGPInstability=spBGPInstability, spPravail=spPravail, fingerprintReceive=fingerprintReceive, spUsername=spUsername, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spUsageType=spUsageType, spcommFailureDone=spcommFailureDone, licenseError=licenseError, spBGPTrapName=spBGPTrapName, spRouter=spRouter, serviceUsageDone=serviceUsageDone, spDNSObserved=spDNSObserved, spBGPTrapPrefix=spBGPTrapPrefix, spThirdPartyZone=spThirdPartyZone, spDetector=spDetector, spFingerprintMessage=spFingerprintMessage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, routingFailover=routingFailover, spBGPTrapNewAttributes=spBGPTrapNewAttributes, hardwareFailure=hardwareFailure, spTMSPrefix=spTMSPrefix, spScriptHost=spScriptHost, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dnsBaselineDone=dnsBaselineDone, spDuration=spDuration, managedObjectUsageDone=managedObjectUsageDone, trafficAutoMitigation=trafficAutoMitigation, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, collectorStart=collectorStart, autoclassifyStart=autoclassifyStart, spLicenseErrCount=spLicenseErrCount, spMitigationName=spMitigationName, serviceUsage=serviceUsage, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceSpeed=spInterfaceSpeed, spSystemErrorType=spSystemErrorType, spReportName=spReportName, collectorDown=collectorDown, spMitigationStart=spMitigationStart, spBlackholeTimeout=spBlackholeTimeout, spFingerprintSender=spFingerprintSender, spHijackLocal=spHijackLocal, deviceSystemError=deviceSystemError)
