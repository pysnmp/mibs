...
# Produced by pysmi-1.1.8 at Mon Jan 17 18:13:20 2022
...
iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Gauge32, NotificationType, Counter64, Bits, Counter32, Integer32, ObjectIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "Bits", "Counter32", "Integer32", "ObjectIdentity", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceSystemError=deviceSystemError, spBGPTrapEvent=spBGPTrapEvent, greDown=greDown, greDownDone=greDownDone, collectorStart=collectorStart, PYSNMP_MODULE_ID=peakflowSPMIB, spInetAddressType=spInetAddressType, spCommFailureDestination=spCommFailureDestination, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spcommFailureDone=spcommFailureDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUsageType=spUsageType, spManagedObject=spManagedObject, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spHijackAttr=spHijackAttr, spBlackholeNexthop=spBlackholeNexthop, spHijackLocal=spHijackLocal, spBGPEvent=spBGPEvent, spBlackholeTimeout=spBlackholeTimeout, deviceDiskUsage=deviceDiskUsage, spRouter=spRouter, spSystemErrorType=spSystemErrorType, spServiceElement=spServiceElement, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationTMSStartV2=mitigationTMSStartV2, hardwareFailure=hardwareFailure, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, fingerprintReceive=fingerprintReceive, cloudSignalingFault=cloudSignalingFault, spTMSMultiPrefix=spTMSMultiPrefix, deviceTotalFlows=deviceTotalFlows, spDuration=spDuration, spThirdPartyAddr=spThirdPartyAddr, mitigationBlackholeStart=mitigationBlackholeStart, spThirdPartyZone=spThirdPartyZone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spHijackRoute=spHijackRoute, peakflowSPMgr=peakflowSPMgr, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceUsage=spInterfaceUsage, dnsBaseline=dnsBaseline, spGreTunnelName=spGreTunnelName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInterfaceUsageHC=spInterfaceUsageHC, spTMSCommunity=spTMSCommunity, hardwareFailureDone=hardwareFailureDone, devicePhysicalMemory=devicePhysicalMemory, managedObjectUsageDone=managedObjectUsageDone, managedObjectUsage=managedObjectUsage, spInterfaceSpeed=spInterfaceSpeed, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spServiceName=spServiceName, peakflowSPCMI=peakflowSPCMI, spLicenseErrType=spLicenseErrType, serviceUsageDone=serviceUsageDone, spManagedObjectFamily=spManagedObjectFamily, spPravail=spPravail, spScriptPort=spScriptPort, notificationLimit=notificationLimit, spDNSObserved=spDNSObserved, spScriptHost=spScriptHost, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBGPTrapName=spBGPTrapName, spApplicationName=spApplicationName, collectorUp=collectorUp, spDNSName=spDNSName, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintFeedback=fingerprintFeedback, spMitigationStart=spMitigationStart, configChange=configChange, bgpTrap=bgpTrap, spUsername=spUsername, spMitigationName=spMitigationName, spDNSObservedMean=spDNSObservedMean, spFingerprintMessage=spFingerprintMessage, licenseError=licenseError, spLicenseErrDescription=spLicenseErrDescription, fingerprintUsage=fingerprintUsage, spBGPTrapPrefix=spBGPTrapPrefix, serviceUsage=serviceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spReportName=spReportName, licenseErrorDone=licenseErrorDone, fingerprintUsageDone=fingerprintUsageDone, spBlackholePrefix=spBlackholePrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceIndex=spInterfaceIndex, spImpactBps=spImpactBps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spMitigationID=spMitigationID, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationTMSStart=mitigationTMSStart, spUnit=spUnit, flowUp=flowUp, spTMSTimeout=spTMSTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, dnsBaselineDone=dnsBaselineDone, spFlowspecCommunity=spFlowspecCommunity, snmpDown=snmpDown, spFingerprintSender=spFingerprintSender, spGreTunnelDestination=spGreTunnelDestination, spInterface=spInterface, peakflowSPTraps=peakflowSPTraps, bgpInstability=bgpInstability, spImpactPps=spImpactPps, spThreshold=spThreshold, spTMSPrefix=spTMSPrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, reportDone=reportDone, bgpHijack=bgpHijack, spScriptCommand=spScriptCommand, snmpUp=snmpUp, bgpUp=bgpUp, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, mitigationFlowspecStart=mitigationFlowspecStart, spInetAddress=spInetAddress, spUsage=spUsage, spDNSObservedMax=spDNSObservedMax, autoclassifyStart=autoclassifyStart, alertScript=alertScript, spScriptStart=spScriptStart, spManagedObjects=spManagedObjects, dosHostDetectionAlert=dosHostDetectionAlert, spCommFailureDescription=spCommFailureDescription, bgpDown=bgpDown, spFlowspecTimeout=spFlowspecTimeout, spCollector=spCollector, interfaceUsage=interfaceUsage, spLicenseErrCount=spLicenseErrCount, spDetector=spDetector, spReportURL=spReportURL, spReportID=spReportID, deviceHealth=deviceHealth, trafficAutoMitigation=trafficAutoMitigation, spDNSExpected=spDNSExpected, flowDown=flowDown, spDetectedCountries=spDetectedCountries, routingFailover=routingFailover, spHardwareFailureDescription=spHardwareFailureDescription, spBGPInstability=spBGPInstability, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spcommFailure=spcommFailure, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, collectorDown=collectorDown, spBlackholeCommunity=spBlackholeCommunity, deviceSwapSpace=deviceSwapSpace, interfaceUsageDone=interfaceUsageDone, mitigationDone=mitigationDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintFeedback=spFingerprintFeedback, bgpInstabilityDone=bgpInstabilityDone, spAlertID=spAlertID, spFingerprintName=spFingerprintName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPMIB=peakflowSPMIB, spVersion=spVersion)
