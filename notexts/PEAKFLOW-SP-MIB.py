...
# Produced by pysmi-1.1.8 at Mon Jan 17 09:54:35 2022
...
Counter32, MibIdentifier, Unsigned32, Bits, ModuleIdentity, IpAddress, Integer32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Unsigned32", "Bits", "ModuleIdentity", "IpAddress", "Integer32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", managedObjectUsage=managedObjectUsage, spBGPTrapEvent=spBGPTrapEvent, spFingerprintName=spFingerprintName, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObject=spManagedObject, trafficAutoMitigation=trafficAutoMitigation, hardwareFailureDone=hardwareFailureDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spImpactBps=spImpactBps, spDuration=spDuration, peakflowSPMIB=peakflowSPMIB, configChange=configChange, greDownDone=greDownDone, deviceTotalFlows=deviceTotalFlows, spCommFailureDescription=spCommFailureDescription, spHardwareFailureDescription=spHardwareFailureDescription, spBlackholeTimeout=spBlackholeTimeout, collectorStart=collectorStart, mitigationTMSStart=mitigationTMSStart, licenseErrorDone=licenseErrorDone, alertScript=alertScript, mitigationTMSStartV2=mitigationTMSStartV2, spBGPInstability=spBGPInstability, spServiceName=spServiceName, deviceHealth=deviceHealth, spDNSObserved=spDNSObserved, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInetAddressType=spInetAddressType, spUsage=spUsage, bgpUp=bgpUp, flowUp=flowUp, spThirdPartyZone=spThirdPartyZone, spApplicationName=spApplicationName, spInterfaceUsage=spInterfaceUsage, spDNSName=spDNSName, spLicenseErrDescription=spLicenseErrDescription, spSystemErrorType=spSystemErrorType, spCommFailureDestination=spCommFailureDestination, spTMSCommunity=spTMSCommunity, peakflowSPMgr=peakflowSPMgr, spAlertDetectionSignatures=spAlertDetectionSignatures, spHijackLocal=spHijackLocal, flowDown=flowDown, serviceUsageDone=serviceUsageDone, collectorDown=collectorDown, spUnit=spUnit, routingFailover=routingFailover, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spReportName=spReportName, deviceSwapSpace=deviceSwapSpace, spcommFailureDone=spcommFailureDone, spInterface=spInterface, deviceSystemErrorDone=deviceSystemErrorDone, cloudSignalingFault=cloudSignalingFault, fingerprintUsage=fingerprintUsage, mitigationDone=mitigationDone, spcommFailure=spcommFailure, spTMSTimeout=spTMSTimeout, spDetectedCountries=spDetectedCountries, spManagedObjects=spManagedObjects, spBlackholePrefix=spBlackholePrefix, interfaceUsageDone=interfaceUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPEvent=spBGPEvent, spBGPTrapName=spBGPTrapName, bgpInstabilityDone=bgpInstabilityDone, bgpHijack=bgpHijack, spReportID=spReportID, spHijackAttr=spHijackAttr, spBGPTrapPrefix=spBGPTrapPrefix, interfaceUsage=interfaceUsage, spMitigationID=spMitigationID, spThirdPartyAddr=spThirdPartyAddr, mitigationThirdPartyStart=mitigationThirdPartyStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, snmpUp=snmpUp, spFingerprintMessage=spFingerprintMessage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCollector=spCollector, managedObjectUsageDone=managedObjectUsageDone, spDNSExpected=spDNSExpected, bgpDown=bgpDown, spFlowspecCommunity=spFlowspecCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spServiceElement=spServiceElement, spDetector=spDetector, spDNSObservedMean=spDNSObservedMean, spUsername=spUsername, peakflowSPTraps=peakflowSPTraps, PYSNMP_MODULE_ID=peakflowSPMIB, spHijackRoute=spHijackRoute, mitigationFlowspecStart=mitigationFlowspecStart, spImpactPps=spImpactPps, spLicenseErrCount=spLicenseErrCount, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterfaceSpeedHC=spInterfaceSpeedHC, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spGreTunnelDestination=spGreTunnelDestination, spInterfaceUsageHC=spInterfaceUsageHC, hardwareFailure=hardwareFailure, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spMitigationStart=spMitigationStart, peakflowSPCMI=peakflowSPCMI, spScriptStart=spScriptStart, greDown=greDown, bgpInstability=bgpInstability, spDNSObservedMax=spDNSObservedMax, spGreTunnelName=spGreTunnelName, spMitigationName=spMitigationName, spUsageType=spUsageType, collectorUp=collectorUp, spThreshold=spThreshold, spInetAddress=spInetAddress, spCloudSignalFaultDescription=spCloudSignalFaultDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, spRouter=spRouter, spReportURL=spReportURL, spSystemErrorDescription=spSystemErrorDescription, spLicenseErrLimit=spLicenseErrLimit, spTMSMultiPrefix=spTMSMultiPrefix, spScriptPort=spScriptPort, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSPrefix=spTMSPrefix, dnsBaselineDone=dnsBaselineDone, spScriptHost=spScriptHost, fingerprintUsageDone=fingerprintUsageDone, spAlertID=spAlertID, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptCommand=spScriptCommand, bgpTrap=bgpTrap, spVersion=spVersion, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFingerprintFeedback=spFingerprintFeedback, deviceDiskUsage=deviceDiskUsage, dosHostDetectionAlert=dosHostDetectionAlert, fingerprintFeedback=fingerprintFeedback, spLicenseErrType=spLicenseErrType, spInterfaceIndex=spInterfaceIndex, fingerprintReceive=fingerprintReceive, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, licenseError=licenseError, spBlackholeCommunity=spBlackholeCommunity, spPravail=spPravail, serviceUsage=serviceUsage, mitigationBlackholeStart=mitigationBlackholeStart, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dnsBaseline=dnsBaseline, reportDone=reportDone, spBlackholeNexthop=spBlackholeNexthop, deviceSystemError=deviceSystemError, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spManagedObjectFamily=spManagedObjectFamily, snmpDown=snmpDown, spFlowspecTimeout=spFlowspecTimeout, notificationLimit=notificationLimit, spFingerprintSender=spFingerprintSender)
