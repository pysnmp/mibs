...
NotificationType, ObjectIdentity, Unsigned32, Counter32, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, Gauge32, iso, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "Gauge32", "iso", "Integer32", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapOldAttributes=spBGPTrapOldAttributes, hardwareFailure=hardwareFailure, spFingerprintName=spFingerprintName, spMitigationID=spMitigationID, deviceSwapSpaceInUse=deviceSwapSpaceInUse, flowDown=flowDown, cloudSignalingFault=cloudSignalingFault, spImpactBps=spImpactBps, peakflowSPCMI=peakflowSPCMI, spManagedObjectFamily=spManagedObjectFamily, interfaceUsageDone=interfaceUsageDone, deviceSwapSpace=deviceSwapSpace, hardwareFailureDone=hardwareFailureDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spReportURL=spReportURL, bgpTrap=bgpTrap, spGreTunnelDestination=spGreTunnelDestination, spUsageType=spUsageType, spBGPEvent=spBGPEvent, spBGPTrapNewAttributes=spBGPTrapNewAttributes, notificationLimit=notificationLimit, spInterfaceUsage=spInterfaceUsage, spBGPTrapEvent=spBGPTrapEvent, spHijackAttr=spHijackAttr, fingerprintFeedback=fingerprintFeedback, spLicenseErrCount=spLicenseErrCount, spRouter=spRouter, spCommFailureDescription=spCommFailureDescription, spLicenseErrLimit=spLicenseErrLimit, spcommFailureDone=spcommFailureDone, fingerprintUsageDone=fingerprintUsageDone, spDNSObserved=spDNSObserved, licenseErrorDone=licenseErrorDone, spFlowspecTimeout=spFlowspecTimeout, spThirdPartyAddr=spThirdPartyAddr, spThreshold=spThreshold, mitigationTMSStartV2=mitigationTMSStartV2, mitigationFlowspecStart=mitigationFlowspecStart, mitigationDone=mitigationDone, spPravail=spPravail, spDNSName=spDNSName, spMitigationName=spMitigationName, snmpUp=snmpUp, spInetAddressType=spInetAddressType, collectorDown=collectorDown, peakflowSPMgr=peakflowSPMgr, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spImpactPps=spImpactPps, spCommFailureDestination=spCommFailureDestination, spLicenseErrType=spLicenseErrType, spInterface=spInterface, mitigationTMSStart=mitigationTMSStart, spInetAddress=spInetAddress, snmpDown=snmpDown, spScriptPort=spScriptPort, serviceUsageDone=serviceUsageDone, collectorStart=collectorStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, collectorUp=collectorUp, spManagedObject=spManagedObject, spUnit=spUnit, spTMSTimeout=spTMSTimeout, spCollector=spCollector, cloudSignalingFaultDone=cloudSignalingFaultDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemErrorDone=deviceSystemErrorDone, spServiceElement=spServiceElement, peakflowSPTraps=peakflowSPTraps, spTMSMultiPrefix=spTMSMultiPrefix, flowUp=flowUp, spHijackRoute=spHijackRoute, spThirdPartyZone=spThirdPartyZone, spDetector=spDetector, spDNSObservedMax=spDNSObservedMax, spHardwareFailureDescription=spHardwareFailureDescription, spAlertID=spAlertID, bgpInstabilityDone=bgpInstabilityDone, autoclassifyStart=autoclassifyStart, interfaceUsage=interfaceUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpHijack=bgpHijack, spScriptStart=spScriptStart, spReportName=spReportName, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosHostDetectionAlert=dosHostDetectionAlert, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spServiceName=spServiceName, spDNSExpected=spDNSExpected, spHijackLocal=spHijackLocal, spVersion=spVersion, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrDescription=spLicenseErrDescription, trafficAutoMitigation=trafficAutoMitigation, peakflowSPMIB=peakflowSPMIB, spcommFailure=spcommFailure, spBlackholeNexthop=spBlackholeNexthop, spInterfaceIndex=spInterfaceIndex, fingerprintUsage=fingerprintUsage, spTMSPrefix=spTMSPrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, routingFailover=routingFailover, PYSNMP_MODULE_ID=peakflowSPMIB, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorDescription=spSystemErrorDescription, spApplicationName=spApplicationName, spBGPInstability=spBGPInstability, spDuration=spDuration, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintSender=spFingerprintSender, deviceTotalFlows=deviceTotalFlows, spBlackholeTimeout=spBlackholeTimeout, reportDone=reportDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, serviceUsage=serviceUsage, bgpDown=bgpDown, deviceHealth=deviceHealth, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemory=devicePhysicalMemory, spFlowspecCommunity=spFlowspecCommunity, spUsername=spUsername, spDNSObservedMean=spDNSObservedMean, fingerprintReceive=fingerprintReceive, alertScript=alertScript, bgpUp=bgpUp, greDown=greDown, spUsage=spUsage, spTMSCommunity=spTMSCommunity, spBGPTrapPrefix=spBGPTrapPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spReportID=spReportID, spGreTunnelName=spGreTunnelName, configChange=configChange, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsageDone=managedObjectUsageDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spBlackholePrefix=spBlackholePrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceDiskUsage=deviceDiskUsage, managedObjectUsage=managedObjectUsage, deviceSystemError=deviceSystemError, spSystemErrorType=spSystemErrorType, spScriptCommand=spScriptCommand, spFingerprintFeedback=spFingerprintFeedback, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, licenseError=licenseError, spFingerprintMessage=spFingerprintMessage, spBGPTrapName=spBGPTrapName, spBlackholeCommunity=spBlackholeCommunity, greDownDone=greDownDone, spScriptHost=spScriptHost, dnsBaseline=dnsBaseline, spDetectedCountries=spDetectedCountries, spManagedObjects=spManagedObjects, spMitigationStart=spMitigationStart, dnsBaselineDone=dnsBaselineDone)
