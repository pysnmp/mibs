...
# Produced by pysmi-1.1.12 at Tue May 28 13:37:40 2024
...
ModuleIdentity, Bits, TimeTicks, Unsigned32, Counter64, IpAddress, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "TimeTicks", "Unsigned32", "Counter64", "IpAddress", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapEvent=spBGPTrapEvent, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsage=fingerprintUsage, spInterfaceUsage=spInterfaceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCommFailureDestination=spCommFailureDestination, snmpUp=snmpUp, mitigationDone=mitigationDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spServiceName=spServiceName, spDetector=spDetector, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFlowspecCommunity=spFlowspecCommunity, spScriptStart=spScriptStart, spCollector=spCollector, spBGPTrapName=spBGPTrapName, PYSNMP_MODULE_ID=peakflowSPMIB, mitigationTMSStart=mitigationTMSStart, collectorDown=collectorDown, spLicenseErrLimit=spLicenseErrLimit, spVersion=spVersion, deviceTotalFlows=deviceTotalFlows, spRouter=spRouter, spMitigationID=spMitigationID, interfaceUsage=interfaceUsage, spApplicationName=spApplicationName, fingerprintFeedback=fingerprintFeedback, licenseError=licenseError, spDNSObservedMean=spDNSObservedMean, spTMSPrefix=spTMSPrefix, spcommFailureDone=spcommFailureDone, spUsername=spUsername, spBGPTrapPrefix=spBGPTrapPrefix, snmpDown=snmpDown, spGreTunnelName=spGreTunnelName, spUsageType=spUsageType, spManagedObject=spManagedObject, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSystemError=deviceSystemError, autoclassifyStart=autoclassifyStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportID=spReportID, spUsage=spUsage, spScriptHost=spScriptHost, peakflowSPCMI=peakflowSPCMI, mitigationTMSStartV2=mitigationTMSStartV2, hardwareFailure=hardwareFailure, peakflowSPMIB=peakflowSPMIB, spBlackholePrefix=spBlackholePrefix, flowUp=flowUp, trafficAutoMitigation=trafficAutoMitigation, peakflowSPMgr=peakflowSPMgr, spTMSCommunity=spTMSCommunity, spDNSObservedMax=spDNSObservedMax, spBGPInstability=spBGPInstability, spAlertDetectionSignatures=spAlertDetectionSignatures, spInetAddressType=spInetAddressType, deviceHealth=deviceHealth, collectorStart=collectorStart, spTMSMultiPrefix=spTMSMultiPrefix, collectorUp=collectorUp, deviceDiskUsage=deviceDiskUsage, spDNSName=spDNSName, spManagedObjects=spManagedObjects, cloudSignalingFaultDone=cloudSignalingFaultDone, managedObjectUsageDone=managedObjectUsageDone, reportDone=reportDone, spScriptPort=spScriptPort, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dnsBaseline=dnsBaseline, spInterfaceIndex=spInterfaceIndex, spFingerprintName=spFingerprintName, fingerprintReceive=fingerprintReceive, spcommFailure=spcommFailure, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spManagedObjectFamily=spManagedObjectFamily, spFlowspecTimeout=spFlowspecTimeout, spHijackAttr=spHijackAttr, bgpHijack=bgpHijack, bgpTrap=bgpTrap, spSystemErrorType=spSystemErrorType, spMitigationName=spMitigationName, spDNSExpected=spDNSExpected, spGreTunnelDestination=spGreTunnelDestination, mitigationBlackholeStart=mitigationBlackholeStart, spTMSTimeout=spTMSTimeout, spImpactBps=spImpactBps, spInetAddress=spInetAddress, bgpInstabilityDone=bgpInstabilityDone, spBlackholeNexthop=spBlackholeNexthop, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spThreshold=spThreshold, spCloudSignalFaultDescription=spCloudSignalFaultDescription, devicePhysicalMemory=devicePhysicalMemory, dnsBaselineDone=dnsBaselineDone, peakflowSPTraps=peakflowSPTraps, spHardwareFailureDescription=spHardwareFailureDescription, routingFailover=routingFailover, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptCommand=spScriptCommand, spReportURL=spReportURL, bgpInstability=bgpInstability, fingerprintUsageDone=fingerprintUsageDone, spInterface=spInterface, deviceSwapSpaceUsage=deviceSwapSpaceUsage, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, deviceSystemErrorDone=deviceSystemErrorDone, spDetectedCountries=spDetectedCountries, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpace=deviceSwapSpace, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spServiceElement=spServiceElement, spDuration=spDuration, mitigationFlowspecStart=mitigationFlowspecStart, alertScript=alertScript, spSystemErrorDescription=spSystemErrorDescription, licenseErrorDone=licenseErrorDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spReportName=spReportName, greDownDone=greDownDone, spLicenseErrCount=spLicenseErrCount, spAlertID=spAlertID, spMitigationStart=spMitigationStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, spImpactPps=spImpactPps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintFeedback=spFingerprintFeedback, spBlackholeTimeout=spBlackholeTimeout, bgpDown=bgpDown, managedObjectUsage=managedObjectUsage, spFingerprintMessage=spFingerprintMessage, bgpUp=bgpUp, cloudSignalingFault=cloudSignalingFault, spUnit=spUnit, spPravail=spPravail, configChange=configChange, spBGPEvent=spBGPEvent, interfaceUsageDone=interfaceUsageDone, spFingerprintSender=spFingerprintSender, deviceTotalFlowsHC=deviceTotalFlowsHC, spHijackRoute=spHijackRoute, spCommFailureDescription=spCommFailureDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, flowDown=flowDown, spInterfaceUsageHC=spInterfaceUsageHC, greDown=greDown, serviceUsage=serviceUsage, spLicenseErrType=spLicenseErrType, spDNSObserved=spDNSObserved, spHijackLocal=spHijackLocal, hardwareFailureDone=hardwareFailureDone, spThirdPartyZone=spThirdPartyZone, spInterfaceSpeed=spInterfaceSpeed, spThirdPartyAddr=spThirdPartyAddr, notificationLimit=notificationLimit, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBlackholeCommunity=spBlackholeCommunity)
