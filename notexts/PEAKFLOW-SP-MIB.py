...
# Produced by pysmi-1.1.8 at Thu Apr 27 11:23:38 2023
...
iso, NotificationType, MibIdentifier, IpAddress, Counter32, Counter64, Unsigned32, ObjectIdentity, Integer32, ModuleIdentity, Gauge32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibIdentifier", "IpAddress", "Counter32", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "ModuleIdentity", "Gauge32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", reportDone=reportDone, managedObjectUsageDone=managedObjectUsageDone, serviceUsage=serviceUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackLocal=spHijackLocal, spManagedObjectFamily=spManagedObjectFamily, spcommFailure=spcommFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, spCommFailureDestination=spCommFailureDestination, spReportID=spReportID, spFingerprintMessage=spFingerprintMessage, spDNSObserved=spDNSObserved, peakflowSPMgr=peakflowSPMgr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDuration=spDuration, spInterfaceSpeed=spInterfaceSpeed, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInetAddressType=spInetAddressType, flowDown=flowDown, mitigationTMSStart=mitigationTMSStart, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingFault=cloudSignalingFault, bgpInstability=bgpInstability, interfaceUsage=interfaceUsage, deviceSystemError=deviceSystemError, spThirdPartyZone=spThirdPartyZone, spHijackRoute=spHijackRoute, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, flowUp=flowUp, spAlertID=spAlertID, spUsage=spUsage, spInetAddress=spInetAddress, spInterfaceSpeedHC=spInterfaceSpeedHC, mitigationThirdPartyStart=mitigationThirdPartyStart, spGreTunnelDestination=spGreTunnelDestination, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceTotalFlows=deviceTotalFlows, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjects=spManagedObjects, mitigationDone=mitigationDone, spFingerprintSender=spFingerprintSender, spDNSObservedMean=spDNSObservedMean, spThreshold=spThreshold, spGreTunnelName=spGreTunnelName, deviceHealth=deviceHealth, spImpactPps=spImpactPps, spScriptStart=spScriptStart, spManagedObject=spManagedObject, spDetector=spDetector, spInterfaceUsage=spInterfaceUsage, fingerprintUsage=fingerprintUsage, spVersion=spVersion, spBGPTrapPrefix=spBGPTrapPrefix, spServiceElement=spServiceElement, spBlackholeTimeout=spBlackholeTimeout, spFlowspecCommunity=spFlowspecCommunity, spBGPInstability=spBGPInstability, spFingerprintFeedback=spFingerprintFeedback, spServiceName=spServiceName, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spTMSTimeout=spTMSTimeout, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrCount=spLicenseErrCount, collectorStart=collectorStart, spBlackholeNexthop=spBlackholeNexthop, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportURL=spReportURL, notificationLimit=notificationLimit, spHijackAttr=spHijackAttr, spMitigationID=spMitigationID, spFlowspecTimeout=spFlowspecTimeout, spLicenseErrLimit=spLicenseErrLimit, spMitigationName=spMitigationName, spScriptHost=spScriptHost, spBGPTrapEvent=spBGPTrapEvent, spImpactBps=spImpactBps, spUsername=spUsername, spScriptCommand=spScriptCommand, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, serviceUsageDone=serviceUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, bgpUp=bgpUp, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceIndex=spInterfaceIndex, configChange=configChange, routingFailover=routingFailover, alertScript=alertScript, spBlackholePrefix=spBlackholePrefix, deviceSystemErrorDone=deviceSystemErrorDone, trafficAutoMitigation=trafficAutoMitigation, PYSNMP_MODULE_ID=peakflowSPMIB, spRouter=spRouter, spFingerprintName=spFingerprintName, spScriptPort=spScriptPort, spApplicationName=spApplicationName, spInterface=spInterface, spTMSPrefix=spTMSPrefix, collectorDown=collectorDown, hardwareFailure=hardwareFailure, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrType=spLicenseErrType, spMitigationStart=spMitigationStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSystemErrorType=spSystemErrorType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spcommFailureDone=spcommFailureDone, spSystemErrorDescription=spSystemErrorDescription, spUsageType=spUsageType, interfaceUsageDone=interfaceUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, greDownDone=greDownDone, cloudSignalingFaultDone=cloudSignalingFaultDone, licenseErrorDone=licenseErrorDone, spReportName=spReportName, dnsBaselineDone=dnsBaselineDone, managedObjectUsage=managedObjectUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, fingerprintFeedback=fingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, fingerprintReceive=fingerprintReceive, spDNSExpected=spDNSExpected, spUnit=spUnit, spTMSCommunity=spTMSCommunity, spBGPEvent=spBGPEvent, deviceSwapSpace=deviceSwapSpace, snmpUp=snmpUp, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, hardwareFailureDone=hardwareFailureDone, snmpDown=snmpDown, bgpDown=bgpDown, devicePhysicalMemory=devicePhysicalMemory, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationFlowspecStart=mitigationFlowspecStart, dnsBaseline=dnsBaseline, spDNSName=spDNSName, peakflowSPCMI=peakflowSPCMI, spHardwareFailureDescription=spHardwareFailureDescription, spCommFailureDescription=spCommFailureDescription, spCollector=spCollector, spInterfaceUsageHC=spInterfaceUsageHC, bgpTrap=bgpTrap, spBlackholeCommunity=spBlackholeCommunity, deviceDiskUsage=deviceDiskUsage, peakflowSPTraps=peakflowSPTraps, spThirdPartyAddr=spThirdPartyAddr, spLicenseErrDescription=spLicenseErrDescription, spDNSObservedMax=spDNSObservedMax, spPravail=spPravail, autoclassifyStart=autoclassifyStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorUp=collectorUp, bgpHijack=bgpHijack, spBGPTrapName=spBGPTrapName, peakflowSPMIB=peakflowSPMIB, licenseError=licenseError)
