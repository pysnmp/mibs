...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:50:01 2024
...
TimeTicks, Unsigned32, Bits, Counter32, iso, IpAddress, MibIdentifier, Integer32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Bits", "Counter32", "iso", "IpAddress", "MibIdentifier", "Integer32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorDown=collectorDown, spSystemErrorDescription=spSystemErrorDescription, spBlackholePrefix=spBlackholePrefix, bgpHijack=bgpHijack, spHardwareFailureDescription=spHardwareFailureDescription, spUsage=spUsage, trafficAutoMitigation=trafficAutoMitigation, spGreTunnelName=spGreTunnelName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportURL=spReportURL, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpDown=snmpDown, spBGPEvent=spBGPEvent, snmpUp=snmpUp, hardwareFailureDone=hardwareFailureDone, spLicenseErrDescription=spLicenseErrDescription, dosNetworkProfiledAlert=dosNetworkProfiledAlert, PYSNMP_MODULE_ID=peakflowSPMIB, spDNSObservedMean=spDNSObservedMean, spAlertID=spAlertID, bgpDown=bgpDown, collectorStart=collectorStart, deviceHealth=deviceHealth, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrCount=spLicenseErrCount, deviceSwapSpace=deviceSwapSpace, licenseErrorDone=licenseErrorDone, bgpInstabilityDone=bgpInstabilityDone, peakflowSPCMI=peakflowSPCMI, spHijackLocal=spHijackLocal, spLicenseErrType=spLicenseErrType, spReportName=spReportName, spUnit=spUnit, spScriptCommand=spScriptCommand, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spFingerprintMessage=spFingerprintMessage, flowUp=flowUp, spInterface=spInterface, deviceDiskUsage=deviceDiskUsage, peakflowSPMIB=peakflowSPMIB, managedObjectUsage=managedObjectUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholeCommunity=spBlackholeCommunity, spFlowspecTimeout=spFlowspecTimeout, spImpactBps=spImpactBps, collectorUp=collectorUp, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spGreTunnelDestination=spGreTunnelDestination, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapPrefix=spBGPTrapPrefix, spHijackAttr=spHijackAttr, spScriptHost=spScriptHost, spCommFailureDestination=spCommFailureDestination, spBGPTrapName=spBGPTrapName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSTimeout=spTMSTimeout, spFingerprintName=spFingerprintName, dnsBaselineDone=dnsBaselineDone, spCommFailureDescription=spCommFailureDescription, spDuration=spDuration, spDetectedCountries=spDetectedCountries, cloudSignalingFault=cloudSignalingFault, spSystemErrorType=spSystemErrorType, spUsageType=spUsageType, deviceSystemErrorDone=deviceSystemErrorDone, spHijackRoute=spHijackRoute, spInterfaceIndex=spInterfaceIndex, peakflowSPMgr=peakflowSPMgr, mitigationTMSStart=mitigationTMSStart, spFlowspecCommunity=spFlowspecCommunity, spBGPInstability=spBGPInstability, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spImpactPps=spImpactPps, spBlackholeTimeout=spBlackholeTimeout, autoclassifyStart=autoclassifyStart, spManagedObjects=spManagedObjects, spDNSName=spDNSName, fingerprintReceive=fingerprintReceive, mitigationFlowspecStart=mitigationFlowspecStart, bgpInstability=bgpInstability, spTMSMultiPrefix=spTMSMultiPrefix, spServiceElement=spServiceElement, alertScript=alertScript, spManagedObjectFamily=spManagedObjectFamily, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObject=spManagedObject, routingFailover=routingFailover, spDNSObserved=spDNSObserved, dosHostDetectionAlert=dosHostDetectionAlert, spApplicationName=spApplicationName, interfaceUsage=interfaceUsage, spUsername=spUsername, spInetAddressType=spInetAddressType, spPravail=spPravail, spAlertDetectionSignatures=spAlertDetectionSignatures, interfaceUsageDone=interfaceUsageDone, spMitigationStart=spMitigationStart, spMitigationID=spMitigationID, spThirdPartyAddr=spThirdPartyAddr, spScriptStart=spScriptStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, fingerprintUsage=fingerprintUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBGPTrapEvent=spBGPTrapEvent, spScriptPort=spScriptPort, greDownDone=greDownDone, fingerprintUsageDone=fingerprintUsageDone, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObservedMax=spDNSObservedMax, spCollector=spCollector, spInterfaceSpeed=spInterfaceSpeed, peakflowSPTraps=peakflowSPTraps, devicePhysicalMemory=devicePhysicalMemory, reportDone=reportDone, bgpUp=bgpUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spVersion=spVersion, serviceUsage=serviceUsage, spRouter=spRouter, spMitigationName=spMitigationName, spInterfaceSpeedHC=spInterfaceSpeedHC, spcommFailureDone=spcommFailureDone, mitigationBlackholeStart=mitigationBlackholeStart, spBlackholeNexthop=spBlackholeNexthop, configChange=configChange, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, flowDown=flowDown, spInterfaceUsage=spInterfaceUsage, spcommFailure=spcommFailure, spThreshold=spThreshold, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyZone=spThirdPartyZone, bgpTrap=bgpTrap, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dnsBaseline=dnsBaseline, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintSender=spFingerprintSender, spDetector=spDetector, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInetAddress=spInetAddress, spReportID=spReportID, serviceUsageDone=serviceUsageDone, mitigationTMSStartV2=mitigationTMSStartV2, spTMSCommunity=spTMSCommunity, spLicenseErrLimit=spLicenseErrLimit, managedObjectUsageDone=managedObjectUsageDone, greDown=greDown, spDNSExpected=spDNSExpected, spServiceName=spServiceName, mitigationDone=mitigationDone, deviceSystemError=deviceSystemError, licenseError=licenseError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceTotalFlows=deviceTotalFlows)
