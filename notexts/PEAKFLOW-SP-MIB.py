...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Bits, iso, IpAddress, Counter32, NotificationType, Counter64, TimeTicks, Integer32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Bits", "iso", "IpAddress", "Counter32", "NotificationType", "Counter64", "TimeTicks", "Integer32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spThirdPartyAddr=spThirdPartyAddr, spBlackholeNexthop=spBlackholeNexthop, deviceSystemError=deviceSystemError, spHijackAttr=spHijackAttr, cloudSignalingFaultDone=cloudSignalingFaultDone, spFingerprintMessage=spFingerprintMessage, deviceDiskUsage=deviceDiskUsage, spPravail=spPravail, serviceUsageDone=serviceUsageDone, devicePhysicalMemory=devicePhysicalMemory, spFingerprintSender=spFingerprintSender, spReportID=spReportID, spHijackRoute=spHijackRoute, spInetAddressType=spInetAddressType, routingFailover=routingFailover, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceSpeed=spInterfaceSpeed, spUsageType=spUsageType, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spReportURL=spReportURL, spcommFailure=spcommFailure, interfaceUsage=interfaceUsage, deviceSwapSpace=deviceSwapSpace, spCommFailureDescription=spCommFailureDescription, spInterface=spInterface, bgpInstabilityDone=bgpInstabilityDone, spLicenseErrDescription=spLicenseErrDescription, interfaceUsageDone=interfaceUsageDone, spLicenseErrCount=spLicenseErrCount, spAlertID=spAlertID, spFlowspecTimeout=spFlowspecTimeout, peakflowSPCMI=peakflowSPCMI, spBlackholeCommunity=spBlackholeCommunity, spManagedObjectFamily=spManagedObjectFamily, mitigationDone=mitigationDone, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceSpeedHC=spInterfaceSpeedHC, spFingerprintFeedback=spFingerprintFeedback, flowDown=flowDown, spServiceName=spServiceName, spDuration=spDuration, spScriptCommand=spScriptCommand, trafficAutoMitigation=trafficAutoMitigation, bgpHijack=bgpHijack, spLicenseErrLimit=spLicenseErrLimit, collectorStart=collectorStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBlackholePrefix=spBlackholePrefix, spImpactPps=spImpactPps, peakflowSPTraps=peakflowSPTraps, spRouter=spRouter, hardwareFailure=hardwareFailure, deviceSystemErrorDone=deviceSystemErrorDone, spThreshold=spThreshold, fingerprintUsageDone=fingerprintUsageDone, spDNSExpected=spDNSExpected, managedObjectUsageDone=managedObjectUsageDone, managedObjectUsage=managedObjectUsage, greDown=greDown, snmpDown=snmpDown, spBGPTrapName=spBGPTrapName, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceUsage=spInterfaceUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spCommFailureDestination=spCommFailureDestination, hardwareFailureDone=hardwareFailureDone, spImpactBps=spImpactBps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spFlowspecCommunity=spFlowspecCommunity, greDownDone=greDownDone, spInetAddress=spInetAddress, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPInstability=spBGPInstability, bgpTrap=bgpTrap, dnsBaseline=dnsBaseline, dosHostDetectionAlert=dosHostDetectionAlert, spSystemErrorDescription=spSystemErrorDescription, collectorDown=collectorDown, spScriptHost=spScriptHost, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationBlackholeStart=mitigationBlackholeStart, spManagedObjects=spManagedObjects, spServiceElement=spServiceElement, spDNSObservedMax=spDNSObservedMax, spDNSName=spDNSName, spVersion=spVersion, spGreTunnelName=spGreTunnelName, spLicenseErrType=spLicenseErrType, licenseError=licenseError, spScriptPort=spScriptPort, spBGPTrapEvent=spBGPTrapEvent, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spMitigationName=spMitigationName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceSwapSpaceInUse=deviceSwapSpaceInUse, fingerprintFeedback=fingerprintFeedback, spTMSMultiPrefix=spTMSMultiPrefix, spSystemErrorType=spSystemErrorType, bgpUp=bgpUp, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationTMSStart=mitigationTMSStart, spMitigationID=spMitigationID, spApplicationName=spApplicationName, bgpDown=bgpDown, spCollector=spCollector, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportName=spReportName, deviceTotalFlowsHC=deviceTotalFlowsHC, flowUp=flowUp, spUnit=spUnit, spDNSObserved=spDNSObserved, spTMSPrefix=spTMSPrefix, spBGPTrapPrefix=spBGPTrapPrefix, configChange=configChange, reportDone=reportDone, licenseErrorDone=licenseErrorDone, peakflowSPMIB=peakflowSPMIB, mitigationFlowspecStart=mitigationFlowspecStart, spHijackLocal=spHijackLocal, PYSNMP_MODULE_ID=peakflowSPMIB, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, autoclassifyStart=autoclassifyStart, mitigationTMSStartV2=mitigationTMSStartV2, fingerprintUsage=fingerprintUsage, spBGPEvent=spBGPEvent, spTMSCommunity=spTMSCommunity, spDNSObservedMean=spDNSObservedMean, cloudSignalingFault=cloudSignalingFault, spDetectedCountries=spDetectedCountries, spUsername=spUsername, snmpUp=snmpUp, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, collectorUp=collectorUp, spcommFailureDone=spcommFailureDone, spDetector=spDetector, dnsBaselineDone=dnsBaselineDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSTimeout=spTMSTimeout, deviceTotalFlows=deviceTotalFlows, peakflowSPMgr=peakflowSPMgr, spThirdPartyZone=spThirdPartyZone, serviceUsage=serviceUsage, spUsage=spUsage, spFingerprintName=spFingerprintName, deviceHealth=deviceHealth, spScriptStart=spScriptStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpInstability=bgpInstability, spManagedObject=spManagedObject, spInterfaceIndex=spInterfaceIndex, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintReceive=fingerprintReceive, alertScript=alertScript, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spMitigationStart=spMitigationStart, notificationLimit=notificationLimit)
