...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:52:41 2021
...
NotificationType, Integer32, TimeTicks, Bits, ObjectIdentity, ModuleIdentity, Counter64, Gauge32, Unsigned32, IpAddress, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "TimeTicks", "Bits", "ObjectIdentity", "ModuleIdentity", "Counter64", "Gauge32", "Unsigned32", "IpAddress", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", licenseError=licenseError, peakflowSPMIB=peakflowSPMIB, spDetector=spDetector, spReportID=spReportID, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spLicenseErrType=spLicenseErrType, spScriptCommand=spScriptCommand, snmpUp=snmpUp, spDetectedCountries=spDetectedCountries, mitigationTMSStartV2=mitigationTMSStartV2, deviceTotalFlows=deviceTotalFlows, flowUp=flowUp, collectorStart=collectorStart, bgpInstabilityDone=bgpInstabilityDone, spBGPTrapEvent=spBGPTrapEvent, spScriptPort=spScriptPort, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterfaceIndex=spInterfaceIndex, peakflowSPMgr=peakflowSPMgr, spTMSCommunity=spTMSCommunity, spBGPEvent=spBGPEvent, spFlowspecCommunity=spFlowspecCommunity, spScriptHost=spScriptHost, spBGPTrapPrefix=spBGPTrapPrefix, interfaceUsage=interfaceUsage, spTMSPrefix=spTMSPrefix, spCommFailureDestination=spCommFailureDestination, bgpHijack=bgpHijack, spServiceName=spServiceName, deviceHealth=deviceHealth, cloudSignalingFault=cloudSignalingFault, spDNSObserved=spDNSObserved, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeTimeout=spBlackholeTimeout, spPravail=spPravail, managedObjectUsage=managedObjectUsage, spInterfaceUsage=spInterfaceUsage, deviceSystemError=deviceSystemError, notificationLimit=notificationLimit, spManagedObject=spManagedObject, hardwareFailureDone=hardwareFailureDone, spBlackholeNexthop=spBlackholeNexthop, PYSNMP_MODULE_ID=peakflowSPMIB, spServiceElement=spServiceElement, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrDescription=spLicenseErrDescription, spUsage=spUsage, bgpTrap=bgpTrap, spThreshold=spThreshold, dnsBaselineDone=dnsBaselineDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowDown=flowDown, spInterface=spInterface, mitigationDone=mitigationDone, routingFailover=routingFailover, spReportName=spReportName, spFingerprintFeedback=spFingerprintFeedback, snmpDown=snmpDown, devicePhysicalMemory=devicePhysicalMemory, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPInstability=spBGPInstability, spDNSObservedMean=spDNSObservedMean, deviceSystemErrorDone=deviceSystemErrorDone, managedObjectUsageDone=managedObjectUsageDone, spBlackholeCommunity=spBlackholeCommunity, spManagedObjects=spManagedObjects, bgpInstability=bgpInstability, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationFlowspecStart=mitigationFlowspecStart, deviceDiskUsage=deviceDiskUsage, spUnit=spUnit, spLicenseErrCount=spLicenseErrCount, fingerprintFeedback=fingerprintFeedback, licenseErrorDone=licenseErrorDone, autoclassifyStart=autoclassifyStart, spVersion=spVersion, spApplicationName=spApplicationName, serviceUsageDone=serviceUsageDone, spImpactBps=spImpactBps, spSystemErrorType=spSystemErrorType, greDown=greDown, spGreTunnelDestination=spGreTunnelDestination, spReportURL=spReportURL, spInetAddressType=spInetAddressType, spManagedObjectFamily=spManagedObjectFamily, spMitigationStart=spMitigationStart, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBlackholePrefix=spBlackholePrefix, bgpUp=bgpUp, spImpactPps=spImpactPps, spcommFailureDone=spcommFailureDone, spCollector=spCollector, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintMessage=spFingerprintMessage, deviceTotalFlowsHC=deviceTotalFlowsHC, spUsername=spUsername, configChange=configChange, reportDone=reportDone, alertScript=alertScript, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpDown=bgpDown, spHijackRoute=spHijackRoute, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRouter=spRouter, fingerprintReceive=fingerprintReceive, spHijackAttr=spHijackAttr, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrLimit=spLicenseErrLimit, spGreTunnelName=spGreTunnelName, hardwareFailure=hardwareFailure, spThirdPartyZone=spThirdPartyZone, spMitigationID=spMitigationID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintSender=spFingerprintSender, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSObservedMax=spDNSObservedMax, spScriptStart=spScriptStart, spDNSExpected=spDNSExpected, spBGPTrapName=spBGPTrapName, spThirdPartyAddr=spThirdPartyAddr, spHardwareFailureDescription=spHardwareFailureDescription, mitigationBlackholeStart=mitigationBlackholeStart, serviceUsage=serviceUsage, dnsBaseline=dnsBaseline, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, peakflowSPTraps=peakflowSPTraps, deviceSwapSpace=deviceSwapSpace, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintName=spFingerprintName, spDNSName=spDNSName, spcommFailure=spcommFailure, spDuration=spDuration, interfaceUsageDone=interfaceUsageDone, fingerprintUsage=fingerprintUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSMultiPrefix=spTMSMultiPrefix, spFlowspecTimeout=spFlowspecTimeout, spHijackLocal=spHijackLocal, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spAlertID=spAlertID, spMitigationName=spMitigationName, spUsageType=spUsageType, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spTMSTimeout=spTMSTimeout, greDownDone=greDownDone, peakflowSPCMI=peakflowSPCMI, spInetAddress=spInetAddress, mitigationTMSStart=mitigationTMSStart, spInterfaceUsageHC=spInterfaceUsageHC, collectorDown=collectorDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsageDone=fingerprintUsageDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, collectorUp=collectorUp)
