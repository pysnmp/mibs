...
Counter32, Integer32, Bits, MibIdentifier, ObjectIdentity, Unsigned32, TimeTicks, IpAddress, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "Unsigned32", "TimeTicks", "IpAddress", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spMitigationID=spMitigationID, spScriptStart=spScriptStart, spSystemErrorDescription=spSystemErrorDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, snmpDown=snmpDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, flowDown=flowDown, managedObjectUsageDone=managedObjectUsageDone, spReportID=spReportID, spInterfaceSpeed=spInterfaceSpeed, spDNSObserved=spDNSObserved, spCloudSignalFaultDescription=spCloudSignalFaultDescription, devicePhysicalMemory=devicePhysicalMemory, spGreTunnelName=spGreTunnelName, spHijackRoute=spHijackRoute, greDown=greDown, spThirdPartyZone=spThirdPartyZone, dnsBaselineDone=dnsBaselineDone, spBGPTrapName=spBGPTrapName, spUsageType=spUsageType, flowUp=flowUp, peakflowSPCMI=peakflowSPCMI, spCommFailureDescription=spCommFailureDescription, mitigationFlowspecStart=mitigationFlowspecStart, deviceTotalFlows=deviceTotalFlows, notificationLimit=notificationLimit, spDetectedCountries=spDetectedCountries, reportDone=reportDone, dosHostDetectionAlert=dosHostDetectionAlert, deviceSystemErrorDone=deviceSystemErrorDone, collectorDown=collectorDown, spCollector=spCollector, spPravail=spPravail, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationThirdPartyStart=mitigationThirdPartyStart, spFingerprintMessage=spFingerprintMessage, hardwareFailureDone=hardwareFailureDone, fingerprintReceive=fingerprintReceive, deviceSwapSpaceInUse=deviceSwapSpaceInUse, collectorUp=collectorUp, spHijackAttr=spHijackAttr, spTMSCommunity=spTMSCommunity, spLicenseErrLimit=spLicenseErrLimit, spImpactBps=spImpactBps, spHardwareFailureDescription=spHardwareFailureDescription, spBGPEvent=spBGPEvent, bgpInstability=bgpInstability, licenseError=licenseError, bgpDown=bgpDown, spManagedObjects=spManagedObjects, mitigationBlackholeStart=mitigationBlackholeStart, mitigationTMSStartV2=mitigationTMSStartV2, bgpUp=bgpUp, spCommFailureDestination=spCommFailureDestination, deviceTotalFlowsHC=deviceTotalFlowsHC, spDNSExpected=spDNSExpected, spInetAddress=spInetAddress, hardwareFailure=hardwareFailure, spInterfaceUsageHC=spInterfaceUsageHC, deviceDiskUsage=deviceDiskUsage, trafficAutoMitigation=trafficAutoMitigation, spVersion=spVersion, spServiceElement=spServiceElement, spScriptCommand=spScriptCommand, spBlackholeNexthop=spBlackholeNexthop, interfaceUsageDone=interfaceUsageDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailover=routingFailover, spThirdPartyAddr=spThirdPartyAddr, cloudSignalingFaultDone=cloudSignalingFaultDone, fingerprintFeedback=fingerprintFeedback, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportURL=spReportURL, spFlowspecTimeout=spFlowspecTimeout, spInterfaceSpeedHC=spInterfaceSpeedHC, spMitigationName=spMitigationName, fingerprintUsage=fingerprintUsage, spManagedObject=spManagedObject, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationTMSStart=mitigationTMSStart, spLicenseErrDescription=spLicenseErrDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spReportName=spReportName, mitigationDone=mitigationDone, spScriptPort=spScriptPort, spDNSName=spDNSName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFault=cloudSignalingFault, fingerprintUsageDone=fingerprintUsageDone, interfaceUsage=interfaceUsage, peakflowSPTraps=peakflowSPTraps, serviceUsage=serviceUsage, spDNSObservedMean=spDNSObservedMean, spImpactPps=spImpactPps, spBGPInstability=spBGPInstability, dnsBaseline=dnsBaseline, spDNSObservedMax=spDNSObservedMax, spUsername=spUsername, serviceUsageDone=serviceUsageDone, snmpUp=snmpUp, spSystemErrorType=spSystemErrorType, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, peakflowSPMIB=peakflowSPMIB, spInterface=spInterface, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapEvent=spBGPTrapEvent, spDetector=spDetector, spInterfaceIndex=spInterfaceIndex, spAlertID=spAlertID, spBlackholeCommunity=spBlackholeCommunity, spServiceName=spServiceName, bgpInstabilityDone=bgpInstabilityDone, spDuration=spDuration, spBlackholePrefix=spBlackholePrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptHost=spScriptHost, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spMitigationStart=spMitigationStart, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spRouter=spRouter, bgpHijack=bgpHijack, spFingerprintName=spFingerprintName, bgpTrap=bgpTrap, managedObjectUsage=managedObjectUsage, collectorStart=collectorStart, licenseErrorDone=licenseErrorDone, spThreshold=spThreshold, alertScript=alertScript, spFingerprintSender=spFingerprintSender, spBGPTrapPrefix=spBGPTrapPrefix, greDownDone=greDownDone, spInetAddressType=spInetAddressType, peakflowSPMgr=peakflowSPMgr, spTMSPrefix=spTMSPrefix, autoclassifyStart=autoclassifyStart, spManagedObjectFamily=spManagedObjectFamily, spGreTunnelDestination=spGreTunnelDestination, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spcommFailureDone=spcommFailureDone, spHijackLocal=spHijackLocal, dosNetworkProfiledAlert=dosNetworkProfiledAlert, configChange=configChange, spFingerprintFeedback=spFingerprintFeedback, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterfaceUsage=spInterfaceUsage, spUnit=spUnit, spcommFailure=spcommFailure, spTMSMultiPrefix=spTMSMultiPrefix, spTMSTimeout=spTMSTimeout, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrType=spLicenseErrType, deviceSystemError=deviceSystemError, deviceSwapSpace=deviceSwapSpace, spUsage=spUsage, deviceHealth=deviceHealth, spApplicationName=spApplicationName)
