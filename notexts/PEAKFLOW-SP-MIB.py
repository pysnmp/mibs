...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:20:45 2022
...
iso, IpAddress, Counter32, Integer32, MibIdentifier, Bits, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, Gauge32, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "Integer32", "MibIdentifier", "Bits", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "Gauge32", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceDiskUsage=deviceDiskUsage, spDetectedCountries=spDetectedCountries, bgpTrap=bgpTrap, spScriptPort=spScriptPort, notificationLimit=notificationLimit, spBGPTrapNewAttributes=spBGPTrapNewAttributes, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spPravail=spPravail, licenseErrorDone=licenseErrorDone, spReportName=spReportName, spAlertDetectionSignatures=spAlertDetectionSignatures, spcommFailureDone=spcommFailureDone, spInterfaceIndex=spInterfaceIndex, cloudSignalingFaultDone=cloudSignalingFaultDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintFeedback=spFingerprintFeedback, managedObjectUsage=managedObjectUsage, mitigationBlackholeStart=mitigationBlackholeStart, greDownDone=greDownDone, hardwareFailure=hardwareFailure, spLicenseErrLimit=spLicenseErrLimit, spServiceElement=spServiceElement, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPInstability=spBGPInstability, spVersion=spVersion, dnsBaseline=dnsBaseline, flowDown=flowDown, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholePrefix=spBlackholePrefix, spMitigationID=spMitigationID, spBGPTrapEvent=spBGPTrapEvent, spHijackRoute=spHijackRoute, fingerprintUsage=fingerprintUsage, bgpInstability=bgpInstability, spCommFailureDescription=spCommFailureDescription, collectorUp=collectorUp, spReportURL=spReportURL, snmpDown=snmpDown, spDNSName=spDNSName, bgpDown=bgpDown, spFingerprintSender=spFingerprintSender, dnsBaselineDone=dnsBaselineDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUsageType=spUsageType, spHardwareFailureDescription=spHardwareFailureDescription, spGreTunnelName=spGreTunnelName, alertScript=alertScript, serviceUsageDone=serviceUsageDone, spTMSTimeout=spTMSTimeout, spFlowspecTimeout=spFlowspecTimeout, spBGPTrapPrefix=spBGPTrapPrefix, spLicenseErrType=spLicenseErrType, mitigationTMSStartV2=mitigationTMSStartV2, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpHijack=bgpHijack, flowUp=flowUp, spLicenseErrCount=spLicenseErrCount, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spFlowspecCommunity=spFlowspecCommunity, fingerprintReceive=fingerprintReceive, spTMSCommunity=spTMSCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationDone=mitigationDone, trafficAutoMitigation=trafficAutoMitigation, spSystemErrorDescription=spSystemErrorDescription, spCollector=spCollector, fingerprintFeedback=fingerprintFeedback, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spInterface=spInterface, spServiceName=spServiceName, deviceTotalFlows=deviceTotalFlows, spDNSExpected=spDNSExpected, interfaceUsage=interfaceUsage, hardwareFailureDone=hardwareFailureDone, spThirdPartyAddr=spThirdPartyAddr, bgpUp=bgpUp, autoclassifyStart=autoclassifyStart, spInterfaceUsage=spInterfaceUsage, spBGPTrapName=spBGPTrapName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationTMSStart=mitigationTMSStart, spBlackholeCommunity=spBlackholeCommunity, cloudSignalingFault=cloudSignalingFault, spThirdPartyZone=spThirdPartyZone, spInterfaceUsageHC=spInterfaceUsageHC, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptHost=spScriptHost, spDNSObservedMean=spDNSObservedMean, spManagedObjects=spManagedObjects, deviceSwapSpace=deviceSwapSpace, interfaceUsageDone=interfaceUsageDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spScriptStart=spScriptStart, spApplicationName=spApplicationName, peakflowSPMIB=peakflowSPMIB, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSMultiPrefix=spTMSMultiPrefix, spMitigationName=spMitigationName, routingFailover=routingFailover, spDNSObserved=spDNSObserved, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSObservedMax=spDNSObservedMax, spReportID=spReportID, greDown=greDown, spUsername=spUsername, spInetAddressType=spInetAddressType, spAlertID=spAlertID, spFingerprintMessage=spFingerprintMessage, spSystemErrorType=spSystemErrorType, fingerprintUsageDone=fingerprintUsageDone, peakflowSPMgr=peakflowSPMgr, spDetector=spDetector, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, serviceUsage=serviceUsage, dosHostDetectionAlert=dosHostDetectionAlert, spTMSPrefix=spTMSPrefix, collectorStart=collectorStart, configChange=configChange, spImpactBps=spImpactBps, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPEvent=spBGPEvent, reportDone=reportDone, spInetAddress=spInetAddress, managedObjectUsageDone=managedObjectUsageDone, spUnit=spUnit, licenseError=licenseError, spcommFailure=spcommFailure, spImpactPps=spImpactPps, spBlackholeTimeout=spBlackholeTimeout, spHijackLocal=spHijackLocal, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTraps=peakflowSPTraps, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCommFailureDestination=spCommFailureDestination, bgpInstabilityDone=bgpInstabilityDone, spFingerprintName=spFingerprintName, spThreshold=spThreshold, spRouter=spRouter, spManagedObjectFamily=spManagedObjectFamily, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPCMI=peakflowSPCMI, spHijackAttr=spHijackAttr, collectorDown=collectorDown, spGreTunnelDestination=spGreTunnelDestination, snmpUp=snmpUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDuration=spDuration, spManagedObject=spManagedObject, spUsage=spUsage, spMitigationStart=spMitigationStart, spScriptCommand=spScriptCommand, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBlackholeNexthop=spBlackholeNexthop, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSystemError=deviceSystemError, deviceHealth=deviceHealth, spInterfaceSpeed=spInterfaceSpeed)
