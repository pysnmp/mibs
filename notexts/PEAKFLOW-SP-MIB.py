...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, ModuleIdentity, Unsigned32, NotificationType, Gauge32, MibIdentifier, Integer32, Counter64, TimeTicks, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spImpactBps=spImpactBps, mitigationBlackholeStart=mitigationBlackholeStart, spReportURL=spReportURL, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, bgpInstability=bgpInstability, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spManagedObjects=spManagedObjects, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowUp=flowUp, spUnit=spUnit, spReportName=spReportName, bgpUp=bgpUp, interfaceUsageDone=interfaceUsageDone, flowDown=flowDown, spTMSPrefix=spTMSPrefix, spFlowspecTimeout=spFlowspecTimeout, spDetectedCountries=spDetectedCountries, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDNSObserved=spDNSObserved, spBGPTrapEvent=spBGPTrapEvent, peakflowSPCMI=peakflowSPCMI, devicePhysicalMemory=devicePhysicalMemory, licenseErrorDone=licenseErrorDone, spCollector=spCollector, serviceUsageDone=serviceUsageDone, spFingerprintName=spFingerprintName, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, managedObjectUsage=managedObjectUsage, fingerprintFeedback=fingerprintFeedback, mitigationThirdPartyStart=mitigationThirdPartyStart, spDuration=spDuration, spDNSObservedMax=spDNSObservedMax, spInetAddressType=spInetAddressType, spBlackholePrefix=spBlackholePrefix, spFingerprintMessage=spFingerprintMessage, spTMSTimeout=spTMSTimeout, spLicenseErrLimit=spLicenseErrLimit, bgpTrap=bgpTrap, spHijackAttr=spHijackAttr, spRouter=spRouter, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spApplicationName=spApplicationName, cloudSignalingFault=cloudSignalingFault, spVersion=spVersion, collectorUp=collectorUp, spPravail=spPravail, spMitigationName=spMitigationName, spBlackholeCommunity=spBlackholeCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, peakflowSPMIB=peakflowSPMIB, bgpInstabilityDone=bgpInstabilityDone, mitigationTMSStartV2=mitigationTMSStartV2, spUsage=spUsage, spInterfaceIndex=spInterfaceIndex, spLicenseErrType=spLicenseErrType, spScriptPort=spScriptPort, spCommFailureDescription=spCommFailureDescription, spHijackLocal=spHijackLocal, mitigationTMSStart=mitigationTMSStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpDown=snmpDown, greDown=greDown, spSystemErrorType=spSystemErrorType, spAlertID=spAlertID, spDNSExpected=spDNSExpected, spTMSCommunity=spTMSCommunity, interfaceUsage=interfaceUsage, managedObjectUsageDone=managedObjectUsageDone, greDownDone=greDownDone, mitigationFlowspecStart=mitigationFlowspecStart, spCommFailureDestination=spCommFailureDestination, spInterfaceUsageHC=spInterfaceUsageHC, spHijackRoute=spHijackRoute, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, configChange=configChange, fingerprintReceive=fingerprintReceive, peakflowSPTraps=peakflowSPTraps, peakflowSPMgr=peakflowSPMgr, spBGPTrapNewAttributes=spBGPTrapNewAttributes, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceSwapSpace=deviceSwapSpace, spDNSName=spDNSName, spSystemErrorDescription=spSystemErrorDescription, spInterfaceUsage=spInterfaceUsage, spGreTunnelName=spGreTunnelName, fingerprintUsageDone=fingerprintUsageDone, spMitigationID=spMitigationID, spBGPTrapName=spBGPTrapName, spManagedObject=spManagedObject, spInterface=spInterface, alertScript=alertScript, deviceSystemError=deviceSystemError, spUsageType=spUsageType, spFingerprintFeedback=spFingerprintFeedback, spBGPEvent=spBGPEvent, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spDNSObservedMean=spDNSObservedMean, spBGPInstability=spBGPInstability, licenseError=licenseError, spGreTunnelDestination=spGreTunnelDestination, bgpDown=bgpDown, reportDone=reportDone, spScriptHost=spScriptHost, spLicenseErrCount=spLicenseErrCount, spInterfaceSpeed=spInterfaceSpeed, dnsBaselineDone=dnsBaselineDone, spThirdPartyZone=spThirdPartyZone, spScriptCommand=spScriptCommand, autoclassifyStart=autoclassifyStart, deviceTotalFlows=deviceTotalFlows, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, collectorDown=collectorDown, hardwareFailureDone=hardwareFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, deviceHealth=deviceHealth, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailure=spcommFailure, spServiceName=spServiceName, spInetAddress=spInetAddress, spFingerprintSender=spFingerprintSender, spLicenseErrDescription=spLicenseErrDescription, spBGPTrapPrefix=spBGPTrapPrefix, serviceUsage=serviceUsage, dosHostDetectionAlert=dosHostDetectionAlert, routingFailover=routingFailover, fingerprintUsage=fingerprintUsage, deviceDiskUsage=deviceDiskUsage, trafficAutoMitigation=trafficAutoMitigation, spcommFailureDone=spcommFailureDone, spThreshold=spThreshold, spBlackholeTimeout=spBlackholeTimeout, notificationLimit=notificationLimit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyAddr=spThirdPartyAddr, spServiceElement=spServiceElement, spTMSMultiPrefix=spTMSMultiPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, spManagedObjectFamily=spManagedObjectFamily, spDetector=spDetector, snmpUp=snmpUp, mitigationDone=mitigationDone, spMitigationStart=spMitigationStart, spImpactPps=spImpactPps, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptStart=spScriptStart, collectorStart=collectorStart, dnsBaseline=dnsBaseline, spReportID=spReportID, bgpHijack=bgpHijack, spBlackholeNexthop=spBlackholeNexthop, spAlertDetectionSignatures=spAlertDetectionSignatures, hardwareFailure=hardwareFailure, spHardwareFailureDescription=spHardwareFailureDescription, spUsername=spUsername, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spFlowspecCommunity=spFlowspecCommunity)
