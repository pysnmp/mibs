...
# Produced by pysmi-1.1.12 at Mon Jun  3 12:17:34 2024
...
Counter32, ModuleIdentity, Bits, iso, IpAddress, Counter64, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ObjectIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Bits", "iso", "IpAddress", "Counter64", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ObjectIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spReportURL=spReportURL, serviceUsage=serviceUsage, spServiceName=spServiceName, serviceUsageDone=serviceUsageDone, bgpUp=bgpUp, spTMSTimeout=spTMSTimeout, spInetAddress=spInetAddress, spDetectedCountries=spDetectedCountries, spManagedObjectFamily=spManagedObjectFamily, spTMSCommunity=spTMSCommunity, spManagedObjects=spManagedObjects, spImpactBps=spImpactBps, peakflowSPMgr=peakflowSPMgr, spBGPTrapPrefix=spBGPTrapPrefix, spDNSObserved=spDNSObserved, spDNSName=spDNSName, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapOldAttributes=spBGPTrapOldAttributes, hardwareFailure=hardwareFailure, spManagedObject=spManagedObject, spAlertID=spAlertID, trafficAutoMitigation=trafficAutoMitigation, spFlowspecCommunity=spFlowspecCommunity, deviceDiskUsage=deviceDiskUsage, spUsername=spUsername, spTMSMultiPrefix=spTMSMultiPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, spSystemErrorType=spSystemErrorType, spLicenseErrLimit=spLicenseErrLimit, dosHostDetectionAlert=dosHostDetectionAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, greDown=greDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, snmpUp=snmpUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, interfaceUsageDone=interfaceUsageDone, spScriptCommand=spScriptCommand, spBGPInstability=spBGPInstability, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dnsBaseline=dnsBaseline, spCollector=spCollector, spBGPTrapName=spBGPTrapName, spDuration=spDuration, spDNSExpected=spDNSExpected, mitigationDone=mitigationDone, spFingerprintMessage=spFingerprintMessage, spBGPEvent=spBGPEvent, flowUp=flowUp, spThirdPartyZone=spThirdPartyZone, autoclassifyStart=autoclassifyStart, mitigationTMSStart=mitigationTMSStart, spBGPTrapEvent=spBGPTrapEvent, spScriptStart=spScriptStart, bgpInstability=bgpInstability, spServiceElement=spServiceElement, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintUsageDone=fingerprintUsageDone, spDetector=spDetector, mitigationFlowspecStart=mitigationFlowspecStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterfaceUsageHC=spInterfaceUsageHC, spUsageType=spUsageType, peakflowSPCMI=peakflowSPCMI, spMitigationName=spMitigationName, peakflowSPTraps=peakflowSPTraps, spReportID=spReportID, spCommFailureDescription=spCommFailureDescription, spFingerprintSender=spFingerprintSender, deviceTotalFlowsHC=deviceTotalFlowsHC, spUnit=spUnit, bgpDown=bgpDown, spRouter=spRouter, collectorUp=collectorUp, spMitigationStart=spMitigationStart, deviceTotalFlows=deviceTotalFlows, mitigationTMSStartV2=mitigationTMSStartV2, spLicenseErrType=spLicenseErrType, flowDown=flowDown, dnsBaselineDone=dnsBaselineDone, spcommFailureDone=spcommFailureDone, fingerprintReceive=fingerprintReceive, spInetAddressType=spInetAddressType, deviceHealth=deviceHealth, spTMSPrefix=spTMSPrefix, spBlackholeCommunity=spBlackholeCommunity, spBlackholePrefix=spBlackholePrefix, spVersion=spVersion, spHijackAttr=spHijackAttr, cloudSignalingFault=cloudSignalingFault, deviceSwapSpace=deviceSwapSpace, spHardwareFailureDescription=spHardwareFailureDescription, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spMitigationID=spMitigationID, notificationLimit=notificationLimit, fingerprintFeedback=fingerprintFeedback, fingerprintUsage=fingerprintUsage, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceSystemError=deviceSystemError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceSpeed=spInterfaceSpeed, spGreTunnelDestination=spGreTunnelDestination, dosHostDetectionAlertDone=dosHostDetectionAlertDone, interfaceUsage=interfaceUsage, spUsage=spUsage, spScriptHost=spScriptHost, mitigationBlackholeStart=mitigationBlackholeStart, licenseError=licenseError, spcommFailure=spcommFailure, spScriptPort=spScriptPort, spThreshold=spThreshold, hardwareFailureDone=hardwareFailureDone, greDownDone=greDownDone, spFlowspecTimeout=spFlowspecTimeout, bgpInstabilityDone=bgpInstabilityDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportName=spReportName, bgpHijack=bgpHijack, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, routingFailover=routingFailover, licenseErrorDone=licenseErrorDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spFingerprintName=spFingerprintName, spDNSObservedMax=spDNSObservedMax, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spLicenseErrCount=spLicenseErrCount, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCommFailureDestination=spCommFailureDestination, spInterface=spInterface, spFingerprintFeedback=spFingerprintFeedback, spSystemErrorDescription=spSystemErrorDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spInterfaceUsage=spInterfaceUsage, spImpactPps=spImpactPps, managedObjectUsageDone=managedObjectUsageDone, peakflowSPMIB=peakflowSPMIB, spPravail=spPravail, deviceSystemErrorDone=deviceSystemErrorDone, configChange=configChange, reportDone=reportDone, spBlackholeNexthop=spBlackholeNexthop, spApplicationName=spApplicationName, bgpTrap=bgpTrap, spGreTunnelName=spGreTunnelName, alertScript=alertScript, managedObjectUsage=managedObjectUsage, spHijackLocal=spHijackLocal, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spDNSObservedMean=spDNSObservedMean, snmpDown=snmpDown, spInterfaceIndex=spInterfaceIndex, collectorDown=collectorDown, collectorStart=collectorStart, spHijackRoute=spHijackRoute, spBlackholeTimeout=spBlackholeTimeout)
