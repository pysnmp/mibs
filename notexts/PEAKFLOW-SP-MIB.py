...
# Produced by pysmi-1.1.8 at Thu Apr 27 09:09:58 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Gauge32, Counter32, IpAddress, iso, Counter64, Bits, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Gauge32", "Counter32", "IpAddress", "iso", "Counter64", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", hardwareFailureDone=hardwareFailureDone, spGreTunnelName=spGreTunnelName, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, alertScript=alertScript, interfaceUsage=interfaceUsage, spBlackholeCommunity=spBlackholeCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptCommand=spScriptCommand, spBGPInstability=spBGPInstability, flowUp=flowUp, spBGPEvent=spBGPEvent, deviceSystemError=deviceSystemError, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, flowDown=flowDown, peakflowSPCMI=peakflowSPCMI, spHijackLocal=spHijackLocal, deviceSwapSpace=deviceSwapSpace, spImpactBps=spImpactBps, spMitigationID=spMitigationID, collectorStart=collectorStart, spInterfaceIndex=spInterfaceIndex, fingerprintFeedback=fingerprintFeedback, spcommFailureDone=spcommFailureDone, fingerprintReceive=fingerprintReceive, spTMSTimeout=spTMSTimeout, bgpUp=bgpUp, spHardwareFailureDescription=spHardwareFailureDescription, spInterface=spInterface, hardwareFailure=hardwareFailure, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, trafficAutoMitigation=trafficAutoMitigation, bgpInstability=bgpInstability, snmpDown=snmpDown, spCollector=spCollector, spManagedObject=spManagedObject, spBlackholeTimeout=spBlackholeTimeout, serviceUsageDone=serviceUsageDone, spAlertID=spAlertID, deviceHealth=deviceHealth, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spRouter=spRouter, spTMSPrefix=spTMSPrefix, fingerprintUsageDone=fingerprintUsageDone, spDNSObservedMax=spDNSObservedMax, mitigationFlowspecStart=mitigationFlowspecStart, deviceDiskUsage=deviceDiskUsage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorDown=collectorDown, managedObjectUsage=managedObjectUsage, routingFailover=routingFailover, spThreshold=spThreshold, spLicenseErrType=spLicenseErrType, spReportURL=spReportURL, spDetectedCountries=spDetectedCountries, spDetector=spDetector, spReportName=spReportName, spFingerprintMessage=spFingerprintMessage, deviceTotalFlows=deviceTotalFlows, spFlowspecTimeout=spFlowspecTimeout, spBlackholePrefix=spBlackholePrefix, spTMSMultiPrefix=spTMSMultiPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPMgr=peakflowSPMgr, spUsage=spUsage, peakflowSPTraps=peakflowSPTraps, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spFingerprintSender=spFingerprintSender, spHijackAttr=spHijackAttr, spScriptPort=spScriptPort, spInetAddress=spInetAddress, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, reportDone=reportDone, spCommFailureDescription=spCommFailureDescription, greDownDone=greDownDone, mitigationTMSStartV2=mitigationTMSStartV2, PYSNMP_MODULE_ID=peakflowSPMIB, spBlackholeNexthop=spBlackholeNexthop, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spBGPTrapNewAttributes=spBGPTrapNewAttributes, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spMitigationStart=spMitigationStart, spVersion=spVersion, spMitigationName=spMitigationName, spManagedObjects=spManagedObjects, spFlowspecCommunity=spFlowspecCommunity, spUsername=spUsername, spUsageType=spUsageType, spFingerprintName=spFingerprintName, managedObjectUsageDone=managedObjectUsageDone, configChange=configChange, spServiceName=spServiceName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, snmpUp=snmpUp, collectorUp=collectorUp, notificationLimit=notificationLimit, spInterfaceSpeed=spInterfaceSpeed, dnsBaselineDone=dnsBaselineDone, bgpDown=bgpDown, spDNSObserved=spDNSObserved, spUnit=spUnit, bgpTrap=bgpTrap, spCommFailureDestination=spCommFailureDestination, cloudSignalingFault=cloudSignalingFault, spPravail=spPravail, spBGPTrapPrefix=spBGPTrapPrefix, spcommFailure=spcommFailure, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintFeedback=spFingerprintFeedback, autoclassifyStart=autoclassifyStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spManagedObjectFamily=spManagedObjectFamily, spThirdPartyAddr=spThirdPartyAddr, spInterfaceUsage=spInterfaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationDone=mitigationDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spImpactPps=spImpactPps, spAlertDetectionSignatures=spAlertDetectionSignatures, serviceUsage=serviceUsage, deviceSystemErrorDone=deviceSystemErrorDone, devicePhysicalMemory=devicePhysicalMemory, spInetAddressType=spInetAddressType, dnsBaseline=dnsBaseline, spLicenseErrLimit=spLicenseErrLimit, spInterfaceSpeedHC=spInterfaceSpeedHC, spSystemErrorType=spSystemErrorType, spLicenseErrDescription=spLicenseErrDescription, licenseError=licenseError, spDNSName=spDNSName, spBGPTrapName=spBGPTrapName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spServiceElement=spServiceElement, interfaceUsageDone=interfaceUsageDone, mitigationTMSStart=mitigationTMSStart, peakflowSPMIB=peakflowSPMIB, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrCount=spLicenseErrCount, spDuration=spDuration, spInterfaceUsageHC=spInterfaceUsageHC, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptStart=spScriptStart, bgpInstabilityDone=bgpInstabilityDone, spDNSExpected=spDNSExpected, spThirdPartyZone=spThirdPartyZone, spReportID=spReportID, fingerprintUsage=fingerprintUsage, dosHostDetectionAlert=dosHostDetectionAlert, spHijackRoute=spHijackRoute, greDown=greDown, spScriptHost=spScriptHost, bgpHijack=bgpHijack, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMean=spDNSObservedMean, licenseErrorDone=licenseErrorDone, spTMSCommunity=spTMSCommunity, spApplicationName=spApplicationName, spGreTunnelDestination=spGreTunnelDestination, mitigationBlackholeStart=mitigationBlackholeStart)
