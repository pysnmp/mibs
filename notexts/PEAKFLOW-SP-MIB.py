...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:04:35 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, MibIdentifier, NotificationType, Counter32, Bits, ObjectIdentity, IpAddress, TimeTicks, Counter64, iso, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "MibIdentifier", "NotificationType", "Counter32", "Bits", "ObjectIdentity", "IpAddress", "TimeTicks", "Counter64", "iso", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyZone=spThirdPartyZone, collectorStart=collectorStart, spDetector=spDetector, dnsBaseline=dnsBaseline, spBGPTrapName=spBGPTrapName, deviceSystemError=deviceSystemError, deviceSystemErrorDone=deviceSystemErrorDone, serviceUsage=serviceUsage, deviceDiskUsage=deviceDiskUsage, collectorDown=collectorDown, spManagedObject=spManagedObject, spTMSTimeout=spTMSTimeout, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spApplicationName=spApplicationName, collectorUp=collectorUp, spSystemErrorType=spSystemErrorType, spDuration=spDuration, spInterfaceIndex=spInterfaceIndex, spInterfaceUsage=spInterfaceUsage, managedObjectUsage=managedObjectUsage, spTMSMultiPrefix=spTMSMultiPrefix, spInterface=spInterface, fingerprintFeedback=fingerprintFeedback, spSystemErrorDescription=spSystemErrorDescription, spFingerprintFeedback=spFingerprintFeedback, managedObjectUsageDone=managedObjectUsageDone, spReportURL=spReportURL, bgpInstabilityDone=bgpInstabilityDone, spBlackholeTimeout=spBlackholeTimeout, spVersion=spVersion, spPravail=spPravail, flowDown=flowDown, notificationLimit=notificationLimit, spScriptHost=spScriptHost, reportDone=reportDone, spcommFailure=spcommFailure, autoclassifyStart=autoclassifyStart, snmpDown=snmpDown, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPInstability=spBGPInstability, spDNSName=spDNSName, licenseErrorDone=licenseErrorDone, spLicenseErrCount=spLicenseErrCount, greDownDone=greDownDone, mitigationFlowspecStart=mitigationFlowspecStart, spFingerprintMessage=spFingerprintMessage, spLicenseErrType=spLicenseErrType, spAlertDetectionSignatures=spAlertDetectionSignatures, fingerprintReceive=fingerprintReceive, spMitigationName=spMitigationName, bgpTrap=bgpTrap, mitigationTMSStartV2=mitigationTMSStartV2, spHijackRoute=spHijackRoute, spLicenseErrDescription=spLicenseErrDescription, bgpInstability=bgpInstability, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObjectFamily=spManagedObjectFamily, dnsBaselineDone=dnsBaselineDone, spReportName=spReportName, spHijackLocal=spHijackLocal, spLicenseErrLimit=spLicenseErrLimit, mitigationDone=mitigationDone, spcommFailureDone=spcommFailureDone, cloudSignalingFault=cloudSignalingFault, spInetAddress=spInetAddress, spCommFailureDestination=spCommFailureDestination, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHardwareFailureDescription=spHardwareFailureDescription, configChange=configChange, spServiceElement=spServiceElement, dosHostDetectionAlert=dosHostDetectionAlert, spBGPTrapEvent=spBGPTrapEvent, peakflowSPMgr=peakflowSPMgr, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, trafficAutoMitigation=trafficAutoMitigation, spReportID=spReportID, spScriptCommand=spScriptCommand, serviceUsageDone=serviceUsageDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spServiceName=spServiceName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyAddr=spThirdPartyAddr, spInetAddressType=spInetAddressType, licenseError=licenseError, peakflowSPCMI=peakflowSPCMI, spDetectedCountries=spDetectedCountries, bgpUp=bgpUp, spUsage=spUsage, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDNSObservedMean=spDNSObservedMean, mitigationTMSStart=mitigationTMSStart, spBGPEvent=spBGPEvent, spTMSPrefix=spTMSPrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceTotalFlows=deviceTotalFlows, interfaceUsage=interfaceUsage, spMitigationID=spMitigationID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCloudSignalFaultDescription=spCloudSignalFaultDescription, routingFailover=routingFailover, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCollector=spCollector, spGreTunnelDestination=spGreTunnelDestination, spFingerprintSender=spFingerprintSender, hardwareFailureDone=hardwareFailureDone, spBlackholeCommunity=spBlackholeCommunity, fingerprintUsage=fingerprintUsage, spDNSObservedMax=spDNSObservedMax, snmpUp=snmpUp, deviceHealth=deviceHealth, peakflowSPTraps=peakflowSPTraps, spAlertID=spAlertID, greDown=greDown, spBGPTrapPrefix=spBGPTrapPrefix, PYSNMP_MODULE_ID=peakflowSPMIB, spScriptStart=spScriptStart, spInterfaceSpeed=spInterfaceSpeed, spMitigationStart=spMitigationStart, spTMSCommunity=spTMSCommunity, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spThreshold=spThreshold, spFlowspecTimeout=spFlowspecTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsageType=spUsageType, spBlackholeNexthop=spBlackholeNexthop, spDNSObserved=spDNSObserved, spManagedObjects=spManagedObjects, bgpDown=bgpDown, spInterfaceSpeedHC=spInterfaceSpeedHC, spRouter=spRouter, spGreTunnelName=spGreTunnelName, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemory=devicePhysicalMemory, peakflowSPMIB=peakflowSPMIB, spFlowspecCommunity=spFlowspecCommunity, interfaceUsageDone=interfaceUsageDone, fingerprintUsageDone=fingerprintUsageDone, spScriptPort=spScriptPort, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spImpactPps=spImpactPps, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSwapSpace=deviceSwapSpace, spUnit=spUnit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, flowUp=flowUp, spHijackAttr=spHijackAttr, spDNSExpected=spDNSExpected, bgpHijack=bgpHijack, alertScript=alertScript, spUsername=spUsername, spFingerprintName=spFingerprintName, mitigationBlackholeStart=mitigationBlackholeStart, spBlackholePrefix=spBlackholePrefix)
