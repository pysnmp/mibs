...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:53:29 2022
...
iso, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Counter64, NotificationType, IpAddress, Unsigned32, Integer32, ModuleIdentity, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "IpAddress", "Unsigned32", "Integer32", "ModuleIdentity", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPEvent=spBGPEvent, serviceUsageDone=serviceUsageDone, spMitigationID=spMitigationID, snmpUp=snmpUp, spTMSPrefix=spTMSPrefix, spBGPInstability=spBGPInstability, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThirdPartyAddr=spThirdPartyAddr, spHijackLocal=spHijackLocal, spManagedObjectFamily=spManagedObjectFamily, spFingerprintSender=spFingerprintSender, spScriptCommand=spScriptCommand, spThirdPartyZone=spThirdPartyZone, managedObjectUsage=managedObjectUsage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spServiceElement=spServiceElement, fingerprintReceive=fingerprintReceive, peakflowSPMIB=peakflowSPMIB, cloudSignalingFaultDone=cloudSignalingFaultDone, spPravail=spPravail, spUsageType=spUsageType, spDNSName=spDNSName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spVersion=spVersion, spDetector=spDetector, spThreshold=spThreshold, spInetAddress=spInetAddress, mitigationThirdPartyStart=mitigationThirdPartyStart, spHardwareFailureDescription=spHardwareFailureDescription, spInterface=spInterface, spSystemErrorDescription=spSystemErrorDescription, dosNetworkProfiledAlert=dosNetworkProfiledAlert, interfaceUsage=interfaceUsage, spServiceName=spServiceName, trafficAutoMitigation=trafficAutoMitigation, spDNSExpected=spDNSExpected, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, spInterfaceUsage=spInterfaceUsage, flowUp=flowUp, mitigationTMSStart=mitigationTMSStart, spLicenseErrCount=spLicenseErrCount, spInterfaceSpeed=spInterfaceSpeed, deviceDiskUsage=deviceDiskUsage, spGreTunnelName=spGreTunnelName, spMitigationName=spMitigationName, dnsBaseline=dnsBaseline, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintName=spFingerprintName, spCommFailureDestination=spCommFailureDestination, hardwareFailureDone=hardwareFailureDone, spBlackholeCommunity=spBlackholeCommunity, spDNSObserved=spDNSObserved, alertScript=alertScript, deviceSwapSpaceUsage=deviceSwapSpaceUsage, cloudSignalingFault=cloudSignalingFault, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDetectedCountries=spDetectedCountries, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInterfaceIndex=spInterfaceIndex, spBGPTrapName=spBGPTrapName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, peakflowSPCMI=peakflowSPCMI, spRouter=spRouter, spReportID=spReportID, greDown=greDown, spFlowspecCommunity=spFlowspecCommunity, fingerprintUsage=fingerprintUsage, managedObjectUsageDone=managedObjectUsageDone, routingFailover=routingFailover, reportDone=reportDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, collectorUp=collectorUp, spBGPTrapPrefix=spBGPTrapPrefix, spImpactPps=spImpactPps, spFingerprintMessage=spFingerprintMessage, spBlackholePrefix=spBlackholePrefix, mitigationDone=mitigationDone, spLicenseErrType=spLicenseErrType, devicePhysicalMemory=devicePhysicalMemory, dosHostDetectionAlertDone=dosHostDetectionAlertDone, autoclassifyStart=autoclassifyStart, deviceSystemErrorDone=deviceSystemErrorDone, spFlowspecTimeout=spFlowspecTimeout, spLicenseErrDescription=spLicenseErrDescription, licenseErrorDone=licenseErrorDone, spReportName=spReportName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spImpactBps=spImpactBps, dnsBaselineDone=dnsBaselineDone, bgpTrap=bgpTrap, spDNSObservedMean=spDNSObservedMean, spUsername=spUsername, spDuration=spDuration, spUsage=spUsage, spHijackRoute=spHijackRoute, bgpDown=bgpDown, spLicenseErrLimit=spLicenseErrLimit, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholeTimeout=spBlackholeTimeout, spInterfaceSpeedHC=spInterfaceSpeedHC, hardwareFailure=hardwareFailure, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spTMSTimeout=spTMSTimeout, spScriptStart=spScriptStart, spApplicationName=spApplicationName, collectorDown=collectorDown, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceUsageHC=spInterfaceUsageHC, spFingerprintFeedback=spFingerprintFeedback, bgpInstabilityDone=bgpInstabilityDone, serviceUsage=serviceUsage, spCollector=spCollector, deviceSystemError=deviceSystemError, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, collectorStart=collectorStart, spGreTunnelDestination=spGreTunnelDestination, spBlackholeNexthop=spBlackholeNexthop, snmpDown=snmpDown, deviceTotalFlows=deviceTotalFlows, licenseError=licenseError, bgpUp=bgpUp, spcommFailureDone=spcommFailureDone, spSystemErrorType=spSystemErrorType, mitigationFlowspecStart=mitigationFlowspecStart, spAlertDetectionSignatures=spAlertDetectionSignatures, flowDown=flowDown, spMitigationStart=spMitigationStart, spHijackAttr=spHijackAttr, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObject=spManagedObject, spManagedObjects=spManagedObjects, spUnit=spUnit, notificationLimit=notificationLimit, configChange=configChange, bgpHijack=bgpHijack, spInetAddressType=spInetAddressType, greDownDone=greDownDone, spDNSObservedMax=spDNSObservedMax, peakflowSPMgr=peakflowSPMgr, spBGPTrapEvent=spBGPTrapEvent, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintFeedback=fingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, bgpInstability=bgpInstability, dosHostDetectionAlert=dosHostDetectionAlert, spScriptHost=spScriptHost, spReportURL=spReportURL, deviceSwapSpace=deviceSwapSpace, spcommFailure=spcommFailure, interfaceUsageDone=interfaceUsageDone, spTMSCommunity=spTMSCommunity, spTMSMultiPrefix=spTMSMultiPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spScriptPort=spScriptPort, peakflowSPTraps=peakflowSPTraps, spAlertID=spAlertID, deviceHealth=deviceHealth, spCommFailureDescription=spCommFailureDescription, mitigationBlackholeStart=mitigationBlackholeStart)
