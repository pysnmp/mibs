...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:52:09 2023
...
ObjectIdentity, NotificationType, Unsigned32, ModuleIdentity, iso, Bits, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Unsigned32", "ModuleIdentity", "iso", "Bits", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceHealth=deviceHealth, dnsBaseline=dnsBaseline, bgpTrap=bgpTrap, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, peakflowSPMgr=peakflowSPMgr, peakflowSPMIB=peakflowSPMIB, spHijackRoute=spHijackRoute, peakflowSPTraps=peakflowSPTraps, spDetector=spDetector, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, collectorDown=collectorDown, deviceDiskUsage=deviceDiskUsage, fingerprintUsage=fingerprintUsage, spFingerprintSender=spFingerprintSender, spScriptStart=spScriptStart, cloudSignalingFaultDone=cloudSignalingFaultDone, fingerprintFeedback=fingerprintFeedback, hardwareFailure=hardwareFailure, mitigationTMSStart=mitigationTMSStart, spBGPTrapEvent=spBGPTrapEvent, dosHostDetectionAlertDone=dosHostDetectionAlertDone, flowUp=flowUp, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrLimit=spLicenseErrLimit, spMitigationName=spMitigationName, spDuration=spDuration, spcommFailureDone=spcommFailureDone, spThirdPartyAddr=spThirdPartyAddr, autoclassifyStart=autoclassifyStart, spGreTunnelDestination=spGreTunnelDestination, spUsageType=spUsageType, spLicenseErrType=spLicenseErrType, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpDown=bgpDown, trafficAutoMitigation=trafficAutoMitigation, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceTotalFlows=deviceTotalFlows, collectorStart=collectorStart, spReportName=spReportName, spFingerprintName=spFingerprintName, spBGPTrapPrefix=spBGPTrapPrefix, interfaceUsage=interfaceUsage, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spApplicationName=spApplicationName, spManagedObject=spManagedObject, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spHijackAttr=spHijackAttr, spReportID=spReportID, spManagedObjectFamily=spManagedObjectFamily, spVersion=spVersion, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceIndex=spInterfaceIndex, spScriptCommand=spScriptCommand, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spThirdPartyZone=spThirdPartyZone, spDNSObserved=spDNSObserved, serviceUsage=serviceUsage, devicePhysicalMemory=devicePhysicalMemory, bgpInstabilityDone=bgpInstabilityDone, spInterfaceUsageHC=spInterfaceUsageHC, spTMSPrefix=spTMSPrefix, spFlowspecCommunity=spFlowspecCommunity, spcommFailure=spcommFailure, greDown=greDown, spFingerprintMessage=spFingerprintMessage, deviceSystemError=deviceSystemError, interfaceUsageDone=interfaceUsageDone, reportDone=reportDone, spRouter=spRouter, spScriptPort=spScriptPort, snmpDown=snmpDown, collectorUp=collectorUp, spDNSExpected=spDNSExpected, spBGPEvent=spBGPEvent, spBlackholeCommunity=spBlackholeCommunity, spGreTunnelName=spGreTunnelName, managedObjectUsage=managedObjectUsage, flowDown=flowDown, mitigationDone=mitigationDone, spUsername=spUsername, spMitigationID=spMitigationID, dnsBaselineDone=dnsBaselineDone, licenseError=licenseError, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSTimeout=spTMSTimeout, spDNSObservedMax=spDNSObservedMax, spDNSObservedMean=spDNSObservedMean, cloudSignalingFault=cloudSignalingFault, managedObjectUsageDone=managedObjectUsageDone, spScriptHost=spScriptHost, spBlackholePrefix=spBlackholePrefix, alertScript=alertScript, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationFlowspecStart=mitigationFlowspecStart, bgpHijack=bgpHijack, serviceUsageDone=serviceUsageDone, spImpactPps=spImpactPps, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceSpeed=spInterfaceSpeed, spCommFailureDescription=spCommFailureDescription, greDownDone=greDownDone, spInetAddressType=spInetAddressType, peakflowSPCMI=peakflowSPCMI, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceSpeedHC=spInterfaceSpeedHC, spSystemErrorType=spSystemErrorType, spHijackLocal=spHijackLocal, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spServiceName=spServiceName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSystemErrorDone=deviceSystemErrorDone, dosHostDetectionAlert=dosHostDetectionAlert, spTMSCommunity=spTMSCommunity, spAlertID=spAlertID, spInterfaceUsage=spInterfaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, notificationLimit=notificationLimit, configChange=configChange, spUsage=spUsage, spSystemErrorDescription=spSystemErrorDescription, spDNSName=spDNSName, spInterface=spInterface, spImpactBps=spImpactBps, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spUnit=spUnit, hardwareFailureDone=hardwareFailureDone, spBGPTrapName=spBGPTrapName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpUp=bgpUp, spInetAddress=spInetAddress, routingFailover=routingFailover, fingerprintReceive=fingerprintReceive, spManagedObjects=spManagedObjects, spCollector=spCollector, spTMSMultiPrefix=spTMSMultiPrefix, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintFeedback=spFingerprintFeedback, licenseErrorDone=licenseErrorDone, spDetectedCountries=spDetectedCountries, spPravail=spPravail, bgpInstability=bgpInstability, spThreshold=spThreshold, spMitigationStart=spMitigationStart, spReportURL=spReportURL, spLicenseErrCount=spLicenseErrCount, snmpUp=snmpUp, spBlackholeNexthop=spBlackholeNexthop, spBGPTrapNewAttributes=spBGPTrapNewAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSwapSpace=deviceSwapSpace, fingerprintUsageDone=fingerprintUsageDone, spFlowspecTimeout=spFlowspecTimeout, spServiceElement=spServiceElement, spCommFailureDestination=spCommFailureDestination, spBGPInstability=spBGPInstability, spBlackholeTimeout=spBlackholeTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate)
