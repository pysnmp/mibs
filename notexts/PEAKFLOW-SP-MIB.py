...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:37:01 2024
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Unsigned32, ModuleIdentity, iso, IpAddress, Integer32, Gauge32, MibIdentifier, ObjectIdentity, Bits, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Unsigned32", "ModuleIdentity", "iso", "IpAddress", "Integer32", "Gauge32", "MibIdentifier", "ObjectIdentity", "Bits", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPEvent=spBGPEvent, spReportURL=spReportURL, spDetectedCountries=spDetectedCountries, spInterfaceUsageHC=spInterfaceUsageHC, fingerprintReceive=fingerprintReceive, spUsername=spUsername, spImpactPps=spImpactPps, bgpDown=bgpDown, snmpDown=snmpDown, spGreTunnelDestination=spGreTunnelDestination, spCommFailureDescription=spCommFailureDescription, spHijackAttr=spHijackAttr, spCommFailureDestination=spCommFailureDestination, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrDescription=spLicenseErrDescription, fingerprintFeedback=fingerprintFeedback, routingFailover=routingFailover, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spUsageType=spUsageType, dosHostDetectionAlert=dosHostDetectionAlert, spAlertID=spAlertID, spScriptHost=spScriptHost, spDNSObservedMean=spDNSObservedMean, spLicenseErrLimit=spLicenseErrLimit, interfaceUsageDone=interfaceUsageDone, deviceDiskUsage=deviceDiskUsage, cloudSignalingFault=cloudSignalingFault, spFlowspecCommunity=spFlowspecCommunity, spManagedObjectFamily=spManagedObjectFamily, spFingerprintSender=spFingerprintSender, spDNSObservedMax=spDNSObservedMax, dnsBaselineDone=dnsBaselineDone, licenseError=licenseError, peakflowSPMIB=peakflowSPMIB, spDNSExpected=spDNSExpected, reportDone=reportDone, serviceUsage=serviceUsage, spInterface=spInterface, spApplicationName=spApplicationName, devicePhysicalMemory=devicePhysicalMemory, greDownDone=greDownDone, managedObjectUsageDone=managedObjectUsageDone, spHijackLocal=spHijackLocal, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpTrap=bgpTrap, spBlackholePrefix=spBlackholePrefix, spTMSMultiPrefix=spTMSMultiPrefix, spVersion=spVersion, deviceSwapSpace=deviceSwapSpace, spFlowspecTimeout=spFlowspecTimeout, serviceUsageDone=serviceUsageDone, spPravail=spPravail, spDNSName=spDNSName, spGreTunnelName=spGreTunnelName, spCollector=spCollector, interfaceUsage=interfaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapPrefix=spBGPTrapPrefix, collectorUp=collectorUp, bgpInstabilityDone=bgpInstabilityDone, spTMSCommunity=spTMSCommunity, spMitigationStart=spMitigationStart, spTMSPrefix=spTMSPrefix, notificationLimit=notificationLimit, spcommFailure=spcommFailure, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapEvent=spBGPTrapEvent, spInterfaceSpeedHC=spInterfaceSpeedHC, trafficAutoMitigation=trafficAutoMitigation, alertScript=alertScript, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceHealth=deviceHealth, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpHijack=bgpHijack, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, collectorStart=collectorStart, spDuration=spDuration, spDetector=spDetector, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHijackRoute=spHijackRoute, spInetAddressType=spInetAddressType, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationID=spMitigationID, spCloudSignalFaultDescription=spCloudSignalFaultDescription, snmpUp=snmpUp, fingerprintUsageDone=fingerprintUsageDone, spThirdPartyZone=spThirdPartyZone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spThreshold=spThreshold, configChange=configChange, flowUp=flowUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spServiceElement=spServiceElement, deviceSystemErrorDone=deviceSystemErrorDone, spDNSObserved=spDNSObserved, spSystemErrorDescription=spSystemErrorDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceTotalFlows=deviceTotalFlows, spImpactBps=spImpactBps, peakflowSPMgr=peakflowSPMgr, spBGPTrapName=spBGPTrapName, spInterfaceUsage=spInterfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, flowDown=flowDown, spScriptStart=spScriptStart, spTMSTimeout=spTMSTimeout, spcommFailureDone=spcommFailureDone, autoclassifyStart=autoclassifyStart, collectorDown=collectorDown, spUsage=spUsage, greDown=greDown, peakflowSPCMI=peakflowSPCMI, spScriptCommand=spScriptCommand, deviceSystemError=deviceSystemError, spInetAddress=spInetAddress, PYSNMP_MODULE_ID=peakflowSPMIB, spLicenseErrCount=spLicenseErrCount, mitigationDone=mitigationDone, peakflowSPTraps=peakflowSPTraps, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spFingerprintMessage=spFingerprintMessage, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spManagedObject=spManagedObject, spHardwareFailureDescription=spHardwareFailureDescription, spThirdPartyAddr=spThirdPartyAddr, spBlackholeCommunity=spBlackholeCommunity, spMitigationName=spMitigationName, hardwareFailure=hardwareFailure, licenseErrorDone=licenseErrorDone, mitigationFlowspecStart=mitigationFlowspecStart, spUnit=spUnit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, fingerprintUsage=fingerprintUsage, bgpInstability=bgpInstability, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintName=spFingerprintName, spFingerprintFeedback=spFingerprintFeedback, spScriptPort=spScriptPort, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBlackholeTimeout=spBlackholeTimeout, spBlackholeNexthop=spBlackholeNexthop, spBGPInstability=spBGPInstability, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsage=managedObjectUsage, spLicenseErrType=spLicenseErrType, mitigationTMSStart=mitigationTMSStart, spRouter=spRouter, spReportID=spReportID, dnsBaseline=dnsBaseline, spInterfaceSpeed=spInterfaceSpeed, spServiceName=spServiceName, spReportName=spReportName, spSystemErrorType=spSystemErrorType, hardwareFailureDone=hardwareFailureDone, spInterfaceIndex=spInterfaceIndex, spManagedObjects=spManagedObjects, bgpUp=bgpUp)
