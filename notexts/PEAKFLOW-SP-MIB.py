...
# Produced by pysmi-1.1.8 at Mon Jan  9 14:06:18 2023
...
Bits, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Unsigned32, Gauge32, ObjectIdentity, iso, MibIdentifier, TimeTicks, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity", "iso", "MibIdentifier", "TimeTicks", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCollector=spCollector, spInterfaceUsageHC=spInterfaceUsageHC, dosHostDetectionAlertDone=dosHostDetectionAlertDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spDetector=spDetector, cloudSignalingFault=cloudSignalingFault, spMitigationStart=spMitigationStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsageType=spUsageType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, dosHostDetectionAlert=dosHostDetectionAlert, PYSNMP_MODULE_ID=peakflowSPMIB, dnsBaselineDone=dnsBaselineDone, spBGPInstability=spBGPInstability, serviceUsageDone=serviceUsageDone, peakflowSPMIB=peakflowSPMIB, spMitigationName=spMitigationName, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapEvent=spBGPTrapEvent, deviceTotalFlowsHC=deviceTotalFlowsHC, peakflowSPCMI=peakflowSPCMI, configChange=configChange, spInterfaceUsage=spInterfaceUsage, mitigationThirdPartyStart=mitigationThirdPartyStart, bgpHijack=bgpHijack, spServiceName=spServiceName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintSender=spFingerprintSender, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spServiceElement=spServiceElement, spAlertDetectionSignatures=spAlertDetectionSignatures, managedObjectUsage=managedObjectUsage, spScriptStart=spScriptStart, spInterfaceIndex=spInterfaceIndex, licenseError=licenseError, spHijackRoute=spHijackRoute, spDNSObservedMax=spDNSObservedMax, bgpInstability=bgpInstability, spInterface=spInterface, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spHardwareFailureDescription=spHardwareFailureDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, spThirdPartyZone=spThirdPartyZone, serviceUsage=serviceUsage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, peakflowSPMgr=peakflowSPMgr, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, fingerprintFeedback=fingerprintFeedback, spLicenseErrDescription=spLicenseErrDescription, snmpDown=snmpDown, spBlackholeNexthop=spBlackholeNexthop, spSystemErrorDescription=spSystemErrorDescription, spThreshold=spThreshold, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, collectorDown=collectorDown, spVersion=spVersion, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDuration=spDuration, spFingerprintFeedback=spFingerprintFeedback, spInterfaceSpeedHC=spInterfaceSpeedHC, spDetectedCountries=spDetectedCountries, spReportName=spReportName, mitigationFlowspecStart=mitigationFlowspecStart, spTMSCommunity=spTMSCommunity, mitigationBlackholeStart=mitigationBlackholeStart, deviceTotalFlows=deviceTotalFlows, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, collectorStart=collectorStart, mitigationDone=mitigationDone, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjectFamily=spManagedObjectFamily, spUnit=spUnit, spDNSObservedMean=spDNSObservedMean, spScriptHost=spScriptHost, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInetAddress=spInetAddress, spCommFailureDestination=spCommFailureDestination, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, flowUp=flowUp, spHijackAttr=spHijackAttr, spLicenseErrLimit=spLicenseErrLimit, deviceSwapSpace=deviceSwapSpace, spApplicationName=spApplicationName, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, greDownDone=greDownDone, dnsBaseline=dnsBaseline, bgpUp=bgpUp, fingerprintUsage=fingerprintUsage, spBlackholeTimeout=spBlackholeTimeout, reportDone=reportDone, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, autoclassifyStart=autoclassifyStart, spBlackholeCommunity=spBlackholeCommunity, spTMSMultiPrefix=spTMSMultiPrefix, deviceDiskUsage=deviceDiskUsage, spBGPTrapPrefix=spBGPTrapPrefix, notificationLimit=notificationLimit, spAlertID=spAlertID, spInetAddressType=spInetAddressType, spLicenseErrType=spLicenseErrType, deviceSystemErrorDone=deviceSystemErrorDone, spUsage=spUsage, mitigationTMSStart=mitigationTMSStart, spBGPTrapName=spBGPTrapName, collectorUp=collectorUp, bgpTrap=bgpTrap, spScriptPort=spScriptPort, spManagedObject=spManagedObject, deviceSystemError=deviceSystemError, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spHijackLocal=spHijackLocal, snmpUp=snmpUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholePrefix=spBlackholePrefix, spGreTunnelDestination=spGreTunnelDestination, managedObjectUsageDone=managedObjectUsageDone, spFlowspecTimeout=spFlowspecTimeout, spThirdPartyAddr=spThirdPartyAddr, trafficAutoMitigation=trafficAutoMitigation, spReportID=spReportID, alertScript=alertScript, spTMSTimeout=spTMSTimeout, spcommFailure=spcommFailure, spInterfaceSpeed=spInterfaceSpeed, spLicenseErrCount=spLicenseErrCount, spcommFailureDone=spcommFailureDone, interfaceUsageDone=interfaceUsageDone, bgpDown=bgpDown, spBGPEvent=spBGPEvent, spDNSName=spDNSName, spManagedObjects=spManagedObjects, spReportURL=spReportURL, spFingerprintMessage=spFingerprintMessage, spDNSExpected=spDNSExpected, hardwareFailureDone=hardwareFailureDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceHealth=deviceHealth, peakflowSPTraps=peakflowSPTraps, licenseErrorDone=licenseErrorDone, spGreTunnelName=spGreTunnelName, spDNSObserved=spDNSObserved, spTMSPrefix=spTMSPrefix, interfaceUsage=interfaceUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spRouter=spRouter, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spSystemErrorType=spSystemErrorType, spUsername=spUsername, spScriptCommand=spScriptCommand, fingerprintReceive=fingerprintReceive, spPravail=spPravail, spMitigationID=spMitigationID, spFingerprintName=spFingerprintName, routingFailover=routingFailover, flowDown=flowDown, spImpactPps=spImpactPps)
