...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:17:35 2022
...
Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, Counter32, TimeTicks, Counter64, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, spUsage=spUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpDown=bgpDown, spFingerprintSender=spFingerprintSender, spDNSObserved=spDNSObserved, spSystemErrorDescription=spSystemErrorDescription, spLicenseErrCount=spLicenseErrCount, fingerprintUsage=fingerprintUsage, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, flowDown=flowDown, snmpUp=snmpUp, spUsername=spUsername, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceSwapSpace=deviceSwapSpace, peakflowSPMIB=peakflowSPMIB, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpUp=bgpUp, spScriptCommand=spScriptCommand, spInterfaceUsageHC=spInterfaceUsageHC, spcommFailureDone=spcommFailureDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spTMSCommunity=spTMSCommunity, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spMitigationID=spMitigationID, notificationLimit=notificationLimit, spFlowspecCommunity=spFlowspecCommunity, bgpTrap=bgpTrap, spCollector=spCollector, dosHostDetectionAlertDone=dosHostDetectionAlertDone, fingerprintFeedback=fingerprintFeedback, spCommFailureDescription=spCommFailureDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPCMI=peakflowSPCMI, spReportID=spReportID, spHijackRoute=spHijackRoute, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, spcommFailure=spcommFailure, routingFailover=routingFailover, bgpInstabilityDone=bgpInstabilityDone, greDown=greDown, spLicenseErrDescription=spLicenseErrDescription, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spDNSObservedMean=spDNSObservedMean, collectorDown=collectorDown, spDuration=spDuration, snmpDown=snmpDown, spScriptPort=spScriptPort, fingerprintUsageDone=fingerprintUsageDone, dnsBaseline=dnsBaseline, spFingerprintName=spFingerprintName, deviceSystemErrorDone=deviceSystemErrorDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSPrefix=spTMSPrefix, spThirdPartyZone=spThirdPartyZone, spInterfaceIndex=spInterfaceIndex, mitigationFlowspecStart=mitigationFlowspecStart, flowUp=flowUp, spThirdPartyAddr=spThirdPartyAddr, deviceTotalFlows=deviceTotalFlows, configChange=configChange, spHijackLocal=spHijackLocal, spGreTunnelName=spGreTunnelName, spLicenseErrType=spLicenseErrType, mitigationTMSStartV2=mitigationTMSStartV2, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSExpected=spDNSExpected, spMitigationStart=spMitigationStart, mitigationDone=mitigationDone, spThreshold=spThreshold, interfaceUsageDone=interfaceUsageDone, alertScript=alertScript, spInetAddress=spInetAddress, spHardwareFailureDescription=spHardwareFailureDescription, hardwareFailure=hardwareFailure, peakflowSPTraps=peakflowSPTraps, spReportName=spReportName, managedObjectUsage=managedObjectUsage, licenseError=licenseError, spAlertID=spAlertID, spInterfaceSpeedHC=spInterfaceSpeedHC, spSystemErrorType=spSystemErrorType, spBGPTrapPrefix=spBGPTrapPrefix, spPravail=spPravail, serviceUsageDone=serviceUsageDone, collectorStart=collectorStart, hardwareFailureDone=hardwareFailureDone, spInterfaceUsage=spInterfaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spVersion=spVersion, spScriptStart=spScriptStart, spHijackAttr=spHijackAttr, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUnit=spUnit, licenseErrorDone=licenseErrorDone, collectorUp=collectorUp, greDownDone=greDownDone, reportDone=reportDone, mitigationTMSStart=mitigationTMSStart, spServiceName=spServiceName, spManagedObjectFamily=spManagedObjectFamily, spMitigationName=spMitigationName, cloudSignalingFaultDone=cloudSignalingFaultDone, spFingerprintMessage=spFingerprintMessage, spImpactPps=spImpactPps, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPInstability=spBGPInstability, bgpInstability=bgpInstability, spImpactBps=spImpactBps, spDNSName=spDNSName, spDetector=spDetector, deviceDiskUsage=deviceDiskUsage, spBGPTrapEvent=spBGPTrapEvent, spDetectedCountries=spDetectedCountries, peakflowSPMgr=peakflowSPMgr, spDNSObservedMax=spDNSObservedMax, spManagedObject=spManagedObject, spInterfaceSpeed=spInterfaceSpeed, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapOldAttributes=spBGPTrapOldAttributes, trafficAutoMitigation=trafficAutoMitigation, dosHostDetectionAlert=dosHostDetectionAlert, spGreTunnelDestination=spGreTunnelDestination, dnsBaselineDone=dnsBaselineDone, spTMSTimeout=spTMSTimeout, spBlackholeCommunity=spBlackholeCommunity, spBGPEvent=spBGPEvent, spFlowspecTimeout=spFlowspecTimeout, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spUsageType=spUsageType, PYSNMP_MODULE_ID=peakflowSPMIB, spInetAddressType=spInetAddressType, spScriptHost=spScriptHost, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, autoclassifyStart=autoclassifyStart, deviceSystemError=deviceSystemError, spInterface=spInterface, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapName=spBGPTrapName, mitigationBlackholeStart=mitigationBlackholeStart, spCommFailureDestination=spCommFailureDestination, spFingerprintFeedback=spFingerprintFeedback, managedObjectUsageDone=managedObjectUsageDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spManagedObjects=spManagedObjects, spBlackholeNexthop=spBlackholeNexthop, deviceHealth=deviceHealth, spTMSMultiPrefix=spTMSMultiPrefix, spApplicationName=spApplicationName, serviceUsage=serviceUsage, spServiceElement=spServiceElement, interfaceUsage=interfaceUsage)
