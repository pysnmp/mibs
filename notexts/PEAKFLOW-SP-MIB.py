...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:00:13 2023
...
ObjectIdentity, NotificationType, TimeTicks, Unsigned32, iso, Bits, Gauge32, Integer32, MibIdentifier, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32", "iso", "Bits", "Gauge32", "Integer32", "MibIdentifier", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", dnsBaseline=dnsBaseline, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spReportName=spReportName, alertScript=alertScript, spInterfaceUsageHC=spInterfaceUsageHC, spBlackholeTimeout=spBlackholeTimeout, spSystemErrorType=spSystemErrorType, spVersion=spVersion, peakflowSPTraps=peakflowSPTraps, deviceTotalFlows=deviceTotalFlows, notificationLimit=notificationLimit, bgpHijack=bgpHijack, dnsBaselineDone=dnsBaselineDone, spTMSCommunity=spTMSCommunity, spFlowspecTimeout=spFlowspecTimeout, licenseErrorDone=licenseErrorDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spSystemErrorDescription=spSystemErrorDescription, collectorDown=collectorDown, spServiceName=spServiceName, bgpInstability=bgpInstability, serviceUsage=serviceUsage, spFingerprintSender=spFingerprintSender, hardwareFailureDone=hardwareFailureDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSName=spDNSName, devicePhysicalMemory=devicePhysicalMemory, spRouter=spRouter, spInterfaceIndex=spInterfaceIndex, spDNSObservedMean=spDNSObservedMean, spcommFailureDone=spcommFailureDone, spFlowspecCommunity=spFlowspecCommunity, spBGPInstability=spBGPInstability, spLicenseErrType=spLicenseErrType, bgpTrap=bgpTrap, dosHostDetectionAlert=dosHostDetectionAlert, spDNSObservedMax=spDNSObservedMax, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDuration=spDuration, peakflowSPMIB=peakflowSPMIB, deviceSwapSpace=deviceSwapSpace, spManagedObjects=spManagedObjects, greDownDone=greDownDone, spScriptStart=spScriptStart, spBGPTrapEvent=spBGPTrapEvent, bgpDown=bgpDown, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, spInterfaceSpeedHC=spInterfaceSpeedHC, spImpactBps=spImpactBps, spInterface=spInterface, spTMSMultiPrefix=spTMSMultiPrefix, spThirdPartyAddr=spThirdPartyAddr, autoclassifyStart=autoclassifyStart, peakflowSPMgr=peakflowSPMgr, spBlackholePrefix=spBlackholePrefix, mitigationThirdPartyStart=mitigationThirdPartyStart, collectorStart=collectorStart, spScriptCommand=spScriptCommand, spFingerprintFeedback=spFingerprintFeedback, spHijackLocal=spHijackLocal, spServiceElement=spServiceElement, spInetAddressType=spInetAddressType, spThreshold=spThreshold, spFingerprintName=spFingerprintName, spDetector=spDetector, flowDown=flowDown, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpDown=snmpDown, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spLicenseErrDescription=spLicenseErrDescription, spUnit=spUnit, fingerprintReceive=fingerprintReceive, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeed=spInterfaceSpeed, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeCommunity=spBlackholeCommunity, collectorUp=collectorUp, spBlackholeNexthop=spBlackholeNexthop, spFingerprintMessage=spFingerprintMessage, spReportID=spReportID, deviceTotalFlowsHC=deviceTotalFlowsHC, spPravail=spPravail, spLicenseErrCount=spLicenseErrCount, interfaceUsage=interfaceUsage, licenseError=licenseError, spMitigationName=spMitigationName, spInetAddress=spInetAddress, mitigationTMSStart=mitigationTMSStart, fingerprintUsage=fingerprintUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapOldAttributes=spBGPTrapOldAttributes, peakflowSPCMI=peakflowSPCMI, PYSNMP_MODULE_ID=peakflowSPMIB, bgpInstabilityDone=bgpInstabilityDone, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, serviceUsageDone=serviceUsageDone, hardwareFailure=hardwareFailure, spScriptHost=spScriptHost, spDetectedCountries=spDetectedCountries, spTMSTimeout=spTMSTimeout, mitigationDone=mitigationDone, spBGPEvent=spBGPEvent, spDNSExpected=spDNSExpected, spAlertID=spAlertID, bgpUp=bgpUp, routingFailover=routingFailover, flowUp=flowUp, spUsername=spUsername, fingerprintFeedback=fingerprintFeedback, fingerprintUsageDone=fingerprintUsageDone, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceUsage=spInterfaceUsage, managedObjectUsage=managedObjectUsage, spManagedObjectFamily=spManagedObjectFamily, spHijackAttr=spHijackAttr, spScriptPort=spScriptPort, greDown=greDown, spBGPTrapName=spBGPTrapName, spGreTunnelDestination=spGreTunnelDestination, spcommFailure=spcommFailure, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCollector=spCollector, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceHealth=deviceHealth, spHijackRoute=spHijackRoute, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spCommFailureDestination=spCommFailureDestination, spCommFailureDescription=spCommFailureDescription, spGreTunnelName=spGreTunnelName, spManagedObject=spManagedObject, spMitigationStart=spMitigationStart, reportDone=reportDone, configChange=configChange, spUsageType=spUsageType, mitigationBlackholeStart=mitigationBlackholeStart, snmpUp=snmpUp, mitigationFlowspecStart=mitigationFlowspecStart, spAlertDetectionSignatures=spAlertDetectionSignatures, spDNSObserved=spDNSObserved, managedObjectUsageDone=managedObjectUsageDone, spBGPTrapPrefix=spBGPTrapPrefix, spTMSPrefix=spTMSPrefix, spApplicationName=spApplicationName, deviceSystemError=deviceSystemError, spMitigationID=spMitigationID, interfaceUsageDone=interfaceUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spImpactPps=spImpactPps, deviceDiskUsage=deviceDiskUsage, cloudSignalingFault=cloudSignalingFault, spThirdPartyZone=spThirdPartyZone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spUsage=spUsage, mitigationTMSStartV2=mitigationTMSStartV2)
