...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:17:40 2023
...
Counter32, ModuleIdentity, TimeTicks, Unsigned32, Integer32, NotificationType, Counter64, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Integer32", "NotificationType", "Counter64", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterface=spInterface, spHijackRoute=spHijackRoute, deviceSwapSpace=deviceSwapSpace, spScriptCommand=spScriptCommand, spBGPTrapPrefix=spBGPTrapPrefix, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, mitigationTMSStart=mitigationTMSStart, spMitigationStart=spMitigationStart, mitigationTMSStartV2=mitigationTMSStartV2, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, serviceUsageDone=serviceUsageDone, peakflowSPCMI=peakflowSPCMI, bgpInstability=bgpInstability, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spSystemErrorType=spSystemErrorType, spReportName=spReportName, spInterfaceUsageHC=spInterfaceUsageHC, spMitigationID=spMitigationID, greDownDone=greDownDone, spUsageType=spUsageType, mitigationDone=mitigationDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptPort=spScriptPort, spLicenseErrType=spLicenseErrType, spTMSPrefix=spTMSPrefix, spCommFailureDescription=spCommFailureDescription, fingerprintUsageDone=fingerprintUsageDone, bgpUp=bgpUp, spInterfaceUsage=spInterfaceUsage, snmpUp=snmpUp, deviceSystemError=deviceSystemError, spHijackAttr=spHijackAttr, spBlackholeTimeout=spBlackholeTimeout, spTMSMultiPrefix=spTMSMultiPrefix, spVersion=spVersion, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, flowUp=flowUp, peakflowSPMgr=peakflowSPMgr, spHijackLocal=spHijackLocal, spServiceName=spServiceName, spUsername=spUsername, collectorUp=collectorUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemory=devicePhysicalMemory, mitigationFlowspecStart=mitigationFlowspecStart, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintName=spFingerprintName, interfaceUsageDone=interfaceUsageDone, spBlackholeNexthop=spBlackholeNexthop, spInetAddressType=spInetAddressType, spBGPTrapOldAttributes=spBGPTrapOldAttributes, greDown=greDown, spReportID=spReportID, spThreshold=spThreshold, spBlackholePrefix=spBlackholePrefix, spThirdPartyAddr=spThirdPartyAddr, bgpTrap=bgpTrap, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrLimit=spLicenseErrLimit, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spCommFailureDestination=spCommFailureDestination, spLicenseErrDescription=spLicenseErrDescription, spSystemErrorDescription=spSystemErrorDescription, spUnit=spUnit, spInterfaceSpeedHC=spInterfaceSpeedHC, autoclassifyStart=autoclassifyStart, peakflowSPTraps=peakflowSPTraps, spServiceElement=spServiceElement, collectorDown=collectorDown, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPTrapName=spBGPTrapName, managedObjectUsageDone=managedObjectUsageDone, spBGPInstability=spBGPInstability, deviceSwapSpaceUsage=deviceSwapSpaceUsage, fingerprintReceive=fingerprintReceive, spDNSObservedMax=spDNSObservedMax, spHardwareFailureDescription=spHardwareFailureDescription, spGreTunnelName=spGreTunnelName, spAlertDetectionSignatures=spAlertDetectionSignatures, configChange=configChange, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFault=cloudSignalingFault, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, reportDone=reportDone, fingerprintFeedback=fingerprintFeedback, alertScript=alertScript, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spRouter=spRouter, mitigationBlackholeStart=mitigationBlackholeStart, licenseErrorDone=licenseErrorDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spFingerprintFeedback=spFingerprintFeedback, cloudSignalingFaultDone=cloudSignalingFaultDone, dnsBaselineDone=dnsBaselineDone, spBlackholeCommunity=spBlackholeCommunity, interfaceUsage=interfaceUsage, spBGPTrapEvent=spBGPTrapEvent, bgpInstabilityDone=bgpInstabilityDone, spManagedObjectFamily=spManagedObjectFamily, spDetector=spDetector, spImpactPps=spImpactPps, managedObjectUsage=managedObjectUsage, spDuration=spDuration, hardwareFailureDone=hardwareFailureDone, licenseError=licenseError, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, notificationLimit=notificationLimit, spScriptHost=spScriptHost, spTMSTimeout=spTMSTimeout, spDNSObservedMean=spDNSObservedMean, routingFailover=routingFailover, spBGPEvent=spBGPEvent, spDNSName=spDNSName, spDNSObserved=spDNSObserved, flowDown=flowDown, spManagedObject=spManagedObject, spDNSExpected=spDNSExpected, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, snmpDown=snmpDown, fingerprintUsage=fingerprintUsage, spMitigationName=spMitigationName, deviceSystemErrorDone=deviceSystemErrorDone, deviceTotalFlows=deviceTotalFlows, dosHostDetectionAlert=dosHostDetectionAlert, spScriptStart=spScriptStart, peakflowSPMIB=peakflowSPMIB, bgpHijack=bgpHijack, spFlowspecCommunity=spFlowspecCommunity, bgpDown=bgpDown, spPravail=spPravail, spReportURL=spReportURL, spCollector=spCollector, spInterfaceIndex=spInterfaceIndex, spAlertID=spAlertID, deviceSwapSpaceInUse=deviceSwapSpaceInUse, trafficAutoMitigation=trafficAutoMitigation, spFingerprintMessage=spFingerprintMessage, spLicenseErrCount=spLicenseErrCount, serviceUsage=serviceUsage, spTMSCommunity=spTMSCommunity, spInetAddress=spInetAddress, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceDiskUsage=deviceDiskUsage, spUsage=spUsage, deviceHealth=deviceHealth, dnsBaseline=dnsBaseline, spImpactBps=spImpactBps, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spThirdPartyZone=spThirdPartyZone, spApplicationName=spApplicationName, spManagedObjects=spManagedObjects, spcommFailureDone=spcommFailureDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFlowspecTimeout=spFlowspecTimeout, spFingerprintSender=spFingerprintSender, spInterfaceSpeed=spInterfaceSpeed, spcommFailure=spcommFailure, collectorStart=collectorStart, spDetectedCountries=spDetectedCountries, hardwareFailure=hardwareFailure)
