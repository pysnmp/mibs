...
# Produced by pysmi-1.1.12 at Tue Dec  3 10:03:15 2024
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, IpAddress, Counter32, Gauge32, TimeTicks, NotificationType, Integer32, iso, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "IpAddress", "Counter32", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "iso", "ObjectIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSystemErrorDone=deviceSystemErrorDone, spBlackholePrefix=spBlackholePrefix, spBlackholeNexthop=spBlackholeNexthop, routingFailover=routingFailover, deviceSwapSpace=deviceSwapSpace, spDetectedCountries=spDetectedCountries, spTMSMultiPrefix=spTMSMultiPrefix, spServiceElement=spServiceElement, flowUp=flowUp, interfaceUsage=interfaceUsage, spLicenseErrCount=spLicenseErrCount, greDown=greDown, spDuration=spDuration, snmpDown=snmpDown, collectorDown=collectorDown, spPravail=spPravail, spDNSExpected=spDNSExpected, spUsername=spUsername, spImpactPps=spImpactPps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, managedObjectUsage=managedObjectUsage, spLicenseErrType=spLicenseErrType, peakflowSPCMI=peakflowSPCMI, spImpactBps=spImpactBps, spUnit=spUnit, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spGreTunnelName=spGreTunnelName, mitigationTMSStart=mitigationTMSStart, deviceSystemError=deviceSystemError, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCloudSignalFaultDescription=spCloudSignalFaultDescription, collectorUp=collectorUp, snmpUp=snmpUp, spHijackAttr=spHijackAttr, spServiceName=spServiceName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationDone=mitigationDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spManagedObject=spManagedObject, spTMSPrefix=spTMSPrefix, bgpUp=bgpUp, fingerprintUsage=fingerprintUsage, autoclassifyStart=autoclassifyStart, reportDone=reportDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spMitigationID=spMitigationID, spFingerprintMessage=spFingerprintMessage, spThreshold=spThreshold, mitigationThirdPartyStart=mitigationThirdPartyStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, serviceUsage=serviceUsage, spBGPEvent=spBGPEvent, dnsBaselineDone=dnsBaselineDone, spScriptStart=spScriptStart, spCollector=spCollector, collectorStart=collectorStart, spDetector=spDetector, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, PYSNMP_MODULE_ID=peakflowSPMIB, spSystemErrorDescription=spSystemErrorDescription, peakflowSPMIB=peakflowSPMIB, deviceHealth=deviceHealth, licenseError=licenseError, spVersion=spVersion, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spGreTunnelDestination=spGreTunnelDestination, spBlackholeTimeout=spBlackholeTimeout, mitigationTMSStartV2=mitigationTMSStartV2, deviceDiskUsage=deviceDiskUsage, spDNSObservedMax=spDNSObservedMax, trafficAutoMitigation=trafficAutoMitigation, spThirdPartyZone=spThirdPartyZone, fingerprintFeedback=fingerprintFeedback, spBGPInstability=spBGPInstability, spDNSObservedMean=spDNSObservedMean, licenseErrorDone=licenseErrorDone, bgpInstabilityDone=bgpInstabilityDone, mitigationBlackholeStart=mitigationBlackholeStart, spcommFailure=spcommFailure, alertScript=alertScript, spInetAddress=spInetAddress, spScriptCommand=spScriptCommand, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spReportURL=spReportURL, greDownDone=greDownDone, spLicenseErrDescription=spLicenseErrDescription, interfaceUsageDone=interfaceUsageDone, spReportName=spReportName, spcommFailureDone=spcommFailureDone, configChange=configChange, spUsageType=spUsageType, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeed=spInterfaceSpeed, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, flowDown=flowDown, spCommFailureDescription=spCommFailureDescription, dnsBaseline=dnsBaseline, peakflowSPTraps=peakflowSPTraps, serviceUsageDone=serviceUsageDone, cloudSignalingFault=cloudSignalingFault, deviceTotalFlows=deviceTotalFlows, spBGPTrapEvent=spBGPTrapEvent, mitigationFlowspecStart=mitigationFlowspecStart, spUsage=spUsage, hardwareFailure=hardwareFailure, spManagedObjectFamily=spManagedObjectFamily, spFingerprintSender=spFingerprintSender, spSystemErrorType=spSystemErrorType, deviceTotalFlowsHC=deviceTotalFlowsHC, spRouter=spRouter, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsageDone=fingerprintUsageDone, spLicenseErrLimit=spLicenseErrLimit, spTMSCommunity=spTMSCommunity, bgpTrap=bgpTrap, spDNSName=spDNSName, spBGPTrapName=spBGPTrapName, spBGPTrapPrefix=spBGPTrapPrefix, hardwareFailureDone=hardwareFailureDone, fingerprintReceive=fingerprintReceive, dosHostDetectionAlert=dosHostDetectionAlert, spHijackLocal=spHijackLocal, spInterface=spInterface, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spApplicationName=spApplicationName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, notificationLimit=notificationLimit, spMitigationName=spMitigationName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spHijackRoute=spHijackRoute, spFlowspecCommunity=spFlowspecCommunity, spAlertID=spAlertID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFlowspecTimeout=spFlowspecTimeout, spCommFailureDestination=spCommFailureDestination, devicePhysicalMemory=devicePhysicalMemory, spHardwareFailureDescription=spHardwareFailureDescription, bgpDown=bgpDown, spInterfaceUsage=spInterfaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterfaceIndex=spInterfaceIndex, spFingerprintName=spFingerprintName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spScriptPort=spScriptPort, spInterfaceUsageHC=spInterfaceUsageHC, managedObjectUsageDone=managedObjectUsageDone, bgpHijack=bgpHijack, spReportID=spReportID, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObjects=spManagedObjects, spScriptHost=spScriptHost, spFingerprintFeedback=spFingerprintFeedback, spInetAddressType=spInetAddressType, spTMSTimeout=spTMSTimeout, spMitigationStart=spMitigationStart, peakflowSPMgr=peakflowSPMgr, spDNSObserved=spDNSObserved, bgpInstability=bgpInstability)
