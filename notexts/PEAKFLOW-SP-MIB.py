...
# Produced by pysmi-1.1.8 at Mon Jan 16 14:59:13 2023
...
Integer32, Gauge32, Counter32, TimeTicks, ObjectIdentity, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Bits, MibIdentifier, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter32", "TimeTicks", "ObjectIdentity", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Bits", "MibIdentifier", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpInstabilityDone=bgpInstabilityDone, spServiceElement=spServiceElement, autoclassifyStart=autoclassifyStart, reportDone=reportDone, hardwareFailureDone=hardwareFailureDone, spSystemErrorDescription=spSystemErrorDescription, spHardwareFailureDescription=spHardwareFailureDescription, managedObjectUsage=managedObjectUsage, spFingerprintSender=spFingerprintSender, dnsBaselineDone=dnsBaselineDone, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpTrap=bgpTrap, spTMSPrefix=spTMSPrefix, fingerprintUsage=fingerprintUsage, flowUp=flowUp, spBlackholeNexthop=spBlackholeNexthop, peakflowSPMIB=peakflowSPMIB, mitigationBlackholeStart=mitigationBlackholeStart, spDNSObserved=spDNSObserved, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstability=bgpInstability, spInterfaceIndex=spInterfaceIndex, notificationLimit=notificationLimit, flowDown=flowDown, mitigationDone=mitigationDone, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingFault=cloudSignalingFault, mitigationTMSStartV2=mitigationTMSStartV2, dosHostDetectionAlert=dosHostDetectionAlert, spUsername=spUsername, spLicenseErrCount=spLicenseErrCount, spInetAddress=spInetAddress, spScriptCommand=spScriptCommand, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spcommFailure=spcommFailure, spBGPInstability=spBGPInstability, licenseErrorDone=licenseErrorDone, spMitigationStart=spMitigationStart, spGreTunnelName=spGreTunnelName, spBGPTrapName=spBGPTrapName, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceHealth=deviceHealth, spInetAddressType=spInetAddressType, fingerprintReceive=fingerprintReceive, spMitigationID=spMitigationID, spManagedObjects=spManagedObjects, spFlowspecCommunity=spFlowspecCommunity, trafficAutoMitigation=trafficAutoMitigation, collectorDown=collectorDown, spThirdPartyZone=spThirdPartyZone, spScriptStart=spScriptStart, hardwareFailure=hardwareFailure, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapPrefix=spBGPTrapPrefix, fingerprintUsageDone=fingerprintUsageDone, spImpactBps=spImpactBps, deviceSystemErrorDone=deviceSystemErrorDone, routingFailover=routingFailover, spLicenseErrLimit=spLicenseErrLimit, spThirdPartyAddr=spThirdPartyAddr, spInterfaceSpeed=spInterfaceSpeed, interfaceUsageDone=interfaceUsageDone, spRouter=spRouter, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpace=deviceSwapSpace, spBGPTrapEvent=spBGPTrapEvent, mitigationFlowspecStart=mitigationFlowspecStart, bgpDown=bgpDown, spAlertDetectionSignatures=spAlertDetectionSignatures, configChange=configChange, serviceUsage=serviceUsage, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSCommunity=spTMSCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spServiceName=spServiceName, spCommFailureDescription=spCommFailureDescription, spLicenseErrType=spLicenseErrType, snmpDown=snmpDown, spFingerprintName=spFingerprintName, spLicenseErrDescription=spLicenseErrDescription, spThreshold=spThreshold, spImpactPps=spImpactPps, spBGPEvent=spBGPEvent, devicePhysicalMemory=devicePhysicalMemory, spVersion=spVersion, collectorUp=collectorUp, spInterfaceSpeedHC=spInterfaceSpeedHC, spcommFailureDone=spcommFailureDone, spDNSExpected=spDNSExpected, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spDuration=spDuration, spManagedObjectFamily=spManagedObjectFamily, bgpUp=bgpUp, spDNSObservedMax=spDNSObservedMax, spHijackLocal=spHijackLocal, spFlowspecTimeout=spFlowspecTimeout, spBlackholeCommunity=spBlackholeCommunity, licenseError=licenseError, fingerprintFeedback=fingerprintFeedback, managedObjectUsageDone=managedObjectUsageDone, dnsBaseline=dnsBaseline, spBlackholeTimeout=spBlackholeTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBlackholePrefix=spBlackholePrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPTraps=peakflowSPTraps, spFingerprintFeedback=spFingerprintFeedback, spCommFailureDestination=spCommFailureDestination, spHijackRoute=spHijackRoute, snmpUp=snmpUp, bgpHijack=bgpHijack, spPravail=spPravail, spTMSMultiPrefix=spTMSMultiPrefix, spGreTunnelDestination=spGreTunnelDestination, spInterface=spInterface, peakflowSPCMI=peakflowSPCMI, spDNSObservedMean=spDNSObservedMean, spTMSTimeout=spTMSTimeout, deviceSystemError=deviceSystemError, greDownDone=greDownDone, spDNSName=spDNSName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, collectorStart=collectorStart, spInterfaceUsage=spInterfaceUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, serviceUsageDone=serviceUsageDone, spUsage=spUsage, peakflowSPMgr=peakflowSPMgr, spUnit=spUnit, alertScript=alertScript, greDown=greDown, spManagedObject=spManagedObject, interfaceUsage=interfaceUsage, spDetector=spDetector, deviceTotalFlows=deviceTotalFlows, spAlertID=spAlertID, spReportID=spReportID, spCollector=spCollector, deviceDiskUsage=deviceDiskUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spUsageType=spUsageType, spScriptHost=spScriptHost, mitigationTMSStart=mitigationTMSStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptPort=spScriptPort, spApplicationName=spApplicationName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spSystemErrorType=spSystemErrorType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spHijackAttr=spHijackAttr, spReportName=spReportName, spReportURL=spReportURL, spMitigationName=spMitigationName, spFingerprintMessage=spFingerprintMessage)
