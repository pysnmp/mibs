...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spCommFailureDescription=spCommFailureDescription, spThirdPartyAddr=spThirdPartyAddr, configChange=configChange, spDNSExpected=spDNSExpected, spManagedObjects=spManagedObjects, spFlowspecTimeout=spFlowspecTimeout, spHijackLocal=spHijackLocal, spThreshold=spThreshold, spScriptHost=spScriptHost, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholeNexthop=spBlackholeNexthop, bgpDown=bgpDown, spBGPEvent=spBGPEvent, spGreTunnelDestination=spGreTunnelDestination, spFingerprintFeedback=spFingerprintFeedback, spGreTunnelName=spGreTunnelName, peakflowSPTraps=peakflowSPTraps, spReportURL=spReportURL, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spInetAddressType=spInetAddressType, spImpactPps=spImpactPps, deviceHealth=deviceHealth, spBlackholePrefix=spBlackholePrefix, spDNSObservedMean=spDNSObservedMean, spFingerprintSender=spFingerprintSender, spBGPInstability=spBGPInstability, spUsername=spUsername, deviceDiskUsage=deviceDiskUsage, deviceTotalFlows=deviceTotalFlows, spRouter=spRouter, collectorStart=collectorStart, mitigationTMSStartV2=mitigationTMSStartV2, dnsBaselineDone=dnsBaselineDone, serviceUsage=serviceUsage, managedObjectUsage=managedObjectUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationDone=mitigationDone, greDown=greDown, spMitigationName=spMitigationName, fingerprintFeedback=fingerprintFeedback, spHijackAttr=spHijackAttr, spFingerprintName=spFingerprintName, peakflowSPMIB=peakflowSPMIB, spDetectedCountries=spDetectedCountries, spInterfaceUsageHC=spInterfaceUsageHC, spReportID=spReportID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, alertScript=alertScript, spManagedObject=spManagedObject, spScriptCommand=spScriptCommand, bgpHijack=bgpHijack, snmpUp=snmpUp, spBGPTrapName=spBGPTrapName, licenseError=licenseError, spDNSName=spDNSName, spTMSCommunity=spTMSCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, routingFailover=routingFailover, spTMSTimeout=spTMSTimeout, spBGPTrapPrefix=spBGPTrapPrefix, collectorDown=collectorDown, spDNSObserved=spDNSObserved, spUnit=spUnit, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dnsBaseline=dnsBaseline, bgpInstabilityDone=bgpInstabilityDone, spThirdPartyZone=spThirdPartyZone, fingerprintUsage=fingerprintUsage, spBlackholeTimeout=spBlackholeTimeout, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spSystemErrorDescription=spSystemErrorDescription, flowDown=flowDown, deviceTotalFlowsHC=deviceTotalFlowsHC, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spImpactBps=spImpactBps, collectorUp=collectorUp, cloudSignalingFault=cloudSignalingFault, spcommFailureDone=spcommFailureDone, spAlertDetectionSignatures=spAlertDetectionSignatures, spDuration=spDuration, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceSystemError=deviceSystemError, spTMSPrefix=spTMSPrefix, spFingerprintMessage=spFingerprintMessage, spUsageType=spUsageType, spLicenseErrCount=spLicenseErrCount, spReportName=spReportName, spServiceElement=spServiceElement, managedObjectUsageDone=managedObjectUsageDone, notificationLimit=notificationLimit, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptPort=spScriptPort, spServiceName=spServiceName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPMgr=peakflowSPMgr, mitigationFlowspecStart=mitigationFlowspecStart, bgpUp=bgpUp, spcommFailure=spcommFailure, spLicenseErrType=spLicenseErrType, spAlertID=spAlertID, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsage=spInterfaceUsage, flowUp=flowUp, greDownDone=greDownDone, spInterfaceIndex=spInterfaceIndex, deviceSwapSpace=deviceSwapSpace, bgpInstability=bgpInstability, peakflowSPCMI=peakflowSPCMI, spUsage=spUsage, spFlowspecCommunity=spFlowspecCommunity, reportDone=reportDone, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceSpeed=spInterfaceSpeed, PYSNMP_MODULE_ID=peakflowSPMIB, hardwareFailure=hardwareFailure, fingerprintUsageDone=fingerprintUsageDone, hardwareFailureDone=hardwareFailureDone, spPravail=spPravail, spLicenseErrLimit=spLicenseErrLimit, spDetector=spDetector, spHijackRoute=spHijackRoute, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spApplicationName=spApplicationName, fingerprintReceive=fingerprintReceive, spInterfaceSpeedHC=spInterfaceSpeedHC, snmpDown=snmpDown, serviceUsageDone=serviceUsageDone, spMitigationStart=spMitigationStart, spManagedObjectFamily=spManagedObjectFamily, spInterface=spInterface, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dosHostDetectionAlert=dosHostDetectionAlert, licenseErrorDone=licenseErrorDone, spMitigationID=spMitigationID, mitigationTMSStart=mitigationTMSStart, spVersion=spVersion, deviceSystemErrorDone=deviceSystemErrorDone, spScriptStart=spScriptStart, spInetAddress=spInetAddress, spDNSObservedMax=spDNSObservedMax, bgpTrap=bgpTrap, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spHardwareFailureDescription=spHardwareFailureDescription, autoclassifyStart=autoclassifyStart, trafficAutoMitigation=trafficAutoMitigation, spLicenseErrDescription=spLicenseErrDescription, spSystemErrorType=spSystemErrorType, interfaceUsage=interfaceUsage, spBlackholeCommunity=spBlackholeCommunity, interfaceUsageDone=interfaceUsageDone, spCollector=spCollector, devicePhysicalMemory=devicePhysicalMemory, spCommFailureDestination=spCommFailureDestination)
