...
NotificationType, TimeTicks, ModuleIdentity, Bits, Gauge32, MibIdentifier, iso, Unsigned32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "ModuleIdentity", "Bits", "Gauge32", "MibIdentifier", "iso", "Unsigned32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBlackholePrefix=spBlackholePrefix, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeCommunity=spBlackholeCommunity, spImpactBps=spImpactBps, spBGPInstability=spBGPInstability, spRouter=spRouter, bgpInstabilityDone=bgpInstabilityDone, licenseError=licenseError, spReportName=spReportName, spGreTunnelName=spGreTunnelName, flowDown=flowDown, managedObjectUsageDone=managedObjectUsageDone, spInetAddressType=spInetAddressType, spDNSObservedMean=spDNSObservedMean, spScriptCommand=spScriptCommand, spCommFailureDestination=spCommFailureDestination, spInterfaceUsageHC=spInterfaceUsageHC, configChange=configChange, spFingerprintFeedback=spFingerprintFeedback, bgpDown=bgpDown, collectorStart=collectorStart, reportDone=reportDone, spTMSCommunity=spTMSCommunity, mitigationBlackholeStart=mitigationBlackholeStart, dosHostDetectionAlert=dosHostDetectionAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, hardwareFailureDone=hardwareFailureDone, spThirdPartyAddr=spThirdPartyAddr, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPEvent=spBGPEvent, spTMSPrefix=spTMSPrefix, spDNSObserved=spDNSObserved, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, greDown=greDown, peakflowSPTraps=peakflowSPTraps, spBGPTrapEvent=spBGPTrapEvent, spUsageType=spUsageType, spAlertDetectionSignatures=spAlertDetectionSignatures, fingerprintUsageDone=fingerprintUsageDone, snmpDown=snmpDown, deviceHealth=deviceHealth, spCommFailureDescription=spCommFailureDescription, spFlowspecTimeout=spFlowspecTimeout, spReportID=spReportID, peakflowSPMIB=peakflowSPMIB, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObject=spManagedObject, spTMSTimeout=spTMSTimeout, spPravail=spPravail, snmpUp=snmpUp, spReportURL=spReportURL, spDuration=spDuration, spBlackholeTimeout=spBlackholeTimeout, fingerprintReceive=fingerprintReceive, spBGPTrapName=spBGPTrapName, fingerprintFeedback=fingerprintFeedback, hardwareFailure=hardwareFailure, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapPrefix=spBGPTrapPrefix, bgpUp=bgpUp, spFingerprintSender=spFingerprintSender, spBlackholeNexthop=spBlackholeNexthop, collectorDown=collectorDown, routingFailover=routingFailover, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spInterfaceSpeed=spInterfaceSpeed, spScriptPort=spScriptPort, spHijackAttr=spHijackAttr, trafficAutoMitigation=trafficAutoMitigation, spDetector=spDetector, spInterfaceIndex=spInterfaceIndex, serviceUsage=serviceUsage, spLicenseErrCount=spLicenseErrCount, spSystemErrorType=spSystemErrorType, deviceTotalFlows=deviceTotalFlows, spMitigationStart=spMitigationStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptStart=spScriptStart, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSwapSpace=deviceSwapSpace, spUnit=spUnit, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spDetectedCountries=spDetectedCountries, deviceDiskUsage=deviceDiskUsage, spManagedObjectFamily=spManagedObjectFamily, spUsername=spUsername, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptHost=spScriptHost, interfaceUsage=interfaceUsage, spCollector=spCollector, spHijackRoute=spHijackRoute, flowUp=flowUp, bgpInstability=bgpInstability, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorDescription=spSystemErrorDescription, notificationLimit=notificationLimit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spGreTunnelDestination=spGreTunnelDestination, deviceSystemError=deviceSystemError, spDNSObservedMax=spDNSObservedMax, cloudSignalingFault=cloudSignalingFault, bgpTrap=bgpTrap, managedObjectUsage=managedObjectUsage, spDNSName=spDNSName, interfaceUsageDone=interfaceUsageDone, spLicenseErrType=spLicenseErrType, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInetAddress=spInetAddress, PYSNMP_MODULE_ID=peakflowSPMIB, dnsBaseline=dnsBaseline, dnsBaselineDone=dnsBaselineDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationTMSStart=mitigationTMSStart, spVersion=spVersion, spFingerprintName=spFingerprintName, fingerprintUsage=fingerprintUsage, spTMSMultiPrefix=spTMSMultiPrefix, spManagedObjects=spManagedObjects, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, spInterface=spInterface, devicePhysicalMemory=devicePhysicalMemory, spMitigationID=spMitigationID, spThirdPartyZone=spThirdPartyZone, spServiceElement=spServiceElement, spUsage=spUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spFingerprintMessage=spFingerprintMessage, spThreshold=spThreshold, spHijackLocal=spHijackLocal, bgpHijack=bgpHijack, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorUp=collectorUp, spApplicationName=spApplicationName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spLicenseErrDescription=spLicenseErrDescription, spInterfaceUsage=spInterfaceUsage, serviceUsageDone=serviceUsageDone, spLicenseErrLimit=spLicenseErrLimit, peakflowSPMgr=peakflowSPMgr, mitigationDone=mitigationDone, spcommFailureDone=spcommFailureDone, mitigationTMSStartV2=mitigationTMSStartV2, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPCMI=peakflowSPCMI, spcommFailure=spcommFailure, spMitigationName=spMitigationName, spAlertID=spAlertID, spHardwareFailureDescription=spHardwareFailureDescription, alertScript=alertScript, autoclassifyStart=autoclassifyStart, greDownDone=greDownDone, spDNSExpected=spDNSExpected, licenseErrorDone=licenseErrorDone, spServiceName=spServiceName, spImpactPps=spImpactPps)
