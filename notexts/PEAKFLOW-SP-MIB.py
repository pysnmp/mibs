...
Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Counter64, Counter32, TimeTicks, iso, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter64", "Counter32", "TimeTicks", "iso", "Unsigned32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPTrapPrefix=spBGPTrapPrefix, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationTMSStart=mitigationTMSStart, spMitigationName=spMitigationName, spInterfaceSpeed=spInterfaceSpeed, spBlackholePrefix=spBlackholePrefix, bgpHijack=bgpHijack, mitigationTMSStartV2=mitigationTMSStartV2, spHardwareFailureDescription=spHardwareFailureDescription, spCommFailureDescription=spCommFailureDescription, spVersion=spVersion, spcommFailureDone=spcommFailureDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFlowspecCommunity=spFlowspecCommunity, deviceSystemErrorDone=deviceSystemErrorDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, notificationLimit=notificationLimit, collectorUp=collectorUp, spDNSExpected=spDNSExpected, serviceUsageDone=serviceUsageDone, spDNSName=spDNSName, dosHostDetectionAlert=dosHostDetectionAlert, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrType=spLicenseErrType, collectorDown=collectorDown, spDuration=spDuration, routingFailover=routingFailover, spcommFailure=spcommFailure, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrCount=spLicenseErrCount, peakflowSPTraps=peakflowSPTraps, spBGPInstability=spBGPInstability, spLicenseErrDescription=spLicenseErrDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, licenseError=licenseError, spBlackholeTimeout=spBlackholeTimeout, deviceTotalFlowsHC=deviceTotalFlowsHC, spScriptStart=spScriptStart, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, spThirdPartyAddr=spThirdPartyAddr, mitigationThirdPartyStart=mitigationThirdPartyStart, spInterfaceUsage=spInterfaceUsage, spDetectedCountries=spDetectedCountries, fingerprintReceive=fingerprintReceive, spTMSPrefix=spTMSPrefix, peakflowSPCMI=peakflowSPCMI, spServiceName=spServiceName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spReportURL=spReportURL, spThreshold=spThreshold, spManagedObjects=spManagedObjects, spScriptCommand=spScriptCommand, spInetAddressType=spInetAddressType, spManagedObject=spManagedObject, spSystemErrorDescription=spSystemErrorDescription, alertScript=alertScript, dosNetworkProfiledAlert=dosNetworkProfiledAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintName=spFingerprintName, peakflowSPMgr=peakflowSPMgr, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInterfaceUsageHC=spInterfaceUsageHC, spCloudSignalFaultDescription=spCloudSignalFaultDescription, collectorStart=collectorStart, devicePhysicalMemory=devicePhysicalMemory, snmpDown=snmpDown, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spThirdPartyZone=spThirdPartyZone, bgpInstabilityDone=bgpInstabilityDone, spUsageType=spUsageType, spBlackholeNexthop=spBlackholeNexthop, spMitigationStart=spMitigationStart, spInterface=spInterface, spDNSObservedMean=spDNSObservedMean, licenseErrorDone=licenseErrorDone, bgpTrap=bgpTrap, spReportName=spReportName, spTMSTimeout=spTMSTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, flowDown=flowDown, spUsage=spUsage, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapEvent=spBGPTrapEvent, deviceDiskUsage=deviceDiskUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, bgpUp=bgpUp, spScriptPort=spScriptPort, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFingerprintSender=spFingerprintSender, spFingerprintFeedback=spFingerprintFeedback, spTMSMultiPrefix=spTMSMultiPrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceSystemError=deviceSystemError, spCommFailureDestination=spCommFailureDestination, managedObjectUsageDone=managedObjectUsageDone, interfaceUsageDone=interfaceUsageDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spCollector=spCollector, bgpInstability=bgpInstability, spUnit=spUnit, spMitigationID=spMitigationID, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceHealth=deviceHealth, spDetector=spDetector, spInterfaceIndex=spInterfaceIndex, spLicenseErrLimit=spLicenseErrLimit, spRouter=spRouter, spAlertID=spAlertID, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholeCommunity=spBlackholeCommunity, reportDone=reportDone, spFingerprintMessage=spFingerprintMessage, serviceUsage=serviceUsage, greDown=greDown, cloudSignalingFault=cloudSignalingFault, spImpactBps=spImpactBps, deviceTotalFlows=deviceTotalFlows, fingerprintUsageDone=fingerprintUsageDone, greDownDone=greDownDone, hardwareFailureDone=hardwareFailureDone, spHijackLocal=spHijackLocal, spGreTunnelName=spGreTunnelName, spTMSCommunity=spTMSCommunity, spManagedObjectFamily=spManagedObjectFamily, spInterfaceSpeedHC=spInterfaceSpeedHC, snmpUp=snmpUp, dnsBaseline=dnsBaseline, spServiceElement=spServiceElement, deviceSwapSpace=deviceSwapSpace, autoclassifyStart=autoclassifyStart, managedObjectUsage=managedObjectUsage, spImpactPps=spImpactPps, spBGPEvent=spBGPEvent, spBGPTrapName=spBGPTrapName, flowUp=flowUp, mitigationBlackholeStart=mitigationBlackholeStart, trafficAutoMitigation=trafficAutoMitigation, PYSNMP_MODULE_ID=peakflowSPMIB, configChange=configChange, cloudSignalingFaultDone=cloudSignalingFaultDone, peakflowSPMIB=peakflowSPMIB, spHijackAttr=spHijackAttr, spDNSObserved=spDNSObserved, spReportID=spReportID, spHijackRoute=spHijackRoute, spPravail=spPravail, spFlowspecTimeout=spFlowspecTimeout, spSystemErrorType=spSystemErrorType, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationDone=mitigationDone, spScriptHost=spScriptHost, spInetAddress=spInetAddress, spApplicationName=spApplicationName, spDNSObservedMax=spDNSObservedMax, interfaceUsage=interfaceUsage, spUsername=spUsername, dnsBaselineDone=dnsBaselineDone, fingerprintUsage=fingerprintUsage, bgpDown=bgpDown)
