...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:52:42 2023
...
TimeTicks, Counter64, Bits, Gauge32, Unsigned32, IpAddress, iso, ModuleIdentity, NotificationType, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Bits", "Gauge32", "Unsigned32", "IpAddress", "iso", "ModuleIdentity", "NotificationType", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHijackAttr=spHijackAttr, licenseErrorDone=licenseErrorDone, spThreshold=spThreshold, mitigationTMSStartV2=mitigationTMSStartV2, spcommFailure=spcommFailure, spManagedObject=spManagedObject, flowUp=flowUp, greDown=greDown, spTMSCommunity=spTMSCommunity, spInterfaceSpeed=spInterfaceSpeed, deviceDiskUsage=deviceDiskUsage, deviceTotalFlows=deviceTotalFlows, spUsername=spUsername, mitigationFlowspecStart=mitigationFlowspecStart, spHijackLocal=spHijackLocal, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, collectorStart=collectorStart, spInterfaceUsageHC=spInterfaceUsageHC, spReportID=spReportID, spManagedObjectFamily=spManagedObjectFamily, spThirdPartyAddr=spThirdPartyAddr, spServiceElement=spServiceElement, devicePhysicalMemory=devicePhysicalMemory, snmpDown=snmpDown, bgpInstability=bgpInstability, autoclassifyStart=autoclassifyStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFingerprintName=spFingerprintName, dnsBaselineDone=dnsBaselineDone, spLicenseErrType=spLicenseErrType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spApplicationName=spApplicationName, spSystemErrorDescription=spSystemErrorDescription, greDownDone=greDownDone, deviceSystemErrorDone=deviceSystemErrorDone, notificationLimit=notificationLimit, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapPrefix=spBGPTrapPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemError=deviceSystemError, spDetector=spDetector, spThirdPartyZone=spThirdPartyZone, spDNSObservedMean=spDNSObservedMean, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spImpactBps=spImpactBps, routingFailover=routingFailover, spMitigationName=spMitigationName, spFingerprintFeedback=spFingerprintFeedback, spDNSExpected=spDNSExpected, spScriptStart=spScriptStart, deviceSwapSpace=deviceSwapSpace, mitigationTMSStart=mitigationTMSStart, peakflowSPCMI=peakflowSPCMI, spMitigationID=spMitigationID, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spManagedObjects=spManagedObjects, peakflowSPTraps=peakflowSPTraps, spVersion=spVersion, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpUp=bgpUp, spInterfaceIndex=spInterfaceIndex, spSystemErrorType=spSystemErrorType, mitigationThirdPartyStart=mitigationThirdPartyStart, spScriptPort=spScriptPort, spFingerprintMessage=spFingerprintMessage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spLicenseErrCount=spLicenseErrCount, bgpInstabilityDone=bgpInstabilityDone, bgpTrap=bgpTrap, spAlertDetectionSignatures=spAlertDetectionSignatures, spcommFailureDone=spcommFailureDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPMIB=peakflowSPMIB, spMitigationStart=spMitigationStart, collectorDown=collectorDown, serviceUsage=serviceUsage, spHijackRoute=spHijackRoute, spReportURL=spReportURL, spGreTunnelDestination=spGreTunnelDestination, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFlowspecTimeout=spFlowspecTimeout, fingerprintReceive=fingerprintReceive, hardwareFailureDone=hardwareFailureDone, spDetectedCountries=spDetectedCountries, spTMSPrefix=spTMSPrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportName=spReportName, dosHostDetectionAlert=dosHostDetectionAlert, interfaceUsage=interfaceUsage, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceHealth=deviceHealth, dnsBaseline=dnsBaseline, spBGPTrapName=spBGPTrapName, spAlertID=spAlertID, spInterface=spInterface, configChange=configChange, trafficAutoMitigation=trafficAutoMitigation, spBlackholePrefix=spBlackholePrefix, spBGPTrapOldAttributes=spBGPTrapOldAttributes, snmpUp=snmpUp, spScriptHost=spScriptHost, licenseError=licenseError, PYSNMP_MODULE_ID=peakflowSPMIB, spDNSObservedMax=spDNSObservedMax, serviceUsageDone=serviceUsageDone, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBlackholeTimeout=spBlackholeTimeout, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSTimeout=spTMSTimeout, fingerprintFeedback=fingerprintFeedback, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPMgr=peakflowSPMgr, spLicenseErrDescription=spLicenseErrDescription, interfaceUsageDone=interfaceUsageDone, reportDone=reportDone, fingerprintUsageDone=fingerprintUsageDone, spDuration=spDuration, spCommFailureDescription=spCommFailureDescription, fingerprintUsage=fingerprintUsage, bgpHijack=bgpHijack, spCollector=spCollector, alertScript=alertScript, managedObjectUsage=managedObjectUsage, cloudSignalingFault=cloudSignalingFault, flowDown=flowDown, spBGPInstability=spBGPInstability, spUsageType=spUsageType, spInetAddressType=spInetAddressType, spBlackholeCommunity=spBlackholeCommunity, spRouter=spRouter, spFingerprintSender=spFingerprintSender, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrLimit=spLicenseErrLimit, spGreTunnelName=spGreTunnelName, deviceTotalFlowsHC=deviceTotalFlowsHC, spScriptCommand=spScriptCommand, spInterfaceUsage=spInterfaceUsage, bgpDown=bgpDown, spBGPEvent=spBGPEvent, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, collectorUp=collectorUp, spUsage=spUsage, spBlackholeNexthop=spBlackholeNexthop, spCommFailureDestination=spCommFailureDestination, spPravail=spPravail, spDNSName=spDNSName, spImpactPps=spImpactPps, mitigationDone=mitigationDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spFlowspecCommunity=spFlowspecCommunity, managedObjectUsageDone=managedObjectUsageDone, spServiceName=spServiceName, hardwareFailure=hardwareFailure, spDNSObserved=spDNSObserved, spTMSMultiPrefix=spTMSMultiPrefix, spInetAddress=spInetAddress, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spUnit=spUnit)
