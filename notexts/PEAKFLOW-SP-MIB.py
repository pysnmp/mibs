...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:29:57 2022
...
Gauge32, Counter32, Unsigned32, IpAddress, ObjectIdentity, Integer32, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Unsigned32", "IpAddress", "ObjectIdentity", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spUsageType=spUsageType, spScriptPort=spScriptPort, spDetector=spDetector, spReportURL=spReportURL, bgpDown=bgpDown, deviceTotalFlows=deviceTotalFlows, spMitigationStart=spMitigationStart, spDetectedCountries=spDetectedCountries, dnsBaselineDone=dnsBaselineDone, spBGPEvent=spBGPEvent, spVersion=spVersion, spFingerprintMessage=spFingerprintMessage, spLicenseErrLimit=spLicenseErrLimit, deviceSwapSpace=deviceSwapSpace, bgpHijack=bgpHijack, notificationLimit=notificationLimit, spThirdPartyAddr=spThirdPartyAddr, alertScript=alertScript, collectorDown=collectorDown, routingFailover=routingFailover, spServiceName=spServiceName, dosHostDetectionAlert=dosHostDetectionAlert, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBGPTrapPrefix=spBGPTrapPrefix, spLicenseErrType=spLicenseErrType, spBGPTrapName=spBGPTrapName, hardwareFailure=hardwareFailure, spTMSTimeout=spTMSTimeout, spInetAddressType=spInetAddressType, hardwareFailureDone=hardwareFailureDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationTMSStart=mitigationTMSStart, collectorUp=collectorUp, peakflowSPMgr=peakflowSPMgr, spAlertID=spAlertID, spGreTunnelName=spGreTunnelName, spImpactBps=spImpactBps, mitigationBlackholeStart=mitigationBlackholeStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationDone=mitigationDone, spLicenseErrDescription=spLicenseErrDescription, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptCommand=spScriptCommand, interfaceUsage=interfaceUsage, fingerprintUsageDone=fingerprintUsageDone, spServiceElement=spServiceElement, managedObjectUsage=managedObjectUsage, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spHijackRoute=spHijackRoute, serviceUsageDone=serviceUsageDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, deviceTotalFlowsHC=deviceTotalFlowsHC, spThreshold=spThreshold, serviceUsage=serviceUsage, PYSNMP_MODULE_ID=peakflowSPMIB, snmpUp=snmpUp, flowUp=flowUp, spDuration=spDuration, configChange=configChange, greDown=greDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spBlackholeTimeout=spBlackholeTimeout, spUnit=spUnit, spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPInstability=spBGPInstability, spInterfaceUsageHC=spInterfaceUsageHC, spDNSName=spDNSName, spReportID=spReportID, spTMSMultiPrefix=spTMSMultiPrefix, spReportName=spReportName, dnsBaseline=dnsBaseline, bgpInstabilityDone=bgpInstabilityDone, spImpactPps=spImpactPps, spThirdPartyZone=spThirdPartyZone, spTMSCommunity=spTMSCommunity, spManagedObjectFamily=spManagedObjectFamily, spFingerprintFeedback=spFingerprintFeedback, fingerprintUsage=fingerprintUsage, flowDown=flowDown, licenseErrorDone=licenseErrorDone, spLicenseErrCount=spLicenseErrCount, spManagedObjects=spManagedObjects, spUsername=spUsername, greDownDone=greDownDone, spManagedObject=spManagedObject, reportDone=reportDone, spDNSObserved=spDNSObserved, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, deviceSystemErrorDone=deviceSystemErrorDone, spDNSObservedMax=spDNSObservedMax, spAlertDetectionSignatures=spAlertDetectionSignatures, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spcommFailureDone=spcommFailureDone, spCollector=spCollector, spDNSObservedMean=spDNSObservedMean, bgpUp=bgpUp, bgpInstability=bgpInstability, spCommFailureDescription=spCommFailureDescription, spInterfaceIndex=spInterfaceIndex, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spHijackAttr=spHijackAttr, spInetAddress=spInetAddress, licenseError=licenseError, spPravail=spPravail, spHijackLocal=spHijackLocal, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, fingerprintFeedback=fingerprintFeedback, spDNSExpected=spDNSExpected, deviceDiskUsage=deviceDiskUsage, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFault=cloudSignalingFault, managedObjectUsageDone=managedObjectUsageDone, spInterfaceUsage=spInterfaceUsage, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPTrapEvent=spBGPTrapEvent, spBlackholeNexthop=spBlackholeNexthop, spMitigationID=spMitigationID, spCommFailureDestination=spCommFailureDestination, spSystemErrorType=spSystemErrorType, mitigationThirdPartyStart=mitigationThirdPartyStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, interfaceUsageDone=interfaceUsageDone, bgpTrap=bgpTrap, peakflowSPMIB=peakflowSPMIB, autoclassifyStart=autoclassifyStart, trafficAutoMitigation=trafficAutoMitigation, spBlackholePrefix=spBlackholePrefix, spRouter=spRouter, collectorStart=collectorStart, spApplicationName=spApplicationName, spFlowspecTimeout=spFlowspecTimeout, spMitigationName=spMitigationName, spGreTunnelDestination=spGreTunnelDestination, mitigationTMSStartV2=mitigationTMSStartV2, spTMSPrefix=spTMSPrefix, spFingerprintName=spFingerprintName, devicePhysicalMemory=devicePhysicalMemory, spcommFailure=spcommFailure, spUsage=spUsage, spInterfaceSpeed=spInterfaceSpeed, spFingerprintSender=spFingerprintSender, spScriptHost=spScriptHost, spInterfaceSpeedHC=spInterfaceSpeedHC, peakflowSPCMI=peakflowSPCMI, deviceSystemError=deviceSystemError, spSystemErrorDescription=spSystemErrorDescription, deviceHealth=deviceHealth, peakflowSPTraps=peakflowSPTraps, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptStart=spScriptStart, snmpDown=snmpDown, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterface=spInterface, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholeCommunity=spBlackholeCommunity)
