...
# Produced by pysmi-1.1.12 at Tue May 28 11:43:45 2024
...
NotificationType, Integer32, ObjectIdentity, iso, ModuleIdentity, Unsigned32, IpAddress, Counter64, TimeTicks, MibIdentifier, Counter32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "Counter64", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", alertScript=alertScript, managedObjectUsageDone=managedObjectUsageDone, interfaceUsage=interfaceUsage, dosHostDetectionAlert=dosHostDetectionAlert, spUsername=spUsername, spInterface=spInterface, spCommFailureDescription=spCommFailureDescription, fingerprintFeedback=fingerprintFeedback, spBGPTrapPrefix=spBGPTrapPrefix, snmpUp=snmpUp, licenseErrorDone=licenseErrorDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHijackRoute=spHijackRoute, collectorDown=collectorDown, cloudSignalingFaultDone=cloudSignalingFaultDone, spDuration=spDuration, spDNSObservedMean=spDNSObservedMean, spManagedObject=spManagedObject, hardwareFailure=hardwareFailure, fingerprintReceive=fingerprintReceive, spMitigationName=spMitigationName, spBGPTrapEvent=spBGPTrapEvent, spReportID=spReportID, spImpactBps=spImpactBps, spHijackLocal=spHijackLocal, spCommFailureDestination=spCommFailureDestination, spBGPEvent=spBGPEvent, greDownDone=greDownDone, spFingerprintName=spFingerprintName, deviceTotalFlows=deviceTotalFlows, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorDescription=spSystemErrorDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spLicenseErrCount=spLicenseErrCount, spManagedObjects=spManagedObjects, dosHostDetectionAlertDone=dosHostDetectionAlertDone, cloudSignalingFault=cloudSignalingFault, spPravail=spPravail, spBlackholeCommunity=spBlackholeCommunity, spSystemErrorType=spSystemErrorType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, spLicenseErrType=spLicenseErrType, spReportURL=spReportURL, spBGPTrapName=spBGPTrapName, spRouter=spRouter, spDNSExpected=spDNSExpected, spInetAddress=spInetAddress, spThirdPartyAddr=spThirdPartyAddr, licenseError=licenseError, bgpInstabilityDone=bgpInstabilityDone, spTMSPrefix=spTMSPrefix, spMitigationStart=spMitigationStart, spInterfaceUsage=spInterfaceUsage, mitigationFlowspecStart=mitigationFlowspecStart, spManagedObjectFamily=spManagedObjectFamily, peakflowSPMgr=peakflowSPMgr, spServiceElement=spServiceElement, spUsage=spUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spThirdPartyZone=spThirdPartyZone, spServiceName=spServiceName, bgpHijack=bgpHijack, spBGPTrapOldAttributes=spBGPTrapOldAttributes, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, devicePhysicalMemory=devicePhysicalMemory, flowDown=flowDown, spDNSObserved=spDNSObserved, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceUsageHC=spInterfaceUsageHC, mitigationBlackholeStart=mitigationBlackholeStart, deviceSwapSpace=deviceSwapSpace, spMitigationID=spMitigationID, spInterfaceSpeedHC=spInterfaceSpeedHC, spGreTunnelName=spGreTunnelName, spApplicationName=spApplicationName, spInterfaceSpeed=spInterfaceSpeed, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrLimit=spLicenseErrLimit, deviceHealth=deviceHealth, configChange=configChange, notificationLimit=notificationLimit, dnsBaselineDone=dnsBaselineDone, spHijackAttr=spHijackAttr, spTMSTimeout=spTMSTimeout, spInetAddressType=spInetAddressType, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintSender=spFingerprintSender, serviceUsage=serviceUsage, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPCMI=peakflowSPCMI, spBGPTrapNewAttributes=spBGPTrapNewAttributes, greDown=greDown, deviceTotalFlowsHC=deviceTotalFlowsHC, snmpDown=snmpDown, mitigationDone=mitigationDone, spScriptHost=spScriptHost, spScriptPort=spScriptPort, spThreshold=spThreshold, peakflowSPTraps=peakflowSPTraps, spBlackholePrefix=spBlackholePrefix, spDetectedCountries=spDetectedCountries, spcommFailure=spcommFailure, bgpTrap=bgpTrap, spScriptStart=spScriptStart, spFlowspecTimeout=spFlowspecTimeout, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceSystemErrorDone=deviceSystemErrorDone, spDNSObservedMax=spDNSObservedMax, spDetector=spDetector, spFingerprintFeedback=spFingerprintFeedback, spScriptCommand=spScriptCommand, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUnit=spUnit, spTMSCommunity=spTMSCommunity, flowUp=flowUp, bgpInstability=bgpInstability, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, trafficAutoMitigation=trafficAutoMitigation, hardwareFailureDone=hardwareFailureDone, spcommFailureDone=spcommFailureDone, spLicenseErrDescription=spLicenseErrDescription, spVersion=spVersion, autoclassifyStart=autoclassifyStart, PYSNMP_MODULE_ID=peakflowSPMIB, interfaceUsageDone=interfaceUsageDone, spImpactPps=spImpactPps, spBGPInstability=spBGPInstability, spUsageType=spUsageType, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationTMSStart=mitigationTMSStart, peakflowSPMIB=peakflowSPMIB, spInterfaceIndex=spInterfaceIndex, reportDone=reportDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholeTimeout=spBlackholeTimeout, spReportName=spReportName, spFlowspecCommunity=spFlowspecCommunity, bgpDown=bgpDown, dnsBaseline=dnsBaseline, spDNSName=spDNSName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spFingerprintMessage=spFingerprintMessage, collectorUp=collectorUp, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceDiskUsage=deviceDiskUsage, fingerprintUsageDone=fingerprintUsageDone, spAlertID=spAlertID, routingFailover=routingFailover, dosNetworkProfiledAlert=dosNetworkProfiledAlert, bgpUp=bgpUp, fingerprintUsage=fingerprintUsage, deviceSystemError=deviceSystemError, spBlackholeNexthop=spBlackholeNexthop, collectorStart=collectorStart, serviceUsageDone=serviceUsageDone, spCollector=spCollector, managedObjectUsage=managedObjectUsage, spGreTunnelDestination=spGreTunnelDestination)
