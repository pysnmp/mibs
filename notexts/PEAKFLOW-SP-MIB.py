...
# Produced by pysmi-1.1.8 at Tue Feb  1 20:57:21 2022
...
Integer32, iso, Gauge32, IpAddress, Counter64, NotificationType, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "IpAddress", "Counter64", "NotificationType", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorStart=collectorStart, flowUp=flowUp, serviceUsage=serviceUsage, spUsageType=spUsageType, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spServiceElement=spServiceElement, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, autoclassifyStart=autoclassifyStart, deviceSystemErrorDone=deviceSystemErrorDone, spInetAddressType=spInetAddressType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorUp=collectorUp, spInterfaceUsageHC=spInterfaceUsageHC, mitigationThirdPartyStart=mitigationThirdPartyStart, spBGPInstability=spBGPInstability, spMitigationID=spMitigationID, spImpactPps=spImpactPps, dnsBaselineDone=dnsBaselineDone, spThreshold=spThreshold, spInterfaceSpeed=spInterfaceSpeed, spFingerprintMessage=spFingerprintMessage, deviceSystemError=deviceSystemError, snmpUp=snmpUp, spBlackholeCommunity=spBlackholeCommunity, licenseError=licenseError, spFlowspecCommunity=spFlowspecCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spManagedObjects=spManagedObjects, spLicenseErrLimit=spLicenseErrLimit, spHijackRoute=spHijackRoute, spMitigationStart=spMitigationStart, mitigationDone=mitigationDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spThirdPartyAddr=spThirdPartyAddr, spGreTunnelName=spGreTunnelName, spInterfaceSpeedHC=spInterfaceSpeedHC, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlert=dosHostDetectionAlert, spManagedObjectFamily=spManagedObjectFamily, spReportID=spReportID, deviceHealth=deviceHealth, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spDNSName=spDNSName, spDNSExpected=spDNSExpected, flowDown=flowDown, hardwareFailure=hardwareFailure, spTMSCommunity=spTMSCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spUsername=spUsername, spDNSObservedMean=spDNSObservedMean, bgpUp=bgpUp, spReportName=spReportName, spcommFailure=spcommFailure, mitigationTMSStartV2=mitigationTMSStartV2, deviceTotalFlows=deviceTotalFlows, spBGPTrapEvent=spBGPTrapEvent, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDNSObservedMax=spDNSObservedMax, spDetectedCountries=spDetectedCountries, spBlackholeNexthop=spBlackholeNexthop, spCommFailureDestination=spCommFailureDestination, cloudSignalingFault=cloudSignalingFault, spHardwareFailureDescription=spHardwareFailureDescription, spLicenseErrDescription=spLicenseErrDescription, spMitigationName=spMitigationName, spSystemErrorDescription=spSystemErrorDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationTMSStart=mitigationTMSStart, spcommFailureDone=spcommFailureDone, spPravail=spPravail, spUsage=spUsage, spAlertID=spAlertID, spTMSPrefix=spTMSPrefix, spVersion=spVersion, licenseErrorDone=licenseErrorDone, peakflowSPMgr=peakflowSPMgr, spDuration=spDuration, spDNSObserved=spDNSObserved, spThirdPartyZone=spThirdPartyZone, spManagedObject=spManagedObject, fingerprintFeedback=fingerprintFeedback, spInterfaceIndex=spInterfaceIndex, routingFailover=routingFailover, mitigationBlackholeStart=mitigationBlackholeStart, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFingerprintFeedback=spFingerprintFeedback, deviceSwapSpace=deviceSwapSpace, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, bgpDown=bgpDown, spImpactBps=spImpactBps, spTMSMultiPrefix=spTMSMultiPrefix, spHijackAttr=spHijackAttr, spBGPTrapName=spBGPTrapName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, managedObjectUsage=managedObjectUsage, peakflowSPTraps=peakflowSPTraps, spFingerprintName=spFingerprintName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInetAddress=spInetAddress, serviceUsageDone=serviceUsageDone, fingerprintUsage=fingerprintUsage, bgpTrap=bgpTrap, spFlowspecTimeout=spFlowspecTimeout, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBlackholePrefix=spBlackholePrefix, notificationLimit=notificationLimit, spDetector=spDetector, mitigationFlowspecStart=mitigationFlowspecStart, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, managedObjectUsageDone=managedObjectUsageDone, peakflowSPCMI=peakflowSPCMI, deviceDiskUsage=deviceDiskUsage, spScriptHost=spScriptHost, alertScript=alertScript, fingerprintUsageDone=fingerprintUsageDone, spUnit=spUnit, spBGPTrapPrefix=spBGPTrapPrefix, spTMSTimeout=spTMSTimeout, interfaceUsageDone=interfaceUsageDone, configChange=configChange, spRouter=spRouter, spInterfaceUsage=spInterfaceUsage, spServiceName=spServiceName, spApplicationName=spApplicationName, greDownDone=greDownDone, spInterface=spInterface, bgpInstability=bgpInstability, devicePhysicalMemory=devicePhysicalMemory, peakflowSPMIB=peakflowSPMIB, interfaceUsage=interfaceUsage, spFingerprintSender=spFingerprintSender, spBlackholeTimeout=spBlackholeTimeout, snmpDown=snmpDown, bgpHijack=bgpHijack, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spSystemErrorType=spSystemErrorType, spBGPEvent=spBGPEvent, greDown=greDown, spCommFailureDescription=spCommFailureDescription, spLicenseErrCount=spLicenseErrCount, spCollector=spCollector, spReportURL=spReportURL, spScriptStart=spScriptStart, hardwareFailureDone=hardwareFailureDone, trafficAutoMitigation=trafficAutoMitigation, deviceTotalFlowsHC=deviceTotalFlowsHC, spHijackLocal=spHijackLocal, collectorDown=collectorDown, spGreTunnelDestination=spGreTunnelDestination, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spLicenseErrType=spLicenseErrType, dnsBaseline=dnsBaseline, reportDone=reportDone, spScriptPort=spScriptPort, spScriptCommand=spScriptCommand)
