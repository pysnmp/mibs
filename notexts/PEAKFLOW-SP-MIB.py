...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:32:37 2022
...
MibIdentifier, NotificationType, Unsigned32, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter64, Bits, ObjectIdentity, Counter32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter64", "Bits", "ObjectIdentity", "Counter32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spFingerprintName=spFingerprintName, peakflowSPMgr=peakflowSPMgr, spManagedObject=spManagedObject, spServiceElement=spServiceElement, spInterfaceUsageHC=spInterfaceUsageHC, hardwareFailure=hardwareFailure, spImpactPps=spImpactPps, spGreTunnelName=spGreTunnelName, fingerprintUsageDone=fingerprintUsageDone, spBGPTrapName=spBGPTrapName, spFingerprintFeedback=spFingerprintFeedback, spFlowspecCommunity=spFlowspecCommunity, spBlackholeTimeout=spBlackholeTimeout, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterface=spInterface, spDetector=spDetector, licenseError=licenseError, spBGPEvent=spBGPEvent, bgpHijack=bgpHijack, spReportURL=spReportURL, spTMSMultiPrefix=spTMSMultiPrefix, autoclassifyStart=autoclassifyStart, spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapPrefix=spBGPTrapPrefix, spFlowspecTimeout=spFlowspecTimeout, dosHostDetectionAlert=dosHostDetectionAlert, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, fingerprintUsage=fingerprintUsage, spMitigationName=spMitigationName, spThirdPartyAddr=spThirdPartyAddr, spApplicationName=spApplicationName, deviceHealth=deviceHealth, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCommFailureDescription=spCommFailureDescription, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, routingFailover=routingFailover, peakflowSPTraps=peakflowSPTraps, deviceDiskUsage=deviceDiskUsage, mitigationTMSStartV2=mitigationTMSStartV2, flowUp=flowUp, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spUsername=spUsername, spcommFailure=spcommFailure, spFingerprintMessage=spFingerprintMessage, spRouter=spRouter, spBGPInstability=spBGPInstability, spLicenseErrType=spLicenseErrType, snmpDown=snmpDown, peakflowSPMIB=peakflowSPMIB, dnsBaselineDone=dnsBaselineDone, deviceSystemErrorDone=deviceSystemErrorDone, spAlertID=spAlertID, spBlackholePrefix=spBlackholePrefix, spDNSObservedMean=spDNSObservedMean, spAlertDetectionSignatures=spAlertDetectionSignatures, mitigationTMSStart=mitigationTMSStart, collectorStart=collectorStart, spInetAddressType=spInetAddressType, snmpUp=snmpUp, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spLicenseErrLimit=spLicenseErrLimit, greDownDone=greDownDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spDNSName=spDNSName, spInterfaceUsage=spInterfaceUsage, spBlackholeCommunity=spBlackholeCommunity, hardwareFailureDone=hardwareFailureDone, serviceUsageDone=serviceUsageDone, interfaceUsageDone=interfaceUsageDone, spThreshold=spThreshold, spSystemErrorType=spSystemErrorType, spMitigationStart=spMitigationStart, trafficAutoMitigation=trafficAutoMitigation, spManagedObjectFamily=spManagedObjectFamily, spHijackAttr=spHijackAttr, spScriptHost=spScriptHost, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyZone=spThirdPartyZone, deviceSwapSpace=deviceSwapSpace, spMitigationID=spMitigationID, spCollector=spCollector, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackRoute=spHijackRoute, spDetectedCountries=spDetectedCountries, spServiceName=spServiceName, PYSNMP_MODULE_ID=peakflowSPMIB, spTMSTimeout=spTMSTimeout, spUsageType=spUsageType, spInterfaceIndex=spInterfaceIndex, collectorDown=collectorDown, spScriptCommand=spScriptCommand, deviceTotalFlows=deviceTotalFlows, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintReceive=fingerprintReceive, notificationLimit=notificationLimit, spcommFailureDone=spcommFailureDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spSystemErrorDescription=spSystemErrorDescription, bgpDown=bgpDown, spManagedObjects=spManagedObjects, cloudSignalingFault=cloudSignalingFault, spBGPTrapEvent=spBGPTrapEvent, spTMSPrefix=spTMSPrefix, devicePhysicalMemory=devicePhysicalMemory, mitigationFlowspecStart=mitigationFlowspecStart, spReportName=spReportName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, alertScript=alertScript, greDown=greDown, spScriptStart=spScriptStart, spInetAddress=spInetAddress, spUsage=spUsage, serviceUsage=serviceUsage, spInterfaceSpeed=spInterfaceSpeed, spDNSObserved=spDNSObserved, spLicenseErrDescription=spLicenseErrDescription, managedObjectUsageDone=managedObjectUsageDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, managedObjectUsage=managedObjectUsage, spHijackLocal=spHijackLocal, spDNSExpected=spDNSExpected, spImpactBps=spImpactBps, collectorUp=collectorUp, spGreTunnelDestination=spGreTunnelDestination, bgpUp=bgpUp, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, mitigationDone=mitigationDone, spDuration=spDuration, spLicenseErrCount=spLicenseErrCount, deviceSystemError=deviceSystemError, deviceTotalFlowsHC=deviceTotalFlowsHC, spPravail=spPravail, bgpInstabilityDone=bgpInstabilityDone, bgpTrap=bgpTrap, configChange=configChange, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPCMI=peakflowSPCMI, spUnit=spUnit, mitigationBlackholeStart=mitigationBlackholeStart, licenseErrorDone=licenseErrorDone, reportDone=reportDone, spBlackholeNexthop=spBlackholeNexthop, spCommFailureDestination=spCommFailureDestination, spVersion=spVersion, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spDNSObservedMax=spDNSObservedMax, spReportID=spReportID, interfaceUsage=interfaceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spScriptPort=spScriptPort, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spFingerprintSender=spFingerprintSender, fingerprintFeedback=fingerprintFeedback, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpInstability=bgpInstability, dnsBaseline=dnsBaseline, spInterfaceSpeedHC=spInterfaceSpeedHC, flowDown=flowDown)
