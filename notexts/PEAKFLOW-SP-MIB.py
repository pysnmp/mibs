...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:47:35 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter64, Unsigned32, Counter32, Integer32, iso, ObjectIdentity, MibIdentifier, Bits, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "Integer32", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDNSObservedMean=spDNSObservedMean, spImpactBps=spImpactBps, spBGPEvent=spBGPEvent, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, greDownDone=greDownDone, deviceTotalFlows=deviceTotalFlows, spManagedObjectFamily=spManagedObjectFamily, mitigationTMSStart=mitigationTMSStart, spInterfaceIndex=spInterfaceIndex, spInetAddress=spInetAddress, spCollector=spCollector, spImpactPps=spImpactPps, spReportURL=spReportURL, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spcommFailureDone=spcommFailureDone, hardwareFailureDone=hardwareFailureDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spcommFailure=spcommFailure, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceUsage=spInterfaceUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spGreTunnelName=spGreTunnelName, spAlertDetectionSignatures=spAlertDetectionSignatures, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPInstability=spBGPInstability, managedObjectUsageDone=managedObjectUsageDone, interfaceUsage=interfaceUsage, spGreTunnelDestination=spGreTunnelDestination, spScriptStart=spScriptStart, spCommFailureDestination=spCommFailureDestination, spLicenseErrDescription=spLicenseErrDescription, spDuration=spDuration, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, fingerprintFeedback=fingerprintFeedback, spTMSPrefix=spTMSPrefix, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholeNexthop=spBlackholeNexthop, spScriptPort=spScriptPort, collectorUp=collectorUp, managedObjectUsage=managedObjectUsage, dosHostDetectionAlert=dosHostDetectionAlert, trafficAutoMitigation=trafficAutoMitigation, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, serviceUsage=serviceUsage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDown=greDown, bgpInstability=bgpInstability, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spThirdPartyAddr=spThirdPartyAddr, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceUsageHC=spInterfaceUsageHC, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintReceive=fingerprintReceive, spInetAddressType=spInetAddressType, serviceUsageDone=serviceUsageDone, peakflowSPCMI=peakflowSPCMI, mitigationTMSStartV2=mitigationTMSStartV2, devicePhysicalMemory=devicePhysicalMemory, spBGPTrapName=spBGPTrapName, spUsage=spUsage, peakflowSPMIB=peakflowSPMIB, spUsername=spUsername, spBlackholeTimeout=spBlackholeTimeout, interfaceUsageDone=interfaceUsageDone, deviceTotalFlowsHC=deviceTotalFlowsHC, bgpDown=bgpDown, spFlowspecCommunity=spFlowspecCommunity, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBlackholePrefix=spBlackholePrefix, spScriptHost=spScriptHost, configChange=configChange, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsageDone=fingerprintUsageDone, spDNSName=spDNSName, collectorStart=collectorStart, bgpHijack=bgpHijack, spLicenseErrType=spLicenseErrType, spDetector=spDetector, spAlertID=spAlertID, spUnit=spUnit, spHijackAttr=spHijackAttr, peakflowSPMgr=peakflowSPMgr, reportDone=reportDone, cloudSignalingFault=cloudSignalingFault, fingerprintUsage=fingerprintUsage, spScriptCommand=spScriptCommand, hardwareFailure=hardwareFailure, spMitigationStart=spMitigationStart, spThreshold=spThreshold, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spManagedObjects=spManagedObjects, spReportID=spReportID, deviceDiskUsage=deviceDiskUsage, spThirdPartyZone=spThirdPartyZone, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorDown=collectorDown, spLicenseErrLimit=spLicenseErrLimit, alertScript=alertScript, spManagedObject=spManagedObject, spApplicationName=spApplicationName, mitigationBlackholeStart=mitigationBlackholeStart, licenseErrorDone=licenseErrorDone, spHardwareFailureDescription=spHardwareFailureDescription, autoclassifyStart=autoclassifyStart, flowUp=flowUp, deviceHealth=deviceHealth, spDetectedCountries=spDetectedCountries, snmpUp=snmpUp, deviceSystemErrorDone=deviceSystemErrorDone, spPravail=spPravail, dnsBaseline=dnsBaseline, deviceSwapSpace=deviceSwapSpace, spInterfaceSpeed=spInterfaceSpeed, spDNSObservedMax=spDNSObservedMax, spSystemErrorType=spSystemErrorType, bgpInstabilityDone=bgpInstabilityDone, bgpTrap=bgpTrap, spBGPTrapEvent=spBGPTrapEvent, notificationLimit=notificationLimit, PYSNMP_MODULE_ID=peakflowSPMIB, spVersion=spVersion, peakflowSPTraps=peakflowSPTraps, spRouter=spRouter, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spLicenseErrCount=spLicenseErrCount, spDNSObserved=spDNSObserved, mitigationDone=mitigationDone, routingFailover=routingFailover, spCommFailureDescription=spCommFailureDescription, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spMitigationID=spMitigationID, spServiceName=spServiceName, flowDown=flowDown, snmpDown=snmpDown, deviceSystemError=deviceSystemError, mitigationThirdPartyStart=mitigationThirdPartyStart, spHijackRoute=spHijackRoute, spMitigationName=spMitigationName, spTMSCommunity=spTMSCommunity, deviceSwapSpaceInUse=deviceSwapSpaceInUse, bgpUp=bgpUp, spDNSExpected=spDNSExpected, spReportName=spReportName, spUsageType=spUsageType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, licenseError=licenseError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spFingerprintName=spFingerprintName, spBlackholeCommunity=spBlackholeCommunity, spFingerprintMessage=spFingerprintMessage, spTMSMultiPrefix=spTMSMultiPrefix, spTMSTimeout=spTMSTimeout, spFingerprintFeedback=spFingerprintFeedback, spInterface=spInterface, spSystemErrorDescription=spSystemErrorDescription, spFingerprintSender=spFingerprintSender, spHijackLocal=spHijackLocal, spServiceElement=spServiceElement, spFlowspecTimeout=spFlowspecTimeout, dnsBaselineDone=dnsBaselineDone)
