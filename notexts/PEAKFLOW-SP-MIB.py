...
# Produced by pysmi-1.1.12 at Tue May 28 12:08:39 2024
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spPravail=spPravail, spHijackAttr=spHijackAttr, spTMSMultiPrefix=spTMSMultiPrefix, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, fingerprintUsage=fingerprintUsage, spApplicationName=spApplicationName, dnsBaseline=dnsBaseline, spImpactPps=spImpactPps, spCollector=spCollector, bgpInstability=bgpInstability, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, notificationLimit=notificationLimit, spBGPTrapNewAttributes=spBGPTrapNewAttributes, deviceTotalFlowsHC=deviceTotalFlowsHC, spServiceName=spServiceName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSObservedMean=spDNSObservedMean, spBGPInstability=spBGPInstability, spUnit=spUnit, spLicenseErrType=spLicenseErrType, licenseError=licenseError, spInterfaceIndex=spInterfaceIndex, spMitigationStart=spMitigationStart, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholeCommunity=spBlackholeCommunity, spFingerprintFeedback=spFingerprintFeedback, spUsage=spUsage, spScriptStart=spScriptStart, spBlackholeNexthop=spBlackholeNexthop, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spMitigationName=spMitigationName, spTMSCommunity=spTMSCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, mitigationTMSStart=mitigationTMSStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHijackRoute=spHijackRoute, spDNSName=spDNSName, fingerprintReceive=fingerprintReceive, flowUp=flowUp, spFlowspecTimeout=spFlowspecTimeout, managedObjectUsageDone=managedObjectUsageDone, spSystemErrorType=spSystemErrorType, spBlackholePrefix=spBlackholePrefix, snmpDown=snmpDown, devicePhysicalMemory=devicePhysicalMemory, interfaceUsage=interfaceUsage, collectorUp=collectorUp, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spSystemErrorDescription=spSystemErrorDescription, spInetAddress=spInetAddress, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapName=spBGPTrapName, spFlowspecCommunity=spFlowspecCommunity, spGreTunnelDestination=spGreTunnelDestination, flowDown=flowDown, spDNSExpected=spDNSExpected, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpDown=bgpDown, spThirdPartyAddr=spThirdPartyAddr, spDNSObserved=spDNSObserved, bgpTrap=bgpTrap, reportDone=reportDone, mitigationBlackholeStart=mitigationBlackholeStart, spInterface=spInterface, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spScriptHost=spScriptHost, spInterfaceSpeed=spInterfaceSpeed, mitigationTMSStartV2=mitigationTMSStartV2, spImpactBps=spImpactBps, managedObjectUsage=managedObjectUsage, bgpUp=bgpUp, configChange=configChange, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spcommFailureDone=spcommFailureDone, spAlertID=spAlertID, spHijackLocal=spHijackLocal, deviceDiskUsage=deviceDiskUsage, spGreTunnelName=spGreTunnelName, spDNSObservedMax=spDNSObservedMax, spFingerprintSender=spFingerprintSender, autoclassifyStart=autoclassifyStart, spMitigationID=spMitigationID, spLicenseErrCount=spLicenseErrCount, peakflowSPTraps=peakflowSPTraps, mitigationThirdPartyStart=mitigationThirdPartyStart, spRouter=spRouter, spServiceElement=spServiceElement, licenseErrorDone=licenseErrorDone, deviceSwapSpace=deviceSwapSpace, hardwareFailureDone=hardwareFailureDone, deviceSystemError=deviceSystemError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjects=spManagedObjects, fingerprintFeedback=fingerprintFeedback, greDownDone=greDownDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailover=routingFailover, spReportName=spReportName, spScriptPort=spScriptPort, mitigationDone=mitigationDone, peakflowSPMIB=peakflowSPMIB, spDetector=spDetector, serviceUsageDone=serviceUsageDone, deviceHealth=deviceHealth, spInetAddressType=spInetAddressType, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, deviceTotalFlows=deviceTotalFlows, spVersion=spVersion, spThreshold=spThreshold, spScriptCommand=spScriptCommand, spCommFailureDestination=spCommFailureDestination, peakflowSPCMI=peakflowSPCMI, collectorStart=collectorStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, hardwareFailure=hardwareFailure, spTMSPrefix=spTMSPrefix, spReportURL=spReportURL, spBlackholeTimeout=spBlackholeTimeout, spInterfaceUsageHC=spInterfaceUsageHC, spReportID=spReportID, bgpInstabilityDone=bgpInstabilityDone, spUsername=spUsername, spDuration=spDuration, spFingerprintMessage=spFingerprintMessage, cloudSignalingFaultDone=cloudSignalingFaultDone, collectorDown=collectorDown, spBGPTrapOldAttributes=spBGPTrapOldAttributes, dnsBaselineDone=dnsBaselineDone, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, spThirdPartyZone=spThirdPartyZone, interfaceUsageDone=interfaceUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceUsage=spInterfaceUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsageType=spUsageType, spHardwareFailureDescription=spHardwareFailureDescription, cloudSignalingFault=cloudSignalingFault, PYSNMP_MODULE_ID=peakflowSPMIB, spDetectedCountries=spDetectedCountries, trafficAutoMitigation=trafficAutoMitigation, mitigationFlowspecStart=mitigationFlowspecStart, spBGPEvent=spBGPEvent, spCommFailureDescription=spCommFailureDescription, alertScript=alertScript, greDown=greDown, snmpUp=snmpUp, spLicenseErrDescription=spLicenseErrDescription, spcommFailure=spcommFailure, serviceUsage=serviceUsage, spManagedObjectFamily=spManagedObjectFamily, peakflowSPMgr=peakflowSPMgr, spBGPTrapEvent=spBGPTrapEvent, spFingerprintName=spFingerprintName, spManagedObject=spManagedObject, fingerprintUsageDone=fingerprintUsageDone, bgpHijack=bgpHijack, spTMSTimeout=spTMSTimeout, spInterfaceSpeedHC=spInterfaceSpeedHC)
