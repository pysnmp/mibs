...
# Produced by pysmi-1.1.12 at Thu Apr  4 09:14:46 2024
...
Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Unsigned32, Integer32, TimeTicks, Counter64, ModuleIdentity, iso, ObjectIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "ModuleIdentity", "iso", "ObjectIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDuration=spDuration, mitigationBlackholeStart=mitigationBlackholeStart, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationDone=mitigationDone, spServiceName=spServiceName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dnsBaseline=dnsBaseline, spManagedObjects=spManagedObjects, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spTMSCommunity=spTMSCommunity, spAlertDetectionSignatures=spAlertDetectionSignatures, spCollector=spCollector, managedObjectUsageDone=managedObjectUsageDone, spDNSObserved=spDNSObserved, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spHijackRoute=spHijackRoute, spMitigationName=spMitigationName, spBlackholeTimeout=spBlackholeTimeout, licenseError=licenseError, mitigationTMSStartV2=mitigationTMSStartV2, spGreTunnelName=spGreTunnelName, interfaceUsage=interfaceUsage, dnsBaselineDone=dnsBaselineDone, mitigationTMSStart=mitigationTMSStart, spInetAddressType=spInetAddressType, deviceTotalFlows=deviceTotalFlows, spBGPTrapName=spBGPTrapName, spDNSObservedMean=spDNSObservedMean, spGreTunnelDestination=spGreTunnelDestination, deviceHealth=deviceHealth, spManagedObject=spManagedObject, peakflowSPMIB=peakflowSPMIB, spBlackholeCommunity=spBlackholeCommunity, bgpUp=bgpUp, spScriptCommand=spScriptCommand, spAlertID=spAlertID, spUsageType=spUsageType, spTMSPrefix=spTMSPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrLimit=spLicenseErrLimit, reportDone=reportDone, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapEvent=spBGPTrapEvent, spBGPInstability=spBGPInstability, fingerprintFeedback=fingerprintFeedback, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapPrefix=spBGPTrapPrefix, spRouter=spRouter, hardwareFailureDone=hardwareFailureDone, spUsername=spUsername, spInterface=spInterface, trafficAutoMitigation=trafficAutoMitigation, greDownDone=greDownDone, spReportID=spReportID, spInterfaceUsage=spInterfaceUsage, spScriptPort=spScriptPort, spDNSObservedMax=spDNSObservedMax, spBlackholePrefix=spBlackholePrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spMitigationID=spMitigationID, spVersion=spVersion, spPravail=spPravail, spDetectedCountries=spDetectedCountries, spInetAddress=spInetAddress, spLicenseErrCount=spLicenseErrCount, mitigationFlowspecStart=mitigationFlowspecStart, peakflowSPTraps=peakflowSPTraps, peakflowSPMgr=peakflowSPMgr, bgpDown=bgpDown, serviceUsageDone=serviceUsageDone, spSystemErrorDescription=spSystemErrorDescription, spThirdPartyZone=spThirdPartyZone, spScriptStart=spScriptStart, spImpactPps=spImpactPps, spTMSTimeout=spTMSTimeout, mitigationThirdPartyStart=mitigationThirdPartyStart, autoclassifyStart=autoclassifyStart, spHijackLocal=spHijackLocal, bgpTrap=bgpTrap, alertScript=alertScript, spInterfaceSpeedHC=spInterfaceSpeedHC, cloudSignalingFault=cloudSignalingFault, licenseErrorDone=licenseErrorDone, spSystemErrorType=spSystemErrorType, peakflowSPCMI=peakflowSPCMI, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObjectFamily=spManagedObjectFamily, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spApplicationName=spApplicationName, bgpInstability=bgpInstability, interfaceUsageDone=interfaceUsageDone, configChange=configChange, serviceUsage=serviceUsage, deviceDiskUsage=deviceDiskUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpInstabilityDone=bgpInstabilityDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spUnit=spUnit, hardwareFailure=hardwareFailure, deviceSystemError=deviceSystemError, flowUp=flowUp, spHijackAttr=spHijackAttr, fingerprintReceive=fingerprintReceive, fingerprintUsageDone=fingerprintUsageDone, spMitigationStart=spMitigationStart, spUsage=spUsage, spImpactBps=spImpactBps, spFlowspecTimeout=spFlowspecTimeout, deviceSwapSpace=deviceSwapSpace, spcommFailureDone=spcommFailureDone, spFingerprintName=spFingerprintName, flowDown=flowDown, cloudSignalingFaultDone=cloudSignalingFaultDone, spThreshold=spThreshold, spInterfaceUsageHC=spInterfaceUsageHC, spFingerprintFeedback=spFingerprintFeedback, spBGPEvent=spBGPEvent, spcommFailure=spcommFailure, collectorUp=collectorUp, spBlackholeNexthop=spBlackholeNexthop, spTMSMultiPrefix=spTMSMultiPrefix, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDetector=spDetector, spInterfaceIndex=spInterfaceIndex, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spFlowspecCommunity=spFlowspecCommunity, spServiceElement=spServiceElement, spLicenseErrDescription=spLicenseErrDescription, spCommFailureDescription=spCommFailureDescription, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, notificationLimit=notificationLimit, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorDown=collectorDown, spDNSName=spDNSName, collectorStart=collectorStart, managedObjectUsage=managedObjectUsage, spDNSExpected=spDNSExpected, spFingerprintMessage=spFingerprintMessage, devicePhysicalMemory=devicePhysicalMemory, bgpHijack=bgpHijack, spReportName=spReportName, fingerprintUsage=fingerprintUsage, spReportURL=spReportURL, PYSNMP_MODULE_ID=peakflowSPMIB, snmpUp=snmpUp, spCommFailureDestination=spCommFailureDestination, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintSender=spFingerprintSender, greDown=greDown, spHardwareFailureDescription=spHardwareFailureDescription, spInterfaceSpeed=spInterfaceSpeed, routingFailover=routingFailover, snmpDown=snmpDown, spScriptHost=spScriptHost, dosHostDetectionAlert=dosHostDetectionAlert)
