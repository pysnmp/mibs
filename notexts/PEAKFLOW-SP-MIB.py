...
# Produced by pysmi-1.1.12 at Tue Jun 18 01:35:38 2024
...
Gauge32, ObjectIdentity, MibIdentifier, Integer32, IpAddress, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Bits", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceSystemError=deviceSystemError, dosHostDetectionAlertDone=dosHostDetectionAlertDone, mitigationBlackholeStart=mitigationBlackholeStart, spServiceElement=spServiceElement, snmpUp=snmpUp, spLicenseErrLimit=spLicenseErrLimit, PYSNMP_MODULE_ID=peakflowSPMIB, spRouter=spRouter, spManagedObjects=spManagedObjects, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spInterfaceUsage=spInterfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spUsername=spUsername, spFingerprintFeedback=spFingerprintFeedback, serviceUsage=serviceUsage, peakflowSPMgr=peakflowSPMgr, spCollector=spCollector, spUsageType=spUsageType, spMitigationID=spMitigationID, flowUp=flowUp, reportDone=reportDone, spPravail=spPravail, mitigationDone=mitigationDone, spTMSPrefix=spTMSPrefix, spHijackLocal=spHijackLocal, spDNSObservedMax=spDNSObservedMax, peakflowSPTraps=peakflowSPTraps, dnsBaselineDone=dnsBaselineDone, spBlackholePrefix=spBlackholePrefix, spDetector=spDetector, spManagedObjectFamily=spManagedObjectFamily, spScriptCommand=spScriptCommand, deviceDiskUsage=deviceDiskUsage, collectorStart=collectorStart, spMitigationName=spMitigationName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spReportURL=spReportURL, spInterface=spInterface, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpDown=bgpDown, spcommFailure=spcommFailure, notificationLimit=notificationLimit, mitigationTMSStart=mitigationTMSStart, spLicenseErrDescription=spLicenseErrDescription, spScriptStart=spScriptStart, licenseError=licenseError, spDuration=spDuration, spSystemErrorType=spSystemErrorType, spCommFailureDestination=spCommFailureDestination, spDNSExpected=spDNSExpected, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spUsage=spUsage, spScriptHost=spScriptHost, configChange=configChange, spBlackholeCommunity=spBlackholeCommunity, spHijackRoute=spHijackRoute, collectorUp=collectorUp, bgpUp=bgpUp, spBGPTrapEvent=spBGPTrapEvent, fingerprintReceive=fingerprintReceive, spDNSObservedMean=spDNSObservedMean, fingerprintUsage=fingerprintUsage, spUnit=spUnit, deviceSwapSpace=deviceSwapSpace, spAlertID=spAlertID, dnsBaseline=dnsBaseline, serviceUsageDone=serviceUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dosHostDetectionAlert=dosHostDetectionAlert, greDown=greDown, licenseErrorDone=licenseErrorDone, spInetAddressType=spInetAddressType, spInterfaceIndex=spInterfaceIndex, spBGPTrapOldAttributes=spBGPTrapOldAttributes, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptPort=spScriptPort, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spTMSCommunity=spTMSCommunity, peakflowSPMIB=peakflowSPMIB, bgpInstability=bgpInstability, spFingerprintName=spFingerprintName, spInterfaceSpeed=spInterfaceSpeed, spReportID=spReportID, spLicenseErrType=spLicenseErrType, collectorDown=collectorDown, trafficAutoMitigation=trafficAutoMitigation, fingerprintUsageDone=fingerprintUsageDone, spTMSMultiPrefix=spTMSMultiPrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, spReportName=spReportName, managedObjectUsageDone=managedObjectUsageDone, snmpDown=snmpDown, spBGPInstability=spBGPInstability, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, hardwareFailureDone=hardwareFailureDone, deviceTotalFlows=deviceTotalFlows, alertScript=alertScript, spBGPEvent=spBGPEvent, spCommFailureDescription=spCommFailureDescription, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spServiceName=spServiceName, mitigationThirdPartyStart=mitigationThirdPartyStart, spFlowspecTimeout=spFlowspecTimeout, spBlackholeNexthop=spBlackholeNexthop, spDetectedCountries=spDetectedCountries, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceSpeedHC=spInterfaceSpeedHC, interfaceUsage=interfaceUsage, cloudSignalingFault=cloudSignalingFault, managedObjectUsage=managedObjectUsage, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spGreTunnelDestination=spGreTunnelDestination, spFingerprintMessage=spFingerprintMessage, spDNSObserved=spDNSObserved, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterfaceUsageHC=spInterfaceUsageHC, spManagedObject=spManagedObject, spBGPTrapName=spBGPTrapName, spVersion=spVersion, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSTimeout=spTMSTimeout, spThirdPartyAddr=spThirdPartyAddr, bgpInstabilityDone=bgpInstabilityDone, spThirdPartyZone=spThirdPartyZone, deviceHealth=deviceHealth, greDownDone=greDownDone, bgpTrap=bgpTrap, flowDown=flowDown, spApplicationName=spApplicationName, deviceSystemErrorDone=deviceSystemErrorDone, spHijackAttr=spHijackAttr, spMitigationStart=spMitigationStart, bgpHijack=bgpHijack, mitigationTMSStartV2=mitigationTMSStartV2, spHardwareFailureDescription=spHardwareFailureDescription, spSystemErrorDescription=spSystemErrorDescription, spBGPTrapPrefix=spBGPTrapPrefix, spGreTunnelName=spGreTunnelName, spImpactPps=spImpactPps, hardwareFailure=hardwareFailure, spDNSName=spDNSName, autoclassifyStart=autoclassifyStart, peakflowSPCMI=peakflowSPCMI, interfaceUsageDone=interfaceUsageDone, spInetAddress=spInetAddress, devicePhysicalMemory=devicePhysicalMemory, spLicenseErrCount=spLicenseErrCount, fingerprintFeedback=fingerprintFeedback, routingFailover=routingFailover, spFingerprintSender=spFingerprintSender, spImpactBps=spImpactBps, mitigationFlowspecStart=mitigationFlowspecStart, spFlowspecCommunity=spFlowspecCommunity, deviceTotalFlowsHC=deviceTotalFlowsHC, spThreshold=spThreshold, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spcommFailureDone=spcommFailureDone)
