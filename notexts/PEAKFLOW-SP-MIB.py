...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:00:20 2024
...
Counter32, ObjectIdentity, Bits, Counter64, NotificationType, IpAddress, TimeTicks, ModuleIdentity, iso, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "IpAddress", "TimeTicks", "ModuleIdentity", "iso", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spBGPInstability=spBGPInstability, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMean=spDNSObservedMean, deviceSwapSpace=deviceSwapSpace, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spScriptHost=spScriptHost, spThirdPartyZone=spThirdPartyZone, spServiceElement=spServiceElement, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrType=spLicenseErrType, spThirdPartyAddr=spThirdPartyAddr, spRouter=spRouter, deviceTotalFlows=deviceTotalFlows, deviceSystemError=deviceSystemError, spFingerprintSender=spFingerprintSender, collectorStart=collectorStart, spUnit=spUnit, spGreTunnelDestination=spGreTunnelDestination, bgpInstability=bgpInstability, spInterfaceUsage=spInterfaceUsage, spBlackholeNexthop=spBlackholeNexthop, spBlackholePrefix=spBlackholePrefix, interfaceUsageDone=interfaceUsageDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, peakflowSPCMI=peakflowSPCMI, spInetAddressType=spInetAddressType, spSystemErrorType=spSystemErrorType, spDuration=spDuration, spMitigationStart=spMitigationStart, dnsBaseline=dnsBaseline, spDNSExpected=spDNSExpected, serviceUsageDone=serviceUsageDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spInterfaceIndex=spInterfaceIndex, managedObjectUsageDone=managedObjectUsageDone, spCommFailureDestination=spCommFailureDestination, fingerprintFeedback=fingerprintFeedback, configChange=configChange, spDNSObservedMax=spDNSObservedMax, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsername=spUsername, reportDone=reportDone, alertScript=alertScript, spDetector=spDetector, spBGPEvent=spBGPEvent, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFlowspecCommunity=spFlowspecCommunity, spDNSName=spDNSName, spManagedObject=spManagedObject, collectorDown=collectorDown, spBGPTrapPrefix=spBGPTrapPrefix, mitigationBlackholeStart=mitigationBlackholeStart, spInterface=spInterface, flowDown=flowDown, spcommFailure=spcommFailure, bgpUp=bgpUp, mitigationTMSStartV2=mitigationTMSStartV2, spTMSCommunity=spTMSCommunity, fingerprintUsageDone=fingerprintUsageDone, spBlackholeTimeout=spBlackholeTimeout, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, autoclassifyStart=autoclassifyStart, spThreshold=spThreshold, spLicenseErrCount=spLicenseErrCount, cloudSignalingFault=cloudSignalingFault, peakflowSPMgr=peakflowSPMgr, spMitigationID=spMitigationID, spInterfaceSpeed=spInterfaceSpeed, spcommFailureDone=spcommFailureDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spScriptCommand=spScriptCommand, spCollector=spCollector, spHijackRoute=spHijackRoute, spReportName=spReportName, spSystemErrorDescription=spSystemErrorDescription, licenseErrorDone=licenseErrorDone, spTMSMultiPrefix=spTMSMultiPrefix, spCloudSignalFaultDescription=spCloudSignalFaultDescription, notificationLimit=notificationLimit, peakflowSPMIB=peakflowSPMIB, spFingerprintName=spFingerprintName, spFingerprintFeedback=spFingerprintFeedback, deviceDiskUsage=deviceDiskUsage, bgpDown=bgpDown, mitigationFlowspecStart=mitigationFlowspecStart, bgpHijack=bgpHijack, hardwareFailureDone=hardwareFailureDone, dnsBaselineDone=dnsBaselineDone, spHardwareFailureDescription=spHardwareFailureDescription, licenseError=licenseError, spServiceName=spServiceName, cloudSignalingFaultDone=cloudSignalingFaultDone, spPravail=spPravail, spGreTunnelName=spGreTunnelName, spScriptPort=spScriptPort, deviceHealth=deviceHealth, collectorUp=collectorUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spScriptStart=spScriptStart, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spUsage=spUsage, spDetectedCountries=spDetectedCountries, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceTotalFlowsHC=deviceTotalFlowsHC, spTMSPrefix=spTMSPrefix, fingerprintReceive=fingerprintReceive, devicePhysicalMemory=devicePhysicalMemory, fingerprintUsage=fingerprintUsage, spAlertID=spAlertID, spReportURL=spReportURL, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjects=spManagedObjects, spImpactPps=spImpactPps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapName=spBGPTrapName, spLicenseErrLimit=spLicenseErrLimit, managedObjectUsage=managedObjectUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spHijackLocal=spHijackLocal, snmpDown=snmpDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spVersion=spVersion, spMitigationName=spMitigationName, spBlackholeCommunity=spBlackholeCommunity, spFlowspecTimeout=spFlowspecTimeout, snmpUp=snmpUp, serviceUsage=serviceUsage, spFingerprintMessage=spFingerprintMessage, routingFailover=routingFailover, greDown=greDown, trafficAutoMitigation=trafficAutoMitigation, spInetAddress=spInetAddress, spHijackAttr=spHijackAttr, mitigationThirdPartyStart=mitigationThirdPartyStart, spCommFailureDescription=spCommFailureDescription, mitigationTMSStart=mitigationTMSStart, peakflowSPTraps=peakflowSPTraps, spDNSObserved=spDNSObserved, bgpTrap=bgpTrap, spApplicationName=spApplicationName, deviceSystemErrorDone=deviceSystemErrorDone, deviceSwapSpaceUsage=deviceSwapSpaceUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, interfaceUsage=interfaceUsage, flowUp=flowUp, spInterfaceUsageHC=spInterfaceUsageHC, bgpInstabilityDone=bgpInstabilityDone, greDownDone=greDownDone, spTMSTimeout=spTMSTimeout, PYSNMP_MODULE_ID=peakflowSPMIB, spManagedObjectFamily=spManagedObjectFamily, spLicenseErrDescription=spLicenseErrDescription, hardwareFailure=hardwareFailure, spImpactBps=spImpactBps, spUsageType=spUsageType, mitigationDone=mitigationDone, spReportID=spReportID)
