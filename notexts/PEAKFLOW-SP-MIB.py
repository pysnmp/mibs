...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:08:14 2022
...
ObjectIdentity, MibIdentifier, Bits, IpAddress, Counter32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Unsigned32, ModuleIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Bits", "IpAddress", "Counter32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Unsigned32", "ModuleIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", managedObjectUsageDone=managedObjectUsageDone, spCollector=spCollector, deviceTotalFlowsHC=deviceTotalFlowsHC, interfaceUsageDone=interfaceUsageDone, bgpInstabilityDone=bgpInstabilityDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spCommFailureDestination=spCommFailureDestination, spInterfaceUsageHC=spInterfaceUsageHC, spFlowspecCommunity=spFlowspecCommunity, peakflowSPMIB=peakflowSPMIB, spDetector=spDetector, spTMSPrefix=spTMSPrefix, serviceUsage=serviceUsage, spBGPInstability=spBGPInstability, spReportID=spReportID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spHijackAttr=spHijackAttr, peakflowSPTraps=peakflowSPTraps, cloudSignalingFaultDone=cloudSignalingFaultDone, spServiceName=spServiceName, spLicenseErrType=spLicenseErrType, routingFailover=routingFailover, spcommFailureDone=spcommFailureDone, serviceUsageDone=serviceUsageDone, spGreTunnelDestination=spGreTunnelDestination, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpace=deviceSwapSpace, spMitigationName=spMitigationName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpTrap=bgpTrap, collectorUp=collectorUp, devicePhysicalMemory=devicePhysicalMemory, spInterfaceSpeedHC=spInterfaceSpeedHC, spFlowspecTimeout=spFlowspecTimeout, spInetAddressType=spInetAddressType, deviceSwapSpaceInUse=deviceSwapSpaceInUse, configChange=configChange, licenseErrorDone=licenseErrorDone, spServiceElement=spServiceElement, peakflowSPCMI=peakflowSPCMI, flowUp=flowUp, spLicenseErrCount=spLicenseErrCount, spFingerprintSender=spFingerprintSender, spBlackholeCommunity=spBlackholeCommunity, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spReportName=spReportName, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptHost=spScriptHost, spDNSExpected=spDNSExpected, spThirdPartyZone=spThirdPartyZone, fingerprintFeedback=fingerprintFeedback, fingerprintReceive=fingerprintReceive, dnsBaselineDone=dnsBaselineDone, spDetectedCountries=spDetectedCountries, spReportURL=spReportURL, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spUsage=spUsage, deviceSystemError=deviceSystemError, spMitigationID=spMitigationID, peakflowSPMgr=peakflowSPMgr, mitigationBlackholeStart=mitigationBlackholeStart, spManagedObjects=spManagedObjects, cloudSignalingFault=cloudSignalingFault, spScriptCommand=spScriptCommand, spBlackholeNexthop=spBlackholeNexthop, spInterfaceSpeed=spInterfaceSpeed, spTMSCommunity=spTMSCommunity, spFingerprintFeedback=spFingerprintFeedback, spAlertID=spAlertID, spThirdPartyAddr=spThirdPartyAddr, spApplicationName=spApplicationName, spUsername=spUsername, dosHostDetectionAlert=dosHostDetectionAlert, spManagedObject=spManagedObject, spDNSName=spDNSName, flowDown=flowDown, bgpInstability=bgpInstability, spUsageType=spUsageType, spHijackLocal=spHijackLocal, deviceHealth=deviceHealth, spBGPTrapName=spBGPTrapName, bgpDown=bgpDown, spDNSObservedMax=spDNSObservedMax, reportDone=reportDone, spImpactPps=spImpactPps, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spPravail=spPravail, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterface=spInterface, spFingerprintName=spFingerprintName, spMitigationStart=spMitigationStart, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spInterfaceUsage=spInterfaceUsage, greDownDone=greDownDone, autoclassifyStart=autoclassifyStart, spVersion=spVersion, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationTMSStart=mitigationTMSStart, deviceDiskUsage=deviceDiskUsage, licenseError=licenseError, spDuration=spDuration, alertScript=alertScript, mitigationDone=mitigationDone, spHijackRoute=spHijackRoute, spCommFailureDescription=spCommFailureDescription, spDNSObservedMean=spDNSObservedMean, spFingerprintMessage=spFingerprintMessage, greDown=greDown, spScriptStart=spScriptStart, fingerprintUsage=fingerprintUsage, spManagedObjectFamily=spManagedObjectFamily, spSystemErrorDescription=spSystemErrorDescription, deviceTotalFlows=deviceTotalFlows, snmpUp=snmpUp, spInterfaceIndex=spInterfaceIndex, notificationLimit=notificationLimit, spLicenseErrDescription=spLicenseErrDescription, spDNSObserved=spDNSObserved, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, collectorStart=collectorStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, snmpDown=snmpDown, spGreTunnelName=spGreTunnelName, trafficAutoMitigation=trafficAutoMitigation, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, fingerprintUsageDone=fingerprintUsageDone, dnsBaseline=dnsBaseline, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spSystemErrorType=spSystemErrorType, spBGPTrapNewAttributes=spBGPTrapNewAttributes, hardwareFailureDone=hardwareFailureDone, bgpHijack=bgpHijack, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpUp=bgpUp, dosNetworkProfiledAlert=dosNetworkProfiledAlert, interfaceUsage=interfaceUsage, managedObjectUsage=managedObjectUsage, spUnit=spUnit, spTMSTimeout=spTMSTimeout, spScriptPort=spScriptPort, spLicenseErrLimit=spLicenseErrLimit, spRouter=spRouter, deviceSystemErrorDone=deviceSystemErrorDone, spBlackholePrefix=spBlackholePrefix, collectorDown=collectorDown, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapPrefix=spBGPTrapPrefix, mitigationFlowspecStart=mitigationFlowspecStart, spcommFailure=spcommFailure, spThreshold=spThreshold, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPEvent=spBGPEvent, spInetAddress=spInetAddress, spTMSMultiPrefix=spTMSMultiPrefix, spBGPTrapEvent=spBGPTrapEvent, hardwareFailure=hardwareFailure, mitigationThirdPartyStart=mitigationThirdPartyStart, spImpactBps=spImpactBps)
