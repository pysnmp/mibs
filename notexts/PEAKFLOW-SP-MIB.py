...
# Produced by pysmi-1.1.12 at Tue Jun  4 02:36:54 2024
...
MibIdentifier, ObjectIdentity, Counter64, IpAddress, Integer32, iso, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "Counter64", "IpAddress", "Integer32", "iso", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType", "Counter32", "Bits")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spMitigationID=spMitigationID, spDetector=spDetector, spCommFailureDestination=spCommFailureDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, serviceUsageDone=serviceUsageDone, bgpUp=bgpUp, spReportURL=spReportURL, spGreTunnelName=spGreTunnelName, managedObjectUsageDone=managedObjectUsageDone, bgpInstabilityDone=bgpInstabilityDone, cloudSignalingFault=cloudSignalingFault, spManagedObjectFamily=spManagedObjectFamily, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrCount=spLicenseErrCount, mitigationTMSStart=mitigationTMSStart, spAlertID=spAlertID, spScriptStart=spScriptStart, interfaceUsage=interfaceUsage, spAlertDetectionSignatures=spAlertDetectionSignatures, spDetectedCountries=spDetectedCountries, spBGPTrapPrefix=spBGPTrapPrefix, spLicenseErrLimit=spLicenseErrLimit, spSystemErrorType=spSystemErrorType, collectorStart=collectorStart, spCommFailureDescription=spCommFailureDescription, deviceDiskUsage=deviceDiskUsage, peakflowSPTraps=peakflowSPTraps, spInetAddressType=spInetAddressType, peakflowSPCMI=peakflowSPCMI, configChange=configChange, mitigationBlackholeStart=mitigationBlackholeStart, flowDown=flowDown, deviceSystemErrorDone=deviceSystemErrorDone, greDown=greDown, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHardwareFailureDescription=spHardwareFailureDescription, cloudSignalingFaultDone=cloudSignalingFaultDone, spLicenseErrDescription=spLicenseErrDescription, spBlackholeCommunity=spBlackholeCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, interfaceUsageDone=interfaceUsageDone, notificationLimit=notificationLimit, dnsBaselineDone=dnsBaselineDone, spMitigationName=spMitigationName, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlows=deviceTotalFlows, spUsageType=spUsageType, greDownDone=greDownDone, spScriptHost=spScriptHost, spFingerprintFeedback=spFingerprintFeedback, spDNSObservedMean=spDNSObservedMean, peakflowSPMIB=peakflowSPMIB, spVersion=spVersion, spCollector=spCollector, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSExpected=spDNSExpected, fingerprintFeedback=fingerprintFeedback, spServiceElement=spServiceElement, spDNSName=spDNSName, devicePhysicalMemory=devicePhysicalMemory, mitigationDone=mitigationDone, trafficAutoMitigation=trafficAutoMitigation, flowUp=flowUp, spTMSMultiPrefix=spTMSMultiPrefix, spDuration=spDuration, spServiceName=spServiceName, deviceSystemError=deviceSystemError, spBGPInstability=spBGPInstability, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObjects=spManagedObjects, spDNSObservedMax=spDNSObservedMax, spThreshold=spThreshold, dnsBaseline=dnsBaseline, spBGPTrapEvent=spBGPTrapEvent, snmpDown=snmpDown, fingerprintUsageDone=fingerprintUsageDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spScriptPort=spScriptPort, spUsage=spUsage, spSystemErrorDescription=spSystemErrorDescription, licenseError=licenseError, spcommFailure=spcommFailure, bgpTrap=bgpTrap, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, hardwareFailure=hardwareFailure, spManagedObject=spManagedObject, bgpDown=bgpDown, spInterface=spInterface, bgpHijack=bgpHijack, fingerprintUsage=fingerprintUsage, deviceHealth=deviceHealth, deviceSwapSpace=deviceSwapSpace, managedObjectUsage=managedObjectUsage, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, hardwareFailureDone=hardwareFailureDone, mitigationTMSStartV2=mitigationTMSStartV2, spPravail=spPravail, spBlackholePrefix=spBlackholePrefix, spFingerprintSender=spFingerprintSender, spHijackRoute=spHijackRoute, bgpInstability=bgpInstability, alertScript=alertScript, reportDone=reportDone, spReportID=spReportID, spInetAddress=spInetAddress, spHijackAttr=spHijackAttr, spTMSTimeout=spTMSTimeout, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, serviceUsage=serviceUsage, routingFailover=routingFailover, spThirdPartyZone=spThirdPartyZone, spTMSPrefix=spTMSPrefix, spLicenseErrType=spLicenseErrType, spRouter=spRouter, spImpactBps=spImpactBps, licenseErrorDone=licenseErrorDone, snmpUp=snmpUp, collectorUp=collectorUp, spInterfaceUsage=spInterfaceUsage, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapNewAttributes=spBGPTrapNewAttributes, peakflowSPMgr=peakflowSPMgr, spBlackholeTimeout=spBlackholeTimeout, spInterfaceIndex=spInterfaceIndex, deviceTotalFlowsHC=deviceTotalFlowsHC, spUnit=spUnit, spMitigationStart=spMitigationStart, spInterfaceSpeed=spInterfaceSpeed, spBGPTrapName=spBGPTrapName, spScriptCommand=spScriptCommand, spBGPEvent=spBGPEvent, PYSNMP_MODULE_ID=peakflowSPMIB, collectorDown=collectorDown, autoclassifyStart=autoclassifyStart, mitigationThirdPartyStart=mitigationThirdPartyStart, fingerprintReceive=fingerprintReceive, spUsername=spUsername, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spImpactPps=spImpactPps, dosHostDetectionAlert=dosHostDetectionAlert, spcommFailureDone=spcommFailureDone, spDNSObserved=spDNSObserved, spHijackLocal=spHijackLocal, mitigationFlowspecStart=mitigationFlowspecStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintName=spFingerprintName, spApplicationName=spApplicationName, spFlowspecTimeout=spFlowspecTimeout, spFingerprintMessage=spFingerprintMessage, spTMSCommunity=spTMSCommunity, spFlowspecCommunity=spFlowspecCommunity, spReportName=spReportName, spThirdPartyAddr=spThirdPartyAddr, spBlackholeNexthop=spBlackholeNexthop, spInterfaceUsageHC=spInterfaceUsageHC)
