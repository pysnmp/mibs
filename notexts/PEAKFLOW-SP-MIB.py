...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:50:43 2021
...
MibIdentifier, iso, ModuleIdentity, Counter32, ObjectIdentity, IpAddress, TimeTicks, NotificationType, Counter64, Bits, Gauge32, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "IpAddress", "TimeTicks", "NotificationType", "Counter64", "Bits", "Gauge32", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDetector=spDetector, spTMSPrefix=spTMSPrefix, spFingerprintFeedback=spFingerprintFeedback, mitigationTMSStart=mitigationTMSStart, deviceDiskUsage=deviceDiskUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, autoclassifyStart=autoclassifyStart, collectorUp=collectorUp, spFlowspecCommunity=spFlowspecCommunity, spGreTunnelDestination=spGreTunnelDestination, serviceUsage=serviceUsage, bgpInstabilityDone=bgpInstabilityDone, deviceTotalFlows=deviceTotalFlows, spManagedObject=spManagedObject, hardwareFailure=hardwareFailure, spInterfaceSpeed=spInterfaceSpeed, spPravail=spPravail, spThirdPartyZone=spThirdPartyZone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, peakflowSPTraps=peakflowSPTraps, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPTrapEvent=spBGPTrapEvent, spInterfaceUsage=spInterfaceUsage, spReportID=spReportID, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationDone=mitigationDone, fingerprintUsage=fingerprintUsage, spDNSName=spDNSName, deviceTotalFlowsHC=deviceTotalFlowsHC, devicePhysicalMemory=devicePhysicalMemory, spDNSObservedMax=spDNSObservedMax, spLicenseErrCount=spLicenseErrCount, peakflowSPCMI=peakflowSPCMI, spRouter=spRouter, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptStart=spScriptStart, deviceSwapSpace=deviceSwapSpace, spLicenseErrLimit=spLicenseErrLimit, spBGPEvent=spBGPEvent, spThirdPartyAddr=spThirdPartyAddr, spBGPInstability=spBGPInstability, spBGPTrapPrefix=spBGPTrapPrefix, greDown=greDown, spApplicationName=spApplicationName, peakflowSPMgr=peakflowSPMgr, notificationLimit=notificationLimit, spScriptHost=spScriptHost, spDuration=spDuration, spFingerprintSender=spFingerprintSender, spServiceName=spServiceName, collectorDown=collectorDown, greDownDone=greDownDone, spUsageType=spUsageType, collectorStart=collectorStart, managedObjectUsage=managedObjectUsage, mitigationFlowspecStart=mitigationFlowspecStart, spBlackholePrefix=spBlackholePrefix, spMitigationStart=spMitigationStart, deviceSystemError=deviceSystemError, dosNetworkProfiledAlert=dosNetworkProfiledAlert, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spScriptCommand=spScriptCommand, spDNSObserved=spDNSObserved, interfaceUsageDone=interfaceUsageDone, spMitigationID=spMitigationID, spInetAddress=spInetAddress, fingerprintReceive=fingerprintReceive, spReportName=spReportName, spHijackRoute=spHijackRoute, deviceHealth=deviceHealth, peakflowSPMIB=peakflowSPMIB, spHijackLocal=spHijackLocal, spLicenseErrType=spLicenseErrType, spCommFailureDestination=spCommFailureDestination, spImpactPps=spImpactPps, routingFailover=routingFailover, spBlackholeNexthop=spBlackholeNexthop, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dnsBaseline=dnsBaseline, spDetectedCountries=spDetectedCountries, trafficAutoMitigation=trafficAutoMitigation, spManagedObjects=spManagedObjects, hardwareFailureDone=hardwareFailureDone, PYSNMP_MODULE_ID=peakflowSPMIB, spHardwareFailureDescription=spHardwareFailureDescription, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, fingerprintUsageDone=fingerprintUsageDone, spVersion=spVersion, spImpactBps=spImpactBps, flowUp=flowUp, bgpUp=bgpUp, spMitigationName=spMitigationName, spInterfaceUsageHC=spInterfaceUsageHC, bgpTrap=bgpTrap, bgpHijack=bgpHijack, spUnit=spUnit, dosHostDetectionAlert=dosHostDetectionAlert, spBlackholeCommunity=spBlackholeCommunity, cloudSignalingFaultDone=cloudSignalingFaultDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapName=spBGPTrapName, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spUsage=spUsage, spInetAddressType=spInetAddressType, fingerprintFeedback=fingerprintFeedback, spcommFailureDone=spcommFailureDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSMultiPrefix=spTMSMultiPrefix, managedObjectUsageDone=managedObjectUsageDone, spScriptPort=spScriptPort, snmpDown=snmpDown, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFlowspecTimeout=spFlowspecTimeout, spSystemErrorDescription=spSystemErrorDescription, spFingerprintName=spFingerprintName, spUsername=spUsername, mitigationThirdPartyStart=mitigationThirdPartyStart, spThreshold=spThreshold, spHijackAttr=spHijackAttr, cloudSignalingFault=cloudSignalingFault, licenseErrorDone=licenseErrorDone, snmpUp=snmpUp, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spInterfaceIndex=spInterfaceIndex, spAlertDetectionSignatures=spAlertDetectionSignatures, spInterfaceSpeedHC=spInterfaceSpeedHC, spServiceElement=spServiceElement, spCommFailureDescription=spCommFailureDescription, bgpDown=bgpDown, interfaceUsage=interfaceUsage, flowDown=flowDown, spDNSExpected=spDNSExpected, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, configChange=configChange, dnsBaselineDone=dnsBaselineDone, spDNSObservedMean=spDNSObservedMean, mitigationBlackholeStart=mitigationBlackholeStart, spSystemErrorType=spSystemErrorType, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, reportDone=reportDone, spManagedObjectFamily=spManagedObjectFamily, dosHostDetectionAlertDone=dosHostDetectionAlertDone, bgpInstability=bgpInstability, spReportURL=spReportURL, spGreTunnelName=spGreTunnelName, serviceUsageDone=serviceUsageDone, spCollector=spCollector, spAlertID=spAlertID, spTMSTimeout=spTMSTimeout, spTMSCommunity=spTMSCommunity, spInterface=spInterface, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, mitigationTMSStartV2=mitigationTMSStartV2, deviceSystemErrorDone=deviceSystemErrorDone, alertScript=alertScript, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spLicenseErrDescription=spLicenseErrDescription, spFingerprintMessage=spFingerprintMessage, licenseError=licenseError, spcommFailure=spcommFailure)
