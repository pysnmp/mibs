...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:51:31 2022
...
TimeTicks, IpAddress, NotificationType, Counter32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, Integer32, Counter64, iso, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "NotificationType", "Counter32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "Integer32", "Counter64", "iso", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpDown=bgpDown, snmpDown=snmpDown, bgpHijack=bgpHijack, cloudSignalingFaultDone=cloudSignalingFaultDone, flowDown=flowDown, peakflowSPCMI=peakflowSPCMI, dnsBaselineDone=dnsBaselineDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCommFailureDescription=spCommFailureDescription, spBGPTrapName=spBGPTrapName, deviceSwapSpaceUsage=deviceSwapSpaceUsage, deviceSystemErrorDone=deviceSystemErrorDone, collectorDown=collectorDown, dnsBaseline=dnsBaseline, spDNSName=spDNSName, spFingerprintFeedback=spFingerprintFeedback, spBlackholePrefix=spBlackholePrefix, spDuration=spDuration, mitigationTMSStart=mitigationTMSStart, greDownDone=greDownDone, spThirdPartyAddr=spThirdPartyAddr, licenseErrorDone=licenseErrorDone, spSystemErrorDescription=spSystemErrorDescription, spDNSObservedMean=spDNSObservedMean, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spCommFailureDestination=spCommFailureDestination, spcommFailure=spcommFailure, spInetAddress=spInetAddress, spInterface=spInterface, spBlackholeTimeout=spBlackholeTimeout, spFlowspecTimeout=spFlowspecTimeout, devicePhysicalMemory=devicePhysicalMemory, spLicenseErrDescription=spLicenseErrDescription, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spGreTunnelDestination=spGreTunnelDestination, bgpTrap=bgpTrap, deviceTotalFlowsHC=deviceTotalFlowsHC, autoclassifyStart=autoclassifyStart, mitigationTMSStartV2=mitigationTMSStartV2, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spLicenseErrCount=spLicenseErrCount, spDNSExpected=spDNSExpected, deviceSystemError=deviceSystemError, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spSystemErrorType=spSystemErrorType, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceUsage=spInterfaceUsage, bgpUp=bgpUp, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spImpactBps=spImpactBps, interfaceUsageDone=interfaceUsageDone, greDown=greDown, spScriptPort=spScriptPort, deviceTotalFlows=deviceTotalFlows, bgpInstabilityDone=bgpInstabilityDone, flowUp=flowUp, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spAlertDetectionSignatures=spAlertDetectionSignatures, spFingerprintSender=spFingerprintSender, spInetAddressType=spInetAddressType, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholeNexthop=spBlackholeNexthop, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spApplicationName=spApplicationName, fingerprintUsageDone=fingerprintUsageDone, spDNSObserved=spDNSObserved, spScriptStart=spScriptStart, spBGPInstability=spBGPInstability, fingerprintUsage=fingerprintUsage, spServiceElement=spServiceElement, spManagedObject=spManagedObject, spManagedObjects=spManagedObjects, spInterfaceIndex=spInterfaceIndex, serviceUsage=serviceUsage, managedObjectUsageDone=managedObjectUsageDone, peakflowSPMgr=peakflowSPMgr, snmpUp=snmpUp, spServiceName=spServiceName, spBGPTrapEvent=spBGPTrapEvent, spTMSCommunity=spTMSCommunity, spReportID=spReportID, spMitigationID=spMitigationID, spBGPEvent=spBGPEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCloudSignalFaultDescription=spCloudSignalFaultDescription, PYSNMP_MODULE_ID=peakflowSPMIB, spUnit=spUnit, spScriptCommand=spScriptCommand, spMitigationName=spMitigationName, cloudSignalingFault=cloudSignalingFault, spCollector=spCollector, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceHealth=deviceHealth, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, collectorStart=collectorStart, spReportName=spReportName, deviceDiskUsage=deviceDiskUsage, spLicenseErrType=spLicenseErrType, collectorUp=collectorUp, spTMSTimeout=spTMSTimeout, mitigationDone=mitigationDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, interfaceUsage=interfaceUsage, bgpInstability=bgpInstability, mitigationFlowspecStart=mitigationFlowspecStart, spHijackAttr=spHijackAttr, spInterfaceSpeed=spInterfaceSpeed, licenseError=licenseError, peakflowSPTraps=peakflowSPTraps, spDetectedCountries=spDetectedCountries, notificationLimit=notificationLimit, reportDone=reportDone, configChange=configChange, peakflowSPMIB=peakflowSPMIB, spUsageType=spUsageType, fingerprintReceive=fingerprintReceive, spThirdPartyZone=spThirdPartyZone, mitigationThirdPartyStart=mitigationThirdPartyStart, spFingerprintMessage=spFingerprintMessage, spGreTunnelName=spGreTunnelName, spFlowspecCommunity=spFlowspecCommunity, spRouter=spRouter, spImpactPps=spImpactPps, spBlackholeCommunity=spBlackholeCommunity, routingFailover=routingFailover, spHijackRoute=spHijackRoute, spDetector=spDetector, spUsername=spUsername, spUsage=spUsage, spMitigationStart=spMitigationStart, spThreshold=spThreshold, fingerprintFeedback=fingerprintFeedback, mitigationBlackholeStart=mitigationBlackholeStart, spHijackLocal=spHijackLocal, spVersion=spVersion, spScriptHost=spScriptHost, spManagedObjectFamily=spManagedObjectFamily, spPravail=spPravail, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, hardwareFailureDone=hardwareFailureDone, serviceUsageDone=serviceUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spTMSMultiPrefix=spTMSMultiPrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, hardwareFailure=hardwareFailure, alertScript=alertScript, managedObjectUsage=managedObjectUsage, deviceSwapSpace=deviceSwapSpace, spInterfaceUsageHC=spInterfaceUsageHC, spcommFailureDone=spcommFailureDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObservedMax=spDNSObservedMax, spReportURL=spReportURL, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spFingerprintName=spFingerprintName, spAlertID=spAlertID, trafficAutoMitigation=trafficAutoMitigation, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spLicenseErrLimit=spLicenseErrLimit, spTMSPrefix=spTMSPrefix)
