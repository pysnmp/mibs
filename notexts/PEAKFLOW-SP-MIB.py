...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Bits, ObjectIdentity, iso, IpAddress, NotificationType, TimeTicks, ModuleIdentity, MibIdentifier, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Bits", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", fingerprintUsageDone=fingerprintUsageDone, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spFingerprintSender=spFingerprintSender, spAlertDetectionSignatures=spAlertDetectionSignatures, spManagedObject=spManagedObject, spLicenseErrDescription=spLicenseErrDescription, trafficAutoMitigation=trafficAutoMitigation, spThreshold=spThreshold, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, notificationLimit=notificationLimit, spDetector=spDetector, spFingerprintName=spFingerprintName, interfaceUsage=interfaceUsage, peakflowSPMIB=peakflowSPMIB, spServiceName=spServiceName, spCollector=spCollector, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spScriptCommand=spScriptCommand, cloudSignalingFault=cloudSignalingFault, flowUp=flowUp, spAlertID=spAlertID, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBlackholeNexthop=spBlackholeNexthop, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spFlowspecCommunity=spFlowspecCommunity, deviceHealth=deviceHealth, hardwareFailure=hardwareFailure, deviceDiskUsage=deviceDiskUsage, serviceUsageDone=serviceUsageDone, spDNSObservedMean=spDNSObservedMean, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spMitigationStart=spMitigationStart, spImpactPps=spImpactPps, spBlackholeTimeout=spBlackholeTimeout, spFingerprintMessage=spFingerprintMessage, collectorDown=collectorDown, spTMSPrefix=spTMSPrefix, spCommFailureDestination=spCommFailureDestination, spDetectedCountries=spDetectedCountries, cloudSignalingFaultDone=cloudSignalingFaultDone, deviceTotalFlows=deviceTotalFlows, deviceSystemErrorDone=deviceSystemErrorDone, spInterfaceIndex=spInterfaceIndex, spInetAddressType=spInetAddressType, alertScript=alertScript, spFlowspecTimeout=spFlowspecTimeout, spUnit=spUnit, spHijackAttr=spHijackAttr, spThirdPartyAddr=spThirdPartyAddr, deviceSystemError=deviceSystemError, spSystemErrorType=spSystemErrorType, interfaceUsageDone=interfaceUsageDone, spInterfaceUsage=spInterfaceUsage, dnsBaseline=dnsBaseline, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spManagedObjectFamily=spManagedObjectFamily, PYSNMP_MODULE_ID=peakflowSPMIB, spReportURL=spReportURL, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spReportID=spReportID, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spUsageType=spUsageType, spDNSName=spDNSName, spPravail=spPravail, spThirdPartyZone=spThirdPartyZone, spTMSCommunity=spTMSCommunity, spServiceElement=spServiceElement, devicePhysicalMemory=devicePhysicalMemory, spBGPEvent=spBGPEvent, spUsername=spUsername, greDown=greDown, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpUp=snmpUp, bgpDown=bgpDown, mitigationThirdPartyStart=mitigationThirdPartyStart, spReportName=spReportName, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spFingerprintFeedback=spFingerprintFeedback, deviceTotalFlowsHC=deviceTotalFlowsHC, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, hardwareFailureDone=hardwareFailureDone, spBGPTrapPrefix=spBGPTrapPrefix, spScriptStart=spScriptStart, routingFailover=routingFailover, spDNSObservedMax=spDNSObservedMax, peakflowSPMgr=peakflowSPMgr, spInterface=spInterface, spHijackRoute=spHijackRoute, bgpTrap=bgpTrap, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpInstabilityDone=bgpInstabilityDone, spTMSTimeout=spTMSTimeout, licenseErrorDone=licenseErrorDone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, serviceUsage=serviceUsage, spBlackholeCommunity=spBlackholeCommunity, spDNSObserved=spDNSObserved, collectorUp=collectorUp, spInetAddress=spInetAddress, spMitigationID=spMitigationID, managedObjectUsageDone=managedObjectUsageDone, mitigationBlackholeStart=mitigationBlackholeStart, greDownDone=greDownDone, spTMSMultiPrefix=spTMSMultiPrefix, autoclassifyStart=autoclassifyStart, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, licenseError=licenseError, mitigationDone=mitigationDone, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpUp=bgpUp, spManagedObjects=spManagedObjects, spInterfaceUsageHC=spInterfaceUsageHC, managedObjectUsage=managedObjectUsage, spScriptPort=spScriptPort, peakflowSPTraps=peakflowSPTraps, spScriptHost=spScriptHost, spLicenseErrLimit=spLicenseErrLimit, spHardwareFailureDescription=spHardwareFailureDescription, spDuration=spDuration, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spImpactBps=spImpactBps, peakflowSPCMI=peakflowSPCMI, spcommFailure=spcommFailure, spMitigationName=spMitigationName, fingerprintFeedback=fingerprintFeedback, spcommFailureDone=spcommFailureDone, fingerprintReceive=fingerprintReceive, mitigationTMSStartV2=mitigationTMSStartV2, spHijackLocal=spHijackLocal, spApplicationName=spApplicationName, spRouter=spRouter, spUsage=spUsage, collectorStart=collectorStart, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spGreTunnelDestination=spGreTunnelDestination, snmpDown=snmpDown, fingerprintUsage=fingerprintUsage, configChange=configChange, spInterfaceSpeed=spInterfaceSpeed, spDNSExpected=spDNSExpected, spBGPTrapName=spBGPTrapName, flowDown=flowDown, deviceSwapSpace=deviceSwapSpace, spBGPTrapOldAttributes=spBGPTrapOldAttributes, reportDone=reportDone, bgpHijack=bgpHijack, spVersion=spVersion, spBGPTrapEvent=spBGPTrapEvent, spBlackholePrefix=spBlackholePrefix, dnsBaselineDone=dnsBaselineDone, spLicenseErrType=spLicenseErrType, spLicenseErrCount=spLicenseErrCount, spCommFailureDescription=spCommFailureDescription, spGreTunnelName=spGreTunnelName, bgpInstability=bgpInstability, spBGPInstability=spBGPInstability, mitigationFlowspecStart=mitigationFlowspecStart, mitigationTMSStart=mitigationTMSStart, spSystemErrorDescription=spSystemErrorDescription)
