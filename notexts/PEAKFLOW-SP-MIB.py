...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:36:07 2024
...
ObjectIdentity, Bits, IpAddress, Unsigned32, ModuleIdentity, TimeTicks, Integer32, NotificationType, Counter32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "IpAddress", "Unsigned32", "ModuleIdentity", "TimeTicks", "Integer32", "NotificationType", "Counter32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPCMI=peakflowSPCMI, spBGPTrapOldAttributes=spBGPTrapOldAttributes, fingerprintFeedback=fingerprintFeedback, greDownDone=greDownDone, spInterface=spInterface, bgpInstabilityDone=bgpInstabilityDone, deviceSystemError=deviceSystemError, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, deviceSwapSpace=deviceSwapSpace, licenseError=licenseError, spDetectedCountries=spDetectedCountries, spDNSName=spDNSName, spCommFailureDescription=spCommFailureDescription, snmpDown=snmpDown, bgpDown=bgpDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUnit=spUnit, fingerprintUsageDone=fingerprintUsageDone, spTMSMultiPrefix=spTMSMultiPrefix, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPEvent=spBGPEvent, notificationLimit=notificationLimit, interfaceUsageDone=interfaceUsageDone, deviceDiskUsage=deviceDiskUsage, spFingerprintFeedback=spFingerprintFeedback, spRouter=spRouter, spThirdPartyAddr=spThirdPartyAddr, spLicenseErrDescription=spLicenseErrDescription, collectorStart=collectorStart, spUsage=spUsage, spHardwareFailureDescription=spHardwareFailureDescription, spHijackRoute=spHijackRoute, spScriptPort=spScriptPort, dnsBaselineDone=dnsBaselineDone, spBlackholeNexthop=spBlackholeNexthop, spBlackholeTimeout=spBlackholeTimeout, spMitigationID=spMitigationID, dosHostDetectionAlert=dosHostDetectionAlert, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailureDone=spcommFailureDone, spTMSTimeout=spTMSTimeout, spServiceElement=spServiceElement, spDNSObservedMax=spDNSObservedMax, spBGPTrapEvent=spBGPTrapEvent, spBlackholePrefix=spBlackholePrefix, spDNSObservedMean=spDNSObservedMean, fingerprintUsage=fingerprintUsage, spThreshold=spThreshold, reportDone=reportDone, spInetAddressType=spInetAddressType, dnsBaseline=dnsBaseline, routingFailover=routingFailover, spServiceName=spServiceName, mitigationBlackholeStart=mitigationBlackholeStart, spPravail=spPravail, spManagedObjectFamily=spManagedObjectFamily, spInterfaceSpeedHC=spInterfaceSpeedHC, managedObjectUsageDone=managedObjectUsageDone, spHijackLocal=spHijackLocal, spVersion=spVersion, deviceSwapSpaceInUse=deviceSwapSpaceInUse, interfaceUsage=interfaceUsage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, bgpHijack=bgpHijack, spGreTunnelDestination=spGreTunnelDestination, spManagedObject=spManagedObject, alertScript=alertScript, spBGPTrapPrefix=spBGPTrapPrefix, mitigationDone=mitigationDone, mitigationFlowspecStart=mitigationFlowspecStart, spApplicationName=spApplicationName, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, devicePhysicalMemory=devicePhysicalMemory, deviceHealth=deviceHealth, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInterfaceSpeed=spInterfaceSpeed, spHijackAttr=spHijackAttr, spUsername=spUsername, cloudSignalingFaultDone=cloudSignalingFaultDone, PYSNMP_MODULE_ID=peakflowSPMIB, spGreTunnelName=spGreTunnelName, spScriptHost=spScriptHost, flowUp=flowUp, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spThirdPartyZone=spThirdPartyZone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, peakflowSPMgr=peakflowSPMgr, spUsageType=spUsageType, spLicenseErrType=spLicenseErrType, spMitigationName=spMitigationName, spCommFailureDestination=spCommFailureDestination, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFlowspecTimeout=spFlowspecTimeout, fingerprintReceive=fingerprintReceive, spInterfaceUsage=spInterfaceUsage, deviceTotalFlows=deviceTotalFlows, deviceTotalFlowsHC=deviceTotalFlowsHC, spAlertID=spAlertID, spSystemErrorType=spSystemErrorType, spImpactBps=spImpactBps, spCloudSignalFaultDescription=spCloudSignalFaultDescription, configChange=configChange, spCollector=spCollector, peakflowSPMIB=peakflowSPMIB, spDuration=spDuration, spSystemErrorDescription=spSystemErrorDescription, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, peakflowSPTraps=peakflowSPTraps, spLicenseErrCount=spLicenseErrCount, collectorDown=collectorDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, hardwareFailure=hardwareFailure, collectorUp=collectorUp, bgpUp=bgpUp, mitigationThirdPartyStart=mitigationThirdPartyStart, spDetector=spDetector, bgpInstability=bgpInstability, mitigationTMSStartV2=mitigationTMSStartV2, bgpTrap=bgpTrap, spInetAddress=spInetAddress, spFingerprintMessage=spFingerprintMessage, spMitigationStart=spMitigationStart, spBGPInstability=spBGPInstability, spBGPTrapName=spBGPTrapName, autoclassifyStart=autoclassifyStart, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spTMSCommunity=spTMSCommunity, flowDown=flowDown, cloudSignalingFault=cloudSignalingFault, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spDNSObserved=spDNSObserved, licenseErrorDone=licenseErrorDone, spManagedObjects=spManagedObjects, spScriptStart=spScriptStart, spReportURL=spReportURL, spFingerprintSender=spFingerprintSender, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spImpactPps=spImpactPps, spInterfaceIndex=spInterfaceIndex, hardwareFailureDone=hardwareFailureDone, serviceUsageDone=serviceUsageDone, spFingerprintName=spFingerprintName, spcommFailure=spcommFailure, snmpUp=snmpUp, serviceUsage=serviceUsage, spFlowspecCommunity=spFlowspecCommunity, trafficAutoMitigation=trafficAutoMitigation, spBlackholeCommunity=spBlackholeCommunity, spReportID=spReportID, spTMSPrefix=spTMSPrefix, spLicenseErrLimit=spLicenseErrLimit, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationTMSStart=mitigationTMSStart, spScriptCommand=spScriptCommand, managedObjectUsage=managedObjectUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, greDown=greDown, spDNSExpected=spDNSExpected, spReportName=spReportName)
