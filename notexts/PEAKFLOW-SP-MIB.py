...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:35:37 2021
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, MibIdentifier, TimeTicks, NotificationType, Counter64, ObjectIdentity, Counter32, Unsigned32, IpAddress, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "MibIdentifier", "TimeTicks", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "IpAddress", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spAlertID=spAlertID, spCommFailureDescription=spCommFailureDescription, spTMSCommunity=spTMSCommunity, spUnit=spUnit, configChange=configChange, spLicenseErrCount=spLicenseErrCount, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBGPTrapNewAttributes=spBGPTrapNewAttributes, snmpUp=snmpUp, collectorStart=collectorStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spDNSObserved=spDNSObserved, serviceUsageDone=serviceUsageDone, spFingerprintSender=spFingerprintSender, spScriptPort=spScriptPort, deviceTotalFlows=deviceTotalFlows, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSName=spDNSName, spcommFailure=spcommFailure, spBGPInstability=spBGPInstability, flowDown=flowDown, spReportID=spReportID, bgpInstabilityDone=bgpInstabilityDone, spInterfaceUsageHC=spInterfaceUsageHC, spImpactPps=spImpactPps, spBlackholeTimeout=spBlackholeTimeout, spScriptHost=spScriptHost, spServiceName=spServiceName, spDuration=spDuration, serviceUsage=serviceUsage, spFingerprintName=spFingerprintName, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spGreTunnelDestination=spGreTunnelDestination, fingerprintFeedback=fingerprintFeedback, licenseErrorDone=licenseErrorDone, spFingerprintMessage=spFingerprintMessage, devicePhysicalMemory=devicePhysicalMemory, bgpUp=bgpUp, spDetector=spDetector, spBGPTrapName=spBGPTrapName, spBGPTrapEvent=spBGPTrapEvent, reportDone=reportDone, spMitigationName=spMitigationName, cloudSignalingFaultDone=cloudSignalingFaultDone, greDownDone=greDownDone, spScriptStart=spScriptStart, spRouter=spRouter, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeNexthop=spBlackholeNexthop, spHijackRoute=spHijackRoute, spInetAddress=spInetAddress, spHardwareFailureDescription=spHardwareFailureDescription, fingerprintReceive=fingerprintReceive, mitigationTMSStartV2=mitigationTMSStartV2, spManagedObjects=spManagedObjects, spLicenseErrType=spLicenseErrType, managedObjectUsageDone=managedObjectUsageDone, bgpTrap=bgpTrap, spPravail=spPravail, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, snmpDown=snmpDown, PYSNMP_MODULE_ID=peakflowSPMIB, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpInstability=bgpInstability, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, autoclassifyStart=autoclassifyStart, spLicenseErrDescription=spLicenseErrDescription, peakflowSPMIB=peakflowSPMIB, spApplicationName=spApplicationName, deviceSystemError=deviceSystemError, managedObjectUsage=managedObjectUsage, spInterface=spInterface, spSystemErrorType=spSystemErrorType, spInterfaceSpeedHC=spInterfaceSpeedHC, spInetAddressType=spInetAddressType, spUsername=spUsername, dnsBaseline=dnsBaseline, spBlackholeCommunity=spBlackholeCommunity, bgpDown=bgpDown, spUsage=spUsage, licenseError=licenseError, fingerprintUsageDone=fingerprintUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrLimit=spLicenseErrLimit, spReportURL=spReportURL, deviceSystemErrorDone=deviceSystemErrorDone, spMitigationID=spMitigationID, mitigationThirdPartyStart=mitigationThirdPartyStart, interfaceUsageDone=interfaceUsageDone, spcommFailureDone=spcommFailureDone, spInterfaceIndex=spInterfaceIndex, dnsBaselineDone=dnsBaselineDone, spTMSTimeout=spTMSTimeout, spMitigationStart=spMitigationStart, alertScript=alertScript, spThirdPartyAddr=spThirdPartyAddr, spInterfaceUsage=spInterfaceUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, fingerprintUsage=fingerprintUsage, spDNSObservedMax=spDNSObservedMax, spTMSMultiPrefix=spTMSMultiPrefix, trafficAutoMitigation=trafficAutoMitigation, spImpactBps=spImpactBps, spInterfaceSpeed=spInterfaceSpeed, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spCommFailureDestination=spCommFailureDestination, spGreTunnelName=spGreTunnelName, spDNSExpected=spDNSExpected, spCollector=spCollector, flowUp=flowUp, collectorUp=collectorUp, deviceHealth=deviceHealth, spThreshold=spThreshold, spServiceElement=spServiceElement, hardwareFailureDone=hardwareFailureDone, spScriptCommand=spScriptCommand, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPEvent=spBGPEvent, spReportName=spReportName, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, greDown=greDown, cloudSignalingFault=cloudSignalingFault, deviceTotalFlowsHC=deviceTotalFlowsHC, peakflowSPTraps=peakflowSPTraps, spFingerprintFeedback=spFingerprintFeedback, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spSystemErrorDescription=spSystemErrorDescription, spDNSObservedMean=spDNSObservedMean, deviceSwapSpace=deviceSwapSpace, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationFlowspecStart=mitigationFlowspecStart, spThirdPartyZone=spThirdPartyZone, spAlertDetectionSignatures=spAlertDetectionSignatures, spFlowspecCommunity=spFlowspecCommunity, peakflowSPCMI=peakflowSPCMI, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spHijackLocal=spHijackLocal, spManagedObject=spManagedObject, spHijackAttr=spHijackAttr, spManagedObjectFamily=spManagedObjectFamily, spBlackholePrefix=spBlackholePrefix, spDetectedCountries=spDetectedCountries, notificationLimit=notificationLimit, interfaceUsage=interfaceUsage, spVersion=spVersion, collectorDown=collectorDown, mitigationDone=mitigationDone, spUsageType=spUsageType, hardwareFailure=hardwareFailure, deviceDiskUsage=deviceDiskUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, routingFailover=routingFailover, mitigationTMSStart=mitigationTMSStart, spFlowspecTimeout=spFlowspecTimeout, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMgr=peakflowSPMgr, spBGPTrapPrefix=spBGPTrapPrefix, bgpHijack=bgpHijack, spTMSPrefix=spTMSPrefix)
