...
# Produced by pysmi-1.1.8 at Fri Oct 13 13:56:05 2023
...
Counter32, Bits, MibIdentifier, Unsigned32, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, Counter64, ObjectIdentity, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibIdentifier", "Unsigned32", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "Counter64", "ObjectIdentity", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", collectorStart=collectorStart, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spPravail=spPravail, spSystemErrorDescription=spSystemErrorDescription, spcommFailure=spcommFailure, spScriptPort=spScriptPort, dosHostDetectionAlert=dosHostDetectionAlert, spGreTunnelDestination=spGreTunnelDestination, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spAlertID=spAlertID, licenseError=licenseError, spUsername=spUsername, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHijackLocal=spHijackLocal, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spServiceName=spServiceName, spServiceElement=spServiceElement, spDNSName=spDNSName, spSystemErrorType=spSystemErrorType, spInetAddress=spInetAddress, alertScript=alertScript, collectorUp=collectorUp, mitigationTMSStart=mitigationTMSStart, deviceTotalFlowsHC=deviceTotalFlowsHC, spBGPTrapOldAttributes=spBGPTrapOldAttributes, hardwareFailure=hardwareFailure, serviceUsage=serviceUsage, snmpDown=snmpDown, spGreTunnelName=spGreTunnelName, spInterfaceUsage=spInterfaceUsage, spLicenseErrDescription=spLicenseErrDescription, PYSNMP_MODULE_ID=peakflowSPMIB, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, snmpUp=snmpUp, spVersion=spVersion, spBGPEvent=spBGPEvent, spDNSExpected=spDNSExpected, spDNSObservedMean=spDNSObservedMean, fingerprintUsage=fingerprintUsage, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, spHardwareFailureDescription=spHardwareFailureDescription, deviceSwapSpace=deviceSwapSpace, mitigationThirdPartyStart=mitigationThirdPartyStart, spMitigationStart=spMitigationStart, deviceHealth=deviceHealth, hardwareFailureDone=hardwareFailureDone, spHijackAttr=spHijackAttr, serviceUsageDone=serviceUsageDone, peakflowSPTraps=peakflowSPTraps, spReportURL=spReportURL, fingerprintFeedback=fingerprintFeedback, spBGPTrapPrefix=spBGPTrapPrefix, dnsBaselineDone=dnsBaselineDone, peakflowSPCMI=peakflowSPCMI, mitigationFlowspecStart=mitigationFlowspecStart, spFlowspecTimeout=spFlowspecTimeout, spInterface=spInterface, configChange=configChange, spCommFailureDescription=spCommFailureDescription, spFlowspecCommunity=spFlowspecCommunity, spInetAddressType=spInetAddressType, trafficAutoMitigation=trafficAutoMitigation, spScriptHost=spScriptHost, spFingerprintFeedback=spFingerprintFeedback, spThirdPartyZone=spThirdPartyZone, spThirdPartyAddr=spThirdPartyAddr, bgpUp=bgpUp, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstabilityDone=bgpInstabilityDone, spThreshold=spThreshold, spRouter=spRouter, licenseErrorDone=licenseErrorDone, spUsage=spUsage, spBlackholePrefix=spBlackholePrefix, interfaceUsageDone=interfaceUsageDone, mitigationDone=mitigationDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, devicePhysicalMemory=devicePhysicalMemory, spAlertDetectionSignatures=spAlertDetectionSignatures, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, peakflowSPMIB=peakflowSPMIB, spImpactBps=spImpactBps, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSTimeout=spTMSTimeout, cloudSignalingFaultDone=cloudSignalingFaultDone, flowUp=flowUp, spScriptStart=spScriptStart, interfaceUsage=interfaceUsage, spImpactPps=spImpactPps, deviceTotalFlows=deviceTotalFlows, greDown=greDown, fingerprintUsageDone=fingerprintUsageDone, bgpTrap=bgpTrap, deviceSystemErrorDone=deviceSystemErrorDone, spLicenseErrType=spLicenseErrType, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSwapSpaceUsage=deviceSwapSpaceUsage, collectorDown=collectorDown, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSPrefix=spTMSPrefix, routingFailover=routingFailover, spApplicationName=spApplicationName, spBGPTrapEvent=spBGPTrapEvent, spInterfaceSpeed=spInterfaceSpeed, spMitigationName=spMitigationName, spScriptCommand=spScriptCommand, spDetector=spDetector, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceUsageHC=spInterfaceUsageHC, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spBlackholeCommunity=spBlackholeCommunity, spLicenseErrLimit=spLicenseErrLimit, spCommFailureDestination=spCommFailureDestination, spLicenseErrCount=spLicenseErrCount, bgpInstability=bgpInstability, spReportName=spReportName, spFingerprintMessage=spFingerprintMessage, spMitigationID=spMitigationID, spBGPTrapName=spBGPTrapName, spBlackholeTimeout=spBlackholeTimeout, spManagedObject=spManagedObject, spBGPInstability=spBGPInstability, peakflowSPMgr=peakflowSPMgr, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, notificationLimit=notificationLimit, spManagedObjects=spManagedObjects, managedObjectUsage=managedObjectUsage, managedObjectUsageDone=managedObjectUsageDone, spInterfaceIndex=spInterfaceIndex, spDNSObservedMax=spDNSObservedMax, spManagedObjectFamily=spManagedObjectFamily, reportDone=reportDone, spDetectedCountries=spDetectedCountries, spDNSObserved=spDNSObserved, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceSystemError=deviceSystemError, spUnit=spUnit, spTMSCommunity=spTMSCommunity, spBlackholeNexthop=spBlackholeNexthop, greDownDone=greDownDone, spUsageType=spUsageType, dnsBaseline=dnsBaseline, spDuration=spDuration, deviceDiskUsage=deviceDiskUsage, spCollector=spCollector, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintName=spFingerprintName, fingerprintReceive=fingerprintReceive, bgpDown=bgpDown, flowDown=flowDown, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spHijackRoute=spHijackRoute, spFingerprintSender=spFingerprintSender, autoclassifyStart=autoclassifyStart, spcommFailureDone=spcommFailureDone, spReportID=spReportID)
