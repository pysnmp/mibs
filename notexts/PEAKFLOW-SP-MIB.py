...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:03:03 2021
...
ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, Counter32, iso, Bits, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32", "iso", "Bits", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spAlertID=spAlertID, cloudSignalingFault=cloudSignalingFault, snmpDown=snmpDown, licenseErrorDone=licenseErrorDone, interfaceUsageDone=interfaceUsageDone, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPMgr=peakflowSPMgr, spDNSObserved=spDNSObserved, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPMIB=peakflowSPMIB, spTMSPrefix=spTMSPrefix, mitigationTMSStart=mitigationTMSStart, spHijackRoute=spHijackRoute, spUnit=spUnit, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spHijackAttr=spHijackAttr, autoclassifyStart=autoclassifyStart, spLicenseErrCount=spLicenseErrCount, PYSNMP_MODULE_ID=peakflowSPMIB, bgpUp=bgpUp, bgpInstabilityDone=bgpInstabilityDone, spInterface=spInterface, spCommFailureDescription=spCommFailureDescription, spPravail=spPravail, hardwareFailureDone=hardwareFailureDone, fingerprintReceive=fingerprintReceive, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptPort=spScriptPort, flowDown=flowDown, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spcommFailureDone=spcommFailureDone, serviceUsage=serviceUsage, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, snmpUp=snmpUp, spDuration=spDuration, spMitigationStart=spMitigationStart, deviceDiskUsage=deviceDiskUsage, deviceTotalFlows=deviceTotalFlows, fingerprintUsageDone=fingerprintUsageDone, spBGPEvent=spBGPEvent, spInetAddressType=spInetAddressType, flowUp=flowUp, spMitigationName=spMitigationName, notificationLimit=notificationLimit, peakflowSPTraps=peakflowSPTraps, spInterfaceSpeedHC=spInterfaceSpeedHC, spBGPTrapNewAttributes=spBGPTrapNewAttributes, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, configChange=configChange, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, dosHostDetectionAlert=dosHostDetectionAlert, spDNSObservedMax=spDNSObservedMax, spTMSMultiPrefix=spTMSMultiPrefix, spSystemErrorType=spSystemErrorType, deviceSystemError=deviceSystemError, bgpHijack=bgpHijack, hardwareFailure=hardwareFailure, spMitigationID=spMitigationID, spRouter=spRouter, mitigationThirdPartyStart=mitigationThirdPartyStart, managedObjectUsageDone=managedObjectUsageDone, spGreTunnelName=spGreTunnelName, deviceSwapSpace=deviceSwapSpace, spBGPInstability=spBGPInstability, spManagedObjects=spManagedObjects, collectorUp=collectorUp, spCollector=spCollector, spReportName=spReportName, spDNSExpected=spDNSExpected, spTMSTimeout=spTMSTimeout, collectorDown=collectorDown, spInterfaceIndex=spInterfaceIndex, spFingerprintSender=spFingerprintSender, spUsername=spUsername, bgpDown=bgpDown, spServiceName=spServiceName, spInterfaceSpeed=spInterfaceSpeed, spFlowspecCommunity=spFlowspecCommunity, spHardwareFailureDescription=spHardwareFailureDescription, spFingerprintFeedback=spFingerprintFeedback, spApplicationName=spApplicationName, spBGPTrapName=spBGPTrapName, spFingerprintName=spFingerprintName, spTMSCommunity=spTMSCommunity, bgpTrap=bgpTrap, interfaceUsage=interfaceUsage, peakflowSPCMI=peakflowSPCMI, spInetAddress=spInetAddress, bgpInstability=bgpInstability, mitigationTMSStartV2=mitigationTMSStartV2, spInterfaceUsageHC=spInterfaceUsageHC, spFlowspecTimeout=spFlowspecTimeout, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spScriptHost=spScriptHost, spDetector=spDetector, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, collectorStart=collectorStart, routingFailover=routingFailover, spThirdPartyAddr=spThirdPartyAddr, fingerprintUsage=fingerprintUsage, mitigationDone=mitigationDone, spLicenseErrType=spLicenseErrType, spCloudSignalFaultDescription=spCloudSignalFaultDescription, greDown=greDown, spBlackholeTimeout=spBlackholeTimeout, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrLimit=spLicenseErrLimit, mitigationFlowspecStart=mitigationFlowspecStart, spDNSName=spDNSName, greDownDone=greDownDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spCommFailureDestination=spCommFailureDestination, fingerprintFeedback=fingerprintFeedback, spLicenseErrDescription=spLicenseErrDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, spImpactBps=spImpactBps, deviceSwapSpaceInUse=deviceSwapSpaceInUse, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBlackholePrefix=spBlackholePrefix, spSystemErrorDescription=spSystemErrorDescription, dnsBaseline=dnsBaseline, spReportURL=spReportURL, spScriptCommand=spScriptCommand, spVersion=spVersion, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dnsBaselineDone=dnsBaselineDone, spReportID=spReportID, alertScript=alertScript, spHijackLocal=spHijackLocal, spBlackholeCommunity=spBlackholeCommunity, serviceUsageDone=serviceUsageDone, trafficAutoMitigation=trafficAutoMitigation, spDNSObservedMean=spDNSObservedMean, spBlackholeNexthop=spBlackholeNexthop, spInterfaceUsage=spInterfaceUsage, deviceHealth=deviceHealth, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spManagedObject=spManagedObject, managedObjectUsage=managedObjectUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spImpactPps=spImpactPps, spUsageType=spUsageType, spFingerprintMessage=spFingerprintMessage, deviceSystemErrorDone=deviceSystemErrorDone, spDetectedCountries=spDetectedCountries, reportDone=reportDone, spServiceElement=spServiceElement, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spThirdPartyZone=spThirdPartyZone, spcommFailure=spcommFailure, spGreTunnelDestination=spGreTunnelDestination, spThreshold=spThreshold, devicePhysicalMemory=devicePhysicalMemory, spUsage=spUsage, spManagedObjectFamily=spManagedObjectFamily, spScriptStart=spScriptStart, licenseError=licenseError)
