...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationBlackholeStart=mitigationBlackholeStart, dnsBaseline=dnsBaseline, fingerprintFeedback=fingerprintFeedback, mitigationDone=mitigationDone, spTMSCommunity=spTMSCommunity, snmpDown=snmpDown, bgpHijack=bgpHijack, managedObjectUsage=managedObjectUsage, spHijackLocal=spHijackLocal, spScriptHost=spScriptHost, bgpDown=bgpDown, spLicenseErrCount=spLicenseErrCount, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapOldAttributes=spBGPTrapOldAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, flowUp=flowUp, collectorStart=collectorStart, spBGPTrapName=spBGPTrapName, spFingerprintSender=spFingerprintSender, spScriptCommand=spScriptCommand, spFingerprintName=spFingerprintName, spInterfaceSpeed=spInterfaceSpeed, bgpInstabilityDone=bgpInstabilityDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spManagedObject=spManagedObject, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spSystemErrorDescription=spSystemErrorDescription, spManagedObjectFamily=spManagedObjectFamily, spInetAddress=spInetAddress, deviceTotalFlows=deviceTotalFlows, spUnit=spUnit, spDNSExpected=spDNSExpected, spManagedObjects=spManagedObjects, spScriptStart=spScriptStart, spDuration=spDuration, bgpInstability=bgpInstability, alertScript=alertScript, mitigationFlowspecStart=mitigationFlowspecStart, spDNSObservedMean=spDNSObservedMean, flowDown=flowDown, bgpTrap=bgpTrap, deviceTotalFlowsHC=deviceTotalFlowsHC, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPMIB=peakflowSPMIB, spInterfaceUsage=spInterfaceUsage, spHijackRoute=spHijackRoute, trafficAutoMitigation=trafficAutoMitigation, hardwareFailureDone=hardwareFailureDone, spcommFailureDone=spcommFailureDone, spBlackholeNexthop=spBlackholeNexthop, spcommFailure=spcommFailure, snmpUp=snmpUp, serviceUsage=serviceUsage, hardwareFailure=hardwareFailure, spBGPInstability=spBGPInstability, reportDone=reportDone, spBGPTrapPrefix=spBGPTrapPrefix, spInterfaceIndex=spInterfaceIndex, spDNSName=spDNSName, spUsername=spUsername, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholePrefix=spBlackholePrefix, spMitigationStart=spMitigationStart, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spAlertID=spAlertID, interfaceUsageDone=interfaceUsageDone, spServiceElement=spServiceElement, spUsageType=spUsageType, mitigationTMSStart=mitigationTMSStart, spCollector=spCollector, spFingerprintFeedback=spFingerprintFeedback, peakflowSPMgr=peakflowSPMgr, deviceSwapSpaceInUse=deviceSwapSpaceInUse, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSystemError=deviceSystemError, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceUsageHC=spInterfaceUsageHC, spGreTunnelDestination=spGreTunnelDestination, interfaceUsage=interfaceUsage, cloudSignalingFaultDone=cloudSignalingFaultDone, spHijackAttr=spHijackAttr, deviceDiskUsage=deviceDiskUsage, spInetAddressType=spInetAddressType, licenseError=licenseError, peakflowSPTraps=peakflowSPTraps, notificationLimit=notificationLimit, deviceSystemErrorDone=deviceSystemErrorDone, spVersion=spVersion, spServiceName=spServiceName, spFlowspecCommunity=spFlowspecCommunity, spBGPTrapEvent=spBGPTrapEvent, configChange=configChange, spUsage=spUsage, spImpactPps=spImpactPps, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spApplicationName=spApplicationName, spImpactBps=spImpactBps, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpUp=bgpUp, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spInterfaceSpeedHC=spInterfaceSpeedHC, spThreshold=spThreshold, devicePhysicalMemory=devicePhysicalMemory, spReportURL=spReportURL, spTMSMultiPrefix=spTMSMultiPrefix, serviceUsageDone=serviceUsageDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, greDownDone=greDownDone, spBGPEvent=spBGPEvent, spThirdPartyZone=spThirdPartyZone, spCommFailureDestination=spCommFailureDestination, spDetectedCountries=spDetectedCountries, spGreTunnelName=spGreTunnelName, fingerprintReceive=fingerprintReceive, cloudSignalingFault=cloudSignalingFault, spFingerprintMessage=spFingerprintMessage, fingerprintUsage=fingerprintUsage, spLicenseErrType=spLicenseErrType, managedObjectUsageDone=managedObjectUsageDone, dosHostDetectionAlert=dosHostDetectionAlert, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterface=spInterface, spAlertDetectionSignatures=spAlertDetectionSignatures, spLicenseErrLimit=spLicenseErrLimit, spDetector=spDetector, deviceSwapSpace=deviceSwapSpace, collectorUp=collectorUp, spHardwareFailureDescription=spHardwareFailureDescription, spPravail=spPravail, dnsBaselineDone=dnsBaselineDone, spReportName=spReportName, spScriptPort=spScriptPort, spReportID=spReportID, spBlackholeCommunity=spBlackholeCommunity, spDNSObservedMax=spDNSObservedMax, routingFailover=routingFailover, autoclassifyStart=autoclassifyStart, spTMSPrefix=spTMSPrefix, spMitigationID=spMitigationID, spFlowspecTimeout=spFlowspecTimeout, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spRouter=spRouter, spDNSObserved=spDNSObserved, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spSystemErrorType=spSystemErrorType, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spTMSTimeout=spTMSTimeout, spBlackholeTimeout=spBlackholeTimeout, fingerprintUsageDone=fingerprintUsageDone, spLicenseErrDescription=spLicenseErrDescription, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spCommFailureDescription=spCommFailureDescription, collectorDown=collectorDown, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, licenseErrorDone=licenseErrorDone, greDown=greDown, deviceHealth=deviceHealth, spThirdPartyAddr=spThirdPartyAddr, peakflowSPCMI=peakflowSPCMI, spMitigationName=spMitigationName)
