...
# Produced by pysmi-1.1.8 at Tue Aug  9 16:03:33 2022
...
Counter32, MibIdentifier, NotificationType, Integer32, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "Integer32", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spApplicationName=spApplicationName, hardwareFailure=hardwareFailure, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInterfaceSpeed=spInterfaceSpeed, bgpUp=bgpUp, deviceHealth=deviceHealth, fingerprintFeedback=fingerprintFeedback, spInterface=spInterface, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInetAddressType=spInetAddressType, mitigationDone=mitigationDone, spImpactPps=spImpactPps, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceTotalFlowsHC=deviceTotalFlowsHC, spThirdPartyAddr=spThirdPartyAddr, spBGPTrapName=spBGPTrapName, peakflowSPCMI=peakflowSPCMI, spManagedObjects=spManagedObjects, spFingerprintSender=spFingerprintSender, spLicenseErrCount=spLicenseErrCount, notificationLimit=notificationLimit, fingerprintReceive=fingerprintReceive, mitigationThirdPartyStart=mitigationThirdPartyStart, spDNSExpected=spDNSExpected, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spReportURL=spReportURL, spRouter=spRouter, spCommFailureDescription=spCommFailureDescription, PYSNMP_MODULE_ID=peakflowSPMIB, flowUp=flowUp, spGreTunnelName=spGreTunnelName, spcommFailure=spcommFailure, mitigationTMSStart=mitigationTMSStart, spLicenseErrType=spLicenseErrType, spBlackholeNexthop=spBlackholeNexthop, mitigationFlowspecStart=mitigationFlowspecStart, spTMSTimeout=spTMSTimeout, interfaceUsageDone=interfaceUsageDone, spBGPTrapEvent=spBGPTrapEvent, spManagedObject=spManagedObject, spUsername=spUsername, collectorDown=collectorDown, collectorStart=collectorStart, spGreTunnelDestination=spGreTunnelDestination, peakflowSPMgr=peakflowSPMgr, spCollector=spCollector, spServiceName=spServiceName, managedObjectUsageDone=managedObjectUsageDone, dnsBaselineDone=dnsBaselineDone, spFingerprintFeedback=spFingerprintFeedback, snmpUp=snmpUp, spcommFailureDone=spcommFailureDone, trafficAutoMitigation=trafficAutoMitigation, spFlowspecTimeout=spFlowspecTimeout, spUsage=spUsage, spDNSName=spDNSName, devicePhysicalMemory=devicePhysicalMemory, interfaceUsage=interfaceUsage, spUsageType=spUsageType, cloudSignalingFaultDone=cloudSignalingFaultDone, spDetector=spDetector, deviceDiskUsage=deviceDiskUsage, deviceSwapSpace=deviceSwapSpace, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dosHostDetectionAlertDone=dosHostDetectionAlertDone, hardwareFailureDone=hardwareFailureDone, spCommFailureDestination=spCommFailureDestination, serviceUsage=serviceUsage, spInterfaceIndex=spInterfaceIndex, configChange=configChange, spHijackAttr=spHijackAttr, spFingerprintMessage=spFingerprintMessage, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spPravail=spPravail, flowDown=flowDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpHijack=bgpHijack, licenseError=licenseError, spInetAddress=spInetAddress, spDNSObservedMean=spDNSObservedMean, dnsBaseline=dnsBaseline, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spMitigationID=spMitigationID, spAlertDetectionSignatures=spAlertDetectionSignatures, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spTMSCommunity=spTMSCommunity, bgpInstabilityDone=bgpInstabilityDone, spVersion=spVersion, autoclassifyStart=autoclassifyStart, spBlackholeCommunity=spBlackholeCommunity, licenseErrorDone=licenseErrorDone, peakflowSPTraps=peakflowSPTraps, alertScript=alertScript, spHijackRoute=spHijackRoute, spScriptCommand=spScriptCommand, spScriptPort=spScriptPort, spImpactBps=spImpactBps, peakflowSPMIB=peakflowSPMIB, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintName=spFingerprintName, spScriptStart=spScriptStart, bgpInstability=bgpInstability, spTMSPrefix=spTMSPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportID=spReportID, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spReportName=spReportName, spMitigationName=spMitigationName, cloudSignalingFault=cloudSignalingFault, spFlowspecCommunity=spFlowspecCommunity, spInterfaceUsageHC=spInterfaceUsageHC, spBGPTrapOldAttributes=spBGPTrapOldAttributes, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spLicenseErrLimit=spLicenseErrLimit, routingFailover=routingFailover, spScriptHost=spScriptHost, spManagedObjectFamily=spManagedObjectFamily, spBGPTrapPrefix=spBGPTrapPrefix, spDuration=spDuration, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceSpeedHC=spInterfaceSpeedHC, bgpTrap=bgpTrap, greDownDone=greDownDone, reportDone=reportDone, spUnit=spUnit, spSystemErrorDescription=spSystemErrorDescription, spDNSObserved=spDNSObserved, greDown=greDown, fingerprintUsage=fingerprintUsage, managedObjectUsage=managedObjectUsage, deviceSystemErrorDone=deviceSystemErrorDone, spThirdPartyZone=spThirdPartyZone, spInterfaceUsage=spInterfaceUsage, mitigationTMSStartV2=mitigationTMSStartV2, spBGPInstability=spBGPInstability, spDNSObservedMax=spDNSObservedMax, spSystemErrorType=spSystemErrorType, spBGPEvent=spBGPEvent, spBlackholeTimeout=spBlackholeTimeout, spServiceElement=spServiceElement, spDetectedCountries=spDetectedCountries, spBlackholePrefix=spBlackholePrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, bgpDown=bgpDown, spLicenseErrDescription=spLicenseErrDescription, spThreshold=spThreshold, fingerprintUsageDone=fingerprintUsageDone, deviceTotalFlows=deviceTotalFlows, spMitigationStart=spMitigationStart, mitigationBlackholeStart=mitigationBlackholeStart, spTMSMultiPrefix=spTMSMultiPrefix, collectorUp=collectorUp, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spHijackLocal=spHijackLocal, deviceSystemError=deviceSystemError, snmpDown=snmpDown, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsageDone=serviceUsageDone, spAlertID=spAlertID, spHardwareFailureDescription=spHardwareFailureDescription)
