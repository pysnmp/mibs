...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spHijackAttr=spHijackAttr, spTMSMultiPrefix=spTMSMultiPrefix, spReportID=spReportID, alertScript=alertScript, peakflowSPCMI=peakflowSPCMI, spInterfaceUsageHC=spInterfaceUsageHC, spDNSObserved=spDNSObserved, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, bgpDown=bgpDown, collectorUp=collectorUp, snmpUp=snmpUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dnsBaselineDone=dnsBaselineDone, spFlowspecTimeout=spFlowspecTimeout, deviceSystemError=deviceSystemError, managedObjectUsageDone=managedObjectUsageDone, spGreTunnelDestination=spGreTunnelDestination, spLicenseErrType=spLicenseErrType, spFingerprintMessage=spFingerprintMessage, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, bgpInstability=bgpInstability, deviceSwapSpace=deviceSwapSpace, hardwareFailure=hardwareFailure, routingFailover=routingFailover, spReportName=spReportName, spTMSPrefix=spTMSPrefix, spInterfaceIndex=spInterfaceIndex, spReportURL=spReportURL, spRouter=spRouter, spUsage=spUsage, spInterfaceSpeed=spInterfaceSpeed, spFingerprintSender=spFingerprintSender, managedObjectUsage=managedObjectUsage, configChange=configChange, mitigationBlackholeStart=mitigationBlackholeStart, mitigationDone=mitigationDone, spMitigationStart=spMitigationStart, spThirdPartyZone=spThirdPartyZone, spGreTunnelName=spGreTunnelName, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationTMSStartV2=mitigationTMSStartV2, peakflowSPTraps=peakflowSPTraps, deviceSystemErrorDone=deviceSystemErrorDone, flowUp=flowUp, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spPravail=spPravail, fingerprintUsage=fingerprintUsage, spDNSExpected=spDNSExpected, collectorStart=collectorStart, spSystemErrorDescription=spSystemErrorDescription, spThirdPartyAddr=spThirdPartyAddr, spBlackholeNexthop=spBlackholeNexthop, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spDetectedCountries=spDetectedCountries, deviceHealth=deviceHealth, spDuration=spDuration, fingerprintReceive=fingerprintReceive, bgpTrap=bgpTrap, mitigationThirdPartyStart=mitigationThirdPartyStart, dosHostDetectionAlert=dosHostDetectionAlert, spLicenseErrCount=spLicenseErrCount, spManagedObjectFamily=spManagedObjectFamily, spScriptStart=spScriptStart, spFingerprintFeedback=spFingerprintFeedback, spBGPEvent=spBGPEvent, snmpDown=snmpDown, spScriptPort=spScriptPort, spInetAddressType=spInetAddressType, trafficAutoMitigation=trafficAutoMitigation, interfaceUsage=interfaceUsage, spThreshold=spThreshold, spCommFailureDescription=spCommFailureDescription, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, cloudSignalingFault=cloudSignalingFault, spServiceName=spServiceName, devicePhysicalMemory=devicePhysicalMemory, spInterfaceUsage=spInterfaceUsage, bgpHijack=bgpHijack, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spVersion=spVersion, spBlackholeTimeout=spBlackholeTimeout, greDown=greDown, spSystemErrorType=spSystemErrorType, serviceUsage=serviceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spServiceElement=spServiceElement, spInterfaceSpeedHC=spInterfaceSpeedHC, spAlertID=spAlertID, spDNSObservedMax=spDNSObservedMax, deviceTotalFlowsHC=deviceTotalFlowsHC, spAlertDetectionSignatures=spAlertDetectionSignatures, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spFingerprintName=spFingerprintName, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, collectorDown=collectorDown, spcommFailure=spcommFailure, spTMSCommunity=spTMSCommunity, spDNSName=spDNSName, autoclassifyStart=autoclassifyStart, spHijackRoute=spHijackRoute, bgpInstabilityDone=bgpInstabilityDone, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spCommFailureDestination=spCommFailureDestination, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spCollector=spCollector, spLicenseErrLimit=spLicenseErrLimit, spFlowspecCommunity=spFlowspecCommunity, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterface=spInterface, peakflowSPMIB=peakflowSPMIB, spScriptCommand=spScriptCommand, notificationLimit=notificationLimit, spBGPInstability=spBGPInstability, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spLicenseErrDescription=spLicenseErrDescription, spDetector=spDetector, interfaceUsageDone=interfaceUsageDone, spUsageType=spUsageType, serviceUsageDone=serviceUsageDone, spBGPTrapName=spBGPTrapName, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spApplicationName=spApplicationName, deviceTotalFlows=deviceTotalFlows, deviceDiskUsage=deviceDiskUsage, mitigationFlowspecStart=mitigationFlowspecStart, peakflowSPMgr=peakflowSPMgr, spBlackholeCommunity=spBlackholeCommunity, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spMitigationID=spMitigationID, spBGPTrapEvent=spBGPTrapEvent, spUnit=spUnit, spHardwareFailureDescription=spHardwareFailureDescription, spScriptHost=spScriptHost, spImpactPps=spImpactPps, dnsBaseline=dnsBaseline, spUsername=spUsername, licenseError=licenseError, flowDown=flowDown, greDownDone=greDownDone, hardwareFailureDone=hardwareFailureDone, fingerprintUsageDone=fingerprintUsageDone, spHijackLocal=spHijackLocal, PYSNMP_MODULE_ID=peakflowSPMIB, spManagedObject=spManagedObject, reportDone=reportDone, spcommFailureDone=spcommFailureDone, spMitigationName=spMitigationName, spDNSObservedMean=spDNSObservedMean, bgpUp=bgpUp, fingerprintFeedback=fingerprintFeedback, spBlackholePrefix=spBlackholePrefix, spManagedObjects=spManagedObjects, spInetAddress=spInetAddress, spBGPTrapPrefix=spBGPTrapPrefix, mitigationTMSStart=mitigationTMSStart, spImpactBps=spImpactBps, spTMSTimeout=spTMSTimeout, licenseErrorDone=licenseErrorDone)
