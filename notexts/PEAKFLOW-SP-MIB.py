...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:13:20 2021
...
TimeTicks, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, iso, Gauge32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "iso", "Gauge32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", deviceTotalFlowsHC=deviceTotalFlowsHC, spServiceElement=spServiceElement, spLicenseErrCount=spLicenseErrCount, spBlackholePrefix=spBlackholePrefix, snmpDown=snmpDown, hardwareFailureDone=hardwareFailureDone, spLicenseErrLimit=spLicenseErrLimit, spUnit=spUnit, spUsage=spUsage, fingerprintFeedback=fingerprintFeedback, mitigationThirdPartyStart=mitigationThirdPartyStart, mitigationTMSStart=mitigationTMSStart, reportDone=reportDone, spServiceName=spServiceName, peakflowSPCMI=peakflowSPCMI, spReportURL=spReportURL, spSystemErrorDescription=spSystemErrorDescription, spInterface=spInterface, spFlowspecCommunity=spFlowspecCommunity, collectorDown=collectorDown, spScriptCommand=spScriptCommand, PYSNMP_MODULE_ID=peakflowSPMIB, collectorUp=collectorUp, bgpInstabilityDone=bgpInstabilityDone, spFingerprintSender=spFingerprintSender, spFingerprintName=spFingerprintName, configChange=configChange, spBGPEvent=spBGPEvent, licenseError=licenseError, devicePhysicalMemory=devicePhysicalMemory, cloudSignalingFaultDone=cloudSignalingFaultDone, spRouter=spRouter, spcommFailure=spcommFailure, greDownDone=greDownDone, spBGPTrapName=spBGPTrapName, managedObjectUsage=managedObjectUsage, spScriptPort=spScriptPort, dosNetworkProfiledAlert=dosNetworkProfiledAlert, deviceSwapSpace=deviceSwapSpace, spGreTunnelDestination=spGreTunnelDestination, spUsername=spUsername, licenseErrorDone=licenseErrorDone, bgpTrap=bgpTrap, spBGPTrapEvent=spBGPTrapEvent, routingFailover=routingFailover, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBlackholeCommunity=spBlackholeCommunity, spBlackholeNexthop=spBlackholeNexthop, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spReportID=spReportID, spThirdPartyZone=spThirdPartyZone, spGreTunnelName=spGreTunnelName, spDNSObservedMax=spDNSObservedMax, spTMSTimeout=spTMSTimeout, spDuration=spDuration, spInterfaceUsage=spInterfaceUsage, serviceUsageDone=serviceUsageDone, spCommFailureDescription=spCommFailureDescription, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceTotalFlows=deviceTotalFlows, dosHostDetectionAlert=dosHostDetectionAlert, spDetector=spDetector, deviceHealth=deviceHealth, greDown=greDown, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spMitigationName=spMitigationName, spFingerprintFeedback=spFingerprintFeedback, flowUp=flowUp, spThreshold=spThreshold, spSystemErrorType=spSystemErrorType, dnsBaseline=dnsBaseline, spDetectedCountries=spDetectedCountries, autoclassifyStart=autoclassifyStart, spVersion=spVersion, serviceUsage=serviceUsage, spPravail=spPravail, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spMitigationStart=spMitigationStart, deviceSystemErrorDone=deviceSystemErrorDone, peakflowSPTraps=peakflowSPTraps, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorStart=collectorStart, bgpInstability=bgpInstability, dnsBaselineDone=dnsBaselineDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, mitigationFlowspecStart=mitigationFlowspecStart, spScriptStart=spScriptStart, spImpactBps=spImpactBps, notificationLimit=notificationLimit, hardwareFailure=hardwareFailure, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCollector=spCollector, spReportName=spReportName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spApplicationName=spApplicationName, spBGPTrapPrefix=spBGPTrapPrefix, spDNSName=spDNSName, fingerprintReceive=fingerprintReceive, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, snmpUp=snmpUp, cloudSignalingFault=cloudSignalingFault, spBGPInstability=spBGPInstability, spCommFailureDestination=spCommFailureDestination, spDNSExpected=spDNSExpected, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, managedObjectUsageDone=managedObjectUsageDone, interfaceUsage=interfaceUsage, alertScript=alertScript, spDNSObservedMean=spDNSObservedMean, spFlowspecTimeout=spFlowspecTimeout, spDNSObserved=spDNSObserved, spMitigationID=spMitigationID, spTMSCommunity=spTMSCommunity, spHijackLocal=spHijackLocal, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spThirdPartyAddr=spThirdPartyAddr, spcommFailureDone=spcommFailureDone, spAlertDetectionSignatures=spAlertDetectionSignatures, bgpHijack=bgpHijack, spInetAddressType=spInetAddressType, fingerprintUsage=fingerprintUsage, spLicenseErrType=spLicenseErrType, deviceSystemError=deviceSystemError, spBlackholeTimeout=spBlackholeTimeout, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spScriptHost=spScriptHost, fingerprintUsageDone=fingerprintUsageDone, spInterfaceUsageHC=spInterfaceUsageHC, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spInetAddress=spInetAddress, flowDown=flowDown, spManagedObjects=spManagedObjects, deviceDiskUsage=deviceDiskUsage, spTMSPrefix=spTMSPrefix, interfaceUsageDone=interfaceUsageDone, spImpactPps=spImpactPps, trafficAutoMitigation=trafficAutoMitigation, spAlertID=spAlertID, mitigationTMSStartV2=mitigationTMSStartV2, bgpDown=bgpDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpUp=bgpUp, spHardwareFailureDescription=spHardwareFailureDescription, spUsageType=spUsageType, peakflowSPMIB=peakflowSPMIB, spManagedObjectFamily=spManagedObjectFamily, spLicenseErrDescription=spLicenseErrDescription, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, mitigationBlackholeStart=mitigationBlackholeStart, spInterfaceSpeed=spInterfaceSpeed, spHijackAttr=spHijackAttr, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spFingerprintMessage=spFingerprintMessage, mitigationDone=mitigationDone, spHijackRoute=spHijackRoute, dosHostDetectionAlertDone=dosHostDetectionAlertDone, peakflowSPMgr=peakflowSPMgr, spManagedObject=spManagedObject, spInterfaceIndex=spInterfaceIndex)
