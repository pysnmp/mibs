...
# Produced by pysmi-1.1.12 at Mon Jun  3 10:53:38 2024
...
TimeTicks, Unsigned32, ModuleIdentity, Counter32, NotificationType, Counter64, iso, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter32", "NotificationType", "Counter64", "iso", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", mitigationTMSStartV2=mitigationTMSStartV2, serviceUsageDone=serviceUsageDone, spSystemErrorType=spSystemErrorType, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spInterfaceUsageHC=spInterfaceUsageHC, hardwareFailure=hardwareFailure, spScriptPort=spScriptPort, spInterfaceIndex=spInterfaceIndex, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spGreTunnelDestination=spGreTunnelDestination, greDownDone=greDownDone, bgpInstability=bgpInstability, spMitigationStart=spMitigationStart, spManagedObjects=spManagedObjects, reportDone=reportDone, spApplicationName=spApplicationName, spReportName=spReportName, spScriptStart=spScriptStart, licenseErrorDone=licenseErrorDone, spFingerprintSender=spFingerprintSender, spServiceElement=spServiceElement, deviceSystemError=deviceSystemError, flowUp=flowUp, spHijackLocal=spHijackLocal, spFlowspecCommunity=spFlowspecCommunity, spVersion=spVersion, collectorUp=collectorUp, collectorStart=collectorStart, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, alertScript=alertScript, spReportID=spReportID, spFlowspecTimeout=spFlowspecTimeout, spHijackRoute=spHijackRoute, dnsBaseline=dnsBaseline, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spTMSPrefix=spTMSPrefix, spFingerprintFeedback=spFingerprintFeedback, deviceSystemErrorDone=deviceSystemErrorDone, bgpTrap=bgpTrap, spLicenseErrCount=spLicenseErrCount, spRouter=spRouter, interfaceUsageDone=interfaceUsageDone, spLicenseErrType=spLicenseErrType, flowDown=flowDown, spDetectedCountries=spDetectedCountries, bgpHijack=bgpHijack, spHijackAttr=spHijackAttr, interfaceUsage=interfaceUsage, trafficAutoMitigation=trafficAutoMitigation, spManagedObjectFamily=spManagedObjectFamily, peakflowSPTraps=peakflowSPTraps, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spBlackholeTimeout=spBlackholeTimeout, spHardwareFailureDescription=spHardwareFailureDescription, spDNSObserved=spDNSObserved, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPMgr=peakflowSPMgr, spInterface=spInterface, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spBGPInstability=spBGPInstability, spTMSCommunity=spTMSCommunity, managedObjectUsage=managedObjectUsage, bgpDown=bgpDown, deviceTotalFlows=deviceTotalFlows, spDNSName=spDNSName, hardwareFailureDone=hardwareFailureDone, spMitigationID=spMitigationID, fingerprintFeedback=fingerprintFeedback, spDNSObservedMean=spDNSObservedMean, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPCMI=peakflowSPCMI, spCollector=spCollector, spBGPTrapEvent=spBGPTrapEvent, spBGPTrapPrefix=spBGPTrapPrefix, spScriptCommand=spScriptCommand, spBGPEvent=spBGPEvent, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, mitigationTMSStart=mitigationTMSStart, spThreshold=spThreshold, deviceHealth=deviceHealth, spTMSMultiPrefix=spTMSMultiPrefix, spUsage=spUsage, spMitigationName=spMitigationName, snmpUp=snmpUp, spInetAddressType=spInetAddressType, autoclassifyStart=autoclassifyStart, cloudSignalingFault=cloudSignalingFault, spCommFailureDescription=spCommFailureDescription, spScriptHost=spScriptHost, spServiceName=spServiceName, spBlackholeNexthop=spBlackholeNexthop, spImpactPps=spImpactPps, spSystemErrorDescription=spSystemErrorDescription, spPravail=spPravail, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, bgpUp=bgpUp, managedObjectUsageDone=managedObjectUsageDone, spBlackholePrefix=spBlackholePrefix, spAlertID=spAlertID, devicePhysicalMemory=devicePhysicalMemory, licenseError=licenseError, routingFailover=routingFailover, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSObservedMax=spDNSObservedMax, spInetAddress=spInetAddress, spAlertDetectionSignatures=spAlertDetectionSignatures, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterfaceSpeed=spInterfaceSpeed, serviceUsage=serviceUsage, spDuration=spDuration, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spcommFailureDone=spcommFailureDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBlackholeCommunity=spBlackholeCommunity, spInterfaceSpeedHC=spInterfaceSpeedHC, dnsBaselineDone=dnsBaselineDone, spManagedObject=spManagedObject, greDown=greDown, spImpactBps=spImpactBps, spThirdPartyZone=spThirdPartyZone, spFingerprintMessage=spFingerprintMessage, mitigationFlowspecStart=mitigationFlowspecStart, spUnit=spUnit, deviceDiskUsage=deviceDiskUsage, mitigationDone=mitigationDone, spReportURL=spReportURL, spLicenseErrLimit=spLicenseErrLimit, spDetector=spDetector, collectorDown=collectorDown, spUsageType=spUsageType, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spFingerprintName=spFingerprintName, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, notificationLimit=notificationLimit, spCommFailureDestination=spCommFailureDestination, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spUsername=spUsername, spTMSTimeout=spTMSTimeout, fingerprintReceive=fingerprintReceive, spLicenseErrDescription=spLicenseErrDescription, snmpDown=snmpDown, fingerprintUsageDone=fingerprintUsageDone, spGreTunnelName=spGreTunnelName, bgpInstabilityDone=bgpInstabilityDone, deviceSwapSpace=deviceSwapSpace, spcommFailure=spcommFailure, spInterfaceUsage=spInterfaceUsage, spDNSExpected=spDNSExpected, fingerprintUsage=fingerprintUsage, dosHostDetectionAlertDone=dosHostDetectionAlertDone, PYSNMP_MODULE_ID=peakflowSPMIB, configChange=configChange, spBGPTrapName=spBGPTrapName, mitigationBlackholeStart=mitigationBlackholeStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spThirdPartyAddr=spThirdPartyAddr, peakflowSPMIB=peakflowSPMIB, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceTotalFlowsHC=deviceTotalFlowsHC)
