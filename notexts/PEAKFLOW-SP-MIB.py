...
# Produced by pysmi-1.1.8 at Wed Sep 13 14:21:54 2023
...
iso, Unsigned32, Counter64, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "Counter64", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spApplicationName=spApplicationName, spDNSExpected=spDNSExpected, managedObjectUsage=managedObjectUsage, peakflowSPMIB=peakflowSPMIB, spFingerprintName=spFingerprintName, devicePhysicalMemory=devicePhysicalMemory, routingFailover=routingFailover, peakflowSPTraps=peakflowSPTraps, mitigationTMSStartV2=mitigationTMSStartV2, spDNSName=spDNSName, spServiceName=spServiceName, spRouter=spRouter, spInterfaceUsage=spInterfaceUsage, spImpactPps=spImpactPps, spBGPTrapNewAttributes=spBGPTrapNewAttributes, dnsBaseline=dnsBaseline, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spTMSMultiPrefix=spTMSMultiPrefix, snmpDown=snmpDown, spScriptStart=spScriptStart, spServiceElement=spServiceElement, collectorDown=collectorDown, spPravail=spPravail, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spMitigationStart=spMitigationStart, spHardwareFailureDescription=spHardwareFailureDescription, spBGPTrapPrefix=spBGPTrapPrefix, mitigationBlackholeStart=mitigationBlackholeStart, deviceSystemError=deviceSystemError, spSystemErrorType=spSystemErrorType, spLicenseErrDescription=spLicenseErrDescription, serviceUsage=serviceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spInterfaceIndex=spInterfaceIndex, spReportURL=spReportURL, spThreshold=spThreshold, licenseErrorDone=licenseErrorDone, spDetector=spDetector, spImpactBps=spImpactBps, spCommFailureDescription=spCommFailureDescription, configChange=configChange, spUsageType=spUsageType, fingerprintUsageDone=fingerprintUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, greDown=greDown, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spGreTunnelName=spGreTunnelName, spCommFailureDestination=spCommFailureDestination, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPMgr=peakflowSPMgr, spUsername=spUsername, spTMSTimeout=spTMSTimeout, deviceSwapSpaceInUse=deviceSwapSpaceInUse, serviceUsageDone=serviceUsageDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spBGPTrapEvent=spBGPTrapEvent, spTMSCommunity=spTMSCommunity, spTMSPrefix=spTMSPrefix, spDNSObserved=spDNSObserved, mitigationThirdPartyStart=mitigationThirdPartyStart, bgpDown=bgpDown, spBlackholeCommunity=spBlackholeCommunity, spcommFailureDone=spcommFailureDone, spFlowspecCommunity=spFlowspecCommunity, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spBlackholeNexthop=spBlackholeNexthop, deviceDiskUsage=deviceDiskUsage, spThirdPartyAddr=spThirdPartyAddr, reportDone=reportDone, spVersion=spVersion, collectorUp=collectorUp, spManagedObjects=spManagedObjects, spInterfaceSpeedHC=spInterfaceSpeedHC, spScriptCommand=spScriptCommand, spBlackholePrefix=spBlackholePrefix, fingerprintFeedback=fingerprintFeedback, spHijackAttr=spHijackAttr, hardwareFailureDone=hardwareFailureDone, bgpUp=bgpUp, interfaceUsageDone=interfaceUsageDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPInstability=spBGPInstability, spDNSObservedMean=spDNSObservedMean, collectorStart=collectorStart, PYSNMP_MODULE_ID=peakflowSPMIB, fingerprintUsage=fingerprintUsage, spManagedObject=spManagedObject, fingerprintReceive=fingerprintReceive, spAlertDetectionSignatures=spAlertDetectionSignatures, spHijackLocal=spHijackLocal, spMitigationName=spMitigationName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, notificationLimit=notificationLimit, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spDNSObservedMax=spDNSObservedMax, bgpTrap=bgpTrap, licenseError=licenseError, deviceSwapSpace=deviceSwapSpace, greDownDone=greDownDone, spAlertID=spAlertID, spFingerprintFeedback=spFingerprintFeedback, deviceHealth=deviceHealth, dnsBaselineDone=dnsBaselineDone, spSystemErrorDescription=spSystemErrorDescription, deviceSystemErrorDone=deviceSystemErrorDone, spHijackRoute=spHijackRoute, spDetectedCountries=spDetectedCountries, spUsage=spUsage, interfaceUsage=interfaceUsage, spReportID=spReportID, deviceTotalFlows=deviceTotalFlows, flowDown=flowDown, spUnit=spUnit, spScriptPort=spScriptPort, autoclassifyStart=autoclassifyStart, spCollector=spCollector, trafficAutoMitigation=trafficAutoMitigation, peakflowSPCMI=peakflowSPCMI, spInterface=spInterface, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spGreTunnelDestination=spGreTunnelDestination, spMitigationID=spMitigationID, spFingerprintMessage=spFingerprintMessage, spBlackholeTimeout=spBlackholeTimeout, spScriptHost=spScriptHost, snmpUp=snmpUp, mitigationTMSStart=mitigationTMSStart, spcommFailure=spcommFailure, spDuration=spDuration, bgpInstabilityDone=bgpInstabilityDone, spInetAddress=spInetAddress, bgpInstability=bgpInstability, deviceTotalFlowsHC=deviceTotalFlowsHC, spThirdPartyZone=spThirdPartyZone, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spLicenseErrType=spLicenseErrType, mitigationDone=mitigationDone, spManagedObjectFamily=spManagedObjectFamily, hardwareFailure=hardwareFailure, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrCount=spLicenseErrCount, alertScript=alertScript, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintSender=spFingerprintSender, managedObjectUsageDone=managedObjectUsageDone, mitigationFlowspecStart=mitigationFlowspecStart, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spInetAddressType=spInetAddressType, bgpHijack=bgpHijack, cloudSignalingFault=cloudSignalingFault, spReportName=spReportName, spBGPTrapName=spBGPTrapName, spLicenseErrLimit=spLicenseErrLimit, spBGPEvent=spBGPEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spInterfaceSpeed=spInterfaceSpeed, spFlowspecTimeout=spFlowspecTimeout, flowUp=flowUp, deviceSwapSpaceUsage=deviceSwapSpaceUsage)
