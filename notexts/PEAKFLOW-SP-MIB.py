...
Integer32, NotificationType, TimeTicks, iso, Bits, Gauge32, ObjectIdentity, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "TimeTicks", "iso", "Bits", "Gauge32", "ObjectIdentity", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, fingerprintUsageDone=fingerprintUsageDone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, greDownDone=greDownDone, spMitigationStart=spMitigationStart, spFlowspecCommunity=spFlowspecCommunity, spBGPTrapName=spBGPTrapName, spThirdPartyAddr=spThirdPartyAddr, interfaceUsage=interfaceUsage, serviceUsageDone=serviceUsageDone, spManagedObjects=spManagedObjects, spcommFailureDone=spcommFailureDone, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, reportDone=reportDone, bgpUp=bgpUp, deviceSwapSpace=deviceSwapSpace, spHijackAttr=spHijackAttr, dnsBaselineDone=dnsBaselineDone, spManagedObjectFamily=spManagedObjectFamily, spRouter=spRouter, spDNSObservedMean=spDNSObservedMean, flowDown=flowDown, devicePhysicalMemory=devicePhysicalMemory, fingerprintReceive=fingerprintReceive, dosNetworkProfiledAlert=dosNetworkProfiledAlert, peakflowSPMgr=peakflowSPMgr, fingerprintUsage=fingerprintUsage, spBlackholeCommunity=spBlackholeCommunity, bgpInstabilityDone=bgpInstabilityDone, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, cloudSignalingFaultDone=cloudSignalingFaultDone, mitigationTMSStartV2=mitigationTMSStartV2, spVersion=spVersion, spDNSObservedMax=spDNSObservedMax, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFlowspecTimeout=spFlowspecTimeout, greDown=greDown, spCommFailureDescription=spCommFailureDescription, configChange=configChange, spHijackLocal=spHijackLocal, spManagedObject=spManagedObject, spApplicationName=spApplicationName, spAlertID=spAlertID, spScriptCommand=spScriptCommand, spBGPTrapPrefix=spBGPTrapPrefix, deviceTotalFlows=deviceTotalFlows, spScriptHost=spScriptHost, spTMSMultiPrefix=spTMSMultiPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSystemError=deviceSystemError, spUsageType=spUsageType, spInetAddressType=spInetAddressType, hardwareFailureDone=hardwareFailureDone, spInterfaceUsage=spInterfaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, spTMSCommunity=spTMSCommunity, spPravail=spPravail, spDNSName=spDNSName, spFingerprintSender=spFingerprintSender, spScriptPort=spScriptPort, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsageDone=managedObjectUsageDone, routingFailover=routingFailover, spTMSPrefix=spTMSPrefix, spDetector=spDetector, spLicenseErrLimit=spLicenseErrLimit, spReportID=spReportID, deviceSwapSpaceInUse=deviceSwapSpaceInUse, interfaceUsageDone=interfaceUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBGPEvent=spBGPEvent, spGreTunnelName=spGreTunnelName, peakflowSPTraps=peakflowSPTraps, PYSNMP_MODULE_ID=peakflowSPMIB, dnsBaseline=dnsBaseline, spReportURL=spReportURL, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationDone=mitigationDone, bgpHijack=bgpHijack, fingerprintFeedback=fingerprintFeedback, serviceUsage=serviceUsage, spMitigationName=spMitigationName, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spMitigationID=spMitigationID, spcommFailure=spcommFailure, collectorDown=collectorDown, spUsage=spUsage, autoclassifyStart=autoclassifyStart, deviceSystemErrorDone=deviceSystemErrorDone, spFingerprintMessage=spFingerprintMessage, spAlertDetectionSignatures=spAlertDetectionSignatures, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, peakflowSPMIB=peakflowSPMIB, collectorUp=collectorUp, spCommFailureDestination=spCommFailureDestination, spUsername=spUsername, spLicenseErrCount=spLicenseErrCount, licenseError=licenseError, spHijackRoute=spHijackRoute, spServiceElement=spServiceElement, spHardwareFailureDescription=spHardwareFailureDescription, notificationLimit=notificationLimit, alertScript=alertScript, hardwareFailure=hardwareFailure, spScriptStart=spScriptStart, mitigationFlowspecStart=mitigationFlowspecStart, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spBlackholePrefix=spBlackholePrefix, mitigationTMSStart=mitigationTMSStart, spBGPTrapEvent=spBGPTrapEvent, spLicenseErrType=spLicenseErrType, spInterfaceUsageHC=spInterfaceUsageHC, trafficAutoMitigation=trafficAutoMitigation, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, cloudSignalingFault=cloudSignalingFault, spLicenseErrDescription=spLicenseErrDescription, spImpactBps=spImpactBps, dosHostDetectionAlert=dosHostDetectionAlert, spImpactPps=spImpactPps, collectorStart=collectorStart, spDuration=spDuration, spThirdPartyZone=spThirdPartyZone, spThreshold=spThreshold, spGreTunnelDestination=spGreTunnelDestination, spFingerprintFeedback=spFingerprintFeedback, spInterface=spInterface, spFingerprintName=spFingerprintName, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spBlackholeNexthop=spBlackholeNexthop, spReportName=spReportName, spSystemErrorType=spSystemErrorType, spInetAddress=spInetAddress, spTMSTimeout=spTMSTimeout, bgpDown=bgpDown, spBlackholeTimeout=spBlackholeTimeout, mitigationThirdPartyStart=mitigationThirdPartyStart, bgpInstability=bgpInstability, deviceDiskUsage=deviceDiskUsage, snmpDown=snmpDown, spCollector=spCollector, spBGPInstability=spBGPInstability, managedObjectUsage=managedObjectUsage, bgpTrap=bgpTrap, flowUp=flowUp, spServiceName=spServiceName, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spSystemErrorDescription=spSystemErrorDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, snmpUp=snmpUp, peakflowSPCMI=peakflowSPCMI, spDNSExpected=spDNSExpected, licenseErrorDone=licenseErrorDone, spUnit=spUnit, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spInterfaceIndex=spInterfaceIndex, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spInterfaceSpeed=spInterfaceSpeed, spDNSObserved=spDNSObserved, deviceHealth=deviceHealth)
