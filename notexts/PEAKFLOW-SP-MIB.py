...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:54:02 2024
...
NotificationType, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, ObjectIdentity, MibIdentifier, Counter32, Unsigned32, Counter64, iso, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "Counter64", "iso", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spUsageType=spUsageType, spBlackholePrefix=spBlackholePrefix, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, flowDown=flowDown, dosHostDetectionAlert=dosHostDetectionAlert, peakflowSPMIB=peakflowSPMIB, spMitigationStart=spMitigationStart, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, deviceSwapSpace=deviceSwapSpace, flowUp=flowUp, spBGPInstability=spBGPInstability, spDetectedCountries=spDetectedCountries, alertScript=alertScript, spDuration=spDuration, spManagedObject=spManagedObject, peakflowSPTraps=peakflowSPTraps, snmpUp=snmpUp, spGreTunnelName=spGreTunnelName, spAlertID=spAlertID, spGreTunnelDestination=spGreTunnelDestination, spScriptStart=spScriptStart, spApplicationName=spApplicationName, spSystemErrorDescription=spSystemErrorDescription, bgpTrap=bgpTrap, licenseErrorDone=licenseErrorDone, interfaceUsageDone=interfaceUsageDone, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, bgpInstability=bgpInstability, peakflowSPMgr=peakflowSPMgr, interfaceUsage=interfaceUsage, fingerprintFeedback=fingerprintFeedback, notificationLimit=notificationLimit, spSystemErrorType=spSystemErrorType, spManagedObjectFamily=spManagedObjectFamily, spDNSExpected=spDNSExpected, mitigationFlowspecStart=mitigationFlowspecStart, spcommFailureDone=spcommFailureDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spLicenseErrDescription=spLicenseErrDescription, serviceUsage=serviceUsage, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, peakflowSPCMI=peakflowSPCMI, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spBGPTrapPrefix=spBGPTrapPrefix, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrCount=spLicenseErrCount, spInterfaceUsageHC=spInterfaceUsageHC, mitigationTMSStartV2=mitigationTMSStartV2, spBlackholeNexthop=spBlackholeNexthop, spScriptHost=spScriptHost, spDNSObserved=spDNSObserved, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spTMSTimeout=spTMSTimeout, spHijackLocal=spHijackLocal, spThirdPartyAddr=spThirdPartyAddr, deviceHealth=deviceHealth, collectorStart=collectorStart, spInetAddress=spInetAddress, spInterface=spInterface, spBGPEvent=spBGPEvent, spInterfaceSpeed=spInterfaceSpeed, spScriptCommand=spScriptCommand, spPravail=spPravail, deviceTotalFlows=deviceTotalFlows, deviceTotalFlowsHC=deviceTotalFlowsHC, collectorDown=collectorDown, mitigationThirdPartyStart=mitigationThirdPartyStart, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, spReportName=spReportName, hardwareFailure=hardwareFailure, spTMSCommunity=spTMSCommunity, spUnit=spUnit, spFingerprintFeedback=spFingerprintFeedback, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spHijackRoute=spHijackRoute, managedObjectUsage=managedObjectUsage, spImpactPps=spImpactPps, deviceDiskUsage=deviceDiskUsage, autoclassifyStart=autoclassifyStart, spUsername=spUsername, spLicenseErrLimit=spLicenseErrLimit, configChange=configChange, spCloudSignalFaultDescription=spCloudSignalFaultDescription, reportDone=reportDone, licenseError=licenseError, fingerprintUsageDone=fingerprintUsageDone, spImpactBps=spImpactBps, spcommFailure=spcommFailure, spLicenseErrType=spLicenseErrType, spCommFailureDestination=spCommFailureDestination, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spBGPTrapEvent=spBGPTrapEvent, spBlackholeCommunity=spBlackholeCommunity, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, bgpUp=bgpUp, spBlackholeTimeout=spBlackholeTimeout, hardwareFailureDone=hardwareFailureDone, spReportID=spReportID, spMitigationID=spMitigationID, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spReportURL=spReportURL, cloudSignalingFault=cloudSignalingFault, spInetAddressType=spInetAddressType, spInterfaceIndex=spInterfaceIndex, routingFailover=routingFailover, spServiceElement=spServiceElement, snmpDown=snmpDown, spFlowspecTimeout=spFlowspecTimeout, spDetector=spDetector, fingerprintUsage=fingerprintUsage, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spFingerprintMessage=spFingerprintMessage, bgpInstabilityDone=bgpInstabilityDone, spDNSName=spDNSName, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPTrapName=spBGPTrapName, mitigationDone=mitigationDone, greDownDone=greDownDone, dnsBaseline=dnsBaseline, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, spDNSObservedMax=spDNSObservedMax, serviceUsageDone=serviceUsageDone, spTMSMultiPrefix=spTMSMultiPrefix, spVersion=spVersion, trafficAutoMitigation=trafficAutoMitigation, managedObjectUsageDone=managedObjectUsageDone, spThirdPartyZone=spThirdPartyZone, spThreshold=spThreshold, spHardwareFailureDescription=spHardwareFailureDescription, mitigationTMSStart=mitigationTMSStart, spCollector=spCollector, spHijackAttr=spHijackAttr, spTMSPrefix=spTMSPrefix, spFlowspecCommunity=spFlowspecCommunity, deviceSystemError=deviceSystemError, spRouter=spRouter, spMitigationName=spMitigationName, deviceSwapSpaceInUse=deviceSwapSpaceInUse, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptPort=spScriptPort, bgpDown=bgpDown, mitigationBlackholeStart=mitigationBlackholeStart, spFingerprintName=spFingerprintName, spDNSObservedMean=spDNSObservedMean, spUsage=spUsage, collectorUp=collectorUp, spServiceName=spServiceName, dnsBaselineDone=dnsBaselineDone, fingerprintReceive=fingerprintReceive, greDown=greDown, devicePhysicalMemory=devicePhysicalMemory, spInterfaceUsage=spInterfaceUsage, spCommFailureDescription=spCommFailureDescription, bgpHijack=bgpHijack, spFingerprintSender=spFingerprintSender, spManagedObjects=spManagedObjects)
