...
# Produced by pysmi-1.1.12 at Fri Nov 22 11:52:14 2024
...
TimeTicks, IpAddress, MibIdentifier, NotificationType, iso, Gauge32, Counter64, Integer32, Bits, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "MibIdentifier", "NotificationType", "iso", "Gauge32", "Counter64", "Integer32", "Bits", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spMitigationName=spMitigationName, peakflowSPTraps=peakflowSPTraps, spBlackholePrefix=spBlackholePrefix, spBGPTrapOldAttributes=spBGPTrapOldAttributes, mitigationTMSStartV2=mitigationTMSStartV2, spFlowspecTimeout=spFlowspecTimeout, spAlertID=spAlertID, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spThirdPartyAddr=spThirdPartyAddr, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, routingFailover=routingFailover, spBGPTrapName=spBGPTrapName, spLicenseErrType=spLicenseErrType, deviceTotalFlowsHC=deviceTotalFlowsHC, spFlowspecCommunity=spFlowspecCommunity, flowDown=flowDown, spInterfaceUsageHC=spInterfaceUsageHC, spInterfaceSpeed=spInterfaceSpeed, spCloudSignalFaultDescription=spCloudSignalFaultDescription, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spThirdPartyZone=spThirdPartyZone, spScriptStart=spScriptStart, spDNSObservedMax=spDNSObservedMax, deviceDiskUsage=deviceDiskUsage, dnsBaseline=dnsBaseline, spApplicationName=spApplicationName, fingerprintFeedback=fingerprintFeedback, reportDone=reportDone, spImpactBps=spImpactBps, PYSNMP_MODULE_ID=peakflowSPMIB, spPravail=spPravail, spCommFailureDescription=spCommFailureDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spSystemErrorDescription=spSystemErrorDescription, spManagedObjects=spManagedObjects, spTMSPrefix=spTMSPrefix, spCollector=spCollector, spBGPEvent=spBGPEvent, spManagedObjectFamily=spManagedObjectFamily, devicePhysicalMemory=devicePhysicalMemory, interfaceUsageDone=interfaceUsageDone, spDNSName=spDNSName, mitigationBlackholeStart=mitigationBlackholeStart, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spReportName=spReportName, spDetector=spDetector, bgpTrap=bgpTrap, spVersion=spVersion, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spDNSObserved=spDNSObserved, spScriptPort=spScriptPort, spBlackholeTimeout=spBlackholeTimeout, fingerprintUsageDone=fingerprintUsageDone, spReportURL=spReportURL, spUsage=spUsage, spSystemErrorType=spSystemErrorType, bgpInstabilityDone=bgpInstabilityDone, licenseError=licenseError, spHijackRoute=spHijackRoute, spInetAddress=spInetAddress, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spUsername=spUsername, greDownDone=greDownDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, hardwareFailureDone=hardwareFailureDone, spThreshold=spThreshold, spFingerprintSender=spFingerprintSender, spBGPInstability=spBGPInstability, fingerprintUsage=fingerprintUsage, deviceSystemErrorDone=deviceSystemErrorDone, bgpHijack=bgpHijack, spServiceElement=spServiceElement, peakflowSPMgr=peakflowSPMgr, bgpUp=bgpUp, serviceUsage=serviceUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, collectorDown=collectorDown, spScriptCommand=spScriptCommand, spDuration=spDuration, snmpDown=snmpDown, spcommFailure=spcommFailure, spFingerprintFeedback=spFingerprintFeedback, spLicenseErrLimit=spLicenseErrLimit, spInterfaceIndex=spInterfaceIndex, spCommFailureDestination=spCommFailureDestination, mitigationThirdPartyStart=mitigationThirdPartyStart, peakflowSPCMI=peakflowSPCMI, spBlackholeCommunity=spBlackholeCommunity, spUnit=spUnit, hardwareFailure=hardwareFailure, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spRouter=spRouter, spReportID=spReportID, bgpDown=bgpDown, collectorStart=collectorStart, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, snmpUp=snmpUp, mitigationDone=mitigationDone, alertScript=alertScript, spInterfaceUsage=spInterfaceUsage, fingerprintReceive=fingerprintReceive, spManagedObject=spManagedObject, notificationLimit=notificationLimit, spDNSExpected=spDNSExpected, interfaceUsage=interfaceUsage, spInetAddressType=spInetAddressType, spTMSMultiPrefix=spTMSMultiPrefix, mitigationTMSStart=mitigationTMSStart, spAlertDetectionSignatures=spAlertDetectionSignatures, managedObjectUsageDone=managedObjectUsageDone, greDown=greDown, deviceSwapSpace=deviceSwapSpace, managedObjectUsage=managedObjectUsage, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, trafficAutoMitigation=trafficAutoMitigation, spBGPTrapPrefix=spBGPTrapPrefix, spTMSTimeout=spTMSTimeout, spBlackholeNexthop=spBlackholeNexthop, autoclassifyStart=autoclassifyStart, spTMSCommunity=spTMSCommunity, mitigationFlowspecStart=mitigationFlowspecStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spGreTunnelDestination=spGreTunnelDestination, configChange=configChange, deviceTotalFlows=deviceTotalFlows, spBGPTrapEvent=spBGPTrapEvent, deviceHealth=deviceHealth, dnsBaselineDone=dnsBaselineDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSystemError=deviceSystemError, spLicenseErrDescription=spLicenseErrDescription, spcommFailureDone=spcommFailureDone, peakflowSPMIB=peakflowSPMIB, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUsageType=spUsageType, cloudSignalingFault=cloudSignalingFault, serviceUsageDone=serviceUsageDone, spFingerprintMessage=spFingerprintMessage, spDNSObservedMean=spDNSObservedMean, spHardwareFailureDescription=spHardwareFailureDescription, spHijackAttr=spHijackAttr, spScriptHost=spScriptHost, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spMitigationID=spMitigationID, spImpactPps=spImpactPps, spDetectedCountries=spDetectedCountries, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, dosHostDetectionAlert=dosHostDetectionAlert, spGreTunnelName=spGreTunnelName, spLicenseErrCount=spLicenseErrCount, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, flowUp=flowUp, licenseErrorDone=licenseErrorDone, spInterface=spInterface, collectorUp=collectorUp, spHijackLocal=spHijackLocal, bgpInstability=bgpInstability, spServiceName=spServiceName, spFingerprintName=spFingerprintName, spMitigationStart=spMitigationStart)
