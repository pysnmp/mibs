...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:46:41 2024
...
Counter32, IpAddress, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, iso, ModuleIdentity, Bits, Gauge32, TimeTicks, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "iso", "ModuleIdentity", "Bits", "Gauge32", "TimeTicks", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spReportName=spReportName, collectorUp=collectorUp, spScriptPort=spScriptPort, notificationLimit=notificationLimit, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spDNSObserved=spDNSObserved, spAlertDetectionSignatures=spAlertDetectionSignatures, alertScript=alertScript, spBGPTrapName=spBGPTrapName, spLicenseErrType=spLicenseErrType, spcommFailure=spcommFailure, spVersion=spVersion, spBlackholeCommunity=spBlackholeCommunity, mitigationDone=mitigationDone, spUnit=spUnit, peakflowSPCMI=peakflowSPCMI, bgpHijack=bgpHijack, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spFingerprintMessage=spFingerprintMessage, spBlackholeNexthop=spBlackholeNexthop, managedObjectUsageDone=managedObjectUsageDone, spUsername=spUsername, spThirdPartyAddr=spThirdPartyAddr, routingFailover=routingFailover, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, serviceUsage=serviceUsage, flowUp=flowUp, configChange=configChange, licenseErrorDone=licenseErrorDone, managedObjectUsage=managedObjectUsage, spTMSMultiPrefix=spTMSMultiPrefix, spLicenseErrLimit=spLicenseErrLimit, spInterfaceUsage=spInterfaceUsage, trafficAutoMitigation=trafficAutoMitigation, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintFeedback=spFingerprintFeedback, spFlowspecCommunity=spFlowspecCommunity, spBGPInstability=spBGPInstability, spBlackholePrefix=spBlackholePrefix, spTMSPrefix=spTMSPrefix, spInetAddressType=spInetAddressType, mitigationThirdPartyStart=mitigationThirdPartyStart, PYSNMP_MODULE_ID=peakflowSPMIB, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spScriptHost=spScriptHost, spReportURL=spReportURL, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCommFailureDestination=spCommFailureDestination, collectorDown=collectorDown, spHijackRoute=spHijackRoute, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, spInterfaceIndex=spInterfaceIndex, spThreshold=spThreshold, autoclassifyStart=autoclassifyStart, dnsBaselineDone=dnsBaselineDone, spBlackholeTimeout=spBlackholeTimeout, spHijackAttr=spHijackAttr, spFlowspecTimeout=spFlowspecTimeout, spImpactPps=spImpactPps, spBGPEvent=spBGPEvent, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spServiceElement=spServiceElement, deviceSwapSpace=deviceSwapSpace, dnsBaseline=dnsBaseline, spHijackLocal=spHijackLocal, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spMitigationStart=spMitigationStart, spDNSObservedMax=spDNSObservedMax, mitigationTMSStart=mitigationTMSStart, spHardwareFailureDescription=spHardwareFailureDescription, greDownDone=greDownDone, licenseError=licenseError, spApplicationName=spApplicationName, spLicenseErrDescription=spLicenseErrDescription, bgpInstabilityDone=bgpInstabilityDone, spReportID=spReportID, bgpDown=bgpDown, bgpInstability=bgpInstability, spServiceName=spServiceName, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spFingerprintName=spFingerprintName, spManagedObject=spManagedObject, deviceTotalFlowsHC=deviceTotalFlowsHC, hardwareFailure=hardwareFailure, fingerprintFeedback=fingerprintFeedback, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spUsage=spUsage, spDetector=spDetector, spDetectedCountries=spDetectedCountries, deviceHealth=deviceHealth, spSystemErrorDescription=spSystemErrorDescription, spInterfaceSpeedHC=spInterfaceSpeedHC, collectorStart=collectorStart, spManagedObjects=spManagedObjects, spManagedObjectFamily=spManagedObjectFamily, spCloudSignalFaultDescription=spCloudSignalFaultDescription, flowDown=flowDown, interfaceUsage=interfaceUsage, interfaceUsageDone=interfaceUsageDone, spDNSObservedMean=spDNSObservedMean, fingerprintUsageDone=fingerprintUsageDone, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spTMSCommunity=spTMSCommunity, spCollector=spCollector, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spSystemErrorType=spSystemErrorType, bgpUp=bgpUp, mitigationTMSStartV2=mitigationTMSStartV2, spFingerprintSender=spFingerprintSender, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, deviceSystemError=deviceSystemError, peakflowSPMIB=peakflowSPMIB, mitigationFlowspecStart=mitigationFlowspecStart, dosHostDetectionAlert=dosHostDetectionAlert, spCommFailureDescription=spCommFailureDescription, snmpDown=snmpDown, spLicenseErrCount=spLicenseErrCount, fingerprintReceive=fingerprintReceive, spInterfaceUsageHC=spInterfaceUsageHC, deviceSystemErrorDone=deviceSystemErrorDone, spUsageType=spUsageType, spDNSName=spDNSName, spMitigationName=spMitigationName, spGreTunnelName=spGreTunnelName, spBGPTrapEvent=spBGPTrapEvent, spcommFailureDone=spcommFailureDone, deviceDiskUsage=deviceDiskUsage, snmpUp=snmpUp, fingerprintUsage=fingerprintUsage, cloudSignalingFault=cloudSignalingFault, spRouter=spRouter, spMitigationID=spMitigationID, spInetAddress=spInetAddress, bgpTrap=bgpTrap, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPMgr=peakflowSPMgr, spGreTunnelDestination=spGreTunnelDestination, spTMSTimeout=spTMSTimeout, devicePhysicalMemory=devicePhysicalMemory, deviceTotalFlows=deviceTotalFlows, deviceSwapSpaceUsage=deviceSwapSpaceUsage, spScriptStart=spScriptStart, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, reportDone=reportDone, cloudSignalingFaultDone=cloudSignalingFaultDone, spScriptCommand=spScriptCommand, serviceUsageDone=serviceUsageDone, spInterface=spInterface, spInterfaceSpeed=spInterfaceSpeed, mitigationBlackholeStart=mitigationBlackholeStart, spDuration=spDuration, spDNSExpected=spDNSExpected, spPravail=spPravail, spImpactBps=spImpactBps, peakflowSPTraps=peakflowSPTraps, greDown=greDown, spThirdPartyZone=spThirdPartyZone, spAlertID=spAlertID, hardwareFailureDone=hardwareFailureDone)
