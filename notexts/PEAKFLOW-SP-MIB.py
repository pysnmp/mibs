...
# Produced by pysmi-1.1.8 at Wed Feb  2 19:23:24 2022
...
ModuleIdentity, Unsigned32, ObjectIdentity, Integer32, IpAddress, MibIdentifier, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Bits, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Integer32", "IpAddress", "MibIdentifier", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Bits", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spServiceElement=spServiceElement, managedObjectUsage=managedObjectUsage, spDetectedCountries=spDetectedCountries, spThirdPartyAddr=spThirdPartyAddr, deviceTotalFlowsHC=deviceTotalFlowsHC, spManagedObjectFamily=spManagedObjectFamily, spHijackRoute=spHijackRoute, spDNSObserved=spDNSObserved, spAlertDetectionSignatures=spAlertDetectionSignatures, greDownDone=greDownDone, interfaceUsage=interfaceUsage, deviceTotalFlows=deviceTotalFlows, spDetector=spDetector, spFingerprintFeedback=spFingerprintFeedback, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spLicenseErrDescription=spLicenseErrDescription, spBlackholePrefix=spBlackholePrefix, spBlackholeNexthop=spBlackholeNexthop, spDNSName=spDNSName, spInetAddress=spInetAddress, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, dnsBaseline=dnsBaseline, dnsBaselineDone=dnsBaselineDone, fingerprintReceive=fingerprintReceive, bgpUp=bgpUp, autoclassifyStart=autoclassifyStart, dosHostDetectionAlert=dosHostDetectionAlert, spManagedObjects=spManagedObjects, hardwareFailure=hardwareFailure, spInterfaceSpeedHC=spInterfaceSpeedHC, deviceSystemErrorDone=deviceSystemErrorDone, bgpDown=bgpDown, spImpactBps=spImpactBps, mitigationFlowspecStart=mitigationFlowspecStart, bgpInstability=bgpInstability, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, dosNetworkProfiledAlert=dosNetworkProfiledAlert, cloudSignalingFault=cloudSignalingFault, spAlertID=spAlertID, mitigationThirdPartyStart=mitigationThirdPartyStart, spCollector=spCollector, spDuration=spDuration, spMitigationID=spMitigationID, spSystemErrorType=spSystemErrorType, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spDNSObservedMax=spDNSObservedMax, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, flowDown=flowDown, collectorUp=collectorUp, spInterfaceUsage=spInterfaceUsage, spCommFailureDescription=spCommFailureDescription, deviceHealth=deviceHealth, spUsageType=spUsageType, licenseError=licenseError, mitigationTMSStart=mitigationTMSStart, flowUp=flowUp, spInterface=spInterface, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, bgpTrap=bgpTrap, spBlackholeTimeout=spBlackholeTimeout, spTMSMultiPrefix=spTMSMultiPrefix, hardwareFailureDone=hardwareFailureDone, spInterfaceIndex=spInterfaceIndex, licenseErrorDone=licenseErrorDone, devicePhysicalMemory=devicePhysicalMemory, alertScript=alertScript, spInterfaceSpeed=spInterfaceSpeed, routingFailover=routingFailover, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spServiceName=spServiceName, notificationLimit=notificationLimit, trafficAutoMitigation=trafficAutoMitigation, deviceSwapSpaceInUse=deviceSwapSpaceInUse, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spFingerprintSender=spFingerprintSender, spFingerprintMessage=spFingerprintMessage, peakflowSPTraps=peakflowSPTraps, spcommFailureDone=spcommFailureDone, spThirdPartyZone=spThirdPartyZone, collectorStart=collectorStart, spHijackAttr=spHijackAttr, spReportID=spReportID, spTMSTimeout=spTMSTimeout, deviceSystemError=deviceSystemError, spFlowspecCommunity=spFlowspecCommunity, spDNSExpected=spDNSExpected, spLicenseErrType=spLicenseErrType, spLicenseErrCount=spLicenseErrCount, spScriptHost=spScriptHost, spThreshold=spThreshold, bgpInstabilityDone=bgpInstabilityDone, spFlowspecTimeout=spFlowspecTimeout, spScriptStart=spScriptStart, spVersion=spVersion, spBGPEvent=spBGPEvent, spUsage=spUsage, spUnit=spUnit, fingerprintUsage=fingerprintUsage, spApplicationName=spApplicationName, spGreTunnelName=spGreTunnelName, spMitigationStart=spMitigationStart, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spLicenseErrLimit=spLicenseErrLimit, spFingerprintName=spFingerprintName, serviceUsageDone=serviceUsageDone, spBGPTrapName=spBGPTrapName, mitigationTMSStartV2=mitigationTMSStartV2, spBGPTrapEvent=spBGPTrapEvent, cloudSignalingFaultDone=cloudSignalingFaultDone, spManagedObject=spManagedObject, mitigationDone=mitigationDone, bgpHijack=bgpHijack, spPravail=spPravail, fingerprintUsageDone=fingerprintUsageDone, deviceDiskUsage=deviceDiskUsage, spInetAddressType=spInetAddressType, fingerprintFeedback=fingerprintFeedback, spImpactPps=spImpactPps, spRouter=spRouter, spcommFailure=spcommFailure, spSystemErrorDescription=spSystemErrorDescription, spGreTunnelDestination=spGreTunnelDestination, deviceSwapSpace=deviceSwapSpace, spCommFailureDestination=spCommFailureDestination, peakflowSPMIB=peakflowSPMIB, interfaceUsageDone=interfaceUsageDone, snmpDown=snmpDown, spScriptCommand=spScriptCommand, deviceSwapSpaceUsage=deviceSwapSpaceUsage, mitigationBlackholeStart=mitigationBlackholeStart, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spReportName=spReportName, spBlackholeCommunity=spBlackholeCommunity, spDNSObservedMean=spDNSObservedMean, configChange=configChange, reportDone=reportDone, PYSNMP_MODULE_ID=peakflowSPMIB, spBGPInstability=spBGPInstability, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spTMSPrefix=spTMSPrefix, spUsername=spUsername, spMitigationName=spMitigationName, spBGPTrapPrefix=spBGPTrapPrefix, peakflowSPCMI=peakflowSPCMI, spHijackLocal=spHijackLocal, spReportURL=spReportURL, spInterfaceUsageHC=spInterfaceUsageHC, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPMgr=peakflowSPMgr, spTMSCommunity=spTMSCommunity, serviceUsage=serviceUsage, spCloudSignalFaultDescription=spCloudSignalFaultDescription, spScriptPort=spScriptPort, dosHostDetectionAlertDone=dosHostDetectionAlertDone, snmpUp=snmpUp, collectorDown=collectorDown, managedObjectUsageDone=managedObjectUsageDone, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapNewAttributes=spBGPTrapNewAttributes, greDown=greDown)
