...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:30:54 2023
...
Bits, Counter64, Unsigned32, TimeTicks, Integer32, IpAddress, iso, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "IpAddress", "iso", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spDNSObservedMax=spDNSObservedMax, spTMSPrefix=spTMSPrefix, spDNSObserved=spDNSObserved, collectorUp=collectorUp, spTMSCommunity=spTMSCommunity, fingerprintFeedback=fingerprintFeedback, dosHostDetectionAlert=dosHostDetectionAlert, serviceUsage=serviceUsage, spInterface=spInterface, spBGPTrapPrefix=spBGPTrapPrefix, spHijackLocal=spHijackLocal, spThreshold=spThreshold, spCloudSignalFaultDescription=spCloudSignalFaultDescription, mitigationTMSStartV2=mitigationTMSStartV2, spUsageType=spUsageType, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spManagedObject=spManagedObject, spDNSExpected=spDNSExpected, spUnit=spUnit, spBlackholeCommunity=spBlackholeCommunity, greDownDone=greDownDone, spTMSTimeout=spTMSTimeout, spCommFailureDescription=spCommFailureDescription, managedObjectUsageDone=managedObjectUsageDone, mitigationDone=mitigationDone, spInterfaceIndex=spInterfaceIndex, spManagedObjectFamily=spManagedObjectFamily, snmpDown=snmpDown, peakflowSPMIB=peakflowSPMIB, spInterfaceUsage=spInterfaceUsage, spLicenseErrCount=spLicenseErrCount, spInetAddress=spInetAddress, spMitigationName=spMitigationName, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, deviceSwapSpace=deviceSwapSpace, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spUsage=spUsage, spCollector=spCollector, bgpInstabilityDone=bgpInstabilityDone, spFingerprintName=spFingerprintName, spLicenseErrLimit=spLicenseErrLimit, devicePhysicalMemory=devicePhysicalMemory, spDetectedCountries=spDetectedCountries, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spInterfaceUsageHC=spInterfaceUsageHC, alertScript=alertScript, spLicenseErrType=spLicenseErrType, spDNSName=spDNSName, fingerprintUsageDone=fingerprintUsageDone, bgpTrap=bgpTrap, licenseErrorDone=licenseErrorDone, spBlackholePrefix=spBlackholePrefix, bgpUp=bgpUp, spcommFailureDone=spcommFailureDone, dnsBaselineDone=dnsBaselineDone, mitigationTMSStart=mitigationTMSStart, snmpUp=snmpUp, spVersion=spVersion, spScriptCommand=spScriptCommand, spHijackRoute=spHijackRoute, dnsBaseline=dnsBaseline, interfaceUsage=interfaceUsage, spMitigationID=spMitigationID, spCommFailureDestination=spCommFailureDestination, spSystemErrorDescription=spSystemErrorDescription, spRouter=spRouter, spBGPTrapName=spBGPTrapName, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, notificationLimit=notificationLimit, hardwareFailureDone=hardwareFailureDone, managedObjectUsage=managedObjectUsage, spLicenseErrDescription=spLicenseErrDescription, spAlertDetectionSignatures=spAlertDetectionSignatures, spFlowspecTimeout=spFlowspecTimeout, fingerprintUsage=fingerprintUsage, deviceTotalFlowsHC=deviceTotalFlowsHC, spMitigationStart=spMitigationStart, spScriptStart=spScriptStart, flowDown=flowDown, mitigationFlowspecStart=mitigationFlowspecStart, deviceSystemError=deviceSystemError, peakflowSPCMI=peakflowSPCMI, deviceHealth=deviceHealth, peakflowSPTraps=peakflowSPTraps, interfaceUsageDone=interfaceUsageDone, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, bgpHijack=bgpHijack, spThirdPartyAddr=spThirdPartyAddr, routingFailover=routingFailover, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spServiceName=spServiceName, spImpactPps=spImpactPps, spApplicationName=spApplicationName, spHijackAttr=spHijackAttr, spBGPEvent=spBGPEvent, autoclassifyStart=autoclassifyStart, spManagedObjects=spManagedObjects, spInterfaceSpeed=spInterfaceSpeed, spDuration=spDuration, mitigationBlackholeStart=mitigationBlackholeStart, flowUp=flowUp, bgpInstability=bgpInstability, mitigationThirdPartyStart=mitigationThirdPartyStart, cloudSignalingFault=cloudSignalingFault, deviceSystemErrorDone=deviceSystemErrorDone, spcommFailure=spcommFailure, deviceSwapSpaceUsage=deviceSwapSpaceUsage, serviceUsageDone=serviceUsageDone, spBGPInstability=spBGPInstability, spInetAddressType=spInetAddressType, deviceDiskUsage=deviceDiskUsage, trafficAutoMitigation=trafficAutoMitigation, spScriptPort=spScriptPort, spFlowspecCommunity=spFlowspecCommunity, fingerprintReceive=fingerprintReceive, spSystemErrorType=spSystemErrorType, collectorDown=collectorDown, spDNSObservedMean=spDNSObservedMean, spHardwareFailureDescription=spHardwareFailureDescription, peakflowSPMgr=peakflowSPMgr, spGreTunnelDestination=spGreTunnelDestination, spImpactBps=spImpactBps, reportDone=reportDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, deviceTotalFlows=deviceTotalFlows, spBlackholeTimeout=spBlackholeTimeout, spFingerprintSender=spFingerprintSender, spReportURL=spReportURL, spTMSMultiPrefix=spTMSMultiPrefix, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spDetector=spDetector, spBGPTrapNewAttributes=spBGPTrapNewAttributes, PYSNMP_MODULE_ID=peakflowSPMIB, spFingerprintMessage=spFingerprintMessage, licenseError=licenseError, spPravail=spPravail, spThirdPartyZone=spThirdPartyZone, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, bgpDown=bgpDown, spScriptHost=spScriptHost, spReportID=spReportID, spFingerprintFeedback=spFingerprintFeedback, spAlertID=spAlertID, dosNetworkProfiledAlert=dosNetworkProfiledAlert, collectorStart=collectorStart, spBGPTrapEvent=spBGPTrapEvent, spServiceElement=spServiceElement, cloudSignalingFaultDone=cloudSignalingFaultDone, spBlackholeNexthop=spBlackholeNexthop, spUsername=spUsername, spGreTunnelName=spGreTunnelName, configChange=configChange, greDown=greDown, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spReportName=spReportName, hardwareFailure=hardwareFailure)
