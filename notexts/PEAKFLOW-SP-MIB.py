...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:32:03 2023
...
TimeTicks, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, MibIdentifier, ModuleIdentity, Counter32, ObjectIdentity, Counter64, IpAddress, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "IpAddress", "Bits", "Integer32")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", spManagedObjects=spManagedObjects, spReportName=spReportName, spReportID=spReportID, spDNSObservedMean=spDNSObservedMean, mitigationTMSStart=mitigationTMSStart, spPravail=spPravail, interfaceUsageDone=interfaceUsageDone, spMitigationID=spMitigationID, bgpHijack=bgpHijack, spThreshold=spThreshold, spManagedObjectFamily=spManagedObjectFamily, spImpactPps=spImpactPps, deviceSystemError=deviceSystemError, spAlertDetectionSignatures=spAlertDetectionSignatures, flowUp=flowUp, collectorDown=collectorDown, spMitigationStart=spMitigationStart, spUsage=spUsage, peakflowSPCMI=peakflowSPCMI, spInterfaceSpeed=spInterfaceSpeed, spDNSName=spDNSName, spInterfaceIndex=spInterfaceIndex, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, spGreTunnelName=spGreTunnelName, spDNSObservedMax=spDNSObservedMax, spBGPInstability=spBGPInstability, dnsBaselineDone=dnsBaselineDone, cloudSignalingFault=cloudSignalingFault, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spDuration=spDuration, spLicenseErrType=spLicenseErrType, bgpDown=bgpDown, spManagedObject=spManagedObject, serviceUsageDone=serviceUsageDone, spRouter=spRouter, spApplicationName=spApplicationName, spDetectedCountries=spDetectedCountries, spSystemErrorDescription=spSystemErrorDescription, licenseError=licenseError, spcommFailureDone=spcommFailureDone, spUnit=spUnit, spHijackLocal=spHijackLocal, spDetector=spDetector, hardwareFailure=hardwareFailure, spGreTunnelDestination=spGreTunnelDestination, spInterfaceUsage=spInterfaceUsage, bgpTrap=bgpTrap, autoclassifyStart=autoclassifyStart, spReportURL=spReportURL, spBlackholePrefix=spBlackholePrefix, serviceUsage=serviceUsage, spLicenseErrCount=spLicenseErrCount, deviceSwapSpaceUsage=deviceSwapSpaceUsage, bgpUp=bgpUp, spAlertID=spAlertID, fingerprintUsage=fingerprintUsage, spInterface=spInterface, spCloudSignalFaultDescription=spCloudSignalFaultDescription, managedObjectUsage=managedObjectUsage, spFingerprintFeedback=spFingerprintFeedback, dnsBaseline=dnsBaseline, hardwareFailureDone=hardwareFailureDone, licenseErrorDone=licenseErrorDone, snmpDown=snmpDown, spFlowspecTimeout=spFlowspecTimeout, peakflowSPMgr=peakflowSPMgr, peakflowSPMIB=peakflowSPMIB, spTMSTimeout=spTMSTimeout, deviceHealth=deviceHealth, alertScript=alertScript, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spUsername=spUsername, spHijackAttr=spHijackAttr, spVersion=spVersion, spScriptPort=spScriptPort, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, spTMSCommunity=spTMSCommunity, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, managedObjectUsageDone=managedObjectUsageDone, spScriptHost=spScriptHost, spTMSPrefix=spTMSPrefix, spCommFailureDestination=spCommFailureDestination, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spFingerprintSender=spFingerprintSender, bgpInstabilityDone=bgpInstabilityDone, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, mitigationFlowspecStart=mitigationFlowspecStart, collectorStart=collectorStart, spThirdPartyAddr=spThirdPartyAddr, snmpUp=snmpUp, deviceTotalFlowsHC=deviceTotalFlowsHC, routingFailover=routingFailover, dosHostDetectionAlertDone=dosHostDetectionAlertDone, fingerprintUsageDone=fingerprintUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, deviceSystemErrorDone=deviceSystemErrorDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, spLicenseErrLimit=spLicenseErrLimit, deviceTotalFlows=deviceTotalFlows, spBlackholeNexthop=spBlackholeNexthop, fingerprintFeedback=fingerprintFeedback, mitigationTMSStartV2=mitigationTMSStartV2, interfaceUsage=interfaceUsage, peakflowSPTraps=peakflowSPTraps, spInterfaceUsageHC=spInterfaceUsageHC, greDown=greDown, spSystemErrorType=spSystemErrorType, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, fingerprintReceive=fingerprintReceive, mitigationThirdPartyStart=mitigationThirdPartyStart, trafficAutoMitigation=trafficAutoMitigation, spServiceElement=spServiceElement, spHardwareFailureDescription=spHardwareFailureDescription, spInetAddressType=spInetAddressType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spImpactBps=spImpactBps, greDownDone=greDownDone, devicePhysicalMemory=devicePhysicalMemory, spBGPEvent=spBGPEvent, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spCommFailureDescription=spCommFailureDescription, deviceDiskUsage=deviceDiskUsage, spCollector=spCollector, spThirdPartyZone=spThirdPartyZone, spBGPTrapEvent=spBGPTrapEvent, spHijackRoute=spHijackRoute, spFingerprintName=spFingerprintName, spScriptStart=spScriptStart, deviceSwapSpace=deviceSwapSpace, mitigationBlackholeStart=mitigationBlackholeStart, PYSNMP_MODULE_ID=peakflowSPMIB, spUsageType=spUsageType, cloudSignalingFaultDone=cloudSignalingFaultDone, spcommFailure=spcommFailure, dosNetworkProfiledAlert=dosNetworkProfiledAlert, spServiceName=spServiceName, spFlowspecCommunity=spFlowspecCommunity, spInetAddress=spInetAddress, spMitigationName=spMitigationName, bgpInstability=bgpInstability, spBlackholeTimeout=spBlackholeTimeout, dosHostDetectionAlert=dosHostDetectionAlert, flowDown=flowDown, configChange=configChange, notificationLimit=notificationLimit, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spBGPTrapName=spBGPTrapName, spDNSExpected=spDNSExpected, spBGPTrapPrefix=spBGPTrapPrefix, mitigationDone=mitigationDone, collectorUp=collectorUp, reportDone=reportDone, spInterfaceSpeedHC=spInterfaceSpeedHC, spBlackholeCommunity=spBlackholeCommunity, spDNSObserved=spDNSObserved, spLicenseErrDescription=spLicenseErrDescription, spFingerprintMessage=spFingerprintMessage, spScriptCommand=spScriptCommand)
