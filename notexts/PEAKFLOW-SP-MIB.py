...
# Produced by pysmi-1.1.12 at Wed May 29 07:13:57 2024
...
ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, Integer32, Counter32, Gauge32, NotificationType, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "Integer32", "Counter32", "Gauge32", "NotificationType", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("PEAKFLOW-SP-MIB", bgpTrap=bgpTrap, spTMSPrefix=spTMSPrefix, hardwareFailureDone=hardwareFailureDone, routingFailoverInterfaceDownAlert=routingFailoverInterfaceDownAlert, dosNetworkProfiledAlertDone=dosNetworkProfiledAlertDone, spLicenseErrCount=spLicenseErrCount, spTMSMultiDiversionPrefix=spTMSMultiDiversionPrefix, bgpDown=bgpDown, spApplicationName=spApplicationName, spBlackholeNexthop=spBlackholeNexthop, autoclassifyStart=autoclassifyStart, spCollector=spCollector, reportDone=reportDone, routingFailover=routingFailover, spFingerprintMessage=spFingerprintMessage, spUnit=spUnit, fingerprintUsage=fingerprintUsage, serviceUsageDone=serviceUsageDone, spRoutingFailoverInterfaces=spRoutingFailoverInterfaces, spThreshold=spThreshold, spGreTunnelName=spGreTunnelName, spInterfaceSpeedHC=spInterfaceSpeedHC, spVersion=spVersion, deviceSwapSpaceUsage=deviceSwapSpaceUsage, managedObjectUsage=managedObjectUsage, spTMSCommunity=spTMSCommunity, mitigationFlowspecStart=mitigationFlowspecStart, deviceSystemErrorDone=deviceSystemErrorDone, spBGPTrapName=spBGPTrapName, spMitigationName=spMitigationName, spFlowspecCommunity=spFlowspecCommunity, dosHostDetectionAlertDone=dosHostDetectionAlertDone, spHijackAttr=spHijackAttr, spScriptPort=spScriptPort, spUsername=spUsername, spAlertDetectionSignatures=spAlertDetectionSignatures, spBGPTrapPrefix=spBGPTrapPrefix, cloudSignalingMitigationRequest=cloudSignalingMitigationRequest, spBlackholeCommunity=spBlackholeCommunity, spCloudSignalFaultDescription=spCloudSignalFaultDescription, deviceTotalFlowsHC=deviceTotalFlowsHC, spInterfaceIndex=spInterfaceIndex, spHijackLocal=spHijackLocal, alertScript=alertScript, spGreTunnelDestination=spGreTunnelDestination, trafficAutoMitigation=trafficAutoMitigation, peakflowSPMgr=peakflowSPMgr, greDown=greDown, spScriptCommand=spScriptCommand, spMitigationStart=spMitigationStart, spDNSObserved=spDNSObserved, configChange=configChange, spCommFailureDestination=spCommFailureDestination, spDetector=spDetector, mitigationTMSStart=mitigationTMSStart, spFingerprintName=spFingerprintName, fingerprintReceive=fingerprintReceive, spBlackholeTimeout=spBlackholeTimeout, spBGPTrapEvent=spBGPTrapEvent, spTMSTimeout=spTMSTimeout, spMitigationID=spMitigationID, snmpUp=snmpUp, spHijackRoute=spHijackRoute, deviceDiskUsage=deviceDiskUsage, spBGPTrapNewAttributes=spBGPTrapNewAttributes, spBlackholePrefix=spBlackholePrefix, spThirdPartyAddr=spThirdPartyAddr, devicePhysicalMemory=devicePhysicalMemory, spBGPEvent=spBGPEvent, spInterface=spInterface, spServiceElement=spServiceElement, deviceSwapSpace=deviceSwapSpace, spCommFailureDescription=spCommFailureDescription, spInetAddress=spInetAddress, spRouter=spRouter, spImpactBps=spImpactBps, devicePhysicalMemoryUsage=devicePhysicalMemoryUsage, spScriptStart=spScriptStart, spUsageType=spUsageType, fingerprintFeedback=fingerprintFeedback, spUsage=spUsage, spDuration=spDuration, bgpInstabilityDone=bgpInstabilityDone, spDNSExpected=spDNSExpected, spManagedObjects=spManagedObjects, collectorUp=collectorUp, spReportURL=spReportURL, deviceSystemError=deviceSystemError, interfaceUsageDone=interfaceUsageDone, bgpHijack=bgpHijack, managedObjectUsageDone=managedObjectUsageDone, cloudSignalingFault=cloudSignalingFault, peakflowSPCMI=peakflowSPCMI, spFlowspecTimeout=spFlowspecTimeout, spInterfaceUsageHC=spInterfaceUsageHC, peakflowSPTrapsEnumerate=peakflowSPTrapsEnumerate, spDNSName=spDNSName, peakflowSPTraps=peakflowSPTraps, interfaceUsage=interfaceUsage, spInetAddressType=spInetAddressType, flowUp=flowUp, dnsBaseline=dnsBaseline, spBGPTrapOldAttributes=spBGPTrapOldAttributes, spSystemErrorDescription=spSystemErrorDescription, spImpactPps=spImpactPps, spLicenseErrDescription=spLicenseErrDescription, deviceSwapSpaceInUse=deviceSwapSpaceInUse, spManagedObject=spManagedObject, spLicenseErrType=spLicenseErrType, deviceCpuLoadAvg1min=deviceCpuLoadAvg1min, deviceHealth=deviceHealth, collectorStart=collectorStart, spFingerprintSender=spFingerprintSender, spPravail=spPravail, flowDown=flowDown, spServiceName=spServiceName, spAlertID=spAlertID, spTMSMultiPrefix=spTMSMultiPrefix, peakflowSPMIB=peakflowSPMIB, bgpUp=bgpUp, spReportName=spReportName, greDownDone=greDownDone, spDNSObservedMax=spDNSObservedMax, fingerprintUsageDone=fingerprintUsageDone, hardwareFailure=hardwareFailure, serviceUsage=serviceUsage, dosNetworkProfiledAlert=dosNetworkProfiledAlert, mitigationThirdPartyStart=mitigationThirdPartyStart, spThirdPartyZone=spThirdPartyZone, spDNSObservedMean=spDNSObservedMean, licenseError=licenseError, spInterfaceSpeed=spInterfaceSpeed, PYSNMP_MODULE_ID=peakflowSPMIB, spHardwareFailureDescription=spHardwareFailureDescription, dnsBaselineDone=dnsBaselineDone, bgpInstability=bgpInstability, notificationLimit=notificationLimit, spScriptHost=spScriptHost, dosHostDetectionAlert=dosHostDetectionAlert, snmpDown=snmpDown, spcommFailure=spcommFailure, spDetectedCountries=spDetectedCountries, spInterfaceUsage=spInterfaceUsage, collectorDown=collectorDown, licenseErrorDone=licenseErrorDone, deviceCpuLoadAvg15min=deviceCpuLoadAvg15min, mitigationDone=mitigationDone, spcommFailureDone=spcommFailureDone, deviceCpuLoadAvg5min=deviceCpuLoadAvg5min, spBGPInstability=spBGPInstability, spLicenseErrLimit=spLicenseErrLimit, mitigationBlackholeStart=mitigationBlackholeStart, spReportID=spReportID, deviceTotalFlows=deviceTotalFlows, cloudSignalingFaultDone=cloudSignalingFaultDone, spFingerprintFeedback=spFingerprintFeedback, devicePhysicalMemoryInUse=devicePhysicalMemoryInUse, routingFailoverInterfaceDownAlertDone=routingFailoverInterfaceDownAlertDone, spManagedObjectFamily=spManagedObjectFamily, mitigationTMSStartV2=mitigationTMSStartV2, spSystemErrorType=spSystemErrorType)
