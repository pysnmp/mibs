...
mibBuilder.exportSymbols("RAY3-MIB", tr3EventAirCapacity=tr3EventAirCapacity, alarmVoltageHigh=alarmVoltageHigh, station=station, rss=rss, alarmNetBitrate=alarmNetBitrate, ray3Traps=ray3Traps, alarmVoltageLow=alarmVoltageLow, rfPowerCurrent=rfPowerCurrent, linkUptime=linkUptime, temperatureModem=temperatureModem, channelArrangement=channelArrangement, AlarmState=AlarmState, swVer=swVer, timeAllConnect=timeAllConnect, eth2InThroughput=eth2InThroughput, useCpu=useCpu, rxChannel=rxChannel, racom=racom, alarmPeerDisconnected=alarmPeerDisconnected, lineStatusII=lineStatusII, tr3Eth1LinkDown=tr3Eth1LinkDown, ifEthEntry=ifEthEntry, tr3BerAlarm=tr3BerAlarm, ServiceState=ServiceState, rxFreq=rxFreq, sshd=sshd, speedGuard=speedGuard, ray3=ray3, txBandwidthKHz=txBandwidthKHz, access=access, matching=matching, statistic=statistic, ip=ip, alarmTemperature=alarmTemperature, ber=ber, txChannel=txChannel, serialNumber=serialNumber, alarmWifiOn=alarmWifiOn, timeMaxDisconnect=timeMaxDisconnect, timeAllDisconnect=timeAllDisconnect, ray3TrapsPrefix=ray3TrapsPrefix, temperatureRadio=temperatureRadio, httpd=httpd, telnetd=telnetd, ethernet=ethernet, tr3NetBitrate=tr3NetBitrate, voltageSource=voltageSource, alarmRss=alarmRss, ethOutThroughput=ethOutThroughput, mdix=mdix, duplex=duplex, radio=radio, tr3VoltageLowAlarm=tr3VoltageLowAlarm, ifEth=ifEth, Tenths=Tenths, frequencyTable=frequencyTable, flowControl=flowControl, tr3WifiOn=tr3WifiOn, eth2Link=eth2Link, product=product, txFreq=txFreq, eth2OutThroughput=eth2OutThroughput, tr3AirConnect=tr3AirConnect, managementVlan=managementVlan, egressQueue=egressQueue, alarm=alarm, swVerRadio=swVerRadio, PYSNMP_MODULE_ID=racom, status=status, systemStatus=systemStatus, alarmMse=alarmMse, PhysAddressRaw=PhysAddressRaw, info=info, alarmBer=alarmBer, rxBandwidthKHz=rxBandwidthKHz, eth1Link=eth1Link, autonego=autonego, ethInThroughput=ethInThroughput, rxModulation=rxModulation, alarmEth1Down=alarmEth1Down, acm=acm, wifiHAP=wifiHAP, OptionSetting=OptionSetting, system=system, voltageUnit=voltageUnit, atpc=atpc, tr3TemperatureAlarm=tr3TemperatureAlarm, maxNetBitrate=maxNetBitrate, securePeerMode=securePeerMode, deviceName=deviceName, Hundredths=Hundredths, mac=mac, numDisconnect=numDisconnect, chassis=chassis, rfPowerConfigured=rfPowerConfigured, unitType=unitType, rxModulationIndex=rxModulationIndex, tr3Eth21LinkDown=tr3Eth21LinkDown, peerNumber=peerNumber, Thousandths=Thousandths, useLogStorage=useLogStorage, mse=mse, ifEthTable=ifEthTable, speed=speed, alarmEth2Down=alarmEth2Down, tr3VoltageHighAlarm=tr3VoltageHighAlarm, txModulation=txModulation, txModulationIndex=txModulationIndex, switch=switch, tr3RssAlarm=tr3RssAlarm, useMemory=useMemory, ifRadio=ifRadio, tr3MseAlarm=tr3MseAlarm, interface=interface, DisplayStringRaw=DisplayStringRaw, productName=productName, netBitrate=netBitrate, reliability=reliability, ModulationList=ModulationList, tr3AirDisconnect=tr3AirDisconnect, managementVlanId=managementVlanId)
