...
mibBuilder.exportSymbols("MPLS-LSR-STD-MIB", mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInterfacePerfOutFragmentedPkts=mplsInterfacePerfOutFragmentedPkts, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsPerfGroup=mplsPerfGroup, mplsLsrModuleReadOnlyCompliance=mplsLsrModuleReadOnlyCompliance, mplsInSegmentPerfDiscards=mplsInSegmentPerfDiscards, mplsOutSegmentPerfPackets=mplsOutSegmentPerfPackets, mplsInSegmentPerfPackets=mplsInSegmentPerfPackets, mplsInterfaceEntry=mplsInterfaceEntry, mplsXCTable=mplsXCTable, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentMapEntry=mplsInSegmentMapEntry, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsLsrStdMIB=mplsLsrStdMIB, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsLabelStackTable=mplsLabelStackTable, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentPerfHCOctets=mplsOutSegmentPerfHCOctets, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsLsrObjects=mplsLsrObjects, mplsInSegmentMapTable=mplsInSegmentMapTable, mplsInSegmentIndexNext=mplsInSegmentIndexNext, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentNextHopAddrType=mplsOutSegmentNextHopAddrType, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfacePerfInLabelsInUse=mplsInterfacePerfInLabelsInUse, mplsOutSegmentPerfDiscards=mplsOutSegmentPerfDiscards, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsXCOperStatus=mplsXCOperStatus, mplsXCOutSegmentIndex=mplsXCOutSegmentIndex, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentPerfOctets=mplsInSegmentPerfOctets, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsXCGroup=mplsXCGroup, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLabelStackLabelPtr=mplsLabelStackLabelPtr, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentPerfHCOctets=mplsInSegmentPerfHCOctets, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentNextHopAddr=mplsOutSegmentNextHopAddr, mplsXCNotificationsEnable=mplsXCNotificationsEnable, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentLabelPtr=mplsInSegmentLabelPtr, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCIndex=mplsXCIndex, mplsInSegmentInterface=mplsInSegmentInterface, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfaceIndex=mplsInterfaceIndex, mplsInterfacePerfInLabelLookupFailures=mplsInterfacePerfInLabelLookupFailures, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentPerfErrors=mplsOutSegmentPerfErrors, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsLsrNotifications=mplsLsrNotifications, PYSNMP_MODULE_ID=mplsLsrStdMIB, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, MplsIndexType=MplsIndexType, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLabelStackEntry=mplsLabelStackEntry, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentMapLabel=mplsInSegmentMapLabel, mplsInSegmentNPop=mplsInSegmentNPop, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentIndex=mplsInSegmentIndex, mplsInSegmentMapLabelPtrIndex=mplsInSegmentMapLabelPtrIndex, mplsXCLspId=mplsXCLspId, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentMapInterface=mplsInSegmentMapInterface, mplsInterfacePerfOutLabelsInUse=mplsInterfacePerfOutLabelsInUse, mplsInSegmentMapIndex=mplsInSegmentMapIndex, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentPerfOctets=mplsOutSegmentPerfOctets, mplsLsrModuleFullCompliance=mplsLsrModuleFullCompliance, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentTopLabelPtr=mplsOutSegmentTopLabelPtr, mplsLsrGroups=mplsLsrGroups, mplsInterfaceTable=mplsInterfaceTable, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentPerfErrors=mplsInSegmentPerfErrors, mplsXCOwner=mplsXCOwner, mplsOutSegmentInterface=mplsOutSegmentInterface, mplsXCUp=mplsXCUp, mplsXCEntry=mplsXCEntry, mplsXCInSegmentIndex=mplsXCInSegmentIndex, mplsXCStorageType=mplsXCStorageType, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentIndex=mplsOutSegmentIndex, MplsIndexNextType=MplsIndexNextType, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCDown=mplsXCDown)
