...
# ASN.1 source CTRON-COMMON-MIB
# Source digest sha256:b07a85df4e7ebc0ba9ddebedf73e55a86d65383acbc433d012f17741eafe017c
...
fnbTRTable = MibTable((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: fnbTRTable.setStatus('mandatory')
fnbTREntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-COMMON-MIB", "fnbTRIndex"))
...
fnbCSMACDTable = MibTable((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: fnbCSMACDTable.setStatus('mandatory')
fnbCSMACDEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-COMMON-MIB", "fnbCSMACDIndex"))
...
fnbPortConnectTable = MibTable((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 3, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: fnbPortConnectTable.setStatus('mandatory')
fnbPortConnectEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 2, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-COMMON-MIB", "fnbPortConnectBoardIndex"), (0, "CTRON-COMMON-MIB", "fnbPortConnectPortIndex"))
...
powerTable = MibTable((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 4, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: powerTable.setStatus('mandatory')
powerEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 1, 6, 1, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-COMMON-MIB", "powerSupplyNum"))
...
fPRedundAddrTable = MibTable((1, 3, 6, 1, 4, 1, 52, 1, 6, 2, 10, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: fPRedundAddrTable.setStatus('mandatory')
fPRedundAddrEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 1, 6, 2, 10, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTRON-COMMON-MIB", "fPRedundAddrId"))
...
mibBuilder.exportSymbols("CTRON-COMMON-MIB", chassis=chassis, chassisAlarmEna=chassisAlarmEna, chassisAlarmState=chassisAlarmState, chassisFNB=chassisFNB, chassisHWRev=chassisHWRev, chassisSlots=chassisSlots, chassisType=chassisType, deviceDate=deviceDate, deviceIPAddress=deviceIPAddress, deviceName=deviceName, deviceTime=deviceTime, deviceType=deviceType, dlBootRev=dlBootRev, dlCommitRAMToFlash=dlCommitRAMToFlash, dlErrorString=dlErrorString, dlFileName=dlFileName, dlFirmwareBase=dlFirmwareBase, dlFirmwareStart=dlFirmwareStart, dlFirmwareTop=dlFirmwareTop, dlFlashCount=dlFlashCount, dlFlashSize=dlFlashSize, dlForceBootp=dlForceBootp, dlForceOnBoot=dlForceOnBoot, dlInitiateColdBoot=dlInitiateColdBoot, dlLastImageFilename=dlLastImageFilename, dlLastServerIPAddress=dlLastServerIPAddress, dlNetAddress=dlNetAddress, dlOnLineDownLoad=dlOnLineDownLoad, dlOperStatus=dlOperStatus, dlServerName=dlServerName, dlTFTPRequest=dlTFTPRequest, dlTFTPRequestHost=dlTFTPRequestHost, dlTftpServerGatewayIPAddress=dlTftpServerGatewayIPAddress, eMME=eMME, eMMEBoardMap=eMMEBoardMap, eMMEFWRev=eMMEFWRev, eMMEHWAddress=eMMEHWAddress, eMMEHWRev=eMMEHWRev, environment=environment, fPRedund=fPRedund, fPRedundActivePort=fPRedundActivePort, fPRedundAddAddr=fPRedundAddAddr, fPRedundAddrEntry=fPRedundAddrEntry, fPRedundAddrIPAddr=fPRedundAddrIPAddr, fPRedundAddrId=fPRedundAddrId, fPRedundAddrTable=fPRedundAddrTable, fPRedundDelAddr=fPRedundDelAddr, fPRedundEnable=fPRedundEnable, fPRedundNumAddr=fPRedundNumAddr, fPRedundPollInterval=fPRedundPollInterval, fPRedundReset=fPRedundReset, fPRedundRetrys=fPRedundRetrys, fPRedundancy=fPRedundancy, fnb2=fnb2, fnbBypass=fnbBypass, fnbCSMACD=fnbCSMACD, fnbCSMACDEntry=fnbCSMACDEntry, fnbCSMACDIndex=fnbCSMACDIndex, fnbCSMACDTable=fnbCSMACDTable, fnbConnect=fnbConnect, fnbConnectLeft=fnbConnectLeft, fnbConnectRight=fnbConnectRight, fnbPortChanges=fnbPortChanges, fnbPortConnect=fnbPortConnect, fnbPortConnectBoardIndex=fnbPortConnectBoardIndex, fnbPortConnectCompID=fnbPortConnectCompID, fnbPortConnectEntry=fnbPortConnectEntry, fnbPortConnectPortAssignment=fnbPortConnectPortAssignment, fnbPortConnectPortIndex=fnbPortConnectPortIndex, fnbPortConnectTable=fnbPortConnectTable, fnbPortConnectionChanges=fnbPortConnectionChanges, fnbRPBypass=fnbRPBypass, fnbTR=fnbTR, fnbTREntry=fnbTREntry, fnbTRIndex=fnbTRIndex, fnbTRTable=fnbTRTable, iRM3=iRM3, iRM3BPSupport=iRM3BPSupport, iRM3FWRev=iRM3FWRev, iRM3HWAddress=iRM3HWAddress, iRM3HWRev=iRM3HWRev, iRM3PortAssoc=iRM3PortAssoc, mRXI=mRXI, mRXIFWRev=mRXIFWRev, mRXIHWAddress=mRXIHWAddress, mRXIHWRev=mRXIHWRev, nB55=nB55, nB55FWRev=nB55FWRev, nB55HWAddress=nB55HWAddress, nB55HWRev=nB55HWRev, powerEntry=powerEntry, powerSupplyId=powerSupplyId, powerSupplyNum=powerSupplyNum, powerSupplyRedun=powerSupplyRedun, powerSupplyRemoteDisable=powerSupplyRemoteDisable, powerSupplyState=powerSupplyState, powerTable=powerTable, tRMM=tRMM, tRMMFWRev=tRMMFWRev, tRMMHWAddress=tRMMHWAddress, tRMMHWRev=tRMMHWRev, upsACLineVoltsIn=upsACLineVoltsIn, upsBatteryCapacity=upsBatteryCapacity, upsBatteryVoltsOut=upsBatteryVoltsOut, upsDisable=upsDisable, upsDisconnect=upsDisconnect, upsID=upsID, upsRevision=upsRevision, upsTest=upsTest, upsUpTime=upsUpTime, upsVersion=upsVersion)
