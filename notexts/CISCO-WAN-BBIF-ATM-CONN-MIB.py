...
# ASN.1 source CISCO-WAN-BBIF-ATM-CONN-MIB
# Source digest sha256:de41c819eaf5c2590baa8e78e4b3b144c1f8b51664b28285c59ed2b37d04c59a
...
if mibBuilder.loadTexts: ciscoWanBbifAtmConnMIB.setLastUpdated('2002-09-09 00:00')
...
bbChanCnfGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 2, 7, 1, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: bbChanCnfGrpTable.setStatus('current')
bbChanCnfGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 2, 7, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-BBIF-ATM-CONN-MIB", "bbChanCnfNum"))
...
bbChanStateGrpTable = MibTable((1, 3, 6, 1, 4, 1, 351, 110, 5, 2, 7, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: bbChanStateGrpTable.setStatus('current')
bbChanStateGrpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 351, 110, 5, 2, 7, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CISCO-WAN-BBIF-ATM-CONN-MIB", "bbChanStateNum"))
...
mibBuilder.exportSymbols("CISCO-WAN-BBIF-ATM-CONN-MIB", IfNsapAddress=IfNsapAddress, PYSNMP_MODULE_ID=ciscoWanBbifAtmConnMIB, bbChanClpHiThreshold=bbChanClpHiThreshold, bbChanClpLoThreshold=bbChanClpLoThreshold, bbChanCnfGrpEntry=bbChanCnfGrpEntry, bbChanCnfGrpTable=bbChanCnfGrpTable, bbChanCnfNum=bbChanCnfNum, bbChanCongstUpdateCode=bbChanCongstUpdateCode, bbChanConnDesc=bbChanConnDesc, bbChanConnType=bbChanConnType, bbChanDiscardOption=bbChanDiscardOption, bbChanEfciThreshold=bbChanEfciThreshold, bbChanEgrPercentUtil=bbChanEgrPercentUtil, bbChanEgrSrvRate=bbChanEgrSrvRate, bbChanEgrXmtState=bbChanEgrXmtState, bbChanFrmDiscardThreshold=bbChanFrmDiscardThreshold, bbChanGcra1Action=bbChanGcra1Action, bbChanGcra2Action=bbChanGcra2Action, bbChanIfNum=bbChanIfNum, bbChanIngrPercentUtil=bbChanIngrPercentUtil, bbChanIngrRcvState=bbChanIngrRcvState, bbChanLocalNsapAddr=bbChanLocalNsapAddr, bbChanLocalVci=bbChanLocalVci, bbChanLocalVpi=bbChanLocalVpi, bbChanMaster=bbChanMaster, bbChanMaxCellMemThreshold=bbChanMaxCellMemThreshold, bbChanMaxCost=bbChanMaxCost, bbChanNumNextAvailable=bbChanNumNextAvailable, bbChanOvrSubOvrRide=bbChanOvrSubOvrRide, bbChanRemoteNsapAddr=bbChanRemoteNsapAddr, bbChanRemoteVci=bbChanRemoteVci, bbChanRemoteVpi=bbChanRemoteVpi, bbChanRestrictTrkType=bbChanRestrictTrkType, bbChanRowStatus=bbChanRowStatus, bbChanRtePriority=bbChanRtePriority, bbChanServiceType=bbChanServiceType, bbChanState=bbChanState, bbChanStateGrpEntry=bbChanStateGrpEntry, bbChanStateGrpTable=bbChanStateGrpTable, bbChanStateNum=bbChanStateNum, bbChanSvcConnId=bbChanSvcConnId, bbChanSvcFlag=bbChanSvcFlag, bbChanTestResult=bbChanTestResult, bbChanTestState=bbChanTestState, bbChanTestStateCPESide=bbChanTestStateCPESide, bbChanTestType=bbChanTestType, bbChanTestTypeCPESide=bbChanTestTypeCPESide, bbChanUpcCDVT=bbChanUpcCDVT, bbChanUpcEnable=bbChanUpcEnable, bbChanUpcMBS=bbChanUpcMBS, bbChanUpcMCR=bbChanUpcMCR, bbChanUpcPCR=bbChanUpcPCR, bbChanUpcSCR=bbChanUpcSCR, bbChanUpcSCRPolicing=bbChanUpcSCRPolicing, bbChanVci=bbChanVci, bbChanVpIdNextAvailable=bbChanVpIdNextAvailable, bbChanVpi=bbChanVpi, bbConnPCR=bbConnPCR, bbConnPercentUtil=bbConnPercentUtil, bbConnSCR=bbConnSCR, bbConnServiceType=bbConnServiceType, bbConnVpcFlag=bbConnVpcFlag, bbRemoteConnPCR=bbRemoteConnPCR, bbRemoteConnPercentUtil=bbRemoteConnPercentUtil, bbRemoteConnSCR=bbRemoteConnSCR, ciscoWanBbifAtmConnMIB=ciscoWanBbifAtmConnMIB, cwbAtmConnCompliance=cwbAtmConnCompliance, cwbAtmConnGeneralGroup=cwbAtmConnGeneralGroup, cwbAtmConnGroup=cwbAtmConnGroup, cwbAtmConnMIBCompliances=cwbAtmConnMIBCompliances, cwbAtmConnMIBConformance=cwbAtmConnMIBConformance, cwbAtmConnMIBGroups=cwbAtmConnMIBGroups, cwbAtmConnStateGroup=cwbAtmConnStateGroup)
