...
NotificationType, MibIdentifier, Unsigned32, Bits, Integer32, TimeTicks, enterprises, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, Counter64, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Unsigned32", "Bits", "Integer32", "TimeTicks", "enterprises", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "Counter64", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, userTableEntry=userTableEntry, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, wirelessLinkAvailability=wirelessLinkAvailability, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, numberOfAntennas=numberOfAntennas, protectionAvailabilityStatus=protectionAvailabilityStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, unitOutOfCalibration=unitOutOfCalibration, protectionState=protectionState, hTTPPortNumber=hTTPPortNumber, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, rFURxFreqMax=rFURxFreqMax, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, alignmentMode=alignmentMode, enableTransmission=enableTransmission, radioLicenseCodeRate=radioLicenseCodeRate, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alarms=alarms, receivePower=receivePower, sNTPServerIPAddress=sNTPServerIPAddress, phyControl=phyControl, encryption=encryption, systemClock=systemClock, bridge=bridge, protectionStatus=protectionStatus, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNMPEnabledTraps=sNMPEnabledTraps, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, maxCodeRate=maxCodeRate, sNTPServerTimeout=sNTPServerTimeout, sNTPPrimaryServer=sNTPPrimaryServer, userName=userName, sMTPEnabledMessages=sMTPEnabledMessages, dataPortFiberStatus=dataPortFiberStatus, ethernet=ethernet, rFUTxPowerMax=rFUTxPowerMax, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, vectorError=vectorError, minModulation=minModulation, configuration=configuration, rFUVersionBank1=rFUVersionBank1, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUTxMuteStatus=rFUTxMuteStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, ptp800=ptp800, rFUTxPowerAlarm=rFUTxPowerAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, protectionStateTrap=protectionStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, gatewayIPAddress=gatewayIPAddress, diverseRfFeederLoss=diverseRfFeederLoss, sNMPTrapVersion=sNMPTrapVersion, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementCommittedInformationRate=managementCommittedInformationRate, radioLicense=radioLicense, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, ptp=ptp, rFUStatus=rFUStatus, daylightSaving=daylightSaving, rFURFSwitchAlarm=rFURFSwitchAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sntp=sntp, bootVersion=bootVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, vLANManagementPriority=vLANManagementPriority, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, management=management, ethernetPriorityTableIndex=ethernetPriorityTableIndex, timeZone=timeZone, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFULockoutAlarm=rFULockoutAlarm, linkName=linkName, neighborInternetAddress=neighborInternetAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, rFUTransceiverLocation=rFUTransceiverLocation, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTable=sNTPServerTable, protectionStats=protectionStats, rFURfBand=rFURfBand, neighborMACAddress=neighborMACAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, radioLicenseBand=radioLicenseBand, rFUTxFreqMin=rFUTxFreqMin, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUFreqSpacing=rFUFreqSpacing, radioLicenseMinCodeRate=radioLicenseMinCodeRate, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, transmitCapacity=transmitCapacity, rFUPowerAlarm=rFUPowerAlarm, cambium=cambium, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicenseModulation=radioLicenseModulation, transmitDataRate=transmitDataRate, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secureModeAlarmTrap=secureModeAlarmTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteMACAddress=remoteMACAddress, sNMPPortNumber=sNMPPortNumber, ethernetPriorityTableEntry=ethernetPriorityTableEntry, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, ptmp=ptmp, rFUActiveFirmwareBank=rFUActiveFirmwareBank, l2CPPriorityTableEntry=l2CPPriorityTableEntry, userTableNumber=userTableNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortStatusTrap=dataPortStatusTrap, dSCPManagementPriority=dSCPManagementPriority, iPv4Address=iPv4Address, tFTPServerInternetAddress=tFTPServerInternetAddress, qOSPriorityScheme=qOSPriorityScheme, antennaGain=antennaGain, managementPortAutoNegotiation=managementPortAutoNegotiation, vLANManagementVID=vLANManagementVID, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitCodeRate=transmitCodeRate, sNMPCommunityString=sNMPCommunityString, linkNameMismatchTrap=linkNameMismatchTrap, iFCableLength=iFCableLength, sNTPServerRetries=sNTPServerRetries, radioLicenseRegion=radioLicenseRegion, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, securityLevel=securityLevel, hTTPAccessEnabled=hTTPAccessEnabled, mPLSTCPriorityTable=mPLSTCPriorityTable, aggregateDataRate=aggregateDataRate, radioLicenseMaxEIRP=radioLicenseMaxEIRP, ethernetPriorityTable=ethernetPriorityTable, sNTPServerTableEntry=sNTPServerTableEntry, supplementary=supplementary, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, linkLoss=linkLoss, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUPlatformCompatibility=rFUPlatformCompatibility, maxModulation=maxModulation, rFURpsAlarm=rFURpsAlarm, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUTxFreqMax=rFUTxFreqMax, radioLicenseBandwidth=radioLicenseBandwidth, transmitModulation=transmitModulation, protectionConfigurationStatus=protectionConfigurationStatus, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUConnectedPlatform=rFUConnectedPlatform, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remotePrimaryMACAddress=remotePrimaryMACAddress, aAAControl=aAAControl, hardwareVersion=hardwareVersion, rFUTxPowerMin=rFUTxPowerMin, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, activeAvailableTime=activeAvailableTime, rFUVersionBank2=rFUVersionBank2, sMTPEmailAlert=sMTPEmailAlert, activeUnit=activeUnit, encryptionAlgorithm=encryptionAlgorithm, userTable=userTable, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, protectionInterfaceStatus=protectionInterfaceStatus, subnetMask=subnetMask, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, versions=versions, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogState=syslogState, smtp=smtp, dataPortStatus=dataPortStatus, radioLicenseTxFreq=radioLicenseTxFreq, aTPCEnable=aTPCEnable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rfu=rfu, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerResponse=sNTPServerResponse, endId=endId, snmpControl=snmpControl, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, transmitterStatus=transmitterStatus, altitude=altitude, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, secureModeAlarm=secureModeAlarm, rFUStatusTrap=rFUStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, userRole=userRole, remoteInternetAddress=remoteInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPState=sNTPState, userTableIndex=userTableIndex, primaryRecovery=primaryRecovery, systemReset=systemReset, sMTPServerPortNumber=sMTPServerPortNumber, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, protectionConfig=protectionConfig, tFTPServerInternetAddressType=tFTPServerInternetAddressType, managementPortStatus=managementPortStatus, receiveModulation=receiveModulation, alignmentModeTrap=alignmentModeTrap, dataPortPauseFrames=dataPortPauseFrames, remotePrimaryIPAddress=remotePrimaryIPAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, longitude=longitude, neighborIPAddress=neighborIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFFeederLoss=rFFeederLoss, iPVersion=iPVersion, dataPortDisabledWarning=dataPortDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteIPAddress=remoteIPAddress, sNTPServerTableNumber=sNTPServerTableNumber, linkNameMismatch=linkNameMismatch, neighborInternetAddressType=neighborInternetAddressType, maximumTransmitPower=maximumTransmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, managementPortStatusTrap=managementPortStatusTrap, protectionSwitchCause=protectionSwitchCause, dataPortWirelessDownAlert=dataPortWirelessDownAlert, l2CPPriorityTableNumber=l2CPPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, sNTPPollInterval=sNTPPollInterval, receiveDataRate=receiveDataRate, latitude=latitude, iPDSCPPriorityTable=iPDSCPPriorityTable, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPLastSync=sNTPLastSync, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protection=protection, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, faultProtectionSwitching=faultProtectionSwitching, diverseAntennaGain=diverseAntennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, iPv6GatewayAddress=iPv6GatewayAddress, wirelessLinkStatus=wirelessLinkStatus, sNTPServerPortNumber=sNTPServerPortNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, syslogClient=syslogClient, minCodeRate=minCodeRate, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementMode=managementMode, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPv6Address=iPv6Address, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortDisabledWarning=managementPortDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, requestedProtectionState=requestedProtectionState, sNTPServerTableIndex=sNTPServerTableIndex, rFURxFreqMin=rFURxFreqMin, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, syslogStateTrap=syslogStateTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, receiveCodeRate=receiveCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, phyStatus=phyStatus, transmitCapacityLimit=transmitCapacityLimit, primarySecondaryMode=primarySecondaryMode, radioLicenseRxFreq=radioLicenseRxFreq, rxDiversityVid=rxDiversityVid, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUCableAlarm=rFUCableAlarm, sNTPSyncTrap=sNTPSyncTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remoteSecondaryIPAddress=remoteSecondaryIPAddress, softwareVersion=softwareVersion, rFUType=rFUType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, telnetAccessEnabled=telnetAccessEnabled, reset=reset, ptpTraps=ptpTraps, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUSerial=rFUSerial, ptpTrapPrefix=ptpTrapPrefix, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, productName=productName, userPassword=userPassword, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, productVariant=productVariant, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, radioLicenseIdentifier=radioLicenseIdentifier, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, fiberY=fiberY, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, localPacketFiltering=localPacketFiltering, syslogClientTrap=syslogClientTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUPowerButtonPressed=rFUPowerButtonPressed)
