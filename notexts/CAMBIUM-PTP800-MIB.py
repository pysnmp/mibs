...
Counter32, ModuleIdentity, iso, NotificationType, ObjectIdentity, TimeTicks, enterprises, IpAddress, NotificationType, Integer32, Counter64, Gauge32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "TimeTicks", "enterprises", "IpAddress", "NotificationType", "Integer32", "Counter64", "Gauge32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, diverseAntennaGain=diverseAntennaGain, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rfu=rfu, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, transmitterStatus=transmitterStatus, sNMPEnabledTraps=sNMPEnabledTraps, supplementary=supplementary, maxCodeRate=maxCodeRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, protectionConfigurationStatus=protectionConfigurationStatus, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, remotePrimaryIPAddress=remotePrimaryIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUTxPowerMin=rFUTxPowerMin, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, radioLicenseMinModulation=radioLicenseMinModulation, dataPortPauseFrames=dataPortPauseFrames, systemClock=systemClock, longitude=longitude, userEnabled=userEnabled, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, requestedProtectionState=requestedProtectionState, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, userTableNumber=userTableNumber, managementPortStatus=managementPortStatus, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortFiberStatus=dataPortFiberStatus, rFUTxFreqMax=rFUTxFreqMax, mPLSTCPriorityTable=mPLSTCPriorityTable, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, latitude=latitude, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTableNumber=ethernetPriorityTableNumber, transmitDataRate=transmitDataRate, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, neighborIPAddress=neighborIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionEnabledMismatch=encryptionEnabledMismatch, managementMode=managementMode, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, protectionSwitchCause=protectionSwitchCause, ethernetFiberSupport=ethernetFiberSupport, siteName=siteName, rFUConnectedPlatform=rFUConnectedPlatform, sNMPPortNumber=sNMPPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, ptpTraps=ptpTraps, secureModeAlarm=secureModeAlarm, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseMaxEIRP=radioLicenseMaxEIRP, vectorError=vectorError, wirelessLinkStatus=wirelessLinkStatus, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remoteInternetAddress=remoteInternetAddress, dataPortStatusTrap=dataPortStatusTrap, rFURfBand=rFURfBand, sNMPTrapTableNumber=sNMPTrapTableNumber, securityLevel=securityLevel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, activeWirelessLinkAvailability=activeWirelessLinkAvailability, numberOfAntennas=numberOfAntennas, daylightSaving=daylightSaving, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, productName=productName, transmitPower=transmitPower, aAAControl=aAAControl, transmitCapacityLimit=transmitCapacityLimit, rFUTxPowerAlarm=rFUTxPowerAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPVersion=iPVersion, versions=versions, protectionStateTrap=protectionStateTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, enableTransmission=enableTransmission, sNTPServerTable=sNTPServerTable, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, radioLicenseCodeRate=radioLicenseCodeRate, ptmp=ptmp, radioLicenseTxFreq=radioLicenseTxFreq, userTableIndex=userTableIndex, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, diverseRfFeederLoss=diverseRfFeederLoss, remotePrimaryMACAddress=remotePrimaryMACAddress, syslogClientTrap=syslogClientTrap, sNTPServerTableIndex=sNTPServerTableIndex, snmpControl=snmpControl, rFUTxMuteStatus=rFUTxMuteStatus, iFCableLength=iFCableLength, iPDSCPPriorityTable=iPDSCPPriorityTable, transmitModulation=transmitModulation, protectionInterfaceStatus=protectionInterfaceStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, altitude=altitude, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, rFUVersionBank1=rFUVersionBank1, remoteInternetAddressType=remoteInternetAddressType, rFUSerial=rFUSerial, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPv4Address=iPv4Address, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNTPServerRetries=sNTPServerRetries, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, rFFeederLoss=rFFeederLoss, protectionState=protectionState, ethernetPriorityTable=ethernetPriorityTable, radioLicenseBandwidth=radioLicenseBandwidth, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rFUFreqSpacing=rFUFreqSpacing, minCodeRate=minCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFULockoutAlarm=rFULockoutAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURpsAlarm=rFURpsAlarm, rxDiversityVid=rxDiversityVid, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, localPacketFiltering=localPacketFiltering, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sNTPServerTimeout=sNTPServerTimeout, remoteSecondaryIPAddress=remoteSecondaryIPAddress, transmitCodeRate=transmitCodeRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rxDiversityVlanTpid=rxDiversityVlanTpid, transmitCapacity=transmitCapacity, protection=protection, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPEmailAlert=sMTPEmailAlert, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortDisabledWarning=managementPortDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, userPassword=userPassword, softwareVersion=softwareVersion, cambium=cambium, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, antennaGain=antennaGain, vLANManagementVIDValidation=vLANManagementVIDValidation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, linkNameMismatch=linkNameMismatch, rFUBranchingConfiguration=rFUBranchingConfiguration, gatewayIPAddress=gatewayIPAddress, managementCommittedInformationRate=managementCommittedInformationRate, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTableEntry=sNTPServerTableEntry, alignmentModeTrap=alignmentModeTrap, ptp800=ptp800, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, neighborInternetAddressType=neighborInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, bridge=bridge, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUPowerAlarm=rFUPowerAlarm, userTable=userTable, receiveModulation=receiveModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, neighborInternetAddress=neighborInternetAddress, sNTPServerResponse=sNTPServerResponse, radioLicenseRegion=radioLicenseRegion, radioLicenseRxFreq=radioLicenseRxFreq, alignmentMode=alignmentMode, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, endId=endId, syslogClient=syslogClient, linkName=linkName, receiveDataRate=receiveDataRate, managementPortStatusTrap=managementPortStatusTrap, rFUProtectionCompatibility=rFUProtectionCompatibility, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPState=sNTPState, primarySecondaryMode=primarySecondaryMode, protectionStatus=protectionStatus, ethernet=ethernet, maxModulation=maxModulation, sNMPCommunityString=sNMPCommunityString, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntp=sntp, activeAvailableTime=activeAvailableTime, syslogState=syslogState, sMTPServerIPAddress=sMTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, maximumTransmitPower=maximumTransmitPower, smtp=smtp, rFUStatusTrap=rFUStatusTrap, hardwareVersion=hardwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sMTPServerPortNumber=sMTPServerPortNumber, systemReset=systemReset, syslogStateTrap=syslogStateTrap, telnetPortNumber=telnetPortNumber, radioLicenseBand=radioLicenseBand, primaryRecoveryPeriod=primaryRecoveryPeriod, protectionStats=protectionStats, fiberY=fiberY, subnetMask=subnetMask, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFURxFreqMin=rFURxFreqMin, iPv6PrefixLength=iPv6PrefixLength, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, encryption=encryption, remoteMACAddress=remoteMACAddress, rFURxFreqMax=rFURxFreqMax, faultProtectionSwitching=faultProtectionSwitching, rFUVersionBank2=rFUVersionBank2, remoteSecondaryMACAddress=remoteSecondaryMACAddress, productVariant=productVariant, vLANManagementVID=vLANManagementVID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aTPCEnable=aTPCEnable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, primaryRecovery=primaryRecovery, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUCableAlarm=rFUCableAlarm, dataPortDisabledWarning=dataPortDisabledWarning, bootVersion=bootVersion, rFUTxPowerMax=rFUTxPowerMax, userTableEntry=userTableEntry, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicense=radioLicense, iPv6GatewayAddress=iPv6GatewayAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, protectionConfig=protectionConfig, sNTPLastSync=sNTPLastSync, secureModeAlarmTrap=secureModeAlarmTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPrimaryServer=sNTPPrimaryServer, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFURFSwitchAlarm=rFURFSwitchAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, alarms=alarms, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, rFUPlatformCompatibility=rFUPlatformCompatibility, sNTPServerTableNumber=sNTPServerTableNumber, minModulation=minModulation, radioLicenseMaxModulation=radioLicenseMaxModulation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteIPAddress=remoteIPAddress, rFUStatus=rFUStatus, rFUType=rFUType, l2CPPriorityTable=l2CPPriorityTable, neighborMACAddress=neighborMACAddress, rFUTxFreqMin=rFUTxFreqMin, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, aggregateDataRate=aggregateDataRate, userName=userName, receiveCodeRate=receiveCodeRate, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, phyStatus=phyStatus, pubStats=pubStats, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseModulation=radioLicenseModulation, licence=licence, phyControl=phyControl, iPv6Address=iPv6Address, timeZone=timeZone, dataPortStatus=dataPortStatus, linkNameMismatchTrap=linkNameMismatchTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, hTTPAccessEnabled=hTTPAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, activeUnit=activeUnit, vLANManagementPriority=vLANManagementPriority, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
