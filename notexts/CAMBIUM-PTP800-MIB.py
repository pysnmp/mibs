...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", endId=endId, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, userTableNumber=userTableNumber, rFUTxFreqMax=rFUTxFreqMax, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, remoteInternetAddress=remoteInternetAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFUTxMuteStatus=rFUTxMuteStatus, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, primaryRecovery=primaryRecovery, transmitCodeRate=transmitCodeRate, rFUActiveFirmwareBank=rFUActiveFirmwareBank, minModulation=minModulation, secondarySoftwareVersion=secondarySoftwareVersion, transmitCapacity=transmitCapacity, sNTPServerResponse=sNTPServerResponse, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, alignmentMode=alignmentMode, sNTPServerRetries=sNTPServerRetries, rFUVersionBank2=rFUVersionBank2, receivePower=receivePower, siteName=siteName, phyControl=phyControl, sMTPEmailAlert=sMTPEmailAlert, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, managementPortStatus=managementPortStatus, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, rFUStatus=rFUStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, ptpTrapPrefix=ptpTrapPrefix, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protectionStatus=protectionStatus, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, protectionInterfaceStatus=protectionInterfaceStatus, userPassword=userPassword, userTableEntry=userTableEntry, ptp800=ptp800, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUTransceiverLocation=rFUTransceiverLocation, iPVersion=iPVersion, rFUType=rFUType, ptmp=ptmp, radioLicenseModulation=radioLicenseModulation, securityLevel=securityLevel, remoteInternetAddressType=remoteInternetAddressType, syslogState=syslogState, rFUBranchingConfiguration=rFUBranchingConfiguration, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, managementMode=managementMode, rFUStatusTrap=rFUStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, dSCPManagementPriority=dSCPManagementPriority, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPServerTableIndex=sNTPServerTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, qOSPriorityScheme=qOSPriorityScheme, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, hTTPPortNumber=hTTPPortNumber, wirelessLinkStatus=wirelessLinkStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, receiveDataRate=receiveDataRate, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, radioLicense=radioLicense, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, activeAvailableTime=activeAvailableTime, protectionConfig=protectionConfig, rFURfBand=rFURfBand, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, licence=licence, rFUPlatformCompatibility=rFUPlatformCompatibility, mPLSTCPriorityTable=mPLSTCPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, cambium=cambium, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, rFUTxFreqMin=rFUTxFreqMin, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFULockoutAlarm=rFULockoutAlarm, primarySecondaryMode=primarySecondaryMode, rFUSerial=rFUSerial, remoteMACAddress=remoteMACAddress, rFUFreqSpacing=rFUFreqSpacing, rFURxFreqMin=rFURxFreqMin, hardwareVersion=hardwareVersion, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, iPv4Address=iPv4Address, remotePrimaryIPAddress=remotePrimaryIPAddress, minCodeRate=minCodeRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6Address=iPv6Address, linkLoss=linkLoss, altitude=altitude, rFURxFreqMax=rFURxFreqMax, enableTransmission=enableTransmission, sNTPServerTable=sNTPServerTable, longitude=longitude, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, bridge=bridge, userTableIndex=userTableIndex, diverseRfFeederLoss=diverseRfFeederLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPServerInternetAddress=sNTPServerInternetAddress, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionSwitchCause=protectionSwitchCause, dataPortFiberStatus=dataPortFiberStatus, dataPortStatusTrap=dataPortStatusTrap, rFUTxPowerMax=rFUTxPowerMax, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ethernetFiberSupport=ethernetFiberSupport, userName=userName, radioLicenseCodeRate=radioLicenseCodeRate, iFCableLength=iFCableLength, ptp=ptp, managementCommittedInformationRate=managementCommittedInformationRate, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, ptpTraps=ptpTraps, rFURFSwitchAlarm=rFURFSwitchAlarm, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxPowerAlarm=rFUTxPowerAlarm, neighborIPAddress=neighborIPAddress, radioLicenseRxFreq=radioLicenseRxFreq, sntp=sntp, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, transmitterStatus=transmitterStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUCableAlarm=rFUCableAlarm, numberOfAntennas=numberOfAntennas, faultProtectionSwitching=faultProtectionSwitching, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseMinCodeRate=radioLicenseMinCodeRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxPowerMin=rFUTxPowerMin, ethernetPriorityTableEntry=ethernetPriorityTableEntry, productName=productName, softwareVersion=softwareVersion, maxModulation=maxModulation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, protectionConfigurationStatus=protectionConfigurationStatus, diverseAntennaGain=diverseAntennaGain, iPv6GatewayAddress=iPv6GatewayAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, configuration=configuration, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicenseRegion=radioLicenseRegion, sNMPTrapTableIndex=sNMPTrapTableIndex, managementPortConfigurationMismatch=managementPortConfigurationMismatch, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, syslogClientTrap=syslogClientTrap, productVariant=productVariant, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPState=sNTPState, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, activeUnit=activeUnit, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapTable=sNMPTrapTable, neighborMACAddress=neighborMACAddress, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUPowerAlarm=rFUPowerAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, linkNameMismatch=linkNameMismatch, sNTPServerIPAddress=sNTPServerIPAddress, encryption=encryption, transmitModulation=transmitModulation, syslogClient=syslogClient, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, rfu=rfu, tFTPServerInternetAddress=tFTPServerInternetAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, fiberY=fiberY, remotePrimaryInternetAddress=remotePrimaryInternetAddress, management=management, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUVersionBank1=rFUVersionBank1, subnetMask=subnetMask, remoteIPAddress=remoteIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFURpsAlarm=rFURpsAlarm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, alarms=alarms, radioLicenseMaxModulation=radioLicenseMaxModulation, snmpControl=snmpControl, sNMPPortNumber=sNMPPortNumber, sNTPServerTableEntry=sNTPServerTableEntry, encryptionEnabledMismatch=encryptionEnabledMismatch, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, localPacketFiltering=localPacketFiltering, vLANManagementVID=vLANManagementVID, vectorError=vectorError, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseTxFreq=radioLicenseTxFreq, sMTPServerIPAddress=sMTPServerIPAddress, rFFeederLoss=rFFeederLoss, supplementary=supplementary, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortPauseFrames=dataPortPauseFrames, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, neighborInternetAddress=neighborInternetAddress, l2CPPriorityTable=l2CPPriorityTable, tFTPServerPortNumber=tFTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, iPv6PrefixLength=iPv6PrefixLength, remotePrimaryMACAddress=remotePrimaryMACAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUProtectionCompatibility=rFUProtectionCompatibility, radioLicenseBand=radioLicenseBand, sNTPLastSync=sNTPLastSync, rxDiversityDataPortStatus=rxDiversityDataPortStatus, aAAControl=aAAControl, remoteSecondaryMACAddress=remoteSecondaryMACAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, receiveCodeRate=receiveCodeRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxBandAboveRx=rFUTxBandAboveRx, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, vLANManagementPriority=vLANManagementPriority, sNTPSync=sNTPSync, receiveModulation=receiveModulation, smtp=smtp, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseIdentifier=radioLicenseIdentifier, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, protectionStateTrap=protectionStateTrap, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerTimeout=sNTPServerTimeout, managementPortWirelessDownAlert=managementPortWirelessDownAlert, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, linkNameMismatchTrap=linkNameMismatchTrap, secureModeAlarm=secureModeAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetPriorityTable=ethernetPriorityTable, rxDiversityVid=rxDiversityVid, sNTPServerTableNumber=sNTPServerTableNumber, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, maxCodeRate=maxCodeRate, reset=reset, managementPortStatusTrap=managementPortStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, phyStatus=phyStatus, userEnabled=userEnabled, bootVersion=bootVersion, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, aTPCEnable=aTPCEnable, pubStats=pubStats, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, requestedProtectionState=requestedProtectionState, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, protection=protection, systemReset=systemReset, dataPortStatus=dataPortStatus, systemClock=systemClock, neighborInternetAddressType=neighborInternetAddressType, protectionStats=protectionStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitCapacityLimit=transmitCapacityLimit, sNTPPrimaryServer=sNTPPrimaryServer, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, timeZone=timeZone, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, secureModeAlarmTrap=secureModeAlarmTrap, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, alignmentModeTrap=alignmentModeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, protectionState=protectionState, userRole=userRole, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
