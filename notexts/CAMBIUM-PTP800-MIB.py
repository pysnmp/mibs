...
Bits, Integer32, Unsigned32, Counter64, Counter32, NotificationType, iso, IpAddress, TimeTicks, ObjectIdentity, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "Unsigned32", "Counter64", "Counter32", "NotificationType", "iso", "IpAddress", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", userEnabled=userEnabled, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, remoteMACAddress=remoteMACAddress, productName=productName, sNTPPollInterval=sNTPPollInterval, secureModeAlarmTrap=secureModeAlarmTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, encryption=encryption, userTableIndex=userTableIndex, managementPortDisabledWarning=managementPortDisabledWarning, phyControl=phyControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseBand=radioLicenseBand, sNTPServerIPAddress=sNTPServerIPAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFURxFreqMin=rFURxFreqMin, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bridge=bridge, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, reset=reset, supplementary=supplementary, managementCommittedInformationRate=managementCommittedInformationRate, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, neighborInternetAddressType=neighborInternetAddressType, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, protectionState=protectionState, dataPortDisabledWarning=dataPortDisabledWarning, transmitDataRate=transmitDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, ptpTraps=ptpTraps, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPSyncTrap=sNTPSyncTrap, productVariant=productVariant, vectorError=vectorError, sNTPPrimaryServer=sNTPPrimaryServer, transmitterStatus=transmitterStatus, timeZone=timeZone, remotePrimaryInternetAddress=remotePrimaryInternetAddress, wirelessLinkAvailability=wirelessLinkAvailability, rFUTxFreqMax=rFUTxFreqMax, syslogStateTrap=syslogStateTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, minCodeRate=minCodeRate, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, primarySecondaryMode=primarySecondaryMode, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, diverseAntennaGain=diverseAntennaGain, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicenseTxFreq=radioLicenseTxFreq, rxDiversityVid=rxDiversityVid, snmpControl=snmpControl, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, transmitPower=transmitPower, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseCodeRate=radioLicenseCodeRate, radioLicenseMinCodeRate=radioLicenseMinCodeRate, secondarySoftwareVersion=secondarySoftwareVersion, diverseRfFeederLoss=diverseRfFeederLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6Address=iPv6Address, sNTPServerRetries=sNTPServerRetries, linkName=linkName, linkNameMismatch=linkNameMismatch, longitude=longitude, versions=versions, protectionConfig=protectionConfig, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionInterfaceStatus=protectionInterfaceStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, tFTPServerInternetAddressType=tFTPServerInternetAddressType, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseMinModulation=radioLicenseMinModulation, ethernet=ethernet, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, l2CPPriorityTableEntry=l2CPPriorityTableEntry, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, requestedProtectionState=requestedProtectionState, activeAvailableTime=activeAvailableTime, rFUPlatformCompatibility=rFUPlatformCompatibility, systemClock=systemClock, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, ptmp=ptmp, radioLicenseIdentifier=radioLicenseIdentifier, radioLicense=radioLicense, licence=licence, sNMPTrapVersion=sNMPTrapVersion, maxCodeRate=maxCodeRate, tFTPServerPortNumber=tFTPServerPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, systemReset=systemReset, iPVersion=iPVersion, rFUVersionBank1=rFUVersionBank1, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFULockoutAlarm=rFULockoutAlarm, sNTPSync=sNTPSync, receiveCodeRate=receiveCodeRate, configuration=configuration, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteIPAddress=remoteIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogControl=syslogControl, sNTPState=sNTPState, rFFeederLoss=rFFeederLoss, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aAAControl=aAAControl, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, userPassword=userPassword, sNMPPortNumber=sNMPPortNumber, protectionStatus=protectionStatus, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNTPServerTimeout=sNTPServerTimeout, phyStatus=phyStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerPortNumber=sNTPServerPortNumber, management=management, maxModulation=maxModulation, managementPortAutoNegotiation=managementPortAutoNegotiation, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, altitude=altitude, aTPCEnable=aTPCEnable, vLANManagementPriority=vLANManagementPriority, ethernetPriorityTableEntry=ethernetPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, ptp800=ptp800, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTxFreqMin=rFUTxFreqMin, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerInternetAddress=sNTPServerInternetAddress, userRole=userRole, ethernetPriorityTable=ethernetPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, dataPortFiberStatusTrap=dataPortFiberStatusTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, neighborMACAddress=neighborMACAddress, latitude=latitude, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, localPacketFiltering=localPacketFiltering, rFUType=rFUType, protectionStats=protectionStats, endId=endId, receiveModulation=receiveModulation, sMTPEmailAlert=sMTPEmailAlert, neighborIPAddress=neighborIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, secureModeAlarm=secureModeAlarm, alignmentModeTrap=alignmentModeTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userName=userName, hardwareVersion=hardwareVersion, rFUTxPowerMax=rFUTxPowerMax, sNMPTrapPortNumber=sNMPTrapPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPServerTableNumber=sNTPServerTableNumber, securityLevel=securityLevel, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, cambium=cambium, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortStatus=dataPortStatus, rFURpsAlarm=rFURpsAlarm, protectionStateTrap=protectionStateTrap, aggregateDataRate=aggregateDataRate, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUVersionBank2=rFUVersionBank2, receiveDataRate=receiveDataRate, protectionConfigurationStatus=protectionConfigurationStatus, ethernetFiberSupport=ethernetFiberSupport, softwareVersion=softwareVersion, iPv6GatewayAddress=iPv6GatewayAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, l2CPPriorityTable=l2CPPriorityTable, rFUTxPowerMin=rFUTxPowerMin, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortPauseFrames=dataPortPauseFrames, receivePower=receivePower, syslogState=syslogState, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, radioLicenseRxFreq=radioLicenseRxFreq, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUStatusTrap=rFUStatusTrap, rFUFreqSpacing=rFUFreqSpacing, userTableEntry=userTableEntry, rFURFSwitchAlarm=rFURFSwitchAlarm, sntp=sntp, syslogClientTrap=syslogClientTrap, ptp=ptp, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitCapacityLimit=transmitCapacityLimit, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerResponse=sNTPServerResponse, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, wirelessLinkStatusTrap=wirelessLinkStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, transmitCodeRate=transmitCodeRate, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", minModulation=minModulation, pubStats=pubStats, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortStatus=managementPortStatus, numberOfAntennas=numberOfAntennas, dSCPManagementPriority=dSCPManagementPriority, encryptionEnabledMismatch=encryptionEnabledMismatch, rfu=rfu, bootVersion=bootVersion, sNMPEnabledTraps=sNMPEnabledTraps, radioLicenseRegion=radioLicenseRegion, userTableNumber=userTableNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, managementMode=managementMode, faultProtectionSwitching=faultProtectionSwitching, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, primaryRecovery=primaryRecovery, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled, rFUStatus=rFUStatus, transmitModulation=transmitModulation, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, radioLicenseModulation=radioLicenseModulation, protectionAvailabilityStatus=protectionAvailabilityStatus, siteName=siteName, radioLicenseMaxModulation=radioLicenseMaxModulation, neighborInternetAddress=neighborInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, sMTPServerIPAddress=sMTPServerIPAddress, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, managementPortStatusTrap=managementPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTransceiverLocation=rFUTransceiverLocation, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, activeUnit=activeUnit, wirelessLinkStatus=wirelessLinkStatus, rFUTxMuteStatus=rFUTxMuteStatus, alignmentMode=alignmentMode, rFUPowerAlarm=rFUPowerAlarm, radioLicenseBandwidth=radioLicenseBandwidth, remoteInternetAddress=remoteInternetAddress, sNTPServerTable=sNTPServerTable, smtp=smtp, protectionSwitchCause=protectionSwitchCause, sNTPServerInternetAddressType=sNTPServerInternetAddressType, dataPortFiberStatus=dataPortFiberStatus, rFURxFreqMax=rFURxFreqMax, primaryRecoveryPeriod=primaryRecoveryPeriod, qOSPriorityScheme=qOSPriorityScheme, transmitCapacity=transmitCapacity, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, remoteInternetAddressType=remoteInternetAddressType, alarms=alarms, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, linkLoss=linkLoss, vLANManagementVIDValidation=vLANManagementVIDValidation, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, iPv6PrefixLength=iPv6PrefixLength, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUActiveFirmwareBank=rFUActiveFirmwareBank, iFCableLength=iFCableLength, rFUCableAlarm=rFUCableAlarm, fiberY=fiberY, hTTPSPortNumber=hTTPSPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, subnetMask=subnetMask, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFURfBand=rFURfBand, userTable=userTable, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, enableTransmission=enableTransmission, rFUSerial=rFUSerial, protection=protection, iPv4Address=iPv4Address, telnetAccessEnabled=telnetAccessEnabled, ethernetPriorityTableIndex=ethernetPriorityTableIndex)
