...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", dataPortStatus=dataPortStatus, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, protectionInterfaceStatus=protectionInterfaceStatus, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, antennaGain=antennaGain, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, activeUnit=activeUnit, unitOutOfCalibration=unitOutOfCalibration, radioLicense=radioLicense, sNMPTrapInternetAddress=sNMPTrapInternetAddress, iPv6GatewayAddress=iPv6GatewayAddress, productVariant=productVariant, sNTPLastSync=sNTPLastSync, neighborIPAddress=neighborIPAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteInternetAddress=remoteInternetAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPVersion=iPVersion, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, ptp=ptp, configuration=configuration, syslogControl=syslogControl, radioLicenseModulation=radioLicenseModulation, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, smtp=smtp, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, ptpTraps=ptpTraps, rxDiversityVid=rxDiversityVid, sNTPState=sNTPState, ethernet=ethernet, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNTPServerTimeout=sNTPServerTimeout, managementPortAutoNegotiation=managementPortAutoNegotiation, sNTPPrimaryServer=sNTPPrimaryServer, ptp800=ptp800, sMTPEnabledMessages=sMTPEnabledMessages, alignmentModeTrap=alignmentModeTrap, telnetPortNumber=telnetPortNumber, iPv6Address=iPv6Address, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUProtectionCompatibility=rFUProtectionCompatibility, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortStatusTrap=dataPortStatusTrap, sNTPServerRetries=sNTPServerRetries, managementCommittedInformationRate=managementCommittedInformationRate, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUVersionBank1=rFUVersionBank1, sNMPCommunityString=sNMPCommunityString, rFUBranchingConfiguration=rFUBranchingConfiguration, rFUTxPowerAlarm=rFUTxPowerAlarm, endId=endId, sNMPEnabledTraps=sNMPEnabledTraps, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, maxCodeRate=maxCodeRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxPowerMax=rFUTxPowerMax, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sMTPServerInternetAddress=sMTPServerInternetAddress, neighborInternetAddress=neighborInternetAddress, transmitterStatus=transmitterStatus, diverseAntennaGain=diverseAntennaGain, rFUStatus=rFUStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sMTPServerIPAddress=sMTPServerIPAddress, aAAControl=aAAControl, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, vLANManagementPriority=vLANManagementPriority, tFTPServerInternetAddress=tFTPServerInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6PrefixLength=iPv6PrefixLength, remotePrimarySecondaryMode=remotePrimarySecondaryMode, hardwareVersion=hardwareVersion, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rFUTxFreqMin=rFUTxFreqMin, remoteMACAddress=remoteMACAddress, fiberY=fiberY, tFTPServerPortNumber=tFTPServerPortNumber, managementPortStatus=managementPortStatus, radioLicenseTxFreq=radioLicenseTxFreq, sNTPServerTableEntry=sNTPServerTableEntry, rFUVersionBank2=rFUVersionBank2, snmpControl=snmpControl, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, rFURxFreqMax=rFURxFreqMax, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rfu=rfu, bridge=bridge, transmitCapacityLimit=transmitCapacityLimit, hTTPPortNumber=hTTPPortNumber, rFUSerial=rFUSerial, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, vectorError=vectorError, numberOfAntennas=numberOfAntennas, latitude=latitude, linkName=linkName, dSCPManagementPriority=dSCPManagementPriority, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, protectionConfigurationStatus=protectionConfigurationStatus, sNTPSync=sNTPSync, secureModeAlarm=secureModeAlarm, userTableNumber=userTableNumber, sNTPServerTableIndex=sNTPServerTableIndex, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFUTxFreqMax=rFUTxFreqMax, iFCableLength=iFCableLength, linkLoss=linkLoss, managementMode=managementMode, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, activeWirelessLinkAvailability=activeWirelessLinkAvailability, altitude=altitude, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, userName=userName, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUConnectedPlatform=rFUConnectedPlatform, receivePower=receivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUStatusTrap=rFUStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, receiveCodeRate=receiveCodeRate, rFUPowerAlarm=rFUPowerAlarm, remoteInternetAddressType=remoteInternetAddressType, vLANManagementVID=vLANManagementVID, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, phyControl=phyControl, systemClock=systemClock, receiveDataRate=receiveDataRate, remoteSecondaryMACAddress=remoteSecondaryMACAddress, linkNameMismatchTrap=linkNameMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, sNTPServerPortNumber=sNTPServerPortNumber, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANManagementVIDValidation=vLANManagementVIDValidation, radioLicenseMaxModulation=radioLicenseMaxModulation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, radioLicenseMinModulation=radioLicenseMinModulation, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, secondarySoftwareVersion=secondarySoftwareVersion, primaryRecovery=primaryRecovery, userTableIndex=userTableIndex, hTTPSPortNumber=hTTPSPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, protectionStateTrap=protectionStateTrap, timeZone=timeZone, ethernetPriorityTableIndex=ethernetPriorityTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, linkNameMismatch=linkNameMismatch, rFUType=rFUType, siteName=siteName, subnetMask=subnetMask, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, managementPortDisabledWarning=managementPortDisabledWarning, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, maxModulation=maxModulation, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, encryptionEnabledMismatch=encryptionEnabledMismatch, remoteIPAddress=remoteIPAddress, sMTPEmailAlert=sMTPEmailAlert, enableTransmission=enableTransmission, protection=protection, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseCodeRate=radioLicenseCodeRate, l2CPPriorityTableIndex=l2CPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFURfBand=rFURfBand, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, activeAvailableTime=activeAvailableTime, rFURFSwitchAlarm=rFURFSwitchAlarm, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remotePrimaryInternetAddress=remotePrimaryInternetAddress, sNTPPollInterval=sNTPPollInterval, longitude=longitude, sNTPServerTable=sNTPServerTable, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClientTrap=syslogClientTrap, aggregateDataRate=aggregateDataRate, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, faultProtectionSwitching=faultProtectionSwitching, ptmp=ptmp, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, phyStatus=phyStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, pubStats=pubStats, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPSyncTrap=sNTPSyncTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, transmitCodeRate=transmitCodeRate, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, secureModeAlarmTrap=secureModeAlarmTrap, protectionStatus=protectionStatus, protectionState=protectionState, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, sNMPPortNumber=sNMPPortNumber, ethernetFiberSupport=ethernetFiberSupport, aTPCEnable=aTPCEnable, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ethernetPriorityTable=ethernetPriorityTable, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, radioLicenseBand=radioLicenseBand, protectionStats=protectionStats, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFURxFreqMin=rFURxFreqMin, dataPortDisabledWarning=dataPortDisabledWarning, minModulation=minModulation, l2CPPriorityTableNumber=l2CPPriorityTableNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFULockoutAlarm=rFULockoutAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, primaryRecoveryPeriod=primaryRecoveryPeriod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", neighborInternetAddressType=neighborInternetAddressType, supplementary=supplementary, userEnabled=userEnabled, softwareVersion=softwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, protectionAvailabilityStatus=protectionAvailabilityStatus, alignmentMode=alignmentMode, userPassword=userPassword, rFUFreqSpacing=rFUFreqSpacing, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sNTPServerInternetAddress=sNTPServerInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortFiberStatus=dataPortFiberStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPServerPortNumber=sMTPServerPortNumber, diverseRfFeederLoss=diverseRfFeederLoss, versions=versions, primarySecondaryMode=primarySecondaryMode, radioLicenseRegion=radioLicenseRegion, localPacketFiltering=localPacketFiltering, ethernetPriorityTableEntry=ethernetPriorityTableEntry, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, l2CPPriorityTable=l2CPPriorityTable, radioLicenseBandwidth=radioLicenseBandwidth, dataPortPauseFrames=dataPortPauseFrames, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitModulation=transmitModulation, managementPortConfigurationMismatch=managementPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, encryption=encryption, userRole=userRole, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFFeederLoss=rFFeederLoss, receiveModulation=receiveModulation, rFURpsAlarm=rFURpsAlarm, neighborMACAddress=neighborMACAddress, gatewayIPAddress=gatewayIPAddress, transmitCapacity=transmitCapacity, cambium=cambium, alarms=alarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, licence=licence, transmitDataRate=transmitDataRate, rFUCableAlarm=rFUCableAlarm, rFUTxPowerMin=rFUTxPowerMin, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNTPServerIPAddress=sNTPServerIPAddress, reset=reset, sNTPServerResponse=sNTPServerResponse, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, management=management, hTTPAccessEnabled=hTTPAccessEnabled, bootVersion=bootVersion, iPv4Address=iPv4Address, remotePrimaryMACAddress=remotePrimaryMACAddress, protectionConfig=protectionConfig, daylightSaving=daylightSaving, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, userTableEntry=userTableEntry, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapTable=sNMPTrapTable, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernetPriorityTableNumber=ethernetPriorityTableNumber, minCodeRate=minCodeRate, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionSwitchCause=protectionSwitchCause, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, securityLevel=securityLevel, sntp=sntp, productName=productName, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, radioLicenseIdentifier=radioLicenseIdentifier, wirelessLinkStatusTrap=wirelessLinkStatusTrap)
