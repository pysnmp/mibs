...
enterprises, Integer32, Unsigned32, NotificationType, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Gauge32, iso, IpAddress, ModuleIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Unsigned32", "NotificationType", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Gauge32", "iso", "IpAddress", "ModuleIdentity", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", transmitCapacity=transmitCapacity, iPv6PrefixLength=iPv6PrefixLength, licence=licence, rFUConnectedPlatform=rFUConnectedPlatform, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionInterfaceStatus=protectionInterfaceStatus, primarySecondaryMode=primarySecondaryMode, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPTrapInternetAddress=sNMPTrapInternetAddress, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUCableAlarm=rFUCableAlarm, rFUTxFreqMin=rFUTxFreqMin, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUFreqSpacing=rFUFreqSpacing, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userRole=userRole, aAAControl=aAAControl, syslogControl=syslogControl, neighborIPAddress=neighborIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, vLANManagementVIDValidation=vLANManagementVIDValidation, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerResponse=sNTPServerResponse, sNMPTrapTable=sNMPTrapTable, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, iPv4Address=iPv4Address, timeZone=timeZone, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, radioLicenseMinModulation=radioLicenseMinModulation, userName=userName, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, numberOfAntennas=numberOfAntennas, sNTPServerTable=sNTPServerTable, rFUVersionBank1=rFUVersionBank1, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementPortStatus=managementPortStatus, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, protectionStatus=protectionStatus, secureModeAlarm=secureModeAlarm, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFURpsAlarm=rFURpsAlarm, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, siteName=siteName, rFURxFreqMax=rFURxFreqMax, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, syslogState=syslogState, primaryRecoveryPeriod=primaryRecoveryPeriod, userTable=userTable, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseTxFreq=radioLicenseTxFreq, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUType=rFUType, protectionAvailabilityStatus=protectionAvailabilityStatus, linkNameMismatch=linkNameMismatch, minCodeRate=minCodeRate, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, systemReset=systemReset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortPauseFrames=dataPortPauseFrames, daylightSaving=daylightSaving, supplementary=supplementary, dataPortStatus=dataPortStatus, configuration=configuration, fiberY=fiberY, radioLicenseRxFreq=radioLicenseRxFreq, ptp=ptp, vLANManagementVID=vLANManagementVID, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ptp800=ptp800, transmitDataRate=transmitDataRate, ptmp=ptmp, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteIPAddress=remoteIPAddress, alignmentModeTrap=alignmentModeTrap, sNTPServerTableIndex=sNTPServerTableIndex, phyStatus=phyStatus, rFFeederLoss=rFFeederLoss, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, diverseAntennaGain=diverseAntennaGain, sNTPServerTimeout=sNTPServerTimeout, activeAvailableTime=activeAvailableTime, ptpTraps=ptpTraps, iPv6GatewayAddress=iPv6GatewayAddress, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, rFURfBand=rFURfBand, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, linkNameMismatchTrap=linkNameMismatchTrap, diverseRfFeederLoss=diverseRfFeederLoss, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, phyControl=phyControl, localPacketFiltering=localPacketFiltering, hardwareVersion=hardwareVersion, linkLoss=linkLoss, tFTPServerInternetAddressType=tFTPServerInternetAddressType, endId=endId, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, activeUnit=activeUnit, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, managementPortWirelessDownAlert=managementPortWirelessDownAlert, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPServerRetries=sNTPServerRetries, activeWirelessLinkAvailability=activeWirelessLinkAvailability, hTTPSAccessEnabled=hTTPSAccessEnabled, radioLicenseCodeRate=radioLicenseCodeRate, rFUPlatformCompatibility=rFUPlatformCompatibility, ethernetPriorityTableEntry=ethernetPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetPriorityTable=ethernetPriorityTable, radioLicenseBand=radioLicenseBand, secureModeAlarmTrap=secureModeAlarmTrap, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, cambium=cambium, sNTPServerInternetAddress=sNTPServerInternetAddress, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, vLANManagementPriority=vLANManagementPriority, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, ethernetFiberSupport=ethernetFiberSupport, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, maxCodeRate=maxCodeRate, managementPortAutoNegotiation=managementPortAutoNegotiation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, transmitModulation=transmitModulation, remoteSecondaryMACAddress=remoteSecondaryMACAddress, smtp=smtp, sntp=sntp, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTable=l2CPPriorityTable, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, alignmentMode=alignmentMode, tFTPServerIPAddress=tFTPServerIPAddress, maxModulation=maxModulation, radioLicenseRegion=radioLicenseRegion, sNTPServerIPAddress=sNTPServerIPAddress, management=management, sNTPServerTableNumber=sNTPServerTableNumber, sMTPServerInternetAddressType=sMTPServerInternetAddressType, sNTPLastSync=sNTPLastSync, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, receiveCodeRate=receiveCodeRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, sNMPTrapVersion=sNMPTrapVersion, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUTxPowerMax=rFUTxPowerMax, radioLicense=radioLicense, iFCableLength=iFCableLength, snmpControl=snmpControl, systemClock=systemClock, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionConfig=protectionConfig, receivePower=receivePower, transmitCapacityLimit=transmitCapacityLimit, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMaxModulation=radioLicenseMaxModulation, latitude=latitude, rFUTxPowerMin=rFUTxPowerMin, hTTPPortNumber=hTTPPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, transmitPower=transmitPower, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUTxFreqMax=rFUTxFreqMax, dataPortDisabledWarning=dataPortDisabledWarning, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sMTPEmailAlert=sMTPEmailAlert, protectionConfigurationStatus=protectionConfigurationStatus, encryptionAlgorithm=encryptionAlgorithm, reset=reset, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveModulation=receiveModulation, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, subnetMask=subnetMask, gatewayIPAddress=gatewayIPAddress, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPDSCPPriorityTable=iPDSCPPriorityTable, userTableNumber=userTableNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, userPassword=userPassword, primaryRecovery=primaryRecovery, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rfu=rfu, qOSPriorityScheme=qOSPriorityScheme, sNTPPollInterval=sNTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, rFUSerial=rFUSerial, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, enableTransmission=enableTransmission, dataPortStatusTrap=dataPortStatusTrap, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPServerTableEntry=sNTPServerTableEntry, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, pubStats=pubStats, sNTPPrimaryServer=sNTPPrimaryServer, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, rFURxFreqMin=rFURxFreqMin, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, userEnabled=userEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, transmitCodeRate=transmitCodeRate, remotePrimaryInternetAddress=remotePrimaryInternetAddress, hTTPAccessEnabled=hTTPAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", faultProtectionSwitching=faultProtectionSwitching, neighborInternetAddressType=neighborInternetAddressType, bridge=bridge, receiveDataRate=receiveDataRate, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFUStatusTrap=rFUStatusTrap, encryption=encryption, remoteInternetAddress=remoteInternetAddress, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, minModulation=minModulation, userTableEntry=userTableEntry, neighborInternetAddress=neighborInternetAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, remoteMACAddress=remoteMACAddress, sNTPSync=sNTPSync, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, aggregateDataRate=aggregateDataRate, protectionState=protectionState, encryptionEnabledMismatch=encryptionEnabledMismatch, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, neighborMACAddress=neighborMACAddress, secondarySoftwareVersion=secondarySoftwareVersion, altitude=altitude, remoteInternetAddressType=remoteInternetAddressType, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, productName=productName, rFUProtectionCompatibility=rFUProtectionCompatibility, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUVersionBank2=rFUVersionBank2, transmitterStatus=transmitterStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rxDiversityVid=rxDiversityVid, unitOutOfCalibration=unitOutOfCalibration, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, vectorError=vectorError, tFTPServerInternetAddress=tFTPServerInternetAddress, radioLicenseModulation=radioLicenseModulation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionStateTrap=protectionStateTrap, radioLicenseIdentifier=radioLicenseIdentifier, protection=protection, sNTPSyncTrap=sNTPSyncTrap, iPVersion=iPVersion, rFUStatus=rFUStatus, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telnetAccessEnabled=telnetAccessEnabled, protectionStats=protectionStats, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernet=ethernet, iPv6Address=iPv6Address, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, softwareVersion=softwareVersion, managementPortStatusTrap=managementPortStatusTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerInternetAddressType=sNTPServerInternetAddressType, wirelessLinkAvailability=wirelessLinkAvailability, productVariant=productVariant, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortDisabledWarning=managementPortDisabledWarning, requestedProtectionState=requestedProtectionState, versions=versions, mPLSTCPriorityTable=mPLSTCPriorityTable, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, protectionSwitchCause=protectionSwitchCause, radioLicenseMinCodeRate=radioLicenseMinCodeRate, aTPCEnable=aTPCEnable, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, securityLevel=securityLevel, rFUPowerAlarm=rFUPowerAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, rFULockoutAlarm=rFULockoutAlarm, linkName=linkName, managementMode=managementMode, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, dataPortFiberStatus=dataPortFiberStatus, userTableIndex=userTableIndex, rFUTxPowerAlarm=rFUTxPowerAlarm, dSCPManagementPriority=dSCPManagementPriority, telnetPortNumber=telnetPortNumber, rFUBranchingConfiguration=rFUBranchingConfiguration, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm)
