...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseMinModulation=radioLicenseMinModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, enableTransmission=enableTransmission, rFUCableAlarm=rFUCableAlarm, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSyncTrap=sNTPSyncTrap, sNTPServerResponse=sNTPServerResponse, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, radioLicenseMinCodeRate=radioLicenseMinCodeRate, managementCommittedInformationRate=managementCommittedInformationRate, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, transmitDataRate=transmitDataRate, aTPCEnable=aTPCEnable, productVariant=productVariant, sMTPServerInternetAddressType=sMTPServerInternetAddressType, transmitModulation=transmitModulation, sNMPTrapInternetAddress=sNMPTrapInternetAddress, ethernet=ethernet, transmitPower=transmitPower, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, rFUVersionBank1=rFUVersionBank1, bootVersion=bootVersion, protectionStats=protectionStats, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionConfig=protectionConfig, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseTxFreq=radioLicenseTxFreq, sNMPTrapIPAddress=sNMPTrapIPAddress, iFCableLength=iFCableLength, rFFeederLoss=rFFeederLoss, managementPortAutoNegotiation=managementPortAutoNegotiation, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, protectionInterfaceStatus=protectionInterfaceStatus, syslogClientTrap=syslogClientTrap, remoteInternetAddressType=remoteInternetAddressType, secureModeAlarm=secureModeAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, productName=productName, iPv6Address=iPv6Address, subnetMask=subnetMask, sntp=sntp, ethernetPriorityTableEntry=ethernetPriorityTableEntry, rFURxFreqMax=rFURxFreqMax, neighborInternetAddressType=neighborInternetAddressType, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFURxFreqMin=rFURxFreqMin, latitude=latitude, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNTPServerTimeout=sNTPServerTimeout, neighborIPAddress=neighborIPAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeUnit=activeUnit, rFUTxFreqMax=rFUTxFreqMax, primarySecondaryMode=primarySecondaryMode, managementPortConfigurationMismatch=managementPortConfigurationMismatch, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, dSCPManagementPriority=dSCPManagementPriority, minCodeRate=minCodeRate, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUVersionBank2=rFUVersionBank2, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUConnectedPlatform=rFUConnectedPlatform, rfu=rfu, remotePrimarySecondaryMode=remotePrimarySecondaryMode, vLANManagementPriority=vLANManagementPriority, iPv6GatewayAddress=iPv6GatewayAddress, rFUTransceiverLocation=rFUTransceiverLocation, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, linkLoss=linkLoss, rFUBranchingConfiguration=rFUBranchingConfiguration, tFTPServerPortNumber=tFTPServerPortNumber, mPLSTCPriorityTable=mPLSTCPriorityTable, primaryRecoveryPeriod=primaryRecoveryPeriod, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPServerPortNumber=sNTPServerPortNumber, phyControl=phyControl, linkName=linkName, protection=protection, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, gatewayIPAddress=gatewayIPAddress, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, maxCodeRate=maxCodeRate, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseModulation=radioLicenseModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hardwareVersion=hardwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, remoteMACAddress=remoteMACAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, syslogState=syslogState, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sNTPSync=sNTPSync, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, reset=reset, systemReset=systemReset, rxDiversityVid=rxDiversityVid, ptp800=ptp800, userTable=userTable, rFUPlatformCompatibility=rFUPlatformCompatibility, vLANManagementVIDValidation=vLANManagementVIDValidation, iPVersion=iPVersion, dataPortDisabledWarning=dataPortDisabledWarning, managementPortStatus=managementPortStatus, sNTPServerTable=sNTPServerTable, ethernetPriorityTableNumber=ethernetPriorityTableNumber, systemClock=systemClock, sNTPServerRetries=sNTPServerRetries, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, managementPortStatusTrap=managementPortStatusTrap, protectionStateTrap=protectionStateTrap, neighborMACAddress=neighborMACAddress, transmitCodeRate=transmitCodeRate, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, rFUFreqSpacing=rFUFreqSpacing, sNTPPrimaryServer=sNTPPrimaryServer, timeZone=timeZone, rFUTxBandAboveRx=rFUTxBandAboveRx, sNTPServerIPAddress=sNTPServerIPAddress, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userRole=userRole, rFUSerial=rFUSerial, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, secondarySoftwareVersion=secondarySoftwareVersion, rFUPowerButtonPressed=rFUPowerButtonPressed, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, userName=userName, sNTPState=sNTPState, radioLicenseBandwidth=radioLicenseBandwidth, protectionState=protectionState, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, receiveDataRate=receiveDataRate, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, ptmp=ptmp, fiberY=fiberY, radioLicense=radioLicense, rFUStatusTrap=rFUStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, l2CPPriorityTable=l2CPPriorityTable, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, tFTPServerIPAddress=tFTPServerIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, protectionStatus=protectionStatus, remoteIPAddress=remoteIPAddress, aggregateDataRate=aggregateDataRate, rFUTxPowerMin=rFUTxPowerMin, softwareVersion=softwareVersion, numberOfAntennas=numberOfAntennas, sNMPPortNumber=sNMPPortNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, userEnabled=userEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, managementMode=managementMode, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, endId=endId, sMTPEnabledMessages=sMTPEnabledMessages, rFUTxMuteStatus=rFUTxMuteStatus, versions=versions, maxModulation=maxModulation, supplementary=supplementary, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, ptp=ptp, rFULockoutAlarm=rFULockoutAlarm, vectorError=vectorError, aAAControl=aAAControl, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, wirelessLinkAvailability=wirelessLinkAvailability, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, radioLicenseRxFreq=radioLicenseRxFreq, rFUTxFreqMin=rFUTxFreqMin, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteInternetAddress=remoteInternetAddress, radioLicenseIdentifier=radioLicenseIdentifier, iPDSCPPriorityTable=iPDSCPPriorityTable, snmpControl=snmpControl, localPacketFiltering=localPacketFiltering, radioLicenseMaxEIRP=radioLicenseMaxEIRP, receiveCodeRate=receiveCodeRate, pubStats=pubStats, rFUTxPowerMax=rFUTxPowerMax, linkNameMismatchTrap=linkNameMismatchTrap, iPv4Address=iPv4Address, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, qOSPriorityScheme=qOSPriorityScheme, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerInternetAddress=tFTPServerInternetAddress, sNTPServerInternetAddress=sNTPServerInternetAddress, hTTPPortNumber=hTTPPortNumber, rFUStatus=rFUStatus, primaryRecovery=primaryRecovery, bridge=bridge, iPv6PrefixLength=iPv6PrefixLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPCommunityString=sNMPCommunityString, hTTPSPortNumber=hTTPSPortNumber, faultProtectionSwitching=faultProtectionSwitching, sNTPServerInternetAddressType=sNTPServerInternetAddressType, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, siteName=siteName, sNTPServerTableNumber=sNTPServerTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, remoteSecondaryIPAddress=remoteSecondaryIPAddress, userTableNumber=userTableNumber, rFUPowerAlarm=rFUPowerAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, encryptionAlgorithm=encryptionAlgorithm, phyStatus=phyStatus, activeAvailableTime=activeAvailableTime, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNTPServerTableEntry=sNTPServerTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURpsAlarm=rFURpsAlarm, managementPortForcedConfiguration=managementPortForcedConfiguration, requestedProtectionState=requestedProtectionState, diverseAntennaGain=diverseAntennaGain, ptpTrapPrefix=ptpTrapPrefix, minModulation=minModulation, rFURfBand=rFURfBand, radioLicenseBand=radioLicenseBand, vLANManagementVID=vLANManagementVID, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, userTableEntry=userTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sNMPTrapTable=sNMPTrapTable, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, dataPortPauseFrames=dataPortPauseFrames, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, dataPortStatus=dataPortStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, protectionSwitchCause=protectionSwitchCause, ethernetPriorityTableIndex=ethernetPriorityTableIndex, sMTPServerInternetAddress=sMTPServerInternetAddress, sNMPEnabledTraps=sNMPEnabledTraps, rFUType=rFUType, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogControl=syslogControl, userPassword=userPassword, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, alignmentMode=alignmentMode, configuration=configuration, sNTPServerTableIndex=sNTPServerTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, radioLicenseRegion=radioLicenseRegion, userTableIndex=userTableIndex, management=management, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, telnetPortNumber=telnetPortNumber, transmitCapacityLimit=transmitCapacityLimit, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, maximumTransmitPower=maximumTransmitPower, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitterStatus=transmitterStatus, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, sNMPTrapVersion=sNMPTrapVersion, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, wirelessLinkStatusTrap=wirelessLinkStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, daylightSaving=daylightSaving, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, securityLevel=securityLevel, l2CPPriorityTableNumber=l2CPPriorityTableNumber, protectionAvailabilityStatus=protectionAvailabilityStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rxDiversityDataPortStatus=rxDiversityDataPortStatus, licence=licence, l2CPPriorityTableIndex=l2CPPriorityTableIndex, antennaGain=antennaGain, altitude=altitude, receiveModulation=receiveModulation, encryption=encryption, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, protectionConfigurationStatus=protectionConfigurationStatus, alignmentModeTrap=alignmentModeTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cambium=cambium, dataPortFiberStatus=dataPortFiberStatus, ethernetPriorityTable=ethernetPriorityTable, secureModeAlarmTrap=secureModeAlarmTrap, diverseRfFeederLoss=diverseRfFeederLoss, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitCapacity=transmitCapacity, linkNameMismatch=linkNameMismatch, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, neighborInternetAddress=neighborInternetAddress)
