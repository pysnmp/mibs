...
MibIdentifier, IpAddress, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Gauge32, Unsigned32, Integer32, TimeTicks, Counter64, ObjectIdentity, NotificationType, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Gauge32", "Unsigned32", "Integer32", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, vectorError=vectorError, iFCableLength=iFCableLength, enableTransmission=enableTransmission, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, userRole=userRole, rFURfBand=rFURfBand, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, minModulation=minModulation, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNMPPortNumber=sNMPPortNumber, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, l2CPPriorityTable=l2CPPriorityTable, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, timeZone=timeZone, ptp=ptp, rFUBranchingConfiguration=rFUBranchingConfiguration, sNTPLastSync=sNTPLastSync, secureModeAlarm=secureModeAlarm, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, diverseRfFeederLoss=diverseRfFeederLoss, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, syslogControl=syslogControl, alarms=alarms, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerRetries=sNTPServerRetries, rfu=rfu, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, linkLoss=linkLoss, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, remotePrimaryMACAddress=remotePrimaryMACAddress, daylightSaving=daylightSaving, softwareVersion=softwareVersion, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, maxCodeRate=maxCodeRate, sMTPServerPortNumber=sMTPServerPortNumber, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionConfig=protectionConfig, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFURxFreqMin=rFURxFreqMin, transmitCodeRate=transmitCodeRate, sNMPTrapTable=sNMPTrapTable, ptp800=ptp800, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, syslogStateTrap=syslogStateTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortStatus=dataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, syslogClientTrap=syslogClientTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, latitude=latitude, userEnabled=userEnabled, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, iPv6Address=iPv6Address, dSCPManagementPriority=dSCPManagementPriority, protectionStateTrap=protectionStateTrap, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, iPVersion=iPVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, licence=licence, protectionState=protectionState, rFUStatusTrap=rFUStatusTrap, userPassword=userPassword, sMTPSourceEmailAddress=sMTPSourceEmailAddress, rFURxFreqMax=rFURxFreqMax, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, dataPortWirelessDownAlert=dataPortWirelessDownAlert, primaryRecovery=primaryRecovery, securityLevel=securityLevel, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitCapacityLimit=transmitCapacityLimit, protectionInterfaceStatus=protectionInterfaceStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, numberOfAntennas=numberOfAntennas, managementPortStatus=managementPortStatus, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxFreqMax=rFUTxFreqMax, hardwareVersion=hardwareVersion, sNTPServerTableNumber=sNTPServerTableNumber, diverseAntennaGain=diverseAntennaGain, remoteInternetAddress=remoteInternetAddress, rFUTransceiverLocation=rFUTransceiverLocation, radioLicenseRxFreq=radioLicenseRxFreq, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, smtp=smtp, remotePrimaryInternetAddress=remotePrimaryInternetAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerIPAddress=sNTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, versions=versions, sNTPServerTable=sNTPServerTable, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVIDValidation=vLANManagementVIDValidation, fiberY=fiberY, ptmp=ptmp, rFUPowerAlarm=rFUPowerAlarm, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, dataPortFiberStatusTrap=dataPortFiberStatusTrap, qOSPriorityScheme=qOSPriorityScheme, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFURFSwitchAlarm=rFURFSwitchAlarm, protectionConfigurationStatus=protectionConfigurationStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityVid=rxDiversityVid, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTable=ethernetPriorityTable, snmpControl=snmpControl, rFUStatus=rFUStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, userTableEntry=userTableEntry, encryption=encryption, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, managementPortStatusTrap=managementPortStatusTrap, primarySecondaryMode=primarySecondaryMode, iPv6PrefixLength=iPv6PrefixLength, iPv6GatewayAddress=iPv6GatewayAddress, transmitPower=transmitPower, ethernet=ethernet, bootVersion=bootVersion, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, rFFeederLoss=rFFeederLoss, ethernetPriorityTableNumber=ethernetPriorityTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, radioLicenseCodeRate=radioLicenseCodeRate, rFUType=rFUType, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPSyncTrap=sNTPSyncTrap, subnetMask=subnetMask, hTTPPortNumber=hTTPPortNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, userTable=userTable, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMinModulation=radioLicenseMinModulation, rFUTxBandAboveRx=rFUTxBandAboveRx, protection=protection, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerIPAddress=tFTPServerIPAddress, phyStatus=phyStatus, transmitCapacityLimitDetail=transmitCapacityLimitDetail, aTPCEnable=aTPCEnable, radioLicenseIdentifier=radioLicenseIdentifier, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNTPServerTimeout=sNTPServerTimeout, neighborIPAddress=neighborIPAddress, rFUTxPowerMin=rFUTxPowerMin, sNTPPrimaryServer=sNTPPrimaryServer, alignmentMode=alignmentMode, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, sNTPSync=sNTPSync, protectionStats=protectionStats, antennaGain=antennaGain, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatusTrap=dataPortStatusTrap, radioLicense=radioLicense, managementPortDisabledWarning=managementPortDisabledWarning, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, productName=productName, transmitCapacity=transmitCapacity, receiveModulation=receiveModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, radioLicenseBand=radioLicenseBand, dataPortFiberStatus=dataPortFiberStatus, endId=endId, activeAvailableTime=activeAvailableTime, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, phyControl=phyControl, radioLicenseModulation=radioLicenseModulation, localPacketFiltering=localPacketFiltering, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUCableAlarm=rFUCableAlarm, transmitModulation=transmitModulation, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUVersionBank2=rFUVersionBank2, primaryRecoveryPeriod=primaryRecoveryPeriod, cambium=cambium, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUSerial=rFUSerial, iPv4Address=iPv4Address, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, mPLSTCPriorityTable=mPLSTCPriorityTable, iPDSCPPriorityTable=iPDSCPPriorityTable, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUPowerButtonPressed=rFUPowerButtonPressed, protectionAvailabilityStatus=protectionAvailabilityStatus, sMTPEmailAlert=sMTPEmailAlert, faultProtectionSwitching=faultProtectionSwitching, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, rFUFreqSpacing=rFUFreqSpacing, remoteMACAddress=remoteMACAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, radioLicenseRegion=radioLicenseRegion, bridge=bridge, supplementary=supplementary, sNMPTrapInternetAddress=sNMPTrapInternetAddress)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, reset=reset, syslogClient=syslogClient, sNTPPollInterval=sNTPPollInterval, rFUVersionBank1=rFUVersionBank1, managementMode=managementMode, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, transmitDataRate=transmitDataRate, tFTPServerInternetAddress=tFTPServerInternetAddress, protectionSwitchCause=protectionSwitchCause, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, management=management, gatewayIPAddress=gatewayIPAddress, minCodeRate=minCodeRate, aggregateDataRate=aggregateDataRate, rFUTxPowerMax=rFUTxPowerMax, telnetPortNumber=telnetPortNumber, neighborInternetAddress=neighborInternetAddress, ptpTraps=ptpTraps, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, maxModulation=maxModulation, protectionStatus=protectionStatus, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, requestedProtectionState=requestedProtectionState, configuration=configuration, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementVID=vLANManagementVID, receiveCodeRate=receiveCodeRate, aAAControl=aAAControl, rFURpsAlarm=rFURpsAlarm, linkNameMismatchTrap=linkNameMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, siteName=siteName, transmitterStatus=transmitterStatus, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, neighborInternetAddressType=neighborInternetAddressType, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, receiveDataRate=receiveDataRate, longitude=longitude, sNTPServerInternetAddress=sNTPServerInternetAddress, radioLicenseMaxModulation=radioLicenseMaxModulation, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, unitOutOfCalibration=unitOutOfCalibration, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, rFUTxFreqMin=rFUTxFreqMin, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, systemClock=systemClock, remoteInternetAddressType=remoteInternetAddressType, linkNameMismatch=linkNameMismatch, dataPortPauseFrames=dataPortPauseFrames, alignmentModeTrap=alignmentModeTrap, secureModeAlarmTrap=secureModeAlarmTrap, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, sNTPServerResponse=sNTPServerResponse, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, activeUnit=activeUnit, productVariant=productVariant, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sntp=sntp, rFULockoutAlarm=rFULockoutAlarm, managementPortAutoNegotiation=managementPortAutoNegotiation, linkName=linkName, remoteIPAddress=remoteIPAddress, encryptionEnabledMismatch=encryptionEnabledMismatch, rFUTxMuteStatus=rFUTxMuteStatus, sNMPCommunityString=sNMPCommunityString, neighborMACAddress=neighborMACAddress, remotePrimaryIPAddress=remotePrimaryIPAddress, userTableNumber=userTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rFUConnectedPlatform=rFUConnectedPlatform, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
