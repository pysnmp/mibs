...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUType=rFUType, sMTPEmailAlert=sMTPEmailAlert, rFUTxFreqMin=rFUTxFreqMin, transmitCapacityLimit=transmitCapacityLimit, sNTPServerTableIndex=sNTPServerTableIndex, aTPCEnable=aTPCEnable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, subnetMask=subnetMask, useVLANForManagementInterfaces=useVLANForManagementInterfaces, softwareVersion=softwareVersion, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, receiveCodeRate=receiveCodeRate, sNTPServerRetries=sNTPServerRetries, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, remotePrimaryMACAddress=remotePrimaryMACAddress, dSCPManagementPriority=dSCPManagementPriority, iPv6PrefixLength=iPv6PrefixLength, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, dataPortStatus=dataPortStatus, fiberY=fiberY, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, managementPortStatusTrap=managementPortStatusTrap, neighborInternetAddressType=neighborInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPServerTable=sNTPServerTable, hTTPPortNumber=hTTPPortNumber, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, vectorError=vectorError, rFUTxFreqMax=rFUTxFreqMax, tFTPServerInternetAddressType=tFTPServerInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNMPTrapInternetAddress=sNMPTrapInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, requestedProtectionState=requestedProtectionState, managementCommittedInformationRate=managementCommittedInformationRate, dataPortFiberStatusTrap=dataPortFiberStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, secureModeAlarmTrap=secureModeAlarmTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, hardwareVersion=hardwareVersion, protectionSwitchCause=protectionSwitchCause, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, securityLevel=securityLevel, userName=userName, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUPowerAlarm=rFUPowerAlarm, protectionStateTrap=protectionStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, rFUTransceiverLocation=rFUTransceiverLocation, sNTPSync=sNTPSync, iPv4Address=iPv4Address, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, radioLicenseMaxEIRP=radioLicenseMaxEIRP, transmitterStatus=transmitterStatus, altitude=altitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, antennaGain=antennaGain, rFUBranchingConfiguration=rFUBranchingConfiguration, telnetAccessEnabled=telnetAccessEnabled, transmitPower=transmitPower, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, linkNameMismatchTrap=linkNameMismatchTrap, l2CPPriorityTable=l2CPPriorityTable, secureModeAlarm=secureModeAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, versions=versions, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, userTableNumber=userTableNumber, protectionState=protectionState, siteName=siteName, linkLoss=linkLoss, l2CPPriorityTableNumber=l2CPPriorityTableNumber, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortForcedConfiguration=managementPortForcedConfiguration, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, tFTPServerIPAddress=tFTPServerIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, longitude=longitude, ptpTraps=ptpTraps, rfu=rfu, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, minCodeRate=minCodeRate, bootVersion=bootVersion, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, iFCableLength=iFCableLength, sMTPServerIPAddress=sMTPServerIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFUTxPowerMin=rFUTxPowerMin, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUConnectedPlatform=rFUConnectedPlatform, userRole=userRole, maxCodeRate=maxCodeRate, alignmentMode=alignmentMode, ethernet=ethernet, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, hTTPAccessEnabled=hTTPAccessEnabled, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxPowerMax=rFUTxPowerMax, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, alignmentModeTrap=alignmentModeTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteInternetAddress=remoteInternetAddress, systemClock=systemClock, userPassword=userPassword, syslogClientTrap=syslogClientTrap, enableTransmission=enableTransmission, receiveDataRate=receiveDataRate, ethernetPriorityTableEntry=ethernetPriorityTableEntry, radioLicenseModulation=radioLicenseModulation, sNMPCommunityString=sNMPCommunityString, rFURxFreqMin=rFURxFreqMin, telnetPortNumber=telnetPortNumber, rFUActiveFirmwareBank=rFUActiveFirmwareBank, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, encryption=encryption, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, protection=protection, rFUStatus=rFUStatus, iPv6GatewayAddress=iPv6GatewayAddress, reset=reset, transmitDataRate=transmitDataRate, rFUTxBandAboveRx=rFUTxBandAboveRx, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, localPacketFiltering=localPacketFiltering, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, tFTPServerPortNumber=tFTPServerPortNumber, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, neighborIPAddress=neighborIPAddress, rFUVersionBank1=rFUVersionBank1, unitOutOfCalibration=unitOutOfCalibration, alarms=alarms, protectionStats=protectionStats, ethernetPriorityTableNumber=ethernetPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatusTrap=dataPortStatusTrap, remotePrimarySecondaryMode=remotePrimarySecondaryMode, transmitCapacity=transmitCapacity, activeAvailableTime=activeAvailableTime, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, radioLicenseTxFreq=radioLicenseTxFreq, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteInternetAddressType=remoteInternetAddressType, ethernetFiberSupport=ethernetFiberSupport, remoteSecondaryIPAddress=remoteSecondaryIPAddress, endId=endId, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, ptp=ptp, vLANManagementVID=vLANManagementVID, sNMPTrapVersion=sNMPTrapVersion, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNMPTrapTable=sNMPTrapTable, managementPortAutoNegotiation=managementPortAutoNegotiation, managementMode=managementMode, aggregateDataRate=aggregateDataRate, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseBandwidth=radioLicenseBandwidth, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, primaryRecovery=primaryRecovery, ptmp=ptmp, rxDiversityDataPortStatus=rxDiversityDataPortStatus, protectionInterfaceStatus=protectionInterfaceStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, dataPortPauseFrames=dataPortPauseFrames, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, radioLicenseMinModulation=radioLicenseMinModulation, dataPortFiberStatus=dataPortFiberStatus, supplementary=supplementary, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, phyControl=phyControl, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogClient=syslogClient, tFTPServerInternetAddress=tFTPServerInternetAddress, receiveModulation=receiveModulation, sNMPEnabledTraps=sNMPEnabledTraps, diverseRfFeederLoss=diverseRfFeederLoss, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rFUCableAlarm=rFUCableAlarm, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPState=sNTPState, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, protectionConfigurationStatus=protectionConfigurationStatus, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licence=licence, linkNameMismatch=linkNameMismatch, rFURfBand=rFURfBand, bridge=bridge, snmpControl=snmpControl, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, rFULockoutAlarm=rFULockoutAlarm, userTableEntry=userTableEntry, numberOfAntennas=numberOfAntennas, remoteIPAddress=remoteIPAddress, sNTPServerResponse=sNTPServerResponse, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPVersion=iPVersion, latitude=latitude, rFUTxMuteStatus=rFUTxMuteStatus, userTableIndex=userTableIndex, productName=productName, protectionStatus=protectionStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, diverseAntennaGain=diverseAntennaGain, radioLicenseCodeRate=radioLicenseCodeRate, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, syslogState=syslogState, radioLicenseBand=radioLicenseBand, rFUStatusTrap=rFUStatusTrap, aAAControl=aAAControl, sNTPServerTimeout=sNTPServerTimeout, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, productVariant=productVariant, iPv6Address=iPv6Address)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, neighborInternetAddress=neighborInternetAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, hTTPSPortNumber=hTTPSPortNumber, rFFeederLoss=rFFeederLoss, sNTPPrimaryServer=sNTPPrimaryServer, qOSPriorityScheme=qOSPriorityScheme, receivePower=receivePower, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFURpsAlarm=rFURpsAlarm, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortDisabledWarning=managementPortDisabledWarning, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, ptp800=ptp800, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, primarySecondaryMode=primarySecondaryMode, vLANManagementVIDValidation=vLANManagementVIDValidation, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, transmitModulation=transmitModulation, rFUSerial=rFUSerial, userTable=userTable, rFUFreqSpacing=rFUFreqSpacing, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPSyncTrap=sNTPSyncTrap, pubStats=pubStats, transmitCodeRate=transmitCodeRate, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, smtp=smtp, rFUPowerButtonPressed=rFUPowerButtonPressed, iPDSCPPriorityTable=iPDSCPPriorityTable, rFUProtectionCompatibility=rFUProtectionCompatibility, maxModulation=maxModulation, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFURxFreqMax=rFURxFreqMax, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, timeZone=timeZone, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, radioLicenseMaxModulation=radioLicenseMaxModulation, rFURFSwitchAlarm=rFURFSwitchAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, ethernetPriorityTable=ethernetPriorityTable, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicense=radioLicense, syslogStateTrap=syslogStateTrap, radioLicenseRxFreq=radioLicenseRxFreq, sMTPSourceEmailAddress=sMTPSourceEmailAddress, faultProtectionSwitching=faultProtectionSwitching, minModulation=minModulation, neighborMACAddress=neighborMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rxDiversityVid=rxDiversityVid, protectionConfig=protectionConfig, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUPlatformCompatibility=rFUPlatformCompatibility, management=management, sNTPServerTableNumber=sNTPServerTableNumber, configuration=configuration, rxDiversityVlanTpid=rxDiversityVlanTpid, radioLicenseRegion=radioLicenseRegion, remoteMACAddress=remoteMACAddress, managementPortConfigurationMismatch=managementPortConfigurationMismatch, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerIPAddress=sNTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rFUVersionBank2=rFUVersionBank2, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, radioLicenseIdentifier=radioLicenseIdentifier, activeUnit=activeUnit, managementPortStatus=managementPortStatus, sNTPLastSync=sNTPLastSync)
