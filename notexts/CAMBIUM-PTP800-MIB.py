...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, sMTPServerInternetAddress=sMTPServerInternetAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, iPv6PrefixLength=iPv6PrefixLength, remotePrimaryIPAddress=remotePrimaryIPAddress, minCodeRate=minCodeRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, linkNameMismatchTrap=linkNameMismatchTrap, ptpTraps=ptpTraps, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteMACAddress=remoteMACAddress, rFUConnectedPlatform=rFUConnectedPlatform, sNTPSyncTrap=sNTPSyncTrap, sNTPServerTableEntry=sNTPServerTableEntry, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, primarySecondaryMode=primarySecondaryMode, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, dSCPManagementPriority=dSCPManagementPriority, telnetPortNumber=telnetPortNumber, rxDiversityVid=rxDiversityVid, radioLicenseBandwidth=radioLicenseBandwidth, ptpTrapPrefix=ptpTrapPrefix, receiveCodeRate=receiveCodeRate, aTPCEnable=aTPCEnable, radioLicenseModulation=radioLicenseModulation, cambium=cambium, radioLicense=radioLicense, sNMPTrapVersion=sNMPTrapVersion, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerTableIndex=sNTPServerTableIndex, sMTPServerInternetAddressType=sMTPServerInternetAddressType, iPv4Address=iPv4Address, faultProtectionSwitching=faultProtectionSwitching, remoteIPAddress=remoteIPAddress, userTableEntry=userTableEntry, daylightSaving=daylightSaving, rFUType=rFUType, rFUTxFreqMax=rFUTxFreqMax, activeWirelessLinkAvailability=activeWirelessLinkAvailability, ethernetPriorityTableIndex=ethernetPriorityTableIndex, management=management, sNTPServerTableNumber=sNTPServerTableNumber, protectionInterfaceStatus=protectionInterfaceStatus, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, rFUBranchingConfiguration=rFUBranchingConfiguration, managementPortWirelessDownAlert=managementPortWirelessDownAlert, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, managementCommittedInformationRate=managementCommittedInformationRate, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, useVLANForManagementInterfaces=useVLANForManagementInterfaces, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, smtp=smtp, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, managementMode=managementMode, alignmentMode=alignmentMode, rFUProtectionCompatibility=rFUProtectionCompatibility, linkNameMismatch=linkNameMismatch, dataPortStatus=dataPortStatus, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, syslogClientTrap=syslogClientTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, vLANManagementPriority=vLANManagementPriority, linkName=linkName, primaryRecovery=primaryRecovery, userPassword=userPassword, transmitterStatus=transmitterStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, managementPortStatusTrap=managementPortStatusTrap, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetPriorityTableNumber=ethernetPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, enableTransmission=enableTransmission, wirelessLinkStatusTrap=wirelessLinkStatusTrap, protectionStateTrap=protectionStateTrap, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, systemReset=systemReset, sNTPLastSync=sNTPLastSync, radioLicenseCodeRate=radioLicenseCodeRate, bridge=bridge, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, remotePrimarySecondaryMode=remotePrimarySecondaryMode, dataPortPauseFrames=dataPortPauseFrames, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, phyStatus=phyStatus, maxModulation=maxModulation, radioLicenseMaxEIRP=radioLicenseMaxEIRP, l2CPPriorityTable=l2CPPriorityTable, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerResponse=sNTPServerResponse, sNTPServerInternetAddressType=sNTPServerInternetAddressType, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, activeUnit=activeUnit, versions=versions, rFUStatusTrap=rFUStatusTrap, hardwareVersion=hardwareVersion, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, syslogControl=syslogControl, rFFeederLoss=rFFeederLoss, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, radioLicenseRegion=radioLicenseRegion, userTableIndex=userTableIndex, latitude=latitude, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licence=licence, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseBand=radioLicenseBand, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, encryption=encryption, l2CPPriorityTableIndex=l2CPPriorityTableIndex, pubStats=pubStats, neighborMACAddress=neighborMACAddress, userTableNumber=userTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, protectionConfig=protectionConfig, subnetMask=subnetMask, longitude=longitude, altitude=altitude, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, aAAControl=aAAControl, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, sNTPServerRetries=sNTPServerRetries, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, hTTPAccessEnabled=hTTPAccessEnabled, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, numberOfAntennas=numberOfAntennas, vectorError=vectorError, rFUActiveFirmwareBank=rFUActiveFirmwareBank, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, rFURfBand=rFURfBand, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNTPServerInternetAddress=sNTPServerInternetAddress, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, securityLevel=securityLevel, iPv6GatewayAddress=iPv6GatewayAddress, rxDiversityVlanTpid=rxDiversityVlanTpid, maxCodeRate=maxCodeRate, diverseAntennaGain=diverseAntennaGain, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUVersionBank2=rFUVersionBank2, rFUTxFreqMin=rFUTxFreqMin, rfu=rfu, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUCableAlarm=rFUCableAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, secureModeAlarmTrap=secureModeAlarmTrap, systemClock=systemClock, managementPortAutoNegotiation=managementPortAutoNegotiation, rFUPlatformCompatibility=rFUPlatformCompatibility, userName=userName, vLANManagementVID=vLANManagementVID, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, receiveModulation=receiveModulation, rFUFreqSpacing=rFUFreqSpacing, productName=productName, protectionConfigurationStatus=protectionConfigurationStatus, sNMPCommunityString=sNMPCommunityString, rFURpsAlarm=rFURpsAlarm, sNTPServerTimeout=sNTPServerTimeout, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, protectionStatus=protectionStatus, linkLoss=linkLoss, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseMinModulation=radioLicenseMinModulation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, fiberY=fiberY, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulation=transmitModulation, syslogState=syslogState, alarms=alarms, sntp=sntp, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUTxPowerMax=rFUTxPowerMax, softwareVersion=softwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, requestedProtectionState=requestedProtectionState, rFUSerial=rFUSerial, userEnabled=userEnabled, tFTPServerPortNumber=tFTPServerPortNumber, rFUPowerAlarm=rFUPowerAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, bootVersion=bootVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, iFCableLength=iFCableLength, iPv6Address=iPv6Address, transmitPower=transmitPower, sNMPTrapInternetAddress=sNMPTrapInternetAddress, remotePrimaryInternetAddress=remotePrimaryInternetAddress, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, alignmentModeTrap=alignmentModeTrap, rFUTransceiverLocation=rFUTransceiverLocation, encryptionAlgorithm=encryptionAlgorithm, sNTPServerPortNumber=sNTPServerPortNumber, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitCodeRate=transmitCodeRate, diverseRfFeederLoss=diverseRfFeederLoss, rFUStatus=rFUStatus, remoteSecondaryMACAddress=remoteSecondaryMACAddress, remoteInternetAddress=remoteInternetAddress, localPacketFiltering=localPacketFiltering)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, managementPortStatus=managementPortStatus, protectionState=protectionState, ethernet=ethernet, receivePower=receivePower, remoteInternetAddressType=remoteInternetAddressType, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, aggregateDataRate=aggregateDataRate, rFUTxMuteStatus=rFUTxMuteStatus, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, unitOutOfCalibration=unitOutOfCalibration, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, ptp800=ptp800, dataPortDisabledWarning=dataPortDisabledWarning, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, telnetAccessEnabled=telnetAccessEnabled, neighborInternetAddressType=neighborInternetAddressType, sNTPServerTable=sNTPServerTable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, activeAvailableTime=activeAvailableTime, configuration=configuration, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, productVariant=productVariant, radioLicenseTxFreq=radioLicenseTxFreq, reset=reset, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, ethernetPriorityTable=ethernetPriorityTable, gatewayIPAddress=gatewayIPAddress, rFUVersionBank1=rFUVersionBank1, siteName=siteName, ptmp=ptmp, phyControl=phyControl, transmitCapacity=transmitCapacity, transmitCapacityLimit=transmitCapacityLimit, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remotePrimaryMACAddress=remotePrimaryMACAddress, sNMPTrapTable=sNMPTrapTable, rFUPowerButtonPressed=rFUPowerButtonPressed, neighborInternetAddress=neighborInternetAddress, qOSPriorityScheme=qOSPriorityScheme, l2CPPriorityTableEntry=l2CPPriorityTableEntry, dataPortFiberStatus=dataPortFiberStatus, rFULockoutAlarm=rFULockoutAlarm, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, userTable=userTable, supplementary=supplementary, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, transmitCapacityLimitDetail=transmitCapacityLimitDetail, hTTPSAccessEnabled=hTTPSAccessEnabled, rFURxFreqMax=rFURxFreqMax, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, neighborIPAddress=neighborIPAddress, endId=endId, sNMPPortNumber=sNMPPortNumber, rFUTxPowerMin=rFUTxPowerMin, minModulation=minModulation, radioLicenseMinCodeRate=radioLicenseMinCodeRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPVersion=iPVersion, tFTPServerInternetAddressType=tFTPServerInternetAddressType, protectionStats=protectionStats, protectionSwitchCause=protectionSwitchCause, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, transmitDataRate=transmitDataRate, userRole=userRole, secureModeAlarm=secureModeAlarm, rFURFSwitchAlarm=rFURFSwitchAlarm, protection=protection, managementPortForcedConfiguration=managementPortForcedConfiguration, radioLicenseMaxModulation=radioLicenseMaxModulation, rFUTxPowerAlarm=rFUTxPowerAlarm, rFURxFreqMin=rFURxFreqMin, sNTPSync=sNTPSync, managementPortConfigurationMismatch=managementPortConfigurationMismatch)
