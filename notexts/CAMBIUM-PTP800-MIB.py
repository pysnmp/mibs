...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, Counter32, enterprises, TimeTicks, NotificationType, IpAddress, Gauge32, MibIdentifier, Counter64, iso, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "Counter32", "enterprises", "TimeTicks", "NotificationType", "IpAddress", "Gauge32", "MibIdentifier", "Counter64", "iso", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, syslogState=syslogState, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, syslogClientTrap=syslogClientTrap, rFUSerial=rFUSerial, versions=versions, l2CPPriorityTableNumber=l2CPPriorityTableNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUPlatformCompatibility=rFUPlatformCompatibility, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPServerInternetAddressType=sNTPServerInternetAddressType, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, sNTPPollInterval=sNTPPollInterval, aggregateDataRate=aggregateDataRate, transmitterStatus=transmitterStatus, rFUType=rFUType, sNTPServerRetries=sNTPServerRetries, userTable=userTable, dataPortFiberStatus=dataPortFiberStatus, iPv6Address=iPv6Address, rFULockoutAlarm=rFULockoutAlarm, syslogStateTrap=syslogStateTrap, faultProtectionSwitching=faultProtectionSwitching, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, tFTPServerInternetAddressType=tFTPServerInternetAddressType, radioLicenseBandwidth=radioLicenseBandwidth, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, neighborInternetAddress=neighborInternetAddress, ptp=ptp, iPDSCPPriorityTable=iPDSCPPriorityTable, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, securityLevel=securityLevel, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, iPVersion=iPVersion, linkName=linkName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, timeZone=timeZone, userTableNumber=userTableNumber, userEnabled=userEnabled, sNMPEnabledTraps=sNMPEnabledTraps, ethernetFiberSupport=ethernetFiberSupport, sNTPLastSync=sNTPLastSync, rFUTxPowerMin=rFUTxPowerMin, remoteInternetAddress=remoteInternetAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitDataRate=transmitDataRate, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUFreqSpacing=rFUFreqSpacing, ptmp=ptmp, rFUPowerAlarm=rFUPowerAlarm, dataPortStatus=dataPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, linkNameMismatchTrap=linkNameMismatchTrap, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseTxFreq=radioLicenseTxFreq, protectionSwitchCause=protectionSwitchCause, ptpTrapPrefix=ptpTrapPrefix, managementPortForcedConfiguration=managementPortForcedConfiguration, hTTPPortNumber=hTTPPortNumber, remoteInternetAddressType=remoteInternetAddressType, radioLicenseRegion=radioLicenseRegion, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, radioLicenseMaxEIRP=radioLicenseMaxEIRP, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPServerTimeout=sNTPServerTimeout, aTPCEnable=aTPCEnable, ptpTraps=ptpTraps, iPv4Address=iPv4Address, telnetPortNumber=telnetPortNumber, bootVersion=bootVersion, dataPortDisabledWarning=dataPortDisabledWarning, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, endId=endId, smtp=smtp, encryption=encryption, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFUConnectedPlatform=rFUConnectedPlatform, linkNameMismatch=linkNameMismatch, transmitCodeRate=transmitCodeRate, minModulation=minModulation, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, alignmentMode=alignmentMode, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, longitude=longitude, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, maxModulation=maxModulation, hTTPAccessEnabled=hTTPAccessEnabled, activeAvailableTime=activeAvailableTime, rFURpsAlarm=rFURpsAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, userPassword=userPassword, cambium=cambium, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, diverseRfFeederLoss=diverseRfFeederLoss, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetPriorityTableEntry=ethernetPriorityTableEntry, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, managementPortDisabledWarning=managementPortDisabledWarning, sMTPServerInternetAddress=sMTPServerInternetAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, tFTPServerIPAddress=tFTPServerIPAddress, secureModeAlarm=secureModeAlarm, remoteIPAddress=remoteIPAddress, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, syslogLocalWrappedTrap=syslogLocalWrappedTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerTableNumber=sNTPServerTableNumber, localPacketFiltering=localPacketFiltering, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityTable=mPLSTCPriorityTable, primaryRecovery=primaryRecovery, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, remoteMACAddress=remoteMACAddress, managementCommittedInformationRate=managementCommittedInformationRate, managementMode=managementMode, transmitCapacityLimitDetail=transmitCapacityLimitDetail, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, receiveCodeRate=receiveCodeRate, syslogClient=syslogClient, wirelessLinkAvailability=wirelessLinkAvailability, rFUTransceiverLocation=rFUTransceiverLocation, iPv6PrefixLength=iPv6PrefixLength, dataPortStatusTrap=dataPortStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, requestedProtectionState=requestedProtectionState, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNMPPortNumber=sNMPPortNumber, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, transmitCapacity=transmitCapacity, encryptionEnabledMismatch=encryptionEnabledMismatch, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, radioLicenseModulation=radioLicenseModulation, tFTPServerInternetAddress=tFTPServerInternetAddress, daylightSaving=daylightSaving, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerTable=sNTPServerTable, bridge=bridge, alignmentModeTrap=alignmentModeTrap, protectionStateTrap=protectionStateTrap, radioLicenseBand=radioLicenseBand, minCodeRate=minCodeRate, reset=reset, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, rFUTxPowerMax=rFUTxPowerMax, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, iPv6GatewayAddress=iPv6GatewayAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, supplementary=supplementary, numberOfAntennas=numberOfAntennas, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFURfBand=rFURfBand, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerTableEntry=sNTPServerTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, vectorError=vectorError, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementPortStatus=managementPortStatus, primarySecondaryMode=primarySecondaryMode, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, rFUTxBandAboveRx=rFUTxBandAboveRx, ptp800=ptp800, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, vLANManagementVIDValidation=vLANManagementVIDValidation, sMTPServerPortNumber=sMTPServerPortNumber, protectionStatus=protectionStatus, activeUnit=activeUnit, systemClock=systemClock, sNMPTrapInternetAddress=sNMPTrapInternetAddress, syslogControl=syslogControl, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUCableAlarm=rFUCableAlarm, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUStatus=rFUStatus, remotePrimaryInternetAddress=remotePrimaryInternetAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, subnetMask=subnetMask, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUVersionBank2=rFUVersionBank2, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, maxCodeRate=maxCodeRate, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rxDiversityVlanTpid=rxDiversityVlanTpid, neighborInternetAddressType=neighborInternetAddressType, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableIndex=l2CPPriorityTableIndex, protectionState=protectionState, userName=userName, enableTransmission=enableTransmission, radioLicenseCodeRate=radioLicenseCodeRate, remotePrimaryIPAddress=remotePrimaryIPAddress, productVariant=productVariant, snmpControl=snmpControl, latitude=latitude, sNTPState=sNTPState, qOSPriorityScheme=qOSPriorityScheme, iFCableLength=iFCableLength, sNTPServerInternetAddress=sNTPServerInternetAddress, receiveDataRate=receiveDataRate, dSCPManagementPriority=dSCPManagementPriority, transmitModulation=transmitModulation, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, primaryRecoveryPeriod=primaryRecoveryPeriod, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", licence=licence, neighborIPAddress=neighborIPAddress, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sNTPServerResponse=sNTPServerResponse, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableNumber=sNMPTrapTableNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUTxMuteStatus=rFUTxMuteStatus, dataPortPauseFrames=dataPortPauseFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, neighborMACAddress=neighborMACAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, gatewayIPAddress=gatewayIPAddress, rFUVersionBank1=rFUVersionBank1, altitude=altitude, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, productName=productName, softwareVersion=softwareVersion, sNTPSync=sNTPSync, configuration=configuration, management=management, ethernetPriorityTable=ethernetPriorityTable, managementPortStatusTrap=managementPortStatusTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, transmitPower=transmitPower, pubStats=pubStats, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, receiveModulation=receiveModulation, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionConfigurationStatus=protectionConfigurationStatus, sMTPEnabledMessages=sMTPEnabledMessages, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, secureModeAlarmTrap=secureModeAlarmTrap, rFURxFreqMin=rFURxFreqMin, radioLicenseMinModulation=radioLicenseMinModulation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sMTPServerInternetAddressType=sMTPServerInternetAddressType, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, receivePower=receivePower, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, unitOutOfCalibration=unitOutOfCalibration, tFTPServerPortNumber=tFTPServerPortNumber, protectionInterfaceStatus=protectionInterfaceStatus, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sntp=sntp, l2CPPriorityTable=l2CPPriorityTable, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rxDiversityVid=rxDiversityVid, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFUStatusTrap=rFUStatusTrap, rFFeederLoss=rFFeederLoss, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionConfig=protectionConfig, rFURxFreqMax=rFURxFreqMax, rFUProtectionCompatibility=rFUProtectionCompatibility, radioLicense=radioLicense, protection=protection, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, transmitCapacityLimit=transmitCapacityLimit, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, fiberY=fiberY, linkLoss=linkLoss, userTableEntry=userTableEntry, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, protectionAvailabilityStatus=protectionAvailabilityStatus, rFUTxFreqMin=rFUTxFreqMin, remoteSecondaryMACAddress=remoteSecondaryMACAddress, phyControl=phyControl, protectionStats=protectionStats, sNMPCommunityString=sNMPCommunityString, rfu=rfu, vLANManagementPriority=vLANManagementPriority, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, phyStatus=phyStatus, rFUTxFreqMax=rFUTxFreqMax)
