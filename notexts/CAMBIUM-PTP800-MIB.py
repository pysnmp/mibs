...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", l2CPPriorityTable=l2CPPriorityTable, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, enableTransmission=enableTransmission, encryptionEnabledMismatch=encryptionEnabledMismatch, sNMPCommunityString=sNMPCommunityString, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, faultProtectionSwitching=faultProtectionSwitching, bootVersion=bootVersion, dataPortFiberStatus=dataPortFiberStatus, alignmentMode=alignmentMode, remotePrimaryInternetAddress=remotePrimaryInternetAddress, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, maxCodeRate=maxCodeRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rFUVersionBank1=rFUVersionBank1, neighborMACAddress=neighborMACAddress, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTxMuteStatus=rFUTxMuteStatus, userTable=userTable, rFUTxPowerMax=rFUTxPowerMax, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, rxDiversityDataPortStatus=rxDiversityDataPortStatus, sNTPServerTable=sNTPServerTable, sNMPTrapIPAddress=sNMPTrapIPAddress, rfu=rfu, rFUType=rFUType, transmitterStatus=transmitterStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitCapacityLimit=transmitCapacityLimit, remoteIPAddress=remoteIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, secureModeAlarmTrap=secureModeAlarmTrap, receiveDataRate=receiveDataRate, primaryRecoveryPeriod=primaryRecoveryPeriod, minModulation=minModulation, aAAControl=aAAControl, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, remotePrimaryIPAddress=remotePrimaryIPAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, remoteSecondaryMACAddress=remoteSecondaryMACAddress, sNTPServerResponse=sNTPServerResponse, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFFeederLoss=rFFeederLoss, tFTPServerInternetAddress=tFTPServerInternetAddress, sMTPServerInternetAddress=sMTPServerInternetAddress, radioLicense=radioLicense, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapVersion=sNMPTrapVersion, iPv4Address=iPv4Address, dataPortPauseFrames=dataPortPauseFrames, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, maxModulation=maxModulation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, longitude=longitude, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, radioLicenseRegion=radioLicenseRegion, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, vLANManagementPriority=vLANManagementPriority, siteName=siteName, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, phyStatus=phyStatus, sNTPPrimaryServer=sNTPPrimaryServer, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFULockoutAlarm=rFULockoutAlarm, sMTPServerPortNumber=sMTPServerPortNumber, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTransceiverLocation=rFUTransceiverLocation, protectionAvailabilityStatus=protectionAvailabilityStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sNTPSync=sNTPSync, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, minCodeRate=minCodeRate, receivePower=receivePower, receiveCodeRate=receiveCodeRate, rFUTxPowerAlarm=rFUTxPowerAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, dSCPManagementPriority=dSCPManagementPriority, rFUCableAlarm=rFUCableAlarm, rFUTxFreqMin=rFUTxFreqMin, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, cambium=cambium, iPv6GatewayAddress=iPv6GatewayAddress, versions=versions, syslogState=syslogState, localPacketFiltering=localPacketFiltering, managementMode=managementMode, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, activeAvailableTime=activeAvailableTime, rFUConnectedPlatform=rFUConnectedPlatform, mPLSTCPriorityTable=mPLSTCPriorityTable, rFUProtectionCompatibility=rFUProtectionCompatibility, sMTPEmailAlert=sMTPEmailAlert, rFUPlatformCompatibility=rFUPlatformCompatibility, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerIPAddress=sNTPServerIPAddress, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFURpsAlarm=rFURpsAlarm, protectionConfig=protectionConfig, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUSerial=rFUSerial, remoteInternetAddress=remoteInternetAddress, ptp800=ptp800, vLANManagementVIDValidation=vLANManagementVIDValidation, snmpControl=snmpControl, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPPortNumber=sNMPPortNumber, rFUPowerAlarm=rFUPowerAlarm, endId=endId, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, reset=reset, sNTPState=sNTPState, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortStatusTrap=managementPortStatusTrap, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secureModeAlarm=secureModeAlarm, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFURxFreqMax=rFURxFreqMax, rxDiversityVid=rxDiversityVid, rFURxFreqMin=rFURxFreqMin, sNMPTrapInternetAddress=sNMPTrapInternetAddress, activeUnit=activeUnit, rFUPowerButtonPressed=rFUPowerButtonPressed, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, iPDSCPPriorityTable=iPDSCPPriorityTable, radioLicenseCodeRate=radioLicenseCodeRate, qOSPriorityScheme=qOSPriorityScheme, radioLicenseBand=radioLicenseBand, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, hTTPPortNumber=hTTPPortNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, remoteMACAddress=remoteMACAddress, rFUFreqSpacing=rFUFreqSpacing, tFTPServerPortNumber=tFTPServerPortNumber, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, productVariant=productVariant, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, radioLicenseIdentifier=radioLicenseIdentifier, sNTPLastSync=sNTPLastSync, protectionStateTrap=protectionStateTrap, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, primaryRecovery=primaryRecovery, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortDisabledWarning=dataPortDisabledWarning, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFURfBand=rFURfBand, sNTPServerTimeout=sNTPServerTimeout, iPv6PrefixLength=iPv6PrefixLength, rFUStatus=rFUStatus, radioLicenseTxFreq=radioLicenseTxFreq, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, ptp=ptp, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, primarySecondaryMode=primarySecondaryMode, encryption=encryption, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, sNTPServerRetries=sNTPServerRetries, radioLicenseRxFreq=radioLicenseRxFreq, softwareVersion=softwareVersion, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, unitOutOfCalibration=unitOutOfCalibration, sNTPServerInternetAddress=sNTPServerInternetAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, hardwareVersion=hardwareVersion, alignmentModeTrap=alignmentModeTrap, protectionInterfaceStatus=protectionInterfaceStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPServerTableIndex=sNTPServerTableIndex, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, userPassword=userPassword, userRole=userRole, rFUTxBandAboveRx=rFUTxBandAboveRx, vLANManagementVID=vLANManagementVID, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, vectorError=vectorError, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, remoteSecondaryIPAddress=remoteSecondaryIPAddress, radioLicenseBandwidth=radioLicenseBandwidth, transmitCapacity=transmitCapacity, neighborInternetAddress=neighborInternetAddress, linkName=linkName, ptmp=ptmp, remoteInternetAddressType=remoteInternetAddressType, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, protectionSwitchCause=protectionSwitchCause, sNTPSyncTrap=sNTPSyncTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, securityLevel=securityLevel, protectionStats=protectionStats, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, phyControl=phyControl, requestedProtectionState=requestedProtectionState, numberOfAntennas=numberOfAntennas, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, aTPCEnable=aTPCEnable, bridge=bridge, wirelessLinkAvailability=wirelessLinkAvailability, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", pubStats=pubStats, radioLicenseMinModulation=radioLicenseMinModulation, managementPortDisabledWarning=managementPortDisabledWarning, subnetMask=subnetMask, remotePrimarySecondaryMode=remotePrimarySecondaryMode, iFCableLength=iFCableLength, rFUVersionBank2=rFUVersionBank2, managementPortStatus=managementPortStatus, licence=licence, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTxFreqMax=rFUTxFreqMax, linkLoss=linkLoss, rFURFSwitchAlarm=rFURFSwitchAlarm, alarms=alarms, transmitCodeRate=transmitCodeRate, receiveModulation=receiveModulation, antennaGain=antennaGain, transmitPower=transmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, l2CPPriorityTableEntry=l2CPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, neighborIPAddress=neighborIPAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, protectionStatus=protectionStatus, hTTPAccessEnabled=hTTPAccessEnabled, userTableEntry=userTableEntry, managementPortConfigurationMismatch=managementPortConfigurationMismatch, management=management, iPv6Address=iPv6Address, linkNameMismatch=linkNameMismatch, protectionState=protectionState, productName=productName, fiberY=fiberY, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, latitude=latitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, neighborInternetAddressType=neighborInternetAddressType, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerTableNumber=sNTPServerTableNumber, protectionConfigurationStatus=protectionConfigurationStatus, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, maximumTransmitPower=maximumTransmitPower, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, rFUTxPowerMin=rFUTxPowerMin, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, userEnabled=userEnabled, managementPortAutoNegotiation=managementPortAutoNegotiation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, syslogClientTrap=syslogClientTrap, remotePrimaryMACAddress=remotePrimaryMACAddress, transmitModulation=transmitModulation, systemReset=systemReset, diverseAntennaGain=diverseAntennaGain, managementCommittedInformationRate=managementCommittedInformationRate, rFUStatusTrap=rFUStatusTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, dataPortStatus=dataPortStatus, diverseRfFeederLoss=diverseRfFeederLoss, altitude=altitude, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, iPVersion=iPVersion, sNTPServerTableEntry=sNTPServerTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, ethernetPriorityTable=ethernetPriorityTable, protection=protection, supplementary=supplementary, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, gatewayIPAddress=gatewayIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, linkNameMismatchTrap=linkNameMismatchTrap, smtp=smtp, radioLicenseModulation=radioLicenseModulation)
