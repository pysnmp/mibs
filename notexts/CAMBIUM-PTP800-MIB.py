...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, sNTPSync=sNTPSync, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, transmitCapacity=transmitCapacity, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, rFUVersionBank2=rFUVersionBank2, sMTPEmailAlert=sMTPEmailAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerInternetAddress=tFTPServerInternetAddress, alarms=alarms, reset=reset, protectionStatus=protectionStatus, userName=userName, phyControl=phyControl, alignmentModeTrap=alignmentModeTrap, radioLicense=radioLicense, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, rFUVersionBank1=rFUVersionBank1, bootVersion=bootVersion, daylightSaving=daylightSaving, protectionAvailabilityStatus=protectionAvailabilityStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, remoteMACAddress=remoteMACAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, transmitModulation=transmitModulation, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseMaxEIRP=radioLicenseMaxEIRP, encryptionAlgorithm=encryptionAlgorithm, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, remotePrimaryIPAddress=remotePrimaryIPAddress, iFCableLength=iFCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, productVariant=productVariant, receiveDataRate=receiveDataRate, dataPortDisabledWarning=dataPortDisabledWarning, managementPortForcedConfiguration=managementPortForcedConfiguration, rFUFreqSpacing=rFUFreqSpacing, rxDiversityDataPortStatus=rxDiversityDataPortStatus, neighborInternetAddress=neighborInternetAddress, sNTPPrimaryServer=sNTPPrimaryServer, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, localPacketFiltering=localPacketFiltering, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortPauseFrames=dataPortPauseFrames, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, management=management, sNTPServerRetries=sNTPServerRetries, qOSPriorityScheme=qOSPriorityScheme, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulation=receiveModulation, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFURpsAlarm=rFURpsAlarm, subnetMask=subnetMask, ptmp=ptmp, iPv6Address=iPv6Address, rFFeederLoss=rFFeederLoss, remoteInternetAddress=remoteInternetAddress, requestedProtectionState=requestedProtectionState, ethernetFiberSupport=ethernetFiberSupport, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, linkName=linkName, transmitCapacityLimitDetail=transmitCapacityLimitDetail, linkLoss=linkLoss, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, remotePrimaryInternetAddress=remotePrimaryInternetAddress, syslogClient=syslogClient, syslogControl=syslogControl, neighborMACAddress=neighborMACAddress, ptp800=ptp800, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, transmitCapacityLimit=transmitCapacityLimit, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, protectionSwitchCause=protectionSwitchCause, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPVersion=iPVersion, activeUnit=activeUnit, remoteIPAddress=remoteIPAddress, gatewayIPAddress=gatewayIPAddress, sNTPServerTimeout=sNTPServerTimeout, tFTPServerIPAddress=tFTPServerIPAddress, receiveCodeRate=receiveCodeRate, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, sNTPServerIPAddress=sNTPServerIPAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, userTableIndex=userTableIndex, dataPortStatus=dataPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortStatus=managementPortStatus, numberOfAntennas=numberOfAntennas, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, sNTPServerTableIndex=sNTPServerTableIndex, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUPowerAlarm=rFUPowerAlarm, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxFreqMin=rFUTxFreqMin, primaryRecovery=primaryRecovery, primaryRecoveryPeriod=primaryRecoveryPeriod, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, smtp=smtp, latitude=latitude, ethernet=ethernet, rFURfBand=rFURfBand, userTable=userTable, dSCPManagementPriority=dSCPManagementPriority, radioLicenseMinModulation=radioLicenseMinModulation, rFUTransceiverLocation=rFUTransceiverLocation, dataPortStatusTrap=dataPortStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, hTTPSPortNumber=hTTPSPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, receivePower=receivePower, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUStatusTrap=rFUStatusTrap, alignmentMode=alignmentMode, configuration=configuration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, protectionStateTrap=protectionStateTrap, userEnabled=userEnabled, hardwareVersion=hardwareVersion, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFUCableAlarm=rFUCableAlarm, radioLicenseMaxModulation=radioLicenseMaxModulation, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, ptp=ptp, radioLicenseCodeRate=radioLicenseCodeRate, primarySecondaryMode=primarySecondaryMode, rFURxFreqMin=rFURxFreqMin, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, siteName=siteName, vLANManagementVIDValidation=vLANManagementVIDValidation, sNTPPollInterval=sNTPPollInterval, radioLicenseModulation=radioLicenseModulation, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUPowerButtonPressed=rFUPowerButtonPressed, cambium=cambium, rFURxFreqMax=rFURxFreqMax, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, activeAvailableTime=activeAvailableTime, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, tFTPServerInternetAddressType=tFTPServerInternetAddressType, encryption=encryption, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, diverseRfFeederLoss=diverseRfFeederLoss, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, ptpTraps=ptpTraps, radioLicenseTxFreq=radioLicenseTxFreq, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitterStatus=transmitterStatus, sNTPLastSync=sNTPLastSync, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protection=protection, l2CPPriorityTable=l2CPPriorityTable, sNTPServerTableNumber=sNTPServerTableNumber, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, iPv6GatewayAddress=iPv6GatewayAddress, phyStatus=phyStatus, systemClock=systemClock, encryptionEnabledMismatch=encryptionEnabledMismatch, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, minCodeRate=minCodeRate, sNMPCommunityString=sNMPCommunityString, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, snmpControl=snmpControl, transmitPower=transmitPower, enableTransmission=enableTransmission, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, rFUTxFreqMax=rFUTxFreqMax, rFUTxBandAboveRx=rFUTxBandAboveRx, ethernetPriorityTable=ethernetPriorityTable, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, endId=endId, sNTPServerResponse=sNTPServerResponse, managementPortDisabledWarning=managementPortDisabledWarning, productName=productName, telnetPortNumber=telnetPortNumber, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, maximumTransmitPower=maximumTransmitPower, minModulation=minModulation, maxModulation=maxModulation, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, secureModeAlarmTrap=secureModeAlarmTrap, rFUSerial=rFUSerial, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, supplementary=supplementary, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityVid=rxDiversityVid, mPLSTCPriorityTable=mPLSTCPriorityTable, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, managementPortStatusTrap=managementPortStatusTrap, rfu=rfu, timeZone=timeZone, radioLicenseBandwidth=radioLicenseBandwidth, sNTPSyncTrap=sNTPSyncTrap, maxCodeRate=maxCodeRate, secondarySoftwareVersion=secondarySoftwareVersion)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, aggregateDataRate=aggregateDataRate, protectionConfigurationStatus=protectionConfigurationStatus, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, vLANManagementVID=vLANManagementVID, transmitCodeRate=transmitCodeRate, faultProtectionSwitching=faultProtectionSwitching, neighborIPAddress=neighborIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, securityLevel=securityLevel, rFUType=rFUType, sntp=sntp, userPassword=userPassword, dataPortFiberStatus=dataPortFiberStatus, remoteInternetAddressType=remoteInternetAddressType, sNTPServerTable=sNTPServerTable, managementMode=managementMode, fiberY=fiberY, protectionState=protectionState, secureModeAlarm=secureModeAlarm, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, protectionInterfaceStatus=protectionInterfaceStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, syslogStateTrap=syslogStateTrap, managementPortWirelessDownAlert=managementPortWirelessDownAlert, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, syslogClientTrap=syslogClientTrap, protectionStats=protectionStats, managementPortConfigurationMismatch=managementPortConfigurationMismatch, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sNMPTrapVersion=sNMPTrapVersion, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, rFUTxPowerMin=rFUTxPowerMin, systemReset=systemReset, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, pubStats=pubStats, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rFUTxPowerMax=rFUTxPowerMax, linkNameMismatchTrap=linkNameMismatchTrap, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, iPv6PrefixLength=iPv6PrefixLength, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, versions=versions, protectionConfig=protectionConfig, rFURFSwitchAlarm=rFURFSwitchAlarm, wirelessLinkStatus=wirelessLinkStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUTxMuteStatus=rFUTxMuteStatus, rFUProtectionCompatibility=rFUProtectionCompatibility, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, radioLicenseRegion=radioLicenseRegion, aTPCEnable=aTPCEnable, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, sMTPServerInternetAddress=sMTPServerInternetAddress, rFUStatus=rFUStatus, iPDSCPPriorityTable=iPDSCPPriorityTable, vectorError=vectorError, managementPortAutoNegotiation=managementPortAutoNegotiation, neighborInternetAddressType=neighborInternetAddressType, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseRxFreq=radioLicenseRxFreq, radioLicenseBand=radioLicenseBand, rFULockoutAlarm=rFULockoutAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, licence=licence, userRole=userRole, linkNameMismatch=linkNameMismatch, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, rxDiversityVlanTpid=rxDiversityVlanTpid, remoteSecondaryIPAddress=remoteSecondaryIPAddress, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, managementCommittedInformationRate=managementCommittedInformationRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, wirelessLinkStatusTrap=wirelessLinkStatusTrap, bridge=bridge, ptpTrapPrefix=ptpTrapPrefix, iPv4Address=iPv4Address, radioLicenseMinCodeRate=radioLicenseMinCodeRate)
