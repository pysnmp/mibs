...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", syslogClientTrap=syslogClientTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, latitude=latitude, sNMPTrapInternetAddress=sNMPTrapInternetAddress, protectionConfig=protectionConfig, localPacketFiltering=localPacketFiltering, radioLicenseMinModulation=radioLicenseMinModulation, telnetAccessEnabled=telnetAccessEnabled, radioLicenseBand=radioLicenseBand, l2CPPriorityTable=l2CPPriorityTable, receiveCodeRate=receiveCodeRate, protectionState=protectionState, managementPortStatusTrap=managementPortStatusTrap, sNMPTrapVersion=sNMPTrapVersion, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, ethernetPriorityTable=ethernetPriorityTable, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPSyncTrap=sNTPSyncTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddressType=remoteInternetAddressType, rFURFSwitchAlarm=rFURFSwitchAlarm, vLANManagementVIDValidation=vLANManagementVIDValidation, unitOutOfCalibration=unitOutOfCalibration, dataPortStatus=dataPortStatus, linkName=linkName, sNTPServerTableEntry=sNTPServerTableEntry, rFUSerial=rFUSerial, primaryRecoveryPeriod=primaryRecoveryPeriod, dataPortPauseFrames=dataPortPauseFrames, versions=versions, sNMPTrapTableNumber=sNMPTrapTableNumber, userTable=userTable, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, managementPortAutoNegotiation=managementPortAutoNegotiation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, ptp800=ptp800, remoteInternetAddress=remoteInternetAddress, softwareVersion=softwareVersion, radioLicenseMaxEIRP=radioLicenseMaxEIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSPortNumber=hTTPSPortNumber, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, iPv6GatewayAddress=iPv6GatewayAddress, systemReset=systemReset, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUVersionBank2=rFUVersionBank2, syslogState=syslogState, aggregateDataRate=aggregateDataRate, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTable=sNMPTrapTable, transmitCodeRate=transmitCodeRate, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, radioLicenseMinCodeRate=radioLicenseMinCodeRate, protectionStats=protectionStats, radioLicenseIdentifier=radioLicenseIdentifier, protectionSwitchCause=protectionSwitchCause, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, subnetMask=subnetMask, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, activeAvailableTime=activeAvailableTime, rFUTxFreqMin=rFUTxFreqMin, cambium=cambium, receivePower=receivePower, remoteSecondaryIPAddress=remoteSecondaryIPAddress, rxDiversityDataPortStatus=rxDiversityDataPortStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, neighborInternetAddress=neighborInternetAddress, maxCodeRate=maxCodeRate, userRole=userRole, smtp=smtp, ethernet=ethernet, phyControl=phyControl, dSCPManagementPriority=dSCPManagementPriority, radioLicenseMaxModulation=radioLicenseMaxModulation, fiberY=fiberY, tFTPServerInternetAddress=tFTPServerInternetAddress, iPVersion=iPVersion, sNTPServerTimeout=sNTPServerTimeout, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, transmitDataRate=transmitDataRate, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, protectionStatus=protectionStatus, sNMPCommunityString=sNMPCommunityString, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, dataPortFiberStatus=dataPortFiberStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, dataPortFiberStatusTrap=dataPortFiberStatusTrap, ptpTraps=ptpTraps, receiveDataRate=receiveDataRate, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFUConnectedPlatform=rFUConnectedPlatform, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, minModulation=minModulation, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitCapacityLimit=transmitCapacityLimit, rFUTxFreqMax=rFUTxFreqMax, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, ptp=ptp, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, licence=licence, wirelessLinkAvailability=wirelessLinkAvailability, endId=endId, sNTPServerRetries=sNTPServerRetries, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, rFUTxPowerMin=rFUTxPowerMin, sMTPServerIPAddress=sMTPServerIPAddress, reset=reset, diverseRfFeederLoss=diverseRfFeederLoss, l2CPPriorityTableNumber=l2CPPriorityTableNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, radioLicenseModulation=radioLicenseModulation, phyStatus=phyStatus, encryptionAlgorithm=encryptionAlgorithm, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNTPServerPortNumber=sNTPServerPortNumber, managementCommittedInformationRate=managementCommittedInformationRate, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFUFreqSpacing=rFUFreqSpacing, primaryRecovery=primaryRecovery, ethernetPriorityTableNumber=ethernetPriorityTableNumber, rFUPlatformCompatibility=rFUPlatformCompatibility, alignmentModeTrap=alignmentModeTrap, rFURxFreqMax=rFURxFreqMax, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementMode=managementMode, secureModeAlarm=secureModeAlarm, protectionInterfaceStatus=protectionInterfaceStatus, sNTPServerTableNumber=sNTPServerTableNumber, rFUTxMuteStatus=rFUTxMuteStatus, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, tFTPServerIPAddress=tFTPServerIPAddress, transmitCapacity=transmitCapacity, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, tFTPServerPortNumber=tFTPServerPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPState=sNTPState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, maxModulation=maxModulation, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, rFURpsAlarm=rFURpsAlarm, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerTableIndex=sNTPServerTableIndex, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUCableAlarm=rFUCableAlarm, rFURxFreqMin=rFURxFreqMin, alarms=alarms, faultProtectionSwitching=faultProtectionSwitching, remotePrimaryInternetAddress=remotePrimaryInternetAddress, protectionStateTrap=protectionStateTrap, linkNameMismatchTrap=linkNameMismatchTrap, hTTPPortNumber=hTTPPortNumber, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, radioLicenseBandwidth=radioLicenseBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, syslogControl=syslogControl, remotePrimarySecondaryMode=remotePrimarySecondaryMode, managementPortDisabledWarning=managementPortDisabledWarning, numberOfAntennas=numberOfAntennas, radioLicenseRegion=radioLicenseRegion, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetPriorityTableEntry=ethernetPriorityTableEntry, protectionAvailabilityStatus=protectionAvailabilityStatus, enableTransmission=enableTransmission, ptpTrapPrefix=ptpTrapPrefix, transmitModulation=transmitModulation, rFUVersionBank1=rFUVersionBank1, rFURfBand=rFURfBand, rFUPowerAlarm=rFUPowerAlarm, sntp=sntp, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatus=wirelessLinkStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, sNTPServerResponse=sNTPServerResponse, sNMPEnabledTraps=sNMPEnabledTraps, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFUTxPowerMax=rFUTxPowerMax, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, productVariant=productVariant, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUType=rFUType, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, secureModeAlarmTrap=secureModeAlarmTrap, productName=productName, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, userPassword=userPassword, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, iPv6PrefixLength=iPv6PrefixLength, receiveModulation=receiveModulation, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remotePrimaryMACAddress=remotePrimaryMACAddress, syslogClient=syslogClient, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, neighborInternetAddressType=neighborInternetAddressType, secondarySoftwareVersion=secondarySoftwareVersion, radioLicenseTxFreq=radioLicenseTxFreq, maximumTransmitPower=maximumTransmitPower, altitude=altitude, userName=userName, protectionConfigurationStatus=protectionConfigurationStatus, pubStats=pubStats, antennaGain=antennaGain, protection=protection, minCodeRate=minCodeRate, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, vLANManagementVID=vLANManagementVID, radioLicenseRxFreq=radioLicenseRxFreq, iPDSCPPriorityTable=iPDSCPPriorityTable, rFFeederLoss=rFFeederLoss, hTTPSAccessEnabled=hTTPSAccessEnabled)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", primarySecondaryMode=primarySecondaryMode, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, userTableNumber=userTableNumber, management=management, linkNameMismatch=linkNameMismatch, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, iFCableLength=iFCableLength, vectorError=vectorError, sNTPLastSync=sNTPLastSync, rFUStatus=rFUStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, ethernetPriorityTableIndex=ethernetPriorityTableIndex, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, snmpControl=snmpControl, bridge=bridge, wirelessLinkStatusTrap=wirelessLinkStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bootVersion=bootVersion, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPServerTable=sNTPServerTable, aTPCEnable=aTPCEnable, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alignmentMode=alignmentMode, rFULockoutAlarm=rFULockoutAlarm, neighborIPAddress=neighborIPAddress, rfu=rfu, neighborMACAddress=neighborMACAddress, sNTPSync=sNTPSync, radioLicenseCodeRate=radioLicenseCodeRate, rxDiversityVid=rxDiversityVid, securityLevel=securityLevel, iPv6Address=iPv6Address, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTable=mPLSTCPriorityTable, radioLicense=radioLicense, userEnabled=userEnabled, sNTPPrimaryServer=sNTPPrimaryServer, managementPortForcedConfiguration=managementPortForcedConfiguration, daylightSaving=daylightSaving, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, remoteMACAddress=remoteMACAddress, sMTPServerInternetAddressType=sMTPServerInternetAddressType, activeUnit=activeUnit, rFUTxBandAboveRx=rFUTxBandAboveRx, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, qOSPriorityScheme=qOSPriorityScheme, encryption=encryption, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, rFUStatusTrap=rFUStatusTrap, longitude=longitude, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, transmitterStatus=transmitterStatus, l2CPPriorityTableEntry=l2CPPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, rFUPowerButtonPressed=rFUPowerButtonPressed, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUProtectionCompatibility=rFUProtectionCompatibility, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, diverseAntennaGain=diverseAntennaGain, systemClock=systemClock, ptmp=ptmp, iPv4Address=iPv4Address, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortStatus=managementPortStatus, configuration=configuration, rFUTxPowerAlarm=rFUTxPowerAlarm, transmitPower=transmitPower, requestedProtectionState=requestedProtectionState)
