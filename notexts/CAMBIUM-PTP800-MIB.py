...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseModulation=radioLicenseModulation, sNTPPrimaryServer=sNTPPrimaryServer, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, diverseAntennaGain=diverseAntennaGain, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rFUFreqSpacing=rFUFreqSpacing, managementPortConfigurationMismatch=managementPortConfigurationMismatch, protectionStateTrap=protectionStateTrap, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatusTrap=wirelessLinkStatusTrap, encryption=encryption, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, gatewayIPAddress=gatewayIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, radioLicenseMinModulation=radioLicenseMinModulation, sNMPEnabledTraps=sNMPEnabledTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, radioLicenseIdentifier=radioLicenseIdentifier, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, protectionAvailabilityStatus=protectionAvailabilityStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUStatus=rFUStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, rFUProtectionCompatibility=rFUProtectionCompatibility, l2CPPriorityTable=l2CPPriorityTable, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, remotePrimaryMACAddress=remotePrimaryMACAddress, protectionConfig=protectionConfig, vLANManagementPriority=vLANManagementPriority, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapTable=sNMPTrapTable, iPv6GatewayAddress=iPv6GatewayAddress, latitude=latitude, radioLicenseBand=radioLicenseBand, rFUTxFreqMax=rFUTxFreqMax, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, maxModulation=maxModulation, ptp800=ptp800, aggregateDataRate=aggregateDataRate, sNTPServerTableNumber=sNTPServerTableNumber, sNTPServerTableEntry=sNTPServerTableEntry, managementCommittedInformationRate=managementCommittedInformationRate, dSCPManagementPriority=dSCPManagementPriority, receivePower=receivePower, transmitCodeRate=transmitCodeRate, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, userName=userName, remotePrimaryInternetAddress=remotePrimaryInternetAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, userTableNumber=userTableNumber, radioLicenseMaxModulation=radioLicenseMaxModulation, vLANManagementVIDValidation=vLANManagementVIDValidation, sNMPPortNumber=sNMPPortNumber, phyControl=phyControl, secondarySoftwareVersion=secondarySoftwareVersion, subnetMask=subnetMask, management=management, neighborIPAddress=neighborIPAddress, maximumTransmitPower=maximumTransmitPower, rFURxFreqMax=rFURxFreqMax, rFUPowerButtonPressed=rFUPowerButtonPressed, pubStats=pubStats, dataPortFiberStatus=dataPortFiberStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerTableIndex=sNTPServerTableIndex, protectionConfigurationStatus=protectionConfigurationStatus, remotePrimarySecondaryMode=remotePrimarySecondaryMode, rFUStatusTrap=rFUStatusTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, ptpTraps=ptpTraps, localPacketFiltering=localPacketFiltering, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, minCodeRate=minCodeRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseRxFreq=radioLicenseRxFreq, dataPortDisabledWarning=dataPortDisabledWarning, ptp=ptp, rFULockoutAlarm=rFULockoutAlarm, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, ethernetFiberSupport=ethernetFiberSupport, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, rFUBranchingConfiguration=rFUBranchingConfiguration, protectionSwitchCause=protectionSwitchCause, transmitDataRate=transmitDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, l2CPPriorityTableNumber=l2CPPriorityTableNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUVersionBank1=rFUVersionBank1, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, rFUTxPowerMax=rFUTxPowerMax, l2CPPriorityTableIndex=l2CPPriorityTableIndex, rFUTxFreqMin=rFUTxFreqMin, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, sNTPServerTimeout=sNTPServerTimeout, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, cambium=cambium, syslogStateTrap=syslogStateTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, sNTPState=sNTPState, sNMPTrapInternetAddress=sNMPTrapInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, alignmentModeTrap=alignmentModeTrap, transmitCapacityLimitDetail=transmitCapacityLimitDetail, minModulation=minModulation, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, dataPortFiberStatusTrap=dataPortFiberStatusTrap, timeZone=timeZone, sNTPLastSync=sNTPLastSync, protection=protection, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUTransceiverLocation=rFUTransceiverLocation, sMTPEmailAlert=sMTPEmailAlert, managementPortStatusTrap=managementPortStatusTrap, remoteInternetAddressType=remoteInternetAddressType, linkLoss=linkLoss, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, tFTPServerInternetAddress=tFTPServerInternetAddress, bootVersion=bootVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, receiveCodeRate=receiveCodeRate, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementMode=managementMode, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, radioLicense=radioLicense, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, protectionState=protectionState, neighborInternetAddress=neighborInternetAddress, rFUVersionBank2=rFUVersionBank2, iPv4Address=iPv4Address, iPv6PrefixLength=iPv6PrefixLength, requestedProtectionState=requestedProtectionState, numberOfAntennas=numberOfAntennas, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, radioLicenseMinCodeRate=radioLicenseMinCodeRate, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortStatus=dataPortStatus, configuration=configuration, secureModeAlarm=secureModeAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remotePrimaryIPAddress=remotePrimaryIPAddress, sntp=sntp, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFURfBand=rFURfBand, sNTPServerRetries=sNTPServerRetries, diverseRfFeederLoss=diverseRfFeederLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, hTTPSPortNumber=hTTPSPortNumber, secureModeAlarmTrap=secureModeAlarmTrap, sNTPServerResponse=sNTPServerResponse, sNTPServerInternetAddress=sNTPServerInternetAddress, alarms=alarms, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionStats=protectionStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, transmitPower=transmitPower, syslogControl=syslogControl, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, transmitCapacity=transmitCapacity, radioLicenseCodeRate=radioLicenseCodeRate, sMTPServerPortNumber=sMTPServerPortNumber, enableTransmission=enableTransmission, receiveModulation=receiveModulation, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, remoteMACAddress=remoteMACAddress, transmitCapacityLimit=transmitCapacityLimit, neighborInternetAddressType=neighborInternetAddressType, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, endId=endId, syslogClientTrap=syslogClientTrap, ethernetPriorityTable=ethernetPriorityTable, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, rFUSerial=rFUSerial, rFUTxMuteStatus=rFUTxMuteStatus, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, primarySecondaryMode=primarySecondaryMode, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, maxCodeRate=maxCodeRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, remoteInternetAddress=remoteInternetAddress, syslogClient=syslogClient, remoteSecondaryIPAddress=remoteSecondaryIPAddress, protectionStatus=protectionStatus, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, alignmentMode=alignmentMode, sNMPCommunityString=sNMPCommunityString, rFUConnectedPlatform=rFUConnectedPlatform, userTable=userTable, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, linkNameMismatchTrap=linkNameMismatchTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, userTableEntry=userTableEntry, rFUCableAlarm=rFUCableAlarm, productName=productName, managementPortStatus=managementPortStatus, transmitModulation=transmitModulation, radioLicenseTxFreq=radioLicenseTxFreq, hTTPPortNumber=hTTPPortNumber, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, wirelessLinkStatus=wirelessLinkStatus, rFURpsAlarm=rFURpsAlarm, rFFeederLoss=rFFeederLoss, productVariant=productVariant)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", sNTPServerTable=sNTPServerTable, managementPortWirelessDownAlert=managementPortWirelessDownAlert, remoteSecondaryMACAddress=remoteSecondaryMACAddress, userPassword=userPassword, rFUPowerAlarm=rFUPowerAlarm, daylightSaving=daylightSaving, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, dataPortPauseFrames=dataPortPauseFrames, vLANManagementVID=vLANManagementVID, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, primaryRecovery=primaryRecovery, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, activeAvailableTime=activeAvailableTime, iPDSCPPriorityTable=iPDSCPPriorityTable, mPLSTCPriorityTable=mPLSTCPriorityTable, systemReset=systemReset, wirelessLinkAvailability=wirelessLinkAvailability, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, userTableIndex=userTableIndex, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, managementPortDisabledWarning=managementPortDisabledWarning, rxDiversityVid=rxDiversityVid, rFUTxBandAboveRx=rFUTxBandAboveRx, vectorError=vectorError, rFUTxPowerMin=rFUTxPowerMin, reset=reset, qOSPriorityScheme=qOSPriorityScheme, siteName=siteName, managementPortAutoNegotiation=managementPortAutoNegotiation, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPVersion=iPVersion, radioLicenseRegion=radioLicenseRegion, primaryRecoveryPeriod=primaryRecoveryPeriod, aTPCEnable=aTPCEnable, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, faultProtectionSwitching=faultProtectionSwitching, neighborMACAddress=neighborMACAddress, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, transmitterStatus=transmitterStatus, encryptionEnabledMismatch=encryptionEnabledMismatch, protectionInterfaceStatus=protectionInterfaceStatus, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, ethernetPriorityTableIndex=ethernetPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, sMTPServerInternetAddressType=sMTPServerInternetAddressType, antennaGain=antennaGain, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, fiberY=fiberY, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, remoteIPAddress=remoteIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, ethernet=ethernet, radioLicenseBandwidth=radioLicenseBandwidth, softwareVersion=softwareVersion, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, ptmp=ptmp, linkName=linkName, rFUType=rFUType, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, activeUnit=activeUnit, linkNameMismatch=linkNameMismatch, altitude=altitude, iFCableLength=iFCableLength, syslogState=syslogState, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, userEnabled=userEnabled, supplementary=supplementary, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, bridge=bridge, sMTPServerIPAddress=sMTPServerIPAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, securityLevel=securityLevel, phyStatus=phyStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, rFURxFreqMin=rFURxFreqMin, iPv6Address=iPv6Address, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rfu=rfu, userRole=userRole, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex)
