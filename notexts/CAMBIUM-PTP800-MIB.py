...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", supplementary=supplementary, rFUTxMuteStatus=rFUTxMuteStatus, managementPortForcedConfiguration=managementPortForcedConfiguration, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, receiveModulation=receiveModulation, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, rFURxFreqMax=rFURxFreqMax, sNMPTrapTable=sNMPTrapTable, localPacketFiltering=localPacketFiltering, managementPortDisabledWarning=managementPortDisabledWarning, userName=userName, ethernetFiberSupport=ethernetFiberSupport, bridge=bridge, ethernet=ethernet, ethernetPriorityTableIndex=ethernetPriorityTableIndex, rFULockoutAlarm=rFULockoutAlarm, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, smtp=smtp, rFUTxPowerAlarm=rFUTxPowerAlarm, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, rFUStatus=rFUStatus, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementVIDValidation=vLANManagementVIDValidation, transmitCapacity=transmitCapacity, transmitCapacityLimit=transmitCapacityLimit, reset=reset, encryptionEnabledMismatch=encryptionEnabledMismatch, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, iPDSCPPriorityTable=iPDSCPPriorityTable, alarms=alarms, transmitDataRate=transmitDataRate, dSCPManagementPriority=dSCPManagementPriority, rFUTxPowerMin=rFUTxPowerMin, rFUVersionBank2=rFUVersionBank2, rFUType=rFUType, rFUBranchingConfiguration=rFUBranchingConfiguration, alignmentModeTrap=alignmentModeTrap, radioLicenseBandwidth=radioLicenseBandwidth, iPv4Address=iPv4Address, linkNameMismatch=linkNameMismatch, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sntp=sntp, sNTPState=sNTPState, radioLicenseMaxModulation=radioLicenseMaxModulation, sNMPTrapTableNumber=sNMPTrapTableNumber, phyControl=phyControl, alignmentMode=alignmentMode, linkNameMismatchTrap=linkNameMismatchTrap, sNTPServerTable=sNTPServerTable, iFCableLength=iFCableLength, remotePrimaryMACAddress=remotePrimaryMACAddress, radioLicenseTxFreq=radioLicenseTxFreq, rFUTxBandAboveRx=rFUTxBandAboveRx, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPv6GatewayAddress=iPv6GatewayAddress, minCodeRate=minCodeRate, rFURFSwitchAlarm=rFURFSwitchAlarm, rxDiversityDataPortStatus=rxDiversityDataPortStatus, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, rxDiversityVlanTpid=rxDiversityVlanTpid, sNTPServerTimeout=sNTPServerTimeout, remoteIPAddress=remoteIPAddress, ethernetPriorityTableEntry=ethernetPriorityTableEntry, enableTransmission=enableTransmission, rFUCableAlarm=rFUCableAlarm, rfu=rfu, minModulation=minModulation, radioLicenseIdentifier=radioLicenseIdentifier, encryption=encryption, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, secureModeAlarmTrap=secureModeAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, protection=protection, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, siteName=siteName, syslogStateTrap=syslogStateTrap, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, syslogClient=syslogClient, syslogState=syslogState, productVariant=productVariant, userRole=userRole, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, ptpTrapPrefix=ptpTrapPrefix, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, l2CPPriorityTableNumber=l2CPPriorityTableNumber, rFUTxPowerMax=rFUTxPowerMax, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, userPassword=userPassword, sNMPTrapPortNumber=sNMPTrapPortNumber, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, managementPortAutoNegotiation=managementPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, activeUnit=activeUnit, iPv6PrefixLength=iPv6PrefixLength, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, bootVersion=bootVersion, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, remoteInternetAddress=remoteInternetAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, faultProtectionSwitching=faultProtectionSwitching, latitude=latitude, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, linkLoss=linkLoss, radioLicenseBand=radioLicenseBand, subnetMask=subnetMask, remoteInternetAddressType=remoteInternetAddressType, sNTPSync=sNTPSync, iPv6Address=iPv6Address, rFURxFreqMin=rFURxFreqMin, sNMPCommunityString=sNMPCommunityString, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, receivePower=receivePower, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, diverseRfFeederLoss=diverseRfFeederLoss, telnetAccessEnabled=telnetAccessEnabled, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, radioLicenseRegion=radioLicenseRegion, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapInternetAddress=sNMPTrapInternetAddress, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, securityLevel=securityLevel, dataPortFiberStatus=dataPortFiberStatus, sNTPPollInterval=sNTPPollInterval, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, rFURpsAlarm=rFURpsAlarm, receiveCodeRate=receiveCodeRate, hTTPSPortNumber=hTTPSPortNumber, timeZone=timeZone, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, ethernetPriorityTable=ethernetPriorityTable, neighborIPAddress=neighborIPAddress, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, neighborInternetAddress=neighborInternetAddress, rFUPowerAlarm=rFUPowerAlarm, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, protectionStatus=protectionStatus, secureModeAlarm=secureModeAlarm, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, remoteMACAddress=remoteMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, rFUSerial=rFUSerial, userTable=userTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, activeWirelessLinkAvailability=activeWirelessLinkAvailability, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, radioLicenseMaxEIRP=radioLicenseMaxEIRP, configuration=configuration, rFUActiveFirmwareBank=rFUActiveFirmwareBank, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, softwareVersion=softwareVersion, systemClock=systemClock, rFUPlatformCompatibility=rFUPlatformCompatibility, linkName=linkName, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, mPLSTCPriorityTable=mPLSTCPriorityTable, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, rFURfBand=rFURfBand, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEmailAlert=sMTPEmailAlert, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpTraps=ptpTraps, userEnabled=userEnabled, rFUProtectionCompatibility=rFUProtectionCompatibility, wirelessLinkStatus=wirelessLinkStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPPortNumber=sNMPPortNumber, protectionStats=protectionStats, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, rFUTransceiverLocation=rFUTransceiverLocation, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, sNTPServerTableEntry=sNTPServerTableEntry, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, remotePrimaryInternetAddress=remotePrimaryInternetAddress, activeAvailableTime=activeAvailableTime, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, longitude=longitude, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, transmitterStatus=transmitterStatus, sNTPServerInternetAddress=sNTPServerInternetAddress, transmitCapacityLimitDetail=transmitCapacityLimitDetail, neighborMACAddress=neighborMACAddress, sNTPServerResponse=sNTPServerResponse, userTableEntry=userTableEntry, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, ptmp=ptmp, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, maximumTransmitPower=maximumTransmitPower, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, vectorError=vectorError, remotePrimaryIPAddress=remotePrimaryIPAddress, aAAControl=aAAControl, managementMode=managementMode, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, versions=versions, cambium=cambium, radioLicenseMinModulation=radioLicenseMinModulation, management=management, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, iPVersion=iPVersion, sNTPServerRetries=sNTPServerRetries, primarySecondaryMode=primarySecondaryMode, protectionAvailabilityStatus=protectionAvailabilityStatus, ptp800=ptp800, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, transmitModulation=transmitModulation, sNTPServerTableNumber=sNTPServerTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, fiberY=fiberY, wirelessLinkStatusTrap=wirelessLinkStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", altitude=altitude, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, diverseAntennaGain=diverseAntennaGain, neighborInternetAddressType=neighborInternetAddressType, maxModulation=maxModulation, endId=endId, rFFeederLoss=rFFeederLoss, hardwareVersion=hardwareVersion, numberOfAntennas=numberOfAntennas, radioLicenseRxFreq=radioLicenseRxFreq, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, managementPortStatusTrap=managementPortStatusTrap, dataPortStatus=dataPortStatus, protectionConfigurationStatus=protectionConfigurationStatus, qOSPriorityScheme=qOSPriorityScheme, unitOutOfCalibration=unitOutOfCalibration, syslogControl=syslogControl, radioLicenseModulation=radioLicenseModulation, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, protectionConfig=protectionConfig, licence=licence, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, maxCodeRate=maxCodeRate, rFUTxFreqMin=rFUTxFreqMin, protectionStateTrap=protectionStateTrap, rxDiversityVid=rxDiversityVid, sMTPServerInternetAddress=sMTPServerInternetAddress, protectionSwitchCause=protectionSwitchCause, transmitCodeRate=transmitCodeRate, rFUPowerButtonPressed=rFUPowerButtonPressed, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, hTTPAccessEnabled=hTTPAccessEnabled, rFUFreqSpacing=rFUFreqSpacing, managementPortStatus=managementPortStatus, requestedProtectionState=requestedProtectionState, gatewayIPAddress=gatewayIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, managementCommittedInformationRate=managementCommittedInformationRate, rFUVersionBank1=rFUVersionBank1, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sMTPServerInternetAddressType=sMTPServerInternetAddressType, l2CPPriorityTable=l2CPPriorityTable, protectionInterfaceStatus=protectionInterfaceStatus, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, sMTPServerPortNumber=sMTPServerPortNumber, dataPortFiberStatusTrap=dataPortFiberStatusTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxFreqMax=rFUTxFreqMax, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPrimaryServer=sNTPPrimaryServer, aggregateDataRate=aggregateDataRate, dataPortPauseFrames=dataPortPauseFrames, remoteSecondaryIPAddress=remoteSecondaryIPAddress, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, remoteSecondaryMACAddress=remoteSecondaryMACAddress, aTPCEnable=aTPCEnable, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerTableIndex=sNTPServerTableIndex, rFUConnectedPlatform=rFUConnectedPlatform, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, radioLicenseCodeRate=radioLicenseCodeRate, radioLicense=radioLicense, protectionState=protectionState, sMTPServerIPAddress=sMTPServerIPAddress, ptp=ptp, snmpControl=snmpControl, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, syslogClientTrap=syslogClientTrap, phyStatus=phyStatus, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, primaryRecovery=primaryRecovery, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementVID=vLANManagementVID, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUStatusTrap=rFUStatusTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod)
