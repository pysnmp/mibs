...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rFUPowerButtonPressed=rFUPowerButtonPressed, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, protectionConfigurationStatus=protectionConfigurationStatus, radioLicenseModulation=radioLicenseModulation, radioLicenseRegion=radioLicenseRegion, sNMPTrapTableEntry=sNMPTrapTableEntry, bridge=bridge, configuration=configuration, productName=productName, pubStats=pubStats, managementPortWirelessDownAlert=managementPortWirelessDownAlert, managementPortConfigurationMismatch=managementPortConfigurationMismatch, sNTPServerTableEntry=sNTPServerTableEntry, radioLicense=radioLicense, secureModeAlarmTrap=secureModeAlarmTrap, management=management, rFUTransceiverLocation=rFUTransceiverLocation, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, supplementary=supplementary, hTTPSAccessEnabled=hTTPSAccessEnabled, antennaGain=antennaGain, syslogClient=syslogClient, remotePrimaryMACAddress=remotePrimaryMACAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, l2CPPriorityTable=l2CPPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, protectionStatus=protectionStatus, sMTPServerInternetAddress=sMTPServerInternetAddress, userTable=userTable, rFUSerial=rFUSerial, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, ptp800=ptp800, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, managementPortForcedConfiguration=managementPortForcedConfiguration, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, sNTPServerRetries=sNTPServerRetries, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, radioLicenseBand=radioLicenseBand, rFUPlatformCompatibility=rFUPlatformCompatibility, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remotePrimaryIPAddress=remotePrimaryIPAddress, managementCommittedInformationRate=managementCommittedInformationRate, iPv6GatewayAddress=iPv6GatewayAddress, fiberY=fiberY, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseMinModulation=radioLicenseMinModulation, iPVersion=iPVersion, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, protectionStats=protectionStats, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, numberOfAntennas=numberOfAntennas, rFUTxBandAboveRx=rFUTxBandAboveRx, receivePower=receivePower, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, encryption=encryption, snmpControl=snmpControl, syslogClientTrap=syslogClientTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPDSCPPriorityTable=iPDSCPPriorityTable, rFFeederLoss=rFFeederLoss, transmitDataRate=transmitDataRate, longitude=longitude, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, secondarySoftwareVersion=secondarySoftwareVersion, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitCapacityLimit=transmitCapacityLimit, ethernetPriorityTableNumber=ethernetPriorityTableNumber, gatewayIPAddress=gatewayIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, iPv4Address=iPv4Address, receiveDataRate=receiveDataRate, transmitCapacityLimitDetail=transmitCapacityLimitDetail, sMTPEmailAlert=sMTPEmailAlert, sNTPServerTableIndex=sNTPServerTableIndex, bootVersion=bootVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, linkLoss=linkLoss, managementMode=managementMode, rFUTxFreqMax=rFUTxFreqMax, remoteIPAddress=remoteIPAddress, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, transmitCapacity=transmitCapacity, sMTPServerPortNumber=sMTPServerPortNumber, rFUConnectedPlatform=rFUConnectedPlatform, vLANManagementVID=vLANManagementVID, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, alarms=alarms, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, sNTPPrimaryServer=sNTPPrimaryServer, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, reset=reset, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerTableNumber=sNTPServerTableNumber, rFURfBand=rFURfBand, rFUActiveFirmwareBank=rFUActiveFirmwareBank, sNMPPortNumber=sNMPPortNumber, dataPortPauseFrames=dataPortPauseFrames, sMTPSourceEmailAddress=sMTPSourceEmailAddress, primarySecondaryMode=primarySecondaryMode, managementPortDisabledWarning=managementPortDisabledWarning, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, neighborMACAddress=neighborMACAddress, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, managementPortAutoNegotiation=managementPortAutoNegotiation, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, neighborInternetAddress=neighborInternetAddress, rFURpsAlarm=rFURpsAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, dataPortStatus=dataPortStatus, secureModeAlarm=secureModeAlarm, rFUTxMuteStatus=rFUTxMuteStatus, ptmp=ptmp, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, ethernet=ethernet, protection=protection, sNTPServerInternetAddressType=sNTPServerInternetAddressType, systemClock=systemClock, radioLicenseTxFreq=radioLicenseTxFreq, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, sNMPTrapInternetAddress=sNMPTrapInternetAddress, minCodeRate=minCodeRate, transmitterStatus=transmitterStatus, rFUBranchingConfiguration=rFUBranchingConfiguration, ethernetFiberSupport=ethernetFiberSupport, minModulation=minModulation, neighborIPAddress=neighborIPAddress, vectorError=vectorError, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, rFUTxPowerMax=rFUTxPowerMax, systemReset=systemReset, rFURFSwitchAlarm=rFURFSwitchAlarm, userName=userName, userPassword=userPassword, rFUStatusTrap=rFUStatusTrap, localPacketFiltering=localPacketFiltering, tFTPServerInternetAddressType=tFTPServerInternetAddressType, protectionSwitchCause=protectionSwitchCause, dataPortWirelessDownAlert=dataPortWirelessDownAlert, radioLicenseIdentifier=radioLicenseIdentifier, radioLicenseMinCodeRate=radioLicenseMinCodeRate, endId=endId, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, rFUTxPowerMin=rFUTxPowerMin, vLANManagementVIDValidation=vLANManagementVIDValidation, dataPortDisabledWarning=dataPortDisabledWarning, dataPortFiberStatus=dataPortFiberStatus, rFUTxFreqMin=rFUTxFreqMin, altitude=altitude, radioLicenseMaxEIRP=radioLicenseMaxEIRP, maxModulation=maxModulation, userEnabled=userEnabled, sNTPServerTable=sNTPServerTable, rFUProtectionCompatibility=rFUProtectionCompatibility, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogControl=syslogControl, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, activeUnit=activeUnit, radioLicenseBandwidth=radioLicenseBandwidth, telnetPortNumber=telnetPortNumber, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionAvailabilityStatus=protectionAvailabilityStatus, hTTPAccessEnabled=hTTPAccessEnabled, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, sMTPServerInternetAddressType=sMTPServerInternetAddressType, maximumTransmitPower=maximumTransmitPower, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, ethernetPriorityTable=ethernetPriorityTable, aggregateDataRate=aggregateDataRate, protectionState=protectionState, sNTPServerTimeout=sNTPServerTimeout, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, activeAvailableTime=activeAvailableTime, userTableIndex=userTableIndex, enableTransmission=enableTransmission, receiveCodeRate=receiveCodeRate, hardwareVersion=hardwareVersion, radioLicenseRxFreq=radioLicenseRxFreq, licence=licence, linkNameMismatchTrap=linkNameMismatchTrap, remoteSecondaryMACAddress=remoteSecondaryMACAddress, iFCableLength=iFCableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogState=syslogState, rFUCableAlarm=rFUCableAlarm, sntp=sntp, rFUStatus=rFUStatus, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUVersionBank1=rFUVersionBank1, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFULockoutAlarm=rFULockoutAlarm, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, tFTPServerPortNumber=tFTPServerPortNumber, cambium=cambium, managementPortStatus=managementPortStatus, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, rFUVersionBank2=rFUVersionBank2, latitude=latitude, diverseRfFeederLoss=diverseRfFeederLoss, iPv6Address=iPv6Address, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteInternetAddress=remoteInternetAddress, productVariant=productVariant, userRole=userRole, activeWirelessLinkAvailability=activeWirelessLinkAvailability, phyStatus=phyStatus, faultProtectionSwitching=faultProtectionSwitching, softwareVersion=softwareVersion, rFUType=rFUType, encryptionEnabledMismatch=encryptionEnabledMismatch, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPLastSync=sNTPLastSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTraps=ptpTraps, protectionConfig=protectionConfig, maxCodeRate=maxCodeRate, linkName=linkName)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dSCPManagementPriority=dSCPManagementPriority, l2CPPriorityTableEntry=l2CPPriorityTableEntry, iPv6PrefixLength=iPv6PrefixLength, sMTPServerIPAddress=sMTPServerIPAddress, rFURxFreqMax=rFURxFreqMax, wirelessLinkStatus=wirelessLinkStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, transmitModulation=transmitModulation, siteName=siteName, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, hTTPSPortNumber=hTTPSPortNumber, managementPortStatusTrap=managementPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableNumber=userTableNumber, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, alignmentMode=alignmentMode, ptpTrapPrefix=ptpTrapPrefix, rFURxFreqMin=rFURxFreqMin, protectionStateTrap=protectionStateTrap, vLANManagementPriority=vLANManagementPriority, transmitCodeRate=transmitCodeRate, timeZone=timeZone, smtp=smtp, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, radioLicenseCodeRate=radioLicenseCodeRate, diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, rxDiversityDataPortStatus=rxDiversityDataPortStatus, primaryRecovery=primaryRecovery, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, qOSPriorityScheme=qOSPriorityScheme, requestedProtectionState=requestedProtectionState, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, aAAControl=aAAControl, rFUPowerAlarm=rFUPowerAlarm, versions=versions, unitOutOfCalibration=unitOutOfCalibration, rFUFreqSpacing=rFUFreqSpacing, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, remoteMACAddress=remoteMACAddress, receiveModulation=receiveModulation, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, neighborInternetAddressType=neighborInternetAddressType, protectionInterfaceStatus=protectionInterfaceStatus, aTPCEnable=aTPCEnable, hTTPPortNumber=hTTPPortNumber, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, sNTPServerResponse=sNTPServerResponse, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sNTPState=sNTPState, rFUTxPowerAlarm=rFUTxPowerAlarm, rxDiversityVid=rxDiversityVid, sNMPCommunityString=sNMPCommunityString, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rfu=rfu, sNTPServerInternetAddress=sNTPServerInternetAddress, ptp=ptp, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, mPLSTCPriorityTable=mPLSTCPriorityTable, l2CPPriorityTableIndex=l2CPPriorityTableIndex, alignmentModeTrap=alignmentModeTrap, encryptionAlgorithm=encryptionAlgorithm, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remotePrimaryInternetAddress=remotePrimaryInternetAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, daylightSaving=daylightSaving, securityLevel=securityLevel, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, phyControl=phyControl, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, telnetAccessEnabled=telnetAccessEnabled, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, tFTPServerIPAddress=tFTPServerIPAddress, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, tFTPServerInternetAddress=tFTPServerInternetAddress, linkNameMismatch=linkNameMismatch, dataPortStatusTrap=dataPortStatusTrap)
