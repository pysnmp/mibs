...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, rFUVersionBank2=rFUVersionBank2, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, secureModeAlarmTrap=secureModeAlarmTrap, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, activeAvailableTime=activeAvailableTime, transmitDataRate=transmitDataRate, transmitCodeRate=transmitCodeRate, ptmp=ptmp, rxDiversityDataPortStatus=rxDiversityDataPortStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, primarySecondaryMode=primarySecondaryMode, rFUFreqSpacing=rFUFreqSpacing, userRole=userRole, managementCommittedInformationRate=managementCommittedInformationRate, radioLicenseRegion=radioLicenseRegion, sNTPServerResponse=sNTPServerResponse, userEnabled=userEnabled, syslogControl=syslogControl, rFUTxBandAboveRx=rFUTxBandAboveRx, dataPortFiberStatus=dataPortFiberStatus, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, iPv4Address=iPv4Address, phyControl=phyControl, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rFURxFreqMax=rFURxFreqMax, userTableEntry=userTableEntry, sNMPTrapTable=sNMPTrapTable, radioLicense=radioLicense, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, receiveDataRate=receiveDataRate, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseMaxEIRP=radioLicenseMaxEIRP, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, pubStats=pubStats, neighborInternetAddressType=neighborInternetAddressType, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, sNTPServerInternetAddress=sNTPServerInternetAddress, sNTPServerTableEntry=sNTPServerTableEntry, sNMPPortNumber=sNMPPortNumber, protectionStats=protectionStats, protectionStateTrap=protectionStateTrap, rFUSerial=rFUSerial, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogStateTrap=syslogStateTrap, sNTPServerTimeout=sNTPServerTimeout, alarms=alarms, userName=userName, wirelessLinkStatusTrap=wirelessLinkStatusTrap, systemClock=systemClock, syslogClient=syslogClient, subnetMask=subnetMask, transmitCapacityLimitDetail=transmitCapacityLimitDetail, maxModulation=maxModulation, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseCodeRate=radioLicenseCodeRate, receiveModulation=receiveModulation, tFTPServerPortNumber=tFTPServerPortNumber, remotePrimaryIPAddress=remotePrimaryIPAddress, vectorError=vectorError, productName=productName, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, transmitterStatus=transmitterStatus, encryption=encryption, softwareVersion=softwareVersion, userTable=userTable, telnetPortNumber=telnetPortNumber, vLANManagementVID=vLANManagementVID, remoteSecondaryMACAddress=remoteSecondaryMACAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, neighborInternetAddress=neighborInternetAddress, activeWirelessLinkAvailability=activeWirelessLinkAvailability, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, mPLSTCPriorityTable=mPLSTCPriorityTable, rfu=rfu, managementPortAutoNegotiation=managementPortAutoNegotiation, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, userTableNumber=userTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, snmpControl=snmpControl, linkNameMismatchTrap=linkNameMismatchTrap, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, rFURxFreqMin=rFURxFreqMin, transmitCapacityLimit=transmitCapacityLimit, protectionConfig=protectionConfig, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, versions=versions, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, protectionSwitchCause=protectionSwitchCause, sNTPServerTable=sNTPServerTable, altitude=altitude, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, ethernetPriorityTableEntry=ethernetPriorityTableEntry, iPv6GatewayAddress=iPv6GatewayAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, supplementary=supplementary, ethernet=ethernet, sNMPTrapPortNumber=sNMPTrapPortNumber, protectionConfigurationStatus=protectionConfigurationStatus, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, rFUActiveFirmwareBank=rFUActiveFirmwareBank, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, remoteIPAddress=remoteIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bridge=bridge, userPassword=userPassword, ptp800=ptp800, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, rxDiversityVlanTpid=rxDiversityVlanTpid, rFUTxPowerAlarm=rFUTxPowerAlarm, remotePrimaryMACAddress=remotePrimaryMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, secureModeAlarm=secureModeAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, fiberY=fiberY, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, latitude=latitude, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, vLANManagementPriority=vLANManagementPriority, sNTPPrimaryServer=sNTPPrimaryServer, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licence=licence, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, securityLevel=securityLevel, localPacketFiltering=localPacketFiltering, dataPortStatus=dataPortStatus, remoteInternetAddress=remoteInternetAddress, rFURpsAlarm=rFURpsAlarm, rFUStatusTrap=rFUStatusTrap, rFUTxMuteStatus=rFUTxMuteStatus, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURfBand=rFURfBand, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, radioLicenseRxFreq=radioLicenseRxFreq, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, antennaGain=antennaGain, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, alignmentModeTrap=alignmentModeTrap, systemReset=systemReset, sNMPTrapTableIndex=sNMPTrapTableIndex, remotePrimaryInternetAddress=remotePrimaryInternetAddress, transmitPower=transmitPower, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, qOSPriorityScheme=qOSPriorityScheme, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, iPVersion=iPVersion, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, ethernetPriorityTableNumber=ethernetPriorityTableNumber, iPv6Address=iPv6Address, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, managementPortStatus=managementPortStatus, rFULockoutAlarm=rFULockoutAlarm, managementPortDisabledWarning=managementPortDisabledWarning, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ptp=ptp, remoteInternetAddressType=remoteInternetAddressType, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, rxDiversityVid=rxDiversityVid, remoteMACAddress=remoteMACAddress, managementMode=managementMode, rFURFSwitchAlarm=rFURFSwitchAlarm, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUCableAlarm=rFUCableAlarm, sNTPState=sNTPState, dataPortPauseFrames=dataPortPauseFrames, ptpTrapPrefix=ptpTrapPrefix, managementPortStatusTrap=managementPortStatusTrap, radioLicenseIdentifier=radioLicenseIdentifier, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, alignmentMode=alignmentMode, numberOfAntennas=numberOfAntennas, hTTPPortNumber=hTTPPortNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, dSCPManagementPriority=dSCPManagementPriority, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, diverseRfFeederLoss=diverseRfFeederLoss, sNTPLastSync=sNTPLastSync, receiveCodeRate=receiveCodeRate, syslogClientTrap=syslogClientTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, protectionAvailabilityStatus=protectionAvailabilityStatus, enableTransmission=enableTransmission, minModulation=minModulation, linkLoss=linkLoss, radioLicenseModulation=radioLicenseModulation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteSecondaryIPAddress=remoteSecondaryIPAddress, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, ethernetPriorityTable=ethernetPriorityTable, minCodeRate=minCodeRate, receivePower=receivePower, managementPortWirelessDownAlert=managementPortWirelessDownAlert, radioLicenseMaxModulation=radioLicenseMaxModulation, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerTableNumber=sNTPServerTableNumber, reset=reset, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, l2CPPriorityTableIndex=l2CPPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUBranchingConfiguration=rFUBranchingConfiguration, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, sNTPSyncTrap=sNTPSyncTrap, rFUTransceiverLocation=rFUTransceiverLocation, rFUPowerButtonPressed=rFUPowerButtonPressed, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPEnabledTraps=sNMPEnabledTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, protectionState=protectionState, rFUPowerAlarm=rFUPowerAlarm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerInternetAddress=tFTPServerInternetAddress, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, rFUType=rFUType, iPv6PrefixLength=iPv6PrefixLength, rFUProtectionCompatibility=rFUProtectionCompatibility, transmitCapacity=transmitCapacity, telnetAccessEnabled=telnetAccessEnabled, rFUTxFreqMin=rFUTxFreqMin)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, faultProtectionSwitching=faultProtectionSwitching, rFUTxPowerMax=rFUTxPowerMax, aTPCEnable=aTPCEnable, sMTPServerInternetAddress=sMTPServerInternetAddress, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, activeUnit=activeUnit, phyStatus=phyStatus, ethernetPriorityTableIndex=ethernetPriorityTableIndex, linkName=linkName, hTTPAccessEnabled=hTTPAccessEnabled, sntp=sntp, dataPortFiberStatusTrap=dataPortFiberStatusTrap, managementPortConfigurationMismatch=managementPortConfigurationMismatch, tFTPServerInternetAddressType=tFTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, radioLicenseMinModulation=radioLicenseMinModulation, rFUConnectedPlatform=rFUConnectedPlatform, sNMPTrapTableNumber=sNMPTrapTableNumber, protectionInterfaceStatus=protectionInterfaceStatus, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, maxCodeRate=maxCodeRate, requestedProtectionState=requestedProtectionState, cambium=cambium, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, l2CPPriorityTable=l2CPPriorityTable, rFUTxPowerMin=rFUTxPowerMin, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseBandwidth=radioLicenseBandwidth, rFFeederLoss=rFFeederLoss, endId=endId, sMTPEnabledMessages=sMTPEnabledMessages, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, rFUVersionBank1=rFUVersionBank1, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, radioLicenseMinCodeRate=radioLicenseMinCodeRate, managementPortForcedConfiguration=managementPortForcedConfiguration, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, sNTPServerRetries=sNTPServerRetries, neighborIPAddress=neighborIPAddress, sNTPServerTableIndex=sNTPServerTableIndex, sNTPSync=sNTPSync, rFUTxFreqMax=rFUTxFreqMax, radioLicenseBand=radioLicenseBand, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, remotePrimarySecondaryMode=remotePrimarySecondaryMode, protection=protection, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hardwareVersion=hardwareVersion, protectionStatus=protectionStatus, l2CPPriorityTableNumber=l2CPPriorityTableNumber, aggregateDataRate=aggregateDataRate, rFUPlatformCompatibility=rFUPlatformCompatibility, longitude=longitude, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, primaryRecoveryPeriod=primaryRecoveryPeriod, configuration=configuration, ptpTraps=ptpTraps, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, neighborMACAddress=neighborMACAddress, rFUStatus=rFUStatus, timeZone=timeZone, iFCableLength=iFCableLength, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkNameMismatch=linkNameMismatch, transmitModulation=transmitModulation, primaryRecovery=primaryRecovery, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, userTableIndex=userTableIndex, encryptionAlgorithm=encryptionAlgorithm, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sMTPEmailAlert=sMTPEmailAlert, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, productVariant=productVariant)
