...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", reset=reset, sMTPServerInternetAddressType=sMTPServerInternetAddressType, rFURxFreqMin=rFURxFreqMin, hardwareVersion=hardwareVersion, remotePrimarySecondaryMode=remotePrimarySecondaryMode, sNTPLastSync=sNTPLastSync, rFURxFreqMax=rFURxFreqMax, rFUTxMuteStatus=rFUTxMuteStatus, managementPortAutoNegotiation=managementPortAutoNegotiation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFURFSwitchAlarm=rFURFSwitchAlarm, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, iPv6PrefixLength=iPv6PrefixLength, sNTPServerTableIndex=sNTPServerTableIndex, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, daylightSaving=daylightSaving, ethernetPriorityTable=ethernetPriorityTable, protection=protection, userTable=userTable, sNTPServerInternetAddressType=sNTPServerInternetAddressType, rFUPlatformCompatibility=rFUPlatformCompatibility, ethernetPriorityTableIndex=ethernetPriorityTableIndex, remoteSecondaryIPAddress=remoteSecondaryIPAddress, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, requestedProtectionState=requestedProtectionState, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, rxDiversityVlanTpid=rxDiversityVlanTpid, syslogState=syslogState, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, hTTPAccessEnabled=hTTPAccessEnabled, configuration=configuration, alignmentModeTrap=alignmentModeTrap, activeUnit=activeUnit, ethernet=ethernet, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, phyStatus=phyStatus, rFUPowerAlarm=rFUPowerAlarm, rFUProtectionCompatibility=rFUProtectionCompatibility, sNTPServerTimeout=sNTPServerTimeout, remotePrimaryMACAddress=remotePrimaryMACAddress, iPDSCPPriorityTable=iPDSCPPriorityTable, ethernetFiberSupport=ethernetFiberSupport, ptpTraps=ptpTraps, receiveCodeRate=receiveCodeRate, wirelessLinkStatus=wirelessLinkStatus, remoteMACAddress=remoteMACAddress, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, userTableEntry=userTableEntry, linkNameMismatchTrap=linkNameMismatchTrap, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, radioLicenseTxFreq=radioLicenseTxFreq, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, numberOfAntennas=numberOfAntennas, sNTPSync=sNTPSync, antennaGain=antennaGain, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, encryptionEnabledMismatch=encryptionEnabledMismatch, transmitDataRate=transmitDataRate, protectionStats=protectionStats, iPv4Address=iPv4Address, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementPortStatus=managementPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, transmitCapacity=transmitCapacity, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, transmitterStatus=transmitterStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteInternetAddressType=remoteInternetAddressType, wirelessLinkStatusTrap=wirelessLinkStatusTrap, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, radioLicenseCodeRate=radioLicenseCodeRate, sNTPServerIPAddress=sNTPServerIPAddress, rFUTxPowerMax=rFUTxPowerMax, rFUVersionBank2=rFUVersionBank2, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPPollInterval=sNTPPollInterval, rFUTxFreqMax=rFUTxFreqMax, alignmentMode=alignmentMode, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, syslogStateTrap=syslogStateTrap, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, rFUTxPowerMin=rFUTxPowerMin, aggregateDataRate=aggregateDataRate, transmitModulation=transmitModulation, pubStats=pubStats, ethernetPriorityTableEntry=ethernetPriorityTableEntry, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, neighborInternetAddress=neighborInternetAddress, vLANManagementVIDValidation=vLANManagementVIDValidation, transmitPower=transmitPower, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFUTransceiverLocation=rFUTransceiverLocation, secureModeAlarm=secureModeAlarm, protectionStatus=protectionStatus, sNTPServerTableNumber=sNTPServerTableNumber, rFUConnectedPlatform=rFUConnectedPlatform, sNMPTrapPortNumber=sNMPTrapPortNumber, iPVersion=iPVersion, vLANManagementPriority=vLANManagementPriority, dataPortPauseFrames=dataPortPauseFrames, rFURfBand=rFURfBand, dataPortStatusTrap=dataPortStatusTrap, rFUCableAlarm=rFUCableAlarm, sMTPEmailAlert=sMTPEmailAlert, radioLicenseBand=radioLicenseBand, transmitCodeRate=transmitCodeRate, activeWirelessLinkAvailability=activeWirelessLinkAvailability, tFTPServerInternetAddressType=tFTPServerInternetAddressType, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, neighborIPAddress=neighborIPAddress, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, phyControl=phyControl, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, gatewayIPAddress=gatewayIPAddress, activeAvailableTime=activeAvailableTime, sNTPServerRetries=sNTPServerRetries, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseRegion=radioLicenseRegion, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secureModeAlarmTrap=secureModeAlarmTrap, linkNameMismatch=linkNameMismatch, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, transmitCapacityLimit=transmitCapacityLimit, rFUFreqSpacing=rFUFreqSpacing, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, l2CPPriorityTableEntry=l2CPPriorityTableEntry, syslogClient=syslogClient, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, neighborInternetAddressType=neighborInternetAddressType, sNMPCommunityString=sNMPCommunityString, latitude=latitude, dSCPManagementPriority=dSCPManagementPriority, linkName=linkName, sNTPServerTable=sNTPServerTable, diverseAntennaGain=diverseAntennaGain, mPLSTCPriorityTable=mPLSTCPriorityTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, altitude=altitude, siteName=siteName, rFULockoutAlarm=rFULockoutAlarm, userPassword=userPassword, securityLevel=securityLevel, rFUPowerButtonPressed=rFUPowerButtonPressed, radioLicenseBandwidth=radioLicenseBandwidth, enableTransmission=enableTransmission, licence=licence, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, rxDiversityDataPortStatus=rxDiversityDataPortStatus, iPv6Address=iPv6Address, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, vectorError=vectorError, rFUTxPowerAlarm=rFUTxPowerAlarm, protectionAvailabilityStatus=protectionAvailabilityStatus, userEnabled=userEnabled, faultProtectionSwitching=faultProtectionSwitching, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, minCodeRate=minCodeRate, l2CPPriorityTable=l2CPPriorityTable, dataPortFiberStatus=dataPortFiberStatus, linkLoss=linkLoss, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, dataPortStatus=dataPortStatus, dataPortFiberStatusTrap=dataPortFiberStatusTrap, protectionStateTrap=protectionStateTrap, managementPortDisabledWarning=managementPortDisabledWarning, radioLicenseMaxEIRP=radioLicenseMaxEIRP, userTableNumber=userTableNumber, rFUStatusTrap=rFUStatusTrap, sntp=sntp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPServerIPAddress=sMTPServerIPAddress, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, rFUSerial=rFUSerial, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, sNMPTrapIPAddress=sNMPTrapIPAddress, productVariant=productVariant, rxDiversityVid=rxDiversityVid, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, protectionSwitchCause=protectionSwitchCause, remotePrimaryInternetAddress=remotePrimaryInternetAddress, maxModulation=maxModulation, receiveDataRate=receiveDataRate, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receivePower=receivePower, snmpControl=snmpControl, radioLicenseMinCodeRate=radioLicenseMinCodeRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, protectionInterfaceStatus=protectionInterfaceStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerInternetAddress=tFTPServerInternetAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, primaryRecovery=primaryRecovery, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, supplementary=supplementary, primarySecondaryMode=primarySecondaryMode, protectionConfigurationStatus=protectionConfigurationStatus, managementPortConfigurationMismatch=managementPortConfigurationMismatch, radioLicenseIdentifier=radioLicenseIdentifier, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, bridge=bridge, remoteIPAddress=remoteIPAddress, cambium=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, productName=productName, sMTPServerInternetAddress=sMTPServerInternetAddress, primaryRecoveryPeriod=primaryRecoveryPeriod, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", remoteSecondaryMACAddress=remoteSecondaryMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, ptp800=ptp800, rFUStatus=rFUStatus, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNTPServerResponse=sNTPServerResponse, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, systemReset=systemReset, bootVersion=bootVersion, rFURpsAlarm=rFURpsAlarm, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, rFUType=rFUType, rFUTxFreqMin=rFUTxFreqMin, qOSPriorityScheme=qOSPriorityScheme, sNMPTrapVersion=sNMPTrapVersion, protectionConfig=protectionConfig, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, managementCommittedInformationRate=managementCommittedInformationRate, fiberY=fiberY, l2CPPriorityTableIndex=l2CPPriorityTableIndex, sNTPPrimaryServer=sNTPPrimaryServer, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, radioLicenseModulation=radioLicenseModulation, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, managementMode=managementMode, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, aAAControl=aAAControl, sNTPServerTableEntry=sNTPServerTableEntry, neighborMACAddress=neighborMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUBranchingConfiguration=rFUBranchingConfiguration, userRole=userRole, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, radioLicense=radioLicense, l2CPPriorityTableNumber=l2CPPriorityTableNumber, managementPortForcedConfiguration=managementPortForcedConfiguration, protectionState=protectionState, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, sNMPTrapInternetAddress=sNMPTrapInternetAddress, localPacketFiltering=localPacketFiltering, aTPCEnable=aTPCEnable, telnetPortNumber=telnetPortNumber, rFUVersionBank1=rFUVersionBank1, remoteInternetAddress=remoteInternetAddress, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, managementPortWirelessDownAlert=managementPortWirelessDownAlert, maxCodeRate=maxCodeRate, ptp=ptp, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, versions=versions, diverseRfFeederLoss=diverseRfFeederLoss, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, hTTPPortNumber=hTTPPortNumber, rfu=rfu, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, tFTPServerPortNumber=tFTPServerPortNumber, rFUTxBandAboveRx=rFUTxBandAboveRx, rFFeederLoss=rFFeederLoss, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, endId=endId, receiveModulation=receiveModulation, sNTPServerPortNumber=sNTPServerPortNumber, minModulation=minModulation, radioLicenseMaxModulation=radioLicenseMaxModulation, remotePrimaryIPAddress=remotePrimaryIPAddress, iFCableLength=iFCableLength, radioLicenseMinModulation=radioLicenseMinModulation, managementPortStatusTrap=managementPortStatusTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, userTableIndex=userTableIndex, iPv6GatewayAddress=iPv6GatewayAddress, sNMPTrapTable=sNMPTrapTable, management=management, rFUActiveFirmwareBank=rFUActiveFirmwareBank, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration, radioLicenseRxFreq=radioLicenseRxFreq)
