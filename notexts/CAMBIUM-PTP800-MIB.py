...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", iPv6PrefixLength=iPv6PrefixLength, numberOfAntennas=numberOfAntennas, sNTPServerResponse=sNTPServerResponse, sNMPCommunityString=sNMPCommunityString, radioLicenseMaxModulation=radioLicenseMaxModulation, protectionStats=protectionStats, protectionAvailabilityStatus=protectionAvailabilityStatus, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, rxDiversityVid=rxDiversityVid, encryptionEnabledMismatch=encryptionEnabledMismatch, dataPortFiberStatusTrap=dataPortFiberStatusTrap, fiberY=fiberY, rFUStatusTrap=rFUStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, enableTransmission=enableTransmission, managementPortAutoNegotiation=managementPortAutoNegotiation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, transmitModulation=transmitModulation, unitOutOfCalibration=unitOutOfCalibration, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, rFURpsAlarm=rFURpsAlarm, rFUConnectedPlatform=rFUConnectedPlatform, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, radioLicenseBandwidth=radioLicenseBandwidth, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, maxCodeRate=maxCodeRate, transmitterStatus=transmitterStatus, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, longitude=longitude, transmitPower=transmitPower, secureModeAlarm=secureModeAlarm, productName=productName, requestedProtectionState=requestedProtectionState, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, secondarySoftwareVersion=secondarySoftwareVersion, pubStats=pubStats, syslogStateTrap=syslogStateTrap, rFURfBand=rFURfBand, sNTPState=sNTPState, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, snmpControl=snmpControl, remoteIPAddress=remoteIPAddress, managementPortDisabledWarning=managementPortDisabledWarning, activeUnit=activeUnit, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, rFUType=rFUType, sNMPTrapVersion=sNMPTrapVersion, l2CPPriorityTableIndex=l2CPPriorityTableIndex, transmitCapacityLimitDetail=transmitCapacityLimitDetail, neighborMACAddress=neighborMACAddress, aAAControl=aAAControl, radioLicenseRegion=radioLicenseRegion, rxDiversityVlanTpid=rxDiversityVlanTpid, mPLSTCPriorityTable=mPLSTCPriorityTable, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, rFUTxBandAboveRx=rFUTxBandAboveRx, faultProtectionSwitching=faultProtectionSwitching, systemReset=systemReset, rFUFreqSpacing=rFUFreqSpacing, radioLicenseCodeRate=radioLicenseCodeRate, neighborInternetAddress=neighborInternetAddress, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, hTTPSAccessEnabled=hTTPSAccessEnabled, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicenseTxFreq=radioLicenseTxFreq, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, reset=reset, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, sNMPEnabledTraps=sNMPEnabledTraps, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, protectionConfigurationStatus=protectionConfigurationStatus, sNTPLastSync=sNTPLastSync, vLANManagementVID=vLANManagementVID, managementPortConfigurationMismatch=managementPortConfigurationMismatch, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, dataPortStatus=dataPortStatus, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, sNTPServerTableNumber=sNTPServerTableNumber, altitude=altitude, subnetMask=subnetMask, sNMPTrapInternetAddress=sNMPTrapInternetAddress, rFUPowerButtonPressed=rFUPowerButtonPressed, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, syslogControl=syslogControl, primaryRecoveryPeriod=primaryRecoveryPeriod, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, managementCommittedInformationRate=managementCommittedInformationRate, rFUTxFreqMax=rFUTxFreqMax, syslogState=syslogState, remoteInternetAddressType=remoteInternetAddressType, sNMPTrapTableIndex=sNMPTrapTableIndex, rFUTxPowerMax=rFUTxPowerMax, neighborIPAddress=neighborIPAddress, systemClock=systemClock, versions=versions, rFUPlatformCompatibility=rFUPlatformCompatibility, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, aTPCEnable=aTPCEnable, qOSPriorityScheme=qOSPriorityScheme, rFURFSwitchAlarm=rFURFSwitchAlarm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteMACAddress=remoteMACAddress, secureModeAlarmTrap=secureModeAlarmTrap, linkNameMismatchTrap=linkNameMismatchTrap, rFUTxMuteStatus=rFUTxMuteStatus, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, protectionStateTrap=protectionStateTrap, securityLevel=securityLevel, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, transmitCodeRate=transmitCodeRate, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, tFTPServerInternetAddress=tFTPServerInternetAddress, ethernetPriorityTableIndex=ethernetPriorityTableIndex, ptp800=ptp800, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, userEnabled=userEnabled, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, receiveCodeRate=receiveCodeRate, activeAvailableTime=activeAvailableTime, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, bootVersion=bootVersion, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, radioLicenseMinModulation=radioLicenseMinModulation, syslogClientTrap=syslogClientTrap, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, supplementary=supplementary, sMTPServerIPAddress=sMTPServerIPAddress, maxModulation=maxModulation, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, iPv6Address=iPv6Address, dataPortDisabledWarning=dataPortDisabledWarning, siteName=siteName, rFUTxPowerAlarm=rFUTxPowerAlarm, radioLicenseModulation=radioLicenseModulation, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, protection=protection, hTTPAccessEnabled=hTTPAccessEnabled, l2CPPriorityTableNumber=l2CPPriorityTableNumber, l2CPPriorityTableEntry=l2CPPriorityTableEntry, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, localPacketFiltering=localPacketFiltering, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, iPv4Address=iPv4Address, protectionConfig=protectionConfig, iPv6GatewayAddress=iPv6GatewayAddress, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, sNTPServerTableIndex=sNTPServerTableIndex, ptpTrapPrefix=ptpTrapPrefix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alignmentModeTrap=alignmentModeTrap, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, dataPortFiberStatus=dataPortFiberStatus, rFUCableAlarm=rFUCableAlarm, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, protectionStatus=protectionStatus, radioLicenseRxFreq=radioLicenseRxFreq, managementMode=managementMode, sNMPTrapPortNumber=sNMPTrapPortNumber, rFUBranchingConfiguration=rFUBranchingConfiguration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, daylightSaving=daylightSaving, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, iFCableLength=iFCableLength, sMTPServerInternetAddressType=sMTPServerInternetAddressType, syslogLocalWrappedTrap=syslogLocalWrappedTrap, remoteSecondaryIPAddress=remoteSecondaryIPAddress, dSCPManagementPriority=dSCPManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, rFUSerial=rFUSerial, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, radioLicenseIdentifier=radioLicenseIdentifier, cambium=cambium, sNTPServerRetries=sNTPServerRetries, rFUVersionBank1=rFUVersionBank1, protectionInterfaceStatus=protectionInterfaceStatus, linkLoss=linkLoss, remotePrimaryIPAddress=remotePrimaryIPAddress, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, transmitCapacity=transmitCapacity, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, dataPortPauseFrames=dataPortPauseFrames, rxDiversityDataPortStatus=rxDiversityDataPortStatus, configuration=configuration, managementPortForcedConfiguration=managementPortForcedConfiguration, sMTPEnabledMessages=sMTPEnabledMessages, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, minModulation=minModulation, managementPortStatus=managementPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, remotePrimarySecondaryMode=remotePrimarySecondaryMode, transmitDataRate=transmitDataRate, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sNMPTrapTable=sNMPTrapTable, transmitCapacityLimit=transmitCapacityLimit, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, sNTPServerTable=sNTPServerTable, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, remoteSecondaryMACAddress=remoteSecondaryMACAddress, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sMTPServerInternetAddress=sMTPServerInternetAddress, tFTPServerIPAddress=tFTPServerIPAddress, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rFUTxPowerMin=rFUTxPowerMin, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTable=userTable, encryptionAlgorithm=encryptionAlgorithm, rFUTransceiverLocation=rFUTransceiverLocation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, activeWirelessLinkAvailability=activeWirelessLinkAvailability, receiveModulation=receiveModulation, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, linkNameMismatch=linkNameMismatch, phyStatus=phyStatus, sNTPServerTimeout=sNTPServerTimeout, protectionState=protectionState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, userName=userName, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, ethernet=ethernet, rFFeederLoss=rFFeederLoss, userTableNumber=userTableNumber, sNMPPortNumber=sNMPPortNumber, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, remotePrimaryInternetAddress=remotePrimaryInternetAddress, timeZone=timeZone)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, alarms=alarms, l2CPPriorityTable=l2CPPriorityTable, ethernetPriorityTableEntry=ethernetPriorityTableEntry, sNTPServerTableEntry=sNTPServerTableEntry, ethernetFiberSupport=ethernetFiberSupport, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, diverseAntennaGain=diverseAntennaGain, ethernetPriorityTable=ethernetPriorityTable, rfu=rfu, radioLicense=radioLicense, userTableEntry=userTableEntry, primarySecondaryMode=primarySecondaryMode, radioLicenseBand=radioLicenseBand, enabledDiagnosticAlarms=enabledDiagnosticAlarms, rFUPowerAlarm=rFUPowerAlarm, vectorError=vectorError, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, tFTPServerInternetAddressType=tFTPServerInternetAddressType, vLANManagementPriority=vLANManagementPriority, ptpTraps=ptpTraps, antennaGain=antennaGain, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alignmentMode=alignmentMode, userTableIndex=userTableIndex, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, rFURxFreqMin=rFURxFreqMin, sNTPServerInternetAddress=sNTPServerInternetAddress, radioLicenseMinCodeRate=radioLicenseMinCodeRate, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, remotePrimaryMACAddress=remotePrimaryMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, sntp=sntp, syslogClient=syslogClient, sNTPServerInternetAddressType=sNTPServerInternetAddressType, sNTPPollInterval=sNTPPollInterval, iPVersion=iPVersion, rFUProtectionCompatibility=rFUProtectionCompatibility, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, rFULockoutAlarm=rFULockoutAlarm, protectionSwitchCause=protectionSwitchCause, rFUTxFreqMin=rFUTxFreqMin, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, remoteInternetAddress=remoteInternetAddress, softwareVersion=softwareVersion, diverseRfFeederLoss=diverseRfFeederLoss, gatewayIPAddress=gatewayIPAddress, rFUStatus=rFUStatus, ptp=ptp, primaryRecovery=primaryRecovery, rFUActiveFirmwareBank=rFUActiveFirmwareBank, rFURxFreqMax=rFURxFreqMax, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, managementPortStatusTrap=managementPortStatusTrap, neighborInternetAddressType=neighborInternetAddressType, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, management=management, iPDSCPPriorityTable=iPDSCPPriorityTable, telnetPortNumber=telnetPortNumber, minCodeRate=minCodeRate, wirelessLinkStatusTrap=wirelessLinkStatusTrap, bridge=bridge, licence=licence, sMTPEmailAlert=sMTPEmailAlert, radioLicenseMaxEIRP=radioLicenseMaxEIRP, endId=endId, vLANManagementVIDValidation=vLANManagementVIDValidation, smtp=smtp, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, ethernetPriorityTableNumber=ethernetPriorityTableNumber, receiveDataRate=receiveDataRate, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPPrimaryServer=sNTPPrimaryServer, rFUVersionBank2=rFUVersionBank2, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap)
