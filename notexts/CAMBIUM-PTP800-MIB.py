...
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", radioLicenseTxFreq=radioLicenseTxFreq, encryption=encryption, managementPortWirelessDownAlert=managementPortWirelessDownAlert, sNTPSync=sNTPSync, wirelessLinkStatusTrap=wirelessLinkStatusTrap, vLANManagementVIDValidation=vLANManagementVIDValidation, tFTPServerInternetAddressType=tFTPServerInternetAddressType, rFUPowerButtonPressedTrap=rFUPowerButtonPressedTrap, linkName=linkName, sNTPSyncTrap=sNTPSyncTrap, encryptionAlgorithmsAvail=encryptionAlgorithmsAvail, iPv6AutoConfiguredLinkLocalAddress=iPv6AutoConfiguredLinkLocalAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, rFUTxBandAboveRx=rFUTxBandAboveRx, sNMPTrapTableNumber=sNMPTrapTableNumber, enableTransmission=enableTransmission, rFUBranchingConfiguration=rFUBranchingConfiguration, gatewayIPAddress=gatewayIPAddress, managementPortDisabledWarningTrap=managementPortDisabledWarningTrap, managementPortEthernetSpeedStatusTrap=managementPortEthernetSpeedStatusTrap, dataPortCopperAutoNegotiation=dataPortCopperAutoNegotiation, alignmentMode=alignmentMode, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, rFUVersionBank1=rFUVersionBank1, protectionConfig=protectionConfig, rFUTxIFSynthLockAlarm=rFUTxIFSynthLockAlarm, rFURxIFSynthLockAlarm=rFURxIFSynthLockAlarm, activeUnit=activeUnit, rFUProtectionCompatibility=rFUProtectionCompatibility, snmpControl=snmpControl, rFULockoutAlarm=rFULockoutAlarm, iPv6GatewayAddress=iPv6GatewayAddress, licensedTransmitCapacityStatusTrap=licensedTransmitCapacityStatusTrap, wirelessReceiveSignalStatusTrap=wirelessReceiveSignalStatusTrap, userTableEntry=userTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, rFUTxFreqMin=rFUTxFreqMin, mPLSTCPriorityTableIndex=mPLSTCPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortPauseFrames=dataPortPauseFrames, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, sNTPServerInternetAddress=sNTPServerInternetAddress, rFUStatusTrap=rFUStatusTrap, licence=licence, remotePrimaryInternetAddress=remotePrimaryInternetAddress, mPLSTCPriorityTable=mPLSTCPriorityTable, management=management, rfu=rfu, protectionAvailabilityStatusTrap=protectionAvailabilityStatusTrap, neighborIPAddress=neighborIPAddress, ptp800=ptp800, sNMPTrapInternetAddressType=sNMPTrapInternetAddressType, bootVersion=bootVersion, alignmentModeTrap=alignmentModeTrap, ethernetPriorityTable=ethernetPriorityTable, transmitPower=transmitPower, managementPortStatus=managementPortStatus, receiveModulation=receiveModulation, longitude=longitude, rFUTxRFSynthLockAlarm=rFUTxRFSynthLockAlarm, dataPortFiberStatus=dataPortFiberStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersionRemoteCompatibility=softwareVersionRemoteCompatibility, managementPortConfigurationMismatch=managementPortConfigurationMismatch, managementPortAutoNegotiation=managementPortAutoNegotiation, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, rFURfSwitchCableAlarm=rFURfSwitchCableAlarm, neighborInternetAddressType=neighborInternetAddressType, remoteMACAddress=remoteMACAddress, productVariant=productVariant, telnetPortNumber=telnetPortNumber, syslogState=syslogState, iPv6PrefixLength=iPv6PrefixLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, altitude=altitude, rFUCommonRFSynthLockAlarm=rFUCommonRFSynthLockAlarm, radioLicense=radioLicense, rFUTxMuteStatus=rFUTxMuteStatus, neighborInternetAddress=neighborInternetAddress, iPv6Address=iPv6Address, rFUFanAssemblyAlarm=rFUFanAssemblyAlarm, linkNameMismatch=linkNameMismatch, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, protectionSwitchCause=protectionSwitchCause, sNTPPollInterval=sNTPPollInterval, secureModeAlarmTrap=secureModeAlarmTrap, neighborMACAddress=neighborMACAddress, remoteSecondaryInternetAddressType=remoteSecondaryInternetAddressType, managementPortSpeedAndDuplex=managementPortSpeedAndDuplex, sNMPTrapTableEntry=sNMPTrapTableEntry, l2CPPriorityTableEntry=l2CPPriorityTableEntry, rFUPowerButtonPressed=rFUPowerButtonPressed, enabledDiagnosticProtectionAlarms=enabledDiagnosticProtectionAlarms, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, rFUCableAlarm=rFUCableAlarm, transmitCapacityLimit=transmitCapacityLimit, sNMPTrapInternetAddress=sNMPTrapInternetAddress, userRole=userRole, rxDiversityAvailabilityStatusTrap=rxDiversityAvailabilityStatusTrap, transmitModulation=transmitModulation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productName=productName, managementPortEthernetSpeedStatus=managementPortEthernetSpeedStatus, sMTPServerIPAddress=sMTPServerIPAddress, l2CPPriorityTableNumber=l2CPPriorityTableNumber, bridge=bridge, iPDSCPPriorityTableEntry=iPDSCPPriorityTableEntry, radioLicenseMinCodeRate=radioLicenseMinCodeRate, numberOfAntennas=numberOfAntennas, antennaReceiveLevelMeasurementWindow=antennaReceiveLevelMeasurementWindow, wirelessReceiveSignalStatus=wirelessReceiveSignalStatus, sNMPPortNumber=sNMPPortNumber, dataPortEthernetSpeedStatusTrap=dataPortEthernetSpeedStatusTrap, sNTPPrimaryServerDeadTime=sNTPPrimaryServerDeadTime, aTPCEnable=aTPCEnable, securityLevel=securityLevel, rFURxFreqMax=rFURxFreqMax, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, timeZone=timeZone, sNTPServerResponse=sNTPServerResponse, managementPortConfigurationMismatchTrap=managementPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, receiveCodeRate=receiveCodeRate, unknownNetworkPriorityQueueMapping=unknownNetworkPriorityQueueMapping, fiberY=fiberY, rxDiversityDataPortStatusTrap=rxDiversityDataPortStatusTrap, configuration=configuration, mPLSTCPriorityTableEntry=mPLSTCPriorityTableEntry, alarms=alarms, iPDSCPPriorityTable=iPDSCPPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, radioLicenseMaxCodeRate=radioLicenseMaxCodeRate, rxDiversityVlanTpidNeighborCompatibility=rxDiversityVlanTpidNeighborCompatibility, rFUTransceiverLocation=rFUTransceiverLocation, managementPortStatusTrap=managementPortStatusTrap, rxDiversityConfigurationStatus=rxDiversityConfigurationStatus, sNTPServerTableIndex=sNTPServerTableIndex, antennaReceiveLevelDeltaThreshold=antennaReceiveLevelDeltaThreshold, remotePrimaryInternetAddressType=remotePrimaryInternetAddressType, daylightSaving=daylightSaving, reset=reset, subnetMask=subnetMask, cambium=cambium, userEnabled=userEnabled, receivePower=receivePower, iPv4Address=iPv4Address, maxCodeRate=maxCodeRate, minCodeRate=minCodeRate, sNTPPrimaryServer=sNTPPrimaryServer, transmitCapacityLimitDetail=transmitCapacityLimitDetail, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, remoteSecondaryMACAddress=remoteSecondaryMACAddress, hTTPPortNumber=hTTPPortNumber, sNTPLastSync=sNTPLastSync, rxDiversityVid=rxDiversityVid, encryptionAlgorithm=encryptionAlgorithm, radioLicenseMaxEIRP=radioLicenseMaxEIRP, protectionAvailabilityStatus=protectionAvailabilityStatus, remotePrimaryMACAddress=remotePrimaryMACAddress, userName=userName, protectionStatus=protectionStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerRetries=sNTPServerRetries, receiveDataRate=receiveDataRate, rFURxRFSynthLockAlarm=rFURxRFSynthLockAlarm, sNTPServerTable=sNTPServerTable, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, protection=protection, l2CPPriorityTable=l2CPPriorityTable, rFUHighTemperatureAlarm=rFUHighTemperatureAlarm, l2CPPriorityTableIndex=l2CPPriorityTableIndex, radioLicenseModulation=radioLicenseModulation, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, softwareVersionRemoteCompatibilityTrap=softwareVersionRemoteCompatibilityTrap, protectionConfigurationStatus=protectionConfigurationStatus, rFUSerial=rFUSerial, pubStats=pubStats, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, rFUCableAttenuationAdjustAlarm=rFUCableAttenuationAdjustAlarm, primaryRecoveryPeriod=primaryRecoveryPeriod, managementPortDisabledWarning=managementPortDisabledWarning, antennaGain=antennaGain, sntp=sntp, linkNameMismatchTrap=linkNameMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, sNMPTrapIPAddress=sNMPTrapIPAddress, protectionStateTrap=protectionStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, managementPortAutoNegAdvertisement=managementPortAutoNegAdvertisement, hardwareVersion=hardwareVersion, endId=endId, sNTPServerTableEntry=sNTPServerTableEntry, dataPortEthernetSpeedStatus=dataPortEthernetSpeedStatus, rFUReceiveBranchingUnitLoss=rFUReceiveBranchingUnitLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteSecondaryInternetAddress=remoteSecondaryInternetAddress, transmitCodeRate=transmitCodeRate, rxDiversityConfigurationStatusTrap=rxDiversityConfigurationStatusTrap, dataPortCopperForcedConfiguration=dataPortCopperForcedConfiguration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, l2CPPriorityQueueMapping=l2CPPriorityQueueMapping, dataPortFiberStatusTrap=dataPortFiberStatusTrap, rFUPowerAlarm=rFUPowerAlarm, transmitDataRate=transmitDataRate, protectionInterfaceStatusTrap=protectionInterfaceStatusTrap, rFFeederLoss=rFFeederLoss, radioLicenseMaxModulation=radioLicenseMaxModulation, radioLicenseCodeRate=radioLicenseCodeRate, diverseRfFeederLoss=diverseRfFeederLoss, hTTPAccessEnabled=hTTPAccessEnabled, ethernetPriorityTableNumber=ethernetPriorityTableNumber, ethernetPriorityQueueMapping=ethernetPriorityQueueMapping, rFURxFreqMin=rFURxFreqMin, iPDSCPPriorityQueueMapping=iPDSCPPriorityQueueMapping, remotePrimaryIPAddress=remotePrimaryIPAddress, phyControl=phyControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, radioLicenseRxFreq=radioLicenseRxFreq, maxModulation=maxModulation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, localPacketFiltering=localPacketFiltering, activeWirelessLinkAvailability=activeWirelessLinkAvailability, encryptionEnabledMismatchTrap=encryptionEnabledMismatchTrap, rFUTxPowerAlarm=rFUTxPowerAlarm, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, rFUTxFreqMax=rFUTxFreqMax, remoteSecondaryIPAddress=remoteSecondaryIPAddress, managementPortForcedConfiguration=managementPortForcedConfiguration, remotePrimarySecondaryMode=remotePrimarySecondaryMode, remoteInternetAddressType=remoteInternetAddressType, unitOutOfCalibration=unitOutOfCalibration, rFUConnectedPlatform=rFUConnectedPlatform, sNTPState=sNTPState, rFUFreqSpacing=rFUFreqSpacing, rFUCommonIFSynthLockAlarm=rFUCommonIFSynthLockAlarm, qOSPriorityScheme=qOSPriorityScheme)
mibBuilder.exportSymbols("CAMBIUM-PTP800-MIB", ethernetPriorityTableIndex=ethernetPriorityTableIndex, licensedTransmitCapacityStatus=licensedTransmitCapacityStatus, rxDiversityVlanTpid=rxDiversityVlanTpid, rxDiversityDataPortStatus=rxDiversityDataPortStatus, rFUVersionBank2=rFUVersionBank2, dataPortStatus=dataPortStatus, sNTPServerInternetAddressType=sNTPServerInternetAddressType, radioLicenseBand=radioLicenseBand, sNMPTrapTable=sNMPTrapTable, transmitCapacity=transmitCapacity, rFURfBand=rFURfBand, vLANManagementVID=vLANManagementVID, iPDSCPPriorityTableIndex=iPDSCPPriorityTableIndex, iFCableLength=iFCableLength, sNTPServerTimeout=sNTPServerTimeout, wirelessLinkAvailability=wirelessLinkAvailability, endWirelessReceiveSignalStatus=endWirelessReceiveSignalStatus, protectionInterfaceStatus=protectionInterfaceStatus, iPVersion=iPVersion, rFURFSwitchAlarm=rFURFSwitchAlarm, rFUType=rFUType, rxDiversityVidNeighborCompatibility=rxDiversityVidNeighborCompatibility, sNTPServerIPAddress=sNTPServerIPAddress, mPLSTCPriorityQueueMapping=mPLSTCPriorityQueueMapping, versions=versions, radioLicenseIncompatibleAlarm=radioLicenseIncompatibleAlarm, faultProtectionSwitching=faultProtectionSwitching, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTraps=ptpTraps, iPDSCPPriorityTableNumber=iPDSCPPriorityTableNumber, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPCommunityString=sNMPCommunityString, sNTPServerPortNumber=sNTPServerPortNumber, minModulation=minModulation, dataPortCopperAutoNegAdvertisement=dataPortCopperAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, rFUTxPowerDegradedAlarm=rFUTxPowerDegradedAlarm, syslogStateTrap=syslogStateTrap, sNTPServerTableNumber=sNTPServerTableNumber, systemReset=systemReset, primaryRecovery=primaryRecovery, rxDiversityAvailabilityStatus=rxDiversityAvailabilityStatus, sNMPTrapReceiverEnabled=sNMPTrapReceiverEnabled, softwareVersion=softwareVersion, radioLicenseRegion=radioLicenseRegion, radioLicenseMinModulation=radioLicenseMinModulation, protectionState=protectionState, sMTPServerInternetAddressType=sMTPServerInternetAddressType, tFTPServerInternetAddress=tFTPServerInternetAddress, supplementary=supplementary, dataPortEthernetMediaTypeToUse=dataPortEthernetMediaTypeToUse, ptp=ptp, systemClock=systemClock, primarySecondaryMode=primarySecondaryMode, rxDiversityNeighborCompatibility=rxDiversityNeighborCompatibility, activeAvailableTime=activeAvailableTime, rFUStatus=rFUStatus, protectionConfigurationStatusTrap=protectionConfigurationStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControl=aAAControl, encryptionEnabledMismatch=encryptionEnabledMismatch, radioLicenseIdentifier=radioLicenseIdentifier, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, protectionStats=protectionStats, rFUTxPowerMax=rFUTxPowerMax, transmitterStatus=transmitterStatus, siteName=siteName, diverseAntennaGain=diverseAntennaGain, radioLicenseBandwidth=radioLicenseBandwidth, userTableIndex=userTableIndex, dSCPManagementPriority=dSCPManagementPriority, sMTPServerInternetAddress=sMTPServerInternetAddress, mPLSTCPriorityTableNumber=mPLSTCPriorityTableNumber, activeCounterMeasurementPeriod=activeCounterMeasurementPeriod, rFURpsAlarm=rFURpsAlarm, secureModeAlarm=secureModeAlarm, endWirelessReceiveSignalStatusTrap=endWirelessReceiveSignalStatusTrap, managementMode=managementMode, requestedProtectionState=requestedProtectionState, rFUTransmitBranchingUnitLoss=rFUTransmitBranchingUnitLoss, dataPortStatusTrap=dataPortStatusTrap, rFUPlatformCompatibility=rFUPlatformCompatibility, rFUTxPowerMin=rFUTxPowerMin, remoteInternetAddress=remoteInternetAddress, managementCommittedInformationRate=managementCommittedInformationRate, userTable=userTable, rFUActiveFirmwareBank=rFUActiveFirmwareBank, ethernetPriorityTableEntry=ethernetPriorityTableEntry)
