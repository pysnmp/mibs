...
# ASN.1 source CT-PRIORITY-CLASSIFY-MIB
# Source digest sha256:44b86d3c78bad2ffd96df33143969da8502ca12e53afca3b0dbc2907bf1f5323
...
pClassifyRTPTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 14, 5, 1, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: pClassifyRTPTable.setStatus('mandatory')
pClassifyRTPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 14, 5, 1, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CT-PRIORITY-CLASSIFY-MIB", "pClassifyRTPInterfaceNumber"))
...
pClassifyUDPTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 14, 5, 2, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: pClassifyUDPTable.setStatus('mandatory')
pClassifyUDPEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 1, 2, 14, 5, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CT-PRIORITY-CLASSIFY-MIB", "pClassifyUDPPortNumber"))
...
mibBuilder.exportSymbols("CT-PRIORITY-CLASSIFY-MIB", ctPriorityExtClassifyConfig=ctPriorityExtClassifyConfig, pClassifyRTCPParsing=pClassifyRTCPParsing, pClassifyRTP=pClassifyRTP, pClassifyRTPEntry=pClassifyRTPEntry, pClassifyRTPInterfaceNumber=pClassifyRTPInterfaceNumber, pClassifyRTPLowDelayQueuePreference=pClassifyRTPLowDelayQueuePreference, pClassifyRTPState=pClassifyRTPState, pClassifyRTPTOSPrecedence=pClassifyRTPTOSPrecedence, pClassifyRTPTable=pClassifyRTPTable, pClassifyRTPTagPriority=pClassifyRTPTagPriority, pClassifyRTPTagVID=pClassifyRTPTagVID, pClassifyUDP=pClassifyUDP, pClassifyUDPEntry=pClassifyUDPEntry, pClassifyUDPLowDelayQueuePreference=pClassifyUDPLowDelayQueuePreference, pClassifyUDPPortNumber=pClassifyUDPPortNumber, pClassifyUDPState=pClassifyUDPState, pClassifyUDPTable=pClassifyUDPTable)
