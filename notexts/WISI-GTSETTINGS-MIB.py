...
MibIdentifier, Counter64, Unsigned32, ModuleIdentity, Gauge32, NotificationType, ObjectIdentity, Counter32, Integer32, Bits, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Unsigned32", "ModuleIdentity", "Gauge32", "NotificationType", "ObjectIdentity", "Counter32", "Integer32", "Bits", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceMAC=gtInterfaceMAC, gtSWOption=gtSWOption, gtSFPSpeed=gtSFPSpeed, gtModuleBackupControl=gtModuleBackupControl, gtBackupControl=gtBackupControl, gtServices=gtServices, gtSFPNumber=gtSFPNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtHMSComMethod=gtHMSComMethod, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceIGMP=gtInterfaceIGMP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtDNSTable=gtDNSTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNumSFP=gtNumSFP, gtUserTable=gtUserTable, gtUserAuthTable=gtUserAuthTable, gtWebProtocol=gtWebProtocol, gtNTPServerAddress=gtNTPServerAddress, gtSFPPlugged=gtSFPPlugged, gtSLARegistered=gtSLARegistered, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4=gtInterfaceIPv4, gtAccesslistTable=gtAccesslistTable, gtGroupName=gtGroupName, gtSFPType=gtSFPType, gtNTPServerTable=gtNTPServerTable, gtBackupStatus=gtBackupStatus, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapPDU=gtTrapPDU, gtSWOptionsIdx=gtSWOptionsIdx, gtAgentComReadString=gtAgentComReadString, gtUpdateFile=gtUpdateFile, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSyslogTable=gtSyslogTable, gtSWOptionsTable=gtSWOptionsTable, gtSLATable=gtSLATable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsConformance=gtSettingsConformance, gtPortsNumber=gtPortsNumber, gtTrapDestPort=gtTrapDestPort, gtDateAndTimeTable=gtDateAndTimeTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPUsername=gtSFTPUsername, gtInterfaceEntry=gtInterfaceEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsLinkup=gtPortsLinkup, gtSFTPPassword=gtSFTPPassword, gtAgentComWriteString=gtAgentComWriteString, gtSLAEntry=gtSLAEntry, gtUser=gtUser, gtSFPLink=gtSFPLink, gtInterfaceNumber=gtInterfaceNumber, gtUpdateControl=gtUpdateControl, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTimeUTC=gtTimeUTC, gtSNMPEntry=gtSNMPEntry, gtTrapDestIP=gtTrapDestIP, gtWebAuth=gtWebAuth, gtInterfaceIfIndex=gtInterfaceIfIndex, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupRights=gtGroupRights, gtNetworkEntry=gtNetworkEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserRowStatus=gtUserRowStatus, gtServicesTable=gtServicesTable, gtServicesEntry=gtServicesEntry, gtHMSTable=gtHMSTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtPortsTable=gtPortsTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFTPServer=gtSFTPServer, gtNetworkTable=gtNetworkTable, gtWebEnable=gtWebEnable, gtCurrentUserPassword=gtCurrentUserPassword, gtGeneral=gtGeneral, gtAgentState=gtAgentState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSyslogEntry=gtSyslogEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtHMSEntry=gtHMSEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserParamIdx=gtUserParamIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTimeZone=gtTimeZone, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsCompliances=gtSettingsCompliances, gtSNMPTable=gtSNMPTable, gtGroupEntry=gtGroupEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAccesslist=gtUserAccesslist, PYSNMP_MODULE_ID=gtSettingsMIB, gtSNMP=gtSNMP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSyslogState=gtSyslogState, gtModuleBackupStatus=gtModuleBackupStatus, gtUserIdx=gtUserIdx, gtFilename=gtFilename, gtSFTPPort=gtSFTPPort, gtNetworkPortName=gtNetworkPortName, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceCLI=gtInterfaceCLI, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNTPServerNumber=gtNTPServerNumber, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPPort=gtBackupSFTPPort, gtCurrentUserName=gtCurrentUserName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserGroup=gtUserGroup, gtUserPassword=gtUserPassword, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceState=gtInterfaceState, gtSwitch=gtSwitch, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSNumber=gtDNSNumber, gtTrapComString=gtTrapComString, gtGroupParamIdx=gtGroupParamIdx, gtUserName=gtUserName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleBackupDate=gtModuleBackupDate, gtSettingsNotifications=gtSettingsNotifications, gtSLAExpires=gtSLAExpires, gtUpdateStatus=gtUpdateStatus, gtAgentPort=gtAgentPort, gtAccesslistIPRange=gtAccesslistIPRange, gtDNSEntry=gtDNSEntry, gtSFPTable=gtSFPTable, gtSyslogIP=gtSyslogIP, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceTable=gtInterfaceTable, gtInterfaceName=gtInterfaceName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapUser=gtTrapUser, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserEntry=gtUserEntry, gtGroupIdx=gtGroupIdx, gtSettingsObjects=gtSettingsObjects, gtDateAndTime=gtDateAndTime, gtNetworking=gtNetworking, gtModuleUpdate=gtModuleUpdate, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleBackup=gtModuleBackup, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSettingsMIB=gtSettingsMIB, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTimeLocal=gtTimeLocal, gtSFPEntry=gtSFPEntry, gtAccesslistName=gtAccesslistName, gtInterfaceStreaming=gtInterfaceStreaming, gtNTPServerEntry=gtNTPServerEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapDestNumber=gtTrapDestNumber, gtGroupTable=gtGroupTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkName=gtNetworkName, gtDNSServerIP=gtDNSServerIP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtHMSGroupName=gtHMSGroupName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtChassisRedundancy=gtChassisRedundancy, gtNetworkPortState=gtNetworkPortState, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistEntry=gtAccesslistEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsGroups=gtSettingsGroups, gtTrapDestEntry=gtTrapDestEntry, gtPortsName=gtPortsName, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapState=gtTrapState, gtPortsEntry=gtPortsEntry, gtHMSNumMembers=gtHMSNumMembers, gtDaylightAdjustment=gtDaylightAdjustment, gtUserAuthEntry=gtUserAuthEntry, gtTrapDestTable=gtTrapDestTable, gtNetworkVLAN=gtNetworkVLAN)
