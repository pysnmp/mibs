...
Gauge32, ObjectIdentity, Bits, Integer32, IpAddress, TimeTicks, Counter32, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "Integer32", "IpAddress", "TimeTicks", "Counter32", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtWebEnable=gtWebEnable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleBackupTable=gtModuleBackupTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateControl=gtUpdateControl, gtNetworkTable=gtNetworkTable, gtTrapDestPort=gtTrapDestPort, gtAgentComWriteString=gtAgentComWriteString, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortName=gtNetworkPortName, gtAgentState=gtAgentState, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSLATable=gtSLATable, gtWebProtocol=gtWebProtocol, gtTrapDestNumber=gtTrapDestNumber, gtTrapSNMPVersion=gtTrapSNMPVersion, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserRowStatus=gtUserRowStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtServicesEntry=gtServicesEntry, gtTrapDestEntry=gtTrapDestEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsTable=gtPortsTable, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserGroup=gtUserGroup, gtGroupIdx=gtGroupIdx, gtSyslogEntry=gtSyslogEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFile=gtUpdateFile, gtSettingsGroups=gtSettingsGroups, gtInterfaceState=gtInterfaceState, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSyslogTable=gtSyslogTable, gtSFTPServer=gtSFTPServer, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFTPPassword=gtSFTPPassword, gtTimeZone=gtTimeZone, gtUpdateStatus=gtUpdateStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSettingsMIB=gtSettingsMIB, gtSyslogIP=gtSyslogIP, gtModuleBackupDate=gtModuleBackupDate, gtSettingsCompliances=gtSettingsCompliances, gtNetworkName=gtNetworkName, gtNTPServerNumber=gtNTPServerNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSEntry=gtDNSEntry, gtSWOption=gtSWOption, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceSNMP=gtInterfaceSNMP, gtSNMP=gtSNMP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceName=gtInterfaceName, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistEntry=gtAccesslistEntry, gtUserName=gtUserName, gtHMSGroupName=gtHMSGroupName, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUser=gtUser, gtInterfaceEntry=gtInterfaceEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDateAndTimeTable=gtDateAndTimeTable, gtGroupEntry=gtGroupEntry, gtInterfaceTable=gtInterfaceTable, gtSFPSpeed=gtSFPSpeed, gtSLAEntry=gtSLAEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapPDU=gtTrapPDU, gtInterfaceCLI=gtInterfaceCLI, gtAccesslistIPRange=gtAccesslistIPRange, gtAccesslistName=gtAccesslistName, gtInterfaceIGMP=gtInterfaceIGMP, gtSwitch=gtSwitch, gtUserTable=gtUserTable, gtSFTPPort=gtSFTPPort, gtSFPLink=gtSFPLink, gtDNSServerIP=gtDNSServerIP, gtSLAExpires=gtSLAExpires, gtGroupParamIdx=gtGroupParamIdx, gtNetworkVLAN=gtNetworkVLAN, gtTrapUser=gtTrapUser, gtModuleBackupEntry=gtModuleBackupEntry, gtUserEntry=gtUserEntry, gtSFPNumber=gtSFPNumber, gtSFPEntry=gtSFPEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtPortsLinkup=gtPortsLinkup, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPType=gtSFPType, gtHeadendSystemManagement=gtHeadendSystemManagement, gtServices=gtServices, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtChassisRedundancy=gtChassisRedundancy, gtBackupControl=gtBackupControl, gtInterfaceMAC=gtInterfaceMAC, gtPortsName=gtPortsName, gtInterfaceStreaming=gtInterfaceStreaming, gtTrapSecurityLevel=gtTrapSecurityLevel, gtDNSNumber=gtDNSNumber, gtTrapDestTable=gtTrapDestTable, gtAgentComReadString=gtAgentComReadString, gtNetworkPortState=gtNetworkPortState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtDateAndTime=gtDateAndTime, gtModuleBackup=gtModuleBackup, gtHMSTable=gtHMSTable, gtModuleBackupControl=gtModuleBackupControl, gtWebAuth=gtWebAuth, gtAgentPort=gtAgentPort, PYSNMP_MODULE_ID=gtSettingsMIB, gtServicesTable=gtServicesTable, gtSyslogState=gtSyslogState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTimeUTC=gtTimeUTC, gtUserAccesslist=gtUserAccesslist, gtSWOptionsTable=gtSWOptionsTable, gtPortsEntry=gtPortsEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserIdx=gtUserIdx, gtTrapState=gtTrapState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSNMPEntry=gtSNMPEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFPPlugged=gtSFPPlugged, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtGeneral=gtGeneral, gtGroupName=gtGroupName, gtHMSNumAvailModules=gtHMSNumAvailModules, gtGroupTable=gtGroupTable, gtSettingsNotifications=gtSettingsNotifications, gtUserParamIdx=gtUserParamIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtDNSTable=gtDNSTable, gtSNMPTable=gtSNMPTable, gtNetworking=gtNetworking, gtCurrentUserName=gtCurrentUserName, gtInterfaceNumber=gtInterfaceNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtCurrentTimeSource=gtCurrentTimeSource, gtAccesslistIdx=gtAccesslistIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNTPServerAddress=gtNTPServerAddress, gtGroupRights=gtGroupRights, gtBackupSFTPServer=gtBackupSFTPServer, gtTimeLocal=gtTimeLocal, gtBackupStatus=gtBackupStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkEntry=gtNetworkEntry, gtModuleUpdate=gtModuleUpdate, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNTPServerTable=gtNTPServerTable, gtSFTPUsername=gtSFTPUsername, gtHMSEntry=gtHMSEntry, gtSettingsObjects=gtSettingsObjects, gtPortsNumber=gtPortsNumber, gtAccesslistTable=gtAccesslistTable, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNumSFP=gtNumSFP, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapDestIP=gtTrapDestIP, gtUserAuthTable=gtUserAuthTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHMSNumMembers=gtHMSNumMembers, gtGroupAccesslist=gtGroupAccesslist, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapComString=gtTrapComString, gtUserPassword=gtUserPassword, gtSFPTable=gtSFPTable, gtSLARegistered=gtSLARegistered, gtFilename=gtFilename, gtSettingsConformance=gtSettingsConformance)
