...
Bits, IpAddress, TimeTicks, Unsigned32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "TimeTicks", "Unsigned32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserAccesslist=gtUserAccesslist, gtAgentComWriteString=gtAgentComWriteString, gtUpdateControl=gtUpdateControl, gtGroupRights=gtGroupRights, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsTable=gtPortsTable, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPPort=gtBackupSFTPPort, gtGroupIdx=gtGroupIdx, gtInterfaceNumber=gtInterfaceNumber, gtHMSNumMembers=gtHMSNumMembers, gtDNSNumber=gtDNSNumber, gtSyslogTable=gtSyslogTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtFilename=gtFilename, gtInterfaceName=gtInterfaceName, gtServices=gtServices, gtDNSServerIP=gtDNSServerIP, gtSFPLink=gtSFPLink, gtUserIdx=gtUserIdx, gtServicesTable=gtServicesTable, gtSFTPUsername=gtSFTPUsername, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserGroup=gtUserGroup, gtSyslogIP=gtSyslogIP, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceCLI=gtInterfaceCLI, gtTrapPDU=gtTrapPDU, gtSyslogEntry=gtSyslogEntry, gtUserName=gtUserName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsMIB=gtSettingsMIB, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestTable=gtTrapDestTable, gtUpdateFilesTable=gtUpdateFilesTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceState=gtInterfaceState, gtInterfaceDHCPState=gtInterfaceDHCPState, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPNumber=gtSFPNumber, gtNetworkName=gtNetworkName, gtCurrentUserPassword=gtCurrentUserPassword, gtTimeZone=gtTimeZone, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtWebEnable=gtWebEnable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtWebProtocol=gtWebProtocol, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceStreaming=gtInterfaceStreaming, gtTimeUTC=gtTimeUTC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUpdateStatus=gtUpdateStatus, gtTrapDestPort=gtTrapDestPort, gtSettingsObjects=gtSettingsObjects, gtHMSComMethod=gtHMSComMethod, gtUser=gtUser, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapUser=gtTrapUser, gtGroupEntry=gtGroupEntry, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestNumber=gtTrapDestNumber, gtUserAuthEntry=gtUserAuthEntry, gtNetworking=gtNetworking, gtCurrentTimeSource=gtCurrentTimeSource, gtUserAuthTable=gtUserAuthTable, gtTrapState=gtTrapState, gtGroupAccesslist=gtGroupAccesslist, gtSNMPTable=gtSNMPTable, gtNetworkPortState=gtNetworkPortState, gtNTPServerAddress=gtNTPServerAddress, gtHMSTable=gtHMSTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtBackupControl=gtBackupControl, gtAccesslistIPRange=gtAccesslistIPRange, gtDateAndTimeEntry=gtDateAndTimeEntry, gtGroupTable=gtGroupTable, gtAgentPort=gtAgentPort, gtUserTable=gtUserTable, gtSLATable=gtSLATable, gtInterfaceVLAN=gtInterfaceVLAN, gtNTPServerTable=gtNTPServerTable, gtServicesEntry=gtServicesEntry, gtTrapDestIP=gtTrapDestIP, gtModuleUpdate=gtModuleUpdate, gtAccesslistIdx=gtAccesslistIdx, gtHMSGroupName=gtHMSGroupName, gtPortsNumber=gtPortsNumber, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceTable=gtInterfaceTable, gtPortsEntry=gtPortsEntry, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSettingsNotifications=gtSettingsNotifications, gtTimeLocal=gtTimeLocal, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAgentState=gtAgentState, gtSwitch=gtSwitch, gtSWOptionsTable=gtSWOptionsTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPTable=gtSFPTable, gtUserPassword=gtUserPassword, gtNetworkTable=gtNetworkTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLAEntry=gtSLAEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupStatus=gtBackupStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortName=gtNetworkPortName, gtSNMP=gtSNMP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAccesslistTable=gtAccesslistTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtWebAuth=gtWebAuth, gtNetworkVLAN=gtNetworkVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSNMPEntry=gtSNMPEntry, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtDateAndTime=gtDateAndTime, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNumSFP=gtNumSFP, gtDaylightAdjustment=gtDaylightAdjustment, gtSFPSpeed=gtSFPSpeed, gtSyslogState=gtSyslogState, gtSFTPServer=gtSFTPServer, gtUserParamIdx=gtUserParamIdx, gtPortsName=gtPortsName, gtSWOption=gtSWOption, gtHMSEntry=gtHMSEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSLARegistered=gtSLARegistered, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtHeadendSystemManagement=gtHeadendSystemManagement, gtDNSEntry=gtDNSEntry, gtCurrentUserName=gtCurrentUserName, gtSLAExpires=gtSLAExpires, gtModuleBackupTable=gtModuleBackupTable, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPPassword=gtSFTPPassword, gtSWOptionsEntry=gtSWOptionsEntry, gtUpdateFile=gtUpdateFile, gtPortsLinkup=gtPortsLinkup, gtAccesslistEntry=gtAccesslistEntry, gtUserRowStatus=gtUserRowStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsGroups=gtSettingsGroups, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceEntry=gtInterfaceEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserEntry=gtUserEntry, gtSFTPPort=gtSFTPPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAgentComReadString=gtAgentComReadString, gtSFPPlugged=gtSFPPlugged, gtDateAndTimeTable=gtDateAndTimeTable, gtNTPServerNumber=gtNTPServerNumber, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPType=gtSFPType, gtGeneral=gtGeneral, gtTrapComString=gtTrapComString, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSettingsConformance=gtSettingsConformance, gtInterfaceMAC=gtInterfaceMAC, gtGroupName=gtGroupName, gtNetworkEntry=gtNetworkEntry, gtAccesslistName=gtAccesslistName, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackup=gtModuleBackup, gtSFPEntry=gtSFPEntry, gtSettingsCompliances=gtSettingsCompliances, gtDNSTable=gtDNSTable)
