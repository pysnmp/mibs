...
MibIdentifier, Unsigned32, Counter64, ModuleIdentity, IpAddress, Gauge32, iso, NotificationType, Integer32, Counter32, TimeTicks, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "Gauge32", "iso", "NotificationType", "Integer32", "Counter32", "TimeTicks", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPSpeed=gtSFPSpeed, gtSyslogState=gtSyslogState, gtUserEntry=gtUserEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapPDU=gtTrapPDU, gtSFTPUsername=gtSFTPUsername, gtSNMP=gtSNMP, gtTrapState=gtTrapState, gtHMSNumMembers=gtHMSNumMembers, gtCurrentUserName=gtCurrentUserName, gtSFPNumber=gtSFPNumber, gtGroupIdx=gtGroupIdx, gtServices=gtServices, gtInterfaceIGMP=gtInterfaceIGMP, gtSyslogIP=gtSyslogIP, gtNumSFP=gtNumSFP, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceName=gtInterfaceName, gtPortsName=gtPortsName, gtSettingsGroups=gtSettingsGroups, gtUserIdx=gtUserIdx, gtPortsBitrateReceive=gtPortsBitrateReceive, gtPortsTable=gtPortsTable, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestPort=gtTrapDestPort, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNetworking=gtNetworking, gtGroupParamIdx=gtGroupParamIdx, gtGroupName=gtGroupName, gtModuleBackupControl=gtModuleBackupControl, gtSFTPServer=gtSFTPServer, gtInterfaceIPv4=gtInterfaceIPv4, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtPortsNumber=gtPortsNumber, gtHMSTable=gtHMSTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPType=gtSFPType, gtInterfaceDHCPState=gtInterfaceDHCPState, gtWebAuth=gtWebAuth, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtBackupSFTPPassword=gtBackupSFTPPassword, gtFilename=gtFilename, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserAccesslist=gtUserAccesslist, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSNMPTable=gtSNMPTable, gtInterfaceMAC=gtInterfaceMAC, gtTimeUTC=gtTimeUTC, gtInterfaceTable=gtInterfaceTable, gtSWOptionsEntry=gtSWOptionsEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPPort=gtSFTPPort, gtSettingsNotifications=gtSettingsNotifications, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserName=gtUserName, gtNetworkName=gtNetworkName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackup=gtModuleBackup, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtAccesslistEntry=gtAccesslistEntry, gtUpdateControl=gtUpdateControl, gtUserPassword=gtUserPassword, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtUserRowStatus=gtUserRowStatus, gtAccesslistName=gtAccesslistName, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsObjects=gtSettingsObjects, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleUpdate=gtModuleUpdate, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupTable=gtGroupTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFPEntry=gtSFPEntry, gtSyslogTable=gtSyslogTable, gtSFPLink=gtSFPLink, gtGroupAccesslist=gtGroupAccesslist, gtSyslogEntry=gtSyslogEntry, gtSFTPPassword=gtSFTPPassword, gtPortsLinkup=gtPortsLinkup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserTable=gtUserTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUpdateStatus=gtUpdateStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserParamIdx=gtUserParamIdx, gtGroupEntry=gtGroupEntry, gtHMSComMethod=gtHMSComMethod, gtSettingsConformance=gtSettingsConformance, gtNetworkPortsTable=gtNetworkPortsTable, gtServicesEntry=gtServicesEntry, gtSLAExpires=gtSLAExpires, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAgentComWriteString=gtAgentComWriteString, gtWebProtocol=gtWebProtocol, gtUpdateFile=gtUpdateFile, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackupDate=gtModuleBackupDate, gtUserAuthTable=gtUserAuthTable, gtNetworkPortName=gtNetworkPortName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistTable=gtAccesslistTable, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapDestTable=gtTrapDestTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsMIB=gtSettingsMIB, gtDNSNumber=gtDNSNumber, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerNumber=gtNTPServerNumber, gtTimeLocal=gtTimeLocal, gtNTPServerTable=gtNTPServerTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupControl=gtBackupControl, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentState=gtAgentState, gtNetworkPortNumber=gtNetworkPortNumber, gtWebEnable=gtWebEnable, gtDNSServerIP=gtDNSServerIP, gtSettingsCompliances=gtSettingsCompliances, gtSwitch=gtSwitch, gtInterfaceStreaming=gtInterfaceStreaming, gtAgentComReadString=gtAgentComReadString, gtSWOption=gtSWOption, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceState=gtInterfaceState, gtTimeZone=gtTimeZone, gtInterfaceEntry=gtInterfaceEntry, gtHMSGroupName=gtHMSGroupName, gtSLARegistered=gtSLARegistered, gtNetworkEntry=gtNetworkEntry, gtAccesslistIdx=gtAccesslistIdx, gtNetworkVLAN=gtNetworkVLAN, gtUserAuthEntry=gtUserAuthEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPServer=gtBackupSFTPServer, gtDaylightAdjustment=gtDaylightAdjustment, gtUser=gtUser, gtUserAuthEnabled=gtUserAuthEnabled, gtDNSTable=gtDNSTable, gtSWOptionsIdx=gtSWOptionsIdx, gtGeneral=gtGeneral, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNTPServerAddress=gtNTPServerAddress, gtNetworkTable=gtNetworkTable, gtHMSEntry=gtHMSEntry, gtSNMPEntry=gtSNMPEntry, gtGroupRights=gtGroupRights, gtInterfaceCLI=gtInterfaceCLI, gtDateAndTime=gtDateAndTime, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSWOptionsTable=gtSWOptionsTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSLATable=gtSLATable, gtNetworkPortState=gtNetworkPortState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSLAEntry=gtSLAEntry, gtPortsEntry=gtPortsEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPTable=gtSFPTable, gtSFPPlugged=gtSFPPlugged, gtServicesTable=gtServicesTable, gtBackupStatus=gtBackupStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentPort=gtAgentPort, gtDNSEntry=gtDNSEntry, gtTrapUser=gtTrapUser, gtUserGroup=gtUserGroup, gtTrapComString=gtTrapComString)
