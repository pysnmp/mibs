...
ObjectIdentity, MibIdentifier, ModuleIdentity, IpAddress, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter32, Bits, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter32", "Bits", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsEntry=gtPortsEntry, gtTrapPDU=gtTrapPDU, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsLinkup=gtPortsLinkup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceWebMgt=gtInterfaceWebMgt, gtWebProtocol=gtWebProtocol, gtGeneral=gtGeneral, gtSWOptionsIdx=gtSWOptionsIdx, gtHMSTable=gtHMSTable, gtNTPServerTable=gtNTPServerTable, gtGroupEntry=gtGroupEntry, gtSyslogState=gtSyslogState, gtAgentState=gtAgentState, gtAccesslistEntry=gtAccesslistEntry, gtUserAuthTable=gtUserAuthTable, gtSFPLink=gtSFPLink, gtPortsTable=gtPortsTable, gtNTPServerEntry=gtNTPServerEntry, gtServicesTable=gtServicesTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSNumMembers=gtHMSNumMembers, gtDaylightAdjustment=gtDaylightAdjustment, gtTimeUTC=gtTimeUTC, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsConformance=gtSettingsConformance, gtSLARegistered=gtSLARegistered, gtSFTPServer=gtSFTPServer, gtUserIdx=gtUserIdx, gtTrapState=gtTrapState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFPType=gtSFPType, gtUpdateFile=gtUpdateFile, gtInterfaceVLAN=gtInterfaceVLAN, gtWebEnable=gtWebEnable, gtSLAEntry=gtSLAEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupName=gtGroupName, gtModuleBackupDate=gtModuleBackupDate, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSLATable=gtSLATable, gtServices=gtServices, gtGroupRights=gtGroupRights, gtInterfaceTable=gtInterfaceTable, gtSettingsObjects=gtSettingsObjects, gtSWOptionsTable=gtSWOptionsTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceState=gtInterfaceState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPSpeed=gtSFPSpeed, gtCurrentUserName=gtCurrentUserName, gtUpdateControl=gtUpdateControl, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtDateAndTimeTable=gtDateAndTimeTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapDestPort=gtTrapDestPort, gtSyslogIP=gtSyslogIP, gtTrapDestTable=gtTrapDestTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtGroupParamIdx=gtGroupParamIdx, gtTrapDestEntry=gtTrapDestEntry, gtUserRowStatus=gtUserRowStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPPlugged=gtSFPPlugged, gtTrapComString=gtTrapComString, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkEntry=gtNetworkEntry, gtGroupAccesslist=gtGroupAccesslist, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsMIB=gtSettingsMIB, gtSNMPEntry=gtSNMPEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtUserGroup=gtUserGroup, gtAgentComWriteString=gtAgentComWriteString, gtSLAExpires=gtSLAExpires, gtSNMP=gtSNMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserParamIdx=gtUserParamIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtNetworkVLAN=gtNetworkVLAN, gtTimeLocal=gtTimeLocal, gtNTPServerNumber=gtNTPServerNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceCLI=gtInterfaceCLI, gtUserName=gtUserName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateFilesTable=gtUpdateFilesTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNumSFP=gtNumSFP, gtSNMPTable=gtSNMPTable, gtNetworkPortState=gtNetworkPortState, gtSettingsGroups=gtSettingsGroups, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtBackupStatus=gtBackupStatus, gtUserPassword=gtUserPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworkName=gtNetworkName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSyslogEntry=gtSyslogEntry, gtDNSNumber=gtDNSNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceNumber=gtInterfaceNumber, gtGroupTable=gtGroupTable, gtSettingsNotifications=gtSettingsNotifications, gtBackupControl=gtBackupControl, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestIP=gtTrapDestIP, gtInterfaceIGMP=gtInterfaceIGMP, gtSFTPPassword=gtSFTPPassword, gtUserTable=gtUserTable, gtHMSEntry=gtHMSEntry, gtAgentPort=gtAgentPort, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAgentComReadString=gtAgentComReadString, gtModuleRedundancyMode=gtModuleRedundancyMode, gtHMSComMethod=gtHMSComMethod, gtUserAuthEntry=gtUserAuthEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtUser=gtUser, gtTimeZone=gtTimeZone, gtUserAccesslist=gtUserAccesslist, gtModuleBackupControl=gtModuleBackupControl, gtFilename=gtFilename, gtInterfaceName=gtInterfaceName, gtUserEntry=gtUserEntry, gtModuleUpdate=gtModuleUpdate, gtPortsNumber=gtPortsNumber, gtHMSGroupName=gtHMSGroupName, gtDNSTable=gtDNSTable, gtSFPEntry=gtSFPEntry, gtTrapUser=gtTrapUser, gtAccesslistName=gtAccesslistName, gtAccesslistIdx=gtAccesslistIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPPort=gtBackupSFTPPort, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFTPPort=gtSFTPPort, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtChassisRedundancy=gtChassisRedundancy, gtDateAndTime=gtDateAndTime, gtSettingsCompliances=gtSettingsCompliances, gtNetworking=gtNetworking, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDNSServerIP=gtDNSServerIP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworkPortName=gtNetworkPortName, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapDestNumber=gtTrapDestNumber, gtSyslogTable=gtSyslogTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPTable=gtSFPTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkTable=gtNetworkTable, gtWebAuth=gtWebAuth, gtGroupIdx=gtGroupIdx, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtPortsName=gtPortsName, gtModuleBackup=gtModuleBackup, gtSwitch=gtSwitch, gtUpdateStatus=gtUpdateStatus, gtAccesslistTable=gtAccesslistTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsBitrateTransmit=gtPortsBitrateTransmit, PYSNMP_MODULE_ID=gtSettingsMIB, gtModuleBackupTable=gtModuleBackupTable, gtSFTPUsername=gtSFTPUsername, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtServicesEntry=gtServicesEntry, gtSFPNumber=gtSFPNumber, gtSWOption=gtSWOption, gtDNSEntry=gtDNSEntry)
