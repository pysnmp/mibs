...
ObjectIdentity, Integer32, Counter64, IpAddress, ModuleIdentity, Gauge32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Counter64", "IpAddress", "ModuleIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSyslogIP=gtSyslogIP, gtSNMPTable=gtSNMPTable, gtAgentComWriteString=gtAgentComWriteString, gtAgentPort=gtAgentPort, gtServices=gtServices, gtNetworkPortState=gtNetworkPortState, gtSFPPlugged=gtSFPPlugged, gtGroupIdx=gtGroupIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtServicesTable=gtServicesTable, gtGroupEntry=gtGroupEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserAccesslist=gtUserAccesslist, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserTable=gtUserTable, gtFilename=gtFilename, gtUserRowStatus=gtUserRowStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleBackupControl=gtModuleBackupControl, gtSLATable=gtSLATable, gtModuleBackupTable=gtModuleBackupTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDateAndTimeTable=gtDateAndTimeTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtGeneral=gtGeneral, gtHMSGroupName=gtHMSGroupName, gtSettingsGroups=gtSettingsGroups, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSyslogEntry=gtSyslogEntry, gtPortsNumber=gtPortsNumber, gtPortsTable=gtPortsTable, gtInterfaceVLAN=gtInterfaceVLAN, gtNumSFP=gtNumSFP, gtAccesslistIdx=gtAccesslistIdx, gtSWOption=gtSWOption, gtModuleBackupEntry=gtModuleBackupEntry, gtPortsLinkup=gtPortsLinkup, gtUserPassword=gtUserPassword, gtGroupTable=gtGroupTable, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceName=gtInterfaceName, gtTrapState=gtTrapState, gtDNSServerIP=gtDNSServerIP, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworkVLAN=gtNetworkVLAN, gtBackupSFTPServer=gtBackupSFTPServer, gtHMSNumMembers=gtHMSNumMembers, gtServicesEntry=gtServicesEntry, gtTrapDestEntry=gtTrapDestEntry, gtDNSTable=gtDNSTable, gtWebProtocol=gtWebProtocol, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSettingsConformance=gtSettingsConformance, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkName=gtNetworkName, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserAuthTable=gtUserAuthTable, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceIGMP=gtInterfaceIGMP, gtNTPServerEntry=gtNTPServerEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkTable=gtNetworkTable, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupName=gtGroupName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPType=gtSFPType, gtUpdateStatus=gtUpdateStatus, gtInterfaceNumber=gtInterfaceNumber, gtTimeZone=gtTimeZone, gtModuleUpdate=gtModuleUpdate, gtSwitch=gtSwitch, gtCurrentUserName=gtCurrentUserName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworking=gtNetworking, gtNetworkEntry=gtNetworkEntry, gtSFTPPassword=gtSFTPPassword, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsObjects=gtSettingsObjects, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUpdateFile=gtUpdateFile, gtSFTPPort=gtSFTPPort, gtInterfaceEntry=gtInterfaceEntry, gtUserGroup=gtUserGroup, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtSyslogTable=gtSyslogTable, gtWebAuth=gtWebAuth, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceTable=gtInterfaceTable, gtTimeLocal=gtTimeLocal, gtBackupStatus=gtBackupStatus, gtTrapDestPort=gtTrapDestPort, gtSFPTable=gtSFPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPNumber=gtSFPNumber, gtUserName=gtUserName, gtSFPLink=gtSFPLink, gtGroupRights=gtGroupRights, gtModuleBackup=gtModuleBackup, gtPortsName=gtPortsName, gtSFPEntry=gtSFPEntry, gtTrapDestNumber=gtTrapDestNumber, gtPortsEntry=gtPortsEntry, gtSLAExpires=gtSLAExpires, gtChassisRedundancy=gtChassisRedundancy, gtHMSTable=gtHMSTable, gtUserIdx=gtUserIdx, gtDateAndTime=gtDateAndTime, gtNetworkPortName=gtNetworkPortName, gtInterfaceState=gtInterfaceState, gtSWOptionsTable=gtSWOptionsTable, gtCurrentUserPassword=gtCurrentUserPassword, gtAgentComReadString=gtAgentComReadString, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerTable=gtNTPServerTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceCLI=gtInterfaceCLI, gtTimeUTC=gtTimeUTC, gtTrapDestIP=gtTrapDestIP, gtAccesslistName=gtAccesslistName, gtUser=gtUser, gtNTPServerNumber=gtNTPServerNumber, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDNSNumber=gtDNSNumber, gtAgentState=gtAgentState, gtSFTPServer=gtSFTPServer, gtUpdateFilesEntry=gtUpdateFilesEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceMAC=gtInterfaceMAC, gtPortsBitrateReceive=gtPortsBitrateReceive, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistEntry=gtAccesslistEntry, gtUpdateControl=gtUpdateControl, gtSLAEntry=gtSLAEntry, gtGroupAccesslist=gtGroupAccesslist, gtSNMPEntry=gtSNMPEntry, gtUserAuthEntry=gtUserAuthEntry, gtHMSEntry=gtHMSEntry, gtTrapDestTable=gtTrapDestTable, gtSFTPUsername=gtSFTPUsername, gtTrapPDU=gtTrapPDU, gtCurrentTimeSource=gtCurrentTimeSource, gtSLARegistered=gtSLARegistered, gtHMSComMethod=gtHMSComMethod, gtUserEntry=gtUserEntry, gtTrapComString=gtTrapComString, gtAccesslistTable=gtAccesslistTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSettingsNotifications=gtSettingsNotifications, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIPv4=gtInterfaceIPv4, gtAccesslistIPRange=gtAccesslistIPRange, gtWebEnable=gtWebEnable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSNMP=gtSNMP, gtSyslogState=gtSyslogState, gtTrapUser=gtTrapUser, gtDNSEntry=gtDNSEntry, gtUserParamIdx=gtUserParamIdx, gtDaylightAdjustment=gtDaylightAdjustment, gtSFPSpeed=gtSFPSpeed, gtBackupControl=gtBackupControl, gtInterfaceStreaming=gtInterfaceStreaming, gtSettingsMIB=gtSettingsMIB, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHeadendSystemManagement=gtHeadendSystemManagement)
