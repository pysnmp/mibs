...
TimeTicks, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Bits, Gauge32, MibIdentifier, Unsigned32, NotificationType, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Bits", "Gauge32", "MibIdentifier", "Unsigned32", "NotificationType", "Integer32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserEntry=gtUserEntry, gtUserPassword=gtUserPassword, gtModuleBackupStatus=gtModuleBackupStatus, gtSWOptionsIdx=gtSWOptionsIdx, gtSLATable=gtSLATable, gtDNSNumber=gtDNSNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPLink=gtSFPLink, gtAgentComReadString=gtAgentComReadString, gtDNSEntry=gtDNSEntry, gtSNMPEntry=gtSNMPEntry, gtTrapDestIP=gtTrapDestIP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFPType=gtSFPType, gtSLARegistered=gtSLARegistered, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapComString=gtTrapComString, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUser=gtUser, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistTable=gtAccesslistTable, gtModuleBackup=gtModuleBackup, gtDateAndTime=gtDateAndTime, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleBackupControl=gtModuleBackupControl, gtUpdateControl=gtUpdateControl, gtTrapPDU=gtTrapPDU, gtServices=gtServices, gtCurrentUserName=gtCurrentUserName, gtUserAuthTable=gtUserAuthTable, gtPortsName=gtPortsName, gtPortsLinkup=gtPortsLinkup, gtNetworkName=gtNetworkName, gtNTPServerTable=gtNTPServerTable, gtSyslogIP=gtSyslogIP, gtTrapState=gtTrapState, gtInterfaceIPv4=gtInterfaceIPv4, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSEntry=gtHMSEntry, gtUserRowStatus=gtUserRowStatus, gtTrapDestPort=gtTrapDestPort, gtTrapUser=gtTrapUser, gtUserGroup=gtUserGroup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUserTable=gtUserTable, gtGroupRights=gtGroupRights, gtGeneral=gtGeneral, gtNetworkPortState=gtNetworkPortState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupStatus=gtBackupStatus, gtAccesslistEntry=gtAccesslistEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtWebEnable=gtWebEnable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFTPServer=gtSFTPServer, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDaylightAdjustment=gtDaylightAdjustment, gtUserAccesslist=gtUserAccesslist, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFile=gtUpdateFile, gtModuleUpdate=gtModuleUpdate, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserAuthEntry=gtUserAuthEntry, gtSwitch=gtSwitch, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSWOption=gtSWOption, gtTrapDestNumber=gtTrapDestNumber, gtSNMP=gtSNMP, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerNumber=gtNTPServerNumber, gtUserParamIdx=gtUserParamIdx, gtTrapDestEntry=gtTrapDestEntry, gtChassisRedundancy=gtChassisRedundancy, gtBackupControl=gtBackupControl, gtSettingsMIB=gtSettingsMIB, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentState=gtAgentState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceSNMP=gtInterfaceSNMP, gtDateAndTimeEntry=gtDateAndTimeEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceStreaming=gtInterfaceStreaming, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifications=gtSettingsNotifications, gtAccesslistName=gtAccesslistName, gtSyslogState=gtSyslogState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtPortsTable=gtPortsTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHMSNumMembers=gtHMSNumMembers, gtGroupName=gtGroupName, gtTrapDestTable=gtTrapDestTable, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFTPUsername=gtSFTPUsername, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTimeUTC=gtTimeUTC, gtInterfaceDHCPState=gtInterfaceDHCPState, gtServicesTable=gtServicesTable, gtGroupIdx=gtGroupIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSFTPPassword=gtSFTPPassword, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtSLAEntry=gtSLAEntry, gtSFPNumber=gtSFPNumber, gtHMSTable=gtHMSTable, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceState=gtInterfaceState, gtGroupTable=gtGroupTable, gtAccesslistIdx=gtAccesslistIdx, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogTable=gtSyslogTable, gtServicesEntry=gtServicesEntry, gtSettingsObjects=gtSettingsObjects, gtGroupAccesslist=gtGroupAccesslist, gtGroupParamIdx=gtGroupParamIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateStatus=gtUpdateStatus, gtSettingsConformance=gtSettingsConformance, gtSFPTable=gtSFPTable, gtSettingsCompliances=gtSettingsCompliances, gtSFPEntry=gtSFPEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtFilename=gtFilename, gtHMSGroupName=gtHMSGroupName, gtSFPPlugged=gtSFPPlugged, gtNetworking=gtNetworking, gtTimeZone=gtTimeZone, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLAExpires=gtSLAExpires, gtNetworkPortName=gtNetworkPortName, gtNTPServerAddress=gtNTPServerAddress, gtPortsNumber=gtPortsNumber, gtDNSTable=gtDNSTable, gtInterfaceName=gtInterfaceName, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentComWriteString=gtAgentComWriteString, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPPort=gtSFTPPort, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceTable=gtInterfaceTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserIdx=gtUserIdx, gtModuleBackupTable=gtModuleBackupTable, gtNumSFP=gtNumSFP, gtNetworkEntry=gtNetworkEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserName=gtUserName, gtWebAuth=gtWebAuth, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsEntry=gtPortsEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceMAC=gtInterfaceMAC, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtTimeLocal=gtTimeLocal, gtNetworkTable=gtNetworkTable, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPFilename=gtBackupSFTPFilename, gtWebProtocol=gtWebProtocol, gtHMSComMethod=gtHMSComMethod, gtGroupEntry=gtGroupEntry, gtSNMPTable=gtSNMPTable, gtSFPSpeed=gtSFPSpeed, gtAgentPort=gtAgentPort, gtIGMPQuerierVersion=gtIGMPQuerierVersion)
