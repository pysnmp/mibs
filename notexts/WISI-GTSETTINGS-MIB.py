...
TimeTicks, Gauge32, Counter64, ObjectIdentity, Integer32, ModuleIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter64", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceMAC=gtInterfaceMAC, gtTimeLocal=gtTimeLocal, gtPortsTable=gtPortsTable, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4=gtInterfaceIPv4, gtPortsEntry=gtPortsEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSLATable=gtSLATable, gtAccesslistIdx=gtAccesslistIdx, gtSFPNumber=gtSFPNumber, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDNSNumber=gtDNSNumber, gtInterfaceName=gtInterfaceName, gtTrapState=gtTrapState, gtWebEnable=gtWebEnable, gtUpdateFilesTable=gtUpdateFilesTable, gtSWOption=gtSWOption, gtNetworkName=gtNetworkName, gtUser=gtUser, gtAgentComWriteString=gtAgentComWriteString, gtAccesslistEntry=gtAccesslistEntry, gtUserIdx=gtUserIdx, gtUserAccesslist=gtUserAccesslist, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsConformance=gtSettingsConformance, gtDNSEntry=gtDNSEntry, gtUserTable=gtUserTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSGroupName=gtHMSGroupName, gtGroupIdx=gtGroupIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPUsername=gtSFTPUsername, gtPortsLinkup=gtPortsLinkup, gtGeneral=gtGeneral, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleUpdate=gtModuleUpdate, gtSNMPEntry=gtSNMPEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserParamIdx=gtUserParamIdx, gtBackupControl=gtBackupControl, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSyslogTable=gtSyslogTable, gtNTPServerTable=gtNTPServerTable, gtSFTPServer=gtSFTPServer, gtGroupAccesslist=gtGroupAccesslist, gtTrapDestTable=gtTrapDestTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupEntry=gtGroupEntry, gtUserGroup=gtUserGroup, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsName=gtPortsName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtWebAuth=gtWebAuth, gtUserAuthTable=gtUserAuthTable, gtGroupTable=gtGroupTable, gtSyslogEntry=gtSyslogEntry, gtTrapDestIP=gtTrapDestIP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerEntry=gtNTPServerEntry, gtHMSTable=gtHMSTable, gtModuleBackupTable=gtModuleBackupTable, gtUpdateStatus=gtUpdateStatus, gtHMSNumMembers=gtHMSNumMembers, gtTimeUTC=gtTimeUTC, gtGroupParamIdx=gtGroupParamIdx, gtBackupStatus=gtBackupStatus, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtUserPassword=gtUserPassword, gtInterfaceStreaming=gtInterfaceStreaming, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateControl=gtUpdateControl, gtAgentState=gtAgentState, gtInterfaceState=gtInterfaceState, gtModuleBackupDate=gtModuleBackupDate, gtSFTPPassword=gtSFTPPassword, gtSFPType=gtSFPType, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSettingsCompliances=gtSettingsCompliances, gtSyslogIP=gtSyslogIP, gtDNSTable=gtDNSTable, gtUpdateFile=gtUpdateFile, gtSFPLink=gtSFPLink, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapComString=gtTrapComString, gtAgentPort=gtAgentPort, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserRowStatus=gtUserRowStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtSyslogState=gtSyslogState, gtFilename=gtFilename, gtCurrentUserPassword=gtCurrentUserPassword, gtServices=gtServices, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFPSpeed=gtSFPSpeed, gtSNMPTable=gtSNMPTable, gtGroupRights=gtGroupRights, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSLAExpires=gtSLAExpires, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistTable=gtAccesslistTable, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkPortState=gtNetworkPortState, gtSLARegistered=gtSLARegistered, gtNetworkEntry=gtNetworkEntry, gtNetworkVLAN=gtNetworkVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleBackupControl=gtModuleBackupControl, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapPDU=gtTrapPDU, gtSwitch=gtSwitch, gtModuleBackup=gtModuleBackup, gtSettingsObjects=gtSettingsObjects, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSWOptionsTable=gtSWOptionsTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkPortNumber=gtNetworkPortNumber, gtCurrentUserName=gtCurrentUserName, gtUserName=gtUserName, gtInterfaceSNMP=gtInterfaceSNMP, gtSFTPPort=gtSFTPPort, gtInterfaceEntry=gtInterfaceEntry, gtServicesTable=gtServicesTable, gtHMSEntry=gtHMSEntry, gtWebProtocol=gtWebProtocol, gtPortsNumber=gtPortsNumber, gtSFPTable=gtSFPTable, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceTable=gtInterfaceTable, gtAgentComReadString=gtAgentComReadString, gtTrapSNMPVersion=gtTrapSNMPVersion, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtServicesEntry=gtServicesEntry, gtInterfaceCLI=gtInterfaceCLI, gtNumSFP=gtNumSFP, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortName=gtNetworkPortName, gtUserEntry=gtUserEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtChassisRedundancy=gtChassisRedundancy, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPPlugged=gtSFPPlugged, gtNetworkTable=gtNetworkTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSLAEntry=gtSLAEntry, gtTimeZone=gtTimeZone, gtTrapDestNumber=gtTrapDestNumber, gtTrapDestPort=gtTrapDestPort, gtSNMP=gtSNMP, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworking=gtNetworking, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsMIB=gtSettingsMIB, gtTrapUser=gtTrapUser, gtGroupName=gtGroupName, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistName=gtAccesslistName, gtSWOptionsIdx=gtSWOptionsIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerNumber=gtNTPServerNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtSFPEntry=gtSFPEntry, gtSettingsNotifications=gtSettingsNotifications)
