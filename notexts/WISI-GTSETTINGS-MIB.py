...
MibIdentifier, Unsigned32, NotificationType, IpAddress, Integer32, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "NotificationType", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter32", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAgentComReadString=gtAgentComReadString, gtModuleBackup=gtModuleBackup, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHMSNumMembers=gtHMSNumMembers, gtDateAndTimeTable=gtDateAndTimeTable, gtUpdateFilesTable=gtUpdateFilesTable, gtSyslogTable=gtSyslogTable, gtGroupAccesslist=gtGroupAccesslist, gtSFPLink=gtSFPLink, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkPortState=gtNetworkPortState, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSNMPEntry=gtSNMPEntry, gtNumSFP=gtNumSFP, gtNetworkTable=gtNetworkTable, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceSNMP=gtInterfaceSNMP, gtSNMP=gtSNMP, gtNetworkEntry=gtNetworkEntry, gtInterfaceTable=gtInterfaceTable, gtTrapUser=gtTrapUser, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUserEntry=gtUserEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFPTable=gtSFPTable, gtUserIdx=gtUserIdx, gtModuleBackupDate=gtModuleBackupDate, gtFilename=gtFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtServicesEntry=gtServicesEntry, gtInterfaceCLI=gtInterfaceCLI, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtWebAuth=gtWebAuth, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsMIB=gtSettingsMIB, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsGroups=gtSettingsGroups, gtGroupName=gtGroupName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtHMSTable=gtHMSTable, gtTrapDestTable=gtTrapDestTable, gtAccesslistIdx=gtAccesslistIdx, gtNetworking=gtNetworking, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupControl=gtBackupControl, gtUpdateControl=gtUpdateControl, gtAccesslistEntry=gtAccesslistEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsCompliances=gtSettingsCompliances, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSyslogIP=gtSyslogIP, gtPortsEntry=gtPortsEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtWebEnable=gtWebEnable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsNumber=gtPortsNumber, gtSLAExpires=gtSLAExpires, gtServicesTable=gtServicesTable, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPPlugged=gtSFPPlugged, gtSWOptionsEntry=gtSWOptionsEntry, gtServices=gtServices, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapDestNumber=gtTrapDestNumber, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDNSNumber=gtDNSNumber, gtGeneral=gtGeneral, gtSyslogEntry=gtSyslogEntry, gtSLAEntry=gtSLAEntry, gtPortsLinkup=gtPortsLinkup, gtModuleBackupTable=gtModuleBackupTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkVLAN=gtNetworkVLAN, gtSwitch=gtSwitch, gtHMSGroupName=gtHMSGroupName, gtUpdateStatus=gtUpdateStatus, gtUserGroup=gtUserGroup, gtNTPServerAddress=gtNTPServerAddress, gtGroupRights=gtGroupRights, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSyslogState=gtSyslogState, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPUsername=gtSFTPUsername, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkPortName=gtNetworkPortName, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUser=gtUser, gtTrapSNMPVersion=gtTrapSNMPVersion, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserRowStatus=gtUserRowStatus, gtNTPServerNumber=gtNTPServerNumber, gtNetworkName=gtNetworkName, gtSettingsObjects=gtSettingsObjects, gtUserTable=gtUserTable, gtInterfaceNumber=gtInterfaceNumber, gtSNMPTable=gtSNMPTable, gtDNSEntry=gtDNSEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHMSEntry=gtHMSEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupSFTPPort=gtBackupSFTPPort, gtTrapState=gtTrapState, gtSFPType=gtSFPType, gtTrapPDU=gtTrapPDU, gtTrapDestPort=gtTrapDestPort, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistTable=gtAccesslistTable, gtSFPEntry=gtSFPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFile=gtUpdateFile, gtSWOption=gtSWOption, gtUserPassword=gtUserPassword, gtModuleBackupEntry=gtModuleBackupEntry, gtDNSTable=gtDNSTable, gtAccesslistName=gtAccesslistName, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsTable=gtPortsTable, gtSLARegistered=gtSLARegistered, gtInterfaceVLAN=gtInterfaceVLAN, gtPortsName=gtPortsName, gtDateAndTime=gtDateAndTime, gtUserName=gtUserName, gtHMSComMethod=gtHMSComMethod, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceWebMgt=gtInterfaceWebMgt, gtCurrentTimeSource=gtCurrentTimeSource, gtUserAuthEntry=gtUserAuthEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestEntry=gtTrapDestEntry, gtNTPServerTable=gtNTPServerTable, gtGroupIdx=gtGroupIdx, gtSWOptionsTable=gtSWOptionsTable, gtChassisRedundancy=gtChassisRedundancy, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAuthTable=gtUserAuthTable, gtSLATable=gtSLATable, gtAgentPort=gtAgentPort, gtInterfaceIPv4=gtInterfaceIPv4, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceEntry=gtInterfaceEntry, gtGroupEntry=gtGroupEntry, gtTimeZone=gtTimeZone, gtSFPNumber=gtSFPNumber, gtAgentState=gtAgentState, gtUserParamIdx=gtUserParamIdx, gtSFTPPassword=gtSFTPPassword, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceName=gtInterfaceName, gtTimeUTC=gtTimeUTC, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFTPPort=gtSFTPPort, gtModuleBackupControl=gtModuleBackupControl, gtSFPSpeed=gtSFPSpeed, gtDNSServerIP=gtDNSServerIP, gtTrapComString=gtTrapComString, gtSFTPServer=gtSFTPServer, gtAgentComWriteString=gtAgentComWriteString, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceState=gtInterfaceState, gtGroupParamIdx=gtGroupParamIdx, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSettingsNotifications=gtSettingsNotifications, gtCurrentUserName=gtCurrentUserName, gtSettingsConformance=gtSettingsConformance, gtUserAccesslist=gtUserAccesslist, gtBackupStatus=gtBackupStatus, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupTable=gtGroupTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceStreaming=gtInterfaceStreaming, gtSWOptionsIdx=gtSWOptionsIdx, gtWebProtocol=gtWebProtocol, gtModuleUpdate=gtModuleUpdate, gtTimeLocal=gtTimeLocal, gtAccesslistIPRange=gtAccesslistIPRange, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceUseVLAN=gtInterfaceUseVLAN)
