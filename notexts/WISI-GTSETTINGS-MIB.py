...
ObjectIdentity, NotificationType, Unsigned32, TimeTicks, Bits, Counter32, MibIdentifier, Counter64, Gauge32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Unsigned32", "TimeTicks", "Bits", "Counter32", "MibIdentifier", "Counter64", "Gauge32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleRedundancyMode=gtModuleRedundancyMode, gtPortsEntry=gtPortsEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackup=gtModuleBackup, gtInterfaceState=gtInterfaceState, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSTable=gtDNSTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFTPPort=gtSFTPPort, gtSFTPServer=gtSFTPServer, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestIP=gtTrapDestIP, gtModuleBackupControl=gtModuleBackupControl, gtGroupIdx=gtGroupIdx, gtTrapDestTable=gtTrapDestTable, gtNetworkPortName=gtNetworkPortName, gtAgentState=gtAgentState, gtNetworkVLAN=gtNetworkVLAN, gtWebEnable=gtWebEnable, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapComString=gtTrapComString, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUpdateControl=gtUpdateControl, gtUser=gtUser, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserIdx=gtUserIdx, gtSFPPlugged=gtSFPPlugged, gtSFPTable=gtSFPTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAccesslistIdx=gtAccesslistIdx, gtUserGroup=gtUserGroup, gtCurrentUserPassword=gtCurrentUserPassword, gtPortsLinkup=gtPortsLinkup, gtNumSFP=gtNumSFP, gtNTPServerNumber=gtNTPServerNumber, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistIPRange=gtAccesslistIPRange, gtSFPEntry=gtSFPEntry, gtBackupStatus=gtBackupStatus, gtPortsNumber=gtPortsNumber, gtUserAuthTable=gtUserAuthTable, gtPortsName=gtPortsName, gtSyslogState=gtSyslogState, gtInterfaceTable=gtInterfaceTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAccesslist=gtUserAccesslist, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFPSpeed=gtSFPSpeed, gtNTPServerTable=gtNTPServerTable, gtUpdateFile=gtUpdateFile, gtInterfaceMAC=gtInterfaceMAC, gtFilename=gtFilename, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestNumber=gtTrapDestNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSNMP=gtSNMP, gtBackupControl=gtBackupControl, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSettingsObjects=gtSettingsObjects, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSComMethod=gtHMSComMethod, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtAccesslistEntry=gtAccesslistEntry, gtGroupTable=gtGroupTable, gtChassisRedundancy=gtChassisRedundancy, PYSNMP_MODULE_ID=gtSettingsMIB, gtGeneral=gtGeneral, gtSettingsConformance=gtSettingsConformance, gtSyslogEntry=gtSyslogEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkTable=gtNetworkTable, gtWebAuth=gtWebAuth, gtSLAExpires=gtSLAExpires, gtHMSGroupName=gtHMSGroupName, gtHMSNumMembers=gtHMSNumMembers, gtSFPLink=gtSFPLink, gtUserEntry=gtUserEntry, gtSyslogTable=gtSyslogTable, gtServicesTable=gtServicesTable, gtAgentComReadString=gtAgentComReadString, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapDestPort=gtTrapDestPort, gtDNSEntry=gtDNSEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortState=gtNetworkPortState, gtDateAndTime=gtDateAndTime, gtTrapState=gtTrapState, gtUserRowStatus=gtUserRowStatus, gtGroupRights=gtGroupRights, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistTable=gtAccesslistTable, gtSettingsMIB=gtSettingsMIB, gtUpdateStatus=gtUpdateStatus, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSNMPTable=gtSNMPTable, gtPortsTable=gtPortsTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleBackupStatus=gtModuleBackupStatus, gtUserName=gtUserName, gtTrapUser=gtTrapUser, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceName=gtInterfaceName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSServerIP=gtDNSServerIP, gtSFTPPassword=gtSFTPPassword, gtTimeZone=gtTimeZone, gtNTPServerEntry=gtNTPServerEntry, gtUserPassword=gtUserPassword, gtSyslogIP=gtSyslogIP, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupAccesslist=gtGroupAccesslist, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSTable=gtHMSTable, gtAccesslistName=gtAccesslistName, gtCurrentUserName=gtCurrentUserName, gtNetworkEntry=gtNetworkEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFPNumber=gtSFPNumber, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworking=gtNetworking, gtServices=gtServices, gtSWOptionsTable=gtSWOptionsTable, gtSLARegistered=gtSLARegistered, gtNTPServerAddress=gtNTPServerAddress, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestEntry=gtTrapDestEntry, gtModuleUpdate=gtModuleUpdate, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSLAEntry=gtSLAEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapPDU=gtTrapPDU, gtNetworkName=gtNetworkName, gtSettingsGroups=gtSettingsGroups, gtUserTable=gtUserTable, gtUserAuthEntry=gtUserAuthEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupEntry=gtGroupEntry, gtInterfaceNumber=gtInterfaceNumber, gtSLATable=gtSLATable, gtSwitch=gtSwitch, gtAgentPort=gtAgentPort, gtWebProtocol=gtWebProtocol, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupDate=gtModuleBackupDate, gtTimeLocal=gtTimeLocal, gtServicesEntry=gtServicesEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDNSNumber=gtDNSNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSWOption=gtSWOption, gtHMSEntry=gtHMSEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFPType=gtSFPType, gtGroupName=gtGroupName, gtUserParamIdx=gtUserParamIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTimeUTC=gtTimeUTC, gtSNMPEntry=gtSNMPEntry, gtInterfaceCLI=gtInterfaceCLI, gtIGMPQueryInterval=gtIGMPQueryInterval, gtGroupParamIdx=gtGroupParamIdx)
