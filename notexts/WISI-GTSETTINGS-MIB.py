...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Integer32, Counter64, Gauge32, MibIdentifier, NotificationType, Counter32, TimeTicks, ObjectIdentity, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Integer32", "Counter64", "Gauge32", "MibIdentifier", "NotificationType", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortState=gtNetworkPortState, gtSFPSpeed=gtSFPSpeed, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNTPServerAddress=gtNTPServerAddress, gtDNSServerIP=gtDNSServerIP, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceWebMgt=gtInterfaceWebMgt, gtChassisRedundancy=gtChassisRedundancy, gtTimeUTC=gtTimeUTC, gtSFPType=gtSFPType, gtSFTPPort=gtSFTPPort, gtSFPTable=gtSFPTable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapPDU=gtTrapPDU, gtSyslogEntry=gtSyslogEntry, gtSFTPUsername=gtSFTPUsername, gtNetworkEntry=gtNetworkEntry, gtUserTable=gtUserTable, gtTimeLocal=gtTimeLocal, gtNetworkPortName=gtNetworkPortName, gtNetworkPortNumber=gtNetworkPortNumber, gtSyslogState=gtSyslogState, gtDNSNumber=gtDNSNumber, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceEntry=gtInterfaceEntry, gtSFPEntry=gtSFPEntry, gtTrapUser=gtTrapUser, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleUpdate=gtModuleUpdate, gtGroupParamIdx=gtGroupParamIdx, gtCurrentUserName=gtCurrentUserName, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapComString=gtTrapComString, gtWebProtocol=gtWebProtocol, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestNumber=gtTrapDestNumber, gtNTPServerTable=gtNTPServerTable, gtSettingsObjects=gtSettingsObjects, gtNetworking=gtNetworking, gtFilename=gtFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPUsername=gtBackupSFTPUsername, gtDateAndTimeTable=gtDateAndTimeTable, gtSyslogIP=gtSyslogIP, gtTrapDestPort=gtTrapDestPort, gtSFPPlugged=gtSFPPlugged, gtModuleBackupDate=gtModuleBackupDate, gtSLAEntry=gtSLAEntry, gtHMSComMethod=gtHMSComMethod, gtUpdateControl=gtUpdateControl, gtWebEnable=gtWebEnable, gtGeneral=gtGeneral, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSEntry=gtHMSEntry, gtSwitch=gtSwitch, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUser=gtUser, gtUserEntry=gtUserEntry, gtPortsTable=gtPortsTable, gtGroupTable=gtGroupTable, gtInterfaceIPv4=gtInterfaceIPv4, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestIP=gtTrapDestIP, gtUserName=gtUserName, gtUpdateStatus=gtUpdateStatus, gtNetworkTable=gtNetworkTable, gtCurrentTimeSource=gtCurrentTimeSource, gtServicesTable=gtServicesTable, gtModuleBackupTable=gtModuleBackupTable, gtAccesslistEntry=gtAccesslistEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAccesslistTable=gtAccesslistTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleBackupControl=gtModuleBackupControl, gtServices=gtServices, gtSLAExpires=gtSLAExpires, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupSFTPPassword=gtBackupSFTPPassword, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateFile=gtUpdateFile, gtInterfaceNumber=gtInterfaceNumber, gtSyslogTable=gtSyslogTable, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceTable=gtInterfaceTable, gtSNMP=gtSNMP, gtGroupRights=gtGroupRights, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceName=gtInterfaceName, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsMIB=gtSettingsMIB, gtSFPNumber=gtSFPNumber, gtPortsNumber=gtPortsNumber, gtSLATable=gtSLATable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLARegistered=gtSLARegistered, gtServicesEntry=gtServicesEntry, gtHMSTable=gtHMSTable, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapDestTable=gtTrapDestTable, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserAuthTable=gtUserAuthTable, gtAgentState=gtAgentState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPLink=gtSFPLink, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsEntry=gtPortsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtWebAuth=gtWebAuth, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapDestRowStatus=gtTrapDestRowStatus, gtAgentPort=gtAgentPort, gtAccesslistIdx=gtAccesslistIdx, gtUserPassword=gtUserPassword, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceState=gtInterfaceState, gtUserGroup=gtUserGroup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTimeZone=gtTimeZone, gtModuleRedundancyMode=gtModuleRedundancyMode, gtModuleBackupStatus=gtModuleBackupStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerNumber=gtNTPServerNumber, gtBackupControl=gtBackupControl, gtSNMPEntry=gtSNMPEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDaylightAdjustment=gtDaylightAdjustment, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFTPPassword=gtSFTPPassword, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkVLAN=gtNetworkVLAN, gtSWOptionsIdx=gtSWOptionsIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDNSTable=gtDNSTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSWOption=gtSWOption, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUserRowStatus=gtUserRowStatus, gtDNSEntry=gtDNSEntry, gtSNMPTable=gtSNMPTable, gtSettingsNotifications=gtSettingsNotifications, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGroupIdx=gtGroupIdx, gtGroupEntry=gtGroupEntry, gtHMSGroupName=gtHMSGroupName, gtTrapDestEntry=gtTrapDestEntry, gtAgentComReadString=gtAgentComReadString, PYSNMP_MODULE_ID=gtSettingsMIB, gtAccesslistName=gtAccesslistName, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkName=gtNetworkName, gtInterfaceCLI=gtInterfaceCLI, gtUserAccesslist=gtUserAccesslist, gtSettingsConformance=gtSettingsConformance, gtPortsName=gtPortsName, gtGroupName=gtGroupName, gtTrapState=gtTrapState, gtNumSFP=gtNumSFP, gtBackupStatus=gtBackupStatus, gtHMSNumMembers=gtHMSNumMembers, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentComWriteString=gtAgentComWriteString, gtUserParamIdx=gtUserParamIdx, gtDateAndTime=gtDateAndTime, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsLinkup=gtPortsLinkup, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPServer=gtSFTPServer, gtUserIdx=gtUserIdx, gtModuleBackup=gtModuleBackup)
