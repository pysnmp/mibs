...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, TimeTicks, Integer32, Bits, NotificationType, Counter64, ObjectIdentity, IpAddress, iso, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "TimeTicks", "Integer32", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "iso", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAgentComReadString=gtAgentComReadString, gtSLARegistered=gtSLARegistered, gtGroupEntry=gtGroupEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSyslogState=gtSyslogState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapState=gtTrapState, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtTimeLocal=gtTimeLocal, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsName=gtPortsName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSNMPTable=gtSNMPTable, gtInterfaceState=gtInterfaceState, gtTrapPDU=gtTrapPDU, gtSNMPEntry=gtSNMPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFile=gtUpdateFile, gtSLATable=gtSLATable, gtHMSNumMembers=gtHMSNumMembers, gtSLAEntry=gtSLAEntry, gtUser=gtUser, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSFPTable=gtSFPTable, gtUserEntry=gtUserEntry, gtSWOption=gtSWOption, gtSFPSpeed=gtSFPSpeed, gtDNSServerIP=gtDNSServerIP, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtSFPNumber=gtSFPNumber, gtDNSNumber=gtDNSNumber, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtDateAndTime=gtDateAndTime, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUpdateStatus=gtUpdateStatus, gtSLAExpires=gtSLAExpires, gtInterfaceNumber=gtInterfaceNumber, gtSettingsNotifications=gtSettingsNotifications, gtGroupIdx=gtGroupIdx, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapUser=gtTrapUser, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworking=gtNetworking, gtSFPLink=gtSFPLink, gtSettingsConformance=gtSettingsConformance, gtModuleBackupTable=gtModuleBackupTable, gtUserIdx=gtUserIdx, gtPortsEntry=gtPortsEntry, gtTimeZone=gtTimeZone, gtSyslogIP=gtSyslogIP, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackupControl=gtModuleBackupControl, gtGroupName=gtGroupName, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceTable=gtInterfaceTable, gtUserAccesslist=gtUserAccesslist, gtUserAuthEntry=gtUserAuthEntry, gtUserParamIdx=gtUserParamIdx, gtTimeUTC=gtTimeUTC, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtPortsNumber=gtPortsNumber, gtNetworkPortState=gtNetworkPortState, gtModuleUpdate=gtModuleUpdate, gtModuleBackup=gtModuleBackup, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserName=gtUserName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSWOptionsIdx=gtSWOptionsIdx, gtHMSGroupName=gtHMSGroupName, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserRowStatus=gtUserRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtServicesTable=gtServicesTable, gtSFTPPassword=gtSFTPPassword, gtInterfaceSNMP=gtInterfaceSNMP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapComString=gtTrapComString, gtFilename=gtFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAgentComWriteString=gtAgentComWriteString, gtHeadendSystemManagement=gtHeadendSystemManagement, gtAccesslistIdx=gtAccesslistIdx, gtWebEnable=gtWebEnable, gtTrapDestEntry=gtTrapDestEntry, gtWebProtocol=gtWebProtocol, PYSNMP_MODULE_ID=gtSettingsMIB, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceEntry=gtInterfaceEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtBackupStatus=gtBackupStatus, gtWebAuth=gtWebAuth, gtUserTable=gtUserTable, gtChassisRedundancy=gtChassisRedundancy, gtDNSEntry=gtDNSEntry, gtServices=gtServices, gtSWOptionsTable=gtSWOptionsTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHMSEntry=gtHMSEntry, gtNetworkEntry=gtNetworkEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPPlugged=gtSFPPlugged, gtUpdateFilesTable=gtUpdateFilesTable, gtNTPServerAddress=gtNTPServerAddress, gtNetworkName=gtNetworkName, gtAccesslistTable=gtAccesslistTable, gtBackupControl=gtBackupControl, gtPortsTable=gtPortsTable, gtSFTPServer=gtSFTPServer, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDaylightAdjustment=gtDaylightAdjustment, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupRights=gtGroupRights, gtCurrentUserName=gtCurrentUserName, gtNTPServerTable=gtNTPServerTable, gtInterfaceMAC=gtInterfaceMAC, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortNumber=gtNetworkPortNumber, gtSwitch=gtSwitch, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPUsername=gtSFTPUsername, gtSettingsMIB=gtSettingsMIB, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceIPv4=gtInterfaceIPv4, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupTable=gtGroupTable, gtHMSComMethod=gtHMSComMethod, gtSNMP=gtSNMP, gtServicesEntry=gtServicesEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkVLAN=gtNetworkVLAN, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentState=gtAgentState, gtDNSTable=gtDNSTable, gtUserGroup=gtUserGroup, gtSyslogTable=gtSyslogTable, gtNetworkPortName=gtNetworkPortName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUpdateControl=gtUpdateControl, gtUserAuthTable=gtUserAuthTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsCompliances=gtSettingsCompliances, gtGeneral=gtGeneral, gtPortsLinkup=gtPortsLinkup, gtUserPassword=gtUserPassword, gtAccesslistName=gtAccesslistName, gtSyslogEntry=gtSyslogEntry, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistEntry=gtAccesslistEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNumSFP=gtNumSFP, gtSFPEntry=gtSFPEntry, gtAgentPort=gtAgentPort, gtGroupParamIdx=gtGroupParamIdx, gtSFTPPort=gtSFTPPort, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNTPServerEntry=gtNTPServerEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceName=gtInterfaceName, gtSettingsObjects=gtSettingsObjects, gtNetworkTable=gtNetworkTable, gtTrapDestTable=gtTrapDestTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFPType=gtSFPType, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSTable=gtHMSTable)
