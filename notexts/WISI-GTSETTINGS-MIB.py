...
TimeTicks, Unsigned32, IpAddress, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, MibIdentifier, Bits, iso, Counter32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "iso", "Counter32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkName=gtNetworkName, gtSyslogState=gtSyslogState, gtUserEntry=gtUserEntry, gtSLATable=gtSLATable, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupRights=gtGroupRights, gtServicesEntry=gtServicesEntry, gtSLARegistered=gtSLARegistered, gtTrapState=gtTrapState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceVLAN=gtInterfaceVLAN, gtTimeLocal=gtTimeLocal, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerTable=gtNTPServerTable, gtInterfaceNumber=gtInterfaceNumber, gtSLAEntry=gtSLAEntry, gtPortsLinkup=gtPortsLinkup, gtTrapComString=gtTrapComString, gtSettingsGroups=gtSettingsGroups, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateControl=gtUpdateControl, gtSFPLink=gtSFPLink, gtSFPSpeed=gtSFPSpeed, gtAccesslistName=gtAccesslistName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAgentState=gtAgentState, gtDNSServerIP=gtDNSServerIP, gtInterfaceStreaming=gtInterfaceStreaming, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPUsername=gtBackupSFTPUsername, gtGroupParamIdx=gtGroupParamIdx, gtTimeZone=gtTimeZone, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtModuleBackupStatus=gtModuleBackupStatus, gtGroupIdx=gtGroupIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDateAndTimeTable=gtDateAndTimeTable, gtPortsTable=gtPortsTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleUpdate=gtModuleUpdate, gtSFTPUsername=gtSFTPUsername, gtUserName=gtUserName, gtInterfaceState=gtInterfaceState, gtHMSEntry=gtHMSEntry, gtHMSGroupName=gtHMSGroupName, gtUserIdx=gtUserIdx, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackup=gtModuleBackup, gtAgentComWriteString=gtAgentComWriteString, gtFilename=gtFilename, gtInterfaceSNMP=gtInterfaceSNMP, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIPv4=gtInterfaceIPv4, gtSFTPPassword=gtSFTPPassword, gtAccesslistTable=gtAccesslistTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtWebEnable=gtWebEnable, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapPDU=gtTrapPDU, gtUserTable=gtUserTable, gtBackupStatus=gtBackupStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtSFTPPort=gtSFTPPort, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsCompliances=gtSettingsCompliances, gtDNSNumber=gtDNSNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHMSNumAvailModules=gtHMSNumAvailModules, gtGroupTable=gtGroupTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSNMPTable=gtSNMPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSNMP=gtSNMP, gtDNSTable=gtDNSTable, gtSettingsMIB=gtSettingsMIB, gtNetworking=gtNetworking, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortState=gtNetworkPortState, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSTable=gtHMSTable, gtUserAccesslist=gtUserAccesslist, gtChassisRedundancy=gtChassisRedundancy, gtSyslogEntry=gtSyslogEntry, gtSFPTable=gtSFPTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSNumMembers=gtHMSNumMembers, gtBackupControl=gtBackupControl, gtInterfaceCLI=gtInterfaceCLI, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupDate=gtModuleBackupDate, gtSNMPEntry=gtSNMPEntry, gtAgentPort=gtAgentPort, gtSWOption=gtSWOption, gtTrapDestIP=gtTrapDestIP, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleBackupTable=gtModuleBackupTable, gtNetworkPortName=gtNetworkPortName, gtAgentComReadString=gtAgentComReadString, gtNetworkTable=gtNetworkTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSyslogTable=gtSyslogTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupName=gtGroupName, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtCurrentUserName=gtCurrentUserName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtServicesTable=gtServicesTable, gtInterfaceIGMP=gtInterfaceIGMP, gtPortsNumber=gtPortsNumber, gtDNSEntry=gtDNSEntry, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceMAC=gtInterfaceMAC, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserAuthTable=gtUserAuthTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, PYSNMP_MODULE_ID=gtSettingsMIB, gtDateAndTime=gtDateAndTime, gtSFPNumber=gtSFPNumber, gtUserPassword=gtUserPassword, gtUserGroup=gtUserGroup, gtUpdateStatus=gtUpdateStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNTPServerNumber=gtNTPServerNumber, gtSFPType=gtSFPType, gtTrapDestPort=gtTrapDestPort, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceTable=gtInterfaceTable, gtSwitch=gtSwitch, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupSFTPPort=gtBackupSFTPPort, gtSFTPServer=gtSFTPServer, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNumSFP=gtNumSFP, gtTimeUTC=gtTimeUTC, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPPlugged=gtSFPPlugged, gtSWOptionsTable=gtSWOptionsTable, gtServices=gtServices, gtInterfaceName=gtInterfaceName, gtPortsName=gtPortsName, gtUpdateFile=gtUpdateFile, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserRowStatus=gtUserRowStatus, gtTrapUser=gtTrapUser, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNTPServerAddress=gtNTPServerAddress, gtSettingsConformance=gtSettingsConformance, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistEntry=gtAccesslistEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkEntry=gtNetworkEntry, gtSLAExpires=gtSLAExpires, gtUserAuthEntry=gtUserAuthEntry, gtUser=gtUser, gtWebAuth=gtWebAuth, gtSFPEntry=gtSFPEntry, gtHMSComMethod=gtHMSComMethod, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtCurrentUserPassword=gtCurrentUserPassword, gtSWOptionsEntry=gtSWOptionsEntry, gtGeneral=gtGeneral, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapDestTable=gtTrapDestTable, gtPortsEntry=gtPortsEntry, gtGroupAccesslist=gtGroupAccesslist, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtGroupEntry=gtGroupEntry, gtSyslogIP=gtSyslogIP, gtSettingsObjects=gtSettingsObjects, gtSettingsNotifications=gtSettingsNotifications, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtWebProtocol=gtWebProtocol)
