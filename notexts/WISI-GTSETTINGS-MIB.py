...
NotificationType, iso, Counter32, Bits, ModuleIdentity, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, IpAddress, Counter64, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter32", "Bits", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "IpAddress", "Counter64", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkTable=gtNetworkTable, gtSettingsConformance=gtSettingsConformance, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceMAC=gtInterfaceMAC, gtAgentPort=gtAgentPort, gtNTPServerNumber=gtNTPServerNumber, gtAccesslistTable=gtAccesslistTable, gtUserAuthTable=gtUserAuthTable, gtTimeZone=gtTimeZone, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsMIB=gtSettingsMIB, gtNumSFP=gtNumSFP, gtTrapDestTable=gtTrapDestTable, gtUserAccesslist=gtUserAccesslist, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupIdx=gtGroupIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNTPServerTable=gtNTPServerTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupName=gtGroupName, gtSWOptionsTable=gtSWOptionsTable, gtAgentComReadString=gtAgentComReadString, gtGroupTable=gtGroupTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPType=gtSFPType, gtWebEnable=gtWebEnable, gtNetworkPortsTable=gtNetworkPortsTable, gtSNMP=gtSNMP, gtTrapComString=gtTrapComString, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSFPPlugged=gtSFPPlugged, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAccesslistIdx=gtAccesslistIdx, gtBackupControl=gtBackupControl, gtPortsEntry=gtPortsEntry, gtUserName=gtUserName, gtGroupEntry=gtGroupEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtUserRowStatus=gtUserRowStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtGeneral=gtGeneral, gtUserIdx=gtUserIdx, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentState=gtAgentState, gtSFTPPort=gtSFTPPort, gtChassisRedundancy=gtChassisRedundancy, gtDaylightAdjustment=gtDaylightAdjustment, gtSyslogState=gtSyslogState, gtBackupStatus=gtBackupStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsCompliances=gtSettingsCompliances, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsObjects=gtSettingsObjects, gtModuleBackup=gtModuleBackup, gtNetworkPortName=gtNetworkPortName, gtModuleBackupStatus=gtModuleBackupStatus, gtPortsName=gtPortsName, gtInterfaceIPv4=gtInterfaceIPv4, gtGroupParamIdx=gtGroupParamIdx, gtSLATable=gtSLATable, gtTrapUser=gtTrapUser, gtNetworkPortNumber=gtNetworkPortNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceState=gtInterfaceState, gtAgentComWriteString=gtAgentComWriteString, gtTrapState=gtTrapState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSWOptionsIdx=gtSWOptionsIdx, gtSFTPUsername=gtSFTPUsername, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUser=gtUser, gtAccesslistIPRange=gtAccesslistIPRange, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserParamIdx=gtUserParamIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserPassword=gtUserPassword, gtSFPNumber=gtSFPNumber, gtNetworkVLAN=gtNetworkVLAN, gtDNSNumber=gtDNSNumber, gtHMSTable=gtHMSTable, gtSettingsGroups=gtSettingsGroups, gtServicesEntry=gtServicesEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDNSEntry=gtDNSEntry, gtNetworkName=gtNetworkName, gtSLARegistered=gtSLARegistered, gtAccesslistName=gtAccesslistName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkEntry=gtNetworkEntry, gtNTPServerAddress=gtNTPServerAddress, gtServices=gtServices, gtGroupRights=gtGroupRights, gtServicesTable=gtServicesTable, gtModuleBackupTable=gtModuleBackupTable, gtSFPTable=gtSFPTable, gtTrapDestNumber=gtTrapDestNumber, gtPortsNumber=gtPortsNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtSWOption=gtSWOption, gtInterfaceEntry=gtInterfaceEntry, gtDNSServerIP=gtDNSServerIP, gtPortsLinkup=gtPortsLinkup, gtModuleBackupDate=gtModuleBackupDate, gtSFPEntry=gtSFPEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkPortState=gtNetworkPortState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPPort=gtBackupSFTPPort, gtFilename=gtFilename, gtUserTable=gtUserTable, gtSyslogIP=gtSyslogIP, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleUpdate=gtModuleUpdate, gtUserAuthEntry=gtUserAuthEntry, gtSFTPPassword=gtSFTPPassword, gtUpdateFile=gtUpdateFile, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSyslogEntry=gtSyslogEntry, gtSNMPTable=gtSNMPTable, gtTrapDestIP=gtTrapDestIP, gtUserEntry=gtUserEntry, gtModuleBackupControl=gtModuleBackupControl, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFPSpeed=gtSFPSpeed, gtNTPServerEntry=gtNTPServerEntry, gtHMSEntry=gtHMSEntry, gtTrapPDU=gtTrapPDU, gtSLAEntry=gtSLAEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupAccesslist=gtGroupAccesslist, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSLAExpires=gtSLAExpires, gtSwitch=gtSwitch, gtTimeUTC=gtTimeUTC, gtTrapDestPort=gtTrapDestPort, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceStreaming=gtInterfaceStreaming, gtPortsBitrateTransmit=gtPortsBitrateTransmit, PYSNMP_MODULE_ID=gtSettingsMIB, gtWebProtocol=gtWebProtocol, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupSFTPFilename=gtBackupSFTPFilename, gtWebAuth=gtWebAuth, gtDNSTable=gtDNSTable, gtInterfaceName=gtInterfaceName, gtInterfaceVLAN=gtInterfaceVLAN, gtUserGroup=gtUserGroup, gtSyslogTable=gtSyslogTable, gtPortsTable=gtPortsTable, gtAccesslistEntry=gtAccesslistEntry, gtDateAndTime=gtDateAndTime, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPLink=gtSFPLink, gtSFTPServer=gtSFTPServer, gtModuleRedundancyMode=gtModuleRedundancyMode, gtHMSGroupName=gtHMSGroupName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTimeLocal=gtTimeLocal, gtHMSNumMembers=gtHMSNumMembers, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateControl=gtUpdateControl, gtInterfaceTable=gtInterfaceTable, gtSNMPEntry=gtSNMPEntry, gtInterfaceCLI=gtInterfaceCLI, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSComMethod=gtHMSComMethod, gtDateAndTimeTable=gtDateAndTimeTable, gtSettingsNotifications=gtSettingsNotifications, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworking=gtNetworking)
