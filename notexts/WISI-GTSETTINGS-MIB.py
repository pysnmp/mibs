...
NotificationType, Counter32, Bits, ModuleIdentity, iso, ObjectIdentity, Unsigned32, Gauge32, Integer32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "ModuleIdentity", "iso", "ObjectIdentity", "Unsigned32", "Gauge32", "Integer32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkTable=gtNetworkTable, gtSNMPEntry=gtSNMPEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistEntry=gtAccesslistEntry, gtSFTPUsername=gtSFTPUsername, gtSFTPPort=gtSFTPPort, gtSFPPlugged=gtSFPPlugged, gtInterfaceState=gtInterfaceState, gtModuleBackup=gtModuleBackup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupParamIdx=gtGroupParamIdx, gtTrapDestNumber=gtTrapDestNumber, gtUserParamIdx=gtUserParamIdx, gtSFPTable=gtSFPTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupEntry=gtGroupEntry, gtInterfaceEntry=gtInterfaceEntry, gtAgentComReadString=gtAgentComReadString, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSyslogIP=gtSyslogIP, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceName=gtInterfaceName, gtTimeLocal=gtTimeLocal, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceCLI=gtInterfaceCLI, gtSettingsNotifications=gtSettingsNotifications, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleBackupControl=gtModuleBackupControl, gtNetworking=gtNetworking, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTimeZone=gtTimeZone, gtGroupAccesslist=gtGroupAccesslist, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserAccesslist=gtUserAccesslist, gtSFPType=gtSFPType, gtSwitch=gtSwitch, gtGroupRights=gtGroupRights, gtTrapDestTable=gtTrapDestTable, gtCurrentUserName=gtCurrentUserName, gtNTPServerTable=gtNTPServerTable, gtTrapDestPort=gtTrapDestPort, gtUserEntry=gtUserEntry, gtPortsNumber=gtPortsNumber, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtWebProtocol=gtWebProtocol, gtHMSNumMembers=gtHMSNumMembers, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSWOptionsTable=gtSWOptionsTable, gtSNMPTable=gtSNMPTable, gtGeneral=gtGeneral, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDateAndTime=gtDateAndTime, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapState=gtTrapState, gtBackupStatus=gtBackupStatus, gtServicesEntry=gtServicesEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServices=gtServices, gtWebEnable=gtWebEnable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserPassword=gtUserPassword, gtChassisRedundancy=gtChassisRedundancy, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleBackupStatus=gtModuleBackupStatus, gtDaylightAdjustment=gtDaylightAdjustment, gtSFTPServer=gtSFTPServer, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistName=gtAccesslistName, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsName=gtPortsName, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsGroups=gtSettingsGroups, gtTrapDestEntry=gtTrapDestEntry, gtHMSTable=gtHMSTable, gtTrapDestIP=gtTrapDestIP, gtDNSNumber=gtDNSNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAgentState=gtAgentState, gtFilename=gtFilename, gtNetworkPortState=gtNetworkPortState, gtDNSServerIP=gtDNSServerIP, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtHMSComMethod=gtHMSComMethod, gtSyslogTable=gtSyslogTable, gtSFPLink=gtSFPLink, gtNTPServerNumber=gtNTPServerNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUserTable=gtUserTable, gtSettingsObjects=gtSettingsObjects, gtSFTPPassword=gtSFTPPassword, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceMAC=gtInterfaceMAC, PYSNMP_MODULE_ID=gtSettingsMIB, gtAgentComWriteString=gtAgentComWriteString, gtModuleBackupEntry=gtModuleBackupEntry, gtTimeUTC=gtTimeUTC, gtUpdateStatus=gtUpdateStatus, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserGroup=gtUserGroup, gtAgentPort=gtAgentPort, gtNumSFP=gtNumSFP, gtGroupIdx=gtGroupIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceTable=gtInterfaceTable, gtSettingsConformance=gtSettingsConformance, gtModuleUpdate=gtModuleUpdate, gtSLAEntry=gtSLAEntry, gtTrapPDU=gtTrapPDU, gtUserAuthEntry=gtUserAuthEntry, gtUserName=gtUserName, gtWebAuth=gtWebAuth, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSTable=gtDNSTable, gtUserAuthTable=gtUserAuthTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtServicesTable=gtServicesTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPSpeed=gtSFPSpeed, gtSyslogState=gtSyslogState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapComString=gtTrapComString, gtHMSEntry=gtHMSEntry, gtPortsTable=gtPortsTable, gtUpdateFilesTable=gtUpdateFilesTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceNumber=gtInterfaceNumber, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSEntry=gtDNSEntry, gtTrapUser=gtTrapUser, gtUserRowStatus=gtUserRowStatus, gtGroupName=gtGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAccesslistTable=gtAccesslistTable, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkEntry=gtNetworkEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceStreaming=gtInterfaceStreaming, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUpdateControl=gtUpdateControl, gtNetworkPortsTable=gtNetworkPortsTable, gtUpdateFile=gtUpdateFile, gtNetworkPortName=gtNetworkPortName, gtNetworkName=gtNetworkName, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPNumber=gtSFPNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUser=gtUser, gtModuleBackupTable=gtModuleBackupTable, gtSLAExpires=gtSLAExpires, gtSNMP=gtSNMP, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceSNMP=gtInterfaceSNMP, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkVLAN=gtNetworkVLAN, gtBackupControl=gtBackupControl, gtSFPEntry=gtSFPEntry, gtAccesslistIdx=gtAccesslistIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSGroupName=gtHMSGroupName, gtUserIdx=gtUserIdx, gtGroupTable=gtGroupTable, gtPortsEntry=gtPortsEntry, gtSettingsMIB=gtSettingsMIB, gtSLATable=gtSLATable, gtSLARegistered=gtSLARegistered, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSWOption=gtSWOption, gtSyslogEntry=gtSyslogEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsLinkup=gtPortsLinkup, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapSNMPVersion=gtTrapSNMPVersion)
