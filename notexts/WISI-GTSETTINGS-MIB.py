...
Bits, Gauge32, ObjectIdentity, Counter64, NotificationType, MibIdentifier, TimeTicks, Counter32, IpAddress, Integer32, ModuleIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "Counter64", "NotificationType", "MibIdentifier", "TimeTicks", "Counter32", "IpAddress", "Integer32", "ModuleIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSNMPTable=gtSNMPTable, gtGroupAccesslist=gtGroupAccesslist, gtUpdateFile=gtUpdateFile, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSNMPEntry=gtSNMPEntry, gtSettingsConformance=gtSettingsConformance, gtInterfaceCLI=gtInterfaceCLI, gtUserIdx=gtUserIdx, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSettingsNotifications=gtSettingsNotifications, gtAgentPort=gtAgentPort, gtDateAndTimeTable=gtDateAndTimeTable, gtAgentComReadString=gtAgentComReadString, gtUserAuthEntry=gtUserAuthEntry, gtPortsName=gtPortsName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapUser=gtTrapUser, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSNMP=gtSNMP, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceMAC=gtInterfaceMAC, gtTimeLocal=gtTimeLocal, gtDateAndTime=gtDateAndTime, gtCurrentUserName=gtCurrentUserName, gtNetworkTable=gtNetworkTable, gtWebAuth=gtWebAuth, gtUserGroup=gtUserGroup, gtInterfaceStreaming=gtInterfaceStreaming, gtAgentSecurityLevel=gtAgentSecurityLevel, gtHMSNumMembers=gtHMSNumMembers, gtGroupTable=gtGroupTable, gtBackupControl=gtBackupControl, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUpdateStatus=gtUpdateStatus, gtSFTPPort=gtSFTPPort, gtNetworkPortNumber=gtNetworkPortNumber, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkName=gtNetworkName, gtPortsTable=gtPortsTable, gtInterfaceName=gtInterfaceName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSLAExpires=gtSLAExpires, gtSyslogState=gtSyslogState, gtDaylightAdjustment=gtDaylightAdjustment, gtSLATable=gtSLATable, gtSFTPServer=gtSFTPServer, gtTimeZone=gtTimeZone, gtTrapComString=gtTrapComString, gtSettingsMIB=gtSettingsMIB, gtWebProtocol=gtWebProtocol, gtBackupSFTPFilename=gtBackupSFTPFilename, gtFilename=gtFilename, gtPortsBitrateReceive=gtPortsBitrateReceive, gtGeneral=gtGeneral, gtModuleBackupControl=gtModuleBackupControl, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebEnable=gtWebEnable, gtSwitch=gtSwitch, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPNumber=gtSFPNumber, gtSFPSpeed=gtSFPSpeed, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSWOptionsIdx=gtSWOptionsIdx, gtGroupParamIdx=gtGroupParamIdx, gtNetworkEntry=gtNetworkEntry, gtInterfaceState=gtInterfaceState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNetworkVLAN=gtNetworkVLAN, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapState=gtTrapState, gtTimeUTC=gtTimeUTC, gtSWOption=gtSWOption, PYSNMP_MODULE_ID=gtSettingsMIB, gtHMSComMethod=gtHMSComMethod, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSyslogIP=gtSyslogIP, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSFPTable=gtSFPTable, gtDNSNumber=gtDNSNumber, gtUserParamIdx=gtUserParamIdx, gtSFPPlugged=gtSFPPlugged, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSyslogEntry=gtSyslogEntry, gtNumSFP=gtNumSFP, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtSFTPUsername=gtSFTPUsername, gtTrapDestTable=gtTrapDestTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSTable=gtHMSTable, gtNetworking=gtNetworking, gtSettingsGroups=gtSettingsGroups, gtModuleBackup=gtModuleBackup, gtInterfaceIPv4=gtInterfaceIPv4, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceEntry=gtInterfaceEntry, gtAgentState=gtAgentState, gtBackupSFTPPort=gtBackupSFTPPort, gtModuleUpdate=gtModuleUpdate, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkPortState=gtNetworkPortState, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUser=gtUser, gtAccesslistName=gtAccesslistName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupRights=gtGroupRights, gtNetworkPortsTable=gtNetworkPortsTable, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapDestIP=gtTrapDestIP, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupEntry=gtModuleBackupEntry, gtUserRowStatus=gtUserRowStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtNTPServerEntry=gtNTPServerEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPPassword=gtBackupSFTPPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsCompliances=gtSettingsCompliances, gtNTPServerNumber=gtNTPServerNumber, gtDNSTable=gtDNSTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserEntry=gtUserEntry, gtTrapDestEntry=gtTrapDestEntry, gtUserAuthTable=gtUserAuthTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateFilesTable=gtUpdateFilesTable, gtUserTable=gtUserTable, gtHMSEntry=gtHMSEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerTable=gtNTPServerTable, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsObjects=gtSettingsObjects, gtTrapDestNumber=gtTrapDestNumber, gtGroupEntry=gtGroupEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserName=gtUserName, gtUpdateControl=gtUpdateControl, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceIGMP=gtInterfaceIGMP, gtUserPassword=gtUserPassword, gtSFTPPassword=gtSFTPPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapPDU=gtTrapPDU, gtSFPEntry=gtSFPEntry, gtPortsEntry=gtPortsEntry, gtHMSGroupName=gtHMSGroupName, gtSFPLink=gtSFPLink, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNTPServerAddress=gtNTPServerAddress, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupStatus=gtBackupStatus, gtTrapDestPort=gtTrapDestPort, gtInterfaceTable=gtInterfaceTable, gtSLAEntry=gtSLAEntry, gtPortsNumber=gtPortsNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtCurrentTimeSource=gtCurrentTimeSource, gtServicesEntry=gtServicesEntry, gtServices=gtServices, gtSFPType=gtSFPType, gtGroupName=gtGroupName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleBackupDate=gtModuleBackupDate, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSLARegistered=gtSLARegistered, gtUserAccesslist=gtUserAccesslist, gtDNSServerIP=gtDNSServerIP, gtInterfaceDHCPState=gtInterfaceDHCPState, gtDNSEntry=gtDNSEntry, gtAccesslistTable=gtAccesslistTable, gtAccesslistEntry=gtAccesslistEntry, gtSyslogTable=gtSyslogTable, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupIdx=gtGroupIdx, gtAccesslistIdx=gtAccesslistIdx, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortName=gtNetworkPortName, gtPortsLinkup=gtPortsLinkup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtServicesTable=gtServicesTable)
