...
NotificationType, Counter32, iso, Integer32, Bits, MibIdentifier, Unsigned32, IpAddress, TimeTicks, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "iso", "Integer32", "Bits", "MibIdentifier", "Unsigned32", "IpAddress", "TimeTicks", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPSpeed=gtSFPSpeed, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceNumber=gtInterfaceNumber, gtSFPTable=gtSFPTable, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserRowStatus=gtUserRowStatus, gtUserName=gtUserName, gtUserPassword=gtUserPassword, gtTrapDestNumber=gtTrapDestNumber, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtServices=gtServices, gtDNSServerIP=gtDNSServerIP, gtUpdateStatus=gtUpdateStatus, gtSWOption=gtSWOption, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLAEntry=gtSLAEntry, gtWebProtocol=gtWebProtocol, gtSFTPPassword=gtSFTPPassword, gtNTPServerTable=gtNTPServerTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapUser=gtTrapUser, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsNumber=gtPortsNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortName=gtNetworkPortName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNumSFP=gtNumSFP, gtSettingsNotifications=gtSettingsNotifications, gtDNSNumber=gtDNSNumber, gtNetworkName=gtNetworkName, gtDateAndTime=gtDateAndTime, gtInterfaceStreaming=gtInterfaceStreaming, gtSFPNumber=gtSFPNumber, gtAccesslistEntry=gtAccesslistEntry, gtSFPType=gtSFPType, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceState=gtInterfaceState, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsMIB=gtSettingsMIB, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapPDU=gtTrapPDU, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSEntry=gtDNSEntry, gtSyslogIP=gtSyslogIP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapDestIP=gtTrapDestIP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkPortsEntry=gtNetworkPortsEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtServicesTable=gtServicesTable, gtNetworkPortsTable=gtNetworkPortsTable, gtUserAuthEntry=gtUserAuthEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtModuleUpdate=gtModuleUpdate, gtPortsTable=gtPortsTable, gtUserTable=gtUserTable, gtUserAccesslist=gtUserAccesslist, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupRights=gtGroupRights, gtTrapComString=gtTrapComString, gtHMSNumMembers=gtHMSNumMembers, gtWebEnable=gtWebEnable, gtSettingsGroups=gtSettingsGroups, gtWebAuth=gtWebAuth, gtGroupAccesslist=gtGroupAccesslist, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserEntry=gtUserEntry, gtTimeUTC=gtTimeUTC, gtGroupIdx=gtGroupIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapState=gtTrapState, gtTimeZone=gtTimeZone, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentComReadString=gtAgentComReadString, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFTPPort=gtSFTPPort, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworking=gtNetworking, gtHMSGroupName=gtHMSGroupName, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerEntry=gtNTPServerEntry, gtNetworkEntry=gtNetworkEntry, gtModuleBackup=gtModuleBackup, gtInterfaceName=gtInterfaceName, gtSLATable=gtSLATable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNTPServerAddress=gtNTPServerAddress, gtFilename=gtFilename, gtGroupEntry=gtGroupEntry, gtGroupName=gtGroupName, gtInterfaceEntry=gtInterfaceEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtSyslogState=gtSyslogState, gtSFPLink=gtSFPLink, gtHMSComMethod=gtHMSComMethod, gtSNMPEntry=gtSNMPEntry, gtServicesEntry=gtServicesEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIPv4=gtInterfaceIPv4, gtPortsLinkup=gtPortsLinkup, gtHMSTable=gtHMSTable, gtNetworkTable=gtNetworkTable, gtUserIdx=gtUserIdx, gtGeneral=gtGeneral, gtSFPPlugged=gtSFPPlugged, gtAgentState=gtAgentState, gtAccesslistName=gtAccesslistName, gtModuleBackupStatus=gtModuleBackupStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistIdx=gtAccesslistIdx, gtModuleBackupTable=gtModuleBackupTable, gtNTPServerNumber=gtNTPServerNumber, gtUpdateFile=gtUpdateFile, gtDNSTable=gtDNSTable, gtTrapDestTable=gtTrapDestTable, gtInterfaceMAC=gtInterfaceMAC, gtGroupTable=gtGroupTable, gtPortsName=gtPortsName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceTable=gtInterfaceTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAccesslistTable=gtAccesslistTable, gtSyslogTable=gtSyslogTable, gtSNMP=gtSNMP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworkPortState=gtNetworkPortState, gtSLARegistered=gtSLARegistered, gtSNMPTable=gtSNMPTable, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapDestPort=gtTrapDestPort, gtNetworkVLAN=gtNetworkVLAN, gtHMSEntry=gtHMSEntry, gtBackupStatus=gtBackupStatus, gtSwitch=gtSwitch, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestEntry=gtTrapDestEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceCLI=gtInterfaceCLI, gtAgentComWriteString=gtAgentComWriteString, gtUser=gtUser, gtGroupParamIdx=gtGroupParamIdx, gtUpdateControl=gtUpdateControl, gtUserAuthTable=gtUserAuthTable, gtPortsEntry=gtPortsEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupControl=gtBackupControl, gtSLAExpires=gtSLAExpires, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsCompliances=gtSettingsCompliances, gtTrapSNMPVersion=gtTrapSNMPVersion, gtCurrentTimeSource=gtCurrentTimeSource, gtSettingsConformance=gtSettingsConformance, gtUserGroup=gtUserGroup, gtSFPEntry=gtSFPEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFTPServer=gtSFTPServer, gtSyslogEntry=gtSyslogEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtChassisRedundancy=gtChassisRedundancy, gtAgentPort=gtAgentPort, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSettingsObjects=gtSettingsObjects, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPUsername=gtSFTPUsername, gtTimeLocal=gtTimeLocal, gtCurrentUserName=gtCurrentUserName, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtModuleBackupDate=gtModuleBackupDate)
