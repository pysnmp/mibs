...
Gauge32, IpAddress, Bits, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, MibIdentifier, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "MibIdentifier", "Counter64", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNTPServerNumber=gtNTPServerNumber, gtTrapState=gtTrapState, gtTrapDestTable=gtTrapDestTable, gtInterfaceTable=gtInterfaceTable, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapUser=gtTrapUser, gtUserAccesslist=gtUserAccesslist, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFTPPort=gtSFTPPort, gtSFTPUsername=gtSFTPUsername, gtDNSNumber=gtDNSNumber, gtFilename=gtFilename, gtBackupSFTPServer=gtBackupSFTPServer, gtNTPServerTable=gtNTPServerTable, gtSyslogIP=gtSyslogIP, gtSNMPEntry=gtSNMPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtSFTPPassword=gtSFTPPassword, gtModuleUpdate=gtModuleUpdate, gtAgentComWriteString=gtAgentComWriteString, gtGroupEntry=gtGroupEntry, gtUserAuthEntry=gtUserAuthEntry, gtAgentPort=gtAgentPort, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworking=gtNetworking, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupTable=gtGroupTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGroupName=gtGroupName, gtUserAuthTable=gtUserAuthTable, gtTrapComString=gtTrapComString, gtUserTable=gtUserTable, gtAccesslistTable=gtAccesslistTable, gtTrapDestIP=gtTrapDestIP, gtCurrentTimeSource=gtCurrentTimeSource, gtUserGroup=gtUserGroup, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserIdx=gtUserIdx, gtBackupControl=gtBackupControl, gtSLAExpires=gtSLAExpires, gtSyslogEntry=gtSyslogEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackupControl=gtModuleBackupControl, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFPSpeed=gtSFPSpeed, gtTimeLocal=gtTimeLocal, gtHMSComMethod=gtHMSComMethod, gtGeneral=gtGeneral, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSyslogTable=gtSyslogTable, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkPortName=gtNetworkPortName, gtSLATable=gtSLATable, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceState=gtInterfaceState, gtChassisRedundancy=gtChassisRedundancy, gtUserPassword=gtUserPassword, gtUserName=gtUserName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtServicesTable=gtServicesTable, gtInterfaceCLI=gtInterfaceCLI, gtModuleBackupStatus=gtModuleBackupStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPEntry=gtSFPEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSTable=gtDNSTable, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsTable=gtPortsTable, gtSettingsObjects=gtSettingsObjects, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsEntry=gtPortsEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtBackupStatus=gtBackupStatus, gtNetworkEntry=gtNetworkEntry, gtInterfaceEntry=gtInterfaceEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtWebAuth=gtWebAuth, gtModuleBackup=gtModuleBackup, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsName=gtPortsName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNTPServerAddress=gtNTPServerAddress, gtUpdateFile=gtUpdateFile, gtSFPPlugged=gtSFPPlugged, gtTrapDestNumber=gtTrapDestNumber, gtSFPType=gtSFPType, gtWebProtocol=gtWebProtocol, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSettingsConformance=gtSettingsConformance, gtNTPServerEntry=gtNTPServerEntry, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistName=gtAccesslistName, gtNetworkName=gtNetworkName, gtUserEntry=gtUserEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserRowStatus=gtUserRowStatus, gtDNSEntry=gtDNSEntry, gtPortsNumber=gtPortsNumber, gtSwitch=gtSwitch, gtSettingsNotifications=gtSettingsNotifications, gtSFPLink=gtSFPLink, gtModuleBackupEntry=gtModuleBackupEntry, gtSWOptionsTable=gtSWOptionsTable, gtSNMP=gtSNMP, gtAgentComReadString=gtAgentComReadString, gtAccesslistEntry=gtAccesslistEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsMIB=gtSettingsMIB, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceMAC=gtInterfaceMAC, gtDNSServerIP=gtDNSServerIP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtGroupAccesslist=gtGroupAccesslist, gtCurrentUserName=gtCurrentUserName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUpdateControl=gtUpdateControl, gtUserParamIdx=gtUserParamIdx, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsGroups=gtSettingsGroups, gtUpdateStatus=gtUpdateStatus, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServicesEntry=gtServicesEntry, gtInterfaceName=gtInterfaceName, gtTimeUTC=gtTimeUTC, gtGroupRights=gtGroupRights, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsCompliances=gtSettingsCompliances, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestPort=gtTrapDestPort, gtNetworkTable=gtNetworkTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortState=gtNetworkPortState, gtHMSGroupName=gtHMSGroupName, gtWebEnable=gtWebEnable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUser=gtUser, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNumSFP=gtNumSFP, gtSFPNumber=gtSFPNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceStreaming=gtInterfaceStreaming, gtHeadendSystemManagement=gtHeadendSystemManagement, gtDateAndTime=gtDateAndTime, gtSLAEntry=gtSLAEntry, gtSFPTable=gtSFPTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistIdx=gtAccesslistIdx, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFTPServer=gtSFTPServer, gtServices=gtServices, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAgentState=gtAgentState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSTable=gtHMSTable, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSEntry=gtHMSEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSyslogState=gtSyslogState, gtDaylightAdjustment=gtDaylightAdjustment, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtPortsLinkup=gtPortsLinkup, gtSNMPTable=gtSNMPTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceVLAN=gtInterfaceVLAN, gtSLARegistered=gtSLARegistered, gtTrapPDU=gtTrapPDU, gtSWOption=gtSWOption, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGroupIdx=gtGroupIdx, gtTimeZone=gtTimeZone)
