...
Gauge32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, Counter32, iso, TimeTicks, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "Counter32", "iso", "TimeTicks", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUpdateStatus=gtUpdateStatus, gtSFPSpeed=gtSFPSpeed, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortState=gtNetworkPortState, gtTimeUTC=gtTimeUTC, gtSFTPUsername=gtSFTPUsername, gtUpdateControl=gtUpdateControl, gtSettingsCompliances=gtSettingsCompliances, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLARegistered=gtSLARegistered, gtNetworkPortVLAN=gtNetworkPortVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtDateAndTime=gtDateAndTime, gtGroupName=gtGroupName, gtFilename=gtFilename, gtUserAuthEnabled=gtUserAuthEnabled, gtCurrentUserName=gtCurrentUserName, gtWebEnable=gtWebEnable, gtNetworking=gtNetworking, gtUserTable=gtUserTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPTable=gtSFPTable, gtGroupTable=gtGroupTable, gtAccesslistEntry=gtAccesslistEntry, gtNetworkEntry=gtNetworkEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupIdx=gtGroupIdx, gtSWOption=gtSWOption, gtTrapDestNumber=gtTrapDestNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtUserRowStatus=gtUserRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistTable=gtAccesslistTable, gtPortsLinkup=gtPortsLinkup, gtUserName=gtUserName, gtUpdateFile=gtUpdateFile, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOptionsIdx=gtSWOptionsIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTimeZone=gtTimeZone, gtPortsTable=gtPortsTable, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceState=gtInterfaceState, gtTrapDestPort=gtTrapDestPort, gtNTPServerEntry=gtNTPServerEntry, gtServices=gtServices, gtSNMP=gtSNMP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapState=gtTrapState, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSTable=gtHMSTable, gtSWOptionsTable=gtSWOptionsTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkPortsTable=gtNetworkPortsTable, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSLAExpires=gtSLAExpires, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestTable=gtTrapDestTable, gtTimeLocal=gtTimeLocal, gtNetworkPortName=gtNetworkPortName, gtAccesslistIdx=gtAccesslistIdx, gtBackupControl=gtBackupControl, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSNMPTable=gtSNMPTable, gtTrapUser=gtTrapUser, gtUserAuthEntry=gtUserAuthEntry, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceRowStatus=gtInterfaceRowStatus, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPNumber=gtSFPNumber, gtGroupAccesslist=gtGroupAccesslist, gtDNSTable=gtDNSTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceMAC=gtInterfaceMAC, gtAgentPort=gtAgentPort, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapDestIP=gtTrapDestIP, gtDNSEntry=gtDNSEntry, gtSettingsMIB=gtSettingsMIB, gtSFPEntry=gtSFPEntry, gtUserEntry=gtUserEntry, gtSyslogTable=gtSyslogTable, gtSettingsGroups=gtSettingsGroups, gtServicesEntry=gtServicesEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapPDU=gtTrapPDU, gtSFPPlugged=gtSFPPlugged, gtUserAccesslist=gtUserAccesslist, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsConformance=gtSettingsConformance, gtSLAEntry=gtSLAEntry, gtUserAuthTable=gtUserAuthTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPPort=gtSFTPPort, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, PYSNMP_MODULE_ID=gtSettingsMIB, gtWebAuth=gtWebAuth, gtModuleBackupDate=gtModuleBackupDate, gtDNSNumber=gtDNSNumber, gtAccesslistName=gtAccesslistName, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsNotifications=gtSettingsNotifications, gtUserIdx=gtUserIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkName=gtNetworkName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtDNSServerIP=gtDNSServerIP, gtGroupEntry=gtGroupEntry, gtUser=gtUser, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceEntry=gtInterfaceEntry, gtSyslogEntry=gtSyslogEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserGroup=gtUserGroup, gtSFTPServer=gtSFTPServer, gtModuleUpdate=gtModuleUpdate, gtInterfaceName=gtInterfaceName, gtHMSComMethod=gtHMSComMethod, gtWebProtocol=gtWebProtocol, gtSFTPPassword=gtSFTPPassword, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupStatus=gtBackupStatus, gtNTPServerTable=gtNTPServerTable, gtNumSFP=gtNumSFP, gtNetworkPortNumber=gtNetworkPortNumber, gtServicesTable=gtServicesTable, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceNumber=gtInterfaceNumber, gtGroupRights=gtGroupRights, gtAgentState=gtAgentState, gtNetworkVLAN=gtNetworkVLAN, gtSettingsObjects=gtSettingsObjects, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceCLI=gtInterfaceCLI, gtTrapComString=gtTrapComString, gtSLATable=gtSLATable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceIPv4=gtInterfaceIPv4, gtSwitch=gtSwitch, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleBackup=gtModuleBackup, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserPassword=gtUserPassword, gtSyslogState=gtSyslogState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtPortsName=gtPortsName, gtSFPType=gtSFPType, gtSWOptionsEntry=gtSWOptionsEntry, gtGeneral=gtGeneral, gtHMSGroupName=gtHMSGroupName, gtHMSEntry=gtHMSEntry, gtSFPLink=gtSFPLink, gtPortsEntry=gtPortsEntry, gtInterfaceTable=gtInterfaceTable, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSNMPEntry=gtSNMPEntry, gtPortsNumber=gtPortsNumber, gtNetworkTable=gtNetworkTable, gtInterfaceSNMP=gtInterfaceSNMP)
