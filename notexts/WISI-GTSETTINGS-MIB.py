...
NotificationType, Unsigned32, Bits, MibIdentifier, iso, Counter32, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, Integer32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Bits", "MibIdentifier", "iso", "Counter32", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Integer32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtDateAndTime=gtDateAndTime, gtUpdateStatus=gtUpdateStatus, gtTimeZone=gtTimeZone, gtNetworkPortName=gtNetworkPortName, gtNetworkTable=gtNetworkTable, gtGeneral=gtGeneral, gtWebProtocol=gtWebProtocol, gtSFPType=gtSFPType, gtSettingsNotifications=gtSettingsNotifications, gtTrapDestTable=gtTrapDestTable, gtModuleBackupControl=gtModuleBackupControl, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtPortsEntry=gtPortsEntry, gtTrapComString=gtTrapComString, gtUserPassword=gtUserPassword, gtInterfaceEntry=gtInterfaceEntry, gtSFPPlugged=gtSFPPlugged, gtDNSEntry=gtDNSEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsGroups=gtSettingsGroups, gtNetworking=gtNetworking, gtTimeUTC=gtTimeUTC, gtInterfaceCLI=gtInterfaceCLI, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSLAExpires=gtSLAExpires, gtAgentState=gtAgentState, gtUserEntry=gtUserEntry, gtModuleUpdate=gtModuleUpdate, gtNetworkPortsEntry=gtNetworkPortsEntry, gtHMSNumMembers=gtHMSNumMembers, gtSFPTable=gtSFPTable, gtTrapDestIP=gtTrapDestIP, gtHMSEntry=gtHMSEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSTable=gtDNSTable, gtUpdateFilesTable=gtUpdateFilesTable, gtSFPEntry=gtSFPEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackup=gtModuleBackup, gtPortsNumber=gtPortsNumber, gtSyslogTable=gtSyslogTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUpdateControl=gtUpdateControl, gtTrapState=gtTrapState, gtSFPNumber=gtSFPNumber, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSyslogIP=gtSyslogIP, gtModuleBackupTable=gtModuleBackupTable, gtCurrentUserPassword=gtCurrentUserPassword, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkPortNumber=gtNetworkPortNumber, gtTimeLocal=gtTimeLocal, gtGroupName=gtGroupName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapSNMPVersion=gtTrapSNMPVersion, gtAccesslistIdx=gtAccesslistIdx, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSComMethod=gtHMSComMethod, gtNetworkEntry=gtNetworkEntry, gtServices=gtServices, gtSwitch=gtSwitch, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFPLink=gtSFPLink, gtNTPServerAddress=gtNTPServerAddress, gtGroupIdx=gtGroupIdx, gtUserAuthTable=gtUserAuthTable, gtServicesEntry=gtServicesEntry, gtInterfaceState=gtInterfaceState, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSTable=gtHMSTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNTPServerNumber=gtNTPServerNumber, gtUserAccesslist=gtUserAccesslist, gtSWOptionsIdx=gtSWOptionsIdx, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserParamIdx=gtUserParamIdx, gtAgentComWriteString=gtAgentComWriteString, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSLARegistered=gtSLARegistered, gtUserTable=gtUserTable, gtAccesslistIPRange=gtAccesslistIPRange, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestNumber=gtTrapDestNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNTPServerTable=gtNTPServerTable, gtPortsLinkup=gtPortsLinkup, gtGroupTable=gtGroupTable, gtFilename=gtFilename, gtBackupSFTPPort=gtBackupSFTPPort, gtNumSFP=gtNumSFP, gtSLAEntry=gtSLAEntry, gtAccesslistTable=gtAccesslistTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSWOption=gtSWOption, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtChassisRedundancy=gtChassisRedundancy, gtSLATable=gtSLATable, gtSFPSpeed=gtSFPSpeed, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsObjects=gtSettingsObjects, gtTrapDestPort=gtTrapDestPort, gtUserName=gtUserName, gtHMSGroupName=gtHMSGroupName, gtSettingsConformance=gtSettingsConformance, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupEntry=gtModuleBackupEntry, gtNetworkName=gtNetworkName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUser=gtUser, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserIdx=gtUserIdx, gtBackupControl=gtBackupControl, gtAgentComReadString=gtAgentComReadString, gtNetworkPortsTable=gtNetworkPortsTable, gtCurrentUserName=gtCurrentUserName, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSNMP=gtSNMP, gtModuleBackupStatus=gtModuleBackupStatus, gtAccesslistEntry=gtAccesslistEntry, gtDNSServerIP=gtDNSServerIP, PYSNMP_MODULE_ID=gtSettingsMIB, gtGroupEntry=gtGroupEntry, gtSFTPServer=gtSFTPServer, gtInterfaceName=gtInterfaceName, gtDNSNumber=gtDNSNumber, gtSFTPUsername=gtSFTPUsername, gtSNMPTable=gtSNMPTable, gtServicesTable=gtServicesTable, gtNetworkPortState=gtNetworkPortState, gtInterfaceTable=gtInterfaceTable, gtSettingsMIB=gtSettingsMIB, gtInterfaceSNMP=gtInterfaceSNMP, gtCurrentTimeSource=gtCurrentTimeSource, gtAccesslistName=gtAccesslistName, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentPort=gtAgentPort, gtWebAuth=gtWebAuth, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNTPServerEntry=gtNTPServerEntry, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapDestEntry=gtTrapDestEntry, gtSFTPPassword=gtSFTPPassword, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupParamIdx=gtGroupParamIdx, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceStreaming=gtInterfaceStreaming, gtSyslogState=gtSyslogState, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceNumber=gtInterfaceNumber, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceMAC=gtInterfaceMAC, gtGroupAccesslist=gtGroupAccesslist, gtWebEnable=gtWebEnable, gtSFTPPort=gtSFTPPort, gtTrapUser=gtTrapUser, gtUserGroup=gtUserGroup, gtPortsTable=gtPortsTable, gtGroupRights=gtGroupRights, gtModuleBackupDate=gtModuleBackupDate, gtDaylightAdjustment=gtDaylightAdjustment, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsCompliances=gtSettingsCompliances, gtUserRowStatus=gtUserRowStatus, gtPortsName=gtPortsName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMPEntry=gtSNMPEntry, gtBackupStatus=gtBackupStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapPDU=gtTrapPDU, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFile=gtUpdateFile)
