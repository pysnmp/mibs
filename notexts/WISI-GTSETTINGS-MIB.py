...
Integer32, IpAddress, NotificationType, ObjectIdentity, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, TimeTicks, Gauge32, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "NotificationType", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "TimeTicks", "Gauge32", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtCurrentTimeSource=gtCurrentTimeSource, gtIGMPQueryInterval=gtIGMPQueryInterval, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSWOptionsTable=gtSWOptionsTable, gtPortsNumber=gtPortsNumber, gtNTPServerAddress=gtNTPServerAddress, gtTrapPDU=gtTrapPDU, gtAccesslistName=gtAccesslistName, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceMAC=gtInterfaceMAC, gtSWOption=gtSWOption, gtUserAuthTable=gtUserAuthTable, gtServicesEntry=gtServicesEntry, gtTrapUser=gtTrapUser, gtNetworking=gtNetworking, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtWebAuth=gtWebAuth, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSwitch=gtSwitch, gtSyslogIP=gtSyslogIP, gtTrapDestEntry=gtTrapDestEntry, gtSNMP=gtSNMP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAccesslist=gtUserAccesslist, gtServices=gtServices, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFTPPort=gtSFTPPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtGeneral=gtGeneral, gtSFPNumber=gtSFPNumber, gtDNSEntry=gtDNSEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapComString=gtTrapComString, gtSFTPServer=gtSFTPServer, gtSLARegistered=gtSLARegistered, gtInterfaceState=gtInterfaceState, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceCLI=gtInterfaceCLI, gtSWOptionsEntry=gtSWOptionsEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, PYSNMP_MODULE_ID=gtSettingsMIB, gtGroupEntry=gtGroupEntry, gtDNSTable=gtDNSTable, gtUser=gtUser, gtAccesslistEntry=gtAccesslistEntry, gtNetworkEntry=gtNetworkEntry, gtAgentComReadString=gtAgentComReadString, gtNetworkPortsTable=gtNetworkPortsTable, gtSettingsMIB=gtSettingsMIB, gtHMSNumMembers=gtHMSNumMembers, gtTimeUTC=gtTimeUTC, gtSFTPPassword=gtSFTPPassword, gtModuleBackup=gtModuleBackup, gtNTPServerEntry=gtNTPServerEntry, gtUpdateControl=gtUpdateControl, gtCurrentUserName=gtCurrentUserName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsLinkup=gtPortsLinkup, gtInterfaceName=gtInterfaceName, gtHMSTable=gtHMSTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsGroups=gtSettingsGroups, gtPortsTable=gtPortsTable, gtSFPPlugged=gtSFPPlugged, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapState=gtTrapState, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDNSNumber=gtDNSNumber, gtGroupTable=gtGroupTable, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleUpdate=gtModuleUpdate, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentPort=gtAgentPort, gtPortsBitrateReceive=gtPortsBitrateReceive, gtPortsEntry=gtPortsEntry, gtHMSGroupName=gtHMSGroupName, gtGroupName=gtGroupName, gtBackupStatus=gtBackupStatus, gtUserPassword=gtUserPassword, gtTrapDestPort=gtTrapDestPort, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerTable=gtNTPServerTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceEntry=gtInterfaceEntry, gtHMSComMethod=gtHMSComMethod, gtSWOptionsIdx=gtSWOptionsIdx, gtChassisRedundancy=gtChassisRedundancy, gtSyslogTable=gtSyslogTable, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSettingsObjects=gtSettingsObjects, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUserName=gtUserName, gtAgentComWriteString=gtAgentComWriteString, gtAgentState=gtAgentState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSettingsConformance=gtSettingsConformance, gtInterfaceNumber=gtInterfaceNumber, gtHMSEntry=gtHMSEntry, gtUserRowStatus=gtUserRowStatus, gtNetworkPortNumber=gtNetworkPortNumber, gtUserEntry=gtUserEntry, gtSFPLink=gtSFPLink, gtSettingsCompliances=gtSettingsCompliances, gtSFPTable=gtSFPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSNMPTable=gtSNMPTable, gtDateAndTime=gtDateAndTime, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTimeLocal=gtTimeLocal, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapDestTable=gtTrapDestTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPEntry=gtSFPEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackupStatus=gtModuleBackupStatus, gtSLATable=gtSLATable, gtTrapDestIP=gtTrapDestIP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateStatus=gtUpdateStatus, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserTable=gtUserTable, gtUserGroup=gtUserGroup, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceTable=gtInterfaceTable, gtWebProtocol=gtWebProtocol, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPType=gtSFPType, gtNetworkPortName=gtNetworkPortName, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapDestNumber=gtTrapDestNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupIdx=gtGroupIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserIdx=gtUserIdx, gtNetworkTable=gtNetworkTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkName=gtNetworkName, gtAccesslistTable=gtAccesslistTable, gtBackupSFTPServer=gtBackupSFTPServer, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSNMPEntry=gtSNMPEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateFile=gtUpdateFile, gtSyslogEntry=gtSyslogEntry, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortState=gtNetworkPortState, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkVLAN=gtNetworkVLAN, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNTPServerNumber=gtNTPServerNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSettingsNotifications=gtSettingsNotifications, gtSLAExpires=gtSLAExpires, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupRights=gtGroupRights, gtPortsName=gtPortsName, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFPSpeed=gtSFPSpeed, gtServicesTable=gtServicesTable, gtDaylightAdjustment=gtDaylightAdjustment, gtSLAEntry=gtSLAEntry, gtBackupControl=gtBackupControl, gtSyslogState=gtSyslogState, gtModuleBackupDate=gtModuleBackupDate, gtTrapSNMPVersion=gtTrapSNMPVersion, gtFilename=gtFilename, gtDNSServerIP=gtDNSServerIP, gtInterfaceVLAN=gtInterfaceVLAN, gtNumSFP=gtNumSFP, gtSFTPUsername=gtSFTPUsername, gtGroupAccesslist=gtGroupAccesslist, gtTimeZone=gtTimeZone, gtWebEnable=gtWebEnable)
