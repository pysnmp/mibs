...
NotificationType, Integer32, iso, Bits, TimeTicks, Counter32, Counter64, Gauge32, MibIdentifier, IpAddress, Unsigned32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "Bits", "TimeTicks", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "IpAddress", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPLink=gtSFPLink, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFPSpeed=gtSFPSpeed, gtHMSTable=gtHMSTable, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtGroupIdx=gtGroupIdx, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceState=gtInterfaceState, gtTrapDestRowStatus=gtTrapDestRowStatus, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthTable=gtUserAuthTable, gtHMSEntry=gtHMSEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtAgentPort=gtAgentPort, gtUpdateControl=gtUpdateControl, gtUpdateStatus=gtUpdateStatus, gtSFPNumber=gtSFPNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtSNMP=gtSNMP, gtNetworkName=gtNetworkName, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFile=gtUpdateFile, gtModuleBackupDate=gtModuleBackupDate, gtNetworkTable=gtNetworkTable, gtSettingsNotifications=gtSettingsNotifications, gtPortsNumber=gtPortsNumber, gtGroupRights=gtGroupRights, gtUserEntry=gtUserEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtUserName=gtUserName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtTrapComString=gtTrapComString, gtNumSFP=gtNumSFP, gtAccesslistEntry=gtAccesslistEntry, gtUserPassword=gtUserPassword, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPType=gtSFPType, gtDNSServerIP=gtDNSServerIP, gtAgentComReadString=gtAgentComReadString, gtSFTPPassword=gtSFTPPassword, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNTPServerNumber=gtNTPServerNumber, gtSLAEntry=gtSLAEntry, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortName=gtNetworkPortName, gtSLATable=gtSLATable, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserAuthEntry=gtUserAuthEntry, gtSLAExpires=gtSLAExpires, gtInterfaceIGMP=gtInterfaceIGMP, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserRowStatus=gtUserRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortState=gtNetworkPortState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtWebProtocol=gtWebProtocol, gtUserParamIdx=gtUserParamIdx, gtModuleBackupControl=gtModuleBackupControl, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceName=gtInterfaceName, gtSyslogIP=gtSyslogIP, gtSWOption=gtSWOption, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSLARegistered=gtSLARegistered, gtWebAuth=gtWebAuth, gtBackupSFTPUsername=gtBackupSFTPUsername, gtGroupEntry=gtGroupEntry, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSwitch=gtSwitch, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsMIB=gtSettingsMIB, gtSFTPServer=gtSFTPServer, gtTimeZone=gtTimeZone, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapDestTable=gtTrapDestTable, gtModuleBackup=gtModuleBackup, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSyslogTable=gtSyslogTable, gtSNMPTable=gtSNMPTable, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSNMPEntry=gtSNMPEntry, gtAgentState=gtAgentState, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupStatus=gtBackupStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSFTPPort=gtSFTPPort, gtIGMPQueryInterval=gtIGMPQueryInterval, gtServices=gtServices, gtSettingsConformance=gtSettingsConformance, gtGroupAccesslist=gtGroupAccesslist, gtFilename=gtFilename, gtNTPServerTable=gtNTPServerTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestPort=gtTrapDestPort, gtCurrentUserPassword=gtCurrentUserPassword, PYSNMP_MODULE_ID=gtSettingsMIB, gtPortsName=gtPortsName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsTable=gtPortsTable, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSWOptionsEntry=gtSWOptionsEntry, gtCurrentUserName=gtCurrentUserName, gtGroupParamIdx=gtGroupParamIdx, gtPortsEntry=gtPortsEntry, gtInterfaceTable=gtInterfaceTable, gtPortsLinkup=gtPortsLinkup, gtUserGroup=gtUserGroup, gtDNSTable=gtDNSTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupTable=gtGroupTable, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapState=gtTrapState, gtTrapPDU=gtTrapPDU, gtUserIdx=gtUserIdx, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPEntry=gtSFPEntry, gtServicesEntry=gtServicesEntry, gtDNSEntry=gtDNSEntry, gtSFPPlugged=gtSFPPlugged, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSyslogEntry=gtSyslogEntry, gtSyslogState=gtSyslogState, gtTimeLocal=gtTimeLocal, gtAccesslistIdx=gtAccesslistIdx, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupName=gtGroupName, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceNumber=gtInterfaceNumber, gtGeneral=gtGeneral, gtDateAndTime=gtDateAndTime, gtDateAndTimeTable=gtDateAndTimeTable, gtUserTable=gtUserTable, gtServicesTable=gtServicesTable, gtNTPServerAddress=gtNTPServerAddress, gtHMSGroupName=gtHMSGroupName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtCurrentTimeSource=gtCurrentTimeSource, gtHMSComMethod=gtHMSComMethod, gtSettingsGroups=gtSettingsGroups, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsObjects=gtSettingsObjects, gtBackupControl=gtBackupControl, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAgentComWriteString=gtAgentComWriteString, gtNetworkEntry=gtNetworkEntry, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserAccesslist=gtUserAccesslist, gtSettingsCompliances=gtSettingsCompliances, gtDNSNumber=gtDNSNumber, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFTPUsername=gtSFTPUsername, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestIP=gtTrapDestIP, gtAccesslistName=gtAccesslistName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistTable=gtAccesslistTable, gtTimeUTC=gtTimeUTC, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworking=gtNetworking, gtHMSNumMembers=gtHMSNumMembers, gtWebEnable=gtWebEnable, gtTrapUser=gtTrapUser, gtSFPTable=gtSFPTable, gtUser=gtUser)
