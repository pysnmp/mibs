...
Integer32, ObjectIdentity, Unsigned32, Gauge32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, Counter64, ModuleIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Unsigned32", "Gauge32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "Counter64", "ModuleIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPType=gtSFPType, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserRowStatus=gtUserRowStatus, gtSFPTable=gtSFPTable, gtAgentComWriteString=gtAgentComWriteString, gtHMSTable=gtHMSTable, gtSWOptionsTable=gtSWOptionsTable, gtDateAndTimeTable=gtDateAndTimeTable, gtCurrentUserPassword=gtCurrentUserPassword, gtSyslogEntry=gtSyslogEntry, gtPortsNumber=gtPortsNumber, gtSLAExpires=gtSLAExpires, gtNetworkPortsTable=gtNetworkPortsTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPLink=gtSFPLink, gtTrapPDU=gtTrapPDU, gtNTPServerTable=gtNTPServerTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQueryInterval=gtIGMPQueryInterval, gtPortsTable=gtPortsTable, gtNTPServerNumber=gtNTPServerNumber, gtSettingsCompliances=gtSettingsCompliances, gtHMSEntry=gtHMSEntry, gtSFTPPassword=gtSFTPPassword, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSComMethod=gtHMSComMethod, gtTimeUTC=gtTimeUTC, gtSettingsObjects=gtSettingsObjects, gtFilename=gtFilename, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupControl=gtBackupControl, gtSFPSpeed=gtSFPSpeed, gtServices=gtServices, gtTrapUser=gtTrapUser, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceName=gtInterfaceName, gtUserAuthEnabled=gtUserAuthEnabled, gtTimeZone=gtTimeZone, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtBackupSFTPPort=gtBackupSFTPPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleUpdate=gtModuleUpdate, gtTrapState=gtTrapState, gtSyslogTable=gtSyslogTable, gtGroupAccesslist=gtGroupAccesslist, gtHMSNumMembers=gtHMSNumMembers, gtSNMPEntry=gtSNMPEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPServer=gtSFTPServer, gtModuleBackupDate=gtModuleBackupDate, gtGroupTable=gtGroupTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSNMP=gtSNMP, gtBackupStatus=gtBackupStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAccesslist=gtUserAccesslist, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserParamIdx=gtUserParamIdx, gtGroupName=gtGroupName, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsEntry=gtPortsEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOptionsEntry=gtSWOptionsEntry, gtServicesTable=gtServicesTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtWebEnable=gtWebEnable, gtInterfaceTable=gtInterfaceTable, gtDaylightAdjustment=gtDaylightAdjustment, gtUserPassword=gtUserPassword, gtAccesslistTable=gtAccesslistTable, gtSFPPlugged=gtSFPPlugged, gtUserTable=gtUserTable, gtUserGroup=gtUserGroup, gtNTPServerAddress=gtNTPServerAddress, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkPortName=gtNetworkPortName, gtUpdateFile=gtUpdateFile, gtTrapSNMPVersion=gtTrapSNMPVersion, gtDateAndTime=gtDateAndTime, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSwitch=gtSwitch, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceMAC=gtInterfaceMAC, gtSFPEntry=gtSFPEntry, gtSettingsGroups=gtSettingsGroups, gtSNMPTable=gtSNMPTable, gtUserEntry=gtUserEntry, gtDNSNumber=gtDNSNumber, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapDestPort=gtTrapDestPort, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUpdateStatus=gtUpdateStatus, gtUserName=gtUserName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSLAEntry=gtSLAEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtDNSServerIP=gtDNSServerIP, gtUserAuthTable=gtUserAuthTable, gtNetworkVLAN=gtNetworkVLAN, gtUpdateControl=gtUpdateControl, gtSFTPUsername=gtSFTPUsername, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceEntry=gtInterfaceEntry, gtNTPServerEntry=gtNTPServerEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestTable=gtTrapDestTable, gtSyslogIP=gtSyslogIP, gtNumSFP=gtNumSFP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtTrapDestNumber=gtTrapDestNumber, gtSLARegistered=gtSLARegistered, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentPort=gtAgentPort, gtModuleBackupEntry=gtModuleBackupEntry, gtDNSTable=gtDNSTable, gtSyslogState=gtSyslogState, PYSNMP_MODULE_ID=gtSettingsMIB, gtSettingsConformance=gtSettingsConformance, gtSettingsNotifications=gtSettingsNotifications, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackup=gtModuleBackup, gtUserAuthEntry=gtUserAuthEntry, gtUser=gtUser, gtTrapDestIP=gtTrapDestIP, gtGroupIdx=gtGroupIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapComString=gtTrapComString, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupRights=gtGroupRights, gtAgentComReadString=gtAgentComReadString, gtWebProtocol=gtWebProtocol, gtInterfaceState=gtInterfaceState, gtBackupSFTPServer=gtBackupSFTPServer, gtDNSEntry=gtDNSEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPPort=gtSFTPPort, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsMIB=gtSettingsMIB, gtUserIdx=gtUserIdx, gtNetworkEntry=gtNetworkEntry, gtAccesslistEntry=gtAccesslistEntry, gtPortsLinkup=gtPortsLinkup, gtWebAuth=gtWebAuth, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGeneral=gtGeneral, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFPNumber=gtSFPNumber, gtAgentState=gtAgentState, gtNetworkName=gtNetworkName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortState=gtNetworkPortState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceIPv4=gtInterfaceIPv4, gtServicesEntry=gtServicesEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAccesslistIdx=gtAccesslistIdx, gtCurrentUserName=gtCurrentUserName, gtNetworking=gtNetworking, gtUpdateFilesEntry=gtUpdateFilesEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestEntry=gtTrapDestEntry, gtGroupEntry=gtGroupEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsName=gtPortsName, gtHMSGroupName=gtHMSGroupName, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceNumber=gtInterfaceNumber, gtSLATable=gtSLATable, gtAccesslistName=gtAccesslistName, gtTimeLocal=gtTimeLocal, gtNetworkTable=gtNetworkTable, gtInterfaceCLI=gtInterfaceCLI, gtSWOption=gtSWOption)
