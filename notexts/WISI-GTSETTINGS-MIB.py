...
ModuleIdentity, TimeTicks, Bits, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, Counter32, MibIdentifier, Counter64, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Bits", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "Counter32", "MibIdentifier", "Counter64", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkTable=gtNetworkTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupStatus=gtModuleBackupStatus, gtTimeLocal=gtTimeLocal, gtUpdateStatus=gtUpdateStatus, gtGeneral=gtGeneral, gtAccesslistName=gtAccesslistName, gtSFPTable=gtSFPTable, gtNetworkPortState=gtNetworkPortState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtServices=gtServices, gtDNSNumber=gtDNSNumber, gtInterfaceNumber=gtInterfaceNumber, gtSyslogState=gtSyslogState, gtModuleUpdate=gtModuleUpdate, gtGroupIdx=gtGroupIdx, gtSLATable=gtSLATable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceState=gtInterfaceState, gtSettingsConformance=gtSettingsConformance, gtNetworkVLAN=gtNetworkVLAN, gtTrapState=gtTrapState, gtUserIdx=gtUserIdx, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupControl=gtBackupControl, gtSWOptionsTable=gtSWOptionsTable, gtUserTable=gtUserTable, gtNetworkPortName=gtNetworkPortName, gtUpdateControl=gtUpdateControl, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSyslogTable=gtSyslogTable, gtPortsTable=gtPortsTable, gtWebAuth=gtWebAuth, gtPortsEntry=gtPortsEntry, gtGroupRights=gtGroupRights, gtSWOptionsEntry=gtSWOptionsEntry, gtUserRowStatus=gtUserRowStatus, gtAgentPort=gtAgentPort, gtDNSTable=gtDNSTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistEntry=gtAccesslistEntry, gtDateAndTime=gtDateAndTime, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceName=gtInterfaceName, gtBackupStatus=gtBackupStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistIdx=gtAccesslistIdx, gtNetworking=gtNetworking, gtSLAEntry=gtSLAEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceEntry=gtInterfaceEntry, gtTimeUTC=gtTimeUTC, gtSFPType=gtSFPType, gtServicesTable=gtServicesTable, gtNetworkName=gtNetworkName, gtGroupName=gtGroupName, gtSFTPUsername=gtSFTPUsername, gtSettingsGroups=gtSettingsGroups, gtSLARegistered=gtSLARegistered, gtSLAExpires=gtSLAExpires, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAgentComWriteString=gtAgentComWriteString, gtCurrentTimeSource=gtCurrentTimeSource, gtUserAccesslist=gtUserAccesslist, gtWebEnable=gtWebEnable, gtUserGroup=gtUserGroup, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAccesslistTable=gtAccesslistTable, gtSFPPlugged=gtSFPPlugged, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNTPServerEntry=gtNTPServerEntry, gtUser=gtUser, gtSFTPServer=gtSFTPServer, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapDestPort=gtTrapDestPort, gtInterfaceMAC=gtInterfaceMAC, gtDateAndTimeTable=gtDateAndTimeTable, gtGroupEntry=gtGroupEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkEntry=gtNetworkEntry, gtTrapComString=gtTrapComString, gtSwitch=gtSwitch, gtSNMP=gtSNMP, gtSettingsObjects=gtSettingsObjects, gtSyslogIP=gtSyslogIP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtCurrentUserPassword=gtCurrentUserPassword, gtNTPServerAddress=gtNTPServerAddress, gtUserAuthEntry=gtUserAuthEntry, gtSNMPEntry=gtSNMPEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleBackupTable=gtModuleBackupTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsNotifications=gtSettingsNotifications, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsLinkup=gtPortsLinkup, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupTable=gtGroupTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtUpdateFile=gtUpdateFile, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapDestEntry=gtTrapDestEntry, gtNumSFP=gtNumSFP, gtAgentComReadString=gtAgentComReadString, gtInterfaceVLAN=gtInterfaceVLAN, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogEntry=gtSyslogEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFTPPassword=gtSFTPPassword, gtHMSTable=gtHMSTable, gtTimeZone=gtTimeZone, gtServicesEntry=gtServicesEntry, gtHMSComMethod=gtHMSComMethod, gtSFPSpeed=gtSFPSpeed, gtUserEntry=gtUserEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerTable=gtNTPServerTable, gtSFPLink=gtSFPLink, gtSNMPTable=gtSNMPTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDNSEntry=gtDNSEntry, gtFilename=gtFilename, gtModuleBackup=gtModuleBackup, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapDestTable=gtTrapDestTable, gtSWOptionsIdx=gtSWOptionsIdx, gtUserAuthTable=gtUserAuthTable, gtDNSServerIP=gtDNSServerIP, gtSFTPPort=gtSFTPPort, gtHMSEntry=gtHMSEntry, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceIGMP=gtInterfaceIGMP, gtPortsNumber=gtPortsNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAccesslistIPRange=gtAccesslistIPRange, gtSWOption=gtSWOption, gtPortsName=gtPortsName, gtCurrentUserName=gtCurrentUserName, gtUserParamIdx=gtUserParamIdx, gtWebProtocol=gtWebProtocol, gtSFPNumber=gtSFPNumber, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapDestIP=gtTrapDestIP, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserName=gtUserName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsMIB=gtSettingsMIB, gtAgentState=gtAgentState, gtHMSNumMembers=gtHMSNumMembers, gtHMSGroupName=gtHMSGroupName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSettingsCompliances=gtSettingsCompliances, gtSFPEntry=gtSFPEntry, gtInterfaceTable=gtInterfaceTable, gtUserPassword=gtUserPassword, gtTrapPDU=gtTrapPDU, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPPort=gtBackupSFTPPort, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapUser=gtTrapUser)
