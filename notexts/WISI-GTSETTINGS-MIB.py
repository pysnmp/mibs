...
Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, ObjectIdentity, iso, NotificationType, Counter64, Unsigned32, IpAddress, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPServer=gtBackupSFTPServer, gtUserParamIdx=gtUserParamIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSComMethod=gtHMSComMethod, gtUserRowStatus=gtUserRowStatus, gtSettingsObjects=gtSettingsObjects, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSyslogEntry=gtSyslogEntry, gtChassisRedundancy=gtChassisRedundancy, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistEntry=gtAccesslistEntry, gtNetworkEntry=gtNetworkEntry, gtInterfaceName=gtInterfaceName, gtSettingsConformance=gtSettingsConformance, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkPortState=gtNetworkPortState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtPortsName=gtPortsName, gtInterfaceMAC=gtInterfaceMAC, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateControl=gtUpdateControl, gtSyslogIP=gtSyslogIP, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapDestTable=gtTrapDestTable, gtNTPServerAddress=gtNTPServerAddress, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNumSFP=gtNumSFP, gtBackupStatus=gtBackupStatus, gtNetworkPortName=gtNetworkPortName, gtSFTPServer=gtSFTPServer, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAuthEnabled=gtUserAuthEnabled, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPType=gtSFPType, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAccesslistIPRange=gtAccesslistIPRange, gtHMSGroupName=gtHMSGroupName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSyslogTable=gtSyslogTable, gtSNMP=gtSNMP, gtTrapDestNumber=gtTrapDestNumber, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTimeZone=gtTimeZone, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSyslogState=gtSyslogState, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackupControl=gtModuleBackupControl, gtGroupEntry=gtGroupEntry, gtDNSNumber=gtDNSNumber, gtModuleBackupDate=gtModuleBackupDate, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkVLAN=gtNetworkVLAN, gtSFTPUsername=gtSFTPUsername, gtTrapUser=gtTrapUser, gtNetworkPortsEntry=gtNetworkPortsEntry, gtGroupParamIdx=gtGroupParamIdx, gtSFTPPassword=gtSFTPPassword, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsMIB=gtSettingsMIB, gtGroupTable=gtGroupTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAgentComWriteString=gtAgentComWriteString, gtSWOption=gtSWOption, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSTable=gtDNSTable, gtInterfaceVLAN=gtInterfaceVLAN, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestEntry=gtTrapDestEntry, gtUserAuthTable=gtUserAuthTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNTPServerEntry=gtNTPServerEntry, gtUserEntry=gtUserEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNetworkName=gtNetworkName, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupAccesslist=gtGroupAccesslist, gtAgentState=gtAgentState, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFPLink=gtSFPLink, gtAccesslistIdx=gtAccesslistIdx, gtServicesTable=gtServicesTable, gtNTPServerTable=gtNTPServerTable, gtGroupName=gtGroupName, gtFilename=gtFilename, gtSettingsGroups=gtSettingsGroups, gtUserName=gtUserName, gtGroupIdx=gtGroupIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtSLARegistered=gtSLARegistered, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserGroup=gtUserGroup, gtWebAuth=gtWebAuth, gtSFTPPort=gtSFTPPort, gtDateAndTime=gtDateAndTime, gtPortsNumber=gtPortsNumber, gtAccesslistTable=gtAccesslistTable, gtSNMPEntry=gtSNMPEntry, gtTimeUTC=gtTimeUTC, gtSLAExpires=gtSLAExpires, gtUserTable=gtUserTable, gtCurrentUserName=gtCurrentUserName, gtNetworkTable=gtNetworkTable, gtServicesEntry=gtServicesEntry, gtSFPEntry=gtSFPEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupControl=gtBackupControl, gtInterfaceTable=gtInterfaceTable, gtUserAuthEntry=gtUserAuthEntry, gtUpdateFile=gtUpdateFile, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerNumber=gtNTPServerNumber, gtHMSTable=gtHMSTable, gtNetworking=gtNetworking, gtTrapDestIP=gtTrapDestIP, gtDateAndTimeTable=gtDateAndTimeTable, gtWebEnable=gtWebEnable, gtSwitch=gtSwitch, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGeneral=gtGeneral, gtSWOptionsIdx=gtSWOptionsIdx, gtSFPTable=gtSFPTable, gtCurrentUserPassword=gtCurrentUserPassword, gtNetworkPortNumber=gtNetworkPortNumber, gtUserAccesslist=gtUserAccesslist, gtServices=gtServices, gtModuleBackup=gtModuleBackup, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtHMSNumMembers=gtHMSNumMembers, gtDNSEntry=gtDNSEntry, gtSLAEntry=gtSLAEntry, gtPortsEntry=gtPortsEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtIGMPQueryInterval=gtIGMPQueryInterval, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapComString=gtTrapComString, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapDestPort=gtTrapDestPort, gtTrapState=gtTrapState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleUpdate=gtModuleUpdate, gtSFPSpeed=gtSFPSpeed, gtUserPassword=gtUserPassword, gtGroupRights=gtGroupRights, gtInterfaceState=gtInterfaceState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFPPlugged=gtSFPPlugged, gtSettingsNotifications=gtSettingsNotifications, gtTimeLocal=gtTimeLocal, gtSFPNumber=gtSFPNumber, gtPortsLinkup=gtPortsLinkup, gtUser=gtUser, gtSLATable=gtSLATable, gtWebProtocol=gtWebProtocol, gtAccesslistName=gtAccesslistName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleBackupTable=gtModuleBackupTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsCompliances=gtSettingsCompliances, gtAgentComReadString=gtAgentComReadString, gtUpdateStatus=gtUpdateStatus, gtHMSEntry=gtHMSEntry, gtInterfaceCLI=gtInterfaceCLI, gtPortsTable=gtPortsTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceSNMP=gtInterfaceSNMP, gtUserIdx=gtUserIdx, gtSNMPTable=gtSNMPTable, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentPort=gtAgentPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapPDU=gtTrapPDU, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval)
