...
ObjectIdentity, Counter64, MibIdentifier, TimeTicks, Bits, Integer32, IpAddress, NotificationType, Gauge32, iso, Counter32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "IpAddress", "NotificationType", "Gauge32", "iso", "Counter32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPTable=gtSFPTable, gtDNSNumber=gtDNSNumber, gtUserRowStatus=gtUserRowStatus, gtPortsLinkup=gtPortsLinkup, gtHMSNumMembers=gtHMSNumMembers, gtFilename=gtFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsGroups=gtSettingsGroups, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFTPPort=gtSFTPPort, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUser=gtUser, gtModuleBackup=gtModuleBackup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtHMSComMethod=gtHMSComMethod, gtUpdateStatus=gtUpdateStatus, gtUserEntry=gtUserEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupControl=gtBackupControl, gtSettingsConformance=gtSettingsConformance, gtSWOption=gtSWOption, gtTrapDestNumber=gtTrapDestNumber, gtSLARegistered=gtSLARegistered, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSyslogState=gtSyslogState, gtGroupRights=gtGroupRights, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSLAExpires=gtSLAExpires, gtModuleBackupDate=gtModuleBackupDate, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceEntry=gtInterfaceEntry, gtSyslogEntry=gtSyslogEntry, gtSFPEntry=gtSFPEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtUserParamIdx=gtUserParamIdx, gtNetworkTable=gtNetworkTable, gtTrapDestTable=gtTrapDestTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtCurrentTimeSource=gtCurrentTimeSource, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFPType=gtSFPType, gtPortsNumber=gtPortsNumber, gtNTPServerTable=gtNTPServerTable, gtInterfaceCLI=gtInterfaceCLI, gtUpdateFile=gtUpdateFile, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupStatus=gtBackupStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPLink=gtSFPLink, gtGroupIdx=gtGroupIdx, gtNTPServerNumber=gtNTPServerNumber, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsMIB=gtSettingsMIB, gtSNMP=gtSNMP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkEntry=gtNetworkEntry, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackupControl=gtModuleBackupControl, gtTrapPDU=gtTrapPDU, gtSFTPServer=gtSFTPServer, gtUserAccesslist=gtUserAccesslist, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTimeLocal=gtTimeLocal, gtSwitch=gtSwitch, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserGroup=gtUserGroup, gtNetworkPortName=gtNetworkPortName, gtAccesslistIPRange=gtAccesslistIPRange, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUpdateControl=gtUpdateControl, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceState=gtInterfaceState, gtModuleUpdate=gtModuleUpdate, gtHMSEntry=gtHMSEntry, gtDNSEntry=gtDNSEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkName=gtNetworkName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFilesEntry=gtUpdateFilesEntry, gtChassisRedundancy=gtChassisRedundancy, gtNumSFP=gtNumSFP, gtSFTPUsername=gtSFTPUsername, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupParamIdx=gtGroupParamIdx, gtGroupAccesslist=gtGroupAccesslist, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSNMPEntry=gtSNMPEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSWOptionsIdx=gtSWOptionsIdx, gtServicesTable=gtServicesTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLATable=gtSLATable, gtTimeUTC=gtTimeUTC, gtNTPServerEntry=gtNTPServerEntry, gtSettingsCompliances=gtSettingsCompliances, gtSyslogIP=gtSyslogIP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsTable=gtPortsTable, gtGroupTable=gtGroupTable, gtUpdateFilesTable=gtUpdateFilesTable, gtSWOptionsEntry=gtSWOptionsEntry, gtServices=gtServices, gtCurrentUserPassword=gtCurrentUserPassword, gtDaylightAdjustment=gtDaylightAdjustment, gtWebProtocol=gtWebProtocol, gtUserIdx=gtUserIdx, gtUserPassword=gtUserPassword, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAccesslistName=gtAccesslistName, gtAgentState=gtAgentState, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUserAuthEntry=gtUserAuthEntry, gtWebEnable=gtWebEnable, gtUserAuthTable=gtUserAuthTable, gtModuleBackupEntry=gtModuleBackupEntry, gtTimeZone=gtTimeZone, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSGroupName=gtHMSGroupName, gtDNSTable=gtDNSTable, gtHMSTable=gtHMSTable, gtInterfaceTable=gtInterfaceTable, gtSFPSpeed=gtSFPSpeed, gtDNSServerIP=gtDNSServerIP, gtSFPNumber=gtSFPNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupTable=gtModuleBackupTable, gtSWOptionsTable=gtSWOptionsTable, gtGeneral=gtGeneral, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserName=gtUserName, gtAccesslistEntry=gtAccesslistEntry, gtTrapDestIP=gtTrapDestIP, gtNetworking=gtNetworking, gtGroupEntry=gtGroupEntry, gtWebAuth=gtWebAuth, gtServicesEntry=gtServicesEntry, gtSLAEntry=gtSLAEntry, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerAddress=gtNTPServerAddress, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtCurrentUserName=gtCurrentUserName, gtSyslogTable=gtSyslogTable, gtSFTPPassword=gtSFTPPassword, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDateAndTime=gtDateAndTime, gtPortsEntry=gtPortsEntry, gtNetworkVLAN=gtNetworkVLAN, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAgentPort=gtAgentPort, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsObjects=gtSettingsObjects, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserTable=gtUserTable, gtTrapUser=gtTrapUser, gtAgentComWriteString=gtAgentComWriteString, gtPortsName=gtPortsName, gtInterfaceNumber=gtInterfaceNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapState=gtTrapState, gtAccesslistTable=gtAccesslistTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSNMPTable=gtSNMPTable, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtSFPPlugged=gtSFPPlugged, gtInterfaceName=gtInterfaceName, gtGroupName=gtGroupName, gtNetworkPortState=gtNetworkPortState, gtTrapComString=gtTrapComString, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestPort=gtTrapDestPort)
