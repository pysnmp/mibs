...
ModuleIdentity, Counter64, NotificationType, Gauge32, Integer32, ObjectIdentity, MibIdentifier, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "Gauge32", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "iso", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkEntry=gtNetworkEntry, gtDNSTable=gtDNSTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserName=gtUserName, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceName=gtInterfaceName, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestTable=gtTrapDestTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkVLAN=gtNetworkVLAN, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNumSFP=gtNumSFP, gtSFPEntry=gtSFPEntry, gtPortsNumber=gtPortsNumber, gtModuleBackupDate=gtModuleBackupDate, gtSNMPTable=gtSNMPTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapState=gtTrapState, gtUpdateControl=gtUpdateControl, gtSNMP=gtSNMP, gtHMSNumMembers=gtHMSNumMembers, gtUserRowStatus=gtUserRowStatus, gtSFPType=gtSFPType, gtTrapPDU=gtTrapPDU, gtServicesEntry=gtServicesEntry, gtWebEnable=gtWebEnable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackup=gtModuleBackup, gtSettingsGroups=gtSettingsGroups, gtModuleBackupTable=gtModuleBackupTable, gtHMSEntry=gtHMSEntry, gtGroupRights=gtGroupRights, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtCurrentTimeSource=gtCurrentTimeSource, gtDNSEntry=gtDNSEntry, gtNTPServerTable=gtNTPServerTable, gtInterfaceStreaming=gtInterfaceStreaming, gtWebProtocol=gtWebProtocol, gtDateAndTime=gtDateAndTime, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtGroupName=gtGroupName, gtTimeUTC=gtTimeUTC, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtTimeLocal=gtTimeLocal, gtSwitch=gtSwitch, gtSyslogEntry=gtSyslogEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPPort=gtSFTPPort, gtUserTable=gtUserTable, gtInterfaceTable=gtInterfaceTable, gtAgentPort=gtAgentPort, gtTrapComString=gtTrapComString, gtTrapDestIP=gtTrapDestIP, gtDNSNumber=gtDNSNumber, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceMAC=gtInterfaceMAC, gtPortsLinkup=gtPortsLinkup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtGroupTable=gtGroupTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtChassisRedundancy=gtChassisRedundancy, gtUser=gtUser, gtUserAuthEntry=gtUserAuthEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceEntry=gtInterfaceEntry, gtPortsTable=gtPortsTable, gtTrapDestEntry=gtTrapDestEntry, gtWebAuth=gtWebAuth, gtSWOption=gtSWOption, gtBackupControl=gtBackupControl, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtCurrentUserPassword=gtCurrentUserPassword, gtAccesslistIPRange=gtAccesslistIPRange, gtFilename=gtFilename, gtGroupIdx=gtGroupIdx, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSLARegistered=gtSLARegistered, gtUserGroup=gtUserGroup, gtNTPServerNumber=gtNTPServerNumber, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAuthTable=gtUserAuthTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUpdateFilesTable=gtUpdateFilesTable, gtSLATable=gtSLATable, gtNetworkPortName=gtNetworkPortName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPTable=gtSFPTable, gtTrapDestNumber=gtTrapDestNumber, gtUserPassword=gtUserPassword, gtSLAEntry=gtSLAEntry, gtCurrentUserName=gtCurrentUserName, gtNetworking=gtNetworking, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceState=gtInterfaceState, gtNetworkName=gtNetworkName, gtModuleBackupControl=gtModuleBackupControl, gtNTPServerEntry=gtNTPServerEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleUpdate=gtModuleUpdate, gtSFPLink=gtSFPLink, gtInterfaceCLI=gtInterfaceCLI, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsMIB=gtSettingsMIB, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAccesslistEntry=gtAccesslistEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTimeZone=gtTimeZone, gtTrapDestPort=gtTrapDestPort, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAgentComWriteString=gtAgentComWriteString, gtSettingsConformance=gtSettingsConformance, gtSWOptionsTable=gtSWOptionsTable, gtBackupStatus=gtBackupStatus, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistIdx=gtAccesslistIdx, gtSyslogTable=gtSyslogTable, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistName=gtAccesslistName, gtSFTPServer=gtSFTPServer, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAgentComReadString=gtAgentComReadString, gtSNMPEntry=gtSNMPEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPPassword=gtSFTPPassword, gtTrapUser=gtTrapUser, gtSFTPUsername=gtSFTPUsername, gtNetworkPortState=gtNetworkPortState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserAccesslist=gtUserAccesslist, gtPortsName=gtPortsName, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDNSServerIP=gtDNSServerIP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUpdateStatus=gtUpdateStatus, gtUserIdx=gtUserIdx, gtSFPPlugged=gtSFPPlugged, gtSFPSpeed=gtSFPSpeed, gtAgentState=gtAgentState, gtUserParamIdx=gtUserParamIdx, gtGroupEntry=gtGroupEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSGroupName=gtHMSGroupName, gtPortsEntry=gtPortsEntry, gtAccesslistTable=gtAccesslistTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsFloodMulticast=gtPortsFloodMulticast, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFPNumber=gtSFPNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerAddress=gtNTPServerAddress, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFile=gtUpdateFile, gtServicesTable=gtServicesTable, gtServices=gtServices, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSTable=gtHMSTable, gtNetworkTable=gtNetworkTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserAuthEnabled=gtUserAuthEnabled, gtUserEntry=gtUserEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSLAExpires=gtSLAExpires, gtSyslogState=gtSyslogState, gtGeneral=gtGeneral)
