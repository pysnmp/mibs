...
ObjectIdentity, Integer32, Unsigned32, NotificationType, Gauge32, Counter32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, iso, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Unsigned32", "NotificationType", "Gauge32", "Counter32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "iso", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserTable=gtUserTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapPDU=gtTrapPDU, gtUpdateFilesTable=gtUpdateFilesTable, gtCurrentUserName=gtCurrentUserName, gtUserParamIdx=gtUserParamIdx, gtInterfaceMAC=gtInterfaceMAC, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSLAEntry=gtSLAEntry, gtSwitch=gtSwitch, gtWebProtocol=gtWebProtocol, gtAgentComWriteString=gtAgentComWriteString, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserEntry=gtUserEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtPortsEntry=gtPortsEntry, gtChassisRedundancy=gtChassisRedundancy, gtTrapState=gtTrapState, gtSettingsConformance=gtSettingsConformance, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDaylightAdjustment=gtDaylightAdjustment, gtSLARegistered=gtSLARegistered, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestNumber=gtTrapDestNumber, gtTrapDestPort=gtTrapDestPort, gtSNMPTable=gtSNMPTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupControl=gtModuleBackupControl, gtUpdateControl=gtUpdateControl, gtGroupTable=gtGroupTable, gtNetworkTable=gtNetworkTable, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSyslogEntry=gtSyslogEntry, gtGroupName=gtGroupName, gtSFTPPort=gtSFTPPort, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNTPServerTable=gtNTPServerTable, gtSettingsCompliances=gtSettingsCompliances, gtNetworkPortName=gtNetworkPortName, gtAccesslistName=gtAccesslistName, gtSyslogState=gtSyslogState, gtWebEnable=gtWebEnable, gtSFPLink=gtSFPLink, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSFPPlugged=gtSFPPlugged, gtSFPTable=gtSFPTable, gtGroupAccesslist=gtGroupAccesslist, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceIGMP=gtInterfaceIGMP, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkName=gtNetworkName, gtGroupParamIdx=gtGroupParamIdx, gtGroupIdx=gtGroupIdx, gtSFPNumber=gtSFPNumber, gtUserRowStatus=gtUserRowStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtGroupRights=gtGroupRights, gtNetworkEntry=gtNetworkEntry, gtFilename=gtFilename, gtAgentState=gtAgentState, gtPortsLinkup=gtPortsLinkup, gtModuleBackupTable=gtModuleBackupTable, gtSNMPEntry=gtSNMPEntry, gtUserIdx=gtUserIdx, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsGroups=gtSettingsGroups, gtHMSGroupName=gtHMSGroupName, gtNetworkVLAN=gtNetworkVLAN, gtTimeLocal=gtTimeLocal, gtUpdateFile=gtUpdateFile, gtSettingsMIB=gtSettingsMIB, gtSFPSpeed=gtSFPSpeed, gtInterfaceEntry=gtInterfaceEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsTable=gtPortsTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPPassword=gtSFTPPassword, gtSFTPServer=gtSFTPServer, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceTable=gtInterfaceTable, gtNTPServerAddress=gtNTPServerAddress, gtTrapDestEntry=gtTrapDestEntry, gtTimeZone=gtTimeZone, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSWOption=gtSWOption, gtInterfaceCLI=gtInterfaceCLI, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAccesslistTable=gtAccesslistTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapUser=gtTrapUser, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSettingsObjects=gtSettingsObjects, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFPEntry=gtSFPEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDateAndTimeTable=gtDateAndTimeTable, gtServicesEntry=gtServicesEntry, gtGroupEntry=gtGroupEntry, gtPortsName=gtPortsName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSEntry=gtDNSEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapDestTable=gtTrapDestTable, gtAccesslistEntry=gtAccesslistEntry, gtBackupControl=gtBackupControl, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceIPv4=gtInterfaceIPv4, gtUserAuthTable=gtUserAuthTable, gtNetworkPortNumber=gtNetworkPortNumber, gtAgentComReadString=gtAgentComReadString, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsNumber=gtPortsNumber, gtUpdateFilesEntry=gtUpdateFilesEntry, gtModuleBackupDate=gtModuleBackupDate, gtUserGroup=gtUserGroup, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtHMSNumMembers=gtHMSNumMembers, gtServices=gtServices, gtGeneral=gtGeneral, gtInterfaceName=gtInterfaceName, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSLATable=gtSLATable, gtUserPassword=gtUserPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtUserAuthEntry=gtUserAuthEntry, gtTimeUTC=gtTimeUTC, gtDNSServerIP=gtDNSServerIP, gtNetworkPortState=gtNetworkPortState, gtIGMPQueryInterval=gtIGMPQueryInterval, gtHMSTable=gtHMSTable, gtAgentPort=gtAgentPort, gtTrapComString=gtTrapComString, gtHMSComMethod=gtHMSComMethod, gtSNMP=gtSNMP, gtDNSNumber=gtDNSNumber, gtAccesslistIdx=gtAccesslistIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSyslogIP=gtSyslogIP, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceState=gtInterfaceState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSLAExpires=gtSLAExpires, gtAccesslistIPRange=gtAccesslistIPRange, gtSFTPUsername=gtSFTPUsername, gtBackupStatus=gtBackupStatus, gtNTPServerNumber=gtNTPServerNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUser=gtUser, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleBackup=gtModuleBackup, gtDNSTable=gtDNSTable, gtWebAuth=gtWebAuth, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserName=gtUserName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPType=gtSFPType, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtCurrentTimeSource=gtCurrentTimeSource, gtServicesTable=gtServicesTable, gtModuleUpdate=gtModuleUpdate, gtUpdateStatus=gtUpdateStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtSyslogTable=gtSyslogTable, gtNTPServerEntry=gtNTPServerEntry, gtUserAccesslist=gtUserAccesslist, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSEntry=gtHMSEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNumSFP=gtNumSFP, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworking=gtNetworking, gtSWOptionsTable=gtSWOptionsTable)
