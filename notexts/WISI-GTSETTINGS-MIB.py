...
iso, Bits, Integer32, Unsigned32, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, TimeTicks, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "Unsigned32", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSLAExpires=gtSLAExpires, gtDNSEntry=gtDNSEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsMIB=gtSettingsMIB, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFPSpeed=gtSFPSpeed, gtAgentComReadString=gtAgentComReadString, gtSLAEntry=gtSLAEntry, gtSettingsGroups=gtSettingsGroups, gtSwitch=gtSwitch, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebEnable=gtWebEnable, gtBackupStatus=gtBackupStatus, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupDate=gtModuleBackupDate, gtModuleBackup=gtModuleBackup, gtNetworking=gtNetworking, gtSFPLink=gtSFPLink, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSLARegistered=gtSLARegistered, gtPortsEntry=gtPortsEntry, gtAgentComWriteString=gtAgentComWriteString, gtSFTPPort=gtSFTPPort, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSGroupName=gtHMSGroupName, gtGeneral=gtGeneral, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserTable=gtUserTable, gtGroupName=gtGroupName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupIdx=gtGroupIdx, gtServices=gtServices, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceVLAN=gtInterfaceVLAN, gtWebAuth=gtWebAuth, gtSFTPPassword=gtSFTPPassword, gtBackupSFTPFilename=gtBackupSFTPFilename, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFPEntry=gtSFPEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsObjects=gtSettingsObjects, gtPortsBitrateReceive=gtPortsBitrateReceive, gtServicesEntry=gtServicesEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserAuthEntry=gtUserAuthEntry, gtSNMPEntry=gtSNMPEntry, gtGroupEntry=gtGroupEntry, gtUserRowStatus=gtUserRowStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtWebProtocol=gtWebProtocol, gtSFTPUsername=gtSFTPUsername, gtSFTPServer=gtSFTPServer, gtUser=gtUser, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserPassword=gtUserPassword, gtAccesslistIdx=gtAccesslistIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistTable=gtAccesslistTable, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAccesslist=gtUserAccesslist, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceEntry=gtInterfaceEntry, gtNetworkPortState=gtNetworkPortState, gtTrapDestIP=gtTrapDestIP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupControl=gtModuleBackupControl, gtUpdateControl=gtUpdateControl, gtUserAuthTable=gtUserAuthTable, gtPortsNumber=gtPortsNumber, gtSFPNumber=gtSFPNumber, gtDateAndTime=gtDateAndTime, gtModuleUpdate=gtModuleUpdate, gtNetworkVLAN=gtNetworkVLAN, gtSyslogState=gtSyslogState, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapState=gtTrapState, gtNetworkName=gtNetworkName, gtHMSNumMembers=gtHMSNumMembers, gtSettingsConformance=gtSettingsConformance, gtSFPPlugged=gtSFPPlugged, gtSyslogTable=gtSyslogTable, gtSyslogEntry=gtSyslogEntry, gtSFPType=gtSFPType, gtTrapSecurityLevel=gtTrapSecurityLevel, gtPortsName=gtPortsName, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceTable=gtInterfaceTable, gtInterfaceCLI=gtInterfaceCLI, gtHMSComMethod=gtHMSComMethod, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestNumber=gtTrapDestNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDNSServerIP=gtDNSServerIP, gtUserIdx=gtUserIdx, gtUserGroup=gtUserGroup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapComString=gtTrapComString, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUpdateStatus=gtUpdateStatus, gtAccesslistEntry=gtAccesslistEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtDateAndTimeTable=gtDateAndTimeTable, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtDNSNumber=gtDNSNumber, gtAgentPort=gtAgentPort, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceState=gtInterfaceState, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSNMP=gtSNMP, gtGroupAccesslist=gtGroupAccesslist, gtServicesTable=gtServicesTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserEntry=gtUserEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceNumber=gtInterfaceNumber, gtSWOptionsTable=gtSWOptionsTable, gtTrapPDU=gtTrapPDU, gtSWOption=gtSWOption, gtNTPServerRowStatus=gtNTPServerRowStatus, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerNumber=gtNTPServerNumber, gtSyslogIP=gtSyslogIP, gtAgentState=gtAgentState, gtTrapUser=gtTrapUser, gtInterfaceMAC=gtInterfaceMAC, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFPTable=gtSFPTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserName=gtUserName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtPortsLinkup=gtPortsLinkup, gtDaylightAdjustment=gtDaylightAdjustment, gtTimeZone=gtTimeZone, gtSWOptionsIdx=gtSWOptionsIdx, gtTimeUTC=gtTimeUTC, gtUserParamIdx=gtUserParamIdx, gtUpdateFile=gtUpdateFile, gtTrapDestTable=gtTrapDestTable, gtGroupTable=gtGroupTable, gtNumSFP=gtNumSFP, gtBackupControl=gtBackupControl, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsTable=gtPortsTable, gtFilename=gtFilename, gtHMSEntry=gtHMSEntry, gtCurrentUserName=gtCurrentUserName, gtNetworkEntry=gtNetworkEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtSNMPTable=gtSNMPTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLATable=gtSLATable, gtNetworkPortName=gtNetworkPortName, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceName=gtInterfaceName, gtNTPServerTable=gtNTPServerTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupRights=gtGroupRights, gtNetworkTable=gtNetworkTable, gtInterfaceStreaming=gtInterfaceStreaming, gtDNSTable=gtDNSTable, gtTimeLocal=gtTimeLocal, gtHMSTable=gtHMSTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistName=gtAccesslistName)
