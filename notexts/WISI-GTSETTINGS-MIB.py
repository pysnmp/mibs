...
iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, MibIdentifier, Counter64, Unsigned32, ModuleIdentity, Counter32, NotificationType, Integer32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "MibIdentifier", "Counter64", "Unsigned32", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", PYSNMP_MODULE_ID=gtSettingsMIB, gtDateAndTime=gtDateAndTime, gtNTPServerNumber=gtNTPServerNumber, gtSettingsGroups=gtSettingsGroups, gtUserPassword=gtUserPassword, gtTrapPDU=gtTrapPDU, gtSettingsObjects=gtSettingsObjects, gtTimeLocal=gtTimeLocal, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceVLAN=gtInterfaceVLAN, gtSFTPUsername=gtSFTPUsername, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSWOptionsTable=gtSWOptionsTable, gtNetworkPortName=gtNetworkPortName, gtSFPTable=gtSFPTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServices=gtServices, gtDNSEntry=gtDNSEntry, gtTrapDestEntry=gtTrapDestEntry, gtUserParamIdx=gtUserParamIdx, gtAccesslistIPRange=gtAccesslistIPRange, gtSLAEntry=gtSLAEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSwitch=gtSwitch, gtInterfaceName=gtInterfaceName, gtNTPServerEntry=gtNTPServerEntry, gtUserName=gtUserName, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkPortsTable=gtNetworkPortsTable, gtSNMPTable=gtSNMPTable, gtNetworkPortState=gtNetworkPortState, gtGroupParamIdx=gtGroupParamIdx, gtHMSEntry=gtHMSEntry, gtDNSNumber=gtDNSNumber, gtSyslogTable=gtSyslogTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtFilename=gtFilename, gtInterfaceNumber=gtInterfaceNumber, gtSFPType=gtSFPType, gtUserIdx=gtUserIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkTable=gtNetworkTable, gtAccesslistTable=gtAccesslistTable, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkName=gtNetworkName, gtSFPNumber=gtSFPNumber, gtAgentComReadString=gtAgentComReadString, gtUserGroup=gtUserGroup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackupDate=gtModuleBackupDate, gtSWOptionsEntry=gtSWOptionsEntry, gtTrapDestNumber=gtTrapDestNumber, gtModuleUpdate=gtModuleUpdate, gtTimeUTC=gtTimeUTC, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsMIB=gtSettingsMIB, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSyslogState=gtSyslogState, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPPort=gtSFTPPort, gtAgentState=gtAgentState, gtUserEntry=gtUserEntry, gtSyslogIP=gtSyslogIP, gtTrapComString=gtTrapComString, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtDNSTable=gtDNSTable, gtUserRowStatus=gtUserRowStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFTPPassword=gtSFTPPassword, gtSFPSpeed=gtSFPSpeed, gtUpdateFile=gtUpdateFile, gtGroupIdx=gtGroupIdx, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceTable=gtInterfaceTable, gtGroupEntry=gtGroupEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkVLAN=gtNetworkVLAN, gtUserAccesslist=gtUserAccesslist, gtNTPServerTable=gtNTPServerTable, gtPortsEntry=gtPortsEntry, gtNTPServerAddress=gtNTPServerAddress, gtPortsNumber=gtPortsNumber, gtAccesslistName=gtAccesslistName, gtBackupStatus=gtBackupStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtGroupAccesslist=gtGroupAccesslist, gtModuleBackupControl=gtModuleBackupControl, gtAccesslistEntry=gtAccesslistEntry, gtGeneral=gtGeneral, gtModuleBackupTable=gtModuleBackupTable, gtNumSFP=gtNumSFP, gtSFTPServer=gtSFTPServer, gtUserAuthTable=gtUserAuthTable, gtModuleBackup=gtModuleBackup, gtHMSTable=gtHMSTable, gtTimeZone=gtTimeZone, gtServicesTable=gtServicesTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSNMP=gtSNMP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAccesslistParamIdx=gtAccesslistParamIdx, gtWebProtocol=gtWebProtocol, gtTrapDestIP=gtTrapDestIP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapDestPort=gtTrapDestPort, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkEntry=gtNetworkEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkPortNumber=gtNetworkPortNumber, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceStreaming=gtInterfaceStreaming, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupRights=gtGroupRights, gtWebEnable=gtWebEnable, gtGroupTable=gtGroupTable, gtNetworking=gtNetworking, gtSLATable=gtSLATable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAgentPort=gtAgentPort, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPPlugged=gtSFPPlugged, gtSLAExpires=gtSLAExpires, gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsNotifications=gtSettingsNotifications, gtSWOptionsIdx=gtSWOptionsIdx, gtUpdateControl=gtUpdateControl, gtTrapUser=gtTrapUser, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSWOption=gtSWOption, gtTrapSNMPVersion=gtTrapSNMPVersion, gtChassisRedundancy=gtChassisRedundancy, gtSyslogEntry=gtSyslogEntry, gtPortsTable=gtPortsTable, gtUpdateStatus=gtUpdateStatus, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSNMPEntry=gtSNMPEntry, gtInterfaceMAC=gtInterfaceMAC, gtUser=gtUser, gtHMSGroupName=gtHMSGroupName, gtSFPLink=gtSFPLink, gtGroupName=gtGroupName, gtInterfaceState=gtInterfaceState, gtUserTable=gtUserTable, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceCLI=gtInterfaceCLI, gtDNSServerIP=gtDNSServerIP, gtTrapState=gtTrapState, gtCurrentUserName=gtCurrentUserName, gtServicesEntry=gtServicesEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsConformance=gtSettingsConformance, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtPortsName=gtPortsName, gtPortsLinkup=gtPortsLinkup, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupControl=gtBackupControl, gtAgentComWriteString=gtAgentComWriteString, gtWebAuth=gtWebAuth, gtHMSNumMembers=gtHMSNumMembers, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAccesslistIdx=gtAccesslistIdx, gtUserAuthEntry=gtUserAuthEntry, gtSFPEntry=gtSFPEntry, gtSLARegistered=gtSLARegistered, gtTrapDestTable=gtTrapDestTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPQueryInterval=gtIGMPQueryInterval)
