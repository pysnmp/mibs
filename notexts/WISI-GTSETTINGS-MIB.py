...
Integer32, Counter32, MibIdentifier, TimeTicks, Counter64, ModuleIdentity, Unsigned32, IpAddress, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "MibIdentifier", "TimeTicks", "Counter64", "ModuleIdentity", "Unsigned32", "IpAddress", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceEntry=gtInterfaceEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLAExpires=gtSLAExpires, gtNetworkPortName=gtNetworkPortName, gtNTPServerNumber=gtNTPServerNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSyslogTable=gtSyslogTable, gtModuleBackupEntry=gtModuleBackupEntry, gtSFTPPassword=gtSFTPPassword, gtBackupSFTPUsername=gtBackupSFTPUsername, gtChassisRedundancy=gtChassisRedundancy, gtSLATable=gtSLATable, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, gtTrapDestTable=gtTrapDestTable, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsEntry=gtPortsEntry, gtDNSTable=gtDNSTable, gtAgentComReadString=gtAgentComReadString, gtAccesslistIPRange=gtAccesslistIPRange, gtBackupControl=gtBackupControl, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSyslogState=gtSyslogState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSNMPTable=gtSNMPTable, gtDateAndTimeTable=gtDateAndTimeTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserTable=gtUserTable, gtPortsTable=gtPortsTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtWebEnable=gtWebEnable, gtSLAEntry=gtSLAEntry, gtGroupTable=gtGroupTable, gtSFPType=gtSFPType, gtModuleBackupDate=gtModuleBackupDate, gtModuleBackup=gtModuleBackup, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserName=gtUserName, gtAccesslistName=gtAccesslistName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPEntry=gtSFPEntry, gtTrapComString=gtTrapComString, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceNumber=gtInterfaceNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtHMSComMethod=gtHMSComMethod, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortNumber=gtNetworkPortNumber, gtTimeUTC=gtTimeUTC, gtTimeLocal=gtTimeLocal, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapState=gtTrapState, gtSNMP=gtSNMP, gtHMSNumMembers=gtHMSNumMembers, gtModuleRedundancyMode=gtModuleRedundancyMode, gtModuleBackupTable=gtModuleBackupTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtWebAuth=gtWebAuth, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkEntry=gtNetworkEntry, gtSettingsMIB=gtSettingsMIB, gtTrapDestEntry=gtTrapDestEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSEntry=gtHMSEntry, gtInterfaceTable=gtInterfaceTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNTPServerTable=gtNTPServerTable, gtAccesslistIdx=gtAccesslistIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestPort=gtTrapDestPort, gtGroupIdx=gtGroupIdx, gtUpdateStatus=gtUpdateStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapDestIP=gtTrapDestIP, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUserAuthTable=gtUserAuthTable, gtWebProtocol=gtWebProtocol, gtUserParamIdx=gtUserParamIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSyslogEntry=gtSyslogEntry, gtSettingsConformance=gtSettingsConformance, gtTimeZone=gtTimeZone, gtGroupName=gtGroupName, gtNetworkPortState=gtNetworkPortState, gtInterfaceIGMP=gtInterfaceIGMP, gtDateAndTime=gtDateAndTime, gtUserAuthEntry=gtUserAuthEntry, gtHMSGroupName=gtHMSGroupName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDaylightAdjustment=gtDaylightAdjustment, gtUserIdx=gtUserIdx, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserRowStatus=gtUserRowStatus, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkTable=gtNetworkTable, gtNTPServerEntry=gtNTPServerEntry, gtPortsNumber=gtPortsNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLARegistered=gtSLARegistered, gtDNSEntry=gtDNSEntry, gtCurrentUserName=gtCurrentUserName, gtSFPPlugged=gtSFPPlugged, gtAccesslistEntry=gtAccesslistEntry, gtServicesTable=gtServicesTable, gtInterfaceState=gtInterfaceState, gtInterfaceMAC=gtInterfaceMAC, gtGeneral=gtGeneral, gtSWOptionsIdx=gtSWOptionsIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtSFTPPort=gtSFTPPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsLinkup=gtPortsLinkup, gtAgentComWriteString=gtAgentComWriteString, gtUpdateControl=gtUpdateControl, gtUpdateFile=gtUpdateFile, gtSFPNumber=gtSFPNumber, gtUser=gtUser, gtUserAccesslist=gtUserAccesslist, gtBackupStatus=gtBackupStatus, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtAccesslistParamIdx=gtAccesslistParamIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtSNMPEntry=gtSNMPEntry, gtGroupEntry=gtGroupEntry, gtInterfaceCLI=gtInterfaceCLI, gtFilename=gtFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtSWOption=gtSWOption, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSettingsNotifications=gtSettingsNotifications, gtSettingsGroups=gtSettingsGroups, gtAgentState=gtAgentState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSNumber=gtDNSNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUserPassword=gtUserPassword, gtUserEntry=gtUserEntry, gtModuleUpdate=gtModuleUpdate, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNumSFP=gtNumSFP, gtInterfaceName=gtInterfaceName, gtTrapPDU=gtTrapPDU, gtNetworking=gtNetworking, gtGroupAccesslist=gtGroupAccesslist, gtServices=gtServices, gtSyslogIP=gtSyslogIP, gtSFPTable=gtSFPTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFPLink=gtSFPLink, gtHMSTable=gtHMSTable, gtSFPSpeed=gtSFPSpeed, gtSettingsObjects=gtSettingsObjects, gtNTPServerAddress=gtNTPServerAddress, gtDNSServerIP=gtDNSServerIP, gtSwitch=gtSwitch, gtPortsName=gtPortsName, gtTrapUser=gtTrapUser, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFTPServer=gtSFTPServer, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtServicesEntry=gtServicesEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAccesslistTable=gtAccesslistTable, gtNetworkName=gtNetworkName, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapDestNumber=gtTrapDestNumber, gtGroupRights=gtGroupRights, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAgentPort=gtAgentPort, gtUserGroup=gtUserGroup, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceStreaming=gtInterfaceStreaming)
