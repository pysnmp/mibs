...
Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, IpAddress, Integer32, Counter64, TimeTicks, iso, MibIdentifier, Bits, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "TimeTicks", "iso", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTimeLocal=gtTimeLocal, gtBackupSFTPPort=gtBackupSFTPPort, gtSNMPEntry=gtSNMPEntry, gtPortsName=gtPortsName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackupDate=gtModuleBackupDate, gtHMSGroupName=gtHMSGroupName, gtInterfaceVLAN=gtInterfaceVLAN, gtDateAndTime=gtDateAndTime, gtSettingsNotifications=gtSettingsNotifications, gtUpdateFilesTable=gtUpdateFilesTable, gtSFTPServer=gtSFTPServer, gtTrapDestPort=gtTrapDestPort, gtNumSFP=gtNumSFP, gtWebAuth=gtWebAuth, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsMIB=gtSettingsMIB, gtModuleBackup=gtModuleBackup, gtNTPServerNumber=gtNTPServerNumber, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceNumber=gtInterfaceNumber, gtSNMPTable=gtSNMPTable, gtSFPTable=gtSFPTable, gtUserPassword=gtUserPassword, gtSLARegistered=gtSLARegistered, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFile=gtUpdateFile, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleBackupStatus=gtModuleBackupStatus, gtAgentComWriteString=gtAgentComWriteString, gtSFPNumber=gtSFPNumber, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistName=gtAccesslistName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkEntry=gtNetworkEntry, gtAgentState=gtAgentState, gtSettingsObjects=gtSettingsObjects, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSComMethod=gtHMSComMethod, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSTable=gtDNSTable, gtSettingsGroups=gtSettingsGroups, gtSyslogState=gtSyslogState, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSwitch=gtSwitch, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogEntry=gtSyslogEntry, gtGroupRights=gtGroupRights, gtWebEnable=gtWebEnable, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapComString=gtTrapComString, gtFilename=gtFilename, gtGeneral=gtGeneral, gtTrapUser=gtTrapUser, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserEntry=gtUserEntry, gtGroupEntry=gtGroupEntry, gtSFTPPassword=gtSFTPPassword, gtTrapPDU=gtTrapPDU, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSyslogTable=gtSyslogTable, gtServicesTable=gtServicesTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapState=gtTrapState, gtHMSEntry=gtHMSEntry, gtTrapDestIP=gtTrapDestIP, gtServices=gtServices, gtUserName=gtUserName, gtSLAExpires=gtSLAExpires, gtUserRowStatus=gtUserRowStatus, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSNMP=gtSNMP, gtSyslogIP=gtSyslogIP, gtDNSEntry=gtDNSEntry, gtUpdateStatus=gtUpdateStatus, gtAccesslistTable=gtAccesslistTable, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupName=gtGroupName, gtModuleBackupControl=gtModuleBackupControl, gtModuleUpdate=gtModuleUpdate, gtAgentComReadString=gtAgentComReadString, gtPortsLinkup=gtPortsLinkup, gtNetworkPortsEntry=gtNetworkPortsEntry, gtDNSServerIP=gtDNSServerIP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestTable=gtTrapDestTable, gtServicesEntry=gtServicesEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFPEntry=gtSFPEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTimeUTC=gtTimeUTC, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPLink=gtSFPLink, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPUsername=gtSFTPUsername, gtGroupParamIdx=gtGroupParamIdx, gtUpdateControl=gtUpdateControl, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLAEntry=gtSLAEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSNumMembers=gtHMSNumMembers, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserAuthEntry=gtUserAuthEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtUserIdx=gtUserIdx, gtPortsNumber=gtPortsNumber, gtAgentPort=gtAgentPort, gtSFTPPort=gtSFTPPort, gtTimeZone=gtTimeZone, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSTable=gtHMSTable, gtGroupIdx=gtGroupIdx, gtUserGroup=gtUserGroup, gtNetworkName=gtNetworkName, gtAccesslistEntry=gtAccesslistEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSWOptionsEntry=gtSWOptionsEntry, gtUserAccesslist=gtUserAccesslist, gtUserParamIdx=gtUserParamIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIPv4=gtInterfaceIPv4, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupTable=gtGroupTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapDestEntry=gtTrapDestEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapDestNumber=gtTrapDestNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtChassisRedundancy=gtChassisRedundancy, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtWebProtocol=gtWebProtocol, gtNTPServerTable=gtNTPServerTable, gtSFPPlugged=gtSFPPlugged, gtNTPServerAddress=gtNTPServerAddress, gtUserAuthTable=gtUserAuthTable, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceMAC=gtInterfaceMAC, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortState=gtNetworkPortState, gtBackupControl=gtBackupControl, gtInterfaceName=gtInterfaceName, gtSWOption=gtSWOption, gtNetworking=gtNetworking, gtNetworkTable=gtNetworkTable, gtSLATable=gtSLATable, gtPortsEntry=gtPortsEntry, gtBackupStatus=gtBackupStatus, gtSFPType=gtSFPType, gtPortsTable=gtPortsTable, gtUser=gtUser, gtUserTable=gtUserTable, gtCurrentUserName=gtCurrentUserName, gtNetworkPortName=gtNetworkPortName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPSpeed=gtSFPSpeed, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistIdx=gtAccesslistIdx, gtDNSNumber=gtDNSNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsConformance=gtSettingsConformance, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceTable=gtInterfaceTable, gtInterfaceState=gtInterfaceState)
