...
Integer32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Counter32, IpAddress, Bits, Counter64, NotificationType, ObjectIdentity, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Counter32", "IpAddress", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSWOption=gtSWOption, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkPortName=gtNetworkPortName, gtSFPPlugged=gtSFPPlugged, gtSFPType=gtSFPType, gtHMSNumMembers=gtHMSNumMembers, gtPortsEntry=gtPortsEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtUserAuthTable=gtUserAuthTable, gtSyslogIP=gtSyslogIP, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceCLI=gtInterfaceCLI, gtUserRowStatus=gtUserRowStatus, gtGroupRights=gtGroupRights, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupDate=gtModuleBackupDate, gtUserAccesslist=gtUserAccesslist, gtSwitch=gtSwitch, gtSettingsObjects=gtSettingsObjects, gtSettingsCompliances=gtSettingsCompliances, gtGroupParamIdx=gtGroupParamIdx, gtSNMPEntry=gtSNMPEntry, gtUserAuthEntry=gtUserAuthEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPUsername=gtSFTPUsername, gtSLAEntry=gtSLAEntry, gtInterfaceMAC=gtInterfaceMAC, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAgentComReadString=gtAgentComReadString, gtGeneral=gtGeneral, gtSFPNumber=gtSFPNumber, gtTrapUser=gtTrapUser, gtBackupControl=gtBackupControl, gtSFTPPort=gtSFTPPort, gtCurrentUserName=gtCurrentUserName, gtPortsNumber=gtPortsNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtPortsTable=gtPortsTable, gtHMSTable=gtHMSTable, gtUserParamIdx=gtUserParamIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAccesslistTable=gtAccesslistTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistIdx=gtAccesslistIdx, gtTrapDestIP=gtTrapDestIP, gtAccesslistEntry=gtAccesslistEntry, gtPortsName=gtPortsName, gtAgentPort=gtAgentPort, gtDNSEntry=gtDNSEntry, gtSettingsConformance=gtSettingsConformance, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsNotifications=gtSettingsNotifications, gtGroupTable=gtGroupTable, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFilesTable=gtUpdateFilesTable, gtSFTPServer=gtSFTPServer, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsGroups=gtSettingsGroups, gtInterfaceNumber=gtInterfaceNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtNTPServerTable=gtNTPServerTable, gtUserGroup=gtUserGroup, gtNetworkTable=gtNetworkTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSEntry=gtHMSEntry, gtUserIdx=gtUserIdx, gtInterfaceName=gtInterfaceName, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceTable=gtInterfaceTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtAgentState=gtAgentState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLARegistered=gtSLARegistered, gtGroupAccesslist=gtGroupAccesslist, gtSFTPPassword=gtSFTPPassword, gtModuleBackupTable=gtModuleBackupTable, gtDNSServerIP=gtDNSServerIP, gtModuleBackup=gtModuleBackup, gtAccesslistIPRange=gtAccesslistIPRange, gtWebAuth=gtWebAuth, gtSWOptionsTable=gtSWOptionsTable, gtServices=gtServices, gtNumSFP=gtNumSFP, gtTrapComString=gtTrapComString, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkPortState=gtNetworkPortState, gtGroupEntry=gtGroupEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupStatus=gtBackupStatus, gtNTPServerEntry=gtNTPServerEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTimeUTC=gtTimeUTC, gtDNSNumber=gtDNSNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSTable=gtDNSTable, gtNTPServerAddress=gtNTPServerAddress, gtUserEntry=gtUserEntry, gtSyslogTable=gtSyslogTable, gtPortsLinkup=gtPortsLinkup, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSLATable=gtSLATable, gtSLAExpires=gtSLAExpires, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTrapDestEntry=gtTrapDestEntry, gtGroupIdx=gtGroupIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceSNMP=gtInterfaceSNMP, gtUserName=gtUserName, gtSFPTable=gtSFPTable, gtServicesTable=gtServicesTable, gtSyslogEntry=gtSyslogEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSGroupName=gtHMSGroupName, gtHMSComMethod=gtHMSComMethod, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPSpeed=gtSFPSpeed, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserPassword=gtUserPassword, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkPortNumber=gtNetworkPortNumber, gtUser=gtUser, gtNetworkName=gtNetworkName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtAccesslistName=gtAccesslistName, gtGroupName=gtGroupName, gtWebEnable=gtWebEnable, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceState=gtInterfaceState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserAuthEnabled=gtUserAuthEnabled, gtTimeLocal=gtTimeLocal, gtNetworkEntry=gtNetworkEntry, gtSFPLink=gtSFPLink, gtCurrentUserPassword=gtCurrentUserPassword, gtServicesEntry=gtServicesEntry, gtModuleUpdate=gtModuleUpdate, gtInterfaceDHCPState=gtInterfaceDHCPState, gtCurrentTimeSource=gtCurrentTimeSource, gtSyslogState=gtSyslogState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebProtocol=gtWebProtocol, gtTrapDestPort=gtTrapDestPort, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtChassisRedundancy=gtChassisRedundancy, gtFilename=gtFilename, gtSettingsMIB=gtSettingsMIB, gtNetworking=gtNetworking, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSNMPTable=gtSNMPTable, gtUserTable=gtUserTable, gtTimeZone=gtTimeZone, gtTrapPDU=gtTrapPDU, gtTrapDestTable=gtTrapDestTable, gtTrapState=gtTrapState, gtAgentComWriteString=gtAgentComWriteString, gtUpdateControl=gtUpdateControl, PYSNMP_MODULE_ID=gtSettingsMIB, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFile=gtUpdateFile, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPEntry=gtSFPEntry, gtUpdateStatus=gtUpdateStatus, gtDateAndTime=gtDateAndTime, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSNMP=gtSNMP, gtInterfaceVLAN=gtInterfaceVLAN)
