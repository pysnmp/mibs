...
ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, TimeTicks, Unsigned32, Bits, MibIdentifier, Counter64, Gauge32, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "TimeTicks", "Unsigned32", "Bits", "MibIdentifier", "Counter64", "Gauge32", "Integer32", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAccesslistTable=gtAccesslistTable, gtInterfaceCLI=gtInterfaceCLI, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtDNSTable=gtDNSTable, gtServicesEntry=gtServicesEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAgentComReadString=gtAgentComReadString, gtModuleBackupStatus=gtModuleBackupStatus, gtSettingsObjects=gtSettingsObjects, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSEntry=gtHMSEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPServer=gtBackupSFTPServer, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSNMP=gtSNMP, gtModuleBackupDate=gtModuleBackupDate, gtTimeZone=gtTimeZone, gtSNMPTable=gtSNMPTable, gtHMSGroupName=gtHMSGroupName, gtSFTPServer=gtSFTPServer, gtModuleBackup=gtModuleBackup, gtUserRowStatus=gtUserRowStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapPDU=gtTrapPDU, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUpdateStatus=gtUpdateStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFTPPort=gtSFTPPort, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworking=gtNetworking, gtTrapState=gtTrapState, gtPortsLinkup=gtPortsLinkup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSWOptionsEntry=gtSWOptionsEntry, gtTrapDestTable=gtTrapDestTable, gtTrapDestIP=gtTrapDestIP, gtSFPTable=gtSFPTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUpdateFile=gtUpdateFile, gtNTPServerNumber=gtNTPServerNumber, gtTrapDestEntry=gtTrapDestEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSyslogTable=gtSyslogTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDNSNumber=gtDNSNumber, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserIdx=gtUserIdx, gtChassisRedundancy=gtChassisRedundancy, gtNetworkPortState=gtNetworkPortState, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupParamIdx=gtGroupParamIdx, gtPortsNumber=gtPortsNumber, gtSFTPPassword=gtSFTPPassword, gtUserAuthEnabled=gtUserAuthEnabled, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkEntry=gtNetworkEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtGroupIdx=gtGroupIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSettingsMIB=gtSettingsMIB, gtFilename=gtFilename, gtSettingsGroups=gtSettingsGroups, gtUserAccesslist=gtUserAccesslist, gtPortsName=gtPortsName, gtGroupTable=gtGroupTable, gtSFPType=gtSFPType, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtGroupName=gtGroupName, gtUpdateFilesTable=gtUpdateFilesTable, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleUpdate=gtModuleUpdate, gtBackupControl=gtBackupControl, gtTimeLocal=gtTimeLocal, gtWebProtocol=gtWebProtocol, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserAuthTable=gtUserAuthTable, gtUserPassword=gtUserPassword, gtAccesslistIdx=gtAccesslistIdx, gtSFPLink=gtSFPLink, gtSLAExpires=gtSLAExpires, gtSFTPUsername=gtSFTPUsername, gtHMSTable=gtHMSTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSComMethod=gtHMSComMethod, gtSWOption=gtSWOption, gtDNSEntry=gtDNSEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSwitch=gtSwitch, gtGroupRights=gtGroupRights, gtNetworkPortName=gtNetworkPortName, gtNumSFP=gtNumSFP, gtSWOptionsTable=gtSWOptionsTable, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceTable=gtInterfaceTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceState=gtInterfaceState, gtAgentState=gtAgentState, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAgentPort=gtAgentPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserTable=gtUserTable, gtGeneral=gtGeneral, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkName=gtNetworkName, gtSFPSpeed=gtSFPSpeed, gtHMSNumMembers=gtHMSNumMembers, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceNumber=gtInterfaceNumber, gtWebAuth=gtWebAuth, gtBackupStatus=gtBackupStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNTPServerTable=gtNTPServerTable, gtUserAuthEntry=gtUserAuthEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtSyslogState=gtSyslogState, gtPortsEntry=gtPortsEntry, gtSettingsConformance=gtSettingsConformance, gtSNMPEntry=gtSNMPEntry, gtDNSServerIP=gtDNSServerIP, gtNetworkTable=gtNetworkTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPNumber=gtSFPNumber, gtTrapComString=gtTrapComString, gtAccesslistName=gtAccesslistName, gtUserEntry=gtUserEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceVLAN=gtInterfaceVLAN, gtSLAEntry=gtSLAEntry, gtNTPServerEntry=gtNTPServerEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtServices=gtServices, gtTrapDestPort=gtTrapDestPort, gtUserName=gtUserName, gtTrapDestNumber=gtTrapDestNumber, gtSFPEntry=gtSFPEntry, gtPortsTable=gtPortsTable, gtUser=gtUser, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTimeUTC=gtTimeUTC, gtSyslogEntry=gtSyslogEntry, gtUpdateControl=gtUpdateControl, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsNotifications=gtSettingsNotifications, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDateAndTime=gtDateAndTime, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGroupAccesslist=gtGroupAccesslist, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtCurrentUserName=gtCurrentUserName, gtSLATable=gtSLATable, gtWebEnable=gtWebEnable, gtServicesTable=gtServicesTable, gtUserGroup=gtUserGroup, gtNetworkPortsTable=gtNetworkPortsTable, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceMAC=gtInterfaceMAC, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSLARegistered=gtSLARegistered, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapUser=gtTrapUser, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceName=gtInterfaceName, gtUserParamIdx=gtUserParamIdx, gtInterfaceEntry=gtInterfaceEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtGroupEntry=gtGroupEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceSNMP=gtInterfaceSNMP, gtSFPPlugged=gtSFPPlugged, gtNTPServerAddress=gtNTPServerAddress)
