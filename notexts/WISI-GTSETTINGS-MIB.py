...
Integer32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, ObjectIdentity, Counter64, Gauge32, iso, MibIdentifier, IpAddress, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter64", "Gauge32", "iso", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPType=gtSFPType, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistName=gtAccesslistName, gtNetworking=gtNetworking, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDNSNumber=gtDNSNumber, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsObjects=gtSettingsObjects, gtTrapUser=gtTrapUser, gtCurrentTimeSource=gtCurrentTimeSource, gtHMSGroupName=gtHMSGroupName, gtUserAuthEnabled=gtUserAuthEnabled, gtSLARegistered=gtSLARegistered, gtHMSTable=gtHMSTable, gtNetworkPortState=gtNetworkPortState, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTimeLocal=gtTimeLocal, gtBackupStatus=gtBackupStatus, gtTrapState=gtTrapState, gtChassisRedundancy=gtChassisRedundancy, gtSettingsCompliances=gtSettingsCompliances, gtNetworkTable=gtNetworkTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSNMPEntry=gtSNMPEntry, gtHMSEntry=gtHMSEntry, gtGroupAccesslist=gtGroupAccesslist, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsName=gtPortsName, gtSNMP=gtSNMP, gtUpdateFile=gtUpdateFile, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestPort=gtTrapDestPort, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkPortName=gtNetworkPortName, gtAgentState=gtAgentState, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSFTPPort=gtSFTPPort, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerTable=gtNTPServerTable, gtTrapPDU=gtTrapPDU, gtPortsTable=gtPortsTable, gtUserParamIdx=gtUserParamIdx, gtUserAuthTable=gtUserAuthTable, gtBackupControl=gtBackupControl, gtSNMPTable=gtSNMPTable, gtSFTPServer=gtSFTPServer, gtDateAndTimeEntry=gtDateAndTimeEntry, gtGroupEntry=gtGroupEntry, gtUpdateControl=gtUpdateControl, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSLAEntry=gtSLAEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceName=gtInterfaceName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtGroupName=gtGroupName, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerNumber=gtNTPServerNumber, gtNetworkEntry=gtNetworkEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAuthEntry=gtUserAuthEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtDNSEntry=gtDNSEntry, gtSyslogTable=gtSyslogTable, gtInterfaceIGMP=gtInterfaceIGMP, gtSettingsGroups=gtSettingsGroups, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserGroup=gtUserGroup, gtUserIdx=gtUserIdx, gtInterfaceEntry=gtInterfaceEntry, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceState=gtInterfaceState, gtNetworkVLAN=gtNetworkVLAN, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceTable=gtInterfaceTable, gtWebProtocol=gtWebProtocol, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPEntry=gtSFPEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleBackupTable=gtModuleBackupTable, gtAgentPort=gtAgentPort, gtInterfaceStreaming=gtInterfaceStreaming, gtTimeZone=gtTimeZone, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceCLI=gtInterfaceCLI, gtGroupParamIdx=gtGroupParamIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFPPlugged=gtSFPPlugged, gtTrapDestIP=gtTrapDestIP, gtModuleBackup=gtModuleBackup, gtSFTPPassword=gtSFTPPassword, gtPortsLinkup=gtPortsLinkup, gtSLATable=gtSLATable, gtGeneral=gtGeneral, gtTrapDestRowStatus=gtTrapDestRowStatus, gtWebAuth=gtWebAuth, gtFilename=gtFilename, gtSFPSpeed=gtSFPSpeed, gtGroupRights=gtGroupRights, gtTrapDestNumber=gtTrapDestNumber, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFPTable=gtSFPTable, gtPortsNumber=gtPortsNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceMAC=gtInterfaceMAC, gtCurrentUserName=gtCurrentUserName, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtDNSTable=gtDNSTable, gtSFPNumber=gtSFPNumber, gtSettingsMIB=gtSettingsMIB, gtHMSNumMembers=gtHMSNumMembers, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkName=gtNetworkName, gtGroupIdx=gtGroupIdx, gtAgentComWriteString=gtAgentComWriteString, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupTable=gtGroupTable, gtBackupSFTPFilename=gtBackupSFTPFilename, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSWOptionsTable=gtSWOptionsTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkPortVLAN=gtNetworkPortVLAN, gtWebEnable=gtWebEnable, gtSettingsNotifications=gtSettingsNotifications, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUser=gtUser, gtTrapDestEntry=gtTrapDestEntry, gtSyslogState=gtSyslogState, gtTrapDestTable=gtTrapDestTable, gtUserEntry=gtUserEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsConformance=gtSettingsConformance, gtSyslogIP=gtSyslogIP, gtTimeUTC=gtTimeUTC, gtBackupSFTPServer=gtBackupSFTPServer, gtServices=gtServices, gtSFPLink=gtSFPLink, gtDateAndTimeTable=gtDateAndTimeTable, gtNTPServerEntry=gtNTPServerEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkPortNumber=gtNetworkPortNumber, gtSwitch=gtSwitch, gtModuleBackupEntry=gtModuleBackupEntry, gtUserName=gtUserName, gtUserPassword=gtUserPassword, gtAccesslistTable=gtAccesslistTable, gtServicesEntry=gtServicesEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtHMSComMethod=gtHMSComMethod, gtUserAccesslist=gtUserAccesslist, gtNumSFP=gtNumSFP, gtSWOption=gtSWOption, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserRowStatus=gtUserRowStatus, gtUserTable=gtUserTable, gtAgentComReadString=gtAgentComReadString, gtDateAndTime=gtDateAndTime, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateFilesTable=gtUpdateFilesTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapComString=gtTrapComString, gtModuleBackupControl=gtModuleBackupControl, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleUpdate=gtModuleUpdate, gtPortsEntry=gtPortsEntry, gtAccesslistEntry=gtAccesslistEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtServicesTable=gtServicesTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSLAExpires=gtSLAExpires, gtSyslogEntry=gtSyslogEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5)
