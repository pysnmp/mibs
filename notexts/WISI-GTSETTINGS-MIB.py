...
TimeTicks, Unsigned32, Gauge32, MibIdentifier, iso, ModuleIdentity, IpAddress, Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Gauge32", "MibIdentifier", "iso", "ModuleIdentity", "IpAddress", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTimeZone=gtTimeZone, gtSyslogState=gtSyslogState, gtCurrentUserName=gtCurrentUserName, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupStatus=gtBackupStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSWOptionsTable=gtSWOptionsTable, gtPortsName=gtPortsName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAccesslistIdx=gtAccesslistIdx, gtAgentPort=gtAgentPort, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceSNMP=gtInterfaceSNMP, gtUserPassword=gtUserPassword, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtWebEnable=gtWebEnable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserGroup=gtUserGroup, gtPortsLinkup=gtPortsLinkup, gtSNMP=gtSNMP, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtAgentComReadString=gtAgentComReadString, gtTrapState=gtTrapState, gtServicesEntry=gtServicesEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtDNSServerIP=gtDNSServerIP, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceMAC=gtInterfaceMAC, gtFilename=gtFilename, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSWOptionsEntry=gtSWOptionsEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSNMPEntry=gtSNMPEntry, gtNTPServerEntry=gtNTPServerEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapDestIP=gtTrapDestIP, gtSFPLink=gtSFPLink, gtAgentState=gtAgentState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebAuth=gtWebAuth, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupTable=gtGroupTable, gtSLARegistered=gtSLARegistered, gtDateAndTimeTable=gtDateAndTimeTable, gtSNMPTable=gtSNMPTable, gtInterfaceState=gtInterfaceState, gtSettingsNotifications=gtSettingsNotifications, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSTable=gtHMSTable, gtPortsTable=gtPortsTable, gtUserTable=gtUserTable, gtPortsNumber=gtPortsNumber, gtGroupName=gtGroupName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupParamIdx=gtGroupParamIdx, gtNumSFP=gtNumSFP, gtSyslogTable=gtSyslogTable, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistName=gtAccesslistName, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAccesslist=gtUserAccesslist, gtModuleBackupDate=gtModuleBackupDate, gtSyslogIP=gtSyslogIP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSettingsCompliances=gtSettingsCompliances, gtHMSNumMembers=gtHMSNumMembers, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSEntry=gtHMSEntry, gtUserAuthTable=gtUserAuthTable, gtModuleUpdate=gtModuleUpdate, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNTPServerNumber=gtNTPServerNumber, gtSLAExpires=gtSLAExpires, gtUser=gtUser, gtNetworkPortState=gtNetworkPortState, gtSettingsMIB=gtSettingsMIB, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapDestNumber=gtTrapDestNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsEntry=gtPortsEntry, gtAccesslistTable=gtAccesslistTable, gtAccesslistEntry=gtAccesslistEntry, gtNetworkEntry=gtNetworkEntry, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtAgentComWriteString=gtAgentComWriteString, gtUserIdx=gtUserIdx, gtNetworkTable=gtNetworkTable, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsGroups=gtSettingsGroups, gtSLATable=gtSLATable, gtUserRowStatus=gtUserRowStatus, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIPv4=gtInterfaceIPv4, gtModuleBackup=gtModuleBackup, gtDNSNumber=gtDNSNumber, gtUserName=gtUserName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkName=gtNetworkName, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupRights=gtGroupRights, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthEntry=gtUserAuthEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTimeUTC=gtTimeUTC, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFPNumber=gtSFPNumber, gtSFPSpeed=gtSFPSpeed, gtSFPEntry=gtSFPEntry, gtTimeLocal=gtTimeLocal, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapDestTable=gtTrapDestTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortName=gtNetworkPortName, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestPort=gtTrapDestPort, gtGroupAccesslist=gtGroupAccesslist, gtGeneral=gtGeneral, gtInterfaceEntry=gtInterfaceEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtNetworking=gtNetworking, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceName=gtInterfaceName, gtInterfaceVLAN=gtInterfaceVLAN, gtBackupControl=gtBackupControl, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSWOption=gtSWOption, gtNTPServerTable=gtNTPServerTable, gtSFTPPassword=gtSFTPPassword, gtTrapUser=gtTrapUser, gtServices=gtServices, gtSwitch=gtSwitch, gtUpdateFile=gtUpdateFile, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPPlugged=gtSFPPlugged, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserEntry=gtUserEntry, gtDNSTable=gtDNSTable, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceTable=gtInterfaceTable, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateStatus=gtUpdateStatus, gtWebProtocol=gtWebProtocol, gtSettingsObjects=gtSettingsObjects, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSyslogEntry=gtSyslogEntry, gtModuleBackupControl=gtModuleBackupControl, gtSFPTable=gtSFPTable, gtSFTPServer=gtSFTPServer, gtSFTPPort=gtSFTPPort, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapPDU=gtTrapPDU, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupEntry=gtGroupEntry, gtSFTPUsername=gtSFTPUsername, gtUpdateFilesTable=gtUpdateFilesTable, gtDNSEntry=gtDNSEntry, gtServicesTable=gtServicesTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapComString=gtTrapComString, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtGroupIdx=gtGroupIdx, gtSFPType=gtSFPType, gtSLAEntry=gtSLAEntry, gtDateAndTime=gtDateAndTime, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateControl=gtUpdateControl, gtUserParamIdx=gtUserParamIdx, gtSettingsConformance=gtSettingsConformance)
