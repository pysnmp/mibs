...
NotificationType, Gauge32, Counter32, Unsigned32, Bits, IpAddress, iso, Integer32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "Unsigned32", "Bits", "IpAddress", "iso", "Integer32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNTPServerTable=gtNTPServerTable, gtUpdateStatus=gtUpdateStatus, gtServicesEntry=gtServicesEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtHeadendSystemManagement=gtHeadendSystemManagement, gtServices=gtServices, gtCurrentTimeSource=gtCurrentTimeSource, gtSWOption=gtSWOption, gtNetworkVLAN=gtNetworkVLAN, gtSFPSpeed=gtSFPSpeed, gtTrapPDU=gtTrapPDU, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupControl=gtModuleBackupControl, gtSFTPPort=gtSFTPPort, gtSFTPServer=gtSFTPServer, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapDestIP=gtTrapDestIP, gtUserAuthEnabled=gtUserAuthEnabled, gtSFPTable=gtSFPTable, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserPassword=gtUserPassword, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSGroupName=gtHMSGroupName, gtModuleBackupDate=gtModuleBackupDate, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceVLAN=gtInterfaceVLAN, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSLAExpires=gtSLAExpires, gtSFTPUsername=gtSFTPUsername, gtTrapUser=gtTrapUser, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPPassword=gtSFTPPassword, gtSettingsObjects=gtSettingsObjects, gtDateAndTimeTable=gtDateAndTimeTable, gtUserAuthEntry=gtUserAuthEntry, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceStreaming=gtInterfaceStreaming, gtPortsLinkup=gtPortsLinkup, gtSFPPlugged=gtSFPPlugged, gtDNSNumber=gtDNSNumber, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsNumber=gtPortsNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGroupIdx=gtGroupIdx, gtFilename=gtFilename, gtInterfaceNumber=gtInterfaceNumber, gtAgentComWriteString=gtAgentComWriteString, gtAgentState=gtAgentState, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackup=gtModuleBackup, gtSFPEntry=gtSFPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtSNMPTable=gtSNMPTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDNSEntry=gtDNSEntry, gtInterfaceState=gtInterfaceState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortName=gtNetworkPortName, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkEntry=gtNetworkEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSLARegistered=gtSLARegistered, gtUser=gtUser, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtGroupEntry=gtGroupEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserTable=gtUserTable, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceTable=gtInterfaceTable, gtHMSNumMembers=gtHMSNumMembers, gtBackupControl=gtBackupControl, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerAddress=gtNTPServerAddress, gtSettingsConformance=gtSettingsConformance, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupStatus=gtBackupStatus, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAccesslistName=gtAccesslistName, gtSyslogIP=gtSyslogIP, gtDNSTable=gtDNSTable, gtSFPLink=gtSFPLink, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDateAndTime=gtDateAndTime, gtSFPNumber=gtSFPNumber, gtAccesslistTable=gtAccesslistTable, gtNetworking=gtNetworking, gtNTPServerNumber=gtNTPServerNumber, gtSFPType=gtSFPType, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsNotifications=gtSettingsNotifications, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogState=gtSyslogState, gtUserGroup=gtUserGroup, gtGeneral=gtGeneral, gtUserIdx=gtUserIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsEntry=gtPortsEntry, gtNetworkTable=gtNetworkTable, gtTimeUTC=gtTimeUTC, gtGroupName=gtGroupName, gtInterfaceName=gtInterfaceName, gtSWOptionsTable=gtSWOptionsTable, gtSNMP=gtSNMP, gtDNSServerIP=gtDNSServerIP, gtSWOptionsEntry=gtSWOptionsEntry, gtSyslogTable=gtSyslogTable, gtWebEnable=gtWebEnable, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkName=gtNetworkName, gtInterfaceMAC=gtInterfaceMAC, gtSNMPEntry=gtSNMPEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserEntry=gtUserEntry, gtSLAEntry=gtSLAEntry, gtUserParamIdx=gtUserParamIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateControl=gtUpdateControl, gtInterfaceCLI=gtInterfaceCLI, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtHMSTable=gtHMSTable, gtAccesslistEntry=gtAccesslistEntry, gtWebAuth=gtWebAuth, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsTable=gtPortsTable, gtPortsName=gtPortsName, gtTimeLocal=gtTimeLocal, gtTrapState=gtTrapState, gtAccesslistIPRange=gtAccesslistIPRange, gtSLATable=gtSLATable, gtServicesTable=gtServicesTable, gtGroupTable=gtGroupTable, gtGroupRights=gtGroupRights, gtTrapDestPort=gtTrapDestPort, gtNumSFP=gtNumSFP, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsMIB=gtSettingsMIB, gtPortsBitrateReceive=gtPortsBitrateReceive, gtHMSComMethod=gtHMSComMethod, gtSyslogEntry=gtSyslogEntry, gtTimeZone=gtTimeZone, gtUserName=gtUserName, gtNetworkPortState=gtNetworkPortState, gtAccesslistIdx=gtAccesslistIdx, gtHMSEntry=gtHMSEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUpdateFile=gtUpdateFile, gtCurrentUserName=gtCurrentUserName, gtTrapComString=gtTrapComString, gtUserRowStatus=gtUserRowStatus, gtInterfaceEntry=gtInterfaceEntry, gtUserAccesslist=gtUserAccesslist, gtWebProtocol=gtWebProtocol, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentPort=gtAgentPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtGroupAccesslist=gtGroupAccesslist, gtNTPServerEntry=gtNTPServerEntry, gtChassisRedundancy=gtChassisRedundancy, PYSNMP_MODULE_ID=gtSettingsMIB, gtSettingsGroups=gtSettingsGroups, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSwitch=gtSwitch, gtGroupParamIdx=gtGroupParamIdx, gtAgentComReadString=gtAgentComReadString, gtInterfaceIPv4=gtInterfaceIPv4, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtTrapDestTable=gtTrapDestTable, gtAccesslistParamIdx=gtAccesslistParamIdx)
