...
Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Gauge32, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, iso, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Gauge32", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsTable=gtPortsTable, gtTrapComString=gtTrapComString, gtPortsLinkup=gtPortsLinkup, gtPortsEntry=gtPortsEntry, gtSettingsObjects=gtSettingsObjects, gtNetworkPortNumber=gtNetworkPortNumber, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtHMSGroupName=gtHMSGroupName, gtSWOptionsTable=gtSWOptionsTable, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapDestNumber=gtTrapDestNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthEnabled=gtUserAuthEnabled, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceEntry=gtInterfaceEntry, gtSettingsCompliances=gtSettingsCompliances, gtNetworkVLAN=gtNetworkVLAN, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleBackup=gtModuleBackup, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupControl=gtBackupControl, gtSNMP=gtSNMP, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkTable=gtNetworkTable, gtTrapState=gtTrapState, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceTable=gtInterfaceTable, gtSyslogIP=gtSyslogIP, gtTrapUser=gtTrapUser, gtTimeUTC=gtTimeUTC, gtSettingsConformance=gtSettingsConformance, gtNTPServerTable=gtNTPServerTable, gtPortsName=gtPortsName, gtUserParamIdx=gtUserParamIdx, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserIdx=gtUserIdx, gtWebProtocol=gtWebProtocol, gtNetworkPortState=gtNetworkPortState, gtTimeLocal=gtTimeLocal, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTimeZone=gtTimeZone, gtSFPLink=gtSFPLink, gtNTPServerNumber=gtNTPServerNumber, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtServices=gtServices, gtNumSFP=gtNumSFP, gtSyslogEntry=gtSyslogEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSwitch=gtSwitch, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserPassword=gtUserPassword, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAuthTable=gtUserAuthTable, gtSFTPPassword=gtSFTPPassword, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGroupEntry=gtGroupEntry, gtGroupTable=gtGroupTable, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserAuthEntry=gtUserAuthEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSTable=gtHMSTable, gtAccesslistTable=gtAccesslistTable, gtNetworkPortsTable=gtNetworkPortsTable, gtServicesEntry=gtServicesEntry, gtWebEnable=gtWebEnable, gtAgentComReadString=gtAgentComReadString, gtAgentComWriteString=gtAgentComWriteString, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapDestIP=gtTrapDestIP, gtAccesslistIdx=gtAccesslistIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSNumMembers=gtHMSNumMembers, gtDNSNumber=gtDNSNumber, gtNTPServerEntry=gtNTPServerEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAccesslistName=gtAccesslistName, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkEntry=gtNetworkEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFTPPort=gtSFTPPort, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupName=gtGroupName, gtSLAEntry=gtSLAEntry, gtNTPServerAddress=gtNTPServerAddress, gtUserRowStatus=gtUserRowStatus, gtUser=gtUser, gtSyslogState=gtSyslogState, gtDNSTable=gtDNSTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceMAC=gtInterfaceMAC, gtAgentPort=gtAgentPort, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUserName=gtUserName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkPortName=gtNetworkPortName, gtSLARegistered=gtSLARegistered, gtPortsBitrateReceive=gtPortsBitrateReceive, PYSNMP_MODULE_ID=gtSettingsMIB, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtModuleBackupDate=gtModuleBackupDate, gtSyslogTable=gtSyslogTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateControl=gtUpdateControl, gtDNSEntry=gtDNSEntry, gtSFTPServer=gtSFTPServer, gtDateAndTime=gtDateAndTime, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceNumber=gtInterfaceNumber, gtFilename=gtFilename, gtSFPEntry=gtSFPEntry, gtUserGroup=gtUserGroup, gtSWOptionsEntry=gtSWOptionsEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPSpeed=gtSFPSpeed, gtModuleBackupEntry=gtModuleBackupEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleBackupTable=gtModuleBackupTable, gtTrapDestPort=gtTrapDestPort, gtNetworking=gtNetworking, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSComMethod=gtHMSComMethod, gtGroupRights=gtGroupRights, gtModuleUpdate=gtModuleUpdate, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkName=gtNetworkName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSEntry=gtHMSEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAccesslist=gtUserAccesslist, gtGroupIdx=gtGroupIdx, gtUpdateFile=gtUpdateFile, gtPortsNumber=gtPortsNumber, gtWebAuth=gtWebAuth, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsMIB=gtSettingsMIB, gtSettingsNotifications=gtSettingsNotifications, gtUserTable=gtUserTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceName=gtInterfaceName, gtSNMPTable=gtSNMPTable, gtBackupStatus=gtBackupStatus, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPPlugged=gtSFPPlugged, gtInterfaceState=gtInterfaceState, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtGeneral=gtGeneral, gtSFPTable=gtSFPTable, gtSFPType=gtSFPType, gtServicesTable=gtServicesTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFPNumber=gtSFPNumber, gtCurrentUserName=gtCurrentUserName, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestTable=gtTrapDestTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapPDU=gtTrapPDU, gtSWOption=gtSWOption, gtAccesslistEntry=gtAccesslistEntry, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceCLI=gtInterfaceCLI, gtSettingsGroups=gtSettingsGroups, gtSLATable=gtSLATable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSNMPEntry=gtSNMPEntry, gtAgentState=gtAgentState, gtAccesslistIPRange=gtAccesslistIPRange, gtSLAExpires=gtSLAExpires, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserEntry=gtUserEntry)
