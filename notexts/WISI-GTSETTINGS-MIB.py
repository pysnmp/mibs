...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Counter32, Gauge32, Unsigned32, IpAddress, ModuleIdentity, ObjectIdentity, Bits, TimeTicks, Integer32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Counter32", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Bits", "TimeTicks", "Integer32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUser=gtUser, gtDNSTable=gtDNSTable, gtBackupSFTPPort=gtBackupSFTPPort, gtTrapState=gtTrapState, gtHMSTable=gtHMSTable, gtModuleBackupDate=gtModuleBackupDate, gtDNSNumber=gtDNSNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSyslogState=gtSyslogState, gtUpdateFile=gtUpdateFile, gtSFPType=gtSFPType, gtModuleBackupTable=gtModuleBackupTable, gtSyslogTable=gtSyslogTable, gtSFPPlugged=gtSFPPlugged, gtInterfaceTable=gtInterfaceTable, gtDateAndTimeTable=gtDateAndTimeTable, gtSLATable=gtSLATable, gtSFPSpeed=gtSFPSpeed, gtAccesslistTable=gtAccesslistTable, gtBackupStatus=gtBackupStatus, gtPortsEntry=gtPortsEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapUser=gtTrapUser, gtModuleBackupStatus=gtModuleBackupStatus, gtUserPassword=gtUserPassword, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDNSEntry=gtDNSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortState=gtNetworkPortState, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtCurrentUserName=gtCurrentUserName, gtTrapDestPort=gtTrapDestPort, gtUserAccesslist=gtUserAccesslist, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapDestEntry=gtTrapDestEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistEntry=gtAccesslistEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestNumber=gtTrapDestNumber, gtSFTPUsername=gtSFTPUsername, gtUpdateControl=gtUpdateControl, gtSLAExpires=gtSLAExpires, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceName=gtInterfaceName, gtInterfaceCLI=gtInterfaceCLI, gtAgentPort=gtAgentPort, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLARegistered=gtSLARegistered, gtTimeZone=gtTimeZone, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsGroups=gtSettingsGroups, gtUpdateStatus=gtUpdateStatus, gtServicesEntry=gtServicesEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPServer=gtSFTPServer, gtNetworkVLAN=gtNetworkVLAN, gtNetworkPortsTable=gtNetworkPortsTable, gtSettingsObjects=gtSettingsObjects, PYSNMP_MODULE_ID=gtSettingsMIB, gtModuleUpdate=gtModuleUpdate, gtInterfaceMAC=gtInterfaceMAC, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapDestTable=gtTrapDestTable, gtGroupIdx=gtGroupIdx, gtSyslogEntry=gtSyslogEntry, gtSNMP=gtSNMP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSLAEntry=gtSLAEntry, gtInterfaceNumber=gtInterfaceNumber, gtBackupControl=gtBackupControl, gtPortsNumber=gtPortsNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapPDU=gtTrapPDU, gtSNMPEntry=gtSNMPEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtNTPServerEntry=gtNTPServerEntry, gtDNSServerIP=gtDNSServerIP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSWOption=gtSWOption, gtWebProtocol=gtWebProtocol, gtUserName=gtUserName, gtSettingsNotifications=gtSettingsNotifications, gtUserGroup=gtUserGroup, gtModuleBackupEntry=gtModuleBackupEntry, gtNumSFP=gtNumSFP, gtInterfaceState=gtInterfaceState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTimeLocal=gtTimeLocal, gtSFPEntry=gtSFPEntry, gtModuleBackup=gtModuleBackup, gtNetworkTable=gtNetworkTable, gtPortsTable=gtPortsTable, gtSyslogIP=gtSyslogIP, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupTable=gtGroupTable, gtAgentComReadString=gtAgentComReadString, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserRowStatus=gtUserRowStatus, gtSWOptionsIdx=gtSWOptionsIdx, gtGeneral=gtGeneral, gtWebEnable=gtWebEnable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupEntry=gtGroupEntry, gtTrapComString=gtTrapComString, gtNTPServerAddress=gtNTPServerAddress, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDateAndTime=gtDateAndTime, gtGroupParamIdx=gtGroupParamIdx, gtNetworking=gtNetworking, gtHMSComMethod=gtHMSComMethod, gtHMSNumMembers=gtHMSNumMembers, gtSFTPPassword=gtSFTPPassword, gtPortsName=gtPortsName, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSEntry=gtHMSEntry, gtAccesslistName=gtAccesslistName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPLink=gtSFPLink, gtPortsLinkup=gtPortsLinkup, gtSettingsConformance=gtSettingsConformance, gtSettingsMIB=gtSettingsMIB, gtUserEntry=gtUserEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserIdx=gtUserIdx, gtNTPServerTable=gtNTPServerTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserParamIdx=gtUserParamIdx, gtSwitch=gtSwitch, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentState=gtAgentState, gtHMSGroupName=gtHMSGroupName, gtSFPNumber=gtSFPNumber, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceSNMP=gtInterfaceSNMP, gtCurrentTimeSource=gtCurrentTimeSource, gtUserAuthTable=gtUserAuthTable, gtNetworkName=gtNetworkName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIGMP=gtInterfaceIGMP, gtNTPServerNumber=gtNTPServerNumber, gtServicesTable=gtServicesTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkEntry=gtNetworkEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtUserAuthEntry=gtUserAuthEntry, gtTimeUTC=gtTimeUTC, gtTrapDestIP=gtTrapDestIP, gtServices=gtServices, gtGroupName=gtGroupName, gtNetworkPortName=gtNetworkPortName, gtAccesslistIPRange=gtAccesslistIPRange, gtGroupRights=gtGroupRights, gtGroupAccesslist=gtGroupAccesslist, gtSNMPTable=gtSNMPTable, gtInterfaceStreaming=gtInterfaceStreaming, gtFilename=gtFilename, gtInterfaceIPv4=gtInterfaceIPv4, gtWebAuth=gtWebAuth, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFTPPort=gtSFTPPort, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSWOptionsTable=gtSWOptionsTable, gtModuleBackupControl=gtModuleBackupControl, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPTable=gtSFPTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAgentComWriteString=gtAgentComWriteString, gtUserTable=gtUserTable, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortsEntry=gtNetworkPortsEntry)
