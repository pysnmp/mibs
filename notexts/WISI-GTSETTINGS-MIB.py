...
Bits, ModuleIdentity, MibIdentifier, Gauge32, NotificationType, iso, IpAddress, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibIdentifier", "Gauge32", "NotificationType", "iso", "IpAddress", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsLinkup=gtPortsLinkup, gtNetworkEntry=gtNetworkEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSyslogTable=gtSyslogTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsNumber=gtPortsNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleUpdate=gtModuleUpdate, gtTrapUser=gtTrapUser, gtInterfaceMAC=gtInterfaceMAC, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserName=gtUserName, gtSFPEntry=gtSFPEntry, gtGroupParamIdx=gtGroupParamIdx, gtSWOptionsTable=gtSWOptionsTable, gtAccesslistIPRange=gtAccesslistIPRange, gtAgentComReadString=gtAgentComReadString, gtAccesslistTable=gtAccesslistTable, gtTimeZone=gtTimeZone, gtGroupEntry=gtGroupEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceIfIndex=gtInterfaceIfIndex, gtHMSTable=gtHMSTable, gtUserParamIdx=gtUserParamIdx, gtSLATable=gtSLATable, gtNetworkTable=gtNetworkTable, gtModuleBackup=gtModuleBackup, gtUserAccesslist=gtUserAccesslist, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupEntry=gtModuleBackupEntry, gtFilename=gtFilename, gtInterfaceEntry=gtInterfaceEntry, gtSyslogEntry=gtSyslogEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTrapDestNumber=gtTrapDestNumber, gtSFTPServer=gtSFTPServer, gtServicesEntry=gtServicesEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtUpdateStatus=gtUpdateStatus, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceName=gtInterfaceName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkPortNumber=gtNetworkPortNumber, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestPort=gtTrapDestPort, gtSFTPUsername=gtSFTPUsername, gtSettingsConformance=gtSettingsConformance, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserGroup=gtUserGroup, gtSFPNumber=gtSFPNumber, gtSwitch=gtSwitch, gtGroupName=gtGroupName, gtWebEnable=gtWebEnable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtGroupTable=gtGroupTable, gtBackupStatus=gtBackupStatus, gtPortsEntry=gtPortsEntry, gtWebProtocol=gtWebProtocol, gtSLAEntry=gtSLAEntry, gtPortsTable=gtPortsTable, gtSFPType=gtSFPType, gtTimeLocal=gtTimeLocal, gtAccesslistIdx=gtAccesslistIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserEntry=gtUserEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNumSFP=gtNumSFP, gtSFTPPort=gtSFTPPort, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSNumber=gtDNSNumber, gtInterfaceTable=gtInterfaceTable, gtNetworkVLAN=gtNetworkVLAN, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPPort=gtBackupSFTPPort, gtDateAndTime=gtDateAndTime, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerAddress=gtNTPServerAddress, gtGroupRights=gtGroupRights, gtSWOption=gtSWOption, gtSLARegistered=gtSLARegistered, gtTrapSecurityLevel=gtTrapSecurityLevel, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupIdx=gtGroupIdx, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserTable=gtUserTable, gtGeneral=gtGeneral, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworking=gtNetworking, gtChassisRedundancy=gtChassisRedundancy, gtSyslogIP=gtSyslogIP, gtTrapPDU=gtTrapPDU, gtUserPassword=gtUserPassword, gtSFPSpeed=gtSFPSpeed, gtModuleBackupStatus=gtModuleBackupStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNTPServerTable=gtNTPServerTable, gtInterfaceIGMP=gtInterfaceIGMP, gtAgentPort=gtAgentPort, gtAgentComWriteString=gtAgentComWriteString, gtSettingsNotifications=gtSettingsNotifications, gtUserAuthEntry=gtUserAuthEntry, gtUser=gtUser, gtAccesslistName=gtAccesslistName, gtInterfaceState=gtInterfaceState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAgentState=gtAgentState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtWebAuth=gtWebAuth, gtSLAExpires=gtSLAExpires, gtSFPLink=gtSFPLink, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleBackupControl=gtModuleBackupControl, gtUserRowStatus=gtUserRowStatus, gtNTPServerNumber=gtNTPServerNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateControl=gtUpdateControl, gtTimeUTC=gtTimeUTC, gtTrapComString=gtTrapComString, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFTPPassword=gtSFTPPassword, gtInterfaceVLAN=gtInterfaceVLAN, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtDNSServerIP=gtDNSServerIP, gtHMSEntry=gtHMSEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsObjects=gtSettingsObjects, gtUserIdx=gtUserIdx, gtSettingsCompliances=gtSettingsCompliances, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtDNSEntry=gtDNSEntry, gtSyslogState=gtSyslogState, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceWebMgt=gtInterfaceWebMgt, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtServicesTable=gtServicesTable, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestIP=gtTrapDestIP, gtPortsName=gtPortsName, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortName=gtNetworkPortName, gtServices=gtServices, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortState=gtNetworkPortState, gtDNSTable=gtDNSTable, gtNetworkName=gtNetworkName, gtHMSNumMembers=gtHMSNumMembers, gtDaylightAdjustment=gtDaylightAdjustment, gtSNMPEntry=gtSNMPEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTrapDestTable=gtTrapDestTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtHMSComMethod=gtHMSComMethod, gtSettingsGroups=gtSettingsGroups, gtTrapState=gtTrapState, gtNTPServerEntry=gtNTPServerEntry, gtGroupAccesslist=gtGroupAccesslist, gtCurrentUserName=gtCurrentUserName, gtUserAuthTable=gtUserAuthTable, gtSNMPTable=gtSNMPTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSGroupName=gtHMSGroupName, gtUpdateFile=gtUpdateFile, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtModuleBackupTable=gtModuleBackupTable, gtSFPTable=gtSFPTable, gtBackupControl=gtBackupControl, gtSFPPlugged=gtSFPPlugged, gtSettingsMIB=gtSettingsMIB, gtSNMP=gtSNMP)
