...
Counter32, IpAddress, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, ModuleIdentity, Gauge32, Unsigned32, iso, NotificationType, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "ModuleIdentity", "Gauge32", "Unsigned32", "iso", "NotificationType", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortName=gtNetworkPortName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPPort=gtBackupSFTPPort, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFPNumber=gtSFPNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceSNMP=gtInterfaceSNMP, gtUserTable=gtUserTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceNumber=gtInterfaceNumber, gtSettingsCompliances=gtSettingsCompliances, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupControl=gtBackupControl, gtAccesslistTable=gtAccesslistTable, gtHMSEntry=gtHMSEntry, gtUpdateStatus=gtUpdateStatus, gtSFTPUsername=gtSFTPUsername, gtPortsLinkup=gtPortsLinkup, gtUser=gtUser, gtAgentComWriteString=gtAgentComWriteString, gtPortsNumber=gtPortsNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserName=gtUserName, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFPType=gtSFPType, gtInterfaceStreaming=gtInterfaceStreaming, gtSLAExpires=gtSLAExpires, gtSNMPEntry=gtSNMPEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPEntry=gtSFPEntry, gtSFPLink=gtSFPLink, gtNetworkPortNumber=gtNetworkPortNumber, gtUserIdx=gtUserIdx, gtUpdateFile=gtUpdateFile, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceIfIndex=gtInterfaceIfIndex, gtModuleUpdate=gtModuleUpdate, gtFilename=gtFilename, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtGeneral=gtGeneral, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSLARegistered=gtSLARegistered, gtUserEntry=gtUserEntry, gtTrapDestTable=gtTrapDestTable, gtGroupAccesslist=gtGroupAccesslist, gtHMSComMethod=gtHMSComMethod, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFTPPort=gtSFTPPort, gtAccesslistIPRange=gtAccesslistIPRange, gtNTPServerTable=gtNTPServerTable, gtDateAndTimeTable=gtDateAndTimeTable, gtWebEnable=gtWebEnable, gtBackupStatus=gtBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNTPServerAddress=gtNTPServerAddress, gtModuleBackup=gtModuleBackup, gtHMSTable=gtHMSTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtNumSFP=gtNumSFP, gtGroupIdx=gtGroupIdx, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceIGMP=gtInterfaceIGMP, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsConformance=gtSettingsConformance, gtUserPassword=gtUserPassword, gtPortsName=gtPortsName, gtUserGroup=gtUserGroup, gtSWOption=gtSWOption, PYSNMP_MODULE_ID=gtSettingsMIB, gtSLAEntry=gtSLAEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupTable=gtModuleBackupTable, gtTrapState=gtTrapState, gtSettingsMIB=gtSettingsMIB, gtSFTPPassword=gtSFTPPassword, gtSFTPServer=gtSFTPServer, gtSettingsObjects=gtSettingsObjects, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtServicesTable=gtServicesTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsNotifications=gtSettingsNotifications, gtTrapPDU=gtTrapPDU, gtChassisRedundancy=gtChassisRedundancy, gtAccesslistEntry=gtAccesslistEntry, gtPortsEntry=gtPortsEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAccesslistName=gtAccesslistName, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDNSNumber=gtDNSNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserParamIdx=gtUserParamIdx, gtNetworkTable=gtNetworkTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupTable=gtGroupTable, gtCurrentUserName=gtCurrentUserName, gtTrapUser=gtTrapUser, gtAgentPort=gtAgentPort, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkPortState=gtNetworkPortState, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceTable=gtInterfaceTable, gtSFPSpeed=gtSFPSpeed, gtNetworkPortsEntry=gtNetworkPortsEntry, gtTimeZone=gtTimeZone, gtUserAuthTable=gtUserAuthTable, gtGroupRights=gtGroupRights, gtGroupEntry=gtGroupEntry, gtUserAccesslist=gtUserAccesslist, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSyslogIP=gtSyslogIP, gtUserRowStatus=gtUserRowStatus, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUpdateControl=gtUpdateControl, gtInterfaceCLI=gtInterfaceCLI, gtSyslogTable=gtSyslogTable, gtDateAndTime=gtDateAndTime, gtSNMP=gtSNMP, gtModuleBackupControl=gtModuleBackupControl, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtGroupName=gtGroupName, gtSLATable=gtSLATable, gtTrapComString=gtTrapComString, gtDNSServerIP=gtDNSServerIP, gtAgentSecurityLevel=gtAgentSecurityLevel, gtServices=gtServices, gtTrapDestPort=gtTrapDestPort, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSNMPTable=gtSNMPTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAgentState=gtAgentState, gtTimeLocal=gtTimeLocal, gtUserAuthEntry=gtUserAuthEntry, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceMAC=gtInterfaceMAC, gtSFPPlugged=gtSFPPlugged, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceName=gtInterfaceName, gtNetworking=gtNetworking, gtWebAuth=gtWebAuth, gtNTPServerEntry=gtNTPServerEntry, gtSFPTable=gtSFPTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleBackupStatus=gtModuleBackupStatus, gtSWOptionsTable=gtSWOptionsTable, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsTable=gtPortsTable, gtDNSTable=gtDNSTable, gtNTPServerNumber=gtNTPServerNumber, gtSyslogEntry=gtSyslogEntry, gtAgentComReadString=gtAgentComReadString, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkEntry=gtNetworkEntry, gtTrapDestNumber=gtTrapDestNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSEntry=gtDNSEntry, gtAccesslistIdx=gtAccesslistIdx, gtSyslogState=gtSyslogState, gtServicesEntry=gtServicesEntry, gtNetworkName=gtNetworkName, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceIPv4=gtInterfaceIPv4, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtWebProtocol=gtWebProtocol, gtTimeUTC=gtTimeUTC, gtSettingsGroups=gtSettingsGroups, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkVLAN=gtNetworkVLAN, gtGroupParamIdx=gtGroupParamIdx, gtSwitch=gtSwitch, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSGroupName=gtHMSGroupName, gtInterfaceState=gtInterfaceState)
