...
Unsigned32, Gauge32, iso, Bits, TimeTicks, Counter32, ObjectIdentity, MibIdentifier, Counter64, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "iso", "Bits", "TimeTicks", "Counter32", "ObjectIdentity", "MibIdentifier", "Counter64", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPNumber=gtSFPNumber, gtTrapDestIP=gtTrapDestIP, gtModuleUpdate=gtModuleUpdate, gtDNSTable=gtDNSTable, gtInterfaceNumber=gtInterfaceNumber, gtNetworkTable=gtNetworkTable, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateControl=gtUpdateControl, gtSNMP=gtSNMP, gtModuleBackupDate=gtModuleBackupDate, gtSFTPServer=gtSFTPServer, gtTimeUTC=gtTimeUTC, gtNetworking=gtNetworking, gtNTPServerTable=gtNTPServerTable, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIGMP=gtInterfaceIGMP, gtSFTPUsername=gtSFTPUsername, gtUserAccesslist=gtUserAccesslist, gtSNMPTable=gtSNMPTable, gtSFPEntry=gtSFPEntry, gtModuleBackupControl=gtModuleBackupControl, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUpdateFile=gtUpdateFile, gtUserRowStatus=gtUserRowStatus, gtUserAuthEntry=gtUserAuthEntry, gtUser=gtUser, gtGroupIdx=gtGroupIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPPort=gtSFTPPort, gtWebProtocol=gtWebProtocol, gtPortsTable=gtPortsTable, gtPortsNumber=gtPortsNumber, gtUserEntry=gtUserEntry, gtNTPServerAddress=gtNTPServerAddress, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSEntry=gtHMSEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkEntry=gtNetworkEntry, gtTrapPDU=gtTrapPDU, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworkPortState=gtNetworkPortState, gtInterfaceCLI=gtInterfaceCLI, gtDateAndTime=gtDateAndTime, gtSettingsMIB=gtSettingsMIB, gtTrapDestNumber=gtTrapDestNumber, gtCurrentUserName=gtCurrentUserName, gtSettingsNotifications=gtSettingsNotifications, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsEntry=gtPortsEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentState=gtAgentState, gtHMSComMethod=gtHMSComMethod, gtAccesslistTable=gtAccesslistTable, gtTrapDestTable=gtTrapDestTable, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupControl=gtBackupControl, gtUpdateStatus=gtUpdateStatus, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupEntry=gtGroupEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDNSEntry=gtDNSEntry, gtAccesslistEntry=gtAccesslistEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebAuth=gtWebAuth, gtTrapUser=gtTrapUser, gtGroupRights=gtGroupRights, gtBackupStatus=gtBackupStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAgentComWriteString=gtAgentComWriteString, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistName=gtAccesslistName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtServices=gtServices, gtNetworkName=gtNetworkName, gtSLARegistered=gtSLARegistered, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPTable=gtSFPTable, gtWebEnable=gtWebEnable, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAuthTable=gtUserAuthTable, gtAgentComReadString=gtAgentComReadString, gtUserName=gtUserName, gtSyslogEntry=gtSyslogEntry, gtSettingsConformance=gtSettingsConformance, gtSFPType=gtSFPType, gtSWOption=gtSWOption, gtHMSTable=gtHMSTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapState=gtTrapState, gtModuleBackupEntry=gtModuleBackupEntry, gtAccesslistIdx=gtAccesslistIdx, gtFilename=gtFilename, gtGroupAccesslist=gtGroupAccesslist, gtUserAuthEnabled=gtUserAuthEnabled, gtAgentPort=gtAgentPort, gtInterfaceEntry=gtInterfaceEntry, gtSettingsObjects=gtSettingsObjects, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceName=gtInterfaceName, gtSyslogTable=gtSyslogTable, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkPortName=gtNetworkPortName, gtGroupName=gtGroupName, gtPortsLinkup=gtPortsLinkup, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSwitch=gtSwitch, gtSWOptionsTable=gtSWOptionsTable, gtServicesTable=gtServicesTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, PYSNMP_MODULE_ID=gtSettingsMIB, gtSettingsCompliances=gtSettingsCompliances, gtPortsName=gtPortsName, gtNTPServerNumber=gtNTPServerNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceTable=gtInterfaceTable, gtNetworkVLAN=gtNetworkVLAN, gtUserTable=gtUserTable, gtNumSFP=gtNumSFP, gtTrapComString=gtTrapComString, gtDNSServerIP=gtDNSServerIP, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSyslogState=gtSyslogState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTimeZone=gtTimeZone, gtUserGroup=gtUserGroup, gtSNMPEntry=gtSNMPEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserParamIdx=gtUserParamIdx, gtUserPassword=gtUserPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtSLATable=gtSLATable, gtSLAExpires=gtSLAExpires, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDNSNumber=gtDNSNumber, gtSFTPPassword=gtSFTPPassword, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPServer=gtBackupSFTPServer, gtUserIdx=gtUserIdx, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtAccesslistIPRange=gtAccesslistIPRange, gtTimeLocal=gtTimeLocal, gtNetworkPortVLAN=gtNetworkPortVLAN, gtModuleBackup=gtModuleBackup, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPLink=gtSFPLink, gtSFPPlugged=gtSFPPlugged, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtServicesEntry=gtServicesEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPSpeed=gtSFPSpeed, gtSyslogIP=gtSyslogIP, gtInterfaceState=gtInterfaceState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupTable=gtGroupTable, gtTrapDestEntry=gtTrapDestEntry, gtHMSGroupName=gtHMSGroupName, gtSWOptionsIdx=gtSWOptionsIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGeneral=gtGeneral, gtTrapDestPort=gtTrapDestPort, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSLAEntry=gtSLAEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSNumMembers=gtHMSNumMembers)
