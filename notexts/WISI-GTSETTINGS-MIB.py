...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, IpAddress, Bits, TimeTicks, ObjectIdentity, Counter32, Counter64, MibIdentifier, iso, Gauge32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "IpAddress", "Bits", "TimeTicks", "ObjectIdentity", "Counter32", "Counter64", "MibIdentifier", "iso", "Gauge32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortState=gtNetworkPortState, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSComMethod=gtHMSComMethod, gtPortsTable=gtPortsTable, gtServicesTable=gtServicesTable, gtAccesslistEntry=gtAccesslistEntry, gtModuleUpdate=gtModuleUpdate, gtUpdateControl=gtUpdateControl, gtSNMP=gtSNMP, gtNetworkVLAN=gtNetworkVLAN, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtWebAuth=gtWebAuth, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFTPServer=gtSFTPServer, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtDNSEntry=gtDNSEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtSyslogEntry=gtSyslogEntry, gtNTPServerNumber=gtNTPServerNumber, gtPortsName=gtPortsName, gtAccesslistIdx=gtAccesslistIdx, gtTrapComString=gtTrapComString, gtUserGroup=gtUserGroup, gtBackupStatus=gtBackupStatus, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestIP=gtTrapDestIP, gtModuleBackupDate=gtModuleBackupDate, gtSFPSpeed=gtSFPSpeed, gtBackupSFTPServer=gtBackupSFTPServer, gtGeneral=gtGeneral, gtHMSTable=gtHMSTable, gtSFPType=gtSFPType, gtNumSFP=gtNumSFP, gtDaylightAdjustment=gtDaylightAdjustment, gtSNMPEntry=gtSNMPEntry, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtDNSTable=gtDNSTable, gtSFPPlugged=gtSFPPlugged, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateFile=gtUpdateFile, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSWOption=gtSWOption, gtHMSEntry=gtHMSEntry, gtWebProtocol=gtWebProtocol, gtGroupIdx=gtGroupIdx, gtAgentState=gtAgentState, gtSyslogIP=gtSyslogIP, gtUpdateFilesTable=gtUpdateFilesTable, gtUserRowStatus=gtUserRowStatus, gtTimeLocal=gtTimeLocal, gtAgentPort=gtAgentPort, gtAgentComReadString=gtAgentComReadString, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserAuthTable=gtUserAuthTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapDestNumber=gtTrapDestNumber, gtSWOptionsIdx=gtSWOptionsIdx, gtChassisRedundancy=gtChassisRedundancy, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistTable=gtAccesslistTable, gtSettingsNotifications=gtSettingsNotifications, gtTrapPDU=gtTrapPDU, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortName=gtNetworkPortName, gtDNSNumber=gtDNSNumber, gtHMSNumMembers=gtHMSNumMembers, gtModuleBackup=gtModuleBackup, gtTrapDestPort=gtTrapDestPort, gtGroupRights=gtGroupRights, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkTable=gtNetworkTable, gtSLAEntry=gtSLAEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPUsername=gtSFTPUsername, gtBackupControl=gtBackupControl, gtGroupTable=gtGroupTable, gtServicesEntry=gtServicesEntry, gtGroupName=gtGroupName, gtInterfaceTable=gtInterfaceTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPLink=gtSFPLink, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceStreaming=gtInterfaceStreaming, gtUserParamIdx=gtUserParamIdx, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGroupParamIdx=gtGroupParamIdx, gtSFTPPort=gtSFTPPort, gtTrapDestTable=gtTrapDestTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceState=gtInterfaceState, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsConformance=gtSettingsConformance, gtSLAExpires=gtSLAExpires, gtSNMPTable=gtSNMPTable, gtNetworkName=gtNetworkName, gtTrapDestEntry=gtTrapDestEntry, gtSLATable=gtSLATable, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerEntry=gtNTPServerEntry, gtSettingsObjects=gtSettingsObjects, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPNumber=gtSFPNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleBackupControl=gtModuleBackupControl, gtWebEnable=gtWebEnable, gtSettingsCompliances=gtSettingsCompliances, gtSettingsMIB=gtSettingsMIB, gtPortsEntry=gtPortsEntry, gtInterfaceName=gtInterfaceName, gtTimeZone=gtTimeZone, gtTimeUTC=gtTimeUTC, gtSFPEntry=gtSFPEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4=gtInterfaceIPv4, gtCurrentUserName=gtCurrentUserName, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerRowStatus=gtNTPServerRowStatus, gtServices=gtServices, gtModuleBackupTable=gtModuleBackupTable, gtNTPServerTable=gtNTPServerTable, gtHMSGroupName=gtHMSGroupName, gtSyslogTable=gtSyslogTable, gtUserEntry=gtUserEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtAgentComWriteString=gtAgentComWriteString, gtSFPTable=gtSFPTable, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSServerIP=gtDNSServerIP, gtNetworking=gtNetworking, gtUserAuthEntry=gtUserAuthEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUpdateStatus=gtUpdateStatus, gtSwitch=gtSwitch, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapState=gtTrapState, gtUserTable=gtUserTable, gtUserAccesslist=gtUserAccesslist, gtSWOptionsTable=gtSWOptionsTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserName=gtUserName, gtPortsLinkup=gtPortsLinkup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceEntry=gtInterfaceEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistIPRange=gtAccesslistIPRange, gtNTPServerAddress=gtNTPServerAddress, gtSFTPPassword=gtSFTPPassword, gtPortsNumber=gtPortsNumber, gtGroupAccesslist=gtGroupAccesslist, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserIdx=gtUserIdx, gtSettingsGroups=gtSettingsGroups, gtNetworkEntry=gtNetworkEntry, gtTrapUser=gtTrapUser, gtSLARegistered=gtSLARegistered, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupEntry=gtGroupEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtFilename=gtFilename, gtUser=gtUser, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, PYSNMP_MODULE_ID=gtSettingsMIB, gtSyslogState=gtSyslogState, gtInterfaceCLI=gtInterfaceCLI, gtUserPassword=gtUserPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAccesslistName=gtAccesslistName)
