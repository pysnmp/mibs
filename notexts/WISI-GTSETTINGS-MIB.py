...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Counter32, NotificationType, IpAddress, Unsigned32, Gauge32, ObjectIdentity, MibIdentifier, ModuleIdentity, TimeTicks, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Counter32", "NotificationType", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter64", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPPort=gtSFTPPort, gtGeneral=gtGeneral, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkPortName=gtNetworkPortName, gtSFPPlugged=gtSFPPlugged, gtTrapState=gtTrapState, gtModuleBackupEntry=gtModuleBackupEntry, gtAccesslistIdx=gtAccesslistIdx, gtTrapDestIP=gtTrapDestIP, gtGroupParamIdx=gtGroupParamIdx, gtSFPEntry=gtSFPEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupSFTPPort=gtBackupSFTPPort, gtTrapComString=gtTrapComString, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkVLAN=gtNetworkVLAN, gtSettingsGroups=gtSettingsGroups, gtSFPSpeed=gtSFPSpeed, gtModuleBackupControl=gtModuleBackupControl, gtBackupControl=gtBackupControl, gtDNSTable=gtDNSTable, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIPv4=gtInterfaceIPv4, gtChassisRedundancy=gtChassisRedundancy, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkName=gtNetworkName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTimeLocal=gtTimeLocal, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFTPPassword=gtSFTPPassword, gtTrapPDU=gtTrapPDU, gtSLATable=gtSLATable, gtUserAuthEnabled=gtUserAuthEnabled, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAgentState=gtAgentState, gtSwitch=gtSwitch, gtServicesEntry=gtServicesEntry, gtNetworkTable=gtNetworkTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsNotifications=gtSettingsNotifications, gtSFTPServer=gtSFTPServer, gtUserAuthTable=gtUserAuthTable, gtPortsLinkup=gtPortsLinkup, gtTrapDestPort=gtTrapDestPort, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPNumber=gtSFPNumber, gtSNMPEntry=gtSNMPEntry, gtUserTable=gtUserTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSTable=gtHMSTable, gtWebEnable=gtWebEnable, gtCurrentTimeSource=gtCurrentTimeSource, gtDateAndTimeTable=gtDateAndTimeTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNTPServerAddress=gtNTPServerAddress, gtModuleBackupStatus=gtModuleBackupStatus, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserAccesslist=gtUserAccesslist, gtInterfaceNumber=gtInterfaceNumber, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHMSGroupName=gtHMSGroupName, gtNetworkPortState=gtNetworkPortState, gtHMSComMethod=gtHMSComMethod, gtUserGroup=gtUserGroup, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPTable=gtSFPTable, gtSFPLink=gtSFPLink, gtSLAExpires=gtSLAExpires, gtServices=gtServices, gtDaylightAdjustment=gtDaylightAdjustment, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceName=gtInterfaceName, gtUpdateStatus=gtUpdateStatus, gtUser=gtUser, gtHMSEntry=gtHMSEntry, gtSLAEntry=gtSLAEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapUser=gtTrapUser, gtSettingsMIB=gtSettingsMIB, gtPortsNumber=gtPortsNumber, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAgentPort=gtAgentPort, gtInterfaceSNMP=gtInterfaceSNMP, gtSyslogIP=gtSyslogIP, gtSWOption=gtSWOption, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtModuleUpdate=gtModuleUpdate, gtSLARegistered=gtSLARegistered, gtAgentComReadString=gtAgentComReadString, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsEntry=gtPortsEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsName=gtPortsName, gtWebProtocol=gtWebProtocol, gtNetworkPortNumber=gtNetworkPortNumber, gtUserIdx=gtUserIdx, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistEntry=gtAccesslistEntry, gtSFTPUsername=gtSFTPUsername, gtInterfaceTable=gtInterfaceTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupTable=gtGroupTable, gtHMSNumMembers=gtHMSNumMembers, gtGroupName=gtGroupName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkEntry=gtNetworkEntry, gtGroupRights=gtGroupRights, gtSNMPTable=gtSNMPTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserName=gtUserName, gtBackupStatus=gtBackupStatus, gtUserRowStatus=gtUserRowStatus, gtSettingsObjects=gtSettingsObjects, gtDateAndTimeEntry=gtDateAndTimeEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUpdateFile=gtUpdateFile, gtNetworking=gtNetworking, gtSNMP=gtSNMP, gtTimeUTC=gtTimeUTC, gtUpdateControl=gtUpdateControl, gtUserParamIdx=gtUserParamIdx, gtNTPServerTable=gtNTPServerTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestEntry=gtTrapDestEntry, gtDNSNumber=gtDNSNumber, gtCurrentUserName=gtCurrentUserName, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceState=gtInterfaceState, gtUserEntry=gtUserEntry, gtUserAuthEntry=gtUserAuthEntry, gtSWOptionsTable=gtSWOptionsTable, gtAccesslistTable=gtAccesslistTable, gtInterfaceCLI=gtInterfaceCLI, gtFilename=gtFilename, gtSettingsConformance=gtSettingsConformance, gtTrapDestTable=gtTrapDestTable, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackup=gtModuleBackup, gtDNSServerIP=gtDNSServerIP, gtPortsTable=gtPortsTable, gtNumSFP=gtNumSFP, gtAgentComWriteString=gtAgentComWriteString, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupEntry=gtGroupEntry, gtSFPType=gtSFPType, gtInterfaceVLAN=gtInterfaceVLAN, gtAccesslistParamIdx=gtAccesslistParamIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAgentSecurityLevel=gtAgentSecurityLevel, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserPassword=gtUserPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTimeZone=gtTimeZone, gtGroupIdx=gtGroupIdx, gtSyslogTable=gtSyslogTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAccesslistName=gtAccesslistName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtWebAuth=gtWebAuth, gtServicesTable=gtServicesTable, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceMAC=gtInterfaceMAC, gtGroupAccesslist=gtGroupAccesslist, gtSettingsCompliances=gtSettingsCompliances, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSyslogEntry=gtSyslogEntry, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceEntry=gtInterfaceEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSyslogState=gtSyslogState, gtDNSEntry=gtDNSEntry, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceWebMgt=gtInterfaceWebMgt)
