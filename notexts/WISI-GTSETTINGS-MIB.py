...
NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Unsigned32, iso, TimeTicks, Counter32, ModuleIdentity, Integer32, IpAddress, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Unsigned32", "iso", "TimeTicks", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkEntry=gtNetworkEntry, gtUserParamIdx=gtUserParamIdx, gtUpdateStatus=gtUpdateStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateControl=gtUpdateControl, gtSyslogTable=gtSyslogTable, gtPortsTable=gtPortsTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtWebEnable=gtWebEnable, gtSFTPPassword=gtSFTPPassword, PYSNMP_MODULE_ID=gtSettingsMIB, gtSwitch=gtSwitch, gtTrapDestPort=gtTrapDestPort, gtBackupControl=gtBackupControl, gtCurrentUserName=gtCurrentUserName, gtSettingsMIB=gtSettingsMIB, gtSFTPUsername=gtSFTPUsername, gtNetworking=gtNetworking, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleBackup=gtModuleBackup, gtUserRowStatus=gtUserRowStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPNumber=gtSFPNumber, gtDaylightAdjustment=gtDaylightAdjustment, gtModuleBackupEntry=gtModuleBackupEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtSyslogEntry=gtSyslogEntry, gtHMSTable=gtHMSTable, gtWebAuth=gtWebAuth, gtHMSGroupName=gtHMSGroupName, gtNetworkPortsTable=gtNetworkPortsTable, gtUserPassword=gtUserPassword, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupTable=gtGroupTable, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapComString=gtTrapComString, gtGroupEntry=gtGroupEntry, gtAccesslistEntry=gtAccesslistEntry, gtPortsLinkup=gtPortsLinkup, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSEntry=gtHMSEntry, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkVLAN=gtNetworkVLAN, gtSLARegistered=gtSLARegistered, gtGroupIdx=gtGroupIdx, gtFilename=gtFilename, gtGroupRights=gtGroupRights, gtTimeZone=gtTimeZone, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkTable=gtNetworkTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtTimeLocal=gtTimeLocal, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPTable=gtSFPTable, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsConformance=gtSettingsConformance, gtTrapPDU=gtTrapPDU, gtTrapUser=gtTrapUser, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAgentComReadString=gtAgentComReadString, gtUserAuthEnabled=gtUserAuthEnabled, gtTimeUTC=gtTimeUTC, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceName=gtInterfaceName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSNMPEntry=gtSNMPEntry, gtNetworkPortName=gtNetworkPortName, gtSFPPlugged=gtSFPPlugged, gtUserName=gtUserName, gtInterfaceState=gtInterfaceState, gtSFPType=gtSFPType, gtSyslogIP=gtSyslogIP, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupAccesslist=gtGroupAccesslist, gtSWOptionsEntry=gtSWOptionsEntry, gtUserAccesslist=gtUserAccesslist, gtSNMP=gtSNMP, gtAccesslistIdx=gtAccesslistIdx, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPServer=gtBackupSFTPServer, gtDNSNumber=gtDNSNumber, gtGeneral=gtGeneral, gtUser=gtUser, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSettingsObjects=gtSettingsObjects, gtUserAuthEntry=gtUserAuthEntry, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtUserIdx=gtUserIdx, gtInterfaceMAC=gtInterfaceMAC, gtSWOptionsTable=gtSWOptionsTable, gtTrapState=gtTrapState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupTable=gtModuleBackupTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserEntry=gtUserEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPServer=gtSFTPServer, gtUpdateFile=gtUpdateFile, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSLATable=gtSLATable, gtDNSTable=gtDNSTable, gtAgentState=gtAgentState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsEntry=gtPortsEntry, gtGroupName=gtGroupName, gtUserTable=gtUserTable, gtNetworkPortState=gtNetworkPortState, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestTable=gtTrapDestTable, gtBackupSFTPPort=gtBackupSFTPPort, gtModuleUpdate=gtModuleUpdate, gtSLAEntry=gtSLAEntry, gtSNMPTable=gtSNMPTable, gtWebProtocol=gtWebProtocol, gtPortsName=gtPortsName, gtTrapDestNumber=gtTrapDestNumber, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAccesslistName=gtAccesslistName, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDNSServerIP=gtDNSServerIP, gtAccesslistTable=gtAccesslistTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSyslogState=gtSyslogState, gtSettingsNotifications=gtSettingsNotifications, gtUserAuthTable=gtUserAuthTable, gtSFPLink=gtSFPLink, gtPortsNumber=gtPortsNumber, gtNumSFP=gtNumSFP, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupControl=gtModuleBackupControl, gtSLAExpires=gtSLAExpires, gtSFPSpeed=gtSFPSpeed, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSEntry=gtDNSEntry, gtUserGroup=gtUserGroup, gtDateAndTime=gtDateAndTime, gtNetworkPortNumber=gtNetworkPortNumber, gtAgentComWriteString=gtAgentComWriteString, gtAgentPort=gtAgentPort, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapDestIP=gtTrapDestIP, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTrapDestEntry=gtTrapDestEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSWOption=gtSWOption, gtInterfaceTable=gtInterfaceTable, gtServicesEntry=gtServicesEntry, gtNetworkName=gtNetworkName, gtSettingsGroups=gtSettingsGroups, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtBackupStatus=gtBackupStatus, gtServicesTable=gtServicesTable, gtSFTPPort=gtSFTPPort, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceNumber=gtInterfaceNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPEntry=gtSFPEntry, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtServices=gtServices, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNTPServerTable=gtNTPServerTable, gtPortsFloodMulticast=gtPortsFloodMulticast)
