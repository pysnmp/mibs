...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter32, Unsigned32, MibIdentifier, IpAddress, TimeTicks, Bits, NotificationType, Gauge32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter32", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "Bits", "NotificationType", "Gauge32", "Counter64", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOption=gtSWOption, gtServices=gtServices, gtTrapComString=gtTrapComString, gtHeadendSystemManagement=gtHeadendSystemManagement, gtWebAuth=gtWebAuth, gtPortsTable=gtPortsTable, gtInterfaceState=gtInterfaceState, gtTrapDestIP=gtTrapDestIP, gtModuleBackupControl=gtModuleBackupControl, gtGroupAccesslist=gtGroupAccesslist, gtSyslogState=gtSyslogState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapDestTable=gtTrapDestTable, gtTrapDestNumber=gtTrapDestNumber, gtFilename=gtFilename, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceCLI=gtInterfaceCLI, gtBackupStatus=gtBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUserRowStatus=gtUserRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsNumber=gtPortsNumber, gtSLAEntry=gtSLAEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPServer=gtSFTPServer, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAgentComReadString=gtAgentComReadString, gtDaylightAdjustment=gtDaylightAdjustment, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceEntry=gtInterfaceEntry, gtGroupTable=gtGroupTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtIGMPQueryInterval=gtIGMPQueryInterval, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUserParamIdx=gtUserParamIdx, gtAccesslistTable=gtAccesslistTable, gtSLATable=gtSLATable, gtSFPTable=gtSFPTable, gtSFPPlugged=gtSFPPlugged, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTimeLocal=gtTimeLocal, gtWebEnable=gtWebEnable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtDNSTable=gtDNSTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNetworkPortState=gtNetworkPortState, gtGroupRights=gtGroupRights, gtSFTPPort=gtSFTPPort, gtSLAExpires=gtSLAExpires, gtSyslogEntry=gtSyslogEntry, gtNetworkTable=gtNetworkTable, gtNetworking=gtNetworking, gtSwitch=gtSwitch, gtInterfaceTable=gtInterfaceTable, gtAccesslistIPRange=gtAccesslistIPRange, gtUserAuthTable=gtUserAuthTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsMIB=gtSettingsMIB, gtModuleBackup=gtModuleBackup, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtDateAndTime=gtDateAndTime, gtServicesEntry=gtServicesEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceName=gtInterfaceName, gtUpdateControl=gtUpdateControl, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceMAC=gtInterfaceMAC, gtAccesslistName=gtAccesslistName, gtInterfaceNumber=gtInterfaceNumber, gtPortsLinkup=gtPortsLinkup, gtWebProtocol=gtWebProtocol, gtAgentPort=gtAgentPort, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapPDU=gtTrapPDU, gtPortsName=gtPortsName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSNMPEntry=gtSNMPEntry, gtNetworkName=gtNetworkName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSEntry=gtHMSEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateFile=gtUpdateFile, gtDNSNumber=gtDNSNumber, gtModuleBackupDate=gtModuleBackupDate, gtNTPServerEntry=gtNTPServerEntry, gtDNSEntry=gtDNSEntry, gtDNSServerIP=gtDNSServerIP, gtAgentState=gtAgentState, gtUserPassword=gtUserPassword, gtCurrentUserName=gtCurrentUserName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPNumber=gtSFPNumber, gtNetworkPortNumber=gtNetworkPortNumber, gtGroupEntry=gtGroupEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPSpeed=gtSFPSpeed, gtNTPServerAddress=gtNTPServerAddress, gtTimeZone=gtTimeZone, gtSFPLink=gtSFPLink, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSyslogIP=gtSyslogIP, gtAccesslistEntry=gtAccesslistEntry, gtChassisRedundancy=gtChassisRedundancy, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleUpdate=gtModuleUpdate, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapState=gtTrapState, gtTrapUser=gtTrapUser, gtSWOptionsTable=gtSWOptionsTable, gtGeneral=gtGeneral, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceIGMP=gtInterfaceIGMP, gtPortsEntry=gtPortsEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsConformance=gtSettingsConformance, gtCurrentTimeSource=gtCurrentTimeSource, gtUserIdx=gtUserIdx, gtModuleBackupTable=gtModuleBackupTable, gtUserGroup=gtUserGroup, gtGroupName=gtGroupName, gtSettingsObjects=gtSettingsObjects, gtSFTPPassword=gtSFTPPassword, gtTimeUTC=gtTimeUTC, gtBackupControl=gtBackupControl, gtSFPType=gtSFPType, gtInterfaceSNMP=gtInterfaceSNMP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupIdx=gtGroupIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtAccesslistIdx=gtAccesslistIdx, gtSNMPTable=gtSNMPTable, gtUserAccesslist=gtUserAccesslist, gtTrapDestEntry=gtTrapDestEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortName=gtNetworkPortName, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSComMethod=gtHMSComMethod, gtDateAndTimeTable=gtDateAndTimeTable, gtUserName=gtUserName, gtNetworkVLAN=gtNetworkVLAN, gtAgentComWriteString=gtAgentComWriteString, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSLARegistered=gtSLARegistered, gtUserTable=gtUserTable, gtSFPEntry=gtSFPEntry, gtNumSFP=gtNumSFP, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserEntry=gtUserEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserAuthEntry=gtUserAuthEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateStatus=gtUpdateStatus, gtUser=gtUser, gtHMSGroupName=gtHMSGroupName, gtSyslogTable=gtSyslogTable, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMP=gtSNMP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestPort=gtTrapDestPort, gtServicesTable=gtServicesTable, gtSettingsGroups=gtSettingsGroups, gtHMSTable=gtHMSTable, gtNetworkEntry=gtNetworkEntry, gtNTPServerTable=gtNTPServerTable)
