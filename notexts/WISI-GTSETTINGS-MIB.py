...
TimeTicks, Counter32, Bits, Unsigned32, ObjectIdentity, Counter64, ModuleIdentity, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Bits", "Unsigned32", "ObjectIdentity", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtWebAuth=gtWebAuth, gtPortsNumber=gtPortsNumber, gtSyslogIP=gtSyslogIP, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsMIB=gtSettingsMIB, gtHMSNumMembers=gtHMSNumMembers, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentComWriteString=gtAgentComWriteString, gtNetworkPortName=gtNetworkPortName, gtNumSFP=gtNumSFP, gtTrapUser=gtTrapUser, gtInterfaceEntry=gtInterfaceEntry, gtDateAndTime=gtDateAndTime, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceMAC=gtInterfaceMAC, gtSFTPPassword=gtSFTPPassword, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtModuleBackup=gtModuleBackup, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsGroups=gtSettingsGroups, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortsTable=gtNetworkPortsTable, gtTimeZone=gtTimeZone, gtSyslogEntry=gtSyslogEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTimeUTC=gtTimeUTC, gtGroupRights=gtGroupRights, gtSLAEntry=gtSLAEntry, gtAgentState=gtAgentState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSNMPEntry=gtSNMPEntry, gtSFTPPort=gtSFTPPort, gtSwitch=gtSwitch, gtInterfaceState=gtInterfaceState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceIGMP=gtInterfaceIGMP, gtSFPType=gtSFPType, gtModuleUpdate=gtModuleUpdate, gtUpdateStatus=gtUpdateStatus, gtAgentComReadString=gtAgentComReadString, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAccesslist=gtUserAccesslist, gtSyslogTable=gtSyslogTable, gtHMSGroupName=gtHMSGroupName, gtGroupTable=gtGroupTable, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSNumber=gtDNSNumber, gtTrapComString=gtTrapComString, gtServicesTable=gtServicesTable, gtSLAExpires=gtSLAExpires, gtPortsEntry=gtPortsEntry, gtPortsLinkup=gtPortsLinkup, gtNTPServerTable=gtNTPServerTable, gtSWOptionsTable=gtSWOptionsTable, gtNetworkVLAN=gtNetworkVLAN, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSLATable=gtSLATable, gtHMSComMethod=gtHMSComMethod, gtGroupAccesslist=gtGroupAccesslist, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAgentPort=gtAgentPort, gtCurrentTimeSource=gtCurrentTimeSource, gtServices=gtServices, gtNTPServerAddress=gtNTPServerAddress, gtDNSServerIP=gtDNSServerIP, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworking=gtNetworking, gtTrapState=gtTrapState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFTPServer=gtSFTPServer, gtInterfaceNumber=gtInterfaceNumber, gtSNMPTable=gtSNMPTable, gtGroupIdx=gtGroupIdx, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFile=gtUpdateFile, gtSNMP=gtSNMP, gtSettingsConformance=gtSettingsConformance, gtGroupParamIdx=gtGroupParamIdx, gtCurrentUserName=gtCurrentUserName, gtNetworkPortState=gtNetworkPortState, gtUserPassword=gtUserPassword, gtSFTPUsername=gtSFTPUsername, gtUpdateFilesTable=gtUpdateFilesTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistIdx=gtAccesslistIdx, gtModuleBackupControl=gtModuleBackupControl, gtSWOptionsIdx=gtSWOptionsIdx, PYSNMP_MODULE_ID=gtSettingsMIB, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtFilename=gtFilename, gtSLARegistered=gtSLARegistered, gtDNSTable=gtDNSTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTimeLocal=gtTimeLocal, gtSettingsNotifications=gtSettingsNotifications, gtUserGroup=gtUserGroup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapDestIP=gtTrapDestIP, gtServicesEntry=gtServicesEntry, gtUser=gtUser, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsName=gtPortsName, gtSFPPlugged=gtSFPPlugged, gtTrapDestTable=gtTrapDestTable, gtModuleBackupTable=gtModuleBackupTable, gtAccesslistTable=gtAccesslistTable, gtDateAndTimeTable=gtDateAndTimeTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtGroupEntry=gtGroupEntry, gtGroupName=gtGroupName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSEntry=gtHMSEntry, gtAccesslistName=gtAccesslistName, gtNTPServerEntry=gtNTPServerEntry, gtTrapPDU=gtTrapPDU, gtHMSNumAvailModules=gtHMSNumAvailModules, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceName=gtInterfaceName, gtGeneral=gtGeneral, gtWebEnable=gtWebEnable, gtTrapDestPort=gtTrapDestPort, gtNetworkEntry=gtNetworkEntry, gtInterfaceTable=gtInterfaceTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateControl=gtUpdateControl, gtWebProtocol=gtWebProtocol, gtDNSEntry=gtDNSEntry, gtUserName=gtUserName, gtChassisRedundancy=gtChassisRedundancy, gtDaylightAdjustment=gtDaylightAdjustment, gtSFPSpeed=gtSFPSpeed, gtInterfaceSNMP=gtInterfaceSNMP, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceCLI=gtInterfaceCLI, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistEntry=gtAccesslistEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFPLink=gtSFPLink, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPTable=gtSFPTable, gtTrapDestNumber=gtTrapDestNumber, gtUserParamIdx=gtUserParamIdx, gtPortsBitrateReceive=gtPortsBitrateReceive, gtBackupStatus=gtBackupStatus, gtAccesslistIPRange=gtAccesslistIPRange, gtUserEntry=gtUserEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupControl=gtBackupControl, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsCompliances=gtSettingsCompliances, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserIdx=gtUserIdx, gtSFPNumber=gtSFPNumber, gtHMSTable=gtHMSTable, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkTable=gtNetworkTable, gtTrapDestEntry=gtTrapDestEntry, gtNTPServerNumber=gtNTPServerNumber, gtUserTable=gtUserTable, gtSyslogState=gtSyslogState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtPortsTable=gtPortsTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSettingsObjects=gtSettingsObjects, gtUserRowStatus=gtUserRowStatus, gtUserAuthEntry=gtUserAuthEntry, gtSFPEntry=gtSFPEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtSWOption=gtSWOption, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkName=gtNetworkName)
