...
NotificationType, Integer32, ObjectIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter32, Counter64, iso, Bits, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter32", "Counter64", "iso", "Bits", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceTable=gtInterfaceTable, gtAgentPort=gtAgentPort, gtGroupAccesslist=gtGroupAccesslist, gtSLAEntry=gtSLAEntry, gtSFPTable=gtSFPTable, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsNumber=gtPortsNumber, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsNotifications=gtSettingsNotifications, gtAccesslistParamIdx=gtAccesslistParamIdx, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupRights=gtGroupRights, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFilesTable=gtUpdateFilesTable, gtSNMPTable=gtSNMPTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupControl=gtModuleBackupControl, gtNetworkName=gtNetworkName, gtNetworkVLAN=gtNetworkVLAN, gtSyslogTable=gtSyslogTable, gtAgentState=gtAgentState, gtGroupName=gtGroupName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFPLink=gtSFPLink, gtHMSTable=gtHMSTable, gtSFPType=gtSFPType, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceCLI=gtInterfaceCLI, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceEntry=gtInterfaceEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapState=gtTrapState, gtTrapComString=gtTrapComString, gtTrapDestNumber=gtTrapDestNumber, gtUserRowStatus=gtUserRowStatus, gtTrapUser=gtTrapUser, gtNetworkPortNumber=gtNetworkPortNumber, gtCurrentUserName=gtCurrentUserName, gtHMSEntry=gtHMSEntry, gtNetworkPortState=gtNetworkPortState, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtCurrentTimeSource=gtCurrentTimeSource, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentComWriteString=gtAgentComWriteString, gtBackupSFTPPort=gtBackupSFTPPort, gtUserParamIdx=gtUserParamIdx, gtWebAuth=gtWebAuth, gtUserAccesslist=gtUserAccesslist, gtHMSComMethod=gtHMSComMethod, gtAccesslistTable=gtAccesslistTable, gtSettingsMIB=gtSettingsMIB, gtTrapPDU=gtTrapPDU, gtUserEntry=gtUserEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserGroup=gtUserGroup, gtDNSTable=gtDNSTable, gtSFPPlugged=gtSFPPlugged, gtAgentComReadString=gtAgentComReadString, gtUserTable=gtUserTable, gtUserPassword=gtUserPassword, gtGroupTable=gtGroupTable, gtSNMP=gtSNMP, gtUserAuthTable=gtUserAuthTable, gtNTPServerAddress=gtNTPServerAddress, gtSFPSpeed=gtSFPSpeed, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerNumber=gtNTPServerNumber, gtNumSFP=gtNumSFP, gtServices=gtServices, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogEntry=gtSyslogEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtDateAndTimeTable=gtDateAndTimeTable, gtWebEnable=gtWebEnable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTimeZone=gtTimeZone, gtInterfaceState=gtInterfaceState, gtBackupSFTPUsername=gtBackupSFTPUsername, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsTable=gtPortsTable, gtGroupIdx=gtGroupIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtSLATable=gtSLATable, gtTrapDestPort=gtTrapDestPort, gtNetworkTable=gtNetworkTable, gtDNSEntry=gtDNSEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapDestEntry=gtTrapDestEntry, gtFilename=gtFilename, gtTrapSNMPVersion=gtTrapSNMPVersion, gtServicesTable=gtServicesTable, gtAccesslistName=gtAccesslistName, gtBackupStatus=gtBackupStatus, gtUpdateControl=gtUpdateControl, gtSFTPServer=gtSFTPServer, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSLARegistered=gtSLARegistered, gtPortsLinkup=gtPortsLinkup, gtSNMPEntry=gtSNMPEntry, gtTrapDestIP=gtTrapDestIP, gtUserAuthEntry=gtUserAuthEntry, gtModuleUpdate=gtModuleUpdate, gtUpdateStatus=gtUpdateStatus, gtNTPServerEntry=gtNTPServerEntry, gtSettingsObjects=gtSettingsObjects, gtPortsEntry=gtPortsEntry, gtNetworking=gtNetworking, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSWOptionsEntry=gtSWOptionsEntry, gtSLAExpires=gtSLAExpires, gtSettingsConformance=gtSettingsConformance, gtModuleBackup=gtModuleBackup, gtWebProtocol=gtWebProtocol, gtSFPEntry=gtSFPEntry, gtUserIdx=gtUserIdx, gtHMSGroupName=gtHMSGroupName, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateFile=gtUpdateFile, gtTimeUTC=gtTimeUTC, gtUser=gtUser, gtSettingsCompliances=gtSettingsCompliances, gtPortsName=gtPortsName, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortsEntry=gtNetworkPortsEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtSFTPUsername=gtSFTPUsername, gtTrapDestTable=gtTrapDestTable, gtDNSNumber=gtDNSNumber, gtGeneral=gtGeneral, gtNetworkPortName=gtNetworkPortName, gtServicesEntry=gtServicesEntry, gtSWOption=gtSWOption, gtNetworkEntry=gtNetworkEntry, gtGroupEntry=gtGroupEntry, gtSyslogIP=gtSyslogIP, gtSFPNumber=gtSFPNumber, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFTPPassword=gtSFTPPassword, gtHMSNumMembers=gtHMSNumMembers, gtBackupControl=gtBackupControl, gtDNSServerIP=gtDNSServerIP, gtInterfaceName=gtInterfaceName, PYSNMP_MODULE_ID=gtSettingsMIB, gtTimeLocal=gtTimeLocal, gtNTPServerTable=gtNTPServerTable, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleBackupTable=gtModuleBackupTable, gtDateAndTime=gtDateAndTime, gtUserName=gtUserName, gtSettingsGroups=gtSettingsGroups, gtSwitch=gtSwitch, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPPort=gtSFTPPort, gtSyslogState=gtSyslogState, gtModuleBackupDate=gtModuleBackupDate)
