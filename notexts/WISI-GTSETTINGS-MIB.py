...
IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Counter32, NotificationType, MibIdentifier, Counter64, Gauge32, Unsigned32, ModuleIdentity, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Counter32", "NotificationType", "MibIdentifier", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceName=gtInterfaceName, gtHMSEntry=gtHMSEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSWOptionsTable=gtSWOptionsTable, gtSyslogTable=gtSyslogTable, gtTimeZone=gtTimeZone, gtDateAndTimeEntry=gtDateAndTimeEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtAgentComReadString=gtAgentComReadString, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDateAndTime=gtDateAndTime, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsGroups=gtSettingsGroups, gtNetworkVLAN=gtNetworkVLAN, gtPortsTable=gtPortsTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtDateAndTimeTable=gtDateAndTimeTable, gtSWOptionsIdx=gtSWOptionsIdx, gtUser=gtUser, gtNetworkPortsTable=gtNetworkPortsTable, gtSFPType=gtSFPType, gtSettingsConformance=gtSettingsConformance, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapPDU=gtTrapPDU, gtUpdateControl=gtUpdateControl, gtInterfaceCLI=gtInterfaceCLI, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceState=gtInterfaceState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestTable=gtTrapDestTable, gtCurrentUserName=gtCurrentUserName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSNMPTable=gtSNMPTable, gtSettingsNotifications=gtSettingsNotifications, gtUserName=gtUserName, gtAccesslistEntry=gtAccesslistEntry, gtTrapDestEntry=gtTrapDestEntry, gtBackupControl=gtBackupControl, gtNTPServerNumber=gtNTPServerNumber, gtUserGroup=gtUserGroup, gtTrapDestPort=gtTrapDestPort, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapUser=gtTrapUser, gtIGMPQueryInterval=gtIGMPQueryInterval, gtBackupSFTPUsername=gtBackupSFTPUsername, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSLATable=gtSLATable, gtUpdateFile=gtUpdateFile, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceMAC=gtInterfaceMAC, gtBackupSFTPServer=gtBackupSFTPServer, gtSyslogState=gtSyslogState, gtPortsLinkup=gtPortsLinkup, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsNumber=gtPortsNumber, gtModuleBackupControl=gtModuleBackupControl, gtWebEnable=gtWebEnable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTimeLocal=gtTimeLocal, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPNumber=gtSFPNumber, gtUserAccesslist=gtUserAccesslist, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSNMP=gtSNMP, gtGroupAccesslist=gtGroupAccesslist, gtSettingsCompliances=gtSettingsCompliances, gtServicesEntry=gtServicesEntry, gtDNSEntry=gtDNSEntry, gtServicesTable=gtServicesTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSWOption=gtSWOption, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSTable=gtHMSTable, gtDNSServerIP=gtDNSServerIP, gtUserRowStatus=gtUserRowStatus, gtNumSFP=gtNumSFP, gtSFTPServer=gtSFTPServer, gtSFPLink=gtSFPLink, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserEntry=gtUserEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtGroupTable=gtGroupTable, gtInterfaceIGMP=gtInterfaceIGMP, gtServices=gtServices, gtTrapDestIP=gtTrapDestIP, gtInterfaceStreaming=gtInterfaceStreaming, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAccesslistName=gtAccesslistName, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkEntry=gtNetworkEntry, gtGroupRights=gtGroupRights, gtSFPSpeed=gtSFPSpeed, gtSettingsObjects=gtSettingsObjects, gtGeneral=gtGeneral, gtUserTable=gtUserTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSFTPPassword=gtSFTPPassword, gtInterfaceVLAN=gtInterfaceVLAN, gtAccesslistIdx=gtAccesslistIdx, gtSettingsMIB=gtSettingsMIB, gtAgentPort=gtAgentPort, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSLAExpires=gtSLAExpires, gtSwitch=gtSwitch, gtNetworkPortState=gtNetworkPortState, gtSNMPEntry=gtSNMPEntry, gtBackupStatus=gtBackupStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkTable=gtNetworkTable, gtModuleBackupEntry=gtModuleBackupEntry, gtSFPTable=gtSFPTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworking=gtNetworking, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtPortsEntry=gtPortsEntry, gtAccesslistTable=gtAccesslistTable, gtHMSComMethod=gtHMSComMethod, gtModuleUpdate=gtModuleUpdate, gtSFPEntry=gtSFPEntry, gtNTPServerTable=gtNTPServerTable, gtSLAEntry=gtSLAEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserAuthEntry=gtUserAuthEntry, gtNetworkPortName=gtNetworkPortName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortsEntry=gtNetworkPortsEntry, gtGroupName=gtGroupName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserIdx=gtUserIdx, gtSyslogEntry=gtSyslogEntry, gtUserAuthTable=gtUserAuthTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackupTable=gtModuleBackupTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkName=gtNetworkName, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestNumber=gtTrapDestNumber, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceTable=gtInterfaceTable, gtGroupIdx=gtGroupIdx, gtDNSNumber=gtDNSNumber, gtPortsName=gtPortsName, gtSyslogIP=gtSyslogIP, gtAgentComWriteString=gtAgentComWriteString, gtSFTPPort=gtSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTimeUTC=gtTimeUTC, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapState=gtTrapState, gtSLARegistered=gtSLARegistered, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapComString=gtTrapComString, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDNSTable=gtDNSTable, gtModuleBackup=gtModuleBackup, gtAgentState=gtAgentState, gtInterfaceEntry=gtInterfaceEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtWebProtocol=gtWebProtocol, gtUserParamIdx=gtUserParamIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtHMSGroupName=gtHMSGroupName, gtUpdateStatus=gtUpdateStatus, gtFilename=gtFilename, gtUserPassword=gtUserPassword, gtGroupEntry=gtGroupEntry, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPPlugged=gtSFPPlugged, gtWebAuth=gtWebAuth)
