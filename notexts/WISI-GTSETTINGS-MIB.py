...
ObjectIdentity, IpAddress, Bits, Unsigned32, ModuleIdentity, Integer32, iso, NotificationType, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Bits", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "NotificationType", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTimeZone=gtTimeZone, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestTable=gtTrapDestTable, gtSFTPUsername=gtSFTPUsername, gtHMSComMethod=gtHMSComMethod, gtUserParamIdx=gtUserParamIdx, gtTimeUTC=gtTimeUTC, gtFilename=gtFilename, gtSwitch=gtSwitch, gtSettingsGroups=gtSettingsGroups, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceName=gtInterfaceName, gtSWOption=gtSWOption, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDNSServerIP=gtDNSServerIP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserGroup=gtUserGroup, gtUser=gtUser, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupEntry=gtGroupEntry, gtWebAuth=gtWebAuth, gtUserTable=gtUserTable, gtSFPEntry=gtSFPEntry, gtNetworkName=gtNetworkName, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkEntry=gtNetworkEntry, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortNumber=gtNetworkPortNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFPTable=gtSFPTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceState=gtInterfaceState, gtAgentComReadString=gtAgentComReadString, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapDestEntry=gtTrapDestEntry, gtUserIdx=gtUserIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapState=gtTrapState, gtGroupIdx=gtGroupIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentComWriteString=gtAgentComWriteString, gtWebEnable=gtWebEnable, gtSFTPPort=gtSFTPPort, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogState=gtSyslogState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceEntry=gtInterfaceEntry, gtNetworkVLAN=gtNetworkVLAN, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPLink=gtSFPLink, gtHMSEntry=gtHMSEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtNumSFP=gtNumSFP, gtGroupName=gtGroupName, gtBackupControl=gtBackupControl, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceCLI=gtInterfaceCLI, gtTrapComString=gtTrapComString, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSFPSpeed=gtSFPSpeed, gtDNSNumber=gtDNSNumber, gtModuleBackupDate=gtModuleBackupDate, gtTrapUser=gtTrapUser, gtSLAEntry=gtSLAEntry, gtGroupRights=gtGroupRights, gtNetworkPortName=gtNetworkPortName, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupStatus=gtBackupStatus, gtNetworkTable=gtNetworkTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceNumber=gtInterfaceNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentPort=gtAgentPort, gtSyslogEntry=gtSyslogEntry, gtGroupParamIdx=gtGroupParamIdx, gtTrapDestPort=gtTrapDestPort, gtDNSTable=gtDNSTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsEntry=gtPortsEntry, gtSyslogIP=gtSyslogIP, gtDNSEntry=gtDNSEntry, gtDateAndTime=gtDateAndTime, gtSFTPPassword=gtSFTPPassword, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceTable=gtInterfaceTable, gtAccesslistName=gtAccesslistName, gtUserName=gtUserName, gtSFPNumber=gtSFPNumber, gtUserAccesslist=gtUserAccesslist, gtPortsTable=gtPortsTable, gtPortsLinkup=gtPortsLinkup, gtSWOptionsTable=gtSWOptionsTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNTPServerNumber=gtNTPServerNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAccesslistIdx=gtAccesslistIdx, gtSLAExpires=gtSLAExpires, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateFile=gtUpdateFile, gtPortsNumber=gtPortsNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtAgentState=gtAgentState, gtNetworkPortsTable=gtNetworkPortsTable, gtUserAuthEnabled=gtUserAuthEnabled, gtServicesTable=gtServicesTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNTPServerAddress=gtNTPServerAddress, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtSFPType=gtSFPType, gtSNMPEntry=gtSNMPEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtSNMP=gtSNMP, gtServicesEntry=gtServicesEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtGeneral=gtGeneral, gtNTPServerTable=gtNTPServerTable, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsIdx=gtSWOptionsIdx, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsName=gtPortsName, gtUserAuthTable=gtUserAuthTable, gtAccesslistEntry=gtAccesslistEntry, gtServices=gtServices, gtBackupSFTPPort=gtBackupSFTPPort, gtTimeLocal=gtTimeLocal, gtHMSTable=gtHMSTable, gtTrapDestIP=gtTrapDestIP, gtUserRowStatus=gtUserRowStatus, gtDateAndTimeTable=gtDateAndTimeTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleBackupControl=gtModuleBackupControl, gtNetworking=gtNetworking, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSFTPServer=gtSFTPServer, gtAccesslistTable=gtAccesslistTable, gtSettingsMIB=gtSettingsMIB, gtModuleBackup=gtModuleBackup, gtSettingsCompliances=gtSettingsCompliances, gtTrapPDU=gtTrapPDU, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateStatus=gtUpdateStatus, gtModuleBackupStatus=gtModuleBackupStatus, gtUserPassword=gtUserPassword, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsNotifications=gtSettingsNotifications, gtSLATable=gtSLATable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGroupTable=gtGroupTable, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsObjects=gtSettingsObjects, gtUpdateControl=gtUpdateControl, gtWebProtocol=gtWebProtocol, gtSFPPlugged=gtSFPPlugged, gtSettingsConformance=gtSettingsConformance, gtSyslogTable=gtSyslogTable, gtInterfaceVLAN=gtInterfaceVLAN, gtUserEntry=gtUserEntry, gtModuleBackupTable=gtModuleBackupTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSLARegistered=gtSLARegistered, gtCurrentUserName=gtCurrentUserName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleUpdate=gtModuleUpdate, gtInterfaceMAC=gtInterfaceMAC, gtSNMPTable=gtSNMPTable, gtNetworkPortState=gtNetworkPortState, gtDateAndTimeEntry=gtDateAndTimeEntry)
