...
NotificationType, ModuleIdentity, Bits, Gauge32, Counter64, Integer32, Unsigned32, TimeTicks, Counter32, IpAddress, MibIdentifier, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Bits", "Gauge32", "Counter64", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkVLAN=gtNetworkVLAN, gtAccesslistName=gtAccesslistName, gtTimeLocal=gtTimeLocal, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsLinkup=gtPortsLinkup, gtCurrentTimeSource=gtCurrentTimeSource, gtSWOptionsEntry=gtSWOptionsEntry, gtSwitch=gtSwitch, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkName=gtNetworkName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkPortName=gtNetworkPortName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtServicesTable=gtServicesTable, gtModuleBackupDate=gtModuleBackupDate, gtSFTPPassword=gtSFTPPassword, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworking=gtNetworking, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsMIB=gtSettingsMIB, gtTrapDestEntry=gtTrapDestEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapComString=gtTrapComString, gtModuleBackupTable=gtModuleBackupTable, gtSLAExpires=gtSLAExpires, gtSFPTable=gtSFPTable, gtUserTable=gtUserTable, gtChassisRedundancy=gtChassisRedundancy, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDNSTable=gtDNSTable, gtNTPServerEntry=gtNTPServerEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNTPServerNumber=gtNTPServerNumber, gtSettingsConformance=gtSettingsConformance, gtSFPLink=gtSFPLink, gtGroupName=gtGroupName, gtUserAuthTable=gtUserAuthTable, gtGroupIdx=gtGroupIdx, gtUpdateFilesEntry=gtUpdateFilesEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtSyslogState=gtSyslogState, gtTimeZone=gtTimeZone, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSWOption=gtSWOption, gtHMSNumMembers=gtHMSNumMembers, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserGroup=gtUserGroup, gtUserRowStatus=gtUserRowStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtBackupStatus=gtBackupStatus, gtUserPassword=gtUserPassword, gtSFTPUsername=gtSFTPUsername, gtGroupAccesslist=gtGroupAccesslist, gtModuleBackup=gtModuleBackup, gtNTPServerTable=gtNTPServerTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortsTable=gtNetworkPortsTable, gtUpdateFile=gtUpdateFile, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSWOptionsTable=gtSWOptionsTable, gtAgentComReadString=gtAgentComReadString, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtGroupEntry=gtGroupEntry, gtSettingsNotifications=gtSettingsNotifications, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtSLAEntry=gtSLAEntry, gtSNMPTable=gtSNMPTable, gtFilename=gtFilename, gtGroupRights=gtGroupRights, gtUserIdx=gtUserIdx, gtSFPPlugged=gtSFPPlugged, gtSFPType=gtSFPType, gtUserParamIdx=gtUserParamIdx, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFPEntry=gtSFPEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtAccesslistIdx=gtAccesslistIdx, gtTrapDestIP=gtTrapDestIP, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestPort=gtTrapDestPort, gtUserAccesslist=gtUserAccesslist, gtUpdateStatus=gtUpdateStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSGroupName=gtHMSGroupName, gtAccesslistEntry=gtAccesslistEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFTPPort=gtSFTPPort, gtWebEnable=gtWebEnable, gtSFTPServer=gtSFTPServer, gtAgentPort=gtAgentPort, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSLATable=gtSLATable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtWebAuth=gtWebAuth, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceState=gtInterfaceState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtAccesslistTable=gtAccesslistTable, gtSettingsCompliances=gtSettingsCompliances, gtWebProtocol=gtWebProtocol, gtBackupSFTPPort=gtBackupSFTPPort, gtModuleUpdate=gtModuleUpdate, gtUserAuthEntry=gtUserAuthEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtDNSEntry=gtDNSEntry, gtGroupTable=gtGroupTable, gtHMSComMethod=gtHMSComMethod, gtIGMPQueryInterval=gtIGMPQueryInterval, gtServices=gtServices, gtNetworkTable=gtNetworkTable, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsNumber=gtPortsNumber, gtInterfaceTable=gtInterfaceTable, gtAgentState=gtAgentState, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackupControl=gtModuleBackupControl, gtGroupParamIdx=gtGroupParamIdx, gtTrapState=gtTrapState, gtNTPServerAddress=gtNTPServerAddress, gtCurrentUserName=gtCurrentUserName, gtModuleBackupStatus=gtModuleBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDNSServerIP=gtDNSServerIP, gtSFPNumber=gtSFPNumber, gtUpdateControl=gtUpdateControl, gtTrapUser=gtTrapUser, gtNetworkPortState=gtNetworkPortState, gtNumSFP=gtNumSFP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestTable=gtTrapDestTable, gtInterfaceCLI=gtInterfaceCLI, gtSyslogIP=gtSyslogIP, gtInterfaceMAC=gtInterfaceMAC, gtDateAndTime=gtDateAndTime, gtSettingsGroups=gtSettingsGroups, gtDNSNumber=gtDNSNumber, gtSFPSpeed=gtSFPSpeed, gtServicesEntry=gtServicesEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkEntry=gtNetworkEntry, gtUser=gtUser, gtSettingsObjects=gtSettingsObjects, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceName=gtInterfaceName, gtHMSEntry=gtHMSEntry, gtSNMP=gtSNMP, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapPDU=gtTrapPDU, gtInterfaceNumber=gtInterfaceNumber, gtNetworkPortNumber=gtNetworkPortNumber, gtUserEntry=gtUserEntry, gtPortsEntry=gtPortsEntry, gtSNMPEntry=gtSNMPEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtSWOptionsIdx=gtSWOptionsIdx, gtUserName=gtUserName, gtSLARegistered=gtSLARegistered, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsTable=gtPortsTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUpdateFilesTable=gtUpdateFilesTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSyslogTable=gtSyslogTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSTable=gtHMSTable, gtUserAuthEnabled=gtUserAuthEnabled, gtGeneral=gtGeneral, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupControl=gtBackupControl, gtPortsName=gtPortsName, gtTimeUTC=gtTimeUTC, gtSyslogEntry=gtSyslogEntry)
