...
ObjectIdentity, MibIdentifier, IpAddress, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, NotificationType, TimeTicks, Gauge32, Unsigned32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "Counter32", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtWebEnable=gtWebEnable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserParamIdx=gtUserParamIdx, gtPortsName=gtPortsName, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAccesslistName=gtAccesslistName, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistIPRange=gtAccesslistIPRange, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtNTPServerTable=gtNTPServerTable, gtSFPSpeed=gtSFPSpeed, gtAgentState=gtAgentState, gtSLAEntry=gtSLAEntry, gtSFTPPassword=gtSFTPPassword, gtModuleBackupDate=gtModuleBackupDate, gtDNSTable=gtDNSTable, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceMAC=gtInterfaceMAC, gtSLAExpires=gtSLAExpires, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPLink=gtSFPLink, PYSNMP_MODULE_ID=gtSettingsMIB, gtSWOptionsTable=gtSWOptionsTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHMSEntry=gtHMSEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapState=gtTrapState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSNMPTable=gtSNMPTable, gtNumSFP=gtNumSFP, gtModuleUpdate=gtModuleUpdate, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSwitch=gtSwitch, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsCompliances=gtSettingsCompliances, gtGroupTable=gtGroupTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtServicesTable=gtServicesTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapUser=gtTrapUser, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsLinkup=gtPortsLinkup, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerEntry=gtNTPServerEntry, gtFilename=gtFilename, gtNetworkName=gtNetworkName, gtNetworkTable=gtNetworkTable, gtUserAuthEnabled=gtUserAuthEnabled, gtPortsNumber=gtPortsNumber, gtSettingsGroups=gtSettingsGroups, gtSNMP=gtSNMP, gtTrapDestNumber=gtTrapDestNumber, gtGroupParamIdx=gtGroupParamIdx, gtUserAuthEntry=gtUserAuthEntry, gtSFPEntry=gtSFPEntry, gtUserEntry=gtUserEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtSyslogIP=gtSyslogIP, gtChassisRedundancy=gtChassisRedundancy, gtHMSComMethod=gtHMSComMethod, gtSFTPServer=gtSFTPServer, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTimeLocal=gtTimeLocal, gtModuleBackupTable=gtModuleBackupTable, gtSyslogState=gtSyslogState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserName=gtUserName, gtAccesslistTable=gtAccesslistTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTimeZone=gtTimeZone, gtUserTable=gtUserTable, gtHMSTable=gtHMSTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceName=gtInterfaceName, gtDNSEntry=gtDNSEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSyslogTable=gtSyslogTable, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAgentPort=gtAgentPort, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapComString=gtTrapComString, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAgentComReadString=gtAgentComReadString, gtNTPServerAddress=gtNTPServerAddress, gtGroupAccesslist=gtGroupAccesslist, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsTable=gtPortsTable, gtGroupIdx=gtGroupIdx, gtInterfaceState=gtInterfaceState, gtDNSNumber=gtDNSNumber, gtUpdateStatus=gtUpdateStatus, gtSWOptionsIdx=gtSWOptionsIdx, gtSWOption=gtSWOption, gtSFTPUsername=gtSFTPUsername, gtUserAuthTable=gtUserAuthTable, gtTrapDestTable=gtTrapDestTable, gtCurrentTimeSource=gtCurrentTimeSource, gtServices=gtServices, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAccesslist=gtUserAccesslist, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupControl=gtBackupControl, gtUserPassword=gtUserPassword, gtUserRowStatus=gtUserRowStatus, gtAccesslistEntry=gtAccesslistEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUser=gtUser, gtGroupRights=gtGroupRights, gtInterfaceIPv4=gtInterfaceIPv4, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtServicesEntry=gtServicesEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapPDU=gtTrapPDU, gtNetworking=gtNetworking, gtAgentComWriteString=gtAgentComWriteString, gtWebProtocol=gtWebProtocol, gtBackupStatus=gtBackupStatus, gtNetworkEntry=gtNetworkEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtUpdateFile=gtUpdateFile, gtPortsEntry=gtPortsEntry, gtSFTPPort=gtSFTPPort, gtSLARegistered=gtSLARegistered, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkVLAN=gtNetworkVLAN, gtWebAuth=gtWebAuth, gtUpdateControl=gtUpdateControl, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortsTable=gtNetworkPortsTable, gtNetworkPortName=gtNetworkPortName, gtModuleBackup=gtModuleBackup, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsConformance=gtSettingsConformance, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceCLI=gtInterfaceCLI, gtSNMPEntry=gtSNMPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtSWOptionsEntry=gtSWOptionsEntry, gtSLATable=gtSLATable, gtNetworkPortState=gtNetworkPortState, gtSettingsObjects=gtSettingsObjects, gtHMSGroupName=gtHMSGroupName, gtNTPServerNumber=gtNTPServerNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPPlugged=gtSFPPlugged, gtInterfaceVLAN=gtInterfaceVLAN, gtTimeUTC=gtTimeUTC, gtInterfaceTable=gtInterfaceTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistIdx=gtAccesslistIdx, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserIdx=gtUserIdx, gtSettingsMIB=gtSettingsMIB, gtDateAndTimeTable=gtDateAndTimeTable, gtSyslogEntry=gtSyslogEntry, gtSFPTable=gtSFPTable, gtGroupName=gtGroupName, gtTrapDestIP=gtTrapDestIP, gtUserGroup=gtUserGroup, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPType=gtSFPType, gtSettingsNotifications=gtSettingsNotifications, gtHMSNumMembers=gtHMSNumMembers, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtGeneral=gtGeneral, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGroupEntry=gtGroupEntry, gtTrapDestPort=gtTrapDestPort, gtCurrentUserName=gtCurrentUserName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFPNumber=gtSFPNumber)
