...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ModuleIdentity, Bits, NotificationType, iso, TimeTicks, Counter64, Unsigned32, Integer32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ModuleIdentity", "Bits", "NotificationType", "iso", "TimeTicks", "Counter64", "Unsigned32", "Integer32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceIGMP=gtInterfaceIGMP, gtSFPLink=gtSFPLink, gtBackupSFTPFilename=gtBackupSFTPFilename, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapDestNumber=gtTrapDestNumber, gtHMSGroupName=gtHMSGroupName, gtHMSNumMembers=gtHMSNumMembers, gtSNMPEntry=gtSNMPEntry, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUserRowStatus=gtUserRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceCLI=gtInterfaceCLI, gtTrapDestIP=gtTrapDestIP, gtTimeLocal=gtTimeLocal, gtUserAuthTable=gtUserAuthTable, gtSyslogEntry=gtSyslogEntry, gtUserIdx=gtUserIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtServicesTable=gtServicesTable, gtNTPServerNumber=gtNTPServerNumber, gtModuleBackupControl=gtModuleBackupControl, gtSettingsGroups=gtSettingsGroups, gtInterfaceMAC=gtInterfaceMAC, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogIP=gtSyslogIP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSServerIP=gtDNSServerIP, gtInterfaceName=gtInterfaceName, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupDate=gtModuleBackupDate, gtModuleBackupStatus=gtModuleBackupStatus, gtServices=gtServices, gtSFPPlugged=gtSFPPlugged, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerAddress=gtNTPServerAddress, gtPortsEntry=gtPortsEntry, gtGroupAccesslist=gtGroupAccesslist, gtNetworkName=gtNetworkName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapDestTable=gtTrapDestTable, gtUserGroup=gtUserGroup, gtGroupName=gtGroupName, gtSFPNumber=gtSFPNumber, gtUser=gtUser, gtBackupControl=gtBackupControl, gtAgentComReadString=gtAgentComReadString, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsObjects=gtSettingsObjects, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNTPServerEntry=gtNTPServerEntry, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtServicesEntry=gtServicesEntry, gtNetworkVLAN=gtNetworkVLAN, gtTimeUTC=gtTimeUTC, gtInterfaceVLAN=gtInterfaceVLAN, gtWebEnable=gtWebEnable, gtSettingsNotifications=gtSettingsNotifications, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceState=gtInterfaceState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSLARegistered=gtSLARegistered, gtSNMPTable=gtSNMPTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupEntry=gtGroupEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleUpdate=gtModuleUpdate, gtCurrentTimeSource=gtCurrentTimeSource, gtHMSTable=gtHMSTable, gtHMSEntry=gtHMSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapUser=gtTrapUser, gtSFTPServer=gtSFTPServer, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPEntry=gtSFPEntry, gtUpdateControl=gtUpdateControl, gtUserEntry=gtUserEntry, gtGroupIdx=gtGroupIdx, gtPortsLinkup=gtPortsLinkup, gtUserAccesslist=gtUserAccesslist, gtSFTPPort=gtSFTPPort, gtModuleBackupTable=gtModuleBackupTable, gtTrapComString=gtTrapComString, gtAccesslistTable=gtAccesslistTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSettingsConformance=gtSettingsConformance, gtSLAExpires=gtSLAExpires, gtPortsNumber=gtPortsNumber, gtTrapDestEntry=gtTrapDestEntry, gtSFPTable=gtSFPTable, gtSNMP=gtSNMP, gtSFPType=gtSFPType, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkEntry=gtNetworkEntry, gtInterfaceNumber=gtInterfaceNumber, gtNetworkPortName=gtNetworkPortName, gtFilename=gtFilename, gtAccesslistIdx=gtAccesslistIdx, gtSFTPUsername=gtSFTPUsername, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTimeZone=gtTimeZone, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSwitch=gtSwitch, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistIPRange=gtAccesslistIPRange, gtSyslogState=gtSyslogState, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSTable=gtDNSTable, gtNumSFP=gtNumSFP, gtModuleBackup=gtModuleBackup, gtGroupRights=gtGroupRights, gtBackupStatus=gtBackupStatus, gtNetworkPortState=gtNetworkPortState, gtBackupSFTPPort=gtBackupSFTPPort, PYSNMP_MODULE_ID=gtSettingsMIB, gtSyslogTable=gtSyslogTable, gtNetworkTable=gtNetworkTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortNumber=gtNetworkPortNumber, gtSWOption=gtSWOption, gtSFTPPassword=gtSFTPPassword, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceEntry=gtInterfaceEntry, gtGeneral=gtGeneral, gtUserName=gtUserName, gtNetworking=gtNetworking, gtDateAndTime=gtDateAndTime, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserParamIdx=gtUserParamIdx, gtDNSNumber=gtDNSNumber, gtAccesslistName=gtAccesslistName, gtSWOptionsTable=gtSWOptionsTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsMIB=gtSettingsMIB, gtWebAuth=gtWebAuth, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerTable=gtNTPServerTable, gtDaylightAdjustment=gtDaylightAdjustment, gtAgentState=gtAgentState, gtUserAuthEnabled=gtUserAuthEnabled, gtHMSComMethod=gtHMSComMethod, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsName=gtPortsName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtDNSEntry=gtDNSEntry, gtWebProtocol=gtWebProtocol, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSLAEntry=gtSLAEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestPort=gtTrapDestPort, gtUpdateFile=gtUpdateFile, gtAgentPort=gtAgentPort, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateStatus=gtUpdateStatus, gtInterfaceTable=gtInterfaceTable, gtTrapState=gtTrapState, gtSLATable=gtSLATable, gtUserPassword=gtUserPassword, gtAccesslistEntry=gtAccesslistEntry, gtSFPSpeed=gtSFPSpeed, gtTrapPDU=gtTrapPDU, gtUserTable=gtUserTable, gtGroupTable=gtGroupTable, gtUserAuthEntry=gtUserAuthEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceSNMP=gtInterfaceSNMP, gtCurrentUserName=gtCurrentUserName, gtPortsTable=gtPortsTable, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsBitrateTransmit=gtPortsBitrateTransmit)
