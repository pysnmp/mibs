...
Gauge32, Bits, MibIdentifier, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, TimeTicks, Counter64, ObjectIdentity, Counter32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "MibIdentifier", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "TimeTicks", "Counter64", "ObjectIdentity", "Counter32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceStreaming=gtInterfaceStreaming, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUpdateStatus=gtUpdateStatus, gtNetworkPortNumber=gtNetworkPortNumber, gtUserParamIdx=gtUserParamIdx, gtTrapPDU=gtTrapPDU, gtSLAEntry=gtSLAEntry, gtTrapDestTable=gtTrapDestTable, gtSyslogIP=gtSyslogIP, gtNetworkPortsEntry=gtNetworkPortsEntry, gtHMSNumMembers=gtHMSNumMembers, gtUserTable=gtUserTable, gtSFPLink=gtSFPLink, gtUserAccesslist=gtUserAccesslist, gtTrapDestNumber=gtTrapDestNumber, gtUserAuthTable=gtUserAuthTable, gtSFPType=gtSFPType, gtSettingsObjects=gtSettingsObjects, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsMIB=gtSettingsMIB, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistName=gtAccesslistName, gtNetworking=gtNetworking, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentPort=gtAgentPort, gtNTPServerAddress=gtNTPServerAddress, gtSNMPEntry=gtSNMPEntry, gtAgentComWriteString=gtAgentComWriteString, gtUserName=gtUserName, gtGroupParamIdx=gtGroupParamIdx, gtGroupIdx=gtGroupIdx, gtUpdateFile=gtUpdateFile, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceIGMP=gtInterfaceIGMP, gtNumSFP=gtNumSFP, gtInterfaceTable=gtInterfaceTable, gtInterfaceSNMP=gtInterfaceSNMP, gtSLARegistered=gtSLARegistered, gtGroupTable=gtGroupTable, gtGroupRights=gtGroupRights, gtUserGroup=gtUserGroup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupSFTPServer=gtBackupSFTPServer, gtHMSGroupName=gtHMSGroupName, gtAccesslistTable=gtAccesslistTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerTable=gtNTPServerTable, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapUser=gtTrapUser, gtGroupEntry=gtGroupEntry, gtNetworkEntry=gtNetworkEntry, gtServicesTable=gtServicesTable, gtTrapDestPort=gtTrapDestPort, gtServices=gtServices, gtUserRowStatus=gtUserRowStatus, gtSNMP=gtSNMP, gtDateAndTime=gtDateAndTime, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDNSNumber=gtDNSNumber, gtUserAuthEntry=gtUserAuthEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupControl=gtBackupControl, gtPortsEntry=gtPortsEntry, gtNTPServerEntry=gtNTPServerEntry, gtUpdateControl=gtUpdateControl, gtTimeLocal=gtTimeLocal, gtModuleUpdate=gtModuleUpdate, gtSwitch=gtSwitch, gtPortsName=gtPortsName, gtSLAExpires=gtSLAExpires, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworkVLAN=gtNetworkVLAN, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSLATable=gtSLATable, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapComString=gtTrapComString, gtTimeZone=gtTimeZone, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFPPlugged=gtSFPPlugged, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtServicesEntry=gtServicesEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFTPPort=gtSFTPPort, gtSettingsCompliances=gtSettingsCompliances, gtWebEnable=gtWebEnable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMPTable=gtSNMPTable, gtUserPassword=gtUserPassword, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortState=gtNetworkPortState, gtDNSServerIP=gtDNSServerIP, gtSFPEntry=gtSFPEntry, gtSFPNumber=gtSFPNumber, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupStatus=gtBackupStatus, gtWebAuth=gtWebAuth, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapState=gtTrapState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSWOptionsIdx=gtSWOptionsIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtNTPServerNumber=gtNTPServerNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtWebProtocol=gtWebProtocol, gtSFTPPassword=gtSFTPPassword, gtSFTPUsername=gtSFTPUsername, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceState=gtInterfaceState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtHMSTable=gtHMSTable, gtNetworkTable=gtNetworkTable, gtUserEntry=gtUserEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSTable=gtDNSTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUser=gtUser, gtPortsNumber=gtPortsNumber, gtTrapDestIP=gtTrapDestIP, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtDNSEntry=gtDNSEntry, gtSettingsNotifications=gtSettingsNotifications, gtSWOption=gtSWOption, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSFPSpeed=gtSFPSpeed, gtModuleBackup=gtModuleBackup, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkName=gtNetworkName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTimeUTC=gtTimeUTC, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAgentState=gtAgentState, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceName=gtInterfaceName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtFilename=gtFilename, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGeneral=gtGeneral, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHMSEntry=gtHMSEntry, gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupAccesslist=gtGroupAccesslist, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSWOptionsEntry=gtSWOptionsEntry, gtAccesslistIdx=gtAccesslistIdx, gtSettingsGroups=gtSettingsGroups, gtAgentSecurityLevel=gtAgentSecurityLevel, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFTPServer=gtSFTPServer, gtUserIdx=gtUserIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsConformance=gtSettingsConformance, gtSyslogEntry=gtSyslogEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAgentComReadString=gtAgentComReadString, gtPortsTable=gtPortsTable, gtNetworkPortName=gtNetworkPortName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPTable=gtSFPTable, gtSyslogState=gtSyslogState, gtGroupName=gtGroupName, gtSWOptionsTable=gtSWOptionsTable, gtPortsLinkup=gtPortsLinkup, gtSyslogTable=gtSyslogTable)
