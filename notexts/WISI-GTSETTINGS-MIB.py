...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, IpAddress, Gauge32, NotificationType, MibIdentifier, ModuleIdentity, ObjectIdentity, TimeTicks, Bits, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "IpAddress", "Gauge32", "NotificationType", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Bits", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtGroupTable=gtGroupTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtHMSNumMembers=gtHMSNumMembers, gtSettingsConformance=gtSettingsConformance, gtSWOptionsEntry=gtSWOptionsEntry, gtUserIdx=gtUserIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtServices=gtServices, gtGroupName=gtGroupName, gtServicesTable=gtServicesTable, gtSFTPPassword=gtSFTPPassword, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPSpeed=gtSFPSpeed, gtSyslogTable=gtSyslogTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLAEntry=gtSLAEntry, gtSNMP=gtSNMP, gtBackupSFTPServer=gtBackupSFTPServer, gtDateAndTime=gtDateAndTime, gtInterfaceNumber=gtInterfaceNumber, gtSettingsMIB=gtSettingsMIB, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserGroup=gtUserGroup, gtNetworkPortState=gtNetworkPortState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAuthEntry=gtUserAuthEntry, gtTimeZone=gtTimeZone, gtBackupSFTPPort=gtBackupSFTPPort, gtSFTPPort=gtSFTPPort, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceVLAN=gtInterfaceVLAN, gtNTPServerNumber=gtNTPServerNumber, gtAccesslistName=gtAccesslistName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFPNumber=gtSFPNumber, gtGroupParamIdx=gtGroupParamIdx, gtSFPTable=gtSFPTable, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleUpdate=gtModuleUpdate, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentState=gtAgentState, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserRowStatus=gtUserRowStatus, gtHMSEntry=gtHMSEntry, gtUserParamIdx=gtUserParamIdx, gtNetworkTable=gtNetworkTable, gtSLATable=gtSLATable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsTable=gtPortsTable, gtWebEnable=gtWebEnable, gtTrapDestEntry=gtTrapDestEntry, gtCurrentUserName=gtCurrentUserName, gtSWOptionsTable=gtSWOptionsTable, gtWebProtocol=gtWebProtocol, gtNetworkPortsTable=gtNetworkPortsTable, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerAddress=gtNTPServerAddress, gtTrapComString=gtTrapComString, gtNumSFP=gtNumSFP, gtUserTable=gtUserTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSLAExpires=gtSLAExpires, gtAccesslistTable=gtAccesslistTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtAccesslistIdx=gtAccesslistIdx, gtModuleBackupTable=gtModuleBackupTable, gtHMSTable=gtHMSTable, gtDNSTable=gtDNSTable, gtAgentComReadString=gtAgentComReadString, gtNetworkName=gtNetworkName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSNMPTable=gtSNMPTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceIGMP=gtInterfaceIGMP, gtWebAuth=gtWebAuth, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceIPv4=gtInterfaceIPv4, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUser=gtUser, gtIGMPQueryInterval=gtIGMPQueryInterval, gtBackupStatus=gtBackupStatus, gtSFPType=gtSFPType, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupIdx=gtGroupIdx, gtSFTPServer=gtSFTPServer, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSWOption=gtSWOption, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceCLI=gtInterfaceCLI, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestTable=gtTrapDestTable, gtNetworkPortName=gtNetworkPortName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateControl=gtUpdateControl, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsLinkup=gtPortsLinkup, gtSFPLink=gtSFPLink, gtTrapDestPort=gtTrapDestPort, gtSFPEntry=gtSFPEntry, gtSettingsNotifications=gtSettingsNotifications, gtUpdateStatus=gtUpdateStatus, gtSNMPEntry=gtSNMPEntry, gtInterfaceName=gtInterfaceName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupAccesslist=gtGroupAccesslist, gtSFTPUsername=gtSFTPUsername, gtSLARegistered=gtSLARegistered, gtAccesslistEntry=gtAccesslistEntry, gtSwitch=gtSwitch, gtNTPServerTable=gtNTPServerTable, gtHMSComMethod=gtHMSComMethod, gtInterfaceTable=gtInterfaceTable, gtUserAuthEnabled=gtUserAuthEnabled, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworking=gtNetworking, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapDestIP=gtTrapDestIP, gtUserEntry=gtUserEntry, gtTrapPDU=gtTrapPDU, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUpdateFile=gtUpdateFile, gtNetworkEntry=gtNetworkEntry, gtGroupRights=gtGroupRights, gtSyslogState=gtSyslogState, gtModuleBackup=gtModuleBackup, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsNumber=gtPortsNumber, gtUserAccesslist=gtUserAccesslist, gtUserName=gtUserName, gtHMSGroupName=gtHMSGroupName, gtDNSNumber=gtDNSNumber, gtPortsEntry=gtPortsEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkVLAN=gtNetworkVLAN, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserPassword=gtUserPassword, gtServicesEntry=gtServicesEntry, gtSettingsGroups=gtSettingsGroups, gtDNSEntry=gtDNSEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapState=gtTrapState, gtTrapDestNumber=gtTrapDestNumber, gtBackupControl=gtBackupControl, gtAgentPort=gtAgentPort, gtAgentComWriteString=gtAgentComWriteString, gtModuleBackupControl=gtModuleBackupControl, gtFilename=gtFilename, gtSyslogEntry=gtSyslogEntry, gtTimeUTC=gtTimeUTC, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSettingsObjects=gtSettingsObjects, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAuthTable=gtUserAuthTable, gtSyslogIP=gtSyslogIP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapUser=gtTrapUser, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceState=gtInterfaceState, gtPortsName=gtPortsName, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleBackupDate=gtModuleBackupDate, gtDNSServerIP=gtDNSServerIP, gtGroupEntry=gtGroupEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGeneral=gtGeneral, PYSNMP_MODULE_ID=gtSettingsMIB, gtTimeLocal=gtTimeLocal, gtSFPPlugged=gtSFPPlugged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupStatus=gtModuleBackupStatus)
