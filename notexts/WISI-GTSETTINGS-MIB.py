...
MibIdentifier, Bits, Unsigned32, iso, Gauge32, Integer32, ObjectIdentity, ModuleIdentity, NotificationType, Counter64, IpAddress, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "iso", "Gauge32", "Integer32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter64", "IpAddress", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtChassisRedundancy=gtChassisRedundancy, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSNMPTable=gtSNMPTable, gtInterfaceCLI=gtInterfaceCLI, gtSFTPServer=gtSFTPServer, gtAccesslistName=gtAccesslistName, gtUser=gtUser, gtSNMPEntry=gtSNMPEntry, gtTimeLocal=gtTimeLocal, gtInterfaceStreaming=gtInterfaceStreaming, gtSFPLink=gtSFPLink, gtUserName=gtUserName, gtNTPServerNumber=gtNTPServerNumber, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupName=gtGroupName, gtInterfaceIPv4=gtInterfaceIPv4, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkTable=gtNetworkTable, gtUserAuthEntry=gtUserAuthEntry, gtPortsNumber=gtPortsNumber, gtAccesslistEntry=gtAccesslistEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFTPPort=gtSFTPPort, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSLATable=gtSLATable, gtNetworkPortState=gtNetworkPortState, gtUserIdx=gtUserIdx, gtInterfaceRowStatus=gtInterfaceRowStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtFilename=gtFilename, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceVLAN=gtInterfaceVLAN, gtNTPServerTable=gtNTPServerTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapDestIP=gtTrapDestIP, gtModuleBackupDate=gtModuleBackupDate, gtSyslogEntry=gtSyslogEntry, gtGroupAccesslist=gtGroupAccesslist, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUpdateControl=gtUpdateControl, gtUserRowStatus=gtUserRowStatus, gtDNSServerIP=gtDNSServerIP, gtAgentPort=gtAgentPort, gtSLARegistered=gtSLARegistered, gtSFTPUsername=gtSFTPUsername, gtHMSComMethod=gtHMSComMethod, gtModuleUpdate=gtModuleUpdate, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSyslogState=gtSyslogState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtWebProtocol=gtWebProtocol, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestPort=gtTrapDestPort, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSLAExpires=gtSLAExpires, gtAgentComReadString=gtAgentComReadString, gtDNSTable=gtDNSTable, gtUserEntry=gtUserEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtAccesslistIPRange=gtAccesslistIPRange, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSNMP=gtSNMP, gtDNSNumber=gtDNSNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSNumMembers=gtHMSNumMembers, gtSyslogTable=gtSyslogTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortName=gtNetworkPortName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSwitch=gtSwitch, gtInterfaceNumber=gtInterfaceNumber, gtNumSFP=gtNumSFP, gtSyslogIP=gtSyslogIP, gtSettingsConformance=gtSettingsConformance, gtSFPPlugged=gtSFPPlugged, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFile=gtUpdateFile, gtDateAndTime=gtDateAndTime, gtPortsTable=gtPortsTable, gtNTPServerEntry=gtNTPServerEntry, gtTrapComString=gtTrapComString, gtModuleBackupEntry=gtModuleBackupEntry, gtServicesTable=gtServicesTable, gtTimeZone=gtTimeZone, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupEntry=gtGroupEntry, gtTrapState=gtTrapState, gtAccesslistIdx=gtAccesslistIdx, gtUpdateStatus=gtUpdateStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSNumAvailModules=gtHMSNumAvailModules, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupTable=gtGroupTable, gtInterfaceTable=gtInterfaceTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtServicesEntry=gtServicesEntry, gtInterfaceState=gtInterfaceState, PYSNMP_MODULE_ID=gtSettingsMIB, gtDNSEntry=gtDNSEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceName=gtInterfaceName, gtSFPEntry=gtSFPEntry, gtSFPNumber=gtSFPNumber, gtPortsEntry=gtPortsEntry, gtUserAccesslist=gtUserAccesslist, gtBackupSFTPServer=gtBackupSFTPServer, gtUserGroup=gtUserGroup, gtTrapDestEntry=gtTrapDestEntry, gtServices=gtServices, gtSLAEntry=gtSLAEntry, gtSFPType=gtSFPType, gtInterfaceSNMP=gtInterfaceSNMP, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtUserPassword=gtUserPassword, gtTrapDestTable=gtTrapDestTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtGroupParamIdx=gtGroupParamIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworking=gtNetworking, gtSWOption=gtSWOption, gtCurrentTimeSource=gtCurrentTimeSource, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkEntry=gtNetworkEntry, gtTrapUser=gtTrapUser, gtWebEnable=gtWebEnable, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsMIB=gtSettingsMIB, gtSWOptionsTable=gtSWOptionsTable, gtHMSEntry=gtHMSEntry, gtTimeUTC=gtTimeUTC, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSettingsCompliances=gtSettingsCompliances, gtUserTable=gtUserTable, gtBackupStatus=gtBackupStatus, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupRights=gtGroupRights, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPSpeed=gtSFPSpeed, gtUserParamIdx=gtUserParamIdx, gtAccesslistTable=gtAccesslistTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkVLAN=gtNetworkVLAN, gtSettingsGroups=gtSettingsGroups, gtNetworkName=gtNetworkName, gtTrapPDU=gtTrapPDU, gtSettingsObjects=gtSettingsObjects, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtCurrentUserName=gtCurrentUserName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestNumber=gtTrapDestNumber, gtNTPServerAddress=gtNTPServerAddress, gtSFPTable=gtSFPTable, gtSFTPPassword=gtSFTPPassword, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserAuthTable=gtUserAuthTable, gtGeneral=gtGeneral, gtHMSTable=gtHMSTable, gtSettingsNotifications=gtSettingsNotifications, gtGroupIdx=gtGroupIdx, gtModuleBackup=gtModuleBackup, gtPortsLinkup=gtPortsLinkup, gtDaylightAdjustment=gtDaylightAdjustment, gtHeadendSystemManagement=gtHeadendSystemManagement, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsName=gtPortsName, gtAgentState=gtAgentState, gtInterfaceEntry=gtInterfaceEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDateAndTimeTable=gtDateAndTimeTable, gtWebAuth=gtWebAuth, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtBackupControl=gtBackupControl, gtBackupSFTPPort=gtBackupSFTPPort, gtCurrentUserPassword=gtCurrentUserPassword, gtUserAuthEnabled=gtUserAuthEnabled, gtAgentComWriteString=gtAgentComWriteString, gtHMSGroupName=gtHMSGroupName)
