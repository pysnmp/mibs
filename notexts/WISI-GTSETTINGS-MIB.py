...
Integer32, Unsigned32, TimeTicks, ObjectIdentity, ModuleIdentity, iso, IpAddress, Bits, MibIdentifier, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "iso", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceDHCPState=gtInterfaceDHCPState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserTable=gtUserTable, gtUserParamIdx=gtUserParamIdx, gtTrapComString=gtTrapComString, gtAgentPort=gtAgentPort, gtHMSGroupName=gtHMSGroupName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTimeZone=gtTimeZone, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkTable=gtNetworkTable, gtSFPLink=gtSFPLink, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSyslogTable=gtSyslogTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistEntry=gtAccesslistEntry, gtUserAuthEntry=gtUserAuthEntry, gtGeneral=gtGeneral, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleBackupControl=gtModuleBackupControl, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortName=gtNetworkPortName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtTrapDestNumber=gtTrapDestNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtFilename=gtFilename, gtSettingsObjects=gtSettingsObjects, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtPortsEntry=gtPortsEntry, gtUserRowStatus=gtUserRowStatus, gtSFPEntry=gtSFPEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAccesslistName=gtAccesslistName, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupTable=gtGroupTable, gtSettingsConformance=gtSettingsConformance, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceRowStatus=gtInterfaceRowStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserPassword=gtUserPassword, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtServices=gtServices, gtInterfaceSNMP=gtInterfaceSNMP, gtUserEntry=gtUserEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtNetworkPortsEntry=gtNetworkPortsEntry, gtDNSEntry=gtDNSEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtChassisRedundancy=gtChassisRedundancy, gtSFTPUsername=gtSFTPUsername, gtNetworkEntry=gtNetworkEntry, gtNetworkName=gtNetworkName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerEntry=gtNTPServerEntry, gtGroupName=gtGroupName, gtSFPType=gtSFPType, gtGroupAccesslist=gtGroupAccesslist, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTimeUTC=gtTimeUTC, gtAccesslistParamIdx=gtAccesslistParamIdx, gtWebAuth=gtWebAuth, gtSNMP=gtSNMP, gtSwitch=gtSwitch, gtTimeLocal=gtTimeLocal, gtSLARegistered=gtSLARegistered, gtInterfaceState=gtInterfaceState, gtSettingsNotifications=gtSettingsNotifications, gtNetworkPortState=gtNetworkPortState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapDestIP=gtTrapDestIP, gtAccesslistTable=gtAccesslistTable, gtHMSTable=gtHMSTable, gtGroupIdx=gtGroupIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtModuleUpdate=gtModuleUpdate, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapUser=gtTrapUser, gtSFPSpeed=gtSFPSpeed, gtSettingsCompliances=gtSettingsCompliances, gtSettingsMIB=gtSettingsMIB, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtPortsName=gtPortsName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUserAuthTable=gtUserAuthTable, gtSettingsGroups=gtSettingsGroups, gtNumSFP=gtNumSFP, gtHMSComMethod=gtHMSComMethod, gtCurrentUserName=gtCurrentUserName, gtNTPServerNumber=gtNTPServerNumber, gtPortsTable=gtPortsTable, gtTrapPDU=gtTrapPDU, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsLinkup=gtPortsLinkup, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapDestTable=gtTrapDestTable, gtNetworkPortsTable=gtNetworkPortsTable, gtUser=gtUser, gtSFTPPassword=gtSFTPPassword, gtInterfaceName=gtInterfaceName, gtPortsNumber=gtPortsNumber, gtNetworking=gtNetworking, gtNTPServerAddress=gtNTPServerAddress, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceEntry=gtInterfaceEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPPlugged=gtSFPPlugged, gtDNSServerIP=gtDNSServerIP, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleRedundancyGroup=gtModuleRedundancyGroup, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapDestPort=gtTrapDestPort, gtSFPNumber=gtSFPNumber, gtUpdateControl=gtUpdateControl, gtUserName=gtUserName, gtModuleBackupDate=gtModuleBackupDate, gtSyslogEntry=gtSyslogEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserIdx=gtUserIdx, gtSWOption=gtSWOption, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceIPv4=gtInterfaceIPv4, gtPortsFloodMulticast=gtPortsFloodMulticast, gtGroupParamIdx=gtGroupParamIdx, gtWebEnable=gtWebEnable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupTable=gtModuleBackupTable, gtSWOptionsTable=gtSWOptionsTable, gtSLAExpires=gtSLAExpires, gtSFPTable=gtSFPTable, gtUserAccesslist=gtUserAccesslist, gtDNSNumber=gtDNSNumber, gtHMSEntry=gtHMSEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtAgentState=gtAgentState, gtDateAndTime=gtDateAndTime, gtAccesslistIPRange=gtAccesslistIPRange, gtUpdateStatus=gtUpdateStatus, gtBackupControl=gtBackupControl, gtSFTPPort=gtSFTPPort, gtSNMPTable=gtSNMPTable, gtTrapState=gtTrapState, gtSLAEntry=gtSLAEntry, gtSyslogIP=gtSyslogIP, gtDNSTable=gtDNSTable, gtAgentComReadString=gtAgentComReadString, gtModuleBackupEntry=gtModuleBackupEntry, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSLATable=gtSLATable, gtSNMPEntry=gtSNMPEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleBackup=gtModuleBackup, gtUserGroup=gtUserGroup, gtSyslogState=gtSyslogState, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceTable=gtInterfaceTable, gtServicesEntry=gtServicesEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAccesslistIdx=gtAccesslistIdx, gtGroupRights=gtGroupRights, gtServicesTable=gtServicesTable, gtUpdateFile=gtUpdateFile, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerTable=gtNTPServerTable, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtAgentComWriteString=gtAgentComWriteString, gtSFTPServer=gtSFTPServer, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebProtocol=gtWebProtocol, gtBackupStatus=gtBackupStatus, gtGroupEntry=gtGroupEntry)
