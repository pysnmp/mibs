...
iso, MibIdentifier, NotificationType, ModuleIdentity, Integer32, Bits, ObjectIdentity, TimeTicks, Counter64, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "Bits", "ObjectIdentity", "TimeTicks", "Counter64", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortNumber=gtNetworkPortNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAccesslistEntry=gtAccesslistEntry, gtAgentComWriteString=gtAgentComWriteString, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceState=gtInterfaceState, gtTrapDestNumber=gtTrapDestNumber, gtUserAuthTable=gtUserAuthTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsEntry=gtPortsEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSyslogEntry=gtSyslogEntry, gtTimeUTC=gtTimeUTC, gtTrapDestTable=gtTrapDestTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserAuthEntry=gtUserAuthEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtHMSComMethod=gtHMSComMethod, gtNetworkPortState=gtNetworkPortState, gtModuleBackupTable=gtModuleBackupTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFTPPassword=gtSFTPPassword, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceName=gtInterfaceName, gtSFPTable=gtSFPTable, gtPortsTable=gtPortsTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsName=gtPortsName, gtUserEntry=gtUserEntry, gtAgentState=gtAgentState, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceTable=gtInterfaceTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtWebEnable=gtWebEnable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPSpeed=gtSFPSpeed, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSNMP=gtSNMP, gtSLAExpires=gtSLAExpires, gtTrapPDU=gtTrapPDU, gtChassisRedundancy=gtChassisRedundancy, gtHMSEntry=gtHMSEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapDestPort=gtTrapDestPort, gtSettingsConformance=gtSettingsConformance, gtSWOptionsTable=gtSWOptionsTable, gtSFPNumber=gtSFPNumber, gtModuleUpdate=gtModuleUpdate, gtSFPType=gtSFPType, gtFilename=gtFilename, gtDNSServerIP=gtDNSServerIP, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIfIndex=gtInterfaceIfIndex, gtModuleBackup=gtModuleBackup, gtModuleBackupEntry=gtModuleBackupEntry, gtUserName=gtUserName, gtGroupTable=gtGroupTable, gtHMSGroupName=gtHMSGroupName, gtBackupControl=gtBackupControl, gtGroupName=gtGroupName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapState=gtTrapState, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFile=gtUpdateFile, gtNTPServerTable=gtNTPServerTable, gtHMSTable=gtHMSTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUpdateControl=gtUpdateControl, gtSLARegistered=gtSLARegistered, gtModuleBackupControl=gtModuleBackupControl, gtBackupSFTPServer=gtBackupSFTPServer, gtSWOptionsEntry=gtSWOptionsEntry, gtSFTPServer=gtSFTPServer, gtTrapUser=gtTrapUser, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserGroup=gtUserGroup, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNumSFP=gtNumSFP, gtAgentComReadString=gtAgentComReadString, gtNetworkTable=gtNetworkTable, gtNetworkPortName=gtNetworkPortName, gtGroupRights=gtGroupRights, gtTrapDestIP=gtTrapDestIP, gtModuleBackupDate=gtModuleBackupDate, gtNTPServerAddress=gtNTPServerAddress, gtAgentPort=gtAgentPort, gtGroupIdx=gtGroupIdx, gtSLAEntry=gtSLAEntry, gtWebAuth=gtWebAuth, gtUser=gtUser, gtNetworking=gtNetworking, gtUserIdx=gtUserIdx, gtInterfaceEntry=gtInterfaceEntry, gtSettingsMIB=gtSettingsMIB, gtTrapDestEntry=gtTrapDestEntry, gtSwitch=gtSwitch, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNTPServerEntry=gtNTPServerEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAccesslistTable=gtAccesslistTable, gtAccesslistName=gtAccesslistName, gtTrapComString=gtTrapComString, gtInterfaceNumber=gtInterfaceNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupEntry=gtGroupEntry, gtUserTable=gtUserTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserAccesslist=gtUserAccesslist, gtIGMPQueryInterval=gtIGMPQueryInterval, gtServicesTable=gtServicesTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSyslogTable=gtSyslogTable, gtSFPPlugged=gtSFPPlugged, gtServices=gtServices, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceCLI=gtInterfaceCLI, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSNMPEntry=gtSNMPEntry, gtCurrentUserName=gtCurrentUserName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFPEntry=gtSFPEntry, gtUserPassword=gtUserPassword, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkName=gtNetworkName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAccesslistIdx=gtAccesslistIdx, gtUpdateStatus=gtUpdateStatus, gtDNSEntry=gtDNSEntry, gtServicesEntry=gtServicesEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtSWOptionsIdx=gtSWOptionsIdx, gtSWOption=gtSWOption, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSettingsGroups=gtSettingsGroups, gtSLATable=gtSLATable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNTPServerNumber=gtNTPServerNumber, gtDNSTable=gtDNSTable, gtUserParamIdx=gtUserParamIdx, gtGeneral=gtGeneral, gtCurrentUserPassword=gtCurrentUserPassword, gtBackupStatus=gtBackupStatus, gtSFTPPort=gtSFTPPort, gtSFTPUsername=gtSFTPUsername, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSettingsObjects=gtSettingsObjects, gtPortsNumber=gtPortsNumber, gtTimeLocal=gtTimeLocal, gtDNSNumber=gtDNSNumber, gtWebProtocol=gtWebProtocol, gtSNMPTable=gtSNMPTable, gtSyslogState=gtSyslogState, gtUserRowStatus=gtUserRowStatus, gtPortsLinkup=gtPortsLinkup, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceMAC=gtInterfaceMAC, gtAccesslistIPRange=gtAccesslistIPRange, gtSFPLink=gtSFPLink, gtHMSNumMembers=gtHMSNumMembers, gtNetworkEntry=gtNetworkEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTimeZone=gtTimeZone, gtSettingsNotifications=gtSettingsNotifications, gtSyslogIP=gtSyslogIP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleBackupStatus=gtModuleBackupStatus)
