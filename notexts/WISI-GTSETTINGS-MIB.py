...
NotificationType, IpAddress, ModuleIdentity, TimeTicks, Integer32, ObjectIdentity, MibIdentifier, Counter64, Gauge32, Bits, Unsigned32, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ModuleIdentity", "TimeTicks", "Integer32", "ObjectIdentity", "MibIdentifier", "Counter64", "Gauge32", "Bits", "Unsigned32", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUpdateStatus=gtUpdateStatus, gtGroupName=gtGroupName, gtUserPassword=gtUserPassword, gtGroupAccesslist=gtGroupAccesslist, gtFilename=gtFilename, gtCurrentUserName=gtCurrentUserName, gtModuleBackupEntry=gtModuleBackupEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSTable=gtDNSTable, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPPassword=gtSFTPPassword, gtNetworkPortNumber=gtNetworkPortNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtGeneral=gtGeneral, gtHMSNumMembers=gtHMSNumMembers, gtNetworkEntry=gtNetworkEntry, gtSettingsGroups=gtSettingsGroups, gtPortsName=gtPortsName, gtBackupSFTPServer=gtBackupSFTPServer, gtAccesslistTable=gtAccesslistTable, gtInterfaceTable=gtInterfaceTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTimeZone=gtTimeZone, gtUserIdx=gtUserIdx, gtTimeLocal=gtTimeLocal, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworking=gtNetworking, gtSNMP=gtSNMP, gtPortsTable=gtPortsTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsMIB=gtSettingsMIB, gtSFPType=gtSFPType, gtDNSEntry=gtDNSEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDNSNumber=gtDNSNumber, gtNetworkVLAN=gtNetworkVLAN, gtAgentComReadString=gtAgentComReadString, gtTrapDestRowStatus=gtTrapDestRowStatus, gtWebAuth=gtWebAuth, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSComMethod=gtHMSComMethod, gtSLAExpires=gtSLAExpires, gtDNSServerIP=gtDNSServerIP, gtNTPServerTable=gtNTPServerTable, gtSettingsCompliances=gtSettingsCompliances, gtHMSTable=gtHMSTable, gtCurrentTimeSource=gtCurrentTimeSource, gtUser=gtUser, gtIGMPQueryInterval=gtIGMPQueryInterval, gtGroupIdx=gtGroupIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUpdateFilesTable=gtUpdateFilesTable, gtSLARegistered=gtSLARegistered, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistName=gtAccesslistName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestIP=gtTrapDestIP, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceVLAN=gtInterfaceVLAN, gtPortsNumber=gtPortsNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestPort=gtTrapDestPort, gtUserEntry=gtUserEntry, gtNTPServerEntry=gtNTPServerEntry, gtHMSEntry=gtHMSEntry, gtAccesslistEntry=gtAccesslistEntry, gtSFTPServer=gtSFTPServer, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceState=gtInterfaceState, gtModuleBackup=gtModuleBackup, gtSNMPTable=gtSNMPTable, gtTrapDestTable=gtTrapDestTable, gtServicesEntry=gtServicesEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkPortState=gtNetworkPortState, gtSFPNumber=gtSFPNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapPDU=gtTrapPDU, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNTPServerNumber=gtNTPServerNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceEntry=gtInterfaceEntry, gtWebEnable=gtWebEnable, gtSettingsConformance=gtSettingsConformance, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogTable=gtSyslogTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceSNMP=gtInterfaceSNMP, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSettingsObjects=gtSettingsObjects, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTrapState=gtTrapState, gtGroupEntry=gtGroupEntry, gtUserGroup=gtUserGroup, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerAddress=gtNTPServerAddress, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUpdateFile=gtUpdateFile, gtSWOptionsTable=gtSWOptionsTable, gtAgentState=gtAgentState, gtGroupTable=gtGroupTable, gtModuleBackupDate=gtModuleBackupDate, gtAgentComWriteString=gtAgentComWriteString, gtServicesTable=gtServicesTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServices=gtServices, gtBackupSFTPPassword=gtBackupSFTPPassword, gtModuleUpdate=gtModuleUpdate, gtPortsEntry=gtPortsEntry, gtSFPTable=gtSFPTable, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceNumber=gtInterfaceNumber, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHMSGroupName=gtHMSGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserAccesslist=gtUserAccesslist, gtDateAndTime=gtDateAndTime, gtSettingsNotifications=gtSettingsNotifications, gtSyslogState=gtSyslogState, gtSFPEntry=gtSFPEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserRowStatus=gtUserRowStatus, gtInterfaceMAC=gtInterfaceMAC, gtUserAuthEntry=gtUserAuthEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserTable=gtUserTable, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSWOption=gtSWOption, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAgentPort=gtAgentPort, gtBackupStatus=gtBackupStatus, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAccesslistIPRange=gtAccesslistIPRange, gtSFPSpeed=gtSFPSpeed, gtInterfaceWebMgt=gtInterfaceWebMgt, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupTable=gtModuleBackupTable, gtNetworkName=gtNetworkName, gtTrapDestNumber=gtTrapDestNumber, gtSFTPUsername=gtSFTPUsername, gtSFPLink=gtSFPLink, gtUserAuthTable=gtUserAuthTable, gtNumSFP=gtNumSFP, gtUserName=gtUserName, gtAccesslistIdx=gtAccesslistIdx, gtUserParamIdx=gtUserParamIdx, gtSLAEntry=gtSLAEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortName=gtNetworkPortName, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtGroupRights=gtGroupRights, gtCurrentUserPassword=gtCurrentUserPassword, gtSLATable=gtSLATable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtTimeUTC=gtTimeUTC, gtSFTPPort=gtSFTPPort, gtPortsLinkup=gtPortsLinkup, gtUpdateControl=gtUpdateControl, gtSwitch=gtSwitch, gtTrapComString=gtTrapComString, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSNMPEntry=gtSNMPEntry, gtBackupControl=gtBackupControl, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupControl=gtModuleBackupControl, gtNetworkTable=gtNetworkTable, gtSFPPlugged=gtSFPPlugged, gtInterfaceName=gtInterfaceName, gtTrapUser=gtTrapUser, gtWebProtocol=gtWebProtocol)
