...
ModuleIdentity, Counter64, Counter32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, ObjectIdentity, Gauge32, Unsigned32, iso, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Counter32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Gauge32", "Unsigned32", "iso", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPServer=gtSFTPServer, gtUserAccesslist=gtUserAccesslist, gtTimeLocal=gtTimeLocal, gtUser=gtUser, gtGroupEntry=gtGroupEntry, gtTrapComString=gtTrapComString, gtNTPServerTable=gtNTPServerTable, gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserPassword=gtUserPassword, gtNTPServerAddress=gtNTPServerAddress, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPPlugged=gtSFPPlugged, gtTrapPDU=gtTrapPDU, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFTPPort=gtSFTPPort, gtHMSComMethod=gtHMSComMethod, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFilesTable=gtUpdateFilesTable, gtUserAuthTable=gtUserAuthTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtHMSGroupName=gtHMSGroupName, gtTimeUTC=gtTimeUTC, gtAgentState=gtAgentState, gtServicesTable=gtServicesTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceNumber=gtInterfaceNumber, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSwitch=gtSwitch, gtGroupParamIdx=gtGroupParamIdx, gtServicesEntry=gtServicesEntry, gtSFTPUsername=gtSFTPUsername, gtSLAExpires=gtSLAExpires, gtModuleUpdate=gtModuleUpdate, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserName=gtUserName, gtTrapDestPort=gtTrapDestPort, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapState=gtTrapState, gtNetworkPortName=gtNetworkPortName, gtUpdateControl=gtUpdateControl, gtUpdateStatus=gtUpdateStatus, gtAccesslistIdx=gtAccesslistIdx, gtHMSNumMembers=gtHMSNumMembers, gtPortsTable=gtPortsTable, gtUserRowStatus=gtUserRowStatus, gtGroupName=gtGroupName, gtSettingsGroups=gtSettingsGroups, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupRights=gtGroupRights, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkPortNumber=gtNetworkPortNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtSLATable=gtSLATable, gtNetworkEntry=gtNetworkEntry, gtUserParamIdx=gtUserParamIdx, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentUserName=gtCurrentUserName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleBackupDate=gtModuleBackupDate, gtUserGroup=gtUserGroup, gtSettingsNotifications=gtSettingsNotifications, gtWebEnable=gtWebEnable, gtInterfaceIGMP=gtInterfaceIGMP, gtGeneral=gtGeneral, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOption=gtSWOption, gtTrapDestIP=gtTrapDestIP, gtHMSTable=gtHMSTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTimeZone=gtTimeZone, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPTable=gtSFPTable, gtSFPNumber=gtSFPNumber, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUserTable=gtUserTable, gtWebProtocol=gtWebProtocol, gtNetworking=gtNetworking, gtInterfaceState=gtInterfaceState, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceCLI=gtInterfaceCLI, gtSFPSpeed=gtSFPSpeed, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNumSFP=gtNumSFP, gtSyslogState=gtSyslogState, gtAccesslistName=gtAccesslistName, gtNetworkVLAN=gtNetworkVLAN, gtSNMP=gtSNMP, gtSyslogIP=gtSyslogIP, gtUpdateFile=gtUpdateFile, gtSettingsConformance=gtSettingsConformance, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackup=gtModuleBackup, gtPortsEntry=gtPortsEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsName=gtPortsName, gtGroupAccesslist=gtGroupAccesslist, gtSFTPPassword=gtSFTPPassword, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestTable=gtTrapDestTable, gtSyslogTable=gtSyslogTable, gtAgentComReadString=gtAgentComReadString, gtPortsLinkup=gtPortsLinkup, gtNetworkTable=gtNetworkTable, gtDNSServerIP=gtDNSServerIP, gtSettingsObjects=gtSettingsObjects, gtSWOptionsTable=gtSWOptionsTable, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtWebAuth=gtWebAuth, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkName=gtNetworkName, gtSFPEntry=gtSFPEntry, gtAgentPort=gtAgentPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtServices=gtServices, gtNTPServerEntry=gtNTPServerEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSLAEntry=gtSLAEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortState=gtNetworkPortState, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapUser=gtTrapUser, gtSLARegistered=gtSLARegistered, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsMIB=gtSettingsMIB, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupTable=gtGroupTable, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupControl=gtBackupControl, gtDateAndTimeTable=gtDateAndTimeTable, gtChassisRedundancy=gtChassisRedundancy, gtSFPLink=gtSFPLink, gtTrapSNMPVersion=gtTrapSNMPVersion, gtAgentComWriteString=gtAgentComWriteString, gtNTPServerNumber=gtNTPServerNumber, gtPortsNumber=gtPortsNumber, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAccesslistTable=gtAccesslistTable, gtUserIdx=gtUserIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupStatus=gtBackupStatus, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHMSEntry=gtHMSEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistEntry=gtAccesslistEntry, gtSNMPTable=gtSNMPTable, gtDNSNumber=gtDNSNumber, gtDNSTable=gtDNSTable, gtDNSEntry=gtDNSEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapDestNumber=gtTrapDestNumber, gtSettingsCompliances=gtSettingsCompliances, gtUserEntry=gtUserEntry, gtSFPType=gtSFPType, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceName=gtInterfaceName, gtDateAndTime=gtDateAndTime, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtFilename=gtFilename, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestEntry=gtTrapDestEntry, gtSyslogEntry=gtSyslogEntry, gtSNMPEntry=gtSNMPEntry, gtInterfaceTable=gtInterfaceTable, gtGroupIdx=gtGroupIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDaylightAdjustment=gtDaylightAdjustment)
