...
ModuleIdentity, ObjectIdentity, Counter32, Gauge32, NotificationType, Integer32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Unsigned32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "Gauge32", "NotificationType", "Integer32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Unsigned32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtHMSGroupName=gtHMSGroupName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTimeZone=gtTimeZone, gtUserPassword=gtUserPassword, gtGroupIdx=gtGroupIdx, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleUpdate=gtModuleUpdate, gtSettingsConformance=gtSettingsConformance, gtTimeLocal=gtTimeLocal, gtSLATable=gtSLATable, gtSyslogState=gtSyslogState, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPType=gtSFPType, gtAccesslistName=gtAccesslistName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtHMSNumMembers=gtHMSNumMembers, gtTrapState=gtTrapState, gtSLAEntry=gtSLAEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkName=gtNetworkName, gtDaylightAdjustment=gtDaylightAdjustment, gtSWOption=gtSWOption, gtTrapDestTable=gtTrapDestTable, gtSettingsCompliances=gtSettingsCompliances, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupControl=gtModuleBackupControl, gtNumSFP=gtNumSFP, gtHMSTable=gtHMSTable, gtDNSNumber=gtDNSNumber, gtNTPServerTable=gtNTPServerTable, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLARegistered=gtSLARegistered, gtInterfaceIGMP=gtInterfaceIGMP, gtAccesslistTable=gtAccesslistTable, gtUpdateFile=gtUpdateFile, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupAccesslist=gtGroupAccesslist, gtChassisRedundancy=gtChassisRedundancy, gtGroupRights=gtGroupRights, gtDNSServerIP=gtDNSServerIP, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkEntry=gtNetworkEntry, gtTrapUser=gtTrapUser, gtModuleBackupStatus=gtModuleBackupStatus, gtSettingsMIB=gtSettingsMIB, gtServicesEntry=gtServicesEntry, gtGeneral=gtGeneral, gtInterfaceCLI=gtInterfaceCLI, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortState=gtNetworkPortState, gtUserAuthTable=gtUserAuthTable, gtDNSTable=gtDNSTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserName=gtUserName, gtUserIdx=gtUserIdx, gtTrapDestNumber=gtTrapDestNumber, gtSNMPTable=gtSNMPTable, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceMAC=gtInterfaceMAC, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsNumber=gtPortsNumber, gtSwitch=gtSwitch, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebAuth=gtWebAuth, gtSFTPUsername=gtSFTPUsername, gtInterfaceNumber=gtInterfaceNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserAccesslist=gtUserAccesslist, gtSFTPServer=gtSFTPServer, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUpdateControl=gtUpdateControl, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentState=gtAgentState, gtSettingsObjects=gtSettingsObjects, gtTrapDestPort=gtTrapDestPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtSFPSpeed=gtSFPSpeed, gtAccesslistIPRange=gtAccesslistIPRange, gtWebProtocol=gtWebProtocol, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtAgentComWriteString=gtAgentComWriteString, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsTable=gtPortsTable, gtServices=gtServices, gtPortsLinkup=gtPortsLinkup, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAuthEntry=gtUserAuthEntry, gtSFPNumber=gtSFPNumber, gtPortsEntry=gtPortsEntry, gtFilename=gtFilename, gtCurrentTimeSource=gtCurrentTimeSource, gtSLAExpires=gtSLAExpires, gtGroupTable=gtGroupTable, gtSNMPEntry=gtSNMPEntry, gtCurrentUserName=gtCurrentUserName, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceEntry=gtInterfaceEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSyslogEntry=gtSyslogEntry, gtTrapDestIP=gtTrapDestIP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPLink=gtSFPLink, gtTimeUTC=gtTimeUTC, gtNetworkVLAN=gtNetworkVLAN, gtNTPServerNumber=gtNTPServerNumber, gtUserRowStatus=gtUserRowStatus, gtUserParamIdx=gtUserParamIdx, gtInterfaceName=gtInterfaceName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSEntry=gtHMSEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUserGroup=gtUserGroup, gtGroupName=gtGroupName, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupStatus=gtBackupStatus, gtAgentComReadString=gtAgentComReadString, gtAgentPort=gtAgentPort, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPEntry=gtSFPEntry, gtSWOptionsTable=gtSWOptionsTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSyslogIP=gtSyslogIP, gtBackupControl=gtBackupControl, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortName=gtNetworkPortName, gtSFPTable=gtSFPTable, gtWebEnable=gtWebEnable, gtNetworkTable=gtNetworkTable, gtDNSEntry=gtDNSEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupEntry=gtGroupEntry, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSettingsGroups=gtSettingsGroups, gtInterfaceState=gtInterfaceState, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapPDU=gtTrapPDU, gtDateAndTime=gtDateAndTime, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapDestEntry=gtTrapDestEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFTPPassword=gtSFTPPassword, gtSyslogTable=gtSyslogTable, gtSFPPlugged=gtSFPPlugged, gtPortsName=gtPortsName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserTable=gtUserTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworking=gtNetworking, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserEntry=gtUserEntry, gtTrapComString=gtTrapComString, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupTable=gtModuleBackupTable, gtModuleBackup=gtModuleBackup, gtServicesTable=gtServicesTable, gtSettingsNotifications=gtSettingsNotifications, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceTable=gtInterfaceTable, gtHMSComMethod=gtHMSComMethod, gtUpdateStatus=gtUpdateStatus, gtNTPServerAddress=gtNTPServerAddress, gtUser=gtUser, gtAccesslistEntry=gtAccesslistEntry, gtSNMP=gtSNMP, gtSFTPPort=gtSFTPPort)
