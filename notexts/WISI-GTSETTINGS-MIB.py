...
Integer32, Counter32, Gauge32, MibIdentifier, IpAddress, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, TimeTicks, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "TimeTicks", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsNumber=gtPortsNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSLARegistered=gtSLARegistered, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistTable=gtAccesslistTable, gtGroupEntry=gtGroupEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtSyslogTable=gtSyslogTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAgentState=gtAgentState, gtTimeZone=gtTimeZone, gtAgentComReadString=gtAgentComReadString, gtSFPPlugged=gtSFPPlugged, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSServerIP=gtDNSServerIP, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSWOptionsIdx=gtSWOptionsIdx, gtDNSNumber=gtDNSNumber, gtUserTable=gtUserTable, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPPort=gtBackupSFTPPort, gtModuleUpdate=gtModuleUpdate, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserGroup=gtUserGroup, gtAgentPort=gtAgentPort, gtInterfaceName=gtInterfaceName, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFPLink=gtSFPLink, gtUpdateControl=gtUpdateControl, gtNTPServerTable=gtNTPServerTable, gtHMSTable=gtHMSTable, gtModuleBackup=gtModuleBackup, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtHMSNumMembers=gtHMSNumMembers, gtAgentComWriteString=gtAgentComWriteString, gtNetworkEntry=gtNetworkEntry, gtHMSEntry=gtHMSEntry, gtTimeLocal=gtTimeLocal, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtGeneral=gtGeneral, gtPortsTable=gtPortsTable, gtSettingsGroups=gtSettingsGroups, gtUserRowStatus=gtUserRowStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTimeUTC=gtTimeUTC, gtNTPServerAddress=gtNTPServerAddress, gtPortsEntry=gtPortsEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSWOption=gtSWOption, gtInterfaceMAC=gtInterfaceMAC, gtServicesEntry=gtServicesEntry, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtServices=gtServices, gtInterfaceEntry=gtInterfaceEntry, gtGroupRights=gtGroupRights, gtNetworking=gtNetworking, gtSettingsMIB=gtSettingsMIB, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceStreaming=gtInterfaceStreaming, gtUser=gtUser, gtUserIdx=gtUserIdx, gtUserParamIdx=gtUserParamIdx, gtSettingsObjects=gtSettingsObjects, gtHMSNumAvailModules=gtHMSNumAvailModules, gtPortsBitrateReceive=gtPortsBitrateReceive, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapState=gtTrapState, gtSFPNumber=gtSFPNumber, gtSWOptionsTable=gtSWOptionsTable, gtSFPTable=gtSFPTable, gtPortsName=gtPortsName, gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceState=gtInterfaceState, gtSFTPPort=gtSFTPPort, gtInterfaceCLI=gtInterfaceCLI, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistName=gtAccesslistName, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDateAndTime=gtDateAndTime, gtNetworkVLAN=gtNetworkVLAN, gtSwitch=gtSwitch, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPUsername=gtSFTPUsername, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFPSpeed=gtSFPSpeed, gtSLATable=gtSLATable, gtSLAExpires=gtSLAExpires, gtFilename=gtFilename, gtNTPServerEntry=gtNTPServerEntry, gtDNSEntry=gtDNSEntry, gtUserEntry=gtUserEntry, gtGroupTable=gtGroupTable, gtGroupParamIdx=gtGroupParamIdx, gtAccesslistIdx=gtAccesslistIdx, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtDNSTable=gtDNSTable, gtTrapUser=gtTrapUser, gtInterfaceVLAN=gtInterfaceVLAN, gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPEntry=gtSFPEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceTable=gtInterfaceTable, gtUserAuthTable=gtUserAuthTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleBackupTable=gtModuleBackupTable, gtSFTPServer=gtSFTPServer, gtSyslogState=gtSyslogState, gtNetworkTable=gtNetworkTable, gtCurrentTimeSource=gtCurrentTimeSource, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupStatus=gtBackupStatus, gtUpdateStatus=gtUpdateStatus, gtTrapDestTable=gtTrapDestTable, gtSNMP=gtSNMP, gtDateAndTimeTable=gtDateAndTimeTable, gtUpdateFile=gtUpdateFile, gtUserAccesslist=gtUserAccesslist, gtAccesslistParamIdx=gtAccesslistParamIdx, gtAccesslistEntry=gtAccesslistEntry, gtNetworkName=gtNetworkName, gtServicesTable=gtServicesTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsNotifications=gtSettingsNotifications, gtUserPassword=gtUserPassword, gtGroupIdx=gtGroupIdx, gtPortsLinkup=gtPortsLinkup, gtTrapDestPort=gtTrapDestPort, gtWebAuth=gtWebAuth, gtSFTPPassword=gtSFTPPassword, gtNumSFP=gtNumSFP, gtModuleBackupControl=gtModuleBackupControl, gtAccesslistIPRange=gtAccesslistIPRange, gtGroupAccesslist=gtGroupAccesslist, gtBackupControl=gtBackupControl, gtTrapDestNumber=gtTrapDestNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapPDU=gtTrapPDU, gtDateAndTimeEntry=gtDateAndTimeEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupEntry=gtModuleBackupEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtGroupName=gtGroupName, gtSFPType=gtSFPType, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortName=gtNetworkPortName, gtHMSGroupName=gtHMSGroupName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSNMPEntry=gtSNMPEntry, gtSettingsConformance=gtSettingsConformance, gtSLAEntry=gtSLAEntry, gtWebEnable=gtWebEnable, gtSNMPTable=gtSNMPTable, gtUserName=gtUserName, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortState=gtNetworkPortState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapDestIP=gtTrapDestIP, gtSyslogEntry=gtSyslogEntry, gtTrapComString=gtTrapComString, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNTPServerNumber=gtNTPServerNumber, gtWebProtocol=gtWebProtocol, gtInterfaceNumber=gtInterfaceNumber)
