...
MibIdentifier, NotificationType, Unsigned32, Counter32, Gauge32, ModuleIdentity, Integer32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Unsigned32", "Counter32", "Gauge32", "ModuleIdentity", "Integer32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestPort=gtTrapDestPort, gtNetworkTable=gtNetworkTable, gtSyslogIP=gtSyslogIP, gtNetworkVLAN=gtNetworkVLAN, gtSFTPPort=gtSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSLAExpires=gtSLAExpires, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestNumber=gtTrapDestNumber, gtGroupIdx=gtGroupIdx, gtSettingsObjects=gtSettingsObjects, gtInterfaceVLAN=gtInterfaceVLAN, gtGeneral=gtGeneral, gtAgentState=gtAgentState, gtPortsEntry=gtPortsEntry, gtInterfaceEntry=gtInterfaceEntry, gtUserIdx=gtUserIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapUser=gtTrapUser, gtSettingsConformance=gtSettingsConformance, gtSWOptionsTable=gtSWOptionsTable, gtSyslogEntry=gtSyslogEntry, gtModuleUpdate=gtModuleUpdate, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPTable=gtSFPTable, gtNTPServerTable=gtNTPServerTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSLARegistered=gtSLARegistered, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkPortsTable=gtNetworkPortsTable, gtServices=gtServices, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtGroupEntry=gtGroupEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupStatus=gtBackupStatus, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPPlugged=gtSFPPlugged, gtSLATable=gtSLATable, gtNetworkName=gtNetworkName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtCurrentUserPassword=gtCurrentUserPassword, gtSFTPServer=gtSFTPServer, gtUser=gtUser, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceName=gtInterfaceName, gtUserName=gtUserName, gtUserTable=gtUserTable, gtTrapDestIP=gtTrapDestIP, gtSFPType=gtSFPType, gtTimeUTC=gtTimeUTC, gtCurrentUserName=gtCurrentUserName, gtWebEnable=gtWebEnable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsMIB=gtSettingsMIB, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSEntry=gtHMSEntry, gtHMSGroupName=gtHMSGroupName, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtDNSServerIP=gtDNSServerIP, gtServicesTable=gtServicesTable, gtTimeZone=gtTimeZone, gtSFTPPassword=gtSFTPPassword, gtDNSNumber=gtDNSNumber, gtGroupTable=gtGroupTable, gtWebProtocol=gtWebProtocol, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTimeLocal=gtTimeLocal, gtNTPServerEntry=gtNTPServerEntry, gtAgentComReadString=gtAgentComReadString, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerNumber=gtNTPServerNumber, gtHMSNumMembers=gtHMSNumMembers, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAgentComWriteString=gtAgentComWriteString, gtAccesslistIPRange=gtAccesslistIPRange, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceRowStatus=gtInterfaceRowStatus, gtHMSTable=gtHMSTable, gtUserGroup=gtUserGroup, gtInterfaceIfIndex=gtInterfaceIfIndex, gtModuleBackupControl=gtModuleBackupControl, gtAccesslistName=gtAccesslistName, gtUpdateControl=gtUpdateControl, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateFile=gtUpdateFile, gtUserEntry=gtUserEntry, gtSLAEntry=gtSLAEntry, gtSFPNumber=gtSFPNumber, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsNumber=gtPortsNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSEntry=gtDNSEntry, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupName=gtGroupName, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPEntry=gtSFPEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtFilename=gtFilename, gtInterfaceMAC=gtInterfaceMAC, gtSFPSpeed=gtSFPSpeed, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUpdateStatus=gtUpdateStatus, gtSFTPUsername=gtSFTPUsername, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkPortName=gtNetworkPortName, gtSyslogState=gtSyslogState, gtChassisRedundancy=gtChassisRedundancy, gtUserPassword=gtUserPassword, gtNumSFP=gtNumSFP, gtNetworking=gtNetworking, gtInterfaceCLI=gtInterfaceCLI, gtWebAuth=gtWebAuth, gtModuleBackup=gtModuleBackup, gtSWOption=gtSWOption, gtUserAuthTable=gtUserAuthTable, gtSettingsNotifications=gtSettingsNotifications, gtTrapPDU=gtTrapPDU, gtHMSComMethod=gtHMSComMethod, gtUserAccesslist=gtUserAccesslist, gtPortsLinkup=gtPortsLinkup, gtInterfaceNumber=gtInterfaceNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSwitch=gtSwitch, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSNMP=gtSNMP, gtDateAndTimeTable=gtDateAndTimeTable, gtDateAndTime=gtDateAndTime, gtGroupParamIdx=gtGroupParamIdx, gtAccesslistIdx=gtAccesslistIdx, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSyslogTable=gtSyslogTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAgentPort=gtAgentPort, gtTrapComString=gtTrapComString, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortState=gtNetworkPortState, gtSFPLink=gtSFPLink, gtSNMPEntry=gtSNMPEntry, gtTrapDestTable=gtTrapDestTable, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPServer=gtBackupSFTPServer, gtUserParamIdx=gtUserParamIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtNTPServerAddress=gtNTPServerAddress, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsName=gtPortsName, gtAccesslistEntry=gtAccesslistEntry, gtModuleBackupTable=gtModuleBackupTable, gtPortsTable=gtPortsTable, gtServicesEntry=gtServicesEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceState=gtInterfaceState, gtGroupAccesslist=gtGroupAccesslist, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceTable=gtInterfaceTable, gtGroupRights=gtGroupRights, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapState=gtTrapState, gtDaylightAdjustment=gtDaylightAdjustment, gtUserRowStatus=gtUserRowStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSTable=gtDNSTable, gtAccesslistTable=gtAccesslistTable, gtSWOptionsIdx=gtSWOptionsIdx, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserAuthEntry=gtUserAuthEntry, gtModuleBackupDate=gtModuleBackupDate, gtBackupControl=gtBackupControl, gtSNMPTable=gtSNMPTable, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleBackupEntry=gtModuleBackupEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworkEntry=gtNetworkEntry)
