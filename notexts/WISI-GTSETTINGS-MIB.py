...
ObjectIdentity, Unsigned32, Gauge32, ModuleIdentity, Counter64, TimeTicks, Counter32, MibIdentifier, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter64", "TimeTicks", "Counter32", "MibIdentifier", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupParamIdx=gtGroupParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtSyslogState=gtSyslogState, gtHMSNumMembers=gtHMSNumMembers, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPType=gtSFPType, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUserName=gtUserName, gtWebEnable=gtWebEnable, gtSettingsNotifications=gtSettingsNotifications, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapDestIP=gtTrapDestIP, gtSFPLink=gtSFPLink, gtServicesEntry=gtServicesEntry, gtNumSFP=gtNumSFP, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceState=gtInterfaceState, gtSWOptionsTable=gtSWOptionsTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, PYSNMP_MODULE_ID=gtSettingsMIB, gtDNSTable=gtDNSTable, gtInterfaceCLI=gtInterfaceCLI, gtDNSEntry=gtDNSEntry, gtTimeLocal=gtTimeLocal, gtAgentComWriteString=gtAgentComWriteString, gtGroupAccesslist=gtGroupAccesslist, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserIdx=gtUserIdx, gtWebAuth=gtWebAuth, gtSLAExpires=gtSLAExpires, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistName=gtAccesslistName, gtUserGroup=gtUserGroup, gtSNMPEntry=gtSNMPEntry, gtNTPServerNumber=gtNTPServerNumber, gtServicesTable=gtServicesTable, gtBackupControl=gtBackupControl, gtNetworking=gtNetworking, gtSFPPlugged=gtSFPPlugged, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtDateAndTime=gtDateAndTime, gtHMSComMethod=gtHMSComMethod, gtDaylightAdjustment=gtDaylightAdjustment, gtServices=gtServices, gtInterfaceTable=gtInterfaceTable, gtNetworkPortNumber=gtNetworkPortNumber, gtSwitch=gtSwitch, gtChassisRedundancy=gtChassisRedundancy, gtTrapPDU=gtTrapPDU, gtBackupStatus=gtBackupStatus, gtTrapDestNumber=gtTrapDestNumber, gtDNSServerIP=gtDNSServerIP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtDNSNumber=gtDNSNumber, gtNTPServerTable=gtNTPServerTable, gtModuleBackupTable=gtModuleBackupTable, gtAgentState=gtAgentState, gtSyslogIP=gtSyslogIP, gtPortsTable=gtPortsTable, gtSFTPPort=gtSFTPPort, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateControl=gtUpdateControl, gtUser=gtUser, gtUpdateFile=gtUpdateFile, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceStreaming=gtInterfaceStreaming, gtTimeZone=gtTimeZone, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsEntry=gtPortsEntry, gtPortsName=gtPortsName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFTPPassword=gtSFTPPassword, gtPortsLinkup=gtPortsLinkup, gtInterfaceNumber=gtInterfaceNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupIdx=gtGroupIdx, gtAccesslistIPRange=gtAccesslistIPRange, gtSLARegistered=gtSLARegistered, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentComReadString=gtAgentComReadString, gtGroupTable=gtGroupTable, gtPortsNumber=gtPortsNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserRowStatus=gtUserRowStatus, gtCurrentUserName=gtCurrentUserName, gtModuleUpdate=gtModuleUpdate, gtSNMPTable=gtSNMPTable, gtUserParamIdx=gtUserParamIdx, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTimeUTC=gtTimeUTC, gtInterfaceName=gtInterfaceName, gtSFPSpeed=gtSFPSpeed, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkEntry=gtNetworkEntry, gtSyslogEntry=gtSyslogEntry, gtModuleBackupControl=gtModuleBackupControl, gtNetworkName=gtNetworkName, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkTable=gtNetworkTable, gtCurrentTimeSource=gtCurrentTimeSource, gtSettingsMIB=gtSettingsMIB, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNTPServerEntry=gtNTPServerEntry, gtWebProtocol=gtWebProtocol, gtSWOptionsEntry=gtSWOptionsEntry, gtSLAEntry=gtSLAEntry, gtUserAccesslist=gtUserAccesslist, gtTrapUser=gtTrapUser, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtHMSTable=gtHMSTable, gtHMSGroupName=gtHMSGroupName, gtGeneral=gtGeneral, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortName=gtNetworkPortName, gtSFPEntry=gtSFPEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleBackupDate=gtModuleBackupDate, gtSFTPServer=gtSFTPServer, gtSFTPUsername=gtSFTPUsername, gtTrapState=gtTrapState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceSNMP=gtInterfaceSNMP, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPNumber=gtSFPNumber, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestEntry=gtTrapDestEntry, gtAgentPort=gtAgentPort, gtGroupName=gtGroupName, gtAccesslistEntry=gtAccesslistEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtGroupEntry=gtGroupEntry, gtNetworkVLAN=gtNetworkVLAN, gtTrapComString=gtTrapComString, gtSFPTable=gtSFPTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceEntry=gtInterfaceEntry, gtFilename=gtFilename, gtAccesslistTable=gtAccesslistTable, gtSyslogTable=gtSyslogTable, gtSWOption=gtSWOption, gtNetworkPortState=gtNetworkPortState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtHMSEntry=gtHMSEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtCurrentUserPassword=gtCurrentUserPassword, gtUserEntry=gtUserEntry, gtGroupRights=gtGroupRights, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserPassword=gtUserPassword, gtModuleBackup=gtModuleBackup, gtTrapDestPort=gtTrapDestPort, gtUpdateStatus=gtUpdateStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestTable=gtTrapDestTable, gtSLATable=gtSLATable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMP=gtSNMP, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthEntry=gtUserAuthEntry, gtSettingsGroups=gtSettingsGroups, gtUserTable=gtUserTable)
