...
NotificationType, ModuleIdentity, Unsigned32, Bits, TimeTicks, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64, IpAddress, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64", "IpAddress", "iso", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtPortsLinkup=gtPortsLinkup, gtInterfaceMAC=gtInterfaceMAC, gtSFTPPort=gtSFTPPort, gtSettingsObjects=gtSettingsObjects, gtUserRowStatus=gtUserRowStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtServicesTable=gtServicesTable, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceVLAN=gtInterfaceVLAN, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtHMSTable=gtHMSTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSyslogIP=gtSyslogIP, gtPortsTable=gtPortsTable, gtTimeLocal=gtTimeLocal, gtFilename=gtFilename, gtGroupName=gtGroupName, gtModuleBackupControl=gtModuleBackupControl, gtModuleBackup=gtModuleBackup, gtInterfaceState=gtInterfaceState, gtAccesslistIPRange=gtAccesslistIPRange, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupIdx=gtGroupIdx, gtUserName=gtUserName, gtDNSTable=gtDNSTable, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSEntry=gtHMSEntry, gtWebEnable=gtWebEnable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestTable=gtTrapDestTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsMIB=gtSettingsMIB, gtModuleBackupStatus=gtModuleBackupStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSLAEntry=gtSLAEntry, gtModuleUpdate=gtModuleUpdate, gtTrapState=gtTrapState, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworking=gtNetworking, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSyslogState=gtSyslogState, gtModuleBackupDate=gtModuleBackupDate, gtUserAuthTable=gtUserAuthTable, gtNetworkPortState=gtNetworkPortState, gtTrapComString=gtTrapComString, gtTimeZone=gtTimeZone, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSWOptionsEntry=gtSWOptionsEntry, gtAgentPort=gtAgentPort, gtUserIdx=gtUserIdx, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFPPlugged=gtSFPPlugged, gtModuleBackupEntry=gtModuleBackupEntry, gtSFPLink=gtSFPLink, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerEntry=gtNTPServerEntry, gtChassisRedundancy=gtChassisRedundancy, gtPortsName=gtPortsName, gtNetworkTable=gtNetworkTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSyslogTable=gtSyslogTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtGeneral=gtGeneral, gtCurrentTimeSource=gtCurrentTimeSource, gtUserAuthEntry=gtUserAuthEntry, gtSFTPPassword=gtSFTPPassword, gtUserGroup=gtUserGroup, gtServicesEntry=gtServicesEntry, gtSFTPServer=gtSFTPServer, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortName=gtNetworkPortName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupEntry=gtGroupEntry, gtSFPNumber=gtSFPNumber, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtDNSServerIP=gtDNSServerIP, gtUser=gtUser, gtDNSNumber=gtDNSNumber, gtSNMPEntry=gtSNMPEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtGroupTable=gtGroupTable, gtTrapPDU=gtTrapPDU, gtInterfaceNumber=gtInterfaceNumber, gtTimeUTC=gtTimeUTC, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSwitch=gtSwitch, gtInterfaceName=gtInterfaceName, gtGroupRights=gtGroupRights, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateControl=gtUpdateControl, gtBackupStatus=gtBackupStatus, gtSLARegistered=gtSLARegistered, gtSFTPUsername=gtSFTPUsername, gtHMSComMethod=gtHMSComMethod, gtAgentComReadString=gtAgentComReadString, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceCLI=gtInterfaceCLI, PYSNMP_MODULE_ID=gtSettingsMIB, gtSWOptionsTable=gtSWOptionsTable, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserPassword=gtUserPassword, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistName=gtAccesslistName, gtSFPSpeed=gtSFPSpeed, gtSFPType=gtSFPType, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUserEntry=gtUserEntry, gtWebProtocol=gtWebProtocol, gtSNMP=gtSNMP, gtNetworkVLAN=gtNetworkVLAN, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtDaylightAdjustment=gtDaylightAdjustment, gtAgentState=gtAgentState, gtUserParamIdx=gtUserParamIdx, gtSLAExpires=gtSLAExpires, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsEntry=gtPortsEntry, gtDNSEntry=gtDNSEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackupTable=gtModuleBackupTable, gtSyslogEntry=gtSyslogEntry, gtInterfaceEntry=gtInterfaceEntry, gtGroupAccesslist=gtGroupAccesslist, gtUserAccesslist=gtUserAccesslist, gtAccesslistEntry=gtAccesslistEntry, gtWebAuth=gtWebAuth, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAccesslistIdx=gtAccesslistIdx, gtBackupControl=gtBackupControl, gtNetworkName=gtNetworkName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNTPServerTable=gtNTPServerTable, gtSWOption=gtSWOption, gtSLATable=gtSLATable, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapDestPort=gtTrapDestPort, gtHMSNumMembers=gtHMSNumMembers, gtNumSFP=gtNumSFP, gtAccesslistTable=gtAccesslistTable, gtTrapUser=gtTrapUser, gtCurrentUserName=gtCurrentUserName, gtSNMPTable=gtSNMPTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkEntry=gtNetworkEntry, gtTrapDestIP=gtTrapDestIP, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAgentComWriteString=gtAgentComWriteString, gtServices=gtServices, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceTable=gtInterfaceTable, gtSFPEntry=gtSFPEntry, gtTrapDestNumber=gtTrapDestNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFile=gtUpdateFile, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsConformance=gtSettingsConformance, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserTable=gtUserTable, gtSFPTable=gtSFPTable, gtPortsNumber=gtPortsNumber, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateStatus=gtUpdateStatus, gtDateAndTime=gtDateAndTime)
