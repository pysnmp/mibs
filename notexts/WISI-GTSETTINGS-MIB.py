...
MibIdentifier, Counter64, ObjectIdentity, ModuleIdentity, Unsigned32, Counter32, iso, Integer32, Bits, TimeTicks, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "Counter32", "iso", "Integer32", "Bits", "TimeTicks", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPServer=gtSFTPServer, gtInterfaceName=gtInterfaceName, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortName=gtNetworkPortName, gtHMSNumMembers=gtHMSNumMembers, gtUserAuthTable=gtUserAuthTable, gtNTPServerNumber=gtNTPServerNumber, gtSyslogEntry=gtSyslogEntry, gtAgentPort=gtAgentPort, gtSwitch=gtSwitch, gtTimeLocal=gtTimeLocal, gtUpdateControl=gtUpdateControl, gtUserName=gtUserName, gtGeneral=gtGeneral, gtInterfaceState=gtInterfaceState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserPassword=gtUserPassword, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserAuthEntry=gtUserAuthEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleBackup=gtModuleBackup, gtSettingsCompliances=gtSettingsCompliances, gtGroupRights=gtGroupRights, gtDateAndTime=gtDateAndTime, gtUserRowStatus=gtUserRowStatus, gtAccesslistIdx=gtAccesslistIdx, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSNMPTable=gtSNMPTable, gtBackupStatus=gtBackupStatus, gtUserAuthEnabled=gtUserAuthEnabled, gtWebEnable=gtWebEnable, gtNetworkPortState=gtNetworkPortState, gtSFTPPort=gtSFTPPort, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSNumAvailModules=gtHMSNumAvailModules, gtGroupAccesslist=gtGroupAccesslist, gtSFPEntry=gtSFPEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtHMSGroupName=gtHMSGroupName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFPSpeed=gtSFPSpeed, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSLATable=gtSLATable, gtInterfaceMAC=gtInterfaceMAC, gtPortsNumber=gtPortsNumber, gtDNSEntry=gtDNSEntry, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceEntry=gtInterfaceEntry, gtSFPNumber=gtSFPNumber, gtFilename=gtFilename, gtUser=gtUser, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceCLI=gtInterfaceCLI, gtPortsTable=gtPortsTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtGroupEntry=gtGroupEntry, gtAccesslistTable=gtAccesslistTable, gtUserIdx=gtUserIdx, gtSFTPPassword=gtSFTPPassword, gtDateAndTimeTable=gtDateAndTimeTable, gtNumSFP=gtNumSFP, gtInterfaceTable=gtInterfaceTable, gtPortsLinkup=gtPortsLinkup, gtServicesTable=gtServicesTable, gtModuleBackupStatus=gtModuleBackupStatus, gtSettingsMIB=gtSettingsMIB, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceVLAN=gtInterfaceVLAN, gtAgentState=gtAgentState, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserGroup=gtUserGroup, gtGroupTable=gtGroupTable, gtSLARegistered=gtSLARegistered, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserTable=gtUserTable, gtSyslogIP=gtSyslogIP, gtTimeZone=gtTimeZone, gtGroupParamIdx=gtGroupParamIdx, gtBackupControl=gtBackupControl, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsGroups=gtSettingsGroups, gtWebAuth=gtWebAuth, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtServices=gtServices, gtInterfaceNumber=gtInterfaceNumber, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSServerIP=gtDNSServerIP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsName=gtPortsName, gtSNMPEntry=gtSNMPEntry, gtAgentComReadString=gtAgentComReadString, gtTrapDestPort=gtTrapDestPort, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistEntry=gtAccesslistEntry, gtModuleBackupTable=gtModuleBackupTable, gtSFTPUsername=gtSFTPUsername, gtModuleUpdate=gtModuleUpdate, gtNetworkPortNumber=gtNetworkPortNumber, gtAccesslistName=gtAccesslistName, gtSLAExpires=gtSLAExpires, gtCurrentUserPassword=gtCurrentUserPassword, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapUser=gtTrapUser, gtTrapDestNumber=gtTrapDestNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFPType=gtSFPType, gtHMSEntry=gtHMSEntry, gtGroupIdx=gtGroupIdx, gtTrapComString=gtTrapComString, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtUserEntry=gtUserEntry, gtNetworkEntry=gtNetworkEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkVLAN=gtNetworkVLAN, gtUpdateFile=gtUpdateFile, gtSyslogTable=gtSyslogTable, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserAccesslist=gtUserAccesslist, gtModuleBackupControl=gtModuleBackupControl, gtNTPServerAddress=gtNTPServerAddress, gtHMSTable=gtHMSTable, gtWebProtocol=gtWebProtocol, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSLAEntry=gtSLAEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapState=gtTrapState, gtBackupSFTPPassword=gtBackupSFTPPassword, PYSNMP_MODULE_ID=gtSettingsMIB, gtChassisRedundancy=gtChassisRedundancy, gtNetworkPortsEntry=gtNetworkPortsEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPPlugged=gtSFPPlugged, gtCurrentUserName=gtCurrentUserName, gtNetworkName=gtNetworkName, gtSNMP=gtSNMP, gtNetworkTable=gtNetworkTable, gtUserParamIdx=gtUserParamIdx, gtTrapDestTable=gtTrapDestTable, gtDNSTable=gtDNSTable, gtSWOption=gtSWOption, gtSyslogState=gtSyslogState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNTPServerTable=gtNTPServerTable, gtPortsEntry=gtPortsEntry, gtTrapPDU=gtTrapPDU, gtBackupSFTPPort=gtBackupSFTPPort, gtTimeUTC=gtTimeUTC, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDaylightAdjustment=gtDaylightAdjustment, gtModuleBackupEntry=gtModuleBackupEntry, gtSFPLink=gtSFPLink, gtNTPServerEntry=gtNTPServerEntry, gtNetworking=gtNetworking, gtDNSNumber=gtDNSNumber, gtServicesEntry=gtServicesEntry, gtGroupName=gtGroupName, gtSFPTable=gtSFPTable, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapDestIP=gtTrapDestIP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateStatus=gtUpdateStatus, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSWOptionsEntry=gtSWOptionsEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask)
