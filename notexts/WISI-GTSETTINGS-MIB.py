...
ModuleIdentity, iso, Counter32, ObjectIdentity, IpAddress, Bits, Counter64, MibIdentifier, Unsigned32, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Counter32", "ObjectIdentity", "IpAddress", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSNMPTable=gtSNMPTable, gtSFPTable=gtSFPTable, gtWebAuth=gtWebAuth, gtInterfaceState=gtInterfaceState, gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtGroupAccesslist=gtGroupAccesslist, gtSNMP=gtSNMP, gtHMSEntry=gtHMSEntry, gtSettingsObjects=gtSettingsObjects, gtInterfaceDHCPState=gtInterfaceDHCPState, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTimeUTC=gtTimeUTC, gtNetworkEntry=gtNetworkEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtPortsEntry=gtPortsEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestNumber=gtTrapDestNumber, gtSFPPlugged=gtSFPPlugged, gtAccesslistTable=gtAccesslistTable, gtNTPServerTable=gtNTPServerTable, gtInterfaceTable=gtInterfaceTable, gtAccesslistName=gtAccesslistName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestRowStatus=gtTrapDestRowStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleBackupTable=gtModuleBackupTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtAgentComWriteString=gtAgentComWriteString, gtSyslogTable=gtSyslogTable, gtSyslogEntry=gtSyslogEntry, gtTrapDestPort=gtTrapDestPort, gtBackupStatus=gtBackupStatus, gtPortsTable=gtPortsTable, gtServicesTable=gtServicesTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceCLI=gtInterfaceCLI, gtSFTPServer=gtSFTPServer, gtPortsNumber=gtPortsNumber, gtCurrentUserPassword=gtCurrentUserPassword, gtChassisRedundancy=gtChassisRedundancy, gtSyslogState=gtSyslogState, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSLATable=gtSLATable, gtAgentPort=gtAgentPort, gtUpdateControl=gtUpdateControl, gtInterfaceStreaming=gtInterfaceStreaming, gtUserAccesslist=gtUserAccesslist, gtUserTable=gtUserTable, gtSettingsConformance=gtSettingsConformance, gtAccesslistIdx=gtAccesslistIdx, gtTimeLocal=gtTimeLocal, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSLAEntry=gtSLAEntry, gtDNSServerIP=gtDNSServerIP, gtUserAuthTable=gtUserAuthTable, gtInterfaceNumber=gtInterfaceNumber, gtTrapPDU=gtTrapPDU, gtSLARegistered=gtSLARegistered, gtFilename=gtFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGeneral=gtGeneral, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPPassword=gtBackupSFTPPassword, gtWebEnable=gtWebEnable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupControl=gtBackupControl, gtUserPassword=gtUserPassword, gtNetworkName=gtNetworkName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSyslogIP=gtSyslogIP, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceIGMP=gtInterfaceIGMP, gtUserGroup=gtUserGroup, gtSWOption=gtSWOption, gtUserRowStatus=gtUserRowStatus, gtSwitch=gtSwitch, gtSettingsGroups=gtSettingsGroups, gtPortsLinkup=gtPortsLinkup, gtDNSEntry=gtDNSEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUser=gtUser, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFPEntry=gtSFPEntry, gtUserIdx=gtUserIdx, gtSFPSpeed=gtSFPSpeed, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkTable=gtNetworkTable, gtGroupRights=gtGroupRights, gtHMSNumMembers=gtHMSNumMembers, gtTrapState=gtTrapState, gtGroupTable=gtGroupTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserEntry=gtUserEntry, gtUpdateStatus=gtUpdateStatus, gtNumSFP=gtNumSFP, gtModuleBackup=gtModuleBackup, gtNetworkVLAN=gtNetworkVLAN, gtSFTPPassword=gtSFTPPassword, gtDateAndTime=gtDateAndTime, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDNSTable=gtDNSTable, gtGroupParamIdx=gtGroupParamIdx, gtNTPServerEntry=gtNTPServerEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsCompliances=gtSettingsCompliances, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPPort=gtBackupSFTPPort, gtTrapUser=gtTrapUser, gtPortsName=gtPortsName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFPNumber=gtSFPNumber, gtInterfaceName=gtInterfaceName, gtUpdateFile=gtUpdateFile, gtNTPServerNumber=gtNTPServerNumber, gtDNSNumber=gtDNSNumber, gtAgentComReadString=gtAgentComReadString, gtSFPLink=gtSFPLink, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtGroupIdx=gtGroupIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPPort=gtSFTPPort, gtInterfaceSNMP=gtInterfaceSNMP, gtHMSTable=gtHMSTable, gtSettingsMIB=gtSettingsMIB, gtTrapDestTable=gtTrapDestTable, gtNetworking=gtNetworking, gtSNMPEntry=gtSNMPEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtHMSComMethod=gtHMSComMethod, gtCurrentTimeSource=gtCurrentTimeSource, gtNTPServerAddress=gtNTPServerAddress, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSWOptionsEntry=gtSWOptionsEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistEntry=gtAccesslistEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortState=gtNetworkPortState, gtServices=gtServices, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserName=gtUserName, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapComString=gtTrapComString, gtWebProtocol=gtWebProtocol, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortNumber=gtNetworkPortNumber, gtUserParamIdx=gtUserParamIdx, gtSFPType=gtSFPType, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentState=gtAgentState, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSWOptionsIdx=gtSWOptionsIdx, gtTimeZone=gtTimeZone, gtServicesEntry=gtServicesEntry, gtSFTPUsername=gtSFTPUsername, gtSettingsNotifications=gtSettingsNotifications, gtBackupSFTPServer=gtBackupSFTPServer, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtGroupEntry=gtGroupEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUserAuthEntry=gtUserAuthEntry, gtModuleBackupDate=gtModuleBackupDate, gtModuleUpdate=gtModuleUpdate, gtGroupName=gtGroupName, PYSNMP_MODULE_ID=gtSettingsMIB, gtSLAExpires=gtSLAExpires, gtNetworkPortName=gtNetworkPortName, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceMAC=gtInterfaceMAC, gtTrapDestIP=gtTrapDestIP)
