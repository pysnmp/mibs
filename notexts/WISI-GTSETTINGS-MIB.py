...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter32, NotificationType, Unsigned32, IpAddress, TimeTicks, ObjectIdentity, ModuleIdentity, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter32", "NotificationType", "Unsigned32", "IpAddress", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtCurrentUserName=gtCurrentUserName, gtInterfaceNumber=gtInterfaceNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapComString=gtTrapComString, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFTPPassword=gtSFTPPassword, gtServicesEntry=gtServicesEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserAccesslist=gtUserAccesslist, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceIPv4=gtInterfaceIPv4, gtUserEntry=gtUserEntry, gtUserIdx=gtUserIdx, gtAccesslistEntry=gtAccesslistEntry, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNetworking=gtNetworking, gtGroupRights=gtGroupRights, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsGroups=gtSettingsGroups, gtSNMP=gtSNMP, gtInterfaceName=gtInterfaceName, gtGroupEntry=gtGroupEntry, gtSyslogEntry=gtSyslogEntry, gtGroupAccesslist=gtGroupAccesslist, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtFilename=gtFilename, gtSWOption=gtSWOption, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSettingsObjects=gtSettingsObjects, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsEntry=gtPortsEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtDNSServerIP=gtDNSServerIP, gtAccesslistIdx=gtAccesslistIdx, gtUserAuthTable=gtUserAuthTable, gtPortsLinkup=gtPortsLinkup, gtHMSNumMembers=gtHMSNumMembers, gtNetworkEntry=gtNetworkEntry, gtUserGroup=gtUserGroup, gtTrapState=gtTrapState, gtWebAuth=gtWebAuth, gtSFPNumber=gtSFPNumber, gtTrapDestPort=gtTrapDestPort, gtSFTPPort=gtSFTPPort, gtTrapUser=gtTrapUser, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsNumber=gtPortsNumber, gtTrapPDU=gtTrapPDU, gtModuleBackupTable=gtModuleBackupTable, gtBackupControl=gtBackupControl, gtUpdateFilesTable=gtUpdateFilesTable, gtUserParamIdx=gtUserParamIdx, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceEntry=gtInterfaceEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceIGMP=gtInterfaceIGMP, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceTable=gtInterfaceTable, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackup=gtModuleBackup, gtAgentComReadString=gtAgentComReadString, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceStreaming=gtInterfaceStreaming, gtUserAuthEntry=gtUserAuthEntry, gtSNMPEntry=gtSNMPEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtTimeLocal=gtTimeLocal, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSNumber=gtDNSNumber, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkTable=gtNetworkTable, gtUserRowStatus=gtUserRowStatus, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNumSFP=gtNumSFP, gtSNMPTable=gtSNMPTable, gtAccesslistTable=gtAccesslistTable, gtAccesslistName=gtAccesslistName, gtSLARegistered=gtSLARegistered, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSLAEntry=gtSLAEntry, gtAgentState=gtAgentState, gtServices=gtServices, gtNTPServerNumber=gtNTPServerNumber, gtGeneral=gtGeneral, gtSFPSpeed=gtSFPSpeed, gtDNSEntry=gtDNSEntry, gtUserTable=gtUserTable, gtSyslogTable=gtSyslogTable, gtUpdateControl=gtUpdateControl, gtInterfaceState=gtInterfaceState, gtCurrentTimeSource=gtCurrentTimeSource, gtSWOptionsTable=gtSWOptionsTable, gtSFPPlugged=gtSFPPlugged, gtUser=gtUser, gtHMSEntry=gtHMSEntry, gtSettingsMIB=gtSettingsMIB, gtNTPServerTable=gtNTPServerTable, gtTrapDestIP=gtTrapDestIP, gtAgentPort=gtAgentPort, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsConformance=gtSettingsConformance, gtHMSGroupName=gtHMSGroupName, gtSFTPServer=gtSFTPServer, gtDNSTable=gtDNSTable, gtUpdateStatus=gtUpdateStatus, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSComMethod=gtHMSComMethod, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapDestTable=gtTrapDestTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPUsername=gtBackupSFTPUsername, gtGroupTable=gtGroupTable, gtModuleBackupControl=gtModuleBackupControl, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtDateAndTimeTable=gtDateAndTimeTable, gtUserAuthEnabled=gtUserAuthEnabled, gtNTPServerEntry=gtNTPServerEntry, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDateAndTime=gtDateAndTime, gtSFPTable=gtSFPTable, gtSettingsNotifications=gtSettingsNotifications, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPUsername=gtSFTPUsername, gtTimeUTC=gtTimeUTC, gtSLATable=gtSLATable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtWebProtocol=gtWebProtocol, gtHMSTable=gtHMSTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupIdx=gtGroupIdx, gtUserPassword=gtUserPassword, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsName=gtPortsName, gtTimeZone=gtTimeZone, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortName=gtNetworkPortName, gtUserName=gtUserName, gtModuleUpdate=gtModuleUpdate, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsTable=gtPortsTable, gtSyslogState=gtSyslogState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtModuleBackupEntry=gtModuleBackupEntry, gtSFPType=gtSFPType, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtDaylightAdjustment=gtDaylightAdjustment, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPEntry=gtSFPEntry, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSLAExpires=gtSLAExpires, gtUpdateFile=gtUpdateFile, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAgentComWriteString=gtAgentComWriteString, gtServicesTable=gtServicesTable, gtSwitch=gtSwitch, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFPLink=gtSFPLink, gtNetworkPortState=gtNetworkPortState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapDestEntry=gtTrapDestEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtNetworkName=gtNetworkName, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupName=gtGroupName, gtTrapDestNumber=gtTrapDestNumber, gtChassisRedundancy=gtChassisRedundancy, gtBackupStatus=gtBackupStatus, gtInterfaceCLI=gtInterfaceCLI, gtSyslogIP=gtSyslogIP, gtWebEnable=gtWebEnable)
