...
Gauge32, MibIdentifier, Integer32, IpAddress, Bits, Counter64, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Unsigned32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Integer32", "IpAddress", "Bits", "Counter64", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Unsigned32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPUsername=gtSFTPUsername, gtHMSNumAvailModules=gtHMSNumAvailModules, gtBackupSFTPServer=gtBackupSFTPServer, gtDateAndTime=gtDateAndTime, gtServicesEntry=gtServicesEntry, gtNumSFP=gtNumSFP, gtUserGroup=gtUserGroup, gtGroupRights=gtGroupRights, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapDestNumber=gtTrapDestNumber, gtNetworkName=gtNetworkName, gtSFTPPassword=gtSFTPPassword, gtSettingsCompliances=gtSettingsCompliances, gtPortsEntry=gtPortsEntry, gtInterfaceState=gtInterfaceState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPUsername=gtBackupSFTPUsername, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupIdx=gtGroupIdx, gtHMSTable=gtHMSTable, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupAccesslist=gtGroupAccesslist, gtUser=gtUser, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUserTable=gtUserTable, gtUserAuthTable=gtUserAuthTable, gtTrapPDU=gtTrapPDU, gtSyslogEntry=gtSyslogEntry, gtCurrentUserName=gtCurrentUserName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistTable=gtAccesslistTable, gtFilename=gtFilename, gtUserRowStatus=gtUserRowStatus, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUpdateFile=gtUpdateFile, gtDaylightAdjustment=gtDaylightAdjustment, gtTimeUTC=gtTimeUTC, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtBackupStatus=gtBackupStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserEntry=gtUserEntry, gtNTPServerEntry=gtNTPServerEntry, gtHMSComMethod=gtHMSComMethod, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleUpdate=gtModuleUpdate, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSyslogState=gtSyslogState, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSNMPTable=gtSNMPTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceTable=gtInterfaceTable, gtSNMP=gtSNMP, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkTable=gtNetworkTable, gtNTPServerAddress=gtNTPServerAddress, gtSFPTable=gtSFPTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtUserAccesslist=gtUserAccesslist, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceName=gtInterfaceName, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSWOptionsEntry=gtSWOptionsEntry, gtDNSTable=gtDNSTable, gtGroupTable=gtGroupTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtGeneral=gtGeneral, gtSWOptionsIdx=gtSWOptionsIdx, gtDateAndTimeTable=gtDateAndTimeTable, gtUserAuthEnabled=gtUserAuthEnabled, gtSFPEntry=gtSFPEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistEntry=gtAccesslistEntry, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestTable=gtTrapDestTable, gtNetworkPortName=gtNetworkPortName, gtSNMPEntry=gtSNMPEntry, gtBackupControl=gtBackupControl, gtWebAuth=gtWebAuth, gtSettingsNotifications=gtSettingsNotifications, gtTrapState=gtTrapState, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogTable=gtSyslogTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPType=gtSFPType, gtPortsLinkup=gtPortsLinkup, gtModuleBackupEntry=gtModuleBackupEntry, gtSLAExpires=gtSLAExpires, gtInterfaceIfIndex=gtInterfaceIfIndex, gtHMSNumMembers=gtHMSNumMembers, gtNetworking=gtNetworking, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceSNMP=gtInterfaceSNMP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleBackup=gtModuleBackup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleBackupControl=gtModuleBackupControl, gtUserPassword=gtUserPassword, gtGroupEntry=gtGroupEntry, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerRowStatus=gtNTPServerRowStatus, gtDNSServerIP=gtDNSServerIP, gtServicesTable=gtServicesTable, gtDNSEntry=gtDNSEntry, gtInterfaceNumber=gtInterfaceNumber, gtSettingsMIB=gtSettingsMIB, gtSyslogIP=gtSyslogIP, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFTPPort=gtSFTPPort, gtSLATable=gtSLATable, gtAgentComReadString=gtAgentComReadString, gtTrapUser=gtTrapUser, gtTrapComString=gtTrapComString, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTimeZone=gtTimeZone, gtSLAEntry=gtSLAEntry, gtTrapDestIP=gtTrapDestIP, gtTrapDestEntry=gtTrapDestEntry, gtSWOption=gtSWOption, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsGroups=gtSettingsGroups, gtSLARegistered=gtSLARegistered, gtSFTPServer=gtSFTPServer, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtAgentState=gtAgentState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtAgentPort=gtAgentPort, gtUserIdx=gtUserIdx, gtPortsTable=gtPortsTable, gtHMSGroupName=gtHMSGroupName, gtSettingsConformance=gtSettingsConformance, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkPortState=gtNetworkPortState, gtUserParamIdx=gtUserParamIdx, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSWOptionsTable=gtSWOptionsTable, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPNumber=gtSFPNumber, gtModuleBackupDate=gtModuleBackupDate, gtSFPLink=gtSFPLink, gtUpdateStatus=gtUpdateStatus, gtDNSNumber=gtDNSNumber, gtWebEnable=gtWebEnable, gtSFPPlugged=gtSFPPlugged, gtSwitch=gtSwitch, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceMAC=gtInterfaceMAC, gtGroupName=gtGroupName, gtUserAuthEntry=gtUserAuthEntry, gtNetworkEntry=gtNetworkEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtWebProtocol=gtWebProtocol, gtTimeLocal=gtTimeLocal, gtPortsNumber=gtPortsNumber, gtServices=gtServices, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortsTable=gtNetworkPortsTable, gtUserName=gtUserName, gtSettingsObjects=gtSettingsObjects, gtSFPSpeed=gtSFPSpeed, gtAccesslistName=gtAccesslistName, gtUpdateControl=gtUpdateControl, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupTable=gtModuleBackupTable, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSEntry=gtHMSEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtPortsName=gtPortsName, gtNTPServerTable=gtNTPServerTable)
