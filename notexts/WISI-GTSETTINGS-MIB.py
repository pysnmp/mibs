...
Counter32, Bits, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, iso, TimeTicks, Counter64, Integer32, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "iso", "TimeTicks", "Counter64", "Integer32", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPServer=gtSFTPServer, gtSyslogTable=gtSyslogTable, gtTrapComString=gtTrapComString, gtModuleUpdate=gtModuleUpdate, gtModuleBackupStatus=gtModuleBackupStatus, gtHMSEntry=gtHMSEntry, gtAgentPort=gtAgentPort, gtHMSNumMembers=gtHMSNumMembers, gtPortsNumber=gtPortsNumber, gtTrapDestPort=gtTrapDestPort, gtTrapState=gtTrapState, gtTrapUser=gtTrapUser, gtSettingsConformance=gtSettingsConformance, gtAccesslistName=gtAccesslistName, gtGeneral=gtGeneral, gtSFPEntry=gtSFPEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtSNMP=gtSNMP, gtDateAndTime=gtDateAndTime, gtDateAndTimeTable=gtDateAndTimeTable, gtUserAuthTable=gtUserAuthTable, gtNumSFP=gtNumSFP, gtSettingsMIB=gtSettingsMIB, gtWebEnable=gtWebEnable, gtSettingsNotifications=gtSettingsNotifications, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceTable=gtInterfaceTable, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsLinkup=gtPortsLinkup, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapDestEntry=gtTrapDestEntry, gtAgentState=gtAgentState, gtGroupAccesslist=gtGroupAccesslist, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserGroup=gtUserGroup, gtNetworkEntry=gtNetworkEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtDNSTable=gtDNSTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQueryInterval=gtIGMPQueryInterval, gtGroupName=gtGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSyslogState=gtSyslogState, gtDNSNumber=gtDNSNumber, gtChassisRedundancy=gtChassisRedundancy, gtBackupControl=gtBackupControl, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupIdx=gtGroupIdx, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAccesslistIPRange=gtAccesslistIPRange, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleBackup=gtModuleBackup, gtSettingsCompliances=gtSettingsCompliances, gtUserParamIdx=gtUserParamIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSLATable=gtSLATable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAuthEntry=gtUserAuthEntry, gtSettingsObjects=gtSettingsObjects, gtInterfaceMAC=gtInterfaceMAC, gtTimeUTC=gtTimeUTC, gtAgentComReadString=gtAgentComReadString, gtUserEntry=gtUserEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupSFTPPort=gtBackupSFTPPort, gtAccesslistIdx=gtAccesslistIdx, gtUserTable=gtUserTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapPDU=gtTrapPDU, gtPortsEntry=gtPortsEntry, gtDNSEntry=gtDNSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAgentComWriteString=gtAgentComWriteString, gtSFPPlugged=gtSFPPlugged, gtHMSTable=gtHMSTable, gtGroupRights=gtGroupRights, gtCurrentUserName=gtCurrentUserName, gtDNSServerIP=gtDNSServerIP, gtNetworkPortsEntry=gtNetworkPortsEntry, gtWebAuth=gtWebAuth, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFPNumber=gtSFPNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSLAExpires=gtSLAExpires, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSNMPEntry=gtSNMPEntry, gtAccesslistTable=gtAccesslistTable, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsName=gtPortsName, gtInterfaceState=gtInterfaceState, gtUpdateStatus=gtUpdateStatus, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkPortName=gtNetworkPortName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortState=gtNetworkPortState, gtUpdateFile=gtUpdateFile, gtUserRowStatus=gtUserRowStatus, gtSLARegistered=gtSLARegistered, gtSFTPUsername=gtSFTPUsername, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupDate=gtModuleBackupDate, gtGroupEntry=gtGroupEntry, gtNTPServerTable=gtNTPServerTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSNMPTable=gtSNMPTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceEntry=gtInterfaceEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtGroupParamIdx=gtGroupParamIdx, gtNetworking=gtNetworking, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateControl=gtUpdateControl, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapDestIP=gtTrapDestIP, gtSFTPPassword=gtSFTPPassword, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceName=gtInterfaceName, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceCLI=gtInterfaceCLI, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtServicesEntry=gtServicesEntry, gtPortsTable=gtPortsTable, gtSFPSpeed=gtSFPSpeed, gtTimeLocal=gtTimeLocal, gtUserIdx=gtUserIdx, gtFilename=gtFilename, gtUserPassword=gtUserPassword, gtUser=gtUser, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserName=gtUserName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerAddress=gtNTPServerAddress, gtBackupStatus=gtBackupStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtSyslogIP=gtSyslogIP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestRowStatus=gtTrapDestRowStatus, gtServicesTable=gtServicesTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceVLAN=gtInterfaceVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFTPPort=gtSFTPPort, gtSLAEntry=gtSLAEntry, gtNetworkTable=gtNetworkTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtGroupTable=gtGroupTable, gtSFPType=gtSFPType, gtSwitch=gtSwitch, gtSettingsGroups=gtSettingsGroups, gtSWOptionsTable=gtSWOptionsTable, gtSFPTable=gtSFPTable, gtTrapDestTable=gtTrapDestTable, gtNetworkVLAN=gtNetworkVLAN, gtHMSGroupName=gtHMSGroupName, gtSWOption=gtSWOption, gtSFPLink=gtSFPLink, gtServices=gtServices, gtUserAccesslist=gtUserAccesslist, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSyslogEntry=gtSyslogEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceNumber=gtInterfaceNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtTimeZone=gtTimeZone, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAccesslistEntry=gtAccesslistEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtHMSComMethod=gtHMSComMethod, gtNTPServerNumber=gtNTPServerNumber, gtWebProtocol=gtWebProtocol, gtNetworkName=gtNetworkName)
