...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, iso, IpAddress, Counter64, Integer32, Unsigned32, MibIdentifier, Bits, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "IpAddress", "Counter64", "Integer32", "Unsigned32", "MibIdentifier", "Bits", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleBackup=gtModuleBackup, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAccesslistTable=gtAccesslistTable, gtUserIdx=gtUserIdx, gtNetworkName=gtNetworkName, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHeadendSystemManagement=gtHeadendSystemManagement, gtModuleUpdate=gtModuleUpdate, gtSWOptionsIdx=gtSWOptionsIdx, gtSFPNumber=gtSFPNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSWOption=gtSWOption, gtPortsTable=gtPortsTable, gtAgentPort=gtAgentPort, gtInterfaceTable=gtInterfaceTable, gtSLATable=gtSLATable, gtModuleBackupTable=gtModuleBackupTable, gtGroupTable=gtGroupTable, gtTrapDestNumber=gtTrapDestNumber, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPUsername=gtBackupSFTPUsername, gtCurrentTimeSource=gtCurrentTimeSource, gtSFPSpeed=gtSFPSpeed, gtBackupControl=gtBackupControl, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsObjects=gtSettingsObjects, gtGroupName=gtGroupName, gtAgentState=gtAgentState, gtSFTPPassword=gtSFTPPassword, gtTrapDestTable=gtTrapDestTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserRowStatus=gtUserRowStatus, gtUserAuthEntry=gtUserAuthEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsConformance=gtSettingsConformance, gtUser=gtUser, gtSettingsCompliances=gtSettingsCompliances, gtUpdateControl=gtUpdateControl, gtInterfaceState=gtInterfaceState, gtInterfaceVLAN=gtInterfaceVLAN, gtTimeUTC=gtTimeUTC, gtDNSServerIP=gtDNSServerIP, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapUser=gtTrapUser, gtGeneral=gtGeneral, gtModuleBackupDate=gtModuleBackupDate, gtSFTPUsername=gtSFTPUsername, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtFilename=gtFilename, gtWebAuth=gtWebAuth, gtSNMP=gtSNMP, gtTrapPDU=gtTrapPDU, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkPortState=gtNetworkPortState, gtInterfaceNumber=gtInterfaceNumber, gtNetworkTable=gtNetworkTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtWebProtocol=gtWebProtocol, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFPEntry=gtSFPEntry, gtNTPServerAddress=gtNTPServerAddress, gtHMSNumAvailModules=gtHMSNumAvailModules, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceEntry=gtInterfaceEntry, gtSNMPTable=gtSNMPTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserName=gtUserName, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDNSEntry=gtDNSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtTimeLocal=gtTimeLocal, gtInterfaceIPv4=gtInterfaceIPv4, gtUserParamIdx=gtUserParamIdx, gtSFTPPort=gtSFTPPort, gtTrapState=gtTrapState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserAuthTable=gtUserAuthTable, gtNetworking=gtNetworking, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserPassword=gtUserPassword, gtUpdateStatus=gtUpdateStatus, gtPortsEntry=gtPortsEntry, gtInterfaceName=gtInterfaceName, gtSyslogTable=gtSyslogTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkEntry=gtNetworkEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserAccesslist=gtUserAccesslist, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupEntry=gtGroupEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceMAC=gtInterfaceMAC, gtSLAEntry=gtSLAEntry, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapComString=gtTrapComString, gtTrapDestIP=gtTrapDestIP, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateFile=gtUpdateFile, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsMIB=gtSettingsMIB, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNTPServerTable=gtNTPServerTable, gtNTPServerEntry=gtNTPServerEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkVLAN=gtNetworkVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUserTable=gtUserTable, gtUserEntry=gtUserEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtCurrentUserName=gtCurrentUserName, gtAgentComReadString=gtAgentComReadString, gtAccesslistIdx=gtAccesslistIdx, gtHMSTable=gtHMSTable, gtSFPPlugged=gtSFPPlugged, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkPortName=gtNetworkPortName, gtPortsName=gtPortsName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupIdx=gtGroupIdx, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtWebEnable=gtWebEnable, gtDNSNumber=gtDNSNumber, gtDNSTable=gtDNSTable, gtNTPServerNumber=gtNTPServerNumber, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtServicesEntry=gtServicesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSLAExpires=gtSLAExpires, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSyslogState=gtSyslogState, gtTrapDestPort=gtTrapDestPort, gtServicesTable=gtServicesTable, gtSFPType=gtSFPType, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtHMSNumMembers=gtHMSNumMembers, gtSFTPServer=gtSFTPServer, gtSwitch=gtSwitch, gtSettingsNotifications=gtSettingsNotifications, gtSWOptionsTable=gtSWOptionsTable, gtSFPLink=gtSFPLink, gtHMSGroupName=gtHMSGroupName, gtHMSComMethod=gtHMSComMethod, gtHMSEntry=gtHMSEntry, gtDateAndTime=gtDateAndTime, gtDaylightAdjustment=gtDaylightAdjustment, gtChassisRedundancy=gtChassisRedundancy, gtSyslogIP=gtSyslogIP, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistName=gtAccesslistName, gtUserGroup=gtUserGroup, gtAccesslistEntry=gtAccesslistEntry, gtSettingsGroups=gtSettingsGroups, gtPortsLinkup=gtPortsLinkup, gtNumSFP=gtNumSFP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDateAndTimeTable=gtDateAndTimeTable, gtPortsNumber=gtPortsNumber, gtSLARegistered=gtSLARegistered, gtGroupAccesslist=gtGroupAccesslist, gtGroupRights=gtGroupRights, gtCurrentUserPassword=gtCurrentUserPassword, gtSyslogEntry=gtSyslogEntry, gtServices=gtServices, gtSNMPEntry=gtSNMPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtTimeZone=gtTimeZone, gtSFPTable=gtSFPTable, gtBackupStatus=gtBackupStatus)
