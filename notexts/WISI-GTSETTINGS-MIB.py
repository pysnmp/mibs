...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, iso, Bits, IpAddress, Counter64, Unsigned32, ObjectIdentity, Gauge32, Counter32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "iso", "Bits", "IpAddress", "Counter64", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSLAEntry=gtSLAEntry, gtGroupName=gtGroupName, gtUserParamIdx=gtUserParamIdx, gtUserGroup=gtUserGroup, gtUpdateFile=gtUpdateFile, gtModuleUpdate=gtModuleUpdate, gtTimeUTC=gtTimeUTC, gtModuleBackupTable=gtModuleBackupTable, gtGroupRights=gtGroupRights, gtDNSTable=gtDNSTable, gtSNMPEntry=gtSNMPEntry, gtWebAuth=gtWebAuth, gtNTPServerAddress=gtNTPServerAddress, gtUserAuthTable=gtUserAuthTable, gtSFTPPassword=gtSFTPPassword, gtTrapDestTable=gtTrapDestTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserIdx=gtUserIdx, gtNetworking=gtNetworking, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortState=gtNetworkPortState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTimeLocal=gtTimeLocal, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtDNSServerIP=gtDNSServerIP, gtPortsName=gtPortsName, gtCurrentTimeSource=gtCurrentTimeSource, gtAccesslistEntry=gtAccesslistEntry, gtUserEntry=gtUserEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackup=gtModuleBackup, gtSwitch=gtSwitch, gtCurrentUserPassword=gtCurrentUserPassword, gtSLAExpires=gtSLAExpires, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSNMP=gtSNMP, gtHMSGroupName=gtHMSGroupName, gtSettingsConformance=gtSettingsConformance, gtSFPPlugged=gtSFPPlugged, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOptionsEntry=gtSWOptionsEntry, gtUserAccesslist=gtUserAccesslist, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistName=gtAccesslistName, gtNetworkTable=gtNetworkTable, gtInterfaceVLAN=gtInterfaceVLAN, gtFilename=gtFilename, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapComString=gtTrapComString, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserTable=gtUserTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtServicesEntry=gtServicesEntry, gtTrapPDU=gtTrapPDU, gtHeadendSystemManagement=gtHeadendSystemManagement, gtWebEnable=gtWebEnable, gtWebProtocol=gtWebProtocol, gtAgentComReadString=gtAgentComReadString, gtUpdateFilesEntry=gtUpdateFilesEntry, gtServices=gtServices, gtDateAndTime=gtDateAndTime, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSyslogIP=gtSyslogIP, gtInterfaceEntry=gtInterfaceEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtUserName=gtUserName, gtSFTPUsername=gtSFTPUsername, gtNetworkName=gtNetworkName, gtGroupTable=gtGroupTable, gtSettingsMIB=gtSettingsMIB, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapUser=gtTrapUser, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapState=gtTrapState, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceCLI=gtInterfaceCLI, gtSLARegistered=gtSLARegistered, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtSLATable=gtSLATable, gtUpdateControl=gtUpdateControl, gtNTPServerNumber=gtNTPServerNumber, gtNumSFP=gtNumSFP, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPEntry=gtSFPEntry, gtHMSTable=gtHMSTable, gtSNMPTable=gtSNMPTable, gtTrapDestIP=gtTrapDestIP, gtGroupEntry=gtGroupEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsNumber=gtPortsNumber, gtAgentPort=gtAgentPort, gtAccesslistTable=gtAccesslistTable, gtBackupStatus=gtBackupStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogTable=gtSyslogTable, gtSettingsObjects=gtSettingsObjects, gtNetworkPortsTable=gtNetworkPortsTable, gtGroupIdx=gtGroupIdx, gtHMSComMethod=gtHMSComMethod, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFPTable=gtSFPTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNTPServerEntry=gtNTPServerEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNTPServerTable=gtNTPServerTable, gtTrapDestPort=gtTrapDestPort, gtGeneral=gtGeneral, gtUserPassword=gtUserPassword, gtTrapDestEntry=gtTrapDestEntry, gtSFTPServer=gtSFTPServer, gtInterfaceNumber=gtInterfaceNumber, gtSFPType=gtSFPType, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkEntry=gtNetworkEntry, gtPortsEntry=gtPortsEntry, gtInterfaceTable=gtInterfaceTable, gtInterfaceStreaming=gtInterfaceStreaming, gtDateAndTimeTable=gtDateAndTimeTable, gtDNSNumber=gtDNSNumber, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceState=gtInterfaceState, gtServicesTable=gtServicesTable, gtUserRowStatus=gtUserRowStatus, gtAgentState=gtAgentState, gtSFTPPort=gtSFTPPort, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsCompliances=gtSettingsCompliances, gtTrapDestNumber=gtTrapDestNumber, gtHMSNumMembers=gtHMSNumMembers, gtGroupParamIdx=gtGroupParamIdx, gtDaylightAdjustment=gtDaylightAdjustment, gtCurrentUserName=gtCurrentUserName, gtNetworkPortName=gtNetworkPortName, gtModuleRedundancyMode=gtModuleRedundancyMode, gtPortsFloodMulticast=gtPortsFloodMulticast, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSEntry=gtDNSEntry, gtSWOption=gtSWOption, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceName=gtInterfaceName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsGroups=gtSettingsGroups, gtNetworkPortNumber=gtNetworkPortNumber, gtAgentComWriteString=gtAgentComWriteString, gtUpdateStatus=gtUpdateStatus, gtNetworkVLAN=gtNetworkVLAN, gtSWOptionsTable=gtSWOptionsTable, gtPortsLinkup=gtPortsLinkup, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, PYSNMP_MODULE_ID=gtSettingsMIB, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsTable=gtPortsTable, gtSFPNumber=gtSFPNumber, gtGroupAccesslist=gtGroupAccesslist, gtSFPSpeed=gtSFPSpeed, gtUser=gtUser, gtHMSNumAvailModules=gtHMSNumAvailModules, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTimeZone=gtTimeZone, gtSyslogEntry=gtSyslogEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtSyslogState=gtSyslogState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsNotifications=gtSettingsNotifications, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupControl=gtBackupControl, gtSFPLink=gtSFPLink, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtChassisRedundancy=gtChassisRedundancy, gtHMSEntry=gtHMSEntry, gtInterfaceDHCPState=gtInterfaceDHCPState)
