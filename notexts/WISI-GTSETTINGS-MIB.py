...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, TimeTicks, Counter32, IpAddress, Gauge32, NotificationType, Counter64, iso, MibIdentifier, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter32", "IpAddress", "Gauge32", "NotificationType", "Counter64", "iso", "MibIdentifier", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPServer=gtSFTPServer, gtSNMPEntry=gtSNMPEntry, gtGroupIdx=gtGroupIdx, gtSyslogState=gtSyslogState, gtModuleBackup=gtModuleBackup, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSTable=gtDNSTable, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupControl=gtBackupControl, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserTable=gtUserTable, gtAgentComWriteString=gtAgentComWriteString, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceVLAN=gtInterfaceVLAN, gtFilename=gtFilename, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUserName=gtUserName, gtGroupEntry=gtGroupEntry, gtTrapUser=gtTrapUser, gtSFTPPassword=gtSFTPPassword, gtTrapDestIP=gtTrapDestIP, gtTrapDestNumber=gtTrapDestNumber, gtSLARegistered=gtSLARegistered, gtInterfaceNumber=gtInterfaceNumber, gtTrapPDU=gtTrapPDU, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTimeLocal=gtTimeLocal, gtGroupAccesslist=gtGroupAccesslist, gtWebEnable=gtWebEnable, gtAgentComReadString=gtAgentComReadString, gtInterfaceIGMP=gtInterfaceIGMP, gtCurrentTimeSource=gtCurrentTimeSource, gtAccesslistTable=gtAccesslistTable, gtSFPTable=gtSFPTable, gtUpdateStatus=gtUpdateStatus, gtAccesslistEntry=gtAccesslistEntry, gtUserIdx=gtUserIdx, gtSNMP=gtSNMP, gtTrapDestEntry=gtTrapDestEntry, gtUserEntry=gtUserEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDaylightAdjustment=gtDaylightAdjustment, gtGroupParamIdx=gtGroupParamIdx, gtDNSServerIP=gtDNSServerIP, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFTPUsername=gtSFTPUsername, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerEntry=gtNTPServerEntry, gtUserParamIdx=gtUserParamIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceState=gtInterfaceState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSWOptionsEntry=gtSWOptionsEntry, gtHMSTable=gtHMSTable, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistName=gtAccesslistName, gtTrapDestTable=gtTrapDestTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupStatus=gtBackupStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceRowStatus=gtInterfaceRowStatus, gtPortsNumber=gtPortsNumber, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtPortsEntry=gtPortsEntry, gtInterfaceEntry=gtInterfaceEntry, gtServicesTable=gtServicesTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSLAExpires=gtSLAExpires, gtNetworkPortNumber=gtNetworkPortNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtSFPPlugged=gtSFPPlugged, gtHMSComMethod=gtHMSComMethod, gtUserPassword=gtUserPassword, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSwitch=gtSwitch, gtTrapDestPort=gtTrapDestPort, gtGroupTable=gtGroupTable, gtInterfaceMAC=gtInterfaceMAC, gtTrapComString=gtTrapComString, gtSettingsGroups=gtSettingsGroups, gtDNSNumber=gtDNSNumber, gtGeneral=gtGeneral, gtDateAndTime=gtDateAndTime, gtUpdateFile=gtUpdateFile, gtPortsLinkup=gtPortsLinkup, gtSettingsMIB=gtSettingsMIB, gtNetworkEntry=gtNetworkEntry, gtInterfaceCLI=gtInterfaceCLI, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkVLAN=gtNetworkVLAN, gtSettingsNotifications=gtSettingsNotifications, gtHMSEntry=gtHMSEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceStreaming=gtInterfaceStreaming, gtGroupRights=gtGroupRights, gtInterfaceName=gtInterfaceName, gtModuleBackupControl=gtModuleBackupControl, gtAccesslistIdx=gtAccesslistIdx, gtAgentSecurityLevel=gtAgentSecurityLevel, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupTable=gtModuleBackupTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtServices=gtServices, gtUserAuthEntry=gtUserAuthEntry, gtSFTPPort=gtSFTPPort, gtUserGroup=gtUserGroup, gtPortsTable=gtPortsTable, gtTimeUTC=gtTimeUTC, gtWebAuth=gtWebAuth, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkName=gtNetworkName, gtInterfaceTable=gtInterfaceTable, gtCurrentUserPassword=gtCurrentUserPassword, gtUserAccesslist=gtUserAccesslist, gtSNMPTable=gtSNMPTable, gtNTPServerNumber=gtNTPServerNumber, gtSyslogTable=gtSyslogTable, gtAccesslistIPRange=gtAccesslistIPRange, gtSyslogEntry=gtSyslogEntry, gtCurrentUserName=gtCurrentUserName, gtSFPType=gtSFPType, gtHMSNumMembers=gtHMSNumMembers, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceSNMP=gtInterfaceSNMP, gtSLAEntry=gtSLAEntry, gtAgentPort=gtAgentPort, gtModuleBackupEntry=gtModuleBackupEntry, gtNumSFP=gtNumSFP, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserAuthTable=gtUserAuthTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkTable=gtNetworkTable, gtNetworkPortName=gtNetworkPortName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPSpeed=gtSFPSpeed, gtChassisRedundancy=gtChassisRedundancy, gtUpdateControl=gtUpdateControl, gtPortsName=gtPortsName, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPNumber=gtSFPNumber, gtSWOption=gtSWOption, gtNetworkPortState=gtNetworkPortState, gtSLATable=gtSLATable, gtSyslogIP=gtSyslogIP, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUser=gtUser, gtUserRowStatus=gtUserRowStatus, gtSettingsCompliances=gtSettingsCompliances, gtSFPEntry=gtSFPEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFilesTable=gtUpdateFilesTable, gtServicesEntry=gtServicesEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtWebProtocol=gtWebProtocol, gtNTPServerTable=gtNTPServerTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTimeZone=gtTimeZone, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleUpdate=gtModuleUpdate, gtGroupName=gtGroupName, gtSWOptionsTable=gtSWOptionsTable, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFPLink=gtSFPLink, gtSettingsObjects=gtSettingsObjects, gtAgentState=gtAgentState, gtNetworking=gtNetworking, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSGroupName=gtHMSGroupName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapState=gtTrapState, gtDNSEntry=gtDNSEntry, gtNetworkPortsTable=gtNetworkPortsTable)
