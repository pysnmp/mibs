...
ModuleIdentity, IpAddress, Unsigned32, TimeTicks, Counter32, iso, Integer32, Bits, Counter64, NotificationType, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Unsigned32", "TimeTicks", "Counter32", "iso", "Integer32", "Bits", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogIP=gtSyslogIP, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTimeLocal=gtTimeLocal, gtSFPType=gtSFPType, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPPort=gtSFTPPort, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceRowStatus=gtInterfaceRowStatus, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapDestIP=gtTrapDestIP, gtGroupEntry=gtGroupEntry, gtSFPNumber=gtSFPNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleUpdate=gtModuleUpdate, gtNTPServerEntry=gtNTPServerEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSNumber=gtDNSNumber, gtSNMPTable=gtSNMPTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPPlugged=gtSFPPlugged, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtModuleBackupDate=gtModuleBackupDate, gtNTPServerTable=gtNTPServerTable, gtTrapDestNumber=gtTrapDestNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSLARegistered=gtSLARegistered, gtUpdateControl=gtUpdateControl, gtTrapSNMPVersion=gtTrapSNMPVersion, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortState=gtNetworkPortState, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSettingsMIB=gtSettingsMIB, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleBackupStatus=gtModuleBackupStatus, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapUser=gtTrapUser, gtNetworkEntry=gtNetworkEntry, gtGroupRights=gtGroupRights, gtUserPassword=gtUserPassword, gtTrapPDU=gtTrapPDU, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkTable=gtNetworkTable, gtHMSNumMembers=gtHMSNumMembers, gtSWOptionsTable=gtSWOptionsTable, gtGroupName=gtGroupName, gtUserEntry=gtUserEntry, gtAgentComWriteString=gtAgentComWriteString, gtCurrentTimeSource=gtCurrentTimeSource, gtChassisRedundancy=gtChassisRedundancy, gtTimeUTC=gtTimeUTC, gtServicesTable=gtServicesTable, gtAgentComReadString=gtAgentComReadString, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserAuthTable=gtUserAuthTable, gtModuleBackupControl=gtModuleBackupControl, gtUserParamIdx=gtUserParamIdx, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAuthEnabled=gtUserAuthEnabled, gtCurrentUserName=gtCurrentUserName, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserAccesslist=gtUserAccesslist, gtBackupControl=gtBackupControl, gtSFPLink=gtSFPLink, gtWebEnable=gtWebEnable, gtSettingsConformance=gtSettingsConformance, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserAuthEntry=gtUserAuthEntry, gtGroupTable=gtGroupTable, gtInterfaceName=gtInterfaceName, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceNumber=gtInterfaceNumber, gtBackupStatus=gtBackupStatus, gtPortsTable=gtPortsTable, gtAgentPort=gtAgentPort, gtSLAEntry=gtSLAEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSTable=gtDNSTable, gtInterfaceMAC=gtInterfaceMAC, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkName=gtNetworkName, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackup=gtModuleBackup, gtModuleBackupTable=gtModuleBackupTable, gtSFPTable=gtSFPTable, gtDaylightAdjustment=gtDaylightAdjustment, gtNTPServerAddress=gtNTPServerAddress, gtPortsNumber=gtPortsNumber, gtSFPEntry=gtSFPEntry, gtUserGroup=gtUserGroup, gtNetworkPortName=gtNetworkPortName, gtUpdateStatus=gtUpdateStatus, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSyslogTable=gtSyslogTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupIdx=gtGroupIdx, gtTrapDestTable=gtTrapDestTable, gtServicesEntry=gtServicesEntry, gtSettingsObjects=gtSettingsObjects, gtDateAndTimeTable=gtDateAndTimeTable, gtTimeZone=gtTimeZone, gtAccesslistEntry=gtAccesslistEntry, gtUserRowStatus=gtUserRowStatus, gtNetworking=gtNetworking, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDNSServerIP=gtDNSServerIP, gtSFTPUsername=gtSFTPUsername, gtHMSEntry=gtHMSEntry, gtUserName=gtUserName, gtInterfaceState=gtInterfaceState, gtSFTPServer=gtSFTPServer, gtNetworkVLAN=gtNetworkVLAN, gtServices=gtServices, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceSNMP=gtInterfaceSNMP, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapState=gtTrapState, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQueryInterval=gtIGMPQueryInterval, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsLinkup=gtPortsLinkup, gtInterfaceTable=gtInterfaceTable, gtSLATable=gtSLATable, gtSyslogEntry=gtSyslogEntry, gtPortsName=gtPortsName, gtSyslogState=gtSyslogState, gtTrapComString=gtTrapComString, gtWebProtocol=gtWebProtocol, gtUser=gtUser, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAccesslistTable=gtAccesslistTable, gtSNMP=gtSNMP, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSTable=gtHMSTable, gtHMSGroupName=gtHMSGroupName, gtSFPSpeed=gtSFPSpeed, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserIdx=gtUserIdx, gtWebAuth=gtWebAuth, gtHMSComMethod=gtHMSComMethod, gtAccesslistName=gtAccesslistName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNumSFP=gtNumSFP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtFilename=gtFilename, gtAccesslistIdx=gtAccesslistIdx, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSwitch=gtSwitch, gtTrapDestPort=gtTrapDestPort, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUpdateFile=gtUpdateFile, gtAccesslistIPRange=gtAccesslistIPRange, gtGroupParamIdx=gtGroupParamIdx, gtDateAndTime=gtDateAndTime, gtNTPServerNumber=gtNTPServerNumber, gtSNMPEntry=gtSNMPEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsEntry=gtPortsEntry, gtSWOption=gtSWOption, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupAccesslist=gtGroupAccesslist, gtDNSEntry=gtDNSEntry, gtGeneral=gtGeneral, gtInterfaceIPv4=gtInterfaceIPv4, gtSLAExpires=gtSLAExpires, gtInterfaceEntry=gtInterfaceEntry, gtUserTable=gtUserTable, gtSFTPPassword=gtSFTPPassword, gtInterfaceStreaming=gtInterfaceStreaming, gtAgentState=gtAgentState, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged)
