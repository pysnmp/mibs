...
Integer32, Counter64, ObjectIdentity, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Gauge32, Unsigned32, MibIdentifier, IpAddress, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ObjectIdentity", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Gauge32", "Unsigned32", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserAuthTable=gtUserAuthTable, gtGroupAccesslist=gtGroupAccesslist, gtGroupRights=gtGroupRights, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserTable=gtUserTable, gtUserAuthEntry=gtUserAuthEntry, gtSLATable=gtSLATable, gtModuleBackupDate=gtModuleBackupDate, gtNetworkEntry=gtNetworkEntry, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleBackupStatus=gtModuleBackupStatus, gtSFTPUsername=gtSFTPUsername, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPServer=gtBackupSFTPServer, gtUserGroup=gtUserGroup, gtModuleBackupTable=gtModuleBackupTable, gtNTPServerEntry=gtNTPServerEntry, gtSNMPTable=gtSNMPTable, gtSNMP=gtSNMP, gtUserName=gtUserName, gtDNSServerIP=gtDNSServerIP, gtTrapDestIP=gtTrapDestIP, gtTrapDestEntry=gtTrapDestEntry, gtWebProtocol=gtWebProtocol, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSyslogState=gtSyslogState, gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtCurrentUserPassword=gtCurrentUserPassword, gtHMSNumMembers=gtHMSNumMembers, gtSFPType=gtSFPType, PYSNMP_MODULE_ID=gtSettingsMIB, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGeneral=gtGeneral, gtFilename=gtFilename, gtSFPEntry=gtSFPEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapPDU=gtTrapPDU, gtSyslogEntry=gtSyslogEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSwitch=gtSwitch, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtWebEnable=gtWebEnable, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtHMSGroupName=gtHMSGroupName, gtSLAExpires=gtSLAExpires, gtTrapSecurityLevel=gtTrapSecurityLevel, gtServicesEntry=gtServicesEntry, gtSFTPPort=gtSFTPPort, gtDateAndTimeTable=gtDateAndTimeTable, gtSFTPPassword=gtSFTPPassword, gtCurrentTimeSource=gtCurrentTimeSource, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupName=gtGroupName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceMAC=gtInterfaceMAC, gtAccesslistEntry=gtAccesslistEntry, gtPortsName=gtPortsName, gtModuleBackup=gtModuleBackup, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNumSFP=gtNumSFP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDNSNumber=gtDNSNumber, gtTrapComString=gtTrapComString, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNTPServerTable=gtNTPServerTable, gtGroupIdx=gtGroupIdx, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateControl=gtUpdateControl, gtAccesslistTable=gtAccesslistTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapState=gtTrapState, gtSFPTable=gtSFPTable, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceCLI=gtInterfaceCLI, gtUserPassword=gtUserPassword, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceTable=gtInterfaceTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUpdateFile=gtUpdateFile, gtNetworkPortName=gtNetworkPortName, gtAccesslistName=gtAccesslistName, gtNTPServerNumber=gtNTPServerNumber, gtDNSEntry=gtDNSEntry, gtTimeLocal=gtTimeLocal, gtNTPServerRowStatus=gtNTPServerRowStatus, gtCurrentUserName=gtCurrentUserName, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSLAEntry=gtSLAEntry, gtSFTPServer=gtSFTPServer, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceName=gtInterfaceName, gtTimeZone=gtTimeZone, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtServicesTable=gtServicesTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAgentPort=gtAgentPort, gtTrapUser=gtTrapUser, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkVLAN=gtNetworkVLAN, gtBackupSFTPPort=gtBackupSFTPPort, gtSyslogIP=gtSyslogIP, gtSWOptionsTable=gtSWOptionsTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkName=gtNetworkName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtBackupControl=gtBackupControl, gtUser=gtUser, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAgentComWriteString=gtAgentComWriteString, gtUserIdx=gtUserIdx, gtPortsLinkup=gtPortsLinkup, gtNTPServerAddress=gtNTPServerAddress, gtServices=gtServices, gtSWOptionsEntry=gtSWOptionsEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceState=gtInterfaceState, gtNetworking=gtNetworking, gtTrapDestNumber=gtTrapDestNumber, gtAgentComReadString=gtAgentComReadString, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestTable=gtTrapDestTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPPlugged=gtSFPPlugged, gtUserAuthEnabled=gtUserAuthEnabled, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGroupTable=gtGroupTable, gtNetworkTable=gtNetworkTable, gtUpdateStatus=gtUpdateStatus, gtAgentState=gtAgentState, gtSyslogTable=gtSyslogTable, gtPortsEntry=gtPortsEntry, gtWebAuth=gtWebAuth, gtSFPLink=gtSFPLink, gtSettingsMIB=gtSettingsMIB, gtSettingsCompliances=gtSettingsCompliances, gtSettingsObjects=gtSettingsObjects, gtHMSEntry=gtHMSEntry, gtTrapDestPort=gtTrapDestPort, gtSWOption=gtSWOption, gtSettingsNotifications=gtSettingsNotifications, gtSFPSpeed=gtSFPSpeed, gtInterfaceSNMP=gtInterfaceSNMP, gtUserRowStatus=gtUserRowStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSLARegistered=gtSLARegistered, gtUserAccesslist=gtUserAccesslist, gtGroupEntry=gtGroupEntry, gtSNMPEntry=gtSNMPEntry, gtInterfaceNumber=gtInterfaceNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsNumber=gtPortsNumber, gtGroupParamIdx=gtGroupParamIdx, gtUserEntry=gtUserEntry, gtPortsTable=gtPortsTable, gtHMSTable=gtHMSTable, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceIGMP=gtInterfaceIGMP, gtDateAndTime=gtDateAndTime, gtTimeUTC=gtTimeUTC, gtSFPNumber=gtSFPNumber, gtChassisRedundancy=gtChassisRedundancy, gtDNSTable=gtDNSTable, gtModuleUpdate=gtModuleUpdate, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSettingsGroups=gtSettingsGroups, gtBackupStatus=gtBackupStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkPortState=gtNetworkPortState)
