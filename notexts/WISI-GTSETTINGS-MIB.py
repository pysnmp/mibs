...
Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ModuleIdentity, Counter64, Gauge32, ObjectIdentity, Bits, IpAddress, NotificationType, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "Bits", "IpAddress", "NotificationType", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNTPServerRowStatus=gtNTPServerRowStatus, gtCurrentUserName=gtCurrentUserName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFTPUsername=gtSFTPUsername, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserName=gtUserName, gtGroupRights=gtGroupRights, gtSNMPTable=gtSNMPTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceEntry=gtInterfaceEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleBackup=gtModuleBackup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPPort=gtSFTPPort, gtSyslogTable=gtSyslogTable, gtNetworkPortState=gtNetworkPortState, gtPortsTable=gtPortsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSLATable=gtSLATable, gtFilename=gtFilename, gtSettingsMIB=gtSettingsMIB, gtNumSFP=gtNumSFP, gtSWOptionsTable=gtSWOptionsTable, gtPortsName=gtPortsName, gtAccesslistIPRange=gtAccesslistIPRange, gtWebAuth=gtWebAuth, gtUserPassword=gtUserPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentComReadString=gtAgentComReadString, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapState=gtTrapState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceState=gtInterfaceState, gtTimeZone=gtTimeZone, gtSWOptionsEntry=gtSWOptionsEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSwitch=gtSwitch, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkPortName=gtNetworkPortName, gtAccesslistName=gtAccesslistName, gtCurrentUserPassword=gtCurrentUserPassword, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceName=gtInterfaceName, gtModuleRedundancyMode=gtModuleRedundancyMode, gtPortsLinkup=gtPortsLinkup, gtTrapComString=gtTrapComString, gtServices=gtServices, gtNetworkVLAN=gtNetworkVLAN, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsEntry=gtPortsEntry, gtPortsNumber=gtPortsNumber, gtChassisRedundancy=gtChassisRedundancy, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDNSServerIP=gtDNSServerIP, gtHMSComMethod=gtHMSComMethod, gtNetworkName=gtNetworkName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSEntry=gtHMSEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGeneral=gtGeneral, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerTable=gtNTPServerTable, gtTrapDestTable=gtTrapDestTable, gtUserAuthEnabled=gtUserAuthEnabled, gtGroupTable=gtGroupTable, gtNetworkTable=gtNetworkTable, gtTimeUTC=gtTimeUTC, gtUserIdx=gtUserIdx, gtSFPLink=gtSFPLink, gtHMSGroupName=gtHMSGroupName, gtNTPServerNumber=gtNTPServerNumber, gtSFTPServer=gtSFTPServer, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceSNMP=gtInterfaceSNMP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSLAEntry=gtSLAEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSLAExpires=gtSLAExpires, gtModuleUpdate=gtModuleUpdate, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSFPTable=gtSFPTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapDestRowStatus=gtTrapDestRowStatus, gtWebProtocol=gtWebProtocol, gtDNSEntry=gtDNSEntry, gtSFPPlugged=gtSFPPlugged, gtModuleBackupControl=gtModuleBackupControl, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogState=gtSyslogState, gtGroupAccesslist=gtGroupAccesslist, gtUserRowStatus=gtUserRowStatus, gtSLARegistered=gtSLARegistered, gtAccesslistIdx=gtAccesslistIdx, gtTimeLocal=gtTimeLocal, gtSettingsGroups=gtSettingsGroups, gtSFPEntry=gtSFPEntry, gtTrapDestNumber=gtTrapDestNumber, gtHMSTable=gtHMSTable, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworking=gtNetworking, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapUser=gtTrapUser, gtGroupEntry=gtGroupEntry, gtWebEnable=gtWebEnable, gtBackupControl=gtBackupControl, gtGroupName=gtGroupName, gtUserAuthEntry=gtUserAuthEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserEntry=gtUserEntry, gtSFTPPassword=gtSFTPPassword, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapSNMPVersion=gtTrapSNMPVersion, gtServicesTable=gtServicesTable, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSTable=gtDNSTable, gtUserTable=gtUserTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapDestIP=gtTrapDestIP, gtTrapDestEntry=gtTrapDestEntry, gtAgentPort=gtAgentPort, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleBackupDate=gtModuleBackupDate, gtSFPSpeed=gtSFPSpeed, gtDateAndTimeEntry=gtDateAndTimeEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtGroupIdx=gtGroupIdx, gtDNSNumber=gtDNSNumber, gtModuleBackupTable=gtModuleBackupTable, gtSFPNumber=gtSFPNumber, gtUserAccesslist=gtUserAccesslist, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogEntry=gtSyslogEntry, gtInterfaceMAC=gtInterfaceMAC, gtTrapDestPort=gtTrapDestPort, gtSFPType=gtSFPType, gtInterfaceTable=gtInterfaceTable, gtGroupParamIdx=gtGroupParamIdx, gtBackupStatus=gtBackupStatus, gtUpdateFile=gtUpdateFile, gtUserParamIdx=gtUserParamIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSNMPEntry=gtSNMPEntry, gtAccesslistTable=gtAccesslistTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceNumber=gtInterfaceNumber, gtDateAndTime=gtDateAndTime, gtModuleBackupEntry=gtModuleBackupEntry, gtUser=gtUser, gtUpdateControl=gtUpdateControl, gtInterfaceCLI=gtInterfaceCLI, gtSyslogIP=gtSyslogIP, gtAgentState=gtAgentState, gtUserGroup=gtUserGroup, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtHMSNumMembers=gtHMSNumMembers, gtServicesEntry=gtServicesEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtBackupSFTPPort=gtBackupSFTPPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNTPServerEntry=gtNTPServerEntry, gtSWOption=gtSWOption, gtNetworkEntry=gtNetworkEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsCompliances=gtSettingsCompliances, gtSettingsObjects=gtSettingsObjects, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceVLAN=gtInterfaceVLAN, gtSNMP=gtSNMP, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapPDU=gtTrapPDU, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserAuthTable=gtUserAuthTable, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerAddress=gtNTPServerAddress, gtUpdateStatus=gtUpdateStatus)
