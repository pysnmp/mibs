...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, IpAddress, iso, Bits, NotificationType, ModuleIdentity, Gauge32, MibIdentifier, TimeTicks, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "IpAddress", "iso", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "MibIdentifier", "TimeTicks", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPNumber=gtSFPNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsGroups=gtSettingsGroups, gtUserParamIdx=gtUserParamIdx, gtSLATable=gtSLATable, gtSWOption=gtSWOption, gtTrapDestPort=gtTrapDestPort, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogEntry=gtSyslogEntry, gtGroupEntry=gtGroupEntry, gtDNSEntry=gtDNSEntry, gtUpdateControl=gtUpdateControl, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUpdateFile=gtUpdateFile, gtGroupAccesslist=gtGroupAccesslist, gtNetworking=gtNetworking, gtSettingsCompliances=gtSettingsCompliances, gtNTPServerNumber=gtNTPServerNumber, gtNetworkVLAN=gtNetworkVLAN, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtServicesEntry=gtServicesEntry, gtSettingsConformance=gtSettingsConformance, gtSFPTable=gtSFPTable, gtSyslogState=gtSyslogState, gtInterfaceName=gtInterfaceName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapState=gtTrapState, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceTable=gtInterfaceTable, gtUserName=gtUserName, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPEntry=gtSFPEntry, gtSNMP=gtSNMP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSServerIP=gtDNSServerIP, gtHMSNumMembers=gtHMSNumMembers, gtPortsEntry=gtPortsEntry, gtInterfaceState=gtInterfaceState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtGroupTable=gtGroupTable, gtSLAExpires=gtSLAExpires, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackup=gtModuleBackup, gtInterfaceIPv4=gtInterfaceIPv4, gtSLARegistered=gtSLARegistered, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPPassword=gtSFTPPassword, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupControl=gtBackupControl, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceStreaming=gtInterfaceStreaming, gtSWOptionsIdx=gtSWOptionsIdx, gtAgentState=gtAgentState, gtModuleBackupEntry=gtModuleBackupEntry, gtNetworkName=gtNetworkName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserAccesslist=gtUserAccesslist, gtTrapComString=gtTrapComString, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtServicesTable=gtServicesTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSyslogTable=gtSyslogTable, gtPortsLinkup=gtPortsLinkup, gtAccesslistEntry=gtAccesslistEntry, gtNTPServerEntry=gtNTPServerEntry, gtNetworkPortState=gtNetworkPortState, gtSNMPTable=gtSNMPTable, gtUserIdx=gtUserIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleBackupStatus=gtModuleBackupStatus, gtSLAEntry=gtSLAEntry, gtInterfaceCLI=gtInterfaceCLI, gtSNMPEntry=gtSNMPEntry, gtUser=gtUser, gtTimeZone=gtTimeZone, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserPassword=gtUserPassword, gtUserEntry=gtUserEntry, gtWebAuth=gtWebAuth, gtNetworkTable=gtNetworkTable, gtTrapPDU=gtTrapPDU, gtTrapUser=gtTrapUser, gtInterfaceNumber=gtInterfaceNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAuthEntry=gtUserAuthEntry, gtUserGroup=gtUserGroup, gtSFTPPort=gtSFTPPort, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSettingsObjects=gtSettingsObjects, gtGeneral=gtGeneral, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceMAC=gtInterfaceMAC, gtAccesslistIdx=gtAccesslistIdx, gtSwitch=gtSwitch, gtHMSEntry=gtHMSEntry, gtNTPServerTable=gtNTPServerTable, gtAgentPort=gtAgentPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtCurrentUserName=gtCurrentUserName, gtModuleBackupDate=gtModuleBackupDate, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtGroupName=gtGroupName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNTPServerAddress=gtNTPServerAddress, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDNSNumber=gtDNSNumber, gtSFPType=gtSFPType, gtNTPServerRowStatus=gtNTPServerRowStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceVLAN=gtInterfaceVLAN, gtChassisRedundancy=gtChassisRedundancy, gtAgentComReadString=gtAgentComReadString, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsMIB=gtSettingsMIB, gtIGMPQueryInterval=gtIGMPQueryInterval, gtBackupStatus=gtBackupStatus, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestIP=gtTrapDestIP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTimeLocal=gtTimeLocal, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsTable=gtPortsTable, gtDNSTable=gtDNSTable, gtNetworkPortName=gtNetworkPortName, gtNetworkPortsTable=gtNetworkPortsTable, gtSWOptionsTable=gtSWOptionsTable, gtDateAndTime=gtDateAndTime, gtSFPPlugged=gtSFPPlugged, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFPLink=gtSFPLink, gtTrapDestTable=gtTrapDestTable, gtUserAuthTable=gtUserAuthTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtWebEnable=gtWebEnable, gtSettingsNotifications=gtSettingsNotifications, gtGroupIdx=gtGroupIdx, gtAccesslistName=gtAccesslistName, gtDaylightAdjustment=gtDaylightAdjustment, gtWebProtocol=gtWebProtocol, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFTPServer=gtSFTPServer, gtHMSTable=gtHMSTable, gtHMSGroupName=gtHMSGroupName, gtCurrentUserPassword=gtCurrentUserPassword, gtServices=gtServices, gtTimeUTC=gtTimeUTC, gtGroupRights=gtGroupRights, gtFilename=gtFilename, gtNetworkEntry=gtNetworkEntry, gtTrapDestNumber=gtTrapDestNumber, gtUserTable=gtUserTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNumSFP=gtNumSFP, gtSFPSpeed=gtSFPSpeed, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceSNMP=gtInterfaceSNMP, gtUserRowStatus=gtUserRowStatus, gtAccesslistTable=gtAccesslistTable, gtHMSComMethod=gtHMSComMethod, gtSyslogIP=gtSyslogIP, gtPortsNumber=gtPortsNumber, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateStatus=gtUpdateStatus, gtPortsName=gtPortsName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPUsername=gtSFTPUsername, gtSWOptionsEntry=gtSWOptionsEntry)
