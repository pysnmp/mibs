...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, IpAddress, Integer32, iso, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "IpAddress", "Integer32", "iso", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtGroupTable=gtGroupTable, gtHMSEntry=gtHMSEntry, gtAgentPort=gtAgentPort, gtServicesEntry=gtServicesEntry, gtGroupEntry=gtGroupEntry, gtWebEnable=gtWebEnable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapDestPort=gtTrapDestPort, gtTrapDestIP=gtTrapDestIP, gtTrapComString=gtTrapComString, gtSFTPPassword=gtSFTPPassword, gtModuleUpdate=gtModuleUpdate, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapPDU=gtTrapPDU, gtInterfaceName=gtInterfaceName, gtTimeLocal=gtTimeLocal, gtGroupRights=gtGroupRights, gtNTPServerAddress=gtNTPServerAddress, gtHMSComMethod=gtHMSComMethod, gtDNSEntry=gtDNSEntry, gtSNMPTable=gtSNMPTable, gtModuleBackup=gtModuleBackup, gtGroupParamIdx=gtGroupParamIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerTable=gtNTPServerTable, gtHMSGroupName=gtHMSGroupName, gtSyslogIP=gtSyslogIP, gtAgentState=gtAgentState, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceCLI=gtInterfaceCLI, gtSFPType=gtSFPType, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtAccesslistIdx=gtAccesslistIdx, gtWebAuth=gtWebAuth, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserGroup=gtUserGroup, gtServicesTable=gtServicesTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceTable=gtInterfaceTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupControl=gtModuleBackupControl, gtSNMP=gtSNMP, gtSettingsCompliances=gtSettingsCompliances, gtSWOptionsEntry=gtSWOptionsEntry, gtSFPSpeed=gtSFPSpeed, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserTable=gtUserTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSNMPEntry=gtSNMPEntry, gtGeneral=gtGeneral, gtModuleBackupTable=gtModuleBackupTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserRowStatus=gtUserRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkVLAN=gtNetworkVLAN, gtHMSNumMembers=gtHMSNumMembers, gtSLAEntry=gtSLAEntry, gtUserPassword=gtUserPassword, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistTable=gtAccesslistTable, gtNumSFP=gtNumSFP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsObjects=gtSettingsObjects, gtSettingsMIB=gtSettingsMIB, gtCurrentTimeSource=gtCurrentTimeSource, gtSettingsGroups=gtSettingsGroups, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceStreaming=gtInterfaceStreaming, gtUserEntry=gtUserEntry, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSyslogEntry=gtSyslogEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleBackupStatus=gtModuleBackupStatus, gtAgentComWriteString=gtAgentComWriteString, gtTimeUTC=gtTimeUTC, gtDateAndTime=gtDateAndTime, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDateAndTimeTable=gtDateAndTimeTable, gtFilename=gtFilename, gtTrapState=gtTrapState, gtPortsEntry=gtPortsEntry, gtUserAccesslist=gtUserAccesslist, gtNetworkTable=gtNetworkTable, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupIdx=gtGroupIdx, gtWebProtocol=gtWebProtocol, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestEntry=gtTrapDestEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtSFTPServer=gtSFTPServer, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceVLAN=gtInterfaceVLAN, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupEntry=gtModuleBackupEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupStatus=gtBackupStatus, gtTrapDestTable=gtTrapDestTable, gtSLARegistered=gtSLARegistered, gtDNSTable=gtDNSTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGroupName=gtGroupName, gtNetworkPortName=gtNetworkPortName, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapDestNumber=gtTrapDestNumber, gtSFTPUsername=gtSFTPUsername, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceNumber=gtInterfaceNumber, gtPortsLinkup=gtPortsLinkup, gtUserName=gtUserName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupSFTPPort=gtBackupSFTPPort, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTimeZone=gtTimeZone, gtBackupControl=gtBackupControl, gtPortsFloodMulticast=gtPortsFloodMulticast, gtCurrentUserName=gtCurrentUserName, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkEntry=gtNetworkEntry, gtUserParamIdx=gtUserParamIdx, gtSWOption=gtSWOption, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentComReadString=gtAgentComReadString, gtNTPServerEntry=gtNTPServerEntry, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceState=gtInterfaceState, gtUpdateControl=gtUpdateControl, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPPort=gtSFTPPort, gtPortsTable=gtPortsTable, gtSyslogTable=gtSyslogTable, gtNetworking=gtNetworking, gtSFPPlugged=gtSFPPlugged, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogState=gtSyslogState, gtUserIdx=gtUserIdx, gtSFPEntry=gtSFPEntry, gtSLATable=gtSLATable, gtAccesslistName=gtAccesslistName, gtTrapUser=gtTrapUser, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsConformance=gtSettingsConformance, gtSFPNumber=gtSFPNumber, gtSFPLink=gtSFPLink, gtUpdateFile=gtUpdateFile, gtUser=gtUser, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtServices=gtServices, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsName=gtPortsName, gtSwitch=gtSwitch, gtInterfaceIPv4=gtInterfaceIPv4, gtSWOptionsTable=gtSWOptionsTable, gtPortsNumber=gtPortsNumber, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNTPServerNumber=gtNTPServerNumber, gtNetworkName=gtNetworkName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAccesslistEntry=gtAccesslistEntry, gtNetworkPortState=gtNetworkPortState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFPTable=gtSFPTable, gtDNSNumber=gtDNSNumber, gtDNSServerIP=gtDNSServerIP, gtSLAExpires=gtSLAExpires, gtHMSTable=gtHMSTable)
