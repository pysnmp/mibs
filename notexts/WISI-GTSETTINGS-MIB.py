...
ModuleIdentity, Integer32, Bits, Gauge32, Counter32, Counter64, ObjectIdentity, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Bits", "Gauge32", "Counter32", "Counter64", "ObjectIdentity", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSLARegistered=gtSLARegistered, gtInterfaceCLI=gtInterfaceCLI, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsConformance=gtSettingsConformance, gtServicesTable=gtServicesTable, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupTable=gtModuleBackupTable, gtUserTable=gtUserTable, gtSNMPEntry=gtSNMPEntry, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPTable=gtSFPTable, gtUserRowStatus=gtUserRowStatus, gtServicesEntry=gtServicesEntry, gtCurrentUserName=gtCurrentUserName, gtDNSNumber=gtDNSNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtHMSComMethod=gtHMSComMethod, gtTrapDestEntry=gtTrapDestEntry, gtTrapState=gtTrapState, gtSyslogTable=gtSyslogTable, gtSettingsNotifications=gtSettingsNotifications, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSettingsMIB=gtSettingsMIB, gtPortsLinkup=gtPortsLinkup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtHMSTable=gtHMSTable, gtTimeUTC=gtTimeUTC, gtSLAEntry=gtSLAEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFTPServer=gtSFTPServer, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsName=gtPortsName, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAccesslistName=gtAccesslistName, gtFilename=gtFilename, gtUserEntry=gtUserEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPUsername=gtSFTPUsername, gtTrapComString=gtTrapComString, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNTPServerAddress=gtNTPServerAddress, gtHMSNumMembers=gtHMSNumMembers, gtNetworkEntry=gtNetworkEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSLAExpires=gtSLAExpires, gtUserIdx=gtUserIdx, gtHMSEntry=gtHMSEntry, gtTrapDestNumber=gtTrapDestNumber, gtUserPassword=gtUserPassword, gtBackupControl=gtBackupControl, gtUpdateControl=gtUpdateControl, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsObjects=gtSettingsObjects, gtInterfaceEntry=gtInterfaceEntry, gtSLATable=gtSLATable, gtAccesslistTable=gtAccesslistTable, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSTable=gtDNSTable, gtDateAndTime=gtDateAndTime, gtModuleBackup=gtModuleBackup, gtAgentComWriteString=gtAgentComWriteString, gtTrapUser=gtTrapUser, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerTable=gtNTPServerTable, gtModuleUpdate=gtModuleUpdate, gtAgentState=gtAgentState, gtGroupName=gtGroupName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUser=gtUser, gtSyslogState=gtSyslogState, gtDNSServerIP=gtDNSServerIP, gtModuleBackupControl=gtModuleBackupControl, gtUserAuthEnabled=gtUserAuthEnabled, gtAgentPort=gtAgentPort, gtSFTPPassword=gtSFTPPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateStatus=gtUpdateStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSyslogIP=gtSyslogIP, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSNMPTable=gtSNMPTable, gtUpdateFile=gtUpdateFile, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupAccesslist=gtGroupAccesslist, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupEntry=gtGroupEntry, gtDNSEntry=gtDNSEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupTable=gtGroupTable, gtAccesslistEntry=gtAccesslistEntry, gtPortsEntry=gtPortsEntry, gtSFTPPort=gtSFTPPort, gtInterfaceTable=gtInterfaceTable, gtSFPPlugged=gtSFPPlugged, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserName=gtUserName, gtTrapDestPort=gtTrapDestPort, gtSWOptionsIdx=gtSWOptionsIdx, gtUserAccesslist=gtUserAccesslist, gtGroupIdx=gtGroupIdx, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSyslogEntry=gtSyslogEntry, gtNetworking=gtNetworking, gtNumSFP=gtNumSFP, gtBackupStatus=gtBackupStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapDestIP=gtTrapDestIP, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPEntry=gtSFPEntry, gtTimeLocal=gtTimeLocal, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGroupRights=gtGroupRights, gtTrapPDU=gtTrapPDU, gtSFPSpeed=gtSFPSpeed, gtSNMP=gtSNMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestTable=gtTrapDestTable, gtSFPLink=gtSFPLink, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkVLAN=gtNetworkVLAN, gtSFPType=gtSFPType, gtUserAuthTable=gtUserAuthTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTimeZone=gtTimeZone, gtSwitch=gtSwitch, gtPortsTable=gtPortsTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtHMSGroupName=gtHMSGroupName, gtGroupParamIdx=gtGroupParamIdx, gtAgentSecurityLevel=gtAgentSecurityLevel, gtWebProtocol=gtWebProtocol, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortName=gtNetworkPortName, gtNTPServerNumber=gtNTPServerNumber, gtSFPNumber=gtSFPNumber, gtInterfaceState=gtInterfaceState, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkTable=gtNetworkTable, gtNTPServerEntry=gtNTPServerEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkPortState=gtNetworkPortState, gtServices=gtServices, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkName=gtNetworkName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserAuthEntry=gtUserAuthEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtPortsNumber=gtPortsNumber, gtAgentComReadString=gtAgentComReadString, gtSWOption=gtSWOption, gtInterfaceName=gtInterfaceName, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsCompliances=gtSettingsCompliances, gtGeneral=gtGeneral, gtWebAuth=gtWebAuth, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSettingsGroups=gtSettingsGroups, gtUserGroup=gtUserGroup, gtAccesslistParamIdx=gtAccesslistParamIdx, gtWebEnable=gtWebEnable)
