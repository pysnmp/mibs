...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, ModuleIdentity, Bits, Gauge32, iso, IpAddress, TimeTicks, Integer32, Counter32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity", "Bits", "Gauge32", "iso", "IpAddress", "TimeTicks", "Integer32", "Counter32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceMAC=gtInterfaceMAC, gtBackupSFTPPort=gtBackupSFTPPort, gtSLATable=gtSLATable, gtNumSFP=gtNumSFP, gtUserAuthTable=gtUserAuthTable, gtSFPEntry=gtSFPEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapDestNumber=gtTrapDestNumber, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserIdx=gtUserIdx, gtChassisRedundancy=gtChassisRedundancy, gtTrapState=gtTrapState, gtFilename=gtFilename, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSTable=gtHMSTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFPSpeed=gtSFPSpeed, gtUserAuthEntry=gtUserAuthEntry, gtTrapUser=gtTrapUser, PYSNMP_MODULE_ID=gtSettingsMIB, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSFPPlugged=gtSFPPlugged, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSNumMembers=gtHMSNumMembers, gtAgentState=gtAgentState, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtUserTable=gtUserTable, gtDNSNumber=gtDNSNumber, gtSettingsGroups=gtSettingsGroups, gtDateAndTimeTable=gtDateAndTimeTable, gtSettingsConformance=gtSettingsConformance, gtUserAccesslist=gtUserAccesslist, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFTPPort=gtSFTPPort, gtCurrentUserPassword=gtCurrentUserPassword, gtUserName=gtUserName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtServices=gtServices, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceVLAN=gtInterfaceVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtDNSServerIP=gtDNSServerIP, gtSettingsNotifications=gtSettingsNotifications, gtUserPassword=gtUserPassword, gtAccesslistEntry=gtAccesslistEntry, gtSettingsMIB=gtSettingsMIB, gtNetworkEntry=gtNetworkEntry, gtPortsTable=gtPortsTable, gtNetworking=gtNetworking, gtPortsNumber=gtPortsNumber, gtUserEntry=gtUserEntry, gtTrapDestEntry=gtTrapDestEntry, gtGroupParamIdx=gtGroupParamIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogState=gtSyslogState, gtNetworkName=gtNetworkName, gtSFTPServer=gtSFTPServer, gtModuleBackupControl=gtModuleBackupControl, gtSettingsObjects=gtSettingsObjects, gtBackupControl=gtBackupControl, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSLARegistered=gtSLARegistered, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSLAExpires=gtSLAExpires, gtAgentPort=gtAgentPort, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDNSTable=gtDNSTable, gtModuleBackup=gtModuleBackup, gtTrapPDU=gtTrapPDU, gtNTPServerAddress=gtNTPServerAddress, gtSyslogEntry=gtSyslogEntry, gtSWOptionsTable=gtSWOptionsTable, gtTrapDestPort=gtTrapDestPort, gtModuleUpdate=gtModuleUpdate, gtAccesslistTable=gtAccesslistTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortState=gtNetworkPortState, gtGroupTable=gtGroupTable, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsName=gtPortsName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupStatus=gtBackupStatus, gtServicesEntry=gtServicesEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPType=gtSFPType, gtServicesTable=gtServicesTable, gtAgentComReadString=gtAgentComReadString, gtHMSComMethod=gtHMSComMethod, gtTrapDestIP=gtTrapDestIP, gtTimeUTC=gtTimeUTC, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkTable=gtNetworkTable, gtCurrentUserName=gtCurrentUserName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDateAndTimeEntry=gtDateAndTimeEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkPortNumber=gtNetworkPortNumber, gtDNSEntry=gtDNSEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFPNumber=gtSFPNumber, gtPortsEntry=gtPortsEntry, gtSFPLink=gtSFPLink, gtInterfaceState=gtInterfaceState, gtHMSEntry=gtHMSEntry, gtSNMPTable=gtSNMPTable, gtInterfaceEntry=gtInterfaceEntry, gtUpdateFile=gtUpdateFile, gtUser=gtUser, gtSettingsCompliances=gtSettingsCompliances, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceTable=gtInterfaceTable, gtInterfaceStreaming=gtInterfaceStreaming, gtDateAndTime=gtDateAndTime, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSyslogIP=gtSyslogIP, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNTPServerTable=gtNTPServerTable, gtUpdateStatus=gtUpdateStatus, gtAgentComWriteString=gtAgentComWriteString, gtHMSGroupName=gtHMSGroupName, gtAccesslistIdx=gtAccesslistIdx, gtUserGroup=gtUserGroup, gtSNMPEntry=gtSNMPEntry, gtSwitch=gtSwitch, gtPortsLinkup=gtPortsLinkup, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFTPUsername=gtSFTPUsername, gtSFTPPassword=gtSFTPPassword, gtSNMP=gtSNMP, gtSWOption=gtSWOption, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSLAEntry=gtSLAEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtWebEnable=gtWebEnable, gtInterfaceCLI=gtInterfaceCLI, gtGeneral=gtGeneral, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtWebProtocol=gtWebProtocol, gtTimeLocal=gtTimeLocal, gtUserRowStatus=gtUserRowStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapComString=gtTrapComString, gtUpdateControl=gtUpdateControl, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapDestTable=gtTrapDestTable, gtInterfaceName=gtInterfaceName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupDate=gtModuleBackupDate, gtTimeZone=gtTimeZone, gtGroupIdx=gtGroupIdx, gtGroupEntry=gtGroupEntry, gtGroupAccesslist=gtGroupAccesslist, gtModuleBackupTable=gtModuleBackupTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtGroupRights=gtGroupRights, gtNetworkPortName=gtNetworkPortName, gtAccesslistName=gtAccesslistName, gtSFPTable=gtSFPTable, gtGroupName=gtGroupName, gtWebAuth=gtWebAuth, gtSWOptionsEntry=gtSWOptionsEntry, gtSyslogTable=gtSyslogTable)
