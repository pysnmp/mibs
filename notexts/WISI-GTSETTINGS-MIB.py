...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, Counter32, Unsigned32, Integer32, Gauge32, MibIdentifier, ModuleIdentity, TimeTicks, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUpdateControl=gtUpdateControl, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtGroupRights=gtGroupRights, gtPortsTable=gtPortsTable, gtGroupEntry=gtGroupEntry, gtUserName=gtUserName, gtUserPassword=gtUserPassword, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFPSpeed=gtSFPSpeed, gtTrapDestPort=gtTrapDestPort, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapState=gtTrapState, gtSFPTable=gtSFPTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPPort=gtBackupSFTPPort, gtNTPServerEntry=gtNTPServerEntry, gtAgentPort=gtAgentPort, gtSettingsConformance=gtSettingsConformance, gtFilename=gtFilename, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortName=gtNetworkPortName, gtModuleBackupEntry=gtModuleBackupEntry, gtHMSNumMembers=gtHMSNumMembers, gtSNMP=gtSNMP, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtSyslogState=gtSyslogState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapPDU=gtTrapPDU, gtUserAccesslist=gtUserAccesslist, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsEntry=gtPortsEntry, gtSFPEntry=gtSFPEntry, gtSFPPlugged=gtSFPPlugged, gtTrapUser=gtTrapUser, gtCurrentUserName=gtCurrentUserName, gtSFTPUsername=gtSFTPUsername, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserTable=gtUserTable, gtDNSTable=gtDNSTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSFPType=gtSFPType, gtInterfaceStreaming=gtInterfaceStreaming, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceIPv4=gtInterfaceIPv4, gtWebEnable=gtWebEnable, gtInterfaceName=gtInterfaceName, gtModuleBackupTable=gtModuleBackupTable, gtSLAExpires=gtSLAExpires, gtHMSTable=gtHMSTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUser=gtUser, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistTable=gtAccesslistTable, gtAccesslistIPRange=gtAccesslistIPRange, gtSwitch=gtSwitch, gtModuleUpdate=gtModuleUpdate, gtNetworkEntry=gtNetworkEntry, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtWebAuth=gtWebAuth, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSNumber=gtDNSNumber, gtBackupControl=gtBackupControl, gtTimeZone=gtTimeZone, gtBackupStatus=gtBackupStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNTPServerTable=gtNTPServerTable, gtTrapDestTable=gtTrapDestTable, gtChassisRedundancy=gtChassisRedundancy, gtHMSEntry=gtHMSEntry, gtInterfaceEntry=gtInterfaceEntry, gtPortsLinkup=gtPortsLinkup, gtInterfaceTable=gtInterfaceTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsGroups=gtSettingsGroups, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserAuthEntry=gtUserAuthEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtSFPLink=gtSFPLink, gtNTPServerNumber=gtNTPServerNumber, gtSFTPPassword=gtSFTPPassword, gtTrapComString=gtTrapComString, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupIdx=gtGroupIdx, gtTrapDestIP=gtTrapDestIP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDNSServerIP=gtDNSServerIP, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAccesslistName=gtAccesslistName, gtServicesTable=gtServicesTable, gtGroupTable=gtGroupTable, gtWebProtocol=gtWebProtocol, gtSLAEntry=gtSLAEntry, gtDateAndTime=gtDateAndTime, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtSWOptionsIdx=gtSWOptionsIdx, gtDateAndTimeTable=gtDateAndTimeTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQueryInterval=gtIGMPQueryInterval, gtServices=gtServices, gtSFTPPort=gtSFTPPort, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGeneral=gtGeneral, gtGroupParamIdx=gtGroupParamIdx, gtSyslogEntry=gtSyslogEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLARegistered=gtSLARegistered, gtSyslogTable=gtSyslogTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsNumber=gtPortsNumber, gtInterfaceMAC=gtInterfaceMAC, gtCurrentTimeSource=gtCurrentTimeSource, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistEntry=gtAccesslistEntry, gtNetworkName=gtNetworkName, gtAgentComReadString=gtAgentComReadString, gtInterfaceIGMP=gtInterfaceIGMP, gtSWOption=gtSWOption, gtUserIdx=gtUserIdx, gtUserGroup=gtUserGroup, gtSFTPServer=gtSFTPServer, gtSWOptionsTable=gtSWOptionsTable, gtAgentComWriteString=gtAgentComWriteString, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortState=gtNetworkPortState, gtTimeUTC=gtTimeUTC, gtUserParamIdx=gtUserParamIdx, gtUserEntry=gtUserEntry, gtSettingsMIB=gtSettingsMIB, gtTimeLocal=gtTimeLocal, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUpdateFile=gtUpdateFile, gtSNMPTable=gtSNMPTable, gtSNMPEntry=gtSNMPEntry, gtModuleBackup=gtModuleBackup, gtDNSEntry=gtDNSEntry, gtUserAuthTable=gtUserAuthTable, gtSettingsCompliances=gtSettingsCompliances, gtGroupName=gtGroupName, gtGroupAccesslist=gtGroupAccesslist, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworking=gtNetworking, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSGroupName=gtHMSGroupName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNumSFP=gtNumSFP, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsName=gtPortsName, gtSettingsNotifications=gtSettingsNotifications, gtSLATable=gtSLATable, gtSyslogIP=gtSyslogIP, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceState=gtInterfaceState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserRowStatus=gtUserRowStatus, gtServicesEntry=gtServicesEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateStatus=gtUpdateStatus, gtSFPNumber=gtSFPNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtModuleBackupStatus=gtModuleBackupStatus, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtAgentState=gtAgentState, gtNetworkTable=gtNetworkTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtHMSComMethod=gtHMSComMethod, gtModuleBackupDate=gtModuleBackupDate)
