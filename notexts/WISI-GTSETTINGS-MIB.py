...
ObjectIdentity, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter64, iso, IpAddress, TimeTicks, Unsigned32, Bits, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter64", "iso", "IpAddress", "TimeTicks", "Unsigned32", "Bits", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceIPv4=gtInterfaceIPv4, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSWOptionsTable=gtSWOptionsTable, gtHMSGroupName=gtHMSGroupName, gtCurrentUserPassword=gtCurrentUserPassword, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSNMPTable=gtSNMPTable, gtGroupName=gtGroupName, gtAgentPort=gtAgentPort, gtGroupEntry=gtGroupEntry, gtSettingsCompliances=gtSettingsCompliances, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSWOptionsIdx=gtSWOptionsIdx, gtSFPTable=gtSFPTable, gtSFPEntry=gtSFPEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateControl=gtUpdateControl, gtSyslogState=gtSyslogState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceIGMP=gtInterfaceIGMP, gtUserIdx=gtUserIdx, gtUserRowStatus=gtUserRowStatus, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworkTable=gtNetworkTable, gtInterfaceTable=gtInterfaceTable, gtHMSComMethod=gtHMSComMethod, gtBackupSFTPFilename=gtBackupSFTPFilename, gtWebProtocol=gtWebProtocol, gtUserName=gtUserName, gtModuleBackup=gtModuleBackup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSNMPEntry=gtSNMPEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTimeLocal=gtTimeLocal, gtUserGroup=gtUserGroup, gtSFTPUsername=gtSFTPUsername, gtCurrentUserName=gtCurrentUserName, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceMAC=gtInterfaceMAC, gtModuleBackupControl=gtModuleBackupControl, gtNetworkVLAN=gtNetworkVLAN, gtDNSTable=gtDNSTable, gtTrapDestNumber=gtTrapDestNumber, gtSLAEntry=gtSLAEntry, gtSFPPlugged=gtSFPPlugged, gtTrapComString=gtTrapComString, gtHMSTable=gtHMSTable, gtInterfaceNumber=gtInterfaceNumber, gtSettingsObjects=gtSettingsObjects, gtSWOption=gtSWOption, gtDateAndTime=gtDateAndTime, gtModuleBackupDate=gtModuleBackupDate, gtTrapDestPort=gtTrapDestPort, gtGeneral=gtGeneral, gtPortsTable=gtPortsTable, gtSFTPPassword=gtSFTPPassword, gtUpdateFilesEntry=gtUpdateFilesEntry, gtChassisRedundancy=gtChassisRedundancy, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAccesslistIdx=gtAccesslistIdx, gtGroupRights=gtGroupRights, gtSFPType=gtSFPType, gtHMSNumMembers=gtHMSNumMembers, gtTrapDestTable=gtTrapDestTable, gtPortsLinkup=gtPortsLinkup, gtNTPServerEntry=gtNTPServerEntry, gtNetworkName=gtNetworkName, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleUpdate=gtModuleUpdate, gtPortsName=gtPortsName, gtAgentState=gtAgentState, gtSyslogTable=gtSyslogTable, gtBackupSFTPPort=gtBackupSFTPPort, gtGroupTable=gtGroupTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUser=gtUser, gtUserAuthTable=gtUserAuthTable, gtAccesslistEntry=gtAccesslistEntry, gtWebEnable=gtWebEnable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPNumber=gtSFPNumber, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSwitch=gtSwitch, gtTrapDestIP=gtTrapDestIP, gtSyslogEntry=gtSyslogEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUserParamIdx=gtUserParamIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupStatus=gtBackupStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerTable=gtNTPServerTable, gtSWOptionsEntry=gtSWOptionsEntry, gtNTPServerNumber=gtNTPServerNumber, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLARegistered=gtSLARegistered, gtSLAExpires=gtSLAExpires, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtServicesTable=gtServicesTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworking=gtNetworking, gtUserEntry=gtUserEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtNumSFP=gtNumSFP, gtSettingsMIB=gtSettingsMIB, gtNetworkPortName=gtNetworkPortName, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupControl=gtBackupControl, gtAccesslistName=gtAccesslistName, gtDNSNumber=gtDNSNumber, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtUpdateStatus=gtUpdateStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQueryInterval=gtIGMPQueryInterval, gtDNSEntry=gtDNSEntry, gtWebAuth=gtWebAuth, gtGroupParamIdx=gtGroupParamIdx, gtNTPServerAddress=gtNTPServerAddress, gtGroupIdx=gtGroupIdx, gtTrapUser=gtTrapUser, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsNumber=gtPortsNumber, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsEntry=gtPortsEntry, gtNetworkEntry=gtNetworkEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFTPServer=gtSFTPServer, gtSyslogIP=gtSyslogIP, gtAccesslistTable=gtAccesslistTable, gtServices=gtServices, gtSNMP=gtSNMP, gtServicesEntry=gtServicesEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceVLAN=gtInterfaceVLAN, gtDNSServerIP=gtDNSServerIP, gtInterfaceEntry=gtInterfaceEntry, gtSLATable=gtSLATable, gtTimeZone=gtTimeZone, gtInterfaceName=gtInterfaceName, gtTimeUTC=gtTimeUTC, gtTrapState=gtTrapState, gtUpdateFilesTable=gtUpdateFilesTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFPSpeed=gtSFPSpeed, gtInterfaceCLI=gtInterfaceCLI, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateFile=gtUpdateFile, gtInterfaceRowStatus=gtInterfaceRowStatus, gtHMSEntry=gtHMSEntry, gtSettingsConformance=gtSettingsConformance, gtSFPLink=gtSFPLink, gtAgentComReadString=gtAgentComReadString, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserAccesslist=gtUserAccesslist, gtInterfaceState=gtInterfaceState, gtSettingsNotifications=gtSettingsNotifications, gtNetworkPortState=gtNetworkPortState, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserPassword=gtUserPassword, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapPDU=gtTrapPDU, gtBackupSFTPServer=gtBackupSFTPServer, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserTable=gtUserTable, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceDHCPState=gtInterfaceDHCPState, gtFilename=gtFilename, gtSFTPPort=gtSFTPPort, gtInterfaceStreaming=gtInterfaceStreaming, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtDateAndTimeTable=gtDateAndTimeTable)
