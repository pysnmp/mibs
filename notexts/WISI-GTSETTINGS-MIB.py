...
IpAddress, MibIdentifier, ModuleIdentity, iso, Bits, Counter32, NotificationType, Gauge32, Unsigned32, ObjectIdentity, Counter64, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibIdentifier", "ModuleIdentity", "iso", "Bits", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtDateAndTime=gtDateAndTime, gtTrapDestEntry=gtTrapDestEntry, gtTrapState=gtTrapState, gtInterfaceIPv4=gtInterfaceIPv4, gtSFTPPassword=gtSFTPPassword, gtUserParamIdx=gtUserParamIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtDNSTable=gtDNSTable, gtGroupRights=gtGroupRights, gtHMSNumMembers=gtHMSNumMembers, gtModuleBackupControl=gtModuleBackupControl, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapDestPort=gtTrapDestPort, gtSettingsNotifications=gtSettingsNotifications, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleUpdate=gtModuleUpdate, gtPortsEntry=gtPortsEntry, gtInterfaceName=gtInterfaceName, gtTrapComString=gtTrapComString, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMP=gtSNMP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupTable=gtGroupTable, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupDate=gtModuleBackupDate, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkTable=gtNetworkTable, gtPortsLinkup=gtPortsLinkup, gtSyslogTable=gtSyslogTable, gtHMSEntry=gtHMSEntry, gtUserGroup=gtUserGroup, gtServices=gtServices, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSwitch=gtSwitch, gtBackupControl=gtBackupControl, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtHMSTable=gtHMSTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSyslogEntry=gtSyslogEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortState=gtNetworkPortState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtWebAuth=gtWebAuth, gtUpdateStatus=gtUpdateStatus, gtAgentComWriteString=gtAgentComWriteString, gtSLAEntry=gtSLAEntry, gtSLAExpires=gtSLAExpires, gtDNSServerIP=gtDNSServerIP, gtInterfaceCLI=gtInterfaceCLI, gtSettingsObjects=gtSettingsObjects, gtSWOptionsEntry=gtSWOptionsEntry, gtUserEntry=gtUserEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserTable=gtUserTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAgentState=gtAgentState, gtAgentPort=gtAgentPort, gtSFPLink=gtSFPLink, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapPDU=gtTrapPDU, gtSLARegistered=gtSLARegistered, gtAgentComReadString=gtAgentComReadString, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUserAuthEntry=gtUserAuthEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceEntry=gtInterfaceEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortNumber=gtNetworkPortNumber, gtUserIdx=gtUserIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtNTPServerEntry=gtNTPServerEntry, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerAddress=gtNTPServerAddress, gtDNSEntry=gtDNSEntry, gtAccesslistEntry=gtAccesslistEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateFile=gtUpdateFile, gtInterfaceTable=gtInterfaceTable, gtModuleBackup=gtModuleBackup, gtSFPEntry=gtSFPEntry, gtPortsTable=gtPortsTable, gtUserAccesslist=gtUserAccesslist, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerNumber=gtNTPServerNumber, gtSettingsGroups=gtSettingsGroups, gtTrapDestTable=gtTrapDestTable, gtSyslogIP=gtSyslogIP, gtAccesslistTable=gtAccesslistTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSyslogState=gtSyslogState, gtAccesslistName=gtAccesslistName, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkPortName=gtNetworkPortName, gtNetworkEntry=gtNetworkEntry, gtUserPassword=gtUserPassword, gtSettingsConformance=gtSettingsConformance, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSLATable=gtSLATable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTrapDestIP=gtTrapDestIP, gtTimeUTC=gtTimeUTC, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPPlugged=gtSFPPlugged, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupIdx=gtGroupIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtPortsName=gtPortsName, gtSettingsMIB=gtSettingsMIB, gtUser=gtUser, gtSNMPTable=gtSNMPTable, gtUserAuthTable=gtUserAuthTable, gtSFPSpeed=gtSFPSpeed, gtNTPServerTable=gtNTPServerTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupName=gtGroupName, gtNetworkVLAN=gtNetworkVLAN, gtSFTPUsername=gtSFTPUsername, gtNetworkName=gtNetworkName, gtTrapDestNumber=gtTrapDestNumber, gtUpdateControl=gtUpdateControl, gtAgentSecurityLevel=gtAgentSecurityLevel, gtServicesTable=gtServicesTable, gtServicesEntry=gtServicesEntry, gtWebEnable=gtWebEnable, gtGroupEntry=gtGroupEntry, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSNMPEntry=gtSNMPEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIGMP=gtInterfaceIGMP, gtCurrentUserName=gtCurrentUserName, gtSFTPServer=gtSFTPServer, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFPTable=gtSFPTable, gtUserName=gtUserName, gtSFTPPort=gtSFTPPort, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtSWOptionsTable=gtSWOptionsTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserRowStatus=gtUserRowStatus, gtTimeZone=gtTimeZone, gtSettingsCompliances=gtSettingsCompliances, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFPNumber=gtSFPNumber, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworking=gtNetworking, gtGeneral=gtGeneral, gtTrapUser=gtTrapUser, gtFilename=gtFilename, gtAccesslistParamIdx=gtAccesslistParamIdx, PYSNMP_MODULE_ID=gtSettingsMIB, gtDaylightAdjustment=gtDaylightAdjustment, gtWebProtocol=gtWebProtocol, gtSWOption=gtSWOption, gtInterfaceState=gtInterfaceState, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTimeLocal=gtTimeLocal, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceNumber=gtInterfaceNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceMAC=gtInterfaceMAC, gtNumSFP=gtNumSFP, gtDNSNumber=gtDNSNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortsEntry=gtNetworkPortsEntry, gtGroupAccesslist=gtGroupAccesslist, gtBackupStatus=gtBackupStatus, gtPortsNumber=gtPortsNumber, gtSFPType=gtSFPType, gtHMSGroupName=gtHMSGroupName)
