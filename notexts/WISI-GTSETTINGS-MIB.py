...
Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, TimeTicks, Gauge32, Unsigned32, Integer32, MibIdentifier, NotificationType, Counter32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "TimeTicks", "Gauge32", "Unsigned32", "Integer32", "MibIdentifier", "NotificationType", "Counter32", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtChassisRedundancy=gtChassisRedundancy, gtNetworkPortState=gtNetworkPortState, gtSLATable=gtSLATable, gtModuleBackupTable=gtModuleBackupTable, gtAccesslistIdx=gtAccesslistIdx, gtPortsEntry=gtPortsEntry, gtHMSNumMembers=gtHMSNumMembers, gtNetworkEntry=gtNetworkEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtUserAuthTable=gtUserAuthTable, gtNetworkTable=gtNetworkTable, gtSFPSpeed=gtSFPSpeed, gtAgentComReadString=gtAgentComReadString, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTrapDestNumber=gtTrapDestNumber, gtUserRowStatus=gtUserRowStatus, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserEntry=gtUserEntry, gtBackupStatus=gtBackupStatus, gtSNMPEntry=gtSNMPEntry, gtTrapDestIP=gtTrapDestIP, gtModuleBackupStatus=gtModuleBackupStatus, gtUser=gtUser, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTimeUTC=gtTimeUTC, gtTrapDestPort=gtTrapDestPort, gtPortsName=gtPortsName, gtSNMP=gtSNMP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSyslogState=gtSyslogState, gtSLAExpires=gtSLAExpires, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkName=gtNetworkName, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceCLI=gtInterfaceCLI, gtSFPPlugged=gtSFPPlugged, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupEntry=gtGroupEntry, gtAccesslistTable=gtAccesslistTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateStatus=gtUpdateStatus, gtSwitch=gtSwitch, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceVLAN=gtInterfaceVLAN, gtPortsNumber=gtPortsNumber, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkPortsEntry=gtNetworkPortsEntry, gtTrapDestTable=gtTrapDestTable, gtDNSEntry=gtDNSEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapPDU=gtTrapPDU, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistIPRange=gtAccesslistIPRange, gtGroupRights=gtGroupRights, gtSLARegistered=gtSLARegistered, gtGroupParamIdx=gtGroupParamIdx, gtNTPServerAddress=gtNTPServerAddress, gtModuleBackup=gtModuleBackup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserTable=gtUserTable, gtHMSComMethod=gtHMSComMethod, gtDNSNumber=gtDNSNumber, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPPassword=gtBackupSFTPPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsConformance=gtSettingsConformance, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsLinkup=gtPortsLinkup, gtSFPEntry=gtSFPEntry, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupAccesslist=gtGroupAccesslist, gtTrapComString=gtTrapComString, gtWebProtocol=gtWebProtocol, gtNetworkVLAN=gtNetworkVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateControl=gtUpdateControl, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceName=gtInterfaceName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserAccesslist=gtUserAccesslist, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceState=gtInterfaceState, gtAgentComWriteString=gtAgentComWriteString, gtAgentState=gtAgentState, gtSFPTable=gtSFPTable, gtSNMPTable=gtSNMPTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtCurrentUserName=gtCurrentUserName, gtSFPType=gtSFPType, gtInterfaceTable=gtInterfaceTable, gtSyslogIP=gtSyslogIP, gtServices=gtServices, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNTPServerEntry=gtNTPServerEntry, gtSWOptionsTable=gtSWOptionsTable, gtTrapDestEntry=gtTrapDestEntry, gtUserParamIdx=gtUserParamIdx, gtSWOptionsIdx=gtSWOptionsIdx, gtWebAuth=gtWebAuth, gtSFTPServer=gtSFTPServer, gtHMSGroupName=gtHMSGroupName, gtSyslogEntry=gtSyslogEntry, gtAccesslistName=gtAccesslistName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapUser=gtTrapUser, gtAgentPort=gtAgentPort, gtTimeLocal=gtTimeLocal, gtNetworking=gtNetworking, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifications=gtSettingsNotifications, gtDNSTable=gtDNSTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUpdateFile=gtUpdateFile, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDateAndTimeEntry=gtDateAndTimeEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGeneral=gtGeneral, gtSFPLink=gtSFPLink, gtGroupTable=gtGroupTable, gtGroupIdx=gtGroupIdx, gtSFTPPassword=gtSFTPPassword, gtPortsTable=gtPortsTable, gtHMSTable=gtHMSTable, gtSettingsObjects=gtSettingsObjects, gtDateAndTime=gtDateAndTime, gtGroupName=gtGroupName, gtAccesslistEntry=gtAccesslistEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDaylightAdjustment=gtDaylightAdjustment, gtHMSNumAvailModules=gtHMSNumAvailModules, gtModuleBackupControl=gtModuleBackupControl, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPNumber=gtSFPNumber, gtNTPServerTable=gtNTPServerTable, gtNetworkPortName=gtNetworkPortName, gtHMSEntry=gtHMSEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupControl=gtBackupControl, gtTrapState=gtTrapState, gtDNSServerIP=gtDNSServerIP, gtNTPServerNumber=gtNTPServerNumber, gtSFTPPort=gtSFTPPort, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsMIB=gtSettingsMIB, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceEntry=gtInterfaceEntry, gtUserPassword=gtUserPassword, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUserIdx=gtUserIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtFilename=gtFilename, gtSettingsCompliances=gtSettingsCompliances, gtUserGroup=gtUserGroup, gtSettingsGroups=gtSettingsGroups, gtModuleUpdate=gtModuleUpdate, gtSLAEntry=gtSLAEntry, gtSWOption=gtSWOption, gtTimeZone=gtTimeZone, gtUserName=gtUserName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceMAC=gtInterfaceMAC, gtSyslogTable=gtSyslogTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceWebMgt=gtInterfaceWebMgt, gtServicesEntry=gtServicesEntry, gtSFTPUsername=gtSFTPUsername, gtServicesTable=gtServicesTable, gtUpdateFilesTable=gtUpdateFilesTable, gtWebEnable=gtWebEnable, gtNumSFP=gtNumSFP, gtAgentSecurityLevel=gtAgentSecurityLevel)
