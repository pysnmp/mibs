...
MibIdentifier, ObjectIdentity, iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ModuleIdentity, Counter32, Unsigned32, Integer32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ModuleIdentity", "Counter32", "Unsigned32", "Integer32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFPTable=gtSFPTable, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackup=gtModuleBackup, gtTrapDestEntry=gtTrapDestEntry, gtGeneral=gtGeneral, gtUserAuthEntry=gtUserAuthEntry, gtSFPSpeed=gtSFPSpeed, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtCurrentUserName=gtCurrentUserName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupTable=gtGroupTable, gtPortsLinkup=gtPortsLinkup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkName=gtNetworkName, gtInterfaceVLAN=gtInterfaceVLAN, gtUserRowStatus=gtUserRowStatus, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDateAndTimeEntry=gtDateAndTimeEntry, gtDNSEntry=gtDNSEntry, gtModuleUpdate=gtModuleUpdate, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapPDU=gtTrapPDU, gtInterfaceIGMP=gtInterfaceIGMP, gtSNMPTable=gtSNMPTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworking=gtNetworking, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapState=gtTrapState, gtUserIdx=gtUserIdx, gtUserParamIdx=gtUserParamIdx, gtGroupRights=gtGroupRights, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceSNMP=gtInterfaceSNMP, gtSNMP=gtSNMP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSTable=gtHMSTable, gtWebProtocol=gtWebProtocol, gtSFTPPort=gtSFTPPort, gtAccesslistName=gtAccesslistName, gtSwitch=gtSwitch, gtDaylightAdjustment=gtDaylightAdjustment, gtAccesslistIdx=gtAccesslistIdx, gtUpdateFilesTable=gtUpdateFilesTable, gtSLARegistered=gtSLARegistered, gtSyslogIP=gtSyslogIP, gtHMSEntry=gtHMSEntry, gtSettingsGroups=gtSettingsGroups, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupEntry=gtModuleBackupEntry, gtSLAEntry=gtSLAEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDNSServerIP=gtDNSServerIP, gtInterfaceDHCPState=gtInterfaceDHCPState, gtChassisRedundancy=gtChassisRedundancy, gtDNSNumber=gtDNSNumber, gtNTPServerTable=gtNTPServerTable, gtTimeUTC=gtTimeUTC, gtNTPServerEntry=gtNTPServerEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtGroupAccesslist=gtGroupAccesslist, gtPortsEntry=gtPortsEntry, gtTimeZone=gtTimeZone, gtAgentComReadString=gtAgentComReadString, gtTrapDestPort=gtTrapDestPort, gtGroupIdx=gtGroupIdx, gtUpdateFile=gtUpdateFile, gtTrapDestTable=gtTrapDestTable, gtSFPNumber=gtSFPNumber, gtServicesEntry=gtServicesEntry, gtSFPEntry=gtSFPEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSettingsConformance=gtSettingsConformance, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupName=gtGroupName, gtSettingsMIB=gtSettingsMIB, gtSWOption=gtSWOption, gtSFPPlugged=gtSFPPlugged, gtTimeLocal=gtTimeLocal, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUserTable=gtUserTable, gtSyslogTable=gtSyslogTable, gtNetworkPortState=gtNetworkPortState, gtAccesslistEntry=gtAccesslistEntry, gtNetworkTable=gtNetworkTable, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceEntry=gtInterfaceEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsObjects=gtSettingsObjects, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerNumber=gtNTPServerNumber, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceCLI=gtInterfaceCLI, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceTable=gtInterfaceTable, gtTrapComString=gtTrapComString, gtWebAuth=gtWebAuth, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkVLAN=gtNetworkVLAN, gtSFTPUsername=gtSFTPUsername, gtUserAuthTable=gtUserAuthTable, gtSFTPServer=gtSFTPServer, gtUserGroup=gtUserGroup, gtTrapDestIP=gtTrapDestIP, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceIPv4=gtInterfaceIPv4, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtWebEnable=gtWebEnable, gtNetworkPortName=gtNetworkPortName, gtUserPassword=gtUserPassword, gtUserName=gtUserName, gtSFPType=gtSFPType, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkPortsTable=gtNetworkPortsTable, gtNumSFP=gtNumSFP, gtUpdateStatus=gtUpdateStatus, gtSyslogEntry=gtSyslogEntry, gtInterfaceName=gtInterfaceName, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleBackupControl=gtModuleBackupControl, gtModuleBackupStatus=gtModuleBackupStatus, gtAccesslistTable=gtAccesslistTable, gtHMSNumMembers=gtHMSNumMembers, gtSLAExpires=gtSLAExpires, gtSWOptionsEntry=gtSWOptionsEntry, gtDateAndTime=gtDateAndTime, gtSWOptionsIdx=gtSWOptionsIdx, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupEntry=gtGroupEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsName=gtPortsName, gtBackupSFTPServer=gtBackupSFTPServer, gtSWOptionsTable=gtSWOptionsTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtDNSTable=gtDNSTable, gtUserEntry=gtUserEntry, gtPortsNumber=gtPortsNumber, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceMAC=gtInterfaceMAC, gtBackupStatus=gtBackupStatus, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtFilename=gtFilename, gtInterfaceState=gtInterfaceState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupControl=gtBackupControl, gtUpdateControl=gtUpdateControl, gtUserAuthEnabled=gtUserAuthEnabled, gtServicesTable=gtServicesTable, gtSyslogState=gtSyslogState, gtAgentPort=gtAgentPort, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSLATable=gtSLATable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtModuleBackupTable=gtModuleBackupTable, gtSFPLink=gtSFPLink, gtModuleBackupDate=gtModuleBackupDate, gtUser=gtUser, gtInterfaceNumber=gtInterfaceNumber, gtAgentState=gtAgentState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestNumber=gtTrapDestNumber, gtTrapUser=gtTrapUser, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSNMPEntry=gtSNMPEntry, gtServices=gtServices, gtHMSComMethod=gtHMSComMethod, gtPortsTable=gtPortsTable, gtSFTPPassword=gtSFTPPassword, gtSettingsCompliances=gtSettingsCompliances, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserAccesslist=gtUserAccesslist, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkEntry=gtNetworkEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, PYSNMP_MODULE_ID=gtSettingsMIB)
