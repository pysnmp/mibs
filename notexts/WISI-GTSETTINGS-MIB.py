...
iso, ModuleIdentity, Integer32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, ObjectIdentity, NotificationType, Counter64, IpAddress, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Integer32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter64", "IpAddress", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNTPServerTable=gtNTPServerTable, gtChassisRedundancy=gtChassisRedundancy, gtSwitch=gtSwitch, gtUserIdx=gtUserIdx, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackupControl=gtModuleBackupControl, gtSFPPlugged=gtSFPPlugged, gtWebEnable=gtWebEnable, gtModuleUpdate=gtModuleUpdate, gtAgentPort=gtAgentPort, gtFilename=gtFilename, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSettingsGroups=gtSettingsGroups, gtSWOption=gtSWOption, gtTimeZone=gtTimeZone, gtTrapDestNumber=gtTrapDestNumber, PYSNMP_MODULE_ID=gtSettingsMIB, gtGroupIdx=gtGroupIdx, gtHMSTable=gtHMSTable, gtBackupStatus=gtBackupStatus, gtNTPServerNumber=gtNTPServerNumber, gtDaylightAdjustment=gtDaylightAdjustment, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSNumMembers=gtHMSNumMembers, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsName=gtPortsName, gtSettingsConformance=gtSettingsConformance, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserTable=gtUserTable, gtSFTPPort=gtSFTPPort, gtNTPServerAddress=gtNTPServerAddress, gtAgentComWriteString=gtAgentComWriteString, gtWebAuth=gtWebAuth, gtGeneral=gtGeneral, gtSWOptionsTable=gtSWOptionsTable, gtNetworkPortState=gtNetworkPortState, gtTrapComString=gtTrapComString, gtTrapDestTable=gtTrapDestTable, gtCurrentUserName=gtCurrentUserName, gtAgentState=gtAgentState, gtSLAEntry=gtSLAEntry, gtUser=gtUser, gtNetworkName=gtNetworkName, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserRowStatus=gtUserRowStatus, gtTimeLocal=gtTimeLocal, gtUserPassword=gtUserPassword, gtSNMPEntry=gtSNMPEntry, gtHMSComMethod=gtHMSComMethod, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPServer=gtBackupSFTPServer, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackup=gtModuleBackup, gtSFPLink=gtSFPLink, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSGroupName=gtHMSGroupName, gtPortsNumber=gtPortsNumber, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDNSTable=gtDNSTable, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateControl=gtUpdateControl, gtSFTPPassword=gtSFTPPassword, gtHMSEntry=gtHMSEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPNumber=gtSFPNumber, gtTrapState=gtTrapState, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateStatus=gtUpdateStatus, gtGroupAccesslist=gtGroupAccesslist, gtDNSServerIP=gtDNSServerIP, gtCurrentUserPassword=gtCurrentUserPassword, gtPortsEntry=gtPortsEntry, gtSFPType=gtSFPType, gtWebProtocol=gtWebProtocol, gtNetworkEntry=gtNetworkEntry, gtTimeUTC=gtTimeUTC, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceTable=gtInterfaceTable, gtUserAuthEntry=gtUserAuthEntry, gtUserParamIdx=gtUserParamIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtDateAndTime=gtDateAndTime, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtTrapUser=gtTrapUser, gtUserGroup=gtUserGroup, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDateAndTimeTable=gtDateAndTimeTable, gtDNSNumber=gtDNSNumber, gtServicesEntry=gtServicesEntry, gtNetworkTable=gtNetworkTable, gtServicesTable=gtServicesTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNetworkVLAN=gtNetworkVLAN, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupControl=gtBackupControl, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAccesslistEntry=gtAccesslistEntry, gtNetworkPortName=gtNetworkPortName, gtSettingsMIB=gtSettingsMIB, gtInterfaceName=gtInterfaceName, gtInterfaceNumber=gtInterfaceNumber, gtUserEntry=gtUserEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtServices=gtServices, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSLATable=gtSLATable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupRights=gtGroupRights, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsNotifications=gtSettingsNotifications, gtPortsTable=gtPortsTable, gtGroupTable=gtGroupTable, gtGroupEntry=gtGroupEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSNMP=gtSNMP, gtSLARegistered=gtSLARegistered, gtDNSEntry=gtDNSEntry, gtSFTPUsername=gtSFTPUsername, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSettingsObjects=gtSettingsObjects, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserName=gtUserName, gtSFTPServer=gtSFTPServer, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworking=gtNetworking, gtAccesslistTable=gtAccesslistTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtPortsLinkup=gtPortsLinkup, gtInterfaceIfIndex=gtInterfaceIfIndex, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestIP=gtTrapDestIP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleBackupTable=gtModuleBackupTable, gtSFPEntry=gtSFPEntry, gtTrapPDU=gtTrapPDU, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFPSpeed=gtSFPSpeed, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFile=gtUpdateFile, gtSFPTable=gtSFPTable, gtAccesslistIdx=gtAccesslistIdx, gtSyslogEntry=gtSyslogEntry, gtSLAExpires=gtSLAExpires, gtSyslogIP=gtSyslogIP, gtModuleBackupStatus=gtModuleBackupStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSyslogState=gtSyslogState, gtTrapDestPort=gtTrapDestPort, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceMAC=gtInterfaceMAC, gtNumSFP=gtNumSFP, gtInterfaceState=gtInterfaceState, gtInterfaceCLI=gtInterfaceCLI, gtUserAccesslist=gtUserAccesslist, gtGroupName=gtGroupName, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthTable=gtUserAuthTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSNMPTable=gtSNMPTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSyslogTable=gtSyslogTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentComReadString=gtAgentComReadString, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceIPv4=gtInterfaceIPv4, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAccesslistName=gtAccesslistName, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsBitrateReceive=gtPortsBitrateReceive)
