...
iso, Bits, ModuleIdentity, Counter32, Counter64, IpAddress, MibIdentifier, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ModuleIdentity", "Counter32", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtGroupIdx=gtGroupIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapDestPort=gtTrapDestPort, gtHMSComMethod=gtHMSComMethod, gtModuleBackup=gtModuleBackup, gtSFPSpeed=gtSFPSpeed, gtTrapDestNumber=gtTrapDestNumber, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGeneral=gtGeneral, gtServices=gtServices, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtTimeUTC=gtTimeUTC, gtModuleUpdate=gtModuleUpdate, gtTrapDestTable=gtTrapDestTable, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkPortsTable=gtNetworkPortsTable, gtUserRowStatus=gtUserRowStatus, gtSLATable=gtSLATable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtPortsLinkup=gtPortsLinkup, gtAccesslistName=gtAccesslistName, gtSettingsMIB=gtSettingsMIB, gtInterfaceStreaming=gtInterfaceStreaming, gtSLAExpires=gtSLAExpires, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsTable=gtPortsTable, gtSFTPUsername=gtSFTPUsername, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAccesslistTable=gtAccesslistTable, gtUserAuthEntry=gtUserAuthEntry, gtUpdateControl=gtUpdateControl, gtInterfaceVLAN=gtInterfaceVLAN, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestEntry=gtTrapDestEntry, gtBackupControl=gtBackupControl, gtSFTPServer=gtSFTPServer, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceName=gtInterfaceName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupTable=gtGroupTable, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFile=gtUpdateFile, gtModuleBackupControl=gtModuleBackupControl, gtSLARegistered=gtSLARegistered, gtSFPNumber=gtSFPNumber, gtSFTPPassword=gtSFTPPassword, gtWebProtocol=gtWebProtocol, gtModuleBackupTable=gtModuleBackupTable, gtSyslogState=gtSyslogState, gtNTPServerTable=gtNTPServerTable, gtUserName=gtUserName, gtUserGroup=gtUserGroup, gtNTPServerNumber=gtNTPServerNumber, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistParamIdx=gtAccesslistParamIdx, gtServicesEntry=gtServicesEntry, gtAgentComReadString=gtAgentComReadString, gtSNMPEntry=gtSNMPEntry, gtGroupName=gtGroupName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentState=gtAgentState, gtInterfaceDHCPState=gtInterfaceDHCPState, gtServicesTable=gtServicesTable, gtDNSNumber=gtDNSNumber, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserIdx=gtUserIdx, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSNumMembers=gtHMSNumMembers, gtAgentComWriteString=gtAgentComWriteString, gtTrapSecurityLevel=gtTrapSecurityLevel, gtCurrentUserName=gtCurrentUserName, gtUserParamIdx=gtUserParamIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapState=gtTrapState, PYSNMP_MODULE_ID=gtSettingsMIB, gtChassisRedundancy=gtChassisRedundancy, gtSyslogEntry=gtSyslogEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceState=gtInterfaceState, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceEntry=gtInterfaceEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateStatus=gtUpdateStatus, gtSWOption=gtSWOption, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistIdx=gtAccesslistIdx, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceMAC=gtInterfaceMAC, gtPortsName=gtPortsName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDNSServerIP=gtDNSServerIP, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPServer=gtBackupSFTPServer, gtTimeLocal=gtTimeLocal, gtSyslogTable=gtSyslogTable, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupStatus=gtBackupStatus, gtSLAEntry=gtSLAEntry, gtNetworkPortState=gtNetworkPortState, gtNetworkName=gtNetworkName, gtSettingsObjects=gtSettingsObjects, gtSettingsCompliances=gtSettingsCompliances, gtTrapUser=gtTrapUser, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupStatus=gtModuleBackupStatus, gtDateAndTime=gtDateAndTime, gtSFPLink=gtSFPLink, gtFilename=gtFilename, gtPortsNumber=gtPortsNumber, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUser=gtUser, gtGroupRights=gtGroupRights, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserPassword=gtUserPassword, gtNetworkEntry=gtNetworkEntry, gtUserAuthTable=gtUserAuthTable, gtPortsEntry=gtPortsEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPPort=gtSFTPPort, gtInterfaceTable=gtInterfaceTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSGroupName=gtHMSGroupName, gtGroupEntry=gtGroupEntry, gtSWOptionsTable=gtSWOptionsTable, gtUserAccesslist=gtUserAccesslist, gtNumSFP=gtNumSFP, gtTrapComString=gtTrapComString, gtUpdateFilesTable=gtUpdateFilesTable, gtUserTable=gtUserTable, gtSFPPlugged=gtSFPPlugged, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsNotifications=gtSettingsNotifications, gtNetworking=gtNetworking, gtTrapSNMPVersion=gtTrapSNMPVersion, gtDateAndTimeTable=gtDateAndTimeTable, gtGroupParamIdx=gtGroupParamIdx, gtNTPServerEntry=gtNTPServerEntry, gtSwitch=gtSwitch, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtNetworkTable=gtNetworkTable, gtSNMP=gtSNMP, gtSettingsConformance=gtSettingsConformance, gtDateAndTimeEntry=gtDateAndTimeEntry, gtDNSEntry=gtDNSEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkVLAN=gtNetworkVLAN, gtSFPTable=gtSFPTable, gtGroupAccesslist=gtGroupAccesslist, gtSFPType=gtSFPType, gtWebEnable=gtWebEnable, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortsEntry=gtNetworkPortsEntry, gtTimeZone=gtTimeZone, gtAccesslistEntry=gtAccesslistEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSyslogIP=gtSyslogIP, gtNetworkPortName=gtNetworkPortName, gtTrapDestIP=gtTrapDestIP, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceCLI=gtInterfaceCLI, gtDNSTable=gtDNSTable, gtHMSTable=gtHMSTable, gtSNMPTable=gtSNMPTable, gtTrapPDU=gtTrapPDU, gtAgentSecurityLevel=gtAgentSecurityLevel, gtWebAuth=gtWebAuth, gtSFPEntry=gtSFPEntry, gtHMSEntry=gtHMSEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtAgentPort=gtAgentPort, gtUserEntry=gtUserEntry)
