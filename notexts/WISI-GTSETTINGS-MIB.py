...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Gauge32, Integer32, TimeTicks, Counter32, Bits, ObjectIdentity, iso, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks", "Counter32", "Bits", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAccesslistTable=gtAccesslistTable, gtChassisRedundancy=gtChassisRedundancy, gtBackupControl=gtBackupControl, gtNTPServerTable=gtNTPServerTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupStatus=gtBackupStatus, gtTrapDestEntry=gtTrapDestEntry, gtNetworkVLAN=gtNetworkVLAN, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAccesslistIPRange=gtAccesslistIPRange, gtServicesTable=gtServicesTable, gtDaylightAdjustment=gtDaylightAdjustment, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSNMPEntry=gtSNMPEntry, gtCurrentUserName=gtCurrentUserName, gtGroupTable=gtGroupTable, gtPortsName=gtPortsName, gtDNSServerIP=gtDNSServerIP, gtInterfaceEntry=gtInterfaceEntry, gtUserEntry=gtUserEntry, gtAccesslistName=gtAccesslistName, gtNTPServerEntry=gtNTPServerEntry, gtNetworkPortName=gtNetworkPortName, gtAgentPort=gtAgentPort, gtNumSFP=gtNumSFP, gtAgentComReadString=gtAgentComReadString, gtUpdateFilesTable=gtUpdateFilesTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFPSpeed=gtSFPSpeed, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestNumber=gtTrapDestNumber, gtBackupSFTPPassword=gtBackupSFTPPassword, gtAccesslistEntry=gtAccesslistEntry, gtTrapPDU=gtTrapPDU, gtGeneral=gtGeneral, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapDestRowStatus=gtTrapDestRowStatus, gtServicesEntry=gtServicesEntry, gtModuleBackupDate=gtModuleBackupDate, gtGroupIdx=gtGroupIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtSLARegistered=gtSLARegistered, gtSFPEntry=gtSFPEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleUpdate=gtModuleUpdate, gtGroupRights=gtGroupRights, gtSettingsGroups=gtSettingsGroups, gtNetworkPortState=gtNetworkPortState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDNSEntry=gtDNSEntry, gtSwitch=gtSwitch, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceIPv4=gtInterfaceIPv4, gtGroupName=gtGroupName, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapDestTable=gtTrapDestTable, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSComMethod=gtHMSComMethod, gtWebAuth=gtWebAuth, gtHMSGroupName=gtHMSGroupName, gtSLAExpires=gtSLAExpires, gtSNMPTable=gtSNMPTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUserAuthEntry=gtUserAuthEntry, gtWebProtocol=gtWebProtocol, gtUserGroup=gtUserGroup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSNMP=gtSNMP, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceCLI=gtInterfaceCLI, gtDateAndTime=gtDateAndTime, gtTrapComString=gtTrapComString, gtNetworking=gtNetworking, gtUserTable=gtUserTable, gtInterfaceIGMP=gtInterfaceIGMP, gtSLATable=gtSLATable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtAgentState=gtAgentState, gtSettingsNotifications=gtSettingsNotifications, gtPortsBitrateReceive=gtPortsBitrateReceive, gtFilename=gtFilename, gtDNSTable=gtDNSTable, gtWebEnable=gtWebEnable, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceName=gtInterfaceName, gtUserName=gtUserName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapState=gtTrapState, gtInterfaceState=gtInterfaceState, gtUserAuthEnabled=gtUserAuthEnabled, gtSyslogIP=gtSyslogIP, gtSFTPPort=gtSFTPPort, gtUpdateControl=gtUpdateControl, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSNumMembers=gtHMSNumMembers, gtSWOption=gtSWOption, gtSettingsObjects=gtSettingsObjects, gtPortsLinkup=gtPortsLinkup, gtDNSNumber=gtDNSNumber, gtNetworkTable=gtNetworkTable, gtSFPPlugged=gtSFPPlugged, gtModuleRedundancyMode=gtModuleRedundancyMode, PYSNMP_MODULE_ID=gtSettingsMIB, gtPortsNumber=gtPortsNumber, gtSFPNumber=gtSFPNumber, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtUpdateStatus=gtUpdateStatus, gtSLAEntry=gtSLAEntry, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceMAC=gtInterfaceMAC, gtTimeZone=gtTimeZone, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupAccesslist=gtGroupAccesslist, gtUserAccesslist=gtUserAccesslist, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFTPUsername=gtSFTPUsername, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentSecurityLevel=gtAgentSecurityLevel, gtGroupParamIdx=gtGroupParamIdx, gtHMSTable=gtHMSTable, gtSWOptionsIdx=gtSWOptionsIdx, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAgentComWriteString=gtAgentComWriteString, gtNetworkEntry=gtNetworkEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleBackup=gtModuleBackup, gtNTPServerAddress=gtNTPServerAddress, gtUserParamIdx=gtUserParamIdx, gtSFPTable=gtSFPTable, gtSettingsConformance=gtSettingsConformance, gtSFTPServer=gtSFTPServer, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserAuthTable=gtUserAuthTable, gtTrapUser=gtTrapUser, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtPortsEntry=gtPortsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtModuleBackupControl=gtModuleBackupControl, gtServices=gtServices, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSyslogEntry=gtSyslogEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtHMSEntry=gtHMSEntry, gtTrapDestIP=gtTrapDestIP, gtNetworkPortsTable=gtNetworkPortsTable, gtSyslogTable=gtSyslogTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFPLink=gtSFPLink, gtSyslogState=gtSyslogState, gtTimeUTC=gtTimeUTC, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleBackupStatus=gtModuleBackupStatus, gtTimeLocal=gtTimeLocal, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkName=gtNetworkName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFile=gtUpdateFile, gtPortsTable=gtPortsTable, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupEntry=gtGroupEntry, gtUserRowStatus=gtUserRowStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUser=gtUser, gtUserPassword=gtUserPassword, gtSFPType=gtSFPType, gtSFTPPassword=gtSFTPPassword, gtTrapDestPort=gtTrapDestPort, gtInterfaceTable=gtInterfaceTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserIdx=gtUserIdx, gtNTPServerNumber=gtNTPServerNumber, gtSettingsMIB=gtSettingsMIB)
