...
NotificationType, Counter32, Counter64, IpAddress, Bits, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ObjectIdentity, TimeTicks, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "IpAddress", "Bits", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleBackupDate=gtModuleBackupDate, gtSNMPTable=gtSNMPTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapUser=gtTrapUser, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTimeUTC=gtTimeUTC, gtNetworking=gtNetworking, gtUserAuthEntry=gtUserAuthEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtUserGroup=gtUserGroup, gtAccesslistEntry=gtAccesslistEntry, gtUserTable=gtUserTable, gtUpdateControl=gtUpdateControl, gtSwitch=gtSwitch, gtServicesTable=gtServicesTable, gtChassisRedundancy=gtChassisRedundancy, gtAccesslistIdx=gtAccesslistIdx, gtSFPLink=gtSFPLink, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupIdx=gtGroupIdx, gtSFPPlugged=gtSFPPlugged, gtInterfaceTable=gtInterfaceTable, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUserPassword=gtUserPassword, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceNumber=gtInterfaceNumber, gtUserRowStatus=gtUserRowStatus, gtHMSTable=gtHMSTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtWebEnable=gtWebEnable, gtModuleBackup=gtModuleBackup, gtDNSNumber=gtDNSNumber, gtAgentState=gtAgentState, gtSFPSpeed=gtSFPSpeed, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtHMSComMethod=gtHMSComMethod, gtTrapDestPort=gtTrapDestPort, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHeadendSystemManagement=gtHeadendSystemManagement, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapState=gtTrapState, gtInterfaceMAC=gtInterfaceMAC, gtAgentPort=gtAgentPort, gtUserName=gtUserName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleUpdate=gtModuleUpdate, gtBackupSFTPPort=gtBackupSFTPPort, gtSettingsCompliances=gtSettingsCompliances, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFTPPort=gtSFTPPort, gtPortsName=gtPortsName, gtServices=gtServices, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAccesslistName=gtAccesslistName, gtCurrentTimeSource=gtCurrentTimeSource, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNumSFP=gtNumSFP, gtUserEntry=gtUserEntry, gtGroupParamIdx=gtGroupParamIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapPDU=gtTrapPDU, gtTrapDestIP=gtTrapDestIP, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSyslogEntry=gtSyslogEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDNSServerIP=gtDNSServerIP, gtSLAExpires=gtSLAExpires, gtAgentComReadString=gtAgentComReadString, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapDestTable=gtTrapDestTable, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFilesTable=gtUpdateFilesTable, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsObjects=gtSettingsObjects, gtDaylightAdjustment=gtDaylightAdjustment, gtDNSEntry=gtDNSEntry, gtNTPServerTable=gtNTPServerTable, gtSNMPEntry=gtSNMPEntry, gtTrapDestEntry=gtTrapDestEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupEntry=gtGroupEntry, gtSyslogTable=gtSyslogTable, gtModuleBackupStatus=gtModuleBackupStatus, gtGroupAccesslist=gtGroupAccesslist, gtPortsEntry=gtPortsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsConformance=gtSettingsConformance, gtTimeZone=gtTimeZone, gtSLARegistered=gtSLARegistered, gtSLATable=gtSLATable, gtSettingsMIB=gtSettingsMIB, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPPassword=gtSFTPPassword, gtNTPServerAddress=gtNTPServerAddress, gtSWOption=gtSWOption, gtNetworkPortState=gtNetworkPortState, gtInterfaceState=gtInterfaceState, gtTimeLocal=gtTimeLocal, gtSWOptionsEntry=gtSWOptionsEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerNumber=gtNTPServerNumber, gtBackupStatus=gtBackupStatus, gtInterfaceName=gtInterfaceName, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGeneral=gtGeneral, gtSyslogState=gtSyslogState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortName=gtNetworkPortName, gtHMSNumAvailModules=gtHMSNumAvailModules, gtBackupControl=gtBackupControl, gtUser=gtUser, gtInterfaceIGMP=gtInterfaceIGMP, gtCurrentUserName=gtCurrentUserName, gtWebProtocol=gtWebProtocol, gtSettingsGroups=gtSettingsGroups, gtPortsTable=gtPortsTable, gtInterfaceCLI=gtInterfaceCLI, gtAccesslistTable=gtAccesslistTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAccesslist=gtUserAccesslist, gtInterfaceWebMgt=gtInterfaceWebMgt, gtGroupTable=gtGroupTable, gtPortsNumber=gtPortsNumber, gtHMSEntry=gtHMSEntry, gtPortsLinkup=gtPortsLinkup, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNTPServerEntry=gtNTPServerEntry, gtGroupName=gtGroupName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPNumber=gtSFPNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUserAuthTable=gtUserAuthTable, gtWebAuth=gtWebAuth, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceIPv4=gtInterfaceIPv4, gtUpdateStatus=gtUpdateStatus, gtFilename=gtFilename, gtSNMP=gtSNMP, gtUserParamIdx=gtUserParamIdx, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPEntry=gtSFPEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkName=gtNetworkName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSWOptionsTable=gtSWOptionsTable, gtSLAEntry=gtSLAEntry, gtModuleBackupControl=gtModuleBackupControl, gtSFTPUsername=gtSFTPUsername, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFPType=gtSFPType, gtNetworkEntry=gtNetworkEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtGroupRights=gtGroupRights, gtTrapComString=gtTrapComString, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtServicesEntry=gtServicesEntry, gtSFPTable=gtSFPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtHMSGroupName=gtHMSGroupName, gtInterfaceStreaming=gtInterfaceStreaming, gtAgentComWriteString=gtAgentComWriteString, gtNetworkTable=gtNetworkTable, gtSFTPServer=gtSFTPServer, gtDNSTable=gtDNSTable, gtHMSNumMembers=gtHMSNumMembers, gtUserIdx=gtUserIdx, gtDateAndTime=gtDateAndTime, gtAccesslistIPRange=gtAccesslistIPRange, gtUpdateFile=gtUpdateFile, gtNetworkVLAN=gtNetworkVLAN, gtSyslogIP=gtSyslogIP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState)
