...
ModuleIdentity, TimeTicks, Bits, Unsigned32, Gauge32, NotificationType, ObjectIdentity, Integer32, MibIdentifier, IpAddress, iso, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Bits", "Unsigned32", "Gauge32", "NotificationType", "ObjectIdentity", "Integer32", "MibIdentifier", "IpAddress", "iso", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtBackupStatus=gtBackupStatus, gtWebProtocol=gtWebProtocol, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateFile=gtUpdateFile, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSNMPEntry=gtSNMPEntry, gtDateAndTime=gtDateAndTime, gtSFPEntry=gtSFPEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSyslogIP=gtSyslogIP, gtSWOption=gtSWOption, gtSFPPlugged=gtSFPPlugged, gtUpdateControl=gtUpdateControl, gtNetworkName=gtNetworkName, gtPortsName=gtPortsName, gtSFTPPassword=gtSFTPPassword, gtSNMPTable=gtSNMPTable, gtHMSTable=gtHMSTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserAccesslist=gtUserAccesslist, gtSLATable=gtSLATable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupIdx=gtGroupIdx, gtUserIdx=gtUserIdx, gtUserParamIdx=gtUserParamIdx, gtSFTPServer=gtSFTPServer, gtUserAuthEntry=gtUserAuthEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsCompliances=gtSettingsCompliances, gtSWOptionsIdx=gtSWOptionsIdx, gtAccesslistEntry=gtAccesslistEntry, gtHMSGroupName=gtHMSGroupName, gtPortsEntry=gtPortsEntry, gtSyslogEntry=gtSyslogEntry, gtSFTPPort=gtSFTPPort, gtSFPSpeed=gtSFPSpeed, gtModuleBackupDate=gtModuleBackupDate, gtBackupControl=gtBackupControl, gtServicesEntry=gtServicesEntry, gtSyslogState=gtSyslogState, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserPassword=gtUserPassword, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceCLI=gtInterfaceCLI, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTimeLocal=gtTimeLocal, gtGroupTable=gtGroupTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceEntry=gtInterfaceEntry, gtDNSTable=gtDNSTable, gtTrapDestEntry=gtTrapDestEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtGeneral=gtGeneral, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPTable=gtSFPTable, gtNetworkVLAN=gtNetworkVLAN, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserAuthTable=gtUserAuthTable, gtTrapComString=gtTrapComString, gtModuleBackupTable=gtModuleBackupTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtHMSComMethod=gtHMSComMethod, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNTPServerAddress=gtNTPServerAddress, gtSwitch=gtSwitch, gtModuleBackupEntry=gtModuleBackupEntry, gtUserTable=gtUserTable, gtGroupAccesslist=gtGroupAccesslist, gtHMSEntry=gtHMSEntry, gtModuleBackup=gtModuleBackup, gtSFPType=gtSFPType, gtAgentPort=gtAgentPort, gtTrapDestNumber=gtTrapDestNumber, gtUserEntry=gtUserEntry, gtUserGroup=gtUserGroup, gtUpdateStatus=gtUpdateStatus, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupRights=gtGroupRights, gtSyslogTable=gtSyslogTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFTPUsername=gtSFTPUsername, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsGroups=gtSettingsGroups, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtModuleUpdate=gtModuleUpdate, gtTimeUTC=gtTimeUTC, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentComReadString=gtAgentComReadString, gtModuleBackupControl=gtModuleBackupControl, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupSFTPFilename=gtBackupSFTPFilename, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsTable=gtPortsTable, gtGroupEntry=gtGroupEntry, gtWebEnable=gtWebEnable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIGMP=gtInterfaceIGMP, gtNetworkPortState=gtNetworkPortState, gtPortsLinkup=gtPortsLinkup, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDateAndTimeEntry=gtDateAndTimeEntry, gtDNSEntry=gtDNSEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsNumber=gtPortsNumber, gtUserRowStatus=gtUserRowStatus, gtSLAEntry=gtSLAEntry, gtDNSServerIP=gtDNSServerIP, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkPortName=gtNetworkPortName, gtSFPLink=gtSFPLink, gtAccesslistName=gtAccesslistName, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsObjects=gtSettingsObjects, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceState=gtInterfaceState, gtNetworking=gtNetworking, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapUser=gtTrapUser, gtGroupName=gtGroupName, gtServicesTable=gtServicesTable, gtCurrentTimeSource=gtCurrentTimeSource, gtAccesslistTable=gtAccesslistTable, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapDestIP=gtTrapDestIP, gtModuleBackupStatus=gtModuleBackupStatus, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceName=gtInterfaceName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSWOptionsTable=gtSWOptionsTable, gtTrapPDU=gtTrapPDU, gtSLAExpires=gtSLAExpires, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestTable=gtTrapDestTable, gtTrapDestPort=gtTrapDestPort, gtFilename=gtFilename, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserName=gtUserName, gtAccesslistIdx=gtAccesslistIdx, gtSFPNumber=gtSFPNumber, gtInterfaceMAC=gtInterfaceMAC, gtUserAuthEnabled=gtUserAuthEnabled, gtWebAuth=gtWebAuth, gtNetworkTable=gtNetworkTable, gtAgentComWriteString=gtAgentComWriteString, gtSettingsConformance=gtSettingsConformance, gtSNMP=gtSNMP, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsMIB=gtSettingsMIB, gtNetworkEntry=gtNetworkEntry, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTimeZone=gtTimeZone, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSLARegistered=gtSLARegistered, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceTable=gtInterfaceTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtCurrentUserName=gtCurrentUserName, PYSNMP_MODULE_ID=gtSettingsMIB, gtModuleRedundancyMode=gtModuleRedundancyMode, gtAgentState=gtAgentState, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerTable=gtNTPServerTable, gtServices=gtServices, gtUser=gtUser, gtCurrentUserPassword=gtCurrentUserPassword, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNumSFP=gtNumSFP, gtDNSNumber=gtDNSNumber, gtTrapState=gtTrapState, gtNetworkPortNumber=gtNetworkPortNumber, gtHMSNumMembers=gtHMSNumMembers)
