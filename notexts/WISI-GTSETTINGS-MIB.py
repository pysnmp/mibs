...
ModuleIdentity, Counter64, NotificationType, Gauge32, Integer32, MibIdentifier, TimeTicks, iso, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "Gauge32", "Integer32", "MibIdentifier", "TimeTicks", "iso", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserGroup=gtUserGroup, gtServices=gtServices, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNTPServerNumber=gtNTPServerNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSEntry=gtHMSEntry, gtTrapPDU=gtTrapPDU, gtUserAuthEntry=gtUserAuthEntry, gtSFPSpeed=gtSFPSpeed, gtWebAuth=gtWebAuth, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGeneral=gtGeneral, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTimeUTC=gtTimeUTC, gtUserPassword=gtUserPassword, gtNetworkPortNumber=gtNetworkPortNumber, gtUserIdx=gtUserIdx, gtGroupName=gtGroupName, gtNTPServerAddress=gtNTPServerAddress, gtDNSNumber=gtDNSNumber, gtModuleBackupDate=gtModuleBackupDate, gtHMSNumMembers=gtHMSNumMembers, gtSettingsMIB=gtSettingsMIB, gtSLATable=gtSLATable, gtSFTPPassword=gtSFTPPassword, gtHMSNumAvailModules=gtHMSNumAvailModules, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkPortsTable=gtNetworkPortsTable, gtNetworkTable=gtNetworkTable, gtPortsEntry=gtPortsEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsNumber=gtPortsNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHMSGroupName=gtHMSGroupName, gtSNMPEntry=gtSNMPEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceVLAN=gtInterfaceVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAgentState=gtAgentState, gtTrapDestPort=gtTrapDestPort, gtModuleBackup=gtModuleBackup, gtAgentComReadString=gtAgentComReadString, gtUpdateFile=gtUpdateFile, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupTable=gtGroupTable, gtBackupStatus=gtBackupStatus, gtSFPPlugged=gtSFPPlugged, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentComWriteString=gtAgentComWriteString, gtUserTable=gtUserTable, gtNetworking=gtNetworking, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSWOptionsIdx=gtSWOptionsIdx, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserRowStatus=gtUserRowStatus, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceIPv4=gtInterfaceIPv4, gtNTPServerEntry=gtNTPServerEntry, gtSFPNumber=gtSFPNumber, gtDNSServerIP=gtDNSServerIP, gtCurrentTimeSource=gtCurrentTimeSource, gtBackupSFTPUsername=gtBackupSFTPUsername, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceCLI=gtInterfaceCLI, gtSFPLink=gtSFPLink, gtInterfaceMAC=gtInterfaceMAC, gtUserName=gtUserName, gtUpdateFilesTable=gtUpdateFilesTable, gtSettingsCompliances=gtSettingsCompliances, gtSLARegistered=gtSLARegistered, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPType=gtSFPType, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSFTPUsername=gtSFTPUsername, gtModuleUpdate=gtModuleUpdate, gtDateAndTime=gtDateAndTime, gtNetworkVLAN=gtNetworkVLAN, gtPortsName=gtPortsName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSNMPTable=gtSNMPTable, gtSWOption=gtSWOption, gtWebProtocol=gtWebProtocol, gtInterfaceSNMP=gtInterfaceSNMP, gtSwitch=gtSwitch, gtHMSTable=gtHMSTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortState=gtNetworkPortState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestIP=gtTrapDestIP, gtGroupIdx=gtGroupIdx, gtCurrentUserName=gtCurrentUserName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtSyslogTable=gtSyslogTable, gtInterfaceState=gtInterfaceState, gtSFPEntry=gtSFPEntry, gtSettingsObjects=gtSettingsObjects, gtDateAndTimeTable=gtDateAndTimeTable, gtUserParamIdx=gtUserParamIdx, gtSFTPPort=gtSFTPPort, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUser=gtUser, gtAccesslistTable=gtAccesslistTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsTable=gtSWOptionsTable, gtDNSTable=gtDNSTable, gtFilename=gtFilename, gtServicesTable=gtServicesTable, gtTimeZone=gtTimeZone, gtSFTPServer=gtSFTPServer, gtTimeLocal=gtTimeLocal, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSComMethod=gtHMSComMethod, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAgentPort=gtAgentPort, gtAccesslistName=gtAccesslistName, gtModuleBackupTable=gtModuleBackupTable, gtTrapComString=gtTrapComString, gtTrapDestEntry=gtTrapDestEntry, gtGroupAccesslist=gtGroupAccesslist, gtGroupRights=gtGroupRights, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsLinkup=gtPortsLinkup, gtSyslogState=gtSyslogState, gtUserAuthTable=gtUserAuthTable, gtSyslogIP=gtSyslogIP, gtWebEnable=gtWebEnable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateControl=gtUpdateControl, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUpdateStatus=gtUpdateStatus, gtInterfaceIGMP=gtInterfaceIGMP, gtSLAEntry=gtSLAEntry, gtGroupParamIdx=gtGroupParamIdx, gtSFPTable=gtSFPTable, gtModuleBackupEntry=gtModuleBackupEntry, gtDNSEntry=gtDNSEntry, gtNetworkEntry=gtNetworkEntry, gtPortsTable=gtPortsTable, gtNTPServerTable=gtNTPServerTable, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNumSFP=gtNumSFP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceTable=gtInterfaceTable, gtInterfaceName=gtInterfaceName, gtTrapUser=gtTrapUser, gtBackupControl=gtBackupControl, gtSettingsConformance=gtSettingsConformance, gtNetworkName=gtNetworkName, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSNMP=gtSNMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceEntry=gtInterfaceEntry, gtAccesslistEntry=gtAccesslistEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtUserAccesslist=gtUserAccesslist, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGroupEntry=gtGroupEntry, gtNetworkPortName=gtNetworkPortName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtServicesEntry=gtServicesEntry, gtAccesslistIdx=gtAccesslistIdx, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsGroups=gtSettingsGroups, gtTrapDestTable=gtTrapDestTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapState=gtTrapState, gtSyslogEntry=gtSyslogEntry, gtUserEntry=gtUserEntry, gtInterfaceNumber=gtInterfaceNumber, gtSLAExpires=gtSLAExpires)
