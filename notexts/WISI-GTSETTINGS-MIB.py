...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, MibIdentifier, iso, IpAddress, NotificationType, Gauge32, Counter32, ModuleIdentity, Unsigned32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "MibIdentifier", "iso", "IpAddress", "NotificationType", "Gauge32", "Counter32", "ModuleIdentity", "Unsigned32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkEntry=gtNetworkEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceTable=gtInterfaceTable, gtAgentComReadString=gtAgentComReadString, gtSFPTable=gtSFPTable, gtInterfaceName=gtInterfaceName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapDestEntry=gtTrapDestEntry, gtNTPServerTable=gtNTPServerTable, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkPortsEntry=gtNetworkPortsEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtPortsTable=gtPortsTable, gtTimeZone=gtTimeZone, gtSFTPPassword=gtSFTPPassword, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebEnable=gtWebEnable, gtInterfaceNumber=gtInterfaceNumber, gtSNMPEntry=gtSNMPEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtBackupStatus=gtBackupStatus, gtSettingsMIB=gtSettingsMIB, gtIGMPQueryInterval=gtIGMPQueryInterval, gtFilename=gtFilename, gtModuleBackupControl=gtModuleBackupControl, gtBackupSFTPServer=gtBackupSFTPServer, gtUserPassword=gtUserPassword, gtSyslogEntry=gtSyslogEntry, gtSFPNumber=gtSFPNumber, gtInterfaceEntry=gtInterfaceEntry, gtTrapDestTable=gtTrapDestTable, gtInterfaceIGMP=gtInterfaceIGMP, gtSFPType=gtSFPType, gtInterfaceDHCPState=gtInterfaceDHCPState, gtServicesEntry=gtServicesEntry, gtWebProtocol=gtWebProtocol, gtNetworkTable=gtNetworkTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentPort=gtAgentPort, gtSettingsCompliances=gtSettingsCompliances, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSTable=gtHMSTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleBackupStatus=gtModuleBackupStatus, gtHMSEntry=gtHMSEntry, gtServicesTable=gtServicesTable, gtUserIdx=gtUserIdx, gtUserEntry=gtUserEntry, gtSFTPServer=gtSFTPServer, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsNumber=gtPortsNumber, gtHMSGroupName=gtHMSGroupName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSWOptionsIdx=gtSWOptionsIdx, gtAccesslistName=gtAccesslistName, gtNetworking=gtNetworking, gtChassisRedundancy=gtChassisRedundancy, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSyslogState=gtSyslogState, gtSFPLink=gtSFPLink, gtAccesslistIPRange=gtAccesslistIPRange, gtUserTable=gtUserTable, gtUpdateStatus=gtUpdateStatus, gtNTPServerNumber=gtNTPServerNumber, gtSLATable=gtSLATable, gtUserName=gtUserName, gtGeneral=gtGeneral, gtUserAuthTable=gtUserAuthTable, gtCurrentTimeSource=gtCurrentTimeSource, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapDestPort=gtTrapDestPort, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSWOptionsTable=gtSWOptionsTable, gtPortsLinkup=gtPortsLinkup, gtHMSNumMembers=gtHMSNumMembers, gtSLARegistered=gtSLARegistered, gtSFPSpeed=gtSFPSpeed, gtSettingsConformance=gtSettingsConformance, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUserAuthEntry=gtUserAuthEntry, gtCurrentUserName=gtCurrentUserName, gtTrapDestIP=gtTrapDestIP, gtUserRowStatus=gtUserRowStatus, gtModuleBackup=gtModuleBackup, gtGroupIdx=gtGroupIdx, gtSyslogTable=gtSyslogTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthEnabled=gtUserAuthEnabled, gtSLAEntry=gtSLAEntry, gtNetworkVLAN=gtNetworkVLAN, gtAccesslistEntry=gtAccesslistEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceCLI=gtInterfaceCLI, gtCurrentUserPassword=gtCurrentUserPassword, gtUserParamIdx=gtUserParamIdx, gtTimeUTC=gtTimeUTC, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSyslogIP=gtSyslogIP, gtWebAuth=gtWebAuth, gtSLAExpires=gtSLAExpires, gtGroupEntry=gtGroupEntry, gtUpdateControl=gtUpdateControl, gtInterfaceState=gtInterfaceState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapPDU=gtTrapPDU, gtSwitch=gtSwitch, gtInterfaceMAC=gtInterfaceMAC, gtModuleUpdate=gtModuleUpdate, gtUserGroup=gtUserGroup, gtTrapComString=gtTrapComString, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkPortsTable=gtNetworkPortsTable, gtDNSEntry=gtDNSEntry, gtSettingsObjects=gtSettingsObjects, gtDateAndTime=gtDateAndTime, gtDaylightAdjustment=gtDaylightAdjustment, gtUserAccesslist=gtUserAccesslist, gtSNMPTable=gtSNMPTable, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUser=gtUser, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSWOption=gtSWOption, gtNetworkName=gtNetworkName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTrapState=gtTrapState, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapUser=gtTrapUser, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkPortName=gtNetworkPortName, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPPort=gtSFTPPort, gtSFTPUsername=gtSFTPUsername, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortState=gtNetworkPortState, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtBackupControl=gtBackupControl, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupRights=gtGroupRights, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateFile=gtUpdateFile, gtHMSComMethod=gtHMSComMethod, gtAccesslistParamIdx=gtAccesslistParamIdx, gtDNSServerIP=gtDNSServerIP, gtSNMP=gtSNMP, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPPlugged=gtSFPPlugged, gtGroupName=gtGroupName, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtServices=gtServices, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPEntry=gtSFPEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtDNSNumber=gtDNSNumber, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistTable=gtAccesslistTable, gtGroupTable=gtGroupTable, gtAgentState=gtAgentState, gtDNSTable=gtDNSTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtPortsEntry=gtPortsEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHeadendSystemManagement=gtHeadendSystemManagement, gtPortsName=gtPortsName, gtTimeLocal=gtTimeLocal, gtAccesslistIdx=gtAccesslistIdx, gtAgentComWriteString=gtAgentComWriteString, gtSettingsNotifications=gtSettingsNotifications, gtGroupParamIdx=gtGroupParamIdx, gtNumSFP=gtNumSFP, gtIGMPQuerierVersion=gtIGMPQuerierVersion)
