...
Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Bits, TimeTicks, Gauge32, MibIdentifier, ObjectIdentity, IpAddress, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Bits", "TimeTicks", "Gauge32", "MibIdentifier", "ObjectIdentity", "IpAddress", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsEntry=gtPortsEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNumSFP=gtNumSFP, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtAccesslistIdx=gtAccesslistIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapDestTable=gtTrapDestTable, gtUserIdx=gtUserIdx, gtSyslogEntry=gtSyslogEntry, gtSettingsObjects=gtSettingsObjects, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentComReadString=gtAgentComReadString, gtGroupName=gtGroupName, gtSLATable=gtSLATable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSTable=gtHMSTable, gtNetworkVLAN=gtNetworkVLAN, gtSyslogTable=gtSyslogTable, gtTrapDestPort=gtTrapDestPort, gtUserAuthEntry=gtUserAuthEntry, gtSFPSpeed=gtSFPSpeed, gtUserPassword=gtUserPassword, gtWebAuth=gtWebAuth, gtSettingsGroups=gtSettingsGroups, gtSNMP=gtSNMP, gtServicesTable=gtServicesTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapDestRowStatus=gtTrapDestRowStatus, gtAccesslistEntry=gtAccesslistEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSNumMembers=gtHMSNumMembers, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserGroup=gtUserGroup, gtModuleBackupDate=gtModuleBackupDate, gtDateAndTimeTable=gtDateAndTimeTable, gtSettingsCompliances=gtSettingsCompliances, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceVLAN=gtInterfaceVLAN, gtSwitch=gtSwitch, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkPortState=gtNetworkPortState, gtSLARegistered=gtSLARegistered, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtWebProtocol=gtWebProtocol, gtNetworkPortsTable=gtNetworkPortsTable, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSettingsConformance=gtSettingsConformance, PYSNMP_MODULE_ID=gtSettingsMIB, gtDNSNumber=gtDNSNumber, gtCurrentUserName=gtCurrentUserName, gtPortsNumber=gtPortsNumber, gtBackupStatus=gtBackupStatus, gtAgentComWriteString=gtAgentComWriteString, gtSWOptionsTable=gtSWOptionsTable, gtBackupControl=gtBackupControl, gtFilename=gtFilename, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapComString=gtTrapComString, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworking=gtNetworking, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtServicesEntry=gtServicesEntry, gtPortsName=gtPortsName, gtUserRowStatus=gtUserRowStatus, gtAccesslistIPRange=gtAccesslistIPRange, gtTimeUTC=gtTimeUTC, gtSFTPPassword=gtSFTPPassword, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMPTable=gtSNMPTable, gtInterfaceTable=gtInterfaceTable, gtTrapSecurityLevel=gtTrapSecurityLevel, gtDNSEntry=gtDNSEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceCLI=gtInterfaceCLI, gtAgentState=gtAgentState, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSLAEntry=gtSLAEntry, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsTable=gtPortsTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserName=gtUserName, gtNTPServerAddress=gtNTPServerAddress, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapDestIP=gtTrapDestIP, gtGroupIdx=gtGroupIdx, gtTrapDestEntry=gtTrapDestEntry, gtTimeZone=gtTimeZone, gtSettingsMIB=gtSettingsMIB, gtNetworkTable=gtNetworkTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUpdateControl=gtUpdateControl, gtAgentPort=gtAgentPort, gtInterfaceName=gtInterfaceName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserParamIdx=gtUserParamIdx, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSFPTable=gtSFPTable, gtNetworkPortName=gtNetworkPortName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPLink=gtSFPLink, gtNetworkName=gtNetworkName, gtNTPServerTable=gtNTPServerTable, gtTrapState=gtTrapState, gtUserEntry=gtUserEntry, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtServices=gtServices, gtSFPType=gtSFPType, gtSyslogState=gtSyslogState, gtTrapPDU=gtTrapPDU, gtUserTable=gtUserTable, gtUpdateFile=gtUpdateFile, gtTrapUser=gtTrapUser, gtGroupEntry=gtGroupEntry, gtModuleBackupTable=gtModuleBackupTable, gtUser=gtUser, gtInterfaceState=gtInterfaceState, gtSFPPlugged=gtSFPPlugged, gtUserAccesslist=gtUserAccesslist, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceEntry=gtInterfaceEntry, gtTimeLocal=gtTimeLocal, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtGroupTable=gtGroupTable, gtChassisRedundancy=gtChassisRedundancy, gtGeneral=gtGeneral, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupRights=gtGroupRights, gtDateAndTime=gtDateAndTime, gtModuleBackupStatus=gtModuleBackupStatus, gtDNSServerIP=gtDNSServerIP, gtSNMPEntry=gtSNMPEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDNSTable=gtDNSTable, gtCurrentUserPassword=gtCurrentUserPassword, gtSFTPUsername=gtSFTPUsername, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceMAC=gtInterfaceMAC, gtHMSGroupName=gtHMSGroupName, gtAccesslistName=gtAccesslistName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtNTPServerNumber=gtNTPServerNumber, gtSFPEntry=gtSFPEntry, gtGroupAccesslist=gtGroupAccesslist, gtTrapDestNumber=gtTrapDestNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceNumber=gtInterfaceNumber, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortsEntry=gtNetworkPortsEntry, gtWebEnable=gtWebEnable, gtPortsLinkup=gtPortsLinkup, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFTPServer=gtSFTPServer, gtSyslogIP=gtSyslogIP, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAccesslistTable=gtAccesslistTable, gtSWOption=gtSWOption, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFTPPort=gtSFTPPort, gtSettingsNotifications=gtSettingsNotifications, gtNetworkEntry=gtNetworkEntry, gtModuleBackup=gtModuleBackup, gtHMSEntry=gtHMSEntry, gtHMSComMethod=gtHMSComMethod, gtModuleUpdate=gtModuleUpdate, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSWOptionsIdx=gtSWOptionsIdx, gtSLAExpires=gtSLAExpires, gtUpdateStatus=gtUpdateStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPNumber=gtSFPNumber)
