...
Counter64, Bits, Gauge32, Counter32, iso, ObjectIdentity, MibIdentifier, NotificationType, Integer32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Gauge32", "Counter32", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtGroupName=gtGroupName, gtTrapDestPort=gtTrapDestPort, gtModuleBackupStatus=gtModuleBackupStatus, gtGroupAccesslist=gtGroupAccesslist, gtUserAuthTable=gtUserAuthTable, gtNetworkPortsTable=gtNetworkPortsTable, gtGroupParamIdx=gtGroupParamIdx, gtUserTable=gtUserTable, gtNTPServerEntry=gtNTPServerEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerAddress=gtNTPServerAddress, gtNumSFP=gtNumSFP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupControl=gtBackupControl, gtNetworkPortState=gtNetworkPortState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAccesslistIdx=gtAccesslistIdx, gtModuleBackupDate=gtModuleBackupDate, gtSFTPPassword=gtSFTPPassword, gtInterfaceSNMP=gtInterfaceSNMP, PYSNMP_MODULE_ID=gtSettingsMIB, gtTimeZone=gtTimeZone, gtSyslogState=gtSyslogState, gtAgentComReadString=gtAgentComReadString, gtAgentSecurityLevel=gtAgentSecurityLevel, gtServicesEntry=gtServicesEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSNMPEntry=gtSNMPEntry, gtSFPType=gtSFPType, gtWebEnable=gtWebEnable, gtUserRowStatus=gtUserRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsNotifications=gtSettingsNotifications, gtChassisRedundancy=gtChassisRedundancy, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleBackupControl=gtModuleBackupControl, gtSFTPServer=gtSFTPServer, gtAccesslistName=gtAccesslistName, gtSFPEntry=gtSFPEntry, gtDNSNumber=gtDNSNumber, gtInterfaceState=gtInterfaceState, gtSFPNumber=gtSFPNumber, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSWOption=gtSWOption, gtSLAEntry=gtSLAEntry, gtTrapPDU=gtTrapPDU, gtUpdateFile=gtUpdateFile, gtDNSEntry=gtDNSEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtWebAuth=gtWebAuth, gtSFPSpeed=gtSFPSpeed, gtNetworking=gtNetworking, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNTPServerTable=gtNTPServerTable, gtAgentState=gtAgentState, gtServicesTable=gtServicesTable, gtTimeLocal=gtTimeLocal, gtUserParamIdx=gtUserParamIdx, gtNetworkEntry=gtNetworkEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapSecurityLevel=gtTrapSecurityLevel, gtPortsNumber=gtPortsNumber, gtInterfaceTable=gtInterfaceTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapDestRowStatus=gtTrapDestRowStatus, gtAccesslistTable=gtAccesslistTable, gtInterfaceCLI=gtInterfaceCLI, gtUpdateControl=gtUpdateControl, gtAgentPort=gtAgentPort, gtServices=gtServices, gtUserAuthEntry=gtUserAuthEntry, gtSNMP=gtSNMP, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsConformance=gtSettingsConformance, gtSWOptionsTable=gtSWOptionsTable, gtTrapComString=gtTrapComString, gtBackupStatus=gtBackupStatus, gtCurrentUserName=gtCurrentUserName, gtSFPTable=gtSFPTable, gtModuleBackup=gtModuleBackup, gtInterfaceIPv4=gtInterfaceIPv4, gtTimeUTC=gtTimeUTC, gtSyslogTable=gtSyslogTable, gtUserGroup=gtUserGroup, gtHMSNumMembers=gtHMSNumMembers, gtSLARegistered=gtSLARegistered, gtNetworkPortNumber=gtNetworkPortNumber, gtSNMPTable=gtSNMPTable, gtInterfaceName=gtInterfaceName, gtDateAndTime=gtDateAndTime, gtSLATable=gtSLATable, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkVLAN=gtNetworkVLAN, gtTrapState=gtTrapState, gtGeneral=gtGeneral, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsGroups=gtSettingsGroups, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceEntry=gtInterfaceEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtWebProtocol=gtWebProtocol, gtTrapDestIP=gtTrapDestIP, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSwitch=gtSwitch, gtSettingsMIB=gtSettingsMIB, gtSyslogIP=gtSyslogIP, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupIdx=gtGroupIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceIGMP=gtInterfaceIGMP, gtPortsEntry=gtPortsEntry, gtHMSTable=gtHMSTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupRights=gtGroupRights, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPPlugged=gtSFPPlugged, gtTrapDestTable=gtTrapDestTable, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceNumber=gtInterfaceNumber, gtHMSEntry=gtHMSEntry, gtUserAccesslist=gtUserAccesslist, gtTrapDestNumber=gtTrapDestNumber, gtSettingsObjects=gtSettingsObjects, gtHMSGroupName=gtHMSGroupName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtPortsTable=gtPortsTable, gtHMSComMethod=gtHMSComMethod, gtAgentComWriteString=gtAgentComWriteString, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkTable=gtNetworkTable, gtSFTPUsername=gtSFTPUsername, gtUserEntry=gtUserEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSLAExpires=gtSLAExpires, gtNetworkName=gtNetworkName, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNTPServerNumber=gtNTPServerNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtModuleBackupTable=gtModuleBackupTable, gtPortsLinkup=gtPortsLinkup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtDNSServerIP=gtDNSServerIP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapUser=gtTrapUser, gtFilename=gtFilename, gtTrapDestEntry=gtTrapDestEntry, gtModuleUpdate=gtModuleUpdate, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortName=gtNetworkPortName, gtSFPLink=gtSFPLink, gtPortsName=gtPortsName, gtUserIdx=gtUserIdx, gtUserPassword=gtUserPassword, gtGroupTable=gtGroupTable, gtUser=gtUser, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserName=gtUserName, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtDNSTable=gtDNSTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFTPPort=gtSFTPPort, gtGroupEntry=gtGroupEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime)
