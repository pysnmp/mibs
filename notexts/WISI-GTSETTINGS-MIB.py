...
Gauge32, Counter64, ObjectIdentity, NotificationType, ModuleIdentity, Counter32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Unsigned32, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Counter32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Unsigned32", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkTable=gtNetworkTable, gtAgentPort=gtAgentPort, gtSettingsMIB=gtSettingsMIB, gtSWOptionsEntry=gtSWOptionsEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTimeLocal=gtTimeLocal, gtPortsBitrateReceive=gtPortsBitrateReceive, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceTable=gtInterfaceTable, gtSLATable=gtSLATable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSyslogTable=gtSyslogTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOptionsIdx=gtSWOptionsIdx, gtServices=gtServices, gtSWOptionsTable=gtSWOptionsTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtChassisRedundancy=gtChassisRedundancy, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtPortsLinkup=gtPortsLinkup, gtAccesslistName=gtAccesslistName, gtDateAndTimeTable=gtDateAndTimeTable, gtSFTPPort=gtSFTPPort, gtSNMP=gtSNMP, gtNetworkEntry=gtNetworkEntry, gtGroupEntry=gtGroupEntry, gtSettingsGroups=gtSettingsGroups, gtGroupAccesslist=gtGroupAccesslist, gtCurrentUserPassword=gtCurrentUserPassword, gtUserAuthTable=gtUserAuthTable, gtNTPServerEntry=gtNTPServerEntry, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceEntry=gtInterfaceEntry, gtSyslogIP=gtSyslogIP, gtSFPNumber=gtSFPNumber, gtTrapUser=gtTrapUser, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDNSEntry=gtDNSEntry, gtGroupIdx=gtGroupIdx, gtSwitch=gtSwitch, gtGroupName=gtGroupName, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPPassword=gtSFTPPassword, gtTrapDestRowStatus=gtTrapDestRowStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsNotifications=gtSettingsNotifications, gtUserTable=gtUserTable, gtSettingsObjects=gtSettingsObjects, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLARegistered=gtSLARegistered, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUpdateStatus=gtUpdateStatus, gtUserEntry=gtUserEntry, gtPortsName=gtPortsName, gtInterfaceStreaming=gtInterfaceStreaming, gtDNSServerIP=gtDNSServerIP, gtUserGroup=gtUserGroup, gtSettingsCompliances=gtSettingsCompliances, gtSyslogEntry=gtSyslogEntry, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestNumber=gtTrapDestNumber, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkName=gtNetworkName, gtBackupControl=gtBackupControl, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserAccesslist=gtUserAccesslist, gtSFPTable=gtSFPTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSTable=gtHMSTable, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkPortState=gtNetworkPortState, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceState=gtInterfaceState, gtUpdateFile=gtUpdateFile, gtWebProtocol=gtWebProtocol, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupTable=gtGroupTable, gtModuleUpdate=gtModuleUpdate, gtModuleBackup=gtModuleBackup, gtSFPLink=gtSFPLink, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentState=gtAgentState, gtTrapPDU=gtTrapPDU, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFTPServer=gtSFTPServer, gtAgentComReadString=gtAgentComReadString, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtWebEnable=gtWebEnable, gtHMSEntry=gtHMSEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworking=gtNetworking, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSLAExpires=gtSLAExpires, gtNTPServerTable=gtNTPServerTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHMSComMethod=gtHMSComMethod, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistTable=gtAccesslistTable, gtCurrentUserName=gtCurrentUserName, gtServicesTable=gtServicesTable, gtUpdateControl=gtUpdateControl, gtAccesslistIdx=gtAccesslistIdx, gtTimeZone=gtTimeZone, gtPortsNumber=gtPortsNumber, gtDaylightAdjustment=gtDaylightAdjustment, gtSLAEntry=gtSLAEntry, gtNetworkPortName=gtNetworkPortName, gtTrapDestTable=gtTrapDestTable, gtNTPServerAddress=gtNTPServerAddress, gtTrapComString=gtTrapComString, gtBackupStatus=gtBackupStatus, gtNTPServerNumber=gtNTPServerNumber, gtUserAuthEnabled=gtUserAuthEnabled, gtDNSNumber=gtDNSNumber, gtBackupSFTPPort=gtBackupSFTPPort, gtSNMPTable=gtSNMPTable, gtUserRowStatus=gtUserRowStatus, gtDNSTable=gtDNSTable, gtInterfaceNumber=gtInterfaceNumber, gtSFPSpeed=gtSFPSpeed, gtAccesslistEntry=gtAccesslistEntry, gtPortsEntry=gtPortsEntry, gtServicesEntry=gtServicesEntry, gtGroupRights=gtGroupRights, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAgentComWriteString=gtAgentComWriteString, gtModuleRedundancyMode=gtModuleRedundancyMode, gtWebAuth=gtWebAuth, gtHMSGroupName=gtHMSGroupName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSWOption=gtSWOption, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapDestIP=gtTrapDestIP, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSNMPEntry=gtSNMPEntry, gtInterfaceCLI=gtInterfaceCLI, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortNumber=gtNetworkPortNumber, gtUserPassword=gtUserPassword, gtSFPEntry=gtSFPEntry, gtSyslogState=gtSyslogState, gtUserParamIdx=gtUserParamIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNumSFP=gtNumSFP, gtInterfaceMAC=gtInterfaceMAC, gtSFPPlugged=gtSFPPlugged, gtTrapState=gtTrapState, gtSettingsConformance=gtSettingsConformance, gtInterfaceVLAN=gtInterfaceVLAN, gtUser=gtUser, gtUserIdx=gtUserIdx, gtUserName=gtUserName, gtInterfaceName=gtInterfaceName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTimeUTC=gtTimeUTC, gtPortsTable=gtPortsTable, gtSFPType=gtSFPType, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFTPUsername=gtSFTPUsername, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtDateAndTime=gtDateAndTime, gtGeneral=gtGeneral, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtFilename=gtFilename)
