...
TimeTicks, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter32, ModuleIdentity, Gauge32, Counter64, Bits, Integer32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter32", "ModuleIdentity", "Gauge32", "Counter64", "Bits", "Integer32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworking=gtNetworking, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsGroups=gtSettingsGroups, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserEntry=gtUserEntry, gtServicesTable=gtServicesTable, gtGroupRights=gtGroupRights, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSComMethod=gtHMSComMethod, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceMAC=gtInterfaceMAC, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestPort=gtTrapDestPort, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtWebEnable=gtWebEnable, gtAgentPort=gtAgentPort, gtUserParamIdx=gtUserParamIdx, gtUserIdx=gtUserIdx, gtTimeLocal=gtTimeLocal, gtSFPType=gtSFPType, gtSyslogIP=gtSyslogIP, gtSettingsMIB=gtSettingsMIB, gtTimeUTC=gtTimeUTC, PYSNMP_MODULE_ID=gtSettingsMIB, gtBackupSFTPUsername=gtBackupSFTPUsername, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceNumber=gtInterfaceNumber, gtSLAEntry=gtSLAEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateFilesTable=gtUpdateFilesTable, gtSNMPTable=gtSNMPTable, gtGeneral=gtGeneral, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateStatus=gtUpdateStatus, gtSFTPPassword=gtSFTPPassword, gtDateAndTime=gtDateAndTime, gtModuleBackupControl=gtModuleBackupControl, gtModuleBackup=gtModuleBackup, gtSFPSpeed=gtSFPSpeed, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPPort=gtBackupSFTPPort, gtModuleUpdate=gtModuleUpdate, gtCurrentUserPassword=gtCurrentUserPassword, gtNumSFP=gtNumSFP, gtBackupStatus=gtBackupStatus, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUpdateFile=gtUpdateFile, gtSWOptionsEntry=gtSWOptionsEntry, gtSNMPEntry=gtSNMPEntry, gtWebProtocol=gtWebProtocol, gtIGMPQueryInterval=gtIGMPQueryInterval, gtHMSGroupName=gtHMSGroupName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSLAExpires=gtSLAExpires, gtTrapComString=gtTrapComString, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsConformance=gtSettingsConformance, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSNMP=gtSNMP, gtSwitch=gtSwitch, gtUserAccesslist=gtUserAccesslist, gtUserRowStatus=gtUserRowStatus, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapDestIP=gtTrapDestIP, gtNetworkPortName=gtNetworkPortName, gtGroupName=gtGroupName, gtDNSEntry=gtDNSEntry, gtGroupAccesslist=gtGroupAccesslist, gtNetworkPortState=gtNetworkPortState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsCompliances=gtSettingsCompliances, gtPortsLinkup=gtPortsLinkup, gtDNSNumber=gtDNSNumber, gtAccesslistName=gtAccesslistName, gtHMSEntry=gtHMSEntry, gtNetworkEntry=gtNetworkEntry, gtNetworkTable=gtNetworkTable, gtNTPServerNumber=gtNTPServerNumber, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSTable=gtHMSTable, gtTrapDestEntry=gtTrapDestEntry, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistTable=gtAccesslistTable, gtSFPPlugged=gtSFPPlugged, gtSyslogState=gtSyslogState, gtPortsNumber=gtPortsNumber, gtNetworkPortsTable=gtNetworkPortsTable, gtModuleBackupDate=gtModuleBackupDate, gtSWOptionsTable=gtSWOptionsTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapDestTable=gtTrapDestTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUserName=gtUserName, gtSLARegistered=gtSLARegistered, gtInterfaceState=gtInterfaceState, gtUpdateControl=gtUpdateControl, gtDNSServerIP=gtDNSServerIP, gtUserAuthTable=gtUserAuthTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsTable=gtPortsTable, gtBackupControl=gtBackupControl, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupIdx=gtGroupIdx, gtSFPNumber=gtSFPNumber, gtInterfaceName=gtInterfaceName, gtSFTPUsername=gtSFTPUsername, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTrapDestNumber=gtTrapDestNumber, gtWebAuth=gtWebAuth, gtInterfaceDHCPState=gtInterfaceDHCPState, gtPortsName=gtPortsName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSettingsObjects=gtSettingsObjects, gtHMSNumMembers=gtHMSNumMembers, gtGroupTable=gtGroupTable, gtPortsEntry=gtPortsEntry, gtNTPServerTable=gtNTPServerTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupStatus=gtModuleBackupStatus, gtAgentState=gtAgentState, gtCurrentTimeSource=gtCurrentTimeSource, gtUserPassword=gtUserPassword, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserAuthEntry=gtUserAuthEntry, gtTrapPDU=gtTrapPDU, gtCurrentUserName=gtCurrentUserName, gtGroupEntry=gtGroupEntry, gtSLATable=gtSLATable, gtFilename=gtFilename, gtServices=gtServices, gtUser=gtUser, gtSFPEntry=gtSFPEntry, gtInterfaceTable=gtInterfaceTable, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserGroup=gtUserGroup, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkPortNumber=gtNetworkPortNumber, gtSWOptionsIdx=gtSWOptionsIdx, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapState=gtTrapState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtDNSTable=gtDNSTable, gtNetworkName=gtNetworkName, gtSyslogEntry=gtSyslogEntry, gtSFTPPort=gtSFTPPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceCLI=gtInterfaceCLI, gtAgentComReadString=gtAgentComReadString, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserAuthEnabled=gtUserAuthEnabled, gtChassisRedundancy=gtChassisRedundancy, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceIPv4=gtInterfaceIPv4, gtBackupSFTPServer=gtBackupSFTPServer, gtSyslogTable=gtSyslogTable, gtUserTable=gtUserTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtServicesEntry=gtServicesEntry, gtSFPLink=gtSFPLink, gtInterfaceEntry=gtInterfaceEntry, gtSWOption=gtSWOption, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkVLAN=gtNetworkVLAN, gtSFPTable=gtSFPTable, gtSFTPServer=gtSFTPServer, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapUser=gtTrapUser, gtTimeZone=gtTimeZone)
