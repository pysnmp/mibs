...
ModuleIdentity, MibIdentifier, Gauge32, Counter64, Bits, iso, ObjectIdentity, Integer32, IpAddress, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "Gauge32", "Counter64", "Bits", "iso", "ObjectIdentity", "Integer32", "IpAddress", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUpdateControl=gtUpdateControl, gtModuleBackupControl=gtModuleBackupControl, gtNetworkTable=gtNetworkTable, gtUserGroup=gtUserGroup, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtAccesslistTable=gtAccesslistTable, gtServices=gtServices, gtGroupRights=gtGroupRights, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNTPServerTable=gtNTPServerTable, gtNetworkPortName=gtNetworkPortName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtNTPServerNumber=gtNTPServerNumber, gtTrapDestTable=gtTrapDestTable, gtInterfaceNumber=gtInterfaceNumber, gtGroupParamIdx=gtGroupParamIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAccesslistEntry=gtAccesslistEntry, gtSettingsMIB=gtSettingsMIB, gtNetworkPortsTable=gtNetworkPortsTable, gtSFPSpeed=gtSFPSpeed, gtGroupTable=gtGroupTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortState=gtNetworkPortState, gtTrapUser=gtTrapUser, gtHMSTable=gtHMSTable, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSyslogIP=gtSyslogIP, gtUserPassword=gtUserPassword, gtSettingsGroups=gtSettingsGroups, gtTrapComString=gtTrapComString, gtSyslogEntry=gtSyslogEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapPDU=gtTrapPDU, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkName=gtNetworkName, gtHMSComMethod=gtHMSComMethod, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceCLI=gtInterfaceCLI, gtUser=gtUser, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestRowStatus=gtTrapDestRowStatus, gtHMSNumMembers=gtHMSNumMembers, gtUserAccesslist=gtUserAccesslist, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtModuleBackupDate=gtModuleBackupDate, gtSFTPPort=gtSFTPPort, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtGroupAccesslist=gtGroupAccesslist, gtSNMP=gtSNMP, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUserRowStatus=gtUserRowStatus, gtSettingsConformance=gtSettingsConformance, gtUserTable=gtUserTable, gtAgentPort=gtAgentPort, gtSWOptionsTable=gtSWOptionsTable, gtDNSNumber=gtDNSNumber, gtTrapState=gtTrapState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDNSServerIP=gtDNSServerIP, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapDestNumber=gtTrapDestNumber, gtTimeUTC=gtTimeUTC, gtTrapDestIP=gtTrapDestIP, gtInterfaceName=gtInterfaceName, gtGroupEntry=gtGroupEntry, gtSFTPServer=gtSFTPServer, gtAccesslistName=gtAccesslistName, gtSWOption=gtSWOption, gtPortsTable=gtPortsTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtFilename=gtFilename, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAccesslistIPRange=gtAccesslistIPRange, gtBackupControl=gtBackupControl, gtSFTPUsername=gtSFTPUsername, gtHMSEntry=gtHMSEntry, gtAgentState=gtAgentState, gtNTPServerAddress=gtNTPServerAddress, gtAgentComReadString=gtAgentComReadString, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSLATable=gtSLATable, gtNumSFP=gtNumSFP, gtSettingsNotifications=gtSettingsNotifications, gtSLAEntry=gtSLAEntry, gtSFPNumber=gtSFPNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtSyslogState=gtSyslogState, gtSNMPTable=gtSNMPTable, gtTimeZone=gtTimeZone, gtUserEntry=gtUserEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServicesTable=gtServicesTable, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSettingsObjects=gtSettingsObjects, gtNetworkEntry=gtNetworkEntry, gtUserAuthEntry=gtUserAuthEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtServicesEntry=gtServicesEntry, gtUserName=gtUserName, gtSyslogTable=gtSyslogTable, gtCurrentUserName=gtCurrentUserName, gtBackupStatus=gtBackupStatus, gtUserParamIdx=gtUserParamIdx, gtInterfaceIGMP=gtInterfaceIGMP, gtGroupIdx=gtGroupIdx, gtPortsLinkup=gtPortsLinkup, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsBitrateReceive=gtPortsBitrateReceive, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkPortsEntry=gtNetworkPortsEntry, gtWebProtocol=gtWebProtocol, gtInterfaceTable=gtInterfaceTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceIPv4=gtInterfaceIPv4, gtGeneral=gtGeneral, gtPortsEntry=gtPortsEntry, gtSFPEntry=gtSFPEntry, gtSwitch=gtSwitch, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserIdx=gtUserIdx, gtUpdateFile=gtUpdateFile, gtDNSEntry=gtDNSEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFTPPassword=gtSFTPPassword, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAgentComWriteString=gtAgentComWriteString, gtUpdateStatus=gtUpdateStatus, gtWebAuth=gtWebAuth, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSNMPEntry=gtSNMPEntry, gtTrapDestPort=gtTrapDestPort, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupName=gtGroupName, gtUserAuthTable=gtUserAuthTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworking=gtNetworking, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleBackup=gtModuleBackup, gtInterfaceSNMP=gtInterfaceSNMP, PYSNMP_MODULE_ID=gtSettingsMIB, gtHMSGroupName=gtHMSGroupName, gtTimeLocal=gtTimeLocal, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDateAndTime=gtDateAndTime, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtWebEnable=gtWebEnable, gtPortsNumber=gtPortsNumber, gtInterfaceState=gtInterfaceState, gtSFPPlugged=gtSFPPlugged, gtSLAExpires=gtSLAExpires, gtSFPLink=gtSFPLink, gtChassisRedundancy=gtChassisRedundancy, gtPortsName=gtPortsName, gtSFPTable=gtSFPTable, gtSLARegistered=gtSLARegistered, gtInterfaceMAC=gtInterfaceMAC, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkVLAN=gtNetworkVLAN, gtSFPType=gtSFPType, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceEntry=gtInterfaceEntry, gtDNSTable=gtDNSTable, gtNetworkPortNumber=gtNetworkPortNumber)
