...
Counter64, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, MibIdentifier, Integer32, Bits, Unsigned32, ObjectIdentity, Gauge32, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "MibIdentifier", "Integer32", "Bits", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSNMPTable=gtSNMPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSWOptionsTable=gtSWOptionsTable, gtNTPServerAddress=gtNTPServerAddress, gtCurrentUserName=gtCurrentUserName, gtNetworking=gtNetworking, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSettingsNotifications=gtSettingsNotifications, gtServicesTable=gtServicesTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortState=gtNetworkPortState, gtUserParamIdx=gtUserParamIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkVLAN=gtNetworkVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserGroup=gtUserGroup, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtHMSNumAvailModules=gtHMSNumAvailModules, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUpdateControl=gtUpdateControl, gtSWOption=gtSWOption, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSettingsConformance=gtSettingsConformance, gtInterfaceTable=gtInterfaceTable, gtSyslogEntry=gtSyslogEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtNTPServerNumber=gtNTPServerNumber, gtAccesslistIdx=gtAccesslistIdx, gtModuleBackupEntry=gtModuleBackupEntry, gtHMSNumMembers=gtHMSNumMembers, gtGroupTable=gtGroupTable, gtTrapState=gtTrapState, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserRowStatus=gtUserRowStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtDateAndTime=gtDateAndTime, gtTrapDestNumber=gtTrapDestNumber, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsCompliances=gtSettingsCompliances, gtNetworkPortName=gtNetworkPortName, gtSFPType=gtSFPType, gtInterfaceIPv4=gtInterfaceIPv4, gtDNSNumber=gtDNSNumber, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSLATable=gtSLATable, gtBackupStatus=gtBackupStatus, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateFile=gtUpdateFile, gtNumSFP=gtNumSFP, gtNTPServerTable=gtNTPServerTable, gtSFPPlugged=gtSFPPlugged, gtTrapPDU=gtTrapPDU, gtTrapDestPort=gtTrapDestPort, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTimeLocal=gtTimeLocal, gtGroupParamIdx=gtGroupParamIdx, gtWebAuth=gtWebAuth, gtUpdateStatus=gtUpdateStatus, gtSFPSpeed=gtSFPSpeed, gtHMSComMethod=gtHMSComMethod, gtTimeUTC=gtTimeUTC, gtSettingsMIB=gtSettingsMIB, gtHMSGroupName=gtHMSGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAuthTable=gtUserAuthTable, gtUpdateFilesTable=gtUpdateFilesTable, gtHMSTable=gtHMSTable, gtTrapDestTable=gtTrapDestTable, gtDNSEntry=gtDNSEntry, gtPortsNumber=gtPortsNumber, gtUserPassword=gtUserPassword, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapDestEntry=gtTrapDestEntry, gtSFPEntry=gtSFPEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceState=gtInterfaceState, gtUserEntry=gtUserEntry, gtModuleBackupTable=gtModuleBackupTable, gtSFTPServer=gtSFTPServer, gtWebEnable=gtWebEnable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFTPPassword=gtSFTPPassword, gtHMSEntry=gtHMSEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceVLAN=gtInterfaceVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFTPUsername=gtSFTPUsername, gtUserIdx=gtUserIdx, gtAgentState=gtAgentState, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSServerIP=gtDNSServerIP, gtUserTable=gtUserTable, gtModuleBackup=gtModuleBackup, gtSyslogState=gtSyslogState, gtInterfaceIGMP=gtInterfaceIGMP, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceMAC=gtInterfaceMAC, gtSNMPEntry=gtSNMPEntry, gtGroupEntry=gtGroupEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupControl=gtModuleBackupControl, gtSLAEntry=gtSLAEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtPortsTable=gtPortsTable, gtInterfaceNumber=gtInterfaceNumber, gtSettingsObjects=gtSettingsObjects, gtSFPTable=gtSFPTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleUpdate=gtModuleUpdate, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkPortsTable=gtNetworkPortsTable, gtNetworkTable=gtNetworkTable, gtSwitch=gtSwitch, gtSyslogIP=gtSyslogIP, gtPortsEntry=gtPortsEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPNumber=gtSFPNumber, gtTrapUser=gtTrapUser, gtSyslogTable=gtSyslogTable, gtUserAuthEntry=gtUserAuthEntry, gtGroupIdx=gtGroupIdx, gtDaylightAdjustment=gtDaylightAdjustment, gtServicesEntry=gtServicesEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPPort=gtSFTPPort, gtSLAExpires=gtSLAExpires, gtBackupSFTPFilename=gtBackupSFTPFilename, gtFilename=gtFilename, gtGroupRights=gtGroupRights, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserName=gtUserName, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtUserAccesslist=gtUserAccesslist, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceEntry=gtInterfaceEntry, gtChassisRedundancy=gtChassisRedundancy, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAccesslistName=gtAccesslistName, gtInterfaceName=gtInterfaceName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSTable=gtDNSTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupName=gtGroupName, gtBackupControl=gtBackupControl, gtWebProtocol=gtWebProtocol, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkName=gtNetworkName, gtAgentComReadString=gtAgentComReadString, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtGeneral=gtGeneral, gtNetworkEntry=gtNetworkEntry, gtPortsLinkup=gtPortsLinkup, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPLink=gtSFPLink, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTimeZone=gtTimeZone, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentPort=gtAgentPort, gtSLARegistered=gtSLARegistered, gtTrapComString=gtTrapComString, gtTrapDestIP=gtTrapDestIP, gtPortsName=gtPortsName, gtServices=gtServices, gtAccesslistTable=gtAccesslistTable, gtNTPServerEntry=gtNTPServerEntry, gtSNMP=gtSNMP, gtUser=gtUser)
