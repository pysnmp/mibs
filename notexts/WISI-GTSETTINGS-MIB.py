...
TimeTicks, Bits, NotificationType, Integer32, Counter64, Unsigned32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Gauge32, Counter32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Gauge32", "Counter32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtWebProtocol=gtWebProtocol, gtHMSGroupName=gtHMSGroupName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPType=gtSFPType, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceIGMP=gtInterfaceIGMP, gtSyslogTable=gtSyslogTable, gtTrapDestNumber=gtTrapDestNumber, gtAgentPort=gtAgentPort, gtInterfaceState=gtInterfaceState, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtDaylightAdjustment=gtDaylightAdjustment, gtSNMP=gtSNMP, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateFile=gtUpdateFile, gtNetworkPortState=gtNetworkPortState, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNTPServerEntry=gtNTPServerEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTimeLocal=gtTimeLocal, gtNetworking=gtNetworking, gtServicesTable=gtServicesTable, gtBackupControl=gtBackupControl, gtUserIdx=gtUserIdx, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapDestIP=gtTrapDestIP, gtPortsNumber=gtPortsNumber, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceName=gtInterfaceName, gtAccesslistTable=gtAccesslistTable, gtSWOption=gtSWOption, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFPTable=gtSFPTable, gtHMSEntry=gtHMSEntry, gtGroupEntry=gtGroupEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPNumber=gtSFPNumber, gtHMSTable=gtHMSTable, gtUpdateControl=gtUpdateControl, gtPortsName=gtPortsName, gtUserAuthTable=gtUserAuthTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDNSEntry=gtDNSEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtHMSComMethod=gtHMSComMethod, gtWebAuth=gtWebAuth, gtAccesslistIPRange=gtAccesslistIPRange, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFTPServer=gtSFTPServer, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtFilename=gtFilename, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtDateAndTimeEntry=gtDateAndTimeEntry, gtPortsTable=gtPortsTable, gtGroupRights=gtGroupRights, gtInterfaceVLAN=gtInterfaceVLAN, gtDNSServerIP=gtDNSServerIP, gtSettingsMIB=gtSettingsMIB, gtServices=gtServices, gtSNMPTable=gtSNMPTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtModuleBackup=gtModuleBackup, gtTrapDestPort=gtTrapDestPort, gtGroupIdx=gtGroupIdx, gtAccesslistIdx=gtAccesslistIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTimeUTC=gtTimeUTC, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFTPUsername=gtSFTPUsername, gtUserAccesslist=gtUserAccesslist, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNTPServerAddress=gtNTPServerAddress, gtDateAndTime=gtDateAndTime, gtInterfaceRowStatus=gtInterfaceRowStatus, gtAgentState=gtAgentState, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSyslogIP=gtSyslogIP, gtSFPPlugged=gtSFPPlugged, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapState=gtTrapState, gtUserEntry=gtUserEntry, gtUserRowStatus=gtUserRowStatus, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupEntry=gtModuleBackupEntry, gtAccesslistEntry=gtAccesslistEntry, gtSFTPPort=gtSFTPPort, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkPortName=gtNetworkPortName, gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkEntry=gtNetworkEntry, gtAgentComWriteString=gtAgentComWriteString, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapComString=gtTrapComString, gtNetworkVLAN=gtNetworkVLAN, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNTPServerNumber=gtNTPServerNumber, gtServicesEntry=gtServicesEntry, gtSLATable=gtSLATable, gtSFPEntry=gtSFPEntry, gtSFPSpeed=gtSFPSpeed, gtGroupParamIdx=gtGroupParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapDestEntry=gtTrapDestEntry, gtSLARegistered=gtSLARegistered, gtSyslogState=gtSyslogState, gtModuleBackupDate=gtModuleBackupDate, gtUserPassword=gtUserPassword, gtSLAEntry=gtSLAEntry, gtInterfaceMAC=gtInterfaceMAC, gtSNMPEntry=gtSNMPEntry, gtWebEnable=gtWebEnable, gtSettingsObjects=gtSettingsObjects, gtSFPLink=gtSFPLink, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSWOptionsTable=gtSWOptionsTable, gtSyslogEntry=gtSyslogEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistName=gtAccesslistName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtBackupStatus=gtBackupStatus, gtDNSTable=gtDNSTable, gtGroupName=gtGroupName, gtInterfaceNumber=gtInterfaceNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateStatus=gtUpdateStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserName=gtUserName, gtDNSNumber=gtDNSNumber, gtUserAuthEntry=gtUserAuthEntry, gtTrapPDU=gtTrapPDU, gtGroupAccesslist=gtGroupAccesslist, gtNetworkTable=gtNetworkTable, gtSettingsConformance=gtSettingsConformance, gtBackupSFTPUsername=gtBackupSFTPUsername, gtGroupTable=gtGroupTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSwitch=gtSwitch, gtGeneral=gtGeneral, gtUserTable=gtUserTable, gtSettingsNotifications=gtSettingsNotifications, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleUpdate=gtModuleUpdate, gtNumSFP=gtNumSFP, gtInterfaceCLI=gtInterfaceCLI, gtUserGroup=gtUserGroup, gtTrapUser=gtTrapUser, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUser=gtUser, gtSLAExpires=gtSLAExpires, gtUserParamIdx=gtUserParamIdx, gtNTPServerTable=gtNTPServerTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupTable=gtModuleBackupTable, gtTrapDestTable=gtTrapDestTable, gtSFTPPassword=gtSFTPPassword, gtInterfaceTable=gtInterfaceTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtPortsLinkup=gtPortsLinkup, gtSWOptionsIdx=gtSWOptionsIdx, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceEntry=gtInterfaceEntry, gtSettingsGroups=gtSettingsGroups, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceDHCPState=gtInterfaceDHCPState, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceIPv4=gtInterfaceIPv4, gtPortsEntry=gtPortsEntry, gtTimeZone=gtTimeZone, gtNetworkName=gtNetworkName)
