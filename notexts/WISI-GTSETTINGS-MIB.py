...
ModuleIdentity, ObjectIdentity, iso, Unsigned32, MibIdentifier, Counter32, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, NotificationType, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "Counter32", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "NotificationType", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNTPServerAddress=gtNTPServerAddress, gtAgentState=gtAgentState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtPortsName=gtPortsName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapDestEntry=gtTrapDestEntry, gtGroupRights=gtGroupRights, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDNSEntry=gtDNSEntry, gtDNSNumber=gtDNSNumber, gtSyslogEntry=gtSyslogEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapDestPort=gtTrapDestPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworking=gtNetworking, gtHMSComMethod=gtHMSComMethod, gtInterfaceName=gtInterfaceName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMPTable=gtSNMPTable, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceEntry=gtInterfaceEntry, gtUpdateStatus=gtUpdateStatus, gtSwitch=gtSwitch, gtSNMPEntry=gtSNMPEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtHMSTable=gtHMSTable, gtTrapPDU=gtTrapPDU, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDateAndTime=gtDateAndTime, gtServicesTable=gtServicesTable, gtTimeLocal=gtTimeLocal, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPFilename=gtBackupSFTPFilename, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkEntry=gtNetworkEntry, gtUserPassword=gtUserPassword, gtSFPTable=gtSFPTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceNumber=gtInterfaceNumber, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNumSFP=gtNumSFP, gtInterfaceVLAN=gtInterfaceVLAN, gtSWOption=gtSWOption, gtUserAuthEntry=gtUserAuthEntry, gtBackupStatus=gtBackupStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtFilename=gtFilename, gtTrapDestIP=gtTrapDestIP, gtWebProtocol=gtWebProtocol, gtSNMP=gtSNMP, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtPortsBitrateTransmit=gtPortsBitrateTransmit, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceIPv4=gtInterfaceIPv4, gtSLATable=gtSLATable, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUserParamIdx=gtUserParamIdx, gtSFTPServer=gtSFTPServer, gtSLARegistered=gtSLARegistered, gtUserRowStatus=gtUserRowStatus, gtBackupSFTPPort=gtBackupSFTPPort, gtGeneral=gtGeneral, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsEntry=gtPortsEntry, gtAgentPort=gtAgentPort, gtBackupControl=gtBackupControl, gtAgentComReadString=gtAgentComReadString, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsObjects=gtSettingsObjects, gtUserTable=gtUserTable, gtCurrentUserName=gtCurrentUserName, gtAgentComWriteString=gtAgentComWriteString, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPEntry=gtSFPEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSFPPlugged=gtSFPPlugged, gtInterfaceState=gtInterfaceState, gtSyslogState=gtSyslogState, gtInterfaceStreaming=gtInterfaceStreaming, gtUser=gtUser, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNTPServerEntry=gtNTPServerEntry, gtUserGroup=gtUserGroup, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtHMSEntry=gtHMSEntry, gtTrapState=gtTrapState, gtSFPNumber=gtSFPNumber, gtNetworkVLAN=gtNetworkVLAN, gtNTPServerTable=gtNTPServerTable, gtNetworkTable=gtNetworkTable, gtInterfaceTable=gtInterfaceTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGroupName=gtGroupName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsNumber=gtPortsNumber, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSyslogIP=gtSyslogIP, gtSettingsGroups=gtSettingsGroups, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortNumber=gtNetworkPortNumber, gtAgentSecurityLevel=gtAgentSecurityLevel, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsCompliances=gtSettingsCompliances, gtSettingsConformance=gtSettingsConformance, gtPortsBitrateReceive=gtPortsBitrateReceive, gtGroupEntry=gtGroupEntry, gtDNSServerIP=gtDNSServerIP, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceCLI=gtInterfaceCLI, gtSFTPPassword=gtSFTPPassword, gtUpdateFile=gtUpdateFile, gtUserName=gtUserName, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleUpdate=gtModuleUpdate, gtNetworkPortState=gtNetworkPortState, gtDaylightAdjustment=gtDaylightAdjustment, gtUserIdx=gtUserIdx, gtSettingsMIB=gtSettingsMIB, gtSettingsNotifications=gtSettingsNotifications, gtModuleBackup=gtModuleBackup, gtNetworkName=gtNetworkName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtAccesslistName=gtAccesslistName, gtAccesslistIPRange=gtAccesslistIPRange, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtServices=gtServices, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapDestTable=gtTrapDestTable, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapComString=gtTrapComString, gtTimeUTC=gtTimeUTC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserEntry=gtUserEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtWebAuth=gtWebAuth, gtSFPSpeed=gtSFPSpeed, gtSLAExpires=gtSLAExpires, gtSWOptionsTable=gtSWOptionsTable, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortName=gtNetworkPortName, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsLinkup=gtPortsLinkup, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPUsername=gtSFTPUsername, gtTrapDestNumber=gtTrapDestNumber, gtHMSNumMembers=gtHMSNumMembers, gtGroupTable=gtGroupTable, gtTimeZone=gtTimeZone, gtSyslogTable=gtSyslogTable, gtSFPType=gtSFPType, gtNTPServerNumber=gtNTPServerNumber, gtHMSGroupName=gtHMSGroupName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleRedundancyMode=gtModuleRedundancyMode, gtAccesslistTable=gtAccesslistTable, gtSFPLink=gtSFPLink, gtServicesEntry=gtServicesEntry, gtSLAEntry=gtSLAEntry, gtUpdateControl=gtUpdateControl, gtWebEnable=gtWebEnable, gtGroupAccesslist=gtGroupAccesslist, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtPortsTable=gtPortsTable, gtModuleBackupTable=gtModuleBackupTable, gtSFTPPort=gtSFTPPort, gtInterfaceMAC=gtInterfaceMAC, gtModuleBackupControl=gtModuleBackupControl, gtUserAccesslist=gtUserAccesslist, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAccesslistIdx=gtAccesslistIdx, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapUser=gtTrapUser, gtGroupIdx=gtGroupIdx, gtModuleBackupDate=gtModuleBackupDate, gtDNSTable=gtDNSTable)
