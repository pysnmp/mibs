...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Bits, ObjectIdentity, NotificationType, TimeTicks, Counter32, MibIdentifier, Integer32, IpAddress, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Bits", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32", "MibIdentifier", "Integer32", "IpAddress", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceNumber=gtInterfaceNumber, gtUserTable=gtUserTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPSpeed=gtSFPSpeed, gtAgentComReadString=gtAgentComReadString, gtSettingsConformance=gtSettingsConformance, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceEntry=gtInterfaceEntry, gtSyslogTable=gtSyslogTable, gtTrapState=gtTrapState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleBackup=gtModuleBackup, gtSFPType=gtSFPType, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupIdx=gtGroupIdx, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSTable=gtHMSTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtPortsTable=gtPortsTable, gtWebProtocol=gtWebProtocol, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPTable=gtSFPTable, gtServicesTable=gtServicesTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMPTable=gtSNMPTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAgentPort=gtAgentPort, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistTable=gtAccesslistTable, gtSettingsGroups=gtSettingsGroups, gtDNSServerIP=gtDNSServerIP, gtSettingsNotifications=gtSettingsNotifications, gtUpdateStatus=gtUpdateStatus, gtGroupAccesslist=gtGroupAccesslist, gtSNMP=gtSNMP, gtTimeUTC=gtTimeUTC, gtSLAExpires=gtSLAExpires, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapPDU=gtTrapPDU, gtPortsNumber=gtPortsNumber, gtInterfaceTable=gtInterfaceTable, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupControl=gtBackupControl, gtPortsName=gtPortsName, gtHMSNumMembers=gtHMSNumMembers, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkTable=gtNetworkTable, gtDNSTable=gtDNSTable, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortsTable=gtNetworkPortsTable, gtSFPPlugged=gtSFPPlugged, gtNTPServerEntry=gtNTPServerEntry, gtSWOptionsTable=gtSWOptionsTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSWOption=gtSWOption, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkPortState=gtNetworkPortState, gtSettingsMIB=gtSettingsMIB, gtSLAEntry=gtSLAEntry, gtSFPNumber=gtSFPNumber, gtNetworkPortsEntry=gtNetworkPortsEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupTable=gtGroupTable, gtNTPServerNumber=gtNTPServerNumber, gtSyslogState=gtSyslogState, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupParamIdx=gtGroupParamIdx, gtSyslogIP=gtSyslogIP, gtUserAuthTable=gtUserAuthTable, gtUser=gtUser, gtSLARegistered=gtSLARegistered, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentComWriteString=gtAgentComWriteString, gtUserEntry=gtUserEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsEntry=gtPortsEntry, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestPort=gtTrapDestPort, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsObjects=gtSettingsObjects, gtModuleBackupDate=gtModuleBackupDate, gtBackupStatus=gtBackupStatus, gtUserAccesslist=gtUserAccesslist, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworking=gtNetworking, gtChassisRedundancy=gtChassisRedundancy, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapUser=gtTrapUser, gtUpdateControl=gtUpdateControl, gtWebEnable=gtWebEnable, gtModuleBackupTable=gtModuleBackupTable, gtSwitch=gtSwitch, gtSNMPEntry=gtSNMPEntry, gtSFTPUsername=gtSFTPUsername, gtNTPServerAddress=gtNTPServerAddress, gtSFTPPassword=gtSFTPPassword, gtInterfaceSNMP=gtInterfaceSNMP, gtSFTPServer=gtSFTPServer, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceName=gtInterfaceName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkEntry=gtNetworkEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTimeZone=gtTimeZone, gtBackupSFTPPort=gtBackupSFTPPort, gtDateAndTimeTable=gtDateAndTimeTable, gtUserIdx=gtUserIdx, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDNSNumber=gtDNSNumber, gtCurrentUserName=gtCurrentUserName, gtGeneral=gtGeneral, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceMAC=gtInterfaceMAC, gtModuleBackupControl=gtModuleBackupControl, gtTimeLocal=gtTimeLocal, gtSyslogEntry=gtSyslogEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUserParamIdx=gtUserParamIdx, gtAccesslistIdx=gtAccesslistIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPEntry=gtSFPEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSGroupName=gtHMSGroupName, gtAgentState=gtAgentState, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserName=gtUserName, gtNTPServerTable=gtNTPServerTable, gtModuleUpdate=gtModuleUpdate, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapComString=gtTrapComString, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUpdateFile=gtUpdateFile, gtPortsLinkup=gtPortsLinkup, gtUserPassword=gtUserPassword, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAuthEntry=gtUserAuthEntry, gtServices=gtServices, gtSettingsCompliances=gtSettingsCompliances, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceStreaming=gtInterfaceStreaming, gtGroupEntry=gtGroupEntry, gtTrapDestTable=gtTrapDestTable, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestNumber=gtTrapDestNumber, gtServicesEntry=gtServicesEntry, gtNumSFP=gtNumSFP, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDateAndTimeEntry=gtDateAndTimeEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceState=gtInterfaceState, gtNetworkVLAN=gtNetworkVLAN, gtNetworkName=gtNetworkName, gtInterfaceIGMP=gtInterfaceIGMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtHMSComMethod=gtHMSComMethod, gtSLATable=gtSLATable, gtGroupRights=gtGroupRights, gtHMSEntry=gtHMSEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceCLI=gtInterfaceCLI, gtSFPLink=gtSFPLink, gtUserGroup=gtUserGroup, gtSFTPPort=gtSFTPPort, gtDNSEntry=gtDNSEntry, gtDateAndTime=gtDateAndTime, gtTrapDestIP=gtTrapDestIP, gtUserRowStatus=gtUserRowStatus, gtWebAuth=gtWebAuth, gtNetworkPortName=gtNetworkPortName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQueryInterval=gtIGMPQueryInterval, gtAccesslistName=gtAccesslistName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtFilename=gtFilename, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupName=gtGroupName)
