...
ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, Counter64, MibIdentifier, Gauge32, iso, TimeTicks, IpAddress, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "Gauge32", "iso", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSLATable=gtSLATable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDNSServerIP=gtDNSServerIP, gtTrapPDU=gtTrapPDU, gtInterfaceTable=gtInterfaceTable, gtUpdateControl=gtUpdateControl, gtCurrentUserName=gtCurrentUserName, gtNetworkPortName=gtNetworkPortName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPEntry=gtSFPEntry, gtSFPSpeed=gtSFPSpeed, gtAgentComReadString=gtAgentComReadString, gtHMSNumAvailModules=gtHMSNumAvailModules, gtServices=gtServices, gtSFPLink=gtSFPLink, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAgentState=gtAgentState, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsGroups=gtSettingsGroups, gtNetworking=gtNetworking, gtNetworkName=gtNetworkName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsLinkup=gtPortsLinkup, gtTrapState=gtTrapState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtModuleBackup=gtModuleBackup, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapUser=gtTrapUser, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkPortState=gtNetworkPortState, gtSWOption=gtSWOption, gtHMSEntry=gtHMSEntry, gtModuleUpdate=gtModuleUpdate, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupTable=gtModuleBackupTable, gtNumSFP=gtNumSFP, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDaylightAdjustment=gtDaylightAdjustment, gtNTPServerTable=gtNTPServerTable, gtUserAuthEntry=gtUserAuthEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleBackupControl=gtModuleBackupControl, gtHMSTable=gtHMSTable, gtUserAccesslist=gtUserAccesslist, gtTrapDestTable=gtTrapDestTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserGroup=gtUserGroup, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTimeZone=gtTimeZone, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceCLI=gtInterfaceCLI, gtTimeLocal=gtTimeLocal, gtCurrentUserPassword=gtCurrentUserPassword, gtUpdateStatus=gtUpdateStatus, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPServer=gtBackupSFTPServer, gtUserRowStatus=gtUserRowStatus, gtPortsNumber=gtPortsNumber, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsConformance=gtSettingsConformance, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsTable=gtPortsTable, gtSLARegistered=gtSLARegistered, gtTrapDestNumber=gtTrapDestNumber, gtGeneral=gtGeneral, gtDNSNumber=gtDNSNumber, gtServicesEntry=gtServicesEntry, gtSFTPPassword=gtSFTPPassword, gtGroupAccesslist=gtGroupAccesslist, gtUserName=gtUserName, gtServicesTable=gtServicesTable, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistTable=gtAccesslistTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSyslogEntry=gtSyslogEntry, gtAccesslistEntry=gtAccesslistEntry, gtSLAEntry=gtSLAEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSTable=gtDNSTable, gtUser=gtUser, gtAccesslistIdx=gtAccesslistIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkEntry=gtNetworkEntry, gtInterfaceState=gtInterfaceState, gtInterfaceName=gtInterfaceName, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapComString=gtTrapComString, gtUserAuthTable=gtUserAuthTable, gtSettingsCompliances=gtSettingsCompliances, gtPortsName=gtPortsName, gtAccesslistName=gtAccesslistName, gtWebProtocol=gtWebProtocol, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIGMP=gtInterfaceIGMP, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSWOptionsTable=gtSWOptionsTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSWOptionsEntry=gtSWOptionsEntry, gtSwitch=gtSwitch, gtUpdateFile=gtUpdateFile, gtSLAExpires=gtSLAExpires, gtTrapDestIP=gtTrapDestIP, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSNMP=gtSNMP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPNumber=gtSFPNumber, gtSNMPEntry=gtSNMPEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserPassword=gtUserPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSyslogIP=gtSyslogIP, gtTrapDestEntry=gtTrapDestEntry, gtSFTPPort=gtSFTPPort, gtDateAndTime=gtDateAndTime, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPType=gtSFPType, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFPPlugged=gtSFPPlugged, gtUserTable=gtUserTable, gtHMSNumMembers=gtHMSNumMembers, gtBackupStatus=gtBackupStatus, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceDHCPState=gtInterfaceDHCPState, gtWebEnable=gtWebEnable, gtFilename=gtFilename, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestPort=gtTrapDestPort, gtSyslogTable=gtSyslogTable, gtHMSComMethod=gtHMSComMethod, gtNetworkVLAN=gtNetworkVLAN, gtSNMPTable=gtSNMPTable, gtBackupControl=gtBackupControl, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSyslogState=gtSyslogState, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserEntry=gtUserEntry, gtGroupEntry=gtGroupEntry, gtUserIdx=gtUserIdx, gtGroupIdx=gtGroupIdx, gtGroupName=gtGroupName, gtChassisRedundancy=gtChassisRedundancy, gtDateAndTimeEntry=gtDateAndTimeEntry, gtAgentComWriteString=gtAgentComWriteString, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebAuth=gtWebAuth, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFTPServer=gtSFTPServer, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceEntry=gtInterfaceEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSettingsObjects=gtSettingsObjects, gtNTPServerAddress=gtNTPServerAddress, gtCurrentTimeSource=gtCurrentTimeSource, gtModuleBackupDate=gtModuleBackupDate, gtSettingsMIB=gtSettingsMIB, gtDNSEntry=gtDNSEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFTPUsername=gtSFTPUsername, gtTimeUTC=gtTimeUTC, gtGroupRights=gtGroupRights, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFPTable=gtSFPTable, gtPortsEntry=gtPortsEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtUserParamIdx=gtUserParamIdx, gtAgentPort=gtAgentPort, gtNetworkTable=gtNetworkTable, gtGroupTable=gtGroupTable, gtSettingsNotifications=gtSettingsNotifications)
