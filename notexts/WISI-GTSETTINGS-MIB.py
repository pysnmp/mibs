...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Gauge32, Counter32, NotificationType, ObjectIdentity, IpAddress, Unsigned32, TimeTicks, Bits, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Gauge32", "Counter32", "NotificationType", "ObjectIdentity", "IpAddress", "Unsigned32", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsTable=gtPortsTable, gtSyslogEntry=gtSyslogEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtDateAndTime=gtDateAndTime, gtPortsNumber=gtPortsNumber, gtUserTable=gtUserTable, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupStatus=gtBackupStatus, gtPortsName=gtPortsName, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSComMethod=gtHMSComMethod, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDateAndTimeTable=gtDateAndTimeTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateStatus=gtUpdateStatus, gtHMSGroupName=gtHMSGroupName, gtInterfaceRowStatus=gtInterfaceRowStatus, gtModuleBackup=gtModuleBackup, gtTrapDestTable=gtTrapDestTable, gtSyslogState=gtSyslogState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTimeZone=gtTimeZone, gtServicesEntry=gtServicesEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPLink=gtSFPLink, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceCLI=gtInterfaceCLI, gtSFPTable=gtSFPTable, gtTrapDestNumber=gtTrapDestNumber, gtGeneral=gtGeneral, gtAccesslistEntry=gtAccesslistEntry, gtGroupEntry=gtGroupEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtAccesslistTable=gtAccesslistTable, gtSFPEntry=gtSFPEntry, gtSFPPlugged=gtSFPPlugged, gtNetworkEntry=gtNetworkEntry, gtNetworkPortState=gtNetworkPortState, gtTrapDestEntry=gtTrapDestEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSLAEntry=gtSLAEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceSNMP=gtInterfaceSNMP, gtSFPType=gtSFPType, gtSNMP=gtSNMP, gtAgentState=gtAgentState, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceDHCPState=gtInterfaceDHCPState, gtDNSTable=gtDNSTable, gtCurrentUserName=gtCurrentUserName, gtNumSFP=gtNumSFP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupSFTPPort=gtBackupSFTPPort, gtUserRowStatus=gtUserRowStatus, gtTrapState=gtTrapState, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleUpdate=gtModuleUpdate, gtUserAuthTable=gtUserAuthTable, gtSFPSpeed=gtSFPSpeed, gtSettingsMIB=gtSettingsMIB, gtUserIdx=gtUserIdx, gtInterfaceName=gtInterfaceName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPNumber=gtSFPNumber, gtGroupParamIdx=gtGroupParamIdx, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPServer=gtSFTPServer, gtSettingsCompliances=gtSettingsCompliances, gtTrapUser=gtTrapUser, gtUpdateFilesTable=gtUpdateFilesTable, gtSWOptionsIdx=gtSWOptionsIdx, gtTimeLocal=gtTimeLocal, gtNetworkVLAN=gtNetworkVLAN, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAuthEnabled=gtUserAuthEnabled, gtSettingsConformance=gtSettingsConformance, gtSNMPTable=gtSNMPTable, gtGroupAccesslist=gtGroupAccesslist, gtHMSTable=gtHMSTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSNMPEntry=gtSNMPEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceNumber=gtInterfaceNumber, gtModuleBackupTable=gtModuleBackupTable, gtUserAuthEntry=gtUserAuthEntry, gtSFTPPort=gtSFTPPort, gtAgentComWriteString=gtAgentComWriteString, gtGroupTable=gtGroupTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerNumber=gtNTPServerNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtAgentComReadString=gtAgentComReadString, gtSettingsGroups=gtSettingsGroups, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceEntry=gtInterfaceEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserParamIdx=gtUserParamIdx, gtSLATable=gtSLATable, gtAccesslistIdx=gtAccesslistIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtServicesTable=gtServicesTable, gtAccesslistName=gtAccesslistName, gtModuleBackupEntry=gtModuleBackupEntry, gtNTPServerAddress=gtNTPServerAddress, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapPDU=gtTrapPDU, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtWebProtocol=gtWebProtocol, gtSFTPUsername=gtSFTPUsername, gtInterfaceVLAN=gtInterfaceVLAN, gtUser=gtUser, gtSFTPPassword=gtSFTPPassword, gtDNSNumber=gtDNSNumber, gtTrapDestIP=gtTrapDestIP, gtGroupName=gtGroupName, gtSettingsNotifications=gtSettingsNotifications, gtTimeUTC=gtTimeUTC, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtHMSEntry=gtHMSEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsFloodMulticast=gtPortsFloodMulticast, gtDNSServerIP=gtDNSServerIP, gtUserEntry=gtUserEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAgentPort=gtAgentPort, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUserAccesslist=gtUserAccesslist, gtDNSEntry=gtDNSEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsEntry=gtPortsEntry, gtInterfaceState=gtInterfaceState, gtInterfaceIPv4=gtInterfaceIPv4, gtUserName=gtUserName, gtSyslogIP=gtSyslogIP, gtNetworkName=gtNetworkName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserPassword=gtUserPassword, gtSWOption=gtSWOption, gtSettingsObjects=gtSettingsObjects, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceTable=gtInterfaceTable, gtUpdateFile=gtUpdateFile, gtWebEnable=gtWebEnable, gtGroupIdx=gtGroupIdx, gtServices=gtServices, gtModuleBackupControl=gtModuleBackupControl, gtModuleBackupDate=gtModuleBackupDate, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUpdateControl=gtUpdateControl, gtFilename=gtFilename, gtSyslogTable=gtSyslogTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNTPServerTable=gtNTPServerTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupControl=gtBackupControl, gtSWOptionsTable=gtSWOptionsTable, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupRights=gtGroupRights, gtTrapComString=gtTrapComString, gtNetworking=gtNetworking, gtTrapDestPort=gtTrapDestPort, gtUserGroup=gtUserGroup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtWebAuth=gtWebAuth, gtSwitch=gtSwitch, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkTable=gtNetworkTable, gtNetworkPortName=gtNetworkPortName, gtSLARegistered=gtSLARegistered, gtPortsLinkup=gtPortsLinkup, gtSLAExpires=gtSLAExpires, gtCurrentUserPassword=gtCurrentUserPassword)
