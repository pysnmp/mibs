...
Counter32, Counter64, iso, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Integer32, MibIdentifier, ObjectIdentity, NotificationType, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "iso", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Integer32", "MibIdentifier", "ObjectIdentity", "NotificationType", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserEntry=gtUserEntry, gtNetworkPortState=gtNetworkPortState, gtSFPType=gtSFPType, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUser=gtUser, gtSettingsMIB=gtSettingsMIB, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsLinkup=gtPortsLinkup, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceNumber=gtInterfaceNumber, gtTimeUTC=gtTimeUTC, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapDestPort=gtTrapDestPort, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsGroups=gtSettingsGroups, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerTable=gtNTPServerTable, gtUpdateStatus=gtUpdateStatus, gtSyslogTable=gtSyslogTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceState=gtInterfaceState, gtGroupParamIdx=gtGroupParamIdx, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifications=gtSettingsNotifications, gtSLAEntry=gtSLAEntry, gtUserTable=gtUserTable, gtHMSGroupName=gtHMSGroupName, gtGroupIdx=gtGroupIdx, gtBackupSFTPUsername=gtBackupSFTPUsername, gtChassisRedundancy=gtChassisRedundancy, gtTrapUser=gtTrapUser, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleBackup=gtModuleBackup, gtUserIdx=gtUserIdx, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupAccesslist=gtGroupAccesslist, gtUserAuthTable=gtUserAuthTable, gtNetworking=gtNetworking, gtAccesslistIdx=gtAccesslistIdx, gtWebProtocol=gtWebProtocol, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceSNMP=gtInterfaceSNMP, gtUserGroup=gtUserGroup, gtUserRowStatus=gtUserRowStatus, gtNetworkEntry=gtNetworkEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSNMPTable=gtSNMPTable, gtDNSEntry=gtDNSEntry, gtSyslogIP=gtSyslogIP, gtTimeLocal=gtTimeLocal, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestIP=gtTrapDestIP, gtGroupEntry=gtGroupEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceTable=gtInterfaceTable, gtUserParamIdx=gtUserParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtBackupStatus=gtBackupStatus, gtWebEnable=gtWebEnable, gtFilename=gtFilename, gtAgentSecurityLevel=gtAgentSecurityLevel, gtWebAuth=gtWebAuth, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUpdateFile=gtUpdateFile, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceMAC=gtInterfaceMAC, gtSFPLink=gtSFPLink, gtTrapSecurityLevel=gtTrapSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtDNSNumber=gtDNSNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPUsername=gtSFTPUsername, gtPortsNumber=gtPortsNumber, gtSNMPEntry=gtSNMPEntry, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapDestTable=gtTrapDestTable, gtUserAuthEnabled=gtUserAuthEnabled, gtDNSServerIP=gtDNSServerIP, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHeadendSystemManagement=gtHeadendSystemManagement, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPPlugged=gtSFPPlugged, gtUserName=gtUserName, gtInterfaceCLI=gtInterfaceCLI, gtUserPassword=gtUserPassword, gtModuleBackupControl=gtModuleBackupControl, gtSFPTable=gtSFPTable, gtDaylightAdjustment=gtDaylightAdjustment, gtSWOptionsIdx=gtSWOptionsIdx, gtModuleBackupDate=gtModuleBackupDate, gtSLATable=gtSLATable, gtHMSTable=gtHMSTable, gtSLARegistered=gtSLARegistered, gtAgentState=gtAgentState, gtAgentComReadString=gtAgentComReadString, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSettingsObjects=gtSettingsObjects, gtAgentComWriteString=gtAgentComWriteString, gtUserAccesslist=gtUserAccesslist, gtInterfaceEntry=gtInterfaceEntry, gtGroupRights=gtGroupRights, gtInterfaceName=gtInterfaceName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerEntry=gtNTPServerEntry, gtSFPSpeed=gtSFPSpeed, gtSFPNumber=gtSFPNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtBackupControl=gtBackupControl, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistTable=gtAccesslistTable, gtDateAndTime=gtDateAndTime, gtSWOptionsEntry=gtSWOptionsEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSLAExpires=gtSLAExpires, gtNumSFP=gtNumSFP, gtGroupTable=gtGroupTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTimeZone=gtTimeZone, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtTrapState=gtTrapState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtCurrentUserName=gtCurrentUserName, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupName=gtGroupName, gtAccesslistName=gtAccesslistName, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsTable=gtPortsTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSComMethod=gtHMSComMethod, gtDNSTable=gtDNSTable, gtServices=gtServices, gtSettingsConformance=gtSettingsConformance, gtHMSEntry=gtHMSEntry, gtPortsName=gtPortsName, gtNetworkTable=gtNetworkTable, gtNetworkName=gtNetworkName, gtTrapDestNumber=gtTrapDestNumber, gtServicesTable=gtServicesTable, gtNTPServerNumber=gtNTPServerNumber, gtSyslogEntry=gtSyslogEntry, gtTrapPDU=gtTrapPDU, gtSFTPPort=gtSFTPPort, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworkPortName=gtNetworkPortName, gtHMSNumMembers=gtHMSNumMembers, gtNetworkVLAN=gtNetworkVLAN, gtDateAndTimeTable=gtDateAndTimeTable, gtAccesslistEntry=gtAccesslistEntry, gtSyslogState=gtSyslogState, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSWOption=gtSWOption, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtServicesEntry=gtServicesEntry, gtGeneral=gtGeneral, gtAgentPort=gtAgentPort, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleUpdate=gtModuleUpdate, gtNTPServerAddress=gtNTPServerAddress, gtSNMP=gtSNMP, gtModuleBackupTable=gtModuleBackupTable, gtSFTPServer=gtSFTPServer, gtUpdateControl=gtUpdateControl, gtSwitch=gtSwitch, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapComString=gtTrapComString, gtSFPEntry=gtSFPEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFTPPassword=gtSFTPPassword, gtPortsEntry=gtPortsEntry, gtTrapDestEntry=gtTrapDestEntry, gtNetworkPortNumber=gtNetworkPortNumber)
