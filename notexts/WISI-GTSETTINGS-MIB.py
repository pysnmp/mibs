...
MibIdentifier, Unsigned32, Counter64, iso, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ObjectIdentity, NotificationType, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Counter64", "iso", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ObjectIdentity", "NotificationType", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserParamIdx=gtUserParamIdx, gtTrapComString=gtTrapComString, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupEntry=gtModuleBackupEntry, gtUserPassword=gtUserPassword, gtDNSServerIP=gtDNSServerIP, gtInterfaceMAC=gtInterfaceMAC, gtUser=gtUser, gtTimeUTC=gtTimeUTC, gtNetworkName=gtNetworkName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHMSNumMembers=gtHMSNumMembers, gtSLAExpires=gtSLAExpires, gtNTPServerTable=gtNTPServerTable, gtAccesslistTable=gtAccesslistTable, gtDNSNumber=gtDNSNumber, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtModuleBackupDate=gtModuleBackupDate, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebProtocol=gtWebProtocol, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserTable=gtUserTable, gtUserAuthEntry=gtUserAuthEntry, gtNetworkEntry=gtNetworkEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserGroup=gtUserGroup, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSyslogTable=gtSyslogTable, gtUpdateFile=gtUpdateFile, gtNTPServerNumber=gtNTPServerNumber, gtPortsLinkup=gtPortsLinkup, gtInterfaceCLI=gtInterfaceCLI, gtSNMPEntry=gtSNMPEntry, gtGroupRights=gtGroupRights, gtBackupSFTPPort=gtBackupSFTPPort, gtGroupTable=gtGroupTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserName=gtUserName, gtSyslogEntry=gtSyslogEntry, gtNumSFP=gtNumSFP, gtSNMP=gtSNMP, gtPortsNumber=gtPortsNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupEntry=gtGroupEntry, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtWebEnable=gtWebEnable, gtUserRowStatus=gtUserRowStatus, gtSettingsMIB=gtSettingsMIB, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentComReadString=gtAgentComReadString, gtUpdateControl=gtUpdateControl, gtUserEntry=gtUserEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupStatus=gtBackupStatus, gtUpdateStatus=gtUpdateStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtModuleUpdate=gtModuleUpdate, gtSFTPPassword=gtSFTPPassword, gtGroupName=gtGroupName, gtModuleBackupControl=gtModuleBackupControl, gtServicesEntry=gtServicesEntry, gtTrapState=gtTrapState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsNotifications=gtSettingsNotifications, gtAgentState=gtAgentState, gtNetworkTable=gtNetworkTable, gtSLAEntry=gtSLAEntry, gtSFPPlugged=gtSFPPlugged, gtTrapUser=gtTrapUser, gtModuleBackupTable=gtModuleBackupTable, gtBackupControl=gtBackupControl, gtFilename=gtFilename, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPSpeed=gtSFPSpeed, gtDNSTable=gtDNSTable, gtAgentComWriteString=gtAgentComWriteString, gtServices=gtServices, gtInterfaceIPv4=gtInterfaceIPv4, gtHMSComMethod=gtHMSComMethod, gtTrapDestIP=gtTrapDestIP, gtSFTPServer=gtSFTPServer, gtAgentPort=gtAgentPort, gtInterfaceName=gtInterfaceName, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSwitch=gtSwitch, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSEntry=gtHMSEntry, gtSFPLink=gtSFPLink, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFTPUsername=gtSFTPUsername, gtAccesslistName=gtAccesslistName, gtInterfaceNumber=gtInterfaceNumber, gtTrapDestPort=gtTrapDestPort, gtSWOptionsIdx=gtSWOptionsIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtSNMPTable=gtSNMPTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSWOption=gtSWOption, gtGeneral=gtGeneral, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapPDU=gtTrapPDU, gtSWOptionsEntry=gtSWOptionsEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSLATable=gtSLATable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUpdateFilesTable=gtUpdateFilesTable, gtWebAuth=gtWebAuth, gtNTPServerEntry=gtNTPServerEntry, gtSFTPPort=gtSFTPPort, gtTimeLocal=gtTimeLocal, gtSettingsGroups=gtSettingsGroups, gtTimeZone=gtTimeZone, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsEntry=gtPortsEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtGroupIdx=gtGroupIdx, gtNetworking=gtNetworking, gtSLARegistered=gtSLARegistered, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceState=gtInterfaceState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserAuthTable=gtUserAuthTable, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestTable=gtTrapDestTable, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleBackupStatus=gtModuleBackupStatus, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIGMP=gtInterfaceIGMP, gtServicesTable=gtServicesTable, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSyslogIP=gtSyslogIP, gtSettingsConformance=gtSettingsConformance, gtPortsName=gtPortsName, gtUserAccesslist=gtUserAccesslist, gtNTPServerAddress=gtNTPServerAddress, gtSettingsObjects=gtSettingsObjects, gtModuleRedundancyMode=gtModuleRedundancyMode, gtCurrentUserName=gtCurrentUserName, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceEntry=gtInterfaceEntry, gtHMSTable=gtHMSTable, gtDNSEntry=gtDNSEntry, gtAccesslistEntry=gtAccesslistEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtUserIdx=gtUserIdx, gtNetworkPortState=gtNetworkPortState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPTable=gtSFPTable, gtGroupParamIdx=gtGroupParamIdx, PYSNMP_MODULE_ID=gtSettingsMIB, gtChassisRedundancy=gtChassisRedundancy, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFPEntry=gtSFPEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortsEntry=gtNetworkPortsEntry, gtHMSGroupName=gtHMSGroupName, gtInterfaceTable=gtInterfaceTable, gtModuleBackup=gtModuleBackup, gtSFPType=gtSFPType, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFPNumber=gtSFPNumber, gtPortsTable=gtPortsTable, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupAccesslist=gtGroupAccesslist, gtSyslogState=gtSyslogState, gtNetworkPortName=gtNetworkPortName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortNumber=gtNetworkPortNumber, gtDateAndTime=gtDateAndTime, gtSettingsCompliances=gtSettingsCompliances, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestEntry=gtTrapDestEntry)
