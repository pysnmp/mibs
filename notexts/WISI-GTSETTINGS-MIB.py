...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Gauge32, ObjectIdentity, IpAddress, Integer32, Counter32, Unsigned32, Counter64, iso, NotificationType, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "Unsigned32", "Counter64", "iso", "NotificationType", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPType=gtSFPType, gtNetworkPortName=gtNetworkPortName, gtTimeUTC=gtTimeUTC, gtPortsBitrateReceive=gtPortsBitrateReceive, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSWOption=gtSWOption, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtAccesslistTable=gtAccesslistTable, gtNumSFP=gtNumSFP, gtGroupEntry=gtGroupEntry, gtSwitch=gtSwitch, gtSyslogTable=gtSyslogTable, gtSLAExpires=gtSLAExpires, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPPlugged=gtSFPPlugged, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistName=gtAccesslistName, gtServicesEntry=gtServicesEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFTPPort=gtSFTPPort, gtAgentPort=gtAgentPort, gtTimeLocal=gtTimeLocal, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDNSEntry=gtDNSEntry, gtSFTPPassword=gtSFTPPassword, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworking=gtNetworking, gtPortsName=gtPortsName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAgentComReadString=gtAgentComReadString, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserEntry=gtUserEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtDateAndTimeTable=gtDateAndTimeTable, gtSWOptionsTable=gtSWOptionsTable, gtUserIdx=gtUserIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerNumber=gtNTPServerNumber, gtUserRowStatus=gtUserRowStatus, gtSWOptionsIdx=gtSWOptionsIdx, gtUserGroup=gtUserGroup, gtGroupAccesslist=gtGroupAccesslist, gtTrapDestIP=gtTrapDestIP, gtDaylightAdjustment=gtDaylightAdjustment, gtWebProtocol=gtWebProtocol, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsEntry=gtPortsEntry, gtSFTPUsername=gtSFTPUsername, gtSyslogIP=gtSyslogIP, gtNetworkEntry=gtNetworkEntry, gtSyslogEntry=gtSyslogEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapDestTable=gtTrapDestTable, gtUserAuthTable=gtUserAuthTable, gtServices=gtServices, gtServicesTable=gtServicesTable, gtGroupTable=gtGroupTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtAgentState=gtAgentState, gtNetworkPortState=gtNetworkPortState, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUserAuthEntry=gtUserAuthEntry, gtSettingsMIB=gtSettingsMIB, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleUpdate=gtModuleUpdate, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtDNSServerIP=gtDNSServerIP, gtTrapState=gtTrapState, gtInterfaceEntry=gtInterfaceEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtUser=gtUser, gtInterfaceState=gtInterfaceState, gtWebAuth=gtWebAuth, gtCurrentUserName=gtCurrentUserName, gtSFPTable=gtSFPTable, gtTimeZone=gtTimeZone, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackupStatus=gtModuleBackupStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtTrapUser=gtTrapUser, gtPortsTable=gtPortsTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsGroups=gtSettingsGroups, gtSLATable=gtSLATable, gtSFPLink=gtSFPLink, gtSFTPServer=gtSFTPServer, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceCLI=gtInterfaceCLI, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerTable=gtNTPServerTable, gtDateAndTime=gtDateAndTime, gtTrapDestRowStatus=gtTrapDestRowStatus, gtHMSGroupName=gtHMSGroupName, gtNetworkVLAN=gtNetworkVLAN, gtInterfaceTable=gtInterfaceTable, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateStatus=gtUpdateStatus, gtGroupIdx=gtGroupIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtFilename=gtFilename, gtAgentComWriteString=gtAgentComWriteString, gtNetworkTable=gtNetworkTable, gtTrapDestEntry=gtTrapDestEntry, gtUserAccesslist=gtUserAccesslist, gtAccesslistIdx=gtAccesslistIdx, gtGroupParamIdx=gtGroupParamIdx, gtDNSNumber=gtDNSNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtUserParamIdx=gtUserParamIdx, gtModuleBackup=gtModuleBackup, gtSLARegistered=gtSLARegistered, gtTrapDestNumber=gtTrapDestNumber, gtSFPNumber=gtSFPNumber, gtUserName=gtUserName, gtHMSEntry=gtHMSEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceWebMgt=gtInterfaceWebMgt, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapPDU=gtTrapPDU, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPEntry=gtSFPEntry, gtUpdateControl=gtUpdateControl, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUserPassword=gtUserPassword, gtNetworkName=gtNetworkName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserTable=gtUserTable, gtWebEnable=gtWebEnable, gtSettingsConformance=gtSettingsConformance, gtChassisRedundancy=gtChassisRedundancy, gtGroupName=gtGroupName, gtHMSComMethod=gtHMSComMethod, gtGroupRights=gtGroupRights, gtInterfaceName=gtInterfaceName, gtSNMPTable=gtSNMPTable, gtSFPSpeed=gtSFPSpeed, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerEntry=gtNTPServerEntry, gtModuleBackupControl=gtModuleBackupControl, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceNumber=gtInterfaceNumber, gtTrapComString=gtTrapComString, gtCurrentUserPassword=gtCurrentUserPassword, gtDNSTable=gtDNSTable, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistEntry=gtAccesslistEntry, gtSyslogState=gtSyslogState, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSNMP=gtSNMP, gtUpdateFile=gtUpdateFile, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtPortsNumber=gtPortsNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSNMPEntry=gtSNMPEntry, gtSLAEntry=gtSLAEntry, gtSettingsNotifications=gtSettingsNotifications, gtBackupControl=gtBackupControl, gtNTPServerRowStatus=gtNTPServerRowStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtHMSTable=gtHMSTable, gtSettingsCompliances=gtSettingsCompliances, gtGeneral=gtGeneral, gtBackupStatus=gtBackupStatus, gtPortsLinkup=gtPortsLinkup, gtInterfaceVLAN=gtInterfaceVLAN, gtBackupSFTPPassword=gtBackupSFTPPassword)
