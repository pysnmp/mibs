...
ModuleIdentity, iso, MibIdentifier, TimeTicks, NotificationType, IpAddress, Integer32, Unsigned32, Counter32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibIdentifier", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "Unsigned32", "Counter32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPNumber=gtSFPNumber, gtFilename=gtFilename, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistTable=gtAccesslistTable, gtUserEntry=gtUserEntry, gtInterfaceState=gtInterfaceState, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceVLAN=gtInterfaceVLAN, gtNumSFP=gtNumSFP, gtSFTPPort=gtSFTPPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUser=gtUser, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPSpeed=gtSFPSpeed, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDateAndTimeTable=gtDateAndTimeTable, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceEntry=gtInterfaceEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDNSNumber=gtDNSNumber, gtTrapDestNumber=gtTrapDestNumber, gtGroupName=gtGroupName, gtSettingsGroups=gtSettingsGroups, gtInterfaceStreaming=gtInterfaceStreaming, gtUserGroup=gtUserGroup, gtInterfaceCLI=gtInterfaceCLI, gtAccesslistIdx=gtAccesslistIdx, gtBackupStatus=gtBackupStatus, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceMAC=gtInterfaceMAC, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupSFTPFilename=gtBackupSFTPFilename, gtDateAndTime=gtDateAndTime, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupParamIdx=gtGroupParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtNetworkTable=gtNetworkTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentComReadString=gtAgentComReadString, gtSFPLink=gtSFPLink, gtSNMP=gtSNMP, gtPortsName=gtPortsName, gtUpdateFile=gtUpdateFile, gtUserAuthEntry=gtUserAuthEntry, gtSLAEntry=gtSLAEntry, gtUserRowStatus=gtUserRowStatus, gtTrapState=gtTrapState, gtUserAuthEnabled=gtUserAuthEnabled, gtDNSServerIP=gtDNSServerIP, gtSyslogState=gtSyslogState, gtWebEnable=gtWebEnable, gtInterfaceIGMP=gtInterfaceIGMP, gtDNSEntry=gtDNSEntry, gtSFPTable=gtSFPTable, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPPlugged=gtSFPPlugged, gtAccesslistIPRange=gtAccesslistIPRange, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistName=gtAccesslistName, gtSettingsMIB=gtSettingsMIB, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceTable=gtInterfaceTable, gtAgentState=gtAgentState, gtNetworking=gtNetworking, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserAuthTable=gtUserAuthTable, gtUserAccesslist=gtUserAccesslist, gtWebProtocol=gtWebProtocol, PYSNMP_MODULE_ID=gtSettingsMIB, gtHMSNumMembers=gtHMSNumMembers, gtHMSEntry=gtHMSEntry, gtSLATable=gtSLATable, gtUserIdx=gtUserIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortState=gtNetworkPortState, gtDNSTable=gtDNSTable, gtUserName=gtUserName, gtUserPassword=gtUserPassword, gtNetworkPortName=gtNetworkPortName, gtModuleBackupDate=gtModuleBackupDate, gtAgentPort=gtAgentPort, gtModuleBackup=gtModuleBackup, gtCurrentUserPassword=gtCurrentUserPassword, gtWebAuth=gtWebAuth, gtBackupSFTPPort=gtBackupSFTPPort, gtTimeLocal=gtTimeLocal, gtNetworkEntry=gtNetworkEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtPortsTable=gtPortsTable, gtTrapUser=gtTrapUser, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSNMPTable=gtSNMPTable, gtChassisRedundancy=gtChassisRedundancy, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtTrapComString=gtTrapComString, gtUpdateStatus=gtUpdateStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkPortsEntry=gtNetworkPortsEntry, gtServices=gtServices, gtGroupTable=gtGroupTable, gtSFPEntry=gtSFPEntry, gtTimeZone=gtTimeZone, gtTrapPDU=gtTrapPDU, gtGroupEntry=gtGroupEntry, gtBackupControl=gtBackupControl, gtSFTPPassword=gtSFTPPassword, gtNTPServerNumber=gtNTPServerNumber, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGeneral=gtGeneral, gtPortsNumber=gtPortsNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtServicesEntry=gtServicesEntry, gtGroupIdx=gtGroupIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtSettingsNotifications=gtSettingsNotifications, gtHMSComMethod=gtHMSComMethod, gtInterfaceSNMP=gtInterfaceSNMP, gtSFPType=gtSFPType, gtTrapDestIP=gtTrapDestIP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsLinkup=gtPortsLinkup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFTPServer=gtSFTPServer, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSyslogEntry=gtSyslogEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtSWOptionsIdx=gtSWOptionsIdx, gtUserTable=gtUserTable, gtSettingsConformance=gtSettingsConformance, gtUserParamIdx=gtUserParamIdx, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtPortsEntry=gtPortsEntry, gtSWOption=gtSWOption, gtNTPServerTable=gtNTPServerTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSLAExpires=gtSLAExpires, gtServicesTable=gtServicesTable, gtNetworkPortNumber=gtNetworkPortNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceIPv4=gtInterfaceIPv4, gtSFTPUsername=gtSFTPUsername, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSWOptionsTable=gtSWOptionsTable, gtModuleBackupControl=gtModuleBackupControl, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSyslogIP=gtSyslogIP, gtNetworkName=gtNetworkName, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAgentComWriteString=gtAgentComWriteString, gtSettingsObjects=gtSettingsObjects, gtModuleUpdate=gtModuleUpdate, gtSyslogTable=gtSyslogTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateControl=gtUpdateControl, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSNMPEntry=gtSNMPEntry, gtSwitch=gtSwitch, gtGroupAccesslist=gtGroupAccesslist, gtNetworkVLAN=gtNetworkVLAN, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapDestTable=gtTrapDestTable, gtInterfaceName=gtInterfaceName, gtHMSGroupName=gtHMSGroupName, gtTimeUTC=gtTimeUTC, gtSLARegistered=gtSLARegistered, gtTrapDestEntry=gtTrapDestEntry, gtTrapDestPort=gtTrapDestPort, gtHMSTable=gtHMSTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtCurrentUserName=gtCurrentUserName, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupRights=gtGroupRights)
