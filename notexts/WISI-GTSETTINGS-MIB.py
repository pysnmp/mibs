...
Bits, TimeTicks, Integer32, Counter32, Unsigned32, Counter64, ObjectIdentity, ModuleIdentity, Gauge32, iso, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Integer32", "Counter32", "Unsigned32", "Counter64", "ObjectIdentity", "ModuleIdentity", "Gauge32", "iso", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtModuleBackup=gtModuleBackup, gtUser=gtUser, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFTPUsername=gtSFTPUsername, gtNetworking=gtNetworking, gtSLAEntry=gtSLAEntry, gtSFTPServer=gtSFTPServer, gtSFPType=gtSFPType, gtPortsNumber=gtPortsNumber, gtNTPServerAddress=gtNTPServerAddress, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleUpdate=gtModuleUpdate, gtSettingsMIB=gtSettingsMIB, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtHMSNumAvailModules=gtHMSNumAvailModules, gtPortsEntry=gtPortsEntry, gtTrapDestPort=gtTrapDestPort, gtDNSServerIP=gtDNSServerIP, gtInterfaceVLAN=gtInterfaceVLAN, gtHMSEntry=gtHMSEntry, gtWebProtocol=gtWebProtocol, gtNetworkEntry=gtNetworkEntry, gtPortsName=gtPortsName, gtDNSNumber=gtDNSNumber, gtTrapDestTable=gtTrapDestTable, gtTrapDestIP=gtTrapDestIP, gtUpdateFile=gtUpdateFile, gtSettingsObjects=gtSettingsObjects, gtAccesslistName=gtAccesslistName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserAccesslist=gtUserAccesslist, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceCLI=gtInterfaceCLI, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupStatus=gtBackupStatus, gtGeneral=gtGeneral, gtUpdateControl=gtUpdateControl, gtSFTPPort=gtSFTPPort, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceIGMP=gtInterfaceIGMP, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceStreaming=gtInterfaceStreaming, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNetworkPortNumber=gtNetworkPortNumber, gtUserAuthEntry=gtUserAuthEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkPortsTable=gtNetworkPortsTable, gtGroupRights=gtGroupRights, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateStatus=gtUpdateStatus, gtTrapUser=gtTrapUser, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFPSpeed=gtSFPSpeed, gtHMSTable=gtHMSTable, gtAccesslistIPRange=gtAccesslistIPRange, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapSecurityLevel=gtTrapSecurityLevel, gtWebEnable=gtWebEnable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupTable=gtModuleBackupTable, gtSFTPPassword=gtSFTPPassword, gtSWOptionsTable=gtSWOptionsTable, gtBackupSFTPServer=gtBackupSFTPServer, gtSWOption=gtSWOption, gtTimeUTC=gtTimeUTC, gtUserRowStatus=gtUserRowStatus, gtSNMP=gtSNMP, gtSLATable=gtSLATable, gtSettingsConformance=gtSettingsConformance, gtAgentState=gtAgentState, gtTrapDestNumber=gtTrapDestNumber, gtSLARegistered=gtSLARegistered, gtDateAndTimeTable=gtDateAndTimeTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapState=gtTrapState, gtTimeLocal=gtTimeLocal, gtTrapComString=gtTrapComString, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSTable=gtDNSTable, gtDateAndTime=gtDateAndTime, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsCompliances=gtSettingsCompliances, gtUserGroup=gtUserGroup, gtNetworkVLAN=gtNetworkVLAN, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerEntry=gtNTPServerEntry, gtHMSNumMembers=gtHMSNumMembers, gtCurrentUserName=gtCurrentUserName, gtSyslogTable=gtSyslogTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackupEntry=gtModuleBackupEntry, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserName=gtUserName, gtDNSEntry=gtDNSEntry, gtNTPServerTable=gtNTPServerTable, gtUserEntry=gtUserEntry, gtUserParamIdx=gtUserParamIdx, gtTrapPDU=gtTrapPDU, gtServicesEntry=gtServicesEntry, gtSFPPlugged=gtSFPPlugged, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupControl=gtBackupControl, gtInterfaceNumber=gtInterfaceNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPTable=gtSFPTable, gtSettingsGroups=gtSettingsGroups, PYSNMP_MODULE_ID=gtSettingsMIB, gtSwitch=gtSwitch, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAccesslistIdx=gtAccesslistIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtNetworkTable=gtNetworkTable, gtPortsLinkup=gtPortsLinkup, gtUserPassword=gtUserPassword, gtInterfaceState=gtInterfaceState, gtFilename=gtFilename, gtSLAExpires=gtSLAExpires, gtInterfaceName=gtInterfaceName, gtSFPNumber=gtSFPNumber, gtGroupIdx=gtGroupIdx, gtGroupParamIdx=gtGroupParamIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserIdx=gtUserIdx, gtInterfaceEntry=gtInterfaceEntry, gtHMSComMethod=gtHMSComMethod, gtUpdateFilesTable=gtUpdateFilesTable, gtNumSFP=gtNumSFP, gtNetworkPortName=gtNetworkPortName, gtAgentComWriteString=gtAgentComWriteString, gtGroupEntry=gtGroupEntry, gtGroupName=gtGroupName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkName=gtNetworkName, gtSWOptionsEntry=gtSWOptionsEntry, gtSyslogState=gtSyslogState, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtTrapDestEntry=gtTrapDestEntry, gtGroupTable=gtGroupTable, gtSFPLink=gtSFPLink, gtSNMPEntry=gtSNMPEntry, gtAgentComReadString=gtAgentComReadString, gtHMSGroupName=gtHMSGroupName, gtInterfaceTable=gtInterfaceTable, gtServices=gtServices, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistTable=gtAccesslistTable, gtUserTable=gtUserTable, gtUserAuthTable=gtUserAuthTable, gtPortsTable=gtPortsTable, gtServicesTable=gtServicesTable, gtDaylightAdjustment=gtDaylightAdjustment, gtTimeZone=gtTimeZone, gtAccesslistEntry=gtAccesslistEntry, gtNTPServerNumber=gtNTPServerNumber, gtGroupAccesslist=gtGroupAccesslist, gtWebAuth=gtWebAuth, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPEntry=gtSFPEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSNMPTable=gtSNMPTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkPortState=gtNetworkPortState, gtSyslogIP=gtSyslogIP, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentPort=gtAgentPort, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState)
