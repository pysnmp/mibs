...
Integer32, Unsigned32, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, iso, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "iso", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSWOptionsTable=gtSWOptionsTable, gtSFPEntry=gtSFPEntry, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtNTPServerNumber=gtNTPServerNumber, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPPlugged=gtSFPPlugged, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworking=gtNetworking, gtTimeUTC=gtTimeUTC, gtUserPassword=gtUserPassword, gtSFPType=gtSFPType, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAccesslistTable=gtAccesslistTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNTPServerAddress=gtNTPServerAddress, gtGroupAccesslist=gtGroupAccesslist, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUserName=gtUserName, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserIdx=gtUserIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceEntry=gtInterfaceEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserGroup=gtUserGroup, gtPortsTable=gtPortsTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAgentComReadString=gtAgentComReadString, gtNumSFP=gtNumSFP, gtUserAuthEntry=gtUserAuthEntry, gtSFTPPort=gtSFTPPort, gtChassisRedundancy=gtChassisRedundancy, gtSNMP=gtSNMP, gtInterfaceState=gtInterfaceState, gtTimeLocal=gtTimeLocal, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsObjects=gtSettingsObjects, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackup=gtModuleBackup, gtPortsNumber=gtPortsNumber, gtInterfaceStreaming=gtInterfaceStreaming, gtSLAEntry=gtSLAEntry, gtSLAExpires=gtSLAExpires, gtSNMPEntry=gtSNMPEntry, gtAccesslistEntry=gtAccesslistEntry, gtBackupControl=gtBackupControl, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSettingsMIB=gtSettingsMIB, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkVLAN=gtNetworkVLAN, gtNetworkTable=gtNetworkTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceSNMP=gtInterfaceSNMP, gtDateAndTimeTable=gtDateAndTimeTable, gtNTPServerTable=gtNTPServerTable, gtAccesslistIdx=gtAccesslistIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleUpdate=gtModuleUpdate, gtSLATable=gtSLATable, gtInterfaceCLI=gtInterfaceCLI, gtUserRowStatus=gtUserRowStatus, gtModuleBackupStatus=gtModuleBackupStatus, gtUser=gtUser, gtTrapState=gtTrapState, gtServices=gtServices, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateFile=gtUpdateFile, gtSFPSpeed=gtSFPSpeed, gtSwitch=gtSwitch, gtTrapDestIP=gtTrapDestIP, gtDNSNumber=gtDNSNumber, gtUserEntry=gtUserEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsLinkup=gtPortsLinkup, gtWebEnable=gtWebEnable, gtTrapUser=gtTrapUser, gtInterfaceMAC=gtInterfaceMAC, gtUserAuthTable=gtUserAuthTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSyslogEntry=gtSyslogEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapDestNumber=gtTrapDestNumber, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPUsername=gtSFTPUsername, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapComString=gtTrapComString, gtUserTable=gtUserTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateControl=gtUpdateControl, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtGroupEntry=gtGroupEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtServicesEntry=gtServicesEntry, gtGeneral=gtGeneral, gtFilename=gtFilename, gtTrapDestTable=gtTrapDestTable, gtNetworkEntry=gtNetworkEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUpdateFilesTable=gtUpdateFilesTable, gtTimeZone=gtTimeZone, gtUpdateStatus=gtUpdateStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortState=gtNetworkPortState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupParamIdx=gtGroupParamIdx, gtServicesTable=gtServicesTable, gtUserParamIdx=gtUserParamIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworkName=gtNetworkName, gtAgentPort=gtAgentPort, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceRowStatus=gtInterfaceRowStatus, gtHMSEntry=gtHMSEntry, gtHMSGroupName=gtHMSGroupName, gtHMSTable=gtHMSTable, gtSettingsNotifications=gtSettingsNotifications, gtPortsEntry=gtPortsEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerEntry=gtNTPServerEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFTPServer=gtSFTPServer, gtSettingsConformance=gtSettingsConformance, gtSFTPPassword=gtSFTPPassword, gtInterfaceName=gtInterfaceName, gtPortsName=gtPortsName, gtHMSComMethod=gtHMSComMethod, gtAccesslistIPRange=gtAccesslistIPRange, gtHMSNumMembers=gtHMSNumMembers, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupControl=gtModuleBackupControl, gtModuleBackupEntry=gtModuleBackupEntry, gtGroupTable=gtGroupTable, gtNetworkPortsTable=gtNetworkPortsTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtSFPTable=gtSFPTable, gtCurrentUserName=gtCurrentUserName, gtDaylightAdjustment=gtDaylightAdjustment, gtSettingsGroups=gtSettingsGroups, gtDNSTable=gtDNSTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceTable=gtInterfaceTable, gtAgentState=gtAgentState, gtWebAuth=gtWebAuth, gtGroupIdx=gtGroupIdx, gtDNSEntry=gtDNSEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSLARegistered=gtSLARegistered, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAccesslistName=gtAccesslistName, gtAgentComWriteString=gtAgentComWriteString, gtSyslogState=gtSyslogState, gtSFPLink=gtSFPLink, gtSFPNumber=gtSFPNumber, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupStatus=gtBackupStatus, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDNSServerIP=gtDNSServerIP, gtSWOption=gtSWOption, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceIGMP=gtInterfaceIGMP, gtDateAndTime=gtDateAndTime, gtSNMPTable=gtSNMPTable, gtBackupSFTPServer=gtBackupSFTPServer, gtUserAuthEnabled=gtUserAuthEnabled, gtTrapDestPort=gtTrapDestPort, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtGroupRights=gtGroupRights, gtGroupName=gtGroupName, gtSWOptionsIdx=gtSWOptionsIdx, gtWebProtocol=gtWebProtocol, gtSyslogTable=gtSyslogTable, gtSyslogIP=gtSyslogIP, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAccesslist=gtUserAccesslist, gtTrapPDU=gtTrapPDU, gtNetworkPortName=gtNetworkPortName)
