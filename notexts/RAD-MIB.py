...
# ASN.1 source RAD-MIB
# Source digest sha256:d9c707dbcc30d1c3d06a4892129755348a57f2f28a38a3e338b036149c27585a
...
mngTrapIpTable = MibTable((1, 3, 6, 1, 4, 1, 164, 6, 2, 7), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: mngTrapIpTable.setStatus('current')
mngEntry = MibTableRow((1, 3, 6, 1, 4, 1, 164, 6, 2, 7, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RAD-MIB", "mngID"))
...
trapTable = MibTable((1, 3, 6, 1, 4, 1, 164, 6, 2, 11), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: trapTable.setStatus('current')
trapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 164, 6, 2, 11, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RAD-MIB", "trapID"))
...
intSwdlTable = MibTable((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 10), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: intSwdlTable.setStatus('current')
intSwdlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 10, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RAD-MIB", "intSwdlObjIdx"), (0, "RAD-MIB", "intSwdlFileIdx"))
...
swdlStatusTable = MibTable((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 11), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: swdlStatusTable.setStatus('current')
swdlStatusEntry = MibTableRow((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 11, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RAD-MIB", "swdlStatusTypeIdx"), (0, "RAD-MIB", "swdlStatusIdx"))
...
autoFileTransferTable = MibTable((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 13, 1), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: autoFileTransferTable.setStatus('current')
autoFileTransferEntry = MibTableRow((1, 3, 6, 1, 4, 1, 164, 6, 2, 12, 13, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "RAD-MIB", "autoFileTransferType"))
...
mibBuilder.exportSymbols("RAD-MIB", MacAddress=MacAddress, agnChangeCnt=agnChangeCnt, agnConfigMsg=agnConfigMsg, agnDeviceCapabilities=agnDeviceCapabilities, agnGlobalAlarmMask=agnGlobalAlarmMask, agnHwVersion=agnHwVersion, agnIndication=agnIndication, agnLed=agnLed, agnMonitorModeCmd=agnMonitorModeCmd, agnSendTrapParameter=agnSendTrapParameter, agnSpecific=agnSpecific, agnStatusChangeTrap=agnStatusChangeTrap, agnStoreCmd=agnStoreCmd, agnSwVersionSwapCmd=agnSwVersionSwapCmd, agnTestStatus=agnTestStatus, agnTrapDelay=agnTrapDelay, agnTrapMask=agnTrapMask, agnTrapValue=agnTrapValue, agnt=agnt, alarmSeverity=alarmSeverity, alarmState=alarmState, autoFileTransfer=autoFileTransfer, autoFileTransferEntry=autoFileTransferEntry, autoFileTransferFileName=autoFileTransferFileName, autoFileTransferOccurrenceRecurrence=autoFileTransferOccurrenceRecurrence, autoFileTransferScheduling=autoFileTransferScheduling, autoFileTransferServerIp=autoFileTransferServerIp, autoFileTransferTable=autoFileTransferTable, autoFileTransferTimeRecurrence=autoFileTransferTimeRecurrence, autoFileTransferType=autoFileTransferType, clearDwldStatusLog=clearDwldStatusLog, fileName=fileName, fileNameWithinProduct=fileNameWithinProduct, fileServerIP=fileServerIP, fileTransCmd=fileTransCmd, fileTransfer=fileTransfer, fileTransferProtocol=fileTransferProtocol, fileTransferServerPort=fileTransferServerPort, fileTransferToSubSystems=fileTransferToSubSystems, intSwdlCardType=intSwdlCardType, intSwdlCmd=intSwdlCmd, intSwdlEntry=intSwdlEntry, intSwdlFileIdx=intSwdlFileIdx, intSwdlFileName=intSwdlFileName, intSwdlFileSwVer=intSwdlFileSwVer, intSwdlFlashIdx=intSwdlFlashIdx, intSwdlObjIdx=intSwdlObjIdx, intSwdlSize=intSwdlSize, intSwdlSlotFileMismatch=intSwdlSlotFileMismatch, intSwdlSwDate=intSwdlSwDate, intSwdlTable=intSwdlTable, intSwdlToSubSystem=intSwdlToSubSystem, mngAlarmTrapMask=mngAlarmTrapMask, mngEntry=mngEntry, mngID=mngID, mngIP=mngIP, mngIPMask=mngIPMask, mngSnmpTrapUdpPort=mngSnmpTrapUdpPort, mngTrapIpTable=mngTrapIpTable, mngTrapMask=mngTrapMask, rad=rad, radGen=radGen, swdlStatusEntry=swdlStatusEntry, swdlStatusFileName=swdlStatusFileName, swdlStatusIdx=swdlStatusIdx, swdlStatusResult=swdlStatusResult, swdlStatusSlot=swdlStatusSlot, swdlStatusStatus=swdlStatusStatus, swdlStatusSubSystem=swdlStatusSubSystem, swdlStatusTable=swdlStatusTable, swdlStatusTime=swdlStatusTime, swdlStatusTypeIdx=swdlStatusTypeIdx, systemClearTablesCmd=systemClearTablesCmd, systemDate=systemDate, systemDefaultGateway=systemDefaultGateway, systemParameter=systemParameter, systemReset=systemReset, systemResetAllStatsCmd=systemResetAllStatsCmd, systemSaveAndResetAllStatsCmd=systemSaveAndResetAllStatsCmd, systemTime=systemTime, systemTimeElapsed=systemTimeElapsed, systemTiming=systemTiming, systems=systems, systemsEvents=systemsEvents, tftpError=tftpError, tftpRetryTimeOut=tftpRetryTimeOut, tftpStatus=tftpStatus, tftpStatusChangeTrap=tftpStatusChangeTrap, tftpTotalTimeOut=tftpTotalTimeOut, trapEntry=trapEntry, trapID=trapID, trapTable=trapTable, trapTimeSinceOccurrence=trapTimeSinceOccurrence, trapVal=trapVal)
