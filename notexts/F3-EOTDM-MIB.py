...
mibBuilder.exportSymbols("F3-EOTDM-MIB", VcgType=VcgType, vcgLcasEnabled=vcgLcasEnabled, PYSNMP_MODULE_ID=f3EOTDMMIB, vcgRowStatus=vcgRowStatus, vcgMemberSkRecvExpectSeq=vcgMemberSkRecvExpectSeq, vcgType=vcgType, vcgEntry=vcgEntry, vcgMemberSkLcasState=vcgMemberSkLcasState, vcgMemberSoLcasState=vcgMemberSoLcasState, f3EotdmObjectGroup=f3EotdmObjectGroup, LcasSkState=LcasSkState, vcgIndex=vcgIndex, f3EotdmObjects=f3EotdmObjects, vcgIfIndex=vcgIfIndex, vcgMemberSkLcasRecvCtrl=vcgMemberSkLcasRecvCtrl, vcgMemberSkLcasSendMst=vcgMemberSkLcasSendMst, WtrTime=WtrTime, vcgMemberSkRecvSeq=vcgMemberSkRecvSeq, vcgClearWtrTimer=vcgClearWtrTimer, vcgSecondaryState=vcgSecondaryState, vcgAdminState=vcgAdminState, HoldOffTime=HoldOffTime, vcgOperationalState=vcgOperationalState, vcgMemberTable=vcgMemberTable, f3EotdmGroups=f3EotdmGroups, f3EotdmCompliance=f3EotdmCompliance, f3EotdmCompliances=f3EotdmCompliances, vcgHoldOffTimer=vcgHoldOffTimer, vcgAssociatedEthernetPort=vcgAssociatedEthernetPort, vcgMemberIndex=vcgMemberIndex, f3EOTDMMIB=f3EOTDMMIB, LcasSoState=LcasSoState, MstState=MstState, CtrlState=CtrlState, f3EotdmConformance=f3EotdmConformance, vcgMemberSoSendSeq=vcgMemberSoSendSeq, vcgMemberIfIndex=vcgMemberIfIndex, vcgMemberRowStatus=vcgMemberRowStatus, vcgMemberSoLcasRecvMst=vcgMemberSoLcasRecvMst, vcgMemberSoLcasSendCtrl=vcgMemberSoLcasSendCtrl, vcgMemberEntry=vcgMemberEntry, vcgTable=vcgTable, vcgWtrTimer=vcgWtrTimer)
