...
TimeTicks, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter32, NotificationType, Integer32, enterprises, iso, Bits, Opaque, MibIdentifier, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "enterprises", "iso", "Bits", "Opaque", "MibIdentifier", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveFilename=archiveFilename, emASMSigInstallComplete=emASMSigInstallComplete, emCpuUsage=emCpuUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, archiveEntry=archiveEntry, emArchives=emArchives, emSchedBackupFailed=emSchedBackupFailed, emDeviceList=emDeviceList, groupNumber=groupNumber, emDeviceActiveMode=emDeviceActiveMode, archiveEntryTable=archiveEntryTable, archiveProduct=archiveProduct, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceOfflineMode=emDeviceOfflineMode, PYSNMP_MODULE_ID=enterpriseManagement, emAlertObjMsg=emAlertObjMsg, emVersion=emVersion, archiveSourceDevice=archiveSourceDevice, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emPerformanceThreshold=emPerformanceThreshold, emImages=emImages, deviceAddressType=deviceAddressType, archiveDescription=archiveDescription, emSoftwareInstallComplete=emSoftwareInstallComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveVersion=archiveVersion, archiveNumber=archiveNumber, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjects=emAlertObjects, emPerformanceStorageCap=emPerformanceStorageCap, imageEntry=imageEntry, emServiceContractExpiry=emServiceContractExpiry, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlerts=emAlerts, emDiskUsage=emDiskUsage, deviceAddress=deviceAddress, emDeviceClockSkew=emDeviceClockSkew, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDevices=emDevices, emDeviceImpaired=emDeviceImpaired, deviceName=deviceName, emHotfixInstallComplete=emHotfixInstallComplete, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emCertificateExpiration=emCertificateExpiration, emDeviceConfigSync=emDeviceConfigSync, emHaSyncFailed=emHaSyncFailed, emRefreshInterval=emRefreshInterval, imageVersion=imageVersion, deviceNumber=deviceNumber, imageEntryTable=imageEntryTable, emDeviceGroups=emDeviceGroups, imageDescription=imageDescription, emMemoryUsage=emMemoryUsage, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateFailed=emASMSigUpdateFailed, enterpriseManagement=enterpriseManagement, emAlertConfigObjects=emAlertConfigObjects, deviceEntry=deviceEntry, groupEntryTable=groupEntryTable, archiveTimeStamp=archiveTimeStamp, emGlobals=emGlobals, deviceEntryTable=deviceEntryTable, emASMSigInstallFailed=emASMSigInstallFailed, groupDescription=groupDescription, groupName=groupName, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emStatsCollectionRateCap=emStatsCollectionRateCap, groupEntry=groupEntry, emAlert=emAlert, imageNumber=imageNumber, emDeviceStandbyMode=emDeviceStandbyMode)
