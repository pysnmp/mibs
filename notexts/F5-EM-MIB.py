...
NotificationType, Counter64, iso, Bits, Counter32, TimeTicks, Gauge32, Unsigned32, IpAddress, Opaque, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "iso", "Bits", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "IpAddress", "Opaque", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, archiveEntry=archiveEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveSourceDevice=archiveSourceDevice, emASMSigInstallFailed=emASMSigInstallFailed, archiveTimeStamp=archiveTimeStamp, emAlertConfigObjects=emAlertConfigObjects, archiveVersion=archiveVersion, deviceAddress=deviceAddress, emImages=emImages, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emSoftwareInstallComplete=emSoftwareInstallComplete, emSoftwareInstallFailed=emSoftwareInstallFailed, imageNumber=imageNumber, groupName=groupName, archiveDescription=archiveDescription, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emASMSigInstallComplete=emASMSigInstallComplete, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceOfflineMode=emDeviceOfflineMode, deviceAddressType=deviceAddressType, deviceEntryTable=deviceEntryTable, emDeviceConfigSync=emDeviceConfigSync, emASMSigUpdateFailed=emASMSigUpdateFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, groupNumber=groupNumber, emDevices=emDevices, emHotfixInstallComplete=emHotfixInstallComplete, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emArchives=emArchives, emPerformanceStorageDays=emPerformanceStorageDays, groupDescription=groupDescription, emAlerts=emAlerts, enterpriseManagement=enterpriseManagement, imageEntry=imageEntry, emVersion=emVersion, emAlertObjects=emAlertObjects, emServiceContractExpiry=emServiceContractExpiry, PYSNMP_MODULE_ID=enterpriseManagement, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceEntry=deviceEntry, imageVersion=imageVersion, emCpuUsage=emCpuUsage, groupEntryTable=groupEntryTable, emDeviceClockSkew=emDeviceClockSkew, imageDescription=imageDescription, emDiskUsage=emDiskUsage, emCertificateExpiration=emCertificateExpiration, emSchedBackupFailed=emSchedBackupFailed, emGlobals=emGlobals, emRefreshInterval=emRefreshInterval, groupEntry=groupEntry, archiveFilename=archiveFilename, emDeviceUnreachable=emDeviceUnreachable, imageEntryTable=imageEntryTable, emDeviceImpaired=emDeviceImpaired, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceList=emDeviceList, archiveProduct=archiveProduct, emHaSyncFailed=emHaSyncFailed, archiveNumber=archiveNumber, emAlert=emAlert, emDeviceActiveMode=emDeviceActiveMode, emMemoryUsage=emMemoryUsage, emDeviceGroups=emDeviceGroups, emHotfixInstallFailed=emHotfixInstallFailed, deviceName=deviceName, emPerformanceStorageCap=emPerformanceStorageCap, emAlertObjMsg=emAlertObjMsg, deviceNumber=deviceNumber, emDeviceStandbyMode=emDeviceStandbyMode)
