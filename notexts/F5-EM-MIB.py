...
TimeTicks, MibIdentifier, ModuleIdentity, enterprises, Integer32, Counter64, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Gauge32, NotificationType, Bits, iso, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "ModuleIdentity", "enterprises", "Integer32", "Counter64", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Gauge32", "NotificationType", "Bits", "iso", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveNumber=archiveNumber, emImages=emImages, emCertificateExpiration=emCertificateExpiration, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceActiveMode=emDeviceActiveMode, emRefreshInterval=emRefreshInterval, deviceEntryTable=deviceEntryTable, imageEntry=imageEntry, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceOfflineMode=emDeviceOfflineMode, groupName=groupName, emDevices=emDevices, emVersion=emVersion, archiveSourceDevice=archiveSourceDevice, emDiskUsage=emDiskUsage, emDeviceImpaired=emDeviceImpaired, emDeviceGroups=emDeviceGroups, emASMSigInstallFailed=emASMSigInstallFailed, archiveEntryTable=archiveEntryTable, archiveVersion=archiveVersion, emAlertObjMsg=emAlertObjMsg, imageVersion=imageVersion, emHotfixInstallComplete=emHotfixInstallComplete, emSchedBackupFailed=emSchedBackupFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceNumber=deviceNumber, enterpriseManagement=enterpriseManagement, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjects=emAlertObjects, groupEntryTable=groupEntryTable, groupNumber=groupNumber, emRaidDriveFailureDetected=emRaidDriveFailureDetected, imageDescription=imageDescription, emHaSyncFailed=emHaSyncFailed, groupEntry=groupEntry, emSoftwareInstallFailed=emSoftwareInstallFailed, imageNumber=imageNumber, emSoftwareInstallComplete=emSoftwareInstallComplete, groupDescription=groupDescription, emMemoryUsage=emMemoryUsage, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceList=emDeviceList, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageCap=emPerformanceStorageCap, archiveDescription=archiveDescription, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emAlerts=emAlerts, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceStandbyMode=emDeviceStandbyMode, emServiceContractExpiry=emServiceContractExpiry, emArchives=emArchives, deviceAddressType=deviceAddressType, archiveTimeStamp=archiveTimeStamp, emDeviceClockSkew=emDeviceClockSkew, emDeviceConfigSync=emDeviceConfigSync, emPerformanceStorageDays=emPerformanceStorageDays, emAlertConfigObjects=emAlertConfigObjects, emPerformanceThreshold=emPerformanceThreshold, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveFilename=archiveFilename, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlert=emAlert, emGlobals=emGlobals, archiveEntry=archiveEntry, emCpuUsage=emCpuUsage, archiveProduct=archiveProduct, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceEntry=deviceEntry, deviceAddress=deviceAddress, imageEntryTable=imageEntryTable, deviceName=deviceName, emStatsDBConnectivityLost=emStatsDBConnectivityLost)
