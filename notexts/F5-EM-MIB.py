...
iso, enterprises, Bits, Opaque, ModuleIdentity, Unsigned32, TimeTicks, MibIdentifier, Integer32, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Bits", "Opaque", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibIdentifier", "Integer32", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", groupName=groupName, deviceEntry=deviceEntry, emDeviceGroups=emDeviceGroups, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emMemoryUsage=emMemoryUsage, deviceNumber=deviceNumber, groupEntry=groupEntry, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveEntry=archiveEntry, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceConfigSync=emDeviceConfigSync, emArchives=emArchives, emStatsCollectionRateCap=emStatsCollectionRateCap, emHaSyncFailed=emHaSyncFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceStandbyMode=emDeviceStandbyMode, archiveNumber=archiveNumber, archiveEntryTable=archiveEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emASMSigInstallComplete=emASMSigInstallComplete, emDiskUsage=emDiskUsage, emASMSigUpdateFailed=emASMSigUpdateFailed, emPerformanceStorageCap=emPerformanceStorageCap, emASMSigInstallFailed=emASMSigInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceAddressType=deviceAddressType, PYSNMP_MODULE_ID=enterpriseManagement, imageNumber=imageNumber, emHotfixInstallFailed=emHotfixInstallFailed, emDevices=emDevices, emAlerts=emAlerts, emDeviceImpaired=emDeviceImpaired, imageEntry=imageEntry, emCertificateExpiration=emCertificateExpiration, deviceEntryTable=deviceEntryTable, deviceAddress=deviceAddress, emPerformanceThreshold=emPerformanceThreshold, emImages=emImages, emDeviceClockSkew=emDeviceClockSkew, emRefreshInterval=emRefreshInterval, archiveVersion=archiveVersion, emDeviceList=emDeviceList, emDeviceOfflineMode=emDeviceOfflineMode, groupDescription=groupDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emSchedBackupFailed=emSchedBackupFailed, archiveProduct=archiveProduct, deviceName=deviceName, emAlertObjects=emAlertObjects, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emCpuUsage=emCpuUsage, emAlertObjMsg=emAlertObjMsg, emGlobals=emGlobals, groupEntryTable=groupEntryTable, emPerformanceStorageDays=emPerformanceStorageDays, enterpriseManagement=enterpriseManagement, emHotfixInstallComplete=emHotfixInstallComplete, imageEntryTable=imageEntryTable, archiveTimeStamp=archiveTimeStamp, imageDescription=imageDescription, archiveSourceDevice=archiveSourceDevice, archiveFilename=archiveFilename, emDeviceUnreachable=emDeviceUnreachable, emScheduledArchiveFailed=emScheduledArchiveFailed, imageVersion=imageVersion, archiveDescription=archiveDescription, emSoftwareInstallComplete=emSoftwareInstallComplete, emVersion=emVersion, groupNumber=groupNumber, emAlertConfigObjects=emAlertConfigObjects, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlert=emAlert, emServiceContractExpiry=emServiceContractExpiry)
