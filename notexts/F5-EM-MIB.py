...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Counter32, NotificationType, Bits, TimeTicks, IpAddress, MibIdentifier, iso, ModuleIdentity, Opaque, enterprises, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Counter32", "NotificationType", "Bits", "TimeTicks", "IpAddress", "MibIdentifier", "iso", "ModuleIdentity", "Opaque", "enterprises", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveVersion=archiveVersion, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceUnreachable=emDeviceUnreachable, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceActiveMode=emDeviceActiveMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceAddress=deviceAddress, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDeviceStandbyMode=emDeviceStandbyMode, emGlobals=emGlobals, groupEntry=groupEntry, emSoftwareInstallFailed=emSoftwareInstallFailed, emServiceContractExpiry=emServiceContractExpiry, emAlertObjMsg=emAlertObjMsg, imageEntryTable=imageEntryTable, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDevices=emDevices, archiveProduct=archiveProduct, archiveFilename=archiveFilename, imageNumber=imageNumber, emImages=emImages, archiveSourceDevice=archiveSourceDevice, emRefreshInterval=emRefreshInterval, deviceEntryTable=deviceEntryTable, emMemoryUsage=emMemoryUsage, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceOfflineMode=emDeviceOfflineMode, archiveEntryTable=archiveEntryTable, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlertConfigObjects=emAlertConfigObjects, emAlertObjects=emAlertObjects, emDeviceGroups=emDeviceGroups, archiveNumber=archiveNumber, emCpuUsage=emCpuUsage, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceImpaired=emDeviceImpaired, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupDescription=groupDescription, emDiskUsage=emDiskUsage, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveTimeStamp=archiveTimeStamp, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceStorageCap=emPerformanceStorageCap, deviceNumber=deviceNumber, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHaSyncFailed=emHaSyncFailed, imageDescription=imageDescription, emDeviceClockSkew=emDeviceClockSkew, emHotfixInstallComplete=emHotfixInstallComplete, groupNumber=groupNumber, deviceEntry=deviceEntry, emPerformanceThreshold=emPerformanceThreshold, imageEntry=imageEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emASMSigInstallComplete=emASMSigInstallComplete, emAlerts=emAlerts, emVersion=emVersion, deviceAddressType=deviceAddressType, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceConfigSync=emDeviceConfigSync, PYSNMP_MODULE_ID=enterpriseManagement, archiveDescription=archiveDescription, emDeviceList=emDeviceList, emCertificateExpiration=emCertificateExpiration, groupEntryTable=groupEntryTable, imageVersion=imageVersion, emArchives=emArchives, groupName=groupName, emSchedBackupFailed=emSchedBackupFailed, emAlert=emAlert, deviceName=deviceName, enterpriseManagement=enterpriseManagement, archiveEntry=archiveEntry)
