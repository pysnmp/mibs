...
Opaque, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Integer32, NotificationType, iso, Bits, Counter32, Counter64, ModuleIdentity, enterprises, Unsigned32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Integer32", "NotificationType", "iso", "Bits", "Counter32", "Counter64", "ModuleIdentity", "enterprises", "Unsigned32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceClockSkew=emDeviceClockSkew, emASMSigInstallComplete=emASMSigInstallComplete, emSchedBackupFailed=emSchedBackupFailed, emPerformanceStorageDays=emPerformanceStorageDays, emAlertObjects=emAlertObjects, emHotfixInstallFailed=emHotfixInstallFailed, archiveDescription=archiveDescription, deviceName=deviceName, groupEntry=groupEntry, emServiceContractExpiry=emServiceContractExpiry, archiveSourceDevice=archiveSourceDevice, emSoftwareInstallFailed=emSoftwareInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceList=emDeviceList, archiveProduct=archiveProduct, emVersion=emVersion, emDevices=emDevices, emDiskUsage=emDiskUsage, emDeviceGroups=emDeviceGroups, emAlerts=emAlerts, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emCpuUsage=emCpuUsage, archiveTimeStamp=archiveTimeStamp, emCertificateExpiration=emCertificateExpiration, emImages=emImages, imageEntryTable=imageEntryTable, groupNumber=groupNumber, emAlert=emAlert, imageVersion=imageVersion, emAlertConfigObjects=emAlertConfigObjects, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceStandbyMode=emDeviceStandbyMode, emDeviceConfigSync=emDeviceConfigSync, emPerformanceThreshold=emPerformanceThreshold, imageNumber=imageNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlertObjMsg=emAlertObjMsg, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emHotfixInstallComplete=emHotfixInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceOfflineMode=emDeviceOfflineMode, deviceAddress=deviceAddress, emDeviceActiveMode=emDeviceActiveMode, deviceNumber=deviceNumber, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, archiveNumber=archiveNumber, archiveEntryTable=archiveEntryTable, enterpriseManagement=enterpriseManagement, archiveEntry=archiveEntry, emGatherServiceContractFailure=emGatherServiceContractFailure, emGlobals=emGlobals, deviceAddressType=deviceAddressType, groupEntryTable=groupEntryTable, emRefreshInterval=emRefreshInterval, archiveFilename=archiveFilename, deviceEntryTable=deviceEntryTable, emHaSyncFailed=emHaSyncFailed, emDeviceImpaired=emDeviceImpaired, emMemoryUsage=emMemoryUsage, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupName=groupName, archiveVersion=archiveVersion, deviceEntry=deviceEntry, imageEntry=imageEntry, emArchives=emArchives, emDeviceUnreachable=emDeviceUnreachable, emSoftwareInstallComplete=emSoftwareInstallComplete, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, groupDescription=groupDescription, imageDescription=imageDescription, PYSNMP_MODULE_ID=enterpriseManagement, emMaxConcurrentUpdates=emMaxConcurrentUpdates)
