...
ModuleIdentity, Counter64, Bits, Unsigned32, Integer32, TimeTicks, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, NotificationType, Opaque, MibIdentifier, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "Integer32", "TimeTicks", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "NotificationType", "Opaque", "MibIdentifier", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emVersion=emVersion, emStatsDBConnectivityLost=emStatsDBConnectivityLost, groupDescription=groupDescription, archiveVersion=archiveVersion, emDeviceOfflineMode=emDeviceOfflineMode, groupNumber=groupNumber, archiveDescription=archiveDescription, deviceNumber=deviceNumber, archiveTimeStamp=archiveTimeStamp, emDeviceImpaired=emDeviceImpaired, deviceEntry=deviceEntry, emAlerts=emAlerts, groupEntryTable=groupEntryTable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlert=emAlert, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigInstallComplete=emASMSigInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emArchives=emArchives, emDevices=emDevices, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emASMSigUpdateFailed=emASMSigUpdateFailed, emDiskUsage=emDiskUsage, emAlertObjects=emAlertObjects, emImages=emImages, archiveProduct=archiveProduct, imageDescription=imageDescription, emMemoryUsage=emMemoryUsage, emDeviceConfigSync=emDeviceConfigSync, archiveSourceDevice=archiveSourceDevice, emDeviceClockSkew=emDeviceClockSkew, emScheduledArchiveFailed=emScheduledArchiveFailed, imageEntry=imageEntry, emDeviceStandbyMode=emDeviceStandbyMode, emCpuUsage=emCpuUsage, emCertificateExpiration=emCertificateExpiration, deviceName=deviceName, imageVersion=imageVersion, groupEntry=groupEntry, emPerformanceStorageDays=emPerformanceStorageDays, emAlertConfigObjects=emAlertConfigObjects, emPerformanceThreshold=emPerformanceThreshold, PYSNMP_MODULE_ID=enterpriseManagement, deviceEntryTable=deviceEntryTable, enterpriseManagement=enterpriseManagement, emDeviceList=emDeviceList, archiveEntryTable=archiveEntryTable, deviceAddressType=deviceAddressType, emASMSigInstallFailed=emASMSigInstallFailed, emSchedBackupFailed=emSchedBackupFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceAddress=deviceAddress, emDeviceGroups=emDeviceGroups, emAlertObjMsg=emAlertObjMsg, emStatsCollectionRateCap=emStatsCollectionRateCap, emGlobals=emGlobals, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceActiveMode=emDeviceActiveMode, emSoftwareInstallFailed=emSoftwareInstallFailed, groupName=groupName, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveNumber=archiveNumber, emHaSyncFailed=emHaSyncFailed, emServiceContractExpiry=emServiceContractExpiry, archiveEntry=archiveEntry, archiveFilename=archiveFilename, emGatherServiceContractFailure=emGatherServiceContractFailure, imageEntryTable=imageEntryTable, emRefreshInterval=emRefreshInterval, emPerformanceStorageCap=emPerformanceStorageCap, imageNumber=imageNumber, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceUnreachable=emDeviceUnreachable)
