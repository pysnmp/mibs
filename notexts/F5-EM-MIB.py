...
Opaque, ModuleIdentity, enterprises, Integer32, NotificationType, IpAddress, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, Counter32, ObjectIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Opaque", "ModuleIdentity", "enterprises", "Integer32", "NotificationType", "IpAddress", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "Counter32", "ObjectIdentity", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("F5-EM-MIB", emASMSigInstallComplete=emASMSigInstallComplete, emRefreshInterval=emRefreshInterval, archiveTimeStamp=archiveTimeStamp, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceImpaired=emDeviceImpaired, emCertificateExpiration=emCertificateExpiration, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDevices=emDevices, imageVersion=imageVersion, emDeviceClockSkew=emDeviceClockSkew, emArchives=emArchives, groupDescription=groupDescription, emPerformanceStorageDays=emPerformanceStorageDays, emASMSigInstallFailed=emASMSigInstallFailed, imageDescription=imageDescription, emDeviceConfigSync=emDeviceConfigSync, emImages=emImages, archiveProduct=archiveProduct, emSchedBackupFailed=emSchedBackupFailed, emDeviceOfflineMode=emDeviceOfflineMode, emMaxConcurrentUpdates=emMaxConcurrentUpdates, groupName=groupName, emAlertObjects=emAlertObjects, archiveVersion=archiveVersion, emDiskUsage=emDiskUsage, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceUnreachable=emDeviceUnreachable, emDeviceStandbyMode=emDeviceStandbyMode, deviceEntry=deviceEntry, imageEntry=imageEntry, emHaSyncFailed=emHaSyncFailed, emGlobals=emGlobals, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceNumber=deviceNumber, archiveEntry=archiveEntry, deviceAddress=deviceAddress, emScheduledArchiveFailed=emScheduledArchiveFailed, archiveNumber=archiveNumber, emDeviceGroups=emDeviceGroups, archiveFilename=archiveFilename, emServiceContractExpiry=emServiceContractExpiry, archiveSourceDevice=archiveSourceDevice, emCpuUsage=emCpuUsage, emDeviceList=emDeviceList, archiveDescription=archiveDescription, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlert=emAlert, imageNumber=imageNumber, emStatsCollectionRateCap=emStatsCollectionRateCap, emMemoryUsage=emMemoryUsage, enterpriseManagement=enterpriseManagement, groupEntry=groupEntry, emDeviceActiveMode=emDeviceActiveMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emPerformanceThreshold=emPerformanceThreshold, groupEntryTable=groupEntryTable, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceName=deviceName, emAlertObjMsg=emAlertObjMsg, imageEntryTable=imageEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlertConfigObjects=emAlertConfigObjects, emGatherServiceContractFailure=emGatherServiceContractFailure, PYSNMP_MODULE_ID=enterpriseManagement, deviceEntryTable=deviceEntryTable, emVersion=emVersion, emHotfixInstallFailed=emHotfixInstallFailed, emAlerts=emAlerts, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceStorageCap=emPerformanceStorageCap, deviceAddressType=deviceAddressType, groupNumber=groupNumber, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveEntryTable=archiveEntryTable)
