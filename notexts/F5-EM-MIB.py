...
Integer32, NotificationType, ModuleIdentity, Counter64, iso, Bits, ObjectIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Gauge32, TimeTicks, enterprises, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ModuleIdentity", "Counter64", "iso", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Gauge32", "TimeTicks", "enterprises", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emASMSigUpdateFailed=emASMSigUpdateFailed, emServiceContractExpiry=emServiceContractExpiry, deviceName=deviceName, emHaSyncFailed=emHaSyncFailed, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveVersion=archiveVersion, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceStandbyMode=emDeviceStandbyMode, emHotfixInstallFailed=emHotfixInstallFailed, emVersion=emVersion, emDeviceClockSkew=emDeviceClockSkew, emAlerts=emAlerts, groupDescription=groupDescription, groupEntryTable=groupEntryTable, emArchives=emArchives, emRefreshInterval=emRefreshInterval, emDeviceImpaired=emDeviceImpaired, archiveProduct=archiveProduct, emDiskUsage=emDiskUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, deviceAddressType=deviceAddressType, emASMSigInstallComplete=emASMSigInstallComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveTimeStamp=archiveTimeStamp, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupNumber=groupNumber, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveSourceDevice=archiveSourceDevice, emPerformanceThreshold=emPerformanceThreshold, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceConfigSync=emDeviceConfigSync, emDeviceOfflineMode=emDeviceOfflineMode, deviceNumber=deviceNumber, emDeviceList=emDeviceList, imageNumber=imageNumber, PYSNMP_MODULE_ID=enterpriseManagement, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceActiveMode=emDeviceActiveMode, emASMSigInstallFailed=emASMSigInstallFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, archiveEntry=archiveEntry, emAlertConfigObjects=emAlertConfigObjects, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, imageVersion=imageVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emAlert=emAlert, emImages=emImages, emDeviceGroups=emDeviceGroups, archiveNumber=archiveNumber, emSchedBackupFailed=emSchedBackupFailed, emAlertObjects=emAlertObjects, deviceAddress=deviceAddress, deviceEntry=deviceEntry, imageDescription=imageDescription, emGlobals=emGlobals, emDevices=emDevices, emPerformanceStorageCap=emPerformanceStorageCap, deviceEntryTable=deviceEntryTable, archiveDescription=archiveDescription, emMemoryUsage=emMemoryUsage, enterpriseManagement=enterpriseManagement, imageEntryTable=imageEntryTable, groupEntry=groupEntry, archiveFilename=archiveFilename, archiveEntryTable=archiveEntryTable, emPerformanceStorageDays=emPerformanceStorageDays, imageEntry=imageEntry, groupName=groupName, emCpuUsage=emCpuUsage, emDeviceUnreachable=emDeviceUnreachable, emAlertObjMsg=emAlertObjMsg, emHotfixInstallComplete=emHotfixInstallComplete, emCertificateExpiration=emCertificateExpiration)
