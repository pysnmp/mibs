...
iso, ModuleIdentity, Gauge32, Bits, NotificationType, enterprises, MibIdentifier, Unsigned32, Opaque, Counter64, IpAddress, TimeTicks, Integer32, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Gauge32", "Bits", "NotificationType", "enterprises", "MibIdentifier", "Unsigned32", "Opaque", "Counter64", "IpAddress", "TimeTicks", "Integer32", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceActiveMode=emDeviceActiveMode, imageNumber=imageNumber, archiveVersion=archiveVersion, emGlobals=emGlobals, enterpriseManagement=enterpriseManagement, emHotfixInstallFailed=emHotfixInstallFailed, emSoftwareInstallFailed=emSoftwareInstallFailed, emHaSyncFailed=emHaSyncFailed, imageDescription=imageDescription, emHotfixInstallComplete=emHotfixInstallComplete, emDeviceConfigSync=emDeviceConfigSync, emServiceContractExpiry=emServiceContractExpiry, emVersion=emVersion, emDiskUsage=emDiskUsage, archiveDescription=archiveDescription, deviceEntryTable=deviceEntryTable, emCertificateExpiration=emCertificateExpiration, imageEntryTable=imageEntryTable, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlertObjects=emAlertObjects, groupName=groupName, emArchives=emArchives, emAlert=emAlert, groupEntry=groupEntry, groupDescription=groupDescription, emDeviceGroups=emDeviceGroups, emMemoryUsage=emMemoryUsage, emScheduledArchiveFailed=emScheduledArchiveFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveTimeStamp=archiveTimeStamp, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceList=emDeviceList, archiveFilename=archiveFilename, deviceAddressType=deviceAddressType, imageVersion=imageVersion, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emDeviceUnreachable=emDeviceUnreachable, emAlerts=emAlerts, deviceNumber=deviceNumber, emASMSigUpdateFailed=emASMSigUpdateFailed, deviceEntry=deviceEntry, emASMSigInstallComplete=emASMSigInstallComplete, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceStorageDays=emPerformanceStorageDays, emPerformanceThreshold=emPerformanceThreshold, archiveNumber=archiveNumber, groupEntryTable=groupEntryTable, emAlertObjMsg=emAlertObjMsg, archiveProduct=archiveProduct, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntry=imageEntry, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigInstallFailed=emASMSigInstallFailed, emSchedBackupFailed=emSchedBackupFailed, emDeviceImpaired=emDeviceImpaired, emDeviceClockSkew=emDeviceClockSkew, emImages=emImages, emAlertConfigObjects=emAlertConfigObjects, deviceAddress=deviceAddress, emCpuUsage=emCpuUsage, deviceName=deviceName, emRefreshInterval=emRefreshInterval, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveSourceDevice=archiveSourceDevice, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveFailureDetected=emRaidDriveFailureDetected, groupNumber=groupNumber, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, archiveEntry=archiveEntry, emDevices=emDevices, emSoftwareInstallComplete=emSoftwareInstallComplete, PYSNMP_MODULE_ID=enterpriseManagement)
