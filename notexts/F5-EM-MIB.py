...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, MibIdentifier, Counter32, Bits, IpAddress, NotificationType, Opaque, Counter64, ObjectIdentity, Unsigned32, Integer32, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "MibIdentifier", "Counter32", "Bits", "IpAddress", "NotificationType", "Opaque", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emHotfixInstallComplete=emHotfixInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emASMSigUpdateFailed=emASMSigUpdateFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceStandbyMode=emDeviceStandbyMode, imageEntryTable=imageEntryTable, emVersion=emVersion, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceEntryTable=deviceEntryTable, emAlertObjMsg=emAlertObjMsg, emDeviceActiveMode=emDeviceActiveMode, groupEntry=groupEntry, archiveSourceDevice=archiveSourceDevice, emAlert=emAlert, archiveProduct=archiveProduct, deviceName=deviceName, archiveEntry=archiveEntry, deviceAddress=deviceAddress, groupName=groupName, emDiskUsage=emDiskUsage, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveVersion=archiveVersion, emPerformanceStorageDays=emPerformanceStorageDays, deviceAddressType=deviceAddressType, archiveNumber=archiveNumber, emImages=emImages, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emPerformanceThreshold=emPerformanceThreshold, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, archiveEntryTable=archiveEntryTable, emServiceContractExpiry=emServiceContractExpiry, emGlobals=emGlobals, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emMemoryUsage=emMemoryUsage, emHaSyncFailed=emHaSyncFailed, enterpriseManagement=enterpriseManagement, groupNumber=groupNumber, emHotfixInstallFailed=emHotfixInstallFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emPerformanceStorageCap=emPerformanceStorageCap, groupEntryTable=groupEntryTable, emDeviceImpaired=emDeviceImpaired, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emSoftwareInstallComplete=emSoftwareInstallComplete, imageDescription=imageDescription, emScheduledArchiveFailed=emScheduledArchiveFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageVersion=imageVersion, archiveFilename=archiveFilename, emCertificateExpiration=emCertificateExpiration, emDeviceGroups=emDeviceGroups, emAlertConfigObjects=emAlertConfigObjects, imageNumber=imageNumber, emDeviceUnreachable=emDeviceUnreachable, emCpuUsage=emCpuUsage, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceEntry=deviceEntry, emRefreshInterval=emRefreshInterval, emSchedBackupFailed=emSchedBackupFailed, archiveDescription=archiveDescription, emASMSigInstallFailed=emASMSigInstallFailed, emDevices=emDevices, imageEntry=imageEntry, archiveTimeStamp=archiveTimeStamp, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceConfigSync=emDeviceConfigSync, groupDescription=groupDescription, emDeviceList=emDeviceList, emAlertObjects=emAlertObjects, emArchives=emArchives, emAlerts=emAlerts, emDeviceClockSkew=emDeviceClockSkew, deviceNumber=deviceNumber)
