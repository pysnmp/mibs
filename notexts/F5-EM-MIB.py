...
ObjectIdentity, Gauge32, TimeTicks, Bits, Unsigned32, NotificationType, Counter64, enterprises, Opaque, iso, MibIdentifier, ModuleIdentity, Integer32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "TimeTicks", "Bits", "Unsigned32", "NotificationType", "Counter64", "enterprises", "Opaque", "iso", "MibIdentifier", "ModuleIdentity", "Integer32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDevices=emDevices, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emHotfixInstallComplete=emHotfixInstallComplete, emMemoryUsage=emMemoryUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDiskUsage=emDiskUsage, emArchives=emArchives, emDeviceStandbyMode=emDeviceStandbyMode, emAlertObjects=emAlertObjects, emASMSigUpdateFailed=emASMSigUpdateFailed, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, archiveTimeStamp=archiveTimeStamp, groupEntryTable=groupEntryTable, emASMSigInstallFailed=emASMSigInstallFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, imageNumber=imageNumber, deviceEntry=deviceEntry, archiveSourceDevice=archiveSourceDevice, deviceEntryTable=deviceEntryTable, emRefreshInterval=emRefreshInterval, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveFilename=archiveFilename, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceNumber=deviceNumber, enterpriseManagement=enterpriseManagement, emStatsDBConnectivityLost=emStatsDBConnectivityLost, PYSNMP_MODULE_ID=enterpriseManagement, archiveProduct=archiveProduct, groupEntry=groupEntry, deviceAddress=deviceAddress, emCpuUsage=emCpuUsage, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emHaSyncFailed=emHaSyncFailed, groupNumber=groupNumber, emPerformanceStorageCap=emPerformanceStorageCap, imageDescription=imageDescription, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjMsg=emAlertObjMsg, emGlobals=emGlobals, imageEntryTable=imageEntryTable, archiveVersion=archiveVersion, groupName=groupName, emStatsCollectionRateCap=emStatsCollectionRateCap, emASMSigInstallComplete=emASMSigInstallComplete, emScheduledArchiveFailed=emScheduledArchiveFailed, emSchedBackupFailed=emSchedBackupFailed, emImages=emImages, emDeviceOfflineMode=emDeviceOfflineMode, deviceAddressType=deviceAddressType, emCertificateExpiration=emCertificateExpiration, emDeviceUnreachable=emDeviceUnreachable, archiveDescription=archiveDescription, deviceName=deviceName, imageVersion=imageVersion, emSoftwareInstallFailed=emSoftwareInstallFailed, emServiceContractExpiry=emServiceContractExpiry, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlert=emAlert, emAlerts=emAlerts, emAlertConfigObjects=emAlertConfigObjects, emDeviceList=emDeviceList, emPerformanceThreshold=emPerformanceThreshold, emDeviceGroups=emDeviceGroups, imageEntry=imageEntry, archiveNumber=archiveNumber, archiveEntryTable=archiveEntryTable, archiveEntry=archiveEntry, emVersion=emVersion, emDeviceClockSkew=emDeviceClockSkew, emDeviceActiveMode=emDeviceActiveMode, emPerformanceStorageDays=emPerformanceStorageDays, emDeviceConfigSync=emDeviceConfigSync, groupDescription=groupDescription, emDeviceImpaired=emDeviceImpaired)
