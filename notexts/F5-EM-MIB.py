...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, Gauge32, MibIdentifier, Bits, Opaque, Integer32, enterprises, Unsigned32, Counter32, Counter64, NotificationType, IpAddress, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "Gauge32", "MibIdentifier", "Bits", "Opaque", "Integer32", "enterprises", "Unsigned32", "Counter32", "Counter64", "NotificationType", "IpAddress", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceOfflineMode=emDeviceOfflineMode, archiveDescription=archiveDescription, deviceEntryTable=deviceEntryTable, emRefreshInterval=emRefreshInterval, archiveEntry=archiveEntry, emAlertObjMsg=emAlertObjMsg, emScheduledArchiveFailed=emScheduledArchiveFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emAlert=emAlert, imageNumber=imageNumber, imageEntry=imageEntry, emDeviceList=emDeviceList, archiveSourceDevice=archiveSourceDevice, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceImpaired=emDeviceImpaired, groupEntryTable=groupEntryTable, emGlobals=emGlobals, emPerformanceThreshold=emPerformanceThreshold, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emSoftwareInstallFailed=emSoftwareInstallFailed, emSoftwareInstallComplete=emSoftwareInstallComplete, emAlertConfigObjects=emAlertConfigObjects, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, imageEntryTable=imageEntryTable, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emASMSigInstallComplete=emASMSigInstallComplete, emCertificateExpiration=emCertificateExpiration, emDeviceConfigSync=emDeviceConfigSync, deviceAddress=deviceAddress, groupEntry=groupEntry, archiveFilename=archiveFilename, emHotfixInstallFailed=emHotfixInstallFailed, emMemoryUsage=emMemoryUsage, emImages=emImages, emAlertObjects=emAlertObjects, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageDays=emPerformanceStorageDays, PYSNMP_MODULE_ID=enterpriseManagement, emDevices=emDevices, imageVersion=imageVersion, emAlerts=emAlerts, emDeviceStandbyMode=emDeviceStandbyMode, emRaidDriveFailureDetected=emRaidDriveFailureDetected, archiveProduct=archiveProduct, enterpriseManagement=enterpriseManagement, emHaSyncFailed=emHaSyncFailed, deviceNumber=deviceNumber, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceName=deviceName, emSchedBackupFailed=emSchedBackupFailed, emASMSigUpdateAvailable=emASMSigUpdateAvailable, groupName=groupName, deviceAddressType=deviceAddressType, groupDescription=groupDescription, archiveNumber=archiveNumber, emHotfixInstallComplete=emHotfixInstallComplete, deviceEntry=deviceEntry, emASMSigInstallFailed=emASMSigInstallFailed, archiveVersion=archiveVersion, emDeviceActiveMode=emDeviceActiveMode, emDiskUsage=emDiskUsage, emArchives=emArchives, emGatherServiceContractFailure=emGatherServiceContractFailure, emCpuUsage=emCpuUsage, archiveEntryTable=archiveEntryTable, groupNumber=groupNumber, emVersion=emVersion, emPerformanceStorageCap=emPerformanceStorageCap, emServiceContractExpiry=emServiceContractExpiry, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceGroups=emDeviceGroups, archiveTimeStamp=archiveTimeStamp, emDeviceClockSkew=emDeviceClockSkew, imageDescription=imageDescription)
