...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Opaque, Counter32, Counter64, ModuleIdentity, iso, Bits, NotificationType, Gauge32, MibIdentifier, IpAddress, ObjectIdentity, Unsigned32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Opaque", "Counter32", "Counter64", "ModuleIdentity", "iso", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "IpAddress", "ObjectIdentity", "Unsigned32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", archiveNumber=archiveNumber, archiveEntryTable=archiveEntryTable, imageNumber=imageNumber, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceStandbyMode=emDeviceStandbyMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageCap=emPerformanceStorageCap, emSoftwareInstallFailed=emSoftwareInstallFailed, deviceName=deviceName, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emCpuUsage=emCpuUsage, deviceEntryTable=deviceEntryTable, deviceAddressType=deviceAddressType, groupNumber=groupNumber, imageEntryTable=imageEntryTable, emCertificateExpiration=emCertificateExpiration, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceClockSkew=emDeviceClockSkew, emSchedBackupFailed=emSchedBackupFailed, emAlertConfigObjects=emAlertConfigObjects, deviceNumber=deviceNumber, emImages=emImages, deviceAddress=deviceAddress, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceList=emDeviceList, emServiceContractExpiry=emServiceContractExpiry, emAlertObjects=emAlertObjects, emDiskUsage=emDiskUsage, emAlerts=emAlerts, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceThreshold=emPerformanceThreshold, groupEntryTable=groupEntryTable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceImpaired=emDeviceImpaired, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigInstallFailed=emASMSigInstallFailed, emDevices=emDevices, groupDescription=groupDescription, archiveProduct=archiveProduct, archiveEntry=archiveEntry, emAlertObjMsg=emAlertObjMsg, groupName=groupName, archiveSourceDevice=archiveSourceDevice, emGlobals=emGlobals, imageDescription=imageDescription, emDeviceActiveMode=emDeviceActiveMode, emArchives=emArchives, emDeviceConfigSync=emDeviceConfigSync, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emPerformanceStorageDays=emPerformanceStorageDays, deviceEntry=deviceEntry, PYSNMP_MODULE_ID=enterpriseManagement, archiveDescription=archiveDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emMemoryUsage=emMemoryUsage, groupEntry=groupEntry, archiveFilename=archiveFilename, emRefreshInterval=emRefreshInterval, imageEntry=imageEntry, enterpriseManagement=enterpriseManagement, archiveTimeStamp=archiveTimeStamp, emAlert=emAlert, emASMSigInstallComplete=emASMSigInstallComplete, emHaSyncFailed=emHaSyncFailed, archiveVersion=archiveVersion, emHotfixInstallFailed=emHotfixInstallFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceOfflineMode=emDeviceOfflineMode, emDeviceUnreachable=emDeviceUnreachable, emHotfixInstallComplete=emHotfixInstallComplete, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceGroups=emDeviceGroups, emGatherServiceContractFailure=emGatherServiceContractFailure, imageVersion=imageVersion, emVersion=emVersion)
