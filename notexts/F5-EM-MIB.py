...
MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, ObjectIdentity, enterprises, iso, NotificationType, Opaque, TimeTicks, Counter32, Gauge32, Counter64, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "ObjectIdentity", "enterprises", "iso", "NotificationType", "Opaque", "TimeTicks", "Counter32", "Gauge32", "Counter64", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("F5-EM-MIB", deviceAddress=deviceAddress, archiveTimeStamp=archiveTimeStamp, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emRefreshInterval=emRefreshInterval, emASMSigUpdateFailed=emASMSigUpdateFailed, archiveVersion=archiveVersion, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupName=groupName, archiveFilename=archiveFilename, emDevices=emDevices, archiveSourceDevice=archiveSourceDevice, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceStandbyMode=emDeviceStandbyMode, imageEntryTable=imageEntryTable, groupDescription=groupDescription, emPerformanceThreshold=emPerformanceThreshold, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveEntry=archiveEntry, emHotfixInstallComplete=emHotfixInstallComplete, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, deviceNumber=deviceNumber, emDeviceClockSkew=emDeviceClockSkew, emAlert=emAlert, groupEntry=groupEntry, emDeviceGroups=emDeviceGroups, emDeviceList=emDeviceList, groupNumber=groupNumber, emMemoryUsage=emMemoryUsage, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, deviceName=deviceName, emGlobals=emGlobals, emSchedBackupFailed=emSchedBackupFailed, imageEntry=imageEntry, emAlerts=emAlerts, emServiceContractExpiry=emServiceContractExpiry, deviceAddressType=deviceAddressType, emVersion=emVersion, emCpuUsage=emCpuUsage, emAlertObjects=emAlertObjects, deviceEntry=deviceEntry, emSoftwareInstallComplete=emSoftwareInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlertConfigObjects=emAlertConfigObjects, emHotfixInstallFailed=emHotfixInstallFailed, emPerformanceStorageDays=emPerformanceStorageDays, emStatsCollectionRateCap=emStatsCollectionRateCap, emAlertObjMsg=emAlertObjMsg, emScheduledArchiveFailed=emScheduledArchiveFailed, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceImpaired=emDeviceImpaired, deviceEntryTable=deviceEntryTable, groupEntryTable=groupEntryTable, imageDescription=imageDescription, archiveNumber=archiveNumber, emDeviceUnreachable=emDeviceUnreachable, emASMSigInstallComplete=emASMSigInstallComplete, emHaSyncFailed=emHaSyncFailed, imageNumber=imageNumber, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveDescription=archiveDescription, imageVersion=imageVersion, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveProduct=archiveProduct, emCertificateExpiration=emCertificateExpiration, emImages=emImages, emDeviceActiveMode=emDeviceActiveMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, enterpriseManagement=enterpriseManagement, PYSNMP_MODULE_ID=enterpriseManagement, archiveEntryTable=archiveEntryTable, emDeviceConfigSync=emDeviceConfigSync, emArchives=emArchives, emPerformanceStorageCap=emPerformanceStorageCap, emDiskUsage=emDiskUsage)
