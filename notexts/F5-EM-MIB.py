...
MibIdentifier, ObjectIdentity, IpAddress, Counter32, Unsigned32, ModuleIdentity, NotificationType, Opaque, enterprises, Counter64, iso, TimeTicks, Bits, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "ModuleIdentity", "NotificationType", "Opaque", "enterprises", "Counter64", "iso", "TimeTicks", "Bits", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", groupEntryTable=groupEntryTable, emAlertConfigObjects=emAlertConfigObjects, emPerformanceThreshold=emPerformanceThreshold, archiveFilename=archiveFilename, emSoftwareInstallFailed=emSoftwareInstallFailed, emAlert=emAlert, groupName=groupName, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emAlertObjMsg=emAlertObjMsg, emDeviceClockSkew=emDeviceClockSkew, emGatherServiceContractFailure=emGatherServiceContractFailure, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, deviceAddressType=deviceAddressType, imageVersion=imageVersion, deviceEntryTable=deviceEntryTable, archiveTimeStamp=archiveTimeStamp, emDeviceOfflineMode=emDeviceOfflineMode, deviceNumber=deviceNumber, deviceName=deviceName, emDeviceUnreachable=emDeviceUnreachable, archiveSourceDevice=archiveSourceDevice, emServiceContractExpiry=emServiceContractExpiry, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceAddress=deviceAddress, emASMSigInstallFailed=emASMSigInstallFailed, imageEntry=imageEntry, imageNumber=imageNumber, archiveProduct=archiveProduct, archiveEntryTable=archiveEntryTable, emDeviceActiveMode=emDeviceActiveMode, archiveVersion=archiveVersion, emGlobals=emGlobals, enterpriseManagement=enterpriseManagement, emDeviceConfigSync=emDeviceConfigSync, emCertificateExpiration=emCertificateExpiration, groupDescription=groupDescription, archiveNumber=archiveNumber, emCpuUsage=emCpuUsage, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveEntry=archiveEntry, emHaSyncFailed=emHaSyncFailed, emDeviceList=emDeviceList, emDeviceImpaired=emDeviceImpaired, emScheduledArchiveFailed=emScheduledArchiveFailed, imageDescription=imageDescription, PYSNMP_MODULE_ID=enterpriseManagement, emVersion=emVersion, emAlertObjects=emAlertObjects, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceStandbyMode=emDeviceStandbyMode, archiveDescription=archiveDescription, emDevices=emDevices, emStatsCollectionRateCap=emStatsCollectionRateCap, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceGroups=emDeviceGroups, groupNumber=groupNumber, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emPerformanceStorageDays=emPerformanceStorageDays, emAlerts=emAlerts, emMemoryUsage=emMemoryUsage, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emHotfixInstallFailed=emHotfixInstallFailed, deviceEntry=deviceEntry, emDiskUsage=emDiskUsage, groupEntry=groupEntry, imageEntryTable=imageEntryTable, emASMSigInstallComplete=emASMSigInstallComplete, emImages=emImages, emSchedBackupFailed=emSchedBackupFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emHotfixInstallComplete=emHotfixInstallComplete, emPerformanceStorageCap=emPerformanceStorageCap, emRefreshInterval=emRefreshInterval, emArchives=emArchives, emSoftwareInstallComplete=emSoftwareInstallComplete)
