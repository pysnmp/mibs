...
enterprises, Counter32, Bits, Integer32, ObjectIdentity, Unsigned32, MibIdentifier, Gauge32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, NotificationType, Opaque, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Bits", "Integer32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "NotificationType", "Opaque", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emASMSigInstallComplete=emASMSigInstallComplete, emDeviceImpaired=emDeviceImpaired, archiveTimeStamp=archiveTimeStamp, emAlert=emAlert, archiveFilename=archiveFilename, emImages=emImages, imageDescription=imageDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, archiveNumber=archiveNumber, imageEntry=imageEntry, archiveProduct=archiveProduct, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigUpdateFailed=emASMSigUpdateFailed, emDeviceGroups=emDeviceGroups, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjects=emAlertObjects, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emSchedBackupFailed=emSchedBackupFailed, emAlertConfigObjects=emAlertConfigObjects, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceOfflineMode=emDeviceOfflineMode, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceUnreachable=emDeviceUnreachable, emCpuUsage=emCpuUsage, emAlertObjMsg=emAlertObjMsg, emDiskUsage=emDiskUsage, emAlerts=emAlerts, groupEntry=groupEntry, imageNumber=imageNumber, emHotfixInstallComplete=emHotfixInstallComplete, emCertificateExpiration=emCertificateExpiration, emPerformanceStorageCap=emPerformanceStorageCap, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageEntryTable=imageEntryTable, enterpriseManagement=enterpriseManagement, emGlobals=emGlobals, emScheduledArchiveFailed=emScheduledArchiveFailed, emArchives=emArchives, deviceAddress=deviceAddress, archiveDescription=archiveDescription, deviceEntryTable=deviceEntryTable, groupDescription=groupDescription, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceClockSkew=emDeviceClockSkew, emHaSyncFailed=emHaSyncFailed, emServiceContractExpiry=emServiceContractExpiry, emDeviceConfigSync=emDeviceConfigSync, archiveVersion=archiveVersion, deviceNumber=deviceNumber, deviceAddressType=deviceAddressType, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, archiveSourceDevice=archiveSourceDevice, deviceName=deviceName, emPerformanceStorageDays=emPerformanceStorageDays, emDevices=emDevices, groupEntryTable=groupEntryTable, emStatsCollectionRateCap=emStatsCollectionRateCap, deviceEntry=deviceEntry, emGatherServiceContractFailure=emGatherServiceContractFailure, archiveEntryTable=archiveEntryTable, imageVersion=imageVersion, emASMSigInstallFailed=emASMSigInstallFailed, emDeviceList=emDeviceList, groupNumber=groupNumber, emVersion=emVersion, groupName=groupName, archiveEntry=archiveEntry, emPerformanceThreshold=emPerformanceThreshold, emMemoryUsage=emMemoryUsage, emDeviceActiveMode=emDeviceActiveMode, emRefreshInterval=emRefreshInterval, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emSoftwareInstallComplete=emSoftwareInstallComplete, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete)
