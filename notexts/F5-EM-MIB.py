...
Integer32, Opaque, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, Gauge32, ModuleIdentity, NotificationType, Counter32, IpAddress, Unsigned32, Counter64, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Opaque", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "Gauge32", "ModuleIdentity", "NotificationType", "Counter32", "IpAddress", "Unsigned32", "Counter64", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("F5-EM-MIB", emArchives=emArchives, archiveFilename=archiveFilename, emVersion=emVersion, archiveEntry=archiveEntry, emDeviceConfigSync=emDeviceConfigSync, imageEntryTable=imageEntryTable, emPerformanceStorageDays=emPerformanceStorageDays, groupDescription=groupDescription, imageDescription=imageDescription, emDeviceActiveMode=emDeviceActiveMode, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emAlertObjMsg=emAlertObjMsg, archiveVersion=archiveVersion, deviceName=deviceName, emDeviceGroups=emDeviceGroups, emHotfixInstallComplete=emHotfixInstallComplete, archiveDescription=archiveDescription, deviceEntryTable=deviceEntryTable, emDeviceStandbyMode=emDeviceStandbyMode, emHaSyncFailed=emHaSyncFailed, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emDeviceOfflineMode=emDeviceOfflineMode, emServiceContractExpiry=emServiceContractExpiry, groupEntryTable=groupEntryTable, emAlertObjects=emAlertObjects, archiveSourceDevice=archiveSourceDevice, emPerformanceThreshold=emPerformanceThreshold, emCpuUsage=emCpuUsage, emDeviceList=emDeviceList, emRefreshInterval=emRefreshInterval, emImages=emImages, emStatsCollectionRateCap=emStatsCollectionRateCap, PYSNMP_MODULE_ID=enterpriseManagement, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, groupNumber=groupNumber, emASMSigInstallFailed=emASMSigInstallFailed, groupEntry=groupEntry, archiveTimeStamp=archiveTimeStamp, emDeviceImpaired=emDeviceImpaired, emAlertConfigObjects=emAlertConfigObjects, emDeviceUnreachable=emDeviceUnreachable, deviceAddress=deviceAddress, emSoftwareInstallComplete=emSoftwareInstallComplete, deviceNumber=deviceNumber, emPerformanceStorageCap=emPerformanceStorageCap, emCertificateExpiration=emCertificateExpiration, imageNumber=imageNumber, archiveNumber=archiveNumber, groupName=groupName, emMemoryUsage=emMemoryUsage, emAlerts=emAlerts, archiveEntryTable=archiveEntryTable, emHotfixInstallFailed=emHotfixInstallFailed, emASMSigUpdateFailed=emASMSigUpdateFailed, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, imageEntry=imageEntry, emDiskUsage=emDiskUsage, archiveProduct=archiveProduct, emScheduledArchiveFailed=emScheduledArchiveFailed, enterpriseManagement=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, emDevices=emDevices, emSchedBackupFailed=emSchedBackupFailed, emGatherServiceContractFailure=emGatherServiceContractFailure, emRaidDriveFailureDetected=emRaidDriveFailureDetected, deviceEntry=deviceEntry, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emAlert=emAlert, emGlobals=emGlobals, emASMSigInstallComplete=emASMSigInstallComplete, imageVersion=imageVersion, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, deviceAddressType=deviceAddressType)
