...
iso, Unsigned32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, TimeTicks, Opaque, MibIdentifier, IpAddress, Counter64, enterprises, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "Opaque", "MibIdentifier", "IpAddress", "Counter64", "enterprises", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("F5-EM-MIB", emDeviceList=emDeviceList, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emPerformanceStorageCap=emPerformanceStorageCap, deviceEntryTable=deviceEntryTable, emVersion=emVersion, deviceAddressType=deviceAddressType, emStatsCollectionRateCap=emStatsCollectionRateCap, emSoftwareInstallFailed=emSoftwareInstallFailed, deviceNumber=deviceNumber, emDevices=emDevices, groupEntryTable=groupEntryTable, emDiskUsage=emDiskUsage, emDeviceGroups=emDeviceGroups, emDeviceUnreachable=emDeviceUnreachable, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceThreshold=emPerformanceThreshold, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emDeviceClockSkew=emDeviceClockSkew, emSchedBackupFailed=emSchedBackupFailed, archiveVersion=archiveVersion, emSoftwareInstallComplete=emSoftwareInstallComplete, emServiceContractExpiry=emServiceContractExpiry, emDeviceActiveMode=emDeviceActiveMode, emAlertObjMsg=emAlertObjMsg, emHotfixInstallFailed=emHotfixInstallFailed, imageVersion=imageVersion, archiveTimeStamp=archiveTimeStamp, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emScheduledArchiveFailed=emScheduledArchiveFailed, emArchives=emArchives, emAlerts=emAlerts, enterpriseManagement=enterpriseManagement, emImages=emImages, emDeviceStandbyMode=emDeviceStandbyMode, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emGatherServiceContractFailure=emGatherServiceContractFailure, groupNumber=groupNumber, imageEntryTable=imageEntryTable, PYSNMP_MODULE_ID=enterpriseManagement, archiveNumber=archiveNumber, emDeviceConfigSync=emDeviceConfigSync, groupEntry=groupEntry, emDeviceImpaired=emDeviceImpaired, emRefreshInterval=emRefreshInterval, emCertificateExpiration=emCertificateExpiration, deviceEntry=deviceEntry, emGlobals=emGlobals, emPerformanceStorageDays=emPerformanceStorageDays, deviceAddress=deviceAddress, deviceName=deviceName, groupName=groupName, emStatsDBConnectivityLost=emStatsDBConnectivityLost, imageDescription=imageDescription, emCpuUsage=emCpuUsage, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, archiveSourceDevice=archiveSourceDevice, archiveFilename=archiveFilename, emASMSigUpdateFailed=emASMSigUpdateFailed, groupDescription=groupDescription, emAlertObjects=emAlertObjects, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emASMSigInstallFailed=emASMSigInstallFailed, imageEntry=imageEntry, imageNumber=imageNumber, archiveEntryTable=archiveEntryTable, archiveProduct=archiveProduct, archiveEntry=archiveEntry, emHotfixInstallComplete=emHotfixInstallComplete, emHaSyncFailed=emHaSyncFailed, archiveDescription=archiveDescription, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceOfflineMode=emDeviceOfflineMode, emAlertConfigObjects=emAlertConfigObjects, emAlert=emAlert, emMemoryUsage=emMemoryUsage)
