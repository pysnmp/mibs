...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, iso, NotificationType, Integer32, ObjectIdentity, Counter64, MibIdentifier, Opaque, Bits, TimeTicks, IpAddress, Unsigned32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "iso", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "MibIdentifier", "Opaque", "Bits", "TimeTicks", "IpAddress", "Unsigned32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("F5-EM-MIB", emCertificateExpiration=emCertificateExpiration, enterpriseManagement=enterpriseManagement, archiveEntry=archiveEntry, emMemoryUsage=emMemoryUsage, imageNumber=imageNumber, emDeviceUnreachable=emDeviceUnreachable, emPerformanceThreshold=emPerformanceThreshold, emDeviceOfflineMode=emDeviceOfflineMode, groupDescription=groupDescription, emHaSyncFailed=emHaSyncFailed, emASMSigInstallFailed=emASMSigInstallFailed, deviceEntry=deviceEntry, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emAlert=emAlert, emAlertConfigObjects=emAlertConfigObjects, archiveSourceDevice=archiveSourceDevice, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emASMSigUpdateFailed=emASMSigUpdateFailed, imageDescription=imageDescription, emAlertObjMsg=emAlertObjMsg, emPerformanceStorageDays=emPerformanceStorageDays, emScheduledArchiveFailed=emScheduledArchiveFailed, emVersion=emVersion, groupEntryTable=groupEntryTable, deviceEntryTable=deviceEntryTable, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveNumber=archiveNumber, groupName=groupName, emASMSigUpdateAvailable=emASMSigUpdateAvailable, deviceNumber=deviceNumber, emASMSigInstallComplete=emASMSigInstallComplete, emDeviceImpaired=emDeviceImpaired, emGatherServiceContractFailure=emGatherServiceContractFailure, emHotfixInstallFailed=emHotfixInstallFailed, emAlertObjects=emAlertObjects, archiveVersion=archiveVersion, emDeviceGroups=emDeviceGroups, PYSNMP_MODULE_ID=enterpriseManagement, emDeviceClockSkew=emDeviceClockSkew, emDiskUsage=emDiskUsage, emPerformanceStorageCap=emPerformanceStorageCap, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emSoftwareInstallFailed=emSoftwareInstallFailed, deviceName=deviceName, emSchedBackupFailed=emSchedBackupFailed, groupEntry=groupEntry, archiveFilename=archiveFilename, deviceAddress=deviceAddress, emDeviceList=emDeviceList, emCpuUsage=emCpuUsage, emDeviceStandbyMode=emDeviceStandbyMode, archiveProduct=archiveProduct, emImages=emImages, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emArchives=emArchives, imageVersion=imageVersion, emRefreshInterval=emRefreshInterval, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageEntry=imageEntry, archiveTimeStamp=archiveTimeStamp, deviceAddressType=deviceAddressType, emDeviceActiveMode=emDeviceActiveMode, emGlobals=emGlobals, emStatsCollectionRateCap=emStatsCollectionRateCap, groupNumber=groupNumber, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, emAlerts=emAlerts, imageEntryTable=imageEntryTable, emHotfixInstallComplete=emHotfixInstallComplete, emServiceContractExpiry=emServiceContractExpiry, emDevices=emDevices, archiveDescription=archiveDescription, emDeviceConfigSync=emDeviceConfigSync)
