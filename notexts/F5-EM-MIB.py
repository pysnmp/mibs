...
Bits, MibIdentifier, ObjectIdentity, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Opaque, Counter32, NotificationType, Gauge32, Counter64, Unsigned32, IpAddress, ModuleIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "ObjectIdentity", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Opaque", "Counter32", "NotificationType", "Gauge32", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertConfigObjects=emAlertConfigObjects, enterpriseManagement=enterpriseManagement, imageNumber=imageNumber, deviceAddressType=deviceAddressType, emPerformanceStorageDays=emPerformanceStorageDays, emRefreshInterval=emRefreshInterval, archiveNumber=archiveNumber, emPerformanceThreshold=emPerformanceThreshold, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emHotfixInstallFailed=emHotfixInstallFailed, groupName=groupName, emHaSyncFailed=emHaSyncFailed, emMaxConcurrentUpdates=emMaxConcurrentUpdates, emPerformanceStorageCap=emPerformanceStorageCap, emServiceContractExpiry=emServiceContractExpiry, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceNumber=deviceNumber, deviceAddress=deviceAddress, emASMSigInstallFailed=emASMSigInstallFailed, emAlertObjects=emAlertObjects, deviceEntry=deviceEntry, emArchives=emArchives, emSoftwareInstallFailed=emSoftwareInstallFailed, archiveSourceDevice=archiveSourceDevice, archiveVersion=archiveVersion, emDeviceImpaired=emDeviceImpaired, emAlerts=emAlerts, emCpuUsage=emCpuUsage, emASMSigInstallComplete=emASMSigInstallComplete, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emDeviceOfflineMode=emDeviceOfflineMode, groupEntry=groupEntry, emScheduledArchiveFailed=emScheduledArchiveFailed, emDeviceConfigSync=emDeviceConfigSync, emDeviceClockSkew=emDeviceClockSkew, imageEntry=imageEntry, archiveEntry=archiveEntry, emDiskUsage=emDiskUsage, emDeviceStandbyMode=emDeviceStandbyMode, emASMSigUpdateFailed=emASMSigUpdateFailed, groupDescription=groupDescription, archiveTimeStamp=archiveTimeStamp, emDeviceGroups=emDeviceGroups, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emDeviceList=emDeviceList, imageVersion=imageVersion, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emImages=emImages, emSoftwareInstallComplete=emSoftwareInstallComplete, archiveProduct=archiveProduct, emMemoryUsage=emMemoryUsage, emAlert=emAlert, emVersion=emVersion, emCertificateExpiration=emCertificateExpiration, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceUnreachable=emDeviceUnreachable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored, groupNumber=groupNumber, imageDescription=imageDescription, archiveDescription=archiveDescription, emASMSigUpdateAvailable=emASMSigUpdateAvailable, emSchedBackupFailed=emSchedBackupFailed, emHotfixInstallComplete=emHotfixInstallComplete, deviceEntryTable=deviceEntryTable, archiveFilename=archiveFilename, groupEntryTable=groupEntryTable, emGlobals=emGlobals, archiveEntryTable=archiveEntryTable, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, imageEntryTable=imageEntryTable, emAlertObjMsg=emAlertObjMsg, emDeviceActiveMode=emDeviceActiveMode, emDevices=emDevices, deviceName=deviceName, PYSNMP_MODULE_ID=enterpriseManagement)
