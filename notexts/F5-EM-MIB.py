...
TimeTicks, Bits, ObjectIdentity, Integer32, Unsigned32, Counter32, iso, Gauge32, ModuleIdentity, Counter64, NotificationType, IpAddress, Opaque, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "Counter32", "iso", "Gauge32", "ModuleIdentity", "Counter64", "NotificationType", "IpAddress", "Opaque", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("F5-EM-MIB", emAlertObjMsg=emAlertObjMsg, deviceAddressType=deviceAddressType, deviceEntryTable=deviceEntryTable, emAlertObjects=emAlertObjects, emHotfixInstallFailed=emHotfixInstallFailed, emDeviceActiveMode=emDeviceActiveMode, emGatherServiceContractFailure=emGatherServiceContractFailure, deviceEntry=deviceEntry, emSchedBackupFailed=emSchedBackupFailed, emStatsCollectionRateCap=emStatsCollectionRateCap, emDeviceStandbyMode=emDeviceStandbyMode, archiveDescription=archiveDescription, groupEntryTable=groupEntryTable, deviceName=deviceName, archiveEntry=archiveEntry, emDeviceImpaired=emDeviceImpaired, emCpuUsage=emCpuUsage, emDeviceConfigSync=emDeviceConfigSync, archiveSourceDevice=archiveSourceDevice, emPerformanceThreshold=emPerformanceThreshold, emDeviceGroups=emDeviceGroups, emArchives=emArchives, emAlerts=emAlerts, groupName=groupName, emDeviceConfigSettingChanged=emDeviceConfigSettingChanged, emDiskUsage=emDiskUsage, imageVersion=imageVersion, imageEntry=imageEntry, archiveVersion=archiveVersion, groupNumber=groupNumber, emHotfixInstallComplete=emHotfixInstallComplete, archiveNumber=archiveNumber, emDeviceClockSkew=emDeviceClockSkew, imageNumber=imageNumber, emCertificateExpiration=emCertificateExpiration, emDeviceForcedOfflineMode=emDeviceForcedOfflineMode, emSoftwareInstallFailed=emSoftwareInstallFailed, emDeviceOfflineMode=emDeviceOfflineMode, emImages=emImages, emStatsDBConnectivityLost=emStatsDBConnectivityLost, emScheduledArchiveFailed=emScheduledArchiveFailed, emVersion=emVersion, emPerformanceStorageDays=emPerformanceStorageDays, imageDescription=imageDescription, emASMSigInstallComplete=emASMSigInstallComplete, emRaidDriveFailureDetected=emRaidDriveFailureDetected, emDeviceUnreachable=emDeviceUnreachable, emHaSyncFailed=emHaSyncFailed, groupEntry=groupEntry, emAlertConfigObjects=emAlertConfigObjects, deviceNumber=deviceNumber, archiveTimeStamp=archiveTimeStamp, archiveFilename=archiveFilename, emMemoryUsage=emMemoryUsage, emASMSigInstallFailed=emASMSigInstallFailed, emAlert=emAlert, emSoftwareInstallComplete=emSoftwareInstallComplete, emASMSigUpdateAvailable=emASMSigUpdateAvailable, PYSNMP_MODULE_ID=enterpriseManagement, emRaidDriveRebuildComplete=emRaidDriveRebuildComplete, emPerformanceStorageCap=emPerformanceStorageCap, archiveProduct=archiveProduct, emServiceContractExpiry=emServiceContractExpiry, enterpriseManagement=enterpriseManagement, emMaxConcurrentUpdates=emMaxConcurrentUpdates, groupDescription=groupDescription, emDevices=emDevices, imageEntryTable=imageEntryTable, emASMSigUpdateFailed=emASMSigUpdateFailed, emRefreshInterval=emRefreshInterval, emDeviceList=emDeviceList, emGlobals=emGlobals, deviceAddress=deviceAddress, archiveEntryTable=archiveEntryTable, emStatsDBConnectivityRestored=emStatsDBConnectivityRestored)
