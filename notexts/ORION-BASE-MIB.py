...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcAlarmEventCategory=dcAlarmEventCategory, systemInfoGroup=systemInfoGroup, powerLimitationTableGroup=powerLimitationTableGroup, dcRectifierGroupName=dcRectifierGroupName, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcTempCompType=dcTempCompType, dcStartTemp=dcStartTemp, dcEnableUsTempComp=dcEnableUsTempComp, controllerBasicCompl=controllerBasicCompl, dcExpectedBackupTime=dcExpectedBackupTime, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcTempComp=dcTempComp, dcNumberRectifiersFailure=dcNumberRectifiersFailure, rectifierTableGroup=rectifierTableGroup, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifierIndex=dcRectifierIndex, dcMeasurement=dcMeasurement, dcUsys20=dcUsys20, dcUsMax=dcUsMax, dcRunawayVoltage=dcRunawayVoltage, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryStringIndex=dcBatteryStringIndex, dcMeterPanel=dcMeterPanel, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcRectifierGroupIndex=dcRectifierGroupIndex, batteryGroup=batteryGroup, systemUrgentAlarm=systemUrgentAlarm, genericAlarmTableGroup=genericAlarmTableGroup, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestInterval=dcBatteryTestInterval, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBoostChargeVoltage=dcBoostChargeVoltage, dcPowerLimitationTable=dcPowerLimitationTable, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcAlarmTable=dcAlarmTable, dcBatteryTestType=dcBatteryTestType, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBoostChargeIstart=dcBoostChargeIstart, systemCriticalAlarm=systemCriticalAlarm, dcRectifierStatus=dcRectifierStatus, dcSoftwareVersion=dcSoftwareVersion, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, defaultLogEventTableGroup=defaultLogEventTableGroup, dcSiteName=dcSiteName, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcMisc=dcMisc, dcEqualize=dcEqualize, dcRectifierEntry=dcRectifierEntry, dcMeasurementName=dcMeasurementName, dcRectifierFunctions=dcRectifierFunctions, dcSlope=dcSlope, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestTempTo=dcBatteryTestTempTo, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcBoostChargeIstop=dcBoostChargeIstop, dcTempSupervision=dcTempSupervision, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBatteryTemperature=dcBatteryTemperature, dcLowStartTemp=dcLowStartTemp, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcBatteryStringTable=dcBatteryStringTable, dcHighTempHyst=dcHighTempHyst, alarmTableGroup=alarmTableGroup, dcMeasurementIndex=dcMeasurementIndex, dcBatteryTestResult=dcBatteryTestResult, dcBatteryTestControl=dcBatteryTestControl, dcStopTemp=dcStopTemp, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, eventHistoryTableGroup=eventHistoryTableGroup, controllerEvents=controllerEvents, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcPowerLimitationEventName=dcPowerLimitationEventName, dcUaMax=dcUaMax, dcHighTemp=dcHighTemp, dcEventHistoryIndex=dcEventHistoryIndex, dcBoostChargeParameter=dcBoostChargeParameter, dcGenericAlarmEntry=dcGenericAlarmEntry, dcControlEventIdentifier=dcControlEventIdentifier, controllerConfs=controllerConfs, dcFloatCharge=dcFloatCharge, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBoostChargeType=dcBoostChargeType, controllerEventsV2=controllerEventsV2, dcHysteresis=dcHysteresis, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEfficiencyCycling=dcEfficiencyCycling, dcEqualizeControl=dcEqualizeControl, controllerEventObjects=controllerEventObjects, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcRectifierGroupTable=dcRectifierGroupTable, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBatteryTestResults=dcBatteryTestResults, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcHighStopVoltage=dcHighStopVoltage, dcControlEventValue=dcControlEventValue, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEventHistoryTable=dcEventHistoryTable, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBattery=dcBattery, dcTrapDestinationIp=dcTrapDestinationIp, dcAlarmIndex=dcAlarmIndex, dcSystemVoltage=dcSystemVoltage, meterPanelEventTableGroup=meterPanelEventTableGroup, dcDefaultLogEventTable=dcDefaultLogEventTable, dcSystemName=dcSystemName, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, notificationsGroup=notificationsGroup, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcControlEventEntry=dcControlEventEntry, dcMeterPanelEventTable=dcMeterPanelEventTable, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcMeasurementUnit=dcMeasurementUnit, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcAlarmEventValue=dcAlarmEventValue, dcDefaultLogEventEntry=dcDefaultLogEventEntry, orionBaseMibModule=orionBaseMibModule, dcLowStopVoltage=dcLowStopVoltage, dcBatteryCurrent=dcBatteryCurrent, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcNumberRectifiers=dcNumberRectifiers, dcPowerLimitationType=dcPowerLimitationType, dcRectifierCurrent=dcRectifierCurrent, dcPowerLimitationLimit=dcPowerLimitationLimit, dcHighStartTemp=dcHighStartTemp, dcGenericAlarmTable=dcGenericAlarmTable, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcSystemDateTime=dcSystemDateTime, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcBoostCharge=dcBoostCharge, dcMaxVoltage=dcMaxVoltage, dcEventHistoryEntry=dcEventHistoryEntry, dcPowerLimitationEntry=dcPowerLimitationEntry, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcBatteryTestDateTime=dcBatteryTestDateTime, dcUrgentAlarmValue=dcUrgentAlarmValue, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcDefaultLogEventLogged=dcDefaultLogEventLogged, trapDestinationTableGroup=trapDestinationTableGroup, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcMeterPanelEventName=dcMeterPanelEventName, dcAlarmEntry=dcAlarmEntry, dcBatteryParameter=dcBatteryParameter, systemMonitorGroup=systemMonitorGroup, dcCriticalAlarmName=dcCriticalAlarmName, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcSystemPower=dcSystemPower, dcBatteryTestUsupport=dcBatteryTestUsupport, dcGenericAlarmIndex=dcGenericAlarmIndex, systemNonUrgentAlarm=systemNonUrgentAlarm, dcSystemMonitor=dcSystemMonitor, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, batteryStringTableGroup=batteryStringTableGroup, measurementTableGroup=measurementTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcCriticalAlarmValue=dcCriticalAlarmValue, dcAlarmEventName=dcAlarmEventName, dcFileProcessingStatus=dcFileProcessingStatus, dcLvdIndex=dcLvdIndex, dcEventProcessingEventName=dcEventProcessingEventName, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEventProcessingEventTable=dcEventProcessingEventTable, orionBaseMib=orionBaseMib, dcBoD=dcBoD, dcHighTempSlope=dcHighTempSlope, dcMeasurementEntry=dcMeasurementEntry, miscGroup=miscGroup, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcLoadCurrent=dcLoadCurrent, dcTrapDestinationIndex=dcTrapDestinationIndex, dcEqualizeDuration=dcEqualizeDuration, dcMeterPanelEventValue=dcMeterPanelEventValue, dcConfig=dcConfig, dcRectifierIdentifier=dcRectifierIdentifier, controllerObjects=controllerObjects, dcRectifierTable=dcRectifierTable, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, PYSNMP_MODULE_ID=orionBaseMibModule, controllerCompl=controllerCompl, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcPowerLimitationIndex=dcPowerLimitationIndex, lvdTableGroup=lvdTableGroup, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeParameter=dcEqualizeParameter, dcMeasurementValue=dcMeasurementValue, dcEqualizeEnabled=dcEqualizeEnabled, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEvtCtrlCharge=dcEvtCtrlCharge, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestStatus=dcBatteryTestStatus, rectifierGroup=rectifierGroup, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcLowTempSlope=dcLowTempSlope, dcPowerLimitation=dcPowerLimitation, dcMinimumLoadStep=dcMinimumLoadStep, dcDefaultLogEventName=dcDefaultLogEventName, dcInputOutput=dcInputOutput, dcLvdEntry=dcLvdEntry, dcUrgentAlarmName=dcUrgentAlarmName, systemAlarmGroup=systemAlarmGroup, dcLvdTable=dcLvdTable, dcRectifier=dcRectifier, dcLvdName=dcLvdName, dcBatteryTest=dcBatteryTest, dcBatteryTestDuration=dcBatteryTestDuration, dcMeasurementTable=dcMeasurementTable, dcEqualizeVoltage=dcEqualizeVoltage, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcChargeState=dcChargeState, dcBatteryStringName=dcBatteryStringName, controlEventTableGroup=controlEventTableGroup, dcTrapDestinationPort=dcTrapDestinationPort, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcUsMin=dcUsMin, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEqualizeInterval=dcEqualizeInterval, dcRunawayTemp=dcRunawayTemp, dcBatteryStringEntry=dcBatteryStringEntry, dcControlEventName=dcControlEventName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEventProcessingEventType=dcEventProcessingEventType, dcBatteryTestParameter=dcBatteryTestParameter, dcMaximumLoadStep=dcMaximumLoadStep, dcEqualizeStatus=dcEqualizeStatus, dcTrapDestinationTable=dcTrapDestinationTable, dcBoostChargeStatus=dcBoostChargeStatus)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcUaMin=dcUaMin, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcCurrentLimit=dcCurrentLimit, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcControlEventIndex=dcControlEventIndex, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcSystemAlarms=dcSystemAlarms, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcMainsFailureAlarm=dcMainsFailureAlarm, controllerGroups=controllerGroups, dcSystemInfo=dcSystemInfo, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBoostChargeControl=dcBoostChargeControl, dcControlEventTable=dcControlEventTable)
