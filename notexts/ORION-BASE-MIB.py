...
Gauge32, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity, Bits, Counter64, iso, Unsigned32, enterprises, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity", "Bits", "Counter64", "iso", "Unsigned32", "enterprises", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEventProcessingEventTable=dcEventProcessingEventTable, dcEventHistoryTable=dcEventHistoryTable, batteryGroup=batteryGroup, dcBatteryTest=dcBatteryTest, dcGenericAlarmEntry=dcGenericAlarmEntry, systemCriticalAlarm=systemCriticalAlarm, dcHighTemp=dcHighTemp, alarmTableGroup=alarmTableGroup, batteryStringTableGroup=batteryStringTableGroup, systemNonUrgentAlarm=systemNonUrgentAlarm, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, orionBaseMibModule=orionBaseMibModule, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryStringEntry=dcBatteryStringEntry, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcLimitSwitchingTimes=dcLimitSwitchingTimes, rectifierGroup=rectifierGroup, genericAlarmTableGroup=genericAlarmTableGroup, dcMeterPanelEventName=dcMeterPanelEventName, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierIndex=dcRectifierIndex, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, orionBaseMib=orionBaseMib, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcLowStopVoltage=dcLowStopVoltage, miscGroup=miscGroup, dcAlarmTable=dcAlarmTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestResult=dcBatteryTestResult, dcTrapDestinationIndex=dcTrapDestinationIndex, dcControlEventIndex=dcControlEventIndex, dcTrapDestinationPort=dcTrapDestinationPort, dcPowerLimitationLimit=dcPowerLimitationLimit, dcMeasurementIndex=dcMeasurementIndex, dcHighTempSlope=dcHighTempSlope, dcCriticalAlarmName=dcCriticalAlarmName, dcGenericAlarmEventName=dcGenericAlarmEventName, dcDefaultLogEventTable=dcDefaultLogEventTable, dcUaMax=dcUaMax, dcExpectedBackupTime=dcExpectedBackupTime, eventHistoryTableGroup=eventHistoryTableGroup, dcSystemVoltage=dcSystemVoltage, dcBatteryTemperature=dcBatteryTemperature, dcUsMin=dcUsMin, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcSystemInfo=dcSystemInfo, controllerEventObjects=controllerEventObjects, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, systemMonitorGroup=systemMonitorGroup, defaultLogEventTableGroup=defaultLogEventTableGroup, dcBoostChargeStatus=dcBoostChargeStatus, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeasurementEntry=dcMeasurementEntry, dcTrapDestinationTable=dcTrapDestinationTable, dcEqualizeVoltage=dcEqualizeVoltage, dcBoostChargeIstart=dcBoostChargeIstart, dcHighStartTemp=dcHighStartTemp, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBoostChargeIstop=dcBoostChargeIstop, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEqualizeTimeLag=dcEqualizeTimeLag, dcConfig=dcConfig, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcUrgentAlarmName=dcUrgentAlarmName, dcAlarmEntry=dcAlarmEntry, dcPowerLimitationIndex=dcPowerLimitationIndex, dcControlEventEntry=dcControlEventEntry, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcMeterPanelEventEntry=dcMeterPanelEventEntry, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcLvdTable=dcLvdTable, dcDefaultLogEventName=dcDefaultLogEventName, dcPowerLimitationEntry=dcPowerLimitationEntry, systemInfoGroup=systemInfoGroup, dcMaxVoltage=dcMaxVoltage, dcBatteryTestParameter=dcBatteryTestParameter, dcAlarmEventValue=dcAlarmEventValue, dcLvdEntry=dcLvdEntry, dcPowerLimitationEventName=dcPowerLimitationEventName, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcSystemAlarms=dcSystemAlarms, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBoostChargeType=dcBoostChargeType, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestResults=dcBatteryTestResults, dcTempComp=dcTempComp, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcLowStartTemp=dcLowStartTemp, lvdTableGroup=lvdTableGroup, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, PYSNMP_MODULE_ID=orionBaseMibModule, dcBatteryTestUsupport=dcBatteryTestUsupport, dcRectifierGroupTable=dcRectifierGroupTable, dcLvdName=dcLvdName, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEqualizeControl=dcEqualizeControl, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEnableUsTempComp=dcEnableUsTempComp, dcMisc=dcMisc, dcEqualizeStatus=dcEqualizeStatus, dcPowerLimitationTable=dcPowerLimitationTable, dcEqualizeLeadTime=dcEqualizeLeadTime, dcUaMin=dcUaMin, dcHysteresis=dcHysteresis, trapDestinationTableGroup=trapDestinationTableGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, dcControlEventName=dcControlEventName, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcLowTempSlope=dcLowTempSlope, dcBattery=dcBattery, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEqualizeInterval=dcEqualizeInterval, dcEventHistoryEntry=dcEventHistoryEntry, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestInterval=dcBatteryTestInterval, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRectifierCurrent=dcRectifierCurrent, dcStopTemp=dcStopTemp, dcEqualizeEnabled=dcEqualizeEnabled, dcRectifierStatus=dcRectifierStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBatteryTestTempFrom=dcBatteryTestTempFrom, rectifierTableGroup=rectifierTableGroup, dcMeasurementTable=dcMeasurementTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcSoftwareVersion=dcSoftwareVersion, dcBatteryStringName=dcBatteryStringName, dcSlope=dcSlope, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBatteryStringTable=dcBatteryStringTable, dcTrapDestinationEntry=dcTrapDestinationEntry, dcGenericAlarmTable=dcGenericAlarmTable, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBatteryTestDateTime=dcBatteryTestDateTime, dcBatteryTestStatus=dcBatteryTestStatus, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcHighStopVoltage=dcHighStopVoltage, powerLimitationTableGroup=powerLimitationTableGroup, controllerGroups=controllerGroups, dcBatteryParameter=dcBatteryParameter, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, systemUrgentAlarm=systemUrgentAlarm, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryTestType=dcBatteryTestType, dcRunawayTemp=dcRunawayTemp, dcMinimumLoadStep=dcMinimumLoadStep, dcBoD=dcBoD, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, controlEventTableGroup=controlEventTableGroup, dcEqualize=dcEqualize, dcMeasurementName=dcMeasurementName, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcRectifierGroupIndex=dcRectifierGroupIndex, dcFileProcessingStatus=dcFileProcessingStatus, dcEfficiencyCycling=dcEfficiencyCycling, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcFloatCharge=dcFloatCharge, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcEventProcessingEventName=dcEventProcessingEventName, measurementTableGroup=measurementTableGroup, dcUrgentAlarmValue=dcUrgentAlarmValue, controllerEventsV2=controllerEventsV2, controllerEvents=controllerEvents, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierIdentifier=dcRectifierIdentifier, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanelEventTable=dcMeterPanelEventTable, dcControlEventTable=dcControlEventTable, dcMeasurement=dcMeasurement, dcSystemPower=dcSystemPower, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcControlEventIdentifier=dcControlEventIdentifier, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcInputOutput=dcInputOutput, dcAlarmEventName=dcAlarmEventName, dcBoostChargeControl=dcBoostChargeControl, dcRectifierFunctions=dcRectifierFunctions, controllerCompl=controllerCompl, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcEqualizeParameter=dcEqualizeParameter, dcMeasurementUnit=dcMeasurementUnit, dcChargeState=dcChargeState, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcEventHistoryIndex=dcEventHistoryIndex, notificationsGroup=notificationsGroup, dcEqualizeDuration=dcEqualizeDuration, dcRectifierGroupName=dcRectifierGroupName, dcSystemName=dcSystemName, dcTempSupervision=dcTempSupervision, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcRectifier=dcRectifier, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBatteryCurrent=dcBatteryCurrent, dcSiteName=dcSiteName, dcControlEventValue=dcControlEventValue, dcEventProcessingEventType=dcEventProcessingEventType, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierEntry=dcRectifierEntry, dcRunawayVoltage=dcRunawayVoltage, dcRectifierGroupEntry=dcRectifierGroupEntry, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBatteryStringIndex=dcBatteryStringIndex, dcSystemMonitor=dcSystemMonitor, dcSystemDateTime=dcSystemDateTime, dcEvtCtrlCharge=dcEvtCtrlCharge, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, systemAlarmGroup=systemAlarmGroup, controllerObjects=controllerObjects, dcMeasurementValue=dcMeasurementValue, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcLoadCurrent=dcLoadCurrent, dcHighTempHyst=dcHighTempHyst, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcGenericAlarmIndex=dcGenericAlarmIndex, dcPowerLimitationType=dcPowerLimitationType, dcUsMax=dcUsMax, dcBoostCharge=dcBoostCharge, dcStartTemp=dcStartTemp, dcCurrentLimit=dcCurrentLimit, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcMaximumLoadStep=dcMaximumLoadStep, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcMeterPanel=dcMeterPanel, controllerConfs=controllerConfs, dcBatteryTestDuration=dcBatteryTestDuration, dcAlarmIndex=dcAlarmIndex)
mibBuilder.exportSymbols("ORION-BASE-MIB", controllerBasicCompl=controllerBasicCompl, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcPowerLimitation=dcPowerLimitation, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcUsys20=dcUsys20, dcTrapDestinationIp=dcTrapDestinationIp, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryTestControl=dcBatteryTestControl, dcTempCompType=dcTempCompType, dcRectifierTable=dcRectifierTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcLvdIndex=dcLvdIndex)
