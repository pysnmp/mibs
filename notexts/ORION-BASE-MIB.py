...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcSystemVoltage=dcSystemVoltage, dcLvdTable=dcLvdTable, dcSystemPower=dcSystemPower, dcCurrentLimit=dcCurrentLimit, dcTotalBatteryCapacity=dcTotalBatteryCapacity, controllerEventsV2=controllerEventsV2, dcBatteryStringName=dcBatteryStringName, dcBatteryTestParameter=dcBatteryTestParameter, dcTrapDestinationPort=dcTrapDestinationPort, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcStartTemp=dcStartTemp, dcBatteryStringTable=dcBatteryStringTable, dcHighTempSlope=dcHighTempSlope, dcBatteryTestDuration=dcBatteryTestDuration, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEventHistoryEntry=dcEventHistoryEntry, dcUsys20=dcUsys20, dcBoostChargeIstop=dcBoostChargeIstop, dcBatteryTestStatus=dcBatteryTestStatus, dcMisc=dcMisc, PYSNMP_MODULE_ID=orionBaseMibModule, dcEqualizeInterval=dcEqualizeInterval, dcTempSupervision=dcTempSupervision, dcMainsFailureAlarm=dcMainsFailureAlarm, dcMeasurementTable=dcMeasurementTable, rectifierGroup=rectifierGroup, dcSystemInfo=dcSystemInfo, dcLvdIndex=dcLvdIndex, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierGroupTable=dcRectifierGroupTable, defaultLogEventTableGroup=defaultLogEventTableGroup, measurementTableGroup=measurementTableGroup, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeTimeLag=dcEqualizeTimeLag, dcAlarmIndex=dcAlarmIndex, dcExpectedBackupTime=dcExpectedBackupTime, dcBoostChargeIstart=dcBoostChargeIstart, dcMaxVoltage=dcMaxVoltage, dcUrgentAlarmValue=dcUrgentAlarmValue, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBatteryTestInterval=dcBatteryTestInterval, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, controllerConfs=controllerConfs, dcEqualizeVoltage=dcEqualizeVoltage, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcInputOutput=dcInputOutput, dcConfig=dcConfig, dcControlEventIdentifier=dcControlEventIdentifier, dcControlEventIndex=dcControlEventIndex, dcSystemAlarms=dcSystemAlarms, dcRunawayTemp=dcRunawayTemp, dcLvdName=dcLvdName, genericAlarmTableGroup=genericAlarmTableGroup, dcNumberRectifiers=dcNumberRectifiers, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierIdentifier=dcRectifierIdentifier, dcAlarmTable=dcAlarmTable, dcAlarmEventName=dcAlarmEventName, dcFloatCharge=dcFloatCharge, dcEqualizeControl=dcEqualizeControl, dcEqualizeDuration=dcEqualizeDuration, rectifierTableGroup=rectifierTableGroup, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, orionBaseMibModule=orionBaseMibModule, dcAlarmEventCategory=dcAlarmEventCategory, dcLvdEntry=dcLvdEntry, dcMaximumLoadStep=dcMaximumLoadStep, dcEqualize=dcEqualize, dcLossOfBackupTime=dcLossOfBackupTime, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcHysteresis=dcHysteresis, dcBatteryTest=dcBatteryTest, dcPowerLimitationIndex=dcPowerLimitationIndex, dcMeasurementIndex=dcMeasurementIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, controllerCompl=controllerCompl, dcNumberUrgentAlarms=dcNumberUrgentAlarms, systemAlarmGroup=systemAlarmGroup, eventProcessingEventTableGroup=eventProcessingEventTableGroup, controllerObjects=controllerObjects, dcBatteryTestControl=dcBatteryTestControl, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcControlEventEntry=dcControlEventEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcUsMax=dcUsMax, dcBatteryTestDateTime=dcBatteryTestDateTime, dcControlEventTable=dcControlEventTable, dcAlarmEntry=dcAlarmEntry, dcBatteryParameter=dcBatteryParameter, dcEventProcessingEventTable=dcEventProcessingEventTable, dcMeterPanel=dcMeterPanel, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, orionBaseMib=orionBaseMib, dcEqualizeLeadTime=dcEqualizeLeadTime, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, controllerEvents=controllerEvents, dcMeterPanelEventName=dcMeterPanelEventName, batteryGroup=batteryGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcLowTempSlope=dcLowTempSlope, dcLowStartTemp=dcLowStartTemp, powerLimitationTableGroup=powerLimitationTableGroup, dcBoostChargeType=dcBoostChargeType, dcGenericAlarmTable=dcGenericAlarmTable, dcTempCompType=dcTempCompType, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcDefaultLogEventName=dcDefaultLogEventName, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcBatteryTestResults=dcBatteryTestResults, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, controllerGroups=controllerGroups, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, notificationsGroup=notificationsGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, miscGroup=miscGroup, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcTrapDestinationIndex=dcTrapDestinationIndex, trapDestinationTableGroup=trapDestinationTableGroup, dcRunawayVoltage=dcRunawayVoltage, dcCriticalAlarmName=dcCriticalAlarmName, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcTempComp=dcTempComp, dcEvtCtrlCharge=dcEvtCtrlCharge, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEqualizeStatus=dcEqualizeStatus, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, rectifierGroupTableGroup=rectifierGroupTableGroup, alarmTableGroup=alarmTableGroup, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierIndex=dcRectifierIndex, dcRectifierGroupIndex=dcRectifierGroupIndex, dcSystemMonitor=dcSystemMonitor, dcHighTemp=dcHighTemp, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeasurement=dcMeasurement, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcPowerLimitationEventName=dcPowerLimitationEventName, dcTrapDestinationTable=dcTrapDestinationTable, dcEventHistoryTable=dcEventHistoryTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcEventProcessingEventName=dcEventProcessingEventName, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcAlarmEventValue=dcAlarmEventValue, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcPowerLimitationTable=dcPowerLimitationTable, dcBatteryTestUsupport=dcBatteryTestUsupport, dcRectifierEntry=dcRectifierEntry, dcRectifierFunctions=dcRectifierFunctions, dcGenericAlarmEntry=dcGenericAlarmEntry, dcTrapDestinationIp=dcTrapDestinationIp, meterPanelEventTableGroup=meterPanelEventTableGroup, dcUrgentAlarmName=dcUrgentAlarmName, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBoostChargeStatus=dcBoostChargeStatus, dcBattery=dcBattery, dcBatteryStringCapacity=dcBatteryStringCapacity, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryStringIndex=dcBatteryStringIndex, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcUaMax=dcUaMax, dcControlEventName=dcControlEventName, dcEqualizeParameter=dcEqualizeParameter, controllerBasicCompl=controllerBasicCompl, dcEqualizeEnabled=dcEqualizeEnabled, dcMeasurementValue=dcMeasurementValue, dcPowerLimitation=dcPowerLimitation, dcControlEventValue=dcControlEventValue, dcBatteryTestResult=dcBatteryTestResult, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcChargeState=dcChargeState, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestTempTo=dcBatteryTestTempTo, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryCurrent=dcBatteryCurrent, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEfficiencyCycling=dcEfficiencyCycling, dcBatteryStringEntry=dcBatteryStringEntry, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcMeasurementName=dcMeasurementName, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcLoadCurrent=dcLoadCurrent, batteryStringTableGroup=batteryStringTableGroup, dcBoostChargeControl=dcBoostChargeControl, dcRectifierTable=dcRectifierTable, dcSystemDateTime=dcSystemDateTime, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcUaMin=dcUaMin, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBoostCharge=dcBoostCharge, dcBoostChargeParameter=dcBoostChargeParameter, dcGenericAlarmIndex=dcGenericAlarmIndex, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierCurrent=dcRectifierCurrent, dcHighStopVoltage=dcHighStopVoltage, dcRectifier=dcRectifier, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcEventProcessingEventType=dcEventProcessingEventType, dcMeasurementEntry=dcMeasurementEntry, systemCriticalAlarm=systemCriticalAlarm, dcFileProcessingStatus=dcFileProcessingStatus, dcPowerLimitationLimit=dcPowerLimitationLimit, dcUsMin=dcUsMin, dcEventHistoryIndex=dcEventHistoryIndex, systemMonitorGroup=systemMonitorGroup, dcRectifierStatus=dcRectifierStatus, systemNonUrgentAlarm=systemNonUrgentAlarm, systemInfoGroup=systemInfoGroup, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcStopTemp=dcStopTemp, dcPowerLimitationType=dcPowerLimitationType, dcMeterPanelEventValue=dcMeterPanelEventValue, controllerEventObjects=controllerEventObjects, controlEventTableGroup=controlEventTableGroup, dcSiteName=dcSiteName, dcHighTempHyst=dcHighTempHyst, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBoD=dcBoD, dcMinimumLoadStep=dcMinimumLoadStep, lvdTableGroup=lvdTableGroup, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcCriticalAlarmValue=dcCriticalAlarmValue, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestType=dcBatteryTestType, dcSoftwareVersion=dcSoftwareVersion, eventHistoryTableGroup=eventHistoryTableGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcSystemName=dcSystemName, dcLowStopVoltage=dcLowStopVoltage, dcDefaultLogEventTable=dcDefaultLogEventTable, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeasurementUnit=dcMeasurementUnit, dcEventHistoryMessage=dcEventHistoryMessage, dcEnableUsTempComp=dcEnableUsTempComp, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcBatteryTemperature=dcBatteryTemperature, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcRectifierGroupName=dcRectifierGroupName, dcSlope=dcSlope, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration)
