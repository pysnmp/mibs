...
MibIdentifier, TimeTicks, ModuleIdentity, Counter64, NotificationType, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Counter32, ObjectIdentity, Gauge32, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter64", "NotificationType", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Counter32", "ObjectIdentity", "Gauge32", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcBatteryStringName=dcBatteryStringName, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcRectifierGroupTable=dcRectifierGroupTable, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcStartTemp=dcStartTemp, dcMeterPanelEventTable=dcMeterPanelEventTable, dcSystemDateTime=dcSystemDateTime, dcBatteryTestInterval=dcBatteryTestInterval, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcMisc=dcMisc, eventHistoryTableGroup=eventHistoryTableGroup, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcEventProcessingEventIndex=dcEventProcessingEventIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeControl=dcEqualizeControl, dcBoostCharge=dcBoostCharge, orionBaseMib=orionBaseMib, dcBatteryTestResult=dcBatteryTestResult, dcBatteryTestDuration=dcBatteryTestDuration, powerLimitationTableGroup=powerLimitationTableGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEventProcessingEventName=dcEventProcessingEventName, measurementTableGroup=measurementTableGroup, dcTrapDestinationEntry=dcTrapDestinationEntry, dcMeasurementUnit=dcMeasurementUnit, controllerEventsV2=controllerEventsV2, dcLowTempSlope=dcLowTempSlope, dcRectifierIndex=dcRectifierIndex, trapDestinationTableGroup=trapDestinationTableGroup, controllerEvents=controllerEvents, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBoostChargeType=dcBoostChargeType, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcMainsFailureAlarm=dcMainsFailureAlarm, dcCurrentLimit=dcCurrentLimit, dcTempComp=dcTempComp, dcUsys20=dcUsys20, dcUsMax=dcUsMax, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcAlarmEventName=dcAlarmEventName, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEfficiencyCycling=dcEfficiencyCycling, dcEqualizeVoltage=dcEqualizeVoltage, controllerEventObjects=controllerEventObjects, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcRectifierTable=dcRectifierTable, dcRectifierGroupName=dcRectifierGroupName, dcLvdDisconnectDelay=dcLvdDisconnectDelay, miscGroup=miscGroup, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcSystemAlarms=dcSystemAlarms, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, rectifierGroupTableGroup=rectifierGroupTableGroup, dcBatteryTest=dcBatteryTest, dcSiteName=dcSiteName, dcChargeState=dcChargeState, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcAlarmEventCategory=dcAlarmEventCategory, dcBoostChargeStatus=dcBoostChargeStatus, systemInfoGroup=systemInfoGroup, dcNumberRectifiers=dcNumberRectifiers, dcControlEventIdentifier=dcControlEventIdentifier, dcCriticalAlarmName=dcCriticalAlarmName, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, rectifierGroup=rectifierGroup, dcBattery=dcBattery, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryParameter=dcBatteryParameter, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcBoostChargeControl=dcBoostChargeControl, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcRectifierIdentifier=dcRectifierIdentifier, orionBaseMibModule=orionBaseMibModule, dcHighStartTemp=dcHighStartTemp, dcBatteryTemperature=dcBatteryTemperature, batteryGroup=batteryGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryTestResults=dcBatteryTestResults, dcRunawayVoltage=dcRunawayVoltage, dcHighTemp=dcHighTemp, dcAlarmIndex=dcAlarmIndex, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcControlEventName=dcControlEventName, meterPanelEventTableGroup=meterPanelEventTableGroup, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcEventHistoryEntry=dcEventHistoryEntry, dcControlEventIndex=dcControlEventIndex, dcSystemVoltage=dcSystemVoltage, genericAlarmTableGroup=genericAlarmTableGroup, controllerGroups=controllerGroups, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEqualizeDuration=dcEqualizeDuration, dcMeasurementTable=dcMeasurementTable, dcEqualizeParameter=dcEqualizeParameter, dcBatteryCurrent=dcBatteryCurrent, dcGenericAlarmEntry=dcGenericAlarmEntry, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcEqualizeInterval=dcEqualizeInterval, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcLossOfBackupTime=dcLossOfBackupTime, dcUrgentAlarmName=dcUrgentAlarmName, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcSoftwareVersion=dcSoftwareVersion, dcEventHistoryTable=dcEventHistoryTable, dcRectifierStatus=dcRectifierStatus, dcPowerLimitationEntry=dcPowerLimitationEntry, dcAlarmTable=dcAlarmTable, dcPowerLimitationEventName=dcPowerLimitationEventName, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBoostChargeVoltage=dcBoostChargeVoltage, dcRectifier=dcRectifier, dcDefaultLogEventTable=dcDefaultLogEventTable, dcMeasurementEntry=dcMeasurementEntry, systemUrgentAlarm=systemUrgentAlarm, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBatteryStringCapacity=dcBatteryStringCapacity, notificationsGroup=notificationsGroup, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcControlEventValue=dcControlEventValue, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBoD=dcBoD, dcEvtCtrlCharge=dcEvtCtrlCharge, dcPowerLimitationType=dcPowerLimitationType, dcControlEventEntry=dcControlEventEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, PYSNMP_MODULE_ID=orionBaseMibModule, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestDateTime=dcBatteryTestDateTime, dcPowerLimitation=dcPowerLimitation, dcEqualizeStatus=dcEqualizeStatus, alarmTableGroup=alarmTableGroup, dcLvdTable=dcLvdTable, dcEqualizeEnabled=dcEqualizeEnabled, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBatteryTestTempTo=dcBatteryTestTempTo, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcHighStopVoltage=dcHighStopVoltage, dcDefaultLogEventName=dcDefaultLogEventName, controlEventTableGroup=controlEventTableGroup, dcRectifierGroupEntry=dcRectifierGroupEntry, systemAlarmGroup=systemAlarmGroup, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBoostChargeParameter=dcBoostChargeParameter, dcTempSupervision=dcTempSupervision, dcMeasurementValue=dcMeasurementValue, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcSystemPower=dcSystemPower, dcTrapDestinationPort=dcTrapDestinationPort, lvdTableGroup=lvdTableGroup, dcTempCompType=dcTempCompType, controllerBasicCompl=controllerBasicCompl, dcAlarmEntry=dcAlarmEntry, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcEqualize=dcEqualize, dcControlEventTable=dcControlEventTable, controllerObjects=controllerObjects, dcFileProcessingStatus=dcFileProcessingStatus, defaultLogEventTableGroup=defaultLogEventTableGroup, dcMeterPanel=dcMeterPanel, dcBatteryStringIndex=dcBatteryStringIndex, dcMeasurement=dcMeasurement, dcMinimumLoadStep=dcMinimumLoadStep, dcEqualizeLeadTime=dcEqualizeLeadTime, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcMeasurementName=dcMeasurementName, dcSlope=dcSlope, dcLowStopVoltage=dcLowStopVoltage, dcBatteryTestType=dcBatteryTestType, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcAlarmEventValue=dcAlarmEventValue, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcPowerLimitationIndex=dcPowerLimitationIndex, dcLowStartTemp=dcLowStartTemp, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcPowerLimitationStatus=dcPowerLimitationStatus, dcCriticalAlarmValue=dcCriticalAlarmValue, dcMaximumLoadStep=dcMaximumLoadStep, dcPowerLimitationTable=dcPowerLimitationTable, dcUaMin=dcUaMin, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEnableUsTempComp=dcEnableUsTempComp, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcHighTempHyst=dcHighTempHyst, dcEventHistoryMessage=dcEventHistoryMessage, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcTrapDestinationIndex=dcTrapDestinationIndex, dcSystemMonitor=dcSystemMonitor, dcBoostChargeIstop=dcBoostChargeIstop, dcTrapDestinationIp=dcTrapDestinationIp, dcRectifierFunctions=dcRectifierFunctions, dcUaMax=dcUaMax, systemMonitorGroup=systemMonitorGroup, dcTrapDestinationTable=dcTrapDestinationTable, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcLvdEntry=dcLvdEntry, dcConfig=dcConfig, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcStopTemp=dcStopTemp, dcUrgentAlarmValue=dcUrgentAlarmValue, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, controllerConfs=controllerConfs, controllerCompl=controllerCompl, dcLoadCurrent=dcLoadCurrent, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcRunawayTemp=dcRunawayTemp, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBatteryTestControl=dcBatteryTestControl, dcGenericAlarmEventName=dcGenericAlarmEventName, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryTestStatus=dcBatteryTestStatus, dcMeasurementIndex=dcMeasurementIndex, dcBatteryStringTable=dcBatteryStringTable, dcSystemName=dcSystemName, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, rectifierTableGroup=rectifierTableGroup, dcExpectedBackupTime=dcExpectedBackupTime, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcEventHistoryIndex=dcEventHistoryIndex, dcEventProcessingEventType=dcEventProcessingEventType, dcUsMin=dcUsMin, dcMaxVoltage=dcMaxVoltage, dcSystemInfo=dcSystemInfo, systemCriticalAlarm=systemCriticalAlarm, dcMeterPanelEventName=dcMeterPanelEventName, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcHysteresis=dcHysteresis, dcHighTempSlope=dcHighTempSlope)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcRectifierEntry=dcRectifierEntry, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcLvdName=dcLvdName, batteryStringTableGroup=batteryStringTableGroup, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBatteryStringEntry=dcBatteryStringEntry, dcInputOutput=dcInputOutput, dcLvdIndex=dcLvdIndex, dcFloatCharge=dcFloatCharge, dcRectifierCurrent=dcRectifierCurrent, dcSystemVoltageSupervision=dcSystemVoltageSupervision)
