...
# Produced by pysmi-1.1.12 at Wed Jul  3 12:26:11 2024
...
ModuleIdentity, Counter32, Unsigned32, Counter64, Bits, MibIdentifier, NotificationType, ObjectIdentity, TimeTicks, Integer32, IpAddress, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "Unsigned32", "Counter64", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity", "TimeTicks", "Integer32", "IpAddress", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, FixedPoint1000=FixedPoint1000, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoEntry=npThermoEntry, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayTable=npRelayTable, npGsmTraps=npGsmTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapSafe=npRelHumTrapSafe, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npTrapInfo=npTrapInfo, npSmoke=npSmoke, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumValue=npRelHumValue, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npCurLoopTable=npCurLoopTable, npThermoTrapStatus=npThermoTrapStatus, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npSmokeStatus=npSmokeStatus, npCurLoopEntry=npCurLoopEntry, npSmokeMemo=npSmokeMemo, npGsmTrap=npGsmTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npThermoTable=npThermoTable, npSmokePower=npSmokePower, npRelHumEntry=npRelHumEntry, npThermoStatus=npThermoStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npGsmFailed=npGsmFailed, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopI=npCurLoopI, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopN=npCurLoopN, npSmokeTable=npSmokeTable, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTable=npRelHumTable, npResetStack=npResetStack, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npReboot=npReboot, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npIoTrapLineN=npIoTrapLineN, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npIoEntry=npIoEntry, npThermoTrapValue=npThermoTrapValue, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayStartReset=npRelayStartReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npIr=npIr, lightcom=lightcom, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh)
