...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:26:28 2021
...
Counter32, TimeTicks, Integer32, Unsigned32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, IpAddress, ObjectIdentity, MibIdentifier, Bits, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Integer32", "Unsigned32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "IpAddress", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermo=npThermo, npIoLevelOut=npIoLevelOut, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoop=npCurLoop, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMode=npRelayMode, npRelHumTrapSafe=npRelHumTrapSafe, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npSmokeEntry=npSmokeEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npRelayTable=npRelayTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTable=npIoTable, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmRegistration=npGsmRegistration, npRelHumidity=npRelHumidity, npGsm=npGsm, npCurLoopStatus=npCurLoopStatus, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumEntry=npRelHumEntry, npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npThermoTrapValue=npThermoTrapValue, npIrStatus=npIrStatus, npIrPlayCmd=npIrPlayCmd, npRelHumN=npRelHumN, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npThermoTrap=npThermoTrap, npRelHumTempStatus=npRelHumTempStatus, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIoLineN=npIoLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npSmokeTrap=npSmokeTrap, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npThermoLow=npThermoLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapR=npCurLoopTrapR, npIoTrap=npIoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTemp=npRelHumTrapTemp, npGsmFailed=npGsmFailed, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npIrCtrl=npIrCtrl, npTrapEmailTo=npTrapEmailTo, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoMemo=npThermoMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayN=npRelayN, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLineN=npIoTrapLineN, npIr=npIr, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npIoLevelIn=npIoLevelIn, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail)
