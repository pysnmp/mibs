...
Bits, ObjectIdentity, Gauge32, NotificationType, MibIdentifier, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, IpAddress, ModuleIdentity, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Gauge32", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "IpAddress", "ModuleIdentity", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapStatus=npThermoTrapStatus, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npGsmFailed=npGsmFailed, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npForcedReboot=npForcedReboot, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npRelayTable=npRelayTable, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npIoEntry=npIoEntry, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npRelHumTrapSafe=npRelHumTrapSafe, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapData=npRelHumTrapData, npCurLoopI=npCurLoopI, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npRelHumValue=npRelHumValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrap=npIoTrap, npRelayState=npRelayState, npIoTraps=npIoTraps, npIr=npIr, npRelHumStatus=npRelHumStatus, npThermoTrapValue=npThermoTrapValue, npIoLevelOut=npIoLevelOut, npSmokeReset=npSmokeReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeEntry=npSmokeEntry, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoPulseCounter=npIoPulseCounter, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npThermoEntry=npThermoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoLow=npThermoLow, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeMemo=npSmokeMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayStartReset=npRelayStartReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsm=npGsm, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npReboot=npReboot, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrap=npSmokeTrap, npIoTable=npIoTable, npIrStatus=npIrStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npIo=npIo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npSmokePower=npSmokePower, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmoke=npSmoke, npRelHumN=npRelHumN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npIrCtrl=npIrCtrl, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTraps=npSmokeTraps, npSmokeTable=npSmokeTable, npThermoValue=npThermoValue, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npIrReset=npIrReset, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapInfo=npTrapInfo, npThermoSensorN=npThermoSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3)
