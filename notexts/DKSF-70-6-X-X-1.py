...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:12:25 2021
...
enterprises, Gauge32, Bits, MibIdentifier, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, ModuleIdentity, IpAddress, Unsigned32, NotificationType, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Bits", "MibIdentifier", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Unsigned32", "NotificationType", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrap=npCurLoopTrap, npThermoStatus=npThermoStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npSoftReboot=npSoftReboot, npIo=npIo, npRelHumStatus=npRelHumStatus, npCurLoopPower=npCurLoopPower, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npIr=npIr, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoEntry=npThermoEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayEntry=npRelayEntry, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayState=npRelayState, npRelayTable=npRelayTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMode=npRelayMode, npIoTable=npIoTable, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npThermoSensorN=npThermoSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npCurLoopR=npCurLoopR, npReboot=npReboot, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapLow=npThermoTrapLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmInfo=npGsmInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrStatus=npIrStatus, npSmokeTable=npSmokeTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npRelayN=npRelayN, npRelHumTrapData=npRelHumTrapData, npSmokeEntry=npSmokeEntry, npRelHumTempValue=npRelHumTempValue, npIoLevelOut=npIoLevelOut, npThermoTrap=npThermoTrap, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmFailed=npGsmFailed, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapHigh=npThermoTrapHigh, npSmokeReset=npSmokeReset, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npIrPlayCmd=npIrPlayCmd, npSmokePower=npSmokePower, npCurLoop=npCurLoop, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo)
