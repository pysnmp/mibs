...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:42:34 2022
...
ObjectIdentity, Bits, NotificationType, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, enterprises, MibIdentifier, Unsigned32, ModuleIdentity, iso, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "NotificationType", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "enterprises", "MibIdentifier", "Unsigned32", "ModuleIdentity", "iso", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npSmokeTraps=npSmokeTraps, npCurLoopEntry=npCurLoopEntry, npCurLoop=npCurLoop, npThermoValue=npThermoValue, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmInfo=npGsmInfo, npIoTraps=npIoTraps, npSmokeTable=npSmokeTable, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumN=npRelHumN, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopPower=npCurLoopPower, npReboot=npReboot, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoEntry=npThermoEntry, npRelayStartReset=npRelayStartReset, npRelayMode=npRelayMode, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapSafe=npRelHumTrapSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLineN=npIoLineN, npForcedReboot=npForcedReboot, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npRelHumTrapFail=npRelHumTrapFail, npSmoke=npSmoke, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npThermoStatus=npThermoStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopTrap=npCurLoopTrap, lightcom=lightcom, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoLevelOut=npIoLevelOut, npRelHumidity=npRelHumidity, npGsm=npGsm, npGsmTraps=npGsmTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTraps=npThermoTraps, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapV=npCurLoopTrapV, npIoLevelIn=npIoLevelIn, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTrap=npGsmTrap, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npTrapInfo=npTrapInfo, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npRelHumTrapDataN=npRelHumTrapDataN, npThermoSensorN=npThermoSensorN, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoLow=npThermoLow, npRelayTable=npRelayTable, npGsmRegistration=npGsmRegistration, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLineN=npIoTrapLineN, npSmokePower=npSmokePower, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npGsmStrength=npGsmStrength, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrap=npIoTrap, npRelay=npRelay, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npIoTable=npIoTable, npSoftReboot=npSoftReboot, npIo=npIo)
