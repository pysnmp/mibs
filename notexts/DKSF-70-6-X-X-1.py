...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:33:47 2021
...
Bits, ModuleIdentity, TimeTicks, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, enterprises, Counter64, NotificationType, ObjectIdentity, Unsigned32, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "TimeTicks", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "enterprises", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npRelayState=npRelayState, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npSmokeSensorN=npSmokeSensorN, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempValue=npRelHumTempValue, npSmokeEntry=npSmokeEntry, npRelHumTrapData=npRelHumTrapData, npThermoSensorN=npThermoSensorN, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npGsmFailed=npGsmFailed, npSoftReboot=npSoftReboot, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npRelayMode=npRelayMode, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumTable=npRelHumTable, npThermoMemo=npThermoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrPlayCmd=npIrPlayCmd, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTraps=npSmokeTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npRelHumidity=npRelHumidity, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmoke=npSmoke, npIoMemo=npIoMemo, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npThermoLow=npThermoLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npGsmTrap=npGsmTrap, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIr=npIr, npCurLoopR=npCurLoopR, npIoLineN=npIoLineN, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npGsmRegistration=npGsmRegistration, npIoTrap=npIoTrap, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTable=npThermoTable, npGsmInfo=npGsmInfo, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npIrStatus=npIrStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npThermoValuePrecise=npThermoValuePrecise, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npIo=npIo, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npThermoEntry=npThermoEntry, npThermoTraps=npThermoTraps, lightcom=lightcom, npIoEntry=npIoEntry, npCurLoopTrap=npCurLoopTrap)
