...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:24:39 2022
...
NotificationType, ModuleIdentity, iso, IpAddress, Counter64, TimeTicks, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter32, Unsigned32, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "IpAddress", "Counter64", "TimeTicks", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npThermoTrapSensorN=npThermoTrapSensorN, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npRelayMode=npRelayMode, npIoEntry=npIoEntry, npReboot=npReboot, npIoTrap=npIoTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapLow=npThermoTrapLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, npSoftReboot=npSoftReboot, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, npSmokeSensorN=npSmokeSensorN, npRelHumN=npRelHumN, npRelHumTrap=npRelHumTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLineN=npIoLineN, npThermoHigh=npThermoHigh, npCurLoopPower=npCurLoopPower, npIo=npIo, npGsmInfo=npGsmInfo, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTable=npThermoTable, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIrStatus=npIrStatus, npSmokeStatus=npSmokeStatus, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, npIoTable=npIoTable, npSmokePower=npSmokePower, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopV=npCurLoopV, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoValuePrecise=npThermoValuePrecise, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopI=npCurLoopI, npResetStack=npResetStack, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelayEntry=npRelayEntry, npSmokeTraps=npSmokeTraps, npCurLoopR=npCurLoopR, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrCtrl=npIrCtrl, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIoTraps=npIoTraps, npGsmFailed=npGsmFailed, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npThermoValue=npThermoValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npThermoTraps=npThermoTraps, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumidity=npRelHumidity, npGsmStrength=npGsmStrength, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopEntry=npCurLoopEntry, npSmokeReset=npSmokeReset)
