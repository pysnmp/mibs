...
IpAddress, Bits, ModuleIdentity, Unsigned32, MibIdentifier, enterprises, TimeTicks, Counter32, iso, Gauge32, ObjectIdentity, Integer32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "MibIdentifier", "enterprises", "TimeTicks", "Counter32", "iso", "Gauge32", "ObjectIdentity", "Integer32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrap=npGsmTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npCurLoopN=npCurLoopN, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValuePrecise=npThermoValuePrecise, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npReboot=npReboot, npRelHumEntry=npRelHumEntry, npRelayTable=npRelayTable, npRelayMemo=npRelayMemo, npResetStack=npResetStack, npIr=npIr, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npThermoTrapHigh=npThermoTrapHigh, npCurLoopV=npCurLoopV, npIoLevelOut=npIoLevelOut, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTable=npSmokeTable, npIoEntry=npIoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmFailed=npGsmFailed, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npRelHumTrapSafe=npRelHumTrapSafe, npGsm=npGsm, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, npRelayEntry=npRelayEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTraps=npCurLoopTraps, npIrReset=npIrReset, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTraps=npGsmTraps, FixedPoint1000=FixedPoint1000, npGsmRegistration=npGsmRegistration, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npThermoSensorN=npThermoSensorN, lightcom=lightcom, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npRelayState=npRelayState, npRelayN=npRelayN, npCurLoopTrapR=npCurLoopTrapR, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoop=npCurLoop, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIo=npIo, npIoTable=npIoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, npRelay=npRelay, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTempValue=npRelHumTempValue, npCurLoopEntry=npCurLoopEntry, npIoTrapMemo=npIoTrapMemo, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo)
