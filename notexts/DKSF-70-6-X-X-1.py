...
Counter64, Unsigned32, Bits, ModuleIdentity, enterprises, Integer32, Gauge32, TimeTicks, NotificationType, IpAddress, Counter32, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "Bits", "ModuleIdentity", "enterprises", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "IpAddress", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapStatus=npThermoTrapStatus, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoop=npCurLoop, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npRelayStartReset=npRelayStartReset, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npCurLoopTrapV=npCurLoopTrapV, npIrReset=npIrReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopI=npCurLoopI, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npIoEntry=npIoEntry, npThermoSensorN=npThermoSensorN, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopEntry=npCurLoopEntry, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npIrCtrl=npIrCtrl, npThermoTrapPrefix=npThermoTrapPrefix, npGsmFailed=npGsmFailed, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npSmokeStatus=npSmokeStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrStatus=npIrStatus, npThermo=npThermo, npReboot=npReboot, npThermoTable=npThermoTable, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npGsmInfo=npGsmInfo, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npCurLoopStatus=npCurLoopStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npGsmStrength=npGsmStrength, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npIoLineN=npIoLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npRelayMode=npRelayMode, npRelHumValue=npRelHumValue, npIoTrapMemo=npIoTrapMemo, npGsmRegistration=npGsmRegistration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npIoTraps=npIoTraps, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeReset=npSmokeReset, npSmokeTrap=npSmokeTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLevelIn=npIoLevelIn, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npIo=npIo, npIr=npIr, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelayTable=npRelayTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo)
