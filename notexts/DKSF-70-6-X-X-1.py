...
# Produced by pysmi-1.1.12 at Wed May 29 07:20:37 2024
...
Gauge32, NotificationType, Bits, ObjectIdentity, TimeTicks, IpAddress, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, MibIdentifier, iso, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "MibIdentifier", "iso", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoPulseCounter=npIoPulseCounter, npGsmInfo=npGsmInfo, npGsmStrength=npGsmStrength, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTable=npRelHumTable, npRelHumTrapFail=npRelHumTrapFail, npIr=npIr, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npReboot=npReboot, npIoLineN=npIoLineN, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTable=npThermoTable, npRelHumTrap=npRelHumTrap, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumValue=npRelHumValue, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npSmokeStatus=npSmokeStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npThermoMemo=npThermoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeSensorN=npSmokeSensorN, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npIoTraps=npIoTraps, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npThermoLow=npThermoLow, lightcom=lightcom, npThermoTrapSensorN=npThermoTrapSensorN, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npTrapInfo=npTrapInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, npCurLoopI=npCurLoopI, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmoke=npSmoke, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npThermoTrapPrefix=npThermoTrapPrefix, npRelayStartReset=npRelayStartReset, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npIoTable=npIoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npForcedReboot=npForcedReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npThermoTrapValue=npThermoTrapValue, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npGsmSendSmsUtf8=npGsmSendSmsUtf8, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermo=npThermo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayMode=npRelayMode, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npIoTrapLineN=npIoTrapLineN, npThermoEntry=npThermoEntry, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayEntry=npRelayEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh)
