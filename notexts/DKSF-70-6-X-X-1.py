...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:05:57 2021
...
TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Integer32, NotificationType, Bits, ModuleIdentity, Counter64, Gauge32, ObjectIdentity, enterprises, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Integer32", "NotificationType", "Bits", "ModuleIdentity", "Counter64", "Gauge32", "ObjectIdentity", "enterprises", "iso", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npIoLineN=npIoLineN, npGsmStrength=npGsmStrength, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npIoTrapMemo=npIoTrapMemo, npIrStatus=npIrStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npThermoLow=npThermoLow, npThermoTrap=npThermoTrap, npRelHumTempValue=npRelHumTempValue, FixedPoint1000=FixedPoint1000, npRelayState=npRelayState, npSmokeTraps=npSmokeTraps, lightcom=lightcom, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npRelayTable=npRelayTable, npIo=npIo, npIoEntry=npIoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npSmoke=npSmoke, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npTrapInfo=npTrapInfo, npCurLoopTable=npCurLoopTable, npIoLevelIn=npIoLevelIn, npSmokeEntry=npSmokeEntry, npThermoTraps=npThermoTraps, npIr=npIr, npRelHumValue=npRelHumValue, npGsmRegistration=npGsmRegistration, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npGsmFailed=npGsmFailed, npIoMemo=npIoMemo, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npRelayN=npRelayN, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npCurLoopN=npCurLoopN, npCurLoopTrapN=npCurLoopTrapN, npThermoTable=npThermoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapEmailTo=npTrapEmailTo, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopV=npCurLoopV, npIrCtrl=npIrCtrl, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapStatus=npThermoTrapStatus, npThermoEntry=npThermoEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npResetStack=npResetStack, npIoTrap=npIoTrap, npRelay=npRelay, npThermoHigh=npThermoHigh, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrap=npRelHumTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrPlayCmd=npIrPlayCmd)
