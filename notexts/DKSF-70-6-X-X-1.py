...
NotificationType, Counter32, Bits, enterprises, Unsigned32, Counter64, ModuleIdentity, IpAddress, MibIdentifier, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "enterprises", "Unsigned32", "Counter64", "ModuleIdentity", "IpAddress", "MibIdentifier", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTable=npIoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npIoPulseCounter=npIoPulseCounter, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npTrapEmailTo=npTrapEmailTo, npGsmRegistration=npGsmRegistration, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIoLevelOut=npIoLevelOut, npSmokeTable=npSmokeTable, npThermoStatus=npThermoStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npThermo=npThermo, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrap=npIoTrap, npIr=npIr, npSmokeTrap=npSmokeTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npThermoMemo=npThermoMemo, npRelayTable=npRelayTable, npGsm=npGsm, npThermoLow=npThermoLow, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npIoTraps=npIoTraps, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapMemo=npThermoTrapMemo, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataN=npRelHumTrapDataN, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmStrength=npGsmStrength, npReboot=npReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npIrStatus=npIrStatus, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmoke=npSmoke, npIo=npIo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npThermoTable=npThermoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrap=npThermoTrap, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapData=npRelHumTrapData, npThermoEntry=npThermoEntry, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npSmokeReset=npSmokeReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapLow=npThermoTrapLow, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapR=npCurLoopTrapR, npIrCtrl=npIrCtrl, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npCurLoopTrapPower=npCurLoopTrapPower, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry)
