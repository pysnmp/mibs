...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:24:23 2023
...
IpAddress, Unsigned32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Gauge32, MibIdentifier, TimeTicks, enterprises, iso, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Gauge32", "MibIdentifier", "TimeTicks", "enterprises", "iso", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrap=npThermoTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapFail=npRelHumTrapFail, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npThermoSensorN=npThermoSensorN, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npRelayN=npRelayN, npTrapEmailTo=npTrapEmailTo, npIo=npIo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoHigh=npThermoHigh, npCurLoopTrap=npCurLoopTrap, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npIoMemo=npIoMemo, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npIoTable=npIoTable, npRelHumN=npRelHumN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumStatus=npRelHumStatus, npTrapInfo=npTrapInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoStatus=npThermoStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTable=npCurLoopTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npCurLoop=npCurLoop, npRelHumTrapTemp=npRelHumTrapTemp, npThermoEntry=npThermoEntry, npIrReset=npIrReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayState=npRelayState, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npIrStatus=npIrStatus, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npIr=npIr, npSmokeTrap=npSmokeTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npGsmStrength=npGsmStrength, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npResetStack=npResetStack, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npCurLoopV=npCurLoopV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopEntry=npCurLoopEntry, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrCtrl=npIrCtrl, npSmokeReset=npSmokeReset, npIoTrapLineN=npIoTrapLineN, npSmokeTrapStatus=npSmokeTrapStatus, lightcom=lightcom, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npCurLoopPower=npCurLoopPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelay=npRelay, npCurLoopTrapI=npCurLoopTrapI, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapR=npCurLoopTrapR)
