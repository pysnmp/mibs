...
# Produced by pysmi-1.1.8 at Wed Feb  2 18:27:50 2022
...
MibIdentifier, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, ObjectIdentity, iso, NotificationType, IpAddress, Counter64, Bits, Unsigned32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "ObjectIdentity", "iso", "NotificationType", "IpAddress", "Counter64", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTable=npIoTable, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopPower=npCurLoopPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npCurLoopTrap=npCurLoopTrap, npThermoHigh=npThermoHigh, npIoPulseCounter=npIoPulseCounter, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMode=npRelayMode, npIoTrapMemo=npIoTrapMemo, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLineN=npIoTrapLineN, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npThermoTrapHigh=npThermoTrapHigh, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, lightcom=lightcom, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npIrReset=npIrReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumStatus=npRelHumStatus, npForcedReboot=npForcedReboot, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npThermoLow=npThermoLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumN=npRelHumN, npIr=npIr, npRelHumidity=npRelHumidity, npRelHumTrapData=npRelHumTrapData, npThermoTrapLow=npThermoTrapLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npThermoStatus=npThermoStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempValue=npRelHumTempValue, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmInfo=npGsmInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npResetStack=npResetStack, npThermoValue=npThermoValue, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npRelayMemo=npRelayMemo, npCurLoopV=npCurLoopV, npRelHumTable=npRelHumTable, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoSensorN=npThermoSensorN, npIoTrapPrefix=npIoTrapPrefix, npSoftReboot=npSoftReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmoke=npSmoke, npCurLoopStatus=npCurLoopStatus, npSmokeReset=npSmokeReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npReboot=npReboot, npThermoTable=npThermoTable, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIo=npIo, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npRelHumTempStatus=npRelHumTempStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopN=npCurLoopN, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrStatus=npIrStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, FixedPoint1000=FixedPoint1000, npGsmStrength=npGsmStrength, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npCurLoopEntry=npCurLoopEntry, npIoTraps=npIoTraps)
