...
# Produced by pysmi-1.1.12 at Tue May 28 12:38:09 2024
...
Bits, IpAddress, NotificationType, Integer32, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, enterprises, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "NotificationType", "Integer32", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "enterprises", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npCurLoopTrapR=npCurLoopTrapR, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopPower=npCurLoopPower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelIn=npIoLevelIn, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeReset=npSmokeReset, npCurLoopI=npCurLoopI, npRelay=npRelay, npSmokeTable=npSmokeTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npReboot=npReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmRegistration=npGsmRegistration, npIr=npIr, npIoPulseCounter=npIoPulseCounter, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempValue=npRelHumTempValue, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npThermoHigh=npThermoHigh, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npIrCtrl=npIrCtrl, npCurLoopTraps=npCurLoopTraps, npRelayState=npRelayState, npCurLoopV=npCurLoopV, npRelHumTrapData=npRelHumTrapData, npRelHumidity=npRelHumidity, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayN=npRelayN, npRelHumTrapFail=npRelHumTrapFail, npIo=npIo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npTrapInfo=npTrapInfo, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npRelHumStatus=npRelHumStatus, npRelHumValue=npRelHumValue, npThermoTrap=npThermoTrap, npCurLoopTable=npCurLoopTable, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npSmokePower=npSmokePower, npThermoStatus=npThermoStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeMemo=npSmokeMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npGsmTrap=npGsmTrap, npThermoTraps=npThermoTraps, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npThermoTrapMemo=npThermoTrapMemo, lightcom=lightcom, npRelHumTable=npRelHumTable, npThermoSensorN=npThermoSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrap=npIoTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps)
