...
# Produced by pysmi-1.1.8 at Wed Jun 29 15:12:48 2022
...
NotificationType, Counter64, Gauge32, ObjectIdentity, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, Bits, MibIdentifier, Integer32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "ObjectIdentity", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, FixedPoint1000=FixedPoint1000, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npRelHumMemo=npRelHumMemo, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npSmokeTable=npSmokeTable, npThermoTrapLow=npThermoTrapLow, npGsmFailed=npGsmFailed, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npCurLoopTraps=npCurLoopTraps, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, npGsmTrap=npGsmTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npIo=npIo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayStartReset=npRelayStartReset, npRelHumTempStatus=npRelHumTempStatus, npIrPlayCmd=npIrPlayCmd, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeReset=npSmokeReset, npSmokeTraps=npSmokeTraps, npIoTable=npIoTable, npIoTrapPrefix=npIoTrapPrefix, npThermoHigh=npThermoHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npThermoValuePrecise=npThermoValuePrecise, npIoTrapMemo=npIoTrapMemo, npIoTraps=npIoTraps, npCurLoopI=npCurLoopI, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npSmokeTrapStatus=npSmokeTrapStatus, npThermo=npThermo, npThermoTrapSensorN=npThermoTrapSensorN, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTable=npCurLoopTable, npCurLoopTrapN=npCurLoopTrapN, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoop=npCurLoop, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayEntry=npRelayEntry, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npRelHumTrap=npRelHumTrap, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npResetStack=npResetStack, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoSensorN=npThermoSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrStatus=npIrStatus, lightcom=lightcom, npIrReset=npIrReset, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoLow=npThermoLow, npThermoTable=npThermoTable, npSmokeMemo=npSmokeMemo, npSmoke=npSmoke, npRelayTable=npRelayTable, npIoLineN=npIoLineN)
