...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:47:00 2023
...
Unsigned32, Gauge32, IpAddress, ModuleIdentity, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, iso, enterprises, Bits, Integer32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "IpAddress", "ModuleIdentity", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "iso", "enterprises", "Bits", "Integer32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npThermoTrapHigh=npThermoTrapHigh, FixedPoint1000=FixedPoint1000, npGsmStrength=npGsmStrength, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayStartReset=npRelayStartReset, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npRelHumValue=npRelHumValue, npIrStatus=npIrStatus, npCurLoopR=npCurLoopR, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoEntry=npThermoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopN=npCurLoopN, npIrReset=npIrReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumN=npRelHumN, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapValue=npThermoTrapValue, npRelayMode=npRelayMode, npIr=npIr, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayState=npRelayState, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTable=npThermoTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoHigh=npThermoHigh, npRelHumTable=npRelHumTable, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrap=npSmokeTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npCurLoopTrap=npCurLoopTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npForcedReboot=npForcedReboot, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoLow=npThermoLow, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npSmokeReset=npSmokeReset, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrCtrl=npIrCtrl, npCurLoopI=npCurLoopI, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npThermoSensorN=npThermoSensorN, npCurLoopV=npCurLoopV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npReboot=npReboot, npTrapInfo=npTrapInfo, npCurLoopPower=npCurLoopPower, npIoTraps=npIoTraps, npGsmTrap=npGsmTrap, npIoLevelIn=npIoLevelIn, npThermoTrapStatus=npThermoTrapStatus, npIo=npIo, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npRelHumEntry=npRelHumEntry, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npCurLoopTraps=npCurLoopTraps, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapData=npRelHumTrapData, lightcom=lightcom, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npSmokePower=npSmokePower, npGsmFailed=npGsmFailed)
