...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:17:43 2023
...
Counter64, TimeTicks, ObjectIdentity, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, ModuleIdentity, IpAddress, Counter32, Integer32, Gauge32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "ObjectIdentity", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "ModuleIdentity", "IpAddress", "Counter32", "Integer32", "Gauge32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapHigh=npThermoTrapHigh, npSmokeEntry=npSmokeEntry, lightcom=lightcom, npRelHumTrapDataN=npRelHumTrapDataN, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npIrStatus=npIrStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopR=npCurLoopR, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npCurLoopTable=npCurLoopTable, npRelayStartReset=npRelayStartReset, npThermoMemo=npThermoMemo, npRelHumMemo=npRelHumMemo, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTraps=npThermoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npThermo=npThermo, npSmokeReset=npSmokeReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npRelHumStatus=npRelHumStatus, npRelayN=npRelayN, npCurLoop=npCurLoop, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npIrCtrl=npIrCtrl, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npIoMemo=npIoMemo, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npGsmRegistration=npGsmRegistration, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npCurLoopV=npCurLoopV, npRelayState=npRelayState, npCurLoopPower=npCurLoopPower, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npRelHumN=npRelHumN, npThermoTable=npThermoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapData=npRelHumTrapData, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, npThermoTrapStatus=npThermoTrapStatus, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npRelay=npRelay, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoSensorN=npThermoSensorN, npTrapEmailTo=npTrapEmailTo, npIoTraps=npIoTraps, npThermoValue=npThermoValue, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapMemo=npThermoTrapMemo, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrap=npThermoTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTraps=npGsmTraps, npRelayMemo=npRelayMemo, npRelayTable=npRelayTable, npCurLoopTrap=npCurLoopTrap, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelIn=npIoLevelIn, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumidity=npRelHumidity, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSoftReboot=npSoftReboot, npCurLoopTrapR=npCurLoopTrapR, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail)
