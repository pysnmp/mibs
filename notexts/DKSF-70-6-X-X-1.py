...
enterprises, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, TimeTicks, Unsigned32, iso, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "TimeTicks", "Unsigned32", "iso", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeMemo=npSmokeMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTempStatus=npRelHumTempStatus, npGsmTrap=npGsmTrap, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npCurLoopPower=npCurLoopPower, npRelayMode=npRelayMode, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npTrapEmailTo=npTrapEmailTo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLineN=npIoTrapLineN, npGsmTraps=npGsmTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIr=npIr, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLevelIn=npIoLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapTemp=npRelHumTrapTemp, npThermoHigh=npThermoHigh, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTraps=npThermoTraps, npSmokeEntry=npSmokeEntry, npReboot=npReboot, npIoLineN=npIoLineN, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npIoTable=npIoTable, npRelHumTrapData=npRelHumTrapData, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmoke=npSmoke, npIoMemo=npIoMemo, npThermoEntry=npThermoEntry, npIo=npIo, npSmokeReset=npSmokeReset, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npIrReset=npIrReset, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npThermoValuePrecise=npThermoValuePrecise, npCurLoopI=npCurLoopI, npIoTrapPrefix=npIoTrapPrefix, lightcom=lightcom, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapMemo=npThermoTrapMemo, npSoftReboot=npSoftReboot, npRelHumTable=npRelHumTable, npForcedReboot=npForcedReboot, npThermoTrap=npThermoTrap, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoLow=npThermoLow, npRelayStartReset=npRelayStartReset, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrap=npSmokeTrap, npGsm=npGsm, npIoTrapLevelIn=npIoTrapLevelIn, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npRelHumValue=npRelHumValue, npRelHumN=npRelHumN, npCurLoopTrapR=npCurLoopTrapR, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix)
