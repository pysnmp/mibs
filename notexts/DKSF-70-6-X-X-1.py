...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:45:20 2022
...
Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Integer32, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, Gauge32, Bits, IpAddress, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Integer32", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "Bits", "IpAddress", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npSmokeSensorN=npSmokeSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayStartReset=npRelayStartReset, npIoLevelIn=npIoLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npThermoMemo=npThermoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopPower=npCurLoopPower, npIo=npIo, npCurLoopTrapR=npCurLoopTrapR, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapV=npCurLoopTrapV, npSmoke=npSmoke, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npCurLoopTrap=npCurLoopTrap, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoValue=npThermoValue, npCurLoopTrapN=npCurLoopTrapN, npIrCtrl=npIrCtrl, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopI=npCurLoopI, lightcom=lightcom, npGsmRegistration=npGsmRegistration, npIoTable=npIoTable, npRelHumTrapData=npRelHumTrapData, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermo=npThermo, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npIoTrap=npIoTrap, npIrReset=npIrReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npIr=npIr, npIoLevelOut=npIoLevelOut, npGsmStrength=npGsmStrength, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIoEntry=npIoEntry, npCurLoopTrapI=npCurLoopTrapI, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npSmokeTable=npSmokeTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npTrapInfo=npTrapInfo, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry, npRelayMemo=npRelayMemo, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npReboot=npReboot, npResetStack=npResetStack, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseStart=npIoSinglePulseStart)
