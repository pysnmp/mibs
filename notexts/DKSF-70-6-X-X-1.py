...
TimeTicks, Integer32, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, MibIdentifier, Counter32, NotificationType, ModuleIdentity, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "MibIdentifier", "Counter32", "NotificationType", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npIrPlayCmd=npIrPlayCmd, npCurLoopTraps=npCurLoopTraps, npThermo=npThermo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npThermoTrapValue=npThermoTrapValue, npCurLoopR=npCurLoopR, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npIoLineN=npIoLineN, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npIoTable=npIoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelay=npRelay, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npIoLevelOut=npIoLevelOut, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npIr=npIr, npIoTrapPrefix=npIoTrapPrefix, npRelayMode=npRelayMode, npSmokeTraps=npSmokeTraps, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npCurLoopEntry=npCurLoopEntry, npThermoTable=npThermoTable, lightcom=lightcom, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npSmokeReset=npSmokeReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, npIoEntry=npIoEntry, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTable=npCurLoopTable, npSmoke=npSmoke, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npIoTraps=npIoTraps, npSoftReboot=npSoftReboot, npIrCtrl=npIrCtrl, npSmokeStatus=npSmokeStatus, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrap=npRelHumTrap, npCurLoopPower=npCurLoopPower, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapV=npCurLoopTrapV, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumMemo=npRelHumMemo, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npRelayMemo=npRelayMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmInfo=npGsmInfo, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npThermoLow=npThermoLow, npGsm=npGsm, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, npRelayStartReset=npRelayStartReset, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npRelayState=npRelayState, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue)
