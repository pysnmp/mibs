...
Bits, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, MibIdentifier, Unsigned32, ModuleIdentity, IpAddress, enterprises, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "MibIdentifier", "Unsigned32", "ModuleIdentity", "IpAddress", "enterprises", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapSensorN=npThermoTrapSensorN, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeEntry=npSmokeEntry, npRelay=npRelay, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npIoTrap=npIoTrap, npRelHumMemo=npRelHumMemo, npRelHumTempValue=npRelHumTempValue, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, FixedPoint1000=FixedPoint1000, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npRelayStartReset=npRelayStartReset, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumN=npRelHumN, npRelayTable=npRelayTable, npIoTrapLineN=npIoTrapLineN, npThermoTraps=npThermoTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrStatus=npIrStatus, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrap=npGsmTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npRelHumTrap=npRelHumTrap, npThermoTrapMemo=npThermoTrapMemo, npIr=npIr, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLevelIn=npIoLevelIn, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapR=npCurLoopTrapR, npIoPulseCounter=npIoPulseCounter, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npRelayMode=npRelayMode, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npThermoStatus=npThermoStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npIrPlayCmd=npIrPlayCmd, npThermoTable=npThermoTable, npThermoValue=npThermoValue, npIrCtrl=npIrCtrl, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npSmokePower=npSmokePower, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npSmokeSensorN=npSmokeSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npGsmStrength=npGsmStrength, npThermoTrap=npThermoTrap, npThermoTrapLow=npThermoTrapLow, npCurLoopTable=npCurLoopTable, npIrReset=npIrReset, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsm=npGsm, npCurLoopTrapV=npCurLoopTrapV)
