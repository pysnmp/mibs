...
# Produced by pysmi-1.1.8 at Thu Sep  7 13:31:13 2023
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, NotificationType, enterprises, Counter64, Gauge32, MibIdentifier, ObjectIdentity, IpAddress, iso, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "NotificationType", "enterprises", "Counter64", "Gauge32", "MibIdentifier", "ObjectIdentity", "IpAddress", "iso", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapData=npRelHumTrapData, npRelayN=npRelayN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npIoTraps=npIoTraps, npThermoSensorN=npThermoSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayStartReset=npRelayStartReset, npIoTrapLineN=npIoTrapLineN, lightcom=lightcom, npCurLoopPower=npCurLoopPower, npIoTrapMemo=npIoTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelay=npRelay, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npSmokeTrap=npSmokeTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoMemo=npThermoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrReset=npIrReset, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npGsmTrap=npGsmTrap, npRelHumTrapFail=npRelHumTrapFail, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npSmokeSensorN=npSmokeSensorN, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npThermoTrap=npThermoTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrap=npIoTrap, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npThermoHigh=npThermoHigh, npThermoTrapValue=npThermoTrapValue, npIo=npIo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npIoEntry=npIoEntry, npIoLevelIn=npIoLevelIn, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapLow=npThermoTrapLow, npGsmFailed=npGsmFailed, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTable=npCurLoopTable, npRelayTable=npRelayTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTrapPrefix=npGsmTrapPrefix, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValue=npThermoValue, npIr=npIr, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npThermoTrapHigh=npThermoTrapHigh, npSmoke=npSmoke, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo)
