...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:56:38 2023
...
enterprises, Counter64, NotificationType, Gauge32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, MibIdentifier, Integer32, Bits, IpAddress, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "NotificationType", "Gauge32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Integer32", "Bits", "IpAddress", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npForcedReboot=npForcedReboot, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayTable=npRelayTable, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoStatus=npThermoStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTempValue=npRelHumTempValue, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npIr=npIr, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npIoEntry=npIoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npRelay=npRelay, npThermoHigh=npThermoHigh, npSmokeTraps=npSmokeTraps, npThermoValuePrecise=npThermoValuePrecise, npIrReset=npIrReset, npCurLoopEntry=npCurLoopEntry, FixedPoint1000=FixedPoint1000, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempStatus=npRelHumTempStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSoftReboot=npSoftReboot, lightcom=lightcom, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoEntry=npThermoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npIoTrapPrefix=npIoTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npThermoTrapValue=npThermoTrapValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrap=npCurLoopTrap, npGsmStrength=npGsmStrength, npSmokeTable=npSmokeTable, npRelHumStatus=npRelHumStatus, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeReset=npSmokeReset, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npGsm=npGsm, npTrapInfo=npTrapInfo, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npThermo=npThermo, npResetStack=npResetStack, npRelHumValue=npRelHumValue, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npIoSinglePulseStart=npIoSinglePulseStart, npIoMemo=npIoMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumidity=npRelHumidity, npReboot=npReboot, npIrStatus=npIrStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npSmokeStatus=npSmokeStatus, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps)
