...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npIoTrapPrefix=npIoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npIoMemo=npIoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npThermoTrapPrefix=npThermoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, lightcom=lightcom, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelayStartReset=npRelayStartReset, npCurLoopR=npCurLoopR, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npResetStack=npResetStack, npRelayMode=npRelayMode, npForcedReboot=npForcedReboot, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIr=npIr, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npThermoLow=npThermoLow, npThermoTrapHigh=npThermoTrapHigh, npIrReset=npIrReset, npIoTraps=npIoTraps, npRelay=npRelay, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapFail=npRelHumTrapFail, npRelHumTable=npRelHumTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelayState=npRelayState, npRelHumTrapTempFail=npRelHumTrapTempFail, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npSmokePower=npSmokePower, npReboot=npReboot, npIrStatus=npIrStatus, npRelHumStatus=npRelHumStatus, npIoTrapMemo=npIoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTraps=npGsmTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmInfo=npGsmInfo, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npIo=npIo, npThermoMemo=npThermoMemo, npSmokeTable=npSmokeTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapInfo=npTrapInfo, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN, npThermoTable=npThermoTable, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npCurLoopTrapI=npCurLoopTrapI, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npRelHumTrapData=npRelHumTrapData, npIoLevelOut=npIoLevelOut, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npGsm=npGsm, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npCurLoopStatus=npCurLoopStatus, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npThermoTrapValue=npThermoTrapValue, npRelHumMemo=npRelHumMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrap=npIoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTraps=npCurLoopTraps, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npRelHumN=npRelHumN, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
