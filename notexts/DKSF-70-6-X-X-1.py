...
# Produced by pysmi-1.1.12 at Tue Sep 17 13:00:22 2024
...
ObjectIdentity, Counter64, IpAddress, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Bits, Integer32, Gauge32, MibIdentifier, TimeTicks, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "IpAddress", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Bits", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npRelayStartReset=npRelayStartReset, npIrStatus=npIrStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumMemo=npRelHumMemo, npThermoHigh=npThermoHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmFailed=npGsmFailed, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npIoEntry=npIoEntry, npRelay=npRelay, npRelHumValue=npRelHumValue, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npGsm=npGsm, npGsmTrap=npGsmTrap, npSmokeTable=npSmokeTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValue=npThermoValue, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npIoLevelIn=npIoLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTraps=npIoTraps, npIoTrap=npIoTrap, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npIoMemo=npIoMemo, npThermoStatus=npThermoStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npCurLoopI=npCurLoopI, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npIr=npIr, npThermoTraps=npThermoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoLow=npThermoLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayTable=npRelayTable, npIoSinglePulseStart=npIoSinglePulseStart, lightcom=lightcom, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMemo=npRelayMemo, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npReboot=npReboot, npCurLoopV=npCurLoopV, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN, npCurLoopR=npCurLoopR, npRelHumTempValue=npRelHumTempValue, npRelHumidity=npRelHumidity, npThermoTrapStatus=npThermoTrapStatus, npSmoke=npSmoke, npIrReset=npIrReset, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npIoLineN=npIoLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npIoTrapPrefix=npIoTrapPrefix, FixedPoint1000=FixedPoint1000, npCurLoopEntry=npCurLoopEntry, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrCtrl=npIrCtrl, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npResetStack=npResetStack, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe)
