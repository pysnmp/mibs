...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:53:15 2021
...
Bits, Counter32, TimeTicks, NotificationType, MibIdentifier, enterprises, IpAddress, Gauge32, Integer32, Counter64, Unsigned32, ModuleIdentity, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "IpAddress", "Gauge32", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTable=npIoTable, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npTrapEmailTo=npTrapEmailTo, npSmokeTraps=npSmokeTraps, npCurLoop=npCurLoop, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npIoEntry=npIoEntry, npGsmInfo=npGsmInfo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempValue=npRelHumTempValue, npSmokeSensorN=npSmokeSensorN, npCurLoopV=npCurLoopV, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMode=npRelayMode, npSmokeEntry=npSmokeEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npTrapInfo=npTrapInfo, npThermoTable=npThermoTable, npSoftReboot=npSoftReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoLow=npThermoLow, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumValue=npRelHumValue, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npRelHumTrap=npRelHumTrap, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTraps=npGsmTraps, npSmokeReset=npSmokeReset, npReboot=npReboot, npSmokeTable=npSmokeTable, npResetStack=npResetStack, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npRelHumidity=npRelHumidity, npCurLoopTrapR=npCurLoopTrapR, npRelHumTable=npRelHumTable, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npForcedReboot=npForcedReboot, npThermoTrapLow=npThermoTrapLow, npIoLineN=npIoLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, FixedPoint1000=FixedPoint1000, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapValue=npThermoTrapValue, npGsmStrength=npGsmStrength, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayState=npRelayState, lightcom=lightcom, npThermoStatus=npThermoStatus, npThermoSensorN=npThermoSensorN, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npCurLoopI=npCurLoopI, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMemo=npRelayMemo, npCurLoopEntry=npCurLoopEntry, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelayEntry=npRelayEntry, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npRelHumTempStatus=npRelHumTempStatus, npRelHumStatus=npRelHumStatus, npCurLoopN=npCurLoopN, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTraps=npIoTraps, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
