...
# Produced by pysmi-1.1.10 at Wed Nov 15 02:40:45 2023
...
Counter64, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, enterprises, Integer32, TimeTicks, iso, Gauge32, Unsigned32, IpAddress, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "enterprises", "Integer32", "TimeTicks", "iso", "Gauge32", "Unsigned32", "IpAddress", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLineN=npIoLineN, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, lightcom=lightcom, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermo=npThermo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npForcedReboot=npForcedReboot, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokePower=npSmokePower, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npThermoValuePrecise=npThermoValuePrecise, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npIrPlayCmd=npIrPlayCmd, npRelHumTrapData=npRelHumTrapData, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npSmoke=npSmoke, npRelayMode=npRelayMode, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npRelHumStatus=npRelHumStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeMemo=npSmokeMemo, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopV=npCurLoopV, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npIrCtrl=npIrCtrl, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npRelHumN=npRelHumN, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npThermoTrapStatus=npThermoTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapLow=npThermoTrapLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, FixedPoint1000=FixedPoint1000, npCurLoopI=npCurLoopI, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmInfo=npGsmInfo, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npIoTrapLevelIn=npIoTrapLevelIn, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npRelayStartReset=npRelayStartReset, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npCurLoopTable=npCurLoopTable, npGsmRegistration=npGsmRegistration, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npIrReset=npIrReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npCurLoopTrap=npCurLoopTrap, npRelay=npRelay, npIoLevelIn=npIoLevelIn, npSmokeStatus=npSmokeStatus, npThermoTrap=npThermoTrap, npRelHumidity=npRelHumidity, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npSmokeTraps=npSmokeTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npRelayMemo=npRelayMemo, npRelayN=npRelayN, npIoTrapLevelLegend=npIoTrapLevelLegend)
