...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:44:12 2021
...
IpAddress, Counter64, NotificationType, Counter32, MibIdentifier, TimeTicks, enterprises, Bits, Unsigned32, ModuleIdentity, Gauge32, Integer32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "NotificationType", "Counter32", "MibIdentifier", "TimeTicks", "enterprises", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npGsm=npGsm, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokePower=npSmokePower, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopStatus=npCurLoopStatus, npGsmFailed=npGsmFailed, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTable=npCurLoopTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npCurLoopPower=npCurLoopPower, npGsmStrength=npGsmStrength, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTable=npThermoTable, npSmokeTable=npSmokeTable, npCurLoopN=npCurLoopN, npRelayMemo=npRelayMemo, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npIoEntry=npIoEntry, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npIoLineN=npIoLineN, npTrapInfo=npTrapInfo, npRelayState=npRelayState, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, lightcom=lightcom, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeSensorN=npSmokeSensorN, npThermoSensorN=npThermoSensorN, npCurLoopTrapV=npCurLoopTrapV, npSmokeTraps=npSmokeTraps, npGsmRegistration=npGsmRegistration, npRelayStartReset=npRelayStartReset, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelay=npRelay, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrap=npSmokeTrap, npThermoHigh=npThermoHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npThermoTrapStatus=npThermoTrapStatus, npIoTrap=npIoTrap, npThermoLow=npThermoLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoMemo=npIoMemo, npGsmTrap=npGsmTrap, npCurLoop=npCurLoop, npRelHumN=npRelHumN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopV=npCurLoopV, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npIr=npIr, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayTable=npRelayTable, npThermo=npThermo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe)
