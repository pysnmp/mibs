...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:30:27 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, IpAddress, Counter32, Unsigned32, Counter64, TimeTicks, Integer32, Gauge32, Bits, ModuleIdentity, enterprises, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "Counter64", "TimeTicks", "Integer32", "Gauge32", "Bits", "ModuleIdentity", "enterprises", "NotificationType", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoPulseCounter=npIoPulseCounter, npIoLineN=npIoLineN, npCurLoopI=npCurLoopI, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npIr=npIr, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrCtrl=npIrCtrl, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npThermoTrapStatus=npThermoTrapStatus, npIrStatus=npIrStatus, npRelHumTrap=npRelHumTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npRelHumValue=npRelHumValue, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npThermoTrap=npThermoTrap, npIoTable=npIoTable, npSmokeStatus=npSmokeStatus, npIoTrapMemo=npIoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npThermo=npThermo, npCurLoopPower=npCurLoopPower, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumMemo=npRelHumMemo, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npThermoMemo=npThermoMemo, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npThermoHigh=npThermoHigh, npRelHumEntry=npRelHumEntry, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npRelHumidity=npRelHumidity, npRelHumStatus=npRelHumStatus, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, lightcom=lightcom, npRelayMode=npRelayMode, npSmokeReset=npSmokeReset, npRelay=npRelay, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npRelayStartReset=npRelayStartReset, npRelayState=npRelayState, npIrReset=npIrReset, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapValue=npThermoTrapValue, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npGsmRegistration=npGsmRegistration, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLevelOut=npIoLevelOut, npGsmInfo=npGsmInfo)
