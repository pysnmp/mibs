...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:45:32 2023
...
Gauge32, MibIdentifier, iso, Bits, Counter32, enterprises, Unsigned32, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "Bits", "Counter32", "enterprises", "Unsigned32", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoMemo=npThermoMemo, npSmokeReset=npSmokeReset, npGsmStrength=npGsmStrength, npRelHumTrap=npRelHumTrap, npThermoLow=npThermoLow, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npSmokeMemo=npSmokeMemo, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npThermoHigh=npThermoHigh, npRelHumStatus=npRelHumStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npThermo=npThermo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTable=npSmokeTable, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npSmokeEntry=npSmokeEntry, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npThermoTrapPrefix=npThermoTrapPrefix, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrap=npSmokeTrap, npThermoStatus=npThermoStatus, npRelHumTable=npRelHumTable, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTraps=npGsmTraps, npThermoTrapHigh=npThermoTrapHigh, npThermoSensorN=npThermoSensorN, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsm=npGsm, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapValue=npThermoTrapValue, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapInfo=npTrapInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npCurLoop=npCurLoop, npIoEntry=npIoEntry, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npIr=npIr, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumN=npRelHumN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npIoLineN=npIoLineN, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npCurLoopPower=npCurLoopPower, npThermoTable=npThermoTable, npIoPulseCounter=npIoPulseCounter, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus, lightcom=lightcom, npSmoke=npSmoke, npThermoValue=npThermoValue, npThermoTraps=npThermoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npIoTrapMemo=npIoTrapMemo, npCurLoopN=npCurLoopN, npResetStack=npResetStack, npRelHumTrapTempSafe=npRelHumTrapTempSafe)
