...
Integer32, ObjectIdentity, MibIdentifier, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Bits, IpAddress, enterprises, ModuleIdentity, iso, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Bits", "IpAddress", "enterprises", "ModuleIdentity", "iso", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npForcedReboot=npForcedReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoMemo=npIoMemo, npThermoHigh=npThermoHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npCurLoopV=npCurLoopV, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermo=npThermo, npThermoMemo=npThermoMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTable=npRelHumTable, npIoTrapLevelIn=npIoTrapLevelIn, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npRelayState=npRelayState, npRelayEntry=npRelayEntry, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npReboot=npReboot, npSmoke=npSmoke, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrap=npGsmTrap, npThermoTrap=npThermoTrap, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npIoTraps=npIoTraps, npRelHumTrap=npRelHumTrap, npIr=npIr, lightcom=lightcom, npThermoEntry=npThermoEntry, npThermoLow=npThermoLow, npThermoTable=npThermoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmInfo=npGsmInfo, npThermoValue=npThermoValue, npSmokeTraps=npSmokeTraps, npRelay=npRelay, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npCurLoopStatus=npCurLoopStatus, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npIo=npIo, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npSmokeMemo=npSmokeMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrCtrl=npIrCtrl, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npRelHumMemo=npRelHumMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoPulseCounter=npIoPulseCounter, FixedPoint1000=FixedPoint1000, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npGsmRegistration=npGsmRegistration, npIoEntry=npIoEntry, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapMemo=npSmokeTrapMemo, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npThermoTrapValue=npThermoTrapValue, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempStatus=npRelHumTempStatus)
