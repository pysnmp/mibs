...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:37:44 2024
...
Unsigned32, NotificationType, IpAddress, ModuleIdentity, TimeTicks, Bits, MibIdentifier, Integer32, ObjectIdentity, iso, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "TimeTicks", "Bits", "MibIdentifier", "Integer32", "ObjectIdentity", "iso", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npSmoke=npSmoke, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTraps=npCurLoopTraps, npRelayStartReset=npRelayStartReset, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrStatus=npIrStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npIoLineN=npIoLineN, npCurLoopTrapI=npCurLoopTrapI, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, lightcom=lightcom, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapData=npRelHumTrapData, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npSmokeTrap=npSmokeTrap, npGsmTraps=npGsmTraps, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmStrength=npGsmStrength, npSmokeEntry=npSmokeEntry, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npRelHumTable=npRelHumTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoStatus=npThermoStatus, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, npIoLevelIn=npIoLevelIn, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npThermoTraps=npThermoTraps, npThermoLow=npThermoLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelOut=npIoLevelOut, npIoTrap=npIoTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumidity=npRelHumidity, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npGsmTrap=npGsmTrap, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npRelay=npRelay, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npRelHumEntry=npRelHumEntry, npIrCtrl=npIrCtrl, npIoTable=npIoTable, npIoEntry=npIoEntry, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npResetStack=npResetStack, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapMemo=npIoTrapMemo)
