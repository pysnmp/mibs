...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:52:54 2021
...
Gauge32, enterprises, ModuleIdentity, Integer32, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Counter64, TimeTicks, iso, Bits, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ModuleIdentity", "Integer32", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Counter64", "TimeTicks", "iso", "Bits", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npThermoEntry=npThermoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npRelayMode=npRelayMode, npSmoke=npSmoke, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTraps=npThermoTraps, npIoTrap=npIoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npCurLoopV=npCurLoopV, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npCurLoopPower=npCurLoopPower, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npThermoHigh=npThermoHigh, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTable=npIoTable, npIoTrapLineN=npIoTrapLineN, npGsmInfo=npGsmInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrap=npRelHumTrap, npCurLoopTrapI=npCurLoopTrapI, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopN=npCurLoopN, npRelayEntry=npRelayEntry, npSoftReboot=npSoftReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npGsmTrap=npGsmTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeReset=npSmokeReset, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumStatus=npRelHumStatus, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength, npSmokeStatus=npSmokeStatus, npIrReset=npIrReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npSmokeTable=npSmokeTable, npIrPlayCmd=npIrPlayCmd, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npReboot=npReboot, npIoSinglePulseStart=npIoSinglePulseStart, npGsm=npGsm, npRelHumMemo=npRelHumMemo, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopEntry=npCurLoopEntry, npForcedReboot=npForcedReboot, lightcom=lightcom, npRelHumTrapTemp=npRelHumTrapTemp, FixedPoint1000=FixedPoint1000, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapValue=npThermoTrapValue, npCurLoopI=npCurLoopI, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npRelayN=npRelayN, npResetStack=npResetStack, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npIo=npIo, npIrCtrl=npIrCtrl, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh)
