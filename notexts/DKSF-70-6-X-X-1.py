...
Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Counter64, Unsigned32, enterprises, IpAddress, Integer32, ModuleIdentity, NotificationType, Bits, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Counter64", "Unsigned32", "enterprises", "IpAddress", "Integer32", "ModuleIdentity", "NotificationType", "Bits", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayN=npRelayN, npIrCtrl=npIrCtrl, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoMemo=npThermoMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npCurLoopPower=npCurLoopPower, npIoMemo=npIoMemo, npReboot=npReboot, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npGsm=npGsm, npSmokeTraps=npSmokeTraps, npIoLevelOut=npIoLevelOut, npSoftReboot=npSoftReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npIo=npIo, npGsmFailed=npGsmFailed, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npForcedReboot=npForcedReboot, npCurLoopV=npCurLoopV, npIrReset=npIrReset, npThermoHigh=npThermoHigh, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeStatus=npSmokeStatus, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeSensorN=npSmokeSensorN, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npSmokeReset=npSmokeReset, npRelHumTrapDataN=npRelHumTrapDataN, npIoTable=npIoTable, npCurLoopR=npCurLoopR, npThermo=npThermo, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopN=npCurLoopN, npRelHumMemo=npRelHumMemo, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npCurLoop=npCurLoop, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npSmokeMemo=npSmokeMemo, npGsmInfo=npGsmInfo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npRelHumTrap=npRelHumTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelayState=npRelayState, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumValue=npRelHumValue, npRelHumTrapSafe=npRelHumTrapSafe, npThermoEntry=npThermoEntry, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoPulseCounter=npIoPulseCounter, npGsmTraps=npGsmTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npRelHumTrapFail=npRelHumTrapFail, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, lightcom=lightcom, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTraps=npThermoTraps, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumN=npRelHumN, npCurLoopTraps=npCurLoopTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npThermoTrapMemo=npThermoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npResetStack=npResetStack, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh)
