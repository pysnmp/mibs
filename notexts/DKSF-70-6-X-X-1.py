...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:44:05 2023
...
iso, Gauge32, IpAddress, Counter64, NotificationType, ModuleIdentity, enterprises, MibIdentifier, Integer32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "IpAddress", "Counter64", "NotificationType", "ModuleIdentity", "enterprises", "MibIdentifier", "Integer32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTraps=npIoTraps, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapInfo=npTrapInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrap=npRelHumTrap, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, npRelayEntry=npRelayEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npGsmInfo=npGsmInfo, npSmokeStatus=npSmokeStatus, npIr=npIr, npIrPlayCmd=npIrPlayCmd, npThermoEntry=npThermoEntry, npThermo=npThermo, npRelayN=npRelayN, npRelHumTempValue=npRelHumTempValue, npGsmTraps=npGsmTraps, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npForcedReboot=npForcedReboot, npCurLoopTraps=npCurLoopTraps, npSmokeTrap=npSmokeTrap, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapI=npCurLoopTrapI, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrap=npIoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoop=npCurLoop, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npSmokePower=npSmokePower, npRelayStartReset=npRelayStartReset, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npThermoSensorN=npThermoSensorN, npIrStatus=npIrStatus, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopStatus=npCurLoopStatus, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npRelayMode=npRelayMode, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npIrReset=npIrReset, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npRelHumN=npRelHumN, npThermoTrapMemo=npThermoTrapMemo, npIoTable=npIoTable, npThermoTrapLow=npThermoTrapLow, lightcom=lightcom, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, FixedPoint1000=FixedPoint1000, npSmokeTrapMemo=npSmokeTrapMemo, npIo=npIo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTable=npCurLoopTable, npIoTrapPrefix=npIoTrapPrefix, npIoLevelOut=npIoLevelOut, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npRelayState=npRelayState, npSmokeReset=npSmokeReset, npCurLoopEntry=npCurLoopEntry, npTrapEmailTo=npTrapEmailTo, npIoLevelIn=npIoLevelIn, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npThermoLow=npThermoLow, npIoTrapLevelIn=npIoTrapLevelIn, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
