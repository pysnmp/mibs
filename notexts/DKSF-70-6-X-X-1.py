...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:23:27 2022
...
Counter32, ModuleIdentity, Counter64, TimeTicks, NotificationType, enterprises, iso, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Gauge32, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "Counter64", "TimeTicks", "NotificationType", "enterprises", "iso", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Gauge32", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npSmokeTable=npSmokeTable, npIrCtrl=npIrCtrl, npRelHumStatus=npRelHumStatus, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIo=npIo, npRelHumidity=npRelHumidity, npSmokeEntry=npSmokeEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapPrefix=npThermoTrapPrefix, npSmokePower=npSmokePower, npRelayState=npRelayState, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMode=npRelayMode, npCurLoopI=npCurLoopI, npRelHumTrapFail=npRelHumTrapFail, npThermoMemo=npThermoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapLow=npThermoTrapLow, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsmRegistration=npGsmRegistration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npThermoValue=npThermoValue, npCurLoopTable=npCurLoopTable, npThermoEntry=npThermoEntry, npIr=npIr, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npCurLoopTrapV=npCurLoopTrapV, npThermoStatus=npThermoStatus, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npIoTraps=npIoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrPlayCmd=npIrPlayCmd, npRelHumValue=npRelHumValue, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npCurLoopTraps=npCurLoopTraps, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopR=npCurLoopR, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, lightcom=lightcom, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsm=npGsm, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npSmoke=npSmoke, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopN=npCurLoopN, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTrap=npGsmTrap, npIrReset=npIrReset, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npThermoTraps=npThermoTraps, npIoTable=npIoTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npIoLineN=npIoLineN, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npRelayTable=npRelayTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelayN=npRelayN, npIrStatus=npIrStatus, npThermoLow=npThermoLow, npGsmFailed=npGsmFailed, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, npCurLoopPower=npCurLoopPower, npSoftReboot=npSoftReboot, npThermoSensorN=npThermoSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTraps=npSmokeTraps, npIoTrap=npIoTrap, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npTrapEmailTo=npTrapEmailTo, npCurLoop=npCurLoop, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermo=npThermo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npSmokeSensorN=npSmokeSensorN)
