...
# Produced by pysmi-1.1.11 at Tue Dec  5 08:37:51 2023
...
TimeTicks, ObjectIdentity, iso, Unsigned32, MibIdentifier, ModuleIdentity, enterprises, Counter64, Integer32, NotificationType, Bits, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "ModuleIdentity", "enterprises", "Counter64", "Integer32", "NotificationType", "Bits", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermo=npThermo, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npIoLevelIn=npIoLevelIn, npThermoHigh=npThermoHigh, npGsmTraps=npGsmTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopR=npCurLoopR, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npCurLoop=npCurLoop, npIo=npIo, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npCurLoopPower=npCurLoopPower, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npThermoTrapLow=npThermoTrapLow, npRelayTable=npRelayTable, npThermoTraps=npThermoTraps, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumEntry=npRelHumEntry, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapStatus=npCurLoopTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayN=npRelayN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMode=npRelayMode, npIrCtrl=npIrCtrl, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTable=npIoTable, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npRelayState=npRelayState, npSmokeStatus=npSmokeStatus, npSmokeTrapStatus=npSmokeTrapStatus, npGsmInfo=npGsmInfo, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTable=npCurLoopTable, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapData=npRelHumTrapData, npThermoTrapStatus=npThermoTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTable=npSmokeTable, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npThermoEntry=npThermoEntry, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npIoMemo=npIoMemo, npThermoMemo=npThermoMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapFail=npRelHumTrapFail, npForcedReboot=npForcedReboot, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npCurLoopI=npCurLoopI, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTable=npRelHumTable, npRelHumN=npRelHumN, npSmoke=npSmoke, npThermoTable=npThermoTable, npGsmFailed=npGsmFailed, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npGsmTrap=npGsmTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoSensorN=npThermoSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumidity=npRelHumidity, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus)
