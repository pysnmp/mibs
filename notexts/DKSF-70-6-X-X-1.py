...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:41:43 2024
...
Counter32, TimeTicks, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, ObjectIdentity, Unsigned32, IpAddress, Gauge32, ModuleIdentity, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npResetStack=npResetStack, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopI=npCurLoopI, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelayN=npRelayN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapI=npCurLoopTrapI, npThermoEntry=npThermoEntry, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelayState=npRelayState, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npIoTrapLineN=npIoTrapLineN, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npCurLoopTrapN=npCurLoopTrapN, lightcom=lightcom, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npRelHumStatus=npRelHumStatus, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTable=npThermoTable, npIoMemo=npIoMemo, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npGsm=npGsm, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrap=npSmokeTrap, npRelHumTrapTemp=npRelHumTrapTemp, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npThermoValue=npThermoValue, npCurLoopR=npCurLoopR, npThermoSensorN=npThermoSensorN, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoValuePrecise=npThermoValuePrecise, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npCurLoopN=npCurLoopN, npSmokeEntry=npSmokeEntry, npRelHumMemo=npRelHumMemo, npGsmRegistration=npGsmRegistration, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npCurLoopPower=npCurLoopPower, npIoLevelOut=npIoLevelOut, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npThermoMemo=npThermoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTraps=npGsmTraps, npThermoLow=npThermoLow, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapInfo=npTrapInfo, npCurLoopTable=npCurLoopTable, npSmokeMemo=npSmokeMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npIrStatus=npIrStatus, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npRelHumTempStatus=npRelHumTempStatus, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus, npRelayTable=npRelayTable, npRelHumTrapData=npRelHumTrapData, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npRelayMode=npRelayMode, npIoSinglePulseDuration=npIoSinglePulseDuration)
