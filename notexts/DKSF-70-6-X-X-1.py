...
enterprises, iso, IpAddress, Integer32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, MibIdentifier, Bits, ModuleIdentity, Counter32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "IpAddress", "Integer32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "MibIdentifier", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npThermoTable=npThermoTable, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npThermoSensorN=npThermoSensorN, npSmokeEntry=npSmokeEntry, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npThermoTraps=npThermoTraps, npRelayStartReset=npRelayStartReset, npRelHumTempValue=npRelHumTempValue, npRelayEntry=npRelayEntry, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempStatus=npRelHumTempStatus, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npThermoEntry=npThermoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npCurLoopR=npCurLoopR, npThermoStatus=npThermoStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npForcedReboot=npForcedReboot, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npThermoTrapValue=npThermoTrapValue, npCurLoopTable=npCurLoopTable, npIoLineN=npIoLineN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermo=npThermo, npGsmStrength=npGsmStrength, npCurLoopV=npCurLoopV, npSmokeTrap=npSmokeTrap, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npCurLoopI=npCurLoopI, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npSmokePower=npSmokePower, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTraps=npSmokeTraps, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, lightcom=lightcom, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmRegistration=npGsmRegistration, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumEntry=npRelHumEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSoftReboot=npSoftReboot, npIoTrapPrefix=npIoTrapPrefix, npCurLoopEntry=npCurLoopEntry, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npIo=npIo, npRelay=npRelay, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayState=npRelayState, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumValue=npRelHumValue, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValue=npThermoValue, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npIoMemo=npIoMemo, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npIrCtrl=npIrCtrl, npGsm=npGsm)
