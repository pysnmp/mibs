...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:39:54 2021
...
MibIdentifier, enterprises, ModuleIdentity, Gauge32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Bits, Counter32, IpAddress, Integer32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "enterprises", "ModuleIdentity", "Gauge32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Bits", "Counter32", "IpAddress", "Integer32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, lightcom=lightcom, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npRelHumN=npRelHumN, npSmokeTrap=npSmokeTrap, npThermoMemo=npThermoMemo, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopI=npCurLoopI, npIoTrapLevelIn=npIoTrapLevelIn, npIoMemo=npIoMemo, npIoTable=npIoTable, npThermoTrap=npThermoTrap, npIrPlayCmd=npIrPlayCmd, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopN=npCurLoopN, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumEntry=npRelHumEntry, npIoLineN=npIoLineN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npGsm=npGsm, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npCurLoopPower=npCurLoopPower, npRelayMemo=npRelayMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmFailed=npGsmFailed, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npSmokeSensorN=npSmokeSensorN, npRelHumidity=npRelHumidity, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValue=npThermoValue, npThermoTable=npThermoTable, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, FixedPoint1000=FixedPoint1000, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTable=npSmokeTable, npIo=npIo, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokePower=npSmokePower, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrap=npRelHumTrap, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmRegistration=npGsmRegistration, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopTable=npCurLoopTable, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapHigh=npThermoTrapHigh, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npThermoSensorN=npThermoSensorN, npSmokeStatus=npSmokeStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapLow=npThermoTrapLow, npSmoke=npSmoke, npSmokeEntry=npSmokeEntry, npGsmTrapPrefix=npGsmTrapPrefix, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npRelayState=npRelayState, npRelHumValue=npRelHumValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npIoTrap=npIoTrap, npResetStack=npResetStack, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, npReboot=npReboot, npTrapEmailTo=npTrapEmailTo, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapPrefix=npIoTrapPrefix)
