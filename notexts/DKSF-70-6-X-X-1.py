...
Integer32, Unsigned32, ModuleIdentity, Bits, Counter64, iso, NotificationType, enterprises, ObjectIdentity, TimeTicks, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "ModuleIdentity", "Bits", "Counter64", "iso", "NotificationType", "enterprises", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npThermoMemo=npThermoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npSmokeMemo=npSmokeMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayN=npRelayN, lightcom=lightcom, npSmoke=npSmoke, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npForcedReboot=npForcedReboot, npRelayMode=npRelayMode, npGsm=npGsm, npThermoTrapValue=npThermoTrapValue, npRelHumidity=npRelHumidity, npGsmTrap=npGsmTrap, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npThermoTraps=npThermoTraps, npCurLoopTrapI=npCurLoopTrapI, npGsmTraps=npGsmTraps, npRelay=npRelay, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoValue=npThermoValue, npRelayEntry=npRelayEntry, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapSafe=npRelHumTrapSafe, npReboot=npReboot, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopI=npCurLoopI, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npIrCtrl=npIrCtrl, npGsmFailed=npGsmFailed, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoStatus=npThermoStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npIrReset=npIrReset, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTable=npCurLoopTable, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumValue=npRelHumValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npIoTrapPrefix=npIoTrapPrefix, npIr=npIr, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopV=npCurLoopV, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npGsmRegistration=npGsmRegistration, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npCurLoopPower=npCurLoopPower, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npThermoTable=npThermoTable, npThermo=npThermo)
