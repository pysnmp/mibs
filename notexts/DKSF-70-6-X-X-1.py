...
Gauge32, iso, Bits, MibIdentifier, ObjectIdentity, Counter32, NotificationType, Unsigned32, Counter64, Integer32, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "Bits", "MibIdentifier", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "Counter64", "Integer32", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npForcedReboot=npForcedReboot, npRelayEntry=npRelayEntry, npIoLevelIn=npIoLevelIn, npIoTable=npIoTable, npRelHumValue=npRelHumValue, npCurLoopN=npCurLoopN, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelay=npRelay, npCurLoopTrapPower=npCurLoopTrapPower, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npSmokeEntry=npSmokeEntry, npRelayState=npRelayState, npCurLoopTable=npCurLoopTable, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npResetStack=npResetStack, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npRelHumidity=npRelHumidity, npGsmInfo=npGsmInfo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapN=npCurLoopTrapN, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npSmokeReset=npSmokeReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempStatus=npRelHumTempStatus, npThermoMemo=npThermoMemo, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrap=npIoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValue=npThermoValue, npGsmFailed=npGsmFailed, npThermo=npThermo, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempValue=npRelHumTempValue, npCurLoopI=npCurLoopI, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumStatus=npRelHumStatus, npSmokeTable=npSmokeTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopV=npCurLoopV, npGsm=npGsm, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npIoTraps=npIoTraps, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npSmoke=npSmoke, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumN=npRelHumN, FixedPoint1000=FixedPoint1000, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayStartReset=npRelayStartReset, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumMemo=npRelHumMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npIoEntry=npIoEntry, lightcom=lightcom, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempFail=npRelHumTrapTempFail)
