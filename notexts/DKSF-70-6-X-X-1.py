...
IpAddress, iso, NotificationType, Gauge32, ModuleIdentity, Counter64, Integer32, ObjectIdentity, Bits, Counter32, TimeTicks, MibIdentifier, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "NotificationType", "Gauge32", "ModuleIdentity", "Counter64", "Integer32", "ObjectIdentity", "Bits", "Counter32", "TimeTicks", "MibIdentifier", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npSmokeTrap=npSmokeTrap, npIoTrapMemo=npIoTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLineN=npIoTrapLineN, npRelHumStatus=npRelHumStatus, npThermoEntry=npThermoEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npSmokeEntry=npSmokeEntry, npTrapInfo=npTrapInfo, npIoLineN=npIoLineN, npGsmTrap=npGsmTrap, npReboot=npReboot, npRelHumTable=npRelHumTable, npThermoStatus=npThermoStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopI=npCurLoopI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npIoEntry=npIoEntry, npGsmTrapPrefix=npGsmTrapPrefix, npSmokePower=npSmokePower, npCurLoopTrapV=npCurLoopTrapV, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrap=npIoTrap, lightcom=lightcom, npGsmFailed=npGsmFailed, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoMemo=npThermoMemo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeSensorN=npSmokeSensorN, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoLow=npThermoLow, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, npForcedReboot=npForcedReboot, FixedPoint1000=FixedPoint1000, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTable=npThermoTable, npGsmRegistration=npGsmRegistration, npGsm=npGsm, npCurLoopStatus=npCurLoopStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeMemo=npSmokeMemo, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoMemo=npIoMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapLow=npThermoTrapLow, npRelHumEntry=npRelHumEntry, npThermoValue=npThermoValue, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npRelayTable=npRelayTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npSmokeReset=npSmokeReset, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npRelay=npRelay, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npThermoTrapHigh=npThermoTrapHigh, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npRelayState=npRelayState)
