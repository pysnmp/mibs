...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:35:18 2022
...
Unsigned32, NotificationType, MibIdentifier, TimeTicks, enterprises, Bits, Integer32, ModuleIdentity, Counter32, ObjectIdentity, Counter64, iso, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "MibIdentifier", "TimeTicks", "enterprises", "Bits", "Integer32", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "iso", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLineN=npIoTrapLineN, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npIoLevelIn=npIoLevelIn, npCurLoopTrapPower=npCurLoopTrapPower, npIoEntry=npIoEntry, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayN=npRelayN, npThermoTable=npThermoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npResetStack=npResetStack, npIoLineN=npIoLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npSmokeMemo=npSmokeMemo, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npThermoTrap=npThermoTrap, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npSmokeTrap=npSmokeTrap, npSmokeEntry=npSmokeEntry, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapValue=npThermoTrapValue, npRelHumTrap=npRelHumTrap, npRelayMode=npRelayMode, npSmokeTable=npSmokeTable, npCurLoopN=npCurLoopN, npIoMemo=npIoMemo, npSmokeReset=npSmokeReset, lightcom=lightcom, npIo=npIo, npIoLevelOut=npIoLevelOut, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npGsmInfo=npGsmInfo, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumMemo=npRelHumMemo, npRelay=npRelay, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTraps=npThermoTraps, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npRelHumN=npRelHumN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumStatus=npRelHumStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataN=npRelHumTrapDataN, npSoftReboot=npSoftReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapMemo=npThermoTrapMemo, npRelHumValue=npRelHumValue, npGsm=npGsm, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npThermoHigh=npThermoHigh, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopStatus=npCurLoopStatus, npIrStatus=npIrStatus, npCurLoopTrapN=npCurLoopTrapN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoMemo=npThermoMemo, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayTable=npRelayTable, npGsmFailed=npGsmFailed, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempStatus=npRelHumTempStatus, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npIoTable=npIoTable, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000)
