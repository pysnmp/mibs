...
# Produced by pysmi-1.1.12 at Fri Jul 19 09:47:47 2024
...
Bits, Counter32, Integer32, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, iso, ModuleIdentity, Unsigned32, TimeTicks, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "iso", "ModuleIdentity", "Unsigned32", "TimeTicks", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npRelHumEntry=npRelHumEntry, npIo=npIo, npGsmTraps=npGsmTraps, npThermoTrapValue=npThermoTrapValue, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npCurLoopTrapV=npCurLoopTrapV, npThermoValue=npThermoValue, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npIr=npIr, npRelayMemo=npRelayMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npThermoValuePrecise=npThermoValuePrecise, npReboot=npReboot, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npIoPulseCounter=npIoPulseCounter, npIoMemo=npIoMemo, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npForcedReboot=npForcedReboot, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokePower=npSmokePower, npIrReset=npIrReset, npRelayTable=npRelayTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npGsmInfo=npGsmInfo, npGsm=npGsm, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTraps=npThermoTraps, npRelHumMemo=npRelHumMemo, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTraps=npSmokeTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npRelHumValue=npRelHumValue, npCurLoopTrapStatus=npCurLoopTrapStatus, FixedPoint1000=FixedPoint1000, npRelay=npRelay, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npIrCtrl=npIrCtrl, npIoLineN=npIoLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npCurLoopTrapN=npCurLoopTrapN, npIoLevelIn=npIoLevelIn, npThermoTrapStatus=npThermoTrapStatus, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npCurLoopStatus=npCurLoopStatus, npTrapInfo=npTrapInfo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npRelayMode=npRelayMode, npSmokeTrap=npSmokeTrap, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataN=npRelHumTrapDataN, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumN=npRelHumN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npCurLoopPower=npCurLoopPower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry)
