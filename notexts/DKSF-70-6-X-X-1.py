...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:31:40 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Integer32, Bits, TimeTicks, enterprises, ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, Gauge32, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Integer32", "Bits", "TimeTicks", "enterprises", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "Gauge32", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTraps=npSmokeTraps, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npRelHumTempStatus=npRelHumTempStatus, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npCurLoopTrapV=npCurLoopTrapV, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumN=npRelHumN, npThermo=npThermo, npIoTrapLevelIn=npIoTrapLevelIn, npGsmRegistration=npGsmRegistration, npGsmInfo=npGsmInfo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeStatus=npSmokeStatus, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npIoEntry=npIoEntry, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayState=npRelayState, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelay=npRelay, npRelHumStatus=npRelHumStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npIo=npIo, npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npIrCtrl=npIrCtrl, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoLow=npThermoLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrap=npIoTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataN=npRelHumTrapDataN, npSmokePower=npSmokePower, npRelHumTable=npRelHumTable, npRelHumMemo=npRelHumMemo, npCurLoopStatus=npCurLoopStatus, npCurLoopTable=npCurLoopTable, npIr=npIr, npThermoTrapMemo=npThermoTrapMemo, npSmokeMemo=npSmokeMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npIoLineN=npIoLineN, npSmokeReset=npSmokeReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npResetStack=npResetStack, npTrapInfo=npTrapInfo, npThermoTrapStatus=npThermoTrapStatus, lightcom=lightcom, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumidity=npRelHumidity, npSmokeTrapMemo=npSmokeTrapMemo, npIoTraps=npIoTraps, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapStatus=npSmokeTrapStatus, npRelayStartReset=npRelayStartReset, npGsmTraps=npGsmTraps, npGsm=npGsm, npRelayMode=npRelayMode, npThermoTable=npThermoTable, npThermoTrap=npThermoTrap, npSoftReboot=npSoftReboot, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npIoLevelIn=npIoLevelIn, npSmokeSensorN=npSmokeSensorN, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npSmokeTrap=npSmokeTrap, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npTrapEmailTo=npTrapEmailTo, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npThermoSensorN=npThermoSensorN)
