...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:40:12 2021
...
Unsigned32, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, MibIdentifier, ModuleIdentity, Counter64, Bits, Gauge32, enterprises, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Counter64", "Bits", "Gauge32", "enterprises", "IpAddress", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrap=npThermoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTraps=npThermoTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumValue=npRelHumValue, npRelHumTrapDataN=npRelHumTrapDataN, npReboot=npReboot, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npRelayMode=npRelayMode, npIoTraps=npIoTraps, npCurLoopPower=npCurLoopPower, npRelHumN=npRelHumN, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npRelayStartReset=npRelayStartReset, npThermoTrapStatus=npThermoTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npIo=npIo, npGsm=npGsm, npIr=npIr, npRelHumTrapTemp=npRelHumTrapTemp, npThermoLow=npThermoLow, npThermoTrapPrefix=npThermoTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npRelHumTrapFail=npRelHumTrapFail, npSmokeTraps=npSmokeTraps, npResetStack=npResetStack, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopEntry=npCurLoopEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTable=npThermoTable, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npIoLevelIn=npIoLevelIn, npSmokeTable=npSmokeTable, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npRelayState=npRelayState, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npGsmTrap=npGsmTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npGsmStrength=npGsmStrength, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokePower=npSmokePower, npSmokeTrap=npSmokeTrap, npSmokeMemo=npSmokeMemo, npCurLoopTrap=npCurLoopTrap, npIoLineN=npIoLineN, npSmokeTrapStatus=npSmokeTrapStatus, npSmoke=npSmoke, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapValue=npThermoTrapValue, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoEntry=npThermoEntry, npThermoValue=npThermoValue, npForcedReboot=npForcedReboot, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npGsmTraps=npGsmTraps, npCurLoopTrapV=npCurLoopTrapV, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npGsmInfo=npGsmInfo, npSmokeEntry=npSmokeEntry, npRelHumTable=npRelHumTable, lightcom=lightcom, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npRelayN=npRelayN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayEntry=npRelayEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8)
