...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:06:03 2023
...
NotificationType, Bits, Counter32, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, MibIdentifier, enterprises, Counter64, IpAddress, Gauge32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter64", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npThermoTrapLow=npThermoTrapLow, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeReset=npSmokeReset, npCurLoopV=npCurLoopV, npCurLoopI=npCurLoopI, npSmokeStatus=npSmokeStatus, npRelayState=npRelayState, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npSmokeTraps=npSmokeTraps, npRelHumTable=npRelHumTable, npThermoTrapStatus=npThermoTrapStatus, npThermoTraps=npThermoTraps, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npSmoke=npSmoke, npIo=npIo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npRelay=npRelay, npGsm=npGsm, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoEntry=npThermoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapValue=npThermoTrapValue, npRelHumTrap=npRelHumTrap, npThermoMemo=npThermoMemo, npRelHumidity=npRelHumidity, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapFail=npRelHumTrapFail, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npCurLoopTrapN=npCurLoopTrapN, npRelayN=npRelayN, npSmokeEntry=npSmokeEntry, npSmokeSensorN=npSmokeSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, npSmokePower=npSmokePower, npThermoSensorN=npThermoSensorN, npThermoTrapMemo=npThermoTrapMemo, npThermoValue=npThermoValue, npSmokeMemo=npSmokeMemo, npCurLoopEntry=npCurLoopEntry, npResetStack=npResetStack, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataStatus=npRelHumTrapDataStatus, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npRelHumN=npRelHumN, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npIoTrapPrefix=npIoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmFailed=npGsmFailed, npSmokeTrap=npSmokeTrap, npRelayEntry=npRelayEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIr=npIr, npIrStatus=npIrStatus, npIoTraps=npIoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npThermo=npThermo, npThermoTrap=npThermoTrap, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npIoTrapMemo=npIoTrapMemo, npReboot=npReboot, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeTable=npSmokeTable, npRelHumTrapSafe=npRelHumTrapSafe, npGsmTrapPrefix=npGsmTrapPrefix, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npIoTrapLevelLegend=npIoTrapLevelLegend)
