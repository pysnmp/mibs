...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:08:53 2023
...
iso, Counter32, Integer32, MibIdentifier, NotificationType, Counter64, ModuleIdentity, Unsigned32, TimeTicks, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Integer32", "MibIdentifier", "NotificationType", "Counter64", "ModuleIdentity", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npIrReset=npIrReset, npIr=npIr, npRelHumMemo=npRelHumMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIo=npIo, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npIrStatus=npIrStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npRelayN=npRelayN, npThermoTrapLow=npThermoTrapLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npRelHumN=npRelHumN, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npIrCtrl=npIrCtrl, npRelHumidity=npRelHumidity, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayStartReset=npRelayStartReset, npIrPlayCmd=npIrPlayCmd, npGsmFailed=npGsmFailed, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npSmokeTrap=npSmokeTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npGsmTrap=npGsmTrap, npRelHumTempValue=npRelHumTempValue, npRelHumTrapFail=npRelHumTrapFail, npRelayTable=npRelayTable, FixedPoint1000=FixedPoint1000, npRelHumStatus=npRelHumStatus, npCurLoopEntry=npCurLoopEntry, lightcom=lightcom, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapValue=npThermoTrapValue, npIoTable=npIoTable, npThermoLow=npThermoLow, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npGsmInfo=npGsmInfo, npSmokePower=npSmokePower, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTraps=npGsmTraps, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermo=npThermo, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npIoLevelOut=npIoLevelOut, npGsm=npGsm, npThermoSensorN=npThermoSensorN, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npCurLoopV=npCurLoopV, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopPower=npCurLoopPower, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTable=npCurLoopTable, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapSafe=npRelHumTrapSafe, npTrapInfo=npTrapInfo, npIoLineN=npIoLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapStatus=npThermoTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopR=npCurLoopR, npCurLoopTrapI=npCurLoopTrapI, npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npResetStack=npResetStack, npSmokeEntry=npSmokeEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataValue=npRelHumTrapDataValue)
