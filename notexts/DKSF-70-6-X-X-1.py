...
Counter32, NotificationType, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, iso, IpAddress, Gauge32, Integer32, Bits, ObjectIdentity, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "iso", "IpAddress", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayMode=npRelayMode, npThermoTrapValue=npThermoTrapValue, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npSoftReboot=npSoftReboot, npThermoTrapMemo=npThermoTrapMemo, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npIr=npIr, npIoMemo=npIoMemo, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npThermoTable=npThermoTable, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npIrPlayCmd=npIrPlayCmd, npIrStatus=npIrStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopR=npCurLoopR, npIoTrapLineN=npIoTrapLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoLevelOut=npIoLevelOut, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npForcedReboot=npForcedReboot, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npIrCtrl=npIrCtrl, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopStatus=npCurLoopStatus, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoLineN=npIoLineN, npRelayMemo=npRelayMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapStatus=npSmokeTrapStatus, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npIoTrapPrefix=npIoTrapPrefix, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npGsmTraps=npGsmTraps, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeEntry=npSmokeEntry, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npCurLoopPower=npCurLoopPower, npThermoTrapHigh=npThermoTrapHigh, npSmokePower=npSmokePower, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeStatus=npSmokeStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, npSmokeTraps=npSmokeTraps, npIo=npIo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayState=npRelayState, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTraps=npCurLoopTraps, npRelHumidity=npRelHumidity, npThermoHigh=npThermoHigh, npReboot=npReboot, npCurLoopTrapR=npCurLoopTrapR, npRelayN=npRelayN, npRelHumStatus=npRelHumStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npGsm=npGsm, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrReset=npIrReset, npRelHumValue=npRelHumValue, npThermoLow=npThermoLow, npIoTraps=npIoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, FixedPoint1000=FixedPoint1000, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npResetStack=npResetStack, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, lightcom=lightcom, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeMemo=npSmokeMemo, npIoTrap=npIoTrap, npGsmFailed=npGsmFailed, npSmokeReset=npSmokeReset, npSmokeTrapMemo=npSmokeTrapMemo, npGsmStrength=npGsmStrength)
