...
iso, IpAddress, Unsigned32, Counter32, TimeTicks, Gauge32, MibIdentifier, Bits, ObjectIdentity, Counter64, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Unsigned32", "Counter32", "TimeTicks", "Gauge32", "MibIdentifier", "Bits", "ObjectIdentity", "Counter64", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npGsm=npGsm, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npGsmInfo=npGsmInfo, npCurLoop=npCurLoop, npRelayMode=npRelayMode, npCurLoopTable=npCurLoopTable, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npGsmRegistration=npGsmRegistration, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmFailed=npGsmFailed, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopV=npCurLoopV, npTrapEmailTo=npTrapEmailTo, npGsmTraps=npGsmTraps, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, PYSNMP_MODULE_ID=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npThermoTrapValue=npThermoTrapValue, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npRelHumTrapSafe=npRelHumTrapSafe, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npSmokeMemo=npSmokeMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npCurLoopN=npCurLoopN, npIoEntry=npIoEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTraps=npThermoTraps, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npCurLoopI=npCurLoopI, npRelayTable=npRelayTable, npIo=npIo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npReboot=npReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTrapN=npCurLoopTrapN, npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npIoLineN=npIoLineN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTraps=npCurLoopTraps, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoLevelOut=npIoLevelOut, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npRelHumStatus=npRelHumStatus, npSmokePower=npSmokePower, npSmokeEntry=npSmokeEntry, lightcom=lightcom, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapStatus=npThermoTrapStatus, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmStrength=npGsmStrength, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoEntry=npThermoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npForcedReboot=npForcedReboot, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrap=npThermoTrap, npSmokeStatus=npSmokeStatus, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapI=npCurLoopTrapI, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh)
