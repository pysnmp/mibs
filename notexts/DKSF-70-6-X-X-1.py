...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:29:21 2021
...
iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ObjectIdentity, IpAddress, Bits, ModuleIdentity, Gauge32, MibIdentifier, Integer32, Unsigned32, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ObjectIdentity", "IpAddress", "Bits", "ModuleIdentity", "Gauge32", "MibIdentifier", "Integer32", "Unsigned32", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npIrReset=npIrReset, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayState=npRelayState, npSmokeTrapStatus=npSmokeTrapStatus, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, npSmokeMemo=npSmokeMemo, FixedPoint1000=FixedPoint1000, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopStatus=npCurLoopStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumMemo=npRelHumMemo, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapPrefix=npIoTrapPrefix, npRelayN=npRelayN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokePower=npSmokePower, npCurLoopV=npCurLoopV, npThermoTrap=npThermoTrap, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumN=npRelHumN, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeEntry=npSmokeEntry, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopR=npCurLoopR, npSmokeTable=npSmokeTable, npGsmFailed=npGsmFailed, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npReboot=npReboot, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npGsmInfo=npGsmInfo, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapR=npCurLoopTrapR, npThermoHigh=npThermoHigh, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npResetStack=npResetStack, npIoTrapLineN=npIoTrapLineN, npRelHumValue=npRelHumValue, npTrapInfo=npTrapInfo, npSmokeTraps=npSmokeTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npRelay=npRelay, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npRelHumTempStatus=npRelHumTempStatus, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopEntry=npCurLoopEntry, npRelHumEntry=npRelHumEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTable=npRelHumTable, npIo=npIo, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npIr=npIr, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npGsmTrap=npGsmTrap, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrap=npCurLoopTrap, npRelayStartReset=npRelayStartReset, npCurLoopTrapI=npCurLoopTrapI, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, npThermoStatus=npThermoStatus, npIoLevelOut=npIoLevelOut, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npThermoLow=npThermoLow, npGsmTrapPrefix=npGsmTrapPrefix, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, npThermoTrapHigh=npThermoTrapHigh, npThermoValuePrecise=npThermoValuePrecise, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmoke=npSmoke, npSmokeSensorN=npSmokeSensorN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npCurLoopPower=npCurLoopPower, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npGsm=npGsm, npIoEntry=npIoEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
