...
NotificationType, IpAddress, Counter32, TimeTicks, MibIdentifier, Counter64, Gauge32, iso, ObjectIdentity, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "Gauge32", "iso", "ObjectIdentity", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoMemo=npIoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npThermoTraps=npThermoTraps, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapPrefix=npIoTrapPrefix, npGsm=npGsm, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npRelHumValue=npRelHumValue, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayState=npRelayState, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npRelHumidity=npRelHumidity, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTraps=npSmokeTraps, npGsmTrap=npGsmTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, npRelayN=npRelayN, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npGsmFailed=npGsmFailed, npSmokeEntry=npSmokeEntry, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayStartReset=npRelayStartReset, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npForcedReboot=npForcedReboot, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrap=npRelHumTrap, npIoLevelIn=npIoLevelIn, npIrCtrl=npIrCtrl, npIo=npIo, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npGsmStrength=npGsmStrength, npSmokeTrapPrefix=npSmokeTrapPrefix, lightcom=lightcom, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npIoSinglePulseDuration=npIoSinglePulseDuration, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIr=npIr, npIrReset=npIrReset, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTable=npRelHumTable, npThermoTable=npThermoTable, npCurLoopN=npCurLoopN, npCurLoopPower=npCurLoopPower, npCurLoopTraps=npCurLoopTraps, npIoLevelOut=npIoLevelOut, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapMemo=npIoTrapMemo, npRelHumEntry=npRelHumEntry, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npRelHumN=npRelHumN, npGsmRegistration=npGsmRegistration, npThermoStatus=npThermoStatus, npRelay=npRelay, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npRelayMemo=npRelayMemo, npRelayMode=npRelayMode, npSmokeTrap=npSmokeTrap, npIoTable=npIoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoLow=npThermoLow, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npCurLoop=npCurLoop, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npSmoke=npSmoke, npRelHumStatus=npRelHumStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeStatus=npSmokeStatus, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrapPrefix=npGsmTrapPrefix)
