...
ObjectIdentity, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Unsigned32, Counter64, Integer32, Counter32, enterprises, NotificationType, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Unsigned32", "Counter64", "Integer32", "Counter32", "enterprises", "NotificationType", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrPlayCmd=npIrPlayCmd, lightcom=lightcom, npCurLoopTrapN=npCurLoopTrapN, npThermoTable=npThermoTable, npCurLoop=npCurLoop, npRelayTable=npRelayTable, npIoLevelIn=npIoLevelIn, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopEntry=npCurLoopEntry, npSmokeTable=npSmokeTable, npRelHumidity=npRelHumidity, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npSmoke=npSmoke, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, npThermoTraps=npThermoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npGsm=npGsm, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npRelHumEntry=npRelHumEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTable=npCurLoopTable, npResetStack=npResetStack, npReboot=npReboot, npThermoValue=npThermoValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npThermoTrapHigh=npThermoTrapHigh, npRelayStartReset=npRelayStartReset, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npThermoTrapStatus=npThermoTrapStatus, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoPulseCounter=npIoPulseCounter, npIoTable=npIoTable, npThermoStatus=npThermoStatus, npForcedReboot=npForcedReboot, npCurLoopR=npCurLoopR, npIr=npIr, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTrapValue=npThermoTrapValue, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeMemo=npSmokeMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapFail=npRelHumTrapFail, npSmokeSensorN=npSmokeSensorN, npRelayN=npRelayN, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeStatus=npSmokeStatus, npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npRelHumValue=npRelHumValue, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempValue=npRelHumTempValue, npIoTraps=npIoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeReset=npSmokeReset, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoValuePrecise=npThermoValuePrecise, npCurLoopPower=npCurLoopPower, npGsmInfo=npGsmInfo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npIoTrapMemo=npIoTrapMemo, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIo=npIo, npRelHumTable=npRelHumTable, npRelay=npRelay, npGsmRegistration=npGsmRegistration, npRelHumMemo=npRelHumMemo, npIrReset=npIrReset, npCurLoopStatus=npCurLoopStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe)
