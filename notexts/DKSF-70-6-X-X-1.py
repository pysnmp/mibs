...
# Produced by pysmi-1.1.12 at Mon Oct 28 02:12:55 2024
...
TimeTicks, Counter64, ObjectIdentity, IpAddress, Gauge32, Integer32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Counter32, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "Gauge32", "Integer32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Counter32", "Bits", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumidity=npRelHumidity, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapN=npCurLoopTrapN, npIoLevelOut=npIoLevelOut, npGsmFailed=npGsmFailed, npRelHumTable=npRelHumTable, npThermoTrapHigh=npThermoTrapHigh, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npTrapEmailTo=npTrapEmailTo, npThermoHigh=npThermoHigh, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapSensorN=npThermoTrapSensorN, npReboot=npReboot, npResetStack=npResetStack, npThermoLow=npThermoLow, npGsmTrap=npGsmTrap, npCurLoopTrap=npCurLoopTrap, npIoTrapLineN=npIoTrapLineN, npSmokeSensorN=npSmokeSensorN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoEntry=npIoEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npIoPulseCounter=npIoPulseCounter, npSmokeReset=npSmokeReset, lightcom=lightcom, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTraps=npCurLoopTraps, npThermoTrap=npThermoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoStatus=npThermoStatus, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npSmokeMemo=npSmokeMemo, npIo=npIo, npSmokeTable=npSmokeTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npSmokePower=npSmokePower, npIrCtrl=npIrCtrl, npCurLoopR=npCurLoopR, npRelHumStatus=npRelHumStatus, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayEntry=npRelayEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npSmoke=npSmoke, npGsmInfo=npGsmInfo, npCurLoopI=npCurLoopI, npGsmTraps=npGsmTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npSmokeTraps=npSmokeTraps, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrap=npIoTrap, npRelHumEntry=npRelHumEntry, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrReset=npIrReset, npRelHumTrapSafe=npRelHumTrapSafe, npIoLineN=npIoLineN, npCurLoopEntry=npCurLoopEntry, npRelay=npRelay, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrStatus=npIrStatus, npIoMemo=npIoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npThermo=npThermo, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npIoTrapMemo=npIoTrapMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeEntry=npSmokeEntry, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npThermoTrapPrefix=npThermoTrapPrefix, npIr=npIr, npGsmStrength=npGsmStrength)
