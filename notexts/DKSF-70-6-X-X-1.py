...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:57:16 2023
...
Counter64, Bits, iso, enterprises, ModuleIdentity, IpAddress, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Gauge32, TimeTicks, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "iso", "enterprises", "ModuleIdentity", "IpAddress", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrStatus=npIrStatus, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npGsmFailed=npGsmFailed, npIoEntry=npIoEntry, npRelay=npRelay, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npReboot=npReboot, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npRelHumN=npRelHumN, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumMemo=npRelHumMemo, npRelayState=npRelayState, npIoTrap=npIoTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npRelHumEntry=npRelHumEntry, npSmokeSensorN=npSmokeSensorN, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapV=npCurLoopTrapV, npGsmTrap=npGsmTrap, npIoTable=npIoTable, npRelHumTable=npRelHumTable, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npSmokeReset=npSmokeReset, npThermoValuePrecise=npThermoValuePrecise, npCurLoop=npCurLoop, npGsmStrength=npGsmStrength, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoHigh=npThermoHigh, npRelHumTempValue=npRelHumTempValue, npGsm=npGsm, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMemo=npRelayMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npRelayTable=npRelayTable, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npTrapInfo=npTrapInfo, npSmokePower=npSmokePower, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npCurLoopTrap=npCurLoopTrap, npThermoTrapStatus=npThermoTrapStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSoftReboot=npSoftReboot, npCurLoopTrapR=npCurLoopTrapR, npSmoke=npSmoke, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoSensorN=npThermoSensorN, npGsmRegistration=npGsmRegistration, npCurLoopN=npCurLoopN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapHigh=npThermoTrapHigh, npCurLoopR=npCurLoopR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTraps=npCurLoopTraps, npGsmTraps=npGsmTraps, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npIr=npIr, npCurLoopV=npCurLoopV, npIoLevelIn=npIoLevelIn, lightcom=lightcom, npRelayEntry=npRelayEntry, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapStatus=npSmokeTrapStatus, npIrReset=npIrReset, npRelHumValue=npRelHumValue)
