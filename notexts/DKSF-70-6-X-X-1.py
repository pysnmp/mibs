...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:30:37 2023
...
Counter64, NotificationType, TimeTicks, IpAddress, enterprises, Counter32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Unsigned32, Bits, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "IpAddress", "enterprises", "Counter32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Unsigned32", "Bits", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npIrReset=npIrReset, npGsmTrap=npGsmTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npResetStack=npResetStack, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIrStatus=npIrStatus, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npRelayMemo=npRelayMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npSmokeTrap=npSmokeTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTable=npThermoTable, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npIoLevelOut=npIoLevelOut, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npTrapInfo=npTrapInfo, npRelHumTempValue=npRelHumTempValue, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npGsmTraps=npGsmTraps, npGsmStrength=npGsmStrength, npSmokeEntry=npSmokeEntry, npIoMemo=npIoMemo, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npIoTraps=npIoTraps, npRelHumMemo=npRelHumMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapMemo=npThermoTrapMemo, npRelay=npRelay, npRelHumTable=npRelHumTable, npThermoEntry=npThermoEntry, npSmoke=npSmoke, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npGsmInfo=npGsmInfo, npRelHumValue=npRelHumValue, FixedPoint1000=FixedPoint1000, npRelHumEntry=npRelHumEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoLineN=npIoLineN, npSmokeStatus=npSmokeStatus, npReboot=npReboot, npRelayN=npRelayN, npRelayEntry=npRelayEntry, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopV=npCurLoopV, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npThermoTraps=npThermoTraps, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npSmokeMemo=npSmokeMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIr=npIr, npCurLoopN=npCurLoopN, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrapV=npCurLoopTrapV, npSmokeReset=npSmokeReset, npThermoTrapLow=npThermoTrapLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayTable=npRelayTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoEntry=npIoEntry, npSoftReboot=npSoftReboot, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npThermoStatus=npThermoStatus, npRelHumidity=npRelHumidity, npGsm=npGsm, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npIoTable=npIoTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopStatus=npCurLoopStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue)
