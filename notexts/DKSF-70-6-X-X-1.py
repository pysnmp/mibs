...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:43:02 2023
...
NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Gauge32, ModuleIdentity, MibIdentifier, enterprises, TimeTicks, iso, Bits, Counter32, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Gauge32", "ModuleIdentity", "MibIdentifier", "enterprises", "TimeTicks", "iso", "Bits", "Counter32", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npGsmFailed=npGsmFailed, npCurLoopTrapStatus=npCurLoopTrapStatus, npResetStack=npResetStack, npThermoTraps=npThermoTraps, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npIr=npIr, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoLow=npThermoLow, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npIoLevelIn=npIoLevelIn, npSmokeTrapStatus=npSmokeTrapStatus, npIoTable=npIoTable, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmRegistration=npGsmRegistration, npRelHumTrapFail=npRelHumTrapFail, npThermo=npThermo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayTable=npRelayTable, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopN=npCurLoopN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapEmailTo=npTrapEmailTo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopTraps=npCurLoopTraps, npIoTrapPrefix=npIoTrapPrefix, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPower=npCurLoopTrapPower, npRelayN=npRelayN, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumMemo=npRelHumMemo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayState=npRelayState, npIo=npIo, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npIoPulseCounter=npIoPulseCounter, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMode=npRelayMode, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoop=npCurLoop, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopPower=npCurLoopPower, npSmoke=npSmoke, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npRelayStartReset=npRelayStartReset, npRelHumTrapDataN=npRelHumTrapDataN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npSmokeTable=npSmokeTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapR=npCurLoopTrapR, npGsm=npGsm, npTrapInfo=npTrapInfo, npCurLoopI=npCurLoopI, npRelHumStatus=npRelHumStatus, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, npGsmTraps=npGsmTraps, npSmokeMemo=npSmokeMemo, npRelHumTable=npRelHumTable, npThermoTrap=npThermoTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npThermoTable=npThermoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoMemo=npThermoMemo, npSmokeEntry=npSmokeEntry, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npForcedReboot=npForcedReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npSoftReboot=npSoftReboot, npThermoTrapMemo=npThermoTrapMemo, npRelay=npRelay, npIoLevelOut=npIoLevelOut)
