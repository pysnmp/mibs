...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:28:37 2023
...
Bits, ObjectIdentity, Counter32, Counter64, Integer32, MibIdentifier, ModuleIdentity, TimeTicks, enterprises, Unsigned32, NotificationType, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "Counter64", "Integer32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "enterprises", "Unsigned32", "NotificationType", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npIoLevelIn=npIoLevelIn, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeEntry=npSmokeEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopV=npCurLoopV, npRelayTable=npRelayTable, npRelayMode=npRelayMode, npSmoke=npSmoke, npIoTraps=npIoTraps, npIoLineN=npIoLineN, npThermoTraps=npThermoTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npThermoMemo=npThermoMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoEntry=npThermoEntry, npThermoTrap=npThermoTrap, npSmokeReset=npSmokeReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npRelHumTrap=npRelHumTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npIr=npIr, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumValue=npRelHumValue, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData, npThermoTrapValue=npThermoTrapValue, npIoTrap=npIoTrap, npSoftReboot=npSoftReboot, npCurLoopTrapI=npCurLoopTrapI, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoMemo=npIoMemo, npRelayStartReset=npRelayStartReset, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npRelayMemo=npRelayMemo, npCurLoop=npCurLoop, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npIoLevelOut=npIoLevelOut, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, lightcom=lightcom, npThermo=npThermo, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeStatus=npSmokeStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelIn=npIoTrapLevelIn, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npThermoHigh=npThermoHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTable=npThermoTable, npGsmTrapPrefix=npGsmTrapPrefix, npRelay=npRelay, npRelayN=npRelayN, npIrReset=npIrReset, npGsmRegistration=npGsmRegistration, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npThermoLow=npThermoLow, npRelHumidity=npRelHumidity, npRelHumMemo=npRelHumMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow)
