...
MibIdentifier, Unsigned32, Bits, Counter32, Gauge32, TimeTicks, Counter64, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, iso, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Bits", "Counter32", "Gauge32", "TimeTicks", "Counter64", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "iso", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapData=npRelHumTrapData, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeMemo=npSmokeMemo, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npIoTrapLevelIn=npIoTrapLevelIn, npThermoEntry=npThermoEntry, npSmokeTable=npSmokeTable, npReboot=npReboot, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoHigh=npThermoHigh, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapSensorN=npThermoTrapSensorN, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsm=npGsm, npRelHumidity=npRelHumidity, npSmokeTrap=npSmokeTrap, npCurLoopTraps=npCurLoopTraps, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTable=npCurLoopTable, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npThermoTable=npThermoTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npIo=npIo, npCurLoop=npCurLoop, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npCurLoopEntry=npCurLoopEntry, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseStart=npIoSinglePulseStart, npGsmTrap=npGsmTrap, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempValue=npRelHumTempValue, npGsmRegistration=npGsmRegistration, npIoTable=npIoTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeReset=npSmokeReset, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, npGsmStrength=npGsmStrength, npThermoTrapValue=npThermoTrapValue, npSmokeStatus=npSmokeStatus, npRelay=npRelay, npRelayStartReset=npRelayStartReset, npRelHumTrapFail=npRelHumTrapFail, npRelayEntry=npRelayEntry, npRelHumTable=npRelHumTable, npCurLoopR=npCurLoopR, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npSoftReboot=npSoftReboot, npSmokeTraps=npSmokeTraps, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValue=npThermoValue, npSmokePower=npSmokePower, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npRelayMode=npRelayMode, npThermo=npThermo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npGsmFailed=npGsmFailed, npRelayTable=npRelayTable, npCurLoopTrapV=npCurLoopTrapV, npForcedReboot=npForcedReboot, npIoMemo=npIoMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrPlayCmd=npIrPlayCmd, FixedPoint1000=FixedPoint1000, npTrapEmailTo=npTrapEmailTo, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumEntry=npRelHumEntry, npRelHumMemo=npRelHumMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter)
