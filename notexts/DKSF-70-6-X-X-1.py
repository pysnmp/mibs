...
# Produced by pysmi-1.1.8 at Thu Feb  9 14:05:09 2023
...
NotificationType, IpAddress, MibIdentifier, Counter32, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, iso, Bits, ModuleIdentity, TimeTicks, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibIdentifier", "Counter32", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "iso", "Bits", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrReset=npIrReset, npReboot=npReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopN=npCurLoopN, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmRegistration=npGsmRegistration, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npForcedReboot=npForcedReboot, npIoTrapLineN=npIoTrapLineN, npGsmFailed=npGsmFailed, npRelHumEntry=npRelHumEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumValue=npRelHumValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumN=npRelHumN, npRelay=npRelay, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npIrCtrl=npIrCtrl, npThermoTable=npThermoTable, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npIrPlayCmd=npIrPlayCmd, npIo=npIo, npIoTrap=npIoTrap, npGsmTrap=npGsmTrap, npThermoTrap=npThermoTrap, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrStatus=npIrStatus, npCurLoopV=npCurLoopV, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npThermoTrapMemo=npThermoTrapMemo, npRelayMode=npRelayMode, npRelHumidity=npRelHumidity, npCurLoopTrapN=npCurLoopTrapN, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayMemo=npRelayMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, lightcom=lightcom, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npSmokeReset=npSmokeReset, npRelHumTable=npRelHumTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npTrapInfo=npTrapInfo, npGsmInfo=npGsmInfo, npIoTable=npIoTable, npGsmTrapPrefix=npGsmTrapPrefix, npSmoke=npSmoke, npRelHumMemo=npRelHumMemo, npSoftReboot=npSoftReboot, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoHigh=npThermoHigh, npTrapEmailTo=npTrapEmailTo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrap=npRelHumTrap, npRelayN=npRelayN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoMemo=npIoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npGsmStrength=npGsmStrength, npRelayStartReset=npRelayStartReset, npThermoEntry=npThermoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoValue=npThermoValue, npRelayTable=npRelayTable, npSmokeSensorN=npSmokeSensorN, npResetStack=npResetStack, npThermo=npThermo, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npGsm=npGsm, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npRelHumStatus=npRelHumStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoMemo=npThermoMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npSmokePower=npSmokePower, npGsmTraps=npGsmTraps, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npCurLoopTrapV=npCurLoopTrapV, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTraps=npIoTraps, npCurLoopTable=npCurLoopTable)
