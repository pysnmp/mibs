...
# Produced by pysmi-1.1.11 at Tue Dec  5 02:32:50 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Bits, iso, enterprises, IpAddress, NotificationType, Gauge32, Unsigned32, Integer32, ObjectIdentity, Counter64, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Bits", "iso", "enterprises", "IpAddress", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "ObjectIdentity", "Counter64", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIrStatus=npIrStatus, npRelHumMemo=npRelHumMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npGsmRegistration=npGsmRegistration, npSoftReboot=npSoftReboot, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopI=npCurLoopI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTraps=npThermoTraps, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npRelHumValue=npRelHumValue, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayStartReset=npRelayStartReset, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeSensorN=npSmokeSensorN, npCurLoopV=npCurLoopV, npThermoTrap=npThermoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npGsmInfo=npGsmInfo, npThermo=npThermo, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIrReset=npIrReset, npSmokeStatus=npSmokeStatus, npCurLoopTrapI=npCurLoopTrapI, npIoMemo=npIoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npGsmTraps=npGsmTraps, lightcom=lightcom, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npCurLoopN=npCurLoopN, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmTrap=npGsmTrap, npTrapInfo=npTrapInfo, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npCurLoopPower=npCurLoopPower, npIoTrap=npIoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapMemo=npIoTrapMemo, npIo=npIo, npRelayTable=npRelayTable, npThermoStatus=npThermoStatus, npGsmStrength=npGsmStrength, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npThermoMemo=npThermoMemo, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npCurLoop=npCurLoop, npRelHumTrapData=npRelHumTrapData, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeMemo=npSmokeMemo, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTemp=npRelHumTrapTemp, npSmokePower=npSmokePower, npRelay=npRelay, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayN=npRelayN, npThermoEntry=npThermoEntry, npIr=npIr, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeReset=npSmokeReset, npIoTrapLevelIn=npIoTrapLevelIn, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeEntry=npSmokeEntry, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrCtrl=npIrCtrl, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumN=npRelHumN, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npThermoSensorN=npThermoSensorN)
