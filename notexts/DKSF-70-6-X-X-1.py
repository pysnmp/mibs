...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:45:34 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Integer32, ModuleIdentity, iso, Counter32, Bits, Gauge32, Unsigned32, NotificationType, enterprises, ObjectIdentity, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Integer32", "ModuleIdentity", "iso", "Counter32", "Bits", "Gauge32", "Unsigned32", "NotificationType", "enterprises", "ObjectIdentity", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmFailed=npGsmFailed, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npGsmTrap=npGsmTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopV=npCurLoopV, npRelayMode=npRelayMode, npSmokeTrapStatus=npSmokeTrapStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopR=npCurLoopR, npIrReset=npIrReset, npSmokeTrap=npSmokeTrap, npSmoke=npSmoke, npThermoEntry=npThermoEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelIn=npIoLevelIn, npRelay=npRelay, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npSoftReboot=npSoftReboot, npCurLoopPower=npCurLoopPower, npGsmRegistration=npGsmRegistration, npRelayStartReset=npRelayStartReset, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npSmokeTrapSensorN=npSmokeTrapSensorN, npReboot=npReboot, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopI=npCurLoopI, npRelHumMemo=npRelHumMemo, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npRelHumTempStatus=npRelHumTempStatus, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeStatus=npSmokeStatus, npCurLoop=npCurLoop, npIo=npIo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTable=npSmokeTable, npSmokeReset=npSmokeReset, npRelHumTrapData=npRelHumTrapData, npTrapInfo=npTrapInfo, npIr=npIr, npRelayTable=npRelayTable, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npThermoSensorN=npThermoSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTable=npRelHumTable, npIrCtrl=npIrCtrl, npIrStatus=npIrStatus, npThermoStatus=npThermoStatus, npIoEntry=npIoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsm=npGsm, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npRelayN=npRelayN, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npThermoLow=npThermoLow, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoValue=npThermoValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapLow=npThermoTrapLow, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npThermoHigh=npThermoHigh, npThermoValuePrecise=npThermoValuePrecise, npIoLevelOut=npIoLevelOut, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npThermoTable=npThermoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npSmokeEntry=npSmokeEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapValue=npThermoTrapValue, npRelayEntry=npRelayEntry, npIoTable=npIoTable)
