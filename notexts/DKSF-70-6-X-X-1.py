...
ModuleIdentity, Gauge32, Counter32, ObjectIdentity, MibIdentifier, Integer32, IpAddress, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Bits, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Bits", "iso", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapFail=npRelHumTrapFail, npRelay=npRelay, npThermoTable=npThermoTable, lightcom=lightcom, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, npGsm=npGsm, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapPrefix=npThermoTrapPrefix, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokePower=npSmokePower, npIoTable=npIoTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayMode=npRelayMode, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npCurLoopN=npCurLoopN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeSensorN=npSmokeSensorN, npIrPlayCmd=npIrPlayCmd, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumN=npRelHumN, npRelHumValue=npRelHumValue, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npIo=npIo, npForcedReboot=npForcedReboot, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npSmokeReset=npSmokeReset, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMemo=npRelayMemo, npIrStatus=npIrStatus, npTrapEmailTo=npTrapEmailTo, npRelHumMemo=npRelHumMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayStartReset=npRelayStartReset, npSmokeStatus=npSmokeStatus, npCurLoopTrapV=npCurLoopTrapV, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npIrReset=npIrReset, npRelHumTrapDataValue=npRelHumTrapDataValue, npResetStack=npResetStack, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npCurLoopTrapPower=npCurLoopTrapPower, npIoLevelIn=npIoLevelIn, npCurLoopI=npCurLoopI, npSmokeEntry=npSmokeEntry, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLineN=npIoLineN, npThermoMemo=npThermoMemo, npIoMemo=npIoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapValue=npThermoTrapValue, npIr=npIr, npRelayEntry=npRelayEntry, npSmokeTraps=npSmokeTraps, npSmokeTrapMemo=npSmokeTrapMemo, npGsmFailed=npGsmFailed, npIoPulseCounter=npIoPulseCounter, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTempValue=npRelHumTempValue, npCurLoopR=npCurLoopR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTable=npCurLoopTable, npThermo=npThermo, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npSoftReboot=npSoftReboot, npIoTraps=npIoTraps, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoEntry=npThermoEntry, npRelHumTrapData=npRelHumTrapData, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npThermoSensorN=npThermoSensorN, npCurLoopTrap=npCurLoopTrap, npThermoTrapLow=npThermoTrapLow, npCurLoop=npCurLoop, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapInfo=npTrapInfo, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumStatus=npRelHumStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopV=npCurLoopV, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrap=npGsmTrap, FixedPoint1000=FixedPoint1000, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npReboot=npReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus)
