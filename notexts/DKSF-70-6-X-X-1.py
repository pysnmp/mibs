...
# Produced by pysmi-1.1.10 at Mon Feb 19 03:00:14 2024
...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Bits, ObjectIdentity, Unsigned32, Counter32, Gauge32, NotificationType, MibIdentifier, TimeTicks, ModuleIdentity, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Bits", "ObjectIdentity", "Unsigned32", "Counter32", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "ModuleIdentity", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration, lightcom=lightcom, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npResetStack=npResetStack, npThermoMemo=npThermoMemo, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTempValue=npRelHumTempValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeStatus=npSmokeStatus, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopV=npCurLoopV, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempStatus=npRelHumTempStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapPrefix=npThermoTrapPrefix, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTable=npCurLoopTable, npCurLoopTrapPower=npCurLoopTrapPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npCurLoopPower=npCurLoopPower, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTrapV=npCurLoopTrapV, npTrapEmailTo=npTrapEmailTo, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npRelHumTrapData=npRelHumTrapData, npRelHumTable=npRelHumTable, npSmokeTable=npSmokeTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmFailed=npGsmFailed, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopI=npCurLoopI, npGsmInfo=npGsmInfo, npIoTrapPrefix=npIoTrapPrefix, npIoMemo=npIoMemo, npReboot=npReboot, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapSensorN=npThermoTrapSensorN, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrStatus=npIrStatus, npIoTrap=npIoTrap, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npSmoke=npSmoke, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoLevelIn=npIoLevelIn, npRelayMemo=npRelayMemo, npIoLineN=npIoLineN, npSmokeTrap=npSmokeTrap, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npIoTrapLineN=npIoTrapLineN, npThermoValue=npThermoValue, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermo=npThermo, npGsmTrap=npGsmTrap, npThermoHigh=npThermoHigh, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npGsmTrapPrefix=npGsmTrapPrefix, npIo=npIo, npRelHumMemo=npRelHumMemo, npSoftReboot=npSoftReboot, npRelay=npRelay, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapR=npCurLoopTrapR, npIoLevelOut=npIoLevelOut, npSmokeTrapMemo=npSmokeTrapMemo, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npRelayN=npRelayN, npIoTable=npIoTable, npIrCtrl=npIrCtrl, npThermoTrapLow=npThermoTrapLow, npRelHumidity=npRelHumidity, npRelHumN=npRelHumN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopR=npCurLoopR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npIrPlayCmd=npIrPlayCmd, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npThermoEntry=npThermoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npRelHumTrapFail=npRelHumTrapFail, npThermoStatus=npThermoStatus)
