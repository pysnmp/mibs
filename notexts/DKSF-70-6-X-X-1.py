...
# Produced by pysmi-1.1.12 at Mon Apr 22 02:15:54 2024
...
Gauge32, Unsigned32, NotificationType, ModuleIdentity, ObjectIdentity, iso, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Counter32, MibIdentifier, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "NotificationType", "ModuleIdentity", "ObjectIdentity", "iso", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Counter32", "MibIdentifier", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumValue=npRelHumValue, npIrReset=npIrReset, npThermo=npThermo, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeReset=npSmokeReset, npRelHumEntry=npRelHumEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npRelHumTable=npRelHumTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayState=npRelayState, npIoMemo=npIoMemo, npCurLoopTrap=npCurLoopTrap, npCurLoopN=npCurLoopN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoop=npCurLoop, npRelayN=npRelayN, npThermoLow=npThermoLow, npSmokeSensorN=npSmokeSensorN, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npRelHumMemo=npRelHumMemo, npIoLevelOut=npIoLevelOut, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIr=npIr, npForcedReboot=npForcedReboot, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npIoTrapMemo=npIoTrapMemo, npCurLoopEntry=npCurLoopEntry, npThermoStatus=npThermoStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokePower=npSmokePower, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrap=npSmokeTrap, npThermoHigh=npThermoHigh, npThermoSensorN=npThermoSensorN, npRelay=npRelay, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayEntry=npRelayEntry, lightcom=lightcom, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmInfo=npGsmInfo, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npIrPlayCmd=npIrPlayCmd, npRelayStartReset=npRelayStartReset, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapN=npCurLoopTrapN, npGsmRegistration=npGsmRegistration, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumN=npRelHumN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrap=npRelHumTrap, npThermoTraps=npThermoTraps, npSmoke=npSmoke, npCurLoopTrapI=npCurLoopTrapI, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumStatus=npRelHumStatus, npTrapEmailTo=npTrapEmailTo, npReboot=npReboot, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npRelayMode=npRelayMode, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelLegend=npIoTrapLevelLegend, FixedPoint1000=FixedPoint1000, npSmokeTraps=npSmokeTraps, npIoEntry=npIoEntry, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npIoTrapPrefix=npIoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTraps=npCurLoopTraps, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npThermoEntry=npThermoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrap=npThermoTrap, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npSmokeMemo=npSmokeMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo)
