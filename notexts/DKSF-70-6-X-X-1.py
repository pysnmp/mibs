...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:38:45 2024
...
iso, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks, Bits, Gauge32, enterprises, MibIdentifier, Integer32, Counter64, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks", "Bits", "Gauge32", "enterprises", "MibIdentifier", "Integer32", "Counter64", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayState=npRelayState, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npIoTrap=npIoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npThermoSensorN=npThermoSensorN, npRelHumValue=npRelHumValue, npThermoMemo=npThermoMemo, npIoLineN=npIoLineN, npTrapInfo=npTrapInfo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npGsm=npGsm, npCurLoopTrap=npCurLoopTrap, npCurLoopTable=npCurLoopTable, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npReboot=npReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayTable=npRelayTable, npRelayN=npRelayN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npIrCtrl=npIrCtrl, npIrReset=npIrReset, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npSmokeTrapMemo=npSmokeTrapMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTable=npThermoTable, npThermoStatus=npThermoStatus, npThermoValue=npThermoValue, npIoTrapMemo=npIoTrapMemo, npRelay=npRelay, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLineN=npIoTrapLineN, npIrStatus=npIrStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npSmokePower=npSmokePower, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTable=npRelHumTable, npIoMemo=npIoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npGsmFailed=npGsmFailed, npRelHumTrapFail=npRelHumTrapFail, npSmokeTable=npSmokeTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npCurLoopTrapI=npCurLoopTrapI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopV=npCurLoopV, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopR=npCurLoopR, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npThermo=npThermo, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npSmokeTrap=npSmokeTrap, npRelHumEntry=npRelHumEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoEntry=npThermoEntry, npGsmTraps=npGsmTraps, npRelayMemo=npRelayMemo, npRelHumN=npRelHumN, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
