...
Bits, Counter32, Gauge32, NotificationType, MibIdentifier, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter64, TimeTicks, Integer32, ModuleIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Gauge32", "NotificationType", "MibIdentifier", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter64", "TimeTicks", "Integer32", "ModuleIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npSoftReboot=npSoftReboot, npIoLevelOut=npIoLevelOut, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npIoLevelIn=npIoLevelIn, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrap=npRelHumTrap, npIoTable=npIoTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npTrapInfo=npTrapInfo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapDataN=npRelHumTrapDataN, lightcom=lightcom, npCurLoopV=npCurLoopV, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrCtrl=npIrCtrl, npCurLoopTrapR=npCurLoopTrapR, npThermoMemo=npThermoMemo, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npSmokeTrap=npSmokeTrap, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npThermoStatus=npThermoStatus, npGsmInfo=npGsmInfo, npSmokeReset=npSmokeReset, npRelHumTrapSafe=npRelHumTrapSafe, npIrStatus=npIrStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIo=npIo, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npIoLineN=npIoLineN, npGsmRegistration=npGsmRegistration, npThermoTrapStatus=npThermoTrapStatus, npIoTrapMemo=npIoTrapMemo, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeTraps=npSmokeTraps, npResetStack=npResetStack, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumidity=npRelHumidity, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npRelay=npRelay, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMemo=npRelayMemo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, npThermoTrapSensorN=npThermoTrapSensorN, npThermoValue=npThermoValue, npThermoTraps=npThermoTraps, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npThermoSensorN=npThermoSensorN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapPrefix=npThermoTrapPrefix, npRelayState=npRelayState, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npGsmTraps=npGsmTraps, npReboot=npReboot, npRelayMode=npRelayMode, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmoke=npSmoke, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapMemo=npThermoTrapMemo, npSmokePower=npSmokePower, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npIoSinglePulseStart=npIoSinglePulseStart, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmStrength=npGsmStrength, npRelHumValue=npRelHumValue, npRelayTable=npRelayTable)
