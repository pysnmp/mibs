...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:30:02 2023
...
Unsigned32, TimeTicks, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, enterprises, Counter32, Bits, MibIdentifier, IpAddress, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "enterprises", "Counter32", "Bits", "MibIdentifier", "IpAddress", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npSmokeEntry=npSmokeEntry, npReboot=npReboot, npRelHumTempStatus=npRelHumTempStatus, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npThermoEntry=npThermoEntry, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoEntry=npIoEntry, npThermoStatus=npThermoStatus, npRelHumValue=npRelHumValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMemo=npRelayMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npThermoTable=npThermoTable, npGsm=npGsm, npRelHumidity=npRelHumidity, npCurLoopEntry=npCurLoopEntry, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapHigh=npThermoTrapHigh, lightcom=lightcom, npRelayStartReset=npRelayStartReset, npIo=npIo, npGsmFailed=npGsmFailed, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmRegistration=npGsmRegistration, npIoLevelOut=npIoLevelOut, npIoMemo=npIoMemo, npThermoTraps=npThermoTraps, npRelHumTrapSafe=npRelHumTrapSafe, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npIoTrap=npIoTrap, npThermoValue=npThermoValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTable=npRelHumTable, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npIoTrapPrefix=npIoTrapPrefix, npIrReset=npIrReset, npGsmTraps=npGsmTraps, npCurLoopTrapPower=npCurLoopTrapPower, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopStatus=npCurLoopStatus, npThermoTrapStatus=npThermoTrapStatus, npRelayN=npRelayN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npThermoTrapValue=npThermoTrapValue, npThermoTrap=npThermoTrap, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapSensorN=npThermoTrapSensorN, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTable=npSmokeTable, npSmokeTrap=npSmokeTrap, npRelayTable=npRelayTable, npResetStack=npResetStack, npSmoke=npSmoke, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTraps=npIoTraps, npCurLoopI=npCurLoopI, npIoPulseCounter=npIoPulseCounter, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumN=npRelHumN, npIrCtrl=npIrCtrl, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrap=npRelHumTrap, npIrStatus=npIrStatus, npThermo=npThermo, npCurLoopR=npCurLoopR, npSmokeSensorN=npSmokeSensorN, npRelHumMemo=npRelHumMemo, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelay=npRelay, npSmokeTraps=npSmokeTraps, npThermoTrapMemo=npThermoTrapMemo, npThermoSensorN=npThermoSensorN, npSmokeStatus=npSmokeStatus, npRelayMode=npRelayMode, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoLow=npThermoLow, npCurLoopTrapN=npCurLoopTrapN, npTrapEmailTo=npTrapEmailTo, npRelayEntry=npRelayEntry, npSmokeReset=npSmokeReset, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npCurLoop=npCurLoop, npCurLoopTable=npCurLoopTable, npCurLoopTrapV=npCurLoopTrapV)
