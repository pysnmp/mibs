...
MibIdentifier, ObjectIdentity, IpAddress, Counter32, TimeTicks, NotificationType, Counter64, Unsigned32, Integer32, enterprises, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "Counter64", "Unsigned32", "Integer32", "enterprises", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmoke=npSmoke, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapValue=npThermoTrapValue, npRelHumTable=npRelHumTable, npIr=npIr, npIrReset=npIrReset, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npGsmStrength=npGsmStrength, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopStatus=npCurLoopStatus, lightcom=lightcom, npRelayState=npRelayState, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmRegistration=npGsmRegistration, npSmokeEntry=npSmokeEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmFailed=npGsmFailed, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopN=npCurLoopN, npSmokeTable=npSmokeTable, npCurLoopEntry=npCurLoopEntry, npGsmTraps=npGsmTraps, npIoTable=npIoTable, npCurLoopI=npCurLoopI, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapPower=npCurLoopTrapPower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelHumStatus=npRelHumStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTable=npCurLoopTable, npIoEntry=npIoEntry, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npIoTraps=npIoTraps, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsm=npGsm, npIo=npIo, npIrCtrl=npIrCtrl, npSoftReboot=npSoftReboot, npGsmInfo=npGsmInfo, npTrapInfo=npTrapInfo, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npRelHumTrap=npRelHumTrap, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumidity=npRelHumidity, npForcedReboot=npForcedReboot, npIrPlayCmd=npIrPlayCmd, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoLevelOut=npIoLevelOut, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTable=npThermoTable, npThermoTrapMemo=npThermoTrapMemo, npThermoMemo=npThermoMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokePower=npSmokePower, npIrStatus=npIrStatus, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeMemo=npSmokeMemo, npRelHumEntry=npRelHumEntry, npRelHumN=npRelHumN, npThermoTraps=npThermoTraps, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npRelayN=npRelayN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoMemo=npIoMemo, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapR=npCurLoopTrapR, npCurLoopV=npCurLoopV, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npRelay=npRelay, npThermoStatus=npThermoStatus, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeReset=npSmokeReset, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopR=npCurLoopR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npRelayMemo=npRelayMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npThermo=npThermo, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTraps=npCurLoopTraps, FixedPoint1000=FixedPoint1000, npGsmSendSmsWin1251=npGsmSendSmsWin1251)
