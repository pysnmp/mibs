...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:19:02 2023
...
ModuleIdentity, ObjectIdentity, Gauge32, NotificationType, Counter32, iso, Bits, Unsigned32, enterprises, IpAddress, Integer32, Counter64, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Gauge32", "NotificationType", "Counter32", "iso", "Bits", "Unsigned32", "enterprises", "IpAddress", "Integer32", "Counter64", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrap=npCurLoopTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npThermoLow=npThermoLow, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npIoTraps=npIoTraps, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npSmokePower=npSmokePower, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npGsm=npGsm, npSmokeTraps=npSmokeTraps, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npTrapInfo=npTrapInfo, npRelHumTrap=npRelHumTrap, npRelHumEntry=npRelHumEntry, npCurLoop=npCurLoop, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npIoTable=npIoTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopPower=npCurLoopPower, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npSmokeMemo=npSmokeMemo, npTrapEmailTo=npTrapEmailTo, npIo=npIo, npRelayTable=npRelayTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelay=npRelay, npResetStack=npResetStack, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTrap=npSmokeTrap, npIoEntry=npIoEntry, npCurLoopV=npCurLoopV, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrStatus=npIrStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapN=npCurLoopTrapN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npSmokeTrapMemo=npSmokeTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrapStatus=npThermoTrapStatus, npCurLoopStatus=npCurLoopStatus, npThermoTraps=npThermoTraps, npReboot=npReboot, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapMemo=npThermoTrapMemo, npRelHumStatus=npRelHumStatus, npThermoMemo=npThermoMemo, npForcedReboot=npForcedReboot, npThermo=npThermo, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npThermoHigh=npThermoHigh, npThermoStatus=npThermoStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npGsmInfo=npGsmInfo, npSmoke=npSmoke, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayMemo=npRelayMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrap=npThermoTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapLineN=npIoTrapLineN, npCurLoopEntry=npCurLoopEntry, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npRelayEntry=npRelayEntry, npIrReset=npIrReset, npCurLoopR=npCurLoopR, npIoLevelIn=npIoLevelIn, npGsmRegistration=npGsmRegistration, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npIoLineN=npIoLineN, npGsmTraps=npGsmTraps, npRelayN=npRelayN, npSmokeTable=npSmokeTable, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npThermoTable=npThermoTable, npThermoEntry=npThermoEntry, npIoTrap=npIoTrap, npRelHumN=npRelHumN, npRelHumTable=npRelHumTable, npIoTrapMemo=npIoTrapMemo, npThermoTrapLow=npThermoTrapLow, npIr=npIr)
