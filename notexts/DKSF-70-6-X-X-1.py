...
IpAddress, Unsigned32, Integer32, Counter32, Bits, iso, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ObjectIdentity, Gauge32, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Integer32", "Counter32", "Bits", "iso", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npIr=npIr, npCurLoopTable=npCurLoopTable, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npCurLoopTrap=npCurLoopTrap, npIrStatus=npIrStatus, npSmoke=npSmoke, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoMemo=npIoMemo, npRelHumTempValue=npRelHumTempValue, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npThermo=npThermo, npCurLoopV=npCurLoopV, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npReboot=npReboot, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npCurLoop=npCurLoop, npSmokeTraps=npSmokeTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumMemo=npRelHumMemo, npThermoMemo=npThermoMemo, npThermoTrapSensorN=npThermoTrapSensorN, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokePower=npSmokePower, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeMemo=npSmokeMemo, npGsm=npGsm, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npThermoTrapStatus=npThermoTrapStatus, npRelayStartReset=npRelayStartReset, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayEntry=npRelayEntry, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoSinglePulseStart=npIoSinglePulseStart, npGsmRegistration=npGsmRegistration, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npGsmInfo=npGsmInfo, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npThermoValuePrecise=npThermoValuePrecise, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npGsmTrap=npGsmTrap, npIoEntry=npIoEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrap=npSmokeTrap, npResetStack=npResetStack, npIoLineN=npIoLineN, npIoTable=npIoTable, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npRelayMemo=npRelayMemo, npRelayN=npRelayN, npCurLoopTrapN=npCurLoopTrapN, npIoTrapLevelIn=npIoTrapLevelIn, npIrPlayCmd=npIrPlayCmd, npRelHumStatus=npRelHumStatus, npThermoValue=npThermoValue, npRelHumN=npRelHumN, npGsmStrength=npGsmStrength, npRelayState=npRelayState, npThermoSensorN=npThermoSensorN, npForcedReboot=npForcedReboot, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npThermoHigh=npThermoHigh, npCurLoopI=npCurLoopI, npThermoTrap=npThermoTrap, npThermoTraps=npThermoTraps, npRelayTable=npRelayTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npIoTraps=npIoTraps, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapMemo=npThermoTrapMemo, npRelHumTable=npRelHumTable)
