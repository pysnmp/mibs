...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:09:53 2023
...
Unsigned32, ObjectIdentity, Counter64, ModuleIdentity, enterprises, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, Integer32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Counter64", "ModuleIdentity", "enterprises", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "Integer32", "iso", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrap=npCurLoopTrap, npCurLoop=npCurLoop, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoEntry=npThermoEntry, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumEntry=npRelHumEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopR=npCurLoopR, npIrCtrl=npIrCtrl, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npIoTrapMemo=npIoTrapMemo, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npIr=npIr, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npResetStack=npResetStack, npCurLoopTable=npCurLoopTable, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapMemo=npSmokeTrapMemo, npIoMemo=npIoMemo, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempValue=npRelHumTempValue, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npThermoHigh=npThermoHigh, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npIoTraps=npIoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumStatus=npRelHumStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataN=npRelHumTrapDataN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npIoEntry=npIoEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeMemo=npSmokeMemo, npIoTrapLineN=npIoTrapLineN, npThermo=npThermo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npThermoTrapStatus=npThermoTrapStatus, npSmokeReset=npSmokeReset, npRelHumTable=npRelHumTable, npRelayState=npRelayState, npGsmRegistration=npGsmRegistration, npThermoLow=npThermoLow, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokePower=npSmokePower, npCurLoopTrapR=npCurLoopTrapR, npRelHumMemo=npRelHumMemo, npIoLineN=npIoLineN, npCurLoopV=npCurLoopV, npSmokeTrapStatus=npSmokeTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npThermoStatus=npThermoStatus, npRelayEntry=npRelayEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoMemo=npThermoMemo, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelay=npRelay, npSmoke=npSmoke, npGsmTraps=npGsmTraps, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopTrapN=npCurLoopTrapN, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopI=npCurLoopI, npIrStatus=npIrStatus, npRelHumTrap=npRelHumTrap, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npRelayTable=npRelayTable, npThermoTrap=npThermoTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelIn=npIoLevelIn, npIrReset=npIrReset, npRelHumN=npRelHumN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npSmokeTable=npSmokeTable, npRelHumValue=npRelHumValue, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapValue=npThermoTrapValue, npIo=npIo, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoSensorN=npThermoSensorN, npGsmTrap=npGsmTrap, npForcedReboot=npForcedReboot)
