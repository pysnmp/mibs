...
Bits, MibIdentifier, Unsigned32, IpAddress, Integer32, ModuleIdentity, Gauge32, Counter32, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity", "Gauge32", "Counter32", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoLow=npThermoLow, npIrCtrl=npIrCtrl, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npThermoTraps=npThermoTraps, npIo=npIo, npCurLoopStatus=npCurLoopStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npRelHumTempStatus=npRelHumTempStatus, npSmokeTrap=npSmokeTrap, npRelHumStatus=npRelHumStatus, npSmokeTraps=npSmokeTraps, npGsmStrength=npGsmStrength, npIoTraps=npIoTraps, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npThermoTrapValue=npThermoTrapValue, npThermoEntry=npThermoEntry, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayStartReset=npRelayStartReset, npIoSinglePulseStart=npIoSinglePulseStart, npThermo=npThermo, npSoftReboot=npSoftReboot, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npSmoke=npSmoke, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npGsmFailed=npGsmFailed, npSmokeMemo=npSmokeMemo, npGsmTrapPrefix=npGsmTrapPrefix, npResetStack=npResetStack, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumidity=npRelHumidity, FixedPoint1000=FixedPoint1000, npIoTrapLevelIn=npIoTrapLevelIn, npRelay=npRelay, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npCurLoop=npCurLoop, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTraps=npCurLoopTraps, lightcom=lightcom, npIoLevelOut=npIoLevelOut, npRelHumTrapFail=npRelHumTrapFail, npGsmTraps=npGsmTraps, npIrPlayCmd=npIrPlayCmd, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npIoLevelIn=npIoLevelIn, npRelHumTrapData=npRelHumTrapData, npThermoValue=npThermoValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npIrReset=npIrReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoStatus=npThermoStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopN=npCurLoopN, npIoEntry=npIoEntry, npSmokeReset=npSmokeReset, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npGsmRegistration=npGsmRegistration, npRelayState=npRelayState, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapMemo=npIoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npForcedReboot=npForcedReboot, npIoLineN=npIoLineN, npSmokeTable=npSmokeTable, npGsmTrap=npGsmTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npSmokeEntry=npSmokeEntry, npIr=npIr, npRelayTable=npRelayTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npThermoTrap=npThermoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npTrapInfo=npTrapInfo, npReboot=npReboot, npRelayMode=npRelayMode, npThermoSensorN=npThermoSensorN, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeStatus=npSmokeStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix)
