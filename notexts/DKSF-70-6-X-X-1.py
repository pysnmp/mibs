...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:26:12 2023
...
TimeTicks, Bits, NotificationType, MibIdentifier, ModuleIdentity, Gauge32, Counter64, ObjectIdentity, IpAddress, enterprises, Counter32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "MibIdentifier", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "IpAddress", "enterprises", "Counter32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmRegistration=npGsmRegistration, npThermoTrap=npThermoTrap, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npRelayEntry=npRelayEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTable=npCurLoopTable, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npGsmInfo=npGsmInfo, npRelayMode=npRelayMode, lightcom=lightcom, npForcedReboot=npForcedReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMemo=npRelayMemo, npReboot=npReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeEntry=npSmokeEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, FixedPoint1000=FixedPoint1000, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrReset=npIrReset, npGsmTraps=npGsmTraps, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npThermoStatus=npThermoStatus, npSmokeSensorN=npSmokeSensorN, npThermoHigh=npThermoHigh, npRelay=npRelay, npCurLoopN=npCurLoopN, npGsm=npGsm, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTable=npIoTable, npThermoEntry=npThermoEntry, npCurLoopStatus=npCurLoopStatus, npTrapEmailTo=npTrapEmailTo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIrStatus=npIrStatus, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapI=npCurLoopTrapI, npRelHumValue=npRelHumValue, npRelHumTrapData=npRelHumTrapData, npIoTrap=npIoTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npRelHumStatus=npRelHumStatus, npIoEntry=npIoEntry, npThermoTable=npThermoTable, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npIo=npIo, npThermoTrapStatus=npThermoTrapStatus, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrapR=npCurLoopTrapR, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTempValue=npRelHumTempValue, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTable=npSmokeTable, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeReset=npSmokeReset, npIr=npIr, npCurLoopPower=npCurLoopPower, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npCurLoopV=npCurLoopV, npIrCtrl=npIrCtrl, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTraps=npIoTraps, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npSmokeMemo=npSmokeMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npResetStack=npResetStack, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoop=npCurLoop, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoLow=npThermoLow, npSoftReboot=npSoftReboot, npThermoValue=npThermoValue, npIrPlayCmd=npIrPlayCmd, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npRelHumEntry=npRelHumEntry, npRelayState=npRelayState, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npIoTrapMemo=npIoTrapMemo, npIoMemo=npIoMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopI=npCurLoopI, npCurLoopR=npCurLoopR, npRelHumTrapSafe=npRelHumTrapSafe, npSmoke=npSmoke, npSmokePower=npSmokePower, npThermo=npThermo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelIn=npIoTrapLevelIn, npIoLevelIn=npIoLevelIn, npIoPulseCounter=npIoPulseCounter, npRelHumTrapTemp=npRelHumTrapTemp, npRelayN=npRelayN, npSmokeTrapStatus=npSmokeTrapStatus)
