...
ObjectIdentity, enterprises, Unsigned32, NotificationType, ModuleIdentity, iso, Bits, MibIdentifier, TimeTicks, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "Bits", "MibIdentifier", "TimeTicks", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumMemo=npRelHumMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npCurLoopTraps=npCurLoopTraps, npSmokeMemo=npSmokeMemo, npRelHumN=npRelHumN, npGsmTrap=npGsmTrap, npRelay=npRelay, npThermoTable=npThermoTable, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIr=npIr, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoEntry=npIoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelayState=npRelayState, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npIoTable=npIoTable, npResetStack=npResetStack, lightcom=lightcom, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapStatus=npThermoTrapStatus, npIrCtrl=npIrCtrl, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npIoTrap=npIoTrap, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npRelHumTable=npRelHumTable, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopEntry=npCurLoopEntry, npCurLoopPower=npCurLoopPower, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmFailed=npGsmFailed, npThermoStatus=npThermoStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayMode=npRelayMode, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayStartReset=npRelayStartReset, npSmoke=npSmoke, npCurLoopV=npCurLoopV, npRelHumStatus=npRelHumStatus, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapFail=npRelHumTrapFail, npIoPulseCounter=npIoPulseCounter, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapData=npRelHumTrapData, npThermoTraps=npThermoTraps, npGsm=npGsm, npRelayN=npRelayN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSoftReboot=npSoftReboot, npGsmTraps=npGsmTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumEntry=npRelHumEntry, npGsmRegistration=npGsmRegistration, npTrapEmailTo=npTrapEmailTo, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npSmokeTrapMemo=npSmokeTrapMemo, FixedPoint1000=FixedPoint1000, npRelHumTrap=npRelHumTrap, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTable=npSmokeTable, npIoLevelOut=npIoLevelOut, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npSmokeStatus=npSmokeStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapMemo=npIoTrapMemo, npCurLoop=npCurLoop, npIoMemo=npIoMemo)
