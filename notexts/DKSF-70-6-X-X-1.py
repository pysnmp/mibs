...
Counter32, Integer32, NotificationType, IpAddress, Counter64, ModuleIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Bits, enterprises, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "NotificationType", "IpAddress", "Counter64", "ModuleIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Bits", "enterprises", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, npSmokeStatus=npSmokeStatus, npGsm=npGsm, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLineN=npIoTrapLineN, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npCurLoopTrapR=npCurLoopTrapR, npIoLineN=npIoLineN, npRelHumTrap=npRelHumTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npRelHumSafeRangeLow=npRelHumSafeRangeLow, lightcom=lightcom, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npSmokeEntry=npSmokeEntry, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoLevelOut=npIoLevelOut, npRelayMemo=npRelayMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoSensorN=npThermoSensorN, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopV=npCurLoopV, npThermoTrapSensorN=npThermoTrapSensorN, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapFail=npRelHumTrapFail, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npIrReset=npIrReset, npReboot=npReboot, npThermoValuePrecise=npThermoValuePrecise, npSmoke=npSmoke, npIrPlayCmd=npIrPlayCmd, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmStrength=npGsmStrength, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npIoEntry=npIoEntry, npCurLoopTable=npCurLoopTable, npRelHumTrapDataN=npRelHumTrapDataN, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npIoMemo=npIoMemo, npGsmTrap=npGsmTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTraps=npThermoTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npIoTrap=npIoTrap, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrap=npSmokeTrap, npGsmRegistration=npGsmRegistration, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npSmokeMemo=npSmokeMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npThermoLow=npThermoLow, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npThermoHigh=npThermoHigh, npThermo=npThermo, npRelHumidity=npRelHumidity, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3)
