...
Integer32, enterprises, IpAddress, Gauge32, Counter64, Bits, Counter32, ModuleIdentity, NotificationType, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "IpAddress", "Gauge32", "Counter64", "Bits", "Counter32", "ModuleIdentity", "NotificationType", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayTable=npRelayTable, uniPingServerSolutionV3=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npGsmTraps=npGsmTraps, npCurLoopI=npCurLoopI, npRelHumTempValue=npRelHumTempValue, npIrCtrl=npIrCtrl, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoHigh=npThermoHigh, npCurLoopTrapI=npCurLoopTrapI, FixedPoint1000=FixedPoint1000, npRelHumTrapTempFail=npRelHumTrapTempFail, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npThermoLow=npThermoLow, npRelay=npRelay, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelOut=npIoLevelOut, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npGsmInfo=npGsmInfo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npThermoTrap=npThermoTrap, npCurLoopN=npCurLoopN, npIrPlayCmd=npIrPlayCmd, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoop=npCurLoop, npSmokeMemo=npSmokeMemo, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npSoftReboot=npSoftReboot, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTable=npCurLoopTable, npIrStatus=npIrStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npSmoke=npSmoke, npSmokeTraps=npSmokeTraps, npIoMemo=npIoMemo, npSmokeReset=npSmokeReset, npRelayMode=npRelayMode, npRelHumEntry=npRelHumEntry, npThermoTrapHigh=npThermoTrapHigh, npGsm=npGsm, npRelayEntry=npRelayEntry, npIoTable=npIoTable, npThermoTrapStatus=npThermoTrapStatus, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValue=npThermoValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrap=npIoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapInfo=npTrapInfo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npTrapEmailTo=npTrapEmailTo, npSmokeSensorN=npSmokeSensorN, npSmokeStatus=npSmokeStatus, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npSmokePower=npSmokePower, npGsmTrap=npGsmTrap, npIo=npIo, npRelHumTrapData=npRelHumTrapData, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npRelHumTrapSafe=npRelHumTrapSafe, npGsmStrength=npGsmStrength, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopEntry=npCurLoopEntry, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npRelayMemo=npRelayMemo, npIoLevelIn=npIoLevelIn, npReboot=npReboot, npThermoTraps=npThermoTraps, lightcom=lightcom, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTempStatus=npRelHumTempStatus, npIoTraps=npIoTraps, npIoEntry=npIoEntry, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npRelHumN=npRelHumN, npForcedReboot=npForcedReboot, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayState=npRelayState, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTrapMemo=npSmokeTrapMemo, npIr=npIr, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopStatus=npCurLoopStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh)
