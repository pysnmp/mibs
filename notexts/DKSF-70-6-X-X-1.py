...
Unsigned32, enterprises, Integer32, iso, TimeTicks, IpAddress, Counter32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, ObjectIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "Integer32", "iso", "TimeTicks", "IpAddress", "Counter32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npTrapInfo=npTrapInfo, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTraps=npSmokeTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrCtrl=npIrCtrl, npSmokeSensorN=npSmokeSensorN, npGsmTraps=npGsmTraps, npIoTraps=npIoTraps, npThermoTrap=npThermoTrap, npCurLoopR=npCurLoopR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npThermo=npThermo, lightcom=lightcom, npRelHumTrap=npRelHumTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeEntry=npSmokeEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelayTable=npRelayTable, npRelHumTempValue=npRelHumTempValue, npIoTrapLineN=npIoTrapLineN, npRelayMode=npRelayMode, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npIr=npIr, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npGsmStrength=npGsmStrength, npRelHumN=npRelHumN, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, npGsmTrap=npGsmTrap, npGsm=npGsm, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npRelHumTrapFail=npRelHumTrapFail, npReboot=npReboot, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopN=npCurLoopN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapEmailTo=npTrapEmailTo, npIoLineN=npIoLineN, npThermoEntry=npThermoEntry, npIoTrapMemo=npIoTrapMemo, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeReset=npSmokeReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npRelHumEntry=npRelHumEntry, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoLow=npThermoLow, npRelHumTrapSafe=npRelHumTrapSafe, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrap=npIoTrap, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npSmokeTable=npSmokeTable, npIrPlayCmd=npIrPlayCmd, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npIoTable=npIoTable, FixedPoint1000=FixedPoint1000, npRelayState=npRelayState, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoop=npCurLoop, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npSmokeMemo=npSmokeMemo, npThermoTrapMemo=npThermoTrapMemo, npThermoMemo=npThermoMemo, npCurLoopPower=npCurLoopPower, npThermoValue=npThermoValue, npCurLoopI=npCurLoopI, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeStatus=npSmokeStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmInfo=npGsmInfo, npCurLoopTrap=npCurLoopTrap, npRelHumStatus=npRelHumStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayStartReset=npRelayStartReset, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npThermoTrapPrefix=npThermoTrapPrefix, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npResetStack=npResetStack, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoEntry=npIoEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow)
