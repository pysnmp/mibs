...
ModuleIdentity, NotificationType, enterprises, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Unsigned32, Counter64, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "enterprises", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Unsigned32", "Counter64", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrCtrl=npIrCtrl, npThermoTrap=npThermoTrap, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapFail=npRelHumTrapFail, npIo=npIo, npRelHumTrapSafe=npRelHumTrapSafe, npIoMemo=npIoMemo, npRelHumTempStatus=npRelHumTempStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, FixedPoint1000=FixedPoint1000, npCurLoopTable=npCurLoopTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrap=npIoTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTraps=npSmokeTraps, npRelHumN=npRelHumN, npThermoStatus=npThermoStatus, npThermoMemo=npThermoMemo, npCurLoopTrapV=npCurLoopTrapV, npRelayTable=npRelayTable, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npSmokeStatus=npSmokeStatus, npIoTrapPrefix=npIoTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTable=npIoTable, npThermo=npThermo, npGsmStrength=npGsmStrength, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, lightcom=lightcom, npRelHumTable=npRelHumTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoHigh=npThermoHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoValuePrecise=npThermoValuePrecise, npThermoValue=npThermoValue, npRelayMemo=npRelayMemo, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npTrapEmailTo=npTrapEmailTo, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapValue=npThermoTrapValue, npRelay=npRelay, npRelayState=npRelayState, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTable=npSmokeTable, npRelHumMemo=npRelHumMemo, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapHigh=npThermoTrapHigh, npIoTrapLineN=npIoTrapLineN, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npResetStack=npResetStack, npGsmTraps=npGsmTraps, npRelayStartReset=npRelayStartReset, npIrReset=npIrReset, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopEntry=npCurLoopEntry, npGsm=npGsm, npSmoke=npSmoke, npThermoSensorN=npThermoSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumEntry=npRelHumEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopV=npCurLoopV, npThermoTrapStatus=npThermoTrapStatus, npIoLineN=npIoLineN, npCurLoopR=npCurLoopR, npThermoTable=npThermoTable, npRelHumTrapTemp=npRelHumTrapTemp, npGsmInfo=npGsmInfo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoop=npCurLoop, npCurLoopI=npCurLoopI, npIoLevelOut=npIoLevelOut, npCurLoopTraps=npCurLoopTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapN=npCurLoopTrapN, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npReboot=npReboot, npIoEntry=npIoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npThermoEntry=npThermoEntry, npThermoLow=npThermoLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopPower=npCurLoopPower, npSmokeReset=npSmokeReset, npIr=npIr, npSmokeEntry=npSmokeEntry)
