...
Integer32, iso, Bits, NotificationType, enterprises, TimeTicks, ObjectIdentity, Gauge32, MibIdentifier, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Bits", "NotificationType", "enterprises", "TimeTicks", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataValue=npRelHumTrapDataValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoValue=npThermoValue, npRelHumEntry=npRelHumEntry, npIrPlayCmd=npIrPlayCmd, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npThermoValuePrecise=npThermoValuePrecise, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPower=npCurLoopTrapPower, npIoTrapLineN=npIoTrapLineN, npIoEntry=npIoEntry, npForcedReboot=npForcedReboot, npIrStatus=npIrStatus, npCurLoopTraps=npCurLoopTraps, lightcom=lightcom, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, npRelHumMemo=npRelHumMemo, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapHigh=npThermoTrapHigh, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTable=npThermoTable, npRelHumValue=npRelHumValue, npRelayState=npRelayState, npGsm=npGsm, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npCurLoopR=npCurLoopR, npRelayEntry=npRelayEntry, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npIrCtrl=npIrCtrl, npCurLoopEntry=npCurLoopEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoMemo=npIoMemo, npCurLoopV=npCurLoopV, npRelHumTrapSafe=npRelHumTrapSafe, npIoTraps=npIoTraps, npGsmInfo=npGsmInfo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokePower=npSmokePower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npSmokeEntry=npSmokeEntry, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npSmokeMemo=npSmokeMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempValue=npRelHumTempValue, npRelayN=npRelayN, npThermoLow=npThermoLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoLineN=npIoLineN, npSmoke=npSmoke, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopN=npCurLoopN, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npGsmStrength=npGsmStrength, npRelHumTempStatus=npRelHumTempStatus, npRelay=npRelay, npThermoTrapStatus=npThermoTrapStatus, npCurLoopTable=npCurLoopTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npIrReset=npIrReset, npRelayStartReset=npRelayStartReset, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npTrapInfo=npTrapInfo, npRelayMode=npRelayMode, npThermoTrapLow=npThermoTrapLow, FixedPoint1000=FixedPoint1000, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapDataN=npRelHumTrapDataN, npGsmRegistration=npGsmRegistration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npResetStack=npResetStack, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npIoTable=npIoTable, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npGsmTrap=npGsmTrap, npGsmFailed=npGsmFailed, npThermo=npThermo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrap=npThermoTrap, npRelHumidity=npRelHumidity, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrap=npCurLoopTrap, npIoTrap=npIoTrap)
