...
ModuleIdentity, Integer32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Counter32, TimeTicks, Gauge32, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Counter32", "TimeTicks", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoMemo=npThermoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumidity=npRelHumidity, npRelayN=npRelayN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapValue=npThermoTrapValue, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokePower=npSmokePower, npSmokeReset=npSmokeReset, npThermo=npThermo, npIoLineN=npIoLineN, npReboot=npReboot, npIoLevelIn=npIoLevelIn, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeMemo=npSmokeMemo, npGsm=npGsm, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIr=npIr, npThermoLow=npThermoLow, npCurLoopTrapV=npCurLoopTrapV, npSmokeTraps=npSmokeTraps, npRelayTable=npRelayTable, npRelayState=npRelayState, npCurLoopStatus=npCurLoopStatus, npThermoTrap=npThermoTrap, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapData=npRelHumTrapData, npGsmInfo=npGsmInfo, npIoTraps=npIoTraps, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopPower=npCurLoopPower, FixedPoint1000=FixedPoint1000, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopV=npCurLoopV, npThermoSensorN=npThermoSensorN, npSmokeTable=npSmokeTable, npThermoEntry=npThermoEntry, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopI=npCurLoopI, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTraps=npCurLoopTraps, npIoTable=npIoTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, lightcom=lightcom, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npSmokeStatus=npSmokeStatus, npRelayStartReset=npRelayStartReset, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npThermoStatus=npThermoStatus, npCurLoopTable=npCurLoopTable, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npIoPulseCounter=npIoPulseCounter, npIo=npIo, npSmokeSensorN=npSmokeSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelay=npRelay, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npForcedReboot=npForcedReboot, npThermoTable=npThermoTable, npCurLoopR=npCurLoopR, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npThermoTrapHigh=npThermoTrapHigh, npGsmTraps=npGsmTraps, npThermoHigh=npThermoHigh, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npGsmRegistration=npGsmRegistration, npTrapEmailTo=npTrapEmailTo, npIoLevelOut=npIoLevelOut, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npIoTrapPrefix=npIoTrapPrefix, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npIoTrap=npIoTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoMemo=npIoMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrStatus=npIrStatus, npThermoTraps=npThermoTraps, npRelHumTrapFail=npRelHumTrapFail, npIrCtrl=npIrCtrl, npResetStack=npResetStack, npIrPlayCmd=npIrPlayCmd, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapStatus=npThermoTrapStatus, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayEntry=npRelayEntry, npRelHumTempValue=npRelHumTempValue, npGsmTrap=npGsmTrap, npThermoValuePrecise=npThermoValuePrecise)
