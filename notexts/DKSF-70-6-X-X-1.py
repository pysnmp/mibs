...
# Produced by pysmi-1.1.12 at Tue Jun  4 11:49:07 2024
...
Counter32, Integer32, Unsigned32, ObjectIdentity, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, enterprises, Bits, IpAddress, MibIdentifier, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "enterprises", "Bits", "IpAddress", "MibIdentifier", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npGsmTrapPrefix=npGsmTrapPrefix, npIoLineN=npIoLineN, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrap=npSmokeTrap, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npRelHumN=npRelHumN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTable=npRelHumTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTraps=npCurLoopTraps, npIoTraps=npIoTraps, npIrPlayCmd=npIrPlayCmd, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npRelHumTrapData=npRelHumTrapData, npCurLoopEntry=npCurLoopEntry, npIoTrapLineN=npIoTrapLineN, npTrapEmailTo=npTrapEmailTo, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeSensorN=npSmokeSensorN, FixedPoint1000=FixedPoint1000, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npSoftReboot=npSoftReboot, lightcom=lightcom, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npResetStack=npResetStack, npGsmTrap=npGsmTrap, npGsmInfo=npGsmInfo, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npRelayState=npRelayState, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoEntry=npIoEntry, npIoLevelOut=npIoLevelOut, npThermoTrap=npThermoTrap, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTable=npThermoTable, npSmoke=npSmoke, npRelHumEntry=npRelHumEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeEntry=npSmokeEntry, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npCurLoopStatus=npCurLoopStatus, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npRelayMode=npRelayMode, npIr=npIr, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoop=npCurLoop, npIo=npIo, npIrCtrl=npIrCtrl, npRelHumTrapTemp=npRelHumTrapTemp, npGsmStrength=npGsmStrength, npIoTable=npIoTable, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTrapValue=npThermoTrapValue, npForcedReboot=npForcedReboot, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npCurLoopPower=npCurLoopPower, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTraps=npThermoTraps, npTrapInfo=npTrapInfo, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npReboot=npReboot, npSmokeReset=npSmokeReset, npIrStatus=npIrStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermo=npThermo, npRelHumStatus=npRelHumStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeMemo=npSmokeMemo, npRelHumTrap=npRelHumTrap, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopTrapPower=npCurLoopTrapPower, npRelay=npRelay, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npSmokePower=npSmokePower, npSmokeTraps=npSmokeTraps, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoStatus=npThermoStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayEntry=npRelayEntry, npIoTrap=npIoTrap, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
