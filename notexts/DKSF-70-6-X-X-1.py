...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:16:47 2023
...
ObjectIdentity, MibIdentifier, NotificationType, Gauge32, Bits, Unsigned32, TimeTicks, iso, Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "Gauge32", "Bits", "Unsigned32", "TimeTicks", "iso", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumValue=npRelHumValue, npCurLoopEntry=npCurLoopEntry, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrPlayCmd=npIrPlayCmd, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapStatus=npThermoTrapStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTable=npRelHumTable, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopPower=npCurLoopPower, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npResetStack=npResetStack, npRelayState=npRelayState, npCurLoopV=npCurLoopV, npCurLoop=npCurLoop, npThermoLow=npThermoLow, npReboot=npReboot, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTraps=npGsmTraps, npThermoTrapPrefix=npThermoTrapPrefix, npIoLevelOut=npIoLevelOut, npCurLoopTrapR=npCurLoopTrapR, npGsmInfo=npGsmInfo, npIoTrapLevelIn=npIoTrapLevelIn, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npThermoEntry=npThermoEntry, npTrapInfo=npTrapInfo, npIoTable=npIoTable, npRelayTable=npRelayTable, npThermoSensorN=npThermoSensorN, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeSensorN=npSmokeSensorN, npSmokePower=npSmokePower, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npGsmTrapPrefix=npGsmTrapPrefix, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npIoTrapPrefix=npIoTrapPrefix, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapPrefix=npCurLoopTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npIrReset=npIrReset, npForcedReboot=npForcedReboot, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopR=npCurLoopR, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayStartReset=npRelayStartReset, npIoTrap=npIoTrap, npRelayMode=npRelayMode, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumN=npRelHumN, npThermo=npThermo, npCurLoopTrap=npCurLoopTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npIo=npIo, npThermoValue=npThermoValue, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npCurLoopTrapI=npCurLoopTrapI, npThermoValuePrecise=npThermoValuePrecise, npThermoHigh=npThermoHigh, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapMemo=npIoTrapMemo, npGsmFailed=npGsmFailed, npRelHumTempValue=npRelHumTempValue, npIoSinglePulseStart=npIoSinglePulseStart, npIoLevelIn=npIoLevelIn, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopTable=npCurLoopTable, npThermoTrapLow=npThermoTrapLow, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrCtrl=npIrCtrl, FixedPoint1000=FixedPoint1000, npIoTraps=npIoTraps, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npCurLoopN=npCurLoopN, npThermoMemo=npThermoMemo, npSmokeTable=npSmokeTable, npThermoTraps=npThermoTraps, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, lightcom=lightcom, npIr=npIr, npGsmTrap=npGsmTrap, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, npSmokeTraps=npSmokeTraps, npRelHumStatus=npRelHumStatus, npGsm=npGsm, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelay=npRelay, npRelayN=npRelayN, npSmokeTrap=npSmokeTrap, npThermoTrap=npThermoTrap)
