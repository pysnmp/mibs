...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:42:02 2023
...
TimeTicks, MibIdentifier, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, IpAddress, Counter64, Unsigned32, Integer32, ModuleIdentity, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "IpAddress", "Counter64", "Unsigned32", "Integer32", "ModuleIdentity", "iso", "Counter32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, FixedPoint1000=FixedPoint1000, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopR=npCurLoopR, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npSmokePower=npSmokePower, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npSmoke=npSmoke, npIrStatus=npIrStatus, npGsmFailed=npGsmFailed, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npIrPlayCmd=npIrPlayCmd, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeMemo=npSmokeMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npThermoSensorN=npThermoSensorN, npThermo=npThermo, npIoTrapPrefix=npIoTrapPrefix, npIoLevelIn=npIoLevelIn, npGsmTraps=npGsmTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoLevelOut=npIoLevelOut, npResetStack=npResetStack, npRelHumTable=npRelHumTable, npRelHumidity=npRelHumidity, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npIoMemo=npIoMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopN=npCurLoopN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoSinglePulseStart=npIoSinglePulseStart, npReboot=npReboot, npThermoTrapValue=npThermoTrapValue, npSmokeSensorN=npSmokeSensorN, npIoTable=npIoTable, npThermoLow=npThermoLow, npRelayStartReset=npRelayStartReset, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayEntry=npRelayEntry, npCurLoopStatus=npCurLoopStatus, npRelHumMemo=npRelHumMemo, npIoPulseCounter=npIoPulseCounter, lightcom=lightcom, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrap=npSmokeTrap, npThermoTable=npThermoTable, npIoTrapMemo=npIoTrapMemo, npRelHumValue=npRelHumValue, npCurLoopTrapPower=npCurLoopTrapPower, npThermoStatus=npThermoStatus, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopV=npCurLoopV, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmStrength=npGsmStrength, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npSmokeReset=npSmokeReset, npThermoTrap=npThermoTrap, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npThermoHigh=npThermoHigh, npIoTrap=npIoTrap, npCurLoopPower=npCurLoopPower, npGsmTrap=npGsmTrap, npCurLoop=npCurLoop, npThermoEntry=npThermoEntry, npRelayMemo=npRelayMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTraps=npIoTraps, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npGsmTrapPrefix=npGsmTrapPrefix, npRelayN=npRelayN, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayState=npRelayState, npTrapInfo=npTrapInfo, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npGsm=npGsm, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npGsmRegistration=npGsmRegistration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTemp=npRelHumTrapTemp, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumN=npRelHumN, npGsmInfo=npGsmInfo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npRelHumEntry=npRelHumEntry, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo)
