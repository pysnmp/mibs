...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:16:34 2021
...
Integer32, Gauge32, iso, Counter32, TimeTicks, Counter64, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "iso", "Counter32", "TimeTicks", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopPower=npCurLoopPower, npCurLoopV=npCurLoopV, npTrapInfo=npTrapInfo, npIoLevelIn=npIoLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIo=npIo, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrap=npThermoTrap, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npForcedReboot=npForcedReboot, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelayStartReset=npRelayStartReset, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, lightcom=lightcom, npSmokeReset=npSmokeReset, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoStatus=npThermoStatus, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeEntry=npSmokeEntry, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npRelayN=npRelayN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npRelay=npRelay, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopI=npCurLoopI, npCurLoopTrap=npCurLoopTrap, npIr=npIr, npRelHumTempValue=npRelHumTempValue, npIoTrapMemo=npIoTrapMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npRelayState=npRelayState, npIrCtrl=npIrCtrl, npReboot=npReboot, npThermoEntry=npThermoEntry, npThermoTrapLow=npThermoTrapLow, npRelHumTable=npRelHumTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTable=npThermoTable, npRelayEntry=npRelayEntry, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npRelayTable=npRelayTable, npSmokeMemo=npSmokeMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrap=npGsmTrap, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeTraps=npSmokeTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrap=npSmokeTrap, npRelHumTrapTemp=npRelHumTrapTemp, npGsm=npGsm, npThermoTrapValue=npThermoTrapValue, npResetStack=npResetStack, npRelHumidity=npRelHumidity, npCurLoopTable=npCurLoopTable, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npGsmStrength=npGsmStrength, npIoTrapLevelIn=npIoTrapLevelIn, npTrapEmailTo=npTrapEmailTo, npIoTraps=npIoTraps, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npCurLoopEntry=npCurLoopEntry, npThermoLow=npThermoLow, npIoTrapLineN=npIoTrapLineN, npRelHumN=npRelHumN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeSensorN=npSmokeSensorN, npGsmFailed=npGsmFailed, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopN=npCurLoopN, npCurLoopTraps=npCurLoopTraps, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npThermo=npThermo, npSmokeTable=npSmokeTable, npSoftReboot=npSoftReboot, npSmokePower=npSmokePower, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumStatus=npRelHumStatus, npRelHumTrap=npRelHumTrap, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmoke=npSmoke, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npIoMemo=npIoMemo, npCurLoopTrapI=npCurLoopTrapI, npCurLoopTrapV=npCurLoopTrapV, npThermoHigh=npThermoHigh, npRelHumTrapData=npRelHumTrapData, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail)
