...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:35:59 2024
...
iso, NotificationType, Counter32, ModuleIdentity, MibIdentifier, Counter64, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Gauge32, TimeTicks, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter32", "ModuleIdentity", "MibIdentifier", "Counter64", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Gauge32", "TimeTicks", "Integer32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npRelHumTable=npRelHumTable, npGsmTrapPrefix=npGsmTrapPrefix, npThermoStatus=npThermoStatus, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npIrStatus=npIrStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapR=npCurLoopTrapR, npRelayMode=npRelayMode, npSoftReboot=npSoftReboot, npCurLoopStatus=npCurLoopStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTempStatus=npRelHumTempStatus, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayMemo=npRelayMemo, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, FixedPoint1000=FixedPoint1000, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npThermoValue=npThermoValue, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npThermoSensorN=npThermoSensorN, npCurLoopTraps=npCurLoopTraps, npThermoLow=npThermoLow, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrap=npCurLoopTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapI=npCurLoopTrapI, npSmokeStatus=npSmokeStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumN=npRelHumN, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopR=npCurLoopR, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmRegistration=npGsmRegistration, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmoke=npSmoke, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapFail=npRelHumTrapFail, npCurLoopN=npCurLoopN, npRelayState=npRelayState, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIrCtrl=npIrCtrl, npSmokeEntry=npSmokeEntry, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayStartReset=npRelayStartReset, lightcom=lightcom, npRelHumTrapTemp=npRelHumTrapTemp, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npThermoTable=npThermoTable, npIoTrapLineN=npIoTrapLineN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapHigh=npThermoTrapHigh, npThermoTrap=npThermoTrap, npIo=npIo, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npThermoHigh=npThermoHigh, npThermoTrapValue=npThermoTrapValue, npGsm=npGsm, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npReboot=npReboot, npRelayTable=npRelayTable, npRelHumidity=npRelHumidity, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, npThermoTrapLow=npThermoTrapLow, npRelHumMemo=npRelHumMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapData=npRelHumTrapData, npSmokeTrap=npSmokeTrap, npGsmStrength=npGsmStrength, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npThermoMemo=npThermoMemo, npThermoTraps=npThermoTraps, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeReset=npSmokeReset, npCurLoopPower=npCurLoopPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayN=npRelayN, npThermo=npThermo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmInfo=npGsmInfo, npSmokeTrapStatus=npSmokeTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoop=npCurLoop, npSmokeTable=npSmokeTable, npRelay=npRelay, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeSensorN=npSmokeSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeTraps=npSmokeTraps, npSmokeMemo=npSmokeMemo, npIoLineN=npIoLineN, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopTable=npCurLoopTable, npRelHumStatus=npRelHumStatus, npRelHumTempValue=npRelHumTempValue, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoEntry=npThermoEntry, npRelHumValue=npRelHumValue, npIoMemo=npIoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmFailed=npGsmFailed)
