...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:12:45 2023
...
Unsigned32, IpAddress, TimeTicks, iso, NotificationType, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Integer32, Gauge32, Counter64, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "TimeTicks", "iso", "NotificationType", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Integer32", "Gauge32", "Counter64", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npResetStack=npResetStack, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapV=npCurLoopTrapV, npIoEntry=npIoEntry, npSmoke=npSmoke, npRelHumTempStatus=npRelHumTempStatus, npIrReset=npIrReset, npGsmFailed=npGsmFailed, npThermoSensorN=npThermoSensorN, npRelayTable=npRelayTable, npIoTraps=npIoTraps, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelay=npRelay, npCurLoopV=npCurLoopV, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npThermoEntry=npThermoEntry, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelIn=npIoTrapLevelIn, npGsm=npGsm, npThermoTrapSensorN=npThermoTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoop=npCurLoop, lightcom=lightcom, npIrCtrl=npIrCtrl, npGsmInfo=npGsmInfo, npReboot=npReboot, npRelHumTable=npRelHumTable, npCurLoopStatus=npCurLoopStatus, npSmokeStatus=npSmokeStatus, npThermoValue=npThermoValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopPower=npCurLoopPower, npSmokeTable=npSmokeTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npSmokeEntry=npSmokeEntry, npRelHumTrap=npRelHumTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npThermoTrap=npThermoTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopTrap=npCurLoopTrap, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopR=npCurLoopR, npIoLineN=npIoLineN, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npRelHumEntry=npRelHumEntry, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoStatus=npThermoStatus, npGsmRegistration=npGsmRegistration, npIr=npIr, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapMemo=npIoTrapMemo, npRelayState=npRelayState, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapHigh=npThermoTrapHigh, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npSoftReboot=npSoftReboot, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelayMode=npRelayMode, npCurLoopTable=npCurLoopTable, npSmokeReset=npSmokeReset, FixedPoint1000=FixedPoint1000, npCurLoopTrapN=npCurLoopTrapN, npIoTrap=npIoTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIrStatus=npIrStatus, npRelHumN=npRelHumN, npThermoMemo=npThermoMemo, npThermoTrapLow=npThermoTrapLow, npCurLoopI=npCurLoopI, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrap=npSmokeTrap, npIo=npIo, npThermoTrapValue=npThermoTrapValue, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npThermoLow=npThermoLow, npCurLoopTrapI=npCurLoopTrapI, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npRelayStartReset=npRelayStartReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayEntry=npRelayEntry, npGsmTraps=npGsmTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValuePrecise=npThermoValuePrecise, npGsmTrapPrefix=npGsmTrapPrefix, npIoMemo=npIoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumidity=npRelHumidity, npRelHumValue=npRelHumValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermo=npThermo, npIoTrapLineN=npIoTrapLineN, npRelayMemo=npRelayMemo, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npRelayN=npRelayN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmTrap=npGsmTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe)
