...
# Produced by pysmi-1.1.8 at Sun Jan 16 15:56:06 2022
...
IpAddress, Integer32, enterprises, NotificationType, ObjectIdentity, TimeTicks, iso, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter32, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "enterprises", "NotificationType", "ObjectIdentity", "TimeTicks", "iso", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter32", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermo=npThermo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npRelayState=npRelayState, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npRelHumMemo=npRelHumMemo, npThermoSensorN=npThermoSensorN, npGsmRegistration=npGsmRegistration, npCurLoopPower=npCurLoopPower, npIoEntry=npIoEntry, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npTrapEmailTo=npTrapEmailTo, npCurLoopTrap=npCurLoopTrap, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoTrapPrefix=npIoTrapPrefix, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npIoTraps=npIoTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTraps=npThermoTraps, npRelayStartReset=npRelayStartReset, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npIrStatus=npIrStatus, npSmokeEntry=npSmokeEntry, npRelHumValue=npRelHumValue, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npGsmTrap=npGsmTrap, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npThermoTrap=npThermoTrap, npResetStack=npResetStack, npIoLineN=npIoLineN, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempFail=npRelHumTrapTempFail, npForcedReboot=npForcedReboot, npThermoTrapMemo=npThermoTrapMemo, npGsmStrength=npGsmStrength, npIrPlayCmd=npIrPlayCmd, npSmokeSensorN=npSmokeSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npRelayEntry=npRelayEntry, lightcom=lightcom, npIoTrap=npIoTrap, npThermoHigh=npThermoHigh, npIo=npIo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTable=npSmokeTable, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npGsm=npGsm, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, npIr=npIr, npRelayMode=npRelayMode, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npRelHumN=npRelHumN, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npCurLoopR=npCurLoopR, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrCtrl=npIrCtrl, npRelayN=npRelayN, npIoMemo=npIoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmTrapPrefix=npGsmTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayMemo=npRelayMemo, npRelayTable=npRelayTable, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npReboot=npReboot, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npSmokeTrap=npSmokeTrap, npTrapInfo=npTrapInfo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumidity=npRelHumidity, npRelay=npRelay, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopN=npCurLoopN, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapN=npCurLoopTrapN, npCurLoopStatus=npCurLoopStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npThermoValue=npThermoValue, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, npSmokeTrapSensorN=npSmokeTrapSensorN)
