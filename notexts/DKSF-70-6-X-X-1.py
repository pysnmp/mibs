...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:31:39 2022
...
Unsigned32, ModuleIdentity, Integer32, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, TimeTicks, iso, Counter64, Bits, NotificationType, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Integer32", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "TimeTicks", "iso", "Counter64", "Bits", "NotificationType", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsm=npGsm, npReboot=npReboot, npIoPulseCounter=npIoPulseCounter, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npResetStack=npResetStack, npRelHumTrap=npRelHumTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIrReset=npIrReset, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, npSmokeTraps=npSmokeTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npIoLevelIn=npIoLevelIn, npThermoTable=npThermoTable, npCurLoopTable=npCurLoopTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmStrength=npGsmStrength, npGsmTraps=npGsmTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumN=npRelHumN, npIoLevelOut=npIoLevelOut, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeMemo=npSmokeMemo, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokePower=npSmokePower, npCurLoopN=npCurLoopN, npSoftReboot=npSoftReboot, npThermoTrapValue=npThermoTrapValue, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoSensorN=npThermoSensorN, npCurLoopR=npCurLoopR, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumValue=npRelHumValue, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapStatus=npThermoTrapStatus, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npSmoke=npSmoke, npRelayEntry=npRelayEntry, npThermoHigh=npThermoHigh, npRelHumMemo=npRelHumMemo, npIoTrap=npIoTrap, lightcom=lightcom, npIoTrapLineN=npIoTrapLineN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIo=npIo, npIoLineN=npIoLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayState=npRelayState, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumStatus=npRelHumStatus, npSmokeTrapMemo=npSmokeTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npThermoTraps=npThermoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopV=npCurLoopV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopEntry=npCurLoopEntry, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npThermoTrapLow=npThermoTrapLow, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIrCtrl=npIrCtrl, npThermoEntry=npThermoEntry, npIoTable=npIoTable, npCurLoopTraps=npCurLoopTraps, npForcedReboot=npForcedReboot, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeSensorN=npSmokeSensorN, npIr=npIr, npCurLoopPower=npCurLoopPower, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrap=npSmokeTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapData=npRelHumTrapData, npThermoStatus=npThermoStatus, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmInfo=npGsmInfo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrap=npGsmTrap, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npRelayTable=npRelayTable, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npCurLoopTrapV=npCurLoopTrapV, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTable=npRelHumTable, npRelay=npRelay, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumidity=npRelHumidity, npRelHumTrapDataN=npRelHumTrapDataN, npIoSinglePulseStart=npIoSinglePulseStart, npThermoValue=npThermoValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npIoEntry=npIoEntry, npThermoTrap=npThermoTrap, npIoMemo=npIoMemo, npThermo=npThermo)
