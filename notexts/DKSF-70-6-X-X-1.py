...
# Produced by pysmi-1.1.12 at Wed May 29 08:13:44 2024
...
enterprises, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, MibIdentifier, iso, Counter64, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "Counter64", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrap=npSmokeTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumidity=npRelHumidity, npRelHumTable=npRelHumTable, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, FixedPoint1000=FixedPoint1000, npThermoTraps=npThermoTraps, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npTrapEmailTo=npTrapEmailTo, npRelHumTrap=npRelHumTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npForcedReboot=npForcedReboot, npSoftReboot=npSoftReboot, npRelayN=npRelayN, npCurLoopR=npCurLoopR, npThermoTrapSensorN=npThermoTrapSensorN, npIoEntry=npIoEntry, npIoTable=npIoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapMemo=npThermoTrapMemo, npSmokeSensorN=npSmokeSensorN, npRelHumMemo=npRelHumMemo, npThermoTrapLow=npThermoTrapLow, npGsmTrap=npGsmTrap, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npThermoValue=npThermoValue, npGsmRegistration=npGsmRegistration, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayEntry=npRelayEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npIrCtrl=npIrCtrl, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapFail=npRelHumTrapFail, npIoLevelOut=npIoLevelOut, npCurLoopN=npCurLoopN, npSmokeTraps=npSmokeTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoop=npCurLoop, npCurLoopTraps=npCurLoopTraps, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npIoLevelIn=npIoLevelIn, npCurLoopStatus=npCurLoopStatus, npSmokeTrapMemo=npSmokeTrapMemo, npReboot=npReboot, npRelay=npRelay, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npThermoEntry=npThermoEntry, npCurLoopEntry=npCurLoopEntry, npRelHumTrapSafe=npRelHumTrapSafe, npIoLineN=npIoLineN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoSensorN=npThermoSensorN, npSmoke=npSmoke, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoStatus=npThermoStatus, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIr=npIr, npRelHumStatus=npRelHumStatus, npThermoTable=npThermoTable, npIoTraps=npIoTraps, npIoTrap=npIoTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoHigh=npThermoHigh, npSmokeEntry=npSmokeEntry, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTable=npSmokeTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapValue=npThermoTrapValue, npThermo=npThermo, npGsm=npGsm, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIoPulseCounter=npIoPulseCounter, npRelHumTempStatus=npRelHumTempStatus, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTraps=npGsmTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrReset=npIrReset, npCurLoopTrap=npCurLoopTrap, npSmokeReset=npSmokeReset, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeStatus=npSmokeStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumValue=npRelHumValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npResetStack=npResetStack, npRelayMode=npRelayMode, npRelayMemo=npRelayMemo, npIo=npIo, npCurLoopTable=npCurLoopTable, npSmokePower=npSmokePower, npGsmInfo=npGsmInfo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeMemo=npSmokeMemo, npIrStatus=npIrStatus, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npIrPlayCmd=npIrPlayCmd, npGsmStrength=npGsmStrength, npIoMemo=npIoMemo, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npRelHumTrapData=npRelHumTrapData)
