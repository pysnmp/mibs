...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:03:22 2021
...
Gauge32, Unsigned32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, Integer32, NotificationType, iso, enterprises, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "Integer32", "NotificationType", "iso", "enterprises", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopStatus=npCurLoopStatus, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmFailed=npGsmFailed, npThermoLow=npThermoLow, npGsm=npGsm, npIo=npIo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayN=npRelayN, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmInfo=npGsmInfo, npThermoTable=npThermoTable, npSmokeTrap=npSmokeTrap, npGsmTrap=npGsmTrap, npCurLoopN=npCurLoopN, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npIoTrapPrefix=npIoTrapPrefix, npGsmTraps=npGsmTraps, npIrStatus=npIrStatus, npRelHumTrapData=npRelHumTrapData, npIrCtrl=npIrCtrl, npRelHumValue=npRelHumValue, npSmokeMemo=npSmokeMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayEntry=npRelayEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValue=npThermoValue, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopPower=npCurLoopPower, npGsmStrength=npGsmStrength, npRelHumTrapTemp=npRelHumTrapTemp, npIoLevelOut=npIoLevelOut, npThermoHigh=npThermoHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeEntry=npSmokeEntry, npCurLoopTrapR=npCurLoopTrapR, npSmokeTable=npSmokeTable, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npIoEntry=npIoEntry, npIrReset=npIrReset, npResetStack=npResetStack, npSmokePower=npSmokePower, npIoTraps=npIoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayState=npRelayState, npIoLevelIn=npIoLevelIn, FixedPoint1000=FixedPoint1000, npIoTrap=npIoTrap, npCurLoopV=npCurLoopV, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoop=npCurLoop, npRelayMemo=npRelayMemo, npGsmRegistration=npGsmRegistration, npThermoTrap=npThermoTrap, npRelHumTrapFail=npRelHumTrapFail, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, lightcom=lightcom, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeSensorN=npSmokeSensorN, npThermoSensorN=npThermoSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npRelHumStatus=npRelHumStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIr=npIr, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoPulseCounter=npIoPulseCounter, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapLow=npThermoTrapLow, npCurLoopTrapI=npCurLoopTrapI, npIoTrapLevelIn=npIoTrapLevelIn, npThermo=npThermo, npForcedReboot=npForcedReboot, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, npThermoValuePrecise=npThermoValuePrecise, npTrapEmailTo=npTrapEmailTo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrap=npRelHumTrap, npSoftReboot=npSoftReboot, npThermoEntry=npThermoEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npReboot=npReboot, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npCurLoopTable=npCurLoopTable, npCurLoopI=npCurLoopI, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTraps=npThermoTraps, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npRelHumN=npRelHumN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumMemo=npRelHumMemo, npCurLoopTrapV=npCurLoopTrapV, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npRelayStartReset=npRelayStartReset, npThermoStatus=npThermoStatus, npIoTable=npIoTable, npRelay=npRelay)
