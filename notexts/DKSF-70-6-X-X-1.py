...
# Produced by pysmi-1.1.8 at Tue Sep 12 12:18:51 2023
...
iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, MibIdentifier, Counter32, Bits, ModuleIdentity, TimeTicks, IpAddress, Counter64, Unsigned32, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter32", "Bits", "ModuleIdentity", "TimeTicks", "IpAddress", "Counter64", "Unsigned32", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTable=npThermoTable, npGsmTraps=npGsmTraps, npThermo=npThermo, npIoTraps=npIoTraps, npIoTrapLineN=npIoTrapLineN, npCurLoopTable=npCurLoopTable, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npCurLoopTraps=npCurLoopTraps, npSmokeTable=npSmokeTable, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTraps=npThermoTraps, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeEntry=npSmokeEntry, npGsmRegistration=npGsmRegistration, npIr=npIr, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapI=npCurLoopTrapI, npIoLevelOut=npIoLevelOut, npRelHumMemo=npRelHumMemo, npThermoTrapPrefix=npThermoTrapPrefix, npIoLineN=npIoLineN, npRelHumValue=npRelHumValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npRelHumTrapFail=npRelHumTrapFail, npRelayState=npRelayState, npIoEntry=npIoEntry, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npSmokeStatus=npSmokeStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npRelHumidity=npRelHumidity, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npGsmStrength=npGsmStrength, npRelHumTrapDataN=npRelHumTrapDataN, npRelayTable=npRelayTable, npCurLoopN=npCurLoopN, npSmokePower=npSmokePower, npIoSinglePulseStart=npIoSinglePulseStart, npIoMemo=npIoMemo, npIoTrapPrefix=npIoTrapPrefix, npIrCtrl=npIrCtrl, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npCurLoopTrap=npCurLoopTrap, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempValue=npRelHumTempValue, npIoPulseCounter=npIoPulseCounter, npThermoHigh=npThermoHigh, npSoftReboot=npSoftReboot, npCurLoopV=npCurLoopV, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrap=npIoTrap, npRelHumTable=npRelHumTable, npGsmTrap=npGsmTrap, npCurLoopStatus=npCurLoopStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoStatus=npThermoStatus, FixedPoint1000=FixedPoint1000, npSmokeMemo=npSmokeMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoTrapLevelIn=npIoTrapLevelIn, npIoTable=npIoTable, npGsm=npGsm, npThermoLow=npThermoLow, npCurLoopTrapN=npCurLoopTrapN, npRelHumEntry=npRelHumEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npForcedReboot=npForcedReboot, npReboot=npReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopEntry=npCurLoopEntry, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npTrapInfo=npTrapInfo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopR=npCurLoopR, npGsmFailed=npGsmFailed, npThermoTrapStatus=npThermoTrapStatus, npSmokeReset=npSmokeReset, npRelayEntry=npRelayEntry, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrap=npRelHumTrap, npCurLoopTrapV=npCurLoopTrapV, npCurLoop=npCurLoop, npThermoValuePrecise=npThermoValuePrecise, npSmoke=npSmoke, npResetStack=npResetStack, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npIrReset=npIrReset, npRelayN=npRelayN, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrap=npSmokeTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npIrPlayCmd=npIrPlayCmd, npThermoSensorN=npThermoSensorN, npRelHumTrapDataStatus=npRelHumTrapDataStatus)
