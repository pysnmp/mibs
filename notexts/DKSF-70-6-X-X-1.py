...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, IpAddress, Counter32, Integer32, Bits, NotificationType, ObjectIdentity, enterprises, ModuleIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "IpAddress", "Counter32", "Integer32", "Bits", "NotificationType", "ObjectIdentity", "enterprises", "ModuleIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npThermoValue=npThermoValue, npIoTrap=npIoTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, npCurLoopV=npCurLoopV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoHigh=npThermoHigh, npRelayStartReset=npRelayStartReset, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npSmokeTrapPrefix=npSmokeTrapPrefix, npTrapEmailTo=npTrapEmailTo, npRelayState=npRelayState, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmInfo=npGsmInfo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataN=npRelHumTrapDataN, npForcedReboot=npForcedReboot, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoEntry=npThermoEntry, npIoEntry=npIoEntry, npRelHumValue=npRelHumValue, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npCurLoopTrapPower=npCurLoopTrapPower, npGsmRegistration=npGsmRegistration, npRelayMode=npRelayMode, npIoLineN=npIoLineN, npResetStack=npResetStack, npSmokeTable=npSmokeTable, npSmokeSensorN=npSmokeSensorN, npThermoTrapMemo=npThermoTrapMemo, npThermo=npThermo, npRelHumTrapFail=npRelHumTrapFail, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoop=npCurLoop, npThermoTrapLow=npThermoTrapLow, npSmokeMemo=npSmokeMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmoke=npSmoke, npIoTraps=npIoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopN=npCurLoopN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, FixedPoint1000=FixedPoint1000, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeEntry=npSmokeEntry, npThermoValuePrecise=npThermoValuePrecise, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapI=npCurLoopTrapI, npSmokePower=npSmokePower, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npRelHumStatus=npRelHumStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTable=npRelHumTable, npRelHumTempValue=npRelHumTempValue, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelayTable=npRelayTable, npCurLoopR=npCurLoopR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npReboot=npReboot, npCurLoopEntry=npCurLoopEntry, npRelayEntry=npRelayEntry, npRelHumTrapTempFail=npRelHumTrapTempFail, npIrReset=npIrReset, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrap=npRelHumTrap, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeStatus=npSmokeStatus, npRelHumidity=npRelHumidity, npRelayMemo=npRelayMemo, npCurLoopTable=npCurLoopTable, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npThermoMemo=npThermoMemo, npRelayN=npRelayN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIo=npIo, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoPulseCounter=npIoPulseCounter, npGsm=npGsm, npIoTrapLevelLegend=npIoTrapLevelLegend, npThermoTable=npThermoTable, npThermoSensorN=npThermoSensorN, npGsmStrength=npGsmStrength, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeTraps=npSmokeTraps, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopStatus=npCurLoopStatus, npCurLoopTraps=npCurLoopTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, npIoLevelIn=npIoLevelIn, npIoTrapMemo=npIoTrapMemo, npGsmTraps=npGsmTraps, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSoftReboot=npSoftReboot, npCurLoopI=npCurLoopI, npIoTrapPrefix=npIoTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeReset=npSmokeReset, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npCurLoopPower=npCurLoopPower, npIr=npIr, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npCurLoopTrapR=npCurLoopTrapR, npThermoStatus=npThermoStatus, npCurLoopTrapV=npCurLoopTrapV)
