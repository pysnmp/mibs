...
# Produced by pysmi-1.1.8 at Thu Oct 26 12:20:07 2023
...
TimeTicks, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter64, Gauge32, Counter32, Integer32, NotificationType, ObjectIdentity, Bits, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter64", "Gauge32", "Counter32", "Integer32", "NotificationType", "ObjectIdentity", "Bits", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npIrPlayCmd=npIrPlayCmd, npCurLoopR=npCurLoopR, npSmokeMemo=npSmokeMemo, npGsmInfo=npGsmInfo, lightcom=lightcom, npCurLoop=npCurLoop, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npGsmRegistration=npGsmRegistration, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelay=npRelay, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoHigh=npThermoHigh, npRelayEntry=npRelayEntry, npSmoke=npSmoke, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLineN=npIoTrapLineN, npSmokeEntry=npSmokeEntry, npSmokeStatus=npSmokeStatus, npResetStack=npResetStack, FixedPoint1000=FixedPoint1000, npThermoMemo=npThermoMemo, npIo=npIo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumN=npRelHumN, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV, npSmokeTable=npSmokeTable, npRelHumTrapSafe=npRelHumTrapSafe, npSmokePower=npSmokePower, npRelHumTempValue=npRelHumTempValue, npReboot=npReboot, npSmokeReset=npSmokeReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTrapMemo=npIoTrapMemo, npCurLoopPower=npCurLoopPower, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumMemo=npRelHumMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, npRelHumTrapTemp=npRelHumTrapTemp, npIoPulseCounter=npIoPulseCounter, npCurLoopEntry=npCurLoopEntry, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTable=npThermoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npCurLoopN=npCurLoopN, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrap=npThermoTrap, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npIrReset=npIrReset, npRelHumTempStatus=npRelHumTempStatus, npSoftReboot=npSoftReboot, npForcedReboot=npForcedReboot, npCurLoopTable=npCurLoopTable, npRelHumTable=npRelHumTable, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValue=npThermoValue, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTraps=npGsmTraps, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npGsmStrength=npGsmStrength, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npGsmTrap=npGsmTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npCurLoopTraps=npCurLoopTraps, npRelHumValue=npRelHumValue, npGsm=npGsm, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrap=npRelHumTrap, npRelHumTrapFail=npRelHumTrapFail, npIoMemo=npIoMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrap=npSmokeTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npIoTable=npIoTable, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopV=npCurLoopV, npRelayMode=npRelayMode, npThermoTraps=npThermoTraps, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmFailed=npGsmFailed, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayTable=npRelayTable, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIr=npIr, npSmokeTraps=npSmokeTraps, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelayMemo=npRelayMemo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopI=npCurLoopI, npIrCtrl=npIrCtrl, npCurLoopTrapN=npCurLoopTrapN, npIoLineN=npIoLineN, npRelayState=npRelayState, npThermo=npThermo, npIoEntry=npIoEntry, npCurLoopTrapR=npCurLoopTrapR, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrap=npCurLoopTrap)
