...
# Produced by pysmi-1.1.12 at Tue Jun  4 08:33:09 2024
...
enterprises, Counter64, Counter32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, IpAddress, iso, MibIdentifier, Gauge32, TimeTicks, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Counter32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "IpAddress", "iso", "MibIdentifier", "Gauge32", "TimeTicks", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapLow=npThermoTrapLow, npGsmInfo=npGsmInfo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIrReset=npIrReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapSensorN=npThermoTrapSensorN, npIoPulseCounter=npIoPulseCounter, npRelHumTable=npRelHumTable, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTemp=npRelHumTrapTemp, npThermoValue=npThermoValue, npRelayStartReset=npRelayStartReset, npCurLoopTable=npCurLoopTable, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTempStatus=npRelHumTempStatus, npSmokeMemo=npSmokeMemo, npRelHumMemo=npRelHumMemo, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npGsmRegistration=npGsmRegistration, npIoTrapLineN=npIoTrapLineN, npThermoStatus=npThermoStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrapSensorN=npSmokeTrapSensorN, FixedPoint1000=FixedPoint1000, npIoLineN=npIoLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataValue=npRelHumTrapDataValue, npIo=npIo, npSmokeTrapPrefix=npSmokeTrapPrefix, npSoftReboot=npSoftReboot, npRelHumTrapFail=npRelHumTrapFail, npIoTraps=npIoTraps, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npIoLevelOut=npIoLevelOut, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmoke=npSmoke, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeEntry=npSmokeEntry, npRelHumEntry=npRelHumEntry, npCurLoopEntry=npCurLoopEntry, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayTable=npRelayTable, npIoTrap=npIoTrap, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npIrPlayCmd=npIrPlayCmd, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npGsm=npGsm, npRelayMode=npRelayMode, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npRelHumTrap=npRelHumTrap, npCurLoopTraps=npCurLoopTraps, npThermoSensorN=npThermoSensorN, npIoTable=npIoTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrap=npCurLoopTrap, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npThermoLow=npThermoLow, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrStatus=npIrStatus, npIrCtrl=npIrCtrl, npSmokeTrap=npSmokeTrap, lightcom=lightcom, npSmokeSensorN=npSmokeSensorN, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npCurLoopPower=npCurLoopPower, npRelHumValue=npRelHumValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTrap=npGsmTrap, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npRelHumidity=npRelHumidity, npThermo=npThermo, npIoEntry=npIoEntry, npIoTrapLevelIn=npIoTrapLevelIn, npThermoTrapValue=npThermoTrapValue, npCurLoopV=npCurLoopV, npRelayMemo=npRelayMemo, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapN=npCurLoopTrapN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayN=npRelayN, npRelHumStatus=npRelHumStatus, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoLevelIn=npIoLevelIn, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrap=npThermoTrap, npCurLoop=npCurLoop, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTable=npThermoTable, npCurLoopTrapR=npCurLoopTrapR, npTrapEmailTo=npTrapEmailTo, npRelay=npRelay, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoHigh=npThermoHigh, npThermoTrapHigh=npThermoTrapHigh, npIoTrapMemo=npIoTrapMemo, npRelayEntry=npRelayEntry, npGsmStrength=npGsmStrength, npThermoEntry=npThermoEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTraps=npSmokeTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npTrapInfo=npTrapInfo, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeStatus=npSmokeStatus, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset)
