...
enterprises, Integer32, IpAddress, Bits, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Counter64, Unsigned32, ObjectIdentity, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "IpAddress", "Bits", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Counter64", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npCurLoopI=npCurLoopI, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoTable=npThermoTable, npGsmStrength=npGsmStrength, npThermoStatus=npThermoStatus, npCurLoop=npCurLoop, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npRelHumidity=npRelHumidity, npIrPlayCmd=npIrPlayCmd, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoEntry=npThermoEntry, npGsmRegistration=npGsmRegistration, npCurLoopTrap=npCurLoopTrap, npSmokeReset=npSmokeReset, npRelayMemo=npRelayMemo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npThermoTraps=npThermoTraps, npThermoTrap=npThermoTrap, npIoTrapPrefix=npIoTrapPrefix, npThermoValue=npThermoValue, npIr=npIr, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrap=npIoTrap, npRelayEntry=npRelayEntry, npIrReset=npIrReset, npGsmFailed=npGsmFailed, npSmoke=npSmoke, npReboot=npReboot, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npTrapInfo=npTrapInfo, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapPower=npCurLoopTrapPower, npSoftReboot=npSoftReboot, npSmokeTraps=npSmokeTraps, npIoPulseCounter=npIoPulseCounter, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmTrap=npGsmTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoSensorN=npThermoSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelayState=npRelayState, npCurLoopR=npCurLoopR, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopStatus=npCurLoopStatus, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npCurLoopN=npCurLoopN, npRelay=npRelay, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopPower=npCurLoopPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npThermoLow=npThermoLow, npIrStatus=npIrStatus, npIo=npIo, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTempValue=npRelHumTempValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumN=npRelHumN, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapHigh=npThermoTrapHigh, npRelHumStatus=npRelHumStatus, npRelHumMemo=npRelHumMemo, npSmokeTable=npSmokeTable, npRelHumTempStatus=npRelHumTempStatus, npIoLevelIn=npIoLevelIn, npIoEntry=npIoEntry, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npSmokeSensorN=npSmokeSensorN, npRelayTable=npRelayTable, lightcom=lightcom, npRelHumTrapSafe=npRelHumTrapSafe, npThermoValuePrecise=npThermoValuePrecise, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapStatus=npCurLoopTrapStatus, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npSmokeMemo=npSmokeMemo, npRelayStartReset=npRelayStartReset, npSmokeEntry=npSmokeEntry, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayN=npRelayN, npForcedReboot=npForcedReboot, npGsmTraps=npGsmTraps, npCurLoopV=npCurLoopV, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapMemo=npSmokeTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npRelHumValue=npRelHumValue, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npIoTrapMemo=npIoTrapMemo, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTable=npCurLoopTable, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumEntry=npRelHumEntry)
