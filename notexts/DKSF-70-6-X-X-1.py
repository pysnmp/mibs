...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrapMemo=npSmokeTrapMemo, npThermoStatus=npThermoStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npThermoTable=npThermoTable, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapLineN=npIoTrapLineN, npThermoMemo=npThermoMemo, npThermo=npThermo, npRelayMode=npRelayMode, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTempValue=npRelHumTempValue, npSoftReboot=npSoftReboot, npIrPlayCmd=npIrPlayCmd, npSmokeStatus=npSmokeStatus, npCurLoopStatus=npCurLoopStatus, npRelayMemo=npRelayMemo, npThermoTrap=npThermoTrap, npRelHumTrap=npRelHumTrap, npSmokePower=npSmokePower, npForcedReboot=npForcedReboot, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapI=npCurLoopTrapI, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTrap=npSmokeTrap, npCurLoopI=npCurLoopI, npIoPulseCounter=npIoPulseCounter, npSmokeTraps=npSmokeTraps, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopPower=npCurLoopPower, npCurLoopN=npCurLoopN, npIrCtrl=npIrCtrl, npSmokeMemo=npSmokeMemo, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoSensorN=npThermoSensorN, npThermoTrapValue=npThermoTrapValue, npRelayEntry=npRelayEntry, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumValue=npRelHumValue, npThermoTrapMemo=npThermoTrapMemo, npIoSinglePulseStart=npIoSinglePulseStart, npRelayStartReset=npRelayStartReset, npRelHumTable=npRelHumTable, npIr=npIr, npThermoTrapStatus=npThermoTrapStatus, npRelay=npRelay, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapMemo=npIoTrapMemo, npRelHumTempStatus=npRelHumTempStatus, npRelHumMemo=npRelHumMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapV=npCurLoopTrapV, npThermoValuePrecise=npThermoValuePrecise, npThermoTraps=npThermoTraps, npCurLoopTraps=npCurLoopTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npResetStack=npResetStack, npCurLoopV=npCurLoopV, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoEntry=npIoEntry, npCurLoopR=npCurLoopR, npRelHumidity=npRelHumidity, npIoTrap=npIoTrap, npIoLevelOut=npIoLevelOut, npRelHumStatus=npRelHumStatus, npThermoValue=npThermoValue, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoHigh=npThermoHigh, npIoTable=npIoTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmStrength=npGsmStrength, npGsmInfo=npGsmInfo, npThermoLow=npThermoLow, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumN=npRelHumN, npThermoEntry=npThermoEntry, npGsmFailed=npGsmFailed, npRelayN=npRelayN, npCurLoopTable=npCurLoopTable, npCurLoop=npCurLoop, npGsmTrap=npGsmTrap, npGsmTraps=npGsmTraps, npSmokeTable=npSmokeTable, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoTrapHigh=npThermoTrapHigh, lightcom=lightcom, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIrStatus=npIrStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopEntry=npCurLoopEntry, npThermoTrapSensorN=npThermoTrapSensorN, npIoLineN=npIoLineN, FixedPoint1000=FixedPoint1000, npGsm=npGsm, npIrReset=npIrReset, npRelHumEntry=npRelHumEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayState=npRelayState, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npSmokeEntry=npSmokeEntry, npIoTraps=npIoTraps)
