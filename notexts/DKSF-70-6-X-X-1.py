...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:20:10 2022
...
ObjectIdentity, Gauge32, enterprises, Counter64, MibIdentifier, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, Counter32, IpAddress, iso, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "enterprises", "Counter64", "MibIdentifier", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "Counter32", "IpAddress", "iso", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTempStatus=npRelHumTempStatus, npRelHumidity=npRelHumidity, npThermoEntry=npThermoEntry, npIoPulseCounter=npIoPulseCounter, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrap=npIoTrap, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoLow=npThermoLow, npCurLoopTable=npCurLoopTable, npIrReset=npIrReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumValue=npRelHumValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopTraps=npCurLoopTraps, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeSensorN=npSmokeSensorN, npRelayState=npRelayState, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmStrength=npGsmStrength, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapValue=npThermoTrapValue, npRelHumTrapData=npRelHumTrapData, npIoLevelIn=npIoLevelIn, npThermoMemo=npThermoMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoSensorN=npThermoSensorN, npRelHumTrap=npRelHumTrap, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, npRelayN=npRelayN, npSmokeTraps=npSmokeTraps, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npSmokeMemo=npSmokeMemo, npSmokePower=npSmokePower, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumN=npRelHumN, npThermoTrap=npThermoTrap, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrapSensorN=npSmokeTrapSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeReset=npSmokeReset, npThermoTrapMemo=npThermoTrapMemo, npRelay=npRelay, npRelayStartReset=npRelayStartReset, npSmokeStatus=npSmokeStatus, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npRelHumEntry=npRelHumEntry, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIr=npIr, npThermoValue=npThermoValue, npCurLoopR=npCurLoopR, npCurLoopV=npCurLoopV, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npGsm=npGsm, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npGsmTrap=npGsmTrap, npIoLevelOut=npIoLevelOut, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npResetStack=npResetStack, npThermoStatus=npThermoStatus, npThermoTrapHigh=npThermoTrapHigh, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmoke=npSmoke, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelayMemo=npRelayMemo, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npSmokeTrap=npSmokeTrap, npReboot=npReboot, npTrapEmailTo=npTrapEmailTo, npRelayMode=npRelayMode, npSmokeEntry=npSmokeEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npIoTable=npIoTable, npGsmTraps=npGsmTraps, npIoTraps=npIoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumMemo=npRelHumMemo, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npTrapInfo=npTrapInfo, npRelayTable=npRelayTable, npCurLoop=npCurLoop, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopPower=npCurLoopPower, npIoTrapPrefix=npIoTrapPrefix, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmFailed=npGsmFailed, npIoLineN=npIoLineN, npForcedReboot=npForcedReboot, npIoTrapMemo=npIoTrapMemo, npIoEntry=npIoEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npIo=npIo, npRelHumTrapFail=npRelHumTrapFail, npThermoHigh=npThermoHigh)
