...
# Produced by pysmi-1.1.12 at Mon Oct  7 02:56:26 2024
...
TimeTicks, enterprises, Integer32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, ModuleIdentity, Counter32, Bits, Gauge32, Unsigned32, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Integer32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "Unsigned32", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npCurLoop=npCurLoop, npRelay=npRelay, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npIr=npIr, npSmokeTable=npSmokeTable, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npRelayTable=npRelayTable, npThermo=npThermo, npIoTrapMemo=npIoTrapMemo, npCurLoopStatus=npCurLoopStatus, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopPower=npCurLoopPower, npIrReset=npIrReset, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopI=npCurLoopI, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npGsmRegistration=npGsmRegistration, npIoTable=npIoTable, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapAllEvents=npRelHumTrapAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTraps=npIoTraps, npSmokeStatus=npSmokeStatus, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTraps=npSmokeTraps, npSmokePower=npSmokePower, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrapMemo=npSmokeTrapMemo, npIrCtrl=npIrCtrl, npReboot=npReboot, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoEntry=npThermoEntry, npCurLoopTraps=npCurLoopTraps, npThermoTraps=npThermoTraps, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, npThermoLow=npThermoLow, npSmoke=npSmoke, npGsmStrength=npGsmStrength, npCurLoopTrapR=npCurLoopTrapR, npCurLoopR=npCurLoopR, npRelHumTrapDataN=npRelHumTrapDataN, npGsmTrap=npGsmTrap, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapStatus=npThermoTrapStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapN=npCurLoopTrapN, npThermoMemo=npThermoMemo, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npGsmTraps=npGsmTraps, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayMode=npRelayMode, npIoLevelIn=npIoLevelIn, npThermoValue=npThermoValue, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumN=npRelHumN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrap=npCurLoopTrap, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npGsmFailed=npGsmFailed, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTable=npRelHumTable, npGsm=npGsm, npSmokeSensorN=npSmokeSensorN, npThermoStatus=npThermoStatus, npRelayStartReset=npRelayStartReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, FixedPoint1000=FixedPoint1000, npSmokeTrap=npSmokeTrap, npCurLoopTable=npCurLoopTable, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTrapPrefix=npGsmTrapPrefix, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, lightcom=lightcom, npTrapEmailTo=npTrapEmailTo, npRelHumEntry=npRelHumEntry, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npThermoTable=npThermoTable, npRelHumidity=npRelHumidity, npRelayState=npRelayState, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapFail=npRelHumTrapFail, npSmokeEntry=npSmokeEntry, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
