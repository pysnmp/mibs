...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:47:34 2023
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, NotificationType, iso, enterprises, ModuleIdentity, Counter32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "NotificationType", "iso", "enterprises", "ModuleIdentity", "Counter32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npRelHumidity=npRelHumidity, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoHigh=npThermoHigh, npSmokeStatus=npSmokeStatus, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrPlayCmd=npIrPlayCmd, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoValue=npThermoValue, npRelayMode=npRelayMode, npCurLoopV=npCurLoopV, npRelHumN=npRelHumN, npSmokeTable=npSmokeTable, npRelHumEntry=npRelHumEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoMemo=npIoMemo, npIoEntry=npIoEntry, npIrCtrl=npIrCtrl, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npCurLoopR=npCurLoopR, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npThermoEntry=npThermoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTraps=npCurLoopTraps, npThermoTable=npThermoTable, npSmoke=npSmoke, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoLow=npThermoLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoTrapMemo=npThermoTrapMemo, npResetStack=npResetStack, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumStatus=npRelHumStatus, npThermo=npThermo, npReboot=npReboot, npThermoTrapLow=npThermoTrapLow, npRelHumTrapData=npRelHumTrapData, npSmokeReset=npSmokeReset, npTrapInfo=npTrapInfo, npCurLoop=npCurLoop, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTable=npCurLoopTable, lightcom=lightcom, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsmTraps=npGsmTraps, npRelayEntry=npRelayEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, FixedPoint1000=FixedPoint1000, npIrStatus=npIrStatus, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npTrapEmailTo=npTrapEmailTo, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npGsmTrap=npGsmTrap, npThermoStatus=npThermoStatus, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npGsmStrength=npGsmStrength, npIr=npIr, npSmokeSensorN=npSmokeSensorN, npIoTrapLineN=npIoTrapLineN, npSoftReboot=npSoftReboot, npCurLoopPower=npCurLoopPower, npSmokeMemo=npSmokeMemo, npSmokeTraps=npSmokeTraps, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npForcedReboot=npForcedReboot, npRelayMemo=npRelayMemo, npGsmInfo=npGsmInfo, npCurLoopEntry=npCurLoopEntry, npIoLevelOut=npIoLevelOut, npThermoTrapStatus=npThermoTrapStatus, npThermoTrap=npThermoTrap, npIo=npIo, npIoTrap=npIoTrap, npIoTable=npIoTable, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTraps=npIoTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTraps=npThermoTraps, npRelayState=npRelayState, npThermoValuePrecise=npThermoValuePrecise, npSmokePower=npSmokePower, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npThermoSensorN=npThermoSensorN, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrap=npRelHumTrap, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopN=npCurLoopN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseStart=npIoSinglePulseStart, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npRelayN=npRelayN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTempStatus=npRelHumTempStatus, npIoPulseCounter=npIoPulseCounter, npRelHumMemo=npRelHumMemo, npRelHumTrapSafe=npRelHumTrapSafe, npGsmFailed=npGsmFailed, npThermoTrapHigh=npThermoTrapHigh, npRelHumTable=npRelHumTable, npGsmRegistration=npGsmRegistration, npRelHumTrapDataN=npRelHumTrapDataN, npGsm=npGsm, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopI=npCurLoopI, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoMemo=npThermoMemo)
