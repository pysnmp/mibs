...
# Produced by pysmi-1.1.8 at Thu Sep 15 10:12:45 2022
...
Integer32, NotificationType, ObjectIdentity, Gauge32, IpAddress, MibIdentifier, enterprises, Counter32, iso, ModuleIdentity, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "MibIdentifier", "enterprises", "Counter32", "iso", "ModuleIdentity", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npGsmTrap=npGsmTrap, npGsm=npGsm, npRelHumidity=npRelHumidity, npGsmFailed=npGsmFailed, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopI=npCurLoopI, npThermoLow=npThermoLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrap=npThermoTrap, npCurLoopPower=npCurLoopPower, npThermoHigh=npThermoHigh, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoLevelIn=npIoLevelIn, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokePower=npSmokePower, npTrapEmailTo=npTrapEmailTo, npSmokeReset=npSmokeReset, npRelHumTrapDataN=npRelHumTrapDataN, npIr=npIr, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npIrReset=npIrReset, npThermoStatus=npThermoStatus, npIrPlayCmd=npIrPlayCmd, npRelHumTrapData=npRelHumTrapData, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrapV=npCurLoopTrapV, npIoPulseCounter=npIoPulseCounter, npReboot=npReboot, npThermoSensorN=npThermoSensorN, npCurLoopTable=npCurLoopTable, npSmokeTraps=npSmokeTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoValue=npThermoValue, npThermoValuePrecise=npThermoValuePrecise, npIrStatus=npIrStatus, npGsmInfo=npGsmInfo, npRelHumTable=npRelHumTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTable=npSmokeTable, npIrCtrl=npIrCtrl, npSmoke=npSmoke, npRelHumTrap=npRelHumTrap, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrapStatus=npThermoTrapStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTable=npIoTable, npGsmStrength=npGsmStrength, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumEntry=npRelHumEntry, npIoEntry=npIoEntry, npCurLoopTrapI=npCurLoopTrapI, npCurLoopR=npCurLoopR, npCurLoop=npCurLoop, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoMemo=npIoMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npThermoTrapValue=npThermoTrapValue, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoTraps=npIoTraps, npRelHumStatus=npRelHumStatus, npRelayStartReset=npRelayStartReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumValue=npRelHumValue, npForcedReboot=npForcedReboot, npGsmTraps=npGsmTraps, npThermo=npThermo, npRelayEntry=npRelayEntry, npResetStack=npResetStack, npCurLoopN=npCurLoopN, npRelayMemo=npRelayMemo, npSmokeEntry=npSmokeEntry, npCurLoopTraps=npCurLoopTraps, npGsmRegistration=npGsmRegistration, npSmokeStatus=npSmokeStatus, npSoftReboot=npSoftReboot, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapSensorN=npThermoTrapSensorN, npRelayTable=npRelayTable, npSmokeMemo=npSmokeMemo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npRelayN=npRelayN, npTrapInfo=npTrapInfo, npCurLoopV=npCurLoopV, npCurLoopEntry=npCurLoopEntry, npRelayMode=npRelayMode, npIo=npIo, npRelayState=npRelayState, lightcom=lightcom, npIoTrap=npIoTrap, npThermoTraps=npThermoTraps, npSmokeTrap=npSmokeTrap, npIoLineN=npIoLineN, npRelHumMemo=npRelHumMemo, npIoTrapPrefix=npIoTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npSmokeSensorN=npSmokeSensorN, npIoLevelOut=npIoLevelOut, npCurLoopStatus=npCurLoopStatus, npRelHumTrapSafe=npRelHumTrapSafe, npThermoTable=npThermoTable, npRelay=npRelay, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempStatus=npRelHumTempStatus, npThermoEntry=npThermoEntry, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8)
