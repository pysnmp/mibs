...
# Produced by pysmi-1.1.8 at Thu Oct 26 11:10:49 2023
...
Integer32, IpAddress, Counter64, iso, Gauge32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Counter64", "iso", "Gauge32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapHigh=npThermoTrapHigh, npGsmInfo=npGsmInfo, npCurLoopR=npCurLoopR, npRelay=npRelay, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelayState=npRelayState, npThermoSensorN=npThermoSensorN, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmTraps=npGsmTraps, npCurLoopN=npCurLoopN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumMemo=npRelHumMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapFail=npRelHumTrapFail, npTrapEmailTo=npTrapEmailTo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapN=npCurLoopTrapN, npReboot=npReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoStatus=npThermoStatus, npIoLineN=npIoLineN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npThermoTraps=npThermoTraps, npIoTrapLineN=npIoTrapLineN, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIrStatus=npIrStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrap=npThermoTrap, npThermoValuePrecise=npThermoValuePrecise, npSmokeTable=npSmokeTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoEntry=npThermoEntry, npIr=npIr, npSoftReboot=npSoftReboot, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMode=npRelayMode, npSmokeStatus=npSmokeStatus, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, lightcom=lightcom, npIoTrap=npIoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempValue=npRelHumTempValue, npIoLevelIn=npIoLevelIn, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelayN=npRelayN, npIoTrapMemo=npIoTrapMemo, npThermoValue=npThermoValue, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npRelayEntry=npRelayEntry, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npResetStack=npResetStack, npIoTraps=npIoTraps, npForcedReboot=npForcedReboot, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumidity=npRelHumidity, npThermoTrapValue=npThermoTrapValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoEntry=npIoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npRelHumN=npRelHumN, npCurLoopTrapPower=npCurLoopTrapPower, npRelayStartReset=npRelayStartReset, npCurLoopTable=npCurLoopTable, npRelHumTrap=npRelHumTrap, npCurLoopTrapV=npCurLoopTrapV, npSmokeTrapMemo=npSmokeTrapMemo, npIoMemo=npIoMemo, npThermo=npThermo, npThermoTrapMemo=npThermoTrapMemo, npCurLoopI=npCurLoopI, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npThermoTrapLow=npThermoTrapLow, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumEntry=npRelHumEntry, npCurLoopTrap=npCurLoopTrap, npThermoMemo=npThermoMemo, npRelHumStatus=npRelHumStatus, npCurLoopEntry=npCurLoopEntry, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmRegistration=npGsmRegistration, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapR=npCurLoopTrapR, npGsmFailed=npGsmFailed, npSmoke=npSmoke, npThermoTable=npThermoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npTrapInfo=npTrapInfo, npCurLoopStatus=npCurLoopStatus, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTraps=npCurLoopTraps, npSmokeTrapStatus=npSmokeTrapStatus, npGsmStrength=npGsmStrength, npGsm=npGsm, npRelHumValue=npRelHumValue, npSmokeTrap=npSmokeTrap, npIo=npIo, npThermoTrapSensorN=npThermoTrapSensorN, npThermoHigh=npThermoHigh, npIoTable=npIoTable, npCurLoopPower=npCurLoopPower, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelayMemo=npRelayMemo, npRelHumTrapSafe=npRelHumTrapSafe, npSmokeMemo=npSmokeMemo, npIrPlayCmd=npIrPlayCmd, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npRelHumTrapData=npRelHumTrapData)
