...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:10:21 2022
...
Counter32, TimeTicks, Gauge32, NotificationType, Counter64, ModuleIdentity, iso, MibIdentifier, Unsigned32, enterprises, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "iso", "MibIdentifier", "Unsigned32", "enterprises", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npGsmInfo=npGsmInfo, npRelHumTrapFail=npRelHumTrapFail, npForcedReboot=npForcedReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSoftReboot=npSoftReboot, npIoMemo=npIoMemo, npRelHumTrapData=npRelHumTrapData, npSmokeTrapMemo=npSmokeTrapMemo, npSmokeSensorN=npSmokeSensorN, npIoTrap=npIoTrap, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmoke=npSmoke, npThermoTrapHigh=npThermoTrapHigh, npIrStatus=npIrStatus, npRelayMode=npRelayMode, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoTrapLow=npThermoTrapLow, npIrCtrl=npIrCtrl, npSmokeTraps=npSmokeTraps, npThermoTable=npThermoTable, npIoTrapPrefix=npIoTrapPrefix, npSmokeReset=npSmokeReset, npIoTrapMemo=npIoTrapMemo, npGsm=npGsm, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTempValue=npRelHumTempValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrap=npRelHumTrap, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npSmokeTrap=npSmokeTrap, npIoPulseCounter=npIoPulseCounter, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelayMemo=npRelayMemo, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npIoEntry=npIoEntry, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTable=npCurLoopTable, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmRegistration=npGsmRegistration, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTraps=npIoTraps, npRelHumTrapTemp=npRelHumTrapTemp, npIoTable=npIoTable, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npRelHumN=npRelHumN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumValue=npRelHumValue, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopStatus=npCurLoopStatus, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapV=npCurLoopTrapV, npCurLoopPower=npCurLoopPower, npCurLoopN=npCurLoopN, npSmokeTable=npSmokeTable, npIoTrapLineN=npIoTrapLineN, npCurLoopV=npCurLoopV, npThermoValuePrecise=npThermoValuePrecise, npSmokeMemo=npSmokeMemo, npThermoTrap=npThermoTrap, npSmokeTrapStatus=npSmokeTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIrReset=npIrReset, npIr=npIr, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoop=npCurLoop, npRelHumStatus=npRelHumStatus, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoMemo=npThermoMemo, lightcom=lightcom, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmStrength=npGsmStrength, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npIoLevelOut=npIoLevelOut, npThermoStatus=npThermoStatus, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npRelayStartReset=npRelayStartReset, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npCurLoopTrap=npCurLoopTrap, npCurLoopR=npCurLoopR, npTrapEmailTo=npTrapEmailTo, npRelHumTrapDataValue=npRelHumTrapDataValue, FixedPoint1000=FixedPoint1000, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npIo=npIo, npCurLoopTrapR=npCurLoopTrapR, npRelayN=npRelayN, npCurLoopTraps=npCurLoopTraps, npThermoLow=npThermoLow, npRelHumMemo=npRelHumMemo, npThermoHigh=npThermoHigh, npRelay=npRelay, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npReboot=npReboot, npThermo=npThermo, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npThermoValue=npThermoValue, npSmokeEntry=npSmokeEntry, npGsmFailed=npGsmFailed, npRelayState=npRelayState, npThermoTraps=npThermoTraps, npThermoSensorN=npThermoSensorN, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmTraps=npGsmTraps, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe)
