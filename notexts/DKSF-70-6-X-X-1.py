...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:05:04 2023
...
iso, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, Counter32, NotificationType, ObjectIdentity, Counter64, Unsigned32, MibIdentifier, enterprises, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "Counter32", "NotificationType", "ObjectIdentity", "Counter64", "Unsigned32", "MibIdentifier", "enterprises", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopR=npCurLoopR, npThermo=npThermo, npCurLoopTraps=npCurLoopTraps, npIoTrapPrefix=npIoTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeSensorN=npSmokeSensorN, npThermoTable=npThermoTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataN=npRelHumTrapDataN, npThermoValue=npThermoValue, npRelHumValue=npRelHumValue, npThermoTrapLow=npThermoTrapLow, npThermoTrapHigh=npThermoTrapHigh, npGsmTrap=npGsmTrap, npGsmStrength=npGsmStrength, npRelHumTrapData=npRelHumTrapData, npSmokeStatus=npSmokeStatus, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopTrapI=npCurLoopTrapI, npGsmTrapPrefix=npGsmTrapPrefix, npRelayTable=npRelayTable, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIrStatus=npIrStatus, npTrapEmailTo=npTrapEmailTo, npThermoTrap=npThermoTrap, npRelayEntry=npRelayEntry, npSmokeReset=npSmokeReset, npGsmRegistration=npGsmRegistration, npIrPlayCmd=npIrPlayCmd, npIoTrapLevelIn=npIoTrapLevelIn, npRelayMode=npRelayMode, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIrCtrl=npIrCtrl, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumStatus=npRelHumStatus, npRelayState=npRelayState, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelayMemo=npRelayMemo, npRelHumTempValue=npRelHumTempValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrapMemo=npIoTrapMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayStartReset=npRelayStartReset, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseStart=npIoSinglePulseStart, npThermoLow=npThermoLow, npIoPulseCounter=npIoPulseCounter, npIrReset=npIrReset, npSmokeTrap=npSmokeTrap, npCurLoopTable=npCurLoopTable, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npIoTrap=npIoTrap, npSmokeTrapMemo=npSmokeTrapMemo, npGsmFailed=npGsmFailed, FixedPoint1000=FixedPoint1000, npCurLoopV=npCurLoopV, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelIn=npIoLevelIn, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapFail=npRelHumTrapFail, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopN=npCurLoopN, npRelHumidity=npRelHumidity, npIoTable=npIoTable, npThermoMemo=npThermoMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayN=npRelayN, npRelHumTrapTemp=npRelHumTrapTemp, npTrapInfo=npTrapInfo, npReboot=npReboot, npCurLoopPower=npCurLoopPower, lightcom=lightcom, npThermoTraps=npThermoTraps, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIr=npIr, npCurLoop=npCurLoop, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTraps=npIoTraps, npRelHumN=npRelHumN, npThermoSensorN=npThermoSensorN, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokePower=npSmokePower, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoStatus=npThermoStatus, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrap=npRelHumTrap, npRelHumMemo=npRelHumMemo, npSmokeMemo=npSmokeMemo, npThermoTrapValue=npThermoTrapValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmoke=npSmoke, npCurLoopI=npCurLoopI, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npSmokeEntry=npSmokeEntry, npIo=npIo, npThermoEntry=npThermoEntry, npThermoHigh=npThermoHigh, npGsmInfo=npGsmInfo, npThermoTrapStatus=npThermoTrapStatus, npGsm=npGsm, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoEntry=npIoEntry, npCurLoopEntry=npCurLoopEntry, npForcedReboot=npForcedReboot, npSmokeTraps=npSmokeTraps, npGsmTraps=npGsmTraps, npCurLoopTrapStatus=npCurLoopTrapStatus, npSoftReboot=npSoftReboot, npIoLevelOut=npIoLevelOut, npIoLineN=npIoLineN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelay=npRelay, npRelHumTempStatus=npRelHumTempStatus, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopStatus=npCurLoopStatus, npRelHumEntry=npRelHumEntry, npResetStack=npResetStack, npIoMemo=npIoMemo)
