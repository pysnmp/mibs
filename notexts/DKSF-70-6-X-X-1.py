...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:15:38 2022
...
iso, Counter32, enterprises, IpAddress, ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, ModuleIdentity, Unsigned32, Integer32, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "enterprises", "IpAddress", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "ModuleIdentity", "Unsigned32", "Integer32", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopPower=npCurLoopPower, npSmokeEntry=npSmokeEntry, npIrPlayCmd=npIrPlayCmd, npRelayMode=npRelayMode, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, npSmokeTrapStatus=npSmokeTrapStatus, npResetStack=npResetStack, npCurLoopStatus=npCurLoopStatus, npRelayTable=npRelayTable, npSmokeStatus=npSmokeStatus, npThermoValuePrecise=npThermoValuePrecise, npIoEntry=npIoEntry, npSmokeTrap=npSmokeTrap, npGsmFailed=npGsmFailed, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npIoTrapLevelIn=npIoTrapLevelIn, npTrapInfo=npTrapInfo, npThermoLow=npThermoLow, npCurLoopV=npCurLoopV, npRelHumTempValue=npRelHumTempValue, npRelHumTrapData=npRelHumTrapData, npCurLoopN=npCurLoopN, npTrapEmailTo=npTrapEmailTo, npIoTrapPrefix=npIoTrapPrefix, npIoTraps=npIoTraps, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npSmokeTraps=npSmokeTraps, npSmokeReset=npSmokeReset, npIoPulseCounter=npIoPulseCounter, npIoTrapLineN=npIoTrapLineN, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrap=npRelHumTrap, npRelHumStatus=npRelHumStatus, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrap=npIoTrap, npThermoTable=npThermoTable, npCurLoopTrapI=npCurLoopTrapI, npIrStatus=npIrStatus, npRelHumEntry=npRelHumEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapHigh=npThermoTrapHigh, npThermoValue=npThermoValue, npGsm=npGsm, npThermoTrapPrefix=npThermoTrapPrefix, npCurLoop=npCurLoop, npThermoTrapValue=npThermoTrapValue, lightcom=lightcom, npCurLoopTrapV=npCurLoopTrapV, npThermoSensorN=npThermoSensorN, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTraps=npCurLoopTraps, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npRelayEntry=npRelayEntry, npRelHumidity=npRelHumidity, npThermoTraps=npThermoTraps, npSmoke=npSmoke, npRelayN=npRelayN, npRelHumTempStatus=npRelHumTempStatus, npThermoTrap=npThermoTrap, npCurLoopTrapR=npCurLoopTrapR, npGsmTraps=npGsmTraps, npRelay=npRelay, npRelHumN=npRelHumN, npCurLoopTrapN=npCurLoopTrapN, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npGsmStrength=npGsmStrength, npIo=npIo, npRelHumTrapDataStatus=npRelHumTrapDataStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayStartReset=npRelayStartReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataN=npRelHumTrapDataN, npThermoHigh=npThermoHigh, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoTrapMemo=npIoTrapMemo, npCurLoopTable=npCurLoopTable, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoEntry=npThermoEntry, npIoLineN=npIoLineN, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npCurLoopEntry=npCurLoopEntry, npSmokePower=npSmokePower, npRelayState=npRelayState, npSmokeTable=npSmokeTable, npCurLoopI=npCurLoopI, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoMemo=npThermoMemo, npGsmInfo=npGsmInfo, npIr=npIr, npCurLoopTrap=npCurLoopTrap, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npForcedReboot=npForcedReboot, npThermoStatus=npThermoStatus, npCurLoopR=npCurLoopR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, FixedPoint1000=FixedPoint1000, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeMemo=npSmokeMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIrReset=npIrReset, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTable=npIoTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapAllEvents=npRelHumTrapAllEvents)
