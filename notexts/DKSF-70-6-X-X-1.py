...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:20:42 2021
...
IpAddress, Gauge32, iso, Bits, ObjectIdentity, MibIdentifier, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Counter64, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Counter64", "Integer32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelayEntry=npRelayEntry, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoSensorN=npThermoSensorN, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npThermoTrapValue=npThermoTrapValue, npRelayState=npRelayState, npSmoke=npSmoke, npThermoHigh=npThermoHigh, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoLineN=npIoLineN, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npThermoTrapSensorN=npThermoTrapSensorN, npIrCtrl=npIrCtrl, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npThermoTrapLow=npThermoTrapLow, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npCurLoopV=npCurLoopV, npCurLoopPower=npCurLoopPower, npSmokePower=npSmokePower, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoopI=npCurLoopI, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTraps=npCurLoopTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npRelHumTrapTemp=npRelHumTrapTemp, npRelayMemo=npRelayMemo, npSmokeTrap=npSmokeTrap, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumEntry=npRelHumEntry, npIoSinglePulseStart=npIoSinglePulseStart, npTrapInfo=npTrapInfo, npIoTrapPrefix=npIoTrapPrefix, npSmokeTraps=npSmokeTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npGsmRegistration=npGsmRegistration, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapLineN=npIoTrapLineN, npSmokeMemo=npSmokeMemo, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapFail=npRelHumTrapFail, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npIrReset=npIrReset, npRelHumN=npRelHumN, npGsmFailed=npGsmFailed, npResetStack=npResetStack, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npThermoTrapHigh=npThermoTrapHigh, npGsmStrength=npGsmStrength, npCurLoopN=npCurLoopN, npGsmInfo=npGsmInfo, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTable=npCurLoopTable, npSmokeTable=npSmokeTable, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempStatus=npRelHumTempStatus, npRelHumStatus=npRelHumStatus, npSmokeEntry=npSmokeEntry, npIoTraps=npIoTraps, npRelHumValue=npRelHumValue, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npThermoTable=npThermoTable, npRelay=npRelay, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npRelHumidity=npRelHumidity, npSmokeTrapStatus=npSmokeTrapStatus, npReboot=npReboot, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoStatus=npThermoStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npThermoValuePrecise=npThermoValuePrecise, npRelayStartReset=npRelayStartReset, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npThermoMemo=npThermoMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapSensorN=npSmokeTrapSensorN, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelayMode=npRelayMode, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTable=npIoTable, npThermoTraps=npThermoTraps, npThermoLow=npThermoLow, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrap=npThermoTrap, npGsm=npGsm, npIr=npIr, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npForcedReboot=npForcedReboot, npThermoValue=npThermoValue, npCurLoopTrapPower=npCurLoopTrapPower, npIo=npIo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopR=npCurLoopR, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npSmokeReset=npSmokeReset, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapSafe=npRelHumTrapSafe, npRelayN=npRelayN, npIoSinglePulseDuration=npIoSinglePulseDuration, lightcom=lightcom, npRelHumTable=npRelHumTable, npCurLoopTrapV=npCurLoopTrapV)
