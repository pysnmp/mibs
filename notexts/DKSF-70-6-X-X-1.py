...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:00:22 2021
...
Gauge32, IpAddress, MibIdentifier, Counter64, iso, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter32, ModuleIdentity, ObjectIdentity, NotificationType, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "MibIdentifier", "Counter64", "iso", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopI=npCurLoopI, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapData=npRelHumTrapData, npIo=npIo, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPower=npCurLoopTrapPower, npSmokeEntry=npSmokeEntry, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSmokePower=npSmokePower, npThermoTrapSensorN=npThermoTrapSensorN, npIoTraps=npIoTraps, npThermoLow=npThermoLow, npCurLoopStatus=npCurLoopStatus, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npIr=npIr, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelay=npRelay, npThermoHigh=npThermoHigh, npRelHumTrapFail=npRelHumTrapFail, lightcom=lightcom, npRelHumN=npRelHumN, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayN=npRelayN, npCurLoopR=npCurLoopR, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTrapMemo=npIoTrapMemo, npGsmStrength=npGsmStrength, npSmokeTrapMemo=npSmokeTrapMemo, npTrapInfo=npTrapInfo, npCurLoopEntry=npCurLoopEntry, npRelayTable=npRelayTable, npIrPlayCmd=npIrPlayCmd, npIoPulseCounter=npIoPulseCounter, npSmokeMemo=npSmokeMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmFailed=npGsmFailed, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTable=npCurLoopTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoMemo=npThermoMemo, npIoEntry=npIoEntry, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoTrapValue=npThermoTrapValue, npThermoTable=npThermoTable, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopV=npCurLoopV, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npCurLoopN=npCurLoopN, npCurLoopTrapV=npCurLoopTrapV, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, FixedPoint1000=FixedPoint1000, npRelHumTempValue=npRelHumTempValue, npRelHumTable=npRelHumTable, npIoLevelIn=npIoLevelIn, npIoTrapPrefix=npIoTrapPrefix, npIoTable=npIoTable, npThermoSensorN=npThermoSensorN, npThermoTrapStatus=npThermoTrapStatus, npRelHumValue=npRelHumValue, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTrap=npIoTrap, npThermoValuePrecise=npThermoValuePrecise, npSmokeStatus=npSmokeStatus, npCurLoopTrapR=npCurLoopTrapR, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTemp=npRelHumTrapTemp, npThermo=npThermo, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTraps=npThermoTraps, npGsm=npGsm, npRelayEntry=npRelayEntry, npRelHumTrap=npRelHumTrap, npIoTrapLineN=npIoTrapLineN, npIrReset=npIrReset, npRelHumMemo=npRelHumMemo, npIoSinglePulseStart=npIoSinglePulseStart, npIrCtrl=npIrCtrl, npCurLoopTrap=npCurLoopTrap, npSoftReboot=npSoftReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeReset=npSmokeReset, npThermoValue=npThermoValue, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelayMode=npRelayMode, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsmTraps=npGsmTraps, npCurLoopTrapI=npCurLoopTrapI, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npGsmRegistration=npGsmRegistration, npCurLoopTrapN=npCurLoopTrapN, npIrStatus=npIrStatus, npCurLoopPower=npCurLoopPower, npSmokeTrap=npSmokeTrap, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTraps=npCurLoopTraps, npReboot=npReboot, npGsmInfo=npGsmInfo, npResetStack=npResetStack, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npSmokeTraps=npSmokeTraps, npGsmTrap=npGsmTrap, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumidity=npRelHumidity, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmoke=npSmoke, npSmokeTrapSensorN=npSmokeTrapSensorN, npTrapEmailTo=npTrapEmailTo, npRelayMemo=npRelayMemo, npThermoEntry=npThermoEntry, npSmokeTable=npSmokeTable, npCurLoopTrapPrefix=npCurLoopTrapPrefix)
