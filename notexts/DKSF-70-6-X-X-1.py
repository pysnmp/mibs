...
ModuleIdentity, enterprises, iso, NotificationType, Counter32, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "iso", "NotificationType", "Counter32", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeSensorN=npSmokeSensorN, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopR=npCurLoopR, npThermoHigh=npThermoHigh, npSmokeMemo=npSmokeMemo, npRelHumTrapDataN=npRelHumTrapDataN, npIoTraps=npIoTraps, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayN=npRelayN, npCurLoopV=npCurLoopV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTable=npIoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmokeTraps=npSmokeTraps, npSmokeStatus=npSmokeStatus, npGsmRegistration=npGsmRegistration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrapLineN=npIoTrapLineN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npRelHumidity=npRelHumidity, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapI=npCurLoopTrapI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayEntry=npRelayEntry, npSoftReboot=npSoftReboot, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrStatus=npIrStatus, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrapPrefix=npIoTrapPrefix, npThermoEntry=npThermoEntry, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoMemo=npIoMemo, npGsm=npGsm, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoTrap=npIoTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmInfo=npGsmInfo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoLow=npThermoLow, npCurLoopTrapV=npCurLoopTrapV, npRelHumMemo=npRelHumMemo, npTrapInfo=npTrapInfo, npIoTrapMemo=npIoTrapMemo, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoStatus=npThermoStatus, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npCurLoopTrapN=npCurLoopTrapN, npIr=npIr, npSmoke=npSmoke, npThermoTraps=npThermoTraps, npCurLoopStatus=npCurLoopStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npRelHumEntry=npRelHumEntry, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeTrap=npSmokeTrap, npIoLevelIn=npIoLevelIn, npRelHumN=npRelHumN, npCurLoopTrapR=npCurLoopTrapR, npThermoValuePrecise=npThermoValuePrecise, npThermoSensorN=npThermoSensorN, npSmokeReset=npSmokeReset, npThermoTable=npThermoTable, npSmokeEntry=npSmokeEntry, npRelHumTempStatus=npRelHumTempStatus, npThermoTrapPrefix=npThermoTrapPrefix, npTrapEmailTo=npTrapEmailTo, npIoEntry=npIoEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrap=npThermoTrap, npRelayStartReset=npRelayStartReset, npRelHumTrapTemp=npRelHumTrapTemp, npIo=npIo, npIoPulseCounter=npIoPulseCounter, npIrCtrl=npIrCtrl, npRelHumTrapData=npRelHumTrapData, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopN=npCurLoopN, npRelayMemo=npRelayMemo, npThermo=npThermo, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapValue=npThermoTrapValue, npGsmTrap=npGsmTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrap=npRelHumTrap, npRelayMode=npRelayMode, npCurLoopTraps=npCurLoopTraps, npCurLoopI=npCurLoopI, npGsmFailed=npGsmFailed, npRelayState=npRelayState, npCurLoop=npCurLoop, npRelHumValue=npRelHumValue, npIoSinglePulseStart=npIoSinglePulseStart, npSmokeTable=npSmokeTable, npCurLoopTable=npCurLoopTable, npGsmStrength=npGsmStrength, npReboot=npReboot, npRelHumStatus=npRelHumStatus, FixedPoint1000=FixedPoint1000, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmTraps=npGsmTraps, npForcedReboot=npForcedReboot, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapMemo=npThermoTrapMemo, lightcom=lightcom, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoMemo=npThermoMemo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTempValue=npRelHumTempValue, npCurLoopTrapPower=npCurLoopTrapPower, npResetStack=npResetStack, npSmokePower=npSmokePower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTrapStatus=npSmokeTrapStatus, npRelayTable=npRelayTable)
