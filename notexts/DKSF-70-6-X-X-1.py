...
# Produced by pysmi-1.1.12 at Thu Apr  4 10:15:08 2024
...
Counter64, Bits, Gauge32, Counter32, NotificationType, TimeTicks, MibIdentifier, iso, ObjectIdentity, ModuleIdentity, Unsigned32, enterprises, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "Gauge32", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "enterprises", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npThermoTrapMemo=npThermoTrapMemo, npSoftReboot=npSoftReboot, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, FixedPoint1000=FixedPoint1000, npIoEntry=npIoEntry, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTable=npThermoTable, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelayStartReset=npRelayStartReset, npCurLoopStatus=npCurLoopStatus, npRelHumN=npRelHumN, npCurLoopN=npCurLoopN, npRelHumValue=npRelHumValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapSafe=npRelHumTrapSafe, npRelayN=npRelayN, npCurLoopR=npCurLoopR, npCurLoopV=npCurLoopV, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npGsm=npGsm, npThermoStatus=npThermoStatus, npGsmTrap=npGsmTrap, npIoTrapLevelIn=npIoTrapLevelIn, npIrStatus=npIrStatus, npSmokeSensorN=npSmokeSensorN, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npThermoTrapLow=npThermoTrapLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelHumEntry=npRelHumEntry, npRelHumTempStatus=npRelHumTempStatus, npThermoValuePrecise=npThermoValuePrecise, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npResetStack=npResetStack, npThermoTrap=npThermoTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoop=npCurLoop, npSmoke=npSmoke, npRelayMode=npRelayMode, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrap=npCurLoopTrap, npRelayEntry=npRelayEntry, npTrapEmailTo=npTrapEmailTo, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, lightcom=lightcom, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumStatus=npRelHumStatus, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapR=npCurLoopTrapR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTable=npRelHumTable, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTrapTempFail=npRelHumTrapTempFail, npGsmStrength=npGsmStrength, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokeTable=npSmokeTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrap=npIoTrap, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapTemp=npRelHumTrapTemp, npRelayTable=npRelayTable, npThermoMemo=npThermoMemo, npSmokeMemo=npSmokeMemo, npThermoEntry=npThermoEntry, npRelHumMemo=npRelHumMemo, npThermo=npThermo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIrCtrl=npIrCtrl, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npForcedReboot=npForcedReboot, npCurLoopTraps=npCurLoopTraps, npIoPulseCounter=npIoPulseCounter, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapMemo=npSmokeTrapMemo, npIoLevelOut=npIoLevelOut, npGsmRegistration=npGsmRegistration, npRelay=npRelay, npIoTable=npIoTable, npTrapInfo=npTrapInfo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeReset=npSmokeReset, npIoSinglePulseStart=npIoSinglePulseStart, npRelayState=npRelayState, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npIr=npIr, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTempValue=npRelHumTempValue, npThermoTraps=npThermoTraps, npSmokePower=npSmokePower, npSmokeStatus=npSmokeStatus, npSmokeEntry=npSmokeEntry, npCurLoopPower=npCurLoopPower, npCurLoopTable=npCurLoopTable, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npGsmTraps=npGsmTraps, npReboot=npReboot, npIoTraps=npIoTraps, npIo=npIo, npGsmInfo=npGsmInfo, npThermoTrapPrefix=npThermoTrapPrefix, npIrPlayCmd=npIrPlayCmd, npCurLoopEntry=npCurLoopEntry, npThermoValue=npThermoValue, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopI=npCurLoopI, npIoTrapLineN=npIoTrapLineN, npIoTrapLevelLegend=npIoTrapLevelLegend, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoLevelIn=npIoLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoTrapMemo=npIoTrapMemo, npThermoLow=npThermoLow, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelayMemo=npRelayMemo, npRelHumTrapData=npRelHumTrapData, npRelHumTrapDataN=npRelHumTrapDataN, uniPingServerSolutionV3=uniPingServerSolutionV3)
