...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:26:00 2023
...
Gauge32, ObjectIdentity, MibIdentifier, Counter64, IpAddress, TimeTicks, NotificationType, enterprises, ModuleIdentity, Unsigned32, iso, Counter32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter64", "IpAddress", "TimeTicks", "NotificationType", "enterprises", "ModuleIdentity", "Unsigned32", "iso", "Counter32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopEntry=npCurLoopEntry, npRelHumN=npRelHumN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSoftReboot=npSoftReboot, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermoSensorN=npThermoSensorN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempValue=npRelHumTempValue, npIrReset=npIrReset, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npReboot=npReboot, npIo=npIo, npSmokeMemo=npSmokeMemo, npSmokeStatus=npSmokeStatus, npThermoTrapSensorN=npThermoTrapSensorN, npGsmTraps=npGsmTraps, npSmokeTrap=npSmokeTrap, npIr=npIr, npSmokeEntry=npSmokeEntry, npRelayStartReset=npRelayStartReset, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npRelHumTrap=npRelHumTrap, npGsmTrap=npGsmTrap, npThermoTrapMemo=npThermoTrapMemo, npThermoStatus=npThermoStatus, npIoTraps=npIoTraps, npRelHumTrapData=npRelHumTrapData, npGsmRegistration=npGsmRegistration, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapR=npCurLoopTrapR, npIoLevelIn=npIoLevelIn, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrap=npIoTrap, npIoPulseCounter=npIoPulseCounter, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npForcedReboot=npForcedReboot, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumStatus=npRelHumStatus, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoopTrapV=npCurLoopTrapV, npIoMemo=npIoMemo, npSmokeTable=npSmokeTable, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopR=npCurLoopR, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npSmokeSensorN=npSmokeSensorN, npTrapEmailTo=npTrapEmailTo, npCurLoopTable=npCurLoopTable, npCurLoop=npCurLoop, npSmokeTrapPrefix=npSmokeTrapPrefix, npGsmInfo=npGsmInfo, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIrCtrl=npIrCtrl, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoLineN=npIoLineN, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npIoTrapPrefix=npIoTrapPrefix, npThermoLow=npThermoLow, npCurLoopStatus=npCurLoopStatus, npCurLoopTrapI=npCurLoopTrapI, npThermoValue=npThermoValue, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npIoEntry=npIoEntry, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, npSmokePower=npSmokePower, npCurLoopTrap=npCurLoopTrap, npRelHumTrapFail=npRelHumTrapFail, npIrPlayCmd=npIrPlayCmd, npIoLevelOut=npIoLevelOut, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, npThermoTrapLow=npThermoTrapLow, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmoke=npSmoke, npThermoEntry=npThermoEntry, npCurLoopV=npCurLoopV, npSmokeReset=npSmokeReset, lightcom=lightcom, npRelayEntry=npRelayEntry, npRelHumValue=npRelHumValue, npSmokeTrapStatus=npSmokeTrapStatus, npGsm=npGsm, npIoTrapMemo=npIoTrapMemo, npCurLoopTraps=npCurLoopTraps, npRelayMemo=npRelayMemo, npThermoMemo=npThermoMemo, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopI=npCurLoopI, npRelHumTable=npRelHumTable, npCurLoopN=npCurLoopN, FixedPoint1000=FixedPoint1000, npRelayN=npRelayN, npThermo=npThermo, npRelayMode=npRelayMode, npThermoTrap=npThermoTrap, npRelayState=npRelayState, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmStrength=npGsmStrength, npThermoTable=npThermoTable, npIoSinglePulseStart=npIoSinglePulseStart, npGsmFailed=npGsmFailed, npResetStack=npResetStack, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumMemo=npRelHumMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTempStatus=npRelHumTempStatus, npTrapInfo=npTrapInfo, npThermoHigh=npThermoHigh, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIrStatus=npIrStatus, npIoTrapLineN=npIoTrapLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumidity=npRelHumidity, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTraps=npThermoTraps)
