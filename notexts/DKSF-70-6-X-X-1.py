...
# Produced by pysmi-1.1.12 at Wed Jul  3 09:14:45 2024
...
TimeTicks, MibIdentifier, iso, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Gauge32, Counter32, ObjectIdentity, Integer32, Unsigned32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "iso", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Gauge32", "Counter32", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoStatus=npThermoStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayN=npRelayN, npSmokeMemo=npSmokeMemo, npThermoTrapStatus=npThermoTrapStatus, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumValue=npRelHumValue, npCurLoopTable=npCurLoopTable, npSmokeSensorN=npSmokeSensorN, npIrPlayCmd=npIrPlayCmd, npIoLevelIn=npIoLevelIn, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npTrapEmailTo=npTrapEmailTo, npSmokeTrapMemo=npSmokeTrapMemo, npGsm=npGsm, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoValue=npThermoValue, npGsmInfo=npGsmInfo, lightcom=lightcom, npRelHumTempStatus=npRelHumTempStatus, npThermoLow=npThermoLow, npSmoke=npSmoke, npSoftReboot=npSoftReboot, FixedPoint1000=FixedPoint1000, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npIr=npIr, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrap=npThermoTrap, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapLineN=npIoTrapLineN, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTraps=npIoTraps, npSmokeTraps=npSmokeTraps, npCurLoopTrapV=npCurLoopTrapV, npRelHumTempValue=npRelHumTempValue, npIrStatus=npIrStatus, npCurLoopTrapI=npCurLoopTrapI, npCurLoopV=npCurLoopV, npThermoTraps=npThermoTraps, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npCurLoopTrap=npCurLoopTrap, npRelHumTrapData=npRelHumTrapData, npGsmTrapPrefix=npGsmTrapPrefix, npIoTrap=npIoTrap, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTable=npThermoTable, npRelHumStatus=npRelHumStatus, npIrCtrl=npIrCtrl, npRelHumEntry=npRelHumEntry, npSmokeReset=npSmokeReset, npSmokeTable=npSmokeTable, npRelayState=npRelayState, npThermoEntry=npThermoEntry, npRelHumTrapDataValue=npRelHumTrapDataValue, npGsmTrap=npGsmTrap, npRelayTable=npRelayTable, npGsmRegistration=npGsmRegistration, npRelHumTrap=npRelHumTrap, npThermoHigh=npThermoHigh, npRelHumTable=npRelHumTable, npCurLoopPower=npCurLoopPower, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoMemo=npIoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTemp=npRelHumTrapTemp, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapSensorN=npThermoTrapSensorN, npThermoTrapMemo=npThermoTrapMemo, npThermoTrapValue=npThermoTrapValue, npCurLoopTrapPower=npCurLoopTrapPower, npIoSinglePulseDuration=npIoSinglePulseDuration, npIo=npIo, npRelHumTrapDataN=npRelHumTrapDataN, npRelayMemo=npRelayMemo, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopStatus=npCurLoopStatus, npIrReset=npIrReset, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npRelHumTrapFail=npRelHumTrapFail, npSmokeTrapPrefix=npSmokeTrapPrefix, npCurLoopTrapN=npCurLoopTrapN, npGsmFailed=npGsmFailed, npRelayEntry=npRelayEntry, npIoLevelOut=npIoLevelOut, npRelay=npRelay, npCurLoopTraps=npCurLoopTraps, npRelHumMemo=npRelHumMemo, npIoLineN=npIoLineN, npIoTrapPrefix=npIoTrapPrefix, npSmokeStatus=npSmokeStatus, npThermoMemo=npThermoMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMode=npRelayMode, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumidity=npRelHumidity, npRelayStartReset=npRelayStartReset, npSmokeEntry=npSmokeEntry, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npReboot=npReboot, npIoTable=npIoTable, npGsmTraps=npGsmTraps, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npThermoTrapLow=npThermoTrapLow, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapMemo=npIoTrapMemo, npResetStack=npResetStack, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermo=npThermo, npCurLoopN=npCurLoopN, npCurLoopI=npCurLoopI, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npForcedReboot=npForcedReboot, npRelHumN=npRelHumN, npCurLoopR=npCurLoopR, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npGsmStrength=npGsmStrength, npSmokePower=npSmokePower, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npIoPulseCounter=npIoPulseCounter)
