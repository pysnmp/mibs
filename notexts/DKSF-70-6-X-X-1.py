...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:56:31 2022
...
ModuleIdentity, enterprises, Bits, Counter32, Gauge32, Integer32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Bits", "Counter32", "Gauge32", "Integer32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumN=npRelHumN, npIo=npIo, npCurLoopTraps=npCurLoopTraps, npGsm=npGsm, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapSafe=npRelHumTrapSafe, npIoTrapMemo=npIoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npCurLoopTable=npCurLoopTable, npGsmRegistration=npGsmRegistration, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTraps=npThermoTraps, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapLow=npThermoTrapLow, npIoTable=npIoTable, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmFailed=npGsmFailed, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIrReset=npIrReset, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelayEntry=npRelayEntry, npThermoStatus=npThermoStatus, npTrapEmailTo=npTrapEmailTo, npThermoEntry=npThermoEntry, npIr=npIr, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoLevelOut=npIoLevelOut, npIoPulseCounter=npIoPulseCounter, npCurLoop=npCurLoop, npThermoTrap=npThermoTrap, npRelayMode=npRelayMode, npSmokeMemo=npSmokeMemo, npThermoSensorN=npThermoSensorN, npThermoLow=npThermoLow, uniPingServerSolutionV3=uniPingServerSolutionV3, npSmokeTraps=npSmokeTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npThermoMemo=npThermoMemo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, lightcom=lightcom, npTrapInfo=npTrapInfo, npSmokeTrap=npSmokeTrap, npThermoValuePrecise=npThermoValuePrecise, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumMemo=npRelHumMemo, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumStatus=npRelHumStatus, npIrPlayCmd=npIrPlayCmd, npIoTraps=npIoTraps, npSmokePower=npSmokePower, npResetStack=npResetStack, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapI=npCurLoopTrapI, npSoftReboot=npSoftReboot, npThermoTrapPrefix=npThermoTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTable=npRelHumTable, npCurLoopN=npCurLoopN, npRelHumTempValue=npRelHumTempValue, npGsmStrength=npGsmStrength, npSmokeStatus=npSmokeStatus, npThermoTrapStatus=npThermoTrapStatus, npCurLoopPower=npCurLoopPower, npRelayN=npRelayN, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrap=npRelHumTrap, npRelayMemo=npRelayMemo, npSmoke=npSmoke, npRelHumValue=npRelHumValue, npCurLoopV=npCurLoopV, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npThermo=npThermo, FixedPoint1000=FixedPoint1000, npThermoTrapHigh=npThermoTrapHigh, npThermoHigh=npThermoHigh, npReboot=npReboot, npRelayState=npRelayState, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValue=npThermoValue, npGsmTraps=npGsmTraps, npRelayTable=npRelayTable, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrap=npCurLoopTrap, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelay=npRelay, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoTrapValue=npThermoTrapValue, npIoMemo=npIoMemo, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopR=npCurLoopR, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeTable=npSmokeTable, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTrapN=npCurLoopTrapN, npForcedReboot=npForcedReboot, npRelayStartReset=npRelayStartReset, npGsmTrap=npGsmTrap, npIoTrap=npIoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeEntry=npSmokeEntry, npThermoTrapMemo=npThermoTrapMemo, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoEntry=npIoEntry, npRelHumTempStatus=npRelHumTempStatus, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npRelHumidity=npRelHumidity, npCurLoopI=npCurLoopI, npThermoTable=npThermoTable, npGsmInfo=npGsmInfo, npRelHumEntry=npRelHumEntry, npIoTrapLevelLegend=npIoTrapLevelLegend, npSmokeSensorN=npSmokeSensorN, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeTrapSensorN=npSmokeTrapSensorN, npIrCtrl=npIrCtrl, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npIoLevelIn=npIoLevelIn, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npCurLoopTrapPower=npCurLoopTrapPower, npIoLineN=npIoLineN)
