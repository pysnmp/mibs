...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:00:29 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, TimeTicks, MibIdentifier, Integer32, Bits, enterprises, iso, Gauge32, NotificationType, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "enterprises", "iso", "Gauge32", "NotificationType", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npIoLineN=npIoLineN, npReboot=npReboot, uniPingServerSolutionV3=uniPingServerSolutionV3, npIoEntry=npIoEntry, npThermoTrapStatus=npThermoTrapStatus, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npResetStack=npResetStack, npSmokeTrap=npSmokeTrap, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo, npCurLoopPower=npCurLoopPower, npRelHumTempStatus=npRelHumTempStatus, npRelHumTempValue=npRelHumTempValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrap=npRelHumTrap, npGsmRegistration=npGsmRegistration, npGsmTrap=npGsmTrap, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npGsmFailed=npGsmFailed, npThermoSensorN=npThermoSensorN, npThermoTraps=npThermoTraps, lightcom=lightcom, npCurLoopTable=npCurLoopTable, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayMemo=npRelayMemo, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npTrapInfo=npTrapInfo, npRelHumTrapFail=npRelHumTrapFail, npThermoValue=npThermoValue, npRelHumidity=npRelHumidity, npCurLoopTraps=npCurLoopTraps, npIo=npIo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermo=npThermo, npSmokeSensorN=npSmokeSensorN, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTable=npThermoTable, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapMemo=npThermoTrapMemo, npIoTrapMemo=npIoTrapMemo, npTrapEmailTo=npTrapEmailTo, npThermoTrapHigh=npThermoTrapHigh, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumValue=npRelHumValue, npSmokeReset=npSmokeReset, npSmokeMemo=npSmokeMemo, npCurLoopV=npCurLoopV, npThermoHigh=npThermoHigh, npCurLoopN=npCurLoopN, npThermoEntry=npThermoEntry, npSoftReboot=npSoftReboot, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapLow=npThermoTrapLow, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumMemo=npRelHumMemo, npGsm=npGsm, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTraps=npSmokeTraps, npCurLoopI=npCurLoopI, npForcedReboot=npForcedReboot, npSmokeStatus=npSmokeStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npRelHumTable=npRelHumTable, npRelHumTrapDataN=npRelHumTrapDataN, npIrStatus=npIrStatus, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npRelHumN=npRelHumN, npRelHumTrapData=npRelHumTrapData, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoTraps=npIoTraps, npThermoTrapSensorN=npThermoTrapSensorN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoSinglePulseStart=npIoSinglePulseStart, npIrReset=npIrReset, npCurLoopTrapI=npCurLoopTrapI, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npCurLoopTrapR=npCurLoopTrapR, npIoMemo=npIoMemo, npSmokePower=npSmokePower, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmStrength=npGsmStrength, FixedPoint1000=FixedPoint1000, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoop=npCurLoop, npThermoMemo=npThermoMemo, npThermoStatus=npThermoStatus, npThermoTrap=npThermoTrap, npRelayN=npRelayN, npIoTrapPrefix=npIoTrapPrefix, npSmokeEntry=npSmokeEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrapSensorN=npSmokeTrapSensorN, npIoTable=npIoTable, npIrCtrl=npIrCtrl, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelay=npRelay, npCurLoopTrap=npCurLoopTrap, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npCurLoopTrapV=npCurLoopTrapV, npIrPlayCmd=npIrPlayCmd, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npSmokeTable=npSmokeTable, npRelayStartReset=npRelayStartReset, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npGsmTraps=npGsmTraps, npCurLoopEntry=npCurLoopEntry, npRelayState=npRelayState, npIr=npIr, npIoLevelOut=npIoLevelOut, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, npRelayMode=npRelayMode, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelayTable=npRelayTable, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npRelHumEntry=npRelHumEntry)
