...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:57:31 2022
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ObjectIdentity, IpAddress, TimeTicks, Integer32, MibIdentifier, iso, enterprises, NotificationType, Unsigned32, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ObjectIdentity", "IpAddress", "TimeTicks", "Integer32", "MibIdentifier", "iso", "enterprises", "NotificationType", "Unsigned32", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTrapN=npCurLoopTrapN, npIoTrapPrefix=npIoTrapPrefix, npThermoTraps=npThermoTraps, npSmokeReset=npSmokeReset, npGsmInfo=npGsmInfo, npCurLoopTrapI=npCurLoopTrapI, npGsmRegistration=npGsmRegistration, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npSmokeMemo=npSmokeMemo, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopI=npCurLoopI, npThermoHigh=npThermoHigh, npGsm=npGsm, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapData=npRelHumTrapData, npThermoValuePrecise=npThermoValuePrecise, npRelayStartReset=npRelayStartReset, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrap=npCurLoopTrap, npRelay=npRelay, npRelHumMemo=npRelHumMemo, npIoEntry=npIoEntry, npCurLoopN=npCurLoopN, npRelayMode=npRelayMode, npRelHumEntry=npRelHumEntry, npIoTrap=npIoTrap, npIoTrapLineN=npIoTrapLineN, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npThermoEntry=npThermoEntry, npIr=npIr, npThermoTrapSensorN=npThermoTrapSensorN, npRelayState=npRelayState, npCurLoopTraps=npCurLoopTraps, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npRelHumTrapFail=npRelHumTrapFail, npRelHumN=npRelHumN, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopV=npCurLoopV, npSmokeTrapMemo=npSmokeTrapMemo, npThermoTrapMemo=npThermoTrapMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeEntry=npSmokeEntry, npRelayEntry=npRelayEntry, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn=npIoTrapLevelIn, npSoftReboot=npSoftReboot, npThermoTrap=npThermoTrap, npGsmTraps=npGsmTraps, npThermoTrapValue=npThermoTrapValue, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoLineN=npIoLineN, npTrapInfo=npTrapInfo, npRelayMemo=npRelayMemo, npThermo=npThermo, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTable=npThermoTable, npGsmStrength=npGsmStrength, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayTable=npRelayTable, npSmokeTraps=npSmokeTraps, npRelHumTempValue=npRelHumTempValue, npRelHumidity=npRelHumidity, npCurLoopR=npCurLoopR, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapTemp=npRelHumTrapTemp, npIrPlayCmd=npIrPlayCmd, npThermoValue=npThermoValue, npRelHumTable=npRelHumTable, lightcom=lightcom, npRelHumTrapDataValue=npRelHumTrapDataValue, npCurLoopPower=npCurLoopPower, npIoTable=npIoTable, npIo=npIo, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTrap=npRelHumTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npSmokeStatus=npSmokeStatus, npSmokeSensorN=npSmokeSensorN, npSmokeTrap=npSmokeTrap, npCurLoopStatus=npCurLoopStatus, npSmokePower=npSmokePower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npCurLoop=npCurLoop, npIrCtrl=npIrCtrl, FixedPoint1000=FixedPoint1000, npResetStack=npResetStack, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTraps=npIoTraps, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopTrapV=npCurLoopTrapV, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npGsmTrap=npGsmTrap, npSmoke=npSmoke, npRelHumValue=npRelHumValue, npSmokeTable=npSmokeTable, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmFailed=npGsmFailed, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumStatus=npRelHumStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npIoMemo=npIoMemo, npCurLoopEntry=npCurLoopEntry, npSmokeTrapPrefix=npSmokeTrapPrefix, npThermoLow=npThermoLow, npForcedReboot=npForcedReboot, npThermoMemo=npThermoMemo, npReboot=npReboot, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npCurLoopTable=npCurLoopTable)
