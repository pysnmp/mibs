...
# Produced by pysmi-1.1.8 at Tue Feb  8 22:11:55 2022
...
ModuleIdentity, iso, enterprises, Bits, Counter32, Gauge32, Integer32, MibIdentifier, Unsigned32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "enterprises", "Bits", "Counter32", "Gauge32", "Integer32", "MibIdentifier", "Unsigned32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoMemo=npThermoMemo, npRelHumTrapTemp=npRelHumTrapTemp, npIoEntry=npIoEntry, npSmokeMemo=npSmokeMemo, npIrReset=npIrReset, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoTrapMemo=npIoTrapMemo, npRelHumTempValue=npRelHumTempValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoPulseCounter=npIoPulseCounter, npThermoSensorN=npThermoSensorN, npCurLoopPower=npCurLoopPower, npThermoTrap=npThermoTrap, npThermoTable=npThermoTable, npThermoStatus=npThermoStatus, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTrap=npCurLoopTrap, npCurLoopR=npCurLoopR, npRelayStartReset=npRelayStartReset, npCurLoopTrapPower=npCurLoopTrapPower, npRelayMemo=npRelayMemo, npCurLoopN=npCurLoopN, npCurLoopV=npCurLoopV, npIoTrapLineN=npIoTrapLineN, npRelHumTrapTempFail=npRelHumTrapTempFail, npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, lightcom=lightcom, npRelHumTable=npRelHumTable, npRelHumTrap=npRelHumTrap, npRelHumidity=npRelHumidity, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npSmokeReset=npSmokeReset, npRelayState=npRelayState, npForcedReboot=npForcedReboot, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npGsmTrap=npGsmTrap, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapPrefix=npIoTrapPrefix, npGsmRegistration=npGsmRegistration, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTable=npIoTable, npRelayEntry=npRelayEntry, npRelHumStatus=npRelHumStatus, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npThermoTrapSensorN=npThermoTrapSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npSmokeTrapPrefix=npSmokeTrapPrefix, npIo=npIo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npThermoHigh=npThermoHigh, npIoTraps=npIoTraps, npCurLoopI=npCurLoopI, npThermoEntry=npThermoEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npResetStack=npResetStack, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapValue=npThermoTrapValue, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopEntry=npCurLoopEntry, npIoLineN=npIoLineN, npCurLoop=npCurLoop, npRelHumMemo=npRelHumMemo, npThermoTrapLow=npThermoTrapLow, npThermo=npThermo, npThermoTraps=npThermoTraps, npRelHumValue=npRelHumValue, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoTrapLevelIn=npIoTrapLevelIn, npGsm=npGsm, npTrapEmailTo=npTrapEmailTo, npThermoTrapMemo=npThermoTrapMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npIoLevelOut=npIoLevelOut, npSoftReboot=npSoftReboot, npSmokeEntry=npSmokeEntry, npCurLoopTraps=npCurLoopTraps, npGsmTrapPrefix=npGsmTrapPrefix, FixedPoint1000=FixedPoint1000, npSmoke=npSmoke, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npSmokeTrapStatus=npSmokeTrapStatus, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoValuePrecise=npThermoValuePrecise, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoTrap=npIoTrap, npRelHumN=npRelHumN, npGsmTraps=npGsmTraps, npRelHumEntry=npRelHumEntry, npThermoTrapStatus=npThermoTrapStatus, npIoSinglePulseStart=npIoSinglePulseStart, npReboot=npReboot, npIoMemo=npIoMemo, npSmokeStatus=npSmokeStatus, npThermoLow=npThermoLow, npSmokePower=npSmokePower, npRelHumTrapData=npRelHumTrapData, npRelay=npRelay, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTrap=npSmokeTrap, npRelayMode=npRelayMode, npCurLoopStatus=npCurLoopStatus, npIr=npIr, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npGsmStrength=npGsmStrength, npIoLevelIn=npIoLevelIn, npCurLoopTrapN=npCurLoopTrapN, npSmokeSensorN=npSmokeSensorN, npRelHumTempStatus=npRelHumTempStatus, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapSafe=npRelHumTrapSafe, npRelayTable=npRelayTable, npCurLoopTable=npCurLoopTable, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapStatus=npCurLoopTrapStatus, npGsmFailed=npGsmFailed, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapPrefix=npThermoTrapPrefix, npSmokeTable=npSmokeTable, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npRelHumTrapDataN=npRelHumTrapDataN, npSmokeTraps=npSmokeTraps, npIrCtrl=npIrCtrl, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npGsmInfo=npGsmInfo)
