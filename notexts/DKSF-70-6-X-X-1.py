...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelay=npRelay, npThermoValuePrecise=npThermoValuePrecise, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npIoTraps=npIoTraps, npRelHumTrapTempFail=npRelHumTrapTempFail, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTrap=npThermoTrap, npRelHumTrapData=npRelHumTrapData, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrap=npRelHumTrap, npThermo=npThermo, npThermoValue=npThermoValue, npIr=npIr, lightcom=lightcom, npRelHumidity=npRelHumidity, npGsmTraps=npGsmTraps, npGsmTrapPrefix=npGsmTrapPrefix, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npResetStack=npResetStack, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapSafe=npRelHumTrapSafe, npRelayState=npRelayState, npCurLoopR=npCurLoopR, npRelHumTempStatus=npRelHumTempStatus, npIrCtrl=npIrCtrl, npRelayStartReset=npRelayStartReset, npRelHumN=npRelHumN, npSmokeTrap=npSmokeTrap, npTrapEmailTo=npTrapEmailTo, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npCurLoopTrapR=npCurLoopTrapR, npCurLoopTable=npCurLoopTable, npThermoTable=npThermoTable, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapHigh=npThermoTrapHigh, npRelHumEntry=npRelHumEntry, npCurLoopTraps=npCurLoopTraps, npReboot=npReboot, npSmokeEntry=npSmokeEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopPower=npCurLoopPower, npSmokeStatus=npSmokeStatus, npSmokeTable=npSmokeTable, npThermoTraps=npThermoTraps, FixedPoint1000=FixedPoint1000, npThermoLow=npThermoLow, npIrReset=npIrReset, npIoTrapMemo=npIoTrapMemo, npSmokeSensorN=npSmokeSensorN, npCurLoopStatus=npCurLoopStatus, npCurLoopV=npCurLoopV, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npSmokePower=npSmokePower, npRelayEntry=npRelayEntry, npSmokeMemo=npSmokeMemo, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npSmoke=npSmoke, npSmokeReset=npSmokeReset, npRelHumTable=npRelHumTable, npRelHumTempValue=npRelHumTempValue, npThermoMemo=npThermoMemo, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoEntry=npIoEntry, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npIoTrapLineN=npIoTrapLineN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npCurLoopTrap=npCurLoopTrap, uniPingServerSolutionV3=uniPingServerSolutionV3, npCurLoopTrapI=npCurLoopTrapI, npCurLoop=npCurLoop, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelayN=npRelayN, npGsm=npGsm, npThermoHigh=npThermoHigh, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeTraps=npSmokeTraps, npThermoTrapLow=npThermoTrapLow, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npRelHumValue=npRelHumValue, npIoLevelOut=npIoLevelOut, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapDataN=npRelHumTrapDataN, npThermoTrapSensorN=npThermoTrapSensorN, npIoMemo=npIoMemo, npCurLoopTrapN=npCurLoopTrapN, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIrPlayCmd=npIrPlayCmd, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npGsmTrap=npGsmTrap, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumMemo=npRelHumMemo, npCurLoopEntry=npCurLoopEntry, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrStatus=npIrStatus, npGsmRegistration=npGsmRegistration, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapValue=npThermoTrapValue, npGsmInfo=npGsmInfo, npGsmFailed=npGsmFailed, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npTrapInfo=npTrapInfo, npSmokeTrapStatus=npSmokeTrapStatus, npThermoTrapStatus=npThermoTrapStatus, npThermoSensorN=npThermoSensorN, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTable=npIoTable, npForcedReboot=npForcedReboot, npRelHumStatus=npRelHumStatus, npRelayMemo=npRelayMemo, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npCurLoopTrapStatus=npCurLoopTrapStatus, npIoTrap=npIoTrap, npCurLoopN=npCurLoopN, npIoLevelIn=npIoLevelIn, npThermoStatus=npThermoStatus, npIoPulseCounter=npIoPulseCounter, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npIo=npIo, npThermoEntry=npThermoEntry, npCurLoopTrapV=npCurLoopTrapV)
