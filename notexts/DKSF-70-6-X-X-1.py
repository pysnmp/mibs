...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:59:17 2022
...
ModuleIdentity, Counter64, enterprises, Bits, NotificationType, Unsigned32, MibIdentifier, Integer32, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "Bits", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumEntry=npRelHumEntry, npGsmInfo=npGsmInfo, npIoTrapMemo=npIoTrapMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIr=npIr, npIrCtrl=npIrCtrl, npSmokeTrapMemo=npSmokeTrapMemo, npThermoEntry=npThermoEntry, npCurLoopR=npCurLoopR, npResetStack=npResetStack, npIoSinglePulseStart=npIoSinglePulseStart, npRelHumTrap=npRelHumTrap, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, uniPingServerSolutionV3=uniPingServerSolutionV3, npThermoValue=npThermoValue, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelayMode=npRelayMode, npGsmFailed=npGsmFailed, npCurLoopStatus=npCurLoopStatus, npRelHumTrapTemp=npRelHumTrapTemp, npSmokeTrapStatus=npSmokeTrapStatus, npIoMemo=npIoMemo, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopTrapV=npCurLoopTrapV, npThermoTrapSensorN=npThermoTrapSensorN, npIoTable=npIoTable, npRelayStartReset=npRelayStartReset, npRelHumidity=npRelHumidity, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelayState=npRelayState, npRelHumStatus=npRelHumStatus, npIrStatus=npIrStatus, npSmokeMemo=npSmokeMemo, npRelay=npRelay, npIoTrapLineN=npIoTrapLineN, npSmokeTraps=npSmokeTraps, npThermoTrapValue=npThermoTrapValue, npCurLoopEntry=npCurLoopEntry, npRelayTable=npRelayTable, npRelayN=npRelayN, lightcom=lightcom, npGsmTrap=npGsmTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npIoPulseCounter=npIoPulseCounter, npRelHumTrapFail=npRelHumTrapFail, npRelHumTrapDataN=npRelHumTrapDataN, npCurLoopTrapI=npCurLoopTrapI, npThermoLow=npThermoLow, npThermoMemo=npThermoMemo, npCurLoopTable=npCurLoopTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeTable=npSmokeTable, npGsmTrapPrefix=npGsmTrapPrefix, npIrPlayCmd=npIrPlayCmd, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTrapR=npCurLoopTrapR, npIoTraps=npIoTraps, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokeReset=npSmokeReset, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermo=npThermo, npRelHumTrapData=npRelHumTrapData, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoTrapPrefix=npIoTrapPrefix, npForcedReboot=npForcedReboot, npIoLevelIn=npIoLevelIn, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npSmokeStatus=npSmokeStatus, npTrapEmailTo=npTrapEmailTo, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npRelHumTable=npRelHumTable, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIrReset=npIrReset, npRelayMemo=npRelayMemo, npThermoStatus=npThermoStatus, npCurLoopI=npCurLoopI, npCurLoopTrapN=npCurLoopTrapN, npRelHumValue=npRelHumValue, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npSmokeTrap=npSmokeTrap, npThermoSensorN=npThermoSensorN, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoop=npCurLoop, npSmokeSensorN=npSmokeSensorN, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npIoEntry=npIoEntry, npRelHumTempStatus=npRelHumTempStatus, npGsmTraps=npGsmTraps, npSmokeTrapPrefix=npSmokeTrapPrefix, npIoLineN=npIoLineN, npThermoTrapPrefix=npThermoTrapPrefix, npGsmStrength=npGsmStrength, npReboot=npReboot, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npThermoHigh=npThermoHigh, npThermoTrap=npThermoTrap, npTrapInfo=npTrapInfo, npCurLoopN=npCurLoopN, npIoLevelOut=npIoLevelOut, FixedPoint1000=FixedPoint1000, npSmokeEntry=npSmokeEntry, npSoftReboot=npSoftReboot, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, npCurLoopTrap=npCurLoopTrap, npThermoValuePrecise=npThermoValuePrecise, npRelayEntry=npRelayEntry, npGsmRegistration=npGsmRegistration, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npIo=npIo, npRelHumTempValue=npRelHumTempValue, npSmoke=npSmoke, npThermoTable=npThermoTable, npIoTrap=npIoTrap, npSmokePower=npSmokePower, npCurLoopPower=npCurLoopPower, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelHumN=npRelHumN, npRelHumMemo=npRelHumMemo, npThermoTraps=npThermoTraps, npCurLoopV=npCurLoopV, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoTrapLow=npThermoTrapLow)
