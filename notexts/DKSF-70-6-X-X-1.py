...
# Produced by pysmi-1.1.8 at Tue Sep 12 13:00:26 2023
...
Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, enterprises, Gauge32, NotificationType, Counter64, ModuleIdentity, Counter32, TimeTicks, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "Counter32", "TimeTicks", "iso", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapAllEvents=npRelHumTrapAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npSmokeStatus=npSmokeStatus, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npRelHumTrapTempFail=npRelHumTrapTempFail, npSmoke=npSmoke, npCurLoopTrapV=npCurLoopTrapV, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTable=npRelHumTable, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTrapData=npRelHumTrapData, npCurLoopTrapI=npCurLoopTrapI, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPower=npCurLoopTrapPower, npRelHumValue=npRelHumValue, npRelHumidity=npRelHumidity, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTable=npCurLoopTable, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npGsmFailed=npGsmFailed, npIrReset=npIrReset, npCurLoopTrapStatus=npCurLoopTrapStatus, npIrStatus=npIrStatus, npThermoTrapStatus=npThermoTrapStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npGsm=npGsm, FixedPoint1000=FixedPoint1000, npThermoValue=npThermoValue, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npResetStack=npResetStack, npCurLoopPower=npCurLoopPower, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumEntry=npRelHumEntry, npSmokeEntry=npSmokeEntry, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npIoTrapMemo=npIoTrapMemo, lightcom=lightcom, npIoTrap=npIoTrap, npRelayMemo=npRelayMemo, npIoPulseCounter=npIoPulseCounter, npRelay=npRelay, npRelayState=npRelayState, npSmokeSensorN=npSmokeSensorN, npThermoStatus=npThermoStatus, npCurLoopTrap=npCurLoopTrap, npTrapInfo=npTrapInfo, npRelHumStatus=npRelHumStatus, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npThermoTable=npThermoTable, npIoLevelOut=npIoLevelOut, npRelHumTempStatus=npRelHumTempStatus, npRelayStartReset=npRelayStartReset, npThermoHigh=npThermoHigh, npSmokeReset=npSmokeReset, npCurLoopStatus=npCurLoopStatus, npCurLoopR=npCurLoopR, npRelHumTrapDataValue=npRelHumTrapDataValue, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapDataN=npRelHumTrapDataN, npIoTraps=npIoTraps, npIo=npIo, npCurLoopV=npCurLoopV, npSmokeTable=npSmokeTable, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npThermoTraps=npThermoTraps, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npThermoMemo=npThermoMemo, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npSmokePower=npSmokePower, npIoTable=npIoTable, npThermoLow=npThermoLow, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npThermoTrapPrefix=npThermoTrapPrefix, npThermoEntry=npThermoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npSmokeTraps=npSmokeTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopI=npCurLoopI, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelayTable=npRelayTable, npIoSinglePulseStart=npIoSinglePulseStart, npIoLineN=npIoLineN, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumN=npRelHumN, npSmokeTrap=npSmokeTrap, npRelHumTrap=npRelHumTrap, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoEntry=npIoEntry, npReboot=npReboot, npGsmTraps=npGsmTraps, npRelHumMemo=npRelHumMemo, npGsmTrap=npGsmTrap, npCurLoopEntry=npCurLoopEntry, npRelHumTrapFail=npRelHumTrapFail, npCurLoopTraps=npCurLoopTraps, npGsmInfo=npGsmInfo, uniPingServerSolutionV3=uniPingServerSolutionV3, npTrapEmailTo=npTrapEmailTo, npCurLoopTrapR=npCurLoopTrapR, npThermo=npThermo, npIr=npIr, npIoLevelIn=npIoLevelIn, npIoMemo=npIoMemo, npIrPlayCmd=npIrPlayCmd, npSmokeMemo=npSmokeMemo, npRelayN=npRelayN, npThermoTrapLow=npThermoTrapLow, npIoTrapLineN=npIoTrapLineN, npGsmStrength=npGsmStrength, npRelayMode=npRelayMode, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopN=npCurLoopN, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapValue=npThermoTrapValue, npThermoValuePrecise=npThermoValuePrecise, npGsmRegistration=npGsmRegistration, npRelayEntry=npRelayEntry, npRelHumTempValue=npRelHumTempValue, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npIoTrapLevelIn=npIoTrapLevelIn, npIoTrapLevelLegend=npIoTrapLevelLegend, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npGsmTrapPrefix=npGsmTrapPrefix, npSoftReboot=npSoftReboot)
