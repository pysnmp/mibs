...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:22:08 2022
...
Unsigned32, ObjectIdentity, enterprises, Bits, Gauge32, Integer32, IpAddress, ModuleIdentity, Counter32, MibIdentifier, Counter64, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "enterprises", "Bits", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "Counter32", "MibIdentifier", "Counter64", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npSmokeTrap=npSmokeTrap, npCurLoopPower=npCurLoopPower, npRelHumStatus=npRelHumStatus, npIoLevelOut=npIoLevelOut, npThermoSensorN=npThermoSensorN, npIoTrap=npIoTrap, npRelayStartReset=npRelayStartReset, npCurLoopV=npCurLoopV, npIoTable=npIoTable, npSmokeEntry=npSmokeEntry, npThermoTrapPrefix=npThermoTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoTraps=npIoTraps, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npIoEntry=npIoEntry, npThermoTraps=npThermoTraps, npSmokeTrapStatus=npSmokeTrapStatus, npResetStack=npResetStack, npForcedReboot=npForcedReboot, npRelHumTrapTempFail=npRelHumTrapTempFail, npThermoEntry=npThermoEntry, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npRelHumTrapDataValue=npRelHumTrapDataValue, npThermoTrapStatus=npThermoTrapStatus, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmokePower=npSmokePower, npThermoTrapValue=npThermoTrapValue, npSmokeTraps=npSmokeTraps, npRelHumTable=npRelHumTable, npCurLoopTraps=npCurLoopTraps, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrapFail=npRelHumTrapFail, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmTrapPrefix=npGsmTrapPrefix, npSmokeTrapSensorN=npSmokeTrapSensorN, npSmokeTable=npSmokeTable, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npRelHumTempValue=npRelHumTempValue, npRelay=npRelay, FixedPoint1000=FixedPoint1000, npIrReset=npIrReset, lightcom=lightcom, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npIrPlayCmd=npIrPlayCmd, npSoftReboot=npSoftReboot, npSmoke=npSmoke, npRelayMemo=npRelayMemo, npThermoTrapLow=npThermoTrapLow, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npRelHumTrapData=npRelHumTrapData, npRelayEntry=npRelayEntry, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoMemo=npThermoMemo, npIoSinglePulseStart=npIoSinglePulseStart, npCurLoopR=npCurLoopR, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapR=npCurLoopTrapR, npGsmTraps=npGsmTraps, npThermoTable=npThermoTable, npIoTrapLevelLegend=npIoTrapLevelLegend, npCurLoopTrapV=npCurLoopTrapV, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npThermoHigh=npThermoHigh, npCurLoop=npCurLoop, npRelHumEntry=npRelHumEntry, npThermoTrap=npThermoTrap, npCurLoopTrapPower=npCurLoopTrapPower, npGsmStrength=npGsmStrength, npCurLoopStatus=npCurLoopStatus, npCurLoopTable=npCurLoopTable, npIr=npIr, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelayMode=npRelayMode, npGsmRegistration=npGsmRegistration, npIoLineN=npIoLineN, npGsmFailed=npGsmFailed, npTrapInfo=npTrapInfo, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTrapI=npCurLoopTrapI, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTrap=npRelHumTrap, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeMemo=npSmokeMemo, npReboot=npReboot, npRelHumTrapSafe=npRelHumTrapSafe, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npCurLoopN=npCurLoopN, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npThermoTrapHigh=npThermoTrapHigh, npCurLoopTrap=npCurLoopTrap, npIoMemo=npIoMemo, npIoLevelIn=npIoLevelIn, npRelayState=npRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeStatus=npSmokeStatus, npIoTrapMemo=npIoTrapMemo, npSmokeTrapMemo=npSmokeTrapMemo, npCurLoopI=npCurLoopI, npRelHumN=npRelHumN, npThermoLow=npThermoLow, npRelHumValue=npRelHumValue, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npThermoTrapMemo=npThermoTrapMemo, npGsmTrap=npGsmTrap, npGsm=npGsm, npIrStatus=npIrStatus, npIoTrapPrefix=npIoTrapPrefix, npSmokeSensorN=npSmokeSensorN, npRelHumTrapDataN=npRelHumTrapDataN, npIoPulseCounter=npIoPulseCounter, npIoTrapLineN=npIoTrapLineN, npThermoValuePrecise=npThermoValuePrecise, npThermo=npThermo, npTrapEmailTo=npTrapEmailTo, npThermoValue=npThermoValue, npIo=npIo, npRelHumTempStatus=npRelHumTempStatus, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumidity=npRelHumidity, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npGsmInfo=npGsmInfo, npThermoTrapSensorN=npThermoTrapSensorN)
