...
MibIdentifier, Integer32, enterprises, NotificationType, Counter32, TimeTicks, Bits, Counter64, ModuleIdentity, Gauge32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "enterprises", "NotificationType", "Counter32", "TimeTicks", "Bits", "Counter64", "ModuleIdentity", "Gauge32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelayEntry=npRelayEntry, npRelHumTrapFail=npRelHumTrapFail, npIoTrapPrefix=npIoTrapPrefix, npRelHumTrapData=npRelHumTrapData, npCurLoop=npCurLoop, npThermoSensorN=npThermoSensorN, npRelHumStatus=npRelHumStatus, npRelHumTable=npRelHumTable, npIoSinglePulseStart=npIoSinglePulseStart, npIrStatus=npIrStatus, npThermoTable=npThermoTable, npRelay=npRelay, npCurLoopTrapR=npCurLoopTrapR, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npRelHumTrapDataValue=npRelHumTrapDataValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npIoTrapLineN=npIoTrapLineN, npThermoTrapHigh=npThermoTrapHigh, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumTrapDataN=npRelHumTrapDataN, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npReboot=npReboot, npSmokePower=npSmokePower, npGsm=npGsm, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npIoLineN=npIoLineN, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, lightcom=lightcom, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npSmokeStatus=npSmokeStatus, npSmokeTrapSensorN=npSmokeTrapSensorN, npThermoTrapLow=npThermoTrapLow, npIo=npIo, npThermoMemo=npThermoMemo, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoPulseCounter=npIoPulseCounter, npThermoTrapValue=npThermoTrapValue, npSmokeTrapPrefix=npSmokeTrapPrefix, npSmokeTrapStatus=npSmokeTrapStatus, npRelHumidity=npRelHumidity, npGsmRegistration=npGsmRegistration, npRelayMemo=npRelayMemo, npRelHumTrap=npRelHumTrap, npRelHumValue=npRelHumValue, npGsmFailed=npGsmFailed, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npSmokeSensorN=npSmokeSensorN, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npCurLoopTrapI=npCurLoopTrapI, npThermoHigh=npThermoHigh, npRelayN=npRelayN, npThermoTrapStatus=npThermoTrapStatus, npCurLoopR=npCurLoopR, npTrapInfo=npTrapInfo, npRelayStartReset=npRelayStartReset, npResetStack=npResetStack, npIoEntry=npIoEntry, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoTrapLevelIn=npIoTrapLevelIn, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npSmokeTrapMemo=npSmokeTrapMemo, npIoTable=npIoTable, npIrPlayCmd=npIrPlayCmd, npIrReset=npIrReset, npIr=npIr, npGsmTraps=npGsmTraps, npRelHumTempValue=npRelHumTempValue, npRelHumN=npRelHumN, npRelHumEntry=npRelHumEntry, npThermoValue=npThermoValue, npCurLoopTrapV=npCurLoopTrapV, npThermoEntry=npThermoEntry, npRelHumTempStatus=npRelHumTempStatus, npSmokeReset=npSmokeReset, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npThermoTrapMemo=npThermoTrapMemo, npCurLoopTable=npCurLoopTable, npSmokeTable=npSmokeTable, npCurLoopTraps=npCurLoopTraps, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoValuePrecise=npThermoValuePrecise, npRelayState=npRelayState, npSoftReboot=npSoftReboot, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapPower=npCurLoopTrapPower, npCurLoopEntry=npCurLoopEntry, npCurLoopTrapN=npCurLoopTrapN, npGsmStrength=npGsmStrength, npIrCtrl=npIrCtrl, npRelayTable=npRelayTable, npSmokeMemo=npSmokeMemo, npThermo=npThermo, npIoSinglePulseDuration=npIoSinglePulseDuration, npThermoTraps=npThermoTraps, npGsmTrapPrefix=npGsmTrapPrefix, npIoLevelIn=npIoLevelIn, npSmoke=npSmoke, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npThermoTrapSensorN=npThermoTrapSensorN, npIoTrap=npIoTrap, npCurLoopI=npCurLoopI, uniPingServerSolutionV3=uniPingServerSolutionV3, FixedPoint1000=FixedPoint1000, npCurLoopPower=npCurLoopPower, npThermoStatus=npThermoStatus, npIoMemo=npIoMemo, npIoTraps=npIoTraps, npCurLoopTrap=npCurLoopTrap, npForcedReboot=npForcedReboot, npCurLoopN=npCurLoopN, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoLevelOut=npIoLevelOut, npSmokeTrap=npSmokeTrap, npSmokeTraps=npSmokeTraps, npCurLoopStatus=npCurLoopStatus, npThermoLow=npThermoLow, npGsmInfo=npGsmInfo, npThermoTrap=npThermoTrap, npCurLoopV=npCurLoopV, npSmokeEntry=npSmokeEntry, npRelHumMemo=npRelHumMemo, npIoTrapMemo=npIoTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels)
