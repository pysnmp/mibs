...
Integer32, Counter32, ModuleIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, MibIdentifier, TimeTicks, iso, ObjectIdentity, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "MibIdentifier", "TimeTicks", "iso", "ObjectIdentity", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("DKSF-70-6-X-X-1", npCurLoopTraps=npCurLoopTraps, npCurLoopV=npCurLoopV, npRelHumN=npRelHumN, npIoTrapLineN=npIoTrapLineN, npRelHumTempStatus=npRelHumTempStatus, npGsmTrap=npGsmTrap, npRelHumTrapTempAboveSafe=npRelHumTrapTempAboveSafe, npSmoke=npSmoke, npSmokeTrapPrefix=npSmokeTrapPrefix, npRelHumTrapDataSafeRangeHigh=npRelHumTrapDataSafeRangeHigh, npIoLevelIn=npIoLevelIn, npCurLoopTrapStatus=npCurLoopTrapStatus, npSmokeEntry=npSmokeEntry, npThermoLow=npThermoLow, npGsmStrength=npGsmStrength, npRelHumTrapTempSafe=npRelHumTrapTempSafe, npIoSinglePulseStart=npIoSinglePulseStart, npThermoSensorN=npThermoSensorN, npCurLoop=npCurLoop, npGsmInfo=npGsmInfo, npCurLoopPower=npCurLoopPower, npSmokeSensorN=npSmokeSensorN, npThermoTrap=npThermoTrap, npIoTrapLevelIn=npIoTrapLevelIn, npSmokeTrap=npSmokeTrap, npRelHumTrapDataStatus=npRelHumTrapDataStatus, npThermoTrapHigh=npThermoTrapHigh, npSmokeTable=npSmokeTable, npCurLoopR=npCurLoopR, npRelHumTrapTempFail=npRelHumTrapTempFail, npRelHumidity=npRelHumidity, npCurLoopN=npCurLoopN, npRelHumTrapFail=npRelHumTrapFail, npThermoValuePrecise=npThermoValuePrecise, npIrCtrl=npIrCtrl, npGsmRegistration=npGsmRegistration, npCurLoopTrapPrefix=npCurLoopTrapPrefix, uniPingServerSolutionV3=uniPingServerSolutionV3, npSoftReboot=npSoftReboot, npTrapInfo=npTrapInfo, npIrStatus=npIrStatus, npSmokeReset=npSmokeReset, npIr=npIr, npRelay=npRelay, npThermoTrapValue=npThermoTrapValue, npIoTrapMemo=npIoTrapMemo, npThermoTraps=npThermoTraps, npThermoEntry=npThermoEntry, npIoSinglePulseDuration=npIoSinglePulseDuration, npRelHumTempValue=npRelHumTempValue, npRelHumValue=npRelHumValue, npSmokeStatus=npSmokeStatus, npRelayMemo=npRelayMemo, npRelHumTrapDataSafeRangeLow=npRelHumTrapDataSafeRangeLow, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapSafe=npRelHumTrapSafe, npCurLoopTrapV=npCurLoopTrapV, npThermoMemo=npThermoMemo, npRelHumTempSafeRangeHigh=npRelHumTempSafeRangeHigh, npIoPulseCounter=npIoPulseCounter, npIrPlayCmd=npIrPlayCmd, npCurLoopTrap=npCurLoopTrap, npReboot=npReboot, npSmokeTraps=npSmokeTraps, npGsmSendSmsWin1251=npGsmSendSmsWin1251, npGsm=npGsm, npIoLineN=npIoLineN, npIoMemo=npIoMemo, npRelHumTrapAboveSafe=npRelHumTrapAboveSafe, npIo=npIo, npSmokeTrapMemo=npSmokeTrapMemo, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npRelHumTrapData=npRelHumTrapData, npIoTrapLevelLegend=npIoTrapLevelLegend, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npSmokeMemo=npSmokeMemo, npResetStack=npResetStack, npRelayEntry=npRelayEntry, npIoTrapPrefix=npIoTrapPrefix, npCurLoopI=npCurLoopI, npSmokeTrapStatus=npSmokeTrapStatus, npCurLoopEntry=npCurLoopEntry, npThermoTrapStatus=npThermoTrapStatus, npGsmTraps=npGsmTraps, npRelHumTrapDataValue=npRelHumTrapDataValue, npRelHumTrapTempAllChannels=npRelHumTrapTempAllChannels, npCurLoopStatus=npCurLoopStatus, npGsmSendSmsUtf8=npGsmSendSmsUtf8, npCurLoopTrapR=npCurLoopTrapR, npRelHumTrapTempAllEvents=npRelHumTrapTempAllEvents, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npIoEntry=npIoEntry, npRelHumMemo=npRelHumMemo, npThermoStatus=npThermoStatus, npSmokePower=npSmokePower, npCurLoopTrapI=npCurLoopTrapI, FixedPoint1000=FixedPoint1000, npSmokeTrapSensorN=npSmokeTrapSensorN, npRelayTable=npRelayTable, npCurLoopTrapPower=npCurLoopTrapPower, npGsmTrapPrefix=npGsmTrapPrefix, npThermoHigh=npThermoHigh, npRelHumTempSafeRangeLow=npRelHumTempSafeRangeLow, npThermoValue=npThermoValue, npRelHumTrapBelowSafe=npRelHumTrapBelowSafe, npRelHumTrap=npRelHumTrap, npRelayStartReset=npRelayStartReset, npGsmFailed=npGsmFailed, npThermoTrapPrefix=npThermoTrapPrefix, npIoTraps=npIoTraps, npRelHumTrapTempBelowSafe=npRelHumTrapTempBelowSafe, npRelayN=npRelayN, npRelHumTrapAllChannels=npRelHumTrapAllChannels, npRelHumTrapDataN=npRelHumTrapDataN, npIrReset=npIrReset, npIoLevelOut=npIoLevelOut, npRelHumTable=npRelHumTable, npRelHumEntry=npRelHumEntry, npThermoTrapSensorN=npThermoTrapSensorN, npCurLoopTrapN=npCurLoopTrapN, npCurLoopTable=npCurLoopTable, npThermoTable=npThermoTable, npRelHumTrapAllEvents=npRelHumTrapAllEvents, npThermo=npThermo, npRelayState=npRelayState, lightcom=lightcom, npForcedReboot=npForcedReboot, npIoTrap=npIoTrap, npIoTable=npIoTable, npRelHumTrapTemp=npRelHumTrapTemp, npRelHumTrapDataMemo=npRelHumTrapDataMemo, npRelHumStatus=npRelHumStatus, npThermoTrapLow=npThermoTrapLow, npRelayMode=npRelayMode, npTrapEmailTo=npTrapEmailTo)
